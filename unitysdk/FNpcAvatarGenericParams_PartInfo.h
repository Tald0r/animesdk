...
#define FNPCAVATARGENERICPARAMS_PARTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x14EF7CA0)

inline static constexpr unsigned int FNpcAvatarGenericParams_PartInfo_TypeDefinitionIndex = 42889;

class FNpcAvatarGenericParams_PartInfo : public ::System::Object
{
public:
	::Il2CppArray<::System::Int32>* logicTags; // 0x10
