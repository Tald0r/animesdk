...
#define FNPCAVATARGENERICPARAMS_PARTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x6309310)

inline static constexpr unsigned int FNpcAvatarGenericParams_PartInfo_TypeDefinitionIndex = 53271;

class FNpcAvatarGenericParams_PartInfo : public ::System::Object
{
public:
	::Il2CppArray<::Il2CppArray<::System::ValueTuple_2<::NapMaterialProperty, ::UnityEngine::Color32>>*>* OverridePropertyColorsArray; // 0x10
