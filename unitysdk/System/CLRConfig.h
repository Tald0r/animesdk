...
#define SYSTEM_CLRCONFIG_CHECKTHROWUNOBSERVEDTASKEXCEPTIONS_OFFSET UNITYSDK_OFFSET(0x19AF7260)
#define SYSTEM_CLRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF7270)
