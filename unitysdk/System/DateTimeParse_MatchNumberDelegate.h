...
#define SYSTEM_DATETIMEPARSE_MATCHNUMBERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A0BF0B0)
#define SYSTEM_DATETIMEPARSE_MATCHNUMBERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A0BF160)
#define SYSTEM_DATETIMEPARSE_MATCHNUMBERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A0BED20)
#define SYSTEM_DATETIMEPARSE_MATCHNUMBERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0BED00)
