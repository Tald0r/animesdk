...
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_CHECKBREAK_OFFSET UNITYSDK_OFFSET(0x1A5FB4F0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_CONTAINSWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A5FF700)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_DEDENT_OFFSET UNITYSDK_OFFSET(0x1A5FAD70)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_DUMPLABEL_OFFSET UNITYSDK_OFFSET(0x1A5FE020)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETCONSTANTVALUESUFFIX_OFFSET UNITYSDK_OFFSET(0x1A5FC7E0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1A5FBF00)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETFLOW_OFFSET UNITYSDK_OFFSET(0x1A5FB400)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETLABELTARGETID_OFFSET UNITYSDK_OFFSET(0x1A5FAE30)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETLABELTARGETNAME_OFFSET UNITYSDK_OFFSET(0x1A5FE250)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETLAMBDAID_OFFSET UNITYSDK_OFFSET(0x1A5FAD90)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETLAMBDANAME_OFFSET UNITYSDK_OFFSET(0x1A5FF580)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETOPERATORPRECEDENCE_OFFSET UNITYSDK_OFFSET(0x1A5FCCA0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETPARAMID_OFFSET UNITYSDK_OFFSET(0x1A5FADE0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GET_BASE_OFFSET UNITYSDK_OFFSET(0x1A5FACE0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GET_DELTA_OFFSET UNITYSDK_OFFSET(0x1A5FAD10)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1A5FAD20)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_INDENT_OFFSET UNITYSDK_OFFSET(0x1A5FAD60)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_ISSIMPLEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A5FC060)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_NEEDSPARENTHESES_OFFSET UNITYSDK_OFFSET(0x1A5FBC20)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_NEWLINE_OFFSET UNITYSDK_OFFSET(0x1A5FAD80)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUTMEMBER_OFFSET UNITYSDK_OFFSET(0x1A5FC9E0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUT_1_OFFSET UNITYSDK_OFFSET(0x1A5FB3E0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUT_2_OFFSET UNITYSDK_OFFSET(0x1A5FB3F0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUT_3_OFFSET UNITYSDK_OFFSET(0x1A5FB2C0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUT_OFFSET UNITYSDK_OFFSET(0x1A5FB2B0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_PARENTHESIZEDVISIT_OFFSET UNITYSDK_OFFSET(0x1A5FBB70)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_QUOTENAME_OFFSET UNITYSDK_OFFSET(0x1A5FF780)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITBINARY_OFFSET UNITYSDK_OFFSET(0x1A5FB5D0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITBLOCK_OFFSET UNITYSDK_OFFSET(0x1A5FDB70)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITCATCHBLOCK_OFFSET UNITYSDK_OFFSET(0x1A5FEB30)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITCONDITIONAL_OFFSET UNITYSDK_OFFSET(0x1A5FC110)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A5FC350)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITDEBUGINFO_OFFSET UNITYSDK_OFFSET(0x1A5FF160)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITDECLARATIONS_OFFSET UNITYSDK_OFFSET(0x1A5FB550)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITDEFAULT_OFFSET UNITYSDK_OFFSET(0x1A5FDE00)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITELEMENTINIT_OFFSET UNITYSDK_OFFSET(0x1A5FD140)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITEXTENSION_OFFSET UNITYSDK_OFFSET(0x1A5FEFA0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITGOTO_OFFSET UNITYSDK_OFFSET(0x1A5FE120)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITINDEX_OFFSET UNITYSDK_OFFSET(0x1A5FEE40)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITINVOCATION_OFFSET UNITYSDK_OFFSET(0x1A5FCB70)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITLABEL_OFFSET UNITYSDK_OFFSET(0x1A5FDE90)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITLISTINIT_OFFSET UNITYSDK_OFFSET(0x1A5FD240)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITLOOP_OFFSET UNITYSDK_OFFSET(0x1A5FE390)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBERASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1A5FD300)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBERINIT_OFFSET UNITYSDK_OFFSET(0x1A5FD550)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBERLISTBINDING_OFFSET UNITYSDK_OFFSET(0x1A5FD390)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBERMEMBERBINDING_OFFSET UNITYSDK_OFFSET(0x1A5FD470)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBER_OFFSET UNITYSDK_OFFSET(0x1A5FCB20)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMETHODCALL_OFFSET UNITYSDK_OFFSET(0x1A5FCCE0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITNEWARRAY_OFFSET UNITYSDK_OFFSET(0x1A5FCEF0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITNEW_OFFSET UNITYSDK_OFFSET(0x1A5FD020)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A5FBDB0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITRUNTIMEVARIABLES_OFFSET UNITYSDK_OFFSET(0x1A5FC950)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITSWITCHCASE_OFFSET UNITYSDK_OFFSET(0x1A5FE650)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITSWITCH_OFFSET UNITYSDK_OFFSET(0x1A5FE980)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITTRY_OFFSET UNITYSDK_OFFSET(0x1A5FEC90)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITTYPEBINARY_OFFSET UNITYSDK_OFFSET(0x1A5FD610)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITUNARY_OFFSET UNITYSDK_OFFSET(0x1A5FD750)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITELAMBDA_OFFSET UNITYSDK_OFFSET(0x1A5FB030)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1A5FB280)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITETO_1_OFFSET UNITYSDK_OFFSET(0x1A5FAF20)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A5FAE80)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITE_OFFSET UNITYSDK_OFFSET(0x1A5FB4B0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5FAC70)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITDECLARATIONS_B__38_0_OFFSET UNITYSDK_OFFSET(0x1A5FF860)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITLISTINIT_B__58_0_OFFSET UNITYSDK_OFFSET(0x1A5FF920)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITMEMBERINIT_B__62_0_OFFSET UNITYSDK_OFFSET(0x1A5FF950)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITMEMBERLISTBINDING_B__60_0_OFFSET UNITYSDK_OFFSET(0x1A5FF930)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITMEMBERMEMBERBINDING_B__61_0_OFFSET UNITYSDK_OFFSET(0x1A5FF940)
...
namespace System::Linq::Expressions
{
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*, ::System::Int32>* _paramIds; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::LabelTarget*, ::System::Int32>* _labelIds; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::LambdaExpression*, ::System::Int32>* _lambdaIds; // 0x20
		::System::Collections::Generic::Queue_1<::System::Linq::Expressions::LambdaExpression*>* _lambdas; // 0x28
