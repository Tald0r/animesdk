...
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_CHECKBREAK_OFFSET UNITYSDK_OFFSET(0x1ABC8B10)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_CONTAINSWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1ABCCD40)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_DEDENT_OFFSET UNITYSDK_OFFSET(0x1ABC8390)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_DUMPLABEL_OFFSET UNITYSDK_OFFSET(0x1ABCB660)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETCONSTANTVALUESUFFIX_OFFSET UNITYSDK_OFFSET(0x1ABC9E00)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1ABC9520)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETFLOW_OFFSET UNITYSDK_OFFSET(0x1ABC8A20)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETLABELTARGETID_OFFSET UNITYSDK_OFFSET(0x1ABC8450)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETLABELTARGETNAME_OFFSET UNITYSDK_OFFSET(0x1ABCB890)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETLAMBDAID_OFFSET UNITYSDK_OFFSET(0x1ABC83B0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETLAMBDANAME_OFFSET UNITYSDK_OFFSET(0x1ABCCBC0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETOPERATORPRECEDENCE_OFFSET UNITYSDK_OFFSET(0x1ABCA2C0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GETPARAMID_OFFSET UNITYSDK_OFFSET(0x1ABC8400)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GET_BASE_OFFSET UNITYSDK_OFFSET(0x1ABC8300)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GET_DELTA_OFFSET UNITYSDK_OFFSET(0x1ABC8330)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1ABC8340)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_INDENT_OFFSET UNITYSDK_OFFSET(0x1ABC8380)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_ISSIMPLEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1ABC9680)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_NEEDSPARENTHESES_OFFSET UNITYSDK_OFFSET(0x1ABC9240)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_NEWLINE_OFFSET UNITYSDK_OFFSET(0x1ABC83A0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUTMEMBER_OFFSET UNITYSDK_OFFSET(0x1ABCA000)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUT_1_OFFSET UNITYSDK_OFFSET(0x1ABC8A00)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUT_2_OFFSET UNITYSDK_OFFSET(0x1ABC8A10)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUT_3_OFFSET UNITYSDK_OFFSET(0x1ABC88E0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_OUT_OFFSET UNITYSDK_OFFSET(0x1ABC88D0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_PARENTHESIZEDVISIT_OFFSET UNITYSDK_OFFSET(0x1ABC9190)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_QUOTENAME_OFFSET UNITYSDK_OFFSET(0x1ABCCDC0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITBINARY_OFFSET UNITYSDK_OFFSET(0x1ABC8BF0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITBLOCK_OFFSET UNITYSDK_OFFSET(0x1ABCB1B0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITCATCHBLOCK_OFFSET UNITYSDK_OFFSET(0x1ABCC170)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITCONDITIONAL_OFFSET UNITYSDK_OFFSET(0x1ABC9730)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITCONSTANT_OFFSET UNITYSDK_OFFSET(0x1ABC9970)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITDEBUGINFO_OFFSET UNITYSDK_OFFSET(0x1ABCC7A0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITDECLARATIONS_OFFSET UNITYSDK_OFFSET(0x1ABC8B70)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITDEFAULT_OFFSET UNITYSDK_OFFSET(0x1ABCB440)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITELEMENTINIT_OFFSET UNITYSDK_OFFSET(0x1ABCA760)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITEXTENSION_OFFSET UNITYSDK_OFFSET(0x1ABCC5E0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITGOTO_OFFSET UNITYSDK_OFFSET(0x1ABCB760)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITINDEX_OFFSET UNITYSDK_OFFSET(0x1ABCC480)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITINVOCATION_OFFSET UNITYSDK_OFFSET(0x1ABCA190)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITLABEL_OFFSET UNITYSDK_OFFSET(0x1ABCB4D0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITLISTINIT_OFFSET UNITYSDK_OFFSET(0x1ABCA860)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITLOOP_OFFSET UNITYSDK_OFFSET(0x1ABCB9D0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBERASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1ABCA920)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBERINIT_OFFSET UNITYSDK_OFFSET(0x1ABCAB90)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBERLISTBINDING_OFFSET UNITYSDK_OFFSET(0x1ABCA9B0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBERMEMBERBINDING_OFFSET UNITYSDK_OFFSET(0x1ABCAAA0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMEMBER_OFFSET UNITYSDK_OFFSET(0x1ABCA140)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITMETHODCALL_OFFSET UNITYSDK_OFFSET(0x1ABCA300)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITNEWARRAY_OFFSET UNITYSDK_OFFSET(0x1ABCA510)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITNEW_OFFSET UNITYSDK_OFFSET(0x1ABCA640)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITPARAMETER_OFFSET UNITYSDK_OFFSET(0x1ABC93D0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITRUNTIMEVARIABLES_OFFSET UNITYSDK_OFFSET(0x1ABC9F70)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITSWITCHCASE_OFFSET UNITYSDK_OFFSET(0x1ABCBC90)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITSWITCH_OFFSET UNITYSDK_OFFSET(0x1ABCBFC0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITTRY_OFFSET UNITYSDK_OFFSET(0x1ABCC2D0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITTYPEBINARY_OFFSET UNITYSDK_OFFSET(0x1ABCAC50)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_VISITUNARY_OFFSET UNITYSDK_OFFSET(0x1ABCAD90)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITELAMBDA_OFFSET UNITYSDK_OFFSET(0x1ABC8650)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1ABC88A0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITETO_1_OFFSET UNITYSDK_OFFSET(0x1ABC8540)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITETO_OFFSET UNITYSDK_OFFSET(0x1ABC84A0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_WRITE_OFFSET UNITYSDK_OFFSET(0x1ABC8AD0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC8290)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITDECLARATIONS_B__38_0_OFFSET UNITYSDK_OFFSET(0x1ABCCEA0)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITLISTINIT_B__58_0_OFFSET UNITYSDK_OFFSET(0x1ABCCF60)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITMEMBERINIT_B__62_0_OFFSET UNITYSDK_OFFSET(0x1ABCCF90)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITMEMBERLISTBINDING_B__60_0_OFFSET UNITYSDK_OFFSET(0x1ABCCF70)
#define SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER__VISITMEMBERMEMBERBINDING_B__61_0_OFFSET UNITYSDK_OFFSET(0x1ABCCF80)
...
namespace System::Linq::Expressions
{
	...
	public:
		...
		::System::Collections::Generic::Stack_1<::System::Int32>* _stack; // 0x18
		::System::IO::TextWriter* _out; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::LabelTarget*, ::System::Int32>* _labelIds; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::Linq::Expressions::ParameterExpression*, ::System::Int32>* _paramIds; // 0x30
		::System::Collections::Generic::Queue_1<::System::Linq::Expressions::LambdaExpression*>* _lambdas; // 0x38
