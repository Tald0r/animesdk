...
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS_GET_DOCUMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B1AB840)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS_GET_LANGUAGEVENDOR_OFFSET UNITYSDK_OFFSET(0x1B1AB830)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS_GET_LANGUAGE_OFFSET UNITYSDK_OFFSET(0x1B1AB820)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1AB640)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B1AB730)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1AB560)
