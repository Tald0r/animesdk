...
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS_GET_DOCUMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1AB8BAA0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS_GET_LANGUAGEVENDOR_OFFSET UNITYSDK_OFFSET(0x1AB8BA90)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS_GET_LANGUAGE_OFFSET UNITYSDK_OFFSET(0x1AB8BA80)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB8B8A0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB8B990)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTWITHGUIDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB8B7C0)
...
namespace System::Linq::Expressions
{
	...
	public:
		...
		::System::Guid _Language_k__BackingField; // 0x28
