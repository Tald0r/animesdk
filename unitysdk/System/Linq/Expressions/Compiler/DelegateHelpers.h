...
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_GETACTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1B15C250)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_GETFUNCTYPE_OFFSET UNITYSDK_OFFSET(0x1B15C620)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_GETNEXTTYPEINFO_OFFSET UNITYSDK_OFFSET(0x1B15BB60)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_MAKECALLSITEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B15C9F0)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_MAKEDELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x1B15B2C0)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_MAKENEWCUSTOMDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B15C200)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_MAKENEWDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B15B770)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_NEXTTYPEINFO_1_OFFSET UNITYSDK_OFFSET(0x1B15B5A0)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_NEXTTYPEINFO_OFFSET UNITYSDK_OFFSET(0x1B15BA20)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS_TRYMAKEVBSTYLEDCALLSITE_OFFSET UNITYSDK_OFFSET(0x1B15BC90)
#define SYSTEM_LINQ_EXPRESSIONS_COMPILER_DELEGATEHELPERS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B15CC60)
