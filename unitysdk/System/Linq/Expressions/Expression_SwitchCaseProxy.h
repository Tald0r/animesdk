...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHCASEPROXY_GET_BODY_OFFSET UNITYSDK_OFFSET(0x1B351E90)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHCASEPROXY_GET_TESTVALUES_OFFSET UNITYSDK_OFFSET(0x1B351EB0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHCASEPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B351E20)
