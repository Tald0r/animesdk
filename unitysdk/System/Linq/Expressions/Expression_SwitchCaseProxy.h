...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHCASEPROXY_GET_BODY_OFFSET UNITYSDK_OFFSET(0x1AD39000)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHCASEPROXY_GET_TESTVALUES_OFFSET UNITYSDK_OFFSET(0x1AD39020)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_SWITCHCASEPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD38F90)
