...
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO_GET_DOCUMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1ABD5120)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1ABD50F0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO_GET_LANGUAGEVENDOR_OFFSET UNITYSDK_OFFSET(0x1ABD5110)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO_GET_LANGUAGE_OFFSET UNITYSDK_OFFSET(0x1ABD5100)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABD5180)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ABD51D0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABD5080)
