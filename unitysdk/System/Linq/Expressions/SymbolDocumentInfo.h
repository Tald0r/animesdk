...
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO_GET_DOCUMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A607AE0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1A607AB0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO_GET_LANGUAGEVENDOR_OFFSET UNITYSDK_OFFSET(0x1A607AD0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO_GET_LANGUAGE_OFFSET UNITYSDK_OFFSET(0x1A607AC0)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A607B40)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A607B90)
#define SYSTEM_LINQ_EXPRESSIONS_SYMBOLDOCUMENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A607A40)
