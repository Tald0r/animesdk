...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_BODY_OFFSET UNITYSDK_OFFSET(0x1B000570)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1B000590)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_DEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1B0005B0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_FAULT_OFFSET UNITYSDK_OFFSET(0x1B0005D0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_FINALLY_OFFSET UNITYSDK_OFFSET(0x1B0005F0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_HANDLERS_OFFSET UNITYSDK_OFFSET(0x1B000610)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1B000630)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B000640)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYEXPRESSIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B000500)
