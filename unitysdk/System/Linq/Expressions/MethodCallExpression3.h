...
#define SYSTEM_LINQ_EXPRESSIONS_METHODCALLEXPRESSION3_GETARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AD60B30)
#define SYSTEM_LINQ_EXPRESSIONS_METHODCALLEXPRESSION3_GETORMAKEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1AD61230)
#define SYSTEM_LINQ_EXPRESSIONS_METHODCALLEXPRESSION3_GET_ARGUMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1AD60BC0)
#define SYSTEM_LINQ_EXPRESSIONS_METHODCALLEXPRESSION3_REWRITE_OFFSET UNITYSDK_OFFSET(0x1AD61240)
#define SYSTEM_LINQ_EXPRESSIONS_METHODCALLEXPRESSION3_SAMEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1AD60BD0)
#define SYSTEM_LINQ_EXPRESSIONS_METHODCALLEXPRESSION3__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD60AB0)
