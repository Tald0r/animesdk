...
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1B614EE0)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_BODY_OFFSET UNITYSDK_OFFSET(0x1B614EB0)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_BREAKLABEL_OFFSET UNITYSDK_OFFSET(0x1B614EC0)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_CONTINUELABEL_OFFSET UNITYSDK_OFFSET(0x1B614ED0)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1B614EA0)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B614E60)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B614F10)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B614FA0)
#define SYSTEM_LINQ_EXPRESSIONS_LOOPEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B614DF0)
