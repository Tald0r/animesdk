...
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1AAC6640)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x1AAC6630)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1AAC6600)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_NEWEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AAC6620)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1AAC6610)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AAC65C0)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_REDUCELISTINIT_OFFSET UNITYSDK_OFFSET(0x1AAC6B90)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_REDUCEMEMBERBINDING_OFFSET UNITYSDK_OFFSET(0x1AAC6A60)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_REDUCEMEMBERINIT_OFFSET UNITYSDK_OFFSET(0x1AAC6680)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_REDUCE_OFFSET UNITYSDK_OFFSET(0x1AAC6670)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AAC6FD0)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AAC7060)
#define SYSTEM_LINQ_EXPRESSIONS_MEMBERINITEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAC6550)
