...
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1B364680)
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1B364660)
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B364630)
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION_GET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1B364670)
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B3646B0)
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B364740)
#define SYSTEM_LINQ_EXPRESSIONS_RUNTIMEVARIABLESEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3645D0)
