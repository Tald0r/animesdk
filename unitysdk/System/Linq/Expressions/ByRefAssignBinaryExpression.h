...
#define SYSTEM_LINQ_EXPRESSIONS_BYREFASSIGNBINARYEXPRESSION_GET_ISBYREF_OFFSET UNITYSDK_OFFSET(0x1AB1B420)
#define SYSTEM_LINQ_EXPRESSIONS_BYREFASSIGNBINARYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB1B3B0)
