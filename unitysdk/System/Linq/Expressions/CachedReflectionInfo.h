...
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_ADDRULE_OFFSET UNITYSDK_OFFSET(0x1AB7FFF0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_BIND_OFFSET UNITYSDK_OFFSET(0x1AB801F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_CLEARMATCH_OFFSET UNITYSDK_OFFSET(0x1AB7FAF0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_CREATEMATCHMAKER_OFFSET UNITYSDK_OFFSET(0x1AB7F8F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_GETCACHEDRULES_OFFSET UNITYSDK_OFFSET(0x1AB7FEF0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_GETMATCH_OFFSET UNITYSDK_OFFSET(0x1AB7F9F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_GETRULECACHE_OFFSET UNITYSDK_OFFSET(0x1AB7FDF0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_GETRULES_OFFSET UNITYSDK_OFFSET(0x1AB7FCF0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_MOVERULE_OFFSET UNITYSDK_OFFSET(0x1AB800F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_SETNOTMATCHED_OFFSET UNITYSDK_OFFSET(0x1AB7F7F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_UPDATERULES_OFFSET UNITYSDK_OFFSET(0x1AB7FBF0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DATETIME_MINVALUE_OFFSET UNITYSDK_OFFSET(0x1AB81D70)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_CTOR_INT32_INT32_INT32_BOOL_BYTE_OFFSET UNITYSDK_OFFSET(0x1AB81620)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_CTOR_INT32_OFFSET UNITYSDK_OFFSET(0x1AB81060)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_CTOR_INT64_OFFSET UNITYSDK_OFFSET(0x1AB81340)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_CTOR_UINT32_OFFSET UNITYSDK_OFFSET(0x1AB811D0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_CTOR_UINT64_OFFSET UNITYSDK_OFFSET(0x1AB814B0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x1AB81C10)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_MINUSONE_OFFSET UNITYSDK_OFFSET(0x1AB81AB0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_MINVALUE_OFFSET UNITYSDK_OFFSET(0x1AB81B60)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_ONE_OFFSET UNITYSDK_OFFSET(0x1AB81A00)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_BYTE_OFFSET UNITYSDK_OFFSET(0x1AB82CF0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_CHAR_OFFSET UNITYSDK_OFFSET(0x1AB837F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_INT16_OFFSET UNITYSDK_OFFSET(0x1AB82FB0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_INT32_OFFSET UNITYSDK_OFFSET(0x1AB83270)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_INT64_OFFSET UNITYSDK_OFFSET(0x1AB83530)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_SBYTE_OFFSET UNITYSDK_OFFSET(0x1AB82E50)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_UINT16_OFFSET UNITYSDK_OFFSET(0x1AB83110)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_UINT32_OFFSET UNITYSDK_OFFSET(0x1AB833D0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_UINT64_OFFSET UNITYSDK_OFFSET(0x1AB83690)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_ZERO_OFFSET UNITYSDK_OFFSET(0x1AB81CC0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DICTIONARYOFSTRINGINT32_ADD_STRING_INT32_OFFSET UNITYSDK_OFFSET(0x1AB82780)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DICTIONARYOFSTRINGINT32_CTOR_INT32_OFFSET UNITYSDK_OFFSET(0x1AB82980)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1AB80BF0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYCONVERT_OFFSET UNITYSDK_OFFSET(0x1AB808F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AB80DF0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x1AB807F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB804F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYGETINDEX_OFFSET UNITYSDK_OFFSET(0x1AB805F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB802F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB80AF0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB809F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYSETINDEX_OFFSET UNITYSDK_OFFSET(0x1AB806F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB803F0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1AB80CF0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_INVALIDCASTEXCEPTION_CTOR_STRING_OFFSET UNITYSDK_OFFSET(0x1AB7F680)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_MATH_POW_DOUBLE_DOUBLE_OFFSET UNITYSDK_OFFSET(0x1AB83950)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_METHODBASE_GETMETHODFROMHANDLE_RUNTIMEMETHODHANDLE_OFFSET UNITYSDK_OFFSET(0x1AB81E20)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_METHODBASE_GETMETHODFROMHANDLE_RUNTIMEMETHODHANDLE_RUNTIMETYPEHANDLE_OFFSET UNITYSDK_OFFSET(0x1AB81F80)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_METHODINFO_CREATEDELEGATE_TYPE_OBJECT_OFFSET UNITYSDK_OFFSET(0x1AB82180)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_NULLABLE_BOOLEAN_CTOR_OFFSET UNITYSDK_OFFSET(0x1AB80EF0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_OBJECT_GETTYPE_OFFSET UNITYSDK_OFFSET(0x1AB82BF0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_STRING_EQUALS_STRING_STRING_OFFSET UNITYSDK_OFFSET(0x1AB82580)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_STRING_FORMAT_STRING_OBJECTARRAY_OFFSET UNITYSDK_OFFSET(0x1AB7F480)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_STRING_OP_EQUALITY_STRING_STRING_OFFSET UNITYSDK_OFFSET(0x1AB82380)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_TYPE_GETTYPEFROMHANDLE_OFFSET UNITYSDK_OFFSET(0x1AB82AF0)
...
namespace System::Linq::Expressions
{
	...
	public:
		...
		{
			return (::System::Reflection::FieldInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x4350);
		}
		...
		{
			return (::System::Reflection::FieldInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x4378);
		}
		...
		{
			return (::System::Reflection::ConstructorInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x43A8);
		}
		...
		{
			return (::System::Reflection::ConstructorInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x43D8);
		}
		...
		{
			return (::System::Reflection::ConstructorInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x43F0);
		}
		...
		{
			return (::System::Reflection::FieldInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x4420);
		}
		...
		{
			return (::System::Reflection::FieldInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x44B8);
		}
		static ::System::Reflection::FieldInfo** StaticGet_s_Decimal_MinValue()
		{
			return (::System::Reflection::FieldInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x44C0);
		}
		...
		{
			return (::System::Reflection::FieldInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x44D0);
		}
