...
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_ADDRULE_OFFSET UNITYSDK_OFFSET(0x1A5B6400)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_BIND_OFFSET UNITYSDK_OFFSET(0x1A5B6600)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_CLEARMATCH_OFFSET UNITYSDK_OFFSET(0x1A5B5F00)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_CREATEMATCHMAKER_OFFSET UNITYSDK_OFFSET(0x1A5B5D00)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_GETCACHEDRULES_OFFSET UNITYSDK_OFFSET(0x1A5B6300)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_GETMATCH_OFFSET UNITYSDK_OFFSET(0x1A5B5E00)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_GETRULECACHE_OFFSET UNITYSDK_OFFSET(0x1A5B6200)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_GETRULES_OFFSET UNITYSDK_OFFSET(0x1A5B6100)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_MOVERULE_OFFSET UNITYSDK_OFFSET(0x1A5B6500)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_SETNOTMATCHED_OFFSET UNITYSDK_OFFSET(0x1A5B5C00)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_CALLSITEOPS_UPDATERULES_OFFSET UNITYSDK_OFFSET(0x1A5B6000)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DATETIME_MINVALUE_OFFSET UNITYSDK_OFFSET(0x1A5B8180)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_CTOR_INT32_INT32_INT32_BOOL_BYTE_OFFSET UNITYSDK_OFFSET(0x1A5B7A30)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_CTOR_INT32_OFFSET UNITYSDK_OFFSET(0x1A5B7470)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_CTOR_INT64_OFFSET UNITYSDK_OFFSET(0x1A5B7750)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_CTOR_UINT32_OFFSET UNITYSDK_OFFSET(0x1A5B75E0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_CTOR_UINT64_OFFSET UNITYSDK_OFFSET(0x1A5B78C0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x1A5B8020)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_MINUSONE_OFFSET UNITYSDK_OFFSET(0x1A5B7EC0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_MINVALUE_OFFSET UNITYSDK_OFFSET(0x1A5B7F70)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_ONE_OFFSET UNITYSDK_OFFSET(0x1A5B7E10)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_BYTE_OFFSET UNITYSDK_OFFSET(0x1A5B9100)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_CHAR_OFFSET UNITYSDK_OFFSET(0x1A5B9C00)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_INT16_OFFSET UNITYSDK_OFFSET(0x1A5B93C0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_INT32_OFFSET UNITYSDK_OFFSET(0x1A5B9680)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_INT64_OFFSET UNITYSDK_OFFSET(0x1A5B9940)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_SBYTE_OFFSET UNITYSDK_OFFSET(0x1A5B9260)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_UINT16_OFFSET UNITYSDK_OFFSET(0x1A5B9520)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_UINT32_OFFSET UNITYSDK_OFFSET(0x1A5B97E0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_OP_IMPLICIT_UINT64_OFFSET UNITYSDK_OFFSET(0x1A5B9AA0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DECIMAL_ZERO_OFFSET UNITYSDK_OFFSET(0x1A5B80D0)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DICTIONARYOFSTRINGINT32_ADD_STRING_INT32_OFFSET UNITYSDK_OFFSET(0x1A5B8B90)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DICTIONARYOFSTRINGINT32_CTOR_INT32_OFFSET UNITYSDK_OFFSET(0x1A5B8D90)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1A5B7000)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYCONVERT_OFFSET UNITYSDK_OFFSET(0x1A5B6D00)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A5B7200)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x1A5B6C00)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1A5B6900)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYGETINDEX_OFFSET UNITYSDK_OFFSET(0x1A5B6A00)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1A5B6700)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1A5B6F00)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYINVOKE_OFFSET UNITYSDK_OFFSET(0x1A5B6E00)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYSETINDEX_OFFSET UNITYSDK_OFFSET(0x1A5B6B00)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1A5B6800)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_DYNAMICOBJECT_TRYUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1A5B7100)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_INVALIDCASTEXCEPTION_CTOR_STRING_OFFSET UNITYSDK_OFFSET(0x1A5B5A90)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_MATH_POW_DOUBLE_DOUBLE_OFFSET UNITYSDK_OFFSET(0x1A5B9D60)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_METHODBASE_GETMETHODFROMHANDLE_RUNTIMEMETHODHANDLE_OFFSET UNITYSDK_OFFSET(0x1A5B8230)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_METHODBASE_GETMETHODFROMHANDLE_RUNTIMEMETHODHANDLE_RUNTIMETYPEHANDLE_OFFSET UNITYSDK_OFFSET(0x1A5B8390)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_METHODINFO_CREATEDELEGATE_TYPE_OBJECT_OFFSET UNITYSDK_OFFSET(0x1A5B8590)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_NULLABLE_BOOLEAN_CTOR_OFFSET UNITYSDK_OFFSET(0x1A5B7300)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_OBJECT_GETTYPE_OFFSET UNITYSDK_OFFSET(0x1A5B9000)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_STRING_EQUALS_STRING_STRING_OFFSET UNITYSDK_OFFSET(0x1A5B8990)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_STRING_FORMAT_STRING_OBJECTARRAY_OFFSET UNITYSDK_OFFSET(0x1A5B5890)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_STRING_OP_EQUALITY_STRING_STRING_OFFSET UNITYSDK_OFFSET(0x1A5B8790)
#define SYSTEM_LINQ_EXPRESSIONS_CACHEDREFLECTIONINFO_GET_TYPE_GETTYPEFROMHANDLE_OFFSET UNITYSDK_OFFSET(0x1A5B8F00)
...
namespace System::Linq::Expressions
{
	...
	public:
		...
		{
			return (::System::Reflection::ConstructorInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x4330);
		}
		...
		{
			return (::System::Reflection::FieldInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x4348);
		}
		static ::System::Reflection::MethodInfo** StaticGet_s_DynamicObject_TryDeleteIndex()
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x4350);
		}
		...
		{
			return (::System::Reflection::FieldInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x4368);
		}
		...
		{
			return (::System::Reflection::ConstructorInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x4378);
		}
		...
		{
			return (::System::Reflection::FieldInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x43A0);
		}
		...
		{
			return (::System::Reflection::FieldInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x43B8);
		}
		static ::System::Reflection::ConstructorInfo** StaticGet_s_Decimal_Ctor_Int32_Int32_Int32_Bool_Byte()
		{
			return (::System::Reflection::ConstructorInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x43C0);
		}
		...
		{
			return (::System::Reflection::ConstructorInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x43E8);
		}
		...
		{
			return (::System::Reflection::ConstructorInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x4418);
		}
		...
		{
			return (::System::Reflection::ConstructorInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x4430);
		}
		...
		{
			return (::System::Reflection::FieldInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x4488);
		}
		static ::System::Reflection::FieldInfo** StaticGet_s_Decimal_MinValue()
		{
			return (::System::Reflection::FieldInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x4490);
		}
		...
		{
			return (::System::Reflection::ConstructorInfo**)Il2CppClass::FromTypeDefinitionIndex(CachedReflectionInfo_TypeDefinitionIndex)->GetStaticField(0x44A8);
		}
