...
#define SYSTEM_LINQ_EXPRESSIONS_SWITCHEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1A92BE60)
#define SYSTEM_LINQ_EXPRESSIONS_SWITCHEXPRESSION_GET_CASES_OFFSET UNITYSDK_OFFSET(0x1A92BE30)
#define SYSTEM_LINQ_EXPRESSIONS_SWITCHEXPRESSION_GET_COMPARISON_OFFSET UNITYSDK_OFFSET(0x1A92BE50)
#define SYSTEM_LINQ_EXPRESSIONS_SWITCHEXPRESSION_GET_DEFAULTBODY_OFFSET UNITYSDK_OFFSET(0x1A92BE40)
#define SYSTEM_LINQ_EXPRESSIONS_SWITCHEXPRESSION_GET_ISLIFTED_OFFSET UNITYSDK_OFFSET(0x1A92BE90)
#define SYSTEM_LINQ_EXPRESSIONS_SWITCHEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1A92BE10)
#define SYSTEM_LINQ_EXPRESSIONS_SWITCHEXPRESSION_GET_SWITCHVALUE_OFFSET UNITYSDK_OFFSET(0x1A92BE20)
#define SYSTEM_LINQ_EXPRESSIONS_SWITCHEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A92BE00)
#define SYSTEM_LINQ_EXPRESSIONS_SWITCHEXPRESSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A92C070)
#define SYSTEM_LINQ_EXPRESSIONS_SWITCHEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A92C130)
#define SYSTEM_LINQ_EXPRESSIONS_SWITCHEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A92BD80)
...
namespace System::Linq::Expressions
{
	...
	{
	public:
		::System::Reflection::MethodInfo* _Comparison_k__BackingField; // 0x10
