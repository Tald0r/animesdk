...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VALIDATEBINARY_OFFSET UNITYSDK_OFFSET(0x1B1A7430)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VALIDATECHILDTYPE_OFFSET UNITYSDK_OFFSET(0x1B1A8DA0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VALIDATESWITCH_OFFSET UNITYSDK_OFFSET(0x1B1A8070)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VALIDATEUNARY_OFFSET UNITYSDK_OFFSET(0x1B1A8500)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1B1A7350)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITBINARY_OFFSET UNITYSDK_OFFSET(0x1B1A7370)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITBLOCK_OFFSET UNITYSDK_OFFSET(0x1B1A75C0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITCATCHBLOCK_OFFSET UNITYSDK_OFFSET(0x1B1A80F0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITCONDITIONAL_OFFSET UNITYSDK_OFFSET(0x1B1A7680)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITCONSTANT_OFFSET UNITYSDK_OFFSET(0x1B1A7790)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITDEBUGINFO_OFFSET UNITYSDK_OFFSET(0x1B1A77A0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITDEFAULT_OFFSET UNITYSDK_OFFSET(0x1B1A77B0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1B1A8E50)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITELEMENTINIT_OFFSET UNITYSDK_OFFSET(0x1B1A8900)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITEXTENSION_OFFSET UNITYSDK_OFFSET(0x1B1A77C0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITGOTO_OFFSET UNITYSDK_OFFSET(0x1B1A77F0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITINDEX_OFFSET UNITYSDK_OFFSET(0x1B1A7B40)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITINVOCATION_OFFSET UNITYSDK_OFFSET(0x1B1A78B0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITLABELTARGET_OFFSET UNITYSDK_OFFSET(0x1B1A7920)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITLABEL_OFFSET UNITYSDK_OFFSET(0x1B1A7930)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITLISTINIT_OFFSET UNITYSDK_OFFSET(0x1B1A8780)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITLOOP_OFFSET UNITYSDK_OFFSET(0x1B1A79E0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITMEMBERASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1B1A8A50)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITMEMBERBINDING_OFFSET UNITYSDK_OFFSET(0x1B1A8980)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITMEMBERINIT_OFFSET UNITYSDK_OFFSET(0x1B1A8600)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITMEMBERLISTBINDING_OFFSET UNITYSDK_OFFSET(0x1B1A8C40)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITMEMBERMEMBERBINDING_OFFSET UNITYSDK_OFFSET(0x1B1A8AE0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1A7AB0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITMETHODCALL_OFFSET UNITYSDK_OFFSET(0x1B1A7BB0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITNEWARRAY_OFFSET UNITYSDK_OFFSET(0x1B1A7C40)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITNEW_OFFSET UNITYSDK_OFFSET(0x1B1A7C70)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B1A7360)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITPARAMETER_OFFSET UNITYSDK_OFFSET(0x1B1A7CB0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITRUNTIMEVARIABLES_OFFSET UNITYSDK_OFFSET(0x1B1A7CC0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITSWITCHCASE_OFFSET UNITYSDK_OFFSET(0x1B1A7D90)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITSWITCH_OFFSET UNITYSDK_OFFSET(0x1B1A7E50)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITTRY_OFFSET UNITYSDK_OFFSET(0x1B1A8200)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITTYPEBINARY_OFFSET UNITYSDK_OFFSET(0x1B1A83B0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISITUNARY_OFFSET UNITYSDK_OFFSET(0x1B1A8460)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISIT_1_OFFSET UNITYSDK_OFFSET(0x1B1A6EC0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR_VISIT_OFFSET UNITYSDK_OFFSET(0x1B1A6E90)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONVISITOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A6E80)

namespace System::Linq::Expressions
{
	inline static constexpr unsigned int ExpressionVisitor_TypeDefinitionIndex = 4475;
