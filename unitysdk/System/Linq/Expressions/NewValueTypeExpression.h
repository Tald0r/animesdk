...
#define SYSTEM_LINQ_EXPRESSIONS_NEWVALUETYPEEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B33F450)
#define SYSTEM_LINQ_EXPRESSIONS_NEWVALUETYPEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B33F3D0)
