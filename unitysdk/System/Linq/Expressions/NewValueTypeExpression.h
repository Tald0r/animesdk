...
#define SYSTEM_LINQ_EXPRESSIONS_NEWVALUETYPEEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AD24F00)
#define SYSTEM_LINQ_EXPRESSIONS_NEWVALUETYPEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD24E80)
