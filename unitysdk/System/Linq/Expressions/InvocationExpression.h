...
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1B160350)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION_GETARGUMENT_OFFSET UNITYSDK_OFFSET(0x1B1602B0)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION_GETORMAKEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1B160260)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION_GET_ARGUMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1B160300)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1B1601B0)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1B1601A0)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION_GET_LAMBDAOPERAND_OFFSET UNITYSDK_OFFSET(0x1B1603D0)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1B160190)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B160180)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION_REWRITE_OFFSET UNITYSDK_OFFSET(0x1B160380)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B1601C0)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1604D0)
#define SYSTEM_LINQ_EXPRESSIONS_INVOCATIONEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B160110)
