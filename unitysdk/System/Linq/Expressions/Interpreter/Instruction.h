...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GETDEBUGCOOKIE_OFFSET UNITYSDK_OFFSET(0x1B15EB40)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GET_CONSUMEDCONTINUATIONS_OFFSET UNITYSDK_OFFSET(0x1B15EA30)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GET_CONSUMEDSTACK_OFFSET UNITYSDK_OFFSET(0x1B15EA10)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GET_CONTINUATIONSBALANCE_OFFSET UNITYSDK_OFFSET(0x1B15EA90)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GET_PRODUCEDCONTINUATIONS_OFFSET UNITYSDK_OFFSET(0x1B15EA40)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GET_PRODUCEDSTACK_OFFSET UNITYSDK_OFFSET(0x1B15EA20)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_GET_STACKBALANCE_OFFSET UNITYSDK_OFFSET(0x1B15EA50)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_NULLCHECK_OFFSET UNITYSDK_OFFSET(0x1B15EB50)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_TODEBUGSTRING_OFFSET UNITYSDK_OFFSET(0x1B15EB20)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B15EAC0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B15D440)
