...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETER_BOXIFINDEXMATCHES_OFFSET UNITYSDK_OFFSET(0x1B4AB680)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETER_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1B4AB710)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETER_RUN_OFFSET UNITYSDK_OFFSET(0x1B4AB670)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4AB660)
