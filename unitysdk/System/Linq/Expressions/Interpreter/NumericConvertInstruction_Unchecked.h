...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERTDOUBLE_OFFSET UNITYSDK_OFFSET(0x19BF2C40)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERTINT32_OFFSET UNITYSDK_OFFSET(0x19BF2610)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERTINT64_OFFSET UNITYSDK_OFFSET(0x19BF2820)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERTUINT64_OFFSET UNITYSDK_OFFSET(0x19BF2A20)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_CONVERT_OFFSET UNITYSDK_OFFSET(0x19BF2020)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x19BF1FD0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NUMERICCONVERTINSTRUCTION_UNCHECKED__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF2010)
