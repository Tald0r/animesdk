...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_EXCLUSIVEORINSTRUCTION_EXCLUSIVEORSBYTE_RUN_OFFSET UNITYSDK_OFFSET(0x1B36DB20)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_EXCLUSIVEORINSTRUCTION_EXCLUSIVEORSBYTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B36DC90)
