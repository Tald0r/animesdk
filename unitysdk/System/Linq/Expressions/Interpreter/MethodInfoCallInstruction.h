...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_METHODINFOCALLINSTRUCTION_GETARGS_OFFSET UNITYSDK_OFFSET(0x1A2DB430)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_METHODINFOCALLINSTRUCTION_GET_ARGUMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A2DAF90)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_METHODINFOCALLINSTRUCTION_GET_PRODUCEDSTACK_OFFSET UNITYSDK_OFFSET(0x1A2DAFB0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_METHODINFOCALLINSTRUCTION_RUN_OFFSET UNITYSDK_OFFSET(0x1A2DB010)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_METHODINFOCALLINSTRUCTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2DB590)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_METHODINFOCALLINSTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2DAFA0)
