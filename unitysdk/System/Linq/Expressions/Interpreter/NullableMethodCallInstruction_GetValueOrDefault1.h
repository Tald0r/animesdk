...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NULLABLEMETHODCALLINSTRUCTION_GETVALUEORDEFAULT1_GET_CONSUMEDSTACK_OFFSET UNITYSDK_OFFSET(0x19BF0CB0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NULLABLEMETHODCALLINSTRUCTION_GETVALUEORDEFAULT1_RUN_OFFSET UNITYSDK_OFFSET(0x19BF0CC0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_NULLABLEMETHODCALLINSTRUCTION_GETVALUEORDEFAULT1__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF0D40)
