...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_IMMUTABLEREFBOX_GET_INSTRUCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1ABE6600)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_IMMUTABLEREFBOX_RUN_OFFSET UNITYSDK_OFFSET(0x1ABE6520)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INITIALIZELOCALINSTRUCTION_IMMUTABLEREFBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABE6510)
