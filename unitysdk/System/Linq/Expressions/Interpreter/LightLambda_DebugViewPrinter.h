...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_ADDHANDLEREXIT_OFFSET UNITYSDK_OFFSET(0x1A5BC970)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_ADDTRYSTART_OFFSET UNITYSDK_OFFSET(0x1A5BC8D0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_ANALYZE_OFFSET UNITYSDK_OFFSET(0x1A5BC1A0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_DEDENT_OFFSET UNITYSDK_OFFSET(0x1A5BCA20)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_EMITEXITS_OFFSET UNITYSDK_OFFSET(0x1A5BDC90)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_INDENT_OFFSET UNITYSDK_OFFSET(0x1A5BC9E0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A5BCA60)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LIGHTLAMBDA_DEBUGVIEWPRINTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5BC060)
...
namespace System::Linq::Expressions::Interpreter
{
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _handlerExit; // 0x20
