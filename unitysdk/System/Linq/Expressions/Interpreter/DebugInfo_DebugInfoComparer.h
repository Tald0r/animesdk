...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEBUGINFO_DEBUGINFOCOMPARER_SYSTEM_COLLECTIONS_GENERIC_ICOMPARER_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEBUGINFO__COMPARE_OFFSET UNITYSDK_OFFSET(0x1B0A9FD0)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_DEBUGINFO_DEBUGINFOCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0AA010)
