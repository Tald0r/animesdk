...
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONLIST_DEBUGVIEW_INSTRUCTIONVIEW_GETDISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0x992680)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONLIST_DEBUGVIEW_INSTRUCTIONVIEW_GETNAME_OFFSET UNITYSDK_OFFSET(0x992670)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONLIST_DEBUGVIEW_INSTRUCTIONVIEW_GETVALUE_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_INSTRUCTIONLIST_DEBUGVIEW_INSTRUCTIONVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x992690)
