...
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1AA780A0)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_ENDCOLUMN_OFFSET UNITYSDK_OFFSET(0x1AA78080)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_ENDLINE_OFFSET UNITYSDK_OFFSET(0x1AA78070)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_ISCLEAR_OFFSET UNITYSDK_OFFSET(0x1AA78090)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_STARTCOLUMN_OFFSET UNITYSDK_OFFSET(0x1AA78060)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_STARTLINE_OFFSET UNITYSDK_OFFSET(0x1AA78050)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA77FD0)
...
namespace System::Linq::Expressions
{
	...
	{
	public:
		::System::Int32 _endColumn; // 0x18
		::System::Int32 _endLine; // 0x1C
		::System::Int32 _startColumn; // 0x20
