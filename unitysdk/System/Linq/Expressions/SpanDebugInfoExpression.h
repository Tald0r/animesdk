...
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1B0AD510)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_ENDCOLUMN_OFFSET UNITYSDK_OFFSET(0x1B0AD4F0)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_ENDLINE_OFFSET UNITYSDK_OFFSET(0x1B0AD4E0)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_ISCLEAR_OFFSET UNITYSDK_OFFSET(0x1B0AD500)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_STARTCOLUMN_OFFSET UNITYSDK_OFFSET(0x1B0AD4D0)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION_GET_STARTLINE_OFFSET UNITYSDK_OFFSET(0x1B0AD4C0)
#define SYSTEM_LINQ_EXPRESSIONS_SPANDEBUGINFOEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0AD440)
...
namespace System::Linq::Expressions
{
	...
	public:
		...
		::System::Int32 _endLine; // 0x20
		::System::Int32 _endColumn; // 0x24
