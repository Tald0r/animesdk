...
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1B371920)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_BYVALPARAMETERTYPEEQUAL_OFFSET UNITYSDK_OFFSET(0x1B3713E0)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1B370BB0)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1B370BA0)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_GET_TYPEOPERAND_OFFSET UNITYSDK_OFFSET(0x1B370BC0)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B370B70)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_REDUCECONSTANTTYPEEQUAL_OFFSET UNITYSDK_OFFSET(0x1B371290)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_REDUCETYPEEQUAL_OFFSET UNITYSDK_OFFSET(0x1B370BD0)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B371950)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B3719E0)
#define SYSTEM_LINQ_EXPRESSIONS_TYPEBINARYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B370B00)
