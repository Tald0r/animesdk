...
#define SYSTEM_LINQ_EXPRESSIONS_ELEMENTINIT_GETARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AD38E20)
#define SYSTEM_LINQ_EXPRESSIONS_ELEMENTINIT_GET_ADDMETHOD_OFFSET UNITYSDK_OFFSET(0x1AD38E00)
#define SYSTEM_LINQ_EXPRESSIONS_ELEMENTINIT_GET_ARGUMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1AD38E80)
#define SYSTEM_LINQ_EXPRESSIONS_ELEMENTINIT_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1AD38E10)
#define SYSTEM_LINQ_EXPRESSIONS_ELEMENTINIT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AD38ED0)
#define SYSTEM_LINQ_EXPRESSIONS_ELEMENTINIT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AD38EE0)
#define SYSTEM_LINQ_EXPRESSIONS_ELEMENTINIT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD38F50)
#define SYSTEM_LINQ_EXPRESSIONS_ELEMENTINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD38DF0)
