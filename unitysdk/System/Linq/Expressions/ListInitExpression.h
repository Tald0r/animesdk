...
#define SYSTEM_LINQ_EXPRESSIONS_LISTINITEXPRESSION_ACCEPT_OFFSET UNITYSDK_OFFSET(0x1B1605C0)
#define SYSTEM_LINQ_EXPRESSIONS_LISTINITEXPRESSION_GET_CANREDUCE_OFFSET UNITYSDK_OFFSET(0x1B160590)
#define SYSTEM_LINQ_EXPRESSIONS_LISTINITEXPRESSION_GET_INITIALIZERS_OFFSET UNITYSDK_OFFSET(0x1B1605B0)
#define SYSTEM_LINQ_EXPRESSIONS_LISTINITEXPRESSION_GET_NEWEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1B1605A0)
#define SYSTEM_LINQ_EXPRESSIONS_LISTINITEXPRESSION_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1B160580)
#define SYSTEM_LINQ_EXPRESSIONS_LISTINITEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B15CF00)
#define SYSTEM_LINQ_EXPRESSIONS_LISTINITEXPRESSION_REDUCE_OFFSET UNITYSDK_OFFSET(0x1B1605F0)
#define SYSTEM_LINQ_EXPRESSIONS_LISTINITEXPRESSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B160600)
#define SYSTEM_LINQ_EXPRESSIONS_LISTINITEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B160690)
#define SYSTEM_LINQ_EXPRESSIONS_LISTINITEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B160510)
