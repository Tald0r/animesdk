...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_1_OFFSET UNITYSDK_OFFSET(0x1A6013D0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_2_OFFSET UNITYSDK_OFFSET(0x1A6015E0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_3_OFFSET UNITYSDK_OFFSET(0x1A6018D0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_4_OFFSET UNITYSDK_OFFSET(0x1A601C90)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_5_OFFSET UNITYSDK_OFFSET(0x1A6012C0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_OFFSET UNITYSDK_OFFSET(0x1A6011B0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_GETVALIDMETHODFORDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1A601030)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_1_OFFSET UNITYSDK_OFFSET(0x1A5FFBB0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_2_OFFSET UNITYSDK_OFFSET(0x1A600430)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_3_OFFSET UNITYSDK_OFFSET(0x1A600680)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_4_OFFSET UNITYSDK_OFFSET(0x1A600940)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_5_OFFSET UNITYSDK_OFFSET(0x1A600C80)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_6_OFFSET UNITYSDK_OFFSET(0x1A602140)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1A5FFBA0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_VALIDATEDYNAMICARGUMENT_1_OFFSET UNITYSDK_OFFSET(0x1A602410)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_VALIDATEDYNAMICARGUMENT_OFFSET UNITYSDK_OFFSET(0x1A6011A0)
