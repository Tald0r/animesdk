...
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_1_OFFSET UNITYSDK_OFFSET(0x1ABCEA10)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_2_OFFSET UNITYSDK_OFFSET(0x1ABCEC20)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_3_OFFSET UNITYSDK_OFFSET(0x1ABCEF10)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_4_OFFSET UNITYSDK_OFFSET(0x1ABCF2D0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_5_OFFSET UNITYSDK_OFFSET(0x1ABCE900)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_DYNAMIC_OFFSET UNITYSDK_OFFSET(0x1ABCE7F0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_GETVALIDMETHODFORDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1ABCE670)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_1_OFFSET UNITYSDK_OFFSET(0x1ABCD1F0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_2_OFFSET UNITYSDK_OFFSET(0x1ABCDA70)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_3_OFFSET UNITYSDK_OFFSET(0x1ABCDCC0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_4_OFFSET UNITYSDK_OFFSET(0x1ABCDF80)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_5_OFFSET UNITYSDK_OFFSET(0x1ABCE2C0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_6_OFFSET UNITYSDK_OFFSET(0x1ABCF780)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_MAKEDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1ABCD1E0)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_VALIDATEDYNAMICARGUMENT_1_OFFSET UNITYSDK_OFFSET(0x1ABCFA50)
#define SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONEXTENSION_VALIDATEDYNAMICARGUMENT_OFFSET UNITYSDK_OFFSET(0x1ABCE7E0)
