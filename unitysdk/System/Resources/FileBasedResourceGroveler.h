...
#define SYSTEM_RESOURCES_FILEBASEDRESOURCEGROVELER_CREATERESOURCESET_OFFSET UNITYSDK_OFFSET(0x18B20740)
#define SYSTEM_RESOURCES_FILEBASEDRESOURCEGROVELER_FINDRESOURCEFILE_OFFSET UNITYSDK_OFFSET(0x18B205F0)
#define SYSTEM_RESOURCES_FILEBASEDRESOURCEGROVELER_GROVELFORRESOURCESET_OFFSET UNITYSDK_OFFSET(0x18B20270)
#define SYSTEM_RESOURCES_FILEBASEDRESOURCEGROVELER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B20260)
