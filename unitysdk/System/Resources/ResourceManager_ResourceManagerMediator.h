...
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GETRESOURCEFILENAME_OFFSET UNITYSDK_OFFSET(0x194E5000)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_BASENAMEFIELD_OFFSET UNITYSDK_OFFSET(0x194E4FC0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_BASENAME_OFFSET UNITYSDK_OFFSET(0x194E51A0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_CALLINGASSEMBLY_OFFSET UNITYSDK_OFFSET(0x194E5130)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_FALLBACKLOC_OFFSET UNITYSDK_OFFSET(0x194E5110)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_LOCATIONINFO_OFFSET UNITYSDK_OFFSET(0x194E4F80)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_LOOKEDFORSATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x194E5030)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_MAINASSEMBLY_OFFSET UNITYSDK_OFFSET(0x194E5150)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_MODULEDIR_OFFSET UNITYSDK_OFFSET(0x194E4F60)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_NEUTRALRESOURCESCULTURE_OFFSET UNITYSDK_OFFSET(0x194E4FE0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_SATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x194E5070)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_GET_USERRESOURCESET_OFFSET UNITYSDK_OFFSET(0x194E4FA0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_OBTAINSATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x194E50B0)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_SET_LOOKEDFORSATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x194E5050)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR_SET_SATELLITECONTRACTVERSION_OFFSET UNITYSDK_OFFSET(0x194E5090)
#define SYSTEM_RESOURCES_RESOURCEMANAGER_RESOURCEMANAGERMEDIATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x194E4EF0)
