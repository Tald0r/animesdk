...
#define SYSTEM_RESOURCES_RESOURCEFALLBACKMANAGER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x197A47C0)
#define SYSTEM_RESOURCES_RESOURCEFALLBACKMANAGER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x197A4770)
#define SYSTEM_RESOURCES_RESOURCEFALLBACKMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x197A46D0)
