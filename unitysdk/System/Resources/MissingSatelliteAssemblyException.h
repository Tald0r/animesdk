...
#define SYSTEM_RESOURCES_MISSINGSATELLITEASSEMBLYEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1898DA10)
#define SYSTEM_RESOURCES_MISSINGSATELLITEASSEMBLYEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1898DA80)
#define SYSTEM_RESOURCES_MISSINGSATELLITEASSEMBLYEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1898D970)
