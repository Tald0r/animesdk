...
#define SYSTEM_XML_XSDVALIDATINGREADER_ADDATTRIBUTEPSVI_OFFSET UNITYSDK_OFFSET(0x18C880D0)
#define SYSTEM_XML_XSDVALIDATINGREADER_CACHINGCALLBACK_OFFSET UNITYSDK_OFFSET(0x18C886D0)
#define SYSTEM_XML_XSDVALIDATINGREADER_CLEARATTRIBUTESINFO_OFFSET UNITYSDK_OFFSET(0x18C85FF0)
#define SYSTEM_XML_XSDVALIDATINGREADER_CLOSE_OFFSET UNITYSDK_OFFSET(0x18C86070)
#define SYSTEM_XML_XSDVALIDATINGREADER_CREATEDUMMYTEXTNODE_OFFSET UNITYSDK_OFFSET(0x18C865A0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETATTRIBUTEPSVI_1_OFFSET UNITYSDK_OFFSET(0x18C88300)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETATTRIBUTEPSVI_OFFSET UNITYSDK_OFFSET(0x18C853E0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x18C85030)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x18C85230)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C84E20)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETCACHINGREADER_OFFSET UNITYSDK_OFFSET(0x18C87F90)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETDEFAULTATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x18C85100)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C84E90)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETISDEFAULT_OFFSET UNITYSDK_OFFSET(0x18C86740)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETMEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x18C86C90)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETORIGINALATOMICVALUESTRINGOFELEMENT_OFFSET UNITYSDK_OFFSET(0x18C87F10)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETSTRINGVALUE_OFFSET UNITYSDK_OFFSET(0x18C87370)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x18C84E10)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_ATTRIBUTESCHEMAINFO_OFFSET UNITYSDK_OFFSET(0x18C84DF0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x18C84BB0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x18C84B60)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_EOF_OFFSET UNITYSDK_OFFSET(0x18C86040)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x18C84C10)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_ISEMPTYELEMENT_OFFSET UNITYSDK_OFFSET(0x18C84BE0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x18C86E90)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x18C86F70)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x18C84A20)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x18C84A70)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x18C862C0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18C84910)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x18C84870)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x18C84AC0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_QUOTECHAR_OFFSET UNITYSDK_OFFSET(0x18C84C50)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x18C860B0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_SCHEMAINFO_OFFSET UNITYSDK_OFFSET(0x18C84CE0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x18C84670)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x18C84CF0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x18C84B10)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_XMLLANG_OFFSET UNITYSDK_OFFSET(0x18C84CB0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_XMLSPACE_OFFSET UNITYSDK_OFFSET(0x18C84C80)
#define SYSTEM_XML_XSDVALIDATINGREADER_INIT_OFFSET UNITYSDK_OFFSET(0x18C840D0)
#define SYSTEM_XML_XSDVALIDATINGREADER_ISXSDROOT_OFFSET UNITYSDK_OFFSET(0x18C87C90)
#define SYSTEM_XML_XSDVALIDATINGREADER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x18C862D0)
#define SYSTEM_XML_XSDVALIDATINGREADER_MOVETOATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x18C85600)
#define SYSTEM_XML_XSDVALIDATINGREADER_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C85310)
#define SYSTEM_XML_XSDVALIDATINGREADER_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x18C85A70)
#define SYSTEM_XML_XSDVALIDATINGREADER_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C85790)
#define SYSTEM_XML_XSDVALIDATINGREADER_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C85910)
#define SYSTEM_XML_XSDVALIDATINGREADER_PROCESSELEMENTEVENT_OFFSET UNITYSDK_OFFSET(0x18C873A0)
#define SYSTEM_XML_XSDVALIDATINGREADER_PROCESSENDELEMENTEVENT_OFFSET UNITYSDK_OFFSET(0x18C879D0)
#define SYSTEM_XML_XSDVALIDATINGREADER_PROCESSINLINESCHEMA_OFFSET UNITYSDK_OFFSET(0x18C85ED0)
#define SYSTEM_XML_XSDVALIDATINGREADER_PROCESSREADEREVENT_OFFSET UNITYSDK_OFFSET(0x18C85CC0)
#define SYSTEM_XML_XSDVALIDATINGREADER_READAHEADFORMEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x18C88380)
#define SYSTEM_XML_XSDVALIDATINGREADER_READATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x18C86400)
#define SYSTEM_XML_XSDVALIDATINGREADER_READ_OFFSET UNITYSDK_OFFSET(0x18C85AD0)
#define SYSTEM_XML_XSDVALIDATINGREADER_RESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x18C863B0)
#define SYSTEM_XML_XSDVALIDATINGREADER_SETUPVALIDATOR_OFFSET UNITYSDK_OFFSET(0x18C84310)
#define SYSTEM_XML_XSDVALIDATINGREADER_SKIP_OFFSET UNITYSDK_OFFSET(0x18C860F0)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x18C87050)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x18C87150)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x18C87260)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x18C866A0)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_ISNIL_OFFSET UNITYSDK_OFFSET(0x18C86B10)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_MEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x18C86C00)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_SCHEMAATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C86E50)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_SCHEMAELEMENT_OFFSET UNITYSDK_OFFSET(0x18C86E00)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_SCHEMATYPE_OFFSET UNITYSDK_OFFSET(0x18C86DA0)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_VALIDITY_OFFSET UNITYSDK_OFFSET(0x18C86B50)
#define SYSTEM_XML_XSDVALIDATINGREADER_VALIDATEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18C87CB0)
#define SYSTEM_XML_XSDVALIDATINGREADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18C84650)
#define SYSTEM_XML_XSDVALIDATINGREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C83F20)
...
namespace System::Xml
{
	...
	public:
		...
		::System::String* NsXmlNs; // 0x10
		::System::String* XsdSchema; // 0x18
		::System::Xml::Schema::ValidationEventHandler* validationEvent; // 0x20
		::System::Xml::ValidatingReaderNodeData* textNode; // 0x28
		::System::Xml::Schema::XmlSchemaValidator* validator; // 0x30
		::Il2CppArray<::System::Xml::AttributePSVIInfo*>* attributePSVINodes; // 0x38
		::System::String* XsiNil; // 0x40
		::System::Xml::IXmlNamespaceResolver* thisNSResolver; // 0x48
		::System::Xml::IXmlNamespaceResolver* coreReaderNSResolver; // 0x50
		::System::Xml::XmlNameTable* coreReaderNameTable; // 0x58
		::System::String* XsiType; // 0x60
		::System::String* XsiNoNamespaceSchemaLocation; // 0x68
		::System::Xml::XmlReader* coreReader; // 0x70
		::System::String* NsXs; // 0x78
		::System::Xml::ValidatingReaderNodeData* cachedNode; // 0x80
		::System::String* NsXsi; // 0x88
		::System::Xml::ReadContentAsBinaryHelper* readBinaryHelper; // 0x90
		::System::Xml::Schema::Parser* inlineSchemaParser; // 0x98
		::System::Xml::AttributePSVIInfo* attributePSVI; // 0xA0
		::System::String* originalAtomicValueString; // 0xA8
		::System::Xml::IXmlLineInfo* lineInfo; // 0xB0
		::System::Xml::XmlNamespaceManager* nsManager; // 0xB8
		::System::Collections::ArrayList* defaultAttributes; // 0xC0
		::System::Xml::XmlResolver* xmlResolver; // 0xC8
		::System::Xml::XmlCharType xmlCharType; // 0xD0
		::System::Xml::Schema::XmlSchemaInfo* xmlSchemaInfo; // 0xD8
		::System::String* XsiSchemaLocation; // 0xE0
		::System::Xml::XsdCachingReader* cachingReader; // 0xE8
		::System::Xml::Schema::XmlValueGetter* valueGetter; // 0xF0
		::System::Object* atomicValue; // 0xF8
		::System::Xml::XsdValidatingReader_ValidatingReaderState savedState; // 0x100
		::System::Boolean processInlineSchema; // 0x104
		::System::Boolean replayCache; // 0x105
		...
		::System::Int32 attributeCount; // 0x110
		::System::Int32 currentAttrIndex; // 0x114
