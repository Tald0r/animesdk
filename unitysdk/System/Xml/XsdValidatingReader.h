...
#define SYSTEM_XML_XSDVALIDATINGREADER_ADDATTRIBUTEPSVI_OFFSET UNITYSDK_OFFSET(0x19149720)
#define SYSTEM_XML_XSDVALIDATINGREADER_CACHINGCALLBACK_OFFSET UNITYSDK_OFFSET(0x19149D00)
#define SYSTEM_XML_XSDVALIDATINGREADER_CLEARATTRIBUTESINFO_OFFSET UNITYSDK_OFFSET(0x19147680)
#define SYSTEM_XML_XSDVALIDATINGREADER_CLOSE_OFFSET UNITYSDK_OFFSET(0x19147700)
#define SYSTEM_XML_XSDVALIDATINGREADER_CREATEDUMMYTEXTNODE_OFFSET UNITYSDK_OFFSET(0x19147C40)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETATTRIBUTEPSVI_1_OFFSET UNITYSDK_OFFSET(0x19149960)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETATTRIBUTEPSVI_OFFSET UNITYSDK_OFFSET(0x19146A80)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x191466E0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x191468E0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x191464D0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETCACHINGREADER_OFFSET UNITYSDK_OFFSET(0x191495F0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETDEFAULTATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x191467B0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19146540)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETISDEFAULT_OFFSET UNITYSDK_OFFSET(0x19147DE0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETMEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x19148310)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETORIGINALATOMICVALUESTRINGOFELEMENT_OFFSET UNITYSDK_OFFSET(0x19149570)
#define SYSTEM_XML_XSDVALIDATINGREADER_GETSTRINGVALUE_OFFSET UNITYSDK_OFFSET(0x191489E0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x191464C0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_ATTRIBUTESCHEMAINFO_OFFSET UNITYSDK_OFFSET(0x191464A0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x19146260)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x19146210)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_EOF_OFFSET UNITYSDK_OFFSET(0x191476D0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x191462C0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_ISEMPTYELEMENT_OFFSET UNITYSDK_OFFSET(0x19146290)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x19148500)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x191485E0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x191460D0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x19146120)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x19147950)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19145FD0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x19145F30)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x19146170)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_QUOTECHAR_OFFSET UNITYSDK_OFFSET(0x19146300)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x19147740)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_SCHEMAINFO_OFFSET UNITYSDK_OFFSET(0x19146390)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x19145D20)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x191463A0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x191461C0)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_XMLLANG_OFFSET UNITYSDK_OFFSET(0x19146360)
#define SYSTEM_XML_XSDVALIDATINGREADER_GET_XMLSPACE_OFFSET UNITYSDK_OFFSET(0x19146330)
#define SYSTEM_XML_XSDVALIDATINGREADER_INIT_OFFSET UNITYSDK_OFFSET(0x19145770)
#define SYSTEM_XML_XSDVALIDATINGREADER_ISXSDROOT_OFFSET UNITYSDK_OFFSET(0x191492F0)
#define SYSTEM_XML_XSDVALIDATINGREADER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x19147960)
#define SYSTEM_XML_XSDVALIDATINGREADER_MOVETOATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x19146CB0)
#define SYSTEM_XML_XSDVALIDATINGREADER_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x191469C0)
#define SYSTEM_XML_XSDVALIDATINGREADER_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x19147110)
#define SYSTEM_XML_XSDVALIDATINGREADER_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19146E40)
#define SYSTEM_XML_XSDVALIDATINGREADER_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19146FB0)
#define SYSTEM_XML_XSDVALIDATINGREADER_PROCESSELEMENTEVENT_OFFSET UNITYSDK_OFFSET(0x19148A10)
#define SYSTEM_XML_XSDVALIDATINGREADER_PROCESSENDELEMENTEVENT_OFFSET UNITYSDK_OFFSET(0x19149040)
#define SYSTEM_XML_XSDVALIDATINGREADER_PROCESSINLINESCHEMA_OFFSET UNITYSDK_OFFSET(0x19147560)
#define SYSTEM_XML_XSDVALIDATINGREADER_PROCESSREADEREVENT_OFFSET UNITYSDK_OFFSET(0x19147350)
#define SYSTEM_XML_XSDVALIDATINGREADER_READAHEADFORMEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x191499E0)
#define SYSTEM_XML_XSDVALIDATINGREADER_READATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x19147AA0)
#define SYSTEM_XML_XSDVALIDATINGREADER_READ_OFFSET UNITYSDK_OFFSET(0x19147160)
#define SYSTEM_XML_XSDVALIDATINGREADER_RESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x19147A50)
#define SYSTEM_XML_XSDVALIDATINGREADER_SETUPVALIDATOR_OFFSET UNITYSDK_OFFSET(0x191459C0)
#define SYSTEM_XML_XSDVALIDATINGREADER_SKIP_OFFSET UNITYSDK_OFFSET(0x19147780)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x191486C0)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x191487C0)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x191488D0)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x19147D50)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_ISNIL_OFFSET UNITYSDK_OFFSET(0x19148190)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_MEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x19148280)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_SCHEMAATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x191484C0)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_SCHEMAELEMENT_OFFSET UNITYSDK_OFFSET(0x19148480)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_SCHEMATYPE_OFFSET UNITYSDK_OFFSET(0x19148420)
#define SYSTEM_XML_XSDVALIDATINGREADER_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_VALIDITY_OFFSET UNITYSDK_OFFSET(0x191481D0)
#define SYSTEM_XML_XSDVALIDATINGREADER_VALIDATEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19149310)
#define SYSTEM_XML_XSDVALIDATINGREADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19145D00)
#define SYSTEM_XML_XSDVALIDATINGREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x191455B0)
...
namespace System::Xml
{
	...
	public:
		...
		::System::Xml::ReadContentAsBinaryHelper* readBinaryHelper; // 0x20
		::System::Object* atomicValue; // 0x28
		::System::String* originalAtomicValueString; // 0x30
		::System::Xml::XmlNamespaceManager* nsManager; // 0x38
		::System::Collections::ArrayList* defaultAttributes; // 0x40
		::System::Xml::XsdCachingReader* cachingReader; // 0x48
		::System::String* NsXs; // 0x50
		::System::Xml::XmlResolver* xmlResolver; // 0x58
		::System::Xml::XmlNameTable* coreReaderNameTable; // 0x60
		::System::Xml::Schema::XmlValueGetter* valueGetter; // 0x68
		::System::Xml::Schema::XmlSchemaInfo* xmlSchemaInfo; // 0x70
		::System::Xml::XmlReader* coreReader; // 0x78
		::System::String* XsdSchema; // 0x80
		::System::String* XsiSchemaLocation; // 0x88
		::System::Xml::Schema::XmlSchemaValidator* validator; // 0x90
		::System::String* NsXsi; // 0x98
		::System::Xml::AttributePSVIInfo* attributePSVI; // 0xA0
		::System::Xml::Schema::ValidationEventHandler* validationEvent; // 0xA8
		::System::String* XsiNil; // 0xB0
		::System::Xml::IXmlNamespaceResolver* thisNSResolver; // 0xB8
		::System::Xml::IXmlNamespaceResolver* coreReaderNSResolver; // 0xC0
		::System::String* XsiType; // 0xC8
		::System::Xml::IXmlLineInfo* lineInfo; // 0xD0
		::System::Xml::XmlCharType xmlCharType; // 0xD8
		::System::String* NsXmlNs; // 0xE0
		::System::Xml::Schema::Parser* inlineSchemaParser; // 0xE8
		::System::Xml::ValidatingReaderNodeData* textNode; // 0xF0
		::Il2CppArray<::System::Xml::AttributePSVIInfo*>* attributePSVINodes; // 0xF8
		::System::Xml::XsdValidatingReader_ValidatingReaderState validationState; // 0x100
		::System::Int32 currentAttrIndex; // 0x104
		::System::Int32 attributeCount; // 0x108
		::System::Int32 coreReaderAttributeCount; // 0x10C
		::System::Boolean processInlineSchema; // 0x110
		::System::Boolean manageNamespaces; // 0x111
		::System::Boolean replayCache; // 0x112
		::System::Xml::XsdValidatingReader_ValidatingReaderState savedState; // 0x114
