...
#define SYSTEM_XML_XMLNODECHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19AD8F10)
#define SYSTEM_XML_XMLNODECHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19AD8F50)
#define SYSTEM_XML_XMLNODECHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19AD8990)
#define SYSTEM_XML_XMLNODECHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD8970)
