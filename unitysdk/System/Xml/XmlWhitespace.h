...
#define SYSTEM_XML_XMLWHITESPACE_CLONENODE_OFFSET UNITYSDK_OFFSET(0x19CBD860)
#define SYSTEM_XML_XMLWHITESPACE_GET_ISTEXT_OFFSET UNITYSDK_OFFSET(0x19CBD900)
#define SYSTEM_XML_XMLWHITESPACE_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x19CBD700)
#define SYSTEM_XML_XMLWHITESPACE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19CBD6E0)
#define SYSTEM_XML_XMLWHITESPACE_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x19CBD720)
#define SYSTEM_XML_XMLWHITESPACE_GET_PARENTNODE_OFFSET UNITYSDK_OFFSET(0x19CBD730)
#define SYSTEM_XML_XMLWHITESPACE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CBD7C0)
#define SYSTEM_XML_XMLWHITESPACE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CBD7E0)
#define SYSTEM_XML_XMLWHITESPACE_WRITECONTENTTO_OFFSET UNITYSDK_OFFSET(0x19CBD8F0)
#define SYSTEM_XML_XMLWHITESPACE_WRITETO_OFFSET UNITYSDK_OFFSET(0x19CBD8B0)
#define SYSTEM_XML_XMLWHITESPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CBD5F0)
