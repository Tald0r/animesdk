...
#define SYSTEM_XML_BINXMLSQLMONEY_TODECIMAL_OFFSET UNITYSDK_OFFSET(0x9546D0)
#define SYSTEM_XML_BINXMLSQLMONEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x954700)
#define SYSTEM_XML_BINXMLSQLMONEY__CTOR_OFFSET UNITYSDK_OFFSET(0x8A10A0)
