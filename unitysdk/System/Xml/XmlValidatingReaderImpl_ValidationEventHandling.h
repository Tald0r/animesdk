...
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATIONEVENTHANDLING_ADDHANDLER_OFFSET UNITYSDK_OFFSET(0x19FBF080)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATIONEVENTHANDLING_SYSTEM_XML_IVALIDATIONEVENTHANDLING_GET_EVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x19FBEF50)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATIONEVENTHANDLING_SYSTEM_XML_IVALIDATIONEVENTHANDLING_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x19FBEF60)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATIONEVENTHANDLING__CTOR_OFFSET UNITYSDK_OFFSET(0x19FBEF40)
