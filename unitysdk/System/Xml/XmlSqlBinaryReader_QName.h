...
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_CHECKPREFIXNS_OFFSET UNITYSDK_OFFSET(0x8808F0)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_CLEAR_OFFSET UNITYSDK_OFFSET(0x8807E0)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_EQUALS_OFFSET UNITYSDK_OFFSET(0x880B80)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x880900)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_GETNSHASHCODE_OFFSET UNITYSDK_OFFSET(0x880A20)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_MATCHNS_OFFSET UNITYSDK_OFFSET(0x880800)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_MATCHPREFIX_OFFSET UNITYSDK_OFFSET(0x880880)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x191443C0)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_SET_OFFSET UNITYSDK_OFFSET(0x30B240)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x880B90)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x30B240)
