...
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_CHECKPREFIXNS_OFFSET UNITYSDK_OFFSET(0x84AF40)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_CLEAR_OFFSET UNITYSDK_OFFSET(0x84AE30)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_EQUALS_OFFSET UNITYSDK_OFFSET(0x84B1D0)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x84AF50)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_GETNSHASHCODE_OFFSET UNITYSDK_OFFSET(0x84B070)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_MATCHNS_OFFSET UNITYSDK_OFFSET(0x84AE50)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_MATCHPREFIX_OFFSET UNITYSDK_OFFSET(0x84AED0)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18C82D10)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_SET_OFFSET UNITYSDK_OFFSET(0x3481C0)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x84B1E0)
#define SYSTEM_XML_XMLSQLBINARYREADER_QNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x3481C0)
