...
#define SYSTEM_XML_UCS4ENCODING2143_GETPREAMBLE_OFFSET UNITYSDK_OFFSET(0x1A4E0A40)
#define SYSTEM_XML_UCS4ENCODING2143_GET_ENCODINGNAME_OFFSET UNITYSDK_OFFSET(0x1A4E0A00)
#define SYSTEM_XML_UCS4ENCODING2143__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E0990)
