...
#define SYSTEM_XML_UCS4DECODER_CONVERT_OFFSET UNITYSDK_OFFSET(0x199A1FE0)
#define SYSTEM_XML_UCS4DECODER_GETCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x199A1D90)
#define SYSTEM_XML_UCS4DECODER_GETCHARS_OFFSET UNITYSDK_OFFSET(0x199A1DB0)
#define SYSTEM_XML_UCS4DECODER_UCS4TOUTF16_OFFSET UNITYSDK_OFFSET(0x199A2320)
#define SYSTEM_XML_UCS4DECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x199A23A0)
