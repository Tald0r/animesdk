...
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONS_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1AA94050)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONS_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1AA94130)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONS_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1AA94210)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA933A0)
