...
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONS_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1A4E1A90)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONS_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A4E1B70)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONS_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1A4E1C50)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E0DE0)
