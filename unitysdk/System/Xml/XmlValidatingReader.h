...
#define SYSTEM_XML_XMLVALIDATINGREADER_GETATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1AC391E0)
#define SYSTEM_XML_XMLVALIDATINGREADER_GETATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x1AC39220)
#define SYSTEM_XML_XMLVALIDATINGREADER_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1AC391A0)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x1AC39160)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x1AC390E0)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1AC390A0)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_EOF_OFFSET UNITYSDK_OFFSET(0x1AC393E0)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_ISEMPTYELEMENT_OFFSET UNITYSDK_OFFSET(0x1AC39120)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1AC38FA0)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_NAMESPACES_OFFSET UNITYSDK_OFFSET(0x1AC39570)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1AC38FE0)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x1AC39470)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1AC38F60)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1AC39020)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1AC39420)
#define SYSTEM_XML_XMLVALIDATINGREADER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AC39060)
#define SYSTEM_XML_XMLVALIDATINGREADER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1AC394B0)
#define SYSTEM_XML_XMLVALIDATINGREADER_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1AC39260)
#define SYSTEM_XML_XMLVALIDATINGREADER_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x1AC39320)
#define SYSTEM_XML_XMLVALIDATINGREADER_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1AC392A0)
#define SYSTEM_XML_XMLVALIDATINGREADER_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1AC392E0)
#define SYSTEM_XML_XMLVALIDATINGREADER_READATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1AC39360)
#define SYSTEM_XML_XMLVALIDATINGREADER_READ_OFFSET UNITYSDK_OFFSET(0x1AC393C0)
#define SYSTEM_XML_XMLVALIDATINGREADER_RESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1AC39520)
