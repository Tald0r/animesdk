...
#define SYSTEM_XML_XMLLINKEDNODE_GET_NEXTSIBLING_OFFSET UNITYSDK_OFFSET(0x1A428C30)
#define SYSTEM_XML_XMLLINKEDNODE_GET_PREVIOUSSIBLING_OFFSET UNITYSDK_OFFSET(0x1A428BD0)
#define SYSTEM_XML_XMLLINKEDNODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A428410)
#define SYSTEM_XML_XMLLINKEDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A428BC0)
