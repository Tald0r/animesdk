...
#define SYSTEM_XML_XPATH_XPATHEXCEPTION_CREATEMESSAGE_OFFSET UNITYSDK_OFFSET(0x19140EF0)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION_CREATE_1_OFFSET UNITYSDK_OFFSET(0x19141580)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION_CREATE_2_OFFSET UNITYSDK_OFFSET(0x19141690)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION_CREATE_OFFSET UNITYSDK_OFFSET(0x19141420)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x19141040)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x191417C0)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191411C0)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191412A0)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x191414E0)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19141380)
#define SYSTEM_XML_XPATH_XPATHEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19140CA0)
