...
#define SYSTEM_XML_SCHEMA_LEAFRANGENODE_EXPANDTREE_OFFSET UNITYSDK_OFFSET(0x1A6A82C0)
#define SYSTEM_XML_SCHEMA_LEAFRANGENODE_GET_ISRANGENODE_OFFSET UNITYSDK_OFFSET(0x1A6A82B0)
#define SYSTEM_XML_SCHEMA_LEAFRANGENODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6A8290)
#define SYSTEM_XML_SCHEMA_LEAFRANGENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6A8250)
