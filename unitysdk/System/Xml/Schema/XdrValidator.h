...
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_ADDID_OFFSET UNITYSDK_OFFSET(0x1A372A60)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_CHECKDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1A372DE0)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_CHECKFORWARDREFS_OFFSET UNITYSDK_OFFSET(0x1A372BC0)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_CHECKVALUE_OFFSET UNITYSDK_OFFSET(0x1A371620)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A372AF0)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_FINDID_OFFSET UNITYSDK_OFFSET(0x1A372A40)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_GET_HASSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A372720)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_GET_ISINLINESCHEMASTARTED_OFFSET UNITYSDK_OFFSET(0x1A36FD30)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_GET_PRESERVEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A372740)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_INIT_OFFSET UNITYSDK_OFFSET(0x1A36F8A0)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_LOADSCHEMAFROMLOCATION_OFFSET UNITYSDK_OFFSET(0x1A371FE0)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_LOADSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A371CB0)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_POP_OFFSET UNITYSDK_OFFSET(0x1A371BF0)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_PROCESSELEMENT_OFFSET UNITYSDK_OFFSET(0x1A370660)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_PROCESSINLINESCHEMA_OFFSET UNITYSDK_OFFSET(0x1A36FD40)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_PROCESSTOKENIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x1A372790)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_PUSH_OFFSET UNITYSDK_OFFSET(0x1A36FB40)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_QUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1A371F20)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_THOROUGHGETELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x1A370730)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_VALIDATECHILDELEMENT_OFFSET UNITYSDK_OFFSET(0x1A370480)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_VALIDATEELEMENT_OFFSET UNITYSDK_OFFSET(0x1A36FF70)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_VALIDATEENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1A370230)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_VALIDATEENDSTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1A371340)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_VALIDATESTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1A370C60)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A36FC60)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A36FAB0)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A36CD20)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::XmlNamespaceManager* nsManager; // 0xA8
