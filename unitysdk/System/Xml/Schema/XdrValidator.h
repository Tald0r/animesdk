...
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_ADDID_OFFSET UNITYSDK_OFFSET(0x1A936470)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_CHECKDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1A9368D0)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_CHECKFORWARDREFS_OFFSET UNITYSDK_OFFSET(0x1A9366B0)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_CHECKVALUE_OFFSET UNITYSDK_OFFSET(0x1A935020)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A936500)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_FINDID_OFFSET UNITYSDK_OFFSET(0x1A936450)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_GET_HASSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A936130)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_GET_ISINLINESCHEMASTARTED_OFFSET UNITYSDK_OFFSET(0x1A933720)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_GET_PRESERVEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A936150)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_INIT_OFFSET UNITYSDK_OFFSET(0x1A933280)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_LOADSCHEMAFROMLOCATION_OFFSET UNITYSDK_OFFSET(0x1A9359F0)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_LOADSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A9356C0)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_POP_OFFSET UNITYSDK_OFFSET(0x1A935600)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_PROCESSELEMENT_OFFSET UNITYSDK_OFFSET(0x1A934050)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_PROCESSINLINESCHEMA_OFFSET UNITYSDK_OFFSET(0x1A933730)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_PROCESSTOKENIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x1A9361A0)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_PUSH_OFFSET UNITYSDK_OFFSET(0x1A933520)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_QUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1A935930)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_THOROUGHGETELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x1A934120)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_VALIDATECHILDELEMENT_OFFSET UNITYSDK_OFFSET(0x1A933E70)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_VALIDATEELEMENT_OFFSET UNITYSDK_OFFSET(0x1A933960)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_VALIDATEENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1A933C20)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_VALIDATEENDSTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1A934D40)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_VALIDATESTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1A934650)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A933650)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A933490)
#define SYSTEM_XML_SCHEMA_XDRVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A930730)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::XmlQualifiedName* name; // 0xA0
