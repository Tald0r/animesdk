...
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A9307F0)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_DETECTVALIDATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1A930150)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_FINDID_OFFSET UNITYSDK_OFFSET(0x1A930800)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_GET_PRESERVEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A92FF50)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A92FF60)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A92FEE0)
