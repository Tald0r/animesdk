...
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A36CDE0)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_DETECTVALIDATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1A36C740)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_FINDID_OFFSET UNITYSDK_OFFSET(0x1A36CDF0)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_GET_PRESERVEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A36C540)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A36C550)
#define SYSTEM_XML_SCHEMA_AUTOVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A36C4D0)
