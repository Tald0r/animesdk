...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLETYPEUNION_CLONE_OFFSET UNITYSDK_OFFSET(0x19E643B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLETYPEUNION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E64610)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::Il2CppArray<::System::Xml::XmlQualifiedName*>* memberTypes; // 0x60
