...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLETYPEUNION_CLONE_OFFSET UNITYSDK_OFFSET(0x1A41C640)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLETYPEUNION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A41C8A0)
