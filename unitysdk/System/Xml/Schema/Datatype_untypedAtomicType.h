...
#define SYSTEM_XML_SCHEMA_DATATYPE_UNTYPEDATOMICTYPE_CREATEVALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x1A0329A0)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNTYPEDATOMICTYPE_GET_BUILTINWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x1A032A00)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNTYPEDATOMICTYPE_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1A032A10)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNTYPEDATOMICTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A032A20)
