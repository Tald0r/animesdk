...
#define SYSTEM_XML_SCHEMA_XSDBUILDER_ADDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19A1F6E0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_ADDPARTICLE_OFFSET UNITYSDK_OFFSET(0x19A235B0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDANNOTATED_ID_OFFSET UNITYSDK_OFFSET(0x19A1E810)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDANYATTRIBUTE_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x19A23150)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDANYATTRIBUTE_PROCESSCONTENTS_OFFSET UNITYSDK_OFFSET(0x19A23180)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDANY_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x19A23F30)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDANY_PROCESSCONTENTS_OFFSET UNITYSDK_OFFSET(0x19A23F60)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDAPPINFO_SOURCE_OFFSET UNITYSDK_OFFSET(0x19A25160)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDATTRIBUTEGROUPREF_REF_OFFSET UNITYSDK_OFFSET(0x19A22CF0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDATTRIBUTEGROUP_NAME_OFFSET UNITYSDK_OFFSET(0x19A22C00)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDATTRIBUTE_DEFAULT_OFFSET UNITYSDK_OFFSET(0x19A1FB80)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDATTRIBUTE_FIXED_OFFSET UNITYSDK_OFFSET(0x19A1FBB0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDATTRIBUTE_FORM_OFFSET UNITYSDK_OFFSET(0x19A1FBE0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDATTRIBUTE_NAME_OFFSET UNITYSDK_OFFSET(0x19A1FEB0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDATTRIBUTE_REF_OFFSET UNITYSDK_OFFSET(0x19A1FD00)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDATTRIBUTE_TYPE_OFFSET UNITYSDK_OFFSET(0x19A1FEE0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDATTRIBUTE_USE_OFFSET UNITYSDK_OFFSET(0x19A1FC70)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDCOMPLEXCONTENTEXTENSION_BASE_OFFSET UNITYSDK_OFFSET(0x19A22410)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDCOMPLEXCONTENTRESTRICTION_BASE_OFFSET UNITYSDK_OFFSET(0x19A22540)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDCOMPLEXCONTENT_MIXED_OFFSET UNITYSDK_OFFSET(0x19A22250)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDCOMPLEXTYPE_ABSTRACT_OFFSET UNITYSDK_OFFSET(0x19A21D90)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDCOMPLEXTYPE_BLOCK_OFFSET UNITYSDK_OFFSET(0x19A21E90)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDCOMPLEXTYPE_FINAL_OFFSET UNITYSDK_OFFSET(0x19A21F00)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDCOMPLEXTYPE_MIXED_OFFSET UNITYSDK_OFFSET(0x19A21F70)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDCOMPLEXTYPE_NAME_OFFSET UNITYSDK_OFFSET(0x19A220A0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDDOCUMENTATION_SOURCE_OFFSET UNITYSDK_OFFSET(0x19A25350)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDDOCUMENTATION_XMLLANG_OFFSET UNITYSDK_OFFSET(0x19A253C0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDELEMENT_ABSTRACT_OFFSET UNITYSDK_OFFSET(0x19A201E0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDELEMENT_BLOCK_OFFSET UNITYSDK_OFFSET(0x19A20390)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDELEMENT_DEFAULT_OFFSET UNITYSDK_OFFSET(0x19A20400)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDELEMENT_FINAL_OFFSET UNITYSDK_OFFSET(0x19A205A0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDELEMENT_FIXED_OFFSET UNITYSDK_OFFSET(0x19A20610)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDELEMENT_FORM_OFFSET UNITYSDK_OFFSET(0x19A20430)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDELEMENT_MAXOCCURS_OFFSET UNITYSDK_OFFSET(0x19A20640)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDELEMENT_MINOCCURS_OFFSET UNITYSDK_OFFSET(0x19A20770)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDELEMENT_NAME_OFFSET UNITYSDK_OFFSET(0x19A208A0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDELEMENT_NILLABLE_OFFSET UNITYSDK_OFFSET(0x19A208D0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDELEMENT_REF_OFFSET UNITYSDK_OFFSET(0x19A209F0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDELEMENT_SUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x19A204C0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDELEMENT_TYPE_OFFSET UNITYSDK_OFFSET(0x19A20AA0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDFACET_FIXED_OFFSET UNITYSDK_OFFSET(0x19A245C0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDFACET_VALUE_OFFSET UNITYSDK_OFFSET(0x19A246C0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDFIELD_XPATH_OFFSET UNITYSDK_OFFSET(0x19A24D70)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDGROUPREF_REF_OFFSET UNITYSDK_OFFSET(0x19A23C20)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDGROUP_NAME_OFFSET UNITYSDK_OFFSET(0x19A23440)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDIDENTITYCONSTRAINT_NAME_OFFSET UNITYSDK_OFFSET(0x19A249B0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDIDENTITYCONSTRAINT_REFER_OFFSET UNITYSDK_OFFSET(0x19A249E0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDIMPORT_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x19A1F2C0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDIMPORT_SCHEMALOCATION_OFFSET UNITYSDK_OFFSET(0x19A1F2F0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDINCLUDE_SCHEMALOCATION_OFFSET UNITYSDK_OFFSET(0x19A1F150)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDNOTATION_NAME_OFFSET UNITYSDK_OFFSET(0x19A24180)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDNOTATION_PUBLIC_OFFSET UNITYSDK_OFFSET(0x19A241B0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDNOTATION_SYSTEM_OFFSET UNITYSDK_OFFSET(0x19A241E0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDPARTICLE_MAXOCCURS_OFFSET UNITYSDK_OFFSET(0x19A23AE0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDPARTICLE_MINOCCURS_OFFSET UNITYSDK_OFFSET(0x19A23B80)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDREDEFINE_SCHEMALOCATION_OFFSET UNITYSDK_OFFSET(0x19A1F460)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSCHEMA_ATTRIBUTEFORMDEFAULT_OFFSET UNITYSDK_OFFSET(0x19A1E850)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSCHEMA_BLOCKDEFAULT_OFFSET UNITYSDK_OFFSET(0x19A1EF70)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSCHEMA_ELEMENTFORMDEFAULT_OFFSET UNITYSDK_OFFSET(0x19A1EA10)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSCHEMA_FINALDEFAULT_OFFSET UNITYSDK_OFFSET(0x19A1EB00)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSCHEMA_TARGETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x19A1EAA0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSCHEMA_VERSION_OFFSET UNITYSDK_OFFSET(0x19A1EAD0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSELECTOR_XPATH_OFFSET UNITYSDK_OFFSET(0x19A24BE0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSIMPLECONTENTEXTENSION_BASE_OFFSET UNITYSDK_OFFSET(0x19A22820)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSIMPLECONTENTRESTRICTION_BASE_OFFSET UNITYSDK_OFFSET(0x19A22980)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSIMPLETYPELIST_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x19A21720)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSIMPLETYPERESTRICTION_BASE_OFFSET UNITYSDK_OFFSET(0x19A218B0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSIMPLETYPEUNION_MEMBERTYPES_OFFSET UNITYSDK_OFFSET(0x19A21410)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSIMPLETYPE_FINAL_OFFSET UNITYSDK_OFFSET(0x19A21270)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_BUILDSIMPLETYPE_NAME_OFFSET UNITYSDK_OFFSET(0x19A21240)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_ENDAPPINFO_OFFSET UNITYSDK_OFFSET(0x19A251E0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_ENDCHILDREN_OFFSET UNITYSDK_OFFSET(0x19A1DB00)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_ENDDOCUMENTATION_OFFSET UNITYSDK_OFFSET(0x19A25520)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_ENDREDEFINE_OFFSET UNITYSDK_OFFSET(0x19A1F490)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_GETCONTAINER_OFFSET UNITYSDK_OFFSET(0x19A1DC40)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_GETNEXTSTATE_OFFSET UNITYSDK_OFFSET(0x19A1CA10)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_GET_CURRENTELEMENT_OFFSET UNITYSDK_OFFSET(0x19A1E700)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_GET_PARENTCONTAINER_OFFSET UNITYSDK_OFFSET(0x19A1E790)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_GET_PARENTELEMENT_OFFSET UNITYSDK_OFFSET(0x19A1E720)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITALL_OFFSET UNITYSDK_OFFSET(0x19A23CD0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITANNOTATION_OFFSET UNITYSDK_OFFSET(0x19A24DA0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITANYATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19A22DA0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITANY_OFFSET UNITYSDK_OFFSET(0x19A23E20)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITAPPINFO_OFFSET UNITYSDK_OFFSET(0x19A25020)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITATTRIBUTEGROUPREF_OFFSET UNITYSDK_OFFSET(0x19A22C30)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x19A22A30)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19A1F4B0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITCHOICE_OFFSET UNITYSDK_OFFSET(0x19A23D40)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITCOMPLEXCONTENTEXTENSION_OFFSET UNITYSDK_OFFSET(0x19A22360)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITCOMPLEXCONTENTRESTRICTION_OFFSET UNITYSDK_OFFSET(0x19A224C0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITCOMPLEXCONTENT_OFFSET UNITYSDK_OFFSET(0x19A220D0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x19A21960)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITDOCUMENTATION_OFFSET UNITYSDK_OFFSET(0x19A25210)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITELEMENT_OFFSET UNITYSDK_OFFSET(0x19A1FF90)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITFACET_OFFSET UNITYSDK_OFFSET(0x19A24210)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITFIELD_OFFSET UNITYSDK_OFFSET(0x19A24C10)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITGROUPREF_OFFSET UNITYSDK_OFFSET(0x19A23470)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITGROUP_OFFSET UNITYSDK_OFFSET(0x19A23210)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITIDENTITYCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x19A246F0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITIMPORT_OFFSET UNITYSDK_OFFSET(0x19A1F180)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITINCLUDE_OFFSET UNITYSDK_OFFSET(0x19A1F010)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITNOTATION_OFFSET UNITYSDK_OFFSET(0x19A23FF0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITREDEFINE_OFFSET UNITYSDK_OFFSET(0x19A1F320)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITSCHEMA_OFFSET UNITYSDK_OFFSET(0x19A1EFE0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITSELECTOR_OFFSET UNITYSDK_OFFSET(0x19A24B40)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITSEQUENCE_OFFSET UNITYSDK_OFFSET(0x19A23DB0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITSIMPLECONTENTEXTENSION_OFFSET UNITYSDK_OFFSET(0x19A22770)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITSIMPLECONTENTRESTRICTION_OFFSET UNITYSDK_OFFSET(0x19A228D0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITSIMPLECONTENT_OFFSET UNITYSDK_OFFSET(0x19A225F0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITSIMPLETYPELIST_OFFSET UNITYSDK_OFFSET(0x19A21610)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITSIMPLETYPERESTRICTION_OFFSET UNITYSDK_OFFSET(0x19A21800)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITSIMPLETYPEUNION_OFFSET UNITYSDK_OFFSET(0x19A212E0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_INITSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x19A20B50)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_ISCONTENTPARSED_OFFSET UNITYSDK_OFFSET(0x19A1D8B0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_ISSKIPABLEELEMENT_OFFSET UNITYSDK_OFFSET(0x19A1D030)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_PARSEBLOCKFINALENUM_OFFSET UNITYSDK_OFFSET(0x19A1EB70)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_PARSEBOOLEAN_OFFSET UNITYSDK_OFFSET(0x19A202D0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_PARSEENUM_OFFSET UNITYSDK_OFFSET(0x19A1E8E0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_PARSEQNAME_OFFSET UNITYSDK_OFFSET(0x19A1FDB0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_PARSEURIREFERENCE_OFFSET UNITYSDK_OFFSET(0x19A251D0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_POP_OFFSET UNITYSDK_OFFSET(0x19A1DB40)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_PROCESSATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19A1D150)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_PROCESSCDATA_OFFSET UNITYSDK_OFFSET(0x19A1D8E0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_PROCESSELEMENT_OFFSET UNITYSDK_OFFSET(0x19A1C8D0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_PROCESSMARKUP_OFFSET UNITYSDK_OFFSET(0x19A1D8D0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_PUSH_OFFSET UNITYSDK_OFFSET(0x19A1CC30)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_RECORDPOSITION_OFFSET UNITYSDK_OFFSET(0x19A1CEF0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_SENDVALIDATIONEVENT_1_OFFSET UNITYSDK_OFFSET(0x19A1D060)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_SENDVALIDATIONEVENT_2_OFFSET UNITYSDK_OFFSET(0x19A1D730)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_SENDVALIDATIONEVENT_3_OFFSET UNITYSDK_OFFSET(0x19A25740)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_SENDVALIDATIONEVENT_4_OFFSET UNITYSDK_OFFSET(0x19A21600)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_SENDVALIDATIONEVENT_OFFSET UNITYSDK_OFFSET(0x19A25550)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_SETCONTAINER_OFFSET UNITYSDK_OFFSET(0x19A1DE70)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_SETMAXOCCURS_OFFSET UNITYSDK_OFFSET(0x19A206E0)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_SETMINOCCURS_OFFSET UNITYSDK_OFFSET(0x19A20810)
#define SYSTEM_XML_SCHEMA_XSDBUILDER_STARTCHILDREN_OFFSET UNITYSDK_OFFSET(0x19A1D920)
#define SYSTEM_XML_SCHEMA_XSDBUILDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A25810)
#define SYSTEM_XML_SCHEMA_XSDBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A1C660)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Xml::Schema::XsdBuilder_XsdEntry*>**)Il2CppClass::FromTypeDefinitionIndex(XsdBuilder_TypeDefinitionIndex)->GetStaticField(0x20C0);
		}
		...
		{
			return (::Il2CppArray<::System::Xml::Schema::XsdBuilder_State>**)Il2CppClass::FromTypeDefinitionIndex(XsdBuilder_TypeDefinitionIndex)->GetStaticField(0x20F8);
		}
		...
		{
			return (::Il2CppArray<::System::Xml::Schema::XsdBuilder_State>**)Il2CppClass::FromTypeDefinitionIndex(XsdBuilder_TypeDefinitionIndex)->GetStaticField(0x2108);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_FormStringValues()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(XsdBuilder_TypeDefinitionIndex)->GetStaticField(0x2110);
		}
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(XsdBuilder_TypeDefinitionIndex)->GetStaticField(0x2128);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_DerivationMethodValues()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(XsdBuilder_TypeDefinitionIndex)->GetStaticField(0x2130);
		}
		...
		{
			return (::Il2CppArray<::System::Xml::Schema::XsdBuilder_XsdAttributeEntry*>**)Il2CppClass::FromTypeDefinitionIndex(XsdBuilder_TypeDefinitionIndex)->GetStaticField(0x2158);
		}
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(XsdBuilder_TypeDefinitionIndex)->GetStaticField(0x21B0);
		}
		...
		::System::Xml::Schema::XmlSchemaElement* element; // 0x10
		::System::Xml::XmlNameTable* nameTable; // 0x18
		::System::Xml::Schema::XmlSchemaSimpleTypeUnion* simpleTypeUnion; // 0x20
		::System::Xml::Schema::SchemaNames* schemaNames; // 0x28
		::System::Xml::Schema::XmlSchemaAll* all; // 0x30
		::System::Xml::Schema::XmlSchemaFacet* facet; // 0x38
		::System::Xml::Schema::XmlSchemaComplexType* complexType; // 0x40
		::System::Xml::XmlReader* reader; // 0x48
		::System::Collections::Stack* containerStack; // 0x50
		::System::Xml::Schema::XmlSchemaAppInfo* appInfo; // 0x58
		::System::Xml::Schema::XmlSchemaInclude* include; // 0x60
		::System::Xml::Schema::XmlSchema* schema; // 0x68
		::System::Collections::ArrayList* unhandledAttributes; // 0x70
		::System::Xml::HWStack* stateHistory; // 0x78
		::System::Xml::Schema::XmlSchemaSimpleType* simpleType; // 0x80
		::System::Xml::Schema::XmlSchemaImport* import; // 0x88
		::System::Xml::Schema::XmlSchemaAttributeGroupRef* attributeGroupRef; // 0x90
		::System::Xml::Schema::XmlSchemaAttribute* attribute; // 0x98
		::System::Xml::Schema::ValidationEventHandler* validationEventHandler; // 0xA0
		::System::Xml::Schema::XmlSchemaIdentityConstraint* identityConstraint; // 0xA8
		::System::Xml::Schema::XmlSchemaNotation* notation; // 0xB0
		::System::Xml::Schema::XmlSchemaDocumentation* documentation; // 0xB8
		::System::Xml::Schema::XmlSchemaSimpleTypeList* simpleTypeList; // 0xC0
		::System::Xml::Schema::XmlSchemaAny* anyElement; // 0xC8
		::System::Xml::Schema::XmlSchemaComplexContentExtension* complexContentExtension; // 0xD0
		::System::Collections::Hashtable* namespaces; // 0xD8
		::System::Xml::Schema::XmlSchemaSimpleContentExtension* simpleContentExtension; // 0xE0
		::System::Xml::Schema::XmlSchemaXPath* xpath; // 0xE8
		::System::Xml::Schema::XmlSchemaGroup* group; // 0xF0
		::System::Xml::Schema::XmlSchemaSequence* sequence; // 0xF8
		::Il2CppArray<::System::Xml::XmlNode*>* markup; // 0x100
		::System::Xml::Schema::XmlSchemaAttributeGroup* attributeGroup; // 0x108
		::System::Xml::Schema::XsdBuilder_XsdEntry* currentEntry; // 0x110
		::System::Xml::Schema::XmlSchemaAnnotation* annotation; // 0x118
		::System::Xml::Schema::XmlSchemaChoice* choice; // 0x120
		::System::Xml::Schema::XmlSchemaGroupRef* groupRef; // 0x128
		::System::Xml::XmlNamespaceManager* namespaceManager; // 0x130
		::System::Xml::Schema::XsdBuilder_XsdEntry* nextEntry; // 0x138
		::System::Xml::Schema::XmlSchemaSimpleContentRestriction* simpleContentRestriction; // 0x140
		::System::Xml::Schema::XmlSchemaComplexContent* complexContent; // 0x148
		::System::Xml::Schema::XmlSchemaObject* xso; // 0x150
		::System::Xml::Schema::XmlSchemaAnyAttribute* anyAttribute; // 0x158
		::System::Xml::Schema::XmlSchemaRedefine* redefine; // 0x160
		::System::Xml::Schema::XmlSchemaComplexContentRestriction* complexContentRestriction; // 0x168
		::System::Xml::Schema::XmlSchemaSimpleContent* simpleContent; // 0x170
		::System::Xml::PositionInfo* positionInfo; // 0x178
		::System::Xml::Schema::XmlSchemaParticle* particle; // 0x180
		::System::Xml::Schema::XmlSchemaSimpleTypeRestriction* simpleTypeRestriction; // 0x188
