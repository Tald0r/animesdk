...
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_BUILDREFNAMESPACES_OFFSET UNITYSDK_OFFSET(0x19EDAFD0)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_BUILDSCHEMALIST_OFFSET UNITYSDK_OFFSET(0x19ED7480)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_CHECKREFINEDATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x19EDEF70)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_CHECKREFINEDCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x19EDF160)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_CHECKREFINEDGROUP_OFFSET UNITYSDK_OFFSET(0x19EDEEE0)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_CHECKREFINEDSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x19EDF3A0)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_CLEANUPREDEFINE_OFFSET UNITYSDK_OFFSET(0x19EDAEB0)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_CLEANUP_OFFSET UNITYSDK_OFFSET(0x19EDAC40)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_COPYINCLUDEDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x19EDB930)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_COUNTGROUPSELFREFERENCE_OFFSET UNITYSDK_OFFSET(0x19EDF4E0)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19ED5D80)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_GETBUILDINSCHEMA_OFFSET UNITYSDK_OFFSET(0x19ED9B00)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_GETCHAMELEONSCHEMA_OFFSET UNITYSDK_OFFSET(0x19ED6420)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_GETINCLUDEDSET_OFFSET UNITYSDK_OFFSET(0x19EDED80)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_GETPARENTSCHEMA_OFFSET UNITYSDK_OFFSET(0x19EDED00)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_GETSCHEMAENTITY_OFFSET UNITYSDK_OFFSET(0x19EDAFA0)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_LOADEXTERNALS_OFFSET UNITYSDK_OFFSET(0x19ED6540)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PARSEURI_OFFSET UNITYSDK_OFFSET(0x19EDB210)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSANNOTATION_1_OFFSET UNITYSDK_OFFSET(0x19EDEC70)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSANNOTATION_OFFSET UNITYSDK_OFFSET(0x19EDB420)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSATTRIBUTECONTENT_OFFSET UNITYSDK_OFFSET(0x19EDFC80)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x19EDD4A0)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19EE0300)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19EDD370)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x19EDD5A0)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSELEMENTCONTENT_OFFSET UNITYSDK_OFFSET(0x19EE0670)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSELEMENT_OFFSET UNITYSDK_OFFSET(0x19EDE5C0)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSGROUP_OFFSET UNITYSDK_OFFSET(0x19EDE850)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSIDENTITYCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x19EE0F00)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSLOCALATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19EDFEA0)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSLOCALELEMENT_OFFSET UNITYSDK_OFFSET(0x19EE0B10)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSNOTATION_OFFSET UNITYSDK_OFFSET(0x19EDEA50)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSPARTICLE_OFFSET UNITYSDK_OFFSET(0x19EE1280)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSREDEFINE_OFFSET UNITYSDK_OFFSET(0x19ED8BE0)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESSSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x19EDDFC0)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x19ED7700)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_RESOLVESCHEMALOCATIONURI_OFFSET UNITYSDK_OFFSET(0x19EDAF50)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_SETPARENT_OFFSET UNITYSDK_OFFSET(0x19EDB400)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_SETSCHEMADEFAULTS_OFFSET UNITYSDK_OFFSET(0x19EDB820)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_VALIDATEIDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19EDB510)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_VALIDATENAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19EDF8A0)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR_VALIDATEQNAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19EE0090)
#define SYSTEM_XML_SCHEMA_PREPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19ED5C40)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Collections::ArrayList* redefinedList; // 0x50
		::System::Collections::Hashtable* processedExternals; // 0x58
		::System::Xml::Schema::XmlSchema* currentSchema; // 0x60
		::System::Xml::XmlReaderSettings* readerSettings; // 0x68
		::System::Collections::SortedList* lockList; // 0x70
		::System::String* NsXsi; // 0x78
		::System::Collections::Hashtable* schemaLocations; // 0x80
		::System::Xml::XmlResolver* xmlResolver; // 0x88
		::System::String* Xmlns; // 0x90
		::System::Xml::Schema::XmlSchema* rootSchemaForRedefine; // 0x98
		::System::Xml::Schema::XmlSchema* rootSchema; // 0xA0
		::System::Collections::Hashtable* chameleonSchemas; // 0xA8
		::System::Xml::Schema::XmlSchemaDerivationMethod finalDefault; // 0xB0
		::System::Xml::Schema::XmlSchemaDerivationMethod blockDefault; // 0xB4
		::System::Xml::Schema::XmlSchemaForm elementFormDefault; // 0xB8
