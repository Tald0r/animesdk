...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLECONTENTRESTRICTION_SET_BASETYPENAME_OFFSET UNITYSDK_OFFSET(0x1A1088F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLECONTENTRESTRICTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A108990)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::XmlSchemaSimpleType* baseType; // 0x68
