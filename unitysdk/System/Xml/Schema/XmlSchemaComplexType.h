...
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLEARCOMPILEDSTATE_OFFSET UNITYSDK_OFFSET(0x1AB59740)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AB58D20)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONEGROUPBASEPARTICLES_OFFSET UNITYSDK_OFFSET(0x1AB59960)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONEPARTICLE_OFFSET UNITYSDK_OFFSET(0x1AB593D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONE_1_OFFSET UNITYSDK_OFFSET(0x1AB582E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CLONE_OFFSET UNITYSDK_OFFSET(0x1AB582D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CONTAINSIDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1AB57E50)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_CREATEANYTYPE_OFFSET UNITYSDK_OFFSET(0x1AB574F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GETRESOLVEDELEMENTFORM_OFFSET UNITYSDK_OFFSET(0x1AB59B00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ANYTYPECONTENTVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1AB57BE0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AB57CB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ATTRIBUTEUSES_OFFSET UNITYSDK_OFFSET(0x1AB57D50)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ISABSTRACT_OFFSET UNITYSDK_OFFSET(0x1AB57C70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1AB57CA0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_GET_LOCALELEMENTS_OFFSET UNITYSDK_OFFSET(0x1AB57DC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_HASATTRIBUTEQNAMEREF_OFFSET UNITYSDK_OFFSET(0x1AB597D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_HASPARTICLEREF_OFFSET UNITYSDK_OFFSET(0x1AB590E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_SET_HASWILDCARD_OFFSET UNITYSDK_OFFSET(0x1AB57E30)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_SET_ISABSTRACT_OFFSET UNITYSDK_OFFSET(0x1AB57C80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE_SET_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1AB57BC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB57190)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB57AD0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::XmlSchemaContentModel* contentModel; // 0x90
		...
		::System::Xml::Schema::XmlSchemaObjectTable* attributeUses; // 0xA8
		::System::Xml::Schema::XmlSchemaParticle* particle; // 0xB0
		::System::Xml::Schema::XmlSchemaObjectCollection* attributes; // 0xB8
		::System::Xml::Schema::XmlSchemaAnyAttribute* anyAttribute; // 0xC0
