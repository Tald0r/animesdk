...
#define SYSTEM_XML_SCHEMA_DOUBLELINKAXIS_CONVERTTREE_OFFSET UNITYSDK_OFFSET(0x1A36E190)
#define SYSTEM_XML_SCHEMA_DOUBLELINKAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A36E130)
