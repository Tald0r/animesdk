...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAIDENTITYCONSTRAINT_GET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19E64080)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAIDENTITYCONSTRAINT_SET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19E64090)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAIDENTITYCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E640A0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::CompiledIdentityConstraint* compiledConstraint; // 0x58
		::System::String* name; // 0x60
		::System::Xml::XmlQualifiedName* qualifiedName; // 0x68
		::System::Xml::Schema::XmlSchemaObjectCollection* fields; // 0x70
