...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAIDENTITYCONSTRAINT_GET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A41C320)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAIDENTITYCONSTRAINT_SET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A41C330)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAIDENTITYCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A41C340)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::CompiledIdentityConstraint* compiledConstraint; // 0x60
		::System::String* name; // 0x68
		::System::Xml::XmlQualifiedName* qualifiedName; // 0x70
