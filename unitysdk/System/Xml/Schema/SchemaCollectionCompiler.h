...
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_BUILDPARTICLECONTENTMODEL_OFFSET UNITYSDK_OFFSET(0x1999F590)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CALCULATEEFFECTIVETOTALRANGE_OFFSET UNITYSDK_OFFSET(0x1999E090)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CALCULATESEQUENCERANGE_OFFSET UNITYSDK_OFFSET(0x1999EE30)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEALL_OFFSET UNITYSDK_OFFSET(0x1999AF70)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZECHOICE_OFFSET UNITYSDK_OFFSET(0x1999B700)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x1999A5E0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEGROUPREF_OFFSET UNITYSDK_OFFSET(0x1999A780)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEPARTICLE_OFFSET UNITYSDK_OFFSET(0x19995440)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZESEQUENCE_OFFSET UNITYSDK_OFFSET(0x1999BFA0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CHECKPARTICLEDERIVATION_OFFSET UNITYSDK_OFFSET(0x19994E70)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CHECKSUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x19994F60)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CHECKUNIONTYPE_OFFSET UNITYSDK_OFFSET(0x19995CF0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x1998F770)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19995200)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19990020)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1998F8C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPELEMENT_OFFSET UNITYSDK_OFFSET(0x1998FD60)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPGROUP_OFFSET UNITYSDK_OFFSET(0x1998F740)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPPARTICLE_OFFSET UNITYSDK_OFFSET(0x199952D0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1998FD40)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUP_1_OFFSET UNITYSDK_OFFSET(0x19990060)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x19989C10)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEANYATTRIBUTEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1999F3F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEANYATTRIBUTEUNION_OFFSET UNITYSDK_OFFSET(0x1999F4C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x19991310)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19994080)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEBASEMEMBERTYPES_OFFSET UNITYSDK_OFFSET(0x199958E0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPEXTYPEELEMENTS_OFFSET UNITYSDK_OFFSET(0x19994DB0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXCONTENTEXTENSION_OFFSET UNITYSDK_OFFSET(0x19996610)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXCONTENTRESTRICTION_OFFSET UNITYSDK_OFFSET(0x19996B80)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXCONTENT_OFFSET UNITYSDK_OFFSET(0x199994A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x19991FD0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECONTENTTYPEPARTICLE_OFFSET UNITYSDK_OFFSET(0x199992C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEELEMENT_OFFSET UNITYSDK_OFFSET(0x199934B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEGROUP_OFFSET UNITYSDK_OFFSET(0x19991260)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEIDENTITYCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x199948D0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILELOCALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19996ED0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEPARTICLEELEMENTS_OFFSET UNITYSDK_OFFSET(0x1999FE30)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESIMPLECONTENTEXTENSION_OFFSET UNITYSDK_OFFSET(0x19995DF0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESIMPLECONTENTRESTRICTION_OFFSET UNITYSDK_OFFSET(0x19996090)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x19992DB0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x19990B00)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILE_OFFSET UNITYSDK_OFFSET(0x1998B250)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x199896A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETANYSCHEMATYPE_OFFSET UNITYSDK_OFFSET(0x19999DE0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x19999F70)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETMAPPINGPARTICLE_OFFSET UNITYSDK_OFFSET(0x1999ED20)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETSCHEMACONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x19999440)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x19995620)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISANYFROMANY_OFFSET UNITYSDK_OFFSET(0x1999CB60)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISELEMENTFROMANY_OFFSET UNITYSDK_OFFSET(0x1999CAF0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISELEMENTFROMELEMENT_OFFSET UNITYSDK_OFFSET(0x1999C820)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISELEMENTFROMGROUPBASE_OFFSET UNITYSDK_OFFSET(0x1999CF20)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISGROUPBASEFROMANY_OFFSET UNITYSDK_OFFSET(0x1999CBB0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISGROUPBASEFROMGROUPBASE_OFFSET UNITYSDK_OFFSET(0x1999D4C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISPARTICLEEMPTIABLE_OFFSET UNITYSDK_OFFSET(0x1999C780)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISSEQUENCEFROMALL_OFFSET UNITYSDK_OFFSET(0x1999D850)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISSEQUENCEFROMCHOICE_OFFSET UNITYSDK_OFFSET(0x1999DC70)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISVALIDOCCURRENCERANGERESTRICTION_1_OFFSET UNITYSDK_OFFSET(0x1999EBF0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISVALIDOCCURRENCERANGERESTRICTION_OFFSET UNITYSDK_OFFSET(0x1999DF40)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISVALIDRESTRICTION_OFFSET UNITYSDK_OFFSET(0x1999A080)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_OUTPUT_OFFSET UNITYSDK_OFFSET(0x1998E190)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_PREPARE_OFFSET UNITYSDK_OFFSET(0x199896F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_PUSHCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x1999F3C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0x19989590)
