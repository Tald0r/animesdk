...
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_BUILDPARTICLECONTENTMODEL_OFFSET UNITYSDK_OFFSET(0x19F73250)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CALCULATEEFFECTIVETOTALRANGE_OFFSET UNITYSDK_OFFSET(0x19F71D50)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CALCULATESEQUENCERANGE_OFFSET UNITYSDK_OFFSET(0x19F72AF0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEALL_OFFSET UNITYSDK_OFFSET(0x19F6EC30)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZECHOICE_OFFSET UNITYSDK_OFFSET(0x19F6F3C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x19F6E290)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEGROUPREF_OFFSET UNITYSDK_OFFSET(0x19F6E440)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZEPARTICLE_OFFSET UNITYSDK_OFFSET(0x19F69110)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CANNONICALIZESEQUENCE_OFFSET UNITYSDK_OFFSET(0x19F6FC60)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CHECKPARTICLEDERIVATION_OFFSET UNITYSDK_OFFSET(0x19F68B40)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CHECKSUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x19F68C30)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CHECKUNIONTYPE_OFFSET UNITYSDK_OFFSET(0x19F699B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x19F63430)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19F68ED0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19F63CC0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x19F63580)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPELEMENT_OFFSET UNITYSDK_OFFSET(0x19F63A20)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPGROUP_OFFSET UNITYSDK_OFFSET(0x19F63400)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPPARTICLE_OFFSET UNITYSDK_OFFSET(0x19F68FA0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUPSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x19F63A00)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUP_1_OFFSET UNITYSDK_OFFSET(0x19F63D00)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x19F5D910)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEANYATTRIBUTEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x19F730B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEANYATTRIBUTEUNION_OFFSET UNITYSDK_OFFSET(0x19F73180)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x19F64FB0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19F67D60)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEBASEMEMBERTYPES_OFFSET UNITYSDK_OFFSET(0x19F695A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPEXTYPEELEMENTS_OFFSET UNITYSDK_OFFSET(0x19F68A80)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXCONTENTEXTENSION_OFFSET UNITYSDK_OFFSET(0x19F6A2D0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXCONTENTRESTRICTION_OFFSET UNITYSDK_OFFSET(0x19F6A840)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXCONTENT_OFFSET UNITYSDK_OFFSET(0x19F6D150)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x19F65CA0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILECONTENTTYPEPARTICLE_OFFSET UNITYSDK_OFFSET(0x19F6CF70)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEELEMENT_OFFSET UNITYSDK_OFFSET(0x19F67180)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEGROUP_OFFSET UNITYSDK_OFFSET(0x19F64F00)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEIDENTITYCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x19F685A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILELOCALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19F6AB90)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILEPARTICLEELEMENTS_OFFSET UNITYSDK_OFFSET(0x19F73AF0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESIMPLECONTENTEXTENSION_OFFSET UNITYSDK_OFFSET(0x19F69AB0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESIMPLECONTENTRESTRICTION_OFFSET UNITYSDK_OFFSET(0x19F69D50)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x19F66A80)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILESUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x19F647A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_COMPILE_OFFSET UNITYSDK_OFFSET(0x19F5EF60)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19F5D3A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETANYSCHEMATYPE_OFFSET UNITYSDK_OFFSET(0x19F6DA90)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x19F6DC20)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETMAPPINGPARTICLE_OFFSET UNITYSDK_OFFSET(0x19F729E0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETSCHEMACONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x19F6D0F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_GETSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x19F692F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISANYFROMANY_OFFSET UNITYSDK_OFFSET(0x19F70820)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISELEMENTFROMANY_OFFSET UNITYSDK_OFFSET(0x19F707B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISELEMENTFROMELEMENT_OFFSET UNITYSDK_OFFSET(0x19F704E0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISELEMENTFROMGROUPBASE_OFFSET UNITYSDK_OFFSET(0x19F70BE0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISGROUPBASEFROMANY_OFFSET UNITYSDK_OFFSET(0x19F70870)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISGROUPBASEFROMGROUPBASE_OFFSET UNITYSDK_OFFSET(0x19F71180)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISPARTICLEEMPTIABLE_OFFSET UNITYSDK_OFFSET(0x19F70440)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISSEQUENCEFROMALL_OFFSET UNITYSDK_OFFSET(0x19F71510)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISSEQUENCEFROMCHOICE_OFFSET UNITYSDK_OFFSET(0x19F71930)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISVALIDOCCURRENCERANGERESTRICTION_1_OFFSET UNITYSDK_OFFSET(0x19F728B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISVALIDOCCURRENCERANGERESTRICTION_OFFSET UNITYSDK_OFFSET(0x19F71C00)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_ISVALIDRESTRICTION_OFFSET UNITYSDK_OFFSET(0x19F6DD30)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_OUTPUT_OFFSET UNITYSDK_OFFSET(0x19F61E80)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_PREPARE_OFFSET UNITYSDK_OFFSET(0x19F5D3F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER_PUSHCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x19F73080)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONCOMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F5D290)
