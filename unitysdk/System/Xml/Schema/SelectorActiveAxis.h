...
#define SYSTEM_XML_SCHEMA_SELECTORACTIVEAXIS_ENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1A932D70)
#define SYSTEM_XML_SCHEMA_SELECTORACTIVEAXIS_GET_LASTDEPTH_OFFSET UNITYSDK_OFFSET(0x1A932C70)
#define SYSTEM_XML_SCHEMA_SELECTORACTIVEAXIS_POPKS_OFFSET UNITYSDK_OFFSET(0x1A9331B0)
#define SYSTEM_XML_SCHEMA_SELECTORACTIVEAXIS_PUSHKS_OFFSET UNITYSDK_OFFSET(0x1A932DA0)
#define SYSTEM_XML_SCHEMA_SELECTORACTIVEAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A932D10)
