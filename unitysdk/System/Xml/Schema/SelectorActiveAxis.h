...
#define SYSTEM_XML_SCHEMA_SELECTORACTIVEAXIS_ENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1A36F390)
#define SYSTEM_XML_SCHEMA_SELECTORACTIVEAXIS_GET_LASTDEPTH_OFFSET UNITYSDK_OFFSET(0x1A36F290)
#define SYSTEM_XML_SCHEMA_SELECTORACTIVEAXIS_POPKS_OFFSET UNITYSDK_OFFSET(0x1A36F7D0)
#define SYSTEM_XML_SCHEMA_SELECTORACTIVEAXIS_PUSHKS_OFFSET UNITYSDK_OFFSET(0x1A36F3C0)
#define SYSTEM_XML_SCHEMA_SELECTORACTIVEAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A36F330)
