...
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER_CHANGETYPEWILDCARDDESTINATION_OFFSET UNITYSDK_OFFSET(0x1A4DE920)
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER_CHANGETYPEWILDCARDSOURCE_OFFSET UNITYSDK_OFFSET(0x1A4DEC80)
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER_CHANGETYPE_1_OFFSET UNITYSDK_OFFSET(0x1A4DED40)
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x1A4DE9C0)
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4DE0E0)
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4DE130)
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4DE0D0)
