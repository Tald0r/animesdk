...
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER_CHANGETYPEWILDCARDDESTINATION_OFFSET UNITYSDK_OFFSET(0x1AA90ED0)
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER_CHANGETYPEWILDCARDSOURCE_OFFSET UNITYSDK_OFFSET(0x1AA91230)
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER_CHANGETYPE_1_OFFSET UNITYSDK_OFFSET(0x1AA912F0)
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x1AA90F70)
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER_CREATE_OFFSET UNITYSDK_OFFSET(0x1AA90690)
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AA906E0)
#define SYSTEM_XML_SCHEMA_XMLMISCCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA90680)
