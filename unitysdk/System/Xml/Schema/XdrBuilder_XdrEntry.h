...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A36F860)
...
namespace System::Xml::Schema
{
	...
	{
	public:
		::System::Xml::Schema::XdrBuilder_XdrEndChildFunction* _EndChildFunc; // 0x10
		::Il2CppArray<::System::Xml::Schema::XdrBuilder_XdrAttributeEntry*>* _Attributes; // 0x18
		::System::Xml::Schema::XdrBuilder_XdrBeginChildFunction* _BeginChildFunc; // 0x20
		::Il2CppArray<::System::Int32>* _NextStates; // 0x28
		::System::Xml::Schema::XdrBuilder_XdrInitFunction* _InitFunc; // 0x30
