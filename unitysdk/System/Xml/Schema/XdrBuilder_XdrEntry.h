...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A933240)
...
namespace System::Xml::Schema
{
	...
	{
	public:
		::Il2CppArray<::System::Int32>* _NextStates; // 0x10
		::System::Xml::Schema::XdrBuilder_XdrEndChildFunction* _EndChildFunc; // 0x18
		::System::Xml::Schema::XdrBuilder_XdrInitFunction* _InitFunc; // 0x20
		::System::Xml::Schema::XdrBuilder_XdrBeginChildFunction* _BeginChildFunc; // 0x28
		::Il2CppArray<::System::Xml::Schema::XdrBuilder_XdrAttributeEntry*>* _Attributes; // 0x30
