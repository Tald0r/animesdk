...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_DECLBASEINFO_RESET_OFFSET UNITYSDK_OFFSET(0x1910A610)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_DECLBASEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1910A560)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::XdrBuilder_DeclBaseInfo* _Next; // 0x30
		::System::String* _TypePrefix; // 0x38
