...
#define SYSTEM_XML_SCHEMA_AXISSTACK_EQUAL_OFFSET UNITYSDK_OFFSET(0x1A6A6B10)
#define SYSTEM_XML_SCHEMA_AXISSTACK_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A6A6A10)
#define SYSTEM_XML_SCHEMA_AXISSTACK_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A6A67D0)
#define SYSTEM_XML_SCHEMA_AXISSTACK_MOVETOCHILD_OFFSET UNITYSDK_OFFSET(0x1A6A6140)
#define SYSTEM_XML_SCHEMA_AXISSTACK_MOVETOPARENT_OFFSET UNITYSDK_OFFSET(0x1A6A64B0)
#define SYSTEM_XML_SCHEMA_AXISSTACK_POP_OFFSET UNITYSDK_OFFSET(0x1A6A6AD0)
#define SYSTEM_XML_SCHEMA_AXISSTACK_PUSH_OFFSET UNITYSDK_OFFSET(0x1A6A6A40)
#define SYSTEM_XML_SCHEMA_AXISSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6A5ED0)
...
namespace System::Xml::Schema
{
	...
	{
	public:
		::System::Xml::Schema::ForwardAxis* subtree; // 0x10
