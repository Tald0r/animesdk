...
#define SYSTEM_XML_SCHEMA_AXISSTACK_EQUAL_OFFSET UNITYSDK_OFFSET(0x1A103ED0)
#define SYSTEM_XML_SCHEMA_AXISSTACK_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A103DD0)
#define SYSTEM_XML_SCHEMA_AXISSTACK_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A103B90)
#define SYSTEM_XML_SCHEMA_AXISSTACK_MOVETOCHILD_OFFSET UNITYSDK_OFFSET(0x1A103500)
#define SYSTEM_XML_SCHEMA_AXISSTACK_MOVETOPARENT_OFFSET UNITYSDK_OFFSET(0x1A103870)
#define SYSTEM_XML_SCHEMA_AXISSTACK_POP_OFFSET UNITYSDK_OFFSET(0x1A103E90)
#define SYSTEM_XML_SCHEMA_AXISSTACK_PUSH_OFFSET UNITYSDK_OFFSET(0x1A103E00)
#define SYSTEM_XML_SCHEMA_AXISSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A103290)
