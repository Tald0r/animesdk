...
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_ALLOWS_1_OFFSET UNITYSDK_OFFSET(0x1947BE10)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_ALLOWS_OFFSET UNITYSDK_OFFSET(0x1947BD80)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_CLONE_OFFSET UNITYSDK_OFFSET(0x1947BB90)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_COMPARESETTOOTHER_OFFSET UNITYSDK_OFFSET(0x1947CD80)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_GET_ENUMERATE_OFFSET UNITYSDK_OFFSET(0x1947BD00)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_INTERSECTION_OFFSET UNITYSDK_OFFSET(0x1947CEA0)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_ISSUBSET_OFFSET UNITYSDK_OFFSET(0x1947C340)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_REMOVENAMESPACE_OFFSET UNITYSDK_OFFSET(0x1947D5A0)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1947BE40)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST_UNION_OFFSET UNITYSDK_OFFSET(0x1947C780)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1947B820)
#define SYSTEM_XML_SCHEMA_NAMESPACELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1947B810)
