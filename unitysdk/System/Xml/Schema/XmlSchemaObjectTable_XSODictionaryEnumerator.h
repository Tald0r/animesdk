...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_XSODICTIONARYENUMERATOR_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x19481420)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_XSODICTIONARYENUMERATOR_GET_KEY_OFFSET UNITYSDK_OFFSET(0x19481570)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_XSODICTIONARYENUMERATOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x194816B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_XSODICTIONARYENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19481400)
