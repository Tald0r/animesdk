...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_XSODICTIONARYENUMERATOR_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x1910E030)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_XSODICTIONARYENUMERATOR_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1910E180)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_XSODICTIONARYENUMERATOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1910E2C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_XSODICTIONARYENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1910E010)
