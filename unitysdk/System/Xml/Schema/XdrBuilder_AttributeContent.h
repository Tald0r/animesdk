...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ATTRIBUTECONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC2F890)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::UInt32 _MaxVal; // 0x38
		::System::UInt32 _MinLength; // 0x3C
