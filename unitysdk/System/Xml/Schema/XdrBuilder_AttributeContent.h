...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ATTRIBUTECONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A684590)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::XmlQualifiedName* _Name; // 0x20
		::System::Object* _Default; // 0x28
		::System::UInt32 _MinVal; // 0x30
		::System::Boolean _Global; // 0x34
		::System::Boolean _Required; // 0x35
		::System::Boolean _EnumerationRequired; // 0x36
		::System::Boolean _HasDataType; // 0x37
		::System::UInt32 _MinLength; // 0x38
		::System::UInt32 _MaxVal; // 0x3C
		::System::UInt32 _MaxLength; // 0x40
