...
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_BUILDREFNAMESPACES_OFFSET UNITYSDK_OFFSET(0x18C73FA0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CHECKREFINEDATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x18C772B0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CHECKREFINEDCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x18C774A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CHECKREFINEDGROUP_OFFSET UNITYSDK_OFFSET(0x18C77230)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CHECKREFINEDSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x18C776E0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CLEANUP_OFFSET UNITYSDK_OFFSET(0x18C6F920)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_COUNTGROUPSELFREFERENCE_OFFSET UNITYSDK_OFFSET(0x18C77820)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x18C6F6C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_GETSCHEMAENTITY_OFFSET UNITYSDK_OFFSET(0x18C73EF0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_LOADEXTERNALS_OFFSET UNITYSDK_OFFSET(0x18C6FD10)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSANNOTATION_OFFSET UNITYSDK_OFFSET(0x18C74200)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSATTRIBUTECONTENT_OFFSET UNITYSDK_OFFSET(0x18C77F90)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x18C75A40)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18C78520)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C75910)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x18C75B30)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSELEMENTCONTENT_OFFSET UNITYSDK_OFFSET(0x18C78820)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSELEMENT_OFFSET UNITYSDK_OFFSET(0x18C76B90)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSGROUP_OFFSET UNITYSDK_OFFSET(0x18C76E20)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSIDENTITYCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x18C791A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSLOCALATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C781D0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSLOCALELEMENT_OFFSET UNITYSDK_OFFSET(0x18C78DB0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSNOTATION_OFFSET UNITYSDK_OFFSET(0x18C77020)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSPARTICLE_OFFSET UNITYSDK_OFFSET(0x18C79530)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSREDEFINE_OFFSET UNITYSDK_OFFSET(0x18C74310)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x18C76540)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x18C70CA0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_RESOLVESCHEMALOCATIONURI_OFFSET UNITYSDK_OFFSET(0x18C73E70)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_SETPARENT_OFFSET UNITYSDK_OFFSET(0x18C741E0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_VALIDATEIDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C70A50)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_VALIDATENAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C77BB0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_VALIDATEQNAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C783C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18C6F620)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Collections::Hashtable* referenceNamespaces; // 0x48
		...
		::System::Xml::Schema::XmlSchemaDerivationMethod finalDefault; // 0x70
		::System::Xml::Schema::XmlSchemaForm elementFormDefault; // 0x74
		::System::Xml::Schema::XmlSchemaForm attributeFormDefault; // 0x78
		::System::Boolean buildinIncluded; // 0x7C
		::System::Xml::Schema::XmlSchemaDerivationMethod blockDefault; // 0x80
