...
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_BUILDREFNAMESPACES_OFFSET UNITYSDK_OFFSET(0x191356C0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CHECKREFINEDATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x191389A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CHECKREFINEDCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x19138B90)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CHECKREFINEDGROUP_OFFSET UNITYSDK_OFFSET(0x19138920)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CHECKREFINEDSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x19138DD0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_CLEANUP_OFFSET UNITYSDK_OFFSET(0x19131040)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_COUNTGROUPSELFREFERENCE_OFFSET UNITYSDK_OFFSET(0x19138F10)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19130DE0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_GETSCHEMAENTITY_OFFSET UNITYSDK_OFFSET(0x19135610)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_LOADEXTERNALS_OFFSET UNITYSDK_OFFSET(0x19131410)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSANNOTATION_OFFSET UNITYSDK_OFFSET(0x19135910)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSATTRIBUTECONTENT_OFFSET UNITYSDK_OFFSET(0x19139680)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x19137130)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19139C20)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19137000)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x19137220)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSELEMENTCONTENT_OFFSET UNITYSDK_OFFSET(0x19139F20)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSELEMENT_OFFSET UNITYSDK_OFFSET(0x19138280)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSGROUP_OFFSET UNITYSDK_OFFSET(0x19138510)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSIDENTITYCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1913A880)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSLOCALATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x191398D0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSLOCALELEMENT_OFFSET UNITYSDK_OFFSET(0x1913A490)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSNOTATION_OFFSET UNITYSDK_OFFSET(0x19138710)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSPARTICLE_OFFSET UNITYSDK_OFFSET(0x1913AC10)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSREDEFINE_OFFSET UNITYSDK_OFFSET(0x19135A20)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESSSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x19137C30)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x191323D0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_RESOLVESCHEMALOCATIONURI_OFFSET UNITYSDK_OFFSET(0x19135590)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_SETPARENT_OFFSET UNITYSDK_OFFSET(0x191358F0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_VALIDATEIDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19132170)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_VALIDATENAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x191392A0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR_VALIDATEQNAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19139AC0)
#define SYSTEM_XML_SCHEMA_SCHEMACOLLECTIONPREPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19130D40)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::String* targetNamespace; // 0x68
		::System::Boolean buildinIncluded; // 0x70
