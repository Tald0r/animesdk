...
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A682540)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_EXPECTEDELEMENTS_OFFSET UNITYSDK_OFFSET(0x1A682560)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_EXPECTEDPARTICLES_OFFSET UNITYSDK_OFFSET(0x1A6827A0)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_INITVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A682340)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_VALIDATEELEMENT_OFFSET UNITYSDK_OFFSET(0x1A6823C0)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6822C0)
