...
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1AC2D840)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_EXPECTEDELEMENTS_OFFSET UNITYSDK_OFFSET(0x1AC2D860)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_EXPECTEDPARTICLES_OFFSET UNITYSDK_OFFSET(0x1AC2DAA0)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_INITVALIDATION_OFFSET UNITYSDK_OFFSET(0x1AC2D640)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR_VALIDATEELEMENT_OFFSET UNITYSDK_OFFSET(0x1AC2D6C0)
#define SYSTEM_XML_SCHEMA_DFACONTENTVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC2D5C0)
