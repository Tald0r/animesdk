...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASEQUENCE_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1AC33100)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASEQUENCE_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0x1AC330F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASEQUENCE_SETITEMS_OFFSET UNITYSDK_OFFSET(0x1AC331B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC331C0)
