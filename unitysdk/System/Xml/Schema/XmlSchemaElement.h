...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT_CLONE_1_OFFSET UNITYSDK_OFFSET(0x18C7D8B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT_CLONE_OFFSET UNITYSDK_OFFSET(0x18C7D8A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT_GET_CONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x18C60890)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT_GET_HASCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x18C6D440)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT_GET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C7D830)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT_GET_NAMESTRING_OFFSET UNITYSDK_OFFSET(0x18C7D850)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT_SETQUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x18C7D820)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT_SET_ISABSTRACT_OFFSET UNITYSDK_OFFSET(0x18C7D620)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT_SET_ISNILLABLE_OFFSET UNITYSDK_OFFSET(0x18C7D630)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT_SET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C7D840)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT_SET_REFNAME_OFFSET UNITYSDK_OFFSET(0x18C7D640)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT_SET_SCHEMATYPENAME_OFFSET UNITYSDK_OFFSET(0x18C7D780)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT_SET_SUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x18C7D6E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7DB10)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::XmlQualifiedName* typeName; // 0x98
		::System::Xml::XmlQualifiedName* qualifiedName; // 0xA0
		::System::String* fixedValue; // 0xA8
		::System::Xml::Schema::XmlSchemaType* type; // 0xB0
		::System::String* defaultValue; // 0xB8
		::System::Xml::Schema::XmlSchemaObjectCollection* constraints; // 0xC0
		::System::Xml::Schema::XmlSchemaType* elementType; // 0xC8
		::System::Xml::Schema::XmlSchemaDerivationMethod finalResolved; // 0xD0
		::System::Boolean isNillable; // 0xD4
		::System::Boolean isAbstract; // 0xD5
		::System::Boolean isLocalTypeDerivationChecked; // 0xD6
		::System::Boolean hasNillableAttribute; // 0xD7
		::System::Boolean hasAbstractAttribute; // 0xD8
		::System::Xml::Schema::XmlSchemaDerivationMethod final; // 0xDC
		::System::Xml::Schema::XmlSchemaForm form; // 0xE0
		::System::Xml::Schema::XmlSchemaDerivationMethod block; // 0xE4
		::System::Xml::Schema::XmlSchemaDerivationMethod blockResolved; // 0xE8
