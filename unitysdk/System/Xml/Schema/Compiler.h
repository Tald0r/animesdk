...
#define SYSTEM_XML_SCHEMA_COMPILER_BUILDPARTICLECONTENTMODEL_OFFSET UNITYSDK_OFFSET(0x18C6D480)
#define SYSTEM_XML_SCHEMA_COMPILER_CALCULATEEFFECTIVETOTALRANGE_OFFSET UNITYSDK_OFFSET(0x18C6C2A0)
#define SYSTEM_XML_SCHEMA_COMPILER_CANNONICALIZEALL_OFFSET UNITYSDK_OFFSET(0x18C67C10)
#define SYSTEM_XML_SCHEMA_COMPILER_CANNONICALIZECHOICE_OFFSET UNITYSDK_OFFSET(0x18C67FC0)
#define SYSTEM_XML_SCHEMA_COMPILER_CANNONICALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x18C69090)
#define SYSTEM_XML_SCHEMA_COMPILER_CANNONICALIZEGROUPREF_OFFSET UNITYSDK_OFFSET(0x18C674C0)
#define SYSTEM_XML_SCHEMA_COMPILER_CANNONICALIZEPARTICLE_OFFSET UNITYSDK_OFFSET(0x18C60E30)
#define SYSTEM_XML_SCHEMA_COMPILER_CANNONICALIZEPOINTLESSROOT_OFFSET UNITYSDK_OFFSET(0x18C66660)
#define SYSTEM_XML_SCHEMA_COMPILER_CANNONICALIZESEQUENCE_OFFSET UNITYSDK_OFFSET(0x18C68880)
#define SYSTEM_XML_SCHEMA_COMPILER_CHECKATRRIBUTEGROUPRESTRICTION_OFFSET UNITYSDK_OFFSET(0x18C61200)
#define SYSTEM_XML_SCHEMA_COMPILER_CHECKPARTICLEDERIVATION_1_OFFSET UNITYSDK_OFFSET(0x18C61160)
#define SYSTEM_XML_SCHEMA_COMPILER_CHECKPARTICLEDERIVATION_OFFSET UNITYSDK_OFFSET(0x18C5FDD0)
#define SYSTEM_XML_SCHEMA_COMPILER_CHECKUNIONTYPE_OFFSET UNITYSDK_OFFSET(0x18C62370)
#define SYSTEM_XML_SCHEMA_COMPILER_CLEANUPATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x18C5AC00)
#define SYSTEM_XML_SCHEMA_COMPILER_CLEANUPATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18C60660)
#define SYSTEM_XML_SCHEMA_COMPILER_CLEANUPATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C5AA60)
#define SYSTEM_XML_SCHEMA_COMPILER_CLEANUPCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x18C5AFA0)
#define SYSTEM_XML_SCHEMA_COMPILER_CLEANUPELEMENT_OFFSET UNITYSDK_OFFSET(0x18C5A680)
#define SYSTEM_XML_SCHEMA_COMPILER_CLEANUPGROUP_OFFSET UNITYSDK_OFFSET(0x18C5ABC0)
#define SYSTEM_XML_SCHEMA_COMPILER_CLEANUPPARTICLE_OFFSET UNITYSDK_OFFSET(0x18C60710)
#define SYSTEM_XML_SCHEMA_COMPILER_CLEANUPSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x18C5B7B0)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILEANYATTRIBUTEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x18C6D080)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILEANYATTRIBUTEUNION_OFFSET UNITYSDK_OFFSET(0x18C6D150)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILEATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x18C5BC50)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18C5E6D0)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILEBASEMEMBERTYPES_OFFSET UNITYSDK_OFFSET(0x18C61F60)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILECOMPLEXCONTENTEXTENSION_OFFSET UNITYSDK_OFFSET(0x18C62C30)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILECOMPLEXCONTENTRESTRICTION_OFFSET UNITYSDK_OFFSET(0x18C631A0)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILECOMPLEXCONTENT_OFFSET UNITYSDK_OFFSET(0x18C65B70)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILECOMPLEXTYPEELEMENTS_OFFSET UNITYSDK_OFFSET(0x18C5F280)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILECOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x18C5C960)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILECONTENTTYPEPARTICLE_OFFSET UNITYSDK_OFFSET(0x18C65990)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILEELEMENT_OFFSET UNITYSDK_OFFSET(0x18C5DAE0)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILEGROUP_OFFSET UNITYSDK_OFFSET(0x18C5BBA0)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILEIDENTITYCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x18C5EDB0)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILELOCALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18C63530)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILEPARTICLEELEMENTS_1_OFFSET UNITYSDK_OFFSET(0x18C60FD0)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILEPARTICLEELEMENTS_OFFSET UNITYSDK_OFFSET(0x18C6DDB0)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILESIMPLECONTENTEXTENSION_OFFSET UNITYSDK_OFFSET(0x18C62470)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILESIMPLECONTENTRESTRICTION_OFFSET UNITYSDK_OFFSET(0x18C62710)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILESIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x18C5D3B0)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILESUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x18C60930)
#define SYSTEM_XML_SCHEMA_COMPILER_COMPILE_OFFSET UNITYSDK_OFFSET(0x18C54580)
#define SYSTEM_XML_SCHEMA_COMPILER_COPYPOSITION_OFFSET UNITYSDK_OFFSET(0x18C69430)
#define SYSTEM_XML_SCHEMA_COMPILER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x18C54510)
#define SYSTEM_XML_SCHEMA_COMPILER_GETANYSCHEMATYPE_OFFSET UNITYSDK_OFFSET(0x18C664A0)
#define SYSTEM_XML_SCHEMA_COMPILER_GETCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x18C665C0)
#define SYSTEM_XML_SCHEMA_COMPILER_GETMAPPINGPARTICLE_OFFSET UNITYSDK_OFFSET(0x18C6CF40)
#define SYSTEM_XML_SCHEMA_COMPILER_GETSCHEMACONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x18C65B10)
#define SYSTEM_XML_SCHEMA_COMPILER_GETSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x18C61EA0)
#define SYSTEM_XML_SCHEMA_COMPILER_IMPORTALLCOMPILEDSCHEMAS_OFFSET UNITYSDK_OFFSET(0x18C5BAA0)
#define SYSTEM_XML_SCHEMA_COMPILER_ISANYFROMANY_OFFSET UNITYSDK_OFFSET(0x18C69CB0)
#define SYSTEM_XML_SCHEMA_COMPILER_ISCHOICEFROMCHOICESUBSTGROUP_OFFSET UNITYSDK_OFFSET(0x18C6B940)
#define SYSTEM_XML_SCHEMA_COMPILER_ISELEMENTFROMANY_OFFSET UNITYSDK_OFFSET(0x18C699E0)
#define SYSTEM_XML_SCHEMA_COMPILER_ISELEMENTFROMELEMENT_OFFSET UNITYSDK_OFFSET(0x18C69520)
#define SYSTEM_XML_SCHEMA_COMPILER_ISELEMENTFROMGROUPBASE_OFFSET UNITYSDK_OFFSET(0x18C6A3C0)
#define SYSTEM_XML_SCHEMA_COMPILER_ISFIXEDEQUAL_OFFSET UNITYSDK_OFFSET(0x18C6C120)
#define SYSTEM_XML_SCHEMA_COMPILER_ISGROUPBASEFROMANY_OFFSET UNITYSDK_OFFSET(0x18C69D60)
#define SYSTEM_XML_SCHEMA_COMPILER_ISGROUPBASEFROMGROUPBASE_OFFSET UNITYSDK_OFFSET(0x18C6B140)
#define SYSTEM_XML_SCHEMA_COMPILER_ISPARTICLEEMPTIABLE_OFFSET UNITYSDK_OFFSET(0x18C69480)
#define SYSTEM_XML_SCHEMA_COMPILER_ISPROCESSCONTENTSRESTRICTED_OFFSET UNITYSDK_OFFSET(0x18C6D220)
#define SYSTEM_XML_SCHEMA_COMPILER_ISSEQUENCEFROMALL_OFFSET UNITYSDK_OFFSET(0x18C6B520)
#define SYSTEM_XML_SCHEMA_COMPILER_ISSEQUENCEFROMCHOICE_OFFSET UNITYSDK_OFFSET(0x18C6BAE0)
#define SYSTEM_XML_SCHEMA_COMPILER_ISVALIDOCCURRENCERANGERESTRICTION_1_OFFSET UNITYSDK_OFFSET(0x18C6CE10)
#define SYSTEM_XML_SCHEMA_COMPILER_ISVALIDOCCURRENCERANGERESTRICTION_OFFSET UNITYSDK_OFFSET(0x18C6BFD0)
#define SYSTEM_XML_SCHEMA_COMPILER_ISVALIDRESTRICTION_OFFSET UNITYSDK_OFFSET(0x18C66B70)
#define SYSTEM_XML_SCHEMA_COMPILER_OUTPUT_OFFSET UNITYSDK_OFFSET(0x18C57190)
#define SYSTEM_XML_SCHEMA_COMPILER_PREPARE_OFFSET UNITYSDK_OFFSET(0x18C586F0)
#define SYSTEM_XML_SCHEMA_COMPILER_PROCESSSUBSTITUTIONGROUPS_OFFSET UNITYSDK_OFFSET(0x18C5F390)
#define SYSTEM_XML_SCHEMA_COMPILER_PUSHCOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x18C6D050)
#define SYSTEM_XML_SCHEMA_COMPILER_RECURSIVELYCHECKREDEFINEDATTRIBUTEGROUPS_OFFSET UNITYSDK_OFFSET(0x18C605E0)
#define SYSTEM_XML_SCHEMA_COMPILER_RECURSIVELYCHECKREDEFINEDGROUPS_OFFSET UNITYSDK_OFFSET(0x18C60520)
#define SYSTEM_XML_SCHEMA_COMPILER_SETDEFAULTFIXED_OFFSET UNITYSDK_OFFSET(0x18C6D2D0)
#define SYSTEM_XML_SCHEMA_COMPILER_UPDATESFORSSIMPLETYPES_OFFSET UNITYSDK_OFFSET(0x18C5B8F0)
#define SYSTEM_XML_SCHEMA_COMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C542B0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::XmlSchema* schemaForSchema; // 0x48
		::System::Collections::Hashtable* importedSchemas; // 0x50
		::System::Xml::Schema::XmlSchemaObjectTable* examplars; // 0x58
		::System::String* restrictionErrorMsg; // 0x60
