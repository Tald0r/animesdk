...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAIMPORT_ADDANNOTATION_OFFSET UNITYSDK_OFFSET(0x1AC330E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAIMPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC330D0)
