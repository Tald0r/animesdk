...
#define SYSTEM_XML_SCHEMA_ASTTREE_COMPILEXPATH_OFFSET UNITYSDK_OFFSET(0x1A4193B0)
#define SYSTEM_XML_SCHEMA_ASTTREE_ISATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A41A100)
#define SYSTEM_XML_SCHEMA_ASTTREE_ISDESCENDANTORSELF_OFFSET UNITYSDK_OFFSET(0x1A41A130)
#define SYSTEM_XML_SCHEMA_ASTTREE_ISNAMETEST_OFFSET UNITYSDK_OFFSET(0x1A41A0D0)
#define SYSTEM_XML_SCHEMA_ASTTREE_ISSELF_OFFSET UNITYSDK_OFFSET(0x1A41A160)
#define SYSTEM_XML_SCHEMA_ASTTREE_SETURN_OFFSET UNITYSDK_OFFSET(0x1A41A190)
#define SYSTEM_XML_SCHEMA_ASTTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A419390)
