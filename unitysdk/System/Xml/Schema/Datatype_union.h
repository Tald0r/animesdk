...
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A104A30)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_CREATEVALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x1A104940)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_GET_FACETSCHECKER_OFFSET UNITYSDK_OFFSET(0x1A104BA0)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_GET_LISTVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1A104C00)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1A104B90)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_GET_VALIDRESTRICTIONFLAGS_OFFSET UNITYSDK_OFFSET(0x1A104C60)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x1A104B30)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_HASATOMICMEMBERS_OFFSET UNITYSDK_OFFSET(0x1A104C70)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_ISUNIONBASEOF_OFFSET UNITYSDK_OFFSET(0x1A104D00)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_TRYPARSEVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A105000)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION_TRYPARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1A104DA0)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A105470)
#define SYSTEM_XML_SCHEMA_DATATYPE_UNION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A104990)
