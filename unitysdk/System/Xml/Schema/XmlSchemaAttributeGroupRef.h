...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUPREF_SET_REFNAME_OFFSET UNITYSDK_OFFSET(0x1A41C180)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUPREF__CTOR_OFFSET UNITYSDK_OFFSET(0x1A41C220)
