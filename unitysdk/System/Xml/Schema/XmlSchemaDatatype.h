...
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_CONCATENATEDTOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4E1680)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_DERIVEBYUNION_OFFSET UNITYSDK_OFFSET(0x1A4E2140)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_FROMXDRNAME_OFFSET UNITYSDK_OFFSET(0x1A4E20E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_FROMXMLTOKENIZEDTYPEXSD_OFFSET UNITYSDK_OFFSET(0x1A4E2000)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_FROMXMLTOKENIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x1A4E1F20)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_GET_TYPECODESTRING_OFFSET UNITYSDK_OFFSET(0x1A4DA880)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1A4E12B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_GET_VARIETY_OFFSET UNITYSDK_OFFSET(0x1A4E12A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_ISDERIVEDFROM_OFFSET UNITYSDK_OFFSET(0x1A4E12C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_TYPECODETOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4E12D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE_XDRCANONIZEURI_OFFSET UNITYSDK_OFFSET(0x1A4E21A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMADATATYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E2350)
