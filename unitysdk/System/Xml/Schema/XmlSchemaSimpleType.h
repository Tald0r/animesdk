...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLETYPE_CLONE_OFFSET UNITYSDK_OFFSET(0x18C7DE40)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASIMPLETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7DDC0)
