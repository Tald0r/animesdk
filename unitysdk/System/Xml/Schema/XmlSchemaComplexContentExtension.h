...
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXCONTENTEXTENSION_SET_BASETYPENAME_OFFSET UNITYSDK_OFFSET(0x1A687B80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXCONTENTEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A687CA0)
