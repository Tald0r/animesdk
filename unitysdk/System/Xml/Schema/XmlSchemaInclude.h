...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAINCLUDE_ADDANNOTATION_OFFSET UNITYSDK_OFFSET(0x19A422F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAINCLUDE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A422E0)
