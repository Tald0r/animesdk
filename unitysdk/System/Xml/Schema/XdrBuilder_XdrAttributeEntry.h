...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRATTRIBUTEENTRY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19CAD1E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRATTRIBUTEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x19CAD1B0)
