...
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_ADDID_OFFSET UNITYSDK_OFFSET(0x1A2629D0)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_CHECKDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1A262DB0)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_CHECKFORWARDREFS_OFFSET UNITYSDK_OFFSET(0x1A262550)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_CHECKVALUE_OFFSET UNITYSDK_OFFSET(0x1A261CB0)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A262440)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_FINDID_OFFSET UNITYSDK_OFFSET(0x1A2629B0)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_GENENTITY_OFFSET UNITYSDK_OFFSET(0x1A260E50)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_GETENTITY_OFFSET UNITYSDK_OFFSET(0x1A262A60)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_GET_PRESERVEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A262690)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_INIT_OFFSET UNITYSDK_OFFSET(0x1A2605B0)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_MEETSSTANDALONECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A260CF0)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_POP_OFFSET UNITYSDK_OFFSET(0x1A262490)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_PROCESSELEMENT_OFFSET UNITYSDK_OFFSET(0x1A2614E0)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_PROCESSTOKENIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x1A2626E0)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_PUSH_OFFSET UNITYSDK_OFFSET(0x1A260750)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_SETDEFAULTTYPEDVALUE_OFFSET UNITYSDK_OFFSET(0x1A262BC0)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_VALIDATECHILDELEMENT_OFFSET UNITYSDK_OFFSET(0x1A261300)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_VALIDATEELEMENT_OFFSET UNITYSDK_OFFSET(0x1A260B70)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_VALIDATEENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1A2610E0)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_VALIDATEENDSTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1A262230)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_VALIDATEPICOMMENT_OFFSET UNITYSDK_OFFSET(0x1A260DA0)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_VALIDATESTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1A261640)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A260880)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2630A0)
#define SYSTEM_XML_SCHEMA_DTDVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A260510)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::HWStack* validationStack; // 0x98
