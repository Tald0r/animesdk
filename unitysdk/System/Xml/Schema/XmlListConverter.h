...
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_CHANGELISTTYPE_OFFSET UNITYSDK_OFFSET(0x1947DDC0)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x1947DCF0)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_CREATEINVALIDCLRMAPPINGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1947E490)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_CREATE_OFFSET UNITYSDK_OFFSET(0x1947DB10)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_ISLISTTYPE_OFFSET UNITYSDK_OFFSET(0x1947E430)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_LISTASSTRING_OFFSET UNITYSDK_OFFSET(0x1947E8A0)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_STRINGASLIST_OFFSET UNITYSDK_OFFSET(0x1947EC70)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER_TOLIST_OFFSET UNITYSDK_OFFSET(0x1947ED90)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1947DAD0)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1947DB00)
#define SYSTEM_XML_SCHEMA_XMLLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1947DAB0)
