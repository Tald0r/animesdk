...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP_CLONE_OFFSET UNITYSDK_OFFSET(0x1A6AA640)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP_GET_ATTRIBUTEUSES_OFFSET UNITYSDK_OFFSET(0x1A6AA5B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP_GET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A6AA620)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP_SET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A6AA630)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAATTRIBUTEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6AA7C0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::XmlSchemaObjectTable* attributeUses; // 0x80
