...
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_CHECKDUPFLAG_OFFSET UNITYSDK_OFFSET(0x91F4A0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_CHECKPROHIBITEDFLAG_OFFSET UNITYSDK_OFFSET(0x91F410)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_CHECKVALUE_OFFSET UNITYSDK_OFFSET(0x91F3D0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEENUMERATIONFACET_OFFSET UNITYSDK_OFFSET(0x91F340)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEFACETCOMBINATIONS_OFFSET UNITYSDK_OFFSET(0x91F3E0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEFRACTIONDIGITSFACET_OFFSET UNITYSDK_OFFSET(0x91F3B0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILELENGTHFACET_OFFSET UNITYSDK_OFFSET(0x91F300)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMAXEXCLUSIVEFACET_OFFSET UNITYSDK_OFFSET(0x91F370)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMAXINCLUSIVEFACET_OFFSET UNITYSDK_OFFSET(0x91F360)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMAXLENGTHFACET_OFFSET UNITYSDK_OFFSET(0x91F320)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMINEXCLUSIVEFACET_OFFSET UNITYSDK_OFFSET(0x91F390)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMININCLUSIVEFACET_OFFSET UNITYSDK_OFFSET(0x91F380)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMINLENGTHFACET_OFFSET UNITYSDK_OFFSET(0x91F310)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEPATTERNFACET_OFFSET UNITYSDK_OFFSET(0x91F330)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILETOTALDIGITSFACET_OFFSET UNITYSDK_OFFSET(0x91F3A0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x91F350)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COPYFACETSFROMBASETYPE_OFFSET UNITYSDK_OFFSET(0x91F3F0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_FINISHFACETCOMPILE_OFFSET UNITYSDK_OFFSET(0x91F3C0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_PARSEFACETVALUE_OFFSET UNITYSDK_OFFSET(0x91F400)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x1A4DBEC0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_SETFLAG_1_OFFSET UNITYSDK_OFFSET(0x91F560)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_SETFLAG_OFFSET UNITYSDK_OFFSET(0x91F530)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4DC9A0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0x91F2F0)
