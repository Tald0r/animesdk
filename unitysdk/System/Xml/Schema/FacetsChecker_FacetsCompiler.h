...
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_CHECKDUPFLAG_OFFSET UNITYSDK_OFFSET(0x94C900)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_CHECKPROHIBITEDFLAG_OFFSET UNITYSDK_OFFSET(0x94C870)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_CHECKVALUE_OFFSET UNITYSDK_OFFSET(0x94C830)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEENUMERATIONFACET_OFFSET UNITYSDK_OFFSET(0x94C7A0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEFACETCOMBINATIONS_OFFSET UNITYSDK_OFFSET(0x94C840)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEFRACTIONDIGITSFACET_OFFSET UNITYSDK_OFFSET(0x94C810)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILELENGTHFACET_OFFSET UNITYSDK_OFFSET(0x94C760)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMAXEXCLUSIVEFACET_OFFSET UNITYSDK_OFFSET(0x94C7D0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMAXINCLUSIVEFACET_OFFSET UNITYSDK_OFFSET(0x94C7C0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMAXLENGTHFACET_OFFSET UNITYSDK_OFFSET(0x94C780)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMINEXCLUSIVEFACET_OFFSET UNITYSDK_OFFSET(0x94C7F0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMININCLUSIVEFACET_OFFSET UNITYSDK_OFFSET(0x94C7E0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEMINLENGTHFACET_OFFSET UNITYSDK_OFFSET(0x94C770)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEPATTERNFACET_OFFSET UNITYSDK_OFFSET(0x94C790)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILETOTALDIGITSFACET_OFFSET UNITYSDK_OFFSET(0x94C800)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COMPILEWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x94C7B0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_COPYFACETSFROMBASETYPE_OFFSET UNITYSDK_OFFSET(0x94C850)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_FINISHFACETCOMPILE_OFFSET UNITYSDK_OFFSET(0x94C820)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_PARSEFACETVALUE_OFFSET UNITYSDK_OFFSET(0x94C860)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x1AA8E470)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_SETFLAG_1_OFFSET UNITYSDK_OFFSET(0x94C9C0)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER_SETFLAG_OFFSET UNITYSDK_OFFSET(0x94C990)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA8EF50)
#define SYSTEM_XML_SCHEMA_FACETSCHECKER_FACETSCOMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0x94C750)
