...
#define SYSTEM_XML_SCHEMA_SCHEMANAMESPACEMANAGER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x19A3CD20)
#define SYSTEM_XML_SCHEMA_SCHEMANAMESPACEMANAGER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x19A3CF00)
#define SYSTEM_XML_SCHEMA_SCHEMANAMESPACEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A3CD10)
