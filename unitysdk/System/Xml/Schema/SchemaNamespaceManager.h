...
#define SYSTEM_XML_SCHEMA_SCHEMANAMESPACEMANAGER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1959AFC0)
#define SYSTEM_XML_SCHEMA_SCHEMANAMESPACEMANAGER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1959B1A0)
#define SYSTEM_XML_SCHEMA_SCHEMANAMESPACEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1959AFB0)
