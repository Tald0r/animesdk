...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAKEYREF_SET_REFER_OFFSET UNITYSDK_OFFSET(0x1A4E2360)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAKEYREF__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E2400)
