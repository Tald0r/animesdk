...
#define SYSTEM_XML_SCHEMA_DATATYPE_NORMALIZEDSTRING_GET_BUILTINWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x1AA8AC70)
#define SYSTEM_XML_SCHEMA_DATATYPE_NORMALIZEDSTRING_GET_HASVALUEFACETS_OFFSET UNITYSDK_OFFSET(0x1AA8AC80)
#define SYSTEM_XML_SCHEMA_DATATYPE_NORMALIZEDSTRING_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1AA8AC60)
#define SYSTEM_XML_SCHEMA_DATATYPE_NORMALIZEDSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA8AC90)
