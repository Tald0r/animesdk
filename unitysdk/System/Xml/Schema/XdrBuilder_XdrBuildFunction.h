...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRBUILDFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A5AC1E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRBUILDFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A5AC220)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRBUILDFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A5ABBC0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDRBUILDFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5ABBB0)
