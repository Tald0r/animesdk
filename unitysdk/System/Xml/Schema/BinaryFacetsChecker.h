...
#define SYSTEM_XML_SCHEMA_BINARYFACETSCHECKER_CHECKVALUEFACETS_1_OFFSET UNITYSDK_OFFSET(0x1A680CE0)
#define SYSTEM_XML_SCHEMA_BINARYFACETSCHECKER_CHECKVALUEFACETS_OFFSET UNITYSDK_OFFSET(0x1A680C90)
#define SYSTEM_XML_SCHEMA_BINARYFACETSCHECKER_MATCHENUMERATION_1_OFFSET UNITYSDK_OFFSET(0x1A680ED0)
#define SYSTEM_XML_SCHEMA_BINARYFACETSCHECKER_MATCHENUMERATION_OFFSET UNITYSDK_OFFSET(0x1A680FC0)
#define SYSTEM_XML_SCHEMA_BINARYFACETSCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A681020)
