...
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ADDORDER_OFFSET UNITYSDK_OFFSET(0x19FA6900)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_CHECKDATATYPE_OFFSET UNITYSDK_OFFSET(0x19FA5E50)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_CHECKDEFAULTATTVALUE_OFFSET UNITYSDK_OFFSET(0x19FA6530)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_COMPAREMINMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x19FA56C0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ENDCHILDREN_OFFSET UNITYSDK_OFFSET(0x19FA31E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_GETCONTENT_OFFSET UNITYSDK_OFFSET(0x19FA41E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_GETMODEL_OFFSET UNITYSDK_OFFSET(0x19FA44D0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_GETNEXTSTATE_OFFSET UNITYSDK_OFFSET(0x19FA1C30)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_GETORDER_OFFSET UNITYSDK_OFFSET(0x19FA46C0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_HANDLEMINMAX_OFFSET UNITYSDK_OFFSET(0x19FA6E40)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ISCONTENTPARSED_OFFSET UNITYSDK_OFFSET(0x19FA30C0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ISGLOBAL_OFFSET UNITYSDK_OFFSET(0x19FA2560)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ISSKIPABLEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19FA2C60)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ISSKIPABLEELEMENT_OFFSET UNITYSDK_OFFSET(0x19FA1EF0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ISXDRSCHEMA_OFFSET UNITYSDK_OFFSET(0x19FA2570)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_ISYES_OFFSET UNITYSDK_OFFSET(0x19FA5C70)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_LOADSCHEMA_OFFSET UNITYSDK_OFFSET(0x19FA2610)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PARSEDTMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x19FA4B10)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PARSEDTMINLENGTH_OFFSET UNITYSDK_OFFSET(0x19FA4CE0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PARSEINTEGER_OFFSET UNITYSDK_OFFSET(0x19FA7FF0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PARSEMAXOCCURS_OFFSET UNITYSDK_OFFSET(0x19FA6BC0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PARSEMINOCCURS_OFFSET UNITYSDK_OFFSET(0x19FA6A40)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_POPGROUPINFO_OFFSET UNITYSDK_OFFSET(0x19FA3460)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_POP_OFFSET UNITYSDK_OFFSET(0x19FA32A0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PROCESSATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19FA20D0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PROCESSCDATA_OFFSET UNITYSDK_OFFSET(0x19FA3130)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PROCESSELEMENT_OFFSET UNITYSDK_OFFSET(0x19FA1AB0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PROCESSMARKUP_OFFSET UNITYSDK_OFFSET(0x19FA30D0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PUSHGROUPINFO_OFFSET UNITYSDK_OFFSET(0x19FA3340)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_PUSH_OFFSET UNITYSDK_OFFSET(0x19FA1EA0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_SENDVALIDATIONEVENT_1_OFFSET UNITYSDK_OFFSET(0x19FA49E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_SENDVALIDATIONEVENT_2_OFFSET UNITYSDK_OFFSET(0x19FA1FE0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_SENDVALIDATIONEVENT_3_OFFSET UNITYSDK_OFFSET(0x19FA8030)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_SENDVALIDATIONEVENT_OFFSET UNITYSDK_OFFSET(0x19FA2F40)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_SETATTRIBUTEPRESENCE_OFFSET UNITYSDK_OFFSET(0x19FA6640)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_STARTCHILDREN_OFFSET UNITYSDK_OFFSET(0x19FA31A0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BEGINATTRIBUTETYPE_OFFSET UNITYSDK_OFFSET(0x19FA61E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BEGINATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19FA7150)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BEGINELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x19FA4E30)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BEGINROOT_OFFSET UNITYSDK_OFFSET(0x19FA35B0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_DEFAULT_OFFSET UNITYSDK_OFFSET(0x19FA5D70)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_DTMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x19FA60E0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_DTMINLENGTH_OFFSET UNITYSDK_OFFSET(0x19FA6160)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_DTTYPE_OFFSET UNITYSDK_OFFSET(0x19FA5DA0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_DTVALUES_OFFSET UNITYSDK_OFFSET(0x19FA6040)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_NAME_OFFSET UNITYSDK_OFFSET(0x19FA5880)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTETYPE_REQUIRED_OFFSET UNITYSDK_OFFSET(0x19FA5BF0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTE_DEFAULT_OFFSET UNITYSDK_OFFSET(0x19FA7120)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTE_REQUIRED_OFFSET UNITYSDK_OFFSET(0x19FA7090)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDATTRIBUTE_TYPE_OFFSET UNITYSDK_OFFSET(0x19FA7000)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_CONTENT_OFFSET UNITYSDK_OFFSET(0x19FA4140)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_DTMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x19FA4A90)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_DTMINLENGTH_OFFSET UNITYSDK_OFFSET(0x19FA4C60)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_DTTYPE_OFFSET UNITYSDK_OFFSET(0x19FA4870)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_DTVALUES_OFFSET UNITYSDK_OFFSET(0x19FA49F0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_MODEL_OFFSET UNITYSDK_OFFSET(0x19FA4430)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_NAME_OFFSET UNITYSDK_OFFSET(0x19FA3EE0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENTTYPE_ORDER_OFFSET UNITYSDK_OFFSET(0x19FA4600)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENT_MAXOCCURS_OFFSET UNITYSDK_OFFSET(0x19FA6B40)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENT_MINOCCURS_OFFSET UNITYSDK_OFFSET(0x19FA69C0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDELEMENT_TYPE_OFFSET UNITYSDK_OFFSET(0x19FA6730)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDGROUP_MAXOCCURS_OFFSET UNITYSDK_OFFSET(0x19FA79B0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDGROUP_MINOCCURS_OFFSET UNITYSDK_OFFSET(0x19FA7920)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDGROUP_ORDER_OFFSET UNITYSDK_OFFSET(0x19FA7820)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDROOT_ID_OFFSET UNITYSDK_OFFSET(0x19FA35A0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_BUILDROOT_NAME_OFFSET UNITYSDK_OFFSET(0x19FA3560)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_CHECKATTRIBUTEDEFAULT_OFFSET UNITYSDK_OFFSET(0x19FA3CD0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDATTRIBUTEDTTYPE_OFFSET UNITYSDK_OFFSET(0x19FA7EF0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDATTRIBUTETYPE_OFFSET UNITYSDK_OFFSET(0x19FA6280)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19FA7640)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDELEMENTDTTYPE_OFFSET UNITYSDK_OFFSET(0x19FA7D90)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x19FA5200)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDELEMENT_OFFSET UNITYSDK_OFFSET(0x19FA6CE0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDGROUP_OFFSET UNITYSDK_OFFSET(0x19FA7A40)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_ENDROOT_OFFSET UNITYSDK_OFFSET(0x19FA36B0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITATTRIBUTEDTTYPE_OFFSET UNITYSDK_OFFSET(0x19FA7E80)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITATTRIBUTETYPE_OFFSET UNITYSDK_OFFSET(0x19FA5730)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19FA6EF0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITELEMENTDTTYPE_OFFSET UNITYSDK_OFFSET(0x19FA7CF0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x19FA3D60)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITELEMENT_OFFSET UNITYSDK_OFFSET(0x19FA6690)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITGROUP_OFFSET UNITYSDK_OFFSET(0x19FA7710)
#define SYSTEM_XML_SCHEMA_XDRBUILDER_XDR_INITROOT_OFFSET UNITYSDK_OFFSET(0x19FA3500)
#define SYSTEM_XML_SCHEMA_XDRBUILDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FA80F0)
#define SYSTEM_XML_SCHEMA_XDRBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FA1810)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::XdrBuilder_ElementContent* _ElementDef; // 0x10
		::System::Xml::XmlResolver* xmlResolver; // 0x18
		::System::Xml::XmlReader* _reader; // 0x20
		::System::Xml::Schema::XdrBuilder_XdrEntry* _NextState; // 0x28
		::System::Xml::XmlNamespaceManager* _CurNsMgr; // 0x30
		::System::String* _Text; // 0x38
		::System::Xml::HWStack* _GroupStack; // 0x40
		::System::Xml::XmlNameTable* _NameTable; // 0x48
		::System::Xml::Schema::SchemaInfo* _SchemaInfo; // 0x50
		::System::Xml::Schema::XdrBuilder_GroupContent* _GroupDef; // 0x58
		::System::Xml::HWStack* _StateHistory; // 0x60
		::System::Xml::PositionInfo* positionInfo; // 0x68
		::System::Xml::Schema::XdrBuilder_DeclBaseInfo* _BaseDecl; // 0x70
		::System::Xml::Schema::SchemaNames* _SchemaNames; // 0x78
		::System::Xml::Schema::XdrBuilder_XdrEntry* _CurState; // 0x80
		::System::Xml::Schema::ValidationEventHandler* validationEventHandler; // 0x88
		::System::String* _XdrName; // 0x90
		::System::String* _XdrPrefix; // 0x98
		::System::Collections::Hashtable* _UndeclaredElements; // 0xA0
		::System::String* _TargetNamespace; // 0xA8
		::System::Xml::Schema::ParticleContentValidator* _contentValidator; // 0xB0
		::System::Xml::Schema::XdrBuilder_AttributeContent* _AttributeDef; // 0xB8
		::System::Xml::Schema::XdrBuilder_DeclBaseInfo* _UndefinedAttributeTypes; // 0xC0
