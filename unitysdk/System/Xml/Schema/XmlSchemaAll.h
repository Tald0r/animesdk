...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAALL_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A4DF450)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAALL_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0x1A4DF440)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAALL_SETITEMS_OFFSET UNITYSDK_OFFSET(0x1A4DF500)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4DF510)
