...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAREDEFINE_ADDANNOTATION_OFFSET UNITYSDK_OFFSET(0x19EE30D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAREDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x19EE2FE0)
...
namespace System::Xml::Schema
{
	...
	{
	public:
		::System::Xml::Schema::XmlSchemaObjectTable* types; // 0x68
