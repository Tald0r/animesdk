...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAREDEFINE_ADDANNOTATION_OFFSET UNITYSDK_OFFSET(0x1A4E2600)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAREDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E2510)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::XmlSchemaObjectTable* groups; // 0x78
