...
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYURI_COMPARE_OFFSET UNITYSDK_OFFSET(0x1912F9D0)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYURI_CREATEVALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x1912F820)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYURI_GET_BUILTINWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x1912F9B0)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYURI_GET_FACETSCHECKER_OFFSET UNITYSDK_OFFSET(0x1912F870)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYURI_GET_HASVALUEFACETS_OFFSET UNITYSDK_OFFSET(0x1912F940)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYURI_GET_LISTVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1912F950)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYURI_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1912F8D0)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYURI_GET_VALIDRESTRICTIONFLAGS_OFFSET UNITYSDK_OFFSET(0x1912F9C0)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYURI_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x1912F8E0)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYURI_TRYPARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1912FA50)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYURI__CCTOR_OFFSET UNITYSDK_OFFSET(0x1912FD40)
#define SYSTEM_XML_SCHEMA_DATATYPE_ANYURI__CTOR_OFFSET UNITYSDK_OFFSET(0x1912FCA0)
