...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_ADDANNOTATION_OFFSET UNITYSDK_OFFSET(0x1913F370)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_CLONE_OFFSET UNITYSDK_OFFSET(0x1913F3A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_GET_IDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1913F340)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_GET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1913F380)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_GET_NAMESPACES_OFFSET UNITYSDK_OFFSET(0x1913F2F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_SETUNHANDLEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1913F360)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_SET_IDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1913F350)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT_SET_NAMEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1913F390)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1913ECF0)
