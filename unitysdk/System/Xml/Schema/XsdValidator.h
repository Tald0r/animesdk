...
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_ADDIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x195A6CD0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_ADDID_OFFSET UNITYSDK_OFFSET(0x195A6C40)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_ATTRIBUTEIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x195A5C10)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_CHECKFORWARDREFS_OFFSET UNITYSDK_OFFSET(0x195A1360)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_CHECKVALUE_OFFSET UNITYSDK_OFFSET(0x195A3D10)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x195A1350)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_ELEMENTIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x195A72D0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_ENDELEMENTIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x195A4240)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_FASTGETELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x195A1B60)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_FINDID_OFFSET UNITYSDK_OFFSET(0x195A6C20)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_GET_HASIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x195A4230)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_GET_HASSCHEMA_OFFSET UNITYSDK_OFFSET(0x195A2BB0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_GET_ISINLINESCHEMASTARTED_OFFSET UNITYSDK_OFFSET(0x195A0B90)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_GET_PRESERVEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x195A6920)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_INIT_OFFSET UNITYSDK_OFFSET(0x195A0630)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_ISXSDROOT_OFFSET UNITYSDK_OFFSET(0x195A1750)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_LOADSCHEMAFROMLOCATION_OFFSET UNITYSDK_OFFSET(0x195A62A0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_LOADSCHEMA_OFFSET UNITYSDK_OFFSET(0x195A3A60)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_POP_OFFSET UNITYSDK_OFFSET(0x195A5AB0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_PROCESSELEMENT_OFFSET UNITYSDK_OFFSET(0x195A1770)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_PROCESSINLINESCHEMA_OFFSET UNITYSDK_OFFSET(0x195A0BA0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_PROCESSTOKENIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x195A6970)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_PROCESSXSIATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x195A1C20)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_PUSH_OFFSET UNITYSDK_OFFSET(0x195A0980)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_THOROUGHGETELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x195A2670)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_UNWRAPUNION_OFFSET UNITYSDK_OFFSET(0x195A5BA0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATECHILDELEMENT_OFFSET UNITYSDK_OFFSET(0x195A14A0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATEELEMENT_OFFSET UNITYSDK_OFFSET(0x195A0EA0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATEENDELEMENT_OFFSET UNITYSDK_OFFSET(0x195A10B0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATEENDSTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x195A3680)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATESTARTELEMENTIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x195A2BD0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATESTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x195A2C20)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR_VALIDATE_OFFSET UNITYSDK_OFFSET(0x195A0AC0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x195A78B0)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195A0950)
#define SYSTEM_XML_SCHEMA_XSDVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x195A05D0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::String* NsXs; // 0xA0
		::System::String* NsXsi; // 0xA8
		::System::String* XsdSchema; // 0xB0
		::System::Xml::Schema::Parser* inlineSchemaParser; // 0xB8
		::System::Xml::Schema::IdRefNode* idRefListHead; // 0xC0
		::System::String* NsXmlNs; // 0xC8
		::System::Collections::Hashtable* IDs; // 0xD0
		::System::String* XsiSchemaLocation; // 0xD8
		::System::String* XsiNil; // 0xE0
