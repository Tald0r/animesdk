...
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_ADDTOTABLE_OFFSET UNITYSDK_OFFSET(0x19453AA0)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_GET_HASERRORS_OFFSET UNITYSDK_OFFSET(0x19453A90)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_GET_SCHEMANAMES_OFFSET UNITYSDK_OFFSET(0x19453A20)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_ISVALIDATTRIBUTEGROUPREDEFINE_OFFSET UNITYSDK_OFFSET(0x19453E40)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_ISVALIDGROUPREDEFINE_OFFSET UNITYSDK_OFFSET(0x194540F0)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_ISVALIDTYPEREDEFINE_OFFSET UNITYSDK_OFFSET(0x19453FE0)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENTNOTHROW_OFFSET UNITYSDK_OFFSET(0x19454F20)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_1_OFFSET UNITYSDK_OFFSET(0x19454200)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_2_OFFSET UNITYSDK_OFFSET(0x19454580)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_3_OFFSET UNITYSDK_OFFSET(0x19454790)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_4_OFFSET UNITYSDK_OFFSET(0x19454950)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_5_OFFSET UNITYSDK_OFFSET(0x19454B60)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_6_OFFSET UNITYSDK_OFFSET(0x19454D70)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_7_OFFSET UNITYSDK_OFFSET(0x19454E10)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_8_OFFSET UNITYSDK_OFFSET(0x194544C0)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR_SENDVALIDATIONEVENT_OFFSET UNITYSDK_OFFSET(0x194542E0)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x194539A0)
#define SYSTEM_XML_SCHEMA_BASEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19453900)
