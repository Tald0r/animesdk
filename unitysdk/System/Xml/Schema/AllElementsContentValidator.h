...
#define SYSTEM_XML_SCHEMA_ALLELEMENTSCONTENTVALIDATOR_ADDELEMENT_OFFSET UNITYSDK_OFFSET(0x1A030340)
#define SYSTEM_XML_SCHEMA_ALLELEMENTSCONTENTVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A030720)
#define SYSTEM_XML_SCHEMA_ALLELEMENTSCONTENTVALIDATOR_EXPECTEDELEMENTS_OFFSET UNITYSDK_OFFSET(0x1A030760)
#define SYSTEM_XML_SCHEMA_ALLELEMENTSCONTENTVALIDATOR_EXPECTEDPARTICLES_OFFSET UNITYSDK_OFFSET(0x1A030D00)
#define SYSTEM_XML_SCHEMA_ALLELEMENTSCONTENTVALIDATOR_GET_ISEMPTIABLE_OFFSET UNITYSDK_OFFSET(0x1A030490)
#define SYSTEM_XML_SCHEMA_ALLELEMENTSCONTENTVALIDATOR_INITVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A0304B0)
#define SYSTEM_XML_SCHEMA_ALLELEMENTSCONTENTVALIDATOR_VALIDATEELEMENT_OFFSET UNITYSDK_OFFSET(0x1A030550)
#define SYSTEM_XML_SCHEMA_ALLELEMENTSCONTENTVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A030260)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::Il2CppArray<::System::Object*>* particles; // 0x28
