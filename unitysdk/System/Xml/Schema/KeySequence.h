...
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_EQUALS_OFFSET UNITYSDK_OFFSET(0x19592D00)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195924D0)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19592300)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_ISQUALIFIED_OFFSET UNITYSDK_OFFSET(0x19592460)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19592340)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195932D0)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x195922A0)
