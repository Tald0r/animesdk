...
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_EQUALS_OFFSET UNITYSDK_OFFSET(0x19A349D0)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19A341A0)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19A33FD0)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_ISQUALIFIED_OFFSET UNITYSDK_OFFSET(0x19A34130)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19A34010)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19A34FA0)
#define SYSTEM_XML_SCHEMA_KEYSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A33F70)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Int32 posline; // 0x18
		::System::Int32 hashcode; // 0x1C
		::System::Int32 dim; // 0x20
