...
#define SYSTEM_XML_SCHEMA_XMLVALUEGETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1910EE00)
#define SYSTEM_XML_SCHEMA_XMLVALUEGETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1910EE30)
#define SYSTEM_XML_SCHEMA_XMLVALUEGETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1910EB60)
#define SYSTEM_XML_SCHEMA_XMLVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1910EB50)
