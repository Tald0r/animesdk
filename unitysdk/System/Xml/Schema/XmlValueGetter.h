...
#define SYSTEM_XML_SCHEMA_XMLVALUEGETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19482200)
#define SYSTEM_XML_SCHEMA_XMLVALUEGETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19482230)
#define SYSTEM_XML_SCHEMA_XMLVALUEGETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19481F60)
#define SYSTEM_XML_SCHEMA_XMLVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19481F40)
