...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_ADD_OFFSET UNITYSDK_OFFSET(0x19480B80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x19481000)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_CONTAINS_OFFSET UNITYSDK_OFFSET(0x19481200)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_FINDINDEXBYVALUE_OFFSET UNITYSDK_OFFSET(0x19480E00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19481390)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x194811E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19481280)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x19481330)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_INSERT_OFFSET UNITYSDK_OFFSET(0x19480C40)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_REMOVE_OFFSET UNITYSDK_OFFSET(0x194810A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE_REPLACE_OFFSET UNITYSDK_OFFSET(0x19480E60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19480AC0)
