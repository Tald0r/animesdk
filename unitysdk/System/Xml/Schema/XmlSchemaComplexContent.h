...
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXCONTENT_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x1A3733F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXCONTENT_SET_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1A3733E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A373400)
