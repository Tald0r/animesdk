...
#define SYSTEM_XML_SCHEMA_DATATYPE_BOOLEAN_COMPARE_OFFSET UNITYSDK_OFFSET(0x1947AB20)
#define SYSTEM_XML_SCHEMA_DATATYPE_BOOLEAN_CREATEVALUECONVERTER_OFFSET UNITYSDK_OFFSET(0x1947A980)
#define SYSTEM_XML_SCHEMA_DATATYPE_BOOLEAN_GET_BUILTINWHITESPACEFACET_OFFSET UNITYSDK_OFFSET(0x1947AB00)
#define SYSTEM_XML_SCHEMA_DATATYPE_BOOLEAN_GET_FACETSCHECKER_OFFSET UNITYSDK_OFFSET(0x1947A9D0)
#define SYSTEM_XML_SCHEMA_DATATYPE_BOOLEAN_GET_LISTVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1947AAA0)
#define SYSTEM_XML_SCHEMA_DATATYPE_BOOLEAN_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x1947AA30)
#define SYSTEM_XML_SCHEMA_DATATYPE_BOOLEAN_GET_VALIDRESTRICTIONFLAGS_OFFSET UNITYSDK_OFFSET(0x1947AB10)
#define SYSTEM_XML_SCHEMA_DATATYPE_BOOLEAN_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x1947AA40)
#define SYSTEM_XML_SCHEMA_DATATYPE_BOOLEAN_TRYPARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1947AC20)
#define SYSTEM_XML_SCHEMA_DATATYPE_BOOLEAN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1947ADC0)
#define SYSTEM_XML_SCHEMA_DATATYPE_BOOLEAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1947AD20)
