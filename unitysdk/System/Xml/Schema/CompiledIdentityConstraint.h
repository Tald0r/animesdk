...
#define SYSTEM_XML_SCHEMA_COMPILEDIDENTITYCONSTRAINT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA8A9F0)
#define SYSTEM_XML_SCHEMA_COMPILEDIDENTITYCONSTRAINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AA8A540)
#define SYSTEM_XML_SCHEMA_COMPILEDIDENTITYCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA8A4D0)
