...
#define SYSTEM_XML_SCHEMA_COMPILEDIDENTITYCONSTRAINT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4D8440)
#define SYSTEM_XML_SCHEMA_COMPILEDIDENTITYCONSTRAINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4D7F90)
#define SYSTEM_XML_SCHEMA_COMPILEDIDENTITYCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4D7F20)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::XmlQualifiedName* refer; // 0x28
