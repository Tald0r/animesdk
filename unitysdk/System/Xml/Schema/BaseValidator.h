...
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A5A6F40)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A5A7FD0)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_FINDID_OFFSET UNITYSDK_OFFSET(0x1A5A6F50)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_GET_EVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1A5A6E20)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_GET_PRESERVEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A5A6F20)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_GET_SCHEMANAMES_OFFSET UNITYSDK_OFFSET(0x1A5A6D40)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_PROCESSENTITY_1_OFFSET UNITYSDK_OFFSET(0x1A5A7DD0)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_PROCESSENTITY_OFFSET UNITYSDK_OFFSET(0x1A5A7B80)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SAVETEXTVALUE_OFFSET UNITYSDK_OFFSET(0x1A5A7560)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_1_OFFSET UNITYSDK_OFFSET(0x1A5A73A0)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_2_OFFSET UNITYSDK_OFFSET(0x1A5A7270)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_3_OFFSET UNITYSDK_OFFSET(0x1A5A7780)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_4_OFFSET UNITYSDK_OFFSET(0x1A5A7850)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_5_OFFSET UNITYSDK_OFFSET(0x1A5A79A0)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_6_OFFSET UNITYSDK_OFFSET(0x1A5A77E0)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_OFFSET UNITYSDK_OFFSET(0x1A5A7770)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SET_BASEURI_OFFSET UNITYSDK_OFFSET(0x1A5A6E10)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SET_DTDINFO_OFFSET UNITYSDK_OFFSET(0x1A5A6E80)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_VALIDATETEXT_OFFSET UNITYSDK_OFFSET(0x1A5A6F60)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_VALIDATEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A5A75D0)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A5A6F30)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5A6C20)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5A6BD0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::IValidationEventHandling* eventHandling; // 0x40
		...
		::System::Text::StringBuilder* textValue; // 0x60
		::System::Xml::Schema::XmlSchemaCollection* schemaCollection; // 0x68
