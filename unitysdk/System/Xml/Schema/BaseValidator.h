...
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_COMPLETEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1AB51E70)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AB52F10)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_FINDID_OFFSET UNITYSDK_OFFSET(0x1AB51E80)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_GET_EVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1AB51D50)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_GET_PRESERVEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1AB51E50)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_GET_SCHEMANAMES_OFFSET UNITYSDK_OFFSET(0x1AB51C70)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_PROCESSENTITY_1_OFFSET UNITYSDK_OFFSET(0x1AB52D10)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_PROCESSENTITY_OFFSET UNITYSDK_OFFSET(0x1AB52AC0)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SAVETEXTVALUE_OFFSET UNITYSDK_OFFSET(0x1AB52490)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_1_OFFSET UNITYSDK_OFFSET(0x1AB522D0)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_2_OFFSET UNITYSDK_OFFSET(0x1AB521A0)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_3_OFFSET UNITYSDK_OFFSET(0x1AB526C0)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_4_OFFSET UNITYSDK_OFFSET(0x1AB52790)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_5_OFFSET UNITYSDK_OFFSET(0x1AB528E0)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_6_OFFSET UNITYSDK_OFFSET(0x1AB52720)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SENDVALIDATIONEVENT_OFFSET UNITYSDK_OFFSET(0x1AB526B0)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SET_BASEURI_OFFSET UNITYSDK_OFFSET(0x1AB51D40)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_SET_DTDINFO_OFFSET UNITYSDK_OFFSET(0x1AB51DB0)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_VALIDATETEXT_OFFSET UNITYSDK_OFFSET(0x1AB51E90)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_VALIDATEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1AB52500)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1AB51E60)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB51B50)
#define SYSTEM_XML_SCHEMA_BASEVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB51B00)
...
namespace System::Xml::Schema
{
	...
	{
	public:
		::System::Text::StringBuilder* textValue; // 0x10
		::System::String* textString; // 0x18
		::System::Xml::Schema::ValidationState* context; // 0x20
		::System::Xml::XmlResolver* xmlResolver; // 0x28
		::System::Xml::Schema::SchemaNames* schemaNames; // 0x30
		::System::Uri* baseUri; // 0x38
		::System::Xml::XmlValidatingReaderImpl* reader; // 0x40
		::System::Xml::XmlQualifiedName* elementName; // 0x48
		::System::Xml::XmlNameTable* nameTable; // 0x50
		::System::Xml::Schema::SchemaInfo* schemaInfo; // 0x58
		::System::Xml::PositionInfo* positionInfo; // 0x60
