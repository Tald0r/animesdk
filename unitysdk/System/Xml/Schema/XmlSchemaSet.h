...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADDSCHEMATOSET_OFFSET UNITYSDK_OFFSET(0x199BCA40)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADDTOTABLE_OFFSET UNITYSDK_OFFSET(0x199BE620)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_1_OFFSET UNITYSDK_OFFSET(0x199B8620)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_2_OFFSET UNITYSDK_OFFSET(0x199B85C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_3_OFFSET UNITYSDK_OFFSET(0x199BD0B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_OFFSET UNITYSDK_OFFSET(0x199B4F90)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_VALIDATIONEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x199B4C00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_CLEARTABLES_OFFSET UNITYSDK_OFFSET(0x199BA460)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_COMPILE_OFFSET UNITYSDK_OFFSET(0x199B9D70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_CONTAINS_OFFSET UNITYSDK_OFFSET(0x199B9D30)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_COPYFROMCOMPILEDSET_OFFSET UNITYSDK_OFFSET(0x199B5B60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_COPYTO_OFFSET UNITYSDK_OFFSET(0x199BC8A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_FINDSCHEMABYNSANDURL_OFFSET UNITYSDK_OFFSET(0x199B8240)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GETRESOLVER_OFFSET UNITYSDK_OFFSET(0x199BEAB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GETSCHEMABYURI_OFFSET UNITYSDK_OFFSET(0x199BEAD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GETSCHEMANAMES_OFFSET UNITYSDK_OFFSET(0x199BE930)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GETTARGETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x199B97E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x199B4D60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_GLOBALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x199B4E00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_GLOBALELEMENTS_OFFSET UNITYSDK_OFFSET(0x199B4D90)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_GLOBALTYPES_OFFSET UNITYSDK_OFFSET(0x199B4E70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_INTERNALSYNCOBJECT_OFFSET UNITYSDK_OFFSET(0x199B47A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_SUBSTITUTIONGROUPS_OFFSET UNITYSDK_OFFSET(0x199B4ED0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_TYPEEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x199B4F30)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_INTERNALVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x199BECA0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ISSCHEMALOADED_OFFSET UNITYSDK_OFFSET(0x199BD520)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_PARSESCHEMA_OFFSET UNITYSDK_OFFSET(0x199BDA20)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_PREPROCESSSCHEMA_OFFSET UNITYSDK_OFFSET(0x199BC740)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_PROCESSNEWSUBSTITUTIONGROUPS_OFFSET UNITYSDK_OFFSET(0x199BDC10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVERECURSIVE_OFFSET UNITYSDK_OFFSET(0x199B8870)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVESCHEMAFROMCACHES_OFFSET UNITYSDK_OFFSET(0x199BBE10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVESCHEMAFROMGLOBALTABLES_OFFSET UNITYSDK_OFFSET(0x199BAFF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVE_OFFSET UNITYSDK_OFFSET(0x199B98B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVE_VALIDATIONEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x199B4CA0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REPROCESS_OFFSET UNITYSDK_OFFSET(0x199BA6A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_RESOLVESUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x199BE100)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_SCHEMAS_1_OFFSET UNITYSDK_OFFSET(0x199BC5A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_SCHEMAS_OFFSET UNITYSDK_OFFSET(0x199BCA10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_SENDVALIDATIONEVENT_OFFSET UNITYSDK_OFFSET(0x199B9810)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_SET_XMLRESOLVER_OFFSET UNITYSDK_OFFSET(0x199B4D00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_VERIFYTABLES_OFFSET UNITYSDK_OFFSET(0x199BE9C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x199B48B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_OFFSET UNITYSDK_OFFSET(0x199B47F0)
