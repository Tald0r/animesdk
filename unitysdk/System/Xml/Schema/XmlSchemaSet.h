...
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADDSCHEMATOSET_OFFSET UNITYSDK_OFFSET(0x19FB3790)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADDTOTABLE_OFFSET UNITYSDK_OFFSET(0x19FB5380)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_1_OFFSET UNITYSDK_OFFSET(0x19FAF3E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_2_OFFSET UNITYSDK_OFFSET(0x19FAF380)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_3_OFFSET UNITYSDK_OFFSET(0x19FB3E10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_OFFSET UNITYSDK_OFFSET(0x19FABDC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ADD_VALIDATIONEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x19FABA50)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_CLEARTABLES_OFFSET UNITYSDK_OFFSET(0x19FB11E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_COMPILE_OFFSET UNITYSDK_OFFSET(0x19FB0B10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_CONTAINS_OFFSET UNITYSDK_OFFSET(0x19FB0AD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_COPYFROMCOMPILEDSET_OFFSET UNITYSDK_OFFSET(0x19FAC960)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_COPYTO_OFFSET UNITYSDK_OFFSET(0x19FB35F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_FINDSCHEMABYNSANDURL_OFFSET UNITYSDK_OFFSET(0x19FAF000)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GETRESOLVER_OFFSET UNITYSDK_OFFSET(0x19FB5800)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GETSCHEMABYURI_OFFSET UNITYSDK_OFFSET(0x19FB5820)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GETSCHEMANAMES_OFFSET UNITYSDK_OFFSET(0x19FB5690)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GETTARGETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x19FB0580)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19FABBB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_GLOBALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19FABC40)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_GLOBALELEMENTS_OFFSET UNITYSDK_OFFSET(0x19FABBE0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_GLOBALTYPES_OFFSET UNITYSDK_OFFSET(0x19FABCA0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_INTERNALSYNCOBJECT_OFFSET UNITYSDK_OFFSET(0x19FAB5F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_SUBSTITUTIONGROUPS_OFFSET UNITYSDK_OFFSET(0x19FABD00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_GET_TYPEEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x19FABD60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_INTERNALVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x19FB59F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_ISSCHEMALOADED_OFFSET UNITYSDK_OFFSET(0x19FB42A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_PARSESCHEMA_OFFSET UNITYSDK_OFFSET(0x19FB4790)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_PREPROCESSSCHEMA_OFFSET UNITYSDK_OFFSET(0x19FB3490)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_PROCESSNEWSUBSTITUTIONGROUPS_OFFSET UNITYSDK_OFFSET(0x19FB4980)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVERECURSIVE_OFFSET UNITYSDK_OFFSET(0x19FAF620)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVESCHEMAFROMCACHES_OFFSET UNITYSDK_OFFSET(0x19FB2B60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVESCHEMAFROMGLOBALTABLES_OFFSET UNITYSDK_OFFSET(0x19FB1D60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVE_OFFSET UNITYSDK_OFFSET(0x19FB0650)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REMOVE_VALIDATIONEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x19FABAF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_REPROCESS_OFFSET UNITYSDK_OFFSET(0x19FB1410)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_RESOLVESUBSTITUTIONGROUP_OFFSET UNITYSDK_OFFSET(0x19FB4E70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_SCHEMAS_1_OFFSET UNITYSDK_OFFSET(0x19FB32F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_SCHEMAS_OFFSET UNITYSDK_OFFSET(0x19FB3760)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_SENDVALIDATIONEVENT_OFFSET UNITYSDK_OFFSET(0x19FB05B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_SET_XMLRESOLVER_OFFSET UNITYSDK_OFFSET(0x19FABB50)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET_VERIFYTABLES_OFFSET UNITYSDK_OFFSET(0x19FB5720)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FAB6F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMASET__CTOR_OFFSET UNITYSDK_OFFSET(0x19FAB630)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Xml::Schema::XmlSchemaObjectTable* schemaTypes; // 0x20
		...
		::System::Xml::Schema::XmlSchemaObjectTable* substitutionGroups; // 0x58
		::System::Xml::Schema::SchemaNames* schemaNames; // 0x60
		::System::Xml::XmlNameTable* nameTable; // 0x68
		::System::Xml::Schema::XmlSchemaObjectTable* typeExtensions; // 0x70
		::System::Collections::SortedList* schemas; // 0x78
		::System::Xml::Schema::SchemaInfo* cachedCompiledInfo; // 0x80
		::System::Xml::Schema::ValidationEventHandler* internalEventHandler; // 0x88
		::System::Collections::Hashtable* schemaLocations; // 0x90
