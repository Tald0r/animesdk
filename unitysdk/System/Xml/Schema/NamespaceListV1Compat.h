...
#define SYSTEM_XML_SCHEMA_NAMESPACELISTV1COMPAT_ALLOWS_OFFSET UNITYSDK_OFFSET(0x1AA8F560)
#define SYSTEM_XML_SCHEMA_NAMESPACELISTV1COMPAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA8F550)
