...
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_ADD_1_OFFSET UNITYSDK_OFFSET(0x1A0365F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_ADD_2_OFFSET UNITYSDK_OFFSET(0x1A036710)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1A0365C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A0360E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GETSCHEMAINFO_OFFSET UNITYSDK_OFFSET(0x1A0364A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GETSCHEMANAMES_OFFSET UNITYSDK_OFFSET(0x1A036530)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A035FC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A035FF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1A036140)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A036470)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1A036450)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1A036460)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A036080)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A035E80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A035DC0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		::System::Collections::Hashtable* collection; // 0x28
