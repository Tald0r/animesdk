...
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_ADD_1_OFFSET UNITYSDK_OFFSET(0x19A1C420)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_ADD_2_OFFSET UNITYSDK_OFFSET(0x19A1C540)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x19A1C3F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19A1BF10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GETSCHEMAINFO_OFFSET UNITYSDK_OFFSET(0x19A1C2D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GETSCHEMANAMES_OFFSET UNITYSDK_OFFSET(0x19A1C360)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19A1BDF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19A1BE20)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x19A1BF70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19A1C2A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19A1C280)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x19A1C290)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19A1BEB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A1BCB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMACOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19A1BBF0)
...
namespace System::Xml::Schema
{
	...
	{
	public:
		::System::Xml::Schema::ValidationEventHandler* validationEventHandler; // 0x10
		...
		::System::Xml::Schema::SchemaNames* schemaNames; // 0x38
