...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAPARTICLE_EMPTYPARTICLE_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A4E2470)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAPARTICLE_EMPTYPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E2480)
