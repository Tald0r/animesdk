...
#define SYSTEM_XML_SCHEMA_XMLBOOLEANCONVERTER_CHANGETYPE_1_OFFSET UNITYSDK_OFFSET(0x1913BF50)
#define SYSTEM_XML_SCHEMA_XMLBOOLEANCONVERTER_CHANGETYPE_2_OFFSET UNITYSDK_OFFSET(0x1913C1A0)
#define SYSTEM_XML_SCHEMA_XMLBOOLEANCONVERTER_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x1913BD10)
#define SYSTEM_XML_SCHEMA_XMLBOOLEANCONVERTER_CREATE_OFFSET UNITYSDK_OFFSET(0x1913B8D0)
#define SYSTEM_XML_SCHEMA_XMLBOOLEANCONVERTER_TOBOOLEAN_1_OFFSET UNITYSDK_OFFSET(0x1913B9A0)
#define SYSTEM_XML_SCHEMA_XMLBOOLEANCONVERTER_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1913B920)
#define SYSTEM_XML_SCHEMA_XMLBOOLEANCONVERTER_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1913BB90)
#define SYSTEM_XML_SCHEMA_XMLBOOLEANCONVERTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1913BB20)
#define SYSTEM_XML_SCHEMA_XMLBOOLEANCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1913B8C0)
