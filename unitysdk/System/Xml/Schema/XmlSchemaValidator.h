...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ADDIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x19472E80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ADDSCHEMA_OFFSET UNITYSDK_OFFSET(0x19467B50)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ADDXMLNAMESPACESCHEMA_OFFSET UNITYSDK_OFFSET(0x19473A60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ADD_VALIDATIONEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x19467A90)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ATTRIBUTEIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1946BE20)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_BUILDELEMENTNAME_1_OFFSET UNITYSDK_OFFSET(0x1946CA90)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_BUILDELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x19471930)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1946BA00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKELEMENTPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1946A7B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKELEMENTVALUE_OFFSET UNITYSDK_OFFSET(0x19472B10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKFORWARDREFS_OFFSET UNITYSDK_OFFSET(0x1946DF90)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKISXMLATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1946B640)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKMIXEDVALUECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1946F370)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKREQUIREDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1946C350)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKSTATETRANSITION_OFFSET UNITYSDK_OFFSET(0x19468DD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKTOKENIZEDTYPES_OFFSET UNITYSDK_OFFSET(0x1946BCC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKXSITYPEANDNIL_OFFSET UNITYSDK_OFFSET(0x19469CF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CLEARPSVI_OFFSET UNITYSDK_OFFSET(0x19468FF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_COMPLETEVALIDATIONERROR_OFFSET UNITYSDK_OFFSET(0x1946F490)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ELEMENTIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x19473460)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ELEMENTVALIDATIONERROR_OFFSET UNITYSDK_OFFSET(0x19471C40)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ENDELEMENTIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1946FC10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ENDVALIDATION_OFFSET UNITYSDK_OFFSET(0x1946DEA0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ENUMERATEANY_OFFSET UNITYSDK_OFFSET(0x19474E40)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_FASTGETELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x194696D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_FINDID_OFFSET UNITYSDK_OFFSET(0x19474080)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GETCONCATENATEDVALUE_OFFSET UNITYSDK_OFFSET(0x1946ECF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GETDEFAULTATTRIBUTEPREFIX_OFFSET UNITYSDK_OFFSET(0x1946E750)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GETSCHEMAELEMENT_OFFSET UNITYSDK_OFFSET(0x1946A8F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GETSUBSTITUTIONGROUPHEAD_OFFSET UNITYSDK_OFFSET(0x19471530)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0x19472DD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GETUNSPECIFIEDDEFAULTATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1946E090)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_CURRENTCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1946EBC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_HASIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1946BE00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_HASSCHEMA_OFFSET UNITYSDK_OFFSET(0x1946EC50)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_PROCESSIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x19472E70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_PROCESSSCHEMAHINTS_OFFSET UNITYSDK_OFFSET(0x19467A30)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_REPORTVALIDATIONWARNINGS_OFFSET UNITYSDK_OFFSET(0x19474390)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_STRICTLYASSESSED_OFFSET UNITYSDK_OFFSET(0x1946EC10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_INITIALIZE_1_OFFSET UNITYSDK_OFFSET(0x194685E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x194683F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_INIT_OFFSET UNITYSDK_OFFSET(0x19467310)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_INTERNALVALIDATEENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1946D4D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_LOADSCHEMA_OFFSET UNITYSDK_OFFSET(0x19470F70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_POP_OFFSET UNITYSDK_OFFSET(0x1946DD00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PRINTEXPECTEDELEMENTS_OFFSET UNITYSDK_OFFSET(0x1946CCE0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PRINTNAMESWITHNS_OFFSET UNITYSDK_OFFSET(0x19474460)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PRINTNAMES_OFFSET UNITYSDK_OFFSET(0x19474CC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PROCESSENTITY_OFFSET UNITYSDK_OFFSET(0x194740A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PROCESSSCHEMALOCATIONS_OFFSET UNITYSDK_OFFSET(0x19469970)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PROCESSTOKENIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x19473D80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PUSH_OFFSET UNITYSDK_OFFSET(0x19467720)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_QNAMESTRING_OFFSET UNITYSDK_OFFSET(0x1946CA00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_RECOMPILESCHEMASET_OFFSET UNITYSDK_OFFSET(0x19467920)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_REMOVE_VALIDATIONEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x19467AF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19467860)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SAVETEXTVALUE_OFFSET UNITYSDK_OFFSET(0x1946CA40)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_10_OFFSET UNITYSDK_OFFSET(0x194743B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_1_OFFSET UNITYSDK_OFFSET(0x1946B7B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_2_OFFSET UNITYSDK_OFFSET(0x1946B470)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_3_OFFSET UNITYSDK_OFFSET(0x194719A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_4_OFFSET UNITYSDK_OFFSET(0x19473AF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_5_OFFSET UNITYSDK_OFFSET(0x194681A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_6_OFFSET UNITYSDK_OFFSET(0x194743A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_7_OFFSET UNITYSDK_OFFSET(0x19471400)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_8_OFFSET UNITYSDK_OFFSET(0x19467FB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_9_OFFSET UNITYSDK_OFFSET(0x19474270)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_OFFSET UNITYSDK_OFFSET(0x19472E60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SETDTDSCHEMAINFO_OFFSET UNITYSDK_OFFSET(0x1946EC00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SET_LINEINFOPROVIDER_OFFSET UNITYSDK_OFFSET(0x19467A40)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SET_SOURCEURI_OFFSET UNITYSDK_OFFSET(0x19467A60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SKIPTOENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1946DAD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_THROWDECLNOTFOUNDWARNINGORERROR_OFFSET UNITYSDK_OFFSET(0x1946A580)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEATOMICVALUE_1_OFFSET UNITYSDK_OFFSET(0x1946EFF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEATOMICVALUE_OFFSET UNITYSDK_OFFSET(0x1946ED10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1946AB60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1946AAC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEELEMENTCONTEXT_OFFSET UNITYSDK_OFFSET(0x19469040)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEELEMENT_OFFSET UNITYSDK_OFFSET(0x19468890)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1946D4C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEENDOFATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1946C240)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATESTARTELEMENTIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1946A880)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATETEXT_1_OFFSET UNITYSDK_OFFSET(0x1946C570)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATETEXT_OFFSET UNITYSDK_OFFSET(0x1946C4F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEWHITESPACE_1_OFFSET UNITYSDK_OFFSET(0x1946D1C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1946D140)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x194751C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19467040)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Xml::Schema::XmlSchemaParticle*>**)Il2CppClass::FromTypeDefinitionIndex(XmlSchemaValidator_TypeDefinitionIndex)->GetStaticField(0x1B38);
		}
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(XmlSchemaValidator_TypeDefinitionIndex)->GetStaticField(0x1B50);
		}
		static ::Il2CppArray<::System::Xml::Schema::XmlSchemaAttribute*>** StaticGet_EmptyAttributeArray()
		{
			return (::Il2CppArray<::System::Xml::Schema::XmlSchemaAttribute*>**)Il2CppClass::FromTypeDefinitionIndex(XmlSchemaValidator_TypeDefinitionIndex)->GetStaticField(0x1B58);
		}
		static ::System::Xml::Schema::XmlSchemaDatatype** StaticGet_dtCDATA()
		{
			return (::System::Xml::Schema::XmlSchemaDatatype**)Il2CppClass::FromTypeDefinitionIndex(XmlSchemaValidator_TypeDefinitionIndex)->GetStaticField(0x1B60);
		}
		::System::String* NsXml; // 0x10
		::System::Xml::IXmlNamespaceResolver* nsResolver; // 0x18
		::System::Xml::Schema::ValidationEventHandler* eventHandler; // 0x20
		::System::Xml::IDtdInfo* dtdSchemaInfo; // 0x28
		::System::String* xsiNilString; // 0x30
		::System::Xml::Schema::SchemaAttDef* wildID; // 0x38
		::System::String* NsXs; // 0x40
		::System::Xml::Schema::ValidationState* context; // 0x48
		::System::String* NsXmlNs; // 0x50
		::System::Xml::HWStack* validationStack; // 0x58
		::System::Uri* sourceUri; // 0x60
		::System::Text::StringBuilder* textValue; // 0x68
		::System::Xml::Schema::XmlSchemaObject* partialValidationType; // 0x70
		::System::Collections::Hashtable* validatedNamespaces; // 0x78
		::System::Object* validationEventSender; // 0x80
		::System::String* xsiNoNamespaceSchemaLocationString; // 0x88
		::System::Xml::XmlQualifiedName* contextQName; // 0x90
		::System::Xml::XmlCharType xmlCharType; // 0x98
		::System::String* NsXsi; // 0xA0
		::System::Collections::Hashtable* IDs; // 0xA8
		::System::String* xsiSchemaLocationString; // 0xB0
		::System::Xml::IXmlLineInfo* positionInfo; // 0xB8
		::System::Xml::Schema::SchemaInfo* compiledSchemaInfo; // 0xC0
		::System::Xml::Schema::XmlSchemaSet* schemaSet; // 0xC8
		::System::String* xsiTypeString; // 0xD0
		::System::Xml::IXmlLineInfo* dummyPositionInfo; // 0xD8
		::System::Xml::XmlResolver* xmlResolver; // 0xE0
		::System::Xml::Schema::IdRefNode* idRefListHead; // 0xE8
		::System::String* sourceUriString; // 0xF0
		::System::Collections::Hashtable* attPresence; // 0xF8
		::System::Xml::XmlNameTable* nameTable; // 0x100
		::System::Xml::Schema::XmlSchemaContentProcessing processContents; // 0x108
		::System::Int32 startIDConstraint; // 0x10C
		::System::Xml::Schema::XmlSchemaValidationFlags validationFlags; // 0x110
		::System::Boolean attrValid; // 0x114
		::System::Boolean isRoot; // 0x115
		::System::Boolean checkEntity; // 0x116
		::System::Boolean rootHasSchema; // 0x117
		::System::Xml::Schema::ValidatorState currentState; // 0x118
