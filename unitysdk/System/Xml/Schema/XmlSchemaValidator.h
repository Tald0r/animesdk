...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ADDIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1988AFD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ADDSCHEMA_OFFSET UNITYSDK_OFFSET(0x1987FBD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ADDXMLNAMESPACESCHEMA_OFFSET UNITYSDK_OFFSET(0x1988BBD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ADD_VALIDATIONEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1987FB10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ATTRIBUTEIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x19883F00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_BUILDELEMENTNAME_1_OFFSET UNITYSDK_OFFSET(0x19884B80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_BUILDELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x19889A70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x19883AD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKELEMENTPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19882880)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKELEMENTVALUE_OFFSET UNITYSDK_OFFSET(0x1988AC50)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKFORWARDREFS_OFFSET UNITYSDK_OFFSET(0x198860A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKISXMLATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19883710)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKMIXEDVALUECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x198874A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKREQUIREDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19884430)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKSTATETRANSITION_OFFSET UNITYSDK_OFFSET(0x19880E80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKTOKENIZEDTYPES_OFFSET UNITYSDK_OFFSET(0x19883DA0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CHECKXSITYPEANDNIL_OFFSET UNITYSDK_OFFSET(0x19881DB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_CLEARPSVI_OFFSET UNITYSDK_OFFSET(0x198810A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_COMPLETEVALIDATIONERROR_OFFSET UNITYSDK_OFFSET(0x198875C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ELEMENTIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1988B5D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ELEMENTVALIDATIONERROR_OFFSET UNITYSDK_OFFSET(0x19889D80)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ENDELEMENTIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x19887D40)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ENDVALIDATION_OFFSET UNITYSDK_OFFSET(0x19885FB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_ENUMERATEANY_OFFSET UNITYSDK_OFFSET(0x1988CF90)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_FASTGETELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x19881790)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_FINDID_OFFSET UNITYSDK_OFFSET(0x1988C1D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GETCONCATENATEDVALUE_OFFSET UNITYSDK_OFFSET(0x19886E00)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GETDEFAULTATTRIBUTEPREFIX_OFFSET UNITYSDK_OFFSET(0x19886850)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GETSCHEMAELEMENT_OFFSET UNITYSDK_OFFSET(0x198829D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GETSUBSTITUTIONGROUPHEAD_OFFSET UNITYSDK_OFFSET(0x19889680)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0x1988AF20)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GETUNSPECIFIEDDEFAULTATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19886190)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_CURRENTCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x19886CC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_HASIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x19883EE0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_HASSCHEMA_OFFSET UNITYSDK_OFFSET(0x19886D60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_PROCESSIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1988AFC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_PROCESSSCHEMAHINTS_OFFSET UNITYSDK_OFFSET(0x1987FAB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_REPORTVALIDATIONWARNINGS_OFFSET UNITYSDK_OFFSET(0x1988C4E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_GET_STRICTLYASSESSED_OFFSET UNITYSDK_OFFSET(0x19886D20)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_INITIALIZE_1_OFFSET UNITYSDK_OFFSET(0x19880670)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19880480)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_INIT_OFFSET UNITYSDK_OFFSET(0x1987F380)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_INTERNALVALIDATEENDELEMENT_OFFSET UNITYSDK_OFFSET(0x198855C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_LOADSCHEMA_OFFSET UNITYSDK_OFFSET(0x198890C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_POP_OFFSET UNITYSDK_OFFSET(0x19885E10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PRINTEXPECTEDELEMENTS_OFFSET UNITYSDK_OFFSET(0x19884DD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PRINTNAMESWITHNS_OFFSET UNITYSDK_OFFSET(0x1988C5B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PRINTNAMES_OFFSET UNITYSDK_OFFSET(0x1988CE10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PROCESSENTITY_OFFSET UNITYSDK_OFFSET(0x1988C1F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PROCESSSCHEMALOCATIONS_OFFSET UNITYSDK_OFFSET(0x19881A30)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PROCESSTOKENIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x1988BEE0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_PUSH_OFFSET UNITYSDK_OFFSET(0x1987F780)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_QNAMESTRING_OFFSET UNITYSDK_OFFSET(0x19884AF0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_RECOMPILESCHEMASET_OFFSET UNITYSDK_OFFSET(0x1987F9A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_REMOVE_VALIDATIONEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1987FB70)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1987F8D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SAVETEXTVALUE_OFFSET UNITYSDK_OFFSET(0x19884B30)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_10_OFFSET UNITYSDK_OFFSET(0x1988C500)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_1_OFFSET UNITYSDK_OFFSET(0x19883880)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_2_OFFSET UNITYSDK_OFFSET(0x19883550)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_3_OFFSET UNITYSDK_OFFSET(0x19889AE0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_4_OFFSET UNITYSDK_OFFSET(0x1988BC60)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_5_OFFSET UNITYSDK_OFFSET(0x19880230)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_6_OFFSET UNITYSDK_OFFSET(0x1988C4F0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_7_OFFSET UNITYSDK_OFFSET(0x19889550)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_8_OFFSET UNITYSDK_OFFSET(0x19880050)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_9_OFFSET UNITYSDK_OFFSET(0x1988C3C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SENDVALIDATIONEVENT_OFFSET UNITYSDK_OFFSET(0x1988AFB0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SETDTDSCHEMAINFO_OFFSET UNITYSDK_OFFSET(0x19886D10)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SET_LINEINFOPROVIDER_OFFSET UNITYSDK_OFFSET(0x1987FAC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SET_SOURCEURI_OFFSET UNITYSDK_OFFSET(0x1987FAE0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_SKIPTOENDELEMENT_OFFSET UNITYSDK_OFFSET(0x19885BD0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_THROWDECLNOTFOUNDWARNINGORERROR_OFFSET UNITYSDK_OFFSET(0x19882650)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEATOMICVALUE_1_OFFSET UNITYSDK_OFFSET(0x19887110)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEATOMICVALUE_OFFSET UNITYSDK_OFFSET(0x19886E20)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x19882C40)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19882BA0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEELEMENTCONTEXT_OFFSET UNITYSDK_OFFSET(0x198810E0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEELEMENT_OFFSET UNITYSDK_OFFSET(0x19880930)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEENDELEMENT_OFFSET UNITYSDK_OFFSET(0x198855B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEENDOFATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19884320)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATESTARTELEMENTIDENTITYCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x19882960)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATETEXT_1_OFFSET UNITYSDK_OFFSET(0x19884640)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATETEXT_OFFSET UNITYSDK_OFFSET(0x198845C0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEWHITESPACE_1_OFFSET UNITYSDK_OFFSET(0x198852B0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR_VALIDATEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x19885230)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1988D310)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1987F0A0)
...
namespace System::Xml::Schema
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(XmlSchemaValidator_TypeDefinitionIndex)->GetStaticField(0x1B48);
		}
		static ::Il2CppArray<::System::Xml::Schema::XmlSchemaParticle*>** StaticGet_EmptyParticleArray()
		{
			return (::Il2CppArray<::System::Xml::Schema::XmlSchemaParticle*>**)Il2CppClass::FromTypeDefinitionIndex(XmlSchemaValidator_TypeDefinitionIndex)->GetStaticField(0x1B50);
		}
		static ::System::Xml::Schema::XmlSchemaDatatype** StaticGet_dtCDATA()
		{
			return (::System::Xml::Schema::XmlSchemaDatatype**)Il2CppClass::FromTypeDefinitionIndex(XmlSchemaValidator_TypeDefinitionIndex)->GetStaticField(0x1B58);
		}
		static ::Il2CppArray<::System::Xml::Schema::XmlSchemaAttribute*>** StaticGet_EmptyAttributeArray()
		{
			return (::Il2CppArray<::System::Xml::Schema::XmlSchemaAttribute*>**)Il2CppClass::FromTypeDefinitionIndex(XmlSchemaValidator_TypeDefinitionIndex)->GetStaticField(0x1B60);
		}
		::System::String* NsXml; // 0x10
		::System::Xml::Schema::SchemaAttDef* wildID; // 0x18
		::System::String* sourceUriString; // 0x20
		::System::Xml::IXmlLineInfo* positionInfo; // 0x28
		::System::Collections::Hashtable* attPresence; // 0x30
		::System::String* xsiSchemaLocationString; // 0x38
		::System::Text::StringBuilder* textValue; // 0x40
		::System::Xml::Schema::IdRefNode* idRefListHead; // 0x48
		::System::Uri* sourceUri; // 0x50
		::System::Xml::XmlQualifiedName* contextQName; // 0x58
		::System::Xml::HWStack* validationStack; // 0x60
		::System::String* NsXs; // 0x68
		::System::Xml::IDtdInfo* dtdSchemaInfo; // 0x70
		::System::Xml::Schema::ValidationEventHandler* eventHandler; // 0x78
		::System::Xml::XmlNameTable* nameTable; // 0x80
		::System::Collections::Hashtable* validatedNamespaces; // 0x88
		::System::Xml::Schema::XmlSchemaSet* schemaSet; // 0x90
		::System::Collections::Hashtable* IDs; // 0x98
		::System::String* xsiNoNamespaceSchemaLocationString; // 0xA0
		...
		::System::Xml::Schema::XmlSchemaObject* partialValidationType; // 0xC8
		::System::Xml::Schema::SchemaInfo* compiledSchemaInfo; // 0xD0
		::System::String* xsiTypeString; // 0xD8
		::System::Xml::XmlCharType xmlCharType; // 0xE0
		::System::Xml::IXmlNamespaceResolver* nsResolver; // 0xE8
		::System::Xml::Schema::ValidationState* context; // 0xF0
		::System::Xml::IXmlLineInfo* dummyPositionInfo; // 0xF8
		::System::String* xsiNilString; // 0x100
