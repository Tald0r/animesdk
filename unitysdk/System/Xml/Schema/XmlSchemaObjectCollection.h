...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_ADD_1_OFFSET UNITYSDK_OFFSET(0x19480620)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x19480310)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_CLONE_OFFSET UNITYSDK_OFFSET(0x19480590)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19480260)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19480090)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_INSERT_OFFSET UNITYSDK_OFFSET(0x194803D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x19480570)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_ONINSERT_OFFSET UNITYSDK_OFFSET(0x19480550)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_ONREMOVE_OFFSET UNITYSDK_OFFSET(0x19480580)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_ONSET_OFFSET UNITYSDK_OFFSET(0x19480560)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x19480490)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x194801A0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAOBJECTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19480040)
