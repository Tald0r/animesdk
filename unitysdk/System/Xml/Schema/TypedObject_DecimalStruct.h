...
#define SYSTEM_XML_SCHEMA_TYPEDOBJECT_DECIMALSTRUCT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x194594D0)
#define SYSTEM_XML_SCHEMA_TYPEDOBJECT_DECIMALSTRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x194594A0)
