...
#define SYSTEM_XML_SCHEMA_TYPEDOBJECT_DECIMALSTRUCT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19871550)
#define SYSTEM_XML_SCHEMA_TYPEDOBJECT_DECIMALSTRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x19871520)
