...
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANY_ALLOWS_OFFSET UNITYSDK_OFFSET(0x195A0350)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANY_BUILDNAMESPACELISTV1COMPAT_OFFSET UNITYSDK_OFFSET(0x195A02D0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANY_BUILDNAMESPACELIST_OFFSET UNITYSDK_OFFSET(0x195A0260)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANY_GET_NAMESTRING_OFFSET UNITYSDK_OFFSET(0x1959FC40)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANY_GET_PROCESSCONTENTSCORRECT_OFFSET UNITYSDK_OFFSET(0x1959FC20)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANY_GET_RESOLVEDNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1959FBC0)
#define SYSTEM_XML_SCHEMA_XMLSCHEMAANY__CTOR_OFFSET UNITYSDK_OFFSET(0x195A0390)
