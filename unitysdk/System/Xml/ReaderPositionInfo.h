...
#define SYSTEM_XML_READERPOSITIONINFO_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x19ED4240)
#define SYSTEM_XML_READERPOSITIONINFO_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x19ED4320)
#define SYSTEM_XML_READERPOSITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19ED4230)
