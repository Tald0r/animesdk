...
#define SYSTEM_XML_READERPOSITIONINFO_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1A4D37F0)
#define SYSTEM_XML_READERPOSITIONINFO_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4D38D0)
#define SYSTEM_XML_READERPOSITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4D37E0)
