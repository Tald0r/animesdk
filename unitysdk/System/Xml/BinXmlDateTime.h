...
#define SYSTEM_XML_BINXMLDATETIME_BREAKDOWNXSDDATETIME_OFFSET UNITYSDK_OFFSET(0x19477B40)
#define SYSTEM_XML_BINXMLDATETIME_BREAKDOWNXSDDATE_OFFSET UNITYSDK_OFFSET(0x19477D50)
#define SYSTEM_XML_BINXMLDATETIME_BREAKDOWNXSDTIME_OFFSET UNITYSDK_OFFSET(0x19477EE0)
#define SYSTEM_XML_BINXMLDATETIME_GETFRACTIONS_1_OFFSET UNITYSDK_OFFSET(0x1947A470)
#define SYSTEM_XML_BINXMLDATETIME_GETFRACTIONS_OFFSET UNITYSDK_OFFSET(0x19479BF0)
#define SYSTEM_XML_BINXMLDATETIME_GETKATMAIDATETICKS_OFFSET UNITYSDK_OFFSET(0x19478D80)
#define SYSTEM_XML_BINXMLDATETIME_GETKATMAITIMETICKS_OFFSET UNITYSDK_OFFSET(0x19478EE0)
#define SYSTEM_XML_BINXMLDATETIME_GETKATMAITIMEZONETICKS_OFFSET UNITYSDK_OFFSET(0x194794A0)
#define SYSTEM_XML_BINXMLDATETIME_SQLDATETIMETODATETIME_OFFSET UNITYSDK_OFFSET(0x19478970)
#define SYSTEM_XML_BINXMLDATETIME_SQLDATETIMETOSTRING_OFFSET UNITYSDK_OFFSET(0x19478750)
#define SYSTEM_XML_BINXMLDATETIME_SQLSMALLDATETIMETODATETIME_OFFSET UNITYSDK_OFFSET(0x19478B40)
#define SYSTEM_XML_BINXMLDATETIME_SQLSMALLDATETIMETOSTRING_OFFSET UNITYSDK_OFFSET(0x19478A90)
#define SYSTEM_XML_BINXMLDATETIME_WRITE2DIG_OFFSET UNITYSDK_OFFSET(0x194770A0)
#define SYSTEM_XML_BINXMLDATETIME_WRITE3DEC_OFFSET UNITYSDK_OFFSET(0x19477210)
#define SYSTEM_XML_BINXMLDATETIME_WRITE4DIGNEG_OFFSET UNITYSDK_OFFSET(0x19477100)
#define SYSTEM_XML_BINXMLDATETIME_WRITEDATE_OFFSET UNITYSDK_OFFSET(0x194772D0)
#define SYSTEM_XML_BINXMLDATETIME_WRITETIMEFULLPRECISION_OFFSET UNITYSDK_OFFSET(0x19477610)
#define SYSTEM_XML_BINXMLDATETIME_WRITETIMEZONE_1_OFFSET UNITYSDK_OFFSET(0x19477A10)
#define SYSTEM_XML_BINXMLDATETIME_WRITETIMEZONE_OFFSET UNITYSDK_OFFSET(0x194778C0)
#define SYSTEM_XML_BINXMLDATETIME_WRITETIME_OFFSET UNITYSDK_OFFSET(0x194773F0)
#define SYSTEM_XML_BINXMLDATETIME_XSDDATETIMETOSTRING_OFFSET UNITYSDK_OFFSET(0x19478010)
#define SYSTEM_XML_BINXMLDATETIME_XSDDATETOSTRING_OFFSET UNITYSDK_OFFSET(0x194782F0)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATEOFFSETTODATETIMEOFFSET_OFFSET UNITYSDK_OFFSET(0x19479310)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATEOFFSETTOSTRING_OFFSET UNITYSDK_OFFSET(0x1947A090)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATETIMEOFFSETTODATETIMEOFFSET_OFFSET UNITYSDK_OFFSET(0x19479390)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATETIMEOFFSETTOSTRING_OFFSET UNITYSDK_OFFSET(0x1947A220)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATETIMETODATETIME_OFFSET UNITYSDK_OFFSET(0x19478E20)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATETIMETOSTRING_OFFSET UNITYSDK_OFFSET(0x19479830)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATETODATETIME_OFFSET UNITYSDK_OFFSET(0x19478CD0)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATETOSTRING_OFFSET UNITYSDK_OFFSET(0x19479590)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAITIMEOFFSETTODATETIMEOFFSET_OFFSET UNITYSDK_OFFSET(0x19479510)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAITIMEOFFSETTOSTRING_OFFSET UNITYSDK_OFFSET(0x1947A540)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAITIMETODATETIME_OFFSET UNITYSDK_OFFSET(0x194791F0)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAITIMETOSTRING_OFFSET UNITYSDK_OFFSET(0x19479DD0)
#define SYSTEM_XML_BINXMLDATETIME_XSDTIMETOSTRING_OFFSET UNITYSDK_OFFSET(0x19478550)
#define SYSTEM_XML_BINXMLDATETIME__CCTOR_OFFSET UNITYSDK_OFFSET(0x1947A7C0)
#define SYSTEM_XML_BINXMLDATETIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1947A7B0)
