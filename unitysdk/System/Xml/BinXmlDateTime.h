...
#define SYSTEM_XML_BINXMLDATETIME_BREAKDOWNXSDDATETIME_OFFSET UNITYSDK_OFFSET(0x19104750)
#define SYSTEM_XML_BINXMLDATETIME_BREAKDOWNXSDDATE_OFFSET UNITYSDK_OFFSET(0x19104960)
#define SYSTEM_XML_BINXMLDATETIME_BREAKDOWNXSDTIME_OFFSET UNITYSDK_OFFSET(0x19104AF0)
#define SYSTEM_XML_BINXMLDATETIME_GETFRACTIONS_1_OFFSET UNITYSDK_OFFSET(0x19107080)
#define SYSTEM_XML_BINXMLDATETIME_GETFRACTIONS_OFFSET UNITYSDK_OFFSET(0x19106800)
#define SYSTEM_XML_BINXMLDATETIME_GETKATMAIDATETICKS_OFFSET UNITYSDK_OFFSET(0x19105990)
#define SYSTEM_XML_BINXMLDATETIME_GETKATMAITIMETICKS_OFFSET UNITYSDK_OFFSET(0x19105AF0)
#define SYSTEM_XML_BINXMLDATETIME_GETKATMAITIMEZONETICKS_OFFSET UNITYSDK_OFFSET(0x191060B0)
#define SYSTEM_XML_BINXMLDATETIME_SQLDATETIMETODATETIME_OFFSET UNITYSDK_OFFSET(0x19105580)
#define SYSTEM_XML_BINXMLDATETIME_SQLDATETIMETOSTRING_OFFSET UNITYSDK_OFFSET(0x19105360)
#define SYSTEM_XML_BINXMLDATETIME_SQLSMALLDATETIMETODATETIME_OFFSET UNITYSDK_OFFSET(0x19105750)
#define SYSTEM_XML_BINXMLDATETIME_SQLSMALLDATETIMETOSTRING_OFFSET UNITYSDK_OFFSET(0x191056A0)
#define SYSTEM_XML_BINXMLDATETIME_WRITE2DIG_OFFSET UNITYSDK_OFFSET(0x19103CB0)
#define SYSTEM_XML_BINXMLDATETIME_WRITE3DEC_OFFSET UNITYSDK_OFFSET(0x19103E20)
#define SYSTEM_XML_BINXMLDATETIME_WRITE4DIGNEG_OFFSET UNITYSDK_OFFSET(0x19103D10)
#define SYSTEM_XML_BINXMLDATETIME_WRITEDATE_OFFSET UNITYSDK_OFFSET(0x19103EE0)
#define SYSTEM_XML_BINXMLDATETIME_WRITETIMEFULLPRECISION_OFFSET UNITYSDK_OFFSET(0x19104220)
#define SYSTEM_XML_BINXMLDATETIME_WRITETIMEZONE_1_OFFSET UNITYSDK_OFFSET(0x19104620)
#define SYSTEM_XML_BINXMLDATETIME_WRITETIMEZONE_OFFSET UNITYSDK_OFFSET(0x191044D0)
#define SYSTEM_XML_BINXMLDATETIME_WRITETIME_OFFSET UNITYSDK_OFFSET(0x19104000)
#define SYSTEM_XML_BINXMLDATETIME_XSDDATETIMETOSTRING_OFFSET UNITYSDK_OFFSET(0x19104C20)
#define SYSTEM_XML_BINXMLDATETIME_XSDDATETOSTRING_OFFSET UNITYSDK_OFFSET(0x19104F00)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATEOFFSETTODATETIMEOFFSET_OFFSET UNITYSDK_OFFSET(0x19105F20)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATEOFFSETTOSTRING_OFFSET UNITYSDK_OFFSET(0x19106CA0)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATETIMEOFFSETTODATETIMEOFFSET_OFFSET UNITYSDK_OFFSET(0x19105FA0)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATETIMEOFFSETTOSTRING_OFFSET UNITYSDK_OFFSET(0x19106E30)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATETIMETODATETIME_OFFSET UNITYSDK_OFFSET(0x19105A30)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATETIMETOSTRING_OFFSET UNITYSDK_OFFSET(0x19106440)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATETODATETIME_OFFSET UNITYSDK_OFFSET(0x191058E0)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAIDATETOSTRING_OFFSET UNITYSDK_OFFSET(0x191061A0)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAITIMEOFFSETTODATETIMEOFFSET_OFFSET UNITYSDK_OFFSET(0x19106120)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAITIMEOFFSETTOSTRING_OFFSET UNITYSDK_OFFSET(0x19107150)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAITIMETODATETIME_OFFSET UNITYSDK_OFFSET(0x19105E00)
#define SYSTEM_XML_BINXMLDATETIME_XSDKATMAITIMETOSTRING_OFFSET UNITYSDK_OFFSET(0x191069E0)
#define SYSTEM_XML_BINXMLDATETIME_XSDTIMETOSTRING_OFFSET UNITYSDK_OFFSET(0x19105160)
#define SYSTEM_XML_BINXMLDATETIME__CCTOR_OFFSET UNITYSDK_OFFSET(0x191073D0)
#define SYSTEM_XML_BINXMLDATETIME__CTOR_OFFSET UNITYSDK_OFFSET(0x191073C0)
