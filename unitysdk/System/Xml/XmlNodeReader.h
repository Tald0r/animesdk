...
#define SYSTEM_XML_XMLNODEREADER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A273520)
#define SYSTEM_XML_XMLNODEREADER_FINISHREADBINARY_OFFSET UNITYSDK_OFFSET(0x1A272700)
#define SYSTEM_XML_XMLNODEREADER_GETATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1A272530)
#define SYSTEM_XML_XMLNODEREADER_GETATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x1A272570)
#define SYSTEM_XML_XMLNODEREADER_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A272500)
#define SYSTEM_XML_XMLNODEREADER_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x1A2724D0)
#define SYSTEM_XML_XMLNODEREADER_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x1A272330)
#define SYSTEM_XML_XMLNODEREADER_GET_CANRESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1A272370)
#define SYSTEM_XML_XMLNODEREADER_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1A272320)
#define SYSTEM_XML_XMLNODEREADER_GET_DTDINFO_OFFSET UNITYSDK_OFFSET(0x1A273800)
#define SYSTEM_XML_XMLNODEREADER_GET_EOF_OFFSET UNITYSDK_OFFSET(0x1A273500)
#define SYSTEM_XML_XMLNODEREADER_GET_HASATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A2735E0)
#define SYSTEM_XML_XMLNODEREADER_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x1A2723B0)
#define SYSTEM_XML_XMLNODEREADER_GET_ISEMPTYELEMENT_OFFSET UNITYSDK_OFFSET(0x1A272380)
#define SYSTEM_XML_XMLNODEREADER_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1A2721B0)
#define SYSTEM_XML_XMLNODEREADER_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1A272240)
#define SYSTEM_XML_XMLNODEREADER_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x1A273620)
#define SYSTEM_XML_XMLNODEREADER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A272170)
#define SYSTEM_XML_XMLNODEREADER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1A272160)
#define SYSTEM_XML_XMLNODEREADER_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1A272290)
#define SYSTEM_XML_XMLNODEREADER_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1A273530)
#define SYSTEM_XML_XMLNODEREADER_GET_SCHEMAINFO_OFFSET UNITYSDK_OFFSET(0x1A272480)
#define SYSTEM_XML_XMLNODEREADER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A2722E0)
#define SYSTEM_XML_XMLNODEREADER_GET_XMLLANG_OFFSET UNITYSDK_OFFSET(0x1A272430)
#define SYSTEM_XML_XMLNODEREADER_GET_XMLSPACE_OFFSET UNITYSDK_OFFSET(0x1A2723E0)
#define SYSTEM_XML_XMLNODEREADER_ISINREADINGSTATES_OFFSET UNITYSDK_OFFSET(0x1A272150)
#define SYSTEM_XML_XMLNODEREADER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A273640)
#define SYSTEM_XML_XMLNODEREADER_MOVETOATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1A272720)
#define SYSTEM_XML_XMLNODEREADER_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A2725F0)
#define SYSTEM_XML_XMLNODEREADER_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x1A272B70)
#define SYSTEM_XML_XMLNODEREADER_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A272920)
#define SYSTEM_XML_XMLNODEREADER_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A272A50)
#define SYSTEM_XML_XMLNODEREADER_READATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1A273700)
#define SYSTEM_XML_XMLNODEREADER_READATZEROLEVEL_OFFSET UNITYSDK_OFFSET(0x1A273470)
#define SYSTEM_XML_XMLNODEREADER_READFORWARD_OFFSET UNITYSDK_OFFSET(0x1A273220)
#define SYSTEM_XML_XMLNODEREADER_READNEXTNODE_OFFSET UNITYSDK_OFFSET(0x1A272E80)
#define SYSTEM_XML_XMLNODEREADER_READSTRING_OFFSET UNITYSDK_OFFSET(0x1A273550)
#define SYSTEM_XML_XMLNODEREADER_READ_1_OFFSET UNITYSDK_OFFSET(0x1A272CE0)
#define SYSTEM_XML_XMLNODEREADER_READ_OFFSET UNITYSDK_OFFSET(0x1A272CD0)
#define SYSTEM_XML_XMLNODEREADER_RESETREADINGMARKS_OFFSET UNITYSDK_OFFSET(0x1A2731F0)
#define SYSTEM_XML_XMLNODEREADER_RESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1A273680)
#define SYSTEM_XML_XMLNODEREADER_SETENDOFFILE_OFFSET UNITYSDK_OFFSET(0x1A273450)
#define SYSTEM_XML_XMLNODEREADER_SKIP_OFFSET UNITYSDK_OFFSET(0x1A273540)
#define SYSTEM_XML_XMLNODEREADER_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1A273750)
#define SYSTEM_XML_XMLNODEREADER_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A273790)
#define SYSTEM_XML_XMLNODEREADER_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1A273770)
#define SYSTEM_XML_XMLNODEREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A272090)
...
namespace System::Xml
{
	...
	{
	public:
		::System::Xml::ReadContentAsBinaryHelper* readBinaryHelper; // 0x10
		::System::Xml::XmlNodeReaderNavigator* readerNav; // 0x18
		::System::Int32 curDepth; // 0x20
		::System::Xml::ReadState readState; // 0x24
		::System::Boolean bInReadBinary; // 0x28
		::System::Boolean bStartFromDocument; // 0x29
		::System::Boolean fEOF; // 0x2A
		::System::Boolean bResolveEntity; // 0x2B
		::System::Xml::XmlNodeType nodeType; // 0x2C
