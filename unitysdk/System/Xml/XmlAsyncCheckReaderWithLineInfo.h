...
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFO_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1A04C330)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFO_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A04C410)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04C240)
