...
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFO_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x19A31FF0)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFO_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x19A320D0)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19A31F00)
