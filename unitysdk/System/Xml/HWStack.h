...
#define SYSTEM_XML_HWSTACK_ADDTOTOP_OFFSET UNITYSDK_OFFSET(0x19A15D20)
#define SYSTEM_XML_HWSTACK_CLONE_OFFSET UNITYSDK_OFFSET(0x19A15F50)
#define SYSTEM_XML_HWSTACK_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19A15DB0)
#define SYSTEM_XML_HWSTACK_PEEK_OFFSET UNITYSDK_OFFSET(0x19A15CD0)
#define SYSTEM_XML_HWSTACK_POP_OFFSET UNITYSDK_OFFSET(0x19A15C80)
#define SYSTEM_XML_HWSTACK_PUSH_OFFSET UNITYSDK_OFFSET(0x19A15B90)
#define SYSTEM_XML_HWSTACK_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19A15E40)
#define SYSTEM_XML_HWSTACK__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A15B50)
#define SYSTEM_XML_HWSTACK__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19A15F30)
#define SYSTEM_XML_HWSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A15B10)
