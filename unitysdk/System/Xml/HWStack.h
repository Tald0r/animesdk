...
#define SYSTEM_XML_HWSTACK_ADDTOTOP_OFFSET UNITYSDK_OFFSET(0x1A02FEF0)
#define SYSTEM_XML_HWSTACK_CLONE_OFFSET UNITYSDK_OFFSET(0x1A030120)
#define SYSTEM_XML_HWSTACK_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A02FF80)
#define SYSTEM_XML_HWSTACK_PEEK_OFFSET UNITYSDK_OFFSET(0x1A02FEA0)
#define SYSTEM_XML_HWSTACK_POP_OFFSET UNITYSDK_OFFSET(0x1A02FE50)
#define SYSTEM_XML_HWSTACK_PUSH_OFFSET UNITYSDK_OFFSET(0x1A02FD60)
#define SYSTEM_XML_HWSTACK_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A030010)
#define SYSTEM_XML_HWSTACK__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A02FD20)
#define SYSTEM_XML_HWSTACK__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A030100)
#define SYSTEM_XML_HWSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A02FCE0)
...
namespace System::Xml
{
	...
	public:
		...
		::System::Int32 limit; // 0x1C
		::System::Int32 used; // 0x20
