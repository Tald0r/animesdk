...
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHNS_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1AC36450)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHNS_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1AC36530)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHNS_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1AC36610)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHNS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC36360)
