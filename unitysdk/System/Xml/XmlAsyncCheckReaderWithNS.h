...
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHNS_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1A68B170)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHNS_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A68B250)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHNS_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1A68B330)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHNS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A68B080)
