...
#define SYSTEM_XML_XMLURLRESOLVER__GETENTITYASYNC_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x93CD80)
#define SYSTEM_XML_XMLURLRESOLVER__GETENTITYASYNC_D__15_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x30F550)
...
namespace System::Xml
{
	...
	struct alignas(8) XmlUrlResolver__GetEntityAsync_d__15
	{
		...
		::System::Type* ofObjectToReturn; // 0x18
