...
#define SYSTEM_XML_XMLPARSERCONTEXT_GET_HASDTDINFO_OFFSET UNITYSDK_OFFSET(0x19127590)
#define SYSTEM_XML_XMLPARSERCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191273B0)
#define SYSTEM_XML_XMLPARSERCONTEXT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19127400)
#define SYSTEM_XML_XMLPARSERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19127360)
...
namespace System::Xml
{
	...
	public:
		...
		::System::Text::Encoding* _encoding; // 0x50
