...
#define SYSTEM_XML_XMLREADERSETTINGS_ADDVALIDATION_OFFSET UNITYSDK_OFFSET(0x19AD9B30)
#define SYSTEM_XML_XMLREADERSETTINGS_CHECKREADONLY_OFFSET UNITYSDK_OFFSET(0x19AD90A0)
#define SYSTEM_XML_XMLREADERSETTINGS_CLONE_OFFSET UNITYSDK_OFFSET(0x19AD96F0)
#define SYSTEM_XML_XMLREADERSETTINGS_CREATEDEFAULTRESOLVER_OFFSET UNITYSDK_OFFSET(0x19AD9EF0)
#define SYSTEM_XML_XMLREADERSETTINGS_CREATEDTDVALIDATINGREADER_OFFSET UNITYSDK_OFFSET(0x19AD9FC0)
#define SYSTEM_XML_XMLREADERSETTINGS_CREATEREADER_1_OFFSET UNITYSDK_OFFSET(0x19AD9CB0)
#define SYSTEM_XML_XMLREADERSETTINGS_CREATEREADER_OFFSET UNITYSDK_OFFSET(0x19AD97E0)
#define SYSTEM_XML_XMLREADERSETTINGS_ENABLELEGACYXMLSETTINGS_OFFSET UNITYSDK_OFFSET(0x19AD9F30)
#define SYSTEM_XML_XMLREADERSETTINGS_GET_SCHEMAS_OFFSET UNITYSDK_OFFSET(0x19AD21C0)
#define SYSTEM_XML_XMLREADERSETTINGS_INITIALIZE_1_OFFSET UNITYSDK_OFFSET(0x19AD9E70)
#define SYSTEM_XML_XMLREADERSETTINGS_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19AD8FE0)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_ASYNC_OFFSET UNITYSDK_OFFSET(0x19AD9060)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_CHECKCHARACTERS_OFFSET UNITYSDK_OFFSET(0x19AD92E0)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_CLOSEINPUT_OFFSET UNITYSDK_OFFSET(0x19AD9560)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_CONFORMANCELEVEL_OFFSET UNITYSDK_OFFSET(0x19AD9260)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_DTDPROCESSING_OFFSET UNITYSDK_OFFSET(0x19AD94E0)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_IGNORECOMMENTS_OFFSET UNITYSDK_OFFSET(0x19AD94A0)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_IGNOREPROCESSINGINSTRUCTIONS_OFFSET UNITYSDK_OFFSET(0x19AD9460)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_IGNOREWHITESPACE_OFFSET UNITYSDK_OFFSET(0x19AD9420)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_LINENUMBEROFFSET_OFFSET UNITYSDK_OFFSET(0x19AD91E0)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_LINEPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x19AD9220)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_MAXCHARACTERSFROMENTITIES_OFFSET UNITYSDK_OFFSET(0x19AD93A0)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_MAXCHARACTERSINDOCUMENT_OFFSET UNITYSDK_OFFSET(0x19AD9320)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x19AD9140)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_SCHEMAS_OFFSET UNITYSDK_OFFSET(0x19AD96A0)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_VALIDATIONFLAGS_OFFSET UNITYSDK_OFFSET(0x19AD9620)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_VALIDATIONTYPE_OFFSET UNITYSDK_OFFSET(0x19AD95A0)
#define SYSTEM_XML_XMLREADERSETTINGS_SET_XMLRESOLVER_OFFSET UNITYSDK_OFFSET(0x19AD9190)
#define SYSTEM_XML_XMLREADERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD8F60)
...
namespace System::Xml
{
	...
	public:
		...
		::System::Boolean checkCharacters; // 0x40
		::System::Boolean useAsync; // 0x41
		::System::Boolean _IsXmlResolverSet_k__BackingField; // 0x42
		::System::Boolean ignorePIs; // 0x43
		::System::Xml::ConformanceLevel conformanceLevel; // 0x44
		::System::Int32 linePositionOffset; // 0x48
		::System::Int32 lineNumberOffset; // 0x4C
		::System::Xml::Schema::XmlSchemaValidationFlags validationFlags; // 0x50
		::System::Xml::DtdProcessing dtdProcessing; // 0x54
		::System::Boolean closeInput; // 0x58
		::System::Boolean ignoreComments; // 0x59
		::System::Boolean isReadOnly; // 0x5A
		::System::Boolean ignoreWhitespace; // 0x5B
		::System::Xml::ValidationType validationType; // 0x5C
