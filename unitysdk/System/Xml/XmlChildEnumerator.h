...
#define SYSTEM_XML_XMLCHILDENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19E67170)
#define SYSTEM_XML_XMLCHILDENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19E67070)
#define SYSTEM_XML_XMLCHILDENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19E67100)
#define SYSTEM_XML_XMLCHILDENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19E67010)
#define SYSTEM_XML_XMLCHILDENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19E670D0)
#define SYSTEM_XML_XMLCHILDENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19E66FD0)
