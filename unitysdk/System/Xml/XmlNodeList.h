...
#define SYSTEM_XML_XMLNODELIST_GET_ITEMOF_OFFSET UNITYSDK_OFFSET(0x19CBBE20)
#define SYSTEM_XML_XMLNODELIST_PRIVATEDISPOSENODELIST_OFFSET UNITYSDK_OFFSET(0x19CBBE40)
#define SYSTEM_XML_XMLNODELIST_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19CBBE30)
#define SYSTEM_XML_XMLNODELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19CBB790)
