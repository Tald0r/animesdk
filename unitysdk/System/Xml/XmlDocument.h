...
#define SYSTEM_XML_XMLDOCUMENT_ADDATTRXMLNAME_OFFSET UNITYSDK_OFFSET(0x19493B10)
#define SYSTEM_XML_XMLDOCUMENT_ADDDEFAULTATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19495910)
#define SYSTEM_XML_XMLDOCUMENT_ADDELEMENTWITHID_OFFSET UNITYSDK_OFFSET(0x194944A0)
#define SYSTEM_XML_XMLDOCUMENT_ADDIDINFO_OFFSET UNITYSDK_OFFSET(0x19493C50)
#define SYSTEM_XML_XMLDOCUMENT_ADDXMLNAME_OFFSET UNITYSDK_OFFSET(0x19493AD0)
#define SYSTEM_XML_XMLDOCUMENT_ADD_NODEINSERTED_OFFSET UNITYSDK_OFFSET(0x19497B70)
#define SYSTEM_XML_XMLDOCUMENT_ADD_NODEREMOVED_OFFSET UNITYSDK_OFFSET(0x19497C30)
#define SYSTEM_XML_XMLDOCUMENT_AFTEREVENT_OFFSET UNITYSDK_OFFSET(0x19497F10)
#define SYSTEM_XML_XMLDOCUMENT_APPENDCHILDFORLOAD_OFFSET UNITYSDK_OFFSET(0x19498640)
#define SYSTEM_XML_XMLDOCUMENT_BEFOREEVENT_OFFSET UNITYSDK_OFFSET(0x19497EC0)
#define SYSTEM_XML_XMLDOCUMENT_CANINSERTAFTER_OFFSET UNITYSDK_OFFSET(0x194951E0)
#define SYSTEM_XML_XMLDOCUMENT_CANINSERTBEFORE_OFFSET UNITYSDK_OFFSET(0x19494FF0)
#define SYSTEM_XML_XMLDOCUMENT_CHECKNAME_OFFSET UNITYSDK_OFFSET(0x19493A20)
#define SYSTEM_XML_XMLDOCUMENT_CLONENODE_OFFSET UNITYSDK_OFFSET(0x19494870)
#define SYSTEM_XML_XMLDOCUMENT_CREATEATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x194969E0)
#define SYSTEM_XML_XMLDOCUMENT_CREATEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19495360)
#define SYSTEM_XML_XMLDOCUMENT_CREATECDATASECTION_OFFSET UNITYSDK_OFFSET(0x19495610)
#define SYSTEM_XML_XMLDOCUMENT_CREATECOMMENT_OFFSET UNITYSDK_OFFSET(0x19495690)
#define SYSTEM_XML_XMLDOCUMENT_CREATEDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19496A60)
#define SYSTEM_XML_XMLDOCUMENT_CREATEDOCUMENTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x194957C0)
#define SYSTEM_XML_XMLDOCUMENT_CREATEDOCUMENTTYPE_OFFSET UNITYSDK_OFFSET(0x19495740)
#define SYSTEM_XML_XMLDOCUMENT_CREATEELEMENT_1_OFFSET UNITYSDK_OFFSET(0x19496B00)
#define SYSTEM_XML_XMLDOCUMENT_CREATEELEMENT_OFFSET UNITYSDK_OFFSET(0x19495860)
#define SYSTEM_XML_XMLDOCUMENT_CREATEENTITYREFERENCE_OFFSET UNITYSDK_OFFSET(0x19495F60)
#define SYSTEM_XML_XMLDOCUMENT_CREATEPROCESSINGINSTRUCTION_OFFSET UNITYSDK_OFFSET(0x19495FC0)
#define SYSTEM_XML_XMLDOCUMENT_CREATESIGNIFICANTWHITESPACE_OFFSET UNITYSDK_OFFSET(0x194961A0)
#define SYSTEM_XML_XMLDOCUMENT_CREATETEXTNODE_OFFSET UNITYSDK_OFFSET(0x194960F0)
#define SYSTEM_XML_XMLDOCUMENT_CREATEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x19496200)
#define SYSTEM_XML_XMLDOCUMENT_CREATEXMLDECLARATION_OFFSET UNITYSDK_OFFSET(0x19496080)
#define SYSTEM_XML_XMLDOCUMENT_GETDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19497F60)
#define SYSTEM_XML_XMLDOCUMENT_GETELEMENTSBYTAGNAME_OFFSET UNITYSDK_OFFSET(0x19496260)
#define SYSTEM_XML_XMLDOCUMENT_GETELEMENT_OFFSET UNITYSDK_OFFSET(0x19493DF0)
#define SYSTEM_XML_XMLDOCUMENT_GETENTITYNODE_OFFSET UNITYSDK_OFFSET(0x19498350)
#define SYSTEM_XML_XMLDOCUMENT_GETEVENTARGS_OFFSET UNITYSDK_OFFSET(0x19497CF0)
#define SYSTEM_XML_XMLDOCUMENT_GETIDINFOBYELEMENT_OFFSET UNITYSDK_OFFSET(0x19493DE0)
#define SYSTEM_XML_XMLDOCUMENT_GETIDINFOBYELEMENT__OFFSET UNITYSDK_OFFSET(0x19493D00)
#define SYSTEM_XML_XMLDOCUMENT_GETINSERTEVENTARGSFORLOAD_OFFSET UNITYSDK_OFFSET(0x19497DF0)
#define SYSTEM_XML_XMLDOCUMENT_GETSCHEMAELEMENTDECL_OFFSET UNITYSDK_OFFSET(0x19495BF0)
#define SYSTEM_XML_XMLDOCUMENT_GETXMLNAME_OFFSET UNITYSDK_OFFSET(0x19493AF0)
#define SYSTEM_XML_XMLDOCUMENT_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x19498630)
#define SYSTEM_XML_XMLDOCUMENT_GET_DECLARATION_OFFSET UNITYSDK_OFFSET(0x19494AF0)
#define SYSTEM_XML_XMLDOCUMENT_GET_DOCUMENTELEMENT_OFFSET UNITYSDK_OFFSET(0x19494BF0)
#define SYSTEM_XML_XMLDOCUMENT_GET_DOCUMENTTYPE_OFFSET UNITYSDK_OFFSET(0x194949E0)
#define SYSTEM_XML_XMLDOCUMENT_GET_ENCODING_OFFSET UNITYSDK_OFFSET(0x19498320)
#define SYSTEM_XML_XMLDOCUMENT_GET_ENTITIES_OFFSET UNITYSDK_OFFSET(0x19496BC0)
#define SYSTEM_XML_XMLDOCUMENT_GET_ISCONTAINER_OFFSET UNITYSDK_OFFSET(0x19494CA0)
#define SYSTEM_XML_XMLDOCUMENT_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x19496BB0)
#define SYSTEM_XML_XMLDOCUMENT_GET_LASTNODE_OFFSET UNITYSDK_OFFSET(0x19494CB0)
#define SYSTEM_XML_XMLDOCUMENT_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x19494BE0)
#define SYSTEM_XML_XMLDOCUMENT_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x19493A00)
#define SYSTEM_XML_XMLDOCUMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19494BD0)
#define SYSTEM_XML_XMLDOCUMENT_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x194949C0)
#define SYSTEM_XML_XMLDOCUMENT_GET_OWNERDOCUMENT_OFFSET UNITYSDK_OFFSET(0x19494CD0)
#define SYSTEM_XML_XMLDOCUMENT_GET_PARENTNODE_OFFSET UNITYSDK_OFFSET(0x194949D0)
#define SYSTEM_XML_XMLDOCUMENT_GET_SCHEMAINFO_OFFSET UNITYSDK_OFFSET(0x19498460)
#define SYSTEM_XML_XMLDOCUMENT_GET_STANDALONE_OFFSET UNITYSDK_OFFSET(0x194977A0)
#define SYSTEM_XML_XMLDOCUMENT_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x194982F0)
#define SYSTEM_XML_XMLDOCUMENT_HASNODETYPEINNEXTSIBLINGS_OFFSET UNITYSDK_OFFSET(0x19494F90)
#define SYSTEM_XML_XMLDOCUMENT_HASNODETYPEINPREVSIBLINGS_OFFSET UNITYSDK_OFFSET(0x19494EE0)
#define SYSTEM_XML_XMLDOCUMENT_IMPORTATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19496850)
#define SYSTEM_XML_XMLDOCUMENT_IMPORTCHILDREN_OFFSET UNITYSDK_OFFSET(0x19494920)
#define SYSTEM_XML_XMLDOCUMENT_IMPORTNODEINTERNAL_OFFSET UNITYSDK_OFFSET(0x194962C0)
#define SYSTEM_XML_XMLDOCUMENT_ISVALIDCHILDTYPE_OFFSET UNITYSDK_OFFSET(0x19494CE0)
#define SYSTEM_XML_XMLDOCUMENT_LOADXML_OFFSET UNITYSDK_OFFSET(0x19497270)
#define SYSTEM_XML_XMLDOCUMENT_LOAD_1_OFFSET UNITYSDK_OFFSET(0x194970C0)
#define SYSTEM_XML_XMLDOCUMENT_LOAD_OFFSET UNITYSDK_OFFSET(0x19496E20)
#define SYSTEM_XML_XMLDOCUMENT_PREPAREDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19495D40)
#define SYSTEM_XML_XMLDOCUMENT_READNODE_OFFSET UNITYSDK_OFFSET(0x19496C20)
#define SYSTEM_XML_XMLDOCUMENT_REMOVEELEMENTWITHID_OFFSET UNITYSDK_OFFSET(0x19494700)
#define SYSTEM_XML_XMLDOCUMENT_REMOVE_NODEINSERTED_OFFSET UNITYSDK_OFFSET(0x19497BD0)
#define SYSTEM_XML_XMLDOCUMENT_REMOVE_NODEREMOVED_OFFSET UNITYSDK_OFFSET(0x19497C90)
#define SYSTEM_XML_XMLDOCUMENT_SAVE_OFFSET UNITYSDK_OFFSET(0x194975F0)
#define SYSTEM_XML_XMLDOCUMENT_SETDEFAULTNAMESPACE_OFFSET UNITYSDK_OFFSET(0x19495540)
#define SYSTEM_XML_XMLDOCUMENT_SETUPREADER_OFFSET UNITYSDK_OFFSET(0x19496CF0)
#define SYSTEM_XML_XMLDOCUMENT_SET_INNERTEXT_OFFSET UNITYSDK_OFFSET(0x19497580)
#define SYSTEM_XML_XMLDOCUMENT_SET_INNERXML_OFFSET UNITYSDK_OFFSET(0x194975E0)
#define SYSTEM_XML_XMLDOCUMENT_SET_LASTNODE_OFFSET UNITYSDK_OFFSET(0x19494CC0)
#define SYSTEM_XML_XMLDOCUMENT_WRITECONTENTTO_OFFSET UNITYSDK_OFFSET(0x194977E0)
#define SYSTEM_XML_XMLDOCUMENT_WRITETO_OFFSET UNITYSDK_OFFSET(0x194977D0)
#define SYSTEM_XML_XMLDOCUMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x194988C0)
#define SYSTEM_XML_XMLDOCUMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x194830F0)
#define SYSTEM_XML_XMLDOCUMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19493770)
#define SYSTEM_XML_XMLDOCUMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x194935B0)
...
namespace System::Xml
{
	...
	public:
		...
		::System::Collections::Hashtable* htElementIdMap; // 0x18
		::System::Xml::Schema::XmlSchemaSet* schemas; // 0x20
		::System::Xml::XmlNodeChangedEventHandler* onNodeChangedDelegate; // 0x28
		::System::String* strID; // 0x30
		::System::String* strSpace; // 0x38
		::System::Xml::XmlNodeChangedEventHandler* onNodeRemovedDelegate; // 0x40
		::System::String* strLang; // 0x48
		::System::Collections::Hashtable* htElementIDAttrDecl; // 0x50
		::System::String* strDocumentFragmentName; // 0x58
		::System::String* strCDataSectionName; // 0x60
		::System::String* strCommentName; // 0x68
		::System::Xml::XmlNodeChangedEventHandler* onNodeChangingDelegate; // 0x70
		::System::Object* objLock; // 0x78
		::System::String* baseURI; // 0x80
		::System::String* strEmpty; // 0x88
		::System::Xml::DomNameTable* domNameTable; // 0x90
		...
		::System::String* strReservedXml; // 0xB0
		::System::Xml::XmlResolver* resolver; // 0xB8
		::System::String* strDocumentName; // 0xC0
		::System::Xml::XmlNodeChangedEventHandler* onNodeInsertingDelegate; // 0xC8
		::System::String* strXmlns; // 0xD0
		::System::String* strTextName; // 0xD8
		::System::Xml::Schema::SchemaInfo* schemaInfo; // 0xE0
		::System::String* strNonSignificantWhitespaceName; // 0xE8
		::System::Xml::XmlNodeChangedEventHandler* onNodeRemovingDelegate; // 0xF0
		::System::String* strEntityName; // 0xF8
		::System::Xml::XmlNamedNodeMap* entities; // 0x100
		::System::String* strXml; // 0x108
		...
		::System::Boolean actualLoadingStatus; // 0x121
