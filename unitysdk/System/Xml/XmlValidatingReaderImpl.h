...
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_ADDDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A1111A0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A110960)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1A110280)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x1A1102B0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A110250)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1A110DB0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETRESOLVER_OFFSET UNITYSDK_OFFSET(0x1A10FAA0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x1A110220)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x1A110060)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_CANRESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1A110A40)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1A110030)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_DTDINFO_OFFSET UNITYSDK_OFFSET(0x1A1111C0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_EOF_OFFSET UNITYSDK_OFFSET(0x1A1101C0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x1A1100C0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_ISEMPTYELEMENT_OFFSET UNITYSDK_OFFSET(0x1A110090)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1A110B60)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A110C80)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1A10FF70)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMESPACEMANAGER_OFFSET UNITYSDK_OFFSET(0x1A1110D0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMESPACES_OFFSET UNITYSDK_OFFSET(0x1A110FD0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1A10FFA0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x1A1101F0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A10FF40)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1A10FF10)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1A10FFD0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_QUOTECHAR_OFFSET UNITYSDK_OFFSET(0x1A1100F0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1A110180)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1A10FD50)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_STANDALONE_OFFSET UNITYSDK_OFFSET(0x1A1110F0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_TYPEDVALUEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A111140)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A110000)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_XMLLANG_OFFSET UNITYSDK_OFFSET(0x1A110150)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_XMLSPACE_OFFSET UNITYSDK_OFFSET(0x1A110120)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A110990)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1A110EF0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVEOFFENTITYREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A110A90)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1A110320)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A1102E0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x1A1103D0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A110350)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A110390)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_PARSEDTDFROMPARSERCONTEXT_OFFSET UNITYSDK_OFFSET(0x1A110700)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_PROCESSCOREREADEREVENT_OFFSET UNITYSDK_OFFSET(0x1A110500)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_READATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1A1109E0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_READSTRING_OFFSET UNITYSDK_OFFSET(0x1A110B40)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_READ_OFFSET UNITYSDK_OFFSET(0x1A110410)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_RESOLVEENTITYINTERNALLY_OFFSET UNITYSDK_OFFSET(0x1A1108D0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_RESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1A110A50)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SETUPVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A10FBC0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SET_SCHEMATYPEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A111110)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SET_TYPEDVALUEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A111170)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1A110DA0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A110E90)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1A110EE0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATEDEFAULTATTRIBUTEONUSE_OFFSET UNITYSDK_OFFSET(0x1A1111E0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATEDTD_OFFSET UNITYSDK_OFFSET(0x1A110FF0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A10F7A0)
...
namespace System::Xml
{
	...
	public:
		...
		::System::Xml::XmlParserContext* parserContext; // 0x10
		::System::Xml::Schema::BaseValidator* validator; // 0x18
		::System::Xml::XmlTextReaderImpl* coreReaderImpl; // 0x20
		::System::Xml::XmlReader* outerReader; // 0x28
		::System::Xml::ReadContentAsBinaryHelper* readBinaryHelper; // 0x30
		::System::Xml::XmlReader* coreReader; // 0x38
		::System::Xml::Schema::XmlSchemaCollection* schemaCollection; // 0x40
		::System::Xml::IXmlNamespaceResolver* coreReaderNSResolver; // 0x48
		::System::Xml::XmlValidatingReaderImpl_ValidationEventHandling* eventHandling; // 0x50
		::System::Boolean processIdentityConstraints; // 0x58
		::System::Xml::XmlValidatingReaderImpl_ParsingFunction parsingFunction; // 0x5C
		::System::Xml::ValidationType validationType; // 0x60
