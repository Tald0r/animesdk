...
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_ADDDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A6B3E40)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A6B3600)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1A6B2F20)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x1A6B2F50)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A6B2EF0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1A6B3A50)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GETRESOLVER_OFFSET UNITYSDK_OFFSET(0x1A6B2730)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x1A6B2EC0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x1A6B2D00)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_CANRESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1A6B36E0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1A6B2CD0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_DTDINFO_OFFSET UNITYSDK_OFFSET(0x1A6B3E60)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_EOF_OFFSET UNITYSDK_OFFSET(0x1A6B2E60)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x1A6B2D60)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_ISEMPTYELEMENT_OFFSET UNITYSDK_OFFSET(0x1A6B2D30)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1A6B3800)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A6B3920)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1A6B2C10)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMESPACEMANAGER_OFFSET UNITYSDK_OFFSET(0x1A6B3D70)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMESPACES_OFFSET UNITYSDK_OFFSET(0x1A6B3C70)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1A6B2C40)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x1A6B2E90)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A6B2BE0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1A6B2BB0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1A6B2C70)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_QUOTECHAR_OFFSET UNITYSDK_OFFSET(0x1A6B2D90)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1A6B2E20)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1A6B29E0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_STANDALONE_OFFSET UNITYSDK_OFFSET(0x1A6B3D90)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_TYPEDVALUEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A6B3DE0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A6B2CA0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_XMLLANG_OFFSET UNITYSDK_OFFSET(0x1A6B2DF0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_GET_XMLSPACE_OFFSET UNITYSDK_OFFSET(0x1A6B2DC0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A6B3630)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1A6B3B90)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVEOFFENTITYREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A6B3730)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1A6B2FC0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A6B2F80)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x1A6B3070)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A6B2FF0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A6B3030)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_PARSEDTDFROMPARSERCONTEXT_OFFSET UNITYSDK_OFFSET(0x1A6B33A0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_PROCESSCOREREADEREVENT_OFFSET UNITYSDK_OFFSET(0x1A6B31A0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_READATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1A6B3680)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_READSTRING_OFFSET UNITYSDK_OFFSET(0x1A6B37E0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_READ_OFFSET UNITYSDK_OFFSET(0x1A6B30B0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_RESOLVEENTITYINTERNALLY_OFFSET UNITYSDK_OFFSET(0x1A6B3570)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_RESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1A6B36F0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SETUPVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A6B2850)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SET_SCHEMATYPEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A6B3DB0)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SET_TYPEDVALUEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A6B3E10)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x1A6B3A40)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A6B3B30)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1A6B3B80)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATEDEFAULTATTRIBUTEONUSE_OFFSET UNITYSDK_OFFSET(0x1A6B3E80)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL_VALIDATEDTD_OFFSET UNITYSDK_OFFSET(0x1A6B3C90)
#define SYSTEM_XML_XMLVALIDATINGREADERIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B2430)
...
namespace System::Xml
{
	...
	public:
		...
		::System::Xml::XmlValidatingReaderImpl_ValidationEventHandling* eventHandling; // 0x10
		::System::Xml::ReadContentAsBinaryHelper* readBinaryHelper; // 0x18
		::System::Xml::Schema::XmlSchemaCollection* schemaCollection; // 0x20
		::System::Xml::XmlReader* outerReader; // 0x28
		::System::Xml::IXmlNamespaceResolver* coreReaderNSResolver; // 0x30
		::System::Xml::XmlTextReaderImpl* coreReaderImpl; // 0x38
		::System::Xml::XmlParserContext* parserContext; // 0x40
