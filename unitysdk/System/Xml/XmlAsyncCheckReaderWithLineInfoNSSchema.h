...
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONSSCHEMA_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x19FBC3D0)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONSSCHEMA_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_ISNIL_OFFSET UNITYSDK_OFFSET(0x19FBC4B0)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONSSCHEMA_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_MEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x19FBC590)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONSSCHEMA_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_SCHEMAATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19FBC830)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONSSCHEMA_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_SCHEMAELEMENT_OFFSET UNITYSDK_OFFSET(0x19FBC750)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONSSCHEMA_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_SCHEMATYPE_OFFSET UNITYSDK_OFFSET(0x19FBC670)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONSSCHEMA_SYSTEM_XML_SCHEMA_IXMLSCHEMAINFO_GET_VALIDITY_OFFSET UNITYSDK_OFFSET(0x19FBC2F0)
#define SYSTEM_XML_XMLASYNCCHECKREADERWITHLINEINFONSSCHEMA__CTOR_OFFSET UNITYSDK_OFFSET(0x19FBC230)
