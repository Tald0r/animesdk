...
#define SYSTEM_XML_XMLCHILDNODES_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A271AB0)
#define SYSTEM_XML_XMLCHILDNODES_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A271A50)
#define SYSTEM_XML_XMLCHILDNODES_ITEM_OFFSET UNITYSDK_OFFSET(0x1A2719E0)
#define SYSTEM_XML_XMLCHILDNODES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2719C0)
