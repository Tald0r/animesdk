...
#define SYSTEM_XML_POSITIONINFO_GETPOSITIONINFO_OFFSET UNITYSDK_OFFSET(0x1AC2BE80)
#define SYSTEM_XML_POSITIONINFO_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1AC2BE60)
#define SYSTEM_XML_POSITIONINFO_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1AC2BE70)
#define SYSTEM_XML_POSITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC2BEF0)
