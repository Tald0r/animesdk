...
#define SYSTEM_XML_POSITIONINFO_GETPOSITIONINFO_OFFSET UNITYSDK_OFFSET(0x1A680B80)
#define SYSTEM_XML_POSITIONINFO_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1A680B60)
#define SYSTEM_XML_POSITIONINFO_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A680B70)
#define SYSTEM_XML_POSITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A680BF0)
