...
#define SYSTEM_XML_XMLEMPTYELEMENTLISTENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19A321E0)
#define SYSTEM_XML_XMLEMPTYELEMENTLISTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19A321C0)
#define SYSTEM_XML_XMLEMPTYELEMENTLISTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19A321D0)
#define SYSTEM_XML_XMLEMPTYELEMENTLISTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19A321B0)
