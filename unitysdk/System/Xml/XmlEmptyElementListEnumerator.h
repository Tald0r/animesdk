...
#define SYSTEM_XML_XMLEMPTYELEMENTLISTENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A04C520)
#define SYSTEM_XML_XMLEMPTYELEMENTLISTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A04C500)
#define SYSTEM_XML_XMLEMPTYELEMENTLISTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A04C510)
#define SYSTEM_XML_XMLEMPTYELEMENTLISTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04C4F0)
