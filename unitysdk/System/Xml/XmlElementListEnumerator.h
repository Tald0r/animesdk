...
#define SYSTEM_XML_XMLELEMENTLISTENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC38140)
#define SYSTEM_XML_XMLELEMENTLISTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AC38080)
#define SYSTEM_XML_XMLELEMENTLISTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AC38110)
#define SYSTEM_XML_XMLELEMENTLISTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC38050)
