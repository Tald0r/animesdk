...
#define SYSTEM_XML_XMLELEMENTLISTENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A68CE60)
#define SYSTEM_XML_XMLELEMENTLISTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A68CDA0)
#define SYSTEM_XML_XMLELEMENTLISTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A68CE30)
#define SYSTEM_XML_XMLELEMENTLISTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A68CD70)
