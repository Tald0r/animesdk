...
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_CLONENODE_OFFSET UNITYSDK_OFFSET(0x1A10F650)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_GET_ISTEXT_OFFSET UNITYSDK_OFFSET(0x1A10F790)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1A10F590)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A10F570)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1A10F5B0)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_GET_PARENTNODE_OFFSET UNITYSDK_OFFSET(0x1A10F5C0)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A10F6A0)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A10F6C0)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_WRITECONTENTTO_OFFSET UNITYSDK_OFFSET(0x1A10F780)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A10F740)
#define SYSTEM_XML_XMLSIGNIFICANTWHITESPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A10F480)
