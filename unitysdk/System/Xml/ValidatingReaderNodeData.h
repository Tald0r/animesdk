...
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x19A4E270)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_GETATOMIZEDNAMEWPREFIX_OFFSET UNITYSDK_OFFSET(0x19A4E3B0)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_SETITEMDATA_1_OFFSET UNITYSDK_OFFSET(0x19A4E5B0)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_SETITEMDATA_2_OFFSET UNITYSDK_OFFSET(0x19A4E5C0)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_SETITEMDATA_OFFSET UNITYSDK_OFFSET(0x19A4E580)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_SETLINEINFO_1_OFFSET UNITYSDK_OFFSET(0x19A4E420)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA_SETLINEINFO_OFFSET UNITYSDK_OFFSET(0x19A4E410)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A4E310)
#define SYSTEM_XML_VALIDATINGREADERNODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19A4E1D0)
...
namespace System::Xml
{
	...
	{
	public:
		::System::Xml::AttributePSVIInfo* attributePSVIInfo; // 0x10
