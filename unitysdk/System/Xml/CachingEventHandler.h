...
#define SYSTEM_XML_CACHINGEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x194538C0)
#define SYSTEM_XML_CACHINGEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x194538F0)
#define SYSTEM_XML_CACHINGEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x194533C0)
#define SYSTEM_XML_CACHINGEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x194533B0)
