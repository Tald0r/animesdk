...
#define SYSTEM_XML_CACHINGEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1986B940)
#define SYSTEM_XML_CACHINGEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1986B970)
#define SYSTEM_XML_CACHINGEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1986B440)
#define SYSTEM_XML_CACHINGEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1986B420)
