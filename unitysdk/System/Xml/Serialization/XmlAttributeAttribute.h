...
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_ADDKEYHASH_OFFSET UNITYSDK_OFFSET(0x1A10D860)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_ATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x1A10D820)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE_GET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x1A10D840)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A10D810)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A10D800)
