...
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY_CREATESERIALIZER_1_OFFSET UNITYSDK_OFFSET(0x199A1CE0)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY_CREATESERIALIZER_2_OFFSET UNITYSDK_OFFSET(0x199A1A60)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY_CREATESERIALIZER_OFFSET UNITYSDK_OFFSET(0x199A1A40)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY__CCTOR_OFFSET UNITYSDK_OFFSET(0x199A1D10)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x199A1A30)
