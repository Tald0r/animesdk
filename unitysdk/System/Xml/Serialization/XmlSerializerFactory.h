...
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY_CREATESERIALIZER_1_OFFSET UNITYSDK_OFFSET(0x19F759B0)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY_CREATESERIALIZER_2_OFFSET UNITYSDK_OFFSET(0x19F75730)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY_CREATESERIALIZER_OFFSET UNITYSDK_OFFSET(0x19F75710)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F759E0)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x19F75700)
