...
#define SYSTEM_XML_SERIALIZATION_XMLTYPESERIALIZATIONSOURCE_EQUALS_OFFSET UNITYSDK_OFFSET(0x19CBB530)
#define SYSTEM_XML_SERIALIZATION_XMLTYPESERIALIZATIONSOURCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19CBB630)
#define SYSTEM_XML_SERIALIZATION_XMLTYPESERIALIZATIONSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CBB3F0)
