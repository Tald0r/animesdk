...
#define SYSTEM_XML_SERIALIZATION_XMLMAPPING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A2D490)
#define SYSTEM_XML_SERIALIZATION_XMLMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x19A2D480)
