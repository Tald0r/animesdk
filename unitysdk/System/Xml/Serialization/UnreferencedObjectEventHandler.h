...
#define SYSTEM_XML_SERIALIZATION_UNREFERENCEDOBJECTEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A939260)
#define SYSTEM_XML_SERIALIZATION_UNREFERENCEDOBJECTEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A9392A0)
#define SYSTEM_XML_SERIALIZATION_UNREFERENCEDOBJECTEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A938CE0)
#define SYSTEM_XML_SERIALIZATION_UNREFERENCEDOBJECTEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A938CC0)
