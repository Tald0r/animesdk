...
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERNAMESPACES_ADDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1911D6C0)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERNAMESPACES_ADD_OFFSET UNITYSDK_OFFSET(0x1911B200)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERNAMESPACES_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1911DDC0)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERNAMESPACES_GET_NAMESPACELIST_OFFSET UNITYSDK_OFFSET(0x1911D8B0)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERNAMESPACES_GET_NAMESPACES_OFFSET UNITYSDK_OFFSET(0x1911D750)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERNAMESPACES_TOARRAY_OFFSET UNITYSDK_OFFSET(0x1911D7C0)
#define SYSTEM_XML_SERIALIZATION_XMLSERIALIZERNAMESPACES__CTOR_OFFSET UNITYSDK_OFFSET(0x1911B1F0)
