...
#define SYSTEM_XML_SERIALIZATION_XMLANYELEMENTATTRIBUTE_ADDKEYHASH_OFFSET UNITYSDK_OFFSET(0x19FBB990)
#define SYSTEM_XML_SERIALIZATION_XMLANYELEMENTATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19FBB970)
#define SYSTEM_XML_SERIALIZATION_XMLANYELEMENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FBB960)
