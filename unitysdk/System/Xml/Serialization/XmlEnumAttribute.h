...
#define SYSTEM_XML_SERIALIZATION_XMLENUMATTRIBUTE_ADDKEYHASH_OFFSET UNITYSDK_OFFSET(0x19AD1DA0)
#define SYSTEM_XML_SERIALIZATION_XMLENUMATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19AD1D90)
#define SYSTEM_XML_SERIALIZATION_XMLENUMATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD1D80)
