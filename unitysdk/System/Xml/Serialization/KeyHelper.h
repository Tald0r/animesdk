...
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_1_OFFSET UNITYSDK_OFFSET(0x1913F960)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_2_OFFSET UNITYSDK_OFFSET(0x1913FA10)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_3_OFFSET UNITYSDK_OFFSET(0x1913FA60)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_4_OFFSET UNITYSDK_OFFSET(0x1913FAB0)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_5_OFFSET UNITYSDK_OFFSET(0x1913FB30)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_OFFSET UNITYSDK_OFFSET(0x1913F950)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1913FBB0)
