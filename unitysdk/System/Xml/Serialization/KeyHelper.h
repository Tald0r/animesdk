...
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_1_OFFSET UNITYSDK_OFFSET(0x18C7E280)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_2_OFFSET UNITYSDK_OFFSET(0x18C7E330)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_3_OFFSET UNITYSDK_OFFSET(0x18C7E380)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_4_OFFSET UNITYSDK_OFFSET(0x18C7E3D0)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_5_OFFSET UNITYSDK_OFFSET(0x18C7E450)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER_ADDFIELD_OFFSET UNITYSDK_OFFSET(0x18C7E270)
#define SYSTEM_XML_SERIALIZATION_KEYHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7E4D0)
