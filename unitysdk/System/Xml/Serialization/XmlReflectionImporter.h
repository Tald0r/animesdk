...
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_CANBENULL_OFFSET UNITYSDK_OFFSET(0x1A26D310)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_CREATEMAPMEMBER_OFFSET UNITYSDK_OFFSET(0x1A26E420)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_CREATETYPEMAPPING_OFFSET UNITYSDK_OFFSET(0x1A26CD80)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_GETDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1A270930)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_GETREFLECTIONMEMBERS_OFFSET UNITYSDK_OFFSET(0x1A26D5D0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_GETTYPENAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A26D4C0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTANYELEMENTINFO_OFFSET UNITYSDK_OFFSET(0x1A26F220)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTCLASSMAPPING_1_OFFSET UNITYSDK_OFFSET(0x1A269EE0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTCLASSMAPPING_OFFSET UNITYSDK_OFFSET(0x1A26D3F0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTELEMENTINFO_OFFSET UNITYSDK_OFFSET(0x1A26F8C0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTENUMMAPPING_OFFSET UNITYSDK_OFFSET(0x1A26C6B0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTINCLUDEDTYPES_OFFSET UNITYSDK_OFFSET(0x1A26F020)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTLISTMAPPING_1_OFFSET UNITYSDK_OFFSET(0x1A26B180)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTLISTMAPPING_OFFSET UNITYSDK_OFFSET(0x1A26F140)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTPRIMITIVEMAPPING_OFFSET UNITYSDK_OFFSET(0x1A26C600)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTTEXTELEMENTINFO_OFFSET UNITYSDK_OFFSET(0x1A270A90)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTTYPEMAPPING_1_OFFSET UNITYSDK_OFFSET(0x1A269B80)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTTYPEMAPPING_2_OFFSET UNITYSDK_OFFSET(0x1A2699E0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTTYPEMAPPING_3_OFFSET UNITYSDK_OFFSET(0x1A269B90)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTTYPEMAPPING_OFFSET UNITYSDK_OFFSET(0x1A2699D0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTXMLNODEMAPPING_OFFSET UNITYSDK_OFFSET(0x1A26C4B0)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_IMPORTXMLSERIALIZABLEMAPPING_OFFSET UNITYSDK_OFFSET(0x1A26CC70)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_INCLUDETYPE_OFFSET UNITYSDK_OFFSET(0x1A270E00)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER_REGISTERDERIVEDMAP_OFFSET UNITYSDK_OFFSET(0x1A26EF10)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A271280)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A269810)
#define SYSTEM_XML_SERIALIZATION_XMLREFLECTIONIMPORTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A269800)
