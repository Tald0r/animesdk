...
#define SYSTEM_XML_SERIALIZATION_XMLELEMENTEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1910F120)
#define SYSTEM_XML_SERIALIZATION_XMLELEMENTEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1910F0C0)
