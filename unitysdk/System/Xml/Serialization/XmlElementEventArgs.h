...
#define SYSTEM_XML_SERIALIZATION_XMLELEMENTEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19482520)
#define SYSTEM_XML_SERIALIZATION_XMLELEMENTEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x194824C0)
