...
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEOVERRIDES_ADDKEYHASH_OFFSET UNITYSDK_OFFSET(0x1988F7B0)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEOVERRIDES_GETKEY_OFFSET UNITYSDK_OFFSET(0x1988F760)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEOVERRIDES_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1988F690)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEOVERRIDES_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1988F680)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTEOVERRIDES__CTOR_OFFSET UNITYSDK_OFFSET(0x1988F620)
