...
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTES_ADDKEYHASH_OFFSET UNITYSDK_OFFSET(0x199A0D50)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTES_GET_ORDER_OFFSET UNITYSDK_OFFSET(0x199A1090)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTES_GET_SORTABLEORDER_OFFSET UNITYSDK_OFFSET(0x199A1160)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x199A0570)
#define SYSTEM_XML_SERIALIZATION_XMLATTRIBUTES__CTOR_OFFSET UNITYSDK_OFFSET(0x199A0410)
...
namespace System::Xml::Serialization
{
	...
	public:
		...
		::System::Xml::Serialization::XmlRootAttribute* xmlRoot; // 0x48
