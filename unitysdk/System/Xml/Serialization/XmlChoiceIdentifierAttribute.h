...
#define SYSTEM_XML_SERIALIZATION_XMLCHOICEIDENTIFIERATTRIBUTE_ADDKEYHASH_OFFSET UNITYSDK_OFFSET(0x19A2D410)
#define SYSTEM_XML_SERIALIZATION_XMLCHOICEIDENTIFIERATTRIBUTE_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x19A2D3F0)
#define SYSTEM_XML_SERIALIZATION_XMLCHOICEIDENTIFIERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A2D3E0)
