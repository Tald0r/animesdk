...
#define SYSTEM_XML_XMLSQLBINARYREADER_ELEMINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0x925C90)
#define SYSTEM_XML_XMLSQLBINARYREADER_ELEMINFO_SET_OFFSET UNITYSDK_OFFSET(0x925C60)
