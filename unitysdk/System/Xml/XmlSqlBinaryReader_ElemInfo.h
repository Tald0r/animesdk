...
#define SYSTEM_XML_XMLSQLBINARYREADER_ELEMINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0x8FE1F0)
#define SYSTEM_XML_XMLSQLBINARYREADER_ELEMINFO_SET_OFFSET UNITYSDK_OFFSET(0x8FE1C0)
