...
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_ADJUSTPOSITION_OFFSET UNITYSDK_OFFSET(0x8C6760)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_GETLOCALNAMEANDNAMESPACEURIANDHASH_OFFSET UNITYSDK_OFFSET(0x8C66B0)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_GETLOCALNAMEANDNAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x8C66A0)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_MATCHHASHNS_OFFSET UNITYSDK_OFFSET(0x8C66E0)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_MATCHNS_OFFSET UNITYSDK_OFFSET(0x84AE50)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x8C6670)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_SET_OFFSET UNITYSDK_OFFSET(0x8C6640)
