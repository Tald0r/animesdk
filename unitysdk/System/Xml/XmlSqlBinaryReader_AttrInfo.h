...
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_ADJUSTPOSITION_OFFSET UNITYSDK_OFFSET(0x8F9A80)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_GETLOCALNAMEANDNAMESPACEURIANDHASH_OFFSET UNITYSDK_OFFSET(0x8F99D0)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_GETLOCALNAMEANDNAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x8F99C0)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_MATCHHASHNS_OFFSET UNITYSDK_OFFSET(0x8F9A00)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_MATCHNS_OFFSET UNITYSDK_OFFSET(0x880800)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x8F9990)
#define SYSTEM_XML_XMLSQLBINARYREADER_ATTRINFO_SET_OFFSET UNITYSDK_OFFSET(0x8F9960)
