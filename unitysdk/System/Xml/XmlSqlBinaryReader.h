...
#define SYSTEM_XML_XMLSQLBINARYREADER_ADDINITNAMESPACE_OFFSET UNITYSDK_OFFSET(0x195AD440)
#define SYSTEM_XML_XMLSQLBINARYREADER_ADDNAME_OFFSET UNITYSDK_OFFSET(0x195B3A90)
#define SYSTEM_XML_XMLSQLBINARYREADER_ADDQNAME_OFFSET UNITYSDK_OFFSET(0x195B3D10)
#define SYSTEM_XML_XMLSQLBINARYREADER_CDATAVALUE_OFFSET UNITYSDK_OFFSET(0x195AF290)
#define SYSTEM_XML_XMLSQLBINARYREADER_CHECKALLOWCONTENT_OFFSET UNITYSDK_OFFSET(0x195B80E0)
#define SYSTEM_XML_XMLSQLBINARYREADER_CHECKTEXTISWS_OFFSET UNITYSDK_OFFSET(0x195B8450)
#define SYSTEM_XML_XMLSQLBINARYREADER_CHECKTEXT_OFFSET UNITYSDK_OFFSET(0x195B8210)
#define SYSTEM_XML_XMLSQLBINARYREADER_CHECKVALUETOKENBOUNDS_OFFSET UNITYSDK_OFFSET(0x195B8E60)
#define SYSTEM_XML_XMLSQLBINARYREADER_CLEARATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x195B5110)
#define SYSTEM_XML_XMLSQLBINARYREADER_CLOSE_OFFSET UNITYSDK_OFFSET(0x195B20E0)
#define SYSTEM_XML_XMLSQLBINARYREADER_FILLALLOWEOF_OFFSET UNITYSDK_OFFSET(0x195B42E0)
#define SYSTEM_XML_XMLSQLBINARYREADER_FILL_OFFSET UNITYSDK_OFFSET(0x195B41B0)
#define SYSTEM_XML_XMLSQLBINARYREADER_FILL__OFFSET UNITYSDK_OFFSET(0x195B4530)
#define SYSTEM_XML_XMLSQLBINARYREADER_FINISHCDATA_OFFSET UNITYSDK_OFFSET(0x195B6900)
#define SYSTEM_XML_XMLSQLBINARYREADER_FINISHENDELEMENT_OFFSET UNITYSDK_OFFSET(0x195B69F0)
#define SYSTEM_XML_XMLSQLBINARYREADER_GENERATEIMPLIEDXMLNSATTRS_OFFSET UNITYSDK_OFFSET(0x195B5570)
#define SYSTEM_XML_XMLSQLBINARYREADER_GENERATETOKENTYPEMAP_OFFSET UNITYSDK_OFFSET(0x195AD570)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETATTRIBUTETEXT_OFFSET UNITYSDK_OFFSET(0x195B0880)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x195B1100)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x195B1050)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x195B0C20)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x195BA410)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETINT16_OFFSET UNITYSDK_OFFSET(0x195B9490)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETINT32_OFFSET UNITYSDK_OFFSET(0x195B94F0)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETINT64_OFFSET UNITYSDK_OFFSET(0x195B95A0)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETSINGLE_OFFSET UNITYSDK_OFFSET(0x195BA360)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETSTRINGALIGNED_OFFSET UNITYSDK_OFFSET(0x195B4FE0)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETSTRING_OFFSET UNITYSDK_OFFSET(0x195AF140)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETUINT16_OFFSET UNITYSDK_OFFSET(0x195B9710)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETUINT32_OFFSET UNITYSDK_OFFSET(0x195B9770)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETUINT64_OFFSET UNITYSDK_OFFSET(0x195B9820)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETVALUETYPE_OFFSET UNITYSDK_OFFSET(0x195B2030)
#define SYSTEM_XML_XMLSQLBINARYREADER_GETXSDKATMAITOKENLENGTH_OFFSET UNITYSDK_OFFSET(0x195B8C90)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x195B0BD0)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x195B0A50)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x195B09A0)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_EOF_OFFSET UNITYSDK_OFFSET(0x195B1B80)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_ISEMPTYELEMENT_OFFSET UNITYSDK_OFFSET(0x195B0A60)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x195AEFE0)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x195AEFF0)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x195B2170)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x195AEFD0)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x195AF000)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x195B22D0)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x195AECF0)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x195B0BC0)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x195AF010)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_XMLLANG_OFFSET UNITYSDK_OFFSET(0x195B0B20)
#define SYSTEM_XML_XMLSQLBINARYREADER_GET_XMLSPACE_OFFSET UNITYSDK_OFFSET(0x195B0A80)
#define SYSTEM_XML_XMLSQLBINARYREADER_GROWATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x195B5090)
#define SYSTEM_XML_XMLSQLBINARYREADER_GROWELEMENTS_OFFSET UNITYSDK_OFFSET(0x195B5010)
#define SYSTEM_XML_XMLSQLBINARYREADER_HASHCHECKFORDUPLICATEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x195B6410)
#define SYSTEM_XML_XMLSQLBINARYREADER_IMPLREADCDATA_OFFSET UNITYSDK_OFFSET(0x195B7640)
#define SYSTEM_XML_XMLSQLBINARYREADER_IMPLREADCOMMENT_OFFSET UNITYSDK_OFFSET(0x195B7600)
#define SYSTEM_XML_XMLSQLBINARYREADER_IMPLREADDATA_OFFSET UNITYSDK_OFFSET(0x195B7F50)
#define SYSTEM_XML_XMLSQLBINARYREADER_IMPLREADDOCTYPE_OFFSET UNITYSDK_OFFSET(0x195B6F60)
#define SYSTEM_XML_XMLSQLBINARYREADER_IMPLREADELEMENT_OFFSET UNITYSDK_OFFSET(0x195B6A50)
#define SYSTEM_XML_XMLSQLBINARYREADER_IMPLREADENDELEMENT_OFFSET UNITYSDK_OFFSET(0x195B6E70)
#define SYSTEM_XML_XMLSQLBINARYREADER_IMPLREADENDNEST_OFFSET UNITYSDK_OFFSET(0x195B7800)
#define SYSTEM_XML_XMLSQLBINARYREADER_IMPLREADNEST_OFFSET UNITYSDK_OFFSET(0x195B76E0)
#define SYSTEM_XML_XMLSQLBINARYREADER_IMPLREADPI_OFFSET UNITYSDK_OFFSET(0x195B7580)
#define SYSTEM_XML_XMLSQLBINARYREADER_IMPLREADXMLTEXT_OFFSET UNITYSDK_OFFSET(0x195B7840)
#define SYSTEM_XML_XMLSQLBINARYREADER_LOCATEATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x195B1160)
#define SYSTEM_XML_XMLSQLBINARYREADER_LOCATEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x195B0E30)
#define SYSTEM_XML_XMLSQLBINARYREADER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x195B2180)
#define SYSTEM_XML_XMLSQLBINARYREADER_MOVETOATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x195B16B0)
#define SYSTEM_XML_XMLSQLBINARYREADER_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x195B13F0)
#define SYSTEM_XML_XMLSQLBINARYREADER_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x195B1A10)
#define SYSTEM_XML_XMLSQLBINARYREADER_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x195B1800)
#define SYSTEM_XML_XMLSQLBINARYREADER_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x195B1900)
#define SYSTEM_XML_XMLSQLBINARYREADER_NAMEFLUSH_OFFSET UNITYSDK_OFFSET(0x195B4030)
#define SYSTEM_XML_XMLSQLBINARYREADER_NEXTTOKEN1_OFFSET UNITYSDK_OFFSET(0x195B4CB0)
#define SYSTEM_XML_XMLSQLBINARYREADER_NEXTTOKEN2_OFFSET UNITYSDK_OFFSET(0x195B4B70)
#define SYSTEM_XML_XMLSQLBINARYREADER_NEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x195B4DA0)
#define SYSTEM_XML_XMLSQLBINARYREADER_PARSEMB32_1_OFFSET UNITYSDK_OFFSET(0x195B48F0)
#define SYSTEM_XML_XMLSQLBINARYREADER_PARSEMB32_OFFSET UNITYSDK_OFFSET(0x195B4180)
#define SYSTEM_XML_XMLSQLBINARYREADER_PARSEMB32__OFFSET UNITYSDK_OFFSET(0x195B4830)
#define SYSTEM_XML_XMLSQLBINARYREADER_PARSEMB64_OFFSET UNITYSDK_OFFSET(0x195B4A40)
#define SYSTEM_XML_XMLSQLBINARYREADER_PARSETEXT_OFFSET UNITYSDK_OFFSET(0x195B3C50)
#define SYSTEM_XML_XMLSQLBINARYREADER_PEEKNEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x195B4E00)
#define SYSTEM_XML_XMLSQLBINARYREADER_PEEKTOKEN_OFFSET UNITYSDK_OFFSET(0x195B4A70)
#define SYSTEM_XML_XMLSQLBINARYREADER_POPNAMESPACES_OFFSET UNITYSDK_OFFSET(0x195B5470)
#define SYSTEM_XML_XMLSQLBINARYREADER_POSITIONONATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x195B15B0)
#define SYSTEM_XML_XMLSQLBINARYREADER_PUSHNAMESPACE_OFFSET UNITYSDK_OFFSET(0x195B5130)
#define SYSTEM_XML_XMLSQLBINARYREADER_READATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x195B1B90)
#define SYSTEM_XML_XMLSQLBINARYREADER_READBYTE_OFFSET UNITYSDK_OFFSET(0x195B4690)
#define SYSTEM_XML_XMLSQLBINARYREADER_READDOC_OFFSET UNITYSDK_OFFSET(0x195B2BF0)
#define SYSTEM_XML_XMLSQLBINARYREADER_READINIT_OFFSET UNITYSDK_OFFSET(0x195B25D0)
#define SYSTEM_XML_XMLSQLBINARYREADER_READNAMEREF_OFFSET UNITYSDK_OFFSET(0x195B3F90)
#define SYSTEM_XML_XMLSQLBINARYREADER_READQNAMEREF_OFFSET UNITYSDK_OFFSET(0x195B4240)
#define SYSTEM_XML_XMLSQLBINARYREADER_READTOKEN_OFFSET UNITYSDK_OFFSET(0x195B4AF0)
#define SYSTEM_XML_XMLSQLBINARYREADER_READUSHORT_OFFSET UNITYSDK_OFFSET(0x195B4740)
#define SYSTEM_XML_XMLSQLBINARYREADER_READ_OFFSET UNITYSDK_OFFSET(0x195B2370)
#define SYSTEM_XML_XMLSQLBINARYREADER_RESCANNEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x195B1DD0)
#define SYSTEM_XML_XMLSQLBINARYREADER_RESCANOVERVALUE_OFFSET UNITYSDK_OFFSET(0x195B2020)
#define SYSTEM_XML_XMLSQLBINARYREADER_RESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x195B2280)
#define SYSTEM_XML_XMLSQLBINARYREADER_SCANATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x195B5740)
#define SYSTEM_XML_XMLSQLBINARYREADER_SCANOVERANYVALUE_OFFSET UNITYSDK_OFFSET(0x195B8500)
#define SYSTEM_XML_XMLSQLBINARYREADER_SCANOVERVALUE_OFFSET UNITYSDK_OFFSET(0x195B5F50)
#define SYSTEM_XML_XMLSQLBINARYREADER_SCANTEXT_OFFSET UNITYSDK_OFFSET(0x195B4E80)
#define SYSTEM_XML_XMLSQLBINARYREADER_SIMPLECHECKFORDUPLICATEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x195B6190)
#define SYSTEM_XML_XMLSQLBINARYREADER_SKIPEXTN_OFFSET UNITYSDK_OFFSET(0x195B4090)
#define SYSTEM_XML_XMLSQLBINARYREADER_SYSTEM_XML_IXMLNAMESPACERESOLVER_GETNAMESPACESINSCOPE_OFFSET UNITYSDK_OFFSET(0x195B3240)
#define SYSTEM_XML_XMLSQLBINARYREADER_SYSTEM_XML_IXMLNAMESPACERESOLVER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x195B3720)
#define SYSTEM_XML_XMLSQLBINARYREADER_THROWNOTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x195B6110)
#define SYSTEM_XML_XMLSQLBINARYREADER_THROWUNEXPECTEDTOKEN_OFFSET UNITYSDK_OFFSET(0x195B3970)
#define SYSTEM_XML_XMLSQLBINARYREADER_THROWXMLEXCEPTION_1_OFFSET UNITYSDK_OFFSET(0x195B5E00)
#define SYSTEM_XML_XMLSQLBINARYREADER_THROWXMLEXCEPTION_OFFSET UNITYSDK_OFFSET(0x195B45B0)
#define SYSTEM_XML_XMLSQLBINARYREADER_UPDATEFROMTEXTREADER_1_OFFSET UNITYSDK_OFFSET(0x195B1500)
#define SYSTEM_XML_XMLSQLBINARYREADER_UPDATEFROMTEXTREADER_OFFSET UNITYSDK_OFFSET(0x195B8160)
#define SYSTEM_XML_XMLSQLBINARYREADER_VALUEASDATETIMESTRING_OFFSET UNITYSDK_OFFSET(0x195BA590)
#define SYSTEM_XML_XMLSQLBINARYREADER_VALUEASDECIMAL_OFFSET UNITYSDK_OFFSET(0x195B9DD0)
#define SYSTEM_XML_XMLSQLBINARYREADER_VALUEASDOUBLE_OFFSET UNITYSDK_OFFSET(0x195B9990)
#define SYSTEM_XML_XMLSQLBINARYREADER_VALUEASLONG_OFFSET UNITYSDK_OFFSET(0x195B8F90)
#define SYSTEM_XML_XMLSQLBINARYREADER_VALUEASSTRING_OFFSET UNITYSDK_OFFSET(0x195AF6B0)
#define SYSTEM_XML_XMLSQLBINARYREADER_VALUEASULONG_OFFSET UNITYSDK_OFFSET(0x195BA2B0)
#define SYSTEM_XML_XMLSQLBINARYREADER_VERIFYVERSION_OFFSET UNITYSDK_OFFSET(0x195B3910)
#define SYSTEM_XML_XMLSQLBINARYREADER_XMLDECLVALUE_OFFSET UNITYSDK_OFFSET(0x195AF4C0)
#define SYSTEM_XML_XMLSQLBINARYREADER_XSDKATMAITIMESCALETOVALUELENGTH_OFFSET UNITYSDK_OFFSET(0x195B8ED0)
#define SYSTEM_XML_XMLSQLBINARYREADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x195BA980)
#define SYSTEM_XML_XMLSQLBINARYREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x195ACE60)
...
namespace System::Xml
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(XmlSqlBinaryReader_TypeDefinitionIndex)->GetStaticField(0x1FD0);
		}
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Xml::XmlSqlBinaryReader_NamespaceDecl*>* namespaces; // 0x18
		::System::String* nsxmlns; // 0x20
		::System::Xml::XmlSqlBinaryReader_NestedBinXml* prevNameInfo; // 0x28
		::System::Xml::SecureStringHasher* hasher; // 0x30
		::Il2CppArray<::System::Xml::XmlSqlBinaryReader_AttrInfo>* attributes; // 0x38
		::System::String* stringValue; // 0x40
		::System::IO::Stream* inStrm; // 0x48
		::Il2CppArray<::System::Int32>* attrHashTbl; // 0x50
		::System::Xml::XmlNameTable* xnt; // 0x58
		::Il2CppArray<::System::Xml::XmlSqlBinaryReader_ElemInfo>* elementStack; // 0x60
		::System::String* baseUri; // 0x68
		::System::String* xml; // 0x70
		::System::Text::Encoding* unicode; // 0x78
		::System::Xml::XmlReader* textXmlReader; // 0x80
		::System::Xml::XmlSqlBinaryReader_QName qnameOther; // 0x88
		::System::Xml::XmlSqlBinaryReader_QName qnameElement; // 0xA0
		::System::String* xmlns; // 0xB8
		::System::Xml::XmlCharType xmlCharType; // 0xC0
		::System::Type* valueType; // 0xC8
		::System::Xml::XmlSqlBinaryReader_SymbolTables symbolTables; // 0xD0
		::System::Int32 posAfterAttrs; // 0xF0
		::System::Int32 docState; // 0xF4
		::System::Int32 elemDepth; // 0xF8
		::System::Xml::XmlNodeType nodetype; // 0xFC
		::System::Xml::BinXmlToken token; // 0x100
		::System::Int32 mark; // 0x104
		::System::Int32 tokLen; // 0x108
		::System::Xml::XmlSqlBinaryReader_ScanState state; // 0x10C
		::System::Xml::DtdProcessing dtdProcessing; // 0x110
		::System::Boolean sniffed; // 0x114
		::System::Byte version; // 0x115
		::System::Boolean hasTypedValue; // 0x116
		::System::Boolean closeInput; // 0x117
		::System::Int32 attrCount; // 0x118
		::System::Int32 attrIndex; // 0x11C
		::System::Int32 end; // 0x120
		::System::Boolean eof; // 0x124
		::System::Boolean ignoreWhitespace; // 0x125
		::System::Boolean ignorePIs; // 0x126
		::System::Boolean xmlspacePreserve; // 0x127
		::System::Int64 offset; // 0x128
		::System::Boolean xntFromSettings; // 0x130
		::System::Boolean ignoreComments; // 0x131
		::System::Boolean isEmpty; // 0x132
		::System::Boolean checkCharacters; // 0x133
		::System::Xml::XmlNodeType parentNodeType; // 0x134
		::System::Int32 tokDataPos; // 0x138
