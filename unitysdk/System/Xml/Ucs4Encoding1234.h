...
#define SYSTEM_XML_UCS4ENCODING1234_GETPREAMBLE_OFFSET UNITYSDK_OFFSET(0x1A271960)
#define SYSTEM_XML_UCS4ENCODING1234_GET_ENCODINGNAME_OFFSET UNITYSDK_OFFSET(0x1A271920)
#define SYSTEM_XML_UCS4ENCODING1234__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2718B0)
