...
#define SYSTEM_WINDOWS_MARKUP_VALUESERIALIZERATTRIBUTE_GET_VALUESERIALIZERTYPENAME_OFFSET UNITYSDK_OFFSET(0x19FE6F40)
#define SYSTEM_WINDOWS_MARKUP_VALUESERIALIZERATTRIBUTE_GET_VALUESERIALIZERTYPE_OFFSET UNITYSDK_OFFSET(0x19FE6EF0)
#define SYSTEM_WINDOWS_MARKUP_VALUESERIALIZERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FE6EE0)
#define SYSTEM_WINDOWS_MARKUP_VALUESERIALIZERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE6ED0)
