...
#define SYSTEM_THREADING_MUTEX_CREATEMUTEX_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19B7CFD0)
#define SYSTEM_THREADING_MUTEX_RELEASEMUTEX_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19B7CFB0)
#define SYSTEM_THREADING_MUTEX_RELEASEMUTEX_OFFSET UNITYSDK_OFFSET(0x19B7D130)
#define SYSTEM_THREADING_MUTEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B7D0E0)
#define SYSTEM_THREADING_MUTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x19B7CFE0)
