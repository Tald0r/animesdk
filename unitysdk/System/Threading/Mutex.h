...
#define SYSTEM_THREADING_MUTEX_CREATEMUTEX_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A1418B0)
#define SYSTEM_THREADING_MUTEX_RELEASEMUTEX_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A141890)
#define SYSTEM_THREADING_MUTEX_RELEASEMUTEX_OFFSET UNITYSDK_OFFSET(0x1A141A10)
#define SYSTEM_THREADING_MUTEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1419C0)
#define SYSTEM_THREADING_MUTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1418C0)
