...
#define SYSTEM_THREADING_SEMAPHORESLIM_CANCELLATIONTOKENCANCELEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1A144730)
#define SYSTEM_THREADING_SEMAPHORESLIM_CHECKDISPOSE_OFFSET UNITYSDK_OFFSET(0x1A142EF0)
#define SYSTEM_THREADING_SEMAPHORESLIM_CREATEANDADDASYNCWAITER_OFFSET UNITYSDK_OFFSET(0x1A144070)
#define SYSTEM_THREADING_SEMAPHORESLIM_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A1446A0)
#define SYSTEM_THREADING_SEMAPHORESLIM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A144650)
#define SYSTEM_THREADING_SEMAPHORESLIM_GETRESOURCESTRING_OFFSET UNITYSDK_OFFSET(0x1A143070)
#define SYSTEM_THREADING_SEMAPHORESLIM_GET_AVAILABLEWAITHANDLE_OFFSET UNITYSDK_OFFSET(0x1A142D90)
#define SYSTEM_THREADING_SEMAPHORESLIM_GET_CURRENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A142D80)
#define SYSTEM_THREADING_SEMAPHORESLIM_QUEUEWAITERTASK_OFFSET UNITYSDK_OFFSET(0x1A144640)
#define SYSTEM_THREADING_SEMAPHORESLIM_RELEASE_1_OFFSET UNITYSDK_OFFSET(0x1A1442E0)
#define SYSTEM_THREADING_SEMAPHORESLIM_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A1442D0)
#define SYSTEM_THREADING_SEMAPHORESLIM_REMOVEASYNCWAITER_OFFSET UNITYSDK_OFFSET(0x1A144240)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAITASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A1437D0)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAITASYNC_OFFSET UNITYSDK_OFFSET(0x1A144060)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAITUNTILCOUNTORTIMEOUTASYNC_OFFSET UNITYSDK_OFFSET(0x1A144140)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAITUNTILCOUNTORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A143C10)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAIT_1_OFFSET UNITYSDK_OFFSET(0x1A1437C0)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAIT_2_OFFSET UNITYSDK_OFFSET(0x1A143090)
#define SYSTEM_THREADING_SEMAPHORESLIM_WAIT_OFFSET UNITYSDK_OFFSET(0x1A143080)
#define SYSTEM_THREADING_SEMAPHORESLIM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A144810)
#define SYSTEM_THREADING_SEMAPHORESLIM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A142F60)
#define SYSTEM_THREADING_SEMAPHORESLIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A142F50)
...
namespace System::Threading
{
	...
	public:
		...
		{
			return (::System::Action_1<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(SemaphoreSlim_TypeDefinitionIndex)->GetStaticField(0x1480);
		}
		static ::System::Threading::Tasks::Task_1<::System::Boolean>** StaticGet_s_trueTask()
		{
			return (::System::Threading::Tasks::Task_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(SemaphoreSlim_TypeDefinitionIndex)->GetStaticField(0x1488);
		}
