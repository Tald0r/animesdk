...
#define SYSTEM_THREADING_SEMAPHORE_CREATESEMAPHORE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19261A10)
#define SYSTEM_THREADING_SEMAPHORE_GETACCESSCONTROL_OFFSET UNITYSDK_OFFSET(0x192620B0)
#define SYSTEM_THREADING_SEMAPHORE_OPENEXISTINGWORKER_OFFSET UNITYSDK_OFFSET(0x19261DA0)
#define SYSTEM_THREADING_SEMAPHORE_OPENEXISTING_1_OFFSET UNITYSDK_OFFSET(0x19261D60)
#define SYSTEM_THREADING_SEMAPHORE_OPENEXISTING_OFFSET UNITYSDK_OFFSET(0x19261D20)
#define SYSTEM_THREADING_SEMAPHORE_OPENSEMAPHORE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x192622B0)
#define SYSTEM_THREADING_SEMAPHORE_RELEASESEMAPHORE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19262090)
#define SYSTEM_THREADING_SEMAPHORE_RELEASE_1_OFFSET UNITYSDK_OFFSET(0x19261F20)
#define SYSTEM_THREADING_SEMAPHORE_RELEASE_OFFSET UNITYSDK_OFFSET(0x19261F10)
#define SYSTEM_THREADING_SEMAPHORE_SETACCESSCONTROL_OFFSET UNITYSDK_OFFSET(0x192621A0)
#define SYSTEM_THREADING_SEMAPHORE_TRYOPENEXISTING_1_OFFSET UNITYSDK_OFFSET(0x19261F00)
#define SYSTEM_THREADING_SEMAPHORE_TRYOPENEXISTING_OFFSET UNITYSDK_OFFSET(0x19261EF0)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19261790)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19261A20)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19261A40)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19261CD0)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_OFFSET UNITYSDK_OFFSET(0x19261780)
