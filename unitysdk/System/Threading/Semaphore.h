...
#define SYSTEM_THREADING_SEMAPHORE_CREATESEMAPHORE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x18E5E770)
#define SYSTEM_THREADING_SEMAPHORE_GETACCESSCONTROL_OFFSET UNITYSDK_OFFSET(0x18E5EE10)
#define SYSTEM_THREADING_SEMAPHORE_OPENEXISTINGWORKER_OFFSET UNITYSDK_OFFSET(0x18E5EB00)
#define SYSTEM_THREADING_SEMAPHORE_OPENEXISTING_1_OFFSET UNITYSDK_OFFSET(0x18E5EAC0)
#define SYSTEM_THREADING_SEMAPHORE_OPENEXISTING_OFFSET UNITYSDK_OFFSET(0x18E5EA80)
#define SYSTEM_THREADING_SEMAPHORE_OPENSEMAPHORE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x18E5F010)
#define SYSTEM_THREADING_SEMAPHORE_RELEASESEMAPHORE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x18E5EDF0)
#define SYSTEM_THREADING_SEMAPHORE_RELEASE_1_OFFSET UNITYSDK_OFFSET(0x18E5EC80)
#define SYSTEM_THREADING_SEMAPHORE_RELEASE_OFFSET UNITYSDK_OFFSET(0x18E5EC70)
#define SYSTEM_THREADING_SEMAPHORE_SETACCESSCONTROL_OFFSET UNITYSDK_OFFSET(0x18E5EF00)
#define SYSTEM_THREADING_SEMAPHORE_TRYOPENEXISTING_1_OFFSET UNITYSDK_OFFSET(0x18E5EC60)
#define SYSTEM_THREADING_SEMAPHORE_TRYOPENEXISTING_OFFSET UNITYSDK_OFFSET(0x18E5EC50)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18E5E4F0)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18E5E780)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18E5E7A0)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18E5EA30)
#define SYSTEM_THREADING_SEMAPHORE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5E4E0)
