...
#define SYSTEM_THREADING_PARAMETERIZEDTHREADSTART_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x192C7700)
#define SYSTEM_THREADING_PARAMETERIZEDTHREADSTART_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x192C7730)
#define SYSTEM_THREADING_PARAMETERIZEDTHREADSTART_INVOKE_OFFSET UNITYSDK_OFFSET(0x192C7200)
#define SYSTEM_THREADING_PARAMETERIZEDTHREADSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x192C71F0)
