...
#define SYSTEM_THREADING_THREADPOOL_ENSUREVMINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1930A800)
#define SYSTEM_THREADING_THREADPOOL_GETAVAILABLETHREADSNATIVE_OFFSET UNITYSDK_OFFSET(0x1930A280)
#define SYSTEM_THREADING_THREADPOOL_GETAVAILABLETHREADS_OFFSET UNITYSDK_OFFSET(0x1930A220)
#define SYSTEM_THREADING_THREADPOOL_GETMINTHREADSNATIVE_OFFSET UNITYSDK_OFFSET(0x1930A1E0)
#define SYSTEM_THREADING_THREADPOOL_GETMINTHREADS_OFFSET UNITYSDK_OFFSET(0x1930A1A0)
#define SYSTEM_THREADING_THREADPOOL_INITIALIZEVMTP_OFFSET UNITYSDK_OFFSET(0x1930AA50)
#define SYSTEM_THREADING_THREADPOOL_ISTHREADPOOLHOSTED_OFFSET UNITYSDK_OFFSET(0x1930ACB0)
#define SYSTEM_THREADING_THREADPOOL_NOTIFYWORKITEMCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1930AA60)
#define SYSTEM_THREADING_THREADPOOL_NOTIFYWORKITEMPROGRESSNATIVE_OFFSET UNITYSDK_OFFSET(0x1930AC20)
#define SYSTEM_THREADING_THREADPOOL_NOTIFYWORKITEMPROGRESS_OFFSET UNITYSDK_OFFSET(0x1930AB30)
#define SYSTEM_THREADING_THREADPOOL_QUEUEUSERWORKITEMHELPER_OFFSET UNITYSDK_OFFSET(0x1930A690)
#define SYSTEM_THREADING_THREADPOOL_QUEUEUSERWORKITEM_1_OFFSET UNITYSDK_OFFSET(0x1930A7D0)
#define SYSTEM_THREADING_THREADPOOL_QUEUEUSERWORKITEM_OFFSET UNITYSDK_OFFSET(0x1930A490)
#define SYSTEM_THREADING_THREADPOOL_REGISTERWAITFORSINGLEOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1930A4D0)
#define SYSTEM_THREADING_THREADPOOL_REGISTERWAITFORSINGLEOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1930A570)
#define SYSTEM_THREADING_THREADPOOL_REGISTERWAITFORSINGLEOBJECT_OFFSET UNITYSDK_OFFSET(0x1930A2E0)
#define SYSTEM_THREADING_THREADPOOL_REPORTTHREADSTATUS_OFFSET UNITYSDK_OFFSET(0x1930AB20)
#define SYSTEM_THREADING_THREADPOOL_REQUESTWORKERTHREAD_OFFSET UNITYSDK_OFFSET(0x1930AA40)
#define SYSTEM_THREADING_THREADPOOL_TRYPOPCUSTOMWORKITEM_OFFSET UNITYSDK_OFFSET(0x1930A940)
#define SYSTEM_THREADING_THREADPOOL_UNSAFEQUEUECUSTOMWORKITEM_OFFSET UNITYSDK_OFFSET(0x1930A870)
#define SYSTEM_THREADING_THREADPOOL_UNSAFEQUEUEUSERWORKITEM_OFFSET UNITYSDK_OFFSET(0x1930A4B0)
