...
#define SYSTEM_THREADING_LOCKQUEUE_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x18620BC0)
#define SYSTEM_THREADING_LOCKQUEUE_PULSE_OFFSET UNITYSDK_OFFSET(0x18620C70)
#define SYSTEM_THREADING_LOCKQUEUE_WAIT_OFFSET UNITYSDK_OFFSET(0x18620990)
#define SYSTEM_THREADING_LOCKQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18620980)
