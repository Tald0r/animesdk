...
#define SYSTEM_THREADING_LOCKQUEUE_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x17FED1C0)
#define SYSTEM_THREADING_LOCKQUEUE_PULSE_OFFSET UNITYSDK_OFFSET(0x17FED270)
#define SYSTEM_THREADING_LOCKQUEUE_WAIT_OFFSET UNITYSDK_OFFSET(0x17FECF90)
#define SYSTEM_THREADING_LOCKQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x17FECF80)
