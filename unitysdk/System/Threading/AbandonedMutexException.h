...
#define SYSTEM_THREADING_ABANDONEDMUTEXEXCEPTION_SETUPEXCEPTION_OFFSET UNITYSDK_OFFSET(0x19DDFE30)
#define SYSTEM_THREADING_ABANDONEDMUTEXEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19DDFCD0)
#define SYSTEM_THREADING_ABANDONEDMUTEXEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19DDFD40)
#define SYSTEM_THREADING_ABANDONEDMUTEXEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19DDFE90)
#define SYSTEM_THREADING_ABANDONEDMUTEXEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDFC40)
