...
#define SYSTEM_THREADING_TIMERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19CD4DD0)
#define SYSTEM_THREADING_TIMERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19CD4E00)
#define SYSTEM_THREADING_TIMERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19CD48D0)
#define SYSTEM_THREADING_TIMERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD48B0)
