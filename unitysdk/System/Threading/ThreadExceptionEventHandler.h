...
#define SYSTEM_THREADING_THREADEXCEPTIONEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x182F91B0)
#define SYSTEM_THREADING_THREADEXCEPTIONEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x182F91F0)
#define SYSTEM_THREADING_THREADEXCEPTIONEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x182F8C30)
#define SYSTEM_THREADING_THREADEXCEPTIONEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x182F8C20)
