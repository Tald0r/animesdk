...
#define SYSTEM_THREADING_BARRIERPOSTPHASEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x185B4D20)
#define SYSTEM_THREADING_BARRIERPOSTPHASEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x185B4C80)
#define SYSTEM_THREADING_BARRIERPOSTPHASEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x185B4DC0)
#define SYSTEM_THREADING_BARRIERPOSTPHASEEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x185B4E70)
#define SYSTEM_THREADING_BARRIERPOSTPHASEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x185B4BE0)
