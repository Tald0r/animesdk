...
#define SYSTEM_THREADING_SPINWAIT_GET_NEXTSPINWILLYIELD_OFFSET UNITYSDK_OFFSET(0x8B1650)
#define SYSTEM_THREADING_SPINWAIT_RESET_OFFSET UNITYSDK_OFFSET(0x2F7610)
#define SYSTEM_THREADING_SPINWAIT_SPINONCE_OFFSET UNITYSDK_OFFSET(0x8B16E0)
#define SYSTEM_THREADING_SPINWAIT_SPINUNTIL_OFFSET UNITYSDK_OFFSET(0x197AF7F0)
