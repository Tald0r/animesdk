...
#define SYSTEM_THREADING_SENDORPOSTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19CD3C50)
#define SYSTEM_THREADING_SENDORPOSTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19CD3C80)
#define SYSTEM_THREADING_SENDORPOSTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19CD3750)
#define SYSTEM_THREADING_SENDORPOSTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD3730)
