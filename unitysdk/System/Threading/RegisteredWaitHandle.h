...
#define SYSTEM_THREADING_REGISTEREDWAITHANDLE_DOCALLBACK_OFFSET UNITYSDK_OFFSET(0x19B7E110)
#define SYSTEM_THREADING_REGISTEREDWAITHANDLE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x19B7E340)
#define SYSTEM_THREADING_REGISTEREDWAITHANDLE_WAIT_OFFSET UNITYSDK_OFFSET(0x19B7D5C0)
#define SYSTEM_THREADING_REGISTEREDWAITHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B7E460)
#define SYSTEM_THREADING_REGISTEREDWAITHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B7D550)
...
namespace System::Threading
{
	...
	public:
		...
		::System::Threading::WaitOrTimerCallback* _callback; // 0x38
