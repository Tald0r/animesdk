...
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREREADERLOCK_1_OFFSET UNITYSDK_OFFSET(0x19150710)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREREADERLOCK_2_OFFSET UNITYSDK_OFFSET(0x19150E40)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1914BEF0)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREWRITERLOCK_1_OFFSET UNITYSDK_OFFSET(0x19150C30)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREWRITERLOCK_2_OFFSET UNITYSDK_OFFSET(0x19150FB0)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1914C0F0)
#define SYSTEM_THREADING_READERWRITERLOCK_CHECKTIMEOUT_OFFSET UNITYSDK_OFFSET(0x19150F00)
#define SYSTEM_THREADING_READERWRITERLOCK_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19150700)
#define SYSTEM_THREADING_READERWRITERLOCK_GET_ISREADERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1914BD40)
#define SYSTEM_THREADING_READERWRITERLOCK_GET_ISWRITERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1914BE20)
#define SYSTEM_THREADING_READERWRITERLOCK_HASWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x19150C00)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEREADERLOCK_1_OFFSET UNITYSDK_OFFSET(0x19151070)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1914BF00)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEWRITERLOCK_1_OFFSET UNITYSDK_OFFSET(0x19151290)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1914C100)
#define SYSTEM_THREADING_READERWRITERLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1914AD10)
