...
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREREADERLOCK_1_OFFSET UNITYSDK_OFFSET(0x194F6090)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREREADERLOCK_2_OFFSET UNITYSDK_OFFSET(0x194F67C0)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREREADERLOCK_OFFSET UNITYSDK_OFFSET(0x194F1880)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREWRITERLOCK_1_OFFSET UNITYSDK_OFFSET(0x194F65B0)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREWRITERLOCK_2_OFFSET UNITYSDK_OFFSET(0x194F6930)
#define SYSTEM_THREADING_READERWRITERLOCK_ACQUIREWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x194F1A80)
#define SYSTEM_THREADING_READERWRITERLOCK_CHECKTIMEOUT_OFFSET UNITYSDK_OFFSET(0x194F6880)
#define SYSTEM_THREADING_READERWRITERLOCK_FINALIZE_OFFSET UNITYSDK_OFFSET(0x194F6080)
#define SYSTEM_THREADING_READERWRITERLOCK_GET_ISREADERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x194F16D0)
#define SYSTEM_THREADING_READERWRITERLOCK_GET_ISWRITERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x194F17B0)
#define SYSTEM_THREADING_READERWRITERLOCK_HASWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x194F6580)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEREADERLOCK_1_OFFSET UNITYSDK_OFFSET(0x194F69F0)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEREADERLOCK_OFFSET UNITYSDK_OFFSET(0x194F1890)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEWRITERLOCK_1_OFFSET UNITYSDK_OFFSET(0x194F6C10)
#define SYSTEM_THREADING_READERWRITERLOCK_RELEASEWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x194F1A90)
#define SYSTEM_THREADING_READERWRITERLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x194F06A0)
