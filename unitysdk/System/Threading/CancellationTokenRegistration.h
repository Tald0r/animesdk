...
#define SYSTEM_THREADING_CANCELLATIONTOKENREGISTRATION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8777B0)
#define SYSTEM_THREADING_CANCELLATIONTOKENREGISTRATION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x877830)
#define SYSTEM_THREADING_CANCELLATIONTOKENREGISTRATION_EQUALS_OFFSET UNITYSDK_OFFSET(0x8777C0)
#define SYSTEM_THREADING_CANCELLATIONTOKENREGISTRATION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x877860)
#define SYSTEM_THREADING_CANCELLATIONTOKENREGISTRATION_TRYDEREGISTER_OFFSET UNITYSDK_OFFSET(0x877740)
#define SYSTEM_THREADING_CANCELLATIONTOKENREGISTRATION__CTOR_OFFSET UNITYSDK_OFFSET(0x548490)
