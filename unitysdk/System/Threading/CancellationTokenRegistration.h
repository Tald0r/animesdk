...
#define SYSTEM_THREADING_CANCELLATIONTOKENREGISTRATION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x848F40)
#define SYSTEM_THREADING_CANCELLATIONTOKENREGISTRATION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x848FC0)
#define SYSTEM_THREADING_CANCELLATIONTOKENREGISTRATION_EQUALS_OFFSET UNITYSDK_OFFSET(0x848F50)
#define SYSTEM_THREADING_CANCELLATIONTOKENREGISTRATION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x848FF0)
#define SYSTEM_THREADING_CANCELLATIONTOKENREGISTRATION_TRYDEREGISTER_OFFSET UNITYSDK_OFFSET(0x848ED0)
#define SYSTEM_THREADING_CANCELLATIONTOKENREGISTRATION__CTOR_OFFSET UNITYSDK_OFFSET(0x3ED010)
