...
#define SYSTEM_THREADING_TASKS_TASK_CONTINGENTPROPERTIES_DEREGISTERCANCELLATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x18620D40)
#define SYSTEM_THREADING_TASKS_TASK_CONTINGENTPROPERTIES_SETCOMPLETED_OFFSET UNITYSDK_OFFSET(0x18620D20)
#define SYSTEM_THREADING_TASKS_TASK_CONTINGENTPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x18620DE0)
...
namespace System::Threading::Tasks
{
	...
	{
	public:
		::System::Threading::Tasks::Shared_1<::System::Threading::CancellationTokenRegistration>* m_cancellationRegistration; // 0x10
		...
		::System::Threading::ManualResetEventSlim* m_completionEvent; // 0x30
