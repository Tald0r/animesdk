...
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS32_GET_LOWESTBREAKITERATION_OFFSET UNITYSDK_OFFSET(0x1A144BC0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS32_SHOULDEXITLOOP_1_OFFSET UNITYSDK_OFFSET(0x1A144CA0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS32_SHOULDEXITLOOP_OFFSET UNITYSDK_OFFSET(0x1A144BD0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS32__CTOR_OFFSET UNITYSDK_OFFSET(0x1A144D30)
