...
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197B03F0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x197B03E0)
