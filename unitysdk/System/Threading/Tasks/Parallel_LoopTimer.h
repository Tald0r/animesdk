...
#define SYSTEM_THREADING_TASKS_PARALLEL_LOOPTIMER_LIMITEXCEEDED_OFFSET UNITYSDK_OFFSET(0x8CCB10)
#define SYSTEM_THREADING_TASKS_PARALLEL_LOOPTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x8CCA40)
