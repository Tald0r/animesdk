...
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_GET_HANDEDOVERCHILDREPLICA_OFFSET UNITYSDK_OFFSET(0x192C84D0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_GET_SAVEDSTATEFORNEXTREPLICA_OFFSET UNITYSDK_OFFSET(0x192C8490)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_GET_SAVEDSTATEFROMPREVIOUSREPLICA_OFFSET UNITYSDK_OFFSET(0x192C84B0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_SET_HANDEDOVERCHILDREPLICA_OFFSET UNITYSDK_OFFSET(0x192C84E0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_SET_SAVEDSTATEFORNEXTREPLICA_OFFSET UNITYSDK_OFFSET(0x192C84A0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK_SET_SAVEDSTATEFROMPREVIOUSREPLICA_OFFSET UNITYSDK_OFFSET(0x192C84C0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATASK__CTOR_OFFSET UNITYSDK_OFFSET(0x192C83D0)
...
namespace System::Threading::Tasks
{
	...
	{
	public:
		::System::Threading::Tasks::Task* m_handedOverChildReplica; // 0x48
		::System::Object* m_stateForNextReplica; // 0x50
		::System::Object* m_stateFromPreviousReplica; // 0x58
