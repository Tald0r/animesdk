...
#define SYSTEM_THREADING_TASKS_RANGEWORKER_FINDNEWWORK32_OFFSET UNITYSDK_OFFSET(0x8A1260)
#define SYSTEM_THREADING_TASKS_RANGEWORKER_FINDNEWWORK_OFFSET UNITYSDK_OFFSET(0x8A1250)
#define SYSTEM_THREADING_TASKS_RANGEWORKER__CTOR_OFFSET UNITYSDK_OFFSET(0x8A1220)
