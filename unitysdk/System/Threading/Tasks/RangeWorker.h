...
#define SYSTEM_THREADING_TASKS_RANGEWORKER_FINDNEWWORK32_OFFSET UNITYSDK_OFFSET(0x879BA0)
#define SYSTEM_THREADING_TASKS_RANGEWORKER_FINDNEWWORK_OFFSET UNITYSDK_OFFSET(0x879B90)
#define SYSTEM_THREADING_TASKS_RANGEWORKER__CTOR_OFFSET UNITYSDK_OFFSET(0x879B60)
...
namespace System::Threading::Tasks
{
	...
	struct alignas(8) RangeWorker
	{
		...
		::System::Int64 m_nMaxIncrementValue; // 0x20
		::System::Int64 m_nIncrementValue; // 0x28
		::System::Int32 m_nCurrentIndexRange; // 0x30
		::System::Boolean _use32BitCurrentIndex; // 0x34
