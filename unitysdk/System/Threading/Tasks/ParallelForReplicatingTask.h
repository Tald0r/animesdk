...
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATINGTASK_CREATEREPLICATASK_OFFSET UNITYSDK_OFFSET(0x19B80310)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATINGTASK_SHOULDREPLICATE_OFFSET UNITYSDK_OFFSET(0x19B802F0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATINGTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x19B800E0)
