...
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATINGTASK_CREATEREPLICATASK_OFFSET UNITYSDK_OFFSET(0x1A144AD0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATINGTASK_SHOULDREPLICATE_OFFSET UNITYSDK_OFFSET(0x1A144AB0)
#define SYSTEM_THREADING_TASKS_PARALLELFORREPLICATINGTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1448A0)
