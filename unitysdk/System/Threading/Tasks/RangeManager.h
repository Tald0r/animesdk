...
#define SYSTEM_THREADING_TASKS_RANGEMANAGER_REGISTERNEWWORKER_OFFSET UNITYSDK_OFFSET(0x18EECCB0)
#define SYSTEM_THREADING_TASKS_RANGEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EECB00)
