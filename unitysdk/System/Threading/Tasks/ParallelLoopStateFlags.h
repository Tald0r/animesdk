...
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_ATOMICLOOPSTATEUPDATE_1_OFFSET UNITYSDK_OFFSET(0x1A0CC230)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_ATOMICLOOPSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0CC1C0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_CANCEL_OFFSET UNITYSDK_OFFSET(0x1A0CC360)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_GET_LOOPSTATEFLAGS_OFFSET UNITYSDK_OFFSET(0x1A0CC1B0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_SETEXCEPTIONAL_OFFSET UNITYSDK_OFFSET(0x1A0CC2B0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0CC470)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0CC410)
