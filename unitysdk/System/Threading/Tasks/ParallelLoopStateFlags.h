...
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_ATOMICLOOPSTATEUPDATE_1_OFFSET UNITYSDK_OFFSET(0x19ADDC70)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_ATOMICLOOPSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19ADDC00)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_CANCEL_OFFSET UNITYSDK_OFFSET(0x19ADDDA0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_GET_LOOPSTATEFLAGS_OFFSET UNITYSDK_OFFSET(0x19ADDBF0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS_SETEXCEPTIONAL_OFFSET UNITYSDK_OFFSET(0x19ADDCF0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19ADDEB0)
#define SYSTEM_THREADING_TASKS_PARALLELLOOPSTATEFLAGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADDE50)
