...
#define SYSTEM_THREADING_TASKS_PARALLEL_FOR_OFFSET UNITYSDK_OFFSET(0x197AFCE0)
#define SYSTEM_THREADING_TASKS_PARALLEL_THROWIFREDUCABLETOSINGLEOCE_OFFSET UNITYSDK_OFFSET(0x197AFDD0)
#define SYSTEM_THREADING_TASKS_PARALLEL__CCTOR_OFFSET UNITYSDK_OFFSET(0x197B0220)
