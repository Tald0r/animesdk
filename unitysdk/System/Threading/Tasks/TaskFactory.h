...
#define SYSTEM_THREADING_TASKS_TASKFACTORY_CHECKCREATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x19014420)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_CHECKFROMASYNCOPTIONS_OFFSET UNITYSDK_OFFSET(0x190147C0)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_CHECKMULTITASKCONTINUATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x19014350)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_COMMONCWANYLOGIC_OFFSET UNITYSDK_OFFSET(0x19014880)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_FROMASYNC_1_OFFSET UNITYSDK_OFFSET(0x19014790)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_FROMASYNC_OFFSET UNITYSDK_OFFSET(0x19014760)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_GETDEFAULTSCHEDULER_OFFSET UNITYSDK_OFFSET(0x19014250)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_STARTNEW_1_OFFSET UNITYSDK_OFFSET(0x19014550)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_STARTNEW_2_OFFSET UNITYSDK_OFFSET(0x19014670)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_STARTNEW_OFFSET UNITYSDK_OFFSET(0x19014470)
#define SYSTEM_THREADING_TASKS_TASKFACTORY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x190142E0)
#define SYSTEM_THREADING_TASKS_TASKFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x190142D0)
