...
#define SYSTEM_THREADING_TASKS_TASKFACTORY_CHECKCREATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x18B29AD0)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_CHECKFROMASYNCOPTIONS_OFFSET UNITYSDK_OFFSET(0x18B29E70)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_CHECKMULTITASKCONTINUATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x18B29A00)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_COMMONCWANYLOGIC_OFFSET UNITYSDK_OFFSET(0x18B29F30)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_FROMASYNC_1_OFFSET UNITYSDK_OFFSET(0x18B29E40)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_FROMASYNC_OFFSET UNITYSDK_OFFSET(0x18B29E10)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_GETDEFAULTSCHEDULER_OFFSET UNITYSDK_OFFSET(0x18B29900)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_STARTNEW_1_OFFSET UNITYSDK_OFFSET(0x18B29C00)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_STARTNEW_2_OFFSET UNITYSDK_OFFSET(0x18B29D20)
#define SYSTEM_THREADING_TASKS_TASKFACTORY_STARTNEW_OFFSET UNITYSDK_OFFSET(0x18B29B20)
#define SYSTEM_THREADING_TASKS_TASKFACTORY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B29990)
#define SYSTEM_THREADING_TASKS_TASKFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x18B29980)
