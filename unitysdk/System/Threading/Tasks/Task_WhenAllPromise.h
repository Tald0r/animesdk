...
#define SYSTEM_THREADING_TASKS_TASK_WHENALLPROMISE_GET_SHOULDNOTIFYDEBUGGEROFWAITCOMPLETION_OFFSET UNITYSDK_OFFSET(0x194F78D0)
#define SYSTEM_THREADING_TASKS_TASK_WHENALLPROMISE_INVOKE_OFFSET UNITYSDK_OFFSET(0x194F74C0)
#define SYSTEM_THREADING_TASKS_TASK_WHENALLPROMISE__CTOR_OFFSET UNITYSDK_OFFSET(0x194F7340)
