...
#define SYSTEM_THREADING_TASKS_TASK_WHENALLPROMISE_GET_SHOULDNOTIFYDEBUGGEROFWAITCOMPLETION_OFFSET UNITYSDK_OFFSET(0x19151F50)
#define SYSTEM_THREADING_TASKS_TASK_WHENALLPROMISE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19151B40)
#define SYSTEM_THREADING_TASKS_TASK_WHENALLPROMISE__CTOR_OFFSET UNITYSDK_OFFSET(0x191519C0)
