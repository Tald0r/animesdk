...
#define SYSTEM_THREADING_READERWRITERLOCKSLIM_TIMEOUTTRACKER_GET_ISEXPIRED_OFFSET UNITYSDK_OFFSET(0x961C50)
#define SYSTEM_THREADING_READERWRITERLOCKSLIM_TIMEOUTTRACKER_GET_REMAININGMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x961BE0)
#define SYSTEM_THREADING_READERWRITERLOCKSLIM_TIMEOUTTRACKER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x961B30)
#define SYSTEM_THREADING_READERWRITERLOCKSLIM_TIMEOUTTRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x961B20)
