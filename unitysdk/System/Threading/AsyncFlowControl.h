...
#define SYSTEM_THREADING_ASYNCFLOWCONTROL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7B32F0)
#define SYSTEM_THREADING_ASYNCFLOWCONTROL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7B3380)
#define SYSTEM_THREADING_ASYNCFLOWCONTROL_EQUALS_OFFSET UNITYSDK_OFFSET(0x7B3310)
#define SYSTEM_THREADING_ASYNCFLOWCONTROL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7B3300)
#define SYSTEM_THREADING_ASYNCFLOWCONTROL_SETUP_OFFSET UNITYSDK_OFFSET(0x7B3220)
#define SYSTEM_THREADING_ASYNCFLOWCONTROL_UNDO_OFFSET UNITYSDK_OFFSET(0x7B32F0)
