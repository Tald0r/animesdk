...
#define SYSTEM_THREADING_WAITHANDLE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1952C6A0)
#define SYSTEM_THREADING_WAITHANDLE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1952C730)
#define SYSTEM_THREADING_WAITHANDLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1952C6F0)
#define SYSTEM_THREADING_WAITHANDLE_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1952B580)
#define SYSTEM_THREADING_WAITHANDLE_GET_SAFEWAITHANDLE_OFFSET UNITYSDK_OFFSET(0x1952B680)
#define SYSTEM_THREADING_WAITHANDLE_INIT_OFFSET UNITYSDK_OFFSET(0x1952B560)
#define SYSTEM_THREADING_WAITHANDLE_INTERNALWAITONE_OFFSET UNITYSDK_OFFSET(0x1952B940)
#define SYSTEM_THREADING_WAITHANDLE_SETHANDLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1952B760)
#define SYSTEM_THREADING_WAITHANDLE_SET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1952B5C0)
#define SYSTEM_THREADING_WAITHANDLE_SET_SAFEWAITHANDLE_OFFSET UNITYSDK_OFFSET(0x1952B720)
#define SYSTEM_THREADING_WAITHANDLE_THROWABANDONEDMUTEXEXCEPTION_1_OFFSET UNITYSDK_OFFSET(0x1952C570)
#define SYSTEM_THREADING_WAITHANDLE_THROWABANDONEDMUTEXEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1952BB80)
#define SYSTEM_THREADING_WAITHANDLE_WAITANY_1_OFFSET UNITYSDK_OFFSET(0x1952C5D0)
#define SYSTEM_THREADING_WAITHANDLE_WAITANY_2_OFFSET UNITYSDK_OFFSET(0x1952C690)
#define SYSTEM_THREADING_WAITHANDLE_WAITANY_OFFSET UNITYSDK_OFFSET(0x1952BBD0)
#define SYSTEM_THREADING_WAITHANDLE_WAITMULTIPLE_OFFSET UNITYSDK_OFFSET(0x1952BF30)
#define SYSTEM_THREADING_WAITHANDLE_WAITONENATIVE_OFFSET UNITYSDK_OFFSET(0x1952BAA0)
#define SYSTEM_THREADING_WAITHANDLE_WAITONE_1_OFFSET UNITYSDK_OFFSET(0x1952B810)
#define SYSTEM_THREADING_WAITHANDLE_WAITONE_2_OFFSET UNITYSDK_OFFSET(0x1952B8E0)
#define SYSTEM_THREADING_WAITHANDLE_WAITONE_3_OFFSET UNITYSDK_OFFSET(0x1952B900)
#define SYSTEM_THREADING_WAITHANDLE_WAITONE_4_OFFSET UNITYSDK_OFFSET(0x1952B920)
#define SYSTEM_THREADING_WAITHANDLE_WAITONE_5_OFFSET UNITYSDK_OFFSET(0x1952B7F0)
#define SYSTEM_THREADING_WAITHANDLE_WAITONE_OFFSET UNITYSDK_OFFSET(0x1952B790)
#define SYSTEM_THREADING_WAITHANDLE_WAIT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1952C780)
#define SYSTEM_THREADING_WAITHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1952C790)
#define SYSTEM_THREADING_WAITHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1952B540)
