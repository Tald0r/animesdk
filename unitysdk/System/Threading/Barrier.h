...
#define SYSTEM_THREADING_BARRIER_ADDPARTICIPANTS_OFFSET UNITYSDK_OFFSET(0x187EA2F0)
#define SYSTEM_THREADING_BARRIER_ADDPARTICIPANT_OFFSET UNITYSDK_OFFSET(0x187EA210)
#define SYSTEM_THREADING_BARRIER_DISCONTINUOUSWAIT_OFFSET UNITYSDK_OFFSET(0x187EB4A0)
#define SYSTEM_THREADING_BARRIER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x187EB8D0)
#define SYSTEM_THREADING_BARRIER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x187EB780)
#define SYSTEM_THREADING_BARRIER_FINISHPHASE_OFFSET UNITYSDK_OFFSET(0x187EAA70)
#define SYSTEM_THREADING_BARRIER_GETCURRENTTOTAL_OFFSET UNITYSDK_OFFSET(0x187EA1B0)
#define SYSTEM_THREADING_BARRIER_GET_CURRENTPHASENUMBER_OFFSET UNITYSDK_OFFSET(0x187E9E80)
#define SYSTEM_THREADING_BARRIER_GET_PARTICIPANTCOUNT_OFFSET UNITYSDK_OFFSET(0x187E9E70)
#define SYSTEM_THREADING_BARRIER_GET_PARTICIPANTSREMAINING_OFFSET UNITYSDK_OFFSET(0x187E9E50)
#define SYSTEM_THREADING_BARRIER_INVOKEPOSTPHASEACTION_OFFSET UNITYSDK_OFFSET(0x187EB700)
#define SYSTEM_THREADING_BARRIER_REMOVEPARTICIPANTS_OFFSET UNITYSDK_OFFSET(0x187EA780)
#define SYSTEM_THREADING_BARRIER_REMOVEPARTICIPANT_OFFSET UNITYSDK_OFFSET(0x187EA770)
#define SYSTEM_THREADING_BARRIER_SETCURRENTTOTAL_OFFSET UNITYSDK_OFFSET(0x187EA1E0)
#define SYSTEM_THREADING_BARRIER_SETRESETEVENTS_OFFSET UNITYSDK_OFFSET(0x187EB690)
#define SYSTEM_THREADING_BARRIER_SET_CURRENTPHASENUMBER_OFFSET UNITYSDK_OFFSET(0x187E9E90)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_1_OFFSET UNITYSDK_OFFSET(0x187EAD50)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_2_OFFSET UNITYSDK_OFFSET(0x187EB390)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_3_OFFSET UNITYSDK_OFFSET(0x187EB3A0)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_4_OFFSET UNITYSDK_OFFSET(0x187EB490)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_5_OFFSET UNITYSDK_OFFSET(0x187EAD60)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_OFFSET UNITYSDK_OFFSET(0x187EAD40)
#define SYSTEM_THREADING_BARRIER_THROWIFDISPOSED_OFFSET UNITYSDK_OFFSET(0x187EA700)
#define SYSTEM_THREADING_BARRIER_WAITCURRENTPHASE_OFFSET UNITYSDK_OFFSET(0x187EB5F0)
#define SYSTEM_THREADING_BARRIER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x187E9EB0)
#define SYSTEM_THREADING_BARRIER__CTOR_OFFSET UNITYSDK_OFFSET(0x187E9EA0)
...
namespace System::Threading
{
	...
	public:
		...
		::System::Action_1<::System::Threading::Barrier*>* m_postPhaseAction; // 0x18
		::System::Threading::ExecutionContext* m_ownerThreadContext; // 0x20
		::System::Exception* m_exception; // 0x28
		::System::Threading::ManualResetEventSlim* m_oddEvent; // 0x30
		::System::Int32 m_currentTotalCount; // 0x38
		::System::Int32 m_actionCallerID; // 0x3C
