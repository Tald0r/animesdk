...
#define SYSTEM_THREADING_BARRIER_ADDPARTICIPANTS_OFFSET UNITYSDK_OFFSET(0x1824FEB0)
#define SYSTEM_THREADING_BARRIER_ADDPARTICIPANT_OFFSET UNITYSDK_OFFSET(0x1824FDD0)
#define SYSTEM_THREADING_BARRIER_DISCONTINUOUSWAIT_OFFSET UNITYSDK_OFFSET(0x18251060)
#define SYSTEM_THREADING_BARRIER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18251490)
#define SYSTEM_THREADING_BARRIER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18251340)
#define SYSTEM_THREADING_BARRIER_FINISHPHASE_OFFSET UNITYSDK_OFFSET(0x18250630)
#define SYSTEM_THREADING_BARRIER_GETCURRENTTOTAL_OFFSET UNITYSDK_OFFSET(0x1824FD70)
#define SYSTEM_THREADING_BARRIER_GET_CURRENTPHASENUMBER_OFFSET UNITYSDK_OFFSET(0x1824FA40)
#define SYSTEM_THREADING_BARRIER_GET_PARTICIPANTCOUNT_OFFSET UNITYSDK_OFFSET(0x1824FA30)
#define SYSTEM_THREADING_BARRIER_GET_PARTICIPANTSREMAINING_OFFSET UNITYSDK_OFFSET(0x1824FA10)
#define SYSTEM_THREADING_BARRIER_INVOKEPOSTPHASEACTION_OFFSET UNITYSDK_OFFSET(0x182512C0)
#define SYSTEM_THREADING_BARRIER_REMOVEPARTICIPANTS_OFFSET UNITYSDK_OFFSET(0x18250340)
#define SYSTEM_THREADING_BARRIER_REMOVEPARTICIPANT_OFFSET UNITYSDK_OFFSET(0x18250330)
#define SYSTEM_THREADING_BARRIER_SETCURRENTTOTAL_OFFSET UNITYSDK_OFFSET(0x1824FDA0)
#define SYSTEM_THREADING_BARRIER_SETRESETEVENTS_OFFSET UNITYSDK_OFFSET(0x18251250)
#define SYSTEM_THREADING_BARRIER_SET_CURRENTPHASENUMBER_OFFSET UNITYSDK_OFFSET(0x1824FA50)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_1_OFFSET UNITYSDK_OFFSET(0x18250910)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_2_OFFSET UNITYSDK_OFFSET(0x18250F50)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_3_OFFSET UNITYSDK_OFFSET(0x18250F60)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_4_OFFSET UNITYSDK_OFFSET(0x18251050)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_5_OFFSET UNITYSDK_OFFSET(0x18250920)
#define SYSTEM_THREADING_BARRIER_SIGNALANDWAIT_OFFSET UNITYSDK_OFFSET(0x18250900)
#define SYSTEM_THREADING_BARRIER_THROWIFDISPOSED_OFFSET UNITYSDK_OFFSET(0x182502C0)
#define SYSTEM_THREADING_BARRIER_WAITCURRENTPHASE_OFFSET UNITYSDK_OFFSET(0x182511B0)
#define SYSTEM_THREADING_BARRIER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1824FA70)
#define SYSTEM_THREADING_BARRIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1824FA60)
