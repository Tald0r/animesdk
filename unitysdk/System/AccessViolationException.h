...
#define SYSTEM_ACCESSVIOLATIONEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19ACE0C0)
#define SYSTEM_ACCESSVIOLATIONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACE020)
...
namespace System
{
	...
	public:
		...
		::System::IntPtr _target; // 0x90
		::System::IntPtr _ip; // 0x98
