...
#define SYSTEM_ACCESSVIOLATIONEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0BC670)
#define SYSTEM_ACCESSVIOLATIONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0BC5D0)
