...
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x19716750)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDCONVERT_OFFSET UNITYSDK_OFFSET(0x19715F70)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x197163D0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x19716F70)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x19715D50)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDGETINDEX_OFFSET UNITYSDK_OFFSET(0x19716BF0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDGETMEMBER_OFFSET UNITYSDK_OFFSET(0x19715800)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x197161C0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDINVOKE_OFFSET UNITYSDK_OFFSET(0x19716590)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDSETINDEX_OFFSET UNITYSDK_OFFSET(0x19716DB0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDSETMEMBER_OFFSET UNITYSDK_OFFSET(0x19715B90)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x197169A0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETCONVERTEDARGS_OFFSET UNITYSDK_OFFSET(0x19717110)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETLIMITEDSELF_OFFSET UNITYSDK_OFFSET(0x19717E10)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETRESTRICTIONS_OFFSET UNITYSDK_OFFSET(0x19717DB0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19717D40)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_ISOVERRIDDEN_OFFSET UNITYSDK_OFFSET(0x197159B0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_REFERENCEARGASSIGN_OFFSET UNITYSDK_OFFSET(0x19717460)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC__CCTOR_OFFSET UNITYSDK_OFFSET(0x19717F60)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC__CTOR_OFFSET UNITYSDK_OFFSET(0x19715760)
