...
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x19BC2950)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDCONVERT_OFFSET UNITYSDK_OFFSET(0x19BC2150)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19BC25B0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x19BC3190)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x19BC1F30)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDGETINDEX_OFFSET UNITYSDK_OFFSET(0x19BC2E00)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDGETMEMBER_OFFSET UNITYSDK_OFFSET(0x19BC19E0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x19BC23A0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDINVOKE_OFFSET UNITYSDK_OFFSET(0x19BC2780)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDSETINDEX_OFFSET UNITYSDK_OFFSET(0x19BC2FD0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDSETMEMBER_OFFSET UNITYSDK_OFFSET(0x19BC1D70)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_BINDUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x19BC2BB0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETCONVERTEDARGS_OFFSET UNITYSDK_OFFSET(0x19BC3330)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETLIMITEDSELF_OFFSET UNITYSDK_OFFSET(0x19BC4030)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETRESTRICTIONS_OFFSET UNITYSDK_OFFSET(0x19BC3FD0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19BC3F60)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_ISOVERRIDDEN_OFFSET UNITYSDK_OFFSET(0x19BC1B90)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_REFERENCEARGASSIGN_OFFSET UNITYSDK_OFFSET(0x19BC3680)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC__CCTOR_OFFSET UNITYSDK_OFFSET(0x19BC4180)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC1940)
