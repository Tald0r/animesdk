...
#define SYSTEM_DYNAMIC_SETMEMBERBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1A5FA140)
#define SYSTEM_DYNAMIC_SETMEMBERBINDER_FALLBACKSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1A5FA2E0)
