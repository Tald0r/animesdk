...
#define SYSTEM_DYNAMIC_SETMEMBERBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1ABC7760)
#define SYSTEM_DYNAMIC_SETMEMBERBINDER_FALLBACKSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1ABC7900)
