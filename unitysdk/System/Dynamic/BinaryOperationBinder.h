...
#define SYSTEM_DYNAMIC_BINARYOPERATIONBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1AFFFE10)
#define SYSTEM_DYNAMIC_BINARYOPERATIONBINDER_FALLBACKBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1AFFFDF0)
