...
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1B1A3AA0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDCONVERT_OFFSET UNITYSDK_OFFSET(0x1B1A32B0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B1A3930)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x1B1A36F0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1A34C0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDGETINDEX_OFFSET UNITYSDK_OFFSET(0x1B1A3570)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1A3360)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1A37B0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B1A3870)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDSETINDEX_OFFSET UNITYSDK_OFFSET(0x1B1A3630)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1A3400)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1B1A39F0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_CREATE_OFFSET UNITYSDK_OFFSET(0x1B1A3D70)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GETEXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x1B1A3B60)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1B1A3160)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GET_LIMITTYPE_OFFSET UNITYSDK_OFFSET(0x1B1A3200)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GET_RESTRICTIONS_OFFSET UNITYSDK_OFFSET(0x1B1A3170)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GET_RUNTIMETYPE_OFFSET UNITYSDK_OFFSET(0x1B1A3180)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1A3FE0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1A3070)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A2F90)
...
namespace System::Dynamic
{
	...
	public:
		...
		::System::Dynamic::BindingRestrictions* _Restrictions_k__BackingField; // 0x10
