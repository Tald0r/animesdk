...
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1AB83CF0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDCONVERT_OFFSET UNITYSDK_OFFSET(0x1AB83500)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AB83B80)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x1AB83940)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB83710)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDGETINDEX_OFFSET UNITYSDK_OFFSET(0x1AB837C0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB835B0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB83A00)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB83AC0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDSETINDEX_OFFSET UNITYSDK_OFFSET(0x1AB83880)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB83650)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_BINDUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1AB83C40)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_CREATE_OFFSET UNITYSDK_OFFSET(0x1AB83FC0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GETEXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x1AB83DB0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AB833B0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GET_LIMITTYPE_OFFSET UNITYSDK_OFFSET(0x1AB83450)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GET_RESTRICTIONS_OFFSET UNITYSDK_OFFSET(0x1AB833C0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT_GET_RUNTIMETYPE_OFFSET UNITYSDK_OFFSET(0x1AB833D0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB84230)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB832C0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB831E0)
