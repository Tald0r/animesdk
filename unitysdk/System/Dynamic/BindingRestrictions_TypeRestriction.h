...
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_TYPERESTRICTION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2C5C50)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_TYPERESTRICTION_GETEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A2C5D30)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_TYPERESTRICTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2C5CE0)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_TYPERESTRICTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2C5BE0)
