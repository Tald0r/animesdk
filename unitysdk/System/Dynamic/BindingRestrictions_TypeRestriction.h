...
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_TYPERESTRICTION_EQUALS_OFFSET UNITYSDK_OFFSET(0x19CD61C0)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_TYPERESTRICTION_GETEXPRESSION_OFFSET UNITYSDK_OFFSET(0x19CD62A0)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_TYPERESTRICTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19CD6250)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_TYPERESTRICTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD6150)
