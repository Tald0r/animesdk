...
#define SYSTEM_DYNAMIC_UTILS_LISTPARAMETERPROVIDER_GETELEMENT_OFFSET UNITYSDK_OFFSET(0x1A5FA410)
#define SYSTEM_DYNAMIC_UTILS_LISTPARAMETERPROVIDER_GET_ELEMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A5FA330)
#define SYSTEM_DYNAMIC_UTILS_LISTPARAMETERPROVIDER_GET_FIRST_OFFSET UNITYSDK_OFFSET(0x1A5FA320)
#define SYSTEM_DYNAMIC_UTILS_LISTPARAMETERPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5FA300)
