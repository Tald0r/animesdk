...
#define SYSTEM_DYNAMIC_UTILS_LISTPARAMETERPROVIDER_GETELEMENT_OFFSET UNITYSDK_OFFSET(0x1ABC7A30)
#define SYSTEM_DYNAMIC_UTILS_LISTPARAMETERPROVIDER_GET_ELEMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1ABC7950)
#define SYSTEM_DYNAMIC_UTILS_LISTPARAMETERPROVIDER_GET_FIRST_OFFSET UNITYSDK_OFFSET(0x1ABC7940)
#define SYSTEM_DYNAMIC_UTILS_LISTPARAMETERPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC7920)
