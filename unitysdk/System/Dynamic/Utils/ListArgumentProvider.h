...
#define SYSTEM_DYNAMIC_UTILS_LISTARGUMENTPROVIDER_GETELEMENT_OFFSET UNITYSDK_OFFSET(0x19CD6500)
#define SYSTEM_DYNAMIC_UTILS_LISTARGUMENTPROVIDER_GET_ELEMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x19CD6420)
#define SYSTEM_DYNAMIC_UTILS_LISTARGUMENTPROVIDER_GET_FIRST_OFFSET UNITYSDK_OFFSET(0x19CD6410)
#define SYSTEM_DYNAMIC_UTILS_LISTARGUMENTPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD63F0)
