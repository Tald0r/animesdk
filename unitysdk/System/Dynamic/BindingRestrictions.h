...
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_GETINSTANCERESTRICTION_OFFSET UNITYSDK_OFFSET(0x1B339310)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_GETTYPERESTRICTION_1_OFFSET UNITYSDK_OFFSET(0x1B339040)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_GETTYPERESTRICTION_OFFSET UNITYSDK_OFFSET(0x1B338F00)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_MERGE_OFFSET UNITYSDK_OFFSET(0x1B338D60)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_TOEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1B339410)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B339420)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B338D50)
