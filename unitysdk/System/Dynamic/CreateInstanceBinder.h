...
#define SYSTEM_DYNAMIC_CREATEINSTANCEBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1AA6EA50)
#define SYSTEM_DYNAMIC_CREATEINSTANCEBINDER_FALLBACKCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AA6EA30)
