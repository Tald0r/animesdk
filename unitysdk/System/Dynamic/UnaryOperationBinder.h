...
#define SYSTEM_DYNAMIC_UNARYOPERATIONBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1AB7ED70)
#define SYSTEM_DYNAMIC_UNARYOPERATIONBINDER_FALLBACKUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1AB7ED50)
