...
#define SYSTEM_DYNAMIC_UNARYOPERATIONBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1A5B5180)
#define SYSTEM_DYNAMIC_UNARYOPERATIONBINDER_FALLBACKUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1A5B5160)
