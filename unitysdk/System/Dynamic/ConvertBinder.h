...
#define SYSTEM_DYNAMIC_CONVERTBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1AEFA0C0)
#define SYSTEM_DYNAMIC_CONVERTBINDER_FALLBACKCONVERT_OFFSET UNITYSDK_OFFSET(0x1AEFA0A0)
