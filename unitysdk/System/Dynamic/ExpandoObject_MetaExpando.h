...
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_ADDDYNAMICTESTANDDEFER_OFFSET UNITYSDK_OFFSET(0x1AD46B70)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AD47A20)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1AD46E70)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDGETORINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AD45F60)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AD46F30)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1AD47090)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GETCLASSENSUREINDEX_OFFSET UNITYSDK_OFFSET(0x1AD47850)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GETLIMITEDSELF_OFFSET UNITYSDK_OFFSET(0x1AD46A50)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GETRESTRICTIONS_OFFSET UNITYSDK_OFFSET(0x1AD47F50)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AD469F0)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD45EC0)
