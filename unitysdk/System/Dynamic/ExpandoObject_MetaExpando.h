...
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_ADDDYNAMICTESTANDDEFER_OFFSET UNITYSDK_OFFSET(0x1B35E1A0)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B35F050)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1B35E4A0)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDGETORINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B35D590)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B35E560)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_BINDSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1B35E6C0)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GETCLASSENSUREINDEX_OFFSET UNITYSDK_OFFSET(0x1B35EE80)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GETLIMITEDSELF_OFFSET UNITYSDK_OFFSET(0x1B35E080)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GETRESTRICTIONS_OFFSET UNITYSDK_OFFSET(0x1B35F580)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B35E020)
#define SYSTEM_DYNAMIC_EXPANDOOBJECT_METAEXPANDO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B35D4F0)
