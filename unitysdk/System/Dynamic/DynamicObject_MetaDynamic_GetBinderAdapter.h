...
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETBINDERADAPTER_FALLBACKGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1F6420)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETBINDERADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F63F0)
