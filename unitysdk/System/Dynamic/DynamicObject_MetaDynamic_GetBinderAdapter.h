...
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETBINDERADAPTER_FALLBACKGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1ABE5560)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_METADYNAMIC_GETBINDERADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABE5530)
