...
#define SYSTEM_DYNAMIC_GETINDEXBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1B35F5E0)
#define SYSTEM_DYNAMIC_GETINDEXBINDER_FALLBACKGETINDEX_OFFSET UNITYSDK_OFFSET(0x1B35F6B0)
