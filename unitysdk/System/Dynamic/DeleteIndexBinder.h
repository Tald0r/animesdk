...
#define SYSTEM_DYNAMIC_DELETEINDEXBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1A5FA050)
#define SYSTEM_DYNAMIC_DELETEINDEXBINDER_FALLBACKDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x1A5FA120)
