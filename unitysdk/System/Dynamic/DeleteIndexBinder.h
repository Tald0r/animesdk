...
#define SYSTEM_DYNAMIC_DELETEINDEXBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1ABC7670)
#define SYSTEM_DYNAMIC_DELETEINDEXBINDER_FALLBACKDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x1ABC7740)
