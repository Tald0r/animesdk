...
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x19BC0CB0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_CREATEARGUMENTMETAOBJECTS_OFFSET UNITYSDK_OFFSET(0x19BC13F0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_GETUPDATEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x19BC17F0)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_GET_ISSTANDARDBINDER_OFFSET UNITYSDK_OFFSET(0x19BC1930)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x19BC0C80)
#define SYSTEM_DYNAMIC_DYNAMICMETAOBJECTBINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC0C30)
