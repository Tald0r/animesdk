...
#define SYSTEM_DYNAMIC_SETINDEXBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1AB7EA90)
#define SYSTEM_DYNAMIC_SETINDEXBINDER_FALLBACKSETINDEX_OFFSET UNITYSDK_OFFSET(0x1AB7ED30)
