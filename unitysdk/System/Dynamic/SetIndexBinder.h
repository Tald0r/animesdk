...
#define SYSTEM_DYNAMIC_SETINDEXBINDER_BIND_OFFSET UNITYSDK_OFFSET(0x1A5B4EA0)
#define SYSTEM_DYNAMIC_SETINDEXBINDER_FALLBACKSETINDEX_OFFSET UNITYSDK_OFFSET(0x1A5B5140)
