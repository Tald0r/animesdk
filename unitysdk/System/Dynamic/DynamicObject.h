...
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_GETMETAOBJECT_OFFSET UNITYSDK_OFFSET(0x1B36B7E0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1B36B790)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYCONVERT_OFFSET UNITYSDK_OFFSET(0x1B36B760)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B36B770)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x1B36B7D0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B36B740)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYGETINDEX_OFFSET UNITYSDK_OFFSET(0x1B36B7B0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1B36B720)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1B36B750)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYINVOKE_OFFSET UNITYSDK_OFFSET(0x1B36B780)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYSETINDEX_OFFSET UNITYSDK_OFFSET(0x1B36B7C0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1B36B730)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1B36B7A0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B36B710)
