...
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_GETMETAOBJECT_OFFSET UNITYSDK_OFFSET(0x1AD5C190)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYBINARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1AD5C140)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYCONVERT_OFFSET UNITYSDK_OFFSET(0x1AD5C110)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AD5C120)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYDELETEINDEX_OFFSET UNITYSDK_OFFSET(0x1AD5C180)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYDELETEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AD5C0F0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYGETINDEX_OFFSET UNITYSDK_OFFSET(0x1AD5C160)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYGETMEMBER_OFFSET UNITYSDK_OFFSET(0x1AD5C0D0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYINVOKEMEMBER_OFFSET UNITYSDK_OFFSET(0x1AD5C100)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYINVOKE_OFFSET UNITYSDK_OFFSET(0x1AD5C130)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYSETINDEX_OFFSET UNITYSDK_OFFSET(0x1AD5C170)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYSETMEMBER_OFFSET UNITYSDK_OFFSET(0x1AD5C0E0)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT_TRYUNARYOPERATION_OFFSET UNITYSDK_OFFSET(0x1AD5C150)
#define SYSTEM_DYNAMIC_DYNAMICOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD5C0C0)
