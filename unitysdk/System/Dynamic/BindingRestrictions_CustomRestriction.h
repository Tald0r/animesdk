...
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A5B4E00)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION_GETEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A5B4E90)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A5B4E60)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5B4DA0)
