...
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AB7E9F0)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION_GETEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AB7EA80)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AB7EA50)
#define SYSTEM_DYNAMIC_BINDINGRESTRICTIONS_CUSTOMRESTRICTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB7E990)
