...
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_READINT32LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1ADB1B90)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_READUINT16LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1ADB1CC0)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_READUINT32LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1ADB1DF0)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_READUINT64LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1ADB1F20)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_1_OFFSET UNITYSDK_OFFSET(0x1ADB1B40)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_2_OFFSET UNITYSDK_OFFSET(0x1ADB1B50)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_3_OFFSET UNITYSDK_OFFSET(0x1ADB1B60)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_4_OFFSET UNITYSDK_OFFSET(0x1ADB1B70)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_5_OFFSET UNITYSDK_OFFSET(0x1ADB1B80)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_OFFSET UNITYSDK_OFFSET(0x1ADB1B30)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_WRITEUINT16LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1ADB2050)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_WRITEUINT32LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1ADB2190)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_WRITEUINT64LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1ADB22C0)
