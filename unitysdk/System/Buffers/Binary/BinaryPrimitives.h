...
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_READINT32LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1A7DEA80)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_READUINT16LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1A7DEBB0)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_READUINT32LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1A7DECE0)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_READUINT64LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1A7DEE10)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_1_OFFSET UNITYSDK_OFFSET(0x1A7DEA30)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_2_OFFSET UNITYSDK_OFFSET(0x1A7DEA40)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_3_OFFSET UNITYSDK_OFFSET(0x1A7DEA50)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_4_OFFSET UNITYSDK_OFFSET(0x1A7DEA60)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_5_OFFSET UNITYSDK_OFFSET(0x1A7DEA70)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_REVERSEENDIANNESS_OFFSET UNITYSDK_OFFSET(0x1A7DEA20)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_WRITEUINT16LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1A7DEF40)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_WRITEUINT32LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1A7DF080)
#define SYSTEM_BUFFERS_BINARY_BINARYPRIMITIVES_WRITEUINT64LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x1A7DF1B0)

namespace System::Buffers::Binary
{
	inline static constexpr unsigned int BinaryPrimitives_TypeDefinitionIndex = 7575;
