...
#define SYSTEM_URI_ALLOWIDNSTATIC_OFFSET UNITYSDK_OFFSET(0x187EBE80)
#define SYSTEM_URI_CALCULATECASEINSENSITIVEHASHCODE_OFFSET UNITYSDK_OFFSET(0x187F3B10)
#define SYSTEM_URI_CANONICALIZE_OFFSET UNITYSDK_OFFSET(0x187FBA10)
#define SYSTEM_URI_CHECKAUTHORITYHELPERHANDLEANYHOSTIRI_OFFSET UNITYSDK_OFFSET(0x187FAD30)
#define SYSTEM_URI_CHECKAUTHORITYHELPERHANDLEDNSIRI_OFFSET UNITYSDK_OFFSET(0x187FA820)
#define SYSTEM_URI_CHECKAUTHORITYHELPER_OFFSET UNITYSDK_OFFSET(0x187F5CD0)
#define SYSTEM_URI_CHECKCANONICAL_OFFSET UNITYSDK_OFFSET(0x187F76F0)
#define SYSTEM_URI_CHECKFORCOLONINFIRSTPATHSEGMENT_OFFSET UNITYSDK_OFFSET(0x187F4E10)
#define SYSTEM_URI_CHECKFORCONFIGLOAD_OFFSET UNITYSDK_OFFSET(0x187FC6B0)
#define SYSTEM_URI_CHECKFORESCAPEDUNRESERVED_OFFSET UNITYSDK_OFFSET(0x187FC890)
#define SYSTEM_URI_CHECKFORUNICODE_OFFSET UNITYSDK_OFFSET(0x187FC770)
#define SYSTEM_URI_CHECKHOSTNAME_OFFSET UNITYSDK_OFFSET(0x187F2C60)
#define SYSTEM_URI_CHECKKNOWNSCHEMES_OFFSET UNITYSDK_OFFSET(0x187FA4B0)
#define SYSTEM_URI_CHECKSCHEMENAME_OFFSET UNITYSDK_OFFSET(0x187F3600)
#define SYSTEM_URI_CHECKSCHEMESYNTAX_OFFSET UNITYSDK_OFFSET(0x187EF1D0)
#define SYSTEM_URI_CHECKSECURITY_OFFSET UNITYSDK_OFFSET(0x187FBBA0)
#define SYSTEM_URI_COMBINEURI_OFFSET UNITYSDK_OFFSET(0x187EF370)
#define SYSTEM_URI_COMPARE_OFFSET UNITYSDK_OFFSET(0x187FD240)
#define SYSTEM_URI_COMPRESS_OFFSET UNITYSDK_OFFSET(0x187F1D90)
#define SYSTEM_URI_CREATEHELPER_OFFSET UNITYSDK_OFFSET(0x187FCAE0)
#define SYSTEM_URI_CREATEHOSTSTRINGHELPER_OFFSET UNITYSDK_OFFSET(0x187F7590)
#define SYSTEM_URI_CREATEHOSTSTRING_OFFSET UNITYSDK_OFFSET(0x187ED840)
#define SYSTEM_URI_CREATETHISFROMURI_OFFSET UNITYSDK_OFFSET(0x187EEA50)
#define SYSTEM_URI_CREATETHIS_OFFSET UNITYSDK_OFFSET(0x187EDD40)
#define SYSTEM_URI_CREATEURIINFO_OFFSET UNITYSDK_OFFSET(0x187EC040)
#define SYSTEM_URI_CREATEURI_OFFSET UNITYSDK_OFFSET(0x187EE050)
#define SYSTEM_URI_ENSUREHOSTSTRING_OFFSET UNITYSDK_OFFSET(0x187ED7E0)
#define SYSTEM_URI_ENSUREPARSEREMAINING_OFFSET UNITYSDK_OFFSET(0x187EC720)
#define SYSTEM_URI_ENSUREURIINFO_OFFSET UNITYSDK_OFFSET(0x187EC010)
#define SYSTEM_URI_EQUALS_OFFSET UNITYSDK_OFFSET(0x187F3E50)
#define SYSTEM_URI_ESCAPEDATASTRING_OFFSET UNITYSDK_OFFSET(0x187FDCA0)
#define SYSTEM_URI_ESCAPESTRING_OFFSET UNITYSDK_OFFSET(0x187FBB00)
#define SYSTEM_URI_ESCAPEUNESCAPEIRI_OFFSET UNITYSDK_OFFSET(0x187FA490)
#define SYSTEM_URI_ESCAPEURISTRING_OFFSET UNITYSDK_OFFSET(0x187FDBD0)
#define SYSTEM_URI_ESCAPE_OFFSET UNITYSDK_OFFSET(0x187FBA20)
#define SYSTEM_URI_FINDENDOFCOMPONENT_1_OFFSET UNITYSDK_OFFSET(0x187FB380)
#define SYSTEM_URI_FINDENDOFCOMPONENT_OFFSET UNITYSDK_OFFSET(0x187FA400)
#define SYSTEM_URI_FROMHEX_OFFSET UNITYSDK_OFFSET(0x187F3830)
#define SYSTEM_URI_GETCANONICALPATH_OFFSET UNITYSDK_OFFSET(0x187F9A80)
#define SYSTEM_URI_GETCOMBINEDSTRING_OFFSET UNITYSDK_OFFSET(0x187EEF00)
#define SYSTEM_URI_GETCOMPONENTSHELPER_OFFSET UNITYSDK_OFFSET(0x187F3C40)
#define SYSTEM_URI_GETCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x187F7C30)
#define SYSTEM_URI_GETESCAPEDPARTS_OFFSET UNITYSDK_OFFSET(0x187F7D70)
#define SYSTEM_URI_GETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x187F0140)
#define SYSTEM_URI_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x187F38D0)
#define SYSTEM_URI_GETHOSTVIACUSTOMSYNTAX_OFFSET UNITYSDK_OFFSET(0x187F70E0)
#define SYSTEM_URI_GETLEFTPART_OFFSET UNITYSDK_OFFSET(0x187F2E20)
#define SYSTEM_URI_GETLOCALPATH_OFFSET UNITYSDK_OFFSET(0x187F08C0)
#define SYSTEM_URI_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x187F0370)
#define SYSTEM_URI_GETPARTS_OFFSET UNITYSDK_OFFSET(0x187F0550)
#define SYSTEM_URI_GETRELATIVESERIALIZATIONSTRING_OFFSET UNITYSDK_OFFSET(0x187FD010)
#define SYSTEM_URI_GETUNESCAPEDPARTS_OFFSET UNITYSDK_OFFSET(0x187F2280)
#define SYSTEM_URI_GETURIPARTSFROMUSERSTRING_OFFSET UNITYSDK_OFFSET(0x187F7EA0)
#define SYSTEM_URI_GET_ABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x187F0560)
#define SYSTEM_URI_GET_ABSOLUTEURI_OFFSET UNITYSDK_OFFSET(0x187F0720)
#define SYSTEM_URI_GET_ALLOWIDN_OFFSET UNITYSDK_OFFSET(0x187EBDE0)
#define SYSTEM_URI_GET_AUTHORITY_OFFSET UNITYSDK_OFFSET(0x187F1380)
#define SYSTEM_URI_GET_DNSSAFEHOST_OFFSET UNITYSDK_OFFSET(0x187F2810)
#define SYSTEM_URI_GET_FRAGMENT_OFFSET UNITYSDK_OFFSET(0x187F2590)
#define SYSTEM_URI_GET_HASAUTHORITY_OFFSET UNITYSDK_OFFSET(0x187FB730)
#define SYSTEM_URI_GET_HOSTNAMETYPE_OFFSET UNITYSDK_OFFSET(0x187F1410)
#define SYSTEM_URI_GET_HOSTTYPE_OFFSET UNITYSDK_OFFSET(0x187EBD50)
#define SYSTEM_URI_GET_HOST_OFFSET UNITYSDK_OFFSET(0x187F1A20)
#define SYSTEM_URI_GET_IDNHOST_OFFSET UNITYSDK_OFFSET(0x187F2B40)
#define SYSTEM_URI_GET_INITIALIZELOCK_OFFSET UNITYSDK_OFFSET(0x187F1AD0)
#define SYSTEM_URI_GET_ISABSOLUTEURI_OFFSET UNITYSDK_OFFSET(0x187EE040)
#define SYSTEM_URI_GET_ISDEFAULTPORT_OFFSET UNITYSDK_OFFSET(0x187F1510)
#define SYSTEM_URI_GET_ISDOSPATH_OFFSET UNITYSDK_OFFSET(0x187EBD30)
#define SYSTEM_URI_GET_ISFILE_OFFSET UNITYSDK_OFFSET(0x187F15D0)
#define SYSTEM_URI_GET_ISIMPLICITFILE_OFFSET UNITYSDK_OFFSET(0x187EBD10)
#define SYSTEM_URI_GET_ISLOOPBACK_OFFSET UNITYSDK_OFFSET(0x187F1650)
#define SYSTEM_URI_GET_ISNOTABSOLUTEURI_OFFSET UNITYSDK_OFFSET(0x187EBD70)
#define SYSTEM_URI_GET_ISUNCORDOSPATH_OFFSET UNITYSDK_OFFSET(0x187EBD20)
#define SYSTEM_URI_GET_ISUNCPATH_OFFSET UNITYSDK_OFFSET(0x187EBD40)
#define SYSTEM_URI_GET_ISUNC_OFFSET UNITYSDK_OFFSET(0x187F19A0)
#define SYSTEM_URI_GET_LOCALPATH_OFFSET UNITYSDK_OFFSET(0x187F0850)
#define SYSTEM_URI_GET_ORIGINALSTRINGSWITCHED_OFFSET UNITYSDK_OFFSET(0x187F2740)
#define SYSTEM_URI_GET_ORIGINALSTRING_OFFSET UNITYSDK_OFFSET(0x187EF2A0)
#define SYSTEM_URI_GET_PATHANDQUERY_OFFSET UNITYSDK_OFFSET(0x187F16E0)
#define SYSTEM_URI_GET_PORT_OFFSET UNITYSDK_OFFSET(0x187F23A0)
#define SYSTEM_URI_GET_PRIVATEABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0x187F0630)
#define SYSTEM_URI_GET_QUERY_OFFSET UNITYSDK_OFFSET(0x187F2460)
#define SYSTEM_URI_GET_SCHEME_OFFSET UNITYSDK_OFFSET(0x187F26F0)
#define SYSTEM_URI_GET_SECUREDPATHINDEX_OFFSET UNITYSDK_OFFSET(0x187EBF70)
#define SYSTEM_URI_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x187F17D0)
#define SYSTEM_URI_GET_SYNTAX_OFFSET UNITYSDK_OFFSET(0x187EBD60)
#define SYSTEM_URI_GET_USERDRIVENPARSING_OFFSET UNITYSDK_OFFSET(0x187EBF40)
#define SYSTEM_URI_GET_USERESCAPED_OFFSET UNITYSDK_OFFSET(0x187F2BA0)
#define SYSTEM_URI_GET_USERINFO_OFFSET UNITYSDK_OFFSET(0x187F2BB0)
#define SYSTEM_URI_HEXESCAPE_OFFSET UNITYSDK_OFFSET(0x187F30E0)
#define SYSTEM_URI_HEXUNESCAPE_OFFSET UNITYSDK_OFFSET(0x187F3240)
#define SYSTEM_URI_INFACT_OFFSET UNITYSDK_OFFSET(0x187EBFF0)
#define SYSTEM_URI_INITIALIZEURICONFIG_OFFSET UNITYSDK_OFFSET(0x187F1B80)
#define SYSTEM_URI_INITIALIZEURI_OFFSET UNITYSDK_OFFSET(0x187FBE40)
#define SYSTEM_URI_INTERNALESCAPESTRING_OFFSET UNITYSDK_OFFSET(0x187F4EF0)
#define SYSTEM_URI_INTERNALISWELLFORMEDORIGINALSTRING_OFFSET UNITYSDK_OFFSET(0x187FD360)
#define SYSTEM_URI_IRIPARSINGSTATIC_OFFSET UNITYSDK_OFFSET(0x187EBD80)
#define SYSTEM_URI_ISASCIILETTERORDIGIT_OFFSET UNITYSDK_OFFSET(0x187F37D0)
#define SYSTEM_URI_ISASCIILETTER_OFFSET UNITYSDK_OFFSET(0x187F37C0)
#define SYSTEM_URI_ISBADFILESYSTEMCHARACTER_OFFSET UNITYSDK_OFFSET(0x187FBCA0)
#define SYSTEM_URI_ISBASEOFHELPER_OFFSET UNITYSDK_OFFSET(0x187FDE60)
#define SYSTEM_URI_ISBASEOF_OFFSET UNITYSDK_OFFSET(0x187FDDB0)
#define SYSTEM_URI_ISBIDICONTROLCHARACTER_OFFSET UNITYSDK_OFFSET(0x187FB740)
#define SYSTEM_URI_ISEXCLUDEDCHARACTER_OFFSET UNITYSDK_OFFSET(0x187FBC40)
#define SYSTEM_URI_ISGENDELIM_OFFSET UNITYSDK_OFFSET(0x187F35E0)
#define SYSTEM_URI_ISHEXDIGIT_OFFSET UNITYSDK_OFFSET(0x187F3810)
#define SYSTEM_URI_ISHEXENCODING_OFFSET UNITYSDK_OFFSET(0x187F3450)
#define SYSTEM_URI_ISINTRANET_OFFSET UNITYSDK_OFFSET(0x187EBF30)
#define SYSTEM_URI_ISLWS_OFFSET UNITYSDK_OFFSET(0x187F5CB0)
#define SYSTEM_URI_ISRESERVEDCHARACTER_OFFSET UNITYSDK_OFFSET(0x187FBC20)
#define SYSTEM_URI_ISWELLFORMEDORIGINALSTRING_OFFSET UNITYSDK_OFFSET(0x187FD330)
#define SYSTEM_URI_ISWELLFORMEDURISTRING_OFFSET UNITYSDK_OFFSET(0x187FD990)
#define SYSTEM_URI_MAKERELATIVEURI_OFFSET UNITYSDK_OFFSET(0x187F4500)
#define SYSTEM_URI_MAKERELATIVE_OFFSET UNITYSDK_OFFSET(0x187FB770)
#define SYSTEM_URI_NOTANY_OFFSET UNITYSDK_OFFSET(0x187EBE70)
#define SYSTEM_URI_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x187E1E50)
#define SYSTEM_URI_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x187EEA10)
#define SYSTEM_URI_PARSEMINIMAL_OFFSET UNITYSDK_OFFSET(0x187F5540)
#define SYSTEM_URI_PARSEREMAINING_OFFSET UNITYSDK_OFFSET(0x187EC730)
#define SYSTEM_URI_PARSESCHEMECHECKIMPLICITFILE_OFFSET UNITYSDK_OFFSET(0x187F5020)
#define SYSTEM_URI_PARSESCHEME_OFFSET UNITYSDK_OFFSET(0x187F4F90)
#define SYSTEM_URI_PARSE_OFFSET UNITYSDK_OFFSET(0x187FBA00)
#define SYSTEM_URI_PATHDIFFERENCE_OFFSET UNITYSDK_OFFSET(0x187F49C0)
#define SYSTEM_URI_PRIVATEPARSEMINIMALIRI_OFFSET UNITYSDK_OFFSET(0x187F6EE0)
#define SYSTEM_URI_PRIVATEPARSEMINIMAL_OFFSET UNITYSDK_OFFSET(0x187F5590)
#define SYSTEM_URI_RECREATEPARTS_OFFSET UNITYSDK_OFFSET(0x187F8800)
#define SYSTEM_URI_RESOLVEHELPER_OFFSET UNITYSDK_OFFSET(0x187EE320)
#define SYSTEM_URI_SETUSERDRIVENPARSING_OFFSET UNITYSDK_OFFSET(0x187EBF50)
#define SYSTEM_URI_STATICINFACT_OFFSET UNITYSDK_OFFSET(0x187EC000)
#define SYSTEM_URI_STATICISFILE_OFFSET UNITYSDK_OFFSET(0x187F1AB0)
#define SYSTEM_URI_STATICNOTANY_OFFSET UNITYSDK_OFFSET(0x187EBF20)
#define SYSTEM_URI_STRIPBIDICONTROLCHARACTER_OFFSET UNITYSDK_OFFSET(0x187FB220)
#define SYSTEM_URI_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x187F0360)
#define SYSTEM_URI_TOSTRING_OFFSET UNITYSDK_OFFSET(0x187F3B80)
#define SYSTEM_URI_TRYCREATE_1_OFFSET UNITYSDK_OFFSET(0x187FCDA0)
#define SYSTEM_URI_TRYCREATE_2_OFFSET UNITYSDK_OFFSET(0x187FCE90)
#define SYSTEM_URI_TRYCREATE_OFFSET UNITYSDK_OFFSET(0x187F4470)
#define SYSTEM_URI_UNESCAPEDATASTRING_OFFSET UNITYSDK_OFFSET(0x187FDA60)
#define SYSTEM_URI_UNESCAPEONLY_OFFSET UNITYSDK_OFFSET(0x187FB410)
#define SYSTEM_URI_UNESCAPE_OFFSET UNITYSDK_OFFSET(0x187FBA30)
#define SYSTEM_URI__CCTOR_OFFSET UNITYSDK_OFFSET(0x187FE150)
#define SYSTEM_URI__CTOR_1_OFFSET UNITYSDK_OFFSET(0x187EDF00)
#define SYSTEM_URI__CTOR_2_OFFSET UNITYSDK_OFFSET(0x187EDF80)
#define SYSTEM_URI__CTOR_3_OFFSET UNITYSDK_OFFSET(0x187EE1F0)
#define SYSTEM_URI__CTOR_4_OFFSET UNITYSDK_OFFSET(0x187EE270)
#define SYSTEM_URI__CTOR_5_OFFSET UNITYSDK_OFFSET(0x187EECE0)
#define SYSTEM_URI__CTOR_6_OFFSET UNITYSDK_OFFSET(0x187F0290)
#define SYSTEM_URI__CTOR_7_OFFSET UNITYSDK_OFFSET(0x187FDDA0)
#define SYSTEM_URI__CTOR_OFFSET UNITYSDK_OFFSET(0x187EDCF0)
...
namespace System
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(Uri_TypeDefinitionIndex)->GetStaticField(0x2CC0);
		}
		...
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(Uri_TypeDefinitionIndex)->GetStaticField(0x2CD8);
		}
		static ::Il2CppArray<::System::Char>** StaticGet_HexLowerChars()
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(Uri_TypeDefinitionIndex)->GetStaticField(0x2CE0);
		}
