...
#define SYSTEM_SRDESCRIPTIONATTRIBUTE_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x191D3DA0)
#define SYSTEM_SRDESCRIPTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x191D3D40)
