...
#define SYSTEM_SRDESCRIPTIONATTRIBUTE_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x18D8B0E0)
#define SYSTEM_SRDESCRIPTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18D8B080)
