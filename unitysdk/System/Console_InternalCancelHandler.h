...
#define SYSTEM_CONSOLE_INTERNALCANCELHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x188A7A90)
#define SYSTEM_CONSOLE_INTERNALCANCELHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x188A7AC0)
#define SYSTEM_CONSOLE_INTERNALCANCELHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x188A77F0)
#define SYSTEM_CONSOLE_INTERNALCANCELHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x188A77E0)
