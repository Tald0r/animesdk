...
#define SYSTEM_HASHCODE_ADD_OFFSET UNITYSDK_OFFSET(0x757920)
#define SYSTEM_HASHCODE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8C5D50)
#define SYSTEM_HASHCODE_GENERATEGLOBALSEED_OFFSET UNITYSDK_OFFSET(0x19A15370)
#define SYSTEM_HASHCODE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8C5D00)
#define SYSTEM_HASHCODE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19A154C0)
#define SYSTEM_HASHCODE_MIXEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0x19A155B0)
#define SYSTEM_HASHCODE_MIXFINAL_OFFSET UNITYSDK_OFFSET(0x19A15610)
#define SYSTEM_HASHCODE_MIXSTATE_OFFSET UNITYSDK_OFFSET(0x19A15590)
#define SYSTEM_HASHCODE_QUEUEROUND_OFFSET UNITYSDK_OFFSET(0x19A15570)
#define SYSTEM_HASHCODE_ROUND_OFFSET UNITYSDK_OFFSET(0x19A15550)
#define SYSTEM_HASHCODE_TOHASHCODE_OFFSET UNITYSDK_OFFSET(0x8C5CF0)
#define SYSTEM_HASHCODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A15AA0)

namespace System
{
	inline static constexpr unsigned int HashCode_TypeDefinitionIndex = 25460;

	struct alignas(4) HashCode
	{
		static ::System::UInt32* StaticGet_s_seed()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(HashCode_TypeDefinitionIndex)->GetStaticField(0x4A20);
		}
