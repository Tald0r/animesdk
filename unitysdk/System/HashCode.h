...
#define SYSTEM_HASHCODE_ADD_OFFSET UNITYSDK_OFFSET(0x792810)
#define SYSTEM_HASHCODE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8F8EF0)
#define SYSTEM_HASHCODE_GENERATEGLOBALSEED_OFFSET UNITYSDK_OFFSET(0x1A005350)
#define SYSTEM_HASHCODE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8F8EA0)
#define SYSTEM_HASHCODE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A0054A0)
#define SYSTEM_HASHCODE_MIXEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0x1A005590)
#define SYSTEM_HASHCODE_MIXFINAL_OFFSET UNITYSDK_OFFSET(0x1A0055F0)
#define SYSTEM_HASHCODE_MIXSTATE_OFFSET UNITYSDK_OFFSET(0x1A005570)
#define SYSTEM_HASHCODE_QUEUEROUND_OFFSET UNITYSDK_OFFSET(0x1A005550)
#define SYSTEM_HASHCODE_ROUND_OFFSET UNITYSDK_OFFSET(0x1A005530)
#define SYSTEM_HASHCODE_TOHASHCODE_OFFSET UNITYSDK_OFFSET(0x8F8E90)
#define SYSTEM_HASHCODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A005A80)

namespace System
{
	inline static constexpr unsigned int HashCode_TypeDefinitionIndex = 26482;

	struct alignas(4) HashCode
	{
		static ::System::UInt32* StaticGet_s_seed()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(HashCode_TypeDefinitionIndex)->GetStaticField(0x49F0);
		}
