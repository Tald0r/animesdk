...
#define SYSTEM_VERSION_APPENDPOSITIVENUMBER_OFFSET UNITYSDK_OFFSET(0x18F196E0)
#define SYSTEM_VERSION_CLONE_OFFSET UNITYSDK_OFFSET(0x18F18BC0)
#define SYSTEM_VERSION_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x18F18D60)
#define SYSTEM_VERSION_COMPARETO_OFFSET UNITYSDK_OFFSET(0x18F18BF0)
#define SYSTEM_VERSION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x18F18E80)
#define SYSTEM_VERSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x18F18DF0)
#define SYSTEM_VERSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18F18F00)
#define SYSTEM_VERSION_GET_BUILD_OFFSET UNITYSDK_OFFSET(0x18F18BA0)
#define SYSTEM_VERSION_GET_MAJOR_OFFSET UNITYSDK_OFFSET(0x18F18B80)
#define SYSTEM_VERSION_GET_MINOR_OFFSET UNITYSDK_OFFSET(0x18F18B90)
#define SYSTEM_VERSION_GET_REVISION_OFFSET UNITYSDK_OFFSET(0x18F18BB0)
#define SYSTEM_VERSION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18F18CE0)
#define SYSTEM_VERSION_OP_GREATERTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x18F1A010)
#define SYSTEM_VERSION_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x18F19FD0)
#define SYSTEM_VERSION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18F19D80)
#define SYSTEM_VERSION_OP_LESSTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x18F19F10)
#define SYSTEM_VERSION_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x18F19E20)
#define SYSTEM_VERSION_PARSE_OFFSET UNITYSDK_OFFSET(0x18F18AC0)
#define SYSTEM_VERSION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x18F18F60)
#define SYSTEM_VERSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18F18F30)
#define SYSTEM_VERSION_TRYPARSECOMPONENT_OFFSET UNITYSDK_OFFSET(0x18F19C70)
#define SYSTEM_VERSION_TRYPARSEVERSION_OFFSET UNITYSDK_OFFSET(0x18F19760)
#define SYSTEM_VERSION__CCTOR_OFFSET UNITYSDK_OFFSET(0x18F1A050)
#define SYSTEM_VERSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F188E0)
#define SYSTEM_VERSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18F189C0)
#define SYSTEM_VERSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18F18A60)
#define SYSTEM_VERSION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18F18B70)
#define SYSTEM_VERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18F187C0)
