...
#define SYSTEM_VERSION_APPENDPOSITIVENUMBER_OFFSET UNITYSDK_OFFSET(0x19313410)
#define SYSTEM_VERSION_CLONE_OFFSET UNITYSDK_OFFSET(0x193128F0)
#define SYSTEM_VERSION_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x19312A90)
#define SYSTEM_VERSION_COMPARETO_OFFSET UNITYSDK_OFFSET(0x19312920)
#define SYSTEM_VERSION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19312BB0)
#define SYSTEM_VERSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x19312B20)
#define SYSTEM_VERSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19312C30)
#define SYSTEM_VERSION_GET_BUILD_OFFSET UNITYSDK_OFFSET(0x193128D0)
#define SYSTEM_VERSION_GET_MAJOR_OFFSET UNITYSDK_OFFSET(0x193128B0)
#define SYSTEM_VERSION_GET_MINOR_OFFSET UNITYSDK_OFFSET(0x193128C0)
#define SYSTEM_VERSION_GET_REVISION_OFFSET UNITYSDK_OFFSET(0x193128E0)
#define SYSTEM_VERSION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19312A10)
#define SYSTEM_VERSION_OP_GREATERTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x19313D40)
#define SYSTEM_VERSION_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x19313D00)
#define SYSTEM_VERSION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19313AB0)
#define SYSTEM_VERSION_OP_LESSTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x19313C40)
#define SYSTEM_VERSION_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x19313B50)
#define SYSTEM_VERSION_PARSE_OFFSET UNITYSDK_OFFSET(0x193127F0)
#define SYSTEM_VERSION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x19312C90)
#define SYSTEM_VERSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19312C60)
#define SYSTEM_VERSION_TRYPARSECOMPONENT_OFFSET UNITYSDK_OFFSET(0x193139A0)
#define SYSTEM_VERSION_TRYPARSEVERSION_OFFSET UNITYSDK_OFFSET(0x19313490)
#define SYSTEM_VERSION__CCTOR_OFFSET UNITYSDK_OFFSET(0x19313D80)
#define SYSTEM_VERSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19312610)
#define SYSTEM_VERSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x193126F0)
#define SYSTEM_VERSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19312790)
#define SYSTEM_VERSION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x193128A0)
#define SYSTEM_VERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x193124F0)
