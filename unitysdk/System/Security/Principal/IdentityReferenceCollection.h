...
#define SYSTEM_SECURITY_PRINCIPAL_IDENTITYREFERENCECOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x198600E0)
#define SYSTEM_SECURITY_PRINCIPAL_IDENTITYREFERENCECOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x19860110)
#define SYSTEM_SECURITY_PRINCIPAL_IDENTITYREFERENCECOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x19860140)
#define SYSTEM_SECURITY_PRINCIPAL_IDENTITYREFERENCECOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x198604B0)
#define SYSTEM_SECURITY_PRINCIPAL_IDENTITYREFERENCECOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19860500)
#define SYSTEM_SECURITY_PRINCIPAL_IDENTITYREFERENCECOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x198600A0)
#define SYSTEM_SECURITY_PRINCIPAL_IDENTITYREFERENCECOLLECTION_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x198600D0)
#define SYSTEM_SECURITY_PRINCIPAL_IDENTITYREFERENCECOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x198605A0)
#define SYSTEM_SECURITY_PRINCIPAL_IDENTITYREFERENCECOLLECTION_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19860550)
#define SYSTEM_SECURITY_PRINCIPAL_IDENTITYREFERENCECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19860050)
