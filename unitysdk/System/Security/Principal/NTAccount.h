...
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT_EQUALS_OFFSET UNITYSDK_OFFSET(0x197C12C0)
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x197C1380)
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x197C12B0)
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x197C1340)
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x197C1410)
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT_TRANSLATE_OFFSET UNITYSDK_OFFSET(0x197C1420)
#define SYSTEM_SECURITY_PRINCIPAL_NTACCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x197C1200)
