...
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1899A780)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_CREATEFROMBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1899A2B0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1899AAA0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1899A990)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1899AB40)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1899AC10)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETSIDAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1899A5A0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETSIDSUBAUTHORITYCOUNT_OFFSET UNITYSDK_OFFSET(0x1899A740)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GETSIDSUBAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1899A690)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x1899A3A0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1899A3C0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1899A920)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1899AE80)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_PARSESDDLFORM_OFFSET UNITYSDK_OFFSET(0x18999B90)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1899ACA0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_TRANSLATE_OFFSET UNITYSDK_OFFSET(0x1899ACB0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_TRYPARSEAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1899AEF0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER_TRYPARSESUBAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1899AFB0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1899B070)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1899A1D0)
#define SYSTEM_SECURITY_PRINCIPAL_SECURITYIDENTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x18999B00)
