...
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_CHECKPERMISSIONSTATE_OFFSET UNITYSDK_OFFSET(0x19309300)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_CHECKSECURITYELEMENT_OFFSET UNITYSDK_OFFSET(0x19309390)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_DEMAND_OFFSET UNITYSDK_OFFSET(0x19309040)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_ELEMENT_OFFSET UNITYSDK_OFFSET(0x193091D0)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x19309050)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19309130)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x19309660)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_THROWINVALIDPERMISSION_OFFSET UNITYSDK_OFFSET(0x193097E0)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19309140)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x19309170)
#define SYSTEM_SECURITY_CODEACCESSPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19309030)
