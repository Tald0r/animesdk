...
#define SYSTEM_SECURITY_SECURESTRINGMARSHAL_SECURESTRINGTOCOTASKMEMANSI_OFFSET UNITYSDK_OFFSET(0x19336840)
#define SYSTEM_SECURITY_SECURESTRINGMARSHAL_SECURESTRINGTOCOTASKMEMUNICODE_OFFSET UNITYSDK_OFFSET(0x193368C0)
#define SYSTEM_SECURITY_SECURESTRINGMARSHAL_SECURESTRINGTOGLOBALALLOCANSI_OFFSET UNITYSDK_OFFSET(0x19336850)
#define SYSTEM_SECURITY_SECURESTRINGMARSHAL_SECURESTRINGTOGLOBALALLOCUNICODE_OFFSET UNITYSDK_OFFSET(0x193368D0)
