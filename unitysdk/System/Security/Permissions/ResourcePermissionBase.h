...
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_ADDPERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x191E5F70)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x191E5FB0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_COPY_OFFSET UNITYSDK_OFFSET(0x191E5FF0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_FROMXML_OFFSET UNITYSDK_OFFSET(0x191E6030)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_GETPERMISSIONENTRIES_OFFSET UNITYSDK_OFFSET(0x191E6070)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_GET_PERMISSIONACCESSTYPE_OFFSET UNITYSDK_OFFSET(0x191E5E70)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_GET_TAGNAMES_OFFSET UNITYSDK_OFFSET(0x191E5EF0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_INTERSECT_OFFSET UNITYSDK_OFFSET(0x191E60B0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x191E60F0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x191E6130)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_REMOVEPERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x191E6170)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_SET_PERMISSIONACCESSTYPE_OFFSET UNITYSDK_OFFSET(0x191E5EB0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_SET_TAGNAMES_OFFSET UNITYSDK_OFFSET(0x191E5F30)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE_TOXML_OFFSET UNITYSDK_OFFSET(0x191E61B0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191E5E30)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x191E5DF0)
