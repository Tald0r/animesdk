...
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x19B34910)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x19B34810)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_GET_RESTRICTEDREGISTRATIONACCESS_OFFSET UNITYSDK_OFFSET(0x19B34890)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x19B34850)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE_SET_RESTRICTEDREGISTRATIONACCESS_OFFSET UNITYSDK_OFFSET(0x19B348D0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B34800)
