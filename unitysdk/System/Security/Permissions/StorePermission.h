...
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x19D7FCE0)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x19D7FD20)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSION_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x19D7FC60)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x19D7FD60)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x19D7FDA0)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x19D7FDE0)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSION_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x19D7FCA0)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x19D7FE20)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D7FC20)
#define SYSTEM_SECURITY_PERMISSIONS_STOREPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19D7FBE0)
