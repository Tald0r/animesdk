...
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_CAST_OFFSET UNITYSDK_OFFSET(0x195B60E0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x195B5D80)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x195B5DD0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x195B5F10)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x195B6160)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x195B6150)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x195B5CE0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x195B6200)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x195B6370)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195B5CD0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x195B5CA0)
