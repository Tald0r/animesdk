...
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_CAST_OFFSET UNITYSDK_OFFSET(0x1919BF70)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x1919BC10)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x1919BC60)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1919BDA0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1919BFF0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1919BFE0)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1919BB70)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x1919C090)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x1919C200)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1919BB60)
#define SYSTEM_SECURITY_PERMISSIONS_REFLECTIONPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1919BB30)
