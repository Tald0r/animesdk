...
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY_GET_PERMISSIONACCESSPATH_OFFSET UNITYSDK_OFFSET(0x1824E370)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1824E330)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1824E2F0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1824E2B0)
