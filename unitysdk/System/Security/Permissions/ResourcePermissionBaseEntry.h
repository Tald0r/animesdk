...
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY_GET_PERMISSIONACCESSPATH_OFFSET UNITYSDK_OFFSET(0x187E87B0)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x187E8770)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x187E8730)
#define SYSTEM_SECURITY_PERMISSIONS_RESOURCEPERMISSIONBASEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x187E86F0)
