...
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x19390340)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x193907F0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x19390190)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x193904D0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x19390390)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x193901A0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_RESET_OFFSET UNITYSDK_OFFSET(0x19390160)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_SETUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x19390090)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x19390170)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x19390630)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x193901B0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_VERIFYACCESS_OFFSET UNITYSDK_OFFSET(0x193900C0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_VERIFYFLAGS_OFFSET UNITYSDK_OFFSET(0x19390BB0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193900A0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19390020)
