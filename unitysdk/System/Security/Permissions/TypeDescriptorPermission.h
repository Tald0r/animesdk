...
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x18FFEE20)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x18FFF2D0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x18FFEC70)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x18FFEFB0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x18FFEE70)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x18FFEC80)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_RESET_OFFSET UNITYSDK_OFFSET(0x18FFEC40)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_SETUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x18FFEB70)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x18FFEC50)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x18FFF110)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x18FFEC90)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_VERIFYACCESS_OFFSET UNITYSDK_OFFSET(0x18FFEBA0)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION_VERIFYFLAGS_OFFSET UNITYSDK_OFFSET(0x18FFF690)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FFEB80)
#define SYSTEM_SECURITY_PERMISSIONS_TYPEDESCRIPTORPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18FFEB00)
