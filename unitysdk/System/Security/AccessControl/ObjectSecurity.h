...
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_AREACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x1914B360)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_COPYSDDLFORM_OFFSET UNITYSDK_OFFSET(0x1914BBA0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GETGROUP_OFFSET UNITYSDK_OFFSET(0x1914B4C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GETOWNER_OFFSET UNITYSDK_OFFSET(0x1914B610)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_ACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x1914B090)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_ACCESSRULESMODIFIED_OFFSET UNITYSDK_OFFSET(0x1914B340)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_AREACCESSRULESPROTECTED_OFFSET UNITYSDK_OFFSET(0x1914AEC0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_AREAUDITRULESPROTECTED_OFFSET UNITYSDK_OFFSET(0x1914AFD0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_AUDITRULESMODIFIED_OFFSET UNITYSDK_OFFSET(0x1914B3F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_GROUPMODIFIED_OFFSET UNITYSDK_OFFSET(0x1914B440)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_ISCONTAINER_OFFSET UNITYSDK_OFFSET(0x1914B460)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_ISDS_OFFSET UNITYSDK_OFFSET(0x1914B480)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_OWNERMODIFIED_OFFSET UNITYSDK_OFFSET(0x1914B4A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_PURGEACCESSRULES_OFFSET UNITYSDK_OFFSET(0x1914B760)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_PURGEAUDITRULES_OFFSET UNITYSDK_OFFSET(0x1914B9A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_READING_OFFSET UNITYSDK_OFFSET(0x1914B0B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_READLOCK_OFFSET UNITYSDK_OFFSET(0x1914AF80)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_READUNLOCK_OFFSET UNITYSDK_OFFSET(0x1914AFB0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SETACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x1914B3B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SETSECURITYDESCRIPTORBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1914BAD0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SET_ACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x1914B200)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SET_ACCESSRULESMODIFIED_OFFSET UNITYSDK_OFFSET(0x1914B380)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SET_AUDITRULESMODIFIED_OFFSET UNITYSDK_OFFSET(0x1914B410)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SIDFROMIR_OFFSET UNITYSDK_OFFSET(0x1914B8D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_WRITELOCK_OFFSET UNITYSDK_OFFSET(0x1914B8A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_WRITEUNLOCK_OFFSET UNITYSDK_OFFSET(0x1914B980)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_WRITING_OFFSET UNITYSDK_OFFSET(0x1914B220)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1914AC80)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1914ADE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1914AC70)
