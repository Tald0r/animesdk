...
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_AREACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x194F0CF0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_COPYSDDLFORM_OFFSET UNITYSDK_OFFSET(0x194F1530)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GETGROUP_OFFSET UNITYSDK_OFFSET(0x194F0E50)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GETOWNER_OFFSET UNITYSDK_OFFSET(0x194F0FA0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_ACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x194F0A20)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_ACCESSRULESMODIFIED_OFFSET UNITYSDK_OFFSET(0x194F0CD0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_AREACCESSRULESPROTECTED_OFFSET UNITYSDK_OFFSET(0x194F0850)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_AREAUDITRULESPROTECTED_OFFSET UNITYSDK_OFFSET(0x194F0960)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_AUDITRULESMODIFIED_OFFSET UNITYSDK_OFFSET(0x194F0D80)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_GROUPMODIFIED_OFFSET UNITYSDK_OFFSET(0x194F0DD0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_ISCONTAINER_OFFSET UNITYSDK_OFFSET(0x194F0DF0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_ISDS_OFFSET UNITYSDK_OFFSET(0x194F0E10)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_GET_OWNERMODIFIED_OFFSET UNITYSDK_OFFSET(0x194F0E30)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_PURGEACCESSRULES_OFFSET UNITYSDK_OFFSET(0x194F10F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_PURGEAUDITRULES_OFFSET UNITYSDK_OFFSET(0x194F1330)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_READING_OFFSET UNITYSDK_OFFSET(0x194F0A40)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_READLOCK_OFFSET UNITYSDK_OFFSET(0x194F0910)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_READUNLOCK_OFFSET UNITYSDK_OFFSET(0x194F0940)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SETACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x194F0D40)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SETSECURITYDESCRIPTORBINARYFORM_OFFSET UNITYSDK_OFFSET(0x194F1460)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SET_ACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x194F0B90)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SET_ACCESSRULESMODIFIED_OFFSET UNITYSDK_OFFSET(0x194F0D10)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SET_AUDITRULESMODIFIED_OFFSET UNITYSDK_OFFSET(0x194F0DA0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_SIDFROMIR_OFFSET UNITYSDK_OFFSET(0x194F1260)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_WRITELOCK_OFFSET UNITYSDK_OFFSET(0x194F1230)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_WRITEUNLOCK_OFFSET UNITYSDK_OFFSET(0x194F1310)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY_WRITING_OFFSET UNITYSDK_OFFSET(0x194F0BB0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x194F0610)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x194F0770)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTSECURITY__CTOR_OFFSET UNITYSDK_OFFSET(0x194F0600)
