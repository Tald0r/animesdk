...
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_CREATEFROMBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1966B410)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1966B570)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1966B710)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_GET_AUDITFLAGS_OFFSET UNITYSDK_OFFSET(0x1966B3B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_GET_INHERITANCEFLAGS_OFFSET UNITYSDK_OFFSET(0x1966B3D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_GET_ISINHERITED_OFFSET UNITYSDK_OFFSET(0x1966B3F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_GET_PROPAGATIONFLAGS_OFFSET UNITYSDK_OFFSET(0x1966B400)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_ISOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1966B550)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1966B5E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1966B800)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_READINT_OFFSET UNITYSDK_OFFSET(0x1966B990)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_READUSHORT_OFFSET UNITYSDK_OFFSET(0x1966B930)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_WRITEINT_OFFSET UNITYSDK_OFFSET(0x1966BA30)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE_WRITEUSHORT_OFFSET UNITYSDK_OFFSET(0x1966BAC0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1966B2A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1966BB10)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1966B230)
