...
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_CLEARACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x197BE700)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_DEFAULTEXCEPTIONFROMERRORCODE_OFFSET UNITYSDK_OFFSET(0x197BE940)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETNAMEDSECURITYINFO_OFFSET UNITYSDK_OFFSET(0x197BFC20)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETSECURITYDESCRIPTORLENGTH_OFFSET UNITYSDK_OFFSET(0x197BF500)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETSECURITYINFO_OFFSET UNITYSDK_OFFSET(0x197BFB00)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_INTERNALGET_1_OFFSET UNITYSDK_OFFSET(0x197BEF80)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_INTERNALGET_OFFSET UNITYSDK_OFFSET(0x197BEC40)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_INTERNALSET_OFFSET UNITYSDK_OFFSET(0x197BF020)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_ISVALIDSECURITYDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x197BF480)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_LOCALFREE_OFFSET UNITYSDK_OFFSET(0x197BF580)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_PERSIST_OFFSET UNITYSDK_OFFSET(0x197BE7C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_RAISEEXCEPTIONONFAILURE_OFFSET UNITYSDK_OFFSET(0x197BE650)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_SETSECURITYINFO_OFFSET UNITYSDK_OFFSET(0x197BFD10)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_WIN32FIXNAME_OFFSET UNITYSDK_OFFSET(0x197BFA50)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_WIN32GETHELPER_OFFSET UNITYSDK_OFFSET(0x197BECE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_WIN32SETHELPER_OFFSET UNITYSDK_OFFSET(0x197BF0D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197BE2A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x197BE2D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x197BE490)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_4_OFFSET UNITYSDK_OFFSET(0x197BE2F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_5_OFFSET UNITYSDK_OFFSET(0x197BE4B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_OFFSET UNITYSDK_OFFSET(0x197BE270)
