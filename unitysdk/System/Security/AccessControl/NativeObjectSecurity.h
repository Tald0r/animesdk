...
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_CLEARACCESSCONTROLSECTIONSMODIFIED_OFFSET UNITYSDK_OFFSET(0x19CCF3B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_DEFAULTEXCEPTIONFROMERRORCODE_OFFSET UNITYSDK_OFFSET(0x19CCF5F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETNAMEDSECURITYINFO_OFFSET UNITYSDK_OFFSET(0x19CD0900)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETSECURITYDESCRIPTORLENGTH_OFFSET UNITYSDK_OFFSET(0x19CD01C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_GETSECURITYINFO_OFFSET UNITYSDK_OFFSET(0x19CD07E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_INTERNALGET_1_OFFSET UNITYSDK_OFFSET(0x19CCFC30)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_INTERNALGET_OFFSET UNITYSDK_OFFSET(0x19CCF8F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_INTERNALSET_OFFSET UNITYSDK_OFFSET(0x19CCFCD0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_ISVALIDSECURITYDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19CD0140)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_LOCALFREE_OFFSET UNITYSDK_OFFSET(0x19CD0240)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_PERSIST_OFFSET UNITYSDK_OFFSET(0x19CCF470)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_RAISEEXCEPTIONONFAILURE_OFFSET UNITYSDK_OFFSET(0x19CCF300)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_SETSECURITYINFO_OFFSET UNITYSDK_OFFSET(0x19CD09F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_WIN32FIXNAME_OFFSET UNITYSDK_OFFSET(0x19CD0730)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_WIN32GETHELPER_OFFSET UNITYSDK_OFFSET(0x19CCF990)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_WIN32SETHELPER_OFFSET UNITYSDK_OFFSET(0x19CCFD90)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19CCEF50)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19CCEF80)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19CCF140)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19CCEFA0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19CCF160)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19CCEF20)
