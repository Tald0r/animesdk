...
#define SYSTEM_SECURITY_ACCESSCONTROL_KNOWNACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19CCEED0)
#define SYSTEM_SECURITY_ACCESSCONTROL_KNOWNACE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19CCEEE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_KNOWNACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CCEE60)
