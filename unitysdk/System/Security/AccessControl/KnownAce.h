...
#define SYSTEM_SECURITY_ACCESSCONTROL_KNOWNACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197BE220)
#define SYSTEM_SECURITY_ACCESSCONTROL_KNOWNACE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x197BE230)
#define SYSTEM_SECURITY_ACCESSCONTROL_KNOWNACE__CTOR_OFFSET UNITYSDK_OFFSET(0x197BE1B0)
