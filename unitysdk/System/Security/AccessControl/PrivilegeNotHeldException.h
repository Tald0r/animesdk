...
#define SYSTEM_SECURITY_ACCESSCONTROL_PRIVILEGENOTHELDEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1914C3F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_PRIVILEGENOTHELDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1914C350)
