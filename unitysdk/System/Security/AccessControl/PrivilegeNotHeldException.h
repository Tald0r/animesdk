...
#define SYSTEM_SECURITY_ACCESSCONTROL_PRIVILEGENOTHELDEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x194F1D80)
#define SYSTEM_SECURITY_ACCESSCONTROL_PRIVILEGENOTHELDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x194F1CE0)
