...
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_ADDACEGETQUALIFIEDACE_OFFSET UNITYSDK_OFFSET(0x18F0E940)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_ADDACE_1_OFFSET UNITYSDK_OFFSET(0x18F0EA00)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_ADDACE_OFFSET UNITYSDK_OFFSET(0x18F0E860)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_APPLYCANONICALSORTTOEXPLICITACES_OFFSET UNITYSDK_OFFSET(0x18F0E500)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_CANONICALIZEANDCLEARAEFA_OFFSET UNITYSDK_OFFSET(0x18F0D400)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_COPYACE_OFFSET UNITYSDK_OFFSET(0x18F0D600)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETACEFLAGS_OFFSET UNITYSDK_OFFSET(0x18F0EB10)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x18F0D6B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETCANONICALEXPLICITACECOUNT_OFFSET UNITYSDK_OFFSET(0x18F0E050)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETCANONICALEXPLICITDENYACECOUNT_OFFSET UNITYSDK_OFFSET(0x18F0DEF0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETOBJECTACETYPEGUIDS_OFFSET UNITYSDK_OFFSET(0x18F0E4B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x18F0D500)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x18F0D520)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x18F0D550)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_INIT_OFFSET UNITYSDK_OFFSET(0x18F0D140)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_ISACEMEANINGLESS_OFFSET UNITYSDK_OFFSET(0x18F0DE60)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_MERGEEXPLICITACEPAIR_OFFSET UNITYSDK_OFFSET(0x18F0E100)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_MERGEEXPLICITACES_OFFSET UNITYSDK_OFFSET(0x18F0DC20)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_PURGE_OFFSET UNITYSDK_OFFSET(0x18F0D6D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_REMOVEACESPECIFIC_OFFSET UNITYSDK_OFFSET(0x18F0EBF0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_REQUIRECANONICITY_OFFSET UNITYSDK_OFFSET(0x18F0D7C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_SETACE_1_OFFSET UNITYSDK_OFFSET(0x18F0EE20)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_SETACE_OFFSET UNITYSDK_OFFSET(0x18F0ED40)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x18F0D660)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_TESTCANONICITY_OFFSET UNITYSDK_OFFSET(0x18F0D830)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F0D150)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18F0D270)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18F0EF30)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL__CTOR_OFFSET UNITYSDK_OFFSET(0x18F0CF50)
...
namespace System::Security::AccessControl
{
	...
	public:
		...
		::System::Boolean is_canonical; // 0x18
		::System::Boolean is_container; // 0x19
		::System::Boolean is_ds; // 0x1A
