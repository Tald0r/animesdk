...
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_ADDACEGETQUALIFIEDACE_OFFSET UNITYSDK_OFFSET(0x19308660)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_ADDACE_1_OFFSET UNITYSDK_OFFSET(0x19308720)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_ADDACE_OFFSET UNITYSDK_OFFSET(0x19308580)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_APPLYCANONICALSORTTOEXPLICITACES_OFFSET UNITYSDK_OFFSET(0x19308220)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_CANONICALIZEANDCLEARAEFA_OFFSET UNITYSDK_OFFSET(0x19307120)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_COPYACE_OFFSET UNITYSDK_OFFSET(0x19307320)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETACEFLAGS_OFFSET UNITYSDK_OFFSET(0x19308830)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x193073D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETCANONICALEXPLICITACECOUNT_OFFSET UNITYSDK_OFFSET(0x19307D70)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETCANONICALEXPLICITDENYACECOUNT_OFFSET UNITYSDK_OFFSET(0x19307C10)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GETOBJECTACETYPEGUIDS_OFFSET UNITYSDK_OFFSET(0x193081D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x19307220)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19307240)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19307270)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_INIT_OFFSET UNITYSDK_OFFSET(0x19306E60)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_ISACEMEANINGLESS_OFFSET UNITYSDK_OFFSET(0x19307B80)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_MERGEEXPLICITACEPAIR_OFFSET UNITYSDK_OFFSET(0x19307E20)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_MERGEEXPLICITACES_OFFSET UNITYSDK_OFFSET(0x19307940)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_PURGE_OFFSET UNITYSDK_OFFSET(0x193073F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_REMOVEACESPECIFIC_OFFSET UNITYSDK_OFFSET(0x19308910)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_REQUIRECANONICITY_OFFSET UNITYSDK_OFFSET(0x193074E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_SETACE_1_OFFSET UNITYSDK_OFFSET(0x19308B40)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_SETACE_OFFSET UNITYSDK_OFFSET(0x19308A60)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19307380)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL_TESTCANONICITY_OFFSET UNITYSDK_OFFSET(0x19307550)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19306E70)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19306F90)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19308C60)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACL__CTOR_OFFSET UNITYSDK_OFFSET(0x19306C80)
