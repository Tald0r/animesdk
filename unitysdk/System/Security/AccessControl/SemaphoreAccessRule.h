...
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREACCESSRULE_GET_SEMAPHORERIGHTS_OFFSET UNITYSDK_OFFSET(0x1890B7A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREACCESSRULE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1890B6C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREACCESSRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1890B620)
