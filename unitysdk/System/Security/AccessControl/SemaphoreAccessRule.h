...
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREACCESSRULE_GET_SEMAPHORERIGHTS_OFFSET UNITYSDK_OFFSET(0x182F6A20)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREACCESSRULE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x182F6940)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREACCESSRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x182F68A0)
