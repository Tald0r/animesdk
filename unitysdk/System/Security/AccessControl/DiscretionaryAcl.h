...
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_ADDACCESS_OFFSET UNITYSDK_OFFSET(0x17FE4BD0)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_APPLYCANONICALSORTTOEXPLICITACES_OFFSET UNITYSDK_OFFSET(0x17FE4F90)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_GETACEINSERTPOSITION_OFFSET UNITYSDK_OFFSET(0x17FE4FD0)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_GETACEQUALIFIER_OFFSET UNITYSDK_OFFSET(0x17FE4D00)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_ISACEMEANINGLESS_OFFSET UNITYSDK_OFFSET(0x17FE4FE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_REMOVEACCESSSPECIFIC_OFFSET UNITYSDK_OFFSET(0x17FE4DC0)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_REMOVEACCESS_OFFSET UNITYSDK_OFFSET(0x17FE4D70)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_SETACCESS_OFFSET UNITYSDK_OFFSET(0x17FE4E60)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17FE4BC0)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL__CTOR_OFFSET UNITYSDK_OFFSET(0x17FE4BB0)
