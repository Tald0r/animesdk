...
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_ADDACCESS_OFFSET UNITYSDK_OFFSET(0x186185C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_APPLYCANONICALSORTTOEXPLICITACES_OFFSET UNITYSDK_OFFSET(0x18618980)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_GETACEINSERTPOSITION_OFFSET UNITYSDK_OFFSET(0x186189C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_GETACEQUALIFIER_OFFSET UNITYSDK_OFFSET(0x186186F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_ISACEMEANINGLESS_OFFSET UNITYSDK_OFFSET(0x186189D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_REMOVEACCESSSPECIFIC_OFFSET UNITYSDK_OFFSET(0x186187B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_REMOVEACCESS_OFFSET UNITYSDK_OFFSET(0x18618760)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL_SETACCESS_OFFSET UNITYSDK_OFFSET(0x18618850)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x186185B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_DISCRETIONARYACL__CTOR_OFFSET UNITYSDK_OFFSET(0x186185A0)
