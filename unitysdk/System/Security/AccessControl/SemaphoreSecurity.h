...
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_ACCESSRULEFACTORY_OFFSET UNITYSDK_OFFSET(0x1946A4F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_ADDACCESSRULE_OFFSET UNITYSDK_OFFSET(0x1946A5C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_ADDAUDITRULE_OFFSET UNITYSDK_OFFSET(0x1946A7A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_AUDITRULEFACTORY_OFFSET UNITYSDK_OFFSET(0x1946A6D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_GET_ACCESSRIGHTTYPE_OFFSET UNITYSDK_OFFSET(0x1946A460)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_GET_ACCESSRULETYPE_OFFSET UNITYSDK_OFFSET(0x1946A490)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_GET_AUDITRULETYPE_OFFSET UNITYSDK_OFFSET(0x1946A4C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_PERSIST_OFFSET UNITYSDK_OFFSET(0x1946A880)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEACCESSRULEALL_OFFSET UNITYSDK_OFFSET(0x1946A610)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEACCESSRULESPECIFIC_OFFSET UNITYSDK_OFFSET(0x1946A640)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEACCESSRULE_OFFSET UNITYSDK_OFFSET(0x1946A5E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEAUDITRULEALL_OFFSET UNITYSDK_OFFSET(0x1946A7F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEAUDITRULESPECIFIC_OFFSET UNITYSDK_OFFSET(0x1946A820)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_REMOVEAUDITRULE_OFFSET UNITYSDK_OFFSET(0x1946A7C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_RESETACCESSRULE_OFFSET UNITYSDK_OFFSET(0x1946A670)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_SETACCESSRULE_OFFSET UNITYSDK_OFFSET(0x1946A6A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY_SETAUDITRULE_OFFSET UNITYSDK_OFFSET(0x1946A850)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1946A400)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1946A430)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHORESECURITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1946A3D0)
