...
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_EXCEPTIONFROMERRORCODE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x192BF440)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_EXCEPTIONFROMERRORCODE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x192BF4D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_EXCEPTIONFROMERRORCODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x192BF050)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_EXCEPTIONFROMERRORCODE__CTOR_OFFSET UNITYSDK_OFFSET(0x192BF040)
