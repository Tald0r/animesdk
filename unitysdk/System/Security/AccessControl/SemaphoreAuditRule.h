...
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREAUDITRULE_GET_SEMAPHORERIGHTS_OFFSET UNITYSDK_OFFSET(0x19D3AA50)
#define SYSTEM_SECURITY_ACCESSCONTROL_SEMAPHOREAUDITRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D3A9B0)
