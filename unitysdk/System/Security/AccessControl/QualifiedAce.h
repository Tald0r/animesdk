...
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_GETOPAQUE_OFFSET UNITYSDK_OFFSET(0x1914AAD0)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_GET_ACEQUALIFIER_OFFSET UNITYSDK_OFFSET(0x1914C440)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_GET_ISCALLBACK_OFFSET UNITYSDK_OFFSET(0x1914C4E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_GET_OPAQUELENGTH_OFFSET UNITYSDK_OFFSET(0x1914A880)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_SETOPAQUE_OFFSET UNITYSDK_OFFSET(0x1914A760)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1914A750)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1914C4F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1914A340)
