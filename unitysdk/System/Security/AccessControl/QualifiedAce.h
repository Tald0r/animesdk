...
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_GETOPAQUE_OFFSET UNITYSDK_OFFSET(0x194F0460)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_GET_ACEQUALIFIER_OFFSET UNITYSDK_OFFSET(0x194F1DD0)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_GET_ISCALLBACK_OFFSET UNITYSDK_OFFSET(0x194F1E70)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_GET_OPAQUELENGTH_OFFSET UNITYSDK_OFFSET(0x194F0210)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE_SETOPAQUE_OFFSET UNITYSDK_OFFSET(0x194F00F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x194F00E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x194F1E80)
#define SYSTEM_SECURITY_ACCESSCONTROL_QUALIFIEDACE__CTOR_OFFSET UNITYSDK_OFFSET(0x194EFCD0)
