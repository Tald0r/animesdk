...
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1914CB10)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x1914C940)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1914CA40)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1914CA60)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_INSERTACE_OFFSET UNITYSDK_OFFSET(0x1914CE10)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_READUSHORT_OFFSET UNITYSDK_OFFSET(0x1914C8E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_REMOVEACE_OFFSET UNITYSDK_OFFSET(0x1914CEA0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1914CAC0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_WRITEUSHORT_OFFSET UNITYSDK_OFFSET(0x1914CDC0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1914C5B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL__CTOR_OFFSET UNITYSDK_OFFSET(0x1914C530)
