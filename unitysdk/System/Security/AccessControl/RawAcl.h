...
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x194F2490)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x194F22D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x194F23C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x194F23E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_INSERTACE_OFFSET UNITYSDK_OFFSET(0x194F2790)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_READUSHORT_OFFSET UNITYSDK_OFFSET(0x194F2270)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_REMOVEACE_OFFSET UNITYSDK_OFFSET(0x194F2820)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x194F2440)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL_WRITEUSHORT_OFFSET UNITYSDK_OFFSET(0x194F2740)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x194F1F40)
#define SYSTEM_SECURITY_ACCESSCONTROL_RAWACL__CTOR_OFFSET UNITYSDK_OFFSET(0x194F1EC0)
