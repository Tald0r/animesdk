...
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_SETSECURITYINFONATIVECALL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x197BFE50)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_SETSECURITYINFONATIVECALL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x197BFF00)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_SETSECURITYINFONATIVECALL_INVOKE_OFFSET UNITYSDK_OFFSET(0x197BF600)
#define SYSTEM_SECURITY_ACCESSCONTROL_NATIVEOBJECTSECURITY_SETSECURITYINFONATIVECALL__CTOR_OFFSET UNITYSDK_OFFSET(0x197BF0C0)
