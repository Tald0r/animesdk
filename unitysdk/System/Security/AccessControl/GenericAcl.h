...
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACL_COPYTO_OFFSET UNITYSDK_OFFSET(0x1966BBC0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1966BDE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACL_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1966BBA0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACL_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1966BBB0)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACL_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1966BD60)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACL_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1966BE30)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1966BB50)
#define SYSTEM_SECURITY_ACCESSCONTROL_GENERICACL__CTOR_OFFSET UNITYSDK_OFFSET(0x1966BB90)
