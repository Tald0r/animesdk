...
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_CONVERTTYPE_OFFSET UNITYSDK_OFFSET(0x1985D3C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x1985D8A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x1985D840)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_GET_INHERITEDOBJECTACETYPEPRESENT_OFFSET UNITYSDK_OFFSET(0x1985D7D0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_GET_OBJECTACETYPEPRESENT_OFFSET UNITYSDK_OFFSET(0x1985D7C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_READGUID_OFFSET UNITYSDK_OFFSET(0x1985D7E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_WRITEGUID_OFFSET UNITYSDK_OFFSET(0x1985DAD0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1985D4B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1985D330)
