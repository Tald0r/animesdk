...
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_CONVERTTYPE_OFFSET UNITYSDK_OFFSET(0x19445370)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x19445850)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x194457F0)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_GET_INHERITEDOBJECTACETYPEPRESENT_OFFSET UNITYSDK_OFFSET(0x19445780)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_GET_OBJECTACETYPEPRESENT_OFFSET UNITYSDK_OFFSET(0x19445770)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_READGUID_OFFSET UNITYSDK_OFFSET(0x19445790)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE_WRITEGUID_OFFSET UNITYSDK_OFFSET(0x19445A80)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19445460)
#define SYSTEM_SECURITY_ACCESSCONTROL_OBJECTACE__CTOR_OFFSET UNITYSDK_OFFSET(0x194452E0)
