...
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE_CONVERTTYPE_OFFSET UNITYSDK_OFFSET(0x194EFBE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE_GETBINARYFORM_OFFSET UNITYSDK_OFFSET(0x194F0220)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE_GET_BINARYLENGTH_OFFSET UNITYSDK_OFFSET(0x194F01C0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x194EFE10)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONACE__CTOR_OFFSET UNITYSDK_OFFSET(0x194EFAA0)
