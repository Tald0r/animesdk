...
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_ADDAUDIT_OFFSET UNITYSDK_OFFSET(0x192BFB30)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_APPLYCANONICALSORTTOEXPLICITACES_OFFSET UNITYSDK_OFFSET(0x192BFD50)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_GETACEINSERTPOSITION_OFFSET UNITYSDK_OFFSET(0x192BFD70)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_ISACEMEANINGLESS_OFFSET UNITYSDK_OFFSET(0x192BFD80)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_ISVALIDAUDITFLAGS_OFFSET UNITYSDK_OFFSET(0x192BFED0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_REMOVEAUDITSPECIFIC_OFFSET UNITYSDK_OFFSET(0x192BFC50)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_REMOVEAUDIT_OFFSET UNITYSDK_OFFSET(0x192BFC00)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_SETAUDIT_OFFSET UNITYSDK_OFFSET(0x192BFC80)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x192BFB20)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL__CTOR_OFFSET UNITYSDK_OFFSET(0x192BFB10)
