...
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_ADDAUDIT_OFFSET UNITYSDK_OFFSET(0x197A7A10)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_APPLYCANONICALSORTTOEXPLICITACES_OFFSET UNITYSDK_OFFSET(0x197A7C30)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_GETACEINSERTPOSITION_OFFSET UNITYSDK_OFFSET(0x197A7C50)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_ISACEMEANINGLESS_OFFSET UNITYSDK_OFFSET(0x197A7C60)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_ISVALIDAUDITFLAGS_OFFSET UNITYSDK_OFFSET(0x197A7DB0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_REMOVEAUDITSPECIFIC_OFFSET UNITYSDK_OFFSET(0x197A7B30)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_REMOVEAUDIT_OFFSET UNITYSDK_OFFSET(0x197A7AE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL_SETAUDIT_OFFSET UNITYSDK_OFFSET(0x197A7B60)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197A7A00)
#define SYSTEM_SECURITY_ACCESSCONTROL_SYSTEMACL__CTOR_OFFSET UNITYSDK_OFFSET(0x197A79F0)
