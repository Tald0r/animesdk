...
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_CHECKACLCONSISTENCY_OFFSET UNITYSDK_OFFSET(0x1951EC00)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_GET_CONTROLFLAGS_OFFSET UNITYSDK_OFFSET(0x1951EBE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_INIT_1_OFFSET UNITYSDK_OFFSET(0x1951EAB0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_INIT_OFFSET UNITYSDK_OFFSET(0x1951E920)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_PURGEACCESSCONTROL_OFFSET UNITYSDK_OFFSET(0x1951ECC0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_PURGEAUDIT_OFFSET UNITYSDK_OFFSET(0x1951ECE0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_SET_DISCRETIONARYACL_OFFSET UNITYSDK_OFFSET(0x1951EB10)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_SET_SYSTEMACL_OFFSET UNITYSDK_OFFSET(0x1951E870)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1951EA50)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1951E8A0)
...
namespace System::Security::AccessControl
{
	...
	public:
		...
		::System::Security::AccessControl::SystemAcl* system_acl; // 0x20
