...
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_CHECKACLCONSISTENCY_OFFSET UNITYSDK_OFFSET(0x199FE990)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_GET_CONTROLFLAGS_OFFSET UNITYSDK_OFFSET(0x199FE970)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_INIT_1_OFFSET UNITYSDK_OFFSET(0x199FE840)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_INIT_OFFSET UNITYSDK_OFFSET(0x199FE6B0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_PURGEACCESSCONTROL_OFFSET UNITYSDK_OFFSET(0x199FEA50)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_PURGEAUDIT_OFFSET UNITYSDK_OFFSET(0x199FEA70)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_SET_DISCRETIONARYACL_OFFSET UNITYSDK_OFFSET(0x199FE8A0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR_SET_SYSTEMACL_OFFSET UNITYSDK_OFFSET(0x199FE600)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x199FE7E0)
#define SYSTEM_SECURITY_ACCESSCONTROL_COMMONSECURITYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x199FE630)
...
namespace System::Security::AccessControl
{
	...
	public:
		...
		::System::Security::AccessControl::DiscretionaryAcl* discretionary_acl; // 0x18
