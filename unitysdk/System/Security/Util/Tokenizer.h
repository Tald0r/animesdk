...
#define SYSTEM_SECURITY_UTIL_TOKENIZER_BASICINITIALIZATION_OFFSET UNITYSDK_OFFSET(0x1966CA80)
#define SYSTEM_SECURITY_UTIL_TOKENIZER_CHANGEFORMAT_OFFSET UNITYSDK_OFFSET(0x1966CB60)
#define SYSTEM_SECURITY_UTIL_TOKENIZER_GETSTRINGTOKEN_OFFSET UNITYSDK_OFFSET(0x1966DCA0)
#define SYSTEM_SECURITY_UTIL_TOKENIZER_GETTOKENS_OFFSET UNITYSDK_OFFSET(0x1966CEC0)
#define SYSTEM_SECURITY_UTIL_TOKENIZER_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1966CAC0)
#define SYSTEM_SECURITY_UTIL_TOKENIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1966CAF0)
...
namespace System::Security::Util
{
	...
	public:
		...
		::System::Int32 _inProcessingTag; // 0x58
		::System::Int32 _inNestedIndex; // 0x5C
		::System::Int32 _inSize; // 0x60
		::System::Int32 _inSavedCharacter; // 0x64
		::System::Int32 LineNo; // 0x68
