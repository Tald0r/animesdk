...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19DDBD00)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_FUNC_OFFSET UNITYSDK_OFFSET(0x19DDB850)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_GETBYTES_OFFSET UNITYSDK_OFFSET(0x19DDB6C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19DDB670)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_SET_ITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x19DDB5C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES_SET_SALT_OFFSET UNITYSDK_OFFSET(0x19DDB410)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19DDB380)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_RFC2898DERIVEBYTES__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDB280)
...
namespace System::Security::Cryptography
{
	...
	{
	public:
		::System::Security::Cryptography::HMACSHA1* m_hmacsha1; // 0x10
