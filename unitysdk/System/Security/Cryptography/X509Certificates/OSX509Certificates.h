...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFARRAYCREATE_OFFSET UNITYSDK_OFFSET(0x19D3B0E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFDATACREATE_OFFSET UNITYSDK_OFFSET(0x19D3AF50)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFRELEASE_OFFSET UNITYSDK_OFFSET(0x19D3B060)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFRETAIN_OFFSET UNITYSDK_OFFSET(0x19D3AFE0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_CFSTRINGCREATEWITHCHARACTERS_OFFSET UNITYSDK_OFFSET(0x19D3AEB0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_FROMINTPTRS_OFFSET UNITYSDK_OFFSET(0x19D3B230)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_GETCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x19D3B2E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_MAKECFDATA_OFFSET UNITYSDK_OFFSET(0x19D3B180)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECCERTIFICATECREATEWITHDATA_OFFSET UNITYSDK_OFFSET(0x19D3ABE0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECPOLICYCREATESSL_OFFSET UNITYSDK_OFFSET(0x19D3AD90)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECTRUSTCREATEWITHCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x19D3AC70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECTRUSTEVALUATE_OFFSET UNITYSDK_OFFSET(0x19D3AE20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_SECTRUSTSETANCHORCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x19D3AD00)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES_TRUSTEVALUATESSL_OFFSET UNITYSDK_OFFSET(0x19D3B580)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OSX509CERTIFICATES__TRUSTEVALUATESSL_OFFSET UNITYSDK_OFFSET(0x19D3B5F0)
