...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_ADDRANGE_OFFSET UNITYSDK_OFFSET(0x195E0410)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_ADD_OFFSET UNITYSDK_OFFSET(0x195DFD50)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_CLOSE_OFFSET UNITYSDK_OFFSET(0x195E0C80)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x195E0D10)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_EXISTS_OFFSET UNITYSDK_OFFSET(0x195E0270)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x195DFBC0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_GET_FACTORY_OFFSET UNITYSDK_OFFSET(0x195DFD00)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_GET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x195DFD10)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x195DFD20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x195DFCE0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x195DFCF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_GET_STOREHANDLE_OFFSET UNITYSDK_OFFSET(0x195DFD40)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_GET_STORE_OFFSET UNITYSDK_OFFSET(0x195DFD30)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_OPEN_OFFSET UNITYSDK_OFFSET(0x195E0DA0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_REMOVERANGE_OFFSET UNITYSDK_OFFSET(0x195E1800)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE_REMOVE_OFFSET UNITYSDK_OFFSET(0x195E1340)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195DF920)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x195DF960)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x195DFA80)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x195DF970)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x195DFB30)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x195DF8A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509STORE__CTOR_OFFSET UNITYSDK_OFFSET(0x195DF830)
...
namespace System::Security::Cryptography::X509Certificates
{
	...
	{
	public:
		::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* list; // 0x10
		::Mono::Security::X509::X509Store* store; // 0x18
