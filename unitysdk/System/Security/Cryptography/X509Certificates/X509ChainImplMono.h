...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_BUILDCHAINFROM_OFFSET UNITYSDK_OFFSET(0x18FCB8C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_BUILD_OFFSET UNITYSDK_OFFSET(0x18FCAEB0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_CHECKCRLS_OFFSET UNITYSDK_OFFSET(0x18FCFC50)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_CHECKREVOCATIONONCHAIN_OFFSET UNITYSDK_OFFSET(0x18FCDE00)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_CHECKREVOCATION_1_OFFSET UNITYSDK_OFFSET(0x18FCED00)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_CHECKREVOCATION_OFFSET UNITYSDK_OFFSET(0x18FCE9D0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_FINDCRL_OFFSET UNITYSDK_OFFSET(0x18FCEF70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_FINDPARENT_OFFSET UNITYSDK_OFFSET(0x18FCC810)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GETAUTHORITYKEYIDENTIFIER_1_OFFSET UNITYSDK_OFFSET(0x18FCE950)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GETAUTHORITYKEYIDENTIFIER_2_OFFSET UNITYSDK_OFFSET(0x18FCE7D0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GETAUTHORITYKEYIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x18FCCEF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GETSUBJECTKEYIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x18FCCF80)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CERTIFICATEAUTHORITIES_OFFSET UNITYSDK_OFFSET(0x18FCC2C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CERTIFICATECOLLECTION_OFFSET UNITYSDK_OFFSET(0x18FCC700)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CHAINELEMENTS_OFFSET UNITYSDK_OFFSET(0x18FCAE10)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CHAINPOLICY_OFFSET UNITYSDK_OFFSET(0x18FCAE20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CHAINSTATUS_OFFSET UNITYSDK_OFFSET(0x18FCAE40)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x18FCAE00)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x18FCADF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_LMCASTORE_OFFSET UNITYSDK_OFFSET(0x18FCC560)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_LMROOTSTORE_OFFSET UNITYSDK_OFFSET(0x18FCC080)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_ROOTS_OFFSET UNITYSDK_OFFSET(0x18FCBD60)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_USERCASTORE_OFFSET UNITYSDK_OFFSET(0x18FCC630)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_USERROOTSTORE_OFFSET UNITYSDK_OFFSET(0x18FCC1A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_ISCHAINCOMPLETE_OFFSET UNITYSDK_OFFSET(0x18FCC9D0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_ISSELFISSUED_OFFSET UNITYSDK_OFFSET(0x18FCD090)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_ISSIGNEDWITH_OFFSET UNITYSDK_OFFSET(0x18FCE520)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PREPAREFORNEXTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x18FCD8C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PROCESSCERTIFICATEEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x18FCE570)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PROCESSCRLENTRYEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x18FCF4C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PROCESSCRLEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x18FCF870)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PROCESS_OFFSET UNITYSDK_OFFSET(0x18FCD210)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_RESET_OFFSET UNITYSDK_OFFSET(0x18FCB600)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_SELECTBESTFROMCOLLECTION_OFFSET UNITYSDK_OFFSET(0x18FCCBF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_SET_CHAINPOLICY_OFFSET UNITYSDK_OFFSET(0x18FCAE30)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_VALIDATECHAIN_OFFSET UNITYSDK_OFFSET(0x18FCBB10)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_WRAPUP_OFFSET UNITYSDK_OFFSET(0x18FCE220)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO__CCTOR_OFFSET UNITYSDK_OFFSET(0x18FD0130)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FCACE0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FCADA0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCACD0)
...
namespace System::Security::Cryptography::X509Certificates
{
	...
	public:
		...
		::System::Security::Cryptography::X509Certificates::X509Store* ca_store; // 0x18
		::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* roots; // 0x20
		::System::Security::Cryptography::X509Certificates::X509ChainElement* bce_restriction; // 0x28
		::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* collection; // 0x30
		::System::Security::Cryptography::X509Certificates::X509ChainPolicy* policy; // 0x38
		::System::Security::Cryptography::X509Certificates::X509Store* root_store; // 0x40
		::System::Security::Cryptography::X509Certificates::X500DistinguishedName* working_issuer_name; // 0x48
		::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* elements; // 0x50
		::System::Security::Cryptography::X509Certificates::X509Store* user_root_store; // 0x58
		::System::Security::Cryptography::X509Certificates::X509Store* user_ca_store; // 0x60
		::System::Security::Cryptography::AsymmetricAlgorithm* working_public_key; // 0x68
		::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* cas; // 0x70
