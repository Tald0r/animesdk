...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_BUILDCHAINFROM_OFFSET UNITYSDK_OFFSET(0x193B7C60)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_BUILD_OFFSET UNITYSDK_OFFSET(0x193B7230)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_CHECKCRLS_OFFSET UNITYSDK_OFFSET(0x193BBFF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_CHECKREVOCATIONONCHAIN_OFFSET UNITYSDK_OFFSET(0x193BA1A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_CHECKREVOCATION_1_OFFSET UNITYSDK_OFFSET(0x193BB0A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_CHECKREVOCATION_OFFSET UNITYSDK_OFFSET(0x193BAD70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_FINDCRL_OFFSET UNITYSDK_OFFSET(0x193BB310)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_FINDPARENT_OFFSET UNITYSDK_OFFSET(0x193B8BB0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GETAUTHORITYKEYIDENTIFIER_1_OFFSET UNITYSDK_OFFSET(0x193BACF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GETAUTHORITYKEYIDENTIFIER_2_OFFSET UNITYSDK_OFFSET(0x193BAB70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GETAUTHORITYKEYIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x193B9290)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GETSUBJECTKEYIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x193B9320)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CERTIFICATEAUTHORITIES_OFFSET UNITYSDK_OFFSET(0x193B8660)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CERTIFICATECOLLECTION_OFFSET UNITYSDK_OFFSET(0x193B8AA0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CHAINELEMENTS_OFFSET UNITYSDK_OFFSET(0x193B7190)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CHAINPOLICY_OFFSET UNITYSDK_OFFSET(0x193B71A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_CHAINSTATUS_OFFSET UNITYSDK_OFFSET(0x193B71C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x193B7180)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x193B7170)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_LMCASTORE_OFFSET UNITYSDK_OFFSET(0x193B8900)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_LMROOTSTORE_OFFSET UNITYSDK_OFFSET(0x193B8420)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_ROOTS_OFFSET UNITYSDK_OFFSET(0x193B8100)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_USERCASTORE_OFFSET UNITYSDK_OFFSET(0x193B89D0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_GET_USERROOTSTORE_OFFSET UNITYSDK_OFFSET(0x193B8540)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_ISCHAINCOMPLETE_OFFSET UNITYSDK_OFFSET(0x193B8D70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_ISSELFISSUED_OFFSET UNITYSDK_OFFSET(0x193B9430)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_ISSIGNEDWITH_OFFSET UNITYSDK_OFFSET(0x193BA8C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PREPAREFORNEXTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x193B9C60)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PROCESSCERTIFICATEEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x193BA910)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PROCESSCRLENTRYEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x193BB860)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PROCESSCRLEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x193BBC10)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_PROCESS_OFFSET UNITYSDK_OFFSET(0x193B95B0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_RESET_OFFSET UNITYSDK_OFFSET(0x193B7980)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_SELECTBESTFROMCOLLECTION_OFFSET UNITYSDK_OFFSET(0x193B8F90)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_SET_CHAINPOLICY_OFFSET UNITYSDK_OFFSET(0x193B71B0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_VALIDATECHAIN_OFFSET UNITYSDK_OFFSET(0x193B7EB0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO_WRAPUP_OFFSET UNITYSDK_OFFSET(0x193BA5C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO__CCTOR_OFFSET UNITYSDK_OFFSET(0x193BC4D0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193B7060)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO__CTOR_2_OFFSET UNITYSDK_OFFSET(0x193B7120)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPLMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x193B7050)
...
namespace System::Security::Cryptography::X509Certificates
{
	...
	public:
		...
		::System::Security::Cryptography::X509Certificates::X509ChainElement* bce_restriction; // 0x10
		::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* collection; // 0x18
		::System::Security::Cryptography::X509Certificates::X509Store* ca_store; // 0x20
		::System::Security::Cryptography::X509Certificates::X509Store* user_ca_store; // 0x28
		::System::Security::Cryptography::AsymmetricAlgorithm* working_public_key; // 0x30
		::System::Security::Cryptography::X509Certificates::X500DistinguishedName* working_issuer_name; // 0x38
		::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* elements; // 0x40
		::Il2CppArray<::System::Security::Cryptography::X509Certificates::X509ChainStatus>* status; // 0x48
		::System::Security::Cryptography::X509Certificates::X509Store* root_store; // 0x50
		::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* roots; // 0x58
		::System::Security::Cryptography::X509Certificates::X509ChainPolicy* policy; // 0x60
