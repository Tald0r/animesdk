...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPL_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18B88BE0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18B88B60)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPL_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18B88BF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPL_THROWIFCONTEXTINVALID_OFFSET UNITYSDK_OFFSET(0x18B88A80)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x18B88C00)
