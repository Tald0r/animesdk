...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_GET_APPLICATIONPOLICY_OFFSET UNITYSDK_OFFSET(0x191D8FD0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_GET_CERTIFICATEPOLICY_OFFSET UNITYSDK_OFFSET(0x191D8FE0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_GET_EXTRASTORE_OFFSET UNITYSDK_OFFSET(0x191D8FF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_GET_REVOCATIONFLAG_OFFSET UNITYSDK_OFFSET(0x191D9400)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_GET_REVOCATIONMODE_OFFSET UNITYSDK_OFFSET(0x191D9480)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_GET_URLRETRIEVALTIMEOUT_OFFSET UNITYSDK_OFFSET(0x191D9500)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_GET_VERIFICATIONFLAGS_OFFSET UNITYSDK_OFFSET(0x191D9520)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_GET_VERIFICATIONTIME_OFFSET UNITYSDK_OFFSET(0x191D95A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_RESET_OFFSET UNITYSDK_OFFSET(0x191D8CA0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_SET_EXTRASTORE_OFFSET UNITYSDK_OFFSET(0x191D93F0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_SET_REVOCATIONFLAG_OFFSET UNITYSDK_OFFSET(0x191D9410)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_SET_REVOCATIONMODE_OFFSET UNITYSDK_OFFSET(0x191D9490)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_SET_URLRETRIEVALTIMEOUT_OFFSET UNITYSDK_OFFSET(0x191D9510)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_SET_VERIFICATIONFLAGS_OFFSET UNITYSDK_OFFSET(0x191D9530)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY_SET_VERIFICATIONTIME_OFFSET UNITYSDK_OFFSET(0x191D95B0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191D8E30)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x191D8B10)
...
namespace System::Security::Cryptography::X509Certificates
{
	...
	public:
		...
		::System::Security::Cryptography::X509Certificates::X509RevocationMode mode; // 0x44
