...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_AREEQUAL_OFFSET UNITYSDK_OFFSET(0x1890D070)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_CANONIZE_OFFSET UNITYSDK_OFFSET(0x1890CDF0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_DECODERAWDATA_OFFSET UNITYSDK_OFFSET(0x1890C3E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_DECODE_OFFSET UNITYSDK_OFFSET(0x1890C8E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_FORMAT_OFFSET UNITYSDK_OFFSET(0x1890CD40)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_GETSEPARATOR_OFFSET UNITYSDK_OFFSET(0x1890CC90)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_GET_CANONICALENCODING_OFFSET UNITYSDK_OFFSET(0x1890CC70)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1890CC80)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1890C480)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1890C5A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1890C5B0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1890CA90)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1890CBA0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1890C330)
