...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509ENHANCEDKEYUSAGEEXTENSION_COPYFROM_OFFSET UNITYSDK_OFFSET(0x1946B350)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509ENHANCEDKEYUSAGEEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1946AA60)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509ENHANCEDKEYUSAGEEXTENSION_ENCODE_OFFSET UNITYSDK_OFFSET(0x1946AF50)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509ENHANCEDKEYUSAGEEXTENSION_GET_ENHANCEDKEYUSAGES_OFFSET UNITYSDK_OFFSET(0x1946B150)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509ENHANCEDKEYUSAGEEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1946B4C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509ENHANCEDKEYUSAGEEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1946A9E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509ENHANCEDKEYUSAGEEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1946AD20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509ENHANCEDKEYUSAGEEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1946A990)
