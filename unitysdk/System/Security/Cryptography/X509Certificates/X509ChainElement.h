...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_COUNT_OFFSET UNITYSDK_OFFSET(0x193B56A0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_GET_CERTIFICATE_OFFSET UNITYSDK_OFFSET(0x193B5650)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_GET_CHAINELEMENTSTATUS_OFFSET UNITYSDK_OFFSET(0x193B5660)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_GET_INFORMATION_OFFSET UNITYSDK_OFFSET(0x193B5670)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_GET_STATUSFLAGS_OFFSET UNITYSDK_OFFSET(0x193B5680)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_SET_OFFSET UNITYSDK_OFFSET(0x193B57D0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_SET_STATUSFLAGS_OFFSET UNITYSDK_OFFSET(0x193B5690)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT_UNCOMPRESSFLAGS_OFFSET UNITYSDK_OFFSET(0x193B5850)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193B6A50)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x193B5630)
