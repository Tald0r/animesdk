...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID_FROMFRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1890BFC0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID_FROMOIDVALUE_OFFSET UNITYSDK_OFFSET(0x1890C0C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID_GET_FRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1890C1E0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1890C1C0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID_SET_FRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1890C290)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1890C1D0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1890BDC0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1890BE50)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1890BF20)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1890BF30)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1890BFB0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_OID__CTOR_OFFSET UNITYSDK_OFFSET(0x1890BDB0)
