...
#define SYSTEM_SECURITY_CRYPTOGRAPHY_SHA1INTERNAL_ADDLENGTH_OFFSET UNITYSDK_OFFSET(0x197AB540)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_SHA1INTERNAL_FILLBUFF_OFFSET UNITYSDK_OFFSET(0x197AB320)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_SHA1INTERNAL_HASHCORE_OFFSET UNITYSDK_OFFSET(0x197A90F0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_SHA1INTERNAL_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x197AA280)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_SHA1INTERNAL_INITIALISEBUFF_OFFSET UNITYSDK_OFFSET(0x197AA7D0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_SHA1INTERNAL_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x197A9040)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_SHA1INTERNAL_PROCESSBLOCK_OFFSET UNITYSDK_OFFSET(0x197A91D0)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_SHA1INTERNAL_PROCESSFINALBLOCK_OFFSET UNITYSDK_OFFSET(0x197AA600)
#define SYSTEM_SECURITY_CRYPTOGRAPHY_SHA1INTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x197A8FE0)
