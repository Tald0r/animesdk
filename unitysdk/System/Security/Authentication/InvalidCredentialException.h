...
#define SYSTEM_SECURITY_AUTHENTICATION_INVALIDCREDENTIALEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F61F60)
#define SYSTEM_SECURITY_AUTHENTICATION_INVALIDCREDENTIALEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18F61FD0)
#define SYSTEM_SECURITY_AUTHENTICATION_INVALIDCREDENTIALEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18F62040)
#define SYSTEM_SECURITY_AUTHENTICATION_INVALIDCREDENTIALEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18F61EC0)
