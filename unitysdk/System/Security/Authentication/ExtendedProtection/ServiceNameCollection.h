...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_ADDIFNEW_OFFSET UNITYSDK_OFFSET(0x19250580)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x19251480)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x192510E0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_MATCH_OFFSET UNITYSDK_OFFSET(0x19251460)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_MERGE_1_OFFSET UNITYSDK_OFFSET(0x19250730)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_MERGE_OFFSET UNITYSDK_OFFSET(0x19250630)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_NORMALIZESERVICENAME_OFFSET UNITYSDK_OFFSET(0x19250B10)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x192501E0)
