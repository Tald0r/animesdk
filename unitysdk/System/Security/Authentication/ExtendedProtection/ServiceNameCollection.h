...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_ADDIFNEW_OFFSET UNITYSDK_OFFSET(0x18E4D2A0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x18E4E1A0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x18E4DE00)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_MATCH_OFFSET UNITYSDK_OFFSET(0x18E4E180)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_MERGE_1_OFFSET UNITYSDK_OFFSET(0x18E4D450)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_MERGE_OFFSET UNITYSDK_OFFSET(0x18E4D350)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION_NORMALIZESERVICENAME_OFFSET UNITYSDK_OFFSET(0x18E4D830)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_SERVICENAMECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18E4CF00)
