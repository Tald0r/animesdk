...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_BUILDPOLICY_OFFSET UNITYSDK_OFFSET(0x1938FA90)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_GET_CUSTOMSERVICENAMES_OFFSET UNITYSDK_OFFSET(0x1938F910)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_GET_POLICYENFORCEMENT_OFFSET UNITYSDK_OFFSET(0x1938F950)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1938F9D0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_GET_PROTECTIONSCENARIO_OFFSET UNITYSDK_OFFSET(0x1938FA10)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_SET_POLICYENFORCEMENT_OFFSET UNITYSDK_OFFSET(0x1938F990)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT_SET_PROTECTIONSCENARIO_OFFSET UNITYSDK_OFFSET(0x1938FA50)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_CONFIGURATION_EXTENDEDPROTECTIONPOLICYELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1938F8D0)
