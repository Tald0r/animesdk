...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICYTYPECONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x19FE4E70)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICYTYPECONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x19FE4EC0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICYTYPECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE4F10)
