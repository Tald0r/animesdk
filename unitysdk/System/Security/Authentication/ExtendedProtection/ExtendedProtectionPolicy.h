...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICY_GET_CUSTOMCHANNELBINDING_OFFSET UNITYSDK_OFFSET(0x18B87D60)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICY_GET_CUSTOMSERVICENAMES_OFFSET UNITYSDK_OFFSET(0x18B87DB0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICY_GET_OSSUPPORTSEXTENDEDPROTECTION_OFFSET UNITYSDK_OFFSET(0x18B87E00)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICY_GET_POLICYENFORCEMENT_OFFSET UNITYSDK_OFFSET(0x18B87E50)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICY_GET_PROTECTIONSCENARIO_OFFSET UNITYSDK_OFFSET(0x18B87EA0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICY_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18B87F30)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18B87EF0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B87C20)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18B87C70)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18B87CC0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICY__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18B87D10)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_EXTENDEDPROTECTIONPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x18B87C10)
