...
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING_GETRAWTOKENBINDINGID_OFFSET UNITYSDK_OFFSET(0x193B5500)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING_GET_BINDINGTYPE_OFFSET UNITYSDK_OFFSET(0x193B55D0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING_SET_BINDINGTYPE_OFFSET UNITYSDK_OFFSET(0x193B55E0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193B55F0)
#define SYSTEM_SECURITY_AUTHENTICATION_EXTENDEDPROTECTION_TOKENBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x193B54F0)
