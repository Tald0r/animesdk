...
#define SYSTEM_OBJECT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x192B8E30)
#define SYSTEM_OBJECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x192B8E20)
#define SYSTEM_OBJECT_FIELDGETTER_OFFSET UNITYSDK_OFFSET(0x192B8EF0)
#define SYSTEM_OBJECT_FIELDSETTER_OFFSET UNITYSDK_OFFSET(0x192B8F00)
#define SYSTEM_OBJECT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x192B8E70)
#define SYSTEM_OBJECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x192B8E80)
#define SYSTEM_OBJECT_GETTYPE_OFFSET UNITYSDK_OFFSET(0x192ACDD0)
#define SYSTEM_OBJECT_INTERNALGETHASHCODE_OFFSET UNITYSDK_OFFSET(0x192B8E90)
#define SYSTEM_OBJECT_MEMBERWISECLONE_OFFSET UNITYSDK_OFFSET(0x192AD000)
#define SYSTEM_OBJECT_REFERENCEEQUALS_OFFSET UNITYSDK_OFFSET(0x192B8EE0)
#define SYSTEM_OBJECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x192B8EA0)
#define SYSTEM_OBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1929FB50)
