...
#define SYSTEM_WEB_UTIL_HTTPENCODER_ENCODEHEADERSTRING_OFFSET UNITYSDK_OFFSET(0x193C0470)
#define SYSTEM_WEB_UTIL_HTTPENCODER_GETCUSTOMENCODERFROMCONFIG_OFFSET UNITYSDK_OFFSET(0x193C1C80)
#define SYSTEM_WEB_UTIL_HTTPENCODER_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x193BFF40)
#define SYSTEM_WEB_UTIL_HTTPENCODER_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x193C00E0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_GET_ENTITIES_OFFSET UNITYSDK_OFFSET(0x193BC9D0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HEADERNAMEVALUEENCODE_OFFSET UNITYSDK_OFFSET(0x193C03B0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HTMLATTRIBUTEENCODE_1_OFFSET UNITYSDK_OFFSET(0x193C07A0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HTMLATTRIBUTEENCODE_OFFSET UNITYSDK_OFFSET(0x193C06F0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HTMLDECODE_1_OFFSET UNITYSDK_OFFSET(0x193C0A40)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HTMLDECODE_OFFSET UNITYSDK_OFFSET(0x193C09A0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HTMLENCODE_1_OFFSET UNITYSDK_OFFSET(0x193C16E0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_HTMLENCODE_OFFSET UNITYSDK_OFFSET(0x193C1640)
#define SYSTEM_WEB_UTIL_HTTPENCODER_INITENTITIES_OFFSET UNITYSDK_OFFSET(0x193BCB50)
#define SYSTEM_WEB_UTIL_HTTPENCODER_JAVASCRIPTSTRINGENCODE_OFFSET UNITYSDK_OFFSET(0x193C2540)
#define SYSTEM_WEB_UTIL_HTTPENCODER_NOTENCODED_OFFSET UNITYSDK_OFFSET(0x193C2520)
#define SYSTEM_WEB_UTIL_HTTPENCODER_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x193C0050)
#define SYSTEM_WEB_UTIL_HTTPENCODER_STRINGBUILDERAPPEND_OFFSET UNITYSDK_OFFSET(0x193C0660)
#define SYSTEM_WEB_UTIL_HTTPENCODER_URLENCODECHAR_OFFSET UNITYSDK_OFFSET(0x193C2180)
#define SYSTEM_WEB_UTIL_HTTPENCODER_URLENCODETOBYTES_OFFSET UNITYSDK_OFFSET(0x193C1A90)
#define SYSTEM_WEB_UTIL_HTTPENCODER_URLENCODE_OFFSET UNITYSDK_OFFSET(0x193C1A20)
#define SYSTEM_WEB_UTIL_HTTPENCODER_URLPATHENCODECHAR_OFFSET UNITYSDK_OFFSET(0x193C1EE0)
#define SYSTEM_WEB_UTIL_HTTPENCODER_URLPATHENCODE_OFFSET UNITYSDK_OFFSET(0x193C1D00)
#define SYSTEM_WEB_UTIL_HTTPENCODER__CCTOR_OFFSET UNITYSDK_OFFSET(0x193C0160)
#define SYSTEM_WEB_UTIL_HTTPENCODER__CTOR_OFFSET UNITYSDK_OFFSET(0x193C03A0)
