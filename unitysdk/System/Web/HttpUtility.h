...
#define SYSTEM_WEB_HTTPUTILITY_GETCHARS_OFFSET UNITYSDK_OFFSET(0x19B367E0)
#define SYSTEM_WEB_HTTPUTILITY_GETCHAR_1_OFFSET UNITYSDK_OFFSET(0x19B36AD0)
#define SYSTEM_WEB_HTTPUTILITY_GETCHAR_OFFSET UNITYSDK_OFFSET(0x19B372E0)
#define SYSTEM_WEB_HTTPUTILITY_GETINT_OFFSET UNITYSDK_OFFSET(0x19B372B0)
#define SYSTEM_WEB_HTTPUTILITY_HTMLATTRIBUTEENCODE_1_OFFSET UNITYSDK_OFFSET(0x19B36090)
#define SYSTEM_WEB_HTTPUTILITY_HTMLATTRIBUTEENCODE_OFFSET UNITYSDK_OFFSET(0x19B35FE0)
#define SYSTEM_WEB_HTTPUTILITY_HTMLDECODE_1_OFFSET UNITYSDK_OFFSET(0x19B38450)
#define SYSTEM_WEB_HTTPUTILITY_HTMLDECODE_OFFSET UNITYSDK_OFFSET(0x19B382C0)
#define SYSTEM_WEB_HTTPUTILITY_HTMLENCODE_1_OFFSET UNITYSDK_OFFSET(0x19B386A0)
#define SYSTEM_WEB_HTTPUTILITY_HTMLENCODE_2_OFFSET UNITYSDK_OFFSET(0x19B38760)
#define SYSTEM_WEB_HTTPUTILITY_HTMLENCODE_OFFSET UNITYSDK_OFFSET(0x19B38510)
#define SYSTEM_WEB_HTTPUTILITY_JAVASCRIPTSTRINGENCODE_1_OFFSET UNITYSDK_OFFSET(0x19B387B0)
#define SYSTEM_WEB_HTTPUTILITY_JAVASCRIPTSTRINGENCODE_OFFSET UNITYSDK_OFFSET(0x19B387A0)
#define SYSTEM_WEB_HTTPUTILITY_PARSEQUERYSTRING_1_OFFSET UNITYSDK_OFFSET(0x19B38D10)
#define SYSTEM_WEB_HTTPUTILITY_PARSEQUERYSTRING_2_OFFSET UNITYSDK_OFFSET(0x19B38EE0)
#define SYSTEM_WEB_HTTPUTILITY_PARSEQUERYSTRING_OFFSET UNITYSDK_OFFSET(0x19B38C90)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODETOBYTES_1_OFFSET UNITYSDK_OFFSET(0x19B37660)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODETOBYTES_2_OFFSET UNITYSDK_OFFSET(0x19B376E0)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODETOBYTES_3_OFFSET UNITYSDK_OFFSET(0x19B373D0)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODETOBYTES_OFFSET UNITYSDK_OFFSET(0x19B373B0)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODE_1_OFFSET UNITYSDK_OFFSET(0x19B362A0)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODE_2_OFFSET UNITYSDK_OFFSET(0x19B36BB0)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODE_3_OFFSET UNITYSDK_OFFSET(0x19B36BD0)
#define SYSTEM_WEB_HTTPUTILITY_URLDECODE_OFFSET UNITYSDK_OFFSET(0x19B36220)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODETOBYTES_1_OFFSET UNITYSDK_OFFSET(0x19B37EC0)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODETOBYTES_2_OFFSET UNITYSDK_OFFSET(0x19B37FA0)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODETOBYTES_3_OFFSET UNITYSDK_OFFSET(0x19B37AE0)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODETOBYTES_OFFSET UNITYSDK_OFFSET(0x19B37E40)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODEUNICODETOBYTES_OFFSET UNITYSDK_OFFSET(0x19B38100)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODEUNICODE_OFFSET UNITYSDK_OFFSET(0x19B38050)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODE_1_OFFSET UNITYSDK_OFFSET(0x19B37800)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODE_2_OFFSET UNITYSDK_OFFSET(0x19B37B70)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODE_3_OFFSET UNITYSDK_OFFSET(0x19B37CD0)
#define SYSTEM_WEB_HTTPUTILITY_URLENCODE_OFFSET UNITYSDK_OFFSET(0x19B37780)
#define SYSTEM_WEB_HTTPUTILITY_URLPATHENCODE_OFFSET UNITYSDK_OFFSET(0x19B38C10)
#define SYSTEM_WEB_HTTPUTILITY_WRITECHARBYTES_OFFSET UNITYSDK_OFFSET(0x19B36850)
#define SYSTEM_WEB_HTTPUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19B35FD0)
