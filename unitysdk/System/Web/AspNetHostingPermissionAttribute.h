...
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x187FE6A0)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSIONATTRIBUTE_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x187FE620)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSIONATTRIBUTE_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x187FE660)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x187FE610)
