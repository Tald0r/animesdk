...
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x18264270)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSIONATTRIBUTE_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x182641F0)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSIONATTRIBUTE_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x18264230)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x182641E0)
