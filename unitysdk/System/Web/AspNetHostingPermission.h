...
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x18FD04B0)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x18FD04F0)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x18FD0430)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x18FD0530)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x18FD0570)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x18FD05B0)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x18FD0470)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x18FD05F0)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FD03F0)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD03B0)
