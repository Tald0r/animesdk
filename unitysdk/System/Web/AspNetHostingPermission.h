...
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x193BC850)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x193BC890)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x193BC7D0)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x193BC8D0)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x193BC910)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x193BC950)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x193BC810)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x193BC990)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193BC790)
#define SYSTEM_WEB_ASPNETHOSTINGPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x193BC750)
