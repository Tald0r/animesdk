...
#define SYSTEM_ACTIVATOR_CREATEINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1857CD20)
#define SYSTEM_ACTIVATOR_CREATEINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x1857CE90)
#define SYSTEM_ACTIVATOR_CREATEINSTANCE_3_OFFSET UNITYSDK_OFFSET(0x1857CEC0)
#define SYSTEM_ACTIVATOR_CREATEINSTANCE_4_OFFSET UNITYSDK_OFFSET(0x1857CEF0)
#define SYSTEM_ACTIVATOR_CREATEINSTANCE_5_OFFSET UNITYSDK_OFFSET(0x1857CF00)
#define SYSTEM_ACTIVATOR_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1857CCF0)
#define SYSTEM_ACTIVATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1857CCE0)
