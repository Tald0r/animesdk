...
#define SYSTEM_DATA_DATAVIEWMANAGER_ADD_LISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A170840)
#define SYSTEM_DATA_DATAVIEWMANAGER_CREATEDATAVIEW_OFFSET UNITYSDK_OFFSET(0x1A170C70)
#define SYSTEM_DATA_DATAVIEWMANAGER_ONLISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A170D20)
#define SYSTEM_DATA_DATAVIEWMANAGER_RELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A171020)
#define SYSTEM_DATA_DATAVIEWMANAGER_REMOVE_LISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A1708C0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1A170430)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A1703E0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1A170400)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1A1703F0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A170200)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_ADD_OFFSET UNITYSDK_OFFSET(0x1A1704F0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A170540)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A170590)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1A170420)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1A170410)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A170490)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A1705A0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_INSERT_OFFSET UNITYSDK_OFFSET(0x1A1705B0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1A170650)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A170600)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A1704A0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_ADDINDEX_OFFSET UNITYSDK_OFFSET(0x1A170940)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_ADDNEW_OFFSET UNITYSDK_OFFSET(0x1A1706B0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_APPLYSORT_OFFSET UNITYSDK_OFFSET(0x1A170950)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_FIND_OFFSET UNITYSDK_OFFSET(0x1A1709A0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWEDIT_OFFSET UNITYSDK_OFFSET(0x1A170700)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWNEW_OFFSET UNITYSDK_OFFSET(0x1A1706A0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWREMOVE_OFFSET UNITYSDK_OFFSET(0x1A170710)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ISSORTED_OFFSET UNITYSDK_OFFSET(0x1A170750)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A1707F0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SORTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A1707A0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSCHANGENOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1A170720)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSSEARCHING_OFFSET UNITYSDK_OFFSET(0x1A170730)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSSORTING_OFFSET UNITYSDK_OFFSET(0x1A170740)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_REMOVEINDEX_OFFSET UNITYSDK_OFFSET(0x1A1709F0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_REMOVESORT_OFFSET UNITYSDK_OFFSET(0x1A170A00)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_ITYPEDLIST_GETITEMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A170AE0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_ITYPEDLIST_GETLISTNAME_OFFSET UNITYSDK_OFFSET(0x1A170A50)
#define SYSTEM_DATA_DATAVIEWMANAGER_TABLECOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A170E40)
#define SYSTEM_DATA_DATAVIEWMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A171210)
#define SYSTEM_DATA_DATAVIEWMANAGER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A16FF30)
#define SYSTEM_DATA_DATAVIEWMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A16FF20)

namespace System::Data
{
	inline static constexpr unsigned int DataViewManager_TypeDefinitionIndex = 36458;
	...
	public:
		...
		{
			return (::System::NotSupportedException**)Il2CppClass::FromTypeDefinitionIndex(DataViewManager_TypeDefinitionIndex)->GetStaticField(0x26A70);
		}
