...
#define SYSTEM_DATA_DATAVIEWMANAGER_ADD_LISTCHANGED_OFFSET UNITYSDK_OFFSET(0x19B8C080)
#define SYSTEM_DATA_DATAVIEWMANAGER_CREATEDATAVIEW_OFFSET UNITYSDK_OFFSET(0x19B8C4B0)
#define SYSTEM_DATA_DATAVIEWMANAGER_ONLISTCHANGED_OFFSET UNITYSDK_OFFSET(0x19B8C560)
#define SYSTEM_DATA_DATAVIEWMANAGER_RELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x19B8C860)
#define SYSTEM_DATA_DATAVIEWMANAGER_REMOVE_LISTCHANGED_OFFSET UNITYSDK_OFFSET(0x19B8C100)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x19B8BC70)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19B8BC20)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19B8BC40)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x19B8BC30)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19B8BA40)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_ADD_OFFSET UNITYSDK_OFFSET(0x19B8BD30)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x19B8BD80)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x19B8BDD0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x19B8BC60)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x19B8BC50)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19B8BCD0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x19B8BDE0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_INSERT_OFFSET UNITYSDK_OFFSET(0x19B8BDF0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x19B8BE90)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x19B8BE40)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COLLECTIONS_ILIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19B8BCE0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_ADDINDEX_OFFSET UNITYSDK_OFFSET(0x19B8C180)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_ADDNEW_OFFSET UNITYSDK_OFFSET(0x19B8BEF0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_APPLYSORT_OFFSET UNITYSDK_OFFSET(0x19B8C190)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_FIND_OFFSET UNITYSDK_OFFSET(0x19B8C1E0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWEDIT_OFFSET UNITYSDK_OFFSET(0x19B8BF40)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWNEW_OFFSET UNITYSDK_OFFSET(0x19B8BEE0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWREMOVE_OFFSET UNITYSDK_OFFSET(0x19B8BF50)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ISSORTED_OFFSET UNITYSDK_OFFSET(0x19B8BF90)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x19B8C030)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SORTPROPERTY_OFFSET UNITYSDK_OFFSET(0x19B8BFE0)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSCHANGENOTIFICATION_OFFSET UNITYSDK_OFFSET(0x19B8BF60)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSSEARCHING_OFFSET UNITYSDK_OFFSET(0x19B8BF70)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSSORTING_OFFSET UNITYSDK_OFFSET(0x19B8BF80)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_REMOVEINDEX_OFFSET UNITYSDK_OFFSET(0x19B8C230)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_IBINDINGLIST_REMOVESORT_OFFSET UNITYSDK_OFFSET(0x19B8C240)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_ITYPEDLIST_GETITEMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19B8C320)
#define SYSTEM_DATA_DATAVIEWMANAGER_SYSTEM_COMPONENTMODEL_ITYPEDLIST_GETLISTNAME_OFFSET UNITYSDK_OFFSET(0x19B8C290)
#define SYSTEM_DATA_DATAVIEWMANAGER_TABLECOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x19B8C680)
#define SYSTEM_DATA_DATAVIEWMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B8CA50)
#define SYSTEM_DATA_DATAVIEWMANAGER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B8B770)
#define SYSTEM_DATA_DATAVIEWMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B8B760)

namespace System::Data
{
	inline static constexpr unsigned int DataViewManager_TypeDefinitionIndex = 35438;
	...
	public:
		...
		{
			return (::System::NotSupportedException**)Il2CppClass::FromTypeDefinitionIndex(DataViewManager_TypeDefinitionIndex)->GetStaticField(0x25040);
		}
