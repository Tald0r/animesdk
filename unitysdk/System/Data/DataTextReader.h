...
#define SYSTEM_DATA_DATATEXTREADER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A6B5950)
#define SYSTEM_DATA_DATATEXTREADER_CREATEREADER_OFFSET UNITYSDK_OFFSET(0x1A6B5380)
#define SYSTEM_DATA_DATATEXTREADER_GETATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1A6B5770)
#define SYSTEM_DATA_DATATEXTREADER_GETATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x1A6B57A0)
#define SYSTEM_DATA_DATATEXTREADER_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A6B5740)
#define SYSTEM_DATA_DATATEXTREADER_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x1A6B5710)
#define SYSTEM_DATA_DATATEXTREADER_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x1A6B55F0)
#define SYSTEM_DATA_DATATEXTREADER_GET_CANREADVALUECHUNK_OFFSET UNITYSDK_OFFSET(0x1A6B5AA0)
#define SYSTEM_DATA_DATATEXTREADER_GET_CANRESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1A6B5A40)
#define SYSTEM_DATA_DATATEXTREADER_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1A6B55C0)
#define SYSTEM_DATA_DATATEXTREADER_GET_EOF_OFFSET UNITYSDK_OFFSET(0x1A6B5920)
#define SYSTEM_DATA_DATATEXTREADER_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x1A6B5650)
#define SYSTEM_DATA_DATATEXTREADER_GET_ISEMPTYELEMENT_OFFSET UNITYSDK_OFFSET(0x1A6B5620)
#define SYSTEM_DATA_DATATEXTREADER_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1A6B5500)
#define SYSTEM_DATA_DATATEXTREADER_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1A6B5530)
#define SYSTEM_DATA_DATATEXTREADER_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x1A6B59E0)
#define SYSTEM_DATA_DATATEXTREADER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A6B54D0)
#define SYSTEM_DATA_DATATEXTREADER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1A6B54A0)
#define SYSTEM_DATA_DATATEXTREADER_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1A6B5560)
#define SYSTEM_DATA_DATATEXTREADER_GET_QUOTECHAR_OFFSET UNITYSDK_OFFSET(0x1A6B5680)
#define SYSTEM_DATA_DATATEXTREADER_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1A6B5980)
#define SYSTEM_DATA_DATATEXTREADER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1A6B5470)
#define SYSTEM_DATA_DATATEXTREADER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A6B5590)
#define SYSTEM_DATA_DATATEXTREADER_GET_XMLLANG_OFFSET UNITYSDK_OFFSET(0x1A6B56E0)
#define SYSTEM_DATA_DATATEXTREADER_GET_XMLSPACE_OFFSET UNITYSDK_OFFSET(0x1A6B56B0)
#define SYSTEM_DATA_DATATEXTREADER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A6B5A10)
#define SYSTEM_DATA_DATATEXTREADER_MOVETOATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1A6B5800)
#define SYSTEM_DATA_DATATEXTREADER_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A6B57D0)
#define SYSTEM_DATA_DATATEXTREADER_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x1A6B5890)
#define SYSTEM_DATA_DATATEXTREADER_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A6B5830)
#define SYSTEM_DATA_DATATEXTREADER_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A6B5860)
#define SYSTEM_DATA_DATATEXTREADER_READATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1A6B58C0)
#define SYSTEM_DATA_DATATEXTREADER_READSTRING_OFFSET UNITYSDK_OFFSET(0x1A6B5AD0)
#define SYSTEM_DATA_DATATEXTREADER_READ_OFFSET UNITYSDK_OFFSET(0x1A6B58F0)
#define SYSTEM_DATA_DATATEXTREADER_RESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1A6B5A70)
#define SYSTEM_DATA_DATATEXTREADER_SKIP_OFFSET UNITYSDK_OFFSET(0x1A6B59B0)
#define SYSTEM_DATA_DATATEXTREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B5410)

namespace System::Data
{
	inline static constexpr unsigned int DataTextReader_TypeDefinitionIndex = 36546;
