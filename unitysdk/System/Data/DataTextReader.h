...
#define SYSTEM_DATA_DATATEXTREADER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A135A10)
#define SYSTEM_DATA_DATATEXTREADER_CREATEREADER_OFFSET UNITYSDK_OFFSET(0x1A135440)
#define SYSTEM_DATA_DATATEXTREADER_GETATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1A135830)
#define SYSTEM_DATA_DATATEXTREADER_GETATTRIBUTE_2_OFFSET UNITYSDK_OFFSET(0x1A135860)
#define SYSTEM_DATA_DATATEXTREADER_GETATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A135800)
#define SYSTEM_DATA_DATATEXTREADER_GET_ATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x1A1357D0)
#define SYSTEM_DATA_DATATEXTREADER_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x1A1356B0)
#define SYSTEM_DATA_DATATEXTREADER_GET_CANREADVALUECHUNK_OFFSET UNITYSDK_OFFSET(0x1A135B60)
#define SYSTEM_DATA_DATATEXTREADER_GET_CANRESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1A135B00)
#define SYSTEM_DATA_DATATEXTREADER_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1A135680)
#define SYSTEM_DATA_DATATEXTREADER_GET_EOF_OFFSET UNITYSDK_OFFSET(0x1A1359E0)
#define SYSTEM_DATA_DATATEXTREADER_GET_ISDEFAULT_OFFSET UNITYSDK_OFFSET(0x1A135710)
#define SYSTEM_DATA_DATATEXTREADER_GET_ISEMPTYELEMENT_OFFSET UNITYSDK_OFFSET(0x1A1356E0)
#define SYSTEM_DATA_DATATEXTREADER_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x1A1355C0)
#define SYSTEM_DATA_DATATEXTREADER_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x1A1355F0)
#define SYSTEM_DATA_DATATEXTREADER_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x1A135AA0)
#define SYSTEM_DATA_DATATEXTREADER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A135590)
#define SYSTEM_DATA_DATATEXTREADER_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1A135560)
#define SYSTEM_DATA_DATATEXTREADER_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1A135620)
#define SYSTEM_DATA_DATATEXTREADER_GET_QUOTECHAR_OFFSET UNITYSDK_OFFSET(0x1A135740)
#define SYSTEM_DATA_DATATEXTREADER_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1A135A40)
#define SYSTEM_DATA_DATATEXTREADER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1A135530)
#define SYSTEM_DATA_DATATEXTREADER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A135650)
#define SYSTEM_DATA_DATATEXTREADER_GET_XMLLANG_OFFSET UNITYSDK_OFFSET(0x1A1357A0)
#define SYSTEM_DATA_DATATEXTREADER_GET_XMLSPACE_OFFSET UNITYSDK_OFFSET(0x1A135770)
#define SYSTEM_DATA_DATATEXTREADER_LOOKUPNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A135AD0)
#define SYSTEM_DATA_DATATEXTREADER_MOVETOATTRIBUTE_1_OFFSET UNITYSDK_OFFSET(0x1A1358C0)
#define SYSTEM_DATA_DATATEXTREADER_MOVETOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A135890)
#define SYSTEM_DATA_DATATEXTREADER_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x1A135950)
#define SYSTEM_DATA_DATATEXTREADER_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A1358F0)
#define SYSTEM_DATA_DATATEXTREADER_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A135920)
#define SYSTEM_DATA_DATATEXTREADER_READATTRIBUTEVALUE_OFFSET UNITYSDK_OFFSET(0x1A135980)
#define SYSTEM_DATA_DATATEXTREADER_READSTRING_OFFSET UNITYSDK_OFFSET(0x1A135B90)
#define SYSTEM_DATA_DATATEXTREADER_READ_OFFSET UNITYSDK_OFFSET(0x1A1359B0)
#define SYSTEM_DATA_DATATEXTREADER_RESOLVEENTITY_OFFSET UNITYSDK_OFFSET(0x1A135B30)
#define SYSTEM_DATA_DATATEXTREADER_SKIP_OFFSET UNITYSDK_OFFSET(0x1A135A70)
#define SYSTEM_DATA_DATATEXTREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1354D0)

namespace System::Data
{
	inline static constexpr unsigned int DataTextReader_TypeDefinitionIndex = 35526;
