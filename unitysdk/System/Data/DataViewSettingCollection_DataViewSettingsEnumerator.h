...
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_DATAVIEWSETTINGSENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A881DA0)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_DATAVIEWSETTINGSENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A881C40)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_DATAVIEWSETTINGSENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A881CF0)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_DATAVIEWSETTINGSENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A881AA0)

namespace System::Data
{
	inline static constexpr unsigned int DataViewSettingCollection_DataViewSettingsEnumerator_TypeDefinitionIndex = 35443;
