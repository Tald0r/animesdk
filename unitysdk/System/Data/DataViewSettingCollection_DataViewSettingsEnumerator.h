...
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_DATAVIEWSETTINGSENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AE4C740)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_DATAVIEWSETTINGSENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AE4C5E0)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_DATAVIEWSETTINGSENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AE4C690)
#define SYSTEM_DATA_DATAVIEWSETTINGCOLLECTION_DATAVIEWSETTINGSENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4C440)

namespace System::Data
{
	inline static constexpr unsigned int DataViewSettingCollection_DataViewSettingsEnumerator_TypeDefinitionIndex = 36463;
