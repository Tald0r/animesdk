...
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_BOUNDARYCHECK_OFFSET UNITYSDK_OFFSET(0x1A3D4320)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3D40B0)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_GET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x1A3D41A0)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_GET_SEED_OFFSET UNITYSDK_OFFSET(0x1A3D41D0)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_GET_STEP_OFFSET UNITYSDK_OFFSET(0x1A3D44D0)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_MOVEAFTER_OFFSET UNITYSDK_OFFSET(0x1A3D4780)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_SETCURRENTANDINCREMENT_OFFSET UNITYSDK_OFFSET(0x1A3D4840)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_SETCURRENT_OFFSET UNITYSDK_OFFSET(0x1A3D4810)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3D4100)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_SET_SEED_OFFSET UNITYSDK_OFFSET(0x1A3D41E0)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER_SET_STEP_OFFSET UNITYSDK_OFFSET(0x1A3D4530)
#define SYSTEM_DATA_AUTOINCREMENTBIGINTEGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3D4970)

namespace System::Data
{
	inline static constexpr unsigned int AutoIncrementBigInteger_TypeDefinitionIndex = 35386;
