...
#define SYSTEM_DATA_OPERATORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AADFA90)

namespace System::Data
{
	inline static constexpr unsigned int OperatorInfo_TypeDefinitionIndex = 35458;
