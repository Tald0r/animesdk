...
#define SYSTEM_DATA_MERGEFAILEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7BFD00)

namespace System::Data
{
	inline static constexpr unsigned int MergeFailedEventArgs_TypeDefinitionIndex = 35474;
