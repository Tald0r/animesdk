...
#define SYSTEM_DATA_UNIQUECONSTRAINT_CANBEREMOVEDFROMCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1A144AF0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CANENABLECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A144FE0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CHECKCANADDTOCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1A144AE0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CHECKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A145350)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CHECKSTATE_OFFSET UNITYSDK_OFFSET(0x1A144AC0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CLONE_1_OFFSET UNITYSDK_OFFSET(0x1A1455A0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CLONE_2_OFFSET UNITYSDK_OFFSET(0x1A145EE0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CLONE_OFFSET UNITYSDK_OFFSET(0x1A145590)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CONSTRAINTINDEXCLEAR_OFFSET UNITYSDK_OFFSET(0x1A144A50)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CONSTRAINTINDEXINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A144A80)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CONTAINSCOLUMN_OFFSET UNITYSDK_OFFSET(0x1A145520)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CREATE_OFFSET UNITYSDK_OFFSET(0x1A1445E0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A144EA0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A146680)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_COLUMNNAMES_OFFSET UNITYSDK_OFFSET(0x1A144A40)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_COLUMNSREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A145510)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_COLUMNS_OFFSET UNITYSDK_OFFSET(0x1A146610)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_ISPRIMARYKEY_OFFSET UNITYSDK_OFFSET(0x1A146620)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_TABLE_OFFSET UNITYSDK_OFFSET(0x1A144F90)
#define SYSTEM_DATA_UNIQUECONSTRAINT_ISCONSTRAINTVIOLATED_OFFSET UNITYSDK_OFFSET(0x1A145080)
#define SYSTEM_DATA_UNIQUECONSTRAINT_NONVIRTUALCHECKSTATE_OFFSET UNITYSDK_OFFSET(0x1A144AD0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_SET_INCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1A146690)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1446C0)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A1447A0)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A1447C0)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A1447E0)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1A144810)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1A144900)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1A1449F0)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_8_OFFSET UNITYSDK_OFFSET(0x1A144A10)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1444F0)

namespace System::Data
{
	inline static constexpr unsigned int UniqueConstraint_TypeDefinitionIndex = 35505;

	class UniqueConstraint : public ::System::Data::Constraint
	{
	public:
		::Il2CppArray<::System::String*>* _columnNames; // 0x38
