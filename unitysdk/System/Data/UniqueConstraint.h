...
#define SYSTEM_DATA_UNIQUECONSTRAINT_CANBEREMOVEDFROMCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1A6C4AE0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CANENABLECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A6C4FD0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CHECKCANADDTOCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1A6C4AD0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CHECKCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A6C5340)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CHECKSTATE_OFFSET UNITYSDK_OFFSET(0x1A6C4AB0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CLONE_1_OFFSET UNITYSDK_OFFSET(0x1A6C5590)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CLONE_2_OFFSET UNITYSDK_OFFSET(0x1A6C5ED0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CLONE_OFFSET UNITYSDK_OFFSET(0x1A6C5580)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CONSTRAINTINDEXCLEAR_OFFSET UNITYSDK_OFFSET(0x1A6C4A40)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CONSTRAINTINDEXINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A6C4A70)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CONTAINSCOLUMN_OFFSET UNITYSDK_OFFSET(0x1A6C5510)
#define SYSTEM_DATA_UNIQUECONSTRAINT_CREATE_OFFSET UNITYSDK_OFFSET(0x1A6C45D0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A6C4E90)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A6C6670)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_COLUMNNAMES_OFFSET UNITYSDK_OFFSET(0x1A6C4A30)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_COLUMNSREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A6C5500)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_COLUMNS_OFFSET UNITYSDK_OFFSET(0x1A6C6600)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_ISPRIMARYKEY_OFFSET UNITYSDK_OFFSET(0x1A6C6610)
#define SYSTEM_DATA_UNIQUECONSTRAINT_GET_TABLE_OFFSET UNITYSDK_OFFSET(0x1A6C4F80)
#define SYSTEM_DATA_UNIQUECONSTRAINT_ISCONSTRAINTVIOLATED_OFFSET UNITYSDK_OFFSET(0x1A6C5070)
#define SYSTEM_DATA_UNIQUECONSTRAINT_NONVIRTUALCHECKSTATE_OFFSET UNITYSDK_OFFSET(0x1A6C4AC0)
#define SYSTEM_DATA_UNIQUECONSTRAINT_SET_INCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1A6C6680)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6C46B0)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A6C4790)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A6C47B0)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A6C47D0)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1A6C4800)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1A6C48F0)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1A6C49E0)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_8_OFFSET UNITYSDK_OFFSET(0x1A6C4A00)
#define SYSTEM_DATA_UNIQUECONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6C44E0)

namespace System::Data
{
	inline static constexpr unsigned int UniqueConstraint_TypeDefinitionIndex = 36525;
	...
	public:
		...
		::System::String* _constraintName; // 0x48
		::Il2CppArray<::System::String*>* _columnNames; // 0x50
