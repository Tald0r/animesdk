...
#define SYSTEM_DATA_DATACOLUMNPROPERTYDESCRIPTOR_CANRESETVALUE_OFFSET UNITYSDK_OFFSET(0x1B2543F0)
#define SYSTEM_DATA_DATACOLUMNPROPERTYDESCRIPTOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B254360)
#define SYSTEM_DATA_DATACOLUMNPROPERTYDESCRIPTOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B2543C0)
#define SYSTEM_DATA_DATACOLUMNPROPERTYDESCRIPTOR_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1B2545B0)
#define SYSTEM_DATA_DATACOLUMNPROPERTYDESCRIPTOR_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B254080)
#define SYSTEM_DATA_DATACOLUMNPROPERTYDESCRIPTOR_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B254300)
#define SYSTEM_DATA_DATACOLUMNPROPERTYDESCRIPTOR_GET_ISBROWSABLE_OFFSET UNITYSDK_OFFSET(0x1B254810)
#define SYSTEM_DATA_DATACOLUMNPROPERTYDESCRIPTOR_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1B254330)
#define SYSTEM_DATA_DATACOLUMNPROPERTYDESCRIPTOR_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1B2542E0)
#define SYSTEM_DATA_DATACOLUMNPROPERTYDESCRIPTOR_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x1B254630)
#define SYSTEM_DATA_DATACOLUMNPROPERTYDESCRIPTOR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1B2546F0)
#define SYSTEM_DATA_DATACOLUMNPROPERTYDESCRIPTOR_SHOULDSERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x1B254800)
#define SYSTEM_DATA_DATACOLUMNPROPERTYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B254040)

namespace System::Data
{
	inline static constexpr unsigned int DataColumnPropertyDescriptor_TypeDefinitionIndex = 36410;
