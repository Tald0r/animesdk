...
#define SYSTEM_DATA_DATAERROR_CLEAR_1_OFFSET UNITYSDK_OFFSET(0x1AA78700)
#define SYSTEM_DATA_DATAERROR_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AA78460)
#define SYSTEM_DATA_DATAERROR_GETCOLUMNERROR_OFFSET UNITYSDK_OFFSET(0x1AA786A0)
#define SYSTEM_DATA_DATAERROR_GETCOLUMNSINERROR_OFFSET UNITYSDK_OFFSET(0x1AA78790)
#define SYSTEM_DATA_DATAERROR_GET_HASERRORS_OFFSET UNITYSDK_OFFSET(0x1AA78360)
#define SYSTEM_DATA_DATAERROR_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1AA78560)
#define SYSTEM_DATA_DATAERROR_SETCOLUMNERROR_OFFSET UNITYSDK_OFFSET(0x1AA78390)
#define SYSTEM_DATA_DATAERROR_SETTEXT_OFFSET UNITYSDK_OFFSET(0x1AA78320)
#define SYSTEM_DATA_DATAERROR_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1AA78340)
#define SYSTEM_DATA_DATAERROR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AA78300)
#define SYSTEM_DATA_DATAERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA782F0)

namespace System::Data
{
	inline static constexpr unsigned int DataError_TypeDefinitionIndex = 36411;
