...
#define SYSTEM_DATA_DATAERROR_CLEAR_1_OFFSET UNITYSDK_OFFSET(0x1A4C6130)
#define SYSTEM_DATA_DATAERROR_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A4C5E90)
#define SYSTEM_DATA_DATAERROR_GETCOLUMNERROR_OFFSET UNITYSDK_OFFSET(0x1A4C60D0)
#define SYSTEM_DATA_DATAERROR_GETCOLUMNSINERROR_OFFSET UNITYSDK_OFFSET(0x1A4C61C0)
#define SYSTEM_DATA_DATAERROR_GET_HASERRORS_OFFSET UNITYSDK_OFFSET(0x1A4C5D90)
#define SYSTEM_DATA_DATAERROR_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A4C5F90)
#define SYSTEM_DATA_DATAERROR_SETCOLUMNERROR_OFFSET UNITYSDK_OFFSET(0x1A4C5DC0)
#define SYSTEM_DATA_DATAERROR_SETTEXT_OFFSET UNITYSDK_OFFSET(0x1A4C5D50)
#define SYSTEM_DATA_DATAERROR_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1A4C5D70)
#define SYSTEM_DATA_DATAERROR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4C5D30)
#define SYSTEM_DATA_DATAERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4C5D20)

namespace System::Data
{
	inline static constexpr unsigned int DataError_TypeDefinitionIndex = 35391;
