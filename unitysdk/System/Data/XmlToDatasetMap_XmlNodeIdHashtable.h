...
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1A174610)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_2_OFFSET UNITYSDK_OFFSET(0x1A174680)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_3_OFFSET UNITYSDK_OFFSET(0x1A174760)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A1745A0)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A174530)

namespace System::Data
{
	inline static constexpr unsigned int XmlToDatasetMap_XmlNodeIdHashtable_TypeDefinitionIndex = 36538;
