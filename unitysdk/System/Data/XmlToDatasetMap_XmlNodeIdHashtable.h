...
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x19B8FE50)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_2_OFFSET UNITYSDK_OFFSET(0x19B8FEC0)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_3_OFFSET UNITYSDK_OFFSET(0x19B8FFB0)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19B8FDE0)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDHASHTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B8FD70)

namespace System::Data
{
	inline static constexpr unsigned int XmlToDatasetMap_XmlNodeIdHashtable_TypeDefinitionIndex = 35518;
