...
#define SYSTEM_DATA_SQLTYPES_SQLINT32_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x9879C0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_COMPARETO_OFFSET UNITYSDK_OFFSET(0x9879B0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_EQUALS_OFFSET UNITYSDK_OFFSET(0x9879D0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9879E0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_GETXSDTYPE_OFFSET UNITYSDK_OFFSET(0x1B120430)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x3602B0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x987770)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1B11FBE0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1B11FB20)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1B11F380)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1B11F690)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B11F9D0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1B11F8E0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1B11FAB0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B11F7C0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1B11F850)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B11F2C0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1B11FA40)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B11F580)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1B11F480)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1B11F310)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_SAMESIGNINT_OFFSET UNITYSDK_OFFSET(0x1B11F470)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x987A50)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x987A60)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_TOSQLDOUBLE_OFFSET UNITYSDK_OFFSET(0x987810)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_TOSQLINT64_OFFSET UNITYSDK_OFFSET(0x987890)
#define SYSTEM_DATA_SQLTYPES_SQLINT32_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9877D0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1204B0)
#define SYSTEM_DATA_SQLTYPES_SQLINT32__CTOR_1_OFFSET UNITYSDK_OFFSET(0x987760)
#define SYSTEM_DATA_SQLTYPES_SQLINT32__CTOR_OFFSET UNITYSDK_OFFSET(0x915780)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlInt32_TypeDefinitionIndex = 36560;

	struct alignas(4) SqlInt32
	{
		static ::System::Data::SqlTypes::SqlInt32* StaticGet_MaxValue()
		{
			return (::System::Data::SqlTypes::SqlInt32*)Il2CppClass::FromTypeDefinitionIndex(SqlInt32_TypeDefinitionIndex)->GetStaticField(0x8B00);
		}
		static ::System::Data::SqlTypes::SqlInt32* StaticGet_Zero()
		{
			return (::System::Data::SqlTypes::SqlInt32*)Il2CppClass::FromTypeDefinitionIndex(SqlInt32_TypeDefinitionIndex)->GetStaticField(0x8B08);
		}
		static ::System::Int64* StaticGet_s_iIntMin()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt32_TypeDefinitionIndex)->GetStaticField(0x8B10);
		}
		static ::System::Data::SqlTypes::SqlInt32* StaticGet_MinValue()
		{
			return (::System::Data::SqlTypes::SqlInt32*)Il2CppClass::FromTypeDefinitionIndex(SqlInt32_TypeDefinitionIndex)->GetStaticField(0x8B18);
		}
		static ::System::Data::SqlTypes::SqlInt32* StaticGet_Null()
		{
			return (::System::Data::SqlTypes::SqlInt32*)Il2CppClass::FromTypeDefinitionIndex(SqlInt32_TypeDefinitionIndex)->GetStaticField(0x8B20);
		}
		static ::System::Int64* StaticGet_s_lBitNotIntMax()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt32_TypeDefinitionIndex)->GetStaticField(0x8B28);
		}
