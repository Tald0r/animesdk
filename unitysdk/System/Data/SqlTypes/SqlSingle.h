...
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x9159F0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x9159E0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x915A00)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x915A10)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_GETXSDTYPE_OFFSET UNITYSDK_OFFSET(0x1A174430)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x3602B0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x9158B0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A173CA0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A173BE0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1A172C80)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1A173040)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A173A60)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1A173920)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A173B60)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A1731C0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1A1732C0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1A1733C0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1A1734F0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_IMPLICIT_5_OFFSET UNITYSDK_OFFSET(0x1A173630)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_IMPLICIT_6_OFFSET UNITYSDK_OFFSET(0x1A1737D0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A172AD0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A173AE0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A172F00)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1A172DC0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1A172BA0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x915A90)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x915AA0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_TOSQLDOUBLE_OFFSET UNITYSDK_OFFSET(0x915960)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x915910)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1744B0)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x915790)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x915820)
#define SYSTEM_DATA_SQLTYPES_SQLSINGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x915780)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlSingle_TypeDefinitionIndex = 36563;

	struct alignas(4) SqlSingle
	{
		static ::System::Data::SqlTypes::SqlSingle* StaticGet_MaxValue()
		{
			return (::System::Data::SqlTypes::SqlSingle*)Il2CppClass::FromTypeDefinitionIndex(SqlSingle_TypeDefinitionIndex)->GetStaticField(0x8B70);
		}
		static ::System::Data::SqlTypes::SqlSingle* StaticGet_Zero()
		{
			return (::System::Data::SqlTypes::SqlSingle*)Il2CppClass::FromTypeDefinitionIndex(SqlSingle_TypeDefinitionIndex)->GetStaticField(0x8B78);
		}
		static ::System::Data::SqlTypes::SqlSingle* StaticGet_MinValue()
		{
			return (::System::Data::SqlTypes::SqlSingle*)Il2CppClass::FromTypeDefinitionIndex(SqlSingle_TypeDefinitionIndex)->GetStaticField(0x8B80);
		}
		static ::System::Data::SqlTypes::SqlSingle* StaticGet_Null()
		{
			return (::System::Data::SqlTypes::SqlSingle*)Il2CppClass::FromTypeDefinitionIndex(SqlSingle_TypeDefinitionIndex)->GetStaticField(0x8B88);
		}
