...
#define SYSTEM_DATA_SQLTYPES_SQLTRUNCATEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5DACF0)
#define SYSTEM_DATA_SQLTYPES_SQLTRUNCATEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5DAC40)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlTruncateException_TypeDefinitionIndex = 35549;
