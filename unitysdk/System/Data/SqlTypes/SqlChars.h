...
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_COPYSTREAMTOBUFFER_OFFSET UNITYSDK_OFFSET(0x1A473810)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_FSTREAM_OFFSET UNITYSDK_OFFSET(0x1A473800)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_GETXSDTYPE_OFFSET UNITYSDK_OFFSET(0x1A473EA0)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1A4737E0)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x1A4737D0)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A473950)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_GET_NULL_OFFSET UNITYSDK_OFFSET(0x1A473F70)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A4739E0)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x1A473BB0)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_SETNULL_OFFSET UNITYSDK_OFFSET(0x1A473640)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A473F20)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A473BE0)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x1A473BF0)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x1A473D30)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A473660)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A4736B0)
#define SYSTEM_DATA_SQLTYPES_SQLCHARS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A473620)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlChars_TypeDefinitionIndex = 35534;
