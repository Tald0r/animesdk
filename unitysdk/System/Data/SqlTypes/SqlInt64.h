...
#define SYSTEM_DATA_SQLTYPES_SQLINT64_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x944B20)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_COMPARETO_OFFSET UNITYSDK_OFFSET(0x944B10)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_EQUALS_OFFSET UNITYSDK_OFFSET(0x944B40)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x944B50)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_GETXSDTYPE_OFFSET UNITYSDK_OFFSET(0x1A883CF0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x3279D0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x944820)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A883460)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A8833B0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1A882A20)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1A882E00)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A883260)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1A883040)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A883340)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A878A20)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1A878980)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1A8788D0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A878970)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A8832D0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_MODULUS_OFFSET UNITYSDK_OFFSET(0x1A882F20)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A882C60)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1A882B40)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1A8829A0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_SAMESIGNLONG_OFFSET UNITYSDK_OFFSET(0x1A882B30)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x2FB060)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x944BC0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x944BD0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_TOSQLBYTE_OFFSET UNITYSDK_OFFSET(0x9448C0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_TOSQLDECIMAL_OFFSET UNITYSDK_OFFSET(0x944A90)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_TOSQLDOUBLE_OFFSET UNITYSDK_OFFSET(0x944930)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_TOSQLINT16_OFFSET UNITYSDK_OFFSET(0x9449B0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_TOSQLINT32_OFFSET UNITYSDK_OFFSET(0x944A20)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_TOSTRING_OFFSET UNITYSDK_OFFSET(0x944880)
#define SYSTEM_DATA_SQLTYPES_SQLINT64__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A883D70)
#define SYSTEM_DATA_SQLTYPES_SQLINT64__CTOR_1_OFFSET UNITYSDK_OFFSET(0x91EE20)
#define SYSTEM_DATA_SQLTYPES_SQLINT64__CTOR_OFFSET UNITYSDK_OFFSET(0x911EC0)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlInt64_TypeDefinitionIndex = 35541;

	struct alignas(8) SqlInt64
	{
		static ::System::Int64* StaticGet_s_lHighIntMask()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt64_TypeDefinitionIndex)->GetStaticField(0x8720);
		}
		static ::System::Data::SqlTypes::SqlInt64* StaticGet_MinValue()
		{
			return (::System::Data::SqlTypes::SqlInt64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt64_TypeDefinitionIndex)->GetStaticField(0x8728);
		}
		static ::System::Data::SqlTypes::SqlInt64* StaticGet_Zero()
		{
			return (::System::Data::SqlTypes::SqlInt64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt64_TypeDefinitionIndex)->GetStaticField(0x8738);
		}
		static ::System::Int64* StaticGet_s_lLowIntMask()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt64_TypeDefinitionIndex)->GetStaticField(0x8748);
		}
		static ::System::Data::SqlTypes::SqlInt64* StaticGet_Null()
		{
			return (::System::Data::SqlTypes::SqlInt64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt64_TypeDefinitionIndex)->GetStaticField(0x8750);
		}
		static ::System::Data::SqlTypes::SqlInt64* StaticGet_MaxValue()
		{
			return (::System::Data::SqlTypes::SqlInt64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt64_TypeDefinitionIndex)->GetStaticField(0x8760);
		}
