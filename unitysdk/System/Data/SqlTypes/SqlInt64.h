...
#define SYSTEM_DATA_SQLTYPES_SQLINT64_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x974140)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_COMPARETO_OFFSET UNITYSDK_OFFSET(0x974130)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_EQUALS_OFFSET UNITYSDK_OFFSET(0x974160)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x974170)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_GETXSDTYPE_OFFSET UNITYSDK_OFFSET(0x1AE4E670)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x3602B0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x973E40)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1AE4DDE0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1AE4DD30)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1AE4D3A0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1AE4D780)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AE4DBE0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1AE4D9C0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1AE4DCC0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1AE43380)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1AE432E0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1AE43230)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AE432D0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1AE4DC50)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_MODULUS_OFFSET UNITYSDK_OFFSET(0x1AE4D8A0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1AE4D5E0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1AE4D4C0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1AE4D320)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_SAMESIGNLONG_OFFSET UNITYSDK_OFFSET(0x1AE4D4B0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x9741E0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x9741F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_TOSQLBYTE_OFFSET UNITYSDK_OFFSET(0x973EE0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_TOSQLDECIMAL_OFFSET UNITYSDK_OFFSET(0x9740B0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_TOSQLDOUBLE_OFFSET UNITYSDK_OFFSET(0x973F50)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_TOSQLINT16_OFFSET UNITYSDK_OFFSET(0x973FD0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_TOSQLINT32_OFFSET UNITYSDK_OFFSET(0x974040)
#define SYSTEM_DATA_SQLTYPES_SQLINT64_TOSTRING_OFFSET UNITYSDK_OFFSET(0x973EA0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE4E6F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT64__CTOR_1_OFFSET UNITYSDK_OFFSET(0x94C280)
#define SYSTEM_DATA_SQLTYPES_SQLINT64__CTOR_OFFSET UNITYSDK_OFFSET(0x93E530)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlInt64_TypeDefinitionIndex = 36561;

	struct alignas(8) SqlInt64
	{
		static ::System::Data::SqlTypes::SqlInt64* StaticGet_MaxValue()
		{
			return (::System::Data::SqlTypes::SqlInt64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt64_TypeDefinitionIndex)->GetStaticField(0x8A80);
		}
		static ::System::Data::SqlTypes::SqlInt64* StaticGet_Zero()
		{
			return (::System::Data::SqlTypes::SqlInt64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt64_TypeDefinitionIndex)->GetStaticField(0x8A90);
		}
		static ::System::Int64* StaticGet_s_lLowIntMask()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt64_TypeDefinitionIndex)->GetStaticField(0x8AA0);
		}
		static ::System::Data::SqlTypes::SqlInt64* StaticGet_Null()
		{
			return (::System::Data::SqlTypes::SqlInt64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt64_TypeDefinitionIndex)->GetStaticField(0x8AA8);
		}
		static ::System::Data::SqlTypes::SqlInt64* StaticGet_MinValue()
		{
			return (::System::Data::SqlTypes::SqlInt64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt64_TypeDefinitionIndex)->GetStaticField(0x8AB8);
		}
		static ::System::Int64* StaticGet_s_lHighIntMask()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(SqlInt64_TypeDefinitionIndex)->GetStaticField(0x8AC8);
		}
