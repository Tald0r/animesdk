...
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x93E700)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x93E6F0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x93E720)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x93E730)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_GETXSDTYPE_OFFSET UNITYSDK_OFFSET(0x1A9A2050)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x3602B0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x93E5D0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A99B990)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A99B8C0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1A99B2A0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1A99B3E0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A9A1B00)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A9A1B70)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A9A1180)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1A9A12B0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1A9A1450)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1A9A1580)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_5_OFFSET UNITYSDK_OFFSET(0x1A9A16C0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_6_OFFSET UNITYSDK_OFFSET(0x1A9A17F0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_7_OFFSET UNITYSDK_OFFSET(0x1A9A19A0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A99B1D0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A99B7F0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A99B570)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1A99B6B0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1A9A1090)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x93E7A0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x93E7B0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_TOSQLSINGLE_OFFSET UNITYSDK_OFFSET(0x93E680)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x93E630)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9A20D0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x93E540)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x93E530)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlDouble_TypeDefinitionIndex = 36557;

	struct alignas(8) SqlDouble
	{
		static ::System::Data::SqlTypes::SqlDouble* StaticGet_MinValue()
		{
			return (::System::Data::SqlTypes::SqlDouble*)Il2CppClass::FromTypeDefinitionIndex(SqlDouble_TypeDefinitionIndex)->GetStaticField(0x8B30);
		}
		static ::System::Data::SqlTypes::SqlDouble* StaticGet_MaxValue()
		{
			return (::System::Data::SqlTypes::SqlDouble*)Il2CppClass::FromTypeDefinitionIndex(SqlDouble_TypeDefinitionIndex)->GetStaticField(0x8B40);
		}
		static ::System::Data::SqlTypes::SqlDouble* StaticGet_Zero()
		{
			return (::System::Data::SqlTypes::SqlDouble*)Il2CppClass::FromTypeDefinitionIndex(SqlDouble_TypeDefinitionIndex)->GetStaticField(0x8B50);
		}
		static ::System::Data::SqlTypes::SqlDouble* StaticGet_Null()
		{
			return (::System::Data::SqlTypes::SqlDouble*)Il2CppClass::FromTypeDefinitionIndex(SqlDouble_TypeDefinitionIndex)->GetStaticField(0x8B60);
		}
