...
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x912090)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x912080)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9120B0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9120C0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_GETXSDTYPE_OFFSET UNITYSDK_OFFSET(0x1A3DD9A0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x3279D0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x911F60)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A3D72E0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A3D7210)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1A3D6BF0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1A3D6D30)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A3DD450)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A3DD4C0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A3DCAD0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1A3DCC00)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1A3DCDA0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1A3DCED0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_5_OFFSET UNITYSDK_OFFSET(0x1A3DD010)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_6_OFFSET UNITYSDK_OFFSET(0x1A3DD140)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_7_OFFSET UNITYSDK_OFFSET(0x1A3DD2F0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A3D6B20)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A3D7140)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A3D6EC0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1A3D7000)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1A3DC9E0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x2FB060)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x912130)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x912140)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_TOSQLSINGLE_OFFSET UNITYSDK_OFFSET(0x912010)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x911FC0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3DDA20)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x911ED0)
#define SYSTEM_DATA_SQLTYPES_SQLDOUBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x911EC0)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlDouble_TypeDefinitionIndex = 35537;

	struct alignas(8) SqlDouble
	{
		static ::System::Data::SqlTypes::SqlDouble* StaticGet_MaxValue()
		{
			return (::System::Data::SqlTypes::SqlDouble*)Il2CppClass::FromTypeDefinitionIndex(SqlDouble_TypeDefinitionIndex)->GetStaticField(0x87D0);
		}
		static ::System::Data::SqlTypes::SqlDouble* StaticGet_Null()
		{
			return (::System::Data::SqlTypes::SqlDouble*)Il2CppClass::FromTypeDefinitionIndex(SqlDouble_TypeDefinitionIndex)->GetStaticField(0x87E0);
		}
		static ::System::Data::SqlTypes::SqlDouble* StaticGet_MinValue()
		{
			return (::System::Data::SqlTypes::SqlDouble*)Il2CppClass::FromTypeDefinitionIndex(SqlDouble_TypeDefinitionIndex)->GetStaticField(0x87F0);
		}
		static ::System::Data::SqlTypes::SqlDouble* StaticGet_Zero()
		{
			return (::System::Data::SqlTypes::SqlDouble*)Il2CppClass::FromTypeDefinitionIndex(SqlDouble_TypeDefinitionIndex)->GetStaticField(0x8800);
		}
