...
#define SYSTEM_DATA_SQLTYPES_SQLINT16_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x93EA50)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_COMPARETO_OFFSET UNITYSDK_OFFSET(0x93EA40)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_EQUALS_OFFSET UNITYSDK_OFFSET(0x93EA60)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x93EA70)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_GETXSDTYPE_OFFSET UNITYSDK_OFFSET(0x1A9A31F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x3602B0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x93E800)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A9A29A0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A9A28E0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1A9A2290)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1A9A2510)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A9A2790)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1A9A26A0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A9A2870)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A9A2610)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A9A21D0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A9A2800)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A9A2410)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1A9A2350)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1A9A2220)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x93EAE0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x93EAF0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_TOSQLDOUBLE_OFFSET UNITYSDK_OFFSET(0x93E8A0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_TOSQLINT64_OFFSET UNITYSDK_OFFSET(0x93E920)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_TOSTRING_OFFSET UNITYSDK_OFFSET(0x93E860)
#define SYSTEM_DATA_SQLTYPES_SQLINT16__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9A3270)
#define SYSTEM_DATA_SQLTYPES_SQLINT16__CTOR_1_OFFSET UNITYSDK_OFFSET(0x93E7F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16__CTOR_OFFSET UNITYSDK_OFFSET(0x93E7E0)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlInt16_TypeDefinitionIndex = 36559;

	struct alignas(2) SqlInt16
	{
		static ::System::Data::SqlTypes::SqlInt16* StaticGet_Null()
		{
			return (::System::Data::SqlTypes::SqlInt16*)Il2CppClass::FromTypeDefinitionIndex(SqlInt16_TypeDefinitionIndex)->GetStaticField(0x8AE0);
		}
		static ::System::Data::SqlTypes::SqlInt16* StaticGet_MinValue()
		{
			return (::System::Data::SqlTypes::SqlInt16*)Il2CppClass::FromTypeDefinitionIndex(SqlInt16_TypeDefinitionIndex)->GetStaticField(0x8AE4);
		}
		static ::System::Int32* StaticGet_s_MASKI2()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(SqlInt16_TypeDefinitionIndex)->GetStaticField(0x8AE8);
		}
		static ::System::Data::SqlTypes::SqlInt16* StaticGet_MaxValue()
		{
			return (::System::Data::SqlTypes::SqlInt16*)Il2CppClass::FromTypeDefinitionIndex(SqlInt16_TypeDefinitionIndex)->GetStaticField(0x8AEC);
		}
		static ::System::Data::SqlTypes::SqlInt16* StaticGet_Zero()
		{
			return (::System::Data::SqlTypes::SqlInt16*)Il2CppClass::FromTypeDefinitionIndex(SqlInt16_TypeDefinitionIndex)->GetStaticField(0x8AF0);
		}
