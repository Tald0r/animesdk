...
#define SYSTEM_DATA_SQLTYPES_SQLINT16_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x9123E0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_COMPARETO_OFFSET UNITYSDK_OFFSET(0x9123D0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_EQUALS_OFFSET UNITYSDK_OFFSET(0x9123F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x912400)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_GETXSDTYPE_OFFSET UNITYSDK_OFFSET(0x1A3DEB40)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x3279D0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x912190)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A3DE2F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A3DE230)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1A3DDBE0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1A3DDE60)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A3DE0E0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1A3DDFF0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A3DE1C0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A3DDF60)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A3DDB20)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A3DE150)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A3DDD60)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1A3DDCA0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1A3DDB70)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x2FB060)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x912470)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x912480)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_TOSQLDOUBLE_OFFSET UNITYSDK_OFFSET(0x912230)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_TOSQLINT64_OFFSET UNITYSDK_OFFSET(0x9122B0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9121F0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3DEBC0)
#define SYSTEM_DATA_SQLTYPES_SQLINT16__CTOR_1_OFFSET UNITYSDK_OFFSET(0x912180)
#define SYSTEM_DATA_SQLTYPES_SQLINT16__CTOR_OFFSET UNITYSDK_OFFSET(0x912170)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlInt16_TypeDefinitionIndex = 35539;

	struct alignas(2) SqlInt16
	{
		static ::System::Int32* StaticGet_s_MASKI2()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(SqlInt16_TypeDefinitionIndex)->GetStaticField(0x8780);
		}
		static ::System::Data::SqlTypes::SqlInt16* StaticGet_Null()
		{
			return (::System::Data::SqlTypes::SqlInt16*)Il2CppClass::FromTypeDefinitionIndex(SqlInt16_TypeDefinitionIndex)->GetStaticField(0x8784);
		}
		static ::System::Data::SqlTypes::SqlInt16* StaticGet_MaxValue()
		{
			return (::System::Data::SqlTypes::SqlInt16*)Il2CppClass::FromTypeDefinitionIndex(SqlInt16_TypeDefinitionIndex)->GetStaticField(0x8788);
		}
		static ::System::Data::SqlTypes::SqlInt16* StaticGet_MinValue()
		{
			return (::System::Data::SqlTypes::SqlInt16*)Il2CppClass::FromTypeDefinitionIndex(SqlInt16_TypeDefinitionIndex)->GetStaticField(0x878C);
		}
		static ::System::Data::SqlTypes::SqlInt16* StaticGet_Zero()
		{
			return (::System::Data::SqlTypes::SqlInt16*)Il2CppClass::FromTypeDefinitionIndex(SqlInt16_TypeDefinitionIndex)->GetStaticField(0x8790);
		}
