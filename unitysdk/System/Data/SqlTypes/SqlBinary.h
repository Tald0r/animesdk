...
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x980810)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_COMPARETO_OFFSET UNITYSDK_OFFSET(0x980800)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_EQUALS_OFFSET UNITYSDK_OFFSET(0x980820)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x980830)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_GETXSDTYPE_OFFSET UNITYSDK_OFFSET(0x1AFDED50)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x314B50)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x980770)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_HASHBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1AFDE970)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AFDE4D0)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1AFDE630)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AFDE2E0)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1AFDE580)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_PERFORMCOMPAREBYTE_OFFSET UNITYSDK_OFFSET(0x1AFDE3A0)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x980840)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x980850)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x980780)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFDEDD0)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x980720)
#define SYSTEM_DATA_SQLTYPES_SQLBINARY__CTOR_OFFSET UNITYSDK_OFFSET(0x2FBE10)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlBinary_TypeDefinitionIndex = 36549;

	struct alignas(8) SqlBinary
	{
		static ::System::Data::SqlTypes::SqlBinary* StaticGet_Null()
		{
			return (::System::Data::SqlTypes::SqlBinary*)Il2CppClass::FromTypeDefinitionIndex(SqlBinary_TypeDefinitionIndex)->GetStaticField(0x268D0);
		}
