...
#define SYSTEM_DATA_SQLTYPES_SQLTYPEEXCEPTION_SQLTYPEEXCEPTIONSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x18F94D90)
#define SYSTEM_DATA_SQLTYPES_SQLTYPEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F94CA0)
#define SYSTEM_DATA_SQLTYPES_SQLTYPEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18F94B80)
#define SYSTEM_DATA_SQLTYPES_SQLTYPEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18F94D10)
#define SYSTEM_DATA_SQLTYPES_SQLTYPEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18F94BF0)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlTypeException_TypeDefinitionIndex = 36567;
