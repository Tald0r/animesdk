...
#define SYSTEM_DATA_SQLTYPES_SQLTYPEEXCEPTION_SQLTYPEEXCEPTIONSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x18A79940)
#define SYSTEM_DATA_SQLTYPES_SQLTYPEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18A79850)
#define SYSTEM_DATA_SQLTYPES_SQLTYPEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18A79730)
#define SYSTEM_DATA_SQLTYPES_SQLTYPEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18A798C0)
#define SYSTEM_DATA_SQLTYPES_SQLTYPEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18A797A0)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlTypeException_TypeDefinitionIndex = 35547;
