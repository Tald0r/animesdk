...
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18F95C80)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_FLUSH_OFFSET UNITYSDK_OFFSET(0x18F95C60)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x18F94ED0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x18F94FD0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x18F95060)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x18F950F0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x18F952B0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_ISSTREAMCLOSED_OFFSET UNITYSDK_OFFSET(0x18F94F60)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_READBYTE_OFFSET UNITYSDK_OFFSET(0x18F959F0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_READ_OFFSET UNITYSDK_OFFSET(0x18F95570)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_SEEK_OFFSET UNITYSDK_OFFSET(0x18F953B0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x18F95BE0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x18F95300)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_THROWIFSTREAMCANNOTREAD_OFFSET UNITYSDK_OFFSET(0x18F95720)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_THROWIFSTREAMCANNOTSEEK_OFFSET UNITYSDK_OFFSET(0x18F95220)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_THROWIFSTREAMCANNOTWRITE_OFFSET UNITYSDK_OFFSET(0x18F95960)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_THROWIFSTREAMCLOSED_OFFSET UNITYSDK_OFFSET(0x18F95160)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x18F95B10)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER_WRITE_OFFSET UNITYSDK_OFFSET(0x18F957B0)
#define SYSTEM_DATA_SQLTYPES_SQLXMLSTREAMWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x18F94E90)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlXmlStreamWrapper_TypeDefinitionIndex = 36572;
