...
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_COPYSTREAMTOBUFFER_OFFSET UNITYSDK_OFFSET(0x1A6E0C40)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_FSTREAM_OFFSET UNITYSDK_OFFSET(0x1A6E0C30)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_GETXSDTYPE_OFFSET UNITYSDK_OFFSET(0x1A6E12C0)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1A6E0C10)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x1A6E0C00)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A6E0D80)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_GET_NULL_OFFSET UNITYSDK_OFFSET(0x1A6E1390)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A6E0E10)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x1A6E0FE0)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_SETNULL_OFFSET UNITYSDK_OFFSET(0x1A6E0B10)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A6E1340)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A6E1010)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x1A6E1020)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x1A6E1150)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6E0B30)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A6E0B80)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E0AF0)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlBytes_TypeDefinitionIndex = 36553;
