...
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_COPYSTREAMTOBUFFER_OFFSET UNITYSDK_OFFSET(0x1A160C40)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_FSTREAM_OFFSET UNITYSDK_OFFSET(0x1A160C30)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_GETXSDTYPE_OFFSET UNITYSDK_OFFSET(0x1A1612C0)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1A160C10)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x1A160C00)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A160D80)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_GET_NULL_OFFSET UNITYSDK_OFFSET(0x1A161390)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A160E10)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x1A160FE0)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_SETNULL_OFFSET UNITYSDK_OFFSET(0x1A160B10)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A161340)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A161010)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x1A161020)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x1A161150)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A160B30)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A160B80)
#define SYSTEM_DATA_SQLTYPES_SQLBYTES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A160AF0)

namespace System::Data::SqlTypes
{
	inline static constexpr unsigned int SqlBytes_TypeDefinitionIndex = 35533;
