...
#define SYSTEM_DATA_INDEXFIELD_EQUALS_OFFSET UNITYSDK_OFFSET(0x915580)
#define SYSTEM_DATA_INDEXFIELD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9155F0)
#define SYSTEM_DATA_INDEXFIELD_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A171300)
#define SYSTEM_DATA_INDEXFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x360200)

namespace System::Data
{
	inline static constexpr unsigned int IndexField_TypeDefinitionIndex = 36516;
