...
#define SYSTEM_DATA_DATATABLECLEAREVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A46E6F0)

namespace System::Data
{
	inline static constexpr unsigned int DataTableClearEventArgs_TypeDefinitionIndex = 35428;
