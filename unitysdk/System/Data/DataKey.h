...
#define SYSTEM_DATA_DATAKEY_CHECKSTATE_OFFSET UNITYSDK_OFFSET(0x93E1E0)
#define SYSTEM_DATA_DATAKEY_COLUMNSEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1A99EE80)
#define SYSTEM_DATA_DATAKEY_COLUMNSEQUAL_OFFSET UNITYSDK_OFFSET(0x93E1F0)
#define SYSTEM_DATA_DATAKEY_CONTAINSCOLUMN_OFFSET UNITYSDK_OFFSET(0x93E290)
#define SYSTEM_DATA_DATAKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x93E370)
#define SYSTEM_DATA_DATAKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x93E360)
#define SYSTEM_DATA_DATAKEY_GETCOLUMNNAMES_OFFSET UNITYSDK_OFFSET(0x93E400)
#define SYSTEM_DATA_DATAKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x93E300)
#define SYSTEM_DATA_DATAKEY_GETINDEXDESC_OFFSET UNITYSDK_OFFSET(0x93E410)
#define SYSTEM_DATA_DATAKEY_GETKEYVALUES_OFFSET UNITYSDK_OFFSET(0x93E420)
#define SYSTEM_DATA_DATAKEY_GETSORTINDEX_1_OFFSET UNITYSDK_OFFSET(0x93E440)
#define SYSTEM_DATA_DATAKEY_GETSORTINDEX_OFFSET UNITYSDK_OFFSET(0x93E430)
#define SYSTEM_DATA_DATAKEY_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x301E20)
#define SYSTEM_DATA_DATAKEY_GET_TABLE_OFFSET UNITYSDK_OFFSET(0x93E190)
#define SYSTEM_DATA_DATAKEY_RECORDSEQUAL_OFFSET UNITYSDK_OFFSET(0x93E450)
#define SYSTEM_DATA_DATAKEY_TOARRAY_OFFSET UNITYSDK_OFFSET(0x93E4F0)
#define SYSTEM_DATA_DATAKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x93E180)

namespace System::Data
{
	inline static constexpr unsigned int DataKey_TypeDefinitionIndex = 36424;
