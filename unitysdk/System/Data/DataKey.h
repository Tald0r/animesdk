...
#define SYSTEM_DATA_DATAKEY_CHECKSTATE_OFFSET UNITYSDK_OFFSET(0x911B70)
#define SYSTEM_DATA_DATAKEY_COLUMNSEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1A3DA7D0)
#define SYSTEM_DATA_DATAKEY_COLUMNSEQUAL_OFFSET UNITYSDK_OFFSET(0x911B80)
#define SYSTEM_DATA_DATAKEY_CONTAINSCOLUMN_OFFSET UNITYSDK_OFFSET(0x911C20)
#define SYSTEM_DATA_DATAKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x911D00)
#define SYSTEM_DATA_DATAKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x911CF0)
#define SYSTEM_DATA_DATAKEY_GETCOLUMNNAMES_OFFSET UNITYSDK_OFFSET(0x911D90)
#define SYSTEM_DATA_DATAKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x911C90)
#define SYSTEM_DATA_DATAKEY_GETINDEXDESC_OFFSET UNITYSDK_OFFSET(0x911DA0)
#define SYSTEM_DATA_DATAKEY_GETKEYVALUES_OFFSET UNITYSDK_OFFSET(0x911DB0)
#define SYSTEM_DATA_DATAKEY_GETSORTINDEX_1_OFFSET UNITYSDK_OFFSET(0x911DD0)
#define SYSTEM_DATA_DATAKEY_GETSORTINDEX_OFFSET UNITYSDK_OFFSET(0x911DC0)
#define SYSTEM_DATA_DATAKEY_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x2D41A0)
#define SYSTEM_DATA_DATAKEY_GET_TABLE_OFFSET UNITYSDK_OFFSET(0x911B20)
#define SYSTEM_DATA_DATAKEY_RECORDSEQUAL_OFFSET UNITYSDK_OFFSET(0x911DE0)
#define SYSTEM_DATA_DATAKEY_TOARRAY_OFFSET UNITYSDK_OFFSET(0x911E80)
#define SYSTEM_DATA_DATAKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x911B10)

namespace System::Data
{
	inline static constexpr unsigned int DataKey_TypeDefinitionIndex = 35404;
