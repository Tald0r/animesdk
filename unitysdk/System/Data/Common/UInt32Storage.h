...
#define SYSTEM_DATA_COMMON_UINT32STORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x18A5E1B0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x18A5EC10)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x18A5EB10)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x18A5F370)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x18A5ED50)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x18A5F2E0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x18A5F470)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x18A5EED0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x18A5F460)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_GET_OFFSET UNITYSDK_OFFSET(0x18A5EF60)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x18A5F250)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x18A5F560)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_SET_OFFSET UNITYSDK_OFFSET(0x18A5F000)
#define SYSTEM_DATA_COMMON_UINT32STORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A5E0C0)

namespace System::Data::Common
{
	inline static constexpr unsigned int UInt32Storage_TypeDefinitionIndex = 35592;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(UInt32Storage_TypeDefinitionIndex)->GetStaticField(0x89C0);
		}
