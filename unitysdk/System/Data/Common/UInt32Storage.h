...
#define SYSTEM_DATA_COMMON_UINT32STORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x18F79600)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x18F7A060)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x18F79F60)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x18F7A7C0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x18F7A1A0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x18F7A730)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x18F7A8C0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x18F7A320)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x18F7A8B0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_GET_OFFSET UNITYSDK_OFFSET(0x18F7A3B0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x18F7A6A0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x18F7A9B0)
#define SYSTEM_DATA_COMMON_UINT32STORAGE_SET_OFFSET UNITYSDK_OFFSET(0x18F7A450)
#define SYSTEM_DATA_COMMON_UINT32STORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18F79510)

namespace System::Data::Common
{
	inline static constexpr unsigned int UInt32Storage_TypeDefinitionIndex = 36612;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(UInt32Storage_TypeDefinitionIndex)->GetStaticField(0x8D20);
		}
