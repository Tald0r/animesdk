...
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B250010)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1B251F00)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B251E80)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1B252570)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1B252000)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1B252240)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1B252800)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1B252070)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B2527C0)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1B2520E0)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_ISNULL_OFFSET UNITYSDK_OFFSET(0x1B251DE0)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B2521D0)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B2529E0)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1B252170)
#define SYSTEM_DATA_COMMON_SQLDECIMALSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B24DCA0)

namespace System::Data::Common
{
	inline static constexpr unsigned int SqlDecimalStorage_TypeDefinitionIndex = 36597;
