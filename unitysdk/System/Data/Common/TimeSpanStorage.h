...
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1AADA590)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1AADB6A0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1AADB530)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1AADBDB0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_CONVERTTOTIMESPAN_OFFSET UNITYSDK_OFFSET(0x1AADB820)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1AADB9D0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1AADBD40)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1AADBF90)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1AADBA50)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1AADBF80)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1AADBAE0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1AADBCB0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1AADC080)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1AADBBB0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AADC0D0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AADA480)

namespace System::Data::Common
{
	inline static constexpr unsigned int TimeSpanStorage_TypeDefinitionIndex = 35590;
	...
	public:
		...
		{
			return (::System::TimeSpan*)Il2CppClass::FromTypeDefinitionIndex(TimeSpanStorage_TypeDefinitionIndex)->GetStaticField(0x8900);
		}
