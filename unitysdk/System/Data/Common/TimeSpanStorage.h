...
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B119D30)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1B11AE40)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B11ACD0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1B11B540)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_CONVERTTOTIMESPAN_OFFSET UNITYSDK_OFFSET(0x1B11AFC0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1B11B170)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1B11B4D0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1B11B720)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1B11B1F0)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B11B710)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1B11B280)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B11B440)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B11B810)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1B11B340)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B11B860)
#define SYSTEM_DATA_COMMON_TIMESPANSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B119C20)

namespace System::Data::Common
{
	inline static constexpr unsigned int TimeSpanStorage_TypeDefinitionIndex = 36610;
	...
	public:
		...
		{
			return (::System::TimeSpan*)Il2CppClass::FromTypeDefinitionIndex(TimeSpanStorage_TypeDefinitionIndex)->GetStaticField(0x8C60);
		}
