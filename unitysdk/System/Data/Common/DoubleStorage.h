...
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x198EB6A0)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x198EC040)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x198EBF10)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x198EC780)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x198EC1C0)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x198EC710)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x198EC870)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x198EC340)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x198EC860)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x198EC3D0)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x198EC680)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x198EC970)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x198EC460)
#define SYSTEM_DATA_COMMON_DOUBLESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x198EB5B0)

namespace System::Data::Common
{
	inline static constexpr unsigned int DoubleStorage_TypeDefinitionIndex = 35563;
