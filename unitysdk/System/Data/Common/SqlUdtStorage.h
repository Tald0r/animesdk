...
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A3D8700)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1A3D8790)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A3D8750)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_CONVERTOBJECTTOXML_1_OFFSET UNITYSDK_OFFSET(0x1A3D9930)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1A3D9550)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_CONVERTXMLTOOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1A3D92E0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1A3D8EC0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1A3D9AC0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1A3D8AA0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A3D9AB0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_GETSTATICNULLFORUDTTYPE_OFFSET UNITYSDK_OFFSET(0x1A3D80F0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1A3D8B80)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_ISNULL_OFFSET UNITYSDK_OFFSET(0x1A3D85B0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A3D8E30)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A3D9C10)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1A3D8BC0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3D9C60)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3D8450)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3D8070)

namespace System::Data::Common
{
	inline static constexpr unsigned int SqlUdtStorage_TypeDefinitionIndex = 35588;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(SqlUdtStorage_TypeDefinitionIndex)->GetStaticField(0x24EF0);
		}
