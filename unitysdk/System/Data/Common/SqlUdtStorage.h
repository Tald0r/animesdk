...
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A99CDB0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1A99CE40)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A99CE00)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_CONVERTOBJECTTOXML_1_OFFSET UNITYSDK_OFFSET(0x1A99DFE0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1A99DC00)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_CONVERTXMLTOOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1A99D990)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1A99D570)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1A99E170)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1A99D150)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A99E160)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_GETSTATICNULLFORUDTTYPE_OFFSET UNITYSDK_OFFSET(0x1A99C7A0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1A99D230)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_ISNULL_OFFSET UNITYSDK_OFFSET(0x1A99CC60)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A99D4E0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A99E2C0)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1A99D270)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A99E310)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A99CB00)
#define SYSTEM_DATA_COMMON_SQLUDTSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A99C720)

namespace System::Data::Common
{
	inline static constexpr unsigned int SqlUdtStorage_TypeDefinitionIndex = 36608;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(SqlUdtStorage_TypeDefinitionIndex)->GetStaticField(0x26920);
		}
