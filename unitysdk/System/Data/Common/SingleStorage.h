...
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A2D1070)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1A2D19D0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A2D18B0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1A2D20F0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1A2D1B40)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1A2D2080)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1A2D21E0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1A2D1CC0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A2D21D0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1A2D1D50)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A2D1FF0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A2D22E0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1A2D1DD0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2D0F80)

namespace System::Data::Common
{
	inline static constexpr unsigned int SingleStorage_TypeDefinitionIndex = 35587;
