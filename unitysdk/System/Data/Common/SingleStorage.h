...
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A89AE90)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1A89B7F0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A89B6D0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1A89BF10)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1A89B960)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1A89BEA0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1A89C000)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1A89BAE0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A89BFF0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1A89BB70)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A89BE10)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A89C100)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1A89BBF0)
#define SYSTEM_DATA_COMMON_SINGLESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A89ADA0)

namespace System::Data::Common
{
	inline static constexpr unsigned int SingleStorage_TypeDefinitionIndex = 36607;
