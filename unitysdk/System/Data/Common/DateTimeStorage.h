...
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A9EAF50)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1A9EB5A0)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A9EB420)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1A9EC000)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1A9EB720)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1A9EBF60)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1A9EC170)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1A9EB8A0)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A9EC160)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1A9EB930)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A9EBED0)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A9EC370)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1A9EBA10)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9EC5A0)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9EAE40)

namespace System::Data::Common
{
	inline static constexpr unsigned int DateTimeStorage_TypeDefinitionIndex = 35561;
	...
	public:
		...
		{
			return (::System::DateTime*)Il2CppClass::FromTypeDefinitionIndex(DateTimeStorage_TypeDefinitionIndex)->GetStaticField(0x8990);
		}
