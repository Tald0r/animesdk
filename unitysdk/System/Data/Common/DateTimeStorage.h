...
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1AFDAC80)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1AFDB2D0)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1AFDB150)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1AFDBD30)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1AFDB450)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1AFDBC90)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1AFDBEA0)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1AFDB5D0)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1AFDBE90)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1AFDB660)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1AFDBC00)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1AFDC0A0)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1AFDB740)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFDC2D0)
#define SYSTEM_DATA_COMMON_DATETIMESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFDAB70)

namespace System::Data::Common
{
	inline static constexpr unsigned int DateTimeStorage_TypeDefinitionIndex = 36581;
	...
	public:
		...
		{
			return (::System::DateTime*)Il2CppClass::FromTypeDefinitionIndex(DateTimeStorage_TypeDefinitionIndex)->GetStaticField(0x8CF0);
		}
