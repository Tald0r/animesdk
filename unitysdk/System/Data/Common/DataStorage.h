...
#define SYSTEM_DATA_COMMON_DATASTORAGE_AGGREGATECOUNT_OFFSET UNITYSDK_OFFSET(0x1AC4AF00)
#define SYSTEM_DATA_COMMON_DATASTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1AC4AEF0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_COMPAREBITS_OFFSET UNITYSDK_OFFSET(0x1AC4AFA0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1AC4B180)
#define SYSTEM_DATA_COMMON_DATASTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1AC4B000)
#define SYSTEM_DATA_COMMON_DATASTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1AC4B140)
#define SYSTEM_DATA_COMMON_DATASTORAGE_COPYBITS_OFFSET UNITYSDK_OFFSET(0x1AC4B010)
#define SYSTEM_DATA_COMMON_DATASTORAGE_COPYVALUEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AC4C180)
#define SYSTEM_DATA_COMMON_DATASTORAGE_CREATESTORAGE_OFFSET UNITYSDK_OFFSET(0x1AC4B1C0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_DETERMINEIFVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1AC4AE10)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETBITS_OFFSET UNITYSDK_OFFSET(0x1AC4B050)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETEMPTYSTORAGEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AC4C170)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETQUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1AC4C2B0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETSTORAGETYPE_OFFSET UNITYSDK_OFFSET(0x1AC4B990)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1AC4B080)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETTYPESTORAGE_OFFSET UNITYSDK_OFFSET(0x1AC4BAB0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GETTYPE_OFFSET UNITYSDK_OFFSET(0x1AC4C1C0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GET_DATETIMEMODE_OFFSET UNITYSDK_OFFSET(0x1AC4AE60)
#define SYSTEM_DATA_COMMON_DATASTORAGE_GET_FORMATPROVIDER_OFFSET UNITYSDK_OFFSET(0x1AC4AE80)
#define SYSTEM_DATA_COMMON_DATASTORAGE_HASVALUE_OFFSET UNITYSDK_OFFSET(0x1AC4B090)
#define SYSTEM_DATA_COMMON_DATASTORAGE_IMPLEMENTSINTERFACES_OFFSET UNITYSDK_OFFSET(0x1AC4BCD0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_IMPLEMENTSINULLABLEVALUE_OFFSET UNITYSDK_OFFSET(0x1AC4BF90)
#define SYSTEM_DATA_COMMON_DATASTORAGE_INSPECTTYPEFORINTERFACES_OFFSET UNITYSDK_OFFSET(0x1AC4BE10)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISNULL_OFFSET UNITYSDK_OFFSET(0x1AC4B0B0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISOBJECTNULL_OFFSET UNITYSDK_OFFSET(0x1AC4C010)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISOBJECTSQLNULL_OFFSET UNITYSDK_OFFSET(0x1AC4C0A0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISSQLTYPE_1_OFFSET UNITYSDK_OFFSET(0x1AC4BBD0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISSQLTYPE_OFFSET UNITYSDK_OFFSET(0x1AC4BBC0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISTYPECUSTOMTYPE_1_OFFSET UNITYSDK_OFFSET(0x1AC4ADF0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_ISTYPECUSTOMTYPE_OFFSET UNITYSDK_OFFSET(0x1AC4BB50)
#define SYSTEM_DATA_COMMON_DATASTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1AC4B0F0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_SETNULLBIT_OFFSET UNITYSDK_OFFSET(0x1AC4B0D0)
#define SYSTEM_DATA_COMMON_DATASTORAGE_SETSTORAGEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AC4C1B0)
#define SYSTEM_DATA_COMMON_DATASTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AC4C330)
#define SYSTEM_DATA_COMMON_DATASTORAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AC4ADC0)
#define SYSTEM_DATA_COMMON_DATASTORAGE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AC4AC90)
#define SYSTEM_DATA_COMMON_DATASTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC4AC20)

namespace System::Data::Common
{
	inline static constexpr unsigned int DataStorage_TypeDefinitionIndex = 35559;
	...
	public:
		...
		{
			return (::System::Func_2<::System::Type*, ::System::Tuple_4<::System::Boolean, ::System::Boolean, ::System::Boolean, ::System::Boolean>*>**)Il2CppClass::FromTypeDefinitionIndex(DataStorage_TypeDefinitionIndex)->GetStaticField(0x24F20);
		}
		...
		{
			return (::System::Collections::Concurrent::ConcurrentDictionary_2<::System::Type*, ::System::Tuple_4<::System::Boolean, ::System::Boolean, ::System::Boolean, ::System::Boolean>*>**)Il2CppClass::FromTypeDefinitionIndex(DataStorage_TypeDefinitionIndex)->GetStaticField(0x24F28);
		}
		static ::Il2CppArray<::System::Type*>** StaticGet_s_storageClassType()
		{
			return (::Il2CppArray<::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(DataStorage_TypeDefinitionIndex)->GetStaticField(0x24F30);
		}
		::System::Type* _dataType; // 0x10
		::System::Data::DataTable* _table; // 0x18
		::System::Object* _nullValue; // 0x20
		::System::Object* _defaultValue; // 0x28
		::System::Data::DataColumn* _column; // 0x30
		::System::Collections::BitArray* _dbNullBits; // 0x38
		::System::Boolean _isStringType; // 0x40
		::System::Boolean _isCloneable; // 0x41
		::System::Boolean _isValueType; // 0x42
		::System::Boolean _isCustomDefinedType; // 0x43
