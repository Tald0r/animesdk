...
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1AE4A250)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1AE4A550)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1AE4A4F0)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1AE4AB50)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1AE4A640)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1AE4A840)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1AE4ADE0)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1AE4A6A0)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1AE4ADA0)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1AE4A700)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_ISNULL_OFFSET UNITYSDK_OFFSET(0x1AE4A4B0)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1AE4A7D0)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1AE4AF20)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1AE4A780)
#define SYSTEM_DATA_COMMON_SQLGUIDSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4A140)

namespace System::Data::Common
{
	inline static constexpr unsigned int SqlGuidStorage_TypeDefinitionIndex = 36599;
