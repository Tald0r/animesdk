...
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1B117980)
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1B117D30)
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B117D20)
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1B118300)
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1B117F80)
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1B118590)
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1B117D40)
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B118550)
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1B117DA0)
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE_ISNULL_OFFSET UNITYSDK_OFFSET(0x1B117BD0)
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B117F10)
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1B1186F0)
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1B117DE0)
#define SYSTEM_DATA_COMMON_SQLBYTESSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B117820)

namespace System::Data::Common
{
	inline static constexpr unsigned int SqlBytesStorage_TypeDefinitionIndex = 36594;
