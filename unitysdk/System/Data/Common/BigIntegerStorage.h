...
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A6D3540)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1A6D3690)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A6D3590)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTFROMBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1A6D3F60)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1A6D4BD0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTTOBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1A6D37E0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1A6D4670)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1A6D4B00)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1A6D4CF0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1A6D4750)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A6D4CB0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1A6D47E0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A6D4A50)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A6D4E20)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1A6D48C0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6D3420)

namespace System::Data::Common
{
	inline static constexpr unsigned int BigIntegerStorage_TypeDefinitionIndex = 36574;
