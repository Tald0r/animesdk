...
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A153550)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1A1536A0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A1535A0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTFROMBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1A153F70)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1A154BE0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTTOBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1A1537F0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1A154680)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1A154B10)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1A154D00)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1A154760)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A154CC0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1A1547F0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A154A60)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A154E30)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1A1548D0)
#define SYSTEM_DATA_COMMON_BIGINTEGERSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A153430)

namespace System::Data::Common
{
	inline static constexpr unsigned int BigIntegerStorage_TypeDefinitionIndex = 35554;
