...
#define SYSTEM_DATA_COMMON_BYTESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A6B4050)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1A6B49E0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A6B4920)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1A6B50B0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1A6B4AE0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1A6B5020)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1A6B51B0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1A6B4C60)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A6B51A0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1A6B4CF0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A6B4F90)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A6B52B0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1A6B4D70)
#define SYSTEM_DATA_COMMON_BYTESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B3F60)

namespace System::Data::Common
{
	inline static constexpr unsigned int ByteStorage_TypeDefinitionIndex = 36576;
