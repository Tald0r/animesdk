...
#define SYSTEM_DATA_COMMON_BYTESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A134110)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1A134AA0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A1349E0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1A135170)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1A134BA0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1A1350E0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1A135270)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1A134D20)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A135260)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1A134DB0)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A135050)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A135370)
#define SYSTEM_DATA_COMMON_BYTESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1A134E30)
#define SYSTEM_DATA_COMMON_BYTESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A134020)

namespace System::Data::Common
{
	inline static constexpr unsigned int ByteStorage_TypeDefinitionIndex = 35556;
