...
#define SYSTEM_DATA_COMMON_CHARSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1AB96E30)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1AB97310)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1AB97250)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1AB97A20)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1AB97410)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1AB979B0)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1AB97B50)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1AB97590)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1AB97B40)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1AB97620)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1AB97920)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1AB97C50)
#define SYSTEM_DATA_COMMON_CHARSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1AB976A0)
#define SYSTEM_DATA_COMMON_CHARSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB96D40)

namespace System::Data::Common
{
	inline static constexpr unsigned int CharStorage_TypeDefinitionIndex = 36577;
