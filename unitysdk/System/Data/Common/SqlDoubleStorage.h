...
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A3D5050)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1A3D75F0)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A3D73B0)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1A3D7C20)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1A3D76E0)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1A3D7900)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1A3D7EB0)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1A3D7750)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A3D7E70)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1A3D77B0)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_ISNULL_OFFSET UNITYSDK_OFFSET(0x1A3D6BB0)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A3D7890)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A3D8000)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1A3D7840)
#define SYSTEM_DATA_COMMON_SQLDOUBLESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3D4F50)

namespace System::Data::Common
{
	inline static constexpr unsigned int SqlDoubleStorage_TypeDefinitionIndex = 35578;
