...
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A2CE8D0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1A2CF170)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A2CEF30)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1A2CF860)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1A2CF360)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1A2CF7E0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x1A2CF9A0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x1A2CF400)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A2CF960)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x1A2CF490)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A2CF730)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A2CFAD0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x1A2CF5D0)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2CFB40)
#define SYSTEM_DATA_COMMON_DATETIMEOFFSETSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2CE7C0)

namespace System::Data::Common
{
	inline static constexpr unsigned int DateTimeOffsetStorage_TypeDefinitionIndex = 35560;
	...
	public:
		...
		{
			return (::System::DateTimeOffset*)Il2CppClass::FromTypeDefinitionIndex(DateTimeOffsetStorage_TypeDefinitionIndex)->GetStaticField(0x8950);
		}
