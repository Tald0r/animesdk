...
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x198EA7C0)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x198EACA0)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x198EABD0)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x198EB360)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x198EADB0)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x198EB2F0)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x198EB460)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x198EAF30)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x198EB450)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x198EAFC0)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x198EB260)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x198EB560)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x198EB040)
#define SYSTEM_DATA_COMMON_BOOLEANSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x198EA6D0)

namespace System::Data::Common
{
	inline static constexpr unsigned int BooleanStorage_TypeDefinitionIndex = 35555;
