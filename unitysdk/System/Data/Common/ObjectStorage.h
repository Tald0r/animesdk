...
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x18A54A10)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x18A558F0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x18A556B0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COMPAREWITHFAMILIES_OFFSET UNITYSDK_OFFSET(0x18A54C80)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x18A54A60)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_CONVERTOBJECTTOXML_1_OFFSET UNITYSDK_OFFSET(0x18A57E80)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x18A579A0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_CONVERTXMLTOOBJECT_1_OFFSET UNITYSDK_OFFSET(0x18A56BF0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x18A56570)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x18A58030)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x18A55BC0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x18A58020)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GETFAMILY_OFFSET UNITYSDK_OFFSET(0x18A55B20)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GETXMLSERIALIZER_1_OFFSET UNITYSDK_OFFSET(0x18A572B0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GETXMLSERIALIZER_OFFSET UNITYSDK_OFFSET(0x18A56B60)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x18A558A0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_ISNULL_OFFSET UNITYSDK_OFFSET(0x18A55C70)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x18A56520)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x18A58350)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x18A55CB0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_VERIFYIDYNAMICMETAOBJECTPROVIDER_OFFSET UNITYSDK_OFFSET(0x18A58520)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18A58610)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A54890)

namespace System::Data::Common
{
	inline static constexpr unsigned int ObjectStorage_TypeDefinitionIndex = 35567;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Collections::Generic::KeyValuePair_2<::System::Type*, ::System::Xml::Serialization::XmlRootAttribute*>, ::System::Xml::Serialization::XmlSerializer*>**)Il2CppClass::FromTypeDefinitionIndex(ObjectStorage_TypeDefinitionIndex)->GetStaticField(0x24FD0);
		}
		static ::System::Object** StaticGet_s_defaultValue()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(ObjectStorage_TypeDefinitionIndex)->GetStaticField(0x24FD8);
		}
		static ::System::Xml::Serialization::XmlSerializerFactory** StaticGet_s_serializerFactory()
		{
			return (::System::Xml::Serialization::XmlSerializerFactory**)Il2CppClass::FromTypeDefinitionIndex(ObjectStorage_TypeDefinitionIndex)->GetStaticField(0x24FE0);
		}
		static ::System::Object** StaticGet_s_tempAssemblyCacheLock()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(ObjectStorage_TypeDefinitionIndex)->GetStaticField(0x24FE8);
		}
