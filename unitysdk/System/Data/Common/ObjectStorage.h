...
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x18F6FE40)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x18F70D20)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x18F70AE0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COMPAREWITHFAMILIES_OFFSET UNITYSDK_OFFSET(0x18F700B0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x18F6FE90)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_CONVERTOBJECTTOXML_1_OFFSET UNITYSDK_OFFSET(0x18F732B0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x18F72DD0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_CONVERTXMLTOOBJECT_1_OFFSET UNITYSDK_OFFSET(0x18F72020)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x18F719A0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COPYVALUE_OFFSET UNITYSDK_OFFSET(0x18F73460)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_COPY_OFFSET UNITYSDK_OFFSET(0x18F70FF0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GETEMPTYSTORAGE_OFFSET UNITYSDK_OFFSET(0x18F73450)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GETFAMILY_OFFSET UNITYSDK_OFFSET(0x18F70F50)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GETXMLSERIALIZER_1_OFFSET UNITYSDK_OFFSET(0x18F726E0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GETXMLSERIALIZER_OFFSET UNITYSDK_OFFSET(0x18F71F90)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_GET_OFFSET UNITYSDK_OFFSET(0x18F70CD0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_ISNULL_OFFSET UNITYSDK_OFFSET(0x18F710A0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x18F71950)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x18F73780)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_SET_OFFSET UNITYSDK_OFFSET(0x18F710E0)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE_VERIFYIDYNAMICMETAOBJECTPROVIDER_OFFSET UNITYSDK_OFFSET(0x18F73950)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18F73A40)
#define SYSTEM_DATA_COMMON_OBJECTSTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18F6FCC0)

namespace System::Data::Common
{
	inline static constexpr unsigned int ObjectStorage_TypeDefinitionIndex = 36587;
	...
	public:
		...
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(ObjectStorage_TypeDefinitionIndex)->GetStaticField(0x26A00);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Collections::Generic::KeyValuePair_2<::System::Type*, ::System::Xml::Serialization::XmlRootAttribute*>, ::System::Xml::Serialization::XmlSerializer*>**)Il2CppClass::FromTypeDefinitionIndex(ObjectStorage_TypeDefinitionIndex)->GetStaticField(0x26A08);
		}
		static ::System::Object** StaticGet_s_tempAssemblyCacheLock()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(ObjectStorage_TypeDefinitionIndex)->GetStaticField(0x26A10);
		}
		static ::System::Xml::Serialization::XmlSerializerFactory** StaticGet_s_serializerFactory()
		{
			return (::System::Xml::Serialization::XmlSerializerFactory**)Il2CppClass::FromTypeDefinitionIndex(ObjectStorage_TypeDefinitionIndex)->GetStaticField(0x26A18);
		}
