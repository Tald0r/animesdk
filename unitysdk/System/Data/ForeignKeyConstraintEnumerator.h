...
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINTENUMERATOR_GETFOREIGNKEYCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A6D9540)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINTENUMERATOR_ISVALIDCANDIDATE_OFFSET UNITYSDK_OFFSET(0x1A6D94D0)
#define SYSTEM_DATA_FOREIGNKEYCONSTRAINTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6D9460)

namespace System::Data
{
	inline static constexpr unsigned int ForeignKeyConstraintEnumerator_TypeDefinitionIndex = 36400;
