...
#define SYSTEM_DATA_AUTOINCREMENTINT64_BOUNDARYCHECK_OFFSET UNITYSDK_OFFSET(0x1A999240)
#define SYSTEM_DATA_AUTOINCREMENTINT64_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A9990B0)
#define SYSTEM_DATA_AUTOINCREMENTINT64_GET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x1A999160)
#define SYSTEM_DATA_AUTOINCREMENTINT64_GET_SEED_OFFSET UNITYSDK_OFFSET(0x1A999190)
#define SYSTEM_DATA_AUTOINCREMENTINT64_GET_STEP_OFFSET UNITYSDK_OFFSET(0x1A999410)
#define SYSTEM_DATA_AUTOINCREMENTINT64_MOVEAFTER_OFFSET UNITYSDK_OFFSET(0x1A999490)
#define SYSTEM_DATA_AUTOINCREMENTINT64_SETCURRENTANDINCREMENT_OFFSET UNITYSDK_OFFSET(0x1A9994C0)
#define SYSTEM_DATA_AUTOINCREMENTINT64_SETCURRENT_OFFSET UNITYSDK_OFFSET(0x1A9994A0)
#define SYSTEM_DATA_AUTOINCREMENTINT64_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A9990E0)
#define SYSTEM_DATA_AUTOINCREMENTINT64_SET_SEED_OFFSET UNITYSDK_OFFSET(0x1A9991A0)
#define SYSTEM_DATA_AUTOINCREMENTINT64_SET_STEP_OFFSET UNITYSDK_OFFSET(0x1A999420)
#define SYSTEM_DATA_AUTOINCREMENTINT64__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9995F0)

namespace System::Data
{
	inline static constexpr unsigned int AutoIncrementInt64_TypeDefinitionIndex = 36405;

	class AutoIncrementInt64 : public ::System::Data::AutoIncrementValue
	{
	public:
		::System::Int64 _step; // 0x18
		::System::Int64 _current; // 0x20
