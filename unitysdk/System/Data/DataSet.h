...
#define SYSTEM_DATA_DATASET_ADD_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x18F87F50)
#define SYSTEM_DATA_DATASET_BEGININIT_OFFSET UNITYSDK_OFFSET(0x18F88030)
#define SYSTEM_DATA_DATASET_CLEAR_OFFSET UNITYSDK_OFFSET(0x18F882F0)
#define SYSTEM_DATA_DATASET_CLONE_OFFSET UNITYSDK_OFFSET(0x18F884F0)
#define SYSTEM_DATA_DATASET_DESERIALIZEDATASETDATA_OFFSET UNITYSDK_OFFSET(0x18F82F50)
#define SYSTEM_DATA_DATASET_DESERIALIZEDATASETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18F83180)
#define SYSTEM_DATA_DATASET_DESERIALIZEDATASETSCHEMA_OFFSET UNITYSDK_OFFSET(0x18F829F0)
#define SYSTEM_DATA_DATASET_DESERIALIZEDATASET_OFFSET UNITYSDK_OFFSET(0x18F81120)
#define SYSTEM_DATA_DATASET_DESERIALIZERELATIONS_OFFSET UNITYSDK_OFFSET(0x18F83360)
#define SYSTEM_DATA_DATASET_ENABLECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x18F85640)
#define SYSTEM_DATA_DATASET_ENDINIT_OFFSET UNITYSDK_OFFSET(0x18F88040)
#define SYSTEM_DATA_DATASET_ESTIMATEDXMLSTRINGSIZE_OFFSET UNITYSDK_OFFSET(0x18F82540)
#define SYSTEM_DATA_DATASET_FAILEDENABLECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x18F84B10)
#define SYSTEM_DATA_DATASET_FINDTABLE_OFFSET UNITYSDK_OFFSET(0x18F93A60)
#define SYSTEM_DATA_DATASET_GETDATASETSCHEMA_OFFSET UNITYSDK_OFFSET(0x18F93E70)
#define SYSTEM_DATA_DATASET_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18F81180)
#define SYSTEM_DATA_DATASET_GETREMOTINGDIFFGRAM_OFFSET UNITYSDK_OFFSET(0x18F89F00)
#define SYSTEM_DATA_DATASET_GETXMLSCHEMAFORREMOTING_OFFSET UNITYSDK_OFFSET(0x18F82390)
#define SYSTEM_DATA_DATASET_GET_DEFAULTVIEWMANAGER_OFFSET UNITYSDK_OFFSET(0x18F85520)
#define SYSTEM_DATA_DATASET_GET_EXTENDEDPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18F84A80)
#define SYSTEM_DATA_DATASET_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x18F86810)
#define SYSTEM_DATA_DATASET_GET_SITE_OFFSET UNITYSDK_OFFSET(0x18F87DB0)
#define SYSTEM_DATA_DATASET_INFERSCHEMA_OFFSET UNITYSDK_OFFSET(0x18F8A6F0)
#define SYSTEM_DATA_DATASET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x18F90A30)
#define SYSTEM_DATA_DATASET_MERGE_1_OFFSET UNITYSDK_OFFSET(0x18F92F80)
#define SYSTEM_DATA_DATASET_MERGE_OFFSET UNITYSDK_OFFSET(0x18F90D80)
#define SYSTEM_DATA_DATASET_MOVETOELEMENT_1_OFFSET UNITYSDK_OFFSET(0x18F8AAB0)
#define SYSTEM_DATA_DATASET_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x18F8A5D0)
#define SYSTEM_DATA_DATASET_ONCLEARFUNCTIONCALLED_OFFSET UNITYSDK_OFFSET(0x18F884D0)
#define SYSTEM_DATA_DATASET_ONDATAROWCREATED_OFFSET UNITYSDK_OFFSET(0x18F93310)
#define SYSTEM_DATA_DATASET_ONINITIALIZED_OFFSET UNITYSDK_OFFSET(0x18F88290)
#define SYSTEM_DATA_DATASET_ONMERGEFAILED_OFFSET UNITYSDK_OFFSET(0x18F931A0)
#define SYSTEM_DATA_DATASET_ONPROPERTYCHANGING_OFFSET UNITYSDK_OFFSET(0x18F93180)
#define SYSTEM_DATA_DATASET_ONREMOVEDTABLE_OFFSET UNITYSDK_OFFSET(0x18F93330)
#define SYSTEM_DATA_DATASET_RAISEMERGEFAILED_OFFSET UNITYSDK_OFFSET(0x18F93210)
#define SYSTEM_DATA_DATASET_RAISEPROPERTYCHANGING_OFFSET UNITYSDK_OFFSET(0x18F86020)
#define SYSTEM_DATA_DATASET_READENDELEMENT_OFFSET UNITYSDK_OFFSET(0x18F8A660)
#define SYSTEM_DATA_DATASET_READXDRSCHEMA_OFFSET UNITYSDK_OFFSET(0x18F8A000)
#define SYSTEM_DATA_DATASET_READXMLDIFFGRAM_OFFSET UNITYSDK_OFFSET(0x18F8EEE0)
#define SYSTEM_DATA_DATASET_READXMLSCHEMA_1_OFFSET UNITYSDK_OFFSET(0x18F840F0)
#define SYSTEM_DATA_DATASET_READXMLSCHEMA_OFFSET UNITYSDK_OFFSET(0x18F89FF0)
#define SYSTEM_DATA_DATASET_READXMLSERIALIZABLE_OFFSET UNITYSDK_OFFSET(0x18F93B80)
#define SYSTEM_DATA_DATASET_READXML_1_OFFSET UNITYSDK_OFFSET(0x18F8DC10)
#define SYSTEM_DATA_DATASET_READXML_2_OFFSET UNITYSDK_OFFSET(0x18F84A70)
#define SYSTEM_DATA_DATASET_READXML_3_OFFSET UNITYSDK_OFFSET(0x18F90EF0)
#define SYSTEM_DATA_DATASET_READXML_OFFSET UNITYSDK_OFFSET(0x18F8DC00)
#define SYSTEM_DATA_DATASET_READXSDSCHEMA_OFFSET UNITYSDK_OFFSET(0x18F8A1F0)
#define SYSTEM_DATA_DATASET_REMOVE_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x18F87FC0)
#define SYSTEM_DATA_DATASET_RESET_OFFSET UNITYSDK_OFFSET(0x18F93610)
#define SYSTEM_DATA_DATASET_SERIALIZEDATASETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18F81930)
#define SYSTEM_DATA_DATASET_SERIALIZEDATASET_OFFSET UNITYSDK_OFFSET(0x18F811B0)
#define SYSTEM_DATA_DATASET_SERIALIZERELATIONS_OFFSET UNITYSDK_OFFSET(0x18F81C50)
#define SYSTEM_DATA_DATASET_SETLOCALEVALUE_OFFSET UNITYSDK_OFFSET(0x18F869E0)
#define SYSTEM_DATA_DATASET_SET_CASESENSITIVE_OFFSET UNITYSDK_OFFSET(0x18F84CC0)
#define SYSTEM_DATA_DATASET_SET_DATASETNAME_OFFSET UNITYSDK_OFFSET(0x18F80B40)
#define SYSTEM_DATA_DATASET_SET_ENFORCECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x18F84B60)
#define SYSTEM_DATA_DATASET_SET_LOCALE_OFFSET UNITYSDK_OFFSET(0x18F86820)
#define SYSTEM_DATA_DATASET_SET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x18F86090)
#define SYSTEM_DATA_DATASET_SET_PREFIX_OFFSET UNITYSDK_OFFSET(0x18F865D0)
#define SYSTEM_DATA_DATASET_SET_REMOTINGFORMAT_OFFSET UNITYSDK_OFFSET(0x18F80D10)
#define SYSTEM_DATA_DATASET_SET_SITE_OFFSET UNITYSDK_OFFSET(0x18F87DC0)
#define SYSTEM_DATA_DATASET_SYSTEM_COMPONENTMODEL_ILISTSOURCE_GETLIST_OFFSET UNITYSDK_OFFSET(0x18F89EF0)
#define SYSTEM_DATA_DATASET_SYSTEM_COMPONENTMODEL_ILISTSOURCE_GET_CONTAINSLISTCOLLECTION_OFFSET UNITYSDK_OFFSET(0x18F85510)
#define SYSTEM_DATA_DATASET_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x18F94340)
#define SYSTEM_DATA_DATASET_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x18F945D0)
#define SYSTEM_DATA_DATASET_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x18F948E0)
#define SYSTEM_DATA_DATASET_TOPLEVELTABLES_1_OFFSET UNITYSDK_OFFSET(0x18F93390)
#define SYSTEM_DATA_DATASET_TOPLEVELTABLES_OFFSET UNITYSDK_OFFSET(0x18F93380)
#define SYSTEM_DATA_DATASET_VALIDATECASECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x18F84FF0)
#define SYSTEM_DATA_DATASET_VALIDATELOCALECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x18F87860)
#define SYSTEM_DATA_DATASET_WRITEXMLSCHEMA_OFFSET UNITYSDK_OFFSET(0x18F8D9D0)
#define SYSTEM_DATA_DATASET_WRITEXML_OFFSET UNITYSDK_OFFSET(0x18F82820)
#define SYSTEM_DATA_DATASET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F80B10)
#define SYSTEM_DATA_DATASET__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18F80E40)
#define SYSTEM_DATA_DATASET__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18F80E60)
#define SYSTEM_DATA_DATASET__CTOR_OFFSET UNITYSDK_OFFSET(0x18F80900)

namespace System::Data
{
	inline static constexpr unsigned int DataSet_TypeDefinitionIndex = 36443;
	...
	public:
		...
		{
			return (::System::Xml::Schema::XmlSchemaComplexType**)Il2CppClass::FromTypeDefinitionIndex(DataSet_TypeDefinitionIndex)->GetStaticField(0x26A20);
		}
		static ::System::Int32* StaticGet_s_objectTypeCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DataSet_TypeDefinitionIndex)->GetStaticField(0x8D40);
		}
