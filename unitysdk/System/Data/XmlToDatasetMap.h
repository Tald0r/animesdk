...
#define SYSTEM_DATA_XMLTODATASETMAP_ADDCOLUMNSCHEMA_1_OFFSET UNITYSDK_OFFSET(0x1ABA5F60)
#define SYSTEM_DATA_XMLTODATASETMAP_ADDCOLUMNSCHEMA_OFFSET UNITYSDK_OFFSET(0x1ABA5D20)
#define SYSTEM_DATA_XMLTODATASETMAP_ADDTABLESCHEMA_1_OFFSET UNITYSDK_OFFSET(0x1ABA5AB0)
#define SYSTEM_DATA_XMLTODATASETMAP_ADDTABLESCHEMA_OFFSET UNITYSDK_OFFSET(0x1ABA5920)
#define SYSTEM_DATA_XMLTODATASETMAP_BUILDIDENTITYMAP_1_OFFSET UNITYSDK_OFFSET(0x1ABA3AA0)
#define SYSTEM_DATA_XMLTODATASETMAP_BUILDIDENTITYMAP_2_OFFSET UNITYSDK_OFFSET(0x1ABA4840)
#define SYSTEM_DATA_XMLTODATASETMAP_BUILDIDENTITYMAP_3_OFFSET UNITYSDK_OFFSET(0x1ABA4C00)
#define SYSTEM_DATA_XMLTODATASETMAP_BUILDIDENTITYMAP_OFFSET UNITYSDK_OFFSET(0x1ABA3380)
#define SYSTEM_DATA_XMLTODATASETMAP_GETCOLUMNSCHEMA_1_OFFSET UNITYSDK_OFFSET(0x1ABA68A0)
#define SYSTEM_DATA_XMLTODATASETMAP_GETCOLUMNSCHEMA_OFFSET UNITYSDK_OFFSET(0x1ABA65C0)
#define SYSTEM_DATA_XMLTODATASETMAP_GETSCHEMAFORNODE_OFFSET UNITYSDK_OFFSET(0x1ABA6A80)
#define SYSTEM_DATA_XMLTODATASETMAP_GETSELFANDDESCENDANTS_OFFSET UNITYSDK_OFFSET(0x1ABA6120)
#define SYSTEM_DATA_XMLTODATASETMAP_GETTABLEFORNODE_OFFSET UNITYSDK_OFFSET(0x1ABA6BE0)
#define SYSTEM_DATA_XMLTODATASETMAP_HANDLESPECIALCOLUMN_OFFSET UNITYSDK_OFFSET(0x1ABA5E20)
#define SYSTEM_DATA_XMLTODATASETMAP_ISMAPPEDCOLUMN_OFFSET UNITYSDK_OFFSET(0x1ABA5900)
#define SYSTEM_DATA_XMLTODATASETMAP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ABA3A90)
#define SYSTEM_DATA_XMLTODATASETMAP__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1ABA4830)
#define SYSTEM_DATA_XMLTODATASETMAP__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1ABA4BF0)
#define SYSTEM_DATA_XMLTODATASETMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA3370)

namespace System::Data
{
	inline static constexpr unsigned int XmlToDatasetMap_TypeDefinitionIndex = 36536;
