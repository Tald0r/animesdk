...
#define SYSTEM_DATA_XMLTODATASETMAP_ADDCOLUMNSCHEMA_1_OFFSET UNITYSDK_OFFSET(0x1A5DE1C0)
#define SYSTEM_DATA_XMLTODATASETMAP_ADDCOLUMNSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A5DDF80)
#define SYSTEM_DATA_XMLTODATASETMAP_ADDTABLESCHEMA_1_OFFSET UNITYSDK_OFFSET(0x1A5DDD10)
#define SYSTEM_DATA_XMLTODATASETMAP_ADDTABLESCHEMA_OFFSET UNITYSDK_OFFSET(0x1A5DDB80)
#define SYSTEM_DATA_XMLTODATASETMAP_BUILDIDENTITYMAP_1_OFFSET UNITYSDK_OFFSET(0x1A5DBCF0)
#define SYSTEM_DATA_XMLTODATASETMAP_BUILDIDENTITYMAP_2_OFFSET UNITYSDK_OFFSET(0x1A5DCA90)
#define SYSTEM_DATA_XMLTODATASETMAP_BUILDIDENTITYMAP_3_OFFSET UNITYSDK_OFFSET(0x1A5DCE50)
#define SYSTEM_DATA_XMLTODATASETMAP_BUILDIDENTITYMAP_OFFSET UNITYSDK_OFFSET(0x1A5DB5D0)
#define SYSTEM_DATA_XMLTODATASETMAP_GETCOLUMNSCHEMA_1_OFFSET UNITYSDK_OFFSET(0x1A5DEB00)
#define SYSTEM_DATA_XMLTODATASETMAP_GETCOLUMNSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A5DE820)
#define SYSTEM_DATA_XMLTODATASETMAP_GETSCHEMAFORNODE_OFFSET UNITYSDK_OFFSET(0x1A5DECE0)
#define SYSTEM_DATA_XMLTODATASETMAP_GETSELFANDDESCENDANTS_OFFSET UNITYSDK_OFFSET(0x1A5DE380)
#define SYSTEM_DATA_XMLTODATASETMAP_GETTABLEFORNODE_OFFSET UNITYSDK_OFFSET(0x1A5DEE40)
#define SYSTEM_DATA_XMLTODATASETMAP_HANDLESPECIALCOLUMN_OFFSET UNITYSDK_OFFSET(0x1A5DE080)
#define SYSTEM_DATA_XMLTODATASETMAP_ISMAPPEDCOLUMN_OFFSET UNITYSDK_OFFSET(0x1A5DDB60)
#define SYSTEM_DATA_XMLTODATASETMAP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5DBCE0)
#define SYSTEM_DATA_XMLTODATASETMAP__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A5DCA80)
#define SYSTEM_DATA_XMLTODATASETMAP__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A5DCE40)
#define SYSTEM_DATA_XMLTODATASETMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5DB5C0)

namespace System::Data
{
	inline static constexpr unsigned int XmlToDatasetMap_TypeDefinitionIndex = 35516;
