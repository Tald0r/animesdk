...
#define SYSTEM_DATA_PRIMARYKEYTYPECONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1A15E710)
#define SYSTEM_DATA_PRIMARYKEYTYPECONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1A15E780)
#define SYSTEM_DATA_PRIMARYKEYTYPECONVERTER_GETPROPERTIESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1A15E700)
#define SYSTEM_DATA_PRIMARYKEYTYPECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A15E690)

namespace System::Data
{
	inline static constexpr unsigned int PrimaryKeyTypeConverter_TypeDefinitionIndex = 35478;
