...
#define SYSTEM_DATA_XMLDIFFLOADER_CREATETABLESHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1AFE12D0)
#define SYSTEM_DATA_XMLDIFFLOADER_GETTABLE_OFFSET UNITYSDK_OFFSET(0x1AFE3550)
#define SYSTEM_DATA_XMLDIFFLOADER_LOADDIFFGRAM_1_OFFSET UNITYSDK_OFFSET(0x1AFE16C0)
#define SYSTEM_DATA_XMLDIFFLOADER_LOADDIFFGRAM_OFFSET UNITYSDK_OFFSET(0x1AFE07A0)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSDIFFS_1_OFFSET UNITYSDK_OFFSET(0x1AFE1920)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSDIFFS_OFFSET UNITYSDK_OFFSET(0x1AFE09B0)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSERRORS_1_OFFSET UNITYSDK_OFFSET(0x1AFE1D20)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSERRORS_OFFSET UNITYSDK_OFFSET(0x1AFE0E10)
#define SYSTEM_DATA_XMLDIFFLOADER_READOLDROWDATA_OFFSET UNITYSDK_OFFSET(0x1AFE2380)
#define SYSTEM_DATA_XMLDIFFLOADER_SKIPWHITESPACES_OFFSET UNITYSDK_OFFSET(0x1AFE2330)
#define SYSTEM_DATA_XMLDIFFLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE37D0)

namespace System::Data
{
	inline static constexpr unsigned int XMLDiffLoader_TypeDefinitionIndex = 36528;
