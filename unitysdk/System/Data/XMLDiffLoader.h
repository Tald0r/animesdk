...
#define SYSTEM_DATA_XMLDIFFLOADER_CREATETABLESHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1A9F15A0)
#define SYSTEM_DATA_XMLDIFFLOADER_GETTABLE_OFFSET UNITYSDK_OFFSET(0x1A9F3820)
#define SYSTEM_DATA_XMLDIFFLOADER_LOADDIFFGRAM_1_OFFSET UNITYSDK_OFFSET(0x1A9F1990)
#define SYSTEM_DATA_XMLDIFFLOADER_LOADDIFFGRAM_OFFSET UNITYSDK_OFFSET(0x1A9F0A70)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSDIFFS_1_OFFSET UNITYSDK_OFFSET(0x1A9F1BF0)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSDIFFS_OFFSET UNITYSDK_OFFSET(0x1A9F0C80)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSERRORS_1_OFFSET UNITYSDK_OFFSET(0x1A9F1FF0)
#define SYSTEM_DATA_XMLDIFFLOADER_PROCESSERRORS_OFFSET UNITYSDK_OFFSET(0x1A9F10E0)
#define SYSTEM_DATA_XMLDIFFLOADER_READOLDROWDATA_OFFSET UNITYSDK_OFFSET(0x1A9F2650)
#define SYSTEM_DATA_XMLDIFFLOADER_SKIPWHITESPACES_OFFSET UNITYSDK_OFFSET(0x1A9F2600)
#define SYSTEM_DATA_XMLDIFFLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9F3AA0)

namespace System::Data
{
	inline static constexpr unsigned int XMLDiffLoader_TypeDefinitionIndex = 35508;
