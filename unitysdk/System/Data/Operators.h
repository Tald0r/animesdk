...
#define SYSTEM_DATA_OPERATORS_ISARITHMETICAL_OFFSET UNITYSDK_OFFSET(0x19B8CC10)
#define SYSTEM_DATA_OPERATORS_ISLOGICAL_OFFSET UNITYSDK_OFFSET(0x19B8CC30)
#define SYSTEM_DATA_OPERATORS_ISRELATIONAL_OFFSET UNITYSDK_OFFSET(0x19B8CC50)
#define SYSTEM_DATA_OPERATORS_PRIORITY_OFFSET UNITYSDK_OFFSET(0x19B8CC60)
#define SYSTEM_DATA_OPERATORS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B8CD40)
#define SYSTEM_DATA_OPERATORS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B8CE20)
#define SYSTEM_DATA_OPERATORS__CTOR_OFFSET UNITYSDK_OFFSET(0x19B8CC00)

namespace System::Data
{
	inline static constexpr unsigned int Operators_TypeDefinitionIndex = 35469;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Operators_TypeDefinitionIndex)->GetStaticField(0x25050);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_s_looks()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Operators_TypeDefinitionIndex)->GetStaticField(0x25058);
		}
