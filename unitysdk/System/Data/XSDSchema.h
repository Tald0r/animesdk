...
#define SYSTEM_DATA_XSDSCHEMA_ADDTABLESTOLIST_OFFSET UNITYSDK_OFFSET(0x18A8B890)
#define SYSTEM_DATA_XSDSCHEMA_BUILDKEY_OFFSET UNITYSDK_OFFSET(0x18A869D0)
#define SYSTEM_DATA_XSDSCHEMA_COLLECTELEMENTSANNOTATIONS_1_OFFSET UNITYSDK_OFFSET(0x18A7A8B0)
#define SYSTEM_DATA_XSDSCHEMA_COLLECTELEMENTSANNOTATIONS_OFFSET UNITYSDK_OFFSET(0x18A7A840)
#define SYSTEM_DATA_XSDSCHEMA_DATASETELEMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x18A7E450)
#define SYSTEM_DATA_XSDSCHEMA_FINDDATASETELEMENT_OFFSET UNITYSDK_OFFSET(0x18A7E870)
#define SYSTEM_DATA_XSDSCHEMA_FINDFIELD_OFFSET UNITYSDK_OFFSET(0x18A867F0)
#define SYSTEM_DATA_XSDSCHEMA_FINDNAMETYPE_OFFSET UNITYSDK_OFFSET(0x18A8B540)
#define SYSTEM_DATA_XSDSCHEMA_FINDTYPENODE_OFFSET UNITYSDK_OFFSET(0x18A7F080)
#define SYSTEM_DATA_XSDSCHEMA_GETBOOLEANATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18A7E720)
#define SYSTEM_DATA_XSDSCHEMA_GETINSTANCENAME_OFFSET UNITYSDK_OFFSET(0x18A7CA00)
#define SYSTEM_DATA_XSDSCHEMA_GETMSDATAATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18A7B620)
#define SYSTEM_DATA_XSDSCHEMA_GETNAMESPACEFROMPREFIX_OFFSET UNITYSDK_OFFSET(0x18A8B9D0)
#define SYSTEM_DATA_XSDSCHEMA_GETPARTICLEITEMS_OFFSET UNITYSDK_OFFSET(0x18A7DF00)
#define SYSTEM_DATA_XSDSCHEMA_GETPARTICLE_OFFSET UNITYSDK_OFFSET(0x18A7EEE0)
#define SYSTEM_DATA_XSDSCHEMA_GETPREFIX_OFFSET UNITYSDK_OFFSET(0x18A88D50)
#define SYSTEM_DATA_XSDSCHEMA_GETSTRINGATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18A7F000)
#define SYSTEM_DATA_XSDSCHEMA_GETTABLENAMESPACE_OFFSET UNITYSDK_OFFSET(0x18A8B370)
#define SYSTEM_DATA_XSDSCHEMA_GETTABLENAME_OFFSET UNITYSDK_OFFSET(0x18A87BD0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEATTRIBUTECOLUMN_OFFSET UNITYSDK_OFFSET(0x18A83610)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x18A84280)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18A832A0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLECOLUMNEXPRESSION_OFFSET UNITYSDK_OFFSET(0x18A7C380)
#define SYSTEM_DATA_XSDSCHEMA_HANDLECOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x18A84740)
#define SYSTEM_DATA_XSDSCHEMA_HANDLECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x18A87D40)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEDATASET_OFFSET UNITYSDK_OFFSET(0x18A7F620)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEELEMENTCOLUMN_OFFSET UNITYSDK_OFFSET(0x18A820C0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEKEYREF_OFFSET UNITYSDK_OFFSET(0x18A86EF0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEPARTICLE_OFFSET UNITYSDK_OFFSET(0x18A814E0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEREFTABLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18A7C900)
#define SYSTEM_DATA_XSDSCHEMA_HANDLERELATIONS_OFFSET UNITYSDK_OFFSET(0x18A81090)
#define SYSTEM_DATA_XSDSCHEMA_HANDLERELATION_OFFSET UNITYSDK_OFFSET(0x18A7CAD0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLESIMPLECONTENTCOLUMN_OFFSET UNITYSDK_OFFSET(0x18A84ED0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLESIMPLETYPESIMPLECONTENTCOLUMN_OFFSET UNITYSDK_OFFSET(0x18A85970)
#define SYSTEM_DATA_XSDSCHEMA_HANDLETABLE_OFFSET UNITYSDK_OFFSET(0x18A7F420)
#define SYSTEM_DATA_XSDSCHEMA_HASATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18A7D4B0)
#define SYSTEM_DATA_XSDSCHEMA_INSTANTIATESIMPLETABLE_OFFSET UNITYSDK_OFFSET(0x18A88270)
#define SYSTEM_DATA_XSDSCHEMA_INSTANTIATETABLE_OFFSET UNITYSDK_OFFSET(0x18A89290)
#define SYSTEM_DATA_XSDSCHEMA_ISDATASETPARTICLE_OFFSET UNITYSDK_OFFSET(0x18A7D850)
#define SYSTEM_DATA_XSDSCHEMA_ISTABLE_OFFSET UNITYSDK_OFFSET(0x18A7E130)
#define SYSTEM_DATA_XSDSCHEMA_ISXSDTYPE_OFFSET UNITYSDK_OFFSET(0x18A8B820)
#define SYSTEM_DATA_XSDSCHEMA_LOADSCHEMA_1_OFFSET UNITYSDK_OFFSET(0x18A6F6D0)
#define SYSTEM_DATA_XSDSCHEMA_LOADSCHEMA_OFFSET UNITYSDK_OFFSET(0x18A7EFD0)
#define SYSTEM_DATA_XSDSCHEMA_PARSEDATATYPE_OFFSET UNITYSDK_OFFSET(0x18A8B630)
#define SYSTEM_DATA_XSDSCHEMA_QUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x18A7B840)
#define SYSTEM_DATA_XSDSCHEMA_SETEXTPROPERTIES_1_OFFSET UNITYSDK_OFFSET(0x18A7C5C0)
#define SYSTEM_DATA_XSDSCHEMA_SETEXTPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18A7BEE0)
#define SYSTEM_DATA_XSDSCHEMA_SETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18A7B8B0)
#define SYSTEM_DATA_XSDSCHEMA_TRANSLATEACCEPTREJECTRULE_OFFSET UNITYSDK_OFFSET(0x18A86D40)
#define SYSTEM_DATA_XSDSCHEMA_TRANSLATERULE_OFFSET UNITYSDK_OFFSET(0x18A86DE0)
#define SYSTEM_DATA_XSDSCHEMA_XSDTOCLR_OFFSET UNITYSDK_OFFSET(0x18A571B0)
#define SYSTEM_DATA_XSDSCHEMA__CCTOR_OFFSET UNITYSDK_OFFSET(0x18A8BF20)
#define SYSTEM_DATA_XSDSCHEMA__CTOR_OFFSET UNITYSDK_OFFSET(0x18A6F6C0)

namespace System::Data
{
	inline static constexpr unsigned int XSDSchema_TypeDefinitionIndex = 35511;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Data::XSDSchema_NameType*>**)Il2CppClass::FromTypeDefinitionIndex(XSDSchema_TypeDefinitionIndex)->GetStaticField(0x25000);
		}
		...
		::System::Collections::Generic::Dictionary_2<::System::Data::DataTable*, ::System::Collections::Generic::List_1<::System::Data::DataTable*>*>* _tableDictionary; // 0x28
		::System::Data::DataSet* _ds; // 0x30
		::System::Xml::Schema::XmlSchemaSet* _schemaSet; // 0x38
		::System::Xml::Schema::XmlSchemaElement* _dsElement; // 0x40
		::System::Collections::ArrayList* _columnExpressions; // 0x48
		::System::Collections::Hashtable* _elementsTable; // 0x50
		::System::Collections::Hashtable* _udSimpleTypes; // 0x58
		::System::Collections::ArrayList* _refTables; // 0x60
		::System::Collections::Hashtable* _constraintNodes; // 0x68
		::System::Collections::Hashtable* _attributes; // 0x70
		::System::Collections::ArrayList* _complexTypes; // 0x78
		::System::Collections::Hashtable* _schemaTypes; // 0x80
		::System::Xml::Schema::XmlSchemaObjectCollection* _elements; // 0x88
		::System::Collections::Hashtable* _attributeGroups; // 0x90
		::System::Xml::Schema::XmlSchemaObjectCollection* _annotations; // 0x98
