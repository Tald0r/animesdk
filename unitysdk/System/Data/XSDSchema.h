...
#define SYSTEM_DATA_XSDSCHEMA_ADDTABLESTOLIST_OFFSET UNITYSDK_OFFSET(0x18FA6CC0)
#define SYSTEM_DATA_XSDSCHEMA_BUILDKEY_OFFSET UNITYSDK_OFFSET(0x18FA1E40)
#define SYSTEM_DATA_XSDSCHEMA_COLLECTELEMENTSANNOTATIONS_1_OFFSET UNITYSDK_OFFSET(0x18F95D00)
#define SYSTEM_DATA_XSDSCHEMA_COLLECTELEMENTSANNOTATIONS_OFFSET UNITYSDK_OFFSET(0x18F95C90)
#define SYSTEM_DATA_XSDSCHEMA_DATASETELEMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x18F99890)
#define SYSTEM_DATA_XSDSCHEMA_FINDDATASETELEMENT_OFFSET UNITYSDK_OFFSET(0x18F99CB0)
#define SYSTEM_DATA_XSDSCHEMA_FINDFIELD_OFFSET UNITYSDK_OFFSET(0x18FA1C60)
#define SYSTEM_DATA_XSDSCHEMA_FINDNAMETYPE_OFFSET UNITYSDK_OFFSET(0x18FA6970)
#define SYSTEM_DATA_XSDSCHEMA_FINDTYPENODE_OFFSET UNITYSDK_OFFSET(0x18F9A4D0)
#define SYSTEM_DATA_XSDSCHEMA_GETBOOLEANATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18F99B60)
#define SYSTEM_DATA_XSDSCHEMA_GETINSTANCENAME_OFFSET UNITYSDK_OFFSET(0x18F97E40)
#define SYSTEM_DATA_XSDSCHEMA_GETMSDATAATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18F96A60)
#define SYSTEM_DATA_XSDSCHEMA_GETNAMESPACEFROMPREFIX_OFFSET UNITYSDK_OFFSET(0x18FA6E00)
#define SYSTEM_DATA_XSDSCHEMA_GETPARTICLEITEMS_OFFSET UNITYSDK_OFFSET(0x18F99340)
#define SYSTEM_DATA_XSDSCHEMA_GETPARTICLE_OFFSET UNITYSDK_OFFSET(0x18F9A320)
#define SYSTEM_DATA_XSDSCHEMA_GETPREFIX_OFFSET UNITYSDK_OFFSET(0x18FA41A0)
#define SYSTEM_DATA_XSDSCHEMA_GETSTRINGATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18F9A450)
#define SYSTEM_DATA_XSDSCHEMA_GETTABLENAMESPACE_OFFSET UNITYSDK_OFFSET(0x18FA67A0)
#define SYSTEM_DATA_XSDSCHEMA_GETTABLENAME_OFFSET UNITYSDK_OFFSET(0x18FA3040)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEATTRIBUTECOLUMN_OFFSET UNITYSDK_OFFSET(0x18F9EA60)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEATTRIBUTEGROUP_OFFSET UNITYSDK_OFFSET(0x18F9F6E0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18F9E6F0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLECOLUMNEXPRESSION_OFFSET UNITYSDK_OFFSET(0x18F977C0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLECOMPLEXTYPE_OFFSET UNITYSDK_OFFSET(0x18F9FBA0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x18FA31B0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEDATASET_OFFSET UNITYSDK_OFFSET(0x18F9AA70)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEELEMENTCOLUMN_OFFSET UNITYSDK_OFFSET(0x18F9D510)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEKEYREF_OFFSET UNITYSDK_OFFSET(0x18FA2360)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEPARTICLE_OFFSET UNITYSDK_OFFSET(0x18F9C920)
#define SYSTEM_DATA_XSDSCHEMA_HANDLEREFTABLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18F97D40)
#define SYSTEM_DATA_XSDSCHEMA_HANDLERELATIONS_OFFSET UNITYSDK_OFFSET(0x18F9C4D0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLERELATION_OFFSET UNITYSDK_OFFSET(0x18F97F10)
#define SYSTEM_DATA_XSDSCHEMA_HANDLESIMPLECONTENTCOLUMN_OFFSET UNITYSDK_OFFSET(0x18FA0330)
#define SYSTEM_DATA_XSDSCHEMA_HANDLESIMPLETYPESIMPLECONTENTCOLUMN_OFFSET UNITYSDK_OFFSET(0x18FA0DD0)
#define SYSTEM_DATA_XSDSCHEMA_HANDLETABLE_OFFSET UNITYSDK_OFFSET(0x18F9A870)
#define SYSTEM_DATA_XSDSCHEMA_HASATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18F988F0)
#define SYSTEM_DATA_XSDSCHEMA_INSTANTIATESIMPLETABLE_OFFSET UNITYSDK_OFFSET(0x18FA36E0)
#define SYSTEM_DATA_XSDSCHEMA_INSTANTIATETABLE_OFFSET UNITYSDK_OFFSET(0x18FA46E0)
#define SYSTEM_DATA_XSDSCHEMA_ISDATASETPARTICLE_OFFSET UNITYSDK_OFFSET(0x18F98C90)
#define SYSTEM_DATA_XSDSCHEMA_ISTABLE_OFFSET UNITYSDK_OFFSET(0x18F99570)
#define SYSTEM_DATA_XSDSCHEMA_ISXSDTYPE_OFFSET UNITYSDK_OFFSET(0x18FA6C50)
#define SYSTEM_DATA_XSDSCHEMA_LOADSCHEMA_1_OFFSET UNITYSDK_OFFSET(0x18F8AB30)
#define SYSTEM_DATA_XSDSCHEMA_LOADSCHEMA_OFFSET UNITYSDK_OFFSET(0x18F9A420)
#define SYSTEM_DATA_XSDSCHEMA_PARSEDATATYPE_OFFSET UNITYSDK_OFFSET(0x18FA6A60)
#define SYSTEM_DATA_XSDSCHEMA_QUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x18F96C80)
#define SYSTEM_DATA_XSDSCHEMA_SETEXTPROPERTIES_1_OFFSET UNITYSDK_OFFSET(0x18F97A00)
#define SYSTEM_DATA_XSDSCHEMA_SETEXTPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18F97320)
#define SYSTEM_DATA_XSDSCHEMA_SETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18F96CF0)
#define SYSTEM_DATA_XSDSCHEMA_TRANSLATEACCEPTREJECTRULE_OFFSET UNITYSDK_OFFSET(0x18FA21B0)
#define SYSTEM_DATA_XSDSCHEMA_TRANSLATERULE_OFFSET UNITYSDK_OFFSET(0x18FA2250)
#define SYSTEM_DATA_XSDSCHEMA_XSDTOCLR_OFFSET UNITYSDK_OFFSET(0x18F725E0)
#define SYSTEM_DATA_XSDSCHEMA__CCTOR_OFFSET UNITYSDK_OFFSET(0x18FA7350)
#define SYSTEM_DATA_XSDSCHEMA__CTOR_OFFSET UNITYSDK_OFFSET(0x18F8AB20)

namespace System::Data
{
	inline static constexpr unsigned int XSDSchema_TypeDefinitionIndex = 36531;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Data::XSDSchema_NameType*>**)Il2CppClass::FromTypeDefinitionIndex(XSDSchema_TypeDefinitionIndex)->GetStaticField(0x26A30);
		}
		::System::Collections::ArrayList* _columnExpressions; // 0x10
		::System::Xml::Schema::XmlSchemaSet* _schemaSet; // 0x18
		::System::Collections::Hashtable* _udSimpleTypes; // 0x20
		::System::Data::DataSet* _ds; // 0x28
		::System::Collections::Hashtable* _elementsTable; // 0x30
		::System::Collections::Hashtable* _constraintNodes; // 0x38
		::System::Collections::ArrayList* _refTables; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::Data::DataTable*, ::System::Collections::Generic::List_1<::System::Data::DataTable*>*>* _tableDictionary; // 0x48
		::System::Collections::ArrayList* _complexTypes; // 0x50
		::System::Collections::Hashtable* _expressions; // 0x58
		::System::Collections::Hashtable* _existingSimpleTypeMap; // 0x60
		::System::Xml::Schema::XmlSchemaElement* _dsElement; // 0x68
		::System::Collections::Hashtable* _attributeGroups; // 0x70
		::System::Collections::Hashtable* _schemaTypes; // 0x78
		::System::Xml::Schema::XmlSchemaObjectCollection* _annotations; // 0x80
		::System::String* _schemaName; // 0x88
		::System::Collections::Hashtable* _attributes; // 0x90
		::System::Xml::Schema::XmlSchemaObjectCollection* _elements; // 0x98
