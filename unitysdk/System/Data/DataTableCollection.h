...
#define SYSTEM_DATA_DATATABLECOLLECTION_ADD_COLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A5D80B0)
#define SYSTEM_DATA_DATATABLECOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1A5D79A0)
#define SYSTEM_DATA_DATATABLECOLLECTION_ARRAYADD_OFFSET UNITYSDK_OFFSET(0x1A5D7FD0)
#define SYSTEM_DATA_DATATABLECOLLECTION_ASSIGNNAME_OFFSET UNITYSDK_OFFSET(0x1A5D8230)
#define SYSTEM_DATA_DATATABLECOLLECTION_BASEADD_OFFSET UNITYSDK_OFFSET(0x1A5D7CD0)
#define SYSTEM_DATA_DATATABLECOLLECTION_BASEGROUPSWITCH_OFFSET UNITYSDK_OFFSET(0x1A5D87E0)
#define SYSTEM_DATA_DATATABLECOLLECTION_BASEREMOVE_OFFSET UNITYSDK_OFFSET(0x1A5D8A40)
#define SYSTEM_DATA_DATATABLECOLLECTION_CANREMOVE_OFFSET UNITYSDK_OFFSET(0x1A5D8B00)
#define SYSTEM_DATA_DATATABLECOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A5D9380)
#define SYSTEM_DATA_DATATABLECOLLECTION_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1A5D9680)
#define SYSTEM_DATA_DATATABLECOLLECTION_CONTAINS_2_OFFSET UNITYSDK_OFFSET(0x1A5D9A70)
#define SYSTEM_DATA_DATATABLECOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A5D8360)
#define SYSTEM_DATA_DATATABLECOLLECTION_FINISHINITCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1A5D9E10)
#define SYSTEM_DATA_DATATABLECOLLECTION_GETTABLESMART_OFFSET UNITYSDK_OFFSET(0x1A5D7790)
#define SYSTEM_DATA_DATATABLECOLLECTION_GETTABLE_OFFSET UNITYSDK_OFFSET(0x1A5D7580)
#define SYSTEM_DATA_DATATABLECOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1A5D6CD0)
#define SYSTEM_DATA_DATATABLECOLLECTION_GET_ITEM_2_OFFSET UNITYSDK_OFFSET(0x1A5D70D0)
#define SYSTEM_DATA_DATATABLECOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A5D6BC0)
#define SYSTEM_DATA_DATATABLECOLLECTION_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1A5D6BB0)
#define SYSTEM_DATA_DATATABLECOLLECTION_INDEXOF_1_OFFSET UNITYSDK_OFFSET(0x1A5D9D00)
#define SYSTEM_DATA_DATATABLECOLLECTION_INDEXOF_2_OFFSET UNITYSDK_OFFSET(0x1A5D9D20)
#define SYSTEM_DATA_DATATABLECOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A5D9C10)
#define SYSTEM_DATA_DATATABLECOLLECTION_INTERNALINDEXOF_1_OFFSET UNITYSDK_OFFSET(0x1A5D71C0)
#define SYSTEM_DATA_DATATABLECOLLECTION_INTERNALINDEXOF_OFFSET UNITYSDK_OFFSET(0x1A5D6DB0)
#define SYSTEM_DATA_DATATABLECOLLECTION_MAKENAME_OFFSET UNITYSDK_OFFSET(0x1A5D82F0)
#define SYSTEM_DATA_DATATABLECOLLECTION_ONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A5D8000)
#define SYSTEM_DATA_DATATABLECOLLECTION_ONCOLLECTIONCHANGING_OFFSET UNITYSDK_OFFSET(0x1A5D7C20)
#define SYSTEM_DATA_DATATABLECOLLECTION_REGISTERNAME_OFFSET UNITYSDK_OFFSET(0x1A5D8380)
#define SYSTEM_DATA_DATATABLECOLLECTION_REMOVE_COLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A5D8170)
#define SYSTEM_DATA_DATATABLECOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A5D9E90)
#define SYSTEM_DATA_DATATABLECOLLECTION_REPLACEFROMINFERENCE_OFFSET UNITYSDK_OFFSET(0x1A5D9DC0)
#define SYSTEM_DATA_DATATABLECOLLECTION_UNREGISTERNAME_OFFSET UNITYSDK_OFFSET(0x1A5D9150)
#define SYSTEM_DATA_DATATABLECOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5DA090)
#define SYSTEM_DATA_DATATABLECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5D6A80)

namespace System::Data
{
	inline static constexpr unsigned int DataTableCollection_TypeDefinitionIndex = 35430;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DataTableCollection_TypeDefinitionIndex)->GetStaticField(0x8940);
		}
		::System::ComponentModel::CollectionChangeEventHandler* _onCollectionChangingDelegate; // 0x10
		::System::Data::DataSet* _dataSet; // 0x18
		::Il2CppArray<::System::Data::DataTable*>* _delayedAddRangeTables; // 0x20
