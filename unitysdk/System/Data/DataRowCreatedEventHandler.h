...
#define SYSTEM_DATA_DATAROWCREATEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E4A3D0)
#define SYSTEM_DATA_DATAROWCREATEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E4A410)
#define SYSTEM_DATA_DATAROWCREATEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E49E50)
#define SYSTEM_DATA_DATAROWCREATEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E49E30)

namespace System::Data
{
	inline static constexpr unsigned int DataRowCreatedEventHandler_TypeDefinitionIndex = 36437;
