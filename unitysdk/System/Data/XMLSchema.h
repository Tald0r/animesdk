...
#define SYSTEM_DATA_XMLSCHEMA_FEQUALIDENTITY_OFFSET UNITYSDK_OFFSET(0x1A5DB2F0)
#define SYSTEM_DATA_XMLSCHEMA_GENUNIQUECOLUMNNAME_OFFSET UNITYSDK_OFFSET(0x1A5DB4C0)
#define SYSTEM_DATA_XMLSCHEMA_GETBOOLEANATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A5DB380)
#define SYSTEM_DATA_XMLSCHEMA_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1A5DAD60)
#define SYSTEM_DATA_XMLSCHEMA_SETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A5DADC0)
#define SYSTEM_DATA_XMLSCHEMA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5DB5B0)

namespace System::Data
{
	inline static constexpr unsigned int XMLSchema_TypeDefinitionIndex = 35509;
