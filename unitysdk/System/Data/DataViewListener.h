...
#define SYSTEM_DATA_DATAVIEWLISTENER_CHILDRELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1B254890)
#define SYSTEM_DATA_DATAVIEWLISTENER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1B254940)
#define SYSTEM_DATA_DATAVIEWLISTENER_COLUMNCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1B254A10)
#define SYSTEM_DATA_DATAVIEWLISTENER_INDEXLISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1B254BA0)
#define SYSTEM_DATA_DATAVIEWLISTENER_MAINTAINDATAVIEW_OFFSET UNITYSDK_OFFSET(0x1B254AE0)
#define SYSTEM_DATA_DATAVIEWLISTENER_PARENTRELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1B254960)
#define SYSTEM_DATA_DATAVIEWLISTENER_REGISTERLISTCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1B255870)
#define SYSTEM_DATA_DATAVIEWLISTENER_REGISTERLISTENER_OFFSET UNITYSDK_OFFSET(0x1B2550D0)
#define SYSTEM_DATA_DATAVIEWLISTENER_REGISTERMETADATAEVENTS_OFFSET UNITYSDK_OFFSET(0x1B254C50)
#define SYSTEM_DATA_DATAVIEWLISTENER_UNREGISTERLISTCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1B2559A0)
#define SYSTEM_DATA_DATAVIEWLISTENER_UNREGISTERMETADATAEVENTS_1_OFFSET UNITYSDK_OFFSET(0x1B255300)
#define SYSTEM_DATA_DATAVIEWLISTENER_UNREGISTERMETADATAEVENTS_OFFSET UNITYSDK_OFFSET(0x1B2552F0)
#define SYSTEM_DATA_DATAVIEWLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B254840)

namespace System::Data
{
	inline static constexpr unsigned int DataViewListener_TypeDefinitionIndex = 36457;
