...
#define SYSTEM_DATA_AUTOINCREMENTVALUE_CLONE_OFFSET UNITYSDK_OFFSET(0x1B117510)
#define SYSTEM_DATA_AUTOINCREMENTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1176F0)

namespace System::Data
{
	inline static constexpr unsigned int AutoIncrementValue_TypeDefinitionIndex = 36404;
