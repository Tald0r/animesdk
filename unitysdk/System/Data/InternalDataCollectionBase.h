...
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_COPYTO_OFFSET UNITYSDK_OFFSET(0x1AFDDF70)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AFDDFC0)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AFDDF30)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1AFDDFF0)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1AFDE150)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1AFDE140)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_NAMESEQUAL_OFFSET UNITYSDK_OFFSET(0x1AFDE000)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFDE170)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFDE160)

namespace System::Data
{
	inline static constexpr unsigned int InternalDataCollectionBase_TypeDefinitionIndex = 36393;
	...
	public:
		...
		{
			return (::System::ComponentModel::CollectionChangeEventArgs**)Il2CppClass::FromTypeDefinitionIndex(InternalDataCollectionBase_TypeDefinitionIndex)->GetStaticField(0x26860);
		}
