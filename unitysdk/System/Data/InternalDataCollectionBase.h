...
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_COPYTO_OFFSET UNITYSDK_OFFSET(0x1A9EE240)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A9EE290)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A9EE200)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1A9EE2C0)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1A9EE420)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1A9EE410)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE_NAMESEQUAL_OFFSET UNITYSDK_OFFSET(0x1A9EE2D0)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9EE440)
#define SYSTEM_DATA_INTERNALDATACOLLECTIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9EE430)

namespace System::Data
{
	inline static constexpr unsigned int InternalDataCollectionBase_TypeDefinitionIndex = 35373;
	...
	public:
		...
		{
			return (::System::ComponentModel::CollectionChangeEventArgs**)Il2CppClass::FromTypeDefinitionIndex(InternalDataCollectionBase_TypeDefinitionIndex)->GetStaticField(0x24E30);
		}
