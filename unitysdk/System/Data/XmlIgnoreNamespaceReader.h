...
#define SYSTEM_DATA_XMLIGNORENAMESPACEREADER_MOVETOFIRSTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1AAE2CB0)
#define SYSTEM_DATA_XMLIGNORENAMESPACEREADER_MOVETONEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1AAE2E40)
#define SYSTEM_DATA_XMLIGNORENAMESPACEREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAE2C70)

namespace System::Data
{
	inline static constexpr unsigned int XmlIgnoreNamespaceReader_TypeDefinitionIndex = 35513;
