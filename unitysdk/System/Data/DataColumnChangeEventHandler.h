...
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A158AA0)
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A158AE0)
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A158520)
#define SYSTEM_DATA_DATACOLUMNCHANGEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A158510)

namespace System::Data
{
	inline static constexpr unsigned int DataColumnChangeEventHandler_TypeDefinitionIndex = 35388;
