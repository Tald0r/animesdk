...
#define SYSTEM_DATA_DATATEXTWRITER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B771440)
#define SYSTEM_DATA_DATATEXTWRITER_CREATEWRITER_OFFSET UNITYSDK_OFFSET(0x1B771010)
#define SYSTEM_DATA_DATATEXTWRITER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B771470)
#define SYSTEM_DATA_DATATEXTWRITER_GET_BASESTREAM_OFFSET UNITYSDK_OFFSET(0x1B771060)
#define SYSTEM_DATA_DATATEXTWRITER_GET_WRITESTATE_OFFSET UNITYSDK_OFFSET(0x1B771410)
#define SYSTEM_DATA_DATATEXTWRITER_LOOKUPPREFIX_OFFSET UNITYSDK_OFFSET(0x1B7714A0)
#define SYSTEM_DATA_DATATEXTWRITER_WRITECDATA_OFFSET UNITYSDK_OFFSET(0x1B7712C0)
#define SYSTEM_DATA_DATATEXTWRITER_WRITECHARS_OFFSET UNITYSDK_OFFSET(0x1B7713E0)
#define SYSTEM_DATA_DATATEXTWRITER_WRITECOMMENT_OFFSET UNITYSDK_OFFSET(0x1B7712F0)
#define SYSTEM_DATA_DATATEXTWRITER_WRITEDOCTYPE_OFFSET UNITYSDK_OFFSET(0x1B771190)
#define SYSTEM_DATA_DATATEXTWRITER_WRITEENDATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B771290)
#define SYSTEM_DATA_DATATEXTWRITER_WRITEENDDOCUMENT_OFFSET UNITYSDK_OFFSET(0x1B771160)
#define SYSTEM_DATA_DATATEXTWRITER_WRITEENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1B771200)
#define SYSTEM_DATA_DATATEXTWRITER_WRITEENTITYREF_OFFSET UNITYSDK_OFFSET(0x1B771350)
#define SYSTEM_DATA_DATATEXTWRITER_WRITEFULLENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1B771230)
#define SYSTEM_DATA_DATATEXTWRITER_WRITEPROCESSINGINSTRUCTION_OFFSET UNITYSDK_OFFSET(0x1B771320)
#define SYSTEM_DATA_DATATEXTWRITER_WRITESTARTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B771260)
#define SYSTEM_DATA_DATATEXTWRITER_WRITESTARTDOCUMENT_1_OFFSET UNITYSDK_OFFSET(0x1B771130)
#define SYSTEM_DATA_DATATEXTWRITER_WRITESTARTDOCUMENT_OFFSET UNITYSDK_OFFSET(0x1B771100)
#define SYSTEM_DATA_DATATEXTWRITER_WRITESTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1B7711D0)
#define SYSTEM_DATA_DATATEXTWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x1B7713B0)
#define SYSTEM_DATA_DATATEXTWRITER_WRITEWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1B771380)
#define SYSTEM_DATA_DATATEXTWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B771050)

namespace System::Data
{
	inline static constexpr unsigned int DataTextWriter_TypeDefinitionIndex = 36545;
