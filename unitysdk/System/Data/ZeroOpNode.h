...
#define SYSTEM_DATA_ZEROOPNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1A2E1090)
#define SYSTEM_DATA_ZEROOPNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1A2E1120)
#define SYSTEM_DATA_ZEROOPNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1A2E11A0)
#define SYSTEM_DATA_ZEROOPNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1A2E10A0)
#define SYSTEM_DATA_ZEROOPNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A2E1240)
#define SYSTEM_DATA_ZEROOPNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A2E1250)
#define SYSTEM_DATA_ZEROOPNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A2E1220)
#define SYSTEM_DATA_ZEROOPNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1A2E1230)
#define SYSTEM_DATA_ZEROOPNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1A2E1260)
#define SYSTEM_DATA_ZEROOPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2DEA00)

namespace System::Data
{
	inline static constexpr unsigned int ZeroOpNode_TypeDefinitionIndex = 35471;
