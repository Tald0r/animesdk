...
#define SYSTEM_DATA_ZEROOPNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1A8AAE90)
#define SYSTEM_DATA_ZEROOPNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1A8AAF20)
#define SYSTEM_DATA_ZEROOPNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1A8AAFA0)
#define SYSTEM_DATA_ZEROOPNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1A8AAEA0)
#define SYSTEM_DATA_ZEROOPNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A8AB040)
#define SYSTEM_DATA_ZEROOPNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A8AB050)
#define SYSTEM_DATA_ZEROOPNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A8AB020)
#define SYSTEM_DATA_ZEROOPNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1A8AB030)
#define SYSTEM_DATA_ZEROOPNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1A8AB060)
#define SYSTEM_DATA_ZEROOPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8A8800)

namespace System::Data
{
	inline static constexpr unsigned int ZeroOpNode_TypeDefinitionIndex = 36491;
