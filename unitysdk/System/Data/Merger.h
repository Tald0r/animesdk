...
#define SYSTEM_DATA_MERGER_GETSRCKEY_OFFSET UNITYSDK_OFFSET(0x1A15D200)
#define SYSTEM_DATA_MERGER_MERGECONSTRAINTS_1_OFFSET UNITYSDK_OFFSET(0x1A15E0E0)
#define SYSTEM_DATA_MERGER_MERGECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1A15B380)
#define SYSTEM_DATA_MERGER_MERGEDATASET_OFFSET UNITYSDK_OFFSET(0x1A159660)
#define SYSTEM_DATA_MERGER_MERGEEXTENDEDPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A15C430)
#define SYSTEM_DATA_MERGER_MERGERELATION_OFFSET UNITYSDK_OFFSET(0x1A15B410)
#define SYSTEM_DATA_MERGER_MERGESCHEMA_OFFSET UNITYSDK_OFFSET(0x1A15D3E0)
#define SYSTEM_DATA_MERGER_MERGETABLEDATA_OFFSET UNITYSDK_OFFSET(0x1A15B2E0)
#define SYSTEM_DATA_MERGER_MERGETABLE_1_OFFSET UNITYSDK_OFFSET(0x1A15CB80)
#define SYSTEM_DATA_MERGER_MERGETABLE_OFFSET UNITYSDK_OFFSET(0x1A15C760)
#define SYSTEM_DATA_MERGER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A159640)
#define SYSTEM_DATA_MERGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A159620)

namespace System::Data
{
	inline static constexpr unsigned int Merger_TypeDefinitionIndex = 35476;
	...
	public:
		...
		::System::Boolean _isStandAlonetable; // 0x20
		::System::Boolean _IgnoreNSforTableLookup; // 0x21
		::System::Boolean _preserveChanges; // 0x22
