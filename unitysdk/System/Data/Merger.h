...
#define SYSTEM_DATA_MERGER_GETSRCKEY_OFFSET UNITYSDK_OFFSET(0x1A6DD200)
#define SYSTEM_DATA_MERGER_MERGECONSTRAINTS_1_OFFSET UNITYSDK_OFFSET(0x1A6DE0E0)
#define SYSTEM_DATA_MERGER_MERGECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1A6DB380)
#define SYSTEM_DATA_MERGER_MERGEDATASET_OFFSET UNITYSDK_OFFSET(0x1A6D9660)
#define SYSTEM_DATA_MERGER_MERGEEXTENDEDPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A6DC430)
#define SYSTEM_DATA_MERGER_MERGERELATION_OFFSET UNITYSDK_OFFSET(0x1A6DB410)
#define SYSTEM_DATA_MERGER_MERGESCHEMA_OFFSET UNITYSDK_OFFSET(0x1A6DD3E0)
#define SYSTEM_DATA_MERGER_MERGETABLEDATA_OFFSET UNITYSDK_OFFSET(0x1A6DB2E0)
#define SYSTEM_DATA_MERGER_MERGETABLE_1_OFFSET UNITYSDK_OFFSET(0x1A6DCB80)
#define SYSTEM_DATA_MERGER_MERGETABLE_OFFSET UNITYSDK_OFFSET(0x1A6DC760)
#define SYSTEM_DATA_MERGER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6D9640)
#define SYSTEM_DATA_MERGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6D9620)

namespace System::Data
{
	inline static constexpr unsigned int Merger_TypeDefinitionIndex = 36496;
	...
	public:
		...
		::System::Boolean _isStandAlonetable; // 0x24
		::System::Boolean _IgnoreNSforTableLookup; // 0x25
		::System::Boolean _preserveChanges; // 0x26
