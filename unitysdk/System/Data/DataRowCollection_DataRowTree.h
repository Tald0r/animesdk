...
#define SYSTEM_DATA_DATAROWCOLLECTION_DATAROWTREE_COMPARENODE_OFFSET UNITYSDK_OFFSET(0x1A2DB650)
#define SYSTEM_DATA_DATAROWCOLLECTION_DATAROWTREE_COMPARESATELITETREENODE_OFFSET UNITYSDK_OFFSET(0x1A2DB690)
#define SYSTEM_DATA_DATAROWCOLLECTION_DATAROWTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2DB5E0)

namespace System::Data
{
	inline static constexpr unsigned int DataRowCollection_DataRowTree_TypeDefinitionIndex = 35416;
