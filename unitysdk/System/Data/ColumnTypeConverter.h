...
#define SYSTEM_DATA_COLUMNTYPECONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1AE40280)
#define SYSTEM_DATA_COLUMNTYPECONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1AE3FCD0)
#define SYSTEM_DATA_COLUMNTYPECONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1AE402F0)
#define SYSTEM_DATA_COLUMNTYPECONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1AE3FD40)
#define SYSTEM_DATA_COLUMNTYPECONVERTER_GETSTANDARDVALUESEXCLUSIVE_OFFSET UNITYSDK_OFFSET(0x1AE40760)
#define SYSTEM_DATA_COLUMNTYPECONVERTER_GETSTANDARDVALUESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1AE40770)
#define SYSTEM_DATA_COLUMNTYPECONVERTER_GETSTANDARDVALUES_OFFSET UNITYSDK_OFFSET(0x1AE405D0)
#define SYSTEM_DATA_COLUMNTYPECONVERTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE40780)
#define SYSTEM_DATA_COLUMNTYPECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE3FCC0)

namespace System::Data
{
	inline static constexpr unsigned int ColumnTypeConverter_TypeDefinitionIndex = 36394;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(ColumnTypeConverter_TypeDefinitionIndex)->GetStaticField(0x26890);
		}
