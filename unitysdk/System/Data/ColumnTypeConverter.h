...
#define SYSTEM_DATA_COLUMNTYPECONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1A875920)
#define SYSTEM_DATA_COLUMNTYPECONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1A875370)
#define SYSTEM_DATA_COLUMNTYPECONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1A875990)
#define SYSTEM_DATA_COLUMNTYPECONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1A8753E0)
#define SYSTEM_DATA_COLUMNTYPECONVERTER_GETSTANDARDVALUESEXCLUSIVE_OFFSET UNITYSDK_OFFSET(0x1A875E00)
#define SYSTEM_DATA_COLUMNTYPECONVERTER_GETSTANDARDVALUESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1A875E10)
#define SYSTEM_DATA_COLUMNTYPECONVERTER_GETSTANDARDVALUES_OFFSET UNITYSDK_OFFSET(0x1A875C70)
#define SYSTEM_DATA_COLUMNTYPECONVERTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A875E20)
#define SYSTEM_DATA_COLUMNTYPECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A875360)

namespace System::Data
{
	inline static constexpr unsigned int ColumnTypeConverter_TypeDefinitionIndex = 35374;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(ColumnTypeConverter_TypeDefinitionIndex)->GetStaticField(0x24E60);
		}
