...
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A3DC2C0)
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A3DC300)
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A3DBD40)
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DBD30)

namespace System::Data
{
	inline static constexpr unsigned int DataTableClearEventHandler_TypeDefinitionIndex = 35429;
