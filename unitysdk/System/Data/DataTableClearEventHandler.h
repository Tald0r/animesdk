...
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A0960)
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A09A0)
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A03E0)
#define SYSTEM_DATA_DATATABLECLEAREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A03C0)

namespace System::Data
{
	inline static constexpr unsigned int DataTableClearEventHandler_TypeDefinitionIndex = 36449;
