...
#define SYSTEM_DATA_DATAROWCOLLECTION_ADDWITHCOLUMNEVENTS_OFFSET UNITYSDK_OFFSET(0x1A3DB5E0)
#define SYSTEM_DATA_DATAROWCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1A3DB230)
#define SYSTEM_DATA_DATAROWCOLLECTION_ARRAYADD_OFFSET UNITYSDK_OFFSET(0x1A3DB6C0)
#define SYSTEM_DATA_DATAROWCOLLECTION_ARRAYCLEAR_OFFSET UNITYSDK_OFFSET(0x1A3DB960)
#define SYSTEM_DATA_DATAROWCOLLECTION_ARRAYINSERT_OFFSET UNITYSDK_OFFSET(0x1A3DB850)
#define SYSTEM_DATA_DATAROWCOLLECTION_ARRAYREMOVE_OFFSET UNITYSDK_OFFSET(0x1A3DB9D0)
#define SYSTEM_DATA_DATAROWCOLLECTION_COPYTO_1_OFFSET UNITYSDK_OFFSET(0x1A3DBBA0)
#define SYSTEM_DATA_DATAROWCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1A3DBB40)
#define SYSTEM_DATA_DATAROWCOLLECTION_DIFFINSERTAT_OFFSET UNITYSDK_OFFSET(0x1A3DB260)
#define SYSTEM_DATA_DATAROWCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A3DBC00)
#define SYSTEM_DATA_DATAROWCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A3DB160)
#define SYSTEM_DATA_DATAROWCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A3DB180)
#define SYSTEM_DATA_DATAROWCOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A3DB550)
#define SYSTEM_DATA_DATAROWCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3DBCF0)
#define SYSTEM_DATA_DATAROWCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DB0A0)

namespace System::Data
{
	inline static constexpr unsigned int DataRowCollection_TypeDefinitionIndex = 35415;
