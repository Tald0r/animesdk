...
#define SYSTEM_DATA_LOOKUPNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1A7BF7E0)
#define SYSTEM_DATA_LOOKUPNODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1A7BFCE0)
#define SYSTEM_DATA_LOOKUPNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1A7BFAA0)
#define SYSTEM_DATA_LOOKUPNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1A7BFC50)
#define SYSTEM_DATA_LOOKUPNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1A7BFA50)
#define SYSTEM_DATA_LOOKUPNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A7BFCC0)
#define SYSTEM_DATA_LOOKUPNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A7BFCD0)
#define SYSTEM_DATA_LOOKUPNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A7BFCA0)
#define SYSTEM_DATA_LOOKUPNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1A7BFCB0)
#define SYSTEM_DATA_LOOKUPNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1A7BFCF0)
#define SYSTEM_DATA_LOOKUPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7BF7D0)

namespace System::Data
{
	inline static constexpr unsigned int LookupNode_TypeDefinitionIndex = 35467;
