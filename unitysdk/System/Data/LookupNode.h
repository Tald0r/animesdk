...
#define SYSTEM_DATA_LOOKUPNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1ADA1480)
#define SYSTEM_DATA_LOOKUPNODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1ADA1980)
#define SYSTEM_DATA_LOOKUPNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1ADA1740)
#define SYSTEM_DATA_LOOKUPNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1ADA18F0)
#define SYSTEM_DATA_LOOKUPNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1ADA16F0)
#define SYSTEM_DATA_LOOKUPNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1ADA1960)
#define SYSTEM_DATA_LOOKUPNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1ADA1970)
#define SYSTEM_DATA_LOOKUPNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1ADA1940)
#define SYSTEM_DATA_LOOKUPNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1ADA1950)
#define SYSTEM_DATA_LOOKUPNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1ADA1990)
#define SYSTEM_DATA_LOOKUPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADA1470)

namespace System::Data
{
	inline static constexpr unsigned int LookupNode_TypeDefinitionIndex = 36487;
