...
#define SYSTEM_DATA_DATAROWCHANGEEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A65450)
#define SYSTEM_DATA_DATAROWCHANGEEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A65490)
#define SYSTEM_DATA_DATAROWCHANGEEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A64ED0)
#define SYSTEM_DATA_DATAROWCHANGEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18A64EC0)

namespace System::Data
{
	inline static constexpr unsigned int DataRowChangeEventHandler_TypeDefinitionIndex = 35414;
