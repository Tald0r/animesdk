...
#define SYSTEM_DATA_DATAROWCHANGEEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18F808B0)
#define SYSTEM_DATA_DATAROWCHANGEEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18F808F0)
#define SYSTEM_DATA_DATAROWCHANGEEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18F80330)
#define SYSTEM_DATA_DATAROWCHANGEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18F80310)

namespace System::Data
{
	inline static constexpr unsigned int DataRowChangeEventHandler_TypeDefinitionIndex = 36434;
