...
#define SYSTEM_DATA_DATATABLENEWROWEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A0F50)
#define SYSTEM_DATA_DATATABLENEWROWEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A0F90)
#define SYSTEM_DATA_DATATABLENEWROWEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A9A09D0)
#define SYSTEM_DATA_DATATABLENEWROWEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A09B0)

namespace System::Data
{
	inline static constexpr unsigned int DataTableNewRowEventHandler_TypeDefinitionIndex = 36452;
