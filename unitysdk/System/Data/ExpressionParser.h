...
#define SYSTEM_DATA_EXPRESSIONPARSER_BUILDEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A8A7EA0)
#define SYSTEM_DATA_EXPRESSIONPARSER_CHECKTOKEN_OFFSET UNITYSDK_OFFSET(0x1A8A8160)
#define SYSTEM_DATA_EXPRESSIONPARSER_ISALPHANUMERIC_OFFSET UNITYSDK_OFFSET(0x1A8A9140)
#define SYSTEM_DATA_EXPRESSIONPARSER_ISALPHA_OFFSET UNITYSDK_OFFSET(0x1A8A9350)
#define SYSTEM_DATA_EXPRESSIONPARSER_ISDIGIT_OFFSET UNITYSDK_OFFSET(0x1A8A8E10)
#define SYSTEM_DATA_EXPRESSIONPARSER_ISWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A8A9370)
#define SYSTEM_DATA_EXPRESSIONPARSER_LOADEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A8A5B70)
#define SYSTEM_DATA_EXPRESSIONPARSER_NODEPEEK_OFFSET UNITYSDK_OFFSET(0x1A8A82A0)
#define SYSTEM_DATA_EXPRESSIONPARSER_NODEPOP_OFFSET UNITYSDK_OFFSET(0x1A8A82F0)
#define SYSTEM_DATA_EXPRESSIONPARSER_NODEPUSH_OFFSET UNITYSDK_OFFSET(0x1A8A81C0)
#define SYSTEM_DATA_EXPRESSIONPARSER_PARSEAGGREGATEARGUMENT_OFFSET UNITYSDK_OFFSET(0x1A8A8330)
#define SYSTEM_DATA_EXPRESSIONPARSER_PARSE_OFFSET UNITYSDK_OFFSET(0x1A8A5CA0)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANBINARYCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A8A8E00)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANDATE_OFFSET UNITYSDK_OFFSET(0x1A8A8880)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANNAME_1_OFFSET UNITYSDK_OFFSET(0x1A8A8AC0)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANNAME_OFFSET UNITYSDK_OFFSET(0x1A8A92D0)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANNUMERIC_OFFSET UNITYSDK_OFFSET(0x1A8A8C80)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANRESERVED_OFFSET UNITYSDK_OFFSET(0x1A8A8E20)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANSTRING_OFFSET UNITYSDK_OFFSET(0x1A8A89C0)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANTOKEN_OFFSET UNITYSDK_OFFSET(0x1A8A8100)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANWHITE_OFFSET UNITYSDK_OFFSET(0x1A8A8810)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCAN_OFFSET UNITYSDK_OFFSET(0x1A8A76F0)
#define SYSTEM_DATA_EXPRESSIONPARSER_STARTSCAN_OFFSET UNITYSDK_OFFSET(0x1A8A5C10)
#define SYSTEM_DATA_EXPRESSIONPARSER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8A9380)
#define SYSTEM_DATA_EXPRESSIONPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8A5AF0)

namespace System::Data
{
	inline static constexpr unsigned int ExpressionParser_TypeDefinitionIndex = 36475;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Data::ExpressionParser_ReservedWords>**)Il2CppClass::FromTypeDefinitionIndex(ExpressionParser_TypeDefinitionIndex)->GetStaticField(0x26980);
		}
		::System::Data::ExpressionNode* _expression; // 0x10
		::Il2CppArray<::System::Char>* _text; // 0x18
		::Il2CppArray<::System::Data::OperatorInfo*>* _ops; // 0x20
		::Il2CppArray<::System::Data::ExpressionNode*>* _nodeStack; // 0x28
		::System::Data::DataTable* _table; // 0x30
		::System::Int32 _prevOperand; // 0x38
		::System::Char _decimalSeparator; // 0x3C
		::System::Char _exponentU; // 0x3E
		::System::Char _listSeparator; // 0x40
		::System::Char _escape; // 0x42
		::System::Data::Tokens _token; // 0x44
		::System::Char _exponentL; // 0x48
		::System::Int32 _topOperator; // 0x4C
