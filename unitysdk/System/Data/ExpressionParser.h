...
#define SYSTEM_DATA_EXPRESSIONPARSER_BUILDEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A2DE0A0)
#define SYSTEM_DATA_EXPRESSIONPARSER_CHECKTOKEN_OFFSET UNITYSDK_OFFSET(0x1A2DE360)
#define SYSTEM_DATA_EXPRESSIONPARSER_ISALPHANUMERIC_OFFSET UNITYSDK_OFFSET(0x1A2DF340)
#define SYSTEM_DATA_EXPRESSIONPARSER_ISALPHA_OFFSET UNITYSDK_OFFSET(0x1A2DF550)
#define SYSTEM_DATA_EXPRESSIONPARSER_ISDIGIT_OFFSET UNITYSDK_OFFSET(0x1A2DF010)
#define SYSTEM_DATA_EXPRESSIONPARSER_ISWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A2DF570)
#define SYSTEM_DATA_EXPRESSIONPARSER_LOADEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A2DBD70)
#define SYSTEM_DATA_EXPRESSIONPARSER_NODEPEEK_OFFSET UNITYSDK_OFFSET(0x1A2DE4A0)
#define SYSTEM_DATA_EXPRESSIONPARSER_NODEPOP_OFFSET UNITYSDK_OFFSET(0x1A2DE4F0)
#define SYSTEM_DATA_EXPRESSIONPARSER_NODEPUSH_OFFSET UNITYSDK_OFFSET(0x1A2DE3C0)
#define SYSTEM_DATA_EXPRESSIONPARSER_PARSEAGGREGATEARGUMENT_OFFSET UNITYSDK_OFFSET(0x1A2DE530)
#define SYSTEM_DATA_EXPRESSIONPARSER_PARSE_OFFSET UNITYSDK_OFFSET(0x1A2DBEA0)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANBINARYCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A2DF000)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANDATE_OFFSET UNITYSDK_OFFSET(0x1A2DEA80)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANNAME_1_OFFSET UNITYSDK_OFFSET(0x1A2DECC0)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANNAME_OFFSET UNITYSDK_OFFSET(0x1A2DF4D0)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANNUMERIC_OFFSET UNITYSDK_OFFSET(0x1A2DEE80)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANRESERVED_OFFSET UNITYSDK_OFFSET(0x1A2DF020)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANSTRING_OFFSET UNITYSDK_OFFSET(0x1A2DEBC0)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANTOKEN_OFFSET UNITYSDK_OFFSET(0x1A2DE300)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCANWHITE_OFFSET UNITYSDK_OFFSET(0x1A2DEA10)
#define SYSTEM_DATA_EXPRESSIONPARSER_SCAN_OFFSET UNITYSDK_OFFSET(0x1A2DD8F0)
#define SYSTEM_DATA_EXPRESSIONPARSER_STARTSCAN_OFFSET UNITYSDK_OFFSET(0x1A2DBE10)
#define SYSTEM_DATA_EXPRESSIONPARSER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2DF580)
#define SYSTEM_DATA_EXPRESSIONPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2DBCF0)

namespace System::Data
{
	inline static constexpr unsigned int ExpressionParser_TypeDefinitionIndex = 35455;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Data::ExpressionParser_ReservedWords>**)Il2CppClass::FromTypeDefinitionIndex(ExpressionParser_TypeDefinitionIndex)->GetStaticField(0x24F50);
		}
		::Il2CppArray<::System::Char>* _text; // 0x10
		::System::Data::ExpressionNode* _expression; // 0x18
		::System::Data::DataTable* _table; // 0x20
		::Il2CppArray<::System::Data::OperatorInfo*>* _ops; // 0x28
		::Il2CppArray<::System::Data::ExpressionNode*>* _nodeStack; // 0x30
		::System::Int32 _topNode; // 0x38
		::System::Char _decimalSeparator; // 0x3C
		::System::Int32 _prevOperand; // 0x40
		::System::Int32 _pos; // 0x44
		::System::Int32 _topOperator; // 0x48
		::System::Int32 _op; // 0x4C
		::System::Char _exponentU; // 0x50
		::System::Char _exponentL; // 0x52
		::System::Data::Tokens _token; // 0x54
		::System::Int32 _start; // 0x58
		::System::Char _listSeparator; // 0x5C
		::System::Char _escape; // 0x5E
