...
#define SYSTEM_DATA_BINARYNODE_BINARYCOMPARE_1_OFFSET UNITYSDK_OFFSET(0x1A151690)
#define SYSTEM_DATA_BINARYNODE_BINARYCOMPARE_OFFSET UNITYSDK_OFFSET(0x1A151670)
#define SYSTEM_DATA_BINARYNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1A14A330)
#define SYSTEM_DATA_BINARYNODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1A1512D0)
#define SYSTEM_DATA_BINARYNODE_EVALBINARYOP_OFFSET UNITYSDK_OFFSET(0x1A14A3F0)
#define SYSTEM_DATA_BINARYNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1A14A3B0)
#define SYSTEM_DATA_BINARYNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1A151150)
#define SYSTEM_DATA_BINARYNODE_EVAL_3_OFFSET UNITYSDK_OFFSET(0x1A151620)
#define SYSTEM_DATA_BINARYNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1A14A390)
#define SYSTEM_DATA_BINARYNODE_GETPRECEDENCETYPE_OFFSET UNITYSDK_OFFSET(0x1A153320)
#define SYSTEM_DATA_BINARYNODE_GETPRECEDENCE_OFFSET UNITYSDK_OFFSET(0x1A153300)
#define SYSTEM_DATA_BINARYNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A151230)
#define SYSTEM_DATA_BINARYNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A151280)
#define SYSTEM_DATA_BINARYNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A151190)
#define SYSTEM_DATA_BINARYNODE_ISMIXEDSQL_OFFSET UNITYSDK_OFFSET(0x1A1533A0)
#define SYSTEM_DATA_BINARYNODE_ISMIXED_OFFSET UNITYSDK_OFFSET(0x1A153340)
#define SYSTEM_DATA_BINARYNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1A1511E0)
#define SYSTEM_DATA_BINARYNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1A151330)
#define SYSTEM_DATA_BINARYNODE_RESULTSQLTYPE_OFFSET UNITYSDK_OFFSET(0x1A1525B0)
#define SYSTEM_DATA_BINARYNODE_RESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1A152D80)
#define SYSTEM_DATA_BINARYNODE_SETTYPEMISMATCHERROR_OFFSET UNITYSDK_OFFSET(0x1A1515D0)
#define SYSTEM_DATA_BINARYNODE_SQLRESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1A153400)
#define SYSTEM_DATA_BINARYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A14A310)

namespace System::Data
{
	inline static constexpr unsigned int BinaryNode_TypeDefinitionIndex = 35447;
