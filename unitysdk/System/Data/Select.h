...
#define SYSTEM_DATA_SELECT_ACCEPTRECORD_OFFSET UNITYSDK_OFFSET(0x1AA68E40)
#define SYSTEM_DATA_SELECT_ANALYZEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AA668C0)
#define SYSTEM_DATA_SELECT_BUILDLINEAREXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AA67EA0)
#define SYSTEM_DATA_SELECT_COMPARECLOSESTCANDIDATEINDEXDESC_OFFSET UNITYSDK_OFFSET(0x1AA67040)
#define SYSTEM_DATA_SELECT_COMPARERECORDS_OFFSET UNITYSDK_OFFSET(0x1AA69A80)
#define SYSTEM_DATA_SELECT_COMPARESORTINDEXDESC_OFFSET UNITYSDK_OFFSET(0x1AA66CC0)
#define SYSTEM_DATA_SELECT_CREATEINDEX_OFFSET UNITYSDK_OFFSET(0x1AA67570)
#define SYSTEM_DATA_SELECT_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1AA69770)
#define SYSTEM_DATA_SELECT_EVAL_OFFSET UNITYSDK_OFFSET(0x1AA69030)
#define SYSTEM_DATA_SELECT_FINDCLOSESTCANDIDATEINDEX_OFFSET UNITYSDK_OFFSET(0x1AA67110)
#define SYSTEM_DATA_SELECT_FINDFIRSTMATCHINGRECORD_OFFSET UNITYSDK_OFFSET(0x1AA69900)
#define SYSTEM_DATA_SELECT_FINDLASTMATCHINGRECORD_OFFSET UNITYSDK_OFFSET(0x1AA699C0)
#define SYSTEM_DATA_SELECT_FINDSORTINDEX_OFFSET UNITYSDK_OFFSET(0x1AA66DC0)
#define SYSTEM_DATA_SELECT_GETBINARYFILTEREDRECORDS_OFFSET UNITYSDK_OFFSET(0x1AA68640)
#define SYSTEM_DATA_SELECT_GETLINEARFILTEREDRECORDS_OFFSET UNITYSDK_OFFSET(0x1AA68870)
#define SYSTEM_DATA_SELECT_GETLINEARFILTEREDROWS_OFFSET UNITYSDK_OFFSET(0x1AA683D0)
#define SYSTEM_DATA_SELECT_GETROWS_OFFSET UNITYSDK_OFFSET(0x1AA68CD0)
#define SYSTEM_DATA_SELECT_INITCANDIDATECOLUMNS_OFFSET UNITYSDK_OFFSET(0x1AA67400)
#define SYSTEM_DATA_SELECT_ISOPERATORIN_OFFSET UNITYSDK_OFFSET(0x1AA67E10)
#define SYSTEM_DATA_SELECT_ISSUPPORTEDOPERATOR_OFFSET UNITYSDK_OFFSET(0x1AA668A0)
#define SYSTEM_DATA_SELECT_SELECTROWS_OFFSET UNITYSDK_OFFSET(0x1AA68070)
#define SYSTEM_DATA_SELECT_SORT_OFFSET UNITYSDK_OFFSET(0x1AA68B10)
#define SYSTEM_DATA_SELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA667F0)

namespace System::Data
{
	inline static constexpr unsigned int Select_TypeDefinitionIndex = 36514;
	...
	public:
		...
		::System::Data::DataExpression* _rowFilter; // 0x28
		::Il2CppArray<::System::Data::Select_ColumnInfo*>* _candidateColumns; // 0x30
		::System::Data::DataTable* _table; // 0x38
		::Il2CppArray<::System::Int32>* _records; // 0x40
		::System::Data::ExpressionNode* _linearExpression; // 0x48
		::System::Int32 _matchedCandidates; // 0x50
		::System::Boolean _candidatesForBinarySearch; // 0x54
		::System::Data::DataViewRowState _recordStates; // 0x58
		::System::Int32 _recordCount; // 0x5C
