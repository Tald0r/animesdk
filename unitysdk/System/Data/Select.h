...
#define SYSTEM_DATA_SELECT_ACCEPTRECORD_OFFSET UNITYSDK_OFFSET(0x1A471750)
#define SYSTEM_DATA_SELECT_ANALYZEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A46F1D0)
#define SYSTEM_DATA_SELECT_BUILDLINEAREXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A4707B0)
#define SYSTEM_DATA_SELECT_COMPARECLOSESTCANDIDATEINDEXDESC_OFFSET UNITYSDK_OFFSET(0x1A46F950)
#define SYSTEM_DATA_SELECT_COMPARERECORDS_OFFSET UNITYSDK_OFFSET(0x1A472390)
#define SYSTEM_DATA_SELECT_COMPARESORTINDEXDESC_OFFSET UNITYSDK_OFFSET(0x1A46F5D0)
#define SYSTEM_DATA_SELECT_CREATEINDEX_OFFSET UNITYSDK_OFFSET(0x1A46FE80)
#define SYSTEM_DATA_SELECT_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A472080)
#define SYSTEM_DATA_SELECT_EVAL_OFFSET UNITYSDK_OFFSET(0x1A471940)
#define SYSTEM_DATA_SELECT_FINDCLOSESTCANDIDATEINDEX_OFFSET UNITYSDK_OFFSET(0x1A46FA20)
#define SYSTEM_DATA_SELECT_FINDFIRSTMATCHINGRECORD_OFFSET UNITYSDK_OFFSET(0x1A472210)
#define SYSTEM_DATA_SELECT_FINDLASTMATCHINGRECORD_OFFSET UNITYSDK_OFFSET(0x1A4722D0)
#define SYSTEM_DATA_SELECT_FINDSORTINDEX_OFFSET UNITYSDK_OFFSET(0x1A46F6D0)
#define SYSTEM_DATA_SELECT_GETBINARYFILTEREDRECORDS_OFFSET UNITYSDK_OFFSET(0x1A470F50)
#define SYSTEM_DATA_SELECT_GETLINEARFILTEREDRECORDS_OFFSET UNITYSDK_OFFSET(0x1A471180)
#define SYSTEM_DATA_SELECT_GETLINEARFILTEREDROWS_OFFSET UNITYSDK_OFFSET(0x1A470CE0)
#define SYSTEM_DATA_SELECT_GETROWS_OFFSET UNITYSDK_OFFSET(0x1A4715E0)
#define SYSTEM_DATA_SELECT_INITCANDIDATECOLUMNS_OFFSET UNITYSDK_OFFSET(0x1A46FD10)
#define SYSTEM_DATA_SELECT_ISOPERATORIN_OFFSET UNITYSDK_OFFSET(0x1A470720)
#define SYSTEM_DATA_SELECT_ISSUPPORTEDOPERATOR_OFFSET UNITYSDK_OFFSET(0x1A46F1B0)
#define SYSTEM_DATA_SELECT_SELECTROWS_OFFSET UNITYSDK_OFFSET(0x1A470980)
#define SYSTEM_DATA_SELECT_SORT_OFFSET UNITYSDK_OFFSET(0x1A471420)
#define SYSTEM_DATA_SELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A46F100)

namespace System::Data
{
	inline static constexpr unsigned int Select_TypeDefinitionIndex = 35494;

	class Select : public ::System::Object
	{
	public:
		::System::Data::Index* _index; // 0x10
		::Il2CppArray<::System::Data::Select_ColumnInfo*>* _candidateColumns; // 0x18
		...
		::Il2CppArray<::System::Data::IndexField>* _indexFields; // 0x40
		::System::Data::DataTable* _table; // 0x48
		::System::Int32 _matchedCandidates; // 0x50
		::System::Int32 _recordCount; // 0x54
		::System::Int32 _nCandidates; // 0x58
		::System::Data::DataViewRowState _recordStates; // 0x5C
		::System::Boolean _candidatesForBinarySearch; // 0x60
