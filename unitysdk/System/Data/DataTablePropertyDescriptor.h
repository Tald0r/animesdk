...
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_CANRESETVALUE_OFFSET UNITYSDK_OFFSET(0x1A9EDB80)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A9EDAF0)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A9EDB50)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1A9EDB90)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A9EDA80)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1A9EDAB0)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1A9EDAC0)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x1A9EDD00)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A9EDD10)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_SHOULDSERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x1A9EDD20)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9EDA40)

namespace System::Data
{
	inline static constexpr unsigned int DataTablePropertyDescriptor_TypeDefinitionIndex = 35433;
