...
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_CANRESETVALUE_OFFSET UNITYSDK_OFFSET(0x1AFDD8B0)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AFDD820)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AFDD880)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1AFDD8C0)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1AFDD7B0)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1AFDD7E0)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1AFDD7F0)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x1AFDDA30)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1AFDDA40)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR_SHOULDSERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x1AFDDA50)
#define SYSTEM_DATA_DATATABLEPROPERTYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFDD770)

namespace System::Data
{
	inline static constexpr unsigned int DataTablePropertyDescriptor_TypeDefinitionIndex = 36453;
