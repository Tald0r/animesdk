...
#define SYSTEM_DATA_INDEX_INDEXTREE_COMPARENODE_OFFSET UNITYSDK_OFFSET(0x1A6D95E0)
#define SYSTEM_DATA_INDEX_INDEXTREE_COMPARESATELITETREENODE_OFFSET UNITYSDK_OFFSET(0x1A6D9600)
#define SYSTEM_DATA_INDEX_INDEXTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6D95B0)

namespace System::Data
{
	inline static constexpr unsigned int Index_IndexTree_TypeDefinitionIndex = 36518;
