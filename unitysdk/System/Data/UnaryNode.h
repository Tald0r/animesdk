...
#define SYSTEM_DATA_UNARYNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1A2E04F0)
#define SYSTEM_DATA_UNARYNODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1A2E0DC0)
#define SYSTEM_DATA_UNARYNODE_EVALUNARYOP_OFFSET UNITYSDK_OFFSET(0x1A2E05B0)
#define SYSTEM_DATA_UNARYNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1A2E0570)
#define SYSTEM_DATA_UNARYNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1A2E0CD0)
#define SYSTEM_DATA_UNARYNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1A2E0520)
#define SYSTEM_DATA_UNARYNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A2E0D60)
#define SYSTEM_DATA_UNARYNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A2E0D90)
#define SYSTEM_DATA_UNARYNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A2E0D00)
#define SYSTEM_DATA_UNARYNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1A2E0D30)
#define SYSTEM_DATA_UNARYNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1A2E0DF0)
#define SYSTEM_DATA_UNARYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2DE9D0)

namespace System::Data
{
	inline static constexpr unsigned int UnaryNode_TypeDefinitionIndex = 35470;
