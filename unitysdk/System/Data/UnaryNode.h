...
#define SYSTEM_DATA_UNARYNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1A8AA2F0)
#define SYSTEM_DATA_UNARYNODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1A8AABC0)
#define SYSTEM_DATA_UNARYNODE_EVALUNARYOP_OFFSET UNITYSDK_OFFSET(0x1A8AA3B0)
#define SYSTEM_DATA_UNARYNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1A8AA370)
#define SYSTEM_DATA_UNARYNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1A8AAAD0)
#define SYSTEM_DATA_UNARYNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1A8AA320)
#define SYSTEM_DATA_UNARYNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A8AAB60)
#define SYSTEM_DATA_UNARYNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A8AAB90)
#define SYSTEM_DATA_UNARYNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A8AAB00)
#define SYSTEM_DATA_UNARYNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1A8AAB30)
#define SYSTEM_DATA_UNARYNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1A8AABF0)
#define SYSTEM_DATA_UNARYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8A87D0)

namespace System::Data
{
	inline static constexpr unsigned int UnaryNode_TypeDefinitionIndex = 36490;
