...
#define SYSTEM_DATA_DATATABLE_ADDDEPENDENTCOLUMN_OFFSET UNITYSDK_OFFSET(0x1990E330)
#define SYSTEM_DATA_DATATABLE_ADDFOREIGNKEY_OFFSET UNITYSDK_OFFSET(0x19908450)
#define SYSTEM_DATA_DATATABLE_ADDROW_OFFSET UNITYSDK_OFFSET(0x19900ED0)
#define SYSTEM_DATA_DATATABLE_ADDUNIQUEKEY_1_OFFSET UNITYSDK_OFFSET(0x19908440)
#define SYSTEM_DATA_DATATABLE_ADDUNIQUEKEY_OFFSET UNITYSDK_OFFSET(0x19908170)
#define SYSTEM_DATA_DATATABLE_ADD_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x19900CB0)
#define SYSTEM_DATA_DATATABLE_BEGININIT_OFFSET UNITYSDK_OFFSET(0x198FE680)
#define SYSTEM_DATA_DATATABLE_CACHENESTEDPARENT_OFFSET UNITYSDK_OFFSET(0x198FB860)
#define SYSTEM_DATA_DATATABLE_CASCADEALL_OFFSET UNITYSDK_OFFSET(0x199029A0)
#define SYSTEM_DATA_DATATABLE_CHECKCASCADINGNAMESPACECONFLICT_OFFSET UNITYSDK_OFFSET(0x198FD160)
#define SYSTEM_DATA_DATATABLE_CHECKFORCLOSUREONEXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x19908F90)
#define SYSTEM_DATA_DATATABLE_CHECKFORCLOSUREONEXPRESSIONTABLES_OFFSET UNITYSDK_OFFSET(0x198F65C0)
#define SYSTEM_DATA_DATATABLE_CHECKNAMESPACEVALIDITYFORNESTEDPARENTRELATIONS_OFFSET UNITYSDK_OFFSET(0x198FE1F0)
#define SYSTEM_DATA_DATATABLE_CHECKNAMESPACEVALIDITYFORNESTEDRELATIONS_OFFSET UNITYSDK_OFFSET(0x198FD5A0)
#define SYSTEM_DATA_DATATABLE_CHECKNOTMODIFYING_OFFSET UNITYSDK_OFFSET(0x19901E20)
#define SYSTEM_DATA_DATATABLE_CLEAR_1_OFFSET UNITYSDK_OFFSET(0x19901E60)
#define SYSTEM_DATA_DATATABLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x19901E50)
#define SYSTEM_DATA_DATATABLE_CLONEHIERARCHY_OFFSET UNITYSDK_OFFSET(0x199006E0)
#define SYSTEM_DATA_DATATABLE_CLONETO_OFFSET UNITYSDK_OFFSET(0x198F4E80)
#define SYSTEM_DATA_DATATABLE_CLONE_1_OFFSET UNITYSDK_OFFSET(0x19900160)
#define SYSTEM_DATA_DATATABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x19900150)
#define SYSTEM_DATA_DATATABLE_COMMITROW_OFFSET UNITYSDK_OFFSET(0x19902AF0)
#define SYSTEM_DATA_DATATABLE_COMPARE_1_OFFSET UNITYSDK_OFFSET(0x19902D70)
#define SYSTEM_DATA_DATATABLE_COMPARE_OFFSET UNITYSDK_OFFSET(0x19902D60)
#define SYSTEM_DATA_DATATABLE_COMPUTE_OFFSET UNITYSDK_OFFSET(0x19902FE0)
#define SYSTEM_DATA_DATATABLE_CONVERTTOROWERROR_OFFSET UNITYSDK_OFFSET(0x198F98D0)
#define SYSTEM_DATA_DATATABLE_CONVERTTOROWSTATE_OFFSET UNITYSDK_OFFSET(0x198F9830)
#define SYSTEM_DATA_DATATABLE_CREATEEMPTYROW_OFFSET UNITYSDK_OFFSET(0x19904EA0)
#define SYSTEM_DATA_DATATABLE_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x199000D0)
#define SYSTEM_DATA_DATATABLE_CREATERELATIONLIST_OFFSET UNITYSDK_OFFSET(0x1990D370)
#define SYSTEM_DATA_DATATABLE_CREATETABLELIST_OFFSET UNITYSDK_OFFSET(0x19909050)
#define SYSTEM_DATA_DATATABLE_DELETEROW_OFFSET UNITYSDK_OFFSET(0x199031F0)
#define SYSTEM_DATA_DATATABLE_DESERIALIZECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x198F7F80)
#define SYSTEM_DATA_DATATABLE_DESERIALIZEDATATABLE_OFFSET UNITYSDK_OFFSET(0x198F0850)
#define SYSTEM_DATA_DATATABLE_DESERIALIZEEXPRESSIONCOLUMNS_OFFSET UNITYSDK_OFFSET(0x198F9330)
#define SYSTEM_DATA_DATATABLE_DESERIALIZETABLEDATA_OFFSET UNITYSDK_OFFSET(0x198F4390)
#define SYSTEM_DATA_DATATABLE_DESERIALIZETABLESCHEMA_OFFSET UNITYSDK_OFFSET(0x198F3430)
#define SYSTEM_DATA_DATATABLE_DORAISENAMESPACECHANGE_OFFSET UNITYSDK_OFFSET(0x198FDA30)
#define SYSTEM_DATA_DATATABLE_ENABLECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x198FAA90)
#define SYSTEM_DATA_DATATABLE_ENDINIT_OFFSET UNITYSDK_OFFSET(0x198FE690)
#define SYSTEM_DATA_DATATABLE_EVALUATEDEPENDENTEXPRESSIONS_1_OFFSET UNITYSDK_OFFSET(0x19906980)
#define SYSTEM_DATA_DATATABLE_EVALUATEDEPENDENTEXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x19902890)
#define SYSTEM_DATA_DATATABLE_EVALUATEEXPRESSIONS_1_OFFSET UNITYSDK_OFFSET(0x19904100)
#define SYSTEM_DATA_DATATABLE_EVALUATEEXPRESSIONS_2_OFFSET UNITYSDK_OFFSET(0x1990E7F0)
#define SYSTEM_DATA_DATATABLE_EVALUATEEXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x1990E490)
#define SYSTEM_DATA_DATATABLE_FINDBYINDEX_OFFSET UNITYSDK_OFFSET(0x198FEF90)
#define SYSTEM_DATA_DATATABLE_FINDMERGETARGET_OFFSET UNITYSDK_OFFSET(0x198FF060)
#define SYSTEM_DATA_DATATABLE_FINDNESTEDPARENTRELATIONS_OFFSET UNITYSDK_OFFSET(0x198FB880)
#define SYSTEM_DATA_DATATABLE_FORMATSORTSTRING_OFFSET UNITYSDK_OFFSET(0x199032C0)
#define SYSTEM_DATA_DATATABLE_FREERECORD_OFFSET UNITYSDK_OFFSET(0x19903420)
#define SYSTEM_DATA_DATATABLE_GETDATATABLESCHEMA_OFFSET UNITYSDK_OFFSET(0x1990D930)
#define SYSTEM_DATA_DATATABLE_GETINDEX_1_OFFSET UNITYSDK_OFFSET(0x199037B0)
#define SYSTEM_DATA_DATATABLE_GETINDEX_OFFSET UNITYSDK_OFFSET(0x19903440)
#define SYSTEM_DATA_DATATABLE_GETINHERITEDNAMESPACE_OFFSET UNITYSDK_OFFSET(0x198FCED0)
#define SYSTEM_DATA_DATATABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x198F0CD0)
#define SYSTEM_DATA_DATATABLE_GETPROPERTYDESCRIPTORCOLLECTION_OFFSET UNITYSDK_OFFSET(0x19908500)
#define SYSTEM_DATA_DATATABLE_GETROWANDCOLUMNERRORS_OFFSET UNITYSDK_OFFSET(0x198F9520)
#define SYSTEM_DATA_DATATABLE_GETROWTYPE_OFFSET UNITYSDK_OFFSET(0x19905350)
#define SYSTEM_DATA_DATATABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x1990DDD0)
#define SYSTEM_DATA_DATATABLE_GETSPECIALHASHCODE_OFFSET UNITYSDK_OFFSET(0x198FB6E0)
#define SYSTEM_DATA_DATATABLE_GET_AREINDEXEVENTSSUSPENDED_OFFSET UNITYSDK_OFFSET(0x198F9C90)
#define SYSTEM_DATA_DATATABLE_GET_CHILDRELATIONS_OFFSET UNITYSDK_OFFSET(0x198FA780)
#define SYSTEM_DATA_DATATABLE_GET_COLUMNS_OFFSET UNITYSDK_OFFSET(0x198FA7F0)
#define SYSTEM_DATA_DATATABLE_GET_COMPAREINFO_OFFSET UNITYSDK_OFFSET(0x198FA800)
#define SYSTEM_DATA_DATATABLE_GET_DEFAULTVIEW_OFFSET UNITYSDK_OFFSET(0x198FA920)
#define SYSTEM_DATA_DATATABLE_GET_DISPLAYEXPRESSIONINTERNAL_OFFSET UNITYSDK_OFFSET(0x198FA9F0)
#define SYSTEM_DATA_DATATABLE_GET_ENCODEDTABLENAME_OFFSET UNITYSDK_OFFSET(0x198FCE10)
#define SYSTEM_DATA_DATATABLE_GET_ENFORCECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x198FAA20)
#define SYSTEM_DATA_DATATABLE_GET_EXTENDEDPROPERTIES_OFFSET UNITYSDK_OFFSET(0x198F6520)
#define SYSTEM_DATA_DATATABLE_GET_FORMATPROVIDER_OFFSET UNITYSDK_OFFSET(0x198FB1C0)
#define SYSTEM_DATA_DATATABLE_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x198FA170)
#define SYSTEM_DATA_DATATABLE_GET_ISTYPEDDATATABLE_OFFSET UNITYSDK_OFFSET(0x198FA180)
#define SYSTEM_DATA_DATATABLE_GET_LIVEINDEXES_OFFSET UNITYSDK_OFFSET(0x198FA640)
#define SYSTEM_DATA_DATATABLE_GET_MINIMUMCAPACITY_OFFSET UNITYSDK_OFFSET(0x198FB7B0)
#define SYSTEM_DATA_DATATABLE_GET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x198F3390)
#define SYSTEM_DATA_DATATABLE_GET_NEEDCOLUMNCHANGEEVENTS_OFFSET UNITYSDK_OFFSET(0x19905580)
#define SYSTEM_DATA_DATATABLE_GET_NESTEDPARENTRELATIONS_OFFSET UNITYSDK_OFFSET(0x198FB850)
#define SYSTEM_DATA_DATATABLE_GET_NESTEDPARENTSCOUNT_OFFSET UNITYSDK_OFFSET(0x198FBD00)
#define SYSTEM_DATA_DATATABLE_GET_PARENTRELATIONS_OFFSET UNITYSDK_OFFSET(0x198FA5D0)
#define SYSTEM_DATA_DATATABLE_GET_PRIMARYKEY_OFFSET UNITYSDK_OFFSET(0x198FC060)
#define SYSTEM_DATA_DATATABLE_GET_RECORDCAPACITY_OFFSET UNITYSDK_OFFSET(0x198FB7D0)
#define SYSTEM_DATA_DATATABLE_GET_ROWDIFFID_OFFSET UNITYSDK_OFFSET(0x1990E2C0)
#define SYSTEM_DATA_DATATABLE_GET_ROWS_OFFSET UNITYSDK_OFFSET(0x198FC560)
#define SYSTEM_DATA_DATATABLE_GET_SELFNESTED_OFFSET UNITYSDK_OFFSET(0x198FA1F0)
#define SYSTEM_DATA_DATATABLE_GET_SITE_OFFSET UNITYSDK_OFFSET(0x19900D30)
#define SYSTEM_DATA_DATATABLE_GET_TYPENAME_OFFSET UNITYSDK_OFFSET(0x198F6480)
#define SYSTEM_DATA_DATATABLE_INCREMENTALCLONETO_OFFSET UNITYSDK_OFFSET(0x19900370)
#define SYSTEM_DATA_DATATABLE_INDEXOF_OFFSET UNITYSDK_OFFSET(0x19902EE0)
#define SYSTEM_DATA_DATATABLE_INSERTRECORDTOINDEXES_OFFSET UNITYSDK_OFFSET(0x199063A0)
#define SYSTEM_DATA_DATATABLE_INSERTROW_1_OFFSET UNITYSDK_OFFSET(0x19900F10)
#define SYSTEM_DATA_DATATABLE_INSERTROW_2_OFFSET UNITYSDK_OFFSET(0x198FFCC0)
#define SYSTEM_DATA_DATATABLE_INSERTROW_OFFSET UNITYSDK_OFFSET(0x19900EF0)
#define SYSTEM_DATA_DATATABLE_ISEMPTYXML_OFFSET UNITYSDK_OFFSET(0x19909860)
#define SYSTEM_DATA_DATATABLE_ISNAMESPACEINHERITED_OFFSET UNITYSDK_OFFSET(0x198FE1E0)
#define SYSTEM_DATA_DATATABLE_ISSUFFIX_OFFSET UNITYSDK_OFFSET(0x19902F60)
#define SYSTEM_DATA_DATATABLE_MERGEROW_OFFSET UNITYSDK_OFFSET(0x198FF6F0)
#define SYSTEM_DATA_DATATABLE_MERGE_1_OFFSET UNITYSDK_OFFSET(0x199089D0)
#define SYSTEM_DATA_DATATABLE_MERGE_OFFSET UNITYSDK_OFFSET(0x199089C0)
#define SYSTEM_DATA_DATATABLE_MOVETOELEMENT_OFFSET UNITYSDK_OFFSET(0x1990D050)
#define SYSTEM_DATA_DATATABLE_NEWEMPTYROW_OFFSET UNITYSDK_OFFSET(0x198F97D0)
#define SYSTEM_DATA_DATATABLE_NEWRECORD_1_OFFSET UNITYSDK_OFFSET(0x199048D0)
#define SYSTEM_DATA_DATATABLE_NEWRECORD_OFFSET UNITYSDK_OFFSET(0x199048C0)
#define SYSTEM_DATA_DATATABLE_NEWROWARRAY_OFFSET UNITYSDK_OFFSET(0x19905380)
#define SYSTEM_DATA_DATATABLE_NEWROWCREATED_OFFSET UNITYSDK_OFFSET(0x19904E10)
#define SYSTEM_DATA_DATATABLE_NEWROWFROMBUILDER_OFFSET UNITYSDK_OFFSET(0x199052A0)
#define SYSTEM_DATA_DATATABLE_NEWROW_1_OFFSET UNITYSDK_OFFSET(0x19904C90)
#define SYSTEM_DATA_DATATABLE_NEWROW_OFFSET UNITYSDK_OFFSET(0x19904D20)
#define SYSTEM_DATA_DATATABLE_NEWUNINITIALIZEDRECORD_OFFSET UNITYSDK_OFFSET(0x19904B00)
#define SYSTEM_DATA_DATATABLE_NEWUNINITIALIZEDROW_OFFSET UNITYSDK_OFFSET(0x19904B80)
#define SYSTEM_DATA_DATATABLE_ONCOLUMNCHANGED_OFFSET UNITYSDK_OFFSET(0x199056D0)
#define SYSTEM_DATA_DATATABLE_ONCOLUMNCHANGING_OFFSET UNITYSDK_OFFSET(0x19905610)
#define SYSTEM_DATA_DATATABLE_ONINITIALIZED_OFFSET UNITYSDK_OFFSET(0x198FEB10)
#define SYSTEM_DATA_DATATABLE_ONPROPERTYCHANGING_OFFSET UNITYSDK_OFFSET(0x19905790)
#define SYSTEM_DATA_DATATABLE_ONREMOVECOLUMNINTERNAL_OFFSET UNITYSDK_OFFSET(0x19905850)
#define SYSTEM_DATA_DATATABLE_ONROWCHANGED_1_OFFSET UNITYSDK_OFFSET(0x19905860)
#define SYSTEM_DATA_DATATABLE_ONROWCHANGED_OFFSET UNITYSDK_OFFSET(0x19902C60)
#define SYSTEM_DATA_DATATABLE_ONROWCHANGING_1_OFFSET UNITYSDK_OFFSET(0x19905920)
#define SYSTEM_DATA_DATATABLE_ONROWCHANGING_OFFSET UNITYSDK_OFFSET(0x19902B60)
#define SYSTEM_DATA_DATATABLE_ONROWDELETED_OFFSET UNITYSDK_OFFSET(0x19905AA0)
#define SYSTEM_DATA_DATATABLE_ONROWDELETING_OFFSET UNITYSDK_OFFSET(0x199059E0)
#define SYSTEM_DATA_DATATABLE_ONTABLECLEARED_OFFSET UNITYSDK_OFFSET(0x19905B60)
#define SYSTEM_DATA_DATATABLE_ONTABLECLEARING_OFFSET UNITYSDK_OFFSET(0x19905C20)
#define SYSTEM_DATA_DATATABLE_ONTABLENEWROW_OFFSET UNITYSDK_OFFSET(0x19905CE0)
#define SYSTEM_DATA_DATATABLE_PARSESORTSTRING_OFFSET UNITYSDK_OFFSET(0x19903470)
#define SYSTEM_DATA_DATATABLE_RAISEPROPERTYCHANGING_OFFSET UNITYSDK_OFFSET(0x198FCDA0)
#define SYSTEM_DATA_DATATABLE_RAISEROWCHANGED_OFFSET UNITYSDK_OFFSET(0x199045F0)
#define SYSTEM_DATA_DATATABLE_RAISEROWCHANGING_1_OFFSET UNITYSDK_OFFSET(0x19903AC0)
#define SYSTEM_DATA_DATATABLE_RAISEROWCHANGING_OFFSET UNITYSDK_OFFSET(0x19907DA0)
#define SYSTEM_DATA_DATATABLE_READENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1990B6C0)
#define SYSTEM_DATA_DATATABLE_READXDRSCHEMA_OFFSET UNITYSDK_OFFSET(0x1990B750)
#define SYSTEM_DATA_DATATABLE_READXMLDIFFGRAM_OFFSET UNITYSDK_OFFSET(0x1990AAB0)
#define SYSTEM_DATA_DATATABLE_READXMLSCHEMA_OFFSET UNITYSDK_OFFSET(0x1990B7C0)
#define SYSTEM_DATA_DATATABLE_READXMLSERIALIZABLE_OFFSET UNITYSDK_OFFSET(0x1990E2B0)
#define SYSTEM_DATA_DATATABLE_READXML_OFFSET UNITYSDK_OFFSET(0x19909B00)
#define SYSTEM_DATA_DATATABLE_READXSDSCHEMA_OFFSET UNITYSDK_OFFSET(0x1990D0E0)
#define SYSTEM_DATA_DATATABLE_RECORDCHANGED_1_OFFSET UNITYSDK_OFFSET(0x19905EE0)
#define SYSTEM_DATA_DATATABLE_RECORDCHANGED_OFFSET UNITYSDK_OFFSET(0x19905DA0)
#define SYSTEM_DATA_DATATABLE_RECORDSTATECHANGED_1_OFFSET UNITYSDK_OFFSET(0x19903F30)
#define SYSTEM_DATA_DATATABLE_RECORDSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x19903DD0)
#define SYSTEM_DATA_DATATABLE_REMOVEDEPENDENTCOLUMN_OFFSET UNITYSDK_OFFSET(0x1990E410)
#define SYSTEM_DATA_DATATABLE_REMOVERECORDFROMINDEXES_OFFSET UNITYSDK_OFFSET(0x199060D0)
#define SYSTEM_DATA_DATATABLE_REMOVEROW_OFFSET UNITYSDK_OFFSET(0x19907540)
#define SYSTEM_DATA_DATATABLE_REMOVE_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x19900CF0)
#define SYSTEM_DATA_DATATABLE_RESETCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x198FA850)
#define SYSTEM_DATA_DATATABLE_RESETINDEXES_OFFSET UNITYSDK_OFFSET(0x198F4E70)
#define SYSTEM_DATA_DATATABLE_RESETINTERNALINDEXES_OFFSET UNITYSDK_OFFSET(0x19907B60)
#define SYSTEM_DATA_DATATABLE_RESET_OFFSET UNITYSDK_OFFSET(0x199077A0)
#define SYSTEM_DATA_DATATABLE_RESTORECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x19909810)
#define SYSTEM_DATA_DATATABLE_RESTOREINDEXEVENTS_OFFSET UNITYSDK_OFFSET(0x198F9CA0)
#define SYSTEM_DATA_DATATABLE_RESTORESHADOWINDEXES_OFFSET UNITYSDK_OFFSET(0x198FA0A0)
#define SYSTEM_DATA_DATATABLE_ROLLBACKROW_OFFSET UNITYSDK_OFFSET(0x19907CE0)
#define SYSTEM_DATA_DATATABLE_SELECT_OFFSET UNITYSDK_OFFSET(0x19903070)
#define SYSTEM_DATA_DATATABLE_SERIALIZECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x198F6AA0)
#define SYSTEM_DATA_DATATABLE_SERIALIZEDATATABLE_OFFSET UNITYSDK_OFFSET(0x198F0D30)
#define SYSTEM_DATA_DATATABLE_SERIALIZEEXPRESSIONCOLUMNS_OFFSET UNITYSDK_OFFSET(0x198F90C0)
#define SYSTEM_DATA_DATATABLE_SERIALIZETABLEDATA_OFFSET UNITYSDK_OFFSET(0x198F29C0)
#define SYSTEM_DATA_DATATABLE_SERIALIZETABLESCHEMA_OFFSET UNITYSDK_OFFSET(0x198F1190)
#define SYSTEM_DATA_DATATABLE_SETCASESENSITIVEVALUE_OFFSET UNITYSDK_OFFSET(0x198F7430)
#define SYSTEM_DATA_DATATABLE_SETDATASET_OFFSET UNITYSDK_OFFSET(0x198FA870)
#define SYSTEM_DATA_DATATABLE_SETKEYVALUES_OFFSET UNITYSDK_OFFSET(0x198FEEF0)
#define SYSTEM_DATA_DATATABLE_SETLOCALEVALUE_OFFSET UNITYSDK_OFFSET(0x198F77C0)
#define SYSTEM_DATA_DATATABLE_SETMERGERECORDS_OFFSET UNITYSDK_OFFSET(0x198FF0C0)
#define SYSTEM_DATA_DATATABLE_SETNEWRECORDWORKER_OFFSET UNITYSDK_OFFSET(0x19901290)
#define SYSTEM_DATA_DATATABLE_SETNEWRECORD_OFFSET UNITYSDK_OFFSET(0x198FF220)
#define SYSTEM_DATA_DATATABLE_SETOLDRECORD_OFFSET UNITYSDK_OFFSET(0x198FF2E0)
#define SYSTEM_DATA_DATATABLE_SETSHADOWINDEXES_OFFSET UNITYSDK_OFFSET(0x198FA060)
#define SYSTEM_DATA_DATATABLE_SET_CASESENSITIVE_OFFSET UNITYSDK_OFFSET(0x198F9BE0)
#define SYSTEM_DATA_DATATABLE_SET_ELEMENTCOLUMNCOUNT_OFFSET UNITYSDK_OFFSET(0x198FB7F0)
#define SYSTEM_DATA_DATATABLE_SET_ENFORCECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x198FAA50)
#define SYSTEM_DATA_DATATABLE_SET_LOCALE_OFFSET UNITYSDK_OFFSET(0x198FB220)
#define SYSTEM_DATA_DATATABLE_SET_MINIMUMCAPACITY_OFFSET UNITYSDK_OFFSET(0x198F7F10)
#define SYSTEM_DATA_DATATABLE_SET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x198F6150)
#define SYSTEM_DATA_DATATABLE_SET_PREFIX_OFFSET UNITYSDK_OFFSET(0x198FEC10)
#define SYSTEM_DATA_DATATABLE_SET_PRIMARYKEY_OFFSET UNITYSDK_OFFSET(0x198FC0A0)
#define SYSTEM_DATA_DATATABLE_SET_REMOTINGFORMAT_OFFSET UNITYSDK_OFFSET(0x198FA700)
#define SYSTEM_DATA_DATATABLE_SET_SITE_OFFSET UNITYSDK_OFFSET(0x19900D40)
#define SYSTEM_DATA_DATATABLE_SET_TABLENAME_OFFSET UNITYSDK_OFFSET(0x198FC570)
#define SYSTEM_DATA_DATATABLE_SET_XMLTEXT_OFFSET UNITYSDK_OFFSET(0x198FEE20)
#define SYSTEM_DATA_DATATABLE_SHADOWINDEXCOPY_OFFSET UNITYSDK_OFFSET(0x19908080)
#define SYSTEM_DATA_DATATABLE_SILENTLYSETVALUE_OFFSET UNITYSDK_OFFSET(0x199066E0)
#define SYSTEM_DATA_DATATABLE_SUSPENDINDEXEVENTS_OFFSET UNITYSDK_OFFSET(0x198FA0C0)
#define SYSTEM_DATA_DATATABLE_SYSTEM_COMPONENTMODEL_ILISTSOURCE_GETLIST_OFFSET UNITYSDK_OFFSET(0x19903AB0)
#define SYSTEM_DATA_DATATABLE_SYSTEM_COMPONENTMODEL_ILISTSOURCE_GET_CONTAINSLISTCOLLECTION_OFFSET UNITYSDK_OFFSET(0x199031E0)
#define SYSTEM_DATA_DATATABLE_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_GETSCHEMA_OFFSET UNITYSDK_OFFSET(0x1990DDC0)
#define SYSTEM_DATA_DATATABLE_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_READXML_OFFSET UNITYSDK_OFFSET(0x1990E050)
#define SYSTEM_DATA_DATATABLE_SYSTEM_XML_SERIALIZATION_IXMLSERIALIZABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x1990E280)
#define SYSTEM_DATA_DATATABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x199080F0)
#define SYSTEM_DATA_DATATABLE_UPDATEPROPERTYDESCRIPTORCOLLECTIONCACHE_OFFSET UNITYSDK_OFFSET(0x199084F0)
#define SYSTEM_DATA_DATATABLE_UPDATINGCURRENT_OFFSET UNITYSDK_OFFSET(0x19907D80)
#define SYSTEM_DATA_DATATABLE_WRITEXMLSCHEMA_OFFSET UNITYSDK_OFFSET(0x19909430)
#define SYSTEM_DATA_DATATABLE_WRITEXML_OFFSET UNITYSDK_OFFSET(0x19908BD0)
#define SYSTEM_DATA_DATATABLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x198F0630)
#define SYSTEM_DATA_DATATABLE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x198F0670)
#define SYSTEM_DATA_DATATABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x198F0140)

namespace System::Data
{
	inline static constexpr unsigned int DataTable_TypeDefinitionIndex = 35425;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DataTable_TypeDefinitionIndex)->GetStaticField(0x8770);
		}
