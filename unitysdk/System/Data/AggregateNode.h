...
#define SYSTEM_DATA_AGGREGATENODE_BIND_1_OFFSET UNITYSDK_OFFSET(0x1A897E60)
#define SYSTEM_DATA_AGGREGATENODE_BIND_OFFSET UNITYSDK_OFFSET(0x1A897B80)
#define SYSTEM_DATA_AGGREGATENODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1A898580)
#define SYSTEM_DATA_AGGREGATENODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1A898030)
#define SYSTEM_DATA_AGGREGATENODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1A898430)
#define SYSTEM_DATA_AGGREGATENODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1A898020)
#define SYSTEM_DATA_AGGREGATENODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A898560)
#define SYSTEM_DATA_AGGREGATENODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A898570)
#define SYSTEM_DATA_AGGREGATENODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A898540)
#define SYSTEM_DATA_AGGREGATENODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1A898550)
#define SYSTEM_DATA_AGGREGATENODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1A8985D0)
#define SYSTEM_DATA_AGGREGATENODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A897AC0)
#define SYSTEM_DATA_AGGREGATENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A897AA0)

namespace System::Data
{
	inline static constexpr unsigned int AggregateNode_TypeDefinitionIndex = 36466;
