...
#define SYSTEM_DATA_AGGREGATENODE_BIND_1_OFFSET UNITYSDK_OFFSET(0x1A2CE040)
#define SYSTEM_DATA_AGGREGATENODE_BIND_OFFSET UNITYSDK_OFFSET(0x1A2CDD60)
#define SYSTEM_DATA_AGGREGATENODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1A2CE760)
#define SYSTEM_DATA_AGGREGATENODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1A2CE210)
#define SYSTEM_DATA_AGGREGATENODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1A2CE610)
#define SYSTEM_DATA_AGGREGATENODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1A2CE200)
#define SYSTEM_DATA_AGGREGATENODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A2CE740)
#define SYSTEM_DATA_AGGREGATENODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A2CE750)
#define SYSTEM_DATA_AGGREGATENODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A2CE720)
#define SYSTEM_DATA_AGGREGATENODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1A2CE730)
#define SYSTEM_DATA_AGGREGATENODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1A2CE7B0)
#define SYSTEM_DATA_AGGREGATENODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2CDCA0)
#define SYSTEM_DATA_AGGREGATENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2CDC80)

namespace System::Data
{
	inline static constexpr unsigned int AggregateNode_TypeDefinitionIndex = 35446;
	...
	public:
		...
		::System::Boolean _local; // 0x40
		::System::Data::Aggregate _aggregate; // 0x44
