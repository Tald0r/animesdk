...
#define SYSTEM_DATA_XMLDATALOADER_ATTACHROWS_OFFSET UNITYSDK_OFFSET(0x1A3DEF20)
#define SYSTEM_DATA_XMLDATALOADER_COUNTNONNSATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A3DF190)
#define SYSTEM_DATA_XMLDATALOADER_FCOLUMNELEMENT_OFFSET UNITYSDK_OFFSET(0x1A3DFB40)
#define SYSTEM_DATA_XMLDATALOADER_FEXCLUDEDNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A3DF360)
#define SYSTEM_DATA_XMLDATALOADER_FIGNORENAMESPACE_1_OFFSET UNITYSDK_OFFSET(0x1A3DFD00)
#define SYSTEM_DATA_XMLDATALOADER_FIGNORENAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A3DFC30)
#define SYSTEM_DATA_XMLDATALOADER_GETINITIALTEXTFROMNODES_OFFSET UNITYSDK_OFFSET(0x1A3DF750)
#define SYSTEM_DATA_XMLDATALOADER_GETROWFROMELEMENT_OFFSET UNITYSDK_OFFSET(0x1A3DF100)
#define SYSTEM_DATA_XMLDATALOADER_GETTEXTONLYCOLUMN_OFFSET UNITYSDK_OFFSET(0x1A3DFA80)
#define SYSTEM_DATA_XMLDATALOADER_GETVALUEFORTEXTONLYCOLUMS_OFFSET UNITYSDK_OFFSET(0x1A3DF3F0)
#define SYSTEM_DATA_XMLDATALOADER_INITNAMETABLE_OFFSET UNITYSDK_OFFSET(0x1A3E16F0)
#define SYSTEM_DATA_XMLDATALOADER_ISTEXTLIKENODE_OFFSET UNITYSDK_OFFSET(0x1A3DF6F0)
#define SYSTEM_DATA_XMLDATALOADER_ISTEXTONLY_OFFSET UNITYSDK_OFFSET(0x1A3DFB20)
#define SYSTEM_DATA_XMLDATALOADER_LOADCOLUMN_OFFSET UNITYSDK_OFFSET(0x1A3E4240)
#define SYSTEM_DATA_XMLDATALOADER_LOADDATA_1_OFFSET UNITYSDK_OFFSET(0x1A3E1850)
#define SYSTEM_DATA_XMLDATALOADER_LOADDATA_OFFSET UNITYSDK_OFFSET(0x1A3DFD90)
#define SYSTEM_DATA_XMLDATALOADER_LOADROWDATA_OFFSET UNITYSDK_OFFSET(0x1A3E0390)
#define SYSTEM_DATA_XMLDATALOADER_LOADROWS_OFFSET UNITYSDK_OFFSET(0x1A3E1290)
#define SYSTEM_DATA_XMLDATALOADER_LOADTABLE_OFFSET UNITYSDK_OFFSET(0x1A3E2DF0)
#define SYSTEM_DATA_XMLDATALOADER_LOADTOPMOSTTABLE_OFFSET UNITYSDK_OFFSET(0x1A3E1DD0)
#define SYSTEM_DATA_XMLDATALOADER_PROCESSXSDSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A3E2BB0)
#define SYSTEM_DATA_XMLDATALOADER_SETROWVALUEFROMXMLTEXT_OFFSET UNITYSDK_OFFSET(0x1A3E1630)
#define SYSTEM_DATA_XMLDATALOADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3DEC80)
#define SYSTEM_DATA_XMLDATALOADER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A3DED80)
#define SYSTEM_DATA_XMLDATALOADER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A3DEE10)
#define SYSTEM_DATA_XMLDATALOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DEC00)

namespace System::Data
{
	inline static constexpr unsigned int XmlDataLoader_TypeDefinitionIndex = 35514;

	class XmlDataLoader : public ::System::Object
	{
	public:
		::System::Collections::Hashtable* _htableExcludedNS; // 0x10
		::System::Object* _UPDGNS; // 0x18
		::System::Collections::Stack* _childRowsStack; // 0x20
		::System::Object* _XSDNS; // 0x28
		::System::Object* _DFFNS; // 0x30
		::System::Object* _SQL_SYNC; // 0x38
		::System::Collections::Hashtable* _nodeToRowMap; // 0x40
		::System::Data::DataTable* _dataTable; // 0x48
		::System::Object* _DIFFID; // 0x50
		::System::Object* _XDRNS; // 0x58
		::System::Xml::XmlReader* _dataReader; // 0x60
		::System::Object* _XDR_SCHEMA; // 0x68
		::System::Object* _XSD_XMLNS_NS; // 0x70
		::System::Object* _ROWORDER; // 0x78
		::System::Xml::XmlElement* _topMostNode; // 0x80
		::System::Object* _MSDNS; // 0x88
		::System::Object* _XSD_SCHEMA; // 0x90
		::System::Data::XmlToDatasetMap* _nodeToSchemaMap; // 0x98
		::System::Object* _HASCHANGES; // 0xA0
		::System::Data::DataSet* _dataSet; // 0xA8
		::System::Boolean _fIsXdr; // 0xB0
		::System::Boolean _isTableLevel; // 0xB1
		::System::Boolean _isDiffgram; // 0xB2
		::System::Boolean _ignoreSchema; // 0xB3
