...
#define SYSTEM_DATA_XMLDATALOADER_ATTACHROWS_OFFSET UNITYSDK_OFFSET(0x1A9A35D0)
#define SYSTEM_DATA_XMLDATALOADER_COUNTNONNSATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A9A3840)
#define SYSTEM_DATA_XMLDATALOADER_FCOLUMNELEMENT_OFFSET UNITYSDK_OFFSET(0x1A9A41F0)
#define SYSTEM_DATA_XMLDATALOADER_FEXCLUDEDNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A9A3A10)
#define SYSTEM_DATA_XMLDATALOADER_FIGNORENAMESPACE_1_OFFSET UNITYSDK_OFFSET(0x1A9A43B0)
#define SYSTEM_DATA_XMLDATALOADER_FIGNORENAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A9A42E0)
#define SYSTEM_DATA_XMLDATALOADER_GETINITIALTEXTFROMNODES_OFFSET UNITYSDK_OFFSET(0x1A9A3E00)
#define SYSTEM_DATA_XMLDATALOADER_GETROWFROMELEMENT_OFFSET UNITYSDK_OFFSET(0x1A9A37B0)
#define SYSTEM_DATA_XMLDATALOADER_GETTEXTONLYCOLUMN_OFFSET UNITYSDK_OFFSET(0x1A9A4130)
#define SYSTEM_DATA_XMLDATALOADER_GETVALUEFORTEXTONLYCOLUMS_OFFSET UNITYSDK_OFFSET(0x1A9A3AA0)
#define SYSTEM_DATA_XMLDATALOADER_INITNAMETABLE_OFFSET UNITYSDK_OFFSET(0x1A9A5D70)
#define SYSTEM_DATA_XMLDATALOADER_ISTEXTLIKENODE_OFFSET UNITYSDK_OFFSET(0x1A9A3DA0)
#define SYSTEM_DATA_XMLDATALOADER_ISTEXTONLY_OFFSET UNITYSDK_OFFSET(0x1A9A41D0)
#define SYSTEM_DATA_XMLDATALOADER_LOADCOLUMN_OFFSET UNITYSDK_OFFSET(0x1A9A8890)
#define SYSTEM_DATA_XMLDATALOADER_LOADDATA_1_OFFSET UNITYSDK_OFFSET(0x1A9A5ED0)
#define SYSTEM_DATA_XMLDATALOADER_LOADDATA_OFFSET UNITYSDK_OFFSET(0x1A9A4440)
#define SYSTEM_DATA_XMLDATALOADER_LOADROWDATA_OFFSET UNITYSDK_OFFSET(0x1A9A4A30)
#define SYSTEM_DATA_XMLDATALOADER_LOADROWS_OFFSET UNITYSDK_OFFSET(0x1A9A5910)
#define SYSTEM_DATA_XMLDATALOADER_LOADTABLE_OFFSET UNITYSDK_OFFSET(0x1A9A7450)
#define SYSTEM_DATA_XMLDATALOADER_LOADTOPMOSTTABLE_OFFSET UNITYSDK_OFFSET(0x1A9A6430)
#define SYSTEM_DATA_XMLDATALOADER_PROCESSXSDSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A9A7210)
#define SYSTEM_DATA_XMLDATALOADER_SETROWVALUEFROMXMLTEXT_OFFSET UNITYSDK_OFFSET(0x1A9A5CB0)
#define SYSTEM_DATA_XMLDATALOADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9A3330)
#define SYSTEM_DATA_XMLDATALOADER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A9A3430)
#define SYSTEM_DATA_XMLDATALOADER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A9A34C0)
#define SYSTEM_DATA_XMLDATALOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A32B0)

namespace System::Data
{
	inline static constexpr unsigned int XmlDataLoader_TypeDefinitionIndex = 36534;

	class XmlDataLoader : public ::System::Object
	{
	public:
		::System::Xml::XmlReader* _dataReader; // 0x10
		::System::Object* _ROWORDER; // 0x18
		::System::Data::XmlToDatasetMap* _nodeToSchemaMap; // 0x20
		::System::Collections::Hashtable* _htableExcludedNS; // 0x28
		::System::Object* _MSDNS; // 0x30
		::System::Data::DataSet* _dataSet; // 0x38
		::System::Object* _SQL_SYNC; // 0x40
		::System::Object* _DIFFID; // 0x48
		::System::Object* _HASCHANGES; // 0x50
		::System::Object* _UPDGNS; // 0x58
		::System::Data::DataTable* _dataTable; // 0x60
		::System::Object* _XDR_SCHEMA; // 0x68
		::System::Collections::Hashtable* _nodeToRowMap; // 0x70
		::System::Collections::Stack* _childRowsStack; // 0x78
		::System::Object* _DFFNS; // 0x80
		::System::Object* _XSD_XMLNS_NS; // 0x88
		::System::Object* _XSDNS; // 0x90
		::System::Object* _XDRNS; // 0x98
		::System::Xml::XmlElement* _topMostNode; // 0xA0
		::System::Object* _XSD_SCHEMA; // 0xA8
		::System::Boolean _fIsXdr; // 0xB0
		::System::Boolean _fromInference; // 0xB1
		::System::Boolean _isTableLevel; // 0xB2
		::System::Boolean _isDiffgram; // 0xB3
		::System::Boolean _ignoreSchema; // 0xB4
