...
#define SYSTEM_DATA_DATAROWVIEW_ADD_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A5D6560)
#define SYSTEM_DATA_DATAROWVIEW_BEGINEDIT_OFFSET UNITYSDK_OFFSET(0x1A5D6480)
#define SYSTEM_DATA_DATAROWVIEW_CANCELEDIT_OFFSET UNITYSDK_OFFSET(0x1A5D6490)
#define SYSTEM_DATA_DATAROWVIEW_CREATECHILDVIEW_1_OFFSET UNITYSDK_OFFSET(0x1A5D5E50)
#define SYSTEM_DATA_DATAROWVIEW_CREATECHILDVIEW_OFFSET UNITYSDK_OFFSET(0x1A5D6270)
#define SYSTEM_DATA_DATAROWVIEW_ENDEDIT_OFFSET UNITYSDK_OFFSET(0x1A5D6510)
#define SYSTEM_DATA_DATAROWVIEW_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A5D5EA0)
#define SYSTEM_DATA_DATAROWVIEW_GETCOLUMNVALUE_OFFSET UNITYSDK_OFFSET(0x1A5D6100)
#define SYSTEM_DATA_DATAROWVIEW_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A5D5EB0)
#define SYSTEM_DATA_DATAROWVIEW_GETRECORD_OFFSET UNITYSDK_OFFSET(0x1A5D5FA0)
#define SYSTEM_DATA_DATAROWVIEW_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0x1A5D64E0)
#define SYSTEM_DATA_DATAROWVIEW_GET_ROWVERSIONDEFAULT_OFFSET UNITYSDK_OFFSET(0x1A5D5F40)
#define SYSTEM_DATA_DATAROWVIEW_HASRECORD_OFFSET UNITYSDK_OFFSET(0x1A5D6010)
#define SYSTEM_DATA_DATAROWVIEW_RAISEPROPERTYCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1A5D6620)
#define SYSTEM_DATA_DATAROWVIEW_REMOVE_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A5D65C0)
#define SYSTEM_DATA_DATAROWVIEW_SETCOLUMNVALUE_OFFSET UNITYSDK_OFFSET(0x1A5D61B0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A5D66B0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCLASSNAME_OFFSET UNITYSDK_OFFSET(0x1A5D6700)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCOMPONENTNAME_OFFSET UNITYSDK_OFFSET(0x1A5D6710)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1A5D6720)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETDEFAULTEVENT_OFFSET UNITYSDK_OFFSET(0x1A5D6730)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETDEFAULTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A5D6740)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEDITOR_OFFSET UNITYSDK_OFFSET(0x1A5D6750)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEVENTS_1_OFFSET UNITYSDK_OFFSET(0x1A5D67E0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEVENTS_OFFSET UNITYSDK_OFFSET(0x1A5D6760)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTIES_1_OFFSET UNITYSDK_OFFSET(0x1A5D6920)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A5D6860)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTYOWNER_OFFSET UNITYSDK_OFFSET(0x1A5D69A0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_IDATAERRORINFO_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1A5D5F00)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_IDATAERRORINFO_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A5D5EE0)
#define SYSTEM_DATA_DATAROWVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5D69B0)
#define SYSTEM_DATA_DATAROWVIEW__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5D6A40)
#define SYSTEM_DATA_DATAROWVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5D5E90)

namespace System::Data
{
	inline static constexpr unsigned int DataRowView_TypeDefinitionIndex = 35421;
	...
	public:
		...
		{
			return (::System::ComponentModel::PropertyDescriptorCollection**)Il2CppClass::FromTypeDefinitionIndex(DataRowView_TypeDefinitionIndex)->GetStaticField(0x24F40);
		}
