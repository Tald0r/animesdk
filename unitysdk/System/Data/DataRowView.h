...
#define SYSTEM_DATA_DATAROWVIEW_ADD_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AB9E2F0)
#define SYSTEM_DATA_DATAROWVIEW_BEGINEDIT_OFFSET UNITYSDK_OFFSET(0x1AB9E210)
#define SYSTEM_DATA_DATAROWVIEW_CANCELEDIT_OFFSET UNITYSDK_OFFSET(0x1AB9E220)
#define SYSTEM_DATA_DATAROWVIEW_CREATECHILDVIEW_1_OFFSET UNITYSDK_OFFSET(0x1AB9DBE0)
#define SYSTEM_DATA_DATAROWVIEW_CREATECHILDVIEW_OFFSET UNITYSDK_OFFSET(0x1AB9E000)
#define SYSTEM_DATA_DATAROWVIEW_ENDEDIT_OFFSET UNITYSDK_OFFSET(0x1AB9E2A0)
#define SYSTEM_DATA_DATAROWVIEW_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AB9DC30)
#define SYSTEM_DATA_DATAROWVIEW_GETCOLUMNVALUE_OFFSET UNITYSDK_OFFSET(0x1AB9DE90)
#define SYSTEM_DATA_DATAROWVIEW_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AB9DC40)
#define SYSTEM_DATA_DATAROWVIEW_GETRECORD_OFFSET UNITYSDK_OFFSET(0x1AB9DD30)
#define SYSTEM_DATA_DATAROWVIEW_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0x1AB9E270)
#define SYSTEM_DATA_DATAROWVIEW_GET_ROWVERSIONDEFAULT_OFFSET UNITYSDK_OFFSET(0x1AB9DCD0)
#define SYSTEM_DATA_DATAROWVIEW_HASRECORD_OFFSET UNITYSDK_OFFSET(0x1AB9DDA0)
#define SYSTEM_DATA_DATAROWVIEW_RAISEPROPERTYCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1AB9E3B0)
#define SYSTEM_DATA_DATAROWVIEW_REMOVE_PROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AB9E350)
#define SYSTEM_DATA_DATAROWVIEW_SETCOLUMNVALUE_OFFSET UNITYSDK_OFFSET(0x1AB9DF40)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AB9E440)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCLASSNAME_OFFSET UNITYSDK_OFFSET(0x1AB9E490)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCOMPONENTNAME_OFFSET UNITYSDK_OFFSET(0x1AB9E4A0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1AB9E4B0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETDEFAULTEVENT_OFFSET UNITYSDK_OFFSET(0x1AB9E4C0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETDEFAULTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1AB9E4D0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEDITOR_OFFSET UNITYSDK_OFFSET(0x1AB9E4E0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEVENTS_1_OFFSET UNITYSDK_OFFSET(0x1AB9E570)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEVENTS_OFFSET UNITYSDK_OFFSET(0x1AB9E4F0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTIES_1_OFFSET UNITYSDK_OFFSET(0x1AB9E6B0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AB9E5F0)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTYOWNER_OFFSET UNITYSDK_OFFSET(0x1AB9E740)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_IDATAERRORINFO_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1AB9DC90)
#define SYSTEM_DATA_DATAROWVIEW_SYSTEM_COMPONENTMODEL_IDATAERRORINFO_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AB9DC70)
#define SYSTEM_DATA_DATAROWVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB9E750)
#define SYSTEM_DATA_DATAROWVIEW__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB9E7E0)
#define SYSTEM_DATA_DATAROWVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB9DC20)

namespace System::Data
{
	inline static constexpr unsigned int DataRowView_TypeDefinitionIndex = 36441;
	...
	public:
		...
		{
			return (::System::ComponentModel::PropertyDescriptorCollection**)Il2CppClass::FromTypeDefinitionIndex(DataRowView_TypeDefinitionIndex)->GetStaticField(0x26970);
		}
