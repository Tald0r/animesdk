...
#define SYSTEM_DATA_DATAEXPRESSION_BIND_OFFSET UNITYSDK_OFFSET(0x1AA78A40)
#define SYSTEM_DATA_DATAEXPRESSION_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1AA75EA0)
#define SYSTEM_DATA_DATAEXPRESSION_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x1AA78C00)
#define SYSTEM_DATA_DATAEXPRESSION_EVALUATE_2_OFFSET UNITYSDK_OFFSET(0x1AA78FD0)
#define SYSTEM_DATA_DATAEXPRESSION_EVALUATE_3_OFFSET UNITYSDK_OFFSET(0x1AA78FE0)
#define SYSTEM_DATA_DATAEXPRESSION_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1AA78BF0)
#define SYSTEM_DATA_DATAEXPRESSION_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AA78BC0)
#define SYSTEM_DATA_DATAEXPRESSION_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x1AA78BE0)
#define SYSTEM_DATA_DATAEXPRESSION_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1AA79730)
#define SYSTEM_DATA_DATAEXPRESSION_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1AA79750)
#define SYSTEM_DATA_DATAEXPRESSION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA79230)
#define SYSTEM_DATA_DATAEXPRESSION_ISTABLEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1AA79630)
#define SYSTEM_DATA_DATAEXPRESSION_ISUNKNOWN_OFFSET UNITYSDK_OFFSET(0x1AA79650)
#define SYSTEM_DATA_DATAEXPRESSION_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1AA79350)
#define SYSTEM_DATA_DATAEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AA788E0)
#define SYSTEM_DATA_DATAEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA788D0)

namespace System::Data
{
	inline static constexpr unsigned int DataExpression_TypeDefinitionIndex = 36471;

	class DataExpression : public ::System::Object
	{
	public:
		::System::Data::ExpressionNode* _expr; // 0x10
		::System::Type* _dataType; // 0x18
		::Il2CppArray<::System::Data::DataColumn*>* _dependency; // 0x20
		::System::Data::DataTable* _table; // 0x28
		::System::String* _originalExpression; // 0x30
		::System::Boolean _bound; // 0x38
		::System::Boolean _parsed; // 0x39
		::System::Data::Common::StorageType _storageType; // 0x3C
