...
#define SYSTEM_DATA_DATAEXPRESSION_BIND_OFFSET UNITYSDK_OFFSET(0x1A4C6470)
#define SYSTEM_DATA_DATAEXPRESSION_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1A4C38D0)
#define SYSTEM_DATA_DATAEXPRESSION_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x1A4C6640)
#define SYSTEM_DATA_DATAEXPRESSION_EVALUATE_2_OFFSET UNITYSDK_OFFSET(0x1A4C6A10)
#define SYSTEM_DATA_DATAEXPRESSION_EVALUATE_3_OFFSET UNITYSDK_OFFSET(0x1A4C6A20)
#define SYSTEM_DATA_DATAEXPRESSION_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A4C6630)
#define SYSTEM_DATA_DATAEXPRESSION_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A4C6600)
#define SYSTEM_DATA_DATAEXPRESSION_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x1A4C6620)
#define SYSTEM_DATA_DATAEXPRESSION_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A4C7170)
#define SYSTEM_DATA_DATAEXPRESSION_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A4C7190)
#define SYSTEM_DATA_DATAEXPRESSION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A4C6C70)
#define SYSTEM_DATA_DATAEXPRESSION_ISTABLEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A4C7070)
#define SYSTEM_DATA_DATAEXPRESSION_ISUNKNOWN_OFFSET UNITYSDK_OFFSET(0x1A4C7090)
#define SYSTEM_DATA_DATAEXPRESSION_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1A4C6D90)
#define SYSTEM_DATA_DATAEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4C6310)
#define SYSTEM_DATA_DATAEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4C6300)

namespace System::Data
{
	inline static constexpr unsigned int DataExpression_TypeDefinitionIndex = 35451;
	...
	public:
		...
		::System::Data::ExpressionNode* _expr; // 0x28
