...
#define SYSTEM_DATA_XDRSCHEMA_FINDNAMETYPE_OFFSET UNITYSDK_OFFSET(0x1A147EE0)
#define SYSTEM_DATA_XDRSCHEMA_FINDTYPENODE_OFFSET UNITYSDK_OFFSET(0x1A146A90)
#define SYSTEM_DATA_XDRSCHEMA_GETINSTANCENAME_OFFSET UNITYSDK_OFFSET(0x1A148140)
#define SYSTEM_DATA_XDRSCHEMA_GETMINMAX_1_OFFSET UNITYSDK_OFFSET(0x1A148E90)
#define SYSTEM_DATA_XDRSCHEMA_GETMINMAX_OFFSET UNITYSDK_OFFSET(0x1A1474F0)
#define SYSTEM_DATA_XDRSCHEMA_HANDLECOLUMN_OFFSET UNITYSDK_OFFSET(0x1A148310)
#define SYSTEM_DATA_XDRSCHEMA_HANDLETABLE_OFFSET UNITYSDK_OFFSET(0x1A146950)
#define SYSTEM_DATA_XDRSCHEMA_HANDLETYPENODE_OFFSET UNITYSDK_OFFSET(0x1A1491B0)
#define SYSTEM_DATA_XDRSCHEMA_INSTANTIATESIMPLETABLE_OFFSET UNITYSDK_OFFSET(0x1A147510)
#define SYSTEM_DATA_XDRSCHEMA_INSTANTIATETABLE_OFFSET UNITYSDK_OFFSET(0x1A147770)
#define SYSTEM_DATA_XDRSCHEMA_ISTEXTONLYCONTENT_OFFSET UNITYSDK_OFFSET(0x1A1470D0)
#define SYSTEM_DATA_XDRSCHEMA_ISXDRFIELD_OFFSET UNITYSDK_OFFSET(0x1A147260)
#define SYSTEM_DATA_XDRSCHEMA_LOADSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A146730)
#define SYSTEM_DATA_XDRSCHEMA_PARSEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1A147FD0)
#define SYSTEM_DATA_XDRSCHEMA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1494B0)
#define SYSTEM_DATA_XDRSCHEMA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A146700)

namespace System::Data
{
	inline static constexpr unsigned int XDRSchema_TypeDefinitionIndex = 35506;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(XDRSchema_TypeDefinitionIndex)->GetStaticField(0x24FB0);
		}
		static ::System::Data::XDRSchema_NameType** StaticGet_s_enumerationNameType()
		{
			return (::System::Data::XDRSchema_NameType**)Il2CppClass::FromTypeDefinitionIndex(XDRSchema_TypeDefinitionIndex)->GetStaticField(0x24FB8);
		}
		static ::Il2CppArray<::System::Data::XDRSchema_NameType*>** StaticGet_s_mapNameTypeXdr()
		{
			return (::Il2CppArray<::System::Data::XDRSchema_NameType*>**)Il2CppClass::FromTypeDefinitionIndex(XDRSchema_TypeDefinitionIndex)->GetStaticField(0x24FC0);
		}
