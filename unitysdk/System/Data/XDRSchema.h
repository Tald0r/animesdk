...
#define SYSTEM_DATA_XDRSCHEMA_FINDNAMETYPE_OFFSET UNITYSDK_OFFSET(0x1A6C7ED0)
#define SYSTEM_DATA_XDRSCHEMA_FINDTYPENODE_OFFSET UNITYSDK_OFFSET(0x1A6C6A80)
#define SYSTEM_DATA_XDRSCHEMA_GETINSTANCENAME_OFFSET UNITYSDK_OFFSET(0x1A6C8130)
#define SYSTEM_DATA_XDRSCHEMA_GETMINMAX_1_OFFSET UNITYSDK_OFFSET(0x1A6C8E80)
#define SYSTEM_DATA_XDRSCHEMA_GETMINMAX_OFFSET UNITYSDK_OFFSET(0x1A6C74E0)
#define SYSTEM_DATA_XDRSCHEMA_HANDLECOLUMN_OFFSET UNITYSDK_OFFSET(0x1A6C8300)
#define SYSTEM_DATA_XDRSCHEMA_HANDLETABLE_OFFSET UNITYSDK_OFFSET(0x1A6C6940)
#define SYSTEM_DATA_XDRSCHEMA_HANDLETYPENODE_OFFSET UNITYSDK_OFFSET(0x1A6C91A0)
#define SYSTEM_DATA_XDRSCHEMA_INSTANTIATESIMPLETABLE_OFFSET UNITYSDK_OFFSET(0x1A6C7500)
#define SYSTEM_DATA_XDRSCHEMA_INSTANTIATETABLE_OFFSET UNITYSDK_OFFSET(0x1A6C7760)
#define SYSTEM_DATA_XDRSCHEMA_ISTEXTONLYCONTENT_OFFSET UNITYSDK_OFFSET(0x1A6C70C0)
#define SYSTEM_DATA_XDRSCHEMA_ISXDRFIELD_OFFSET UNITYSDK_OFFSET(0x1A6C7250)
#define SYSTEM_DATA_XDRSCHEMA_LOADSCHEMA_OFFSET UNITYSDK_OFFSET(0x1A6C6720)
#define SYSTEM_DATA_XDRSCHEMA_PARSEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1A6C7FC0)
#define SYSTEM_DATA_XDRSCHEMA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6C94A0)
#define SYSTEM_DATA_XDRSCHEMA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6C66F0)

namespace System::Data
{
	inline static constexpr unsigned int XDRSchema_TypeDefinitionIndex = 36526;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(XDRSchema_TypeDefinitionIndex)->GetStaticField(0x269E0);
		}
		static ::System::Data::XDRSchema_NameType** StaticGet_s_enumerationNameType()
		{
			return (::System::Data::XDRSchema_NameType**)Il2CppClass::FromTypeDefinitionIndex(XDRSchema_TypeDefinitionIndex)->GetStaticField(0x269E8);
		}
		static ::Il2CppArray<::System::Data::XDRSchema_NameType*>** StaticGet_s_mapNameTypeXdr()
		{
			return (::Il2CppArray<::System::Data::XDRSchema_NameType*>**)Il2CppClass::FromTypeDefinitionIndex(XDRSchema_TypeDefinitionIndex)->GetStaticField(0x269F0);
		}
		::System::Data::DataSet* _ds; // 0x10
		::System::Xml::XmlElement* _schemaRoot; // 0x18
		::System::String* _schemaName; // 0x20
		::System::String* _schemaUri; // 0x28
