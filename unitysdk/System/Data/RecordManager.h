...
#define SYSTEM_DATA_RECORDMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A6DEE30)
#define SYSTEM_DATA_RECORDMANAGER_COPYRECORD_OFFSET UNITYSDK_OFFSET(0x1A6DF140)
#define SYSTEM_DATA_RECORDMANAGER_FREERECORD_OFFSET UNITYSDK_OFFSET(0x1A6DEC60)
#define SYSTEM_DATA_RECORDMANAGER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A6DF0F0)
#define SYSTEM_DATA_RECORDMANAGER_GROWRECORDCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A6DE910)
#define SYSTEM_DATA_RECORDMANAGER_IMPORTRECORD_OFFSET UNITYSDK_OFFSET(0x1A6DF130)
#define SYSTEM_DATA_RECORDMANAGER_NEWCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A6DE9C0)
#define SYSTEM_DATA_RECORDMANAGER_NEWRECORDBASE_OFFSET UNITYSDK_OFFSET(0x1A6DEBE0)
#define SYSTEM_DATA_RECORDMANAGER_NORMALIZEDMINIMUMCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A6DE9E0)
#define SYSTEM_DATA_RECORDMANAGER_SETROWCACHE_OFFSET UNITYSDK_OFFSET(0x1A6DF540)
#define SYSTEM_DATA_RECORDMANAGER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A6DEDA0)
#define SYSTEM_DATA_RECORDMANAGER_SET_MINIMUMCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A6DEB80)
#define SYSTEM_DATA_RECORDMANAGER_SET_RECORDCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A6DEA20)
#define SYSTEM_DATA_RECORDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6DE890)

namespace System::Data
{
	inline static constexpr unsigned int RecordManager_TypeDefinitionIndex = 36509;

	class RecordManager : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Data::DataRow*>* _rows; // 0x10
		...
		::System::Int32 _minimumCapacity; // 0x2C
		::System::Int32 _recordCapacity; // 0x30
