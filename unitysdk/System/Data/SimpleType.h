...
#define SYSTEM_DATA_SIMPLETYPE_CANHAVEMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x1A160A50)
#define SYSTEM_DATA_SIMPLETYPE_CONVERTTOANNONYMOUSSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1A160AA0)
#define SYSTEM_DATA_SIMPLETYPE_CREATEBYTEARRAYTYPE_OFFSET UNITYSDK_OFFSET(0x1A1607A0)
#define SYSTEM_DATA_SIMPLETYPE_CREATEENUMERATEDTYPE_OFFSET UNITYSDK_OFFSET(0x1A160710)
#define SYSTEM_DATA_SIMPLETYPE_CREATELIMITEDSTRINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A160830)
#define SYSTEM_DATA_SIMPLETYPE_CREATESIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1A1608C0)
#define SYSTEM_DATA_SIMPLETYPE_GET_SIMPLETYPEQUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1A1601F0)
#define SYSTEM_DATA_SIMPLETYPE_HASCONFLICTINGDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A1609A0)
#define SYSTEM_DATA_SIMPLETYPE_ISPLAINSTRING_OFFSET UNITYSDK_OFFSET(0x1A15FFF0)
#define SYSTEM_DATA_SIMPLETYPE_LOADTYPEVALUES_OFFSET UNITYSDK_OFFSET(0x1A15F710)
#define SYSTEM_DATA_SIMPLETYPE_QUALIFIEDNAME_OFFSET UNITYSDK_OFFSET(0x1A160230)
#define SYSTEM_DATA_SIMPLETYPE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A15FFA0)
#define SYSTEM_DATA_SIMPLETYPE_TONODE_OFFSET UNITYSDK_OFFSET(0x1A1602A0)
#define SYSTEM_DATA_SIMPLETYPE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A15F5D0)
#define SYSTEM_DATA_SIMPLETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A15F570)

namespace System::Data
{
	inline static constexpr unsigned int SimpleType_TypeDefinitionIndex = 35504;
