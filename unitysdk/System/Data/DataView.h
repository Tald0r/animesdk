...
#define SYSTEM_DATA_DATAVIEW_ADDNEW_OFFSET UNITYSDK_OFFSET(0x1A136DE0)
#define SYSTEM_DATA_DATAVIEW_ADD_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A139320)
#define SYSTEM_DATA_DATAVIEW_ADD_LISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A139180)
#define SYSTEM_DATA_DATAVIEW_BEGININIT_OFFSET UNITYSDK_OFFSET(0x1A137380)
#define SYSTEM_DATA_DATAVIEW_CHECKOPEN_OFFSET UNITYSDK_OFFSET(0x1A137120)
#define SYSTEM_DATA_DATAVIEW_CHECKSORT_OFFSET UNITYSDK_OFFSET(0x1A136890)
#define SYSTEM_DATA_DATAVIEW_CHILDRELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A13BB60)
#define SYSTEM_DATA_DATAVIEW_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A1375A0)
#define SYSTEM_DATA_DATAVIEW_COLUMNCOLLECTIONCHANGEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A13C110)
#define SYSTEM_DATA_DATAVIEW_COLUMNCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A13BF40)
#define SYSTEM_DATA_DATAVIEW_COPYTO_1_OFFSET UNITYSDK_OFFSET(0x1A1379B0)
#define SYSTEM_DATA_DATAVIEW_COPYTO_OFFSET UNITYSDK_OFFSET(0x1A137600)
#define SYSTEM_DATA_DATAVIEW_CREATESORTSTRING_OFFSET UNITYSDK_OFFSET(0x1A139430)
#define SYSTEM_DATA_DATAVIEW_DELETE_1_OFFSET UNITYSDK_OFFSET(0x1A137D30)
#define SYSTEM_DATA_DATAVIEW_DELETE_OFFSET UNITYSDK_OFFSET(0x1A137D10)
#define SYSTEM_DATA_DATAVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A138160)
#define SYSTEM_DATA_DATAVIEW_ENDINIT_OFFSET UNITYSDK_OFFSET(0x1A137390)
#define SYSTEM_DATA_DATAVIEW_FINISHADDNEW_OFFSET UNITYSDK_OFFSET(0x1A137F70)
#define SYSTEM_DATA_DATAVIEW_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A1381B0)
#define SYSTEM_DATA_DATAVIEW_GETFILTER_OFFSET UNITYSDK_OFFSET(0x1A13A4D0)
#define SYSTEM_DATA_DATAVIEW_GETFINDINDEX_OFFSET UNITYSDK_OFFSET(0x1A138830)
#define SYSTEM_DATA_DATAVIEW_GETRECORD_OFFSET UNITYSDK_OFFSET(0x1A13A4E0)
#define SYSTEM_DATA_DATAVIEW_GETROWVIEW_1_OFFSET UNITYSDK_OFFSET(0x1A136D80)
#define SYSTEM_DATA_DATAVIEW_GETROWVIEW_OFFSET UNITYSDK_OFFSET(0x1A137910)
#define SYSTEM_DATA_DATAVIEW_GETROW_OFFSET UNITYSDK_OFFSET(0x1A136CB0)
#define SYSTEM_DATA_DATAVIEW_GETSORTDESCRIPTIONS_OFFSET UNITYSDK_OFFSET(0x1A13A0C0)
#define SYSTEM_DATA_DATAVIEW_GETSORTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A1390B0)
#define SYSTEM_DATA_DATAVIEW_GET_COUNTFROMINDEX_OFFSET UNITYSDK_OFFSET(0x1A136170)
#define SYSTEM_DATA_DATAVIEW_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A136150)
#define SYSTEM_DATA_DATAVIEW_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A136190)
#define SYSTEM_DATA_DATAVIEW_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A136C00)
#define SYSTEM_DATA_DATAVIEW_GET_ROWFILTER_OFFSET UNITYSDK_OFFSET(0x1A1361B0)
#define SYSTEM_DATA_DATAVIEW_GET_SORT_OFFSET UNITYSDK_OFFSET(0x1A1365A0)
#define SYSTEM_DATA_DATAVIEW_INDEXLISTCHANGEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A13A690)
#define SYSTEM_DATA_DATAVIEW_INDEXLISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A13A600)
#define SYSTEM_DATA_DATAVIEW_INDEXOFDATAROWVIEW_OFFSET UNITYSDK_OFFSET(0x1A138510)
#define SYSTEM_DATA_DATAVIEW_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A137170)
#define SYSTEM_DATA_DATAVIEW_MAINTAINDATAVIEW_OFFSET UNITYSDK_OFFSET(0x1A13A770)
#define SYSTEM_DATA_DATAVIEW_ONINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A137550)
#define SYSTEM_DATA_DATAVIEW_ONLISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A13AFA0)
#define SYSTEM_DATA_DATAVIEW_PARENTRELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A13BD50)
#define SYSTEM_DATA_DATAVIEW_REMOVE_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A139380)
#define SYSTEM_DATA_DATAVIEW_REMOVE_LISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A139250)
#define SYSTEM_DATA_DATAVIEW_RESETROWVIEWCACHE_OFFSET UNITYSDK_OFFSET(0x1A13AB40)
#define SYSTEM_DATA_DATAVIEW_RESET_OFFSET UNITYSDK_OFFSET(0x1A13B390)
#define SYSTEM_DATA_DATAVIEW_SETDATAVIEWMANAGER_OFFSET UNITYSDK_OFFSET(0x1A13B510)
#define SYSTEM_DATA_DATAVIEW_SETINDEX2_OFFSET UNITYSDK_OFFSET(0x1A135F80)
#define SYSTEM_DATA_DATAVIEW_SETINDEX_OFFSET UNITYSDK_OFFSET(0x1A13B740)
#define SYSTEM_DATA_DATAVIEW_SET_ROWFILTER_OFFSET UNITYSDK_OFFSET(0x1A136210)
#define SYSTEM_DATA_DATAVIEW_SET_ROWSTATEFILTER_OFFSET UNITYSDK_OFFSET(0x1A136460)
#define SYSTEM_DATA_DATAVIEW_SET_SORT_OFFSET UNITYSDK_OFFSET(0x1A136600)
#define SYSTEM_DATA_DATAVIEW_SET_TABLE_OFFSET UNITYSDK_OFFSET(0x1A136920)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1A1361A0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1A136910)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_ADD_OFFSET UNITYSDK_OFFSET(0x1A138360)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A1383D0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A138420)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1A138350)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1A138340)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A136BA0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A1384A0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_INSERT_OFFSET UNITYSDK_OFFSET(0x1A138690)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1A138810)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A1386E0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A136C60)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_APPLYSORT_OFFSET UNITYSDK_OFFSET(0x1A139AE0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_GET_FILTER_OFFSET UNITYSDK_OFFSET(0x1A13A090)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_GET_SORTDESCRIPTIONS_OFFSET UNITYSDK_OFFSET(0x1A13A0B0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_GET_SUPPORTSADVANCEDSORTING_OFFSET UNITYSDK_OFFSET(0x1A13A380)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_GET_SUPPORTSFILTERING_OFFSET UNITYSDK_OFFSET(0x1A13A390)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_REMOVEFILTER_OFFSET UNITYSDK_OFFSET(0x1A139FE0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_SET_FILTER_OFFSET UNITYSDK_OFFSET(0x1A13A0A0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_ADDINDEX_OFFSET UNITYSDK_OFFSET(0x1A1393E0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_ADDNEW_OFFSET UNITYSDK_OFFSET(0x1A138F50)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_APPLYSORT_OFFSET UNITYSDK_OFFSET(0x1A139410)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_FIND_OFFSET UNITYSDK_OFFSET(0x1A139530)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWEDIT_OFFSET UNITYSDK_OFFSET(0x1A138F60)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWNEW_OFFSET UNITYSDK_OFFSET(0x1A138F40)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWREMOVE_OFFSET UNITYSDK_OFFSET(0x1A138F70)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ISSORTED_OFFSET UNITYSDK_OFFSET(0x1A138FB0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A139140)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SORTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A139020)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSCHANGENOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1A138F80)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSSEARCHING_OFFSET UNITYSDK_OFFSET(0x1A138F90)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSSORTING_OFFSET UNITYSDK_OFFSET(0x1A138FA0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_REMOVEINDEX_OFFSET UNITYSDK_OFFSET(0x1A139A10)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_REMOVESORT_OFFSET UNITYSDK_OFFSET(0x1A139A40)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_ITYPEDLIST_GETITEMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A13A400)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_ITYPEDLIST_GETLISTNAME_OFFSET UNITYSDK_OFFSET(0x1A13A3A0)
#define SYSTEM_DATA_DATAVIEW_UPDATEINDEX_1_OFFSET UNITYSDK_OFFSET(0x1A13BAF0)
#define SYSTEM_DATA_DATAVIEW_UPDATEINDEX_2_OFFSET UNITYSDK_OFFSET(0x1A13B760)
#define SYSTEM_DATA_DATAVIEW_UPDATEINDEX_OFFSET UNITYSDK_OFFSET(0x1A1375E0)
#define SYSTEM_DATA_DATAVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A13C120)
#define SYSTEM_DATA_DATAVIEW__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A135EE0)
#define SYSTEM_DATA_DATAVIEW__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A135F40)
#define SYSTEM_DATA_DATAVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A135BC0)

namespace System::Data
{
	inline static constexpr unsigned int DataView_TypeDefinitionIndex = 35435;
	...
	public:
		...
		{
			return (::System::ComponentModel::ListChangedEventArgs**)Il2CppClass::FromTypeDefinitionIndex(DataView_TypeDefinitionIndex)->GetStaticField(0x24FA0);
		}
		static ::System::Int32* StaticGet_s_objectTypeCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DataView_TypeDefinitionIndex)->GetStaticField(0x89A0);
		}
		::System::Data::DataTable* _table; // 0x20
		::System::String* _delayedSort; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Data::Index*>* _findIndexes; // 0x30
		::System::Comparison_1<::System::Data::DataRow*>* _comparison; // 0x38
		::System::Data::DataViewManager* _dataViewManager; // 0x40
		::System::Data::DataViewListener* _dvListener; // 0x48
		::System::Data::Index* _index; // 0x50
		::System::Data::DataTable* _delayedTable; // 0x58
		::System::Collections::Generic::Dictionary_2<::System::Data::DataRow*, ::System::Data::DataRowView*>* _rowViewCache; // 0x60
		::System::Data::DataRow* _addNewRow; // 0x68
		::System::EventHandler* Initialized; // 0x70
		::System::String* _delayedRowFilter; // 0x78
		::System::ComponentModel::ListChangedEventHandler* _onListChanged; // 0x80
		::System::Collections::Generic::Dictionary_2<::System::Data::DataRow*, ::System::Data::DataRowView*>* _rowViewBuffer; // 0x88
		::System::ComponentModel::ListChangedEventArgs* _addNewMoved; // 0x90
		::System::Data::IFilter* _rowFilter; // 0x98
		::System::String* _sort; // 0xA0
		::System::Boolean _allowNew; // 0xA8
		::System::Boolean _shouldOpen; // 0xA9
		::System::Boolean _fInitInProgress; // 0xAA
		::System::Int32 _objectID; // 0xAC
		::System::Data::DataViewRowState _recordStates; // 0xB0
		::System::Boolean _allowEdit; // 0xB4
		::System::Boolean _locked; // 0xB5
		::System::Boolean _open; // 0xB6
		::System::Boolean _allowDelete; // 0xB7
		::System::Data::DataViewRowState _delayedRecordStates; // 0xB8
		::System::Boolean _fEndInitInProgress; // 0xBC
		::System::Boolean _applyDefaultSort; // 0xBD
