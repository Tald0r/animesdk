...
#define SYSTEM_DATA_DATAVIEW_ADDNEW_OFFSET UNITYSDK_OFFSET(0x1A6B6D70)
#define SYSTEM_DATA_DATAVIEW_ADD_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A6B9310)
#define SYSTEM_DATA_DATAVIEW_ADD_LISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A6B9190)
#define SYSTEM_DATA_DATAVIEW_BEGININIT_OFFSET UNITYSDK_OFFSET(0x1A6B7330)
#define SYSTEM_DATA_DATAVIEW_CHECKOPEN_OFFSET UNITYSDK_OFFSET(0x1A6B70C0)
#define SYSTEM_DATA_DATAVIEW_CHECKSORT_OFFSET UNITYSDK_OFFSET(0x1A6B6810)
#define SYSTEM_DATA_DATAVIEW_CHILDRELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A6BBB50)
#define SYSTEM_DATA_DATAVIEW_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A6B7560)
#define SYSTEM_DATA_DATAVIEW_COLUMNCOLLECTIONCHANGEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A6BC100)
#define SYSTEM_DATA_DATAVIEW_COLUMNCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A6BBF30)
#define SYSTEM_DATA_DATAVIEW_COPYTO_1_OFFSET UNITYSDK_OFFSET(0x1A6B7980)
#define SYSTEM_DATA_DATAVIEW_COPYTO_OFFSET UNITYSDK_OFFSET(0x1A6B75C0)
#define SYSTEM_DATA_DATAVIEW_CREATESORTSTRING_OFFSET UNITYSDK_OFFSET(0x1A6B9420)
#define SYSTEM_DATA_DATAVIEW_DELETE_1_OFFSET UNITYSDK_OFFSET(0x1A6B7D00)
#define SYSTEM_DATA_DATAVIEW_DELETE_OFFSET UNITYSDK_OFFSET(0x1A6B7CE0)
#define SYSTEM_DATA_DATAVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A6B8150)
#define SYSTEM_DATA_DATAVIEW_ENDINIT_OFFSET UNITYSDK_OFFSET(0x1A6B7340)
#define SYSTEM_DATA_DATAVIEW_FINISHADDNEW_OFFSET UNITYSDK_OFFSET(0x1A6B7F50)
#define SYSTEM_DATA_DATAVIEW_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A6B81A0)
#define SYSTEM_DATA_DATAVIEW_GETFILTER_OFFSET UNITYSDK_OFFSET(0x1A6BA4D0)
#define SYSTEM_DATA_DATAVIEW_GETFINDINDEX_OFFSET UNITYSDK_OFFSET(0x1A6B8820)
#define SYSTEM_DATA_DATAVIEW_GETRECORD_OFFSET UNITYSDK_OFFSET(0x1A6BA4E0)
#define SYSTEM_DATA_DATAVIEW_GETROWVIEW_1_OFFSET UNITYSDK_OFFSET(0x1A6B6D10)
#define SYSTEM_DATA_DATAVIEW_GETROWVIEW_OFFSET UNITYSDK_OFFSET(0x1A6B78E0)
#define SYSTEM_DATA_DATAVIEW_GETROW_OFFSET UNITYSDK_OFFSET(0x1A6B6C40)
#define SYSTEM_DATA_DATAVIEW_GETSORTDESCRIPTIONS_OFFSET UNITYSDK_OFFSET(0x1A6BA0B0)
#define SYSTEM_DATA_DATAVIEW_GETSORTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A6B90B0)
#define SYSTEM_DATA_DATAVIEW_GET_COUNTFROMINDEX_OFFSET UNITYSDK_OFFSET(0x1A6B60C0)
#define SYSTEM_DATA_DATAVIEW_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A6B60A0)
#define SYSTEM_DATA_DATAVIEW_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A6B60F0)
#define SYSTEM_DATA_DATAVIEW_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A6B6B90)
#define SYSTEM_DATA_DATAVIEW_GET_ROWFILTER_OFFSET UNITYSDK_OFFSET(0x1A6B6110)
#define SYSTEM_DATA_DATAVIEW_GET_SORT_OFFSET UNITYSDK_OFFSET(0x1A6B6510)
#define SYSTEM_DATA_DATAVIEW_INDEXLISTCHANGEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A6BA690)
#define SYSTEM_DATA_DATAVIEW_INDEXLISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A6BA600)
#define SYSTEM_DATA_DATAVIEW_INDEXOFDATAROWVIEW_OFFSET UNITYSDK_OFFSET(0x1A6B8500)
#define SYSTEM_DATA_DATAVIEW_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A6B7110)
#define SYSTEM_DATA_DATAVIEW_MAINTAINDATAVIEW_OFFSET UNITYSDK_OFFSET(0x1A6BA770)
#define SYSTEM_DATA_DATAVIEW_ONINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A6B7510)
#define SYSTEM_DATA_DATAVIEW_ONLISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A6BAFA0)
#define SYSTEM_DATA_DATAVIEW_PARENTRELATIONCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A6BBD40)
#define SYSTEM_DATA_DATAVIEW_REMOVE_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A6B9370)
#define SYSTEM_DATA_DATAVIEW_REMOVE_LISTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A6B9250)
#define SYSTEM_DATA_DATAVIEW_RESETROWVIEWCACHE_OFFSET UNITYSDK_OFFSET(0x1A6BAB40)
#define SYSTEM_DATA_DATAVIEW_RESET_OFFSET UNITYSDK_OFFSET(0x1A6BB380)
#define SYSTEM_DATA_DATAVIEW_SETDATAVIEWMANAGER_OFFSET UNITYSDK_OFFSET(0x1A6BB500)
#define SYSTEM_DATA_DATAVIEW_SETINDEX2_OFFSET UNITYSDK_OFFSET(0x1A6B5ED0)
#define SYSTEM_DATA_DATAVIEW_SETINDEX_OFFSET UNITYSDK_OFFSET(0x1A6BB730)
#define SYSTEM_DATA_DATAVIEW_SET_ROWFILTER_OFFSET UNITYSDK_OFFSET(0x1A6B6170)
#define SYSTEM_DATA_DATAVIEW_SET_ROWSTATEFILTER_OFFSET UNITYSDK_OFFSET(0x1A6B63D0)
#define SYSTEM_DATA_DATAVIEW_SET_SORT_OFFSET UNITYSDK_OFFSET(0x1A6B6570)
#define SYSTEM_DATA_DATAVIEW_SET_TABLE_OFFSET UNITYSDK_OFFSET(0x1A6B68A0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1A6B6100)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1A6B6890)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_ADD_OFFSET UNITYSDK_OFFSET(0x1A6B8350)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A6B83C0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A6B8410)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1A6B8340)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1A6B8330)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A6B6B30)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A6B8490)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_INSERT_OFFSET UNITYSDK_OFFSET(0x1A6B8680)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1A6B8800)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A6B86D0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COLLECTIONS_ILIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A6B6BF0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_APPLYSORT_OFFSET UNITYSDK_OFFSET(0x1A6B9AD0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_GET_FILTER_OFFSET UNITYSDK_OFFSET(0x1A6BA080)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_GET_SORTDESCRIPTIONS_OFFSET UNITYSDK_OFFSET(0x1A6BA0A0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_GET_SUPPORTSADVANCEDSORTING_OFFSET UNITYSDK_OFFSET(0x1A6BA370)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_GET_SUPPORTSFILTERING_OFFSET UNITYSDK_OFFSET(0x1A6BA380)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_REMOVEFILTER_OFFSET UNITYSDK_OFFSET(0x1A6B9FD0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLISTVIEW_SET_FILTER_OFFSET UNITYSDK_OFFSET(0x1A6BA090)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_ADDINDEX_OFFSET UNITYSDK_OFFSET(0x1A6B93D0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_ADDNEW_OFFSET UNITYSDK_OFFSET(0x1A6B8F40)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_APPLYSORT_OFFSET UNITYSDK_OFFSET(0x1A6B9400)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_FIND_OFFSET UNITYSDK_OFFSET(0x1A6B9520)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWEDIT_OFFSET UNITYSDK_OFFSET(0x1A6B8F50)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWNEW_OFFSET UNITYSDK_OFFSET(0x1A6B8F30)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ALLOWREMOVE_OFFSET UNITYSDK_OFFSET(0x1A6B8F60)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_ISSORTED_OFFSET UNITYSDK_OFFSET(0x1A6B8FA0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A6B9150)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SORTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A6B9010)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSCHANGENOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1A6B8F70)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSSEARCHING_OFFSET UNITYSDK_OFFSET(0x1A6B8F80)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_GET_SUPPORTSSORTING_OFFSET UNITYSDK_OFFSET(0x1A6B8F90)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_REMOVEINDEX_OFFSET UNITYSDK_OFFSET(0x1A6B9A00)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_IBINDINGLIST_REMOVESORT_OFFSET UNITYSDK_OFFSET(0x1A6B9A30)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_ITYPEDLIST_GETITEMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A6BA3F0)
#define SYSTEM_DATA_DATAVIEW_SYSTEM_COMPONENTMODEL_ITYPEDLIST_GETLISTNAME_OFFSET UNITYSDK_OFFSET(0x1A6BA390)
#define SYSTEM_DATA_DATAVIEW_UPDATEINDEX_1_OFFSET UNITYSDK_OFFSET(0x1A6BBAE0)
#define SYSTEM_DATA_DATAVIEW_UPDATEINDEX_2_OFFSET UNITYSDK_OFFSET(0x1A6BB750)
#define SYSTEM_DATA_DATAVIEW_UPDATEINDEX_OFFSET UNITYSDK_OFFSET(0x1A6B75A0)
#define SYSTEM_DATA_DATAVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6BC110)
#define SYSTEM_DATA_DATAVIEW__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6B5E30)
#define SYSTEM_DATA_DATAVIEW__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A6B5E90)
#define SYSTEM_DATA_DATAVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B5B00)

namespace System::Data
{
	inline static constexpr unsigned int DataView_TypeDefinitionIndex = 36455;
	...
	public:
		...
		{
			return (::System::ComponentModel::ListChangedEventArgs**)Il2CppClass::FromTypeDefinitionIndex(DataView_TypeDefinitionIndex)->GetStaticField(0x269D0);
		}
		static ::System::Int32* StaticGet_s_objectTypeCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DataView_TypeDefinitionIndex)->GetStaticField(0x8D00);
		}
		::System::Data::DataViewListener* _dvListener; // 0x20
		::System::Comparison_1<::System::Data::DataRow*>* _comparison; // 0x28
		::System::String* _delayedSort; // 0x30
		::System::ComponentModel::ListChangedEventHandler* _onListChanged; // 0x38
		::System::Data::Index* _index; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::Data::DataRow*, ::System::Data::DataRowView*>* _rowViewCache; // 0x48
		::System::Data::DataTable* _delayedTable; // 0x50
		::System::String* _delayedRowFilter; // 0x58
		::System::ComponentModel::ListChangedEventArgs* _addNewMoved; // 0x60
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Data::Index*>* _findIndexes; // 0x68
		::System::EventHandler* Initialized; // 0x70
		::System::Data::DataViewManager* _dataViewManager; // 0x78
		::System::Collections::Generic::Dictionary_2<::System::Data::DataRow*, ::System::Data::DataRowView*>* _rowViewBuffer; // 0x80
		::System::Data::IFilter* _rowFilter; // 0x88
		::System::String* _sort; // 0x90
		::System::Data::DataTable* _table; // 0x98
		::System::Data::DataRow* _addNewRow; // 0xA0
		::System::Boolean _fEndInitInProgress; // 0xA8
		::System::Boolean _allowEdit; // 0xA9
		::System::Boolean _open; // 0xAA
		::System::Data::DataViewRowState _delayedRecordStates; // 0xAC
		::System::Boolean _fInitInProgress; // 0xB0
		::System::Boolean _allowDelete; // 0xB1
		::System::Data::DataViewRowState _recordStates; // 0xB4
		::System::Int32 _objectID; // 0xB8
		::System::Boolean _shouldOpen; // 0xBC
		::System::Boolean _locked; // 0xBD
		::System::Boolean _applyDefaultSort; // 0xBE
		::System::Boolean _allowNew; // 0xBF
