...
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_ADDCACHE_OFFSET UNITYSDK_OFFSET(0x1A6D9070)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_ADDCORE_OFFSET UNITYSDK_OFFSET(0x1A6D90C0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_ADD_RELATIONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A6D8F70)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_ENSUREDATASET_OFFSET UNITYSDK_OFFSET(0x1A6D8D10)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_GETDATASET_OFFSET UNITYSDK_OFFSET(0x1A6D8D70)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1A6D8EB0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A6D8DD0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1A6D8D00)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_REMOVECACHE_OFFSET UNITYSDK_OFFSET(0x1A6D9210)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_REMOVECORE_OFFSET UNITYSDK_OFFSET(0x1A6D9300)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION_REMOVE_RELATIONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A6D8FF0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATATABLERELATIONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6D8BF0)

namespace System::Data
{
	inline static constexpr unsigned int DataRelationCollection_DataTableRelationCollection_TypeDefinitionIndex = 36427;
