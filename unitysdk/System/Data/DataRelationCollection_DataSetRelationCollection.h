...
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_ADDCORE_OFFSET UNITYSDK_OFFSET(0x1AA79BF0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AA79910)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_FINISHINITRELATIONS_OFFSET UNITYSDK_OFFSET(0x1AA7AAC0)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_GETDATASET_OFFSET UNITYSDK_OFFSET(0x1AA79950)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1AA79B30)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AA79960)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1AA79900)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION_REMOVECORE_OFFSET UNITYSDK_OFFSET(0x1AA7A700)
#define SYSTEM_DATA_DATARELATIONCOLLECTION_DATASETRELATIONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA79770)

namespace System::Data
{
	inline static constexpr unsigned int DataRelationCollection_DataSetRelationCollection_TypeDefinitionIndex = 36428;
