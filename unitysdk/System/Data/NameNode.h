...
#define SYSTEM_DATA_NAMENODE_BIND_OFFSET UNITYSDK_OFFSET(0x1A4D57A0)
#define SYSTEM_DATA_NAMENODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1A4D5BB0)
#define SYSTEM_DATA_NAMENODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1A4D59A0)
#define SYSTEM_DATA_NAMENODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1A4D5AF0)
#define SYSTEM_DATA_NAMENODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1A4D5950)
#define SYSTEM_DATA_NAMENODE_GET_ISSQLCOLUMN_OFFSET UNITYSDK_OFFSET(0x1A4D5780)
#define SYSTEM_DATA_NAMENODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A4D5B50)
#define SYSTEM_DATA_NAMENODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A4D5B80)
#define SYSTEM_DATA_NAMENODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A4D5B40)
#define SYSTEM_DATA_NAMENODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1A4D5AC0)
#define SYSTEM_DATA_NAMENODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1A4D5C00)
#define SYSTEM_DATA_NAMENODE_PARSENAME_OFFSET UNITYSDK_OFFSET(0x1A4D54D0)
#define SYSTEM_DATA_NAMENODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4D5770)
#define SYSTEM_DATA_NAMENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4D54A0)

namespace System::Data
{
	inline static constexpr unsigned int NameNode_TypeDefinitionIndex = 35468;
