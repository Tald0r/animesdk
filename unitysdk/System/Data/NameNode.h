...
#define SYSTEM_DATA_NAMENODE_BIND_OFFSET UNITYSDK_OFFSET(0x1AA87D60)
#define SYSTEM_DATA_NAMENODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1AA88180)
#define SYSTEM_DATA_NAMENODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1AA87F60)
#define SYSTEM_DATA_NAMENODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1AA880C0)
#define SYSTEM_DATA_NAMENODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1AA87F10)
#define SYSTEM_DATA_NAMENODE_GET_ISSQLCOLUMN_OFFSET UNITYSDK_OFFSET(0x1AA87D40)
#define SYSTEM_DATA_NAMENODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1AA88120)
#define SYSTEM_DATA_NAMENODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1AA88150)
#define SYSTEM_DATA_NAMENODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1AA88110)
#define SYSTEM_DATA_NAMENODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1AA88090)
#define SYSTEM_DATA_NAMENODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1AA881D0)
#define SYSTEM_DATA_NAMENODE_PARSENAME_OFFSET UNITYSDK_OFFSET(0x1AA87A90)
#define SYSTEM_DATA_NAMENODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AA87D30)
#define SYSTEM_DATA_NAMENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA87A60)

namespace System::Data
{
	inline static constexpr unsigned int NameNode_TypeDefinitionIndex = 36488;
