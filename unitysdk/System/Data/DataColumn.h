...
#define SYSTEM_DATA_DATACOLUMN_ADDDEPENDENTCOLUMN_OFFSET UNITYSDK_OFFSET(0x19B8B590)
#define SYSTEM_DATA_DATACOLUMN_BINDEXPRESSION_OFFSET UNITYSDK_OFFSET(0x19B87BA0)
#define SYSTEM_DATA_DATACOLUMN_CHECKCOLUMNCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x19B89A00)
#define SYSTEM_DATA_DATACOLUMN_CHECKMAXLENGTH_1_OFFSET UNITYSDK_OFFSET(0x19B89B40)
#define SYSTEM_DATA_DATACOLUMN_CHECKMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x19B88420)
#define SYSTEM_DATA_DATACOLUMN_CHECKNOTALLOWNULL_OFFSET UNITYSDK_OFFSET(0x19B84B90)
#define SYSTEM_DATA_DATACOLUMN_CHECKNULLABLE_OFFSET UNITYSDK_OFFSET(0x19B89A60)
#define SYSTEM_DATA_DATACOLUMN_CHECKUNIQUE_OFFSET UNITYSDK_OFFSET(0x19B896B0)
#define SYSTEM_DATA_DATACOLUMN_CLONE_OFFSET UNITYSDK_OFFSET(0x19B89E90)
#define SYSTEM_DATA_DATACOLUMN_COMPAREVALUETO_1_OFFSET UNITYSDK_OFFSET(0x19B89E00)
#define SYSTEM_DATA_DATACOLUMN_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x19B89C80)
#define SYSTEM_DATA_DATACOLUMN_COMPARE_OFFSET UNITYSDK_OFFSET(0x19B89C50)
#define SYSTEM_DATA_DATACOLUMN_CONVERTOBJECTTOXML_1_OFFSET UNITYSDK_OFFSET(0x19B8B350)
#define SYSTEM_DATA_DATACOLUMN_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x19B87130)
#define SYSTEM_DATA_DATACOLUMN_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x19B89E30)
#define SYSTEM_DATA_DATACOLUMN_CONVERTXMLTOOBJECT_1_OFFSET UNITYSDK_OFFSET(0x19B8B2A0)
#define SYSTEM_DATA_DATACOLUMN_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x19B8B200)
#define SYSTEM_DATA_DATACOLUMN_COPYVALUEINTOSTORE_OFFSET UNITYSDK_OFFSET(0x19B8B4A0)
#define SYSTEM_DATA_DATACOLUMN_COPY_OFFSET UNITYSDK_OFFSET(0x19B89E60)
#define SYSTEM_DATA_DATACOLUMN_FINISHINITINPROGRESS_OFFSET UNITYSDK_OFFSET(0x19B8B030)
#define SYSTEM_DATA_DATACOLUMN_FREERECORD_OFFSET UNITYSDK_OFFSET(0x19B891A0)
#define SYSTEM_DATA_DATACOLUMN_GETAGGREGATEVALUE_OFFSET UNITYSDK_OFFSET(0x19B8A480)
#define SYSTEM_DATA_DATACOLUMN_GETCOLUMNVALUEASSTRING_OFFSET UNITYSDK_OFFSET(0x19B86F30)
#define SYSTEM_DATA_DATACOLUMN_GETDATAROW_OFFSET UNITYSDK_OFFSET(0x19B88E50)
#define SYSTEM_DATA_DATACOLUMN_GETEMPTYCOLUMNSTORE_OFFSET UNITYSDK_OFFSET(0x19B8B400)
#define SYSTEM_DATA_DATACOLUMN_GETSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x19B89C20)
#define SYSTEM_DATA_DATACOLUMN_GET_AUTOINCREMENTCURRENT_OFFSET UNITYSDK_OFFSET(0x19B85E30)
#define SYSTEM_DATA_DATACOLUMN_GET_AUTOINCREMENTSEED_OFFSET UNITYSDK_OFFSET(0x19B85E80)
#define SYSTEM_DATA_DATACOLUMN_GET_AUTOINCREMENTSTEP_OFFSET UNITYSDK_OFFSET(0x19B86340)
#define SYSTEM_DATA_DATACOLUMN_GET_AUTOINCREMENT_OFFSET UNITYSDK_OFFSET(0x19B84FF0)
#define SYSTEM_DATA_DATACOLUMN_GET_AUTOINC_OFFSET UNITYSDK_OFFSET(0x19B85D00)
#define SYSTEM_DATA_DATACOLUMN_GET_CAPTION_OFFSET UNITYSDK_OFFSET(0x19B86480)
#define SYSTEM_DATA_DATACOLUMN_GET_COMPUTED_OFFSET UNITYSDK_OFFSET(0x19B871D0)
#define SYSTEM_DATA_DATACOLUMN_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x19B87490)
#define SYSTEM_DATA_DATACOLUMN_GET_ENCODEDCOLUMNNAME_OFFSET UNITYSDK_OFFSET(0x19B86C60)
#define SYSTEM_DATA_DATACOLUMN_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x19B87BD0)
#define SYSTEM_DATA_DATACOLUMN_GET_EXTENDEDPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19B87F80)
#define SYSTEM_DATA_DATACOLUMN_GET_FORMATPROVIDER_OFFSET UNITYSDK_OFFSET(0x19B86150)
#define SYSTEM_DATA_DATACOLUMN_GET_HASDATA_OFFSET UNITYSDK_OFFSET(0x19B85320)
#define SYSTEM_DATA_DATACOLUMN_GET_ISCUSTOMTYPE_OFFSET UNITYSDK_OFFSET(0x19B8A580)
#define SYSTEM_DATA_DATACOLUMN_GET_ISVALUETYPE_OFFSET UNITYSDK_OFFSET(0x19B88010)
#define SYSTEM_DATA_DATACOLUMN_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19B87100)
#define SYSTEM_DATA_DATACOLUMN_GET_LOCALE_OFFSET UNITYSDK_OFFSET(0x19B865F0)
#define SYSTEM_DATA_DATACOLUMN_GET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x19B88820)
#define SYSTEM_DATA_DATACOLUMN_GET_SORTINDEX_OFFSET UNITYSDK_OFFSET(0x19B88CB0)
#define SYSTEM_DATA_DATACOLUMN_GET_TABLE_OFFSET UNITYSDK_OFFSET(0x19B88D80)
#define SYSTEM_DATA_DATACOLUMN_HANDLEDEPENDENTCOLUMNLIST_OFFSET UNITYSDK_OFFSET(0x19B87CC0)
#define SYSTEM_DATA_DATACOLUMN_INITIALIZERECORD_OFFSET UNITYSDK_OFFSET(0x19B87F40)
#define SYSTEM_DATA_DATACOLUMN_INIT_OFFSET UNITYSDK_OFFSET(0x19B8A4F0)
#define SYSTEM_DATA_DATACOLUMN_INSURESTORAGE_OFFSET UNITYSDK_OFFSET(0x19B8B070)
#define SYSTEM_DATA_DATACOLUMN_ISAUTOINCREMENTTYPE_OFFSET UNITYSDK_OFFSET(0x19B851B0)
#define SYSTEM_DATA_DATACOLUMN_ISINRELATION_OFFSET UNITYSDK_OFFSET(0x19B871E0)
#define SYSTEM_DATA_DATACOLUMN_ISMAXLENGTHVIOLATED_OFFSET UNITYSDK_OFFSET(0x19B8A770)
#define SYSTEM_DATA_DATACOLUMN_ISNOTALLOWDBNULLVIOLATED_OFFSET UNITYSDK_OFFSET(0x19B8AE70)
#define SYSTEM_DATA_DATACOLUMN_ISVALUECUSTOMTYPEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19B8A660)
#define SYSTEM_DATA_DATACOLUMN_ONPROPERTYCHANGING_OFFSET UNITYSDK_OFFSET(0x19B8B050)
#define SYSTEM_DATA_DATACOLUMN_ONSETDATASET_OFFSET UNITYSDK_OFFSET(0x19B8B180)
#define SYSTEM_DATA_DATACOLUMN_RAISEPROPERTYCHANGING_OFFSET UNITYSDK_OFFSET(0x19B86BF0)
#define SYSTEM_DATA_DATACOLUMN_REMOVEDEPENDENTCOLUMN_OFFSET UNITYSDK_OFFSET(0x19B8B650)
#define SYSTEM_DATA_DATACOLUMN_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x19B8B0E0)
#define SYSTEM_DATA_DATACOLUMN_SETMAXLENGTHSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x19B88030)
#define SYSTEM_DATA_DATACOLUMN_SETORDINALINTERNAL_OFFSET UNITYSDK_OFFSET(0x19B88B50)
#define SYSTEM_DATA_DATACOLUMN_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x19B8B4E0)
#define SYSTEM_DATA_DATACOLUMN_SETTABLE_OFFSET UNITYSDK_OFFSET(0x19B88D90)
#define SYSTEM_DATA_DATACOLUMN_SETVALUE_OFFSET UNITYSDK_OFFSET(0x19B89070)
#define SYSTEM_DATA_DATACOLUMN_SET_ALLOWDBNULL_OFFSET UNITYSDK_OFFSET(0x19B84A00)
#define SYSTEM_DATA_DATACOLUMN_SET_AUTOINCREMENTCURRENT_OFFSET UNITYSDK_OFFSET(0x19B85EA0)
#define SYSTEM_DATA_DATACOLUMN_SET_AUTOINCREMENTSEED_OFFSET UNITYSDK_OFFSET(0x19B86230)
#define SYSTEM_DATA_DATACOLUMN_SET_AUTOINCREMENTSTEP_OFFSET UNITYSDK_OFFSET(0x19B86370)
#define SYSTEM_DATA_DATACOLUMN_SET_AUTOINCREMENT_OFFSET UNITYSDK_OFFSET(0x19B85010)
#define SYSTEM_DATA_DATACOLUMN_SET_CAPTION_OFFSET UNITYSDK_OFFSET(0x19B864A0)
#define SYSTEM_DATA_DATACOLUMN_SET_COLUMNMAPPING_OFFSET UNITYSDK_OFFSET(0x19B89730)
#define SYSTEM_DATA_DATACOLUMN_SET_COLUMNNAME_OFFSET UNITYSDK_OFFSET(0x19B86680)
#define SYSTEM_DATA_DATACOLUMN_SET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x19B85330)
#define SYSTEM_DATA_DATACOLUMN_SET_DATETIMEMODE_OFFSET UNITYSDK_OFFSET(0x19B87A90)
#define SYSTEM_DATA_DATACOLUMN_SET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x19B87690)
#define SYSTEM_DATA_DATACOLUMN_SET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x19B83DF0)
#define SYSTEM_DATA_DATACOLUMN_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19B88EB0)
#define SYSTEM_DATA_DATACOLUMN_SET_MAXLENGTH_OFFSET UNITYSDK_OFFSET(0x19B881B0)
#define SYSTEM_DATA_DATACOLUMN_SET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x19B888E0)
#define SYSTEM_DATA_DATACOLUMN_SET_PREFIX_OFFSET UNITYSDK_OFFSET(0x19B86D20)
#define SYSTEM_DATA_DATACOLUMN_SET_READONLY_OFFSET UNITYSDK_OFFSET(0x19B87BF0)
#define SYSTEM_DATA_DATACOLUMN_SET_SIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x19B83C70)
#define SYSTEM_DATA_DATACOLUMN_SET_UNIQUE_OFFSET UNITYSDK_OFFSET(0x19B891D0)
#define SYSTEM_DATA_DATACOLUMN_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B8B190)
#define SYSTEM_DATA_DATACOLUMN_UPDATECOLUMNTYPE_OFFSET UNITYSDK_OFFSET(0x19B83CE0)
#define SYSTEM_DATA_DATACOLUMN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B83940)
#define SYSTEM_DATA_DATACOLUMN__CTOR_OFFSET UNITYSDK_OFFSET(0x19B838F0)

namespace System::Data
{
	inline static constexpr unsigned int DataColumn_TypeDefinitionIndex = 35383;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DataColumn_TypeDefinitionIndex)->GetStaticField(0x89F0);
		}
		::System::String* _columnPrefix; // 0x20
		::System::String* _encodedColumnName; // 0x28
		::System::Object* _defaultValue; // 0x30
		::System::Data::Index* _sortIndex; // 0x38
		::System::String* _columnUri; // 0x40
		::System::Data::SimpleType* _simpleType; // 0x48
		::System::String* _XmlDataType_k__BackingField; // 0x50
		::System::Type* _dataType; // 0x58
		::System::Data::PropertyCollection* _extendedProperties; // 0x60
		::System::Data::Common::DataStorage* _storage; // 0x68
		::System::String* _columnName; // 0x70
		::System::Data::DataExpression* _expression; // 0x78
		::System::ComponentModel::PropertyChangedEventHandler* PropertyChanging; // 0x80
		::System::String* _caption; // 0x88
		::System::Data::AutoIncrementValue* _autoInc; // 0x90
		::System::Data::DataTable* _table; // 0x98
		::System::Collections::Generic::List_1<::System::Data::DataColumn*>* _dependentColumns; // 0xA0
		::System::Data::Common::StorageType _storageType; // 0xA8
		::System::Data::MappingType _columnMapping; // 0xAC
		::System::Boolean _isSqlType; // 0xB0
		::System::Boolean _implementsIChangeTracking; // 0xB1
		::System::Boolean _defaultValueIsNull; // 0xB2
		::System::Boolean _implementsIXMLSerializable; // 0xB3
		::System::Data::DataSetDateTime _dateTimeMode; // 0xB4
		::System::Int32 _errors; // 0xB8
		::System::Int32 _objectID; // 0xBC
		::System::Int32 _hashCode; // 0xC0
		::System::Int32 _maxLength; // 0xC4
		::System::Boolean _readOnly; // 0xC8
		::System::Boolean _implementsINullable; // 0xC9
		::System::Boolean _allowNull; // 0xCA
		::System::Int32 _ordinal; // 0xCC
		::System::Boolean _implementsIRevertibleChangeTracking; // 0xD0
		::System::Boolean _unique; // 0xD1
