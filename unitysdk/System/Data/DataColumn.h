...
#define SYSTEM_DATA_DATACOLUMN_ADDDEPENDENTCOLUMN_OFFSET UNITYSDK_OFFSET(0x1A16FD50)
#define SYSTEM_DATA_DATACOLUMN_BINDEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A16C320)
#define SYSTEM_DATA_DATACOLUMN_CHECKCOLUMNCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A16E1B0)
#define SYSTEM_DATA_DATACOLUMN_CHECKMAXLENGTH_1_OFFSET UNITYSDK_OFFSET(0x1A16E2F0)
#define SYSTEM_DATA_DATACOLUMN_CHECKMAXLENGTH_OFFSET UNITYSDK_OFFSET(0x1A16CBD0)
#define SYSTEM_DATA_DATACOLUMN_CHECKNOTALLOWNULL_OFFSET UNITYSDK_OFFSET(0x1A169390)
#define SYSTEM_DATA_DATACOLUMN_CHECKNULLABLE_OFFSET UNITYSDK_OFFSET(0x1A16E210)
#define SYSTEM_DATA_DATACOLUMN_CHECKUNIQUE_OFFSET UNITYSDK_OFFSET(0x1A16DE60)
#define SYSTEM_DATA_DATACOLUMN_CLONE_OFFSET UNITYSDK_OFFSET(0x1A16E640)
#define SYSTEM_DATA_DATACOLUMN_COMPAREVALUETO_1_OFFSET UNITYSDK_OFFSET(0x1A16E5B0)
#define SYSTEM_DATA_DATACOLUMN_COMPAREVALUETO_OFFSET UNITYSDK_OFFSET(0x1A16E430)
#define SYSTEM_DATA_DATACOLUMN_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A16E400)
#define SYSTEM_DATA_DATACOLUMN_CONVERTOBJECTTOXML_1_OFFSET UNITYSDK_OFFSET(0x1A16FB10)
#define SYSTEM_DATA_DATACOLUMN_CONVERTOBJECTTOXML_OFFSET UNITYSDK_OFFSET(0x1A16B8C0)
#define SYSTEM_DATA_DATACOLUMN_CONVERTVALUE_OFFSET UNITYSDK_OFFSET(0x1A16E5E0)
#define SYSTEM_DATA_DATACOLUMN_CONVERTXMLTOOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1A16FA60)
#define SYSTEM_DATA_DATACOLUMN_CONVERTXMLTOOBJECT_OFFSET UNITYSDK_OFFSET(0x1A16F9C0)
#define SYSTEM_DATA_DATACOLUMN_COPYVALUEINTOSTORE_OFFSET UNITYSDK_OFFSET(0x1A16FC60)
#define SYSTEM_DATA_DATACOLUMN_COPY_OFFSET UNITYSDK_OFFSET(0x1A16E610)
#define SYSTEM_DATA_DATACOLUMN_FINISHINITINPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A16F7F0)
#define SYSTEM_DATA_DATACOLUMN_FREERECORD_OFFSET UNITYSDK_OFFSET(0x1A16D950)
#define SYSTEM_DATA_DATACOLUMN_GETAGGREGATEVALUE_OFFSET UNITYSDK_OFFSET(0x1A16EC40)
#define SYSTEM_DATA_DATACOLUMN_GETCOLUMNVALUEASSTRING_OFFSET UNITYSDK_OFFSET(0x1A16B6C0)
#define SYSTEM_DATA_DATACOLUMN_GETDATAROW_OFFSET UNITYSDK_OFFSET(0x1A16D600)
#define SYSTEM_DATA_DATACOLUMN_GETEMPTYCOLUMNSTORE_OFFSET UNITYSDK_OFFSET(0x1A16FBC0)
#define SYSTEM_DATA_DATACOLUMN_GETSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1A16E3D0)
#define SYSTEM_DATA_DATACOLUMN_GET_AUTOINCREMENTCURRENT_OFFSET UNITYSDK_OFFSET(0x1A16A610)
#define SYSTEM_DATA_DATACOLUMN_GET_AUTOINCREMENTSEED_OFFSET UNITYSDK_OFFSET(0x1A16A650)
#define SYSTEM_DATA_DATACOLUMN_GET_AUTOINCREMENTSTEP_OFFSET UNITYSDK_OFFSET(0x1A16AAF0)
#define SYSTEM_DATA_DATACOLUMN_GET_AUTOINCREMENT_OFFSET UNITYSDK_OFFSET(0x1A1697F0)
#define SYSTEM_DATA_DATACOLUMN_GET_AUTOINC_OFFSET UNITYSDK_OFFSET(0x1A16A4F0)
#define SYSTEM_DATA_DATACOLUMN_GET_CAPTION_OFFSET UNITYSDK_OFFSET(0x1A16AC20)
#define SYSTEM_DATA_DATACOLUMN_GET_COMPUTED_OFFSET UNITYSDK_OFFSET(0x1A16B960)
#define SYSTEM_DATA_DATACOLUMN_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1A16BC20)
#define SYSTEM_DATA_DATACOLUMN_GET_ENCODEDCOLUMNNAME_OFFSET UNITYSDK_OFFSET(0x1A16B3F0)
#define SYSTEM_DATA_DATACOLUMN_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A16C350)
#define SYSTEM_DATA_DATACOLUMN_GET_EXTENDEDPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A16C710)
#define SYSTEM_DATA_DATACOLUMN_GET_FORMATPROVIDER_OFFSET UNITYSDK_OFFSET(0x1A16A910)
#define SYSTEM_DATA_DATACOLUMN_GET_HASDATA_OFFSET UNITYSDK_OFFSET(0x1A169B20)
#define SYSTEM_DATA_DATACOLUMN_GET_ISCUSTOMTYPE_OFFSET UNITYSDK_OFFSET(0x1A16ED40)
#define SYSTEM_DATA_DATACOLUMN_GET_ISVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1A16C7B0)
#define SYSTEM_DATA_DATACOLUMN_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A16B890)
#define SYSTEM_DATA_DATACOLUMN_GET_LOCALE_OFFSET UNITYSDK_OFFSET(0x1A16AD80)
#define SYSTEM_DATA_DATACOLUMN_GET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A16CFD0)
#define SYSTEM_DATA_DATACOLUMN_GET_SORTINDEX_OFFSET UNITYSDK_OFFSET(0x1A16D460)
#define SYSTEM_DATA_DATACOLUMN_GET_TABLE_OFFSET UNITYSDK_OFFSET(0x1A16D530)
#define SYSTEM_DATA_DATACOLUMN_HANDLEDEPENDENTCOLUMNLIST_OFFSET UNITYSDK_OFFSET(0x1A16C450)
#define SYSTEM_DATA_DATACOLUMN_INITIALIZERECORD_OFFSET UNITYSDK_OFFSET(0x1A16C6D0)
#define SYSTEM_DATA_DATACOLUMN_INIT_OFFSET UNITYSDK_OFFSET(0x1A16ECB0)
#define SYSTEM_DATA_DATACOLUMN_INSURESTORAGE_OFFSET UNITYSDK_OFFSET(0x1A16F830)
#define SYSTEM_DATA_DATACOLUMN_ISAUTOINCREMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A1699B0)
#define SYSTEM_DATA_DATACOLUMN_ISINRELATION_OFFSET UNITYSDK_OFFSET(0x1A16B970)
#define SYSTEM_DATA_DATACOLUMN_ISMAXLENGTHVIOLATED_OFFSET UNITYSDK_OFFSET(0x1A16EF30)
#define SYSTEM_DATA_DATACOLUMN_ISNOTALLOWDBNULLVIOLATED_OFFSET UNITYSDK_OFFSET(0x1A16F630)
#define SYSTEM_DATA_DATACOLUMN_ISVALUECUSTOMTYPEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A16EE20)
#define SYSTEM_DATA_DATACOLUMN_ONPROPERTYCHANGING_OFFSET UNITYSDK_OFFSET(0x1A16F810)
#define SYSTEM_DATA_DATACOLUMN_ONSETDATASET_OFFSET UNITYSDK_OFFSET(0x1A16F940)
#define SYSTEM_DATA_DATACOLUMN_RAISEPROPERTYCHANGING_OFFSET UNITYSDK_OFFSET(0x1A16B380)
#define SYSTEM_DATA_DATACOLUMN_REMOVEDEPENDENTCOLUMN_OFFSET UNITYSDK_OFFSET(0x1A16FE10)
#define SYSTEM_DATA_DATACOLUMN_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1A16F8A0)
#define SYSTEM_DATA_DATACOLUMN_SETMAXLENGTHSIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1A16C7D0)
#define SYSTEM_DATA_DATACOLUMN_SETORDINALINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A16D300)
#define SYSTEM_DATA_DATACOLUMN_SETSTORAGE_OFFSET UNITYSDK_OFFSET(0x1A16FCA0)
#define SYSTEM_DATA_DATACOLUMN_SETTABLE_OFFSET UNITYSDK_OFFSET(0x1A16D540)
#define SYSTEM_DATA_DATACOLUMN_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A16D820)
#define SYSTEM_DATA_DATACOLUMN_SET_ALLOWDBNULL_OFFSET UNITYSDK_OFFSET(0x1A169200)
#define SYSTEM_DATA_DATACOLUMN_SET_AUTOINCREMENTCURRENT_OFFSET UNITYSDK_OFFSET(0x1A16A670)
#define SYSTEM_DATA_DATACOLUMN_SET_AUTOINCREMENTSEED_OFFSET UNITYSDK_OFFSET(0x1A16A9F0)
#define SYSTEM_DATA_DATACOLUMN_SET_AUTOINCREMENTSTEP_OFFSET UNITYSDK_OFFSET(0x1A16AB10)
#define SYSTEM_DATA_DATACOLUMN_SET_AUTOINCREMENT_OFFSET UNITYSDK_OFFSET(0x1A169810)
#define SYSTEM_DATA_DATACOLUMN_SET_CAPTION_OFFSET UNITYSDK_OFFSET(0x1A16AC30)
#define SYSTEM_DATA_DATACOLUMN_SET_COLUMNMAPPING_OFFSET UNITYSDK_OFFSET(0x1A16DEE0)
#define SYSTEM_DATA_DATACOLUMN_SET_COLUMNNAME_OFFSET UNITYSDK_OFFSET(0x1A16AE10)
#define SYSTEM_DATA_DATACOLUMN_SET_DATATYPE_OFFSET UNITYSDK_OFFSET(0x1A169B30)
#define SYSTEM_DATA_DATACOLUMN_SET_DATETIMEMODE_OFFSET UNITYSDK_OFFSET(0x1A16C210)
#define SYSTEM_DATA_DATACOLUMN_SET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1A16BE20)
#define SYSTEM_DATA_DATACOLUMN_SET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A1685E0)
#define SYSTEM_DATA_DATACOLUMN_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A16D660)
#define SYSTEM_DATA_DATACOLUMN_SET_MAXLENGTH_OFFSET UNITYSDK_OFFSET(0x1A16C960)
#define SYSTEM_DATA_DATACOLUMN_SET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A16D090)
#define SYSTEM_DATA_DATACOLUMN_SET_PREFIX_OFFSET UNITYSDK_OFFSET(0x1A16B4B0)
#define SYSTEM_DATA_DATACOLUMN_SET_READONLY_OFFSET UNITYSDK_OFFSET(0x1A16C370)
#define SYSTEM_DATA_DATACOLUMN_SET_SIMPLETYPE_OFFSET UNITYSDK_OFFSET(0x1A168460)
#define SYSTEM_DATA_DATACOLUMN_SET_UNIQUE_OFFSET UNITYSDK_OFFSET(0x1A16D980)
#define SYSTEM_DATA_DATACOLUMN_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A16F950)
#define SYSTEM_DATA_DATACOLUMN_UPDATECOLUMNTYPE_OFFSET UNITYSDK_OFFSET(0x1A1684D0)
#define SYSTEM_DATA_DATACOLUMN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A168130)
#define SYSTEM_DATA_DATACOLUMN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1680E0)

namespace System::Data
{
	inline static constexpr unsigned int DataColumn_TypeDefinitionIndex = 36403;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DataColumn_TypeDefinitionIndex)->GetStaticField(0x8D50);
		}
		::System::Data::AutoIncrementValue* _autoInc; // 0x20
		::System::String* _columnPrefix; // 0x28
		::System::Data::SimpleType* _simpleType; // 0x30
		::System::String* _encodedColumnName; // 0x38
		::System::Object* _defaultValue; // 0x40
		::System::Type* _dataType; // 0x48
		::System::String* _columnUri; // 0x50
		::System::Data::Common::DataStorage* _storage; // 0x58
		::System::Data::Index* _sortIndex; // 0x60
		::System::String* _columnName; // 0x68
		::System::ComponentModel::PropertyChangedEventHandler* PropertyChanging; // 0x70
		::System::String* _caption; // 0x78
		::System::Data::DataTable* _table; // 0x80
		::System::String* _XmlDataType_k__BackingField; // 0x88
		::System::Data::DataExpression* _expression; // 0x90
		::System::Data::PropertyCollection* _extendedProperties; // 0x98
		::System::Collections::Generic::List_1<::System::Data::DataColumn*>* _dependentColumns; // 0xA0
		::System::Int32 _hashCode; // 0xA8
		::System::Int32 _objectID; // 0xAC
		::System::Int32 _maxLength; // 0xB0
		::System::Data::Common::StorageType _storageType; // 0xB4
		::System::Int32 _ordinal; // 0xB8
		::System::Data::DataSetDateTime _dateTimeMode; // 0xBC
		::System::Boolean _readOnly; // 0xC0
		::System::Boolean _defaultValueIsNull; // 0xC1
		::System::Data::MappingType _columnMapping; // 0xC4
		::System::Boolean _isSqlType; // 0xC8
		::System::Boolean _allowNull; // 0xC9
		::System::Boolean _unique; // 0xCA
		::System::Boolean _implementsIRevertibleChangeTracking; // 0xCB
		::System::Int32 _errors; // 0xCC
		::System::Boolean _implementsIChangeTracking; // 0xD0
		::System::Boolean _implementsIXMLSerializable; // 0xD1
		::System::Boolean _implementsINullable; // 0xD2
