...
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A5DABF0)
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A5DAC30)
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A5DA670)
#define SYSTEM_DATA_MERGEFAILEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5DA660)

namespace System::Data
{
	inline static constexpr unsigned int MergeFailedEventHandler_TypeDefinitionIndex = 35475;
