...
#define SYSTEM_DATA_CONSTNODE_BIND_OFFSET UNITYSDK_OFFSET(0x198EFAD0)
#define SYSTEM_DATA_CONSTNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x198EFAF0)
#define SYSTEM_DATA_CONSTNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x198EFB00)
#define SYSTEM_DATA_CONSTNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x198EFAE0)
#define SYSTEM_DATA_CONSTNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x198EFB30)
#define SYSTEM_DATA_CONSTNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x198EFB40)
#define SYSTEM_DATA_CONSTNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x198EFB10)
#define SYSTEM_DATA_CONSTNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x198EFB20)
#define SYSTEM_DATA_CONSTNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x198EFB50)
#define SYSTEM_DATA_CONSTNODE_SMALLESTDECIMAL_OFFSET UNITYSDK_OFFSET(0x198EF6F0)
#define SYSTEM_DATA_CONSTNODE_SMALLESTNUMERIC_OFFSET UNITYSDK_OFFSET(0x198EF210)
#define SYSTEM_DATA_CONSTNODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x198EF050)
#define SYSTEM_DATA_CONSTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x198EF030)

namespace System::Data
{
	inline static constexpr unsigned int ConstNode_TypeDefinitionIndex = 35450;
