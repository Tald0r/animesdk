...
#define SYSTEM_DATA_CONSTNODE_BIND_OFFSET UNITYSDK_OFFSET(0x19E49DA0)
#define SYSTEM_DATA_CONSTNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x19E49DC0)
#define SYSTEM_DATA_CONSTNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x19E49DD0)
#define SYSTEM_DATA_CONSTNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x19E49DB0)
#define SYSTEM_DATA_CONSTNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x19E49E00)
#define SYSTEM_DATA_CONSTNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x19E49E10)
#define SYSTEM_DATA_CONSTNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x19E49DE0)
#define SYSTEM_DATA_CONSTNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x19E49DF0)
#define SYSTEM_DATA_CONSTNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x19E49E20)
#define SYSTEM_DATA_CONSTNODE_SMALLESTDECIMAL_OFFSET UNITYSDK_OFFSET(0x19E499C0)
#define SYSTEM_DATA_CONSTNODE_SMALLESTNUMERIC_OFFSET UNITYSDK_OFFSET(0x19E494E0)
#define SYSTEM_DATA_CONSTNODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19E49320)
#define SYSTEM_DATA_CONSTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E49300)

namespace System::Data
{
	inline static constexpr unsigned int ConstNode_TypeDefinitionIndex = 36470;
