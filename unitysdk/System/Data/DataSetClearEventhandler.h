...
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A2DBC60)
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A2DBCA0)
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A2DB6E0)
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2DB6D0)

namespace System::Data
{
	inline static constexpr unsigned int DataSetClearEventhandler_TypeDefinitionIndex = 35418;
