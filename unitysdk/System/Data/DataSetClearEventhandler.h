...
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A8A5A60)
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A8A5AA0)
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A8A54E0)
#define SYSTEM_DATA_DATASETCLEAREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8A54C0)

namespace System::Data
{
	inline static constexpr unsigned int DataSetClearEventhandler_TypeDefinitionIndex = 36438;
