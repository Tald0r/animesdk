...
#define SYSTEM_DATA_RELATIONSHIPCONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1A142EC0)
#define SYSTEM_DATA_RELATIONSHIPCONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1A142F30)
#define SYSTEM_DATA_RELATIONSHIPCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A142EB0)

namespace System::Data
{
	inline static constexpr unsigned int RelationshipConverter_TypeDefinitionIndex = 35491;
