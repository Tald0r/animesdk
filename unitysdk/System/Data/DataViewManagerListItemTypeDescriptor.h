...
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_GETDATAVIEW_OFFSET UNITYSDK_OFFSET(0x1AFDD9A0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AFDDA70)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCLASSNAME_OFFSET UNITYSDK_OFFSET(0x1AFDDAC0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCOMPONENTNAME_OFFSET UNITYSDK_OFFSET(0x1AFDDAD0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1AFDDAE0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETDEFAULTEVENT_OFFSET UNITYSDK_OFFSET(0x1AFDDAF0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETDEFAULTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1AFDDB00)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEDITOR_OFFSET UNITYSDK_OFFSET(0x1AFDDB10)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEVENTS_1_OFFSET UNITYSDK_OFFSET(0x1AFDDBA0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEVENTS_OFFSET UNITYSDK_OFFSET(0x1AFDDB20)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTIES_1_OFFSET UNITYSDK_OFFSET(0x1AFDDCE0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AFDDC20)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTYOWNER_OFFSET UNITYSDK_OFFSET(0x1AFDDF60)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFDDA60)

namespace System::Data
{
	inline static constexpr unsigned int DataViewManagerListItemTypeDescriptor_TypeDefinitionIndex = 36459;
