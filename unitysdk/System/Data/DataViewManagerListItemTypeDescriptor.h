...
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_GETDATAVIEW_OFFSET UNITYSDK_OFFSET(0x1A9EDC70)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A9EDD40)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCLASSNAME_OFFSET UNITYSDK_OFFSET(0x1A9EDD90)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCOMPONENTNAME_OFFSET UNITYSDK_OFFSET(0x1A9EDDA0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1A9EDDB0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETDEFAULTEVENT_OFFSET UNITYSDK_OFFSET(0x1A9EDDC0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETDEFAULTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A9EDDD0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEDITOR_OFFSET UNITYSDK_OFFSET(0x1A9EDDE0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEVENTS_1_OFFSET UNITYSDK_OFFSET(0x1A9EDE70)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETEVENTS_OFFSET UNITYSDK_OFFSET(0x1A9EDDF0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTIES_1_OFFSET UNITYSDK_OFFSET(0x1A9EDFB0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A9EDEF0)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR_SYSTEM_COMPONENTMODEL_ICUSTOMTYPEDESCRIPTOR_GETPROPERTYOWNER_OFFSET UNITYSDK_OFFSET(0x1A9EE230)
#define SYSTEM_DATA_DATAVIEWMANAGERLISTITEMTYPEDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9EDD30)

namespace System::Data
{
	inline static constexpr unsigned int DataViewManagerListItemTypeDescriptor_TypeDefinitionIndex = 35439;
