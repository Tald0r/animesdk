...
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDENTETY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1990F390)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDENTETY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1990F300)
#define SYSTEM_DATA_XMLTODATASETMAP_XMLNODEIDENTETY__CTOR_OFFSET UNITYSDK_OFFSET(0x1990F2F0)

namespace System::Data
{
	inline static constexpr unsigned int XmlToDatasetMap_XmlNodeIdentety_TypeDefinitionIndex = 35517;
