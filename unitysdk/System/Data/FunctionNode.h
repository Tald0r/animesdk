...
#define SYSTEM_DATA_FUNCTIONNODE_ADDARGUMENT_OFFSET UNITYSDK_OFFSET(0x1AD9C610)
#define SYSTEM_DATA_FUNCTIONNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1AD9C860)
#define SYSTEM_DATA_FUNCTIONNODE_CHECK_OFFSET UNITYSDK_OFFSET(0x1AD9CC40)
#define SYSTEM_DATA_FUNCTIONNODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1ADA00E0)
#define SYSTEM_DATA_FUNCTIONNODE_EVALFUNCTION_OFFSET UNITYSDK_OFFSET(0x1AD9DF40)
#define SYSTEM_DATA_FUNCTIONNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1AD9CF30)
#define SYSTEM_DATA_FUNCTIONNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1AD9FE80)
#define SYSTEM_DATA_FUNCTIONNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1AD9CF20)
#define SYSTEM_DATA_FUNCTIONNODE_GETDATATYPE_OFFSET UNITYSDK_OFFSET(0x1AD9DD80)
#define SYSTEM_DATA_FUNCTIONNODE_GET_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1ADA04A0)
#define SYSTEM_DATA_FUNCTIONNODE_GET_ISAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1ADA0550)
#define SYSTEM_DATA_FUNCTIONNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1AD9FFE0)
#define SYSTEM_DATA_FUNCTIONNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1ADA0060)
#define SYSTEM_DATA_FUNCTIONNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1AD9FED0)
#define SYSTEM_DATA_FUNCTIONNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1AD9FF60)
#define SYSTEM_DATA_FUNCTIONNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1ADA0160)
#define SYSTEM_DATA_FUNCTIONNODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ADA08F0)
#define SYSTEM_DATA_FUNCTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD9C4C0)

namespace System::Data
{
	inline static constexpr unsigned int FunctionNode_TypeDefinitionIndex = 36483;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Data::Function*>**)Il2CppClass::FromTypeDefinitionIndex(FunctionNode_TypeDefinitionIndex)->GetStaticField(0x26A40);
		}
