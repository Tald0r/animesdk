...
#define SYSTEM_DATA_FUNCTIONNODE_ADDARGUMENT_OFFSET UNITYSDK_OFFSET(0x1A7BA970)
#define SYSTEM_DATA_FUNCTIONNODE_BIND_OFFSET UNITYSDK_OFFSET(0x1A7BABC0)
#define SYSTEM_DATA_FUNCTIONNODE_CHECK_OFFSET UNITYSDK_OFFSET(0x1A7BAFA0)
#define SYSTEM_DATA_FUNCTIONNODE_DEPENDSON_OFFSET UNITYSDK_OFFSET(0x1A7BE440)
#define SYSTEM_DATA_FUNCTIONNODE_EVALFUNCTION_OFFSET UNITYSDK_OFFSET(0x1A7BC2A0)
#define SYSTEM_DATA_FUNCTIONNODE_EVAL_1_OFFSET UNITYSDK_OFFSET(0x1A7BB290)
#define SYSTEM_DATA_FUNCTIONNODE_EVAL_2_OFFSET UNITYSDK_OFFSET(0x1A7BE1E0)
#define SYSTEM_DATA_FUNCTIONNODE_EVAL_OFFSET UNITYSDK_OFFSET(0x1A7BB280)
#define SYSTEM_DATA_FUNCTIONNODE_GETDATATYPE_OFFSET UNITYSDK_OFFSET(0x1A7BC0E0)
#define SYSTEM_DATA_FUNCTIONNODE_GET_AGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A7BE800)
#define SYSTEM_DATA_FUNCTIONNODE_GET_ISAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A7BE8B0)
#define SYSTEM_DATA_FUNCTIONNODE_HASLOCALAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A7BE340)
#define SYSTEM_DATA_FUNCTIONNODE_HASREMOTEAGGREGATE_OFFSET UNITYSDK_OFFSET(0x1A7BE3C0)
#define SYSTEM_DATA_FUNCTIONNODE_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x1A7BE230)
#define SYSTEM_DATA_FUNCTIONNODE_ISTABLECONSTANT_OFFSET UNITYSDK_OFFSET(0x1A7BE2C0)
#define SYSTEM_DATA_FUNCTIONNODE_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1A7BE4C0)
#define SYSTEM_DATA_FUNCTIONNODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7BEC50)
#define SYSTEM_DATA_FUNCTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7BA820)

namespace System::Data
{
	inline static constexpr unsigned int FunctionNode_TypeDefinitionIndex = 35463;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Data::Function*>**)Il2CppClass::FromTypeDefinitionIndex(FunctionNode_TypeDefinitionIndex)->GetStaticField(0x25010);
		}
