...
#define SYSTEM_DATA_RANGE_CHECKNULL_OFFSET UNITYSDK_OFFSET(0x876220)
#define SYSTEM_DATA_RANGE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x8761B0)
#define SYSTEM_DATA_RANGE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x5655B0)
#define SYSTEM_DATA_RANGE_GET_MIN_OFFSET UNITYSDK_OFFSET(0x8761D0)
#define SYSTEM_DATA_RANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x876150)

namespace System::Data
{
	inline static constexpr unsigned int Range_TypeDefinitionIndex = 36500;
