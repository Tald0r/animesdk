...
#define SYSTEM_DATA_RANGE_CHECKNULL_OFFSET UNITYSDK_OFFSET(0x847810)
#define SYSTEM_DATA_RANGE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x8477A0)
#define SYSTEM_DATA_RANGE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x5F25F0)
#define SYSTEM_DATA_RANGE_GET_MIN_OFFSET UNITYSDK_OFFSET(0x8477C0)
#define SYSTEM_DATA_RANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x847740)

namespace System::Data
{
	inline static constexpr unsigned int Range_TypeDefinitionIndex = 35480;
