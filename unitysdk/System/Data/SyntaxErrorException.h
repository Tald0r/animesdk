...
#define SYSTEM_DATA_SYNTAXERROREXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4D7BA0)
#define SYSTEM_DATA_SYNTAXERROREXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A4D7C40)
#define SYSTEM_DATA_SYNTAXERROREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4D7B50)

namespace System::Data
{
	inline static constexpr unsigned int SyntaxErrorException_TypeDefinitionIndex = 35461;
