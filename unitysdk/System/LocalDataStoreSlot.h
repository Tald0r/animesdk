...
#define SYSTEM_LOCALDATASTORESLOT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A137010)
#define SYSTEM_LOCALDATASTORESLOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A137090)
#define SYSTEM_LOCALDATASTORESLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A137000)
