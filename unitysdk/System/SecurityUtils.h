...
#define SYSTEM_SECURITYUTILS_ARRAYCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19D805B0)
#define SYSTEM_SECURITYUTILS_CONSTRUCTORINFOINVOKE_OFFSET UNITYSDK_OFFSET(0x19D80510)
#define SYSTEM_SECURITYUTILS_DEMANDGRANTSET_OFFSET UNITYSDK_OFFSET(0x19D7FFD0)
#define SYSTEM_SECURITYUTILS_DEMANDREFLECTIONACCESS_OFFSET UNITYSDK_OFFSET(0x19D7FFC0)
#define SYSTEM_SECURITYUTILS_FIELDINFOGETVALUE_OFFSET UNITYSDK_OFFSET(0x19D80390)
#define SYSTEM_SECURITYUTILS_GENERICARGUMENTSAREVISIBLE_OFFSET UNITYSDK_OFFSET(0x19D802E0)
#define SYSTEM_SECURITYUTILS_GET_MEMBERACCESSPERMISSION_OFFSET UNITYSDK_OFFSET(0x19D7FE60)
#define SYSTEM_SECURITYUTILS_GET_RESTRICTEDMEMBERACCESSPERMISSION_OFFSET UNITYSDK_OFFSET(0x19D7FF10)
#define SYSTEM_SECURITYUTILS_HASREFLECTIONPERMISSION_OFFSET UNITYSDK_OFFSET(0x19D7FFE0)
#define SYSTEM_SECURITYUTILS_METHODINFOINVOKE_OFFSET UNITYSDK_OFFSET(0x19D80430)
#define SYSTEM_SECURITYUTILS_SECURECONSTRUCTORINVOKE_1_OFFSET UNITYSDK_OFFSET(0x19D801D0)
#define SYSTEM_SECURITYUTILS_SECURECONSTRUCTORINVOKE_OFFSET UNITYSDK_OFFSET(0x19D801B0)
#define SYSTEM_SECURITYUTILS_SECURECREATEINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x19D80080)
#define SYSTEM_SECURITYUTILS_SECURECREATEINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x19D80120)
#define SYSTEM_SECURITYUTILS_SECURECREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19D7FFF0)
#define SYSTEM_SECURITYUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D80610)
