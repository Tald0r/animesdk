...
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_EXITTIME_OFFSET UNITYSDK_OFFSET(0x18BA25D0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_PRIVILEGEDPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x18BA25E0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x18BA25C0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_TOTALPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x18BA2600)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_USERPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x18BA25F0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES__CTOR_OFFSET UNITYSDK_OFFSET(0x18BA2610)
...
namespace System::Diagnostics
{
	...
	public:
		...
		::System::Int64 create; // 0x18
		::System::Int64 exit; // 0x20
