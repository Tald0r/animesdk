...
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_EXITTIME_OFFSET UNITYSDK_OFFSET(0x18591870)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_PRIVILEGEDPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x18591880)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x18591860)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_TOTALPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x185918A0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES_GET_USERPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x18591890)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREADTIMES__CTOR_OFFSET UNITYSDK_OFFSET(0x185918B0)
