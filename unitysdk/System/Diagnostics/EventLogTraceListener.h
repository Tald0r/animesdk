...
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_GET_EVENTLOG_OFFSET UNITYSDK_OFFSET(0x1A334420)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_SET_EVENTLOG_OFFSET UNITYSDK_OFFSET(0x1A334460)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1A3344E0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_WRITE_OFFSET UNITYSDK_OFFSET(0x1A3344A0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3343A0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A3343E0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A334360)
