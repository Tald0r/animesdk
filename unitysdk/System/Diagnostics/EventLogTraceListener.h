...
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_GET_EVENTLOG_OFFSET UNITYSDK_OFFSET(0x19D75F30)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_SET_EVENTLOG_OFFSET UNITYSDK_OFFSET(0x19D75F70)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x19D75FF0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER_WRITE_OFFSET UNITYSDK_OFFSET(0x19D75FB0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D75EB0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19D75EF0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D75E70)
