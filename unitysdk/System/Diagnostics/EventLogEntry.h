...
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_EQUALS_OFFSET UNITYSDK_OFFSET(0x18591720)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_CATEGORYNUMBER_OFFSET UNITYSDK_OFFSET(0x185913E0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x185913A0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_DATA_OFFSET UNITYSDK_OFFSET(0x18591420)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_ENTRYTYPE_OFFSET UNITYSDK_OFFSET(0x18591460)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x185914A0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x185914E0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x18591520)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x18591560)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x185915A0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_REPLACEMENTSTRINGS_OFFSET UNITYSDK_OFFSET(0x185915E0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_SOURCE_OFFSET UNITYSDK_OFFSET(0x18591620)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_TIMEGENERATED_OFFSET UNITYSDK_OFFSET(0x18591660)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_TIMEWRITTEN_OFFSET UNITYSDK_OFFSET(0x185916A0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x185916E0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18591760)
#define SYSTEM_DIAGNOSTICS_EVENTLOGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x18591360)
