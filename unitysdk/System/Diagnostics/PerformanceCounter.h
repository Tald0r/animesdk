...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_BEGININIT_OFFSET UNITYSDK_OFFSET(0x1931C710)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_CLOSESHAREDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1931C790)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1931C750)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_DECREMENT_OFFSET UNITYSDK_OFFSET(0x1931C7D0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_ENDINIT_OFFSET UNITYSDK_OFFSET(0x1931C810)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_GET_CATEGORYNAME_OFFSET UNITYSDK_OFFSET(0x1931C310)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_GET_COUNTERHELP_OFFSET UNITYSDK_OFFSET(0x1931C390)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_GET_COUNTERNAME_OFFSET UNITYSDK_OFFSET(0x1931C3D0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_GET_COUNTERTYPE_OFFSET UNITYSDK_OFFSET(0x1931C450)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_GET_INSTANCELIFETIME_OFFSET UNITYSDK_OFFSET(0x1931C490)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_GET_INSTANCENAME_OFFSET UNITYSDK_OFFSET(0x1931C510)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x1931C590)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_GET_RAWVALUE_OFFSET UNITYSDK_OFFSET(0x1931C610)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_GET_READONLY_OFFSET UNITYSDK_OFFSET(0x1931C690)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_INCREMENTBY_OFFSET UNITYSDK_OFFSET(0x1931C890)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_INCREMENT_OFFSET UNITYSDK_OFFSET(0x1931C850)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_NEXTSAMPLE_OFFSET UNITYSDK_OFFSET(0x1931C8D0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_NEXTVALUE_OFFSET UNITYSDK_OFFSET(0x1931C910)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_REMOVEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1931C950)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_SET_CATEGORYNAME_OFFSET UNITYSDK_OFFSET(0x1931C350)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_SET_COUNTERNAME_OFFSET UNITYSDK_OFFSET(0x1931C410)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_SET_INSTANCELIFETIME_OFFSET UNITYSDK_OFFSET(0x1931C4D0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_SET_INSTANCENAME_OFFSET UNITYSDK_OFFSET(0x1931C550)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_SET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x1931C5D0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_SET_RAWVALUE_OFFSET UNITYSDK_OFFSET(0x1931C650)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER_SET_READONLY_OFFSET UNITYSDK_OFFSET(0x1931C6D0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1931C1D0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1931C210)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1931C250)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1931C290)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1931C2D0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1931C190)
...
namespace System::Diagnostics
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PerformanceCounter_TypeDefinitionIndex)->GetStaticField(0x11E20);
		}
