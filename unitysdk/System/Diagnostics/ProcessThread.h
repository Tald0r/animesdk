...
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_BASEPRIORITY_OFFSET UNITYSDK_OFFSET(0x18FDFCD0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_CURRENTPRIORITY_OFFSET UNITYSDK_OFFSET(0x18FDFCE0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_ID_OFFSET UNITYSDK_OFFSET(0x18FDFCF0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_PRIORITYBOOSTENABLED_OFFSET UNITYSDK_OFFSET(0x18FDFD10)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_PRIORITYLEVEL_OFFSET UNITYSDK_OFFSET(0x18FDFD30)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_PRIVILEGEDPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x18FDFD50)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_STARTADDRESS_OFFSET UNITYSDK_OFFSET(0x18FDFD70)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x18FDFD80)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_THREADSTATE_OFFSET UNITYSDK_OFFSET(0x18FDFD90)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_TOTALPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x18FDFDA0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_USERPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x18FDFDB0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_WAITREASON_OFFSET UNITYSDK_OFFSET(0x18FDFDC0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_RESETIDEALPROCESSOR_OFFSET UNITYSDK_OFFSET(0x18FDFDD0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_IDEALPROCESSOR_OFFSET UNITYSDK_OFFSET(0x18FDFD00)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_PRIORITYBOOSTENABLED_OFFSET UNITYSDK_OFFSET(0x18FDFD20)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_PRIORITYLEVEL_OFFSET UNITYSDK_OFFSET(0x18FDFD40)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_PROCESSORAFFINITY_OFFSET UNITYSDK_OFFSET(0x18FDFD60)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDFC80)
