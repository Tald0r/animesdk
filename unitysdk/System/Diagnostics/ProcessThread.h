...
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_BASEPRIORITY_OFFSET UNITYSDK_OFFSET(0x193711B0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_CURRENTPRIORITY_OFFSET UNITYSDK_OFFSET(0x193711C0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_ID_OFFSET UNITYSDK_OFFSET(0x193711D0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_PRIORITYBOOSTENABLED_OFFSET UNITYSDK_OFFSET(0x193711F0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_PRIORITYLEVEL_OFFSET UNITYSDK_OFFSET(0x19371210)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_PRIVILEGEDPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x19371230)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_STARTADDRESS_OFFSET UNITYSDK_OFFSET(0x19371250)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x19371260)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_THREADSTATE_OFFSET UNITYSDK_OFFSET(0x19371270)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_TOTALPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x19371280)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_USERPROCESSORTIME_OFFSET UNITYSDK_OFFSET(0x19371290)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_GET_WAITREASON_OFFSET UNITYSDK_OFFSET(0x193712A0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_RESETIDEALPROCESSOR_OFFSET UNITYSDK_OFFSET(0x193712B0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_IDEALPROCESSOR_OFFSET UNITYSDK_OFFSET(0x193711E0)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_PRIORITYBOOSTENABLED_OFFSET UNITYSDK_OFFSET(0x19371200)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_PRIORITYLEVEL_OFFSET UNITYSDK_OFFSET(0x19371220)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD_SET_PROCESSORAFFINITY_OFFSET UNITYSDK_OFFSET(0x19371240)
#define SYSTEM_DIAGNOSTICS_PROCESSTHREAD__CTOR_OFFSET UNITYSDK_OFFSET(0x19371160)
