...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x191CAC30)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_GET_CATEGORYNAME_OFFSET UNITYSDK_OFFSET(0x191CAAB0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x191CAB30)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x191CABB0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_SET_CATEGORYNAME_OFFSET UNITYSDK_OFFSET(0x191CAAF0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_SET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x191CAB70)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE_SET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x191CABF0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x191CAAA0)
