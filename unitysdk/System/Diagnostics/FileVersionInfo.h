...
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_APPENDFORMAT_OFFSET UNITYSDK_OFFSET(0x197E5290)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GETVERSIONINFO_INTERNAL_OFFSET UNITYSDK_OFFSET(0x197E5140)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GETVERSIONINFO_OFFSET UNITYSDK_OFFSET(0x197E5150)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_COMMENTS_OFFSET UNITYSDK_OFFSET(0x197E4F90)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_COMPANYNAME_OFFSET UNITYSDK_OFFSET(0x197E4FA0)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_FILEBUILDPART_OFFSET UNITYSDK_OFFSET(0x197E4FB0)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_FILEDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x197E4FC0)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_FILEMAJORPART_OFFSET UNITYSDK_OFFSET(0x197E4FD0)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_FILEMINORPART_OFFSET UNITYSDK_OFFSET(0x197E4FE0)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x197E4FF0)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_FILEPRIVATEPART_OFFSET UNITYSDK_OFFSET(0x197E5000)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_FILEVERSION_OFFSET UNITYSDK_OFFSET(0x197E5010)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_INTERNALNAME_OFFSET UNITYSDK_OFFSET(0x197E5020)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_ISDEBUG_OFFSET UNITYSDK_OFFSET(0x197E5030)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_ISPATCHED_OFFSET UNITYSDK_OFFSET(0x197E5040)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_ISPRERELEASE_OFFSET UNITYSDK_OFFSET(0x197E5050)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_ISPRIVATEBUILD_OFFSET UNITYSDK_OFFSET(0x197E5060)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_ISSPECIALBUILD_OFFSET UNITYSDK_OFFSET(0x197E5070)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_LANGUAGE_OFFSET UNITYSDK_OFFSET(0x197E5080)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_LEGALCOPYRIGHT_OFFSET UNITYSDK_OFFSET(0x197E5090)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_LEGALTRADEMARKS_OFFSET UNITYSDK_OFFSET(0x197E50A0)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_ORIGINALFILENAME_OFFSET UNITYSDK_OFFSET(0x197E50B0)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_PRIVATEBUILD_OFFSET UNITYSDK_OFFSET(0x197E50C0)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_PRODUCTBUILDPART_OFFSET UNITYSDK_OFFSET(0x197E50D0)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_PRODUCTMAJORPART_OFFSET UNITYSDK_OFFSET(0x197E50E0)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_PRODUCTMINORPART_OFFSET UNITYSDK_OFFSET(0x197E50F0)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_PRODUCTNAME_OFFSET UNITYSDK_OFFSET(0x197E5100)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_PRODUCTPRIVATEPART_OFFSET UNITYSDK_OFFSET(0x197E5110)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_PRODUCTVERSION_OFFSET UNITYSDK_OFFSET(0x197E5120)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_GET_SPECIALBUILD_OFFSET UNITYSDK_OFFSET(0x197E5130)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x197E5340)
#define SYSTEM_DIAGNOSTICS_FILEVERSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x197E4F40)
...
namespace System::Diagnostics
{
	...
	public:
		...
		::System::String* productversion; // 0x20
		::System::String* filedescription; // 0x28
		::System::String* specialbuild; // 0x30
		::System::String* fileversion; // 0x38
		::System::String* originalfilename; // 0x40
		::System::String* privatebuild; // 0x48
		::System::String* legalcopyright; // 0x50
		::System::String* legaltrademarks; // 0x58
		::System::String* internalname; // 0x60
		::System::String* comments; // 0x68
		::System::String* productname; // 0x70
		::System::String* companyname; // 0x78
		::System::Int32 filebuildpart; // 0x80
		::System::Int32 productbuildpart; // 0x84
		::System::Int32 fileprivatepart; // 0x88
		::System::Int32 filemajorpart; // 0x8C
		::System::Boolean isprivatebuild; // 0x90
		::System::Boolean isdebug; // 0x91
		::System::Boolean ispatched; // 0x92
		::System::Int32 productprivatepart; // 0x94
		::System::Int32 fileminorpart; // 0x98
		::System::Boolean isprerelease; // 0x9C
		::System::Boolean isspecialbuild; // 0x9D
		::System::Int32 productminorpart; // 0xA0
