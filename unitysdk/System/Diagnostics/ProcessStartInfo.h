...
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x193A03E0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_CREATENOWINDOW_OFFSET UNITYSDK_OFFSET(0x193A0410)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_DOMAIN_OFFSET UNITYSDK_OFFSET(0x193A0BE0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_ENVIRONMENTVARIABLES_OFFSET UNITYSDK_OFFSET(0x193A0430)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_ENVIRONMENT_OFFSET UNITYSDK_OFFSET(0x193A0A40)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_ERRORDIALOGPARENTHANDLE_OFFSET UNITYSDK_OFFSET(0x193A0CB0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_ERRORDIALOG_OFFSET UNITYSDK_OFFSET(0x193A0C90)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x193A0C30)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_HAVEENVVARS_OFFSET UNITYSDK_OFFSET(0x193A0DF0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_LOADUSERPROFILE_OFFSET UNITYSDK_OFFSET(0x193A0C10)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_PASSWORDINCLEARTEXT_OFFSET UNITYSDK_OFFSET(0x193A0BC0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x193A0BA0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_REDIRECTSTANDARDERROR_OFFSET UNITYSDK_OFFSET(0x193A0AF0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_REDIRECTSTANDARDINPUT_OFFSET UNITYSDK_OFFSET(0x193A0AB0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_REDIRECTSTANDARDOUTPUT_OFFSET UNITYSDK_OFFSET(0x193A0AD0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_STANDARDERRORENCODING_OFFSET UNITYSDK_OFFSET(0x193A0B10)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_STANDARDOUTPUTENCODING_OFFSET UNITYSDK_OFFSET(0x193A0B30)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x193A0B70)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_USESHELLEXECUTE_OFFSET UNITYSDK_OFFSET(0x193A0B50)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_VERBS_OFFSET UNITYSDK_OFFSET(0x193A0E00)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_VERB_OFFSET UNITYSDK_OFFSET(0x193A03B0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_WINDOWSTYLE_OFFSET UNITYSDK_OFFSET(0x193A0CD0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_GET_WORKINGDIRECTORY_OFFSET UNITYSDK_OFFSET(0x193A0C60)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x193A0400)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_CREATENOWINDOW_OFFSET UNITYSDK_OFFSET(0x193A0420)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_DOMAIN_OFFSET UNITYSDK_OFFSET(0x193A0C00)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_ERRORDIALOGPARENTHANDLE_OFFSET UNITYSDK_OFFSET(0x193A0CC0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_ERRORDIALOG_OFFSET UNITYSDK_OFFSET(0x193A0CA0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x193A0C50)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_LOADUSERPROFILE_OFFSET UNITYSDK_OFFSET(0x193A0C20)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_PASSWORDINCLEARTEXT_OFFSET UNITYSDK_OFFSET(0x193A0BD0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x193A0BB0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_REDIRECTSTANDARDERROR_OFFSET UNITYSDK_OFFSET(0x193A0B00)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_REDIRECTSTANDARDINPUT_OFFSET UNITYSDK_OFFSET(0x193A0AC0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_REDIRECTSTANDARDOUTPUT_OFFSET UNITYSDK_OFFSET(0x193A0AE0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_STANDARDERRORENCODING_OFFSET UNITYSDK_OFFSET(0x193A0B20)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_STANDARDOUTPUTENCODING_OFFSET UNITYSDK_OFFSET(0x193A0B40)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_USERNAME_OFFSET UNITYSDK_OFFSET(0x193A0B90)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_USESHELLEXECUTE_OFFSET UNITYSDK_OFFSET(0x193A0B60)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_VERB_OFFSET UNITYSDK_OFFSET(0x193A03D0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_WINDOWSTYLE_OFFSET UNITYSDK_OFFSET(0x193A0CE0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO_SET_WORKINGDIRECTORY_OFFSET UNITYSDK_OFFSET(0x193A0C80)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x193A0E60)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193A0340)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO__CTOR_2_OFFSET UNITYSDK_OFFSET(0x193A0390)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO__CTOR_3_OFFSET UNITYSDK_OFFSET(0x193A03A0)
#define SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x193A0330)
