...
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTARGS_GET_DATA_OFFSET UNITYSDK_OFFSET(0x19370E60)
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19370E70)
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19370E30)
