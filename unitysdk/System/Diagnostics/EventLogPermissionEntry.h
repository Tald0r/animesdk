...
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONENTRY_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x1A3342E0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONENTRY_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x1A334320)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3342A0)
