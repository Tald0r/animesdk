...
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONENTRY_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x19D75DF0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONENTRY_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x19D75E30)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x19D75DB0)
