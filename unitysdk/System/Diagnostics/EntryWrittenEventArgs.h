...
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTARGS_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x1A5F0C80)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5F0C40)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F0C00)
