...
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTARGS_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x19FD7C40)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FD7C00)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD7BC0)
