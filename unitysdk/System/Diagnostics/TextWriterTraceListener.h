...
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_CLOSE_OFFSET UNITYSDK_OFFSET(0x182DAAB0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x182DAB50)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_ENSUREWRITER_OFFSET UNITYSDK_OFFSET(0x182DA8D0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_FLUSH_OFFSET UNITYSDK_OFFSET(0x182DACB0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_GETENCODINGWITHFALLBACK_OFFSET UNITYSDK_OFFSET(0x182DAFA0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_GET_WRITER_OFFSET UNITYSDK_OFFSET(0x182DA8B0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_SET_WRITER_OFFSET UNITYSDK_OFFSET(0x182DAAA0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x182DAE80)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_WRITE_OFFSET UNITYSDK_OFFSET(0x182DAD60)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x182DA6A0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x182DA6B0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x182DA770)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x182DA800)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x182DA880)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_6_OFFSET UNITYSDK_OFFSET(0x182DA890)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x182DA690)
