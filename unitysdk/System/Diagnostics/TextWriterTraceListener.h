...
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_CLOSE_OFFSET UNITYSDK_OFFSET(0x188EF7B0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x188EF850)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_ENSUREWRITER_OFFSET UNITYSDK_OFFSET(0x188EF5D0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_FLUSH_OFFSET UNITYSDK_OFFSET(0x188EF9B0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_GETENCODINGWITHFALLBACK_OFFSET UNITYSDK_OFFSET(0x188EFCA0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_GET_WRITER_OFFSET UNITYSDK_OFFSET(0x188EF5B0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_SET_WRITER_OFFSET UNITYSDK_OFFSET(0x188EF7A0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x188EFB80)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER_WRITE_OFFSET UNITYSDK_OFFSET(0x188EFA60)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x188EF3A0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x188EF3B0)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x188EF470)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x188EF500)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x188EF580)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_6_OFFSET UNITYSDK_OFFSET(0x188EF590)
#define SYSTEM_DIAGNOSTICS_TEXTWRITERTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x188EF390)
