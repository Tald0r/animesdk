...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_COUNTEREXISTS_1_OFFSET UNITYSDK_OFFSET(0x19FD8D00)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_COUNTEREXISTS_2_OFFSET UNITYSDK_OFFSET(0x19FD8D40)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_COUNTEREXISTS_OFFSET UNITYSDK_OFFSET(0x19FD8CC0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_CREATE_1_OFFSET UNITYSDK_OFFSET(0x19FD8DC0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_CREATE_2_OFFSET UNITYSDK_OFFSET(0x19FD8E00)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_CREATE_3_OFFSET UNITYSDK_OFFSET(0x19FD8E40)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_CREATE_OFFSET UNITYSDK_OFFSET(0x19FD8D80)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_DELETE_OFFSET UNITYSDK_OFFSET(0x19FD8E80)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_EXISTS_1_OFFSET UNITYSDK_OFFSET(0x19FD8F00)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_EXISTS_OFFSET UNITYSDK_OFFSET(0x19FD8EC0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_GETCATEGORIES_1_OFFSET UNITYSDK_OFFSET(0x19FD8F80)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_GETCATEGORIES_OFFSET UNITYSDK_OFFSET(0x19FD8F40)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_GETCOUNTERS_1_OFFSET UNITYSDK_OFFSET(0x19FD9000)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_GETCOUNTERS_OFFSET UNITYSDK_OFFSET(0x19FD8FC0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_GETINSTANCENAMES_OFFSET UNITYSDK_OFFSET(0x19FD9040)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_GET_CATEGORYHELP_OFFSET UNITYSDK_OFFSET(0x19FD8B40)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_GET_CATEGORYNAME_OFFSET UNITYSDK_OFFSET(0x19FD8B80)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_GET_CATEGORYTYPE_OFFSET UNITYSDK_OFFSET(0x19FD8C00)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x19FD8C40)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_INSTANCEEXISTS_1_OFFSET UNITYSDK_OFFSET(0x19FD90C0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_INSTANCEEXISTS_2_OFFSET UNITYSDK_OFFSET(0x19FD9100)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_INSTANCEEXISTS_OFFSET UNITYSDK_OFFSET(0x19FD9080)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_READCATEGORY_OFFSET UNITYSDK_OFFSET(0x19FD9140)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_SET_CATEGORYNAME_OFFSET UNITYSDK_OFFSET(0x19FD8BC0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY_SET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x19FD8C80)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FD8AC0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19FD8B00)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERCATEGORY__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD8A80)
