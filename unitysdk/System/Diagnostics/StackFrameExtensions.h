...
#define SYSTEM_DIAGNOSTICS_STACKFRAMEEXTENSIONS_GETNATIVEIMAGEBASE_OFFSET UNITYSDK_OFFSET(0x191CAC70)
#define SYSTEM_DIAGNOSTICS_STACKFRAMEEXTENSIONS_GETNATIVEIP_OFFSET UNITYSDK_OFFSET(0x191CACB0)
#define SYSTEM_DIAGNOSTICS_STACKFRAMEEXTENSIONS_HASILOFFSET_OFFSET UNITYSDK_OFFSET(0x191CACF0)
#define SYSTEM_DIAGNOSTICS_STACKFRAMEEXTENSIONS_HASMETHOD_OFFSET UNITYSDK_OFFSET(0x191CAD30)
#define SYSTEM_DIAGNOSTICS_STACKFRAMEEXTENSIONS_HASNATIVEIMAGE_OFFSET UNITYSDK_OFFSET(0x191CAD70)
#define SYSTEM_DIAGNOSTICS_STACKFRAMEEXTENSIONS_HASSOURCE_OFFSET UNITYSDK_OFFSET(0x191CADB0)
