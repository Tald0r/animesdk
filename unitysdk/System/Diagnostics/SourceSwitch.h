...
#define SYSTEM_DIAGNOSTICS_SOURCESWITCH_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x191B8CE0)
#define SYSTEM_DIAGNOSTICS_SOURCESWITCH_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x191B8EC0)
#define SYSTEM_DIAGNOSTICS_SOURCESWITCH_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x191B8D60)
#define SYSTEM_DIAGNOSTICS_SOURCESWITCH_SHOULDTRACE_OFFSET UNITYSDK_OFFSET(0x191B8E80)
#define SYSTEM_DIAGNOSTICS_SOURCESWITCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191B8AC0)
#define SYSTEM_DIAGNOSTICS_SOURCESWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x191B8A40)
