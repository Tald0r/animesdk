...
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x19450E20)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x19450D20)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x19450DA0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_SET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x19450D60)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_SET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x19450DE0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19450D10)
