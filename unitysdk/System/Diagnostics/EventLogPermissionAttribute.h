...
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x19094660)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x19094560)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x190945E0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_SET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x190945A0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE_SET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x19094620)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19094550)
