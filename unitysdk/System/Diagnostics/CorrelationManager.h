...
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_GETLOGICALOPERATIONSTACK_OFFSET UNITYSDK_OFFSET(0x18E399D0)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x18E39810)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_GET_LOGICALOPERATIONSTACK_OFFSET UNITYSDK_OFFSET(0x18E39930)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_SET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x18E398D0)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_STARTLOGICALOPERATION_1_OFFSET UNITYSDK_OFFSET(0x18E39B90)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_STARTLOGICALOPERATION_OFFSET UNITYSDK_OFFSET(0x18E39A70)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_STOPLOGICALOPERATION_OFFSET UNITYSDK_OFFSET(0x18E39BC0)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E39800)
