...
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_GETLOGICALOPERATIONSTACK_OFFSET UNITYSDK_OFFSET(0x1923CC70)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x1923CAB0)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_GET_LOGICALOPERATIONSTACK_OFFSET UNITYSDK_OFFSET(0x1923CBD0)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_SET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x1923CB70)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_STARTLOGICALOPERATION_1_OFFSET UNITYSDK_OFFSET(0x1923CE30)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_STARTLOGICALOPERATION_OFFSET UNITYSDK_OFFSET(0x1923CD10)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER_STOPLOGICALOPERATION_OFFSET UNITYSDK_OFFSET(0x1923CE60)
#define SYSTEM_DIAGNOSTICS_CORRELATIONMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1923CAA0)
