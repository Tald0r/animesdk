...
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19450C90)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19450CD0)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19450C50)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19450C10)
