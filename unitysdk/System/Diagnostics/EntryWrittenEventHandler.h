...
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190944D0)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19094510)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19094490)
#define SYSTEM_DIAGNOSTICS_ENTRYWRITTENEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19094450)
