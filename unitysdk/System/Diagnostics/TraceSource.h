...
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_CLOSE_OFFSET UNITYSDK_OFFSET(0x19680680)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_CREATESWITCH_OFFSET UNITYSDK_OFFSET(0x19683CF0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_FLUSH_OFFSET UNITYSDK_OFFSET(0x19680A10)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GETSUPPORTEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19681260)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19683E10)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GET_LISTENERS_OFFSET UNITYSDK_OFFSET(0x19683F90)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19681C90)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GET_SWITCH_OFFSET UNITYSDK_OFFSET(0x19684070)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19680440)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_NOCONFIGINIT_OFFSET UNITYSDK_OFFSET(0x19680500)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_REFRESHALL_OFFSET UNITYSDK_OFFSET(0x19681270)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_REFRESH_OFFSET UNITYSDK_OFFSET(0x19681570)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_SET_SWITCH_OFFSET UNITYSDK_OFFSET(0x19684150)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEDATA_1_OFFSET UNITYSDK_OFFSET(0x19682FE0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEDATA_OFFSET UNITYSDK_OFFSET(0x19682980)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEEVENT_1_OFFSET UNITYSDK_OFFSET(0x19681CA0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEEVENT_2_OFFSET UNITYSDK_OFFSET(0x19682300)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEEVENT_OFFSET UNITYSDK_OFFSET(0x19681640)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEINFORMATION_1_OFFSET UNITYSDK_OFFSET(0x19683650)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEINFORMATION_OFFSET UNITYSDK_OFFSET(0x19683640)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACETRANSFER_OFFSET UNITYSDK_OFFSET(0x19683660)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x196842A0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1967FCB0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1967FCA0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE__PRUNECACHEDTRACESOURCES_OFFSET UNITYSDK_OFFSET(0x1967FEA0)
...
namespace System::Diagnostics
{
	...
	public:
		...
		::System::Diagnostics::SourceSwitch* internalSwitch; // 0x10
