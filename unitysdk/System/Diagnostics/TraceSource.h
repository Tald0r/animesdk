...
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_CLOSE_OFFSET UNITYSDK_OFFSET(0x19B1EFE0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_CREATESWITCH_OFFSET UNITYSDK_OFFSET(0x19B22650)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_FLUSH_OFFSET UNITYSDK_OFFSET(0x19B1F370)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GETSUPPORTEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19B1FBC0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19B22770)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GET_LISTENERS_OFFSET UNITYSDK_OFFSET(0x19B228F0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19B205F0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_GET_SWITCH_OFFSET UNITYSDK_OFFSET(0x19B229D0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19B1EDA0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_NOCONFIGINIT_OFFSET UNITYSDK_OFFSET(0x19B1EE60)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_REFRESHALL_OFFSET UNITYSDK_OFFSET(0x19B1FBD0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_REFRESH_OFFSET UNITYSDK_OFFSET(0x19B1FED0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_SET_SWITCH_OFFSET UNITYSDK_OFFSET(0x19B22AB0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEDATA_1_OFFSET UNITYSDK_OFFSET(0x19B21940)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEDATA_OFFSET UNITYSDK_OFFSET(0x19B212E0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEEVENT_1_OFFSET UNITYSDK_OFFSET(0x19B20600)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEEVENT_2_OFFSET UNITYSDK_OFFSET(0x19B20C60)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEEVENT_OFFSET UNITYSDK_OFFSET(0x19B1FFA0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEINFORMATION_1_OFFSET UNITYSDK_OFFSET(0x19B21FB0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACEINFORMATION_OFFSET UNITYSDK_OFFSET(0x19B21FA0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE_TRACETRANSFER_OFFSET UNITYSDK_OFFSET(0x19B21FC0)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B22C00)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B1E610)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1E600)
#define SYSTEM_DIAGNOSTICS_TRACESOURCE__PRUNECACHEDTRACESOURCES_OFFSET UNITYSDK_OFFSET(0x19B1E800)
...
namespace System::Diagnostics
{
	...
	public:
		...
		::System::Diagnostics::TraceListenerCollection* listeners; // 0x18
		::System::Collections::Specialized::StringDictionary* attributes; // 0x20
		::System::Diagnostics::SourceSwitch* internalSwitch; // 0x28
