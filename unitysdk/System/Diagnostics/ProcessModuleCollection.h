...
#define SYSTEM_DIAGNOSTICS_PROCESSMODULECOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x19371070)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULECOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x193710E0)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULECOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19370F30)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULECOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x19371000)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULECOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19370EC0)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19370EB0)
