...
#define SYSTEM_DIAGNOSTICS_TRACEFILTER_SHOULDTRACE_1_OFFSET UNITYSDK_OFFSET(0x191B9CB0)
#define SYSTEM_DIAGNOSTICS_TRACEFILTER_SHOULDTRACE_2_OFFSET UNITYSDK_OFFSET(0x191B9CF0)
#define SYSTEM_DIAGNOSTICS_TRACEFILTER_SHOULDTRACE_OFFSET UNITYSDK_OFFSET(0x191B9C70)
#define SYSTEM_DIAGNOSTICS_TRACEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x191B9D40)
