...
#define SYSTEM_DIAGNOSTICS_TRACEFILTER_SHOULDTRACE_1_OFFSET UNITYSDK_OFFSET(0x18D71000)
#define SYSTEM_DIAGNOSTICS_TRACEFILTER_SHOULDTRACE_2_OFFSET UNITYSDK_OFFSET(0x18D71040)
#define SYSTEM_DIAGNOSTICS_TRACEFILTER_SHOULDTRACE_OFFSET UNITYSDK_OFFSET(0x18D70FC0)
#define SYSTEM_DIAGNOSTICS_TRACEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D71090)
