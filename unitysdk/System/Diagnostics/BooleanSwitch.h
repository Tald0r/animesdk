...
#define SYSTEM_DIAGNOSTICS_BOOLEANSWITCH_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A5F0B10)
#define SYSTEM_DIAGNOSTICS_BOOLEANSWITCH_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A5F0B70)
#define SYSTEM_DIAGNOSTICS_BOOLEANSWITCH_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A5F0B50)
#define SYSTEM_DIAGNOSTICS_BOOLEANSWITCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5F0AA0)
#define SYSTEM_DIAGNOSTICS_BOOLEANSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5EE160)
