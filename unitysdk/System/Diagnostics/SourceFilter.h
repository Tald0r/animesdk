...
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER_GET_SOURCE_OFFSET UNITYSDK_OFFSET(0x18F4C9A0)
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER_SET_SOURCE_OFFSET UNITYSDK_OFFSET(0x18F4C8A0)
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER_SHOULDTRACE_OFFSET UNITYSDK_OFFSET(0x18F4C910)
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18F4C830)
