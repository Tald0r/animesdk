...
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER_GET_SOURCE_OFFSET UNITYSDK_OFFSET(0x1931CB10)
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER_SET_SOURCE_OFFSET UNITYSDK_OFFSET(0x1931CA10)
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER_SHOULDTRACE_OFFSET UNITYSDK_OFFSET(0x1931CA80)
#define SYSTEM_DIAGNOSTICS_SOURCEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1931C9A0)
