...
#define SYSTEM_DIAGNOSTICS_TRACEUTILS_CONVERTTOBASETYPEORENUM_OFFSET UNITYSDK_OFFSET(0x18FB62D0)
#define SYSTEM_DIAGNOSTICS_TRACEUTILS_GETRUNTIMEOBJECT_OFFSET UNITYSDK_OFFSET(0x18FB62C0)
#define SYSTEM_DIAGNOSTICS_TRACEUTILS_VERIFYATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18FB4E80)
