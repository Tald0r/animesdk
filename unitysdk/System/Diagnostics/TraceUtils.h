...
#define SYSTEM_DIAGNOSTICS_TRACEUTILS_CONVERTTOBASETYPEORENUM_OFFSET UNITYSDK_OFFSET(0x193A26D0)
#define SYSTEM_DIAGNOSTICS_TRACEUTILS_GETRUNTIMEOBJECT_OFFSET UNITYSDK_OFFSET(0x193A26C0)
#define SYSTEM_DIAGNOSTICS_TRACEUTILS_VERIFYATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x193A1280)
