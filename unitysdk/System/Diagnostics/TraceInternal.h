...
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_ASSERT_1_OFFSET UNITYSDK_OFFSET(0x18BA51A0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_ASSERT_2_OFFSET UNITYSDK_OFFSET(0x18BA51B0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_ASSERT_OFFSET UNITYSDK_OFFSET(0x18BA4930)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_CLOSE_OFFSET UNITYSDK_OFFSET(0x18BA4590)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_FAIL_1_OFFSET UNITYSDK_OFFSET(0x18BA51C0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_FAIL_OFFSET UNITYSDK_OFFSET(0x18BA4950)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_FLUSH_OFFSET UNITYSDK_OFFSET(0x18BA3D80)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_APPNAME_OFFSET UNITYSDK_OFFSET(0x18BA29D0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_AUTOFLUSH_OFFSET UNITYSDK_OFFSET(0x18BA2A50)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x18BA2A90)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x18BA2FB0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_LISTENERS_OFFSET UNITYSDK_OFFSET(0x18BA2620)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_USEGLOBALLOCK_OFFSET UNITYSDK_OFFSET(0x18BA2A70)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_INDENT_OFFSET UNITYSDK_OFFSET(0x18BA3440)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_INITIALIZESETTINGS_OFFSET UNITYSDK_OFFSET(0x18BA5A20)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_REFRESH_OFFSET UNITYSDK_OFFSET(0x18BA5A30)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SETINDENTSIZE_OFFSET UNITYSDK_OFFSET(0x18BA2FD0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SET_AUTOFLUSH_OFFSET UNITYSDK_OFFSET(0x18BA2A60)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x18BA2AE0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x18BA2FC0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SET_USEGLOBALLOCK_OFFSET UNITYSDK_OFFSET(0x18BA2A80)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_TRACEEVENT_OFFSET UNITYSDK_OFFSET(0x18BA5AF0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_UNINDENT_OFFSET UNITYSDK_OFFSET(0x18BA38E0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITEIF_1_OFFSET UNITYSDK_OFFSET(0x18BAB4E0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITEIF_2_OFFSET UNITYSDK_OFFSET(0x18BAB4F0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITEIF_3_OFFSET UNITYSDK_OFFSET(0x18BAB500)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITEIF_OFFSET UNITYSDK_OFFSET(0x18BAB4D0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINEIF_1_OFFSET UNITYSDK_OFFSET(0x18BAB520)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINEIF_2_OFFSET UNITYSDK_OFFSET(0x18BAB530)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINEIF_3_OFFSET UNITYSDK_OFFSET(0x18BAB540)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINEIF_OFFSET UNITYSDK_OFFSET(0x18BAB510)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINE_1_OFFSET UNITYSDK_OFFSET(0x18BA9BC0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINE_2_OFFSET UNITYSDK_OFFSET(0x18BAA410)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINE_3_OFFSET UNITYSDK_OFFSET(0x18BAAC70)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINE_OFFSET UNITYSDK_OFFSET(0x18BA9370)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITE_1_OFFSET UNITYSDK_OFFSET(0x18BA7A60)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITE_2_OFFSET UNITYSDK_OFFSET(0x18BA82B0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITE_3_OFFSET UNITYSDK_OFFSET(0x18BA8B10)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITE_OFFSET UNITYSDK_OFFSET(0x18BA7210)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x18BAB550)
...
namespace System::Diagnostics
{
	...
	public:
		...
		{
			return (::System::Diagnostics::TraceListenerCollection**)Il2CppClass::FromTypeDefinitionIndex(TraceInternal_TypeDefinitionIndex)->GetStaticField(0x26F8);
		}
