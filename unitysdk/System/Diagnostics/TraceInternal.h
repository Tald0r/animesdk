...
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_ASSERT_1_OFFSET UNITYSDK_OFFSET(0x18594440)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_ASSERT_2_OFFSET UNITYSDK_OFFSET(0x18594450)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_ASSERT_OFFSET UNITYSDK_OFFSET(0x18593BD0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_CLOSE_OFFSET UNITYSDK_OFFSET(0x18593830)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_FAIL_1_OFFSET UNITYSDK_OFFSET(0x18594460)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_FAIL_OFFSET UNITYSDK_OFFSET(0x18593BF0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_FLUSH_OFFSET UNITYSDK_OFFSET(0x18593020)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_APPNAME_OFFSET UNITYSDK_OFFSET(0x18591C70)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_AUTOFLUSH_OFFSET UNITYSDK_OFFSET(0x18591CF0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x18591D30)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x18592250)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_LISTENERS_OFFSET UNITYSDK_OFFSET(0x185918C0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_GET_USEGLOBALLOCK_OFFSET UNITYSDK_OFFSET(0x18591D10)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_INDENT_OFFSET UNITYSDK_OFFSET(0x185926E0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_INITIALIZESETTINGS_OFFSET UNITYSDK_OFFSET(0x18594CC0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_REFRESH_OFFSET UNITYSDK_OFFSET(0x18594CD0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SETINDENTSIZE_OFFSET UNITYSDK_OFFSET(0x18592270)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SET_AUTOFLUSH_OFFSET UNITYSDK_OFFSET(0x18591D00)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x18591D80)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x18592260)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_SET_USEGLOBALLOCK_OFFSET UNITYSDK_OFFSET(0x18591D20)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_TRACEEVENT_OFFSET UNITYSDK_OFFSET(0x18594D90)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_UNINDENT_OFFSET UNITYSDK_OFFSET(0x18592B80)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITEIF_1_OFFSET UNITYSDK_OFFSET(0x1859A780)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITEIF_2_OFFSET UNITYSDK_OFFSET(0x1859A790)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITEIF_3_OFFSET UNITYSDK_OFFSET(0x1859A7A0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITEIF_OFFSET UNITYSDK_OFFSET(0x1859A770)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINEIF_1_OFFSET UNITYSDK_OFFSET(0x1859A7C0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINEIF_2_OFFSET UNITYSDK_OFFSET(0x1859A7D0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINEIF_3_OFFSET UNITYSDK_OFFSET(0x1859A7E0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINEIF_OFFSET UNITYSDK_OFFSET(0x1859A7B0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINE_1_OFFSET UNITYSDK_OFFSET(0x18598E60)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINE_2_OFFSET UNITYSDK_OFFSET(0x185996B0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINE_3_OFFSET UNITYSDK_OFFSET(0x18599F10)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITELINE_OFFSET UNITYSDK_OFFSET(0x18598610)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITE_1_OFFSET UNITYSDK_OFFSET(0x18596D00)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITE_2_OFFSET UNITYSDK_OFFSET(0x18597550)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITE_3_OFFSET UNITYSDK_OFFSET(0x18597DB0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL_WRITE_OFFSET UNITYSDK_OFFSET(0x185964B0)
#define SYSTEM_DIAGNOSTICS_TRACEINTERNAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1859A7F0)
