...
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE_GET_CATEGORYID_OFFSET UNITYSDK_OFFSET(0x191B86D0)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE_GET_ENTRYTYPE_OFFSET UNITYSDK_OFFSET(0x191B8750)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x191B87D0)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE_SET_CATEGORYID_OFFSET UNITYSDK_OFFSET(0x191B8710)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE_SET_ENTRYTYPE_OFFSET UNITYSDK_OFFSET(0x191B8790)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE_SET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x191B8810)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191B8690)
#define SYSTEM_DIAGNOSTICS_EVENTINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x191B8650)
