...
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x188EF310)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x188EF350)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_GET_COUNTERNAME_OFFSET UNITYSDK_OFFSET(0x188EF210)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x188EF250)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x188EF290)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x188EF2D0)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188EF1D0)
