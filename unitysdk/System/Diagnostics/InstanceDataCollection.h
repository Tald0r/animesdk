...
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x182DA610)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x182DA650)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_GET_COUNTERNAME_OFFSET UNITYSDK_OFFSET(0x182DA510)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x182DA550)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x182DA590)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x182DA5D0)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATACOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x182DA4D0)
