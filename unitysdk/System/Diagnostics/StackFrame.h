...
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETFILELINENUMBER_OFFSET UNITYSDK_OFFSET(0x199EDCA0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETFILENAME_OFFSET UNITYSDK_OFFSET(0x199EDCB0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETMETHOD_OFFSET UNITYSDK_OFFSET(0x199EDCE0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GETSECUREFILENAME_OFFSET UNITYSDK_OFFSET(0x199EDCC0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_GET_FRAME_INFO_OFFSET UNITYSDK_OFFSET(0x199EDA00)
#define SYSTEM_DIAGNOSTICS_STACKFRAME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x199EDCF0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x199EDBD0)
#define SYSTEM_DIAGNOSTICS_STACKFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x199EDAF0)
