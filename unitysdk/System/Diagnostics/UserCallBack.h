...
#define SYSTEM_DIAGNOSTICS_USERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x188F0250)
#define SYSTEM_DIAGNOSTICS_USERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x188F0280)
#define SYSTEM_DIAGNOSTICS_USERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x188EFD50)
#define SYSTEM_DIAGNOSTICS_USERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x188EFD30)
