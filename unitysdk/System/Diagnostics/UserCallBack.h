...
#define SYSTEM_DIAGNOSTICS_USERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x182DB540)
#define SYSTEM_DIAGNOSTICS_USERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x182DB570)
#define SYSTEM_DIAGNOSTICS_USERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x182DB040)
#define SYSTEM_DIAGNOSTICS_USERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x182DB030)
