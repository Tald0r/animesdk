...
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_CLOSE_OFFSET UNITYSDK_OFFSET(0x18FB4C20)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18FB4C10)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18FB4BC0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_FAIL_1_OFFSET UNITYSDK_OFFSET(0x18FB4EB0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_FAIL_OFFSET UNITYSDK_OFFSET(0x18FB4E90)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_FLUSH_OFFSET UNITYSDK_OFFSET(0x18FB4C30)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GETSUPPORTEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18FB4FC0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18FB4AD0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_FILTER_OFFSET UNITYSDK_OFFSET(0x18FB4D10)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x18FB4C40)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x18FB4C70)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_ISTHREADSAFE_OFFSET UNITYSDK_OFFSET(0x18FB4BB0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18FB4B80)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_NEEDINDENT_OFFSET UNITYSDK_OFFSET(0x18FB4D30)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_GET_TRACEOUTPUTOPTIONS_OFFSET UNITYSDK_OFFSET(0x18FB4D50)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_ISENABLED_OFFSET UNITYSDK_OFFSET(0x18FB62B0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18FB4DD0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_FILTER_OFFSET UNITYSDK_OFFSET(0x18FB4D20)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x18FB4C50)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x18FB4C80)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x18FB4BA0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_NEEDINDENT_OFFSET UNITYSDK_OFFSET(0x18FB4D40)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_SET_TRACEOUTPUTOPTIONS_OFFSET UNITYSDK_OFFSET(0x18FB4D60)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEDATA_1_OFFSET UNITYSDK_OFFSET(0x18FB5DF0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEDATA_OFFSET UNITYSDK_OFFSET(0x18FB5450)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEEVENT_1_OFFSET UNITYSDK_OFFSET(0x18FB6030)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEEVENT_2_OFFSET UNITYSDK_OFFSET(0x18FB60E0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACEEVENT_OFFSET UNITYSDK_OFFSET(0x18FB5FF0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_TRACETRANSFER_OFFSET UNITYSDK_OFFSET(0x18FB6200)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITEFOOTER_OFFSET UNITYSDK_OFFSET(0x18FB5630)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x18FB5520)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITEINDENT_OFFSET UNITYSDK_OFFSET(0x18FB51E0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITELINE_1_OFFSET UNITYSDK_OFFSET(0x18FB5300)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITELINE_2_OFFSET UNITYSDK_OFFSET(0x18FB53A0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x18FB5260)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITE_1_OFFSET UNITYSDK_OFFSET(0x18FB5070)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITE_2_OFFSET UNITYSDK_OFFSET(0x18FB5110)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER_WRITE_OFFSET UNITYSDK_OFFSET(0x18FB4FD0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FB4AC0)
#define SYSTEM_DIAGNOSTICS_TRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB4AB0)
...
namespace System::Diagnostics
{
	...
	public:
		...
		::System::Int32 indentLevel; // 0x3C
		::System::Diagnostics::TraceOptions traceOptions; // 0x40
		::System::Boolean needIndent; // 0x44
