...
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATA_GET_COUNTERHELP_OFFSET UNITYSDK_OFFSET(0x18590E20)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATA_GET_COUNTERNAME_OFFSET UNITYSDK_OFFSET(0x18590EA0)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATA_GET_COUNTERTYPE_OFFSET UNITYSDK_OFFSET(0x18590F20)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATA_SET_COUNTERHELP_OFFSET UNITYSDK_OFFSET(0x18590E60)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATA_SET_COUNTERNAME_OFFSET UNITYSDK_OFFSET(0x18590EE0)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATA_SET_COUNTERTYPE_OFFSET UNITYSDK_OFFSET(0x18590F60)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18590DE0)
#define SYSTEM_DIAGNOSTICS_COUNTERCREATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18590DA0)
