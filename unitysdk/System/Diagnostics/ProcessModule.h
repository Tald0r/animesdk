...
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_GET_BASEADDRESS_OFFSET UNITYSDK_OFFSET(0x19059960)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_GET_ENTRYPOINTADDRESS_OFFSET UNITYSDK_OFFSET(0x19059970)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x19059980)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_GET_FILEVERSIONINFO_OFFSET UNITYSDK_OFFSET(0x19059990)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_GET_MODULEMEMORYSIZE_OFFSET UNITYSDK_OFFSET(0x190599A0)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_GET_MODULENAME_OFFSET UNITYSDK_OFFSET(0x190599B0)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x190599C0)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x190599D0)
#define SYSTEM_DIAGNOSTICS_PROCESSMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x190598D0)
...
namespace System::Diagnostics
{
	...
	public:
		...
		::System::IntPtr entryaddr; // 0x40
		::System::IntPtr baseaddr; // 0x48
		::System::Int32 memory_size; // 0x50
