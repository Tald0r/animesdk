...
#define SYSTEM_DIAGNOSTICS_DEBUG_ASSERT_1_OFFSET UNITYSDK_OFFSET(0x190593D0)
#define SYSTEM_DIAGNOSTICS_DEBUG_ASSERT_2_OFFSET UNITYSDK_OFFSET(0x190593E0)
#define SYSTEM_DIAGNOSTICS_DEBUG_ASSERT_3_OFFSET UNITYSDK_OFFSET(0x190593F0)
#define SYSTEM_DIAGNOSTICS_DEBUG_ASSERT_OFFSET UNITYSDK_OFFSET(0x190593B0)
#define SYSTEM_DIAGNOSTICS_DEBUG_CLOSE_OFFSET UNITYSDK_OFFSET(0x190593A0)
#define SYSTEM_DIAGNOSTICS_DEBUG_FAIL_1_OFFSET UNITYSDK_OFFSET(0x190594D0)
#define SYSTEM_DIAGNOSTICS_DEBUG_FAIL_OFFSET UNITYSDK_OFFSET(0x190594C0)
#define SYSTEM_DIAGNOSTICS_DEBUG_FLUSH_OFFSET UNITYSDK_OFFSET(0x19059390)
#define SYSTEM_DIAGNOSTICS_DEBUG_GET_AUTOFLUSH_OFFSET UNITYSDK_OFFSET(0x190592F0)
#define SYSTEM_DIAGNOSTICS_DEBUG_GET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x19059310)
#define SYSTEM_DIAGNOSTICS_DEBUG_GET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x19059370)
#define SYSTEM_DIAGNOSTICS_DEBUG_GET_LISTENERS_OFFSET UNITYSDK_OFFSET(0x190592E0)
#define SYSTEM_DIAGNOSTICS_DEBUG_INDENT_OFFSET UNITYSDK_OFFSET(0x19059770)
#define SYSTEM_DIAGNOSTICS_DEBUG_PRINT_1_OFFSET UNITYSDK_OFFSET(0x190594F0)
#define SYSTEM_DIAGNOSTICS_DEBUG_PRINT_OFFSET UNITYSDK_OFFSET(0x190594E0)
#define SYSTEM_DIAGNOSTICS_DEBUG_SET_AUTOFLUSH_OFFSET UNITYSDK_OFFSET(0x19059300)
#define SYSTEM_DIAGNOSTICS_DEBUG_SET_INDENTLEVEL_OFFSET UNITYSDK_OFFSET(0x19059360)
#define SYSTEM_DIAGNOSTICS_DEBUG_SET_INDENTSIZE_OFFSET UNITYSDK_OFFSET(0x19059380)
#define SYSTEM_DIAGNOSTICS_DEBUG_UNINDENT_OFFSET UNITYSDK_OFFSET(0x19059780)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITEIF_1_OFFSET UNITYSDK_OFFSET(0x19059700)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITEIF_2_OFFSET UNITYSDK_OFFSET(0x19059710)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITEIF_3_OFFSET UNITYSDK_OFFSET(0x19059720)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITEIF_OFFSET UNITYSDK_OFFSET(0x190596F0)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITELINEIF_1_OFFSET UNITYSDK_OFFSET(0x19059740)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITELINEIF_2_OFFSET UNITYSDK_OFFSET(0x19059750)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITELINEIF_3_OFFSET UNITYSDK_OFFSET(0x19059760)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITELINEIF_OFFSET UNITYSDK_OFFSET(0x19059730)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITELINE_1_OFFSET UNITYSDK_OFFSET(0x19059600)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITELINE_2_OFFSET UNITYSDK_OFFSET(0x19059610)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITELINE_3_OFFSET UNITYSDK_OFFSET(0x19059620)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITELINE_4_OFFSET UNITYSDK_OFFSET(0x19059630)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITELINE_OFFSET UNITYSDK_OFFSET(0x190595F0)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITE_1_OFFSET UNITYSDK_OFFSET(0x190595C0)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITE_2_OFFSET UNITYSDK_OFFSET(0x190595D0)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITE_3_OFFSET UNITYSDK_OFFSET(0x190595E0)
#define SYSTEM_DIAGNOSTICS_DEBUG_WRITE_OFFSET UNITYSDK_OFFSET(0x190595B0)
