...
#define SYSTEM_DIAGNOSTICS_SWITCHLEVELATTRIBUTE_GET_SWITCHLEVELTYPE_OFFSET UNITYSDK_OFFSET(0x1A334780)
#define SYSTEM_DIAGNOSTICS_SWITCHLEVELATTRIBUTE_SET_SWITCHLEVELTYPE_OFFSET UNITYSDK_OFFSET(0x1A334710)
#define SYSTEM_DIAGNOSTICS_SWITCHLEVELATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3346A0)
