...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION_GET_PERMISSIONENTRIES_OFFSET UNITYSDK_OFFSET(0x19059890)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x190597D0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19059810)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19059850)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19059790)
