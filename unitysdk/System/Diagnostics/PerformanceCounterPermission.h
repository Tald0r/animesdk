...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION_GET_PERMISSIONENTRIES_OFFSET UNITYSDK_OFFSET(0x18B65010)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B64F50)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18B64F90)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18B64FD0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18B64F10)
