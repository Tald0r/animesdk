...
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION_GET_PERMISSIONENTRIES_OFFSET UNITYSDK_OFFSET(0x19D24280)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D241C0)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19D24200)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19D24240)
#define SYSTEM_DIAGNOSTICS_EVENTLOGPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19D24180)
