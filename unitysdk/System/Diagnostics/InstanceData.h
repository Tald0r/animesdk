...
#define SYSTEM_DIAGNOSTICS_INSTANCEDATA_GET_INSTANCENAME_OFFSET UNITYSDK_OFFSET(0x18E3A9F0)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATA_GET_RAWVALUE_OFFSET UNITYSDK_OFFSET(0x18E3AA30)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATA_GET_SAMPLE_OFFSET UNITYSDK_OFFSET(0x18E3AA70)
#define SYSTEM_DIAGNOSTICS_INSTANCEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3A9B0)
