...
#define SYSTEM_DIAGNOSTICS_SWITCH_GETSUPPORTEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18D70BB0)
#define SYSTEM_DIAGNOSTICS_SWITCH_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18D70930)
#define SYSTEM_DIAGNOSTICS_SWITCH_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x18D70A00)
#define SYSTEM_DIAGNOSTICS_SWITCH_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x18D709F0)
#define SYSTEM_DIAGNOSTICS_SWITCH_GET_INTIALIZEDLOCK_OFFSET UNITYSDK_OFFSET(0x18D70350)
#define SYSTEM_DIAGNOSTICS_SWITCH_GET_SWITCHSETTING_OFFSET UNITYSDK_OFFSET(0x18D70070)
#define SYSTEM_DIAGNOSTICS_SWITCH_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x18D70330)
#define SYSTEM_DIAGNOSTICS_SWITCH_INITIALIZECONFIGSETTINGS_OFFSET UNITYSDK_OFFSET(0x18D70BA0)
#define SYSTEM_DIAGNOSTICS_SWITCH_INITIALIZEWITHSTATUS_OFFSET UNITYSDK_OFFSET(0x18D70A20)
#define SYSTEM_DIAGNOSTICS_SWITCH_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x18D709E0)
#define SYSTEM_DIAGNOSTICS_SWITCH_ONSWITCHSETTINGCHANGED_OFFSET UNITYSDK_OFFSET(0x18D70BC0)
#define SYSTEM_DIAGNOSTICS_SWITCH_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x18D70BD0)
#define SYSTEM_DIAGNOSTICS_SWITCH_REFRESHALL_OFFSET UNITYSDK_OFFSET(0x18D70C20)
#define SYSTEM_DIAGNOSTICS_SWITCH_REFRESH_OFFSET UNITYSDK_OFFSET(0x18D70E50)
#define SYSTEM_DIAGNOSTICS_SWITCH_SET_SWITCHSETTING_OFFSET UNITYSDK_OFFSET(0x18D700C0)
#define SYSTEM_DIAGNOSTICS_SWITCH_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x18D70B70)
#define SYSTEM_DIAGNOSTICS_SWITCH__CCTOR_OFFSET UNITYSDK_OFFSET(0x18D70F30)
#define SYSTEM_DIAGNOSTICS_SWITCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18D6FE80)
#define SYSTEM_DIAGNOSTICS_SWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x18D6FE00)
#define SYSTEM_DIAGNOSTICS_SWITCH__PRUNECACHEDSWITCHES_OFFSET UNITYSDK_OFFSET(0x18D70390)
...
namespace System::Diagnostics
{
	...
	public:
		...
		::System::Object* m_intializedLock; // 0x40
		::System::Boolean initialized; // 0x48
		::System::Boolean initializing; // 0x49
