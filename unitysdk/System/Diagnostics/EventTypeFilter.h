...
#define SYSTEM_DIAGNOSTICS_EVENTTYPEFILTER_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19450E80)
#define SYSTEM_DIAGNOSTICS_EVENTTYPEFILTER_SET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19450E90)
#define SYSTEM_DIAGNOSTICS_EVENTTYPEFILTER_SHOULDTRACE_OFFSET UNITYSDK_OFFSET(0x19450E70)
#define SYSTEM_DIAGNOSTICS_EVENTTYPEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19450E60)
