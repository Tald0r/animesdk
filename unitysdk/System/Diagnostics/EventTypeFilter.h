...
#define SYSTEM_DIAGNOSTICS_EVENTTYPEFILTER_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x190946C0)
#define SYSTEM_DIAGNOSTICS_EVENTTYPEFILTER_SET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x190946D0)
#define SYSTEM_DIAGNOSTICS_EVENTTYPEFILTER_SHOULDTRACE_OFFSET UNITYSDK_OFFSET(0x190946B0)
#define SYSTEM_DIAGNOSTICS_EVENTTYPEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x190946A0)
