...
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_CALCULATE_1_OFFSET UNITYSDK_OFFSET(0x18BA1FC0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_CALCULATE_OFFSET UNITYSDK_OFFSET(0x18BA1F80)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x823630)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_BASEVALUE_OFFSET UNITYSDK_OFFSET(0x823430)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_COUNTERFREQUENCY_OFFSET UNITYSDK_OFFSET(0x823470)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_COUNTERTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x8234B0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_COUNTERTYPE_OFFSET UNITYSDK_OFFSET(0x8234F0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_RAWVALUE_OFFSET UNITYSDK_OFFSET(0x823530)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_SYSTEMFREQUENCY_OFFSET UNITYSDK_OFFSET(0x823570)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_TIMESTAMP100NSEC_OFFSET UNITYSDK_OFFSET(0x8235F0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x8235B0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18BA2040)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18BA2080)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8233F0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x8233B0)
...
namespace System::Diagnostics
{
	...
	struct alignas(1) CounterSample
	{
		...
		{
			return (::System::Diagnostics::CounterSample*)Il2CppClass::FromTypeDefinitionIndex(CounterSample_TypeDefinitionIndex)->GetStaticField(0x11E10);
		}
