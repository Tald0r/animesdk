...
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_CALCULATE_1_OFFSET UNITYSDK_OFFSET(0x18591260)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_CALCULATE_OFFSET UNITYSDK_OFFSET(0x18591220)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7F57D0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_BASEVALUE_OFFSET UNITYSDK_OFFSET(0x7F55D0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_COUNTERFREQUENCY_OFFSET UNITYSDK_OFFSET(0x7F5610)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_COUNTERTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x7F5650)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_COUNTERTYPE_OFFSET UNITYSDK_OFFSET(0x7F5690)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_RAWVALUE_OFFSET UNITYSDK_OFFSET(0x7F56D0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_SYSTEMFREQUENCY_OFFSET UNITYSDK_OFFSET(0x7F5710)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_TIMESTAMP100NSEC_OFFSET UNITYSDK_OFFSET(0x7F5790)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x7F5750)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x185912E0)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18591320)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x7F5590)
#define SYSTEM_DIAGNOSTICS_COUNTERSAMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x7F5550)
...
namespace System::Diagnostics
{
	...
	struct alignas(1) CounterSample
	{
		...
		{
			return (::System::Diagnostics::CounterSample*)Il2CppClass::FromTypeDefinitionIndex(CounterSample_TypeDefinitionIndex)->GetStaticField(0x11CE0);
		}
