...
#define SYSTEM_DIAGNOSTICS_ASSERTWRAPPER_SHOWASSERT_OFFSET UNITYSDK_OFFSET(0x1858FC80)
#define SYSTEM_DIAGNOSTICS_ASSERTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1858FCE0)
