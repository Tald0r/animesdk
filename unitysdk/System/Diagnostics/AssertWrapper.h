...
#define SYSTEM_DIAGNOSTICS_ASSERTWRAPPER_SHOWASSERT_OFFSET UNITYSDK_OFFSET(0x18BA09E0)
#define SYSTEM_DIAGNOSTICS_ASSERTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x18BA0A40)
