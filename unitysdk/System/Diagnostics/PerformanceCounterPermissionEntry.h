...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONENTRY_GET_CATEGORYNAME_OFFSET UNITYSDK_OFFSET(0x191B8980)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONENTRY_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x191B89C0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONENTRY_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x191B8A00)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x191B8940)
