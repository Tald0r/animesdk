...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONENTRY_GET_CATEGORYNAME_OFFSET UNITYSDK_OFFSET(0x18D6FCD0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONENTRY_GET_MACHINENAME_OFFSET UNITYSDK_OFFSET(0x18D6FD10)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONENTRY_GET_PERMISSIONACCESS_OFFSET UNITYSDK_OFFSET(0x18D6FD50)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERPERMISSIONENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x18D6FC90)
