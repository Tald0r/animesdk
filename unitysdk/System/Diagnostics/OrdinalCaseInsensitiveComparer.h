...
#define SYSTEM_DIAGNOSTICS_ORDINALCASEINSENSITIVECOMPARER_COMPARE_OFFSET UNITYSDK_OFFSET(0x18D6FBA0)
#define SYSTEM_DIAGNOSTICS_ORDINALCASEINSENSITIVECOMPARER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18D6FC50)
#define SYSTEM_DIAGNOSTICS_ORDINALCASEINSENSITIVECOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D6FC40)
