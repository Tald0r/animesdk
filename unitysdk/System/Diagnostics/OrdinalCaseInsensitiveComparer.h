...
#define SYSTEM_DIAGNOSTICS_ORDINALCASEINSENSITIVECOMPARER_COMPARE_OFFSET UNITYSDK_OFFSET(0x191B8850)
#define SYSTEM_DIAGNOSTICS_ORDINALCASEINSENSITIVECOMPARER__CCTOR_OFFSET UNITYSDK_OFFSET(0x191B8900)
#define SYSTEM_DIAGNOSTICS_ORDINALCASEINSENSITIVECOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x191B88F0)
