...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERMANAGER_SYSTEM_DIAGNOSTICS_ICOLLECTDATA_CLOSEDATA_OFFSET UNITYSDK_OFFSET(0x18BA2540)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERMANAGER_SYSTEM_DIAGNOSTICS_ICOLLECTDATA_COLLECTDATA_OFFSET UNITYSDK_OFFSET(0x18BA2580)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18BA2500)
