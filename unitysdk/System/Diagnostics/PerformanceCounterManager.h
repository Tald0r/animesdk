...
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERMANAGER_SYSTEM_DIAGNOSTICS_ICOLLECTDATA_CLOSEDATA_OFFSET UNITYSDK_OFFSET(0x185917E0)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERMANAGER_SYSTEM_DIAGNOSTICS_ICOLLECTDATA_COLLECTDATA_OFFSET UNITYSDK_OFFSET(0x18591820)
#define SYSTEM_DIAGNOSTICS_PERFORMANCECOUNTERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x185917A0)
