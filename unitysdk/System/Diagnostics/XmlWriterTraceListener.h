...
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B22CD0)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19B22D10)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19B22D50)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19B22D90)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19B22DD0)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B22C90)
