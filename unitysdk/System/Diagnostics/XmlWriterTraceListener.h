...
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19684370)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x196843B0)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x196843F0)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19684430)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19684470)
#define SYSTEM_DIAGNOSTICS_XMLWRITERTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x19684330)
