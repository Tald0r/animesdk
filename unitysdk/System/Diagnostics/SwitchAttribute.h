...
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GETALLRECURSIVE_1_OFFSET UNITYSDK_OFFSET(0x1A5F30B0)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GETALLRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1A5F2F20)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GETALL_OFFSET UNITYSDK_OFFSET(0x1A5F2D80)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GET_SWITCHDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A5F2D60)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GET_SWITCHNAME_OFFSET UNITYSDK_OFFSET(0x1A5F2D40)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GET_SWITCHTYPE_OFFSET UNITYSDK_OFFSET(0x1A5F2D50)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_SET_SWITCHDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A5F2D70)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_SET_SWITCHNAME_OFFSET UNITYSDK_OFFSET(0x1A5F2BE0)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_SET_SWITCHTYPE_OFFSET UNITYSDK_OFFSET(0x1A5F2CD0)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F2B70)
