...
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GETALLRECURSIVE_1_OFFSET UNITYSDK_OFFSET(0x19FDA070)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GETALLRECURSIVE_OFFSET UNITYSDK_OFFSET(0x19FD9EE0)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GETALL_OFFSET UNITYSDK_OFFSET(0x19FD9D40)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GET_SWITCHDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19FD9D20)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GET_SWITCHNAME_OFFSET UNITYSDK_OFFSET(0x19FD9D00)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_GET_SWITCHTYPE_OFFSET UNITYSDK_OFFSET(0x19FD9D10)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_SET_SWITCHDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19FD9D30)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_SET_SWITCHNAME_OFFSET UNITYSDK_OFFSET(0x19FD9BA0)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE_SET_SWITCHTYPE_OFFSET UNITYSDK_OFFSET(0x19FD9C90)
#define SYSTEM_DIAGNOSTICS_SWITCHATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD9B30)
