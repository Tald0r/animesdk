...
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A5F31A0)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_TRACEERROR_OFFSET UNITYSDK_OFFSET(0x1A5F3250)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_TRACEINFO_OFFSET UNITYSDK_OFFSET(0x1A5F32D0)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_TRACEVERBOSE_OFFSET UNITYSDK_OFFSET(0x1A5F3310)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_TRACEWARNING_OFFSET UNITYSDK_OFFSET(0x1A5F3290)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_ONSWITCHSETTINGCHANGED_OFFSET UNITYSDK_OFFSET(0x1A5F3350)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A5F33B0)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A5F31E0)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5F3130)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5EE2C0)
