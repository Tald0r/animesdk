...
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x19FDA160)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_TRACEERROR_OFFSET UNITYSDK_OFFSET(0x19FDA210)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_TRACEINFO_OFFSET UNITYSDK_OFFSET(0x19FDA290)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_TRACEVERBOSE_OFFSET UNITYSDK_OFFSET(0x19FDA2D0)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_GET_TRACEWARNING_OFFSET UNITYSDK_OFFSET(0x19FDA250)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_ONSWITCHSETTINGCHANGED_OFFSET UNITYSDK_OFFSET(0x19FDA310)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19FDA370)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x19FDA1A0)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FDA0F0)
#define SYSTEM_DIAGNOSTICS_TRACESWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD5280)
