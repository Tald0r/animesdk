...
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_GETSUPPORTEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19092F80)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_GET_DELIMITER_OFFSET UNITYSDK_OFFSET(0x19092B40)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_SET_DELIMITER_OFFSET UNITYSDK_OFFSET(0x19092DA0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_TRACEDATA_1_OFFSET UNITYSDK_OFFSET(0x19093930)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_TRACEDATA_OFFSET UNITYSDK_OFFSET(0x19093840)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_TRACEEVENT_1_OFFSET UNITYSDK_OFFSET(0x19093770)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_TRACEEVENT_OFFSET UNITYSDK_OFFSET(0x19092FF0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_WRITEESCAPED_OFFSET UNITYSDK_OFFSET(0x19093230)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_WRITEFOOTER_OFFSET UNITYSDK_OFFSET(0x190933A0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x19093130)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER_WRITESTACKESCAPED_OFFSET UNITYSDK_OFFSET(0x19093AC0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19092990)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x190929B0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19092A50)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19092AE0)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19092B10)
#define SYSTEM_DIAGNOSTICS_DELIMITEDLISTTRACELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x19092960)
