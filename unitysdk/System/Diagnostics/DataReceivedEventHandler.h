...
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x182DA0C0)
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x182DA100)
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x182D9B40)
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x182D9B30)
