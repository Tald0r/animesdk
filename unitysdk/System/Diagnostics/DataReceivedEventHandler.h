...
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x188EEDC0)
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x188EEE00)
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x188EE840)
#define SYSTEM_DIAGNOSTICS_DATARECEIVEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x188EE820)
