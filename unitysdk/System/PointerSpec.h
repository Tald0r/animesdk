...
#define SYSTEM_POINTERSPEC_APPEND_OFFSET UNITYSDK_OFFSET(0x186096E0)
#define SYSTEM_POINTERSPEC_RESOLVE_OFFSET UNITYSDK_OFFSET(0x18609690)
#define SYSTEM_POINTERSPEC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18609710)
#define SYSTEM_POINTERSPEC__CTOR_OFFSET UNITYSDK_OFFSET(0x18609680)
