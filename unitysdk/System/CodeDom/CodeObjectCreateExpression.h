...
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION_GET_CREATETYPE_OFFSET UNITYSDK_OFFSET(0x1936CEC0)
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1936CF40)
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION_SET_CREATETYPE_OFFSET UNITYSDK_OFFSET(0x1936CF00)
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1936CE00)
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1936CE40)
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1936CE80)
#define SYSTEM_CODEDOM_CODEOBJECTCREATEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1936CDC0)
