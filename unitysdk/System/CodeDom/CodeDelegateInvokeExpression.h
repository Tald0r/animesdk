...
#define SYSTEM_CODEDOM_CODEDELEGATEINVOKEEXPRESSION_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1936C680)
#define SYSTEM_CODEDOM_CODEDELEGATEINVOKEEXPRESSION_GET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x1936C6C0)
#define SYSTEM_CODEDOM_CODEDELEGATEINVOKEEXPRESSION_SET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x1936C700)
#define SYSTEM_CODEDOM_CODEDELEGATEINVOKEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1936C600)
#define SYSTEM_CODEDOM_CODEDELEGATEINVOKEEXPRESSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1936C640)
#define SYSTEM_CODEDOM_CODEDELEGATEINVOKEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1936C5C0)
