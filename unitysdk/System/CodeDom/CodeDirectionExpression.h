...
#define SYSTEM_CODEDOM_CODEDIRECTIONEXPRESSION_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x191C3620)
#define SYSTEM_CODEDOM_CODEDIRECTIONEXPRESSION_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x191C36A0)
#define SYSTEM_CODEDOM_CODEDIRECTIONEXPRESSION_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x191C3660)
#define SYSTEM_CODEDOM_CODEDIRECTIONEXPRESSION_SET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x191C36E0)
#define SYSTEM_CODEDOM_CODEDIRECTIONEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191C35E0)
#define SYSTEM_CODEDOM_CODEDIRECTIONEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x191C35A0)
