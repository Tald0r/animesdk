...
#define SYSTEM_CODEDOM_CODESNIPPETCOMPILEUNIT_GET_LINEPRAGMA_OFFSET UNITYSDK_OFFSET(0x1904A930)
#define SYSTEM_CODEDOM_CODESNIPPETCOMPILEUNIT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1904A9B0)
#define SYSTEM_CODEDOM_CODESNIPPETCOMPILEUNIT_SET_LINEPRAGMA_OFFSET UNITYSDK_OFFSET(0x1904A970)
#define SYSTEM_CODEDOM_CODESNIPPETCOMPILEUNIT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1904A9F0)
#define SYSTEM_CODEDOM_CODESNIPPETCOMPILEUNIT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1904A8F0)
#define SYSTEM_CODEDOM_CODESNIPPETCOMPILEUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1904A8B0)
