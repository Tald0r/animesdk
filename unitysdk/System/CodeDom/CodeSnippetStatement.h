...
#define SYSTEM_CODEDOM_CODESNIPPETSTATEMENT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x18B8AAC0)
#define SYSTEM_CODEDOM_CODESNIPPETSTATEMENT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x18B8AB00)
#define SYSTEM_CODEDOM_CODESNIPPETSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B8AA80)
#define SYSTEM_CODEDOM_CODESNIPPETSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B8AA40)
