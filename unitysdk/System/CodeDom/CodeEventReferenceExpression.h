...
#define SYSTEM_CODEDOM_CODEEVENTREFERENCEEXPRESSION_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x19D1BD30)
#define SYSTEM_CODEDOM_CODEEVENTREFERENCEEXPRESSION_GET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x19D1BDB0)
#define SYSTEM_CODEDOM_CODEEVENTREFERENCEEXPRESSION_SET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x19D1BD70)
#define SYSTEM_CODEDOM_CODEEVENTREFERENCEEXPRESSION_SET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x19D1BDF0)
#define SYSTEM_CODEDOM_CODEEVENTREFERENCEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D1BCF0)
#define SYSTEM_CODEDOM_CODEEVENTREFERENCEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19D1BCB0)
