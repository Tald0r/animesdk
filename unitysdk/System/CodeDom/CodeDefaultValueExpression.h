...
#define SYSTEM_CODEDOM_CODEDEFAULTVALUEEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1941CAA0)
#define SYSTEM_CODEDOM_CODEDEFAULTVALUEEXPRESSION_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1941CAE0)
#define SYSTEM_CODEDOM_CODEDEFAULTVALUEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1941CA60)
#define SYSTEM_CODEDOM_CODEDEFAULTVALUEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1941CA20)
