...
#define SYSTEM_CODEDOM_CODESNIPPETTYPEMEMBER_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x19B144F0)
#define SYSTEM_CODEDOM_CODESNIPPETTYPEMEMBER_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x19B14530)
#define SYSTEM_CODEDOM_CODESNIPPETTYPEMEMBER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B144B0)
#define SYSTEM_CODEDOM_CODESNIPPETTYPEMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B14470)
