...
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT_GET_CATCHCLAUSES_OFFSET UNITYSDK_OFFSET(0x1822BAE0)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT_GET_FINALLYSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1822BB20)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT_GET_TRYSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1822BB60)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1822BA60)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1822BAA0)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1822BA20)
