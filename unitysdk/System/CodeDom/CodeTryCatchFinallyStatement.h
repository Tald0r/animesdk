...
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT_GET_CATCHCLAUSES_OFFSET UNITYSDK_OFFSET(0x187C5EC0)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT_GET_FINALLYSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x187C5F00)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT_GET_TRYSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x187C5F40)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x187C5E40)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x187C5E80)
#define SYSTEM_CODEDOM_CODETRYCATCHFINALLYSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x187C5E00)
