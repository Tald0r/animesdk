...
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT_GET_EVENT_OFFSET UNITYSDK_OFFSET(0x19B138B0)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT_GET_LISTENER_OFFSET UNITYSDK_OFFSET(0x19B13930)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT_SET_EVENT_OFFSET UNITYSDK_OFFSET(0x19B138F0)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT_SET_LISTENER_OFFSET UNITYSDK_OFFSET(0x19B13970)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B13830)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19B13870)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B137F0)
