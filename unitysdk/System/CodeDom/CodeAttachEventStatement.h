...
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT_GET_EVENT_OFFSET UNITYSDK_OFFSET(0x19674FA0)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT_GET_LISTENER_OFFSET UNITYSDK_OFFSET(0x19675020)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT_SET_EVENT_OFFSET UNITYSDK_OFFSET(0x19674FE0)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT_SET_LISTENER_OFFSET UNITYSDK_OFFSET(0x19675060)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19674F20)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19674F60)
#define SYSTEM_CODEDOM_CODEATTACHEVENTSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19674EE0)
