...
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x191C34A0)
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT_GET_FALSESTATEMENTS_OFFSET UNITYSDK_OFFSET(0x191C3520)
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT_GET_TRUESTATEMENTS_OFFSET UNITYSDK_OFFSET(0x191C3560)
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x191C34E0)
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191C3420)
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191C3460)
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x191C33E0)
