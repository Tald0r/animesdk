...
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x195BF830)
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT_GET_FALSESTATEMENTS_OFFSET UNITYSDK_OFFSET(0x195BF8B0)
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT_GET_TRUESTATEMENTS_OFFSET UNITYSDK_OFFSET(0x195BF8F0)
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x195BF870)
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195BF7B0)
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x195BF7F0)
#define SYSTEM_CODEDOM_CODECONDITIONSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x195BF770)
