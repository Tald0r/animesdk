...
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT_GET_EVENT_OFFSET UNITYSDK_OFFSET(0x1941CC20)
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT_GET_LISTENER_OFFSET UNITYSDK_OFFSET(0x1941CCA0)
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT_SET_EVENT_OFFSET UNITYSDK_OFFSET(0x1941CC60)
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT_SET_LISTENER_OFFSET UNITYSDK_OFFSET(0x1941CCE0)
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1941CBA0)
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1941CBE0)
#define SYSTEM_CODEDOM_CODEREMOVEEVENTSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1941CB60)
