...
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_GET_INCREMENTSTATEMENT_OFFSET UNITYSDK_OFFSET(0x191C3B20)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_GET_INITSTATEMENT_OFFSET UNITYSDK_OFFSET(0x191C3BA0)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_GET_STATEMENTS_OFFSET UNITYSDK_OFFSET(0x191C3C20)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_GET_TESTEXPRESSION_OFFSET UNITYSDK_OFFSET(0x191C3C60)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_SET_INCREMENTSTATEMENT_OFFSET UNITYSDK_OFFSET(0x191C3B60)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_SET_INITSTATEMENT_OFFSET UNITYSDK_OFFSET(0x191C3BE0)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_SET_TESTEXPRESSION_OFFSET UNITYSDK_OFFSET(0x191C3CA0)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191C3AE0)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x191C3AA0)
