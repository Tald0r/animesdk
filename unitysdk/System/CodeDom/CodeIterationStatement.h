...
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_GET_INCREMENTSTATEMENT_OFFSET UNITYSDK_OFFSET(0x195BFEB0)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_GET_INITSTATEMENT_OFFSET UNITYSDK_OFFSET(0x195BFF30)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_GET_STATEMENTS_OFFSET UNITYSDK_OFFSET(0x195BFFB0)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_GET_TESTEXPRESSION_OFFSET UNITYSDK_OFFSET(0x195BFFF0)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_SET_INCREMENTSTATEMENT_OFFSET UNITYSDK_OFFSET(0x195BFEF0)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_SET_INITSTATEMENT_OFFSET UNITYSDK_OFFSET(0x195BFF70)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT_SET_TESTEXPRESSION_OFFSET UNITYSDK_OFFSET(0x195C0030)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195BFE70)
#define SYSTEM_CODEDOM_CODEITERATIONSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x195BFE30)
