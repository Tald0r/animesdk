...
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_GETSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x18FDB2D0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_HASGET_OFFSET UNITYSDK_OFFSET(0x18FDB310)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_HASSET_OFFSET UNITYSDK_OFFSET(0x18FDB390)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_IMPLEMENTATIONTYPES_OFFSET UNITYSDK_OFFSET(0x18FDB410)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x18FDB450)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x18FDB490)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_SETSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x18FDB510)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x18FDB550)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_HASGET_OFFSET UNITYSDK_OFFSET(0x18FDB350)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_HASSET_OFFSET UNITYSDK_OFFSET(0x18FDB3D0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x18FDB4D0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x18FDB590)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDB290)
