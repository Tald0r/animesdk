...
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_GETSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1936C780)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_HASGET_OFFSET UNITYSDK_OFFSET(0x1936C7C0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_HASSET_OFFSET UNITYSDK_OFFSET(0x1936C840)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_IMPLEMENTATIONTYPES_OFFSET UNITYSDK_OFFSET(0x1936C8C0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1936C900)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1936C940)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_SETSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x1936C9C0)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1936CA00)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_HASGET_OFFSET UNITYSDK_OFFSET(0x1936C800)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_HASSET_OFFSET UNITYSDK_OFFSET(0x1936C880)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_PRIVATEIMPLEMENTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1936C980)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1936CA40)
#define SYSTEM_CODEDOM_CODEMEMBERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1936C740)
