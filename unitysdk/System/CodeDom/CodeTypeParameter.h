...
#define SYSTEM_CODEDOM_CODETYPEPARAMETER_GET_CONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1A5ECFC0)
#define SYSTEM_CODEDOM_CODETYPEPARAMETER_GET_CUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A5ED000)
#define SYSTEM_CODEDOM_CODETYPEPARAMETER_GET_HASCONSTRUCTORCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A5ED040)
#define SYSTEM_CODEDOM_CODETYPEPARAMETER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A5ED0C0)
#define SYSTEM_CODEDOM_CODETYPEPARAMETER_SET_HASCONSTRUCTORCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A5ED080)
#define SYSTEM_CODEDOM_CODETYPEPARAMETER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A5ED100)
#define SYSTEM_CODEDOM_CODETYPEPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5ECF80)
#define SYSTEM_CODEDOM_CODETYPEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5ECF40)
