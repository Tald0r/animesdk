...
#define SYSTEM_CODEDOM_CODETYPEMEMBER_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18B56130)
#define SYSTEM_CODEDOM_CODETYPEMEMBER_GET_COMMENTS_OFFSET UNITYSDK_OFFSET(0x18B561B0)
#define SYSTEM_CODEDOM_CODETYPEMEMBER_GET_CUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18B561F0)
#define SYSTEM_CODEDOM_CODETYPEMEMBER_GET_ENDDIRECTIVES_OFFSET UNITYSDK_OFFSET(0x18B56270)
#define SYSTEM_CODEDOM_CODETYPEMEMBER_GET_LINEPRAGMA_OFFSET UNITYSDK_OFFSET(0x18B562B0)
#define SYSTEM_CODEDOM_CODETYPEMEMBER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18B56330)
#define SYSTEM_CODEDOM_CODETYPEMEMBER_GET_STARTDIRECTIVES_OFFSET UNITYSDK_OFFSET(0x18B563B0)
#define SYSTEM_CODEDOM_CODETYPEMEMBER_SET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18B56170)
#define SYSTEM_CODEDOM_CODETYPEMEMBER_SET_CUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18B56230)
#define SYSTEM_CODEDOM_CODETYPEMEMBER_SET_LINEPRAGMA_OFFSET UNITYSDK_OFFSET(0x18B562F0)
#define SYSTEM_CODEDOM_CODETYPEMEMBER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x18B56370)
#define SYSTEM_CODEDOM_CODETYPEMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B560F0)
