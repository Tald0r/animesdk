...
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION_GET_CREATETYPE_OFFSET UNITYSDK_OFFSET(0x190068B0)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION_GET_INITIALIZERS_OFFSET UNITYSDK_OFFSET(0x19006930)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION_GET_SIZEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x190069F0)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x19006970)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION_SET_CREATETYPE_OFFSET UNITYSDK_OFFSET(0x190068F0)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION_SET_SIZEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x19006A30)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x190069B0)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19006670)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x190066B0)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x190066F0)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19006730)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19006770)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION__CTOR_6_OFFSET UNITYSDK_OFFSET(0x190067B0)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION__CTOR_7_OFFSET UNITYSDK_OFFSET(0x190067F0)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION__CTOR_8_OFFSET UNITYSDK_OFFSET(0x19006830)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION__CTOR_9_OFFSET UNITYSDK_OFFSET(0x19006870)
#define SYSTEM_CODEDOM_CODEARRAYCREATEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19006630)
