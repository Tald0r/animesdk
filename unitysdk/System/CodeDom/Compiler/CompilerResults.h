...
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_COMPILEDASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1822BBE0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_ERRORS_OFFSET UNITYSDK_OFFSET(0x1822BC60)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_EVIDENCE_OFFSET UNITYSDK_OFFSET(0x1822BCA0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_NATIVECOMPILERRETURNVALUE_OFFSET UNITYSDK_OFFSET(0x1822BD20)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_OUTPUT_OFFSET UNITYSDK_OFFSET(0x1822BDA0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_PATHTOASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1822BDE0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_GET_TEMPFILES_OFFSET UNITYSDK_OFFSET(0x1822BE60)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_SET_COMPILEDASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1822BC20)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_SET_EVIDENCE_OFFSET UNITYSDK_OFFSET(0x1822BCE0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_SET_NATIVECOMPILERRETURNVALUE_OFFSET UNITYSDK_OFFSET(0x1822BD60)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_SET_PATHTOASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1822BE20)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS_SET_TEMPFILES_OFFSET UNITYSDK_OFFSET(0x1822BEA0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERRESULTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1822BBA0)
