...
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_ADDRANGE_1_OFFSET UNITYSDK_OFFSET(0x18FDC090)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_ADDRANGE_OFFSET UNITYSDK_OFFSET(0x18FDC050)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x18FDC010)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x18FDC0D0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x18FDC110)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_GET_HASERRORS_OFFSET UNITYSDK_OFFSET(0x18FDBF10)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_GET_HASWARNINGS_OFFSET UNITYSDK_OFFSET(0x18FDBF50)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x18FDBF90)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x18FDC150)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_INSERT_OFFSET UNITYSDK_OFFSET(0x18FDC190)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x18FDC1D0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x18FDBFD0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FDBE90)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FDBED0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERRORCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDBE50)
