...
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_ADDEXTENSION_1_OFFSET UNITYSDK_OFFSET(0x19676D20)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_ADDEXTENSION_OFFSET UNITYSDK_OFFSET(0x19676CE0)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_ADDFILE_OFFSET UNITYSDK_OFFSET(0x19676D60)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x19676DA0)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_DELETE_OFFSET UNITYSDK_OFFSET(0x19676DE0)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19676E20)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19676E60)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_GET_BASEPATH_OFFSET UNITYSDK_OFFSET(0x19676AE0)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19676B20)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_GET_KEEPFILES_OFFSET UNITYSDK_OFFSET(0x19676B60)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_GET_TEMPDIR_OFFSET UNITYSDK_OFFSET(0x19676CA0)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_SET_KEEPFILES_OFFSET UNITYSDK_OFFSET(0x19676BA0)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x19676EA0)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19676BE0)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19676C20)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x19676C60)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19676EE0)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19676F20)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19676A60)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19676AA0)
#define SYSTEM_CODEDOM_COMPILER_TEMPFILECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19676A20)
