...
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMDOMBATCH_OFFSET UNITYSDK_OFFSET(0x1944A140)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMDOM_OFFSET UNITYSDK_OFFSET(0x1944A100)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMFILEBATCH_OFFSET UNITYSDK_OFFSET(0x1944A1C0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMFILE_OFFSET UNITYSDK_OFFSET(0x1944A180)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMSOURCEBATCH_OFFSET UNITYSDK_OFFSET(0x1944A240)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMSOURCE_OFFSET UNITYSDK_OFFSET(0x1944A200)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_GETRESPONSEFILECMDARGS_OFFSET UNITYSDK_OFFSET(0x1944A280)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_JOINSTRINGARRAY_OFFSET UNITYSDK_OFFSET(0x1944A2C0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMDOMBATCH_OFFSET UNITYSDK_OFFSET(0x1944A340)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMDOM_OFFSET UNITYSDK_OFFSET(0x1944A300)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMFILEBATCH_OFFSET UNITYSDK_OFFSET(0x1944A3C0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMFILE_OFFSET UNITYSDK_OFFSET(0x1944A380)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMSOURCEBATCH_OFFSET UNITYSDK_OFFSET(0x1944A440)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMSOURCE_OFFSET UNITYSDK_OFFSET(0x1944A400)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0x1944A0C0)
