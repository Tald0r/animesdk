...
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMDOMBATCH_OFFSET UNITYSDK_OFFSET(0x1908D9A0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMDOM_OFFSET UNITYSDK_OFFSET(0x1908D960)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMFILEBATCH_OFFSET UNITYSDK_OFFSET(0x1908DA20)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMFILE_OFFSET UNITYSDK_OFFSET(0x1908D9E0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMSOURCEBATCH_OFFSET UNITYSDK_OFFSET(0x1908DAA0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_FROMSOURCE_OFFSET UNITYSDK_OFFSET(0x1908DA60)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_GETRESPONSEFILECMDARGS_OFFSET UNITYSDK_OFFSET(0x1908DAE0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_JOINSTRINGARRAY_OFFSET UNITYSDK_OFFSET(0x1908DB20)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMDOMBATCH_OFFSET UNITYSDK_OFFSET(0x1908DBA0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMDOM_OFFSET UNITYSDK_OFFSET(0x1908DB60)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMFILEBATCH_OFFSET UNITYSDK_OFFSET(0x1908DC20)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMFILE_OFFSET UNITYSDK_OFFSET(0x1908DBE0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMSOURCEBATCH_OFFSET UNITYSDK_OFFSET(0x1908DCA0)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER_SYSTEM_CODEDOM_COMPILER_ICODECOMPILER_COMPILEASSEMBLYFROMSOURCE_OFFSET UNITYSDK_OFFSET(0x1908DC60)
#define SYSTEM_CODEDOM_COMPILER_CODECOMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0x1908D920)
