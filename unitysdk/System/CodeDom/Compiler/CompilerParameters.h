...
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_COMPILEROPTIONS_OFFSET UNITYSDK_OFFSET(0x195C0880)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_COREASSEMBLYFILENAME_OFFSET UNITYSDK_OFFSET(0x195C0900)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_EMBEDDEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x195C0980)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_EVIDENCE_OFFSET UNITYSDK_OFFSET(0x195C09C0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_GENERATEEXECUTABLE_OFFSET UNITYSDK_OFFSET(0x195C0A40)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_GENERATEINMEMORY_OFFSET UNITYSDK_OFFSET(0x195C0AC0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_INCLUDEDEBUGINFORMATION_OFFSET UNITYSDK_OFFSET(0x195C0B40)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_LINKEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x195C0BC0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_MAINCLASS_OFFSET UNITYSDK_OFFSET(0x195C0C00)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_OUTPUTASSEMBLY_OFFSET UNITYSDK_OFFSET(0x195C0C80)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_REFERENCEDASSEMBLIES_OFFSET UNITYSDK_OFFSET(0x195C0D00)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_TEMPFILES_OFFSET UNITYSDK_OFFSET(0x195C0D40)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_TREATWARNINGSASERRORS_OFFSET UNITYSDK_OFFSET(0x195C0DC0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_USERTOKEN_OFFSET UNITYSDK_OFFSET(0x195C0E40)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_WARNINGLEVEL_OFFSET UNITYSDK_OFFSET(0x195C0EC0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_GET_WIN32RESOURCE_OFFSET UNITYSDK_OFFSET(0x195C0F40)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_COMPILEROPTIONS_OFFSET UNITYSDK_OFFSET(0x195C08C0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_COREASSEMBLYFILENAME_OFFSET UNITYSDK_OFFSET(0x195C0940)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_EVIDENCE_OFFSET UNITYSDK_OFFSET(0x195C0A00)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_GENERATEEXECUTABLE_OFFSET UNITYSDK_OFFSET(0x195C0A80)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_GENERATEINMEMORY_OFFSET UNITYSDK_OFFSET(0x195C0B00)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_INCLUDEDEBUGINFORMATION_OFFSET UNITYSDK_OFFSET(0x195C0B80)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_MAINCLASS_OFFSET UNITYSDK_OFFSET(0x195C0C40)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_OUTPUTASSEMBLY_OFFSET UNITYSDK_OFFSET(0x195C0CC0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_TEMPFILES_OFFSET UNITYSDK_OFFSET(0x195C0D80)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_TREATWARNINGSASERRORS_OFFSET UNITYSDK_OFFSET(0x195C0E00)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_USERTOKEN_OFFSET UNITYSDK_OFFSET(0x195C0E80)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_WARNINGLEVEL_OFFSET UNITYSDK_OFFSET(0x195C0F00)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS_SET_WIN32RESOURCE_OFFSET UNITYSDK_OFFSET(0x195C0F80)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195C07C0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x195C0800)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x195C0840)
#define SYSTEM_CODEDOM_COMPILER_COMPILERPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x195C0780)
