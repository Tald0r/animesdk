...
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_COMPILEASSEMBLYFROMDOM_OFFSET UNITYSDK_OFFSET(0x19676060)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_COMPILEASSEMBLYFROMFILE_OFFSET UNITYSDK_OFFSET(0x196760A0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_COMPILEASSEMBLYFROMSOURCE_OFFSET UNITYSDK_OFFSET(0x196760E0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEESCAPEDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x19676120)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEGENERATOR_1_OFFSET UNITYSDK_OFFSET(0x196761A0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEGENERATOR_OFFSET UNITYSDK_OFFSET(0x19676160)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEPARSER_OFFSET UNITYSDK_OFFSET(0x196761E0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEPROVIDER_1_OFFSET UNITYSDK_OFFSET(0x19676260)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEPROVIDER_OFFSET UNITYSDK_OFFSET(0x19676220)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_CREATEVALIDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x196762A0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMCOMPILEUNIT_OFFSET UNITYSDK_OFFSET(0x196762E0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMEXPRESSION_OFFSET UNITYSDK_OFFSET(0x19676320)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMMEMBER_OFFSET UNITYSDK_OFFSET(0x19676360)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMNAMESPACE_OFFSET UNITYSDK_OFFSET(0x196763A0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMSTATEMENT_OFFSET UNITYSDK_OFFSET(0x196763E0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GENERATECODEFROMTYPE_OFFSET UNITYSDK_OFFSET(0x19676420)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETALLCOMPILERINFO_OFFSET UNITYSDK_OFFSET(0x19676460)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETCOMPILERINFO_OFFSET UNITYSDK_OFFSET(0x196764A0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x196764E0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETLANGUAGEFROMEXTENSION_OFFSET UNITYSDK_OFFSET(0x19676520)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GETTYPEOUTPUT_OFFSET UNITYSDK_OFFSET(0x19676560)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GET_FILEEXTENSION_OFFSET UNITYSDK_OFFSET(0x19675FE0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_GET_LANGUAGEOPTIONS_OFFSET UNITYSDK_OFFSET(0x19676020)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_ISDEFINEDEXTENSION_OFFSET UNITYSDK_OFFSET(0x196765A0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_ISDEFINEDLANGUAGE_OFFSET UNITYSDK_OFFSET(0x196765E0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_ISVALIDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x19676620)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_PARSE_OFFSET UNITYSDK_OFFSET(0x19676660)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER_SUPPORTS_OFFSET UNITYSDK_OFFSET(0x196766A0)
#define SYSTEM_CODEDOM_COMPILER_CODEDOMPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19675FA0)
