...
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_CREATEDEFAULTCOMPILERPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19FD42D0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_CREATEPROVIDER_1_OFFSET UNITYSDK_OFFSET(0x19FD4350)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_CREATEPROVIDER_OFFSET UNITYSDK_OFFSET(0x19FD4310)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_GETEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x19FD4390)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_GETLANGUAGES_OFFSET UNITYSDK_OFFSET(0x19FD43D0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_GET_CODEDOMPROVIDERTYPE_OFFSET UNITYSDK_OFFSET(0x19FD4250)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_GET_ISCODEDOMPROVIDERTYPEVALID_OFFSET UNITYSDK_OFFSET(0x19FD4290)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD4210)
