...
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_CREATEDEFAULTCOMPILERPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A5ED300)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_CREATEPROVIDER_1_OFFSET UNITYSDK_OFFSET(0x1A5ED380)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_CREATEPROVIDER_OFFSET UNITYSDK_OFFSET(0x1A5ED340)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_GETEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1A5ED3C0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_GETLANGUAGES_OFFSET UNITYSDK_OFFSET(0x1A5ED400)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_GET_CODEDOMPROVIDERTYPE_OFFSET UNITYSDK_OFFSET(0x1A5ED280)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO_GET_ISCODEDOMPROVIDERTYPEVALID_OFFSET UNITYSDK_OFFSET(0x1A5ED2C0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5ED240)
