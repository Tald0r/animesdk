...
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_CONTINUEONNEWLINE_OFFSET UNITYSDK_OFFSET(0x197DD190)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEBINARYOPERATOREXPRESSION_OFFSET UNITYSDK_OFFSET(0x197DD1D0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECODEFROMMEMBER_OFFSET UNITYSDK_OFFSET(0x197DD210)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMMENTSTATEMENTS_OFFSET UNITYSDK_OFFSET(0x197DD290)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMMENTSTATEMENT_OFFSET UNITYSDK_OFFSET(0x197DD250)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMPILEUNITEND_OFFSET UNITYSDK_OFFSET(0x197DD310)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMPILEUNITSTART_OFFSET UNITYSDK_OFFSET(0x197DD350)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATECOMPILEUNIT_OFFSET UNITYSDK_OFFSET(0x197DD2D0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDECIMALVALUE_OFFSET UNITYSDK_OFFSET(0x197DD390)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDEFAULTVALUEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x197DD3D0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDIRECTIONEXPRESSION_OFFSET UNITYSDK_OFFSET(0x197DD410)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDIRECTIVES_OFFSET UNITYSDK_OFFSET(0x197DD450)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEDOUBLEVALUE_OFFSET UNITYSDK_OFFSET(0x197DD490)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x197DD4D0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATENAMESPACEIMPORTS_OFFSET UNITYSDK_OFFSET(0x197DD550)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATENAMESPACES_OFFSET UNITYSDK_OFFSET(0x197DD590)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATENAMESPACE_OFFSET UNITYSDK_OFFSET(0x197DD510)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEPARAMETERDECLARATIONEXPRESSION_OFFSET UNITYSDK_OFFSET(0x197DD5D0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATEPRIMITIVEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x197DD610)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESINGLEFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x197DD650)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESNIPPETCOMPILEUNIT_OFFSET UNITYSDK_OFFSET(0x197DD690)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESNIPPETSTATEMENT_OFFSET UNITYSDK_OFFSET(0x197DD6D0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESTATEMENTS_OFFSET UNITYSDK_OFFSET(0x197DD750)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATESTATEMENT_OFFSET UNITYSDK_OFFSET(0x197DD710)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATETYPEOFEXPRESSION_OFFSET UNITYSDK_OFFSET(0x197DD790)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATETYPEREFERENCEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x197DD7D0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GENERATETYPES_OFFSET UNITYSDK_OFFSET(0x197DD810)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_CURRENTCLASS_OFFSET UNITYSDK_OFFSET(0x197DCE50)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_CURRENTMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x197DCED0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_CURRENTMEMBER_OFFSET UNITYSDK_OFFSET(0x197DCE90)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_CURRENTTYPENAME_OFFSET UNITYSDK_OFFSET(0x197DCF10)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_INDENT_OFFSET UNITYSDK_OFFSET(0x197DCF50)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTCLASS_OFFSET UNITYSDK_OFFSET(0x197DCFD0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTDELEGATE_OFFSET UNITYSDK_OFFSET(0x197DD010)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTENUM_OFFSET UNITYSDK_OFFSET(0x197DD050)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTINTERFACE_OFFSET UNITYSDK_OFFSET(0x197DD090)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_ISCURRENTSTRUCT_OFFSET UNITYSDK_OFFSET(0x197DD0D0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x197DD110)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_GET_OUTPUT_OFFSET UNITYSDK_OFFSET(0x197DD150)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_ISVALIDLANGUAGEINDEPENDENTIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x197DD850)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTATTRIBUTEARGUMENT_OFFSET UNITYSDK_OFFSET(0x197DD890)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTATTRIBUTEDECLARATIONS_OFFSET UNITYSDK_OFFSET(0x197DD8D0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTDIRECTION_OFFSET UNITYSDK_OFFSET(0x197DD910)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTEXPRESSIONLIST_1_OFFSET UNITYSDK_OFFSET(0x197DD990)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTEXPRESSIONLIST_OFFSET UNITYSDK_OFFSET(0x197DD950)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTFIELDSCOPEMODIFIER_OFFSET UNITYSDK_OFFSET(0x197DD9D0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x197DDA10)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTMEMBERACCESSMODIFIER_OFFSET UNITYSDK_OFFSET(0x197DDA50)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTMEMBERSCOPEMODIFIER_OFFSET UNITYSDK_OFFSET(0x197DDA90)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTOPERATOR_OFFSET UNITYSDK_OFFSET(0x197DDAD0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTPARAMETERS_OFFSET UNITYSDK_OFFSET(0x197DDB10)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTTYPEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x197DDB50)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_OUTPUTTYPENAMEPAIR_OFFSET UNITYSDK_OFFSET(0x197DDB90)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SET_INDENT_OFFSET UNITYSDK_OFFSET(0x197DCF90)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_CREATEESCAPEDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x197DDBD0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_CREATEVALIDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x197DDC10)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMCOMPILEUNIT_OFFSET UNITYSDK_OFFSET(0x197DDC50)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMEXPRESSION_OFFSET UNITYSDK_OFFSET(0x197DDC90)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMNAMESPACE_OFFSET UNITYSDK_OFFSET(0x197DDCD0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMSTATEMENT_OFFSET UNITYSDK_OFFSET(0x197DDD10)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GENERATECODEFROMTYPE_OFFSET UNITYSDK_OFFSET(0x197DDD50)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_GETTYPEOUTPUT_OFFSET UNITYSDK_OFFSET(0x197DDD90)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_ISVALIDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x197DDDD0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_SUPPORTS_OFFSET UNITYSDK_OFFSET(0x197DDE10)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_SYSTEM_CODEDOM_COMPILER_ICODEGENERATOR_VALIDATEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x197DDE50)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_VALIDATEIDENTIFIERS_OFFSET UNITYSDK_OFFSET(0x197DDED0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR_VALIDATEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x197DDE90)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x197DCE10)
