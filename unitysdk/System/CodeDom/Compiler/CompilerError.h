...
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_GET_COLUMN_OFFSET UNITYSDK_OFFSET(0x18FACBE0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_GET_ERRORNUMBER_OFFSET UNITYSDK_OFFSET(0x18FACC60)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_GET_ERRORTEXT_OFFSET UNITYSDK_OFFSET(0x18FACCE0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x18FACD60)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_GET_ISWARNING_OFFSET UNITYSDK_OFFSET(0x18FACDE0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_GET_LINE_OFFSET UNITYSDK_OFFSET(0x18FACE60)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_SET_COLUMN_OFFSET UNITYSDK_OFFSET(0x18FACC20)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_SET_ERRORNUMBER_OFFSET UNITYSDK_OFFSET(0x18FACCA0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_SET_ERRORTEXT_OFFSET UNITYSDK_OFFSET(0x18FACD20)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x18FACDA0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_SET_ISWARNING_OFFSET UNITYSDK_OFFSET(0x18FACE20)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_SET_LINE_OFFSET UNITYSDK_OFFSET(0x18FACEA0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FACBA0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x18FACB60)
