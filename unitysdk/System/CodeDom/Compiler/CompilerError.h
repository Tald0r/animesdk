...
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_GET_COLUMN_OFFSET UNITYSDK_OFFSET(0x19398FD0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_GET_ERRORNUMBER_OFFSET UNITYSDK_OFFSET(0x19399050)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_GET_ERRORTEXT_OFFSET UNITYSDK_OFFSET(0x193990D0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x19399150)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_GET_ISWARNING_OFFSET UNITYSDK_OFFSET(0x193991D0)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_GET_LINE_OFFSET UNITYSDK_OFFSET(0x19399250)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_SET_COLUMN_OFFSET UNITYSDK_OFFSET(0x19399010)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_SET_ERRORNUMBER_OFFSET UNITYSDK_OFFSET(0x19399090)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_SET_ERRORTEXT_OFFSET UNITYSDK_OFFSET(0x19399110)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x19399190)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_SET_ISWARNING_OFFSET UNITYSDK_OFFSET(0x19399210)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR_SET_LINE_OFFSET UNITYSDK_OFFSET(0x19399290)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19398F90)
#define SYSTEM_CODEDOM_COMPILER_COMPILERERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x19398F50)
