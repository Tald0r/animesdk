...
#define SYSTEM_CODEDOM_COMPILER_GENERATEDCODEATTRIBUTE_GET_TOOL_OFFSET UNITYSDK_OFFSET(0x19FD4420)
#define SYSTEM_CODEDOM_COMPILER_GENERATEDCODEATTRIBUTE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x19FD4430)
#define SYSTEM_CODEDOM_COMPILER_GENERATEDCODEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD4410)
