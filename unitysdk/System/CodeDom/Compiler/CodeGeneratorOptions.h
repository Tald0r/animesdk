...
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_GET_BLANKLINESBETWEENMEMBERS_OFFSET UNITYSDK_OFFSET(0x19B15030)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_GET_BRACINGSTYLE_OFFSET UNITYSDK_OFFSET(0x19B150B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_GET_ELSEONCLOSING_OFFSET UNITYSDK_OFFSET(0x19B15130)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_GET_INDENTSTRING_OFFSET UNITYSDK_OFFSET(0x19B151B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19B15230)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_GET_VERBATIMORDER_OFFSET UNITYSDK_OFFSET(0x19B152B0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_SET_BLANKLINESBETWEENMEMBERS_OFFSET UNITYSDK_OFFSET(0x19B15070)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_SET_BRACINGSTYLE_OFFSET UNITYSDK_OFFSET(0x19B150F0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_SET_ELSEONCLOSING_OFFSET UNITYSDK_OFFSET(0x19B15170)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_SET_INDENTSTRING_OFFSET UNITYSDK_OFFSET(0x19B151F0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19B15270)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS_SET_VERBATIMORDER_OFFSET UNITYSDK_OFFSET(0x19B152F0)
#define SYSTEM_CODEDOM_COMPILER_CODEGENERATOROPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19B14FF0)
