...
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAITWITHCAPTURE_1_OFFSET UNITYSDK_OFFSET(0x182C06B0)
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAITWITHCAPTURE_2_OFFSET UNITYSDK_OFFSET(0x182C06F0)
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAITWITHCAPTURE_3_OFFSET UNITYSDK_OFFSET(0x182C0730)
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAITWITHCAPTURE_OFFSET UNITYSDK_OFFSET(0x182C0670)
#define SYSTEM_CODEDOM_COMPILER_EXECUTOR_EXECWAIT_OFFSET UNITYSDK_OFFSET(0x182C0630)
