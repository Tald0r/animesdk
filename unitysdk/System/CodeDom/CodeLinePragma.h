...
#define SYSTEM_CODEDOM_CODELINEPRAGMA_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x19398790)
#define SYSTEM_CODEDOM_CODELINEPRAGMA_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x19398810)
#define SYSTEM_CODEDOM_CODELINEPRAGMA_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x193987D0)
#define SYSTEM_CODEDOM_CODELINEPRAGMA_SET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x19398850)
#define SYSTEM_CODEDOM_CODELINEPRAGMA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19398750)
#define SYSTEM_CODEDOM_CODELINEPRAGMA__CTOR_OFFSET UNITYSDK_OFFSET(0x19398710)
