...
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_ADD_POPULATEBASETYPES_OFFSET UNITYSDK_OFFSET(0x191C42F0)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_ADD_POPULATEMEMBERS_OFFSET UNITYSDK_OFFSET(0x191C4370)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_GET_BASETYPES_OFFSET UNITYSDK_OFFSET(0x191C3F30)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_GET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x191C3F70)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_GET_ISENUM_OFFSET UNITYSDK_OFFSET(0x191C3FF0)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_GET_ISINTERFACE_OFFSET UNITYSDK_OFFSET(0x191C4070)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_GET_ISPARTIAL_OFFSET UNITYSDK_OFFSET(0x191C40F0)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_GET_ISSTRUCT_OFFSET UNITYSDK_OFFSET(0x191C4170)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_GET_MEMBERS_OFFSET UNITYSDK_OFFSET(0x191C41F0)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_GET_TYPEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x191C4230)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_GET_TYPEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x191C42B0)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_REMOVE_POPULATEBASETYPES_OFFSET UNITYSDK_OFFSET(0x191C4330)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_REMOVE_POPULATEMEMBERS_OFFSET UNITYSDK_OFFSET(0x191C43B0)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_SET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x191C3FB0)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_SET_ISENUM_OFFSET UNITYSDK_OFFSET(0x191C4030)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_SET_ISINTERFACE_OFFSET UNITYSDK_OFFSET(0x191C40B0)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_SET_ISPARTIAL_OFFSET UNITYSDK_OFFSET(0x191C4130)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_SET_ISSTRUCT_OFFSET UNITYSDK_OFFSET(0x191C41B0)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION_SET_TYPEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x191C4270)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191C3EF0)
#define SYSTEM_CODEDOM_CODETYPEDECLARATION__CTOR_OFFSET UNITYSDK_OFFSET(0x191C3EE0)
