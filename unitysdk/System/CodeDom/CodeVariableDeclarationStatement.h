...
#define SYSTEM_CODEDOM_CODEVARIABLEDECLARATIONSTATEMENT_GET_INITEXPRESSION_OFFSET UNITYSDK_OFFSET(0x18D66160)
#define SYSTEM_CODEDOM_CODEVARIABLEDECLARATIONSTATEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18D661E0)
#define SYSTEM_CODEDOM_CODEVARIABLEDECLARATIONSTATEMENT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x18D66260)
#define SYSTEM_CODEDOM_CODEVARIABLEDECLARATIONSTATEMENT_SET_INITEXPRESSION_OFFSET UNITYSDK_OFFSET(0x18D661A0)
#define SYSTEM_CODEDOM_CODEVARIABLEDECLARATIONSTATEMENT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x18D66220)
#define SYSTEM_CODEDOM_CODEVARIABLEDECLARATIONSTATEMENT_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x18D662A0)
#define SYSTEM_CODEDOM_CODEVARIABLEDECLARATIONSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18D65FE0)
#define SYSTEM_CODEDOM_CODEVARIABLEDECLARATIONSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18D66020)
#define SYSTEM_CODEDOM_CODEVARIABLEDECLARATIONSTATEMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18D66060)
#define SYSTEM_CODEDOM_CODEVARIABLEDECLARATIONSTATEMENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18D660A0)
#define SYSTEM_CODEDOM_CODEVARIABLEDECLARATIONSTATEMENT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x18D660E0)
#define SYSTEM_CODEDOM_CODEVARIABLEDECLARATIONSTATEMENT__CTOR_6_OFFSET UNITYSDK_OFFSET(0x18D66120)
#define SYSTEM_CODEDOM_CODEVARIABLEDECLARATIONSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D65FA0)
