...
#define SYSTEM_CODEDOM_CODEPRIMITIVEEXPRESSION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x18F474A0)
#define SYSTEM_CODEDOM_CODEPRIMITIVEEXPRESSION_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x18F474E0)
#define SYSTEM_CODEDOM_CODEPRIMITIVEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F47460)
#define SYSTEM_CODEDOM_CODEPRIMITIVEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18F47420)
