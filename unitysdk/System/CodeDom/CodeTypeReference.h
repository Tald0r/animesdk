...
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_ARRAYELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x191AEA50)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_ARRAYRANK_OFFSET UNITYSDK_OFFSET(0x191AEAD0)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_BASETYPE_OFFSET UNITYSDK_OFFSET(0x191AEB50)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x191AEBD0)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_GET_TYPEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x191AEC50)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_SET_ARRAYELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x191AEA90)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_SET_ARRAYRANK_OFFSET UNITYSDK_OFFSET(0x191AEB10)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_SET_BASETYPE_OFFSET UNITYSDK_OFFSET(0x191AEB90)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE_SET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x191AEC10)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191AE850)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191AE890)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x191AE8D0)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x191AE910)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x191AE950)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x191AE990)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_7_OFFSET UNITYSDK_OFFSET(0x191AE9D0)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_8_OFFSET UNITYSDK_OFFSET(0x191AEA10)
#define SYSTEM_CODEDOM_CODETYPEREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x191AE810)
