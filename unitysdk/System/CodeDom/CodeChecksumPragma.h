...
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_GET_CHECKSUMALGORITHMID_OFFSET UNITYSDK_OFFSET(0x19675120)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_GET_CHECKSUMDATA_OFFSET UNITYSDK_OFFSET(0x196751A0)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x19675220)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_SET_CHECKSUMALGORITHMID_OFFSET UNITYSDK_OFFSET(0x19675160)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_SET_CHECKSUMDATA_OFFSET UNITYSDK_OFFSET(0x196751E0)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x19675260)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x196750E0)
#define SYSTEM_CODEDOM_CODECHECKSUMPRAGMA__CTOR_OFFSET UNITYSDK_OFFSET(0x196750A0)
