...
#define SYSTEM_CODEDOM_CODECASTEXPRESSION_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1936C180)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1936C200)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION_SET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1936C1C0)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION_SET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1936C240)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1936C0C0)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1936C100)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1936C140)
#define SYSTEM_CODEDOM_CODECASTEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1936C080)
