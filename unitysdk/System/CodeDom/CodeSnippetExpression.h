...
#define SYSTEM_CODEDOM_CODESNIPPETEXPRESSION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x191C3D60)
#define SYSTEM_CODEDOM_CODESNIPPETEXPRESSION_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x191C3DA0)
#define SYSTEM_CODEDOM_CODESNIPPETEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191C3D20)
#define SYSTEM_CODEDOM_CODESNIPPETEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x191C3CE0)
