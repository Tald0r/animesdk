...
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_GET_CATCHEXCEPTIONTYPE_OFFSET UNITYSDK_OFFSET(0x182BFBE0)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x182BFC60)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_GET_STATEMENTS_OFFSET UNITYSDK_OFFSET(0x182BFCE0)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_SET_CATCHEXCEPTIONTYPE_OFFSET UNITYSDK_OFFSET(0x182BFC20)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE_SET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x182BFCA0)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x182BFB20)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x182BFB60)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x182BFBA0)
#define SYSTEM_CODEDOM_CODECATCHCLAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x182BFAE0)
