...
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE_GET_REGIONMODE_OFFSET UNITYSDK_OFFSET(0x182C03F0)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE_GET_REGIONTEXT_OFFSET UNITYSDK_OFFSET(0x182C0470)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE_SET_REGIONMODE_OFFSET UNITYSDK_OFFSET(0x182C0430)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE_SET_REGIONTEXT_OFFSET UNITYSDK_OFFSET(0x182C04B0)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x182C03B0)
#define SYSTEM_CODEDOM_CODEREGIONDIRECTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x182C0370)
