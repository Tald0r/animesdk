...
#define SYSTEM_CODEDOM_CODETYPEDELEGATE_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x188D5230)
#define SYSTEM_CODEDOM_CODETYPEDELEGATE_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x188D5270)
#define SYSTEM_CODEDOM_CODETYPEDELEGATE_SET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x188D52B0)
#define SYSTEM_CODEDOM_CODETYPEDELEGATE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x188D51F0)
#define SYSTEM_CODEDOM_CODETYPEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x188D51B0)
