...
#define SYSTEM_CODEDOM_CODECOMPILEUNIT_GET_ASSEMBLYCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x188D49F0)
#define SYSTEM_CODEDOM_CODECOMPILEUNIT_GET_ENDDIRECTIVES_OFFSET UNITYSDK_OFFSET(0x188D4A30)
#define SYSTEM_CODEDOM_CODECOMPILEUNIT_GET_NAMESPACES_OFFSET UNITYSDK_OFFSET(0x188D4A70)
#define SYSTEM_CODEDOM_CODECOMPILEUNIT_GET_REFERENCEDASSEMBLIES_OFFSET UNITYSDK_OFFSET(0x188D4AB0)
#define SYSTEM_CODEDOM_CODECOMPILEUNIT_GET_STARTDIRECTIVES_OFFSET UNITYSDK_OFFSET(0x188D4AF0)
#define SYSTEM_CODEDOM_CODECOMPILEUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x188D49E0)
