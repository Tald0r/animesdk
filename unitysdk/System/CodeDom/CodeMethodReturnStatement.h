...
#define SYSTEM_CODEDOM_CODEMETHODRETURNSTATEMENT_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x19B140B0)
#define SYSTEM_CODEDOM_CODEMETHODRETURNSTATEMENT_SET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x19B140F0)
#define SYSTEM_CODEDOM_CODEMETHODRETURNSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B14070)
#define SYSTEM_CODEDOM_CODEMETHODRETURNSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B14030)
