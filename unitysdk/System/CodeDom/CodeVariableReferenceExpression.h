...
#define SYSTEM_CODEDOM_CODEVARIABLEREFERENCEEXPRESSION_GET_VARIABLENAME_OFFSET UNITYSDK_OFFSET(0x1A5ED1C0)
#define SYSTEM_CODEDOM_CODEVARIABLEREFERENCEEXPRESSION_SET_VARIABLENAME_OFFSET UNITYSDK_OFFSET(0x1A5ED200)
#define SYSTEM_CODEDOM_CODEVARIABLEREFERENCEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5ED180)
#define SYSTEM_CODEDOM_CODEVARIABLEREFERENCEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5ED140)
