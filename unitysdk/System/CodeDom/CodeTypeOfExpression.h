...
#define SYSTEM_CODEDOM_CODETYPEOFEXPRESSION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A5ECEC0)
#define SYSTEM_CODEDOM_CODETYPEOFEXPRESSION_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A5ECF00)
#define SYSTEM_CODEDOM_CODETYPEOFEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5ECE00)
#define SYSTEM_CODEDOM_CODETYPEOFEXPRESSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A5ECE40)
#define SYSTEM_CODEDOM_CODETYPEOFEXPRESSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A5ECE80)
#define SYSTEM_CODEDOM_CODETYPEOFEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5ECDC0)
