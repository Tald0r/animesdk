...
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT_GET_LABEL_OFFSET UNITYSDK_OFFSET(0x19B13F30)
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT_GET_STATEMENT_OFFSET UNITYSDK_OFFSET(0x19B13FB0)
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT_SET_LABEL_OFFSET UNITYSDK_OFFSET(0x19B13F70)
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT_SET_STATEMENT_OFFSET UNITYSDK_OFFSET(0x19B13FF0)
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B13EB0)
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19B13EF0)
#define SYSTEM_CODEDOM_CODELABELEDSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B13E70)
