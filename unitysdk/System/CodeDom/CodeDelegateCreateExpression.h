...
#define SYSTEM_CODEDOM_CODEDELEGATECREATEEXPRESSION_GET_DELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x196753E0)
#define SYSTEM_CODEDOM_CODEDELEGATECREATEEXPRESSION_GET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x19675460)
#define SYSTEM_CODEDOM_CODEDELEGATECREATEEXPRESSION_GET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x196754E0)
#define SYSTEM_CODEDOM_CODEDELEGATECREATEEXPRESSION_SET_DELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x19675420)
#define SYSTEM_CODEDOM_CODEDELEGATECREATEEXPRESSION_SET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x196754A0)
#define SYSTEM_CODEDOM_CODEDELEGATECREATEEXPRESSION_SET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x19675520)
#define SYSTEM_CODEDOM_CODEDELEGATECREATEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x196753A0)
#define SYSTEM_CODEDOM_CODEDELEGATECREATEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19675360)
