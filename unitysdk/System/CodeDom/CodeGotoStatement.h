...
#define SYSTEM_CODEDOM_CODEGOTOSTATEMENT_GET_LABEL_OFFSET UNITYSDK_OFFSET(0x19FD3A50)
#define SYSTEM_CODEDOM_CODEGOTOSTATEMENT_SET_LABEL_OFFSET UNITYSDK_OFFSET(0x19FD3A90)
#define SYSTEM_CODEDOM_CODEGOTOSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FD3A10)
#define SYSTEM_CODEDOM_CODEGOTOSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD39D0)
