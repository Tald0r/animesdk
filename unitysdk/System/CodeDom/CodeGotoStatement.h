...
#define SYSTEM_CODEDOM_CODEGOTOSTATEMENT_GET_LABEL_OFFSET UNITYSDK_OFFSET(0x1A5ECA80)
#define SYSTEM_CODEDOM_CODEGOTOSTATEMENT_SET_LABEL_OFFSET UNITYSDK_OFFSET(0x1A5ECAC0)
#define SYSTEM_CODEDOM_CODEGOTOSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5ECA40)
#define SYSTEM_CODEDOM_CODEGOTOSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5ECA00)
