...
#define SYSTEM_CODEDOM_CODEMEMBERFIELD_GET_INITEXPRESSION_OFFSET UNITYSDK_OFFSET(0x19398990)
#define SYSTEM_CODEDOM_CODEMEMBERFIELD_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19398A10)
#define SYSTEM_CODEDOM_CODEMEMBERFIELD_SET_INITEXPRESSION_OFFSET UNITYSDK_OFFSET(0x193989D0)
#define SYSTEM_CODEDOM_CODEMEMBERFIELD_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x19398A50)
#define SYSTEM_CODEDOM_CODEMEMBERFIELD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193988D0)
#define SYSTEM_CODEDOM_CODEMEMBERFIELD__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19398910)
#define SYSTEM_CODEDOM_CODEMEMBERFIELD__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19398950)
#define SYSTEM_CODEDOM_CODEMEMBERFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x19398890)
