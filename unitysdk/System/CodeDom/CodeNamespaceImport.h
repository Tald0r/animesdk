...
#define SYSTEM_CODEDOM_CODENAMESPACEIMPORT_GET_LINEPRAGMA_OFFSET UNITYSDK_OFFSET(0x18B8A940)
#define SYSTEM_CODEDOM_CODENAMESPACEIMPORT_GET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x18B8A9C0)
#define SYSTEM_CODEDOM_CODENAMESPACEIMPORT_SET_LINEPRAGMA_OFFSET UNITYSDK_OFFSET(0x18B8A980)
#define SYSTEM_CODEDOM_CODENAMESPACEIMPORT_SET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x18B8AA00)
#define SYSTEM_CODEDOM_CODENAMESPACEIMPORT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B8A900)
#define SYSTEM_CODEDOM_CODENAMESPACEIMPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B8A8C0)
