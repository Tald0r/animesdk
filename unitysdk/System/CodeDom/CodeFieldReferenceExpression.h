...
#define SYSTEM_CODEDOM_CODEFIELDREFERENCEEXPRESSION_GET_FIELDNAME_OFFSET UNITYSDK_OFFSET(0x1822B920)
#define SYSTEM_CODEDOM_CODEFIELDREFERENCEEXPRESSION_GET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x1822B9A0)
#define SYSTEM_CODEDOM_CODEFIELDREFERENCEEXPRESSION_SET_FIELDNAME_OFFSET UNITYSDK_OFFSET(0x1822B960)
#define SYSTEM_CODEDOM_CODEFIELDREFERENCEEXPRESSION_SET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x1822B9E0)
#define SYSTEM_CODEDOM_CODEFIELDREFERENCEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1822B8E0)
#define SYSTEM_CODEDOM_CODEFIELDREFERENCEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1822B8A0)
