...
#define SYSTEM_CODEDOM_CODEEXPRESSIONSTATEMENT_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A5EC980)
#define SYSTEM_CODEDOM_CODEEXPRESSIONSTATEMENT_SET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A5EC9C0)
#define SYSTEM_CODEDOM_CODEEXPRESSIONSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5EC940)
#define SYSTEM_CODEDOM_CODEEXPRESSIONSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5EC900)
