...
#define SYSTEM_CODEDOM_CODEMETHODREFERENCEEXPRESSION_GET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x1904A770)
#define SYSTEM_CODEDOM_CODEMETHODREFERENCEEXPRESSION_GET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x1904A7F0)
#define SYSTEM_CODEDOM_CODEMETHODREFERENCEEXPRESSION_GET_TYPEARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1904A870)
#define SYSTEM_CODEDOM_CODEMETHODREFERENCEEXPRESSION_SET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x1904A7B0)
#define SYSTEM_CODEDOM_CODEMETHODREFERENCEEXPRESSION_SET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x1904A830)
#define SYSTEM_CODEDOM_CODEMETHODREFERENCEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1904A6F0)
#define SYSTEM_CODEDOM_CODEMETHODREFERENCEEXPRESSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1904A730)
#define SYSTEM_CODEDOM_CODEMETHODREFERENCEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1904A6B0)
