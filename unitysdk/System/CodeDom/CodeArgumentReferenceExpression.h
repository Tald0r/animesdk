...
#define SYSTEM_CODEDOM_CODEARGUMENTREFERENCEEXPRESSION_GET_PARAMETERNAME_OFFSET UNITYSDK_OFFSET(0x191C3360)
#define SYSTEM_CODEDOM_CODEARGUMENTREFERENCEEXPRESSION_SET_PARAMETERNAME_OFFSET UNITYSDK_OFFSET(0x191C33A0)
#define SYSTEM_CODEDOM_CODEARGUMENTREFERENCEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191C3320)
#define SYSTEM_CODEDOM_CODEARGUMENTREFERENCEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x191C32E0)
