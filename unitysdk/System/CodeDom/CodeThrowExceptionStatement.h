...
#define SYSTEM_CODEDOM_CODETHROWEXCEPTIONSTATEMENT_GET_TOTHROW_OFFSET UNITYSDK_OFFSET(0x191C3E60)
#define SYSTEM_CODEDOM_CODETHROWEXCEPTIONSTATEMENT_SET_TOTHROW_OFFSET UNITYSDK_OFFSET(0x191C3EA0)
#define SYSTEM_CODEDOM_CODETHROWEXCEPTIONSTATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191C3E20)
#define SYSTEM_CODEDOM_CODETHROWEXCEPTIONSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x191C3DE0)
