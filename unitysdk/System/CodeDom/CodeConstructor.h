...
#define SYSTEM_CODEDOM_CODECONSTRUCTOR_GET_BASECONSTRUCTORARGS_OFFSET UNITYSDK_OFFSET(0x196752E0)
#define SYSTEM_CODEDOM_CODECONSTRUCTOR_GET_CHAINEDCONSTRUCTORARGS_OFFSET UNITYSDK_OFFSET(0x19675320)
#define SYSTEM_CODEDOM_CODECONSTRUCTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x196752A0)
