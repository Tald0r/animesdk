...
#define SYSTEM_CODEDOM_CODECONSTRUCTOR_GET_BASECONSTRUCTORARGS_OFFSET UNITYSDK_OFFSET(0x19B13BF0)
#define SYSTEM_CODEDOM_CODECONSTRUCTOR_GET_CHAINEDCONSTRUCTORARGS_OFFSET UNITYSDK_OFFSET(0x19B13C30)
#define SYSTEM_CODEDOM_CODECONSTRUCTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19B13BB0)
