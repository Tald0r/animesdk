...
#define SYSTEM_CODEDOM_CODEBINARYOPERATOREXPRESSION_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x19236650)
#define SYSTEM_CODEDOM_CODEBINARYOPERATOREXPRESSION_GET_OPERATOR_OFFSET UNITYSDK_OFFSET(0x192366D0)
#define SYSTEM_CODEDOM_CODEBINARYOPERATOREXPRESSION_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x19236750)
#define SYSTEM_CODEDOM_CODEBINARYOPERATOREXPRESSION_SET_LEFT_OFFSET UNITYSDK_OFFSET(0x19236690)
#define SYSTEM_CODEDOM_CODEBINARYOPERATOREXPRESSION_SET_OPERATOR_OFFSET UNITYSDK_OFFSET(0x19236710)
#define SYSTEM_CODEDOM_CODEBINARYOPERATOREXPRESSION_SET_RIGHT_OFFSET UNITYSDK_OFFSET(0x19236790)
#define SYSTEM_CODEDOM_CODEBINARYOPERATOREXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19236610)
#define SYSTEM_CODEDOM_CODEBINARYOPERATOREXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x192365D0)
