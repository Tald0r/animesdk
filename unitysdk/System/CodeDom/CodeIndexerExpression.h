...
#define SYSTEM_CODEDOM_CODEINDEXEREXPRESSION_GET_INDICES_OFFSET UNITYSDK_OFFSET(0x1904A1F0)
#define SYSTEM_CODEDOM_CODEINDEXEREXPRESSION_GET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x1904A230)
#define SYSTEM_CODEDOM_CODEINDEXEREXPRESSION_SET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x1904A270)
#define SYSTEM_CODEDOM_CODEINDEXEREXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1904A1B0)
#define SYSTEM_CODEDOM_CODEINDEXEREXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1904A170)
