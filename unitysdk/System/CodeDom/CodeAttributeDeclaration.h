...
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x18F46FE0)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION_GET_ATTRIBUTETYPE_OFFSET UNITYSDK_OFFSET(0x18F47020)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18F47060)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x18F470A0)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F46EE0)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18F46F20)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18F46F60)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18F46FA0)
#define SYSTEM_CODEDOM_CODEATTRIBUTEDECLARATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18F46EA0)
