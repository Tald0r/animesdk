...
#define SYSTEM_CODEDOM_CODESTATEMENT_GET_ENDDIRECTIVES_OFFSET UNITYSDK_OFFSET(0x19FD3C90)
#define SYSTEM_CODEDOM_CODESTATEMENT_GET_LINEPRAGMA_OFFSET UNITYSDK_OFFSET(0x19FD3CD0)
#define SYSTEM_CODEDOM_CODESTATEMENT_GET_STARTDIRECTIVES_OFFSET UNITYSDK_OFFSET(0x19FD3D50)
#define SYSTEM_CODEDOM_CODESTATEMENT_SET_LINEPRAGMA_OFFSET UNITYSDK_OFFSET(0x19FD3D10)
#define SYSTEM_CODEDOM_CODESTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD3C50)
