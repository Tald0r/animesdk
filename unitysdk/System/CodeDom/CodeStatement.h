...
#define SYSTEM_CODEDOM_CODESTATEMENT_GET_ENDDIRECTIVES_OFFSET UNITYSDK_OFFSET(0x1A5ECCC0)
#define SYSTEM_CODEDOM_CODESTATEMENT_GET_LINEPRAGMA_OFFSET UNITYSDK_OFFSET(0x1A5ECD00)
#define SYSTEM_CODEDOM_CODESTATEMENT_GET_STARTDIRECTIVES_OFFSET UNITYSDK_OFFSET(0x1A5ECD80)
#define SYSTEM_CODEDOM_CODESTATEMENT_SET_LINEPRAGMA_OFFSET UNITYSDK_OFFSET(0x1A5ECD40)
#define SYSTEM_CODEDOM_CODESTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5ECC80)
