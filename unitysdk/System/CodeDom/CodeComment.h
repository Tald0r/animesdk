...
#define SYSTEM_CODEDOM_CODECOMMENT_GET_DOCCOMMENT_OFFSET UNITYSDK_OFFSET(0x1A330450)
#define SYSTEM_CODEDOM_CODECOMMENT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1A3304D0)
#define SYSTEM_CODEDOM_CODECOMMENT_SET_DOCCOMMENT_OFFSET UNITYSDK_OFFSET(0x1A330490)
#define SYSTEM_CODEDOM_CODECOMMENT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1A330510)
#define SYSTEM_CODEDOM_CODECOMMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3303D0)
#define SYSTEM_CODEDOM_CODECOMMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A330410)
#define SYSTEM_CODEDOM_CODECOMMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A330390)
