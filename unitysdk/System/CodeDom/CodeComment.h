...
#define SYSTEM_CODEDOM_CODECOMMENT_GET_DOCCOMMENT_OFFSET UNITYSDK_OFFSET(0x19D71F90)
#define SYSTEM_CODEDOM_CODECOMMENT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x19D72010)
#define SYSTEM_CODEDOM_CODECOMMENT_SET_DOCCOMMENT_OFFSET UNITYSDK_OFFSET(0x19D71FD0)
#define SYSTEM_CODEDOM_CODECOMMENT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x19D72050)
#define SYSTEM_CODEDOM_CODECOMMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D71F10)
#define SYSTEM_CODEDOM_CODECOMMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19D71F50)
#define SYSTEM_CODEDOM_CODECOMMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19D71ED0)
