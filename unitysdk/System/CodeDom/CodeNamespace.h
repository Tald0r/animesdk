...
#define SYSTEM_CODEDOM_CODENAMESPACE_ADD_POPULATECOMMENTS_OFFSET UNITYSDK_OFFSET(0x196759E0)
#define SYSTEM_CODEDOM_CODENAMESPACE_ADD_POPULATEIMPORTS_OFFSET UNITYSDK_OFFSET(0x19675A60)
#define SYSTEM_CODEDOM_CODENAMESPACE_ADD_POPULATETYPES_OFFSET UNITYSDK_OFFSET(0x19675AE0)
#define SYSTEM_CODEDOM_CODENAMESPACE_GET_COMMENTS_OFFSET UNITYSDK_OFFSET(0x196758A0)
#define SYSTEM_CODEDOM_CODENAMESPACE_GET_IMPORTS_OFFSET UNITYSDK_OFFSET(0x196758E0)
#define SYSTEM_CODEDOM_CODENAMESPACE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19675920)
#define SYSTEM_CODEDOM_CODENAMESPACE_GET_TYPES_OFFSET UNITYSDK_OFFSET(0x196759A0)
#define SYSTEM_CODEDOM_CODENAMESPACE_REMOVE_POPULATECOMMENTS_OFFSET UNITYSDK_OFFSET(0x19675A20)
#define SYSTEM_CODEDOM_CODENAMESPACE_REMOVE_POPULATEIMPORTS_OFFSET UNITYSDK_OFFSET(0x19675AA0)
#define SYSTEM_CODEDOM_CODENAMESPACE_REMOVE_POPULATETYPES_OFFSET UNITYSDK_OFFSET(0x19675B20)
#define SYSTEM_CODEDOM_CODENAMESPACE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19675960)
#define SYSTEM_CODEDOM_CODENAMESPACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19675860)
#define SYSTEM_CODEDOM_CODENAMESPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19675820)
