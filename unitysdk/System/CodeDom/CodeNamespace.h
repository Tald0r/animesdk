...
#define SYSTEM_CODEDOM_CODENAMESPACE_ADD_POPULATECOMMENTS_OFFSET UNITYSDK_OFFSET(0x19B142F0)
#define SYSTEM_CODEDOM_CODENAMESPACE_ADD_POPULATEIMPORTS_OFFSET UNITYSDK_OFFSET(0x19B14370)
#define SYSTEM_CODEDOM_CODENAMESPACE_ADD_POPULATETYPES_OFFSET UNITYSDK_OFFSET(0x19B143F0)
#define SYSTEM_CODEDOM_CODENAMESPACE_GET_COMMENTS_OFFSET UNITYSDK_OFFSET(0x19B141B0)
#define SYSTEM_CODEDOM_CODENAMESPACE_GET_IMPORTS_OFFSET UNITYSDK_OFFSET(0x19B141F0)
#define SYSTEM_CODEDOM_CODENAMESPACE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19B14230)
#define SYSTEM_CODEDOM_CODENAMESPACE_GET_TYPES_OFFSET UNITYSDK_OFFSET(0x19B142B0)
#define SYSTEM_CODEDOM_CODENAMESPACE_REMOVE_POPULATECOMMENTS_OFFSET UNITYSDK_OFFSET(0x19B14330)
#define SYSTEM_CODEDOM_CODENAMESPACE_REMOVE_POPULATEIMPORTS_OFFSET UNITYSDK_OFFSET(0x19B143B0)
#define SYSTEM_CODEDOM_CODENAMESPACE_REMOVE_POPULATETYPES_OFFSET UNITYSDK_OFFSET(0x19B14430)
#define SYSTEM_CODEDOM_CODENAMESPACE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19B14270)
#define SYSTEM_CODEDOM_CODENAMESPACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B14170)
#define SYSTEM_CODEDOM_CODENAMESPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B14130)
