...
#define SYSTEM_CODEDOM_CODEPROPERTYREFERENCEEXPRESSION_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x18F475A0)
#define SYSTEM_CODEDOM_CODEPROPERTYREFERENCEEXPRESSION_GET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x18F47620)
#define SYSTEM_CODEDOM_CODEPROPERTYREFERENCEEXPRESSION_SET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x18F475E0)
#define SYSTEM_CODEDOM_CODEPROPERTYREFERENCEEXPRESSION_SET_TARGETOBJECT_OFFSET UNITYSDK_OFFSET(0x18F47660)
#define SYSTEM_CODEDOM_CODEPROPERTYREFERENCEEXPRESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F47560)
#define SYSTEM_CODEDOM_CODEPROPERTYREFERENCEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18F47520)
