...
#define SYSTEM_URIBUILDER_EQUALS_OFFSET UNITYSDK_OFFSET(0x19471870)
#define SYSTEM_URIBUILDER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19471950)
#define SYSTEM_URIBUILDER_GET_FRAGMENT_OFFSET UNITYSDK_OFFSET(0x194712C0)
#define SYSTEM_URIBUILDER_GET_HOST_OFFSET UNITYSDK_OFFSET(0x194712D0)
#define SYSTEM_URIBUILDER_GET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x194712E0)
#define SYSTEM_URIBUILDER_GET_PATH_OFFSET UNITYSDK_OFFSET(0x19471320)
#define SYSTEM_URIBUILDER_GET_PORT_OFFSET UNITYSDK_OFFSET(0x19471330)
#define SYSTEM_URIBUILDER_GET_QUERY_OFFSET UNITYSDK_OFFSET(0x19471340)
#define SYSTEM_URIBUILDER_GET_SCHEME_OFFSET UNITYSDK_OFFSET(0x19471350)
#define SYSTEM_URIBUILDER_GET_URI_OFFSET UNITYSDK_OFFSET(0x19471360)
#define SYSTEM_URIBUILDER_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x19471830)
#define SYSTEM_URIBUILDER_INIT_OFFSET UNITYSDK_OFFSET(0x19470380)
#define SYSTEM_URIBUILDER_SETFIELDSFROMURI_OFFSET UNITYSDK_OFFSET(0x19470630)
#define SYSTEM_URIBUILDER_SET_EXTRA_OFFSET UNITYSDK_OFFSET(0x19471000)
#define SYSTEM_URIBUILDER_SET_FRAGMENT_OFFSET UNITYSDK_OFFSET(0x19471220)
#define SYSTEM_URIBUILDER_SET_HOST_OFFSET UNITYSDK_OFFSET(0x19470AB0)
#define SYSTEM_URIBUILDER_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x194712F0)
#define SYSTEM_URIBUILDER_SET_PATH_OFFSET UNITYSDK_OFFSET(0x19470DE0)
#define SYSTEM_URIBUILDER_SET_PORT_OFFSET UNITYSDK_OFFSET(0x19470BE0)
#define SYSTEM_URIBUILDER_SET_QUERY_OFFSET UNITYSDK_OFFSET(0x19471270)
#define SYSTEM_URIBUILDER_SET_SCHEME_OFFSET UNITYSDK_OFFSET(0x19470920)
#define SYSTEM_URIBUILDER_SET_USERNAME_OFFSET UNITYSDK_OFFSET(0x19471840)
#define SYSTEM_URIBUILDER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x194713F0)
#define SYSTEM_URIBUILDER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x194701B0)
#define SYSTEM_URIBUILDER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19470540)
#define SYSTEM_URIBUILDER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x194707E0)
#define SYSTEM_URIBUILDER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19470B60)
#define SYSTEM_URIBUILDER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19470C60)
#define SYSTEM_URIBUILDER__CTOR_6_OFFSET UNITYSDK_OFFSET(0x19470ED0)
#define SYSTEM_URIBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19470120)
