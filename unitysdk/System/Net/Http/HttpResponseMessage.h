...
#define SYSTEM_NET_HTTP_HTTPRESPONSEMESSAGE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19DFEAF0)
#define SYSTEM_NET_HTTP_HTTPRESPONSEMESSAGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19DFEAD0)
#define SYSTEM_NET_HTTP_HTTPRESPONSEMESSAGE_ENSURESUCCESSSTATUSCODE_OFFSET UNITYSDK_OFFSET(0x19DFEB20)
#define SYSTEM_NET_HTTP_HTTPRESPONSEMESSAGE_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x19DFEA50)
#define SYSTEM_NET_HTTP_HTTPRESPONSEMESSAGE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x19DF9710)
#define SYSTEM_NET_HTTP_HTTPRESPONSEMESSAGE_GET_ISSUCCESSSTATUSCODE_OFFSET UNITYSDK_OFFSET(0x19DFEA60)
#define SYSTEM_NET_HTTP_HTTPRESPONSEMESSAGE_GET_REASONPHRASE_OFFSET UNITYSDK_OFFSET(0x19DFEA70)
#define SYSTEM_NET_HTTP_HTTPRESPONSEMESSAGE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x19DFEA90)
#define SYSTEM_NET_HTTP_HTTPRESPONSEMESSAGE_SET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x19DFE9F0)
#define SYSTEM_NET_HTTP_HTTPRESPONSEMESSAGE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19DFEBD0)
#define SYSTEM_NET_HTTP_HTTPRESPONSEMESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19DF95B0)
#define SYSTEM_NET_HTTP_HTTPRESPONSEMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DFE9B0)

namespace System::Net::Http
{
	inline static constexpr unsigned int HttpResponseMessage_TypeDefinitionIndex = 23526;
