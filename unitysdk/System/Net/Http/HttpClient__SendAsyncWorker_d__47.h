...
#define SYSTEM_NET_HTTP_HTTPCLIENT__SENDASYNCWORKER_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8FAA70)
#define SYSTEM_NET_HTTP_HTTPCLIENT__SENDASYNCWORKER_D__47_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x35B990)

namespace System::Net::Http
{
	inline static constexpr unsigned int HttpClient__SendAsyncWorker_d__47_TypeDefinitionIndex = 23511;
	...
	struct alignas(8) HttpClient__SendAsyncWorker_d__47
	{
		...
		::System::Net::Http::HttpResponseMessage* _response_5__1; // 0x20
		::System::Threading::CancellationToken cancellationToken; // 0x28
		::System::Net::Http::HttpClient* __4__this; // 0x30
		::System::Threading::CancellationTokenSource* _lcts_5__2; // 0x38
		::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::System::Net::Http::HttpResponseMessage*> __t__builder; // 0x40
		::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Net::Http::HttpResponseMessage*> __u__1; // 0x58
