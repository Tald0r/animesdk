...
#define SYSTEM_NET_HTTP_HTTPCLIENTHANDLER__SENDASYNC_D__64_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8FAA80)
#define SYSTEM_NET_HTTP_HTTPCLIENTHANDLER__SENDASYNC_D__64_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x8434F0)

namespace System::Net::Http
{
	inline static constexpr unsigned int HttpClientHandler__SendAsync_d__64_TypeDefinitionIndex = 23514;

	struct alignas(8) HttpClientHandler__SendAsync_d__64
	{
		::System::IO::Stream* _stream_5__3; // 0x10
		...
		::System::Net::HttpWebResponse* _wresponse_5__4; // 0x48
		::System::Net::Http::HttpClientHandler* __4__this; // 0x50
		...
		::System::Net::HttpWebRequest* _wrequest_5__1; // 0x78
		::System::Threading::CancellationTokenRegistration __7__wrap1; // 0x80
		::System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1_ConfiguredTaskAwaiter<::System::Net::WebResponse*> __u__3; // 0x98
