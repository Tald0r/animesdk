...
#define SYSTEM_NET_HTTP_HEADERS_TRANSFERCODINGHEADERVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3D65F0)
#define SYSTEM_NET_HTTP_HEADERS_TRANSFERCODINGHEADERVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3D6700)
#define SYSTEM_NET_HTTP_HEADERS_TRANSFERCODINGHEADERVALUE_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A3D6500)
#define SYSTEM_NET_HTTP_HEADERS_TRANSFERCODINGHEADERVALUE_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3D65A0)
#define SYSTEM_NET_HTTP_HEADERS_TRANSFERCODINGHEADERVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3D6860)
#define SYSTEM_NET_HTTP_HEADERS_TRANSFERCODINGHEADERVALUE_TRYPARSEELEMENT_OFFSET UNITYSDK_OFFSET(0x1A3D6930)
#define SYSTEM_NET_HTTP_HEADERS_TRANSFERCODINGHEADERVALUE_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x1A3D68B0)
#define SYSTEM_NET_HTTP_HEADERS_TRANSFERCODINGHEADERVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3D6590)
#define SYSTEM_NET_HTTP_HEADERS_TRANSFERCODINGHEADERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3D62B0)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int TransferCodingHeaderValue_TypeDefinitionIndex = 24262;
