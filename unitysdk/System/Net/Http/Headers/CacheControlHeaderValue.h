...
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x19DE59B0)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19DE5BD0)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_GET_EXTENSIONS_OFFSET UNITYSDK_OFFSET(0x19DE53B0)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_GET_NOCACHEHEADERS_OFFSET UNITYSDK_OFFSET(0x19DE5440)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_GET_PRIVATEHEADERS_OFFSET UNITYSDK_OFFSET(0x19DE54B0)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x19DE5520)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19DE6BD0)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x19DE5DC0)
#define SYSTEM_NET_HTTP_HEADERS_CACHECONTROLHEADERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE6A90)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int CacheControlHeaderValue_TypeDefinitionIndex = 23530;
	...
	public:
		...
		::System::Boolean _OnlyIfCached_k__BackingField; // 0x49
		::System::Boolean _NoStore_k__BackingField; // 0x4A
		::System::Boolean _Public_k__BackingField; // 0x4B
		::System::Boolean _NoCache_k__BackingField; // 0x4C
		::System::Nullable_1<::System::TimeSpan> _SharedMaxAge_k__BackingField; // 0x50
		::System::Boolean _MaxStale_k__BackingField; // 0x60
		::System::Boolean _ProxyRevalidate_k__BackingField; // 0x61
		::System::Boolean _MustRevalidate_k__BackingField; // 0x62
		::System::Boolean _Private_k__BackingField; // 0x63
