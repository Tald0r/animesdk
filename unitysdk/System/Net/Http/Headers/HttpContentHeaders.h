...
#define SYSTEM_NET_HTTP_HEADERS_HTTPCONTENTHEADERS_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1A3CABC0)
#define SYSTEM_NET_HTTP_HEADERS_HTTPCONTENTHEADERS_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A3CAD20)
#define SYSTEM_NET_HTTP_HEADERS_HTTPCONTENTHEADERS_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A3CAD60)
#define SYSTEM_NET_HTTP_HEADERS_HTTPCONTENTHEADERS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3CADC0)
#define SYSTEM_NET_HTTP_HEADERS_HTTPCONTENTHEADERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3CA990)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int HttpContentHeaders_TypeDefinitionIndex = 24226;
