...
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A3D3BB0)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A3D3D20)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1A3D3B10)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3D40C0)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x1A3D3E30)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3D3AA0)
#define SYSTEM_NET_HTTP_HEADERS_RANGECONDITIONHEADERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3D3A80)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int RangeConditionHeaderValue_TypeDefinitionIndex = 24257;
