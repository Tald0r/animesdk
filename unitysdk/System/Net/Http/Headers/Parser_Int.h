...
#define SYSTEM_NET_HTTP_HEADERS_PARSER_INT_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x19DF1350)

namespace System::Net::Http::Headers
{
	inline static constexpr unsigned int Parser_Int_TypeDefinitionIndex = 23566;
