...
#define SYSTEM_NET_CONNECTIONPOOL_ABORT_OFFSET UNITYSDK_OFFSET(0x18E3D110)
#define SYSTEM_NET_CONNECTIONPOOL_ASYNCTHREAD_OFFSET UNITYSDK_OFFSET(0x18E3B690)
#define SYSTEM_NET_CONNECTIONPOOL_CANCELERRORCALLBACKWRAPPER_OFFSET UNITYSDK_OFFSET(0x18E3D340)
#define SYSTEM_NET_CONNECTIONPOOL_CANCELERRORCALLBACK_OFFSET UNITYSDK_OFFSET(0x18E3D3B0)
#define SYSTEM_NET_CONNECTIONPOOL_CLEANUPCALLBACKWRAPPER_OFFSET UNITYSDK_OFFSET(0x18E3C690)
#define SYSTEM_NET_CONNECTIONPOOL_CLEANUPCALLBACK_OFFSET UNITYSDK_OFFSET(0x18E3C7D0)
#define SYSTEM_NET_CONNECTIONPOOL_CREATE_OFFSET UNITYSDK_OFFSET(0x18E3CE90)
#define SYSTEM_NET_CONNECTIONPOOL_DESTROY_OFFSET UNITYSDK_OFFSET(0x18E3CD20)
#define SYSTEM_NET_CONNECTIONPOOL_FORCECLEANUP_OFFSET UNITYSDK_OFFSET(0x18E3CBC0)
#define SYSTEM_NET_CONNECTIONPOOL_GETCONNECTION_OFFSET UNITYSDK_OFFSET(0x18E3D8E0)
#define SYSTEM_NET_CONNECTIONPOOL_GETFROMPOOL_OFFSET UNITYSDK_OFFSET(0x18E3D470)
#define SYSTEM_NET_CONNECTIONPOOL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x18E3C640)
#define SYSTEM_NET_CONNECTIONPOOL_GET_CREATIONMUTEX_OFFSET UNITYSDK_OFFSET(0x18E3AF40)
#define SYSTEM_NET_CONNECTIONPOOL_GET_ERROREVENT_OFFSET UNITYSDK_OFFSET(0x18E3AFC0)
#define SYSTEM_NET_CONNECTIONPOOL_GET_ERROROCCURRED_OFFSET UNITYSDK_OFFSET(0x18E3C680)
#define SYSTEM_NET_CONNECTIONPOOL_GET_MAXPOOLSIZE_OFFSET UNITYSDK_OFFSET(0x18E3C660)
#define SYSTEM_NET_CONNECTIONPOOL_GET_MINPOOLSIZE_OFFSET UNITYSDK_OFFSET(0x18E3C670)
#define SYSTEM_NET_CONNECTIONPOOL_GET_OFFSET UNITYSDK_OFFSET(0x18E3BB00)
#define SYSTEM_NET_CONNECTIONPOOL_GET_SEMAPHORE_OFFSET UNITYSDK_OFFSET(0x18E3B010)
#define SYSTEM_NET_CONNECTIONPOOL_GET_SERVICEPOINT_OFFSET UNITYSDK_OFFSET(0x18E3C650)
#define SYSTEM_NET_CONNECTIONPOOL_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x18E3B190)
#define SYSTEM_NET_CONNECTIONPOOL_PUTCONNECTION_1_OFFSET UNITYSDK_OFFSET(0x18E3C120)
#define SYSTEM_NET_CONNECTIONPOOL_PUTCONNECTION_OFFSET UNITYSDK_OFFSET(0x18E3DB00)
#define SYSTEM_NET_CONNECTIONPOOL_PUTNEW_OFFSET UNITYSDK_OFFSET(0x18E3DB20)
#define SYSTEM_NET_CONNECTIONPOOL_QUEUEREQUEST_OFFSET UNITYSDK_OFFSET(0x18E3B520)
#define SYSTEM_NET_CONNECTIONPOOL_RECLAIMEMANCIPATEDOBJECTS_OFFSET UNITYSDK_OFFSET(0x18E3D570)
#define SYSTEM_NET_CONNECTIONPOOL_USERCREATEREQUEST_OFFSET UNITYSDK_OFFSET(0x18E3D520)
#define SYSTEM_NET_CONNECTIONPOOL__CCTOR_OFFSET UNITYSDK_OFFSET(0x18E3DC20)
#define SYSTEM_NET_CONNECTIONPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3B090)
...
namespace System::Net
{
	...
	public:
		...
		::System::Net::InterlockedStack* m_StackOld; // 0x10
		::System::Net::InterlockedStack* m_StackNew; // 0x18
		::System::Collections::ArrayList* m_ObjectList; // 0x20
		::System::Threading::Thread* m_AsyncThread; // 0x28
		::System::Net::TimerThread_Timer* m_ErrorTimer; // 0x30
		::System::Exception* m_ResError; // 0x38
		::System::Net::ServicePoint* m_ServicePoint; // 0x40
		::Il2CppArray<::System::Threading::WaitHandle*>* m_WaitHandles; // 0x48
		::System::Net::TimerThread_Queue* m_CleanupQueue; // 0x50
		::System::Collections::Queue* m_QueuedRequests; // 0x58
		::System::Net::CreateConnectionDelegate* m_CreateConnectionCallback; // 0x60
		::System::Int32 m_TotalObjects; // 0x68
		::System::Net::ConnectionPool_State m_State; // 0x6C
		::System::Boolean m_ErrorOccured; // 0x70
		::System::Int32 m_MinPoolSize; // 0x74
		::System::Int32 m_WaitCount; // 0x78
		::System::Int32 m_MaxPoolSize; // 0x7C
