...
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x197FA580)
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x197FA5C0)
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x197FA000)
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x197F9FF0)
