...
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D39960)
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D399A0)
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D393E0)
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D393C0)
