...
#define SYSTEM_NET_WEBCLIENT_UPLOADBITSSTATE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1938E800)
#define SYSTEM_NET_WEBCLIENT_UPLOADBITSSTATE_GET_ASYNC_OFFSET UNITYSDK_OFFSET(0x1938E4B0)
#define SYSTEM_NET_WEBCLIENT_UPLOADBITSSTATE_GET_FILEUPLOAD_OFFSET UNITYSDK_OFFSET(0x1938E4A0)
#define SYSTEM_NET_WEBCLIENT_UPLOADBITSSTATE_SETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x1938E4C0)
#define SYSTEM_NET_WEBCLIENT_UPLOADBITSSTATE_WRITEBYTES_OFFSET UNITYSDK_OFFSET(0x1938E610)
#define SYSTEM_NET_WEBCLIENT_UPLOADBITSSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1938E3D0)
...
namespace System::Net
{
	...
	{
	public:
		::System::Net::WebClient* WebClient; // 0x10
		::Il2CppArray<::System::Byte>* Footer; // 0x18
		::Il2CppArray<::System::Byte>* Header; // 0x20
		::System::Net::WebRequest* Request; // 0x28
		::Il2CppArray<::System::Byte>* InnerBuffer; // 0x30
		::System::IO::Stream* ReadStream; // 0x38
		::System::ComponentModel::AsyncOperation* AsyncOp; // 0x40
		::System::Net::CompletionDelegate* DownloadCompletionDelegate; // 0x48
		::System::Net::WebClient_ProgressData* Progress; // 0x50
		::System::IO::Stream* WriteStream; // 0x58
		::System::Net::CompletionDelegate* UploadCompletionDelegate; // 0x60
