...
#define SYSTEM_NET_VALIDATIONHELPER_EXCEPTIONMESSAGE_OFFSET UNITYSDK_OFFSET(0x19247940)
#define SYSTEM_NET_VALIDATIONHELPER_HASHSTRING_OFFSET UNITYSDK_OFFSET(0x19247B10)
#define SYSTEM_NET_VALIDATIONHELPER_ISBLANKSTRING_OFFSET UNITYSDK_OFFSET(0x19247C00)
#define SYSTEM_NET_VALIDATIONHELPER_ISINVALIDHTTPSTRING_OFFSET UNITYSDK_OFFSET(0x19247BA0)
#define SYSTEM_NET_VALIDATIONHELPER_MAKEEMPTYARRAYNULL_OFFSET UNITYSDK_OFFSET(0x19247910)
#define SYSTEM_NET_VALIDATIONHELPER_MAKESTRINGNULL_OFFSET UNITYSDK_OFFSET(0x19247930)
#define SYSTEM_NET_VALIDATIONHELPER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x192479C0)
#define SYSTEM_NET_VALIDATIONHELPER_VALIDATERANGE_OFFSET UNITYSDK_OFFSET(0x19247C20)
#define SYSTEM_NET_VALIDATIONHELPER_VALIDATESEGMENT_OFFSET UNITYSDK_OFFSET(0x19247C30)
#define SYSTEM_NET_VALIDATIONHELPER_VALIDATETCPPORT_OFFSET UNITYSDK_OFFSET(0x19247C10)
#define SYSTEM_NET_VALIDATIONHELPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19247CE0)
