...
#define SYSTEM_NET_HTTPLISTENEREXCEPTION_GET_ERRORCODE_OFFSET UNITYSDK_OFFSET(0x190691D0)
#define SYSTEM_NET_HTTPLISTENEREXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19068FC0)
#define SYSTEM_NET_HTTPLISTENEREXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19069070)
#define SYSTEM_NET_HTTPLISTENEREXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19069110)
#define SYSTEM_NET_HTTPLISTENEREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19068ED0)
