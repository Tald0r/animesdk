...
#define SYSTEM_NET_WEBPROXYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18D8A190)
...
namespace System::Net
{
	...
	public:
		...
		::System::Collections::Hashtable* proxyHostAddresses; // 0x20
		::System::Uri* proxyAddress; // 0x28
