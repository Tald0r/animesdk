...
#define SYSTEM_NET_OPENREADCOMPLETEDEVENTARGS_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x19386720)
#define SYSTEM_NET_OPENREADCOMPLETEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19386740)
#define SYSTEM_NET_OPENREADCOMPLETEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x193866D0)
