...
#define SYSTEM_NET_OPENREADCOMPLETEDEVENTARGS_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x18FF5210)
#define SYSTEM_NET_OPENREADCOMPLETEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FF5230)
#define SYSTEM_NET_OPENREADCOMPLETEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF51C0)
