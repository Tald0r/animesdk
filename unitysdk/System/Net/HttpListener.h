...
#define SYSTEM_NET_HTTPLISTENER_ABORT_OFFSET UNITYSDK_OFFSET(0x19425B00)
#define SYSTEM_NET_HTTPLISTENER_ADDCONNECTION_OFFSET UNITYSDK_OFFSET(0x19427980)
#define SYSTEM_NET_HTTPLISTENER_BEGINGETCONTEXT_OFFSET UNITYSDK_OFFSET(0x19426880)
#define SYSTEM_NET_HTTPLISTENER_CHECKDISPOSED_OFFSET UNITYSDK_OFFSET(0x194256D0)
#define SYSTEM_NET_HTTPLISTENER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x19425C60)
#define SYSTEM_NET_HTTPLISTENER_CLOSE_1_OFFSET UNITYSDK_OFFSET(0x19425B80)
#define SYSTEM_NET_HTTPLISTENER_CLOSE_OFFSET UNITYSDK_OFFSET(0x19425BE0)
#define SYSTEM_NET_HTTPLISTENER_CREATESSLSTREAM_OFFSET UNITYSDK_OFFSET(0x19425360)
#define SYSTEM_NET_HTTPLISTENER_ENDGETCONTEXT_OFFSET UNITYSDK_OFFSET(0x19426CB0)
#define SYSTEM_NET_HTTPLISTENER_GETCONTEXTASYNC_OFFSET UNITYSDK_OFFSET(0x19427250)
#define SYSTEM_NET_HTTPLISTENER_GETCONTEXTFROMQUEUE_OFFSET UNITYSDK_OFFSET(0x19426BF0)
#define SYSTEM_NET_HTTPLISTENER_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x19427000)
#define SYSTEM_NET_HTTPLISTENER_GET_AUTHENTICATIONSCHEMESELECTORDELEGATE_OFFSET UNITYSDK_OFFSET(0x19425760)
#define SYSTEM_NET_HTTPLISTENER_GET_AUTHENTICATIONSCHEMES_OFFSET UNITYSDK_OFFSET(0x194256A0)
#define SYSTEM_NET_HTTPLISTENER_GET_DEFAULTSERVICENAMES_OFFSET UNITYSDK_OFFSET(0x194259C0)
#define SYSTEM_NET_HTTPLISTENER_GET_EXTENDEDPROTECTIONPOLICY_OFFSET UNITYSDK_OFFSET(0x19425910)
#define SYSTEM_NET_HTTPLISTENER_GET_EXTENDEDPROTECTIONSELECTORDELEGATE_OFFSET UNITYSDK_OFFSET(0x19425790)
#define SYSTEM_NET_HTTPLISTENER_GET_IGNOREWRITEEXCEPTIONS_OFFSET UNITYSDK_OFFSET(0x19425850)
#define SYSTEM_NET_HTTPLISTENER_GET_ISLISTENING_OFFSET UNITYSDK_OFFSET(0x19425880)
#define SYSTEM_NET_HTTPLISTENER_GET_ISSUPPORTED_OFFSET UNITYSDK_OFFSET(0x19425890)
#define SYSTEM_NET_HTTPLISTENER_GET_PREFIXES_OFFSET UNITYSDK_OFFSET(0x194258A0)
#define SYSTEM_NET_HTTPLISTENER_GET_REALM_OFFSET UNITYSDK_OFFSET(0x19425AA0)
#define SYSTEM_NET_HTTPLISTENER_GET_TIMEOUTMANAGER_OFFSET UNITYSDK_OFFSET(0x194258C0)
#define SYSTEM_NET_HTTPLISTENER_GET_UNSAFECONNECTIONNTLMAUTHENTICATION_OFFSET UNITYSDK_OFFSET(0x19425AD0)
#define SYSTEM_NET_HTTPLISTENER_LOADCERTIFICATEANDKEY_OFFSET UNITYSDK_OFFSET(0x19424F90)
#define SYSTEM_NET_HTTPLISTENER_REGISTERCONTEXT_OFFSET UNITYSDK_OFFSET(0x19427360)
#define SYSTEM_NET_HTTPLISTENER_REMOVECONNECTION_OFFSET UNITYSDK_OFFSET(0x194279B0)
#define SYSTEM_NET_HTTPLISTENER_SELECTAUTHENTICATIONSCHEME_OFFSET UNITYSDK_OFFSET(0x19426FC0)
#define SYSTEM_NET_HTTPLISTENER_SET_AUTHENTICATIONSCHEMESELECTORDELEGATE_OFFSET UNITYSDK_OFFSET(0x19425770)
#define SYSTEM_NET_HTTPLISTENER_SET_AUTHENTICATIONSCHEMES_OFFSET UNITYSDK_OFFSET(0x194256B0)
#define SYSTEM_NET_HTTPLISTENER_SET_EXTENDEDPROTECTIONPOLICY_OFFSET UNITYSDK_OFFSET(0x19425920)
#define SYSTEM_NET_HTTPLISTENER_SET_EXTENDEDPROTECTIONSELECTORDELEGATE_OFFSET UNITYSDK_OFFSET(0x194257A0)
#define SYSTEM_NET_HTTPLISTENER_SET_IGNOREWRITEEXCEPTIONS_OFFSET UNITYSDK_OFFSET(0x19425860)
#define SYSTEM_NET_HTTPLISTENER_SET_REALM_OFFSET UNITYSDK_OFFSET(0x19425AB0)
#define SYSTEM_NET_HTTPLISTENER_SET_UNSAFECONNECTIONNTLMAUTHENTICATION_OFFSET UNITYSDK_OFFSET(0x19425AE0)
#define SYSTEM_NET_HTTPLISTENER_START_OFFSET UNITYSDK_OFFSET(0x194270E0)
#define SYSTEM_NET_HTTPLISTENER_STOP_OFFSET UNITYSDK_OFFSET(0x19427160)
#define SYSTEM_NET_HTTPLISTENER_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x194271D0)
#define SYSTEM_NET_HTTPLISTENER_UNREGISTERCONTEXT_OFFSET UNITYSDK_OFFSET(0x194277A0)
#define SYSTEM_NET_HTTPLISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19424D30)
#define SYSTEM_NET_HTTPLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x19424D00)
...
namespace System::Net
{
	...
	public:
		...
		::System::Net::HttpListenerPrefixCollection* prefixes; // 0x30
		::System::Net::ServiceNameStore* defaultServiceNames; // 0x38
		...
		::System::Security::Authentication::ExtendedProtection::ExtendedProtectionPolicy* extendedProtectionPolicy; // 0x58
		::System::Collections::ArrayList* wait_queue; // 0x60
		::System::Object* _internalLock; // 0x68
		::System::Net::HttpListener_ExtendedProtectionSelector* extendedProtectionSelectorDelegate; // 0x70
		::System::String* realm; // 0x78
		::System::Boolean unsafe_ntlm_auth; // 0x80
		::System::Boolean ignore_write_exceptions; // 0x81
		::System::Boolean disposed; // 0x82
