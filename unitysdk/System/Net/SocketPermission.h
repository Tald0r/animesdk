...
#define SYSTEM_NET_SOCKETPERMISSION_ADDPERMISSION_OFFSET UNITYSDK_OFFSET(0x187E2100)
#define SYSTEM_NET_SOCKETPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x187E2270)
#define SYSTEM_NET_SOCKETPERMISSION_FROMXML_1_OFFSET UNITYSDK_OFFSET(0x187E41C0)
#define SYSTEM_NET_SOCKETPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x187E3CA0)
#define SYSTEM_NET_SOCKETPERMISSION_GET_ACCEPTLIST_OFFSET UNITYSDK_OFFSET(0x187E2210)
#define SYSTEM_NET_SOCKETPERMISSION_GET_CONNECTLIST_OFFSET UNITYSDK_OFFSET(0x187E2240)
#define SYSTEM_NET_SOCKETPERMISSION_INTERSECTEMPTY_OFFSET UNITYSDK_OFFSET(0x187E2630)
#define SYSTEM_NET_SOCKETPERMISSION_INTERSECT_1_OFFSET UNITYSDK_OFFSET(0x187E26A0)
#define SYSTEM_NET_SOCKETPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x187E23F0)
#define SYSTEM_NET_SOCKETPERMISSION_ISSUBSETOF_1_OFFSET UNITYSDK_OFFSET(0x187E30E0)
#define SYSTEM_NET_SOCKETPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x187E2F40)
#define SYSTEM_NET_SOCKETPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x187E3790)
#define SYSTEM_NET_SOCKETPERMISSION_TOXML_1_OFFSET UNITYSDK_OFFSET(0x187E3920)
#define SYSTEM_NET_SOCKETPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x187E37A0)
#define SYSTEM_NET_SOCKETPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x187E48D0)
#define SYSTEM_NET_SOCKETPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x187E1F50)
#define SYSTEM_NET_SOCKETPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x187E1EB0)
