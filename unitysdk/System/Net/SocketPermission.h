...
#define SYSTEM_NET_SOCKETPERMISSION_ADDPERMISSION_OFFSET UNITYSDK_OFFSET(0x18247CB0)
#define SYSTEM_NET_SOCKETPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x18247E20)
#define SYSTEM_NET_SOCKETPERMISSION_FROMXML_1_OFFSET UNITYSDK_OFFSET(0x18249D70)
#define SYSTEM_NET_SOCKETPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x18249850)
#define SYSTEM_NET_SOCKETPERMISSION_GET_ACCEPTLIST_OFFSET UNITYSDK_OFFSET(0x18247DC0)
#define SYSTEM_NET_SOCKETPERMISSION_GET_CONNECTLIST_OFFSET UNITYSDK_OFFSET(0x18247DF0)
#define SYSTEM_NET_SOCKETPERMISSION_INTERSECTEMPTY_OFFSET UNITYSDK_OFFSET(0x182481E0)
#define SYSTEM_NET_SOCKETPERMISSION_INTERSECT_1_OFFSET UNITYSDK_OFFSET(0x18248250)
#define SYSTEM_NET_SOCKETPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x18247FA0)
#define SYSTEM_NET_SOCKETPERMISSION_ISSUBSETOF_1_OFFSET UNITYSDK_OFFSET(0x18248C90)
#define SYSTEM_NET_SOCKETPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x18248AF0)
#define SYSTEM_NET_SOCKETPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x18249340)
#define SYSTEM_NET_SOCKETPERMISSION_TOXML_1_OFFSET UNITYSDK_OFFSET(0x182494D0)
#define SYSTEM_NET_SOCKETPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x18249350)
#define SYSTEM_NET_SOCKETPERMISSION_UNION_OFFSET UNITYSDK_OFFSET(0x1824A480)
#define SYSTEM_NET_SOCKETPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18247B00)
#define SYSTEM_NET_SOCKETPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18247A60)
