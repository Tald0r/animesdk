...
#define SYSTEM_NET_DOWNLOADDATACOMPLETEDEVENTARGS_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x1945B700)
#define SYSTEM_NET_DOWNLOADDATACOMPLETEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1945B720)
#define SYSTEM_NET_DOWNLOADDATACOMPLETEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1945B6B0)
