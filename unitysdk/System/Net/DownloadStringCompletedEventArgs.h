...
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTARGS_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x19D288F0)
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D28910)
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19D288A0)
