...
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPINTERFACEPROPERTIES_GETIPV4PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1968C2B0)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPINTERFACEPROPERTIES_GET_GATEWAYADDRESSES_OFFSET UNITYSDK_OFFSET(0x1968C330)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPINTERFACEPROPERTIES_PARSEROUTEINFO_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1968C320)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSIPINTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1968C240)
