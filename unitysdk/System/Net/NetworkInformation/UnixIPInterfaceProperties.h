...
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GETIPV6PROPERTIES_OFFSET UNITYSDK_OFFSET(0x19015560)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_ANYCASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x19015CF0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_DHCPSERVERADDRESSES_OFFSET UNITYSDK_OFFSET(0x19015E70)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_DNSADDRESSES_OFFSET UNITYSDK_OFFSET(0x19015EF0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_DNSSUFFIX_OFFSET UNITYSDK_OFFSET(0x19015F10)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_ISDNSENABLED_OFFSET UNITYSDK_OFFSET(0x19015F30)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_ISDYNAMICDNSENABLED_OFFSET UNITYSDK_OFFSET(0x19015F40)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_MULTICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x19015F50)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_UNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x19016140)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_WINSSERVERSADDRESSES_OFFSET UNITYSDK_OFFSET(0x19016300)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_PARSERESOLVCONF_OFFSET UNITYSDK_OFFSET(0x190155B0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES__CCTOR_OFFSET UNITYSDK_OFFSET(0x19016380)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x19015550)
...
namespace System::Net::NetworkInformation
{
	...
	public:
		...
		::System::Net::NetworkInformation::IPv4InterfaceProperties* ipv4iface_properties; // 0x18
