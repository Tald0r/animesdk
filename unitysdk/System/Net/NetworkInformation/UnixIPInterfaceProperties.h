...
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GETIPV6PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1942B400)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_ANYCASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1942BB90)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_DHCPSERVERADDRESSES_OFFSET UNITYSDK_OFFSET(0x1942BD10)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_DNSADDRESSES_OFFSET UNITYSDK_OFFSET(0x1942BD90)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_DNSSUFFIX_OFFSET UNITYSDK_OFFSET(0x1942BDB0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_ISDNSENABLED_OFFSET UNITYSDK_OFFSET(0x1942BDD0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_ISDYNAMICDNSENABLED_OFFSET UNITYSDK_OFFSET(0x1942BDE0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_MULTICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1942BDF0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_UNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1942BFE0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_GET_WINSSERVERSADDRESSES_OFFSET UNITYSDK_OFFSET(0x1942C1A0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES_PARSERESOLVCONF_OFFSET UNITYSDK_OFFSET(0x1942B450)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1942C220)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPINTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1942B3F0)
