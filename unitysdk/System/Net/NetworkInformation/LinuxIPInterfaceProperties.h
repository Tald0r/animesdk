...
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES_GETIPV4PROPERTIES_OFFSET UNITYSDK_OFFSET(0x18FC25B0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES_GET_GATEWAYADDRESSES_OFFSET UNITYSDK_OFFSET(0x18FC2B60)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES_PARSEROUTEINFO_OFFSET UNITYSDK_OFFSET(0x18FC2620)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC2540)
