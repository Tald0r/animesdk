...
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES_GETIPV4PROPERTIES_OFFSET UNITYSDK_OFFSET(0x193AE920)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES_GET_GATEWAYADDRESSES_OFFSET UNITYSDK_OFFSET(0x193AEED0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES_PARSEROUTEINFO_OFFSET UNITYSDK_OFFSET(0x193AE990)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPINTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x193AE8B0)
