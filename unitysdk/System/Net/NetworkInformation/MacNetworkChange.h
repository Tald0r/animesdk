...
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_ADD_NETWORKADDRESSCHANGED_1_OFFSET UNITYSDK_OFFSET(0x19D7BB10)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_ADD_NETWORKADDRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x19D7B910)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_ADD_NETWORKAVAILABILITYCHANGED_1_OFFSET UNITYSDK_OFFSET(0x19D7BC50)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_ADD_NETWORKAVAILABILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x19D7BA10)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_CFRELEASE_OFFSET UNITYSDK_OFFSET(0x19D7B510)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_CFRUNLOOPGETMAIN_OFFSET UNITYSDK_OFFSET(0x19D7B590)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19D7C440)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_DLCLOSE_OFFSET UNITYSDK_OFFSET(0x19D7B490)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_DLOPEN_OFFSET UNITYSDK_OFFSET(0x19D7B350)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_DLSYM_OFFSET UNITYSDK_OFFSET(0x19D7B3F0)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_GET_HASREGISTEREDEVENTS_OFFSET UNITYSDK_OFFSET(0x19D7BDE0)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x19D7BD50)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_HANDLECALLBACK_OFFSET UNITYSDK_OFFSET(0x19D7B210)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_LOADRUNLOOPMODE_OFFSET UNITYSDK_OFFSET(0x19D7C160)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_REMOVE_NETWORKADDRESSCHANGED_1_OFFSET UNITYSDK_OFFSET(0x19D7BBD0)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_REMOVE_NETWORKADDRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x19D7B990)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_REMOVE_NETWORKAVAILABILITYCHANGED_1_OFFSET UNITYSDK_OFFSET(0x19D7BD60)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_REMOVE_NETWORKAVAILABILITYCHANGED_OFFSET UNITYSDK_OFFSET(0x19D7BA90)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_SCNETWORKREACHABILITYCREATEWITHADDRESS_OFFSET UNITYSDK_OFFSET(0x19D7B610)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_SCNETWORKREACHABILITYGETFLAGS_OFFSET UNITYSDK_OFFSET(0x19D7B6A0)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_SCNETWORKREACHABILITYSCHEDULEWITHRUNLOOP_OFFSET UNITYSDK_OFFSET(0x19D7B7D0)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_SCNETWORKREACHABILITYSETCALLBACK_OFFSET UNITYSDK_OFFSET(0x19D7B730)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE_SCNETWORKREACHABILITYUNSCHEDULEFROMRUNLOOP_OFFSET UNITYSDK_OFFSET(0x19D7B870)
#define SYSTEM_NET_NETWORKINFORMATION_MACNETWORKCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D7BE00)
...
namespace System::Net::NetworkInformation
{
	...
	public:
		...
		::System::Net::NetworkInformation::NetworkAddressChangedEventHandler* networkAddressChanged; // 0x10
		::System::Net::NetworkInformation::NetworkAvailabilityChangedEventHandler* networkAvailabilityChanged; // 0x18
		::System::Net::NetworkInformation::MacNetworkChange_SCNetworkReachabilityCallback* callback; // 0x20
		::System::IntPtr runLoopMode; // 0x28
		::System::IntPtr handle; // 0x30
		::System::Net::NetworkInformation::MacNetworkChange_NetworkReachabilityFlags flags; // 0x38
		::System::Boolean scheduledWithRunLoop; // 0x3C
