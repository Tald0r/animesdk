...
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A33B410)
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS_GETADDRESSBYTES_OFFSET UNITYSDK_OFFSET(0x1A33B5D0)
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A33B050)
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS_PARSE_OFFSET UNITYSDK_OFFSET(0x1A33B630)
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A33B4B0)
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A33BA50)
#define SYSTEM_NET_NETWORKINFORMATION_PHYSICALADDRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A33B040)
