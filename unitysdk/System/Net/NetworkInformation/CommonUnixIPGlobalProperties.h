...
#define SYSTEM_NET_NETWORKINFORMATION_COMMONUNIXIPGLOBALPROPERTIES_GETDOMAINNAME_OFFSET UNITYSDK_OFFSET(0x191D5970)
#define SYSTEM_NET_NETWORKINFORMATION_COMMONUNIXIPGLOBALPROPERTIES_GETHOSTNAME_OFFSET UNITYSDK_OFFSET(0x191D58E0)
#define SYSTEM_NET_NETWORKINFORMATION_COMMONUNIXIPGLOBALPROPERTIES_GET_DHCPSCOPENAME_OFFSET UNITYSDK_OFFSET(0x191D5A00)
#define SYSTEM_NET_NETWORKINFORMATION_COMMONUNIXIPGLOBALPROPERTIES_GET_DOMAINNAME_OFFSET UNITYSDK_OFFSET(0x191D5A10)
#define SYSTEM_NET_NETWORKINFORMATION_COMMONUNIXIPGLOBALPROPERTIES_GET_HOSTNAME_OFFSET UNITYSDK_OFFSET(0x191D5C20)
#define SYSTEM_NET_NETWORKINFORMATION_COMMONUNIXIPGLOBALPROPERTIES_GET_ISWINSPROXY_OFFSET UNITYSDK_OFFSET(0x191D5DB0)
#define SYSTEM_NET_NETWORKINFORMATION_COMMONUNIXIPGLOBALPROPERTIES_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x191D5DC0)
#define SYSTEM_NET_NETWORKINFORMATION_COMMONUNIXIPGLOBALPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x191D5DD0)
