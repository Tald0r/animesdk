...
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GETIPSTATUS_OFFSET UNITYSDK_OFFSET(0x1942B300)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x1942B3B0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1942B3E0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1942B3D0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_ROUNDTRIPTIME_OFFSET UNITYSDK_OFFSET(0x1942B3C0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x1942B3A0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1942B190)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1942B1C0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1942B380)
#define SYSTEM_NET_NETWORKINFORMATION_PINGREPLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1942B180)
