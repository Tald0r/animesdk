...
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_BEGINGETUNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1A5F6CC0)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_ENDGETUNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1A5F6D10)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_GETIPGLOBALPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A5F6BF0)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_GETUNICASTADDRESSESASYNC_OFFSET UNITYSDK_OFFSET(0x1A5F6D60)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_GETUNICASTADDRESSES_OFFSET UNITYSDK_OFFSET(0x1A5F6C70)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_GET_PLATFORMNEEDSLIBCWORKAROUND_OFFSET UNITYSDK_OFFSET(0x1A5F6BB0)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES_INTERNALGETIPGLOBALPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A5F6C30)
#define SYSTEM_NET_NETWORKINFORMATION_IPGLOBALPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F6F10)
