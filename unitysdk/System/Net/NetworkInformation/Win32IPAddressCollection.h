...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION_ADDSUBSEQUENTLYSTRING_OFFSET UNITYSDK_OFFSET(0x187DFBE0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION_FROMANYCAST_OFFSET UNITYSDK_OFFSET(0x187DFEE0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION_FROMDNSSERVER_OFFSET UNITYSDK_OFFSET(0x187E00B0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION_FROMSOCKETADDRESS_OFFSET UNITYSDK_OFFSET(0x187E0280)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION_FROMWINSSERVER_OFFSET UNITYSDK_OFFSET(0x187E0360)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x187E0530)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x187DFB30)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x187DFD70)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPADDRESSCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x187DFAE0)
