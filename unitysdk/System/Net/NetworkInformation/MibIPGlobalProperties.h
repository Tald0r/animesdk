...
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_CREATEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x193AF9E0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETACTIVETCPCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x193B04E0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETACTIVETCPLISTENERS_OFFSET UNITYSDK_OFFSET(0x193B0760)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETACTIVEUDPLISTENERS_OFFSET UNITYSDK_OFFSET(0x193B07D0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETICMPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x193B0840)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETICMPV6STATISTICS_OFFSET UNITYSDK_OFFSET(0x193B0890)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETIPV4GLOBALSTATISTICS_OFFSET UNITYSDK_OFFSET(0x193B08E0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETIPV6GLOBALSTATISTICS_OFFSET UNITYSDK_OFFSET(0x193B0930)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETLOCALADDRESSES_OFFSET UNITYSDK_OFFSET(0x193AFF10)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETPROPERTIES4_OFFSET UNITYSDK_OFFSET(0x193AF430)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETPROPERTIES6_OFFSET UNITYSDK_OFFSET(0x193AFAC0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETROWS_OFFSET UNITYSDK_OFFSET(0x193B0200)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETTCPIPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x193B0980)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETTCPIPV6STATISTICS_OFFSET UNITYSDK_OFFSET(0x193B09D0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETUDPIPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x193B0A20)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETUDPIPV6STATISTICS_OFFSET UNITYSDK_OFFSET(0x193B0A70)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_TOENDPOINT_OFFSET UNITYSDK_OFFSET(0x193B0060)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES__CCTOR_OFFSET UNITYSDK_OFFSET(0x193B0AC0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x193AF380)
...
namespace System::Net::NetworkInformation
{
	...
	public:
		...
		::System::String* StatisticsFileIPv6; // 0x30
