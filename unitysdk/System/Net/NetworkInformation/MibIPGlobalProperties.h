...
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_CREATEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x18FC3660)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETACTIVETCPCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x18FC4160)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETACTIVETCPLISTENERS_OFFSET UNITYSDK_OFFSET(0x18FC43E0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETACTIVEUDPLISTENERS_OFFSET UNITYSDK_OFFSET(0x18FC4450)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETICMPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x18FC44C0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETICMPV6STATISTICS_OFFSET UNITYSDK_OFFSET(0x18FC4510)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETIPV4GLOBALSTATISTICS_OFFSET UNITYSDK_OFFSET(0x18FC4560)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETIPV6GLOBALSTATISTICS_OFFSET UNITYSDK_OFFSET(0x18FC45B0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETLOCALADDRESSES_OFFSET UNITYSDK_OFFSET(0x18FC3B90)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETPROPERTIES4_OFFSET UNITYSDK_OFFSET(0x18FC30B0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETPROPERTIES6_OFFSET UNITYSDK_OFFSET(0x18FC3740)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETROWS_OFFSET UNITYSDK_OFFSET(0x18FC3E80)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETTCPIPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x18FC4600)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETTCPIPV6STATISTICS_OFFSET UNITYSDK_OFFSET(0x18FC4650)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETUDPIPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x18FC46A0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_GETUDPIPV6STATISTICS_OFFSET UNITYSDK_OFFSET(0x18FC46F0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES_TOENDPOINT_OFFSET UNITYSDK_OFFSET(0x18FC3CE0)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES__CCTOR_OFFSET UNITYSDK_OFFSET(0x18FC4740)
#define SYSTEM_NET_NETWORKINFORMATION_MIBIPGLOBALPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC3000)
