...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE_GETNETWORKPARAMS_OFFSET UNITYSDK_OFFSET(0x193B1890)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE_GET_FIXEDINFO_OFFSET UNITYSDK_OFFSET(0x193B1960)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE__CCTOR_OFFSET UNITYSDK_OFFSET(0x193B1BE0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x193B1BD0)
