...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32_IP_ADAPTER_ADDRESSES_GET_DDNSENABLED_OFFSET UNITYSDK_OFFSET(0x89FFB0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32_IP_ADAPTER_ADDRESSES_GET_DHCPENABLED_OFFSET UNITYSDK_OFFSET(0x89FFC0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32_IP_ADAPTER_ADDRESSES_GET_ISRECEIVEONLY_OFFSET UNITYSDK_OFFSET(0x89FFD0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32_IP_ADAPTER_ADDRESSES_GET_NOMULTICAST_OFFSET UNITYSDK_OFFSET(0x89FFE0)
