...
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMTCPCONNECTIONINFORMATION_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x19386530)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMTCPCONNECTIONINFORMATION_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x19386540)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMTCPCONNECTIONINFORMATION_GET_STATE_OFFSET UNITYSDK_OFFSET(0x19386520)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMTCPCONNECTIONINFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19386510)
