...
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPGLOBALPROPERTIES_GETACTIVETCPCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x190A7140)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPGLOBALPROPERTIES_GETACTIVETCPLISTENERS_OFFSET UNITYSDK_OFFSET(0x190A7190)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPGLOBALPROPERTIES_GETACTIVEUDPLISTENERS_OFFSET UNITYSDK_OFFSET(0x190A71E0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPGLOBALPROPERTIES_GETICMPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x190A7230)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPGLOBALPROPERTIES_GETICMPV6STATISTICS_OFFSET UNITYSDK_OFFSET(0x190A7280)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPGLOBALPROPERTIES_GETIPV4GLOBALSTATISTICS_OFFSET UNITYSDK_OFFSET(0x190A72D0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPGLOBALPROPERTIES_GETIPV6GLOBALSTATISTICS_OFFSET UNITYSDK_OFFSET(0x190A7320)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPGLOBALPROPERTIES_GETTCPIPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x190A7370)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPGLOBALPROPERTIES_GETTCPIPV6STATISTICS_OFFSET UNITYSDK_OFFSET(0x190A73C0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPGLOBALPROPERTIES_GETUDPIPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x190A7410)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPGLOBALPROPERTIES_GETUDPIPV6STATISTICS_OFFSET UNITYSDK_OFFSET(0x190A7460)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPGLOBALPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x190A74B0)
