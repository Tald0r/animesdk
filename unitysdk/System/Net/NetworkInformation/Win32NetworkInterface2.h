...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETADAPTERSINFO_1_OFFSET UNITYSDK_OFFSET(0x18FC5AC0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETADAPTERSINFO_OFFSET UNITYSDK_OFFSET(0x18FC5870)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETIFENTRY_OFFSET UNITYSDK_OFFSET(0x18FC5940)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETIPPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18FC60D0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETIPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x18FC60E0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GETPHYSICALADDRESS_OFFSET UNITYSDK_OFFSET(0x18FC60F0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x18FC6180)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_ID_OFFSET UNITYSDK_OFFSET(0x18FC6190)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_ISRECEIVEONLY_OFFSET UNITYSDK_OFFSET(0x18FC61A0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18FC61B0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_NETWORKINTERFACETYPE_OFFSET UNITYSDK_OFFSET(0x18FC61C0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_OPERATIONALSTATUS_OFFSET UNITYSDK_OFFSET(0x18FC61D0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x18FC61E0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_GET_SUPPORTSMULTICAST_OFFSET UNITYSDK_OFFSET(0x18FC6200)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2_SUPPORTS_OFFSET UNITYSDK_OFFSET(0x18FC6150)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32NETWORKINTERFACE2__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC5DB0)
...
namespace System::Net::NetworkInformation
{
	...
	public:
		...
		::System::Net::NetworkInformation::Win32IPv4InterfaceStatistics* ip4stats; // 0x80
