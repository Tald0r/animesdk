...
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMIPADDRESSINFORMATION_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x1A5F9AF0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMIPADDRESSINFORMATION_GET_ISDNSELIGIBLE_OFFSET UNITYSDK_OFFSET(0x1A5F9B10)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMIPADDRESSINFORMATION_GET_ISTRANSIENT_OFFSET UNITYSDK_OFFSET(0x1A5F9B00)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMIPADDRESSINFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F9AE0)
