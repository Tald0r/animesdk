...
#define SYSTEM_NET_NETWORKINFORMATION_PINGCOMPLETEDEVENTARGS_GET_REPLY_OFFSET UNITYSDK_OFFSET(0x193864C0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGCOMPLETEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193864D0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGCOMPLETEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19386470)
