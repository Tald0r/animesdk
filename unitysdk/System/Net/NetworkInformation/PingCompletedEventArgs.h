...
#define SYSTEM_NET_NETWORKINFORMATION_PINGCOMPLETEDEVENTARGS_GET_REPLY_OFFSET UNITYSDK_OFFSET(0x18FF4FB0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGCOMPLETEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FF4FC0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGCOMPLETEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF4F60)
