...
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ADDRESSPREFERREDLIFETIME_OFFSET UNITYSDK_OFFSET(0x18D85980)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ADDRESSVALIDLIFETIME_OFFSET UNITYSDK_OFFSET(0x18D85970)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x18D858E0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_DHCPLEASELIFETIME_OFFSET UNITYSDK_OFFSET(0x18D85990)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_DUPLICATEADDRESSDETECTIONSTATE_OFFSET UNITYSDK_OFFSET(0x18D85960)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ISDNSELIGIBLE_OFFSET UNITYSDK_OFFSET(0x18D85920)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ISTRANSIENT_OFFSET UNITYSDK_OFFSET(0x18D85900)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_PREFIXORIGIN_OFFSET UNITYSDK_OFFSET(0x18D85940)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_SUFFIXORIGIN_OFFSET UNITYSDK_OFFSET(0x18D85950)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_TOMULTICASTIPADDRESSINFORMATIONCOLLECTION_OFFSET UNITYSDK_OFFSET(0x18D859A0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18D858D0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18D858C0)
