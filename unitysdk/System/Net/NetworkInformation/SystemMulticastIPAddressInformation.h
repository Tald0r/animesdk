...
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ADDRESSPREFERREDLIFETIME_OFFSET UNITYSDK_OFFSET(0x191CE650)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ADDRESSVALIDLIFETIME_OFFSET UNITYSDK_OFFSET(0x191CE640)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x191CE5B0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_DHCPLEASELIFETIME_OFFSET UNITYSDK_OFFSET(0x191CE660)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_DUPLICATEADDRESSDETECTIONSTATE_OFFSET UNITYSDK_OFFSET(0x191CE630)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ISDNSELIGIBLE_OFFSET UNITYSDK_OFFSET(0x191CE5F0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_ISTRANSIENT_OFFSET UNITYSDK_OFFSET(0x191CE5D0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_PREFIXORIGIN_OFFSET UNITYSDK_OFFSET(0x191CE610)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_GET_SUFFIXORIGIN_OFFSET UNITYSDK_OFFSET(0x191CE620)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION_TOMULTICASTIPADDRESSINFORMATIONCOLLECTION_OFFSET UNITYSDK_OFFSET(0x191CE670)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191CE5A0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMMULTICASTIPADDRESSINFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x191CE590)
