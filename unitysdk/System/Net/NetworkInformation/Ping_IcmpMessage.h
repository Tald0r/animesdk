...
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_COMPUTECHECKSUM_OFFSET UNITYSDK_OFFSET(0x194635D0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x194637E0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_CODE_OFFSET UNITYSDK_OFFSET(0x194636A0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x19463780)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x194636E0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_IPSTATUS_OFFSET UNITYSDK_OFFSET(0x194637F0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_SEQUENCE_OFFSET UNITYSDK_OFFSET(0x19463730)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19463660)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x194633D0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ICMPMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19463380)
