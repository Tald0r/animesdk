...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_DATAGRAMSRECEIVED_OFFSET UNITYSDK_OFFSET(0x18FF5160)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_DATAGRAMSSENT_OFFSET UNITYSDK_OFFSET(0x18FF5170)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_INCOMINGDATAGRAMSDISCARDED_OFFSET UNITYSDK_OFFSET(0x18FF5180)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_INCOMINGDATAGRAMSWITHERRORS_OFFSET UNITYSDK_OFFSET(0x18FF5190)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS_GET_UDPLISTENERS_OFFSET UNITYSDK_OFFSET(0x18FF51A0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32UDPSTATISTICS__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF5150)
