...
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x191D8990)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_ISAUTOMATICPRIVATEADDRESSINGACTIVE_OFFSET UNITYSDK_OFFSET(0x191D8A40)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_ISAUTOMATICPRIVATEADDRESSINGENABLED_OFFSET UNITYSDK_OFFSET(0x191D8A50)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_ISDHCPENABLED_OFFSET UNITYSDK_OFFSET(0x191D8A60)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_USESWINS_OFFSET UNITYSDK_OFFSET(0x191D8A70)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x191D8980)
