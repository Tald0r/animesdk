...
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x195D4D20)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_ISAUTOMATICPRIVATEADDRESSINGACTIVE_OFFSET UNITYSDK_OFFSET(0x195D4DD0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_ISAUTOMATICPRIVATEADDRESSINGENABLED_OFFSET UNITYSDK_OFFSET(0x195D4DE0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_ISDHCPENABLED_OFFSET UNITYSDK_OFFSET(0x195D4DF0)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES_GET_USESWINS_OFFSET UNITYSDK_OFFSET(0x195D4E00)
#define SYSTEM_NET_NETWORKINFORMATION_UNIXIPV4INTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x195D4D10)
