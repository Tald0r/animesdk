...
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKADDRESSCHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x192469F0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKADDRESSCHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19246A30)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKADDRESSCHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19246470)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKADDRESSCHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19246450)
