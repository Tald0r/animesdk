...
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GETNETMASK_OFFSET UNITYSDK_OFFSET(0x19D2B0F0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GETNETWORKINTERFACES_OFFSET UNITYSDK_OFFSET(0x19D2AFA0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GET_INTERNALIPV6LOOPBACKINTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x19D2B0A0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GET_INTERNALLOOPBACKINTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x19D2B040)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_INTERNALGETISNETWORKAVAILABLE_OFFSET UNITYSDK_OFFSET(0x19D2B030)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D2B160)
