...
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GETNETMASK_OFFSET UNITYSDK_OFFSET(0x197EBD80)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GETNETWORKINTERFACES_OFFSET UNITYSDK_OFFSET(0x197EBC30)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GET_INTERNALIPV6LOOPBACKINTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x197EBD30)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_GET_INTERNALLOOPBACKINTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x197EBCD0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE_INTERNALGETISNETWORKAVAILABLE_OFFSET UNITYSDK_OFFSET(0x197EBCC0)
#define SYSTEM_NET_NETWORKINFORMATION_SYSTEMNETWORKINTERFACE__CCTOR_OFFSET UNITYSDK_OFFSET(0x197EBDF0)
