...
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPV4INTERFACEPROPERTIES_GET_ISFORWARDINGENABLED_OFFSET UNITYSDK_OFFSET(0x185A2FE0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPV4INTERFACEPROPERTIES_GET_MTU_OFFSET UNITYSDK_OFFSET(0x185A3100)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXIPV4INTERFACEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x185A2FD0)
