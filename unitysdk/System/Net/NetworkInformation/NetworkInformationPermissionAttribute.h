...
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x18BB40E0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE_GET_ACCESS_OFFSET UNITYSDK_OFFSET(0x18BB40C0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE_SET_ACCESS_OFFSET UNITYSDK_OFFSET(0x18BB40D0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB40B0)
