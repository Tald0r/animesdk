...
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x185A3360)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE_GET_ACCESS_OFFSET UNITYSDK_OFFSET(0x185A3340)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE_SET_ACCESS_OFFSET UNITYSDK_OFFSET(0x185A3350)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINFORMATIONPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x185A3330)
