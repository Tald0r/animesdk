...
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKINTERFACE_GETIPPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19462790)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKINTERFACE_GETIPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x19462840)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKINTERFACE_GET_IFACEPATH_OFFSET UNITYSDK_OFFSET(0x19462680)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKINTERFACE_GET_OPERATIONALSTATUS_OFFSET UNITYSDK_OFFSET(0x194628A0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKINTERFACE_GET_SUPPORTSMULTICAST_OFFSET UNITYSDK_OFFSET(0x19462EB0)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKINTERFACE_READLINE_OFFSET UNITYSDK_OFFSET(0x19462C20)
#define SYSTEM_NET_NETWORKINFORMATION_LINUXNETWORKINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19462690)
