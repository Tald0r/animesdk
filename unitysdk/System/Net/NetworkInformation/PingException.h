...
#define SYSTEM_NET_NETWORKINFORMATION_PINGEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193B0BF0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x193B0C40)
#define SYSTEM_NET_NETWORKINFORMATION_PINGEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x193B0CB0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x193B0B50)
