...
#define SYSTEM_NET_NETWORKINFORMATION_MACOSNETWORKINTERFACE_GETIPPROPERTIES_OFFSET UNITYSDK_OFFSET(0x182DE220)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSNETWORKINTERFACE_GETIPV4STATISTICS_OFFSET UNITYSDK_OFFSET(0x182DE2D0)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSNETWORKINTERFACE_GET_OPERATIONALSTATUS_OFFSET UNITYSDK_OFFSET(0x182DE320)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSNETWORKINTERFACE_GET_SUPPORTSMULTICAST_OFFSET UNITYSDK_OFFSET(0x182DE330)
#define SYSTEM_NET_NETWORKINFORMATION_MACOSNETWORKINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x182DE1A0)
