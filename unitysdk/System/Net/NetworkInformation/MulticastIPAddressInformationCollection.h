...
#define SYSTEM_NET_NETWORKINFORMATION_MULTICASTIPADDRESSINFORMATIONCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1A33AC90)
#define SYSTEM_NET_NETWORKINFORMATION_MULTICASTIPADDRESSINFORMATIONCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A33AED0)
#define SYSTEM_NET_NETWORKINFORMATION_MULTICASTIPADDRESSINFORMATIONCOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A33AD50)
#define SYSTEM_NET_NETWORKINFORMATION_MULTICASTIPADDRESSINFORMATIONCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1A33ABD0)
#define SYSTEM_NET_NETWORKINFORMATION_MULTICASTIPADDRESSINFORMATIONCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A33ADC0)
#define SYSTEM_NET_NETWORKINFORMATION_MULTICASTIPADDRESSINFORMATIONCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A33AC30)
#define SYSTEM_NET_NETWORKINFORMATION_MULTICASTIPADDRESSINFORMATIONCOLLECTION_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1A33AC80)
#define SYSTEM_NET_NETWORKINFORMATION_MULTICASTIPADDRESSINFORMATIONCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A33AE10)
#define SYSTEM_NET_NETWORKINFORMATION_MULTICASTIPADDRESSINFORMATIONCOLLECTION_INTERNALADD_OFFSET UNITYSDK_OFFSET(0x1A33ACF0)
#define SYSTEM_NET_NETWORKINFORMATION_MULTICASTIPADDRESSINFORMATIONCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A33AE70)
#define SYSTEM_NET_NETWORKINFORMATION_MULTICASTIPADDRESSINFORMATIONCOLLECTION_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A33ADB0)
#define SYSTEM_NET_NETWORKINFORMATION_MULTICASTIPADDRESSINFORMATIONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A33AB80)
