...
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINTERFACEFACTORY_WIN32NETWORKINTERFACEAPI_GETADAPTERSADDRESSES_1_OFFSET UNITYSDK_OFFSET(0x18244960)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINTERFACEFACTORY_WIN32NETWORKINTERFACEAPI_GETADAPTERSADDRESSES_OFFSET UNITYSDK_OFFSET(0x182447F0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINTERFACEFACTORY_WIN32NETWORKINTERFACEAPI_GETALLNETWORKINTERFACES_OFFSET UNITYSDK_OFFSET(0x18244CF0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINTERFACEFACTORY_WIN32NETWORKINTERFACEAPI_GETBESTINTERFACEEX_OFFSET UNITYSDK_OFFSET(0x182448D0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINTERFACEFACTORY_WIN32NETWORKINTERFACEAPI_GETBESTINTERFACEFORADDRESS_OFFSET UNITYSDK_OFFSET(0x18245270)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINTERFACEFACTORY_WIN32NETWORKINTERFACEAPI_GETLOOPBACKINTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x18245390)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINTERFACEFACTORY_WIN32NETWORKINTERFACEAPI_GETNETMASK_OFFSET UNITYSDK_OFFSET(0x182453D0)
#define SYSTEM_NET_NETWORKINFORMATION_NETWORKINTERFACEFACTORY_WIN32NETWORKINTERFACEAPI__CTOR_OFFSET UNITYSDK_OFFSET(0x18245420)
