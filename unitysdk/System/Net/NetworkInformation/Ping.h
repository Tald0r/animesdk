...
#define SYSTEM_NET_NETWORKINFORMATION_PING_ADD_PINGCOMPLETED_OFFSET UNITYSDK_OFFSET(0x19B2B7C0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_BUILDPINGARGS_OFFSET UNITYSDK_OFFSET(0x19B2D3B0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_CAPGET_OFFSET UNITYSDK_OFFSET(0x19B2BAB0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_CHECKLINUXCAPABILITIES_OFFSET UNITYSDK_OFFSET(0x19B2BB40)
#define SYSTEM_NET_NETWORKINFORMATION_PING_ONPINGCOMPLETED_OFFSET UNITYSDK_OFFSET(0x19B2BCC0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_REMOVE_PINGCOMPLETED_OFFSET UNITYSDK_OFFSET(0x19B2B840)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNCCANCEL_OFFSET UNITYSDK_OFFSET(0x19B2DB90)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_1_OFFSET UNITYSDK_OFFSET(0x19B2D870)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_2_OFFSET UNITYSDK_OFFSET(0x19B2D970)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_3_OFFSET UNITYSDK_OFFSET(0x19B2D980)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_4_OFFSET UNITYSDK_OFFSET(0x19B2DA30)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_5_OFFSET UNITYSDK_OFFSET(0x19B2DA90)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_6_OFFSET UNITYSDK_OFFSET(0x19B2DB10)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_7_OFFSET UNITYSDK_OFFSET(0x19B2D6D0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x19B2D620)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_1_OFFSET UNITYSDK_OFFSET(0x19B2DF40)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_2_OFFSET UNITYSDK_OFFSET(0x19B2E040)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_3_OFFSET UNITYSDK_OFFSET(0x19B2E050)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_4_OFFSET UNITYSDK_OFFSET(0x19B2E100)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_5_OFFSET UNITYSDK_OFFSET(0x19B2E160)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_6_OFFSET UNITYSDK_OFFSET(0x19B2E1E0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_7_OFFSET UNITYSDK_OFFSET(0x19B2DD10)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPINGASYNC_OFFSET UNITYSDK_OFFSET(0x19B2DC70)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDPRIVILEGED_OFFSET UNITYSDK_OFFSET(0x19B2C2F0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SENDUNPRIVILEGED_OFFSET UNITYSDK_OFFSET(0x19B2CBD0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_1_OFFSET UNITYSDK_OFFSET(0x19B2BE30)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_2_OFFSET UNITYSDK_OFFSET(0x19B2BF00)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_3_OFFSET UNITYSDK_OFFSET(0x19B2C0F0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_4_OFFSET UNITYSDK_OFFSET(0x19B2C170)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_5_OFFSET UNITYSDK_OFFSET(0x19B2C1F0)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_6_OFFSET UNITYSDK_OFFSET(0x19B2C290)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_7_OFFSET UNITYSDK_OFFSET(0x19B2BF70)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SEND_OFFSET UNITYSDK_OFFSET(0x19B2BD60)
#define SYSTEM_NET_NETWORKINFORMATION_PING_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19B2BCB0)
#define SYSTEM_NET_NETWORKINFORMATION_PING__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B2B8C0)
#define SYSTEM_NET_NETWORKINFORMATION_PING__CTOR_OFFSET UNITYSDK_OFFSET(0x19B2B9D0)
...
namespace System::Net::NetworkInformation
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Ping_TypeDefinitionIndex)->GetStaticField(0x2858);
		}
		static ::Il2CppArray<::System::Byte>** StaticGet_default_buffer()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(Ping_TypeDefinitionIndex)->GetStaticField(0x2860);
		}
