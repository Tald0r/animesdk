...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCPROW_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x187E0650)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCPROW_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x187E0700)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCPROW_GET_TCPINFO_OFFSET UNITYSDK_OFFSET(0x187E07B0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x187E0930)
