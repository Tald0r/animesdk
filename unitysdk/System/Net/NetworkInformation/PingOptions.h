...
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_GET_DONTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x185A3BC0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_GET_TTL_OFFSET UNITYSDK_OFFSET(0x185A3B40)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_SET_DONTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x185A3BD0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_SET_TTL_OFFSET UNITYSDK_OFFSET(0x185A3B50)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x185A3B30)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x185A3AB0)
