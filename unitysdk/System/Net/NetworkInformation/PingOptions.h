...
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_GET_DONTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x18BB4950)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_GET_TTL_OFFSET UNITYSDK_OFFSET(0x18BB48D0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_SET_DONTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x18BB4960)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS_SET_TTL_OFFSET UNITYSDK_OFFSET(0x18BB48E0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18BB48C0)
#define SYSTEM_NET_NETWORKINFORMATION_PINGOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB4840)
