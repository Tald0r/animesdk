...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCP6ROW_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x185A3BF0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCP6ROW_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x185A3CC0)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCP6ROW_GET_TCPINFO_OFFSET UNITYSDK_OFFSET(0x185A3D90)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCP6ROW__CTOR_OFFSET UNITYSDK_OFFSET(0x185A3F50)
