...
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCP6ROW_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x18BB4980)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCP6ROW_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x18BB4A50)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCP6ROW_GET_TCPINFO_OFFSET UNITYSDK_OFFSET(0x18BB4B20)
#define SYSTEM_NET_NETWORKINFORMATION_WIN32IPGLOBALPROPERTIES_WIN32_MIB_TCP6ROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB4CE0)
