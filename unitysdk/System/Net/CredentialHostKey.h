...
#define SYSTEM_NET_CREDENTIALHOSTKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x182DC8A0)
#define SYSTEM_NET_CREDENTIALHOSTKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x182DC670)
#define SYSTEM_NET_CREDENTIALHOSTKEY_MATCH_OFFSET UNITYSDK_OFFSET(0x182DC610)
#define SYSTEM_NET_CREDENTIALHOSTKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x182DC940)
#define SYSTEM_NET_CREDENTIALHOSTKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x182DC600)
