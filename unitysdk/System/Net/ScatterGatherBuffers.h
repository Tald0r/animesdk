...
#define SYSTEM_NET_SCATTERGATHERBUFFERS_ALLOCATEMEMORYCHUNK_OFFSET UNITYSDK_OFFSET(0x19B2E7E0)
#define SYSTEM_NET_SCATTERGATHERBUFFERS_GETBUFFERS_OFFSET UNITYSDK_OFFSET(0x19B2E870)
#define SYSTEM_NET_SCATTERGATHERBUFFERS_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x19B2E9C0)
#define SYSTEM_NET_SCATTERGATHERBUFFERS_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x19B2E9E0)
#define SYSTEM_NET_SCATTERGATHERBUFFERS_WRITE_OFFSET UNITYSDK_OFFSET(0x19B2E9F0)
#define SYSTEM_NET_SCATTERGATHERBUFFERS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B2E740)
#define SYSTEM_NET_SCATTERGATHERBUFFERS__CTOR_OFFSET UNITYSDK_OFFSET(0x19B2E730)
