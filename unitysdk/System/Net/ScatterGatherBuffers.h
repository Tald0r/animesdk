...
#define SYSTEM_NET_SCATTERGATHERBUFFERS_ALLOCATEMEMORYCHUNK_OFFSET UNITYSDK_OFFSET(0x1968FDF0)
#define SYSTEM_NET_SCATTERGATHERBUFFERS_GETBUFFERS_OFFSET UNITYSDK_OFFSET(0x1968FE80)
#define SYSTEM_NET_SCATTERGATHERBUFFERS_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1968FFD0)
#define SYSTEM_NET_SCATTERGATHERBUFFERS_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1968FFF0)
#define SYSTEM_NET_SCATTERGATHERBUFFERS_WRITE_OFFSET UNITYSDK_OFFSET(0x19690000)
#define SYSTEM_NET_SCATTERGATHERBUFFERS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1968FD50)
#define SYSTEM_NET_SCATTERGATHERBUFFERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1968FD40)
