...
#define SYSTEM_NET_BUFFEROFFSETSIZE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19685900)
#define SYSTEM_NET_BUFFEROFFSETSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x196858A0)
