...
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A33DB30)
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A33DB70)
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A33D5B0)
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A33D590)
