...
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D7F600)
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D7F640)
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D7F080)
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D7F070)
