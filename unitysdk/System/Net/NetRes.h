...
#define SYSTEM_NET_NETRES_GETWEBSTATUSCODESTRING_1_OFFSET UNITYSDK_OFFSET(0x1942A050)
#define SYSTEM_NET_NETRES_GETWEBSTATUSCODESTRING_OFFSET UNITYSDK_OFFSET(0x19429EE0)
#define SYSTEM_NET_NETRES_GETWEBSTATUSSTRING_1_OFFSET UNITYSDK_OFFSET(0x19429E80)
#define SYSTEM_NET_NETRES_GETWEBSTATUSSTRING_OFFSET UNITYSDK_OFFSET(0x19429D70)
#define SYSTEM_NET_NETRES__CTOR_OFFSET UNITYSDK_OFFSET(0x19429D60)
