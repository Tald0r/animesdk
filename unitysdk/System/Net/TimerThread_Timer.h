...
#define SYSTEM_NET_TIMERTHREAD_TIMER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x195DB620)
#define SYSTEM_NET_TIMERTHREAD_TIMER_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x195DB520)
#define SYSTEM_NET_TIMERTHREAD_TIMER_GET_EXPIRATION_OFFSET UNITYSDK_OFFSET(0x195DB540)
#define SYSTEM_NET_TIMERTHREAD_TIMER_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x195DB530)
#define SYSTEM_NET_TIMERTHREAD_TIMER_GET_TIMEREMAINING_OFFSET UNITYSDK_OFFSET(0x195DB550)
#define SYSTEM_NET_TIMERTHREAD_TIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x195DB4D0)
