...
#define SYSTEM_NET_PROXYCHAIN_PROXYENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x187E1E90)
#define SYSTEM_NET_PROXYCHAIN_PROXYENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x187E1B20)
#define SYSTEM_NET_PROXYCHAIN_PROXYENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x187E1BD0)
#define SYSTEM_NET_PROXYCHAIN_PROXYENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x187E1E80)
#define SYSTEM_NET_PROXYCHAIN_PROXYENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x187E1BC0)
#define SYSTEM_NET_PROXYCHAIN_PROXYENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x187E1990)
