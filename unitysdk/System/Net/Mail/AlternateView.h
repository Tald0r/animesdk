...
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_CREATEALTERNATEVIEWFROMSTRING_1_OFFSET UNITYSDK_OFFSET(0x197EA220)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_CREATEALTERNATEVIEWFROMSTRING_2_OFFSET UNITYSDK_OFFSET(0x197EA4E0)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_CREATEALTERNATEVIEWFROMSTRING_OFFSET UNITYSDK_OFFSET(0x197EA010)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0x197EA7B0)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x197E9FE0)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_GET_LINKEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x197EA000)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_SET_BASEURI_OFFSET UNITYSDK_OFFSET(0x197E9FF0)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197E9CE0)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW__CTOR_2_OFFSET UNITYSDK_OFFSET(0x197E9D90)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW__CTOR_3_OFFSET UNITYSDK_OFFSET(0x197E9E40)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW__CTOR_4_OFFSET UNITYSDK_OFFSET(0x197E9EC0)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW__CTOR_5_OFFSET UNITYSDK_OFFSET(0x197E9F50)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x197E9C30)
