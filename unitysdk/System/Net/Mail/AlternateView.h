...
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_CREATEALTERNATEVIEWFROMSTRING_1_OFFSET UNITYSDK_OFFSET(0x19D29590)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_CREATEALTERNATEVIEWFROMSTRING_2_OFFSET UNITYSDK_OFFSET(0x19D29850)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_CREATEALTERNATEVIEWFROMSTRING_OFFSET UNITYSDK_OFFSET(0x19D29380)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19D29B20)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_GET_BASEURI_OFFSET UNITYSDK_OFFSET(0x19D29350)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_GET_LINKEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x19D29370)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW_SET_BASEURI_OFFSET UNITYSDK_OFFSET(0x19D29360)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D29050)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19D29100)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19D291B0)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19D29230)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19D292C0)
#define SYSTEM_NET_MAIL_ALTERNATEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D28FA0)
