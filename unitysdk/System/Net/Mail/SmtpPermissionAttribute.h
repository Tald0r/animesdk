...
#define SYSTEM_NET_MAIL_SMTPPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x19D79350)
#define SYSTEM_NET_MAIL_SMTPPERMISSIONATTRIBUTE_GET_ACCESS_OFFSET UNITYSDK_OFFSET(0x19D792D0)
#define SYSTEM_NET_MAIL_SMTPPERMISSIONATTRIBUTE_SET_ACCESS_OFFSET UNITYSDK_OFFSET(0x19D79310)
#define SYSTEM_NET_MAIL_SMTPPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D792C0)
