...
#define SYSTEM_NET_MAIL_MAILADDRESSCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x182DD8B0)
#define SYSTEM_NET_MAIL_MAILADDRESSCOLLECTION_INSERTITEM_OFFSET UNITYSDK_OFFSET(0x182DDA40)
#define SYSTEM_NET_MAIL_MAILADDRESSCOLLECTION_SETITEM_OFFSET UNITYSDK_OFFSET(0x182DDAC0)
#define SYSTEM_NET_MAIL_MAILADDRESSCOLLECTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x182DDB40)
#define SYSTEM_NET_MAIL_MAILADDRESSCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x182DDDE0)
