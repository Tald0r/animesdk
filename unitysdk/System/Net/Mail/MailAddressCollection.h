...
#define SYSTEM_NET_MAIL_MAILADDRESSCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x188F25D0)
#define SYSTEM_NET_MAIL_MAILADDRESSCOLLECTION_INSERTITEM_OFFSET UNITYSDK_OFFSET(0x188F2760)
#define SYSTEM_NET_MAIL_MAILADDRESSCOLLECTION_SETITEM_OFFSET UNITYSDK_OFFSET(0x188F27E0)
#define SYSTEM_NET_MAIL_MAILADDRESSCOLLECTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x188F2860)
#define SYSTEM_NET_MAIL_MAILADDRESSCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188F2B00)
