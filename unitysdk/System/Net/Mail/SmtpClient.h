...
#define SYSTEM_NET_MAIL_SMTPCLIENT_ADDPRIORITYHEADER_OFFSET UNITYSDK_OFFSET(0x18B79BB0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_ADD_SENDCOMPLETED_OFFSET UNITYSDK_OFFSET(0x18B75CC0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_AUTHENTICATE_1_OFFSET UNITYSDK_OFFSET(0x18B7D970)
#define SYSTEM_NET_MAIL_SMTPCLIENT_AUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x18B7A7E0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_CHECKCANCELLATION_OFFSET UNITYSDK_OFFSET(0x18B77100)
#define SYSTEM_NET_MAIL_SMTPCLIENT_CHECKSTATE_OFFSET UNITYSDK_OFFSET(0x18B756E0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_CHECKSTATUS_OFFSET UNITYSDK_OFFSET(0x18B7E030)
#define SYSTEM_NET_MAIL_SMTPCLIENT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18B75DD0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18B75DC0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_ENCODEADDRESSES_OFFSET UNITYSDK_OFFSET(0x18B76080)
#define SYSTEM_NET_MAIL_SMTPCLIENT_ENCODEADDRESS_OFFSET UNITYSDK_OFFSET(0x18B75DE0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_ENCODEBODY_1_OFFSET UNITYSDK_OFFSET(0x18B765E0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_ENCODEBODY_OFFSET UNITYSDK_OFFSET(0x18B76430)
#define SYSTEM_NET_MAIL_SMTPCLIENT_ENCODESUBJECTRFC2047_OFFSET UNITYSDK_OFFSET(0x18B763C0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_ENDSECTION_OFFSET UNITYSDK_OFFSET(0x18B76C20)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GENERATEBOUNDARY_1_OFFSET UNITYSDK_OFFSET(0x18B76FB0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GENERATEBOUNDARY_OFFSET UNITYSDK_OFFSET(0x18B76F00)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GETTRANSFERENCODINGNAME_OFFSET UNITYSDK_OFFSET(0x18B7B3A0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x18B755A0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18B75660)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GET_DELIVERYFORMAT_OFFSET UNITYSDK_OFFSET(0x18B75A50)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GET_DELIVERYMETHOD_OFFSET UNITYSDK_OFFSET(0x18B75750)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GET_ENABLESSL_OFFSET UNITYSDK_OFFSET(0x18B757D0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GET_HOST_OFFSET UNITYSDK_OFFSET(0x18B75850)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GET_PICKUPDIRECTORYLOCATION_OFFSET UNITYSDK_OFFSET(0x18B75960)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GET_PORT_OFFSET UNITYSDK_OFFSET(0x18B75980)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GET_SERVICEPOINT_OFFSET UNITYSDK_OFFSET(0x18B75AD0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GET_TARGETNAME_OFFSET UNITYSDK_OFFSET(0x18B75640)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x18B75B20)
#define SYSTEM_NET_MAIL_SMTPCLIENT_GET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18B75BF0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_INITIATESECURECONNECTION_OFFSET UNITYSDK_OFFSET(0x18B7A430)
#define SYSTEM_NET_MAIL_SMTPCLIENT_ISERROR_OFFSET UNITYSDK_OFFSET(0x18B77050)
#define SYSTEM_NET_MAIL_SMTPCLIENT_ONSENDCOMPLETED_OFFSET UNITYSDK_OFFSET(0x18B77060)
#define SYSTEM_NET_MAIL_SMTPCLIENT_PARSEEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x18B77410)
#define SYSTEM_NET_MAIL_SMTPCLIENT_READ_OFFSET UNITYSDK_OFFSET(0x18B77170)
#define SYSTEM_NET_MAIL_SMTPCLIENT_REMOVE_SENDCOMPLETED_OFFSET UNITYSDK_OFFSET(0x18B75D40)
#define SYSTEM_NET_MAIL_SMTPCLIENT_RESETEXTENSIONS_OFFSET UNITYSDK_OFFSET(0x18B77400)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDASYNCCANCEL_OFFSET UNITYSDK_OFFSET(0x18B7AFE0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDASYNC_1_OFFSET UNITYSDK_OFFSET(0x18B7AF50)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x18B7AC10)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x18B7C6D0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDBODYLESSSINGLEALTERNATE_OFFSET UNITYSDK_OFFSET(0x18B7B3F0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDBODYWITHALTERNATEVIEWS_OFFSET UNITYSDK_OFFSET(0x18B7B610)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDCOMMAND_OFFSET UNITYSDK_OFFSET(0x18B7A3A0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDCORE_OFFSET UNITYSDK_OFFSET(0x18B784D0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDDATA_OFFSET UNITYSDK_OFFSET(0x18B76CA0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDDOT_OFFSET UNITYSDK_OFFSET(0x18B7A9D0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDHEADER_OFFSET UNITYSDK_OFFSET(0x18B79B30)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDINTERNAL_OFFSET UNITYSDK_OFFSET(0x18B78200)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDLINKEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x18B7D0A0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDMAILASYNCCOMPLETEDHANDLER_OFFSET UNITYSDK_OFFSET(0x18B7ADF0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDMAILASYNC_1_OFFSET UNITYSDK_OFFSET(0x18B7AD70)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDMAILASYNC_OFFSET UNITYSDK_OFFSET(0x18B7AAC0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDSIMPLEBODY_OFFSET UNITYSDK_OFFSET(0x18B7B0B0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDTOFILE_OFFSET UNITYSDK_OFFSET(0x18B77A00)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDWITHATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x18B79E70)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SENDWITHOUTATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x18B7A2B0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SEND_1_OFFSET UNITYSDK_OFFSET(0x18B7AA40)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SEND_OFFSET UNITYSDK_OFFSET(0x18B776D0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18B75670)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SET_DELIVERYFORMAT_OFFSET UNITYSDK_OFFSET(0x18B75A60)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SET_DELIVERYMETHOD_OFFSET UNITYSDK_OFFSET(0x18B75760)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SET_ENABLESSL_OFFSET UNITYSDK_OFFSET(0x18B757E0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SET_HOST_OFFSET UNITYSDK_OFFSET(0x18B75860)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SET_PICKUPDIRECTORYLOCATION_OFFSET UNITYSDK_OFFSET(0x18B75970)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SET_PORT_OFFSET UNITYSDK_OFFSET(0x18B75990)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SET_TARGETNAME_OFFSET UNITYSDK_OFFSET(0x18B75650)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x18B75B30)
#define SYSTEM_NET_MAIL_SMTPCLIENT_SET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18B75C00)
#define SYSTEM_NET_MAIL_SMTPCLIENT_STARTSECTION_1_OFFSET UNITYSDK_OFFSET(0x18B7CDE0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_STARTSECTION_2_OFFSET UNITYSDK_OFFSET(0x18B7D5C0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_STARTSECTION_OFFSET UNITYSDK_OFFSET(0x18B7CC70)
#define SYSTEM_NET_MAIL_SMTPCLIENT_THROWIFERROR_OFFSET UNITYSDK_OFFSET(0x18B7E0A0)
#define SYSTEM_NET_MAIL_SMTPCLIENT_TOQUOTEDPRINTABLE_1_OFFSET UNITYSDK_OFFSET(0x18B76770)
#define SYSTEM_NET_MAIL_SMTPCLIENT_TOQUOTEDPRINTABLE_OFFSET UNITYSDK_OFFSET(0x18B765B0)
#define SYSTEM_NET_MAIL_SMTPCLIENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B75520)
#define SYSTEM_NET_MAIL_SMTPCLIENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18B75490)
#define SYSTEM_NET_MAIL_SMTPCLIENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B75420)
...
namespace System::Net::Mail
{
	...
	{
	public:
		::System::Threading::Mutex* mutex; // 0x10
		::System::IO::Stream* stream; // 0x18
		::System::String* _TargetName_k__BackingField; // 0x20
		::System::Net::Mail::SendCompletedEventHandler* SendCompleted; // 0x28
		::System::String* pickupDirectoryLocation; // 0x30
		::System::Object* user_async_state; // 0x38
		::System::Security::Cryptography::X509Certificates::X509CertificateCollection* clientCertificates; // 0x40
		::System::IO::StreamWriter* writer; // 0x48
		::System::IO::StreamReader* reader; // 0x50
		::System::ComponentModel::BackgroundWorker* worker; // 0x58
		::System::Net::Mail::MailAddress* defaultFrom; // 0x60
		::System::String* host; // 0x68
		::System::Net::ICredentialsByHost* credentials; // 0x70
		::System::Net::Mail::MailMessage* messageInProcess; // 0x78
		::System::Net::Sockets::TcpClient* client; // 0x80
		::System::Net::Mail::SmtpClient_AuthMechs authMechs; // 0x88
		::System::Int32 port; // 0x8C
		::System::Int32 timeout; // 0x90
		::System::Net::Mail::SmtpDeliveryFormat deliveryFormat; // 0x94
		::System::Boolean enableSsl; // 0x98
		::System::Int32 boundaryIndex; // 0x9C
		::System::Net::Mail::SmtpDeliveryMethod deliveryMethod; // 0xA0
