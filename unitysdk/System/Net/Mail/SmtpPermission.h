...
#define SYSTEM_NET_MAIL_SMTPPERMISSION_ADDPERMISSION_OFFSET UNITYSDK_OFFSET(0x19D29EF0)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x19D29F30)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x19D29F70)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_GET_ACCESS_OFFSET UNITYSDK_OFFSET(0x19D29EB0)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x19D29FB0)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x19D29FF0)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x19D2A030)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x19D2A070)
#define SYSTEM_NET_MAIL_SMTPPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D29E30)
#define SYSTEM_NET_MAIL_SMTPPERMISSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19D29E70)
#define SYSTEM_NET_MAIL_SMTPPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19D29DF0)
