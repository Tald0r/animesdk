...
#define SYSTEM_NET_MAIL_SMTPPERMISSION_ADDPERMISSION_OFFSET UNITYSDK_OFFSET(0x197EAB80)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x197EABC0)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x197EAC00)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_GET_ACCESS_OFFSET UNITYSDK_OFFSET(0x197EAB40)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x197EAC40)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x197EAC80)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x197EACC0)
#define SYSTEM_NET_MAIL_SMTPPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x197EAD00)
#define SYSTEM_NET_MAIL_SMTPPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197EAAC0)
#define SYSTEM_NET_MAIL_SMTPPERMISSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x197EAB00)
#define SYSTEM_NET_MAIL_SMTPPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x197EAA80)
