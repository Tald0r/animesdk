...
#define SYSTEM_NET_MAIL_ATTACHMENTCOLLECTION_CLEARITEMS_OFFSET UNITYSDK_OFFSET(0x1A5F6A20)
#define SYSTEM_NET_MAIL_ATTACHMENTCOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A5F6990)
#define SYSTEM_NET_MAIL_ATTACHMENTCOLLECTION_INSERTITEM_OFFSET UNITYSDK_OFFSET(0x1A5F6A60)
#define SYSTEM_NET_MAIL_ATTACHMENTCOLLECTION_REMOVEITEM_OFFSET UNITYSDK_OFFSET(0x1A5F6AB0)
#define SYSTEM_NET_MAIL_ATTACHMENTCOLLECTION_SETITEM_OFFSET UNITYSDK_OFFSET(0x1A5F6AF0)
#define SYSTEM_NET_MAIL_ATTACHMENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F6950)
