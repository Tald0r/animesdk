...
#define SYSTEM_NET_MAIL_SMTPEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x193AE1A0)
#define SYSTEM_NET_MAIL_SMTPEXCEPTION_GET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x193AE180)
#define SYSTEM_NET_MAIL_SMTPEXCEPTION_SET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x193AE190)
#define SYSTEM_NET_MAIL_SMTPEXCEPTION_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x193AE290)
#define SYSTEM_NET_MAIL_SMTPEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193ADD90)
#define SYSTEM_NET_MAIL_SMTPEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x193ADEA0)
#define SYSTEM_NET_MAIL_SMTPEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x193ADF10)
#define SYSTEM_NET_MAIL_SMTPEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x193ADE30)
#define SYSTEM_NET_MAIL_SMTPEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x193AE110)
#define SYSTEM_NET_MAIL_SMTPEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x193ADCF0)
