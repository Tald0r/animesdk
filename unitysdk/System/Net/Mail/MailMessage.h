...
#define SYSTEM_NET_MAIL_MAILMESSAGE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x195CF8E0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x195CF860)
#define SYSTEM_NET_MAIL_MAILMESSAGE_ENCODESUBJECTRFC2047_OFFSET UNITYSDK_OFFSET(0x195CFC00)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_ALTERNATEVIEWS_OFFSET UNITYSDK_OFFSET(0x195CF120)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_ATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x195CF130)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BCC_OFFSET UNITYSDK_OFFSET(0x195CF140)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BODYCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x195CF200)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BODYENCODING_OFFSET UNITYSDK_OFFSET(0x195CF570)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BODYTRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x195CF590)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BODY_OFFSET UNITYSDK_OFFSET(0x195CF150)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_CC_OFFSET UNITYSDK_OFFSET(0x195CF640)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_CONTENTTRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x195CF310)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_DELIVERYNOTIFICATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x195CF650)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_FROM_OFFSET UNITYSDK_OFFSET(0x195CF670)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_HEADERSENCODING_OFFSET UNITYSDK_OFFSET(0x195CF6E0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x195CF690)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_ISBODYHTML_OFFSET UNITYSDK_OFFSET(0x195CF6A0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x195CF6C0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_REPLYTOLIST_OFFSET UNITYSDK_OFFSET(0x195CF700)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_REPLYTO_OFFSET UNITYSDK_OFFSET(0x195CF710)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_SENDER_OFFSET UNITYSDK_OFFSET(0x195CF800)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_SUBJECTENCODING_OFFSET UNITYSDK_OFFSET(0x195CF830)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_SUBJECT_OFFSET UNITYSDK_OFFSET(0x195CF820)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_TO_OFFSET UNITYSDK_OFFSET(0x195CF850)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_UTF8UNMARKED_OFFSET UNITYSDK_OFFSET(0x195CF8F0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GUESSENCODING_OFFSET UNITYSDK_OFFSET(0x195CF160)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GUESSTRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x195CF370)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_BODYENCODING_OFFSET UNITYSDK_OFFSET(0x195CF580)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_BODYTRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x195CF5F0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_BODY_OFFSET UNITYSDK_OFFSET(0x195CEF70)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_DELIVERYNOTIFICATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x195CF660)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_FROM_OFFSET UNITYSDK_OFFSET(0x195CF680)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_HEADERSENCODING_OFFSET UNITYSDK_OFFSET(0x195CF6F0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_ISBODYHTML_OFFSET UNITYSDK_OFFSET(0x195CF6B0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x195CF6D0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_REPLYTO_OFFSET UNITYSDK_OFFSET(0x195CF790)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_SENDER_OFFSET UNITYSDK_OFFSET(0x195CF810)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_SUBJECTENCODING_OFFSET UNITYSDK_OFFSET(0x195CF840)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_SUBJECT_OFFSET UNITYSDK_OFFSET(0x195CF090)
#define SYSTEM_NET_MAIL_MAILMESSAGE_TO2047_OFFSET UNITYSDK_OFFSET(0x195CF9F0)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x195CFE50)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195CE800)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x195CE8A0)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x195CEBB0)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x195CE520)
...
namespace System::Net::Mail
{
	...
	public:
		...
		::System::Text::Encoding* bodyEncoding; // 0x18
		::System::Net::Mail::AttachmentCollection* attachments; // 0x20
		::System::String* subject; // 0x28
		::System::Net::Mail::MailAddressCollection* bcc; // 0x30
		::System::String* body; // 0x38
		::System::Net::Mail::AlternateViewCollection* alternateViews; // 0x40
		::System::Net::Mail::MailAddressCollection* to; // 0x48
		::System::Collections::Specialized::NameValueCollection* headers; // 0x50
		::System::Net::Mail::MailAddress* from; // 0x58
		::System::Net::Mail::MailAddress* sender; // 0x60
		::System::Text::Encoding* subjectEncoding; // 0x68
		::System::Net::Mail::MailAddressCollection* cc; // 0x70
		::System::Text::Encoding* headersEncoding; // 0x78
		::System::Net::Mail::DeliveryNotificationOptions deliveryNotificationOptions; // 0x80
		::System::Boolean isHtml; // 0x84
		::System::Net::Mail::MailPriority priority; // 0x88
