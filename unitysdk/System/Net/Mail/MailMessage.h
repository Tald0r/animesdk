...
#define SYSTEM_NET_MAIL_MAILMESSAGE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x191D3550)
#define SYSTEM_NET_MAIL_MAILMESSAGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x191D34D0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_ENCODESUBJECTRFC2047_OFFSET UNITYSDK_OFFSET(0x191D3870)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_ALTERNATEVIEWS_OFFSET UNITYSDK_OFFSET(0x191D2D90)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_ATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x191D2DA0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BCC_OFFSET UNITYSDK_OFFSET(0x191D2DB0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BODYCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x191D2E70)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BODYENCODING_OFFSET UNITYSDK_OFFSET(0x191D31E0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BODYTRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x191D3200)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_BODY_OFFSET UNITYSDK_OFFSET(0x191D2DC0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_CC_OFFSET UNITYSDK_OFFSET(0x191D32B0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_CONTENTTRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x191D2F80)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_DELIVERYNOTIFICATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x191D32C0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_FROM_OFFSET UNITYSDK_OFFSET(0x191D32E0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_HEADERSENCODING_OFFSET UNITYSDK_OFFSET(0x191D3350)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x191D3300)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_ISBODYHTML_OFFSET UNITYSDK_OFFSET(0x191D3310)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x191D3330)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_REPLYTOLIST_OFFSET UNITYSDK_OFFSET(0x191D3370)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_REPLYTO_OFFSET UNITYSDK_OFFSET(0x191D3380)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_SENDER_OFFSET UNITYSDK_OFFSET(0x191D3470)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_SUBJECTENCODING_OFFSET UNITYSDK_OFFSET(0x191D34A0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_SUBJECT_OFFSET UNITYSDK_OFFSET(0x191D3490)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_TO_OFFSET UNITYSDK_OFFSET(0x191D34C0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GET_UTF8UNMARKED_OFFSET UNITYSDK_OFFSET(0x191D3560)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GUESSENCODING_OFFSET UNITYSDK_OFFSET(0x191D2DD0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_GUESSTRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x191D2FE0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_BODYENCODING_OFFSET UNITYSDK_OFFSET(0x191D31F0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_BODYTRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x191D3260)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_BODY_OFFSET UNITYSDK_OFFSET(0x191D2BE0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_DELIVERYNOTIFICATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x191D32D0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_FROM_OFFSET UNITYSDK_OFFSET(0x191D32F0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_HEADERSENCODING_OFFSET UNITYSDK_OFFSET(0x191D3360)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_ISBODYHTML_OFFSET UNITYSDK_OFFSET(0x191D3320)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x191D3340)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_REPLYTO_OFFSET UNITYSDK_OFFSET(0x191D3400)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_SENDER_OFFSET UNITYSDK_OFFSET(0x191D3480)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_SUBJECTENCODING_OFFSET UNITYSDK_OFFSET(0x191D34B0)
#define SYSTEM_NET_MAIL_MAILMESSAGE_SET_SUBJECT_OFFSET UNITYSDK_OFFSET(0x191D2D00)
#define SYSTEM_NET_MAIL_MAILMESSAGE_TO2047_OFFSET UNITYSDK_OFFSET(0x191D3660)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x191D3AC0)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191D2470)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191D2510)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x191D2820)
#define SYSTEM_NET_MAIL_MAILMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x191D2190)
...
namespace System::Net::Mail
{
	...
	public:
		...
		::System::Net::Mail::AttachmentCollection* attachments; // 0x10
		::System::Net::Mail::MailAddress* sender; // 0x18
		::System::Text::Encoding* bodyEncoding; // 0x20
		::System::Text::Encoding* headersEncoding; // 0x28
		::System::Net::Mail::AlternateViewCollection* alternateViews; // 0x30
		::System::Text::Encoding* subjectEncoding; // 0x38
		::System::Net::Mail::MailAddressCollection* bcc; // 0x40
		::System::String* body; // 0x48
		::System::Net::Mail::MailAddressCollection* replyTo; // 0x50
		::System::Net::Mail::MailAddress* from; // 0x58
		::System::String* subject; // 0x60
		::System::Collections::Specialized::NameValueCollection* headers; // 0x68
		::System::Net::Mail::MailAddressCollection* to; // 0x70
		::System::Net::Mail::MailAddressCollection* cc; // 0x78
