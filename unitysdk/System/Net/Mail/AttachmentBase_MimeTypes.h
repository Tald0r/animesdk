...
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_MIMETYPES_GETMIMETYPE_OFFSET UNITYSDK_OFFSET(0x191CC630)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_MIMETYPES__CCTOR_OFFSET UNITYSDK_OFFSET(0x191C6A60)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_MIMETYPES__CTOR_OFFSET UNITYSDK_OFFSET(0x191CC710)
