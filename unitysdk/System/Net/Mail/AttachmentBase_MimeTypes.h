...
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_MIMETYPES_GETMIMETYPE_OFFSET UNITYSDK_OFFSET(0x18D83950)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_MIMETYPES__CCTOR_OFFSET UNITYSDK_OFFSET(0x18D7DD80)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_MIMETYPES__CTOR_OFFSET UNITYSDK_OFFSET(0x18D83A30)
