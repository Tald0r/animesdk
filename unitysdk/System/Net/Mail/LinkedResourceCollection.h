...
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_CLEARITEMS_OFFSET UNITYSDK_OFFSET(0x18D83B10)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18D83B00)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18D83A80)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_INSERTITEM_OFFSET UNITYSDK_OFFSET(0x18D83B50)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_REMOVEITEM_OFFSET UNITYSDK_OFFSET(0x18D83BA0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_SETITEM_OFFSET UNITYSDK_OFFSET(0x18D83BE0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18D83A40)
