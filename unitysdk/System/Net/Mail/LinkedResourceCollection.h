...
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_CLEARITEMS_OFFSET UNITYSDK_OFFSET(0x191CC7F0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x191CC7E0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x191CC760)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_INSERTITEM_OFFSET UNITYSDK_OFFSET(0x191CC830)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_REMOVEITEM_OFFSET UNITYSDK_OFFSET(0x191CC880)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION_SETITEM_OFFSET UNITYSDK_OFFSET(0x191CC8C0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x191CC720)
