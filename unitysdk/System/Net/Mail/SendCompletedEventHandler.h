...
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18F576F0)
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18F57730)
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18F57170)
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18F57160)
