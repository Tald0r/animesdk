...
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19327890)
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x193278D0)
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19327310)
#define SYSTEM_NET_MAIL_SENDCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x193272F0)
