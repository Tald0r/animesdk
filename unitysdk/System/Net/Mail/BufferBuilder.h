...
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_1_OFFSET UNITYSDK_OFFSET(0x18F56B60)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_2_OFFSET UNITYSDK_OFFSET(0x18F56BF0)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_3_OFFSET UNITYSDK_OFFSET(0x18F56C80)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_4_OFFSET UNITYSDK_OFFSET(0x18F56CA0)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_5_OFFSET UNITYSDK_OFFSET(0x18F56DE0)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_6_OFFSET UNITYSDK_OFFSET(0x18F56F30)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_OFFSET UNITYSDK_OFFSET(0x18F56AC0)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_ENSUREBUFFER_OFFSET UNITYSDK_OFFSET(0x18F56A60)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x18F57140)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x18F57130)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_RESET_OFFSET UNITYSDK_OFFSET(0x18F57150)
#define SYSTEM_NET_MAIL_BUFFERBUILDER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F56A40)
#define SYSTEM_NET_MAIL_BUFFERBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18F56A10)
