...
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_1_OFFSET UNITYSDK_OFFSET(0x19326CF0)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_2_OFFSET UNITYSDK_OFFSET(0x19326D80)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_3_OFFSET UNITYSDK_OFFSET(0x19326E10)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_4_OFFSET UNITYSDK_OFFSET(0x19326E30)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_5_OFFSET UNITYSDK_OFFSET(0x19326F70)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_6_OFFSET UNITYSDK_OFFSET(0x193270C0)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_APPEND_OFFSET UNITYSDK_OFFSET(0x19326C50)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_ENSUREBUFFER_OFFSET UNITYSDK_OFFSET(0x19326BF0)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x193272D0)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x193272C0)
#define SYSTEM_NET_MAIL_BUFFERBUILDER_RESET_OFFSET UNITYSDK_OFFSET(0x193272E0)
#define SYSTEM_NET_MAIL_BUFFERBUILDER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19326BD0)
#define SYSTEM_NET_MAIL_BUFFERBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19326BA0)
