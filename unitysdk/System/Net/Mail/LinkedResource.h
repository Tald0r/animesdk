...
#define SYSTEM_NET_MAIL_LINKEDRESOURCE_CREATELINKEDRESOURCEFROMSTRING_1_OFFSET UNITYSDK_OFFSET(0x195CE1B0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE_CREATELINKEDRESOURCEFROMSTRING_2_OFFSET UNITYSDK_OFFSET(0x195CE3A0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE_CREATELINKEDRESOURCEFROMSTRING_OFFSET UNITYSDK_OFFSET(0x195CDFC0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE_GET_CONTENTLINK_OFFSET UNITYSDK_OFFSET(0x195CDFA0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE_SET_CONTENTLINK_OFFSET UNITYSDK_OFFSET(0x195CDFB0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195CDD70)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x195CDDE0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x195CDE50)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x195CDEC0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x195CDF30)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x195CDD00)
