...
#define SYSTEM_NET_MAIL_LINKEDRESOURCE_CREATELINKEDRESOURCEFROMSTRING_1_OFFSET UNITYSDK_OFFSET(0x191D1E20)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE_CREATELINKEDRESOURCEFROMSTRING_2_OFFSET UNITYSDK_OFFSET(0x191D2010)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE_CREATELINKEDRESOURCEFROMSTRING_OFFSET UNITYSDK_OFFSET(0x191D1C30)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE_GET_CONTENTLINK_OFFSET UNITYSDK_OFFSET(0x191D1C10)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE_SET_CONTENTLINK_OFFSET UNITYSDK_OFFSET(0x191D1C20)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191D19E0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191D1A50)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x191D1AC0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x191D1B30)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x191D1BA0)
#define SYSTEM_NET_MAIL_LINKEDRESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x191D1970)
