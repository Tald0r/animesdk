...
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19384470)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19384450)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x19384380)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_GET_CONTENTSTREAM_OFFSET UNITYSDK_OFFSET(0x19384400)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x19384410)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_GET_TRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x19384430)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_SET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x19384390)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x19384420)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_SET_TRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x19384440)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19383DA0)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19383E90)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19383F80)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x193840F0)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19384230)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19383C80)
