...
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18FF2F50)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18FF2F30)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x18FF2E60)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_GET_CONTENTSTREAM_OFFSET UNITYSDK_OFFSET(0x18FF2EE0)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x18FF2EF0)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_GET_TRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x18FF2F10)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_SET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x18FF2E70)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x18FF2F00)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE_SET_TRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x18FF2F20)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FF2880)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FF2970)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18FF2A60)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18FF2BD0)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x18FF2D10)
#define SYSTEM_NET_MAIL_ATTACHMENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF2760)
