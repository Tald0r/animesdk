...
#define SYSTEM_NET_MAIL_ATTACHMENT_CREATEATTACHMENTFROMSTRING_1_OFFSET UNITYSDK_OFFSET(0x19B277C0)
#define SYSTEM_NET_MAIL_ATTACHMENT_CREATEATTACHMENTFROMSTRING_2_OFFSET UNITYSDK_OFFSET(0x19B27B10)
#define SYSTEM_NET_MAIL_ATTACHMENT_CREATEATTACHMENTFROMSTRING_OFFSET UNITYSDK_OFFSET(0x19B275D0)
#define SYSTEM_NET_MAIL_ATTACHMENT_GET_CONTENTDISPOSITION_OFFSET UNITYSDK_OFFSET(0x19B27290)
#define SYSTEM_NET_MAIL_ATTACHMENT_GET_NAMEENCODING_OFFSET UNITYSDK_OFFSET(0x19B275B0)
#define SYSTEM_NET_MAIL_ATTACHMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19B272A0)
#define SYSTEM_NET_MAIL_ATTACHMENT_INITNAME_OFFSET UNITYSDK_OFFSET(0x19B26EC0)
#define SYSTEM_NET_MAIL_ATTACHMENT_SET_NAMEENCODING_OFFSET UNITYSDK_OFFSET(0x19B275C0)
#define SYSTEM_NET_MAIL_ATTACHMENT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19B271C0)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B26F50)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19B26FF0)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19B27090)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19B27120)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19B271E0)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B26E30)
