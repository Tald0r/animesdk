...
#define SYSTEM_NET_MAIL_ATTACHMENT_CREATEATTACHMENTFROMSTRING_1_OFFSET UNITYSDK_OFFSET(0x19688DF0)
#define SYSTEM_NET_MAIL_ATTACHMENT_CREATEATTACHMENTFROMSTRING_2_OFFSET UNITYSDK_OFFSET(0x19689140)
#define SYSTEM_NET_MAIL_ATTACHMENT_CREATEATTACHMENTFROMSTRING_OFFSET UNITYSDK_OFFSET(0x19688C00)
#define SYSTEM_NET_MAIL_ATTACHMENT_GET_CONTENTDISPOSITION_OFFSET UNITYSDK_OFFSET(0x196888C0)
#define SYSTEM_NET_MAIL_ATTACHMENT_GET_NAMEENCODING_OFFSET UNITYSDK_OFFSET(0x19688BE0)
#define SYSTEM_NET_MAIL_ATTACHMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x196888D0)
#define SYSTEM_NET_MAIL_ATTACHMENT_INITNAME_OFFSET UNITYSDK_OFFSET(0x196884F0)
#define SYSTEM_NET_MAIL_ATTACHMENT_SET_NAMEENCODING_OFFSET UNITYSDK_OFFSET(0x19688BF0)
#define SYSTEM_NET_MAIL_ATTACHMENT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x196887F0)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19688580)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19688620)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x196886C0)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19688750)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19688810)
#define SYSTEM_NET_MAIL_ATTACHMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19688460)
