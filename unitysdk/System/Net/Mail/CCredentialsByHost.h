...
#define SYSTEM_NET_MAIL_CCREDENTIALSBYHOST_GETCREDENTIAL_OFFSET UNITYSDK_OFFSET(0x18FC1900)
#define SYSTEM_NET_MAIL_CCREDENTIALSBYHOST__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC18F0)
