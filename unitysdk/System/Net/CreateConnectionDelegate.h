...
#define SYSTEM_NET_CREATECONNECTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19422EE0)
#define SYSTEM_NET_CREATECONNECTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19422F10)
#define SYSTEM_NET_CREATECONNECTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x194229A0)
#define SYSTEM_NET_CREATECONNECTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19422980)
