...
#define SYSTEM_NET_CREATECONNECTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1900D050)
#define SYSTEM_NET_CREATECONNECTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1900D080)
#define SYSTEM_NET_CREATECONNECTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1900CB10)
#define SYSTEM_NET_CREATECONNECTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1900CB00)
