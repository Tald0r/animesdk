...
#define SYSTEM_NET_CACHEDTRANSPORTCONTEXT_GETCHANNELBINDING_OFFSET UNITYSDK_OFFSET(0x19420DF0)
#define SYSTEM_NET_CACHEDTRANSPORTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19420DE0)
