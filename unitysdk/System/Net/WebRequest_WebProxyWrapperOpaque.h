...
#define SYSTEM_NET_WEBREQUEST_WEBPROXYWRAPPEROPAQUE_GETPROXIES_OFFSET UNITYSDK_OFFSET(0x1A33DC10)
#define SYSTEM_NET_WEBREQUEST_WEBPROXYWRAPPEROPAQUE_GETPROXY_OFFSET UNITYSDK_OFFSET(0x1A33DB90)
#define SYSTEM_NET_WEBREQUEST_WEBPROXYWRAPPEROPAQUE_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1A33DBD0)
#define SYSTEM_NET_WEBREQUEST_WEBPROXYWRAPPEROPAQUE_ISBYPASSED_OFFSET UNITYSDK_OFFSET(0x1A33DBB0)
#define SYSTEM_NET_WEBREQUEST_WEBPROXYWRAPPEROPAQUE_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1A33DBF0)
#define SYSTEM_NET_WEBREQUEST_WEBPROXYWRAPPEROPAQUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A33DB80)
