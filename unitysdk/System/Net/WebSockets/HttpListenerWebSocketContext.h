...
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_COPYPRINCIPAL_OFFSET UNITYSDK_OFFSET(0x182F5AA0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_COOKIECOLLECTION_OFFSET UNITYSDK_OFFSET(0x182F5CB0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x182F5C60)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_ISAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x182F5CD0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_ISLOCAL_OFFSET UNITYSDK_OFFSET(0x182F5CE0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_ISSECURECONNECTION_OFFSET UNITYSDK_OFFSET(0x182F5CF0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x182F5C70)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_REQUESTURI_OFFSET UNITYSDK_OFFSET(0x182F5C50)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_SECWEBSOCKETKEY_OFFSET UNITYSDK_OFFSET(0x182F5CA0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_SECWEBSOCKETPROTOCOLS_OFFSET UNITYSDK_OFFSET(0x182F5C80)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_SECWEBSOCKETVERSION_OFFSET UNITYSDK_OFFSET(0x182F5C90)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_USER_OFFSET UNITYSDK_OFFSET(0x182F5CC0)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT_GET_WEBSOCKET_OFFSET UNITYSDK_OFFSET(0x182F5D00)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x182F5D10)
#define SYSTEM_NET_WEBSOCKETS_HTTPLISTENERWEBSOCKETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x182F58F0)
...
namespace System::Net::WebSockets
{
	...
	{
	public:
		::System::Collections::Specialized::NameValueCollection* _headers; // 0x10
		::System::String* _secWebSocketVersion; // 0x18
		::System::Net::WebSockets::WebSocket* _webSocket; // 0x20
		::System::Security::Principal::IPrincipal* _user; // 0x28
		::System::String* _origin; // 0x30
		::System::Collections::Generic::IEnumerable_1<::System::String*>* _secWebSocketProtocols; // 0x38
		::System::Uri* _requestUri; // 0x40
		::System::String* _secWebSocketKey; // 0x48
		::System::Net::CookieCollection* _cookieCollection; // 0x50
		::System::Boolean _isAuthenticated; // 0x58
