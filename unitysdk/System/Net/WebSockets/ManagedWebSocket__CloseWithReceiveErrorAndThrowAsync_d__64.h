...
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__CLOSEWITHRECEIVEERRORANDTHROWASYNC_D__64_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x849710)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__CLOSEWITHRECEIVEERRORANDTHROWASYNC_D__64_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x324FD0)
...
namespace System::Net::WebSockets
{
	...
	struct alignas(8) ManagedWebSocket__CloseWithReceiveErrorAndThrowAsync_d__64
	{
		...
		::System::Exception* innerException; // 0x48
