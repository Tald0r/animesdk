...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_ABORT_OFFSET UNITYSDK_OFFSET(0x19D37DC0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_BUILDREQUESTHEADER_OFFSET UNITYSDK_OFFSET(0x19D381A0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CHECKPLATFORMSUPPORT_OFFSET UNITYSDK_OFFSET(0x19D37D90)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CLOSEASYNC_OFFSET UNITYSDK_OFFSET(0x19D37E90)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CLOSEOUTPUTASYNC_OFFSET UNITYSDK_OFFSET(0x19D37EC0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CONNECTASYNCCORE_OFFSET UNITYSDK_OFFSET(0x19D37EF0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CONNECTSOCKETASYNC_OFFSET UNITYSDK_OFFSET(0x19D38080)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CREATESECKEYANDSECWEBSOCKETACCEPT_OFFSET UNITYSDK_OFFSET(0x19D38910)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_CREATE_OFFSET UNITYSDK_OFFSET(0x19D37C50)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19D37DA0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_GET_CLOSESTATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19D37D30)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_GET_CLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x19D37D10)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_GET_STATE_OFFSET UNITYSDK_OFFSET(0x19D37D50)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_GET_SUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x19D37D70)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x19D37D00)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_PARSEANDVALIDATECONNECTRESPONSEASYNC_OFFSET UNITYSDK_OFFSET(0x19D38BB0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_READRESPONSEHEADERLINEASYNC_OFFSET UNITYSDK_OFFSET(0x19D38DB0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x19D37E50)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x19D37E00)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE_VALIDATEANDTRACKHEADER_OFFSET UNITYSDK_OFFSET(0x19D38CA0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D38E80)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D37CC0)
