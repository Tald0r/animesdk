...
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_ADDSUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x187E7F80)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x187E82A0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x187E7DA0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_COOKIES_OFFSET UNITYSDK_OFFSET(0x187E7F00)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x187E7CA0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_KEEPALIVEINTERVAL_OFFSET UNITYSDK_OFFSET(0x187E8120)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_PROXY_OFFSET UNITYSDK_OFFSET(0x187E7D20)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_RECEIVEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x187E8280)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_REQUESTEDSUBPROTOCOLS_OFFSET UNITYSDK_OFFSET(0x187E7C10)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_REQUESTHEADERS_OFFSET UNITYSDK_OFFSET(0x187E7C00)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_SENDBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x187E8290)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_GET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x187E7C20)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SETBUFFER_1_OFFSET UNITYSDK_OFFSET(0x187E8460)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x187E82C0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SETREQUESTHEADER_OFFSET UNITYSDK_OFFSET(0x187E7B00)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SETTOREADONLY_OFFSET UNITYSDK_OFFSET(0x187E8670)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x187E7E40)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_COOKIES_OFFSET UNITYSDK_OFFSET(0x187E7F10)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x187E7CB0)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_KEEPALIVEINTERVAL_OFFSET UNITYSDK_OFFSET(0x187E8130)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_PROXY_OFFSET UNITYSDK_OFFSET(0x187E7D30)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_SET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x187E7C30)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS_THROWIFREADONLY_OFFSET UNITYSDK_OFFSET(0x187E7B90)
#define SYSTEM_NET_WEBSOCKETS_CLIENTWEBSOCKETOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x187E7A40)
...
namespace System::Net::WebSockets
{
	...
	{
	public:
		::System::Collections::Generic::List_1<::System::String*>* _requestedSubProtocols; // 0x10
		::System::Net::CookieContainer* _cookies; // 0x18
		::System::Net::IWebProxy* _proxy; // 0x20
		::System::Security::Cryptography::X509Certificates::X509CertificateCollection* _clientCertificates; // 0x28
		::System::Nullable_1<::System::ArraySegment_1<::System::Byte>> _buffer; // 0x30
		...
		::System::Int32 _sendBufferSize; // 0x5C
