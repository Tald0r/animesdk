...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_THROWIFINVALIDSTATE_OFFSET UNITYSDK_OFFSET(0x18BC0CB0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_THROWPLATFORMNOTSUPPORTEDEXCEPTION_OFFSET UNITYSDK_OFFSET(0x18BC1250)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATEARRAYSEGMENT_OFFSET UNITYSDK_OFFSET(0x18BC12A0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATEBUFFER_OFFSET UNITYSDK_OFFSET(0x18BC13C0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATECLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x18BC1020)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATESUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x18BC0DE0)
