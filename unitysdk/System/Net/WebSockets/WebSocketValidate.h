...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_THROWIFINVALIDSTATE_OFFSET UNITYSDK_OFFSET(0x185AFE60)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_THROWPLATFORMNOTSUPPORTEDEXCEPTION_OFFSET UNITYSDK_OFFSET(0x185B0400)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATEARRAYSEGMENT_OFFSET UNITYSDK_OFFSET(0x185B0450)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATEBUFFER_OFFSET UNITYSDK_OFFSET(0x185B0570)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATECLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x185B01D0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETVALIDATE_VALIDATESUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x185AFF90)
