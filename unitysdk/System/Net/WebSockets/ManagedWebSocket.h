...
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ABORT_OFFSET UNITYSDK_OFFSET(0x18F5E9A0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ALLOCATESENDBUFFER_OFFSET UNITYSDK_OFFSET(0x18F5F3F0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_APPLYMASK_1_OFFSET UNITYSDK_OFFSET(0x18F60310)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_APPLYMASK_OFFSET UNITYSDK_OFFSET(0x18F5F6E0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEASYNCPRIVATE_OFFSET UNITYSDK_OFFSET(0x18F5E4D0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEASYNC_OFFSET UNITYSDK_OFFSET(0x18F5E270)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEOUTPUTASYNC_OFFSET UNITYSDK_OFFSET(0x18F5E670)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEWITHRECEIVEERRORANDTHROWASYNC_OFFSET UNITYSDK_OFFSET(0x18F5FE10)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_COMBINEMASKBYTES_OFFSET UNITYSDK_OFFSET(0x18F601E0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CONSUMEFROMBUFFER_OFFSET UNITYSDK_OFFSET(0x18F601D0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CREATEFROMCONNECTEDSTREAM_OFFSET UNITYSDK_OFFSET(0x18F5D120)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CREATEOPERATIONCANCELEDEXCEPTION_OFFSET UNITYSDK_OFFSET(0x18F5F270)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_DISPOSECORE_OFFSET UNITYSDK_OFFSET(0x18F5D750)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18F5D6A0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ENSUREBUFFERCONTAINSASYNC_OFFSET UNITYSDK_OFFSET(0x18F601F0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_CLOSESTATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x18F5D880)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_CLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x18F5D870)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_RECEIVEASYNCLOCK_OFFSET UNITYSDK_OFFSET(0x18F5D690)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_STATEUPDATELOCK_OFFSET UNITYSDK_OFFSET(0x18F5D680)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_STATE_OFFSET UNITYSDK_OFFSET(0x18F5D890)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_SUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x18F5D8A0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_HANDLERECEIVEDCLOSEASYNC_OFFSET UNITYSDK_OFFSET(0x18F5FB60)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_HANDLERECEIVEDPINGPONGASYNC_OFFSET UNITYSDK_OFFSET(0x18F5FC30)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ISVALIDCLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x18F5FDD0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_RECEIVEASYNCPRIVATE_OFFSET UNITYSDK_OFFSET(0x18F5E170)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x18F5DE20)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_RELEASESENDBUFFER_OFFSET UNITYSDK_OFFSET(0x18F5F370)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x18F5D8B0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDCLOSEFRAMEASYNC_OFFSET UNITYSDK_OFFSET(0x18F5E880)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDFRAMEASYNC_OFFSET UNITYSDK_OFFSET(0x18F5DBF0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDFRAMEFALLBACKASYNC_OFFSET UNITYSDK_OFFSET(0x18F5EEC0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDFRAMELOCKACQUIREDNONCANCELABLEASYNC_OFFSET UNITYSDK_OFFSET(0x18F5EA60)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDKEEPALIVEFRAMEASYNC_OFFSET UNITYSDK_OFFSET(0x18F5F880)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_THROWIFOPERATIONINPROGRESS_OFFSET UNITYSDK_OFFSET(0x18F5DB40)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_TRYPARSEMESSAGEHEADERFROMRECEIVEBUFFER_OFFSET UNITYSDK_OFFSET(0x18F5FF40)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_TRYVALIDATEUTF8_OFFSET UNITYSDK_OFFSET(0x18F60450)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_WRITEFRAMETOSENDBUFFER_OFFSET UNITYSDK_OFFSET(0x18F5F090)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x18F5F460)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_WRITERANDOMMASK_OFFSET UNITYSDK_OFFSET(0x18F5FAC0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__CCTOR_OFFSET UNITYSDK_OFFSET(0x18F606B0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__CTOR_OFFSET UNITYSDK_OFFSET(0x18F5D1C0)
...
namespace System::Net::WebSockets
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* _receiveBuffer; // 0x10
		::System::Threading::CancellationTokenSource* _abortSource; // 0x18
		::System::String* _closeStatusDescription; // 0x20
		::System::Threading::Timer* _keepAliveTimer; // 0x28
		::System::Threading::SemaphoreSlim* _sendFrameAsyncLock; // 0x30
		::System::Threading::Tasks::Task* _lastSendAsync; // 0x38
		::System::IO::Stream* _stream; // 0x40
		::Il2CppArray<::System::Byte>* _sendBuffer; // 0x48
		::System::Threading::Tasks::Task_1<::System::Net::WebSockets::WebSocketReceiveResult*>* _lastReceiveAsync; // 0x50
		...
		::System::Int32 _receiveBufferOffset; // 0x80
		::System::Nullable_1<::System::Net::WebSockets::WebSocketCloseStatus> _closeStatus; // 0x84
		::System::Boolean _disposed; // 0x8C
		::System::Boolean _lastSendWasFragment; // 0x8D
		::System::Net::WebSockets::WebSocketState _state; // 0x90
		::System::Boolean _receiveBufferFromPool; // 0x94
		::System::Boolean _receivedCloseFrame; // 0x95
		::System::Boolean _isServer; // 0x96
		::System::Boolean _sentCloseFrame; // 0x97
