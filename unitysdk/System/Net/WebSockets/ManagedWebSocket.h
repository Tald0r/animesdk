...
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ABORT_OFFSET UNITYSDK_OFFSET(0x1932EBD0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ALLOCATESENDBUFFER_OFFSET UNITYSDK_OFFSET(0x1932F620)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_APPLYMASK_1_OFFSET UNITYSDK_OFFSET(0x19330620)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_APPLYMASK_OFFSET UNITYSDK_OFFSET(0x1932F910)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEASYNCPRIVATE_OFFSET UNITYSDK_OFFSET(0x1932E630)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEASYNC_OFFSET UNITYSDK_OFFSET(0x1932E3E0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEOUTPUTASYNC_OFFSET UNITYSDK_OFFSET(0x1932E7C0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CLOSEWITHRECEIVEERRORANDTHROWASYNC_OFFSET UNITYSDK_OFFSET(0x19330040)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_COMBINEMASKBYTES_OFFSET UNITYSDK_OFFSET(0x19330480)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CONSUMEFROMBUFFER_OFFSET UNITYSDK_OFFSET(0x19330470)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CREATEFROMCONNECTEDSTREAM_OFFSET UNITYSDK_OFFSET(0x1932D2B0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_CREATEOPERATIONCANCELEDEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1932F4A0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_DISPOSECORE_OFFSET UNITYSDK_OFFSET(0x1932D8E0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1932D830)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ENSUREBUFFERCONTAINSASYNC_OFFSET UNITYSDK_OFFSET(0x19330490)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_CLOSESTATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1932DA00)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_CLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x1932D9F0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_RECEIVEASYNCLOCK_OFFSET UNITYSDK_OFFSET(0x1932D820)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_STATEUPDATELOCK_OFFSET UNITYSDK_OFFSET(0x1932D810)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1932DA10)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_GET_SUBPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1932DA20)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_HANDLERECEIVEDCLOSEASYNC_OFFSET UNITYSDK_OFFSET(0x1932FD90)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_HANDLERECEIVEDPINGPONGASYNC_OFFSET UNITYSDK_OFFSET(0x1932FE70)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_ISVALIDCLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x19330000)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_RECEIVEASYNCPRIVATE_OFFSET UNITYSDK_OFFSET(0x1932E2E0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x1932DFA0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_RELEASESENDBUFFER_OFFSET UNITYSDK_OFFSET(0x1932F5A0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x1932DA30)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDCLOSEFRAMEASYNC_OFFSET UNITYSDK_OFFSET(0x1932EA20)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDFRAMEASYNC_OFFSET UNITYSDK_OFFSET(0x1932DD60)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDFRAMEFALLBACKASYNC_OFFSET UNITYSDK_OFFSET(0x1932F0F0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDFRAMELOCKACQUIREDNONCANCELABLEASYNC_OFFSET UNITYSDK_OFFSET(0x1932EC90)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_SENDKEEPALIVEFRAMEASYNC_OFFSET UNITYSDK_OFFSET(0x1932FAB0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_THROWIFOPERATIONINPROGRESS_OFFSET UNITYSDK_OFFSET(0x1932DCB0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_TRYPARSEMESSAGEHEADERFROMRECEIVEBUFFER_OFFSET UNITYSDK_OFFSET(0x193301E0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_TRYVALIDATEUTF8_OFFSET UNITYSDK_OFFSET(0x19330760)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_WRITEFRAMETOSENDBUFFER_OFFSET UNITYSDK_OFFSET(0x1932F2D0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x1932F690)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET_WRITERANDOMMASK_OFFSET UNITYSDK_OFFSET(0x1932FCF0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__CCTOR_OFFSET UNITYSDK_OFFSET(0x193309C0)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__CTOR_OFFSET UNITYSDK_OFFSET(0x1932D350)
...
namespace System::Net::WebSockets
{
	...
	public:
		...
		{
			return (::System::Text::UTF8Encoding**)Il2CppClass::FromTypeDefinitionIndex(ManagedWebSocket_TypeDefinitionIndex)->GetStaticField(0x2A50);
		}
		...
		{
			return (::System::Security::Cryptography::RandomNumberGenerator**)Il2CppClass::FromTypeDefinitionIndex(ManagedWebSocket_TypeDefinitionIndex)->GetStaticField(0x2A60);
		}
		...
		::System::Threading::SemaphoreSlim* _sendFrameAsyncLock; // 0x10
		::System::String* _closeStatusDescription; // 0x18
		::System::Threading::CancellationTokenSource* _abortSource; // 0x20
		::System::Threading::Tasks::Task* _lastSendAsync; // 0x28
		::System::Net::WebSockets::ManagedWebSocket_Utf8MessageState* _utf8TextState; // 0x30
		::Il2CppArray<::System::Byte>* _sendBuffer; // 0x38
		::System::Threading::Tasks::Task_1<::System::Net::WebSockets::WebSocketReceiveResult*>* _lastReceiveAsync; // 0x40
		::System::Threading::Timer* _keepAliveTimer; // 0x48
		::System::IO::Stream* _stream; // 0x50
		::System::String* _subprotocol; // 0x58
		::Il2CppArray<::System::Byte>* _receiveBuffer; // 0x60
		::System::Boolean _receivedCloseFrame; // 0x68
		::System::Boolean _lastSendWasFragment; // 0x69
		::System::Boolean _disposed; // 0x6A
		::System::Boolean _isServer; // 0x6B
		::System::Boolean _receiveBufferFromPool; // 0x6C
		::System::Boolean _sentCloseFrame; // 0x6D
		::System::Net::WebSockets::WebSocketState _state; // 0x70
		::System::Net::WebSockets::ManagedWebSocket_MessageHeader _lastReceiveHeader; // 0x78
		::System::Int32 _receiveBufferCount; // 0x88
		::System::Int32 _receivedMaskOffsetOffset; // 0x8C
		::System::Int32 _receiveBufferOffset; // 0x90
		::System::Nullable_1<::System::Net::WebSockets::WebSocketCloseStatus> _closeStatus; // 0x94
