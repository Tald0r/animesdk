...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_CREATECLIENTBUFFER_OFFSET UNITYSDK_OFFSET(0x191E0B20)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_CREATECLIENTWEBSOCKET_OFFSET UNITYSDK_OFFSET(0x191E0E80)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_CREATESERVERBUFFER_OFFSET UNITYSDK_OFFSET(0x191E0CE0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_GET_DEFAULTKEEPALIVEINTERVAL_OFFSET UNITYSDK_OFFSET(0x191E0A10)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_ISAPPLICATIONTARGETING45_OFFSET UNITYSDK_OFFSET(0x191E0E20)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_ISSTATETERMINAL_OFFSET UNITYSDK_OFFSET(0x191E0B10)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_REGISTERPREFIXES_OFFSET UNITYSDK_OFFSET(0x191E0E30)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_THROWONINVALIDSTATE_OFFSET UNITYSDK_OFFSET(0x191E0A20)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET__CTOR_OFFSET UNITYSDK_OFFSET(0x191E11A0)
