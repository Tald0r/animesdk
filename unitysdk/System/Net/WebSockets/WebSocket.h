...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_CREATECLIENTBUFFER_OFFSET UNITYSDK_OFFSET(0x195DCED0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_CREATECLIENTWEBSOCKET_OFFSET UNITYSDK_OFFSET(0x195DD230)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_CREATESERVERBUFFER_OFFSET UNITYSDK_OFFSET(0x195DD090)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_GET_DEFAULTKEEPALIVEINTERVAL_OFFSET UNITYSDK_OFFSET(0x195DCDC0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_ISAPPLICATIONTARGETING45_OFFSET UNITYSDK_OFFSET(0x195DD1D0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_ISSTATETERMINAL_OFFSET UNITYSDK_OFFSET(0x195DCEC0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_REGISTERPREFIXES_OFFSET UNITYSDK_OFFSET(0x195DD1E0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET_THROWONINVALIDSTATE_OFFSET UNITYSDK_OFFSET(0x195DCDD0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKET__CTOR_OFFSET UNITYSDK_OFFSET(0x195DD550)
