...
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__SENDCLOSEFRAMEASYNC_D__67_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x897C00)
#define SYSTEM_NET_WEBSOCKETS_MANAGEDWEBSOCKET__SENDCLOSEFRAMEASYNC_D__67_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x308FB0)
...
namespace System::Net::WebSockets
{
	...
	struct alignas(8) ManagedWebSocket__SendCloseFrameAsync_d__67
	{
		...
		::System::String* closeStatusDescription; // 0x20
