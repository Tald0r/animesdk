...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x18FFE180)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE___C__CONNECTASYNCCORE_B__24_0_OFFSET UNITYSDK_OFFSET(0x18FFE1D0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE___C__CONNECTSOCKETASYNC_B__25_0_OFFSET UNITYSDK_OFFSET(0x18FFE250)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE___C__CONNECTSOCKETASYNC_B__25_1_OFFSET UNITYSDK_OFFSET(0x18FFE2E0)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETHANDLE___C__CTOR_OFFSET UNITYSDK_OFFSET(0x18FFE1C0)
...
namespace System::Net::WebSockets
{
	...
	public:
		...
		{
			return (::System::Net::WebSockets::WebSocketHandle___c**)Il2CppClass::FromTypeDefinitionIndex(WebSocketHandle___c_TypeDefinitionIndex)->GetStaticField(0x3268);
		}
