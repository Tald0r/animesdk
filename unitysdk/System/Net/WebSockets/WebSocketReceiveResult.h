...
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_CLOSESTATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A33DE40)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_CLOSESTATUS_OFFSET UNITYSDK_OFFSET(0x1A33DE30)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A33DE00)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_ENDOFMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A33DE10)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT_GET_MESSAGETYPE_OFFSET UNITYSDK_OFFSET(0x1A33DE20)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A33DD70)
#define SYSTEM_NET_WEBSOCKETS_WEBSOCKETRECEIVERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A33DCF0)
...
namespace System::Net::WebSockets
{
	...
	public:
		...
		::System::Net::WebSockets::WebSocketMessageType _MessageType_k__BackingField; // 0x28
