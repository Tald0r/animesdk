...
#define SYSTEM_NET_WEBUTILITY_CONVERTSMPTOUTF16_OFFSET UNITYSDK_OFFSET(0x185B1450)
#define SYSTEM_NET_WEBUTILITY_GETNEXTUNICODESCALARVALUEFROMUTF16SURROGATE_OFFSET UNITYSDK_OFFSET(0x185B0C70)
#define SYSTEM_NET_WEBUTILITY_GET_HTMLDECODECONFORMANCE_OFFSET UNITYSDK_OFFSET(0x185B1380)
#define SYSTEM_NET_WEBUTILITY_GET_HTMLENCODECONFORMANCE_OFFSET UNITYSDK_OFFSET(0x185B0BA0)
#define SYSTEM_NET_WEBUTILITY_HEXTOINT_OFFSET UNITYSDK_OFFSET(0x185B21D0)
#define SYSTEM_NET_WEBUTILITY_HTMLDECODE_1_OFFSET UNITYSDK_OFFSET(0x185B0EC0)
#define SYSTEM_NET_WEBUTILITY_HTMLDECODE_OFFSET UNITYSDK_OFFSET(0x185B0CD0)
#define SYSTEM_NET_WEBUTILITY_HTMLENCODE_1_OFFSET UNITYSDK_OFFSET(0x185B08A0)
#define SYSTEM_NET_WEBUTILITY_HTMLENCODE_OFFSET UNITYSDK_OFFSET(0x185B0650)
#define SYSTEM_NET_WEBUTILITY_INDEXOFHTMLENCODINGCHARS_OFFSET UNITYSDK_OFFSET(0x185B0740)
#define SYSTEM_NET_WEBUTILITY_INTTOHEX_OFFSET UNITYSDK_OFFSET(0x185B1B90)
#define SYSTEM_NET_WEBUTILITY_ISURLSAFECHAR_OFFSET UNITYSDK_OFFSET(0x185B1B50)
#define SYSTEM_NET_WEBUTILITY_STRINGREQUIRESHTMLDECODING_OFFSET UNITYSDK_OFFSET(0x185B0DD0)
#define SYSTEM_NET_WEBUTILITY_URLDECODEINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x185B2210)
#define SYSTEM_NET_WEBUTILITY_URLDECODEINTERNAL_OFFSET UNITYSDK_OFFSET(0x185B1E20)
#define SYSTEM_NET_WEBUTILITY_URLDECODETOBYTES_OFFSET UNITYSDK_OFFSET(0x185B25B0)
#define SYSTEM_NET_WEBUTILITY_URLDECODE_OFFSET UNITYSDK_OFFSET(0x185B24C0)
#define SYSTEM_NET_WEBUTILITY_URLENCODETOBYTES_OFFSET UNITYSDK_OFFSET(0x185B1DB0)
#define SYSTEM_NET_WEBUTILITY_URLENCODE_1_OFFSET UNITYSDK_OFFSET(0x185B15E0)
#define SYSTEM_NET_WEBUTILITY_URLENCODE_2_OFFSET UNITYSDK_OFFSET(0x185B1BA0)
#define SYSTEM_NET_WEBUTILITY_URLENCODE_OFFSET UNITYSDK_OFFSET(0x185B1490)
#define SYSTEM_NET_WEBUTILITY_VALIDATEURLENCODINGPARAMETERS_OFFSET UNITYSDK_OFFSET(0x185B1A60)
#define SYSTEM_NET_WEBUTILITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x185B2620)
