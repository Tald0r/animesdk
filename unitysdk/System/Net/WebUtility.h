...
#define SYSTEM_NET_WEBUTILITY_CONVERTSMPTOUTF16_OFFSET UNITYSDK_OFFSET(0x18BC22A0)
#define SYSTEM_NET_WEBUTILITY_GETNEXTUNICODESCALARVALUEFROMUTF16SURROGATE_OFFSET UNITYSDK_OFFSET(0x18BC1AC0)
#define SYSTEM_NET_WEBUTILITY_GET_HTMLDECODECONFORMANCE_OFFSET UNITYSDK_OFFSET(0x18BC21D0)
#define SYSTEM_NET_WEBUTILITY_GET_HTMLENCODECONFORMANCE_OFFSET UNITYSDK_OFFSET(0x18BC19F0)
#define SYSTEM_NET_WEBUTILITY_HEXTOINT_OFFSET UNITYSDK_OFFSET(0x18BC3020)
#define SYSTEM_NET_WEBUTILITY_HTMLDECODE_1_OFFSET UNITYSDK_OFFSET(0x18BC1D10)
#define SYSTEM_NET_WEBUTILITY_HTMLDECODE_OFFSET UNITYSDK_OFFSET(0x18BC1B20)
#define SYSTEM_NET_WEBUTILITY_HTMLENCODE_1_OFFSET UNITYSDK_OFFSET(0x18BC16F0)
#define SYSTEM_NET_WEBUTILITY_HTMLENCODE_OFFSET UNITYSDK_OFFSET(0x18BC14A0)
#define SYSTEM_NET_WEBUTILITY_INDEXOFHTMLENCODINGCHARS_OFFSET UNITYSDK_OFFSET(0x18BC1590)
#define SYSTEM_NET_WEBUTILITY_INTTOHEX_OFFSET UNITYSDK_OFFSET(0x18BC29E0)
#define SYSTEM_NET_WEBUTILITY_ISURLSAFECHAR_OFFSET UNITYSDK_OFFSET(0x18BC29A0)
#define SYSTEM_NET_WEBUTILITY_STRINGREQUIRESHTMLDECODING_OFFSET UNITYSDK_OFFSET(0x18BC1C20)
#define SYSTEM_NET_WEBUTILITY_URLDECODEINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x18BC3060)
#define SYSTEM_NET_WEBUTILITY_URLDECODEINTERNAL_OFFSET UNITYSDK_OFFSET(0x18BC2C70)
#define SYSTEM_NET_WEBUTILITY_URLDECODETOBYTES_OFFSET UNITYSDK_OFFSET(0x18BC3400)
#define SYSTEM_NET_WEBUTILITY_URLDECODE_OFFSET UNITYSDK_OFFSET(0x18BC3310)
#define SYSTEM_NET_WEBUTILITY_URLENCODETOBYTES_OFFSET UNITYSDK_OFFSET(0x18BC2C00)
#define SYSTEM_NET_WEBUTILITY_URLENCODE_1_OFFSET UNITYSDK_OFFSET(0x18BC2430)
#define SYSTEM_NET_WEBUTILITY_URLENCODE_2_OFFSET UNITYSDK_OFFSET(0x18BC29F0)
#define SYSTEM_NET_WEBUTILITY_URLENCODE_OFFSET UNITYSDK_OFFSET(0x18BC22E0)
#define SYSTEM_NET_WEBUTILITY_VALIDATEURLENCODINGPARAMETERS_OFFSET UNITYSDK_OFFSET(0x18BC28B0)
#define SYSTEM_NET_WEBUTILITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x18BC3470)
...
namespace System::Net
{
	...
	public:
		...
		{
			return (::System::Net::Configuration::UnicodeEncodingConformance*)Il2CppClass::FromTypeDefinitionIndex(WebUtility_TypeDefinitionIndex)->GetStaticField(0x12E0);
		}
		static ::System::Net::Configuration::UnicodeDecodingConformance* StaticGet__htmlDecodeConformance()
		{
			return (::System::Net::Configuration::UnicodeDecodingConformance*)Il2CppClass::FromTypeDefinitionIndex(WebUtility_TypeDefinitionIndex)->GetStaticField(0x12E4);
		}
