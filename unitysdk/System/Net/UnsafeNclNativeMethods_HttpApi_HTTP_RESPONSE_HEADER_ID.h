...
#define SYSTEM_NET_UNSAFENCLNATIVEMETHODS_HTTPAPI_HTTP_RESPONSE_HEADER_ID_INDEXOFKNOWNHEADER_OFFSET UNITYSDK_OFFSET(0x19247760)
#define SYSTEM_NET_UNSAFENCLNATIVEMETHODS_HTTPAPI_HTTP_RESPONSE_HEADER_ID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19247870)
#define SYSTEM_NET_UNSAFENCLNATIVEMETHODS_HTTPAPI_HTTP_RESPONSE_HEADER_ID__CCTOR_OFFSET UNITYSDK_OFFSET(0x19247630)
