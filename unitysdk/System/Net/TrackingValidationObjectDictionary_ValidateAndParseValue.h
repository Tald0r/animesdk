...
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_VALIDATEANDPARSEVALUE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D7EA50)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_VALIDATEANDPARSEVALUE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D7EA80)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_VALIDATEANDPARSEVALUE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D7E510)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_VALIDATEANDPARSEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D7E500)
