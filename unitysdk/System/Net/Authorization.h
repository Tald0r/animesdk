...
#define SYSTEM_NET_AUTHORIZATION_GET_COMPLETE_OFFSET UNITYSDK_OFFSET(0x191CDBE0)
#define SYSTEM_NET_AUTHORIZATION_GET_CONNECTIONGROUPID_OFFSET UNITYSDK_OFFSET(0x191CDBD0)
#define SYSTEM_NET_AUTHORIZATION_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x191CDBC0)
#define SYSTEM_NET_AUTHORIZATION_GET_MUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x191CDC60)
#define SYSTEM_NET_AUTHORIZATION_GET_PROTECTIONREALM_OFFSET UNITYSDK_OFFSET(0x191CDC00)
#define SYSTEM_NET_AUTHORIZATION_SETCOMPLETE_OFFSET UNITYSDK_OFFSET(0x191CDBF0)
#define SYSTEM_NET_AUTHORIZATION_SET_MUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x191CDC80)
#define SYSTEM_NET_AUTHORIZATION_SET_PROTECTIONREALM_OFFSET UNITYSDK_OFFSET(0x191CDC10)
#define SYSTEM_NET_AUTHORIZATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191CDA90)
#define SYSTEM_NET_AUTHORIZATION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191CDAE0)
#define SYSTEM_NET_AUTHORIZATION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x191CDB50)
#define SYSTEM_NET_AUTHORIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x191CDA40)
...
namespace System::Net
{
	...
	public:
		...
		::System::String* m_ConnectionGroupId; // 0x20
		::Il2CppArray<::System::String*>* m_ProtectionRealm; // 0x28
