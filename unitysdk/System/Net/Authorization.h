...
#define SYSTEM_NET_AUTHORIZATION_GET_COMPLETE_OFFSET UNITYSDK_OFFSET(0x195C9F70)
#define SYSTEM_NET_AUTHORIZATION_GET_CONNECTIONGROUPID_OFFSET UNITYSDK_OFFSET(0x195C9F60)
#define SYSTEM_NET_AUTHORIZATION_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x195C9F50)
#define SYSTEM_NET_AUTHORIZATION_GET_MUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x195C9FF0)
#define SYSTEM_NET_AUTHORIZATION_GET_PROTECTIONREALM_OFFSET UNITYSDK_OFFSET(0x195C9F90)
#define SYSTEM_NET_AUTHORIZATION_SETCOMPLETE_OFFSET UNITYSDK_OFFSET(0x195C9F80)
#define SYSTEM_NET_AUTHORIZATION_SET_MUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x195CA010)
#define SYSTEM_NET_AUTHORIZATION_SET_PROTECTIONREALM_OFFSET UNITYSDK_OFFSET(0x195C9FA0)
#define SYSTEM_NET_AUTHORIZATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195C9E20)
#define SYSTEM_NET_AUTHORIZATION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x195C9E70)
#define SYSTEM_NET_AUTHORIZATION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x195C9EE0)
#define SYSTEM_NET_AUTHORIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x195C9DD0)
