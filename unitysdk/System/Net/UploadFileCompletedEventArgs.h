...
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTARGS_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x19691C20)
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19691C40)
#define SYSTEM_NET_UPLOADFILECOMPLETEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19691BD0)
