...
#define SYSTEM_NET_WEBRESPONSE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A5FB6D0)
#define SYSTEM_NET_WEBRESPONSE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A5FB730)
#define SYSTEM_NET_WEBRESPONSE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A5FB6E0)
#define SYSTEM_NET_WEBRESPONSE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A5FB6C0)
#define SYSTEM_NET_WEBRESPONSE_GETRESPONSESTREAM_OFFSET UNITYSDK_OFFSET(0x1A5FB910)
#define SYSTEM_NET_WEBRESPONSE_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1A5FB7D0)
#define SYSTEM_NET_WEBRESPONSE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A5FB870)
#define SYSTEM_NET_WEBRESPONSE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1A5FB9B0)
#define SYSTEM_NET_WEBRESPONSE_GET_ISCACHEFRESH_OFFSET UNITYSDK_OFFSET(0x1A5FB7A0)
#define SYSTEM_NET_WEBRESPONSE_GET_ISFROMCACHE_OFFSET UNITYSDK_OFFSET(0x1A5FB780)
#define SYSTEM_NET_WEBRESPONSE_GET_ISMUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1A5FB7C0)
#define SYSTEM_NET_WEBRESPONSE_GET_RESPONSEURI_OFFSET UNITYSDK_OFFSET(0x1A5FB960)
#define SYSTEM_NET_WEBRESPONSE_GET_SUPPORTSHEADERS_OFFSET UNITYSDK_OFFSET(0x1A5FBA00)
#define SYSTEM_NET_WEBRESPONSE_SET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1A5FB820)
#define SYSTEM_NET_WEBRESPONSE_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A5FB8C0)
#define SYSTEM_NET_WEBRESPONSE_SET_INTERNALSETFROMCACHE_OFFSET UNITYSDK_OFFSET(0x1A5FB790)
#define SYSTEM_NET_WEBRESPONSE_SET_INTERNALSETISCACHEFRESH_OFFSET UNITYSDK_OFFSET(0x1A5FB7B0)
#define SYSTEM_NET_WEBRESPONSE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A5FB690)
#define SYSTEM_NET_WEBRESPONSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5FB680)
#define SYSTEM_NET_WEBRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5FB670)
