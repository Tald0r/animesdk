...
#define SYSTEM_NET_NETWORKCREDENTIAL_GETCREDENTIAL_1_OFFSET UNITYSDK_OFFSET(0x19386450)
#define SYSTEM_NET_NETWORKCREDENTIAL_GETCREDENTIAL_OFFSET UNITYSDK_OFFSET(0x19386440)
#define SYSTEM_NET_NETWORKCREDENTIAL_GET_DOMAIN_OFFSET UNITYSDK_OFFSET(0x19386120)
#define SYSTEM_NET_NETWORKCREDENTIAL_GET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x19386030)
#define SYSTEM_NET_NETWORKCREDENTIAL_GET_SECUREPASSWORD_OFFSET UNITYSDK_OFFSET(0x19386100)
#define SYSTEM_NET_NETWORKCREDENTIAL_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x19386020)
#define SYSTEM_NET_NETWORKCREDENTIAL_INTERNALGETDOMAINUSERNAME_OFFSET UNITYSDK_OFFSET(0x19386400)
#define SYSTEM_NET_NETWORKCREDENTIAL_INTERNALGETDOMAIN_OFFSET UNITYSDK_OFFSET(0x193863F0)
#define SYSTEM_NET_NETWORKCREDENTIAL_INTERNALGETPASSWORD_OFFSET UNITYSDK_OFFSET(0x19386040)
#define SYSTEM_NET_NETWORKCREDENTIAL_INTERNALGETSECUREPASSWORD_OFFSET UNITYSDK_OFFSET(0x193863E0)
#define SYSTEM_NET_NETWORKCREDENTIAL_INTERNALGETUSERNAME_OFFSET UNITYSDK_OFFSET(0x19386130)
#define SYSTEM_NET_NETWORKCREDENTIAL_SET_DOMAIN_OFFSET UNITYSDK_OFFSET(0x19385F70)
#define SYSTEM_NET_NETWORKCREDENTIAL_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x19385F50)
#define SYSTEM_NET_NETWORKCREDENTIAL_SET_SECUREPASSWORD_OFFSET UNITYSDK_OFFSET(0x19385F90)
#define SYSTEM_NET_NETWORKCREDENTIAL_SET_USERNAME_OFFSET UNITYSDK_OFFSET(0x19385F30)
#define SYSTEM_NET_NETWORKCREDENTIAL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19385D50)
#define SYSTEM_NET_NETWORKCREDENTIAL__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19385DA0)
#define SYSTEM_NET_NETWORKCREDENTIAL__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19385D00)
#define SYSTEM_NET_NETWORKCREDENTIAL__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19385E60)
#define SYSTEM_NET_NETWORKCREDENTIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19385C50)
