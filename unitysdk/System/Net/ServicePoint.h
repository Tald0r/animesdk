...
#define SYSTEM_NET_SERVICEPOINT_CALLENDPOINTDELEGATE_OFFSET UNITYSDK_OFFSET(0x19465C50)
#define SYSTEM_NET_SERVICEPOINT_CHECKAVAILABLEFORRECYCLING_OFFSET UNITYSDK_OFFSET(0x19464AF0)
#define SYSTEM_NET_SERVICEPOINT_CLOSECONNECTIONGROUP_OFFSET UNITYSDK_OFFSET(0x19465840)
#define SYSTEM_NET_SERVICEPOINT_GETCONNECTIONGROUP_OFFSET UNITYSDK_OFFSET(0x19464830)
#define SYSTEM_NET_SERVICEPOINT_GETCONNECTION_OFFSET UNITYSDK_OFFSET(0x19465DB0)
#define SYSTEM_NET_SERVICEPOINT_GETMUSTIMPLEMENT_OFFSET UNITYSDK_OFFSET(0x19463F10)
#define SYSTEM_NET_SERVICEPOINT_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x19463F00)
#define SYSTEM_NET_SERVICEPOINT_GET_BINDIPENDPOINTDELEGATE_OFFSET UNITYSDK_OFFSET(0x19463FC0)
#define SYSTEM_NET_SERVICEPOINT_GET_CERTIFICATE_OFFSET UNITYSDK_OFFSET(0x194659A0)
#define SYSTEM_NET_SERVICEPOINT_GET_CLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x19465B10)
#define SYSTEM_NET_SERVICEPOINT_GET_CONNECTIONLEASETIMEOUT_OFFSET UNITYSDK_OFFSET(0x19463FE0)
#define SYSTEM_NET_SERVICEPOINT_GET_CONNECTIONLIMIT_OFFSET UNITYSDK_OFFSET(0x19464080)
#define SYSTEM_NET_SERVICEPOINT_GET_CONNECTIONNAME_OFFSET UNITYSDK_OFFSET(0x194640D0)
#define SYSTEM_NET_SERVICEPOINT_GET_CURRENTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x19464130)
#define SYSTEM_NET_SERVICEPOINT_GET_EXPECT100CONTINUE_OFFSET UNITYSDK_OFFSET(0x194643F0)
#define SYSTEM_NET_SERVICEPOINT_GET_HASTIMEDOUT_OFFSET UNITYSDK_OFFSET(0x19465080)
#define SYSTEM_NET_SERVICEPOINT_GET_HOSTENTRY_OFFSET UNITYSDK_OFFSET(0x19465170)
#define SYSTEM_NET_SERVICEPOINT_GET_IDLESINCE_OFFSET UNITYSDK_OFFSET(0x19464140)
#define SYSTEM_NET_SERVICEPOINT_GET_MAXIDLETIME_OFFSET UNITYSDK_OFFSET(0x19464150)
#define SYSTEM_NET_SERVICEPOINT_GET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x19464280)
#define SYSTEM_NET_SERVICEPOINT_GET_RECEIVEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x19464290)
#define SYSTEM_NET_SERVICEPOINT_GET_SENDCONTINUE_OFFSET UNITYSDK_OFFSET(0x19464400)
#define SYSTEM_NET_SERVICEPOINT_GET_SUPPORTSPIPELINING_OFFSET UNITYSDK_OFFSET(0x19464330)
#define SYSTEM_NET_SERVICEPOINT_GET_USECONNECT_OFFSET UNITYSDK_OFFSET(0x19464810)
#define SYSTEM_NET_SERVICEPOINT_GET_USENAGLEALGORITHM_OFFSET UNITYSDK_OFFSET(0x19464570)
#define SYSTEM_NET_SERVICEPOINT_GET_USESPROXY_OFFSET UNITYSDK_OFFSET(0x194647F0)
#define SYSTEM_NET_SERVICEPOINT_IDLETIMERCALLBACK_OFFSET UNITYSDK_OFFSET(0x19465060)
#define SYSTEM_NET_SERVICEPOINT_KEEPALIVESETUP_OFFSET UNITYSDK_OFFSET(0x19464630)
#define SYSTEM_NET_SERVICEPOINT_PUTBYTES_OFFSET UNITYSDK_OFFSET(0x194646C0)
#define SYSTEM_NET_SERVICEPOINT_REMOVECONNECTIONGROUP_OFFSET UNITYSDK_OFFSET(0x19464A90)
#define SYSTEM_NET_SERVICEPOINT_SENDREQUEST_OFFSET UNITYSDK_OFFSET(0x19465670)
#define SYSTEM_NET_SERVICEPOINT_SETTCPKEEPALIVE_OFFSET UNITYSDK_OFFSET(0x194645A0)
#define SYSTEM_NET_SERVICEPOINT_SETVERSION_OFFSET UNITYSDK_OFFSET(0x19465660)
#define SYSTEM_NET_SERVICEPOINT_SET_BINDIPENDPOINTDELEGATE_OFFSET UNITYSDK_OFFSET(0x19463FD0)
#define SYSTEM_NET_SERVICEPOINT_SET_CONNECTIONLEASETIMEOUT_OFFSET UNITYSDK_OFFSET(0x19464030)
#define SYSTEM_NET_SERVICEPOINT_SET_CONNECTIONLIMIT_OFFSET UNITYSDK_OFFSET(0x19464090)
#define SYSTEM_NET_SERVICEPOINT_SET_EXPECT100CONTINUE_OFFSET UNITYSDK_OFFSET(0x19464560)
#define SYSTEM_NET_SERVICEPOINT_SET_MAXIDLETIME_OFFSET UNITYSDK_OFFSET(0x19464160)
#define SYSTEM_NET_SERVICEPOINT_SET_RECEIVEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x194642E0)
#define SYSTEM_NET_SERVICEPOINT_SET_SENDCONTINUE_OFFSET UNITYSDK_OFFSET(0x19464590)
#define SYSTEM_NET_SERVICEPOINT_SET_USECONNECT_OFFSET UNITYSDK_OFFSET(0x19464820)
#define SYSTEM_NET_SERVICEPOINT_SET_USENAGLEALGORITHM_OFFSET UNITYSDK_OFFSET(0x19464580)
#define SYSTEM_NET_SERVICEPOINT_SET_USESPROXY_OFFSET UNITYSDK_OFFSET(0x19464800)
#define SYSTEM_NET_SERVICEPOINT_UPDATECLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x19448770)
#define SYSTEM_NET_SERVICEPOINT_UPDATESERVERCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x19465AE0)
#define SYSTEM_NET_SERVICEPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19465E10)
#define SYSTEM_NET_SERVICEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19463E90)
#define SYSTEM_NET_SERVICEPOINT__GETCONNECTIONGROUP_B__66_0_OFFSET UNITYSDK_OFFSET(0x19465E00)
...
namespace System::Net
{
	...
	public:
		...
		::System::Threading::Timer* idleTimer; // 0x18
		...
		::System::Int32 connectionLimit; // 0x64
		::System::DateTime idleSince; // 0x68
		::System::Int32 tcp_keepalive_interval; // 0x70
		::System::Boolean tcp_keepalive; // 0x74
		::System::Boolean usesProxy; // 0x75
		::System::Boolean sendContinue; // 0x76
		::System::Boolean useNagle; // 0x77
		::System::Boolean useConnect; // 0x78
		::System::Int32 maxIdleTime; // 0x7C
		::System::Int32 tcp_keepalive_time; // 0x80
