...
#define SYSTEM_NET_DNSPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x1823A7E0)
#define SYSTEM_NET_DNSPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1823A7D0)
