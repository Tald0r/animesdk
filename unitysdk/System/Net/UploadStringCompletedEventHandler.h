...
#define SYSTEM_NET_UPLOADSTRINGCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FE2590)
#define SYSTEM_NET_UPLOADSTRINGCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FE25D0)
#define SYSTEM_NET_UPLOADSTRINGCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FE2010)
#define SYSTEM_NET_UPLOADSTRINGCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE2000)
