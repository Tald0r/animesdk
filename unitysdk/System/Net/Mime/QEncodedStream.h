...
#define SYSTEM_NET_MIME_QENCODEDSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x19D79D40)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x19D79EC0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_DECODEBYTES_OFFSET UNITYSDK_OFFSET(0x19D79F80)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_ENCODEBYTES_OFFSET UNITYSDK_OFFSET(0x19D7A920)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x19D7AE70)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_FLUSHINTERNAL_OFFSET UNITYSDK_OFFSET(0x19D79F30)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x19D7AF30)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GETENCODEDSTRING_OFFSET UNITYSDK_OFFSET(0x19D7ADB0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x19D7ADA0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x19D79CD0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GET_WRITESTATE_OFFSET UNITYSDK_OFFSET(0x19D79D30)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x19D7AFA0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D7B120)
#define SYSTEM_NET_MIME_QENCODEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19D79CA0)
