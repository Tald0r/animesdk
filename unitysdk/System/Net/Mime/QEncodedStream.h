...
#define SYSTEM_NET_MIME_QENCODEDSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1A338240)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A3383C0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_DECODEBYTES_OFFSET UNITYSDK_OFFSET(0x1A338480)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_ENCODEBYTES_OFFSET UNITYSDK_OFFSET(0x1A338E20)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x1A339370)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_FLUSHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A338430)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A339430)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GETENCODEDSTRING_OFFSET UNITYSDK_OFFSET(0x1A3392B0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x1A3392A0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1A3381D0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_GET_WRITESTATE_OFFSET UNITYSDK_OFFSET(0x1A338230)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1A3394A0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A339620)
#define SYSTEM_NET_MIME_QENCODEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3381A0)
...
namespace System::Net::Mime
{
	...
	public:
		...
		::System::Net::Mime::QEncodedStream_ReadStateInfo* readState; // 0x38
