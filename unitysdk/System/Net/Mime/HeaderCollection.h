...
#define SYSTEM_NET_MIME_HEADERCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x19428F30)
#define SYSTEM_NET_MIME_HEADERCOLLECTION_GETVALUES_OFFSET UNITYSDK_OFFSET(0x19428620)
#define SYSTEM_NET_MIME_HEADERCOLLECTION_GET_OFFSET UNITYSDK_OFFSET(0x19428380)
#define SYSTEM_NET_MIME_HEADERCOLLECTION_INTERNALADD_OFFSET UNITYSDK_OFFSET(0x194288E0)
#define SYSTEM_NET_MIME_HEADERCOLLECTION_INTERNALREMOVE_OFFSET UNITYSDK_OFFSET(0x194288C0)
#define SYSTEM_NET_MIME_HEADERCOLLECTION_INTERNALSET_OFFSET UNITYSDK_OFFSET(0x194288D0)
#define SYSTEM_NET_MIME_HEADERCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x19428170)
#define SYSTEM_NET_MIME_HEADERCOLLECTION_SET_OFFSET UNITYSDK_OFFSET(0x19428960)
#define SYSTEM_NET_MIME_HEADERCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19428110)
