...
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT_COMPLETEWRITE_OFFSET UNITYSDK_OFFSET(0x191CCC80)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT_END_OFFSET UNITYSDK_OFFSET(0x191CCD40)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT_ONWRITE_OFFSET UNITYSDK_OFFSET(0x191CCDB0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT_WRITE_OFFSET UNITYSDK_OFFSET(0x191CD080)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x191CD450)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x191CCC00)
