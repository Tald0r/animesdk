...
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT_COMPLETEWRITE_OFFSET UNITYSDK_OFFSET(0x18D83FA0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT_END_OFFSET UNITYSDK_OFFSET(0x18D84060)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT_ONWRITE_OFFSET UNITYSDK_OFFSET(0x18D840D0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT_WRITE_OFFSET UNITYSDK_OFFSET(0x18D843A0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x18D84770)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITEASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D83F20)
