...
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_COMPLETESEQUENCE_OFFSET UNITYSDK_OFFSET(0x191CCAE0)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_DECREMENT_OFFSET UNITYSDK_OFFSET(0x191CCA00)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_END_OFFSET UNITYSDK_OFFSET(0x191CCB50)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_ENTER_OFFSET UNITYSDK_OFFSET(0x191CC970)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x191CC960)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_INCREMENT_OFFSET UNITYSDK_OFFSET(0x191CC980)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_LEAVE_1_OFFSET UNITYSDK_OFFSET(0x191CCA70)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_LEAVE_OFFSET UNITYSDK_OFFSET(0x191CC990)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x191CC910)
