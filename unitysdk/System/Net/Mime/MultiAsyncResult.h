...
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_COMPLETESEQUENCE_OFFSET UNITYSDK_OFFSET(0x18D83E00)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_DECREMENT_OFFSET UNITYSDK_OFFSET(0x18D83D20)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_END_OFFSET UNITYSDK_OFFSET(0x18D83E70)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_ENTER_OFFSET UNITYSDK_OFFSET(0x18D83C90)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x18D83C80)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_INCREMENT_OFFSET UNITYSDK_OFFSET(0x18D83CA0)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_LEAVE_1_OFFSET UNITYSDK_OFFSET(0x18D83D90)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT_LEAVE_OFFSET UNITYSDK_OFFSET(0x18D83CB0)
#define SYSTEM_NET_MIME_MULTIASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D83C30)
