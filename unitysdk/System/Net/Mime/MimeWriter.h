...
#define SYSTEM_NET_MIME_MIMEWRITER_BEGINCLOSE_OFFSET UNITYSDK_OFFSET(0x1A337CE0)
#define SYSTEM_NET_MIME_MIMEWRITER_CHECKBOUNDARY_OFFSET UNITYSDK_OFFSET(0x1A337FF0)
#define SYSTEM_NET_MIME_MIMEWRITER_CLOSE_1_OFFSET UNITYSDK_OFFSET(0x1A337DD0)
#define SYSTEM_NET_MIME_MIMEWRITER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A337F60)
#define SYSTEM_NET_MIME_MIMEWRITER_ENDCLOSE_OFFSET UNITYSDK_OFFSET(0x1A337F20)
#define SYSTEM_NET_MIME_MIMEWRITER_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x1A337FA0)
#define SYSTEM_NET_MIME_MIMEWRITER_WRITEHEADERS_OFFSET UNITYSDK_OFFSET(0x1A3379D0)
#define SYSTEM_NET_MIME_MIMEWRITER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A338110)
#define SYSTEM_NET_MIME_MIMEWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A337890)
