...
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x19074B60)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x19074CE0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_DECODEBYTES_OFFSET UNITYSDK_OFFSET(0x19074EB0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_ENCODEBYTES_OFFSET UNITYSDK_OFFSET(0x19075850)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x19076C00)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_FLUSHINTERNAL_OFFSET UNITYSDK_OFFSET(0x19074D10)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x19076CC0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_GETENCODEDSTRING_OFFSET UNITYSDK_OFFSET(0x19076A70)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x19076A60)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x19074A30)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_GET_WRITESTATE_OFFSET UNITYSDK_OFFSET(0x19074A90)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x19076D00)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM__CCTOR_OFFSET UNITYSDK_OFFSET(0x19076E50)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x190749E0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19074960)
