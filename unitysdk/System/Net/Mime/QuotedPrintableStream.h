...
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x18B80270)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x18B803F0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_DECODEBYTES_OFFSET UNITYSDK_OFFSET(0x18B805C0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_ENCODEBYTES_OFFSET UNITYSDK_OFFSET(0x18B80F60)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x18B82310)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_FLUSHINTERNAL_OFFSET UNITYSDK_OFFSET(0x18B80420)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x18B823D0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_GETENCODEDSTRING_OFFSET UNITYSDK_OFFSET(0x18B82180)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x18B82170)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x18B80140)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_GET_WRITESTATE_OFFSET UNITYSDK_OFFSET(0x18B801A0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x18B82410)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM__CCTOR_OFFSET UNITYSDK_OFFSET(0x18B82560)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B800F0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18B80070)
