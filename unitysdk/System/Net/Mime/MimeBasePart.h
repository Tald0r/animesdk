...
#define SYSTEM_NET_MIME_MIMEBASEPART_BEGINSEND_OFFSET UNITYSDK_OFFSET(0x195D1A00)
#define SYSTEM_NET_MIME_MIMEBASEPART_DECODEENCODING_OFFSET UNITYSDK_OFFSET(0x195D0A80)
#define SYSTEM_NET_MIME_MIMEBASEPART_DECODEHEADERVALUE_OFFSET UNITYSDK_OFFSET(0x195D04E0)
#define SYSTEM_NET_MIME_MIMEBASEPART_ENCODEHEADERVALUE_1_OFFSET UNITYSDK_OFFSET(0x195D0120)
#define SYSTEM_NET_MIME_MIMEBASEPART_ENCODEHEADERVALUE_OFFSET UNITYSDK_OFFSET(0x195D0110)
#define SYSTEM_NET_MIME_MIMEBASEPART_ENDSEND_OFFSET UNITYSDK_OFFSET(0x195D1A50)
#define SYSTEM_NET_MIME_MIMEBASEPART_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x195D0D30)
#define SYSTEM_NET_MIME_MIMEBASEPART_GET_CONTENTLOCATION_OFFSET UNITYSDK_OFFSET(0x195D11F0)
#define SYSTEM_NET_MIME_MIMEBASEPART_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x195D1540)
#define SYSTEM_NET_MIME_MIMEBASEPART_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x195D0E60)
#define SYSTEM_NET_MIME_MIMEBASEPART_ISANSI_OFFSET UNITYSDK_OFFSET(0x195D0C50)
#define SYSTEM_NET_MIME_MIMEBASEPART_ISASCII_OFFSET UNITYSDK_OFFSET(0x195D0400)
#define SYSTEM_NET_MIME_MIMEBASEPART_PREPAREHEADERS_OFFSET UNITYSDK_OFFSET(0x195D16B0)
#define SYSTEM_NET_MIME_MIMEBASEPART_SEND_OFFSET UNITYSDK_OFFSET(0x195D19B0)
#define SYSTEM_NET_MIME_MIMEBASEPART_SET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x195D0FD0)
#define SYSTEM_NET_MIME_MIMEBASEPART_SET_CONTENTLOCATION_OFFSET UNITYSDK_OFFSET(0x195D1320)
#define SYSTEM_NET_MIME_MIMEBASEPART_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x195D15F0)
#define SYSTEM_NET_MIME_MIMEBASEPART_SHOULDUSEBASE64ENCODING_OFFSET UNITYSDK_OFFSET(0x195CFEF0)
#define SYSTEM_NET_MIME_MIMEBASEPART__CTOR_OFFSET UNITYSDK_OFFSET(0x195CFEE0)
...
namespace System::Net::Mime
{
	...
	public:
		...
		::System::Net::Mime::HeaderCollection* headers; // 0x10
