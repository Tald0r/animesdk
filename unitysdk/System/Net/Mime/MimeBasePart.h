...
#define SYSTEM_NET_MIME_MIMEBASEPART_BEGINSEND_OFFSET UNITYSDK_OFFSET(0x191D5670)
#define SYSTEM_NET_MIME_MIMEBASEPART_DECODEENCODING_OFFSET UNITYSDK_OFFSET(0x191D46F0)
#define SYSTEM_NET_MIME_MIMEBASEPART_DECODEHEADERVALUE_OFFSET UNITYSDK_OFFSET(0x191D4150)
#define SYSTEM_NET_MIME_MIMEBASEPART_ENCODEHEADERVALUE_1_OFFSET UNITYSDK_OFFSET(0x191D3D90)
#define SYSTEM_NET_MIME_MIMEBASEPART_ENCODEHEADERVALUE_OFFSET UNITYSDK_OFFSET(0x191D3D80)
#define SYSTEM_NET_MIME_MIMEBASEPART_ENDSEND_OFFSET UNITYSDK_OFFSET(0x191D56C0)
#define SYSTEM_NET_MIME_MIMEBASEPART_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x191D49A0)
#define SYSTEM_NET_MIME_MIMEBASEPART_GET_CONTENTLOCATION_OFFSET UNITYSDK_OFFSET(0x191D4E60)
#define SYSTEM_NET_MIME_MIMEBASEPART_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x191D51B0)
#define SYSTEM_NET_MIME_MIMEBASEPART_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x191D4AD0)
#define SYSTEM_NET_MIME_MIMEBASEPART_ISANSI_OFFSET UNITYSDK_OFFSET(0x191D48C0)
#define SYSTEM_NET_MIME_MIMEBASEPART_ISASCII_OFFSET UNITYSDK_OFFSET(0x191D4070)
#define SYSTEM_NET_MIME_MIMEBASEPART_PREPAREHEADERS_OFFSET UNITYSDK_OFFSET(0x191D5320)
#define SYSTEM_NET_MIME_MIMEBASEPART_SEND_OFFSET UNITYSDK_OFFSET(0x191D5620)
#define SYSTEM_NET_MIME_MIMEBASEPART_SET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x191D4C40)
#define SYSTEM_NET_MIME_MIMEBASEPART_SET_CONTENTLOCATION_OFFSET UNITYSDK_OFFSET(0x191D4F90)
#define SYSTEM_NET_MIME_MIMEBASEPART_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x191D5260)
#define SYSTEM_NET_MIME_MIMEBASEPART_SHOULDUSEBASE64ENCODING_OFFSET UNITYSDK_OFFSET(0x191D3B60)
#define SYSTEM_NET_MIME_MIMEBASEPART__CTOR_OFFSET UNITYSDK_OFFSET(0x191D3B50)
...
namespace System::Net::Mime
{
	...
	public:
		...
		::System::Net::Mime::ContentType* contentType; // 0x20
