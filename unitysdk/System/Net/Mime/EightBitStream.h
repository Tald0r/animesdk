...
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x18BB2F20)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_DECODEBYTES_OFFSET UNITYSDK_OFFSET(0x18BB38A0)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_ENCODEBYTES_OFFSET UNITYSDK_OFFSET(0x18BB38F0)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_ENCODELINES_OFFSET UNITYSDK_OFFSET(0x18BB3170)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x18BB3530)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_GETENCODEDSTRING_OFFSET UNITYSDK_OFFSET(0x18BB3950)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x18BB3940)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_GET_WRITESTATE_OFFSET UNITYSDK_OFFSET(0x18BB2E50)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x18BB35E0)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18BB2F00)
#define SYSTEM_NET_MIME_EIGHTBITSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB2EF0)
