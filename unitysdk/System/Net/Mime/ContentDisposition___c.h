...
#define SYSTEM_NET_MIME_CONTENTDISPOSITION___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x187DB6C0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION___C__CTOR_OFFSET UNITYSDK_OFFSET(0x187DB700)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION___C___CCTOR_B__13_0_OFFSET UNITYSDK_OFFSET(0x187DB710)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION___C___CCTOR_B__13_1_OFFSET UNITYSDK_OFFSET(0x187DB7C0)
