...
#define SYSTEM_NET_MIME_MIMEMULTIPART_BEGINSEND_OFFSET UNITYSDK_OFFSET(0x18B7F990)
#define SYSTEM_NET_MIME_MIMEMULTIPART_COMPLETE_OFFSET UNITYSDK_OFFSET(0x18B7E590)
#define SYSTEM_NET_MIME_MIMEMULTIPART_CONTENTSTREAMCALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x18B7F3F0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_CONTENTSTREAMCALLBACK_OFFSET UNITYSDK_OFFSET(0x18B7F1F0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_GETNEXTBOUNDARY_OFFSET UNITYSDK_OFFSET(0x18B7E480)
#define SYSTEM_NET_MIME_MIMEMULTIPART_GET_PARTS_OFFSET UNITYSDK_OFFSET(0x18B7E520)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEPARTSENTCALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x18B7ECC0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEPARTSENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x18B7EAC0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEWRITERCLOSECALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x18B7E940)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEWRITERCLOSECALLBACK_OFFSET UNITYSDK_OFFSET(0x18B7E750)
#define SYSTEM_NET_MIME_MIMEMULTIPART_SEND_OFFSET UNITYSDK_OFFSET(0x18B7FBE0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_SETTYPE_OFFSET UNITYSDK_OFFSET(0x18B7E1D0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_SET_MIMEMULTIPARTTYPE_OFFSET UNITYSDK_OFFSET(0x18B7E120)
#define SYSTEM_NET_MIME_MIMEMULTIPART__CTOR_OFFSET UNITYSDK_OFFSET(0x18B7E110)
