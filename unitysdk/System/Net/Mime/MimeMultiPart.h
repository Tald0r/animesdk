...
#define SYSTEM_NET_MIME_MIMEMULTIPART_BEGINSEND_OFFSET UNITYSDK_OFFSET(0x19074280)
#define SYSTEM_NET_MIME_MIMEMULTIPART_COMPLETE_OFFSET UNITYSDK_OFFSET(0x19072E80)
#define SYSTEM_NET_MIME_MIMEMULTIPART_CONTENTSTREAMCALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x19073CE0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_CONTENTSTREAMCALLBACK_OFFSET UNITYSDK_OFFSET(0x19073AE0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_GETNEXTBOUNDARY_OFFSET UNITYSDK_OFFSET(0x19072D70)
#define SYSTEM_NET_MIME_MIMEMULTIPART_GET_PARTS_OFFSET UNITYSDK_OFFSET(0x19072E10)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEPARTSENTCALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x190735B0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEPARTSENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x190733B0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEWRITERCLOSECALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x19073230)
#define SYSTEM_NET_MIME_MIMEMULTIPART_MIMEWRITERCLOSECALLBACK_OFFSET UNITYSDK_OFFSET(0x19073040)
#define SYSTEM_NET_MIME_MIMEMULTIPART_SEND_OFFSET UNITYSDK_OFFSET(0x190744D0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_SETTYPE_OFFSET UNITYSDK_OFFSET(0x19072AC0)
#define SYSTEM_NET_MIME_MIMEMULTIPART_SET_MIMEMULTIPARTTYPE_OFFSET UNITYSDK_OFFSET(0x19072A10)
#define SYSTEM_NET_MIME_MIMEMULTIPART__CTOR_OFFSET UNITYSDK_OFFSET(0x19072A00)
