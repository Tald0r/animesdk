...
#define SYSTEM_NET_MIME_QENCODEDSTREAM_WRITEASYNCRESULT_COMPLETEWRITE_OFFSET UNITYSDK_OFFSET(0x19462070)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_WRITEASYNCRESULT_END_OFFSET UNITYSDK_OFFSET(0x194620D0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_WRITEASYNCRESULT_ONWRITE_OFFSET UNITYSDK_OFFSET(0x19462140)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_WRITEASYNCRESULT_WRITE_OFFSET UNITYSDK_OFFSET(0x19462390)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_WRITEASYNCRESULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x19462600)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_WRITEASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x19461FF0)
