...
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO_GET_LASTBITS_OFFSET UNITYSDK_OFFSET(0x18BB2E30)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO_GET_PADDING_OFFSET UNITYSDK_OFFSET(0x18BB2E10)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO_SET_LASTBITS_OFFSET UNITYSDK_OFFSET(0x18BB2E40)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO_SET_PADDING_OFFSET UNITYSDK_OFFSET(0x18BB2E20)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18BB2DC0)
#define SYSTEM_NET_MIME_BASE64WRITESTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAE670)
