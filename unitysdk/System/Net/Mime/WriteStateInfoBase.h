...
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPENDCRLF_OFFSET UNITYSDK_OFFSET(0x18B81FF0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPENDFOOTER_OFFSET UNITYSDK_OFFSET(0x18B827E0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPENDHEADER_OFFSET UNITYSDK_OFFSET(0x18B82800)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPEND_1_OFFSET UNITYSDK_OFFSET(0x18B820B0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPEND_OFFSET UNITYSDK_OFFSET(0x18B81F40)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_BUFFERFLUSHED_OFFSET UNITYSDK_OFFSET(0x18B82400)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_ENSURESPACEINBUFFER_OFFSET UNITYSDK_OFFSET(0x18B82770)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x18B82740)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_CURRENTLINELENGTH_OFFSET UNITYSDK_OFFSET(0x18B82760)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_FOOTERLENGTH_OFFSET UNITYSDK_OFFSET(0x18B82700)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_FOOTER_OFFSET UNITYSDK_OFFSET(0x18B82720)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_HEADER_OFFSET UNITYSDK_OFFSET(0x18B82730)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x18B82750)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_MAXLINELENGTH_OFFSET UNITYSDK_OFFSET(0x18B82820)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_RESET_OFFSET UNITYSDK_OFFSET(0x18B82830)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B80220)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18B826B0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B82650)
...
namespace System::Net::Mime
{
	...
	public:
		...
		::System::Int32 _maxLineLength; // 0x28
		::System::Int32 _currentLineLength; // 0x2C
		::System::Int32 _currentBufferUsed; // 0x30
