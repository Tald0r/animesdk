...
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPENDCRLF_OFFSET UNITYSDK_OFFSET(0x190768E0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPENDFOOTER_OFFSET UNITYSDK_OFFSET(0x190770D0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPENDHEADER_OFFSET UNITYSDK_OFFSET(0x190770F0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPEND_1_OFFSET UNITYSDK_OFFSET(0x190769A0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_APPEND_OFFSET UNITYSDK_OFFSET(0x19076830)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_BUFFERFLUSHED_OFFSET UNITYSDK_OFFSET(0x19076CF0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_ENSURESPACEINBUFFER_OFFSET UNITYSDK_OFFSET(0x19077060)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x19077030)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_CURRENTLINELENGTH_OFFSET UNITYSDK_OFFSET(0x19077050)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_FOOTERLENGTH_OFFSET UNITYSDK_OFFSET(0x19076FF0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_FOOTER_OFFSET UNITYSDK_OFFSET(0x19077010)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_HEADER_OFFSET UNITYSDK_OFFSET(0x19077020)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x19077040)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_GET_MAXLINELENGTH_OFFSET UNITYSDK_OFFSET(0x19077110)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE_RESET_OFFSET UNITYSDK_OFFSET(0x19077120)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19074B10)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19076FA0)
#define SYSTEM_NET_MIME_WRITESTATEINFOBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19076F40)
...
namespace System::Net::Mime
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* _header; // 0x18
