...
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_CREATEFOOTER_OFFSET UNITYSDK_OFFSET(0x193AE840)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_CREATEHEADER_OFFSET UNITYSDK_OFFSET(0x193AE710)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_GETENCODERFORHEADER_OFFSET UNITYSDK_OFFSET(0x193AE430)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_GETENCODER_OFFSET UNITYSDK_OFFSET(0x193AE2D0)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_GET_DEFAULTMAXLINELENGTH_OFFSET UNITYSDK_OFFSET(0x193AE2C0)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x193AE8A0)
