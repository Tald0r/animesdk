...
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_CREATEFOOTER_OFFSET UNITYSDK_OFFSET(0x18FC24D0)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_CREATEHEADER_OFFSET UNITYSDK_OFFSET(0x18FC23A0)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_GETENCODERFORHEADER_OFFSET UNITYSDK_OFFSET(0x18FC20C0)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_GETENCODER_OFFSET UNITYSDK_OFFSET(0x18FC1F60)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY_GET_DEFAULTMAXLINELENGTH_OFFSET UNITYSDK_OFFSET(0x18FC1F50)
#define SYSTEM_NET_MIME_ENCODEDSTREAMFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC2530)
