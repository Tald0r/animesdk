...
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_GET_BYTE_OFFSET UNITYSDK_OFFSET(0x19327930)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_GET_ISESCAPED_OFFSET UNITYSDK_OFFSET(0x19327910)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_SET_BYTE_OFFSET UNITYSDK_OFFSET(0x19327940)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_SET_ISESCAPED_OFFSET UNITYSDK_OFFSET(0x19327920)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19327950)
