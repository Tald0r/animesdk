...
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_GET_BYTE_OFFSET UNITYSDK_OFFSET(0x18F57790)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_GET_ISESCAPED_OFFSET UNITYSDK_OFFSET(0x18F57770)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_SET_BYTE_OFFSET UNITYSDK_OFFSET(0x18F577A0)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO_SET_ISESCAPED_OFFSET UNITYSDK_OFFSET(0x18F57780)
#define SYSTEM_NET_MIME_QENCODEDSTREAM_READSTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18F577B0)
