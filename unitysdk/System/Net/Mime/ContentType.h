...
#define SYSTEM_NET_MIME_CONTENTTYPE_ENCODETOBUFFER_OFFSET UNITYSDK_OFFSET(0x19B2A770)
#define SYSTEM_NET_MIME_CONTENTTYPE_ENCODE_OFFSET UNITYSDK_OFFSET(0x19B2A290)
#define SYSTEM_NET_MIME_CONTENTTYPE_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B2A9B0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B2AA50)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_BOUNDARY_OFFSET UNITYSDK_OFFSET(0x19B297C0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_CHARSET_OFFSET UNITYSDK_OFFSET(0x19B29BA0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x19B2A270)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_MEDIATYPE_OFFSET UNITYSDK_OFFSET(0x19B29C80)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19B272C0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x19B298C0)
#define SYSTEM_NET_MIME_CONTENTTYPE_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x19B28E90)
#define SYSTEM_NET_MIME_CONTENTTYPE_PERSISTIFNEEDED_OFFSET UNITYSDK_OFFSET(0x19B2A0C0)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_BOUNDARY_OFFSET UNITYSDK_OFFSET(0x19B29980)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_CHARSET_OFFSET UNITYSDK_OFFSET(0x19B27D70)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_MEDIATYPE_OFFSET UNITYSDK_OFFSET(0x19B29CA0)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19B273C0)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_OFFSET UNITYSDK_OFFSET(0x19B29EE0)
#define SYSTEM_NET_MIME_CONTENTTYPE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B2A060)
#define SYSTEM_NET_MIME_CONTENTTYPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B2ABB0)
#define SYSTEM_NET_MIME_CONTENTTYPE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B279F0)
#define SYSTEM_NET_MIME_CONTENTTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B28E20)
...
namespace System::Net::Mime
{
	...
	public:
		...
		::System::Boolean isChanged; // 0x30
		::System::Boolean isPersisted; // 0x31
