...
#define SYSTEM_NET_MIME_CONTENTTYPE_ENCODETOBUFFER_OFFSET UNITYSDK_OFFSET(0x1968BDA0)
#define SYSTEM_NET_MIME_CONTENTTYPE_ENCODE_OFFSET UNITYSDK_OFFSET(0x1968B8C0)
#define SYSTEM_NET_MIME_CONTENTTYPE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1968BFE0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1968C080)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_BOUNDARY_OFFSET UNITYSDK_OFFSET(0x1968ADF0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_CHARSET_OFFSET UNITYSDK_OFFSET(0x1968B1D0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x1968B8A0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_MEDIATYPE_OFFSET UNITYSDK_OFFSET(0x1968B2B0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x196888F0)
#define SYSTEM_NET_MIME_CONTENTTYPE_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1968AEF0)
#define SYSTEM_NET_MIME_CONTENTTYPE_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1968A4C0)
#define SYSTEM_NET_MIME_CONTENTTYPE_PERSISTIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1968B6F0)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_BOUNDARY_OFFSET UNITYSDK_OFFSET(0x1968AFB0)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_CHARSET_OFFSET UNITYSDK_OFFSET(0x196893A0)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_MEDIATYPE_OFFSET UNITYSDK_OFFSET(0x1968B2D0)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x196889F0)
#define SYSTEM_NET_MIME_CONTENTTYPE_SET_OFFSET UNITYSDK_OFFSET(0x1968B510)
#define SYSTEM_NET_MIME_CONTENTTYPE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1968B690)
#define SYSTEM_NET_MIME_CONTENTTYPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1968C1E0)
#define SYSTEM_NET_MIME_CONTENTTYPE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19689020)
#define SYSTEM_NET_MIME_CONTENTTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1968A450)
...
namespace System::Net::Mime
{
	...
	public:
		...
		::System::String* subType; // 0x18
		::System::String* mediaType; // 0x20
		::System::Net::TrackingStringDictionary* parameters; // 0x28
