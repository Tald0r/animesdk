...
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_ENCODETOBUFFER_OFFSET UNITYSDK_OFFSET(0x187DA8B0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_ENCODE_OFFSET UNITYSDK_OFFSET(0x187DA3C0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_EQUALS_OFFSET UNITYSDK_OFFSET(0x187DAEC0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_GETDATEPARAMETER_OFFSET UNITYSDK_OFFSET(0x187D9040)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x187DAF60)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_GET_CREATIONDATE_OFFSET UNITYSDK_OFFSET(0x187D9710)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_GET_DISPOSITIONTYPE_OFFSET UNITYSDK_OFFSET(0x187D92D0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x187D93B0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_GET_INLINE_OFFSET UNITYSDK_OFFSET(0x187D9A70)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x187DA3A0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_GET_MODIFICATIONDATE_OFFSET UNITYSDK_OFFSET(0x187D98C0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x187D91E0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_GET_READDATE_OFFSET UNITYSDK_OFFSET(0x187D9B30)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x187D9CE0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x187D88B0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_PERSISTIFNEEDED_OFFSET UNITYSDK_OFFSET(0x187DA1F0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_SET_CREATIONDATE_OFFSET UNITYSDK_OFFSET(0x187D9750)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_SET_DISPOSITIONTYPE_OFFSET UNITYSDK_OFFSET(0x187D92E0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x187D94E0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_SET_INLINE_OFFSET UNITYSDK_OFFSET(0x187D9AE0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_SET_MODIFICATIONDATE_OFFSET UNITYSDK_OFFSET(0x187D9900)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_SET_OFFSET UNITYSDK_OFFSET(0x187DA010)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_SET_READDATE_OFFSET UNITYSDK_OFFSET(0x187D9B70)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x187D9EA0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x187DA190)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x187D83D0)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x187D8830)
#define SYSTEM_NET_MIME_CONTENTDISPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x187D87F0)
