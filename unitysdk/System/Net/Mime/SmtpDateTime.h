...
#define SYSTEM_NET_MIME_SMTPDATETIME_FORMATDATE_OFFSET UNITYSDK_OFFSET(0x19385570)
#define SYSTEM_NET_MIME_SMTPDATETIME_GET_DATE_OFFSET UNITYSDK_OFFSET(0x193852B0)
#define SYSTEM_NET_MIME_SMTPDATETIME_INITIALIZESHORTHANDLOOKUPS_OFFSET UNITYSDK_OFFSET(0x193844F0)
#define SYSTEM_NET_MIME_SMTPDATETIME_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x19384BE0)
#define SYSTEM_NET_MIME_SMTPDATETIME_TIMESPANTOOFFSET_OFFSET UNITYSDK_OFFSET(0x193855F0)
#define SYSTEM_NET_MIME_SMTPDATETIME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x193853B0)
#define SYSTEM_NET_MIME_SMTPDATETIME_TRYPARSETIMEZONESTRING_OFFSET UNITYSDK_OFFSET(0x19384ED0)
#define SYSTEM_NET_MIME_SMTPDATETIME_VALIDATEANDGETSANITIZEDTIMESPAN_OFFSET UNITYSDK_OFFSET(0x193849E0)
#define SYSTEM_NET_MIME_SMTPDATETIME_VALIDATEANDGETTIMEZONEOFFSETVALUES_OFFSET UNITYSDK_OFFSET(0x19385730)
#define SYSTEM_NET_MIME_SMTPDATETIME_VALIDATETIMEZONESHORTHANDVALUE_OFFSET UNITYSDK_OFFSET(0x193858F0)
#define SYSTEM_NET_MIME_SMTPDATETIME__CCTOR_OFFSET UNITYSDK_OFFSET(0x19385980)
#define SYSTEM_NET_MIME_SMTPDATETIME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19384BA0)
#define SYSTEM_NET_MIME_SMTPDATETIME__CTOR_OFFSET UNITYSDK_OFFSET(0x193848E0)
