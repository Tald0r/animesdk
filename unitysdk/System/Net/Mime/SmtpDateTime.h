...
#define SYSTEM_NET_MIME_SMTPDATETIME_FORMATDATE_OFFSET UNITYSDK_OFFSET(0x18FF4060)
#define SYSTEM_NET_MIME_SMTPDATETIME_GET_DATE_OFFSET UNITYSDK_OFFSET(0x18FF3DA0)
#define SYSTEM_NET_MIME_SMTPDATETIME_INITIALIZESHORTHANDLOOKUPS_OFFSET UNITYSDK_OFFSET(0x18FF2FD0)
#define SYSTEM_NET_MIME_SMTPDATETIME_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x18FF36D0)
#define SYSTEM_NET_MIME_SMTPDATETIME_TIMESPANTOOFFSET_OFFSET UNITYSDK_OFFSET(0x18FF40E0)
#define SYSTEM_NET_MIME_SMTPDATETIME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18FF3EA0)
#define SYSTEM_NET_MIME_SMTPDATETIME_TRYPARSETIMEZONESTRING_OFFSET UNITYSDK_OFFSET(0x18FF39C0)
#define SYSTEM_NET_MIME_SMTPDATETIME_VALIDATEANDGETSANITIZEDTIMESPAN_OFFSET UNITYSDK_OFFSET(0x18FF34D0)
#define SYSTEM_NET_MIME_SMTPDATETIME_VALIDATEANDGETTIMEZONEOFFSETVALUES_OFFSET UNITYSDK_OFFSET(0x18FF4220)
#define SYSTEM_NET_MIME_SMTPDATETIME_VALIDATETIMEZONESHORTHANDVALUE_OFFSET UNITYSDK_OFFSET(0x18FF43E0)
#define SYSTEM_NET_MIME_SMTPDATETIME__CCTOR_OFFSET UNITYSDK_OFFSET(0x18FF4470)
#define SYSTEM_NET_MIME_SMTPDATETIME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FF3690)
#define SYSTEM_NET_MIME_SMTPDATETIME__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF33D0)
...
namespace System::Net::Mime
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(SmtpDateTime_TypeDefinitionIndex)->GetStaticField(0x3500);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_validDateTimeFormats()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(SmtpDateTime_TypeDefinitionIndex)->GetStaticField(0x3508);
		}
