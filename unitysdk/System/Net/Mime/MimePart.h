...
#define SYSTEM_NET_MIME_MIMEPART_BEGINSEND_OFFSET UNITYSDK_OFFSET(0x19461C20)
#define SYSTEM_NET_MIME_MIMEPART_COMPLETE_OFFSET UNITYSDK_OFFSET(0x19460BF0)
#define SYSTEM_NET_MIME_MIMEPART_CONTENTSTREAMCALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x19461790)
#define SYSTEM_NET_MIME_MIMEPART_CONTENTSTREAMCALLBACK_OFFSET UNITYSDK_OFFSET(0x19461A20)
#define SYSTEM_NET_MIME_MIMEPART_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1945FFF0)
#define SYSTEM_NET_MIME_MIMEPART_GETENCODEDSTREAM_OFFSET UNITYSDK_OFFSET(0x19461630)
#define SYSTEM_NET_MIME_MIMEPART_GET_CONTENTDISPOSITION_OFFSET UNITYSDK_OFFSET(0x19460020)
#define SYSTEM_NET_MIME_MIMEPART_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x19460010)
#define SYSTEM_NET_MIME_MIMEPART_GET_TRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x194601F0)
#define SYSTEM_NET_MIME_MIMEPART_READCALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x19460FB0)
#define SYSTEM_NET_MIME_MIMEPART_READCALLBACK_OFFSET UNITYSDK_OFFSET(0x19460DB0)
#define SYSTEM_NET_MIME_MIMEPART_RESETSTREAM_OFFSET UNITYSDK_OFFSET(0x19461E00)
#define SYSTEM_NET_MIME_MIMEPART_SEND_OFFSET UNITYSDK_OFFSET(0x19461EB0)
#define SYSTEM_NET_MIME_MIMEPART_SETCONTENT_1_OFFSET UNITYSDK_OFFSET(0x194608E0)
#define SYSTEM_NET_MIME_MIMEPART_SETCONTENT_2_OFFSET UNITYSDK_OFFSET(0x19460B20)
#define SYSTEM_NET_MIME_MIMEPART_SETCONTENT_OFFSET UNITYSDK_OFFSET(0x19460840)
#define SYSTEM_NET_MIME_MIMEPART_SET_CONTENTDISPOSITION_OFFSET UNITYSDK_OFFSET(0x19460030)
#define SYSTEM_NET_MIME_MIMEPART_SET_TRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x194603A0)
#define SYSTEM_NET_MIME_MIMEPART_WRITECALLBACKHANDLER_OFFSET UNITYSDK_OFFSET(0x19461200)
#define SYSTEM_NET_MIME_MIMEPART_WRITECALLBACK_OFFSET UNITYSDK_OFFSET(0x19461430)
#define SYSTEM_NET_MIME_MIMEPART__CTOR_OFFSET UNITYSDK_OFFSET(0x1945FFE0)
