...
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_READSTATEINFO_GET_BYTE_OFFSET UNITYSDK_OFFSET(0x193844C0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_READSTATEINFO_GET_ISESCAPED_OFFSET UNITYSDK_OFFSET(0x193844A0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_READSTATEINFO_SET_BYTE_OFFSET UNITYSDK_OFFSET(0x193844D0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_READSTATEINFO_SET_ISESCAPED_OFFSET UNITYSDK_OFFSET(0x193844B0)
#define SYSTEM_NET_MIME_QUOTEDPRINTABLESTREAM_READSTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x193844E0)
