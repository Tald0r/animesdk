...
#define SYSTEM_NET_MIME_BASEWRITER_BEGINGETCONTENTSTREAM_OFFSET UNITYSDK_OFFSET(0x19689EC0)
#define SYSTEM_NET_MIME_BASEWRITER_CHECKBOUNDARY_OFFSET UNITYSDK_OFFSET(0x1968A370)
#define SYSTEM_NET_MIME_BASEWRITER_ENDGETCONTENTSTREAM_OFFSET UNITYSDK_OFFSET(0x1968A020)
#define SYSTEM_NET_MIME_BASEWRITER_FLUSH_OFFSET UNITYSDK_OFFSET(0x19689C60)
#define SYSTEM_NET_MIME_BASEWRITER_GETCONTENTSTREAM_1_OFFSET UNITYSDK_OFFSET(0x19689B30)
#define SYSTEM_NET_MIME_BASEWRITER_GETCONTENTSTREAM_OFFSET UNITYSDK_OFFSET(0x19689B20)
#define SYSTEM_NET_MIME_BASEWRITER_ONWRITE_OFFSET UNITYSDK_OFFSET(0x1968A0D0)
#define SYSTEM_NET_MIME_BASEWRITER_WRITEANDFOLD_OFFSET UNITYSDK_OFFSET(0x19689880)
#define SYSTEM_NET_MIME_BASEWRITER_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x196896D0)
#define SYSTEM_NET_MIME_BASEWRITER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1968A380)
#define SYSTEM_NET_MIME_BASEWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x19689590)
...
namespace System::Net::Mime
{
	...
	public:
		...
		::System::Net::Mail::BufferBuilder* bufferBuilder; // 0x28
