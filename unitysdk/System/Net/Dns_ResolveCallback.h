...
#define SYSTEM_NET_DNS_RESOLVECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19424CC0)
#define SYSTEM_NET_DNS_RESOLVECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19424CF0)
#define SYSTEM_NET_DNS_RESOLVECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19424780)
#define SYSTEM_NET_DNS_RESOLVECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19424760)
