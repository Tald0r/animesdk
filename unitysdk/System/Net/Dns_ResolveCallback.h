...
#define SYSTEM_NET_DNS_RESOLVECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1900EE10)
#define SYSTEM_NET_DNS_RESOLVECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1900EE40)
#define SYSTEM_NET_DNS_RESOLVECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1900E8D0)
#define SYSTEM_NET_DNS_RESOLVECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1900E8C0)
