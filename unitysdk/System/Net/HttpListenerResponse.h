...
#define SYSTEM_NET_HTTPLISTENERRESPONSE_ABORT_OFFSET UNITYSDK_OFFSET(0x191C4510)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_ADDHEADER_OFFSET UNITYSDK_OFFSET(0x191C4550)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_APPENDCOOKIE_OFFSET UNITYSDK_OFFSET(0x191C4680)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_APPENDHEADER_OFFSET UNITYSDK_OFFSET(0x191C4820)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_CLOSE_1_OFFSET UNITYSDK_OFFSET(0x191C4950)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_CLOSE_2_OFFSET UNITYSDK_OFFSET(0x191C30C0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_CLOSE_OFFSET UNITYSDK_OFFSET(0x191C44E0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_COOKIETOCLIENTSTRING_OFFSET UNITYSDK_OFFSET(0x191C59E0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_COPYFROM_OFFSET UNITYSDK_OFFSET(0x191C4990)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_FINDCOOKIE_OFFSET UNITYSDK_OFFSET(0x191C4A60)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_FORMATHEADERS_OFFSET UNITYSDK_OFFSET(0x191C5C10)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_CONTENTENCODING_OFFSET UNITYSDK_OFFSET(0x191C3030)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_CONTENTLENGTH64_OFFSET UNITYSDK_OFFSET(0x191C3E90)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x191C3FA0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_COOKIES_OFFSET UNITYSDK_OFFSET(0x191C3FB0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_FORCECLOSECHUNKED_OFFSET UNITYSDK_OFFSET(0x191C3DC0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x191C4070)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x191C4090)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_OUTPUTSTREAM_OFFSET UNITYSDK_OFFSET(0x191C4160)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x191C41B0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_REDIRECTLOCATION_OFFSET UNITYSDK_OFFSET(0x191C43A0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_SENDCHUNKED_OFFSET UNITYSDK_OFFSET(0x191C4470)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x191C4480)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_STATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x191C4490)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_ISTOKEN_OFFSET UNITYSDK_OFFSET(0x191C6680)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_QUOTEDSTRING_OFFSET UNITYSDK_OFFSET(0x191C65D0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_REDIRECT_OFFSET UNITYSDK_OFFSET(0x191C4A30)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SENDHEADERS_OFFSET UNITYSDK_OFFSET(0x191C4EC0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SETCOOKIE_OFFSET UNITYSDK_OFFSET(0x191C67A0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_CONTENTENCODING_OFFSET UNITYSDK_OFFSET(0x191C3DD0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_CONTENTLENGTH64_OFFSET UNITYSDK_OFFSET(0x191C3EA0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x191C2F70)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_COOKIES_OFFSET UNITYSDK_OFFSET(0x191C4060)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_HEADERS_OFFSET UNITYSDK_OFFSET(0x191C4080)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x191C40A0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x191C41C0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_REDIRECTLOCATION_OFFSET UNITYSDK_OFFSET(0x191C43B0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_SENDCHUNKED_OFFSET UNITYSDK_OFFSET(0x191C1B30)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x191C2E60)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_STATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x191C44A0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x191C44B0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE__CCTOR_OFFSET UNITYSDK_OFFSET(0x191C6970)
#define SYSTEM_NET_HTTPLISTENERRESPONSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191C69B0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x191C3D00)
...
namespace System::Net
{
	...
	public:
		...
		::System::Boolean force_close_chunked; // 0x72
		::System::Boolean disposed; // 0x73
		::System::Boolean keep_alive; // 0x74
		::System::Boolean chunked; // 0x75
