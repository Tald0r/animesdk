...
#define SYSTEM_NET_HTTPLISTENERRESPONSE_ABORT_OFFSET UNITYSDK_OFFSET(0x18D7B830)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_ADDHEADER_OFFSET UNITYSDK_OFFSET(0x18D7B870)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_APPENDCOOKIE_OFFSET UNITYSDK_OFFSET(0x18D7B9A0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_APPENDHEADER_OFFSET UNITYSDK_OFFSET(0x18D7BB40)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_CLOSE_1_OFFSET UNITYSDK_OFFSET(0x18D7BC70)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_CLOSE_2_OFFSET UNITYSDK_OFFSET(0x18D7A3F0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_CLOSE_OFFSET UNITYSDK_OFFSET(0x18D7B800)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_COOKIETOCLIENTSTRING_OFFSET UNITYSDK_OFFSET(0x18D7CD00)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_COPYFROM_OFFSET UNITYSDK_OFFSET(0x18D7BCB0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_FINDCOOKIE_OFFSET UNITYSDK_OFFSET(0x18D7BD80)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_FORMATHEADERS_OFFSET UNITYSDK_OFFSET(0x18D7CF30)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_CONTENTENCODING_OFFSET UNITYSDK_OFFSET(0x18D7A360)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_CONTENTLENGTH64_OFFSET UNITYSDK_OFFSET(0x18D7B1B0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x18D7B2C0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_COOKIES_OFFSET UNITYSDK_OFFSET(0x18D7B2D0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_FORCECLOSECHUNKED_OFFSET UNITYSDK_OFFSET(0x18D7B0E0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x18D7B390)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x18D7B3B0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_OUTPUTSTREAM_OFFSET UNITYSDK_OFFSET(0x18D7B480)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x18D7B4D0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_REDIRECTLOCATION_OFFSET UNITYSDK_OFFSET(0x18D7B6C0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_SENDCHUNKED_OFFSET UNITYSDK_OFFSET(0x18D7B790)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x18D7B7A0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_GET_STATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x18D7B7B0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_ISTOKEN_OFFSET UNITYSDK_OFFSET(0x18D7D9A0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_QUOTEDSTRING_OFFSET UNITYSDK_OFFSET(0x18D7D8F0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_REDIRECT_OFFSET UNITYSDK_OFFSET(0x18D7BD50)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SENDHEADERS_OFFSET UNITYSDK_OFFSET(0x18D7C1E0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SETCOOKIE_OFFSET UNITYSDK_OFFSET(0x18D7DAC0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_CONTENTENCODING_OFFSET UNITYSDK_OFFSET(0x18D7B0F0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_CONTENTLENGTH64_OFFSET UNITYSDK_OFFSET(0x18D7B1C0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x18D7A2A0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_COOKIES_OFFSET UNITYSDK_OFFSET(0x18D7B380)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_HEADERS_OFFSET UNITYSDK_OFFSET(0x18D7B3A0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x18D7B3C0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x18D7B4E0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_REDIRECTLOCATION_OFFSET UNITYSDK_OFFSET(0x18D7B6D0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_SENDCHUNKED_OFFSET UNITYSDK_OFFSET(0x18D78E80)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x18D7A190)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SET_STATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x18D7B7C0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18D7B7D0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18D7DC90)
#define SYSTEM_NET_HTTPLISTENERRESPONSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18D7DCD0)
#define SYSTEM_NET_HTTPLISTENERRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x18D7B020)
