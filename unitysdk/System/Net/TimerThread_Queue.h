...
#define SYSTEM_NET_TIMERTHREAD_QUEUE_CREATETIMER_OFFSET UNITYSDK_OFFSET(0x18BB6710)
#define SYSTEM_NET_TIMERTHREAD_QUEUE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x18BB6700)
#define SYSTEM_NET_TIMERTHREAD_QUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB66F0)
