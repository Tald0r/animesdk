...
#define SYSTEM_NET_TIMERTHREAD_INFINITETIMERQUEUE_CREATETIMER_OFFSET UNITYSDK_OFFSET(0x1824CA40)
#define SYSTEM_NET_TIMERTHREAD_INFINITETIMERQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1824CA30)
