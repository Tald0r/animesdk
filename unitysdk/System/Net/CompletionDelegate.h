...
#define SYSTEM_NET_COMPLETIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B67C60)
#define SYSTEM_NET_COMPLETIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B67CA0)
#define SYSTEM_NET_COMPLETIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B67640)
#define SYSTEM_NET_COMPLETIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B67630)
