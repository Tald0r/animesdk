...
#define SYSTEM_NET_COMPLETIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1905C520)
#define SYSTEM_NET_COMPLETIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1905C560)
#define SYSTEM_NET_COMPLETIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1905BEF0)
#define SYSTEM_NET_COMPLETIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1905BED0)
