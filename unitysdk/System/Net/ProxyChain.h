...
#define SYSTEM_NET_PROXYCHAIN_ABORT_OFFSET UNITYSDK_OFFSET(0x187E1A80)
#define SYSTEM_NET_PROXYCHAIN_DISPOSE_OFFSET UNITYSDK_OFFSET(0x187E1A00)
#define SYSTEM_NET_PROXYCHAIN_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x187E1930)
#define SYSTEM_NET_PROXYCHAIN_GET_DESTINATION_OFFSET UNITYSDK_OFFSET(0x187E1A70)
#define SYSTEM_NET_PROXYCHAIN_GET_ENUMERATOR_OFFSET UNITYSDK_OFFSET(0x187E1A10)
#define SYSTEM_NET_PROXYCHAIN_GET_HTTPABORTDELEGATE_OFFSET UNITYSDK_OFFSET(0x187E1AB0)
#define SYSTEM_NET_PROXYCHAIN_HTTPABORT_OFFSET UNITYSDK_OFFSET(0x187E1A90)
#define SYSTEM_NET_PROXYCHAIN_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x187E19A0)
#define SYSTEM_NET_PROXYCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x187E18A0)
...
namespace System::Net
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::Uri*>* m_Cache; // 0x20
