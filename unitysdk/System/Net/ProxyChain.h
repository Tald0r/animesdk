...
#define SYSTEM_NET_PROXYCHAIN_ABORT_OFFSET UNITYSDK_OFFSET(0x18247630)
#define SYSTEM_NET_PROXYCHAIN_DISPOSE_OFFSET UNITYSDK_OFFSET(0x182475B0)
#define SYSTEM_NET_PROXYCHAIN_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x182474E0)
#define SYSTEM_NET_PROXYCHAIN_GET_DESTINATION_OFFSET UNITYSDK_OFFSET(0x18247620)
#define SYSTEM_NET_PROXYCHAIN_GET_ENUMERATOR_OFFSET UNITYSDK_OFFSET(0x182475C0)
#define SYSTEM_NET_PROXYCHAIN_GET_HTTPABORTDELEGATE_OFFSET UNITYSDK_OFFSET(0x18247660)
#define SYSTEM_NET_PROXYCHAIN_HTTPABORT_OFFSET UNITYSDK_OFFSET(0x18247640)
#define SYSTEM_NET_PROXYCHAIN_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18247550)
#define SYSTEM_NET_PROXYCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x18247450)
...
namespace System::Net
{
	...
	public:
		...
		::System::Net::ProxyChain_ProxyEnumerator* m_MainEnumerator; // 0x20
		::System::Net::HttpAbortDelegate* m_HttpAbortDelegate; // 0x28
