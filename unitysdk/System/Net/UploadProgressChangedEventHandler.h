...
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1943C990)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1943C9D0)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1943C410)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1943C3F0)
