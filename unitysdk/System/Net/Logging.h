...
#define SYSTEM_NET_LOGGING_ENTER_1_OFFSET UNITYSDK_OFFSET(0x1945E360)
#define SYSTEM_NET_LOGGING_ENTER_2_OFFSET UNITYSDK_OFFSET(0x1945E370)
#define SYSTEM_NET_LOGGING_ENTER_OFFSET UNITYSDK_OFFSET(0x1945E350)
#define SYSTEM_NET_LOGGING_EXCEPTION_OFFSET UNITYSDK_OFFSET(0x1945E380)
#define SYSTEM_NET_LOGGING_EXIT_1_OFFSET UNITYSDK_OFFSET(0x1945E3A0)
#define SYSTEM_NET_LOGGING_EXIT_2_OFFSET UNITYSDK_OFFSET(0x1945E3B0)
#define SYSTEM_NET_LOGGING_EXIT_OFFSET UNITYSDK_OFFSET(0x1945E390)
#define SYSTEM_NET_LOGGING_GET_HTTPLISTENER_OFFSET UNITYSDK_OFFSET(0x1945E330)
#define SYSTEM_NET_LOGGING_GET_SOCKETS_OFFSET UNITYSDK_OFFSET(0x1945E340)
#define SYSTEM_NET_LOGGING_GET_WEB_OFFSET UNITYSDK_OFFSET(0x1945E320)
#define SYSTEM_NET_LOGGING_PRINTERROR_OFFSET UNITYSDK_OFFSET(0x1945E410)
#define SYSTEM_NET_LOGGING_PRINTINFO_1_OFFSET UNITYSDK_OFFSET(0x1945E3D0)
#define SYSTEM_NET_LOGGING_PRINTINFO_2_OFFSET UNITYSDK_OFFSET(0x1945E3E0)
#define SYSTEM_NET_LOGGING_PRINTINFO_OFFSET UNITYSDK_OFFSET(0x1945E3C0)
#define SYSTEM_NET_LOGGING_PRINTWARNING_1_OFFSET UNITYSDK_OFFSET(0x1945E400)
#define SYSTEM_NET_LOGGING_PRINTWARNING_OFFSET UNITYSDK_OFFSET(0x1945E3F0)
#define SYSTEM_NET_LOGGING__CCTOR_OFFSET UNITYSDK_OFFSET(0x1945E420)
