...
#define SYSTEM_NET_IPADDRESS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x195CD3D0)
#define SYSTEM_NET_IPADDRESS_EQUALS_OFFSET UNITYSDK_OFFSET(0x195CD650)
#define SYSTEM_NET_IPADDRESS_GETADDRESSBYTES_OFFSET UNITYSDK_OFFSET(0x195CC850)
#define SYSTEM_NET_IPADDRESS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195CD810)
#define SYSTEM_NET_IPADDRESS_GET_ADDRESSFAMILY_OFFSET UNITYSDK_OFFSET(0x195CCC20)
#define SYSTEM_NET_IPADDRESS_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x195CC760)
#define SYSTEM_NET_IPADDRESS_GET_ISBROADCAST_OFFSET UNITYSDK_OFFSET(0x195CD3E0)
#define SYSTEM_NET_IPADDRESS_GET_ISIPV4MAPPEDTOIPV6_OFFSET UNITYSDK_OFFSET(0x195CD5B0)
#define SYSTEM_NET_IPADDRESS_GET_ISIPV6LINKLOCAL_OFFSET UNITYSDK_OFFSET(0x195CD4A0)
#define SYSTEM_NET_IPADDRESS_GET_ISIPV6MULTICAST_OFFSET UNITYSDK_OFFSET(0x195CD450)
#define SYSTEM_NET_IPADDRESS_GET_ISIPV6SITELOCAL_OFFSET UNITYSDK_OFFSET(0x195CD4F0)
#define SYSTEM_NET_IPADDRESS_GET_ISIPV6TEREDO_OFFSET UNITYSDK_OFFSET(0x195CD540)
#define SYSTEM_NET_IPADDRESS_GET_SCOPEID_OFFSET UNITYSDK_OFFSET(0x195CCC30)
#define SYSTEM_NET_IPADDRESS_HOSTTONETWORKORDER_1_OFFSET UNITYSDK_OFFSET(0x195CD1B0)
#define SYSTEM_NET_IPADDRESS_HOSTTONETWORKORDER_2_OFFSET UNITYSDK_OFFSET(0x195CD1E0)
#define SYSTEM_NET_IPADDRESS_HOSTTONETWORKORDER_OFFSET UNITYSDK_OFFSET(0x195CD150)
#define SYSTEM_NET_IPADDRESS_INTERNALPARSE_OFFSET UNITYSDK_OFFSET(0x195CC430)
#define SYSTEM_NET_IPADDRESS_ISLOOPBACK_OFFSET UNITYSDK_OFFSET(0x195CD2D0)
#define SYSTEM_NET_IPADDRESS_MAPTOIPV4_OFFSET UNITYSDK_OFFSET(0x195CDA90)
#define SYSTEM_NET_IPADDRESS_MAPTOIPV6_OFFSET UNITYSDK_OFFSET(0x195CD9A0)
#define SYSTEM_NET_IPADDRESS_NETWORKTOHOSTORDER_1_OFFSET UNITYSDK_OFFSET(0x195CD260)
#define SYSTEM_NET_IPADDRESS_NETWORKTOHOSTORDER_2_OFFSET UNITYSDK_OFFSET(0x195CD2A0)
#define SYSTEM_NET_IPADDRESS_NETWORKTOHOSTORDER_OFFSET UNITYSDK_OFFSET(0x195CD1F0)
#define SYSTEM_NET_IPADDRESS_PARSE_OFFSET UNITYSDK_OFFSET(0x195CC730)
#define SYSTEM_NET_IPADDRESS_SET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x195CC7D0)
#define SYSTEM_NET_IPADDRESS_SET_SCOPEID_OFFSET UNITYSDK_OFFSET(0x195CCCA0)
#define SYSTEM_NET_IPADDRESS_SNAPSHOT_OFFSET UNITYSDK_OFFSET(0x195CD880)
#define SYSTEM_NET_IPADDRESS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195CCD50)
#define SYSTEM_NET_IPADDRESS_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x195CC3F0)
#define SYSTEM_NET_IPADDRESS__CCTOR_OFFSET UNITYSDK_OFFSET(0x195CDB40)
#define SYSTEM_NET_IPADDRESS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195CBFE0)
#define SYSTEM_NET_IPADDRESS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x195CC1C0)
#define SYSTEM_NET_IPADDRESS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x195CC210)
#define SYSTEM_NET_IPADDRESS__CTOR_4_OFFSET UNITYSDK_OFFSET(0x195CC3B0)
#define SYSTEM_NET_IPADDRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x195CBF70)
