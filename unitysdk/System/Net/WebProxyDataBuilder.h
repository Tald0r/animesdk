...
#define SYSTEM_NET_WEBPROXYDATABUILDER_BUILD_OFFSET UNITYSDK_OFFSET(0x1902EEF0)
#define SYSTEM_NET_WEBPROXYDATABUILDER_BYPASSSTRINGESCAPE_OFFSET UNITYSDK_OFFSET(0x1902FA10)
#define SYSTEM_NET_WEBPROXYDATABUILDER_CONVERTREGEXRESERVEDCHARS_OFFSET UNITYSDK_OFFSET(0x1902FEB0)
#define SYSTEM_NET_WEBPROXYDATABUILDER_CREATEINVALIDPROXYSTRINGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1902F880)
#define SYSTEM_NET_WEBPROXYDATABUILDER_PARSEBYPASSLIST_OFFSET UNITYSDK_OFFSET(0x1902F5E0)
#define SYSTEM_NET_WEBPROXYDATABUILDER_PARSEPROTOCOLPROXIES_OFFSET UNITYSDK_OFFSET(0x1902F1F0)
#define SYSTEM_NET_WEBPROXYDATABUILDER_PARSEPROXYURI_OFFSET UNITYSDK_OFFSET(0x1902F090)
#define SYSTEM_NET_WEBPROXYDATABUILDER_SETAUTODETECTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1902F860)
#define SYSTEM_NET_WEBPROXYDATABUILDER_SETAUTOPROXYURL_OFFSET UNITYSDK_OFFSET(0x1902F7B0)
#define SYSTEM_NET_WEBPROXYDATABUILDER_SETPROXYANDBYPASSLIST_OFFSET UNITYSDK_OFFSET(0x1902EF40)
#define SYSTEM_NET_WEBPROXYDATABUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19030040)
