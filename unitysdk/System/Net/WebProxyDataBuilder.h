...
#define SYSTEM_NET_WEBPROXYDATABUILDER_BUILD_OFFSET UNITYSDK_OFFSET(0x19444E00)
#define SYSTEM_NET_WEBPROXYDATABUILDER_BYPASSSTRINGESCAPE_OFFSET UNITYSDK_OFFSET(0x19445920)
#define SYSTEM_NET_WEBPROXYDATABUILDER_CONVERTREGEXRESERVEDCHARS_OFFSET UNITYSDK_OFFSET(0x19445DC0)
#define SYSTEM_NET_WEBPROXYDATABUILDER_CREATEINVALIDPROXYSTRINGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x19445790)
#define SYSTEM_NET_WEBPROXYDATABUILDER_PARSEBYPASSLIST_OFFSET UNITYSDK_OFFSET(0x194454F0)
#define SYSTEM_NET_WEBPROXYDATABUILDER_PARSEPROTOCOLPROXIES_OFFSET UNITYSDK_OFFSET(0x19445100)
#define SYSTEM_NET_WEBPROXYDATABUILDER_PARSEPROXYURI_OFFSET UNITYSDK_OFFSET(0x19444FA0)
#define SYSTEM_NET_WEBPROXYDATABUILDER_SETAUTODETECTSETTINGS_OFFSET UNITYSDK_OFFSET(0x19445770)
#define SYSTEM_NET_WEBPROXYDATABUILDER_SETAUTOPROXYURL_OFFSET UNITYSDK_OFFSET(0x194456C0)
#define SYSTEM_NET_WEBPROXYDATABUILDER_SETPROXYANDBYPASSLIST_OFFSET UNITYSDK_OFFSET(0x19444E50)
#define SYSTEM_NET_WEBPROXYDATABUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19445F50)
