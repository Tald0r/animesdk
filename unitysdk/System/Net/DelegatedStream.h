...
#define SYSTEM_NET_DELEGATEDSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x19372470)
#define SYSTEM_NET_DELEGATEDSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x19372560)
#define SYSTEM_NET_DELEGATEDSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x19372640)
#define SYSTEM_NET_DELEGATEDSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x19372670)
#define SYSTEM_NET_DELEGATEDSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x19372720)
#define SYSTEM_NET_DELEGATEDSTREAM_FLUSHASYNC_OFFSET UNITYSDK_OFFSET(0x193727F0)
#define SYSTEM_NET_DELEGATEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x193727C0)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_BASESTREAM_OFFSET UNITYSDK_OFFSET(0x193721E0)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x193721F0)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x19372220)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x19372250)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x19372280)
#define SYSTEM_NET_DELEGATEDSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x19372320)
#define SYSTEM_NET_DELEGATEDSTREAM_READASYNC_OFFSET UNITYSDK_OFFSET(0x193728E0)
#define SYSTEM_NET_DELEGATEDSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x19372820)
#define SYSTEM_NET_DELEGATEDSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x193729B0)
#define SYSTEM_NET_DELEGATEDSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x19372A60)
#define SYSTEM_NET_DELEGATEDSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x193723C0)
#define SYSTEM_NET_DELEGATEDSTREAM_WRITEASYNC_OFFSET UNITYSDK_OFFSET(0x19372BC0)
#define SYSTEM_NET_DELEGATEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x19372B10)
#define SYSTEM_NET_DELEGATEDSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19372120)
#define SYSTEM_NET_DELEGATEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19372100)
