...
#define SYSTEM_NET_SERVICENAMESTORE_ADDSINGLESERVICENAME_OFFSET UNITYSDK_OFFSET(0x1942C480)
#define SYSTEM_NET_SERVICENAMESTORE_ADD_OFFSET UNITYSDK_OFFSET(0x1942C500)
#define SYSTEM_NET_SERVICENAMESTORE_BUILDSERVICENAMES_OFFSET UNITYSDK_OFFSET(0x1942C5C0)
#define SYSTEM_NET_SERVICENAMESTORE_BUILDSIMPLESERVICENAME_OFFSET UNITYSDK_OFFSET(0x1942CA40)
#define SYSTEM_NET_SERVICENAMESTORE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1942CBC0)
#define SYSTEM_NET_SERVICENAMESTORE_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1942C4E0)
#define SYSTEM_NET_SERVICENAMESTORE_EXTRACTHOSTNAME_OFFSET UNITYSDK_OFFSET(0x1942CC10)
#define SYSTEM_NET_SERVICENAMESTORE_GET_SERVICENAMES_OFFSET UNITYSDK_OFFSET(0x19425A30)
#define SYSTEM_NET_SERVICENAMESTORE_REMOVE_OFFSET UNITYSDK_OFFSET(0x1942C9D0)
#define SYSTEM_NET_SERVICENAMESTORE__CTOR_OFFSET UNITYSDK_OFFSET(0x19425640)
