...
#define SYSTEM_NET_TIMERTHREAD_TIMERQUEUE_CREATETIMER_OFFSET UNITYSDK_OFFSET(0x1A5FAC10)
#define SYSTEM_NET_TIMERTHREAD_TIMERQUEUE_FIRE_OFFSET UNITYSDK_OFFSET(0x1A5FAE30)
#define SYSTEM_NET_TIMERTHREAD_TIMERQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5FAB90)
