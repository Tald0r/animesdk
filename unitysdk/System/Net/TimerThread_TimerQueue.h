...
#define SYSTEM_NET_TIMERTHREAD_TIMERQUEUE_CREATETIMER_OFFSET UNITYSDK_OFFSET(0x19FE1B90)
#define SYSTEM_NET_TIMERTHREAD_TIMERQUEUE_FIRE_OFFSET UNITYSDK_OFFSET(0x19FE1DB0)
#define SYSTEM_NET_TIMERTHREAD_TIMERQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE1B10)
