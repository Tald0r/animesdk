...
#define SYSTEM_NET_INTERLOCKEDGATE_COMPLETE_OFFSET UNITYSDK_OFFSET(0x868EA0)
#define SYSTEM_NET_INTERLOCKEDGATE_FINISHSIGNALING_OFFSET UNITYSDK_OFFSET(0x868E20)
#define SYSTEM_NET_INTERLOCKEDGATE_FINISHTRIGGERING_OFFSET UNITYSDK_OFFSET(0x868D20)
#define SYSTEM_NET_INTERLOCKEDGATE_RESET_OFFSET UNITYSDK_OFFSET(0x7A2900)
#define SYSTEM_NET_INTERLOCKEDGATE_STARTSIGNALING_OFFSET UNITYSDK_OFFSET(0x868DA0)
#define SYSTEM_NET_INTERLOCKEDGATE_STARTTRIGGERING_OFFSET UNITYSDK_OFFSET(0x868CA0)
#define SYSTEM_NET_INTERLOCKEDGATE_TRIGGER_OFFSET UNITYSDK_OFFSET(0x868C20)
