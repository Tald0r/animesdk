...
#define SYSTEM_NET_INTERLOCKEDGATE_COMPLETE_OFFSET UNITYSDK_OFFSET(0x897010)
#define SYSTEM_NET_INTERLOCKEDGATE_FINISHSIGNALING_OFFSET UNITYSDK_OFFSET(0x896F90)
#define SYSTEM_NET_INTERLOCKEDGATE_FINISHTRIGGERING_OFFSET UNITYSDK_OFFSET(0x896E90)
#define SYSTEM_NET_INTERLOCKEDGATE_RESET_OFFSET UNITYSDK_OFFSET(0x2F7610)
#define SYSTEM_NET_INTERLOCKEDGATE_STARTSIGNALING_OFFSET UNITYSDK_OFFSET(0x896F10)
#define SYSTEM_NET_INTERLOCKEDGATE_STARTTRIGGERING_OFFSET UNITYSDK_OFFSET(0x896E10)
#define SYSTEM_NET_INTERLOCKEDGATE_TRIGGER_OFFSET UNITYSDK_OFFSET(0x896D90)
