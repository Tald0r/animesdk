...
#define SYSTEM_NET_SERVICEPOINTMANAGER_CLOSECONNECTIONGROUP_OFFSET UNITYSDK_OFFSET(0x191CFDE0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_FINDSERVICEPOINT_1_OFFSET UNITYSDK_OFFSET(0x191CFD50)
#define SYSTEM_NET_SERVICEPOINTMANAGER_FINDSERVICEPOINT_2_OFFSET UNITYSDK_OFFSET(0x191CF3C0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_FINDSERVICEPOINT_OFFSET UNITYSDK_OFFSET(0x191CF390)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GETLEGACYCERTIFICATEPOLICY_OFFSET UNITYSDK_OFFSET(0x191CEB70)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GETMUSTIMPLEMENT_OFFSET UNITYSDK_OFFSET(0x191CECB0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_CERTIFICATEPOLICY_OFFSET UNITYSDK_OFFSET(0x191CEA40)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_CHECKCERTIFICATEREVOCATIONLIST_OFFSET UNITYSDK_OFFSET(0x191CEBA0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_DEFAULTCONNECTIONLIMIT_OFFSET UNITYSDK_OFFSET(0x191CEC20)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_DISABLESENDAUXRECORD_OFFSET UNITYSDK_OFFSET(0x191CF2A0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_DISABLESTRONGCRYPTO_OFFSET UNITYSDK_OFFSET(0x191CF290)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_DNSREFRESHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x191CED60)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_ENABLEDNSROUNDROBIN_OFFSET UNITYSDK_OFFSET(0x191CEDD0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_ENCRYPTIONPOLICY_OFFSET UNITYSDK_OFFSET(0x191CF1A0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_EXPECT100CONTINUE_OFFSET UNITYSDK_OFFSET(0x191CF1B0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_MAXSERVICEPOINTIDLETIME_OFFSET UNITYSDK_OFFSET(0x191CEE50)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_MAXSERVICEPOINTS_OFFSET UNITYSDK_OFFSET(0x191CEF00)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_REUSEPORT_OFFSET UNITYSDK_OFFSET(0x191CEFB0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_SECURITYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x191CF010)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_SERVERCERTIFICATEVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x191CF0A0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_SERVERCERTVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x191CF070)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_USENAGLEALGORITHM_OFFSET UNITYSDK_OFFSET(0x191CF220)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SETTCPKEEPALIVE_OFFSET UNITYSDK_OFFSET(0x191CF2B0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_CERTIFICATEPOLICY_OFFSET UNITYSDK_OFFSET(0x191CEB30)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_CHECKCERTIFICATEREVOCATIONLIST_OFFSET UNITYSDK_OFFSET(0x191CEBE0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_DEFAULTCONNECTIONLIMIT_OFFSET UNITYSDK_OFFSET(0x191CEC50)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_DNSREFRESHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x191CED90)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_ENABLEDNSROUNDROBIN_OFFSET UNITYSDK_OFFSET(0x191CEE10)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_EXPECT100CONTINUE_OFFSET UNITYSDK_OFFSET(0x191CF1F0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_MAXSERVICEPOINTIDLETIME_OFFSET UNITYSDK_OFFSET(0x191CEE80)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_MAXSERVICEPOINTS_OFFSET UNITYSDK_OFFSET(0x191CEF30)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_REUSEPORT_OFFSET UNITYSDK_OFFSET(0x191CEFC0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_SECURITYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x191CF040)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_SERVERCERTIFICATEVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x191CF120)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_USENAGLEALGORITHM_OFFSET UNITYSDK_OFFSET(0x191CF260)
#define SYSTEM_NET_SERVICEPOINTMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x191CE9D0)
#define SYSTEM_NET_SERVICEPOINTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x191CEA30)
