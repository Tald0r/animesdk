...
#define SYSTEM_NET_SERVICEPOINTMANAGER_CLOSECONNECTIONGROUP_OFFSET UNITYSDK_OFFSET(0x18D87110)
#define SYSTEM_NET_SERVICEPOINTMANAGER_FINDSERVICEPOINT_1_OFFSET UNITYSDK_OFFSET(0x18D87080)
#define SYSTEM_NET_SERVICEPOINTMANAGER_FINDSERVICEPOINT_2_OFFSET UNITYSDK_OFFSET(0x18D866F0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_FINDSERVICEPOINT_OFFSET UNITYSDK_OFFSET(0x18D866C0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GETLEGACYCERTIFICATEPOLICY_OFFSET UNITYSDK_OFFSET(0x18D85EA0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GETMUSTIMPLEMENT_OFFSET UNITYSDK_OFFSET(0x18D85FE0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_CERTIFICATEPOLICY_OFFSET UNITYSDK_OFFSET(0x18D85D70)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_CHECKCERTIFICATEREVOCATIONLIST_OFFSET UNITYSDK_OFFSET(0x18D85ED0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_DEFAULTCONNECTIONLIMIT_OFFSET UNITYSDK_OFFSET(0x18D85F50)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_DISABLESENDAUXRECORD_OFFSET UNITYSDK_OFFSET(0x18D865D0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_DISABLESTRONGCRYPTO_OFFSET UNITYSDK_OFFSET(0x18D865C0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_DNSREFRESHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18D86090)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_ENABLEDNSROUNDROBIN_OFFSET UNITYSDK_OFFSET(0x18D86100)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_ENCRYPTIONPOLICY_OFFSET UNITYSDK_OFFSET(0x18D864D0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_EXPECT100CONTINUE_OFFSET UNITYSDK_OFFSET(0x18D864E0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_MAXSERVICEPOINTIDLETIME_OFFSET UNITYSDK_OFFSET(0x18D86180)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_MAXSERVICEPOINTS_OFFSET UNITYSDK_OFFSET(0x18D86230)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_REUSEPORT_OFFSET UNITYSDK_OFFSET(0x18D862E0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_SECURITYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x18D86340)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_SERVERCERTIFICATEVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x18D863D0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_SERVERCERTVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x18D863A0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_GET_USENAGLEALGORITHM_OFFSET UNITYSDK_OFFSET(0x18D86550)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SETTCPKEEPALIVE_OFFSET UNITYSDK_OFFSET(0x18D865E0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_CERTIFICATEPOLICY_OFFSET UNITYSDK_OFFSET(0x18D85E60)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_CHECKCERTIFICATEREVOCATIONLIST_OFFSET UNITYSDK_OFFSET(0x18D85F10)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_DEFAULTCONNECTIONLIMIT_OFFSET UNITYSDK_OFFSET(0x18D85F80)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_DNSREFRESHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18D860C0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_ENABLEDNSROUNDROBIN_OFFSET UNITYSDK_OFFSET(0x18D86140)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_EXPECT100CONTINUE_OFFSET UNITYSDK_OFFSET(0x18D86520)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_MAXSERVICEPOINTIDLETIME_OFFSET UNITYSDK_OFFSET(0x18D861B0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_MAXSERVICEPOINTS_OFFSET UNITYSDK_OFFSET(0x18D86260)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_REUSEPORT_OFFSET UNITYSDK_OFFSET(0x18D862F0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_SECURITYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x18D86370)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_SERVERCERTIFICATEVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x18D86450)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SET_USENAGLEALGORITHM_OFFSET UNITYSDK_OFFSET(0x18D86590)
#define SYSTEM_NET_SERVICEPOINTMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18D85D00)
#define SYSTEM_NET_SERVICEPOINTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D85D60)
...
namespace System::Net
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ServicePointManager_TypeDefinitionIndex)->GetStaticField(0xF14);
		}
		static ::System::Boolean* StaticGet__checkCRL()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ServicePointManager_TypeDefinitionIndex)->GetStaticField(0xF15);
		}
		static ::System::Boolean* StaticGet_useNagle()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ServicePointManager_TypeDefinitionIndex)->GetStaticField(0xF16);
		}
		static ::System::Boolean* StaticGet_expectContinue()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ServicePointManager_TypeDefinitionIndex)->GetStaticField(0xF17);
		}
		static ::System::Net::SecurityProtocolType* StaticGet__securityProtocol()
		{
			return (::System::Net::SecurityProtocolType*)Il2CppClass::FromTypeDefinitionIndex(ServicePointManager_TypeDefinitionIndex)->GetStaticField(0xF18);
		}
