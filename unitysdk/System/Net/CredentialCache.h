...
#define SYSTEM_NET_CREDENTIALCACHE_ADD_1_OFFSET UNITYSDK_OFFSET(0x18BB1010)
#define SYSTEM_NET_CREDENTIALCACHE_ADD_OFFSET UNITYSDK_OFFSET(0x18BB0DF0)
#define SYSTEM_NET_CREDENTIALCACHE_GETCREDENTIAL_1_OFFSET UNITYSDK_OFFSET(0x18BB18A0)
#define SYSTEM_NET_CREDENTIALCACHE_GETCREDENTIAL_OFFSET UNITYSDK_OFFSET(0x18BB14E0)
#define SYSTEM_NET_CREDENTIALCACHE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18BB1CD0)
#define SYSTEM_NET_CREDENTIALCACHE_GET_DEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18BB1D40)
#define SYSTEM_NET_CREDENTIALCACHE_GET_DEFAULTNETWORKCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18BB1DA0)
#define SYSTEM_NET_CREDENTIALCACHE_GET_ISDEFAULTINCACHE_OFFSET UNITYSDK_OFFSET(0x18BB0D30)
#define SYSTEM_NET_CREDENTIALCACHE_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x18BB13E0)
#define SYSTEM_NET_CREDENTIALCACHE_REMOVE_OFFSET UNITYSDK_OFFSET(0x18BB12A0)
#define SYSTEM_NET_CREDENTIALCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB0D40)
...
namespace System::Net
{
	...
	public:
		...
		::System::Int32 m_NumbDefaultCredInCache; // 0x20
