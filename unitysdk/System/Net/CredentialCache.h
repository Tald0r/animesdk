...
#define SYSTEM_NET_CREDENTIALCACHE_ADD_1_OFFSET UNITYSDK_OFFSET(0x185A02A0)
#define SYSTEM_NET_CREDENTIALCACHE_ADD_OFFSET UNITYSDK_OFFSET(0x185A0080)
#define SYSTEM_NET_CREDENTIALCACHE_GETCREDENTIAL_1_OFFSET UNITYSDK_OFFSET(0x185A0B30)
#define SYSTEM_NET_CREDENTIALCACHE_GETCREDENTIAL_OFFSET UNITYSDK_OFFSET(0x185A0770)
#define SYSTEM_NET_CREDENTIALCACHE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x185A0F60)
#define SYSTEM_NET_CREDENTIALCACHE_GET_DEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x185A0FD0)
#define SYSTEM_NET_CREDENTIALCACHE_GET_DEFAULTNETWORKCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x185A1030)
#define SYSTEM_NET_CREDENTIALCACHE_GET_ISDEFAULTINCACHE_OFFSET UNITYSDK_OFFSET(0x1859FFC0)
#define SYSTEM_NET_CREDENTIALCACHE_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x185A0670)
#define SYSTEM_NET_CREDENTIALCACHE_REMOVE_OFFSET UNITYSDK_OFFSET(0x185A0530)
#define SYSTEM_NET_CREDENTIALCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1859FFD0)
