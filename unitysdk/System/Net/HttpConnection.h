...
#define SYSTEM_NET_HTTPCONNECTION_BEGINREADREQUEST_OFFSET UNITYSDK_OFFSET(0x191C1800)
#define SYSTEM_NET_HTTPCONNECTION_CLOSESOCKET_OFFSET UNITYSDK_OFFSET(0x191C1680)
#define SYSTEM_NET_HTTPCONNECTION_CLOSE_1_OFFSET UNITYSDK_OFFSET(0x191C2420)
#define SYSTEM_NET_HTTPCONNECTION_CLOSE_OFFSET UNITYSDK_OFFSET(0x191C31C0)
#define SYSTEM_NET_HTTPCONNECTION_GETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x191C19C0)
#define SYSTEM_NET_HTTPCONNECTION_GETRESPONSESTREAM_OFFSET UNITYSDK_OFFSET(0x191C1BF0)
#define SYSTEM_NET_HTTPCONNECTION_GET_CLIENTCERTIFICATEERRORS_OFFSET UNITYSDK_OFFSET(0x191C14F0)
#define SYSTEM_NET_HTTPCONNECTION_GET_CLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x191C1500)
#define SYSTEM_NET_HTTPCONNECTION_GET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x191C1510)
#define SYSTEM_NET_HTTPCONNECTION_GET_ISSECURE_OFFSET UNITYSDK_OFFSET(0x191C15F0)
#define SYSTEM_NET_HTTPCONNECTION_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x191C1530)
#define SYSTEM_NET_HTTPCONNECTION_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x191C1600)
#define SYSTEM_NET_HTTPCONNECTION_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x191C15A0)
#define SYSTEM_NET_HTTPCONNECTION_GET_REUSES_OFFSET UNITYSDK_OFFSET(0x191C1520)
#define SYSTEM_NET_HTTPCONNECTION_GET_SSLSTREAM_OFFSET UNITYSDK_OFFSET(0x191C14E0)
#define SYSTEM_NET_HTTPCONNECTION_INIT_OFFSET UNITYSDK_OFFSET(0x191C13F0)
#define SYSTEM_NET_HTTPCONNECTION_ONREADINTERNAL_OFFSET UNITYSDK_OFFSET(0x191C1DE0)
#define SYSTEM_NET_HTTPCONNECTION_ONREAD_OFFSET UNITYSDK_OFFSET(0x191C1CF0)
#define SYSTEM_NET_HTTPCONNECTION_ONTIMEOUT_OFFSET UNITYSDK_OFFSET(0x191C1620)
#define SYSTEM_NET_HTTPCONNECTION_PROCESSINPUT_OFFSET UNITYSDK_OFFSET(0x191C2970)
#define SYSTEM_NET_HTTPCONNECTION_READLINE_OFFSET UNITYSDK_OFFSET(0x191C2CB0)
#define SYSTEM_NET_HTTPCONNECTION_REMOVECONNECTION_OFFSET UNITYSDK_OFFSET(0x191C2C60)
#define SYSTEM_NET_HTTPCONNECTION_SENDERROR_1_OFFSET UNITYSDK_OFFSET(0x191C2940)
#define SYSTEM_NET_HTTPCONNECTION_SENDERROR_OFFSET UNITYSDK_OFFSET(0x191C2210)
#define SYSTEM_NET_HTTPCONNECTION_SET_PREFIX_OFFSET UNITYSDK_OFFSET(0x191C1610)
#define SYSTEM_NET_HTTPCONNECTION_UNBIND_OFFSET UNITYSDK_OFFSET(0x191C17B0)
#define SYSTEM_NET_HTTPCONNECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x191C31D0)
#define SYSTEM_NET_HTTPCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x191C1070)
#define SYSTEM_NET_HTTPCONNECTION___CTOR_B__24_0_OFFSET UNITYSDK_OFFSET(0x191C3230)
...
namespace System::Net
{
	...
	public:
		...
		::System::Net::HttpListener* last_listener; // 0x18
		::System::Net::ListenerPrefix* prefix; // 0x20
		::Il2CppArray<::System::Byte>* buffer; // 0x28
		::System::Net::EndPointListener* epl; // 0x30
		::System::Security::Cryptography::X509Certificates::X509Certificate* cert; // 0x38
		::System::IO::Stream* stream; // 0x40
		::System::IO::MemoryStream* ms; // 0x48
		::System::Net::Sockets::Socket* sock; // 0x50
		::System::Text::StringBuilder* current_line; // 0x58
		::System::Threading::Timer* timer; // 0x60
		::System::Net::HttpListenerContext* context; // 0x68
		::System::Net::RequestStream* i_stream; // 0x70
		::Il2CppArray<::System::Int32>* client_cert_errors; // 0x78
		::System::Security::Cryptography::X509Certificates::X509Certificate2* client_cert; // 0x80
