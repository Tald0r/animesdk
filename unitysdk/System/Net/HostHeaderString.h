...
#define SYSTEM_NET_HOSTHEADERSTRING_CONVERT_OFFSET UNITYSDK_OFFSET(0x18F56740)
#define SYSTEM_NET_HOSTHEADERSTRING_COPY_OFFSET UNITYSDK_OFFSET(0x18F569C0)
#define SYSTEM_NET_HOSTHEADERSTRING_GET_BYTECOUNT_OFFSET UNITYSDK_OFFSET(0x18F56970)
#define SYSTEM_NET_HOSTHEADERSTRING_GET_BYTES_OFFSET UNITYSDK_OFFSET(0x18F569A0)
#define SYSTEM_NET_HOSTHEADERSTRING_GET_STRING_OFFSET UNITYSDK_OFFSET(0x18F56940)
#define SYSTEM_NET_HOSTHEADERSTRING_INIT_OFFSET UNITYSDK_OFFSET(0x18F56700)
#define SYSTEM_NET_HOSTHEADERSTRING_SET_STRING_OFFSET UNITYSDK_OFFSET(0x18F56950)
#define SYSTEM_NET_HOSTHEADERSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F56720)
#define SYSTEM_NET_HOSTHEADERSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x18F566F0)
