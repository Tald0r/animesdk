...
#define SYSTEM_NET_HTTPLISTENERREQUEST_GCCDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D7AFE0)
#define SYSTEM_NET_HTTPLISTENERREQUEST_GCCDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D7B010)
#define SYSTEM_NET_HTTPLISTENERREQUEST_GCCDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D7AD40)
#define SYSTEM_NET_HTTPLISTENERREQUEST_GCCDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18D7AD30)
