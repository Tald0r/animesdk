...
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTARGS_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x18FC9060)
#define SYSTEM_NET_WRITESTREAMCLOSEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18FC9040)
