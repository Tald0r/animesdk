...
#define SYSTEM_NET_ENDPOINTPERMISSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x19686320)
#define SYSTEM_NET_ENDPOINTPERMISSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x196863B0)
#define SYSTEM_NET_ENDPOINTPERMISSION_GET_HOSTNAME_OFFSET UNITYSDK_OFFSET(0x196862F0)
#define SYSTEM_NET_ENDPOINTPERMISSION_GET_PORT_OFFSET UNITYSDK_OFFSET(0x19686300)
#define SYSTEM_NET_ENDPOINTPERMISSION_GET_TRANSPORT_OFFSET UNITYSDK_OFFSET(0x19686310)
#define SYSTEM_NET_ENDPOINTPERMISSION_INTERSECTHOSTNAME_OFFSET UNITYSDK_OFFSET(0x19687050)
#define SYSTEM_NET_ENDPOINTPERMISSION_INTERSECT_1_OFFSET UNITYSDK_OFFSET(0x19687290)
#define SYSTEM_NET_ENDPOINTPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x19686F50)
#define SYSTEM_NET_ENDPOINTPERMISSION_ISSUBSETOF_1_OFFSET UNITYSDK_OFFSET(0x19686B40)
#define SYSTEM_NET_ENDPOINTPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x19686710)
#define SYSTEM_NET_ENDPOINTPERMISSION_RESOLVE_OFFSET UNITYSDK_OFFSET(0x19686880)
#define SYSTEM_NET_ENDPOINTPERMISSION_TONUMBER_OFFSET UNITYSDK_OFFSET(0x19686DB0)
#define SYSTEM_NET_ENDPOINTPERMISSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19686440)
#define SYSTEM_NET_ENDPOINTPERMISSION_UNDORESOLVE_OFFSET UNITYSDK_OFFSET(0x19687790)
#define SYSTEM_NET_ENDPOINTPERMISSION__CCTOR_OFFSET UNITYSDK_OFFSET(0x196877A0)
#define SYSTEM_NET_ENDPOINTPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19687810)
#define SYSTEM_NET_ENDPOINTPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19686260)
