...
#define SYSTEM_NET_ENDPOINTPERMISSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B24CD0)
#define SYSTEM_NET_ENDPOINTPERMISSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B24D60)
#define SYSTEM_NET_ENDPOINTPERMISSION_GET_HOSTNAME_OFFSET UNITYSDK_OFFSET(0x19B24CA0)
#define SYSTEM_NET_ENDPOINTPERMISSION_GET_PORT_OFFSET UNITYSDK_OFFSET(0x19B24CB0)
#define SYSTEM_NET_ENDPOINTPERMISSION_GET_TRANSPORT_OFFSET UNITYSDK_OFFSET(0x19B24CC0)
#define SYSTEM_NET_ENDPOINTPERMISSION_INTERSECTHOSTNAME_OFFSET UNITYSDK_OFFSET(0x19B25A00)
#define SYSTEM_NET_ENDPOINTPERMISSION_INTERSECT_1_OFFSET UNITYSDK_OFFSET(0x19B25C40)
#define SYSTEM_NET_ENDPOINTPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x19B25900)
#define SYSTEM_NET_ENDPOINTPERMISSION_ISSUBSETOF_1_OFFSET UNITYSDK_OFFSET(0x19B254F0)
#define SYSTEM_NET_ENDPOINTPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x19B250C0)
#define SYSTEM_NET_ENDPOINTPERMISSION_RESOLVE_OFFSET UNITYSDK_OFFSET(0x19B25230)
#define SYSTEM_NET_ENDPOINTPERMISSION_TONUMBER_OFFSET UNITYSDK_OFFSET(0x19B25760)
#define SYSTEM_NET_ENDPOINTPERMISSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B24DF0)
#define SYSTEM_NET_ENDPOINTPERMISSION_UNDORESOLVE_OFFSET UNITYSDK_OFFSET(0x19B26140)
#define SYSTEM_NET_ENDPOINTPERMISSION__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B26150)
#define SYSTEM_NET_ENDPOINTPERMISSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B261C0)
#define SYSTEM_NET_ENDPOINTPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19B24C10)
