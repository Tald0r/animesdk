...
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x195DC350)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_GET_ACCEPTPATTERN_OFFSET UNITYSDK_OFFSET(0x195DC110)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_GET_ACCEPT_OFFSET UNITYSDK_OFFSET(0x195DBDD0)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_GET_CONNECTPATTERN_OFFSET UNITYSDK_OFFSET(0x195DBED0)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_GET_CONNECT_OFFSET UNITYSDK_OFFSET(0x195DBCD0)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_SET_ACCEPTPATTERN_OFFSET UNITYSDK_OFFSET(0x195DC1B0)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_SET_ACCEPT_OFFSET UNITYSDK_OFFSET(0x195DBDF0)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_SET_CONNECTPATTERN_OFFSET UNITYSDK_OFFSET(0x195DBF70)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_SET_CONNECT_OFFSET UNITYSDK_OFFSET(0x195DBCF0)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x195DBCC0)
...
namespace System::Net
{
	...
	{
	public:
		::System::Object* m_accept; // 0x18
		::System::Object* m_connect; // 0x20
