...
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_CREATEPERMISSION_OFFSET UNITYSDK_OFFSET(0x191DFFA0)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_GET_ACCEPTPATTERN_OFFSET UNITYSDK_OFFSET(0x191DFD60)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_GET_ACCEPT_OFFSET UNITYSDK_OFFSET(0x191DFA20)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_GET_CONNECTPATTERN_OFFSET UNITYSDK_OFFSET(0x191DFB20)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_GET_CONNECT_OFFSET UNITYSDK_OFFSET(0x191DF920)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_SET_ACCEPTPATTERN_OFFSET UNITYSDK_OFFSET(0x191DFE00)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_SET_ACCEPT_OFFSET UNITYSDK_OFFSET(0x191DFA40)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_SET_CONNECTPATTERN_OFFSET UNITYSDK_OFFSET(0x191DFBC0)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE_SET_CONNECT_OFFSET UNITYSDK_OFFSET(0x191DF940)
#define SYSTEM_NET_WEBPERMISSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x191DF910)
