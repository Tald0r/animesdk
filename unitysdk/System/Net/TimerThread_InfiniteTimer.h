...
#define SYSTEM_NET_TIMERTHREAD_INFINITETIMER_CANCEL_OFFSET UNITYSDK_OFFSET(0x182E4870)
#define SYSTEM_NET_TIMERTHREAD_INFINITETIMER_GET_HASEXPIRED_OFFSET UNITYSDK_OFFSET(0x182E4860)
#define SYSTEM_NET_TIMERTHREAD_INFINITETIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x182E4810)
