...
#define SYSTEM_NET_SERVICEPOINTMANAGER_SPKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1932A270)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SPKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1932A1F0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SPKEY_GET_URI_OFFSET UNITYSDK_OFFSET(0x1932A1A0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SPKEY_GET_USECONNECT_OFFSET UNITYSDK_OFFSET(0x1932A1B0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SPKEY_GET_USESPROXY_OFFSET UNITYSDK_OFFSET(0x1932A1C0)
#define SYSTEM_NET_SERVICEPOINTMANAGER_SPKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1932A190)
