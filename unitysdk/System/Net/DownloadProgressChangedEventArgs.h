...
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTARGS_GET_BYTESRECEIVED_OFFSET UNITYSDK_OFFSET(0x18B73FB0)
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTARGS_GET_TOTALBYTESTORECEIVE_OFFSET UNITYSDK_OFFSET(0x18B73FC0)
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B73FD0)
#define SYSTEM_NET_DOWNLOADPROGRESSCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18B73F60)
