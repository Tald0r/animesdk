...
#define SYSTEM_NET_HTTPABORTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19687E00)
#define SYSTEM_NET_HTTPABORTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19687E40)
#define SYSTEM_NET_HTTPABORTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19687860)
#define SYSTEM_NET_HTTPABORTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19687850)
