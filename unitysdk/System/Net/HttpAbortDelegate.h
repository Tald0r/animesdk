...
#define SYSTEM_NET_HTTPABORTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19B267C0)
#define SYSTEM_NET_HTTPABORTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19B26800)
#define SYSTEM_NET_HTTPABORTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19B26220)
#define SYSTEM_NET_HTTPABORTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B26200)
