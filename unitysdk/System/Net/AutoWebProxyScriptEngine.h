...
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_ABORT_OFFSET UNITYSDK_OFFSET(0x195CA0A0)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_CHECKFORCHANGES_OFFSET UNITYSDK_OFFSET(0x195CA0B0)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_CLOSE_OFFSET UNITYSDK_OFFSET(0x195CA090)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_GETPROXIES_1_OFFSET UNITYSDK_OFFSET(0x195CA080)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_GETPROXIES_OFFSET UNITYSDK_OFFSET(0x195CA070)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_GET_AUTOMATICALLYDETECTSETTINGS_OFFSET UNITYSDK_OFFSET(0x195CA050)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_GET_AUTOMATICCONFIGURATIONSCRIPT_OFFSET UNITYSDK_OFFSET(0x195CA030)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_SET_AUTOMATICALLYDETECTSETTINGS_OFFSET UNITYSDK_OFFSET(0x195CA060)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_SET_AUTOMATICCONFIGURATIONSCRIPT_OFFSET UNITYSDK_OFFSET(0x195CA040)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE__CTOR_OFFSET UNITYSDK_OFFSET(0x195CA020)
