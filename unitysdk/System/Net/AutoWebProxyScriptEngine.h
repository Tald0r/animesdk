...
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_ABORT_OFFSET UNITYSDK_OFFSET(0x191CDD10)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_CHECKFORCHANGES_OFFSET UNITYSDK_OFFSET(0x191CDD20)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_CLOSE_OFFSET UNITYSDK_OFFSET(0x191CDD00)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_GETPROXIES_1_OFFSET UNITYSDK_OFFSET(0x191CDCF0)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_GETPROXIES_OFFSET UNITYSDK_OFFSET(0x191CDCE0)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_GET_AUTOMATICALLYDETECTSETTINGS_OFFSET UNITYSDK_OFFSET(0x191CDCC0)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_GET_AUTOMATICCONFIGURATIONSCRIPT_OFFSET UNITYSDK_OFFSET(0x191CDCA0)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_SET_AUTOMATICALLYDETECTSETTINGS_OFFSET UNITYSDK_OFFSET(0x191CDCD0)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE_SET_AUTOMATICCONFIGURATIONSCRIPT_OFFSET UNITYSDK_OFFSET(0x191CDCB0)
#define SYSTEM_NET_AUTOWEBPROXYSCRIPTENGINE__CTOR_OFFSET UNITYSDK_OFFSET(0x191CDC90)
