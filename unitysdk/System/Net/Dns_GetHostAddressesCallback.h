...
#define SYSTEM_NET_DNS_GETHOSTADDRESSESCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19686220)
#define SYSTEM_NET_DNS_GETHOSTADDRESSESCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19686250)
#define SYSTEM_NET_DNS_GETHOSTADDRESSESCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19685CE0)
#define SYSTEM_NET_DNS_GETHOSTADDRESSESCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19685CD0)
