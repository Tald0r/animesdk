...
#define SYSTEM_NET_DNS_GETHOSTADDRESSESCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19B24BD0)
#define SYSTEM_NET_DNS_GETHOSTADDRESSESCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19B24C00)
#define SYSTEM_NET_DNS_GETHOSTADDRESSESCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19B24690)
#define SYSTEM_NET_DNS_GETHOSTADDRESSESCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19B24670)
