...
#define SYSTEM_NET_HTTPLISTENERREQUEST_CONTEXT_GETCHANNELBINDING_OFFSET UNITYSDK_OFFSET(0x19B26C60)
#define SYSTEM_NET_HTTPLISTENERREQUEST_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B26CB0)
