...
#define SYSTEM_NET_HTTPLISTENERREQUEST_CONTEXT_GETCHANNELBINDING_OFFSET UNITYSDK_OFFSET(0x19688290)
#define SYSTEM_NET_HTTPLISTENERREQUEST_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x196882E0)
