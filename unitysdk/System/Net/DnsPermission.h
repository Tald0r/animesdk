...
#define SYSTEM_NET_DNSPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x1A5F5390)
#define SYSTEM_NET_DNSPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x1A5F53D0)
#define SYSTEM_NET_DNSPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x1A5F5410)
#define SYSTEM_NET_DNSPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x1A5F5450)
#define SYSTEM_NET_DNSPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1A5F5490)
#define SYSTEM_NET_DNSPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x1A5F54D0)
#define SYSTEM_NET_DNSPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F5350)
