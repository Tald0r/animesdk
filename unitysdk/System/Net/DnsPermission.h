...
#define SYSTEM_NET_DNSPERMISSION_COPY_OFFSET UNITYSDK_OFFSET(0x19FDC350)
#define SYSTEM_NET_DNSPERMISSION_FROMXML_OFFSET UNITYSDK_OFFSET(0x19FDC390)
#define SYSTEM_NET_DNSPERMISSION_INTERSECT_OFFSET UNITYSDK_OFFSET(0x19FDC3D0)
#define SYSTEM_NET_DNSPERMISSION_ISSUBSETOF_OFFSET UNITYSDK_OFFSET(0x19FDC410)
#define SYSTEM_NET_DNSPERMISSION_ISUNRESTRICTED_OFFSET UNITYSDK_OFFSET(0x19FDC450)
#define SYSTEM_NET_DNSPERMISSION_TOXML_OFFSET UNITYSDK_OFFSET(0x19FDC490)
#define SYSTEM_NET_DNSPERMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19FDC310)
