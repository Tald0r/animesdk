...
#define SYSTEM_NET_COOKIEEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x188F0F30)
#define SYSTEM_NET_COOKIEEXCEPTION_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x188F0F10)
#define SYSTEM_NET_COOKIEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x188F0DE0)
#define SYSTEM_NET_COOKIEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x188F0E50)
#define SYSTEM_NET_COOKIEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x188F0EC0)
#define SYSTEM_NET_COOKIEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188F0D40)
