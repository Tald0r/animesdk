...
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x19691230)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_CLEAR_OFFSET UNITYSDK_OFFSET(0x19691240)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x19690EB0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19691210)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_INTERNALGET_OFFSET UNITYSDK_OFFSET(0x19690ED0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_INTERNALSET_OFFSET UNITYSDK_OFFSET(0x19691060)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_PERSISTVALUE_OFFSET UNITYSDK_OFFSET(0x19690A20)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_REMOVE_OFFSET UNITYSDK_OFFSET(0x19691340)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x19690EC0)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19691220)
#define SYSTEM_NET_TRACKINGVALIDATIONOBJECTDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x196909B0)
...
namespace System::Net
{
	...
	{
	public:
		::System::Collections::Generic::IDictionary_2<::System::String*, ::System::Net::TrackingValidationObjectDictionary_ValidateAndParseValue*>* validators; // 0x18
		::System::Collections::Generic::IDictionary_2<::System::String*, ::System::Object*>* internalObjects; // 0x20
