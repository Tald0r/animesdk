...
#define SYSTEM_NET_HTTPWEBREQUEST_ABORT_OFFSET UNITYSDK_OFFSET(0x18FEBC00)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_1_OFFSET UNITYSDK_OFFSET(0x18FEAFD0)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_2_OFFSET UNITYSDK_OFFSET(0x18FEB350)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_3_OFFSET UNITYSDK_OFFSET(0x18FEB360)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_4_OFFSET UNITYSDK_OFFSET(0x18FEB370)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_5_OFFSET UNITYSDK_OFFSET(0x18FEB380)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_6_OFFSET UNITYSDK_OFFSET(0x18FEACB0)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_7_OFFSET UNITYSDK_OFFSET(0x18FEAFF0)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_OFFSET UNITYSDK_OFFSET(0x18FEACA0)
#define SYSTEM_NET_HTTPWEBREQUEST_BEGINGETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x18FEB3A0)
#define SYSTEM_NET_HTTPWEBREQUEST_BEGINGETRESPONSE_OFFSET UNITYSDK_OFFSET(0x18FEC310)
#define SYSTEM_NET_HTTPWEBREQUEST_CHECKAUTHORIZATION_OFFSET UNITYSDK_OFFSET(0x18FF1180)
#define SYSTEM_NET_HTTPWEBREQUEST_CHECKFINALSTATUS_OFFSET UNITYSDK_OFFSET(0x18FF0680)
#define SYSTEM_NET_HTTPWEBREQUEST_CHECKIFFORCEWRITE_OFFSET UNITYSDK_OFFSET(0x18FEC1F0)
#define SYSTEM_NET_HTTPWEBREQUEST_CHECKREQUESTSTARTED_OFFSET UNITYSDK_OFFSET(0x18FE8620)
#define SYSTEM_NET_HTTPWEBREQUEST_CHECKSENDERROR_OFFSET UNITYSDK_OFFSET(0x18FEF7B0)
#define SYSTEM_NET_HTTPWEBREQUEST_CHECKVALIDHOST_OFFSET UNITYSDK_OFFSET(0x18FE9840)
#define SYSTEM_NET_HTTPWEBREQUEST_DOCONTINUEDELEGATE_OFFSET UNITYSDK_OFFSET(0x18FECF20)
#define SYSTEM_NET_HTTPWEBREQUEST_DOPREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x18FEE5E0)
#define SYSTEM_NET_HTTPWEBREQUEST_ENDGETREQUESTSTREAM_1_OFFSET UNITYSDK_OFFSET(0x18FEC780)
#define SYSTEM_NET_HTTPWEBREQUEST_ENDGETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x18FEB8F0)
#define SYSTEM_NET_HTTPWEBREQUEST_ENDGETRESPONSE_OFFSET UNITYSDK_OFFSET(0x18FEC670)
#define SYSTEM_NET_HTTPWEBREQUEST_GENERATECONNECTIONGROUP_OFFSET UNITYSDK_OFFSET(0x18FF11D0)
#define SYSTEM_NET_HTTPWEBREQUEST_GETHEADERS_OFFSET UNITYSDK_OFFSET(0x18FED870)
#define SYSTEM_NET_HTTPWEBREQUEST_GETMUSTIMPLEMENT_OFFSET UNITYSDK_OFFSET(0x18FE8760)
#define SYSTEM_NET_HTTPWEBREQUEST_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18FEC850)
#define SYSTEM_NET_HTTPWEBREQUEST_GETREQUESTHEADERS_OFFSET UNITYSDK_OFFSET(0x18FEEC30)
#define SYSTEM_NET_HTTPWEBREQUEST_GETREQUESTSTREAM_1_OFFSET UNITYSDK_OFFSET(0x18FEC1A0)
#define SYSTEM_NET_HTTPWEBREQUEST_GETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x18FEB9D0)
#define SYSTEM_NET_HTTPWEBREQUEST_GETRESPONSE_OFFSET UNITYSDK_OFFSET(0x18FEC790)
#define SYSTEM_NET_HTTPWEBREQUEST_GETSERVICEPOINT_OFFSET UNITYSDK_OFFSET(0x18FEA460)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_ABORTED_OFFSET UNITYSDK_OFFSET(0x18FEB8D0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_ACCEPT_OFFSET UNITYSDK_OFFSET(0x18FE8560)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x18FE8690)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_ALLOWAUTOREDIRECT_OFFSET UNITYSDK_OFFSET(0x18FE86B0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_ALLOWREADSTREAMBUFFERING_OFFSET UNITYSDK_OFFSET(0x18FE86F0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_ALLOWWRITESTREAMBUFFERING_OFFSET UNITYSDK_OFFSET(0x18FE86D0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_AUTHURI_OFFSET UNITYSDK_OFFSET(0x18FEABD0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_AUTOMATICDECOMPRESSION_OFFSET UNITYSDK_OFFSET(0x18FE8810)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x18FE8AF0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CONNECTIONGROUPNAME_OFFSET UNITYSDK_OFFSET(0x18FE8E90)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CONNECTION_OFFSET UNITYSDK_OFFSET(0x18FE8C00)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x18FE8EB0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x18FE8FD0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CONTINUEDELEGATE_OFFSET UNITYSDK_OFFSET(0x18FE9020)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CONTINUETIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FE9DC0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_COOKIECONTAINER_OFFSET UNITYSDK_OFFSET(0x18FE9040)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18FE9060)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_DATE_OFFSET UNITYSDK_OFFSET(0x18FE9080)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_DEFAULTMAXIMUMERRORRESPONSELENGTH_OFFSET UNITYSDK_OFFSET(0x18FE91D0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_DEFAULTMAXIMUMRESPONSEHEADERSLENGTH_OFFSET UNITYSDK_OFFSET(0x18FE9CC0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_EXPECTCONTINUE_OFFSET UNITYSDK_OFFSET(0x18FEABB0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_EXPECT_OFFSET UNITYSDK_OFFSET(0x18FE9250)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_FINISHEDREADING_OFFSET UNITYSDK_OFFSET(0x18FEC820)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_GOTREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x18FEABA0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_HAVERESPONSE_OFFSET UNITYSDK_OFFSET(0x18FE9440)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x18FE9450)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_HOST_OFFSET UNITYSDK_OFFSET(0x18FE9660)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_IFMODIFIEDSINCE_OFFSET UNITYSDK_OFFSET(0x18FE9940)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_INTERNALALLOWBUFFERING_OFFSET UNITYSDK_OFFSET(0x18FE88A0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x18FE9C00)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_MAXIMUMAUTOMATICREDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x18FE9C20)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_MAXIMUMRESPONSEHEADERSLENGTH_OFFSET UNITYSDK_OFFSET(0x18FE9CA0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_MEDIATYPE_OFFSET UNITYSDK_OFFSET(0x18FE9E60)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_METHODWITHBUFFER_OFFSET UNITYSDK_OFFSET(0x18FE89C0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x18FE9E80)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_PIPELINED_OFFSET UNITYSDK_OFFSET(0x18FEA110)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x18FEA130)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x18FEA150)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_PROXYQUERY_OFFSET UNITYSDK_OFFSET(0x18FEABE0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_PROXY_OFFSET UNITYSDK_OFFSET(0x18FEA3C0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_READWRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FE9D20)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_REFERER_OFFSET UNITYSDK_OFFSET(0x18FEA570)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_REQUESTURI_OFFSET UNITYSDK_OFFSET(0x18FEA6D0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_REUSECONNECTION_OFFSET UNITYSDK_OFFSET(0x18FF11B0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_SENDCHUNKED_OFFSET UNITYSDK_OFFSET(0x18FEA6E0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_SERVERCERTIFICATEVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x18FEAC20)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_SERVERCERTVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x18FEAC10)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_SERVICEPOINTNOLOCK_OFFSET UNITYSDK_OFFSET(0x18FEA780)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_SERVICEPOINT_OFFSET UNITYSDK_OFFSET(0x18FEA770)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_SUPPORTSCOOKIECONTAINER_OFFSET UNITYSDK_OFFSET(0x18FEA790)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_THROWONERROR_OFFSET UNITYSDK_OFFSET(0x18FE8FB0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FEA7A0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_TLSPROVIDER_OFFSET UNITYSDK_OFFSET(0x18FE8AD0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_TLSSETTINGS_OFFSET UNITYSDK_OFFSET(0x18FE8AE0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_TRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x18FEA800)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_UNSAFEAUTHENTICATEDCONNECTIONSHARING_OFFSET UNITYSDK_OFFSET(0x18FEAB80)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18FEAA30)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_USERAGENT_OFFSET UNITYSDK_OFFSET(0x18FEAB10)
#define SYSTEM_NET_HTTPWEBREQUEST_HANDLENTLMAUTH_OFFSET UNITYSDK_OFFSET(0x18FEF8A0)
#define SYSTEM_NET_HTTPWEBREQUEST_REDIRECT_OFFSET UNITYSDK_OFFSET(0x18FECFB0)
#define SYSTEM_NET_HTTPWEBREQUEST_RESETAUTHORIZATION_OFFSET UNITYSDK_OFFSET(0x18FE7EC0)
#define SYSTEM_NET_HTTPWEBREQUEST_REWRITEREDIRECTTOGET_OFFSET UNITYSDK_OFFSET(0x18FECF40)
#define SYSTEM_NET_HTTPWEBREQUEST_SETDATEHEADERHELPER_OFFSET UNITYSDK_OFFSET(0x18FE9190)
#define SYSTEM_NET_HTTPWEBREQUEST_SETRESPONSEDATA_OFFSET UNITYSDK_OFFSET(0x18FEFBC0)
#define SYSTEM_NET_HTTPWEBREQUEST_SETRESPONSEERROR_OFFSET UNITYSDK_OFFSET(0x18FEF3F0)
#define SYSTEM_NET_HTTPWEBREQUEST_SETSPECIALHEADERS_OFFSET UNITYSDK_OFFSET(0x18FE8410)
#define SYSTEM_NET_HTTPWEBREQUEST_SETWRITESTREAMERROR_1_OFFSET UNITYSDK_OFFSET(0x18FEF3A0)
#define SYSTEM_NET_HTTPWEBREQUEST_SETWRITESTREAMERROR_OFFSET UNITYSDK_OFFSET(0x18FEE8B0)
#define SYSTEM_NET_HTTPWEBREQUEST_SETWRITESTREAMINNER_OFFSET UNITYSDK_OFFSET(0x18FEF360)
#define SYSTEM_NET_HTTPWEBREQUEST_SETWRITESTREAM_OFFSET UNITYSDK_OFFSET(0x18FEF230)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_ACCEPT_OFFSET UNITYSDK_OFFSET(0x18FE85A0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x18FE86A0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_ALLOWAUTOREDIRECT_OFFSET UNITYSDK_OFFSET(0x18FE86C0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_ALLOWREADSTREAMBUFFERING_OFFSET UNITYSDK_OFFSET(0x18FE8700)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_ALLOWWRITESTREAMBUFFERING_OFFSET UNITYSDK_OFFSET(0x18FE86E0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_AUTOMATICDECOMPRESSION_OFFSET UNITYSDK_OFFSET(0x18FE8820)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x18FE8B90)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CONNECTIONGROUPNAME_OFFSET UNITYSDK_OFFSET(0x18FE8EA0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CONNECTION_OFFSET UNITYSDK_OFFSET(0x18FE8C40)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x18FE8EC0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x18FE9010)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CONTINUEDELEGATE_OFFSET UNITYSDK_OFFSET(0x18FE9030)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CONTINUETIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FE9E10)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_COOKIECONTAINER_OFFSET UNITYSDK_OFFSET(0x18FE9050)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18FE9070)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_DATE_OFFSET UNITYSDK_OFFSET(0x18FE9140)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_DEFAULTMAXIMUMERRORRESPONSELENGTH_OFFSET UNITYSDK_OFFSET(0x18FE9210)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_DEFAULTMAXIMUMRESPONSEHEADERSLENGTH_OFFSET UNITYSDK_OFFSET(0x18FE9CF0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_EXPECTCONTINUE_OFFSET UNITYSDK_OFFSET(0x18FEABC0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_EXPECT_OFFSET UNITYSDK_OFFSET(0x18FE9290)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_FINISHEDREADING_OFFSET UNITYSDK_OFFSET(0x18FEC830)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_HEADERS_OFFSET UNITYSDK_OFFSET(0x18FE9460)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_HOST_OFFSET UNITYSDK_OFFSET(0x18FE9710)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_IFMODIFIEDSINCE_OFFSET UNITYSDK_OFFSET(0x18FE9AA0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_INTERNALCONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x18FE8FA0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x18FE9C10)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_MAXIMUMAUTOMATICREDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x18FE9C30)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_MAXIMUMRESPONSEHEADERSLENGTH_OFFSET UNITYSDK_OFFSET(0x18FE9CB0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_MEDIATYPE_OFFSET UNITYSDK_OFFSET(0x18FE9E70)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_METHOD_OFFSET UNITYSDK_OFFSET(0x18FE9E90)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_PIPELINED_OFFSET UNITYSDK_OFFSET(0x18FEA120)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x18FEA140)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x18FEA160)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_PROXY_OFFSET UNITYSDK_OFFSET(0x18FEA3D0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_READWRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FE9D30)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_REFERER_OFFSET UNITYSDK_OFFSET(0x18FEA5B0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_REUSECONNECTION_OFFSET UNITYSDK_OFFSET(0x18FF11C0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_SENDCHUNKED_OFFSET UNITYSDK_OFFSET(0x18FEA6F0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_SERVERCERTIFICATEVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x18FEAC40)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_THROWONERROR_OFFSET UNITYSDK_OFFSET(0x18FE8FC0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FEA7B0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_TRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x18FEA840)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_UNSAFEAUTHENTICATEDCONNECTIONSHARING_OFFSET UNITYSDK_OFFSET(0x18FEAB90)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18FEAAA0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_USERAGENT_OFFSET UNITYSDK_OFFSET(0x18FEAB50)
#define SYSTEM_NET_HTTPWEBREQUEST_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18FEC840)
#define SYSTEM_NET_HTTPWEBREQUEST__CCTOR_OFFSET UNITYSDK_OFFSET(0x18FE7D20)
#define SYSTEM_NET_HTTPWEBREQUEST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FE7EF0)
#define SYSTEM_NET_HTTPWEBREQUEST__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FE7F20)
#define SYSTEM_NET_HTTPWEBREQUEST__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18FF1600)
#define SYSTEM_NET_HTTPWEBREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE7D30)
#define SYSTEM_NET_HTTPWEBREQUEST__SETWRITESTREAMINNER_B__259_0_OFFSET UNITYSDK_OFFSET(0x18FF1440)
#define SYSTEM_NET_HTTPWEBREQUEST__SETWRITESTREAM_B__258_0_OFFSET UNITYSDK_OFFSET(0x18FF12A0)
#define SYSTEM_NET_HTTPWEBREQUEST__SETWRITESTREAM_B__258_1_OFFSET UNITYSDK_OFFSET(0x18FF1370)
...
namespace System::Net
{
	...
	public:
		...
		::System::Net::WebConnection* WebConnection; // 0x40
		::System::Security::Cryptography::X509Certificates::X509CertificateCollection* certificates; // 0x48
		::System::Net::ICredentials* credentials; // 0x50
		::System::Net::HttpWebResponse* webResponse; // 0x58
		::System::EventHandler* abortHandler; // 0x60
		::System::Net::ServicePoint* servicePoint; // 0x68
		::System::Version* version; // 0x70
		::System::Net::CookieContainer* cookieContainer; // 0x78
		::System::Action_1<::System::IO::Stream*>* ResendContentFactory; // 0x80
		::System::String* host; // 0x88
		::System::Net::WebAsyncResult* asyncWrite; // 0x90
		::System::Net::WebAsyncResult* asyncRead; // 0x98
		::System::Version* actualVersion; // 0xA0
		::System::Net::HttpWebRequest_AuthorizationState proxy_auth_state; // 0xA8
		::System::Net::WebHeaderCollection* webHeaders; // 0xB8
		::Il2CppArray<::System::Byte>* bodyBuffer; // 0xC0
		::System::String* mediaType; // 0xC8
		::Mono::Security::Interface::MonoTlsSettings* tlsSettings; // 0xD0
		::System::Net::IWebProxy* proxy; // 0xD8
		::System::Exception* saved_exc; // 0xE0
		::System::Net::HttpContinueDelegate* continueDelegate; // 0xE8
		::System::String* initialMethod; // 0xF0
		::System::Object* locker; // 0xF8
		::System::Uri* actualUri; // 0x100
		::System::Net::ServerCertValidationCallback* certValidationCallback; // 0x108
		::System::Net::WebConnection* StoredConnection; // 0x110
		::System::String* connectionGroup; // 0x118
		::System::Net::HttpWebRequest_AuthorizationState auth_state; // 0x120
		::System::String* method; // 0x130
		::System::Net::WebConnectionStream* writeStream; // 0x138
		::Mono::Security::Interface::MonoTlsProvider* tlsProvider; // 0x140
		::System::Boolean preAuthenticate; // 0x148
		::System::Boolean haveResponse; // 0x149
		::System::Boolean expectContinue; // 0x14A
		::System::Boolean haveContentLength; // 0x14B
		::System::Int32 maxAutoRedirect; // 0x14C
		::System::Int32 aborted; // 0x150
		::System::Boolean _ReuseConnection_k__BackingField; // 0x154
		::System::Boolean getResponseCalled; // 0x155
		::System::Boolean pipelined; // 0x156
		::System::Boolean hostChanged; // 0x157
		::System::Int32 maxResponseHeadersLength; // 0x158
		::System::Boolean finished_reading; // 0x15C
		::System::Boolean usedPreAuth; // 0x15D
		::System::Boolean force_version; // 0x15E
		::System::Boolean sendChunked; // 0x15F
		::System::Int32 bodyBufferLength; // 0x160
		::System::Boolean keepAlive; // 0x164
		::System::Boolean _ThrowOnError_k__BackingField; // 0x165
		::System::Boolean allowAutoRedirect; // 0x166
		::System::Boolean unsafe_auth_blah; // 0x167
		::System::Net::DecompressionMethods auto_decomp; // 0x168
		::System::Int32 timeout; // 0x16C
		::System::Int32 readWriteTimeout; // 0x170
		::System::Int64 contentLength; // 0x178
		::System::Int32 redirects; // 0x180
		::System::Boolean haveRequest; // 0x184
		::System::Boolean requestSent; // 0x185
		::System::Boolean gotRequestStream; // 0x186
		::System::Boolean allowBuffering; // 0x187
