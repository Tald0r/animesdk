...
#define SYSTEM_NET_HTTPWEBREQUEST_ABORT_OFFSET UNITYSDK_OFFSET(0x1937D130)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_1_OFFSET UNITYSDK_OFFSET(0x1937C520)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_2_OFFSET UNITYSDK_OFFSET(0x1937C8A0)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_3_OFFSET UNITYSDK_OFFSET(0x1937C8B0)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_4_OFFSET UNITYSDK_OFFSET(0x1937C8C0)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_5_OFFSET UNITYSDK_OFFSET(0x1937C8D0)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_6_OFFSET UNITYSDK_OFFSET(0x1937C200)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_7_OFFSET UNITYSDK_OFFSET(0x1937C540)
#define SYSTEM_NET_HTTPWEBREQUEST_ADDRANGE_OFFSET UNITYSDK_OFFSET(0x1937C1F0)
#define SYSTEM_NET_HTTPWEBREQUEST_BEGINGETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x1937C8F0)
#define SYSTEM_NET_HTTPWEBREQUEST_BEGINGETRESPONSE_OFFSET UNITYSDK_OFFSET(0x1937D840)
#define SYSTEM_NET_HTTPWEBREQUEST_CHECKAUTHORIZATION_OFFSET UNITYSDK_OFFSET(0x193826C0)
#define SYSTEM_NET_HTTPWEBREQUEST_CHECKFINALSTATUS_OFFSET UNITYSDK_OFFSET(0x19381BC0)
#define SYSTEM_NET_HTTPWEBREQUEST_CHECKIFFORCEWRITE_OFFSET UNITYSDK_OFFSET(0x1937D720)
#define SYSTEM_NET_HTTPWEBREQUEST_CHECKREQUESTSTARTED_OFFSET UNITYSDK_OFFSET(0x19379B70)
#define SYSTEM_NET_HTTPWEBREQUEST_CHECKSENDERROR_OFFSET UNITYSDK_OFFSET(0x19380D00)
#define SYSTEM_NET_HTTPWEBREQUEST_CHECKVALIDHOST_OFFSET UNITYSDK_OFFSET(0x1937AD90)
#define SYSTEM_NET_HTTPWEBREQUEST_DOCONTINUEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1937E450)
#define SYSTEM_NET_HTTPWEBREQUEST_DOPREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1937FB20)
#define SYSTEM_NET_HTTPWEBREQUEST_ENDGETREQUESTSTREAM_1_OFFSET UNITYSDK_OFFSET(0x1937DCB0)
#define SYSTEM_NET_HTTPWEBREQUEST_ENDGETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x1937CE30)
#define SYSTEM_NET_HTTPWEBREQUEST_ENDGETRESPONSE_OFFSET UNITYSDK_OFFSET(0x1937DBA0)
#define SYSTEM_NET_HTTPWEBREQUEST_GENERATECONNECTIONGROUP_OFFSET UNITYSDK_OFFSET(0x19382710)
#define SYSTEM_NET_HTTPWEBREQUEST_GETHEADERS_OFFSET UNITYSDK_OFFSET(0x1937EDA0)
#define SYSTEM_NET_HTTPWEBREQUEST_GETMUSTIMPLEMENT_OFFSET UNITYSDK_OFFSET(0x19379CB0)
#define SYSTEM_NET_HTTPWEBREQUEST_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1937DD80)
#define SYSTEM_NET_HTTPWEBREQUEST_GETREQUESTHEADERS_OFFSET UNITYSDK_OFFSET(0x19380170)
#define SYSTEM_NET_HTTPWEBREQUEST_GETREQUESTSTREAM_1_OFFSET UNITYSDK_OFFSET(0x1937D6D0)
#define SYSTEM_NET_HTTPWEBREQUEST_GETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x1937CF10)
#define SYSTEM_NET_HTTPWEBREQUEST_GETRESPONSE_OFFSET UNITYSDK_OFFSET(0x1937DCC0)
#define SYSTEM_NET_HTTPWEBREQUEST_GETSERVICEPOINT_OFFSET UNITYSDK_OFFSET(0x1937B9B0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_ABORTED_OFFSET UNITYSDK_OFFSET(0x1937CE10)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_ACCEPT_OFFSET UNITYSDK_OFFSET(0x19379AB0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x19379BE0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_ALLOWAUTOREDIRECT_OFFSET UNITYSDK_OFFSET(0x19379C00)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_ALLOWREADSTREAMBUFFERING_OFFSET UNITYSDK_OFFSET(0x19379C40)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_ALLOWWRITESTREAMBUFFERING_OFFSET UNITYSDK_OFFSET(0x19379C20)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_AUTHURI_OFFSET UNITYSDK_OFFSET(0x1937C120)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_AUTOMATICDECOMPRESSION_OFFSET UNITYSDK_OFFSET(0x19379D60)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1937A040)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CONNECTIONGROUPNAME_OFFSET UNITYSDK_OFFSET(0x1937A3E0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CONNECTION_OFFSET UNITYSDK_OFFSET(0x1937A150)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1937A400)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1937A520)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CONTINUEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1937A570)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CONTINUETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1937B310)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_COOKIECONTAINER_OFFSET UNITYSDK_OFFSET(0x1937A590)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1937A5B0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_DATE_OFFSET UNITYSDK_OFFSET(0x1937A5D0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_DEFAULTMAXIMUMERRORRESPONSELENGTH_OFFSET UNITYSDK_OFFSET(0x1937A720)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_DEFAULTMAXIMUMRESPONSEHEADERSLENGTH_OFFSET UNITYSDK_OFFSET(0x1937B210)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_EXPECTCONTINUE_OFFSET UNITYSDK_OFFSET(0x1937C100)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_EXPECT_OFFSET UNITYSDK_OFFSET(0x1937A7A0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_FINISHEDREADING_OFFSET UNITYSDK_OFFSET(0x1937DD50)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_GOTREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x1937C0F0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_HAVERESPONSE_OFFSET UNITYSDK_OFFSET(0x1937A990)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1937A9A0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_HOST_OFFSET UNITYSDK_OFFSET(0x1937ABB0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_IFMODIFIEDSINCE_OFFSET UNITYSDK_OFFSET(0x1937AE90)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_INTERNALALLOWBUFFERING_OFFSET UNITYSDK_OFFSET(0x19379DF0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x1937B150)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_MAXIMUMAUTOMATICREDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1937B170)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_MAXIMUMRESPONSEHEADERSLENGTH_OFFSET UNITYSDK_OFFSET(0x1937B1F0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_MEDIATYPE_OFFSET UNITYSDK_OFFSET(0x1937B3B0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_METHODWITHBUFFER_OFFSET UNITYSDK_OFFSET(0x19379F10)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1937B3D0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_PIPELINED_OFFSET UNITYSDK_OFFSET(0x1937B660)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1937B680)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x1937B6A0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_PROXYQUERY_OFFSET UNITYSDK_OFFSET(0x1937C130)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_PROXY_OFFSET UNITYSDK_OFFSET(0x1937B920)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_READWRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1937B270)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_REFERER_OFFSET UNITYSDK_OFFSET(0x1937BAC0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_REQUESTURI_OFFSET UNITYSDK_OFFSET(0x1937BC20)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_REUSECONNECTION_OFFSET UNITYSDK_OFFSET(0x193826F0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_SENDCHUNKED_OFFSET UNITYSDK_OFFSET(0x1937BC30)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_SERVERCERTIFICATEVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1937C170)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_SERVERCERTVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1937C160)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_SERVICEPOINTNOLOCK_OFFSET UNITYSDK_OFFSET(0x1937BCD0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_SERVICEPOINT_OFFSET UNITYSDK_OFFSET(0x1937BCC0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_SUPPORTSCOOKIECONTAINER_OFFSET UNITYSDK_OFFSET(0x1937BCE0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_THROWONERROR_OFFSET UNITYSDK_OFFSET(0x1937A500)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1937BCF0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_TLSPROVIDER_OFFSET UNITYSDK_OFFSET(0x1937A020)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_TLSSETTINGS_OFFSET UNITYSDK_OFFSET(0x1937A030)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_TRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x1937BD50)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_UNSAFEAUTHENTICATEDCONNECTIONSHARING_OFFSET UNITYSDK_OFFSET(0x1937C0D0)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1937BF80)
#define SYSTEM_NET_HTTPWEBREQUEST_GET_USERAGENT_OFFSET UNITYSDK_OFFSET(0x1937C060)
#define SYSTEM_NET_HTTPWEBREQUEST_HANDLENTLMAUTH_OFFSET UNITYSDK_OFFSET(0x19380DF0)
#define SYSTEM_NET_HTTPWEBREQUEST_REDIRECT_OFFSET UNITYSDK_OFFSET(0x1937E4E0)
#define SYSTEM_NET_HTTPWEBREQUEST_RESETAUTHORIZATION_OFFSET UNITYSDK_OFFSET(0x19379410)
#define SYSTEM_NET_HTTPWEBREQUEST_REWRITEREDIRECTTOGET_OFFSET UNITYSDK_OFFSET(0x1937E470)
#define SYSTEM_NET_HTTPWEBREQUEST_SETDATEHEADERHELPER_OFFSET UNITYSDK_OFFSET(0x1937A6E0)
#define SYSTEM_NET_HTTPWEBREQUEST_SETRESPONSEDATA_OFFSET UNITYSDK_OFFSET(0x19381110)
#define SYSTEM_NET_HTTPWEBREQUEST_SETRESPONSEERROR_OFFSET UNITYSDK_OFFSET(0x19380940)
#define SYSTEM_NET_HTTPWEBREQUEST_SETSPECIALHEADERS_OFFSET UNITYSDK_OFFSET(0x19379960)
#define SYSTEM_NET_HTTPWEBREQUEST_SETWRITESTREAMERROR_1_OFFSET UNITYSDK_OFFSET(0x193808F0)
#define SYSTEM_NET_HTTPWEBREQUEST_SETWRITESTREAMERROR_OFFSET UNITYSDK_OFFSET(0x1937FDF0)
#define SYSTEM_NET_HTTPWEBREQUEST_SETWRITESTREAMINNER_OFFSET UNITYSDK_OFFSET(0x193808B0)
#define SYSTEM_NET_HTTPWEBREQUEST_SETWRITESTREAM_OFFSET UNITYSDK_OFFSET(0x19380780)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_ACCEPT_OFFSET UNITYSDK_OFFSET(0x19379AF0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x19379BF0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_ALLOWAUTOREDIRECT_OFFSET UNITYSDK_OFFSET(0x19379C10)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_ALLOWREADSTREAMBUFFERING_OFFSET UNITYSDK_OFFSET(0x19379C50)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_ALLOWWRITESTREAMBUFFERING_OFFSET UNITYSDK_OFFSET(0x19379C30)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_AUTOMATICDECOMPRESSION_OFFSET UNITYSDK_OFFSET(0x19379D70)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1937A0E0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CONNECTIONGROUPNAME_OFFSET UNITYSDK_OFFSET(0x1937A3F0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CONNECTION_OFFSET UNITYSDK_OFFSET(0x1937A190)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1937A410)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1937A560)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CONTINUEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1937A580)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CONTINUETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1937B360)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_COOKIECONTAINER_OFFSET UNITYSDK_OFFSET(0x1937A5A0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1937A5C0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_DATE_OFFSET UNITYSDK_OFFSET(0x1937A690)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_DEFAULTMAXIMUMERRORRESPONSELENGTH_OFFSET UNITYSDK_OFFSET(0x1937A760)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_DEFAULTMAXIMUMRESPONSEHEADERSLENGTH_OFFSET UNITYSDK_OFFSET(0x1937B240)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_EXPECTCONTINUE_OFFSET UNITYSDK_OFFSET(0x1937C110)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_EXPECT_OFFSET UNITYSDK_OFFSET(0x1937A7E0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_FINISHEDREADING_OFFSET UNITYSDK_OFFSET(0x1937DD60)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1937A9B0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_HOST_OFFSET UNITYSDK_OFFSET(0x1937AC60)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_IFMODIFIEDSINCE_OFFSET UNITYSDK_OFFSET(0x1937AFF0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_INTERNALCONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1937A4F0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x1937B160)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_MAXIMUMAUTOMATICREDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1937B180)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_MAXIMUMRESPONSEHEADERSLENGTH_OFFSET UNITYSDK_OFFSET(0x1937B200)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_MEDIATYPE_OFFSET UNITYSDK_OFFSET(0x1937B3C0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_METHOD_OFFSET UNITYSDK_OFFSET(0x1937B3E0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_PIPELINED_OFFSET UNITYSDK_OFFSET(0x1937B670)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x1937B690)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x1937B6B0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_PROXY_OFFSET UNITYSDK_OFFSET(0x1937B930)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_READWRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1937B280)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_REFERER_OFFSET UNITYSDK_OFFSET(0x1937BB00)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_REUSECONNECTION_OFFSET UNITYSDK_OFFSET(0x19382700)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_SENDCHUNKED_OFFSET UNITYSDK_OFFSET(0x1937BC40)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_SERVERCERTIFICATEVALIDATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1937C190)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_THROWONERROR_OFFSET UNITYSDK_OFFSET(0x1937A510)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1937BD00)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_TRANSFERENCODING_OFFSET UNITYSDK_OFFSET(0x1937BD90)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_UNSAFEAUTHENTICATEDCONNECTIONSHARING_OFFSET UNITYSDK_OFFSET(0x1937C0E0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x1937BFF0)
#define SYSTEM_NET_HTTPWEBREQUEST_SET_USERAGENT_OFFSET UNITYSDK_OFFSET(0x1937C0A0)
#define SYSTEM_NET_HTTPWEBREQUEST_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1937DD70)
#define SYSTEM_NET_HTTPWEBREQUEST__CCTOR_OFFSET UNITYSDK_OFFSET(0x19379270)
#define SYSTEM_NET_HTTPWEBREQUEST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19379440)
#define SYSTEM_NET_HTTPWEBREQUEST__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19379470)
#define SYSTEM_NET_HTTPWEBREQUEST__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19382B20)
#define SYSTEM_NET_HTTPWEBREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x19379280)
#define SYSTEM_NET_HTTPWEBREQUEST__SETWRITESTREAMINNER_B__259_0_OFFSET UNITYSDK_OFFSET(0x19382970)
#define SYSTEM_NET_HTTPWEBREQUEST__SETWRITESTREAM_B__258_0_OFFSET UNITYSDK_OFFSET(0x193827E0)
#define SYSTEM_NET_HTTPWEBREQUEST__SETWRITESTREAM_B__258_1_OFFSET UNITYSDK_OFFSET(0x193828B0)
...
namespace System::Net
{
	...
	public:
		...
		::System::Net::ServicePoint* servicePoint; // 0x48
		::System::Net::WebConnectionStream* writeStream; // 0x50
		::System::Uri* requestUri; // 0x58
		::System::String* connectionGroup; // 0x60
		::System::Exception* saved_exc; // 0x68
		::Mono::Security::Interface::MonoTlsProvider* tlsProvider; // 0x70
		::System::Net::WebAsyncResult* asyncWrite; // 0x78
		::System::Net::WebConnection* StoredConnection; // 0x80
		::Il2CppArray<::System::Byte>* bodyBuffer; // 0x88
		...
		::System::Version* actualVersion; // 0xB0
		::System::Net::HttpWebRequest_AuthorizationState auth_state; // 0xB8
		::System::Net::CookieContainer* cookieContainer; // 0xC8
		::System::Net::HttpContinueDelegate* continueDelegate; // 0xD0
		::System::Net::WebConnection* WebConnection; // 0xD8
		::Mono::Security::Interface::MonoTlsSettings* tlsSettings; // 0xE0
		::System::String* host; // 0xE8
		::System::String* initialMethod; // 0xF0
		::System::Net::WebHeaderCollection* webHeaders; // 0xF8
		::System::String* method; // 0x100
		::System::Net::HttpWebRequest_AuthorizationState proxy_auth_state; // 0x108
		::System::Net::HttpWebResponse* webResponse; // 0x118
		::System::Object* locker; // 0x120
		::System::Security::Cryptography::X509Certificates::X509CertificateCollection* certificates; // 0x128
		::System::Version* version; // 0x130
		::System::Net::ICredentials* credentials; // 0x138
		::System::EventHandler* abortHandler; // 0x140
		::System::Boolean unsafe_auth_blah; // 0x148
		::System::Boolean pipelined; // 0x149
		::System::Boolean expectContinue; // 0x14A
		::System::Boolean haveContentLength; // 0x14B
		::System::Int32 maxResponseHeadersLength; // 0x14C
		::System::Boolean usedPreAuth; // 0x150
		::System::Boolean force_version; // 0x151
		::System::Boolean hostChanged; // 0x152
		::System::Boolean finished_reading; // 0x153
		...
		::System::Boolean gotRequestStream; // 0x164
		::System::Boolean preAuthenticate; // 0x165
		::System::Boolean _ThrowOnError_k__BackingField; // 0x166
		::System::Boolean getResponseCalled; // 0x167
		::System::Int32 redirects; // 0x168
		...
		::System::Boolean sendChunked; // 0x181
		::System::Boolean allowAutoRedirect; // 0x182
		::System::Boolean requestSent; // 0x183
		::System::Boolean haveResponse; // 0x184
		::System::Boolean haveRequest; // 0x185
		::System::Boolean keepAlive; // 0x186
