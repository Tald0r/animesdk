...
#define SYSTEM_NET_OPENREADCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D2B790)
#define SYSTEM_NET_OPENREADCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D2B7D0)
#define SYSTEM_NET_OPENREADCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D2B210)
#define SYSTEM_NET_OPENREADCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D2B1F0)
