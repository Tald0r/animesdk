...
#define SYSTEM_NET_HTTPPROTOCOLUTILS_DATE2STRING_OFFSET UNITYSDK_OFFSET(0x19688380)
#define SYSTEM_NET_HTTPPROTOCOLUTILS_STRING2DATE_OFFSET UNITYSDK_OFFSET(0x19688300)
#define SYSTEM_NET_HTTPPROTOCOLUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x196882F0)
