...
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTARGS_GET_BYTESRECEIVED_OFFSET UNITYSDK_OFFSET(0x193B4800)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTARGS_GET_BYTESSENT_OFFSET UNITYSDK_OFFSET(0x193B4820)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTARGS_GET_TOTALBYTESTORECEIVE_OFFSET UNITYSDK_OFFSET(0x193B4810)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTARGS_GET_TOTALBYTESTOSEND_OFFSET UNITYSDK_OFFSET(0x193B4830)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193B4840)
#define SYSTEM_NET_UPLOADPROGRESSCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x193B4790)
...
namespace System::Net
{
	...
	public:
		...
		::System::Int64 m_TotalBytesToSend; // 0x30
