...
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTARGS_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x1943CA30)
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1943CA50)
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1943C9E0)
