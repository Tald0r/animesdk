...
#define SYSTEM_NET_WEBREQUEST_ABORT_OFFSET UNITYSDK_OFFSET(0x197F6810)
#define SYSTEM_NET_WEBREQUEST_BEGINGETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x197F5E60)
#define SYSTEM_NET_WEBREQUEST_BEGINGETRESPONSE_OFFSET UNITYSDK_OFFSET(0x197F5DC0)
#define SYSTEM_NET_WEBREQUEST_CREATEDEFAULT_OFFSET UNITYSDK_OFFSET(0x197F4890)
#define SYSTEM_NET_WEBREQUEST_CREATEHTTP_1_OFFSET UNITYSDK_OFFSET(0x197F49F0)
#define SYSTEM_NET_WEBREQUEST_CREATEHTTP_OFFSET UNITYSDK_OFFSET(0x197F4940)
#define SYSTEM_NET_WEBREQUEST_CREATE_1_OFFSET UNITYSDK_OFFSET(0x197F4750)
#define SYSTEM_NET_WEBREQUEST_CREATE_2_OFFSET UNITYSDK_OFFSET(0x197F47E0)
#define SYSTEM_NET_WEBREQUEST_CREATE_OFFSET UNITYSDK_OFFSET(0x197F4290)
#define SYSTEM_NET_WEBREQUEST_ENDGETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x197F5EB0)
#define SYSTEM_NET_WEBREQUEST_ENDGETRESPONSE_OFFSET UNITYSDK_OFFSET(0x197F5E10)
#define SYSTEM_NET_WEBREQUEST_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x197F5470)
#define SYSTEM_NET_WEBREQUEST_GETREQUESTSTREAMASYNC_OFFSET UNITYSDK_OFFSET(0x197F5F00)
#define SYSTEM_NET_WEBREQUEST_GETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x197F5D20)
#define SYSTEM_NET_WEBREQUEST_GETRESPONSEASYNC_OFFSET UNITYSDK_OFFSET(0x197F6420)
#define SYSTEM_NET_WEBREQUEST_GETRESPONSE_OFFSET UNITYSDK_OFFSET(0x197F5D70)
#define SYSTEM_NET_WEBREQUEST_GETSYSTEMWEBPROXY_OFFSET UNITYSDK_OFFSET(0x197F6DD0)
#define SYSTEM_NET_WEBREQUEST_GET_AUTHENTICATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x197F6880)
#define SYSTEM_NET_WEBREQUEST_GET_CACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x197F55A0)
#define SYSTEM_NET_WEBREQUEST_GET_CACHEPROTOCOL_OFFSET UNITYSDK_OFFSET(0x197F6860)
#define SYSTEM_NET_WEBREQUEST_GET_CONNECTIONGROUPNAME_OFFSET UNITYSDK_OFFSET(0x197F5780)
#define SYSTEM_NET_WEBREQUEST_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x197F58C0)
#define SYSTEM_NET_WEBREQUEST_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x197F5960)
#define SYSTEM_NET_WEBREQUEST_GET_CREATORINSTANCE_OFFSET UNITYSDK_OFFSET(0x197F4170)
#define SYSTEM_NET_WEBREQUEST_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x197F5A00)
#define SYSTEM_NET_WEBREQUEST_GET_DEFAULTCACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x197F5480)
#define SYSTEM_NET_WEBREQUEST_GET_DEFAULTTIMERQUEUE_OFFSET UNITYSDK_OFFSET(0x197F4260)
#define SYSTEM_NET_WEBREQUEST_GET_DEFAULTWEBPROXY_OFFSET UNITYSDK_OFFSET(0x197F6D70)
#define SYSTEM_NET_WEBREQUEST_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x197F5820)
#define SYSTEM_NET_WEBREQUEST_GET_IMPERSONATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x197F68A0)
#define SYSTEM_NET_WEBREQUEST_GET_INTERNALDEFAULTWEBPROXY_OFFSET UNITYSDK_OFFSET(0x197F6910)
#define SYSTEM_NET_WEBREQUEST_GET_INTERNALSYNCOBJECT_OFFSET UNITYSDK_OFFSET(0x197F41B0)
#define SYSTEM_NET_WEBREQUEST_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x197F5690)
#define SYSTEM_NET_WEBREQUEST_GET_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x197F5BE0)
#define SYSTEM_NET_WEBREQUEST_GET_PREFIXLIST_OFFSET UNITYSDK_OFFSET(0x197F4510)
#define SYSTEM_NET_WEBREQUEST_GET_PROXY_OFFSET UNITYSDK_OFFSET(0x197F5B40)
#define SYSTEM_NET_WEBREQUEST_GET_REQUESTURI_OFFSET UNITYSDK_OFFSET(0x197F5730)
#define SYSTEM_NET_WEBREQUEST_GET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x197F5C80)
#define SYSTEM_NET_WEBREQUEST_GET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x197F5AA0)
#define SYSTEM_NET_WEBREQUEST_INTERNALGETSYSTEMWEBPROXY_OFFSET UNITYSDK_OFFSET(0x197F6E10)
#define SYSTEM_NET_WEBREQUEST_INTERNALSETCACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x197F5620)
#define SYSTEM_NET_WEBREQUEST_POPULATEPREFIXLIST_OFFSET UNITYSDK_OFFSET(0x197F52E0)
#define SYSTEM_NET_WEBREQUEST_REGISTERPORTABLEWEBREQUESTCREATOR_OFFSET UNITYSDK_OFFSET(0x197F41A0)
#define SYSTEM_NET_WEBREQUEST_REGISTERPREFIX_OFFSET UNITYSDK_OFFSET(0x197F4D10)
#define SYSTEM_NET_WEBREQUEST_REQUESTCALLBACK_OFFSET UNITYSDK_OFFSET(0x197F68C0)
#define SYSTEM_NET_WEBREQUEST_SAFECAPTUREIDENITY_OFFSET UNITYSDK_OFFSET(0x197F6310)
#define SYSTEM_NET_WEBREQUEST_SETUPCACHEPROTOCOL_OFFSET UNITYSDK_OFFSET(0x197F6E30)
#define SYSTEM_NET_WEBREQUEST_SET_AUTHENTICATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x197F6890)
#define SYSTEM_NET_WEBREQUEST_SET_CACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x197F55B0)
#define SYSTEM_NET_WEBREQUEST_SET_CACHEPROTOCOL_OFFSET UNITYSDK_OFFSET(0x197F6870)
#define SYSTEM_NET_WEBREQUEST_SET_CONNECTIONGROUPNAME_OFFSET UNITYSDK_OFFSET(0x197F57D0)
#define SYSTEM_NET_WEBREQUEST_SET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x197F5910)
#define SYSTEM_NET_WEBREQUEST_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x197F59B0)
#define SYSTEM_NET_WEBREQUEST_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x197F5A50)
#define SYSTEM_NET_WEBREQUEST_SET_DEFAULTCACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x197F54F0)
#define SYSTEM_NET_WEBREQUEST_SET_DEFAULTWEBPROXY_OFFSET UNITYSDK_OFFSET(0x197F6DA0)
#define SYSTEM_NET_WEBREQUEST_SET_HEADERS_OFFSET UNITYSDK_OFFSET(0x197F5870)
#define SYSTEM_NET_WEBREQUEST_SET_IMPERSONATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x197F68B0)
#define SYSTEM_NET_WEBREQUEST_SET_INTERNALDEFAULTWEBPROXY_OFFSET UNITYSDK_OFFSET(0x197F6B60)
#define SYSTEM_NET_WEBREQUEST_SET_METHOD_OFFSET UNITYSDK_OFFSET(0x197F56E0)
#define SYSTEM_NET_WEBREQUEST_SET_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x197F5C30)
#define SYSTEM_NET_WEBREQUEST_SET_PREFIXLIST_OFFSET UNITYSDK_OFFSET(0x197F52A0)
#define SYSTEM_NET_WEBREQUEST_SET_PROXY_OFFSET UNITYSDK_OFFSET(0x197F5B90)
#define SYSTEM_NET_WEBREQUEST_SET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x197F5CD0)
#define SYSTEM_NET_WEBREQUEST_SET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x197F5AF0)
#define SYSTEM_NET_WEBREQUEST_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x197F5440)
#define SYSTEM_NET_WEBREQUEST__CCTOR_OFFSET UNITYSDK_OFFSET(0x197F7010)
#define SYSTEM_NET_WEBREQUEST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197F5430)
#define SYSTEM_NET_WEBREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x197F5420)
#define SYSTEM_NET_WEBREQUEST__GETREQUESTSTREAMASYNC_B__78_0_OFFSET UNITYSDK_OFFSET(0x197F7080)
#define SYSTEM_NET_WEBREQUEST__GETRESPONSEASYNC_B__79_0_OFFSET UNITYSDK_OFFSET(0x197F7230)
...
namespace System::Net
{
	...
	public:
		...
		{
			return (::System::Collections::ArrayList**)Il2CppClass::FromTypeDefinitionIndex(WebRequest_TypeDefinitionIndex)->GetStaticField(0x3B00);
		}
