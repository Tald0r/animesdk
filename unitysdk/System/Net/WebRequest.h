...
#define SYSTEM_NET_WEBREQUEST_ABORT_OFFSET UNITYSDK_OFFSET(0x19D35C10)
#define SYSTEM_NET_WEBREQUEST_BEGINGETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x19D35220)
#define SYSTEM_NET_WEBREQUEST_BEGINGETRESPONSE_OFFSET UNITYSDK_OFFSET(0x19D35180)
#define SYSTEM_NET_WEBREQUEST_CREATEDEFAULT_OFFSET UNITYSDK_OFFSET(0x19D33C50)
#define SYSTEM_NET_WEBREQUEST_CREATEHTTP_1_OFFSET UNITYSDK_OFFSET(0x19D33DB0)
#define SYSTEM_NET_WEBREQUEST_CREATEHTTP_OFFSET UNITYSDK_OFFSET(0x19D33D00)
#define SYSTEM_NET_WEBREQUEST_CREATE_1_OFFSET UNITYSDK_OFFSET(0x19D33B10)
#define SYSTEM_NET_WEBREQUEST_CREATE_2_OFFSET UNITYSDK_OFFSET(0x19D33BA0)
#define SYSTEM_NET_WEBREQUEST_CREATE_OFFSET UNITYSDK_OFFSET(0x19D33650)
#define SYSTEM_NET_WEBREQUEST_ENDGETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x19D35270)
#define SYSTEM_NET_WEBREQUEST_ENDGETRESPONSE_OFFSET UNITYSDK_OFFSET(0x19D351D0)
#define SYSTEM_NET_WEBREQUEST_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x19D34830)
#define SYSTEM_NET_WEBREQUEST_GETREQUESTSTREAMASYNC_OFFSET UNITYSDK_OFFSET(0x19D352C0)
#define SYSTEM_NET_WEBREQUEST_GETREQUESTSTREAM_OFFSET UNITYSDK_OFFSET(0x19D350E0)
#define SYSTEM_NET_WEBREQUEST_GETRESPONSEASYNC_OFFSET UNITYSDK_OFFSET(0x19D35800)
#define SYSTEM_NET_WEBREQUEST_GETRESPONSE_OFFSET UNITYSDK_OFFSET(0x19D35130)
#define SYSTEM_NET_WEBREQUEST_GETSYSTEMWEBPROXY_OFFSET UNITYSDK_OFFSET(0x19D361D0)
#define SYSTEM_NET_WEBREQUEST_GET_AUTHENTICATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x19D35C80)
#define SYSTEM_NET_WEBREQUEST_GET_CACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x19D34960)
#define SYSTEM_NET_WEBREQUEST_GET_CACHEPROTOCOL_OFFSET UNITYSDK_OFFSET(0x19D35C60)
#define SYSTEM_NET_WEBREQUEST_GET_CONNECTIONGROUPNAME_OFFSET UNITYSDK_OFFSET(0x19D34B40)
#define SYSTEM_NET_WEBREQUEST_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x19D34C80)
#define SYSTEM_NET_WEBREQUEST_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x19D34D20)
#define SYSTEM_NET_WEBREQUEST_GET_CREATORINSTANCE_OFFSET UNITYSDK_OFFSET(0x19D33530)
#define SYSTEM_NET_WEBREQUEST_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x19D34DC0)
#define SYSTEM_NET_WEBREQUEST_GET_DEFAULTCACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x19D34840)
#define SYSTEM_NET_WEBREQUEST_GET_DEFAULTTIMERQUEUE_OFFSET UNITYSDK_OFFSET(0x19D33620)
#define SYSTEM_NET_WEBREQUEST_GET_DEFAULTWEBPROXY_OFFSET UNITYSDK_OFFSET(0x19D36170)
#define SYSTEM_NET_WEBREQUEST_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x19D34BE0)
#define SYSTEM_NET_WEBREQUEST_GET_IMPERSONATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x19D35CA0)
#define SYSTEM_NET_WEBREQUEST_GET_INTERNALDEFAULTWEBPROXY_OFFSET UNITYSDK_OFFSET(0x19D35D10)
#define SYSTEM_NET_WEBREQUEST_GET_INTERNALSYNCOBJECT_OFFSET UNITYSDK_OFFSET(0x19D33570)
#define SYSTEM_NET_WEBREQUEST_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x19D34A50)
#define SYSTEM_NET_WEBREQUEST_GET_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x19D34FA0)
#define SYSTEM_NET_WEBREQUEST_GET_PREFIXLIST_OFFSET UNITYSDK_OFFSET(0x19D338D0)
#define SYSTEM_NET_WEBREQUEST_GET_PROXY_OFFSET UNITYSDK_OFFSET(0x19D34F00)
#define SYSTEM_NET_WEBREQUEST_GET_REQUESTURI_OFFSET UNITYSDK_OFFSET(0x19D34AF0)
#define SYSTEM_NET_WEBREQUEST_GET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x19D35040)
#define SYSTEM_NET_WEBREQUEST_GET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x19D34E60)
#define SYSTEM_NET_WEBREQUEST_INTERNALGETSYSTEMWEBPROXY_OFFSET UNITYSDK_OFFSET(0x19D36210)
#define SYSTEM_NET_WEBREQUEST_INTERNALSETCACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x19D349E0)
#define SYSTEM_NET_WEBREQUEST_POPULATEPREFIXLIST_OFFSET UNITYSDK_OFFSET(0x19D346A0)
#define SYSTEM_NET_WEBREQUEST_REGISTERPORTABLEWEBREQUESTCREATOR_OFFSET UNITYSDK_OFFSET(0x19D33560)
#define SYSTEM_NET_WEBREQUEST_REGISTERPREFIX_OFFSET UNITYSDK_OFFSET(0x19D340D0)
#define SYSTEM_NET_WEBREQUEST_REQUESTCALLBACK_OFFSET UNITYSDK_OFFSET(0x19D35CC0)
#define SYSTEM_NET_WEBREQUEST_SAFECAPTUREIDENITY_OFFSET UNITYSDK_OFFSET(0x19D356F0)
#define SYSTEM_NET_WEBREQUEST_SETUPCACHEPROTOCOL_OFFSET UNITYSDK_OFFSET(0x19D36230)
#define SYSTEM_NET_WEBREQUEST_SET_AUTHENTICATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x19D35C90)
#define SYSTEM_NET_WEBREQUEST_SET_CACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x19D34970)
#define SYSTEM_NET_WEBREQUEST_SET_CACHEPROTOCOL_OFFSET UNITYSDK_OFFSET(0x19D35C70)
#define SYSTEM_NET_WEBREQUEST_SET_CONNECTIONGROUPNAME_OFFSET UNITYSDK_OFFSET(0x19D34B90)
#define SYSTEM_NET_WEBREQUEST_SET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x19D34CD0)
#define SYSTEM_NET_WEBREQUEST_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x19D34D70)
#define SYSTEM_NET_WEBREQUEST_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x19D34E10)
#define SYSTEM_NET_WEBREQUEST_SET_DEFAULTCACHEPOLICY_OFFSET UNITYSDK_OFFSET(0x19D348B0)
#define SYSTEM_NET_WEBREQUEST_SET_DEFAULTWEBPROXY_OFFSET UNITYSDK_OFFSET(0x19D361A0)
#define SYSTEM_NET_WEBREQUEST_SET_HEADERS_OFFSET UNITYSDK_OFFSET(0x19D34C30)
#define SYSTEM_NET_WEBREQUEST_SET_IMPERSONATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x19D35CB0)
#define SYSTEM_NET_WEBREQUEST_SET_INTERNALDEFAULTWEBPROXY_OFFSET UNITYSDK_OFFSET(0x19D35F60)
#define SYSTEM_NET_WEBREQUEST_SET_METHOD_OFFSET UNITYSDK_OFFSET(0x19D34AA0)
#define SYSTEM_NET_WEBREQUEST_SET_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x19D34FF0)
#define SYSTEM_NET_WEBREQUEST_SET_PREFIXLIST_OFFSET UNITYSDK_OFFSET(0x19D34660)
#define SYSTEM_NET_WEBREQUEST_SET_PROXY_OFFSET UNITYSDK_OFFSET(0x19D34F50)
#define SYSTEM_NET_WEBREQUEST_SET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x19D35090)
#define SYSTEM_NET_WEBREQUEST_SET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x19D34EB0)
#define SYSTEM_NET_WEBREQUEST_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x19D34800)
#define SYSTEM_NET_WEBREQUEST__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D36410)
#define SYSTEM_NET_WEBREQUEST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D347F0)
#define SYSTEM_NET_WEBREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x19D347E0)
#define SYSTEM_NET_WEBREQUEST__GETREQUESTSTREAMASYNC_B__78_0_OFFSET UNITYSDK_OFFSET(0x19D36480)
#define SYSTEM_NET_WEBREQUEST__GETRESPONSEASYNC_B__79_0_OFFSET UNITYSDK_OFFSET(0x19D36630)
...
namespace System::Net
{
	...
	public:
		...
		{
			return (::System::Collections::ArrayList**)Il2CppClass::FromTypeDefinitionIndex(WebRequest_TypeDefinitionIndex)->GetStaticField(0x3B10);
		}
		static ::System::Net::IWebProxy** StaticGet_s_DefaultWebProxy()
		{
			return (::System::Net::IWebProxy**)Il2CppClass::FromTypeDefinitionIndex(WebRequest_TypeDefinitionIndex)->GetStaticField(0x3B18);
		}
		static ::System::Object** StaticGet_s_InternalSyncObject()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(WebRequest_TypeDefinitionIndex)->GetStaticField(0x3B20);
		}
