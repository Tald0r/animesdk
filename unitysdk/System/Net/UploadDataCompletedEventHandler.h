...
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A33D540)
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A33D580)
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A33CFC0)
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A33CFA0)
