...
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D7F020)
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D7F060)
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D7EAA0)
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D7EA90)
