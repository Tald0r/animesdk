...
#define SYSTEM_NET_HTTPLISTENERTIMEOUTMANAGER_GET_DRAINENTITYBODY_OFFSET UNITYSDK_OFFSET(0x19011BD0)
#define SYSTEM_NET_HTTPLISTENERTIMEOUTMANAGER_GET_ENTITYBODY_OFFSET UNITYSDK_OFFSET(0x19011B30)
#define SYSTEM_NET_HTTPLISTENERTIMEOUTMANAGER_GET_HEADERWAIT_OFFSET UNITYSDK_OFFSET(0x19011DB0)
#define SYSTEM_NET_HTTPLISTENERTIMEOUTMANAGER_GET_IDLECONNECTION_OFFSET UNITYSDK_OFFSET(0x19011D10)
#define SYSTEM_NET_HTTPLISTENERTIMEOUTMANAGER_GET_MINSENDBYTESPERSECOND_OFFSET UNITYSDK_OFFSET(0x19011E50)
#define SYSTEM_NET_HTTPLISTENERTIMEOUTMANAGER_GET_REQUESTQUEUE_OFFSET UNITYSDK_OFFSET(0x19011C70)
#define SYSTEM_NET_HTTPLISTENERTIMEOUTMANAGER_SET_DRAINENTITYBODY_OFFSET UNITYSDK_OFFSET(0x19011C20)
#define SYSTEM_NET_HTTPLISTENERTIMEOUTMANAGER_SET_ENTITYBODY_OFFSET UNITYSDK_OFFSET(0x19011B80)
#define SYSTEM_NET_HTTPLISTENERTIMEOUTMANAGER_SET_HEADERWAIT_OFFSET UNITYSDK_OFFSET(0x19011E00)
#define SYSTEM_NET_HTTPLISTENERTIMEOUTMANAGER_SET_IDLECONNECTION_OFFSET UNITYSDK_OFFSET(0x19011D60)
#define SYSTEM_NET_HTTPLISTENERTIMEOUTMANAGER_SET_MINSENDBYTESPERSECOND_OFFSET UNITYSDK_OFFSET(0x19011EA0)
#define SYSTEM_NET_HTTPLISTENERTIMEOUTMANAGER_SET_REQUESTQUEUE_OFFSET UNITYSDK_OFFSET(0x19011CC0)
#define SYSTEM_NET_HTTPLISTENERTIMEOUTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19011EF0)
