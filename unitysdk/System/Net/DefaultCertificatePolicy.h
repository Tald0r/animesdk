...
#define SYSTEM_NET_DEFAULTCERTIFICATEPOLICY_CHECKVALIDATIONRESULT_OFFSET UNITYSDK_OFFSET(0x19685C20)
#define SYSTEM_NET_DEFAULTCERTIFICATEPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x19685CC0)
