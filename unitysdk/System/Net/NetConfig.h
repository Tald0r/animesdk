...
#define SYSTEM_NET_NETCONFIG_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x197EAD50)
#define SYSTEM_NET_NETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EAD40)
