...
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADDINTERNALNOTCOMMON_OFFSET UNITYSDK_OFFSET(0x1924B3C0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1924B160)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADDWITHOUTVALIDATE_OFFSET UNITYSDK_OFFSET(0x1924AA00)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADD_1_OFFSET UNITYSDK_OFFSET(0x19249BC0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADD_2_OFFSET UNITYSDK_OFFSET(0x192499F0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADD_3_OFFSET UNITYSDK_OFFSET(0x1924B7A0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x19249870)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ALLOWMULTIVALUES_OFFSET UNITYSDK_OFFSET(0x19248F20)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CHANGEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1924B200)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CHECKBADCHARS_OFFSET UNITYSDK_OFFSET(0x1924ABD0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CHECKUPDATE_OFFSET UNITYSDK_OFFSET(0x1924B2F0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1924DFE0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CONTAINSNONASCIICHARS_OFFSET UNITYSDK_OFFSET(0x1924B460)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETASSTRING_OFFSET UNITYSDK_OFFSET(0x1924BCC0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1924DD30)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETKEY_OFFSET UNITYSDK_OFFSET(0x1924CA80)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1924C750)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETVALUES_1_OFFSET UNITYSDK_OFFSET(0x1924DEC0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETVALUES_OFFSET UNITYSDK_OFFSET(0x1924BA50)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_1_OFFSET UNITYSDK_OFFSET(0x1924CB10)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ALLKEYS_OFFSET UNITYSDK_OFFSET(0x1924DF50)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ALLOWHTTPREQUESTHEADER_OFFSET UNITYSDK_OFFSET(0x19248FD0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ALLOWHTTPRESPONSEHEADER_OFFSET UNITYSDK_OFFSET(0x19249010)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_CACHECONTROL_OFFSET UNITYSDK_OFFSET(0x19248570)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x19247FF0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x19248610)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1924CA50)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_DATE_OFFSET UNITYSDK_OFFSET(0x192486B0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ETAG_OFFSET UNITYSDK_OFFSET(0x192487F0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_EXPIRES_OFFSET UNITYSDK_OFFSET(0x19248750)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_INNERCOLLECTION_OFFSET UNITYSDK_OFFSET(0x19248EB0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x19249380)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19249060)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x1924DDF0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_LASTMODIFIED_OFFSET UNITYSDK_OFFSET(0x19248890)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x19248930)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_OFFSET UNITYSDK_OFFSET(0x19248090)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_PROXYAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x192489E0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_SERVER_OFFSET UNITYSDK_OFFSET(0x19248BC0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_SETCOOKIE2_OFFSET UNITYSDK_OFFSET(0x19248A80)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_SETCOOKIE_OFFSET UNITYSDK_OFFSET(0x19248B20)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_VIA_OFFSET UNITYSDK_OFFSET(0x19248C60)
#define SYSTEM_NET_WEBHEADERCOLLECTION_INTERNALHASKEYS_OFFSET UNITYSDK_OFFSET(0x1924DE80)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ISRESTRICTED_1_OFFSET UNITYSDK_OFFSET(0x1924BFE0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ISRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1924BF60)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ISVALIDTOKEN_OFFSET UNITYSDK_OFFSET(0x1924B4C0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_NORMALIZECOMMONHEADERS_OFFSET UNITYSDK_OFFSET(0x19248D00)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ONDESERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1924C740)
#define SYSTEM_NET_WEBHEADERCOLLECTION_PARSEHEADERSSTRICT_OFFSET UNITYSDK_OFFSET(0x1924D1F0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_PARSEHEADERS_OFFSET UNITYSDK_OFFSET(0x1924CBA0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_REMOVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1924B2A0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x1924A890)
#define SYSTEM_NET_WEBHEADERCOLLECTION_REMOVE_2_OFFSET UNITYSDK_OFFSET(0x1924A780)
#define SYSTEM_NET_WEBHEADERCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1924A610)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SETADDVERIFIED_OFFSET UNITYSDK_OFFSET(0x1924AFD0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SETINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x19244E40)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SETINTERNAL_OFFSET UNITYSDK_OFFSET(0x1924A3E0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_1_OFFSET UNITYSDK_OFFSET(0x1924A1B0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_2_OFFSET UNITYSDK_OFFSET(0x19249F70)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x19249630)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x192491F0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_OFFSET UNITYSDK_OFFSET(0x19249DF0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1924DD20)
#define SYSTEM_NET_WEBHEADERCOLLECTION_THROWONRESTRICTEDHEADER_OFFSET UNITYSDK_OFFSET(0x1924B590)
#define SYSTEM_NET_WEBHEADERCOLLECTION_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1924BF20)
#define SYSTEM_NET_WEBHEADERCOLLECTION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1924BEE0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1924BC80)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1924E010)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1924C0A0)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1924C160)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1924C570)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19242CD0)
...
namespace System::Net
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::SByte>**)Il2CppClass::FromTypeDefinitionIndex(WebHeaderCollection_TypeDefinitionIndex)->GetStaticField(0x3A90);
		}
		static ::Il2CppArray<::System::Char>** StaticGet_HttpTrimCharacters()
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(WebHeaderCollection_TypeDefinitionIndex)->GetStaticField(0x3A98);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_s_CommonHeaderNames()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(WebHeaderCollection_TypeDefinitionIndex)->GetStaticField(0x3AA0);
		}
		...
		{
			return (::System::Net::HeaderInfoTable**)Il2CppClass::FromTypeDefinitionIndex(WebHeaderCollection_TypeDefinitionIndex)->GetStaticField(0x3AB0);
		}
