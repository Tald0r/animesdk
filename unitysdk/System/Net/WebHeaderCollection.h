...
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADDINTERNALNOTCOMMON_OFFSET UNITYSDK_OFFSET(0x18E480D0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADDINTERNAL_OFFSET UNITYSDK_OFFSET(0x18E47E70)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADDWITHOUTVALIDATE_OFFSET UNITYSDK_OFFSET(0x18E47710)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADD_1_OFFSET UNITYSDK_OFFSET(0x18E468D0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADD_2_OFFSET UNITYSDK_OFFSET(0x18E46700)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADD_3_OFFSET UNITYSDK_OFFSET(0x18E484B0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x18E46580)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ALLOWMULTIVALUES_OFFSET UNITYSDK_OFFSET(0x18E45C30)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CHANGEINTERNAL_OFFSET UNITYSDK_OFFSET(0x18E47F10)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CHECKBADCHARS_OFFSET UNITYSDK_OFFSET(0x18E478E0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CHECKUPDATE_OFFSET UNITYSDK_OFFSET(0x18E48000)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x18E4ACF0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_CONTAINSNONASCIICHARS_OFFSET UNITYSDK_OFFSET(0x18E48170)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETASSTRING_OFFSET UNITYSDK_OFFSET(0x18E489D0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18E4AA40)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETKEY_OFFSET UNITYSDK_OFFSET(0x18E49790)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18E49460)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETVALUES_1_OFFSET UNITYSDK_OFFSET(0x18E4ABD0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GETVALUES_OFFSET UNITYSDK_OFFSET(0x18E48760)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_1_OFFSET UNITYSDK_OFFSET(0x18E49820)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ALLKEYS_OFFSET UNITYSDK_OFFSET(0x18E4AC60)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ALLOWHTTPREQUESTHEADER_OFFSET UNITYSDK_OFFSET(0x18E45CE0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ALLOWHTTPRESPONSEHEADER_OFFSET UNITYSDK_OFFSET(0x18E45D20)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_CACHECONTROL_OFFSET UNITYSDK_OFFSET(0x18E45280)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x18E44D00)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x18E45320)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x18E49760)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_DATE_OFFSET UNITYSDK_OFFSET(0x18E453C0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ETAG_OFFSET UNITYSDK_OFFSET(0x18E45500)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_EXPIRES_OFFSET UNITYSDK_OFFSET(0x18E45460)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_INNERCOLLECTION_OFFSET UNITYSDK_OFFSET(0x18E45BC0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x18E46090)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x18E45D70)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x18E4AB00)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_LASTMODIFIED_OFFSET UNITYSDK_OFFSET(0x18E455A0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x18E45640)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_OFFSET UNITYSDK_OFFSET(0x18E44DA0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_PROXYAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x18E456F0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_SERVER_OFFSET UNITYSDK_OFFSET(0x18E458D0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_SETCOOKIE2_OFFSET UNITYSDK_OFFSET(0x18E45790)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_SETCOOKIE_OFFSET UNITYSDK_OFFSET(0x18E45830)
#define SYSTEM_NET_WEBHEADERCOLLECTION_GET_VIA_OFFSET UNITYSDK_OFFSET(0x18E45970)
#define SYSTEM_NET_WEBHEADERCOLLECTION_INTERNALHASKEYS_OFFSET UNITYSDK_OFFSET(0x18E4AB90)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ISRESTRICTED_1_OFFSET UNITYSDK_OFFSET(0x18E48CF0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ISRESTRICTED_OFFSET UNITYSDK_OFFSET(0x18E48C70)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ISVALIDTOKEN_OFFSET UNITYSDK_OFFSET(0x18E481D0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_NORMALIZECOMMONHEADERS_OFFSET UNITYSDK_OFFSET(0x18E45A10)
#define SYSTEM_NET_WEBHEADERCOLLECTION_ONDESERIALIZATION_OFFSET UNITYSDK_OFFSET(0x18E49450)
#define SYSTEM_NET_WEBHEADERCOLLECTION_PARSEHEADERSSTRICT_OFFSET UNITYSDK_OFFSET(0x18E49F00)
#define SYSTEM_NET_WEBHEADERCOLLECTION_PARSEHEADERS_OFFSET UNITYSDK_OFFSET(0x18E498B0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_REMOVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x18E47FB0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x18E475A0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_REMOVE_2_OFFSET UNITYSDK_OFFSET(0x18E47490)
#define SYSTEM_NET_WEBHEADERCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x18E47320)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SETADDVERIFIED_OFFSET UNITYSDK_OFFSET(0x18E47CE0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SETINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x18E41B90)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SETINTERNAL_OFFSET UNITYSDK_OFFSET(0x18E470F0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_1_OFFSET UNITYSDK_OFFSET(0x18E46EC0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_2_OFFSET UNITYSDK_OFFSET(0x18E46C80)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x18E46340)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x18E45F00)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SET_OFFSET UNITYSDK_OFFSET(0x18E46B00)
#define SYSTEM_NET_WEBHEADERCOLLECTION_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18E4AA30)
#define SYSTEM_NET_WEBHEADERCOLLECTION_THROWONRESTRICTEDHEADER_OFFSET UNITYSDK_OFFSET(0x18E482A0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x18E48C30)
#define SYSTEM_NET_WEBHEADERCOLLECTION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x18E48BF0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18E48990)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x18E4AD20)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18E48DB0)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18E48E70)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18E49280)
#define SYSTEM_NET_WEBHEADERCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3FA20)
...
namespace System::Net
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(WebHeaderCollection_TypeDefinitionIndex)->GetStaticField(0x3A90);
		}
		...
		{
			return (::System::Net::HeaderInfoTable**)Il2CppClass::FromTypeDefinitionIndex(WebHeaderCollection_TypeDefinitionIndex)->GetStaticField(0x3AA0);
		}
