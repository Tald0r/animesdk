...
#define SYSTEM_NET_GLOBALPROXYSELECTION_GETEMPTYWEBPROXY_OFFSET UNITYSDK_OFFSET(0x1A3358E0)
#define SYSTEM_NET_GLOBALPROXYSELECTION_GET_SELECT_OFFSET UNITYSDK_OFFSET(0x1A335800)
#define SYSTEM_NET_GLOBALPROXYSELECTION_SET_SELECT_OFFSET UNITYSDK_OFFSET(0x1A335920)
#define SYSTEM_NET_GLOBALPROXYSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A335970)
