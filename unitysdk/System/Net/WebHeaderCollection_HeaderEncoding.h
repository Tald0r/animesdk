...
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_DECODEUTF8FROMSTRING_OFFSET UNITYSDK_OFFSET(0x1932D040)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETBYTECOUNT_OFFSET UNITYSDK_OFFSET(0x1932CED0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x1932CF90)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1932CEF0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETSTRING_1_OFFSET UNITYSDK_OFFSET(0x1932CDB0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1932CD80)
