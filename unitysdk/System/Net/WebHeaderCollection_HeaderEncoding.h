...
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_DECODEUTF8FROMSTRING_OFFSET UNITYSDK_OFFSET(0x18F5CEB0)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETBYTECOUNT_OFFSET UNITYSDK_OFFSET(0x18F5CD40)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x18F5CE00)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETBYTES_OFFSET UNITYSDK_OFFSET(0x18F5CD60)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETSTRING_1_OFFSET UNITYSDK_OFFSET(0x18F5CC20)
#define SYSTEM_NET_WEBHEADERCOLLECTION_HEADERENCODING_GETSTRING_OFFSET UNITYSDK_OFFSET(0x18F5CBF0)
