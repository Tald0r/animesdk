...
#define SYSTEM_NET_BASE64STREAM_WRITEASYNCRESULT_COMPLETEWRITE_OFFSET UNITYSDK_OFFSET(0x18F54070)
#define SYSTEM_NET_BASE64STREAM_WRITEASYNCRESULT_END_OFFSET UNITYSDK_OFFSET(0x18F54350)
#define SYSTEM_NET_BASE64STREAM_WRITEASYNCRESULT_ONWRITE_OFFSET UNITYSDK_OFFSET(0x18F540D0)
#define SYSTEM_NET_BASE64STREAM_WRITEASYNCRESULT_WRITE_OFFSET UNITYSDK_OFFSET(0x18F53E40)
#define SYSTEM_NET_BASE64STREAM_WRITEASYNCRESULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x18F543C0)
#define SYSTEM_NET_BASE64STREAM_WRITEASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x18F53DC0)
