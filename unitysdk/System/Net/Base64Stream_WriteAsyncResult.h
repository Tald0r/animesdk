...
#define SYSTEM_NET_BASE64STREAM_WRITEASYNCRESULT_COMPLETEWRITE_OFFSET UNITYSDK_OFFSET(0x193241F0)
#define SYSTEM_NET_BASE64STREAM_WRITEASYNCRESULT_END_OFFSET UNITYSDK_OFFSET(0x193244D0)
#define SYSTEM_NET_BASE64STREAM_WRITEASYNCRESULT_ONWRITE_OFFSET UNITYSDK_OFFSET(0x19324250)
#define SYSTEM_NET_BASE64STREAM_WRITEASYNCRESULT_WRITE_OFFSET UNITYSDK_OFFSET(0x19323FC0)
#define SYSTEM_NET_BASE64STREAM_WRITEASYNCRESULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x19324540)
#define SYSTEM_NET_BASE64STREAM_WRITEASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x19323F40)
