...
#define SYSTEM_NET_DNSENDPOINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x19242130)
#define SYSTEM_NET_DNSENDPOINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x192421D0)
#define SYSTEM_NET_DNSENDPOINT_GET_ADDRESSFAMILY_OFFSET UNITYSDK_OFFSET(0x19242530)
#define SYSTEM_NET_DNSENDPOINT_GET_HOST_OFFSET UNITYSDK_OFFSET(0x19242520)
#define SYSTEM_NET_DNSENDPOINT_GET_PORT_OFFSET UNITYSDK_OFFSET(0x19242540)
#define SYSTEM_NET_DNSENDPOINT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19242230)
#define SYSTEM_NET_DNSENDPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19241FB0)
#define SYSTEM_NET_DNSENDPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19241FA0)
