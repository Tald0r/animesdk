...
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMPARRAYTOCONSOLE_OFFSET UNITYSDK_OFFSET(0x19B23AC0)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMPARRAYTOFILE_OFFSET UNITYSDK_OFFSET(0x19B23AF0)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMPARRAY_OFFSET UNITYSDK_OFFSET(0x19B23AE0)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMP_1_OFFSET UNITYSDK_OFFSET(0x19B23B40)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMP_2_OFFSET UNITYSDK_OFFSET(0x19B23B50)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMP_3_OFFSET UNITYSDK_OFFSET(0x19B23B60)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMP_OFFSET UNITYSDK_OFFSET(0x19B23B30)
#define SYSTEM_NET_BASELOGGINGOBJECT_ENTERFUNC_OFFSET UNITYSDK_OFFSET(0x19B23AA0)
#define SYSTEM_NET_BASELOGGINGOBJECT_FLUSH_1_OFFSET UNITYSDK_OFFSET(0x19B23B10)
#define SYSTEM_NET_BASELOGGINGOBJECT_FLUSH_OFFSET UNITYSDK_OFFSET(0x19B23B00)
#define SYSTEM_NET_BASELOGGINGOBJECT_LEAVEFUNC_OFFSET UNITYSDK_OFFSET(0x19B23AB0)
#define SYSTEM_NET_BASELOGGINGOBJECT_LOGGINGMONITORTICK_OFFSET UNITYSDK_OFFSET(0x19B23B20)
#define SYSTEM_NET_BASELOGGINGOBJECT_PRINTLINE_OFFSET UNITYSDK_OFFSET(0x19B23AD0)
#define SYSTEM_NET_BASELOGGINGOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B23A90)
