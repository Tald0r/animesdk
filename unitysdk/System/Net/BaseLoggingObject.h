...
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMPARRAYTOCONSOLE_OFFSET UNITYSDK_OFFSET(0x19685140)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMPARRAYTOFILE_OFFSET UNITYSDK_OFFSET(0x19685170)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMPARRAY_OFFSET UNITYSDK_OFFSET(0x19685160)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMP_1_OFFSET UNITYSDK_OFFSET(0x196851C0)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMP_2_OFFSET UNITYSDK_OFFSET(0x196851D0)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMP_3_OFFSET UNITYSDK_OFFSET(0x196851E0)
#define SYSTEM_NET_BASELOGGINGOBJECT_DUMP_OFFSET UNITYSDK_OFFSET(0x196851B0)
#define SYSTEM_NET_BASELOGGINGOBJECT_ENTERFUNC_OFFSET UNITYSDK_OFFSET(0x19685120)
#define SYSTEM_NET_BASELOGGINGOBJECT_FLUSH_1_OFFSET UNITYSDK_OFFSET(0x19685190)
#define SYSTEM_NET_BASELOGGINGOBJECT_FLUSH_OFFSET UNITYSDK_OFFSET(0x19685180)
#define SYSTEM_NET_BASELOGGINGOBJECT_LEAVEFUNC_OFFSET UNITYSDK_OFFSET(0x19685130)
#define SYSTEM_NET_BASELOGGINGOBJECT_LOGGINGMONITORTICK_OFFSET UNITYSDK_OFFSET(0x196851A0)
#define SYSTEM_NET_BASELOGGINGOBJECT_PRINTLINE_OFFSET UNITYSDK_OFFSET(0x19685150)
#define SYSTEM_NET_BASELOGGINGOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19685110)
