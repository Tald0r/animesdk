...
#define SYSTEM_NET_SOCKETS_UDPCLIENT_ALLOWNATTRAVERSAL_OFFSET UNITYSDK_OFFSET(0x19D2ED90)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_BEGINRECEIVE_OFFSET UNITYSDK_OFFSET(0x19D30430)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_BEGINSEND_1_OFFSET UNITYSDK_OFFSET(0x19D2FEC0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_BEGINSEND_2_OFFSET UNITYSDK_OFFSET(0x19D30130)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_BEGINSEND_OFFSET UNITYSDK_OFFSET(0x19D2FBE0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_CHECKFORBROADCAST_OFFSET UNITYSDK_OFFSET(0x19D2F3E0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_CLOSE_OFFSET UNITYSDK_OFFSET(0x19D2EED0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_CONNECT_1_OFFSET UNITYSDK_OFFSET(0x19D2F270)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_CONNECT_2_OFFSET UNITYSDK_OFFSET(0x19D2F0E0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_CONNECT_OFFSET UNITYSDK_OFFSET(0x19D2E0F0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_CREATECLIENTSOCKET_OFFSET UNITYSDK_OFFSET(0x19D2DD00)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19D2EFD0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19D2EFB0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_DROPMULTICASTGROUP_1_OFFSET UNITYSDK_OFFSET(0x19D31060)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_DROPMULTICASTGROUP_OFFSET UNITYSDK_OFFSET(0x19D30DA0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_ENDRECEIVE_OFFSET UNITYSDK_OFFSET(0x19D30550)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_ENDSEND_OFFSET UNITYSDK_OFFSET(0x19D30160)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_FREERESOURCES_OFFSET UNITYSDK_OFFSET(0x19D2EEF0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x19D2EAD0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0x19D2EAF0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_CLIENT_OFFSET UNITYSDK_OFFSET(0x19D2EAB0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_DONTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x19D2EB50)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_ENABLEBROADCAST_OFFSET UNITYSDK_OFFSET(0x19D2EC20)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x19D2EC60)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_MULTICASTLOOPBACK_OFFSET UNITYSDK_OFFSET(0x19D2EBE0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_GET_TTL_OFFSET UNITYSDK_OFFSET(0x19D2EB10)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_JOINMULTICASTGROUP_1_OFFSET UNITYSDK_OFFSET(0x19D309C0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_JOINMULTICASTGROUP_2_OFFSET UNITYSDK_OFFSET(0x19D30AC0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_JOINMULTICASTGROUP_3_OFFSET UNITYSDK_OFFSET(0x19D30C40)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_JOINMULTICASTGROUP_OFFSET UNITYSDK_OFFSET(0x19D30700)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x19D31580)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_RECEIVE_OFFSET UNITYSDK_OFFSET(0x19D30260)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SENDASYNC_1_OFFSET UNITYSDK_OFFSET(0x19D31310)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SENDASYNC_2_OFFSET UNITYSDK_OFFSET(0x19D31450)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x19D311E0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SEND_1_OFFSET UNITYSDK_OFFSET(0x19D2F700)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SEND_2_OFFSET UNITYSDK_OFFSET(0x19D2FA70)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SEND_OFFSET UNITYSDK_OFFSET(0x19D2F490)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x19D2EAE0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_CLIENT_OFFSET UNITYSDK_OFFSET(0x19D2EAC0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_DONTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x19D2EB70)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_ENABLEBROADCAST_OFFSET UNITYSDK_OFFSET(0x19D2EC40)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x19D2ED00)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_MULTICASTLOOPBACK_OFFSET UNITYSDK_OFFSET(0x19D2EC00)
#define SYSTEM_NET_SOCKETS_UDPCLIENT_SET_TTL_OFFSET UNITYSDK_OFFSET(0x19D2EB30)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D2DBF0)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19D2DD40)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19D2DD50)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19D2DF20)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19D2E000)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19D2DB70)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__RECEIVEASYNC_B__64_0_OFFSET UNITYSDK_OFFSET(0x19D31660)
#define SYSTEM_NET_SOCKETS_UDPCLIENT__RECEIVEASYNC_B__64_1_OFFSET UNITYSDK_OFFSET(0x19D31670)
