...
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_GET_ISCONNECTED_OFFSET UNITYSDK_OFFSET(0x8A1C70)
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_GET_ISLISTENING_OFFSET UNITYSDK_OFFSET(0x8A1C90)
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_GET_ISNONBLOCKING_OFFSET UNITYSDK_OFFSET(0x8A1C50)
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_GET_PROTOCOLINFORMATION_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_GET_USEONLYOVERLAPPEDIO_OFFSET UNITYSDK_OFFSET(0x8A1CB0)
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_SET_ISCONNECTED_OFFSET UNITYSDK_OFFSET(0x8A1C80)
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_SET_ISLISTENING_OFFSET UNITYSDK_OFFSET(0x8A1CA0)
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_SET_ISNONBLOCKING_OFFSET UNITYSDK_OFFSET(0x8A1C60)
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_SET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x2C6250)
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_SET_PROTOCOLINFORMATION_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_SET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x2D26A0)
#define SYSTEM_NET_SOCKETS_SOCKETINFORMATION_SET_USEONLYOVERLAPPEDIO_OFFSET UNITYSDK_OFFSET(0x8A1CC0)
