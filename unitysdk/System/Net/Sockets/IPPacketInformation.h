...
#define SYSTEM_NET_SOCKETS_IPPACKETINFORMATION_EQUALS_OFFSET UNITYSDK_OFFSET(0x84B360)
#define SYSTEM_NET_SOCKETS_IPPACKETINFORMATION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x84B3E0)
#define SYSTEM_NET_SOCKETS_IPPACKETINFORMATION_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define SYSTEM_NET_SOCKETS_IPPACKETINFORMATION_GET_INTERFACE_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define SYSTEM_NET_SOCKETS_IPPACKETINFORMATION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18D87570)
#define SYSTEM_NET_SOCKETS_IPPACKETINFORMATION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18D876A0)
#define SYSTEM_NET_SOCKETS_IPPACKETINFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x324900)
