...
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x195DB080)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x195DB090)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_ENDOFPACKET_OFFSET UNITYSDK_OFFSET(0x195DB0B0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_FILEPATH_OFFSET UNITYSDK_OFFSET(0x195DB070)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x195DB0A0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x195DAEB0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195DAD20)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x195DAE90)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x195DADA0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x195DAED0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x195DB050)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_6_OFFSET UNITYSDK_OFFSET(0x195DAF50)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x195DAD10)
