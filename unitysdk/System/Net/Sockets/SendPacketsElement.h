...
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x191DECE0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x191DECF0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_ENDOFPACKET_OFFSET UNITYSDK_OFFSET(0x191DED10)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_FILEPATH_OFFSET UNITYSDK_OFFSET(0x191DECD0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x191DED00)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x191DEB10)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191DE980)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191DEAF0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x191DEA00)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x191DEB30)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x191DECB0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_6_OFFSET UNITYSDK_OFFSET(0x191DEBB0)
#define SYSTEM_NET_SOCKETS_SENDPACKETSELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x191DE970)
