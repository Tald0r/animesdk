...
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_ASYNCFAIL_OFFSET UNITYSDK_OFFSET(0x197EDCF0)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_ATTEMPTCONNECTION_OFFSET UNITYSDK_OFFSET(0x197ED500)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_CALLASYNCFAIL_OFFSET UNITYSDK_OFFSET(0x197EDEC0)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_CANCEL_OFFSET UNITYSDK_OFFSET(0x197EDD70)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_DNSCALLBACK_OFFSET UNITYSDK_OFFSET(0x197ED440)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_DODNSCALLBACK_OFFSET UNITYSDK_OFFSET(0x197ED0D0)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_FAIL_OFFSET UNITYSDK_OFFSET(0x197ED810)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_INTERNALCONNECTCALLBACK_OFFSET UNITYSDK_OFFSET(0x197ED870)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_STARTCONNECTASYNC_OFFSET UNITYSDK_OFFSET(0x197ECD30)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_SUCCEED_OFFSET UNITYSDK_OFFSET(0x197EDC20)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_SYNCFAIL_OFFSET UNITYSDK_OFFSET(0x197ECFE0)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x197EDFF0)
...
namespace System::Net::Sockets
{
	...
	public:
		...
		::Il2CppArray<::System::Net::IPAddress*>* addressList; // 0x28
