...
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_ASYNCFAIL_OFFSET UNITYSDK_OFFSET(0x19D2D070)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_ATTEMPTCONNECTION_OFFSET UNITYSDK_OFFSET(0x19D2C880)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_CALLASYNCFAIL_OFFSET UNITYSDK_OFFSET(0x19D2D240)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_CANCEL_OFFSET UNITYSDK_OFFSET(0x19D2D0F0)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_DNSCALLBACK_OFFSET UNITYSDK_OFFSET(0x19D2C7C0)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_DODNSCALLBACK_OFFSET UNITYSDK_OFFSET(0x19D2C450)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_FAIL_OFFSET UNITYSDK_OFFSET(0x19D2CB90)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_INTERNALCONNECTCALLBACK_OFFSET UNITYSDK_OFFSET(0x19D2CBF0)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_STARTCONNECTASYNC_OFFSET UNITYSDK_OFFSET(0x19D2C0B0)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_SUCCEED_OFFSET UNITYSDK_OFFSET(0x19D2CFA0)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC_SYNCFAIL_OFFSET UNITYSDK_OFFSET(0x19D2C360)
#define SYSTEM_NET_SOCKETS_MULTIPLECONNECTASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x19D2D380)
...
namespace System::Net::Sockets
{
	...
	{
	public:
		::System::Net::DnsEndPoint* endPoint; // 0x10
		::Il2CppArray<::System::Net::IPAddress*>* addressList; // 0x18
		::System::Net::Sockets::SocketAsyncEventArgs* userArgs; // 0x20
		::System::Net::Sockets::SocketAsyncEventArgs* internalArgs; // 0x28
		::System::Object* lockObject; // 0x30
		::System::Net::Sockets::MultipleConnectAsync_State state; // 0x38
		::System::Int32 nextAddress; // 0x3C
