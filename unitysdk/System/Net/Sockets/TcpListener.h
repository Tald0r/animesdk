...
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ACCEPTSOCKETASYNC_OFFSET UNITYSDK_OFFSET(0x1938E1A0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x1938DDF0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ACCEPTTCPCLIENTASYNC_OFFSET UNITYSDK_OFFSET(0x1938E2B0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ACCEPTTCPCLIENT_OFFSET UNITYSDK_OFFSET(0x1938DE70)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ALLOWNATTRAVERSAL_OFFSET UNITYSDK_OFFSET(0x1938D910)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_BEGINACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x1938DEF0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_BEGINACCEPTTCPCLIENT_OFFSET UNITYSDK_OFFSET(0x1938E050)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_CREATE_OFFSET UNITYSDK_OFFSET(0x1938D590)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ENDACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x1938DF80)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ENDACCEPTTCPCLIENT_OFFSET UNITYSDK_OFFSET(0x1938E0B0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1938D730)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_GET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x1938D770)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x1938D740)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_GET_SERVER_OFFSET UNITYSDK_OFFSET(0x1938D720)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_PENDING_OFFSET UNITYSDK_OFFSET(0x1938DD70)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_SET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x1938D810)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_START_1_OFFSET UNITYSDK_OFFSET(0x1938DAE0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_START_OFFSET UNITYSDK_OFFSET(0x1938DAD0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_STOP_OFFSET UNITYSDK_OFFSET(0x1938DC20)
#define SYSTEM_NET_SOCKETS_TCPLISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1938D330)
#define SYSTEM_NET_SOCKETS_TCPLISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1938D440)
#define SYSTEM_NET_SOCKETS_TCPLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1938D280)
