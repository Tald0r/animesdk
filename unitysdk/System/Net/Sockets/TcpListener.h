...
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ACCEPTSOCKETASYNC_OFFSET UNITYSDK_OFFSET(0x18FFCC90)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x18FFC8E0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ACCEPTTCPCLIENTASYNC_OFFSET UNITYSDK_OFFSET(0x18FFCDA0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ACCEPTTCPCLIENT_OFFSET UNITYSDK_OFFSET(0x18FFC960)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ALLOWNATTRAVERSAL_OFFSET UNITYSDK_OFFSET(0x18FFC400)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_BEGINACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x18FFC9E0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_BEGINACCEPTTCPCLIENT_OFFSET UNITYSDK_OFFSET(0x18FFCB40)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_CREATE_OFFSET UNITYSDK_OFFSET(0x18FFC080)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ENDACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x18FFCA70)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_ENDACCEPTTCPCLIENT_OFFSET UNITYSDK_OFFSET(0x18FFCBA0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x18FFC220)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_GET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x18FFC260)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_GET_LOCALENDPOINT_OFFSET UNITYSDK_OFFSET(0x18FFC230)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_GET_SERVER_OFFSET UNITYSDK_OFFSET(0x18FFC210)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_PENDING_OFFSET UNITYSDK_OFFSET(0x18FFC860)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_SET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x18FFC300)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_START_1_OFFSET UNITYSDK_OFFSET(0x18FFC5D0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_START_OFFSET UNITYSDK_OFFSET(0x18FFC5C0)
#define SYSTEM_NET_SOCKETS_TCPLISTENER_STOP_OFFSET UNITYSDK_OFFSET(0x18FFC710)
#define SYSTEM_NET_SOCKETS_TCPLISTENER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FFBE20)
#define SYSTEM_NET_SOCKETS_TCPLISTENER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FFBF30)
#define SYSTEM_NET_SOCKETS_TCPLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FFBD70)
