...
#define SYSTEM_NET_SOCKETS_TCPCLIENT_BEGINCONNECT_1_OFFSET UNITYSDK_OFFSET(0x187E6050)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_BEGINCONNECT_2_OFFSET UNITYSDK_OFFSET(0x187E6070)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_BEGINCONNECT_OFFSET UNITYSDK_OFFSET(0x187E6030)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CLOSE_OFFSET UNITYSDK_OFFSET(0x187E6620)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECTASYNC_1_OFFSET UNITYSDK_OFFSET(0x187E6220)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECTASYNC_2_OFFSET UNITYSDK_OFFSET(0x187E6380)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECTASYNC_OFFSET UNITYSDK_OFFSET(0x187E60C0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECT_1_OFFSET UNITYSDK_OFFSET(0x187E5E90)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECT_2_OFFSET UNITYSDK_OFFSET(0x187E5DB0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECT_3_OFFSET UNITYSDK_OFFSET(0x187E6000)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_CONNECT_OFFSET UNITYSDK_OFFSET(0x187E5180)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x187E6640)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x187E6660)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_ENDCONNECT_OFFSET UNITYSDK_OFFSET(0x187E6090)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x187E68C0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x187E64E0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x187E5C20)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0x187E5C40)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_CLIENT_OFFSET UNITYSDK_OFFSET(0x187E5C00)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_CONNECTED_OFFSET UNITYSDK_OFFSET(0x187E5C60)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x187E5C80)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_LINGERSTATE_OFFSET UNITYSDK_OFFSET(0x187E6CC0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_NODELAY_OFFSET UNITYSDK_OFFSET(0x187E6D50)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_RECEIVEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x187E6930)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_RECEIVETIMEOUT_OFFSET UNITYSDK_OFFSET(0x187E6B40)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_SENDBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x187E6A80)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_GET_SENDTIMEOUT_OFFSET UNITYSDK_OFFSET(0x187E6C00)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x187E4E30)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_NUMERICOPTION_OFFSET UNITYSDK_OFFSET(0x187E69C0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x187E5C30)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_CLIENT_OFFSET UNITYSDK_OFFSET(0x187E5C10)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_EXCLUSIVEADDRESSUSE_OFFSET UNITYSDK_OFFSET(0x187E5D20)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_LINGERSTATE_OFFSET UNITYSDK_OFFSET(0x187E6D20)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_NODELAY_OFFSET UNITYSDK_OFFSET(0x187E6DF0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_RECEIVEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x187E6A50)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_RECEIVETIMEOUT_OFFSET UNITYSDK_OFFSET(0x187E6BD0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_SENDBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x187E6B10)
#define SYSTEM_NET_SOCKETS_TCPCLIENT_SET_SENDTIMEOUT_OFFSET UNITYSDK_OFFSET(0x187E6C90)
#define SYSTEM_NET_SOCKETS_TCPCLIENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x187E4E80)
#define SYSTEM_NET_SOCKETS_TCPCLIENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x187E4EF0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x187E4FF0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x187E5BF0)
#define SYSTEM_NET_SOCKETS_TCPCLIENT__CTOR_OFFSET UNITYSDK_OFFSET(0x187E4D60)
