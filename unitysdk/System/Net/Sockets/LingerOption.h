...
#define SYSTEM_NET_SOCKETS_LINGEROPTION_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x191DE930)
#define SYSTEM_NET_SOCKETS_LINGEROPTION_GET_LINGERTIME_OFFSET UNITYSDK_OFFSET(0x191DE950)
#define SYSTEM_NET_SOCKETS_LINGEROPTION_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x191DE940)
#define SYSTEM_NET_SOCKETS_LINGEROPTION_SET_LINGERTIME_OFFSET UNITYSDK_OFFSET(0x191DE960)
#define SYSTEM_NET_SOCKETS_LINGEROPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x191DE920)
