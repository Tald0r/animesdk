...
#define SYSTEM_NET_SOCKETS_MULTIPLESOCKETMULTIPLECONNECTASYNC_GETNEXTADDRESS_OFFSET UNITYSDK_OFFSET(0x182DEAA0)
#define SYSTEM_NET_SOCKETS_MULTIPLESOCKETMULTIPLECONNECTASYNC_ONFAIL_OFFSET UNITYSDK_OFFSET(0x182DEC30)
#define SYSTEM_NET_SOCKETS_MULTIPLESOCKETMULTIPLECONNECTASYNC_ONSUCCEED_OFFSET UNITYSDK_OFFSET(0x182DEB50)
#define SYSTEM_NET_SOCKETS_MULTIPLESOCKETMULTIPLECONNECTASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x182DE9A0)
