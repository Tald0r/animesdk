...
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_GET_GROUP_OFFSET UNITYSDK_OFFSET(0x18D87A00)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_GET_INTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x18D87A30)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_GET_LOCALADDRESS_OFFSET UNITYSDK_OFFSET(0x18D87A20)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_SET_GROUP_OFFSET UNITYSDK_OFFSET(0x18D87A10)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_SET_INTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x18D87A40)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_SET_LOCALADDRESS_OFFSET UNITYSDK_OFFSET(0x18D878A0)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18D878B0)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18D87960)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18D877F0)
