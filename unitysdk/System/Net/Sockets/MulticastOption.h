...
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_GET_GROUP_OFFSET UNITYSDK_OFFSET(0x191D06D0)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_GET_INTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x191D0700)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_GET_LOCALADDRESS_OFFSET UNITYSDK_OFFSET(0x191D06F0)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_SET_GROUP_OFFSET UNITYSDK_OFFSET(0x191D06E0)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_SET_INTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x191D0710)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION_SET_LOCALADDRESS_OFFSET UNITYSDK_OFFSET(0x191D0570)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191D0580)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191D0630)
#define SYSTEM_NET_SOCKETS_MULTICASTOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x191D04C0)
