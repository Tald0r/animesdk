...
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC_GETNEXTADDRESS_OFFSET UNITYSDK_OFFSET(0x19246FD0)
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC_ONFAIL_OFFSET UNITYSDK_OFFSET(0x19247070)
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC_ONSUCCEED_OFFSET UNITYSDK_OFFSET(0x192470F0)
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x19246FA0)
