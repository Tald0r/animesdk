...
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC_GETNEXTADDRESS_OFFSET UNITYSDK_OFFSET(0x18E43D00)
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC_ONFAIL_OFFSET UNITYSDK_OFFSET(0x18E43DA0)
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC_ONSUCCEED_OFFSET UNITYSDK_OFFSET(0x18E43E20)
#define SYSTEM_NET_SOCKETS_SINGLESOCKETMULTIPLECONNECTASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x18E43CD0)
