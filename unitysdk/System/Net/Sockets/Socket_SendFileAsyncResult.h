...
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_ASYNCSTATE_OFFSET UNITYSDK_OFFSET(0x185A4EE0)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_ASYNCWAITHANDLE_OFFSET UNITYSDK_OFFSET(0x185A4F90)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_COMPLETEDSYNCHRONOUSLY_OFFSET UNITYSDK_OFFSET(0x185A5040)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_DELEGATE_OFFSET UNITYSDK_OFFSET(0x185A51A0)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x185A50F0)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT_GET_ORIGINAL_OFFSET UNITYSDK_OFFSET(0x185A51B0)
#define SYSTEM_NET_SOCKETS_SOCKET_SENDFILEASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x185A4ED0)
