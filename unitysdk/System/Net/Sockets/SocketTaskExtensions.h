...
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_ACCEPTASYNC_1_OFFSET UNITYSDK_OFFSET(0x1932A890)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_ACCEPTASYNC_OFFSET UNITYSDK_OFFSET(0x1932A660)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_1_OFFSET UNITYSDK_OFFSET(0x1932AD00)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_2_OFFSET UNITYSDK_OFFSET(0x1932AF70)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_3_OFFSET UNITYSDK_OFFSET(0x1932B1E0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_OFFSET UNITYSDK_OFFSET(0x1932AAD0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1932B6B0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x1932B450)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEFROMASYNC_OFFSET UNITYSDK_OFFSET(0x1932B8F0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEMESSAGEFROMASYNC_OFFSET UNITYSDK_OFFSET(0x1932BC50)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_SENDASYNC_1_OFFSET UNITYSDK_OFFSET(0x1932C250)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x1932BFF0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_SENDTOASYNC_OFFSET UNITYSDK_OFFSET(0x1932C490)
