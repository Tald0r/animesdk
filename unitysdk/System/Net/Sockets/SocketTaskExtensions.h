...
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_ACCEPTASYNC_1_OFFSET UNITYSDK_OFFSET(0x18F5A6F0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_ACCEPTASYNC_OFFSET UNITYSDK_OFFSET(0x18F5A4C0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_1_OFFSET UNITYSDK_OFFSET(0x18F5AB60)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_2_OFFSET UNITYSDK_OFFSET(0x18F5ADD0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_3_OFFSET UNITYSDK_OFFSET(0x18F5B040)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_CONNECTASYNC_OFFSET UNITYSDK_OFFSET(0x18F5A930)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEASYNC_1_OFFSET UNITYSDK_OFFSET(0x18F5B510)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEASYNC_OFFSET UNITYSDK_OFFSET(0x18F5B2B0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEFROMASYNC_OFFSET UNITYSDK_OFFSET(0x18F5B750)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_RECEIVEMESSAGEFROMASYNC_OFFSET UNITYSDK_OFFSET(0x18F5BAB0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_SENDASYNC_1_OFFSET UNITYSDK_OFFSET(0x18F5C0B0)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_SENDASYNC_OFFSET UNITYSDK_OFFSET(0x18F5BE50)
#define SYSTEM_NET_SOCKETS_SOCKETTASKEXTENSIONS_SENDTOASYNC_OFFSET UNITYSDK_OFFSET(0x18F5C2F0)
