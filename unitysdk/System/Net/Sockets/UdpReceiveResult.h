...
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x38ADC0)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_EQUALS_OFFSET UNITYSDK_OFFSET(0x87B360)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x87B2A0)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x191DF010)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x191DF0A0)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x87B290)
