...
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x6B3130)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_EQUALS_OFFSET UNITYSDK_OFFSET(0x8AE560)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8AE4A0)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x223870)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x272280)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x195DB3B0)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x195DB440)
#define SYSTEM_NET_SOCKETS_UDPRECEIVERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x8AE490)
