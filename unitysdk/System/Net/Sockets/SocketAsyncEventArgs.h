...
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_ADD_COMPLETED_OFFSET UNITYSDK_OFFSET(0x19D7DF20)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_COMPLETE_OFFSET UNITYSDK_OFFSET(0x19D7E1D0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19D7E0D0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19D7E0C0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19D7E0B0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINISHCONNECTBYNAMESYNCFAILURE_OFFSET UNITYSDK_OFFSET(0x19D7E390)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINISHOPERATIONASYNCFAILURE_OFFSET UNITYSDK_OFFSET(0x19D7E3E0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINISHWRAPPERCONNECTSUCCESS_OFFSET UNITYSDK_OFFSET(0x19D7E430)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_ACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x19D7DC70)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_BUFFERLIST_OFFSET UNITYSDK_OFFSET(0x19D7DCB0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x19D7DC90)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_BYTESTRANSFERRED_OFFSET UNITYSDK_OFFSET(0x19D7DD40)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_CONNECTBYNAMEERROR_OFFSET UNITYSDK_OFFSET(0x19D7DC50)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_CONNECTSOCKET_OFFSET UNITYSDK_OFFSET(0x19D7DEE0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19D7DD60)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_DISCONNECTREUSESOCKET_OFFSET UNITYSDK_OFFSET(0x19D7DD80)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_LASTOPERATION_OFFSET UNITYSDK_OFFSET(0x19D7DDA0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x19D7DDC0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_POLICYRESTRICTED_OFFSET UNITYSDK_OFFSET(0x19D7DF00)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_RECEIVEMESSAGEFROMPACKETINFO_OFFSET UNITYSDK_OFFSET(0x19D7DE00)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x19D7DDE0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SENDPACKETSELEMENTS_OFFSET UNITYSDK_OFFSET(0x19D7DE20)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SENDPACKETSFLAGS_OFFSET UNITYSDK_OFFSET(0x19D7DE40)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SENDPACKETSSENDSIZE_OFFSET UNITYSDK_OFFSET(0x19D7DE60)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SOCKETCLIENTACCESSPOLICYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x19D7E480)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SOCKETERROR_OFFSET UNITYSDK_OFFSET(0x19D7DE80)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SOCKETFLAGS_OFFSET UNITYSDK_OFFSET(0x19D7DEA0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_USERTOKEN_OFFSET UNITYSDK_OFFSET(0x19D7DEC0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x19D7E1F0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_REMOVE_COMPLETED_OFFSET UNITYSDK_OFFSET(0x19D7DFA0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETBUFFER_1_OFFSET UNITYSDK_OFFSET(0x19D7E260)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x19D7E250)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETLASTOPERATION_OFFSET UNITYSDK_OFFSET(0x19D7E120)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETRESULTS_OFFSET UNITYSDK_OFFSET(0x19D7E460)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_ACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x19D7DC80)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_BUFFERLIST_OFFSET UNITYSDK_OFFSET(0x19D7DCC0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_BUFFER_OFFSET UNITYSDK_OFFSET(0x19D7DCA0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_BYTESTRANSFERRED_OFFSET UNITYSDK_OFFSET(0x19D7DD50)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_CONNECTBYNAMEERROR_OFFSET UNITYSDK_OFFSET(0x19D7DC60)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x19D7DD70)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_DISCONNECTREUSESOCKET_OFFSET UNITYSDK_OFFSET(0x19D7DD90)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_LASTOPERATION_OFFSET UNITYSDK_OFFSET(0x19D7DDB0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x19D7DDD0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_POLICYRESTRICTED_OFFSET UNITYSDK_OFFSET(0x19D7DF10)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_RECEIVEMESSAGEFROMPACKETINFO_OFFSET UNITYSDK_OFFSET(0x19D7DE10)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x19D7DDF0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SENDPACKETSELEMENTS_OFFSET UNITYSDK_OFFSET(0x19D7DE30)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SENDPACKETSFLAGS_OFFSET UNITYSDK_OFFSET(0x19D7DE50)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SENDPACKETSSENDSIZE_OFFSET UNITYSDK_OFFSET(0x19D7DE70)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SOCKETCLIENTACCESSPOLICYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x19D7E4C0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SOCKETERROR_OFFSET UNITYSDK_OFFSET(0x19D7DE90)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SOCKETFLAGS_OFFSET UNITYSDK_OFFSET(0x19D7DEB0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_USERTOKEN_OFFSET UNITYSDK_OFFSET(0x19D7DED0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_STARTOPERATIONCOMMON_OFFSET UNITYSDK_OFFSET(0x19D7E370)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_STARTOPERATIONWRAPPERCONNECT_OFFSET UNITYSDK_OFFSET(0x19D7E380)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D7E070)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19D7E020)
...
namespace System::Net::Sockets
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* _Buffer_k__BackingField; // 0x28
		...
		::Il2CppArray<::System::Net::Sockets::SendPacketsElement*>* _SendPacketsElements_k__BackingField; // 0x40
		...
		::System::EventHandler_1<::System::Net::Sockets::SocketAsyncEventArgs*>* Completed; // 0x60
		::System::Net::EndPoint* remote_ep; // 0x68
		::System::Boolean _DisconnectReuseSocket_k__BackingField; // 0x70
		::System::Boolean disposed; // 0x71
		::System::Boolean _PolicyRestricted_k__BackingField; // 0x72
		::System::Int32 _SendPacketsSendSize_k__BackingField; // 0x74
		::System::Net::Sockets::SocketFlags _SocketFlags_k__BackingField; // 0x78
		::System::Int32 in_progress; // 0x7C
		::System::Int32 _Offset_k__BackingField; // 0x80
		::System::Net::Sockets::SocketError _SocketError_k__BackingField; // 0x84
		::System::Int32 _BytesTransferred_k__BackingField; // 0x88
		::System::Net::Sockets::TransmitFileOptions _SendPacketsFlags_k__BackingField; // 0x8C
