...
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_ADD_COMPLETED_OFFSET UNITYSDK_OFFSET(0x1A33C430)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1A33C6E0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A33C5E0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A33C5D0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A33C5C0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINISHCONNECTBYNAMESYNCFAILURE_OFFSET UNITYSDK_OFFSET(0x1A33C890)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINISHOPERATIONASYNCFAILURE_OFFSET UNITYSDK_OFFSET(0x1A33C8E0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_FINISHWRAPPERCONNECTSUCCESS_OFFSET UNITYSDK_OFFSET(0x1A33C930)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_ACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x1A33C180)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_BUFFERLIST_OFFSET UNITYSDK_OFFSET(0x1A33C1C0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1A33C1A0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_BYTESTRANSFERRED_OFFSET UNITYSDK_OFFSET(0x1A33C250)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_CONNECTBYNAMEERROR_OFFSET UNITYSDK_OFFSET(0x1A33C160)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_CONNECTSOCKET_OFFSET UNITYSDK_OFFSET(0x1A33C3F0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A33C270)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_DISCONNECTREUSESOCKET_OFFSET UNITYSDK_OFFSET(0x1A33C290)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_LASTOPERATION_OFFSET UNITYSDK_OFFSET(0x1A33C2B0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1A33C2D0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_POLICYRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1A33C410)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_RECEIVEMESSAGEFROMPACKETINFO_OFFSET UNITYSDK_OFFSET(0x1A33C310)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x1A33C2F0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SENDPACKETSELEMENTS_OFFSET UNITYSDK_OFFSET(0x1A33C330)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SENDPACKETSFLAGS_OFFSET UNITYSDK_OFFSET(0x1A33C350)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SENDPACKETSSENDSIZE_OFFSET UNITYSDK_OFFSET(0x1A33C370)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SOCKETCLIENTACCESSPOLICYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1A33C980)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SOCKETERROR_OFFSET UNITYSDK_OFFSET(0x1A33C390)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_SOCKETFLAGS_OFFSET UNITYSDK_OFFSET(0x1A33C3B0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_GET_USERTOKEN_OFFSET UNITYSDK_OFFSET(0x1A33C3D0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1A33C700)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_REMOVE_COMPLETED_OFFSET UNITYSDK_OFFSET(0x1A33C4B0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1A33C770)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x1A33C760)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETLASTOPERATION_OFFSET UNITYSDK_OFFSET(0x1A33C630)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SETRESULTS_OFFSET UNITYSDK_OFFSET(0x1A33C960)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_ACCEPTSOCKET_OFFSET UNITYSDK_OFFSET(0x1A33C190)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_BUFFERLIST_OFFSET UNITYSDK_OFFSET(0x1A33C1D0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1A33C1B0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_BYTESTRANSFERRED_OFFSET UNITYSDK_OFFSET(0x1A33C260)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_CONNECTBYNAMEERROR_OFFSET UNITYSDK_OFFSET(0x1A33C170)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A33C280)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_DISCONNECTREUSESOCKET_OFFSET UNITYSDK_OFFSET(0x1A33C2A0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_LASTOPERATION_OFFSET UNITYSDK_OFFSET(0x1A33C2C0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1A33C2E0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_POLICYRESTRICTED_OFFSET UNITYSDK_OFFSET(0x1A33C420)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_RECEIVEMESSAGEFROMPACKETINFO_OFFSET UNITYSDK_OFFSET(0x1A33C320)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_REMOTEENDPOINT_OFFSET UNITYSDK_OFFSET(0x1A33C300)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SENDPACKETSELEMENTS_OFFSET UNITYSDK_OFFSET(0x1A33C340)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SENDPACKETSFLAGS_OFFSET UNITYSDK_OFFSET(0x1A33C360)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SENDPACKETSSENDSIZE_OFFSET UNITYSDK_OFFSET(0x1A33C380)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SOCKETCLIENTACCESSPOLICYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1A33C9C0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SOCKETERROR_OFFSET UNITYSDK_OFFSET(0x1A33C3A0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_SOCKETFLAGS_OFFSET UNITYSDK_OFFSET(0x1A33C3C0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_SET_USERTOKEN_OFFSET UNITYSDK_OFFSET(0x1A33C3E0)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_STARTOPERATIONCOMMON_OFFSET UNITYSDK_OFFSET(0x1A33C870)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS_STARTOPERATIONWRAPPERCONNECT_OFFSET UNITYSDK_OFFSET(0x1A33C880)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A33C580)
#define SYSTEM_NET_SOCKETS_SOCKETASYNCEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A33C530)
...
namespace System::Net::Sockets
{
	...
	{
	public:
		::Il2CppArray<::System::Byte>* _Buffer_k__BackingField; // 0x10
		...
		::System::Net::Sockets::Socket* _AcceptSocket_k__BackingField; // 0x30
		::System::Net::Sockets::IPPacketInformation _ReceiveMessageFromPacketInfo_k__BackingField; // 0x38
		::System::Exception* _ConnectByNameError_k__BackingField; // 0x48
		::System::Net::Sockets::Socket* current_socket; // 0x50
		::System::Net::EndPoint* remote_ep; // 0x58
		::Il2CppArray<::System::Net::Sockets::SendPacketsElement*>* _SendPacketsElements_k__BackingField; // 0x60
		::System::Object* _UserToken_k__BackingField; // 0x68
		::System::Int32 _SendPacketsSendSize_k__BackingField; // 0x70
		::System::Int32 _Count_k__BackingField; // 0x74
		::System::Int32 _Offset_k__BackingField; // 0x78
		::System::Net::Sockets::SocketAsyncOperation _LastOperation_k__BackingField; // 0x7C
		::System::Net::Sockets::SocketError _SocketError_k__BackingField; // 0x80
		::System::Int32 in_progress; // 0x84
		::System::Net::Sockets::SocketFlags _SocketFlags_k__BackingField; // 0x88
		::System::Boolean _PolicyRestricted_k__BackingField; // 0x8C
		::System::Boolean _DisconnectReuseSocket_k__BackingField; // 0x8D
		::System::Boolean disposed; // 0x8E
		::System::Net::Sockets::TransmitFileOptions _SendPacketsFlags_k__BackingField; // 0x90
