...
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_BEGINMULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x194689D0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x194675D0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x19467EA0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x19467410)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_CONVERTTONOTSOCKETOWNER_OFFSET UNITYSDK_OFFSET(0x19466470)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x194674C0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_ENDMULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x19468E30)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x19467C10)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x19468520)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x194675A0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_FLUSHASYNC_OFFSET UNITYSDK_OFFSET(0x194690A0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x19469090)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x19466500)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x19466510)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x19466530)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x19466520)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CONNECTED_OFFSET UNITYSDK_OFFSET(0x194675B0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_DATAAVAILABLE_OFFSET UNITYSDK_OFFSET(0x194668B0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_INTERNALSOCKET_OFFSET UNITYSDK_OFFSET(0x194662B0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x194669D0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x19466A30)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_READABLE_OFFSET UNITYSDK_OFFSET(0x194664C0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x19466540)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_SOCKET_OFFSET UNITYSDK_OFFSET(0x194662A0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_WRITEABLE_OFFSET UNITYSDK_OFFSET(0x194664E0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x19466740)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_INITNETWORKSTREAM_OFFSET UNITYSDK_OFFSET(0x19465F30)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_INTERNALABORTSOCKET_OFFSET UNITYSDK_OFFSET(0x19466340)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_MULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x194687B0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_POLLREAD_OFFSET UNITYSDK_OFFSET(0x19466B50)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_POLL_OFFSET UNITYSDK_OFFSET(0x19466B70)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x19466C90)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x19466AF0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x19469130)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SETSOCKETTIMEOUTOPTION_OFFSET UNITYSDK_OFFSET(0x194666B0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x19466A90)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_READABLE_OFFSET UNITYSDK_OFFSET(0x194664D0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x194665E0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_WRITEABLE_OFFSET UNITYSDK_OFFSET(0x194664F0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x194667E0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_UNSAFEBEGINMULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x19468C00)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_UNSAFEBEGINREAD_OFFSET UNITYSDK_OFFSET(0x19467940)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_UNSAFEBEGINWRITE_OFFSET UNITYSDK_OFFSET(0x19468210)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x19467060)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19465E90)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19466010)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_3_OFFSET UNITYSDK_OFFSET(0x194660A0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19466150)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_5_OFFSET UNITYSDK_OFFSET(0x194661F0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19465E50)
...
namespace System::Net::Sockets
{
	...
	public:
		...
		::System::Boolean m_CleanedUp; // 0x38
		::System::Boolean m_Writeable; // 0x39
		::System::Boolean m_OwnsSocket; // 0x3A
