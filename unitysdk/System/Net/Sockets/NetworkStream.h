...
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_BEGINMULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x190AC1E0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x190AADE0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x190AB6B0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x190AAC20)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_CONVERTTONOTSOCKETOWNER_OFFSET UNITYSDK_OFFSET(0x190A9C80)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x190AACD0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_ENDMULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x190AC640)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x190AB420)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x190ABD30)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x190AADB0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_FLUSHASYNC_OFFSET UNITYSDK_OFFSET(0x190AC8B0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x190AC8A0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x190A9D10)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x190A9D20)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x190A9D40)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x190A9D30)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_CONNECTED_OFFSET UNITYSDK_OFFSET(0x190AADC0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_DATAAVAILABLE_OFFSET UNITYSDK_OFFSET(0x190AA0C0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_INTERNALSOCKET_OFFSET UNITYSDK_OFFSET(0x190A9AC0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x190AA1E0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x190AA240)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_READABLE_OFFSET UNITYSDK_OFFSET(0x190A9CD0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x190A9D50)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_SOCKET_OFFSET UNITYSDK_OFFSET(0x190A9AB0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_WRITEABLE_OFFSET UNITYSDK_OFFSET(0x190A9CF0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_GET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x190A9F50)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_INITNETWORKSTREAM_OFFSET UNITYSDK_OFFSET(0x190A9740)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_INTERNALABORTSOCKET_OFFSET UNITYSDK_OFFSET(0x190A9B50)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_MULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x190ABFC0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_POLLREAD_OFFSET UNITYSDK_OFFSET(0x190AA360)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_POLL_OFFSET UNITYSDK_OFFSET(0x190AA380)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x190AA4A0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x190AA300)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x190AC940)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SETSOCKETTIMEOUTOPTION_OFFSET UNITYSDK_OFFSET(0x190A9EC0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x190AA2A0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_READABLE_OFFSET UNITYSDK_OFFSET(0x190A9CE0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x190A9DF0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_WRITEABLE_OFFSET UNITYSDK_OFFSET(0x190A9D00)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_SET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x190A9FF0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_UNSAFEBEGINMULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x190AC410)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_UNSAFEBEGINREAD_OFFSET UNITYSDK_OFFSET(0x190AB150)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_UNSAFEBEGINWRITE_OFFSET UNITYSDK_OFFSET(0x190ABA20)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x190AA870)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x190A96A0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x190A9820)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_3_OFFSET UNITYSDK_OFFSET(0x190A98B0)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_4_OFFSET UNITYSDK_OFFSET(0x190A9960)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_5_OFFSET UNITYSDK_OFFSET(0x190A9A00)
#define SYSTEM_NET_SOCKETS_NETWORKSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x190A9660)
