...
#define SYSTEM_NET_SOCKETS_IPV6MULTICASTOPTION_GET_GROUP_OFFSET UNITYSDK_OFFSET(0x187E4D40)
#define SYSTEM_NET_SOCKETS_IPV6MULTICASTOPTION_GET_INTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x187E4D50)
#define SYSTEM_NET_SOCKETS_IPV6MULTICASTOPTION_SET_GROUP_OFFSET UNITYSDK_OFFSET(0x187E4B90)
#define SYSTEM_NET_SOCKETS_IPV6MULTICASTOPTION_SET_INTERFACEINDEX_OFFSET UNITYSDK_OFFSET(0x187E4C00)
#define SYSTEM_NET_SOCKETS_IPV6MULTICASTOPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x187E4C80)
#define SYSTEM_NET_SOCKETS_IPV6MULTICASTOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x187E4AA0)
