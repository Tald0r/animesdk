...
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x182DD0C0)
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x182DD100)
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x182DCB40)
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x182DCB30)
