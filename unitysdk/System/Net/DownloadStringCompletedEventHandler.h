...
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x188F1DE0)
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x188F1E20)
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x188F1860)
#define SYSTEM_NET_DOWNLOADSTRINGCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x188F1840)
