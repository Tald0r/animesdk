...
#define SYSTEM_NET_BASE64STREAM_READASYNCRESULT_COMPLETEREAD_OFFSET UNITYSDK_OFFSET(0x18D719E0)
#define SYSTEM_NET_BASE64STREAM_READASYNCRESULT_END_OFFSET UNITYSDK_OFFSET(0x18D71E40)
#define SYSTEM_NET_BASE64STREAM_READASYNCRESULT_ONREAD_OFFSET UNITYSDK_OFFSET(0x18D71C00)
#define SYSTEM_NET_BASE64STREAM_READASYNCRESULT_READ_OFFSET UNITYSDK_OFFSET(0x18D71A60)
#define SYSTEM_NET_BASE64STREAM_READASYNCRESULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x18D71EC0)
#define SYSTEM_NET_BASE64STREAM_READASYNCRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D71960)
