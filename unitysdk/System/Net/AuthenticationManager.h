...
#define SYSTEM_NET_AUTHENTICATIONMANAGER_AUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x193A3500)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x193A33C0)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_DOAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x193A3600)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_DOUNREGISTER_OFFSET UNITYSDK_OFFSET(0x193A4590)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_ENSUREMODULES_OFFSET UNITYSDK_OFFSET(0x193A2F10)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_GETMUSTIMPLEMENT_OFFSET UNITYSDK_OFFSET(0x193A3240)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_GET_CREDENTIALPOLICY_OFFSET UNITYSDK_OFFSET(0x193A3180)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_GET_CUSTOMTARGETNAMEDICTIONARY_OFFSET UNITYSDK_OFFSET(0x193A32F0)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_GET_OSSUPPORTSEXTENDEDPROTECTION_OFFSET UNITYSDK_OFFSET(0x193A33B0)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_GET_REGISTEREDMODULES_OFFSET UNITYSDK_OFFSET(0x193A3330)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_PREAUTHENTICATE_OFFSET UNITYSDK_OFFSET(0x193A3CB0)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0x193A4390)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_SET_CREDENTIALPOLICY_OFFSET UNITYSDK_OFFSET(0x193A31E0)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_UNREGISTER_1_OFFSET UNITYSDK_OFFSET(0x193A4C40)
#define SYSTEM_NET_AUTHENTICATIONMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x193A4B20)
#define SYSTEM_NET_AUTHENTICATIONMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x193A4CC0)
#define SYSTEM_NET_AUTHENTICATIONMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x193A2F00)
