...
#define SYSTEM_NET_POOLEDSTREAM_ACTIVATE_1_OFFSET UNITYSDK_OFFSET(0x193B30B0)
#define SYSTEM_NET_POOLEDSTREAM_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x193B3090)
#define SYSTEM_NET_POOLEDSTREAM_BEGINMULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x193B3F30)
#define SYSTEM_NET_POOLEDSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x193B3E30)
#define SYSTEM_NET_POOLEDSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x193B3EB0)
#define SYSTEM_NET_POOLEDSTREAM_CHECKLIFETIME_OFFSET UNITYSDK_OFFSET(0x193B3230)
#define SYSTEM_NET_POOLEDSTREAM_CLOSESOCKET_OFFSET UNITYSDK_OFFSET(0x193B3C20)
#define SYSTEM_NET_POOLEDSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x193B3D50)
#define SYSTEM_NET_POOLEDSTREAM_CONNECTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x193B3280)
#define SYSTEM_NET_POOLEDSTREAM_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x193B31D0)
#define SYSTEM_NET_POOLEDSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x193B3A90)
#define SYSTEM_NET_POOLEDSTREAM_ENDMULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x193B3F60)
#define SYSTEM_NET_POOLEDSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x193B3E90)
#define SYSTEM_NET_POOLEDSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x193B3F10)
#define SYSTEM_NET_POOLEDSTREAM_FLUSHASYNC_OFFSET UNITYSDK_OFFSET(0x193B3FA0)
#define SYSTEM_NET_POOLEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x193B3F90)
#define SYSTEM_NET_POOLEDSTREAM_GET_CANBEPOOLED_OFFSET UNITYSDK_OFFSET(0x193B2E90)
#define SYSTEM_NET_POOLEDSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x193B37A0)
#define SYSTEM_NET_POOLEDSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x193B37C0)
#define SYSTEM_NET_POOLEDSTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x193B37F0)
#define SYSTEM_NET_POOLEDSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x193B37D0)
#define SYSTEM_NET_POOLEDSTREAM_GET_ISEMANCIPATED_OFFSET UNITYSDK_OFFSET(0x193B2F10)
#define SYSTEM_NET_POOLEDSTREAM_GET_ISINITALIZING_OFFSET UNITYSDK_OFFSET(0x193B2E80)
#define SYSTEM_NET_POOLEDSTREAM_GET_JUSTCONNECTED_OFFSET UNITYSDK_OFFSET(0x193B2E60)
#define SYSTEM_NET_POOLEDSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x193B39A0)
#define SYSTEM_NET_POOLEDSTREAM_GET_NETWORKSTREAM_OFFSET UNITYSDK_OFFSET(0x193B3760)
#define SYSTEM_NET_POOLEDSTREAM_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x193B2F50)
#define SYSTEM_NET_POOLEDSTREAM_GET_POOL_OFFSET UNITYSDK_OFFSET(0x193B3060)
#define SYSTEM_NET_POOLEDSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x193B39C0)
#define SYSTEM_NET_POOLEDSTREAM_GET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x193B3800)
#define SYSTEM_NET_POOLEDSTREAM_GET_SERVERADDRESS_OFFSET UNITYSDK_OFFSET(0x193B2E70)
#define SYSTEM_NET_POOLEDSTREAM_GET_SERVICEPOINT_OFFSET UNITYSDK_OFFSET(0x193B3070)
#define SYSTEM_NET_POOLEDSTREAM_GET_SOCKET_OFFSET UNITYSDK_OFFSET(0x193B3780)
#define SYSTEM_NET_POOLEDSTREAM_GET_USINGSECURESTREAM_OFFSET UNITYSDK_OFFSET(0x193B3750)
#define SYSTEM_NET_POOLEDSTREAM_GET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x193B38D0)
#define SYSTEM_NET_POOLEDSTREAM_MULTIPLEWRITE_OFFSET UNITYSDK_OFFSET(0x193B3A60)
#define SYSTEM_NET_POOLEDSTREAM_POLLREAD_OFFSET UNITYSDK_OFFSET(0x193B4120)
#define SYSTEM_NET_POOLEDSTREAM_POLL_OFFSET UNITYSDK_OFFSET(0x193B4100)
#define SYSTEM_NET_POOLEDSTREAM_POSTPOP_OFFSET UNITYSDK_OFFSET(0x193B3580)
#define SYSTEM_NET_POOLEDSTREAM_PREPUSH_OFFSET UNITYSDK_OFFSET(0x193B33D0)
#define SYSTEM_NET_POOLEDSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x193B3A20)
#define SYSTEM_NET_POOLEDSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x193B3A00)
#define SYSTEM_NET_POOLEDSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x193B4040)
#define SYSTEM_NET_POOLEDSTREAM_SETSOCKETTIMEOUTOPTION_OFFSET UNITYSDK_OFFSET(0x193B4060)
#define SYSTEM_NET_POOLEDSTREAM_SET_CANBEPOOLED_OFFSET UNITYSDK_OFFSET(0x193B2F00)
#define SYSTEM_NET_POOLEDSTREAM_SET_NETWORKSTREAM_OFFSET UNITYSDK_OFFSET(0x193B3770)
#define SYSTEM_NET_POOLEDSTREAM_SET_OWNER_OFFSET UNITYSDK_OFFSET(0x193B2F90)
#define SYSTEM_NET_POOLEDSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x193B39E0)
#define SYSTEM_NET_POOLEDSTREAM_SET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x193B38B0)
#define SYSTEM_NET_POOLEDSTREAM_SET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x193B3980)
#define SYSTEM_NET_POOLEDSTREAM_UNSAFEBEGINREAD_OFFSET UNITYSDK_OFFSET(0x193B3E50)
#define SYSTEM_NET_POOLEDSTREAM_UNSAFEBEGINWRITE_OFFSET UNITYSDK_OFFSET(0x193B3ED0)
#define SYSTEM_NET_POOLEDSTREAM_UPDATELIFETIME_OFFSET UNITYSDK_OFFSET(0x193B33A0)
#define SYSTEM_NET_POOLEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x193B3A40)
#define SYSTEM_NET_POOLEDSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193B2DB0)
#define SYSTEM_NET_POOLEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x193B2CE0)
...
namespace System::Net
{
	...
	{
	public:
		::System::Net::Sockets::Socket* m_AbortSocket6; // 0x28
		::System::Net::IPAddress* m_ServerAddress; // 0x30
		::System::WeakReference* m_Owner; // 0x38
		::System::Net::GeneralAsyncDelegate* m_AsyncCallback; // 0x40
		::System::Net::Sockets::Socket* m_AbortSocket; // 0x48
		::System::Net::Sockets::NetworkStream* m_NetworkStream; // 0x50
		::System::Net::ConnectionPool* m_ConnectionPool; // 0x58
		::System::DateTime m_CreateTime; // 0x60
		::System::TimeSpan m_Lifetime; // 0x68
		::System::Boolean m_ConnectionIsDoomed; // 0x70
		::System::Boolean m_Initalizing; // 0x71
		::System::Boolean m_JustConnected; // 0x72
		::System::Boolean m_CheckLifetime; // 0x73
		::System::Int32 m_PooledCount; // 0x74
