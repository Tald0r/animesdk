...
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO_GET_POS_OFFSET UNITYSDK_OFFSET(0x18BB0850)
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO_GET_VAL_OFFSET UNITYSDK_OFFSET(0x18BB0830)
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO_SET_POS_OFFSET UNITYSDK_OFFSET(0x18BB0860)
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO_SET_VAL_OFFSET UNITYSDK_OFFSET(0x18BB0840)
#define SYSTEM_NET_BASE64STREAM_READSTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAE840)
