...
#define SYSTEM_NET_SOCKETADDRESS_COPYADDRESSSIZEINTOBUFFER_OFFSET UNITYSDK_OFFSET(0x18FFB4A0)
#define SYSTEM_NET_SOCKETADDRESS_EQUALS_OFFSET UNITYSDK_OFFSET(0x18FFB5C0)
#define SYSTEM_NET_SOCKETADDRESS_GETADDRESSSIZEOFFSET_OFFSET UNITYSDK_OFFSET(0x18FFB590)
#define SYSTEM_NET_SOCKETADDRESS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18FFB650)
#define SYSTEM_NET_SOCKETADDRESS_GETIPADDRESS_OFFSET UNITYSDK_OFFSET(0x18FFB1B0)
#define SYSTEM_NET_SOCKETADDRESS_GETIPENDPOINT_OFFSET UNITYSDK_OFFSET(0x18FFB420)
#define SYSTEM_NET_SOCKETADDRESS_GET_FAMILY_OFFSET UNITYSDK_OFFSET(0x18FFAAE0)
#define SYSTEM_NET_SOCKETADDRESS_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x18FFAB40)
#define SYSTEM_NET_SOCKETADDRESS_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x18FFAB30)
#define SYSTEM_NET_SOCKETADDRESS_SETSIZE_OFFSET UNITYSDK_OFFSET(0x18FFB5B0)
#define SYSTEM_NET_SOCKETADDRESS_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x18FFABD0)
#define SYSTEM_NET_SOCKETADDRESS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18FFBA70)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FFAC80)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FFAD40)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18FFB140)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18FFAC70)
