...
#define SYSTEM_NET_SOCKETADDRESS_COPYADDRESSSIZEINTOBUFFER_OFFSET UNITYSDK_OFFSET(0x1938C9B0)
#define SYSTEM_NET_SOCKETADDRESS_EQUALS_OFFSET UNITYSDK_OFFSET(0x1938CAD0)
#define SYSTEM_NET_SOCKETADDRESS_GETADDRESSSIZEOFFSET_OFFSET UNITYSDK_OFFSET(0x1938CAA0)
#define SYSTEM_NET_SOCKETADDRESS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1938CB60)
#define SYSTEM_NET_SOCKETADDRESS_GETIPADDRESS_OFFSET UNITYSDK_OFFSET(0x1938C6C0)
#define SYSTEM_NET_SOCKETADDRESS_GETIPENDPOINT_OFFSET UNITYSDK_OFFSET(0x1938C930)
#define SYSTEM_NET_SOCKETADDRESS_GET_FAMILY_OFFSET UNITYSDK_OFFSET(0x1938BFF0)
#define SYSTEM_NET_SOCKETADDRESS_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1938C050)
#define SYSTEM_NET_SOCKETADDRESS_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1938C040)
#define SYSTEM_NET_SOCKETADDRESS_SETSIZE_OFFSET UNITYSDK_OFFSET(0x1938CAC0)
#define SYSTEM_NET_SOCKETADDRESS_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1938C0E0)
#define SYSTEM_NET_SOCKETADDRESS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1938CF80)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1938C190)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1938C250)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1938C650)
#define SYSTEM_NET_SOCKETADDRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1938C180)
