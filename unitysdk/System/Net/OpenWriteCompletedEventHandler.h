...
#define SYSTEM_NET_OPENWRITECOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A33C030)
#define SYSTEM_NET_OPENWRITECOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A33C070)
#define SYSTEM_NET_OPENWRITECOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A33BAB0)
#define SYSTEM_NET_OPENWRITECOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A33BA90)
