...
#define SYSTEM_NET_OPENWRITECOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D7DB20)
#define SYSTEM_NET_OPENWRITECOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D7DB60)
#define SYSTEM_NET_OPENWRITECOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D7D5A0)
#define SYSTEM_NET_OPENWRITECOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D7D590)
