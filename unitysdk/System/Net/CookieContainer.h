...
#define SYSTEM_NET_COOKIECONTAINER_ADDREMOVEDOMAIN_OFFSET UNITYSDK_OFFSET(0x19063E20)
#define SYSTEM_NET_COOKIECONTAINER_ADD_1_OFFSET UNITYSDK_OFFSET(0x19063520)
#define SYSTEM_NET_COOKIECONTAINER_ADD_2_OFFSET UNITYSDK_OFFSET(0x19064150)
#define SYSTEM_NET_COOKIECONTAINER_ADD_3_OFFSET UNITYSDK_OFFSET(0x19064480)
#define SYSTEM_NET_COOKIECONTAINER_ADD_4_OFFSET UNITYSDK_OFFSET(0x19064630)
#define SYSTEM_NET_COOKIECONTAINER_ADD_OFFSET UNITYSDK_OFFSET(0x19062AE0)
#define SYSTEM_NET_COOKIECONTAINER_AGECOOKIES_OFFSET UNITYSDK_OFFSET(0x1905CAF0)
#define SYSTEM_NET_COOKIECONTAINER_BUILDCOOKIECOLLECTIONFROMDOMAINMATCHES_OFFSET UNITYSDK_OFFSET(0x190657B0)
#define SYSTEM_NET_COOKIECONTAINER_COOKIECUTTER_OFFSET UNITYSDK_OFFSET(0x19064AC0)
#define SYSTEM_NET_COOKIECONTAINER_EXPIRECOLLECTION_OFFSET UNITYSDK_OFFSET(0x19063F30)
#define SYSTEM_NET_COOKIECONTAINER_GETCOOKIEHEADER_1_OFFSET UNITYSDK_OFFSET(0x19066950)
#define SYSTEM_NET_COOKIECONTAINER_GETCOOKIEHEADER_OFFSET UNITYSDK_OFFSET(0x190668B0)
#define SYSTEM_NET_COOKIECONTAINER_GETCOOKIES_OFFSET UNITYSDK_OFFSET(0x190652C0)
#define SYSTEM_NET_COOKIECONTAINER_GET_CAPACITY_OFFSET UNITYSDK_OFFSET(0x1905C990)
#define SYSTEM_NET_COOKIECONTAINER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x190629B0)
#define SYSTEM_NET_COOKIECONTAINER_GET_MAXCOOKIESIZE_OFFSET UNITYSDK_OFFSET(0x190629C0)
#define SYSTEM_NET_COOKIECONTAINER_GET_PERDOMAINCAPACITY_OFFSET UNITYSDK_OFFSET(0x19062A40)
#define SYSTEM_NET_COOKIECONTAINER_INTERNALGETCOOKIES_OFFSET UNITYSDK_OFFSET(0x19065360)
#define SYSTEM_NET_COOKIECONTAINER_ISLOCALDOMAIN_OFFSET UNITYSDK_OFFSET(0x19062F60)
#define SYSTEM_NET_COOKIECONTAINER_MERGEUPDATECOLLECTIONS_OFFSET UNITYSDK_OFFSET(0x19066610)
#define SYSTEM_NET_COOKIECONTAINER_SETCOOKIES_OFFSET UNITYSDK_OFFSET(0x19066D00)
#define SYSTEM_NET_COOKIECONTAINER_SET_CAPACITY_OFFSET UNITYSDK_OFFSET(0x1905C9A0)
#define SYSTEM_NET_COOKIECONTAINER_SET_MAXCOOKIESIZE_OFFSET UNITYSDK_OFFSET(0x190629D0)
#define SYSTEM_NET_COOKIECONTAINER_SET_PERDOMAINCAPACITY_OFFSET UNITYSDK_OFFSET(0x19062A50)
#define SYSTEM_NET_COOKIECONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19066DE0)
#define SYSTEM_NET_COOKIECONTAINER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1905C720)
#define SYSTEM_NET_COOKIECONTAINER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1905C7A0)
#define SYSTEM_NET_COOKIECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1905C630)
...
namespace System::Net
{
	...
	public:
		...
		::System::Int32 m_maxCookiesPerDomain; // 0x28
