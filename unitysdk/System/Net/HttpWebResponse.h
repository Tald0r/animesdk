...
#define SYSTEM_NET_HTTPWEBRESPONSE_CHECKDISPOSED_OFFSET UNITYSDK_OFFSET(0x1A336790)
#define SYSTEM_NET_HTTPWEBRESPONSE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A337310)
#define SYSTEM_NET_HTTPWEBRESPONSE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A337390)
#define SYSTEM_NET_HTTPWEBRESPONSE_FILLCOOKIES_OFFSET UNITYSDK_OFFSET(0x1A3361C0)
#define SYSTEM_NET_HTTPWEBRESPONSE_GETMUSTIMPLEMENT_OFFSET UNITYSDK_OFFSET(0x1A336980)
#define SYSTEM_NET_HTTPWEBRESPONSE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A336FD0)
#define SYSTEM_NET_HTTPWEBRESPONSE_GETRESPONSEHEADER_OFFSET UNITYSDK_OFFSET(0x1A336E00)
#define SYSTEM_NET_HTTPWEBRESPONSE_GETRESPONSESTREAM_OFFSET UNITYSDK_OFFSET(0x1A336F00)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_CHARACTERSET_OFFSET UNITYSDK_OFFSET(0x1A336580)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_CONTENTENCODING_OFFSET UNITYSDK_OFFSET(0x1A336700)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1A3367F0)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A336660)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_COOKIES_OFFSET UNITYSDK_OFFSET(0x1A336800)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_HEADERS_OFFSET UNITYSDK_OFFSET(0x1A336970)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_ISMUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1A336A30)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_LASTMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A336A80)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1A336B90)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x1A336C00)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_RESPONSEURI_OFFSET UNITYSDK_OFFSET(0x1A336C70)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_SERVER_OFFSET UNITYSDK_OFFSET(0x1A336CE0)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x1A336D70)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_STATUSDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A336D80)
#define SYSTEM_NET_HTTPWEBRESPONSE_GET_SUPPORTSHEADERS_OFFSET UNITYSDK_OFFSET(0x1A336DF0)
#define SYSTEM_NET_HTTPWEBRESPONSE_READALL_OFFSET UNITYSDK_OFFSET(0x1A336E90)
#define SYSTEM_NET_HTTPWEBRESPONSE_SET_COOKIES_OFFSET UNITYSDK_OFFSET(0x1A336900)
#define SYSTEM_NET_HTTPWEBRESPONSE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A337340)
#define SYSTEM_NET_HTTPWEBRESPONSE_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1A336FC0)
#define SYSTEM_NET_HTTPWEBRESPONSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A336320)
#define SYSTEM_NET_HTTPWEBRESPONSE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A3373E0)
#define SYSTEM_NET_HTTPWEBRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A335F20)
