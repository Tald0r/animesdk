...
#define SYSTEM_NET_HTTPLISTENER_EXTENDEDPROTECTIONSELECTOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19242BF0)
#define SYSTEM_NET_HTTPLISTENER_EXTENDEDPROTECTIONSELECTOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19242C20)
#define SYSTEM_NET_HTTPLISTENER_EXTENDEDPROTECTIONSELECTOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x192426B0)
#define SYSTEM_NET_HTTPLISTENER_EXTENDEDPROTECTIONSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19242690)
