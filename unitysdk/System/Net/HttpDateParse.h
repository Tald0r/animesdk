...
#define SYSTEM_NET_HTTPDATEPARSE_MAKE_UPPER_OFFSET UNITYSDK_OFFSET(0x193ACA40)
#define SYSTEM_NET_HTTPDATEPARSE_MAPDAYMONTHTODWORD_OFFSET UNITYSDK_OFFSET(0x193ACAC0)
#define SYSTEM_NET_HTTPDATEPARSE_PARSEHTTPDATE_OFFSET UNITYSDK_OFFSET(0x193AD1C0)
