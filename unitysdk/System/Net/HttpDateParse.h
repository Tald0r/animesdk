...
#define SYSTEM_NET_HTTPDATEPARSE_MAKE_UPPER_OFFSET UNITYSDK_OFFSET(0x18FC06D0)
#define SYSTEM_NET_HTTPDATEPARSE_MAPDAYMONTHTODWORD_OFFSET UNITYSDK_OFFSET(0x18FC0750)
#define SYSTEM_NET_HTTPDATEPARSE_PARSEHTTPDATE_OFFSET UNITYSDK_OFFSET(0x18FC0E50)
