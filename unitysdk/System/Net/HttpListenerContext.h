...
#define SYSTEM_NET_HTTPLISTENERCONTEXT_ACCEPTWEBSOCKETASYNC_1_OFFSET UNITYSDK_OFFSET(0x195CBE40)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_ACCEPTWEBSOCKETASYNC_2_OFFSET UNITYSDK_OFFSET(0x195CBE90)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_ACCEPTWEBSOCKETASYNC_3_OFFSET UNITYSDK_OFFSET(0x195CBEE0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_ACCEPTWEBSOCKETASYNC_OFFSET UNITYSDK_OFFSET(0x195CBDF0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_CONNECTION_OFFSET UNITYSDK_OFFSET(0x195CB9F0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x195CB9C0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_ERRORSTATUS_OFFSET UNITYSDK_OFFSET(0x195CB9A0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_HAVEERROR_OFFSET UNITYSDK_OFFSET(0x195CB9E0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_REQUEST_OFFSET UNITYSDK_OFFSET(0x195CBA00)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_RESPONSE_OFFSET UNITYSDK_OFFSET(0x195CBA10)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_GET_USER_OFFSET UNITYSDK_OFFSET(0x195CBA20)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_PARSEAUTHENTICATION_OFFSET UNITYSDK_OFFSET(0x195CBA30)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_PARSEBASICAUTHENTICATION_OFFSET UNITYSDK_OFFSET(0x195CBB80)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_SET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x195CB9D0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT_SET_ERRORSTATUS_OFFSET UNITYSDK_OFFSET(0x195CB9B0)
#define SYSTEM_NET_HTTPLISTENERCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195CBF30)
#define SYSTEM_NET_HTTPLISTENERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x195CB890)
