...
#define SYSTEM_NET_CACHE_REQUESTCACHEVALIDATOR_CREATEVALIDATOR_OFFSET UNITYSDK_OFFSET(0x18B675D0)
#define SYSTEM_NET_CACHE_REQUESTCACHEVALIDATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18B67620)
