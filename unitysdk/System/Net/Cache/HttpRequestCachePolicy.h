...
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_CACHESYNCDATE_OFFSET UNITYSDK_OFFSET(0x19371BC0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_INTERNALCACHESYNCDATEUTC_OFFSET UNITYSDK_OFFSET(0x19371C00)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x19371BB0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_MAXAGE_OFFSET UNITYSDK_OFFSET(0x19371C10)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_MAXSTALE_OFFSET UNITYSDK_OFFSET(0x19371C30)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_MINFRESH_OFFSET UNITYSDK_OFFSET(0x19371C20)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_MAPLEVEL_OFFSET UNITYSDK_OFFSET(0x19371560)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19371C40)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x19371FF0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19371410)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x193715E0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x193717C0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_4_OFFSET UNITYSDK_OFFSET(0x193719B0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19371B20)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x19371340)
...
namespace System::Net::Cache
{
	...
	public:
		...
		::System::Net::Cache::HttpRequestCacheLevel m_Level; // 0x28
		::System::TimeSpan m_MaxStale; // 0x30
