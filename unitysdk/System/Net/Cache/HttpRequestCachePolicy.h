...
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_CACHESYNCDATE_OFFSET UNITYSDK_OFFSET(0x18FE06E0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_INTERNALCACHESYNCDATEUTC_OFFSET UNITYSDK_OFFSET(0x18FE0720)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x18FE06D0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_MAXAGE_OFFSET UNITYSDK_OFFSET(0x18FE0730)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_MAXSTALE_OFFSET UNITYSDK_OFFSET(0x18FE0750)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_GET_MINFRESH_OFFSET UNITYSDK_OFFSET(0x18FE0740)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_MAPLEVEL_OFFSET UNITYSDK_OFFSET(0x18FE0080)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18FE0760)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x18FE0B10)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FDFF30)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FE0100)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18FE02E0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18FE04D0)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_5_OFFSET UNITYSDK_OFFSET(0x18FE0640)
#define SYSTEM_NET_CACHE_HTTPREQUESTCACHEPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDFE60)
