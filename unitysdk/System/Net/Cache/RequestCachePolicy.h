...
#define SYSTEM_NET_CACHE_REQUESTCACHEPOLICY_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A5F47A0)
#define SYSTEM_NET_CACHE_REQUESTCACHEPOLICY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A5F47B0)
#define SYSTEM_NET_CACHE_REQUESTCACHEPOLICY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5F4730)
#define SYSTEM_NET_CACHE_REQUESTCACHEPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F46F0)
