...
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_GET_ENTRYMETADATA_OFFSET UNITYSDK_OFFSET(0x19459EE0)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_GET_EXPIRESUTC_OFFSET UNITYSDK_OFFSET(0x19459DE0)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_GET_HITCOUNT_OFFSET UNITYSDK_OFFSET(0x19459E80)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_GET_ISPARTIALENTRY_OFFSET UNITYSDK_OFFSET(0x19459EC0)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_GET_ISPRIVATEENTRY_OFFSET UNITYSDK_OFFSET(0x19459DA0)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_GET_LASTACCESSEDUTC_OFFSET UNITYSDK_OFFSET(0x19459E00)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_GET_LASTMODIFIEDUTC_OFFSET UNITYSDK_OFFSET(0x19459E20)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_GET_LASTSYNCHRONIZEDUTC_OFFSET UNITYSDK_OFFSET(0x19459E40)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_GET_MAXSTALE_OFFSET UNITYSDK_OFFSET(0x19459E60)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_GET_STREAMSIZE_OFFSET UNITYSDK_OFFSET(0x19459DC0)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_GET_SYSTEMMETADATA_OFFSET UNITYSDK_OFFSET(0x19459F00)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_GET_USAGECOUNT_OFFSET UNITYSDK_OFFSET(0x19459EA0)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_SET_ENTRYMETADATA_OFFSET UNITYSDK_OFFSET(0x19459EF0)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_SET_EXPIRESUTC_OFFSET UNITYSDK_OFFSET(0x19459DF0)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_SET_HITCOUNT_OFFSET UNITYSDK_OFFSET(0x19459E90)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_SET_ISPARTIALENTRY_OFFSET UNITYSDK_OFFSET(0x19459ED0)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_SET_ISPRIVATEENTRY_OFFSET UNITYSDK_OFFSET(0x19459DB0)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_SET_LASTACCESSEDUTC_OFFSET UNITYSDK_OFFSET(0x19459E10)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_SET_LASTMODIFIEDUTC_OFFSET UNITYSDK_OFFSET(0x19459E30)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_SET_LASTSYNCHRONIZEDUTC_OFFSET UNITYSDK_OFFSET(0x19459E50)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_SET_MAXSTALE_OFFSET UNITYSDK_OFFSET(0x19459E70)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_SET_STREAMSIZE_OFFSET UNITYSDK_OFFSET(0x19459DD0)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_SET_SYSTEMMETADATA_OFFSET UNITYSDK_OFFSET(0x19459F10)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_SET_USAGECOUNT_OFFSET UNITYSDK_OFFSET(0x19459EB0)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19459F20)
#define SYSTEM_NET_CACHE_REQUESTCACHEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x19459D80)
...
namespace System::Net::Cache
{
	...
	public:
		...
		::System::DateTime m_LastSynchronizedUtc; // 0x20
		::System::DateTime m_LastAccessedUtc; // 0x28
		::System::DateTime m_ExpiresUtc; // 0x30
		::System::Int64 m_StreamSize; // 0x38
		::System::TimeSpan m_MaxStale; // 0x40
		::System::DateTime m_LastModifiedUtc; // 0x48
		::System::Int32 m_UsageCount; // 0x50
		::System::Int32 m_HitCount; // 0x54
