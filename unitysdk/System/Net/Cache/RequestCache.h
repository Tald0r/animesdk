...
#define SYSTEM_NET_CACHE_REQUESTCACHE_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x18BB0890)
#define SYSTEM_NET_CACHE_REQUESTCACHE_GET_ISPRIVATECACHE_OFFSET UNITYSDK_OFFSET(0x18BB0880)
#define SYSTEM_NET_CACHE_REQUESTCACHE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18BB08A0)
#define SYSTEM_NET_CACHE_REQUESTCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB0870)
