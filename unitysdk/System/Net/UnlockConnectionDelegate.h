...
#define SYSTEM_NET_UNLOCKCONNECTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D31A30)
#define SYSTEM_NET_UNLOCKCONNECTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D31A60)
#define SYSTEM_NET_UNLOCKCONNECTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D31790)
#define SYSTEM_NET_UNLOCKCONNECTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D31770)
