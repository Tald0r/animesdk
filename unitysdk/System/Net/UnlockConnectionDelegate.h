...
#define SYSTEM_NET_UNLOCKCONNECTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x197F2680)
#define SYSTEM_NET_UNLOCKCONNECTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x197F26B0)
#define SYSTEM_NET_UNLOCKCONNECTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x197F23E0)
#define SYSTEM_NET_UNLOCKCONNECTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x197F23D0)
