...
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x191D2BD0)
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x191D2C10)
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x191D2650)
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x191D2630)
