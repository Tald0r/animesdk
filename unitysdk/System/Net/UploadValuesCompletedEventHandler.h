...
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D89EF0)
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D89F30)
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D89970)
#define SYSTEM_NET_UPLOADVALUESCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D89960)
