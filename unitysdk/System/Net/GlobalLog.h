...
#define SYSTEM_NET_GLOBALLOG_ADDTOARRAY_OFFSET UNITYSDK_OFFSET(0x191CF280)
#define SYSTEM_NET_GLOBALLOG_ASSERT_1_OFFSET UNITYSDK_OFFSET(0x191CF3B0)
#define SYSTEM_NET_GLOBALLOG_ASSERT_2_OFFSET UNITYSDK_OFFSET(0x191CF3C0)
#define SYSTEM_NET_GLOBALLOG_ASSERT_OFFSET UNITYSDK_OFFSET(0x191CF2E0)
#define SYSTEM_NET_GLOBALLOG_DUMPARRAY_OFFSET UNITYSDK_OFFSET(0x191CF440)
#define SYSTEM_NET_GLOBALLOG_DUMP_1_OFFSET UNITYSDK_OFFSET(0x191CF460)
#define SYSTEM_NET_GLOBALLOG_DUMP_2_OFFSET UNITYSDK_OFFSET(0x191CF470)
#define SYSTEM_NET_GLOBALLOG_DUMP_3_OFFSET UNITYSDK_OFFSET(0x191CF480)
#define SYSTEM_NET_GLOBALLOG_DUMP_OFFSET UNITYSDK_OFFSET(0x191CF450)
#define SYSTEM_NET_GLOBALLOG_ENTER_1_OFFSET UNITYSDK_OFFSET(0x191CF2D0)
#define SYSTEM_NET_GLOBALLOG_ENTER_OFFSET UNITYSDK_OFFSET(0x191CF2C0)
#define SYSTEM_NET_GLOBALLOG_GET_CURRENTTHREADKIND_OFFSET UNITYSDK_OFFSET(0x191CF1E0)
#define SYSTEM_NET_GLOBALLOG_IGNORE_OFFSET UNITYSDK_OFFSET(0x191CF290)
#define SYSTEM_NET_GLOBALLOG_LEAVEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x191CF3F0)
#define SYSTEM_NET_GLOBALLOG_LEAVE_1_OFFSET UNITYSDK_OFFSET(0x191CF410)
#define SYSTEM_NET_GLOBALLOG_LEAVE_2_OFFSET UNITYSDK_OFFSET(0x191CF420)
#define SYSTEM_NET_GLOBALLOG_LEAVE_3_OFFSET UNITYSDK_OFFSET(0x191CF430)
#define SYSTEM_NET_GLOBALLOG_LEAVE_OFFSET UNITYSDK_OFFSET(0x191CF400)
#define SYSTEM_NET_GLOBALLOG_LOGGINGINITIALIZE_OFFSET UNITYSDK_OFFSET(0x191CF1A0)
#define SYSTEM_NET_GLOBALLOG_PRINTHEX_OFFSET UNITYSDK_OFFSET(0x191CF2B0)
#define SYSTEM_NET_GLOBALLOG_PRINT_OFFSET UNITYSDK_OFFSET(0x191CF2A0)
#define SYSTEM_NET_GLOBALLOG_SETTHREADSOURCE_OFFSET UNITYSDK_OFFSET(0x191CF1F0)
#define SYSTEM_NET_GLOBALLOG_THREADCONTRACT_1_OFFSET UNITYSDK_OFFSET(0x191CF210)
#define SYSTEM_NET_GLOBALLOG_THREADCONTRACT_OFFSET UNITYSDK_OFFSET(0x191CF200)
#define SYSTEM_NET_GLOBALLOG__CCTOR_OFFSET UNITYSDK_OFFSET(0x191CF490)
