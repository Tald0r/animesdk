...
#define SYSTEM_NET_GLOBALLOG_ADDTOARRAY_OFFSET UNITYSDK_OFFSET(0x195CB610)
#define SYSTEM_NET_GLOBALLOG_ASSERT_1_OFFSET UNITYSDK_OFFSET(0x195CB740)
#define SYSTEM_NET_GLOBALLOG_ASSERT_2_OFFSET UNITYSDK_OFFSET(0x195CB750)
#define SYSTEM_NET_GLOBALLOG_ASSERT_OFFSET UNITYSDK_OFFSET(0x195CB670)
#define SYSTEM_NET_GLOBALLOG_DUMPARRAY_OFFSET UNITYSDK_OFFSET(0x195CB7D0)
#define SYSTEM_NET_GLOBALLOG_DUMP_1_OFFSET UNITYSDK_OFFSET(0x195CB7F0)
#define SYSTEM_NET_GLOBALLOG_DUMP_2_OFFSET UNITYSDK_OFFSET(0x195CB800)
#define SYSTEM_NET_GLOBALLOG_DUMP_3_OFFSET UNITYSDK_OFFSET(0x195CB810)
#define SYSTEM_NET_GLOBALLOG_DUMP_OFFSET UNITYSDK_OFFSET(0x195CB7E0)
#define SYSTEM_NET_GLOBALLOG_ENTER_1_OFFSET UNITYSDK_OFFSET(0x195CB660)
#define SYSTEM_NET_GLOBALLOG_ENTER_OFFSET UNITYSDK_OFFSET(0x195CB650)
#define SYSTEM_NET_GLOBALLOG_GET_CURRENTTHREADKIND_OFFSET UNITYSDK_OFFSET(0x195CB570)
#define SYSTEM_NET_GLOBALLOG_IGNORE_OFFSET UNITYSDK_OFFSET(0x195CB620)
#define SYSTEM_NET_GLOBALLOG_LEAVEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x195CB780)
#define SYSTEM_NET_GLOBALLOG_LEAVE_1_OFFSET UNITYSDK_OFFSET(0x195CB7A0)
#define SYSTEM_NET_GLOBALLOG_LEAVE_2_OFFSET UNITYSDK_OFFSET(0x195CB7B0)
#define SYSTEM_NET_GLOBALLOG_LEAVE_3_OFFSET UNITYSDK_OFFSET(0x195CB7C0)
#define SYSTEM_NET_GLOBALLOG_LEAVE_OFFSET UNITYSDK_OFFSET(0x195CB790)
#define SYSTEM_NET_GLOBALLOG_LOGGINGINITIALIZE_OFFSET UNITYSDK_OFFSET(0x195CB530)
#define SYSTEM_NET_GLOBALLOG_PRINTHEX_OFFSET UNITYSDK_OFFSET(0x195CB640)
#define SYSTEM_NET_GLOBALLOG_PRINT_OFFSET UNITYSDK_OFFSET(0x195CB630)
#define SYSTEM_NET_GLOBALLOG_SETTHREADSOURCE_OFFSET UNITYSDK_OFFSET(0x195CB580)
#define SYSTEM_NET_GLOBALLOG_THREADCONTRACT_1_OFFSET UNITYSDK_OFFSET(0x195CB5A0)
#define SYSTEM_NET_GLOBALLOG_THREADCONTRACT_OFFSET UNITYSDK_OFFSET(0x195CB590)
#define SYSTEM_NET_GLOBALLOG__CCTOR_OFFSET UNITYSDK_OFFSET(0x195CB820)
