...
#define SYSTEM_NET_CONFIGURATION_WEBREQUESTMODULEELEMENT_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x18FB8D10)
#define SYSTEM_NET_CONFIGURATION_WEBREQUESTMODULEELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x18FB8D90)
#define SYSTEM_NET_CONFIGURATION_WEBREQUESTMODULEELEMENT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x18FB8DD0)
#define SYSTEM_NET_CONFIGURATION_WEBREQUESTMODULEELEMENT_SET_PREFIX_OFFSET UNITYSDK_OFFSET(0x18FB8D50)
#define SYSTEM_NET_CONFIGURATION_WEBREQUESTMODULEELEMENT_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x18FB8E10)
#define SYSTEM_NET_CONFIGURATION_WEBREQUESTMODULEELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FB8C90)
#define SYSTEM_NET_CONFIGURATION_WEBREQUESTMODULEELEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FB8CD0)
#define SYSTEM_NET_CONFIGURATION_WEBREQUESTMODULEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB8C50)
