...
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_DRAINENTITYBODY_OFFSET UNITYSDK_OFFSET(0x191BB6D0)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_ENTITYBODY_OFFSET UNITYSDK_OFFSET(0x191BB710)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_HEADERWAIT_OFFSET UNITYSDK_OFFSET(0x191BB750)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_IDLECONNECTION_OFFSET UNITYSDK_OFFSET(0x191BB790)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_MINSENDBYTESPERSECOND_OFFSET UNITYSDK_OFFSET(0x191BB7D0)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x191BB810)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT_GET_REQUESTQUEUE_OFFSET UNITYSDK_OFFSET(0x191BB850)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERTIMEOUTSELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x191BB690)
