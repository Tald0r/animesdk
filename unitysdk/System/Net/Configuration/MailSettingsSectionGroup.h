...
#define SYSTEM_NET_CONFIGURATION_MAILSETTINGSSECTIONGROUP_GET_SMTP_OFFSET UNITYSDK_OFFSET(0x18BB0CF0)
#define SYSTEM_NET_CONFIGURATION_MAILSETTINGSSECTIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB0CB0)
