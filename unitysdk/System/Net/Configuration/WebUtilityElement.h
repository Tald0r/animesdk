...
#define SYSTEM_NET_CONFIGURATION_WEBUTILITYELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1923E0A0)
#define SYSTEM_NET_CONFIGURATION_WEBUTILITYELEMENT_GET_UNICODEDECODINGCONFORMANCE_OFFSET UNITYSDK_OFFSET(0x1923E0E0)
#define SYSTEM_NET_CONFIGURATION_WEBUTILITYELEMENT_GET_UNICODEENCODINGCONFORMANCE_OFFSET UNITYSDK_OFFSET(0x1923E160)
#define SYSTEM_NET_CONFIGURATION_WEBUTILITYELEMENT_SET_UNICODEDECODINGCONFORMANCE_OFFSET UNITYSDK_OFFSET(0x1923E120)
#define SYSTEM_NET_CONFIGURATION_WEBUTILITYELEMENT_SET_UNICODEENCODINGCONFORMANCE_OFFSET UNITYSDK_OFFSET(0x1923E1A0)
#define SYSTEM_NET_CONFIGURATION_WEBUTILITYELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1923E060)
