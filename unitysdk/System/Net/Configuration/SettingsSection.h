...
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_HTTPLISTENER_OFFSET UNITYSDK_OFFSET(0x1900B480)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_HTTPWEBREQUEST_OFFSET UNITYSDK_OFFSET(0x1900B4C0)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_IPV6_OFFSET UNITYSDK_OFFSET(0x1900B500)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_PERFORMANCECOUNTERS_OFFSET UNITYSDK_OFFSET(0x1900B540)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1900B580)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_SERVICEPOINTMANAGER_OFFSET UNITYSDK_OFFSET(0x1900B5C0)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_SOCKET_OFFSET UNITYSDK_OFFSET(0x1900B600)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_WEBPROXYSCRIPT_OFFSET UNITYSDK_OFFSET(0x1900B640)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION_GET_WEBUTILITY_OFFSET UNITYSDK_OFFSET(0x1900B680)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1900B440)
