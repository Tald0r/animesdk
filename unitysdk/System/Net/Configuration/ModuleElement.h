...
#define SYSTEM_NET_CONFIGURATION_MODULEELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x193A4D50)
#define SYSTEM_NET_CONFIGURATION_MODULEELEMENT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x193A4D90)
#define SYSTEM_NET_CONFIGURATION_MODULEELEMENT_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x193A4DD0)
#define SYSTEM_NET_CONFIGURATION_MODULEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x193A4D10)
