...
#define SYSTEM_NET_CONFIGURATION_FTPCACHEPOLICYELEMENT_DESERIALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x1900B3C0)
#define SYSTEM_NET_CONFIGURATION_FTPCACHEPOLICYELEMENT_GET_POLICYLEVEL_OFFSET UNITYSDK_OFFSET(0x1900B300)
#define SYSTEM_NET_CONFIGURATION_FTPCACHEPOLICYELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1900B380)
#define SYSTEM_NET_CONFIGURATION_FTPCACHEPOLICYELEMENT_RESET_OFFSET UNITYSDK_OFFSET(0x1900B400)
#define SYSTEM_NET_CONFIGURATION_FTPCACHEPOLICYELEMENT_SET_POLICYLEVEL_OFFSET UNITYSDK_OFFSET(0x1900B340)
#define SYSTEM_NET_CONFIGURATION_FTPCACHEPOLICYELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1900B2C0)
