...
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTSECTION_GET_CONNECTIONMANAGEMENT_OFFSET UNITYSDK_OFFSET(0x1905C5B0)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTSECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1905C5F0)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1905C570)
