...
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x191BB5D0)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERELEMENT_GET_TIMEOUTS_OFFSET UNITYSDK_OFFSET(0x191BB610)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERELEMENT_GET_UNESCAPEREQUESTURL_OFFSET UNITYSDK_OFFSET(0x191BB650)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x191BB590)
