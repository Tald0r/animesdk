...
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x18D72920)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERELEMENT_GET_TIMEOUTS_OFFSET UNITYSDK_OFFSET(0x18D72960)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERELEMENT_GET_UNESCAPEREQUESTURL_OFFSET UNITYSDK_OFFSET(0x18D729A0)
#define SYSTEM_NET_CONFIGURATION_HTTPLISTENERELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D728E0)
