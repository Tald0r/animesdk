...
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULEELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x19B24400)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULEELEMENT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19B24440)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULEELEMENT_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x19B24480)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULEELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B243C0)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B24380)
