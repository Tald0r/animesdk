...
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTION_GET_BYPASSLIST_OFFSET UNITYSDK_OFFSET(0x197E8C80)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTION_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x197E8CC0)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTION_GET_MODULE_OFFSET UNITYSDK_OFFSET(0x197E8D40)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x197E8D80)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTION_GET_PROXY_OFFSET UNITYSDK_OFFSET(0x197E8DC0)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTION_GET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x197E8E00)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTION_POSTDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x197E8E80)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTION_RESET_OFFSET UNITYSDK_OFFSET(0x197E8EC0)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTION_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x197E8D00)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTION_SET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x197E8E40)
#define SYSTEM_NET_CONFIGURATION_DEFAULTPROXYSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x197E8C40)
