...
#define SYSTEM_NET_CONFIGURATION_PROXYELEMENT_GET_AUTODETECT_OFFSET UNITYSDK_OFFSET(0x1923DDA0)
#define SYSTEM_NET_CONFIGURATION_PROXYELEMENT_GET_BYPASSONLOCAL_OFFSET UNITYSDK_OFFSET(0x1923DE20)
#define SYSTEM_NET_CONFIGURATION_PROXYELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1923DEA0)
#define SYSTEM_NET_CONFIGURATION_PROXYELEMENT_GET_PROXYADDRESS_OFFSET UNITYSDK_OFFSET(0x1923DEE0)
#define SYSTEM_NET_CONFIGURATION_PROXYELEMENT_GET_SCRIPTLOCATION_OFFSET UNITYSDK_OFFSET(0x1923DF60)
#define SYSTEM_NET_CONFIGURATION_PROXYELEMENT_GET_USESYSTEMDEFAULT_OFFSET UNITYSDK_OFFSET(0x1923DFE0)
#define SYSTEM_NET_CONFIGURATION_PROXYELEMENT_SET_AUTODETECT_OFFSET UNITYSDK_OFFSET(0x1923DDE0)
#define SYSTEM_NET_CONFIGURATION_PROXYELEMENT_SET_BYPASSONLOCAL_OFFSET UNITYSDK_OFFSET(0x1923DE60)
#define SYSTEM_NET_CONFIGURATION_PROXYELEMENT_SET_PROXYADDRESS_OFFSET UNITYSDK_OFFSET(0x1923DF20)
#define SYSTEM_NET_CONFIGURATION_PROXYELEMENT_SET_SCRIPTLOCATION_OFFSET UNITYSDK_OFFSET(0x1923DFA0)
#define SYSTEM_NET_CONFIGURATION_PROXYELEMENT_SET_USESYSTEMDEFAULT_OFFSET UNITYSDK_OFFSET(0x1923E020)
#define SYSTEM_NET_CONFIGURATION_PROXYELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1923DD60)
