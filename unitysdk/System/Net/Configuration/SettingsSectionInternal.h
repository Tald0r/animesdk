...
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_GET_CHECKCERTIFICATENAME_OFFSET UNITYSDK_OFFSET(0x1A335710)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_GET_CHECKCERTIFICATEREVOCATIONLIST_OFFSET UNITYSDK_OFFSET(0x1A335770)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_GET_DNSREFRESHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A335730)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_GET_ENABLEDNSROUNDROBIN_OFFSET UNITYSDK_OFFSET(0x1A335750)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_GET_ENCRYPTIONPOLICY_OFFSET UNITYSDK_OFFSET(0x1A335790)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_GET_EXPECT100CONTINUE_OFFSET UNITYSDK_OFFSET(0x1A3356F0)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_GET_IPV6ENABLED_OFFSET UNITYSDK_OFFSET(0x1A3357B0)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_GET_SECTION_OFFSET UNITYSDK_OFFSET(0x1A3356A0)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_GET_USENAGLEALGORITHM_OFFSET UNITYSDK_OFFSET(0x1A3356D0)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_SET_CHECKCERTIFICATENAME_OFFSET UNITYSDK_OFFSET(0x1A335720)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_SET_CHECKCERTIFICATEREVOCATIONLIST_OFFSET UNITYSDK_OFFSET(0x1A335780)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_SET_DNSREFRESHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A335740)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_SET_ENABLEDNSROUNDROBIN_OFFSET UNITYSDK_OFFSET(0x1A335760)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_SET_ENCRYPTIONPOLICY_OFFSET UNITYSDK_OFFSET(0x1A3357A0)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_SET_EXPECT100CONTINUE_OFFSET UNITYSDK_OFFSET(0x1A335700)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL_SET_USENAGLEALGORITHM_OFFSET UNITYSDK_OFFSET(0x1A3356E0)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3357D0)
#define SYSTEM_NET_CONFIGURATION_SETTINGSSECTIONINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3357C0)
...
namespace System::Net::Configuration
{
	...
	public:
		...
		::System::Boolean _EnableDnsRoundRobin_k__BackingField; // 0x14
		::System::Boolean _UseNagleAlgorithm_k__BackingField; // 0x15
		::System::Boolean _CheckCertificateName_k__BackingField; // 0x16
		::System::Boolean _Expect100Continue_k__BackingField; // 0x17
		...
		::System::Boolean HttpListenerUnescapeRequestUrl; // 0x20
