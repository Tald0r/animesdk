...
#define SYSTEM_NET_CONFIGURATION_SMTPSPECIFIEDPICKUPDIRECTORYELEMENT_GET_PICKUPDIRECTORYLOCATION_OFFSET UNITYSDK_OFFSET(0x19FDB830)
#define SYSTEM_NET_CONFIGURATION_SMTPSPECIFIEDPICKUPDIRECTORYELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x19FDB8B0)
#define SYSTEM_NET_CONFIGURATION_SMTPSPECIFIEDPICKUPDIRECTORYELEMENT_SET_PICKUPDIRECTORYLOCATION_OFFSET UNITYSDK_OFFSET(0x19FDB870)
#define SYSTEM_NET_CONFIGURATION_SMTPSPECIFIEDPICKUPDIRECTORYELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FDB7F0)
