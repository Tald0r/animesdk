...
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x182DB710)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_GET_MAXCONNECTION_OFFSET UNITYSDK_OFFSET(0x182DB790)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x182DB810)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_SET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x182DB750)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_SET_MAXCONNECTION_OFFSET UNITYSDK_OFFSET(0x182DB7D0)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x182DB6D0)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x182DB690)
