...
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x188F0420)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_GET_MAXCONNECTION_OFFSET UNITYSDK_OFFSET(0x188F04A0)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x188F0520)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_SET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x188F0460)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT_SET_MAXCONNECTION_OFFSET UNITYSDK_OFFSET(0x188F04E0)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x188F03E0)
#define SYSTEM_NET_CONFIGURATION_CONNECTIONMANAGEMENTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x188F03A0)
