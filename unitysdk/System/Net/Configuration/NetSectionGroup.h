...
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GETSECTIONGROUP_OFFSET UNITYSDK_OFFSET(0x191BBA90)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_AUTHENTICATIONMODULES_OFFSET UNITYSDK_OFFSET(0x191BB8D0)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_CONNECTIONMANAGEMENT_OFFSET UNITYSDK_OFFSET(0x191BB910)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_DEFAULTPROXY_OFFSET UNITYSDK_OFFSET(0x191BB950)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_MAILSETTINGS_OFFSET UNITYSDK_OFFSET(0x191BB990)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_REQUESTCACHING_OFFSET UNITYSDK_OFFSET(0x191BB9D0)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x191BBA10)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_WEBREQUESTMODULES_OFFSET UNITYSDK_OFFSET(0x191BBA50)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x191BB890)
