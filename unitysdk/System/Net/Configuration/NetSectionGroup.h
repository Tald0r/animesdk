...
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GETSECTIONGROUP_OFFSET UNITYSDK_OFFSET(0x18D72DE0)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_AUTHENTICATIONMODULES_OFFSET UNITYSDK_OFFSET(0x18D72C20)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_CONNECTIONMANAGEMENT_OFFSET UNITYSDK_OFFSET(0x18D72C60)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_DEFAULTPROXY_OFFSET UNITYSDK_OFFSET(0x18D72CA0)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_MAILSETTINGS_OFFSET UNITYSDK_OFFSET(0x18D72CE0)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_REQUESTCACHING_OFFSET UNITYSDK_OFFSET(0x18D72D20)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x18D72D60)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP_GET_WEBREQUESTMODULES_OFFSET UNITYSDK_OFFSET(0x18D72DA0)
#define SYSTEM_NET_CONFIGURATION_NETSECTIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18D72BE0)
