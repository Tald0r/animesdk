...
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT_GET_DOWNLOADTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1823A140)
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1823A1C0)
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT_POSTDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1823A200)
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT_SET_DOWNLOADTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1823A180)
#define SYSTEM_NET_CONFIGURATION_WEBPROXYSCRIPTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1823A100)
