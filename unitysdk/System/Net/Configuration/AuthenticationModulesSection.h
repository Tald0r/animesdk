...
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULESSECTION_GET_AUTHENTICATIONMODULES_OFFSET UNITYSDK_OFFSET(0x18D727E0)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULESSECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x18D72820)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULESSECTION_INITIALIZEDEFAULT_OFFSET UNITYSDK_OFFSET(0x18D72860)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULESSECTION_POSTDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x18D728A0)
#define SYSTEM_NET_CONFIGURATION_AUTHENTICATIONMODULESSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18D727A0)
