...
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_GET_DELIVERYFORMAT_OFFSET UNITYSDK_OFFSET(0x18239EC0)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_GET_DELIVERYMETHOD_OFFSET UNITYSDK_OFFSET(0x18239F40)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_GET_FROM_OFFSET UNITYSDK_OFFSET(0x18239FC0)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_GET_NETWORK_OFFSET UNITYSDK_OFFSET(0x1823A040)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1823A080)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_GET_SPECIFIEDPICKUPDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1823A0C0)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_SET_DELIVERYFORMAT_OFFSET UNITYSDK_OFFSET(0x18239F00)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_SET_DELIVERYMETHOD_OFFSET UNITYSDK_OFFSET(0x18239F80)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION_SET_FROM_OFFSET UNITYSDK_OFFSET(0x1823A000)
#define SYSTEM_NET_CONFIGURATION_SMTPSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18239E80)
