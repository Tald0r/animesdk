...
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x18BB0AB0)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x18BB0AF0)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION_CREATENEWELEMENT_OFFSET UNITYSDK_OFFSET(0x18BB0B30)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION_GETELEMENTKEY_OFFSET UNITYSDK_OFFSET(0x18BB0B70)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x18BB09F0)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x18BB0970)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION_GET_THROWONDUPLICATE_OFFSET UNITYSDK_OFFSET(0x18BB0A70)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x18BB0BB0)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x18BB0C70)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x18BB0C30)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x18BB0BF0)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x18BB0A30)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x18BB09B0)
#define SYSTEM_NET_CONFIGURATION_BYPASSELEMENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB0930)
