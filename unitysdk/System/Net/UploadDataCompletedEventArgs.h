...
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTARGS_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x1932CA80)
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1932CAA0)
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1932CA30)
