...
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTARGS_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x18F5C8D0)
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F5C8F0)
#define SYSTEM_NET_UPLOADDATACOMPLETEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18F5C880)
