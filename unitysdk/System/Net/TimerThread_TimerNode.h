...
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_CANCEL_OFFSET UNITYSDK_OFFSET(0x19247230)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_FIRE_OFFSET UNITYSDK_OFFSET(0x192473A0)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_GET_HASEXPIRED_OFFSET UNITYSDK_OFFSET(0x192471E0)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_GET_NEXT_OFFSET UNITYSDK_OFFSET(0x192471F0)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_GET_PREV_OFFSET UNITYSDK_OFFSET(0x19247210)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_SET_NEXT_OFFSET UNITYSDK_OFFSET(0x19247200)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE_SET_PREV_OFFSET UNITYSDK_OFFSET(0x19247220)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19247180)
#define SYSTEM_NET_TIMERTHREAD_TIMERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19247100)
