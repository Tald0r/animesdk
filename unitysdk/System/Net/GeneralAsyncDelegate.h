...
#define SYSTEM_NET_GENERALASYNCDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B745A0)
#define SYSTEM_NET_GENERALASYNCDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B745E0)
#define SYSTEM_NET_GENERALASYNCDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B74020)
#define SYSTEM_NET_GENERALASYNCDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B74010)
