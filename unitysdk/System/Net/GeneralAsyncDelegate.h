...
#define SYSTEM_NET_GENERALASYNCDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19068E80)
#define SYSTEM_NET_GENERALASYNCDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19068EC0)
#define SYSTEM_NET_GENERALASYNCDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19068900)
#define SYSTEM_NET_GENERALASYNCDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x190688E0)
