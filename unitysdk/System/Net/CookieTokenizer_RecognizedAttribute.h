...
#define SYSTEM_NET_COOKIETOKENIZER_RECOGNIZEDATTRIBUTE_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define SYSTEM_NET_COOKIETOKENIZER_RECOGNIZEDATTRIBUTE_ISEQUALTO_OFFSET UNITYSDK_OFFSET(0x87B230)
#define SYSTEM_NET_COOKIETOKENIZER_RECOGNIZEDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x324900)
