...
#define SYSTEM_NET_WEBPROXY_ABORTGETPROXIESAUTO_OFFSET UNITYSDK_OFFSET(0x182F5580)
#define SYSTEM_NET_WEBPROXY_AREALLBYPASSED_OFFSET UNITYSDK_OFFSET(0x182F51A0)
#define SYSTEM_NET_WEBPROXY_CHECKFORCHANGES_OFFSET UNITYSDK_OFFSET(0x182F41E0)
#define SYSTEM_NET_WEBPROXY_CREATEDEFAULTPROXY_OFFSET UNITYSDK_OFFSET(0x182DB890)
#define SYSTEM_NET_WEBPROXY_CREATEPROXYURI_OFFSET UNITYSDK_OFFSET(0x182F39D0)
#define SYSTEM_NET_WEBPROXY_DELETESCRIPTENGINE_OFFSET UNITYSDK_OFFSET(0x182F3E60)
#define SYSTEM_NET_WEBPROXY_GETDEFAULTPROXY_OFFSET UNITYSDK_OFFSET(0x182F4A10)
#define SYSTEM_NET_WEBPROXY_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x182F4CC0)
#define SYSTEM_NET_WEBPROXY_GETPROXIESAUTO_OFFSET UNITYSDK_OFFSET(0x182F5550)
#define SYSTEM_NET_WEBPROXY_GETPROXYAUTOFAILOVER_OFFSET UNITYSDK_OFFSET(0x182F5590)
#define SYSTEM_NET_WEBPROXY_GETPROXYAUTO_OFFSET UNITYSDK_OFFSET(0x182F4360)
#define SYSTEM_NET_WEBPROXY_GETPROXY_OFFSET UNITYSDK_OFFSET(0x182F41F0)
#define SYSTEM_NET_WEBPROXY_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x182F3E30)
#define SYSTEM_NET_WEBPROXY_GET_BYPASSARRAYLIST_OFFSET UNITYSDK_OFFSET(0x182F4180)
#define SYSTEM_NET_WEBPROXY_GET_BYPASSLIST_OFFSET UNITYSDK_OFFSET(0x182F3F60)
#define SYSTEM_NET_WEBPROXY_GET_BYPASSPROXYONLOCAL_OFFSET UNITYSDK_OFFSET(0x182F3F30)
#define SYSTEM_NET_WEBPROXY_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x182F4080)
#define SYSTEM_NET_WEBPROXY_GET_SCRIPTENGINE_OFFSET UNITYSDK_OFFSET(0x182F4F40)
#define SYSTEM_NET_WEBPROXY_GET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x182F40A0)
#define SYSTEM_NET_WEBPROXY_ISBYPASSEDAUTO_OFFSET UNITYSDK_OFFSET(0x182F4A00)
#define SYSTEM_NET_WEBPROXY_ISBYPASSEDMANUAL_OFFSET UNITYSDK_OFFSET(0x182F4370)
#define SYSTEM_NET_WEBPROXY_ISBYPASSED_OFFSET UNITYSDK_OFFSET(0x182F4990)
#define SYSTEM_NET_WEBPROXY_ISLOCALINPROXYHASH_OFFSET UNITYSDK_OFFSET(0x182F48C0)
#define SYSTEM_NET_WEBPROXY_ISLOCAL_OFFSET UNITYSDK_OFFSET(0x182F46D0)
#define SYSTEM_NET_WEBPROXY_ISMATCHINBYPASSLIST_OFFSET UNITYSDK_OFFSET(0x182F4400)
#define SYSTEM_NET_WEBPROXY_PROXYURI_OFFSET UNITYSDK_OFFSET(0x182F54A0)
#define SYSTEM_NET_WEBPROXY_SET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x182F3E40)
#define SYSTEM_NET_WEBPROXY_SET_AUTODETECT_OFFSET UNITYSDK_OFFSET(0x182F3E70)
#define SYSTEM_NET_WEBPROXY_SET_BYPASSLIST_OFFSET UNITYSDK_OFFSET(0x182F4030)
#define SYSTEM_NET_WEBPROXY_SET_BYPASSPROXYONLOCAL_OFFSET UNITYSDK_OFFSET(0x182F3F40)
#define SYSTEM_NET_WEBPROXY_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x182F4090)
#define SYSTEM_NET_WEBPROXY_SET_SCRIPTENGINE_OFFSET UNITYSDK_OFFSET(0x182F4F50)
#define SYSTEM_NET_WEBPROXY_SET_SCRIPTLOCATION_OFFSET UNITYSDK_OFFSET(0x182F3ED0)
#define SYSTEM_NET_WEBPROXY_SET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x182F4110)
#define SYSTEM_NET_WEBPROXY_SYSTEM_NET_IAUTOWEBPROXY_GETPROXIES_OFFSET UNITYSDK_OFFSET(0x182F5060)
#define SYSTEM_NET_WEBPROXY_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x182F4C90)
#define SYSTEM_NET_WEBPROXY_UNSAFEUPDATEFROMREGISTRY_OFFSET UNITYSDK_OFFSET(0x182F4C80)
#define SYSTEM_NET_WEBPROXY_UPDATEREGEXLIST_OFFSET UNITYSDK_OFFSET(0x182F35A0)
#define SYSTEM_NET_WEBPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x182F4F60)
#define SYSTEM_NET_WEBPROXY__CTOR_10_OFFSET UNITYSDK_OFFSET(0x182F4A40)
#define SYSTEM_NET_WEBPROXY__CTOR_11_OFFSET UNITYSDK_OFFSET(0x182F4A30)
#define SYSTEM_NET_WEBPROXY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x182F3500)
#define SYSTEM_NET_WEBPROXY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x182F3520)
#define SYSTEM_NET_WEBPROXY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x182F3540)
#define SYSTEM_NET_WEBPROXY__CTOR_4_OFFSET UNITYSDK_OFFSET(0x182F34A0)
#define SYSTEM_NET_WEBPROXY__CTOR_5_OFFSET UNITYSDK_OFFSET(0x182F3800)
#define SYSTEM_NET_WEBPROXY__CTOR_6_OFFSET UNITYSDK_OFFSET(0x182F38E0)
#define SYSTEM_NET_WEBPROXY__CTOR_7_OFFSET UNITYSDK_OFFSET(0x182F3AB0)
#define SYSTEM_NET_WEBPROXY__CTOR_8_OFFSET UNITYSDK_OFFSET(0x182F3BB0)
#define SYSTEM_NET_WEBPROXY__CTOR_9_OFFSET UNITYSDK_OFFSET(0x182F3CF0)
#define SYSTEM_NET_WEBPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x182F3480)
