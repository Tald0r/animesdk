...
#define SYSTEM_NET_WEBPROXY_ABORTGETPROXIESAUTO_OFFSET UNITYSDK_OFFSET(0x1890A300)
#define SYSTEM_NET_WEBPROXY_AREALLBYPASSED_OFFSET UNITYSDK_OFFSET(0x18909F20)
#define SYSTEM_NET_WEBPROXY_CHECKFORCHANGES_OFFSET UNITYSDK_OFFSET(0x18908F60)
#define SYSTEM_NET_WEBPROXY_CREATEDEFAULTPROXY_OFFSET UNITYSDK_OFFSET(0x188F05A0)
#define SYSTEM_NET_WEBPROXY_CREATEPROXYURI_OFFSET UNITYSDK_OFFSET(0x18908750)
#define SYSTEM_NET_WEBPROXY_DELETESCRIPTENGINE_OFFSET UNITYSDK_OFFSET(0x18908BE0)
#define SYSTEM_NET_WEBPROXY_GETDEFAULTPROXY_OFFSET UNITYSDK_OFFSET(0x18909790)
#define SYSTEM_NET_WEBPROXY_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18909A40)
#define SYSTEM_NET_WEBPROXY_GETPROXIESAUTO_OFFSET UNITYSDK_OFFSET(0x1890A2D0)
#define SYSTEM_NET_WEBPROXY_GETPROXYAUTOFAILOVER_OFFSET UNITYSDK_OFFSET(0x1890A310)
#define SYSTEM_NET_WEBPROXY_GETPROXYAUTO_OFFSET UNITYSDK_OFFSET(0x189090E0)
#define SYSTEM_NET_WEBPROXY_GETPROXY_OFFSET UNITYSDK_OFFSET(0x18908F70)
#define SYSTEM_NET_WEBPROXY_GET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x18908BB0)
#define SYSTEM_NET_WEBPROXY_GET_BYPASSARRAYLIST_OFFSET UNITYSDK_OFFSET(0x18908F00)
#define SYSTEM_NET_WEBPROXY_GET_BYPASSLIST_OFFSET UNITYSDK_OFFSET(0x18908CE0)
#define SYSTEM_NET_WEBPROXY_GET_BYPASSPROXYONLOCAL_OFFSET UNITYSDK_OFFSET(0x18908CB0)
#define SYSTEM_NET_WEBPROXY_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18908E00)
#define SYSTEM_NET_WEBPROXY_GET_SCRIPTENGINE_OFFSET UNITYSDK_OFFSET(0x18909CC0)
#define SYSTEM_NET_WEBPROXY_GET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18908E20)
#define SYSTEM_NET_WEBPROXY_ISBYPASSEDAUTO_OFFSET UNITYSDK_OFFSET(0x18909780)
#define SYSTEM_NET_WEBPROXY_ISBYPASSEDMANUAL_OFFSET UNITYSDK_OFFSET(0x189090F0)
#define SYSTEM_NET_WEBPROXY_ISBYPASSED_OFFSET UNITYSDK_OFFSET(0x18909710)
#define SYSTEM_NET_WEBPROXY_ISLOCALINPROXYHASH_OFFSET UNITYSDK_OFFSET(0x18909640)
#define SYSTEM_NET_WEBPROXY_ISLOCAL_OFFSET UNITYSDK_OFFSET(0x18909450)
#define SYSTEM_NET_WEBPROXY_ISMATCHINBYPASSLIST_OFFSET UNITYSDK_OFFSET(0x18909180)
#define SYSTEM_NET_WEBPROXY_PROXYURI_OFFSET UNITYSDK_OFFSET(0x1890A220)
#define SYSTEM_NET_WEBPROXY_SET_ADDRESS_OFFSET UNITYSDK_OFFSET(0x18908BC0)
#define SYSTEM_NET_WEBPROXY_SET_AUTODETECT_OFFSET UNITYSDK_OFFSET(0x18908BF0)
#define SYSTEM_NET_WEBPROXY_SET_BYPASSLIST_OFFSET UNITYSDK_OFFSET(0x18908DB0)
#define SYSTEM_NET_WEBPROXY_SET_BYPASSPROXYONLOCAL_OFFSET UNITYSDK_OFFSET(0x18908CC0)
#define SYSTEM_NET_WEBPROXY_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18908E10)
#define SYSTEM_NET_WEBPROXY_SET_SCRIPTENGINE_OFFSET UNITYSDK_OFFSET(0x18909CD0)
#define SYSTEM_NET_WEBPROXY_SET_SCRIPTLOCATION_OFFSET UNITYSDK_OFFSET(0x18908C50)
#define SYSTEM_NET_WEBPROXY_SET_USEDEFAULTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x18908E90)
#define SYSTEM_NET_WEBPROXY_SYSTEM_NET_IAUTOWEBPROXY_GETPROXIES_OFFSET UNITYSDK_OFFSET(0x18909DE0)
#define SYSTEM_NET_WEBPROXY_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18909A10)
#define SYSTEM_NET_WEBPROXY_UNSAFEUPDATEFROMREGISTRY_OFFSET UNITYSDK_OFFSET(0x18909A00)
#define SYSTEM_NET_WEBPROXY_UPDATEREGEXLIST_OFFSET UNITYSDK_OFFSET(0x18908310)
#define SYSTEM_NET_WEBPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x18909CE0)
#define SYSTEM_NET_WEBPROXY__CTOR_10_OFFSET UNITYSDK_OFFSET(0x189097C0)
#define SYSTEM_NET_WEBPROXY__CTOR_11_OFFSET UNITYSDK_OFFSET(0x189097B0)
#define SYSTEM_NET_WEBPROXY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18908270)
#define SYSTEM_NET_WEBPROXY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18908290)
#define SYSTEM_NET_WEBPROXY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x189082B0)
#define SYSTEM_NET_WEBPROXY__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18908210)
#define SYSTEM_NET_WEBPROXY__CTOR_5_OFFSET UNITYSDK_OFFSET(0x18908570)
#define SYSTEM_NET_WEBPROXY__CTOR_6_OFFSET UNITYSDK_OFFSET(0x18908650)
#define SYSTEM_NET_WEBPROXY__CTOR_7_OFFSET UNITYSDK_OFFSET(0x18908830)
#define SYSTEM_NET_WEBPROXY__CTOR_8_OFFSET UNITYSDK_OFFSET(0x18908930)
#define SYSTEM_NET_WEBPROXY__CTOR_9_OFFSET UNITYSDK_OFFSET(0x18908A70)
#define SYSTEM_NET_WEBPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x18908200)
