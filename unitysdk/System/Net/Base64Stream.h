...
#define SYSTEM_NET_BASE64STREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x1859DAF0)
#define SYSTEM_NET_BASE64STREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1859DC70)
#define SYSTEM_NET_BASE64STREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1859DDF0)
#define SYSTEM_NET_BASE64STREAM_DECODEBYTES_OFFSET UNITYSDK_OFFSET(0x1859E170)
#define SYSTEM_NET_BASE64STREAM_ENCODEBYTES_1_OFFSET UNITYSDK_OFFSET(0x1859E6F0)
#define SYSTEM_NET_BASE64STREAM_ENCODEBYTES_OFFSET UNITYSDK_OFFSET(0x1859E6D0)
#define SYSTEM_NET_BASE64STREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x1859F4D0)
#define SYSTEM_NET_BASE64STREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x1859F5C0)
#define SYSTEM_NET_BASE64STREAM_FLUSHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1859E120)
#define SYSTEM_NET_BASE64STREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1859F6B0)
#define SYSTEM_NET_BASE64STREAM_GETENCODEDSTRING_OFFSET UNITYSDK_OFFSET(0x1859F410)
#define SYSTEM_NET_BASE64STREAM_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x1859F400)
#define SYSTEM_NET_BASE64STREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1859DA50)
#define SYSTEM_NET_BASE64STREAM_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x1859DA80)
#define SYSTEM_NET_BASE64STREAM_GET_WRITESTATE_OFFSET UNITYSDK_OFFSET(0x1859DAE0)
#define SYSTEM_NET_BASE64STREAM_READ_OFFSET UNITYSDK_OFFSET(0x1859F720)
#define SYSTEM_NET_BASE64STREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1859F850)
#define SYSTEM_NET_BASE64STREAM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1859F9D0)
#define SYSTEM_NET_BASE64STREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1859D960)
#define SYSTEM_NET_BASE64STREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1859DA00)
#define SYSTEM_NET_BASE64STREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1859D850)
