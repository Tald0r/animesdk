...
#define SYSTEM_NET_BASE64STREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x18BAE860)
#define SYSTEM_NET_BASE64STREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x18BAE9E0)
#define SYSTEM_NET_BASE64STREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x18BAEB60)
#define SYSTEM_NET_BASE64STREAM_DECODEBYTES_OFFSET UNITYSDK_OFFSET(0x18BAEEE0)
#define SYSTEM_NET_BASE64STREAM_ENCODEBYTES_1_OFFSET UNITYSDK_OFFSET(0x18BAF460)
#define SYSTEM_NET_BASE64STREAM_ENCODEBYTES_OFFSET UNITYSDK_OFFSET(0x18BAF440)
#define SYSTEM_NET_BASE64STREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x18BB0240)
#define SYSTEM_NET_BASE64STREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x18BB0330)
#define SYSTEM_NET_BASE64STREAM_FLUSHINTERNAL_OFFSET UNITYSDK_OFFSET(0x18BAEE90)
#define SYSTEM_NET_BASE64STREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x18BB0420)
#define SYSTEM_NET_BASE64STREAM_GETENCODEDSTRING_OFFSET UNITYSDK_OFFSET(0x18BB0180)
#define SYSTEM_NET_BASE64STREAM_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x18BB0170)
#define SYSTEM_NET_BASE64STREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x18BAE7C0)
#define SYSTEM_NET_BASE64STREAM_GET_READSTATE_OFFSET UNITYSDK_OFFSET(0x18BAE7F0)
#define SYSTEM_NET_BASE64STREAM_GET_WRITESTATE_OFFSET UNITYSDK_OFFSET(0x18BAE850)
#define SYSTEM_NET_BASE64STREAM_READ_OFFSET UNITYSDK_OFFSET(0x18BB0490)
#define SYSTEM_NET_BASE64STREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x18BB05C0)
#define SYSTEM_NET_BASE64STREAM__CCTOR_OFFSET UNITYSDK_OFFSET(0x18BB0740)
#define SYSTEM_NET_BASE64STREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18BAE6D0)
#define SYSTEM_NET_BASE64STREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18BAE770)
#define SYSTEM_NET_BASE64STREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAE5C0)
