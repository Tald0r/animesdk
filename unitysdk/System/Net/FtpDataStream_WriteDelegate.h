...
#define SYSTEM_NET_FTPDATASTREAM_WRITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D28F10)
#define SYSTEM_NET_FTPDATASTREAM_WRITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D28F90)
#define SYSTEM_NET_FTPDATASTREAM_WRITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D28970)
#define SYSTEM_NET_FTPDATASTREAM_WRITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D28950)
