...
#define SYSTEM_NET_INTERLOCKEDSTACK_POP_OFFSET UNITYSDK_OFFSET(0x19D790C0)
#define SYSTEM_NET_INTERLOCKEDSTACK_PUSH_OFFSET UNITYSDK_OFFSET(0x19D78F80)
#define SYSTEM_NET_INTERLOCKEDSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19D78F20)
