...
#define SYSTEM_NET_TRACKINGSTRINGDICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x18F5C640)
#define SYSTEM_NET_TRACKINGSTRINGDICTIONARY_CLEAR_OFFSET UNITYSDK_OFFSET(0x18F5C6D0)
#define SYSTEM_NET_TRACKINGSTRINGDICTIONARY_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x18F5C620)
#define SYSTEM_NET_TRACKINGSTRINGDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x18F5C7E0)
#define SYSTEM_NET_TRACKINGSTRINGDICTIONARY_REMOVE_OFFSET UNITYSDK_OFFSET(0x18F5C760)
#define SYSTEM_NET_TRACKINGSTRINGDICTIONARY_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x18F5C630)
#define SYSTEM_NET_TRACKINGSTRINGDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x18F5C7F0)
#define SYSTEM_NET_TRACKINGSTRINGDICTIONARY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F5C5B0)
#define SYSTEM_NET_TRACKINGSTRINGDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x18F5C550)
