...
#define SYSTEM_NET_DNS_BEGINGETHOSTADDRESSES_OFFSET UNITYSDK_OFFSET(0x19372E60)
#define SYSTEM_NET_DNS_BEGINGETHOSTBYNAME_OFFSET UNITYSDK_OFFSET(0x19372C90)
#define SYSTEM_NET_DNS_BEGINGETHOSTENTRY_1_OFFSET UNITYSDK_OFFSET(0x19373100)
#define SYSTEM_NET_DNS_BEGINGETHOSTENTRY_OFFSET UNITYSDK_OFFSET(0x19372FB0)
#define SYSTEM_NET_DNS_BEGINRESOLVE_OFFSET UNITYSDK_OFFSET(0x19372DA0)
#define SYSTEM_NET_DNS_ENDGETHOSTADDRESSES_OFFSET UNITYSDK_OFFSET(0x19373350)
#define SYSTEM_NET_DNS_ENDGETHOSTBYNAME_OFFSET UNITYSDK_OFFSET(0x193731C0)
#define SYSTEM_NET_DNS_ENDGETHOSTENTRY_OFFSET UNITYSDK_OFFSET(0x19373410)
#define SYSTEM_NET_DNS_ENDRESOLVE_OFFSET UNITYSDK_OFFSET(0x19373290)
#define SYSTEM_NET_DNS_ERROR_11001_OFFSET UNITYSDK_OFFSET(0x19373510)
#define SYSTEM_NET_DNS_GETHOSTADDRESSESASYNC_OFFSET UNITYSDK_OFFSET(0x193741E0)
#define SYSTEM_NET_DNS_GETHOSTADDRESSES_OFFSET UNITYSDK_OFFSET(0x19373EC0)
#define SYSTEM_NET_DNS_GETHOSTBYADDRESSFROMSTRING_OFFSET UNITYSDK_OFFSET(0x19373990)
#define SYSTEM_NET_DNS_GETHOSTBYADDRESS_1_OFFSET UNITYSDK_OFFSET(0x19373B10)
#define SYSTEM_NET_DNS_GETHOSTBYADDRESS_OFFSET UNITYSDK_OFFSET(0x19373910)
#define SYSTEM_NET_DNS_GETHOSTBYADDR_INTERNAL_OFFSET UNITYSDK_OFFSET(0x193734F0)
#define SYSTEM_NET_DNS_GETHOSTBYNAME_INTERNAL_OFFSET UNITYSDK_OFFSET(0x193734E0)
#define SYSTEM_NET_DNS_GETHOSTBYNAME_OFFSET UNITYSDK_OFFSET(0x19373D90)
#define SYSTEM_NET_DNS_GETHOSTENTRYASYNC_1_OFFSET UNITYSDK_OFFSET(0x19374420)
#define SYSTEM_NET_DNS_GETHOSTENTRYASYNC_OFFSET UNITYSDK_OFFSET(0x19374300)
#define SYSTEM_NET_DNS_GETHOSTENTRY_1_OFFSET UNITYSDK_OFFSET(0x19373D10)
#define SYSTEM_NET_DNS_GETHOSTENTRY_OFFSET UNITYSDK_OFFSET(0x19373B80)
#define SYSTEM_NET_DNS_GETHOSTNAME_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19373500)
#define SYSTEM_NET_DNS_GETHOSTNAME_OFFSET UNITYSDK_OFFSET(0x19374080)
#define SYSTEM_NET_DNS_HOSTENT_TO_IPHOSTENTRY_OFFSET UNITYSDK_OFFSET(0x19373580)
#define SYSTEM_NET_DNS_RESOLVE_OFFSET UNITYSDK_OFFSET(0x19374110)
#define SYSTEM_NET_DNS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19372C80)
