...
#define SYSTEM_NET_SECURITY_LOCALCERTIFICATESELECTIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FE1AA0)
#define SYSTEM_NET_SECURITY_LOCALCERTIFICATESELECTIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FE1B00)
#define SYSTEM_NET_SECURITY_LOCALCERTIFICATESELECTIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FE13B0)
#define SYSTEM_NET_SECURITY_LOCALCERTIFICATESELECTIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE13A0)
