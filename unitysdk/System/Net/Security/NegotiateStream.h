...
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENTASYNC_1_OFFSET UNITYSDK_OFFSET(0x18FF6110)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENTASYNC_2_OFFSET UNITYSDK_OFFSET(0x18FF6310)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENTASYNC_3_OFFSET UNITYSDK_OFFSET(0x18FF64A0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENTASYNC_4_OFFSET UNITYSDK_OFFSET(0x18FF64F0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENTASYNC_OFFSET UNITYSDK_OFFSET(0x18FF5FB0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENT_1_OFFSET UNITYSDK_OFFSET(0x18FF5A70)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENT_2_OFFSET UNITYSDK_OFFSET(0x18FF5AC0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENT_3_OFFSET UNITYSDK_OFFSET(0x18FF5B10)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENT_4_OFFSET UNITYSDK_OFFSET(0x18FF5B60)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x18FF5A20)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVERASYNC_1_OFFSET UNITYSDK_OFFSET(0x18FF66A0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVERASYNC_2_OFFSET UNITYSDK_OFFSET(0x18FF66F0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVERASYNC_3_OFFSET UNITYSDK_OFFSET(0x18FF6740)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVERASYNC_OFFSET UNITYSDK_OFFSET(0x18FF6540)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVER_1_OFFSET UNITYSDK_OFFSET(0x18FF5C00)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVER_2_OFFSET UNITYSDK_OFFSET(0x18FF5C50)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVER_3_OFFSET UNITYSDK_OFFSET(0x18FF5CA0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_AUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x18FF5BB0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASCLIENT_1_OFFSET UNITYSDK_OFFSET(0x18FF5700)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASCLIENT_2_OFFSET UNITYSDK_OFFSET(0x18FF5750)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASCLIENT_3_OFFSET UNITYSDK_OFFSET(0x18FF57A0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASCLIENT_4_OFFSET UNITYSDK_OFFSET(0x18FF57F0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x18FF56B0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASSERVER_1_OFFSET UNITYSDK_OFFSET(0x18FF58E0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASSERVER_2_OFFSET UNITYSDK_OFFSET(0x18FF5930)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASSERVER_3_OFFSET UNITYSDK_OFFSET(0x18FF5980)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINAUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x18FF5890)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x18FF5840)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x18FF59D0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18FF5CF0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_ENDAUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x18FF5D00)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_ENDAUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x18FF5DA0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x18FF5D50)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x18FF5DF0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x18FF5E40)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x18FF52D0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x18FF5300)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FF5330)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x18FF5380)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_IMPERSONATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x18FF53B0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_ISAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x18FF5400)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_ISENCRYPTED_OFFSET UNITYSDK_OFFSET(0x18FF5450)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_ISMUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x18FF54A0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_ISSERVER_OFFSET UNITYSDK_OFFSET(0x18FF54F0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_ISSIGNED_OFFSET UNITYSDK_OFFSET(0x18FF5540)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x18FF5590)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x18FF55C0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FF5620)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_REMOTEIDENTITY_OFFSET UNITYSDK_OFFSET(0x18FF5640)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_GET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FF5690)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_READ_OFFSET UNITYSDK_OFFSET(0x18FF5E70)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x18FF5EC0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x18FF5F10)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x18FF55F0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_SET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FF5630)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_SET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x18FF56A0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x18FF5F60)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FF52C0)
#define SYSTEM_NET_SECURITY_NEGOTIATESTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF52B0)
