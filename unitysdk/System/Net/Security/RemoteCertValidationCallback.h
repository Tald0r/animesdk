...
#define SYSTEM_NET_SECURITY_REMOTECERTVALIDATIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x191DE7E0)
#define SYSTEM_NET_SECURITY_REMOTECERTVALIDATIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x191DE880)
#define SYSTEM_NET_SECURITY_REMOTECERTVALIDATIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x191C0E00)
#define SYSTEM_NET_SECURITY_REMOTECERTVALIDATIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x191DE7D0)
