...
#define SYSTEM_NET_SECURITY_REMOTECERTVALIDATIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x195DAB80)
#define SYSTEM_NET_SECURITY_REMOTECERTVALIDATIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x195DAC20)
#define SYSTEM_NET_SECURITY_REMOTECERTVALIDATIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x195BD130)
#define SYSTEM_NET_SECURITY_REMOTECERTVALIDATIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x195DAB60)
