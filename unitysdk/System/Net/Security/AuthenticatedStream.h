...
#define SYSTEM_NET_SECURITY_AUTHENTICATEDSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1936A8A0)
#define SYSTEM_NET_SECURITY_AUTHENTICATEDSTREAM_GET_INNERSTREAM_OFFSET UNITYSDK_OFFSET(0x193867B0)
#define SYSTEM_NET_SECURITY_AUTHENTICATEDSTREAM_GET_LEAVEINNERSTREAMOPEN_OFFSET UNITYSDK_OFFSET(0x193867A0)
#define SYSTEM_NET_SECURITY_AUTHENTICATEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19366F70)
