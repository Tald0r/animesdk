...
#define SYSTEM_NULLCONSOLEDRIVER_READKEY_OFFSET UNITYSDK_OFFSET(0x18607C80)
#define SYSTEM_NULLCONSOLEDRIVER_RESETCOLOR_OFFSET UNITYSDK_OFFSET(0x18607CF0)
#define SYSTEM_NULLCONSOLEDRIVER_SET_FOREGROUNDCOLOR_OFFSET UNITYSDK_OFFSET(0x18607C70)
#define SYSTEM_NULLCONSOLEDRIVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18607D10)
#define SYSTEM_NULLCONSOLEDRIVER__CTOR_OFFSET UNITYSDK_OFFSET(0x18607D00)
