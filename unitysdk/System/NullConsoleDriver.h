...
#define SYSTEM_NULLCONSOLEDRIVER_READKEY_OFFSET UNITYSDK_OFFSET(0x17FD4270)
#define SYSTEM_NULLCONSOLEDRIVER_RESETCOLOR_OFFSET UNITYSDK_OFFSET(0x17FD42E0)
#define SYSTEM_NULLCONSOLEDRIVER_SET_FOREGROUNDCOLOR_OFFSET UNITYSDK_OFFSET(0x17FD4260)
#define SYSTEM_NULLCONSOLEDRIVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17FD4300)
#define SYSTEM_NULLCONSOLEDRIVER__CTOR_OFFSET UNITYSDK_OFFSET(0x17FD42F0)
