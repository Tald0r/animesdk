...
#define SYSTEM_GENERICURIPARSER_MAPGENERICPARSEROPTIONS_OFFSET UNITYSDK_OFFSET(0x1909D220)
#define SYSTEM_GENERICURIPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1909D110)
