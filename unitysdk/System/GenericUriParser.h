...
#define SYSTEM_GENERICURIPARSER_MAPGENERICPARSEROPTIONS_OFFSET UNITYSDK_OFFSET(0x194599E0)
#define SYSTEM_GENERICURIPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x194598D0)
