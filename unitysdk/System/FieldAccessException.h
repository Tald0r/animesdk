...
#define SYSTEM_FIELDACCESSEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A12DEE0)
#define SYSTEM_FIELDACCESSEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A12DF50)
#define SYSTEM_FIELDACCESSEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A12DE40)
