...
#define SYSTEM_IO_SEARCHPATTERN2_COMPILE_OFFSET UNITYSDK_OFFSET(0x18F508B0)
#define SYSTEM_IO_SEARCHPATTERN2_GET_HASWILDCARD_OFFSET UNITYSDK_OFFSET(0x18F50E50)
#define SYSTEM_IO_SEARCHPATTERN2_ISMATCH_1_OFFSET UNITYSDK_OFFSET(0x18F50DD0)
#define SYSTEM_IO_SEARCHPATTERN2_ISMATCH_OFFSET UNITYSDK_OFFSET(0x18F50BA0)
#define SYSTEM_IO_SEARCHPATTERN2_MATCH_OFFSET UNITYSDK_OFFSET(0x18F50C10)
#define SYSTEM_IO_SEARCHPATTERN2__CCTOR_OFFSET UNITYSDK_OFFSET(0x18F50E60)
#define SYSTEM_IO_SEARCHPATTERN2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F508A0)
#define SYSTEM_IO_SEARCHPATTERN2__CTOR_OFFSET UNITYSDK_OFFSET(0x18F4F0B0)
