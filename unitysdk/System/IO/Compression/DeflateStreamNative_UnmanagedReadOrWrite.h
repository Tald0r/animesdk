...
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAMNATIVE_UNMANAGEDREADORWRITE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19420CA0)
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAMNATIVE_UNMANAGEDREADORWRITE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19420D30)
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAMNATIVE_UNMANAGEDREADORWRITE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19420910)
#define SYSTEM_IO_COMPRESSION_DEFLATESTREAMNATIVE_UNMANAGEDREADORWRITE__CTOR_OFFSET UNITYSDK_OFFSET(0x194208F0)
