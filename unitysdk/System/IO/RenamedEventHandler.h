...
#define SYSTEM_IO_RENAMEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19684B00)
#define SYSTEM_IO_RENAMEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19684B40)
#define SYSTEM_IO_RENAMEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19684580)
#define SYSTEM_IO_RENAMEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19684570)
