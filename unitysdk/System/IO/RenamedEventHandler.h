...
#define SYSTEM_IO_RENAMEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19B23470)
#define SYSTEM_IO_RENAMEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19B234B0)
#define SYSTEM_IO_RENAMEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19B22EF0)
#define SYSTEM_IO_RENAMEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B22ED0)
