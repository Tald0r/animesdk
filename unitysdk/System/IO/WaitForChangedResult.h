...
#define SYSTEM_IO_WAITFORCHANGEDRESULT_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x272280)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_GET_OLDNAME_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_GET_TIMEDOUT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_SET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x302300)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x302310)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_SET_OLDNAME_OFFSET UNITYSDK_OFFSET(0x3123A0)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_SET_TIMEDOUT_OFFSET UNITYSDK_OFFSET(0x39A7D0)
