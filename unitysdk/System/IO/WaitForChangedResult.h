...
#define SYSTEM_IO_WAITFORCHANGEDRESULT_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_GET_OLDNAME_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_GET_TIMEDOUT_OFFSET UNITYSDK_OFFSET(0x35D950)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_SET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x2D3600)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x2CB170)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_SET_OLDNAME_OFFSET UNITYSDK_OFFSET(0x2D26A0)
#define SYSTEM_IO_WAITFORCHANGEDRESULT_SET_TIMEDOUT_OFFSET UNITYSDK_OFFSET(0x35DA50)
