...
#define SYSTEM_IO_FILESTREAM_READDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B1D930)
#define SYSTEM_IO_FILESTREAM_READDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B1D9B0)
#define SYSTEM_IO_FILESTREAM_READDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B1D350)
#define SYSTEM_IO_FILESTREAM_READDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B1D340)
