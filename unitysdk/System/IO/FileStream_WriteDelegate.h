...
#define SYSTEM_IO_FILESTREAM_WRITEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x186037F0)
#define SYSTEM_IO_FILESTREAM_WRITEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18603870)
#define SYSTEM_IO_FILESTREAM_WRITEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18603250)
#define SYSTEM_IO_FILESTREAM_WRITEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18603230)
