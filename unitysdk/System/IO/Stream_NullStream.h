...
#define SYSTEM_IO_STREAM_NULLSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x192B6E60)
#define SYSTEM_IO_STREAM_NULLSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x192B6EF0)
#define SYSTEM_IO_STREAM_NULLSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x192B6D70)
#define SYSTEM_IO_STREAM_NULLSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x192B6E70)
#define SYSTEM_IO_STREAM_NULLSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x192B6F00)
#define SYSTEM_IO_STREAM_NULLSTREAM_FLUSHASYNC_OFFSET UNITYSDK_OFFSET(0x192B6D90)
#define SYSTEM_IO_STREAM_NULLSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x192B6D80)
#define SYSTEM_IO_STREAM_NULLSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x192B6D10)
#define SYSTEM_IO_STREAM_NULLSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x192B6D30)
#define SYSTEM_IO_STREAM_NULLSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x192B6D20)
#define SYSTEM_IO_STREAM_NULLSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x192B6D40)
#define SYSTEM_IO_STREAM_NULLSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x192B6D50)
#define SYSTEM_IO_STREAM_NULLSTREAM_READASYNC_OFFSET UNITYSDK_OFFSET(0x192B6F90)
#define SYSTEM_IO_STREAM_NULLSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x192B7030)
#define SYSTEM_IO_STREAM_NULLSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x192B6F80)
#define SYSTEM_IO_STREAM_NULLSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x192B7130)
#define SYSTEM_IO_STREAM_NULLSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x192B7140)
#define SYSTEM_IO_STREAM_NULLSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x192B6D60)
#define SYSTEM_IO_STREAM_NULLSTREAM_WRITEASYNC_OFFSET UNITYSDK_OFFSET(0x192B7050)
#define SYSTEM_IO_STREAM_NULLSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x192B7120)
#define SYSTEM_IO_STREAM_NULLSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x192B7040)
#define SYSTEM_IO_STREAM_NULLSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x192B6CF0)
