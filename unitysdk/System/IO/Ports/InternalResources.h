...
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_ENDOFFILE_OFFSET UNITYSDK_OFFSET(0x187D3C30)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_ENDREADCALLEDTWICE_OFFSET UNITYSDK_OFFSET(0x187D3E80)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_ENDWRITECALLEDTWICE_OFFSET UNITYSDK_OFFSET(0x187D3EE0)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_FILENOTOPEN_OFFSET UNITYSDK_OFFSET(0x187D3DC0)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x187D3C90)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_MAKEHRFROMERRORCODE_OFFSET UNITYSDK_OFFSET(0x187D4230)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_WINIOERROR_OFFSET UNITYSDK_OFFSET(0x187D3F40)
#define SYSTEM_IO_PORTS_INTERNALRESOURCES_WRONGASYNCRESULT_OFFSET UNITYSDK_OFFSET(0x187D3E20)
