...
#define SYSTEM_IO_PORTS_SERIALPORT_ADD_DATARECEIVED_OFFSET UNITYSDK_OFFSET(0x18BAE040)
#define SYSTEM_IO_PORTS_SERIALPORT_ADD_ERRORRECEIVED_OFFSET UNITYSDK_OFFSET(0x18BAE0C0)
#define SYSTEM_IO_PORTS_SERIALPORT_ADD_PINCHANGED_OFFSET UNITYSDK_OFFSET(0x18BAE140)
#define SYSTEM_IO_PORTS_SERIALPORT_CLOSE_OFFSET UNITYSDK_OFFSET(0x18BAE1C0)
#define SYSTEM_IO_PORTS_SERIALPORT_DISCARDINBUFFER_OFFSET UNITYSDK_OFFSET(0x18BAE200)
#define SYSTEM_IO_PORTS_SERIALPORT_DISCARDOUTBUFFER_OFFSET UNITYSDK_OFFSET(0x18BAE240)
#define SYSTEM_IO_PORTS_SERIALPORT_GETPORTNAMES_OFFSET UNITYSDK_OFFSET(0x18BAE280)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BASESTREAM_OFFSET UNITYSDK_OFFSET(0x18BAD580)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BAUDRATE_OFFSET UNITYSDK_OFFSET(0x18BAD5C0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BREAKSTATE_OFFSET UNITYSDK_OFFSET(0x18BAD640)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BYTESTOREAD_OFFSET UNITYSDK_OFFSET(0x18BAD6C0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_BYTESTOWRITE_OFFSET UNITYSDK_OFFSET(0x18BAD700)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_CDHOLDING_OFFSET UNITYSDK_OFFSET(0x18BAD740)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_CTSHOLDING_OFFSET UNITYSDK_OFFSET(0x18BAD780)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_DATABITS_OFFSET UNITYSDK_OFFSET(0x18BAD7C0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_DISCARDNULL_OFFSET UNITYSDK_OFFSET(0x18BAD840)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_DSRHOLDING_OFFSET UNITYSDK_OFFSET(0x18BAD8C0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_DTRENABLE_OFFSET UNITYSDK_OFFSET(0x18BAD900)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_ENCODING_OFFSET UNITYSDK_OFFSET(0x18BAD980)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_HANDSHAKE_OFFSET UNITYSDK_OFFSET(0x18BADA00)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x18BADA80)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_NEWLINE_OFFSET UNITYSDK_OFFSET(0x18BADAC0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_PARITYREPLACE_OFFSET UNITYSDK_OFFSET(0x18BADBC0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_PARITY_OFFSET UNITYSDK_OFFSET(0x18BADB40)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_PORTNAME_OFFSET UNITYSDK_OFFSET(0x18BADC40)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_READBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x18BADCC0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18BADD40)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_RECEIVEDBYTESTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x18BADDC0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_RTSENABLE_OFFSET UNITYSDK_OFFSET(0x18BADE40)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_STOPBITS_OFFSET UNITYSDK_OFFSET(0x18BADEC0)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_WRITEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x18BADF40)
#define SYSTEM_IO_PORTS_SERIALPORT_GET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x18BADFC0)
#define SYSTEM_IO_PORTS_SERIALPORT_OPEN_OFFSET UNITYSDK_OFFSET(0x18BAE2C0)
#define SYSTEM_IO_PORTS_SERIALPORT_READBYTE_OFFSET UNITYSDK_OFFSET(0x18BAE380)
#define SYSTEM_IO_PORTS_SERIALPORT_READCHAR_OFFSET UNITYSDK_OFFSET(0x18BAE3C0)
#define SYSTEM_IO_PORTS_SERIALPORT_READEXISTING_OFFSET UNITYSDK_OFFSET(0x18BAE400)
#define SYSTEM_IO_PORTS_SERIALPORT_READLINE_OFFSET UNITYSDK_OFFSET(0x18BAE440)
#define SYSTEM_IO_PORTS_SERIALPORT_READTO_OFFSET UNITYSDK_OFFSET(0x18BAE480)
#define SYSTEM_IO_PORTS_SERIALPORT_READ_1_OFFSET UNITYSDK_OFFSET(0x18BAE340)
#define SYSTEM_IO_PORTS_SERIALPORT_READ_OFFSET UNITYSDK_OFFSET(0x18BAE300)
#define SYSTEM_IO_PORTS_SERIALPORT_REMOVE_DATARECEIVED_OFFSET UNITYSDK_OFFSET(0x18BAE080)
#define SYSTEM_IO_PORTS_SERIALPORT_REMOVE_ERRORRECEIVED_OFFSET UNITYSDK_OFFSET(0x18BAE100)
#define SYSTEM_IO_PORTS_SERIALPORT_REMOVE_PINCHANGED_OFFSET UNITYSDK_OFFSET(0x18BAE180)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_BAUDRATE_OFFSET UNITYSDK_OFFSET(0x18BAD600)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_BREAKSTATE_OFFSET UNITYSDK_OFFSET(0x18BAD680)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_DATABITS_OFFSET UNITYSDK_OFFSET(0x18BAD800)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_DISCARDNULL_OFFSET UNITYSDK_OFFSET(0x18BAD880)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_DTRENABLE_OFFSET UNITYSDK_OFFSET(0x18BAD940)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_ENCODING_OFFSET UNITYSDK_OFFSET(0x18BAD9C0)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_HANDSHAKE_OFFSET UNITYSDK_OFFSET(0x18BADA40)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_NEWLINE_OFFSET UNITYSDK_OFFSET(0x18BADB00)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_PARITYREPLACE_OFFSET UNITYSDK_OFFSET(0x18BADC00)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_PARITY_OFFSET UNITYSDK_OFFSET(0x18BADB80)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_PORTNAME_OFFSET UNITYSDK_OFFSET(0x18BADC80)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_READBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x18BADD00)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18BADD80)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_RECEIVEDBYTESTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x18BADE00)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_RTSENABLE_OFFSET UNITYSDK_OFFSET(0x18BADE80)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_STOPBITS_OFFSET UNITYSDK_OFFSET(0x18BADF00)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_WRITEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x18BADF80)
#define SYSTEM_IO_PORTS_SERIALPORT_SET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x18BAE000)
#define SYSTEM_IO_PORTS_SERIALPORT_WRITELINE_OFFSET UNITYSDK_OFFSET(0x18BAE580)
#define SYSTEM_IO_PORTS_SERIALPORT_WRITE_1_OFFSET UNITYSDK_OFFSET(0x18BAE500)
#define SYSTEM_IO_PORTS_SERIALPORT_WRITE_2_OFFSET UNITYSDK_OFFSET(0x18BAE540)
#define SYSTEM_IO_PORTS_SERIALPORT_WRITE_OFFSET UNITYSDK_OFFSET(0x18BAE4C0)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18BAD400)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18BAD440)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18BAD480)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18BAD4C0)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_5_OFFSET UNITYSDK_OFFSET(0x18BAD500)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_6_OFFSET UNITYSDK_OFFSET(0x18BAD540)
#define SYSTEM_IO_PORTS_SERIALPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAD3C0)
