...
#define SYSTEM_IO_PORTS_SERIALPINCHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x191BA420)
#define SYSTEM_IO_PORTS_SERIALPINCHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x191BA460)
#define SYSTEM_IO_PORTS_SERIALPINCHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x191BA3E0)
#define SYSTEM_IO_PORTS_SERIALPINCHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x191BA3A0)
