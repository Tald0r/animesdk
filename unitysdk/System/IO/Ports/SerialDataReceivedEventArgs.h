...
#define SYSTEM_IO_PORTS_SERIALDATARECEIVEDEVENTARGS_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x187D4280)
#define SYSTEM_IO_PORTS_SERIALDATARECEIVEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x187D4240)
