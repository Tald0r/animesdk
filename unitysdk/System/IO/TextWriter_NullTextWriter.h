...
#define SYSTEM_IO_TEXTWRITER_NULLTEXTWRITER_GET_ENCODING_OFFSET UNITYSDK_OFFSET(0x19DCFC50)
#define SYSTEM_IO_TEXTWRITER_NULLTEXTWRITER_WRITELINE_1_OFFSET UNITYSDK_OFFSET(0x19DCFD00)
#define SYSTEM_IO_TEXTWRITER_NULLTEXTWRITER_WRITELINE_2_OFFSET UNITYSDK_OFFSET(0x19DCFD10)
#define SYSTEM_IO_TEXTWRITER_NULLTEXTWRITER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x19DCFCF0)
#define SYSTEM_IO_TEXTWRITER_NULLTEXTWRITER_WRITE_1_OFFSET UNITYSDK_OFFSET(0x19DCFCE0)
#define SYSTEM_IO_TEXTWRITER_NULLTEXTWRITER_WRITE_OFFSET UNITYSDK_OFFSET(0x19DCFCD0)
#define SYSTEM_IO_TEXTWRITER_NULLTEXTWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DCFC10)
