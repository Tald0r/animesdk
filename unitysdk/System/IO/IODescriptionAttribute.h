...
#define SYSTEM_IO_IODESCRIPTIONATTRIBUTE_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1905A130)
#define SYSTEM_IO_IODESCRIPTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1905A0D0)
