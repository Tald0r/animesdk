...
#define SYSTEM_IO_FILESYSTEMEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D27310)
#define SYSTEM_IO_FILESYSTEMEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D27350)
#define SYSTEM_IO_FILESYSTEMEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D26D90)
#define SYSTEM_IO_FILESYSTEMEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D26D70)
