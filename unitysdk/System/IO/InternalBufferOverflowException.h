...
#define SYSTEM_IO_INTERNALBUFFEROVERFLOWEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1909D3A0)
#define SYSTEM_IO_INTERNALBUFFEROVERFLOWEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1909D410)
#define SYSTEM_IO_INTERNALBUFFEROVERFLOWEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1909D460)
#define SYSTEM_IO_INTERNALBUFFEROVERFLOWEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1909D300)
