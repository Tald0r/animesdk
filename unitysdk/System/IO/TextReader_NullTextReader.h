...
#define SYSTEM_IO_TEXTREADER_NULLTEXTREADER_READLINE_OFFSET UNITYSDK_OFFSET(0x19CC32B0)
#define SYSTEM_IO_TEXTREADER_NULLTEXTREADER_READ_OFFSET UNITYSDK_OFFSET(0x19CC32A0)
#define SYSTEM_IO_TEXTREADER_NULLTEXTREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC3280)
