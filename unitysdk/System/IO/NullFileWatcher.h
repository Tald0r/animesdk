...
#define SYSTEM_IO_NULLFILEWATCHER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x182DB5A0)
#define SYSTEM_IO_NULLFILEWATCHER_STARTDISPATCHING_OFFSET UNITYSDK_OFFSET(0x182DB580)
#define SYSTEM_IO_NULLFILEWATCHER_STOPDISPATCHING_OFFSET UNITYSDK_OFFSET(0x182DB590)
#define SYSTEM_IO_NULLFILEWATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x182DB620)
