...
#define SYSTEM_IO_NULLFILEWATCHER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x188F02B0)
#define SYSTEM_IO_NULLFILEWATCHER_STARTDISPATCHING_OFFSET UNITYSDK_OFFSET(0x188F0290)
#define SYSTEM_IO_NULLFILEWATCHER_STOPDISPATCHING_OFFSET UNITYSDK_OFFSET(0x188F02A0)
#define SYSTEM_IO_NULLFILEWATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x188F0330)
