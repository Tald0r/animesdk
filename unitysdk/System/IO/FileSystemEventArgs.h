...
#define SYSTEM_IO_FILESYSTEMEVENTARGS_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x18FDFE30)
#define SYSTEM_IO_FILESYSTEMEVENTARGS_GET_FULLPATH_OFFSET UNITYSDK_OFFSET(0x18FDFE40)
#define SYSTEM_IO_FILESYSTEMEVENTARGS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18FDFE50)
#define SYSTEM_IO_FILESYSTEMEVENTARGS_SETNAME_OFFSET UNITYSDK_OFFSET(0x18FDFE20)
#define SYSTEM_IO_FILESYSTEMEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDFDE0)
