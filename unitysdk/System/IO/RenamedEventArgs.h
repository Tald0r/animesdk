...
#define SYSTEM_IO_RENAMEDEVENTARGS_GET_OLDFULLPATH_OFFSET UNITYSDK_OFFSET(0x19459CF0)
#define SYSTEM_IO_RENAMEDEVENTARGS_GET_OLDNAME_OFFSET UNITYSDK_OFFSET(0x19459D00)
#define SYSTEM_IO_RENAMEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19459C90)
