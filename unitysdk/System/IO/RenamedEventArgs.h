...
#define SYSTEM_IO_RENAMEDEVENTARGS_GET_OLDFULLPATH_OFFSET UNITYSDK_OFFSET(0x1909D530)
#define SYSTEM_IO_RENAMEDEVENTARGS_GET_OLDNAME_OFFSET UNITYSDK_OFFSET(0x1909D540)
#define SYSTEM_IO_RENAMEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1909D4D0)
