...
#define SYSTEM_IO_PINNEDBUFFERMEMORYSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19DCF660)
#define SYSTEM_IO_PINNEDBUFFERMEMORYSTREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19DCF5A0)
#define SYSTEM_IO_PINNEDBUFFERMEMORYSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19DCF490)
#define SYSTEM_IO_PINNEDBUFFERMEMORYSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19DCF450)
