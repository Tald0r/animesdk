...
#define SYSTEM_IO_ERROREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D71690)
#define SYSTEM_IO_ERROREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D716D0)
#define SYSTEM_IO_ERROREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D71110)
#define SYSTEM_IO_ERROREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D71100)
