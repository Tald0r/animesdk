...
#define SYSTEM_IO_ERROREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x191BA350)
#define SYSTEM_IO_ERROREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x191BA390)
#define SYSTEM_IO_ERROREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x191B9DD0)
#define SYSTEM_IO_ERROREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x191B9DB0)
