...
#define SYSTEM_IO_TEXTWRITER_CLOSE_OFFSET UNITYSDK_OFFSET(0x19CC3590)
#define SYSTEM_IO_TEXTWRITER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19CC35F0)
#define SYSTEM_IO_TEXTWRITER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19CC35E0)
#define SYSTEM_IO_TEXTWRITER_FLUSH_OFFSET UNITYSDK_OFFSET(0x19CC3640)
#define SYSTEM_IO_TEXTWRITER_GET_FORMATPROVIDER_OFFSET UNITYSDK_OFFSET(0x19CC3500)
#define SYSTEM_IO_TEXTWRITER_GET_INITIALNEWLINE_OFFSET UNITYSDK_OFFSET(0x19CC32C0)
#define SYSTEM_IO_TEXTWRITER_GET_NEWLINE_OFFSET UNITYSDK_OFFSET(0x19CC3650)
#define SYSTEM_IO_TEXTWRITER_SET_NEWLINE_OFFSET UNITYSDK_OFFSET(0x19CC3700)
#define SYSTEM_IO_TEXTWRITER_SYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19CC37F0)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_10_OFFSET UNITYSDK_OFFSET(0x19CC4210)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_11_OFFSET UNITYSDK_OFFSET(0x19CC43F0)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_12_OFFSET UNITYSDK_OFFSET(0x19CC4520)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_13_OFFSET UNITYSDK_OFFSET(0x19CC4590)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_14_OFFSET UNITYSDK_OFFSET(0x19CC4610)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_1_OFFSET UNITYSDK_OFFSET(0x19CC4050)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_2_OFFSET UNITYSDK_OFFSET(0x19CC4080)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_3_OFFSET UNITYSDK_OFFSET(0x19CC40B0)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_4_OFFSET UNITYSDK_OFFSET(0x19CC40F0)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_5_OFFSET UNITYSDK_OFFSET(0x19CC4120)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_6_OFFSET UNITYSDK_OFFSET(0x19CC4150)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_7_OFFSET UNITYSDK_OFFSET(0x19CC4180)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_8_OFFSET UNITYSDK_OFFSET(0x19CC41B0)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_9_OFFSET UNITYSDK_OFFSET(0x19CC41E0)
#define SYSTEM_IO_TEXTWRITER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x19CC4030)
#define SYSTEM_IO_TEXTWRITER_WRITE_10_OFFSET UNITYSDK_OFFSET(0x19CC3CD0)
#define SYSTEM_IO_TEXTWRITER_WRITE_11_OFFSET UNITYSDK_OFFSET(0x19CC3DF0)
#define SYSTEM_IO_TEXTWRITER_WRITE_12_OFFSET UNITYSDK_OFFSET(0x19CC3E60)
#define SYSTEM_IO_TEXTWRITER_WRITE_13_OFFSET UNITYSDK_OFFSET(0x19CC3EE0)
#define SYSTEM_IO_TEXTWRITER_WRITE_14_OFFSET UNITYSDK_OFFSET(0x19CC3F60)
#define SYSTEM_IO_TEXTWRITER_WRITE_1_OFFSET UNITYSDK_OFFSET(0x19CC38C0)
#define SYSTEM_IO_TEXTWRITER_WRITE_2_OFFSET UNITYSDK_OFFSET(0x19CC38F0)
#define SYSTEM_IO_TEXTWRITER_WRITE_3_OFFSET UNITYSDK_OFFSET(0x19CC3A70)
#define SYSTEM_IO_TEXTWRITER_WRITE_4_OFFSET UNITYSDK_OFFSET(0x19CC3AB0)
#define SYSTEM_IO_TEXTWRITER_WRITE_5_OFFSET UNITYSDK_OFFSET(0x19CC3B00)
#define SYSTEM_IO_TEXTWRITER_WRITE_6_OFFSET UNITYSDK_OFFSET(0x19CC3B50)
#define SYSTEM_IO_TEXTWRITER_WRITE_7_OFFSET UNITYSDK_OFFSET(0x19CC3BA0)
#define SYSTEM_IO_TEXTWRITER_WRITE_8_OFFSET UNITYSDK_OFFSET(0x19CC3BF0)
#define SYSTEM_IO_TEXTWRITER_WRITE_9_OFFSET UNITYSDK_OFFSET(0x19CC3C40)
#define SYSTEM_IO_TEXTWRITER_WRITE_OFFSET UNITYSDK_OFFSET(0x19CC38B0)
#define SYSTEM_IO_TEXTWRITER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19CC46E0)
#define SYSTEM_IO_TEXTWRITER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19CC3410)
#define SYSTEM_IO_TEXTWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC3320)
...
namespace System::IO
{
	...
	public:
		...
		{
			return (::System::IO::TextWriter**)Il2CppClass::FromTypeDefinitionIndex(TextWriter_TypeDefinitionIndex)->GetStaticField(0x1200);
		}
