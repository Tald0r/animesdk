...
#define SYSTEM_PARAMETERIZEDSTRINGS_ASBOOL_OFFSET UNITYSDK_OFFSET(0x18609390)
#define SYSTEM_PARAMETERIZEDSTRINGS_ASINT_OFFSET UNITYSDK_OFFSET(0x18609380)
#define SYSTEM_PARAMETERIZEDSTRINGS_EVALUATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x18607F40)
#define SYSTEM_PARAMETERIZEDSTRINGS_EVALUATE_OFFSET UNITYSDK_OFFSET(0x18607D70)
#define SYSTEM_PARAMETERIZEDSTRINGS_FORMATPRINTF_OFFSET UNITYSDK_OFFSET(0x18608E10)
#define SYSTEM_PARAMETERIZEDSTRINGS_GETDYNAMICORSTATICVARIABLES_OFFSET UNITYSDK_OFFSET(0x186092B0)
#define SYSTEM_PARAMETERIZEDSTRINGS_SNPRINTF_1_OFFSET UNITYSDK_OFFSET(0x186095D0)
#define SYSTEM_PARAMETERIZEDSTRINGS_SNPRINTF_OFFSET UNITYSDK_OFFSET(0x18609500)
#define SYSTEM_PARAMETERIZEDSTRINGS_STRINGFROMASCIIBYTES_OFFSET UNITYSDK_OFFSET(0x186093A0)
