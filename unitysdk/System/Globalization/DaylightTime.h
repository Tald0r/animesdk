...
#define SYSTEM_GLOBALIZATION_DAYLIGHTTIME_GET_DELTA_OFFSET UNITYSDK_OFFSET(0x18EC50F0)
#define SYSTEM_GLOBALIZATION_DAYLIGHTTIME_GET_END_OFFSET UNITYSDK_OFFSET(0x18EC50E0)
#define SYSTEM_GLOBALIZATION_DAYLIGHTTIME_GET_START_OFFSET UNITYSDK_OFFSET(0x18EC50D0)
#define SYSTEM_GLOBALIZATION_DAYLIGHTTIME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18EC50C0)
#define SYSTEM_GLOBALIZATION_DAYLIGHTTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x18EC50B0)
