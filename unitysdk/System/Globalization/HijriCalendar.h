...
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x17FCCDE0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x17FCD070)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_CHECKERARANGE_OFFSET UNITYSDK_OFFSET(0x17FCC0D0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_CHECKTICKSRANGE_OFFSET UNITYSDK_OFFSET(0x17FCBF90)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_CHECKYEARMONTHRANGE_OFFSET UNITYSDK_OFFSET(0x17FCC2E0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_CHECKYEARRANGE_OFFSET UNITYSDK_OFFSET(0x17FCC160)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_DAYSUPTOHIJRIYEAR_OFFSET UNITYSDK_OFFSET(0x17FCBC60)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETABSOLUTEDATEHIJRI_OFFSET UNITYSDK_OFFSET(0x17FCBA80)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETADVANCEHIJRIDATE_OFFSET UNITYSDK_OFFSET(0x17FCBF80)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETDATEPART_OFFSET UNITYSDK_OFFSET(0x17FCC420)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x17FCD080)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x17FCD0B0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x17FCD100)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x17FCD130)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x17FCCCD0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x17FCD250)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x17FCD5A0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x17FCD380)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x17FCD350)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x17FCD3F0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x17FCBA40)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x17FCBA70)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x17FCD2C0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_HIJRIADJUSTMENT_OFFSET UNITYSDK_OFFSET(0x17FCBD90)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x17FCBA60)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x17FCB9E0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x17FCB980)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x17FCD830)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x17FCD410)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x17FCD600)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x17FCBDB0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_SET_HIJRIADJUSTMENT_OFFSET UNITYSDK_OFFSET(0x17FCBE50)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x17FCD870)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x17FCD670)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x17FCD9A0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x17FCDAC0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x17FCBA50)
