...
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x186007B0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x18600A40)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_CHECKERARANGE_OFFSET UNITYSDK_OFFSET(0x185FFAA0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_CHECKTICKSRANGE_OFFSET UNITYSDK_OFFSET(0x185FF960)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_CHECKYEARMONTHRANGE_OFFSET UNITYSDK_OFFSET(0x185FFCB0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_CHECKYEARRANGE_OFFSET UNITYSDK_OFFSET(0x185FFB30)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_DAYSUPTOHIJRIYEAR_OFFSET UNITYSDK_OFFSET(0x185FF630)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETABSOLUTEDATEHIJRI_OFFSET UNITYSDK_OFFSET(0x185FF450)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETADVANCEHIJRIDATE_OFFSET UNITYSDK_OFFSET(0x185FF950)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETDATEPART_OFFSET UNITYSDK_OFFSET(0x185FFDF0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x18600A50)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x18600A80)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x18600AD0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x18600B00)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x186006A0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x18600C20)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x18600F70)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x18600D50)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x18600D20)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x18600DC0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x185FF410)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x185FF440)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x18600C90)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_HIJRIADJUSTMENT_OFFSET UNITYSDK_OFFSET(0x185FF760)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x185FF430)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x185FF3B0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x185FF350)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x18601200)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x18600DE0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x18600FD0)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x185FF780)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_SET_HIJRIADJUSTMENT_OFFSET UNITYSDK_OFFSET(0x185FF820)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x18601240)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x18601040)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x18601370)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x18601490)
#define SYSTEM_GLOBALIZATION_HIJRICALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x185FF420)
