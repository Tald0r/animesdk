...
#define SYSTEM_GLOBALIZATION_IDNMAPPING_CONVERT_OFFSET UNITYSDK_OFFSET(0x18EC76E0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_EQUALS_OFFSET UNITYSDK_OFFSET(0x18EC7400)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETASCII_1_OFFSET UNITYSDK_OFFSET(0x18EC7660)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETASCII_2_OFFSET UNITYSDK_OFFSET(0x18EC7560)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETASCII_OFFSET UNITYSDK_OFFSET(0x18EC7480)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18EC7470)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETUNICODE_1_OFFSET UNITYSDK_OFFSET(0x18EC8650)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETUNICODE_2_OFFSET UNITYSDK_OFFSET(0x18EC8550)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETUNICODE_OFFSET UNITYSDK_OFFSET(0x18EC8470)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GET_ALLOWUNASSIGNED_OFFSET UNITYSDK_OFFSET(0x18EC73C0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GET_USESTD3ASCIIRULES_OFFSET UNITYSDK_OFFSET(0x18EC73E0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_NAMEPREP_OFFSET UNITYSDK_OFFSET(0x18EC7DC0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_SET_ALLOWUNASSIGNED_OFFSET UNITYSDK_OFFSET(0x18EC73D0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_SET_USESTD3ASCIIRULES_OFFSET UNITYSDK_OFFSET(0x18EC73F0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_TOASCII_OFFSET UNITYSDK_OFFSET(0x18EC79D0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_TOUNICODE_OFFSET UNITYSDK_OFFSET(0x18EC7BD0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_VERIFYLENGTH_OFFSET UNITYSDK_OFFSET(0x18EC8100)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_VERIFYPROHIBITEDCHARACTERS_OFFSET UNITYSDK_OFFSET(0x18EC81F0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_VERIFYSTD3ASCIIRULES_OFFSET UNITYSDK_OFFSET(0x18EC7F40)
#define SYSTEM_GLOBALIZATION_IDNMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x18EC7360)
