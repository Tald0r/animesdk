...
#define SYSTEM_GLOBALIZATION_IDNMAPPING_CONVERT_OFFSET UNITYSDK_OFFSET(0x1897FC10)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_EQUALS_OFFSET UNITYSDK_OFFSET(0x1897F930)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETASCII_1_OFFSET UNITYSDK_OFFSET(0x1897FB90)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETASCII_2_OFFSET UNITYSDK_OFFSET(0x1897FA90)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETASCII_OFFSET UNITYSDK_OFFSET(0x1897F9B0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1897F9A0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETUNICODE_1_OFFSET UNITYSDK_OFFSET(0x18980B80)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETUNICODE_2_OFFSET UNITYSDK_OFFSET(0x18980A80)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GETUNICODE_OFFSET UNITYSDK_OFFSET(0x189809A0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GET_ALLOWUNASSIGNED_OFFSET UNITYSDK_OFFSET(0x1897F8F0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_GET_USESTD3ASCIIRULES_OFFSET UNITYSDK_OFFSET(0x1897F910)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_NAMEPREP_OFFSET UNITYSDK_OFFSET(0x189802F0)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_SET_ALLOWUNASSIGNED_OFFSET UNITYSDK_OFFSET(0x1897F900)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_SET_USESTD3ASCIIRULES_OFFSET UNITYSDK_OFFSET(0x1897F920)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_TOASCII_OFFSET UNITYSDK_OFFSET(0x1897FF00)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_TOUNICODE_OFFSET UNITYSDK_OFFSET(0x18980100)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_VERIFYLENGTH_OFFSET UNITYSDK_OFFSET(0x18980630)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_VERIFYPROHIBITEDCHARACTERS_OFFSET UNITYSDK_OFFSET(0x18980720)
#define SYSTEM_GLOBALIZATION_IDNMAPPING_VERIFYSTD3ASCIIRULES_OFFSET UNITYSDK_OFFSET(0x18980470)
#define SYSTEM_GLOBALIZATION_IDNMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1897F890)
