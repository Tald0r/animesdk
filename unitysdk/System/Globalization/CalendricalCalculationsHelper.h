...
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_ABERRATION_OFFSET UNITYSDK_OFFSET(0x19DCE050)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_ANGLE_OFFSET UNITYSDK_OFFSET(0x19DC8CA0)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_ASDAYFRACTION_OFFSET UNITYSDK_OFFSET(0x19DC91E0)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_ASLOCALTIME_OFFSET UNITYSDK_OFFSET(0x19DCAA60)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_ASSEASON_OFFSET UNITYSDK_OFFSET(0x19DCE810)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_CENTURIESFROM1900_OFFSET UNITYSDK_OFFSET(0x19DC91F0)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_COMPUTE_OFFSET UNITYSDK_OFFSET(0x19DCE4F0)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_COPYSIGN_OFFSET UNITYSDK_OFFSET(0x19DC9F80)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_COSOFDEGREE_OFFSET UNITYSDK_OFFSET(0x19DC8BC0)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_DEFAULTEPHEMERISCORRECTION_OFFSET UNITYSDK_OFFSET(0x19DC9280)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_EPHEMERISCORRECTION1620TO1699_OFFSET UNITYSDK_OFFSET(0x19DC98F0)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_EPHEMERISCORRECTION1700TO1799_OFFSET UNITYSDK_OFFSET(0x19DC9760)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_EPHEMERISCORRECTION1800TO1899_OFFSET UNITYSDK_OFFSET(0x19DC9560)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_EPHEMERISCORRECTION1900TO1987_OFFSET UNITYSDK_OFFSET(0x19DC9360)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_EPHEMERISCORRECTION1988TO2019_OFFSET UNITYSDK_OFFSET(0x19DC9340)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_EPHEMERISCORRECTION_OFFSET UNITYSDK_OFFSET(0x19DC9A80)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_EQUATIONOFTIME_OFFSET UNITYSDK_OFFSET(0x19DCA0C0)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_ESTIMATEPRIOR_OFFSET UNITYSDK_OFFSET(0x19DCE840)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_GETGREGORIANYEAR_OFFSET UNITYSDK_OFFSET(0x19DC8FB0)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_GETNUMBEROFDAYS_OFFSET UNITYSDK_OFFSET(0x19DC8F80)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_INITLONGITUDE_OFFSET UNITYSDK_OFFSET(0x19DCABE0)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_ISNEGATIVE_OFFSET UNITYSDK_OFFSET(0x19DC9F00)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_JULIANCENTURIES_OFFSET UNITYSDK_OFFSET(0x19DC9E80)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_MIDDAYATPERSIANOBSERVATIONSITE_OFFSET UNITYSDK_OFFSET(0x19DCAD00)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_MIDDAY_OFFSET UNITYSDK_OFFSET(0x19DCAAF0)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_NORMALIZELONGITUDE_OFFSET UNITYSDK_OFFSET(0x19DC9140)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_NUTATION_OFFSET UNITYSDK_OFFSET(0x19DCE150)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_OBLIQUITY_OFFSET UNITYSDK_OFFSET(0x19DC8CD0)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_PERIODICTERM_OFFSET UNITYSDK_OFFSET(0x19DCAF00)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_PERSIANNEWYEARONORBEFORE_OFFSET UNITYSDK_OFFSET(0x19DCEB50)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_POLYNOMIALSUM_OFFSET UNITYSDK_OFFSET(0x19DC8E60)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_RADIANSFROMDEGREES_OFFSET UNITYSDK_OFFSET(0x19DC8B30)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_REMINDER_OFFSET UNITYSDK_OFFSET(0x19DC9100)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_SINOFDEGREE_OFFSET UNITYSDK_OFFSET(0x19DC8B50)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_SUMLONGSEQUENCEOFPERIODICTERMS_OFFSET UNITYSDK_OFFSET(0x19DCB010)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER_TANOFDEGREE_OFFSET UNITYSDK_OFFSET(0x19DC8C30)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DCED00)
#define SYSTEM_GLOBALIZATION_CALENDRICALCALCULATIONSHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DCECF0)
...
namespace System::Globalization
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Globalization::CalendricalCalculationsHelper_EphemerisCorrectionAlgorithmMap>**)Il2CppClass::FromTypeDefinitionIndex(CalendricalCalculationsHelper_TypeDefinitionIndex)->GetStaticField(0x1378);
		}
