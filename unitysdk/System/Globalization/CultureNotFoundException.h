...
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x195A58C0)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION_GET_DEFAULTMESSAGE_OFFSET UNITYSDK_OFFSET(0x195A5330)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION_GET_FORMATEDINVALIDCULTUREID_OFFSET UNITYSDK_OFFSET(0x195A5A80)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION_GET_INVALIDCULTUREID_OFFSET UNITYSDK_OFFSET(0x195A5A60)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION_GET_INVALIDCULTURENAME_OFFSET UNITYSDK_OFFSET(0x195A5A70)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x195A5B70)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195A5370)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x195A53E0)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x195A5450)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x195A54C0)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x195A5550)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION__CTOR_6_OFFSET UNITYSDK_OFFSET(0x195A55E0)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION__CTOR_7_OFFSET UNITYSDK_OFFSET(0x195A5660)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION__CTOR_8_OFFSET UNITYSDK_OFFSET(0x195A56E0)
#define SYSTEM_GLOBALIZATION_CULTURENOTFOUNDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x195A5290)
