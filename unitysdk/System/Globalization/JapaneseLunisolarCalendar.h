...
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x18B15E40)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETGREGORIANYEAR_OFFSET UNITYSDK_OFFSET(0x18B15B20)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETYEARINFO_OFFSET UNITYSDK_OFFSET(0x18B159A0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x18B15B00)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x18B15E60)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_CALERAINFO_OFFSET UNITYSDK_OFFSET(0x18B15970)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x18B15880)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x18B15E80)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x18B15E70)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MAXCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x18B158A0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x18B15910)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x18B15820)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MINCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x18B15890)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MINDATE_OFFSET UNITYSDK_OFFSET(0x18B158B0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x18B157C0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_TRIMERAS_OFFSET UNITYSDK_OFFSET(0x18B15B40)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x18B15EA0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x18B15CF0)
