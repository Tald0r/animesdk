...
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x19000790)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETGREGORIANYEAR_OFFSET UNITYSDK_OFFSET(0x19000470)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETYEARINFO_OFFSET UNITYSDK_OFFSET(0x190002F0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x19000450)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x190007B0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_CALERAINFO_OFFSET UNITYSDK_OFFSET(0x190002C0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x190001D0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x190007D0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x190007C0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MAXCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x190001F0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x19000260)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x19000170)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MINCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x190001E0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MINDATE_OFFSET UNITYSDK_OFFSET(0x19000200)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x19000110)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR_TRIMERAS_OFFSET UNITYSDK_OFFSET(0x19000490)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x190007F0)
#define SYSTEM_GLOBALIZATION_JAPANESELUNISOLARCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x19000640)
