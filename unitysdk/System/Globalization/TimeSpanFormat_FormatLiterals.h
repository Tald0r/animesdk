...
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_DAYHOURSEP_OFFSET UNITYSDK_OFFSET(0x879620)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_END_OFFSET UNITYSDK_OFFSET(0x879720)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_HOURMINUTESEP_OFFSET UNITYSDK_OFFSET(0x879660)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_MINUTESECONDSEP_OFFSET UNITYSDK_OFFSET(0x8796A0)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_SECONDFRACTIONSEP_OFFSET UNITYSDK_OFFSET(0x8796E0)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_GET_START_OFFSET UNITYSDK_OFFSET(0x8795E0)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_INITINVARIANT_OFFSET UNITYSDK_OFFSET(0x1913A6F0)
#define SYSTEM_GLOBALIZATION_TIMESPANFORMAT_FORMATLITERALS_INIT_OFFSET UNITYSDK_OFFSET(0x879760)
