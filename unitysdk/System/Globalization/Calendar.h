...
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDDAYS_OFFSET UNITYSDK_OFFSET(0x1858A250)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDHOURS_OFFSET UNITYSDK_OFFSET(0x1858A260)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x1858A240)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDMINUTES_OFFSET UNITYSDK_OFFSET(0x1858A270)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDSECONDS_OFFSET UNITYSDK_OFFSET(0x1858A280)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDWEEKS_OFFSET UNITYSDK_OFFSET(0x1858A290)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADD_OFFSET UNITYSDK_OFFSET(0x1858A0F0)
#define SYSTEM_GLOBALIZATION_CALENDAR_CHECKADDRESULT_OFFSET UNITYSDK_OFFSET(0x18589FD0)
#define SYSTEM_GLOBALIZATION_CALENDAR_CLONE_OFFSET UNITYSDK_OFFSET(0x18589CC0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x1858A2B0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x1858A2D0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETFIRSTDAYWEEKOFYEAR_OFFSET UNITYSDK_OFFSET(0x1858A420)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETHOUR_OFFSET UNITYSDK_OFFSET(0x1858A2F0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETLEAPMONTH_1_OFFSET UNITYSDK_OFFSET(0x1858AC70)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1858AC50)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x1858A330)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETMINUTE_OFFSET UNITYSDK_OFFSET(0x1858A380)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x1858A3C0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETSECOND_OFFSET UNITYSDK_OFFSET(0x1858A3E0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETSYSTEMTWODIGITYEARSETTING_OFFSET UNITYSDK_OFFSET(0x1858B2D0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETWEEKOFYEARFULLDAYS_OFFSET UNITYSDK_OFFSET(0x1858A4F0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETWEEKOFYEAROFMINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1858A7A0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETWEEKOFYEAR_OFFSET UNITYSDK_OFFSET(0x1858A920)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x18589CA0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x18589C90)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_CURRENTERAVALUE_OFFSET UNITYSDK_OFFSET(0x18589F60)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x1858A910)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x18589C80)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x18589CB0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x18589C60)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x18589C50)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1858AFB0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x1858AC00)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1858AC30)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x1858AD10)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISVALIDDAY_OFFSET UNITYSDK_OFFSET(0x1858AF40)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISVALIDMONTH_OFFSET UNITYSDK_OFFSET(0x1858AEE0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISVALIDYEAR_OFFSET UNITYSDK_OFFSET(0x1858AE80)
#define SYSTEM_GLOBALIZATION_CALENDAR_READONLY_OFFSET UNITYSDK_OFFSET(0x18589DA0)
#define SYSTEM_GLOBALIZATION_CALENDAR_SETREADONLYSTATE_OFFSET UNITYSDK_OFFSET(0x18589F50)
#define SYSTEM_GLOBALIZATION_CALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1858AFC0)
#define SYSTEM_GLOBALIZATION_CALENDAR_TIMETOTICKS_OFFSET UNITYSDK_OFFSET(0x1858B110)
#define SYSTEM_GLOBALIZATION_CALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x1858AD30)
#define SYSTEM_GLOBALIZATION_CALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x1858B030)
#define SYSTEM_GLOBALIZATION_CALENDAR_TRYTODATETIME_OFFSET UNITYSDK_OFFSET(0x1858AD90)
#define SYSTEM_GLOBALIZATION_CALENDAR_VERIFYWRITABLE_OFFSET UNITYSDK_OFFSET(0x18589EE0)
#define SYSTEM_GLOBALIZATION_CALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x18589C70)
