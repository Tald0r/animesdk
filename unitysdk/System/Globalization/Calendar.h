...
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDDAYS_OFFSET UNITYSDK_OFFSET(0x17F56020)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDHOURS_OFFSET UNITYSDK_OFFSET(0x17F56030)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x17F56010)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDMINUTES_OFFSET UNITYSDK_OFFSET(0x17F56040)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDSECONDS_OFFSET UNITYSDK_OFFSET(0x17F56050)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADDWEEKS_OFFSET UNITYSDK_OFFSET(0x17F56060)
#define SYSTEM_GLOBALIZATION_CALENDAR_ADD_OFFSET UNITYSDK_OFFSET(0x17F55EC0)
#define SYSTEM_GLOBALIZATION_CALENDAR_CHECKADDRESULT_OFFSET UNITYSDK_OFFSET(0x17F55DA0)
#define SYSTEM_GLOBALIZATION_CALENDAR_CLONE_OFFSET UNITYSDK_OFFSET(0x17F55A90)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x17F56080)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x17F560A0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETFIRSTDAYWEEKOFYEAR_OFFSET UNITYSDK_OFFSET(0x17F561F0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETHOUR_OFFSET UNITYSDK_OFFSET(0x17F560C0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETLEAPMONTH_1_OFFSET UNITYSDK_OFFSET(0x17F56A40)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x17F56A20)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x17F56100)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETMINUTE_OFFSET UNITYSDK_OFFSET(0x17F56150)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x17F56190)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETSECOND_OFFSET UNITYSDK_OFFSET(0x17F561B0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETSYSTEMTWODIGITYEARSETTING_OFFSET UNITYSDK_OFFSET(0x17F570A0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETWEEKOFYEARFULLDAYS_OFFSET UNITYSDK_OFFSET(0x17F562C0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETWEEKOFYEAROFMINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x17F56570)
#define SYSTEM_GLOBALIZATION_CALENDAR_GETWEEKOFYEAR_OFFSET UNITYSDK_OFFSET(0x17F566F0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x17F55A70)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x17F55A60)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_CURRENTERAVALUE_OFFSET UNITYSDK_OFFSET(0x17F55D30)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x17F566E0)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x17F55A50)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x17F55A80)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x17F55A30)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x17F55A20)
#define SYSTEM_GLOBALIZATION_CALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x17F56D80)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x17F569D0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x17F56A00)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x17F56AE0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISVALIDDAY_OFFSET UNITYSDK_OFFSET(0x17F56D10)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISVALIDMONTH_OFFSET UNITYSDK_OFFSET(0x17F56CB0)
#define SYSTEM_GLOBALIZATION_CALENDAR_ISVALIDYEAR_OFFSET UNITYSDK_OFFSET(0x17F56C50)
#define SYSTEM_GLOBALIZATION_CALENDAR_READONLY_OFFSET UNITYSDK_OFFSET(0x17F55B70)
#define SYSTEM_GLOBALIZATION_CALENDAR_SETREADONLYSTATE_OFFSET UNITYSDK_OFFSET(0x17F55D20)
#define SYSTEM_GLOBALIZATION_CALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x17F56D90)
#define SYSTEM_GLOBALIZATION_CALENDAR_TIMETOTICKS_OFFSET UNITYSDK_OFFSET(0x17F56EE0)
#define SYSTEM_GLOBALIZATION_CALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x17F56B00)
#define SYSTEM_GLOBALIZATION_CALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x17F56E00)
#define SYSTEM_GLOBALIZATION_CALENDAR_TRYTODATETIME_OFFSET UNITYSDK_OFFSET(0x17F56B60)
#define SYSTEM_GLOBALIZATION_CALENDAR_VERIFYWRITABLE_OFFSET UNITYSDK_OFFSET(0x17F55CB0)
#define SYSTEM_GLOBALIZATION_CALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x17F55A40)
