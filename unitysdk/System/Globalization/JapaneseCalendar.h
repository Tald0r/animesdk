...
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_ABBREVERANAMES_OFFSET UNITYSDK_OFFSET(0x18DA3070)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x18DA2AD0)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x18DA2AF0)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_COMPAREERARANGES_OFFSET UNITYSDK_OFFSET(0x18DA2550)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_ENGLISHERANAMES_OFFSET UNITYSDK_OFFSET(0x18DA3160)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_ERANAMES_OFFSET UNITYSDK_OFFSET(0x18DA2F80)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x18DA2BA0)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x18DA2BE0)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x18DA2C50)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x18DA2B20)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x18DA2B40)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETDEFAULTINSTANCE_OFFSET UNITYSDK_OFFSET(0x18DA2840)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETERAFROMVALUE_OFFSET UNITYSDK_OFFSET(0x18DA2590)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETERAINFO_OFFSET UNITYSDK_OFFSET(0x18DA20F0)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETERASFROMREGISTRY_OFFSET UNITYSDK_OFFSET(0x18DA2540)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x18DA2CF0)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x18DA2DE0)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x18DA2C90)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x18DA2D10)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETWEEKOFYEAR_OFFSET UNITYSDK_OFFSET(0x18DA2CC0)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x18DA2D50)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x18DA20E0)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x18DA2F60)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x18DA2AC0)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x18DA20D0)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x18DA2090)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x18DA32F0)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x18DA2D70)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x18DA2E00)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x18DA2D90)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_ISVALIDYEAR_OFFSET UNITYSDK_OFFSET(0x18DA3250)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x18DA3330)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x18DA2E20)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x18DA2E40)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x18DA3480)
#define SYSTEM_GLOBALIZATION_JAPANESECALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x18DA2900)
...
namespace System::Globalization
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Globalization::EraInfo*>**)Il2CppClass::FromTypeDefinitionIndex(JapaneseCalendar_TypeDefinitionIndex)->GetStaticField(0x6B0);
		}
		static ::System::Globalization::Calendar** StaticGet_s_defaultInstance()
		{
			return (::System::Globalization::Calendar**)Il2CppClass::FromTypeDefinitionIndex(JapaneseCalendar_TypeDefinitionIndex)->GetStaticField(0x6B8);
		}
