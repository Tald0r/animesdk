...
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x19AD1200)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GETGREGORIANYEAR_OFFSET UNITYSDK_OFFSET(0x19AD1090)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GETYEARINFO_OFFSET UNITYSDK_OFFSET(0x19AD0F10)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x19AD1080)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x19AD1230)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_CALERAINFO_OFFSET UNITYSDK_OFFSET(0x19AD0F00)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x19AD0E10)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x19AD1240)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x19AD1220)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MAXCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x19AD0E30)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x19AD0EA0)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x19AD0DB0)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MINCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x19AD0E20)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MINDATE_OFFSET UNITYSDK_OFFSET(0x19AD0E40)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x19AD0D50)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x19AD1290)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD11A0)
