...
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x1A0BF7C0)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GETGREGORIANYEAR_OFFSET UNITYSDK_OFFSET(0x1A0BF650)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GETYEARINFO_OFFSET UNITYSDK_OFFSET(0x1A0BF4D0)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x1A0BF640)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x1A0BF7F0)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_CALERAINFO_OFFSET UNITYSDK_OFFSET(0x1A0BF4C0)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x1A0BF3D0)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x1A0BF800)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A0BF7E0)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MAXCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x1A0BF3F0)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x1A0BF460)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1A0BF370)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MINCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x1A0BF3E0)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MINDATE_OFFSET UNITYSDK_OFFSET(0x1A0BF400)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1A0BF310)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0BF850)
#define SYSTEM_GLOBALIZATION_CHINESELUNISOLARCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0BF760)
