...
#define SYSTEM_GLOBALIZATION_GLOBALIZATIONASSEMBLY_GETGLOBALIZATIONRESOURCEBYTEPTR_OFFSET UNITYSDK_OFFSET(0x19886BD0)
#define SYSTEM_GLOBALIZATION_GLOBALIZATIONASSEMBLY__CTOR_OFFSET UNITYSDK_OFFSET(0x19886C80)
