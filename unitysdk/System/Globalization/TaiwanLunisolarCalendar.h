...
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x1858BD80)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GETGREGORIANYEAR_OFFSET UNITYSDK_OFFSET(0x1858BC40)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GETYEARINFO_OFFSET UNITYSDK_OFFSET(0x1858BAB0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x1858BC20)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x1858BDA0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_CALERAINFO_OFFSET UNITYSDK_OFFSET(0x1858BA50)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x1858B960)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x1858BDC0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x1858BDB0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MAXCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x1858B980)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x1858B9F0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1858B900)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MINCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x1858B970)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MINDATE_OFFSET UNITYSDK_OFFSET(0x1858B990)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1858B8A0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1858BDE0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1858BC60)
