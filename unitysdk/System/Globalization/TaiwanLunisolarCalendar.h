...
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x17F57B50)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GETGREGORIANYEAR_OFFSET UNITYSDK_OFFSET(0x17F57A10)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GETYEARINFO_OFFSET UNITYSDK_OFFSET(0x17F57880)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x17F579F0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x17F57B70)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_CALERAINFO_OFFSET UNITYSDK_OFFSET(0x17F57820)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x17F57730)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x17F57B90)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x17F57B80)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MAXCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x17F57750)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x17F577C0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x17F576D0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MINCALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x17F57740)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MINDATE_OFFSET UNITYSDK_OFFSET(0x17F57760)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x17F57670)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x17F57BB0)
#define SYSTEM_GLOBALIZATION_TAIWANLUNISOLARCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x17F57A30)
