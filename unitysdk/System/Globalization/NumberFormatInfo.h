...
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_CHECKGROUPSIZE_OFFSET UNITYSDK_OFFSET(0x19001A40)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_CLONE_OFFSET UNITYSDK_OFFSET(0x19001770)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GETFORMAT_OFFSET UNITYSDK_OFFSET(0x19003A10)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x19001520)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x19001830)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x19001970)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x190022D0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x19001B20)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x190025A0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYPOSITIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x19002F70)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYSYMBOL_OFFSET UNITYSDK_OFFSET(0x190023E0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENTINFO_OFFSET UNITYSDK_OFFSET(0x19001670)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_DIGITSUBSTITUTION_OFFSET UNITYSDK_OFFSET(0x19003900)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_INVARIANTINFO_OFFSET UNITYSDK_OFFSET(0x190012D0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x19001A30)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NANSYMBOL_OFFSET UNITYSDK_OFFSET(0x190024C0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NATIVEDIGITS_OFFSET UNITYSDK_OFFSET(0x19003770)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NEGATIVEINFINITYSYMBOL_OFFSET UNITYSDK_OFFSET(0x19002AA0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NEGATIVESIGN_OFFSET UNITYSDK_OFFSET(0x19002B80)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x19002C60)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x19002DA0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x19002E60)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x19001DB0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x190026E0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x19003270)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x190033B0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x19003470)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x19002040)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x19002960)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTPOSITIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x19002820)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTSYMBOL_OFFSET UNITYSDK_OFFSET(0x19003590)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERMILLESYMBOL_OFFSET UNITYSDK_OFFSET(0x19003680)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_POSITIVEINFINITYSYMBOL_OFFSET UNITYSDK_OFFSET(0x190030B0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_POSITIVESIGN_OFFSET UNITYSDK_OFFSET(0x19003190)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_ONDESERIALIZED_OFFSET UNITYSDK_OFFSET(0x19000E30)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_ONDESERIALIZING_OFFSET UNITYSDK_OFFSET(0x19000E20)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_ONSERIALIZING_OFFSET UNITYSDK_OFFSET(0x19000D20)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_READONLY_OFFSET UNITYSDK_OFFSET(0x19001410)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x19001840)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x19001980)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x190022E0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x19001BF0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x190025B0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYPOSITIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x19002F80)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYSYMBOL_OFFSET UNITYSDK_OFFSET(0x190023F0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_DIGITSUBSTITUTION_OFFSET UNITYSDK_OFFSET(0x19003910)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NANSYMBOL_OFFSET UNITYSDK_OFFSET(0x190024D0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NATIVEDIGITS_OFFSET UNITYSDK_OFFSET(0x19003850)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NEGATIVEINFINITYSYMBOL_OFFSET UNITYSDK_OFFSET(0x19002AB0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NEGATIVESIGN_OFFSET UNITYSDK_OFFSET(0x19002B90)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x19002C70)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x19002DB0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x19002E70)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x19001E80)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x190026F0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x19003280)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x190033C0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x19003480)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x19002110)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x19002970)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTPOSITIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x19002830)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTSYMBOL_OFFSET UNITYSDK_OFFSET(0x190035A0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERMILLESYMBOL_OFFSET UNITYSDK_OFFSET(0x19003690)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_POSITIVEINFINITYSYMBOL_OFFSET UNITYSDK_OFFSET(0x190030C0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_POSITIVESIGN_OFFSET UNITYSDK_OFFSET(0x190031A0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VALIDATEPARSESTYLEFLOATINGPOINT_OFFSET UNITYSDK_OFFSET(0x19003AF0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VALIDATEPARSESTYLEINTEGER_OFFSET UNITYSDK_OFFSET(0x19003A60)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x19000E40)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYDIGITSUBSTITUTION_OFFSET UNITYSDK_OFFSET(0x190011F0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x19000EF0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYNATIVEDIGITS_OFFSET UNITYSDK_OFFSET(0x19000F60)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYWRITABLE_OFFSET UNITYSDK_OFFSET(0x19001260)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19000980)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19000970)
