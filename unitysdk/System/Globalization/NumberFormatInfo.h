...
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_CHECKGROUPSIZE_OFFSET UNITYSDK_OFFSET(0x18B170F0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_CLONE_OFFSET UNITYSDK_OFFSET(0x18B16E20)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GETFORMAT_OFFSET UNITYSDK_OFFSET(0x18B190C0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x18B16BD0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x18B16EE0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B17020)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B17980)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x18B171D0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x18B17C50)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYPOSITIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x18B18620)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENCYSYMBOL_OFFSET UNITYSDK_OFFSET(0x18B17A90)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_CURRENTINFO_OFFSET UNITYSDK_OFFSET(0x18B16D20)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_DIGITSUBSTITUTION_OFFSET UNITYSDK_OFFSET(0x18B18FB0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_INVARIANTINFO_OFFSET UNITYSDK_OFFSET(0x18B16980)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x18B170E0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NANSYMBOL_OFFSET UNITYSDK_OFFSET(0x18B17B70)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NATIVEDIGITS_OFFSET UNITYSDK_OFFSET(0x18B18E20)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NEGATIVEINFINITYSYMBOL_OFFSET UNITYSDK_OFFSET(0x18B18150)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NEGATIVESIGN_OFFSET UNITYSDK_OFFSET(0x18B18230)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x18B18310)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B18450)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B18510)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x18B17460)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_NUMBERNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x18B17D90)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x18B18920)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B18A60)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B18B20)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x18B176F0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x18B18010)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTPOSITIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x18B17ED0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERCENTSYMBOL_OFFSET UNITYSDK_OFFSET(0x18B18C40)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_PERMILLESYMBOL_OFFSET UNITYSDK_OFFSET(0x18B18D30)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_POSITIVEINFINITYSYMBOL_OFFSET UNITYSDK_OFFSET(0x18B18760)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_GET_POSITIVESIGN_OFFSET UNITYSDK_OFFSET(0x18B18840)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_ONDESERIALIZED_OFFSET UNITYSDK_OFFSET(0x18B164E0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_ONDESERIALIZING_OFFSET UNITYSDK_OFFSET(0x18B164D0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_ONSERIALIZING_OFFSET UNITYSDK_OFFSET(0x18B163D0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_READONLY_OFFSET UNITYSDK_OFFSET(0x18B16AC0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x18B16EF0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B17030)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B17990)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x18B172A0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x18B17C60)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYPOSITIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x18B18630)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_CURRENCYSYMBOL_OFFSET UNITYSDK_OFFSET(0x18B17AA0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_DIGITSUBSTITUTION_OFFSET UNITYSDK_OFFSET(0x18B18FC0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NANSYMBOL_OFFSET UNITYSDK_OFFSET(0x18B17B80)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NATIVEDIGITS_OFFSET UNITYSDK_OFFSET(0x18B18F00)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NEGATIVEINFINITYSYMBOL_OFFSET UNITYSDK_OFFSET(0x18B18160)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NEGATIVESIGN_OFFSET UNITYSDK_OFFSET(0x18B18240)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x18B18320)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B18460)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B18520)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x18B17530)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_NUMBERNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x18B17DA0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTDECIMALDIGITS_OFFSET UNITYSDK_OFFSET(0x18B18930)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B18A70)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B18B30)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTGROUPSIZES_OFFSET UNITYSDK_OFFSET(0x18B177C0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTNEGATIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x18B18020)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTPOSITIVEPATTERN_OFFSET UNITYSDK_OFFSET(0x18B17EE0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERCENTSYMBOL_OFFSET UNITYSDK_OFFSET(0x18B18C50)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_PERMILLESYMBOL_OFFSET UNITYSDK_OFFSET(0x18B18D40)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_POSITIVEINFINITYSYMBOL_OFFSET UNITYSDK_OFFSET(0x18B18770)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_SET_POSITIVESIGN_OFFSET UNITYSDK_OFFSET(0x18B18850)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VALIDATEPARSESTYLEFLOATINGPOINT_OFFSET UNITYSDK_OFFSET(0x18B191A0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VALIDATEPARSESTYLEINTEGER_OFFSET UNITYSDK_OFFSET(0x18B19110)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYDECIMALSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B164F0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYDIGITSUBSTITUTION_OFFSET UNITYSDK_OFFSET(0x18B168A0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYGROUPSEPARATOR_OFFSET UNITYSDK_OFFSET(0x18B165A0)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYNATIVEDIGITS_OFFSET UNITYSDK_OFFSET(0x18B16610)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO_VERIFYWRITABLE_OFFSET UNITYSDK_OFFSET(0x18B16910)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B16030)
#define SYSTEM_GLOBALIZATION_NUMBERFORMATINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18B16020)
