...
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x19CC1680)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x19CC1A80)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_CHECKTICKSRANGE_OFFSET UNITYSDK_OFFSET(0x19CC11B0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_DATETOTICKS_OFFSET UNITYSDK_OFFSET(0x19CC14C0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETABSOLUTEDATE_OFFSET UNITYSDK_OFFSET(0x19CC1300)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETDATEPART_OFFSET UNITYSDK_OFFSET(0x19CC0F80)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x19CC1A90)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x19CC1AC0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x19CC1B20)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x19CC1B50)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x19CC1CB0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETERA_OFFSET UNITYSDK_OFFSET(0x19CC1D00)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETGREGORIANYEAR_OFFSET UNITYSDK_OFFSET(0x19CC0D00)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x19CC22E0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x19CC1F60)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETMONTH_OFFSET UNITYSDK_OFFSET(0x19CC1F30)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETWEEKOFYEAR_OFFSET UNITYSDK_OFFSET(0x19CC2550)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETYEAR_1_OFFSET UNITYSDK_OFFSET(0x19CC2060)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GETYEAR_OFFSET UNITYSDK_OFFSET(0x19CC1F80)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x19CC1DC0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_GET_MAXYEAR_OFFSET UNITYSDK_OFFSET(0x19CC0C70)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x19CC2130)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x19CC22F0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x19CC22A0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_ISVALIDYEAR_OFFSET UNITYSDK_OFFSET(0x19CC0F00)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_TIMETOTICKS_OFFSET UNITYSDK_OFFSET(0x19CC1540)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_TODATETIME_OFFSET UNITYSDK_OFFSET(0x19CC23D0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x19CC2660)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19CC27D0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDARHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC0C80)
