...
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x185FE010)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x185FE3B0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_CHECKERARANGE_OFFSET UNITYSDK_OFFSET(0x185FCFD0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_CHECKTICKSRANGE_OFFSET UNITYSDK_OFFSET(0x185FC7D0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_CHECKYEARMONTHRANGE_OFFSET UNITYSDK_OFFSET(0x185FD250)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_CHECKYEARRANGE_OFFSET UNITYSDK_OFFSET(0x185FD0F0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETCELESTIALSTEM_OFFSET UNITYSDK_OFFSET(0x185FCA40)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x185FE800)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x185FED10)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x185FE620)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x185FD370)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x185FE980)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x185FEF70)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x185FED70)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x185FEA00)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETSEXAGENARYYEAR_OFFSET UNITYSDK_OFFSET(0x185FC620)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETTERRESTRIALBRANCH_OFFSET UNITYSDK_OFFSET(0x185FCB60)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x185FEB80)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x185FC610)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x185FEFE0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GREGORIANISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x185FD3C0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_GREGORIANTOLUNAR_OFFSET UNITYSDK_OFFSET(0x185FDA20)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_INTERNALGETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x185FD330)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_INTERNALISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x185FE390)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x185FEDB0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x185FEF30)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x185FEFB0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_LUNARTOGREGORIAN_OFFSET UNITYSDK_OFFSET(0x185FD640)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_LUNARTOTIME_OFFSET UNITYSDK_OFFSET(0x185FDDD0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_MAXERACALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x185FCE20)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_MINERACALENDARYEAR_OFFSET UNITYSDK_OFFSET(0x185FCC80)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x185FF050)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_TIMETOLUNAR_OFFSET UNITYSDK_OFFSET(0x185FC8E0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x185FD400)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x185FF1D0)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x185FF260)
#define SYSTEM_GLOBALIZATION_EASTASIANLUNISOLARCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x185FCFC0)
