...
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANRESULT_GETTIMESPANPARSEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x848CC0)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANRESULT_INIT_OFFSET UNITYSDK_OFFSET(0x848B50)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANRESULT_SETFAILURE_1_OFFSET UNITYSDK_OFFSET(0x848BD0)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANRESULT_SETFAILURE_2_OFFSET UNITYSDK_OFFSET(0x848C40)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANRESULT_SETFAILURE_OFFSET UNITYSDK_OFFSET(0x848B60)
