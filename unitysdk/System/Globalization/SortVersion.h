...
#define SYSTEM_GLOBALIZATION_SORTVERSION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x199EFCF0)
#define SYSTEM_GLOBALIZATION_SORTVERSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x199EFB70)
#define SYSTEM_GLOBALIZATION_SORTVERSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x199EFE20)
#define SYSTEM_GLOBALIZATION_SORTVERSION_GET_FULLVERSION_OFFSET UNITYSDK_OFFSET(0x199EFAC0)
#define SYSTEM_GLOBALIZATION_SORTVERSION_GET_SORTID_OFFSET UNITYSDK_OFFSET(0x199EFAD0)
#define SYSTEM_GLOBALIZATION_SORTVERSION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x199EFD80)
#define SYSTEM_GLOBALIZATION_SORTVERSION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x199EFC40)
#define SYSTEM_GLOBALIZATION_SORTVERSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x199EFAF0)
#define SYSTEM_GLOBALIZATION_SORTVERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x199EFAE0)
