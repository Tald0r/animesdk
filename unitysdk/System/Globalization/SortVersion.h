...
#define SYSTEM_GLOBALIZATION_SORTVERSION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1950FF60)
#define SYSTEM_GLOBALIZATION_SORTVERSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1950FDE0)
#define SYSTEM_GLOBALIZATION_SORTVERSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19510090)
#define SYSTEM_GLOBALIZATION_SORTVERSION_GET_FULLVERSION_OFFSET UNITYSDK_OFFSET(0x1950FD30)
#define SYSTEM_GLOBALIZATION_SORTVERSION_GET_SORTID_OFFSET UNITYSDK_OFFSET(0x1950FD40)
#define SYSTEM_GLOBALIZATION_SORTVERSION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1950FFF0)
#define SYSTEM_GLOBALIZATION_SORTVERSION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1950FEB0)
#define SYSTEM_GLOBALIZATION_SORTVERSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1950FD60)
#define SYSTEM_GLOBALIZATION_SORTVERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1950FD50)
