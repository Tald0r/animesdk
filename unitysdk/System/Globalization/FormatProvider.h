...
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_FORMATBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1A886B70)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER_TRYSTRINGTOBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1A888CD0)
#define SYSTEM_GLOBALIZATION_FORMATPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A888F60)
