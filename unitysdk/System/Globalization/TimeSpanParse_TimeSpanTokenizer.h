...
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_BACKONE_OFFSET UNITYSDK_OFFSET(0x8A1410)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_GETNEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x8A13C0)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_GET_CURRENTCHAR_OFFSET UNITYSDK_OFFSET(0x8A1460)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_GET_EOL_OFFSET UNITYSDK_OFFSET(0x8A13E0)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_GET_NEXTCHAR_OFFSET UNITYSDK_OFFSET(0x8A1420)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_INIT_1_OFFSET UNITYSDK_OFFSET(0x30F0B0)
#define SYSTEM_GLOBALIZATION_TIMESPANPARSE_TIMESPANTOKENIZER_INIT_OFFSET UNITYSDK_OFFSET(0x8A13B0)
