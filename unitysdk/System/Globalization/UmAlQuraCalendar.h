...
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x1913BB30)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x1913BDE0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_CHECKERARANGE_OFFSET UNITYSDK_OFFSET(0x1913B440)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_CHECKTICKSRANGE_OFFSET UNITYSDK_OFFSET(0x1913B300)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_CHECKYEARMONTHRANGE_OFFSET UNITYSDK_OFFSET(0x1913B610)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_CHECKYEARRANGE_OFFSET UNITYSDK_OFFSET(0x1913B4B0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_CONVERTGREGORIANTOHIJRI_OFFSET UNITYSDK_OFFSET(0x1913B6B0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_CONVERTHIJRITOGREGORIAN_OFFSET UNITYSDK_OFFSET(0x1913AFD0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GETABSOLUTEDATEUMALQURA_OFFSET UNITYSDK_OFFSET(0x1913B240)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GETDATEPART_OFFSET UNITYSDK_OFFSET(0x1913B9D0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x1913BDF0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x1913BE10)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x1913BE60)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x1913BE80)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x1913C060)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x1913C0D0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1913C360)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x1913C1B0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x1913C190)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x1913C220)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1913AF80)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x1913AFA0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GET_DAYSINYEARBEFOREMINSUPPORTEDYEAR_OFFSET UNITYSDK_OFFSET(0x1913AFC0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x1913C140)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x1913AFB0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1913AF20)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1913AEC0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1913C6A0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_INITDATEMAPPING_OFFSET UNITYSDK_OFFSET(0x1913AD20)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x1913C240)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1913C3C0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x1913C430)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_REALGETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x1913BF40)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1913C6E0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x1913C4A0)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x1913C810)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1913C930)
#define SYSTEM_GLOBALIZATION_UMALQURACALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1913AF90)
