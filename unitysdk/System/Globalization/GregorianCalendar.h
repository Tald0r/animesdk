...
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x19850530)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x19850880)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_DATETOTICKS_OFFSET UNITYSDK_OFFSET(0x198504E0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GETABSOLUTEDATE_OFFSET UNITYSDK_OFFSET(0x19850320)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GETDATEPART_OFFSET UNITYSDK_OFFSET(0x19850120)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x19850890)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x198508C0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x19850910)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x19850940)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x19850B70)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GETDEFAULTINSTANCE_OFFSET UNITYSDK_OFFSET(0x1984FF50)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x19850CC0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x198511E0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x19850D50)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x19850D20)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x19850E40)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1984FF40)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GET_CALENDARTYPE_OFFSET UNITYSDK_OFFSET(0x19850020)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x19850CD0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x19850110)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1984FF30)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1984FF20)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x19851750)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x19850E60)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x198512F0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x198514D0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_ONDESERIALIZED_OFFSET UNITYSDK_OFFSET(0x1984FE80)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_SET_CALENDARTYPE_OFFSET UNITYSDK_OFFSET(0x19850030)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x19851790)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x19851610)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x198518C0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR_TRYTODATETIME_OFFSET UNITYSDK_OFFSET(0x198516E0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x198519D0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1984F7C0)
#define SYSTEM_GLOBALIZATION_GREGORIANCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x19850010)
...
namespace System::Globalization
{
	...
	public:
		...
		{
			return (::System::Globalization::Calendar**)Il2CppClass::FromTypeDefinitionIndex(GregorianCalendar_TypeDefinitionIndex)->GetStaticField(0x78);
		}
