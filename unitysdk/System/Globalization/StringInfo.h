...
#define SYSTEM_GLOBALIZATION_STRINGINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B6C660)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GETCURRENTTEXTELEMENTLEN_OFFSET UNITYSDK_OFFSET(0x19B6CF10)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B6C700)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GETNEXTTEXTELEMENT_1_OFFSET UNITYSDK_OFFSET(0x19B6CD40)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GETNEXTTEXTELEMENT_OFFSET UNITYSDK_OFFSET(0x19B6CD30)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GETTEXTELEMENTENUMERATOR_1_OFFSET UNITYSDK_OFFSET(0x19B6D0C0)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GETTEXTELEMENTENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19B6D0B0)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GET_INDEXES_OFFSET UNITYSDK_OFFSET(0x19B6C790)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GET_LENGTHINTEXTELEMENTS_OFFSET UNITYSDK_OFFSET(0x19B6C9F0)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GET_STRING_OFFSET UNITYSDK_OFFSET(0x19B6C9E0)
#define SYSTEM_GLOBALIZATION_STRINGINFO_ONDESERIALIZED_OFFSET UNITYSDK_OFFSET(0x19B6C630)
#define SYSTEM_GLOBALIZATION_STRINGINFO_ONDESERIALIZING_OFFSET UNITYSDK_OFFSET(0x19B6C620)
#define SYSTEM_GLOBALIZATION_STRINGINFO_PARSECOMBININGCHARACTERS_OFFSET UNITYSDK_OFFSET(0x19B6C7E0)
#define SYSTEM_GLOBALIZATION_STRINGINFO_SET_STRING_OFFSET UNITYSDK_OFFSET(0x19B6C5A0)
#define SYSTEM_GLOBALIZATION_STRINGINFO_SUBSTRINGBYTEXTELEMENTS_1_OFFSET UNITYSDK_OFFSET(0x19B6CB30)
#define SYSTEM_GLOBALIZATION_STRINGINFO_SUBSTRINGBYTEXTELEMENTS_OFFSET UNITYSDK_OFFSET(0x19B6CA40)
#define SYSTEM_GLOBALIZATION_STRINGINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B6C520)
#define SYSTEM_GLOBALIZATION_STRINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6C4A0)
