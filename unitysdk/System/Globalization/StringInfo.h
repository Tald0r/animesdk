...
#define SYSTEM_GLOBALIZATION_STRINGINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A130F30)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GETCURRENTTEXTELEMENTLEN_OFFSET UNITYSDK_OFFSET(0x1A1317E0)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A130FD0)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GETNEXTTEXTELEMENT_1_OFFSET UNITYSDK_OFFSET(0x1A131610)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GETNEXTTEXTELEMENT_OFFSET UNITYSDK_OFFSET(0x1A131600)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GETTEXTELEMENTENUMERATOR_1_OFFSET UNITYSDK_OFFSET(0x1A131990)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GETTEXTELEMENTENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A131980)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GET_INDEXES_OFFSET UNITYSDK_OFFSET(0x1A131060)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GET_LENGTHINTEXTELEMENTS_OFFSET UNITYSDK_OFFSET(0x1A1312C0)
#define SYSTEM_GLOBALIZATION_STRINGINFO_GET_STRING_OFFSET UNITYSDK_OFFSET(0x1A1312B0)
#define SYSTEM_GLOBALIZATION_STRINGINFO_ONDESERIALIZED_OFFSET UNITYSDK_OFFSET(0x1A130F00)
#define SYSTEM_GLOBALIZATION_STRINGINFO_ONDESERIALIZING_OFFSET UNITYSDK_OFFSET(0x1A130EF0)
#define SYSTEM_GLOBALIZATION_STRINGINFO_PARSECOMBININGCHARACTERS_OFFSET UNITYSDK_OFFSET(0x1A1310B0)
#define SYSTEM_GLOBALIZATION_STRINGINFO_SET_STRING_OFFSET UNITYSDK_OFFSET(0x1A130E70)
#define SYSTEM_GLOBALIZATION_STRINGINFO_SUBSTRINGBYTEXTELEMENTS_1_OFFSET UNITYSDK_OFFSET(0x1A131400)
#define SYSTEM_GLOBALIZATION_STRINGINFO_SUBSTRINGBYTEXTELEMENTS_OFFSET UNITYSDK_OFFSET(0x1A131310)
#define SYSTEM_GLOBALIZATION_STRINGINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A130DF0)
#define SYSTEM_GLOBALIZATION_STRINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A130D70)
