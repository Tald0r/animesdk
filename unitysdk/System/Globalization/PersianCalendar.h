...
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x17FCE8D0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x17FCEBF0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_CHECKERARANGE_OFFSET UNITYSDK_OFFSET(0x17FCE020)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_CHECKTICKSRANGE_OFFSET UNITYSDK_OFFSET(0x17FCDEE0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_CHECKYEARMONTHRANGE_OFFSET UNITYSDK_OFFSET(0x17FCE230)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_CHECKYEARRANGE_OFFSET UNITYSDK_OFFSET(0x17FCE0B0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_DAYSINPREVIOUSMONTHS_OFFSET UNITYSDK_OFFSET(0x17FCDE40)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETABSOLUTEDATEPERSIAN_OFFSET UNITYSDK_OFFSET(0x17FCDC80)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDATEPART_OFFSET UNITYSDK_OFFSET(0x17FCE470)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x17FCEC00)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x17FCEC20)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x17FCEC70)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x17FCEC90)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x17FCEDD0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x17FCEFF0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x17FCF400)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x17FCF110)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x17FCF0F0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x17FCF180)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x17FCDC40)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x17FCDC60)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x17FCF060)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x17FCDC70)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x17FCDBE0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x17FCDB80)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x17FCF4D0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x17FCF260)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x17FCF460)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x17FCEF50)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_MONTHFROMORDINALDAY_OFFSET UNITYSDK_OFFSET(0x17FCE370)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x17FCF510)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x17FCE710)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x17FCF640)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x17FCF760)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x17FCDC50)
...
namespace System::Globalization
{
	...
	public:
		...
		{
			return (::System::DateTime*)Il2CppClass::FromTypeDefinitionIndex(PersianCalendar_TypeDefinitionIndex)->GetStaticField(0xD70);
		}
		static ::System::Int32* StaticGet_PersianEra()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PersianCalendar_TypeDefinitionIndex)->GetStaticField(0xD78);
		}
		static ::System::Int64* StaticGet_PersianEpoch()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(PersianCalendar_TypeDefinitionIndex)->GetStaticField(0xD80);
		}
