...
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x186022A0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x186025C0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_CHECKERARANGE_OFFSET UNITYSDK_OFFSET(0x186019F0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_CHECKTICKSRANGE_OFFSET UNITYSDK_OFFSET(0x186018B0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_CHECKYEARMONTHRANGE_OFFSET UNITYSDK_OFFSET(0x18601C00)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_CHECKYEARRANGE_OFFSET UNITYSDK_OFFSET(0x18601A80)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_DAYSINPREVIOUSMONTHS_OFFSET UNITYSDK_OFFSET(0x18601810)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETABSOLUTEDATEPERSIAN_OFFSET UNITYSDK_OFFSET(0x18601650)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDATEPART_OFFSET UNITYSDK_OFFSET(0x18601E40)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x186025D0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x186025F0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x18602640)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x18602660)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x186027A0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x186029C0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x18602DD0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x18602AE0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x18602AC0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x18602B50)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x18601610)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_BASECALENDARID_OFFSET UNITYSDK_OFFSET(0x18601630)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x18602A30)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x18601640)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x186015B0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x18601550)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x18602EA0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x18602C30)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x18602E30)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x18602920)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_MONTHFROMORDINALDAY_OFFSET UNITYSDK_OFFSET(0x18601D40)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x18602EE0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x186020E0)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x18603010)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x18603130)
#define SYSTEM_GLOBALIZATION_PERSIANCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x18601620)
...
namespace System::Globalization
{
	...
	public:
		...
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(PersianCalendar_TypeDefinitionIndex)->GetStaticField(0xD70);
		}
