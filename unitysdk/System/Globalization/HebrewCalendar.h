...
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_ADDMONTHS_OFFSET UNITYSDK_OFFSET(0x1A12F4A0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_ADDYEARS_OFFSET UNITYSDK_OFFSET(0x1A12F8F0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_CHECKERARANGE_OFFSET UNITYSDK_OFFSET(0x1A12E210)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_CHECKHEBREWDAYVALUE_OFFSET UNITYSDK_OFFSET(0x1A12E4D0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_CHECKHEBREWMONTHVALUE_OFFSET UNITYSDK_OFFSET(0x1A12E2A0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_CHECKHEBREWYEARVALUE_OFFSET UNITYSDK_OFFSET(0x1A12E090)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_CHECKTICKSRANGE_OFFSET UNITYSDK_OFFSET(0x1A12E780)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDATEPART_OFFSET UNITYSDK_OFFSET(0x1A12EB80)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDAYDIFFERENCE_OFFSET UNITYSDK_OFFSET(0x1A130450)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDAYOFMONTH_OFFSET UNITYSDK_OFFSET(0x1A12FB90)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDAYOFWEEK_OFFSET UNITYSDK_OFFSET(0x1A12FBC0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDAYOFYEAR_OFFSET UNITYSDK_OFFSET(0x1A12FCB0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDAYSINMONTH_OFFSET UNITYSDK_OFFSET(0x1A12E5B0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETDAYSINYEAR_OFFSET UNITYSDK_OFFSET(0x1A12FE90)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETERA_OFFSET UNITYSDK_OFFSET(0x1A12FF90)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETHEBREWYEARTYPE_OFFSET UNITYSDK_OFFSET(0x1A12FC10)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1A1303A0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETLUNARMONTHDAY_OFFSET UNITYSDK_OFFSET(0x1A12E960)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETMONTHSINYEAR_OFFSET UNITYSDK_OFFSET(0x1A12E420)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETMONTH_OFFSET UNITYSDK_OFFSET(0x1A130080)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1A12E8C0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GETYEAR_OFFSET UNITYSDK_OFFSET(0x1A12FD70)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GET_ALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1A12E060)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GET_ERAS_OFFSET UNITYSDK_OFFSET(0x1A12FFF0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A12E080)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GET_MAXSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1A12E000)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GET_MINSUPPORTEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1A12DFA0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_GET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1A130940)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_HEBREWTOGREGORIAN_OFFSET UNITYSDK_OFFSET(0x1A130770)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_ISLEAPDAY_OFFSET UNITYSDK_OFFSET(0x1A130150)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_ISLEAPMONTH_OFFSET UNITYSDK_OFFSET(0x1A1302D0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_ISLEAPYEAR_OFFSET UNITYSDK_OFFSET(0x1A1300B0)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_SET_TWODIGITYEARMAX_OFFSET UNITYSDK_OFFSET(0x1A130980)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_TODATETIME_OFFSET UNITYSDK_OFFSET(0x1A12FD90)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR_TOFOURDIGITYEAR_OFFSET UNITYSDK_OFFSET(0x1A130A50)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A130B70)
#define SYSTEM_GLOBALIZATION_HEBREWCALENDAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A12E070)
...
namespace System::Globalization
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(HebrewCalendar_TypeDefinitionIndex)->GetStaticField(0xD10);
		}
