...
#define SYSTEM_UNCNAMEHELPER_ISVALID_OFFSET UNITYSDK_OFFSET(0x187EB9D0)
#define SYSTEM_UNCNAMEHELPER_PARSECANONICALNAME_OFFSET UNITYSDK_OFFSET(0x187EB9C0)
#define SYSTEM_UNCNAMEHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x187EB9B0)
