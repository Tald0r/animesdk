...
#define SYSTEM_ENTRYPOINTNOTFOUNDEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A12DDB0)
#define SYSTEM_ENTRYPOINTNOTFOUNDEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A12DE20)
#define SYSTEM_ENTRYPOINTNOTFOUNDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A12DD10)
