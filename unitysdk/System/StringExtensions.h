...
#define SYSTEM_STRINGEXTENSIONS_SUBSTRINGTRIM_1_OFFSET UNITYSDK_OFFSET(0x195E25C0)
#define SYSTEM_STRINGEXTENSIONS_SUBSTRINGTRIM_OFFSET UNITYSDK_OFFSET(0x195E25A0)
