...
#define SYSTEM_ARGUMENTEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18FE4630)
#define SYSTEM_ARGUMENTEXCEPTION_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x18FE4470)
#define SYSTEM_ARGUMENTEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FE4230)
#define SYSTEM_ARGUMENTEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18FE42A0)
#define SYSTEM_ARGUMENTEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18FE4310)
#define SYSTEM_ARGUMENTEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18FE4390)
#define SYSTEM_ARGUMENTEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x18FE4400)
#define SYSTEM_ARGUMENTEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE4190)
