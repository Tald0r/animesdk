...
#define SYSTEM_ARRAY_SORTERGENERICARRAY_DOWNHEAP_OFFSET UNITYSDK_OFFSET(0x908F30)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_HEAPSORT_OFFSET UNITYSDK_OFFSET(0x908EA0)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_INSERTIONSORT_OFFSET UNITYSDK_OFFSET(0x908F40)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_INTROSORT_OFFSET UNITYSDK_OFFSET(0x908E80)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_INTROSPECTIVESORT_OFFSET UNITYSDK_OFFSET(0x908E70)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_PICKPIVOTANDPARTITION_OFFSET UNITYSDK_OFFSET(0x908E90)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_SORT_OFFSET UNITYSDK_OFFSET(0x908E70)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_SWAPIFGREATERWITHITEMS_OFFSET UNITYSDK_OFFSET(0x908E50)
#define SYSTEM_ARRAY_SORTERGENERICARRAY_SWAP_OFFSET UNITYSDK_OFFSET(0x908E60)
#define SYSTEM_ARRAY_SORTERGENERICARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x8DE500)
