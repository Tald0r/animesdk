...
#define SYSTEM_NUMERICS_QUATERNION_CREATEFROMAXISANGLE_OFFSET UNITYSDK_OFFSET(0x1A896510)
#define SYSTEM_NUMERICS_QUATERNION_CREATEFROMYAWPITCHROLL_OFFSET UNITYSDK_OFFSET(0x1A896590)
#define SYSTEM_NUMERICS_QUATERNION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x93C0A0)
#define SYSTEM_NUMERICS_QUATERNION_EQUALS_OFFSET UNITYSDK_OFFSET(0x8D11B0)
#define SYSTEM_NUMERICS_QUATERNION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x93C140)
#define SYSTEM_NUMERICS_QUATERNION_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x1A896460)
#define SYSTEM_NUMERICS_QUATERNION_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1A8964A0)
#define SYSTEM_NUMERICS_QUATERNION_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A896840)
#define SYSTEM_NUMERICS_QUATERNION_SLERP_OFFSET UNITYSDK_OFFSET(0x1A8966B0)
#define SYSTEM_NUMERICS_QUATERNION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x93C130)
#define SYSTEM_NUMERICS_QUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x42F920)
