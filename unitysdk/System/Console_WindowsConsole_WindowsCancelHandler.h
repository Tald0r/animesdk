...
#define SYSTEM_CONSOLE_WINDOWSCONSOLE_WINDOWSCANCELHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17F4D2F0)
#define SYSTEM_CONSOLE_WINDOWSCONSOLE_WINDOWSCANCELHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17F4D340)
#define SYSTEM_CONSOLE_WINDOWSCONSOLE_WINDOWSCANCELHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x17F4CFF0)
#define SYSTEM_CONSOLE_WINDOWSCONSOLE_WINDOWSCANCELHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17F4CFE0)
