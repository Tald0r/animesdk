...
#define SYSTEM_GUID_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x8CC730)
#define SYSTEM_GUID_COMPARETO_OFFSET UNITYSDK_OFFSET(0x8CC720)
#define SYSTEM_GUID_EATALLWHITESPACE_OFFSET UNITYSDK_OFFSET(0x19AFB5C0)
#define SYSTEM_GUID_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8CC6A0)
#define SYSTEM_GUID_EQUALS_OFFSET UNITYSDK_OFFSET(0x8CC620)
#define SYSTEM_GUID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8CC5F0)
#define SYSTEM_GUID_GETRESULT_OFFSET UNITYSDK_OFFSET(0x8CC710)
#define SYSTEM_GUID_HEXSTOCHARS_1_OFFSET UNITYSDK_OFFSET(0x19AFCC00)
#define SYSTEM_GUID_HEXSTOCHARS_OFFSET UNITYSDK_OFFSET(0x19AFCB80)
#define SYSTEM_GUID_HEXTOCHAR_OFFSET UNITYSDK_OFFSET(0x19AFCB70)
#define SYSTEM_GUID_ISHEXPREFIX_OFFSET UNITYSDK_OFFSET(0x19AFB6D0)
#define SYSTEM_GUID_NEWGUID_OFFSET UNITYSDK_OFFSET(0x19AFCCC0)
#define SYSTEM_GUID_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19AFCA80)
#define SYSTEM_GUID_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19AFCAF0)
#define SYSTEM_GUID_PARSE_OFFSET UNITYSDK_OFFSET(0x19AFA350)
#define SYSTEM_GUID_STRINGTOINT_1_OFFSET UNITYSDK_OFFSET(0x19AFB840)
#define SYSTEM_GUID_STRINGTOINT_2_OFFSET UNITYSDK_OFFSET(0x19AFB890)
#define SYSTEM_GUID_STRINGTOINT_OFFSET UNITYSDK_OFFSET(0x19AFB7B0)
#define SYSTEM_GUID_STRINGTOLONG_1_OFFSET UNITYSDK_OFFSET(0x19AFBA30)
#define SYSTEM_GUID_STRINGTOLONG_OFFSET UNITYSDK_OFFSET(0x19AFB830)
#define SYSTEM_GUID_STRINGTOSHORT_1_OFFSET UNITYSDK_OFFSET(0x19AFB850)
#define SYSTEM_GUID_STRINGTOSHORT_OFFSET UNITYSDK_OFFSET(0x19AFB7E0)
#define SYSTEM_GUID_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x8CC5D0)
#define SYSTEM_GUID_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8CC7E0)
#define SYSTEM_GUID_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x8CC7E0)
#define SYSTEM_GUID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8CC5E0)
#define SYSTEM_GUID_TRYPARSEGUIDWITHDASHES_OFFSET UNITYSDK_OFFSET(0x19AFA460)
#define SYSTEM_GUID_TRYPARSEGUIDWITHHEXPREFIX_OFFSET UNITYSDK_OFFSET(0x19AFA910)
#define SYSTEM_GUID_TRYPARSEGUIDWITHNOSTYLE_OFFSET UNITYSDK_OFFSET(0x19AFB1F0)
#define SYSTEM_GUID_TRYPARSEGUID_OFFSET UNITYSDK_OFFSET(0x19AF9E50)
#define SYSTEM_GUID_TRYPARSE_OFFSET UNITYSDK_OFFSET(0x19AFA400)
#define SYSTEM_GUID__CCTOR_OFFSET UNITYSDK_OFFSET(0x19AFCE40)
#define SYSTEM_GUID__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8CC540)
#define SYSTEM_GUID__CTOR_2_OFFSET UNITYSDK_OFFSET(0x8CC5B0)
#define SYSTEM_GUID__CTOR_3_OFFSET UNITYSDK_OFFSET(0x8CC540)
#define SYSTEM_GUID__CTOR_4_OFFSET UNITYSDK_OFFSET(0x8CC5C0)
#define SYSTEM_GUID__CTOR_OFFSET UNITYSDK_OFFSET(0x8CC530)
