...
#define SYSTEM_GC_ADDMEMORYPRESSURE_OFFSET UNITYSDK_OFFSET(0x19CBE740)
#define SYSTEM_GC_COLLECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x19CBEAC0)
#define SYSTEM_GC_COLLECT_1_OFFSET UNITYSDK_OFFSET(0x19CBE910)
#define SYSTEM_GC_COLLECT_2_OFFSET UNITYSDK_OFFSET(0x19CBE8C0)
#define SYSTEM_GC_COLLECT_3_OFFSET UNITYSDK_OFFSET(0x19CBE9A0)
#define SYSTEM_GC_COLLECT_4_OFFSET UNITYSDK_OFFSET(0x19CBE9E0)
#define SYSTEM_GC_COLLECT_OFFSET UNITYSDK_OFFSET(0x19CBE860)
#define SYSTEM_GC_GETCOLLECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x19CBE6C0)
#define SYSTEM_GC_GETMAXGENERATION_OFFSET UNITYSDK_OFFSET(0x19CBE6D0)
#define SYSTEM_GC_GETTOTALMEMORY_OFFSET UNITYSDK_OFFSET(0x19CBECA0)
#define SYSTEM_GC_GET_EPHEMERON_TOMBSTONE_OFFSET UNITYSDK_OFFSET(0x19CBE730)
#define SYSTEM_GC_GET_MAXGENERATION_OFFSET UNITYSDK_OFFSET(0x19CBE970)
#define SYSTEM_GC_INTERNALCOLLECT_OFFSET UNITYSDK_OFFSET(0x19CBE6E0)
#define SYSTEM_GC_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x19CBEB50)
#define SYSTEM_GC_RECORDPRESSURE_OFFSET UNITYSDK_OFFSET(0x19CBE710)
#define SYSTEM_GC_REGISTER_EPHEMERON_ARRAY_OFFSET UNITYSDK_OFFSET(0x19CBE720)
#define SYSTEM_GC_REMOVEMEMORYPRESSURE_OFFSET UNITYSDK_OFFSET(0x19CBE7D0)
#define SYSTEM_GC_REREGISTERFORFINALIZE_OFFSET UNITYSDK_OFFSET(0x19CBEC20)
#define SYSTEM_GC_SUPPRESSFINALIZE_OFFSET UNITYSDK_OFFSET(0x19CBEB90)
#define SYSTEM_GC__CCTOR_OFFSET UNITYSDK_OFFSET(0x19CBECE0)
#define SYSTEM_GC__REREGISTERFORFINALIZE_OFFSET UNITYSDK_OFFSET(0x19CBEBF0)
#define SYSTEM_GC__SUPPRESSFINALIZE_OFFSET UNITYSDK_OFFSET(0x19CBEB60)
