...
#define SYSTEM_GC_ADDMEMORYPRESSURE_OFFSET UNITYSDK_OFFSET(0x197ADA80)
#define SYSTEM_GC_COLLECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x197ADE00)
#define SYSTEM_GC_COLLECT_1_OFFSET UNITYSDK_OFFSET(0x197ADC50)
#define SYSTEM_GC_COLLECT_2_OFFSET UNITYSDK_OFFSET(0x197ADC00)
#define SYSTEM_GC_COLLECT_3_OFFSET UNITYSDK_OFFSET(0x197ADCE0)
#define SYSTEM_GC_COLLECT_4_OFFSET UNITYSDK_OFFSET(0x197ADD20)
#define SYSTEM_GC_COLLECT_OFFSET UNITYSDK_OFFSET(0x197ADBA0)
#define SYSTEM_GC_GETCOLLECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x197ADA00)
#define SYSTEM_GC_GETMAXGENERATION_OFFSET UNITYSDK_OFFSET(0x197ADA10)
#define SYSTEM_GC_GETTOTALMEMORY_OFFSET UNITYSDK_OFFSET(0x197ADFE0)
#define SYSTEM_GC_GET_EPHEMERON_TOMBSTONE_OFFSET UNITYSDK_OFFSET(0x197ADA70)
#define SYSTEM_GC_GET_MAXGENERATION_OFFSET UNITYSDK_OFFSET(0x197ADCB0)
#define SYSTEM_GC_INTERNALCOLLECT_OFFSET UNITYSDK_OFFSET(0x197ADA20)
#define SYSTEM_GC_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x197ADE90)
#define SYSTEM_GC_RECORDPRESSURE_OFFSET UNITYSDK_OFFSET(0x197ADA50)
#define SYSTEM_GC_REGISTER_EPHEMERON_ARRAY_OFFSET UNITYSDK_OFFSET(0x197ADA60)
#define SYSTEM_GC_REMOVEMEMORYPRESSURE_OFFSET UNITYSDK_OFFSET(0x197ADB10)
#define SYSTEM_GC_REREGISTERFORFINALIZE_OFFSET UNITYSDK_OFFSET(0x197ADF60)
#define SYSTEM_GC_SUPPRESSFINALIZE_OFFSET UNITYSDK_OFFSET(0x197ADED0)
#define SYSTEM_GC__CCTOR_OFFSET UNITYSDK_OFFSET(0x197AE020)
#define SYSTEM_GC__REREGISTERFORFINALIZE_OFFSET UNITYSDK_OFFSET(0x197ADF30)
#define SYSTEM_GC__SUPPRESSFINALIZE_OFFSET UNITYSDK_OFFSET(0x197ADEA0)
