...
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_1_OFFSET UNITYSDK_OFFSET(0x197C4580)
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_2_OFFSET UNITYSDK_OFFSET(0x197C45F0)
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_3_OFFSET UNITYSDK_OFFSET(0x197C4690)
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_4_OFFSET UNITYSDK_OFFSET(0x197C4760)
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_5_OFFSET UNITYSDK_OFFSET(0x197C4860)
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_6_OFFSET UNITYSDK_OFFSET(0x197C4990)
#define SYSTEM_VALUETUPLE_COMBINEHASHCODES_OFFSET UNITYSDK_OFFSET(0x197C4540)
#define SYSTEM_VALUETUPLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x2FB060)
#define SYSTEM_VALUETUPLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x31FDD0)
#define SYSTEM_VALUETUPLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8B44F0)
#define SYSTEM_VALUETUPLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2FB060)
#define SYSTEM_VALUETUPLE_SYSTEM_COLLECTIONS_ISTRUCTURALCOMPARABLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x8B45A0)
#define SYSTEM_VALUETUPLE_SYSTEM_COLLECTIONS_ISTRUCTURALEQUATABLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8B4540)
#define SYSTEM_VALUETUPLE_SYSTEM_COLLECTIONS_ISTRUCTURALEQUATABLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2FB060)
#define SYSTEM_VALUETUPLE_SYSTEM_ICOMPARABLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x8B4590)
#define SYSTEM_VALUETUPLE_SYSTEM_IVALUETUPLEINTERNAL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2FB060)
#define SYSTEM_VALUETUPLE_SYSTEM_IVALUETUPLEINTERNAL_TOSTRINGEND_OFFSET UNITYSDK_OFFSET(0x8B45F0)
#define SYSTEM_VALUETUPLE_SYSTEM_RUNTIME_COMPILERSERVICES_ITUPLE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x2FB060)
#define SYSTEM_VALUETUPLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8B45B0)
