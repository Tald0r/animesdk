...
#define SYSTEM_EVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19DC8AE0)
#define SYSTEM_EVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19DC8B20)
#define SYSTEM_EVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19DC8560)
#define SYSTEM_EVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DC8540)
