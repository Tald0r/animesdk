...
#define SYSTEM_ASSEMBLYLOADEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1912DBE0)
#define SYSTEM_ASSEMBLYLOADEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1912DC20)
#define SYSTEM_ASSEMBLYLOADEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1912D660)
#define SYSTEM_ASSEMBLYLOADEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1912D650)
