...
#define SYSTEM_SR_FORMAT_OFFSET UNITYSDK_OFFSET(0x1ADB7220)
#define SYSTEM_SR_GETRESOURCESTRING_OFFSET UNITYSDK_OFFSET(0x1ADB7100)
#define SYSTEM_SR_GET_ARGUMENT_BADFORMATSPECIFIER_OFFSET UNITYSDK_OFFSET(0x1ADB73E0)
#define SYSTEM_SR_GET_ARGUMENT_DESTINATIONTOOSHORT_OFFSET UNITYSDK_OFFSET(0x1ADB7380)
#define SYSTEM_SR_GET_ARGUMENT_GWITHPRECISIONNOTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1ADB2EC0)
#define SYSTEM_SR_GET_ARGUMENT_INVALIDTYPEWITHPOINTERSNOTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1ADB7320)
#define SYSTEM_SR_GET_ARGUMENT_PRECISIONTOOLARGE_OFFSET UNITYSDK_OFFSET(0x1ADB7440)
#define SYSTEM_SR_GET_ENDPOSITIONNOTREACHED_OFFSET UNITYSDK_OFFSET(0x1ADB74A0)
#define SYSTEM_SR_GET_NOTSUPPORTED_CANNOTCALLEQUALSONSPAN_OFFSET UNITYSDK_OFFSET(0x1ADB7260)
#define SYSTEM_SR_GET_NOTSUPPORTED_CANNOTCALLGETHASHCODEONSPAN_OFFSET UNITYSDK_OFFSET(0x1ADB72C0)
#define SYSTEM_SR_GET_RESOURCEMANAGER_OFFSET UNITYSDK_OFFSET(0x1ADB7030)
#define SYSTEM_SR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ADB7500)
...
namespace System
{
	...
	public:
		...
		{
			return (::System::Resources::ResourceManager**)Il2CppClass::FromTypeDefinitionIndex(SR_TypeDefinitionIndex)->GetStaticField(0x65E0);
		}
		static ::System::Type** StaticGet__ResourceType_k__BackingField()
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(SR_TypeDefinitionIndex)->GetStaticField(0x65E8);
		}
