...
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_FALLBACK_1_OFFSET UNITYSDK_OFFSET(0x19865B30)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_FALLBACK_OFFSET UNITYSDK_OFFSET(0x198659E0)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_GETNEXTCHAR_OFFSET UNITYSDK_OFFSET(0x19865D40)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_GET_INTERNALSYNCOBJECT_OFFSET UNITYSDK_OFFSET(0x19865960)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_GET_REMAINING_OFFSET UNITYSDK_OFFSET(0x19865D80)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_MOVEPREVIOUS_OFFSET UNITYSDK_OFFSET(0x19865D60)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_RESET_OFFSET UNITYSDK_OFFSET(0x19865D90)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER_TRYBESTFIT_OFFSET UNITYSDK_OFFSET(0x19865A20)
#define SYSTEM_TEXT_INTERNALENCODERBESTFITFALLBACKBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19865700)
