...
#define SYSTEM_TEXT_ENCODINGNLS_GETBYTECOUNT_1_OFFSET UNITYSDK_OFFSET(0x194F4920)
#define SYSTEM_TEXT_ENCODINGNLS_GETBYTECOUNT_2_OFFSET UNITYSDK_OFFSET(0x194F49B0)
#define SYSTEM_TEXT_ENCODINGNLS_GETBYTECOUNT_OFFSET UNITYSDK_OFFSET(0x194F47B0)
#define SYSTEM_TEXT_ENCODINGNLS_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x194F4C80)
#define SYSTEM_TEXT_ENCODINGNLS_GETBYTES_2_OFFSET UNITYSDK_OFFSET(0x194F4EB0)
#define SYSTEM_TEXT_ENCODINGNLS_GETBYTES_OFFSET UNITYSDK_OFFSET(0x194F4A80)
#define SYSTEM_TEXT_ENCODINGNLS_GETCHARCOUNT_1_OFFSET UNITYSDK_OFFSET(0x194F5140)
#define SYSTEM_TEXT_ENCODINGNLS_GETCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x194F4FD0)
#define SYSTEM_TEXT_ENCODINGNLS_GETCHARS_1_OFFSET UNITYSDK_OFFSET(0x194F5440)
#define SYSTEM_TEXT_ENCODINGNLS_GETCHARS_OFFSET UNITYSDK_OFFSET(0x194F5210)
#define SYSTEM_TEXT_ENCODINGNLS_GETDECODER_OFFSET UNITYSDK_OFFSET(0x194F5770)
#define SYSTEM_TEXT_ENCODINGNLS_GETENCODER_OFFSET UNITYSDK_OFFSET(0x194F57E0)
#define SYSTEM_TEXT_ENCODINGNLS_GETSTRING_OFFSET UNITYSDK_OFFSET(0x194F5560)
#define SYSTEM_TEXT_ENCODINGNLS__CTOR_OFFSET UNITYSDK_OFFSET(0x194F4750)
