...
#define SYSTEM_TEXT_UNICODEENCODING_DECODER_GET_HASSTATE_OFFSET UNITYSDK_OFFSET(0x18B294D0)
#define SYSTEM_TEXT_UNICODEENCODING_DECODER_RESET_OFFSET UNITYSDK_OFFSET(0x18B294A0)
#define SYSTEM_TEXT_UNICODEENCODING_DECODER_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18B29220)
#define SYSTEM_TEXT_UNICODEENCODING_DECODER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B28E20)
#define SYSTEM_TEXT_UNICODEENCODING_DECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B28DE0)
