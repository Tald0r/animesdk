...
#define SYSTEM_TEXT_ENCODEREXCEPTIONFALLBACK_CREATEFALLBACKBUFFER_OFFSET UNITYSDK_OFFSET(0x18DB5020)
#define SYSTEM_TEXT_ENCODEREXCEPTIONFALLBACK_EQUALS_OFFSET UNITYSDK_OFFSET(0x18DB5070)
#define SYSTEM_TEXT_ENCODEREXCEPTIONFALLBACK_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18DB5090)
#define SYSTEM_TEXT_ENCODEREXCEPTIONFALLBACK_GET_MAXCHARCOUNT_OFFSET UNITYSDK_OFFSET(0x18DB5060)
#define SYSTEM_TEXT_ENCODEREXCEPTIONFALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18DB5010)
