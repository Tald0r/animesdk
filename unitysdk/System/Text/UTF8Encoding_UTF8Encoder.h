...
#define SYSTEM_TEXT_UTF8ENCODING_UTF8ENCODER_RESET_OFFSET UNITYSDK_OFFSET(0x192C7080)
#define SYSTEM_TEXT_UTF8ENCODING_UTF8ENCODER_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x192C6E40)
#define SYSTEM_TEXT_UTF8ENCODING_UTF8ENCODER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x192C6B90)
#define SYSTEM_TEXT_UTF8ENCODING_UTF8ENCODER__CTOR_OFFSET UNITYSDK_OFFSET(0x192C6B60)
