...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_CAPTURE_OFFSET UNITYSDK_OFFSET(0x19FE6C70)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_CHARINCLASS_OFFSET UNITYSDK_OFFSET(0x19FE6AF0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_CHARINSET_OFFSET UNITYSDK_OFFSET(0x19FE6AC0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_CHECKTIMEOUT_OFFSET UNITYSDK_OFFSET(0x19FE63B0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_CRAWLPOS_OFFSET UNITYSDK_OFFSET(0x19FE6C50)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_CRAWL_OFFSET UNITYSDK_OFFSET(0x19FE6B70)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_DOCHECKTIMEOUT_OFFSET UNITYSDK_OFFSET(0x19FE6610)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_DOUBLECRAWL_OFFSET UNITYSDK_OFFSET(0x19FE6B00)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_DOUBLESTACK_OFFSET UNITYSDK_OFFSET(0x19FE67D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_DOUBLETRACK_OFFSET UNITYSDK_OFFSET(0x19FE6840)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_ENSURESTORAGE_OFFSET UNITYSDK_OFFSET(0x19FE66E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_INITMATCH_OFFSET UNITYSDK_OFFSET(0x19FE63D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_ISBOUNDARY_OFFSET UNITYSDK_OFFSET(0x19FE68B0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_ISECMABOUNDARY_OFFSET UNITYSDK_OFFSET(0x19FE69D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_ISMATCHED_OFFSET UNITYSDK_OFFSET(0x19FE6EA0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_MATCHINDEX_OFFSET UNITYSDK_OFFSET(0x19FE6DE0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_MATCHLENGTH_OFFSET UNITYSDK_OFFSET(0x19FE6E10)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_POPCRAWL_OFFSET UNITYSDK_OFFSET(0x19FE6C10)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_SCAN_1_OFFSET UNITYSDK_OFFSET(0x19FE5FF0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_SCAN_OFFSET UNITYSDK_OFFSET(0x19FE5F90)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_STARTTIMEOUTWATCH_OFFSET UNITYSDK_OFFSET(0x19FE6350)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_TIDYMATCH_OFFSET UNITYSDK_OFFSET(0x19FE65D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_TRANSFERCAPTURE_OFFSET UNITYSDK_OFFSET(0x19FE6CD0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER_UNCAPTURE_OFFSET UNITYSDK_OFFSET(0x19FE6E40)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE5F80)
...
namespace System::Text::RegularExpressions
{
	...
	public:
		...
		::System::Text::RegularExpressions::Regex* runregex; // 0x20
		::Il2CppArray<::System::Int32>* runstack; // 0x28
		::Il2CppArray<::System::Int32>* runcrawl; // 0x30
		::System::String* runtext; // 0x38
		::System::Int32 runtextbeg; // 0x40
		::System::Int32 timeoutOccursAt; // 0x44
		::System::Int32 runtextpos; // 0x48
		::System::Int32 runtextstart; // 0x4C
		::System::Boolean ignoreTimeout; // 0x50
		::System::Int32 runtrackcount; // 0x54
		::System::Int32 timeout; // 0x58
		::System::Int32 timeoutChecksToSkip; // 0x5C
		::System::Int32 runtrackpos; // 0x60
		::System::Int32 runtextend; // 0x64
		::System::Int32 runcrawlpos; // 0x68
		::System::Int32 runstackpos; // 0x6C
