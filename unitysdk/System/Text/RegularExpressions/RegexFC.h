...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXFC_ADDFC_OFFSET UNITYSDK_OFFSET(0x1890D820)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXFC_GETFIRSTCHARS_OFFSET UNITYSDK_OFFSET(0x1890D8B0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXFC_ISCASEINSENSITIVE_OFFSET UNITYSDK_OFFSET(0x1890D8F0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXFC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1890D740)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXFC__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1890D7F0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXFC__CTOR_OFFSET UNITYSDK_OFFSET(0x1890D700)
