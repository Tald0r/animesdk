...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_CACHECODE_OFFSET UNITYSDK_OFFSET(0x1946C220)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_COMPILETOASSEMBLY_1_OFFSET UNITYSDK_OFFSET(0x194700A0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_COMPILETOASSEMBLY_2_OFFSET UNITYSDK_OFFSET(0x194700E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_COMPILETOASSEMBLY_OFFSET UNITYSDK_OFFSET(0x19470060)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_ESCAPE_OFFSET UNITYSDK_OFFSET(0x1946CB50)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GETGROUPNAMES_OFFSET UNITYSDK_OFFSET(0x1946E2E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GETGROUPNUMBERS_OFFSET UNITYSDK_OFFSET(0x1946E3C0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GET_CACHESIZE_OFFSET UNITYSDK_OFFSET(0x1946CC50)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GET_CAPNAMES_OFFSET UNITYSDK_OFFSET(0x1946D8C0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GET_CAPS_OFFSET UNITYSDK_OFFSET(0x1946CE80)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GET_MATCHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1946E2A0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1946E290)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GET_RIGHTTOLEFT_OFFSET UNITYSDK_OFFSET(0x1946E2B0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GROUPNAMEFROMNUMBER_OFFSET UNITYSDK_OFFSET(0x1946E7F0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_GROUPNUMBERFROMNAME_OFFSET UNITYSDK_OFFSET(0x1946E910)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_INITDEFAULTMATCHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1946C920)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_INITIALIZEREFERENCES_OFFSET UNITYSDK_OFFSET(0x1946C180)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_ISMATCH_1_OFFSET UNITYSDK_OFFSET(0x1946EB50)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_ISMATCH_2_OFFSET UNITYSDK_OFFSET(0x1946EA90)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_ISMATCH_3_OFFSET UNITYSDK_OFFSET(0x1946EBA0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_ISMATCH_4_OFFSET UNITYSDK_OFFSET(0x1946EC20)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1946EA50)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_LOOKUPCACHEDANDUPDATE_OFFSET UNITYSDK_OFFSET(0x1946BF20)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCHES_1_OFFSET UNITYSDK_OFFSET(0x1946F3B0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCHES_2_OFFSET UNITYSDK_OFFSET(0x1946F2E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCHES_3_OFFSET UNITYSDK_OFFSET(0x1946F400)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCHES_4_OFFSET UNITYSDK_OFFSET(0x1946F490)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCHES_OFFSET UNITYSDK_OFFSET(0x1946F2A0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCH_1_OFFSET UNITYSDK_OFFSET(0x1946F0D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCH_2_OFFSET UNITYSDK_OFFSET(0x1946F010)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCH_3_OFFSET UNITYSDK_OFFSET(0x1946F120)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCH_4_OFFSET UNITYSDK_OFFSET(0x1946F190)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCH_5_OFFSET UNITYSDK_OFFSET(0x1946F200)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_MATCH_OFFSET UNITYSDK_OFFSET(0x1946EFD0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_10_OFFSET UNITYSDK_OFFSET(0x1946FBF0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_11_OFFSET UNITYSDK_OFFSET(0x1946FB70)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_1_OFFSET UNITYSDK_OFFSET(0x1946F620)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_2_OFFSET UNITYSDK_OFFSET(0x1946F560)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_3_OFFSET UNITYSDK_OFFSET(0x1946F680)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_4_OFFSET UNITYSDK_OFFSET(0x1946F8C0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_5_OFFSET UNITYSDK_OFFSET(0x1946F6E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_6_OFFSET UNITYSDK_OFFSET(0x1946F950)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_7_OFFSET UNITYSDK_OFFSET(0x1946FA40)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_8_OFFSET UNITYSDK_OFFSET(0x1946F9D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_9_OFFSET UNITYSDK_OFFSET(0x1946FAC0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_REPLACE_OFFSET UNITYSDK_OFFSET(0x1946F510)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_RUN_OFFSET UNITYSDK_OFFSET(0x1946EC90)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SET_CACHESIZE_OFFSET UNITYSDK_OFFSET(0x1946CC80)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SET_CAPNAMES_OFFSET UNITYSDK_OFFSET(0x1946DD40)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SET_CAPS_OFFSET UNITYSDK_OFFSET(0x1946D320)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SPLIT_1_OFFSET UNITYSDK_OFFSET(0x1946FD80)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SPLIT_2_OFFSET UNITYSDK_OFFSET(0x1946FD20)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SPLIT_3_OFFSET UNITYSDK_OFFSET(0x1946FE00)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SPLIT_4_OFFSET UNITYSDK_OFFSET(0x1946FF20)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SPLIT_5_OFFSET UNITYSDK_OFFSET(0x1946FEA0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SPLIT_OFFSET UNITYSDK_OFFSET(0x1946FCA0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1946C7A0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1946E2D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_UNESCAPE_OFFSET UNITYSDK_OFFSET(0x1946CBD0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_USEOPTIONC_OFFSET UNITYSDK_OFFSET(0x1946FFC0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_USEOPTIONINVARIANT_OFFSET UNITYSDK_OFFSET(0x1946FFB0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_USEOPTIONR_OFFSET UNITYSDK_OFFSET(0x1946E2C0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX_VALIDATEMATCHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1946BE80)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CCTOR_OFFSET UNITYSDK_OFFSET(0x1946FFD0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1946BA10)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1946BE10)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1946BE60)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1946BA60)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1946C680)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1946B9E0)
...
namespace System::Text::RegularExpressions
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Regex_TypeDefinitionIndex)->GetStaticField(0xFB0);
		}
		...
		::System::Collections::Hashtable* capnames; // 0x28
		...
		::System::Text::RegularExpressions::RegexRunnerFactory* factory; // 0x40
		::Il2CppArray<::System::String*>* capslist; // 0x48
		::System::Boolean refsInitialized; // 0x50
		::System::Text::RegularExpressions::RegexOptions roptions; // 0x54
