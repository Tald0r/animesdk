...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_GROUP_GET_CAPTURES_OFFSET UNITYSDK_OFFSET(0x193369F0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_GROUP_GET_NAME_OFFSET UNITYSDK_OFFSET(0x193369E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_GROUP_GET_SUCCESS_OFFSET UNITYSDK_OFFSET(0x193369D0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_GROUP_SYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19336A50)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_GROUP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19336B20)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_GROUP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19336BA0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_GROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19336940)
