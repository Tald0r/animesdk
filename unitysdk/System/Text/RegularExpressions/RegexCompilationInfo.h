...
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_GET_ISPUBLIC_OFFSET UNITYSDK_OFFSET(0x18D91C40)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_GET_MATCHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18D91C60)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_GET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x18D91C30)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18D91C20)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x18D91C00)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_GET_PATTERN_OFFSET UNITYSDK_OFFSET(0x18D91BF0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_INITMATCHTIMEOUTDEFAULTFOROLDVERSIONDESERIALIZATION_OFFSET UNITYSDK_OFFSET(0x18D91800)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_SET_ISPUBLIC_OFFSET UNITYSDK_OFFSET(0x18D91C50)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_SET_MATCHTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18D91BB0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_SET_NAMESPACE_OFFSET UNITYSDK_OFFSET(0x18D91B40)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_SET_NAME_OFFSET UNITYSDK_OFFSET(0x18D91A50)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_SET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x18D91C10)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO_SET_PATTERN_OFFSET UNITYSDK_OFFSET(0x18D919E0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18D918B0)
#define SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXCOMPILATIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18D91830)
