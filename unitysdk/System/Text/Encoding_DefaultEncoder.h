...
#define SYSTEM_TEXT_ENCODING_DEFAULTENCODER_GETBYTECOUNT_1_OFFSET UNITYSDK_OFFSET(0x1914ED20)
#define SYSTEM_TEXT_ENCODING_DEFAULTENCODER_GETBYTECOUNT_OFFSET UNITYSDK_OFFSET(0x1914ECF0)
#define SYSTEM_TEXT_ENCODING_DEFAULTENCODER_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x1914ED90)
#define SYSTEM_TEXT_ENCODING_DEFAULTENCODER_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1914ED50)
#define SYSTEM_TEXT_ENCODING_DEFAULTENCODER_GETREALOBJECT_OFFSET UNITYSDK_OFFSET(0x1914EB80)
#define SYSTEM_TEXT_ENCODING_DEFAULTENCODER_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x1914EC30)
#define SYSTEM_TEXT_ENCODING_DEFAULTENCODER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1914E910)
#define SYSTEM_TEXT_ENCODING_DEFAULTENCODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1914E900)
