...
#define SYSTEM_TEXT_UTF7ENCODING_DECODERUTF7FALLBACKBUFFER_FALLBACK_OFFSET UNITYSDK_OFFSET(0x1914FEE0)
#define SYSTEM_TEXT_UTF7ENCODING_DECODERUTF7FALLBACKBUFFER_GETNEXTCHAR_OFFSET UNITYSDK_OFFSET(0x1914FF30)
#define SYSTEM_TEXT_UTF7ENCODING_DECODERUTF7FALLBACKBUFFER_GET_REMAINING_OFFSET UNITYSDK_OFFSET(0x1914FF50)
#define SYSTEM_TEXT_UTF7ENCODING_DECODERUTF7FALLBACKBUFFER_INTERNALFALLBACK_OFFSET UNITYSDK_OFFSET(0x1914FF70)
#define SYSTEM_TEXT_UTF7ENCODING_DECODERUTF7FALLBACKBUFFER_RESET_OFFSET UNITYSDK_OFFSET(0x1914FF60)
#define SYSTEM_TEXT_UTF7ENCODING_DECODERUTF7FALLBACKBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1914FED0)
