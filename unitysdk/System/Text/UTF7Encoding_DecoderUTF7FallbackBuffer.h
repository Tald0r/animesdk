...
#define SYSTEM_TEXT_UTF7ENCODING_DECODERUTF7FALLBACKBUFFER_FALLBACK_OFFSET UNITYSDK_OFFSET(0x194F5860)
#define SYSTEM_TEXT_UTF7ENCODING_DECODERUTF7FALLBACKBUFFER_GETNEXTCHAR_OFFSET UNITYSDK_OFFSET(0x194F58B0)
#define SYSTEM_TEXT_UTF7ENCODING_DECODERUTF7FALLBACKBUFFER_GET_REMAINING_OFFSET UNITYSDK_OFFSET(0x194F58D0)
#define SYSTEM_TEXT_UTF7ENCODING_DECODERUTF7FALLBACKBUFFER_INTERNALFALLBACK_OFFSET UNITYSDK_OFFSET(0x194F58F0)
#define SYSTEM_TEXT_UTF7ENCODING_DECODERUTF7FALLBACKBUFFER_RESET_OFFSET UNITYSDK_OFFSET(0x194F58E0)
#define SYSTEM_TEXT_UTF7ENCODING_DECODERUTF7FALLBACKBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x194F5850)
