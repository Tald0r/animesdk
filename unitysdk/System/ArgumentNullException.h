...
#define SYSTEM_ARGUMENTNULLEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19876EE0)
#define SYSTEM_ARGUMENTNULLEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1987C780)
#define SYSTEM_ARGUMENTNULLEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1987C7F0)
#define SYSTEM_ARGUMENTNULLEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1987C6E0)
