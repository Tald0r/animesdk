...
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERBASE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B150A30)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1509F0)
