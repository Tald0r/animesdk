...
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERBASE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B76F9E0)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76F9A0)
