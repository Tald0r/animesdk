...
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1B76FB20)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B76FB60)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B76FA60)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1B76FAA0)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1B76FAE0)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1B76FBA0)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76FA20)
