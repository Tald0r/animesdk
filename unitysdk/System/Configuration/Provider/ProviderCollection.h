...
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1B150B70)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B150BB0)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B150AB0)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1B150AF0)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1B150B30)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1B150BF0)
#define SYSTEM_CONFIGURATION_PROVIDER_PROVIDERCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B150A70)
