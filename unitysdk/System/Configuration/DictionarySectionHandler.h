...
#define SYSTEM_CONFIGURATION_DICTIONARYSECTIONHANDLER_CREATE_OFFSET UNITYSDK_OFFSET(0x19D75A60)
#define SYSTEM_CONFIGURATION_DICTIONARYSECTIONHANDLER_GET_KEYATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x19D759E0)
#define SYSTEM_CONFIGURATION_DICTIONARYSECTIONHANDLER_GET_VALUEATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x19D75A20)
#define SYSTEM_CONFIGURATION_DICTIONARYSECTIONHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D759A0)
