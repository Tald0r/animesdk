...
#define SYSTEM_CONFIGURATION_DICTIONARYSECTIONHANDLER_CREATE_OFFSET UNITYSDK_OFFSET(0x1A333F50)
#define SYSTEM_CONFIGURATION_DICTIONARYSECTIONHANDLER_GET_KEYATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x1A333ED0)
#define SYSTEM_CONFIGURATION_DICTIONARYSECTIONHANDLER_GET_VALUEATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x1A333F10)
#define SYSTEM_CONFIGURATION_DICTIONARYSECTIONHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A333E90)
