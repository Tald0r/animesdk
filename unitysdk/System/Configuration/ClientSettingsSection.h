...
#define SYSTEM_CONFIGURATION_CLIENTSETTINGSSECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x18BA04E0)
#define SYSTEM_CONFIGURATION_CLIENTSETTINGSSECTION_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x18BA0520)
#define SYSTEM_CONFIGURATION_CLIENTSETTINGSSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18BA04A0)
