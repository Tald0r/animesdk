...
#define SYSTEM_CONFIGURATION_IGNORESECTIONHANDLER_CREATE_OFFSET UNITYSDK_OFFSET(0x19FD7710)
#define SYSTEM_CONFIGURATION_IGNORESECTIONHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD76D0)
