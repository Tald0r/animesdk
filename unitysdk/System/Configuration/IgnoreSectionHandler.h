...
#define SYSTEM_CONFIGURATION_IGNORESECTIONHANDLER_CREATE_OFFSET UNITYSDK_OFFSET(0x1A5F0750)
#define SYSTEM_CONFIGURATION_IGNORESECTIONHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F0710)
