...
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1858F940)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1858F980)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_CLONE_OFFSET UNITYSDK_OFFSET(0x1858F9C0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1858FA00)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1858FA40)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1858F840)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1858F880)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1858F8C0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1858F900)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ONADDCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1858FAC0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ONADD_OFFSET UNITYSDK_OFFSET(0x1858FA80)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ONCLEARCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1858FB40)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x1858FB00)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ONREMOVECOMPLETE_OFFSET UNITYSDK_OFFSET(0x1858FBC0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_ONREMOVE_OFFSET UNITYSDK_OFFSET(0x1858FB80)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1858FC00)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION_SETREADONLY_OFFSET UNITYSDK_OFFSET(0x1858FC40)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1858F800)
