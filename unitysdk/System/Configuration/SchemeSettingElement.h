...
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENT_GET_GENERICURIPARSEROPTIONS_OFFSET UNITYSDK_OFFSET(0x1967F6E0)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1967F720)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1967F760)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1967F6A0)
