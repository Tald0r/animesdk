...
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENT_GET_GENERICURIPARSEROPTIONS_OFFSET UNITYSDK_OFFSET(0x19B1E040)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19B1E080)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x19B1E0C0)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1E000)
