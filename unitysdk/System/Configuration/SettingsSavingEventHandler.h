...
#define SYSTEM_CONFIGURATION_SETTINGSSAVINGEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D240B0)
#define SYSTEM_CONFIGURATION_SETTINGSSAVINGEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D240F0)
#define SYSTEM_CONFIGURATION_SETTINGSSAVINGEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D24070)
#define SYSTEM_CONFIGURATION_SETTINGSSAVINGEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D24030)
