...
#define SYSTEM_CONFIGURATION_SETTINGSSAVINGEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x197E4D30)
#define SYSTEM_CONFIGURATION_SETTINGSSAVINGEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x197E4D70)
#define SYSTEM_CONFIGURATION_SETTINGSSAVINGEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x197E4CF0)
#define SYSTEM_CONFIGURATION_SETTINGSSAVINGEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x197E4CB0)
