...
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_CREATENEWELEMENT_OFFSET UNITYSDK_OFFSET(0x1A334190)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_GETELEMENTKEY_OFFSET UNITYSDK_OFFSET(0x1A3341D0)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_GET_COLLECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1A3340D0)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1A334150)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A334110)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A334210)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A334090)
