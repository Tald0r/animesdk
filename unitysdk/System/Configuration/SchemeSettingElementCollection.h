...
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_CREATENEWELEMENT_OFFSET UNITYSDK_OFFSET(0x19D75CA0)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_GETELEMENTKEY_OFFSET UNITYSDK_OFFSET(0x19D75CE0)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_GET_COLLECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x19D75BE0)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x19D75C60)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19D75C20)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x19D75D20)
#define SYSTEM_CONFIGURATION_SCHEMESETTINGELEMENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19D75BA0)
