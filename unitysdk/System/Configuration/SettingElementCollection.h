...
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x19058E60)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x19058EA0)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_CREATENEWELEMENT_OFFSET UNITYSDK_OFFSET(0x19058EE0)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_GETELEMENTKEY_OFFSET UNITYSDK_OFFSET(0x19058F60)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_GET_COLLECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x19058DE0)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_GET_ELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x19058E20)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_GET_OFFSET UNITYSDK_OFFSET(0x19058F20)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x19058FA0)
#define SYSTEM_CONFIGURATION_SETTINGELEMENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19058DA0)
