...
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS_GET_NEWVALUE_OFFSET UNITYSDK_OFFSET(0x191B8210)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS_GET_SETTINGCLASS_OFFSET UNITYSDK_OFFSET(0x191B8250)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS_GET_SETTINGKEY_OFFSET UNITYSDK_OFFSET(0x191B8290)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS_GET_SETTINGNAME_OFFSET UNITYSDK_OFFSET(0x191B82D0)
#define SYSTEM_CONFIGURATION_SETTINGCHANGINGEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x191B81D0)
