...
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B1505F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GET_COLLECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1B150470)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B1504B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GET_ELEMENTNAME_OFFSET UNITYSDK_OFFSET(0x1B1504F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1B150530)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1B150570)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_GET_THROWONDUPLICATE_OFFSET UNITYSDK_OFFSET(0x1B1505B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_ISMODIFIED_OFFSET UNITYSDK_OFFSET(0x1B150630)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_RESETMODIFIED_OFFSET UNITYSDK_OFFSET(0x1B1506B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_RESET_OFFSET UNITYSDK_OFFSET(0x1B150670)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1B1506F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION_UNMERGE_OFFSET UNITYSDK_OFFSET(0x1B150730)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B150430)
