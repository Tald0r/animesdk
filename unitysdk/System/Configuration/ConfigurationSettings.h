...
#define SYSTEM_CONFIGURATION_CONFIGURATIONSETTINGS_GETCONFIG_OFFSET UNITYSDK_OFFSET(0x1A333E00)
#define SYSTEM_CONFIGURATION_CONFIGURATIONSETTINGS_GET_APPSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A333DC0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A333D80)
