...
#define SYSTEM_CONFIGURATION_CONFIGURATIONSETTINGS_GETCONFIG_OFFSET UNITYSDK_OFFSET(0x19D75910)
#define SYSTEM_CONFIGURATION_CONFIGURATIONSETTINGS_GET_APPSETTINGS_OFFSET UNITYSDK_OFFSET(0x19D758D0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19D75890)
