...
#define SYSTEM_CONFIGURATION_CONFIGURATIONEXCEPTION_GETXMLNODEFILENAME_OFFSET UNITYSDK_OFFSET(0x197E49F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONEXCEPTION_GETXMLNODELINENUMBER_OFFSET UNITYSDK_OFFSET(0x197E4A30)
#define SYSTEM_CONFIGURATION_CONFIGURATIONEXCEPTION_GET_BAREMESSAGE_OFFSET UNITYSDK_OFFSET(0x197E4930)
#define SYSTEM_CONFIGURATION_CONFIGURATIONEXCEPTION_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x197E4970)
#define SYSTEM_CONFIGURATION_CONFIGURATIONEXCEPTION_GET_LINE_OFFSET UNITYSDK_OFFSET(0x197E49B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197E4770)
#define SYSTEM_CONFIGURATION_CONFIGURATIONEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x197E47B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x197E47F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x197E4830)
#define SYSTEM_CONFIGURATION_CONFIGURATIONEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x197E4870)
#define SYSTEM_CONFIGURATION_CONFIGURATIONEXCEPTION__CTOR_6_OFFSET UNITYSDK_OFFSET(0x197E48B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONEXCEPTION__CTOR_7_OFFSET UNITYSDK_OFFSET(0x197E48F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x197E4730)
