...
#define SYSTEM_CONFIGURATION_APPSETTINGSREADER_GETVALUE_OFFSET UNITYSDK_OFFSET(0x19058D60)
#define SYSTEM_CONFIGURATION_APPSETTINGSREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x19058D20)
