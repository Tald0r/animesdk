...
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1967F860)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1967F8A0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1967F920)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1967F9A0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1967FA20)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_PROVIDER_OFFSET UNITYSDK_OFFSET(0x1967FAA0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_SERIALIZEAS_OFFSET UNITYSDK_OFFSET(0x1967FB20)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_THROWONERRORDESERIALIZING_OFFSET UNITYSDK_OFFSET(0x1967FBA0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_GET_THROWONERRORSERIALIZING_OFFSET UNITYSDK_OFFSET(0x1967FC20)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1967F8E0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1967F960)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1967F9E0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1967FA60)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_PROVIDER_OFFSET UNITYSDK_OFFSET(0x1967FAE0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_SERIALIZEAS_OFFSET UNITYSDK_OFFSET(0x1967FB60)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_THROWONERRORDESERIALIZING_OFFSET UNITYSDK_OFFSET(0x1967FBE0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY_SET_THROWONERRORSERIALIZING_OFFSET UNITYSDK_OFFSET(0x1967FC60)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1967F7E0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1967F820)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1967F7A0)
