...
#define SYSTEM_CONFIGURATION_SETTINGSLOADEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19420090)
#define SYSTEM_CONFIGURATION_SETTINGSLOADEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x194200D0)
#define SYSTEM_CONFIGURATION_SETTINGSLOADEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19420050)
#define SYSTEM_CONFIGURATION_SETTINGSLOADEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19420010)
