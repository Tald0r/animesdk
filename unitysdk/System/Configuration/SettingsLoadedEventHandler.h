...
#define SYSTEM_CONFIGURATION_SETTINGSLOADEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1900A220)
#define SYSTEM_CONFIGURATION_SETTINGSLOADEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1900A260)
#define SYSTEM_CONFIGURATION_SETTINGSLOADEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1900A1E0)
#define SYSTEM_CONFIGURATION_SETTINGSLOADEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1900A1A0)
