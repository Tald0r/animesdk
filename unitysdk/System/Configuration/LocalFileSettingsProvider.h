...
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_GETPREVIOUSVERSION_OFFSET UNITYSDK_OFFSET(0x197E4B30)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_GETPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x197E4B70)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_GET_APPLICATIONNAME_OFFSET UNITYSDK_OFFSET(0x197E4AB0)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x197E4BB0)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_RESET_OFFSET UNITYSDK_OFFSET(0x197E4BF0)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_SETPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x197E4C30)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_SET_APPLICATIONNAME_OFFSET UNITYSDK_OFFSET(0x197E4AF0)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_UPGRADE_OFFSET UNITYSDK_OFFSET(0x197E4C70)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x197E4A70)
