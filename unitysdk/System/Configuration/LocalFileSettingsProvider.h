...
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_GETPREVIOUSVERSION_OFFSET UNITYSDK_OFFSET(0x19D23EB0)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_GETPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x19D23EF0)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_GET_APPLICATIONNAME_OFFSET UNITYSDK_OFFSET(0x19D23E30)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19D23F30)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_RESET_OFFSET UNITYSDK_OFFSET(0x19D23F70)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_SETPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x19D23FB0)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_SET_APPLICATIONNAME_OFFSET UNITYSDK_OFFSET(0x19D23E70)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER_UPGRADE_OFFSET UNITYSDK_OFFSET(0x19D23FF0)
#define SYSTEM_CONFIGURATION_LOCALFILESETTINGSPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D23DF0)
