...
#define SYSTEM_CONFIGURATION_SETTINGSMANAGEABILITYATTRIBUTE_GET_MANAGEABILITY_OFFSET UNITYSDK_OFFSET(0x18FB3EF0)
#define SYSTEM_CONFIGURATION_SETTINGSMANAGEABILITYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB3EE0)
