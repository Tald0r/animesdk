...
#define SYSTEM_CONFIGURATION_IRIPARSINGELEMENT_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x19D75AE0)
#define SYSTEM_CONFIGURATION_IRIPARSINGELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x19D75B60)
#define SYSTEM_CONFIGURATION_IRIPARSINGELEMENT_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x19D75B20)
#define SYSTEM_CONFIGURATION_IRIPARSINGELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19D75AA0)
