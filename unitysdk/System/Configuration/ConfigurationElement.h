...
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_DESERIALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x1B150230)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B1501F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_INITIALIZEDEFAULT_OFFSET UNITYSDK_OFFSET(0x1B150270)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_ISMODIFIED_OFFSET UNITYSDK_OFFSET(0x1B1502B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_POSTDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B1502F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_RESETMODIFIED_OFFSET UNITYSDK_OFFSET(0x1B150370)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_RESET_OFFSET UNITYSDK_OFFSET(0x1B150330)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_SERIALIZETOXMLELEMENT_OFFSET UNITYSDK_OFFSET(0x1B1503B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT_UNMERGE_OFFSET UNITYSDK_OFFSET(0x1B1503F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1501B0)
