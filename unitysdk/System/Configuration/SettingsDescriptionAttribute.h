...
#define SYSTEM_CONFIGURATION_SETTINGSDESCRIPTIONATTRIBUTE_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1944F0A0)
#define SYSTEM_CONFIGURATION_SETTINGSDESCRIPTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1944F090)
