...
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_DESERIALIZED_OFFSET UNITYSDK_OFFSET(0x1900A2E0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x1900A360)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1900A3E0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_PROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1900A460)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_PROPERTY_OFFSET UNITYSDK_OFFSET(0x1900A420)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_SERIALIZEDVALUE_OFFSET UNITYSDK_OFFSET(0x1900A4E0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_USINGDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1900A560)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_SET_DESERIALIZED_OFFSET UNITYSDK_OFFSET(0x1900A320)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_SET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x1900A3A0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_SET_PROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1900A4A0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_SET_SERIALIZEDVALUE_OFFSET UNITYSDK_OFFSET(0x1900A520)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1900A2A0)
