...
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_DESERIALIZED_OFFSET UNITYSDK_OFFSET(0x19420150)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x194201D0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19420250)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_PROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x194202D0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_PROPERTY_OFFSET UNITYSDK_OFFSET(0x19420290)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_SERIALIZEDVALUE_OFFSET UNITYSDK_OFFSET(0x19420350)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_GET_USINGDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x194203D0)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_SET_DESERIALIZED_OFFSET UNITYSDK_OFFSET(0x19420190)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_SET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x19420210)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_SET_PROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x19420310)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE_SET_SERIALIZEDVALUE_OFFSET UNITYSDK_OFFSET(0x19420390)
#define SYSTEM_CONFIGURATION_SETTINGSPROPERTYVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19420110)
