...
#define SYSTEM_CONFIGURATION_SETTINGSSERIALIZEASATTRIBUTE_GET_SERIALIZEAS_OFFSET UNITYSDK_OFFSET(0x197E4DC0)
#define SYSTEM_CONFIGURATION_SETTINGSSERIALIZEASATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x197E4DB0)
