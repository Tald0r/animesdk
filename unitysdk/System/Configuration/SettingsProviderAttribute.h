...
#define SYSTEM_CONFIGURATION_SETTINGSPROVIDERATTRIBUTE_GET_PROVIDERTYPENAME_OFFSET UNITYSDK_OFFSET(0x182D9A70)
#define SYSTEM_CONFIGURATION_SETTINGSPROVIDERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x182D9A60)
#define SYSTEM_CONFIGURATION_SETTINGSPROVIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x182D9A50)
