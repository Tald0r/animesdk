...
#define SYSTEM_CONFIGURATION_SETTINGSPROVIDERATTRIBUTE_GET_PROVIDERTYPENAME_OFFSET UNITYSDK_OFFSET(0x188EE760)
#define SYSTEM_CONFIGURATION_SETTINGSPROVIDERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x188EE750)
#define SYSTEM_CONFIGURATION_SETTINGSPROVIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x188EE740)
