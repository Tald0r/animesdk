...
#define SYSTEM_CONFIGURATION_IDNELEMENT_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x191B8110)
#define SYSTEM_CONFIGURATION_IDNELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x191B8190)
#define SYSTEM_CONFIGURATION_IDNELEMENT_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x191B8150)
#define SYSTEM_CONFIGURATION_IDNELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x191B80D0)
