...
#define SYSTEM_CONFIGURATION_IDNELEMENT_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x18D6F460)
#define SYSTEM_CONFIGURATION_IDNELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x18D6F4E0)
#define SYSTEM_CONFIGURATION_IDNELEMENT_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x18D6F4A0)
#define SYSTEM_CONFIGURATION_IDNELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D6F420)
