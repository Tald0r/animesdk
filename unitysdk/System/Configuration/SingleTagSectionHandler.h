...
#define SYSTEM_CONFIGURATION_SINGLETAGSECTIONHANDLER_CREATE_OFFSET UNITYSDK_OFFSET(0x188EE7E0)
#define SYSTEM_CONFIGURATION_SINGLETAGSECTIONHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x188EE7A0)
