...
#define SYSTEM_CONFIGURATION_SETTINGSGROUPDESCRIPTIONATTRIBUTE_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A334260)
#define SYSTEM_CONFIGURATION_SETTINGSGROUPDESCRIPTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A334250)
