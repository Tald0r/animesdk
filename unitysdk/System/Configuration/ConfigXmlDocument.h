...
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1931BC30)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1931BC70)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_LOADSINGLEELEMENT_OFFSET UNITYSDK_OFFSET(0x1931BD30)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_SYSTEM_CONFIGURATION_INTERNAL_ICONFIGERRORINFO_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1931BCB0)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_SYSTEM_CONFIGURATION_INTERNAL_ICONFIGERRORINFO_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x1931BCF0)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1931BBF0)
