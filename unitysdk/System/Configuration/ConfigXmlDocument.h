...
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x18F4BAC0)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x18F4BB00)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_LOADSINGLEELEMENT_OFFSET UNITYSDK_OFFSET(0x18F4BBC0)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_SYSTEM_CONFIGURATION_INTERNAL_ICONFIGERRORINFO_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x18F4BB40)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT_SYSTEM_CONFIGURATION_INTERNAL_ICONFIGERRORINFO_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x18F4BB80)
#define SYSTEM_CONFIGURATION_CONFIGXMLDOCUMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18F4BA80)
