...
#define SYSTEM_CONFIGURATION_SETTINGELEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1941FDD0)
#define SYSTEM_CONFIGURATION_SETTINGELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1941FE50)
#define SYSTEM_CONFIGURATION_SETTINGELEMENT_GET_SERIALIZEAS_OFFSET UNITYSDK_OFFSET(0x1941FE90)
#define SYSTEM_CONFIGURATION_SETTINGELEMENT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1941FF10)
#define SYSTEM_CONFIGURATION_SETTINGELEMENT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1941FE10)
#define SYSTEM_CONFIGURATION_SETTINGELEMENT_SET_SERIALIZEAS_OFFSET UNITYSDK_OFFSET(0x1941FED0)
#define SYSTEM_CONFIGURATION_SETTINGELEMENT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1941FF50)
#define SYSTEM_CONFIGURATION_SETTINGELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1941FD90)
#define SYSTEM_CONFIGURATION_SETTINGELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1941FD50)
