...
#define SYSTEM_CONFIGURATION_SETTINGSBASE_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x19FD7790)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19FD77D0)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19FD7810)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x19FD7890)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_GET_PROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x19FD78D0)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_GET_PROVIDERS_OFFSET UNITYSDK_OFFSET(0x19FD7910)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19FD7950)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_SAVE_OFFSET UNITYSDK_OFFSET(0x19FD7990)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19FD7850)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_SYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19FD79D0)
#define SYSTEM_CONFIGURATION_SETTINGSBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD7750)
