...
#define SYSTEM_CONFIGURATION_SETTINGSBASE_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1A5F07D0)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1A5F0810)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A5F0850)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A5F08D0)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_GET_PROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x1A5F0910)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_GET_PROVIDERS_OFFSET UNITYSDK_OFFSET(0x1A5F0950)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A5F0990)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_SAVE_OFFSET UNITYSDK_OFFSET(0x1A5F09D0)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A5F0890)
#define SYSTEM_CONFIGURATION_SETTINGSBASE_SYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1A5F0A10)
#define SYSTEM_CONFIGURATION_SETTINGSBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F0790)
