...
#define SYSTEM_CONFIGURATION_URISECTION_GET_IDN_OFFSET UNITYSDK_OFFSET(0x18E39670)
#define SYSTEM_CONFIGURATION_URISECTION_GET_IRIPARSING_OFFSET UNITYSDK_OFFSET(0x18E396B0)
#define SYSTEM_CONFIGURATION_URISECTION_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x18E396F0)
#define SYSTEM_CONFIGURATION_URISECTION_GET_SCHEMESETTINGS_OFFSET UNITYSDK_OFFSET(0x18E39730)
#define SYSTEM_CONFIGURATION_URISECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18E39630)
