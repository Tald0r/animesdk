...
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_DESERIALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x191B8410)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x191B8350)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_GET_VALUEXML_OFFSET UNITYSDK_OFFSET(0x191B8390)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_ISMODIFIED_OFFSET UNITYSDK_OFFSET(0x191B8450)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_RESETMODIFIED_OFFSET UNITYSDK_OFFSET(0x191B84D0)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_RESET_OFFSET UNITYSDK_OFFSET(0x191B8490)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_SERIALIZETOXMLELEMENT_OFFSET UNITYSDK_OFFSET(0x191B8510)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_SET_VALUEXML_OFFSET UNITYSDK_OFFSET(0x191B83D0)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_UNMERGE_OFFSET UNITYSDK_OFFSET(0x191B8550)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x191B8310)
