...
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_DESERIALIZEELEMENT_OFFSET UNITYSDK_OFFSET(0x18D6F760)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x18D6F6A0)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_GET_VALUEXML_OFFSET UNITYSDK_OFFSET(0x18D6F6E0)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_ISMODIFIED_OFFSET UNITYSDK_OFFSET(0x18D6F7A0)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_RESETMODIFIED_OFFSET UNITYSDK_OFFSET(0x18D6F820)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_RESET_OFFSET UNITYSDK_OFFSET(0x18D6F7E0)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_SERIALIZETOXMLELEMENT_OFFSET UNITYSDK_OFFSET(0x18D6F860)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_SET_VALUEXML_OFFSET UNITYSDK_OFFSET(0x18D6F720)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT_UNMERGE_OFFSET UNITYSDK_OFFSET(0x18D6F8A0)
#define SYSTEM_CONFIGURATION_SETTINGVALUEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D6F660)
