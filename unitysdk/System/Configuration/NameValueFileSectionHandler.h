...
#define SYSTEM_CONFIGURATION_NAMEVALUEFILESECTIONHANDLER_CREATE_OFFSET UNITYSDK_OFFSET(0x1931BDB0)
#define SYSTEM_CONFIGURATION_NAMEVALUEFILESECTIONHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1931BD70)
