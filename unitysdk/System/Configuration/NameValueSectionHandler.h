...
#define SYSTEM_CONFIGURATION_NAMEVALUESECTIONHANDLER_CREATE_OFFSET UNITYSDK_OFFSET(0x191CA8E0)
#define SYSTEM_CONFIGURATION_NAMEVALUESECTIONHANDLER_GET_KEYATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x191CA860)
#define SYSTEM_CONFIGURATION_NAMEVALUESECTIONHANDLER_GET_VALUEATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x191CA8A0)
#define SYSTEM_CONFIGURATION_NAMEVALUESECTIONHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x191CA820)
