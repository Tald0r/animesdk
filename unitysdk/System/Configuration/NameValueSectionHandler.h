...
#define SYSTEM_CONFIGURATION_NAMEVALUESECTIONHANDLER_CREATE_OFFSET UNITYSDK_OFFSET(0x195C6C70)
#define SYSTEM_CONFIGURATION_NAMEVALUESECTIONHANDLER_GET_KEYATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x195C6BF0)
#define SYSTEM_CONFIGURATION_NAMEVALUESECTIONHANDLER_GET_VALUEATTRIBUTENAME_OFFSET UNITYSDK_OFFSET(0x195C6C30)
#define SYSTEM_CONFIGURATION_NAMEVALUESECTIONHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x195C6BB0)
