...
#define SYSTEM_CONFIGURATION_CONFIGURATIONPROPERTYCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B76F820)
#define SYSTEM_CONFIGURATION_CONFIGURATIONPROPERTYCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B76F760)
#define SYSTEM_CONFIGURATION_CONFIGURATIONPROPERTYCOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1B76F7A0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONPROPERTYCOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1B76F7E0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONPROPERTYCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1B76F860)
#define SYSTEM_CONFIGURATION_CONFIGURATIONPROPERTYCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76F720)
