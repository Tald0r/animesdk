...
#define SYSTEM_CONFIGURATION_CONFIGURATIONPROPERTYCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B150870)
#define SYSTEM_CONFIGURATION_CONFIGURATIONPROPERTYCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B1507B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONPROPERTYCOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1B1507F0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONPROPERTYCOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1B150830)
#define SYSTEM_CONFIGURATION_CONFIGURATIONPROPERTYCOLLECTION_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1B1508B0)
#define SYSTEM_CONFIGURATION_CONFIGURATIONPROPERTYCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B150770)
