...
#define SYSTEM_ASSEMBLYLOADEVENTARGS_GET_LOADEDASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1857EEC0)
#define SYSTEM_ASSEMBLYLOADEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1857D8D0)
