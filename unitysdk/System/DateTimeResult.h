...
#define SYSTEM_DATETIMERESULT_INIT_OFFSET UNITYSDK_OFFSET(0x842C90)
#define SYSTEM_DATETIMERESULT_SETDATE_OFFSET UNITYSDK_OFFSET(0x2CA8F0)
#define SYSTEM_DATETIMERESULT_SETFAILURE_1_OFFSET UNITYSDK_OFFSET(0x842CD0)
#define SYSTEM_DATETIMERESULT_SETFAILURE_OFFSET UNITYSDK_OFFSET(0x842CC0)
