...
#define SYSTEM_MEDIA_SOUNDPLAYER_ADD_LOADCOMPLETED_OFFSET UNITYSDK_OFFSET(0x193A2B00)
#define SYSTEM_MEDIA_SOUNDPLAYER_ADD_SOUNDLOCATIONCHANGED_OFFSET UNITYSDK_OFFSET(0x193A2B80)
#define SYSTEM_MEDIA_SOUNDPLAYER_ADD_STREAMCHANGED_OFFSET UNITYSDK_OFFSET(0x193A2C00)
#define SYSTEM_MEDIA_SOUNDPLAYER_GET_ISLOADCOMPLETED_OFFSET UNITYSDK_OFFSET(0x193A28C0)
#define SYSTEM_MEDIA_SOUNDPLAYER_GET_LOADTIMEOUT_OFFSET UNITYSDK_OFFSET(0x193A2900)
#define SYSTEM_MEDIA_SOUNDPLAYER_GET_SOUNDLOCATION_OFFSET UNITYSDK_OFFSET(0x193A2980)
#define SYSTEM_MEDIA_SOUNDPLAYER_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x193A2A00)
#define SYSTEM_MEDIA_SOUNDPLAYER_GET_TAG_OFFSET UNITYSDK_OFFSET(0x193A2A80)
#define SYSTEM_MEDIA_SOUNDPLAYER_LOADASYNC_OFFSET UNITYSDK_OFFSET(0x193A2CC0)
#define SYSTEM_MEDIA_SOUNDPLAYER_LOAD_OFFSET UNITYSDK_OFFSET(0x193A2C80)
#define SYSTEM_MEDIA_SOUNDPLAYER_ONLOADCOMPLETED_OFFSET UNITYSDK_OFFSET(0x193A2D00)
#define SYSTEM_MEDIA_SOUNDPLAYER_ONSOUNDLOCATIONCHANGED_OFFSET UNITYSDK_OFFSET(0x193A2D40)
#define SYSTEM_MEDIA_SOUNDPLAYER_ONSTREAMCHANGED_OFFSET UNITYSDK_OFFSET(0x193A2D80)
#define SYSTEM_MEDIA_SOUNDPLAYER_PLAYLOOPING_OFFSET UNITYSDK_OFFSET(0x193A2E00)
#define SYSTEM_MEDIA_SOUNDPLAYER_PLAYSYNC_OFFSET UNITYSDK_OFFSET(0x193A2E40)
#define SYSTEM_MEDIA_SOUNDPLAYER_PLAY_OFFSET UNITYSDK_OFFSET(0x193A2DC0)
#define SYSTEM_MEDIA_SOUNDPLAYER_REMOVE_LOADCOMPLETED_OFFSET UNITYSDK_OFFSET(0x193A2B40)
#define SYSTEM_MEDIA_SOUNDPLAYER_REMOVE_SOUNDLOCATIONCHANGED_OFFSET UNITYSDK_OFFSET(0x193A2BC0)
#define SYSTEM_MEDIA_SOUNDPLAYER_REMOVE_STREAMCHANGED_OFFSET UNITYSDK_OFFSET(0x193A2C40)
#define SYSTEM_MEDIA_SOUNDPLAYER_SET_LOADTIMEOUT_OFFSET UNITYSDK_OFFSET(0x193A2940)
#define SYSTEM_MEDIA_SOUNDPLAYER_SET_SOUNDLOCATION_OFFSET UNITYSDK_OFFSET(0x193A29C0)
#define SYSTEM_MEDIA_SOUNDPLAYER_SET_STREAM_OFFSET UNITYSDK_OFFSET(0x193A2A40)
#define SYSTEM_MEDIA_SOUNDPLAYER_SET_TAG_OFFSET UNITYSDK_OFFSET(0x193A2AC0)
#define SYSTEM_MEDIA_SOUNDPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0x193A2E80)
#define SYSTEM_MEDIA_SOUNDPLAYER_SYSTEM_RUNTIME_SERIALIZATION_ISERIALIZABLE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x193A2EC0)
#define SYSTEM_MEDIA_SOUNDPLAYER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193A2800)
#define SYSTEM_MEDIA_SOUNDPLAYER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x193A2840)
#define SYSTEM_MEDIA_SOUNDPLAYER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x193A2880)
#define SYSTEM_MEDIA_SOUNDPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x193A27C0)
