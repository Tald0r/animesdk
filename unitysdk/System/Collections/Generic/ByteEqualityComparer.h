...
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0BD7F0)
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0BD5F0)
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER_GETHASHCODE_1_OFFSET UNITYSDK_OFFSET(0x1A0BD820)
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0BD600)
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A0BD610)
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER_LASTINDEXOF_OFFSET UNITYSDK_OFFSET(0x1A0BD790)
#define SYSTEM_COLLECTIONS_GENERIC_BYTEEQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0BD8E0)
