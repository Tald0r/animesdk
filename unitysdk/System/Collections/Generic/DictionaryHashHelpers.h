...
#define SYSTEM_COLLECTIONS_GENERIC_DICTIONARYHASHHELPERS__CCTOR_OFFSET UNITYSDK_OFFSET(0x197960D0)
#define SYSTEM_COLLECTIONS_GENERIC_DICTIONARYHASHHELPERS__CTOR_OFFSET UNITYSDK_OFFSET(0x197960C0)
