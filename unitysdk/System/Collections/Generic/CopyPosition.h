...
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_GET_COLUMN_OFFSET UNITYSDK_OFFSET(0x302230)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_GET_DEBUGGERDISPLAY_OFFSET UNITYSDK_OFFSET(0x7F8310)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_GET_ROW_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_GET_START_OFFSET UNITYSDK_OFFSET(0x187C6E20)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x7F82E0)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x2F3C30)
