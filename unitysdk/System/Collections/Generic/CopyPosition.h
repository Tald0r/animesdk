...
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_GET_COLUMN_OFFSET UNITYSDK_OFFSET(0x2D38E0)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_GET_DEBUGGERDISPLAY_OFFSET UNITYSDK_OFFSET(0x7C4470)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_GET_ROW_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_GET_START_OFFSET UNITYSDK_OFFSET(0x1822CA40)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x7C4440)
#define SYSTEM_COLLECTIONS_GENERIC_COPYPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3730)
