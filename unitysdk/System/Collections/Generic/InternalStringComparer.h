...
#define SYSTEM_COLLECTIONS_GENERIC_INTERNALSTRINGCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x192EAB00)
#define SYSTEM_COLLECTIONS_GENERIC_INTERNALSTRINGCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x192EAA70)
#define SYSTEM_COLLECTIONS_GENERIC_INTERNALSTRINGCOMPARER_INDEXOF_OFFSET UNITYSDK_OFFSET(0x192EAB30)
#define SYSTEM_COLLECTIONS_GENERIC_INTERNALSTRINGCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x192EABC0)
