...
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x19317B60)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_ASGENERICDICTIONARY_OFFSET UNITYSDK_OFFSET(0x19317F30)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_CLEAR_OFFSET UNITYSDK_OFFSET(0x19317C60)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x19317C90)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_CONTAINSVALUE_OFFSET UNITYSDK_OFFSET(0x19317D90)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_COPYTO_OFFSET UNITYSDK_OFFSET(0x19317DC0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19317DF0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19317850)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19317880)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x193178B0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x19317AD0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x19317B00)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x19317B30)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_REMOVE_OFFSET UNITYSDK_OFFSET(0x19317E20)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_REPLACEHASHTABLE_OFFSET UNITYSDK_OFFSET(0x19317F20)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x193179D0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x193177F0)
