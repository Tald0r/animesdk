...
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3999D0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_EQUALS_OFFSET UNITYSDK_OFFSET(0x888520)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x888580)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_GET_MASK_OFFSET UNITYSDK_OFFSET(0x34B1E0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x547780)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x191AF080)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x191AF090)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8885E0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x191AF100)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x3999C0)
