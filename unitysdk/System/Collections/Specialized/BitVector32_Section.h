...
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x316490)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_EQUALS_OFFSET UNITYSDK_OFFSET(0x84B270)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x84B2D0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_GET_MASK_OFFSET UNITYSDK_OFFSET(0x3305B0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x555760)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18D66390)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18D663A0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x84B330)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18D66410)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x316480)
