...
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVEHASHTABLE_1_OFFSET UNITYSDK_OFFSET(0x1A5ED4F0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVEHASHTABLE_2_OFFSET UNITYSDK_OFFSET(0x1A5ED550)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVEHASHTABLE_OFFSET UNITYSDK_OFFSET(0x1A5ED470)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVESORTEDLIST_OFFSET UNITYSDK_OFFSET(0x1A5ED5B0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5ED5F0)
