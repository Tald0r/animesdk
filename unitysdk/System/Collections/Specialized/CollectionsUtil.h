...
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVEHASHTABLE_1_OFFSET UNITYSDK_OFFSET(0x19FD44C0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVEHASHTABLE_2_OFFSET UNITYSDK_OFFSET(0x19FD4520)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVEHASHTABLE_OFFSET UNITYSDK_OFFSET(0x19FD4440)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL_CREATECASEINSENSITIVESORTEDLIST_OFFSET UNITYSDK_OFFSET(0x19FD4580)
#define SYSTEM_COLLECTIONS_SPECIALIZED_COLLECTIONSUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD45C0)
