...
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER_ADD_OFFSET UNITYSDK_OFFSET(0x19FD48A0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x19FD4930)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19FD4770)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER_REMOVE_OFFSET UNITYSDK_OFFSET(0x19FD49C0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19FD4810)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FD46B0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARYWITHCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD45D0)
