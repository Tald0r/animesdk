...
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_ADD_OFFSET UNITYSDK_OFFSET(0x1908DD30)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1908DE80)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1908DE50)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1908E8C0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1908DEB0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1908DEE0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x1908DFB0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x1908E070)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_REMOVE_OFFSET UNITYSDK_OFFSET(0x1908E130)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1908DDC0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_STRING___ADD_OFFSET UNITYSDK_OFFSET(0x1908E200)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_STRING___CONTAINS_OFFSET UNITYSDK_OFFSET(0x1908E240)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_STRING___COPYTO_OFFSET UNITYSDK_OFFSET(0x1908E2E0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_STRING___GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1908E750)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SYSTEM_COLLECTIONS_GENERIC_ICOLLECTION_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_STRING___REMOVE_OFFSET UNITYSDK_OFFSET(0x1908E760)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1908E870)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1908E190)
#define SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY_GENERICADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1908DD20)
...
namespace System::Collections::Specialized
{
	...
	{
	public:
		::System::Collections::Specialized::StringDictionary_GenericAdapter_ICollectionToGenericCollectionAdapter* _values; // 0x10
