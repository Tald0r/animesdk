...
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_COUNTBITSSET_OFFSET UNITYSDK_OFFSET(0x1904B150)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_CREATEMASKFROMHIGHVALUE_OFFSET UNITYSDK_OFFSET(0x1904B230)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_CREATEMASK_1_OFFSET UNITYSDK_OFFSET(0x1904B1B0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_CREATEMASK_OFFSET UNITYSDK_OFFSET(0x1904B170)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_CREATESECTIONHELPER_OFFSET UNITYSDK_OFFSET(0x1904B280)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_CREATESECTION_1_OFFSET UNITYSDK_OFFSET(0x1904B440)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_CREATESECTION_OFFSET UNITYSDK_OFFSET(0x1904B270)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_EQUALS_OFFSET UNITYSDK_OFFSET(0x877E30)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x877E90)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_GET_DATA_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x877DE0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x877DB0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x877E00)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x877DC0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x877EF0)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1904B510)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32__CTOR_1_OFFSET UNITYSDK_OFFSET(0x302300)
#define SYSTEM_COLLECTIONS_SPECIALIZED_BITVECTOR32__CTOR_OFFSET UNITYSDK_OFFSET(0x302300)
