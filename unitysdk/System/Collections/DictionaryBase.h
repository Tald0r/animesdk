...
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x19AF8170)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_COPYTO_OFFSET UNITYSDK_OFFSET(0x19AF7DC0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19AF8350)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19AF7AA0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_GET_INNERHASHTABLE_OFFSET UNITYSDK_OFFSET(0x19AF7A30)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_ONGET_OFFSET UNITYSDK_OFFSET(0x19AF8450)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19AF7BC0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x19AF7CC0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x19AF80E0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x19AF8060)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x19AF7B40)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x19AF7AC0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19AF7E50)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x19AF7C40)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x19AF7D40)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_REMOVE_OFFSET UNITYSDK_OFFSET(0x19AF81F0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19AF7EF0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19AF83D0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF8460)
