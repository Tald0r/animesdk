...
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x19659800)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_COPYTO_OFFSET UNITYSDK_OFFSET(0x19659450)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x196599E0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19659130)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_GET_INNERHASHTABLE_OFFSET UNITYSDK_OFFSET(0x196590C0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_ONGET_OFFSET UNITYSDK_OFFSET(0x19659AE0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19659250)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x19659350)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x19659770)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x196596F0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x196591D0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x19659150)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x196594E0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x196592D0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x196593D0)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_REMOVE_OFFSET UNITYSDK_OFFSET(0x19659880)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19659580)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19659A60)
#define SYSTEM_COLLECTIONS_DICTIONARYBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19659AF0)
