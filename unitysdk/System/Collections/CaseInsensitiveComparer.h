...
#define SYSTEM_COLLECTIONS_CASEINSENSITIVECOMPARER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1959CBE0)
#define SYSTEM_COLLECTIONS_CASEINSENSITIVECOMPARER_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x1959CAD0)
#define SYSTEM_COLLECTIONS_CASEINSENSITIVECOMPARER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1959CA50)
#define SYSTEM_COLLECTIONS_CASEINSENSITIVECOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1959C9B0)
