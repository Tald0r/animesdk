...
#define SYSTEM_COLLECTIONS_DICTIONARYENTRY_GET_KEY_OFFSET UNITYSDK_OFFSET(0x223870)
#define SYSTEM_COLLECTIONS_DICTIONARYENTRY_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x272280)
#define SYSTEM_COLLECTIONS_DICTIONARYENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x301710)
