...
#define SYSTEM_COLLECTIONS_HASHTABLE_KEYCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1959D160)
#define SYSTEM_COLLECTIONS_HASHTABLE_KEYCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1959D340)
#define SYSTEM_COLLECTIONS_HASHTABLE_KEYCOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1959D420)
#define SYSTEM_COLLECTIONS_HASHTABLE_KEYCOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1959D3C0)
#define SYSTEM_COLLECTIONS_HASHTABLE_KEYCOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1959D3F0)
#define SYSTEM_COLLECTIONS_HASHTABLE_KEYCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1959D150)
