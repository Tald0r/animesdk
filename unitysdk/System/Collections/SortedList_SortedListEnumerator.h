...
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_CLONE_OFFSET UNITYSDK_OFFSET(0x19ACFA10)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19ACFD50)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x19ACFC80)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_GET_KEY_OFFSET UNITYSDK_OFFSET(0x19ACFAB0)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19ACFE00)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19ACFB70)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19ACFEC0)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACF9D0)
