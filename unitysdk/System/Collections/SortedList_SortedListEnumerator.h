...
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0BDFC0)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A0BE300)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x1A0BE230)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1A0BE060)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A0BE3B0)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A0BE120)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A0BE470)
#define SYSTEM_COLLECTIONS_SORTEDLIST_SORTEDLISTENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0BDF80)
...
namespace System::Collections
{
	...
	public:
		...
		::System::Int32 getObjectRetType; // 0x3C
