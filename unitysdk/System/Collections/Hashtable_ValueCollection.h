...
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1A0BD910)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A0BDB00)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A0BDBE0)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x1A0BDB80)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x1A0BDBB0)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0BD900)
