...
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x19ACF360)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19ACF550)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19ACF630)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19ACF5D0)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x19ACF600)
#define SYSTEM_COLLECTIONS_HASHTABLE_VALUECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACF350)
