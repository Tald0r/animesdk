...
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x191B0430)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x191B05C0)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE_GET_LICENSEPROVIDER_OFFSET UNITYSDK_OFFSET(0x191B0370)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE_GET_TYPEID_OFFSET UNITYSDK_OFFSET(0x191B03C0)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x191B05D0)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191B0350)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191B0360)
#define SYSTEM_COMPONENTMODEL_LICENSEPROVIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x191B0340)
