...
#define SYSTEM_COMPONENTMODEL_HANDLEDEVENTARGS_GET_HANDLED_OFFSET UNITYSDK_OFFSET(0x187CB560)
#define SYSTEM_COMPONENTMODEL_HANDLEDEVENTARGS_SET_HANDLED_OFFSET UNITYSDK_OFFSET(0x187CB570)
#define SYSTEM_COMPONENTMODEL_HANDLEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x187CB530)
#define SYSTEM_COMPONENTMODEL_HANDLEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x187CB500)
