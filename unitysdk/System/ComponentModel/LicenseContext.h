...
#define SYSTEM_COMPONENTMODEL_LICENSECONTEXT_GETSAVEDLICENSEKEY_OFFSET UNITYSDK_OFFSET(0x18B95BE0)
#define SYSTEM_COMPONENTMODEL_LICENSECONTEXT_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x18B95BF0)
#define SYSTEM_COMPONENTMODEL_LICENSECONTEXT_GET_USAGEMODE_OFFSET UNITYSDK_OFFSET(0x18B95BD0)
#define SYSTEM_COMPONENTMODEL_LICENSECONTEXT_SETSAVEDLICENSEKEY_OFFSET UNITYSDK_OFFSET(0x18B95C00)
#define SYSTEM_COMPONENTMODEL_LICENSECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B95C10)
