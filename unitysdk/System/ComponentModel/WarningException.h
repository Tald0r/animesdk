...
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x188EE520)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION_GET_HELPTOPIC_OFFSET UNITYSDK_OFFSET(0x188EE510)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION_GET_HELPURL_OFFSET UNITYSDK_OFFSET(0x188EE500)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x188EE270)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x188EE2E0)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x188EE360)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x188EE1F0)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x188EE3D0)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188EE180)
