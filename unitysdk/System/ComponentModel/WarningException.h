...
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x182D9830)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION_GET_HELPTOPIC_OFFSET UNITYSDK_OFFSET(0x182D9820)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION_GET_HELPURL_OFFSET UNITYSDK_OFFSET(0x182D9810)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x182D9580)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x182D95F0)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x182D9670)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x182D9500)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x182D96E0)
#define SYSTEM_COMPONENTMODEL_WARNINGEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x182D9490)
