...
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x187CC240)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x187CC370)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x187CC2B0)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x187CC420)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x187CC730)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GETCREATEINSTANCESUPPORTED_OFFSET UNITYSDK_OFFSET(0x187CC750)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GETPROPERTIESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x187CC7A0)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x187CC770)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GETSTANDARDVALUESEXCLUSIVE_OFFSET UNITYSDK_OFFSET(0x187CCC80)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GETSTANDARDVALUESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x187CCC60)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GETSTANDARDVALUES_OFFSET UNITYSDK_OFFSET(0x187CC7C0)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GET_NULLABLETYPE_OFFSET UNITYSDK_OFFSET(0x187CCDD0)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GET_UNDERLYINGTYPECONVERTER_OFFSET UNITYSDK_OFFSET(0x187CCDF0)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_GET_UNDERLYINGTYPE_OFFSET UNITYSDK_OFFSET(0x187CCDE0)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER_ISVALID_OFFSET UNITYSDK_OFFSET(0x187CCCA0)
#define SYSTEM_COMPONENTMODEL_NULLABLECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x187CC190)
...
namespace System::ComponentModel
{
	...
	public:
		...
		::System::Type* simpleType; // 0x18
		::System::ComponentModel::TypeConverter* simpleTypeConverter; // 0x20
