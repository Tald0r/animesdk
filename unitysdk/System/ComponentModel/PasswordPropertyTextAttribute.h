...
#define SYSTEM_COMPONENTMODEL_PASSWORDPROPERTYTEXTATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1967D910)
#define SYSTEM_COMPONENTMODEL_PASSWORDPROPERTYTEXTATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1967D970)
#define SYSTEM_COMPONENTMODEL_PASSWORDPROPERTYTEXTATTRIBUTE_GET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1967D900)
#define SYSTEM_COMPONENTMODEL_PASSWORDPROPERTYTEXTATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1967D980)
#define SYSTEM_COMPONENTMODEL_PASSWORDPROPERTYTEXTATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1967DA40)
#define SYSTEM_COMPONENTMODEL_PASSWORDPROPERTYTEXTATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1967D8F0)
#define SYSTEM_COMPONENTMODEL_PASSWORDPROPERTYTEXTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1967D8E0)
