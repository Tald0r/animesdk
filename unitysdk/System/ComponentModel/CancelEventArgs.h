...
#define SYSTEM_COMPONENTMODEL_CANCELEVENTARGS_GET_CANCEL_OFFSET UNITYSDK_OFFSET(0x1936E470)
#define SYSTEM_COMPONENTMODEL_CANCELEVENTARGS_SET_CANCEL_OFFSET UNITYSDK_OFFSET(0x1936E480)
#define SYSTEM_COMPONENTMODEL_CANCELEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1936E440)
#define SYSTEM_COMPONENTMODEL_CANCELEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1936E410)
