...
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1908EED0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1908EF80)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE_GET_DATAMEMBER_OFFSET UNITYSDK_OFFSET(0x1908EEC0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE_GET_DATASOURCE_OFFSET UNITYSDK_OFFSET(0x1908EEB0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1908EF90)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1908EE90)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1908EEA0)
#define SYSTEM_COMPONENTMODEL_COMPLEXBINDINGPROPERTIESATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1908EE80)
