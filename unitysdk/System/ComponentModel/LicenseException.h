...
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x18585520)
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION_GET_LICENSEDTYPE_OFFSET UNITYSDK_OFFSET(0x18585510)
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18585100)
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18585080)
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18585370)
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18585400)
#define SYSTEM_COMPONENTMODEL_LICENSEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18584EC0)
