...
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER_APPLYRESOURCES_1_OFFSET UNITYSDK_OFFSET(0x195C2140)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER_APPLYRESOURCES_OFFSET UNITYSDK_OFFSET(0x195C2120)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER_FILLRESOURCES_OFFSET UNITYSDK_OFFSET(0x195C2CE0)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER_GET_NEUTRALRESOURCESCULTURE_OFFSET UNITYSDK_OFFSET(0x195C2090)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195C2030)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x195C1FD0)
