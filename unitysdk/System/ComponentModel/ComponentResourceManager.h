...
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER_APPLYRESOURCES_1_OFFSET UNITYSDK_OFFSET(0x191C5DB0)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER_APPLYRESOURCES_OFFSET UNITYSDK_OFFSET(0x191C5D90)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER_FILLRESOURCES_OFFSET UNITYSDK_OFFSET(0x191C6950)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER_GET_NEUTRALRESOURCESCULTURE_OFFSET UNITYSDK_OFFSET(0x191C5D00)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191C5CA0)
#define SYSTEM_COMPONENTMODEL_COMPONENTRESOURCEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x191C5C40)
