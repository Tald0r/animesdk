...
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x18584B40)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18584BF0)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE_GET_DESIGNERBASETYPENAME_OFFSET UNITYSDK_OFFSET(0x18584A90)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE_GET_DESIGNERTYPENAME_OFFSET UNITYSDK_OFFSET(0x18584AA0)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE_GET_TYPEID_OFFSET UNITYSDK_OFFSET(0x18584AB0)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18584880)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x185848F0)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18584990)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x18584A40)
#define SYSTEM_COMPONENTMODEL_DESIGNERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x185847B0)
