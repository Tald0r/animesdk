...
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_ATTRIBUTEPROVIDER_ATTRIBUTETYPEDESCRIPTOR_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18D6B1E0)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_ATTRIBUTEPROVIDER_ATTRIBUTETYPEDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18D6B1D0)
