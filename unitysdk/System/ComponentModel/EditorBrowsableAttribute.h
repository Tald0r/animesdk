...
#define SYSTEM_COMPONENTMODEL_EDITORBROWSABLEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x188D6810)
#define SYSTEM_COMPONENTMODEL_EDITORBROWSABLEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x188D6870)
#define SYSTEM_COMPONENTMODEL_EDITORBROWSABLEATTRIBUTE_GET_STATE_OFFSET UNITYSDK_OFFSET(0x188D6800)
#define SYSTEM_COMPONENTMODEL_EDITORBROWSABLEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x188D67F0)
#define SYSTEM_COMPONENTMODEL_EDITORBROWSABLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x188D67E0)
