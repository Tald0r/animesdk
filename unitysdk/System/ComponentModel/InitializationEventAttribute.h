...
#define SYSTEM_COMPONENTMODEL_INITIALIZATIONEVENTATTRIBUTE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x1931A680)
#define SYSTEM_COMPONENTMODEL_INITIALIZATIONEVENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1931A670)
