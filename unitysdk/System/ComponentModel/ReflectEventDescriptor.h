...
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_ADDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1939E570)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_FILLATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1939ED00)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_FILLEVENTINFOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1939ED50)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_FILLMETHODS_OFFSET UNITYSDK_OFFSET(0x1939DED0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_FILLSINGLEMETHODATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1939F1E0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1939DEC0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1939DEA0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_GET_ISMULTICAST_OFFSET UNITYSDK_OFFSET(0x1939E510)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR_REMOVEEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1939F6A0)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1939DD00)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1939DE00)
#define SYSTEM_COMPONENTMODEL_REFLECTEVENTDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1939DB60)
...
namespace System::ComponentModel
{
	...
	public:
		...
		::System::Reflection::EventInfo* realEvent; // 0x68
		::System::Reflection::MethodInfo* addMethod; // 0x70
		::System::Type* type; // 0x78
		::System::Reflection::MethodInfo* removeMethod; // 0x80
