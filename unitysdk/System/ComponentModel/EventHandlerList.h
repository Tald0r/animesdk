...
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_ADDHANDLERS_OFFSET UNITYSDK_OFFSET(0x19B1B7E0)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_ADDHANDLER_OFFSET UNITYSDK_OFFSET(0x19B1B740)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19B1B8C0)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_FIND_OFFSET UNITYSDK_OFFSET(0x19B1B680)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19B1B650)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_REMOVEHANDLER_OFFSET UNITYSDK_OFFSET(0x19B1B8D0)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19B1B6B0)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B1B640)
#define SYSTEM_COMPONENTMODEL_EVENTHANDLERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1B630)
