...
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_ATTRIBUTEFILTERCACHEITEM_ISVALID_OFFSET UNITYSDK_OFFSET(0x188EA380)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_ATTRIBUTEFILTERCACHEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x188EA3F0)
