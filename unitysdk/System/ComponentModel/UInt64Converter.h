...
#define SYSTEM_COMPONENTMODEL_UINT64CONVERTER_FROMSTRING_1_OFFSET UNITYSDK_OFFSET(0x187D2B00)
#define SYSTEM_COMPONENTMODEL_UINT64CONVERTER_FROMSTRING_2_OFFSET UNITYSDK_OFFSET(0x187D2B40)
#define SYSTEM_COMPONENTMODEL_UINT64CONVERTER_FROMSTRING_OFFSET UNITYSDK_OFFSET(0x187D2A50)
#define SYSTEM_COMPONENTMODEL_UINT64CONVERTER_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x187D2A20)
#define SYSTEM_COMPONENTMODEL_UINT64CONVERTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x187D2B80)
#define SYSTEM_COMPONENTMODEL_UINT64CONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x187D2C10)
