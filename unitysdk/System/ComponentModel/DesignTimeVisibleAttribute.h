...
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x191AFE40)
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x191AFEA0)
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0x191AFE30)
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x191AFF10)
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x191AFFB0)
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191AFE20)
#define SYSTEM_COMPONENTMODEL_DESIGNTIMEVISIBLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x191AFE10)
