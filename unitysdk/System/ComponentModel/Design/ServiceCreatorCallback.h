...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECREATORCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x182C17A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECREATORCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x182C17E0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECREATORCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x182C1200)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECREATORCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x182C11F0)
