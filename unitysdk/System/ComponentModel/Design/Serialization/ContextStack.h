...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_CONTEXTSTACK_APPEND_OFFSET UNITYSDK_OFFSET(0x191AFBE0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_CONTEXTSTACK_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x191AF9E0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_CONTEXTSTACK_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x191AFB00)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_CONTEXTSTACK_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x191AFA40)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_CONTEXTSTACK_POP_OFFSET UNITYSDK_OFFSET(0x191AFCB0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_CONTEXTSTACK_PUSH_OFFSET UNITYSDK_OFFSET(0x191AFD40)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_CONTEXTSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x191AFE00)
