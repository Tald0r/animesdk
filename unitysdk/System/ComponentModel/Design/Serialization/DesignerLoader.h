...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DESIGNERLOADER_FLUSH_OFFSET UNITYSDK_OFFSET(0x18FDE2A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DESIGNERLOADER_GET_LOADING_OFFSET UNITYSDK_OFFSET(0x18FDE290)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DESIGNERLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDE2B0)
