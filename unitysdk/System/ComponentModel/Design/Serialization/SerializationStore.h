...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_SERIALIZATIONSTORE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18FB12F0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_SERIALIZATIONSTORE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18FB12D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_SERIALIZATIONSTORE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB1310)
