...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_EQUALS_OFFSET UNITYSDK_OFFSET(0x868BB0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x868C10)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x2C3A90)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_GET_MEMBER_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18FDE4B0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18FDE4D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP__CCTOR_OFFSET UNITYSDK_OFFSET(0x18FDE4F0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_MEMBERRELATIONSHIP__CTOR_OFFSET UNITYSDK_OFFSET(0x868BA0)
