...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DEFAULTSERIALIZATIONPROVIDERATTRIBUTE_GET_PROVIDERTYPENAME_OFFSET UNITYSDK_OFFSET(0x1939CB10)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DEFAULTSERIALIZATIONPROVIDERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1939CAA0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DEFAULTSERIALIZATIONPROVIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1939CA20)
