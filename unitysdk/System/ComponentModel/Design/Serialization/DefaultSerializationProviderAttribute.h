...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DEFAULTSERIALIZATIONPROVIDERATTRIBUTE_GET_PROVIDERTYPENAME_OFFSET UNITYSDK_OFFSET(0x18FB0710)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DEFAULTSERIALIZATIONPROVIDERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FB06A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERIALIZATION_DEFAULTSERIALIZATIONPROVIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FB0620)
