...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x18E35390)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x18E355C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x18E354B0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18E356B0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18E351E0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERVERB__CTOR_OFFSET UNITYSDK_OFFSET(0x18E34FF0)
