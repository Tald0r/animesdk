...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNTIMELICENSECONTEXT_GETSAVEDLICENSEKEY_OFFSET UNITYSDK_OFFSET(0x1936F6A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNTIMELICENSECONTEXT_GET_USAGEMODE_OFFSET UNITYSDK_OFFSET(0x1936F690)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNTIMELICENSECONTEXT_SETSAVEDLICENSEKEY_OFFSET UNITYSDK_OFFSET(0x1936F6B0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNTIMELICENSECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1936F700)
