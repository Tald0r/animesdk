...
#define SYSTEM_COMPONENTMODEL_DESIGN_STANDARDTOOLWINDOWS__CCTOR_OFFSET UNITYSDK_OFFSET(0x18584640)
#define SYSTEM_COMPONENTMODEL_DESIGN_STANDARDTOOLWINDOWS__CTOR_OFFSET UNITYSDK_OFFSET(0x18584630)
