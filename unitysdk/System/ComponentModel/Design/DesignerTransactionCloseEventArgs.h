...
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTIONCLOSEEVENTARGS_GET_LASTTRANSACTION_OFFSET UNITYSDK_OFFSET(0x19FD6720)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTIONCLOSEEVENTARGS_GET_TRANSACTIONCOMMITTED_OFFSET UNITYSDK_OFFSET(0x19FD6710)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTIONCLOSEEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FD66D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_DESIGNERTRANSACTIONCLOSEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD66A0)
