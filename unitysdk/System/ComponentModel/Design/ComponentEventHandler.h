...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A331CC0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A331D00)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A331740)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A331720)
