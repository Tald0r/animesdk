...
#define SYSTEM_COMPONENTMODEL_DESIGN_CHECKOUTEXCEPTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x190515B0)
#define SYSTEM_COMPONENTMODEL_DESIGN_CHECKOUTEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19051410)
#define SYSTEM_COMPONENTMODEL_DESIGN_CHECKOUTEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19051480)
#define SYSTEM_COMPONENTMODEL_DESIGN_CHECKOUTEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x190514F0)
#define SYSTEM_COMPONENTMODEL_DESIGN_CHECKOUTEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19051540)
#define SYSTEM_COMPONENTMODEL_DESIGN_CHECKOUTEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19051370)
