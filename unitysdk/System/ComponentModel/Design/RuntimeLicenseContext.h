...
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT_CASEINSENSITIVEMANIFESTRESOURCESTREAMLOOKUP_OFFSET UNITYSDK_OFFSET(0x1A332BE0)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT_GETLOCALPATH_OFFSET UNITYSDK_OFFSET(0x1A331F80)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT_GETSAVEDLICENSEKEY_OFFSET UNITYSDK_OFFSET(0x1A332070)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT_OPENREAD_OFFSET UNITYSDK_OFFSET(0x1A332D90)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A332EF0)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A332EE0)
