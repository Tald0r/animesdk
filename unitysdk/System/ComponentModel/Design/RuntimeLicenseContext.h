...
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT_CASEINSENSITIVEMANIFESTRESOURCESTREAMLOOKUP_OFFSET UNITYSDK_OFFSET(0x19D74710)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT_GETLOCALPATH_OFFSET UNITYSDK_OFFSET(0x19D73AB0)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT_GETSAVEDLICENSEKEY_OFFSET UNITYSDK_OFFSET(0x19D73BA0)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT_OPENREAD_OFFSET UNITYSDK_OFFSET(0x19D748C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D74A20)
#define SYSTEM_COMPONENTMODEL_DESIGN_RUNTIMELICENSECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19D74A10)
