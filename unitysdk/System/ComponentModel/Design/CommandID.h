...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_EQUALS_OFFSET UNITYSDK_OFFSET(0x19679B30)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19679BF0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_GET_GUID_OFFSET UNITYSDK_OFFSET(0x19679C20)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_GET_ID_OFFSET UNITYSDK_OFFSET(0x19679B20)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19679C30)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID__CTOR_OFFSET UNITYSDK_OFFSET(0x19679B10)
