...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B18470)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B18530)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_GET_GUID_OFFSET UNITYSDK_OFFSET(0x19B18560)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_GET_ID_OFFSET UNITYSDK_OFFSET(0x19B18460)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B18570)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMMANDID__CTOR_OFFSET UNITYSDK_OFFSET(0x19B18450)
