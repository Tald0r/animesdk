...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_ADDSERVICE_1_OFFSET UNITYSDK_OFFSET(0x18230130)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_ADDSERVICE_2_OFFSET UNITYSDK_OFFSET(0x182304D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_ADDSERVICE_3_OFFSET UNITYSDK_OFFSET(0x182304F0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_ADDSERVICE_OFFSET UNITYSDK_OFFSET(0x18230110)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x182307D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x182307B0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x182309E0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_GET_CONTAINER_OFFSET UNITYSDK_OFFSET(0x1822FF10)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_GET_DEFAULTSERVICES_OFFSET UNITYSDK_OFFSET(0x18230040)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_GET_SERVICES_OFFSET UNITYSDK_OFFSET(0x182300A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_REMOVESERVICE_1_OFFSET UNITYSDK_OFFSET(0x18230DE0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_REMOVESERVICE_OFFSET UNITYSDK_OFFSET(0x18230DC0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18230ED0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1822FF00)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1822FEF0)
