...
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_ADDSERVICE_1_OFFSET UNITYSDK_OFFSET(0x187CA530)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_ADDSERVICE_2_OFFSET UNITYSDK_OFFSET(0x187CA8D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_ADDSERVICE_3_OFFSET UNITYSDK_OFFSET(0x187CA8F0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_ADDSERVICE_OFFSET UNITYSDK_OFFSET(0x187CA510)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x187CABD0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x187CABB0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x187CADE0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_GET_CONTAINER_OFFSET UNITYSDK_OFFSET(0x187CA310)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_GET_DEFAULTSERVICES_OFFSET UNITYSDK_OFFSET(0x187CA440)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_GET_SERVICES_OFFSET UNITYSDK_OFFSET(0x187CA4A0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_REMOVESERVICE_1_OFFSET UNITYSDK_OFFSET(0x187CB1E0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER_REMOVESERVICE_OFFSET UNITYSDK_OFFSET(0x187CB1C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x187CB2D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x187CA300)
#define SYSTEM_COMPONENTMODEL_DESIGN_SERVICECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x187CA2F0)
