...
#define SYSTEM_COMPONENTMODEL_DESIGN_ACTIVEDESIGNEREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x197DFC70)
#define SYSTEM_COMPONENTMODEL_DESIGN_ACTIVEDESIGNEREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x197DFCB0)
#define SYSTEM_COMPONENTMODEL_DESIGN_ACTIVEDESIGNEREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x197DF6F0)
#define SYSTEM_COMPONENTMODEL_DESIGN_ACTIVEDESIGNEREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x197DF6E0)
