...
#define SYSTEM_COMPONENTMODEL_DESIGN_STANDARDCOMMANDS__CCTOR_OFFSET UNITYSDK_OFFSET(0x197E0200)
#define SYSTEM_COMPONENTMODEL_DESIGN_STANDARDCOMMANDS__CTOR_OFFSET UNITYSDK_OFFSET(0x197E01F0)
