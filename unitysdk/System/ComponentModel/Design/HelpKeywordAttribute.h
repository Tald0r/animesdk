...
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x191C7440)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x191C74C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_GET_HELPKEYWORD_OFFSET UNITYSDK_OFFSET(0x191C7430)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x191C74D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x191C75D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191C7340)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191C73B0)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x191C7330)
