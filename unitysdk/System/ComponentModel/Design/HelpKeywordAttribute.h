...
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x195C37D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195C3850)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_GET_HELPKEYWORD_OFFSET UNITYSDK_OFFSET(0x195C37C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x195C3860)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x195C3960)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195C36D0)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x195C3740)
#define SYSTEM_COMPONENTMODEL_DESIGN_HELPKEYWORDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x195C36C0)
