...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x182C1160)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_MEMBER_OFFSET UNITYSDK_OFFSET(0x182C1170)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_NEWVALUE_OFFSET UNITYSDK_OFFSET(0x182C1180)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_OLDVALUE_OFFSET UNITYSDK_OFFSET(0x182C1190)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x182C11A0)
