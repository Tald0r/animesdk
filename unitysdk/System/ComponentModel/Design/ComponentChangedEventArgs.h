...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x188D5E20)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_MEMBER_OFFSET UNITYSDK_OFFSET(0x188D5E30)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_NEWVALUE_OFFSET UNITYSDK_OFFSET(0x188D5E40)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS_GET_OLDVALUE_OFFSET UNITYSDK_OFFSET(0x188D5E50)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x188D5E60)
