...
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_ADD_COMMANDCHANGED_OFFSET UNITYSDK_OFFSET(0x19B19380)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_CHECKED_OFFSET UNITYSDK_OFFSET(0x19B19100)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_COMMANDID_OFFSET UNITYSDK_OFFSET(0x19B19400)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x19B191E0)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_OLESTATUS_OFFSET UNITYSDK_OFFSET(0x19B19550)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x19B19250)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_SUPPORTED_OFFSET UNITYSDK_OFFSET(0x19B19280)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0x19B19300)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_INVOKE_1_OFFSET UNITYSDK_OFFSET(0x19B19540)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_INVOKE_OFFSET UNITYSDK_OFFSET(0x19B19410)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_ONCOMMANDCHANGED_OFFSET UNITYSDK_OFFSET(0x19B19560)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_REMOVE_COMMANDCHANGED_OFFSET UNITYSDK_OFFSET(0x19B193C0)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_SETSTATUS_OFFSET UNITYSDK_OFFSET(0x19B19170)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_SET_CHECKED_OFFSET UNITYSDK_OFFSET(0x19B19110)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x19B191F0)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_SET_SUPPORTED_OFFSET UNITYSDK_OFFSET(0x19B19290)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_SET_VISIBLE_OFFSET UNITYSDK_OFFSET(0x19B19310)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B19580)
#define SYSTEM_COMPONENTMODEL_DESIGN_MENUCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x19B190F0)
...
namespace System::ComponentModel::Design
{
	...
	public:
		...
		::System::ComponentModel::Design::CommandID* commandID; // 0x10
		::System::EventHandler* execHandler; // 0x18
		::System::EventHandler* statusHandler; // 0x20
		::System::Collections::IDictionary* properties; // 0x28
