...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTRENAMEEVENTARGS_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x191C7060)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTRENAMEEVENTARGS_GET_NEWNAME_OFFSET UNITYSDK_OFFSET(0x191C7080)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTRENAMEEVENTARGS_GET_OLDNAME_OFFSET UNITYSDK_OFFSET(0x191C7070)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTRENAMEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x191C7090)
