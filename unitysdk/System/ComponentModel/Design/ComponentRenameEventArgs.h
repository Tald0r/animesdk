...
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTRENAMEEVENTARGS_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x195C33F0)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTRENAMEEVENTARGS_GET_NEWNAME_OFFSET UNITYSDK_OFFSET(0x195C3410)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTRENAMEEVENTARGS_GET_OLDNAME_OFFSET UNITYSDK_OFFSET(0x195C3400)
#define SYSTEM_COMPONENTMODEL_DESIGN_COMPONENTRENAMEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x195C3420)
