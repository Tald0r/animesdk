...
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_ADDVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1967E270)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1967DE80)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x1967E3E0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_FILLATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1967E530)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETCHILDPROPERTIES_1_OFFSET UNITYSDK_OFFSET(0x1967E570)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETCHILDPROPERTIES_2_OFFSET UNITYSDK_OFFSET(0x1967E590)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETCHILDPROPERTIES_3_OFFSET UNITYSDK_OFFSET(0x1967E5B0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETCHILDPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1967E550)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETEDITOR_OFFSET UNITYSDK_OFFSET(0x1967E720)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1967EAD0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETINVOCATIONTARGET_OFFSET UNITYSDK_OFFSET(0x1967EB30)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETTYPEFROMNAME_OFFSET UNITYSDK_OFFSET(0x1967DCD0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETVALUECHANGEDHANDLER_OFFSET UNITYSDK_OFFSET(0x1967EDF0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GET_CONVERTER_OFFSET UNITYSDK_OFFSET(0x1967DB20)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GET_ISLOCALIZABLE_OFFSET UNITYSDK_OFFSET(0x1967E0B0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GET_SERIALIZATIONVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1967E1D0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GET_SUPPORTSCHANGEEVENTS_OFFSET UNITYSDK_OFFSET(0x1967EE40)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1967EC30)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_REMOVEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1967EC90)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1967DB00)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1967DB10)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1967DAF0)
