...
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_ADDVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19B1CBD0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19B1C7E0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B1CD40)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_FILLATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19B1CE90)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETCHILDPROPERTIES_1_OFFSET UNITYSDK_OFFSET(0x19B1CED0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETCHILDPROPERTIES_2_OFFSET UNITYSDK_OFFSET(0x19B1CEF0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETCHILDPROPERTIES_3_OFFSET UNITYSDK_OFFSET(0x19B1CF10)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETCHILDPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19B1CEB0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETEDITOR_OFFSET UNITYSDK_OFFSET(0x19B1D080)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B1D430)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETINVOCATIONTARGET_OFFSET UNITYSDK_OFFSET(0x19B1D490)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETTYPEFROMNAME_OFFSET UNITYSDK_OFFSET(0x19B1C630)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GETVALUECHANGEDHANDLER_OFFSET UNITYSDK_OFFSET(0x19B1D750)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GET_CONVERTER_OFFSET UNITYSDK_OFFSET(0x19B1C480)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GET_ISLOCALIZABLE_OFFSET UNITYSDK_OFFSET(0x19B1CA10)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GET_SERIALIZATIONVISIBILITY_OFFSET UNITYSDK_OFFSET(0x19B1CB30)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_GET_SUPPORTSCHANGEEVENTS_OFFSET UNITYSDK_OFFSET(0x19B1D7A0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19B1D590)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR_REMOVEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19B1D5F0)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B1C460)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19B1C470)
#define SYSTEM_COMPONENTMODEL_PROPERTYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1C450)
...
namespace System::ComponentModel
{
	...
	public:
		...
		::System::Collections::Hashtable* valueChangedHandlers; // 0x70
		::Il2CppArray<::System::Type*>* editorTypes; // 0x78
