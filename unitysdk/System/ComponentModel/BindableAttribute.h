...
#define SYSTEM_COMPONENTMODEL_BINDABLEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1939C860)
#define SYSTEM_COMPONENTMODEL_BINDABLEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1939C8C0)
#define SYSTEM_COMPONENTMODEL_BINDABLEATTRIBUTE_GET_BINDABLE_OFFSET UNITYSDK_OFFSET(0x1939C840)
#define SYSTEM_COMPONENTMODEL_BINDABLEATTRIBUTE_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1939C850)
#define SYSTEM_COMPONENTMODEL_BINDABLEATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1939C8D0)
#define SYSTEM_COMPONENTMODEL_BINDABLEATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1939C9A0)
#define SYSTEM_COMPONENTMODEL_BINDABLEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1939C7F0)
#define SYSTEM_COMPONENTMODEL_BINDABLEATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1939C800)
#define SYSTEM_COMPONENTMODEL_BINDABLEATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1939C820)
#define SYSTEM_COMPONENTMODEL_BINDABLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1939C7E0)
