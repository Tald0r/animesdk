...
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1822E040)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1822E0B0)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1822E120)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1822EEB0)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_GETCULTURENAME_OFFSET UNITYSDK_OFFSET(0x1822E020)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_GETSTANDARDVALUESEXCLUSIVE_OFFSET UNITYSDK_OFFSET(0x1822F4A0)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_GETSTANDARDVALUESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1822F4B0)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_GETSTANDARDVALUES_OFFSET UNITYSDK_OFFSET(0x1822ECD0)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_GET_DEFAULTCULTURESTRING_OFFSET UNITYSDK_OFFSET(0x1822DFE0)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1822F4C0)
