...
#define SYSTEM_COMPONENTMODEL_REFRESHEVENTARGS_GET_COMPONENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1936FE70)
#define SYSTEM_COMPONENTMODEL_REFRESHEVENTARGS_GET_TYPECHANGED_OFFSET UNITYSDK_OFFSET(0x1936FE80)
#define SYSTEM_COMPONENTMODEL_REFRESHEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1936FE40)
#define SYSTEM_COMPONENTMODEL_REFRESHEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1936FDF0)
