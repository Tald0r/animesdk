...
#define SYSTEM_COMPONENTMODEL_EXPANDABLEOBJECTCONVERTER_GETPROPERTIESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x182C1D80)
#define SYSTEM_COMPONENTMODEL_EXPANDABLEOBJECTCONVERTER_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x182C1BC0)
#define SYSTEM_COMPONENTMODEL_EXPANDABLEOBJECTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x182C1BB0)
