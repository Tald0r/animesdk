...
#define SYSTEM_COMPONENTMODEL_RECOMMENDEDASCONFIGURABLEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x19239A40)
#define SYSTEM_COMPONENTMODEL_RECOMMENDEDASCONFIGURABLEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19239AC0)
#define SYSTEM_COMPONENTMODEL_RECOMMENDEDASCONFIGURABLEATTRIBUTE_GET_RECOMMENDEDASCONFIGURABLE_OFFSET UNITYSDK_OFFSET(0x19239A30)
#define SYSTEM_COMPONENTMODEL_RECOMMENDEDASCONFIGURABLEATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19239AD0)
#define SYSTEM_COMPONENTMODEL_RECOMMENDEDASCONFIGURABLEATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19239AE0)
#define SYSTEM_COMPONENTMODEL_RECOMMENDEDASCONFIGURABLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19239A20)
