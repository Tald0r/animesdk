...
#define SYSTEM_COMPONENTMODEL_ATTRIBUTEPROVIDERATTRIBUTE_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x18F495D0)
#define SYSTEM_COMPONENTMODEL_ATTRIBUTEPROVIDERATTRIBUTE_GET_TYPENAME_OFFSET UNITYSDK_OFFSET(0x18F495C0)
#define SYSTEM_COMPONENTMODEL_ATTRIBUTEPROVIDERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F49490)
#define SYSTEM_COMPONENTMODEL_ATTRIBUTEPROVIDERATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18F49540)
#define SYSTEM_COMPONENTMODEL_ATTRIBUTEPROVIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18F49420)
