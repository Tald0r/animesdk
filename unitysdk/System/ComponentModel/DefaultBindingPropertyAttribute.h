...
#define SYSTEM_COMPONENTMODEL_DEFAULTBINDINGPROPERTYATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x195C3310)
#define SYSTEM_COMPONENTMODEL_DEFAULTBINDINGPROPERTYATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195C3390)
#define SYSTEM_COMPONENTMODEL_DEFAULTBINDINGPROPERTYATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x195C3300)
#define SYSTEM_COMPONENTMODEL_DEFAULTBINDINGPROPERTYATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x195C33A0)
#define SYSTEM_COMPONENTMODEL_DEFAULTBINDINGPROPERTYATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195C32F0)
#define SYSTEM_COMPONENTMODEL_DEFAULTBINDINGPROPERTYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x195C32E0)
