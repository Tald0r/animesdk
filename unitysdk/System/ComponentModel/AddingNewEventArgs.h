...
#define SYSTEM_COMPONENTMODEL_ADDINGNEWEVENTARGS_GET_NEWOBJECT_OFFSET UNITYSDK_OFFSET(0x19D729D0)
#define SYSTEM_COMPONENTMODEL_ADDINGNEWEVENTARGS_SET_NEWOBJECT_OFFSET UNITYSDK_OFFSET(0x19D729E0)
#define SYSTEM_COMPONENTMODEL_ADDINGNEWEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D729A0)
#define SYSTEM_COMPONENTMODEL_ADDINGNEWEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19D72980)
