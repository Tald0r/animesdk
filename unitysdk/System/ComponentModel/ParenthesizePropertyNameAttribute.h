...
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x192398A0)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19239900)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_GET_NEEDPARENTHESIS_OFFSET UNITYSDK_OFFSET(0x19239890)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19239910)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x192399D0)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19239880)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19239870)
