...
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x18E36600)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18E36660)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_GET_NEEDPARENTHESIS_OFFSET UNITYSDK_OFFSET(0x18E365F0)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18E36670)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18E36730)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18E365E0)
#define SYSTEM_COMPONENTMODEL_PARENTHESIZEPROPERTYNAMEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E365D0)
