...
#define SYSTEM_COMPONENTMODEL_DATETIMEOFFSETCONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1A5EE330)
#define SYSTEM_COMPONENTMODEL_DATETIMEOFFSETCONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1A5EE3A0)
#define SYSTEM_COMPONENTMODEL_DATETIMEOFFSETCONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1A5EE410)
#define SYSTEM_COMPONENTMODEL_DATETIMEOFFSETCONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1A5EE7A0)
#define SYSTEM_COMPONENTMODEL_DATETIMEOFFSETCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5EF6D0)
