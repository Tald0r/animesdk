...
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x18B95B20)
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18B95BC0)
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE_GET_INSTALLERTYPE_OFFSET UNITYSDK_OFFSET(0x18B95AE0)
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B95AD0)
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B95AA0)
