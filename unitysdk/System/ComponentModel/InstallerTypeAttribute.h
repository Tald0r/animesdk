...
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x18584DC0)
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18584E60)
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE_GET_INSTALLERTYPE_OFFSET UNITYSDK_OFFSET(0x18584D80)
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18584D70)
#define SYSTEM_COMPONENTMODEL_INSTALLERTYPEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18584D40)
