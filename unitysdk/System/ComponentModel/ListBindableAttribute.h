...
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x18B5D3A0)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18B5D400)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE_GET_LISTBINDABLE_OFFSET UNITYSDK_OFFSET(0x18B5D390)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18B5D410)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18B5D4E0)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B5D380)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B5D370)
