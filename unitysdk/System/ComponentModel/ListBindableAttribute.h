...
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x19051C30)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19051C90)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE_GET_LISTBINDABLE_OFFSET UNITYSDK_OFFSET(0x19051C20)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19051CA0)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19051D70)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19051C10)
#define SYSTEM_COMPONENTMODEL_LISTBINDABLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19051C00)
