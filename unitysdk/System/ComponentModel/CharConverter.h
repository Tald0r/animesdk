...
#define SYSTEM_COMPONENTMODEL_CHARCONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1908E910)
#define SYSTEM_COMPONENTMODEL_CHARCONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1908EC50)
#define SYSTEM_COMPONENTMODEL_CHARCONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1908E9C0)
#define SYSTEM_COMPONENTMODEL_CHARCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1908EE60)
