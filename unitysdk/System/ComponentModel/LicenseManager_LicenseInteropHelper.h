...
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_ALLOCATEANDVALIDATELICENSE_OFFSET UNITYSDK_OFFSET(0x19239050)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_GETCURRENTCONTEXTINFO_OFFSET UNITYSDK_OFFSET(0x19239630)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_GETLICINFO_OFFSET UNITYSDK_OFFSET(0x192393F0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_REQUESTLICKEY_OFFSET UNITYSDK_OFFSET(0x19239290)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER_SAVEKEYINCURRENTCONTEXT_OFFSET UNITYSDK_OFFSET(0x19239780)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LICENSEINTEROPHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19239860)
