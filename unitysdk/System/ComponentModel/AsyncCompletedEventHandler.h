...
#define SYSTEM_COMPONENTMODEL_ASYNCCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1822D2C0)
#define SYSTEM_COMPONENTMODEL_ASYNCCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1822D300)
#define SYSTEM_COMPONENTMODEL_ASYNCCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1822CD40)
#define SYSTEM_COMPONENTMODEL_ASYNCCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1822CD30)
