...
#define SYSTEM_COMPONENTMODEL_DOWORKEVENTARGS_GET_ARGUMENT_OFFSET UNITYSDK_OFFSET(0x18B95A70)
#define SYSTEM_COMPONENTMODEL_DOWORKEVENTARGS_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x18B95A80)
#define SYSTEM_COMPONENTMODEL_DOWORKEVENTARGS_SET_RESULT_OFFSET UNITYSDK_OFFSET(0x18B95A90)
#define SYSTEM_COMPONENTMODEL_DOWORKEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18B8DDF0)
