...
#define SYSTEM_COMPONENTMODEL_DOWORKEVENTARGS_GET_ARGUMENT_OFFSET UNITYSDK_OFFSET(0x18584D10)
#define SYSTEM_COMPONENTMODEL_DOWORKEVENTARGS_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x18584D20)
#define SYSTEM_COMPONENTMODEL_DOWORKEVENTARGS_SET_RESULT_OFFSET UNITYSDK_OFFSET(0x18584D30)
#define SYSTEM_COMPONENTMODEL_DOWORKEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1857CF80)
