...
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_ADDVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x18234760)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_CANRESETVALUE_OFFSET UNITYSDK_OFFSET(0x18235D40)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERCANRESETVALUE_OFFSET UNITYSDK_OFFSET(0x182348F0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERGETRECEIVERTYPE_OFFSET UNITYSDK_OFFSET(0x18234D50)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERGETTYPE_OFFSET UNITYSDK_OFFSET(0x18234D60)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERGETVALUE_OFFSET UNITYSDK_OFFSET(0x18234BF0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERRESETVALUE_OFFSET UNITYSDK_OFFSET(0x18234D70)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERSETVALUE_OFFSET UNITYSDK_OFFSET(0x182352D0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_EXTENDERSHOULDSERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x182357F0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_FILLATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x18236600)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GETVALUE_OFFSET UNITYSDK_OFFSET(0x18235FC0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_AMBIENTVALUE_OFFSET UNITYSDK_OFFSET(0x182331A0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_CHANGEDEVENTVALUE_OFFSET UNITYSDK_OFFSET(0x182332F0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x18233640)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x18233650)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_GETMETHODVALUE_OFFSET UNITYSDK_OFFSET(0x18233860)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_IPROPCHANGEDEVENTVALUE_OFFSET UNITYSDK_OFFSET(0x18233450)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_ISEXTENDER_OFFSET UNITYSDK_OFFSET(0x18233C60)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x18233C70)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x18234250)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_RESETMETHODVALUE_OFFSET UNITYSDK_OFFSET(0x18234260)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_SETMETHODVALUE_OFFSET UNITYSDK_OFFSET(0x18233D40)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_SHOULDSERIALIZEMETHODVALUE_OFFSET UNITYSDK_OFFSET(0x182344E0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_GET_SUPPORTSCHANGEEVENTS_OFFSET UNITYSDK_OFFSET(0x182382D0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_ONINOTIFYPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x18237350)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x18237510)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_REMOVEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x18237600)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x18237790)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x18237C00)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_SET_IPROPCHANGEDEVENTVALUE_OFFSET UNITYSDK_OFFSET(0x182335D0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR_SHOULDSERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x18236260)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x18238310)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18232D10)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18232E00)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18232EC0)
#define SYSTEM_COMPONENTMODEL_REFLECTPROPERTYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x182329F0)
...
namespace System::ComponentModel
{
	...
	public:
		...
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(ReflectPropertyDescriptor_TypeDefinitionIndex)->GetStaticField(0x2BB0);
		}
		...
		{
			return (::Il2CppArray<::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(ReflectPropertyDescriptor_TypeDefinitionIndex)->GetStaticField(0x2BC0);
		}
		...
		::System::Reflection::MethodInfo* setMethod; // 0x88
		::System::ComponentModel::EventDescriptor* realChangedEvent; // 0x90
		::System::Type* receiverType; // 0x98
		::System::Type* type; // 0xA0
		::System::Object* ambientValue; // 0xA8
		::System::Object* defaultValue; // 0xB0
		::System::Reflection::MethodInfo* getMethod; // 0xB8
		::System::Reflection::MethodInfo* shouldSerializeMethod; // 0xC0
		::System::Reflection::PropertyInfo* propInfo; // 0xC8
		::System::ComponentModel::EventDescriptor* realIPropChangedEvent; // 0xD0
		::System::Reflection::MethodInfo* resetMethod; // 0xD8
