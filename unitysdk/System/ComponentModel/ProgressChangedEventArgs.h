...
#define SYSTEM_COMPONENTMODEL_PROGRESSCHANGEDEVENTARGS_GET_PROGRESSPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x1941F7F0)
#define SYSTEM_COMPONENTMODEL_PROGRESSCHANGEDEVENTARGS_GET_USERSTATE_OFFSET UNITYSDK_OFFSET(0x1941F800)
#define SYSTEM_COMPONENTMODEL_PROGRESSCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1941F7B0)
