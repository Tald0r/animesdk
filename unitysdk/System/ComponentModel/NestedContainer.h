...
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_CREATESITE_OFFSET UNITYSDK_OFFSET(0x19091090)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19091120)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x19091240)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_GET_OWNERNAME_OFFSET UNITYSDK_OFFSET(0x19090D50)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x19090D40)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER_ONOWNERDISPOSED_OFFSET UNITYSDK_OFFSET(0x190912B0)
#define SYSTEM_COMPONENTMODEL_NESTEDCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x19090C10)
