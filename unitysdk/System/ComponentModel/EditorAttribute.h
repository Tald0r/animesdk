...
#define SYSTEM_COMPONENTMODEL_EDITORATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1944D1C0)
#define SYSTEM_COMPONENTMODEL_EDITORATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1944D270)
#define SYSTEM_COMPONENTMODEL_EDITORATTRIBUTE_GET_EDITORBASETYPENAME_OFFSET UNITYSDK_OFFSET(0x1944D110)
#define SYSTEM_COMPONENTMODEL_EDITORATTRIBUTE_GET_EDITORTYPENAME_OFFSET UNITYSDK_OFFSET(0x1944D120)
#define SYSTEM_COMPONENTMODEL_EDITORATTRIBUTE_GET_TYPEID_OFFSET UNITYSDK_OFFSET(0x1944D130)
#define SYSTEM_COMPONENTMODEL_EDITORATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1944CF70)
#define SYSTEM_COMPONENTMODEL_EDITORATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1944D010)
#define SYSTEM_COMPONENTMODEL_EDITORATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1944D0C0)
#define SYSTEM_COMPONENTMODEL_EDITORATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1944CF50)
