...
#define SYSTEM_COMPONENTMODEL_DATETIMECONVERTER_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x18B5B7E0)
#define SYSTEM_COMPONENTMODEL_DATETIMECONVERTER_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x18B5B850)
#define SYSTEM_COMPONENTMODEL_DATETIMECONVERTER_CONVERTFROM_OFFSET UNITYSDK_OFFSET(0x18B5B8C0)
#define SYSTEM_COMPONENTMODEL_DATETIMECONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x18B5BBB0)
#define SYSTEM_COMPONENTMODEL_DATETIMECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B5CAD0)
