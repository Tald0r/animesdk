...
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x187C9B60)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x187C9BF0)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE_GET_ISIDENTITY_OFFSET UNITYSDK_OFFSET(0x187C9B20)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE_GET_ISNULLABLE_OFFSET UNITYSDK_OFFSET(0x187C9B30)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x187C9B40)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE_GET_PRIMARYKEY_OFFSET UNITYSDK_OFFSET(0x187C9B50)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x187C9AE0)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x187C9B00)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x187C9AC0)
#define SYSTEM_COMPONENTMODEL_DATAOBJECTFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x187C9AA0)
...
namespace System::ComponentModel
{
	...
	{
	public:
		::System::Boolean _isNullable; // 0x10
		::System::Boolean _isIdentity; // 0x11
