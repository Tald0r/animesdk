...
#define SYSTEM_COMPONENTMODEL_READONLYATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x18F4AB30)
#define SYSTEM_COMPONENTMODEL_READONLYATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18F4AB90)
#define SYSTEM_COMPONENTMODEL_READONLYATTRIBUTE_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x18F4AB20)
#define SYSTEM_COMPONENTMODEL_READONLYATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x18F4ABA0)
#define SYSTEM_COMPONENTMODEL_READONLYATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18F4AC40)
#define SYSTEM_COMPONENTMODEL_READONLYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18F4AB10)
