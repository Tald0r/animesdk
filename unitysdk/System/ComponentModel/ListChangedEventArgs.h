...
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_LISTCHANGEDTYPE_OFFSET UNITYSDK_OFFSET(0x19090BD0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_NEWINDEX_OFFSET UNITYSDK_OFFSET(0x19090BE0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_OLDINDEX_OFFSET UNITYSDK_OFFSET(0x19090BF0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_PROPERTYDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19090C00)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19090B50)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19090B90)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19090B10)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19090AD0)
