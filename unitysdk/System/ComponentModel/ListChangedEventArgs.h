...
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_LISTCHANGEDTYPE_OFFSET UNITYSDK_OFFSET(0x1944D390)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_NEWINDEX_OFFSET UNITYSDK_OFFSET(0x1944D3A0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_OLDINDEX_OFFSET UNITYSDK_OFFSET(0x1944D3B0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS_GET_PROPERTYDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1944D3C0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1944D310)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1944D350)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1944D2D0)
#define SYSTEM_COMPONENTMODEL_LISTCHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1944D290)
