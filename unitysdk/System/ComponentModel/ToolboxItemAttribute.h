...
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B1DAC0)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B1DE60)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_GET_TOOLBOXITEMTYPENAME_OFFSET UNITYSDK_OFFSET(0x19B1DE40)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_GET_TOOLBOXITEMTYPE_OFFSET UNITYSDK_OFFSET(0x19B1DCA0)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE_ISDEFAULTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19B1D970)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B1DEF0)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B1DBE0)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19B1DC70)
#define SYSTEM_COMPONENTMODEL_TOOLBOXITEMATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1DB90)
