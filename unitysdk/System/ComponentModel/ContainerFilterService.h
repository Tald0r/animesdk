...
#define SYSTEM_COMPONENTMODEL_CONTAINERFILTERSERVICE_FILTERCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1936F050)
#define SYSTEM_COMPONENTMODEL_CONTAINERFILTERSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1936F040)
