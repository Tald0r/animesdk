...
#define SYSTEM_COMPONENTMODEL_MULTILINESTRINGCONVERTER_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x18D67920)
#define SYSTEM_COMPONENTMODEL_MULTILINESTRINGCONVERTER_GETPROPERTIESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x18D67A10)
#define SYSTEM_COMPONENTMODEL_MULTILINESTRINGCONVERTER_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18D67A00)
#define SYSTEM_COMPONENTMODEL_MULTILINESTRINGCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D67A20)
