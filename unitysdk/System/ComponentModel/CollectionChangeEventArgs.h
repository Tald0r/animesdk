...
#define SYSTEM_COMPONENTMODEL_COLLECTIONCHANGEEVENTARGS_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x18FDD010)
#define SYSTEM_COMPONENTMODEL_COLLECTIONCHANGEEVENTARGS_GET_ELEMENT_OFFSET UNITYSDK_OFFSET(0x18FDD020)
#define SYSTEM_COMPONENTMODEL_COLLECTIONCHANGEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDCFD0)
