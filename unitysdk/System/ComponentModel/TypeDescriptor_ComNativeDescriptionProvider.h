...
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER_GETTYPEDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1941FA80)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER_GET_HANDLER_OFFSET UNITYSDK_OFFSET(0x1941FA60)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER_SET_HANDLER_OFFSET UNITYSDK_OFFSET(0x1941FA70)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1941FA50)
