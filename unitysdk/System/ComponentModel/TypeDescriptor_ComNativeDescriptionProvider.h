...
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER_GETTYPEDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19009C10)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER_GET_HANDLER_OFFSET UNITYSDK_OFFSET(0x19009BF0)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER_SET_HANDLER_OFFSET UNITYSDK_OFFSET(0x19009C00)
#define SYSTEM_COMPONENTMODEL_TYPEDESCRIPTOR_COMNATIVEDESCRIPTIONPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19009BE0)
