...
#define SYSTEM_COMPONENTMODEL_COMPONENTCONVERTER_GETPROPERTIESSUPPORTED_OFFSET UNITYSDK_OFFSET(0x19237C90)
#define SYSTEM_COMPONENTMODEL_COMPONENTCONVERTER_GETPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19237B80)
#define SYSTEM_COMPONENTMODEL_COMPONENTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19237B10)
