...
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATION_CREATEOPERATION_OFFSET UNITYSDK_OFFSET(0x191C5720)
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATION_FINALIZE_OFFSET UNITYSDK_OFFSET(0x191C51F0)
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATION_GET_SYNCHRONIZATIONCONTEXT_OFFSET UNITYSDK_OFFSET(0x191C5280)
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATION_GET_USERSUPPLIEDSTATE_OFFSET UNITYSDK_OFFSET(0x191C5270)
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATION_OPERATIONCOMPLETEDCORE_OFFSET UNITYSDK_OFFSET(0x191C5540)
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATION_OPERATIONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x191C5600)
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATION_POSTOPERATIONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x191C5470)
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATION_POST_OFFSET UNITYSDK_OFFSET(0x191C5290)
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATION_VERIFYDELEGATENOTNULL_OFFSET UNITYSDK_OFFSET(0x191C5400)
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATION_VERIFYNOTCOMPLETED_OFFSET UNITYSDK_OFFSET(0x191C5390)
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191C5790)
#define SYSTEM_COMPONENTMODEL_ASYNCOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x191C51B0)
