...
#define SYSTEM_COMPONENTMODEL_WEAKHASHTABLE_EQUALITYWEAKREFERENCE_EQUALS_OFFSET UNITYSDK_OFFSET(0x18B64410)
#define SYSTEM_COMPONENTMODEL_WEAKHASHTABLE_EQUALITYWEAKREFERENCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18B64490)
#define SYSTEM_COMPONENTMODEL_WEAKHASHTABLE_EQUALITYWEAKREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B643C0)
