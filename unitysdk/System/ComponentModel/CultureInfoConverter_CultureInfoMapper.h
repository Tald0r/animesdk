...
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_CULTUREINFOMAPPER_GETCULTUREINFONAME_OFFSET UNITYSDK_OFFSET(0x1857D040)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_CULTUREINFOMAPPER_INITIALIZECULTUREINFOMAP_OFFSET UNITYSDK_OFFSET(0x1857D140)
