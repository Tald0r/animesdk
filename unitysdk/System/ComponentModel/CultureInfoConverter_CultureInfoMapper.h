...
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_CULTUREINFOMAPPER_GETCULTUREINFONAME_OFFSET UNITYSDK_OFFSET(0x18B8DEB0)
#define SYSTEM_COMPONENTMODEL_CULTUREINFOCONVERTER_CULTUREINFOMAPPER_INITIALIZECULTUREINFOMAP_OFFSET UNITYSDK_OFFSET(0x18B8DFB0)
