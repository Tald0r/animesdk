...
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_GETKEY_OFFSET UNITYSDK_OFFSET(0x188D6AA0)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_GETLICENSE_OFFSET UNITYSDK_OFFSET(0x188D6B30)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_ISKEYVALID_OFFSET UNITYSDK_OFFSET(0x188D6A60)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x188D6FA0)
