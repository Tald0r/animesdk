...
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_GETKEY_OFFSET UNITYSDK_OFFSET(0x182C1DD0)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_GETLICENSE_OFFSET UNITYSDK_OFFSET(0x182C1E60)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_ISKEYVALID_OFFSET UNITYSDK_OFFSET(0x182C1D90)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x182C22D0)
