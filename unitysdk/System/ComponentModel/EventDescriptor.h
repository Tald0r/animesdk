...
#define SYSTEM_COMPONENTMODEL_EVENTDESCRIPTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191B0320)
#define SYSTEM_COMPONENTMODEL_EVENTDESCRIPTOR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191B0330)
#define SYSTEM_COMPONENTMODEL_EVENTDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x191B0310)
