...
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_CACHEPROVIDER_OFFSET UNITYSDK_OFFSET(0x195C4810)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_CREATEWITHCONTEXT_1_OFFSET UNITYSDK_OFFSET(0x195C4B30)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_CREATEWITHCONTEXT_OFFSET UNITYSDK_OFFSET(0x195C4AC0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GETCACHEDNOLICENSEPROVIDER_OFFSET UNITYSDK_OFFSET(0x195C5150)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GETCACHEDPROVIDERINSTANCE_OFFSET UNITYSDK_OFFSET(0x195C5340)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GETCACHEDPROVIDER_OFFSET UNITYSDK_OFFSET(0x195C5220)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GETLICENSEINTEROPHELPERTYPE_OFFSET UNITYSDK_OFFSET(0x195C5460)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GET_CURRENTCONTEXT_OFFSET UNITYSDK_OFFSET(0x195C43D0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GET_USAGEMODE_OFFSET UNITYSDK_OFFSET(0x195C4750)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_ISLICENSED_OFFSET UNITYSDK_OFFSET(0x195C54B0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_ISVALID_1_OFFSET UNITYSDK_OFFSET(0x195C57E0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_ISVALID_OFFSET UNITYSDK_OFFSET(0x195C5690)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LOCKCONTEXT_OFFSET UNITYSDK_OFFSET(0x195C4E30)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_SET_CURRENTCONTEXT_OFFSET UNITYSDK_OFFSET(0x195C45C0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_UNLOCKCONTEXT_OFFSET UNITYSDK_OFFSET(0x195C4FC0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_VALIDATEINTERNALRECURSIVE_OFFSET UNITYSDK_OFFSET(0x195C58B0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_VALIDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x195C5600)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_VALIDATE_1_OFFSET UNITYSDK_OFFSET(0x195C5F00)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_VALIDATE_OFFSET UNITYSDK_OFFSET(0x195C5D80)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x195C6030)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x195C43C0)
...
namespace System::ComponentModel
{
	...
	public:
		...
		{
			return (::System::Collections::Hashtable**)Il2CppClass::FromTypeDefinitionIndex(LicenseManager_TypeDefinitionIndex)->GetStaticField(0x3028);
		}
		static ::System::ComponentModel::LicenseContext** StaticGet_context()
		{
			return (::System::ComponentModel::LicenseContext**)Il2CppClass::FromTypeDefinitionIndex(LicenseManager_TypeDefinitionIndex)->GetStaticField(0x3030);
		}
