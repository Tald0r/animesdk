...
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_CACHEPROVIDER_OFFSET UNITYSDK_OFFSET(0x191C8480)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_CREATEWITHCONTEXT_1_OFFSET UNITYSDK_OFFSET(0x191C87A0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_CREATEWITHCONTEXT_OFFSET UNITYSDK_OFFSET(0x191C8730)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GETCACHEDNOLICENSEPROVIDER_OFFSET UNITYSDK_OFFSET(0x191C8DC0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GETCACHEDPROVIDERINSTANCE_OFFSET UNITYSDK_OFFSET(0x191C8FB0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GETCACHEDPROVIDER_OFFSET UNITYSDK_OFFSET(0x191C8E90)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GETLICENSEINTEROPHELPERTYPE_OFFSET UNITYSDK_OFFSET(0x191C90D0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GET_CURRENTCONTEXT_OFFSET UNITYSDK_OFFSET(0x191C8040)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_GET_USAGEMODE_OFFSET UNITYSDK_OFFSET(0x191C83C0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_ISLICENSED_OFFSET UNITYSDK_OFFSET(0x191C9120)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_ISVALID_1_OFFSET UNITYSDK_OFFSET(0x191C9450)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_ISVALID_OFFSET UNITYSDK_OFFSET(0x191C9300)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_LOCKCONTEXT_OFFSET UNITYSDK_OFFSET(0x191C8AA0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_SET_CURRENTCONTEXT_OFFSET UNITYSDK_OFFSET(0x191C8230)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_UNLOCKCONTEXT_OFFSET UNITYSDK_OFFSET(0x191C8C30)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_VALIDATEINTERNALRECURSIVE_OFFSET UNITYSDK_OFFSET(0x191C9520)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_VALIDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x191C9270)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_VALIDATE_1_OFFSET UNITYSDK_OFFSET(0x191C9B70)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER_VALIDATE_OFFSET UNITYSDK_OFFSET(0x191C99F0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x191C9CA0)
#define SYSTEM_COMPONENTMODEL_LICENSEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x191C8030)
