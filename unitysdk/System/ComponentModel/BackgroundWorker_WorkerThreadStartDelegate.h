...
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_WORKERTHREADSTARTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1939C7A0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_WORKERTHREADSTARTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1939C7D0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_WORKERTHREADSTARTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1939C2A0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_WORKERTHREADSTARTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1939C280)
