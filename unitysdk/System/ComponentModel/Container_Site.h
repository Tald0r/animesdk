...
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x182C1070)
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x182C1050)
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE_GET_CONTAINER_OFFSET UNITYSDK_OFFSET(0x182C1060)
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE_GET_DESIGNMODE_OFFSET UNITYSDK_OFFSET(0x182C10E0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x182C10F0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x182C1100)
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE__CTOR_OFFSET UNITYSDK_OFFSET(0x182C1040)
