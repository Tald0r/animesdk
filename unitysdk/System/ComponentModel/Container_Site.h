...
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x188D5D30)
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x188D5D10)
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE_GET_CONTAINER_OFFSET UNITYSDK_OFFSET(0x188D5D20)
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE_GET_DESIGNMODE_OFFSET UNITYSDK_OFFSET(0x188D5DA0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x188D5DB0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x188D5DC0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_SITE__CTOR_OFFSET UNITYSDK_OFFSET(0x188D5D00)
...
namespace System::ComponentModel
{
	...
	{
	public:
		::System::ComponentModel::Container* container; // 0x10
