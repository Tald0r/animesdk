...
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19370430)
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19370470)
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1936FEB0)
#define SYSTEM_COMPONENTMODEL_RUNWORKERCOMPLETEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1936FE90)
