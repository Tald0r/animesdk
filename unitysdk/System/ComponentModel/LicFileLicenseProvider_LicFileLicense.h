...
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_LICFILELICENSE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A5EF9D0)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_LICFILELICENSE_GET_LICENSEKEY_OFFSET UNITYSDK_OFFSET(0x1A5EF9C0)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_LICFILELICENSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5EF9B0)
