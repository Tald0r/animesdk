...
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_LICFILELICENSE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19FD6990)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_LICFILELICENSE_GET_LICENSEKEY_OFFSET UNITYSDK_OFFSET(0x19FD6980)
#define SYSTEM_COMPONENTMODEL_LICFILELICENSEPROVIDER_LICFILELICENSE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD6970)
