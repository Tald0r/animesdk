...
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ADD_DOWORK_OFFSET UNITYSDK_OFFSET(0x1857C020)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ADD_PROGRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x1857C680)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ADD_RUNWORKERCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1857CB40)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ASYNCOPERATIONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1857BF10)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_CANCELASYNC_OFFSET UNITYSDK_OFFSET(0x1857BFB0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_GET_CANCELLATIONPENDING_OFFSET UNITYSDK_OFFSET(0x1857BFA0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_GET_ISBUSY_OFFSET UNITYSDK_OFFSET(0x1857C2B0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_GET_WORKERREPORTSPROGRESS_OFFSET UNITYSDK_OFFSET(0x1857CDD0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_GET_WORKERSUPPORTSCANCELLATION_OFFSET UNITYSDK_OFFSET(0x1857CDF0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ONDOWORK_OFFSET UNITYSDK_OFFSET(0x1857C2C0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ONPROGRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x1857C540)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_ONRUNWORKERCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1857C400)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_PROGRESSREPORTER_OFFSET UNITYSDK_OFFSET(0x1857C910)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_REMOVE_DOWORK_OFFSET UNITYSDK_OFFSET(0x1857C1A0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_REMOVE_PROGRESSCHANGED_OFFSET UNITYSDK_OFFSET(0x1857C800)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_REMOVE_RUNWORKERCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1857CCC0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_REPORTPROGRESS_1_OFFSET UNITYSDK_OFFSET(0x1857C9A0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_REPORTPROGRESS_OFFSET UNITYSDK_OFFSET(0x1857C990)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_RUNWORKERASYNC_1_OFFSET UNITYSDK_OFFSET(0x1857CA90)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_RUNWORKERASYNC_OFFSET UNITYSDK_OFFSET(0x1857CA80)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_SET_WORKERREPORTSPROGRESS_OFFSET UNITYSDK_OFFSET(0x1857CDE0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_SET_WORKERSUPPORTSCANCELLATION_OFFSET UNITYSDK_OFFSET(0x1857CE00)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER_WORKERTHREADSTART_OFFSET UNITYSDK_OFFSET(0x1857CE10)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1857CFC0)
#define SYSTEM_COMPONENTMODEL_BACKGROUNDWORKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1857BE40)
...
namespace System::ComponentModel
{
	...
	public:
		...
		::System::Threading::SendOrPostCallback* progressReporter; // 0x38
		::System::Threading::SendOrPostCallback* operationCompleted; // 0x40
		::System::Boolean canCancelWorker; // 0x48
		::System::Boolean workerReportsProgress; // 0x49
		::System::Boolean isRunning; // 0x4A
