...
#define SYSTEM_COMPONENTMODEL_COMPONENT_ADD_DISPOSED_OFFSET UNITYSDK_OFFSET(0x1936E580)
#define SYSTEM_COMPONENTMODEL_COMPONENT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1936E8E0)
#define SYSTEM_COMPONENTMODEL_COMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1936E890)
#define SYSTEM_COMPONENTMODEL_COMPONENT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1936E4F0)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x1936ECB0)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GET_CANRAISEEVENTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1936E570)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GET_CANRAISEEVENTS_OFFSET UNITYSDK_OFFSET(0x1936E560)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GET_CONTAINER_OFFSET UNITYSDK_OFFSET(0x1936EBD0)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GET_DESIGNMODE_OFFSET UNITYSDK_OFFSET(0x1936ED90)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GET_EVENTS_OFFSET UNITYSDK_OFFSET(0x1936E700)
#define SYSTEM_COMPONENTMODEL_COMPONENT_GET_SITE_OFFSET UNITYSDK_OFFSET(0x1936E870)
#define SYSTEM_COMPONENTMODEL_COMPONENT_REMOVE_DISPOSED_OFFSET UNITYSDK_OFFSET(0x1936E760)
#define SYSTEM_COMPONENTMODEL_COMPONENT_SET_SITE_OFFSET UNITYSDK_OFFSET(0x1936E880)
#define SYSTEM_COMPONENTMODEL_COMPONENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1936EE70)
#define SYSTEM_COMPONENTMODEL_COMPONENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1936EFD0)
#define SYSTEM_COMPONENTMODEL_COMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1936EFC0)
