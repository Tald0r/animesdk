...
#define SYSTEM_COMPONENTMODEL_CONTAINER_ADD_1_OFFSET UNITYSDK_OFFSET(0x19B16B60)
#define SYSTEM_COMPONENTMODEL_CONTAINER_ADD_OFFSET UNITYSDK_OFFSET(0x19B16B40)
#define SYSTEM_COMPONENTMODEL_CONTAINER_CREATESITE_OFFSET UNITYSDK_OFFSET(0x19B17000)
#define SYSTEM_COMPONENTMODEL_CONTAINER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19B170A0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19B17050)
#define SYSTEM_COMPONENTMODEL_CONTAINER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19B16AD0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x19B17470)
#define SYSTEM_COMPONENTMODEL_CONTAINER_GET_COMPONENTS_OFFSET UNITYSDK_OFFSET(0x19B174C0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_REMOVEWITHOUTUNSITING_OFFSET UNITYSDK_OFFSET(0x19B17C50)
#define SYSTEM_COMPONENTMODEL_CONTAINER_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x19B178E0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_REMOVE_OFFSET UNITYSDK_OFFSET(0x19B16FF0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_VALIDATENAME_OFFSET UNITYSDK_OFFSET(0x19B17C60)
#define SYSTEM_COMPONENTMODEL_CONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B18100)
