...
#define SYSTEM_COMPONENTMODEL_CONTAINER_ADD_1_OFFSET UNITYSDK_OFFSET(0x19678230)
#define SYSTEM_COMPONENTMODEL_CONTAINER_ADD_OFFSET UNITYSDK_OFFSET(0x19678210)
#define SYSTEM_COMPONENTMODEL_CONTAINER_CREATESITE_OFFSET UNITYSDK_OFFSET(0x196786D0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19678770)
#define SYSTEM_COMPONENTMODEL_CONTAINER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19678720)
#define SYSTEM_COMPONENTMODEL_CONTAINER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x196781A0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_GETSERVICE_OFFSET UNITYSDK_OFFSET(0x19678B30)
#define SYSTEM_COMPONENTMODEL_CONTAINER_GET_COMPONENTS_OFFSET UNITYSDK_OFFSET(0x19678B80)
#define SYSTEM_COMPONENTMODEL_CONTAINER_REMOVEWITHOUTUNSITING_OFFSET UNITYSDK_OFFSET(0x19679310)
#define SYSTEM_COMPONENTMODEL_CONTAINER_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x19678FA0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_REMOVE_OFFSET UNITYSDK_OFFSET(0x196786C0)
#define SYSTEM_COMPONENTMODEL_CONTAINER_VALIDATENAME_OFFSET UNITYSDK_OFFSET(0x19679320)
#define SYSTEM_COMPONENTMODEL_CONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x196797C0)
...
namespace System::ComponentModel
{
	...
	{
	public:
		::System::ComponentModel::ComponentCollection* components; // 0x10
		::System::Object* syncObj; // 0x18
		::System::ComponentModel::ContainerFilterService* filter; // 0x20
