...
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x191B11B0)
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE_EQUALS_OFFSET UNITYSDK_OFFSET(0x191B1140)
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x191B1340)
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE_GET_TABCLASSES_OFFSET UNITYSDK_OFFSET(0x191B09C0)
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE_GET_TABCLASSNAMES_OFFSET UNITYSDK_OFFSET(0x191B1060)
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE_GET_TABSCOPES_OFFSET UNITYSDK_OFFSET(0x191B1130)
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE_INITIALIZEARRAYS_1_OFFSET UNITYSDK_OFFSET(0x191B16E0)
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE_INITIALIZEARRAYS_2_OFFSET UNITYSDK_OFFSET(0x191B1360)
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE_INITIALIZEARRAYS_OFFSET UNITYSDK_OFFSET(0x191B1350)
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x191B0780)
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x191B08D0)
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x191B0790)
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x191B08E0)
#define SYSTEM_COMPONENTMODEL_PROPERTYTABATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x191B0730)
...
namespace System::ComponentModel
{
	...
	public:
		...
		::Il2CppArray<::System::String*>* tabClassNames; // 0x18
