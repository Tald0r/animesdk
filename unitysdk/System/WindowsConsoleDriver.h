...
#define SYSTEM_WINDOWSCONSOLEDRIVER_GETATTRFOREGROUND_OFFSET UNITYSDK_OFFSET(0x1A0CE7E0)
#define SYSTEM_WINDOWSCONSOLEDRIVER_GETCONSOLESCREENBUFFERINFO_OFFSET UNITYSDK_OFFSET(0x1A0CE710)
#define SYSTEM_WINDOWSCONSOLEDRIVER_GETSTDHANDLE_OFFSET UNITYSDK_OFFSET(0x1A0CE650)
#define SYSTEM_WINDOWSCONSOLEDRIVER_ISMODIFIERKEY_OFFSET UNITYSDK_OFFSET(0x1A0CEE20)
#define SYSTEM_WINDOWSCONSOLEDRIVER_READCONSOLEINPUT_OFFSET UNITYSDK_OFFSET(0x1A0CECE0)
#define SYSTEM_WINDOWSCONSOLEDRIVER_READKEY_OFFSET UNITYSDK_OFFSET(0x1A0CEA50)
#define SYSTEM_WINDOWSCONSOLEDRIVER_RESETCOLOR_OFFSET UNITYSDK_OFFSET(0x1A0CEE40)
#define SYSTEM_WINDOWSCONSOLEDRIVER_SETCONSOLETEXTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A0CE980)
#define SYSTEM_WINDOWSCONSOLEDRIVER_SET_FOREGROUNDCOLOR_OFFSET UNITYSDK_OFFSET(0x1A0CE7F0)
#define SYSTEM_WINDOWSCONSOLEDRIVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0CE400)
