...
#define SYSTEM_RUNTIME_SERIALIZATION_DATACONTRACTATTRIBUTE_GET_ISREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B156B80)
#define SYSTEM_RUNTIME_SERIALIZATION_DATACONTRACTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B156B70)

namespace System::Runtime::Serialization
{
	inline static constexpr unsigned int DataContractAttribute_TypeDefinitionIndex = 6515;
