...
#define SYSTEM_RUNTIME_SERIALIZATION_ENUMMEMBERATTRIBUTE_GET_ISVALUESETEXPLICITLY_OFFSET UNITYSDK_OFFSET(0x1B775D60)
#define SYSTEM_RUNTIME_SERIALIZATION_ENUMMEMBERATTRIBUTE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B775D40)
#define SYSTEM_RUNTIME_SERIALIZATION_ENUMMEMBERATTRIBUTE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B775D50)
#define SYSTEM_RUNTIME_SERIALIZATION_ENUMMEMBERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B775D30)
