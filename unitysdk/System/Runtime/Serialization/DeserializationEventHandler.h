...
#define SYSTEM_RUNTIME_SERIALIZATION_DESERIALIZATIONEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x185999D0)
#define SYSTEM_RUNTIME_SERIALIZATION_DESERIALIZATIONEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18599A00)
#define SYSTEM_RUNTIME_SERIALIZATION_DESERIALIZATIONEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x185994D0)
#define SYSTEM_RUNTIME_SERIALIZATION_DESERIALIZATIONEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x185994B0)
