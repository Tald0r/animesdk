...
#define SYSTEM_RUNTIME_SERIALIZATION_SERIALIZATIONEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A0CA350)
#define SYSTEM_RUNTIME_SERIALIZATION_SERIALIZATIONEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A0CA3A0)
#define SYSTEM_RUNTIME_SERIALIZATION_SERIALIZATIONEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A0C9DB0)
#define SYSTEM_RUNTIME_SERIALIZATION_SERIALIZATIONEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0CA330)
