...
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_PRIMITIVEARRAY_INIT_OFFSET UNITYSDK_OFFSET(0x19CCE0F0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_PRIMITIVEARRAY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x19CCE3A0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_PRIMITIVEARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x19CCE0E0)
...
namespace System::Runtime::Serialization::Formatters::Binary
{
	...
	public:
		...
		::Il2CppArray<::System::Boolean>* booleanA; // 0x28
		...
		::Il2CppArray<::System::Int64>* int64A; // 0x58
