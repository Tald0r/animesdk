...
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_CHECKFORNULL_OFFSET UNITYSDK_OFFSET(0x1985BE50)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_CHECKTYPEFORMAT_OFFSET UNITYSDK_OFFSET(0x1985B280)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_GETASSEMBLYID_OFFSET UNITYSDK_OFFSET(0x19859B50)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_GETNAMEINFO_OFFSET UNITYSDK_OFFSET(0x1985D280)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_GETNEXT_OFFSET UNITYSDK_OFFSET(0x1985A4A0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_GETTYPE_OFFSET UNITYSDK_OFFSET(0x1985B290)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_INTERNALGETID_OFFSET UNITYSDK_OFFSET(0x19859A90)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_MEMBERTONAMEINFO_OFFSET UNITYSDK_OFFSET(0x1985B650)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_PUTNAMEINFO_OFFSET UNITYSDK_OFFSET(0x1985A480)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_SCHEDULE_1_OFFSET UNITYSDK_OFFSET(0x1985C140)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_SCHEDULE_OFFSET UNITYSDK_OFFSET(0x1985CFD0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x198594C0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_TOCODE_OFFSET UNITYSDK_OFFSET(0x1985B2B0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_TYPETONAMEINFO_1_OFFSET UNITYSDK_OFFSET(0x1985B810)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_TYPETONAMEINFO_2_OFFSET UNITYSDK_OFFSET(0x19859DF0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_TYPETONAMEINFO_3_OFFSET UNITYSDK_OFFSET(0x1985C040)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_TYPETONAMEINFO_4_OFFSET UNITYSDK_OFFSET(0x1985BF90)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_TYPETONAMEINFO_OFFSET UNITYSDK_OFFSET(0x1985D1E0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITEARRAYMEMBER_OFFSET UNITYSDK_OFFSET(0x1985C3A0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITEARRAY_OFFSET UNITYSDK_OFFSET(0x1985A5D0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITEKNOWNVALUECLASS_OFFSET UNITYSDK_OFFSET(0x1985C280)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITEMEMBERSETUP_OFFSET UNITYSDK_OFFSET(0x1985B680)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITEMEMBERS_OFFSET UNITYSDK_OFFSET(0x1985B8B0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITEOBJECTREF_OFFSET UNITYSDK_OFFSET(0x1985C260)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITERECTANGLE_OFFSET UNITYSDK_OFFSET(0x1985C7B0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITESERIALIZEDSTREAMHEADER_OFFSET UNITYSDK_OFFSET(0x19859A30)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x1985CFF0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1985B310)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITE_OFFSET UNITYSDK_OFFSET(0x19859EC0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x19859370)
...
namespace System::Runtime::Serialization::Formatters::Binary
{
	...
	public:
		...
		::System::Collections::Hashtable* assemblyToIdTable; // 0x58
		...
		::System::Runtime::Serialization::SerializationObjectManager* m_objectManager; // 0x70
