...
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_CHECKFORNULL_OFFSET UNITYSDK_OFFSET(0x19443E20)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_CHECKTYPEFORMAT_OFFSET UNITYSDK_OFFSET(0x19443250)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_GETASSEMBLYID_OFFSET UNITYSDK_OFFSET(0x19441B30)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_GETNAMEINFO_OFFSET UNITYSDK_OFFSET(0x19445230)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_GETNEXT_OFFSET UNITYSDK_OFFSET(0x19442480)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_GETTYPE_OFFSET UNITYSDK_OFFSET(0x19443260)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_INTERNALGETID_OFFSET UNITYSDK_OFFSET(0x19441A70)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_MEMBERTONAMEINFO_OFFSET UNITYSDK_OFFSET(0x19443620)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_PUTNAMEINFO_OFFSET UNITYSDK_OFFSET(0x19442460)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_SCHEDULE_1_OFFSET UNITYSDK_OFFSET(0x19444100)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_SCHEDULE_OFFSET UNITYSDK_OFFSET(0x19444F80)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x194414A0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_TOCODE_OFFSET UNITYSDK_OFFSET(0x19443280)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_TYPETONAMEINFO_1_OFFSET UNITYSDK_OFFSET(0x194437F0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_TYPETONAMEINFO_2_OFFSET UNITYSDK_OFFSET(0x19441DE0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_TYPETONAMEINFO_3_OFFSET UNITYSDK_OFFSET(0x19444000)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_TYPETONAMEINFO_4_OFFSET UNITYSDK_OFFSET(0x19443F50)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_TYPETONAMEINFO_OFFSET UNITYSDK_OFFSET(0x19445190)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITEARRAYMEMBER_OFFSET UNITYSDK_OFFSET(0x19444350)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITEARRAY_OFFSET UNITYSDK_OFFSET(0x194425B0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITEKNOWNVALUECLASS_OFFSET UNITYSDK_OFFSET(0x19444230)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITEMEMBERSETUP_OFFSET UNITYSDK_OFFSET(0x19443650)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITEMEMBERS_OFFSET UNITYSDK_OFFSET(0x19443890)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITEOBJECTREF_OFFSET UNITYSDK_OFFSET(0x19444210)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITERECTANGLE_OFFSET UNITYSDK_OFFSET(0x19444760)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITESERIALIZEDSTREAMHEADER_OFFSET UNITYSDK_OFFSET(0x19441A10)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x19444FA0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITE_1_OFFSET UNITYSDK_OFFSET(0x194432E0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER_WRITE_OFFSET UNITYSDK_OFFSET(0x19441EB0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_OBJECTWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x19441350)
...
namespace System::Runtime::Serialization::Formatters::Binary
{
	...
	public:
		...
		::System::Runtime::Serialization::SerializationObjectManager* m_objectManager; // 0x18
		::System::Runtime::Serialization::StreamingContext m_context; // 0x20
		::System::Runtime::Serialization::IFormatterConverter* m_formatterConverter; // 0x30
		::Il2CppArray<::System::Object*>* crossAppDomainArray; // 0x38
		::System::String* topName; // 0x40
		::System::Object* previousObj; // 0x48
		::System::Runtime::Serialization::ISurrogateSelector* m_surrogates; // 0x50
		::System::Type* previousType; // 0x58
		...
		::System::Runtime::Serialization::ObjectIDGenerator* m_idGenerator; // 0x78
		::System::Collections::Hashtable* assemblyToIdTable; // 0x80
