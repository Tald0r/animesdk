...
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_SIZEDARRAY_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0C6680)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_SIZEDARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A0C66B0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_SIZEDARRAY_INCREASECAPACITY_OFFSET UNITYSDK_OFFSET(0x1A0C68B0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_SIZEDARRAY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A0C6720)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_SIZEDARRAY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0C65A0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_SIZEDARRAY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A0C65E0)
#define SYSTEM_RUNTIME_SERIALIZATION_FORMATTERS_BINARY_SIZEDARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0C6560)
