...
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE_GETPROPERTIESFORNEWCONTEXT_OFFSET UNITYSDK_OFFSET(0x17FD7E50)
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE_ISCONTEXTOK_OFFSET UNITYSDK_OFFSET(0x17FD7E40)
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17FD7E30)
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x17FD7E20)
