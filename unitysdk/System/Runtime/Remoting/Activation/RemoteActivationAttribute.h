...
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE_GETPROPERTIESFORNEWCONTEXT_OFFSET UNITYSDK_OFFSET(0x1860B870)
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE_ISCONTEXTOK_OFFSET UNITYSDK_OFFSET(0x1860B860)
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1860B850)
#define SYSTEM_RUNTIME_REMOTING_ACTIVATION_REMOTEACTIVATIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1860B840)
