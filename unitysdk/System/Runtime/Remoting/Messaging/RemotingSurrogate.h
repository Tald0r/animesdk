...
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_REMOTINGSURROGATE_GETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x19197870)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_REMOTINGSURROGATE_SETOBJECTDATA_OFFSET UNITYSDK_OFFSET(0x19197900)
#define SYSTEM_RUNTIME_REMOTING_MESSAGING_REMOTINGSURROGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19197950)
