...
#define SYSTEM_RUNTIME_REMOTING_PROXIES_PROXYATTRIBUTE_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x188B64A0)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_PROXYATTRIBUTE_CREATEPROXY_OFFSET UNITYSDK_OFFSET(0x188B6580)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_PROXYATTRIBUTE_GETPROPERTIESFORNEWCONTEXT_OFFSET UNITYSDK_OFFSET(0x188B65E0)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_PROXYATTRIBUTE_ISCONTEXTOK_OFFSET UNITYSDK_OFFSET(0x188B65F0)
#define SYSTEM_RUNTIME_REMOTING_PROXIES_PROXYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x188B6490)
