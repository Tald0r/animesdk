...
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_RENEWALDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19665010)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_RENEWALDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19665040)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_RENEWALDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19664AD0)
#define SYSTEM_RUNTIME_REMOTING_LIFETIME_LEASE_RENEWALDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19664AC0)
