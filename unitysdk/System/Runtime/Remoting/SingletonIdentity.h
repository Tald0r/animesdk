...
#define SYSTEM_RUNTIME_REMOTING_SINGLETONIDENTITY_ASYNCOBJECTPROCESSMESSAGE_OFFSET UNITYSDK_OFFSET(0x194E6050)
#define SYSTEM_RUNTIME_REMOTING_SINGLETONIDENTITY_GETSERVEROBJECT_OFFSET UNITYSDK_OFFSET(0x194E5D80)
#define SYSTEM_RUNTIME_REMOTING_SINGLETONIDENTITY_SYNCOBJECTPROCESSMESSAGE_OFFSET UNITYSDK_OFFSET(0x194E5EE0)
#define SYSTEM_RUNTIME_REMOTING_SINGLETONIDENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x194E5D70)
