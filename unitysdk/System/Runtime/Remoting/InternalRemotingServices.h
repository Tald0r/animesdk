...
#define SYSTEM_RUNTIME_REMOTING_INTERNALREMOTINGSERVICES_GETCACHEDSOAPATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19DD2F10)
#define SYSTEM_RUNTIME_REMOTING_INTERNALREMOTINGSERVICES__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DD33A0)
#define SYSTEM_RUNTIME_REMOTING_INTERNALREMOTINGSERVICES__CTOR_OFFSET UNITYSDK_OFFSET(0x19DD2F00)
