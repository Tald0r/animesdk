...
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_COPYBLOCKUNALIGNED_OFFSET UNITYSDK_OFFSET(0x1B157280)
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_COPYBLOCK_1_OFFSET UNITYSDK_OFFSET(0x1B157270)
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_COPYBLOCK_OFFSET UNITYSDK_OFFSET(0x1B157260)
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_INITBLOCKUNALIGNED_1_OFFSET UNITYSDK_OFFSET(0x1B1572C0)
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_INITBLOCKUNALIGNED_OFFSET UNITYSDK_OFFSET(0x1B1572B0)
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_INITBLOCK_1_OFFSET UNITYSDK_OFFSET(0x1B1572A0)
#define SYSTEM_RUNTIME_COMPILERSERVICES_UNSAFE_INITBLOCK_OFFSET UNITYSDK_OFFSET(0x1B157290)

namespace System::Runtime::CompilerServices
{
	inline static constexpr unsigned int Unsafe_TypeDefinitionIndex = 6513;
