...
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_MERGEDRUNTIMEVARIABLES_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AD24F20)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_MERGEDRUNTIMEVARIABLES_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AD24F40)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_MERGEDRUNTIMEVARIABLES_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AD250F0)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_MERGEDRUNTIMEVARIABLES__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD24F10)
...
namespace System::Runtime::CompilerServices
{
	...
	public:
		...
		::Il2CppArray<::System::Int32>* _indexes; // 0x18
