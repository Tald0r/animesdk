...
#define SYSTEM_RUNTIME_COMPILERSERVICES_FORMATTABLESTRINGFACTORY_CONCRETEFORMATTABLESTRING_GETARGUMENTS_OFFSET UNITYSDK_OFFSET(0x18DAA800)
#define SYSTEM_RUNTIME_COMPILERSERVICES_FORMATTABLESTRINGFACTORY_CONCRETEFORMATTABLESTRING_GETARGUMENT_OFFSET UNITYSDK_OFFSET(0x18DAA830)
#define SYSTEM_RUNTIME_COMPILERSERVICES_FORMATTABLESTRINGFACTORY_CONCRETEFORMATTABLESTRING_GET_ARGUMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x18DAA810)
#define SYSTEM_RUNTIME_COMPILERSERVICES_FORMATTABLESTRINGFACTORY_CONCRETEFORMATTABLESTRING_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x18DAA7F0)
#define SYSTEM_RUNTIME_COMPILERSERVICES_FORMATTABLESTRINGFACTORY_CONCRETEFORMATTABLESTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18DAA870)
#define SYSTEM_RUNTIME_COMPILERSERVICES_FORMATTABLESTRINGFACTORY_CONCRETEFORMATTABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x18DAA7E0)
