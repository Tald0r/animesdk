...
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_RUNTIMEVARIABLES_SYSTEM_RUNTIME_COMPILERSERVICES_IRUNTIMEVARIABLES_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AD623F0)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_RUNTIMEVARIABLES_SYSTEM_RUNTIME_COMPILERSERVICES_IRUNTIMEVARIABLES_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AD62410)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_RUNTIMEVARIABLES_SYSTEM_RUNTIME_COMPILERSERVICES_IRUNTIMEVARIABLES_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AD62510)
#define SYSTEM_RUNTIME_COMPILERSERVICES_RUNTIMEOPS_RUNTIMEVARIABLES__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD623E0)
