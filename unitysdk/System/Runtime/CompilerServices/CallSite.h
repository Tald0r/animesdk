...
#define SYSTEM_RUNTIME_COMPILERSERVICES_CALLSITE_CREATE_OFFSET UNITYSDK_OFFSET(0x1AB8BAC0)
#define SYSTEM_RUNTIME_COMPILERSERVICES_CALLSITE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB8C020)
#define SYSTEM_RUNTIME_COMPILERSERVICES_CALLSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB8BAB0)
