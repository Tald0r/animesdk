...
#define SYSTEM_RUNTIME_COMPILERSERVICES_CALLSITEOPS_CLEARMATCH_OFFSET UNITYSDK_OFFSET(0x1B3648D0)
#define SYSTEM_RUNTIME_COMPILERSERVICES_CALLSITEOPS_GETMATCH_OFFSET UNITYSDK_OFFSET(0x1B3648B0)
#define SYSTEM_RUNTIME_COMPILERSERVICES_CALLSITEOPS_SETNOTMATCHED_OFFSET UNITYSDK_OFFSET(0x1B364890)
