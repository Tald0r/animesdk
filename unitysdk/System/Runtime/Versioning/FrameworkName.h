...
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x197FA900)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_EQUALS_OFFSET UNITYSDK_OFFSET(0x197FA770)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x197FAA30)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GET_FULLNAME_OFFSET UNITYSDK_OFFSET(0x197FA600)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x197FA5D0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GET_PROFILE_OFFSET UNITYSDK_OFFSET(0x197FA5F0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x197FA5E0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x197FB340)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x197FB490)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x197FAB90)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197FABB0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME__CTOR_2_OFFSET UNITYSDK_OFFSET(0x197FADC0)
#define SYSTEM_RUNTIME_VERSIONING_FRAMEWORKNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x197FABA0)
...
namespace System::Runtime::Versioning
{
	...
	public:
		...
		::System::String* m_profile; // 0x10
		::System::String* m_fullName; // 0x18
		::System::Version* m_version; // 0x20
		::System::String* m_identifier; // 0x28
