...
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_ADD_OFFSET UNITYSDK_OFFSET(0x19FE4820)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19FE47E0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_GET_INITIALTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x19FE47F0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_GET_MAXIMUMTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x19FE4800)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19FE4810)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_REMOVE_OFFSET UNITYSDK_OFFSET(0x19FE4BF0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FE46B0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE46A0)
...
namespace System::Runtime::InteropServices
{
	...
	public:
		...
		::Il2CppArray<::System::Int32>* gc_counts; // 0x18
		::System::Int32 threshold; // 0x20
		::System::Int32 gc_gen; // 0x24
		::System::Int32 maximumThreshold; // 0x28
		::System::Int32 handleCount; // 0x2C
