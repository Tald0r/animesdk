...
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_ADD_OFFSET UNITYSDK_OFFSET(0x1A5FD8A0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A5FD860)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_GET_INITIALTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1A5FD870)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_GET_MAXIMUMTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1A5FD880)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A5FD890)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A5FDC70)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5FD730)
#define SYSTEM_RUNTIME_INTEROPSERVICES_HANDLECOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5FD720)
...
namespace System::Runtime::InteropServices
{
	...
	public:
		...
		::System::Int32 initialThreshold; // 0x24
		::System::Int32 threshold; // 0x28
