...
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x1907C330)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONDATACHANGE_OFFSET UNITYSDK_OFFSET(0x1907C360)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONRENAME_OFFSET UNITYSDK_OFFSET(0x1907C400)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONSAVE_OFFSET UNITYSDK_OFFSET(0x1907C4A0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONVIEWCHANGE_OFFSET UNITYSDK_OFFSET(0x1907C4D0)
