...
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x18B87A30)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONDATACHANGE_OFFSET UNITYSDK_OFFSET(0x18B87A60)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONRENAME_OFFSET UNITYSDK_OFFSET(0x18B87B00)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONSAVE_OFFSET UNITYSDK_OFFSET(0x18B87BA0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IADVISESINK_ONVIEWCHANGE_OFFSET UNITYSDK_OFFSET(0x18B87BD0)
