...
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMSTATDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x1890B160)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMSTATDATA_NEXT_OFFSET UNITYSDK_OFFSET(0x1890B240)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMSTATDATA_RESET_OFFSET UNITYSDK_OFFSET(0x1890B590)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMSTATDATA_SKIP_OFFSET UNITYSDK_OFFSET(0x1890B5D0)
