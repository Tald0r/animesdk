...
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_DADVISE_OFFSET UNITYSDK_OFFSET(0x182F5D80)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_DUNADVISE_OFFSET UNITYSDK_OFFSET(0x182F5E50)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_ENUMDADVISE_OFFSET UNITYSDK_OFFSET(0x182F5E90)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_ENUMFORMATETC_OFFSET UNITYSDK_OFFSET(0x182F5F80)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_GETCANONICALFORMATETC_OFFSET UNITYSDK_OFFSET(0x182F6050)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_GETDATAHERE_OFFSET UNITYSDK_OFFSET(0x182F6190)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_GETDATA_OFFSET UNITYSDK_OFFSET(0x182F60A0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_QUERYGETDATA_OFFSET UNITYSDK_OFFSET(0x182F62E0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IDATAOBJECT_SETDATA_OFFSET UNITYSDK_OFFSET(0x182F6330)
