...
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_CLONE_OFFSET UNITYSDK_OFFSET(0x195DD560)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_NEXT_OFFSET UNITYSDK_OFFSET(0x195DD640)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_RESET_OFFSET UNITYSDK_OFFSET(0x195DD8C0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_SKIP_OFFSET UNITYSDK_OFFSET(0x195DD900)
