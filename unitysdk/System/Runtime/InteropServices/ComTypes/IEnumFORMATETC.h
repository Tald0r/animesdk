...
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_CLONE_OFFSET UNITYSDK_OFFSET(0x191E11B0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_NEXT_OFFSET UNITYSDK_OFFSET(0x191E1290)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_RESET_OFFSET UNITYSDK_OFFSET(0x191E1510)
#define SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IENUMFORMATETC_SKIP_OFFSET UNITYSDK_OFFSET(0x191E1550)
