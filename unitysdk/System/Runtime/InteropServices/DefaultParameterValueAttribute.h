...
#define SYSTEM_RUNTIME_INTEROPSERVICES_DEFAULTPARAMETERVALUEATTRIBUTE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x190ADBE0)
#define SYSTEM_RUNTIME_INTEROPSERVICES_DEFAULTPARAMETERVALUEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x190ADBD0)
