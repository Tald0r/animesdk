...
#define SYSTEM_FORMATTABLESTRING_SYSTEM_IFORMATTABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19CBE4E0)
#define SYSTEM_FORMATTABLESTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19CBE590)
#define SYSTEM_FORMATTABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19CBE6B0)
