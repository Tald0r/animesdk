...
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_DOWNHEAP_OFFSET UNITYSDK_OFFSET(0x8B12D0)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_HEAPSORT_OFFSET UNITYSDK_OFFSET(0x8B1240)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_INSERTIONSORT_OFFSET UNITYSDK_OFFSET(0x8B12E0)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_INTROSORT_OFFSET UNITYSDK_OFFSET(0x8B1220)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_INTROSPECTIVESORT_OFFSET UNITYSDK_OFFSET(0x8B1210)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_PICKPIVOTANDPARTITION_OFFSET UNITYSDK_OFFSET(0x8B1230)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_SORT_OFFSET UNITYSDK_OFFSET(0x8B1210)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_SWAPIFGREATERWITHITEMS_OFFSET UNITYSDK_OFFSET(0x8B11F0)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY_SWAP_OFFSET UNITYSDK_OFFSET(0x8B1200)
#define SYSTEM_ARRAY_SORTEROBJECTARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x8B11A0)
