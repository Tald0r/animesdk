...
#define SYSTEM_RESOLVEEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A13CBF0)
#define SYSTEM_RESOLVEEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A13CC30)
#define SYSTEM_RESOLVEEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A13C650)
#define SYSTEM_RESOLVEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A13C630)
