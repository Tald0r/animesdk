...
#define SYSTEM_TIMERS_ELAPSEDEVENTARGS_GET_SIGNALTIME_OFFSET UNITYSDK_OFFSET(0x193BC700)
#define SYSTEM_TIMERS_ELAPSEDEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193BC710)
#define SYSTEM_TIMERS_ELAPSEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x193BC6D0)
