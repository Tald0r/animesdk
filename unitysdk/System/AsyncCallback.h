...
#define SYSTEM_ASYNCCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18FE4C20)
#define SYSTEM_ASYNCCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18FE4C50)
#define SYSTEM_ASYNCCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18FE4720)
#define SYSTEM_ASYNCCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE4700)
