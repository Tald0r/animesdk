...
#define SYSTEM_REFLECTION_LOCALVARIABLEINFO_GET_LOCALINDEX_OFFSET UNITYSDK_OFFSET(0x192F92D0)
#define SYSTEM_REFLECTION_LOCALVARIABLEINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x192F92E0)
#define SYSTEM_REFLECTION_LOCALVARIABLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x192F92C0)
