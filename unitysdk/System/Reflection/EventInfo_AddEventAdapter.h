...
#define SYSTEM_REFLECTION_EVENTINFO_ADDEVENTADAPTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19B77780)
#define SYSTEM_REFLECTION_EVENTINFO_ADDEVENTADAPTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19B777C0)
#define SYSTEM_REFLECTION_EVENTINFO_ADDEVENTADAPTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19B77200)
#define SYSTEM_REFLECTION_EVENTINFO_ADDEVENTADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B771F0)
