...
#define SYSTEM_REFLECTION_TYPEFILTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19514360)
#define SYSTEM_REFLECTION_TYPEFILTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x195143A0)
#define SYSTEM_REFLECTION_TYPEFILTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19513DC0)
#define SYSTEM_REFLECTION_TYPEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19513DB0)
