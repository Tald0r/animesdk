...
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_083577508CCFDAF3_OFFSET UNITYSDK_OFFSET(0x18DAA3E0)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_112470CB691FDA03_OFFSET UNITYSDK_OFFSET(0x18DAA190)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_174799846CA15A4F_OFFSET UNITYSDK_OFFSET(0x18DA9E80)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_2F6219C4A95C40F8_1_OFFSET UNITYSDK_OFFSET(0x18DAA400)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_2F6219C4A95C40F8_OFFSET UNITYSDK_OFFSET(0x18DAA0B0)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_33E1CA6DAAD71527_OFFSET UNITYSDK_OFFSET(0x18DAA390)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_49E3FA61F17A6A16_OFFSET UNITYSDK_OFFSET(0x18DA9D90)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_4AF4168DFA35476A_OFFSET UNITYSDK_OFFSET(0x18DAA0E0)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_683AB4C0BF80802E_OFFSET UNITYSDK_OFFSET(0x18DA9F30)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x18DA9D80)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_A285420CEEE763C4_OFFSET UNITYSDK_OFFSET(0x18DAA1A0)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_BDBBE7F5A62DA389_OFFSET UNITYSDK_OFFSET(0x18DA9EB0)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x18DAA3F0)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_D1930F218259A7F2_OFFSET UNITYSDK_OFFSET(0x18DA9FB0)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_E291BBBD9ADF338F_OFFSET UNITYSDK_OFFSET(0x18DAA130)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x18DA9DC0)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_F0088C88851A7DFB_2_OFFSET UNITYSDK_OFFSET(0x18DA9DE0)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_F0088C88851A7DFB_3_OFFSET UNITYSDK_OFFSET(0x18DA9E00)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_F0088C88851A7DFB_4_OFFSET UNITYSDK_OFFSET(0x18DA9E20)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_F0088C88851A7DFB_5_OFFSET UNITYSDK_OFFSET(0x18DA9E40)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_F0088C88851A7DFB_6_OFFSET UNITYSDK_OFFSET(0x18DA9E60)
#define SYSTEM_REFLECTION_FIELDINFO_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x18DA9DA0)
