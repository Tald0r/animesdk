...
#define SYSTEM_REFLECTION_EMIT_ASSEMBLYBUILDER_DEFINEDYNAMICASSEMBLY_OFFSET UNITYSDK_OFFSET(0x19AD25E0)
#define SYSTEM_REFLECTION_EMIT_ASSEMBLYBUILDER_DEFINEDYNAMICMODULE_OFFSET UNITYSDK_OFFSET(0x19AD2630)
#define SYSTEM_REFLECTION_EMIT_ASSEMBLYBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD2680)
