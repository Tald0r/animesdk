...
#define SYSTEM_REFLECTION_EMIT_ASSEMBLYBUILDER_DEFINEDYNAMICASSEMBLY_OFFSET UNITYSDK_OFFSET(0x1A0C0BA0)
#define SYSTEM_REFLECTION_EMIT_ASSEMBLYBUILDER_DEFINEDYNAMICMODULE_OFFSET UNITYSDK_OFFSET(0x1A0C0BF0)
#define SYSTEM_REFLECTION_EMIT_ASSEMBLYBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0C0C40)
