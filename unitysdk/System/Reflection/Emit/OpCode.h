...
#define SYSTEM_REFLECTION_EMIT_OPCODE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7E8CE0)
#define SYSTEM_REFLECTION_EMIT_OPCODE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7E8C50)
#define SYSTEM_REFLECTION_EMIT_OPCODE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x7E8D40)
#define SYSTEM_REFLECTION_EMIT_OPCODE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x7E8D50)
#define SYSTEM_REFLECTION_EMIT_OPCODE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1858E510)
#define SYSTEM_REFLECTION_EMIT_OPCODE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1858E520)
#define SYSTEM_REFLECTION_EMIT_OPCODE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7E8D40)
#define SYSTEM_REFLECTION_EMIT_OPCODE__CTOR_OFFSET UNITYSDK_OFFSET(0x7E8C20)
