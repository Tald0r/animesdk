...
#define SYSTEM_REFLECTION_EMIT_TYPEBUILDERINSTANTIATION_MAKEGENERICTYPE_OFFSET UNITYSDK_OFFSET(0x19CC6B80)
#define SYSTEM_REFLECTION_EMIT_TYPEBUILDERINSTANTIATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC6BD0)
