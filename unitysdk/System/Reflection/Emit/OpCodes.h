...
#define SYSTEM_REFLECTION_EMIT_OPCODES__CCTOR_OFFSET UNITYSDK_OFFSET(0x17F5A310)
#define SYSTEM_REFLECTION_EMIT_OPCODES__CTOR_OFFSET UNITYSDK_OFFSET(0x17F5A300)
