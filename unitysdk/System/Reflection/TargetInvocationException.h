...
#define SYSTEM_REFLECTION_TARGETINVOCATIONEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197B60A0)
#define SYSTEM_REFLECTION_TARGETINVOCATIONEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x197B6150)
#define SYSTEM_REFLECTION_TARGETINVOCATIONEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x197B61C0)
#define SYSTEM_REFLECTION_TARGETINVOCATIONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x197B6000)
