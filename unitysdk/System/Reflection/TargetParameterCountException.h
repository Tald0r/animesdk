...
#define SYSTEM_REFLECTION_TARGETPARAMETERCOUNTEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19857620)
#define SYSTEM_REFLECTION_TARGETPARAMETERCOUNTEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19857690)
#define SYSTEM_REFLECTION_TARGETPARAMETERCOUNTEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19857580)
