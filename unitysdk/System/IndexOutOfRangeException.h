...
#define SYSTEM_INDEXOUTOFRANGEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19856C10)
#define SYSTEM_INDEXOUTOFRANGEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19856C80)
#define SYSTEM_INDEXOUTOFRANGEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19856B70)
