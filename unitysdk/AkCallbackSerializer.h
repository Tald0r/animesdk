...
#define AKCALLBACKSERIALIZER_AUDIOSOURCECHANGECALLBACKFUNC_OFFSET UNITYSDK_OFFSET(0x1B6FA1F0)
#define AKCALLBACKSERIALIZER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B6F9E00)
#define AKCALLBACKSERIALIZER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B6F9D40)
#define AKCALLBACKSERIALIZER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B6F9D90)
#define AKCALLBACKSERIALIZER_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1B6F9CD0)
#define AKCALLBACKSERIALIZER_INIT_OFFSET UNITYSDK_OFFSET(0x1B6F9F60)
#define AKCALLBACKSERIALIZER_LOCK_OFFSET UNITYSDK_OFFSET(0x1B6FA070)
#define AKCALLBACKSERIALIZER_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1B6F9CE0)
#define AKCALLBACKSERIALIZER_SETLOCALOUTPUT_OFFSET UNITYSDK_OFFSET(0x1B6FA170)
#define AKCALLBACKSERIALIZER_TERM_OFFSET UNITYSDK_OFFSET(0x1B6F9FF0)
#define AKCALLBACKSERIALIZER_UNLOCK_OFFSET UNITYSDK_OFFSET(0x1B6FA0F0)
#define AKCALLBACKSERIALIZER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6FA2B0)
#define AKCALLBACKSERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F9CC0)

inline static constexpr unsigned int AkCallbackSerializer_TypeDefinitionIndex = 30871;
