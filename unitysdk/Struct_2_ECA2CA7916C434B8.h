...
#define STRUCT_2_ECA2CA7916C434B8_METHOD_2_4C5B0382BFD2F6C7_OFFSET UNITYSDK_OFFSET(0x379A20)
#define STRUCT_2_ECA2CA7916C434B8_METHOD_2_9C12A00315CAECCE_OFFSET UNITYSDK_OFFSET(0x379960)
#define STRUCT_2_ECA2CA7916C434B8_METHOD_2_CA4BE6C7E64D0A7D_OFFSET UNITYSDK_OFFSET(0x379A30)

inline static constexpr unsigned int Struct_2_ECA2CA7916C434B8_TypeDefinitionIndex = 55922;
...
struct alignas(8) Struct_2_ECA2CA7916C434B8
{
	...
	::SimpleJSON::JSONNode* Method_2_4C5B0382BFD2F6C7()
	{
		return ((::SimpleJSON::JSONNode*(*)(::PVOID))((::PBYTE)hIl2Cpp + STRUCT_2_ECA2CA7916C434B8_METHOD_2_4C5B0382BFD2F6C7_OFFSET))(this);
	}
