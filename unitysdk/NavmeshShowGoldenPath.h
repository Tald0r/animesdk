...
#define NAVMESHSHOWGOLDENPATH_RAYCASTSPHERE_OFFSET UNITYSDK_OFFSET(0x1B67AB50)
#define NAVMESHSHOWGOLDENPATH_START_OFFSET UNITYSDK_OFFSET(0x1B67A000)
#define NAVMESHSHOWGOLDENPATH_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B67A090)
#define NAVMESHSHOWGOLDENPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B67B190)

inline static constexpr unsigned int NavmeshShowGoldenPath_TypeDefinitionIndex = 83749;
