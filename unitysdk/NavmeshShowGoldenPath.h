...
#define NAVMESHSHOWGOLDENPATH_RAYCASTSPHERE_OFFSET UNITYSDK_OFFSET(0x1B06CE40)
#define NAVMESHSHOWGOLDENPATH_START_OFFSET UNITYSDK_OFFSET(0x1B06C2F0)
#define NAVMESHSHOWGOLDENPATH_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B06C380)
#define NAVMESHSHOWGOLDENPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B06D480)

inline static constexpr unsigned int NavmeshShowGoldenPath_TypeDefinitionIndex = 81711;
