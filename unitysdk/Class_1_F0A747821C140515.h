...
#define CLASS_1_F0A747821C140515_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0xAAA4720)
#define CLASS_1_F0A747821C140515_SERIALIZE_OFFSET UNITYSDK_OFFSET(0xAAA4650)
#define CLASS_1_F0A747821C140515__CCTOR_OFFSET UNITYSDK_OFFSET(0xAAA4830)
#define CLASS_1_F0A747821C140515__CTOR_OFFSET UNITYSDK_OFFSET(0xAAA4820)

inline static constexpr unsigned int Class_1_F0A747821C140515_TypeDefinitionIndex = 72658;
...
public:
	...
	{
		return (::Class_1_F0A747821C140515**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F0A747821C140515_TypeDefinitionIndex)->GetStaticField(0x2EBF0);
	}
