...
#define CLASS_1_A0EE873EACD64B72_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x6998EE0)
#define CLASS_1_A0EE873EACD64B72_FROMFLX_OFFSET UNITYSDK_OFFSET(0x69976D0)
#define CLASS_1_A0EE873EACD64B72_METHOD_1_1943FA7E230C2956_OFFSET UNITYSDK_OFFSET(0x69999B0)
#define CLASS_1_A0EE873EACD64B72_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x69999A0)
#define CLASS_1_A0EE873EACD64B72_METHOD_1_5CD2CB00158B8315_OFFSET UNITYSDK_OFFSET(0x6998F40)
#define CLASS_1_A0EE873EACD64B72_METHOD_1_82A3EC7819F9DAA7_OFFSET UNITYSDK_OFFSET(0x6997750)
#define CLASS_1_A0EE873EACD64B72_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x6999990)
#define CLASS_1_A0EE873EACD64B72__CCTOR_OFFSET UNITYSDK_OFFSET(0x6999950)
#define CLASS_1_A0EE873EACD64B72__CTOR_OFFSET UNITYSDK_OFFSET(0x6999940)

inline static constexpr unsigned int Class_1_A0EE873EACD64B72_TypeDefinitionIndex = 64487;
...
public:
	...
	{
		return (::Class_1_3FA5D0827BD681C1**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A0EE873EACD64B72_TypeDefinitionIndex)->GetStaticField(0x393E0);
	}
	::MoleMole::Config::ConfigGadgetMetaData* Field_1_11; // 0x10
	::System::Collections::Generic::List_1<::System::String*>* Field_1_13; // 0x18
	::Class_1_5FA9CCDDD9957726* Field_1_16; // 0x20
	::Class_1_3F84F94BB18519B8_1* Field_1_12; // 0x28
	...
	::Enum_3_22FC528C31017F2F Field_1_1; // 0x44
