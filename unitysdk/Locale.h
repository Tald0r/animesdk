...
#define LOCALE_GETTEXT_1_OFFSET UNITYSDK_OFFSET(0x1AFE3800)
#define LOCALE_GETTEXT_OFFSET UNITYSDK_OFFSET(0x1AFE37F0)
#define LOCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE37E0)
