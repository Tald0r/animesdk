...
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B019F20)
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B019F80)
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0199C0)
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0199B0)

inline static constexpr unsigned int AkSoundEngine_UnregisterGameObjectCallback_TypeDefinitionIndex = 29997;
