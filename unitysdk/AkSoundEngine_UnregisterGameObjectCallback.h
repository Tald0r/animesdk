...
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B628370)
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6283D0)
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B627E00)
#define AKSOUNDENGINE_UNREGISTERGAMEOBJECTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B627DE0)

inline static constexpr unsigned int AkSoundEngine_UnregisterGameObjectCallback_TypeDefinitionIndex = 30950;
