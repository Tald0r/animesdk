...
#define SURFINGINTERACTIONFOAM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x196FA120)
#define SURFINGINTERACTIONFOAM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x196F9CF0)
#define SURFINGINTERACTIONFOAM_UPDATE_OFFSET UNITYSDK_OFFSET(0x196F9D50)
#define SURFINGINTERACTIONFOAM__CTOR_OFFSET UNITYSDK_OFFSET(0x196FA1B0)

inline static constexpr unsigned int SurfingInteractionFoam_TypeDefinitionIndex = 61651;
