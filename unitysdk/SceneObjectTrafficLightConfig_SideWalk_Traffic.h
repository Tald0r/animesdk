...
#define SCENEOBJECTTRAFFICLIGHTCONFIG_SIDEWALK_TRAFFIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1853A450)

inline static constexpr unsigned int SceneObjectTrafficLightConfig_SideWalk_Traffic_TypeDefinitionIndex = 60604;
