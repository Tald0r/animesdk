...
#define FRAMEENDREFRESHMANAGER_CALLKEY_COMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x87CF500)
#define FRAMEENDREFRESHMANAGER_CALLKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x34BE30)
#define FRAMEENDREFRESHMANAGER_CALLKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x34BDF0)
#define FRAMEENDREFRESHMANAGER_CALLKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x34BE40)
#define FRAMEENDREFRESHMANAGER_CALLKEY_GETUNITYID_OFFSET UNITYSDK_OFFSET(0x87CF1D0)
#define FRAMEENDREFRESHMANAGER_CALLKEY_MAKEARGKEYS_OFFSET UNITYSDK_OFFSET(0x87CF360)
#define FRAMEENDREFRESHMANAGER_CALLKEY_OWNERSEQUAL_OFFSET UNITYSDK_OFFSET(0x87CF8E0)
#define FRAMEENDREFRESHMANAGER_CALLKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x34BD90)
#define FRAMEENDREFRESHMANAGER_CALLKEY___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x34BEB0)
#define FRAMEENDREFRESHMANAGER_CALLKEY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x34BF30)

inline static constexpr unsigned int FrameEndRefreshManager_CallKey_TypeDefinitionIndex = 54492;
