...
#define FRAMEENDREFRESHMANAGER_CALLKEY_COMPUTEHASH_OFFSET UNITYSDK_OFFSET(0xF463BD0)
#define FRAMEENDREFRESHMANAGER_CALLKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x577700)
#define FRAMEENDREFRESHMANAGER_CALLKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x5776C0)
#define FRAMEENDREFRESHMANAGER_CALLKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x577710)
#define FRAMEENDREFRESHMANAGER_CALLKEY_GETUNITYID_OFFSET UNITYSDK_OFFSET(0xF4638A0)
#define FRAMEENDREFRESHMANAGER_CALLKEY_MAKEARGKEYS_OFFSET UNITYSDK_OFFSET(0xF463A30)
#define FRAMEENDREFRESHMANAGER_CALLKEY_OWNERSEQUAL_OFFSET UNITYSDK_OFFSET(0xF463FB0)
#define FRAMEENDREFRESHMANAGER_CALLKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x577660)
#define FRAMEENDREFRESHMANAGER_CALLKEY___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x577780)
#define FRAMEENDREFRESHMANAGER_CALLKEY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x577800)

inline static constexpr unsigned int FrameEndRefreshManager_CallKey_TypeDefinitionIndex = 68158;
