...
#define CAPSULESHANDLER_ADDCHARACTER_OFFSET UNITYSDK_OFFSET(0x19B1B0E0)
#define CAPSULESHANDLER_CONTAINSCHARACTER_OFFSET UNITYSDK_OFFSET(0x19B1B1F0)
#define CAPSULESHANDLER_DISPOSEBUFFERS_OFFSET UNITYSDK_OFFSET(0x19B1BBC0)
#define CAPSULESHANDLER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19B1AF80)
#define CAPSULESHANDLER_INITIALIZEBUFFERS_OFFSET UNITYSDK_OFFSET(0x19B1B900)
#define CAPSULESHANDLER_REMOVECHARACTER_OFFSET UNITYSDK_OFFSET(0x19B1B730)
#define CAPSULESHANDLER_RESET_OFFSET UNITYSDK_OFFSET(0x19B1B860)
#define CAPSULESHANDLER_UPDATEBUFFERS_OFFSET UNITYSDK_OFFSET(0x19B1BCC0)
#define CAPSULESHANDLER_UPDATECHARACTERSHADOWS_OFFSET UNITYSDK_OFFSET(0x19B1BD30)
#define CAPSULESHANDLER_UPDATELISTS_OFFSET UNITYSDK_OFFSET(0x19B1B280)
#define CAPSULESHANDLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B1BED0)
#define CAPSULESHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1B000)

inline static constexpr unsigned int CapsulesHandler_TypeDefinitionIndex = 28151;
...
public:
	...
	{
		return (::CapsulesHandler**)Il2CppClass::FromTypeDefinitionIndex(CapsulesHandler_TypeDefinitionIndex)->GetStaticField(0x221D0);
	}
	static ::System::Boolean* StaticGet_capsuleAOCharacterExists()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(CapsulesHandler_TypeDefinitionIndex)->GetStaticField(0x6AD0);
	}
	::UnityEngine::ComputeBuffer* capsulesBuffer; // 0x10
	::System::Collections::Generic::List_1<::Character>* Characters; // 0x18
	::UnityEngine::ComputeBuffer* charactersBuffer; // 0x20
	::System::Collections::Generic::List_1<::Capsule>* Capsules; // 0x28
	::System::Collections::Generic::List_1<::MonoRenderEntity*>* CharacterShadows; // 0x30
