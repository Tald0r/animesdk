...
#define CLASS_2_EC5A7AD641CF932C_STRUCT_2_D3C819F24441B3C6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x37D450)
#define CLASS_2_EC5A7AD641CF932C_STRUCT_2_D3C819F24441B3C6_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

inline static constexpr unsigned int Class_2_EC5A7AD641CF932C_Struct_2_D3C819F24441B3C6_TypeDefinitionIndex = 69917;

struct alignas(8) Class_2_EC5A7AD641CF932C_Struct_2_D3C819F24441B3C6
{
	::System::Collections::Generic::IList_1<::System::String*>* Field_2_10; // 0x10
	::Class_2_EC5A7AD641CF932C* Field_2_2; // 0x18
	::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::Class_2_EC5A7AD641CF932C_Class_1_BCC994F93231B781*> Field_2_11; // 0x20
