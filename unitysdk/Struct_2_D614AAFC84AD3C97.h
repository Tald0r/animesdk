...
#define STRUCT_2_D614AAFC84AD3C97_METHOD_2_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x45D750)
#define STRUCT_2_D614AAFC84AD3C97_METHOD_2_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x2F2E20)
#define STRUCT_2_D614AAFC84AD3C97_METHOD_2_2209773381A72B3E_OFFSET UNITYSDK_OFFSET(0x45D7D0)
#define STRUCT_2_D614AAFC84AD3C97_METHOD_2_9763C1632AD7B1F4_OFFSET UNITYSDK_OFFSET(0x45D7C0)

inline static constexpr unsigned int Struct_2_D614AAFC84AD3C97_TypeDefinitionIndex = 61154;

struct alignas(8) Struct_2_D614AAFC84AD3C97
{
	::Struct_2_E147DFD2A4EE8B0B Field_2_0; // 0x10
	::Class_0_16E4307DCC419505_195* Field_2_1; // 0x28
