...
#define CLASS_3_F9C281C6214ADFA5_CREATEFILTERS_OFFSET UNITYSDK_OFFSET(0x716D0A0)
#define CLASS_3_F9C281C6214ADFA5_METHOD_3_3EDF51F11BB8555D_OFFSET UNITYSDK_OFFSET(0x716DC50)
#define CLASS_3_F9C281C6214ADFA5_METHOD_3_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0x716DBE0)
#define CLASS_3_F9C281C6214ADFA5_METHOD_3_8DC652D916C182B2_OFFSET UNITYSDK_OFFSET(0x716D420)
#define CLASS_3_F9C281C6214ADFA5_METHOD_3_BADC81CF9C936EDA_OFFSET UNITYSDK_OFFSET(0x716DB70)
#define CLASS_3_F9C281C6214ADFA5_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x716EA60)
#define CLASS_3_F9C281C6214ADFA5_UPDATE_OFFSET UNITYSDK_OFFSET(0x716D340)
#define CLASS_3_F9C281C6214ADFA5__CCTOR_OFFSET UNITYSDK_OFFSET(0x716DB00)
#define CLASS_3_F9C281C6214ADFA5__CTOR_OFFSET UNITYSDK_OFFSET(0x716DAE0)

inline static constexpr unsigned int Class_3_F9C281C6214ADFA5_TypeDefinitionIndex = 77165;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_3_F9C281C6214ADFA5_TypeDefinitionIndex)->GetStaticField(0x294B0);
	}
	static ::System::Action_3<::Class_3_B4FB01F6D0265A09*, ::Class_3_3B9412253A0E3E79*, ::Class_3_F35B080B137ECC46*>** StaticGet_Field_3_2()
	{
		return (::System::Action_3<::Class_3_B4FB01F6D0265A09*, ::Class_3_3B9412253A0E3E79*, ::Class_3_F35B080B137ECC46*>**)Il2CppClass::FromTypeDefinitionIndex(Class_3_F9C281C6214ADFA5_TypeDefinitionIndex)->GetStaticField(0x294B8);
	}
