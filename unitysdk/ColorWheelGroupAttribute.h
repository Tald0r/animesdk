...
#define COLORWHEELGROUPATTRIBUTE_CONVERTTOFORMATTEDSTRING_OFFSET UNITYSDK_OFFSET(0x185B4EE0)
#define COLORWHEELGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x185B5310)

inline static constexpr unsigned int ColorWheelGroupAttribute_TypeDefinitionIndex = 28069;
