...
#define ENGINECHECKER_GET_BASEOBJECTCHECKLEVEL_OFFSET UNITYSDK_OFFSET(0x7021450)
#define ENGINECHECKER_INITENGINECHECKFLAGS_OFFSET UNITYSDK_OFFSET(0x70214E0)
#define ENGINECHECKER_SET_BASEOBJECTCHECKLEVEL_OFFSET UNITYSDK_OFFSET(0x7021460)
#define ENGINECHECKER__CCTOR_OFFSET UNITYSDK_OFFSET(0x70215D0)
#define ENGINECHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0x70215C0)

inline static constexpr unsigned int EngineChecker_TypeDefinitionIndex = 50041;
...
public:
	...
	{
		return (::EngineChecker_CheckLevel*)Il2CppClass::FromTypeDefinitionIndex(EngineChecker_TypeDefinitionIndex)->GetStaticField(0x103D0);
	}
