...
#define NAPSCENEANIMATIONDYNAMICPROXY_AUTOBINDMATERIAL_OFFSET UNITYSDK_OFFSET(0x7588990)
#define NAPSCENEANIMATIONDYNAMICPROXY_AUTOBINDPARTICLES_OFFSET UNITYSDK_OFFSET(0x7588B90)
#define NAPSCENEANIMATIONDYNAMICPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x7588EE0)
#define NAPSCENEANIMATIONDYNAMICPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x7588D50)
#define NAPSCENEANIMATIONDYNAMICPROXY_PAUSE_OFFSET UNITYSDK_OFFSET(0x7589070)
#define NAPSCENEANIMATIONDYNAMICPROXY_REPLAY_OFFSET UNITYSDK_OFFSET(0x7589400)
#define NAPSCENEANIMATIONDYNAMICPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x7589750)

inline static constexpr unsigned int NapSceneAnimationDynamicProxy_TypeDefinitionIndex = 70135;
