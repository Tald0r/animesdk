...
#define ACLSTREAMINGCACHEDISPLAYER_APPLYSORTINPLACE_OFFSET UNITYSDK_OFFSET(0x11ABFED0)
#define ACLSTREAMINGCACHEDISPLAYER_BUILDLAYOUT_OFFSET UNITYSDK_OFFSET(0x11ABC6A0)
#define ACLSTREAMINGCACHEDISPLAYER_CLAMPPAGE_OFFSET UNITYSDK_OFFSET(0x11ABD570)
#define ACLSTREAMINGCACHEDISPLAYER_COMPUTESCALE_OFFSET UNITYSDK_OFFSET(0x11ABC600)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWLIST_OFFSET UNITYSDK_OFFSET(0x11ABF400)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWPAGER_OFFSET UNITYSDK_OFFSET(0x11ABF9B0)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWPROGRESS_OFFSET UNITYSDK_OFFSET(0x11ABEC40)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWTEX_OFFSET UNITYSDK_OFFSET(0x11ABE9B0)
#define ACLSTREAMINGCACHEDISPLAYER_ENSURESTYLES_OFFSET UNITYSDK_OFFSET(0x11ABDEA0)
#define ACLSTREAMINGCACHEDISPLAYER_FORMATBYTES_OFFSET UNITYSDK_OFFSET(0x11ABF100)
#define ACLSTREAMINGCACHEDISPLAYER_GETCLIPS_OFFSET UNITYSDK_OFFSET(0x11ABF2E0)
#define ACLSTREAMINGCACHEDISPLAYER_MINIBUTTON_OFFSET UNITYSDK_OFFSET(0x11ABEFC0)
#define ACLSTREAMINGCACHEDISPLAYER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x11ABD1E0)
#define ACLSTREAMINGCACHEDISPLAYER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11ABC380)
#define ACLSTREAMINGCACHEDISPLAYER_ONGUI_OFFSET UNITYSDK_OFFSET(0x11ABD670)
#define ACLSTREAMINGCACHEDISPLAYER_SORTLABEL_OFFSET UNITYSDK_OFFSET(0x11ABF340)
#define ACLSTREAMINGCACHEDISPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0x11ABD310)
#define ACLSTREAMINGCACHEDISPLAYER__APPLYSORTINPLACE_B__76_0_OFFSET UNITYSDK_OFFSET(0x11AC0C40)
#define ACLSTREAMINGCACHEDISPLAYER__CCTOR_OFFSET UNITYSDK_OFFSET(0x11AC0C00)
#define ACLSTREAMINGCACHEDISPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x11AC0A50)

inline static constexpr unsigned int ACLStreamingCacheDisplayer_TypeDefinitionIndex = 84208;
...
public:
	...
	{
		return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(ACLStreamingCacheDisplayer_TypeDefinitionIndex)->GetStaticField(0x11DB0);
	}
