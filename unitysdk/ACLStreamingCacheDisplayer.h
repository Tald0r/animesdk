...
#define ACLSTREAMINGCACHEDISPLAYER_APPLYSORTINPLACE_OFFSET UNITYSDK_OFFSET(0x12444820)
#define ACLSTREAMINGCACHEDISPLAYER_BUILDLAYOUT_OFFSET UNITYSDK_OFFSET(0x12440FF0)
#define ACLSTREAMINGCACHEDISPLAYER_CLAMPPAGE_OFFSET UNITYSDK_OFFSET(0x12441EC0)
#define ACLSTREAMINGCACHEDISPLAYER_COMPUTESCALE_OFFSET UNITYSDK_OFFSET(0x12440F50)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWLIST_OFFSET UNITYSDK_OFFSET(0x12443D50)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWPAGER_OFFSET UNITYSDK_OFFSET(0x12444300)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWPROGRESS_OFFSET UNITYSDK_OFFSET(0x12443590)
#define ACLSTREAMINGCACHEDISPLAYER_DRAWTEX_OFFSET UNITYSDK_OFFSET(0x12443300)
#define ACLSTREAMINGCACHEDISPLAYER_ENSURESTYLES_OFFSET UNITYSDK_OFFSET(0x124427F0)
#define ACLSTREAMINGCACHEDISPLAYER_FORMATBYTES_OFFSET UNITYSDK_OFFSET(0x12443A50)
#define ACLSTREAMINGCACHEDISPLAYER_GETCLIPS_OFFSET UNITYSDK_OFFSET(0x12443C30)
#define ACLSTREAMINGCACHEDISPLAYER_MINIBUTTON_OFFSET UNITYSDK_OFFSET(0x12443910)
#define ACLSTREAMINGCACHEDISPLAYER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x12441B30)
#define ACLSTREAMINGCACHEDISPLAYER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x12440CD0)
#define ACLSTREAMINGCACHEDISPLAYER_ONGUI_OFFSET UNITYSDK_OFFSET(0x12441FC0)
#define ACLSTREAMINGCACHEDISPLAYER_SORTLABEL_OFFSET UNITYSDK_OFFSET(0x12443C90)
#define ACLSTREAMINGCACHEDISPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0x12441C60)
#define ACLSTREAMINGCACHEDISPLAYER__APPLYSORTINPLACE_B__76_0_OFFSET UNITYSDK_OFFSET(0x12445590)
#define ACLSTREAMINGCACHEDISPLAYER__CCTOR_OFFSET UNITYSDK_OFFSET(0x12445550)
#define ACLSTREAMINGCACHEDISPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x124453A0)

inline static constexpr unsigned int ACLStreamingCacheDisplayer_TypeDefinitionIndex = 82134;
...
public:
	...
	{
		return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(ACLStreamingCacheDisplayer_TypeDefinitionIndex)->GetStaticField(0x11CA0);
	}
