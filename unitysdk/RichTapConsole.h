...
#define RICHTAPCONSOLE_ADDMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A7A99F0)
#define RICHTAPCONSOLE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A7B1610)
#define RICHTAPCONSOLE_CLAMPWINDOWPOSITION_OFFSET UNITYSDK_OFFSET(0x1A7B1AF0)
#define RICHTAPCONSOLE_CLEARALLMESSAGES_OFFSET UNITYSDK_OFFSET(0x1A7B1F40)
#define RICHTAPCONSOLE_DRAWCONSOLEWINDOW_OFFSET UNITYSDK_OFFSET(0x1A7B19E0)
#define RICHTAPCONSOLE_DRAWTOOLBAR_OFFSET UNITYSDK_OFFSET(0x1A7B1E20)
#define RICHTAPCONSOLE_DRAWWINDOWCONTENT_OFFSET UNITYSDK_OFFSET(0x1A7B1B70)
#define RICHTAPCONSOLE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A7B15D0)
#define RICHTAPCONSOLE_INITGUISTYLE_OFFSET UNITYSDK_OFFSET(0x1A7B1820)
#define RICHTAPCONSOLE_INITWINDOWRECT_OFFSET UNITYSDK_OFFSET(0x1A7B17B0)
#define RICHTAPCONSOLE_ONGUI_OFFSET UNITYSDK_OFFSET(0x1A7B19D0)
#define RICHTAPCONSOLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A7B19C0)
#define RICHTAPCONSOLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7B2010)

inline static constexpr unsigned int RichTapConsole_TypeDefinitionIndex = 34922;
...
public:
	...
	{
		return (::RichTapConsole**)Il2CppClass::FromTypeDefinitionIndex(RichTapConsole_TypeDefinitionIndex)->GetStaticField(0x24BF0);
	}
