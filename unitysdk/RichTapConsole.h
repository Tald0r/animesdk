...
#define RICHTAPCONSOLE_ADDMESSAGE_OFFSET UNITYSDK_OFFSET(0x1AD8B6A0)
#define RICHTAPCONSOLE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AD932C0)
#define RICHTAPCONSOLE_CLAMPWINDOWPOSITION_OFFSET UNITYSDK_OFFSET(0x1AD937A0)
#define RICHTAPCONSOLE_CLEARALLMESSAGES_OFFSET UNITYSDK_OFFSET(0x1AD93BE0)
#define RICHTAPCONSOLE_DRAWCONSOLEWINDOW_OFFSET UNITYSDK_OFFSET(0x1AD93690)
#define RICHTAPCONSOLE_DRAWTOOLBAR_OFFSET UNITYSDK_OFFSET(0x1AD93AC0)
#define RICHTAPCONSOLE_DRAWWINDOWCONTENT_OFFSET UNITYSDK_OFFSET(0x1AD93820)
#define RICHTAPCONSOLE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1AD93280)
#define RICHTAPCONSOLE_INITGUISTYLE_OFFSET UNITYSDK_OFFSET(0x1AD934D0)
#define RICHTAPCONSOLE_INITWINDOWRECT_OFFSET UNITYSDK_OFFSET(0x1AD93460)
#define RICHTAPCONSOLE_ONGUI_OFFSET UNITYSDK_OFFSET(0x1AD93680)
#define RICHTAPCONSOLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AD93670)
#define RICHTAPCONSOLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD93CB0)

inline static constexpr unsigned int RichTapConsole_TypeDefinitionIndex = 35924;
...
public:
	...
	{
		return (::RichTapConsole**)Il2CppClass::FromTypeDefinitionIndex(RichTapConsole_TypeDefinitionIndex)->GetStaticField(0x26620);
	}
