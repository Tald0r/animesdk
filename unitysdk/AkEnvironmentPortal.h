...
#define AKENVIRONMENTPORTAL_GETAUXSENDVALUEFORPOSITION_OFFSET UNITYSDK_OFFSET(0x1B017650)
#define AKENVIRONMENTPORTAL_GET_BOXCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1B0171D0)
#define AKENVIRONMENTPORTAL_GET_ENVIRONMENTSSHAREAUXBUS_OFFSET UNITYSDK_OFFSET(0x1B0172E0)
#define AKENVIRONMENTPORTAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B017B60)

inline static constexpr unsigned int AkEnvironmentPortal_TypeDefinitionIndex = 30109;
