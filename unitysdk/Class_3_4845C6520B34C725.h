...
#define CLASS_3_4845C6520B34C725_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x65C0580)
#define CLASS_3_4845C6520B34C725_METHOD_3_32B2368221A04800_OFFSET UNITYSDK_OFFSET(0x65C0750)
#define CLASS_3_4845C6520B34C725_METHOD_3_6B015C3E5E148E39_OFFSET UNITYSDK_OFFSET(0x65C0860)
#define CLASS_3_4845C6520B34C725_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x65C0800)
#define CLASS_3_4845C6520B34C725_METHOD_3_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x65C09F0)
#define CLASS_3_4845C6520B34C725_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x65C0140)
#define CLASS_3_4845C6520B34C725__CCTOR_OFFSET UNITYSDK_OFFSET(0x65C05E0)
#define CLASS_3_4845C6520B34C725__CTOR_OFFSET UNITYSDK_OFFSET(0x65C0660)

inline static constexpr unsigned int Class_3_4845C6520B34C725_TypeDefinitionIndex = 76964;

class Class_3_4845C6520B34C725 : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_15 = 0x10; // 0x0
	::System::Collections::Generic::List_1<::RootMotion::FinalIK::AimController*>* Field_3_3; // 0x48
	::UnityEngine::GameObject* Field_3_4; // 0x50
	::System::String* Field_3_7; // 0x58
	::System::Action* Field_3_5; // 0x60
	::System::Collections::Generic::List_1<::RootMotion::FinalIK::AimIK*>* Field_3_0; // 0x68
	::System::Collections::Generic::List_1<::RootMotion::FinalIK::AimController*>* Field_3_2; // 0x70
	::System::Collections::Generic::Dictionary_2<::RootMotion::FinalIK::AimController*, ::RootMotion::FinalIK::IKSolver_UpdateDelegate*>* Field_3_12; // 0x78
	::MoleMole::Config::ConfigPosRot* Field_3_10; // 0x80
	::UnityEngine::Vector3 Field_3_9; // 0x88
	::MoleMole::Config::AimIKLockTargetType Field_3_11; // 0x94
	::System::Single Field_3_14; // 0x98
	::System::Boolean Field_3_6; // 0x9C
	::System::Boolean Field_3_8; // 0x9D
	::System::Boolean Field_3_1; // 0x9E
	::UnityEngine::Vector2 Field_3_13; // 0xA0
