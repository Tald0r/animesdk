...
#define STRUCT_2_433EAFD16930C7BA_EQUALS_OFFSET UNITYSDK_OFFSET(0x2FF0B0)
#define STRUCT_2_433EAFD16930C7BA_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x2FF120)
#define STRUCT_2_433EAFD16930C7BA_METHOD_2_C409EC373E6784B4_OFFSET UNITYSDK_OFFSET(0x69D7E90)
#define STRUCT_2_433EAFD16930C7BA__CCTOR_OFFSET UNITYSDK_OFFSET(0x69D7E50)
#define STRUCT_2_433EAFD16930C7BA__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3730)

inline static constexpr unsigned int Struct_2_433EAFD16930C7BA_TypeDefinitionIndex = 66056;

struct alignas(4) Struct_2_433EAFD16930C7BA
{
	static ::System::UInt32* StaticGet_Field_2_1()
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_433EAFD16930C7BA_TypeDefinitionIndex)->GetStaticField(0xC520);
	}
	static ::Struct_2_433EAFD16930C7BA* StaticGet_Field_2_0()
	{
		return (::Struct_2_433EAFD16930C7BA*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_433EAFD16930C7BA_TypeDefinitionIndex)->GetStaticField(0xC524);
	}
