...
#define STRUCT_2_433EAFD16930C7BA_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A37B0)
#define STRUCT_2_433EAFD16930C7BA_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x3A3820)
#define STRUCT_2_433EAFD16930C7BA_METHOD_2_C409EC373E6784B4_OFFSET UNITYSDK_OFFSET(0xAF19340)
#define STRUCT_2_433EAFD16930C7BA__CCTOR_OFFSET UNITYSDK_OFFSET(0xAF19290)
#define STRUCT_2_433EAFD16930C7BA__CTOR_OFFSET UNITYSDK_OFFSET(0x2F3C30)

inline static constexpr unsigned int Struct_2_433EAFD16930C7BA_TypeDefinitionIndex = 46755;

struct alignas(4) Struct_2_433EAFD16930C7BA
{
	static ::Struct_2_433EAFD16930C7BA* StaticGet_Field_2_0()
	{
		return (::Struct_2_433EAFD16930C7BA*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_433EAFD16930C7BA_TypeDefinitionIndex)->GetStaticField(0x10440);
	}
	static ::System::UInt32* StaticGet_Field_2_1()
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_433EAFD16930C7BA_TypeDefinitionIndex)->GetStaticField(0x10448);
	}
