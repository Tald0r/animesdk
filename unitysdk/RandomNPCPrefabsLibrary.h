...
#define RANDOMNPCPREFABSLIBRARY__CTOR_OFFSET UNITYSDK_OFFSET(0x10BAFED0)

inline static constexpr unsigned int RandomNPCPrefabsLibrary_TypeDefinitionIndex = 66402;
