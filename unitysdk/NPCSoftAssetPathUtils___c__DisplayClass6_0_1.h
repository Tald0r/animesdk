...
inline static constexpr unsigned int NPCSoftAssetPathUtils___c__DisplayClass6_0_1_TypeDefinitionIndex = 73725;

template <typename T>
class NPCSoftAssetPathUtils___c__DisplayClass6_0_1 : public ::System::Object
{
public:
	::Cysharp::Threading::Tasks::UniTaskCompletionSource_1<T>* s; // 0x0
