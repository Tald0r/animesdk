...
#define CLASS_1_A8D9A742F7AB118B_METHOD_1_0BE1846AC20D43BE_OFFSET UNITYSDK_OFFSET(0x8291EB0)
#define CLASS_1_A8D9A742F7AB118B_METHOD_1_A8AE4A9A45E37F95_OFFSET UNITYSDK_OFFSET(0x82920F0)
#define CLASS_1_A8D9A742F7AB118B_METHOD_1_A9BE66C3121D30F7_OFFSET UNITYSDK_OFFSET(0x8292210)
#define CLASS_1_A8D9A742F7AB118B__CTOR_OFFSET UNITYSDK_OFFSET(0x8291EA0)

inline static constexpr unsigned int Class_1_A8D9A742F7AB118B_TypeDefinitionIndex = 55527;
...
public:
	...
	{
		return (::MoleMole::Config::ConfigAutoBattleAccessoryEffect**)Il2CppClass::FromTypeDefinitionIndex(Class_1_A8D9A742F7AB118B_TypeDefinitionIndex)->GetStaticField(0x33110);
	}
