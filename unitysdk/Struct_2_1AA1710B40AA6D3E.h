...
#define STRUCT_2_1AA1710B40AA6D3E_METHOD_2_C2245EC58D417830_OFFSET UNITYSDK_OFFSET(0x3605C0)
#define STRUCT_2_1AA1710B40AA6D3E__CCTOR_OFFSET UNITYSDK_OFFSET(0x8DF6020)

inline static constexpr unsigned int Struct_2_1AA1710B40AA6D3E_TypeDefinitionIndex = 48498;

struct alignas(4) Struct_2_1AA1710B40AA6D3E
{
	static ::Struct_2_1AA1710B40AA6D3E* StaticGet_Field_2_3()
	{
		return (::Struct_2_1AA1710B40AA6D3E*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_1AA1710B40AA6D3E_TypeDefinitionIndex)->GetStaticField(0xA340);
	}
