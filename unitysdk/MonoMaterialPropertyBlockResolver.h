...
#define MONOMATERIALPROPERTYBLOCKRESOLVER_INIT_OFFSET UNITYSDK_OFFSET(0x972A0C0)
#define MONOMATERIALPROPERTYBLOCKRESOLVER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x972A3F0)
#define MONOMATERIALPROPERTYBLOCKRESOLVER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x972A040)
#define MONOMATERIALPROPERTYBLOCKRESOLVER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x972A380)
#define MONOMATERIALPROPERTYBLOCKRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x972B020)

inline static constexpr unsigned int MonoMaterialPropertyBlockResolver_TypeDefinitionIndex = 58670;
