...
#define CLASS_1_D9E4C3C79299D8BD_METHOD_1_2D8A4C8F5B7C3014_OFFSET UNITYSDK_OFFSET(0x64F1E40)
#define CLASS_1_D9E4C3C79299D8BD_METHOD_1_6533DC33308961E1_OFFSET UNITYSDK_OFFSET(0x64F2E80)
#define CLASS_1_D9E4C3C79299D8BD_METHOD_1_DE4A4EF3E9227C35_OFFSET UNITYSDK_OFFSET(0x64F30B0)
#define CLASS_1_D9E4C3C79299D8BD__CTOR_OFFSET UNITYSDK_OFFSET(0x64F1E30)

inline static constexpr unsigned int Class_1_D9E4C3C79299D8BD_TypeDefinitionIndex = 69492;
...
public:
	...
	static ::MoleMole::Vector2Int Method_1_DE4A4EF3E9227C35(::UnityEngine::Vector2 a1, ::UnityEngine::Vector2 a2, ::System::Single a3)
	{
		return ((::MoleMole::Vector2Int(*)(::UnityEngine::Vector2, ::UnityEngine::Vector2, ::System::Single))((::PBYTE)hIl2Cpp + CLASS_1_D9E4C3C79299D8BD_METHOD_1_DE4A4EF3E9227C35_OFFSET))(a1, a2, a3);
	}
