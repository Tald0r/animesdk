...
#define ENVVOLUMEFOGCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x72858C0)
#define ENVVOLUMEFOGCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x72859D0)
#define ENVVOLUMEFOGCONTROLLER_RECOVERGLOBALFOGPARAMS_OFFSET UNITYSDK_OFFSET(0x7285840)
#define ENVVOLUMEFOGCONTROLLER_SETHEIGHTFOGCONFIG_OFFSET UNITYSDK_OFFSET(0x72856D0)
#define ENVVOLUMEFOGCONTROLLER_SWITCHPARAMS_OFFSET UNITYSDK_OFFSET(0x72854B0)
#define ENVVOLUMEFOGCONTROLLER_TESTDARK_OFFSET UNITYSDK_OFFSET(0x72855F0)
#define ENVVOLUMEFOGCONTROLLER_TESTLIGHT_OFFSET UNITYSDK_OFFSET(0x7285760)
#define ENVVOLUMEFOGCONTROLLER_TESTSWITCHPARAMS_OFFSET UNITYSDK_OFFSET(0x7285440)
#define ENVVOLUMEFOGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7285A90)

inline static constexpr unsigned int EnvVolumeFogController_TypeDefinitionIndex = 42391;
