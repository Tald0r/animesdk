...
#define ENVVOLUMEFOGCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x8187800)
#define ENVVOLUMEFOGCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x8187910)
#define ENVVOLUMEFOGCONTROLLER_RECOVERGLOBALFOGPARAMS_OFFSET UNITYSDK_OFFSET(0x8187780)
#define ENVVOLUMEFOGCONTROLLER_SETHEIGHTFOGCONFIG_OFFSET UNITYSDK_OFFSET(0x8187610)
#define ENVVOLUMEFOGCONTROLLER_SWITCHPARAMS_OFFSET UNITYSDK_OFFSET(0x81873F0)
#define ENVVOLUMEFOGCONTROLLER_TESTDARK_OFFSET UNITYSDK_OFFSET(0x8187530)
#define ENVVOLUMEFOGCONTROLLER_TESTLIGHT_OFFSET UNITYSDK_OFFSET(0x81876A0)
#define ENVVOLUMEFOGCONTROLLER_TESTSWITCHPARAMS_OFFSET UNITYSDK_OFFSET(0x8187380)
#define ENVVOLUMEFOGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x81879D0)

inline static constexpr unsigned int EnvVolumeFogController_TypeDefinitionIndex = 53887;
