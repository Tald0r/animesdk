...
#define HUEANDSATURATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x164F0FF0)

inline static constexpr unsigned int HueAndSaturationGroup_TypeDefinitionIndex = 44251;
