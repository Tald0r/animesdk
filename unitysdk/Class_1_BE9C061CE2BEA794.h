...
#define CLASS_1_BE9C061CE2BEA794_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8344A50)
#define CLASS_1_BE9C061CE2BEA794_METHOD_1_2A0F87BBFF6387F7_OFFSET UNITYSDK_OFFSET(0x8344E10)
#define CLASS_1_BE9C061CE2BEA794_METHOD_1_D4F033201DFBB6EB_OFFSET UNITYSDK_OFFSET(0x8344C10)
#define CLASS_1_BE9C061CE2BEA794_METHOD_1_DFEC27F1F6CA5A80_OFFSET UNITYSDK_OFFSET(0x8344AC0)
#define CLASS_1_BE9C061CE2BEA794_METHOD_1_EC860A8C4A16970C_OFFSET UNITYSDK_OFFSET(0x8344C20)
#define CLASS_1_BE9C061CE2BEA794__CTOR_OFFSET UNITYSDK_OFFSET(0x8344BE0)

inline static constexpr unsigned int Class_1_BE9C061CE2BEA794_TypeDefinitionIndex = 76737;
