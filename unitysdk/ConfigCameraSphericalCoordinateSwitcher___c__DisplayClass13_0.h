...
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x80C53C0)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER___C__DISPLAYCLASS13_0__WAITUNTILTIMECURSOR_B__0_OFFSET UNITYSDK_OFFSET(0x80C53D0)

inline static constexpr unsigned int ConfigCameraSphericalCoordinateSwitcher___c__DisplayClass13_0_TypeDefinitionIndex = 78826;
