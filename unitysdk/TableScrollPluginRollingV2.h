...
#define TABLESCROLLPLUGINROLLINGV2_ADD_OFFSET UNITYSDK_OFFSET(0x6A838D0)
#define TABLESCROLLPLUGINROLLINGV2_DELTA_OFFSET UNITYSDK_OFFSET(0x6A837D0)
#define TABLESCROLLPLUGINROLLINGV2_DIV_OFFSET UNITYSDK_OFFSET(0x6A83AB0)
#define TABLESCROLLPLUGINROLLINGV2_ISEQUALTO_OFFSET UNITYSDK_OFFSET(0x6A83D60)
#define TABLESCROLLPLUGINROLLINGV2_LERP_OFFSET UNITYSDK_OFFSET(0x6A83E70)
#define TABLESCROLLPLUGINROLLINGV2_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x6A83C90)
#define TABLESCROLLPLUGINROLLINGV2_MUL_OFFSET UNITYSDK_OFFSET(0x6A839C0)
#define TABLESCROLLPLUGINROLLINGV2_POSTPROCESSROLLINGTARGET_OFFSET UNITYSDK_OFFSET(0x6A836D0)
#define TABLESCROLLPLUGINROLLINGV2_STOPTHESHOLD_OFFSET UNITYSDK_OFFSET(0x6A83C20)
#define TABLESCROLLPLUGINROLLINGV2_ZERO_OFFSET UNITYSDK_OFFSET(0x6A83BA0)
#define TABLESCROLLPLUGINROLLINGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x6A83660)
#define TABLESCROLLPLUGINROLLINGV2___BASE_POSTPROCESSROLLINGTARGET_OFFSET UNITYSDK_OFFSET(0x6A83F10)

inline static constexpr unsigned int TableScrollPluginRollingV2_TypeDefinitionIndex = 73946;
