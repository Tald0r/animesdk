...
#define TABLESCROLLPLUGINROLLINGV2_ADD_OFFSET UNITYSDK_OFFSET(0x16EB2680)
#define TABLESCROLLPLUGINROLLINGV2_DELTA_OFFSET UNITYSDK_OFFSET(0x16EB2580)
#define TABLESCROLLPLUGINROLLINGV2_DIV_OFFSET UNITYSDK_OFFSET(0x16EB2860)
#define TABLESCROLLPLUGINROLLINGV2_ISEQUALTO_OFFSET UNITYSDK_OFFSET(0x16EB2B10)
#define TABLESCROLLPLUGINROLLINGV2_LERP_OFFSET UNITYSDK_OFFSET(0x16EB2C20)
#define TABLESCROLLPLUGINROLLINGV2_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x16EB2A40)
#define TABLESCROLLPLUGINROLLINGV2_MUL_OFFSET UNITYSDK_OFFSET(0x16EB2770)
#define TABLESCROLLPLUGINROLLINGV2_POSTPROCESSROLLINGTARGET_OFFSET UNITYSDK_OFFSET(0x16EB2480)
#define TABLESCROLLPLUGINROLLINGV2_STOPTHESHOLD_OFFSET UNITYSDK_OFFSET(0x16EB29D0)
#define TABLESCROLLPLUGINROLLINGV2_ZERO_OFFSET UNITYSDK_OFFSET(0x16EB2950)
#define TABLESCROLLPLUGINROLLINGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x16EB2410)
#define TABLESCROLLPLUGINROLLINGV2___BASE_POSTPROCESSROLLINGTARGET_OFFSET UNITYSDK_OFFSET(0x16EB2CC0)

inline static constexpr unsigned int TableScrollPluginRollingV2_TypeDefinitionIndex = 70700;
