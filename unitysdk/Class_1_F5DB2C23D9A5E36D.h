...
#define CLASS_1_F5DB2C23D9A5E36D__CTOR_OFFSET UNITYSDK_OFFSET(0xC4AE8A0)

inline static constexpr unsigned int Class_1_F5DB2C23D9A5E36D_TypeDefinitionIndex = 53057;
...
public:
	...
	::MoleMole::Level::RatingType Field_1_2; // 0x18
