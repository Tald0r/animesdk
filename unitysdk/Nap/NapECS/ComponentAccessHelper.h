...
#define NAP_NAPECS_COMPONENTACCESSHELPER_TOCOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x18D74810)

namespace Nap::NapECS
{
	inline static constexpr unsigned int ComponentAccessHelper_TypeDefinitionIndex = 35126;
