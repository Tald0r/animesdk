...
#define NAP_NAPECS_COMPONENTACCESSHELPER_TOCOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x188154C0)

namespace Nap::NapECS
{
	inline static constexpr unsigned int ComponentAccessHelper_TypeDefinitionIndex = 34205;
