...
#define NAP_NAPECS_ECSDATACOMPSCOPEWRITER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x842710)
#define NAP_NAPECS_ECSDATACOMPSCOPEWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x842700)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsDataCompScopeWriter_TypeDefinitionIndex = 34208;
