...
#define NAP_NAPECS_ECSCOMPONENTCHUNK_REGISTERENTITY_OFFSET UNITYSDK_OFFSET(0x18821500)
#define NAP_NAPECS_ECSCOMPONENTCHUNK_REMOVESWAPENTITYID_OFFSET UNITYSDK_OFFSET(0x18821E20)
#define NAP_NAPECS_ECSCOMPONENTCHUNK_UNREGISTERENTITY_OFFSET UNITYSDK_OFFSET(0x188218C0)
#define NAP_NAPECS_ECSCOMPONENTCHUNK__CTOR_OFFSET UNITYSDK_OFFSET(0x18819F80)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsComponentChunk_TypeDefinitionIndex = 34171;
