...
#define NAP_NAPECS_ECSCOMPONENTCHUNK_REGISTERENTITY_OFFSET UNITYSDK_OFFSET(0x18D80850)
#define NAP_NAPECS_ECSCOMPONENTCHUNK_REMOVESWAPENTITYID_OFFSET UNITYSDK_OFFSET(0x18D81160)
#define NAP_NAPECS_ECSCOMPONENTCHUNK_UNREGISTERENTITY_OFFSET UNITYSDK_OFFSET(0x18D80C00)
#define NAP_NAPECS_ECSCOMPONENTCHUNK__CTOR_OFFSET UNITYSDK_OFFSET(0x18D792B0)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsComponentChunk_TypeDefinitionIndex = 35219;
