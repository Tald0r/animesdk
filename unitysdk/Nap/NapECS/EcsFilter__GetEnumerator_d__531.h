...
#define NAP_NAPECS_ECSFILTER__GETENUMERATOR_D__531_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18D886A0)
#define NAP_NAPECS_ECSFILTER__GETENUMERATOR_D__531_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NAP_NAPECS_ECSENTITY__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18D887C0)
#define NAP_NAPECS_ECSFILTER__GETENUMERATOR_D__531_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18D88820)
#define NAP_NAPECS_ECSFILTER__GETENUMERATOR_D__531_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18D887D0)
#define NAP_NAPECS_ECSFILTER__GETENUMERATOR_D__531_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18D88690)
#define NAP_NAPECS_ECSFILTER__GETENUMERATOR_D__531__CTOR_OFFSET UNITYSDK_OFFSET(0x18D87FE0)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsFilter__GetEnumerator_d__531_TypeDefinitionIndex = 35172;
