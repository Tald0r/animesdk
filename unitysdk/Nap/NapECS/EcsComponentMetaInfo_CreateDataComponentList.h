...
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATEDATACOMPONENTLIST_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x188228D0)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATEDATACOMPONENTLIST_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18822900)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATEDATACOMPONENTLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x18822630)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATEDATACOMPONENTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18822620)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsComponentMetaInfo_CreateDataComponentList_TypeDefinitionIndex = 34121;
