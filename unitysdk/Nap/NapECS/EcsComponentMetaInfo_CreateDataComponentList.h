...
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATEDATACOMPONENTLIST_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D81C40)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATEDATACOMPONENTLIST_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D81C70)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATEDATACOMPONENTLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D819A0)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATEDATACOMPONENTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18D81980)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsComponentMetaInfo_CreateDataComponentList_TypeDefinitionIndex = 35119;
