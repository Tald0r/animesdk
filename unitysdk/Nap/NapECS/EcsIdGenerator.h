...
#define NAP_NAPECS_ECSIDGENERATOR_GENERATE_OFFSET UNITYSDK_OFFSET(0x18D80270)
#define NAP_NAPECS_ECSIDGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18D81370)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsIdGenerator_TypeDefinitionIndex = 35222;
