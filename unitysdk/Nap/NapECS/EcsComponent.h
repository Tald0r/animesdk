...
#define NAP_NAPECS_ECSCOMPONENT_ADDTOENTITY_OFFSET UNITYSDK_OFFSET(0x18821200)
#define NAP_NAPECS_ECSCOMPONENT_DESTROY_OFFSET UNITYSDK_OFFSET(0x18821050)
#define NAP_NAPECS_ECSCOMPONENT_DISPATCHREADYINTERNAL_OFFSET UNITYSDK_OFFSET(0x18820720)
#define NAP_NAPECS_ECSCOMPONENT_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x18821300)
#define NAP_NAPECS_ECSCOMPONENT_GETENTITY_OFFSET UNITYSDK_OFFSET(0x188209A0)
#define NAP_NAPECS_ECSCOMPONENT_GET_CLASSID_OFFSET UNITYSDK_OFFSET(0x18820360)
#define NAP_NAPECS_ECSCOMPONENT_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x18820340)
#define NAP_NAPECS_ECSCOMPONENT_GET_ID_OFFSET UNITYSDK_OFFSET(0x18820320)
#define NAP_NAPECS_ECSCOMPONENT_GET_ISASYNC_OFFSET UNITYSDK_OFFSET(0x18820400)
#define NAP_NAPECS_ECSCOMPONENT_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x188203F0)
#define NAP_NAPECS_ECSCOMPONENT_GET_SHOTCLASSID_OFFSET UNITYSDK_OFFSET(0x18820370)
#define NAP_NAPECS_ECSCOMPONENT_NEW_OFFSET UNITYSDK_OFFSET(0x18820D30)
#define NAP_NAPECS_ECSCOMPONENT_ONADD_OFFSET UNITYSDK_OFFSET(0x18821290)
#define NAP_NAPECS_ECSCOMPONENT_RESET_OFFSET UNITYSDK_OFFSET(0x18821110)
#define NAP_NAPECS_ECSCOMPONENT_SETISREADY_OFFSET UNITYSDK_OFFSET(0x188208A0)
#define NAP_NAPECS_ECSCOMPONENT_SETVALID_OFFSET UNITYSDK_OFFSET(0x18820410)
#define NAP_NAPECS_ECSCOMPONENT_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x18820350)
#define NAP_NAPECS_ECSCOMPONENT_SET_ID_OFFSET UNITYSDK_OFFSET(0x18820330)
#define NAP_NAPECS_ECSCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18820480)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsComponent_TypeDefinitionIndex = 34172;
	...
	public:
		...
		::System::Boolean _isAsync; // 0x2C
		::System::Boolean _isValid; // 0x2D
		...
		::System::Byte get_shotClassId()
		{
			return ((::System::Byte(*)(::PVOID))((::PBYTE)hIl2Cpp + NAP_NAPECS_ECSCOMPONENT_GET_SHOTCLASSID_OFFSET))(this);
		}
