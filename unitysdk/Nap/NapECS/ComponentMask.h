...
#define NAP_NAPECS_COMPONENTMASK_COMPARE_OFFSET UNITYSDK_OFFSET(0x18D74A60)
#define NAP_NAPECS_COMPONENTMASK_CREATELOMASK_OFFSET UNITYSDK_OFFSET(0x18D762D0)
#define NAP_NAPECS_COMPONENTMASK_EQUALS_OFFSET UNITYSDK_OFFSET(0x86CD60)
#define NAP_NAPECS_COMPONENTMASK_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x86CBA0)
#define NAP_NAPECS_COMPONENTMASK_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x86CE10)
#define NAP_NAPECS_COMPONENTMASK_GETTRUERANKNOCHECK_OFFSET UNITYSDK_OFFSET(0x86D040)
#define NAP_NAPECS_COMPONENTMASK_GETTRUERANK_OFFSET UNITYSDK_OFFSET(0x18D760E0)
#define NAP_NAPECS_COMPONENTMASK_GET_ALLFALSE_OFFSET UNITYSDK_OFFSET(0x86C9E0)
#define NAP_NAPECS_COMPONENTMASK_GET_ALLTRUE_OFFSET UNITYSDK_OFFSET(0x86CA60)
#define NAP_NAPECS_COMPONENTMASK_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x86CAE0)
#define NAP_NAPECS_COMPONENTMASK_HASALL_OFFSET UNITYSDK_OFFSET(0x86CD40)
#define NAP_NAPECS_COMPONENTMASK_HASANY_OFFSET UNITYSDK_OFFSET(0x86CD50)
#define NAP_NAPECS_COMPONENTMASK_NUMBITSET_OFFSET UNITYSDK_OFFSET(0x18D76270)
#define NAP_NAPECS_COMPONENTMASK_NUMBITTRUE_OFFSET UNITYSDK_OFFSET(0x86CED0)
#define NAP_NAPECS_COMPONENTMASK_OP_BITWISEAND_OFFSET UNITYSDK_OFFSET(0x18D74F70)
#define NAP_NAPECS_COMPONENTMASK_OP_BITWISEOR_OFFSET UNITYSDK_OFFSET(0x18D74EA0)
#define NAP_NAPECS_COMPONENTMASK_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18D75040)
#define NAP_NAPECS_COMPONENTMASK_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18D75100)
#define NAP_NAPECS_COMPONENTMASK_OP_ONESCOMPLEMENT_OFFSET UNITYSDK_OFFSET(0x18D74DF0)
#define NAP_NAPECS_COMPONENTMASK_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x86CB30)
#define NAP_NAPECS_COMPONENTMASK_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x86CC50)
#define NAP_NAPECS_COMPONENTMASK_TRUERANKOFINDEX_OFFSET UNITYSDK_OFFSET(0x86D030)
#define NAP_NAPECS_COMPONENTMASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x18D74930)
#define NAP_NAPECS_COMPONENTMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x3B6380)
#define NAP_NAPECS_COMPONENTMASK___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x86D070)

namespace Nap::NapECS
{
	inline static constexpr unsigned int ComponentMask_TypeDefinitionIndex = 35212;
	...
	struct alignas(8) ComponentMask
	{
		...
		{
			return (::System::Collections::Generic::IComparer_1<::Nap::NapECS::ComponentMask>**)Il2CppClass::FromTypeDefinitionIndex(ComponentMask_TypeDefinitionIndex)->GetStaticField(0x26200);
		}
		static ::Il2CppArray<::System::UInt64>** StaticGet_LookUpTable()
		{
			return (::Il2CppArray<::System::UInt64>**)Il2CppClass::FromTypeDefinitionIndex(ComponentMask_TypeDefinitionIndex)->GetStaticField(0x26208);
		}
		static ::Nap::NapECS::ComponentMask* StaticGet_Empty()
		{
			return (::Nap::NapECS::ComponentMask*)Il2CppClass::FromTypeDefinitionIndex(ComponentMask_TypeDefinitionIndex)->GetStaticField(0x83C0);
		}
