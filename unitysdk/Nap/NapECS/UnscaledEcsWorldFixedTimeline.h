...
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE_CREATE_OFFSET UNITYSDK_OFFSET(0x1883D530)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1883D720)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE_GET_FIXEDTICKCOUNTINFRAME_OFFSET UNITYSDK_OFFSET(0x1883EFE0)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE_GET_LASTFIXEDTICKCOUNTINFRAME_OFFSET UNITYSDK_OFFSET(0x1883EF80)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE_ONECSWORLDFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1883DFF0)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE_SET_TOTALFIXEDTICKCOUNTINFRAME_OFFSET UNITYSDK_OFFSET(0x1883F000)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1883F020)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1883F010)

namespace Nap::NapECS
{
	inline static constexpr unsigned int UnscaledEcsWorldFixedTimeline_TypeDefinitionIndex = 34153;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UnscaledEcsWorldFixedTimeline_TypeDefinitionIndex)->GetStaticField(0x80E0);
		}
