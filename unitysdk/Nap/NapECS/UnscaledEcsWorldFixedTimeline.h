...
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE_CREATE_OFFSET UNITYSDK_OFFSET(0x18D9C860)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18D9CA50)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE_GET_FIXEDTICKCOUNTINFRAME_OFFSET UNITYSDK_OFFSET(0x18D9E320)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE_GET_LASTFIXEDTICKCOUNTINFRAME_OFFSET UNITYSDK_OFFSET(0x18D9E2C0)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE_ONECSWORLDFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x18D9D320)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE_SET_TOTALFIXEDTICKCOUNTINFRAME_OFFSET UNITYSDK_OFFSET(0x18D9E340)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18D9E360)
#define NAP_NAPECS_UNSCALEDECSWORLDFIXEDTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18D9E350)

namespace Nap::NapECS
{
	inline static constexpr unsigned int UnscaledEcsWorldFixedTimeline_TypeDefinitionIndex = 35207;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UnscaledEcsWorldFixedTimeline_TypeDefinitionIndex)->GetStaticField(0x8440);
		}
