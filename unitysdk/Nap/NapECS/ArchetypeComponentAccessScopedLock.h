...
#define NAP_NAPECS_ARCHETYPECOMPONENTACCESSSCOPEDLOCK_CREATE_OFFSET UNITYSDK_OFFSET(0x188151E0)
#define NAP_NAPECS_ARCHETYPECOMPONENTACCESSSCOPEDLOCK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8419F0)

namespace Nap::NapECS
{
	inline static constexpr unsigned int ArchetypeComponentAccessScopedLock_TypeDefinitionIndex = 34137;
