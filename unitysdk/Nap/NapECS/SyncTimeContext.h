...
#define NAP_NAPECS_SYNCTIMECONTEXT_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x2D8620)
#define NAP_NAPECS_SYNCTIMECONTEXT_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x2CA610)
#define NAP_NAPECS_SYNCTIMECONTEXT_GET_UNSCALEDDELTATIME_OFFSET UNITYSDK_OFFSET(0x35DA00)
#define NAP_NAPECS_SYNCTIMECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x842A40)

namespace Nap::NapECS
{
	inline static constexpr unsigned int SyncTimeContext_TypeDefinitionIndex = 34151;
