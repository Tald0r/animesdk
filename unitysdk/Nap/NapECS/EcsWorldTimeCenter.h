...
#define NAP_NAPECS_ECSWORLDTIMECENTER_CREATE_OFFSET UNITYSDK_OFFSET(0x18D95B60)
#define NAP_NAPECS_ECSWORLDTIMECENTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18D97DB0)
#define NAP_NAPECS_ECSWORLDTIMECENTER_FIXEDSTEP_OFFSET UNITYSDK_OFFSET(0x18D977C0)
#define NAP_NAPECS_ECSWORLDTIMECENTER_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x18D9C730)
#define NAP_NAPECS_ECSWORLDTIMECENTER_GET_SCALEDFIXEDTIMELINE_OFFSET UNITYSDK_OFFSET(0x18D9C7B0)
#define NAP_NAPECS_ECSWORLDTIMECENTER_GET_SCALEDTIMELINE_OFFSET UNITYSDK_OFFSET(0x18D9C790)
#define NAP_NAPECS_ECSWORLDTIMECENTER_GET_UNSCALEDFIXEDTIMELINE_OFFSET UNITYSDK_OFFSET(0x18D9C770)
#define NAP_NAPECS_ECSWORLDTIMECENTER_GET_UNSCALEDTIMELINE_OFFSET UNITYSDK_OFFSET(0x18D9C750)
#define NAP_NAPECS_ECSWORLDTIMECENTER_INITFIXEDSTARTTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x18D9CD20)
#define NAP_NAPECS_ECSWORLDTIMECENTER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x18D97520)
#define NAP_NAPECS_ECSWORLDTIMECENTER_INITSTARTTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x18D9CC60)
#define NAP_NAPECS_ECSWORLDTIMECENTER_INNERSTEPPHASEVALIDCHECK_OFFSET UNITYSDK_OFFSET(0x18D9CFF0)
#define NAP_NAPECS_ECSWORLDTIMECENTER_ISTIMELINEINITIALIZED_OFFSET UNITYSDK_OFFSET(0x18D9CBA0)
#define NAP_NAPECS_ECSWORLDTIMECENTER_ONECSWORLDFIXEDUPDATESTARTINFRAME_OFFSET UNITYSDK_OFFSET(0x18D9D240)
#define NAP_NAPECS_ECSWORLDTIMECENTER_SET_PHASE_OFFSET UNITYSDK_OFFSET(0x18D9C740)
#define NAP_NAPECS_ECSWORLDTIMECENTER_SET_SCALEDFIXEDTIMELINE_OFFSET UNITYSDK_OFFSET(0x18D9C7C0)
#define NAP_NAPECS_ECSWORLDTIMECENTER_SET_SCALEDTIMELINE_OFFSET UNITYSDK_OFFSET(0x18D9C7A0)
#define NAP_NAPECS_ECSWORLDTIMECENTER_SET_UNSCALEDFIXEDTIMELINE_OFFSET UNITYSDK_OFFSET(0x18D9C780)
#define NAP_NAPECS_ECSWORLDTIMECENTER_SET_UNSCALEDTIMELINE_OFFSET UNITYSDK_OFFSET(0x18D9C760)
#define NAP_NAPECS_ECSWORLDTIMECENTER_START_OFFSET UNITYSDK_OFFSET(0x18D975C0)
#define NAP_NAPECS_ECSWORLDTIMECENTER_STEP_OFFSET UNITYSDK_OFFSET(0x18D97670)
#define NAP_NAPECS_ECSWORLDTIMECENTER_STOP_OFFSET UNITYSDK_OFFSET(0x18D97CF0)
#define NAP_NAPECS_ECSWORLDTIMECENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D9C7D0)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorldTimeCenter_TypeDefinitionIndex = 35121;

	class EcsWorldTimeCenter : public ::System::Object
	{
	public:
		::Nap::NapECS::UnscaledEcsWorldFixedTimeline* _UnscaledFixedTimeline_k__BackingField; // 0x10
