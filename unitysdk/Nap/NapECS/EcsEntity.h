...
#define NAP_NAPECS_ECSENTITY_ADDPRELOADCOMPONENT_OFFSET UNITYSDK_OFFSET(0x18825390)
#define NAP_NAPECS_ECSENTITY_ADDSTATEMASK_OFFSET UNITYSDK_OFFSET(0x18824A40)
#define NAP_NAPECS_ECSENTITY_CLEARPRELOADCOMPONENT_OFFSET UNITYSDK_OFFSET(0x18825830)
#define NAP_NAPECS_ECSENTITY_GETBIT_OFFSET UNITYSDK_OFFSET(0x18826380)
#define NAP_NAPECS_ECSENTITY_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x18825010)
#define NAP_NAPECS_ECSENTITY_GETSTRUCTCOMPWRITER_OFFSET UNITYSDK_OFFSET(0x18825310)
#define NAP_NAPECS_ECSENTITY_GET_ARCHETYPE_OFFSET UNITYSDK_OFFSET(0x18823EF0)
#define NAP_NAPECS_ECSENTITY_GET_COMPONENTLIST_OFFSET UNITYSDK_OFFSET(0x18823EE0)
#define NAP_NAPECS_ECSENTITY_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x18823020)
#define NAP_NAPECS_ECSENTITY_GET_ENTITYNAME_OFFSET UNITYSDK_OFFSET(0x18823080)
#define NAP_NAPECS_ECSENTITY_GET_ID_OFFSET UNITYSDK_OFFSET(0x18823030)
#define NAP_NAPECS_ECSENTITY_GET_ISDEBUGPAUSE_OFFSET UNITYSDK_OFFSET(0x18823B80)
#define NAP_NAPECS_ECSENTITY_GET_ISENTITYONPREREADY_OFFSET UNITYSDK_OFFSET(0x188230A0)
#define NAP_NAPECS_ECSENTITY_GET_ISENTITYONREADY_OFFSET UNITYSDK_OFFSET(0x1881EC10)
#define NAP_NAPECS_ECSENTITY_GET_ISENTITYSENDREADY_OFFSET UNITYSDK_OFFSET(0x188234C0)
#define NAP_NAPECS_ECSENTITY_GET_ISPAUSE_OFFSET UNITYSDK_OFFSET(0x18823680)
#define NAP_NAPECS_ECSENTITY_GET_ISPRELOAD_OFFSET UNITYSDK_OFFSET(0x18823B90)
#define NAP_NAPECS_ECSENTITY_GET_MASK_OFFSET UNITYSDK_OFFSET(0x188218A0)
#define NAP_NAPECS_ECSENTITY_GET_REFWORLD_OFFSET UNITYSDK_OFFSET(0x18823040)
#define NAP_NAPECS_ECSENTITY_GET__ISENTITYONPREREADY_OFFSET UNITYSDK_OFFSET(0x18823110)
#define NAP_NAPECS_ECSENTITY_GET__ISENTITYONREADY_OFFSET UNITYSDK_OFFSET(0x18823260)
#define NAP_NAPECS_ECSENTITY_GET__ISENTITYSENDREADY_OFFSET UNITYSDK_OFFSET(0x18823530)
#define NAP_NAPECS_ECSENTITY_GET__ISPAUSE_OFFSET UNITYSDK_OFFSET(0x18823750)
#define NAP_NAPECS_ECSENTITY_GET__ISPRELOAD_OFFSET UNITYSDK_OFFSET(0x18823C00)
#define NAP_NAPECS_ECSENTITY_GET__ISSTATEDIRTY_OFFSET UNITYSDK_OFFSET(0x18824690)
#define NAP_NAPECS_ECSENTITY_GET__ISVALID_OFFSET UNITYSDK_OFFSET(0x18824700)
#define NAP_NAPECS_ECSENTITY_GET__REFWORLD_OFFSET UNITYSDK_OFFSET(0x18823060)
#define NAP_NAPECS_ECSENTITY_HASCOMPONENT_OFFSET UNITYSDK_OFFSET(0x18825960)
#define NAP_NAPECS_ECSENTITY_INIT_OFFSET UNITYSDK_OFFSET(0x18823F00)
#define NAP_NAPECS_ECSENTITY_ISINSTATEMASK_OFFSET UNITYSDK_OFFSET(0x18824770)
#define NAP_NAPECS_ECSENTITY_ISREMOVING_OFFSET UNITYSDK_OFFSET(0x188248B0)
#define NAP_NAPECS_ECSENTITY_ISRUNNABLE_OFFSET UNITYSDK_OFFSET(0x1881EC80)
#define NAP_NAPECS_ECSENTITY_ISTOBEREMOVED_OFFSET UNITYSDK_OFFSET(0x18824980)
#define NAP_NAPECS_ECSENTITY_ISVALID_OFFSET UNITYSDK_OFFSET(0x18824330)
#define NAP_NAPECS_ECSENTITY_MARKARCHETYPESINGLEDATAWRITE_OFFSET UNITYSDK_OFFSET(0x18822EC0)
#define NAP_NAPECS_ECSENTITY_ONADDCOMPONENT_OFFSET UNITYSDK_OFFSET(0x18825EE0)
#define NAP_NAPECS_ECSENTITY_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x18826320)
#define NAP_NAPECS_ECSENTITY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18826100)
#define NAP_NAPECS_ECSENTITY_ONREMOVECOMPONENT_OFFSET UNITYSDK_OFFSET(0x18825F70)
#define NAP_NAPECS_ECSENTITY_ONUPDATEARCHETYPE_OFFSET UNITYSDK_OFFSET(0x18825AC0)
#define NAP_NAPECS_ECSENTITY_REMOVESTATEMASK_OFFSET UNITYSDK_OFFSET(0x18824BF0)
#define NAP_NAPECS_ECSENTITY_RESET_OFFSET UNITYSDK_OFFSET(0x18824EA0)
#define NAP_NAPECS_ECSENTITY_SETBIT_OFFSET UNITYSDK_OFFSET(0x188263F0)
#define NAP_NAPECS_ECSENTITY_SET_ENTITYNAME_OFFSET UNITYSDK_OFFSET(0x18823090)
#define NAP_NAPECS_ECSENTITY_SET_ISENTITYONPREREADY_OFFSET UNITYSDK_OFFSET(0x18823180)
#define NAP_NAPECS_ECSENTITY_SET_ISENTITYONREADY_OFFSET UNITYSDK_OFFSET(0x188232D0)
#define NAP_NAPECS_ECSENTITY_SET_ISENTITYSENDREADY_OFFSET UNITYSDK_OFFSET(0x188235A0)
#define NAP_NAPECS_ECSENTITY_SET_ISPAUSE_OFFSET UNITYSDK_OFFSET(0x188237C0)
#define NAP_NAPECS_ECSENTITY_SET_ISPRELOAD_OFFSET UNITYSDK_OFFSET(0x18823C70)
#define NAP_NAPECS_ECSENTITY_SET__ISENTITYONPREREADY_OFFSET UNITYSDK_OFFSET(0x18823190)
#define NAP_NAPECS_ECSENTITY_SET__ISENTITYONREADY_OFFSET UNITYSDK_OFFSET(0x188233F0)
#define NAP_NAPECS_ECSENTITY_SET__ISENTITYSENDREADY_OFFSET UNITYSDK_OFFSET(0x188235B0)
#define NAP_NAPECS_ECSENTITY_SET__ISPAUSE_OFFSET UNITYSDK_OFFSET(0x18823AB0)
#define NAP_NAPECS_ECSENTITY_SET__ISPRELOAD_OFFSET UNITYSDK_OFFSET(0x18823E10)
#define NAP_NAPECS_ECSENTITY_SET__ISSTATEDIRTY_OFFSET UNITYSDK_OFFSET(0x18824260)
#define NAP_NAPECS_ECSENTITY_SET__ISVALID_OFFSET UNITYSDK_OFFSET(0x188247E0)
#define NAP_NAPECS_ECSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18826480)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsEntity_TypeDefinitionIndex = 34148;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(EcsEntity_TypeDefinitionIndex)->GetStaticField(0xC510);
		}
		::System::String* _entityName; // 0x10
		...
		::System::Byte _entityFlags; // 0x34
		::System::Boolean _isDebugPause; // 0x35
		::System::Boolean editorFoldout; // 0x36
