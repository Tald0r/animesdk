...
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ADDCOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x18D9BEB0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_APPLYDELTA_OFFSET UNITYSDK_OFFSET(0x18D9BA90)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_GETCOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x18D9A2A0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_GETVERSION_OFFSET UNITYSDK_OFFSET(0x18D9B0D0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_HANDLEDIRTYENTITIES_OFFSET UNITYSDK_OFFSET(0x18D967F0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_HANDLEENTITYADD_OFFSET UNITYSDK_OFFSET(0x18D9B830)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_HANDLEENTITYREMOVE_OFFSET UNITYSDK_OFFSET(0x18D9B960)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ONENTITYADDED_OFFSET UNITYSDK_OFFSET(0x18D9A4D0)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ONENTITYCHANGED_OFFSET UNITYSDK_OFFSET(0x18D9A610)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ONENTITYDESTROY_OFFSET UNITYSDK_OFFSET(0x18D9B140)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_ONENTITYLAYOUTCHANGED_OFFSET UNITYSDK_OFFSET(0x18D9B340)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_REMOVECOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x18D9C030)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_SETMERGE_OFFSET UNITYSDK_OFFSET(0x18D9AD10)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP_SETREMOVE_OFFSET UNITYSDK_OFFSET(0x18D9AA10)
#define NAP_NAPECS_ECSWORLD_ENTITYCOMPONENTMASKMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x18D95940)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorld_EntityComponentMaskMap_TypeDefinitionIndex = 35193;

	class EcsWorld_EntityComponentMaskMap : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::Nap::NapECS::ComponentMask, ::System::Int32>* _deltaBuffer; // 0x10
		...
		::System::Collections::Generic::List_1<::Nap::NapECS::ComponentMask>* _removeBuffer; // 0x28
