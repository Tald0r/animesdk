...
#define NAP_NAPECS_UNSCALEDECSWORLDTIMELINE_CREATE_OFFSET UNITYSDK_OFFSET(0x1883D4B0)
#define NAP_NAPECS_UNSCALEDECSWORLDTIMELINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1883D6B0)
#define NAP_NAPECS_UNSCALEDECSWORLDTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1883F060)

namespace Nap::NapECS
{
	inline static constexpr unsigned int UnscaledEcsWorldTimeline_TypeDefinitionIndex = 34229;
