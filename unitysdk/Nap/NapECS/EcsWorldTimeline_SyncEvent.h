...
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D9DB70)
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D9DC00)
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D9D650)
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D9DB50)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorldTimeline_SyncEvent_TypeDefinitionIndex = 35134;
