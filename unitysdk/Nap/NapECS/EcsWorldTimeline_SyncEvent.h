...
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1883E820)
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1883E8B0)
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1883E320)
#define NAP_NAPECS_ECSWORLDTIMELINE_SYNCEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1883E810)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorldTimeline_SyncEvent_TypeDefinitionIndex = 34124;
