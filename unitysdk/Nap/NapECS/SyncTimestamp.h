...
#define NAP_NAPECS_SYNCTIMESTAMP_GET_SCALEDTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x3EB2F0)
#define NAP_NAPECS_SYNCTIMESTAMP_GET_UNSCALEDTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x322CC0)
#define NAP_NAPECS_SYNCTIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x86D820)

namespace Nap::NapECS
{
	inline static constexpr unsigned int SyncTimestamp_TypeDefinitionIndex = 35128;
