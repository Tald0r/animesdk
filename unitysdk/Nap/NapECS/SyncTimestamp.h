...
#define NAP_NAPECS_SYNCTIMESTAMP_GET_SCALEDTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x39B980)
#define NAP_NAPECS_SYNCTIMESTAMP_GET_UNSCALEDTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x2D8730)
#define NAP_NAPECS_SYNCTIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x842A70)

namespace Nap::NapECS
{
	inline static constexpr unsigned int SyncTimestamp_TypeDefinitionIndex = 34216;
