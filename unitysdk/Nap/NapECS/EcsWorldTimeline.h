...
#define NAP_NAPECS_ECSWORLDTIMELINE_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x1883E170)
#define NAP_NAPECS_ECSWORLDTIMELINE_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1883E0F0)
#define NAP_NAPECS_ECSWORLDTIMELINE_GET_LASTTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1883E150)
#define NAP_NAPECS_ECSWORLDTIMELINE_GET_STARTTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1883E110)
#define NAP_NAPECS_ECSWORLDTIMELINE_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1883E130)
#define NAP_NAPECS_ECSWORLDTIMELINE_HALT_OFFSET UNITYSDK_OFFSET(0x1883DC10)
#define NAP_NAPECS_ECSWORLDTIMELINE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1883DAB0)
#define NAP_NAPECS_ECSWORLDTIMELINE_INNERRESETEVENT_OFFSET UNITYSDK_OFFSET(0x1883E730)
#define NAP_NAPECS_ECSWORLDTIMELINE_ONHALT_OFFSET UNITYSDK_OFFSET(0x1883E7A0)
#define NAP_NAPECS_ECSWORLDTIMELINE_ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1883E190)
#define NAP_NAPECS_ECSWORLDTIMELINE_RESET_OFFSET UNITYSDK_OFFSET(0x1883E260)
#define NAP_NAPECS_ECSWORLDTIMELINE_SEEK_OFFSET UNITYSDK_OFFSET(0x1883DD40)
#define NAP_NAPECS_ECSWORLDTIMELINE_SET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x1883E180)
#define NAP_NAPECS_ECSWORLDTIMELINE_SET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1883E100)
#define NAP_NAPECS_ECSWORLDTIMELINE_SET_LASTTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1883E160)
#define NAP_NAPECS_ECSWORLDTIMELINE_SET_STARTTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1883E120)
#define NAP_NAPECS_ECSWORLDTIMELINE_SET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1883E140)
#define NAP_NAPECS_ECSWORLDTIMELINE_VALIDATEDELTATIME_OFFSET UNITYSDK_OFFSET(0x1883E6A0)
#define NAP_NAPECS_ECSWORLDTIMELINE_VALIDATETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1883E1F0)
#define NAP_NAPECS_ECSWORLDTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1883E800)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorldTimeline_TypeDefinitionIndex = 34123;

	class EcsWorldTimeline : public ::System::Object
	{
	public:
		::Nap::NapECS::EcsWorldTimeline_SyncEvent* OnHaltTime; // 0x10
		::Nap::NapECS::EcsWorldTimeline_SyncEvent* OnSyncTime; // 0x18
