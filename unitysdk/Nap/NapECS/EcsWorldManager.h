...
#define NAP_NAPECS_ECSWORLDMANAGER_CREATEWORLD_OFFSET UNITYSDK_OFFSET(0x1883D250)
#define NAP_NAPECS_ECSWORLDMANAGER_DESTROYWORLD_OFFSET UNITYSDK_OFFSET(0x1883D2C0)
#define NAP_NAPECS_ECSWORLDMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1883D180)
#define NAP_NAPECS_ECSWORLDMANAGER_NAP_NAPECS_ICREATABLE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1883D0B0)
#define NAP_NAPECS_ECSWORLDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1883D3E0)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorldManager_TypeDefinitionIndex = 34118;
