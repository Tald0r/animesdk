...
#define NAP_NAPECS_ECSFILTER_ADDARCHETYPE_OFFSET UNITYSDK_OFFSET(0x18826E70)
#define NAP_NAPECS_ECSFILTER_ADDEXCLUDETYPE_OFFSET UNITYSDK_OFFSET(0x188288D0)
#define NAP_NAPECS_ECSFILTER_ADDINCLUDETYPE_OFFSET UNITYSDK_OFFSET(0x18828690)
#define NAP_NAPECS_ECSFILTER_ADDWAITTYPE_OFFSET UNITYSDK_OFFSET(0x18828BA0)
#define NAP_NAPECS_ECSFILTER_CHECKANDMARKASYNCCOMP_OFFSET UNITYSDK_OFFSET(0x18828F60)
#define NAP_NAPECS_ECSFILTER_CHECKENTITYFOREACHCONSISTENCY_OFFSET UNITYSDK_OFFSET(0x18826EF0)
#define NAP_NAPECS_ECSFILTER_CONTAINS_OFFSET UNITYSDK_OFFSET(0x188283C0)
#define NAP_NAPECS_ECSFILTER_EXCLUDE_OFFSET UNITYSDK_OFFSET(0x18828850)
#define NAP_NAPECS_ECSFILTER_GETENTITY_OFFSET UNITYSDK_OFFSET(0x18828480)
#define NAP_NAPECS_ECSFILTER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x188274C0)
#define NAP_NAPECS_ECSFILTER_GET_ARCHETYPELIST_OFFSET UNITYSDK_OFFSET(0x18826E40)
#define NAP_NAPECS_ECSFILTER_GET_ENTITYCOUNT_OFFSET UNITYSDK_OFFSET(0x18826870)
#define NAP_NAPECS_ECSFILTER_GET_ENTITYLIST_OFFSET UNITYSDK_OFFSET(0x18826E50)
#define NAP_NAPECS_ECSFILTER_GET_EXCLUDETYPELIST_OFFSET UNITYSDK_OFFSET(0x18826E20)
#define NAP_NAPECS_ECSFILTER_GET_HASSYSTEMDEPEND_OFFSET UNITYSDK_OFFSET(0x188268D0)
#define NAP_NAPECS_ECSFILTER_GET_INCLUDETYPELIST_OFFSET UNITYSDK_OFFSET(0x18826E10)
#define NAP_NAPECS_ECSFILTER_GET_ONENTITYPAUSEACTION_OFFSET UNITYSDK_OFFSET(0x1881D610)
#define NAP_NAPECS_ECSFILTER_GET_ONENTITYREADYACTION_OFFSET UNITYSDK_OFFSET(0x1881D520)
#define NAP_NAPECS_ECSFILTER_GET_ONENTITYREADYPOSTACTION_OFFSET UNITYSDK_OFFSET(0x1881D590)
#define NAP_NAPECS_ECSFILTER_GET_ONENTITYREADYPREACTION_OFFSET UNITYSDK_OFFSET(0x1881D4B0)
#define NAP_NAPECS_ECSFILTER_GET_ONENTITYRESUMEACTION_OFFSET UNITYSDK_OFFSET(0x1881D680)
#define NAP_NAPECS_ECSFILTER_GET_ONREMOVEENTITYACTION_OFFSET UNITYSDK_OFFSET(0x18826A30)
#define NAP_NAPECS_ECSFILTER_GET_READYENTITYSET_OFFSET UNITYSDK_OFFSET(0x18826E60)
#define NAP_NAPECS_ECSFILTER_GET_RUNNABLEENTITYCOUNT_OFFSET UNITYSDK_OFFSET(0x18826890)
#define NAP_NAPECS_ECSFILTER_GET_RUNNABLEINCLUDEPAUSEDENTITYCOUNT_OFFSET UNITYSDK_OFFSET(0x188268B0)
#define NAP_NAPECS_ECSFILTER_GET_WAITREADYTYPELIST_OFFSET UNITYSDK_OFFSET(0x18826E30)
#define NAP_NAPECS_ECSFILTER_HASRUNNABLEENTITY_OFFSET UNITYSDK_OFFSET(0x188292B0)
#define NAP_NAPECS_ECSFILTER_INCLUDE_OFFSET UNITYSDK_OFFSET(0x18828610)
#define NAP_NAPECS_ECSFILTER_INITEMPTYCOMPONENTDICT_OFFSET UNITYSDK_OFFSET(0x18828D70)
#define NAP_NAPECS_ECSFILTER_ISCOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x188282C0)
#define NAP_NAPECS_ECSFILTER_ISENTITYPAUSED_OFFSET UNITYSDK_OFFSET(0x18824DB0)
#define NAP_NAPECS_ECSFILTER_REMOVEENTITYFROMFILTER_OFFSET UNITYSDK_OFFSET(0x18827560)
#define NAP_NAPECS_ECSFILTER_REMOVEFROMASYNCDICT_OFFSET UNITYSDK_OFFSET(0x18827A50)
#define NAP_NAPECS_ECSFILTER_SET_ENTITYCOUNT_OFFSET UNITYSDK_OFFSET(0x18826880)
#define NAP_NAPECS_ECSFILTER_SET_HASSYSTEMDEPEND_OFFSET UNITYSDK_OFFSET(0x188268E0)
#define NAP_NAPECS_ECSFILTER_SET_ONADDENTITYACTION_OFFSET UNITYSDK_OFFSET(0x188268F0)
#define NAP_NAPECS_ECSFILTER_SET_ONENTITYPAUSEACTION_OFFSET UNITYSDK_OFFSET(0x18826CF0)
#define NAP_NAPECS_ECSFILTER_SET_ONENTITYREADYACTION_OFFSET UNITYSDK_OFFSET(0x18826BD0)
#define NAP_NAPECS_ECSFILTER_SET_ONENTITYREADYPOSTACTION_OFFSET UNITYSDK_OFFSET(0x18826C60)
#define NAP_NAPECS_ECSFILTER_SET_ONENTITYREADYPREACTION_OFFSET UNITYSDK_OFFSET(0x18826B40)
#define NAP_NAPECS_ECSFILTER_SET_ONENTITYRESUMEACTION_OFFSET UNITYSDK_OFFSET(0x18826D80)
#define NAP_NAPECS_ECSFILTER_SET_ONPOSTADDENTITYACTION_OFFSET UNITYSDK_OFFSET(0x18826990)
#define NAP_NAPECS_ECSFILTER_SET_ONREMOVEENTITYACTION_OFFSET UNITYSDK_OFFSET(0x18826AA0)
#define NAP_NAPECS_ECSFILTER_SET_RUNNABLEENTITYCOUNT_OFFSET UNITYSDK_OFFSET(0x188268A0)
#define NAP_NAPECS_ECSFILTER_SET_RUNNABLEINCLUDEPAUSEDENTITYCOUNT_OFFSET UNITYSDK_OFFSET(0x188268C0)
#define NAP_NAPECS_ECSFILTER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18828C90)
#define NAP_NAPECS_ECSFILTER_WAITREADY_OFFSET UNITYSDK_OFFSET(0x18828B20)
#define NAP_NAPECS_ECSFILTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18828170)
#define NAP_NAPECS_ECSFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18827C60)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsFilter_TypeDefinitionIndex = 34126;

	class EcsFilter : public ::System::Object
	{
	public:
		::Nap::NapECS::EcsCallbackAction_1<::System::Action_1<::System::UInt32>*>* OnEntityResumeActionItem; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::Nap::NapECS::EcsComponent*>*>* componentDictForEach; // 0x18
		::Nap::NapECS::EcsCallbackAction_1<::System::Action_1<::System::UInt32>*>* OnEntityReadyPreActionItem; // 0x20
		::Nap::NapECS::EcsCallbackAction_1<::System::Action_1<::Nap::NapECS::EcsEntity*>*>* OnRemoveEntityActionItem; // 0x28
		::System::Type* _CurWorldRefType_k__BackingField; // 0x30
		::Nap::NapECS::EcsCallbackAction_1<::System::Action_1<::System::UInt32>*>* OnEntityPauseActionItem; // 0x38
		::Nap::NapECS::DictionaryList_2<::System::UInt32, ::Nap::NapECS::EcsEntity*>* entityList; // 0x40
		::Nap::NapECS::EcsCallbackAction_1<::System::Action_1<::System::UInt32>*>* OnEntityReadyActionItem; // 0x48
		::System::Collections::Generic::List_1<::Nap::NapECS::EcsArchetype*>* archetypeList; // 0x50
		::System::Collections::Generic::List_1<::System::Int32>* excludeTypeList; // 0x58
		::Nap::NapECS::EcsCallbackAction_1<::System::Action_1<::Nap::NapECS::EcsEntity*>*>* OnPostAddEntityActionItem; // 0x60
		::System::String* DebugName; // 0x68
		::System::String* Name; // 0x70
		::System::Collections::Generic::List_1<::Nap::NapECS::EcsEntity*>* entityListForEach; // 0x78
		::System::Collections::Generic::HashSet_1<::System::UInt32>* readyEntitySet; // 0x80
		::Nap::NapECS::EcsWorld* worldRef; // 0x88
		::Nap::NapECS::EcsCallbackAction_1<::System::Action_1<::System::UInt32>*>* OnEntityReadyPostActionItem; // 0x90
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::Nap::NapECS::EcsComponent*>*>* componentDict; // 0x98
		::System::Collections::Generic::List_1<::System::Int32>* waitTypeList; // 0xA0
		::Nap::NapECS::EcsSystem* System; // 0xA8
		::System::Collections::Generic::List_1<::Nap::NapECS::EcsComponent*>* tmpComponentList; // 0xB0
		::System::Collections::Generic::List_1<::System::Int32>* includeTypeList; // 0xB8
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::HashSet_1<::Nap::NapECS::EcsComponent*>*>* asyncComponentSet; // 0xC0
		::Nap::NapECS::EcsCallbackAction_1<::System::Action_1<::Nap::NapECS::EcsEntity*>*>* OnAddEntityActionItem; // 0xC8
		::System::Int32 IsVisitingFrame; // 0xD0
		::Nap::NapECS::EcsCompFilter compFilter; // 0xD8
		::System::Int32 WaitReadyCompClassId; // 0x120
		::System::Int32 FilterIndex; // 0x124
		::System::Boolean _HasSystemDepend_k__BackingField; // 0x128
		::System::Boolean isDirty; // 0x129
		::System::Boolean isEverVisited; // 0x12A
		::System::Boolean enableForEachAccelerate; // 0x12B
		::System::Int32 _RunnableEntityCount_k__BackingField; // 0x12C
		::System::Int32 _RunnableIncludePausedEntityCount_k__BackingField; // 0x130
		::System::Int32 _EntityCount_k__BackingField; // 0x134
