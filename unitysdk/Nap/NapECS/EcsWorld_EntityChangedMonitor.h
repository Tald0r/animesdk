...
#define NAP_NAPECS_ECSWORLD_ENTITYCHANGEDMONITOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x842830)
#define NAP_NAPECS_ECSWORLD_ENTITYCHANGEDMONITOR__CTOR_OFFSET UNITYSDK_OFFSET(0x8427B0)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorld_EntityChangedMonitor_TypeDefinitionIndex = 34156;
