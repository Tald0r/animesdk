...
#define NAP_NAPECS_SCALEDECSWORLDTIMELINE_CREATE_OFFSET UNITYSDK_OFFSET(0x18D9C8E0)
#define NAP_NAPECS_SCALEDECSWORLDTIMELINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18D9CAC0)
#define NAP_NAPECS_SCALEDECSWORLDTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18D9DDD0)

namespace Nap::NapECS
{
	inline static constexpr unsigned int ScaledEcsWorldTimeline_TypeDefinitionIndex = 35215;
