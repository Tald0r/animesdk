...
#define NAP_NAPECS_SCALEDECSWORLDTIMELINE_CREATE_OFFSET UNITYSDK_OFFSET(0x1883D5B0)
#define NAP_NAPECS_SCALEDECSWORLDTIMELINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1883D790)
#define NAP_NAPECS_SCALEDECSWORLDTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1883EA80)

namespace Nap::NapECS
{
	inline static constexpr unsigned int ScaledEcsWorldTimeline_TypeDefinitionIndex = 34227;
