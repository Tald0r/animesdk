...
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATECOMPONENTLIST_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x188225E0)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATECOMPONENTLIST_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18822610)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATECOMPONENTLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x18822340)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATECOMPONENTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18822330)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsComponentMetaInfo_CreateComponentList_TypeDefinitionIndex = 34120;
