...
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATECOMPONENTLIST_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D81940)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATECOMPONENTLIST_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D81970)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATECOMPONENTLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D816A0)
#define NAP_NAPECS_ECSCOMPONENTMETAINFO_CREATECOMPONENTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18D81680)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsComponentMetaInfo_CreateComponentList_TypeDefinitionIndex = 35118;
