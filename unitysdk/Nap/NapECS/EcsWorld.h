...
#define NAP_NAPECS_ECSWORLD_ADDCOMPONENTSTOENTITY_1_OFFSET UNITYSDK_OFFSET(0x18D981B0)
#define NAP_NAPECS_ECSWORLD_ADDCOMPONENTSTOENTITY_OFFSET UNITYSDK_OFFSET(0x18D98010)
#define NAP_NAPECS_ECSWORLD_ADDCOMPONENTTOENTITY_OFFSET UNITYSDK_OFFSET(0x18D98F80)
#define NAP_NAPECS_ECSWORLD_ADDFILTER_OFFSET UNITYSDK_OFFSET(0x18D87460)
#define NAP_NAPECS_ECSWORLD_ADDSYSTEM_OFFSET UNITYSDK_OFFSET(0x18D960E0)
#define NAP_NAPECS_ECSWORLD_AFTERANIMATORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x18D97910)
#define NAP_NAPECS_ECSWORLD_CREATESYSTEMS_OFFSET UNITYSDK_OFFSET(0x18D95EA0)
#define NAP_NAPECS_ECSWORLD_DESTROYENTITY_OFFSET UNITYSDK_OFFSET(0x18D99A20)
#define NAP_NAPECS_ECSWORLD_DIAGNOSECHECKFILTERCONSISTENCY_OFFSET UNITYSDK_OFFSET(0x18D99700)
#define NAP_NAPECS_ECSWORLD_ENDOFFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x18D979F0)
#define NAP_NAPECS_ECSWORLD_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x18D97380)
#define NAP_NAPECS_ECSWORLD_GETARCHETYPEVERSION_OFFSET UNITYSDK_OFFSET(0x18D9A200)
#define NAP_NAPECS_ECSWORLD_GETCOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x18D9A280)
#define NAP_NAPECS_ECSWORLD_GET_TIMECENTER_OFFSET UNITYSDK_OFFSET(0x18D95630)
#define NAP_NAPECS_ECSWORLD_INNERFIXEDSTEPTIMECENTER_OFFSET UNITYSDK_OFFSET(0x18D97410)
#define NAP_NAPECS_ECSWORLD_INNERSTEPTIMECENTER_OFFSET UNITYSDK_OFFSET(0x18D965D0)
#define NAP_NAPECS_ECSWORLD_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18D966C0)
#define NAP_NAPECS_ECSWORLD_LINKFILTERARCHETYPE_OFFSET UNITYSDK_OFFSET(0x18D7EB10)
#define NAP_NAPECS_ECSWORLD_MODIFYENTITYCOMPONENTSINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x18D98410)
#define NAP_NAPECS_ECSWORLD_MODIFYENTITYCOMPONENTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x18D980F0)
#define NAP_NAPECS_ECSWORLD_ONADDCOMPONENT_OFFSET UNITYSDK_OFFSET(0x18D99930)
#define NAP_NAPECS_ECSWORLD_ONANIMIKPOSTUPDATE_OFFSET UNITYSDK_OFFSET(0x18D97A60)
#define NAP_NAPECS_ECSWORLD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18D97BB0)
#define NAP_NAPECS_ECSWORLD_ONPOSTPARTICLESYSTEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18D97B40)
#define NAP_NAPECS_ECSWORLD_ONPOSTSIMULATIONUPDATE_OFFSET UNITYSDK_OFFSET(0x18D97AD0)
#define NAP_NAPECS_ECSWORLD_POSTLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18D96750)
#define NAP_NAPECS_ECSWORLD_REMOVECOMPONENTFROMENTITY_OFFSET UNITYSDK_OFFSET(0x18D99400)
#define NAP_NAPECS_ECSWORLD_REMOVECOMPONENTSFROMENTITY_OFFSET UNITYSDK_OFFSET(0x18D99100)
#define NAP_NAPECS_ECSWORLD_SET_TIMECENTER_OFFSET UNITYSDK_OFFSET(0x18D95640)
#define NAP_NAPECS_ECSWORLD_STARTTIMECENTER_OFFSET UNITYSDK_OFFSET(0x18D962A0)
#define NAP_NAPECS_ECSWORLD_START_OFFSET UNITYSDK_OFFSET(0x18D96170)
#define NAP_NAPECS_ECSWORLD_UPDATE_OFFSET UNITYSDK_OFFSET(0x18D96540)
#define NAP_NAPECS_ECSWORLD_WAITFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x18D97980)
#define NAP_NAPECS_ECSWORLD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18D95660)
#define NAP_NAPECS_ECSWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x18D95650)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorld_TypeDefinitionIndex = 35190;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EcsWorld_TypeDefinitionIndex)->GetStaticField(0x83F0);
		}
		static ::System::Boolean* StaticGet_EnableDiagnose()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EcsWorld_TypeDefinitionIndex)->GetStaticField(0x83F1);
		}
		::Nap::NapECS::EcsFilterGroup* filterGroup; // 0x10
		::Nap::NapECS::EcsComponentGroup* componentGroup; // 0x18
		::Nap::NapECS::EcsEntityGroup* entityGroup; // 0x20
		::Nap::NapECS::EcsSystemGroup* systemGroup; // 0x28
		::Nap::NapECS::EcsWorldTimeCenter* _TimeCenter_k__BackingField; // 0x30
