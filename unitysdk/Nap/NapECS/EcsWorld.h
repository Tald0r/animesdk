...
#define NAP_NAPECS_ECSWORLD_ADDCOMPONENTSTOENTITY_1_OFFSET UNITYSDK_OFFSET(0x18838E70)
#define NAP_NAPECS_ECSWORLD_ADDCOMPONENTSTOENTITY_OFFSET UNITYSDK_OFFSET(0x18838CC0)
#define NAP_NAPECS_ECSWORLD_ADDCOMPONENTTOENTITY_OFFSET UNITYSDK_OFFSET(0x18839C40)
#define NAP_NAPECS_ECSWORLD_ADDFILTER_OFFSET UNITYSDK_OFFSET(0x188280F0)
#define NAP_NAPECS_ECSWORLD_ADDSYSTEM_OFFSET UNITYSDK_OFFSET(0x18836DA0)
#define NAP_NAPECS_ECSWORLD_AFTERANIMATORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x188385D0)
#define NAP_NAPECS_ECSWORLD_CREATESYSTEMS_OFFSET UNITYSDK_OFFSET(0x18836B60)
#define NAP_NAPECS_ECSWORLD_DESTROYENTITY_OFFSET UNITYSDK_OFFSET(0x1883A6E0)
#define NAP_NAPECS_ECSWORLD_DIAGNOSECHECKFILTERCONSISTENCY_OFFSET UNITYSDK_OFFSET(0x1883A3C0)
#define NAP_NAPECS_ECSWORLD_ENDOFFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x188386B0)
#define NAP_NAPECS_ECSWORLD_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x18838040)
#define NAP_NAPECS_ECSWORLD_GETARCHETYPEVERSION_OFFSET UNITYSDK_OFFSET(0x1883AEC0)
#define NAP_NAPECS_ECSWORLD_GETCOMPONENTMASK_OFFSET UNITYSDK_OFFSET(0x1883AF40)
#define NAP_NAPECS_ECSWORLD_GET_TIMECENTER_OFFSET UNITYSDK_OFFSET(0x188362E0)
#define NAP_NAPECS_ECSWORLD_INNERFIXEDSTEPTIMECENTER_OFFSET UNITYSDK_OFFSET(0x188380D0)
#define NAP_NAPECS_ECSWORLD_INNERSTEPTIMECENTER_OFFSET UNITYSDK_OFFSET(0x18837290)
#define NAP_NAPECS_ECSWORLD_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18837380)
#define NAP_NAPECS_ECSWORLD_LINKFILTERARCHETYPE_OFFSET UNITYSDK_OFFSET(0x1881F7B0)
#define NAP_NAPECS_ECSWORLD_MODIFYENTITYCOMPONENTSINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x188390D0)
#define NAP_NAPECS_ECSWORLD_MODIFYENTITYCOMPONENTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x18838DA0)
#define NAP_NAPECS_ECSWORLD_ONADDCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1883A5F0)
#define NAP_NAPECS_ECSWORLD_ONANIMIKPOSTUPDATE_OFFSET UNITYSDK_OFFSET(0x18838720)
#define NAP_NAPECS_ECSWORLD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18838870)
#define NAP_NAPECS_ECSWORLD_ONPOSTPARTICLESYSTEMUPDATE_OFFSET UNITYSDK_OFFSET(0x18838800)
#define NAP_NAPECS_ECSWORLD_ONPOSTSIMULATIONUPDATE_OFFSET UNITYSDK_OFFSET(0x18838790)
#define NAP_NAPECS_ECSWORLD_POSTLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18837410)
#define NAP_NAPECS_ECSWORLD_REMOVECOMPONENTFROMENTITY_OFFSET UNITYSDK_OFFSET(0x1883A0C0)
#define NAP_NAPECS_ECSWORLD_REMOVECOMPONENTSFROMENTITY_OFFSET UNITYSDK_OFFSET(0x18839DC0)
#define NAP_NAPECS_ECSWORLD_SET_TIMECENTER_OFFSET UNITYSDK_OFFSET(0x188362F0)
#define NAP_NAPECS_ECSWORLD_STARTTIMECENTER_OFFSET UNITYSDK_OFFSET(0x18836F60)
#define NAP_NAPECS_ECSWORLD_START_OFFSET UNITYSDK_OFFSET(0x18836E30)
#define NAP_NAPECS_ECSWORLD_UPDATE_OFFSET UNITYSDK_OFFSET(0x18837200)
#define NAP_NAPECS_ECSWORLD_WAITFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x18838640)
#define NAP_NAPECS_ECSWORLD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18836310)
#define NAP_NAPECS_ECSWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x18836300)

namespace Nap::NapECS
{
	inline static constexpr unsigned int EcsWorld_TypeDefinitionIndex = 34154;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EcsWorld_TypeDefinitionIndex)->GetStaticField(0x8090);
		}
		static ::System::Boolean* StaticGet_EnableDiagnose()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(EcsWorld_TypeDefinitionIndex)->GetStaticField(0x8091);
		}
		::Nap::NapECS::EcsFilterGroup* filterGroup; // 0x10
		::Nap::NapECS::EcsEntityGroup* entityGroup; // 0x18
		::Nap::NapECS::EcsComponentGroup* componentGroup; // 0x20
		::Nap::NapECS::EcsWorldTimeCenter* _TimeCenter_k__BackingField; // 0x28
		::Nap::NapECS::EcsSystemGroup* systemGroup; // 0x30
		::Nap::NapECS::EcsWorld_EntityComponentMaskMap* _componentMaskMap; // 0x38
		::Nap::NapECS::EcsArchetypeGroup* archetypeGroup; // 0x40
