...
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B03F8A0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_COROUTINEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B041460)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_CREATEGETDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B040850)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_CREATESETDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B040A10)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_GET_SYNCHRONIZEDVARIABLES_OFFSET UNITYSDK_OFFSET(0x1B03F830)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_GET_UPDATEINTERVALSECONDS_OFFSET UNITYSDK_OFFSET(0x1B03F7C0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_GET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1B03F6A0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_SET_SYNCHRONIZEDVARIABLES_OFFSET UNITYSDK_OFFSET(0x1B03F840)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_SET_UPDATEINTERVALSECONDS_OFFSET UNITYSDK_OFFSET(0x1B03F7D0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_SET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1B03F6B0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_TICK_OFFSET UNITYSDK_OFFSET(0x1B040E70)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_UPDATEINTERVALCHANGED_OFFSET UNITYSDK_OFFSET(0x1B03F700)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B040E20)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0414E0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int VariableSynchronizer_TypeDefinitionIndex = 31189;
