...
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AA31540)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_COROUTINEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA33100)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_CREATEGETDELEGATE_OFFSET UNITYSDK_OFFSET(0x1AA324F0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_CREATESETDELEGATE_OFFSET UNITYSDK_OFFSET(0x1AA326B0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_GET_SYNCHRONIZEDVARIABLES_OFFSET UNITYSDK_OFFSET(0x1AA314D0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_GET_UPDATEINTERVALSECONDS_OFFSET UNITYSDK_OFFSET(0x1AA31460)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_GET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1AA31340)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_SET_SYNCHRONIZEDVARIABLES_OFFSET UNITYSDK_OFFSET(0x1AA314E0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_SET_UPDATEINTERVALSECONDS_OFFSET UNITYSDK_OFFSET(0x1AA31470)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_SET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1AA31350)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_TICK_OFFSET UNITYSDK_OFFSET(0x1AA32B10)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_UPDATEINTERVALCHANGED_OFFSET UNITYSDK_OFFSET(0x1AA313A0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AA32AC0)
#define BEHAVIORDESIGNER_RUNTIME_VARIABLESYNCHRONIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA33180)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int VariableSynchronizer_TypeDefinitionIndex = 30237;
