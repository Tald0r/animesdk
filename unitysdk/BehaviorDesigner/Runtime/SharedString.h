...
#define BEHAVIORDESIGNER_RUNTIME_SHAREDSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AC6E700)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC6E7A0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int SharedString_TypeDefinitionIndex = 30261;
