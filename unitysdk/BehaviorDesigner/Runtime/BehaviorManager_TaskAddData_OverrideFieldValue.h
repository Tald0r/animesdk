...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1B4459D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B4459C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4459E0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B445A40)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_TaskAddData_OverrideFieldValue_TypeDefinitionIndex = 31150;
