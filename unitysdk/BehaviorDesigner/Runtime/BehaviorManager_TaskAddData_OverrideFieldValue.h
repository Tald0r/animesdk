...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1AE2BEB0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AE2BEA0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AE2BEC0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_OVERRIDEFIELDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE2BF20)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_TaskAddData_OverrideFieldValue_TypeDefinitionIndex = 30197;
