...
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZATIONDATABASE_GET_INITIALIZER_OFFSET UNITYSDK_OFFSET(0x1B0B8370)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZATIONDATABASE_QUERYTYPEDESERIALIZER_OFFSET UNITYSDK_OFFSET(0x1B0B84B0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZATIONDATABASE_SET_INITIALIZER_OFFSET UNITYSDK_OFFSET(0x1B0B83B0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZATIONDATABASE_WARMUP_OFFSET UNITYSDK_OFFSET(0x1B0B83F0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int PrecompiledTypeDeserializationDatabase_TypeDefinitionIndex = 31181;
	...
	public:
		...
		{
			return (::BehaviorDesigner::Runtime::PrecompiledTypeDeserializationDatabase_DatabaseInitializer**)Il2CppClass::FromTypeDefinitionIndex(PrecompiledTypeDeserializationDatabase_TypeDefinitionIndex)->GetStaticField(0x24E20);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::BehaviorDesigner::Runtime::PrecompiledTypeDeserializer*>**)Il2CppClass::FromTypeDefinitionIndex(PrecompiledTypeDeserializationDatabase_TypeDefinitionIndex)->GetStaticField(0x24E28);
		}
