...
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_DESERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A6DA410)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_DESERIALIZESHAREDVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A6D9810)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_DESERIALIZETASK_OFFSET UNITYSDK_OFFSET(0x1A6D8900)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_DESERIALIZEVARIABLES_OFFSET UNITYSDK_OFFSET(0x1A6D8500)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_GET_TASKIDS_OFFSET UNITYSDK_OFFSET(0x1A6D6C60)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_INDEXTOUNITYOBJECT_OFFSET UNITYSDK_OFFSET(0x1A6DC8D0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_LOAD_1_OFFSET UNITYSDK_OFFSET(0x1A6D9400)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_LOAD_OFFSET UNITYSDK_OFFSET(0x1A6D6CD0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_SET_TASKIDS_OFFSET UNITYSDK_OFFSET(0x1A6D6C90)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1A6DE5A0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOMATRIX4X4_OFFSET UNITYSDK_OFFSET(0x1A6DDF30)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOQUATERNION_OFFSET UNITYSDK_OFFSET(0x1A6DDD00)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTORECT_OFFSET UNITYSDK_OFFSET(0x1A6DE7E0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOVECTOR2INT_OFFSET UNITYSDK_OFFSET(0x1A6DD590)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOVECTOR2_OFFSET UNITYSDK_OFFSET(0x1A6DD410)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOVECTOR3INT_OFFSET UNITYSDK_OFFSET(0x1A6DD8F0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1A6DD700)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOVECTOR4_OFFSET UNITYSDK_OFFSET(0x1A6DDAC0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_VALUETOANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1A6DEAF0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_VALUETOLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1A6DEAB0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_VALUETOOBJECT_OFFSET UNITYSDK_OFFSET(0x1A6DC9D0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6DF480)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6DF460)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int JSONDeserialization_TypeDefinitionIndex = 30212;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Object*>*>**)Il2CppClass::FromTypeDefinitionIndex(JSONDeserialization_TypeDefinitionIndex)->GetStaticField(0x23530);
		}
		static ::BehaviorDesigner::Runtime::GlobalVariables** StaticGet_globalVariables()
		{
			return (::BehaviorDesigner::Runtime::GlobalVariables**)Il2CppClass::FromTypeDefinitionIndex(JSONDeserialization_TypeDefinitionIndex)->GetStaticField(0x23538);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::BehaviorDesigner::Runtime::JSONDeserialization_TaskField, ::System::Collections::Generic::List_1<::System::Int32>*>**)Il2CppClass::FromTypeDefinitionIndex(JSONDeserialization_TypeDefinitionIndex)->GetStaticField(0x23540);
		}
		static ::System::Boolean* StaticGet_updatedSerialization()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(JSONDeserialization_TypeDefinitionIndex)->GetStaticField(0x78F0);
		}
