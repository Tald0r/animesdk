...
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_DESERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1AC85640)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_DESERIALIZESHAREDVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AC84A40)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_DESERIALIZETASK_OFFSET UNITYSDK_OFFSET(0x1AC83B40)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_DESERIALIZEVARIABLES_OFFSET UNITYSDK_OFFSET(0x1AC83740)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_GET_TASKIDS_OFFSET UNITYSDK_OFFSET(0x1AC81EA0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_INDEXTOUNITYOBJECT_OFFSET UNITYSDK_OFFSET(0x1AC87B00)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_LOAD_1_OFFSET UNITYSDK_OFFSET(0x1AC84630)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_LOAD_OFFSET UNITYSDK_OFFSET(0x1AC81F10)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_SET_TASKIDS_OFFSET UNITYSDK_OFFSET(0x1AC81ED0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1AC897D0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOMATRIX4X4_OFFSET UNITYSDK_OFFSET(0x1AC89160)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOQUATERNION_OFFSET UNITYSDK_OFFSET(0x1AC88F30)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTORECT_OFFSET UNITYSDK_OFFSET(0x1AC89A10)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOVECTOR2INT_OFFSET UNITYSDK_OFFSET(0x1AC887C0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOVECTOR2_OFFSET UNITYSDK_OFFSET(0x1AC88640)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOVECTOR3INT_OFFSET UNITYSDK_OFFSET(0x1AC88B20)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1AC88930)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_STRINGTOVECTOR4_OFFSET UNITYSDK_OFFSET(0x1AC88CF0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_VALUETOANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1AC89D20)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_VALUETOLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1AC89CE0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_VALUETOOBJECT_OFFSET UNITYSDK_OFFSET(0x1AC87C00)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AC8A6A0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC8A680)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int JSONDeserialization_TypeDefinitionIndex = 31165;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Object*>*>**)Il2CppClass::FromTypeDefinitionIndex(JSONDeserialization_TypeDefinitionIndex)->GetStaticField(0x24E50);
		}
		static ::BehaviorDesigner::Runtime::GlobalVariables** StaticGet_globalVariables()
		{
			return (::BehaviorDesigner::Runtime::GlobalVariables**)Il2CppClass::FromTypeDefinitionIndex(JSONDeserialization_TypeDefinitionIndex)->GetStaticField(0x24E58);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::BehaviorDesigner::Runtime::JSONDeserialization_TaskField, ::System::Collections::Generic::List_1<::System::Int32>*>**)Il2CppClass::FromTypeDefinitionIndex(JSONDeserialization_TypeDefinitionIndex)->GetStaticField(0x24E60);
		}
		static ::System::Boolean* StaticGet_updatedSerialization()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(JSONDeserialization_TypeDefinitionIndex)->GetStaticField(0x7C20);
		}
