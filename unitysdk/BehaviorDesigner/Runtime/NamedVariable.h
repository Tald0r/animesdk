...
#define BEHAVIORDESIGNER_RUNTIME_NAMEDVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A3D60)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int NamedVariable_TypeDefinitionIndex = 30255;
