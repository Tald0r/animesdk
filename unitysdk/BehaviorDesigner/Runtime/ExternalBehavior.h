...
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_BEHAVIORDESIGNER_RUNTIME_IBEHAVIOR_GETINSTANCEID_OFFSET UNITYSDK_OFFSET(0x1AC279B0)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_CHECKFORSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1AC272E0)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_FINDTASKSWITHNAME_1_OFFSET UNITYSDK_OFFSET(0x1AC27840)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_FINDTASKSWITHNAME_OFFSET UNITYSDK_OFFSET(0x1AC27710)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_FINDTASKWITHNAME_1_OFFSET UNITYSDK_OFFSET(0x1AC275F0)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_FINDTASKWITHNAME_OFFSET UNITYSDK_OFFSET(0x1AC27540)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_GETBEHAVIORSOURCE_OFFSET UNITYSDK_OFFSET(0x1AC27110)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_GETOBJECT_OFFSET UNITYSDK_OFFSET(0x1AC271A0)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_GETOWNERNAME_OFFSET UNITYSDK_OFFSET(0x1AC271E0)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_GETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AC27340)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_GET_BEHAVIORSOURCE_OFFSET UNITYSDK_OFFSET(0x1AC270F0)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_GET_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x1AC27240)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_INIT_OFFSET UNITYSDK_OFFSET(0x1AC27250)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_SETBEHAVIORSOURCE_OFFSET UNITYSDK_OFFSET(0x1AC27150)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_SETVARIABLEVALUE_OFFSET UNITYSDK_OFFSET(0x1AC274B0)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_SETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AC273F0)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR_SET_BEHAVIORSOURCE_OFFSET UNITYSDK_OFFSET(0x1AC27100)
#define BEHAVIORDESIGNER_RUNTIME_EXTERNALBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC27980)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int ExternalBehavior_TypeDefinitionIndex = 30207;
