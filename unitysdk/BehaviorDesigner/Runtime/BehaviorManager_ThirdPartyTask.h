...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASK_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1B0B82D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASK_GET_THIRDPARTYOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1B0B82F0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASK_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0B8300)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASK_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1B0B82E0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B8360)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_ThirdPartyTask_TypeDefinitionIndex = 31147;
