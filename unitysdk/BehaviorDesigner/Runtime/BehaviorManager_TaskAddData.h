...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_DESTROY_OFFSET UNITYSDK_OFFSET(0x1AA60AD0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AA60A70)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKADDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA60C50)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_TaskAddData_TypeDefinitionIndex = 30196;
	...
	public:
		...
		::System::Int32 parentIndex; // 0x34
		::System::Boolean fromExternalTask; // 0x38
