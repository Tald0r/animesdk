...
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_CHECKFORSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1B25ECC0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_DOMAINRESET_OFFSET UNITYSDK_OFFSET(0x1B25F6F0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GETALLVARIABLES_OFFSET UNITYSDK_OFFSET(0x1B25F1C0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1B25F090)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B25EA80)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GET_VARIABLEDATA_OFFSET UNITYSDK_OFFSET(0x1B25F050)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1B25EE10)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B25F070)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SETALLVARIABLES_OFFSET UNITYSDK_OFFSET(0x1B25F6A0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SETVARIABLEVALUE_OFFSET UNITYSDK_OFFSET(0x1B25F5A0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1B25F210)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SET_VARIABLEDATA_OFFSET UNITYSDK_OFFSET(0x1B25F060)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1B25EE20)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B25F080)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_UPDATEVARIABLENAME_OFFSET UNITYSDK_OFFSET(0x1B25F630)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_UPDATEVARIABLESINDEX_OFFSET UNITYSDK_OFFSET(0x1B25EE70)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B25F770)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B25F740)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int GlobalVariables_TypeDefinitionIndex = 31162;
	...
	public:
		...
		{
			return (::BehaviorDesigner::Runtime::GlobalVariables**)Il2CppClass::FromTypeDefinitionIndex(GlobalVariables_TypeDefinitionIndex)->GetStaticField(0x24FA0);
		}
