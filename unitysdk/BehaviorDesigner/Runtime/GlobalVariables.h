...
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_CHECKFORSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1AC58F30)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_DOMAINRESET_OFFSET UNITYSDK_OFFSET(0x1AC59960)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GETALLVARIABLES_OFFSET UNITYSDK_OFFSET(0x1AC59430)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AC59300)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1AC58CF0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GET_VARIABLEDATA_OFFSET UNITYSDK_OFFSET(0x1AC592C0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1AC59080)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AC592E0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SETALLVARIABLES_OFFSET UNITYSDK_OFFSET(0x1AC59910)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SETVARIABLEVALUE_OFFSET UNITYSDK_OFFSET(0x1AC59810)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AC59480)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SET_VARIABLEDATA_OFFSET UNITYSDK_OFFSET(0x1AC592D0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1AC59090)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AC592F0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_UPDATEVARIABLENAME_OFFSET UNITYSDK_OFFSET(0x1AC598A0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES_UPDATEVARIABLESINDEX_OFFSET UNITYSDK_OFFSET(0x1AC590E0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AC599E0)
#define BEHAVIORDESIGNER_RUNTIME_GLOBALVARIABLES__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC599B0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int GlobalVariables_TypeDefinitionIndex = 30209;
	...
	public:
		...
		{
			return (::BehaviorDesigner::Runtime::GlobalVariables**)Il2CppClass::FromTypeDefinitionIndex(GlobalVariables_TypeDefinitionIndex)->GetStaticField(0x23680);
		}
