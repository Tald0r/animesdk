...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_CHECKFORSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1A496880)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_GETALLVARIABLES_OFFSET UNITYSDK_OFFSET(0x1A49A120)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_GETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A499E10)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_GET_BEHAVIORID_OFFSET UNITYSDK_OFFSET(0x1A496530)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_GET_DETACHEDTASKS_OFFSET UNITYSDK_OFFSET(0x1A496590)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_GET_ENTRYTASK_OFFSET UNITYSDK_OFFSET(0x1A496550)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_GET_HASSERIALIZED_OFFSET UNITYSDK_OFFSET(0x1A496660)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x1A4966A0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_GET_ROOTTASK_OFFSET UNITYSDK_OFFSET(0x1A496570)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_GET_TASKDATA_OFFSET UNITYSDK_OFFSET(0x1A496680)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_GET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1A4965B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A496750)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_LOAD_OFFSET UNITYSDK_OFFSET(0x1A496810)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_REPLACEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A49A170)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_SAVE_OFFSET UNITYSDK_OFFSET(0x1A4967A0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_SETALLVARIABLES_OFFSET UNITYSDK_OFFSET(0x1A496610)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_SETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A49A360)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_SET_BEHAVIORID_OFFSET UNITYSDK_OFFSET(0x1A496540)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_SET_DETACHEDTASKS_OFFSET UNITYSDK_OFFSET(0x1A4965A0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_SET_ENTRYTASK_OFFSET UNITYSDK_OFFSET(0x1A496560)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_SET_HASSERIALIZED_OFFSET UNITYSDK_OFFSET(0x1A496670)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_SET_OWNER_OFFSET UNITYSDK_OFFSET(0x1A4966B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_SET_ROOTTASK_OFFSET UNITYSDK_OFFSET(0x1A496580)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_SET_TASKDATA_OFFSET UNITYSDK_OFFSET(0x1A496690)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_SET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1A4965C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A49A620)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_UPDATEVARIABLENAME_OFFSET UNITYSDK_OFFSET(0x1A49A5B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE_UPDATEVARIABLESINDEX_OFFSET UNITYSDK_OFFSET(0x1A499F40)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4966E0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4966C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORSOURCE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A49AAA0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorSource_TypeDefinitionIndex = 31155;
