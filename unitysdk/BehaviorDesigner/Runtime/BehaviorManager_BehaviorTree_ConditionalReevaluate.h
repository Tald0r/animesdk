...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_CONDITIONALREEVALUATE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A62A0A0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_CONDITIONALREEVALUATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A62A090)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_BehaviorTree_ConditionalReevaluate_TypeDefinitionIndex = 30192;

	class BehaviorManager_BehaviorTree_ConditionalReevaluate : public ::System::Object
	{
	public:
		::System::Int32 compositeIndex; // 0x10
		::System::Int32 stackIndex; // 0x14
