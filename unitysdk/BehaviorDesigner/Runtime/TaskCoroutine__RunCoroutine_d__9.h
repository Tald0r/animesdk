...
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__RUNCOROUTINE_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B287F40)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__RUNCOROUTINE_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B2880F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__RUNCOROUTINE_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B288150)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__RUNCOROUTINE_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B288100)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__RUNCOROUTINE_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B287F30)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__RUNCOROUTINE_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x1B287F20)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int TaskCoroutine__RunCoroutine_d__9_TypeDefinitionIndex = 31187;
