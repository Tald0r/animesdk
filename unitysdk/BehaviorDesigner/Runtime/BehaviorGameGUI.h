...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORGAMEGUI_ONGUI_OFFSET UNITYSDK_OFFSET(0x1AD14450)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORGAMEGUI_START_OFFSET UNITYSDK_OFFSET(0x1AD14400)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORGAMEGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD14BE0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorGameGUI_TypeDefinitionIndex = 30183;
