...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORGAMEGUI_ONGUI_OFFSET UNITYSDK_OFFSET(0x1B32E9D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORGAMEGUI_START_OFFSET UNITYSDK_OFFSET(0x1B32E980)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORGAMEGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B32F160)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorGameGUI_TypeDefinitionIndex = 31136;
