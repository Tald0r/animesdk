...
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x19E7B8E0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISGLOBAL_OFFSET UNITYSDK_OFFSET(0x19E7B8C0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISNONE_OFFSET UNITYSDK_OFFSET(0x19E7B9A0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISPRIVATE_OFFSET UNITYSDK_OFFSET(0x19E7B900)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISSHARED_OFFSET UNITYSDK_OFFSET(0x19E7B8A0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19E7B920)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_NETWORKSYNC_OFFSET UNITYSDK_OFFSET(0x19E7B980)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROPERTYMAPPINGOWNER_OFFSET UNITYSDK_OFFSET(0x19E7B960)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x19E7B940)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x19E7B7E0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMISGLOBAL_OFFSET UNITYSDK_OFFSET(0x19E7B7C0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMISPRIVATE_OFFSET UNITYSDK_OFFSET(0x19E7B800)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMISSHARED_OFFSET UNITYSDK_OFFSET(0x19E7B7A0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMNAME_OFFSET UNITYSDK_OFFSET(0x19E7B820)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMNETWORKSYNC_OFFSET UNITYSDK_OFFSET(0x19E7B880)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMPROPERTYMAPPINGOWNER_OFFSET UNITYSDK_OFFSET(0x19E7B860)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMPROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x19E7B840)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_INITIALIZEPROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x19E7BA50)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x19E7B8F0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_ISGLOBAL_OFFSET UNITYSDK_OFFSET(0x19E7B8D0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_ISPRIVATE_OFFSET UNITYSDK_OFFSET(0x19E7B910)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_ISSHARED_OFFSET UNITYSDK_OFFSET(0x19E7B8B0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19E7B930)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_NETWORKSYNC_OFFSET UNITYSDK_OFFSET(0x19E7B990)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROPERTYMAPPINGOWNER_OFFSET UNITYSDK_OFFSET(0x19E7B970)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x19E7B950)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x19E7B7F0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMISGLOBAL_OFFSET UNITYSDK_OFFSET(0x19E7B7D0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMISPRIVATE_OFFSET UNITYSDK_OFFSET(0x19E7B810)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMISSHARED_OFFSET UNITYSDK_OFFSET(0x19E7B7B0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMNAME_OFFSET UNITYSDK_OFFSET(0x19E7B830)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMNETWORKSYNC_OFFSET UNITYSDK_OFFSET(0x19E7B890)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMPROPERTYMAPPINGOWNER_OFFSET UNITYSDK_OFFSET(0x19E7B870)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMPROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x19E7B850)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19E7BA10)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E7BAB0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E7BAA0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int SharedVariable_TypeDefinitionIndex = 30205;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SharedVariable_TypeDefinitionIndex)->GetStaticField(0x7960);
		}
