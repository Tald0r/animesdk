...
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1A49F700)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISGLOBAL_OFFSET UNITYSDK_OFFSET(0x1A49F6E0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISNONE_OFFSET UNITYSDK_OFFSET(0x1A49F7C0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISPRIVATE_OFFSET UNITYSDK_OFFSET(0x1A49F720)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_ISSHARED_OFFSET UNITYSDK_OFFSET(0x1A49F6C0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A49F740)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_NETWORKSYNC_OFFSET UNITYSDK_OFFSET(0x1A49F7A0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROPERTYMAPPINGOWNER_OFFSET UNITYSDK_OFFSET(0x1A49F780)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x1A49F760)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1A49F600)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMISGLOBAL_OFFSET UNITYSDK_OFFSET(0x1A49F5E0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMISPRIVATE_OFFSET UNITYSDK_OFFSET(0x1A49F620)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMISSHARED_OFFSET UNITYSDK_OFFSET(0x1A49F5C0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMNAME_OFFSET UNITYSDK_OFFSET(0x1A49F640)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMNETWORKSYNC_OFFSET UNITYSDK_OFFSET(0x1A49F6A0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMPROPERTYMAPPINGOWNER_OFFSET UNITYSDK_OFFSET(0x1A49F680)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_GET_PROXYMPROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x1A49F660)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_INITIALIZEPROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x1A49F870)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1A49F710)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_ISGLOBAL_OFFSET UNITYSDK_OFFSET(0x1A49F6F0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_ISPRIVATE_OFFSET UNITYSDK_OFFSET(0x1A49F730)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_ISSHARED_OFFSET UNITYSDK_OFFSET(0x1A49F6D0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A49F750)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_NETWORKSYNC_OFFSET UNITYSDK_OFFSET(0x1A49F7B0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROPERTYMAPPINGOWNER_OFFSET UNITYSDK_OFFSET(0x1A49F790)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x1A49F770)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1A49F610)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMISGLOBAL_OFFSET UNITYSDK_OFFSET(0x1A49F5F0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMISPRIVATE_OFFSET UNITYSDK_OFFSET(0x1A49F630)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMISSHARED_OFFSET UNITYSDK_OFFSET(0x1A49F5D0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMNAME_OFFSET UNITYSDK_OFFSET(0x1A49F650)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMNETWORKSYNC_OFFSET UNITYSDK_OFFSET(0x1A49F6B0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMPROPERTYMAPPINGOWNER_OFFSET UNITYSDK_OFFSET(0x1A49F690)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_SET_PROXYMPROPERTYMAPPING_OFFSET UNITYSDK_OFFSET(0x1A49F670)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A49F830)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A49F8D0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A49F8C0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int SharedVariable_TypeDefinitionIndex = 31158;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SharedVariable_TypeDefinitionIndex)->GetStaticField(0x7C90);
		}
