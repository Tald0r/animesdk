...
#define BEHAVIORDESIGNER_RUNTIME_TASKFIELDASSIGNER_SETTASKFIELD_OFFSET UNITYSDK_OFFSET(0x925FF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKFIELDASSIGNER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x925FC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKFIELDASSIGNER__CTOR_OFFSET UNITYSDK_OFFSET(0x925FA0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int TaskFieldAssigner_TypeDefinitionIndex = 30227;
