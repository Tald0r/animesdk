...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASKCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B56BF0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASKCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B56C60)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASKCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B56B40)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_ThirdPartyTaskComparer_TypeDefinitionIndex = 30195;
