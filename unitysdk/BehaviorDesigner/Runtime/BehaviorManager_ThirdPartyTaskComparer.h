...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASKCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A0FF030)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASKCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A0FF0A0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_THIRDPARTYTASKCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0FEF80)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_ThirdPartyTaskComparer_TypeDefinitionIndex = 31148;
