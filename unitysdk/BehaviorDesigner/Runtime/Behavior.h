...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ADD_ONBEHAVIOREND_OFFSET UNITYSDK_OFFSET(0x1ABFFA70)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ADD_ONBEHAVIORPARAMBIND_OFFSET UNITYSDK_OFFSET(0x1ABFF7D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ADD_ONBEHAVIORRESTART_OFFSET UNITYSDK_OFFSET(0x1ABFF990)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ADD_ONBEHAVIORSTART_OFFSET UNITYSDK_OFFSET(0x1ABFF8B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ATTACHLOADINGFINISHCB_OFFSET UNITYSDK_OFFSET(0x1ABFF020)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_BEHAVIORDESIGNER_RUNTIME_IBEHAVIOR_GETINSTANCEID_OFFSET UNITYSDK_OFFSET(0x1AC050A0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_CHECKFORSERIALIZATION_1_OFFSET UNITYSDK_OFFSET(0x1AC00EB0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_CHECKFORSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x1AC008B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_CREATEBEHAVIORMANAGER_OFFSET UNITYSDK_OFFSET(0x1AC00010)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_DISABLEBEHAVIOR_1_OFFSET UNITYSDK_OFFSET(0x1AC00380)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_DISABLEBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1AC001F0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_DOMAINRESET_OFFSET UNITYSDK_OFFSET(0x1AC04E10)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ENABLEBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1ABFFE30)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_FINDTASKSWITHNAME_1_OFFSET UNITYSDK_OFFSET(0x1AC02400)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_FINDTASKSWITHNAME_OFFSET UNITYSDK_OFFSET(0x1AC022E0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_FINDTASKWITHNAME_1_OFFSET UNITYSDK_OFFSET(0x1AC021C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_FINDTASKWITHNAME_OFFSET UNITYSDK_OFFSET(0x1AC02120)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GETACTIVETASKS_OFFSET UNITYSDK_OFFSET(0x1AC02540)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GETALLVARIABLES_OFFSET UNITYSDK_OFFSET(0x1AC00DB0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GETBEHAVIORSOURCE_OFFSET UNITYSDK_OFFSET(0x1ABFF650)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GETDELEGATE_OFFSET UNITYSDK_OFFSET(0x1AC03DC0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GETOBJECT_OFFSET UNITYSDK_OFFSET(0x1ABFF6E0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GETOWNERNAME_OFFSET UNITYSDK_OFFSET(0x1ABFF720)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GETTOPPARENTBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1AC04F60)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AC00810)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_ASYNCHRONOUSLOAD_OFFSET UNITYSDK_OFFSET(0x1ABFEEA0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_ASYNCLOADREQUEST_OFFSET UNITYSDK_OFFSET(0x1ABFF0D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_BEHAVIORDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1ABFF5D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_BEHAVIORMODE_OFFSET UNITYSDK_OFFSET(0x1AC04EC0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_BEHAVIORNAME_OFFSET UNITYSDK_OFFSET(0x1ABFF550)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_BEHAVIORPROXYGETTER_OFFSET UNITYSDK_OFFSET(0x1ABFF0F0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_EXECUTIONSTATUS_OFFSET UNITYSDK_OFFSET(0x1ABFF7A0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_EXTERNALBEHAVIORVERSION_OFFSET UNITYSDK_OFFSET(0x1ABFF1D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_EXTERNALBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1ABFF1F0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_GROUP_OFFSET UNITYSDK_OFFSET(0x1ABFF190)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_HASEVENT_OFFSET UNITYSDK_OFFSET(0x1ABFF7C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_HASINHERITEDVARIABLES_OFFSET UNITYSDK_OFFSET(0x1ABFF530)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_ISASYNCLOADED_OFFSET UNITYSDK_OFFSET(0x1ABFEFA0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_ISRUNTIMEBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1ABFEEC0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_LASTASYNCLOADUSERDATA_OFFSET UNITYSDK_OFFSET(0x1ABFEEE0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_LOADINGREFCOUNT_OFFSET UNITYSDK_OFFSET(0x1ABFEF00)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_LOADTHREADEVENT_OFFSET UNITYSDK_OFFSET(0x1ABFF110)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_LOGTASKCHANGES_OFFSET UNITYSDK_OFFSET(0x1ABFF170)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_PARENTBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1AC04EE0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_PAUSEWHENDISABLED_OFFSET UNITYSDK_OFFSET(0x1ABFF130)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_RESETVALUESONRESTART_OFFSET UNITYSDK_OFFSET(0x1ABFF1B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_RESTARTWHENCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1ABFF150)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_STARTWHENENABLED_OFFSET UNITYSDK_OFFSET(0x1ABFEE80)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET_TAGID_OFFSET UNITYSDK_OFFSET(0x1ABFF000)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_GET__ASYNCLOADEDTAG_OFFSET UNITYSDK_OFFSET(0x1ABFEF20)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_INITHASEVENT_OFFSET UNITYSDK_OFFSET(0x1AC03680)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x1AC01FA0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONBEHAVIORENDED_OFFSET UNITYSDK_OFFSET(0x1AC03950)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONBEHAVIORPARAMBINDED_OFFSET UNITYSDK_OFFSET(0x1AC03830)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONBEHAVIORRESTARTED_OFFSET UNITYSDK_OFFSET(0x1AC038F0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONBEHAVIORSTARTED_OFFSET UNITYSDK_OFFSET(0x1AC03890)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONCOLLISIONENTER2D_OFFSET UNITYSDK_OFFSET(0x1AC017D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x1AC01190)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1AC01960)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x1AC01320)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x1AC01E10)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AC00690)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AC00640)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AC00500)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONSUBBEHAVIORPARAMBINDED_OFFSET UNITYSDK_OFFSET(0x1AC05020)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONTRIGGERENTER2D_OFFSET UNITYSDK_OFFSET(0x1AC01AF0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1AC014B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x1AC01C80)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1AC01640)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_REGISTEREVENT_1_OFFSET UNITYSDK_OFFSET(0x1AC03D60)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_REGISTEREVENT_OFFSET UNITYSDK_OFFSET(0x1AC039B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_REMOVE_ONBEHAVIOREND_OFFSET UNITYSDK_OFFSET(0x1ABFFAE0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_REMOVE_ONBEHAVIORPARAMBIND_OFFSET UNITYSDK_OFFSET(0x1ABFF840)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_REMOVE_ONBEHAVIORRESTART_OFFSET UNITYSDK_OFFSET(0x1ABFFA00)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_REMOVE_ONBEHAVIORSTART_OFFSET UNITYSDK_OFFSET(0x1ABFF920)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_REPLACEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AC00900)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_RESETVALUES_OFFSET UNITYSDK_OFFSET(0x1AC04590)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x1AC04AC0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SAVERESETVALUES_OFFSET UNITYSDK_OFFSET(0x1AC04220)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SAVEVALUES_OFFSET UNITYSDK_OFFSET(0x1AC043D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SAVEVALUE_OFFSET UNITYSDK_OFFSET(0x1AC04720)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x1AC03F20)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SETBEHAVIORSOURCE_OFFSET UNITYSDK_OFFSET(0x1ABFF690)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SETPARENTBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1AC04F00)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SETVARIABLEVALUE_OFFSET UNITYSDK_OFFSET(0x1AC00AC0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AC009E0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_ASYNCHRONOUSLOAD_OFFSET UNITYSDK_OFFSET(0x1ABFEEB0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_ASYNCLOADREQUEST_OFFSET UNITYSDK_OFFSET(0x1ABFF0E0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_BEHAVIORDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1ABFF5F0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_BEHAVIORMODE_OFFSET UNITYSDK_OFFSET(0x1AC04ED0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_BEHAVIORNAME_OFFSET UNITYSDK_OFFSET(0x1ABFF570)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_BEHAVIORPROXYGETTER_OFFSET UNITYSDK_OFFSET(0x1ABFF100)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_EXECUTIONSTATUS_OFFSET UNITYSDK_OFFSET(0x1ABFF7B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_EXTERNALBEHAVIORVERSION_OFFSET UNITYSDK_OFFSET(0x1ABFF1E0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_EXTERNALBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1ABFF200)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_GROUP_OFFSET UNITYSDK_OFFSET(0x1ABFF1A0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_HASINHERITEDVARIABLES_OFFSET UNITYSDK_OFFSET(0x1ABFF540)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_ISRUNTIMEBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1ABFEED0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_LASTASYNCLOADUSERDATA_OFFSET UNITYSDK_OFFSET(0x1ABFEEF0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_LOADINGREFCOUNT_OFFSET UNITYSDK_OFFSET(0x1ABFEF10)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_LOADTHREADEVENT_OFFSET UNITYSDK_OFFSET(0x1ABFF120)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_LOGTASKCHANGES_OFFSET UNITYSDK_OFFSET(0x1ABFF180)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_PARENTBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1AC04EF0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_PAUSEWHENDISABLED_OFFSET UNITYSDK_OFFSET(0x1ABFF140)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_RESETVALUESONRESTART_OFFSET UNITYSDK_OFFSET(0x1ABFF1C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_RESTARTWHENCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1ABFF160)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_STARTWHENENABLED_OFFSET UNITYSDK_OFFSET(0x1ABFEE90)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET_TAGID_OFFSET UNITYSDK_OFFSET(0x1ABFF010)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_SET__ASYNCLOADEDTAG_OFFSET UNITYSDK_OFFSET(0x1ABFEF30)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_STARTTASKCOROUTINE_1_OFFSET UNITYSDK_OFFSET(0x1AC02B90)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_STARTTASKCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1AC02680)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_START_OFFSET UNITYSDK_OFFSET(0x1ABFFC40)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_STOPALLTASKCOROUTINES_OFFSET UNITYSDK_OFFSET(0x1AC032A0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_STOPTASKCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1AC03120)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_TASKCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1ABFFC80)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_TASKCOROUTINEENDED_OFFSET UNITYSDK_OFFSET(0x1AC034C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AC04DC0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_TRYSETLOADEDTAG_OFFSET UNITYSDK_OFFSET(0x1ABFEF40)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_UNREGISTEREVENT_1_OFFSET UNITYSDK_OFFSET(0x1AC041C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR_UNREGISTEREVENT_OFFSET UNITYSDK_OFFSET(0x1AC03FC0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AC05080)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABFFB50)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIOR___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AC05180)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int Behavior_TypeDefinitionIndex = 31132;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Behavior_TypeDefinitionIndex)->GetStaticField(0x7C40);
		}
		static ::System::Int32* StaticGet__behaviorManagerIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Behavior_TypeDefinitionIndex)->GetStaticField(0x7C44);
		}
