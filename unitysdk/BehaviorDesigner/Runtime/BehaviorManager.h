...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_ADDTOTASKLIST_OFFSET UNITYSDK_OFFSET(0x1A0F3300)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_ATTACHLOADINGFINISHCB_OFFSET UNITYSDK_OFFSET(0x1A0EEA80)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A0F1250)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x1A0FE430)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORONCOLLISIONENTER2D_OFFSET UNITYSDK_OFFSET(0x1A0FD800)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x1A0FCE40)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1A0FDA70)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x1A0FD0B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x1A0FE1C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORONTRIGGERENTER2D_OFFSET UNITYSDK_OFFSET(0x1A0FDCE0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1A0FD320)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x1A0FDF50)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1A0FD590)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_COROUTINEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0F92C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_DESTROYBEHAVIOR_1_OFFSET UNITYSDK_OFFSET(0x1A0F76B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_DESTROYBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1A0F7AE0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_DESTROYMANAGER_OFFSET UNITYSDK_OFFSET(0x1A0FEAE0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_DISABLEBEHAVIOR_1_OFFSET UNITYSDK_OFFSET(0x1A0F7350)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_DISABLEBEHAVIOR_2_OFFSET UNITYSDK_OFFSET(0x1A0F73C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_DISABLEBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1A0F1590)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_DOMAINRESET_OFFSET UNITYSDK_OFFSET(0x1A0FEA80)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_ENABLEBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1A0F1940)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_FINDLCA_OFFSET UNITYSDK_OFFSET(0x1A0FB700)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_FIXEDTICK_1_OFFSET UNITYSDK_OFFSET(0x1A0F9BE0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_FIXEDTICK_OFFSET UNITYSDK_OFFSET(0x1A0F9110)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0F9030)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_GETACTIVETASKS_OFFSET UNITYSDK_OFFSET(0x1A0FCB00)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_GET_BEHAVIORTREES_OFFSET UNITYSDK_OFFSET(0x1A0F0570)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_GET_DEBUG_BEHAVIORASYNCLOADMANAGER_OFFSET UNITYSDK_OFFSET(0x1A0EFE30)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_GET_DIALOGUESYSTEMSTOPMETHOD_OFFSET UNITYSDK_OFFSET(0x1A0F0ED0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_GET_EXECUTIONSPERTICK_OFFSET UNITYSDK_OFFSET(0x1A0F04C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x1A0F0500)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_GET_MAXTASKEXECUTIONSPERTICK_OFFSET UNITYSDK_OFFSET(0x1A0F04E0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_GET_PLAYMAKERSTOPMETHOD_OFFSET UNITYSDK_OFFSET(0x1A0F0580)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_GET_UPDATEINTERVALSECONDS_OFFSET UNITYSDK_OFFSET(0x1A0F0450)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_GET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1A0F0330)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_GET_USCRIPTSTOPMETHOD_OFFSET UNITYSDK_OFFSET(0x1A0F0D10)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_GET_USEQUENCERSTOPMETHOD_OFFSET UNITYSDK_OFFSET(0x1A0F1090)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_INTERRUPT_1_OFFSET UNITYSDK_OFFSET(0x1A0FC6C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_INTERRUPT_OFFSET UNITYSDK_OFFSET(0x1A0FBA50)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_ISBEHAVIORENABLED_OFFSET UNITYSDK_OFFSET(0x1A0F1CE0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_ISCHILD_OFFSET UNITYSDK_OFFSET(0x1A0FB900)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_ISPARENTTASK_OFFSET UNITYSDK_OFFSET(0x1A0FB9B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0F8DC0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_LOADBEHAVIORCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A0EF8A0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_LOADBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1A0F2370)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_MAPOBJECTTOTASK_OFFSET UNITYSDK_OFFSET(0x1A0FE680)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x1A0F17B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A0F1320)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_ONMGRLATETICK_OFFSET UNITYSDK_OFFSET(0x1A0F9240)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_OVERRIDEFIELDS_OFFSET UNITYSDK_OFFSET(0x1A0F5940)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_OVERRIDESHAREDVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A0F69F0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_POPTASK_1_OFFSET UNITYSDK_OFFSET(0x1A0F7B40)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_POPTASK_OFFSET UNITYSDK_OFFSET(0x1A0FACE0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_PUSHTASK_OFFSET UNITYSDK_OFFSET(0x1A0F56E0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_REEVALUATECONDITIONALTASKS_OFFSET UNITYSDK_OFFSET(0x1A0F9F90)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_REEVALUATEPARENTTASKS_OFFSET UNITYSDK_OFFSET(0x1A0F9D50)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_REMOVEACTIVETHIRDPARTYTASK_OFFSET UNITYSDK_OFFSET(0x1A0FC970)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_REMOVECHILDCONDITIONALREEVALUATE_OFFSET UNITYSDK_OFFSET(0x1A0F87F0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_REMOVESTACK_OFFSET UNITYSDK_OFFSET(0x1A0FBFF0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_RESTARTBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1A0F89E0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_RESTART_OFFSET UNITYSDK_OFFSET(0x1A0F8BA0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_ROUNDEDTIME_OFFSET UNITYSDK_OFFSET(0x1A0FBEA0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_RUNPARENTTASK_OFFSET UNITYSDK_OFFSET(0x1A0FBAC0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_RUNTASK_OFFSET UNITYSDK_OFFSET(0x1A0FAD80)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_SET_EXECUTIONSPERTICK_OFFSET UNITYSDK_OFFSET(0x1A0F04D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_SET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x1A0F0540)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_SET_MAXTASKEXECUTIONSPERTICK_OFFSET UNITYSDK_OFFSET(0x1A0F04F0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_SET_UPDATEINTERVALSECONDS_OFFSET UNITYSDK_OFFSET(0x1A0F0460)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_SET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1A0F0340)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_STOPTHIRDPARTYTASK_OFFSET UNITYSDK_OFFSET(0x1A0FC260)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TASKFOROBJECT_OFFSET UNITYSDK_OFFSET(0x1A0FE980)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TICK_1_OFFSET UNITYSDK_OFFSET(0x1A0F9A70)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TICK_2_OFFSET UNITYSDK_OFFSET(0x1A0F9340)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TICK_OFFSET UNITYSDK_OFFSET(0x1A0F8D30)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TRYGETBEHAVIORINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A0F1860)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TRYGETBEHAVIORTREE_OFFSET UNITYSDK_OFFSET(0x1A0FCCF0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TRYLOADBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1A0EEB20)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_TRYPUSHLOADSUBTREEREQUEST_OFFSET UNITYSDK_OFFSET(0x1A0EF4B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_UPDATEINTERVALCHANGED_OFFSET UNITYSDK_OFFSET(0x1A0F0390)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A0F8CE0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__BEFORELOADHANDLE_OFFSET UNITYSDK_OFFSET(0x1A0EFE40)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0FEF90)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0FECF0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__FILLREFUNITYOBJECTPATH_OFFSET UNITYSDK_OFFSET(0x1A0EF1A0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__GREEN_OFFSET UNITYSDK_OFFSET(0x1A0F3150)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__ISBEHAVIORLOADVERSIONEQUAL_OFFSET UNITYSDK_OFFSET(0x1A0EF070)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__ISINTERRUPTIONINCURSTACK_OFFSET UNITYSDK_OFFSET(0x1A0F9CE0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__LATETICKASYNCLOAD_OFFSET UNITYSDK_OFFSET(0x1A0EFDD0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__LOADFINISHEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A0EF730)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__LOGERR_OFFSET UNITYSDK_OFFSET(0x1A0F31D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__LOGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A0F3220)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__LOG_LOAD_OFFSET UNITYSDK_OFFSET(0x1A0F30C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__RED_OFFSET UNITYSDK_OFFSET(0x1A0F3110)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__TRYSTARTBEHAVIORLOADTICK_OFFSET UNITYSDK_OFFSET(0x1A0EF160)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER__YELLOW_OFFSET UNITYSDK_OFFSET(0x1A0F3190)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_TypeDefinitionIndex = 31137;
	...
	public:
		...
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(BehaviorManager_TypeDefinitionIndex)->GetStaticField(0x24E70);
		}
		static ::System::Reflection::MethodInfo** StaticGet_uSequencerStopMethod()
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(BehaviorManager_TypeDefinitionIndex)->GetStaticField(0x24E78);
		}
		static ::System::Text::StringBuilder** StaticGet__sharedCacheBuilder()
		{
			return (::System::Text::StringBuilder**)Il2CppClass::FromTypeDefinitionIndex(BehaviorManager_TypeDefinitionIndex)->GetStaticField(0x24E80);
		}
		static ::BehaviorDesigner::Runtime::BehaviorManager** StaticGet_instance()
		{
			return (::BehaviorDesigner::Runtime::BehaviorManager**)Il2CppClass::FromTypeDefinitionIndex(BehaviorManager_TypeDefinitionIndex)->GetStaticField(0x24E88);
		}
		static ::System::Reflection::MethodInfo** StaticGet_dialogueSystemStopMethod()
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(BehaviorManager_TypeDefinitionIndex)->GetStaticField(0x24E90);
		}
		static ::System::Reflection::MethodInfo** StaticGet_uScriptStopMethod()
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(BehaviorManager_TypeDefinitionIndex)->GetStaticField(0x24E98);
		}
		static ::Il2CppArray<::System::Object*>** StaticGet_invokeParameters()
		{
			return (::Il2CppArray<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(BehaviorManager_TypeDefinitionIndex)->GetStaticField(0x24EA0);
		}
		static ::System::Boolean* StaticGet_UsingMultiThreadLoading()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(BehaviorManager_TypeDefinitionIndex)->GetStaticField(0x7C30);
		}
		static ::System::Boolean* StaticGet_isPlaying()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(BehaviorManager_TypeDefinitionIndex)->GetStaticField(0x7C31);
		}
