...
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER_SERIALIZEARRAY_OFFSET UNITYSDK_OFFSET(0x1ABD5930)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER_SERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1ABD5B40)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER_SERIALIZEOTHER_OFFSET UNITYSDK_OFFSET(0x1ABD6050)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER_SERIALIZESTRING_OFFSET UNITYSDK_OFFSET(0x1ABD5600)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER_SERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x1ABD54B0)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ABD53A0)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABD5320)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int MiniJSON_Serializer_TypeDefinitionIndex = 31171;
