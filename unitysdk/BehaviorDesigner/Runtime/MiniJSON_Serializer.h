...
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER_SERIALIZEARRAY_OFFSET UNITYSDK_OFFSET(0x1A62A720)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER_SERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A62A930)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER_SERIALIZEOTHER_OFFSET UNITYSDK_OFFSET(0x1A62AE40)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER_SERIALIZESTRING_OFFSET UNITYSDK_OFFSET(0x1A62A3F0)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER_SERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x1A62A2A0)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A62A190)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_SERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A62A110)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int MiniJSON_Serializer_TypeDefinitionIndex = 30218;
