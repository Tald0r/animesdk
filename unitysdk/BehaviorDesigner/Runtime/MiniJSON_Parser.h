...
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A49DAE0)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A49F150)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_GET_NEXTCHAR_OFFSET UNITYSDK_OFFSET(0x1A49ED70)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_GET_NEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x1A49DE70)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_GET_NEXTWORD_OFFSET UNITYSDK_OFFSET(0x1A49EE50)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_GET_PEEKCHAR_OFFSET UNITYSDK_OFFSET(0x1A49F340)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_ISWORDBREAK_OFFSET UNITYSDK_OFFSET(0x1A49D710)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSEARRAY_OFFSET UNITYSDK_OFFSET(0x1A49E9F0)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSEBYTOKEN_OFFSET UNITYSDK_OFFSET(0x1A49EB40)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSENUMBER_OFFSET UNITYSDK_OFFSET(0x1A49EC70)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A49DB80)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSESTRING_OFFSET UNITYSDK_OFFSET(0x1A49E270)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1A49DA90)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSE_OFFSET UNITYSDK_OFFSET(0x1A49D830)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A49D7B0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int MiniJSON_Parser_TypeDefinitionIndex = 31169;
