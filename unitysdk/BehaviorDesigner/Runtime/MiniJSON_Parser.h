...
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19E79CC0)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x19E7B330)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_GET_NEXTCHAR_OFFSET UNITYSDK_OFFSET(0x19E7AF50)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_GET_NEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x19E7A050)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_GET_NEXTWORD_OFFSET UNITYSDK_OFFSET(0x19E7B030)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_GET_PEEKCHAR_OFFSET UNITYSDK_OFFSET(0x19E7B520)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_ISWORDBREAK_OFFSET UNITYSDK_OFFSET(0x19E798F0)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSEARRAY_OFFSET UNITYSDK_OFFSET(0x19E7ABD0)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSEBYTOKEN_OFFSET UNITYSDK_OFFSET(0x19E7AD20)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSENUMBER_OFFSET UNITYSDK_OFFSET(0x19E7AE50)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSEOBJECT_OFFSET UNITYSDK_OFFSET(0x19E79D60)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSESTRING_OFFSET UNITYSDK_OFFSET(0x19E7A450)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x19E79C70)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER_PARSE_OFFSET UNITYSDK_OFFSET(0x19E79A10)
#define BEHAVIORDESIGNER_RUNTIME_MINIJSON_PARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E79990)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int MiniJSON_Parser_TypeDefinitionIndex = 30216;
