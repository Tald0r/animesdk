...
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A49D350)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZEREFERENCEDTASK_OFFSET UNITYSDK_OFFSET(0x1A49D0D0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZESHAREDVARIABLE_1_OFFSET UNITYSDK_OFFSET(0x1A49C6E0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZESHAREDVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A49C4F0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZETASK_OFFSET UNITYSDK_OFFSET(0x1A49B460)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZEVARIABLES_OFFSET UNITYSDK_OFFSET(0x1A49AF20)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_1_OFFSET UNITYSDK_OFFSET(0x1A49C0B0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_OFFSET UNITYSDK_OFFSET(0x1A496A80)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int JSONDeserialization_PrecompiledDeserialization_TypeDefinitionIndex = 31166;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::BehaviorDesigner::Runtime::TaskFieldAssigner>**)Il2CppClass::FromTypeDefinitionIndex(JSONDeserialization_PrecompiledDeserialization_TypeDefinitionIndex)->GetStaticField(0x24E10);
		}
