...
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x19E79530)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZEREFERENCEDTASK_OFFSET UNITYSDK_OFFSET(0x19E792A0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZESHAREDVARIABLE_1_OFFSET UNITYSDK_OFFSET(0x19E788B0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZESHAREDVARIABLE_OFFSET UNITYSDK_OFFSET(0x19E786C0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZETASK_OFFSET UNITYSDK_OFFSET(0x19E77630)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDDESERIALIZEVARIABLES_OFFSET UNITYSDK_OFFSET(0x19E770F0)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_1_OFFSET UNITYSDK_OFFSET(0x19E78280)
#define BEHAVIORDESIGNER_RUNTIME_JSONDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_OFFSET UNITYSDK_OFFSET(0x19E72C20)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int JSONDeserialization_PrecompiledDeserialization_TypeDefinitionIndex = 30213;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::BehaviorDesigner::Runtime::TaskFieldAssigner>**)Il2CppClass::FromTypeDefinitionIndex(JSONDeserialization_PrecompiledDeserialization_TypeDefinitionIndex)->GetStaticField(0x234F0);
		}
