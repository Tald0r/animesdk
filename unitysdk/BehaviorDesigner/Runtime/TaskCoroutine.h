...
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE_GET_COROUTINE_OFFSET UNITYSDK_OFFSET(0x1AA04670)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE_RUNCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1AA04760)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE_STOP_OFFSET UNITYSDK_OFFSET(0x1AA04680)
#define BEHAVIORDESIGNER_RUNTIME_TASKCOROUTINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA046C0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int TaskCoroutine_TypeDefinitionIndex = 30234;
