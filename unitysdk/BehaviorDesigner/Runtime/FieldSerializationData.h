...
#define BEHAVIORDESIGNER_RUNTIME_FIELDSERIALIZATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19E76CB0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int FieldSerializationData_TypeDefinitionIndex = 30231;
