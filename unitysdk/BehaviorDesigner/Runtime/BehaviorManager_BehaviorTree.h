...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_GET_CURRENTNONPARENTTASKINDEX_OFFSET UNITYSDK_OFFSET(0x1B2872F0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_GET_CURRENTNONPARENTTASK_OFFSET UNITYSDK_OFFSET(0x1B287330)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_GET_LASTNONPARENTTASKINFO_INDEX_OFFSET UNITYSDK_OFFSET(0x1B2873F0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_GET_LASTNONPARENTTASKINFO_NAME_OFFSET UNITYSDK_OFFSET(0x1B2873D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_GET_LASTNONPARENTTASKSTATUS_OFFSET UNITYSDK_OFFSET(0x1B2873B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_GET_LASTNONPARENTTASK_OFFSET UNITYSDK_OFFSET(0x1B287310)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B287410)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_SET_CURRENTNONPARENTTASKINDEX_OFFSET UNITYSDK_OFFSET(0x1B287300)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_SET_CURRENTNONPARENTTASK_OFFSET UNITYSDK_OFFSET(0x1B287340)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_SET_LASTNONPARENTTASKINFO_INDEX_OFFSET UNITYSDK_OFFSET(0x1B287400)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_SET_LASTNONPARENTTASKINFO_NAME_OFFSET UNITYSDK_OFFSET(0x1B2873E0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_SET_LASTNONPARENTTASKSTATUS_OFFSET UNITYSDK_OFFSET(0x1B2873C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE_SET_LASTNONPARENTTASK_OFFSET UNITYSDK_OFFSET(0x1B287320)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2878D0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_BehaviorTree_TypeDefinitionIndex = 31144;

	class BehaviorManager_BehaviorTree : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::Collections::Generic::Stack_1<::System::Int32>*>* activeStack; // 0x10
		::System::Collections::Generic::List_1<::BehaviorDesigner::Runtime::Tasks::TaskStatus>* interruptionTaskStatus; // 0x18
		::BehaviorDesigner::Runtime::Behavior* behavior; // 0x20
		::System::Collections::Generic::List_1<::System::Int32>* parentCompositeIndex; // 0x28
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::System::Int32>*>* childrenIndex; // 0x30
		::System::Collections::Generic::List_1<::BehaviorDesigner::Runtime::Tasks::Task*>* taskList; // 0x38
		::System::String* errorState; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::BehaviorDesigner::Runtime::BehaviorManager_BehaviorTree_ConditionalReevaluate*>* conditionalReevaluateMap; // 0x48
		::System::Collections::Generic::List_1<::BehaviorDesigner::Runtime::BehaviorManager_BehaviorTree_ConditionalReevaluate*>* conditionalReevaluate; // 0x50
		::BehaviorDesigner::Runtime::Tasks::Task* _currentNonParentTask; // 0x58
		::System::Collections::Generic::List_1<::System::Int32>* parentIndex; // 0x60
		::System::String* _LastNonParentTaskInfo_Name_k__BackingField; // 0x68
		::System::Collections::Generic::List_1<::System::Int32>* parentReevaluate; // 0x70
		::System::Collections::Generic::List_1<::System::Int32>* relativeChildIndex; // 0x78
		::System::Collections::Generic::List_1<::System::Int32>* interruptionIndex; // 0x80
		::BehaviorDesigner::Runtime::Tasks::Task* _lastNonParentTask_k__BackingField; // 0x88
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::System::Int32>*>* childConditionalIndex; // 0x90
		::System::Collections::Generic::List_1<::BehaviorDesigner::Runtime::Tasks::TaskStatus>* nonInstantTaskStatus; // 0x98
		::System::Int32 stepTag; // 0xA0
		::System::Int32 _currentNonParentTaskIndex_k__BackingField; // 0xA4
		::System::Boolean destroyBehavior; // 0xA8
		::BehaviorDesigner::Runtime::Tasks::TaskStatus _LastNonParentTaskStatus_k__BackingField; // 0xAC
		::System::Int32 executionCount; // 0xB0
