...
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVECTOR3INT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AC6E8A0)
#define BEHAVIORDESIGNER_RUNTIME_SHAREDVECTOR3INT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC6E960)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int SharedVector3Int_TypeDefinitionIndex = 30268;
