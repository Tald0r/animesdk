...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER_CREATTASKWORK_OFFSET UNITYSDK_OFFSET(0x19E714A0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19E71200)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER_FOREGROUNDTICK_OFFSET UNITYSDK_OFFSET(0x19E71590)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER_GET_DEBUGCURPENDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x19E71280)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER_GET_DEBUGCURWORKINGTHREADCOUNT_OFFSET UNITYSDK_OFFSET(0x19E71270)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER_GET_DEBUGISVALIDTASK_OFFSET UNITYSDK_OFFSET(0x19E71290)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER_GET_PENDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x19E712A0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER_PREPARESUBTREELOADINGREQUEST_OFFSET UNITYSDK_OFFSET(0x19E71F50)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER_PUSHLOADINGREQUEST_OFFSET UNITYSDK_OFFSET(0x19E712D0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E726C0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E710B0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER__NOTIFYONELOADITEM_OFFSET UNITYSDK_OFFSET(0x19E71DB0)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER__TASKPROCESSIMPL_OFFSET UNITYSDK_OFFSET(0x19E72130)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORASYNCLOADMANAGER__TASKPROCESS_OFFSET UNITYSDK_OFFSET(0x19E72040)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_BehaviorAsyncLoadManager_TypeDefinitionIndex = 30185;
	...
	public:
		...
		{
			return (::BehaviorDesigner::Runtime::BehaviorManager_BehaviorAsyncLoadManager**)Il2CppClass::FromTypeDefinitionIndex(BehaviorManager_BehaviorAsyncLoadManager_TypeDefinitionIndex)->GetStaticField(0x23600);
		}
		static ::System::Int32* StaticGet_s_SharedWorkerCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BehaviorManager_BehaviorAsyncLoadManager_TypeDefinitionIndex)->GetStaticField(0x7950);
		}
		...
		::System::Text::StringBuilder* errorWriteInfo; // 0x30
		::System::Threading::Tasks::Task* processTask; // 0x38
		::BehaviorDesigner::Runtime::BehaviorManager_BehaviorAsyncLoadItem* _lastItem; // 0x40
		::System::Collections::Concurrent::ConcurrentQueue_1<::BehaviorDesigner::Runtime::BehaviorManager_BehaviorAsyncLoadItem*>* _subTreeQueue; // 0x48
		...
		::System::Int32 _curWorkingThreadCount; // 0x58
		::System::Int32 _curPendingCount; // 0x5C
		::System::Boolean _isValidTask; // 0x60
		::System::Single _foregroundTime; // 0x64
