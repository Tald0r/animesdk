...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A659F10)
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER___C__DISPLAYCLASS1_0__TRYLOADBEHAVIOR_B__0_OFFSET UNITYSDK_OFFSET(0x1A659F20)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager___c__DisplayClass1_0_TypeDefinitionIndex = 30198;
