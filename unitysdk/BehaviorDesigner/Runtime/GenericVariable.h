...
#define BEHAVIORDESIGNER_RUNTIME_GENERICVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A49AC30)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int GenericVariable_TypeDefinitionIndex = 31202;
