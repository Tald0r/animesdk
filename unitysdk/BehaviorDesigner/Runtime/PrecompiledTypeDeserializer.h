...
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1AFF16D0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOBOOL_OFFSET UNITYSDK_OFFSET(0x1AFF05B0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOBYTE_OFFSET UNITYSDK_OFFSET(0x1AFF0980)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1AFF09F0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTODOUBLE_OFFSET UNITYSDK_OFFSET(0x1AFF03F0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOFLOAT_OFFSET UNITYSDK_OFFSET(0x1AFF02E0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOINT_OFFSET UNITYSDK_OFFSET(0x1AFEFF00)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1AFF1910)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOLONG_OFFSET UNITYSDK_OFFSET(0x1AFF0500)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOMATRIX4X4_OFFSET UNITYSDK_OFFSET(0x1AFF1370)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOQUATERNION_OFFSET UNITYSDK_OFFSET(0x1AFF10F0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTORECT_OFFSET UNITYSDK_OFFSET(0x1AFF1240)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOSTRING_OFFSET UNITYSDK_OFFSET(0x1AFF0600)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOUINT_OFFSET UNITYSDK_OFFSET(0x1AFEFFE0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOULONG_OFFSET UNITYSDK_OFFSET(0x1AFF00F0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOUSHORT_OFFSET UNITYSDK_OFFSET(0x1AFF0200)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR2INT_OFFSET UNITYSDK_OFFSET(0x1AFF0C50)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR2_OFFSET UNITYSDK_OFFSET(0x1AFF0B40)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR3INT_OFFSET UNITYSDK_OFFSET(0x1AFF0E80)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1AFF0D40)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR4_OFFSET UNITYSDK_OFFSET(0x1AFF0FA0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_CRC32_OFFSET UNITYSDK_OFFSET(0x1AFF0830)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_GETFIELDSIZE_OFFSET UNITYSDK_OFFSET(0x1AFEFE60)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_GET_CRCTABLE_OFFSET UNITYSDK_OFFSET(0x1AFEFC10)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_INDEXTOUNITYOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1AFF3F80)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_INDEXTOUNITYOBJECT_OFFSET UNITYSDK_OFFSET(0x1AFF19D0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGHASH_OFFSET UNITYSDK_OFFSET(0x1AFEFC40)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1AFF30D0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOMATRIX4X4_OFFSET UNITYSDK_OFFSET(0x1AFF2A60)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOQUATERNION_OFFSET UNITYSDK_OFFSET(0x1AFF2830)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTORECT_OFFSET UNITYSDK_OFFSET(0x1AFF3310)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR2INT_OFFSET UNITYSDK_OFFSET(0x1AFF20C0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR2_OFFSET UNITYSDK_OFFSET(0x1AFF1F40)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR3INT_OFFSET UNITYSDK_OFFSET(0x1AFF2420)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1AFF2230)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR4_OFFSET UNITYSDK_OFFSET(0x1AFF25F0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_TRYGETFIELDINDEX_1_OFFSET UNITYSDK_OFFSET(0x1AFF1CD0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_TRYGETFIELDINDEX_OFFSET UNITYSDK_OFFSET(0x1AFF1A50)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_VALUETOANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1AFF3620)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_VALUETOLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1AFF35E0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFF4000)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFF3FF0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int PrecompiledTypeDeserializer_TypeDefinitionIndex = 31174;
	...
	public:
		...
		{
			return (::BehaviorDesigner::Runtime::PrecompiledTypeDeserializer_WrongVersionException**)Il2CppClass::FromTypeDefinitionIndex(PrecompiledTypeDeserializer_TypeDefinitionIndex)->GetStaticField(0x24F80);
		}
