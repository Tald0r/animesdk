...
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1AA019A0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOBOOL_OFFSET UNITYSDK_OFFSET(0x1AA00880)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOBYTE_OFFSET UNITYSDK_OFFSET(0x1AA00C50)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1AA00CC0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTODOUBLE_OFFSET UNITYSDK_OFFSET(0x1AA006C0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOFLOAT_OFFSET UNITYSDK_OFFSET(0x1AA005B0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOINT_OFFSET UNITYSDK_OFFSET(0x1AA001D0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1AA01BE0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOLONG_OFFSET UNITYSDK_OFFSET(0x1AA007D0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOMATRIX4X4_OFFSET UNITYSDK_OFFSET(0x1AA01640)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOQUATERNION_OFFSET UNITYSDK_OFFSET(0x1AA013C0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTORECT_OFFSET UNITYSDK_OFFSET(0x1AA01510)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOSTRING_OFFSET UNITYSDK_OFFSET(0x1AA008D0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOUINT_OFFSET UNITYSDK_OFFSET(0x1AA002B0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOULONG_OFFSET UNITYSDK_OFFSET(0x1AA003C0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOUSHORT_OFFSET UNITYSDK_OFFSET(0x1AA004D0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR2INT_OFFSET UNITYSDK_OFFSET(0x1AA00F20)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR2_OFFSET UNITYSDK_OFFSET(0x1AA00E10)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR3INT_OFFSET UNITYSDK_OFFSET(0x1AA01150)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1AA01010)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_BYTESTOVECTOR4_OFFSET UNITYSDK_OFFSET(0x1AA01270)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_CRC32_OFFSET UNITYSDK_OFFSET(0x1AA00B00)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_GETFIELDSIZE_OFFSET UNITYSDK_OFFSET(0x1AA00130)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_GET_CRCTABLE_OFFSET UNITYSDK_OFFSET(0x1A9FFEE0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_INDEXTOUNITYOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1AA04260)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_INDEXTOUNITYOBJECT_OFFSET UNITYSDK_OFFSET(0x1AA01CA0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGHASH_OFFSET UNITYSDK_OFFSET(0x1A9FFF10)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1AA033A0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOMATRIX4X4_OFFSET UNITYSDK_OFFSET(0x1AA02D30)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOQUATERNION_OFFSET UNITYSDK_OFFSET(0x1AA02B00)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTORECT_OFFSET UNITYSDK_OFFSET(0x1AA035E0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR2INT_OFFSET UNITYSDK_OFFSET(0x1AA02390)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR2_OFFSET UNITYSDK_OFFSET(0x1AA02210)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR3INT_OFFSET UNITYSDK_OFFSET(0x1AA026F0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1AA02500)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_STRINGTOVECTOR4_OFFSET UNITYSDK_OFFSET(0x1AA028C0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_TRYGETFIELDINDEX_1_OFFSET UNITYSDK_OFFSET(0x1AA01FA0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_TRYGETFIELDINDEX_OFFSET UNITYSDK_OFFSET(0x1AA01D20)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_VALUETOANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1AA038F0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER_VALUETOLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1AA038B0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA042E0)
#define BEHAVIORDESIGNER_RUNTIME_PRECOMPILEDTYPEDESERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA042D0)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int PrecompiledTypeDeserializer_TypeDefinitionIndex = 30221;
	...
	public:
		...
		{
			return (::BehaviorDesigner::Runtime::PrecompiledTypeDeserializer_WrongVersionException**)Il2CppClass::FromTypeDefinitionIndex(PrecompiledTypeDeserializer_TypeDefinitionIndex)->GetStaticField(0x23660);
		}
