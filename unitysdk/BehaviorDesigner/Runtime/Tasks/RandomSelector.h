...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B289620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1B2895D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1B289350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B289680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1B2896F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR_ONEND_OFFSET UNITYSDK_OFFSET(0x1B289760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B2897C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B289410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR_SHUFFLECHILDEN_OFFSET UNITYSDK_OFFSET(0x1B289460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B289810)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B2898D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1B289960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1B2899F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B289A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1B289B10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B289BA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B289C30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSELECTOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B289CC0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int RandomSelector_TypeDefinitionIndex = 31273;
