...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETBOOLLIST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA04960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETBOOLLIST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA047E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETBOOLLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA04A50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETBOOLLIST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA04A90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETBOOLLIST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA04B20)

namespace BehaviorDesigner::Runtime::Tasks::Basic::Math
{
	inline static constexpr unsigned int SetBoolList_TypeDefinitionIndex = 30350;
