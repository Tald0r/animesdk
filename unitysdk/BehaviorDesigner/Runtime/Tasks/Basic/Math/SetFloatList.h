...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A100940)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A1007D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A100A40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A100A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A100B10)

namespace BehaviorDesigner::Runtime::Tasks::Basic::Math
{
	inline static constexpr unsigned int SetFloatList_TypeDefinitionIndex = 31303;
