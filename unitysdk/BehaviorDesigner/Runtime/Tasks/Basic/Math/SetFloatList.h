...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B58500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B58390)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19B58600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B58640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETFLOATLIST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B586D0)

namespace BehaviorDesigner::Runtime::Tasks::Basic::Math
{
	inline static constexpr unsigned int SetFloatList_TypeDefinitionIndex = 30351;
