...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETINTLIST_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B588D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETINTLIST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B58760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETINTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19B589C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETINTLIST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B58A00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_MATH_SETINTLIST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B58A90)

namespace BehaviorDesigner::Runtime::Tasks::Basic::Math
{
	inline static constexpr unsigned int SetIntList_TypeDefinitionIndex = 30352;
