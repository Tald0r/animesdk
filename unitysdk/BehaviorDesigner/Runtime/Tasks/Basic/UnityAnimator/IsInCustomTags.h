...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xAD9F4C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS_ONRESET_OFFSET UNITYSDK_OFFSET(0xAD9F6C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xAD9F600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS__CTOR_OFFSET UNITYSDK_OFFSET(0xAD9F720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xAD9F760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0xAD9F7F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xAD9F880)

namespace BehaviorDesigner::Runtime::Tasks::Basic::UnityAnimator
{
	inline static constexpr unsigned int IsInCustomTags_TypeDefinitionIndex = 52362;
