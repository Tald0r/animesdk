...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xBD073C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS_ONRESET_OFFSET UNITYSDK_OFFSET(0xBD075B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xBD074F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS__CTOR_OFFSET UNITYSDK_OFFSET(0xBD07610)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xBD07650)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0xBD076E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINCUSTOMTAGS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xBD07770)

namespace BehaviorDesigner::Runtime::Tasks::Basic::UnityAnimator
{
	inline static constexpr unsigned int IsInCustomTags_TypeDefinitionIndex = 41806;
