...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINZONETAGS_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xBC76B60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINZONETAGS_ONRESET_OFFSET UNITYSDK_OFFSET(0xBC771A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINZONETAGS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xBC76CA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINZONETAGS__CTOR_OFFSET UNITYSDK_OFFSET(0xBC77200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINZONETAGS___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xBC77240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINZONETAGS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0xBC772D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BASIC_UNITYANIMATOR_ISINZONETAGS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xBC77360)

namespace BehaviorDesigner::Runtime::Tasks::Basic::UnityAnimator
{
	inline static constexpr unsigned int IsInZoneTags_TypeDefinitionIndex = 43513;
