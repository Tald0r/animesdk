...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x19E7D220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT_DOINTERRUPT_OFFSET UNITYSDK_OFFSET(0x19E7D2C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x19E7D270)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT_ONEND_OFFSET UNITYSDK_OFFSET(0x19E7D3E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x19E7D3A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E7D430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x19E7D480)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x19E7D510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x19E7D5A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x19E7D630)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Interrupt_TypeDefinitionIndex = 30336;
