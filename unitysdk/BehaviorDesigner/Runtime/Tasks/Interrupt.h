...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A4A1040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT_DOINTERRUPT_OFFSET UNITYSDK_OFFSET(0x1A4A10E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1A4A1090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT_ONEND_OFFSET UNITYSDK_OFFSET(0x1A4A1200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1A4A11C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A1250)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A4A12A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1A4A1330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1A4A13C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INTERRUPT___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1A4A1450)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Interrupt_TypeDefinitionIndex = 31288;
