...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_IDLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A8619A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_IDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8619F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_IDLE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A861A30)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Idle_TypeDefinitionIndex = 31256;
