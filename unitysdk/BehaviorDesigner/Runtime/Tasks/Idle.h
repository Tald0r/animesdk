...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_IDLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A4060)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_IDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A40B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_IDLE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A40F0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Idle_TypeDefinitionIndex = 30304;
