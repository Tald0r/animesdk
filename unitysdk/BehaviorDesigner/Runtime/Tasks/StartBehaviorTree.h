...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_BEHAVIORENDED_OFFSET UNITYSDK_OFFSET(0x1AC8C4A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC8C4F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC8C6C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC8BE70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC8C350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC8C890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC8C9A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC8CA30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC8CAC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC8CB50)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int StartBehaviorTree_TypeDefinitionIndex = 31266;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedBool* waitForCompletion; // 0x68
