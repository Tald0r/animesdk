...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_BEHAVIORENDED_OFFSET UNITYSDK_OFFSET(0x1A6E1280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_ONEND_OFFSET UNITYSDK_OFFSET(0x1A6E12D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E14A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E0C50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E1130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E1670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1A6E1780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E1810)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E18A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_STARTBEHAVIORTREE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E1930)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int StartBehaviorTree_TypeDefinitionIndex = 30314;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedBool* waitForCompletion; // 0x78
