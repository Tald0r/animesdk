...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AD15270)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AD151F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1AD15230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1AD15110)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AD152D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1AD15170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1AD153E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_ONEND_OFFSET UNITYSDK_OFFSET(0x1AD15460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1AD15350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD154D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AD15510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AD15590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1AD15610)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1AD15690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AD15720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1AD157C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1AD15860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AD15900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1AD15990)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Parallel_TypeDefinitionIndex = 30317;
