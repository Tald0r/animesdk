...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B32F7F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B32F770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1B32F7B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1B32F690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B32F850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1B32F6F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1B32F960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_ONEND_OFFSET UNITYSDK_OFFSET(0x1B32F9E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1B32F8D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B32FA50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B32FA90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B32FB10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1B32FB90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1B32FC10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B32FCA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1B32FD40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1B32FDE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B32FE80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLEL___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1B32FF10)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Parallel_TypeDefinitionIndex = 31269;
