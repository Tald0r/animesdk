...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1B2888D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_ONEND_OFFSET UNITYSDK_OFFSET(0x1B288890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B288AC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B288840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B2887D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1B288B20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1B288B70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B288C00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B288C90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B288D20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B288DB0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasExitedCollision2D_TypeDefinitionIndex = 31233;
