...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1AC6F340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC6F300)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC6F530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC6F2B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1AC6F240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC6F590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1AC6F5E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC6F670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC6F700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC6F790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION2D___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1AC6F820)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasExitedCollision2D_TypeDefinitionIndex = 30281;
