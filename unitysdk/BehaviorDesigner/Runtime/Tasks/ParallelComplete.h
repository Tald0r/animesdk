...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AFF5D30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AFF5CB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1AFF5CF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1AFF5BD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AFF5D90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1AFF5C30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1AFF5E10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AFF5F30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1AFF5E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFF5FA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AFF5FE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AFF6070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1AFF6100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1AFF6190)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AFF6220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1AFF62C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1AFF6350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AFF63E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1AFF6470)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int ParallelComplete_TypeDefinitionIndex = 31270;
