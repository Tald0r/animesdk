...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AA06010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AA05F90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1AA05FD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1AA05EB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AA06070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1AA05F10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1AA060F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AA06210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1AA06170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA06280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AA062C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AA06350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1AA063E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1AA06470)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AA06500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1AA065A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1AA06630)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AA066C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PARALLELCOMPLETE___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1AA06750)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int ParallelComplete_TypeDefinitionIndex = 30318;
