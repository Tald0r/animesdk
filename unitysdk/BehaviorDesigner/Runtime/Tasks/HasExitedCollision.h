...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x1A4A0AE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION_ONEND_OFFSET UNITYSDK_OFFSET(0x1A4A0AA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A0CD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A0A50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1A4A09E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A0D20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION___BASE_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x1A4A0D70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1A4A0E00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A0E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A0F20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDCOLLISION___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1A4A0FB0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasExitedCollision_TypeDefinitionIndex = 31232;
