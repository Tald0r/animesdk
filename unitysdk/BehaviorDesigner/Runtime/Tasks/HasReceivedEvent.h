...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_ONBEHAVIORCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1AA05800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_ONEND_OFFSET UNITYSDK_OFFSET(0x1AA04F40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA05B40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA04BB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA04EF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_RECEIVEDEVENT_1_OFFSET UNITYSDK_OFFSET(0x1AA052D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_RECEIVEDEVENT_2_OFFSET UNITYSDK_OFFSET(0x1AA053F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_RECEIVEDEVENT_3_OFFSET UNITYSDK_OFFSET(0x1AA055B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT_RECEIVEDEVENT_OFFSET UNITYSDK_OFFSET(0x1AA05290)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA05B90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT___BASE_ONBEHAVIORCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1AA05BE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AA05C70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA05D00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA05D90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASRECEIVEDEVENT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA05E20)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasReceivedEvent_TypeDefinitionIndex = 30329;
