...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNKNOWNPARENTTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B26B3D0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int UnknownParentTask_TypeDefinitionIndex = 31300;
