...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AC06F10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR_CANREEVALUATE_OFFSET UNITYSDK_OFFSET(0x1AC07160)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AC07120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1AC06E80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AC06F90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1AC06EC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1AC07030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC07080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR_ONREEVALUATIONENDED_OFFSET UNITYSDK_OFFSET(0x1AC07200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR_ONREEVALUATIONSTARTED_OFFSET UNITYSDK_OFFSET(0x1AC071A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1AC070D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC072E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AC07330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR___BASE_CANREEVALUATE_OFFSET UNITYSDK_OFFSET(0x1AC073C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR___BASE_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AC07450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1AC074E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AC07570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR___BASE_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1AC07610)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1AC076A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC07730)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR___BASE_ONREEVALUATIONENDED_OFFSET UNITYSDK_OFFSET(0x1AC077C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR___BASE_ONREEVALUATIONSTARTED_OFFSET UNITYSDK_OFFSET(0x1AC07850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SELECTOREVALUATOR___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1AC078E0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int SelectorEvaluator_TypeDefinitionIndex = 31276;
	...
	public:
		...
		::BehaviorDesigner::Runtime::Tasks::TaskStatus storedExecutionStatus; // 0x6C
