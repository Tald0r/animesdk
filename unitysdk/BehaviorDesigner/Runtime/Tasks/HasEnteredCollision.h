...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x1B288260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION_ONEND_OFFSET UNITYSDK_OFFSET(0x1B288220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B288450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B2881D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B288160)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2884B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION___BASE_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x1B288500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B288590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B288620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B2886B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B288740)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasEnteredCollision_TypeDefinitionIndex = 31228;
