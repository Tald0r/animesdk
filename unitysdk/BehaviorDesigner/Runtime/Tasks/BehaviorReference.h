...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BEHAVIORREFERENCE_GETEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0x1A65A800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BEHAVIORREFERENCE_ONPREPAREEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0x1A65A6E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BEHAVIORREFERENCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A65A840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BEHAVIORREFERENCE_VERIFY_OFFSET UNITYSDK_OFFSET(0x1A65A720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BEHAVIORREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65A890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BEHAVIORREFERENCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A65A8D0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int BehaviorReference_TypeDefinitionIndex = 30302;
