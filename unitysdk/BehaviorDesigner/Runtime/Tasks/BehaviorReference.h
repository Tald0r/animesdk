...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BEHAVIORREFERENCE_GETEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0x1AC05AA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BEHAVIORREFERENCE_ONPREPAREEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0x1AC05980)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BEHAVIORREFERENCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC05AE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BEHAVIORREFERENCE_VERIFY_OFFSET UNITYSDK_OFFSET(0x1AC059C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BEHAVIORREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC05B30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_BEHAVIORREFERENCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC05B70)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int BehaviorReference_TypeDefinitionIndex = 31254;
	...
	public:
		...
		::Il2CppArray<::BehaviorDesigner::Runtime::ExternalBehavior*>* externalBehaviors; // 0x60
