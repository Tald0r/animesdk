...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A62BB20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1A62BAD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1A62B850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1A62BB80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1A62BBF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE_ONEND_OFFSET UNITYSDK_OFFSET(0x1A62BC60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A62BCC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A62B910)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE_SHUFFLECHILDEN_OFFSET UNITYSDK_OFFSET(0x1A62B960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A62BD10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A62BDD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1A62BE60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1A62BEF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1A62BF80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1A62C010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1A62C0A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A62C130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMSEQUENCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A62C1C0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int RandomSequence_TypeDefinitionIndex = 30322;
