...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILFAILURE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A637950)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILFAILURE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1A6379A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILFAILURE_ONEND_OFFSET UNITYSDK_OFFSET(0x1A6379F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILFAILURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A637A40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILFAILURE___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A637A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILFAILURE___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1A637B10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILFAILURE___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1A637BA0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int UntilFailure_TypeDefinitionIndex = 30342;
