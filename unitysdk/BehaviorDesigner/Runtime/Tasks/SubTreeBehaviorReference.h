...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC07B50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC079C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC07A20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE_SETLINKSUBBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1AC07970)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC07BB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC07BF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC07C80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SUBTREEBEHAVIORREFERENCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC07D10)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int SubTreeBehaviorReference_TypeDefinitionIndex = 31297;

	class SubTreeBehaviorReference : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::System::String* SubTreeName; // 0x58
		::BehaviorDesigner::Runtime::Behavior* linkedSubBehavior; // 0x60
		::BehaviorDesigner::Runtime::ExternalBehavior* externalBehavior; // 0x68
