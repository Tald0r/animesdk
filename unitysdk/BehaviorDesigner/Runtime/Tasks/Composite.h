...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COMPOSITE_GET_ABORTTYPE_OFFSET UNITYSDK_OFFSET(0x19B58B40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COMPOSITE_GET_PROXYABORTTYPE_OFFSET UNITYSDK_OFFSET(0x19B58B20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COMPOSITE_ONREEVALUATIONENDED_OFFSET UNITYSDK_OFFSET(0x19B58B90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COMPOSITE_ONREEVALUATIONSTARTED_OFFSET UNITYSDK_OFFSET(0x19B58B50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COMPOSITE_SET_PROXYABORTTYPE_OFFSET UNITYSDK_OFFSET(0x19B58B30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B58BE0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Composite_TypeDefinitionIndex = 30273;
