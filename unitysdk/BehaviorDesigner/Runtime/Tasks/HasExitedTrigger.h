...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER_ONEND_OFFSET UNITYSDK_OFFSET(0x1AE2C640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE2C870)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1AE2C680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE2C5F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1AE2C580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE2C8D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AE2C920)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE2C9B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER___BASE_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1AE2CA40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE2CAD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1AE2CB60)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasExitedTrigger_TypeDefinitionIndex = 30282;
