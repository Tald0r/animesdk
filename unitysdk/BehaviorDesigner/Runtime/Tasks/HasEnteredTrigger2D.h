...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER2D_ONEND_OFFSET UNITYSDK_OFFSET(0x1B232FF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER2D_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B233220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER2D_ONTRIGGERENTER2D_OFFSET UNITYSDK_OFFSET(0x1B233030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER2D_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B232FA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER2D_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B232F30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1B233280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER2D___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B2332D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER2D___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B233360)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER2D___BASE_ONTRIGGERENTER2D_OFFSET UNITYSDK_OFFSET(0x1B2333F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER2D___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B233480)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER2D___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B233510)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasEnteredTrigger2D_TypeDefinitionIndex = 31231;
