...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A4A14E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE_DECORATE_OFFSET UNITYSDK_OFFSET(0x1A4A1580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1A4A1530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE_ONEND_OFFSET UNITYSDK_OFFSET(0x1A4A15D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A1620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A4A1660)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE___BASE_DECORATE_OFFSET UNITYSDK_OFFSET(0x1A4A16F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1A4A1780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1A4A1810)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int ReturnFailure_TypeDefinitionIndex = 31291;
