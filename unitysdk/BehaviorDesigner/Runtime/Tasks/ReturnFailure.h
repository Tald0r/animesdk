...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x19E7D6C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE_DECORATE_OFFSET UNITYSDK_OFFSET(0x19E7D760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x19E7D710)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE_ONEND_OFFSET UNITYSDK_OFFSET(0x19E7D7B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E7D800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x19E7D840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE___BASE_DECORATE_OFFSET UNITYSDK_OFFSET(0x19E7D8D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x19E7D960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNFAILURE___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x19E7D9F0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int ReturnFailure_TypeDefinitionIndex = 30339;
