...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_DECORATOR_MAXCHILDREN_OFFSET UNITYSDK_OFFSET(0x1A101060)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_DECORATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1010B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_DECORATOR___BASE_MAXCHILDREN_OFFSET UNITYSDK_OFFSET(0x1A1010F0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Decorator_TypeDefinitionIndex = 31287;
