...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_DRAWSTATUSINFO_OFFSET UNITYSDK_OFFSET(0x1AC28D80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_GET_DISABLED_OFFSET UNITYSDK_OFFSET(0x1AC28D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_GET_EXECUTIONSTATUS_OFFSET UNITYSDK_OFFSET(0x1AC28D60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_GET_FRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1AC28D20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_GET_PROXYFRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1AC28D00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_SET_DISABLED_OFFSET UNITYSDK_OFFSET(0x1AC28D50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_SET_EXECUTIONSTATUS_OFFSET UNITYSDK_OFFSET(0x1AC28D70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_SET_FRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1AC28D30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK_SET_PROXYFRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1AC28D10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SERVICES_SUBTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC28DD0)

namespace BehaviorDesigner::Runtime::Tasks::Services
{
	inline static constexpr unsigned int SubTask_TypeDefinitionIndex = 30815;
