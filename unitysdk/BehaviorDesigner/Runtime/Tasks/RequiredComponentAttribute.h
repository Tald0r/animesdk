...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REQUIREDCOMPONENTATTRIBUTE_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1AD160B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REQUIREDCOMPONENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD160C0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int RequiredComponentAttribute_TypeDefinitionIndex = 30299;
