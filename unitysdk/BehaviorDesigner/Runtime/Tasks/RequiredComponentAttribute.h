...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REQUIREDCOMPONENTATTRIBUTE_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B330630)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REQUIREDCOMPONENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B330640)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int RequiredComponentAttribute_TypeDefinitionIndex = 31251;
