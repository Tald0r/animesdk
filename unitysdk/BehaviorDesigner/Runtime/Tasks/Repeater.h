...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AC093C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AC09580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC095D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC09620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC09760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AC09820)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AC098B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC09940)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC099D0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Repeater_TypeDefinitionIndex = 30338;
