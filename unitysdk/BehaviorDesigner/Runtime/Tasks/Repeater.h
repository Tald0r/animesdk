...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B21DB90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B21DD50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER_ONEND_OFFSET UNITYSDK_OFFSET(0x1B21DDA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B21DDF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21DF30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B21DFF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B21E080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B21E110)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_REPEATER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B21E1A0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Repeater_TypeDefinitionIndex = 31290;

	class Repeater : public ::BehaviorDesigner::Runtime::Tasks::Decorator
	{
	public:
		::BehaviorDesigner::Runtime::SharedInt* count; // 0x58
