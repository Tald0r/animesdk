...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AC05D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR_CANREEVALUATE_OFFSET UNITYSDK_OFFSET(0x1AC05E80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1AC05C00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AC05F10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR_ONDRAWNODETEXT_OFFSET UNITYSDK_OFFSET(0x1AC06070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC06000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC06100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC05CE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC05E10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR_OVERRIDESTATUS_1_OFFSET UNITYSDK_OFFSET(0x1AC05FB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1AC05F60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC06150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AC06190)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR___BASE_CANREEVALUATE_OFFSET UNITYSDK_OFFSET(0x1AC06220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1AC062B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AC06340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR___BASE_ONDRAWNODETEXT_OFFSET UNITYSDK_OFFSET(0x1AC063D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC06460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC064F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC06580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC06610)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR___BASE_OVERRIDESTATUS_1_OFFSET UNITYSDK_OFFSET(0x1AC06730)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_CONDITIONALEVALUATOR___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1AC066A0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int ConditionalEvaluator_TypeDefinitionIndex = 31285;
