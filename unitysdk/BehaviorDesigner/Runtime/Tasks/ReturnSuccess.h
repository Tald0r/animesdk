...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x19E7DA80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS_DECORATE_OFFSET UNITYSDK_OFFSET(0x19E7DB20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x19E7DAD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS_ONEND_OFFSET UNITYSDK_OFFSET(0x19E7DB70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x19E7DBC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x19E7DC00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS___BASE_DECORATE_OFFSET UNITYSDK_OFFSET(0x19E7DC90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x19E7DD20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RETURNSUCCESS___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x19E7DDB0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int ReturnSuccess_TypeDefinitionIndex = 30340;
