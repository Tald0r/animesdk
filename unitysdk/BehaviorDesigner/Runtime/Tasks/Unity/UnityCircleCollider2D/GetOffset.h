...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETOFFSET_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFF9FC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETOFFSET_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFF9BD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETOFFSET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFF9DF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFA030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETOFFSET___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFFA070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETOFFSET___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFFA100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETOFFSET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFFA190)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCircleCollider2D
{
	inline static constexpr unsigned int GetOffset_TypeDefinitionIndex = 31652;
