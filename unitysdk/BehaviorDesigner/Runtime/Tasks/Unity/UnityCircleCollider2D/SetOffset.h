...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC75110)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC74CE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC74F00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC75180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC751C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC75250)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC752E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCircleCollider2D
{
	inline static constexpr unsigned int SetOffset_TypeDefinitionIndex = 30702;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector3* offset; // 0x70
