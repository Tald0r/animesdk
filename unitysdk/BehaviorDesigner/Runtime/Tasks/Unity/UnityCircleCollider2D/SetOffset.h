...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B28E690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B28E260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B28E480)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B28E700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B28E740)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B28E7D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETOFFSET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B28E860)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCircleCollider2D
{
	inline static constexpr unsigned int SetOffset_TypeDefinitionIndex = 31654;
