...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC8F670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC8F2B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC8F4D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC8F6C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC8F700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC8F790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC8F820)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCircleCollider2D
{
	inline static constexpr unsigned int GetRadius_TypeDefinitionIndex = 31653;
