...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E4450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E4090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E42B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E44A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E44E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E4570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_GETRADIUS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E4600)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCircleCollider2D
{
	inline static constexpr unsigned int GetRadius_TypeDefinitionIndex = 30701;
