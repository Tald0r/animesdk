...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFFA630)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFFA220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFFA440)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFA680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFFA6C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFFA750)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFFA7E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCircleCollider2D
{
	inline static constexpr unsigned int SetRadius_TypeDefinitionIndex = 31655;
