...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA0A900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA0A4F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA0A710)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA0A950)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA0A990)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA0AA20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCIRCLECOLLIDER2D_SETRADIUS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA0AAB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCircleCollider2D
{
	inline static constexpr unsigned int SetRadius_TypeDefinitionIndex = 30703;
