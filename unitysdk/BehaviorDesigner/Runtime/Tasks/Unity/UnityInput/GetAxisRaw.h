...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXISRAW_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5E290)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXISRAW_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5E0E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXISRAW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B5E300)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXISRAW___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5E340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXISRAW___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5E3D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int GetAxisRaw_TypeDefinitionIndex = 30668;
