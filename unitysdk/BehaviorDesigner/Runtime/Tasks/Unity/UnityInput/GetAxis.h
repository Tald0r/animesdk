...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXIS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE30E50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXIS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE30CA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE30EC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXIS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE30F00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETAXIS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE30F90)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int GetAxis_TypeDefinitionIndex = 30667;
