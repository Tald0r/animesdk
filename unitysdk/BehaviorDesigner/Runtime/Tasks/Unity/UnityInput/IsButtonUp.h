...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISBUTTONUP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BEBA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISBUTTONUP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BEB00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISBUTTONUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BEC10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISBUTTONUP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BEC50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISBUTTONUP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BEC90)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int IsButtonUp_TypeDefinitionIndex = 31626;
