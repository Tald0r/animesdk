...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISMOUSEDOWN_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A9620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISMOUSEDOWN_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A9580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISMOUSEDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A96D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISMOUSEDOWN___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A9710)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISMOUSEDOWN___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A97A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int IsMouseDown_TypeDefinitionIndex = 30677;
