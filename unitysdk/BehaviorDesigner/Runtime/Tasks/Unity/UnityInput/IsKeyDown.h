...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYDOWN_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E5030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYDOWN_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E4FE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E5080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYDOWN___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E50C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYDOWN___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E5150)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int IsKeyDown_TypeDefinitionIndex = 30675;
