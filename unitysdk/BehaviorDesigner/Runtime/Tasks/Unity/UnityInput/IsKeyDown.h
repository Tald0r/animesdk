...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYDOWN_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC90250)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYDOWN_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC90200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC902A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYDOWN___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC902E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISKEYDOWN___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC90370)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int IsKeyDown_TypeDefinitionIndex = 31627;
