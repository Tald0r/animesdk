...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E4E20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E4D80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E4E80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E4EC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E4F50)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int GetMousePosition_TypeDefinitionIndex = 30672;
