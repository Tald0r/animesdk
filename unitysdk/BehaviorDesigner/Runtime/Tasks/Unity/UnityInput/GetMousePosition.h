...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC90040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC8FFA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC900A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC900E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC90170)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int GetMousePosition_TypeDefinitionIndex = 31624;
