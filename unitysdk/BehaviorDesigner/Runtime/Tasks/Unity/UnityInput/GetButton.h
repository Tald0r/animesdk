...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETBUTTON_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B238D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETBUTTON_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B238C80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x1B238E20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETBUTTON___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B238E60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETBUTTON___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B238EF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int GetButton_TypeDefinitionIndex = 31621;
