...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETACCELERATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC76250)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETACCELERATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC761B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETACCELERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC762B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETACCELERATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC762F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETACCELERATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC76380)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int GetAcceleration_TypeDefinitionIndex = 30666;
