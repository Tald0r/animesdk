...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEBUTTON_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC2DBB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEBUTTON_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC2DAF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC2DCF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEBUTTON___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC2DD30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETMOUSEBUTTON___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC2DDC0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int GetMouseButton_TypeDefinitionIndex = 30671;
