...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISMOUSEUP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A98D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISMOUSEUP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A9830)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISMOUSEUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A9980)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISMOUSEUP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A99C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_ISMOUSEUP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A9A50)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int IsMouseUp_TypeDefinitionIndex = 30678;
