...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BE980)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BE910)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BEA30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BEA70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYINPUT_GETKEY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BEAB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityInput
{
	inline static constexpr unsigned int GetKey_TypeDefinitionIndex = 31622;
