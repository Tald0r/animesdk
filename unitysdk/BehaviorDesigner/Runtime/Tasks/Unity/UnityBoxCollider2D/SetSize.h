...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BD4B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0BD0A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BD2C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BD510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BD550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0BD590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER2D_SETSIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BD5D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityBoxCollider2D
{
	inline static constexpr unsigned int SetSize_TypeDefinitionIndex = 31665;
