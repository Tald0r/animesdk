...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5D8E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B5D4D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5D6F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x19B5D930)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5D970)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B5DA00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSTEPOFFSET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5DA90)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int SetStepOffset_TypeDefinitionIndex = 30813;
