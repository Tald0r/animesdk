...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x1B035FA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONEND_OFFSET UNITYSDK_OFFSET(0x1B035F60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0361B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B035F10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B035EA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B036210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x1B036260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B0362F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B036380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B036410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B0364A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int HasColliderHit_TypeDefinitionIndex = 31752;
