...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x1AA27C30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONEND_OFFSET UNITYSDK_OFFSET(0x1AA27BF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA27E40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA27BA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1AA27B30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA27EA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x1AA27EF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AA27F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA28010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA280A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_HASCOLLIDERHIT___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1AA28130)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int HasColliderHit_TypeDefinitionIndex = 30800;
