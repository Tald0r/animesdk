...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B223D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2239A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B223BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B223D90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B223DD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B223E60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B223EF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int IsGrounded_TypeDefinitionIndex = 31759;
