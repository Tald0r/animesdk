...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0F570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0F1D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0F3F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0F5C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0F600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0F690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_ISGROUNDED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0F720)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int IsGrounded_TypeDefinitionIndex = 30807;
