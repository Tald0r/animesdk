...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSLOPELIMIT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A866840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSLOPELIMIT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A866430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSLOPELIMIT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A866650)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSLOPELIMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A866890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSLOPELIMIT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A8668D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSLOPELIMIT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A866960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETSLOPELIMIT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A8669F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int SetSlopeLimit_TypeDefinitionIndex = 31764;
