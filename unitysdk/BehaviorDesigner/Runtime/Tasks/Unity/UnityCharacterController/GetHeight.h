...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETHEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0E930)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETHEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0E570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETHEIGHT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0E790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETHEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0E980)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETHEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0E9C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETHEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0EA50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETHEIGHT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0EAE0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int GetHeight_TypeDefinitionIndex = 30802;
