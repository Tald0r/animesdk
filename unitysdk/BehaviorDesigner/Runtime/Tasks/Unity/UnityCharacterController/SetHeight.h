...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA095C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA091B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA093D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA09610)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA09650)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA096E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA09770)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int SetHeight_TypeDefinitionIndex = 30810;
