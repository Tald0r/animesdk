...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFF92F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFF8EE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFF9100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFF9340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFF9380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFF9410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_SETHEIGHT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFF94A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int SetHeight_TypeDefinitionIndex = 31762;
