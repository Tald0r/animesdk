...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BE4C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0BE100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BE320)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BE510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BE550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0BE590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BE5D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int GetStepOffset_TypeDefinitionIndex = 31757;
