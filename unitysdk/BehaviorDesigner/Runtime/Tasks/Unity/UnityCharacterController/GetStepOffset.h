...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA66F50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA66B90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA66DB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA66FA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA66FE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA67020)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSTEPOFFSET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA67060)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int GetStepOffset_TypeDefinitionIndex = 30805;
