...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B28E020)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B28DC60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B28DE80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B28E070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B28E0B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B28E140)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B28E1D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int GetSlopeLimit_TypeDefinitionIndex = 31756;
