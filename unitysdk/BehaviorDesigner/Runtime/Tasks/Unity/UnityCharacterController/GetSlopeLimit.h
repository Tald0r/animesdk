...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC74AA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC746E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC74900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC74AF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC74B30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC74BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETSLOPELIMIT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC74C50)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int GetSlopeLimit_TypeDefinitionIndex = 30804;
