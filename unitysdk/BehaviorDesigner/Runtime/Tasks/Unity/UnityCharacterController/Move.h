...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0FBF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0F7B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0F9D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0FC60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0FCA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0FD30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_MOVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0FDC0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int Move_TypeDefinitionIndex = 30808;

	class Move : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedGameObject* targetGameObject; // 0x58
		::BehaviorDesigner::Runtime::SharedVector3* motion; // 0x60
