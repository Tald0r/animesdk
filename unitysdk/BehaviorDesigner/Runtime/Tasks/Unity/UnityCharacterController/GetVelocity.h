...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0EF70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0EB70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0ED90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0EFE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0F020)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0F0B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCHARACTERCONTROLLER_GETVELOCITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0F140)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCharacterController
{
	inline static constexpr unsigned int GetVelocity_TypeDefinitionIndex = 30806;
