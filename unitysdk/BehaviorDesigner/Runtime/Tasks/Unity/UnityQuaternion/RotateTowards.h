...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2D040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2CCB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2D0B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2D0F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2D180)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int RotateTowards_TypeDefinitionIndex = 30555;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedQuaternion* fromQuaternion; // 0x68
		::BehaviorDesigner::Runtime::SharedFloat* maxDeltaDegrees; // 0x70
