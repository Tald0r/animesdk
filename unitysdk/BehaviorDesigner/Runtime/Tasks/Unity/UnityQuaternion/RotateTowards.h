...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B03B3A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B03B010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B03B410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B03B450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ROTATETOWARDS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B03B4E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int RotateTowards_TypeDefinitionIndex = 31507;
