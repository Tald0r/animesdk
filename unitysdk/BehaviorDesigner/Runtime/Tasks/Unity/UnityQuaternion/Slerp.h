...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_SLERP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2D430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_SLERP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2D210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_SLERP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2D4A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_SLERP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2D4E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_SLERP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2D570)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int Slerp_TypeDefinitionIndex = 30556;
