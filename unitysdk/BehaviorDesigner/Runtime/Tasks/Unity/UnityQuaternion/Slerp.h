...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_SLERP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B03B790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_SLERP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B03B570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_SLERP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B03B800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_SLERP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B03B840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_SLERP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B03B8D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int Slerp_TypeDefinitionIndex = 31508;
