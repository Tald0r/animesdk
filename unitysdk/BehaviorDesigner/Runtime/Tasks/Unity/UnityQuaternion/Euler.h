...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_EULER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A634210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_EULER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6340F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_EULER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A634290)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_EULER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6342D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_EULER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A634360)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int Euler_TypeDefinitionIndex = 30549;
