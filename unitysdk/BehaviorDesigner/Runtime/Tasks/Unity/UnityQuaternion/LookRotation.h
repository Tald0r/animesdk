...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B603D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B602A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19B60450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B60490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B60520)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int LookRotation_TypeDefinitionIndex = 30554;
