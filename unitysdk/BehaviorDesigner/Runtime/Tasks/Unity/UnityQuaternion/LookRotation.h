...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A1087F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A1086C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A108870)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A1088B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_LOOKROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A108940)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int LookRotation_TypeDefinitionIndex = 31506;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector3* forwardVector; // 0x68
