...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC2F400)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC2F300)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC2F460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC2F4A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_INVERSE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC2F530)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int Inverse_TypeDefinitionIndex = 30552;
