...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_FROMTOROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B44B940)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_FROMTOROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B44B760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_FROMTOROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44B9C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_FROMTOROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B44BA00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_FROMTOROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B44BA90)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int FromToRotation_TypeDefinitionIndex = 31502;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector3* toDirection; // 0x68
