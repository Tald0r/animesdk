...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_FROMTOROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE31E00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_FROMTOROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE31C20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_FROMTOROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE31E80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_FROMTOROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE31EC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_FROMTOROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE31F50)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int FromToRotation_TypeDefinitionIndex = 30550;
