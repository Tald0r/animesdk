...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_DOT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E7210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_DOT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E7040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_DOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E7280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_DOT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E72C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_DOT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E7350)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int Dot_TypeDefinitionIndex = 30548;
