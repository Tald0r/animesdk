...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ANGLE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C1990)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ANGLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C1790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C1A00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ANGLE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C1A40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYQUATERNION_ANGLE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C1A80)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityQuaternion
{
	inline static constexpr unsigned int Angle_TypeDefinitionIndex = 31498;
