...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETREALTIMESINCESTARTUP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2F640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETREALTIMESINCESTARTUP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2F5D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETREALTIMESINCESTARTUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2F690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETREALTIMESINCESTARTUP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2F6D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETREALTIMESINCESTARTUP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2F760)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTime
{
	inline static constexpr unsigned int GetRealtimeSinceStartup_TypeDefinitionIndex = 30430;
