...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE5C800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE5C790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE5C850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE5C890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE5C920)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTime
{
	inline static constexpr unsigned int GetTimeScale_TypeDefinitionIndex = 30432;
