...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B46DB60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B46DAF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B46DBB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B46DBF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIMESCALE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B46DC80)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTime
{
	inline static constexpr unsigned int GetTimeScale_TypeDefinitionIndex = 31384;
