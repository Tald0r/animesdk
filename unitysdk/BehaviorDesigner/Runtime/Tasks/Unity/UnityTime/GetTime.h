...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B03DBC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B03DB50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B03DC10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B03DC50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_GETTIME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B03DCE0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTime
{
	inline static constexpr unsigned int GetTime_TypeDefinitionIndex = 31383;
