...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B62D20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B62C80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B62D80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B62DC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B62E50)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTime
{
	inline static constexpr unsigned int SetTimeScale_TypeDefinitionIndex = 30433;
