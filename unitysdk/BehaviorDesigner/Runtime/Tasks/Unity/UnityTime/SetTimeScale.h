...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A10B140)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A10B0A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A10B1A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A10B1E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTIME_SETTIMESCALE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A10B270)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTime
{
	inline static constexpr unsigned int SetTimeScale_TypeDefinitionIndex = 31385;
