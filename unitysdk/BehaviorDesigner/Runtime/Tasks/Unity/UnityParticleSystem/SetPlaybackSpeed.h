...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B334E30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B334A50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B334C40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B334E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B334EE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B334F70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETPLAYBACKSPEED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B335000)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetPlaybackSpeed_TypeDefinitionIndex = 31544;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* playbackSpeed; // 0x70
