...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETTIME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E61A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETTIME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E5E10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETTIME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E6000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E61F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETTIME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E6230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETTIME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E62C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETTIME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E6350)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int GetTime_TypeDefinitionIndex = 30581;
