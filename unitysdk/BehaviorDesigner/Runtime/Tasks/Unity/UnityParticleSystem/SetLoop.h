...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B46C460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B46C080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B46C270)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B46C510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B46C550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B46C5E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETLOOP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B46C670)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetLoop_TypeDefinitionIndex = 31542;
