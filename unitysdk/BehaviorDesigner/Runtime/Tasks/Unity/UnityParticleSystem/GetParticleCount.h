...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETPARTICLECOUNT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC90DF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETPARTICLECOUNT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC90A50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETPARTICLECOUNT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC90C40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETPARTICLECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC90E40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETPARTICLECOUNT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC90E80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETPARTICLECOUNT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC90F10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETPARTICLECOUNT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC90FA0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int GetParticleCount_TypeDefinitionIndex = 31531;
