...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2BE60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA2BA60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2BC50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2BEB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2BEF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA2BF80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2C010)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetStartDelay_TypeDefinitionIndex = 30594;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* startDelay; // 0x70
