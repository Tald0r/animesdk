...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B03A1D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B039DD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B039FC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B03A220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B03A260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B03A2F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTDELAY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B03A380)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetStartDelay_TypeDefinitionIndex = 31546;
