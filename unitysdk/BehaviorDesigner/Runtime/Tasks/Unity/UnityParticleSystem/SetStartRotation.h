...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2C4A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA2C0A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2C290)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2C4F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2C530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA2C5C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2C650)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetStartRotation_TypeDefinitionIndex = 30596;
