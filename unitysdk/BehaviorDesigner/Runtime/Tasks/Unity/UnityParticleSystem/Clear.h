...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A5A20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A56B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A58A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A5A70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A5AB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A5B40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_CLEAR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A5BD0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int Clear_TypeDefinitionIndex = 31525;
