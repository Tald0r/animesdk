...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_STOP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC11390)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_STOP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC11020)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_STOP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC11210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_STOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC113E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_STOP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC11420)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_STOP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC114B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_STOP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC11540)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int Stop_TypeDefinitionIndex = 30601;
