...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_ISALIVE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C1160)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_ISALIVE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0C0DF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_ISALIVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C0FE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_ISALIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C11B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_ISALIVE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C11F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_ISALIVE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0C1230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_ISALIVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C1270)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int IsAlive_TypeDefinitionIndex = 31534;
