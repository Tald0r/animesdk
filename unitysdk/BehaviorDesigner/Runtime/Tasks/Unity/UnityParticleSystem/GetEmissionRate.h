...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETEMISSIONRATE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC90810)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETEMISSIONRATE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC90400)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETEMISSIONRATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC905F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETEMISSIONRATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC90860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETEMISSIONRATE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC908A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETEMISSIONRATE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC90930)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETEMISSIONRATE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC909C0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int GetEmissionRate_TypeDefinitionIndex = 31527;
