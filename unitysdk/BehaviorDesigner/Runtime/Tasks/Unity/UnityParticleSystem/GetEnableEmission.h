...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B266610)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B266270)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B266460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2666C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B266700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B266790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETENABLEEMISSION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B266820)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int GetEnableEmission_TypeDefinitionIndex = 31528;
