...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1ABDF0B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1ABDED10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDEF00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABDF100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1ABDF140)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1ABDF1D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDF260)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int GetDuration_TypeDefinitionIndex = 31526;
