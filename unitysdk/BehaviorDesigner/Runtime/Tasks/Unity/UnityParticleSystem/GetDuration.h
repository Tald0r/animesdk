...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A633EB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A633B10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A633D00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A633F00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A633F40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A633FD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETDURATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A634060)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int GetDuration_TypeDefinitionIndex = 30574;
