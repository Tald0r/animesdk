...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A6C90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A6890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A6A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A6CE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A6D20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A6DB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A6E40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetStartSpeed_TypeDefinitionIndex = 31550;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* startSpeed; // 0x70
