...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E82E80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E82A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E82C70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x19E82ED0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E82F10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E82FA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTSPEED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E83030)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetStartSpeed_TypeDefinitionIndex = 30598;
