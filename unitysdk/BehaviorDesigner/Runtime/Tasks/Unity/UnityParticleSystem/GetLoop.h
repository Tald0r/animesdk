...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B46BDE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B46BA40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B46BC30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B46BE90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B46BED0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B46BF60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_GETLOOP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B46BFF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int GetLoop_TypeDefinitionIndex = 31529;
