...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E6E00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E6A20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E6C10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E6E50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E6E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E6F20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETTIME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E6FB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetTime_TypeDefinitionIndex = 30599;
