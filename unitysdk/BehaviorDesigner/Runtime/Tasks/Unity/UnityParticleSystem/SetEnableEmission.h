...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A65F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A6210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A6400)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A66A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A66E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A6770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A6800)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetEnableEmission_TypeDefinitionIndex = 31541;
