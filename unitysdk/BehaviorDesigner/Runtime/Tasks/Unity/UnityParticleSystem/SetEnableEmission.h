...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E827E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E82400)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E825F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E82890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E828D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E82960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETENABLEEMISSION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E829F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetEnableEmission_TypeDefinitionIndex = 30589;
