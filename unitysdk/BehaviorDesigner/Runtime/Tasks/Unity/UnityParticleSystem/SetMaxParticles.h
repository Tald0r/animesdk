...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A9EC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A2A9AE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A9CD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A9F70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A9FB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A2AA040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETMAXPARTICLES___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2AA0D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetMaxParticles_TypeDefinitionIndex = 30591;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedInt* maxParticles; // 0x68
