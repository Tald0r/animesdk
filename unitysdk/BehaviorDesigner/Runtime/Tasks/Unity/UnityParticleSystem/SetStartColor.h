...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B3354B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B335090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B335280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B335510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B335550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B3355E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPARTICLESYSTEM_SETSTARTCOLOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B335670)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityParticleSystem
{
	inline static constexpr unsigned int SetStartColor_TypeDefinitionIndex = 31545;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedColor* startColor; // 0x68
