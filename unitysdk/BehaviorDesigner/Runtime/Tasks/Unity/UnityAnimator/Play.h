...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E80020)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E7FC20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E7FE40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x19E80090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E800E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E80170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E80200)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int Play_TypeDefinitionIndex = 30785;
