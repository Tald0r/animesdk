...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A3E40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A3A40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A3C60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A3EA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A3EF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A3F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_PLAY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A4010)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int Play_TypeDefinitionIndex = 31737;
