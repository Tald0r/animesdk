...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISPARAMETERCONTROLLEDBYCURVE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A630620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISPARAMETERCONTROLLEDBYCURVE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A630240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISPARAMETERCONTROLLEDBYCURVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A630460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISPARAMETERCONTROLLEDBYCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A630680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISPARAMETERCONTROLLEDBYCURVE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6306C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISPARAMETERCONTROLLEDBYCURVE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A630750)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISPARAMETERCONTROLLEDBYCURVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6307E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int IsParameterControlledByCurve_TypeDefinitionIndex = 30783;
