...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETSPEED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B469560)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETSPEED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B469180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETSPEED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B4693A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4695B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETSPEED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B4695F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETSPEED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B469680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETSPEED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B469710)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int SetSpeed_TypeDefinitionIndex = 31746;
