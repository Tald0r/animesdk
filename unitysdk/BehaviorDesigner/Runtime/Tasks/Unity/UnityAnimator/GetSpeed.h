...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETSPEED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE57570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETSPEED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE571D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETSPEED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE573F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE575C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETSPEED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE57600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETSPEED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE57690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETSPEED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE57720)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int GetSpeed_TypeDefinitionIndex = 30779;
