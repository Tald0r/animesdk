...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STARTRECORDING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE2FDB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STARTRECORDING_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE2FA50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STARTRECORDING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE2FC70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STARTRECORDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE2FE00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STARTRECORDING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE2FE40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STARTRECORDING___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE2FED0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STARTRECORDING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE2FF60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int StartRecording_TypeDefinitionIndex = 30796;
