...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD17050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD16C90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD16EB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD170B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD170F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD17180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETDELTAROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD17210)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int GetDeltaRotation_TypeDefinitionIndex = 30774;
