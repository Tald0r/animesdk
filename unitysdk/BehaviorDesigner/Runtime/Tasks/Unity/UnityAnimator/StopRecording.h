...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0336D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B033370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B033590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B033720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B033760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0337F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPRECORDING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B033880)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int StopRecording_TypeDefinitionIndex = 31750;
