...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B264040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2639A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B263BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x1B263FB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B264100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B264140)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2641D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B264260)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int SetIntegerParameter_TypeDefinitionIndex = 31743;
	...
	public:
		...
		{
			return (::System::Action_3<::UnityEngine::Animator*, ::System::Int32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(SetIntegerParameter_TypeDefinitionIndex)->GetStaticField(0x24FB0);
		}
