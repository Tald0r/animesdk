...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5E2F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC5DC50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5DE70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x1AC5E260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5E3B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5E3F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC5E480)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETINTEGERPARAMETER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5E510)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int SetIntegerParameter_TypeDefinitionIndex = 30791;
	...
	public:
		...
		{
			return (::System::Action_3<::UnityEngine::Animator*, ::System::Int32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(SetIntegerParameter_TypeDefinitionIndex)->GetStaticField(0x23690);
		}
