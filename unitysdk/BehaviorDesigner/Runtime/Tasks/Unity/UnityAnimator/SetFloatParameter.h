...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A4750)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A40A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A42C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x1A4A46C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A47B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A47F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A4880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A4910)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int SetFloatParameter_TypeDefinitionIndex = 31741;
	...
	public:
		...
		{
			return (::System::Action_3<::UnityEngine::Animator*, ::System::Int32, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(SetFloatParameter_TypeDefinitionIndex)->GetStaticField(0x24F30);
		}
