...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E80940)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E80290)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E804B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x19E808B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E809A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E809E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E80A70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETFLOATPARAMETER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E80B00)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int SetFloatParameter_TypeDefinitionIndex = 30789;
	...
	public:
		...
		{
			return (::System::Action_3<::UnityEngine::Animator*, ::System::Int32, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(SetFloatParameter_TypeDefinitionIndex)->GetStaticField(0x23610);
		}
