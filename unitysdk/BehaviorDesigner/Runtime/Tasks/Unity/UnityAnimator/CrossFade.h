...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_CROSSFADE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE56F60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_CROSSFADE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE56AC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_CROSSFADE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE56CE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_CROSSFADE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE56FD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_CROSSFADE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE57020)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_CROSSFADE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE570B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_CROSSFADE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE57140)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int CrossFade_TypeDefinitionIndex = 30770;
