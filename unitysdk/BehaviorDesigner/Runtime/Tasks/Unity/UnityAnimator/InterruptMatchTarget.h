...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A630000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A62FC90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A62FEB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A630050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A630090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A630120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_INTERRUPTMATCHTARGET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6301B0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int InterruptMatchTarget_TypeDefinitionIndex = 30781;
