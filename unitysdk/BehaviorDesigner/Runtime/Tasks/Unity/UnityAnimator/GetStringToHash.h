...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETSTRINGTOHASH_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A7010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETSTRINGTOHASH_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A6F40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETSTRINGTOHASH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A70D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETSTRINGTOHASH___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A7110)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETSTRINGTOHASH___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A71A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int GetStringToHash_TypeDefinitionIndex = 30780;
