...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPPLAYBACK_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B28BAB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPPLAYBACK_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B28B750)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPPLAYBACK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B28B970)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPPLAYBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B28BB00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPPLAYBACK___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B28BB40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPPLAYBACK___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B28BBD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_STOPPLAYBACK___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B28BC60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int StopPlayback_TypeDefinitionIndex = 31749;
