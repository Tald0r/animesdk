...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A65D850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A65D4B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A65D6D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65D8A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A65D8E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A65D970)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_GETGRAVITYWEIGHT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A65DA00)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int GetGravityWeight_TypeDefinitionIndex = 30776;
