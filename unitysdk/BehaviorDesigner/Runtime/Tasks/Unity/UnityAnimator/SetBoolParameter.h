...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETBOOLPARAMETER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B237BE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETBOOLPARAMETER_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B237530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETBOOLPARAMETER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B237750)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETBOOLPARAMETER_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x1B237B50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETBOOLPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B237CA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETBOOLPARAMETER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B237CE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETBOOLPARAMETER___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B237D70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_SETBOOLPARAMETER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B237E00)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int SetBoolParameter_TypeDefinitionIndex = 31739;
	...
	public:
		...
		{
			return (::System::Action_3<::UnityEngine::Animator*, ::System::Int32, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(SetBoolParameter_TypeDefinitionIndex)->GetStaticField(0x24F90);
		}
