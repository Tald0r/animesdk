...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISINTRANSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE57B90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISINTRANSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE577B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISINTRANSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE579D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISINTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE57C40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISINTRANSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE57C80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISINTRANSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE57D10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATOR_ISINTRANSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE57DA0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimator
{
	inline static constexpr unsigned int IsInTransition_TypeDefinitionIndex = 30782;
