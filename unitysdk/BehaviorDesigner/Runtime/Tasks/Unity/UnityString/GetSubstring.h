...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETSUBSTRING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE33B20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETSUBSTRING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE337D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETSUBSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE33C90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETSUBSTRING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE33EB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETSUBSTRING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE33F40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityString
{
	inline static constexpr unsigned int GetSubstring_TypeDefinitionIndex = 30439;

	class GetSubstring : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedInt* startIndex; // 0x58
