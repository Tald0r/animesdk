...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_ISNULLOREMPTY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC130C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_ISNULLOREMPTY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC13010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_ISNULLOREMPTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC13110)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_ISNULLOREMPTY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC13150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_ISNULLOREMPTY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC131E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityString
{
	inline static constexpr unsigned int IsNullOrEmpty_TypeDefinitionIndex = 30440;
