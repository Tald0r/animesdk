...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x19B61F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B623B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B61FE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B62410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x19B62450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B624E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B62570)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityString
{
	inline static constexpr unsigned int Format_TypeDefinitionIndex = 30436;
