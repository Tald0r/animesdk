...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1A10A3A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A10A7D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A10A400)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A10A830)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1A10A870)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A10A900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_FORMAT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A10A990)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityString
{
	inline static constexpr unsigned int Format_TypeDefinitionIndex = 31388;

	class Format : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedString* format; // 0x58
		::Il2CppArray<::System::Object*>* variableValues; // 0x60
		::BehaviorDesigner::Runtime::SharedString* storeResult; // 0x68
		::Il2CppArray<::BehaviorDesigner::Runtime::SharedGenericVariable*>* variables; // 0x70
