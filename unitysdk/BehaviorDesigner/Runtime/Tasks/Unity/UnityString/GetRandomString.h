...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E85C00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E85AD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19E85C50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E85C90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E85D20)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityString
{
	inline static constexpr unsigned int GetRandomString_TypeDefinitionIndex = 30438;
