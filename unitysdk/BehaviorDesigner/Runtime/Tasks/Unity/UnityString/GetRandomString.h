...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A9A20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A98F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A9A70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A9AB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETRANDOMSTRING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A9B40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityString
{
	inline static constexpr unsigned int GetRandomString_TypeDefinitionIndex = 31390;
