...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_BUILDSTRING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC12E60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_BUILDSTRING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC12C50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_BUILDSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC12EB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_BUILDSTRING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC12EF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_BUILDSTRING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC12F80)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityString
{
	inline static constexpr unsigned int BuildString_TypeDefinitionIndex = 30434;
