...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_COMPARETO_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C3790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_COMPARETO_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C3650)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_COMPARETO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C3860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_COMPARETO___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C38A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_COMPARETO___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C38E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityString
{
	inline static constexpr unsigned int CompareTo_TypeDefinitionIndex = 31387;
