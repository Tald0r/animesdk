...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_COMPARETO_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA6C220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_COMPARETO_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA6C0E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_COMPARETO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA6C2F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_COMPARETO___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA6C330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_COMPARETO___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA6C370)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityString
{
	inline static constexpr unsigned int CompareTo_TypeDefinitionIndex = 30435;
