...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETLENGTH_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B26A160)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETLENGTH_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B26A0A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETLENGTH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B26A220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETLENGTH___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B26A260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYSTRING_GETLENGTH___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B26A2F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityString
{
	inline static constexpr unsigned int GetLength_TypeDefinitionIndex = 31389;
