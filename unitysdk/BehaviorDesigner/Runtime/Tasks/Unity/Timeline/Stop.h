...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_STOP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B4483C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_STOP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B448050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_STOP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B448240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_STOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B448410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_STOP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B448450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_STOP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B4484E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_STOP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B448570)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Timeline
{
	inline static constexpr unsigned int Stop_TypeDefinitionIndex = 31380;
