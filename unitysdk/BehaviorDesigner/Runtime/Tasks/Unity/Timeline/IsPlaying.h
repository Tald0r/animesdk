...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPLAYING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A62FA50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPLAYING_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A62F6E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPLAYING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A62F8D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPLAYING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A62FAA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPLAYING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A62FAE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPLAYING___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A62FB70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPLAYING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A62FC00)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Timeline
{
	inline static constexpr unsigned int IsPlaying_TypeDefinitionIndex = 30424;
