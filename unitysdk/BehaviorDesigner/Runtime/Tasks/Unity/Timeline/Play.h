...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_PLAY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA07500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_PLAY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA06FE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_PLAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA071E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_PLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA075C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_PLAY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA07600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_PLAY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA07690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_PLAY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA07720)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Timeline
{
	inline static constexpr unsigned int Play_TypeDefinitionIndex = 30426;
