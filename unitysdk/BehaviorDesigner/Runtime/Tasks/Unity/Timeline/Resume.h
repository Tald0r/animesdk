...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE55430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE54FC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE551B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE554E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE55520)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE555B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE55640)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Timeline
{
	inline static constexpr unsigned int Resume_TypeDefinitionIndex = 30427;
