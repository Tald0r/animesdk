...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B466780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B466310)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B466500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B466830)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B466870)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B466900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_RESUME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B466990)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Timeline
{
	inline static constexpr unsigned int Resume_TypeDefinitionIndex = 31379;
