...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPAUSED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC2BE50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPAUSED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC2BAE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPAUSED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC2BCD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPAUSED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC2BEA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPAUSED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC2BEE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPAUSED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC2BF70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_TIMELINE_ISPAUSED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC2C000)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Timeline
{
	inline static constexpr unsigned int IsPaused_TypeDefinitionIndex = 30423;
