...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B28D3C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B28D030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B28D220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B28D410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B28D450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B28D4E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B28D570)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCapsuleCollider
{
	inline static constexpr unsigned int GetHeight_TypeDefinitionIndex = 31658;
