...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC73E40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC73AB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC73CA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC73E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC73ED0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC73F60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETHEIGHT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC73FF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCapsuleCollider
{
	inline static constexpr unsigned int GetHeight_TypeDefinitionIndex = 30706;
