...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B035590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B035200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0353F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B035640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B035680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B035710)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0357A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCapsuleCollider
{
	inline static constexpr unsigned int GetDirection_TypeDefinitionIndex = 31657;
