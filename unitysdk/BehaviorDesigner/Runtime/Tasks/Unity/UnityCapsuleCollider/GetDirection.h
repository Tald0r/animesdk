...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA27220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA26E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA27080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA272D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA27310)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA273A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_GETDIRECTION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA27430)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCapsuleCollider
{
	inline static constexpr unsigned int GetDirection_TypeDefinitionIndex = 30705;
