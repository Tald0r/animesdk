...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE594A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE590C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE592B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE594F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE59530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE595C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE59650)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCapsuleCollider
{
	inline static constexpr unsigned int SetHeight_TypeDefinitionIndex = 30710;

	class SetHeight : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::UnityEngine::CapsuleCollider* capsuleCollider; // 0x58
		::BehaviorDesigner::Runtime::SharedFloat* direction; // 0x60
