...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B46A7F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B46A410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B46A600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B46A840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B46A880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B46A910)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETHEIGHT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B46A9A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCapsuleCollider
{
	inline static constexpr unsigned int SetHeight_TypeDefinitionIndex = 31662;
