...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETDIRECTION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BDA00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETDIRECTION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0BD620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETDIRECTION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BD810)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BDAB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETDIRECTION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BDAF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETDIRECTION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0BDB30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYCAPSULECOLLIDER_SETDIRECTION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BDB70)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityCapsuleCollider
{
	inline static constexpr unsigned int SetDirection_TypeDefinitionIndex = 31661;
