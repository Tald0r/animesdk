...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVEFORCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA0C0A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVEFORCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA0BC80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVEFORCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA0BE70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVEFORCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA0C110)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVEFORCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA0C150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVEFORCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA0C1E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVEFORCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA0C270)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int AddRelativeForce_TypeDefinitionIndex = 30511;
