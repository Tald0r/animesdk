...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2AA890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A2AA590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2AA780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2AA900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2AA940)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A2AA9D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2AAA60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int AddRelativeTorque_TypeDefinitionIndex = 30512;
