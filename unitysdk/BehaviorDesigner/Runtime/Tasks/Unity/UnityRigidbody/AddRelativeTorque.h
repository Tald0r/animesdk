...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A8681B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A867EB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A8680A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A868220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A868260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A8682F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDRELATIVETORQUE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A868380)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int AddRelativeTorque_TypeDefinitionIndex = 31464;
