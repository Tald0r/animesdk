...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA6AA80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA6A560)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA6A750)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA6AB10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA6AB50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA6AB90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA6ABD0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int AddExplosionForce_TypeDefinitionIndex = 30508;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector3* explosionPosition; // 0x68
		::BehaviorDesigner::Runtime::SharedFloat* explosionRadius; // 0x70
		::BehaviorDesigner::Runtime::SharedFloat* explosionForce; // 0x78
