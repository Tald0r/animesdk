...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C1FF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0C1AD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C1CC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C2080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C20C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0C2100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDEXPLOSIONFORCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C2140)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int AddExplosionForce_TypeDefinitionIndex = 31460;

	class AddExplosionForce : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedVector3* explosionPosition; // 0x58
		::UnityEngine::Rigidbody* rigidbody; // 0x60
		::BehaviorDesigner::Runtime::SharedFloat* explosionRadius; // 0x68
		::BehaviorDesigner::Runtime::SharedFloat* explosionForce; // 0x70
