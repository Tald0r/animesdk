...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC30F20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETROTATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC30B60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC30D50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC30F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC30FC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETROTATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC31050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC310E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int GetRotation_TypeDefinitionIndex = 30522;
