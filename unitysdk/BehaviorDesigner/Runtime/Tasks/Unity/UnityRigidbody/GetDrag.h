...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETDRAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A868DD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETDRAG_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A868A40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETDRAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A868C30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETDRAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A868E20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETDRAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A868E60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETDRAG___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A868EF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETDRAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A868F80)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int GetDrag_TypeDefinitionIndex = 31469;
