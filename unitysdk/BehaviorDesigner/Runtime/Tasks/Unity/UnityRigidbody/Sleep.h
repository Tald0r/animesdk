...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SLEEP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A662FC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SLEEP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A662C50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SLEEP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A662E40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SLEEP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A663010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SLEEP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A663050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SLEEP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6630E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SLEEP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A663170)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int Sleep_TypeDefinitionIndex = 30541;
