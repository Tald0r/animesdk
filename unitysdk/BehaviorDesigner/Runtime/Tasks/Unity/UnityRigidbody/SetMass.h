...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETMASS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2E6D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETMASS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA2E2F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETMASS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2E4E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETMASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2E720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETMASS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2E760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETMASS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA2E7F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETMASS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2E880)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int SetMass_TypeDefinitionIndex = 30536;
