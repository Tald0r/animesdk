...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B226510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B226140)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B226330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B226580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B2265C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B226650)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B2266E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int GetPosition_TypeDefinitionIndex = 31473;
