...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDFORCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C25B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDFORCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0C2190)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDFORCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C2380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDFORCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C2630)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDFORCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C2670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDFORCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0C26B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_ADDFORCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C26F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int AddForce_TypeDefinitionIndex = 31461;
