...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E85880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E85480)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E85670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E858E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E85920)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E859B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E85A40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int SetRotation_TypeDefinitionIndex = 30538;
