...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A96A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A92A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A9490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A9700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A9740)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A97D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A9860)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int SetRotation_TypeDefinitionIndex = 31490;
