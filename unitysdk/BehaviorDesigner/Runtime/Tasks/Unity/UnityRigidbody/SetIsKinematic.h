...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETISKINEMATIC_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC31550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETISKINEMATIC_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC31170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETISKINEMATIC_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC31360)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETISKINEMATIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC31600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETISKINEMATIC___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC31640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETISKINEMATIC___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC316D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETISKINEMATIC___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC31760)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int SetIsKinematic_TypeDefinitionIndex = 30535;
