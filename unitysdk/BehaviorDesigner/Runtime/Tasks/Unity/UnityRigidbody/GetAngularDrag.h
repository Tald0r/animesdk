...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B23B770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B23B3E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B23B5D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B23B7C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B23B800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B23B890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B23B920)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int GetAngularDrag_TypeDefinitionIndex = 31466;
