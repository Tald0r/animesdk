...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC302F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC2FF60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC30150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC30340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC30380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC30410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETANGULARDRAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC304A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int GetAngularDrag_TypeDefinitionIndex = 30514;
