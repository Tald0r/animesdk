...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2DA10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA2D600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2D7F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2DA80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2DAC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA2DB50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2DBE0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int MovePosition_TypeDefinitionIndex = 30527;
