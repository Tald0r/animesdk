...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B03BD70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B03B960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B03BB50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B03BDE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B03BE20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B03BEB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_MOVEPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B03BF40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int MovePosition_TypeDefinitionIndex = 31479;
