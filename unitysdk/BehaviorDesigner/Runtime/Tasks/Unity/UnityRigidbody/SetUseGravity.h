...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETUSEGRAVITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A8693F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETUSEGRAVITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A869010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETUSEGRAVITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A869200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETUSEGRAVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8694A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETUSEGRAVITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A8694E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETUSEGRAVITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A869570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_SETUSEGRAVITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A869600)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int SetUseGravity_TypeDefinitionIndex = 31491;
