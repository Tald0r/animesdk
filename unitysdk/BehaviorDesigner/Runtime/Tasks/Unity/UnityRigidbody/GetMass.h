...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETMASS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C3020)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETMASS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0C2C90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETMASS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C2E80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETMASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C3070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETMASS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C30B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETMASS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0C30F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_GETMASS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C3130)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int GetMass_TypeDefinitionIndex = 31472;
