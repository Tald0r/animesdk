...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC63520)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC631B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC633A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC63570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC635B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC63640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC636D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int WakeUp_TypeDefinitionIndex = 30543;
