...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B269260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B268EF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B2690E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2692B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B2692F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B269380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_WAKEUP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B269410)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int WakeUp_TypeDefinitionIndex = 31495;
