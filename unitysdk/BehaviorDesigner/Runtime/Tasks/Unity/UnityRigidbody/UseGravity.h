...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA6BF80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA6BC10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA6BE00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA6BFD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA6C010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA6C050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY_USEGRAVITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA6C090)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody
{
	inline static constexpr unsigned int UseGravity_TypeDefinitionIndex = 30542;
