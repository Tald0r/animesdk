...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_LINECAST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE5B5E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_LINECAST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE5B3B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_LINECAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE5B670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_LINECAST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE5B6C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS_LINECAST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE5B750)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPhysics
{
	inline static constexpr unsigned int Linecast_TypeDefinitionIndex = 30570;
