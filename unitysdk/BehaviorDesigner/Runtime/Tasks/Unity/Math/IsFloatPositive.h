...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_ISFLOATPOSITIVE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFF65B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_ISFLOATPOSITIVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFF6510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_ISFLOATPOSITIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFF6600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_ISFLOATPOSITIVE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFF6640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_ISFLOATPOSITIVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFF66D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int IsFloatPositive_TypeDefinitionIndex = 31587;
