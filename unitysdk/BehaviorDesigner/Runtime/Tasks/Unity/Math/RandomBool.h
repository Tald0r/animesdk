...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMBOOL_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BADE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BAE50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMBOOL___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BAE90)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int RandomBool_TypeDefinitionIndex = 31591;
