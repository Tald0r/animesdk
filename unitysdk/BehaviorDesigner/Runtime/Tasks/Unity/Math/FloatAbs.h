...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATABS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B261010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATABS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B260F60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATABS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B261060)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATABS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B2610A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATABS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B261130)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int FloatAbs_TypeDefinitionIndex = 31575;
