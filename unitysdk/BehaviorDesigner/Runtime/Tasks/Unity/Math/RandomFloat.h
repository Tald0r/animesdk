...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMFLOAT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5C0D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMFLOAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5BC50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5C160)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMFLOAT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5C1A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMFLOAT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5C230)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int RandomFloat_TypeDefinitionIndex = 30640;
