...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATCOMPARISON_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5BA70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATCOMPARISON_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5B460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATCOMPARISON__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5BAF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATCOMPARISON___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5BB30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_FLOATCOMPARISON___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5BBC0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int FloatComparison_TypeDefinitionIndex = 30625;
