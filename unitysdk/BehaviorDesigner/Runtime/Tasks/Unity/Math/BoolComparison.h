...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLCOMPARISON_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B289E50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLCOMPARISON_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B289D50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLCOMPARISON__CTOR_OFFSET UNITYSDK_OFFSET(0x1B289F90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLCOMPARISON___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B289FD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLCOMPARISON___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B28A060)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int BoolComparison_TypeDefinitionIndex = 31571;
