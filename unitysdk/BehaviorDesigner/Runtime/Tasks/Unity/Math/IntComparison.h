...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCOMPARISON_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B592B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCOMPARISON_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B58D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCOMPARISON__CTOR_OFFSET UNITYSDK_OFFSET(0x19B59330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCOMPARISON___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B59370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCOMPARISON___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B59400)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int IntComparison_TypeDefinitionIndex = 30631;
