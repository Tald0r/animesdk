...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCOMPARISON_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A1016F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCOMPARISON_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A101180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCOMPARISON__CTOR_OFFSET UNITYSDK_OFFSET(0x1A101770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCOMPARISON___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A1017B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTCOMPARISON___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A101840)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int IntComparison_TypeDefinitionIndex = 31583;
