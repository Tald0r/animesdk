...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETFLOAT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0A5E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETFLOAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0A530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0A640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETFLOAT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0A680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETFLOAT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0A710)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int SetFloat_TypeDefinitionIndex = 30644;
