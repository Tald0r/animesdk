...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMINT_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B596C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMINT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B59490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B597A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMINT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B597E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_RANDOMINT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B59870)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int RandomInt_TypeDefinitionIndex = 30642;
