...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTABS_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E7E330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTABS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E7E290)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTABS__CTOR_OFFSET UNITYSDK_OFFSET(0x19E7E3E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTABS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E7E420)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_INTABS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E7E4B0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int IntAbs_TypeDefinitionIndex = 30629;
