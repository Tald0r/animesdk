...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_LERPANGLE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A6430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_LERPANGLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A61C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_LERPANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A6490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_LERPANGLE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A64D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_LERPANGLE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A6560)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int LerpAngle_TypeDefinitionIndex = 30638;
