...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLFLIP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A62E130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLFLIP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A62E090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLFLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A62E190)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLFLIP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A62E1D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_BOOLFLIP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A62E260)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int BoolFlip_TypeDefinitionIndex = 30620;
