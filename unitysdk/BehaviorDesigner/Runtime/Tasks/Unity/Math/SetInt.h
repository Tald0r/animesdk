...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETINT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B466070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETINT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B465FC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4661B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETINT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B4661F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETINT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B466280)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int SetInt_TypeDefinitionIndex = 31597;
