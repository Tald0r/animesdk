...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETINT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE54D20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETINT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE54C70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE54E60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETINT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE54EA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_MATH_SETINT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE54F30)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Math
{
	inline static constexpr unsigned int SetInt_TypeDefinitionIndex = 30645;
