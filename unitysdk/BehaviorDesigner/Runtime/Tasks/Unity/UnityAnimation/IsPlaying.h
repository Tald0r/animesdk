...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_ISPLAYING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE55B30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_ISPLAYING_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE556D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_ISPLAYING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE558C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_ISPLAYING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE55BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_ISPLAYING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE55C00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_ISPLAYING___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE55C90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_ISPLAYING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE55D20)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int IsPlaying_TypeDefinitionIndex = 30760;
