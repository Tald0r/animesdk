...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E26F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E2310)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E2500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E2780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E27C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E2850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAYQUEUED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E28E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int PlayQueued_TypeDefinitionIndex = 30762;
