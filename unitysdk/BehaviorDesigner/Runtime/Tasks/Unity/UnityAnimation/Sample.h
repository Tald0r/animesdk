...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5C090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B5BD20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5BF10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B5C0E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5C120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B5C1B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SAMPLE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5C240)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int Sample_TypeDefinitionIndex = 30764;
