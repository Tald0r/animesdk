...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE56210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE55DB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE55FA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE562A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE562E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE56370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_PLAY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE56400)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int Play_TypeDefinitionIndex = 30761;
