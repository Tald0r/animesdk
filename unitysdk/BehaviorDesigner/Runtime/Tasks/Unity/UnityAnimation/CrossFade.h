...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5BA50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B5B320)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5B510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B5BB10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5BB70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B5BC00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5BC90)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int CrossFade_TypeDefinitionIndex = 30757;
