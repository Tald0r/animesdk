...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_STOP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA24DB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_STOP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA24950)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_STOP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA24B40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_STOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA24E10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_STOP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA24E50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_STOP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA24EE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_STOP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA24F70)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int Stop_TypeDefinitionIndex = 30767;
