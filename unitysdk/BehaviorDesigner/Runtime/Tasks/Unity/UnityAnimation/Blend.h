...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5C6A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC5C2C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5C4B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5C710)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5C760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC5C7F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_BLEND___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5C880)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int Blend_TypeDefinitionIndex = 30756;
	...
	public:
		...
		::System::Single targetWeight; // 0x78
		::System::Single fadeLength; // 0x7C
