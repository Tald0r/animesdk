...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B2630B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B262D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B262F30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B263100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B263140)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2631D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_SETWRAPMODE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B263260)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int SetWrapMode_TypeDefinitionIndex = 31718;
