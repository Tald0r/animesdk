...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC08490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC080A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC08290)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC08530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC08580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC08610)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC086A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int CrossFadeQueued_TypeDefinitionIndex = 31710;
