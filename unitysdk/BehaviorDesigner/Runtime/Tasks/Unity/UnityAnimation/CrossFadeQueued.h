...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A65D210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A65CE20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A65D010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65D2B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A65D300)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A65D390)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_CROSSFADEQUEUED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A65D420)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int CrossFadeQueued_TypeDefinitionIndex = 30758;
