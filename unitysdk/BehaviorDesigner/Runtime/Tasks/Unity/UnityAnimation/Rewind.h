...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_REWIND_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5CD70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_REWIND_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC5C910)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_REWIND_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5CB00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_REWIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5CE00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_REWIND___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5CE40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_REWIND___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC5CED0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYANIMATION_REWIND___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5CF60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAnimation
{
	inline static constexpr unsigned int Rewind_TypeDefinitionIndex = 30763;
