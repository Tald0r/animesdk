...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B235A50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B2358C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B235B40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B235B80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B235C10)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Collider
{
	inline static constexpr unsigned int GetEnabled_TypeDefinitionIndex = 31650;
