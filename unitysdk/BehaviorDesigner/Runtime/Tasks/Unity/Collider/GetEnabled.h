...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC2A5B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC2A420)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC2A6A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC2A6E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_GETENABLED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC2A770)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Collider
{
	inline static constexpr unsigned int GetEnabled_TypeDefinitionIndex = 30698;
