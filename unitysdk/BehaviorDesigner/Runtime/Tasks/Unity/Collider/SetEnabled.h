...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A1E60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A1C70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A1F50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A1F90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_COLLIDER_SETENABLED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A2020)

namespace BehaviorDesigner::Runtime::Tasks::Unity::Collider
{
	inline static constexpr unsigned int SetEnabled_TypeDefinitionIndex = 31651;
