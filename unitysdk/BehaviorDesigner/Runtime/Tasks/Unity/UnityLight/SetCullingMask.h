...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD196D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD19330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD19550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD19720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD19760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD197F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCULLINGMASK___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD19880)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetCullingMask_TypeDefinitionIndex = 30656;
