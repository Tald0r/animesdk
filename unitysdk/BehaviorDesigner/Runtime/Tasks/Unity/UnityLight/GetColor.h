...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC10220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0FE50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC10070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC10280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC102C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC10350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOLOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC103E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int GetColor_TypeDefinitionIndex = 30646;
