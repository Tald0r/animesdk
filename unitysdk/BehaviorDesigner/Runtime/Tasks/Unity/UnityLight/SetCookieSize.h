...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B037670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B037260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B037480)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0376C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B037700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B037790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIESIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B037820)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetCookieSize_TypeDefinitionIndex = 31607;

	class SetCookieSize : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedFloat* cookieSize; // 0x58
