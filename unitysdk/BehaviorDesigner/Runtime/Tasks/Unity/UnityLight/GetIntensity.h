...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETINTENSITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BF810)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETINTENSITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0BF460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETINTENSITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BF680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETINTENSITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BF860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETINTENSITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BF8A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETINTENSITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0BF8E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETINTENSITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BF920)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int GetIntensity_TypeDefinitionIndex = 31600;
