...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C0790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0C0380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C05A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C07E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C0820)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0C0860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSPOTANGLE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C08A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetSpotAngle_TypeDefinitionIndex = 31614;
