...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0AE00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0A9F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0AC10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0AE50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0AE90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0AF20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWBIAS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0AFB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetShadowBias_TypeDefinitionIndex = 31611;
