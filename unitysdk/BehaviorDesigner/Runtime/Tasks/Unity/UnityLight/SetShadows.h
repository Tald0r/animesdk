...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA68CB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA68910)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA68B30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA68D00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA68D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA68D80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA68DC0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetShadows_TypeDefinitionIndex = 30661;
