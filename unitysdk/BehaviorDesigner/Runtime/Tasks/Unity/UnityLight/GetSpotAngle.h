...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5EAF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B5E740)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5E960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B5EB40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5EB80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B5EC10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSPOTANGLE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5ECA0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int GetSpotAngle_TypeDefinitionIndex = 30652;
