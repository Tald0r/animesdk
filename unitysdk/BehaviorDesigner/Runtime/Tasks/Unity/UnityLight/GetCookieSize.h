...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BF300)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0BEF50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BF170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BF350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BF390)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0BF3D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETCOOKIESIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BF410)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int GetCookieSize_TypeDefinitionIndex = 31599;
