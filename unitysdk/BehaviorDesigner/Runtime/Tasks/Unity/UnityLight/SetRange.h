...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETRANGE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA29FA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETRANGE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA29B90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETRANGE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA29DB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA29FF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETRANGE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2A030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETRANGE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA2A0C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETRANGE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2A150)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetRange_TypeDefinitionIndex = 30658;
