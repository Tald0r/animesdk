...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A1074F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A107150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A107370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A107540)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A107580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A107610)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A1076A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetCookie_TypeDefinitionIndex = 31606;
