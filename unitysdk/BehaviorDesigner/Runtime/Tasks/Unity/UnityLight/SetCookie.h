...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5F0D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B5ED30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5EF50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B5F120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5F160)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B5F1F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETCOOKIE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5F280)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetCookie_TypeDefinitionIndex = 30654;
