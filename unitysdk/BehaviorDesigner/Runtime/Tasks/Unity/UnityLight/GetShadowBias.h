...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1ABDE4D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1ABDE120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDE340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABDE520)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1ABDE560)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1ABDE5F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETSHADOWBIAS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDE680)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int GetShadowBias_TypeDefinitionIndex = 31602;
