...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2A5F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA2A1E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2A400)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2A640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2A680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA2A710)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2A7A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetShadowSoftnessStrength_TypeDefinitionIndex = 30660;
