...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B038960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B038550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B038770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0389B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0389F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B038A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETSHADOWSOFTNESSSTRENGTH___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B038B10)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetShadowSoftnessStrength_TypeDefinitionIndex = 31612;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* shadowStrength; // 0x68
