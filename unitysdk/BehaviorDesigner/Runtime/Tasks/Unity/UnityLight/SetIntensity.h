...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B037CC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0378B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B037AD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B037D10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B037D50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B037DE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_SETINTENSITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B037E70)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int SetIntensity_TypeDefinitionIndex = 31609;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* intensity; // 0x68
