...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD190F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD18D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD18F60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD19140)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD19180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD19210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLIGHT_GETRANGE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD192A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLight
{
	inline static constexpr unsigned int GetRange_TypeDefinitionIndex = 30649;
