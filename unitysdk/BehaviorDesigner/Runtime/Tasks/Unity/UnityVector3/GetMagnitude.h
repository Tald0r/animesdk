...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE35540)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE35450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE355B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE355F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE35680)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int GetMagnitude_TypeDefinitionIndex = 30360;
