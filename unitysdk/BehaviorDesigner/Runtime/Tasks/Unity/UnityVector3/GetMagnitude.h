...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B44F080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B44EF90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44F0F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B44F130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETMAGNITUDE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B44F1C0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int GetMagnitude_TypeDefinitionIndex = 31312;
