...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETVECTOR2_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFFEB20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETVECTOR2_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFFEA40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFEB90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETVECTOR2___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFFEBD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETVECTOR2___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFFEC60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int GetVector2_TypeDefinitionIndex = 31316;
