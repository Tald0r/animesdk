...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETVECTOR2_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA0EE00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETVECTOR2_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA0ED20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA0EE70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETVECTOR2___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA0EEB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETVECTOR2___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA0EF40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int GetVector2_TypeDefinitionIndex = 30364;
