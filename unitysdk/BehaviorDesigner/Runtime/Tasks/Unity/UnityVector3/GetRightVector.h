...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETRIGHTVECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4AA930)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETRIGHTVECTOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4AA8B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETRIGHTVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4AA990)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETRIGHTVECTOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4AA9D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETRIGHTVECTOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4AAA60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int GetRightVector_TypeDefinitionIndex = 31313;
