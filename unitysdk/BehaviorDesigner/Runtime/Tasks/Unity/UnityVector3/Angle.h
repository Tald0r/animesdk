...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ANGLE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B338570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ANGLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B3382F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3385E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ANGLE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B338620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ANGLE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B3386B0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int Angle_TypeDefinitionIndex = 31307;
