...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ANGLE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD1DFF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ANGLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD1DD70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD1E060)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ANGLE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD1E0A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ANGLE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD1E130)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int Angle_TypeDefinitionIndex = 30355;
