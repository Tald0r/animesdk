...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETXYZ_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC331C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETXYZ_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC32E60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETXYZ__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC33240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETXYZ___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC33280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETXYZ___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC33310)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int SetXYZ_TypeDefinitionIndex = 30374;

	class SetXYZ : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedFloat* xValue; // 0x58
		::BehaviorDesigner::Runtime::SharedFloat* yValue; // 0x60
		::BehaviorDesigner::Runtime::SharedVector3* vector3Variable; // 0x68
		::BehaviorDesigner::Runtime::SharedFloat* zValue; // 0x70
