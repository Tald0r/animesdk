...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B23E110)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B23DF60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B23E180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B23E1C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B23E250)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int Distance_TypeDefinitionIndex = 31309;
