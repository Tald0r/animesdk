...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC32C90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC32AE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC32D00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC32D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_DISTANCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC32DD0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int Distance_TypeDefinitionIndex = 30357;
