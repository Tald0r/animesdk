...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETFORWARDVECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC14EE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETFORWARDVECTOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC14E60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETFORWARDVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC14F40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETFORWARDVECTOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC14F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_GETFORWARDVECTOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC15010)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int GetForwardVector_TypeDefinitionIndex = 30359;
