...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETVALUE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E9850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETVALUE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E9740)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E98C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETVALUE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E9900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETVALUE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E9990)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int SetValue_TypeDefinitionIndex = 30373;
