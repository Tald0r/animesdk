...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETVALUE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC94A70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETVALUE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC94960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC94AE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETVALUE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC94B20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_SETVALUE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC94BB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int SetValue_TypeDefinitionIndex = 31325;
