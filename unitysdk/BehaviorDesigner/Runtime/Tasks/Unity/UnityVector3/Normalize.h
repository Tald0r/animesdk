...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_NORMALIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E87070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_NORMALIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E86F10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_NORMALIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E870E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_NORMALIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E87120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_NORMALIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E871B0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int Normalize_TypeDefinitionIndex = 30369;
