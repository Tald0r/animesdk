...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_NORMALIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4AAE90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_NORMALIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4AAD30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_NORMALIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4AAF00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_NORMALIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4AAF40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_NORMALIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4AAFD0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int Normalize_TypeDefinitionIndex = 31321;
