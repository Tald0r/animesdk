...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ROTATETOWARDS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC94780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ROTATETOWARDS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC94450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ROTATETOWARDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC94800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ROTATETOWARDS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC94840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ROTATETOWARDS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC948D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int RotateTowards_TypeDefinitionIndex = 31324;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector3* currentRotation; // 0x78
