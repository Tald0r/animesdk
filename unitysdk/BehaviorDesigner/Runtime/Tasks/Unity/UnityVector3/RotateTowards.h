...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ROTATETOWARDS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E9560)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ROTATETOWARDS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E9230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ROTATETOWARDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E95E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ROTATETOWARDS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E9620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR3_ROTATETOWARDS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E96B0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector3
{
	inline static constexpr unsigned int RotateTowards_TypeDefinitionIndex = 30372;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector3* targetRotation; // 0x60
		::BehaviorDesigner::Runtime::SharedVector3* storeResult; // 0x68
		::BehaviorDesigner::Runtime::SharedFloat* maxMagnitudeDelta; // 0x70
		::BehaviorDesigner::Runtime::SharedFloat* maxDegreesDelta; // 0x78
