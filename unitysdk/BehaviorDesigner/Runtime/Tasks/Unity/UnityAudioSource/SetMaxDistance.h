...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMAXDISTANCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5F680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMAXDISTANCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC5F270)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMAXDISTANCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5F490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMAXDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5F6E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMAXDISTANCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5F720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMAXDISTANCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC5F7B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMAXDISTANCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5F840)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetMaxDistance_TypeDefinitionIndex = 30743;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* maxDistance; // 0x70
