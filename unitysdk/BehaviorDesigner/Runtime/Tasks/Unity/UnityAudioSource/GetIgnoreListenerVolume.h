...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETIGNORELISTENERVOLUME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B449EF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETIGNORELISTENERVOLUME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B449B30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETIGNORELISTENERVOLUME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B449D50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETIGNORELISTENERVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B449FA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETIGNORELISTENERVOLUME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B449FE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETIGNORELISTENERVOLUME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B44A070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETIGNORELISTENERVOLUME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B44A100)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetIgnoreListenerVolume_TypeDefinitionIndex = 31674;
