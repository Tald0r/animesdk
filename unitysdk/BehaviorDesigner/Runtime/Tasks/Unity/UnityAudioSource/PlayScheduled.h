...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC731B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC72D90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC72FB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC73200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC73250)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC732E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAYSCHEDULED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC73370)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int PlayScheduled_TypeDefinitionIndex = 30738;
