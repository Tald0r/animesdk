...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETLOOP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E3A10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETLOOP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E3600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETLOOP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E3820)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETLOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E3AC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETLOOP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E3B00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETLOOP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E3B90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETLOOP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E3C20)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetLoop_TypeDefinitionIndex = 30742;
