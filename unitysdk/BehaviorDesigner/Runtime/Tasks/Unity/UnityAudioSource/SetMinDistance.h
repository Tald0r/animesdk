...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A65E580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A65E170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A65E390)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65E5E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A65E620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A65E6B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMINDISTANCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A65E740)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetMinDistance_TypeDefinitionIndex = 30744;
