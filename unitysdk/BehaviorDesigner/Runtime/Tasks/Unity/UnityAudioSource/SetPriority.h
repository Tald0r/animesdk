...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA088D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA084C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA086E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA08990)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA089D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA08A60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETPRIORITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA08AF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetPriority_TypeDefinitionIndex = 30747;
