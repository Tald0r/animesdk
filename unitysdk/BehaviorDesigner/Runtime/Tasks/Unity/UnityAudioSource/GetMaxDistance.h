...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE58E70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE58AB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE58CD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE58ED0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE58F10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE58FA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE59030)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetMaxDistance_TypeDefinitionIndex = 30724;
