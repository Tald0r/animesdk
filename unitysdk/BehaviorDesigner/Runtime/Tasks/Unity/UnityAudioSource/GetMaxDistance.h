...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B46A1C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B469E00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B46A020)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B46A220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B46A260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B46A2F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMAXDISTANCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B46A380)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetMaxDistance_TypeDefinitionIndex = 31676;
