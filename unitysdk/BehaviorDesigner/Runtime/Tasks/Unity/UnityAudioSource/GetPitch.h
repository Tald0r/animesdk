...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPITCH_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA25960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPITCH_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA255A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPITCH_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA257C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA259C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPITCH___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA25A00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPITCH___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA25A90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPITCH___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA25B20)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetPitch_TypeDefinitionIndex = 30727;
