...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_STOP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A865B50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_STOP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A8657B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_STOP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A8659D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_STOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A865BA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_STOP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A865BE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_STOP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A865C70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_STOP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A865D00)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int Stop_TypeDefinitionIndex = 31707;
