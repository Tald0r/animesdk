...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B221B90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2217D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B2219F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B221C50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B221C90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B221D20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B221DB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetPriority_TypeDefinitionIndex = 31680;
