...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0D3C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0D000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0D220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0D480)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0D4C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0D550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETPRIORITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0D5E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetPriority_TypeDefinitionIndex = 30728;
