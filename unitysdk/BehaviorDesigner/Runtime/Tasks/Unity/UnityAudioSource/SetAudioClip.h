...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B264D80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2649E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B264C00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B264DD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B264E10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B264EA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B264F30)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetAudioClip_TypeDefinitionIndex = 31691;
	...
	public:
		...
		::UnityEngine::AudioClip* audioClip; // 0x70
