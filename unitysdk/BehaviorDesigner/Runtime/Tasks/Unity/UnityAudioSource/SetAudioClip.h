...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5F030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC5EC90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5EEB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5F080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5F0C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC5F150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETAUDIOCLIP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5F1E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetAudioClip_TypeDefinitionIndex = 30739;
