...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0DA10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0D670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0D890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0DA60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0DAA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0DB30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_PLAY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0DBC0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int Play_TypeDefinitionIndex = 30735;
