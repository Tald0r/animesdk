...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B034990)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B034580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0347A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0349F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B034A30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B034AC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B034B50)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetVolume_TypeDefinitionIndex = 31706;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* volume; // 0x70
