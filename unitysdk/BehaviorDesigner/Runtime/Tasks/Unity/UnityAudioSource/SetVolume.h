...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA26620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA26210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA26430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA26680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA266C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA26750)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETVOLUME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA267E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetVolume_TypeDefinitionIndex = 30754;
