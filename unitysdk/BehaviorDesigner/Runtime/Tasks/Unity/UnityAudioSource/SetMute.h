...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A65EBE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A65E7D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A65E9F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65EC90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A65ECD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A65ED60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETMUTE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A65EDF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetMute_TypeDefinitionIndex = 30745;

	class SetMute : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedGameObject* targetGameObject; // 0x58
		::BehaviorDesigner::Runtime::SharedBool* mute; // 0x60
