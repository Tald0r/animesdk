...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B221530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B221170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B221390)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2215E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B221620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2216B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B221740)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetMute_TypeDefinitionIndex = 31678;
