...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0CD60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0C9A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0CBC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0CE10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0CE50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0CEE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMUTE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0CF70)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetMute_TypeDefinitionIndex = 30726;
