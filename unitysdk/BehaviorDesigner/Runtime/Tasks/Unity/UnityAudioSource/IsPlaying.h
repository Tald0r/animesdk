...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC8DF30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC8DB90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC8DDB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC8DF80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC8DFC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC8E050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC8E0E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int IsPlaying_TypeDefinitionIndex = 31685;
