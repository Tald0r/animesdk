...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E2D10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E2970)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E2B90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E2D60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E2DA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6E2E30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_ISPLAYING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E2EC0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int IsPlaying_TypeDefinitionIndex = 30733;
