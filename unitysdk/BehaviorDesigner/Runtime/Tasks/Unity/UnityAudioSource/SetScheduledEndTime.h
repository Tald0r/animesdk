...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDENDTIME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A632000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDENDTIME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A631BF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDENDTIME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A631E10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDENDTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A632050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDENDTIME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6320A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDENDTIME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A632130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_SETSCHEDULEDENDTIME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6321C0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int SetScheduledEndTime_TypeDefinitionIndex = 30749;
