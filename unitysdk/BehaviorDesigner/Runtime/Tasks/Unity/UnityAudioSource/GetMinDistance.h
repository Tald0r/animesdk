...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMINDISTANCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1ABDC530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMINDISTANCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1ABDC170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMINDISTANCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDC390)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMINDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABDC590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMINDISTANCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1ABDC5D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMINDISTANCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1ABDC660)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETMINDISTANCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDC6F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetMinDistance_TypeDefinitionIndex = 31677;
