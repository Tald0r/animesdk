...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A4D60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A49A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A4BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A4E10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A4E50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4A4EE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYAUDIOSOURCE_GETLOOP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A4F70)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityAudioSource
{
	inline static constexpr unsigned int GetLoop_TypeDefinitionIndex = 31675;
