...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A867CF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A867BB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A867D50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A867D90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A867E20)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int SetString_TypeDefinitionIndex = 31518;
