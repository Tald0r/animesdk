...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2AA3D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2AA290)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2AA430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2AA470)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETSTRING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2AA500)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int SetString_TypeDefinitionIndex = 30566;
