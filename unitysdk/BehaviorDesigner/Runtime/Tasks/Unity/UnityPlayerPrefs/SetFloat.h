...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETFLOAT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B3362B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETFLOAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B336150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B336310)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETFLOAT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B336350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETFLOAT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B3363E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int SetFloat_TypeDefinitionIndex = 31516;
