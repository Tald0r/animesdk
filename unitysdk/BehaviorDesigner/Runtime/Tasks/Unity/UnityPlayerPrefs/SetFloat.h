...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETFLOAT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD1BD30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETFLOAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD1BBD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD1BD90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETFLOAT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD1BDD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETFLOAT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD1BE60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int SetFloat_TypeDefinitionIndex = 30564;
