...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SAVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0C970)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0C9C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SAVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0CA00)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int Save_TypeDefinitionIndex = 31515;
