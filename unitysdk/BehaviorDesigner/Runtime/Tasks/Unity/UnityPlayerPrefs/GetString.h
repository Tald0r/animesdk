...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC77600)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC77470)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC77670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC776B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC77740)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int GetString_TypeDefinitionIndex = 30561;
