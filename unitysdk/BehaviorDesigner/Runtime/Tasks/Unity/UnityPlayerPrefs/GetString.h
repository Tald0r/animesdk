...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B290BB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B290A20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B290C20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B290C60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETSTRING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B290CF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int GetString_TypeDefinitionIndex = 31513;
