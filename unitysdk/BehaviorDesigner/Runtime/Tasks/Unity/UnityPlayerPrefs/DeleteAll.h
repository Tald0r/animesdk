...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_DELETEALL_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A867A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_DELETEALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A867AE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_DELETEALL___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A867B20)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int DeleteAll_TypeDefinitionIndex = 31509;
