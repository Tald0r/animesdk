...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETFLOAT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2CAE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETFLOAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2C960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2CB50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETFLOAT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2CB90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETFLOAT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2CC20)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int GetFloat_TypeDefinitionIndex = 30559;

	class GetFloat : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedFloat* storeResult; // 0x58
		::BehaviorDesigner::Runtime::SharedFloat* defaultValue; // 0x60
