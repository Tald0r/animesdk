...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETINT_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B60080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETINT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5FF50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B60140)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETINT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B60180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_SETINT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B60210)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int SetInt_TypeDefinitionIndex = 30565;
