...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_HASKEY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B23A5D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_HASKEY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B23A510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_HASKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B23A620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_HASKEY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B23A660)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_HASKEY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B23A6F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int HasKey_TypeDefinitionIndex = 31514;
