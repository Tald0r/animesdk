...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETINT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B335EA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETINT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B335D30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B335FF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETINT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B336030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPLAYERPREFS_GETINT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B3360C0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPlayerPrefs
{
	inline static constexpr unsigned int GetInt_TypeDefinitionIndex = 31512;
