...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC2E7F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC2E450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC2E670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC2E840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC2E880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC2E910)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC2E9A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int IsStopped_TypeDefinitionIndex = 30608;
