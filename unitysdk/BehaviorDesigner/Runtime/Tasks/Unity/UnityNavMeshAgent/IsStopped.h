...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B239C80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2398E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B239B00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B239CD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B239D10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B239DA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_ISSTOPPED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B239E30)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int IsStopped_TypeDefinitionIndex = 31560;
