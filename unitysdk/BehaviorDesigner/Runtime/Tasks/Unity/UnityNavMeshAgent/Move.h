...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0C0C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0BC80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0BEA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0C130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0C170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0C200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0C290)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int Move_TypeDefinitionIndex = 31561;
