...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A660E40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A660A00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A660C20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A660EB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A660EF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A660F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_MOVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A661010)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int Move_TypeDefinitionIndex = 30609;
