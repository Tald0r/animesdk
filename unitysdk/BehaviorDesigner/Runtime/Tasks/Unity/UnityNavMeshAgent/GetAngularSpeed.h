...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETANGULARSPEED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6338D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETANGULARSPEED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A633510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETANGULARSPEED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A633730)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETANGULARSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A633920)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETANGULARSPEED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A633960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETANGULARSPEED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6339F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETANGULARSPEED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A633A80)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int GetAngularSpeed_TypeDefinitionIndex = 30603;
