...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESETPATH_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD19CB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESETPATH_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD19910)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESETPATH_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD19B30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESETPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD19D00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESETPATH___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD19D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESETPATH___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD19DD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESETPATH___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD19E60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int ResetPath_TypeDefinitionIndex = 30610;
