...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2ABD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA2A830)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2AA50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2AC20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA2AC60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA2ACF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2AD80)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int Resume_TypeDefinitionIndex = 30611;
