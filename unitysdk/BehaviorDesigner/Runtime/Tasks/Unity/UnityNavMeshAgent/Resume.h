...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B038F40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B038BA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B038DC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B038F90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B038FD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B039060)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_RESUME___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0390F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int Resume_TypeDefinitionIndex = 31563;
