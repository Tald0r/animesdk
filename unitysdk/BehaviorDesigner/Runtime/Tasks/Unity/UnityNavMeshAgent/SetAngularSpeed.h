...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B23A2D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B239EC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B23A0E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B23A320)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B23A360)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B23A3F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_SETANGULARSPEED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B23A480)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int SetAngularSpeed_TypeDefinitionIndex = 31565;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* angularSpeed; // 0x70
