...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETSPEED_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5F6D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETSPEED_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B5F310)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETSPEED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5F530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x19B5F720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETSPEED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5F760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETSPEED___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B5F7F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_GETSPEED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5F880)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int GetSpeed_TypeDefinitionIndex = 30607;
