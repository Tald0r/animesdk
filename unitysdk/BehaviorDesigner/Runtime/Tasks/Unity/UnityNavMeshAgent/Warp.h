...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B266010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B265BD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B265DF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B266080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B2660C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B266150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYNAVMESHAGENT_WARP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B2661E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityNavMeshAgent
{
	inline static constexpr unsigned int Warp_TypeDefinitionIndex = 31570;
