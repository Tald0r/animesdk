...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_SETLAYER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA678A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_SETLAYER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA67770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_SETLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA67900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_SETLAYER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA67950)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_SETLAYER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA67990)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLayerMask
{
	inline static constexpr unsigned int SetLayer_TypeDefinitionIndex = 30665;
