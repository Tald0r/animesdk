...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_SETLAYER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BEE10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_SETLAYER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BECE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_SETLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BEE70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_SETLAYER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BEEC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_SETLAYER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BEF00)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLayerMask
{
	inline static constexpr unsigned int SetLayer_TypeDefinitionIndex = 31617;
