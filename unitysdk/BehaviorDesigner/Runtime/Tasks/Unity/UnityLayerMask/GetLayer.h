...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_GETLAYER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A1069A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_GETLAYER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A106880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_GETLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A106A00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_GETLAYER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A106A40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYLAYERMASK_GETLAYER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A106AD0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityLayerMask
{
	inline static constexpr unsigned int GetLayer_TypeDefinitionIndex = 31616;
