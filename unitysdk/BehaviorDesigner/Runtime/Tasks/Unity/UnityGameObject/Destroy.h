...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0368C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0367A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B036910)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B036950)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0369E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int Destroy_TypeDefinitionIndex = 31635;
