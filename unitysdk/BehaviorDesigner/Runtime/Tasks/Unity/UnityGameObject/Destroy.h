...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA28550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA28430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA285A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA285E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_DESTROY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA28670)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int Destroy_TypeDefinitionIndex = 30683;
