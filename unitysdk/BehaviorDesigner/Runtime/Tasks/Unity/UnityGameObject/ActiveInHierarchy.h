...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVEINHIERARCHY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B238650)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVEINHIERARCHY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B238590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVEINHIERARCHY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2386A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVEINHIERARCHY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B2386E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_ACTIVEINHIERARCHY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B238770)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int ActiveInHierarchy_TypeDefinitionIndex = 31631;
