...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA28CE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA28BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA28D90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA28DD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA28E60)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int SetActive_TypeDefinitionIndex = 30692;

	class SetActive : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedGameObject* targetGameObject; // 0x58
		::BehaviorDesigner::Runtime::SharedBool* active; // 0x60
