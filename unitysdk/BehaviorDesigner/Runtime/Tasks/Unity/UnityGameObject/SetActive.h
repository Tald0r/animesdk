...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B037050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B036F30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B037100)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B037140)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETACTIVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0371D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int SetActive_TypeDefinitionIndex = 31644;
