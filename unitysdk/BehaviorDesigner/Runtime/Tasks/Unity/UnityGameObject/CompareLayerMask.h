...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0A840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0A770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0A890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0A8D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARELAYERMASK___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0A960)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int CompareLayerMask_TypeDefinitionIndex = 31633;
