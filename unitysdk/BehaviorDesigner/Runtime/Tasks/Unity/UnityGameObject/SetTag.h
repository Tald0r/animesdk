...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETTAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5DF20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETTAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5DE00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B5DF80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETTAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5DFC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETTAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5E050)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int SetTag_TypeDefinitionIndex = 30693;
