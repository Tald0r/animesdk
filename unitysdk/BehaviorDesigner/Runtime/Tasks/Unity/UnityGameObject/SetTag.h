...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETTAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A106340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETTAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A106230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1063A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETTAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A1063E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SETTAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A106470)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int SetTag_TypeDefinitionIndex = 31645;
