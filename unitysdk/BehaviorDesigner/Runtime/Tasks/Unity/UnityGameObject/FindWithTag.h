...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A866CA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A866A80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A866D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A866D80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A866E10)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int FindWithTag_TypeDefinitionIndex = 31639;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedBool* random; // 0x68
