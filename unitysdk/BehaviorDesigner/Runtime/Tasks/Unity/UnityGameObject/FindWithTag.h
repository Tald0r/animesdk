...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A9380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A9150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A9420)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A9460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FINDWITHTAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A94F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int FindWithTag_TypeDefinitionIndex = 30687;
