...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_INSTANTIATE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC2D5D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_INSTANTIATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC2D360)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_INSTANTIATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC2D660)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_INSTANTIATE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC2D6C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_INSTANTIATE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC2D750)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int Instantiate_TypeDefinitionIndex = 30690;
