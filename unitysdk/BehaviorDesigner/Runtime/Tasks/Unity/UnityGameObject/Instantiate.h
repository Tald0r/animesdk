...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_INSTANTIATE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B238A70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_INSTANTIATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B238800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_INSTANTIATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B238B00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_INSTANTIATE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B238B60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_INSTANTIATE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B238BF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int Instantiate_TypeDefinitionIndex = 31642;
