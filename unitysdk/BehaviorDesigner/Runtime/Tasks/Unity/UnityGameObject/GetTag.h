...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A106070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A105F50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1060D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A106110)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A1061A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int GetTag_TypeDefinitionIndex = 31641;
