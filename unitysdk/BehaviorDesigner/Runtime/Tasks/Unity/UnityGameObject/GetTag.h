...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5DC40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5DB20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B5DCA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5DCE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETTAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5DD70)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int GetTag_TypeDefinitionIndex = 30689;
