...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SENDMESSAGE__ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA28A00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SENDMESSAGE__ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA28700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SENDMESSAGE___CTOR_OFFSET UNITYSDK_OFFSET(0x1AA28A60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SENDMESSAGE____BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA28AA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SENDMESSAGE____BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA28B30)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int SendMessage__TypeDefinitionIndex = 30691;
