...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SENDMESSAGE__ONRESET_OFFSET UNITYSDK_OFFSET(0x1B036D70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SENDMESSAGE__ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B036A70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SENDMESSAGE___CTOR_OFFSET UNITYSDK_OFFSET(0x1B036DD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SENDMESSAGE____BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B036E10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_SENDMESSAGE____BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B036EA0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int SendMessage__TypeDefinitionIndex = 31643;
