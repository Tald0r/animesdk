...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARETAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFFA980)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARETAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFFA870)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARETAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFA9E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARETAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFFAA20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_COMPARETAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFFAAB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int CompareTag_TypeDefinitionIndex = 31634;
