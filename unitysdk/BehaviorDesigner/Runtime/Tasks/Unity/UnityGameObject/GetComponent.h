...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BE790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BE620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BE840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0BE880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0BE8C0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int GetComponent_TypeDefinitionIndex = 31640;
