...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA67220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA670B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA672D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA67310)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_GETCOMPONENT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA67350)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int GetComponent_TypeDefinitionIndex = 30688;
