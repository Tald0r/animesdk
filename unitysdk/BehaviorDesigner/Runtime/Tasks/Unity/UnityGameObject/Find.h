...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FIND_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B265A20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FIND_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B265920)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B265A70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FIND___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B265AB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FIND___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B265B40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int Find_TypeDefinitionIndex = 31637;
