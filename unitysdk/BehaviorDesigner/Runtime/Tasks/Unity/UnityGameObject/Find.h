...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FIND_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5FCD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FIND_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5FBD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5FD20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FIND___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5FD60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYGAMEOBJECT_FIND___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5FDF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityGameObject
{
	inline static constexpr unsigned int Find_TypeDefinitionIndex = 30685;
