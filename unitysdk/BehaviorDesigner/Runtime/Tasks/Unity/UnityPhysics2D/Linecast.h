...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC617D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC61630)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC61840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC61890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC61920)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPhysics2D
{
	inline static constexpr unsigned int Linecast_TypeDefinitionIndex = 30568;
