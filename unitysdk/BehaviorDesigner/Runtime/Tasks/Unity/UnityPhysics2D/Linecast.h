...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B267510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B267370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B267580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B2675D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_LINECAST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B267660)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPhysics2D
{
	inline static constexpr unsigned int Linecast_TypeDefinitionIndex = 31520;

	class Linecast : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedVector2* startPosition; // 0x58
		::BehaviorDesigner::Runtime::SharedVector2* endPosition; // 0x60
