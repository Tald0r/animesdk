...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_RAYCAST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B290800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_RAYCAST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B28FFF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_RAYCAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B290890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_RAYCAST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B290900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_RAYCAST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B290990)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPhysics2D
{
	inline static constexpr unsigned int Raycast_TypeDefinitionIndex = 31521;

	class Raycast : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedFloat* storeHitDistance; // 0x58
		::BehaviorDesigner::Runtime::SharedVector2* originPosition; // 0x60
		::BehaviorDesigner::Runtime::SharedGameObject* storeHitObject; // 0x68
		::BehaviorDesigner::Runtime::SharedVector2* storeHitNormal; // 0x70
		::BehaviorDesigner::Runtime::SharedVector2* direction; // 0x78
		::BehaviorDesigner::Runtime::SharedGameObject* originGameObject; // 0x80
		::BehaviorDesigner::Runtime::SharedFloat* distance; // 0x88
		::BehaviorDesigner::Runtime::SharedVector2* storeHitPoint; // 0x90
