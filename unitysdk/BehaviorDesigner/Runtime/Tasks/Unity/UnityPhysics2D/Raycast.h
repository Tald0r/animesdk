...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_RAYCAST_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC77260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_RAYCAST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC76A60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_RAYCAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC772F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_RAYCAST___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC77350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYPHYSICS2D_RAYCAST___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC773E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityPhysics2D
{
	inline static constexpr unsigned int Raycast_TypeDefinitionIndex = 30569;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedGameObject* originGameObject; // 0x68
		::BehaviorDesigner::Runtime::SharedGameObject* storeHitObject; // 0x70
		::BehaviorDesigner::Runtime::SharedVector2* storeHitNormal; // 0x78
		::BehaviorDesigner::Runtime::SharedVector2* storeHitPoint; // 0x80
