...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDFLOAT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0B200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDFLOAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0B150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0B260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDFLOAT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0B2A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDFLOAT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0B330)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SetSharedFloat_TypeDefinitionIndex = 30465;
