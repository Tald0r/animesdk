...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDFLOAT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B21F9D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDFLOAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B21F920)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21FA30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDFLOAT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B21FA70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDFLOAT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B21FB00)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SetSharedFloat_TypeDefinitionIndex = 31417;
