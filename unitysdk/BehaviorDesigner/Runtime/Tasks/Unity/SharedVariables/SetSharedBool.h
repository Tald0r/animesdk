...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDBOOL_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5B080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDBOOL_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5AFC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x19B5B1C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDBOOL___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5B200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDBOOL___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5B290)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SetSharedBool_TypeDefinitionIndex = 30463;
