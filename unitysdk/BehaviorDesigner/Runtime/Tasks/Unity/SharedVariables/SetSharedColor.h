...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDCOLOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A62F200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDCOLOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A62F120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A62F280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDCOLOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A62F2C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDCOLOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A62F350)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SetSharedColor_TypeDefinitionIndex = 30464;
