...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDSTRING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC07EE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDSTRING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC07DA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC07F40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDSTRING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC07F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDSTRING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC08010)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int CompareSharedString_TypeDefinitionIndex = 31409;
