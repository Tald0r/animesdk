...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDRECT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B236800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDRECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B236580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B236880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDRECT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B2368C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDRECT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B236950)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int CompareSharedRect_TypeDefinitionIndex = 31408;

	class CompareSharedRect : public ::BehaviorDesigner::Runtime::Tasks::Conditional
	{
	public:
		::BehaviorDesigner::Runtime::SharedRect* compareTo; // 0x50
		::BehaviorDesigner::Runtime::SharedRect* variable; // 0x58
