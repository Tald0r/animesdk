...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A102A70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A1027F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A102AE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A102B20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A102BB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int CompareSharedQuaternion_TypeDefinitionIndex = 31407;
