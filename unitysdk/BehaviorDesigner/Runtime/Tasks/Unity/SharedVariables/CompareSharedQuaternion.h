...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5A640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5A3C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x19B5A6B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B5A6F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDQUATERNION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B5A780)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int CompareSharedQuaternion_TypeDefinitionIndex = 30455;

	class CompareSharedQuaternion : public ::BehaviorDesigner::Runtime::Tasks::Conditional
	{
	public:
		::BehaviorDesigner::Runtime::SharedQuaternion* variable; // 0x50
		::BehaviorDesigner::Runtime::SharedQuaternion* compareTo; // 0x58
