...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD16800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD16720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD16880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD168C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD16950)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SetSharedRect_TypeDefinitionIndex = 30472;
