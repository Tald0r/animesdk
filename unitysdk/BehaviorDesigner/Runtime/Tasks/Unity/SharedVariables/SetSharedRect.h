...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B330D80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B330CA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B330E00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B330E40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDRECT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B330ED0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SetSharedRect_TypeDefinitionIndex = 31424;
