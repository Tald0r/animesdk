...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDFLOAT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0A910)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDFLOAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0A7A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0A970)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDFLOAT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0A9B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDFLOAT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0AA40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int CompareSharedFloat_TypeDefinitionIndex = 30449;
