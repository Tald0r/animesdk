...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDFLOAT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B21F0E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDFLOAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B21EF70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21F140)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDFLOAT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B21F180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDFLOAT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B21F210)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int CompareSharedFloat_TypeDefinitionIndex = 31401;
