...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A864120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A863F30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A864170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A8641B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A864240)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SharedTransformToGameObject_TypeDefinitionIndex = 31433;
