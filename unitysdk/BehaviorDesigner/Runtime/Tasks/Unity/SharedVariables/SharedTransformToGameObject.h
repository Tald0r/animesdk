...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A67E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A65F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A6830)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A6870)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SHAREDTRANSFORMTOGAMEOBJECT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A6900)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SharedTransformToGameObject_TypeDefinitionIndex = 30481;
