...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDINT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B28A1E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDINT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B28A0F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B28A320)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDINT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B28A360)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_COMPARESHAREDINT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B28A3F0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int CompareSharedInt_TypeDefinitionIndex = 31404;
