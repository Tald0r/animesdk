...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR2_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A31D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR2_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A3120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A3230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR2___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4A3270)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_SHAREDVARIABLES_SETSHAREDVECTOR2___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4A3300)

namespace BehaviorDesigner::Runtime::Tasks::Unity::SharedVariables
{
	inline static constexpr unsigned int SetSharedVector2_TypeDefinitionIndex = 31428;
