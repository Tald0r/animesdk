...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_SETENABLED_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E813E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_SETENABLED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E811F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_SETENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x19E814D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_SETENABLED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E81510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_SETENABLED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E815A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityBehaviour
{
	inline static constexpr unsigned int SetEnabled_TypeDefinitionIndex = 30720;
