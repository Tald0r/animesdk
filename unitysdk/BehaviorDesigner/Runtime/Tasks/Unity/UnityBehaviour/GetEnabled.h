...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_GETENABLED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC8F060)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_GETENABLED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC8EED0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_GETENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC8F150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_GETENABLED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC8F190)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_GETENABLED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC8F220)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityBehaviour
{
	inline static constexpr unsigned int GetEnabled_TypeDefinitionIndex = 31670;
