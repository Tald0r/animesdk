...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_ISENABLED_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0DD60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_ISENABLED_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0DC50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_ISENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0DDE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_ISENABLED___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0DE20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBEHAVIOUR_ISENABLED___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0DEB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityBehaviour
{
	inline static constexpr unsigned int IsEnabled_TypeDefinitionIndex = 30719;
