...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A636090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6358F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A635B10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x1A636130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A636170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A636200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_ROTATEAROUND___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A636290)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int RotateAround_TypeDefinitionIndex = 30410;
