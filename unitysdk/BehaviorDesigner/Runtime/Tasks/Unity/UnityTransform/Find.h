...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0F580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0F0F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0F310)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC0F5D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC0F610)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC0F6A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC0F730)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int Find_TypeDefinitionIndex = 31344;

	class Find : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedString* transformName; // 0x58
