...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A664300)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A663E70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A664090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1A664350)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A664390)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A664420)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_FIND___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6644B0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int Find_TypeDefinitionIndex = 30392;
