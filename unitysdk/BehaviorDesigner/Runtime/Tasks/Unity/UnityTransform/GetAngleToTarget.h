...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETANGLETOTARGET_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C42D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETANGLETOTARGET_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0C3930)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETANGLETOTARGET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C3B50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETANGLETOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C43C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETANGLETOTARGET___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0C44D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETANGLETOTARGET___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0C4510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETANGLETOTARGET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0C4550)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int GetAngleToTarget_TypeDefinitionIndex = 31345;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedBool* ignoreHeight; // 0x68
		::BehaviorDesigner::Runtime::SharedGameObject* targetGameObject; // 0x70
		::UnityEngine::GameObject* prevGameObject; // 0x78
		::BehaviorDesigner::Runtime::SharedGameObject* targetObject; // 0x80
		::UnityEngine::Transform* targetTransform; // 0x88
