...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILDCOUNT_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E86170)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILDCOUNT_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E85DB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILDCOUNT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E85FD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILDCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E86220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILDCOUNT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E86260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILDCOUNT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E862F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILDCOUNT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E86380)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int GetChildCount_TypeDefinitionIndex = 30395;
