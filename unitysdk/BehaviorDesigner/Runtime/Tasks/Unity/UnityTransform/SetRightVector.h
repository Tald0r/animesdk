...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFFE470)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFFDFF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFFE210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFE4E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFFE520)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFFE5B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFFE640)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int SetRightVector_TypeDefinitionIndex = 31371;
