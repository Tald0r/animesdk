...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA0E750)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA0E2D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA0E4F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA0E7C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA0E800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA0E890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETRIGHTVECTOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA0E920)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int SetRightVector_TypeDefinitionIndex = 30419;
