...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B2293C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B228F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B2291A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B229430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B229470)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B229500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B229590)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int SetPosition_TypeDefinitionIndex = 31370;
