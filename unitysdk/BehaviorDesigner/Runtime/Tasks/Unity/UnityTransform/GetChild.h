...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B44DF40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B44DB10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B44DD30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44E000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B44E040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B44E0D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETCHILD___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B44E160)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int GetChild_TypeDefinitionIndex = 31346;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedTransform* storeValue; // 0x78
