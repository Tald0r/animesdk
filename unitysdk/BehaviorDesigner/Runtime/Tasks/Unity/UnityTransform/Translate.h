...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1ABE20F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1ABE1BB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABE1DD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABE2160)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1ABE21B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1ABE2240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_TRANSLATE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABE22D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int Translate_TypeDefinitionIndex = 31374;
