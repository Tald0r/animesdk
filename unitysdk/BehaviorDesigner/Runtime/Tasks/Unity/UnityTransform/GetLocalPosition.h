...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A10B700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A10B300)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A10B520)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A10B770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A10B7B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A10B840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A10B8D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int GetLocalPosition_TypeDefinitionIndex = 31351;
