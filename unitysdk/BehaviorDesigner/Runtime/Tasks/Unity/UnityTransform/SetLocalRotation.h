...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E86840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E86410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E86630)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E868A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E868E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19E86970)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E86A00)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int SetLocalRotation_TypeDefinitionIndex = 30415;

	class SetLocalRotation : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::UnityEngine::GameObject* prevGameObject; // 0x58
		::BehaviorDesigner::Runtime::SharedQuaternion* localRotation; // 0x60
