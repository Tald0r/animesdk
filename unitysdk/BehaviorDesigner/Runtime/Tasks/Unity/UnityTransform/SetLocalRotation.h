...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4AA660)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4AA230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4AA450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4AA6C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A4AA700)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A4AA790)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALROTATION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4AA820)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int SetLocalRotation_TypeDefinitionIndex = 31367;
