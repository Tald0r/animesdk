...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETFORWARDVECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC64B60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETFORWARDVECTOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC64640)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETFORWARDVECTOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC64860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETFORWARDVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC64BD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETFORWARDVECTOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC64C10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETFORWARDVECTOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC64CA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETFORWARDVECTOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC64D30)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int GetForwardVector_TypeDefinitionIndex = 30397;
