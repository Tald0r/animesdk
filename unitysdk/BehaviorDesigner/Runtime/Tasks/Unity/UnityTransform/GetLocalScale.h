...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALSCALE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA6D420)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALSCALE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA6D020)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALSCALE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA6D240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA6D490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALSCALE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA6D4D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALSCALE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA6D510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETLOCALSCALE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA6D550)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int GetLocalScale_TypeDefinitionIndex = 30401;
