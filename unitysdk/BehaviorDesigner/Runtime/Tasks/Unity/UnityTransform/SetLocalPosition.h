...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA6D9E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA6D5A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA6D7C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA6DA50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA6DA90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA6DAD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_SETLOCALPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA6DB10)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int SetLocalPosition_TypeDefinitionIndex = 30414;

	class SetLocalPosition : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::UnityEngine::GameObject* prevGameObject; // 0x58
		::BehaviorDesigner::Runtime::SharedVector3* localPosition; // 0x60
