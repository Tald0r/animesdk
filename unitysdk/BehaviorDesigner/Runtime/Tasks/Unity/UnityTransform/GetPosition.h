...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA0D9A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA0D5A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA0D7C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA0DA10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA0DA50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA0DAE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYTRANSFORM_GETPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA0DB70)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityTransform
{
	inline static constexpr unsigned int GetPosition_TypeDefinitionIndex = 30403;
