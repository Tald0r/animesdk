...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_NORMALIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6657E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_NORMALIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6656B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_NORMALIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A665830)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_NORMALIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A665870)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_NORMALIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A665900)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int Normalize_TypeDefinitionIndex = 30387;
