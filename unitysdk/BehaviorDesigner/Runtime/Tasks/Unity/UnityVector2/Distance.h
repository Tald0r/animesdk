...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_DISTANCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A10BAB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_DISTANCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A10B960)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_DISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A10BB10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_DISTANCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A10BB50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_DISTANCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A10BBE0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int Distance_TypeDefinitionIndex = 31328;
