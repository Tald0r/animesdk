...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE35290)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE35130)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE352F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE35330)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE353C0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int Multiply_TypeDefinitionIndex = 30386;
