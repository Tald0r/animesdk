...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B44EDD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B44EC70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44EE30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B44EE70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MULTIPLY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B44EF00)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int Multiply_TypeDefinitionIndex = 31338;
