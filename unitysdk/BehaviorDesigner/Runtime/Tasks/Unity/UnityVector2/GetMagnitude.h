...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETMAGNITUDE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A10BD50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETMAGNITUDE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A10BC70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETMAGNITUDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A10BDB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETMAGNITUDE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A10BDF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETMAGNITUDE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A10BE80)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int GetMagnitude_TypeDefinitionIndex = 31330;
