...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETXY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B03F4E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETXY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B03F260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B03F540)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETXY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B03F580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETXY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B03F610)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int SetXY_TypeDefinitionIndex = 31343;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedFloat* yValue; // 0x68
