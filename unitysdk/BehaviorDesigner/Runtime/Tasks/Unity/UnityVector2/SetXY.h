...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETXY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA31180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETXY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA30F00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA311E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETXY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA31220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETXY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA312B0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int SetXY_TypeDefinitionIndex = 30391;
