...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETUPVECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A665500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETUPVECTOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6654A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETUPVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A665550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETUPVECTOR___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A665590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_GETUPVECTOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A665620)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int GetUpVector_TypeDefinitionIndex = 30381;
