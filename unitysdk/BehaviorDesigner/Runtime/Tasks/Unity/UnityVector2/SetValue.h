...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETVALUE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6377A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETVALUE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6376F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6377F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETVALUE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A637830)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_SETVALUE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6378C0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int SetValue_TypeDefinitionIndex = 30390;

	class SetValue : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedVector2* vector2Variable; // 0x58
		::BehaviorDesigner::Runtime::SharedVector2* vector2Value; // 0x60
