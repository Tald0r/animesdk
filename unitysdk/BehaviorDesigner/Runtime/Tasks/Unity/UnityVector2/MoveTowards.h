...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MOVETOWARDS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE34F70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MOVETOWARDS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE34CC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MOVETOWARDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE34FD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MOVETOWARDS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE35010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYVECTOR2_MOVETOWARDS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE350A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityVector2
{
	inline static constexpr unsigned int MoveTowards_TypeDefinitionIndex = 30385;
