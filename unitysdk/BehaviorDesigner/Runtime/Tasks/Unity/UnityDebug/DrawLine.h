...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_DRAWLINE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E4A10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_DRAWLINE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E4690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_DRAWLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E4B30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_DRAWLINE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6E4C60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_DRAWLINE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6E4CF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityDebug
{
	inline static constexpr unsigned int DrawLine_TypeDefinitionIndex = 30694;
