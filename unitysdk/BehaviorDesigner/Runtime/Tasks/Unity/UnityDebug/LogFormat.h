...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_LOGFORMAT_BUILDPARAMSARRAY_OFFSET UNITYSDK_OFFSET(0x1AC75550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_LOGFORMAT_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AC75EE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_LOGFORMAT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC75F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_LOGFORMAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC75370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_LOGFORMAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC76050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_LOGFORMAT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC76090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_LOGFORMAT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC76120)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityDebug
{
	inline static constexpr unsigned int LogFormat_TypeDefinitionIndex = 30696;

	class LogFormat : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedBool* logError; // 0x58
		::BehaviorDesigner::Runtime::SharedVariable* arg0; // 0x60
