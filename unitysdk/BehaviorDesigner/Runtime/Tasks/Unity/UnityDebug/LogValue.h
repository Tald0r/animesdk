...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_LOGVALUE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5FA20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_LOGVALUE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5F8D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_LOGVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5FA70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_LOGVALUE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC5FAB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYDEBUG_LOGVALUE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC5FB40)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityDebug
{
	inline static constexpr unsigned int LogValue_TypeDefinitionIndex = 30697;
