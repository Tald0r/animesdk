...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A632CC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6328B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A632AA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A632D30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A632D70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A632E00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A632E90)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityBoxCollider
{
	inline static constexpr unsigned int SetSize_TypeDefinitionIndex = 30717;
