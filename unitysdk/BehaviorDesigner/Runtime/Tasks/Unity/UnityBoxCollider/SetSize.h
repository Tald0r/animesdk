...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1ABDDEC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1ABDDAB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDDCA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABDDF30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1ABDDF70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1ABDE000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_SETSIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDE090)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityBoxCollider
{
	inline static constexpr unsigned int SetSize_TypeDefinitionIndex = 31669;
