...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_GETSIZE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFF8C80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_GETSIZE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFF88B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_GETSIZE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFF8AA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_GETSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFF8CF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_GETSIZE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFF8D30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_GETSIZE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFF8DC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYBOXCOLLIDER_GETSIZE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFF8E50)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityBoxCollider
{
	inline static constexpr unsigned int GetSize_TypeDefinitionIndex = 31667;
