...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A109B40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A109730)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A109950)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A109B90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A109BD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A109C60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A109CF0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int SetMass_TypeDefinitionIndex = 31456;
