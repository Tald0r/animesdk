...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B61720)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B61310)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B61530)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19B61770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19B617B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x19B61840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETMASS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19B618D0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int SetMass_TypeDefinitionIndex = 30504;

	class SetMass : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedFloat* mass; // 0x58
