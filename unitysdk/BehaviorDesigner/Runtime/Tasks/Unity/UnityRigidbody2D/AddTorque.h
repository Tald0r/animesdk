...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDTORQUE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1ABDFC30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDTORQUE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1ABDF820)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDTORQUE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDFA40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDTORQUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABDFC80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDTORQUE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1ABDFCC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDTORQUE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1ABDFD50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDTORQUE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDFDE0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int AddTorque_TypeDefinitionIndex = 31437;
