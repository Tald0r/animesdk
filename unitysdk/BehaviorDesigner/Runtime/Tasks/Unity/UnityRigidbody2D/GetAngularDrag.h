...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARDRAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B44C510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARDRAG_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B44C150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARDRAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B44C370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARDRAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44C560)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARDRAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B44C5A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARDRAG___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B44C630)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETANGULARDRAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B44C6C0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int GetAngularDrag_TypeDefinitionIndex = 31438;
