...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE32FB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE32C10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE32E30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE33000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE33040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE330D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISSLEEPING___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE33160)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int IsSleeping_TypeDefinitionIndex = 30496;
