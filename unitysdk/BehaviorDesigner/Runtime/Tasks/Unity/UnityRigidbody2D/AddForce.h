...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A108DF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A1089D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A108BF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A108E50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A108E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A108F20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A108FB0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int AddForce_TypeDefinitionIndex = 31435;
