...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA0C6D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA0C300)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA0C520)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA0C780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA0C7C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AA0C850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA0C8E0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int GetIsKinematic_TypeDefinitionIndex = 30490;
