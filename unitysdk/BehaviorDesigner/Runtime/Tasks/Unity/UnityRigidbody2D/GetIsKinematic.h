...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFFC3F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFFC020)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFFC240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFC4A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFFC4E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFFC570)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETISKINEMATIC___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFFC600)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int GetIsKinematic_TypeDefinitionIndex = 31442;
