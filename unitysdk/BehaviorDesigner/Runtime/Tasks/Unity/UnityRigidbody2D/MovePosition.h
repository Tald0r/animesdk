...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B23D080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B23CC70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B23CE90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B23D0E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B23D120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B23D1B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_MOVEPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B23D240)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int MovePosition_TypeDefinitionIndex = 31449;
