...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A635080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A634C70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A634E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6350E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A635120)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A6351B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETVELOCITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A635240)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int SetVelocity_TypeDefinitionIndex = 30505;

	class SetVelocity : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::BehaviorDesigner::Runtime::SharedVector2* velocity; // 0x58
