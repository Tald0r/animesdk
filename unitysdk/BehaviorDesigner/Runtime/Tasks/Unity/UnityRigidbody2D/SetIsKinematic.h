...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B227180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B226D70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B226F90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B227230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B227270)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B227300)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETISKINEMATIC___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B227390)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int SetIsKinematic_TypeDefinitionIndex = 31455;

	class SetIsKinematic : public ::BehaviorDesigner::Runtime::Tasks::Action
	{
	public:
		::UnityEngine::GameObject* prevGameObject; // 0x58
		::BehaviorDesigner::Runtime::SharedBool* isKinematic; // 0x60
