...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETANGULARDRAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC32260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETANGULARDRAG_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC31E50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETANGULARDRAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC32070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETANGULARDRAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC322B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETANGULARDRAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC322F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETANGULARDRAG___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AC32380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_SETANGULARDRAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC32410)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int SetAngularDrag_TypeDefinitionIndex = 30499;
