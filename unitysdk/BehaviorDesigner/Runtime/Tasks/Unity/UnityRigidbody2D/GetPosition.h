...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B291770)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2913A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B2915C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2917D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B291810)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2918A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B291930)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int GetPosition_TypeDefinitionIndex = 31444;
