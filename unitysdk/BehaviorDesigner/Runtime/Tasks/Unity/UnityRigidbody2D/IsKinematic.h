...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISKINEMATIC_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE5C550)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISKINEMATIC_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE5C1B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISKINEMATIC_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE5C3D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISKINEMATIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE5C5A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISKINEMATIC___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE5C5E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISKINEMATIC___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AE5C670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ISKINEMATIC___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE5C700)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int IsKinematic_TypeDefinitionIndex = 30495;
