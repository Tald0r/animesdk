...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCEATPOSITION_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A1094D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCEATPOSITION_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A109040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCEATPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A109260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCEATPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A109540)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCEATPOSITION___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A109580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCEATPOSITION___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1A109610)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_ADDFORCEATPOSITION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A1096A0)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int AddForceAtPosition_TypeDefinitionIndex = 31436;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVector2* force; // 0x70
		::UnityEngine::Rigidbody2D* rigidbody2D; // 0x78
