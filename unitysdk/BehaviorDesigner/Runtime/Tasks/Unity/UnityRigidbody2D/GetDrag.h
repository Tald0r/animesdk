...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETDRAG_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B269860)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETDRAG_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2694A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETDRAG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B2696C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETDRAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2698B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETDRAG___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B2698F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETDRAG___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B269980)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETDRAG___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B269A10)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int GetDrag_TypeDefinitionIndex = 31440;
