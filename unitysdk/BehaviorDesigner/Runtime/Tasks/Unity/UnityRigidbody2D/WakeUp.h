...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFFD080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFFCCE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFFCF00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFD0D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AFFD110)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AFFD1A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_WAKEUP___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFFD230)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int WakeUp_TypeDefinitionIndex = 31459;
