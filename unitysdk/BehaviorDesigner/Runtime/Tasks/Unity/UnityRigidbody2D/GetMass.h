...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B337460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B3370A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B3372C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3374B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B3374F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B337580)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B337610)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int GetMass_TypeDefinitionIndex = 31443;
