...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD1CEE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD1CB20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD1CD40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD1CF30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AD1CF70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1AD1D000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNITY_UNITYRIGIDBODY2D_GETMASS___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD1D090)

namespace BehaviorDesigner::Runtime::Tasks::Unity::UnityRigidbody2D
{
	inline static constexpr unsigned int GetMass_TypeDefinitionIndex = 30491;
