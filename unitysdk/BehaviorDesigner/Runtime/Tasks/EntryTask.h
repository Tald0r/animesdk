...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_ENTRYTASK_MAXCHILDREN_OFFSET UNITYSDK_OFFSET(0x1A2A3DF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_ENTRYTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A3F80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_ENTRYTASK___BASE_MAXCHILDREN_OFFSET UNITYSDK_OFFSET(0x1A2A3FC0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int EntryTask_TypeDefinitionIndex = 30344;
