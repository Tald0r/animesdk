...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B446740)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1B4467F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD_ONEND_OFFSET UNITYSDK_OFFSET(0x1B4469E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B446AC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1B446930)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD_TASKEXECUTING_OFFSET UNITYSDK_OFFSET(0x1B4468D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B446B80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B446BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD___BASE_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1B446C50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B446CE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B446D70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1B446E00)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int TaskGuard_TypeDefinitionIndex = 31293;
