...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AE2CC10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1AE2CCC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD_ONEND_OFFSET UNITYSDK_OFFSET(0x1AE2CEB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE2CF90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1AE2CE00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD_TASKEXECUTING_OFFSET UNITYSDK_OFFSET(0x1AE2CDA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE2D040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AE2D080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD___BASE_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1AE2D110)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AE2D1A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AE2D230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASKGUARD___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1AE2D2C0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int TaskGuard_TypeDefinitionIndex = 30341;
