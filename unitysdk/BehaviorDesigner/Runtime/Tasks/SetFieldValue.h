...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SETFIELDVALUE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A5FF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SETFIELDVALUE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A5AF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SETFIELDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A6040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SETFIELDVALUE___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A2A6080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_SETFIELDVALUE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2A6110)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int SetFieldValue_TypeDefinitionIndex = 30310;
