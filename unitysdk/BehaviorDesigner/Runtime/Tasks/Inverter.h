...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INVERTER_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AC8B180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INVERTER_DECORATE_OFFSET UNITYSDK_OFFSET(0x1AC8B220)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INVERTER_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AC8B1D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INVERTER_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC8B280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC8B2D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INVERTER___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1AC8B310)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INVERTER___BASE_DECORATE_OFFSET UNITYSDK_OFFSET(0x1AC8B3A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INVERTER___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1AC8B430)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_INVERTER___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC8B4C0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Inverter_TypeDefinitionIndex = 31289;
