...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC08E10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC09040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1AC08E50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC08DC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1AC08D50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC090A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC090F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC09180)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1AC09210)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC092A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1AC09330)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasEnteredTrigger_TypeDefinitionIndex = 30278;
