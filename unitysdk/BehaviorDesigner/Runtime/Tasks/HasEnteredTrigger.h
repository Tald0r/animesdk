...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_ONEND_OFFSET UNITYSDK_OFFSET(0x1B21D5E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B21D810)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1B21D620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B21D590)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B21D520)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21D870)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B21D8C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B21D950)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1B21D9E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B21DA70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDTRIGGER___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B21DB00)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasEnteredTrigger_TypeDefinitionIndex = 31230;
