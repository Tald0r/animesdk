...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B291B60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_CANREEVALUATE_OFFSET UNITYSDK_OFFSET(0x1B291E70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B291E30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1B291AD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B291BD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1B291B10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1B291D40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONEND_OFFSET UNITYSDK_OFFSET(0x1B291D90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONREEVALUATIONENDED_OFFSET UNITYSDK_OFFSET(0x1B291F00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONREEVALUATIONSTARTED_OFFSET UNITYSDK_OFFSET(0x1B291EB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2919C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1B291DE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2920D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B292140)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_CANREEVALUATE_OFFSET UNITYSDK_OFFSET(0x1B2921D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_CANRUNPARALLELCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B292260)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1B2922F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B292380)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONCHILDSTARTED_OFFSET UNITYSDK_OFFSET(0x1B292420)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1B2924B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B292540)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONREEVALUATIONENDED_OFFSET UNITYSDK_OFFSET(0x1B2925D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONREEVALUATIONSTARTED_OFFSET UNITYSDK_OFFSET(0x1B292660)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2926F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UTILITYSELECTOR___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1B292780)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int UtilitySelector_TypeDefinitionIndex = 31278;
