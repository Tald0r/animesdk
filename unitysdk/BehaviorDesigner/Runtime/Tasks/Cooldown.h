...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B21CE10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1B21CEE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B21CF30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN_ONEND_OFFSET UNITYSDK_OFFSET(0x1B21D110)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN_OVERRIDESTATUS_1_OFFSET UNITYSDK_OFFSET(0x1B21D0B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1B21CF90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21D160)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B21D1C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1B21D250)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B21D2E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B21D370)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN___BASE_OVERRIDESTATUS_1_OFFSET UNITYSDK_OFFSET(0x1B21D490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_COOLDOWN___BASE_OVERRIDESTATUS_OFFSET UNITYSDK_OFFSET(0x1B21D400)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Cooldown_TypeDefinitionIndex = 31286;
