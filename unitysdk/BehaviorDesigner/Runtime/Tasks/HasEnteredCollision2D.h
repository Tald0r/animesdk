...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D_ONCOLLISIONENTER2D_OFFSET UNITYSDK_OFFSET(0x1B031C00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D_ONEND_OFFSET UNITYSDK_OFFSET(0x1B031BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B031DF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B031B70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B031B00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1B031E50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D___BASE_ONCOLLISIONENTER2D_OFFSET UNITYSDK_OFFSET(0x1B031EA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B031F30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B031FC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B032050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B0320E0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasEnteredCollision2D_TypeDefinitionIndex = 31229;
