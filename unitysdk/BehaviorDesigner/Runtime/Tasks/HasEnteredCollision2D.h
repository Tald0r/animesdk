...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D_ONCOLLISIONENTER2D_OFFSET UNITYSDK_OFFSET(0x1AA23880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D_ONEND_OFFSET UNITYSDK_OFFSET(0x1AA23840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA23A70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA237F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1AA23780)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA23AD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D___BASE_ONCOLLISIONENTER2D_OFFSET UNITYSDK_OFFSET(0x1AA23B20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AA23BB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AA23C40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA23CD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASENTEREDCOLLISION2D___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1AA23D60)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasEnteredCollision2D_TypeDefinitionIndex = 30277;
