...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILSUCCESS_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B26B410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILSUCCESS_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B26B460)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILSUCCESS_ONEND_OFFSET UNITYSDK_OFFSET(0x1B26B4B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILSUCCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B26B500)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILSUCCESS___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B26B540)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILSUCCESS___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B26B5D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_UNTILSUCCESS___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B26B660)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int UntilSuccess_TypeDefinitionIndex = 31295;
