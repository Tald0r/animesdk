...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_ACTION_GET_PROXY_SUBTASKS_OFFSET UNITYSDK_OFFSET(0x1A65A660)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_ACTION_GET_SUBTASKS_OFFSET UNITYSDK_OFFSET(0x1A65A680)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_ACTION_SET_PROXY_SUBTASKS_OFFSET UNITYSDK_OFFSET(0x1A65A670)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_ACTION_SET_SUBTASKS_OFFSET UNITYSDK_OFFSET(0x1A65A690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_ACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65A6A0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Action_TypeDefinitionIndex = 30272;
