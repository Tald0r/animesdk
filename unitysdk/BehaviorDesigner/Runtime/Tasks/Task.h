...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B0B9BD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GETDEFAULTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B0B8D20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GETPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B0B93D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GETUTILITY_OFFSET UNITYSDK_OFFSET(0x1B0B9410)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_DISABLED_OFFSET UNITYSDK_OFFSET(0x1B0B9ED0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_FRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1B0B9E70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B0B9B10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_ID_OFFSET UNITYSDK_OFFSET(0x1B0B9E50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x1B0B9E90)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_LASTSTATUS_OFFSET UNITYSDK_OFFSET(0x1B0B90A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x1B0B9E30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_PROXYFRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1B0B9060)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_PROXYID_OFFSET UNITYSDK_OFFSET(0x1B0B9040)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_PROXYINSTANT_OFFSET UNITYSDK_OFFSET(0x1B0B9080)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_PROXYOWNER_OFFSET UNITYSDK_OFFSET(0x1B0B9020)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_GET_REFERENCEID_OFFSET UNITYSDK_OFFSET(0x1B0B9EB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x1B0B9A70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1B0B9200)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONBEHAVIORCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1B0B9490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONBEHAVIORRESTART_OFFSET UNITYSDK_OFFSET(0x1B0B9450)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONCOLLISIONENTER2D_OFFSET UNITYSDK_OFFSET(0x1B0B98E0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x1B0B97A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1B0B9930)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x1B0B97F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1B0B9390)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x1B0B9A20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1B0B94D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONDRAWNODETEXT_OFFSET UNITYSDK_OFFSET(0x1B0B9510)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONEND_OFFSET UNITYSDK_OFFSET(0x1B0B9300)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0B92C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0B9280)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1B0B9340)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B0B8F40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B0B9240)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONTRIGGERENTER2D_OFFSET UNITYSDK_OFFSET(0x1B0B9980)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1B0B9840)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x1B0B99D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1B0B9890)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0B8FD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_DELETEALL_OFFSET UNITYSDK_OFFSET(0x1B0BA7B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_DELETEKEY_OFFSET UNITYSDK_OFFSET(0x1B0BA690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x1B0B9EF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_GETINT_OFFSET UNITYSDK_OFFSET(0x1B0BA0F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1B0BA2C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_HASKEY_OFFSET UNITYSDK_OFFSET(0x1B0BA490)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x1B0BA010)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_SETINT_OFFSET UNITYSDK_OFFSET(0x1B0BA1F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_PLAYERPREFS_SETSTRING_OFFSET UNITYSDK_OFFSET(0x1B0BA3C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B0B91B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SETGAMEOBJECTGETTER_OFFSET UNITYSDK_OFFSET(0x1B0B9AB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_DISABLED_OFFSET UNITYSDK_OFFSET(0x1B0B9EE0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_FRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1B0B9E80)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B0B9B00)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_ID_OFFSET UNITYSDK_OFFSET(0x1B0B9E60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x1B0B9EA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_LASTSTATUS_OFFSET UNITYSDK_OFFSET(0x1B0B90B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_OWNER_OFFSET UNITYSDK_OFFSET(0x1B0B9E40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_PROXYFRIENDLYNAME_OFFSET UNITYSDK_OFFSET(0x1B0B9070)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_PROXYID_OFFSET UNITYSDK_OFFSET(0x1B0B9050)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_PROXYINSTANT_OFFSET UNITYSDK_OFFSET(0x1B0B9090)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_PROXYOWNER_OFFSET UNITYSDK_OFFSET(0x1B0B9030)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_REFERENCEID_OFFSET UNITYSDK_OFFSET(0x1B0B9EC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_TASKTAGID_OFFSET UNITYSDK_OFFSET(0x1B0B9BB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_SET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B0B9BC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_STARTCOROUTINE_1_OFFSET UNITYSDK_OFFSET(0x1B0B95C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_STARTCOROUTINE_2_OFFSET UNITYSDK_OFFSET(0x1B0B9620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_STARTCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1B0B9560)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_STOPALLCOROUTINES_OFFSET UNITYSDK_OFFSET(0x1B0B9750)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_STOPCOROUTINE_1_OFFSET UNITYSDK_OFFSET(0x1B0B96F0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_STOPCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1B0B9690)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_TASKCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1B0B90C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK_TRYGETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B0B9CC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0BA9B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_TASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BA990)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int Task_TypeDefinitionIndex = 31227;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(Task_TypeDefinitionIndex)->GetStaticField(0x24E30);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>** StaticGet_sharedStringValueMap()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Task_TypeDefinitionIndex)->GetStaticField(0x24E38);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>** StaticGet_sharedIntValueMap()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Task_TypeDefinitionIndex)->GetStaticField(0x24E40);
		}
		static ::System::Int32* StaticGet_sharedMapState()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Task_TypeDefinitionIndex)->GetStaticField(0x7C10);
		}
		::BehaviorDesigner::Runtime::Tasks::GameObjectGetter* _innerGameObjectGetter; // 0x10
		::UnityEngine::GameObject* _innerGameObject; // 0x18
		...
		::BehaviorDesigner::Runtime::Tasks::TaskStatus _LastStatus_k__BackingField; // 0x48
