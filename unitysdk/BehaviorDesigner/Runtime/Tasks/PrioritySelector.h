...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PRIORITYSELECTOR_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B2337C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PRIORITYSELECTOR_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1B233760)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PRIORITYSELECTOR_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B233830)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PRIORITYSELECTOR_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1B233880)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PRIORITYSELECTOR_ONEND_OFFSET UNITYSDK_OFFSET(0x1B2338D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PRIORITYSELECTOR_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B2335B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PRIORITYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B233920)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PRIORITYSELECTOR___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x1B233990)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PRIORITYSELECTOR___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x1B233A20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PRIORITYSELECTOR___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x1B233AB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PRIORITYSELECTOR___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x1B233B40)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PRIORITYSELECTOR___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1B233BD0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_PRIORITYSELECTOR___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x1B233C60)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int PrioritySelector_TypeDefinitionIndex = 31272;
