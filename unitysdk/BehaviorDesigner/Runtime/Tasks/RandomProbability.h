...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1B288E60)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B289000)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B288F50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B289150)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1B2891A0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1B289230)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B2892C0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int RandomProbability_TypeDefinitionIndex = 31282;
