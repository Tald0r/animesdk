...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1AC6F8D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC6FA70)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC6F9C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC6FBC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x1AC6FC10)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC6FCA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_RANDOMPROBABILITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC6FD30)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int RandomProbability_TypeDefinitionIndex = 30330;
