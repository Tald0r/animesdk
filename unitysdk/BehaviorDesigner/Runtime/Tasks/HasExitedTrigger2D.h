...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC068C0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC06AF0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D_ONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x1AC06900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC06870)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1AC06800)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC06B50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1AC06BA0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1AC06C30)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D___BASE_ONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x1AC06CC0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC06D50)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1AC06DE0)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasExitedTrigger2D_TypeDefinitionIndex = 31235;
