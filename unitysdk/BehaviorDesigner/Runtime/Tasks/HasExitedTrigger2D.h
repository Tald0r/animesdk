...
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D_ONEND_OFFSET UNITYSDK_OFFSET(0x1A65B620)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A65B850)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D_ONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x1A65B660)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A65B5D0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1A65B560)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65B8B0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x1A65B900)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A65B990)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D___BASE_ONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x1A65BA20)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A65BAB0)
#define BEHAVIORDESIGNER_RUNTIME_TASKS_HASEXITEDTRIGGER2D___BASE_SELFCONTAINSMETHOD_OFFSET UNITYSDK_OFFSET(0x1A65BB40)

namespace BehaviorDesigner::Runtime::Tasks
{
	inline static constexpr unsigned int HasExitedTrigger2D_TypeDefinitionIndex = 30283;
