...
#define BEHAVIORDESIGNER_RUNTIME_IDTOTASKWRAPPER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8FE240)
#define BEHAVIORDESIGNER_RUNTIME_IDTOTASKWRAPPER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8FE250)
#define BEHAVIORDESIGNER_RUNTIME_IDTOTASKWRAPPER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8FE230)
#define BEHAVIORDESIGNER_RUNTIME_IDTOTASKWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x8FE220)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int IDToTaskWrapper_TypeDefinitionIndex = 30225;
