...
#define BEHAVIORDESIGNER_RUNTIME_IDTOTASKWRAPPER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x928870)
#define BEHAVIORDESIGNER_RUNTIME_IDTOTASKWRAPPER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x928880)
#define BEHAVIORDESIGNER_RUNTIME_IDTOTASKWRAPPER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x928860)
#define BEHAVIORDESIGNER_RUNTIME_IDTOTASKWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x928850)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int IDToTaskWrapper_TypeDefinitionIndex = 31178;
