...
#define BEHAVIORDESIGNER_RUNTIME_BEHAVIORMANAGER_BEHAVIORSUBTREELOADDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A3D50)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BehaviorManager_BehaviorSubTreeLoadData_TypeDefinitionIndex = 30189;
