...
#define BEHAVIORDESIGNER_RUNTIME_BINARYDESERIALIZECONTEXT_GET_TASKIDS_OFFSET UNITYSDK_OFFSET(0x1A65A0E0)
#define BEHAVIORDESIGNER_RUNTIME_BINARYDESERIALIZECONTEXT_SET_TASKIDS_OFFSET UNITYSDK_OFFSET(0x1A65A120)
#define BEHAVIORDESIGNER_RUNTIME_BINARYDESERIALIZECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65A160)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BinaryDeserializeContext_TypeDefinitionIndex = 30220;
	...
	public:
		...
		::Il2CppArray<::System::Byte>* BytesBuffer; // 0x18
		::System::Security::Cryptography::SHA1* Sha1; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::String*>* StringCache; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* FieldIndexMap; // 0x30
