...
#define BEHAVIORDESIGNER_RUNTIME_BINARYDESERIALIZECONTEXT_GET_TASKIDS_OFFSET UNITYSDK_OFFSET(0x1AC05380)
#define BEHAVIORDESIGNER_RUNTIME_BINARYDESERIALIZECONTEXT_SET_TASKIDS_OFFSET UNITYSDK_OFFSET(0x1AC053C0)
#define BEHAVIORDESIGNER_RUNTIME_BINARYDESERIALIZECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC05400)

namespace BehaviorDesigner::Runtime
{
	inline static constexpr unsigned int BinaryDeserializeContext_TypeDefinitionIndex = 31173;

	class BinaryDeserializeContext : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::String*>* StringCache; // 0x10
		::BehaviorDesigner::Runtime::IVariableSource* VariableSource; // 0x18
		::Il2CppArray<::System::Byte>* BytesBuffer; // 0x20
		::BehaviorDesigner::Runtime::FieldSerializationData* FieldSerializationData; // 0x28
		::System::Security::Cryptography::SHA1* Sha1; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* FieldIndexMap; // 0x38
		::System::Int32 AnimationCurveAdvance; // 0x40
		::System::Boolean StrHashSerialization; // 0x44
		::System::Boolean ShaHashSerialization; // 0x45
		::System::Boolean UpdatedSerialization; // 0x46
