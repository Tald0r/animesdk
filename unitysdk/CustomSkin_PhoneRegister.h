...
#define CUSTOMSKIN_PHONEREGISTER_CLICKBACKBTN_OFFSET UNITYSDK_OFFSET(0xD627470)
#define CUSTOMSKIN_PHONEREGISTER_CLICKCLOSEBTN_OFFSET UNITYSDK_OFFSET(0xD627510)
#define CUSTOMSKIN_PHONEREGISTER_CLICKUSERAGREEMENTBUTTON_OFFSET UNITYSDK_OFFSET(0xD627C10)
#define CUSTOMSKIN_PHONEREGISTER_CLICKUSERPRIVACYBUTTON_OFFSET UNITYSDK_OFFSET(0xD627CB0)
#define CUSTOMSKIN_PHONEREGISTER_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0xD627AF0)
#define CUSTOMSKIN_PHONEREGISTER_ENTERGAME_OFFSET UNITYSDK_OFFSET(0xD627F60)
#define CUSTOMSKIN_PHONEREGISTER_INSTANCE_OFFSET UNITYSDK_OFFSET(0xD6255E0)
#define CUSTOMSKIN_PHONEREGISTER_ONCLICKAGREMENTALLCHECKBOX_OFFSET UNITYSDK_OFFSET(0xD627D50)
#define CUSTOMSKIN_PHONEREGISTER_ONCLOSE_OFFSET UNITYSDK_OFFSET(0xD625760)
#define CUSTOMSKIN_PHONEREGISTER_ONCONSOLECANCEL_OFFSET UNITYSDK_OFFSET(0xD628530)
#define CUSTOMSKIN_PHONEREGISTER_ONELEMENTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0xD626470)
#define CUSTOMSKIN_PHONEREGISTER_ONOPENCONSOLEPROTOCOLWINDOW_OFFSET UNITYSDK_OFFSET(0xD6282F0)
#define CUSTOMSKIN_PHONEREGISTER_ONOPENLOGINREGISTER_OFFSET UNITYSDK_OFFSET(0xD625C70)
#define CUSTOMSKIN_PHONEREGISTER_ONPHONEINPUTVALUECHANGE_OFFSET UNITYSDK_OFFSET(0xD6275B0)
#define CUSTOMSKIN_PHONEREGISTER_ONPWDVALUECHANGE_OFFSET UNITYSDK_OFFSET(0xD627630)
#define CUSTOMSKIN_PHONEREGISTER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD625AD0)
#define CUSTOMSKIN_PHONEREGISTER_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0xD6276A0)
#define CUSTOMSKIN_PHONEREGISTER_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0xD627BA0)
#define CUSTOMSKIN_PHONEREGISTER_SETACCOUNTINPUT_OFFSET UNITYSDK_OFFSET(0xD6266E0)
#define CUSTOMSKIN_PHONEREGISTER_SETCHECKBOX_OFFSET UNITYSDK_OFFSET(0xD626E50)
#define CUSTOMSKIN_PHONEREGISTER_SETGETCODEBTN_OFFSET UNITYSDK_OFFSET(0xD626D80)
#define CUSTOMSKIN_PHONEREGISTER_SETPRIVACY_OFFSET UNITYSDK_OFFSET(0xD627120)
#define CUSTOMSKIN_PHONEREGISTER_SETPWDINPUT_OFFSET UNITYSDK_OFFSET(0xD626A70)
#define CUSTOMSKIN_PHONEREGISTER_SETREGISTER_OFFSET UNITYSDK_OFFSET(0xD626FE0)
#define CUSTOMSKIN_PHONEREGISTER_SETZONETIP_OFFSET UNITYSDK_OFFSET(0xD626600)
#define CUSTOMSKIN_PHONEREGISTER_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0xD6278F0)
#define CUSTOMSKIN_PHONEREGISTER_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0xD627260)
#define CUSTOMSKIN_PHONEREGISTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD6256E0)
#define CUSTOMSKIN_PHONEREGISTER__REQUESTVERIFYMESSAGE_B__21_0_OFFSET UNITYSDK_OFFSET(0xD628760)
#define CUSTOMSKIN_PHONEREGISTER___BASE_ONELEMENTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0xD628950)

inline static constexpr unsigned int CustomSkin_PhoneRegister_TypeDefinitionIndex = 66379;
...
public:
	...
	{
		return (::CustomSkin_PhoneRegister**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_PhoneRegister_TypeDefinitionIndex)->GetStaticField(0x438D0);
	}
