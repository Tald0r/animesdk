...
#define CUSTOMSKIN_PHONEREGISTER_CLICKBACKBTN_OFFSET UNITYSDK_OFFSET(0x9D35760)
#define CUSTOMSKIN_PHONEREGISTER_CLICKCLOSEBTN_OFFSET UNITYSDK_OFFSET(0x9D35800)
#define CUSTOMSKIN_PHONEREGISTER_CLICKUSERAGREEMENTBUTTON_OFFSET UNITYSDK_OFFSET(0x9D35F00)
#define CUSTOMSKIN_PHONEREGISTER_CLICKUSERPRIVACYBUTTON_OFFSET UNITYSDK_OFFSET(0x9D35FA0)
#define CUSTOMSKIN_PHONEREGISTER_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x9D35DE0)
#define CUSTOMSKIN_PHONEREGISTER_ENTERGAME_OFFSET UNITYSDK_OFFSET(0x9D36250)
#define CUSTOMSKIN_PHONEREGISTER_INSTANCE_OFFSET UNITYSDK_OFFSET(0x9D338F0)
#define CUSTOMSKIN_PHONEREGISTER_ONCLICKAGREMENTALLCHECKBOX_OFFSET UNITYSDK_OFFSET(0x9D36040)
#define CUSTOMSKIN_PHONEREGISTER_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x9D33A70)
#define CUSTOMSKIN_PHONEREGISTER_ONCONSOLECANCEL_OFFSET UNITYSDK_OFFSET(0x9D36820)
#define CUSTOMSKIN_PHONEREGISTER_ONELEMENTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x9D34770)
#define CUSTOMSKIN_PHONEREGISTER_ONOPENCONSOLEPROTOCOLWINDOW_OFFSET UNITYSDK_OFFSET(0x9D365E0)
#define CUSTOMSKIN_PHONEREGISTER_ONOPENLOGINREGISTER_OFFSET UNITYSDK_OFFSET(0x9D33F80)
#define CUSTOMSKIN_PHONEREGISTER_ONPHONEINPUTVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x9D358A0)
#define CUSTOMSKIN_PHONEREGISTER_ONPWDVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x9D35920)
#define CUSTOMSKIN_PHONEREGISTER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9D33DE0)
#define CUSTOMSKIN_PHONEREGISTER_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x9D35990)
#define CUSTOMSKIN_PHONEREGISTER_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x9D35E90)
#define CUSTOMSKIN_PHONEREGISTER_SETACCOUNTINPUT_OFFSET UNITYSDK_OFFSET(0x9D349E0)
#define CUSTOMSKIN_PHONEREGISTER_SETCHECKBOX_OFFSET UNITYSDK_OFFSET(0x9D35140)
#define CUSTOMSKIN_PHONEREGISTER_SETGETCODEBTN_OFFSET UNITYSDK_OFFSET(0x9D35070)
#define CUSTOMSKIN_PHONEREGISTER_SETPRIVACY_OFFSET UNITYSDK_OFFSET(0x9D35410)
#define CUSTOMSKIN_PHONEREGISTER_SETPWDINPUT_OFFSET UNITYSDK_OFFSET(0x9D34D70)
#define CUSTOMSKIN_PHONEREGISTER_SETREGISTER_OFFSET UNITYSDK_OFFSET(0x9D352D0)
#define CUSTOMSKIN_PHONEREGISTER_SETZONETIP_OFFSET UNITYSDK_OFFSET(0x9D34900)
#define CUSTOMSKIN_PHONEREGISTER_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x9D35BE0)
#define CUSTOMSKIN_PHONEREGISTER_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x9D35550)
#define CUSTOMSKIN_PHONEREGISTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D339F0)
#define CUSTOMSKIN_PHONEREGISTER__REQUESTVERIFYMESSAGE_B__21_0_OFFSET UNITYSDK_OFFSET(0x9D36A50)
#define CUSTOMSKIN_PHONEREGISTER___BASE_ONELEMENTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x9D36C40)

inline static constexpr unsigned int CustomSkin_PhoneRegister_TypeDefinitionIndex = 75523;
...
public:
	...
	{
		return (::CustomSkin_PhoneRegister**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_PhoneRegister_TypeDefinitionIndex)->GetStaticField(0x44480);
	}
