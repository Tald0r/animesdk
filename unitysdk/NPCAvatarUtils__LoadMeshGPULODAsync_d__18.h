...
#define NPCAVATARUTILS__LOADMESHGPULODASYNC_D__18_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x315460)
#define NPCAVATARUTILS__LOADMESHGPULODASYNC_D__18_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

inline static constexpr unsigned int NPCAvatarUtils__LoadMeshGPULODAsync_d__18_TypeDefinitionIndex = 48385;
