...
#define RICHTAP_COMMON_CONTROLLERSTATECHANGECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A7A82F0)
#define RICHTAP_COMMON_CONTROLLERSTATECHANGECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7A8360)
#define RICHTAP_COMMON_CONTROLLERSTATECHANGECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A7A7FB0)
#define RICHTAP_COMMON_CONTROLLERSTATECHANGECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A7FA0)

namespace RichTap::Common
{
	inline static constexpr unsigned int ControllerStateChangeCallback_TypeDefinitionIndex = 34954;
