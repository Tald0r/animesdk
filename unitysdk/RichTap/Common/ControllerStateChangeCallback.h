...
#define RICHTAP_COMMON_CONTROLLERSTATECHANGECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AD89FA0)
#define RICHTAP_COMMON_CONTROLLERSTATECHANGECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AD8A010)
#define RICHTAP_COMMON_CONTROLLERSTATECHANGECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AD89C60)
#define RICHTAP_COMMON_CONTROLLERSTATECHANGECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD89C40)

namespace RichTap::Common
{
	inline static constexpr unsigned int ControllerStateChangeCallback_TypeDefinitionIndex = 35956;
