...
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A7A7F20)
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7A7F90)
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A7A7BE0)
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A7BD0)

namespace RichTap::Common
{
	inline static constexpr unsigned int ControllerConnectionListener_TypeDefinitionIndex = 34953;
