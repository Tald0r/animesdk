...
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AD89BC0)
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AD89C30)
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AD89870)
#define RICHTAP_COMMON_CONTROLLERCONNECTIONLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD89850)

namespace RichTap::Common
{
	inline static constexpr unsigned int ControllerConnectionListener_TypeDefinitionIndex = 35955;
