...
#define RICHTAP_COMMON_HAPTICDATAMANAGER_ADDTOREALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1A7A8DA0)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_ADDTOVIRTUALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1A7A9230)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_CLEARPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1A7A9420)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_DECIDEREALPLAYBACK_OFFSET UNITYSDK_OFFSET(0x1A7A8370)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_GETREALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1A7A89D0)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_GETVIRTUALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1A7A8AD0)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_REMOVEFROMREALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1A7A8CA0)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_REMOVEFROMVIRTUALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1A7A9330)
#define RICHTAP_COMMON_HAPTICDATAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A9720)

namespace RichTap::Common
{
	inline static constexpr unsigned int HapticDataManager_TypeDefinitionIndex = 34946;

	class HapticDataManager : public ::RichTap::Internal::SingletonBase_1<::RichTap::Common::HapticDataManager*>
	{
	public:
		::System::Collections::Generic::List_1<::RichTap::Common::HapticDataModel*>* virtualPlayList; // 0x10
		::System::Object* realPlayLock; // 0x18
		::System::Collections::Generic::List_1<::RichTap::Common::HapticDataModel*>* realPlayList; // 0x20
