...
#define RICHTAP_COMMON_HAPTICDATAMANAGER_ADDTOREALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1AD8AA50)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_ADDTOVIRTUALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1AD8AEE0)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_CLEARPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1AD8B0D0)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_DECIDEREALPLAYBACK_OFFSET UNITYSDK_OFFSET(0x1AD8A020)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_GETREALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1AD8A680)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_GETVIRTUALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1AD8A780)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_REMOVEFROMREALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1AD8A950)
#define RICHTAP_COMMON_HAPTICDATAMANAGER_REMOVEFROMVIRTUALPLAYLIST_OFFSET UNITYSDK_OFFSET(0x1AD8AFE0)
#define RICHTAP_COMMON_HAPTICDATAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD8B3D0)

namespace RichTap::Common
{
	inline static constexpr unsigned int HapticDataManager_TypeDefinitionIndex = 35948;

	class HapticDataManager : public ::RichTap::Internal::SingletonBase_1<::RichTap::Common::HapticDataManager*>
	{
	public:
		::System::Object* realPlayLock; // 0x10
		::System::Object* virtualLock; // 0x18
		::System::Collections::Generic::List_1<::RichTap::Common::HapticDataModel*>* virtualPlayList; // 0x20
