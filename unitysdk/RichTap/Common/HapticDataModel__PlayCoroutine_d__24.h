...
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AD8BF40)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD8BFB0)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD8C010)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AD8BFC0)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD8BF30)
#define RICHTAP_COMMON_HAPTICDATAMODEL__PLAYCOROUTINE_D__24__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD8BD60)

namespace RichTap::Common
{
	inline static constexpr unsigned int HapticDataModel__PlayCoroutine_d__24_TypeDefinitionIndex = 35952;
