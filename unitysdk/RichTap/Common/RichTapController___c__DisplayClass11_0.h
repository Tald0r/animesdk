...
#define RICHTAP_COMMON_RICHTAPCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7AABD0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER___C__DISPLAYCLASS11_0__PLAY_B__0_OFFSET UNITYSDK_OFFSET(0x1A7AC320)

namespace RichTap::Common
{
	inline static constexpr unsigned int RichTapController___c__DisplayClass11_0_TypeDefinitionIndex = 34956;
