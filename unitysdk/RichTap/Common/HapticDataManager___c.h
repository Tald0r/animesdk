...
#define RICHTAP_COMMON_HAPTICDATAMANAGER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD8B4D0)
#define RICHTAP_COMMON_HAPTICDATAMANAGER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD8B510)
#define RICHTAP_COMMON_HAPTICDATAMANAGER___C__DECIDEREALPLAYBACK_B__5_0_OFFSET UNITYSDK_OFFSET(0x1AD8B520)

namespace RichTap::Common
{
	inline static constexpr unsigned int HapticDataManager___c_TypeDefinitionIndex = 35950;
	...
	public:
		...
		{
			return (::System::Comparison_1<::RichTap::Common::HapticDataModel*>**)Il2CppClass::FromTypeDefinitionIndex(HapticDataManager___c_TypeDefinitionIndex)->GetStaticField(0x265F0);
		}
		static ::RichTap::Common::HapticDataManager___c** StaticGet___9()
		{
			return (::RichTap::Common::HapticDataManager___c**)Il2CppClass::FromTypeDefinitionIndex(HapticDataManager___c_TypeDefinitionIndex)->GetStaticField(0x265F8);
		}
