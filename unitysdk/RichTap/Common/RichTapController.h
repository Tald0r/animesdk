...
#define RICHTAP_COMMON_RICHTAPCONTROLLER_ENABLEALLCONNECTEDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1AD8DC60)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_ENABLEALTERNATIVEASSETS_OFFSET UNITYSDK_OFFSET(0x1AD8D4A0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_ENABLESHOWPLAYINGHEDIALOG_OFFSET UNITYSDK_OFFSET(0x1AD8D630)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETCONNECTEDCONTROLLERCOUNT_OFFSET UNITYSDK_OFFSET(0x1AD8DA40)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETCONNECTEDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1AD8D8E0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1AD8C220)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1AD8D410)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETPLUGINVERSION_OFFSET UNITYSDK_OFFSET(0x1AD8C180)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETRECENTINPUTCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1AD8DD60)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETRICHTAPENABLE_OFFSET UNITYSDK_OFFSET(0x1AD8C1D0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x1AD8C140)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_ISRICHTAPSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1AD8C1E0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_PLAYPREBAKE_OFFSET UNITYSDK_OFFSET(0x1AD8C910)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0x1AD8C240)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_REGISTERCONTROLLERCONNECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1AD8C020)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_REGISTERCONTROLLERSTATECHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AD8C0B0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SENDLOOPPARAM_OFFSET UNITYSDK_OFFSET(0x1AD8CC90)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETGAIN_OFFSET UNITYSDK_OFFSET(0x1AD8CAE0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1AD8C200)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETINTLEVEL_OFFSET UNITYSDK_OFFSET(0x1AD8CC70)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETRICHTAPENABLE_OFFSET UNITYSDK_OFFSET(0x1AD8C1C0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETTARGETCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1AD8DB40)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_STOP_OFFSET UNITYSDK_OFFSET(0x1AD8CFE0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_UNINIT_OFFSET UNITYSDK_OFFSET(0x1AD8C160)
#define RICHTAP_COMMON_RICHTAPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD8DF80)

namespace RichTap::Common
{
	inline static constexpr unsigned int RichTapController_TypeDefinitionIndex = 35957;
	...
	public:
		...
		::System::Boolean enableRichtap; // 0x10
		::System::Single intLevel; // 0x14
