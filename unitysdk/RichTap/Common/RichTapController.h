...
#define RICHTAP_COMMON_RICHTAPCONTROLLER_ENABLEALLCONNECTEDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1A7ABFB0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_ENABLEALTERNATIVEASSETS_OFFSET UNITYSDK_OFFSET(0x1A7AB7F0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_ENABLESHOWPLAYINGHEDIALOG_OFFSET UNITYSDK_OFFSET(0x1A7AB980)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETCONNECTEDCONTROLLERCOUNT_OFFSET UNITYSDK_OFFSET(0x1A7ABD90)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETCONNECTEDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1A7ABC30)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1A7AA570)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1A7AB760)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETPLUGINVERSION_OFFSET UNITYSDK_OFFSET(0x1A7AA4D0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETRECENTINPUTCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1A7AC0B0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_GETRICHTAPENABLE_OFFSET UNITYSDK_OFFSET(0x1A7AA520)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x1A7AA490)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_ISRICHTAPSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1A7AA530)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_PLAYPREBAKE_OFFSET UNITYSDK_OFFSET(0x1A7AAC60)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0x1A7AA590)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_REGISTERCONTROLLERCONNECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1A7AA370)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_REGISTERCONTROLLERSTATECHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A7AA400)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SENDLOOPPARAM_OFFSET UNITYSDK_OFFSET(0x1A7AAFE0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETGAIN_OFFSET UNITYSDK_OFFSET(0x1A7AAE30)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1A7AA550)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETINTLEVEL_OFFSET UNITYSDK_OFFSET(0x1A7AAFC0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETRICHTAPENABLE_OFFSET UNITYSDK_OFFSET(0x1A7AA510)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_SETTARGETCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1A7ABE90)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_STOP_OFFSET UNITYSDK_OFFSET(0x1A7AB330)
#define RICHTAP_COMMON_RICHTAPCONTROLLER_UNINIT_OFFSET UNITYSDK_OFFSET(0x1A7AA4B0)
#define RICHTAP_COMMON_RICHTAPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7AC2D0)

namespace RichTap::Common
{
	inline static constexpr unsigned int RichTapController_TypeDefinitionIndex = 34955;
