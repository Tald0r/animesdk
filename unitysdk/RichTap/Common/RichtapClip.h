...
#define RICHTAP_COMMON_RICHTAPCLIP_GETCLIPNAME_OFFSET UNITYSDK_OFFSET(0x1A7ACF90)
#define RICHTAP_COMMON_RICHTAPCLIP_GETCONTENT_OFFSET UNITYSDK_OFFSET(0x1A7ACF80)
#define RICHTAP_COMMON_RICHTAPCLIP_LOAD_OFFSET UNITYSDK_OFFSET(0x1A7ACF50)
#define RICHTAP_COMMON_RICHTAPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7ACF00)

namespace RichTap::Common
{
	inline static constexpr unsigned int RichtapClip_TypeDefinitionIndex = 34952;
