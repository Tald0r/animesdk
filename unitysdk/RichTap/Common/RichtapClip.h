...
#define RICHTAP_COMMON_RICHTAPCLIP_GETCLIPNAME_OFFSET UNITYSDK_OFFSET(0x1AD8EC40)
#define RICHTAP_COMMON_RICHTAPCLIP_GETCONTENT_OFFSET UNITYSDK_OFFSET(0x1AD8EC30)
#define RICHTAP_COMMON_RICHTAPCLIP_LOAD_OFFSET UNITYSDK_OFFSET(0x1AD8EC00)
#define RICHTAP_COMMON_RICHTAPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD8EBB0)

namespace RichTap::Common
{
	inline static constexpr unsigned int RichtapClip_TypeDefinitionIndex = 35954;
