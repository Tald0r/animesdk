...
#define RICHTAP_COMMON_RICHTAPSDKROUTER_ENABLEALLCONNECTEDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1AD8DCE0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETCONNECTEDCONTROLLERCOUNT_OFFSET UNITYSDK_OFFSET(0x1AD8DAC0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETCONNECTEDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1AD8D990)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1AD8C230)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1AD8C890)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETPREBAKEDLENGTH_OFFSET UNITYSDK_OFFSET(0x1AD8CAD0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETRECENTINPUTCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1AD8DDE0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_GETRICHTAPSDKVERSION_OFFSET UNITYSDK_OFFSET(0x1AD8E430)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_INIT_OFFSET UNITYSDK_OFFSET(0x1AD8C150)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_ISRICHTAPSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1AD8C1F0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_PLAYPREBAKE_OFFSET UNITYSDK_OFFSET(0x1AD8B8E0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_PLAY_OFFSET UNITYSDK_OFFSET(0x1AD8B810)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_REGISTERCONTROLLERCONNECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1AD8DE60)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_REGISTERCONTROLLERSTATECHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AD8DEF0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_SENDLOOPPARAM_OFFSET UNITYSDK_OFFSET(0x1AD8CFD0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_SETGAIN_OFFSET UNITYSDK_OFFSET(0x1AD8CC60)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_SETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1AD8C210)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_SETTARGETCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1AD8DBD0)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_STOP_OFFSET UNITYSDK_OFFSET(0x1AD8BE70)
#define RICHTAP_COMMON_RICHTAPSDKROUTER_UNINIT_OFFSET UNITYSDK_OFFSET(0x1AD8C170)
#define RICHTAP_COMMON_RICHTAPSDKROUTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD8EBA0)

namespace RichTap::Common
{
	inline static constexpr unsigned int RichTapSDKRouter_TypeDefinitionIndex = 35953;
