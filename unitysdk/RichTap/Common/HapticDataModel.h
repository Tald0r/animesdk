...
#define RICHTAP_COMMON_HAPTICDATAMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7A9930)
#define RICHTAP_COMMON_HAPTICDATAMODEL_NOTIFYPLAYCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A7AA000)
#define RICHTAP_COMMON_HAPTICDATAMODEL_PLAYCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A7A9E30)
#define RICHTAP_COMMON_HAPTICDATAMODEL_RELEASECOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A7A9990)
#define RICHTAP_COMMON_HAPTICDATAMODEL_STARTREALPLAY_OFFSET UNITYSDK_OFFSET(0x1A7A8E90)
#define RICHTAP_COMMON_HAPTICDATAMODEL_STARTVIRTUALPLAY_OFFSET UNITYSDK_OFFSET(0x1A7A9C40)
#define RICHTAP_COMMON_HAPTICDATAMODEL_STOPREALPLAY_OFFSET UNITYSDK_OFFSET(0x1A7A8BD0)
#define RICHTAP_COMMON_HAPTICDATAMODEL_STOPVIRTUALPLAY_OFFSET UNITYSDK_OFFSET(0x1A7A9660)
#define RICHTAP_COMMON_HAPTICDATAMODEL_UPDATELOOPPARAMS_OFFSET UNITYSDK_OFFSET(0x1A7AA240)
#define RICHTAP_COMMON_HAPTICDATAMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7AA250)

namespace RichTap::Common
{
	inline static constexpr unsigned int HapticDataModel_TypeDefinitionIndex = 34949;

	class HapticDataModel : public ::System::Object
	{
	public:
		::UnityEngine::Events::UnityAction_1<::System::Boolean>* RealPlayCompleted; // 0x10
		::UnityEngine::Events::UnityAction_1<::System::Boolean>* VirtualPlayCompleted; // 0x18
		::System::String* name; // 0x20
		::System::String* identifier; // 0x28
		::System::String* uuid; // 0x30
		::System::String* heData; // 0x38
		::System::Int32 priority; // 0x40
		::System::Int32 prebakeId; // 0x44
		::System::Int64 startTime; // 0x48
		::System::Int32 duration; // 0x50
		::System::Int32 playId; // 0x54
		::System::Int32 interval; // 0x58
		::RichTap::Types::FXPlayType type; // 0x5C
		::System::Int32 loop; // 0x60
		::System::Int32 insertionIndex; // 0x64
		::System::Int32 startOffset; // 0x68
		::System::Int32 currentLoopNum; // 0x6C
		::System::Int32 amplitude; // 0x70
		::System::Int32 frequency; // 0x74
