...
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A7ADBB0)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_DEVICENAME_OFFSET UNITYSDK_OFFSET(0x1A7ADBF0)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_ENABLEALLCONNECTEDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1A7ACD50)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_ENABLELOG_OFFSET UNITYSDK_OFFSET(0x1A7AD950)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_ENABLETARGETCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1A7ACCC0)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_GETCONNECTEDCONTROLLERCOUNT_OFFSET UNITYSDK_OFFSET(0x1A7ACC40)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_GETCONNECTEDGAMECONTROLLERS_OFFSET UNITYSDK_OFFSET(0x1A7ACBC0)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_GETDURATION_OFFSET UNITYSDK_OFFSET(0x1A7AC980)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_GETRECENTINPUTCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1A7ADB30)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_GETVERSIONNAME_OFFSET UNITYSDK_OFFSET(0x1A7AD840)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_GETVERSION_OFFSET UNITYSDK_OFFSET(0x1A7AC790)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A7AD740)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_INIT_OFFSET UNITYSDK_OFFSET(0x1A7AC420)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_PLAY_OFFSET UNITYSDK_OFFSET(0x1A7AC8C0)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_QUIT_OFFSET UNITYSDK_OFFSET(0x1A7AC670)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_REGISTERCONTROLLERCONNECTIONLISTENER_OFFSET UNITYSDK_OFFSET(0x1A7ACDD0)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_REGISTERCONTROLLERSTATECHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A7ACE60)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A7AD7C0)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_SENDLOOPPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A7AD8C0)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_SETMULTIPOINTTRIGGERMODE_OFFSET UNITYSDK_OFFSET(0x1A7ADA90)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_SETTRIGGERMODE_OFFSET UNITYSDK_OFFSET(0x1A7AD9D0)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_STOP_OFFSET UNITYSDK_OFFSET(0x1A7ACB40)
#define RICHTAP_PLATFORMS_XINPUT_XINPUTNATIVEBRIDGE_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x1A7ACA00)

namespace RichTap::Platforms::XInput
{
	inline static constexpr unsigned int XInputNativeBridge_TypeDefinitionIndex = 34940;
