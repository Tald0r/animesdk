...
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_ADD_ONPLAYEVENTCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1A7AD1F0)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_GETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1A7AD730)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1A7AD700)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_GETPREBAKEDLENGTH_OFFSET UNITYSDK_OFFSET(0x1A7AD6F0)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_GETVERSION_OFFSET UNITYSDK_OFFSET(0x1A7AD370)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A7AD350)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_ISRICHTAPEFFECTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1A7AD360)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_ONPLAYEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A7AD3D0)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_PLAYPREBAKE_OFFSET UNITYSDK_OFFSET(0x1A7AD380)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_PLAY_OFFSET UNITYSDK_OFFSET(0x1A7AD390)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_QUIT_OFFSET UNITYSDK_OFFSET(0x1A7AD3B0)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_REMOVE_ONPLAYEVENTCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1A7AD2A0)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_SETGAIN_OFFSET UNITYSDK_OFFSET(0x1A7AD710)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_SETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1A7AD720)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_STOP_OFFSET UNITYSDK_OFFSET(0x1A7AD3A0)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x1A7AD3C0)

namespace RichTap::Platforms::Mobile
{
	inline static constexpr unsigned int IOSSDKBridge_TypeDefinitionIndex = 34943;
	...
	public:
		...
		{
			return (::System::Action_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(IOSSDKBridge_TypeDefinitionIndex)->GetStaticField(0x24BE0);
		}
