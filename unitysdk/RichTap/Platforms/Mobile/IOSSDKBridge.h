...
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_ADD_ONPLAYEVENTCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1AD8EEA0)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_GETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1AD8F3E0)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1AD8F3B0)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_GETPREBAKEDLENGTH_OFFSET UNITYSDK_OFFSET(0x1AD8F3A0)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_GETVERSION_OFFSET UNITYSDK_OFFSET(0x1AD8F020)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AD8F000)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_ISRICHTAPEFFECTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1AD8F010)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_ONPLAYEREVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AD8F080)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_PLAYPREBAKE_OFFSET UNITYSDK_OFFSET(0x1AD8F030)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_PLAY_OFFSET UNITYSDK_OFFSET(0x1AD8F040)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_QUIT_OFFSET UNITYSDK_OFFSET(0x1AD8F060)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_REMOVE_ONPLAYEVENTCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1AD8EF50)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_SETGAIN_OFFSET UNITYSDK_OFFSET(0x1AD8F3C0)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_SETHAPTICMODE_OFFSET UNITYSDK_OFFSET(0x1AD8F3D0)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_STOP_OFFSET UNITYSDK_OFFSET(0x1AD8F050)
#define RICHTAP_PLATFORMS_MOBILE_IOSSDKBRIDGE_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x1AD8F070)

namespace RichTap::Platforms::Mobile
{
	inline static constexpr unsigned int IOSSDKBridge_TypeDefinitionIndex = 35945;
	...
	public:
		...
		{
			return (::System::Action_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(IOSSDKBridge_TypeDefinitionIndex)->GetStaticField(0x26610);
		}
