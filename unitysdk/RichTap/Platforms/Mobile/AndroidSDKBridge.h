...
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_GETDURATION_OFFSET UNITYSDK_OFFSET(0x1A7AD040)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_GETPREBAKEDURATION_OFFSET UNITYSDK_OFFSET(0x1A7AD050)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_GETVERSION_OFFSET UNITYSDK_OFFSET(0x1A7ACFB0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A7AD070)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_HASVIBRATOR_OFFSET UNITYSDK_OFFSET(0x1A7AD030)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A7ACFA0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_ISRICHTAPEFFECTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1A7AD010)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_PLAYPREBAKE_OFFSET UNITYSDK_OFFSET(0x1A7ACFC0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_PLAY_OFFSET UNITYSDK_OFFSET(0x1A7ACFD0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_QUIT_OFFSET UNITYSDK_OFFSET(0x1A7AD000)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_SETGAIN_OFFSET UNITYSDK_OFFSET(0x1A7AD060)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_STOP_OFFSET UNITYSDK_OFFSET(0x1A7ACFF0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x1A7ACFE0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7AD160)

namespace RichTap::Platforms::Mobile
{
	inline static constexpr unsigned int AndroidSDKBridge_TypeDefinitionIndex = 34942;
	...
	public:
		...
		{
			return (::RichTap::Platforms::Mobile::AndroidSDKBridge**)Il2CppClass::FromTypeDefinitionIndex(AndroidSDKBridge_TypeDefinitionIndex)->GetStaticField(0x24BD0);
		}
		...
		::System::Boolean isRichtapCore; // 0x11
		::System::Boolean haveVibrator; // 0x12
