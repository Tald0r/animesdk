...
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_GETDURATION_OFFSET UNITYSDK_OFFSET(0x1AD8ECF0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_GETPREBAKEDURATION_OFFSET UNITYSDK_OFFSET(0x1AD8ED00)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_GETVERSION_OFFSET UNITYSDK_OFFSET(0x1AD8EC60)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1AD8ED20)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_HASVIBRATOR_OFFSET UNITYSDK_OFFSET(0x1AD8ECE0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AD8EC50)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_ISRICHTAPEFFECTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1AD8ECC0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_PLAYPREBAKE_OFFSET UNITYSDK_OFFSET(0x1AD8EC70)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_PLAY_OFFSET UNITYSDK_OFFSET(0x1AD8EC80)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_QUIT_OFFSET UNITYSDK_OFFSET(0x1AD8ECB0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_SETGAIN_OFFSET UNITYSDK_OFFSET(0x1AD8ED10)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_STOP_OFFSET UNITYSDK_OFFSET(0x1AD8ECA0)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x1AD8EC90)
#define RICHTAP_PLATFORMS_MOBILE_ANDROIDSDKBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD8EE10)

namespace RichTap::Platforms::Mobile
{
	inline static constexpr unsigned int AndroidSDKBridge_TypeDefinitionIndex = 35944;
	...
	public:
		...
		{
			return (::RichTap::Platforms::Mobile::AndroidSDKBridge**)Il2CppClass::FromTypeDefinitionIndex(AndroidSDKBridge_TypeDefinitionIndex)->GetStaticField(0x26600);
		}
		// static const ::System::Int32 ANDROID_OREO = 0x1A; // 0x0
		// static const ::System::Int32 ANDROID_12 = 0x1F; // 0x0
		::System::Boolean isRichtapCore; // 0x10
		::System::Boolean haveVibrator; // 0x11
		::System::Boolean isInitialized; // 0x12
