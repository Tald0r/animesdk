...
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1AD900D0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1AD900C0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1AD900E0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETINDEX_OFFSET UNITYSDK_OFFSET(0x1AD900A0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETMODE_OFFSET UNITYSDK_OFFSET(0x1AD90090)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1AD900B0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1AD900F0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_PLAY_OFFSET UNITYSDK_OFFSET(0x1AD90100)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AD901C0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD909F0)

namespace RichTap::Source::Components
{
	inline static constexpr unsigned int TriggerEffectComponent_TypeDefinitionIndex = 35941;
