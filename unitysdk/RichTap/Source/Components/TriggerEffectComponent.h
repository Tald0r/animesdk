...
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1A7AE420)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1A7AE410)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A7AE430)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETINDEX_OFFSET UNITYSDK_OFFSET(0x1A7AE3F0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETMODE_OFFSET UNITYSDK_OFFSET(0x1A7AE3E0)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1A7AE400)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_GETSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1A7AE440)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_PLAY_OFFSET UNITYSDK_OFFSET(0x1A7AE450)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7AE510)
#define RICHTAP_SOURCE_COMPONENTS_TRIGGEREFFECTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7AED40)

namespace RichTap::Source::Components
{
	inline static constexpr unsigned int TriggerEffectComponent_TypeDefinitionIndex = 34939;
