...
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1AD8FC20)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETCLIP_OFFSET UNITYSDK_OFFSET(0x1AD8FC00)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETCONTENT_OFFSET UNITYSDK_OFFSET(0x1AD8FC60)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1AD8FC30)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETLOOPCOUNT_OFFSET UNITYSDK_OFFSET(0x1AD8FC40)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETLOOPINTERVAL_OFFSET UNITYSDK_OFFSET(0x1AD8FC50)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETPRIORITY_OFFSET UNITYSDK_OFFSET(0x1AD8FC10)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETUID_OFFSET UNITYSDK_OFFSET(0x1AD8FBF0)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_PLAY_OFFSET UNITYSDK_OFFSET(0x1AD8FCF0)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_SENDLOOPPARAM_OFFSET UNITYSDK_OFFSET(0x1AD8FF10)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_STOP_OFFSET UNITYSDK_OFFSET(0x1AD8FE80)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD90040)

namespace RichTap::Source::Components
{
	inline static constexpr unsigned int RichtapClipEffectComponent_TypeDefinitionIndex = 35940;
