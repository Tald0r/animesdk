...
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1A7ADF70)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETCLIP_OFFSET UNITYSDK_OFFSET(0x1A7ADF50)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETCONTENT_OFFSET UNITYSDK_OFFSET(0x1A7ADFB0)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A7ADF80)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETLOOPCOUNT_OFFSET UNITYSDK_OFFSET(0x1A7ADF90)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETLOOPINTERVAL_OFFSET UNITYSDK_OFFSET(0x1A7ADFA0)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETPRIORITY_OFFSET UNITYSDK_OFFSET(0x1A7ADF60)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_GETUID_OFFSET UNITYSDK_OFFSET(0x1A7ADF40)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_PLAY_OFFSET UNITYSDK_OFFSET(0x1A7AE040)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_SENDLOOPPARAM_OFFSET UNITYSDK_OFFSET(0x1A7AE260)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT_STOP_OFFSET UNITYSDK_OFFSET(0x1A7AE1D0)
#define RICHTAP_SOURCE_COMPONENTS_RICHTAPCLIPEFFECTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7AE390)

namespace RichTap::Source::Components
{
	inline static constexpr unsigned int RichtapClipEffectComponent_TypeDefinitionIndex = 34938;
