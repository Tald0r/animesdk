...
#define RICHTAP_SOURCE_TRIGGEREFFECT_BUILDFEEDBACKMODE_OFFSET UNITYSDK_OFFSET(0x1A7B0140)
#define RICHTAP_SOURCE_TRIGGEREFFECT_BUILDVIBRATIONMODE_OFFSET UNITYSDK_OFFSET(0x1A7B00D0)
#define RICHTAP_SOURCE_TRIGGEREFFECT_BUILDWEAPONMODE_OFFSET UNITYSDK_OFFSET(0x1A7B0190)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1A7B00A0)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1A7B0090)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A7B00B0)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETINDEX_OFFSET UNITYSDK_OFFSET(0x1A7B0070)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETMODE_OFFSET UNITYSDK_OFFSET(0x1A7B0060)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1A7B0080)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1A7B00C0)
#define RICHTAP_SOURCE_TRIGGEREFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x1A7B01F0)
#define RICHTAP_SOURCE_TRIGGEREFFECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7B02B0)
#define RICHTAP_SOURCE_TRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7B0130)

namespace RichTap::Source
{
	inline static constexpr unsigned int TriggerEffect_TypeDefinitionIndex = 34937;
