...
#define RICHTAP_SOURCE_TRIGGEREFFECT_BUILDFEEDBACKMODE_OFFSET UNITYSDK_OFFSET(0x1AD91DF0)
#define RICHTAP_SOURCE_TRIGGEREFFECT_BUILDVIBRATIONMODE_OFFSET UNITYSDK_OFFSET(0x1AD91D80)
#define RICHTAP_SOURCE_TRIGGEREFFECT_BUILDWEAPONMODE_OFFSET UNITYSDK_OFFSET(0x1AD91E40)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1AD91D50)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1AD91D40)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1AD91D60)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETINDEX_OFFSET UNITYSDK_OFFSET(0x1AD91D20)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETMODE_OFFSET UNITYSDK_OFFSET(0x1AD91D10)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1AD91D30)
#define RICHTAP_SOURCE_TRIGGEREFFECT_GETSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1AD91D70)
#define RICHTAP_SOURCE_TRIGGEREFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x1AD91EA0)
#define RICHTAP_SOURCE_TRIGGEREFFECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AD91F60)
#define RICHTAP_SOURCE_TRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD91DE0)

namespace RichTap::Source
{
	inline static constexpr unsigned int TriggerEffect_TypeDefinitionIndex = 35939;
