...
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECT_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1A7AF400)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECT_GETCLIP_OFFSET UNITYSDK_OFFSET(0x1A7AF3E0)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECT_GETCONTENT_OFFSET UNITYSDK_OFFSET(0x1A7AF440)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECT_GETFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A7AF410)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECT_GETLOOPCOUNT_OFFSET UNITYSDK_OFFSET(0x1A7AF420)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECT_GETLOOPINTERVAL_OFFSET UNITYSDK_OFFSET(0x1A7AF430)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECT_GETPRIORITY_OFFSET UNITYSDK_OFFSET(0x1A7AF3F0)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECT_GETUID_OFFSET UNITYSDK_OFFSET(0x1A7AF3D0)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x1A7AF4D0)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECT_SENDLOOPPARAM_OFFSET UNITYSDK_OFFSET(0x1A7AF6F0)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECT_STOP_OFFSET UNITYSDK_OFFSET(0x1A7AF660)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7AF060)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7AF820)

namespace RichTap::Source
{
	inline static constexpr unsigned int RichtapClipEffect_TypeDefinitionIndex = 34934;
