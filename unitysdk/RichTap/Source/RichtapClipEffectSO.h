...
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECTSO_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1A7AFBF0)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECTSO_GETCLIP_OFFSET UNITYSDK_OFFSET(0x1A7AFBD0)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECTSO_GETCONTENT_OFFSET UNITYSDK_OFFSET(0x1A7AFC30)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECTSO_GETFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A7AFC00)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECTSO_GETLOOPCOUNT_OFFSET UNITYSDK_OFFSET(0x1A7AFC10)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECTSO_GETLOOPINTERVAL_OFFSET UNITYSDK_OFFSET(0x1A7AFC20)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECTSO_GETPRIORITY_OFFSET UNITYSDK_OFFSET(0x1A7AFBE0)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECTSO_GETUID_OFFSET UNITYSDK_OFFSET(0x1A7AFBC0)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECTSO_PLAY_OFFSET UNITYSDK_OFFSET(0x1A7AFCC0)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECTSO_SENDLOOPPARAM_OFFSET UNITYSDK_OFFSET(0x1A7AFEE0)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECTSO_STOP_OFFSET UNITYSDK_OFFSET(0x1A7AFE50)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECTSO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7AF850)
#define RICHTAP_SOURCE_RICHTAPCLIPEFFECTSO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7B0010)

namespace RichTap::Source
{
	inline static constexpr unsigned int RichtapClipEffectSO_TypeDefinitionIndex = 34935;
