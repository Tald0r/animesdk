...
#define RICHTAP_SOURCE_TRIGGEREFFECTSO_BUILDFEEDBACKMODE_OFFSET UNITYSDK_OFFSET(0x1A7B0BC0)
#define RICHTAP_SOURCE_TRIGGEREFFECTSO_BUILDVIBRATIONMODE_OFFSET UNITYSDK_OFFSET(0x1A7B0B50)
#define RICHTAP_SOURCE_TRIGGEREFFECTSO_BUILDWEAPONMODE_OFFSET UNITYSDK_OFFSET(0x1A7B0C30)
#define RICHTAP_SOURCE_TRIGGEREFFECTSO_GETAMPLITUDE_OFFSET UNITYSDK_OFFSET(0x1A7B0B20)
#define RICHTAP_SOURCE_TRIGGEREFFECTSO_GETENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1A7B0B10)
#define RICHTAP_SOURCE_TRIGGEREFFECTSO_GETFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A7B0B30)
#define RICHTAP_SOURCE_TRIGGEREFFECTSO_GETINDEX_OFFSET UNITYSDK_OFFSET(0x1A7B0AF0)
#define RICHTAP_SOURCE_TRIGGEREFFECTSO_GETMODE_OFFSET UNITYSDK_OFFSET(0x1A7B0AE0)
#define RICHTAP_SOURCE_TRIGGEREFFECTSO_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1A7B0B00)
#define RICHTAP_SOURCE_TRIGGEREFFECTSO_GETSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1A7B0B40)
#define RICHTAP_SOURCE_TRIGGEREFFECTSO_PLAY_OFFSET UNITYSDK_OFFSET(0x1A7B0CA0)
#define RICHTAP_SOURCE_TRIGGEREFFECTSO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7B0D60)
#define RICHTAP_SOURCE_TRIGGEREFFECTSO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7B1590)

namespace RichTap::Source
{
	inline static constexpr unsigned int TriggerEffectSO_TypeDefinitionIndex = 34936;
