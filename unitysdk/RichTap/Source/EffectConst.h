...
#define RICHTAP_SOURCE_EFFECTCONST_AMPLITUDECHECK_OFFSET UNITYSDK_OFFSET(0x1AD8F8B0)
#define RICHTAP_SOURCE_EFFECTCONST_FREQUENCYCHECK_OFFSET UNITYSDK_OFFSET(0x1AD8F8C0)
#define RICHTAP_SOURCE_EFFECTCONST_LOOPCOUNTCHECK_OFFSET UNITYSDK_OFFSET(0x1AD90A10)
#define RICHTAP_SOURCE_EFFECTCONST_LOOPINTERVALCHECK_OFFSET UNITYSDK_OFFSET(0x1AD8F8E0)
#define RICHTAP_SOURCE_EFFECTCONST_TRIGGERSETTINGCHECK_OFFSET UNITYSDK_OFFSET(0x1AD90A20)

namespace RichTap::Source
{
	inline static constexpr unsigned int EffectConst_TypeDefinitionIndex = 35934;
