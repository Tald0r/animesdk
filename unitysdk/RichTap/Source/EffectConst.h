...
#define RICHTAP_SOURCE_EFFECTCONST_AMPLITUDECHECK_OFFSET UNITYSDK_OFFSET(0x1A7ADC00)
#define RICHTAP_SOURCE_EFFECTCONST_FREQUENCYCHECK_OFFSET UNITYSDK_OFFSET(0x1A7ADC10)
#define RICHTAP_SOURCE_EFFECTCONST_LOOPCOUNTCHECK_OFFSET UNITYSDK_OFFSET(0x1A7AED60)
#define RICHTAP_SOURCE_EFFECTCONST_LOOPINTERVALCHECK_OFFSET UNITYSDK_OFFSET(0x1A7ADC30)
#define RICHTAP_SOURCE_EFFECTCONST_TRIGGERSETTINGCHECK_OFFSET UNITYSDK_OFFSET(0x1A7AED70)

namespace RichTap::Source
{
	inline static constexpr unsigned int EffectConst_TypeDefinitionIndex = 34932;
