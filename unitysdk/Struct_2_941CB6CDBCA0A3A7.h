...
#define STRUCT_2_941CB6CDBCA0A3A7_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3164B0)
#define STRUCT_2_941CB6CDBCA0A3A7_EQUALS_OFFSET UNITYSDK_OFFSET(0x316490)
#define STRUCT_2_941CB6CDBCA0A3A7_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x316570)
#define STRUCT_2_941CB6CDBCA0A3A7_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x316640)
#define STRUCT_2_941CB6CDBCA0A3A7_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x3165E0)
#define STRUCT_2_941CB6CDBCA0A3A7__CCTOR_OFFSET UNITYSDK_OFFSET(0x6E78120)
#define STRUCT_2_941CB6CDBCA0A3A7__CTOR_OFFSET UNITYSDK_OFFSET(0x316480)

inline static constexpr unsigned int Struct_2_941CB6CDBCA0A3A7_TypeDefinitionIndex = 41205;

struct alignas(2) Struct_2_941CB6CDBCA0A3A7
{
	static ::Struct_2_941CB6CDBCA0A3A7* StaticGet_Field_2_2()
	{
		return (::Struct_2_941CB6CDBCA0A3A7*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_941CB6CDBCA0A3A7_TypeDefinitionIndex)->GetStaticField(0xB0E0);
	}
