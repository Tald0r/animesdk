...
#define CUSTOMSKIN_MHYBIND__COUNTDOWN_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8A403D0)
#define CUSTOMSKIN_MHYBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8A40530)
#define CUSTOMSKIN_MHYBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8A40590)
#define CUSTOMSKIN_MHYBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x8A40540)
#define CUSTOMSKIN_MHYBIND__COUNTDOWN_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A403C0)
#define CUSTOMSKIN_MHYBIND__COUNTDOWN_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x8A403B0)

inline static constexpr unsigned int CustomSkin_MHYBind__CountDown_d__19_TypeDefinitionIndex = 41572;
