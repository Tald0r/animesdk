...
#define CUSTOMSKIN_MHYBIND__COUNTDOWN_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xADC7460)
#define CUSTOMSKIN_MHYBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xADC75C0)
#define CUSTOMSKIN_MHYBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xADC7620)
#define CUSTOMSKIN_MHYBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xADC75D0)
#define CUSTOMSKIN_MHYBIND__COUNTDOWN_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xADC7450)
#define CUSTOMSKIN_MHYBIND__COUNTDOWN_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0xADC7440)

inline static constexpr unsigned int CustomSkin_MHYBind__CountDown_d__19_TypeDefinitionIndex = 79230;
