...
#define OPAQUEMOTIONVECTORRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17631CB0)
#define OPAQUEMOTIONVECTORRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17631AF0)
#define OPAQUEMOTIONVECTORRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x17631DC0)

inline static constexpr unsigned int OpaqueMotionVectorRenderer_TypeDefinitionIndex = 29079;
