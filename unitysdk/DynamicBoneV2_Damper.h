...
#define DYNAMICBONEV2_DAMPER_DAMP_1_OFFSET UNITYSDK_OFFSET(0x1B17C3B0)
#define DYNAMICBONEV2_DAMPER_DAMP_2_OFFSET UNITYSDK_OFFSET(0x1B17BCE0)
#define DYNAMICBONEV2_DAMPER_DAMP_OFFSET UNITYSDK_OFFSET(0x1B17C340)
#define DYNAMICBONEV2_DAMPER_DECAYCONSTANT_OFFSET UNITYSDK_OFFSET(0x1B17C2E0)
#define DYNAMICBONEV2_DAMPER_DECAYEDREMAINDER_OFFSET UNITYSDK_OFFSET(0x1B17C310)

inline static constexpr unsigned int DynamicBoneV2_Damper_TypeDefinitionIndex = 32544;
