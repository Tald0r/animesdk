...
#define DYNAMICBONEV2_DAMPER_DAMP_1_OFFSET UNITYSDK_OFFSET(0x1AB6F2A0)
#define DYNAMICBONEV2_DAMPER_DAMP_2_OFFSET UNITYSDK_OFFSET(0x1AB6EBD0)
#define DYNAMICBONEV2_DAMPER_DAMP_OFFSET UNITYSDK_OFFSET(0x1AB6F230)
#define DYNAMICBONEV2_DAMPER_DECAYCONSTANT_OFFSET UNITYSDK_OFFSET(0x1AB6F1D0)
#define DYNAMICBONEV2_DAMPER_DECAYEDREMAINDER_OFFSET UNITYSDK_OFFSET(0x1AB6F200)

inline static constexpr unsigned int DynamicBoneV2_Damper_TypeDefinitionIndex = 31590;
