...
#define CLASS_1_A238E29B18A7ED1A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x71C8680)
#define CLASS_1_A238E29B18A7ED1A_METHOD_1_2B0E0E88A9334A58_1_OFFSET UNITYSDK_OFFSET(0x71C8940)
#define CLASS_1_A238E29B18A7ED1A_METHOD_1_2B0E0E88A9334A58_OFFSET UNITYSDK_OFFSET(0x71C8880)
#define CLASS_1_A238E29B18A7ED1A_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x71C8E30)
#define CLASS_1_A238E29B18A7ED1A_METHOD_1_8649317719F42121_OFFSET UNITYSDK_OFFSET(0x71C8AB0)
#define CLASS_1_A238E29B18A7ED1A_METHOD_1_C74CF020AA42ED85_1_OFFSET UNITYSDK_OFFSET(0x71C8870)
#define CLASS_1_A238E29B18A7ED1A_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x71C8860)
#define CLASS_1_A238E29B18A7ED1A_METHOD_1_D14801A69F4D309C_OFFSET UNITYSDK_OFFSET(0x71C8E20)
#define CLASS_1_A238E29B18A7ED1A_METHOD_1_D7B7C909A67BD350_OFFSET UNITYSDK_OFFSET(0x71C8A00)
#define CLASS_1_A238E29B18A7ED1A__CTOR_OFFSET UNITYSDK_OFFSET(0x71C7FB0)

inline static constexpr unsigned int Class_1_A238E29B18A7ED1A_TypeDefinitionIndex = 68095;

class Class_1_A238E29B18A7ED1A : public ::System::Object
{
public:
	// static const ::System::Int32 Field_1_9 = 0x1; // 0x0
	::MoleMole::Photo::Skeleton* Field_1_7; // 0x10
	::UnityEngine::Animator* Field_1_5; // 0x18
	::Foundation::NativeMemory* Field_1_8; // 0x20
	::UnityEngine::AvatarMask* Field_1_4; // 0x28
	::Struct_2_ACD0EF80A5330786 Field_1_6; // 0x30
	::UnityEngine::Animations::AnimationScriptPlayable Field_1_1; // 0xC0
	::Foundation::NativeVariable_1<::PipelineCamera::Optional_1<::Struct_2_6E1B724B14572104_7>> Field_1_2; // 0xD0
