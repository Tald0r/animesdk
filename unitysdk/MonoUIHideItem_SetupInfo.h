...
#define MONOUIHIDEITEM_SETUPINFO_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x6060AD0)
#define MONOUIHIDEITEM_SETUPINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x6060970)
#define MONOUIHIDEITEM_SETUPINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x6060A20)

inline static constexpr unsigned int MonoUIHideItem_SetupInfo_TypeDefinitionIndex = 52692;
