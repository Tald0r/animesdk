...
#define MONOUIHIDEITEM_SETUPINFO_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x7BF5CC0)
#define MONOUIHIDEITEM_SETUPINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x7BF5B60)
#define MONOUIHIDEITEM_SETUPINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x7BF5C10)

inline static constexpr unsigned int MonoUIHideItem_SetupInfo_TypeDefinitionIndex = 55261;
