...
#define SCENEWATERPROXY_BARYCENTRIC_COORDS_OFFSET UNITYSDK_OFFSET(0x1B16F470)
#define SCENEWATERPROXY_GETBOUNDINWS_1_OFFSET UNITYSDK_OFFSET(0x1B1705B0)
#define SCENEWATERPROXY_GETBOUNDINWS_OFFSET UNITYSDK_OFFSET(0x1B170500)
#define SCENEWATERPROXY_GETMINMAXV2_OFFSET UNITYSDK_OFFSET(0x1B16F930)
#define SCENEWATERPROXY_GETMINMAX_OFFSET UNITYSDK_OFFSET(0x1B16F8B0)
#define SCENEWATERPROXY_INTERPOLATE_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B16F5F0)
#define SCENEWATERPROXY_ISPOINTINTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1B16F120)
#define SCENEWATERPROXY_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1B16F990)
#define SCENEWATERPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B16E180)
#define SCENEWATERPROXY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B1702D0)
#define SCENEWATERPROXY_SETWAVECENTERPOS_OFFSET UNITYSDK_OFFSET(0x1B16E4D0)
#define SCENEWATERPROXY_TRIANGLE_INTERPOLATION_OFFSET UNITYSDK_OFFSET(0x1B16F6B0)
#define SCENEWATERPROXY_TRIANGLE_INTERPOLATION_UP_DOWN_OFFSET UNITYSDK_OFFSET(0x1B16F260)
#define SCENEWATERPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B170C80)

inline static constexpr unsigned int SceneWaterProxy_TypeDefinitionIndex = 35897;
