...
#define SCENEWATERPROXY_BARYCENTRIC_COORDS_OFFSET UNITYSDK_OFFSET(0x1AB52220)
#define SCENEWATERPROXY_GETBOUNDINWS_1_OFFSET UNITYSDK_OFFSET(0x1AB53370)
#define SCENEWATERPROXY_GETBOUNDINWS_OFFSET UNITYSDK_OFFSET(0x1AB532C0)
#define SCENEWATERPROXY_GETMINMAXV2_OFFSET UNITYSDK_OFFSET(0x1AB526F0)
#define SCENEWATERPROXY_GETMINMAX_OFFSET UNITYSDK_OFFSET(0x1AB52670)
#define SCENEWATERPROXY_INTERPOLATE_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AB523B0)
#define SCENEWATERPROXY_ISPOINTINTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1AB51ED0)
#define SCENEWATERPROXY_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1AB52750)
#define SCENEWATERPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AB50F30)
#define SCENEWATERPROXY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AB53090)
#define SCENEWATERPROXY_SETWAVECENTERPOS_OFFSET UNITYSDK_OFFSET(0x1AB51280)
#define SCENEWATERPROXY_TRIANGLE_INTERPOLATION_OFFSET UNITYSDK_OFFSET(0x1AB52470)
#define SCENEWATERPROXY_TRIANGLE_INTERPOLATION_UP_DOWN_OFFSET UNITYSDK_OFFSET(0x1AB52010)
#define SCENEWATERPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB53A40)

inline static constexpr unsigned int SceneWaterProxy_TypeDefinitionIndex = 34895;
