...
#define CLASS_3_5C2B812082E67330_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x772A050)
#define CLASS_3_5C2B812082E67330_METHOD_3_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x772A140)
#define CLASS_3_5C2B812082E67330_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x772A290)
#define CLASS_3_5C2B812082E67330_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x772A2F0)
#define CLASS_3_5C2B812082E67330_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x7729FD0)
#define CLASS_3_5C2B812082E67330__CCTOR_OFFSET UNITYSDK_OFFSET(0x772A0B0)
#define CLASS_3_5C2B812082E67330__CTOR_OFFSET UNITYSDK_OFFSET(0x772A130)

inline static constexpr unsigned int Class_3_5C2B812082E67330_TypeDefinitionIndex = 80577;

class Class_3_5C2B812082E67330 : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_7 = 0xC0; // 0x0
	::MoleMole::Battle::Entity* Field_3_1; // 0x48
	::Class_4_7D91CA380C94C005* Field_3_4; // 0x50
	::MoleMole::Config::ConfigTrainingRoom* Field_3_0; // 0x58
	::System::Collections::Generic::List_1<::Class_2_D89CCC627A66D0AD*>* Field_3_2; // 0x60
