...
#define MONOPARTICLESYSTEMUPDATEMODE_AWAKE_OFFSET UNITYSDK_OFFSET(0x9933EB0)
#define MONOPARTICLESYSTEMUPDATEMODE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9933F80)
#define MONOPARTICLESYSTEMUPDATEMODE_UPDATEMANUAL_OFFSET UNITYSDK_OFFSET(0x99341D0)
#define MONOPARTICLESYSTEMUPDATEMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x99342E0)

inline static constexpr unsigned int MonoParticleSystemUpdateMode_TypeDefinitionIndex = 73679;
