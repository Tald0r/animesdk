...
#define AKPELLEGRINOSETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x19A0D4A0)
#define AKPELLEGRINOSETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x19A0D4B0)
#define AKPELLEGRINOSETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x19A0D490)
#define AKPELLEGRINOSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0D110)

inline static constexpr unsigned int AkPellegrinoSettings_TypeDefinitionIndex = 31039;
