...
#define AKPELLEGRINOSETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x1956B7C0)
#define AKPELLEGRINOSETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x1956B7D0)
#define AKPELLEGRINOSETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1956B7B0)
#define AKPELLEGRINOSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1956B420)

inline static constexpr unsigned int AkPellegrinoSettings_TypeDefinitionIndex = 30086;
