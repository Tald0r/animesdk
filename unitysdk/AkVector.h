...
#define AKVECTOR_GET_X_OFFSET UNITYSDK_OFFSET(0x1B61A6D0)
#define AKVECTOR_GET_Y_OFFSET UNITYSDK_OFFSET(0x1B61A6F0)
#define AKVECTOR_GET_Z_OFFSET UNITYSDK_OFFSET(0x1B61A710)
#define AKVECTOR_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B61A720)
#define AKVECTOR_SET_X_OFFSET UNITYSDK_OFFSET(0x1B61A6C0)
#define AKVECTOR_SET_Y_OFFSET UNITYSDK_OFFSET(0x1B61A6E0)
#define AKVECTOR_SET_Z_OFFSET UNITYSDK_OFFSET(0x1B61A700)
#define AKVECTOR_ZERO_OFFSET UNITYSDK_OFFSET(0x1B61A6B0)
#define AKVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B61A750)

inline static constexpr unsigned int AkVector_TypeDefinitionIndex = 30998;
