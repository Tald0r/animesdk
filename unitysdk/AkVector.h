...
#define AKVECTOR_GET_X_OFFSET UNITYSDK_OFFSET(0x1B008540)
#define AKVECTOR_GET_Y_OFFSET UNITYSDK_OFFSET(0x1B008560)
#define AKVECTOR_GET_Z_OFFSET UNITYSDK_OFFSET(0x1B008580)
#define AKVECTOR_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B008590)
#define AKVECTOR_SET_X_OFFSET UNITYSDK_OFFSET(0x1B008530)
#define AKVECTOR_SET_Y_OFFSET UNITYSDK_OFFSET(0x1B008550)
#define AKVECTOR_SET_Z_OFFSET UNITYSDK_OFFSET(0x1B008570)
#define AKVECTOR_ZERO_OFFSET UNITYSDK_OFFSET(0x1B008520)
#define AKVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0085C0)

inline static constexpr unsigned int AkVector_TypeDefinitionIndex = 30045;
