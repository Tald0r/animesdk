...
#define AUDIO_PINVOKE_GETGLOBALSTATS_OFFSET UNITYSDK_OFFSET(0x7362420)
#define AUDIO_PINVOKE_GETMODULEHANDLE_OFFSET UNITYSDK_OFFSET(0x7362530)
#define AUDIO_PINVOKE_GETPADERROR_OFFSET UNITYSDK_OFFSET(0x7362AD0)
#define AUDIO_PINVOKE_NAP_GETAUDIOBUFFER_OFFSET UNITYSDK_OFFSET(0x73624A0)
#define AUDIO_PINVOKE_SCEPADCLOSE_OFFSET UNITYSDK_OFFSET(0x7362830)
#define AUDIO_PINVOKE_SCEPADGETHANDLE_OFFSET UNITYSDK_OFFSET(0x73627A0)
#define AUDIO_PINVOKE_SCEPADGETJACKSTATE_OFFSET UNITYSDK_OFFSET(0x73629C0)
#define AUDIO_PINVOKE_SCEPADINIT_OFFSET UNITYSDK_OFFSET(0x7362600)
#define AUDIO_PINVOKE_SCEPADOPEN_OFFSET UNITYSDK_OFFSET(0x7362700)
#define AUDIO_PINVOKE_SCEPADSETAUDIOOUTPATH_OFFSET UNITYSDK_OFFSET(0x73628B0)
#define AUDIO_PINVOKE_SCEPADSETVOLUMEGAIN_OFFSET UNITYSDK_OFFSET(0x7362930)
#define AUDIO_PINVOKE_SCEPADTERMINATE_OFFSET UNITYSDK_OFFSET(0x7362680)
#define AUDIO_PINVOKE__CTOR_OFFSET UNITYSDK_OFFSET(0x7362C00)

inline static constexpr unsigned int Audio_PINVOKE_TypeDefinitionIndex = 70683;
