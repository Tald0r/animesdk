...
#define AUDIO_PINVOKE_GETGLOBALSTATS_OFFSET UNITYSDK_OFFSET(0x9E78860)
#define AUDIO_PINVOKE_GETMODULEHANDLE_OFFSET UNITYSDK_OFFSET(0x9E78970)
#define AUDIO_PINVOKE_GETPADERROR_OFFSET UNITYSDK_OFFSET(0x9E78F10)
#define AUDIO_PINVOKE_NAP_GETAUDIOBUFFER_OFFSET UNITYSDK_OFFSET(0x9E788E0)
#define AUDIO_PINVOKE_SCEPADCLOSE_OFFSET UNITYSDK_OFFSET(0x9E78C70)
#define AUDIO_PINVOKE_SCEPADGETHANDLE_OFFSET UNITYSDK_OFFSET(0x9E78BE0)
#define AUDIO_PINVOKE_SCEPADGETJACKSTATE_OFFSET UNITYSDK_OFFSET(0x9E78E00)
#define AUDIO_PINVOKE_SCEPADINIT_OFFSET UNITYSDK_OFFSET(0x9E78A40)
#define AUDIO_PINVOKE_SCEPADOPEN_OFFSET UNITYSDK_OFFSET(0x9E78B40)
#define AUDIO_PINVOKE_SCEPADSETAUDIOOUTPATH_OFFSET UNITYSDK_OFFSET(0x9E78CF0)
#define AUDIO_PINVOKE_SCEPADSETVOLUMEGAIN_OFFSET UNITYSDK_OFFSET(0x9E78D70)
#define AUDIO_PINVOKE_SCEPADTERMINATE_OFFSET UNITYSDK_OFFSET(0x9E78AC0)
#define AUDIO_PINVOKE__CTOR_OFFSET UNITYSDK_OFFSET(0x9E79040)

inline static constexpr unsigned int Audio_PINVOKE_TypeDefinitionIndex = 59815;
