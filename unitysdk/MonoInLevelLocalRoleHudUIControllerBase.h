...
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x7BF0E90)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_GET_FOLLOWPOS_OFFSET UNITYSDK_OFFSET(0x7BF0D00)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ISINCAMERAVISIBLERANGE_OFFSET UNITYSDK_OFFSET(0x7BF3C70)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_LERPCLOSETO_OFFSET UNITYSDK_OFFSET(0x7BF4300)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_LINEFRAMEANIMATION2_OFFSET UNITYSDK_OFFSET(0x7BF3EA0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x7BF11E0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x7BF2B40)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ONLOCALAVATARCHANGED_OFFSET UNITYSDK_OFFSET(0x7BF4400)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7BF29B0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7BF0FF0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_ONVISIBLE_OFFSET UNITYSDK_OFFSET(0x7BF41F0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_UPDATEAFTERCAMERALATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7BF2CD0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_UPDATEFOLLOWINFO_OFFSET UNITYSDK_OFFSET(0x7BF13B0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_UPDATEHUDOFFSETX_OFFSET UNITYSDK_OFFSET(0x7BF33F0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_UPDATEHUDOFFSETY_OFFSET UNITYSDK_OFFSET(0x7BF2D50)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE_UPDATEPOS_OFFSET UNITYSDK_OFFSET(0x7BF16D0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x7BF4480)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x7BF44A0)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x7BF4570)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7BF4580)
#define MONOINLEVELLOCALROLEHUDUICONTROLLERBASE___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7BF4500)

inline static constexpr unsigned int MonoInLevelLocalRoleHudUIControllerBase_TypeDefinitionIndex = 43445;
