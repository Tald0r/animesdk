...
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x6779FB0)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x677A190)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x677A1F0)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x677A1A0)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6779FA0)
#define CUSTOMSKIN_OVERSEANEWDEVICEPHONEVERIFY__COUNTDOWN_D__16__CTOR_OFFSET UNITYSDK_OFFSET(0x6779F90)

inline static constexpr unsigned int CustomSkin_OverseaNewDevicePhoneVerify__CountDown_d__16_TypeDefinitionIndex = 54401;
