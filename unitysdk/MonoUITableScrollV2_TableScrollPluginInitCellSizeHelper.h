...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER_CHECKCELLSIZEVALID_OFFSET UNITYSDK_OFFSET(0x9A34CE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER_GET_MINCELLSIZE_OFFSET UNITYSDK_OFFSET(0x9A33CC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER_INITCELLSIZEINNER_OFFSET UNITYSDK_OFFSET(0x9A33DE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER_INITCELLSIZE_1_OFFSET UNITYSDK_OFFSET(0x9A33C40)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER_INITCELLSIZE_OFFSET UNITYSDK_OFFSET(0x9A33D60)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER_MARKCELLSIZEDIRTY_OFFSET UNITYSDK_OFFSET(0x9A341F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER_REGISTERCUSTOMTEMPLATEPROVIDER_OFFSET UNITYSDK_OFFSET(0x9A33CE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER_SETMINCELLSIZE_OFFSET UNITYSDK_OFFSET(0x9A34560)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER_SET_MINCELLSIZE_OFFSET UNITYSDK_OFFSET(0x9A33CD0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9A33B80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A33B70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER__INITCELLSIZEINNER_G__PROCESSTEMPINSTANCE_10_0_OFFSET UNITYSDK_OFFSET(0x9A34250)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER__SETMINCELLSIZE_G__GETMINCELLSIZE_11_0_OFFSET UNITYSDK_OFFSET(0x9A347B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITCELLSIZEHELPER___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x9A34EA0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginInitCellSizeHelper_TypeDefinitionIndex = 64438;
