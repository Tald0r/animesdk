...
#define VIDEOLIGHTSYNC_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1ABBB400)
#define VIDEOLIGHTSYNC_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ABBB180)
#define VIDEOLIGHTSYNC_TURNOFFLIGHT_OFFSET UNITYSDK_OFFSET(0x1ABBB4A0)
#define VIDEOLIGHTSYNC_UPDATEVIDEOFRAME_OFFSET UNITYSDK_OFFSET(0x1ABBB810)
#define VIDEOLIGHTSYNC_UPDATEVIDEONAME_OFFSET UNITYSDK_OFFSET(0x1ABBB640)
#define VIDEOLIGHTSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABBB900)

inline static constexpr unsigned int VideoLightSync_TypeDefinitionIndex = 54683;
