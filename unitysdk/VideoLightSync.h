...
#define VIDEOLIGHTSYNC_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16C41A80)
#define VIDEOLIGHTSYNC_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16C41800)
#define VIDEOLIGHTSYNC_TURNOFFLIGHT_OFFSET UNITYSDK_OFFSET(0x16C41B20)
#define VIDEOLIGHTSYNC_UPDATEVIDEOFRAME_OFFSET UNITYSDK_OFFSET(0x16C41E90)
#define VIDEOLIGHTSYNC_UPDATEVIDEONAME_OFFSET UNITYSDK_OFFSET(0x16C41CC0)
#define VIDEOLIGHTSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x16C41F80)

inline static constexpr unsigned int VideoLightSync_TypeDefinitionIndex = 50763;
