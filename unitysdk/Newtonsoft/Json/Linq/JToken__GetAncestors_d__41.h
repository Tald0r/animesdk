...
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AD11470)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NEWTONSOFT_JSON_LINQ_JTOKEN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AD11570)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NEWTONSOFT_JSON_LINQ_JTOKEN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD11500)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AD11710)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD11560)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AD11510)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD11460)
#define NEWTONSOFT_JSON_LINQ_JTOKEN__GETANCESTORS_D__41__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD113C0)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JToken__GetAncestors_d__41_TypeDefinitionIndex = 7051;

	class JToken__GetAncestors_d__41 : public ::System::Object
	{
	public:
		::Newtonsoft::Json::Linq::JToken* __2__current; // 0x10
		::Newtonsoft::Json::Linq::JToken* _current_5__1; // 0x18
		::Newtonsoft::Json::Linq::JToken* __4__this; // 0x20
		::System::Boolean __3__self; // 0x28
		::System::Boolean self; // 0x29
