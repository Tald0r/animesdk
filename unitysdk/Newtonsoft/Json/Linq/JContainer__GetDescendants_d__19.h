...
#define NEWTONSOFT_JSON_LINQ_JCONTAINER__GETDESCENDANTS_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B73B8E0)
#define NEWTONSOFT_JSON_LINQ_JCONTAINER__GETDESCENDANTS_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NEWTONSOFT_JSON_LINQ_JTOKEN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B73C020)
#define NEWTONSOFT_JSON_LINQ_JCONTAINER__GETDESCENDANTS_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NEWTONSOFT_JSON_LINQ_JTOKEN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B73BFB0)
#define NEWTONSOFT_JSON_LINQ_JCONTAINER__GETDESCENDANTS_D__19_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B73C1C0)
#define NEWTONSOFT_JSON_LINQ_JCONTAINER__GETDESCENDANTS_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B73C010)
#define NEWTONSOFT_JSON_LINQ_JCONTAINER__GETDESCENDANTS_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B73BFC0)
#define NEWTONSOFT_JSON_LINQ_JCONTAINER__GETDESCENDANTS_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B73B5C0)
#define NEWTONSOFT_JSON_LINQ_JCONTAINER__GETDESCENDANTS_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x1B73B520)
#define NEWTONSOFT_JSON_LINQ_JCONTAINER__GETDESCENDANTS_D__19___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B73B830)
#define NEWTONSOFT_JSON_LINQ_JCONTAINER__GETDESCENDANTS_D__19___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1B73B780)
...
namespace Newtonsoft::Json::Linq
{
	...
	public:
		...
		::System::Boolean self; // 0x3C
		::System::Boolean __3__self; // 0x3D
