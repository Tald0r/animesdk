...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYINDEXFILTER_EXECUTEFILTER_OFFSET UNITYSDK_OFFSET(0x1A987ED0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYINDEXFILTER_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1A987EB0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYINDEXFILTER_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x1A987EC0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYINDEXFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A987F40)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int ArrayIndexFilter_TypeDefinitionIndex = 7063;
