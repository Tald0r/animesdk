...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_BOOLEANQUERYEXPRESSION_EQUALSWITHSTRINGCOERCION_OFFSET UNITYSDK_OFFSET(0x1B0BD3C0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_BOOLEANQUERYEXPRESSION_GET_PATH_OFFSET UNITYSDK_OFFSET(0x1B0BCEA0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_BOOLEANQUERYEXPRESSION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0BCEC0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_BOOLEANQUERYEXPRESSION_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1B0BCEE0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_BOOLEANQUERYEXPRESSION_SET_PATH_OFFSET UNITYSDK_OFFSET(0x1B0BCEB0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_BOOLEANQUERYEXPRESSION_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0BCED0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_BOOLEANQUERYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BD8E0)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int BooleanQueryExpression_TypeDefinitionIndex = 7079;
