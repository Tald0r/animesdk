...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYMULTIPLEINDEXFILTER_EXECUTEFILTER_OFFSET UNITYSDK_OFFSET(0x1A2F28C0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYMULTIPLEINDEXFILTER_GET_INDEXES_OFFSET UNITYSDK_OFFSET(0x1A2F28A0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYMULTIPLEINDEXFILTER_SET_INDEXES_OFFSET UNITYSDK_OFFSET(0x1A2F28B0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYMULTIPLEINDEXFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F2A60)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int ArrayMultipleIndexFilter_TypeDefinitionIndex = 7065;
