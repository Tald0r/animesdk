...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER_EXECUTEFILTER_OFFSET UNITYSDK_OFFSET(0x1A32EE80)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER_GET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A32EE60)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER_SET_EXPRESSION_OFFSET UNITYSDK_OFFSET(0x1A32EE70)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A32EEF0)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int QueryFilter_TypeDefinitionIndex = 7080;
