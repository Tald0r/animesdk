...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1AEA8DF0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_ENSURELENGTH_OFFSET UNITYSDK_OFFSET(0x1AEA96B0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x1AEABDA0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1AEABD90)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_GET_FILTERS_OFFSET UNITYSDK_OFFSET(0x1AEA8AB0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_MATCH_OFFSET UNITYSDK_OFFSET(0x1AEABAF0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEARRAYINDEXER_OFFSET UNITYSDK_OFFSET(0x1AEA9DB0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEEXPRESSION_OFFSET UNITYSDK_OFFSET(0x1AEAA6E0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEINDEXER_OFFSET UNITYSDK_OFFSET(0x1AEA9530)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEMAIN_OFFSET UNITYSDK_OFFSET(0x1AEA8BD0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEOPERATOR_OFFSET UNITYSDK_OFFSET(0x1AEAB100)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEPATH_OFFSET UNITYSDK_OFFSET(0x1AEA8E60)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEQUERY_OFFSET UNITYSDK_OFFSET(0x1AEA9AB0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEQUOTEDFIELD_OFFSET UNITYSDK_OFFSET(0x1AEA9730)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1AEAB500)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_READQUOTEDSTRING_OFFSET UNITYSDK_OFFSET(0x1AEABB90)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH_SET_FILTERS_OFFSET UNITYSDK_OFFSET(0x1AEA8AC0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_JPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEA8AD0)
