...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDMULTIPLEFILTER_EXECUTEFILTER_OFFSET UNITYSDK_OFFSET(0x1B108270)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDMULTIPLEFILTER_GET_NAMES_OFFSET UNITYSDK_OFFSET(0x1B108250)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDMULTIPLEFILTER_SET_NAMES_OFFSET UNITYSDK_OFFSET(0x1B108260)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_FIELDMULTIPLEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1082E0)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int FieldMultipleFilter_TypeDefinitionIndex = 7071;
