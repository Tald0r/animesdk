...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1ACCDCB0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NEWTONSOFT_JSON_LINQ_JTOKEN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1ACCE310)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NEWTONSOFT_JSON_LINQ_JTOKEN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ACCE2A0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1ACCE4B0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ACCE300)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1ACCE2B0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ACCD9A0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACCD900)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1ACCDC00)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1ACCDB50)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int QueryFilter__ExecuteFilter_d__4_TypeDefinitionIndex = 7081;

	class QueryFilter__ExecuteFilter_d__4 : public ::System::Object
	{
	public:
		::Newtonsoft::Json::Linq::JsonPath::QueryFilter* __4__this; // 0x10
		::System::Collections::Generic::IEnumerator_1<::Newtonsoft::Json::Linq::JToken*>* __7__wrap1; // 0x18
		::System::Collections::Generic::IEnumerator_1<::Newtonsoft::Json::Linq::JToken*>* __7__wrap2; // 0x20
