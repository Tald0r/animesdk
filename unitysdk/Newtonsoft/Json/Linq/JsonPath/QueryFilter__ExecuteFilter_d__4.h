...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B2F7DE0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NEWTONSOFT_JSON_LINQ_JTOKEN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B2F8440)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NEWTONSOFT_JSON_LINQ_JTOKEN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B2F83D0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B2F85E0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B2F8430)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B2F83E0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B2F7AD0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F7A30)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B2F7D30)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_QUERYFILTER__EXECUTEFILTER_D__4___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1B2F7C80)
...
namespace Newtonsoft::Json::Linq::JsonPath
{
	...
	{
	public:
		::System::Collections::Generic::IEnumerator_1<::Newtonsoft::Json::Linq::JToken*>* __7__wrap2; // 0x10
		::Newtonsoft::Json::Linq::JsonPath::QueryFilter* __4__this; // 0x18
