...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B24A5E0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NEWTONSOFT_JSON_LINQ_JTOKEN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B24AC40)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NEWTONSOFT_JSON_LINQ_JTOKEN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B24ABD0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B24ADE0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B24AC30)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B24ABE0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B24A460)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1B24A3C0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B24A530)
...
namespace Newtonsoft::Json::Linq::JsonPath
{
	...
	public:
		...
		::Newtonsoft::Json::Linq::JToken* _value_5__2; // 0x20
		::Newtonsoft::Json::Linq::JToken* _root_5__1; // 0x28
		::Newtonsoft::Json::Linq::JsonPath::ScanFilter* __4__this; // 0x30
