...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AC481E0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NEWTONSOFT_JSON_LINQ_JTOKEN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AC48840)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NEWTONSOFT_JSON_LINQ_JTOKEN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC487D0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AC489E0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC48830)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AC487E0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AC48060)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC47FC0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_SCANFILTER__EXECUTEFILTER_D__4___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1AC48130)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int ScanFilter__ExecuteFilter_d__4_TypeDefinitionIndex = 7083;

	class ScanFilter__ExecuteFilter_d__4 : public ::System::Object
	{
	public:
		::Newtonsoft::Json::Linq::JToken* _value_5__2; // 0x10
		...
		::Newtonsoft::Json::Linq::JToken* _root_5__1; // 0x30
		::System::Collections::Generic::IEnumerable_1<::Newtonsoft::Json::Linq::JToken*>* current; // 0x38
		::Newtonsoft::Json::Linq::JsonPath::ScanFilter* __4__this; // 0x40
