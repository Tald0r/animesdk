...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_COMPOSITEEXPRESSION_GET_EXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x1A8C7AF0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_COMPOSITEEXPRESSION_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1A8C7B90)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_COMPOSITEEXPRESSION_SET_EXPRESSIONS_OFFSET UNITYSDK_OFFSET(0x1A8C7B00)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_COMPOSITEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C7B10)

namespace Newtonsoft::Json::Linq::JsonPath
{
	inline static constexpr unsigned int CompositeExpression_TypeDefinitionIndex = 7078;
