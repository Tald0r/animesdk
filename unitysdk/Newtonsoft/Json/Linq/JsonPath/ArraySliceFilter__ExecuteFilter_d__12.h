...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER__EXECUTEFILTER_D__12_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B32BEC0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER__EXECUTEFILTER_D__12_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NEWTONSOFT_JSON_LINQ_JTOKEN__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B32C6F0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER__EXECUTEFILTER_D__12_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NEWTONSOFT_JSON_LINQ_JTOKEN__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B32C680)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER__EXECUTEFILTER_D__12_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B32C8A0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER__EXECUTEFILTER_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B32C6E0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER__EXECUTEFILTER_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B32C690)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER__EXECUTEFILTER_D__12_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B32BD50)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER__EXECUTEFILTER_D__12__CTOR_OFFSET UNITYSDK_OFFSET(0x1B32BCB0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER__EXECUTEFILTER_D__12___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B32BE10)
...
namespace Newtonsoft::Json::Linq::JsonPath
{
	...
	public:
		...
		::Newtonsoft::Json::Linq::JToken* _t_5__6; // 0x38
		...
		::System::Boolean _positiveStep_5__5; // 0x56
		::System::Int32 _stopIndex_5__4; // 0x58
