...
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_EXECUTEFILTER_OFFSET UNITYSDK_OFFSET(0x1A8D78E0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_GET_END_OFFSET UNITYSDK_OFFSET(0x1A8D78A0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_GET_START_OFFSET UNITYSDK_OFFSET(0x1A8D7880)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_GET_STEP_OFFSET UNITYSDK_OFFSET(0x1A8D78C0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A8D7950)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_SET_END_OFFSET UNITYSDK_OFFSET(0x1A8D78B0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_SET_START_OFFSET UNITYSDK_OFFSET(0x1A8D7890)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER_SET_STEP_OFFSET UNITYSDK_OFFSET(0x1A8D78D0)
#define NEWTONSOFT_JSON_LINQ_JSONPATH_ARRAYSLICEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D7970)
