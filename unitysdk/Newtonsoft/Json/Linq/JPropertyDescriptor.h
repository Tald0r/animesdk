...
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_CANRESETVALUE_OFFSET UNITYSDK_OFFSET(0x1A32EAC0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_CASTINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A32EA50)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1A32EAD0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_GET_COMPONENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A32ECE0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1A32ED10)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_GET_NAMEHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A32ED50)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1A32ED20)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_RESETVALUE_OFFSET UNITYSDK_OFFSET(0x1A32EB50)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A32EB60)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR_SHOULDSERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x1A32ECD0)
#define NEWTONSOFT_JSON_LINQ_JPROPERTYDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A32EA40)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JPropertyDescriptor_TypeDefinitionIndex = 7044;
