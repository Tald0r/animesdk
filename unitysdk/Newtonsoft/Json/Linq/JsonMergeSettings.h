...
#define NEWTONSOFT_JSON_LINQ_JSONMERGESETTINGS_GET_MERGEARRAYHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8DED30)
#define NEWTONSOFT_JSON_LINQ_JSONMERGESETTINGS_GET_MERGENULLVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8DEDB0)
#define NEWTONSOFT_JSON_LINQ_JSONMERGESETTINGS_SET_MERGEARRAYHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8DED40)
#define NEWTONSOFT_JSON_LINQ_JSONMERGESETTINGS_SET_MERGENULLVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8DEDC0)
#define NEWTONSOFT_JSON_LINQ_JSONMERGESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8DEE30)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JsonMergeSettings_TypeDefinitionIndex = 7048;
