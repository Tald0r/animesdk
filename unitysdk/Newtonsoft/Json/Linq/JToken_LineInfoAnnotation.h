...
#define NEWTONSOFT_JSON_LINQ_JTOKEN_LINEINFOANNOTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD11720)

namespace Newtonsoft::Json::Linq
{
	inline static constexpr unsigned int JToken_LineInfoAnnotation_TypeDefinitionIndex = 7050;
