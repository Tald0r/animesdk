...
#define NEWTONSOFT_JSON_JSONCONVERT_DESERIALIZEOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1B32AE40)
#define NEWTONSOFT_JSON_JSONCONVERT_DESERIALIZEOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1B32AEA0)
#define NEWTONSOFT_JSON_JSONCONVERT_DESERIALIZEOBJECT_3_OFFSET UNITYSDK_OFFSET(0x1B32AF10)
#define NEWTONSOFT_JSON_JSONCONVERT_DESERIALIZEOBJECT_4_OFFSET UNITYSDK_OFFSET(0x1B32ABA0)
#define NEWTONSOFT_JSON_JSONCONVERT_DESERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B32AB40)
#define NEWTONSOFT_JSON_JSONCONVERT_ENSUREDECIMALPLACE_1_OFFSET UNITYSDK_OFFSET(0x1B328AE0)
#define NEWTONSOFT_JSON_JSONCONVERT_ENSUREDECIMALPLACE_OFFSET UNITYSDK_OFFSET(0x1B3286F0)
#define NEWTONSOFT_JSON_JSONCONVERT_ENSUREFLOATFORMAT_OFFSET UNITYSDK_OFFSET(0x1B328830)
#define NEWTONSOFT_JSON_JSONCONVERT_GET_DEFAULTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B327D00)
#define NEWTONSOFT_JSON_JSONCONVERT_POPULATEOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1B32B080)
#define NEWTONSOFT_JSON_JSONCONVERT_POPULATEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B32B010)
#define NEWTONSOFT_JSON_JSONCONVERT_SERIALIZEOBJECTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B32A850)
#define NEWTONSOFT_JSON_JSONCONVERT_SERIALIZEOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1B32A290)
#define NEWTONSOFT_JSON_JSONCONVERT_SERIALIZEOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1B32A3F0)
#define NEWTONSOFT_JSON_JSONCONVERT_SERIALIZEOBJECT_3_OFFSET UNITYSDK_OFFSET(0x1B32A550)
#define NEWTONSOFT_JSON_JSONCONVERT_SERIALIZEOBJECT_4_OFFSET UNITYSDK_OFFSET(0x1B32A780)
#define NEWTONSOFT_JSON_JSONCONVERT_SERIALIZEOBJECT_5_OFFSET UNITYSDK_OFFSET(0x1B32A200)
#define NEWTONSOFT_JSON_JSONCONVERT_SERIALIZEOBJECT_6_OFFSET UNITYSDK_OFFSET(0x1B32A2F0)
#define NEWTONSOFT_JSON_JSONCONVERT_SERIALIZEOBJECT_7_OFFSET UNITYSDK_OFFSET(0x1B32A6D0)
#define NEWTONSOFT_JSON_JSONCONVERT_SERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B32A160)
#define NEWTONSOFT_JSON_JSONCONVERT_SET_DEFAULTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B327D60)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_10_OFFSET UNITYSDK_OFFSET(0x1B3285D0)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_11_OFFSET UNITYSDK_OFFSET(0x1B328600)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_12_OFFSET UNITYSDK_OFFSET(0x1B328630)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_13_OFFSET UNITYSDK_OFFSET(0x1B328660)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_14_OFFSET UNITYSDK_OFFSET(0x1B328780)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_15_OFFSET UNITYSDK_OFFSET(0x1B3289B0)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_16_OFFSET UNITYSDK_OFFSET(0x1B328A30)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_17_OFFSET UNITYSDK_OFFSET(0x1B328B30)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_18_OFFSET UNITYSDK_OFFSET(0x1B328B60)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_19_OFFSET UNITYSDK_OFFSET(0x1B328B90)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1B327E20)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_20_OFFSET UNITYSDK_OFFSET(0x1B328C50)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_21_OFFSET UNITYSDK_OFFSET(0x1B328D40)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_22_OFFSET UNITYSDK_OFFSET(0x1B328DE0)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_23_OFFSET UNITYSDK_OFFSET(0x1B328E40)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_24_OFFSET UNITYSDK_OFFSET(0x1B328F70)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_25_OFFSET UNITYSDK_OFFSET(0x1B329020)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_26_OFFSET UNITYSDK_OFFSET(0x1B328410)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_27_OFFSET UNITYSDK_OFFSET(0x1B328F10)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_28_OFFSET UNITYSDK_OFFSET(0x1B329180)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_29_OFFSET UNITYSDK_OFFSET(0x1B329230)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x1B3280D0)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_3_OFFSET UNITYSDK_OFFSET(0x1B328130)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_4_OFFSET UNITYSDK_OFFSET(0x1B328300)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_5_OFFSET UNITYSDK_OFFSET(0x1B328370)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_6_OFFSET UNITYSDK_OFFSET(0x1B328520)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_7_OFFSET UNITYSDK_OFFSET(0x1B328540)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_8_OFFSET UNITYSDK_OFFSET(0x1B328570)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_9_OFFSET UNITYSDK_OFFSET(0x1B3285A0)
#define NEWTONSOFT_JSON_JSONCONVERT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B327DC0)
#define NEWTONSOFT_JSON_JSONCONVERT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B32B310)
...
namespace Newtonsoft::Json
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(JsonConvert_TypeDefinitionIndex)->GetStaticField(0x5CE8);
		}
		...
		{
			return (::System::Func_1<::Newtonsoft::Json::JsonSerializerSettings*>**)Il2CppClass::FromTypeDefinitionIndex(JsonConvert_TypeDefinitionIndex)->GetStaticField(0x5CF8);
		}
