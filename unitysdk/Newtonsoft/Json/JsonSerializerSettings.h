...
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_BINDER_OFFSET UNITYSDK_OFFSET(0x1A8B4A30)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_CHECKADDITIONALCONTENT_OFFSET UNITYSDK_OFFSET(0x1A8B4DF0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_CONSTRUCTORHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4880)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1A8B4A70)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_CONTRACTRESOLVER_OFFSET UNITYSDK_OFFSET(0x1A8B48C0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_CONVERTERS_OFFSET UNITYSDK_OFFSET(0x1A8B4760)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_CULTURE_OFFSET UNITYSDK_OFFSET(0x1A8B4DA0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_DATEFORMATHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4C20)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_DATEFORMATSTRING_OFFSET UNITYSDK_OFFSET(0x1A8B4AE0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_DATEPARSEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4CA0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_DATETIMEZONEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4C60)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_DEFAULTVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4720)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_EQUALITYCOMPARER_OFFSET UNITYSDK_OFFSET(0x1A8B48E0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1A8B4A50)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_FLOATFORMATHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4CE0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_FLOATPARSEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4D20)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_FORMATTING_OFFSET UNITYSDK_OFFSET(0x1A8B4BE0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_MAXDEPTH_OFFSET UNITYSDK_OFFSET(0x1A8B4B40)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_METADATAPROPERTYHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4800)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_MISSINGMEMBERHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4660)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_NULLVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B46E0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_OBJECTCREATIONHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B46A0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_PRESERVEREFERENCESHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4780)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_REFERENCELOOPHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4620)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_REFERENCERESOLVERPROVIDER_OFFSET UNITYSDK_OFFSET(0x1A8B49F0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_REFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1A8B4900)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_STRINGESCAPEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4D60)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_TRACEWRITER_OFFSET UNITYSDK_OFFSET(0x1A8B4A10)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_TYPENAMEASSEMBLYFORMAT_OFFSET UNITYSDK_OFFSET(0x1A8B4840)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_GET_TYPENAMEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B47C0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_BINDER_OFFSET UNITYSDK_OFFSET(0x1A8B4A40)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_CHECKADDITIONALCONTENT_OFFSET UNITYSDK_OFFSET(0x1A8B4E10)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_CONSTRUCTORHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B48A0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1A8B4AC0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_CONTRACTRESOLVER_OFFSET UNITYSDK_OFFSET(0x1A8B48D0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_CONVERTERS_OFFSET UNITYSDK_OFFSET(0x1A8B4770)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_CULTURE_OFFSET UNITYSDK_OFFSET(0x1A8B4DE0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_DATEFORMATHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4C40)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_DATEFORMATSTRING_OFFSET UNITYSDK_OFFSET(0x1A8B4B30)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_DATEPARSEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4CC0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_DATETIMEZONEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4C80)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_DEFAULTVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4740)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_EQUALITYCOMPARER_OFFSET UNITYSDK_OFFSET(0x1A8B48F0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_ERROR_OFFSET UNITYSDK_OFFSET(0x1A8B4A60)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_FLOATFORMATHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4D00)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_FLOATPARSEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4D40)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_FORMATTING_OFFSET UNITYSDK_OFFSET(0x1A8B4C00)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_MAXDEPTH_OFFSET UNITYSDK_OFFSET(0x1A8B4B50)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_METADATAPROPERTYHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4820)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_MISSINGMEMBERHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4680)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_NULLVALUEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4700)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_OBJECTCREATIONHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B46C0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_PRESERVEREFERENCESHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B47A0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_REFERENCELOOPHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4640)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_REFERENCERESOLVERPROVIDER_OFFSET UNITYSDK_OFFSET(0x1A8B4A00)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_REFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1A8B4950)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_STRINGESCAPEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B4D80)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_TRACEWRITER_OFFSET UNITYSDK_OFFSET(0x1A8B4A20)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_TYPENAMEASSEMBLYFORMAT_OFFSET UNITYSDK_OFFSET(0x1A8B4860)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS_SET_TYPENAMEHANDLING_OFFSET UNITYSDK_OFFSET(0x1A8B47E0)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8B4E20)
#define NEWTONSOFT_JSON_JSONSERIALIZERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8B4E50)
...
namespace Newtonsoft::Json
{
	...
	public:
		...
		{
			return (::System::Globalization::CultureInfo**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializerSettings_TypeDefinitionIndex)->GetStaticField(0x5E80);
		}
		static ::System::Runtime::Serialization::StreamingContext* StaticGet_DefaultContext()
		{
			return (::System::Runtime::Serialization::StreamingContext*)Il2CppClass::FromTypeDefinitionIndex(JsonSerializerSettings_TypeDefinitionIndex)->GetStaticField(0x5E88);
		}
		...
		::System::Runtime::Serialization::SerializationBinder* _Binder_k__BackingField; // 0x30
		...
		::Newtonsoft::Json::Serialization::IContractResolver* _ContractResolver_k__BackingField; // 0x50
		::System::Collections::Generic::IList_1<::Newtonsoft::Json::JsonConverter*>* _Converters_k__BackingField; // 0x58
		...
		::System::Nullable_1<::Newtonsoft::Json::NullValueHandling> _nullValueHandling; // 0x70
		...
		::System::Nullable_1<::Newtonsoft::Json::ReferenceLoopHandling> _referenceLoopHandling; // 0x88
		...
		::System::Nullable_1<::Newtonsoft::Json::DateFormatHandling> _dateFormatHandling; // 0xA0
		::System::Nullable_1<::Newtonsoft::Json::FloatParseHandling> _floatParseHandling; // 0xA8
		::System::Nullable_1<::Newtonsoft::Json::TypeNameHandling> _typeNameHandling; // 0xB0
		::System::Nullable_1<::Newtonsoft::Json::ObjectCreationHandling> _objectCreationHandling; // 0xB8
		::System::Nullable_1<::Newtonsoft::Json::FloatFormatHandling> _floatFormatHandling; // 0xC0
		::System::Nullable_1<::Newtonsoft::Json::PreserveReferencesHandling> _preserveReferencesHandling; // 0xC8
		::System::Nullable_1<::Newtonsoft::Json::StringEscapeHandling> _stringEscapeHandling; // 0xD0
		::System::Boolean _maxDepthSet; // 0xD8
		::System::Boolean _dateFormatStringSet; // 0xD9
		...
		::System::Nullable_1<::Newtonsoft::Json::DateTimeZoneHandling> _dateTimeZoneHandling; // 0xE4
		::System::Nullable_1<::Newtonsoft::Json::MissingMemberHandling> _missingMemberHandling; // 0xEC
		::System::Nullable_1<::Newtonsoft::Json::ConstructorHandling> _constructorHandling; // 0xF4
		::System::Nullable_1<::Newtonsoft::Json::Formatting> _formatting; // 0xFC
