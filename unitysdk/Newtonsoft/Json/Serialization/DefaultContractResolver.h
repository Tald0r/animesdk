...
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CANCONVERTTOSTRING_OFFSET UNITYSDK_OFFSET(0x1A336F00)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATEARRAYCONTRACT_OFFSET UNITYSDK_OFFSET(0x1A336040)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATECONSTRUCTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A333110)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATECONTRACT_OFFSET UNITYSDK_OFFSET(0x1A3368E0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATEDICTIONARYCONTRACT_OFFSET UNITYSDK_OFFSET(0x1A335960)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATEISERIALIZABLECONTRACT_OFFSET UNITYSDK_OFFSET(0x1A3364B0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATELINQCONTRACT_OFFSET UNITYSDK_OFFSET(0x1A336450)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATEMEMBERVALUEPROVIDER_OFFSET UNITYSDK_OFFSET(0x1A337A80)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATEOBJECTCONTRACT_OFFSET UNITYSDK_OFFSET(0x1A330A50)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATEPRIMITIVECONTRACT_OFFSET UNITYSDK_OFFSET(0x1A3363F0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A337670)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATEPROPERTYFROMCONSTRUCTORPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A333400)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A337B50)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATESHOULDSERIALIZETEST_OFFSET UNITYSDK_OFFSET(0x1A337E50)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_CREATESTRINGCONTRACT_OFFSET UNITYSDK_OFFSET(0x1A336830)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GETATTRIBUTECONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A331360)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GETCALLBACKMETHODSFORTYPE_OFFSET UNITYSDK_OFFSET(0x1A334550)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GETCLASSHIERARCHYFORTYPE_OFFSET UNITYSDK_OFFSET(0x1A3329C0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GETCLRTYPEFULLNAME_OFFSET UNITYSDK_OFFSET(0x1A337480)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GETDEFAULTCREATOR_OFFSET UNITYSDK_OFFSET(0x1A333EB0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GETEXTENSIONDATAMEMBERFORTYPE_OFFSET UNITYSDK_OFFSET(0x1A331AF0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GETPARAMETERIZEDCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A331950)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GETRESOLVEDPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1A3385A0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GETSERIALIZABLEMEMBERS_OFFSET UNITYSDK_OFFSET(0x1A32F6E0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GETSTATE_OFFSET UNITYSDK_OFFSET(0x1A32F2C0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GET_DEFAULTMEMBERSSEARCHFLAGS_OFFSET UNITYSDK_OFFSET(0x1A32F0A0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GET_DYNAMICCODEGENERATION_OFFSET UNITYSDK_OFFSET(0x1A32EF90)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GET_IGNORESERIALIZABLEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A32F100)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GET_IGNORESERIALIZABLEINTERFACE_OFFSET UNITYSDK_OFFSET(0x1A32F0E0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A32EF30)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GET_NAMINGSTRATEGY_OFFSET UNITYSDK_OFFSET(0x1A32F120)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_GET_SERIALIZECOMPILERGENERATEDMEMBERS_OFFSET UNITYSDK_OFFSET(0x1A32F0C0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_INITIALIZECONTRACT_OFFSET UNITYSDK_OFFSET(0x1A330DE0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_ISICONVERTIBLE_OFFSET UNITYSDK_OFFSET(0x1A337170)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_ISJSONPRIMITIVETYPE_OFFSET UNITYSDK_OFFSET(0x1A336D20)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_ISVALIDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A335400)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_RESOLVECALLBACKMETHODS_OFFSET UNITYSDK_OFFSET(0x1A334130)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_RESOLVECONTRACTCONVERTER_OFFSET UNITYSDK_OFFSET(0x1A333E50)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_RESOLVECONTRACT_OFFSET UNITYSDK_OFFSET(0x1A32F320)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_RESOLVEDICTIONARYKEY_OFFSET UNITYSDK_OFFSET(0x1A338560)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_RESOLVEPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1A338540)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_SETEXTENSIONDATADELEGATES_OFFSET UNITYSDK_OFFSET(0x1A331CA0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_SETISSPECIFIEDACTIONS_OFFSET UNITYSDK_OFFSET(0x1A3380D0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_SETPROPERTYSETTINGSFROMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A3337B0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_SET_DEFAULTMEMBERSSEARCHFLAGS_OFFSET UNITYSDK_OFFSET(0x1A32F0B0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_SET_IGNORESERIALIZABLEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A32F110)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_SET_IGNORESERIALIZABLEINTERFACE_OFFSET UNITYSDK_OFFSET(0x1A32F0F0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_SET_NAMINGSTRATEGY_OFFSET UNITYSDK_OFFSET(0x1A32F130)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_SET_SERIALIZECOMPILERGENERATEDMEMBERS_OFFSET UNITYSDK_OFFSET(0x1A32F0D0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_SHOULDSERIALIZEENTITYMEMBER_OFFSET UNITYSDK_OFFSET(0x1A330940)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_SHOULDSKIPDESERIALIZED_OFFSET UNITYSDK_OFFSET(0x1A3353F0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER_SHOULDSKIPSERIALIZING_OFFSET UNITYSDK_OFFSET(0x1A3353E0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3385B0)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A32F200)
#define NEWTONSOFT_JSON_SERIALIZATION_DEFAULTCONTRACTRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A32F140)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int DefaultContractResolver_TypeDefinitionIndex = 6962;
	...
	public:
		...
		{
			return (::Il2CppArray<::Newtonsoft::Json::JsonConverter*>**)Il2CppClass::FromTypeDefinitionIndex(DefaultContractResolver_TypeDefinitionIndex)->GetStaticField(0x5DC0);
		}
		static ::Newtonsoft::Json::Serialization::DefaultContractResolverState** StaticGet__sharedState()
		{
			return (::Newtonsoft::Json::Serialization::DefaultContractResolverState**)Il2CppClass::FromTypeDefinitionIndex(DefaultContractResolver_TypeDefinitionIndex)->GetStaticField(0x5DC8);
		}
		static ::Newtonsoft::Json::Serialization::IContractResolver** StaticGet__instance()
		{
			return (::Newtonsoft::Json::Serialization::IContractResolver**)Il2CppClass::FromTypeDefinitionIndex(DefaultContractResolver_TypeDefinitionIndex)->GetStaticField(0x5DD0);
		}
		static ::System::Object** StaticGet_TypeContractCacheLock()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(DefaultContractResolver_TypeDefinitionIndex)->GetStaticField(0x5DD8);
		}
		::Newtonsoft::Json::Serialization::NamingStrategy* _NamingStrategy_k__BackingField; // 0x10
		::Newtonsoft::Json::Serialization::DefaultContractResolverState* _instanceState; // 0x18
		::System::Boolean _IgnoreSerializableAttribute_k__BackingField; // 0x20
		::System::Boolean _sharedCache; // 0x21
		::System::Boolean _IgnoreSerializableInterface_k__BackingField; // 0x22
		::System::Boolean _SerializeCompilerGeneratedMembers_k__BackingField; // 0x23
