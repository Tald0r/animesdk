...
#define NEWTONSOFT_JSON_SERIALIZATION_CAMELCASENAMINGSTRATEGY_RESOLVEPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1A32EF20)
#define NEWTONSOFT_JSON_SERIALIZATION_CAMELCASENAMINGSTRATEGY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A32EF10)
#define NEWTONSOFT_JSON_SERIALIZATION_CAMELCASENAMINGSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A32EF00)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int CamelCaseNamingStrategy_TypeDefinitionIndex = 6958;
