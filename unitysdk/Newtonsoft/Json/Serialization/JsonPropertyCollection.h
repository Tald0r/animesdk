...
#define NEWTONSOFT_JSON_SERIALIZATION_JSONPROPERTYCOLLECTION_ADDPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A0B5F80)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONPROPERTYCOLLECTION_GETCLOSESTMATCHPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A0B6230)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONPROPERTYCOLLECTION_GETKEYFORITEM_OFFSET UNITYSDK_OFFSET(0x1A0B5F60)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONPROPERTYCOLLECTION_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A0B6270)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONPROPERTYCOLLECTION_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1A0B6410)
#define NEWTONSOFT_JSON_SERIALIZATION_JSONPROPERTYCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0B5580)

namespace Newtonsoft::Json::Serialization
{
	inline static constexpr unsigned int JsonPropertyCollection_TypeDefinitionIndex = 6999;
