...
#define NEWTONSOFT_JSON_JSONSERIALIZATIONEXCEPTION_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1A7FEFC0)
#define NEWTONSOFT_JSON_JSONSERIALIZATIONEXCEPTION_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1A7FF270)
#define NEWTONSOFT_JSON_JSONSERIALIZATIONEXCEPTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1A7FEC40)
#define NEWTONSOFT_JSON_JSONSERIALIZATIONEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7FED70)
#define NEWTONSOFT_JSON_JSONSERIALIZATIONEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A7FF1B0)
#define NEWTONSOFT_JSON_JSONSERIALIZATIONEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A7FF220)
#define NEWTONSOFT_JSON_JSONSERIALIZATIONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7FF150)

namespace Newtonsoft::Json
{
	inline static constexpr unsigned int JsonSerializationException_TypeDefinitionIndex = 6872;
