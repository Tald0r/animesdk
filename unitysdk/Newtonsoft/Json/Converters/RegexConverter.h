...
#define NEWTONSOFT_JSON_CONVERTERS_REGEXCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1ADFA710)
#define NEWTONSOFT_JSON_CONVERTERS_REGEXCONVERTER_HASFLAG_OFFSET UNITYSDK_OFFSET(0x1ADFA240)
#define NEWTONSOFT_JSON_CONVERTERS_REGEXCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1ADFA250)
#define NEWTONSOFT_JSON_CONVERTERS_REGEXCONVERTER_READREGEXOBJECT_OFFSET UNITYSDK_OFFSET(0x1ADFA2F0)
#define NEWTONSOFT_JSON_CONVERTERS_REGEXCONVERTER_READREGEXSTRING_OFFSET UNITYSDK_OFFSET(0x1ADFA5C0)
#define NEWTONSOFT_JSON_CONVERTERS_REGEXCONVERTER_WRITEBSON_OFFSET UNITYSDK_OFFSET(0x1ADFA000)
#define NEWTONSOFT_JSON_CONVERTERS_REGEXCONVERTER_WRITEJSON_1_OFFSET UNITYSDK_OFFSET(0x1ADFA0D0)
#define NEWTONSOFT_JSON_CONVERTERS_REGEXCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1ADF9F40)
#define NEWTONSOFT_JSON_CONVERTERS_REGEXCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADFA750)
