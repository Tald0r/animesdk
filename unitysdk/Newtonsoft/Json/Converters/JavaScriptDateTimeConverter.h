...
#define NEWTONSOFT_JSON_CONVERTERS_JAVASCRIPTDATETIMECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A8C0C20)
#define NEWTONSOFT_JSON_CONVERTERS_JAVASCRIPTDATETIMECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A8C09B0)
#define NEWTONSOFT_JSON_CONVERTERS_JAVASCRIPTDATETIMECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C1420)

namespace Newtonsoft::Json::Converters
{
	inline static constexpr unsigned int JavaScriptDateTimeConverter_TypeDefinitionIndex = 7089;
