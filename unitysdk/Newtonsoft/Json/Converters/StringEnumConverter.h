...
#define NEWTONSOFT_JSON_CONVERTERS_STRINGENUMCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1B753E10)
#define NEWTONSOFT_JSON_CONVERTERS_STRINGENUMCONVERTER_GET_ALLOWINTEGERVALUES_OFFSET UNITYSDK_OFFSET(0x1B7538B0)
#define NEWTONSOFT_JSON_CONVERTERS_STRINGENUMCONVERTER_GET_CAMELCASETEXT_OFFSET UNITYSDK_OFFSET(0x1B753890)
#define NEWTONSOFT_JSON_CONVERTERS_STRINGENUMCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1B753AC0)
#define NEWTONSOFT_JSON_CONVERTERS_STRINGENUMCONVERTER_SET_ALLOWINTEGERVALUES_OFFSET UNITYSDK_OFFSET(0x1B7538C0)
#define NEWTONSOFT_JSON_CONVERTERS_STRINGENUMCONVERTER_SET_CAMELCASETEXT_OFFSET UNITYSDK_OFFSET(0x1B7538A0)
#define NEWTONSOFT_JSON_CONVERTERS_STRINGENUMCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1B7538F0)
#define NEWTONSOFT_JSON_CONVERTERS_STRINGENUMCONVERTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B7538E0)
#define NEWTONSOFT_JSON_CONVERTERS_STRINGENUMCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7538D0)
