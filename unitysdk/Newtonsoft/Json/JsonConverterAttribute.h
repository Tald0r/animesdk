...
#define NEWTONSOFT_JSON_JSONCONVERTERATTRIBUTE_GET_CONVERTERPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B137870)
#define NEWTONSOFT_JSON_JSONCONVERTERATTRIBUTE_GET_CONVERTERTYPE_OFFSET UNITYSDK_OFFSET(0x1B137860)
#define NEWTONSOFT_JSON_JSONCONVERTERATTRIBUTE_SET_CONVERTERPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B137880)
#define NEWTONSOFT_JSON_JSONCONVERTERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B137900)
#define NEWTONSOFT_JSON_JSONCONVERTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B137890)

namespace Newtonsoft::Json
{
	inline static constexpr unsigned int JsonConverterAttribute_TypeDefinitionIndex = 6858;
