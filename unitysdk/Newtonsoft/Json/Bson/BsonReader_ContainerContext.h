...
#define NEWTONSOFT_JSON_BSON_BSONREADER_CONTAINERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A983B40)

namespace Newtonsoft::Json::Bson
{
	inline static constexpr unsigned int BsonReader_ContainerContext_TypeDefinitionIndex = 7099;
