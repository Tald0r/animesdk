...
#define NEWTONSOFT_JSON_BSON_BSONWRITER_ADDPARENT_OFFSET UNITYSDK_OFFSET(0x1A0A7160)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_ADDTOKEN_OFFSET UNITYSDK_OFFSET(0x1A0A7330)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_ADDVALUE_OFFSET UNITYSDK_OFFSET(0x1A0A74F0)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A0A72A0)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A0A6E60)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_GET_DATETIMEKINDHANDLING_OFFSET UNITYSDK_OFFSET(0x1A0A6BE0)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_REMOVEPARENT_OFFSET UNITYSDK_OFFSET(0x1A0A6F10)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_SET_DATETIMEKINDHANDLING_OFFSET UNITYSDK_OFFSET(0x1A0A6C00)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITECOMMENT_OFFSET UNITYSDK_OFFSET(0x1A0A6F30)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEEND_OFFSET UNITYSDK_OFFSET(0x1A0A6EA0)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITENULL_OFFSET UNITYSDK_OFFSET(0x1A0A7560)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEOBJECTID_OFFSET UNITYSDK_OFFSET(0x1A0A8250)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1A0A7270)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITERAWVALUE_OFFSET UNITYSDK_OFFSET(0x1A0A7020)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITERAW_OFFSET UNITYSDK_OFFSET(0x1A0A6FD0)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEREGEX_OFFSET UNITYSDK_OFFSET(0x1A0A8370)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITESTARTARRAY_OFFSET UNITYSDK_OFFSET(0x1A0A7070)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITESTARTCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A0A6F80)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITESTARTOBJECT_OFFSET UNITYSDK_OFFSET(0x1A0A7180)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEUNDEFINED_OFFSET UNITYSDK_OFFSET(0x1A0A75D0)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_10_OFFSET UNITYSDK_OFFSET(0x1A0A7BA0)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_11_OFFSET UNITYSDK_OFFSET(0x1A0A7C20)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_12_OFFSET UNITYSDK_OFFSET(0x1A0A7D00)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_13_OFFSET UNITYSDK_OFFSET(0x1A0A7D80)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_14_OFFSET UNITYSDK_OFFSET(0x1A0A7E00)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_15_OFFSET UNITYSDK_OFFSET(0x1A0A7E90)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_16_OFFSET UNITYSDK_OFFSET(0x1A0A7F60)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_17_OFFSET UNITYSDK_OFFSET(0x1A0A7FF0)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_18_OFFSET UNITYSDK_OFFSET(0x1A0A8070)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_19_OFFSET UNITYSDK_OFFSET(0x1A0A80F0)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A0A7640)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_20_OFFSET UNITYSDK_OFFSET(0x1A0A8190)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_2_OFFSET UNITYSDK_OFFSET(0x1A0A76F0)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_3_OFFSET UNITYSDK_OFFSET(0x1A0A7770)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_4_OFFSET UNITYSDK_OFFSET(0x1A0A7830)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_5_OFFSET UNITYSDK_OFFSET(0x1A0A78B0)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_6_OFFSET UNITYSDK_OFFSET(0x1A0A7980)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_7_OFFSET UNITYSDK_OFFSET(0x1A0A7A10)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_8_OFFSET UNITYSDK_OFFSET(0x1A0A7AA0)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_9_OFFSET UNITYSDK_OFFSET(0x1A0A7B20)
#define NEWTONSOFT_JSON_BSON_BSONWRITER_WRITEVALUE_OFFSET UNITYSDK_OFFSET(0x1A0A7550)
#define NEWTONSOFT_JSON_BSON_BSONWRITER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0A6D80)
#define NEWTONSOFT_JSON_BSON_BSONWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0A6C20)

namespace Newtonsoft::Json::Bson
{
	inline static constexpr unsigned int BsonWriter_TypeDefinitionIndex = 7109;
	...
	public:
		...
		::Newtonsoft::Json::Bson::BsonBinaryWriter* _writer; // 0x78
