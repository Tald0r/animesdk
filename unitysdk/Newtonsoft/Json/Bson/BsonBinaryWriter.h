...
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_CALCULATESIZEWITHLENGTH_OFFSET UNITYSDK_OFFSET(0x1A663BE0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_CALCULATESIZE_1_OFFSET UNITYSDK_OFFSET(0x1A661BA0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A663BD0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A661B40)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A661B10)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_GET_DATETIMEKINDHANDLING_OFFSET UNITYSDK_OFFSET(0x1A661AE0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_SET_DATETIMEKINDHANDLING_OFFSET UNITYSDK_OFFSET(0x1A661AF0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x1A6639B0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_WRITETOKENINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A6626A0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_WRITETOKEN_OFFSET UNITYSDK_OFFSET(0x1A661B70)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER_WRITEUTF8BYTES_OFFSET UNITYSDK_OFFSET(0x1A663A20)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A663BF0)
#define NEWTONSOFT_JSON_BSON_BSONBINARYWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A661B00)
