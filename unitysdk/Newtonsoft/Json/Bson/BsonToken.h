...
#define NEWTONSOFT_JSON_BSON_BSONTOKEN_GET_CALCULATEDSIZE_OFFSET UNITYSDK_OFFSET(0x1A2EA040)
#define NEWTONSOFT_JSON_BSON_BSONTOKEN_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1A2EA020)
#define NEWTONSOFT_JSON_BSON_BSONTOKEN_SET_CALCULATEDSIZE_OFFSET UNITYSDK_OFFSET(0x1A2EA050)
#define NEWTONSOFT_JSON_BSON_BSONTOKEN_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1A2EA030)
#define NEWTONSOFT_JSON_BSON_BSONTOKEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2EA060)

namespace Newtonsoft::Json::Bson
{
	inline static constexpr unsigned int BsonToken_TypeDefinitionIndex = 7100;
