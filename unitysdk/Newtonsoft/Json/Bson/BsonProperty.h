...
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AC44120)
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AC44140)
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1AC44130)
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AC44150)
#define NEWTONSOFT_JSON_BSON_BSONPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC44160)

namespace Newtonsoft::Json::Bson
{
	inline static constexpr unsigned int BsonProperty_TypeDefinitionIndex = 7107;
