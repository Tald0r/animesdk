...
#define NEWTONSOFT_JSON_BSON_BSONREADER_BYTESINSEQUENCE_OFFSET UNITYSDK_OFFSET(0x1B248C80)
#define NEWTONSOFT_JSON_BSON_BSONREADER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B247A20)
#define NEWTONSOFT_JSON_BSON_BSONREADER_ENSUREBUFFERS_OFFSET UNITYSDK_OFFSET(0x1B248600)
#define NEWTONSOFT_JSON_BSON_BSONREADER_GETLASTFULLCHARSTOP_OFFSET UNITYSDK_OFFSET(0x1B2486F0)
#define NEWTONSOFT_JSON_BSON_BSONREADER_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1B248790)
#define NEWTONSOFT_JSON_BSON_BSONREADER_GET_DATETIMEKINDHANDLING_OFFSET UNITYSDK_OFFSET(0x1B2465C0)
#define NEWTONSOFT_JSON_BSON_BSONREADER_GET_JSONNET35BINARYCOMPATIBILITY_OFFSET UNITYSDK_OFFSET(0x1B246580)
#define NEWTONSOFT_JSON_BSON_BSONREADER_GET_READROOTVALUEASARRAY_OFFSET UNITYSDK_OFFSET(0x1B2465A0)
#define NEWTONSOFT_JSON_BSON_BSONREADER_MOVEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B248460)
#define NEWTONSOFT_JSON_BSON_BSONREADER_POPCONTEXT_OFFSET UNITYSDK_OFFSET(0x1B2483A0)
#define NEWTONSOFT_JSON_BSON_BSONREADER_PUSHCONTEXT_OFFSET UNITYSDK_OFFSET(0x1B247B20)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READBINARY_OFFSET UNITYSDK_OFFSET(0x1B2484C0)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READBYTES_OFFSET UNITYSDK_OFFSET(0x1B247B80)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READBYTE_OFFSET UNITYSDK_OFFSET(0x1B248360)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READCODEWSCOPE_OFFSET UNITYSDK_OFFSET(0x1B2476F0)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B248480)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READELEMENT_OFFSET UNITYSDK_OFFSET(0x1B2469C0)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READINT32_OFFSET UNITYSDK_OFFSET(0x1B247A60)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READINT64_OFFSET UNITYSDK_OFFSET(0x1B2485C0)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READLENGTHSTRING_OFFSET UNITYSDK_OFFSET(0x1B247AA0)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READNORMAL_OFFSET UNITYSDK_OFFSET(0x1B2470B0)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B247460)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READSTRING_OFFSET UNITYSDK_OFFSET(0x1B246A50)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READTYPE_1_OFFSET UNITYSDK_OFFSET(0x1B246A10)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READTYPE_OFFSET UNITYSDK_OFFSET(0x1B247BC0)
#define NEWTONSOFT_JSON_BSON_BSONREADER_READ_OFFSET UNITYSDK_OFFSET(0x1B246F60)
#define NEWTONSOFT_JSON_BSON_BSONREADER_SET_DATETIMEKINDHANDLING_OFFSET UNITYSDK_OFFSET(0x1B2465D0)
#define NEWTONSOFT_JSON_BSON_BSONREADER_SET_JSONNET35BINARYCOMPATIBILITY_OFFSET UNITYSDK_OFFSET(0x1B246590)
#define NEWTONSOFT_JSON_BSON_BSONREADER_SET_READROOTVALUEASARRAY_OFFSET UNITYSDK_OFFSET(0x1B2465B0)
#define NEWTONSOFT_JSON_BSON_BSONREADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B248FB0)
#define NEWTONSOFT_JSON_BSON_BSONREADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B246770)
#define NEWTONSOFT_JSON_BSON_BSONREADER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B2465F0)
#define NEWTONSOFT_JSON_BSON_BSONREADER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B246890)
#define NEWTONSOFT_JSON_BSON_BSONREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2465E0)
...
namespace Newtonsoft::Json::Bson
{
	...
	public:
		...
		::Newtonsoft::Json::Bson::BsonType _currentElementType; // 0x9D
