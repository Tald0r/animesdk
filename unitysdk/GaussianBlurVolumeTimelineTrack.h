...
#define GAUSSIANBLURVOLUMETIMELINETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x668F9C0)
#define GAUSSIANBLURVOLUMETIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x66902E0)
#define GAUSSIANBLURVOLUMETIMELINETRACK___BASE_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x6690310)

inline static constexpr unsigned int GaussianBlurVolumeTimelineTrack_TypeDefinitionIndex = 60846;
