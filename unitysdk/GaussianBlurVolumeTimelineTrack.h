...
#define GAUSSIANBLURVOLUMETIMELINETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x6900C60)
#define GAUSSIANBLURVOLUMETIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x6901580)
#define GAUSSIANBLURVOLUMETIMELINETRACK___BASE_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x69015B0)

inline static constexpr unsigned int GaussianBlurVolumeTimelineTrack_TypeDefinitionIndex = 46477;
