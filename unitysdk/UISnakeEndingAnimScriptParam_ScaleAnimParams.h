...
#define UISNAKEENDINGANIMSCRIPTPARAM_SCALEANIMPARAMS_CALVALUEBYEVALUATECURVE_OFFSET UNITYSDK_OFFSET(0x1AC62BB0)
#define UISNAKEENDINGANIMSCRIPTPARAM_SCALEANIMPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC62C60)

inline static constexpr unsigned int UISnakeEndingAnimScriptParam_ScaleAnimParams_TypeDefinitionIndex = 83650;
