...
#define UISNAKEENDINGANIMSCRIPTPARAM_SCALEANIMPARAMS_CALVALUEBYEVALUATECURVE_OFFSET UNITYSDK_OFFSET(0x1A82B6D0)
#define UISNAKEENDINGANIMSCRIPTPARAM_SCALEANIMPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A82B780)

inline static constexpr unsigned int UISnakeEndingAnimScriptParam_ScaleAnimParams_TypeDefinitionIndex = 81700;
