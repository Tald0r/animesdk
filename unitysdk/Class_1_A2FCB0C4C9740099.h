...
#define CLASS_1_A2FCB0C4C9740099__CTOR_OFFSET UNITYSDK_OFFSET(0x8AD0260)

inline static constexpr unsigned int Class_1_A2FCB0C4C9740099_TypeDefinitionIndex = 60782;

class Class_1_A2FCB0C4C9740099 : public ::System::Object
{
public:
	::MoleMole::UIAbyssArpeggioTalentPageController* Field_1_0; // 0x10
	::MoleMole::UIAbyssArpeggioTalentRowWidgetController* Field_1_3; // 0x18
