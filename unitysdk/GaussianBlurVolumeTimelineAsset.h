...
#define GAUSSIANBLURVOLUMETIMELINEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x8E7DC40)
#define GAUSSIANBLURVOLUMETIMELINEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x8E7DC30)
#define GAUSSIANBLURVOLUMETIMELINEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x8E7DE60)

inline static constexpr unsigned int GaussianBlurVolumeTimelineAsset_TypeDefinitionIndex = 53907;
