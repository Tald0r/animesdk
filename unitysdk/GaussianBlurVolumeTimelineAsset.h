...
#define GAUSSIANBLURVOLUMETIMELINEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x5FE0B10)
#define GAUSSIANBLURVOLUMETIMELINEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x5FE0B00)
#define GAUSSIANBLURVOLUMETIMELINEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x5FE0D40)

inline static constexpr unsigned int GaussianBlurVolumeTimelineAsset_TypeDefinitionIndex = 73430;
