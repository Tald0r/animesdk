...
#define CLASS_2_DA2256243096945B_BINARYLOADFIELDS_OFFSET UNITYSDK_OFFSET(0x19D05290)
#define CLASS_2_DA2256243096945B_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19D04240)
#define CLASS_2_DA2256243096945B_ISTYPESTRICTLYEQUAL_OFFSET UNITYSDK_OFFSET(0x19D042B0)
#define CLASS_2_DA2256243096945B_JSONDESERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x19D04300)
#define CLASS_2_DA2256243096945B__CTOR_OFFSET UNITYSDK_OFFSET(0x19D05F30)

inline static constexpr unsigned int Class_2_DA2256243096945B_TypeDefinitionIndex = 83003;
