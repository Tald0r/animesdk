...
#define CLASS_2_DA2256243096945B_BINARYLOADFIELDS_OFFSET UNITYSDK_OFFSET(0x194C3AB0)
#define CLASS_2_DA2256243096945B_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x194C2A60)
#define CLASS_2_DA2256243096945B_ISTYPESTRICTLYEQUAL_OFFSET UNITYSDK_OFFSET(0x194C2AD0)
#define CLASS_2_DA2256243096945B_JSONDESERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x194C2B20)
#define CLASS_2_DA2256243096945B__CTOR_OFFSET UNITYSDK_OFFSET(0x194C4760)

inline static constexpr unsigned int Class_2_DA2256243096945B_TypeDefinitionIndex = 80857;
