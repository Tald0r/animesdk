...
#define PUSHBOXTILEVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0x1919BE30)
#define PUSHBOXTILEVIEW_GETWORLDLOCALPOS_OFFSET UNITYSDK_OFFSET(0x1919C700)
#define PUSHBOXTILEVIEW_GET_SELFGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1919CEF0)
#define PUSHBOXTILEVIEW_GET_SELFTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1919CE20)
#define PUSHBOXTILEVIEW_INIT_OFFSET UNITYSDK_OFFSET(0x1919C3B0)
#define PUSHBOXTILEVIEW_PLAYFRONTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1919C0A0)
#define PUSHBOXTILEVIEW_PLAYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1919CA10)
#define PUSHBOXTILEVIEW_REFRESHBYSERVERINFO_OFFSET UNITYSDK_OFFSET(0x1919C7D0)
#define PUSHBOXTILEVIEW_SETHIDDEN_OFFSET UNITYSDK_OFFSET(0x1919BEB0)
#define PUSHBOXTILEVIEW_SETWORLDLOCALPOS_OFFSET UNITYSDK_OFFSET(0x1919C650)
#define PUSHBOXTILEVIEW_SHOWREALTILE_OFFSET UNITYSDK_OFFSET(0x1919C2D0)
#define PUSHBOXTILEVIEW_SHOWRESETFRAME_OFFSET UNITYSDK_OFFSET(0x1919BFE0)
#define PUSHBOXTILEVIEW_SHOWWHITE_OFFSET UNITYSDK_OFFSET(0x1919BF30)
#define PUSHBOXTILEVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1919CC40)
#define PUSHBOXTILEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1919CFC0)

inline static constexpr unsigned int PushBoxTileView_TypeDefinitionIndex = 74691;
