...
#define CLASS_3_D4C48C7E44C6A2A6_CREATEFILTERS_OFFSET UNITYSDK_OFFSET(0x77E4B70)
#define CLASS_3_D4C48C7E44C6A2A6_METHOD_3_22BF706A189D417F_OFFSET UNITYSDK_OFFSET(0x77E57C0)
#define CLASS_3_D4C48C7E44C6A2A6_METHOD_3_5AB20B48B8E64C8B_OFFSET UNITYSDK_OFFSET(0x77E50E0)
#define CLASS_3_D4C48C7E44C6A2A6_METHOD_3_BADC81CF9C936EDA_OFFSET UNITYSDK_OFFSET(0x77E5010)
#define CLASS_3_D4C48C7E44C6A2A6_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x77E5080)
#define CLASS_3_D4C48C7E44C6A2A6_METHOD_3_E10DB4083CB3460C_OFFSET UNITYSDK_OFFSET(0x77E5530)
#define CLASS_3_D4C48C7E44C6A2A6_POSTLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x77E4E70)
#define CLASS_3_D4C48C7E44C6A2A6__CTOR_OFFSET UNITYSDK_OFFSET(0x77E4FF0)

inline static constexpr unsigned int Class_3_D4C48C7E44C6A2A6_TypeDefinitionIndex = 38711;
