...
#define AGENTLINKMOVER__NORMALSPEED_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x737BDD0)
#define AGENTLINKMOVER__NORMALSPEED_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x737C100)
#define AGENTLINKMOVER__NORMALSPEED_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x737C160)
#define AGENTLINKMOVER__NORMALSPEED_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x737C110)
#define AGENTLINKMOVER__NORMALSPEED_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x737BDC0)
#define AGENTLINKMOVER__NORMALSPEED_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x737BDB0)

inline static constexpr unsigned int AgentLinkMover__NormalSpeed_d__3_TypeDefinitionIndex = 75949;
