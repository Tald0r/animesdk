...
#define AKROOM_EXIT_OFFSET UNITYSDK_OFFSET(0x1B3FDEE0)
#define AKROOM_GETAKROOMID_OFFSET UNITYSDK_OFFSET(0x1B3FD950)
#define AKROOM_GETID_OFFSET UNITYSDK_OFFSET(0x1B3FDB80)
#define AKROOM_GET_ROOMCOUNT_OFFSET UNITYSDK_OFFSET(0x1B3FDCE0)
#define AKROOM_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1B3FF450)
#define AKROOM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B3FEB20)
#define AKROOM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B3FDFE0)
#define AKROOM_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1B3FF0D0)
#define AKROOM_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1B3FF110)
#define AKROOM_POSTROOMTONE_OFFSET UNITYSDK_OFFSET(0x1B3FF150)
#define AKROOM_SET_ROOMCOUNT_OFFSET UNITYSDK_OFFSET(0x1B3FDD40)
#define AKROOM_TRYENTER_OFFSET UNITYSDK_OFFSET(0x1B3FDDA0)
#define AKROOM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B3FF5F0)
#define AKROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3FF460)

inline static constexpr unsigned int AkRoom_TypeDefinitionIndex = 31085;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AkRoom_TypeDefinitionIndex)->GetStaticField(0x7BC0);
	}
	static ::System::UInt64* StaticGet_INVALID_ROOM_ID()
	{
		return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(AkRoom_TypeDefinitionIndex)->GetStaticField(0x7BC8);
	}
