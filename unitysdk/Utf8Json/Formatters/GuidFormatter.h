...
#define UTF8JSON_FORMATTERS_GUIDFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B06E040)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B06DF40)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B06DF80)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B06DE80)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B06E090)
#define UTF8JSON_FORMATTERS_GUIDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B06E080)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int GuidFormatter_TypeDefinitionIndex = 82032;
	...
	public:
		...
		{
			return (::Utf8Json::IJsonFormatter_1<::System::Guid>**)Il2CppClass::FromTypeDefinitionIndex(GuidFormatter_TypeDefinitionIndex)->GetStaticField(0x47260);
		}
