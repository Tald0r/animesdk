...
#define UTF8JSON_FORMATTERS_INT16FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B7080C0)
#define UTF8JSON_FORMATTERS_INT16FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B708000)
#define UTF8JSON_FORMATTERS_INT16FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B708010)
#define UTF8JSON_FORMATTERS_INT16FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B707FD0)
#define UTF8JSON_FORMATTERS_INT16FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B708140)
#define UTF8JSON_FORMATTERS_INT16FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B708130)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int Int16Formatter_TypeDefinitionIndex = 84036;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::Int16Formatter**)Il2CppClass::FromTypeDefinitionIndex(Int16Formatter_TypeDefinitionIndex)->GetStaticField(0x48B80);
		}
