...
#define UTF8JSON_FORMATTERS_ENUMFORMATTERHELPER_GETDESERIALIZEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B008B50)
#define UTF8JSON_FORMATTERS_ENUMFORMATTERHELPER_GETSERIALIZEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B0085E0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int EnumFormatterHelper_TypeDefinitionIndex = 81980;
