...
#define UTF8JSON_FORMATTERS_ENUMFORMATTERHELPER_GETDESERIALIZEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B61ACE0)
#define UTF8JSON_FORMATTERS_ENUMFORMATTERHELPER_GETSERIALIZEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B61A770)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int EnumFormatterHelper_TypeDefinitionIndex = 84021;
