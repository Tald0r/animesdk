...
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B3D3190)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B3D2F60)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B3D3080)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B3D2EE0)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B3D3370)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3D3360)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int DoubleFormatter_TypeDefinitionIndex = 84059;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::DoubleFormatter**)Il2CppClass::FromTypeDefinitionIndex(DoubleFormatter_TypeDefinitionIndex)->GetStaticField(0x483E0);
		}
