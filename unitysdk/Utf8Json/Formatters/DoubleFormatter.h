...
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1ADBE5B0)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADBE380)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1ADBE4A0)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADBE300)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ADBE790)
#define UTF8JSON_FORMATTERS_DOUBLEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADBE780)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int DoubleFormatter_TypeDefinitionIndex = 82018;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::DoubleFormatter**)Il2CppClass::FromTypeDefinitionIndex(DoubleFormatter_TypeDefinitionIndex)->GetStaticField(0x469D0);
		}
