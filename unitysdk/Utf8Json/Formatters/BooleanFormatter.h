...
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1ABFBFB0)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ABFBF00)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1ABFBF10)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ABFBEF0)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABFBFF0)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABFBFE0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int BooleanFormatter_TypeDefinitionIndex = 82021;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::BooleanFormatter**)Il2CppClass::FromTypeDefinitionIndex(BooleanFormatter_TypeDefinitionIndex)->GetStaticField(0x471B0);
		}
