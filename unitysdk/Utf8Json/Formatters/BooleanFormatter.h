...
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B20D2D0)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B20D220)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B20D230)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B20D210)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B20D310)
#define UTF8JSON_FORMATTERS_BOOLEANFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B20D300)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int BooleanFormatter_TypeDefinitionIndex = 84062;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::BooleanFormatter**)Il2CppClass::FromTypeDefinitionIndex(BooleanFormatter_TypeDefinitionIndex)->GetStaticField(0x48BC0);
		}
