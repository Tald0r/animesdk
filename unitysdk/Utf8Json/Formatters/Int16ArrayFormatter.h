...
#define UTF8JSON_FORMATTERS_INT16ARRAYFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B668040)
#define UTF8JSON_FORMATTERS_INT16ARRAYFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B667E90)
#define UTF8JSON_FORMATTERS_INT16ARRAYFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6681B0)
#define UTF8JSON_FORMATTERS_INT16ARRAYFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6681A0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int Int16ArrayFormatter_TypeDefinitionIndex = 84038;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::Int16ArrayFormatter**)Il2CppClass::FromTypeDefinitionIndex(Int16ArrayFormatter_TypeDefinitionIndex)->GetStaticField(0x48960);
		}
