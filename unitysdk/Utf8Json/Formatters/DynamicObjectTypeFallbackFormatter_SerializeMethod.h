...
#define UTF8JSON_FORMATTERS_DYNAMICOBJECTTYPEFALLBACKFORMATTER_SERIALIZEMETHOD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E4660)
#define UTF8JSON_FORMATTERS_DYNAMICOBJECTTYPEFALLBACKFORMATTER_SERIALIZEMETHOD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E4700)
#define UTF8JSON_FORMATTERS_DYNAMICOBJECTTYPEFALLBACKFORMATTER_SERIALIZEMETHOD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E3FB0)
#define UTF8JSON_FORMATTERS_DYNAMICOBJECTTYPEFALLBACKFORMATTER_SERIALIZEMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E3F90)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int DynamicObjectTypeFallbackFormatter_SerializeMethod_TypeDefinitionIndex = 84019;
