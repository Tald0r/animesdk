...
#define UTF8JSON_FORMATTERS_INT32FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B5E8370)
#define UTF8JSON_FORMATTERS_INT32FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B5E82B0)
#define UTF8JSON_FORMATTERS_INT32FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B5E82C0)
#define UTF8JSON_FORMATTERS_INT32FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B5E8280)
#define UTF8JSON_FORMATTERS_INT32FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5E83F0)
#define UTF8JSON_FORMATTERS_INT32FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5E83E0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int Int32Formatter_TypeDefinitionIndex = 84039;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::Int32Formatter**)Il2CppClass::FromTypeDefinitionIndex(Int32Formatter_TypeDefinitionIndex)->GetStaticField(0x48A20);
		}
