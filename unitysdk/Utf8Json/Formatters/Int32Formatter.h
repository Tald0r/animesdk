...
#define UTF8JSON_FORMATTERS_INT32FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1AFD9600)
#define UTF8JSON_FORMATTERS_INT32FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AFD9540)
#define UTF8JSON_FORMATTERS_INT32FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1AFD9550)
#define UTF8JSON_FORMATTERS_INT32FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AFD9510)
#define UTF8JSON_FORMATTERS_INT32FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFD9680)
#define UTF8JSON_FORMATTERS_INT32FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD9670)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int Int32Formatter_TypeDefinitionIndex = 81998;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::Int32Formatter**)Il2CppClass::FromTypeDefinitionIndex(Int32Formatter_TypeDefinitionIndex)->GetStaticField(0x47010);
		}
