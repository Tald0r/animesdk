...
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6CF660)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6CF580)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6CF530)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CF4E0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableDateTimeFormatter_TypeDefinitionIndex = 83999;
