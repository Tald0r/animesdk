...
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0C1590)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0C14B0)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0C1460)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C1410)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableDateTimeFormatter_TypeDefinitionIndex = 81958;
