...
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6CEB60)
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6CEB00)
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6CEAF0)
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CEAE0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int DateTimeFormatter_TypeDefinitionIndex = 83998;
