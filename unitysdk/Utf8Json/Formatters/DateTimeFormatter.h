...
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0C0A90)
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0C0A30)
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0C0A20)
#define UTF8JSON_FORMATTERS_DATETIMEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C0A10)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int DateTimeFormatter_TypeDefinitionIndex = 81957;
