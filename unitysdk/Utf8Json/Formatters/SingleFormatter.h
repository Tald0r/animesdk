...
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B509F80)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B509E60)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B509E70)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B509DE0)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B509FC0)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B509FB0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int SingleFormatter_TypeDefinitionIndex = 84056;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::SingleFormatter**)Il2CppClass::FromTypeDefinitionIndex(SingleFormatter_TypeDefinitionIndex)->GetStaticField(0x48BB0);
		}
