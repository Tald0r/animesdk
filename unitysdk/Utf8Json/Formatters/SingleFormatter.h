...
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1AEE21F0)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AEE20D0)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1AEE20E0)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AEE2050)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AEE2230)
#define UTF8JSON_FORMATTERS_SINGLEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEE2220)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int SingleFormatter_TypeDefinitionIndex = 82015;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::SingleFormatter**)Il2CppClass::FromTypeDefinitionIndex(SingleFormatter_TypeDefinitionIndex)->GetStaticField(0x471A0);
		}
