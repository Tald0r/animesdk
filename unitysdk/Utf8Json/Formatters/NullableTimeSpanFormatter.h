...
#define UTF8JSON_FORMATTERS_NULLABLETIMESPANFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0C1B70)
#define UTF8JSON_FORMATTERS_NULLABLETIMESPANFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0C1A60)
#define UTF8JSON_FORMATTERS_NULLABLETIMESPANFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C1A10)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableTimeSpanFormatter_TypeDefinitionIndex = 81965;
