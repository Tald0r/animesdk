...
#define UTF8JSON_FORMATTERS_NULLABLETIMESPANFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6CFC40)
#define UTF8JSON_FORMATTERS_NULLABLETIMESPANFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6CFB30)
#define UTF8JSON_FORMATTERS_NULLABLETIMESPANFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CFAE0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableTimeSpanFormatter_TypeDefinitionIndex = 84006;
