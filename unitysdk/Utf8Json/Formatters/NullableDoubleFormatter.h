...
#define UTF8JSON_FORMATTERS_NULLABLEDOUBLEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B6CFA20)
#define UTF8JSON_FORMATTERS_NULLABLEDOUBLEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6CF830)
#define UTF8JSON_FORMATTERS_NULLABLEDOUBLEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B6CF880)
#define UTF8JSON_FORMATTERS_NULLABLEDOUBLEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6CF740)
#define UTF8JSON_FORMATTERS_NULLABLEDOUBLEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6CFAA0)
#define UTF8JSON_FORMATTERS_NULLABLEDOUBLEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CFA90)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableDoubleFormatter_TypeDefinitionIndex = 84060;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::NullableDoubleFormatter**)Il2CppClass::FromTypeDefinitionIndex(NullableDoubleFormatter_TypeDefinitionIndex)->GetStaticField(0x48C00);
		}
