...
#define UTF8JSON_FORMATTERS_UINT16FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B05C510)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B05C450)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B05C460)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B05C420)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B05C590)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B05C580)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int UInt16Formatter_TypeDefinitionIndex = 82006;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::UInt16Formatter**)Il2CppClass::FromTypeDefinitionIndex(UInt16Formatter_TypeDefinitionIndex)->GetStaticField(0x46F60);
		}
