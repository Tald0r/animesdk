...
#define UTF8JSON_FORMATTERS_UINT16FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B6682E0)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B668220)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B668230)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6681F0)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B668360)
#define UTF8JSON_FORMATTERS_UINT16FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B668350)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int UInt16Formatter_TypeDefinitionIndex = 84047;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::UInt16Formatter**)Il2CppClass::FromTypeDefinitionIndex(UInt16Formatter_TypeDefinitionIndex)->GetStaticField(0x48970);
		}
