...
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B61B4E0)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B61B4C0)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B61B4D0)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B61B4B0)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B61B500)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B61B4F0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableStringFormatter_TypeDefinitionIndex = 84068;
	...
	public:
		...
		{
			return (::Utf8Json::IJsonFormatter_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(NullableStringFormatter_TypeDefinitionIndex)->GetStaticField(0x48B60);
		}
