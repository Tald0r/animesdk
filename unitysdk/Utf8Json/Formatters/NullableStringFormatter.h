...
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B009350)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B009330)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B009340)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B009320)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B009370)
#define UTF8JSON_FORMATTERS_NULLABLESTRINGFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B009360)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableStringFormatter_TypeDefinitionIndex = 82027;
	...
	public:
		...
		{
			return (::Utf8Json::IJsonFormatter_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(NullableStringFormatter_TypeDefinitionIndex)->GetStaticField(0x47150);
		}
