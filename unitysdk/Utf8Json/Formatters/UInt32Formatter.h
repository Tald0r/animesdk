...
#define UTF8JSON_FORMATTERS_UINT32FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B06F490)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B06F3D0)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B06F3E0)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B06F3A0)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B06F510)
#define UTF8JSON_FORMATTERS_UINT32FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B06F500)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int UInt32Formatter_TypeDefinitionIndex = 82009;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::UInt32Formatter**)Il2CppClass::FromTypeDefinitionIndex(UInt32Formatter_TypeDefinitionIndex)->GetStaticField(0x47180);
		}
