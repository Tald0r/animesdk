...
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4E5450)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4E53A0)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4E5350)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E5300)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableDateTimeOffsetFormatter_TypeDefinitionIndex = 84003;
