...
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AEC6590)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AEC64E0)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEC6490)
#define UTF8JSON_FORMATTERS_NULLABLEDATETIMEOFFSETFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEC6440)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableDateTimeOffsetFormatter_TypeDefinitionIndex = 81962;
