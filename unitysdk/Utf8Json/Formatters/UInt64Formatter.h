...
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B12D590)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B12D460)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B12D4E0)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B12D430)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B12D5D0)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B12D5C0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int UInt64Formatter_TypeDefinitionIndex = 82012;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::UInt64Formatter**)Il2CppClass::FromTypeDefinitionIndex(UInt64Formatter_TypeDefinitionIndex)->GetStaticField(0x47190);
		}
