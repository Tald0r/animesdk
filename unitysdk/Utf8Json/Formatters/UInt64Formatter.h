...
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B748180)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B748050)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B7480D0)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B748020)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B7481C0)
#define UTF8JSON_FORMATTERS_UINT64FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7481B0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int UInt64Formatter_TypeDefinitionIndex = 84053;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::UInt64Formatter**)Il2CppClass::FromTypeDefinitionIndex(UInt64Formatter_TypeDefinitionIndex)->GetStaticField(0x48BA0);
		}
