...
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1AEE1D10)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AEE1BF0)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1AEE1C30)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AEE1B90)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AEE1DB0)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEE1DA0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableByteFormatter_TypeDefinitionIndex = 82005;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::NullableByteFormatter**)Il2CppClass::FromTypeDefinitionIndex(NullableByteFormatter_TypeDefinitionIndex)->GetStaticField(0x47210);
		}
