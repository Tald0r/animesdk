...
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B509AA0)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B509980)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B5099C0)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B509920)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B509B40)
#define UTF8JSON_FORMATTERS_NULLABLEBYTEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B509B30)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableByteFormatter_TypeDefinitionIndex = 84046;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::NullableByteFormatter**)Il2CppClass::FromTypeDefinitionIndex(NullableByteFormatter_TypeDefinitionIndex)->GetStaticField(0x48C20);
		}
