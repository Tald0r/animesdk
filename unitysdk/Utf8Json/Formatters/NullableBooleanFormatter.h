...
#define UTF8JSON_FORMATTERS_NULLABLEBOOLEANFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1AEC6390)
#define UTF8JSON_FORMATTERS_NULLABLEBOOLEANFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AEC6290)
#define UTF8JSON_FORMATTERS_NULLABLEBOOLEANFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1AEC62D0)
#define UTF8JSON_FORMATTERS_NULLABLEBOOLEANFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AEC6270)
#define UTF8JSON_FORMATTERS_NULLABLEBOOLEANFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AEC6400)
#define UTF8JSON_FORMATTERS_NULLABLEBOOLEANFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEC63F0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableBooleanFormatter_TypeDefinitionIndex = 82022;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::NullableBooleanFormatter**)Il2CppClass::FromTypeDefinitionIndex(NullableBooleanFormatter_TypeDefinitionIndex)->GetStaticField(0x47200);
		}
