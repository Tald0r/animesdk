...
#define UTF8JSON_FORMATTERS_BYTEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B707F10)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B707E50)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B707E60)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B707E20)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B707F90)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B707F80)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int ByteFormatter_TypeDefinitionIndex = 84045;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::ByteFormatter**)Il2CppClass::FromTypeDefinitionIndex(ByteFormatter_TypeDefinitionIndex)->GetStaticField(0x48BD0);
		}
