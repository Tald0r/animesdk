...
#define UTF8JSON_FORMATTERS_BYTEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B0F1400)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0F1340)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B0F1350)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0F1310)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0F1480)
#define UTF8JSON_FORMATTERS_BYTEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F1470)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int ByteFormatter_TypeDefinitionIndex = 82004;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::ByteFormatter**)Il2CppClass::FromTypeDefinitionIndex(ByteFormatter_TypeDefinitionIndex)->GetStaticField(0x471C0);
		}
