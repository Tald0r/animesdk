...
#define UTF8JSON_FORMATTERS_INT64FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B6D84C0)
#define UTF8JSON_FORMATTERS_INT64FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6D8390)
#define UTF8JSON_FORMATTERS_INT64FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B6D8410)
#define UTF8JSON_FORMATTERS_INT64FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6D8360)
#define UTF8JSON_FORMATTERS_INT64FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6D8500)
#define UTF8JSON_FORMATTERS_INT64FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D84F0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int Int64Formatter_TypeDefinitionIndex = 84042;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::Int64Formatter**)Il2CppClass::FromTypeDefinitionIndex(Int64Formatter_TypeDefinitionIndex)->GetStaticField(0x48570);
		}
