...
#define UTF8JSON_FORMATTERS_INT64FORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B0CA3F0)
#define UTF8JSON_FORMATTERS_INT64FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0CA2C0)
#define UTF8JSON_FORMATTERS_INT64FORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B0CA340)
#define UTF8JSON_FORMATTERS_INT64FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0CA290)
#define UTF8JSON_FORMATTERS_INT64FORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0CA430)
#define UTF8JSON_FORMATTERS_INT64FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0CA420)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int Int64Formatter_TypeDefinitionIndex = 82001;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::Int64Formatter**)Il2CppClass::FromTypeDefinitionIndex(Int64Formatter_TypeDefinitionIndex)->GetStaticField(0x46B60);
		}
