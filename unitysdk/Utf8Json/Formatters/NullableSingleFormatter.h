...
#define UTF8JSON_FORMATTERS_NULLABLESINGLEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B6D8A50)
#define UTF8JSON_FORMATTERS_NULLABLESINGLEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6D88E0)
#define UTF8JSON_FORMATTERS_NULLABLESINGLEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B6D8920)
#define UTF8JSON_FORMATTERS_NULLABLESINGLEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6D8850)
#define UTF8JSON_FORMATTERS_NULLABLESINGLEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6D8AC0)
#define UTF8JSON_FORMATTERS_NULLABLESINGLEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D8AB0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int NullableSingleFormatter_TypeDefinitionIndex = 84057;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::NullableSingleFormatter**)Il2CppClass::FromTypeDefinitionIndex(NullableSingleFormatter_TypeDefinitionIndex)->GetStaticField(0x48590);
		}
