...
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B6D8F50)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6D8E90)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B6D8EA0)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6D8E60)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6D8FD0)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D8FC0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int SByteFormatter_TypeDefinitionIndex = 84033;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::SByteFormatter**)Il2CppClass::FromTypeDefinitionIndex(SByteFormatter_TypeDefinitionIndex)->GetStaticField(0x485B0);
		}
