...
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER_DESERIALIZEFROMPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B0CAE80)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0CADC0)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER_SERIALIZETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B0CADD0)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0CAD90)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0CAF00)
#define UTF8JSON_FORMATTERS_SBYTEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0CAEF0)

namespace Utf8Json::Formatters
{
	inline static constexpr unsigned int SByteFormatter_TypeDefinitionIndex = 81992;
	...
	public:
		...
		{
			return (::Utf8Json::Formatters::SByteFormatter**)Il2CppClass::FromTypeDefinitionIndex(SByteFormatter_TypeDefinitionIndex)->GetStaticField(0x46BA0);
		}
