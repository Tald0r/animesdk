...
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS12_0__BUILDDESERIALIZE_B__0_OFFSET UNITYSDK_OFFSET(0x1AB63F70)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB63F60)

namespace Utf8Json::Resolvers::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass12_0_TypeDefinitionIndex = 81818;

	class DynamicObjectTypeBuilder___c__DisplayClass12_0 : public ::System::Object
	{
	public:
		::Utf8Json::Internal::Emit::ArgumentField argReader; // 0x10
		::System::Func_3<::System::Int32, ::Utf8Json::Internal::Emit::MetaMember*, ::System::Boolean>* tryEmitLoadCustomFormatter; // 0x20
		::System::Reflection::Emit::ILGenerator* il; // 0x28
		::Il2CppArray<::Utf8Json::Resolvers::Internal::DynamicObjectTypeBuilder_DeserializeInfo>* infoList; // 0x30
		::Utf8Json::Internal::Emit::ArgumentField argResolver; // 0x38
