...
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS7_3__BUILDANONYMOUSFORMATTER_B__7_OFFSET UNITYSDK_OFFSET(0x1B0A40B0)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS7_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A40A0)

namespace Utf8Json::Resolvers::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass7_3_TypeDefinitionIndex = 81816;
