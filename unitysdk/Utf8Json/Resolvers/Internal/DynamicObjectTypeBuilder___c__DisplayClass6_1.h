...
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS6_1__BUILDTYPE_B__1_OFFSET UNITYSDK_OFFSET(0x1A93FA60)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS6_1__BUILDTYPE_B__2_OFFSET UNITYSDK_OFFSET(0x1A93FB90)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS6_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A938910)

namespace Utf8Json::Resolvers::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass6_1_TypeDefinitionIndex = 81810;
