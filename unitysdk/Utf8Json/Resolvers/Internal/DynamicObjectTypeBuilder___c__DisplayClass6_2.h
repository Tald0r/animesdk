...
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS6_2__BUILDTYPE_B__3_OFFSET UNITYSDK_OFFSET(0x1B4E7F00)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS6_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E7EF0)

namespace Utf8Json::Resolvers::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass6_2_TypeDefinitionIndex = 83852;
