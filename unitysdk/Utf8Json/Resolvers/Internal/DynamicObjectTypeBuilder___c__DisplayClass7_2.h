...
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS7_2__BUILDANONYMOUSFORMATTER_B__5_OFFSET UNITYSDK_OFFSET(0x1B6D9760)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS7_2__BUILDANONYMOUSFORMATTER_B__6_OFFSET UNITYSDK_OFFSET(0x1B6D9770)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS7_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D9750)

namespace Utf8Json::Resolvers::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass7_2_TypeDefinitionIndex = 83856;
