...
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS7_2__BUILDANONYMOUSFORMATTER_B__5_OFFSET UNITYSDK_OFFSET(0x1B0CB690)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS7_2__BUILDANONYMOUSFORMATTER_B__6_OFFSET UNITYSDK_OFFSET(0x1B0CB6A0)
#define UTF8JSON_RESOLVERS_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS7_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0CB680)

namespace Utf8Json::Resolvers::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass7_2_TypeDefinitionIndex = 81815;
