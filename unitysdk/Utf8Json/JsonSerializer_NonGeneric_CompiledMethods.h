...
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_COMPILEDMETHODS_GETMETHOD_OFFSET UNITYSDK_OFFSET(0x1B213380)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_COMPILEDMETHODS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2131B0)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_NonGeneric_CompiledMethods_TypeDefinitionIndex = 83783;

	class JsonSerializer_NonGeneric_CompiledMethods : public ::System::Object
	{
	public:
		::System::Func_3<::System::IO::Stream*, ::Utf8Json::IJsonFormatterResolver*, ::System::Object*>* deserialize3; // 0x10
		...
		::Utf8Json::JsonSerializer_NonGeneric_DeserializeJsonReader* deserialize4; // 0x40
