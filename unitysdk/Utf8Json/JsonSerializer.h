...
#define UTF8JSON_JSONSERIALIZER_FILLFROMSTREAM_OFFSET UNITYSDK_OFFSET(0x1AB63080)
#define UTF8JSON_JSONSERIALIZER_GET_DEFAULTRESOLVER_OFFSET UNITYSDK_OFFSET(0x1AB61540)
#define UTF8JSON_JSONSERIALIZER_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1AB61650)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINTBYTEARRAY_1_OFFSET UNITYSDK_OFFSET(0x1AB62570)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINTBYTEARRAY_2_OFFSET UNITYSDK_OFFSET(0x1AB626C0)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINTBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1AB62510)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINT_1_OFFSET UNITYSDK_OFFSET(0x1AB61770)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINT_2_OFFSET UNITYSDK_OFFSET(0x1AB62350)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINT_OFFSET UNITYSDK_OFFSET(0x1AB61710)
#define UTF8JSON_JSONSERIALIZER_SETDEFAULTRESOLVER_OFFSET UNITYSDK_OFFSET(0x1AB616B0)
#define UTF8JSON_JSONSERIALIZER_WRITEPRITTYPRINT_OFFSET UNITYSDK_OFFSET(0x1AB618C0)
#define UTF8JSON_JSONSERIALIZER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB63110)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_TypeDefinitionIndex = 81738;
	...
	public:
		...
		{
			return (::Utf8Json::IJsonFormatterResolver**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_TypeDefinitionIndex)->GetStaticField(0x473F0);
		}
		static ::Il2CppArray<::Il2CppArray<::System::Byte>*>** StaticGet_indent()
		{
			return (::Il2CppArray<::Il2CppArray<::System::Byte>*>**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_TypeDefinitionIndex)->GetStaticField(0x473F8);
		}
		static ::Il2CppArray<::System::Byte>** StaticGet_newLine()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_TypeDefinitionIndex)->GetStaticField(0x47400);
		}
