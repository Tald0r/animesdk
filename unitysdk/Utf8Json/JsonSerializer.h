...
#define UTF8JSON_JSONSERIALIZER_FILLFROMSTREAM_OFFSET UNITYSDK_OFFSET(0x1B193A80)
#define UTF8JSON_JSONSERIALIZER_GET_DEFAULTRESOLVER_OFFSET UNITYSDK_OFFSET(0x1B191F40)
#define UTF8JSON_JSONSERIALIZER_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1B192050)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINTBYTEARRAY_1_OFFSET UNITYSDK_OFFSET(0x1B192F70)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINTBYTEARRAY_2_OFFSET UNITYSDK_OFFSET(0x1B1930C0)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINTBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1B192F10)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINT_1_OFFSET UNITYSDK_OFFSET(0x1B192170)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINT_2_OFFSET UNITYSDK_OFFSET(0x1B192D50)
#define UTF8JSON_JSONSERIALIZER_PRETTYPRINT_OFFSET UNITYSDK_OFFSET(0x1B192110)
#define UTF8JSON_JSONSERIALIZER_SETDEFAULTRESOLVER_OFFSET UNITYSDK_OFFSET(0x1B1920B0)
#define UTF8JSON_JSONSERIALIZER_WRITEPRITTYPRINT_OFFSET UNITYSDK_OFFSET(0x1B1922C0)
#define UTF8JSON_JSONSERIALIZER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B193B10)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_TypeDefinitionIndex = 83779;
	...
	public:
		...
		{
			return (::Utf8Json::IJsonFormatterResolver**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_TypeDefinitionIndex)->GetStaticField(0x48E00);
		}
		static ::Il2CppArray<::System::Byte>** StaticGet_newLine()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_TypeDefinitionIndex)->GetStaticField(0x48E08);
		}
		static ::Il2CppArray<::Il2CppArray<::System::Byte>*>** StaticGet_indent()
		{
			return (::Il2CppArray<::Il2CppArray<::System::Byte>*>**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_TypeDefinitionIndex)->GetStaticField(0x48E10);
		}
