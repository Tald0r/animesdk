...
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_ADD_1_OFFSET UNITYSDK_OFFSET(0x1A936B90)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x1A936B20)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_EMITMATCH_OFFSET UNITYSDK_OFFSET(0x1A9374F0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A937350)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A937340)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_TOSTRINGCORE_OFFSET UNITYSDK_OFFSET(0x1A936EE0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A936DF0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_TRYGETVALUESAFE_OFFSET UNITYSDK_OFFSET(0x1A936D60)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_YIELDCORE_OFFSET UNITYSDK_OFFSET(0x1A937490)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A936A70)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int AutomataDictionary_TypeDefinitionIndex = 81881;
