...
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_ADD_1_OFFSET UNITYSDK_OFFSET(0x1AF177F0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x1AF17780)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_EMITMATCH_OFFSET UNITYSDK_OFFSET(0x1AF18150)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AF17FB0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AF17FA0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_TOSTRINGCORE_OFFSET UNITYSDK_OFFSET(0x1AF17B40)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AF17A50)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_TRYGETVALUESAFE_OFFSET UNITYSDK_OFFSET(0x1AF179C0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_YIELDCORE_OFFSET UNITYSDK_OFFSET(0x1AF180F0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF176D0)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int AutomataDictionary_TypeDefinitionIndex = 83922;
