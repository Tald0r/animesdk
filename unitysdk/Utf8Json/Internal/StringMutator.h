...
#define UTF8JSON_INTERNAL_STRINGMUTATOR_ORIGINAL_OFFSET UNITYSDK_OFFSET(0x1B708EE0)
#define UTF8JSON_INTERNAL_STRINGMUTATOR_TOCAMELCASE_OFFSET UNITYSDK_OFFSET(0x1B708EF0)
#define UTF8JSON_INTERNAL_STRINGMUTATOR_TOSNAKECASE_OFFSET UNITYSDK_OFFSET(0x1B7090A0)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int StringMutator_TypeDefinitionIndex = 83941;
