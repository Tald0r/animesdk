...
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_ADD_1_OFFSET UNITYSDK_OFFSET(0x1B5E96D0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_ADD_OFFSET UNITYSDK_OFFSET(0x1B5E9450)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_BINARYSEARCH_OFFSET UNITYSDK_OFFSET(0x1B5E9900)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1B5E9B90)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_EMITSEARCHNEXTCORE_OFFSET UNITYSDK_OFFSET(0x1B5E9D60)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_EMITSEARCHNEXT_OFFSET UNITYSDK_OFFSET(0x1B5E9C20)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_GET_HASCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B5E93C0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_SEARCHNEXTSAFE_OFFSET UNITYSDK_OFFSET(0x1B5E9980)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_SEARCHNEXT_OFFSET UNITYSDK_OFFSET(0x1B5E9700)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_YIELDCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B5E9BC0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5EB170)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5E93D0)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int AutomataDictionary_AutomataNode_TypeDefinitionIndex = 83923;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt64>**)Il2CppClass::FromTypeDefinitionIndex(AutomataDictionary_AutomataNode_TypeDefinitionIndex)->GetStaticField(0x48A60);
		}
		static ::Il2CppArray<::Utf8Json::Internal::AutomataDictionary_AutomataNode*>** StaticGet_emptyNodes()
		{
			return (::Il2CppArray<::Utf8Json::Internal::AutomataDictionary_AutomataNode*>**)Il2CppClass::FromTypeDefinitionIndex(AutomataDictionary_AutomataNode_TypeDefinitionIndex)->GetStaticField(0x48A68);
		}
