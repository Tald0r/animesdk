...
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_ADD_1_OFFSET UNITYSDK_OFFSET(0x1AFDA960)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_ADD_OFFSET UNITYSDK_OFFSET(0x1AFDA6E0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_BINARYSEARCH_OFFSET UNITYSDK_OFFSET(0x1AFDAB90)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1AFDAE20)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_EMITSEARCHNEXTCORE_OFFSET UNITYSDK_OFFSET(0x1AFDAFF0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_EMITSEARCHNEXT_OFFSET UNITYSDK_OFFSET(0x1AFDAEB0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_GET_HASCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AFDA650)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_SEARCHNEXTSAFE_OFFSET UNITYSDK_OFFSET(0x1AFDAC10)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_SEARCHNEXT_OFFSET UNITYSDK_OFFSET(0x1AFDA990)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE_YIELDCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AFDAE50)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFDC400)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFDA660)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int AutomataDictionary_AutomataNode_TypeDefinitionIndex = 81882;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt64>**)Il2CppClass::FromTypeDefinitionIndex(AutomataDictionary_AutomataNode_TypeDefinitionIndex)->GetStaticField(0x47050);
		}
		static ::Il2CppArray<::Utf8Json::Internal::AutomataDictionary_AutomataNode*>** StaticGet_emptyNodes()
		{
			return (::Il2CppArray<::Utf8Json::Internal::AutomataDictionary_AutomataNode*>**)Il2CppClass::FromTypeDefinitionIndex(AutomataDictionary_AutomataNode_TypeDefinitionIndex)->GetStaticField(0x47058);
		}
