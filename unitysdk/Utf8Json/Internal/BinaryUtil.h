...
#define UTF8JSON_INTERNAL_BINARYUTIL_ENSURECAPACITY_OFFSET UNITYSDK_OFFSET(0x1B0CAF40)
#define UTF8JSON_INTERNAL_BINARYUTIL_FASTCLONEWITHRESIZE_OFFSET UNITYSDK_OFFSET(0x1B0CB160)
#define UTF8JSON_INTERNAL_BINARYUTIL_FASTRESIZE_OFFSET UNITYSDK_OFFSET(0x1B0CB0A0)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int BinaryUtil_TypeDefinitionIndex = 81888;
