...
#define UTF8JSON_INTERNAL_BINARYUTIL_ENSURECAPACITY_OFFSET UNITYSDK_OFFSET(0x1B6D9010)
#define UTF8JSON_INTERNAL_BINARYUTIL_FASTCLONEWITHRESIZE_OFFSET UNITYSDK_OFFSET(0x1B6D9230)
#define UTF8JSON_INTERNAL_BINARYUTIL_FASTRESIZE_OFFSET UNITYSDK_OFFSET(0x1B6D9170)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int BinaryUtil_TypeDefinitionIndex = 83929;
