...
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6013D0)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS19_0__EMITSEARCHNEXTCORE_B__2_OFFSET UNITYSDK_OFFSET(0x1B601410)
#define UTF8JSON_INTERNAL_AUTOMATADICTIONARY_AUTOMATANODE___C__DISPLAYCLASS19_0__EMITSEARCHNEXTCORE_B__3_OFFSET UNITYSDK_OFFSET(0x1B6013E0)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int AutomataDictionary_AutomataNode___c__DisplayClass19_0_TypeDefinitionIndex = 83925;
