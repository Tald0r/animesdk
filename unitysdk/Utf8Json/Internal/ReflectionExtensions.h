...
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLFIELDSCORE_OFFSET UNITYSDK_OFFSET(0x1A937960)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLFIELDS_OFFSET UNITYSDK_OFFSET(0x1A937840)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLPROPERTIESCORE_OFFSET UNITYSDK_OFFSET(0x1A9377E0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A9376C0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_ISANONYMOUS_OFFSET UNITYSDK_OFFSET(0x1A9375B0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_ISNULLABLE_OFFSET UNITYSDK_OFFSET(0x1A937510)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_ISPUBLIC_OFFSET UNITYSDK_OFFSET(0x1A937580)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int ReflectionExtensions_TypeDefinitionIndex = 81896;
