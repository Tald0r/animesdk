...
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLFIELDSCORE_OFFSET UNITYSDK_OFFSET(0x1AF185C0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLFIELDS_OFFSET UNITYSDK_OFFSET(0x1AF184A0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLPROPERTIESCORE_OFFSET UNITYSDK_OFFSET(0x1AF18440)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_GETALLPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AF18320)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_ISANONYMOUS_OFFSET UNITYSDK_OFFSET(0x1AF18210)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_ISNULLABLE_OFFSET UNITYSDK_OFFSET(0x1AF18170)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS_ISPUBLIC_OFFSET UNITYSDK_OFFSET(0x1AF181E0)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int ReflectionExtensions_TypeDefinitionIndex = 83937;
