...
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLFIELDSCORE_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B212920)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLFIELDSCORE_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_REFLECTION_FIELDINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B2130B0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLFIELDSCORE_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_REFLECTION_FIELDINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B213040)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLFIELDSCORE_D__6_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B213130)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLFIELDSCORE_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B2130A0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLFIELDSCORE_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B213050)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLFIELDSCORE_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B212690)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLFIELDSCORE_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0x1B212670)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLFIELDSCORE_D__6___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B2127C0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLFIELDSCORE_D__6___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1B212870)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int ReflectionExtensions__GetAllFieldsCore_d__6_TypeDefinitionIndex = 83939;
