...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_MINUS_OFFSET UNITYSDK_OFFSET(0x1B6B1730)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x9AC1B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x1B6B1960)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x9AC220)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B6B1870)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1B6B1750)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x9AC1A0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_TIMES_OFFSET UNITYSDK_OFFSET(0x1B6B17E0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP__CTOR_OFFSET UNITYSDK_OFFSET(0x31E200)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int DiyFp_TypeDefinitionIndex = 83957;
