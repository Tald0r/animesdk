...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_MINUS_OFFSET UNITYSDK_OFFSET(0x1B0A38D0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x978CF0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x1B0A3B00)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x978D60)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B0A3A10)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1B0A38F0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x978CE0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP_TIMES_OFFSET UNITYSDK_OFFSET(0x1B0A3980)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DIYFP__CTOR_OFFSET UNITYSDK_OFFSET(0x324900)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int DiyFp_TypeDefinitionIndex = 81916;
