...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_ADJUSTMENTPOWEROFTEN_OFFSET UNITYSDK_OFFSET(0x1B669240)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_COMPUTEGUESS_OFFSET UNITYSDK_OFFSET(0x1B669860)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_CUTTOMAXSIGNIFICANTDIGITS_OFFSET UNITYSDK_OFFSET(0x1B668910)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_DIYFPSTRTOD_OFFSET UNITYSDK_OFFSET(0x1B669380)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_DOUBLESTRTOD_OFFSET UNITYSDK_OFFSET(0x1B668DE0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_GETCOPYBUFFER_OFFSET UNITYSDK_OFFSET(0x1B668670)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_READDIYFP_OFFSET UNITYSDK_OFFSET(0x1B668C80)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_READUINT64_OFFSET UNITYSDK_OFFSET(0x1B668BF0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_STRTOD_OFFSET UNITYSDK_OFFSET(0x1B669990)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_STRTOF_OFFSET UNITYSDK_OFFSET(0x1B669A80)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_TRIMANDCUT_OFFSET UNITYSDK_OFFSET(0x1B6689D0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_TRIMLEADINGZEROS_OFFSET UNITYSDK_OFFSET(0x1B6687D0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_TRIMTRAILINGZEROS_OFFSET UNITYSDK_OFFSET(0x1B668880)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B669D10)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int StringToDouble_TypeDefinitionIndex = 83970;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(StringToDouble_TypeDefinitionIndex)->GetStaticField(0x48980);
		}
		static ::System::Int32* StaticGet_kExactPowersOfTenSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(StringToDouble_TypeDefinitionIndex)->GetStaticField(0x11CF0);
		}
