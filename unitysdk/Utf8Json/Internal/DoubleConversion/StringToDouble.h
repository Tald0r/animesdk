...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_ADJUSTMENTPOWEROFTEN_OFFSET UNITYSDK_OFFSET(0x1B05D470)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_COMPUTEGUESS_OFFSET UNITYSDK_OFFSET(0x1B05DA90)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_CUTTOMAXSIGNIFICANTDIGITS_OFFSET UNITYSDK_OFFSET(0x1B05CB40)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_DIYFPSTRTOD_OFFSET UNITYSDK_OFFSET(0x1B05D5B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_DOUBLESTRTOD_OFFSET UNITYSDK_OFFSET(0x1B05D010)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_GETCOPYBUFFER_OFFSET UNITYSDK_OFFSET(0x1B05C8A0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_READDIYFP_OFFSET UNITYSDK_OFFSET(0x1B05CEB0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_READUINT64_OFFSET UNITYSDK_OFFSET(0x1B05CE20)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_STRTOD_OFFSET UNITYSDK_OFFSET(0x1B05DBC0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_STRTOF_OFFSET UNITYSDK_OFFSET(0x1B05DCB0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_TRIMANDCUT_OFFSET UNITYSDK_OFFSET(0x1B05CC00)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_TRIMLEADINGZEROS_OFFSET UNITYSDK_OFFSET(0x1B05CA00)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE_TRIMTRAILINGZEROS_OFFSET UNITYSDK_OFFSET(0x1B05CAB0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGTODOUBLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B05DF40)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int StringToDouble_TypeDefinitionIndex = 81929;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Double>**)Il2CppClass::FromTypeDefinitionIndex(StringToDouble_TypeDefinitionIndex)->GetStaticField(0x46F70);
		}
		static ::System::Int32* StaticGet_kExactPowersOfTenSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(StringToDouble_TypeDefinitionIndex)->GetStaticField(0x11BE0);
		}
