...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGBUILDER_ADDCHARACTER_OFFSET UNITYSDK_OFFSET(0x95AA10)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGBUILDER_ADDPADDING_OFFSET UNITYSDK_OFFSET(0x977CF0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGBUILDER_ADDSTRINGSLOW_OFFSET UNITYSDK_OFFSET(0x977D70)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGBUILDER_ADDSTRING_OFFSET UNITYSDK_OFFSET(0x977CC0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGBUILDER_ADDSUBSTRING_1_OFFSET UNITYSDK_OFFSET(0x977CE0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGBUILDER_ADDSUBSTRING_OFFSET UNITYSDK_OFFSET(0x977CD0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_STRINGBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x324900)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int StringBuilder_TypeDefinitionIndex = 81917;
