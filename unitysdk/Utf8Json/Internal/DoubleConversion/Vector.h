...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_FIRST_OFFSET UNITYSDK_OFFSET(0x977C80)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x978DC0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_IS_EMPTY_OFFSET UNITYSDK_OFFSET(0x2C50C0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_LAST_OFFSET UNITYSDK_OFFSET(0x978E40)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_LENGTH_OFFSET UNITYSDK_OFFSET(0x2C50B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x978E00)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR_SUBVECTOR_OFFSET UNITYSDK_OFFSET(0x978E80)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_VECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x315C50)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int Vector_TypeDefinitionIndex = 81928;
