...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_BIGGESTPOWERTEN_OFFSET UNITYSDK_OFFSET(0x1B50C000)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_CREATEDECIMALREPRESENTATION_OFFSET UNITYSDK_OFFSET(0x1B50CF20)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_CREATEEXPONENTIALREPRESENTATION_OFFSET UNITYSDK_OFFSET(0x1B50D410)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_DIGITGEN_OFFSET UNITYSDK_OFFSET(0x1B50C130)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_DOUBLETOASCII_OFFSET UNITYSDK_OFFSET(0x1B50CCB0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_FASTDTOA_OFFSET UNITYSDK_OFFSET(0x1B50CA20)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x1B50BE10)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1B50BA80)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_GETDECIMALREPBUFFER_OFFSET UNITYSDK_OFFSET(0x1B50B640)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_GETEXPONENTIALREPBUFFER_OFFSET UNITYSDK_OFFSET(0x1B50B7B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_GETTOSTRINGBUFFER_OFFSET UNITYSDK_OFFSET(0x1B50B910)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_GRISU3_OFFSET UNITYSDK_OFFSET(0x1B50C5C0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_HANDLESPECIALVALUES_OFFSET UNITYSDK_OFFSET(0x1B50CB00)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_ROUNDWEED_OFFSET UNITYSDK_OFFSET(0x1B50BEF0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_TOSHORTESTIEEENUMBER_OFFSET UNITYSDK_OFFSET(0x1B50BB60)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B50D790)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int DoubleToStringConverter_TypeDefinitionIndex = 83959;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x48F50);
		}
		static ::Il2CppArray<::System::UInt32>** StaticGet_kSmallPowersOfTen()
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x48F58);
		}
		static ::Il2CppArray<::System::Byte>** StaticGet_infinity_symbol_()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x48F60);
		}
		static ::System::Int32* StaticGet_decimal_in_shortest_high_()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x11D80);
		}
		static ::System::Char* StaticGet_exponent_character_()
		{
			return (::System::Char*)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x11D84);
		}
		static ::Utf8Json::Internal::DoubleConversion::DoubleToStringConverter_Flags* StaticGet_flags_()
		{
			return (::Utf8Json::Internal::DoubleConversion::DoubleToStringConverter_Flags*)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x11D88);
		}
		static ::System::Int32* StaticGet_decimal_in_shortest_low_()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x11D8C);
		}
