...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_BIGGESTPOWERTEN_OFFSET UNITYSDK_OFFSET(0x1AEE4270)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_CREATEDECIMALREPRESENTATION_OFFSET UNITYSDK_OFFSET(0x1AEE5190)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_CREATEEXPONENTIALREPRESENTATION_OFFSET UNITYSDK_OFFSET(0x1AEE5680)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_DIGITGEN_OFFSET UNITYSDK_OFFSET(0x1AEE43A0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_DOUBLETOASCII_OFFSET UNITYSDK_OFFSET(0x1AEE4F20)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_FASTDTOA_OFFSET UNITYSDK_OFFSET(0x1AEE4C90)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x1AEE4080)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1AEE3CF0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_GETDECIMALREPBUFFER_OFFSET UNITYSDK_OFFSET(0x1AEE38B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_GETEXPONENTIALREPBUFFER_OFFSET UNITYSDK_OFFSET(0x1AEE3A20)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_GETTOSTRINGBUFFER_OFFSET UNITYSDK_OFFSET(0x1AEE3B80)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_GRISU3_OFFSET UNITYSDK_OFFSET(0x1AEE4830)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_HANDLESPECIALVALUES_OFFSET UNITYSDK_OFFSET(0x1AEE4D70)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_ROUNDWEED_OFFSET UNITYSDK_OFFSET(0x1AEE4160)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER_TOSHORTESTIEEENUMBER_OFFSET UNITYSDK_OFFSET(0x1AEE3DD0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_DOUBLETOSTRINGCONVERTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AEE5A00)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int DoubleToStringConverter_TypeDefinitionIndex = 81918;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x47540);
		}
		static ::Il2CppArray<::System::Byte>** StaticGet_infinity_symbol_()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x47548);
		}
		static ::Il2CppArray<::System::Byte>** StaticGet_nan_symbol_()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x47550);
		}
		static ::System::Int32* StaticGet_decimal_in_shortest_low_()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x11C70);
		}
		static ::System::Char* StaticGet_exponent_character_()
		{
			return (::System::Char*)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x11C74);
		}
		static ::System::Int32* StaticGet_decimal_in_shortest_high_()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x11C78);
		}
		static ::Utf8Json::Internal::DoubleConversion::DoubleToStringConverter_Flags* StaticGet_flags_()
		{
			return (::Utf8Json::Internal::DoubleConversion::DoubleToStringConverter_Flags*)Il2CppClass::FromTypeDefinitionIndex(DoubleToStringConverter_TypeDefinitionIndex)->GetStaticField(0x11C7C);
		}
