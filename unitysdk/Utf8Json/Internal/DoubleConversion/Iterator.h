...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x977C80)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1B06F5B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1B06F600)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_EQUALITY_2_OFFSET UNITYSDK_OFFSET(0x1B06F680)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B06F5E0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_GREATERTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x1B06F700)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1B06F780)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_INCREMENT_OFFSET UNITYSDK_OFFSET(0x1B06F5A0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1B06F640)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_INEQUALITY_2_OFFSET UNITYSDK_OFFSET(0x1B06F6C0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B06F5F0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_LESSTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x1B06F740)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1B06F7C0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1B06F5D0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x324900)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int Iterator_TypeDefinitionIndex = 81930;
