...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x9AB200)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1B67D2C0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1B67D310)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_EQUALITY_2_OFFSET UNITYSDK_OFFSET(0x1B67D390)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B67D2F0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_GREATERTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x1B67D410)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1B67D490)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_INCREMENT_OFFSET UNITYSDK_OFFSET(0x1B67D2B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1B67D350)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_INEQUALITY_2_OFFSET UNITYSDK_OFFSET(0x1B67D3D0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B67D300)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_LESSTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x1B67D450)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1B67D4D0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1B67D2E0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_ITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x31E200)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int Iterator_TypeDefinitionIndex = 83971;
