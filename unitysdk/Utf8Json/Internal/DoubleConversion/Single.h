...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ASDIYFP_OFFSET UNITYSDK_OFFSET(0x9A6A20)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ASUINT32_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_EXPONENT_OFFSET UNITYSDK_OFFSET(0x9A6A70)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_INFINITY_OFFSET UNITYSDK_OFFSET(0x1B6016A0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ISDENORMAL_OFFSET UNITYSDK_OFFSET(0x9A6AB0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ISINFINITE_OFFSET UNITYSDK_OFFSET(0x9A6AF0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ISNAN_OFFSET UNITYSDK_OFFSET(0x9A6AD0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0x9A6AC0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_LOWERBOUNDARYISCLOSER_OFFSET UNITYSDK_OFFSET(0x9A6C40)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_NAN_OFFSET UNITYSDK_OFFSET(0x1B6016B0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_NORMALIZEDBOUNDARIES_OFFSET UNITYSDK_OFFSET(0x9A6B20)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_SIGNIFICAND_OFFSET UNITYSDK_OFFSET(0x9A6A90)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_SIGN_OFFSET UNITYSDK_OFFSET(0x9A6B10)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_UPPERBOUNDARY_OFFSET UNITYSDK_OFFSET(0x9A6BF0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_VALUE_OFFSET UNITYSDK_OFFSET(0x2F60A0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x2F60B0)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int Single_TypeDefinitionIndex = 83966;
