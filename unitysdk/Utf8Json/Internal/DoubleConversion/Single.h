...
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ASDIYFP_OFFSET UNITYSDK_OFFSET(0x973DF0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ASUINT32_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_EXPONENT_OFFSET UNITYSDK_OFFSET(0x973E40)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_INFINITY_OFFSET UNITYSDK_OFFSET(0x1AFF2870)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ISDENORMAL_OFFSET UNITYSDK_OFFSET(0x973E80)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ISINFINITE_OFFSET UNITYSDK_OFFSET(0x973EC0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ISNAN_OFFSET UNITYSDK_OFFSET(0x973EA0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0x973E90)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_LOWERBOUNDARYISCLOSER_OFFSET UNITYSDK_OFFSET(0x974010)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_NAN_OFFSET UNITYSDK_OFFSET(0x1AFF2880)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_NORMALIZEDBOUNDARIES_OFFSET UNITYSDK_OFFSET(0x973EF0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_SIGNIFICAND_OFFSET UNITYSDK_OFFSET(0x973E60)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_SIGN_OFFSET UNITYSDK_OFFSET(0x973EE0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_UPPERBOUNDARY_OFFSET UNITYSDK_OFFSET(0x973FC0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE_VALUE_OFFSET UNITYSDK_OFFSET(0x2C4AF0)
#define UTF8JSON_INTERNAL_DOUBLECONVERSION_SINGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x2C4B00)

namespace Utf8Json::Internal::DoubleConversion
{
	inline static constexpr unsigned int Single_TypeDefinitionIndex = 81925;
