...
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_BESTMATCHCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1B18DFA0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_CONSTRUCTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B18DFC0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x1B18DF50)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_ISCONCRETECLASS_OFFSET UNITYSDK_OFFSET(0x1B18DF80)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_ISSTRUCT_OFFSET UNITYSDK_OFFSET(0x1B18DF70)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_MEMBERS_OFFSET UNITYSDK_OFFSET(0x1B18DFE0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B18DF30)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_SET_BESTMATCHCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1B18DFB0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_SET_CONSTRUCTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B18DFD0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_SET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x1B18DF60)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_SET_ISCONCRETECLASS_OFFSET UNITYSDK_OFFSET(0x1B18DF90)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_SET_MEMBERS_OFFSET UNITYSDK_OFFSET(0x1B18DFF0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B18DF40)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_TRYGETNEXTCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1B18F7A0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B18E000)

namespace Utf8Json::Internal::Emit
{
	inline static constexpr unsigned int MetaType_TypeDefinitionIndex = 83955;
	...
	public:
		...
		::Il2CppArray<::Utf8Json::Internal::Emit::MetaMember*>* _ConstructorParameters_k__BackingField; // 0x20
