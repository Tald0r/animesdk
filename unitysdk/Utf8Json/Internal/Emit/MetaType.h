...
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_BESTMATCHCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1AB5D5A0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_CONSTRUCTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1AB5D5C0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x1AB5D550)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_ISCONCRETECLASS_OFFSET UNITYSDK_OFFSET(0x1AB5D580)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_ISSTRUCT_OFFSET UNITYSDK_OFFSET(0x1AB5D570)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_MEMBERS_OFFSET UNITYSDK_OFFSET(0x1AB5D5E0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AB5D530)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_SET_BESTMATCHCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1AB5D5B0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_SET_CONSTRUCTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1AB5D5D0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_SET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x1AB5D560)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_SET_ISCONCRETECLASS_OFFSET UNITYSDK_OFFSET(0x1AB5D590)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_SET_MEMBERS_OFFSET UNITYSDK_OFFSET(0x1AB5D5F0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AB5D540)
#define UTF8JSON_INTERNAL_EMIT_METATYPE_TRYGETNEXTCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1AB5EDA0)
#define UTF8JSON_INTERNAL_EMIT_METATYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB5D600)

namespace Utf8Json::Internal::Emit
{
	inline static constexpr unsigned int MetaType_TypeDefinitionIndex = 81914;
	...
	public:
		...
		::Il2CppArray<::Utf8Json::Internal::Emit::MetaMember*>* _ConstructorParameters_k__BackingField; // 0x28
