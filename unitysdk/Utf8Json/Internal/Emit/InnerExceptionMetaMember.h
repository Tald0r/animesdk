...
#define UTF8JSON_INTERNAL_EMIT_INNEREXCEPTIONMETAMEMBER_EMITLOADVALUE_OFFSET UNITYSDK_OFFSET(0x1B601710)
#define UTF8JSON_INTERNAL_EMIT_INNEREXCEPTIONMETAMEMBER_EMITSERIALIZEDIRECTLY_OFFSET UNITYSDK_OFFSET(0x1B601820)
#define UTF8JSON_INTERNAL_EMIT_INNEREXCEPTIONMETAMEMBER_EMITSTOREVALUE_OFFSET UNITYSDK_OFFSET(0x1B6017D0)
#define UTF8JSON_INTERNAL_EMIT_INNEREXCEPTIONMETAMEMBER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B601980)
#define UTF8JSON_INTERNAL_EMIT_INNEREXCEPTIONMETAMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6016C0)

namespace Utf8Json::Internal::Emit
{
	inline static constexpr unsigned int InnerExceptionMetaMember_TypeDefinitionIndex = 83953;
	...
	public:
		...
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(InnerExceptionMetaMember_TypeDefinitionIndex)->GetStaticField(0x49000);
		}
		static ::System::Reflection::MethodInfo** StaticGet_nongenericSerialize()
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(InnerExceptionMetaMember_TypeDefinitionIndex)->GetStaticField(0x49008);
		}
