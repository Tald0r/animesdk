...
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1ABFE360)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITBOXORDONOTHING_OFFSET UNITYSDK_OFFSET(0x1ABFE8F0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITCALL_OFFSET UNITYSDK_OFFSET(0x1ABFEE50)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITFALSE_OFFSET UNITYSDK_OFFSET(0x1ABFE440)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITINCREMENTFOR_OFFSET UNITYSDK_OFFSET(0x1ABFF4C0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITINTZERORETURN_OFFSET UNITYSDK_OFFSET(0x1ABFF0B0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITLDARGA_OFFSET UNITYSDK_OFFSET(0x1ABFEC10)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITLDARG_OFFSET UNITYSDK_OFFSET(0x1ABFE990)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITLDC_I4_OFFSET UNITYSDK_OFFSET(0x1ABFE4C0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITLDFLD_OFFSET UNITYSDK_OFFSET(0x1ABFEF30)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITLDLOCA_1_OFFSET UNITYSDK_OFFSET(0x1ABFE2C0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITLDLOCA_OFFSET UNITYSDK_OFFSET(0x1ABFE1F0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITLDLOC_1_OFFSET UNITYSDK_OFFSET(0x1ABFDFB0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITLDLOC_OFFSET UNITYSDK_OFFSET(0x1ABFDDB0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITLDSFLD_OFFSET UNITYSDK_OFFSET(0x1ABFEFB0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITLOADTHIS_OFFSET UNITYSDK_OFFSET(0x1ABFEB90)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITNULLRETURN_OFFSET UNITYSDK_OFFSET(0x1ABFF190)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITPOP_OFFSET UNITYSDK_OFFSET(0x1ABFEDB0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITRET_OFFSET UNITYSDK_OFFSET(0x1ABFF030)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITSTARG_OFFSET UNITYSDK_OFFSET(0x1ABFECE0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITSTLOC_1_OFFSET UNITYSDK_OFFSET(0x1ABFE1D0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITSTLOC_OFFSET UNITYSDK_OFFSET(0x1ABFDFD0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITTHROWNOTIMPLEMENTED_OFFSET UNITYSDK_OFFSET(0x1ABFF2A0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITTRUE_OFFSET UNITYSDK_OFFSET(0x1ABFE2E0)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITULONG_OFFSET UNITYSDK_OFFSET(0x1ABFF220)
#define UTF8JSON_INTERNAL_EMIT_ILGENERATOREXTENSIONS_EMITUNBOXORCAST_OFFSET UNITYSDK_OFFSET(0x1ABFE830)

namespace Utf8Json::Internal::Emit
{
	inline static constexpr unsigned int ILGeneratorExtensions_TypeDefinitionIndex = 81907;
