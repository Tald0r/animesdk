...
#define UTF8JSON_INTERNAL_EMIT_STRINGCONSTANTVALUEMETAMEMBER_EMITLOADVALUE_OFFSET UNITYSDK_OFFSET(0x1B18F960)
#define UTF8JSON_INTERNAL_EMIT_STRINGCONSTANTVALUEMETAMEMBER_EMITSTOREVALUE_OFFSET UNITYSDK_OFFSET(0x1B18FA00)
#define UTF8JSON_INTERNAL_EMIT_STRINGCONSTANTVALUEMETAMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B18F900)

namespace Utf8Json::Internal::Emit
{
	inline static constexpr unsigned int StringConstantValueMetaMember_TypeDefinitionIndex = 83952;
