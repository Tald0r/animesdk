...
#define UTF8JSON_INTERNAL_EMIT_STRINGCONSTANTVALUEMETAMEMBER_EMITLOADVALUE_OFFSET UNITYSDK_OFFSET(0x1AB5EF60)
#define UTF8JSON_INTERNAL_EMIT_STRINGCONSTANTVALUEMETAMEMBER_EMITSTOREVALUE_OFFSET UNITYSDK_OFFSET(0x1AB5F000)
#define UTF8JSON_INTERNAL_EMIT_STRINGCONSTANTVALUEMETAMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB5EF00)

namespace Utf8Json::Internal::Emit
{
	inline static constexpr unsigned int StringConstantValueMetaMember_TypeDefinitionIndex = 81911;
