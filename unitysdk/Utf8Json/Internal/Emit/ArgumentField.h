...
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD_EMITLOAD_OFFSET UNITYSDK_OFFSET(0x9962A0)
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD_EMITSTORE_OFFSET UNITYSDK_OFFSET(0x9962C0)
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9961E0)
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x917820)

namespace Utf8Json::Internal::Emit
{
	inline static constexpr unsigned int ArgumentField_TypeDefinitionIndex = 83947;
