...
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD_EMITLOAD_OFFSET UNITYSDK_OFFSET(0x964E60)
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD_EMITSTORE_OFFSET UNITYSDK_OFFSET(0x964E80)
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x964DA0)
#define UTF8JSON_INTERNAL_EMIT_ARGUMENTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x8EE0A0)

namespace Utf8Json::Internal::Emit
{
	inline static constexpr unsigned int ArgumentField_TypeDefinitionIndex = 81906;
