...
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B708650)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_REFLECTION_PROPERTYINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B708DE0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_REFLECTION_PROPERTYINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B708D70)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B708E60)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B708DD0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B708D80)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B7083C0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7083A0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B7084F0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1B7085A0)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int ReflectionExtensions__GetAllPropertiesCore_d__4_TypeDefinitionIndex = 83938;
	...
	public:
		...
		::System::Collections::Generic::HashSet_1<::System::String*>* nameCheck; // 0x18
		::System::Type* __3__type; // 0x20
		::System::Collections::Generic::HashSet_1<::System::String*>* __3__nameCheck; // 0x28
