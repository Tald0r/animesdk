...
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B0F1B40)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_REFLECTION_PROPERTYINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B0F22D0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_REFLECTION_PROPERTYINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B0F2260)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B0F2350)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B0F22C0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B0F2270)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B0F18B0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F1890)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B0F19E0)
#define UTF8JSON_INTERNAL_REFLECTIONEXTENSIONS__GETALLPROPERTIESCORE_D__4___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1B0F1A90)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int ReflectionExtensions__GetAllPropertiesCore_d__4_TypeDefinitionIndex = 81897;
