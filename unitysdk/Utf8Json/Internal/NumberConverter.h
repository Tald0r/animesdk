...
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_ISNUMBERREPRESENTATION_OFFSET UNITYSDK_OFFSET(0x1AB5F5C0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_ISNUMBER_OFFSET UNITYSDK_OFFSET(0x1AB5F5B0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1AB61320)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READBYTE_OFFSET UNITYSDK_OFFSET(0x1AB5F7D0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READDOUBLE_OFFSET UNITYSDK_OFFSET(0x1AB5FB00)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READINT16_OFFSET UNITYSDK_OFFSET(0x1AB5F700)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READINT32_OFFSET UNITYSDK_OFFSET(0x1AB5F760)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READINT64_OFFSET UNITYSDK_OFFSET(0x1AB5F640)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READSBYTE_OFFSET UNITYSDK_OFFSET(0x1AB5F5E0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READSINGLE_OFFSET UNITYSDK_OFFSET(0x1AB5FA20)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READUINT16_OFFSET UNITYSDK_OFFSET(0x1AB5F950)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READUINT32_OFFSET UNITYSDK_OFFSET(0x1AB5F9B0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READUINT64_OFFSET UNITYSDK_OFFSET(0x1AB5F830)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1AB5FBE0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEDOUBLE_OFFSET UNITYSDK_OFFSET(0x1AB612B0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEINT16_OFFSET UNITYSDK_OFFSET(0x1AB61220)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEINT32_OFFSET UNITYSDK_OFFSET(0x1AB61230)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEINT64_OFFSET UNITYSDK_OFFSET(0x1AB60510)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITESBYTE_OFFSET UNITYSDK_OFFSET(0x1AB60500)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITESINGLE_OFFSET UNITYSDK_OFFSET(0x1AB61240)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEUINT16_OFFSET UNITYSDK_OFFSET(0x1AB604E0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEUINT32_OFFSET UNITYSDK_OFFSET(0x1AB604F0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEUINT64_OFFSET UNITYSDK_OFFSET(0x1AB5FBF0)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int NumberConverter_TypeDefinitionIndex = 81895;
