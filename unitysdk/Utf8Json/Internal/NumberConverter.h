...
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_ISNUMBERREPRESENTATION_OFFSET UNITYSDK_OFFSET(0x1B18FFC0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_ISNUMBER_OFFSET UNITYSDK_OFFSET(0x1B18FFB0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1B191D20)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READBYTE_OFFSET UNITYSDK_OFFSET(0x1B1901D0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B190500)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READINT16_OFFSET UNITYSDK_OFFSET(0x1B190100)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READINT32_OFFSET UNITYSDK_OFFSET(0x1B190160)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READINT64_OFFSET UNITYSDK_OFFSET(0x1B190040)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READSBYTE_OFFSET UNITYSDK_OFFSET(0x1B18FFE0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READSINGLE_OFFSET UNITYSDK_OFFSET(0x1B190420)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READUINT16_OFFSET UNITYSDK_OFFSET(0x1B190350)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READUINT32_OFFSET UNITYSDK_OFFSET(0x1B1903B0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_READUINT64_OFFSET UNITYSDK_OFFSET(0x1B190230)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1B1905E0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B191CB0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEINT16_OFFSET UNITYSDK_OFFSET(0x1B191C20)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEINT32_OFFSET UNITYSDK_OFFSET(0x1B191C30)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEINT64_OFFSET UNITYSDK_OFFSET(0x1B190F10)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITESBYTE_OFFSET UNITYSDK_OFFSET(0x1B190F00)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITESINGLE_OFFSET UNITYSDK_OFFSET(0x1B191C40)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEUINT16_OFFSET UNITYSDK_OFFSET(0x1B190EE0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEUINT32_OFFSET UNITYSDK_OFFSET(0x1B190EF0)
#define UTF8JSON_INTERNAL_NUMBERCONVERTER_WRITEUINT64_OFFSET UNITYSDK_OFFSET(0x1B1905F0)

namespace Utf8Json::Internal
{
	inline static constexpr unsigned int NumberConverter_TypeDefinitionIndex = 83936;
