...
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AEE6360)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AEE63E0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AEE6020)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEE6010)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_NonGeneric_DeserializeJsonReader_TypeDefinitionIndex = 81741;
