...
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B50E100)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B50E180)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B50DDC0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZEJSONREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B50DDA0)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_NonGeneric_DeserializeJsonReader_TypeDefinitionIndex = 83782;
