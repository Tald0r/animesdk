...
#define UTF8JSON_JSONFORMATTERATTRIBUTE_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1AEE5ED0)
#define UTF8JSON_JSONFORMATTERATTRIBUTE_GET_FORMATTERTYPE_OFFSET UNITYSDK_OFFSET(0x1AEE5EB0)
#define UTF8JSON_JSONFORMATTERATTRIBUTE_SET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1AEE5EE0)
#define UTF8JSON_JSONFORMATTERATTRIBUTE_SET_FORMATTERTYPE_OFFSET UNITYSDK_OFFSET(0x1AEE5EC0)
#define UTF8JSON_JSONFORMATTERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEE5F00)
#define UTF8JSON_JSONFORMATTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEE5EF0)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonFormatterAttribute_TypeDefinitionIndex = 81722;
