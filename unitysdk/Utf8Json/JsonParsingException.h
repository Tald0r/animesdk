...
#define UTF8JSON_JSONPARSINGEXCEPTION_GETUNDERLYINGBYTEARRAYUNSAFE_OFFSET UNITYSDK_OFFSET(0x1B00A3C0)
#define UTF8JSON_JSONPARSINGEXCEPTION_GETUNDERLYINGSTRINGUNSAFE_OFFSET UNITYSDK_OFFSET(0x1B00A400)
#define UTF8JSON_JSONPARSINGEXCEPTION_GET_ACTUALCHAR_OFFSET UNITYSDK_OFFSET(0x1B00A280)
#define UTF8JSON_JSONPARSINGEXCEPTION_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1B00A260)
#define UTF8JSON_JSONPARSINGEXCEPTION_SET_ACTUALCHAR_OFFSET UNITYSDK_OFFSET(0x1B00A290)
#define UTF8JSON_JSONPARSINGEXCEPTION_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1B00A270)
#define UTF8JSON_JSONPARSINGEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B00A300)
#define UTF8JSON_JSONPARSINGEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B00A2A0)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonParsingException_TypeDefinitionIndex = 81737;
