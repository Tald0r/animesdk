...
#define UTF8JSON_JSONPARSINGEXCEPTION_GETUNDERLYINGBYTEARRAYUNSAFE_OFFSET UNITYSDK_OFFSET(0x1B61C550)
#define UTF8JSON_JSONPARSINGEXCEPTION_GETUNDERLYINGSTRINGUNSAFE_OFFSET UNITYSDK_OFFSET(0x1B61C590)
#define UTF8JSON_JSONPARSINGEXCEPTION_GET_ACTUALCHAR_OFFSET UNITYSDK_OFFSET(0x1B61C410)
#define UTF8JSON_JSONPARSINGEXCEPTION_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1B61C3F0)
#define UTF8JSON_JSONPARSINGEXCEPTION_SET_ACTUALCHAR_OFFSET UNITYSDK_OFFSET(0x1B61C420)
#define UTF8JSON_JSONPARSINGEXCEPTION_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1B61C400)
#define UTF8JSON_JSONPARSINGEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B61C490)
#define UTF8JSON_JSONPARSINGEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B61C430)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonParsingException_TypeDefinitionIndex = 83778;
