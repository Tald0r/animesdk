...
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1AEC7E50)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1AEC7F90)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1AEC80C0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_4_OFFSET UNITYSDK_OFFSET(0x1AEC82A0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_5_OFFSET UNITYSDK_OFFSET(0x1AEC8150)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_6_OFFSET UNITYSDK_OFFSET(0x1AEC8330)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_7_OFFSET UNITYSDK_OFFSET(0x1AEC83C0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_8_OFFSET UNITYSDK_OFFSET(0x1AEC8500)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_9_OFFSET UNITYSDK_OFFSET(0x1AEC8590)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AEC7DC0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_GETORADD_OFFSET UNITYSDK_OFFSET(0x1AEC6A70)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEUNSAFE_1_OFFSET UNITYSDK_OFFSET(0x1AEC7720)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEUNSAFE_2_OFFSET UNITYSDK_OFFSET(0x1AEC7920)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEUNSAFE_3_OFFSET UNITYSDK_OFFSET(0x1AEC77C0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEUNSAFE_OFFSET UNITYSDK_OFFSET(0x1AEC7530)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_10_OFFSET UNITYSDK_OFFSET(0x1AEC7350)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1AEC6D90)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1AEC6E20)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1AEC6C50)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_4_OFFSET UNITYSDK_OFFSET(0x1AEC6EC0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_5_OFFSET UNITYSDK_OFFSET(0x1AEC7170)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_6_OFFSET UNITYSDK_OFFSET(0x1AEC7210)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_7_OFFSET UNITYSDK_OFFSET(0x1AEC7020)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_8_OFFSET UNITYSDK_OFFSET(0x1AEC72C0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_9_OFFSET UNITYSDK_OFFSET(0x1AEC7490)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AEC6B00)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_TOJSONSTRING_1_OFFSET UNITYSDK_OFFSET(0x1AEC7B70)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_TOJSONSTRING_2_OFFSET UNITYSDK_OFFSET(0x1AEC7D40)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_TOJSONSTRING_3_OFFSET UNITYSDK_OFFSET(0x1AEC7C00)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_TOJSONSTRING_OFFSET UNITYSDK_OFFSET(0x1AEC7A70)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AEC69B0)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_NonGeneric_TypeDefinitionIndex = 81739;
	...
	public:
		...
		{
			return (::Utf8Json::Internal::ThreadsafeTypeKeyHashTable_1<::Utf8Json::JsonSerializer_NonGeneric_CompiledMethods*>**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_NonGeneric_TypeDefinitionIndex)->GetStaticField(0x474B0);
		}
		static ::System::Func_2<::System::Type*, ::Utf8Json::JsonSerializer_NonGeneric_CompiledMethods*>** StaticGet_CreateCompiledMethods()
		{
			return (::System::Func_2<::System::Type*, ::Utf8Json::JsonSerializer_NonGeneric_CompiledMethods*>**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_NonGeneric_TypeDefinitionIndex)->GetStaticField(0x474B8);
		}
