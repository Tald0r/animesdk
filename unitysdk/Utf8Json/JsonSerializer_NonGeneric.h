...
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1B4E6D10)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1B4E6E50)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1B4E6F80)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_4_OFFSET UNITYSDK_OFFSET(0x1B4E7160)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_5_OFFSET UNITYSDK_OFFSET(0x1B4E7010)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_6_OFFSET UNITYSDK_OFFSET(0x1B4E71F0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_7_OFFSET UNITYSDK_OFFSET(0x1B4E7280)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_8_OFFSET UNITYSDK_OFFSET(0x1B4E73C0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_9_OFFSET UNITYSDK_OFFSET(0x1B4E7450)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4E6C80)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_GETORADD_OFFSET UNITYSDK_OFFSET(0x1B4E5930)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEUNSAFE_1_OFFSET UNITYSDK_OFFSET(0x1B4E65E0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEUNSAFE_2_OFFSET UNITYSDK_OFFSET(0x1B4E67E0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEUNSAFE_3_OFFSET UNITYSDK_OFFSET(0x1B4E6680)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEUNSAFE_OFFSET UNITYSDK_OFFSET(0x1B4E63F0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_10_OFFSET UNITYSDK_OFFSET(0x1B4E6210)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1B4E5C50)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1B4E5CE0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1B4E5B10)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_4_OFFSET UNITYSDK_OFFSET(0x1B4E5D80)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_5_OFFSET UNITYSDK_OFFSET(0x1B4E6030)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_6_OFFSET UNITYSDK_OFFSET(0x1B4E60D0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_7_OFFSET UNITYSDK_OFFSET(0x1B4E5EE0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_8_OFFSET UNITYSDK_OFFSET(0x1B4E6180)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_9_OFFSET UNITYSDK_OFFSET(0x1B4E6350)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4E59C0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_TOJSONSTRING_1_OFFSET UNITYSDK_OFFSET(0x1B4E6A30)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_TOJSONSTRING_2_OFFSET UNITYSDK_OFFSET(0x1B4E6C00)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_TOJSONSTRING_3_OFFSET UNITYSDK_OFFSET(0x1B4E6AC0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_TOJSONSTRING_OFFSET UNITYSDK_OFFSET(0x1B4E6930)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4E5870)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_NonGeneric_TypeDefinitionIndex = 83780;
	...
	public:
		...
		{
			return (::System::Func_2<::System::Type*, ::Utf8Json::JsonSerializer_NonGeneric_CompiledMethods*>**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_NonGeneric_TypeDefinitionIndex)->GetStaticField(0x48EC0);
		}
		...
		{
			return (::Utf8Json::Internal::ThreadsafeTypeKeyHashTable_1<::Utf8Json::JsonSerializer_NonGeneric_CompiledMethods*>**)Il2CppClass::FromTypeDefinitionIndex(JsonSerializer_NonGeneric_TypeDefinitionIndex)->GetStaticField(0x48EC8);
		}
