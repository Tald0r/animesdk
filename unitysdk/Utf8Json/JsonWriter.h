...
#define UTF8JSON_JSONWRITER_ADVANCEOFFSET_OFFSET UNITYSDK_OFFSET(0x98D2A0)
#define UTF8JSON_JSONWRITER_ENSURECAPACITY_OFFSET UNITYSDK_OFFSET(0x98D560)
#define UTF8JSON_JSONWRITER_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x98D2B0)
#define UTF8JSON_JSONWRITER_GETENCODEDPROPERTYNAMEWITHBEGINOBJECT_OFFSET UNITYSDK_OFFSET(0x1B193EB0)
#define UTF8JSON_JSONWRITER_GETENCODEDPROPERTYNAMEWITHOUTQUOTATION_OFFSET UNITYSDK_OFFSET(0x1B193F90)
#define UTF8JSON_JSONWRITER_GETENCODEDPROPERTYNAMEWITHPREFIXVALUESEPARATOR_OFFSET UNITYSDK_OFFSET(0x1B193DD0)
#define UTF8JSON_JSONWRITER_GETENCODEDPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B193D40)
#define UTF8JSON_JSONWRITER_GET_CURRENTOFFSET_OFFSET UNITYSDK_OFFSET(0x2EC6E0)
#define UTF8JSON_JSONWRITER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x98D4B0)
#define UTF8JSON_JSONWRITER_TOUTF8BYTEARRAY_OFFSET UNITYSDK_OFFSET(0x98D440)
#define UTF8JSON_JSONWRITER_WRITEBEGINARRAY_OFFSET UNITYSDK_OFFSET(0x98D660)
#define UTF8JSON_JSONWRITER_WRITEBEGINOBJECT_OFFSET UNITYSDK_OFFSET(0x98D720)
#define UTF8JSON_JSONWRITER_WRITEBOOLEAN_OFFSET UNITYSDK_OFFSET(0x98D970)
#define UTF8JSON_JSONWRITER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x98DAA0)
#define UTF8JSON_JSONWRITER_WRITEDOUBLE_OFFSET UNITYSDK_OFFSET(0x98DA20)
#define UTF8JSON_JSONWRITER_WRITEENDARRAY_OFFSET UNITYSDK_OFFSET(0x98D6C0)
#define UTF8JSON_JSONWRITER_WRITEENDOBJECT_OFFSET UNITYSDK_OFFSET(0x98D780)
#define UTF8JSON_JSONWRITER_WRITEFALSE_OFFSET UNITYSDK_OFFSET(0x98D990)
#define UTF8JSON_JSONWRITER_WRITEINT16_OFFSET UNITYSDK_OFFSET(0x98DB90)
#define UTF8JSON_JSONWRITER_WRITEINT32_OFFSET UNITYSDK_OFFSET(0x98DBC0)
#define UTF8JSON_JSONWRITER_WRITEINT64_OFFSET UNITYSDK_OFFSET(0x98DBF0)
#define UTF8JSON_JSONWRITER_WRITENAMESEPARATOR_OFFSET UNITYSDK_OFFSET(0x98D840)
#define UTF8JSON_JSONWRITER_WRITENULL_OFFSET UNITYSDK_OFFSET(0x98D960)
#define UTF8JSON_JSONWRITER_WRITEPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x98D8A0)
#define UTF8JSON_JSONWRITER_WRITEQUOTATION_OFFSET UNITYSDK_OFFSET(0x98D900)
#define UTF8JSON_JSONWRITER_WRITERAWUNSAFE_OFFSET UNITYSDK_OFFSET(0x98D620)
#define UTF8JSON_JSONWRITER_WRITERAW_1_OFFSET UNITYSDK_OFFSET(0x98D5D0)
#define UTF8JSON_JSONWRITER_WRITERAW_OFFSET UNITYSDK_OFFSET(0x98D570)
#define UTF8JSON_JSONWRITER_WRITESBYTE_OFFSET UNITYSDK_OFFSET(0x98DB60)
#define UTF8JSON_JSONWRITER_WRITESINGLE_OFFSET UNITYSDK_OFFSET(0x98D9A0)
#define UTF8JSON_JSONWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x98DC20)
#define UTF8JSON_JSONWRITER_WRITETRUE_OFFSET UNITYSDK_OFFSET(0x98D980)
#define UTF8JSON_JSONWRITER_WRITEUINT16_OFFSET UNITYSDK_OFFSET(0x98DAD0)
#define UTF8JSON_JSONWRITER_WRITEUINT32_OFFSET UNITYSDK_OFFSET(0x98DB00)
#define UTF8JSON_JSONWRITER_WRITEUINT64_OFFSET UNITYSDK_OFFSET(0x98DB30)
#define UTF8JSON_JSONWRITER_WRITEVALUESEPARATOR_OFFSET UNITYSDK_OFFSET(0x98D7E0)
#define UTF8JSON_JSONWRITER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B194630)
#define UTF8JSON_JSONWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x2F8050)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonWriter_TypeDefinitionIndex = 83789;

	struct alignas(8) JsonWriter
	{
		static ::Il2CppArray<::System::Byte>** StaticGet_emptyBytes()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(JsonWriter_TypeDefinitionIndex)->GetStaticField(0x48E30);
		}
