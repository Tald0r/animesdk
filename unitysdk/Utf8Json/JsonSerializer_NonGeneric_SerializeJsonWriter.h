...
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B00A880)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B00A910)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B00A500)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B00A4F0)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_NonGeneric_SerializeJsonWriter_TypeDefinitionIndex = 81740;
