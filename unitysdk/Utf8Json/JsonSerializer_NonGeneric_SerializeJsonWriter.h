...
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B61CA30)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B61CAC0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B61C6A0)
#define UTF8JSON_JSONSERIALIZER_NONGENERIC_SERIALIZEJSONWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B61C680)

namespace Utf8Json
{
	inline static constexpr unsigned int JsonSerializer_NonGeneric_SerializeJsonWriter_TypeDefinitionIndex = 83781;
