...
#define FXCOLORCORRECTIONPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0xB7E9E80)
#define FXCOLORCORRECTIONPROXY_COPYVALUEFROMFXCOLORCORRECTION_OFFSET UNITYSDK_OFFSET(0xB7EA210)
#define FXCOLORCORRECTIONPROXY_SETVALUETOFXCOLORCORRECTION_OFFSET UNITYSDK_OFFSET(0xB7EA590)
#define FXCOLORCORRECTIONPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xB7EA520)
#define FXCOLORCORRECTIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xB7EAD10)

inline static constexpr unsigned int FXColorCorrectionProxy_TypeDefinitionIndex = 43079;
