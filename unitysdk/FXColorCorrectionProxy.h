...
#define FXCOLORCORRECTIONPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x804CF10)
#define FXCOLORCORRECTIONPROXY_COPYVALUEFROMFXCOLORCORRECTION_OFFSET UNITYSDK_OFFSET(0x804D2A0)
#define FXCOLORCORRECTIONPROXY_SETVALUETOFXCOLORCORRECTION_OFFSET UNITYSDK_OFFSET(0x804D620)
#define FXCOLORCORRECTIONPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x804D5B0)
#define FXCOLORCORRECTIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x804DDA0)

inline static constexpr unsigned int FXColorCorrectionProxy_TypeDefinitionIndex = 79653;
