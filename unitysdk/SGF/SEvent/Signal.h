...
#define SGF_SEVENT_SIGNAL_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1AB431F0)
#define SGF_SEVENT_SIGNAL_INVOKESAFE_OFFSET UNITYSDK_OFFSET(0x1AB43540)
#define SGF_SEVENT_SIGNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB433B0)
#define SGF_SEVENT_SIGNAL_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1AB43110)
#define SGF_SEVENT_SIGNAL_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1AB43270)
#define SGF_SEVENT_SIGNAL_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1AB43340)
#define SGF_SEVENT_SIGNAL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB43750)
#define SGF_SEVENT_SIGNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB43740)

namespace SGF::SEvent
{
	inline static constexpr unsigned int Signal_TypeDefinitionIndex = 7946;
