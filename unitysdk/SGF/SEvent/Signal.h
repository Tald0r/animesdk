...
#define SGF_SEVENT_SIGNAL_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1B0FA520)
#define SGF_SEVENT_SIGNAL_INVOKESAFE_OFFSET UNITYSDK_OFFSET(0x1B0FA870)
#define SGF_SEVENT_SIGNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0FA6E0)
#define SGF_SEVENT_SIGNAL_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1B0FA440)
#define SGF_SEVENT_SIGNAL_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1B0FA5A0)
#define SGF_SEVENT_SIGNAL_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1B0FA670)
#define SGF_SEVENT_SIGNAL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0FAA80)
#define SGF_SEVENT_SIGNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0FAA70)

namespace SGF::SEvent
{
	inline static constexpr unsigned int Signal_TypeDefinitionIndex = 7741;
