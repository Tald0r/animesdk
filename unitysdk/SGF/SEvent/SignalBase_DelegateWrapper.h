...
#define SGF_SEVENT_SIGNALBASE_DELEGATEWRAPPER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x998720)
#define SGF_SEVENT_SIGNALBASE_DELEGATEWRAPPER_EQUALS_OFFSET UNITYSDK_OFFSET(0x998670)
#define SGF_SEVENT_SIGNALBASE_DELEGATEWRAPPER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x998730)
#define SGF_SEVENT_SIGNALBASE_DELEGATEWRAPPER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B439CD0)
#define SGF_SEVENT_SIGNALBASE_DELEGATEWRAPPER_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B439A00)
#define SGF_SEVENT_SIGNALBASE_DELEGATEWRAPPER_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B4399A0)
#define SGF_SEVENT_SIGNALBASE_DELEGATEWRAPPER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B439DD0)
#define SGF_SEVENT_SIGNALBASE_DELEGATEWRAPPER___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9987C0)
#define SGF_SEVENT_SIGNALBASE_DELEGATEWRAPPER___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x998820)

namespace SGF::SEvent
{
	inline static constexpr unsigned int SignalBase_DelegateWrapper_TypeDefinitionIndex = 8184;
