...
#define SGF_SEVENT_DELEGATEINFO_GETDELEGATEINFO_OFFSET UNITYSDK_OFFSET(0x1ABC9E40)
#define SGF_SEVENT_DELEGATEINFO_GETFRIENDLYFIELDNAME_OFFSET UNITYSDK_OFFSET(0x1ABCAB00)
#define SGF_SEVENT_DELEGATEINFO_GETFRIENDLYMETHODNAME_OFFSET UNITYSDK_OFFSET(0x1ABCA010)
#define SGF_SEVENT_DELEGATEINFO_GETFRIENDLYTYPENAME_OFFSET UNITYSDK_OFFSET(0x1ABCB010)
#define SGF_SEVENT_DELEGATEINFO_GETORIGINALTYPEFROMCLOSURE_OFFSET UNITYSDK_OFFSET(0x1ABCA510)
#define SGF_SEVENT_DELEGATEINFO_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1ABC9D80)
#define SGF_SEVENT_DELEGATEINFO_GET_FRIENDLYMETHODNAME_OFFSET UNITYSDK_OFFSET(0x1ABC9D40)
#define SGF_SEVENT_DELEGATEINFO_GET_ISCLOSURE_OFFSET UNITYSDK_OFFSET(0x1ABC9E20)
#define SGF_SEVENT_DELEGATEINFO_GET_ISSTATIC_OFFSET UNITYSDK_OFFSET(0x1ABC9E00)
#define SGF_SEVENT_DELEGATEINFO_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1ABC9D20)
#define SGF_SEVENT_DELEGATEINFO_GET_ORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1ABC9DA0)
#define SGF_SEVENT_DELEGATEINFO_GET_TARGETORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1ABC9DE0)
#define SGF_SEVENT_DELEGATEINFO_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1ABC9DC0)
#define SGF_SEVENT_DELEGATEINFO_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1ABC9D60)
#define SGF_SEVENT_DELEGATEINFO_GUESSORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1ABCA820)
#define SGF_SEVENT_DELEGATEINFO_ISCOMPILERGENERATED_OFFSET UNITYSDK_OFFSET(0x1ABCA390)
#define SGF_SEVENT_DELEGATEINFO_SET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1ABC9D90)
#define SGF_SEVENT_DELEGATEINFO_SET_FRIENDLYMETHODNAME_OFFSET UNITYSDK_OFFSET(0x1ABC9D50)
#define SGF_SEVENT_DELEGATEINFO_SET_ISCLOSURE_OFFSET UNITYSDK_OFFSET(0x1ABC9E30)
#define SGF_SEVENT_DELEGATEINFO_SET_ISSTATIC_OFFSET UNITYSDK_OFFSET(0x1ABC9E10)
#define SGF_SEVENT_DELEGATEINFO_SET_METHOD_OFFSET UNITYSDK_OFFSET(0x1ABC9D30)
#define SGF_SEVENT_DELEGATEINFO_SET_ORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1ABC9DB0)
#define SGF_SEVENT_DELEGATEINFO_SET_TARGETORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1ABC9DF0)
#define SGF_SEVENT_DELEGATEINFO_SET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1ABC9DD0)
#define SGF_SEVENT_DELEGATEINFO_SET_TARGET_OFFSET UNITYSDK_OFFSET(0x1ABC9D70)
#define SGF_SEVENT_DELEGATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABCA000)

namespace SGF::SEvent
{
	inline static constexpr unsigned int DelegateInfo_TypeDefinitionIndex = 7956;

	class DelegateInfo : public ::System::Object
	{
	public:
		::System::Type* _OriginalType_k__BackingField; // 0x10
		::System::Type* _TargetOriginalType_k__BackingField; // 0x18
		::System::String* _FriendlyMethodName_k__BackingField; // 0x20
