...
#define SGF_SEVENT_DELEGATEINFO_GETDELEGATEINFO_OFFSET UNITYSDK_OFFSET(0x1B21A340)
#define SGF_SEVENT_DELEGATEINFO_GETFRIENDLYFIELDNAME_OFFSET UNITYSDK_OFFSET(0x1B21B000)
#define SGF_SEVENT_DELEGATEINFO_GETFRIENDLYMETHODNAME_OFFSET UNITYSDK_OFFSET(0x1B21A510)
#define SGF_SEVENT_DELEGATEINFO_GETFRIENDLYTYPENAME_OFFSET UNITYSDK_OFFSET(0x1B21B510)
#define SGF_SEVENT_DELEGATEINFO_GETORIGINALTYPEFROMCLOSURE_OFFSET UNITYSDK_OFFSET(0x1B21AA10)
#define SGF_SEVENT_DELEGATEINFO_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1B21A280)
#define SGF_SEVENT_DELEGATEINFO_GET_FRIENDLYMETHODNAME_OFFSET UNITYSDK_OFFSET(0x1B21A240)
#define SGF_SEVENT_DELEGATEINFO_GET_ISCLOSURE_OFFSET UNITYSDK_OFFSET(0x1B21A320)
#define SGF_SEVENT_DELEGATEINFO_GET_ISSTATIC_OFFSET UNITYSDK_OFFSET(0x1B21A300)
#define SGF_SEVENT_DELEGATEINFO_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1B21A220)
#define SGF_SEVENT_DELEGATEINFO_GET_ORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1B21A2A0)
#define SGF_SEVENT_DELEGATEINFO_GET_TARGETORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1B21A2E0)
#define SGF_SEVENT_DELEGATEINFO_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1B21A2C0)
#define SGF_SEVENT_DELEGATEINFO_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1B21A260)
#define SGF_SEVENT_DELEGATEINFO_GUESSORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1B21AD20)
#define SGF_SEVENT_DELEGATEINFO_ISCOMPILERGENERATED_OFFSET UNITYSDK_OFFSET(0x1B21A890)
#define SGF_SEVENT_DELEGATEINFO_SET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1B21A290)
#define SGF_SEVENT_DELEGATEINFO_SET_FRIENDLYMETHODNAME_OFFSET UNITYSDK_OFFSET(0x1B21A250)
#define SGF_SEVENT_DELEGATEINFO_SET_ISCLOSURE_OFFSET UNITYSDK_OFFSET(0x1B21A330)
#define SGF_SEVENT_DELEGATEINFO_SET_ISSTATIC_OFFSET UNITYSDK_OFFSET(0x1B21A310)
#define SGF_SEVENT_DELEGATEINFO_SET_METHOD_OFFSET UNITYSDK_OFFSET(0x1B21A230)
#define SGF_SEVENT_DELEGATEINFO_SET_ORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1B21A2B0)
#define SGF_SEVENT_DELEGATEINFO_SET_TARGETORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1B21A2F0)
#define SGF_SEVENT_DELEGATEINFO_SET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1B21A2D0)
#define SGF_SEVENT_DELEGATEINFO_SET_TARGET_OFFSET UNITYSDK_OFFSET(0x1B21A270)
#define SGF_SEVENT_DELEGATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21A500)

namespace SGF::SEvent
{
	inline static constexpr unsigned int DelegateInfo_TypeDefinitionIndex = 8115;

	class DelegateInfo : public ::System::Object
	{
	public:
		::System::Type* _OriginalType_k__BackingField; // 0x10
		::System::Object* _Target_k__BackingField; // 0x18
		::System::Type* _TargetOriginalType_k__BackingField; // 0x20
		::System::String* _FriendlyMethodName_k__BackingField; // 0x28
		::System::Reflection::MethodInfo* _Method_k__BackingField; // 0x30
		::System::Type* _DeclaringType_k__BackingField; // 0x38
		::System::Type* _TargetType_k__BackingField; // 0x40
