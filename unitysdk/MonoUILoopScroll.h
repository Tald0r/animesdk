...
#define MONOUILOOPSCROLL_ADDID_OFFSET UNITYSDK_OFFSET(0xA0982C0)
#define MONOUILOOPSCROLL_AWAKE_OFFSET UNITYSDK_OFFSET(0xA097B50)
#define MONOUILOOPSCROLL_FINDNEARESTNOTEMPTYINDEX_OFFSET UNITYSDK_OFFSET(0xA0997B0)
#define MONOUILOOPSCROLL_GETCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0xA098340)
#define MONOUILOOPSCROLL_GETMOVESTEP_OFFSET UNITYSDK_OFFSET(0xA0990F0)
#define MONOUILOOPSCROLL_INIT_OFFSET UNITYSDK_OFFSET(0xA097C20)
#define MONOUILOOPSCROLL_MOVECENTERGAMEOBJECTID_OFFSET UNITYSDK_OFFSET(0xA099060)
#define MONOUILOOPSCROLL_MOVEID_OFFSET UNITYSDK_OFFSET(0xA098FE0)
#define MONOUILOOPSCROLL_MOVESCROLL_OFFSET UNITYSDK_OFFSET(0xA099BD0)
#define MONOUILOOPSCROLL_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xA09A4D0)
#define MONOUILOOPSCROLL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA098A40)
#define MONOUILOOPSCROLL_ONDRAG_OFFSET UNITYSDK_OFFSET(0xA09A3D0)
#define MONOUILOOPSCROLL_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xA09A460)
#define MONOUILOOPSCROLL_ROLETOGO_OFFSET UNITYSDK_OFFSET(0xA098C60)
#define MONOUILOOPSCROLL_SCROLLTOINDEX_OFFSET UNITYSDK_OFFSET(0xA099710)
#define MONOUILOOPSCROLL_START_OFFSET UNITYSDK_OFFSET(0xA0991C0)
#define MONOUILOOPSCROLL_SUBID_OFFSET UNITYSDK_OFFSET(0xA099150)
#define MONOUILOOPSCROLL_UPDATESELECTANIM_OFFSET UNITYSDK_OFFSET(0xA0983D0)
#define MONOUILOOPSCROLL_UPDATE_OFFSET UNITYSDK_OFFSET(0xA099220)
#define MONOUILOOPSCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0xA09A540)

inline static constexpr unsigned int MonoUILoopScroll_TypeDefinitionIndex = 57495;
...
public:
	...
	::System::Void Start()
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MONOUILOOPSCROLL_START_OFFSET))(this);
	}
