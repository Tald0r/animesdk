...
#define MONOUILOOPSCROLL_ADDID_OFFSET UNITYSDK_OFFSET(0x972B9D0)
#define MONOUILOOPSCROLL_AWAKE_OFFSET UNITYSDK_OFFSET(0x972B260)
#define MONOUILOOPSCROLL_FINDNEARESTNOTEMPTYINDEX_OFFSET UNITYSDK_OFFSET(0x972CE60)
#define MONOUILOOPSCROLL_GETCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x972BA50)
#define MONOUILOOPSCROLL_GETMOVESTEP_OFFSET UNITYSDK_OFFSET(0x972C800)
#define MONOUILOOPSCROLL_INIT_OFFSET UNITYSDK_OFFSET(0x972B330)
#define MONOUILOOPSCROLL_MOVECENTERGAMEOBJECTID_OFFSET UNITYSDK_OFFSET(0x972C770)
#define MONOUILOOPSCROLL_MOVEID_OFFSET UNITYSDK_OFFSET(0x972C6F0)
#define MONOUILOOPSCROLL_MOVESCROLL_OFFSET UNITYSDK_OFFSET(0x972D280)
#define MONOUILOOPSCROLL_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x972DB80)
#define MONOUILOOPSCROLL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x972C150)
#define MONOUILOOPSCROLL_ONDRAG_OFFSET UNITYSDK_OFFSET(0x972DA80)
#define MONOUILOOPSCROLL_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x972DB10)
#define MONOUILOOPSCROLL_ROLETOGO_OFFSET UNITYSDK_OFFSET(0x972C370)
#define MONOUILOOPSCROLL_SCROLLTOINDEX_OFFSET UNITYSDK_OFFSET(0x972CDC0)
#define MONOUILOOPSCROLL_SUBID_OFFSET UNITYSDK_OFFSET(0x972C860)
#define MONOUILOOPSCROLL_UPDATESELECTANIM_OFFSET UNITYSDK_OFFSET(0x972BAE0)
#define MONOUILOOPSCROLL_UPDATE_OFFSET UNITYSDK_OFFSET(0x972C8D0)
#define MONOUILOOPSCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x972DBF0)

inline static constexpr unsigned int MonoUILoopScroll_TypeDefinitionIndex = 51983;
