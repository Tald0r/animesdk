...
#define CLASS_1_402812A65CC3A690__CTOR_OFFSET UNITYSDK_OFFSET(0x80D2DC0)

inline static constexpr unsigned int Class_1_402812A65CC3A690_TypeDefinitionIndex = 72308;
...
public:
	...
	::Share::EItemType Field_1_1; // 0x1C
