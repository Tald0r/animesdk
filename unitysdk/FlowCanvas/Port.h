...
#define FLOWCANVAS_PORT_CANACCEPTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A21CEF0)
#define FLOWCANVAS_PORT_FLAGINVALIDCAST_OFFSET UNITYSDK_OFFSET(0x1A21CED0)
#define FLOWCANVAS_PORT_FLAGMISSING_OFFSET UNITYSDK_OFFSET(0x1A21CEB0)
#define FLOWCANVAS_PORT_FLAGVALID_OFFSET UNITYSDK_OFFSET(0x1A219580)
#define FLOWCANVAS_PORT_GETFIRSTINPUTCONNECTION_OFFSET UNITYSDK_OFFSET(0x1A21D1A0)
#define FLOWCANVAS_PORT_GETFIRSTOUTPUTCONNECTION_OFFSET UNITYSDK_OFFSET(0x1A21D2B0)
#define FLOWCANVAS_PORT_GETPORTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A21CFA0)
#define FLOWCANVAS_PORT_GET_BINDSTATUS_OFFSET UNITYSDK_OFFSET(0x1A21CE70)
#define FLOWCANVAS_PORT_GET_CONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A21CE50)
#define FLOWCANVAS_PORT_GET_DISPLAYCONTENT_OFFSET UNITYSDK_OFFSET(0x1A21CE90)
#define FLOWCANVAS_PORT_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A21CE10)
#define FLOWCANVAS_PORT_GET_ISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A214D10)
#define FLOWCANVAS_PORT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A21CE30)
#define FLOWCANVAS_PORT_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1A21CDF0)
#define FLOWCANVAS_PORT_ISDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A21D640)
#define FLOWCANVAS_PORT_ISENUMERABLECOLLECTION_OFFSET UNITYSDK_OFFSET(0x1A21D6F0)
#define FLOWCANVAS_PORT_ISFLOWPORT_OFFSET UNITYSDK_OFFSET(0x1A21D3C0)
#define FLOWCANVAS_PORT_ISINPUTPORT_OFFSET UNITYSDK_OFFSET(0x1A2194C0)
#define FLOWCANVAS_PORT_ISOUTPUTPORT_OFFSET UNITYSDK_OFFSET(0x1A219520)
#define FLOWCANVAS_PORT_ISUNITYOBJECT_OFFSET UNITYSDK_OFFSET(0x1A21D480)
#define FLOWCANVAS_PORT_ISUNITYSCENEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A21D530)
#define FLOWCANVAS_PORT_ISVALUEPORT_OFFSET UNITYSDK_OFFSET(0x1A21D420)
#define FLOWCANVAS_PORT_ISWILD_OFFSET UNITYSDK_OFFSET(0x1A21D760)
#define FLOWCANVAS_PORT_SET_BINDSTATUS_OFFSET UNITYSDK_OFFSET(0x1A21CE80)
#define FLOWCANVAS_PORT_SET_CONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A21CE60)
#define FLOWCANVAS_PORT_SET_DISPLAYCONTENT_OFFSET UNITYSDK_OFFSET(0x1A21CEA0)
#define FLOWCANVAS_PORT_SET_ID_OFFSET UNITYSDK_OFFSET(0x1A21CE20)
#define FLOWCANVAS_PORT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A21CE40)
#define FLOWCANVAS_PORT_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1A21CE00)
#define FLOWCANVAS_PORT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A21D7B0)
#define FLOWCANVAS_PORT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A21CDE0)
#define FLOWCANVAS_PORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A21CDD0)
#define FLOWCANVAS_PORT__GETFIRSTINPUTCONNECTION_B__36_0_OFFSET UNITYSDK_OFFSET(0x1A21D8C0)
#define FLOWCANVAS_PORT__GETFIRSTOUTPUTCONNECTION_B__37_0_OFFSET UNITYSDK_OFFSET(0x1A21D930)
#define FLOWCANVAS_PORT__GETPORTCONNECTIONS_B__35_0_OFFSET UNITYSDK_OFFSET(0x1A21D7E0)
#define FLOWCANVAS_PORT__GETPORTCONNECTIONS_B__35_1_OFFSET UNITYSDK_OFFSET(0x1A21D850)

namespace FlowCanvas
{
	inline static constexpr unsigned int Port_TypeDefinitionIndex = 27512;
