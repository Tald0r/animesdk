...
#define FLOWCANVAS_FLOW_RETURNDATA_GET_RETURNCALL_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define FLOWCANVAS_FLOW_RETURNDATA_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define FLOWCANVAS_FLOW_RETURNDATA_SET_RETURNCALL_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define FLOWCANVAS_FLOW_RETURNDATA_SET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x2CB170)
#define FLOWCANVAS_FLOW_RETURNDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x2D6E20)

namespace FlowCanvas
{
	inline static constexpr unsigned int Flow_ReturnData_TypeDefinitionIndex = 26498;
