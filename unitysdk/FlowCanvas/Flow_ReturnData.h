...
#define FLOWCANVAS_FLOW_RETURNDATA_GET_RETURNCALL_OFFSET UNITYSDK_OFFSET(0x223870)
#define FLOWCANVAS_FLOW_RETURNDATA_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x272280)
#define FLOWCANVAS_FLOW_RETURNDATA_SET_RETURNCALL_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define FLOWCANVAS_FLOW_RETURNDATA_SET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x302310)
#define FLOWCANVAS_FLOW_RETURNDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x301710)

namespace FlowCanvas
{
	inline static constexpr unsigned int Flow_ReturnData_TypeDefinitionIndex = 26591;
