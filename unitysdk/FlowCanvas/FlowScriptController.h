...
#define FLOWCANVAS_FLOWSCRIPTCONTROLLER_CALLFUNCTIONASYNC_OFFSET UNITYSDK_OFFSET(0x19153330)
#define FLOWCANVAS_FLOWSCRIPTCONTROLLER_CALLFUNCTION_1_OFFSET UNITYSDK_OFFSET(0x191532D0)
#define FLOWCANVAS_FLOWSCRIPTCONTROLLER_CALLFUNCTION_OFFSET UNITYSDK_OFFSET(0x19153270)
#define FLOWCANVAS_FLOWSCRIPTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x191533A0)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowScriptController_TypeDefinitionIndex = 26053;
