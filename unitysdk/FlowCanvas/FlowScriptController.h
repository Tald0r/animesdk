...
#define FLOWCANVAS_FLOWSCRIPTCONTROLLER_CALLFUNCTIONASYNC_OFFSET UNITYSDK_OFFSET(0x19545480)
#define FLOWCANVAS_FLOWSCRIPTCONTROLLER_CALLFUNCTION_1_OFFSET UNITYSDK_OFFSET(0x19545420)
#define FLOWCANVAS_FLOWSCRIPTCONTROLLER_CALLFUNCTION_OFFSET UNITYSDK_OFFSET(0x195453C0)
#define FLOWCANVAS_FLOWSCRIPTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x195454F0)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowScriptController_TypeDefinitionIndex = 27456;
