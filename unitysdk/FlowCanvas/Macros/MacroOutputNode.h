...
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE_GET_ICONALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1A1AA4F0)
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE_GET_MACRO_OFFSET UNITYSDK_OFFSET(0x1A1AA500)
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0x1A1AA9C0)
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A1AA540)
#define FLOWCANVAS_MACROS_MACROOUTPUTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1AA9D0)

namespace FlowCanvas::Macros
{
	inline static constexpr unsigned int MacroOutputNode_TypeDefinitionIndex = 25729;
