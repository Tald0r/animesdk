...
#define FLOWCANVAS_MACROS_CUSTOMMACROENUMWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0x192583E0)

namespace FlowCanvas::Macros
{
	inline static constexpr unsigned int CustomMacroEnumWrap_TypeDefinitionIndex = 25985;
