...
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER___C__DISPLAYCLASS30_3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A560EE0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER___C__DISPLAYCLASS30_3__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x1A560EF0)

namespace FlowCanvas::Macros
{
	inline static constexpr unsigned int MacroNodeWrapper___c__DisplayClass30_3_TypeDefinitionIndex = 25978;
