...
#define FLOWCANVAS_MACROS_MACROINPUTNODE_GET_ICONALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1A600040)
#define FLOWCANVAS_MACROS_MACROINPUTNODE_GET_MACRO_OFFSET UNITYSDK_OFFSET(0x1A600050)
#define FLOWCANVAS_MACROS_MACROINPUTNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A600090)
#define FLOWCANVAS_MACROS_MACROINPUTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6004C0)

namespace FlowCanvas::Macros
{
	inline static constexpr unsigned int MacroInputNode_TypeDefinitionIndex = 26935;
