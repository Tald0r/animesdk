...
#define FLOWCANVAS_MACROS_MACRO_ADDEXAMPLEPORTS_OFFSET UNITYSDK_OFFSET(0x19153A30)
#define FLOWCANVAS_MACROS_MACRO_ADDINPUTDEFINITION_OFFSET UNITYSDK_OFFSET(0x191537A0)
#define FLOWCANVAS_MACROS_MACRO_ADDOUTPUTDEFINITION_OFFSET UNITYSDK_OFFSET(0x191538E0)
#define FLOWCANVAS_MACROS_MACRO_CALLFLOWINPUT_OFFSET UNITYSDK_OFFSET(0x19153BC0)
#define FLOWCANVAS_MACROS_MACRO_GET_ALLOWBLACKBOARDOVERRIDES_OFFSET UNITYSDK_OFFSET(0x19153480)
#define FLOWCANVAS_MACROS_MACRO_GET_BINDMACRONODEWRAPPERID_OFFSET UNITYSDK_OFFSET(0x19153490)
#define FLOWCANVAS_MACROS_MACRO_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x191534B0)
#define FLOWCANVAS_MACROS_MACRO_GET_EXIT_OFFSET UNITYSDK_OFFSET(0x19153600)
#define FLOWCANVAS_MACROS_MACRO_ONDERIVEDDATADESERIALIZATION_OFFSET UNITYSDK_OFFSET(0x191533F0)
#define FLOWCANVAS_MACROS_MACRO_ONDERIVEDDATASERIALIZATION_OFFSET UNITYSDK_OFFSET(0x191533C0)
#define FLOWCANVAS_MACROS_MACRO_ONGRAPHVALIDATE_OFFSET UNITYSDK_OFFSET(0x19153760)
#define FLOWCANVAS_MACROS_MACRO_SET_BINDMACRONODEWRAPPERID_OFFSET UNITYSDK_OFFSET(0x191534A0)
#define FLOWCANVAS_MACROS_MACRO__CTOR_OFFSET UNITYSDK_OFFSET(0x19153D70)

namespace FlowCanvas::Macros
{
	inline static constexpr unsigned int Macro_TypeDefinitionIndex = 25866;
