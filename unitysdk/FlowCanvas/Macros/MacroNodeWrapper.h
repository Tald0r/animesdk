...
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A3EE730)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_GET_MACRO_OFFSET UNITYSDK_OFFSET(0x1A3EE880)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A3EE680)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_MAKEINSTANCEWITHOUTGATHERPORTS_OFFSET UNITYSDK_OFFSET(0x1A3EED60)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_MAKEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A3EED40)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_GET_CURRENTINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A3EEB90)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_GET_INSTANCES_OFFSET UNITYSDK_OFFSET(0x1A3EEC20)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A3EEC10)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A3EE9F0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_GET_VARIABLESMAP_OFFSET UNITYSDK_OFFSET(0x1A3EEBF0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_SET_CURRENTINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A3EEBA0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_SET_INSTANCES_OFFSET UNITYSDK_OFFSET(0x1A3EECF0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A3EEA00)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IGRAPHASSIGNABLE_SET_VARIABLESMAP_OFFSET UNITYSDK_OFFSET(0x1A3EEC00)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A3EEEE0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A3EEFD0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A3EF180)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_SET_MACRO_OFFSET UNITYSDK_OFFSET(0x1A3EE890)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER_SET_TMACRO_OFFSET UNITYSDK_OFFSET(0x1A3EE9E0)
#define FLOWCANVAS_MACROS_MACRONODEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3EF930)

namespace FlowCanvas::Macros
{
	inline static constexpr unsigned int MacroNodeWrapper_TypeDefinitionIndex = 25975;
