...
#define FLOWCANVAS_VALUEINPUT_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A081F30)
#define FLOWCANVAS_VALUEINPUT_GET_SKIPSELFINSTANCEASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1A0822D0)
#define FLOWCANVAS_VALUEINPUT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A082250)
#define FLOWCANVAS_VALUEINPUT_SETDEFAULTANDSERIALIZEDVALUE_OFFSET UNITYSDK_OFFSET(0x1A082270)
#define FLOWCANVAS_VALUEINPUT_SET_SKIPSELFINSTANCEASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1A0822E0)
#define FLOWCANVAS_VALUEINPUT_SKIPSELFINSTANCEASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1A0822C0)
#define FLOWCANVAS_VALUEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A081F20)

namespace FlowCanvas
{
	inline static constexpr unsigned int ValueInput_TypeDefinitionIndex = 25845;
