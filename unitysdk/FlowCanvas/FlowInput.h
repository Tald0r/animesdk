...
#define FLOWCANVAS_FLOWINPUT_GET_POINTER_OFFSET UNITYSDK_OFFSET(0x19DFF770)
#define FLOWCANVAS_FLOWINPUT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19DFF790)
#define FLOWCANVAS_FLOWINPUT_RECORDCALLINFO_OFFSET UNITYSDK_OFFSET(0x19DFF7C0)
#define FLOWCANVAS_FLOWINPUT_SET_POINTER_OFFSET UNITYSDK_OFFSET(0x19DFF780)
#define FLOWCANVAS_FLOWINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x19DFF650)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowInput_TypeDefinitionIndex = 25642;
	...
	public:
		...
		{
			return (::System::Action_2<::FlowCanvas::FlowInput*, ::FlowCanvas::FlowNode*>**)Il2CppClass::FromTypeDefinitionIndex(FlowInput_TypeDefinitionIndex)->GetStaticField(0x1E4F0);
		}
