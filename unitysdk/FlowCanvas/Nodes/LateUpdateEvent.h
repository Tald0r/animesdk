...
#define FLOWCANVAS_NODES_LATEUPDATEEVENT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x195478C0)
#define FLOWCANVAS_NODES_LATEUPDATEEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19547760)
#define FLOWCANVAS_NODES_LATEUPDATEEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19547810)
#define FLOWCANVAS_NODES_LATEUPDATEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19547730)
#define FLOWCANVAS_NODES_LATEUPDATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19547900)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LateUpdateEvent_TypeDefinitionIndex = 27477;
