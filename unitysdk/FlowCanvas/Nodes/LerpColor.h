...
#define FLOWCANVAS_NODES_LERPCOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A47D520)
#define FLOWCANVAS_NODES_LERPCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A47D5F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LerpColor_TypeDefinitionIndex = 27034;
