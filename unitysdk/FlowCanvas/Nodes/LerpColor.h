...
#define FLOWCANVAS_NODES_LERPCOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E8FD40)
#define FLOWCANVAS_NODES_LERPCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19E8FE10)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LerpColor_TypeDefinitionIndex = 25732;
