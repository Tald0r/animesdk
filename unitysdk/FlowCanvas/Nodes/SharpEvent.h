...
#define FLOWCANVAS_NODES_SHARPEVENT_CREATE_OFFSET UNITYSDK_OFFSET(0x183DDF80)
#define FLOWCANVAS_NODES_SHARPEVENT_GET_EVENTINFO_OFFSET UNITYSDK_OFFSET(0x183DDF60)
#define FLOWCANVAS_NODES_SHARPEVENT_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x183DDF40)
#define FLOWCANVAS_NODES_SHARPEVENT_SETINSTANCE_OFFSET UNITYSDK_OFFSET(0x183DE1A0)
#define FLOWCANVAS_NODES_SHARPEVENT_SET_EVENTINFO_OFFSET UNITYSDK_OFFSET(0x183DDF70)
#define FLOWCANVAS_NODES_SHARPEVENT_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x183DDF50)
#define FLOWCANVAS_NODES_SHARPEVENT_STARTLISTENING_OFFSET UNITYSDK_OFFSET(0x183DE1B0)
#define FLOWCANVAS_NODES_SHARPEVENT_STOPLISTENING_OFFSET UNITYSDK_OFFSET(0x183DE270)
#define FLOWCANVAS_NODES_SHARPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x183DE330)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SharpEvent_TypeDefinitionIndex = 25343;
