...
#define FLOWCANVAS_NODES_APPLICATIONQUITEVENT_APPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x1A176E30)
#define FLOWCANVAS_NODES_APPLICATIONQUITEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A176CD0)
#define FLOWCANVAS_NODES_APPLICATIONQUITEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A176D80)
#define FLOWCANVAS_NODES_APPLICATIONQUITEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A176E70)
#define FLOWCANVAS_NODES_APPLICATIONQUITEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A176EA0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ApplicationQuitEvent_TypeDefinitionIndex = 26066;
