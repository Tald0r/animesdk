...
#define FLOWCANVAS_NODES_TWEENQUATERNION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19E044B0)
#define FLOWCANVAS_NODES_TWEENQUATERNION_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E044D0)
#define FLOWCANVAS_NODES_TWEENQUATERNION_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19E044C0)
#define FLOWCANVAS_NODES_TWEENQUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E04550)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenQuaternion_TypeDefinitionIndex = 25595;
