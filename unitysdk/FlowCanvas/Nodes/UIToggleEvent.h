...
#define FLOWCANVAS_NODES_UITOGGLEEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A5636C0)
#define FLOWCANVAS_NODES_UITOGGLEEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A5635D0)
#define FLOWCANVAS_NODES_UITOGGLEEVENT_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A5638B0)
#define FLOWCANVAS_NODES_UITOGGLEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A5637D0)
#define FLOWCANVAS_NODES_UITOGGLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A563900)
#define FLOWCANVAS_NODES_UITOGGLEEVENT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1A563930)
#define FLOWCANVAS_NODES_UITOGGLEEVENT__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1A563990)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UIToggleEvent_TypeDefinitionIndex = 27170;
