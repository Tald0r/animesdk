...
#define FLOWCANVAS_NODES_UITOGGLEEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19F528B0)
#define FLOWCANVAS_NODES_UITOGGLEEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19F527C0)
#define FLOWCANVAS_NODES_UITOGGLEEVENT_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19F52AA0)
#define FLOWCANVAS_NODES_UITOGGLEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19F529C0)
#define FLOWCANVAS_NODES_UITOGGLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F52AF0)
#define FLOWCANVAS_NODES_UITOGGLEEVENT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x19F52B20)
#define FLOWCANVAS_NODES_UITOGGLEEVENT__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x19F52B80)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UIToggleEvent_TypeDefinitionIndex = 26078;
