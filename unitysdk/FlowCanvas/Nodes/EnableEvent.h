...
#define FLOWCANVAS_NODES_ENABLEEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A07EFA0)
#define FLOWCANVAS_NODES_ENABLEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A07EFE0)
#define FLOWCANVAS_NODES_ENABLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A07F010)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int EnableEvent_TypeDefinitionIndex = 25492;
