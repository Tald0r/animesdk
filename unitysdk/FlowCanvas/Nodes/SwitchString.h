...
#define FLOWCANVAS_NODES_SWITCHSTRING_ISCHOICENODE_OFFSET UNITYSDK_OFFSET(0x19FE9AA0)
#define FLOWCANVAS_NODES_SWITCHSTRING_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19FE9860)
#define FLOWCANVAS_NODES_SWITCHSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE9AB0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchString_TypeDefinitionIndex = 26204;
