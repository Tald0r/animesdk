...
#define FLOWCANVAS_NODES_TWEENFLOAT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1974C590)
#define FLOWCANVAS_NODES_TWEENFLOAT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1974C5B0)
#define FLOWCANVAS_NODES_TWEENFLOAT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1974C5A0)
#define FLOWCANVAS_NODES_TWEENFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1974C640)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenFloat_TypeDefinitionIndex = 25797;
