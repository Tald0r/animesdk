...
#define FLOWCANVAS_NODES_WAITWHILE_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x1A82B320)
#define FLOWCANVAS_NODES_WAITWHILE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A82B330)
#define FLOWCANVAS_NODES_WAITWHILE_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0x1A82B380)
#define FLOWCANVAS_NODES_WAITWHILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A82B3C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitWhile_TypeDefinitionIndex = 26803;
