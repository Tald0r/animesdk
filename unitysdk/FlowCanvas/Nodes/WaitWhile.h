...
#define FLOWCANVAS_NODES_WAITWHILE_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x1A2639B0)
#define FLOWCANVAS_NODES_WAITWHILE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A2639C0)
#define FLOWCANVAS_NODES_WAITWHILE_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0x1A263A10)
#define FLOWCANVAS_NODES_WAITWHILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A263A50)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitWhile_TypeDefinitionIndex = 26219;
