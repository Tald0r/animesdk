...
#define FLOWCANVAS_NODES_FORLOOP___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19C79090)
#define FLOWCANVAS_NODES_FORLOOP___C__DISPLAYCLASS6_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x19C790A0)
#define FLOWCANVAS_NODES_FORLOOP___C__DISPLAYCLASS6_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x19C790C0)
#define FLOWCANVAS_NODES_FORLOOP___C__DISPLAYCLASS6_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0x19C79620)
#define FLOWCANVAS_NODES_FORLOOP___C__DISPLAYCLASS6_0__REGISTERPORTS_B__3_OFFSET UNITYSDK_OFFSET(0x19C79600)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ForLoop___c__DisplayClass6_0_TypeDefinitionIndex = 26456;
	...
	public:
		...
		::FlowCanvas::FlowBreak* __9__3; // 0x28
