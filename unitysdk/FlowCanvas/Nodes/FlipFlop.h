...
#define FLOWCANVAS_NODES_FLIPFLOP_GET_NAME_OFFSET UNITYSDK_OFFSET(0x195473C0)
#define FLOWCANVAS_NODES_FLIPFLOP_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19547420)
#define FLOWCANVAS_NODES_FLIPFLOP_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19547430)
#define FLOWCANVAS_NODES_FLIPFLOP_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19547440)
#define FLOWCANVAS_NODES_FLIPFLOP__CTOR_OFFSET UNITYSDK_OFFSET(0x195475A0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FlipFlop_TypeDefinitionIndex = 26231;
