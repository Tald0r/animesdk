...
#define FLOWCANVAS_NODES_UIBUTTONEVENT_ONCLICK_OFFSET UNITYSDK_OFFSET(0x19C034B0)
#define FLOWCANVAS_NODES_UIBUTTONEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19C03310)
#define FLOWCANVAS_NODES_UIBUTTONEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19C031A0)
#define FLOWCANVAS_NODES_UIBUTTONEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19C03420)
#define FLOWCANVAS_NODES_UIBUTTONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C034F0)
#define FLOWCANVAS_NODES_UIBUTTONEVENT__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x19C03520)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UIButtonEvent_TypeDefinitionIndex = 26011;
