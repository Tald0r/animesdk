...
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_ADDPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A600C20)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GATHERPORTSUPDATEREFS_OFFSET UNITYSDK_OFFSET(0x1A600D10)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GETRETURNVALUE_OFFSET UNITYSDK_OFFSET(0x1A600C10)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A600730)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A6005B0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_PARAMETERTYPES_OFFSET UNITYSDK_OFFSET(0x1A600610)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_RETURNS_OFFSET UNITYSDK_OFFSET(0x1A6005D0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1A6005F0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_INVOKEASYNC_OFFSET UNITYSDK_OFFSET(0x1A600B00)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A600990)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_NODECANVAS_FRAMEWORK_IINVOKABLE_GETINVOCATIONID_OFFSET UNITYSDK_OFFSET(0x1A6008D0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_NODECANVAS_FRAMEWORK_IINVOKABLE_INVOKEASYNC_OFFSET UNITYSDK_OFFSET(0x1A600A40)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_NODECANVAS_FRAMEWORK_IINVOKABLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6008E0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A600770)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A600780)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A6005C0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_SET_RETURNS_OFFSET UNITYSDK_OFFSET(0x1A6005E0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A601090)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT__GATHERPORTSUPDATEREFS_B__27_0_OFFSET UNITYSDK_OFFSET(0x1A6011A0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT__INVOKE_B__23_0_OFFSET UNITYSDK_OFFSET(0x1A601190)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomFunctionEvent_TypeDefinitionIndex = 27162;
	...
	public:
		...
		::ParadoxNotion::DynamicParameterDefinition* _returns; // 0xB8
		::System::Object* returnValue; // 0xC0
		::Il2CppArray<::System::Object*>* args; // 0xC8
		::System::String* identifier; // 0xD0
