...
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_ADDPARAMETER_OFFSET UNITYSDK_OFFSET(0x19FE7B90)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GATHERPORTSUPDATEREFS_OFFSET UNITYSDK_OFFSET(0x19FE7C80)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GETRETURNVALUE_OFFSET UNITYSDK_OFFSET(0x19FE7B80)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19FE7690)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x19FE7520)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_PARAMETERTYPES_OFFSET UNITYSDK_OFFSET(0x19FE7580)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_RETURNS_OFFSET UNITYSDK_OFFSET(0x19FE7540)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x19FE7560)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_INVOKEASYNC_OFFSET UNITYSDK_OFFSET(0x19FE7A70)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FE7900)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_NODECANVAS_FRAMEWORK_IINVOKABLE_GETINVOCATIONID_OFFSET UNITYSDK_OFFSET(0x19FE7840)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_NODECANVAS_FRAMEWORK_IINVOKABLE_INVOKEASYNC_OFFSET UNITYSDK_OFFSET(0x19FE79B0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_NODECANVAS_FRAMEWORK_IINVOKABLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FE7850)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19FE76D0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19FE76F0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x19FE7530)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT_SET_RETURNS_OFFSET UNITYSDK_OFFSET(0x19FE7550)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE8000)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT__GATHERPORTSUPDATEREFS_B__27_0_OFFSET UNITYSDK_OFFSET(0x19FE8110)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT__INVOKE_B__23_0_OFFSET UNITYSDK_OFFSET(0x19FE8100)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomFunctionEvent_TypeDefinitionIndex = 25322;
