...
#define FLOWCANVAS_NODES_LERPVECTOR3_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FE8AB0)
#define FLOWCANVAS_NODES_LERPVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE8BA0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LerpVector3_TypeDefinitionIndex = 26838;
