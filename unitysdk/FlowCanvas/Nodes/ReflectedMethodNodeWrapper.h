...
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GETNODEWILDDEFINITIONTYPE_OFFSET UNITYSDK_OFFSET(0x19C19A50)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x19C19000)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19C19060)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_REFLECTEDMETHODNODE_OFFSET UNITYSDK_OFFSET(0x19C18FE0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_SERIALIZEDMETHODBASE_OFFSET UNITYSDK_OFFSET(0x19C19030)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_GET_TMETHOD_OFFSET UNITYSDK_OFFSET(0x19C19040)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0x19C198D0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19C19AD0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_SETMETHODBASE_OFFSET UNITYSDK_OFFSET(0x19C19620)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x19C19660)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_SET_REFLECTEDMETHODNODE_OFFSET UNITYSDK_OFFSET(0x19C18FF0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER_SET_TMETHOD_OFFSET UNITYSDK_OFFSET(0x19C19050)
#define FLOWCANVAS_NODES_REFLECTEDMETHODNODEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C19B40)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedMethodNodeWrapper_TypeDefinitionIndex = 26223;
