...
#define FLOWCANVAS_NODES_WAITWHILE__INVOKE_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19C1A590)
#define FLOWCANVAS_NODES_WAITWHILE__INVOKE_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C1A640)
#define FLOWCANVAS_NODES_WAITWHILE__INVOKE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C1A6A0)
#define FLOWCANVAS_NODES_WAITWHILE__INVOKE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19C1A650)
#define FLOWCANVAS_NODES_WAITWHILE__INVOKE_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C1A580)
#define FLOWCANVAS_NODES_WAITWHILE__INVOKE_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x19C1A570)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitWhile__Invoke_d__3_TypeDefinitionIndex = 26804;

	class WaitWhile__Invoke_d__3 : public ::System::Object
	{
	public:
		::FlowCanvas::Nodes::WaitWhile* __4__this; // 0x10
