...
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_TRANSFORM_ONTRIGGERENTER2D_OFFSET UNITYSDK_OFFSET(0x1A39F820)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_TRANSFORM_ONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x1A39F960)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_TRANSFORM_ONTRIGGERSTAY2D_OFFSET UNITYSDK_OFFSET(0x1A39F8C0)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_TRANSFORM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A39F2C0)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_TRANSFORM_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A39F3E0)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_TRANSFORM_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A39F600)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_TRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A39FA00)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_TRANSFORM__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1A39FA30)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_TRANSFORM__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1A39FA40)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Trigger2DEvents_Transform_TypeDefinitionIndex = 26426;
