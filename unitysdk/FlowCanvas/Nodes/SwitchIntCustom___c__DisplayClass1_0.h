...
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1974C020)
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM___C__DISPLAYCLASS1_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1974C030)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchIntCustom___c__DisplayClass1_0_TypeDefinitionIndex = 26321;
	...
	public:
		...
		::FlowCanvas::Nodes::SwitchIntCustom* __4__this; // 0x28
