...
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_CALLBACK_OFFSET UNITYSDK_OFFSET(0x19C17A00)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_GET_DELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x19C17410)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x19C174B0)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19C17A50)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0x19C17A60)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19C174C0)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_SET_DELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x19C17430)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C17C00)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT__REGISTERPORTS_B__9_0_OFFSET UNITYSDK_OFFSET(0x19C17C20)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int DelegateCallbackEvent_TypeDefinitionIndex = 26828;
