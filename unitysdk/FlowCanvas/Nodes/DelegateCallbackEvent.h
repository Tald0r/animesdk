...
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_CALLBACK_OFFSET UNITYSDK_OFFSET(0x19749B70)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_GET_DELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x19749580)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x19749620)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19749BC0)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0x19749BD0)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19749630)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT_SET_DELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x197495A0)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19749D70)
#define FLOWCANVAS_NODES_DELEGATECALLBACKEVENT__REGISTERPORTS_B__9_0_OFFSET UNITYSDK_OFFSET(0x19749D90)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int DelegateCallbackEvent_TypeDefinitionIndex = 26449;
	...
	public:
		...
		::FlowCanvas::FlowOutput* callbackPort; // 0xB8
		::FlowCanvas::Nodes::ReflectedDelegateEvent* reflectedEvent; // 0xC0
		::FlowCanvas::ValueOutput* delegatePort; // 0xC8
