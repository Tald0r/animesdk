...
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_GETRUNTIMEICONTYPE_OFFSET UNITYSDK_OFFSET(0x1A1C17F0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_GET_CALLABLE_OFFSET UNITYSDK_OFFSET(0x1A1C1930)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_GET_EXPOSEDPARAMSCOUNT_OFFSET UNITYSDK_OFFSET(0x1A1C19B0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_GET_EXPOSEPARAMS_OFFSET UNITYSDK_OFFSET(0x1A1C1960)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1A1C1840)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1A1C17E0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_SETDEFAULTPARAMETERVALUES_OFFSET UNITYSDK_OFFSET(0x1A1C19F0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_SETDROPINSTANCEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A1C1B60)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_SET_CALLABLE_OFFSET UNITYSDK_OFFSET(0x1A1C1940)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_SET_EXPOSEDPARAMSCOUNT_OFFSET UNITYSDK_OFFSET(0x1A1C19C0)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER_SET_EXPOSEPARAMS_OFFSET UNITYSDK_OFFSET(0x1A1C1970)
#define FLOWCANVAS_NODES_REFLECTEDMETHODBASENODEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C1C10)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedMethodBaseNodeWrapper_TypeDefinitionIndex = 27413;
