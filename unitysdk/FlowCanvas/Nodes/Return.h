...
#define FLOWCANVAS_NODES_RETURN_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19FF0660)
#define FLOWCANVAS_NODES_RETURN__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF0700)
#define FLOWCANVAS_NODES_RETURN__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x19FF0720)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Return_TypeDefinitionIndex = 27465;
