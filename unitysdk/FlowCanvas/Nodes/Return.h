...
#define FLOWCANVAS_NODES_RETURN_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19A00930)
#define FLOWCANVAS_NODES_RETURN__CTOR_OFFSET UNITYSDK_OFFSET(0x19A009D0)
#define FLOWCANVAS_NODES_RETURN__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x19A009F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Return_TypeDefinitionIndex = 25778;
