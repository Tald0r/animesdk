...
#define FLOWCANVAS_NODES_EXTRACTCONTACTPOINT_INVOKE_OFFSET UNITYSDK_OFFSET(0x19DAC5E0)
#define FLOWCANVAS_NODES_EXTRACTCONTACTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAC630)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExtractContactPoint_TypeDefinitionIndex = 26627;
