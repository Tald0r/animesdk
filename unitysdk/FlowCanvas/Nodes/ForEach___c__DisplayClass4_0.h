...
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19C17DD0)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x19C17DE0)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x19C17E00)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0x19C17E20)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__3_OFFSET UNITYSDK_OFFSET(0x19C18360)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__4_OFFSET UNITYSDK_OFFSET(0x19C18340)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ForEach___c__DisplayClass4_0_TypeDefinitionIndex = 26133;
