...
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19749F40)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x19749F50)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x19749F70)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0x19749F90)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__3_OFFSET UNITYSDK_OFFSET(0x1974A4D0)
#define FLOWCANVAS_NODES_FOREACH___C__DISPLAYCLASS4_0__REGISTERPORTS_B__4_OFFSET UNITYSDK_OFFSET(0x1974A4B0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ForEach___c__DisplayClass4_0_TypeDefinitionIndex = 26503;

	class ForEach___c__DisplayClass4_0 : public ::System::Object
	{
	public:
		::FlowCanvas::FlowOutput* fCurrent; // 0x10
		::FlowCanvas::Nodes::ForEach* __4__this; // 0x18
		::FlowCanvas::FlowBreak* __9__4; // 0x20
		::FlowCanvas::FlowOutput* fFinish; // 0x28
