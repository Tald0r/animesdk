...
#define FLOWCANVAS_NODES_STARTEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A602130)
#define FLOWCANVAS_NODES_STARTEVENT_ONSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A602400)
#define FLOWCANVAS_NODES_STARTEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A6024A0)
#define FLOWCANVAS_NODES_STARTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6024F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int StartEvent_TypeDefinitionIndex = 26807;
