...
#define FLOWCANVAS_NODES_OWNERVARIABLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1974A9C0)
#define FLOWCANVAS_NODES_OWNERVARIABLE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1974AA00)
#define FLOWCANVAS_NODES_OWNERVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1974AA80)
#define FLOWCANVAS_NODES_OWNERVARIABLE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x1974AAA0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int OwnerVariable_TypeDefinitionIndex = 26242;
