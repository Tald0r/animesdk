...
#define FLOWCANVAS_NODES_OWNERVARIABLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19C18850)
#define FLOWCANVAS_NODES_OWNERVARIABLE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19C18890)
#define FLOWCANVAS_NODES_OWNERVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C18910)
#define FLOWCANVAS_NODES_OWNERVARIABLE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x19C18930)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int OwnerVariable_TypeDefinitionIndex = 27051;
