...
#define FLOWCANVAS_NODES_VECTOR3DIVIDE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E04B50)
#define FLOWCANVAS_NODES_VECTOR3DIVIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E04B80)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Vector3Divide_TypeDefinitionIndex = 26266;
