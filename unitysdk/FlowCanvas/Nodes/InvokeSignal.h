...
#define FLOWCANVAS_NODES_INVOKESIGNAL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A261500)
#define FLOWCANVAS_NODES_INVOKESIGNAL_GET_SIGNALDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A261440)
#define FLOWCANVAS_NODES_INVOKESIGNAL_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A261780)
#define FLOWCANVAS_NODES_INVOKESIGNAL_SETTARGET_OFFSET UNITYSDK_OFFSET(0x1A2616C0)
#define FLOWCANVAS_NODES_INVOKESIGNAL_SET_SIGNALDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A2614A0)
#define FLOWCANVAS_NODES_INVOKESIGNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A261BC0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int InvokeSignal_TypeDefinitionIndex = 26533;
