...
#define FLOWCANVAS_NODES_INTEGERMODULO_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C79CB0)
#define FLOWCANVAS_NODES_INTEGERMODULO__CTOR_OFFSET UNITYSDK_OFFSET(0x19C79CC0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int IntegerModulo_TypeDefinitionIndex = 26758;
