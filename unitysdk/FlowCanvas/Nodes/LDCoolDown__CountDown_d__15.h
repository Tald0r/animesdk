...
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x87CE7C0)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x87CEA90)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x87CEAF0)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x87CEAA0)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x87CE7B0)
#define FLOWCANVAS_NODES_LDCOOLDOWN__COUNTDOWN_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x87CE7A0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCoolDown__CountDown_d__15_TypeDefinitionIndex = 37746;

	class LDCoolDown__CountDown_d__15 : public ::System::Object
	{
	public:
		::FlowCanvas::Flow f; // 0x10
		::FlowCanvas::Nodes::LDCoolDown* __4__this; // 0x38
