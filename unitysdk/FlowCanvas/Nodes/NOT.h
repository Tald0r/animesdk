...
#define FLOWCANVAS_NODES_NOT_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C18820)
#define FLOWCANVAS_NODES_NOT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C18830)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int NOT_TypeDefinitionIndex = 27719;
