...
#define FLOWCANVAS_NODES_CODEEVENT_CALL_OFFSET UNITYSDK_OFFSET(0x1A1BF750)
#define FLOWCANVAS_NODES_CODEEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A1BF520)
#define FLOWCANVAS_NODES_CODEEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A1BF420)
#define FLOWCANVAS_NODES_CODEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A1BF710)
#define FLOWCANVAS_NODES_CODEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1BF790)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CodeEvent_TypeDefinitionIndex = 26757;
