...
#define FLOWCANVAS_NODES_EXTRACTCONTACTPOINT2D_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C78E80)
#define FLOWCANVAS_NODES_EXTRACTCONTACTPOINT2D__CTOR_OFFSET UNITYSDK_OFFSET(0x19C78FD0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExtractContactPoint2D_TypeDefinitionIndex = 25446;
