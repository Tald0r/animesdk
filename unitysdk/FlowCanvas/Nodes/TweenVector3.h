...
#define FLOWCANVAS_NODES_TWEENVECTOR3_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A5634F0)
#define FLOWCANVAS_NODES_TWEENVECTOR3_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A563520)
#define FLOWCANVAS_NODES_TWEENVECTOR3_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A563510)
#define FLOWCANVAS_NODES_TWEENVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5635B0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenVector3_TypeDefinitionIndex = 26028;
