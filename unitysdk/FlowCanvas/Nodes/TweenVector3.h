...
#define FLOWCANVAS_NODES_TWEENVECTOR3_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19F526E0)
#define FLOWCANVAS_NODES_TWEENVECTOR3_INVOKE_OFFSET UNITYSDK_OFFSET(0x19F52710)
#define FLOWCANVAS_NODES_TWEENVECTOR3_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19F52700)
#define FLOWCANVAS_NODES_TWEENVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x19F527A0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenVector3_TypeDefinitionIndex = 26161;
