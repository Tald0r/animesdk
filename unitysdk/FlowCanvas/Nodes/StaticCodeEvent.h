...
#define FLOWCANVAS_NODES_STATICCODEEVENT_CALL_OFFSET UNITYSDK_OFFSET(0x19FE96A0)
#define FLOWCANVAS_NODES_STATICCODEEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19FE9470)
#define FLOWCANVAS_NODES_STATICCODEEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19FE9560)
#define FLOWCANVAS_NODES_STATICCODEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19FE96E0)
#define FLOWCANVAS_NODES_STATICCODEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE9720)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int StaticCodeEvent_TypeDefinitionIndex = 25588;
