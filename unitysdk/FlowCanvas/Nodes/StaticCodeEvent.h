...
#define FLOWCANVAS_NODES_STATICCODEEVENT_CALL_OFFSET UNITYSDK_OFFSET(0x1A602740)
#define FLOWCANVAS_NODES_STATICCODEEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A602510)
#define FLOWCANVAS_NODES_STATICCODEEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A602600)
#define FLOWCANVAS_NODES_STATICCODEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A602780)
#define FLOWCANVAS_NODES_STATICCODEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6027C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int StaticCodeEvent_TypeDefinitionIndex = 27177;
