...
#define FLOWCANVAS_NODES_LERPFLOAT_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C79CE0)
#define FLOWCANVAS_NODES_LERPFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C79E20)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LerpFloat_TypeDefinitionIndex = 25813;
