...
#define FLOWCANVAS_NODES_LERPFLOAT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A21B480)
#define FLOWCANVAS_NODES_LERPFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A21B5C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LerpFloat_TypeDefinitionIndex = 26375;
