...
#define FLOWCANVAS_NODES_WAITFORONEFRAME_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x1A39FFB0)
#define FLOWCANVAS_NODES_WAITFORONEFRAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A39FFC0)
#define FLOWCANVAS_NODES_WAITFORONEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A0000)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForOneFrame_TypeDefinitionIndex = 26723;
