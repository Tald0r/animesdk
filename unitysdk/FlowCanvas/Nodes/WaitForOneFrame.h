...
#define FLOWCANVAS_NODES_WAITFORONEFRAME_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x19DAED50)
#define FLOWCANVAS_NODES_WAITFORONEFRAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x19DAED60)
#define FLOWCANVAS_NODES_WAITFORONEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAEDA0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForOneFrame_TypeDefinitionIndex = 26668;
