...
#define FLOWCANVAS_NODES_COLLISIONEVENTS_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x19C789F0)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x19C78B10)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_ONCOLLISIONSTAY_OFFSET UNITYSDK_OFFSET(0x19C78A80)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19C78420)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19C785D0)
#define FLOWCANVAS_NODES_COLLISIONEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19C787E0)
#define FLOWCANVAS_NODES_COLLISIONEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C78BA0)
#define FLOWCANVAS_NODES_COLLISIONEVENTS__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x19C78BD0)
#define FLOWCANVAS_NODES_COLLISIONEVENTS__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x19C78BE0)
#define FLOWCANVAS_NODES_COLLISIONEVENTS__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x19C78C00)
#define FLOWCANVAS_NODES_COLLISIONEVENTS__REGISTERPORTS_B__5_3_OFFSET UNITYSDK_OFFSET(0x19C78C90)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CollisionEvents_TypeDefinitionIndex = 26539;
