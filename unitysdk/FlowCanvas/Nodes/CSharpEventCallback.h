...
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_CALLBACK_OFFSET UNITYSDK_OFFSET(0x19C161F0)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_GETNODEWILDDEFINITIONTYPE_OFFSET UNITYSDK_OFFSET(0x19C16240)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_GET_AUTOHANDLEREGISTRATION_OFFSET UNITYSDK_OFFSET(0x19C15A90)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19C159F0)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x19C15AA0)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19C15AB0)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19C15BE0)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0x19C16270)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19C15CF0)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_REGISTER_OFFSET UNITYSDK_OFFSET(0x19C15AC0)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x19C15A10)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x19C15C10)
#define FLOWCANVAS_NODES_CSHARPEVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19C16410)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CSharpEventCallback_TypeDefinitionIndex = 26455;

	class CSharpEventCallback : public ::FlowCanvas::Nodes::EventNode
	{
	public:
		::FlowCanvas::FlowOutput* flowCallback; // 0xA8
		::Il2CppArray<::System::Object*>* argValues; // 0xB0
		::FlowCanvas::Nodes::ReflectedDelegateEvent* reflectedEvent; // 0xB8
		::FlowCanvas::ValueInput* eventInput; // 0xC0
