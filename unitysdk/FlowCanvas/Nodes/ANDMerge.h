...
#define FLOWCANVAS_NODES_ANDMERGE_CHECK_OFFSET UNITYSDK_OFFSET(0x19C15870)
#define FLOWCANVAS_NODES_ANDMERGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19C15750)
#define FLOWCANVAS_NODES_ANDMERGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C15970)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ANDMerge_TypeDefinitionIndex = 27623;
