...
#define FLOWCANVAS_NODES_ANDMERGE_CHECK_OFFSET UNITYSDK_OFFSET(0x197479F0)
#define FLOWCANVAS_NODES_ANDMERGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x197478D0)
#define FLOWCANVAS_NODES_ANDMERGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19747AF0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ANDMerge_TypeDefinitionIndex = 25886;
