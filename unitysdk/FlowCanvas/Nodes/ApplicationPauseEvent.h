...
#define FLOWCANVAS_NODES_APPLICATIONPAUSEEVENT_APPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x19258590)
#define FLOWCANVAS_NODES_APPLICATIONPAUSEEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x192583F0)
#define FLOWCANVAS_NODES_APPLICATIONPAUSEEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x192584C0)
#define FLOWCANVAS_NODES_APPLICATIONPAUSEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x192585E0)
#define FLOWCANVAS_NODES_APPLICATIONPAUSEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19258670)
#define FLOWCANVAS_NODES_APPLICATIONPAUSEEVENT__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x19258690)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ApplicationPauseEvent_TypeDefinitionIndex = 26682;
