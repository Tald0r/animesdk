...
#define FLOWCANVAS_NODES_SIGNALCALLBACK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A07FD90)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_GET_SIGNALDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A07FCD0)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A080580)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A080370)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_ONINVOKED_OFFSET UNITYSDK_OFFSET(0x1A080AE0)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A080060)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A080780)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_SETTARGET_OFFSET UNITYSDK_OFFSET(0x1A07FF80)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_SET_SIGNALDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A07FD30)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A080040)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A080050)
#define FLOWCANVAS_NODES_SIGNALCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A080D30)
#define FLOWCANVAS_NODES_SIGNALCALLBACK__REGISTERPORTS_B__16_0_OFFSET UNITYSDK_OFFSET(0x1A080D60)
#define FLOWCANVAS_NODES_SIGNALCALLBACK__REGISTERPORTS_B__16_1_OFFSET UNITYSDK_OFFSET(0x1A080D70)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SignalCallback_TypeDefinitionIndex = 25623;

	class SignalCallback : public ::FlowCanvas::Nodes::RouterEventNode_1<::UnityEngine::Transform*>
	{
	public:
		::UnityEngine::Transform* sender; // 0xC0
