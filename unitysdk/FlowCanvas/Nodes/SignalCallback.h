...
#define FLOWCANVAS_NODES_SIGNALCALLBACK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A652920)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_GET_SIGNALDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A652860)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A653110)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A652F00)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_ONINVOKED_OFFSET UNITYSDK_OFFSET(0x1A653670)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A652BF0)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A653310)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_SETTARGET_OFFSET UNITYSDK_OFFSET(0x1A652B10)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_SET_SIGNALDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A6528C0)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A652BD0)
#define FLOWCANVAS_NODES_SIGNALCALLBACK_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A652BE0)
#define FLOWCANVAS_NODES_SIGNALCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6538C0)
#define FLOWCANVAS_NODES_SIGNALCALLBACK__REGISTERPORTS_B__16_0_OFFSET UNITYSDK_OFFSET(0x1A6538F0)
#define FLOWCANVAS_NODES_SIGNALCALLBACK__REGISTERPORTS_B__16_1_OFFSET UNITYSDK_OFFSET(0x1A653900)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SignalCallback_TypeDefinitionIndex = 26550;

	class SignalCallback : public ::FlowCanvas::Nodes::RouterEventNode_1<::UnityEngine::Transform*>
	{
	public:
		::NodeCanvas::Framework::BBParameter_1<::NodeCanvas::Framework::SignalDefinition*>* _signalDefinition; // 0xC0
