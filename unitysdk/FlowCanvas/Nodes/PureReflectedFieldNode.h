...
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1974AD50)
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE_INITINTERNAL_OFFSET UNITYSDK_OFFSET(0x1974AC60)
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1974ADD0)
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1974AC80)
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1974B0E0)
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x1974B0F0)
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE__REGISTERPORTS_B__7_1_OFFSET UNITYSDK_OFFSET(0x1974B100)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int PureReflectedFieldNode_TypeDefinitionIndex = 25125;

	class PureReflectedFieldNode : public ::FlowCanvas::Nodes::BaseReflectedFieldNode
	{
	public:
		::System::Object* valueObject; // 0x88
		::FlowCanvas::ValueInput* valueInput; // 0x90
