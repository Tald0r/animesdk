...
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x19C18BE0)
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE_INITINTERNAL_OFFSET UNITYSDK_OFFSET(0x19C18AF0)
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19C18C50)
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x19C18B10)
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C18F50)
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x19C18F60)
#define FLOWCANVAS_NODES_PUREREFLECTEDFIELDNODE__REGISTERPORTS_B__7_1_OFFSET UNITYSDK_OFFSET(0x19C18F70)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int PureReflectedFieldNode_TypeDefinitionIndex = 26414;

	class PureReflectedFieldNode : public ::FlowCanvas::Nodes::BaseReflectedFieldNode
	{
	public:
		::FlowCanvas::ValueInput* valueInput; // 0x88
		::System::Object* instanceObject; // 0x90
		::FlowCanvas::ValueInput* instanceInput; // 0x98
		::System::Object* valueObject; // 0xA0
