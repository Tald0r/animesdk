...
#define FLOWCANVAS_NODES_TASKCONDITION_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x19C1A060)
#define FLOWCANVAS_NODES_TASKCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19C1A040)
#define FLOWCANVAS_NODES_TASKCONDITION_NODECANVAS_FRAMEWORK_ITASKASSIGNABLE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x19C1A080)
#define FLOWCANVAS_NODES_TASKCONDITION_NODECANVAS_FRAMEWORK_ITASKASSIGNABLE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x19C1A090)
#define FLOWCANVAS_NODES_TASKCONDITION_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19C1A100)
#define FLOWCANVAS_NODES_TASKCONDITION_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19C1A200)
#define FLOWCANVAS_NODES_TASKCONDITION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19C1A240)
#define FLOWCANVAS_NODES_TASKCONDITION_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x19C1A070)
#define FLOWCANVAS_NODES_TASKCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19C1A2B0)
#define FLOWCANVAS_NODES_TASKCONDITION__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x19C1A2D0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TaskCondition_TypeDefinitionIndex = 27725;
