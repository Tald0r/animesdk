...
#define FLOWCANVAS_NODES_TASKCONDITION_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1974C200)
#define FLOWCANVAS_NODES_TASKCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1974C1E0)
#define FLOWCANVAS_NODES_TASKCONDITION_NODECANVAS_FRAMEWORK_ITASKASSIGNABLE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1974C220)
#define FLOWCANVAS_NODES_TASKCONDITION_NODECANVAS_FRAMEWORK_ITASKASSIGNABLE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1974C230)
#define FLOWCANVAS_NODES_TASKCONDITION_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1974C2A0)
#define FLOWCANVAS_NODES_TASKCONDITION_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1974C3A0)
#define FLOWCANVAS_NODES_TASKCONDITION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1974C3E0)
#define FLOWCANVAS_NODES_TASKCONDITION_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1974C210)
#define FLOWCANVAS_NODES_TASKCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1974C450)
#define FLOWCANVAS_NODES_TASKCONDITION__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x1974C470)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TaskCondition_TypeDefinitionIndex = 26077;
