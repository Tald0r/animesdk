...
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME__INVOKE_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A2638F0)
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A263940)
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A2639A0)
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A263950)
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME__INVOKE_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A2638E0)
#define FLOWCANVAS_NODES_WAITFORENDOFFRAME__INVOKE_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2638D0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForEndOfFrame__Invoke_d__2_TypeDefinitionIndex = 25164;
