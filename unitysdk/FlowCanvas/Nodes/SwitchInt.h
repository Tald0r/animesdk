...
#define FLOWCANVAS_NODES_SWITCHINT_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x183DE340)
#define FLOWCANVAS_NODES_SWITCHINT_ISCHOICENODE_OFFSET UNITYSDK_OFFSET(0x183DE520)
#define FLOWCANVAS_NODES_SWITCHINT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x183DE360)
#define FLOWCANVAS_NODES_SWITCHINT_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x183DE350)
#define FLOWCANVAS_NODES_SWITCHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x183DE530)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchInt_TypeDefinitionIndex = 26086;
