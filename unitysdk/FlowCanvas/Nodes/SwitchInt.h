...
#define FLOWCANVAS_NODES_SWITCHINT_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1917AFD0)
#define FLOWCANVAS_NODES_SWITCHINT_ISCHOICENODE_OFFSET UNITYSDK_OFFSET(0x1917B1B0)
#define FLOWCANVAS_NODES_SWITCHINT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1917AFF0)
#define FLOWCANVAS_NODES_SWITCHINT_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1917AFE0)
#define FLOWCANVAS_NODES_SWITCHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1917B1C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchInt_TypeDefinitionIndex = 26500;
