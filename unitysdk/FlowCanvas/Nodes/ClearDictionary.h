...
#define FLOWCANVAS_NODES_CLEARDICTIONARY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A1772C0)
#define FLOWCANVAS_NODES_CLEARDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A177380)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ClearDictionary_TypeDefinitionIndex = 26198;
