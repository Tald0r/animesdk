...
#define FLOWCANVAS_NODES_SWITCHMACROLOCALENUM_ISCHOICENODE_OFFSET UNITYSDK_OFFSET(0x1A3F20A0)
#define FLOWCANVAS_NODES_SWITCHMACROLOCALENUM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A3F1CE0)
#define FLOWCANVAS_NODES_SWITCHMACROLOCALENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F20B0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchMacroLocalEnum_TypeDefinitionIndex = 27728;
