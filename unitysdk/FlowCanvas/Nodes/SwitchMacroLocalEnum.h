...
#define FLOWCANVAS_NODES_SWITCHMACROLOCALENUM_ISCHOICENODE_OFFSET UNITYSDK_OFFSET(0x19E03820)
#define FLOWCANVAS_NODES_SWITCHMACROLOCALENUM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19E03460)
#define FLOWCANVAS_NODES_SWITCHMACROLOCALENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x19E03830)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchMacroLocalEnum_TypeDefinitionIndex = 25129;
