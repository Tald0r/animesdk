...
#define FLOWCANVAS_NODES_FLOATGREATERTHAN_INVOKE_OFFSET UNITYSDK_OFFSET(0x19F506B0)
#define FLOWCANVAS_NODES_FLOATGREATERTHAN__CTOR_OFFSET UNITYSDK_OFFSET(0x19F506C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatGreaterThan_TypeDefinitionIndex = 26100;
