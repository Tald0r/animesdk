...
#define FLOWCANVAS_NODES_CALLABLEFUNCTIONNODEBASE_CALLOUTPUTCALL_OFFSET UNITYSDK_OFFSET(0x19F502D0)
#define FLOWCANVAS_NODES_CALLABLEFUNCTIONNODEBASE_ISCOULDOUTCALL_OFFSET UNITYSDK_OFFSET(0x19F502C0)
#define FLOWCANVAS_NODES_CALLABLEFUNCTIONNODEBASE_ONCALLOUTPUTCALL_OFFSET UNITYSDK_OFFSET(0x19F503E0)
#define FLOWCANVAS_NODES_CALLABLEFUNCTIONNODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F503F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CallableFunctionNodeBase_TypeDefinitionIndex = 26398;
