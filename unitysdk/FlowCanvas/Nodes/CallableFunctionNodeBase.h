...
#define FLOWCANVAS_NODES_CALLABLEFUNCTIONNODEBASE_CALLOUTPUTCALL_OFFSET UNITYSDK_OFFSET(0x1A561080)
#define FLOWCANVAS_NODES_CALLABLEFUNCTIONNODEBASE_ISCOULDOUTCALL_OFFSET UNITYSDK_OFFSET(0x1A561070)
#define FLOWCANVAS_NODES_CALLABLEFUNCTIONNODEBASE_ONCALLOUTPUTCALL_OFFSET UNITYSDK_OFFSET(0x1A561190)
#define FLOWCANVAS_NODES_CALLABLEFUNCTIONNODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5611A0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CallableFunctionNodeBase_TypeDefinitionIndex = 27340;
