...
#define FLOWCANVAS_NODES_LATENTACTIONNODE_ONREGISTERDERIVEDPORTS_OFFSET UNITYSDK_OFFSET(0x1A07F060)
#define FLOWCANVAS_NODES_LATENTACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A07F120)
#define FLOWCANVAS_NODES_LATENTACTIONNODE__ONREGISTERDERIVEDPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x1A07F130)
#define FLOWCANVAS_NODES_LATENTACTIONNODE__ONREGISTERDERIVEDPORTS_B__1_1_OFFSET UNITYSDK_OFFSET(0x1A07F180)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LatentActionNode_TypeDefinitionIndex = 26371;
