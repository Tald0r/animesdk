...
#define FLOWCANVAS_NODES_LATENTACTIONNODE_ONREGISTERDERIVEDPORTS_OFFSET UNITYSDK_OFFSET(0x1A651BF0)
#define FLOWCANVAS_NODES_LATENTACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A651CB0)
#define FLOWCANVAS_NODES_LATENTACTIONNODE__ONREGISTERDERIVEDPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x1A651CC0)
#define FLOWCANVAS_NODES_LATENTACTIONNODE__ONREGISTERDERIVEDPORTS_B__1_1_OFFSET UNITYSDK_OFFSET(0x1A651D10)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LatentActionNode_TypeDefinitionIndex = 26431;
