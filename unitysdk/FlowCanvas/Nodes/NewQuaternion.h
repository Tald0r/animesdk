...
#define FLOWCANVAS_NODES_NEWQUATERNION_INVOKE_OFFSET UNITYSDK_OFFSET(0x19258810)
#define FLOWCANVAS_NODES_NEWQUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x19258840)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int NewQuaternion_TypeDefinitionIndex = 25982;
