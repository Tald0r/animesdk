...
#define FLOWCANVAS_NODES_INTEGERGREATERTHAN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A828D20)
#define FLOWCANVAS_NODES_INTEGERGREATERTHAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A828D30)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int IntegerGreaterThan_TypeDefinitionIndex = 27362;
