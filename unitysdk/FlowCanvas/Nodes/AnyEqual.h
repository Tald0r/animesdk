...
#define FLOWCANVAS_NODES_ANYEQUAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A117E20)
#define FLOWCANVAS_NODES_ANYEQUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A117E30)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int AnyEqual_TypeDefinitionIndex = 26938;
