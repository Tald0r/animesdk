...
#define FLOWCANVAS_NODES_TASKACTION_DOUPDATE_OFFSET UNITYSDK_OFFSET(0x19258EE0)
#define FLOWCANVAS_NODES_TASKACTION_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x19258CD0)
#define FLOWCANVAS_NODES_TASKACTION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19258CB0)
#define FLOWCANVAS_NODES_TASKACTION_NODECANVAS_FRAMEWORK_ITASKASSIGNABLE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x19258D00)
#define FLOWCANVAS_NODES_TASKACTION_NODECANVAS_FRAMEWORK_ITASKASSIGNABLE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x19258D10)
#define FLOWCANVAS_NODES_TASKACTION_ONGRAPHPAUSED_OFFSET UNITYSDK_OFFSET(0x19258E20)
#define FLOWCANVAS_NODES_TASKACTION_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19258DA0)
#define FLOWCANVAS_NODES_TASKACTION_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19258DB0)
#define FLOWCANVAS_NODES_TASKACTION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19258E50)
#define FLOWCANVAS_NODES_TASKACTION_SET_ACTION_OFFSET UNITYSDK_OFFSET(0x19258CE0)
#define FLOWCANVAS_NODES_TASKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19258F40)
#define FLOWCANVAS_NODES_TASKACTION__REGISTERPORTS_B__14_0_OFFSET UNITYSDK_OFFSET(0x19258F60)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TaskAction_TypeDefinitionIndex = 25546;
	...
	public:
		...
		::NodeCanvas::Framework::ActionTask* _action; // 0xB8
