...
#define FLOWCANVAS_NODES_TASKACTION_DOUPDATE_OFFSET UNITYSDK_OFFSET(0x196D5490)
#define FLOWCANVAS_NODES_TASKACTION_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x196D5280)
#define FLOWCANVAS_NODES_TASKACTION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x196D5260)
#define FLOWCANVAS_NODES_TASKACTION_NODECANVAS_FRAMEWORK_ITASKASSIGNABLE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x196D52B0)
#define FLOWCANVAS_NODES_TASKACTION_NODECANVAS_FRAMEWORK_ITASKASSIGNABLE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x196D52C0)
#define FLOWCANVAS_NODES_TASKACTION_ONGRAPHPAUSED_OFFSET UNITYSDK_OFFSET(0x196D53D0)
#define FLOWCANVAS_NODES_TASKACTION_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x196D5350)
#define FLOWCANVAS_NODES_TASKACTION_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x196D5360)
#define FLOWCANVAS_NODES_TASKACTION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x196D5400)
#define FLOWCANVAS_NODES_TASKACTION_SET_ACTION_OFFSET UNITYSDK_OFFSET(0x196D5290)
#define FLOWCANVAS_NODES_TASKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x196D54F0)
#define FLOWCANVAS_NODES_TASKACTION__REGISTERPORTS_B__14_0_OFFSET UNITYSDK_OFFSET(0x196D5510)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TaskAction_TypeDefinitionIndex = 27188;
