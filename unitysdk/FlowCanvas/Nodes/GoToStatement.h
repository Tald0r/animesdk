...
#define FLOWCANVAS_NODES_GOTOSTATEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A39DFA0)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1A39DF40)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_NODECANVAS_FRAMEWORK_IHAVENODEREFERENCE_GET_TARGETREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A39DF30)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A39E180)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_SETTARGET_OFFSET UNITYSDK_OFFSET(0x1A39E0E0)
#define FLOWCANVAS_NODES_GOTOSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A39E1F0)
#define FLOWCANVAS_NODES_GOTOSTATEMENT__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x1A39E210)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int GoToStatement_TypeDefinitionIndex = 26948;
