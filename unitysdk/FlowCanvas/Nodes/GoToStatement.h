...
#define FLOWCANVAS_NODES_GOTOSTATEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19DACD80)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x19DACD20)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_NODECANVAS_FRAMEWORK_IHAVENODEREFERENCE_GET_TARGETREFERENCE_OFFSET UNITYSDK_OFFSET(0x19DACD10)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19DACF60)
#define FLOWCANVAS_NODES_GOTOSTATEMENT_SETTARGET_OFFSET UNITYSDK_OFFSET(0x19DACEC0)
#define FLOWCANVAS_NODES_GOTOSTATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19DACFD0)
#define FLOWCANVAS_NODES_GOTOSTATEMENT__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x19DACFF0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int GoToStatement_TypeDefinitionIndex = 26009;
