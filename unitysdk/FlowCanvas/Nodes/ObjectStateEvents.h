...
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19F51090)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19F51000)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19F50F70)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19F50A80)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19F50B50)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19F50D60)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x19F51120)
#define FLOWCANVAS_NODES_OBJECTSTATEEVENTS__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x19F51150)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ObjectStateEvents_TypeDefinitionIndex = 26045;
	...
	public:
		...
		::FlowCanvas::FlowOutput* onEnable; // 0xC8
		::FlowCanvas::FlowOutput* onDisable; // 0xD0
		::UnityEngine::GameObject* receiver; // 0xD8
