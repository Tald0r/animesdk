...
#define FLOWCANVAS_NODES_MULTITOGGLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19E02E20)
#define FLOWCANVAS_NODES_MULTITOGGLE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19E02EC0)
#define FLOWCANVAS_NODES_MULTITOGGLE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19E02EF0)
#define FLOWCANVAS_NODES_MULTITOGGLE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19E02F00)
#define FLOWCANVAS_NODES_MULTITOGGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E03150)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int MultiToggle_TypeDefinitionIndex = 25379;

	class MultiToggle : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::System::Int32 current; // 0xA8
		::System::Int32 original; // 0xAC
