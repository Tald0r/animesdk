...
#define FLOWCANVAS_NODES_MULTITOGGLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A3F1690)
#define FLOWCANVAS_NODES_MULTITOGGLE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A3F1730)
#define FLOWCANVAS_NODES_MULTITOGGLE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A3F1760)
#define FLOWCANVAS_NODES_MULTITOGGLE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A3F1770)
#define FLOWCANVAS_NODES_MULTITOGGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F19D0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int MultiToggle_TypeDefinitionIndex = 26907;
