...
#define FLOWCANVAS_NODES_XORMERGE_CHECK_OFFSET UNITYSDK_OFFSET(0x192592B0)
#define FLOWCANVAS_NODES_XORMERGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19259190)
#define FLOWCANVAS_NODES_XORMERGE__CTOR_OFFSET UNITYSDK_OFFSET(0x192593A0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int XORMerge_TypeDefinitionIndex = 26159;
