...
#define FLOWCANVAS_NODES_XORMERGE_CHECK_OFFSET UNITYSDK_OFFSET(0x196D5860)
#define FLOWCANVAS_NODES_XORMERGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x196D5740)
#define FLOWCANVAS_NODES_XORMERGE__CTOR_OFFSET UNITYSDK_OFFSET(0x196D5950)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int XORMerge_TypeDefinitionIndex = 26666;
