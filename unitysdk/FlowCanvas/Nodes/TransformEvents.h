...
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x19F520B0)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x19F51FF0)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19F51BC0)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19F51D10)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19F51E80)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x19F52170)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x19F521A0)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x19F521B0)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x19F521C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TransformEvents_TypeDefinitionIndex = 25139;

	class TransformEvents : public ::FlowCanvas::Nodes::RouterEventNode_1<::UnityEngine::Transform*>
	{
	public:
		::UnityEngine::Transform* receiver; // 0xC0
		::FlowCanvas::FlowOutput* onParentChanged; // 0xC8
		::System::Collections::Generic::IEnumerable_1<::UnityEngine::Transform*>* children; // 0xD0
		::FlowCanvas::FlowOutput* onChildrenChanged; // 0xD8
