...
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x1A562EC0)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A562E00)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A5629B0)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A562B00)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A562C80)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A562F80)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1A562FB0)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1A562FC0)
#define FLOWCANVAS_NODES_TRANSFORMEVENTS__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x1A562FD0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TransformEvents_TypeDefinitionIndex = 27424;

	class TransformEvents : public ::FlowCanvas::Nodes::RouterEventNode_1<::UnityEngine::Transform*>
	{
	public:
		::UnityEngine::Transform* receiver; // 0xC0
		::UnityEngine::Transform* parent; // 0xC8
