...
#define FLOWCANVAS_NODES_SENDEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x183DDBD0)
#define FLOWCANVAS_NODES_SENDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x183DDC00)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SendEvent_TypeDefinitionIndex = 26634;
