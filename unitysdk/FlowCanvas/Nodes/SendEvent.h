...
#define FLOWCANVAS_NODES_SENDEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1917A8A0)
#define FLOWCANVAS_NODES_SENDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1917A8D0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SendEvent_TypeDefinitionIndex = 27537;
