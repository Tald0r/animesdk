...
#define FLOWCANVAS_NODES_EVENTUNIVERSALDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A71FED0)
#define FLOWCANVAS_NODES_EVENTUNIVERSALDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A71FF00)
#define FLOWCANVAS_NODES_EVENTUNIVERSALDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A71FC30)
#define FLOWCANVAS_NODES_EVENTUNIVERSALDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A71FC10)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int EventUniversalDelegate_TypeDefinitionIndex = 26714;
