...
#define FLOWCANVAS_NODES_INTEGERADD_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C79C20)
#define FLOWCANVAS_NODES_INTEGERADD__CTOR_OFFSET UNITYSDK_OFFSET(0x19C79C30)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int IntegerAdd_TypeDefinitionIndex = 26317;
