...
#define FLOWCANVAS_NODES_TWEENVECTOR3__INVOKE_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A3F31C0)
#define FLOWCANVAS_NODES_TWEENVECTOR3__INVOKE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3F3360)
#define FLOWCANVAS_NODES_TWEENVECTOR3__INVOKE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3F33C0)
#define FLOWCANVAS_NODES_TWEENVECTOR3__INVOKE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A3F3370)
#define FLOWCANVAS_NODES_TWEENVECTOR3__INVOKE_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A3F31B0)
#define FLOWCANVAS_NODES_TWEENVECTOR3__INVOKE_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F31A0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenVector3__Invoke_d__4_TypeDefinitionIndex = 26029;
	...
	public:
		...
		::ParadoxNotion::Animation::EaseType interpolation; // 0x24
		::UnityEngine::Vector3 to; // 0x28
