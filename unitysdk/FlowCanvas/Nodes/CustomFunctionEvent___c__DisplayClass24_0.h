...
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A21A4B0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONEVENT___C__DISPLAYCLASS24_0__INVOKEASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1A21A4C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomFunctionEvent___c__DisplayClass24_0_TypeDefinitionIndex = 27163;

	class CustomFunctionEvent___c__DisplayClass24_0 : public ::System::Object
	{
	public:
		::FlowCanvas::FlowHandler* flowCallback; // 0x10
