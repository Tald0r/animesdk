...
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A654610)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A654520)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A654800)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A654720)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A654850)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1A654880)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1A6548E0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UIDropdownEvent_TypeDefinitionIndex = 27545;
