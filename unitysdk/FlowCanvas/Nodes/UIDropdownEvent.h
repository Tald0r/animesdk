...
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A081A50)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A081960)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A081C40)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A081B60)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A081C90)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1A081CC0)
#define FLOWCANVAS_NODES_UIDROPDOWNEVENT__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1A081D20)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UIDropdownEvent_TypeDefinitionIndex = 25478;
