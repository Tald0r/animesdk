...
#define FLOWCANVAS_NODES_ANDMERGE___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1AA9F0)
#define FLOWCANVAS_NODES_ANDMERGE___C__DISPLAYCLASS4_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1A1AAA00)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ANDMerge___c__DisplayClass4_0_TypeDefinitionIndex = 25887;
