...
#define FLOWCANVAS_NODES_ANDMERGE___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A117DC0)
#define FLOWCANVAS_NODES_ANDMERGE___C__DISPLAYCLASS4_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1A117DD0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ANDMerge___c__DisplayClass4_0_TypeDefinitionIndex = 27624;
