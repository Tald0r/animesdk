...
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19157D80)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19157E50)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19157FC0)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19158180)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT_ONVARIABLEREFCHANGE_OFFSET UNITYSDK_OFFSET(0x191581D0)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x191580A0)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19158240)
#define FLOWCANVAS_NODES_VARIABLECHANGEDEVENT__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x19158260)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int VariableChangedEvent_TypeDefinitionIndex = 26306;

	class VariableChangedEvent : public ::FlowCanvas::Nodes::EventNode
	{
	public:
		::NodeCanvas::Framework::Internal::BBObjectParameter* targetVariable; // 0xA8
