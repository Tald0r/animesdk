...
#define FLOWCANVAS_NODES_INPUTCUSTOMAXISEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1974A4F0)
#define FLOWCANVAS_NODES_INPUTCUSTOMAXISEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1974A710)
#define FLOWCANVAS_NODES_INPUTCUSTOMAXISEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1974A720)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int InputCustomAxisEvent_TypeDefinitionIndex = 25714;
