...
#define FLOWCANVAS_NODES_WAIT_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x1A178DE0)
#define FLOWCANVAS_NODES_WAIT_GET_TIMELEFT_OFFSET UNITYSDK_OFFSET(0x1A178DC0)
#define FLOWCANVAS_NODES_WAIT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A178E00)
#define FLOWCANVAS_NODES_WAIT_SET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x1A178DF0)
#define FLOWCANVAS_NODES_WAIT_SET_TIMELEFT_OFFSET UNITYSDK_OFFSET(0x1A178DD0)
#define FLOWCANVAS_NODES_WAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A178E60)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Wait_TypeDefinitionIndex = 26492;
