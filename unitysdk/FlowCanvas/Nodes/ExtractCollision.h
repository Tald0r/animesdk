...
#define FLOWCANVAS_NODES_EXTRACTCOLLISION_INVOKE_OFFSET UNITYSDK_OFFSET(0x199FF380)
#define FLOWCANVAS_NODES_EXTRACTCOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0x199FF480)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExtractCollision_TypeDefinitionIndex = 26335;
