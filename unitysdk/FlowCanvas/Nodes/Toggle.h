...
#define FLOWCANVAS_NODES_TOGGLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A562780)
#define FLOWCANVAS_NODES_TOGGLE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A5627E0)
#define FLOWCANVAS_NODES_TOGGLE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A5627F0)
#define FLOWCANVAS_NODES_TOGGLE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A562800)
#define FLOWCANVAS_NODES_TOGGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A562990)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Toggle_TypeDefinitionIndex = 26925;
