...
#define FLOWCANVAS_NODES_TOGGLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19F51990)
#define FLOWCANVAS_NODES_TOGGLE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19F519F0)
#define FLOWCANVAS_NODES_TOGGLE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19F51A00)
#define FLOWCANVAS_NODES_TOGGLE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19F51A10)
#define FLOWCANVAS_NODES_TOGGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F51BA0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Toggle_TypeDefinitionIndex = 25388;
