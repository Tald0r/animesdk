...
#define FLOWCANVAS_NODES_MOVETO_INVOKE_OFFSET UNITYSDK_OFFSET(0x1974A8C0)
#define FLOWCANVAS_NODES_MOVETO_ONBREAK_OFFSET UNITYSDK_OFFSET(0x1974A950)
#define FLOWCANVAS_NODES_MOVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x1974A970)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int MoveTo_TypeDefinitionIndex = 26732;
