...
#define FLOWCANVAS_NODES_DUMMY___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19C78D80)
#define FLOWCANVAS_NODES_DUMMY___C__DISPLAYCLASS2_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x19C78D90)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Dummy___c__DisplayClass2_0_TypeDefinitionIndex = 25414;
