...
#define FLOWCANVAS_NODES_DOONCE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x191789D0)
#define FLOWCANVAS_NODES_DOONCE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x191789E0)
#define FLOWCANVAS_NODES_DOONCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19178AE0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int DoOnce_TypeDefinitionIndex = 27632;
