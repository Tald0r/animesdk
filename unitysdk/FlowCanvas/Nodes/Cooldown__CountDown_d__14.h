...
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19C164A0)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C16770)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C167D0)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19C16780)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C16490)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x19C16480)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Cooldown__CountDown_d__14_TypeDefinitionIndex = 27078;
