...
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19748610)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x197488E0)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19748940)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x197488F0)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19748600)
#define FLOWCANVAS_NODES_COOLDOWN__COUNTDOWN_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x197485F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Cooldown__CountDown_d__14_TypeDefinitionIndex = 26325;
