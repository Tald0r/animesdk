...
#define FLOWCANVAS_NODES_ISOFTYPE_GET_OBJECT_OFFSET UNITYSDK_OFFSET(0x19178DD0)
#define FLOWCANVAS_NODES_ISOFTYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19178DF0)
#define FLOWCANVAS_NODES_ISOFTYPE_SET_OBJECT_OFFSET UNITYSDK_OFFSET(0x19178DE0)
#define FLOWCANVAS_NODES_ISOFTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19178E90)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int IsOfType_TypeDefinitionIndex = 27637;
