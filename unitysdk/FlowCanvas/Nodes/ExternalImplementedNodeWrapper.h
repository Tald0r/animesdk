...
#define FLOWCANVAS_NODES_EXTERNALIMPLEMENTEDNODEWRAPPER_GETRUNTIMEICONTYPE_OFFSET UNITYSDK_OFFSET(0x19DAC3B0)
#define FLOWCANVAS_NODES_EXTERNALIMPLEMENTEDNODEWRAPPER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19DAC300)
#define FLOWCANVAS_NODES_EXTERNALIMPLEMENTEDNODEWRAPPER_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x19DAC260)
#define FLOWCANVAS_NODES_EXTERNALIMPLEMENTEDNODEWRAPPER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19DAC3D0)
#define FLOWCANVAS_NODES_EXTERNALIMPLEMENTEDNODEWRAPPER_SETTARGET_OFFSET UNITYSDK_OFFSET(0x19DAC560)
#define FLOWCANVAS_NODES_EXTERNALIMPLEMENTEDNODEWRAPPER_SET_TARGET_OFFSET UNITYSDK_OFFSET(0x19DAC2A0)
#define FLOWCANVAS_NODES_EXTERNALIMPLEMENTEDNODEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAC5C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExternalImplementedNodeWrapper_TypeDefinitionIndex = 26227;
