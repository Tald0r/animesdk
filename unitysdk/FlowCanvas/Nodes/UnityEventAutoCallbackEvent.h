...
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A262C00)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_GET_FIELD_OFFSET UNITYSDK_OFFSET(0x1A262C80)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_GET_ISSTATIC_OFFSET UNITYSDK_OFFSET(0x1A262BE0)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_GET_MEMBER_OFFSET UNITYSDK_OFFSET(0x1A262BC0)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A262D20)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_GET_PROP_OFFSET UNITYSDK_OFFSET(0x1A262CD0)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1A262FB0)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_ONEVENTRAISED_OFFSET UNITYSDK_OFFSET(0x1A263810)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A2634D0)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A263780)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A263020)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT_SETEVENT_OFFSET UNITYSDK_OFFSET(0x1A262FC0)
#define FLOWCANVAS_NODES_UNITYEVENTAUTOCALLBACKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A263860)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UnityEventAutoCallbackEvent_TypeDefinitionIndex = 26891;

	class UnityEventAutoCallbackEvent : public ::FlowCanvas::Nodes::EventNode
	{
	public:
		::FlowCanvas::Nodes::ReflectedUnityEvent* reflectedEvent; // 0xA8
