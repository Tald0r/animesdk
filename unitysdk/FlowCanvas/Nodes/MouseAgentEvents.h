...
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_ONMOUSEDOWN_OFFSET UNITYSDK_OFFSET(0x19179CE0)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_ONMOUSEDRAG_OFFSET UNITYSDK_OFFSET(0x19179E00)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_ONMOUSEENTER_OFFSET UNITYSDK_OFFSET(0x191799A0)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_ONMOUSEEXIT_OFFSET UNITYSDK_OFFSET(0x19179C50)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_ONMOUSEOVER_OFFSET UNITYSDK_OFFSET(0x19179BC0)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_ONMOUSEUP_OFFSET UNITYSDK_OFFSET(0x19179D70)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19179070)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_STOREHIT_OFFSET UNITYSDK_OFFSET(0x19179A30)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x191791E0)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x191795C0)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x19179E90)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x19179EC0)
#define FLOWCANVAS_NODES_MOUSEAGENTEVENTS__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x19179ED0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int MouseAgentEvents_TypeDefinitionIndex = 26036;
	...
	public:
		...
		::FlowCanvas::FlowOutput* onDown; // 0xD8
