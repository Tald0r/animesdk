...
#define FLOWCANVAS_NODES_INTEGERNOTEQUAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x196D4D90)
#define FLOWCANVAS_NODES_INTEGERNOTEQUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x196D4DA0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int IntegerNotEqual_TypeDefinitionIndex = 26116;
