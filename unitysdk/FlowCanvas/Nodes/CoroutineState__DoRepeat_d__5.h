...
#define FLOWCANVAS_NODES_COROUTINESTATE__DOREPEAT_D__5_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19748970)
#define FLOWCANVAS_NODES_COROUTINESTATE__DOREPEAT_D__5_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19748B40)
#define FLOWCANVAS_NODES_COROUTINESTATE__DOREPEAT_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19748BA0)
#define FLOWCANVAS_NODES_COROUTINESTATE__DOREPEAT_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19748B50)
#define FLOWCANVAS_NODES_COROUTINESTATE__DOREPEAT_D__5_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19748960)
#define FLOWCANVAS_NODES_COROUTINESTATE__DOREPEAT_D__5__CTOR_OFFSET UNITYSDK_OFFSET(0x19748950)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CoroutineState__DoRepeat_d__5_TypeDefinitionIndex = 25455;

	class CoroutineState__DoRepeat_d__5 : public ::System::Object
	{
	public:
		::FlowCanvas::Flow f; // 0x10
		::FlowCanvas::FlowOutput* fUpdate; // 0x38
		::FlowCanvas::FlowOutput* fStart; // 0x40
		::FlowCanvas::Nodes::CoroutineState* __4__this; // 0x48
