...
#define FLOWCANVAS_NODES_INPUTAXISEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19FE8500)
#define FLOWCANVAS_NODES_INPUTAXISEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x19FE85E0)
#define FLOWCANVAS_NODES_INPUTAXISEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE85F0)
#define FLOWCANVAS_NODES_INPUTAXISEVENT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x19FE8610)
#define FLOWCANVAS_NODES_INPUTAXISEVENT__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x19FE8620)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int InputAxisEvent_TypeDefinitionIndex = 26847;
