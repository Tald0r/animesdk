...
#define FLOWCANVAS_NODES_OSCILLATOREVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A261FA0)
#define FLOWCANVAS_NODES_OSCILLATOREVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A261EF0)
#define FLOWCANVAS_NODES_OSCILLATOREVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A261FB0)
#define FLOWCANVAS_NODES_OSCILLATOREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A261D80)
#define FLOWCANVAS_NODES_OSCILLATOREVENT__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x1A2620E0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int OscillatorEvent_TypeDefinitionIndex = 26390;
