...
#define FLOWCANVAS_NODES_EXTRACTVECTOR3_INVOKE_OFFSET UNITYSDK_OFFSET(0x19DAC650)
#define FLOWCANVAS_NODES_EXTRACTVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAC680)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExtractVector3_TypeDefinitionIndex = 26252;
