...
#define FLOWCANVAS_NODES_CUSTOMEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19FEEB50)
#define FLOWCANVAS_NODES_CUSTOMEVENT_ONCUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0x19FEEDC0)
#define FLOWCANVAS_NODES_CUSTOMEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19FEED00)
#define FLOWCANVAS_NODES_CUSTOMEVENT_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19FEEBC0)
#define FLOWCANVAS_NODES_CUSTOMEVENT_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19FEEC60)
#define FLOWCANVAS_NODES_CUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEF050)
#define FLOWCANVAS_NODES_CUSTOMEVENT__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x19FEF090)
#define FLOWCANVAS_NODES_CUSTOMEVENT__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x19FEF0A0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomEvent_TypeDefinitionIndex = 27645;

	class CustomEvent : public ::FlowCanvas::Nodes::RouterEventNode_1<::NodeCanvas::Framework::GraphOwner*>
	{
	public:
		::NodeCanvas::Framework::GraphOwner* sender; // 0xC0
		::FlowCanvas::FlowOutput* onReceived; // 0xC8
		::NodeCanvas::Framework::GraphOwner* receiver; // 0xD0
