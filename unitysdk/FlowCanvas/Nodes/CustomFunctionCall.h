...
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19C16C60)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19C16BC0)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_GET_SOURCEFUNCTIONUID_OFFSET UNITYSDK_OFFSET(0x19C16A40)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_GET_SOURCEFUNCTION_OFFSET UNITYSDK_OFFSET(0x19C16A60)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C17140)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19C16E30)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_SETFUNCTION_OFFSET UNITYSDK_OFFSET(0x19C16D40)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL_SET_SOURCEFUNCTIONUID_OFFSET UNITYSDK_OFFSET(0x19C16A50)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C17350)
#define FLOWCANVAS_NODES_CUSTOMFUNCTIONCALL__GET_SOURCEFUNCTION_B__9_0_OFFSET UNITYSDK_OFFSET(0x19C17370)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomFunctionCall_TypeDefinitionIndex = 26716;
	...
	public:
		...
		::System::WeakReference_1<::FlowCanvas::Nodes::CustomFunctionEvent*>* _sourceFunctionRef; // 0xB8
