...
#define FLOWCANVAS_NODES_OR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A829690)
#define FLOWCANVAS_NODES_OR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8296A0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int OR_TypeDefinitionIndex = 26310;
