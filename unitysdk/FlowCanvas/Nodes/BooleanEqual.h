...
#define FLOWCANVAS_NODES_BOOLEANEQUAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A07E0B0)
#define FLOWCANVAS_NODES_BOOLEANEQUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A07E0C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int BooleanEqual_TypeDefinitionIndex = 25740;
