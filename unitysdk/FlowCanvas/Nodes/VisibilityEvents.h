...
#define FLOWCANVAS_NODES_VISIBILITYEVENTS_ONBECAMEINVISIBLE_OFFSET UNITYSDK_OFFSET(0x1A178CF0)
#define FLOWCANVAS_NODES_VISIBILITYEVENTS_ONBECAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x1A178C60)
#define FLOWCANVAS_NODES_VISIBILITYEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A1788C0)
#define FLOWCANVAS_NODES_VISIBILITYEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A178980)
#define FLOWCANVAS_NODES_VISIBILITYEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A178AF0)
#define FLOWCANVAS_NODES_VISIBILITYEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A178D80)
#define FLOWCANVAS_NODES_VISIBILITYEVENTS__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x1A178DB0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int VisibilityEvents_TypeDefinitionIndex = 26399;
