...
#define FLOWCANVAS_NODES_SWITCHSTRING___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1ACB70)
#define FLOWCANVAS_NODES_SWITCHSTRING___C__DISPLAYCLASS1_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1A1ACB80)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchString___c__DisplayClass1_0_TypeDefinitionIndex = 26205;
	...
	public:
		...
		::FlowCanvas::Nodes::SwitchString* __4__this; // 0x20
