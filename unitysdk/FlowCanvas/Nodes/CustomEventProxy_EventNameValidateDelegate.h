...
#define FLOWCANVAS_NODES_CUSTOMEVENTPROXY_EVENTNAMEVALIDATEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A07EF10)
#define FLOWCANVAS_NODES_CUSTOMEVENTPROXY_EVENTNAMEVALIDATEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A07EF50)
#define FLOWCANVAS_NODES_CUSTOMEVENTPROXY_EVENTNAMEVALIDATEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A07E970)
#define FLOWCANVAS_NODES_CUSTOMEVENTPROXY_EVENTNAMEVALIDATEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A07E960)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomEventProxy_EventNameValidateDelegate_TypeDefinitionIndex = 26316;
