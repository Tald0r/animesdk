...
#define FLOWCANVAS_NODES_KEYBOARDEVENTS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19E020F0)
#define FLOWCANVAS_NODES_KEYBOARDEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19E021C0)
#define FLOWCANVAS_NODES_KEYBOARDEVENTS_UPDATE_OFFSET UNITYSDK_OFFSET(0x19E02250)
#define FLOWCANVAS_NODES_KEYBOARDEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x19E02260)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int KeyboardEvents_TypeDefinitionIndex = 26737;
	...
	public:
		...
		::FlowCanvas::FlowOutput* down; // 0xB8
