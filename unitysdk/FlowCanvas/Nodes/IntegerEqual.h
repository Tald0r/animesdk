...
#define FLOWCANVAS_NODES_INTEGEREQUAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FEF260)
#define FLOWCANVAS_NODES_INTEGEREQUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEF270)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int IntegerEqual_TypeDefinitionIndex = 26285;
