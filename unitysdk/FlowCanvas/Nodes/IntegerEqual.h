...
#define FLOWCANVAS_NODES_INTEGEREQUAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x199FF530)
#define FLOWCANVAS_NODES_INTEGEREQUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x199FF540)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int IntegerEqual_TypeDefinitionIndex = 25955;
