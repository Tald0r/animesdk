...
#define FLOWCANVAS_NODES_LATCHBOOL___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C0520)
#define FLOWCANVAS_NODES_LATCHBOOL___C__DISPLAYCLASS1_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1A1C0530)
#define FLOWCANVAS_NODES_LATCHBOOL___C__DISPLAYCLASS1_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x1A1C0590)
#define FLOWCANVAS_NODES_LATCHBOOL___C__DISPLAYCLASS1_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0x1A1C05F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LatchBool___c__DisplayClass1_0_TypeDefinitionIndex = 27097;
