...
#define FLOWCANVAS_NODES_LATCHBOOL___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19C017D0)
#define FLOWCANVAS_NODES_LATCHBOOL___C__DISPLAYCLASS1_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x19C017E0)
#define FLOWCANVAS_NODES_LATCHBOOL___C__DISPLAYCLASS1_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x19C01840)
#define FLOWCANVAS_NODES_LATCHBOOL___C__DISPLAYCLASS1_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0x19C018A0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LatchBool___c__DisplayClass1_0_TypeDefinitionIndex = 26562;
