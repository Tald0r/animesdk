...
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x19E024B0)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_BREAKALL_OFFSET UNITYSDK_OFFSET(0x19E02410)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x19E02820)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19E022C0)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_INTERNALCOROUTINE_OFFSET UNITYSDK_OFFSET(0x19E02650)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_ONBREAK_OFFSET UNITYSDK_OFFSET(0x19E02810)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19E02390)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19E023A0)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE_ONREGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19E026C0)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E02830)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__INTERNALCOROUTINE_B__15_0_OFFSET UNITYSDK_OFFSET(0x19E02840)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__ONREGISTERPORTS_B__16_0_OFFSET UNITYSDK_OFFSET(0x19E02850)
#define FLOWCANVAS_NODES_LATENTACTIONNODEBASE__ONREGISTERPORTS_B__16_1_OFFSET UNITYSDK_OFFSET(0x19E02860)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LatentActionNodeBase_TypeDefinitionIndex = 25741;
	...
	public:
		...
		::UnityEngine::Coroutine* currentCoroutine; // 0x40
		::FlowCanvas::FlowOutput* onFinish; // 0x48
		::System::Collections::Generic::Queue_1<::FlowCanvas::Nodes::LatentActionNodeBase_RoutineData>* routineQueue; // 0x50
