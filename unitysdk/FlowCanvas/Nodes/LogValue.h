...
#define FLOWCANVAS_NODES_LOGVALUE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C79E40)
#define FLOWCANVAS_NODES_LOGVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C79E50)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LogValue_TypeDefinitionIndex = 25678;
