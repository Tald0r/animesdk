...
#define FLOWCANVAS_NODES_LOGVALUE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A21B5E0)
#define FLOWCANVAS_NODES_LOGVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A21B5F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LogValue_TypeDefinitionIndex = 26209;
