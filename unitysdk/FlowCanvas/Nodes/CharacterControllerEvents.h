...
#define FLOWCANVAS_NODES_CHARACTERCONTROLLEREVENTS_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x199FE420)
#define FLOWCANVAS_NODES_CHARACTERCONTROLLEREVENTS_ONCONTROLLERCOLLIDERHIT_OFFSET UNITYSDK_OFFSET(0x199FEB00)
#define FLOWCANVAS_NODES_CHARACTERCONTROLLEREVENTS_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x199FE340)
#define FLOWCANVAS_NODES_CHARACTERCONTROLLEREVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x199FE790)
#define FLOWCANVAS_NODES_CHARACTERCONTROLLEREVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x199FE940)
#define FLOWCANVAS_NODES_CHARACTERCONTROLLEREVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x199FEA20)
#define FLOWCANVAS_NODES_CHARACTERCONTROLLEREVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x199FEB90)
#define FLOWCANVAS_NODES_CHARACTERCONTROLLEREVENTS__REGISTERPORTS_B__9_0_OFFSET UNITYSDK_OFFSET(0x199FEBC0)
#define FLOWCANVAS_NODES_CHARACTERCONTROLLEREVENTS__REGISTERPORTS_B__9_1_OFFSET UNITYSDK_OFFSET(0x199FEBD0)
#define FLOWCANVAS_NODES_CHARACTERCONTROLLEREVENTS__REGISTERPORTS_B__9_2_OFFSET UNITYSDK_OFFSET(0x199FEC00)
#define FLOWCANVAS_NODES_CHARACTERCONTROLLEREVENTS__REGISTERPORTS_B__9_3_OFFSET UNITYSDK_OFFSET(0x199FEC30)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CharacterControllerEvents_TypeDefinitionIndex = 26074;
	...
	public:
		...
		::UnityEngine::CharacterController* receiver; // 0xC8
		::FlowCanvas::FlowOutput* onGrounded; // 0xD0
		::FlowCanvas::FlowOutput* onUnGrounded; // 0xD8
		::UnityEngine::ControllerColliderHit* hitInfo; // 0xE0
		::FlowCanvas::FlowOutput* onHit; // 0xE8
