...
#define FLOWCANVAS_NODES_PUREREFLECTEDEXTRACTORNODE_GETPORTHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1A651F40)
#define FLOWCANVAS_NODES_PUREREFLECTEDEXTRACTORNODE_GETPORTHANDLER_OFFSET UNITYSDK_OFFSET(0x1A651ED0)
#define FLOWCANVAS_NODES_PUREREFLECTEDEXTRACTORNODE_INITINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A651EC0)
#define FLOWCANVAS_NODES_PUREREFLECTEDEXTRACTORNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A651FB0)
#define FLOWCANVAS_NODES_PUREREFLECTEDEXTRACTORNODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A652210)
#define FLOWCANVAS_NODES_PUREREFLECTEDEXTRACTORNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A652200)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int PureReflectedExtractorNode_TypeDefinitionIndex = 26189;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(PureReflectedExtractorNode_TypeDefinitionIndex)->GetStaticField(0x1F450);
		}
