...
#define FLOWCANVAS_NODES_PUREREFLECTEDEXTRACTORNODE_GETPORTHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1A07F3B0)
#define FLOWCANVAS_NODES_PUREREFLECTEDEXTRACTORNODE_GETPORTHANDLER_OFFSET UNITYSDK_OFFSET(0x1A07F340)
#define FLOWCANVAS_NODES_PUREREFLECTEDEXTRACTORNODE_INITINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A07F330)
#define FLOWCANVAS_NODES_PUREREFLECTEDEXTRACTORNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A07F420)
#define FLOWCANVAS_NODES_PUREREFLECTEDEXTRACTORNODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A07F680)
#define FLOWCANVAS_NODES_PUREREFLECTEDEXTRACTORNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A07F670)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int PureReflectedExtractorNode_TypeDefinitionIndex = 26512;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(PureReflectedExtractorNode_TypeDefinitionIndex)->GetStaticField(0x1E950);
		}
