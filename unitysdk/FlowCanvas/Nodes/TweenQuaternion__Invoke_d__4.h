...
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19FF08F0)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FF0A70)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FF0AD0)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19FF0A80)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19FF08E0)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF08D0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenQuaternion__Invoke_d__4_TypeDefinitionIndex = 27291;
