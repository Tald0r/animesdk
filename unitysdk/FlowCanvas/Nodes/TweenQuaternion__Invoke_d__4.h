...
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19A00BC0)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19A00D40)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19A00DA0)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19A00D50)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19A00BB0)
#define FLOWCANVAS_NODES_TWEENQUATERNION__INVOKE_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x19A00BA0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenQuaternion__Invoke_d__4_TypeDefinitionIndex = 25596;
	...
	public:
		...
		::UnityEngine::Quaternion to; // 0x34
