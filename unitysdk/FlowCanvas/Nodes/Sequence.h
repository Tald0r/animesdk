...
#define FLOWCANVAS_NODES_SEQUENCE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1917A930)
#define FLOWCANVAS_NODES_SEQUENCE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1917A8F0)
#define FLOWCANVAS_NODES_SEQUENCE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1917A920)
#define FLOWCANVAS_NODES_SEQUENCE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1917A9D0)
#define FLOWCANVAS_NODES_SEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1917ABF0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Sequence_TypeDefinitionIndex = 27616;
