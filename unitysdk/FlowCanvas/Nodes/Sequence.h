...
#define FLOWCANVAS_NODES_SEQUENCE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x183DDC60)
#define FLOWCANVAS_NODES_SEQUENCE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x183DDC20)
#define FLOWCANVAS_NODES_SEQUENCE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x183DDC50)
#define FLOWCANVAS_NODES_SEQUENCE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x183DDD00)
#define FLOWCANVAS_NODES_SEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x183DDF20)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Sequence_TypeDefinitionIndex = 25374;
