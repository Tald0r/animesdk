...
#define FLOWCANVAS_NODES_XOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1974CB20)
#define FLOWCANVAS_NODES_XOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1974CB30)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int XOR_TypeDefinitionIndex = 25935;
