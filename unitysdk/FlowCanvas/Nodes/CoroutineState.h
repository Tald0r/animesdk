...
#define FLOWCANVAS_NODES_COROUTINESTATE_DOREPEAT_OFFSET UNITYSDK_OFFSET(0x199FED90)
#define FLOWCANVAS_NODES_COROUTINESTATE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0x199FED80)
#define FLOWCANVAS_NODES_COROUTINESTATE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x199FEC40)
#define FLOWCANVAS_NODES_COROUTINESTATE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x199FEC70)
#define FLOWCANVAS_NODES_COROUTINESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x199FEE10)
#define FLOWCANVAS_NODES_COROUTINESTATE__DOREPEAT_B__5_0_OFFSET UNITYSDK_OFFSET(0x199FEE30)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CoroutineState_TypeDefinitionIndex = 25454;
