...
#define FLOWCANVAS_NODES_COROUTINESTATE_DOREPEAT_OFFSET UNITYSDK_OFFSET(0x19FEEAA0)
#define FLOWCANVAS_NODES_COROUTINESTATE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0x19FEEA90)
#define FLOWCANVAS_NODES_COROUTINESTATE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19FEE950)
#define FLOWCANVAS_NODES_COROUTINESTATE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19FEE980)
#define FLOWCANVAS_NODES_COROUTINESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEEB20)
#define FLOWCANVAS_NODES_COROUTINESTATE__DOREPEAT_B__5_0_OFFSET UNITYSDK_OFFSET(0x19FEEB40)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CoroutineState_TypeDefinitionIndex = 25966;
