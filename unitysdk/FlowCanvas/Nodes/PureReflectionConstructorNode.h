...
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE_CALL_OFFSET UNITYSDK_OFFSET(0x191561F0)
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE_INITINTERNAL_OFFSET UNITYSDK_OFFSET(0x19154900)
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE_REGISTERINPUT_OFFSET UNITYSDK_OFFSET(0x19156610)
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE_REGISTEROUTPUT_OFFSET UNITYSDK_OFFSET(0x19156530)
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19156920)
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x191548F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int PureReflectionConstructorNode_TypeDefinitionIndex = 25528;

	class PureReflectionConstructorNode : public ::FlowCanvas::Nodes::BaseReflectedConstructorNode
	{
	public:
		::System::Object* resultObject; // 0x98
