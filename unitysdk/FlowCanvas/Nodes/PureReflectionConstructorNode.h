...
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE_CALL_OFFSET UNITYSDK_OFFSET(0x19548350)
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE_INITINTERNAL_OFFSET UNITYSDK_OFFSET(0x19546A50)
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE_REGISTERINPUT_OFFSET UNITYSDK_OFFSET(0x19548770)
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE_REGISTEROUTPUT_OFFSET UNITYSDK_OFFSET(0x19548690)
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19548A80)
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19546A40)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int PureReflectionConstructorNode_TypeDefinitionIndex = 26957;

	class PureReflectionConstructorNode : public ::FlowCanvas::Nodes::BaseReflectedConstructorNode
	{
	public:
		::System::Object* resultObject; // 0x98
		::Il2CppArray<::FlowCanvas::ValueInput*>* inputs; // 0xA0
