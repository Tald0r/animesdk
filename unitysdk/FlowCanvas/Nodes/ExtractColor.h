...
#define FLOWCANVAS_NODES_EXTRACTCOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A1AAC70)
#define FLOWCANVAS_NODES_EXTRACTCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1AACA0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExtractColor_TypeDefinitionIndex = 25908;
