...
#define FLOWCANVAS_NODES_EXTRACTCOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A118040)
#define FLOWCANVAS_NODES_EXTRACTCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A118070)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExtractColor_TypeDefinitionIndex = 26403;
