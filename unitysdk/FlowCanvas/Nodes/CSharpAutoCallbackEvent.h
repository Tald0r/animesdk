...
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_GET_EVENTINFO_OFFSET UNITYSDK_OFFSET(0x19FED0D0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_GET_ISSTATICEVENT_OFFSET UNITYSDK_OFFSET(0x19FED0F0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19FED1D0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x19FED4D0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_ONEVENTRAISED_OFFSET UNITYSDK_OFFSET(0x19FEDFE0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19FEDAB0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19FEDE10)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19FED530)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_SETEVENT_OFFSET UNITYSDK_OFFSET(0x19FED4E0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEE030)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CSharpAutoCallbackEvent_TypeDefinitionIndex = 26420;

	class CSharpAutoCallbackEvent : public ::FlowCanvas::Nodes::EventNode
	{
	public:
		::FlowCanvas::FlowOutput* callback; // 0xA8
		::FlowCanvas::Nodes::ReflectedDelegateEvent* reflectedEvent; // 0xB0
		::System::Object* instance; // 0xB8
		::FlowCanvas::ValueInput* instancePort; // 0xC0
