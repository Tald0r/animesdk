...
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_GET_EVENTINFO_OFFSET UNITYSDK_OFFSET(0x199FD3D0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_GET_ISSTATICEVENT_OFFSET UNITYSDK_OFFSET(0x199FD3F0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x199FD4D0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x199FD7D0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_ONEVENTRAISED_OFFSET UNITYSDK_OFFSET(0x199FE2D0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x199FDDB0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x199FE100)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x199FD830)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT_SETEVENT_OFFSET UNITYSDK_OFFSET(0x199FD7E0)
#define FLOWCANVAS_NODES_CSHARPAUTOCALLBACKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x199FE320)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CSharpAutoCallbackEvent_TypeDefinitionIndex = 25261;
