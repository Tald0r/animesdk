...
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDMETHODNODE_CREATE_OFFSET UNITYSDK_OFFSET(0x1A1778C0)
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDMETHODNODE_GETNAME_OFFSET UNITYSDK_OFFSET(0x1A178140)
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDMETHODNODE_TRYCREATEJIT_OFFSET UNITYSDK_OFFSET(0x1A177A40)
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDMETHODNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1778B0)

namespace FlowCanvas::Nodes::Legacy
{
	inline static constexpr unsigned int ReflectedMethodNode_TypeDefinitionIndex = 25612;
