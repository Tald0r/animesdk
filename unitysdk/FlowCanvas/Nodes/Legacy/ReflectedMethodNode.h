...
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDMETHODNODE_CREATE_OFFSET UNITYSDK_OFFSET(0x1A720140)
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDMETHODNODE_GETNAME_OFFSET UNITYSDK_OFFSET(0x1A7209B0)
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDMETHODNODE_TRYCREATEJIT_OFFSET UNITYSDK_OFFSET(0x1A7202C0)
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDMETHODNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A720130)

namespace FlowCanvas::Nodes::Legacy
{
	inline static constexpr unsigned int ReflectedMethodNode_TypeDefinitionIndex = 26744;
