...
#define FLOWCANVAS_NODES_LEGACY_PUREREFLECTEDMETHODNODE_CALLMETHOD_OFFSET UNITYSDK_OFFSET(0x19E8F900)
#define FLOWCANVAS_NODES_LEGACY_PUREREFLECTEDMETHODNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19E8ED30)
#define FLOWCANVAS_NODES_LEGACY_PUREREFLECTEDMETHODNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E8FD30)

namespace FlowCanvas::Nodes::Legacy
{
	inline static constexpr unsigned int PureReflectedMethodNode_TypeDefinitionIndex = 25427;
	...
	public:
		...
		::System::Collections::Generic::List_1<::FlowCanvas::ValueInput*>* paramsInputs; // 0x30
		::System::Collections::Generic::List_1<::FlowCanvas::ValueInput*>* inputs; // 0x38
		::System::Object* returnValue; // 0x40
