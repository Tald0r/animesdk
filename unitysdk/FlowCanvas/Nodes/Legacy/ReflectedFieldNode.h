...
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDFIELDNODE_CREATE_OFFSET UNITYSDK_OFFSET(0x19DAD2C0)
#define FLOWCANVAS_NODES_LEGACY_REFLECTEDFIELDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAD300)

namespace FlowCanvas::Nodes::Legacy
{
	inline static constexpr unsigned int ReflectedFieldNode_TypeDefinitionIndex = 26774;
