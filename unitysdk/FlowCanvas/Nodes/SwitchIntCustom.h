...
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM_ISCHOICENODE_OFFSET UNITYSDK_OFFSET(0x1A081050)
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A080E30)
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A081060)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchIntCustom_TypeDefinitionIndex = 26320;
