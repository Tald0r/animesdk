...
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM_ISCHOICENODE_OFFSET UNITYSDK_OFFSET(0x1A653BF0)
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A6539C0)
#define FLOWCANVAS_NODES_SWITCHINTCUSTOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A653C00)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchIntCustom_TypeDefinitionIndex = 26788;
