...
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_ONTRIGGERENTER2D_OFFSET UNITYSDK_OFFSET(0x183DEA90)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_ONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x183DEBD0)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_ONTRIGGERSTAY2D_OFFSET UNITYSDK_OFFSET(0x183DEB30)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x183DE550)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x183DE670)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x183DE880)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x183DEC70)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x183DECA0)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x183DECB0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Trigger2DEvents_TypeDefinitionIndex = 25861;
