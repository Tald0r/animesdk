...
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_ONTRIGGERENTER2D_OFFSET UNITYSDK_OFFSET(0x1917B740)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_ONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x1917B880)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_ONTRIGGERSTAY2D_OFFSET UNITYSDK_OFFSET(0x1917B7E0)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1917B1E0)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1917B300)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1917B520)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1917B920)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1917B950)
#define FLOWCANVAS_NODES_TRIGGER2DEVENTS__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1917B960)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Trigger2DEvents_TypeDefinitionIndex = 27267;
