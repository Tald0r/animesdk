...
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_GETDEFFROMINFO_OFFSET UNITYSDK_OFFSET(0x19156DE0)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_GETGENERATEDKEY_OFFSET UNITYSDK_OFFSET(0x19157810)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_GETGETTERDEFFROMINFO_OFFSET UNITYSDK_OFFSET(0x19156C70)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_1_OFFSET UNITYSDK_OFFSET(0x191572D0)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_2_OFFSET UNITYSDK_OFFSET(0x19154630)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_3_OFFSET UNITYSDK_OFFSET(0x19157540)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_4_OFFSET UNITYSDK_OFFSET(0x191576B0)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_OFFSET UNITYSDK_OFFSET(0x19157090)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedNodesHelper_TypeDefinitionIndex = 26765;
