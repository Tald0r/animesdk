...
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_GETDEFFROMINFO_OFFSET UNITYSDK_OFFSET(0x19548F40)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_GETGENERATEDKEY_OFFSET UNITYSDK_OFFSET(0x19549970)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_GETGETTERDEFFROMINFO_OFFSET UNITYSDK_OFFSET(0x19548DD0)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_1_OFFSET UNITYSDK_OFFSET(0x19549430)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_2_OFFSET UNITYSDK_OFFSET(0x19546780)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_3_OFFSET UNITYSDK_OFFSET(0x195496A0)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_4_OFFSET UNITYSDK_OFFSET(0x19549810)
#define FLOWCANVAS_NODES_REFLECTEDNODESHELPER_INITPARAMS_OFFSET UNITYSDK_OFFSET(0x195491F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedNodesHelper_TypeDefinitionIndex = 26009;
