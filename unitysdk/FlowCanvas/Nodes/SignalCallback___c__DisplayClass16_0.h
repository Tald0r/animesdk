...
#define FLOWCANVAS_NODES_SIGNALCALLBACK___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19C7AA20)
#define FLOWCANVAS_NODES_SIGNALCALLBACK___C__DISPLAYCLASS16_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0x19C7AA30)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SignalCallback___c__DisplayClass16_0_TypeDefinitionIndex = 25624;
