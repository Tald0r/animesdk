...
#define FLOWCANVAS_NODES_PARTICLECOLLISION2DEVENTS_ONPARTICLECOLLISION_OFFSET UNITYSDK_OFFSET(0x19DADC10)
#define FLOWCANVAS_NODES_PARTICLECOLLISION2DEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19DAD8A0)
#define FLOWCANVAS_NODES_PARTICLECOLLISION2DEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19DADA50)
#define FLOWCANVAS_NODES_PARTICLECOLLISION2DEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19DADB30)
#define FLOWCANVAS_NODES_PARTICLECOLLISION2DEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x19DADDF0)
#define FLOWCANVAS_NODES_PARTICLECOLLISION2DEVENTS__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x19DADE20)
#define FLOWCANVAS_NODES_PARTICLECOLLISION2DEVENTS__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x19DADE30)
#define FLOWCANVAS_NODES_PARTICLECOLLISION2DEVENTS__REGISTERPORTS_B__4_2_OFFSET UNITYSDK_OFFSET(0x19DADE40)
#define FLOWCANVAS_NODES_PARTICLECOLLISION2DEVENTS__REGISTERPORTS_B__4_3_OFFSET UNITYSDK_OFFSET(0x19DADE80)
#define FLOWCANVAS_NODES_PARTICLECOLLISION2DEVENTS__REGISTERPORTS_B__4_4_OFFSET UNITYSDK_OFFSET(0x19DADEE0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ParticleCollision2DEvents_TypeDefinitionIndex = 26268;
