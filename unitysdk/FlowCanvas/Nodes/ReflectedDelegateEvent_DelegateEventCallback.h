...
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A00820)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A00850)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A00280)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x199FE070)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedDelegateEvent_DelegateEventCallback_TypeDefinitionIndex = 25891;
