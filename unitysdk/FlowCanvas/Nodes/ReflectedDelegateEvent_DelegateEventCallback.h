...
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FF0550)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FF0580)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FEFFB0)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_DELEGATEEVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEDD70)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedDelegateEvent_DelegateEventCallback_TypeDefinitionIndex = 26194;
