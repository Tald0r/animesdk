...
#define FLOWCANVAS_NODES_INTEGERDIVIDE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6016C0)
#define FLOWCANVAS_NODES_INTEGERDIVIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6016D0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int IntegerDivide_TypeDefinitionIndex = 26560;
