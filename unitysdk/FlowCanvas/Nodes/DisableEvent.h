...
#define FLOWCANVAS_NODES_DISABLEEVENT_ONPOSTGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x183DB870)
#define FLOWCANVAS_NODES_DISABLEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x183DB8B0)
#define FLOWCANVAS_NODES_DISABLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x183DB8E0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int DisableEvent_TypeDefinitionIndex = 25267;
