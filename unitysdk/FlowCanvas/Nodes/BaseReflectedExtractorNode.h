...
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_ADD_ONGETAOTEXTRACTORNODE_OFFSET UNITYSDK_OFFSET(0x1A176EC0)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_GETEXTRACTORNODE_OFFSET UNITYSDK_OFFSET(0x1A177020)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_GET_PARAMS_OFFSET UNITYSDK_OFFSET(0x1A1771E0)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1A177290)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_INIT_OFFSET UNITYSDK_OFFSET(0x1A177170)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_REMOVE_ONGETAOTEXTRACTORNODE_OFFSET UNITYSDK_OFFSET(0x1A176F70)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_SET_PARAMS_OFFSET UNITYSDK_OFFSET(0x1A177230)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_SET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1A1772A0)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1772B0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int BaseReflectedExtractorNode_TypeDefinitionIndex = 25345;
	...
	public:
		...
		{
			return (::System::Func_4<::System::Type*, ::System::Boolean, ::Il2CppArray<::System::Reflection::MemberInfo*>*, ::FlowCanvas::Nodes::BaseReflectedExtractorNode*>**)Il2CppClass::FromTypeDefinitionIndex(BaseReflectedExtractorNode_TypeDefinitionIndex)->GetStaticField(0x1E920);
		}
