...
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_ADD_ONGETAOTEXTRACTORNODE_OFFSET UNITYSDK_OFFSET(0x1A71F730)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_GETEXTRACTORNODE_OFFSET UNITYSDK_OFFSET(0x1A71F890)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_GET_PARAMS_OFFSET UNITYSDK_OFFSET(0x1A71FA50)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1A71FB00)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_INIT_OFFSET UNITYSDK_OFFSET(0x1A71F9E0)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_REMOVE_ONGETAOTEXTRACTORNODE_OFFSET UNITYSDK_OFFSET(0x1A71F7E0)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_SET_PARAMS_OFFSET UNITYSDK_OFFSET(0x1A71FAA0)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE_SET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1A71FB10)
#define FLOWCANVAS_NODES_BASEREFLECTEDEXTRACTORNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A71FB20)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int BaseReflectedExtractorNode_TypeDefinitionIndex = 25969;
	...
	public:
		...
		{
			return (::System::Func_4<::System::Type*, ::System::Boolean, ::Il2CppArray<::System::Reflection::MemberInfo*>*, ::FlowCanvas::Nodes::BaseReflectedExtractorNode*>**)Il2CppClass::FromTypeDefinitionIndex(BaseReflectedExtractorNode_TypeDefinitionIndex)->GetStaticField(0x1F420);
		}
