...
#define FLOWCANVAS_NODES_ORMERGE_CHECK_OFFSET UNITYSDK_OFFSET(0x19258980)
#define FLOWCANVAS_NODES_ORMERGE_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x19258860)
#define FLOWCANVAS_NODES_ORMERGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19258880)
#define FLOWCANVAS_NODES_ORMERGE_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x19258870)
#define FLOWCANVAS_NODES_ORMERGE__CTOR_OFFSET UNITYSDK_OFFSET(0x192589F0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ORMerge_TypeDefinitionIndex = 26577;
