...
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_UNITYEVENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A119DD0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_UNITYEVENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A119E00)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_UNITYEVENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A1198D0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_UNITYEVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1198B0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedUnityEvent_UnityEventCallback_TypeDefinitionIndex = 26801;
