...
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_UNITYEVENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A1AC9C0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_UNITYEVENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A1AC9F0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_UNITYEVENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A1AC4C0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_UNITYEVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1AC4B0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedUnityEvent_UnityEventCallback_TypeDefinitionIndex = 26664;
