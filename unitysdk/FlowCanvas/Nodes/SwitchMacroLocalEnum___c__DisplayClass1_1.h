...
#define FLOWCANVAS_NODES_SWITCHMACROLOCALENUM___C__DISPLAYCLASS1_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F2090)
#define FLOWCANVAS_NODES_SWITCHMACROLOCALENUM___C__DISPLAYCLASS1_1__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1A3F2130)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchMacroLocalEnum___c__DisplayClass1_1_TypeDefinitionIndex = 27730;

	class SwitchMacroLocalEnum___c__DisplayClass1_1 : public ::System::Object
	{
	public:
		::FlowCanvas::Nodes::SwitchMacroLocalEnum___c__DisplayClass1_0* CS___8__locals1; // 0x10
		::FlowCanvas::FlowOutput* defaultCase; // 0x18
		::Il2CppArray<::FlowCanvas::FlowOutput*>* cases; // 0x20
		::FlowCanvas::ValueInput_1<::FlowCanvas::Macros::CustomMacroEnumWrap*>* selector; // 0x28
