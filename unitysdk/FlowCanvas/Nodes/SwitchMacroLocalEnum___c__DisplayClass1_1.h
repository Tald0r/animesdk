...
#define FLOWCANVAS_NODES_SWITCHMACROLOCALENUM___C__DISPLAYCLASS1_1__CTOR_OFFSET UNITYSDK_OFFSET(0x19E03810)
#define FLOWCANVAS_NODES_SWITCHMACROLOCALENUM___C__DISPLAYCLASS1_1__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x19E038B0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchMacroLocalEnum___c__DisplayClass1_1_TypeDefinitionIndex = 25131;
