...
#define FLOWCANVAS_NODES_LDWHILENEXT__DOWHILE_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA3FF760)
#define FLOWCANVAS_NODES_LDWHILENEXT__DOWHILE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA3FFAF0)
#define FLOWCANVAS_NODES_LDWHILENEXT__DOWHILE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA3FFB50)
#define FLOWCANVAS_NODES_LDWHILENEXT__DOWHILE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA3FFB00)
#define FLOWCANVAS_NODES_LDWHILENEXT__DOWHILE_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA3FF750)
#define FLOWCANVAS_NODES_LDWHILENEXT__DOWHILE_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0xA3FF740)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWhileNext__DoWhile_d__8_TypeDefinitionIndex = 47711;
