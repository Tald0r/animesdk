...
#define FLOWCANVAS_NODES_WAITUNTIL__INVOKE_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A654960)
#define FLOWCANVAS_NODES_WAITUNTIL__INVOKE_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A654A10)
#define FLOWCANVAS_NODES_WAITUNTIL__INVOKE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A654A70)
#define FLOWCANVAS_NODES_WAITUNTIL__INVOKE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A654A20)
#define FLOWCANVAS_NODES_WAITUNTIL__INVOKE_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A654950)
#define FLOWCANVAS_NODES_WAITUNTIL__INVOKE_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A654940)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitUntil__Invoke_d__3_TypeDefinitionIndex = 26874;
