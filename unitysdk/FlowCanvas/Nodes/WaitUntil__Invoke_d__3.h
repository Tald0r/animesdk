...
#define FLOWCANVAS_NODES_WAITUNTIL__INVOKE_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A081DA0)
#define FLOWCANVAS_NODES_WAITUNTIL__INVOKE_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A081E50)
#define FLOWCANVAS_NODES_WAITUNTIL__INVOKE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A081EB0)
#define FLOWCANVAS_NODES_WAITUNTIL__INVOKE_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A081E60)
#define FLOWCANVAS_NODES_WAITUNTIL__INVOKE_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A081D90)
#define FLOWCANVAS_NODES_WAITUNTIL__INVOKE_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A081D80)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitUntil__Invoke_d__3_TypeDefinitionIndex = 25178;
