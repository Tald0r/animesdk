...
#define FLOWCANVAS_NODES_LDFOREACHNEXT_ENUMERATORELEMENTS_OFFSET UNITYSDK_OFFSET(0xA3FECF0)
#define FLOWCANVAS_NODES_LDFOREACHNEXT_GETNODEWILDDEFINITIONTYPE_OFFSET UNITYSDK_OFFSET(0xA3FEFF0)
#define FLOWCANVAS_NODES_LDFOREACHNEXT_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0xA3FF070)
#define FLOWCANVAS_NODES_LDFOREACHNEXT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA3FEAC0)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA3FF290)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0xA3FF2B0)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0xA3FF2C0)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__REGISTERPORTS_B__8_2_OFFSET UNITYSDK_OFFSET(0xA3FF2D0)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__REGISTERPORTS_B__8_3_OFFSET UNITYSDK_OFFSET(0xA3FF560)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__REGISTERPORTS_B__8_4_OFFSET UNITYSDK_OFFSET(0xA3FF5A0)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__REGISTERPORTS_B__8_5_OFFSET UNITYSDK_OFFSET(0xA3FF550)
#define FLOWCANVAS_NODES_LDFOREACHNEXT___BASE_GETNODEWILDDEFINITIONTYPE_OFFSET UNITYSDK_OFFSET(0xA3FF5E0)
#define FLOWCANVAS_NODES_LDFOREACHNEXT___BASE_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0xA3FF640)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDForeachNext_TypeDefinitionIndex = 71888;
	...
	public:
		...
		::System::Object* currentObject; // 0xB8
