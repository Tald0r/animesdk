...
#define FLOWCANVAS_NODES_LDFOREACHNEXT_ENUMERATORELEMENTS_OFFSET UNITYSDK_OFFSET(0xB421A60)
#define FLOWCANVAS_NODES_LDFOREACHNEXT_GETNODEWILDDEFINITIONTYPE_OFFSET UNITYSDK_OFFSET(0xB421D60)
#define FLOWCANVAS_NODES_LDFOREACHNEXT_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0xB421DE0)
#define FLOWCANVAS_NODES_LDFOREACHNEXT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB421830)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB422000)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0xB422020)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0xB422030)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__REGISTERPORTS_B__8_2_OFFSET UNITYSDK_OFFSET(0xB422040)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__REGISTERPORTS_B__8_3_OFFSET UNITYSDK_OFFSET(0xB4222D0)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__REGISTERPORTS_B__8_4_OFFSET UNITYSDK_OFFSET(0xB422310)
#define FLOWCANVAS_NODES_LDFOREACHNEXT__REGISTERPORTS_B__8_5_OFFSET UNITYSDK_OFFSET(0xB4222C0)
#define FLOWCANVAS_NODES_LDFOREACHNEXT___BASE_GETNODEWILDDEFINITIONTYPE_OFFSET UNITYSDK_OFFSET(0xB422350)
#define FLOWCANVAS_NODES_LDFOREACHNEXT___BASE_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0xB4223B0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDForeachNext_TypeDefinitionIndex = 40295;
	...
	public:
		...
		::System::Object* currentObject; // 0xC0
		::System::Collections::IEnumerator* enumerator; // 0xC8
