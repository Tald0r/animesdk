...
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1A6541B0)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1A6542F0)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x1A654250)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A653C50)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A653D70)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A653F90)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A654390)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x1A6543C0)
#define FLOWCANVAS_NODES_TRIGGEREVENTS_TRANSFORM__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x1A6543D0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TriggerEvents_Transform_TypeDefinitionIndex = 26463;
