...
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x19FF11E0)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FF11F0)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF1230)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForPhysicsFrame_TypeDefinitionIndex = 26107;
