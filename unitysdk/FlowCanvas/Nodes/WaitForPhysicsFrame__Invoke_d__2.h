...
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19158290)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x191582E0)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19158340)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x191582F0)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19158280)
#define FLOWCANVAS_NODES_WAITFORPHYSICSFRAME__INVOKE_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x19158270)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitForPhysicsFrame__Invoke_d__2_TypeDefinitionIndex = 25948;
