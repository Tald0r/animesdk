...
#define FLOWCANVAS_NODES_LOGTEXT_INVOKE_OFFSET UNITYSDK_OFFSET(0x19DAD310)
#define FLOWCANVAS_NODES_LOGTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAD320)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LogText_TypeDefinitionIndex = 26734;
