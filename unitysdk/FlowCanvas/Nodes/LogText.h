...
#define FLOWCANVAS_NODES_LOGTEXT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A39E530)
#define FLOWCANVAS_NODES_LOGTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A39E540)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int LogText_TypeDefinitionIndex = 27708;
