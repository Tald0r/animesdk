...
#define FLOWCANVAS_NODES_ANIMATOREVENTS_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x19FECFF0)
#define FLOWCANVAS_NODES_ANIMATOREVENTS_ONANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0x19FECF70)
#define FLOWCANVAS_NODES_ANIMATOREVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19FECB70)
#define FLOWCANVAS_NODES_ANIMATOREVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19FECC70)
#define FLOWCANVAS_NODES_ANIMATOREVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19FECDF0)
#define FLOWCANVAS_NODES_ANIMATOREVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x19FED080)
#define FLOWCANVAS_NODES_ANIMATOREVENTS__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x19FED0B0)
#define FLOWCANVAS_NODES_ANIMATOREVENTS__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x19FED0C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int AnimatorEvents_TypeDefinitionIndex = 27345;

	class AnimatorEvents : public ::FlowCanvas::Nodes::RouterEventNode_1<::UnityEngine::Animator*>
	{
	public:
		::FlowCanvas::FlowOutput* onAnimatorIK; // 0xC0
		::UnityEngine::Animator* receiver; // 0xC8
		::FlowCanvas::FlowOutput* onAnimatorMove; // 0xD0
