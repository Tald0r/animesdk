...
#define FLOWCANVAS_NODES_TWEENCOLOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19F521D0)
#define FLOWCANVAS_NODES_TWEENCOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x19F521F0)
#define FLOWCANVAS_NODES_TWEENCOLOR_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19F521E0)
#define FLOWCANVAS_NODES_TWEENCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19F52270)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenColor_TypeDefinitionIndex = 25258;
