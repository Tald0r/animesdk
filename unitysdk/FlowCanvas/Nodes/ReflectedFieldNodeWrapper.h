...
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GETRUNTIMEICONTYPE_OFFSET UNITYSDK_OFFSET(0x183DD3B0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_FIELD_OFFSET UNITYSDK_OFFSET(0x183DD3E0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x183DD460)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_REFLECTEDFIELDNODE_OFFSET UNITYSDK_OFFSET(0x183DD400)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_TACCESSMODE_OFFSET UNITYSDK_OFFSET(0x183DD440)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_GET_TFIELD_OFFSET UNITYSDK_OFFSET(0x183DD420)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x183DD3A0)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_0__MIGRATE_OFFSET UNITYSDK_OFFSET(0x183DD030)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x183DDB60)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_SETFIELD_OFFSET UNITYSDK_OFFSET(0x183DD920)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_SET_REFLECTEDFIELDNODE_OFFSET UNITYSDK_OFFSET(0x183DD410)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_SET_TACCESSMODE_OFFSET UNITYSDK_OFFSET(0x183DD450)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER_SET_TFIELD_OFFSET UNITYSDK_OFFSET(0x183DD430)
#define FLOWCANVAS_NODES_REFLECTEDFIELDNODEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x183DDBB0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedFieldNodeWrapper_TypeDefinitionIndex = 25836;

	class ReflectedFieldNodeWrapper : public ::FlowCanvas::FlowNode
	{
	public:
		::ParadoxNotion::Serialization::SerializedFieldInfo* _field; // 0xA8
		::FlowCanvas::Nodes::BaseReflectedFieldNode* _reflectedFieldNode_k__BackingField; // 0xB0
