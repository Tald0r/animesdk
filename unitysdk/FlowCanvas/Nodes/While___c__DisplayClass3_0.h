...
#define FLOWCANVAS_NODES_WHILE___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19E90DC0)
#define FLOWCANVAS_NODES_WHILE___C__DISPLAYCLASS3_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x19E90DD0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int While___c__DisplayClass3_0_TypeDefinitionIndex = 26426;
