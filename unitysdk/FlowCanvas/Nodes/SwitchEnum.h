...
#define FLOWCANVAS_NODES_SWITCHENUM_GETNODEWILDDEFINITIONTYPE_OFFSET UNITYSDK_OFFSET(0x19E90930)
#define FLOWCANVAS_NODES_SWITCHENUM_GET_STYPE_OFFSET UNITYSDK_OFFSET(0x19E904F0)
#define FLOWCANVAS_NODES_SWITCHENUM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19E904D0)
#define FLOWCANVAS_NODES_SWITCHENUM_ISCHOICENODE_OFFSET UNITYSDK_OFFSET(0x19E90920)
#define FLOWCANVAS_NODES_SWITCHENUM_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0x19E90960)
#define FLOWCANVAS_NODES_SWITCHENUM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19E90590)
#define FLOWCANVAS_NODES_SWITCHENUM_SET_STYPE_OFFSET UNITYSDK_OFFSET(0x19E90510)
#define FLOWCANVAS_NODES_SWITCHENUM_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x19E904E0)
#define FLOWCANVAS_NODES_SWITCHENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x19E90B10)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchEnum_TypeDefinitionIndex = 25759;
