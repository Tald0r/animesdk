...
#define FLOWCANVAS_NODES_FLOATMULTIPLY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A601250)
#define FLOWCANVAS_NODES_FLOATMULTIPLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A601260)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatMultiply_TypeDefinitionIndex = 27334;
