...
#define FLOWCANVAS_NODES_FLOATLESSTHAN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A720100)
#define FLOWCANVAS_NODES_FLOATLESSTHAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A720110)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatLessThan_TypeDefinitionIndex = 27641;
