...
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS_ONPARTICLECOLLISION_OFFSET UNITYSDK_OFFSET(0x19155EC0)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19155A50)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19155C00)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x19155D60)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x191560A0)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x191560D0)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x191560E0)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_2_OFFSET UNITYSDK_OFFSET(0x191560F0)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_3_OFFSET UNITYSDK_OFFSET(0x19156130)
#define FLOWCANVAS_NODES_PARTICLECOLLISIONEVENTS__REGISTERPORTS_B__4_4_OFFSET UNITYSDK_OFFSET(0x19156190)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ParticleCollisionEvents_TypeDefinitionIndex = 26671;
