...
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_ONMOUSEDOWN_OFFSET UNITYSDK_OFFSET(0x1A1AC240)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_ONMOUSEDRAG_OFFSET UNITYSDK_OFFSET(0x1A1AC360)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_ONMOUSEENTER_OFFSET UNITYSDK_OFFSET(0x1A1ABF00)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_ONMOUSEEXIT_OFFSET UNITYSDK_OFFSET(0x1A1AC1B0)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_ONMOUSEOVER_OFFSET UNITYSDK_OFFSET(0x1A1AC120)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_ONMOUSEUP_OFFSET UNITYSDK_OFFSET(0x1A1AC2D0)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A1AB5F0)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_STOREHIT_OFFSET UNITYSDK_OFFSET(0x1A1ABF90)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A1AB760)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A1ABB30)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1AC3F0)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x1A1AC420)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x1A1AC430)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int MouseAgent2DEvents_TypeDefinitionIndex = 26849;

	class MouseAgent2DEvents : public ::FlowCanvas::Nodes::RouterEventNode_1<::UnityEngine::Collider2D*>
	{
	public:
		::FlowCanvas::FlowOutput* onUp; // 0xC0
		::FlowCanvas::FlowOutput* onOver; // 0xC8
		::FlowCanvas::FlowOutput* onEnter; // 0xD0
		::UnityEngine::Collider2D* receiver; // 0xD8
		::FlowCanvas::FlowOutput* onDown; // 0xE0
		::FlowCanvas::FlowOutput* onExit; // 0xE8
		::FlowCanvas::FlowOutput* onDrag; // 0xF0
