...
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_ONMOUSEDOWN_OFFSET UNITYSDK_OFFSET(0x1A119640)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_ONMOUSEDRAG_OFFSET UNITYSDK_OFFSET(0x1A119760)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_ONMOUSEENTER_OFFSET UNITYSDK_OFFSET(0x1A119300)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_ONMOUSEEXIT_OFFSET UNITYSDK_OFFSET(0x1A1195B0)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_ONMOUSEOVER_OFFSET UNITYSDK_OFFSET(0x1A119520)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_ONMOUSEUP_OFFSET UNITYSDK_OFFSET(0x1A1196D0)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A1189D0)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_STOREHIT_OFFSET UNITYSDK_OFFSET(0x1A119390)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A118B40)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A118F20)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1197F0)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x1A119820)
#define FLOWCANVAS_NODES_MOUSEAGENT2DEVENTS__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x1A119830)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int MouseAgent2DEvents_TypeDefinitionIndex = 27437;
