...
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_ADD__CALLBACK_OFFSET UNITYSDK_OFFSET(0x19C79E70)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_CALLBACKMETHOD0_OFFSET UNITYSDK_OFFSET(0x19C7A970)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19C79F80)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x19C79F70)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_INITFOREVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19C79FB0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_REMOVE__CALLBACK_OFFSET UNITYSDK_OFFSET(0x19C79EF0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_STARTLISTENING_OFFSET UNITYSDK_OFFSET(0x19C7A5F0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT_STOPLISTENING_OFFSET UNITYSDK_OFFSET(0x19C7A7B0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C79FA0)
#define FLOWCANVAS_NODES_REFLECTEDUNITYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C79F90)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedUnityEvent_TypeDefinitionIndex = 26663;

	class ReflectedUnityEvent : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Reflection::ParameterInfo*>* _parameters; // 0x10
		::FlowCanvas::Nodes::ReflectedUnityEvent_UnityEventCallback* _callback; // 0x18
		::System::Reflection::MethodInfo* _removeListenerMethod; // 0x20
		::System::Reflection::MethodInfo* _callMethod; // 0x28
