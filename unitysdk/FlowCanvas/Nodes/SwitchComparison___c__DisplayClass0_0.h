...
#define FLOWCANVAS_NODES_SWITCHCOMPARISON___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A829BD0)
#define FLOWCANVAS_NODES_SWITCHCOMPARISON___C__DISPLAYCLASS0_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1A829BE0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SwitchComparison___c__DisplayClass0_0_TypeDefinitionIndex = 27550;

	class SwitchComparison___c__DisplayClass0_0 : public ::System::Object
	{
	public:
		::FlowCanvas::FlowOutput* less; // 0x10
		::FlowCanvas::FlowOutput* notEqual; // 0x18
		::FlowCanvas::FlowOutput* greater; // 0x20
