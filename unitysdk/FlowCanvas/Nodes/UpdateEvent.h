...
#define FLOWCANVAS_NODES_UPDATEEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19FEA020)
#define FLOWCANVAS_NODES_UPDATEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19FE9FF0)
#define FLOWCANVAS_NODES_UPDATEEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x19FEA030)
#define FLOWCANVAS_NODES_UPDATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEA130)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UpdateEvent_TypeDefinitionIndex = 25601;
