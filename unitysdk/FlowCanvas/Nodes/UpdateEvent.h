...
#define FLOWCANVAS_NODES_UPDATEEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A6030C0)
#define FLOWCANVAS_NODES_UPDATEEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A603090)
#define FLOWCANVAS_NODES_UPDATEEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A6030D0)
#define FLOWCANVAS_NODES_UPDATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6031D0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UpdateEvent_TypeDefinitionIndex = 26314;
