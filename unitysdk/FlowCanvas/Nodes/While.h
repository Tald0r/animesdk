...
#define FLOWCANVAS_NODES_WHILE_DOWHILE_OFFSET UNITYSDK_OFFSET(0x19DAEEE0)
#define FLOWCANVAS_NODES_WHILE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19DAEDB0)
#define FLOWCANVAS_NODES_WHILE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19DAEDC0)
#define FLOWCANVAS_NODES_WHILE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19DAEDF0)
#define FLOWCANVAS_NODES_WHILE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAEF60)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int While_TypeDefinitionIndex = 26424;
