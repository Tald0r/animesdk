...
#define FLOWCANVAS_NODES_TWEENFLOAT__INVOKE_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19E90B50)
#define FLOWCANVAS_NODES_TWEENFLOAT__INVOKE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19E90D50)
#define FLOWCANVAS_NODES_TWEENFLOAT__INVOKE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19E90DB0)
#define FLOWCANVAS_NODES_TWEENFLOAT__INVOKE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19E90D60)
#define FLOWCANVAS_NODES_TWEENFLOAT__INVOKE_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19E90B40)
#define FLOWCANVAS_NODES_TWEENFLOAT__INVOKE_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x19E90B30)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TweenFloat__Invoke_d__4_TypeDefinitionIndex = 25798;
