...
#define FLOWCANVAS_NODES_WAITUNTIL_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x1974C660)
#define FLOWCANVAS_NODES_WAITUNTIL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1974C670)
#define FLOWCANVAS_NODES_WAITUNTIL_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0x1974C6C0)
#define FLOWCANVAS_NODES_WAITUNTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1974C700)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitUntil_TypeDefinitionIndex = 25177;
