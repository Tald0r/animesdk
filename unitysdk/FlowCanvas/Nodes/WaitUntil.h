...
#define FLOWCANVAS_NODES_WAITUNTIL_GET_ALLOWROUTINEQUEUEING_OFFSET UNITYSDK_OFFSET(0x19C1A4C0)
#define FLOWCANVAS_NODES_WAITUNTIL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C1A4D0)
#define FLOWCANVAS_NODES_WAITUNTIL_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0x19C1A520)
#define FLOWCANVAS_NODES_WAITUNTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C1A560)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaitUntil_TypeDefinitionIndex = 26873;
