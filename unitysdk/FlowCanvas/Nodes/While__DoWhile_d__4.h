...
#define FLOWCANVAS_NODES_WHILE__DOWHILE_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1974C870)
#define FLOWCANVAS_NODES_WHILE__DOWHILE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1974CAB0)
#define FLOWCANVAS_NODES_WHILE__DOWHILE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1974CB10)
#define FLOWCANVAS_NODES_WHILE__DOWHILE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1974CAC0)
#define FLOWCANVAS_NODES_WHILE__DOWHILE_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1974C860)
#define FLOWCANVAS_NODES_WHILE__DOWHILE_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1974C850)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int While__DoWhile_d__4_TypeDefinitionIndex = 26427;
	...
	public:
		...
		::FlowCanvas::Nodes::While___c__DisplayClass4_0* __8__1; // 0x20
		::FlowCanvas::Flow f; // 0x28
		::System::Object* __2__current; // 0x50
		::FlowCanvas::Nodes::While* __4__this; // 0x58
