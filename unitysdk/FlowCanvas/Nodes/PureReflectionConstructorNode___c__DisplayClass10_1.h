...
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE___C__DISPLAYCLASS10_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A601E40)
#define FLOWCANVAS_NODES_PUREREFLECTIONCONSTRUCTORNODE___C__DISPLAYCLASS10_1__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x1A601E50)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int PureReflectionConstructorNode___c__DisplayClass10_1_TypeDefinitionIndex = 26960;
