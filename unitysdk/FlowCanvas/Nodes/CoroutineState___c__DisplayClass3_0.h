...
#define FLOWCANVAS_NODES_COROUTINESTATE___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A47BAC0)
#define FLOWCANVAS_NODES_COROUTINESTATE___C__DISPLAYCLASS3_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x1A47BAD0)
#define FLOWCANVAS_NODES_COROUTINESTATE___C__DISPLAYCLASS3_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x1A47BBA0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int CoroutineState___c__DisplayClass3_0_TypeDefinitionIndex = 25968;
