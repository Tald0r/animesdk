...
#define FLOWCANVAS_NODES_CONSTRUCTIONEVENT_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A6004E0)
#define FLOWCANVAS_NODES_CONSTRUCTIONEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A600540)
#define FLOWCANVAS_NODES_CONSTRUCTIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A600590)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ConstructionEvent_TypeDefinitionIndex = 27697;
