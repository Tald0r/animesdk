...
#define FLOWCANVAS_NODES_BASEREFLECTEDMETHODNODE_ADD_ONGETAOTREFLECTEDMETHODNODE_OFFSET UNITYSDK_OFFSET(0x19DAB990)
#define FLOWCANVAS_NODES_BASEREFLECTEDMETHODNODE_GETMETHODNODE_OFFSET UNITYSDK_OFFSET(0x19DABAF0)
#define FLOWCANVAS_NODES_BASEREFLECTEDMETHODNODE_INIT_OFFSET UNITYSDK_OFFSET(0x19DABE40)
#define FLOWCANVAS_NODES_BASEREFLECTEDMETHODNODE_REMOVE_ONGETAOTREFLECTEDMETHODNODE_OFFSET UNITYSDK_OFFSET(0x19DABA40)
#define FLOWCANVAS_NODES_BASEREFLECTEDMETHODNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DABFF0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int BaseReflectedMethodNode_TypeDefinitionIndex = 26101;
	...
	public:
		...
		{
			return (::System::Func_2<::System::Reflection::MethodInfo*, ::FlowCanvas::Nodes::BaseReflectedMethodNode*>**)Il2CppClass::FromTypeDefinitionIndex(BaseReflectedMethodNode_TypeDefinitionIndex)->GetStaticField(0x1F210);
		}
