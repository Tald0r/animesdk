...
#define FLOWCANVAS_NODES_SIMPLEXNODE_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19E8FF50)
#define FLOWCANVAS_NODES_SIMPLEXNODE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19E8FE50)
#define FLOWCANVAS_NODES_SIMPLEXNODE_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x19E8FFF0)
#define FLOWCANVAS_NODES_SIMPLEXNODE_GET_PARENTNODE_OFFSET UNITYSDK_OFFSET(0x19E8FE30)
#define FLOWCANVAS_NODES_SIMPLEXNODE_ONGRAPHPAUSED_OFFSET UNITYSDK_OFFSET(0x19E90490)
#define FLOWCANVAS_NODES_SIMPLEXNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19E90480)
#define FLOWCANVAS_NODES_SIMPLEXNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19E904B0)
#define FLOWCANVAS_NODES_SIMPLEXNODE_ONGRAPHUNPAUSED_OFFSET UNITYSDK_OFFSET(0x19E904A0)
#define FLOWCANVAS_NODES_SIMPLEXNODE_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0x19E90470)
#define FLOWCANVAS_NODES_SIMPLEXNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19E900C0)
#define FLOWCANVAS_NODES_SIMPLEXNODE_SETDEFAULTPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19E90280)
#define FLOWCANVAS_NODES_SIMPLEXNODE_SET_PARENTNODE_OFFSET UNITYSDK_OFFSET(0x19E8FE40)
#define FLOWCANVAS_NODES_SIMPLEXNODE_STARTCOROUTINE_OFFSET UNITYSDK_OFFSET(0x19E90440)
#define FLOWCANVAS_NODES_SIMPLEXNODE_STOPCOROUTINE_OFFSET UNITYSDK_OFFSET(0x19E90460)
#define FLOWCANVAS_NODES_SIMPLEXNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E904C0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int SimplexNode_TypeDefinitionIndex = 26485;

	class SimplexNode : public ::System::Object
	{
	public:
		::System::String* _name; // 0x10
		::FlowCanvas::FlowNode* _parentNode_k__BackingField; // 0x18
		::Il2CppArray<::System::Reflection::ParameterInfo*>* _parameters; // 0x20
