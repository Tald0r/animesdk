...
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19C035A0)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C03670)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C036D0)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19C03680)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C03590)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x19C03580)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Wait__Invoke_d__8_TypeDefinitionIndex = 26493;
