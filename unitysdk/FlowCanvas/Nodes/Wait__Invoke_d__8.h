...
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A1C2300)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A1C23D0)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A1C2430)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A1C23E0)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A1C22F0)
#define FLOWCANVAS_NODES_WAIT__INVOKE_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C22E0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Wait__Invoke_d__8_TypeDefinitionIndex = 26635;
