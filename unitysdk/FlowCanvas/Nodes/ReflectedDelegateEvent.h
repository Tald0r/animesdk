...
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_ADD_OFFSET UNITYSDK_OFFSET(0x19FEDD90)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_ADD_ONCALLBACK_OFFSET UNITYSDK_OFFSET(0x19FEF580)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_ASDELEGATE_OFFSET UNITYSDK_OFFSET(0x19FEFF20)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_CALLBACK0_OFFSET UNITYSDK_OFFSET(0x19FEFF80)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_GETMETHODFORDELEGATETYPE_OFFSET UNITYSDK_OFFSET(0x19FEF690)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x19FF04B0)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_REMOVE_OFFSET UNITYSDK_OFFSET(0x19FEDF60)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT_REMOVE_ONCALLBACK_OFFSET UNITYSDK_OFFSET(0x19FEF600)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FEDA40)
#define FLOWCANVAS_NODES_REFLECTEDDELEGATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEF680)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedDelegateEvent_TypeDefinitionIndex = 26193;
