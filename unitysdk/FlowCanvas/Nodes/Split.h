...
#define FLOWCANVAS_NODES_SPLIT_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x19E03280)
#define FLOWCANVAS_NODES_SPLIT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19E032A0)
#define FLOWCANVAS_NODES_SPLIT_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x19E03290)
#define FLOWCANVAS_NODES_SPLIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E03440)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Split_TypeDefinitionIndex = 26702;
