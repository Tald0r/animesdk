...
#define FLOWCANVAS_NODES_SPLIT_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A3F1B00)
#define FLOWCANVAS_NODES_SPLIT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A3F1B20)
#define FLOWCANVAS_NODES_SPLIT_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A3F1B10)
#define FLOWCANVAS_NODES_SPLIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F1CC0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Split_TypeDefinitionIndex = 27130;
