...
#define FLOWCANVAS_NODES_TASKACTION__DOUPDATE_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19C02F70)
#define FLOWCANVAS_NODES_TASKACTION__DOUPDATE_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C03130)
#define FLOWCANVAS_NODES_TASKACTION__DOUPDATE_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C03190)
#define FLOWCANVAS_NODES_TASKACTION__DOUPDATE_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19C03140)
#define FLOWCANVAS_NODES_TASKACTION__DOUPDATE_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C02F60)
#define FLOWCANVAS_NODES_TASKACTION__DOUPDATE_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x19C02F50)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int TaskAction__DoUpdate_d__15_TypeDefinitionIndex = 25547;
