...
#define FLOWCANVAS_NODES_NEWVECTOR2_INVOKE_OFFSET UNITYSDK_OFFSET(0x19F50A50)
#define FLOWCANVAS_NODES_NEWVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x19F50A60)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int NewVector2_TypeDefinitionIndex = 26880;
