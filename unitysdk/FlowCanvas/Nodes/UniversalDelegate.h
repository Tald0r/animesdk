...
#define FLOWCANVAS_NODES_UNIVERSALDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19DAED10)
#define FLOWCANVAS_NODES_UNIVERSALDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19DAED40)
#define FLOWCANVAS_NODES_UNIVERSALDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19DAE810)
#define FLOWCANVAS_NODES_UNIVERSALDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DAE800)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UniversalDelegate_TypeDefinitionIndex = 25854;
