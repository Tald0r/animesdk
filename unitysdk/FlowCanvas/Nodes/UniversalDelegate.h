...
#define FLOWCANVAS_NODES_UNIVERSALDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A39FF70)
#define FLOWCANVAS_NODES_UNIVERSALDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A39FFA0)
#define FLOWCANVAS_NODES_UNIVERSALDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A39FA70)
#define FLOWCANVAS_NODES_UNIVERSALDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A39FA50)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int UniversalDelegate_TypeDefinitionIndex = 27262;
