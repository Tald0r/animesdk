...
#define FLOWCANVAS_NODES_REFLECTEDCONSTRUCTORNODEWRAPPER_GET_CONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A07F9D0)
#define FLOWCANVAS_NODES_REFLECTEDCONSTRUCTORNODEWRAPPER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A07FA00)
#define FLOWCANVAS_NODES_REFLECTEDCONSTRUCTORNODEWRAPPER_GET_REFLECTEDCONSTRUCTORNODE_OFFSET UNITYSDK_OFFSET(0x1A07F9B0)
#define FLOWCANVAS_NODES_REFLECTEDCONSTRUCTORNODEWRAPPER_GET_SERIALIZEDMETHODBASE_OFFSET UNITYSDK_OFFSET(0x1A07F9F0)
#define FLOWCANVAS_NODES_REFLECTEDCONSTRUCTORNODEWRAPPER_GET_TCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A07F990)
#define FLOWCANVAS_NODES_REFLECTEDCONSTRUCTORNODEWRAPPER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A07FC40)
#define FLOWCANVAS_NODES_REFLECTEDCONSTRUCTORNODEWRAPPER_SETCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A07FBE0)
#define FLOWCANVAS_NODES_REFLECTEDCONSTRUCTORNODEWRAPPER_SETMETHODBASE_OFFSET UNITYSDK_OFFSET(0x1A07FB50)
#define FLOWCANVAS_NODES_REFLECTEDCONSTRUCTORNODEWRAPPER_SET_REFLECTEDCONSTRUCTORNODE_OFFSET UNITYSDK_OFFSET(0x1A07F9C0)
#define FLOWCANVAS_NODES_REFLECTEDCONSTRUCTORNODEWRAPPER_SET_TCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A07F9A0)
#define FLOWCANVAS_NODES_REFLECTEDCONSTRUCTORNODEWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A07FCB0)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int ReflectedConstructorNodeWrapper_TypeDefinitionIndex = 26229;
