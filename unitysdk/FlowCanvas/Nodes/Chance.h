...
#define FLOWCANVAS_NODES_CHANCE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19154A10)
#define FLOWCANVAS_NODES_CHANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19154B40)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int Chance_TypeDefinitionIndex = 26211;
