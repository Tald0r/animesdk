...
#define FLOWCANVAS_NODES_GETSHARPEVENT_GET_EVENTINFO_OFFSET UNITYSDK_OFFSET(0x19C79640)
#define FLOWCANVAS_NODES_GETSHARPEVENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19C79670)
#define FLOWCANVAS_NODES_GETSHARPEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x19C79910)
#define FLOWCANVAS_NODES_GETSHARPEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x19C79980)
#define FLOWCANVAS_NODES_GETSHARPEVENT_SETEVENT_OFFSET UNITYSDK_OFFSET(0x19C79920)
#define FLOWCANVAS_NODES_GETSHARPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C79C00)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int GetSharpEvent_TypeDefinitionIndex = 25473;
