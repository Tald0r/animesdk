...
#define FLOWCANVAS_NODES_FLOATADD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A07F030)
#define FLOWCANVAS_NODES_FLOATADD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A07F040)

namespace FlowCanvas::Nodes
{
	inline static constexpr unsigned int FloatAdd_TypeDefinitionIndex = 26140;
