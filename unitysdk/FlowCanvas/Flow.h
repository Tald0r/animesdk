...
#define FLOWCANVAS_FLOW_BEGINBREAKBLOCK_OFFSET UNITYSDK_OFFSET(0x3186D0)
#define FLOWCANVAS_FLOW_BREAK_OFFSET UNITYSDK_OFFSET(0x923F60)
#define FLOWCANVAS_FLOW_CALL_OFFSET UNITYSDK_OFFSET(0x923EF0)
#define FLOWCANVAS_FLOW_ENDBREAKBLOCK_OFFSET UNITYSDK_OFFSET(0x923F50)
#define FLOWCANVAS_FLOW_GET_NEW_OFFSET UNITYSDK_OFFSET(0x1A39B4F0)
#define FLOWCANVAS_FLOW_GET_TICKS_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define FLOWCANVAS_FLOW_RETURN_OFFSET UNITYSDK_OFFSET(0x923F40)
#define FLOWCANVAS_FLOW_SETRETURNDATA_OFFSET UNITYSDK_OFFSET(0x923F30)
#define FLOWCANVAS_FLOW_SET_TICKS_OFFSET UNITYSDK_OFFSET(0x302300)

namespace FlowCanvas
{
	inline static constexpr unsigned int Flow_TypeDefinitionIndex = 26590;
