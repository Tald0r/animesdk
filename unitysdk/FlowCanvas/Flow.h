...
#define FLOWCANVAS_FLOW_BEGINBREAKBLOCK_OFFSET UNITYSDK_OFFSET(0x2FC190)
#define FLOWCANVAS_FLOW_BREAK_OFFSET UNITYSDK_OFFSET(0x8F8B90)
#define FLOWCANVAS_FLOW_CALL_OFFSET UNITYSDK_OFFSET(0x8F8B20)
#define FLOWCANVAS_FLOW_ENDBREAKBLOCK_OFFSET UNITYSDK_OFFSET(0x8F8B80)
#define FLOWCANVAS_FLOW_GET_NEW_OFFSET UNITYSDK_OFFSET(0x19DAA2C0)
#define FLOWCANVAS_FLOW_GET_TICKS_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define FLOWCANVAS_FLOW_RETURN_OFFSET UNITYSDK_OFFSET(0x8F8B70)
#define FLOWCANVAS_FLOW_SETRETURNDATA_OFFSET UNITYSDK_OFFSET(0x8F8B60)
#define FLOWCANVAS_FLOW_SET_TICKS_OFFSET UNITYSDK_OFFSET(0x2D3600)

namespace FlowCanvas
{
	inline static constexpr unsigned int Flow_TypeDefinitionIndex = 26497;
