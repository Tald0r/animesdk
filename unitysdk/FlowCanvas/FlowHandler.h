...
#define FLOWCANVAS_FLOWHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x183DB270)
#define FLOWCANVAS_FLOWHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x183DB2E0)
#define FLOWCANVAS_FLOWHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x183DADB0)
#define FLOWCANVAS_FLOWHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x183D9AC0)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowHandler_TypeDefinitionIndex = 26867;
