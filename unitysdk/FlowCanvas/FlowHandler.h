...
#define FLOWCANVAS_FLOWHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19178340)
#define FLOWCANVAS_FLOWHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x191783B0)
#define FLOWCANVAS_FLOWHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19177E70)
#define FLOWCANVAS_FLOWHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x191771D0)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowHandler_TypeDefinitionIndex = 26832;
