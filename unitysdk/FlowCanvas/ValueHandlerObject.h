...
#define FLOWCANVAS_VALUEHANDLEROBJECT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A3F36D0)
#define FLOWCANVAS_VALUEHANDLEROBJECT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A3F3700)
#define FLOWCANVAS_VALUEHANDLEROBJECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A3F3430)
#define FLOWCANVAS_VALUEHANDLEROBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3EF910)

namespace FlowCanvas
{
	inline static constexpr unsigned int ValueHandlerObject_TypeDefinitionIndex = 26889;
