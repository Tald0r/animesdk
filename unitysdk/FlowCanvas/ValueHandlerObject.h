...
#define FLOWCANVAS_VALUEHANDLEROBJECT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E04E40)
#define FLOWCANVAS_VALUEHANDLEROBJECT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E04E70)
#define FLOWCANVAS_VALUEHANDLEROBJECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E04BA0)
#define FLOWCANVAS_VALUEHANDLEROBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E010D0)

namespace FlowCanvas
{
	inline static constexpr unsigned int ValueHandlerObject_TypeDefinitionIndex = 26605;
