...
#define FLOWCANVAS_FLOWNODE_ADDFLOWINPUT_1_OFFSET UNITYSDK_OFFSET(0x1A2177D0)
#define FLOWCANVAS_FLOWNODE_ADDFLOWINPUT_OFFSET UNITYSDK_OFFSET(0x1A217B10)
#define FLOWCANVAS_FLOWNODE_ADDFLOWOUTPUT_OFFSET UNITYSDK_OFFSET(0x1A2178C0)
#define FLOWCANVAS_FLOWNODE_ADDVALUEINPUT_1_OFFSET UNITYSDK_OFFSET(0x1A2179A0)
#define FLOWCANVAS_FLOWNODE_ADDVALUEINPUT_OFFSET UNITYSDK_OFFSET(0x1A217C30)
#define FLOWCANVAS_FLOWNODE_ADDVALUEOUTPUT_1_OFFSET UNITYSDK_OFFSET(0x1A217C40)
#define FLOWCANVAS_FLOWNODE_ADDVALUEOUTPUT_OFFSET UNITYSDK_OFFSET(0x1A217A80)
#define FLOWCANVAS_FLOWNODE_ASSIGNSELFINSTANCEPORT_OFFSET UNITYSDK_OFFSET(0x1A216620)
#define FLOWCANVAS_FLOWNODE_BINDPORTS_OFFSET UNITYSDK_OFFSET(0x1A215940)
#define FLOWCANVAS_FLOWNODE_CALLOUTPUTBYNETWORK_OFFSET UNITYSDK_OFFSET(0x1A217AC0)
#define FLOWCANVAS_FLOWNODE_CHECKREVERSEIDEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A217D30)
#define FLOWCANVAS_FLOWNODE_DESERIALIZEINPUTPORTVALUES_OFFSET UNITYSDK_OFFSET(0x1A217430)
#define FLOWCANVAS_FLOWNODE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x1A217AA0)
#define FLOWCANVAS_FLOWNODE_GATHERPORTS_OFFSET UNITYSDK_OFFSET(0x1A214D40)
#define FLOWCANVAS_FLOWNODE_GETALLPORTS_OFFSET UNITYSDK_OFFSET(0x1A215F90)
#define FLOWCANVAS_FLOWNODE_GETFIRSTINPUTOFTYPE_OFFSET UNITYSDK_OFFSET(0x1A216310)
#define FLOWCANVAS_FLOWNODE_GETFIRSTOUTPUTOFTYPE_OFFSET UNITYSDK_OFFSET(0x1A2164A0)
#define FLOWCANVAS_FLOWNODE_GETINPUTFLOWPORTS_OFFSET UNITYSDK_OFFSET(0x1A216190)
#define FLOWCANVAS_FLOWNODE_GETINPUTPORT_OFFSET UNITYSDK_OFFSET(0x1A215CD0)
#define FLOWCANVAS_FLOWNODE_GETINPUTVALUEPORTS_OFFSET UNITYSDK_OFFSET(0x1A216250)
#define FLOWCANVAS_FLOWNODE_GETNODEWILDDEFINITIONTYPE_OFFSET UNITYSDK_OFFSET(0x1A2195A0)
#define FLOWCANVAS_FLOWNODE_GETOUTPUTFLOWPORTS_OFFSET UNITYSDK_OFFSET(0x1A216010)
#define FLOWCANVAS_FLOWNODE_GETOUTPUTPORT_OFFSET UNITYSDK_OFFSET(0x1A215E30)
#define FLOWCANVAS_FLOWNODE_GETOUTPUTVALUEPORTS_OFFSET UNITYSDK_OFFSET(0x1A2160D0)
#define FLOWCANVAS_FLOWNODE_GETUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1A214FD0)
#define FLOWCANVAS_FLOWNODE_GET_ALLOWASPRIME_OFFSET UNITYSDK_OFFSET(0x1A214690)
#define FLOWCANVAS_FLOWNODE_GET_CANSELFCONNECT_OFFSET UNITYSDK_OFFSET(0x1A2146A0)
#define FLOWCANVAS_FLOWNODE_GET_COMMENTSALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1A2146E0)
#define FLOWCANVAS_FLOWNODE_GET_FLOWGRAPH_OFFSET UNITYSDK_OFFSET(0x1A214700)
#define FLOWCANVAS_FLOWNODE_GET_ICONALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1A2146F0)
#define FLOWCANVAS_FLOWNODE_GET_IGNORESELFINSTANCEPORTASSIGNMENT_OFFSET UNITYSDK_OFFSET(0x1A214760)
#define FLOWCANVAS_FLOWNODE_GET_ISLASTWAVECHECKNODE_OFFSET UNITYSDK_OFFSET(0x1A217AD0)
#define FLOWCANVAS_FLOWNODE_GET_ISUSEDDIFFERDATA_OFFSET UNITYSDK_OFFSET(0x1A2154D0)
#define FLOWCANVAS_FLOWNODE_GET_MAXINCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A214670)
#define FLOWCANVAS_FLOWNODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A214680)
#define FLOWCANVAS_FLOWNODE_GET_NODEEXERECORDSEQ_OFFSET UNITYSDK_OFFSET(0x1A214F80)
#define FLOWCANVAS_FLOWNODE_GET_OUTCONNECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1A2146B0)
#define FLOWCANVAS_FLOWNODE_GET_SPACE_OFFSET UNITYSDK_OFFSET(0x1A214750)
#define FLOWCANVAS_FLOWNODE_GET_TINPUTPORTVALUES_OFFSET UNITYSDK_OFFSET(0x1A214650)
#define FLOWCANVAS_FLOWNODE_GET_UNIQUEIDSTR_OFFSET UNITYSDK_OFFSET(0x1A215480)
#define FLOWCANVAS_FLOWNODE_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1A214FA0)
#define FLOWCANVAS_FLOWNODE_ISCHOICENODE_OFFSET UNITYSDK_OFFSET(0x1A215690)
#define FLOWCANVAS_FLOWNODE_ISPRELOADDONE_OFFSET UNITYSDK_OFFSET(0x1A217AB0)
#define FLOWCANVAS_FLOWNODE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0x1A215680)
#define FLOWCANVAS_FLOWNODE_ONCHILDCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A214F50)
#define FLOWCANVAS_FLOWNODE_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A214F70)
#define FLOWCANVAS_FLOWNODE_ONPARENTCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A214F40)
#define FLOWCANVAS_FLOWNODE_ONPARENTDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A214F60)
#define FLOWCANVAS_FLOWNODE_ONPORTCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A2156A0)
#define FLOWCANVAS_FLOWNODE_ONPORTDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A215800)
#define FLOWCANVAS_FLOWNODE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A214D30)
#define FLOWCANVAS_FLOWNODE_QUALIFYPORTNAMEANDID_OFFSET UNITYSDK_OFFSET(0x1A217B20)
#define FLOWCANVAS_FLOWNODE_REFRESHEDITORPORTS_OFFSET UNITYSDK_OFFSET(0x1A217B00)
#define FLOWCANVAS_FLOWNODE_REPLACEORREGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1A216910)
#define FLOWCANVAS_FLOWNODE_REPLACEWITH_OFFSET UNITYSDK_OFFSET(0x1A219050)
#define FLOWCANVAS_FLOWNODE_SET_ISLASTWAVECHECKNODE_OFFSET UNITYSDK_OFFSET(0x1A217AE0)
#define FLOWCANVAS_FLOWNODE_SET_ISUSEDDIFFERDATA_OFFSET UNITYSDK_OFFSET(0x1A2155B0)
#define FLOWCANVAS_FLOWNODE_SET_NODEEXERECORDSEQ_OFFSET UNITYSDK_OFFSET(0x1A214F90)
#define FLOWCANVAS_FLOWNODE_SET_TINPUTPORTVALUES_OFFSET UNITYSDK_OFFSET(0x1A214660)
#define FLOWCANVAS_FLOWNODE_TRYADDFIELDDELEGATEFLOWOUTPUT_OFFSET UNITYSDK_OFFSET(0x1A2188F0)
#define FLOWCANVAS_FLOWNODE_TRYADDFIELDDELEGATEVALUEINPUT_OFFSET UNITYSDK_OFFSET(0x1A218A30)
#define FLOWCANVAS_FLOWNODE_TRYADDMETHODFLOWINPUT_OFFSET UNITYSDK_OFFSET(0x1A218180)
#define FLOWCANVAS_FLOWNODE_TRYADDPROPERTYVALUEOUTPUT_OFFSET UNITYSDK_OFFSET(0x1A218320)
#define FLOWCANVAS_FLOWNODE_TRYADDREFLECTIONBASEDREGISTRATIONFOROBJECT_OFFSET UNITYSDK_OFFSET(0x1A217EA0)
#define FLOWCANVAS_FLOWNODE_TRYGETNEWGENERICMETHODFORWILD_OFFSET UNITYSDK_OFFSET(0x1A2198E0)
#define FLOWCANVAS_FLOWNODE_TRYGETNEWGENERICTYPEFORWILD_OFFSET UNITYSDK_OFFSET(0x1A219600)
#define FLOWCANVAS_FLOWNODE_TRYHANDLEWILDPORTCONNECTION_OFFSET UNITYSDK_OFFSET(0x1A215780)
#define FLOWCANVAS_FLOWNODE_TRYREMOVEPORTIFMISSINGANDCLEAN_OFFSET UNITYSDK_OFFSET(0x1A215810)
#define FLOWCANVAS_FLOWNODE_UNBINDPORTS_OFFSET UNITYSDK_OFFSET(0x1A215C30)
#define FLOWCANVAS_FLOWNODE_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A214D20)
#define FLOWCANVAS_FLOWNODE_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A214770)
#define FLOWCANVAS_FLOWNODE_VALIDATECONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A217AF0)
#define FLOWCANVAS_FLOWNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A219AD0)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowNode_TypeDefinitionIndex = 27081;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::FlowCanvas::Port*>* outputPorts; // 0x88
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Object*>* _inputPortValues; // 0x90
