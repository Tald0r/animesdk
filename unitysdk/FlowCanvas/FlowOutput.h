...
#define FLOWCANVAS_FLOWOUTPUT_ADD_POINTER_OFFSET UNITYSDK_OFFSET(0x19C00300)
#define FLOWCANVAS_FLOWOUTPUT_APPEND_OFFSET UNITYSDK_OFFSET(0x19C00610)
#define FLOWCANVAS_FLOWOUTPUT_BINDTO_OFFSET UNITYSDK_OFFSET(0x19C005B0)
#define FLOWCANVAS_FLOWOUTPUT_CALLANDNOTIFYSERVER_OFFSET UNITYSDK_OFFSET(0x19C00490)
#define FLOWCANVAS_FLOWOUTPUT_CALL_OFFSET UNITYSDK_OFFSET(0x19C004D0)
#define FLOWCANVAS_FLOWOUTPUT_GET_CALLSEQ_OFFSET UNITYSDK_OFFSET(0x19C00470)
#define FLOWCANVAS_FLOWOUTPUT_GET_ISNOTSENDFLOWCALLTOSERVER_OFFSET UNITYSDK_OFFSET(0x19C00450)
#define FLOWCANVAS_FLOWOUTPUT_GET_ISSENDFLOWCALLTOSERVER_OFFSET UNITYSDK_OFFSET(0x19C00410)
#define FLOWCANVAS_FLOWOUTPUT_GET_ISTARGETCHOICENODE_OFFSET UNITYSDK_OFFSET(0x19C00430)
#define FLOWCANVAS_FLOWOUTPUT_GET_ISTARGETNODESERVERCARE_OFFSET UNITYSDK_OFFSET(0x19C003F0)
#define FLOWCANVAS_FLOWOUTPUT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19C003C0)
#define FLOWCANVAS_FLOWOUTPUT_RECORDCALLINFO_OFFSET UNITYSDK_OFFSET(0x19C005A0)
#define FLOWCANVAS_FLOWOUTPUT_REMOVE_POINTER_OFFSET UNITYSDK_OFFSET(0x19C00360)
#define FLOWCANVAS_FLOWOUTPUT_SET_CALLSEQ_OFFSET UNITYSDK_OFFSET(0x19C00480)
#define FLOWCANVAS_FLOWOUTPUT_SET_ISNOTSENDFLOWCALLTOSERVER_OFFSET UNITYSDK_OFFSET(0x19C00460)
#define FLOWCANVAS_FLOWOUTPUT_SET_ISSENDFLOWCALLTOSERVER_OFFSET UNITYSDK_OFFSET(0x19C00420)
#define FLOWCANVAS_FLOWOUTPUT_SET_ISTARGETCHOICENODE_OFFSET UNITYSDK_OFFSET(0x19C00440)
#define FLOWCANVAS_FLOWOUTPUT_SET_ISTARGETNODESERVERCARE_OFFSET UNITYSDK_OFFSET(0x19C00400)
#define FLOWCANVAS_FLOWOUTPUT_UNBIND_OFFSET UNITYSDK_OFFSET(0x19C00670)
#define FLOWCANVAS_FLOWOUTPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C002F0)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowOutput_TypeDefinitionIndex = 25685;
	...
	public:
		...
		{
			return (::System::Action_2<::FlowCanvas::FlowOutput*, ::FlowCanvas::FlowNode*>**)Il2CppClass::FromTypeDefinitionIndex(FlowOutput_TypeDefinitionIndex)->GetStaticField(0x1F700);
		}
