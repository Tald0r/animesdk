...
#define FLOWCANVAS_FLOWRETURN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A3EE640)
#define FLOWCANVAS_FLOWRETURN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A3EE670)
#define FLOWCANVAS_FLOWRETURN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A3EE140)
#define FLOWCANVAS_FLOWRETURN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3EE120)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowReturn_TypeDefinitionIndex = 27204;
