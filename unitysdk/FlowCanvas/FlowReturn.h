...
#define FLOWCANVAS_FLOWRETURN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19DFFE00)
#define FLOWCANVAS_FLOWRETURN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19DFFE30)
#define FLOWCANVAS_FLOWRETURN_INVOKE_OFFSET UNITYSDK_OFFSET(0x19DFF900)
#define FLOWCANVAS_FLOWRETURN__CTOR_OFFSET UNITYSDK_OFFSET(0x19DFF8F0)

namespace FlowCanvas
{
	inline static constexpr unsigned int FlowReturn_TypeDefinitionIndex = 25726;
