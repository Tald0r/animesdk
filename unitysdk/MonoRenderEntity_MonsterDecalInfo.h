...
#define MONORENDERENTITY_MONSTERDECALINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x182D2800)

inline static constexpr unsigned int MonoRenderEntity_MonsterDecalInfo_TypeDefinitionIndex = 29048;
...
public:
	...
	::System::Boolean rtCleared; // 0x28
	::System::Boolean isHit; // 0x29
	::System::Int32 cellResolution; // 0x2C
	::UnityEngine::Matrix4x4 decalMatrix; // 0x30
	::System::Int32 decalCellIndex; // 0x70
