...
#define ROOTMOTION_AVATARUTILITY_GETIKGOALTQ_OFFSET UNITYSDK_OFFSET(0x1B517C80)
#define ROOTMOTION_AVATARUTILITY_GETPOSTROTATION_OFFSET UNITYSDK_OFFSET(0x1B5179C0)
#define ROOTMOTION_AVATARUTILITY_GETWORLDSPACEIKGOAL_OFFSET UNITYSDK_OFFSET(0x1B518F10)
#define ROOTMOTION_AVATARUTILITY_HUMANIDFROMAVATARIKGOAL_OFFSET UNITYSDK_OFFSET(0x1B517C60)
#define ROOTMOTION_AVATARUTILITY_WORLDSPACEIKGOALTOBONE_OFFSET UNITYSDK_OFFSET(0x1B518790)
#define ROOTMOTION_AVATARUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B519190)

namespace RootMotion
{
	inline static constexpr unsigned int AvatarUtility_TypeDefinitionIndex = 35970;
