...
#define ROOTMOTION_AVATARUTILITY_GETIKGOALTQ_OFFSET UNITYSDK_OFFSET(0x1AEFA600)
#define ROOTMOTION_AVATARUTILITY_GETPOSTROTATION_OFFSET UNITYSDK_OFFSET(0x1AEFA340)
#define ROOTMOTION_AVATARUTILITY_GETWORLDSPACEIKGOAL_OFFSET UNITYSDK_OFFSET(0x1AEFB9C0)
#define ROOTMOTION_AVATARUTILITY_HUMANIDFROMAVATARIKGOAL_OFFSET UNITYSDK_OFFSET(0x1AEFA5E0)
#define ROOTMOTION_AVATARUTILITY_WORLDSPACEIKGOALTOBONE_OFFSET UNITYSDK_OFFSET(0x1AEFB240)
#define ROOTMOTION_AVATARUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEFBC40)

namespace RootMotion
{
	inline static constexpr unsigned int AvatarUtility_TypeDefinitionIndex = 34968;
