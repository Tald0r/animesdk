...
#define ROOTMOTION_BAKER_CLIPSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACFAAD0)

namespace RootMotion
{
	inline static constexpr unsigned int Baker_ClipSettings_TypeDefinitionIndex = 34962;
