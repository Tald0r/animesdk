...
#define ROOTMOTION_BAKERTRANSFORM_ADDLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1A3BFB20)
#define ROOTMOTION_BAKERTRANSFORM_ADDROOTMOTIONCURVES_OFFSET UNITYSDK_OFFSET(0x1A3BF430)
#define ROOTMOTION_BAKERTRANSFORM_REDUCEKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1A3BF6F0)
#define ROOTMOTION_BAKERTRANSFORM_RESET_OFFSET UNITYSDK_OFFSET(0x1A3BF040)
#define ROOTMOTION_BAKERTRANSFORM_SETCURVES_OFFSET UNITYSDK_OFFSET(0x1A3BF150)
#define ROOTMOTION_BAKERTRANSFORM_SETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1A3BF840)
#define ROOTMOTION_BAKERTRANSFORM_SETRELATIVESPACE_OFFSET UNITYSDK_OFFSET(0x1A3BF130)
#define ROOTMOTION_BAKERTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3BF010)

namespace RootMotion
{
	inline static constexpr unsigned int BakerTransform_TypeDefinitionIndex = 34972;
