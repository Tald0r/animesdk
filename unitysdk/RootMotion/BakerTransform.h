...
#define ROOTMOTION_BAKERTRANSFORM_ADDLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1A9841C0)
#define ROOTMOTION_BAKERTRANSFORM_ADDROOTMOTIONCURVES_OFFSET UNITYSDK_OFFSET(0x1A983AD0)
#define ROOTMOTION_BAKERTRANSFORM_REDUCEKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1A983D90)
#define ROOTMOTION_BAKERTRANSFORM_RESET_OFFSET UNITYSDK_OFFSET(0x1A9836E0)
#define ROOTMOTION_BAKERTRANSFORM_SETCURVES_OFFSET UNITYSDK_OFFSET(0x1A9837F0)
#define ROOTMOTION_BAKERTRANSFORM_SETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1A983EE0)
#define ROOTMOTION_BAKERTRANSFORM_SETRELATIVESPACE_OFFSET UNITYSDK_OFFSET(0x1A9837D0)
#define ROOTMOTION_BAKERTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9836B0)

namespace RootMotion
{
	inline static constexpr unsigned int BakerTransform_TypeDefinitionIndex = 35974;
