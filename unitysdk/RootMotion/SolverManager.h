...
#define ROOTMOTION_SOLVERMANAGER_DISABLE_OFFSET UNITYSDK_OFFSET(0x1ACA5F30)
#define ROOTMOTION_SOLVERMANAGER_ENBALESOLVERS_OFFSET UNITYSDK_OFFSET(0x1ACA6030)
#define ROOTMOTION_SOLVERMANAGER_FINDANIMATORRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1ACA65F0)
#define ROOTMOTION_SOLVERMANAGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1ACA6CF0)
#define ROOTMOTION_SOLVERMANAGER_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1ACA6020)
#define ROOTMOTION_SOLVERMANAGER_GET_ANIMATEPHYSICS_OFFSET UNITYSDK_OFFSET(0x1ACA6410)
#define ROOTMOTION_SOLVERMANAGER_GET_ISANIMATED_OFFSET UNITYSDK_OFFSET(0x1ACA6C20)
#define ROOTMOTION_SOLVERMANAGER_GET_SHOULDSKIPANIMATORDELAYMODE_OFFSET UNITYSDK_OFFSET(0x1ACA5ED0)
#define ROOTMOTION_SOLVERMANAGER_INITIATESOLVER_OFFSET UNITYSDK_OFFSET(0x1ACA6000)
#define ROOTMOTION_SOLVERMANAGER_INITIATE_OFFSET UNITYSDK_OFFSET(0x1ACA6200)
#define ROOTMOTION_SOLVERMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1ACA6D40)
#define ROOTMOTION_SOLVERMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ACA6340)
#define ROOTMOTION_SOLVERMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1ACA61B0)
#define ROOTMOTION_SOLVERMANAGER_START_OFFSET UNITYSDK_OFFSET(0x1ACA6240)
#define ROOTMOTION_SOLVERMANAGER_UPDATESOLVEREXTERNAL_OFFSET UNITYSDK_OFFSET(0x1ACA6E40)
#define ROOTMOTION_SOLVERMANAGER_UPDATESOLVER_OFFSET UNITYSDK_OFFSET(0x1ACA6010)
#define ROOTMOTION_SOLVERMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1ACA6BD0)
#define ROOTMOTION_SOLVERMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ACA6EA0)
#define ROOTMOTION_SOLVERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACA6E80)

namespace RootMotion
{
	inline static constexpr unsigned int SolverManager_TypeDefinitionIndex = 35999;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RootMotion::SolverManager*>**)Il2CppClass::FromTypeDefinitionIndex(SolverManager_TypeDefinitionIndex)->GetStaticField(0x26640);
		}
