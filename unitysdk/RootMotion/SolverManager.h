...
#define ROOTMOTION_SOLVERMANAGER_DISABLE_OFFSET UNITYSDK_OFFSET(0x1A6FACD0)
#define ROOTMOTION_SOLVERMANAGER_ENBALESOLVERS_OFFSET UNITYSDK_OFFSET(0x1A6FADD0)
#define ROOTMOTION_SOLVERMANAGER_FINDANIMATORRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1A6FB390)
#define ROOTMOTION_SOLVERMANAGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6FBA90)
#define ROOTMOTION_SOLVERMANAGER_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A6FADC0)
#define ROOTMOTION_SOLVERMANAGER_GET_ANIMATEPHYSICS_OFFSET UNITYSDK_OFFSET(0x1A6FB1B0)
#define ROOTMOTION_SOLVERMANAGER_GET_ISANIMATED_OFFSET UNITYSDK_OFFSET(0x1A6FB9C0)
#define ROOTMOTION_SOLVERMANAGER_GET_SHOULDSKIPANIMATORDELAYMODE_OFFSET UNITYSDK_OFFSET(0x1A6FAC70)
#define ROOTMOTION_SOLVERMANAGER_INITIATESOLVER_OFFSET UNITYSDK_OFFSET(0x1A6FADA0)
#define ROOTMOTION_SOLVERMANAGER_INITIATE_OFFSET UNITYSDK_OFFSET(0x1A6FAFA0)
#define ROOTMOTION_SOLVERMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6FBAE0)
#define ROOTMOTION_SOLVERMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A6FB0E0)
#define ROOTMOTION_SOLVERMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A6FAF50)
#define ROOTMOTION_SOLVERMANAGER_START_OFFSET UNITYSDK_OFFSET(0x1A6FAFE0)
#define ROOTMOTION_SOLVERMANAGER_UPDATESOLVEREXTERNAL_OFFSET UNITYSDK_OFFSET(0x1A6FBBE0)
#define ROOTMOTION_SOLVERMANAGER_UPDATESOLVER_OFFSET UNITYSDK_OFFSET(0x1A6FADB0)
#define ROOTMOTION_SOLVERMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A6FB970)
#define ROOTMOTION_SOLVERMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6FBC40)
#define ROOTMOTION_SOLVERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6FBC20)

namespace RootMotion
{
	inline static constexpr unsigned int SolverManager_TypeDefinitionIndex = 34997;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RootMotion::SolverManager*>**)Il2CppClass::FromTypeDefinitionIndex(SolverManager_TypeDefinitionIndex)->GetStaticField(0x24C10);
		}
