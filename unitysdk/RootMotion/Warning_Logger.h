...
#define ROOTMOTION_WARNING_LOGGER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A260F50)
#define ROOTMOTION_WARNING_LOGGER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A260F80)
#define ROOTMOTION_WARNING_LOGGER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A249B40)
#define ROOTMOTION_WARNING_LOGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A260F40)

namespace RootMotion
{
	inline static constexpr unsigned int Warning_Logger_TypeDefinitionIndex = 35003;
