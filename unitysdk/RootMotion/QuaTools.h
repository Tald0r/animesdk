...
#define ROOTMOTION_QUATOOLS_CLAMPANGLE_OFFSET UNITYSDK_OFFSET(0x1B3EF270)
#define ROOTMOTION_QUATOOLS_CLAMPROTATION_OFFSET UNITYSDK_OFFSET(0x1B3EF040)
#define ROOTMOTION_QUATOOLS_FROMTOAROUNDAXIS_OFFSET UNITYSDK_OFFSET(0x1B3EEA10)
#define ROOTMOTION_QUATOOLS_FROMTOROTATIONDELTA_OFFSET UNITYSDK_OFFSET(0x1B3EED70)
#define ROOTMOTION_QUATOOLS_FROMTOROTATION_OFFSET UNITYSDK_OFFSET(0x1B3EEC50)
#define ROOTMOTION_QUATOOLS_GETAXIS_OFFSET UNITYSDK_OFFSET(0x1B3EEF40)
#define ROOTMOTION_QUATOOLS_GETBANK_1_OFFSET UNITYSDK_OFFSET(0x1B3EE240)
#define ROOTMOTION_QUATOOLS_GETBANK_OFFSET UNITYSDK_OFFSET(0x1B3ED900)
#define ROOTMOTION_QUATOOLS_GETPITCH_1_OFFSET UNITYSDK_OFFSET(0x1B3EDFF0)
#define ROOTMOTION_QUATOOLS_GETPITCH_OFFSET UNITYSDK_OFFSET(0x1B3ED7D0)
#define ROOTMOTION_QUATOOLS_GETYAW_1_OFFSET UNITYSDK_OFFSET(0x1B3EDD50)
#define ROOTMOTION_QUATOOLS_GETYAW_OFFSET UNITYSDK_OFFSET(0x1B3ED680)
#define ROOTMOTION_QUATOOLS_LERP_OFFSET UNITYSDK_OFFSET(0x1B3EE830)
#define ROOTMOTION_QUATOOLS_LINEARBLEND_OFFSET UNITYSDK_OFFSET(0x1B3EE910)
#define ROOTMOTION_QUATOOLS_MATCHROTATION_OFFSET UNITYSDK_OFFSET(0x1B3EF410)
#define ROOTMOTION_QUATOOLS_MIRRORYZ_1_OFFSET UNITYSDK_OFFSET(0x1B3EFB50)
#define ROOTMOTION_QUATOOLS_MIRRORYZ_OFFSET UNITYSDK_OFFSET(0x1B3EF7E0)
#define ROOTMOTION_QUATOOLS_ROTATIONTOLOCALSPACE_OFFSET UNITYSDK_OFFSET(0x1B3EEB40)
#define ROOTMOTION_QUATOOLS_SLERP_OFFSET UNITYSDK_OFFSET(0x1B3EE8A0)
#define ROOTMOTION_QUATOOLS_SPHERICALBLEND_OFFSET UNITYSDK_OFFSET(0x1B3EE990)
#define ROOTMOTION_QUATOOLS_TOBIPOLAR_1_OFFSET UNITYSDK_OFFSET(0x1B3EF790)
#define ROOTMOTION_QUATOOLS_TOBIPOLAR_OFFSET UNITYSDK_OFFSET(0x1B3EF6A0)

namespace RootMotion
{
	inline static constexpr unsigned int QuaTools_TypeDefinitionIndex = 35997;
