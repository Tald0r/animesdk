...
#define ROOTMOTION_BAKERHUMANOIDQT_EVALUATEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A88D310)
#define ROOTMOTION_BAKERHUMANOIDQT_EVALUATEROTATION_OFFSET UNITYSDK_OFFSET(0x1A88D240)
#define ROOTMOTION_BAKERHUMANOIDQT_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A88D3B0)
#define ROOTMOTION_BAKERHUMANOIDQT_GETCURVESFROMCLIP_OFFSET UNITYSDK_OFFSET(0x1A88D560)
#define ROOTMOTION_BAKERHUMANOIDQT_MOVELASTKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1A88DB10)
#define ROOTMOTION_BAKERHUMANOIDQT_MOVELASTKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1A88DE30)
#define ROOTMOTION_BAKERHUMANOIDQT_MULTIPLYLENGTH_OFFSET UNITYSDK_OFFSET(0x1A88DF40)
#define ROOTMOTION_BAKERHUMANOIDQT_RESET_OFFSET UNITYSDK_OFFSET(0x1A88D050)
#define ROOTMOTION_BAKERHUMANOIDQT_SETCURVES_OFFSET UNITYSDK_OFFSET(0x1A88E050)
#define ROOTMOTION_BAKERHUMANOIDQT_SETIKKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1A88D570)
#define ROOTMOTION_BAKERHUMANOIDQT_SETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1A88DA10)
#define ROOTMOTION_BAKERHUMANOIDQT_SETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1A88DEB0)
#define ROOTMOTION_BAKERHUMANOIDQT_SETROOTLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1A88DF30)
#define ROOTMOTION_BAKERHUMANOIDQT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A88D160)
#define ROOTMOTION_BAKERHUMANOIDQT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A88CF80)

namespace RootMotion
{
	inline static constexpr unsigned int BakerHumanoidQT_TypeDefinitionIndex = 34970;
