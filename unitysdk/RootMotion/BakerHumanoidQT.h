...
#define ROOTMOTION_BAKERHUMANOIDQT_EVALUATEPOSITION_OFFSET UNITYSDK_OFFSET(0x1AE4F170)
#define ROOTMOTION_BAKERHUMANOIDQT_EVALUATEROTATION_OFFSET UNITYSDK_OFFSET(0x1AE4F0A0)
#define ROOTMOTION_BAKERHUMANOIDQT_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1AE4F210)
#define ROOTMOTION_BAKERHUMANOIDQT_GETCURVESFROMCLIP_OFFSET UNITYSDK_OFFSET(0x1AE4F3C0)
#define ROOTMOTION_BAKERHUMANOIDQT_MOVELASTKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1AE4F970)
#define ROOTMOTION_BAKERHUMANOIDQT_MOVELASTKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1AE4FC90)
#define ROOTMOTION_BAKERHUMANOIDQT_MULTIPLYLENGTH_OFFSET UNITYSDK_OFFSET(0x1AE4FDA0)
#define ROOTMOTION_BAKERHUMANOIDQT_RESET_OFFSET UNITYSDK_OFFSET(0x1AE4EEB0)
#define ROOTMOTION_BAKERHUMANOIDQT_SETCURVES_OFFSET UNITYSDK_OFFSET(0x1AE4FEB0)
#define ROOTMOTION_BAKERHUMANOIDQT_SETIKKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1AE4F3D0)
#define ROOTMOTION_BAKERHUMANOIDQT_SETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1AE4F870)
#define ROOTMOTION_BAKERHUMANOIDQT_SETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1AE4FD10)
#define ROOTMOTION_BAKERHUMANOIDQT_SETROOTLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1AE4FD90)
#define ROOTMOTION_BAKERHUMANOIDQT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE4EFC0)
#define ROOTMOTION_BAKERHUMANOIDQT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4EDE0)

namespace RootMotion
{
	inline static constexpr unsigned int BakerHumanoidQT_TypeDefinitionIndex = 35972;
