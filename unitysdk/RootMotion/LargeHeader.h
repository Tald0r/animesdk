...
#define ROOTMOTION_LARGEHEADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD01390)
#define ROOTMOTION_LARGEHEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD01340)

namespace RootMotion
{
	inline static constexpr unsigned int LargeHeader_TypeDefinitionIndex = 34994;
