...
#define ROOTMOTION_HUMANOIDBAKER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1ACA4A50)
#define ROOTMOTION_HUMANOIDBAKER_GETCHARACTERROOT_OFFSET UNITYSDK_OFFSET(0x1ACA5150)
#define ROOTMOTION_HUMANOIDBAKER_ONSETCURVES_OFFSET UNITYSDK_OFFSET(0x1ACA5500)
#define ROOTMOTION_HUMANOIDBAKER_ONSETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1ACA5790)
#define ROOTMOTION_HUMANOIDBAKER_ONSETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1ACA52B0)
#define ROOTMOTION_HUMANOIDBAKER_ONSTARTBAKING_OFFSET UNITYSDK_OFFSET(0x1ACA5170)
#define ROOTMOTION_HUMANOIDBAKER_UPDATEHUMANPOSE_OFFSET UNITYSDK_OFFSET(0x1ACA5C10)
#define ROOTMOTION_HUMANOIDBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACA5DF0)

namespace RootMotion
{
	inline static constexpr unsigned int HumanoidBaker_TypeDefinitionIndex = 35975;
