...
#define ROOTMOTION_HUMANOIDBAKER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A6F97F0)
#define ROOTMOTION_HUMANOIDBAKER_GETCHARACTERROOT_OFFSET UNITYSDK_OFFSET(0x1A6F9EF0)
#define ROOTMOTION_HUMANOIDBAKER_ONSETCURVES_OFFSET UNITYSDK_OFFSET(0x1A6FA2A0)
#define ROOTMOTION_HUMANOIDBAKER_ONSETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1A6FA530)
#define ROOTMOTION_HUMANOIDBAKER_ONSETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1A6FA050)
#define ROOTMOTION_HUMANOIDBAKER_ONSTARTBAKING_OFFSET UNITYSDK_OFFSET(0x1A6F9F10)
#define ROOTMOTION_HUMANOIDBAKER_UPDATEHUMANPOSE_OFFSET UNITYSDK_OFFSET(0x1A6FA9B0)
#define ROOTMOTION_HUMANOIDBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6FAB90)

namespace RootMotion
{
	inline static constexpr unsigned int HumanoidBaker_TypeDefinitionIndex = 34973;
