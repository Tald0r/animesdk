...
#define ROOTMOTION_BIPEDREFERENCES_ADDBONETOEYES_OFFSET UNITYSDK_OFFSET(0x1A3C34D0)
#define ROOTMOTION_BIPEDREFERENCES_ADDBONETOHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1A3C3670)
#define ROOTMOTION_BIPEDREFERENCES_ADDBONETOSPINE_OFFSET UNITYSDK_OFFSET(0x1A3C3160)
#define ROOTMOTION_BIPEDREFERENCES_ASSIGNHUMANOIDREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A3C1590)
#define ROOTMOTION_BIPEDREFERENCES_AUTODETECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A3C1150)
#define ROOTMOTION_BIPEDREFERENCES_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A3C0900)
#define ROOTMOTION_BIPEDREFERENCES_DETECTLIMB_OFFSET UNITYSDK_OFFSET(0x1A3C3020)
#define ROOTMOTION_BIPEDREFERENCES_DETECTREFERENCESBYNAMING_OFFSET UNITYSDK_OFFSET(0x1A3C1E00)
#define ROOTMOTION_BIPEDREFERENCES_EYESERROR_OFFSET UNITYSDK_OFFSET(0x1A3C4540)
#define ROOTMOTION_BIPEDREFERENCES_EYESWARNING_OFFSET UNITYSDK_OFFSET(0x1A3C4A80)
#define ROOTMOTION_BIPEDREFERENCES_FACINGAXISWARNING_OFFSET UNITYSDK_OFFSET(0x1A3C4EF0)
#define ROOTMOTION_BIPEDREFERENCES_GETVERTICALOFFSET_OFFSET UNITYSDK_OFFSET(0x1A3C54B0)
#define ROOTMOTION_BIPEDREFERENCES_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A3C0310)
#define ROOTMOTION_BIPEDREFERENCES_GET_ISFILLED_OFFSET UNITYSDK_OFFSET(0x1A3BFD90)
#define ROOTMOTION_BIPEDREFERENCES_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A3C0330)
#define ROOTMOTION_BIPEDREFERENCES_ISNECKBONE_OFFSET UNITYSDK_OFFSET(0x1A3C37E0)
#define ROOTMOTION_BIPEDREFERENCES_LIMBERROR_OFFSET UNITYSDK_OFFSET(0x1A3C3960)
#define ROOTMOTION_BIPEDREFERENCES_LIMBWARNING_OFFSET UNITYSDK_OFFSET(0x1A3C4780)
#define ROOTMOTION_BIPEDREFERENCES_ROOTHEIGHTWARNING_OFFSET UNITYSDK_OFFSET(0x1A3C4A90)
#define ROOTMOTION_BIPEDREFERENCES_SETUPERROR_OFFSET UNITYSDK_OFFSET(0x1A3C2E80)
#define ROOTMOTION_BIPEDREFERENCES_SETUPWARNING_OFFSET UNITYSDK_OFFSET(0x1A3C2F70)
#define ROOTMOTION_BIPEDREFERENCES_SPINEERROR_OFFSET UNITYSDK_OFFSET(0x1A3C4020)
#define ROOTMOTION_BIPEDREFERENCES_SPINEWARNING_OFFSET UNITYSDK_OFFSET(0x1A3C4A70)
#define ROOTMOTION_BIPEDREFERENCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C1550)

namespace RootMotion
{
	inline static constexpr unsigned int BipedReferences_TypeDefinitionIndex = 34981;
