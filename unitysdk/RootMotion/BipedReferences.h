...
#define ROOTMOTION_BIPEDREFERENCES_ADDBONETOEYES_OFFSET UNITYSDK_OFFSET(0x1A987B70)
#define ROOTMOTION_BIPEDREFERENCES_ADDBONETOHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1A987D10)
#define ROOTMOTION_BIPEDREFERENCES_ADDBONETOSPINE_OFFSET UNITYSDK_OFFSET(0x1A987800)
#define ROOTMOTION_BIPEDREFERENCES_ASSIGNHUMANOIDREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A985C30)
#define ROOTMOTION_BIPEDREFERENCES_AUTODETECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A9857F0)
#define ROOTMOTION_BIPEDREFERENCES_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A984FA0)
#define ROOTMOTION_BIPEDREFERENCES_DETECTLIMB_OFFSET UNITYSDK_OFFSET(0x1A9876C0)
#define ROOTMOTION_BIPEDREFERENCES_DETECTREFERENCESBYNAMING_OFFSET UNITYSDK_OFFSET(0x1A9864A0)
#define ROOTMOTION_BIPEDREFERENCES_EYESERROR_OFFSET UNITYSDK_OFFSET(0x1A988BE0)
#define ROOTMOTION_BIPEDREFERENCES_EYESWARNING_OFFSET UNITYSDK_OFFSET(0x1A989120)
#define ROOTMOTION_BIPEDREFERENCES_FACINGAXISWARNING_OFFSET UNITYSDK_OFFSET(0x1A989590)
#define ROOTMOTION_BIPEDREFERENCES_GETVERTICALOFFSET_OFFSET UNITYSDK_OFFSET(0x1A989B50)
#define ROOTMOTION_BIPEDREFERENCES_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A9849B0)
#define ROOTMOTION_BIPEDREFERENCES_GET_ISFILLED_OFFSET UNITYSDK_OFFSET(0x1A984430)
#define ROOTMOTION_BIPEDREFERENCES_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A9849D0)
#define ROOTMOTION_BIPEDREFERENCES_ISNECKBONE_OFFSET UNITYSDK_OFFSET(0x1A987E80)
#define ROOTMOTION_BIPEDREFERENCES_LIMBERROR_OFFSET UNITYSDK_OFFSET(0x1A988000)
#define ROOTMOTION_BIPEDREFERENCES_LIMBWARNING_OFFSET UNITYSDK_OFFSET(0x1A988E20)
#define ROOTMOTION_BIPEDREFERENCES_ROOTHEIGHTWARNING_OFFSET UNITYSDK_OFFSET(0x1A989130)
#define ROOTMOTION_BIPEDREFERENCES_SETUPERROR_OFFSET UNITYSDK_OFFSET(0x1A987520)
#define ROOTMOTION_BIPEDREFERENCES_SETUPWARNING_OFFSET UNITYSDK_OFFSET(0x1A987610)
#define ROOTMOTION_BIPEDREFERENCES_SPINEERROR_OFFSET UNITYSDK_OFFSET(0x1A9886C0)
#define ROOTMOTION_BIPEDREFERENCES_SPINEWARNING_OFFSET UNITYSDK_OFFSET(0x1A989110)
#define ROOTMOTION_BIPEDREFERENCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A985BF0)

namespace RootMotion
{
	inline static constexpr unsigned int BipedReferences_TypeDefinitionIndex = 35983;
