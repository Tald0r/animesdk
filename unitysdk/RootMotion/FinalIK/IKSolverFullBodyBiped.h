...
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_APPLYBENDCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1A810840)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A80FC60)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_DETECTROOTNODEBONE_OFFSET UNITYSDK_OFFSET(0x1A80EFC0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETBENDCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A80C780)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETBODYOFFSET_OFFSET UNITYSDK_OFFSET(0x1A810410)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETCHAIN_1_OFFSET UNITYSDK_OFFSET(0x1A80C130)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETCHAIN_OFFSET UNITYSDK_OFFSET(0x1A80BF90)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A80B8B0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A80C340)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETHANDBODYPULL_OFFSET UNITYSDK_OFFSET(0x1A810650)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETHEADMAPPING_OFFSET UNITYSDK_OFFSET(0x1A80C740)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETLEFTCLAVICLE_OFFSET UNITYSDK_OFFSET(0x1A80F540)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETLIMBMAPPING_1_OFFSET UNITYSDK_OFFSET(0x1A80C550)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETLIMBMAPPING_OFFSET UNITYSDK_OFFSET(0x1A80C440)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETRIGHTCLAVICLE_OFFSET UNITYSDK_OFFSET(0x1A80F780)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETSPINEMAPPING_OFFSET UNITYSDK_OFFSET(0x1A80C730)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_BODYEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A80B870)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_HEADMAPPING_OFFSET UNITYSDK_OFFSET(0x1A80BEF0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTARMCHAIN_OFFSET UNITYSDK_OFFSET(0x1A80BCF0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTARMMAPPING_OFFSET UNITYSDK_OFFSET(0x1A80BDF0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTFOOTEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A80BC70)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A80BBF0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTLEGCHAIN_OFFSET UNITYSDK_OFFSET(0x1A80BD70)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTLEGMAPPING_OFFSET UNITYSDK_OFFSET(0x1A80BE70)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTSHOULDEREFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A80BAF0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTTHIGHEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A80BB70)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_PULLBODYOFFSET_OFFSET UNITYSDK_OFFSET(0x1A80FC20)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTARMCHAIN_OFFSET UNITYSDK_OFFSET(0x1A80BD30)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTARMMAPPING_OFFSET UNITYSDK_OFFSET(0x1A80BE30)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTFOOTEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A80BCB0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A80BC30)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTLEGCHAIN_OFFSET UNITYSDK_OFFSET(0x1A80BDB0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTLEGMAPPING_OFFSET UNITYSDK_OFFSET(0x1A80BEB0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTSHOULDEREFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A80BB30)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTTHIGHEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A80BBB0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A80C890)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_PULLBODY_OFFSET UNITYSDK_OFFSET(0x1A80FF20)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_READPOSE_OFFSET UNITYSDK_OFFSET(0x1A80FDE0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETCHAINWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1A80BF30)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETEFFECTORWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1A80C090)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETLIMBORIENTATIONS_OFFSET UNITYSDK_OFFSET(0x1A80F9C0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETLIMBORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A80FA20)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETTOREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A80CB10)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SET_PULLBODYOFFSET_OFFSET UNITYSDK_OFFSET(0x1A80FC40)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1A810E30)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A810F00)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverFullBodyBiped_TypeDefinitionIndex = 35075;
