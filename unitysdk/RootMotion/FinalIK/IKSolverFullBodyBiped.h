...
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_APPLYBENDCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1AE0C380)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1AE0B7A0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_DETECTROOTNODEBONE_OFFSET UNITYSDK_OFFSET(0x1AE0AB00)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETBENDCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1AE082C0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETBODYOFFSET_OFFSET UNITYSDK_OFFSET(0x1AE0BF50)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETCHAIN_1_OFFSET UNITYSDK_OFFSET(0x1AE07C70)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETCHAIN_OFFSET UNITYSDK_OFFSET(0x1AE07AD0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AE073F0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AE07E80)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETHANDBODYPULL_OFFSET UNITYSDK_OFFSET(0x1AE0C190)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETHEADMAPPING_OFFSET UNITYSDK_OFFSET(0x1AE08280)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETLEFTCLAVICLE_OFFSET UNITYSDK_OFFSET(0x1AE0B080)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETLIMBMAPPING_1_OFFSET UNITYSDK_OFFSET(0x1AE08090)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETLIMBMAPPING_OFFSET UNITYSDK_OFFSET(0x1AE07F80)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETRIGHTCLAVICLE_OFFSET UNITYSDK_OFFSET(0x1AE0B2C0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GETSPINEMAPPING_OFFSET UNITYSDK_OFFSET(0x1AE08270)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_BODYEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AE073B0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_HEADMAPPING_OFFSET UNITYSDK_OFFSET(0x1AE07A30)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTARMCHAIN_OFFSET UNITYSDK_OFFSET(0x1AE07830)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTARMMAPPING_OFFSET UNITYSDK_OFFSET(0x1AE07930)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTFOOTEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AE077B0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AE07730)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTLEGCHAIN_OFFSET UNITYSDK_OFFSET(0x1AE078B0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTLEGMAPPING_OFFSET UNITYSDK_OFFSET(0x1AE079B0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTSHOULDEREFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AE07630)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_LEFTTHIGHEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AE076B0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_PULLBODYOFFSET_OFFSET UNITYSDK_OFFSET(0x1AE0B760)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTARMCHAIN_OFFSET UNITYSDK_OFFSET(0x1AE07870)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTARMMAPPING_OFFSET UNITYSDK_OFFSET(0x1AE07970)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTFOOTEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AE077F0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AE07770)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTLEGCHAIN_OFFSET UNITYSDK_OFFSET(0x1AE078F0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTLEGMAPPING_OFFSET UNITYSDK_OFFSET(0x1AE079F0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTSHOULDEREFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AE07670)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_GET_RIGHTTHIGHEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AE076F0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AE083D0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_PULLBODY_OFFSET UNITYSDK_OFFSET(0x1AE0BA60)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_READPOSE_OFFSET UNITYSDK_OFFSET(0x1AE0B920)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETCHAINWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1AE07A70)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETEFFECTORWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1AE07BD0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETLIMBORIENTATIONS_OFFSET UNITYSDK_OFFSET(0x1AE0B500)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETLIMBORIENTATION_OFFSET UNITYSDK_OFFSET(0x1AE0B560)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SETTOREFERENCES_OFFSET UNITYSDK_OFFSET(0x1AE08650)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_SET_PULLBODYOFFSET_OFFSET UNITYSDK_OFFSET(0x1AE0B780)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1AE0C970)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODYBIPED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE0CA40)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverFullBodyBiped_TypeDefinitionIndex = 36077;
