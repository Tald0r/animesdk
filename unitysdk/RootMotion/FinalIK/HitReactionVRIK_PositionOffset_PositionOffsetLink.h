...
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_POSITIONOFFSETLINK_APPLY_OFFSET UNITYSDK_OFFSET(0x1A811000)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_POSITIONOFFSETLINK_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1A8112C0)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_POSITIONOFFSETLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8112D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReactionVRIK_PositionOffset_PositionOffsetLink_TypeDefinitionIndex = 36161;
