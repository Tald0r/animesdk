...
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_EFFECTORTYPE_OFFSET UNITYSDK_OFFSET(0x1AA5BF40)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_ININTERACTION_OFFSET UNITYSDK_OFFSET(0x1AA5BFA0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_INTERACTIONOBJECT_OFFSET UNITYSDK_OFFSET(0x1AA5BF80)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1AA5BF60)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x1AA5EF30)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_INITIATE_OFFSET UNITYSDK_OFFSET(0x1AA5C050)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_ONPOSTFBBIK_OFFSET UNITYSDK_OFFSET(0x1AA5EFD0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_PAUSE_OFFSET UNITYSDK_OFFSET(0x1AA5CAB0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_PICKUP_OFFSET UNITYSDK_OFFSET(0x1AA5E670)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_RESETTODEFAULTS_OFFSET UNITYSDK_OFFSET(0x1AA5C420)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_RESUME_OFFSET UNITYSDK_OFFSET(0x1AA5CCE0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_SET_EFFECTORTYPE_OFFSET UNITYSDK_OFFSET(0x1AA5BF50)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_SET_INTERACTIONOBJECT_OFFSET UNITYSDK_OFFSET(0x1AA5BF90)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_SET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1AA5BF70)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_START_1_OFFSET UNITYSDK_OFFSET(0x1AA5CF10)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_START_OFFSET UNITYSDK_OFFSET(0x1AA5CD80)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_STOP_OFFSET UNITYSDK_OFFSET(0x1AA5ECF0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_STOREDEFAULTS_OFFSET UNITYSDK_OFFSET(0x1AA5C170)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_TRIGGERUNTRIGGEREDEVENTS_OFFSET UNITYSDK_OFFSET(0x1AA5E380)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AA5D890)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA5C010)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionEffector_TypeDefinitionIndex = 35103;
