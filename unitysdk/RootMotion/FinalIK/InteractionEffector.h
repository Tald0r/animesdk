...
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_EFFECTORTYPE_OFFSET UNITYSDK_OFFSET(0x1B08D8B0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_ININTERACTION_OFFSET UNITYSDK_OFFSET(0x1B08D910)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_INTERACTIONOBJECT_OFFSET UNITYSDK_OFFSET(0x1B08D8F0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1B08D8D0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x1B0908A0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_INITIATE_OFFSET UNITYSDK_OFFSET(0x1B08D9C0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_ONPOSTFBBIK_OFFSET UNITYSDK_OFFSET(0x1B090940)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_PAUSE_OFFSET UNITYSDK_OFFSET(0x1B08E420)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_PICKUP_OFFSET UNITYSDK_OFFSET(0x1B08FFE0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_RESETTODEFAULTS_OFFSET UNITYSDK_OFFSET(0x1B08DD90)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_RESUME_OFFSET UNITYSDK_OFFSET(0x1B08E650)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_SET_EFFECTORTYPE_OFFSET UNITYSDK_OFFSET(0x1B08D8C0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_SET_INTERACTIONOBJECT_OFFSET UNITYSDK_OFFSET(0x1B08D900)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_SET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1B08D8E0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_START_1_OFFSET UNITYSDK_OFFSET(0x1B08E880)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_START_OFFSET UNITYSDK_OFFSET(0x1B08E6F0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_STOP_OFFSET UNITYSDK_OFFSET(0x1B090660)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_STOREDEFAULTS_OFFSET UNITYSDK_OFFSET(0x1B08DAE0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_TRIGGERUNTRIGGEREDEVENTS_OFFSET UNITYSDK_OFFSET(0x1B08FCF0)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B08F200)
#define ROOTMOTION_FINALIK_INTERACTIONEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B08D980)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionEffector_TypeDefinitionIndex = 36105;
