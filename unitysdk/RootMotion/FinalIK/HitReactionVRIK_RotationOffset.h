...
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1AB7A7F0)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1AB7A6E0)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_HIT_OFFSET UNITYSDK_OFFSET(0x1AB7A470)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_ONAPPLY_OFFSET UNITYSDK_OFFSET(0x1AB7A860)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB7AD10)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReactionVRIK_RotationOffset_TypeDefinitionIndex = 35160;
