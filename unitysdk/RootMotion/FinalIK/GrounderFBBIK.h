...
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1B4A3E30)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_INITIATE_OFFSET UNITYSDK_OFFSET(0x1B4A3A30)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_ISREADYTOINITIATE_OFFSET UNITYSDK_OFFSET(0x1B4A38C0)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B4A3E40)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B4A46E0)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_ONPOSTSOLVERUPDATE_OFFSET UNITYSDK_OFFSET(0x1B4A46D0)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_ONSOLVERUPDATE_OFFSET UNITYSDK_OFFSET(0x1B4A3E50)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B4A3830)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_OPENTUTORIAL_OFFSET UNITYSDK_OFFSET(0x1B4A3790)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1B4A37E0)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0x1B4A3880)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_SETLEGIK_OFFSET UNITYSDK_OFFSET(0x1B4A44A0)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B4A3950)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A4880)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GrounderFBBIK_TypeDefinitionIndex = 36020;
