...
#define ROOTMOTION_FINALIK_CCDBENDGOAL_BEFOREIK_OFFSET UNITYSDK_OFFSET(0x1B0DFE40)
#define ROOTMOTION_FINALIK_CCDBENDGOAL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B0E0220)
#define ROOTMOTION_FINALIK_CCDBENDGOAL_START_OFFSET UNITYSDK_OFFSET(0x1B0DFD90)
#define ROOTMOTION_FINALIK_CCDBENDGOAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E0350)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int CCDBendGoal_TypeDefinitionIndex = 36149;
