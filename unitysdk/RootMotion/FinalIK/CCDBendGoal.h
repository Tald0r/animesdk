...
#define ROOTMOTION_FINALIK_CCDBENDGOAL_BEFOREIK_OFFSET UNITYSDK_OFFSET(0x1AAA8950)
#define ROOTMOTION_FINALIK_CCDBENDGOAL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AAA8D30)
#define ROOTMOTION_FINALIK_CCDBENDGOAL_START_OFFSET UNITYSDK_OFFSET(0x1AAA88B0)
#define ROOTMOTION_FINALIK_CCDBENDGOAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAA8E60)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int CCDBendGoal_TypeDefinitionIndex = 35147;
