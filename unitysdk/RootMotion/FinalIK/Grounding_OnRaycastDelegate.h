...
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A561DB0)
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A561EB0)
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A561670)
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A561660)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounding_OnRaycastDelegate_TypeDefinitionIndex = 35026;
