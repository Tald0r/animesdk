...
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB0D480)
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB0D580)
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB0CD40)
#define ROOTMOTION_FINALIK_GROUNDING_ONRAYCASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0CD20)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounding_OnRaycastDelegate_TypeDefinitionIndex = 36028;
