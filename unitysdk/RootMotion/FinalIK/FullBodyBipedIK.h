...
#define ROOTMOTION_FINALIK_FULLBODYBIPEDIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1A3C5B20)
#define ROOTMOTION_FINALIK_FULLBODYBIPEDIK_AUTODETECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A3C6430)
#define ROOTMOTION_FINALIK_FULLBODYBIPEDIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1A3C5B90)
#define ROOTMOTION_FINALIK_FULLBODYBIPEDIK_OPENINSPECTORTUTORIAL_OFFSET UNITYSDK_OFFSET(0x1A3C5A80)
#define ROOTMOTION_FINALIK_FULLBODYBIPEDIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A3C59E0)
#define ROOTMOTION_FINALIK_FULLBODYBIPEDIK_OPENSETUPTUTORIAL_OFFSET UNITYSDK_OFFSET(0x1A3C5A30)
#define ROOTMOTION_FINALIK_FULLBODYBIPEDIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1A3C5990)
#define ROOTMOTION_FINALIK_FULLBODYBIPEDIK_REFERENCESERROR_OFFSET UNITYSDK_OFFSET(0x1A3C5BA0)
#define ROOTMOTION_FINALIK_FULLBODYBIPEDIK_REFERENCESWARNING_OFFSET UNITYSDK_OFFSET(0x1A3C5F00)
#define ROOTMOTION_FINALIK_FULLBODYBIPEDIK_REINITIATE_OFFSET UNITYSDK_OFFSET(0x1A3C6400)
#define ROOTMOTION_FINALIK_FULLBODYBIPEDIK_SETREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A3C5B70)
#define ROOTMOTION_FINALIK_FULLBODYBIPEDIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1A3C5AD0)
#define ROOTMOTION_FINALIK_FULLBODYBIPEDIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C6500)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FullBodyBipedIK_TypeDefinitionIndex = 35036;
