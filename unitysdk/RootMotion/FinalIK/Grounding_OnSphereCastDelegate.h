...
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ACFC300)
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ACFC420)
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ACFBC10)
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACFBC00)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounding_OnSphereCastDelegate_TypeDefinitionIndex = 35028;
