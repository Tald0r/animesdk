...
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B30EEF0)
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B30F010)
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B30E800)
#define ROOTMOTION_FINALIK_GROUNDING_ONSPHERECASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B30E7E0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounding_OnSphereCastDelegate_TypeDefinitionIndex = 36030;
