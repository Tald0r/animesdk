...
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_AUTODETECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A25F020)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_GETTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A24D030)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A25E9E0)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_GET_ISFILLED_OFFSET UNITYSDK_OFFSET(0x1A24C720)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A25E8A0)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A25E890)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VRIK_References_TypeDefinitionIndex = 35045;
