...
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_AUTODETECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A826940)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_GETTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A814950)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A826300)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES_GET_ISFILLED_OFFSET UNITYSDK_OFFSET(0x1A814040)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A8261C0)
#define ROOTMOTION_FINALIK_VRIK_REFERENCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8261B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VRIK_References_TypeDefinitionIndex = 36047;
