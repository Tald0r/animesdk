...
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1AB12B10)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_LIMITROTATION_OFFSET UNITYSDK_OFFSET(0x1AB12B90)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_LIMITSWING_OFFSET UNITYSDK_OFFSET(0x1AB12C20)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AB12A70)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AB12A20)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_SETSPLINE_OFFSET UNITYSDK_OFFSET(0x1AB12B60)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1AB12AC0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITSPLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB13320)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLimitSpline_TypeDefinitionIndex = 36139;
