...
#define ROOTMOTION_FINALIK_EDITORIKPOSE_GET_POSESTORED_OFFSET UNITYSDK_OFFSET(0x1ACFB090)
#define ROOTMOTION_FINALIK_EDITORIKPOSE_RESTORE_OFFSET UNITYSDK_OFFSET(0x1ACFB270)
#define ROOTMOTION_FINALIK_EDITORIKPOSE_STORE_OFFSET UNITYSDK_OFFSET(0x1ACFB0B0)
#define ROOTMOTION_FINALIK_EDITORIKPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACFB4C0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int EditorIKPose_TypeDefinitionIndex = 35149;
