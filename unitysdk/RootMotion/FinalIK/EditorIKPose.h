...
#define ROOTMOTION_FINALIK_EDITORIKPOSE_GET_POSESTORED_OFFSET UNITYSDK_OFFSET(0x1B30DC70)
#define ROOTMOTION_FINALIK_EDITORIKPOSE_RESTORE_OFFSET UNITYSDK_OFFSET(0x1B30DE50)
#define ROOTMOTION_FINALIK_EDITORIKPOSE_STORE_OFFSET UNITYSDK_OFFSET(0x1B30DC90)
#define ROOTMOTION_FINALIK_EDITORIKPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B30E0A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int EditorIKPose_TypeDefinitionIndex = 36151;
