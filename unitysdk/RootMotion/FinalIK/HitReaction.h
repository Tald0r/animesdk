...
#define ROOTMOTION_FINALIK_HITREACTION_GET_INPROGRESS_OFFSET UNITYSDK_OFFSET(0x1AFACED0)
#define ROOTMOTION_FINALIK_HITREACTION_HIT_OFFSET UNITYSDK_OFFSET(0x1AFAD220)
#define ROOTMOTION_FINALIK_HITREACTION_ONMODIFYOFFSET_OFFSET UNITYSDK_OFFSET(0x1AFACF80)
#define ROOTMOTION_FINALIK_HITREACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFAD740)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_TypeDefinitionIndex = 35150;
