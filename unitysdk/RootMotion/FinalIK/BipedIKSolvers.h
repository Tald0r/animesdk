...
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS_ASSIGNREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A249070)
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS_GET_IKSOLVERS_OFFSET UNITYSDK_OFFSET(0x1A248CA0)
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS_GET_LIMBS_OFFSET UNITYSDK_OFFSET(0x1A248A30)
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2493D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int BipedIKSolvers_TypeDefinitionIndex = 35005;
