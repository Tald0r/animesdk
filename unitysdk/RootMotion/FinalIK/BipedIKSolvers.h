...
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS_ASSIGNREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A810990)
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS_GET_IKSOLVERS_OFFSET UNITYSDK_OFFSET(0x1A8105C0)
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS_GET_LIMBS_OFFSET UNITYSDK_OFFSET(0x1A810350)
#define ROOTMOTION_FINALIK_BIPEDIKSOLVERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A810CF0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int BipedIKSolvers_TypeDefinitionIndex = 36007;
