...
#define ROOTMOTION_FINALIK_IKSOLVERCCD_FADEOUTBONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1AEFEBB0)
#define ROOTMOTION_FINALIK_IKSOLVERCCD_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1AEFEC40)
#define ROOTMOTION_FINALIK_IKSOLVERCCD_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AEFED00)
#define ROOTMOTION_FINALIK_IKSOLVERCCD_SOLVE_OFFSET UNITYSDK_OFFSET(0x1AEFF100)
#define ROOTMOTION_FINALIK_IKSOLVERCCD__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEFFD90)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverCCD_TypeDefinitionIndex = 35069;
