...
#define ROOTMOTION_FINALIK_IKSOLVERCCD_FADEOUTBONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1B51C120)
#define ROOTMOTION_FINALIK_IKSOLVERCCD_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1B51C1B0)
#define ROOTMOTION_FINALIK_IKSOLVERCCD_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B51C270)
#define ROOTMOTION_FINALIK_IKSOLVERCCD_SOLVE_OFFSET UNITYSDK_OFFSET(0x1B51C670)
#define ROOTMOTION_FINALIK_IKSOLVERCCD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51D300)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverCCD_TypeDefinitionIndex = 36071;
