...
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1B4A6FA0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_LIMITROTATION_OFFSET UNITYSDK_OFFSET(0x1B4A6FF0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_LIMITSWING_OFFSET UNITYSDK_OFFSET(0x1B4A7080)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B4A6F00)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1B4A6EB0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1B4A6F50)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A75B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLimitAngle_TypeDefinitionIndex = 36134;
