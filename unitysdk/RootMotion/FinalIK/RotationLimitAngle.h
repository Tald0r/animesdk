...
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1AE8BF40)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_LIMITROTATION_OFFSET UNITYSDK_OFFSET(0x1AE8BF90)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_LIMITSWING_OFFSET UNITYSDK_OFFSET(0x1AE8C020)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AE8BEA0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AE8BE50)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1AE8BEF0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE8C550)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLimitAngle_TypeDefinitionIndex = 35132;
