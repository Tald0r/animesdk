...
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6C5540)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6C55D0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6C51B0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6C51A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionSystem_InteractionEventDelegate_TypeDefinitionIndex = 35114;
