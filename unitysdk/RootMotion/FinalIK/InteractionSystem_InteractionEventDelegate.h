...
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AC707A0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AC70830)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AC70400)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC703E0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionSystem_InteractionEventDelegate_TypeDefinitionIndex = 36116;
