...
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_BACKWARDREACH_OFFSET UNITYSDK_OFFSET(0x1AC6BEC0)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AC6A660)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_FORWARDREACH_OFFSET UNITYSDK_OFFSET(0x1AC6BC70)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_INITIATE_OFFSET UNITYSDK_OFFSET(0x1AC6A740)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AC69EA0)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_MAPTOSOLVERPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1AC6C0B0)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_READPOSE_OFFSET UNITYSDK_OFFSET(0x1AC6B240)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_SETBONES_OFFSET UNITYSDK_OFFSET(0x1AC6A540)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1AC6A560)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_USEFABRIK_OFFSET UNITYSDK_OFFSET(0x1AC6B210)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1AC6B790)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AC6A3F0)
#define ROOTMOTION_FINALIK_IKMAPPINGSPINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC6A2E0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMappingSpine_TypeDefinitionIndex = 36062;
