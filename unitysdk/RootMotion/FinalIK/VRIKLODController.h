...
#define ROOTMOTION_FINALIK_VRIKLODCONTROLLER_GETLODLEVEL_OFFSET UNITYSDK_OFFSET(0x1AAB47B0)
#define ROOTMOTION_FINALIK_VRIKLODCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1AAB46E0)
#define ROOTMOTION_FINALIK_VRIKLODCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AAB4770)
#define ROOTMOTION_FINALIK_VRIKLODCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAB4970)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VRIKLODController_TypeDefinitionIndex = 35186;
