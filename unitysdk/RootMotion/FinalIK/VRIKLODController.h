...
#define ROOTMOTION_FINALIK_VRIKLODCONTROLLER_GETLODLEVEL_OFFSET UNITYSDK_OFFSET(0x1B0EBCA0)
#define ROOTMOTION_FINALIK_VRIKLODCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1B0EBBD0)
#define ROOTMOTION_FINALIK_VRIKLODCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B0EBC60)
#define ROOTMOTION_FINALIK_VRIKLODCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EBE60)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VRIKLODController_TypeDefinitionIndex = 36188;
