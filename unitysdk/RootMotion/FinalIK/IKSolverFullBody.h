...
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_APPLYBENDCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1A77E6D0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A77D980)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETCHAINANDNODEINDEXES_OFFSET UNITYSDK_OFFSET(0x1A77CF10)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETCHAININDEX_OFFSET UNITYSDK_OFFSET(0x1A77CC50)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETCHAIN_OFFSET UNITYSDK_OFFSET(0x1A77CC00)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A77CA20)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETNODE_OFFSET UNITYSDK_OFFSET(0x1A77CEA0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1A77CF90)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1A77D1C0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A77D470)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1A77DAD0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A77DD20)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_READPOSE_OFFSET UNITYSDK_OFFSET(0x1A77DEC0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_SOLVE_OFFSET UNITYSDK_OFFSET(0x1A77E230)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1A77D7C0)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1A77E720)
#define ROOTMOTION_FINALIK_IKSOLVERFULLBODY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A77E920)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverFullBody_TypeDefinitionIndex = 35072;
