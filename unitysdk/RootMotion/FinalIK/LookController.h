...
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_CUSTOMROTATETOWARDS_OFFSET UNITYSDK_OFFSET(0x1AE132B0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_CUSTOMSLERP_OFFSET UNITYSDK_OFFSET(0x1AE11AC0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_DOUPDATEONCE_OFFSET UNITYSDK_OFFSET(0x1AE0EF20)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_FIXDIR_OFFSET UNITYSDK_OFFSET(0x1AE108B0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_FIXEDLERP_OFFSET UNITYSDK_OFFSET(0x1AE13260)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_FIXPITCH_OFFSET UNITYSDK_OFFSET(0x1AE13580)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GETROTATEXZDIR_OFFSET UNITYSDK_OFFSET(0x1AE12FB0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x1AE0DCC0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x1AE0DDB0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETPITCHDOWN_OFFSET UNITYSDK_OFFSET(0x1AE0DFE0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETPITCHUP_OFFSET UNITYSDK_OFFSET(0x1AE0DFA0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETSPEEDONCHANGETARGET_OFFSET UNITYSDK_OFFSET(0x1AE0E080)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETSPEEDONGETTARGET_OFFSET UNITYSDK_OFFSET(0x1AE0E060)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETSPEEDONLOCKINGTARGET_OFFSET UNITYSDK_OFFSET(0x1AE0E0C0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETSPEEDONMISSINGTARGET_OFFSET UNITYSDK_OFFSET(0x1AE0E0A0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETYAWLEFT_OFFSET UNITYSDK_OFFSET(0x1AE0E040)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_GETYAWRIGHT_OFFSET UNITYSDK_OFFSET(0x1AE0E020)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_ISVALIDPIVOT_OFFSET UNITYSDK_OFFSET(0x1AE0DE20)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0x1AE0DF20)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_INITSTARTDIR_OFFSET UNITYSDK_OFFSET(0x1AE0E5E0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_ISOUTOFRANGE_OFFSET UNITYSDK_OFFSET(0x1AE13630)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_ISWEIGHTZERO_OFFSET UNITYSDK_OFFSET(0x1AE10510)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE0EF30)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AE0EF10)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_RESTOREIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1AE0F590)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_ROTATEBYHINGERYAWPITCH_OFFSET UNITYSDK_OFFSET(0x1AE12240)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1AE0E0E0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_UPDATEBYSPHERICAL_OFFSET UNITYSDK_OFFSET(0x1AE0FBD0)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_UPDATELOCKINGDIR_OFFSET UNITYSDK_OFFSET(0x1AE10540)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER_UPDATEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AE0F690)
#define ROOTMOTION_FINALIK_LOOKCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE13D60)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int LookController_TypeDefinitionIndex = 36167;
