...
#define ROOTMOTION_FINALIK_IKSOLVERARM_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A812B00)
#define ROOTMOTION_FINALIK_IKSOLVERARM_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1A812180)
#define ROOTMOTION_FINALIK_IKSOLVERARM_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1A812420)
#define ROOTMOTION_FINALIK_IKSOLVERARM_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A811A60)
#define ROOTMOTION_FINALIK_IKSOLVERARM_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1A812B80)
#define ROOTMOTION_FINALIK_IKSOLVERARM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A813390)
#define ROOTMOTION_FINALIK_IKSOLVERARM_READ_OFFSET UNITYSDK_OFFSET(0x1A812C30)
#define ROOTMOTION_FINALIK_IKSOLVERARM_SETCHAIN_OFFSET UNITYSDK_OFFSET(0x1A8120F0)
#define ROOTMOTION_FINALIK_IKSOLVERARM_SOLVE_OFFSET UNITYSDK_OFFSET(0x1A8133C0)
#define ROOTMOTION_FINALIK_IKSOLVERARM_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1A8128B0)
#define ROOTMOTION_FINALIK_IKSOLVERARM_WRITE_OFFSET UNITYSDK_OFFSET(0x1A813480)
#define ROOTMOTION_FINALIK_IKSOLVERARM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A813740)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverArm_TypeDefinitionIndex = 36070;
