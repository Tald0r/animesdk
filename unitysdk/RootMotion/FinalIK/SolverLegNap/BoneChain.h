...
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_APPENDENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1A6F89D0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_ENSURESIZE_OFFSET UNITYSDK_OFFSET(0x1A6F87C0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GETLASTBONEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A6F9160)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GETNODEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A6F8C80)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A6F90F0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1A6F8CD0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A6F8120)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_MULUNIONSCALE_OFFSET UNITYSDK_OFFSET(0x1A6F8920)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_NODEFROMTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A6F8820)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_POSITIONAPPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1A6F9780)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_RESOLVEBONES_OFFSET UNITYSDK_OFFSET(0x1A6F8E00)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_RESOLVEDIRTY_OFFSET UNITYSDK_OFFSET(0x1A6F9770)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SCALEAPPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1A6F97C0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SETFIRSTDIRTY_OFFSET UNITYSDK_OFFSET(0x1A6F8D40)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SETROTATION_OFFSET UNITYSDK_OFFSET(0x1A6F8A50)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SETUPBONECHAINRETURNTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A6F8130)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SETUPBONECHAIN_OFFSET UNITYSDK_OFFSET(0x1A6F8990)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_WRITETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A6F91E0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6F97E0)

namespace RootMotion::FinalIK::SolverLegNap
{
	inline static constexpr unsigned int BoneChain_TypeDefinitionIndex = 35193;
