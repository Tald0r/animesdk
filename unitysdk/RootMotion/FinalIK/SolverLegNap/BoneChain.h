...
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_APPENDENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1ACA3C30)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_ENSURESIZE_OFFSET UNITYSDK_OFFSET(0x1ACA3A20)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GETLASTBONEPOSITION_OFFSET UNITYSDK_OFFSET(0x1ACA43C0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GETNODEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1ACA3EE0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1ACA4350)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1ACA3F30)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1ACA3380)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_MULUNIONSCALE_OFFSET UNITYSDK_OFFSET(0x1ACA3B80)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_NODEFROMTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1ACA3A80)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_POSITIONAPPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1ACA49E0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_RESOLVEBONES_OFFSET UNITYSDK_OFFSET(0x1ACA4060)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_RESOLVEDIRTY_OFFSET UNITYSDK_OFFSET(0x1ACA49D0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SCALEAPPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1ACA4A20)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SETFIRSTDIRTY_OFFSET UNITYSDK_OFFSET(0x1ACA3FA0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SETROTATION_OFFSET UNITYSDK_OFFSET(0x1ACA3CB0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SETUPBONECHAINRETURNTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1ACA3390)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_SETUPBONECHAIN_OFFSET UNITYSDK_OFFSET(0x1ACA3BF0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN_WRITETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1ACA4440)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_BONECHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACA4A40)

namespace RootMotion::FinalIK::SolverLegNap
{
	inline static constexpr unsigned int BoneChain_TypeDefinitionIndex = 36195;
	...
	public:
		...
		::System::Int32 _firstDirty; // 0x1C
		::RootMotion::FinalIK::SolverLegNap::BoneChain_Node rootNode; // 0x20
