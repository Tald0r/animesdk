...
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_DISTANCESQ_OFFSET UNITYSDK_OFFSET(0x1AC72D70)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_GENERATETRANSFORMLIST_OFFSET UNITYSDK_OFFSET(0x1AC72F60)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_GETDISTANCETOPANEL_OFFSET UNITYSDK_OFFSET(0x1AC73550)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_GETTRANSFORMSCACHE_OFFSET UNITYSDK_OFFSET(0x1AC731B0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_ISVALIDBONECHAIN_OFFSET UNITYSDK_OFFSET(0x1AC72DB0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_ROTATEAXISTOABOVEPANEL_OFFSET UNITYSDK_OFFSET(0x1AC73260)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AC73590)

namespace RootMotion::FinalIK::SolverLegNap
{
	inline static constexpr unsigned int IKSolverLegNapUtils_TypeDefinitionIndex = 36200;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Transform*>**)Il2CppClass::FromTypeDefinitionIndex(IKSolverLegNapUtils_TypeDefinitionIndex)->GetStaticField(0x26700);
		}
