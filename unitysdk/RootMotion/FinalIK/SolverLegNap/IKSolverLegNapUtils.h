...
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_DISTANCESQ_OFFSET UNITYSDK_OFFSET(0x1A6C7B10)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_GENERATETRANSFORMLIST_OFFSET UNITYSDK_OFFSET(0x1A6C7D00)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_GETDISTANCETOPANEL_OFFSET UNITYSDK_OFFSET(0x1A6C82F0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_GETTRANSFORMSCACHE_OFFSET UNITYSDK_OFFSET(0x1A6C7F50)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_ISVALIDBONECHAIN_OFFSET UNITYSDK_OFFSET(0x1A6C7B50)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS_ROTATEAXISTOABOVEPANEL_OFFSET UNITYSDK_OFFSET(0x1A6C8000)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_IKSOLVERLEGNAPUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6C8330)

namespace RootMotion::FinalIK::SolverLegNap
{
	inline static constexpr unsigned int IKSolverLegNapUtils_TypeDefinitionIndex = 35198;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Transform*>**)Il2CppClass::FromTypeDefinitionIndex(IKSolverLegNapUtils_TypeDefinitionIndex)->GetStaticField(0x24CD0);
		}
