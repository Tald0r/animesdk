...
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_TWOBONEIKNAP_GETDIRECTIONTOBENDPOINT_OFFSET UNITYSDK_OFFSET(0x1A3D3DB0)
#define ROOTMOTION_FINALIK_SOLVERLEGNAP_TWOBONEIKNAP_SOLVETWOBONEIK_OFFSET UNITYSDK_OFFSET(0x1A3D3870)

namespace RootMotion::FinalIK::SolverLegNap
{
	inline static constexpr unsigned int TwoBoneIKNap_TypeDefinitionIndex = 35199;
