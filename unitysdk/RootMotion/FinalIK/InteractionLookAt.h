...
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_LOOK_OFFSET UNITYSDK_OFFSET(0x1AE8A100)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_ONFIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AE8A3E0)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_SOLVEHEAD_OFFSET UNITYSDK_OFFSET(0x1AE8A8B0)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_SOLVESPINE_OFFSET UNITYSDK_OFFSET(0x1AE8A770)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AE8A480)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE8A9F0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionLookAt_TypeDefinitionIndex = 35104;
