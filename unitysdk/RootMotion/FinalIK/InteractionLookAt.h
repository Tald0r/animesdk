...
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_LOOK_OFFSET UNITYSDK_OFFSET(0x1B4A5160)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_ONFIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1B4A5440)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_SOLVEHEAD_OFFSET UNITYSDK_OFFSET(0x1B4A5910)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_SOLVESPINE_OFFSET UNITYSDK_OFFSET(0x1B4A57D0)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B4A54E0)
#define ROOTMOTION_FINALIK_INTERACTIONLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A5A50)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionLookAt_TypeDefinitionIndex = 36106;
