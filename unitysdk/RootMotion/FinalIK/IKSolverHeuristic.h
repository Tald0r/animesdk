...
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_ADDBONE_OFFSET UNITYSDK_OFFSET(0x1AAAEDB0)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AAAF080)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1AAAF550)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1AAAF560)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_GETSINGULARITYOFFSET_OFFSET UNITYSDK_OFFSET(0x1AAAC010)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_GET_ALLOWCOMMONPARENT_OFFSET UNITYSDK_OFFSET(0x1AAAF760)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_GET_BONELENGTHCANBEZERO_OFFSET UNITYSDK_OFFSET(0x1AAAF750)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_GET_LOCALDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AAAC570)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_GET_MINBONES_OFFSET UNITYSDK_OFFSET(0x1AAAF740)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_GET_POSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1AAAC500)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_INITIATEBONES_OFFSET UNITYSDK_OFFSET(0x1AAAAE20)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AAAF100)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1AAAF770)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AAAF780)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_SETCHAIN_OFFSET UNITYSDK_OFFSET(0x1AAAEB90)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_SINGULARITYDETECTED_OFFSET UNITYSDK_OFFSET(0x1AAAF790)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1AAAEF80)
#define ROOTMOTION_FINALIK_IKSOLVERHEURISTIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAAEB30)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverHeuristic_TypeDefinitionIndex = 35076;
