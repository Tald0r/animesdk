...
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1B3EBD00)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1B3EBBA0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_ONAPPLY_OFFSET UNITYSDK_OFFSET(0x1B3EBD70)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3EC170)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_HitPointEffector_TypeDefinitionIndex = 36154;
