...
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1ADD7130)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1ADD6FD0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_ONAPPLY_OFFSET UNITYSDK_OFFSET(0x1ADD71A0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADD75A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_HitPointEffector_TypeDefinitionIndex = 35152;
