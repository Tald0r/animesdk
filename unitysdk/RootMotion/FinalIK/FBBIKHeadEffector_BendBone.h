...
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AE879F0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1AE879B0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE87990)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE87970)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBBIKHeadEffector_BendBone_TypeDefinitionIndex = 35049;
