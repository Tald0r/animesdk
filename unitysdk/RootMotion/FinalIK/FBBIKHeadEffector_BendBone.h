...
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1B4A2A50)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1B4A2A10)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4A29F0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_BENDBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A29D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBBIKHeadEffector_BendBone_TypeDefinitionIndex = 36051;
