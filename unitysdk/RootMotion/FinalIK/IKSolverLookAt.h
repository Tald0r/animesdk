...
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A98E410)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GETFORWARDS_OFFSET UNITYSDK_OFFSET(0x1A990B60)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1A98EAA0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1A98EE50)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_EYESISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A98EA80)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_EYESISVALID_OFFSET UNITYSDK_OFFSET(0x1A98E8F0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_HEADBASEFORWARD_OFFSET UNITYSDK_OFFSET(0x1A991010)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_HEADISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A98EA00)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_HEADISVALID_OFFSET UNITYSDK_OFFSET(0x1A98E8E0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_SPINEBASEFORWARD_OFFSET UNITYSDK_OFFSET(0x1A991050)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_SPINEISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A98E9E0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_GET_SPINEISVALID_OFFSET UNITYSDK_OFFSET(0x1A98E7F0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A98E580)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1A98F4E0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A98FB70)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETBONES_OFFSET UNITYSDK_OFFSET(0x1A98F300)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETCHAIN_OFFSET UNITYSDK_OFFSET(0x1A98F260)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_1_OFFSET UNITYSDK_OFFSET(0x1A98DDD0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_2_OFFSET UNITYSDK_OFFSET(0x1A98DE20)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_3_OFFSET UNITYSDK_OFFSET(0x1A98DE90)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_4_OFFSET UNITYSDK_OFFSET(0x1A98DF30)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_5_OFFSET UNITYSDK_OFFSET(0x1A98E000)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SETLOOKATWEIGHT_OFFSET UNITYSDK_OFFSET(0x1A98DDA0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SOLVEEYES_OFFSET UNITYSDK_OFFSET(0x1A9904B0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SOLVEHEAD_OFFSET UNITYSDK_OFFSET(0x1A990040)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_SOLVESPINE_OFFSET UNITYSDK_OFFSET(0x1A98FD70)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1A98E120)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9910D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLookAt_TypeDefinitionIndex = 36086;
