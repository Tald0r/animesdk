...
#define ROOTMOTION_FINALIK_INERTIA_BODY_EFFECTORLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB0A00)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Inertia_Body_EffectorLink_TypeDefinitionIndex = 35164;
