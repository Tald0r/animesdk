...
#define ROOTMOTION_FINALIK_OFFSETMODIFIER__INITIATE_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B3ED020)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER__INITIATE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B3ED190)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER__INITIATE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B3ED1F0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER__INITIATE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B3ED1A0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER__INITIATE_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B3ED010)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER__INITIATE_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3ED000)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int OffsetModifier__Initiate_d__8_TypeDefinitionIndex = 36171;
