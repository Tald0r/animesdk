...
#define ROOTMOTION_FINALIK_OFFSETMODIFIER__INITIATE_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1ADD8450)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER__INITIATE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ADD85C0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER__INITIATE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ADD8620)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER__INITIATE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1ADD85D0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER__INITIATE_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ADD8440)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER__INITIATE_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADD8430)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int OffsetModifier__Initiate_d__8_TypeDefinitionIndex = 35169;
