...
#define ROOTMOTION_FINALIK_INERTIA_ONMODIFYOFFSET_OFFSET UNITYSDK_OFFSET(0x1AF00710)
#define ROOTMOTION_FINALIK_INERTIA_RESETBODIES_OFFSET UNITYSDK_OFFSET(0x1AF00690)
#define ROOTMOTION_FINALIK_INERTIA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF007D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Inertia_TypeDefinitionIndex = 35162;
