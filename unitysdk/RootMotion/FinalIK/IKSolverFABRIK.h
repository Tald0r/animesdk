...
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_BACKWARDREACHLIMITED_OFFSET UNITYSDK_OFFSET(0x1B0E5330)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_BACKWARDREACHUNLIMITED_OFFSET UNITYSDK_OFFSET(0x1B0E5DA0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_BACKWARDREACH_OFFSET UNITYSDK_OFFSET(0x1B0E1C40)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_FORWARDREACH_OFFSET UNITYSDK_OFFSET(0x1B0E1800)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_GETIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1B0E1CE0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_GETLIMITEDROTATION_OFFSET UNITYSDK_OFFSET(0x1B0E50E0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_GETPARENTSOLVERPOSITION_OFFSET UNITYSDK_OFFSET(0x1B0E2EF0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_GETPARENTSOLVERROTATION_OFFSET UNITYSDK_OFFSET(0x1B0E2D30)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_GET_BONELENGTHCANBEZERO_OFFSET UNITYSDK_OFFSET(0x1B0E3D00)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_LIMITFORWARD_OFFSET UNITYSDK_OFFSET(0x1B0E4110)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_MAPTOSOLVERPOSITIONSLIMITED_OFFSET UNITYSDK_OFFSET(0x1B0E3FF0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_MAPTOSOLVERPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1B0E3E10)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1B0E1DA0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_ONPOSTSOLVE_OFFSET UNITYSDK_OFFSET(0x1B0E1C90)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_ONPRESOLVE_OFFSET UNITYSDK_OFFSET(0x1B0E0F70)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0E30D0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_SOLVEBACKWARD_OFFSET UNITYSDK_OFFSET(0x1B0E1AF0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_SOLVEFORWARD_OFFSET UNITYSDK_OFFSET(0x1B0E0E80)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_SOLVEJOINT_OFFSET UNITYSDK_OFFSET(0x1B0E3D10)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_SOLVERMOVECHILDRENAROUNDPOINT_OFFSET UNITYSDK_OFFSET(0x1B0E4EB0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_SOLVERMOVE_OFFSET UNITYSDK_OFFSET(0x1B0E4B20)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_SOLVERROTATECHILDREN_OFFSET UNITYSDK_OFFSET(0x1B0E4D80)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_SOLVERROTATE_OFFSET UNITYSDK_OFFSET(0x1B0E4BA0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK_SOLVE_OFFSET UNITYSDK_OFFSET(0x1B0E3C00)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E5FA0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverFABRIK_TypeDefinitionIndex = 36072;
