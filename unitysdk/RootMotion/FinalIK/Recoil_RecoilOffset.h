...
#define ROOTMOTION_FINALIK_RECOIL_RECOILOFFSET_APPLY_OFFSET UNITYSDK_OFFSET(0x1ADD86E0)
#define ROOTMOTION_FINALIK_RECOIL_RECOILOFFSET_START_OFFSET UNITYSDK_OFFSET(0x1ADD8630)
#define ROOTMOTION_FINALIK_RECOIL_RECOILOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADD8A10)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Recoil_RecoilOffset_TypeDefinitionIndex = 35178;
