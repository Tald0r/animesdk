...
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_APPLY_OFFSET UNITYSDK_OFFSET(0x1AA57C40)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_GET_CROSSFADER_OFFSET UNITYSDK_OFFSET(0x1AA57A90)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_GET_FORCE_OFFSET UNITYSDK_OFFSET(0x1AA57AD0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_GET_INPROGRESS_OFFSET UNITYSDK_OFFSET(0x1AA57A80)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_GET_TIMER_OFFSET UNITYSDK_OFFSET(0x1AA57AB0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_HIT_OFFSET UNITYSDK_OFFSET(0x1AA57B00)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_SET_CROSSFADER_OFFSET UNITYSDK_OFFSET(0x1AA57AA0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_SET_FORCE_OFFSET UNITYSDK_OFFSET(0x1AA57AF0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT_SET_TIMER_OFFSET UNITYSDK_OFFSET(0x1AA57AC0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA57D20)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_HitPoint_TypeDefinitionIndex = 35151;
