...
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_ROTATIONOFFSETLINK_APPLY_OFFSET UNITYSDK_OFFSET(0x1AA57D30)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_ROTATIONOFFSETLINK_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1AA57E30)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_ROTATIONOFFSET_ROTATIONOFFSETLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA57E40)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReactionVRIK_RotationOffset_RotationOffsetLink_TypeDefinitionIndex = 35161;
