...
#define ROOTMOTION_FINALIK_POSER_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A997E90)
#define ROOTMOTION_FINALIK_POSER_INITIATESOLVER_OFFSET UNITYSDK_OFFSET(0x1A997E60)
#define ROOTMOTION_FINALIK_POSER_UPDATEMANUAL_OFFSET UNITYSDK_OFFSET(0x1A997E10)
#define ROOTMOTION_FINALIK_POSER_UPDATESOLVER_OFFSET UNITYSDK_OFFSET(0x1A997E20)
#define ROOTMOTION_FINALIK_POSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A997EB0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Poser_TypeDefinitionIndex = 36128;
