...
#define ROOTMOTION_FINALIK_ARMIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1A560D80)
#define ROOTMOTION_FINALIK_ARMIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1A560DD0)
#define ROOTMOTION_FINALIK_ARMIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A560E30)
#define ROOTMOTION_FINALIK_ARMIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A560CE0)
#define ROOTMOTION_FINALIK_ARMIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1A560C90)
#define ROOTMOTION_FINALIK_ARMIK_SETTARGETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1A560DE0)
#define ROOTMOTION_FINALIK_ARMIK_START_OFFSET UNITYSDK_OFFSET(0x1A560DF0)
#define ROOTMOTION_FINALIK_ARMIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1A560D30)
#define ROOTMOTION_FINALIK_ARMIK_UPDATEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1A5610F0)
#define ROOTMOTION_FINALIK_ARMIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5612A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ArmIK_TypeDefinitionIndex = 35032;
