...
#define ROOTMOTION_FINALIK_ARMIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1AB0C440)
#define ROOTMOTION_FINALIK_ARMIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1AB0C490)
#define ROOTMOTION_FINALIK_ARMIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB0C4F0)
#define ROOTMOTION_FINALIK_ARMIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AB0C3A0)
#define ROOTMOTION_FINALIK_ARMIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AB0C350)
#define ROOTMOTION_FINALIK_ARMIK_SETTARGETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AB0C4A0)
#define ROOTMOTION_FINALIK_ARMIK_START_OFFSET UNITYSDK_OFFSET(0x1AB0C4B0)
#define ROOTMOTION_FINALIK_ARMIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1AB0C3F0)
#define ROOTMOTION_FINALIK_ARMIK_UPDATEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AB0C7B0)
#define ROOTMOTION_FINALIK_ARMIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0C960)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ArmIK_TypeDefinitionIndex = 36034;
