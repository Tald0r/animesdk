...
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1B19DB40)
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE_LIMITHINGE_OFFSET UNITYSDK_OFFSET(0x1B19DBD0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE_LIMITROTATION_OFFSET UNITYSDK_OFFSET(0x1B19DB90)
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B19DAA0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1B19DA50)
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1B19DAF0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITHINGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B19DFD0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLimitHinge_TypeDefinitionIndex = 36135;
