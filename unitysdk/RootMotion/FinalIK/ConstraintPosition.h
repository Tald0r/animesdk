...
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITION_UPDATECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A6B8F70)
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6B90C0)
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B90B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ConstraintPosition_TypeDefinitionIndex = 35007;
