...
#define ROOTMOTION_FINALIK_GENERICPOSER_MAP_FIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AE885D0)
#define ROOTMOTION_FINALIK_GENERICPOSER_MAP_STOREDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x1AE88630)
#define ROOTMOTION_FINALIK_GENERICPOSER_MAP_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AE88340)
#define ROOTMOTION_FINALIK_GENERICPOSER_MAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE88070)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GenericPoser_Map_TypeDefinitionIndex = 35124;
