...
#define ROOTMOTION_FINALIK_GENERICPOSER_MAP_FIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B4A3630)
#define ROOTMOTION_FINALIK_GENERICPOSER_MAP_STOREDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x1B4A3690)
#define ROOTMOTION_FINALIK_GENERICPOSER_MAP_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B4A33A0)
#define ROOTMOTION_FINALIK_GENERICPOSER_MAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A30D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GenericPoser_Map_TypeDefinitionIndex = 36126;
