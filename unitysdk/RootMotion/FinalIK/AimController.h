...
#define ROOTMOTION_FINALIK_AIMCONTROLLER_APPLYMINDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AE560A0)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_FIXEDLERP_OFFSET UNITYSDK_OFFSET(0x1AE56050)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0x1AE53950)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_INNERHANDLETARGETOFFSET_OFFSET UNITYSDK_OFFSET(0x1AE53B60)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_INNERUPDATEAIMCOORDINATEOFFSET_OFFSET UNITYSDK_OFFSET(0x1AE53C00)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AE54390)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_ROOTROTATION_OFFSET UNITYSDK_OFFSET(0x1AE56210)
#define ROOTMOTION_FINALIK_AIMCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1AE53800)
#define ROOTMOTION_FINALIK_AIMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE56730)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int AimController_TypeDefinitionIndex = 36140;
