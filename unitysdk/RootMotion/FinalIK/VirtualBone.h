...
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x1B19E080)
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_LOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1B19E010)
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_LOCALROTATION_OFFSET UNITYSDK_OFFSET(0x1B19E040)
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1B19E060)
#define ROOTMOTION_FINALIK_VIRTUALBONE_SET_LOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1B19E030)
#define ROOTMOTION_FINALIK_VIRTUALBONE_SET_LOCALROTATION_OFFSET UNITYSDK_OFFSET(0x1B19E050)
#define ROOTMOTION_FINALIK_VIRTUALBONE_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1B19E070)
#define ROOTMOTION_FINALIK_VIRTUALBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B19E090)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VirtualBone_TypeDefinitionIndex = 36191;
