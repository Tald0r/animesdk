...
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x1AB7E2D0)
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_LOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1AB7E260)
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_LOCALROTATION_OFFSET UNITYSDK_OFFSET(0x1AB7E290)
#define ROOTMOTION_FINALIK_VIRTUALBONE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1AB7E2B0)
#define ROOTMOTION_FINALIK_VIRTUALBONE_SET_LOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1AB7E280)
#define ROOTMOTION_FINALIK_VIRTUALBONE_SET_LOCALROTATION_OFFSET UNITYSDK_OFFSET(0x1AB7E2A0)
#define ROOTMOTION_FINALIK_VIRTUALBONE_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1AB7E2C0)
#define ROOTMOTION_FINALIK_VIRTUALBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB7E2E0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VirtualBone_TypeDefinitionIndex = 35189;
