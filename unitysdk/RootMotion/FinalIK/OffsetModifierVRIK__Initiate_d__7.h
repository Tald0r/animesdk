...
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AD23E10)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD23F80)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD23FE0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AD23F90)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD23E00)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__INITIATE_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD23DF0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int OffsetModifierVRIK__Initiate_d__7_TypeDefinitionIndex = 36173;

	class OffsetModifierVRIK__Initiate_d__7 : public ::System::Object
	{
	public:
		::RootMotion::FinalIK::OffsetModifierVRIK* __4__this; // 0x10
