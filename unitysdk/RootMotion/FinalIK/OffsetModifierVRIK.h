...
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x1AE8AA00)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK_INITIATE_OFFSET UNITYSDK_OFFSET(0x1AE8AAE0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK_MODIFYOFFSET_OFFSET UNITYSDK_OFFSET(0x1AE8AB30)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AE8AC10)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK_START_OFFSET UNITYSDK_OFFSET(0x1AE8AA20)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE8A0E0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int OffsetModifierVRIK_TypeDefinitionIndex = 35170;
