...
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x1B4A5A60)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK_INITIATE_OFFSET UNITYSDK_OFFSET(0x1B4A5B40)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK_MODIFYOFFSET_OFFSET UNITYSDK_OFFSET(0x1B4A5B90)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B4A5C70)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK_START_OFFSET UNITYSDK_OFFSET(0x1B4A5A80)
#define ROOTMOTION_FINALIK_OFFSETMODIFIERVRIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A5140)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int OffsetModifierVRIK_TypeDefinitionIndex = 36172;
