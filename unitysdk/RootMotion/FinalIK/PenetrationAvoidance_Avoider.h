...
#define ROOTMOTION_FINALIK_PENETRATIONAVOIDANCE_AVOIDER_GETOFFSETTARGET_OFFSET UNITYSDK_OFFSET(0x1B4A5FA0)
#define ROOTMOTION_FINALIK_PENETRATIONAVOIDANCE_AVOIDER_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1B4A6130)
#define ROOTMOTION_FINALIK_PENETRATIONAVOIDANCE_AVOIDER_SOLVE_OFFSET UNITYSDK_OFFSET(0x1B4A5DA0)
#define ROOTMOTION_FINALIK_PENETRATIONAVOIDANCE_AVOIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A6650)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int PenetrationAvoidance_Avoider_TypeDefinitionIndex = 36177;
