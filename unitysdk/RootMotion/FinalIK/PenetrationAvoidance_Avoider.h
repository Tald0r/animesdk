...
#define ROOTMOTION_FINALIK_PENETRATIONAVOIDANCE_AVOIDER_GETOFFSETTARGET_OFFSET UNITYSDK_OFFSET(0x1AE8AF40)
#define ROOTMOTION_FINALIK_PENETRATIONAVOIDANCE_AVOIDER_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1AE8B0D0)
#define ROOTMOTION_FINALIK_PENETRATIONAVOIDANCE_AVOIDER_SOLVE_OFFSET UNITYSDK_OFFSET(0x1AE8AD40)
#define ROOTMOTION_FINALIK_PENETRATIONAVOIDANCE_AVOIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE8B5F0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int PenetrationAvoidance_Avoider_TypeDefinitionIndex = 35175;
