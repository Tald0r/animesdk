...
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A827170)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_CALIBRATE_1_OFFSET UNITYSDK_OFFSET(0x1A8277F0)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_CALIBRATE_OFFSET UNITYSDK_OFFSET(0x1A827290)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_GET_PELVISTARGETRIGHT_OFFSET UNITYSDK_OFFSET(0x1A827140)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A828450)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_ONPREUPDATE_OFFSET UNITYSDK_OFFSET(0x1A827A40)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER_SET_PELVISTARGETRIGHT_OFFSET UNITYSDK_OFFSET(0x1A827160)
#define ROOTMOTION_FINALIK_VRIKROOTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A828580)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VRIKRootController_TypeDefinitionIndex = 36189;
