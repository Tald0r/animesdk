...
#define ROOTMOTION_FINALIK_AIMPOSER_GETPOSE_OFFSET UNITYSDK_OFFSET(0x1A3C55B0)
#define ROOTMOTION_FINALIK_AIMPOSER_SETPOSEACTIVE_OFFSET UNITYSDK_OFFSET(0x1A3C56B0)
#define ROOTMOTION_FINALIK_AIMPOSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C5710)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int AimPoser_TypeDefinitionIndex = 35141;
