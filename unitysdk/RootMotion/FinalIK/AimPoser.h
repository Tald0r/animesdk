...
#define ROOTMOTION_FINALIK_AIMPOSER_GETPOSE_OFFSET UNITYSDK_OFFSET(0x1A989C50)
#define ROOTMOTION_FINALIK_AIMPOSER_SETPOSEACTIVE_OFFSET UNITYSDK_OFFSET(0x1A989D50)
#define ROOTMOTION_FINALIK_AIMPOSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A989DB0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int AimPoser_TypeDefinitionIndex = 36143;
