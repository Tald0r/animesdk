...
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1A98B510)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1A98B470)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_HIT_OFFSET UNITYSDK_OFFSET(0x1A98B200)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_ONAPPLY_OFFSET UNITYSDK_OFFSET(0x1A98B580)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A98B680)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_HitPointBone_TypeDefinitionIndex = 36156;
