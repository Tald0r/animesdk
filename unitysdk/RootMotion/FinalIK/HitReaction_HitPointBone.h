...
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1A3C6E70)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1A3C6DD0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_HIT_OFFSET UNITYSDK_OFFSET(0x1A3C6B60)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE_ONAPPLY_OFFSET UNITYSDK_OFFSET(0x1A3C6EE0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C6FE0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_HitPointBone_TypeDefinitionIndex = 35154;
