...
#define ROOTMOTION_FINALIK_EDITORIK_GET_IK_OFFSET UNITYSDK_OFFSET(0x1AE867A0)
#define ROOTMOTION_FINALIK_EDITORIK_INITIATE_OFFSET UNITYSDK_OFFSET(0x1AE86F40)
#define ROOTMOTION_FINALIK_EDITORIK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AE86BF0)
#define ROOTMOTION_FINALIK_EDITORIK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AE86A90)
#define ROOTMOTION_FINALIK_EDITORIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AE867C0)
#define ROOTMOTION_FINALIK_EDITORIK_SET_IK_OFFSET UNITYSDK_OFFSET(0x1AE867B0)
#define ROOTMOTION_FINALIK_EDITORIK_STOREDEFAULTPOSE_OFFSET UNITYSDK_OFFSET(0x1AE86E60)
#define ROOTMOTION_FINALIK_EDITORIK_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AE87300)
#define ROOTMOTION_FINALIK_EDITORIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE87710)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int EditorIK_TypeDefinitionIndex = 35148;
