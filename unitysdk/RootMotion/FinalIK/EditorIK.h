...
#define ROOTMOTION_FINALIK_EDITORIK_GET_IK_OFFSET UNITYSDK_OFFSET(0x1B4A1800)
#define ROOTMOTION_FINALIK_EDITORIK_INITIATE_OFFSET UNITYSDK_OFFSET(0x1B4A1FA0)
#define ROOTMOTION_FINALIK_EDITORIK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B4A1C50)
#define ROOTMOTION_FINALIK_EDITORIK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B4A1AF0)
#define ROOTMOTION_FINALIK_EDITORIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B4A1820)
#define ROOTMOTION_FINALIK_EDITORIK_SET_IK_OFFSET UNITYSDK_OFFSET(0x1B4A1810)
#define ROOTMOTION_FINALIK_EDITORIK_STOREDEFAULTPOSE_OFFSET UNITYSDK_OFFSET(0x1B4A1EC0)
#define ROOTMOTION_FINALIK_EDITORIK_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B4A2360)
#define ROOTMOTION_FINALIK_EDITORIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A2770)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int EditorIK_TypeDefinitionIndex = 36150;
