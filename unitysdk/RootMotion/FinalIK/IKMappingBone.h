...
#define ROOTMOTION_FINALIK_IKMAPPINGBONE_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A899830)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE_INITIATE_OFFSET UNITYSDK_OFFSET(0x1A899870)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A899620)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE_READPOSE_OFFSET UNITYSDK_OFFSET(0x1A8998F0)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1A8997A0)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1A899940)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A899730)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8996D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMappingBone_TypeDefinitionIndex = 35057;
