...
#define ROOTMOTION_FINALIK_IKMAPPINGBONE_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AE5B690)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE_INITIATE_OFFSET UNITYSDK_OFFSET(0x1AE5B6D0)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AE5B480)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE_READPOSE_OFFSET UNITYSDK_OFFSET(0x1AE5B750)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1AE5B600)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1AE5B7A0)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE5B590)
#define ROOTMOTION_FINALIK_IKMAPPINGBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE5B530)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMappingBone_TypeDefinitionIndex = 36059;
