...
#define ROOTMOTION_FINALIK_FABRIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1AE07250)
#define ROOTMOTION_FINALIK_FABRIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1AE072A0)
#define ROOTMOTION_FINALIK_FABRIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AE071B0)
#define ROOTMOTION_FINALIK_FABRIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AE07160)
#define ROOTMOTION_FINALIK_FABRIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1AE07200)
#define ROOTMOTION_FINALIK_FABRIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE072B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FABRIK_TypeDefinitionIndex = 36036;
