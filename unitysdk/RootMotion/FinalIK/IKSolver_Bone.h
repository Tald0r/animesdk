...
#define ROOTMOTION_FINALIK_IKSOLVER_BONE_GET_ROTATIONLIMIT_OFFSET UNITYSDK_OFFSET(0x1A3C6FF0)
#define ROOTMOTION_FINALIK_IKSOLVER_BONE_SETTOSOLVERPOSITION_OFFSET UNITYSDK_OFFSET(0x1A3C7E40)
#define ROOTMOTION_FINALIK_IKSOLVER_BONE_SET_ROTATIONLIMIT_OFFSET UNITYSDK_OFFSET(0x1A3C7170)
#define ROOTMOTION_FINALIK_IKSOLVER_BONE_SOLVERSWING_OFFSET UNITYSDK_OFFSET(0x1A3C76C0)
#define ROOTMOTION_FINALIK_IKSOLVER_BONE_SWING2D_OFFSET UNITYSDK_OFFSET(0x1A3C7AF0)
#define ROOTMOTION_FINALIK_IKSOLVER_BONE_SWING_OFFSET UNITYSDK_OFFSET(0x1A3C71E0)
#define ROOTMOTION_FINALIK_IKSOLVER_BONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3C7EC0)
#define ROOTMOTION_FINALIK_IKSOLVER_BONE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A3C7F10)
#define ROOTMOTION_FINALIK_IKSOLVER_BONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C7E80)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolver_Bone_TypeDefinitionIndex = 35063;
