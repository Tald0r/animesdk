...
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE_CALCULATE_OFFSET UNITYSDK_OFFSET(0x1B0EB950)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE_GET_A_OFFSET UNITYSDK_OFFSET(0x1B0EB730)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE_GET_B_OFFSET UNITYSDK_OFFSET(0x1B0EB770)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE_GET_C_OFFSET UNITYSDK_OFFSET(0x1B0EB7B0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B0EB940)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE_GET_O_OFFSET UNITYSDK_OFFSET(0x1B0EB6F0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EB7F0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLimitPolygonal_ReachCone_TypeDefinitionIndex = 36137;
