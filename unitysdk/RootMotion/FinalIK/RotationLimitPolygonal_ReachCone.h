...
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE_CALCULATE_OFFSET UNITYSDK_OFFSET(0x1AAB4460)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE_GET_A_OFFSET UNITYSDK_OFFSET(0x1AAB4240)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE_GET_B_OFFSET UNITYSDK_OFFSET(0x1AAB4280)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE_GET_C_OFFSET UNITYSDK_OFFSET(0x1AAB42C0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AAB4450)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE_GET_O_OFFSET UNITYSDK_OFFSET(0x1AAB4200)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_REACHCONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAB4300)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLimitPolygonal_ReachCone_TypeDefinitionIndex = 35135;
