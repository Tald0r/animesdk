...
#define ROOTMOTION_FINALIK_TWISTSOLVER_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A568BB0)
#define ROOTMOTION_FINALIK_TWISTSOLVER_INITIATE_OFFSET UNITYSDK_OFFSET(0x1A567ED0)
#define ROOTMOTION_FINALIK_TWISTSOLVER_RELAX_OFFSET UNITYSDK_OFFSET(0x1A568C90)
#define ROOTMOTION_FINALIK_TWISTSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A567E60)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int TwistSolver_TypeDefinitionIndex = 35102;
