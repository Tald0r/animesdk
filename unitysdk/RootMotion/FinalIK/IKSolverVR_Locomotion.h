...
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_ADDDELTAPOSITION_ANIMATED_OFFSET UNITYSDK_OFFSET(0x1A8224C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_ADDDELTAPOSITION_OFFSET UNITYSDK_OFFSET(0x1A815F30)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_ADDDELTAPOSITION_PROCEDURAL_OFFSET UNITYSDK_OFFSET(0x1A8223C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_ADDDELTAROTATION_ANIMATED_OFFSET UNITYSDK_OFFSET(0x1A822030)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_ADDDELTAROTATION_OFFSET UNITYSDK_OFFSET(0x1A815FB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_ADDDELTAROTATION_PROCEDURAL_OFFSET UNITYSDK_OFFSET(0x1A821900)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_CANSTEP_OFFSET UNITYSDK_OFFSET(0x1A822920)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_GETLINESPHERECOLLISION_OFFSET UNITYSDK_OFFSET(0x1A8229C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_GET_CENTEROFMASS_OFFSET UNITYSDK_OFFSET(0x1A822600)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_GET_LEFTFOOTSTEPPOSITION_OFFSET UNITYSDK_OFFSET(0x1A822C60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_GET_LEFTFOOTSTEPROTATION_OFFSET UNITYSDK_OFFSET(0x1A822D10)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_GET_RIGHTFOOTSTEPPOSITION_OFFSET UNITYSDK_OFFSET(0x1A822CB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_GET_RIGHTFOOTSTEPROTATION_OFFSET UNITYSDK_OFFSET(0x1A822D60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_INITIATE_ANIMATED_OFFSET UNITYSDK_OFFSET(0x1A821220)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_INITIATE_OFFSET UNITYSDK_OFFSET(0x1A81BBE0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_INITIATE_PROCEDURAL_OFFSET UNITYSDK_OFFSET(0x1A820C20)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_RELAX_OFFSET UNITYSDK_OFFSET(0x1A821880)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_RELAX_PROCEDURAL_OFFSET UNITYSDK_OFFSET(0x1A821890)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_RESETPARAMS_OFFSET UNITYSDK_OFFSET(0x1A822550)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_RESET_ANIMATED_OFFSET UNITYSDK_OFFSET(0x1A81E150)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_RESET_OFFSET UNITYSDK_OFFSET(0x1A8170F0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_RESET_PROCEDURAL_OFFSET UNITYSDK_OFFSET(0x1A821410)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_SET_CENTEROFMASS_OFFSET UNITYSDK_OFFSET(0x1A822620)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_SOLVE_ANIMATED_OFFSET UNITYSDK_OFFSET(0x1A81E3F0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_SOLVE_PROCEDURAL_OFFSET UNITYSDK_OFFSET(0x1A81BC30)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_STEPBLOCKED_OFFSET UNITYSDK_OFFSET(0x1A822640)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A820AD0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Locomotion_TypeDefinitionIndex = 36096;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(IKSolverVR_Locomotion_TypeDefinitionIndex)->GetStaticField(0x8860);
		}
		static ::System::Int32* StaticGet_VRIK_Horizontal()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(IKSolverVR_Locomotion_TypeDefinitionIndex)->GetStaticField(0x8864);
		}
		static ::System::Boolean* StaticGet_isHashed()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(IKSolverVR_Locomotion_TypeDefinitionIndex)->GetStaticField(0x8868);
		}
		static ::System::Int32* StaticGet_VRIK_Vertical()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(IKSolverVR_Locomotion_TypeDefinitionIndex)->GetStaticField(0x886C);
		}
		static ::System::Int32* StaticGet_VRIK_Speed()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(IKSolverVR_Locomotion_TypeDefinitionIndex)->GetStaticField(0x8870);
		}
		static ::System::Int32* StaticGet_VRIK_IsMoving()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(IKSolverVR_Locomotion_TypeDefinitionIndex)->GetStaticField(0x8874);
		}
