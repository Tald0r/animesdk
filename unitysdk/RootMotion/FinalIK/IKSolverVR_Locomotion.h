...
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_ADDDELTAPOSITION_ANIMATED_OFFSET UNITYSDK_OFFSET(0x1A25ABA0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_ADDDELTAPOSITION_OFFSET UNITYSDK_OFFSET(0x1A24E610)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_ADDDELTAPOSITION_PROCEDURAL_OFFSET UNITYSDK_OFFSET(0x1A25AAA0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_ADDDELTAROTATION_ANIMATED_OFFSET UNITYSDK_OFFSET(0x1A25A710)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_ADDDELTAROTATION_OFFSET UNITYSDK_OFFSET(0x1A24E690)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_ADDDELTAROTATION_PROCEDURAL_OFFSET UNITYSDK_OFFSET(0x1A259FE0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_CANSTEP_OFFSET UNITYSDK_OFFSET(0x1A25B000)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_GETLINESPHERECOLLISION_OFFSET UNITYSDK_OFFSET(0x1A25B0A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_GET_CENTEROFMASS_OFFSET UNITYSDK_OFFSET(0x1A25ACE0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_GET_LEFTFOOTSTEPPOSITION_OFFSET UNITYSDK_OFFSET(0x1A25B340)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_GET_LEFTFOOTSTEPROTATION_OFFSET UNITYSDK_OFFSET(0x1A25B3F0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_GET_RIGHTFOOTSTEPPOSITION_OFFSET UNITYSDK_OFFSET(0x1A25B390)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_GET_RIGHTFOOTSTEPROTATION_OFFSET UNITYSDK_OFFSET(0x1A25B440)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_INITIATE_ANIMATED_OFFSET UNITYSDK_OFFSET(0x1A259900)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_INITIATE_OFFSET UNITYSDK_OFFSET(0x1A2542C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_INITIATE_PROCEDURAL_OFFSET UNITYSDK_OFFSET(0x1A259300)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_RELAX_OFFSET UNITYSDK_OFFSET(0x1A259F60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_RELAX_PROCEDURAL_OFFSET UNITYSDK_OFFSET(0x1A259F70)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_RESETPARAMS_OFFSET UNITYSDK_OFFSET(0x1A25AC30)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_RESET_ANIMATED_OFFSET UNITYSDK_OFFSET(0x1A256830)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_RESET_OFFSET UNITYSDK_OFFSET(0x1A24F7D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_RESET_PROCEDURAL_OFFSET UNITYSDK_OFFSET(0x1A259AF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_SET_CENTEROFMASS_OFFSET UNITYSDK_OFFSET(0x1A25AD00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_SOLVE_ANIMATED_OFFSET UNITYSDK_OFFSET(0x1A256AD0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_SOLVE_PROCEDURAL_OFFSET UNITYSDK_OFFSET(0x1A254310)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION_STEPBLOCKED_OFFSET UNITYSDK_OFFSET(0x1A25AD20)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LOCOMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2591B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Locomotion_TypeDefinitionIndex = 35094;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(IKSolverVR_Locomotion_TypeDefinitionIndex)->GetStaticField(0x8500);
		}
		static ::System::Int32* StaticGet_VRIK_Turn()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(IKSolverVR_Locomotion_TypeDefinitionIndex)->GetStaticField(0x8504);
		}
		static ::System::Int32* StaticGet_VRIK_Vertical()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(IKSolverVR_Locomotion_TypeDefinitionIndex)->GetStaticField(0x8508);
		}
		static ::System::Int32* StaticGet_VRIK_Horizontal()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(IKSolverVR_Locomotion_TypeDefinitionIndex)->GetStaticField(0x850C);
		}
		static ::System::Int32* StaticGet_VRIK_IsMoving()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(IKSolverVR_Locomotion_TypeDefinitionIndex)->GetStaticField(0x8510);
		}
		static ::System::Boolean* StaticGet_isHashed()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(IKSolverVR_Locomotion_TypeDefinitionIndex)->GetStaticField(0x8514);
		}
