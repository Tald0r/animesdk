...
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_APPLYLIMITS_OFFSET UNITYSDK_OFFSET(0x1B091110)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x1B090F00)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_INITIATE_OFFSET UNITYSDK_OFFSET(0x1B090FE0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_MODIFYOFFSET_OFFSET UNITYSDK_OFFSET(0x1B091030)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B091220)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_START_OFFSET UNITYSDK_OFFSET(0x1B090F20)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B091350)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int OffsetModifier_TypeDefinitionIndex = 36169;
