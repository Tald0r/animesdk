...
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_TRIGONOMETRICCONTEXT_DOSOLVE_OFFSET UNITYSDK_OFFSET(0x953170)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_TRIGONOMETRICCONTEXT_FIXTWISTROTATIONS_OFFSET UNITYSDK_OFFSET(0x9531C0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_TRIGONOMETRICCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x953160)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLegNap_TrigonometricContext_TypeDefinitionIndex = 35080;
