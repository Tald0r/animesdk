...
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_TRIGONOMETRICCONTEXT_DOSOLVE_OFFSET UNITYSDK_OFFSET(0x987350)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_TRIGONOMETRICCONTEXT_FIXTWISTROTATIONS_OFFSET UNITYSDK_OFFSET(0x9873A0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_TRIGONOMETRICCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x987340)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLegNap_TrigonometricContext_TypeDefinitionIndex = 36082;
