...
#define ROOTMOTION_FINALIK_GROUNDER_GETLEGSPINEBENDVECTOR_OFFSET UNITYSDK_OFFSET(0x1AB771B0)
#define ROOTMOTION_FINALIK_GROUNDER_GETLEGSPINETANGENT_OFFSET UNITYSDK_OFFSET(0x1AB77560)
#define ROOTMOTION_FINALIK_GROUNDER_GETSPINEOFFSETTARGET_OFFSET UNITYSDK_OFFSET(0x1AB770F0)
#define ROOTMOTION_FINALIK_GROUNDER_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1AB770D0)
#define ROOTMOTION_FINALIK_GROUNDER_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x1AB77530)
#define ROOTMOTION_FINALIK_GROUNDER_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1AB770E0)
#define ROOTMOTION_FINALIK_GROUNDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB77950)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounder_TypeDefinitionIndex = 35015;
