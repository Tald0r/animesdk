...
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_APPLY_OFFSET UNITYSDK_OFFSET(0x1AE5C150)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AE5BCF0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_FIXDIR_OFFSET UNITYSDK_OFFSET(0x1AE5C300)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x1AE5D5E0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x1AE5D600)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETPITCHDOWN_OFFSET UNITYSDK_OFFSET(0x1AE5BC60)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETPITCHUP_OFFSET UNITYSDK_OFFSET(0x1AE5BC30)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETYAWLEFT_OFFSET UNITYSDK_OFFSET(0x1AE5BCC0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETYAWRIGHT_OFFSET UNITYSDK_OFFSET(0x1AE5BC90)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_RECORD_OFFSET UNITYSDK_OFFSET(0x1AE5BE70)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_START_OFFSET UNITYSDK_OFFSET(0x1AE5BE60)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE5D650)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLookAt_TypeDefinitionIndex = 36102;
