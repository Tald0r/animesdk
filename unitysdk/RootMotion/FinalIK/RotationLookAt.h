...
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_APPLY_OFFSET UNITYSDK_OFFSET(0x1A89A2F0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A899E90)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_FIXDIR_OFFSET UNITYSDK_OFFSET(0x1A89A4A0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x1A89B780)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x1A89B7A0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETPITCHDOWN_OFFSET UNITYSDK_OFFSET(0x1A899E00)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETPITCHUP_OFFSET UNITYSDK_OFFSET(0x1A899DD0)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETYAWLEFT_OFFSET UNITYSDK_OFFSET(0x1A899E60)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_GET_GETYAWRIGHT_OFFSET UNITYSDK_OFFSET(0x1A899E30)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_RECORD_OFFSET UNITYSDK_OFFSET(0x1A89A010)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT_START_OFFSET UNITYSDK_OFFSET(0x1A89A000)
#define ROOTMOTION_FINALIK_ROTATIONLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A89B7F0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLookAt_TypeDefinitionIndex = 35100;
