...
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x1AF00530)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE_INITIATE_OFFSET UNITYSDK_OFFSET(0x1AEFFE80)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE_LOOKAT_OFFSET UNITYSDK_OFFSET(0x1AF001C0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEFFE30)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEFFDF0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLookAt_LookAtBone_TypeDefinitionIndex = 35085;
