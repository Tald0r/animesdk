...
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x1B51DAA0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE_INITIATE_OFFSET UNITYSDK_OFFSET(0x1B51D3F0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE_LOOKAT_OFFSET UNITYSDK_OFFSET(0x1B51D730)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B51D3A0)
#define ROOTMOTION_FINALIK_IKSOLVERLOOKAT_LOOKATBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51D360)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLookAt_LookAtBone_TypeDefinitionIndex = 36087;
