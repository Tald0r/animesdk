...
#define ROOTMOTION_FINALIK_BIPEDIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1AC62FD0)
#define ROOTMOTION_FINALIK_BIPEDIK_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AC63F70)
#define ROOTMOTION_FINALIK_BIPEDIK_GETGOALIK_OFFSET UNITYSDK_OFFSET(0x1AC630C0)
#define ROOTMOTION_FINALIK_BIPEDIK_GETIKPOSITIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AC63020)
#define ROOTMOTION_FINALIK_BIPEDIK_GETIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1AC634A0)
#define ROOTMOTION_FINALIK_BIPEDIK_GETIKROTATIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AC63160)
#define ROOTMOTION_FINALIK_BIPEDIK_GETIKROTATION_OFFSET UNITYSDK_OFFSET(0x1AC63540)
#define ROOTMOTION_FINALIK_BIPEDIK_INITIATEBIPEDIK_OFFSET UNITYSDK_OFFSET(0x1AC637F0)
#define ROOTMOTION_FINALIK_BIPEDIK_INITIATESOLVER_OFFSET UNITYSDK_OFFSET(0x1AC63800)
#define ROOTMOTION_FINALIK_BIPEDIK_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x1AC64080)
#define ROOTMOTION_FINALIK_BIPEDIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AC62F30)
#define ROOTMOTION_FINALIK_BIPEDIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AC62EE0)
#define ROOTMOTION_FINALIK_BIPEDIK_SETIKPOSITIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AC63200)
#define ROOTMOTION_FINALIK_BIPEDIK_SETIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1AC63360)
#define ROOTMOTION_FINALIK_BIPEDIK_SETIKROTATIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AC632B0)
#define ROOTMOTION_FINALIK_BIPEDIK_SETIKROTATION_OFFSET UNITYSDK_OFFSET(0x1AC63400)
#define ROOTMOTION_FINALIK_BIPEDIK_SETLOOKATPOSITION_OFFSET UNITYSDK_OFFSET(0x1AC63720)
#define ROOTMOTION_FINALIK_BIPEDIK_SETLOOKATWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AC635E0)
#define ROOTMOTION_FINALIK_BIPEDIK_SETSPINEPOSITION_OFFSET UNITYSDK_OFFSET(0x1AC63760)
#define ROOTMOTION_FINALIK_BIPEDIK_SETSPINEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AC637A0)
#define ROOTMOTION_FINALIK_BIPEDIK_SETTODEFAULTS_OFFSET UNITYSDK_OFFSET(0x1AC63E20)
#define ROOTMOTION_FINALIK_BIPEDIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1AC62F80)
#define ROOTMOTION_FINALIK_BIPEDIK_UPDATEBIPEDIK_OFFSET UNITYSDK_OFFSET(0x1AC639F0)
#define ROOTMOTION_FINALIK_BIPEDIK_UPDATESOLVER_OFFSET UNITYSDK_OFFSET(0x1AC63A00)
#define ROOTMOTION_FINALIK_BIPEDIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC640B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int BipedIK_TypeDefinitionIndex = 36006;
