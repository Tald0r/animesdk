...
#define ROOTMOTION_FINALIK_RECOIL_AFTERAIMIK_OFFSET UNITYSDK_OFFSET(0x1A25D530)
#define ROOTMOTION_FINALIK_RECOIL_AFTERFBBIK_OFFSET UNITYSDK_OFFSET(0x1A25D2B0)
#define ROOTMOTION_FINALIK_RECOIL_FIRE_OFFSET UNITYSDK_OFFSET(0x1A25B730)
#define ROOTMOTION_FINALIK_RECOIL_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1A25B6F0)
#define ROOTMOTION_FINALIK_RECOIL_GET_PRIMARYHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A25D170)
#define ROOTMOTION_FINALIK_RECOIL_GET_PRIMARYHAND_OFFSET UNITYSDK_OFFSET(0x1A25D010)
#define ROOTMOTION_FINALIK_RECOIL_GET_SECONDARYHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A25D210)
#define ROOTMOTION_FINALIK_RECOIL_GET_SECONDARYHAND_OFFSET UNITYSDK_OFFSET(0x1A25D0C0)
#define ROOTMOTION_FINALIK_RECOIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A25D680)
#define ROOTMOTION_FINALIK_RECOIL_ONMODIFYOFFSET_OFFSET UNITYSDK_OFFSET(0x1A25B990)
#define ROOTMOTION_FINALIK_RECOIL_SETHANDROTATIONS_OFFSET UNITYSDK_OFFSET(0x1A25B710)
#define ROOTMOTION_FINALIK_RECOIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A25D8A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Recoil_TypeDefinitionIndex = 35177;
