...
#define ROOTMOTION_FINALIK_RECOIL_AFTERAIMIK_OFFSET UNITYSDK_OFFSET(0x1A824E50)
#define ROOTMOTION_FINALIK_RECOIL_AFTERFBBIK_OFFSET UNITYSDK_OFFSET(0x1A824BD0)
#define ROOTMOTION_FINALIK_RECOIL_FIRE_OFFSET UNITYSDK_OFFSET(0x1A823050)
#define ROOTMOTION_FINALIK_RECOIL_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1A823010)
#define ROOTMOTION_FINALIK_RECOIL_GET_PRIMARYHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A824A90)
#define ROOTMOTION_FINALIK_RECOIL_GET_PRIMARYHAND_OFFSET UNITYSDK_OFFSET(0x1A824930)
#define ROOTMOTION_FINALIK_RECOIL_GET_SECONDARYHANDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A824B30)
#define ROOTMOTION_FINALIK_RECOIL_GET_SECONDARYHAND_OFFSET UNITYSDK_OFFSET(0x1A8249E0)
#define ROOTMOTION_FINALIK_RECOIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A824FA0)
#define ROOTMOTION_FINALIK_RECOIL_ONMODIFYOFFSET_OFFSET UNITYSDK_OFFSET(0x1A8232B0)
#define ROOTMOTION_FINALIK_RECOIL_SETHANDROTATIONS_OFFSET UNITYSDK_OFFSET(0x1A823030)
#define ROOTMOTION_FINALIK_RECOIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8251C0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Recoil_TypeDefinitionIndex = 36179;
