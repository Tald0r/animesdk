...
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_CCDPASS_OFFSET UNITYSDK_OFFSET(0x1AC66C70)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_CHESTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AC660F0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ITERATE_OFFSET UNITYSDK_OFFSET(0x1AC67250)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_LERPSOLVERPOSITION_OFFSET UNITYSDK_OFFSET(0x1AC68210)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AC68B30)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONFIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AC64F70)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONPOSTUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC68310)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONPREREAD_OFFSET UNITYSDK_OFFSET(0x1AC65650)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_ONSTOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1AC646E0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_POSTSTRETCHING_OFFSET UNITYSDK_OFFSET(0x1AC686D0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_SOLVE_OFFSET UNITYSDK_OFFSET(0x1AC68120)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_SPINEBEND_OFFSET UNITYSDK_OFFSET(0x1AC666E0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR_START_OFFSET UNITYSDK_OFFSET(0x1AC642F0)
#define ROOTMOTION_FINALIK_FBBIKHEADEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC68E40)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBBIKHeadEffector_TypeDefinitionIndex = 36050;
