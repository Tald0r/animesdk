...
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1AE0CC90)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1AE0CCE0)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AE0CAB0)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_OPENTUTORIAL1_OFFSET UNITYSDK_OFFSET(0x1AE0CB00)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_OPENTUTORIAL2_OFFSET UNITYSDK_OFFSET(0x1AE0CB50)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_OPENTUTORIAL3_OFFSET UNITYSDK_OFFSET(0x1AE0CBA0)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_OPENTUTORIAL4_OFFSET UNITYSDK_OFFSET(0x1AE0CBF0)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AE0CA60)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_RESETROTATION_OFFSET UNITYSDK_OFFSET(0x1AE0CD50)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_ROTATETO_OFFSET UNITYSDK_OFFSET(0x1AE0CDE0)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1AE0CC40)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE0DB20)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionTarget_TypeDefinitionIndex = 36117;
