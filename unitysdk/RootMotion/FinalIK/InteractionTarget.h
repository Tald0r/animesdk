...
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1A811150)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1A8111A0)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A810F70)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_OPENTUTORIAL1_OFFSET UNITYSDK_OFFSET(0x1A810FC0)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_OPENTUTORIAL2_OFFSET UNITYSDK_OFFSET(0x1A811010)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_OPENTUTORIAL3_OFFSET UNITYSDK_OFFSET(0x1A811060)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_OPENTUTORIAL4_OFFSET UNITYSDK_OFFSET(0x1A8110B0)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1A810F20)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_RESETROTATION_OFFSET UNITYSDK_OFFSET(0x1A811210)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_ROTATETO_OFFSET UNITYSDK_OFFSET(0x1A8112A0)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1A811100)
#define ROOTMOTION_FINALIK_INTERACTIONTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A811FE0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionTarget_TypeDefinitionIndex = 35115;
