...
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_GET_ISSTEPPING_OFFSET UNITYSDK_OFFSET(0x1B3EC410)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_GET_STEPPROGRESS_OFFSET UNITYSDK_OFFSET(0x1B3EC420)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_RESET_OFFSET UNITYSDK_OFFSET(0x1B3EC5D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_SET_STEPPROGRESS_OFFSET UNITYSDK_OFFSET(0x1B3EC430)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_STEPTO_OFFSET UNITYSDK_OFFSET(0x1B3EC610)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_UPDATESTANDING_OFFSET UNITYSDK_OFFSET(0x1B3EC9D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_UPDATESTEPPING_OFFSET UNITYSDK_OFFSET(0x1B3EC7D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B3ECC50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3EC440)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Footstep_TypeDefinitionIndex = 36094;
