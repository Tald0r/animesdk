...
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_GET_ISSTEPPING_OFFSET UNITYSDK_OFFSET(0x1ADD7840)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_GET_STEPPROGRESS_OFFSET UNITYSDK_OFFSET(0x1ADD7850)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_RESET_OFFSET UNITYSDK_OFFSET(0x1ADD7A00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_SET_STEPPROGRESS_OFFSET UNITYSDK_OFFSET(0x1ADD7860)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_STEPTO_OFFSET UNITYSDK_OFFSET(0x1ADD7A40)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_UPDATESTANDING_OFFSET UNITYSDK_OFFSET(0x1ADD7E00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_UPDATESTEPPING_OFFSET UNITYSDK_OFFSET(0x1ADD7C00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP_UPDATE_OFFSET UNITYSDK_OFFSET(0x1ADD8080)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FOOTSTEP__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADD7870)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Footstep_TypeDefinitionIndex = 35092;
