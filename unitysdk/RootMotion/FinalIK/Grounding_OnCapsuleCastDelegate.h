...
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AC98BB0)
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AC98D00)
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AC98200)
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC981E0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounding_OnCapsuleCastDelegate_TypeDefinitionIndex = 36029;
