...
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6ED950)
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6EDAA0)
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6ECFB0)
#define ROOTMOTION_FINALIK_GROUNDING_ONCAPSULECASTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6ECFA0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounding_OnCapsuleCastDelegate_TypeDefinitionIndex = 35027;
