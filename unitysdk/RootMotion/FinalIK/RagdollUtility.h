...
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_AFTERANIMATION_OFFSET UNITYSDK_OFFSET(0x1A6C6640)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_AFTERLASTIK_OFFSET UNITYSDK_OFFSET(0x1A6C69F0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_DISABLERAGDOLLSMOOTH_OFFSET UNITYSDK_OFFSET(0x1A6C5990)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_DISABLERAGDOLL_OFFSET UNITYSDK_OFFSET(0x1A6C5690)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_ENABLERAGDOLL_OFFSET UNITYSDK_OFFSET(0x1A6C55E0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6C6460)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A6C6550)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_GET_IKUSED_OFFSET UNITYSDK_OFFSET(0x1A6C67D0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_GET_ISRAGDOLL_OFFSET UNITYSDK_OFFSET(0x1A6C5610)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6C65D0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A6C6E70)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_ONFINALPOSE_OFFSET UNITYSDK_OFFSET(0x1A6C6960)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_RAGDOLLENABLER_OFFSET UNITYSDK_OFFSET(0x1A6C6A90)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_RECORDVELOCITIES_OFFSET UNITYSDK_OFFSET(0x1A6C6A20)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_START_OFFSET UNITYSDK_OFFSET(0x1A6C59E0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_STORELOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1A6C5880)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A6C60E0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6C6FB0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RagdollUtility_TypeDefinitionIndex = 35127;
