...
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_AFTERANIMATION_OFFSET UNITYSDK_OFFSET(0x1AC718A0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_AFTERLASTIK_OFFSET UNITYSDK_OFFSET(0x1AC71C50)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_DISABLERAGDOLLSMOOTH_OFFSET UNITYSDK_OFFSET(0x1AC70BF0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_DISABLERAGDOLL_OFFSET UNITYSDK_OFFSET(0x1AC708F0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_ENABLERAGDOLL_OFFSET UNITYSDK_OFFSET(0x1AC70840)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC716C0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AC717B0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_GET_IKUSED_OFFSET UNITYSDK_OFFSET(0x1AC71A30)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_GET_ISRAGDOLL_OFFSET UNITYSDK_OFFSET(0x1AC70870)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC71830)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AC720D0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_ONFINALPOSE_OFFSET UNITYSDK_OFFSET(0x1AC71BC0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_RAGDOLLENABLER_OFFSET UNITYSDK_OFFSET(0x1AC71CF0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_RECORDVELOCITIES_OFFSET UNITYSDK_OFFSET(0x1AC71C80)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_START_OFFSET UNITYSDK_OFFSET(0x1AC70C40)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_STORELOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1AC70AE0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AC71340)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC72210)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RagdollUtility_TypeDefinitionIndex = 36129;
