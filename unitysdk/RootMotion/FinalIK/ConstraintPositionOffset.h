...
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITIONOFFSET_GET_POSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1B089340)
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITIONOFFSET_UPDATECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1B089050)
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITIONOFFSET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0893E0)
#define ROOTMOTION_FINALIK_CONSTRAINTPOSITIONOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0893D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ConstraintPositionOffset_TypeDefinitionIndex = 36010;
