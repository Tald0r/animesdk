...
#define ROOTMOTION_FINALIK_IKSOLVERLEG_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1B311060)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1B3106E0)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1B310980)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B30FFF0)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1B3110E0)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B3118F0)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_READ_OFFSET UNITYSDK_OFFSET(0x1B311190)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_SETCHAIN_OFFSET UNITYSDK_OFFSET(0x1B310650)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_SOLVE_OFFSET UNITYSDK_OFFSET(0x1B311920)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1B310E10)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_WRITE_OFFSET UNITYSDK_OFFSET(0x1B311A30)
#define ROOTMOTION_FINALIK_IKSOLVERLEG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B311CF0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLeg_TypeDefinitionIndex = 36079;
