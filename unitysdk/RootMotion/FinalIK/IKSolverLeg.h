...
#define ROOTMOTION_FINALIK_IKSOLVERLEG_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1ACFE470)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1ACFDAF0)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1ACFDD90)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_ISVALID_OFFSET UNITYSDK_OFFSET(0x1ACFD400)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1ACFE4F0)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ACFED00)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_READ_OFFSET UNITYSDK_OFFSET(0x1ACFE5A0)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_SETCHAIN_OFFSET UNITYSDK_OFFSET(0x1ACFDA60)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_SOLVE_OFFSET UNITYSDK_OFFSET(0x1ACFED30)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1ACFE220)
#define ROOTMOTION_FINALIK_IKSOLVERLEG_WRITE_OFFSET UNITYSDK_OFFSET(0x1ACFEE40)
#define ROOTMOTION_FINALIK_IKSOLVERLEG__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACFF100)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLeg_TypeDefinitionIndex = 35077;
