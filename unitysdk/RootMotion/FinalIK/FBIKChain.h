...
#define ROOTMOTION_FINALIK_FBIKCHAIN_BACKWARDREACH_OFFSET UNITYSDK_OFFSET(0x1ADD69C0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CALCULATEBONELENGTHS_OFFSET UNITYSDK_OFFSET(0x1ADD42D0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_FORWARDREACH_OFFSET UNITYSDK_OFFSET(0x1ADD6460)
#define ROOTMOTION_FINALIK_FBIKCHAIN_GETDIRTOBENDPOINT_OFFSET UNITYSDK_OFFSET(0x1ADD5B50)
#define ROOTMOTION_FINALIK_FBIKCHAIN_GETNODEINDEX_OFFSET UNITYSDK_OFFSET(0x1ADD3D80)
#define ROOTMOTION_FINALIK_FBIKCHAIN_INITIATE_OFFSET UNITYSDK_OFFSET(0x1ADD4050)
#define ROOTMOTION_FINALIK_FBIKCHAIN_ISVALID_OFFSET UNITYSDK_OFFSET(0x1ADD3F20)
#define ROOTMOTION_FINALIK_FBIKCHAIN_PUSH_OFFSET UNITYSDK_OFFSET(0x1ADD5400)
#define ROOTMOTION_FINALIK_FBIKCHAIN_REACH_OFFSET UNITYSDK_OFFSET(0x1ADD50D0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_READPOSE_OFFSET UNITYSDK_OFFSET(0x1ADD4A50)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SETNODES_OFFSET UNITYSDK_OFFSET(0x1ADD3C20)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVECHILDCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1ADD66B0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVECONSTRAINTSYSTEMS_OFFSET UNITYSDK_OFFSET(0x1ADD6CA0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVEFABRIKJOINT_OFFSET UNITYSDK_OFFSET(0x1ADD6730)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVELINEARCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1ADD6E90)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVETRIGONOMETRIC_OFFSET UNITYSDK_OFFSET(0x1ADD57E0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_STAGE1_OFFSET UNITYSDK_OFFSET(0x1ADD5E40)
#define ROOTMOTION_FINALIK_FBIKCHAIN_STAGE2_OFFSET UNITYSDK_OFFSET(0x1ADD6820)
#define ROOTMOTION_FINALIK_FBIKCHAIN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ADD3B20)
#define ROOTMOTION_FINALIK_FBIKCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADD3A70)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBIKChain_TypeDefinitionIndex = 35050;
