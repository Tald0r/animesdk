...
#define ROOTMOTION_FINALIK_FBIKCHAIN_BACKWARDREACH_OFFSET UNITYSDK_OFFSET(0x1B3EB590)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CALCULATEBONELENGTHS_OFFSET UNITYSDK_OFFSET(0x1B3E8EA0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_FORWARDREACH_OFFSET UNITYSDK_OFFSET(0x1B3EB030)
#define ROOTMOTION_FINALIK_FBIKCHAIN_GETDIRTOBENDPOINT_OFFSET UNITYSDK_OFFSET(0x1B3EA720)
#define ROOTMOTION_FINALIK_FBIKCHAIN_GETNODEINDEX_OFFSET UNITYSDK_OFFSET(0x1B3E8950)
#define ROOTMOTION_FINALIK_FBIKCHAIN_INITIATE_OFFSET UNITYSDK_OFFSET(0x1B3E8C20)
#define ROOTMOTION_FINALIK_FBIKCHAIN_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B3E8AF0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_PUSH_OFFSET UNITYSDK_OFFSET(0x1B3E9FD0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_REACH_OFFSET UNITYSDK_OFFSET(0x1B3E9CA0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_READPOSE_OFFSET UNITYSDK_OFFSET(0x1B3E9620)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SETNODES_OFFSET UNITYSDK_OFFSET(0x1B3E87F0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVECHILDCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B3EB280)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVECONSTRAINTSYSTEMS_OFFSET UNITYSDK_OFFSET(0x1B3EB870)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVEFABRIKJOINT_OFFSET UNITYSDK_OFFSET(0x1B3EB300)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVELINEARCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1B3EBA60)
#define ROOTMOTION_FINALIK_FBIKCHAIN_SOLVETRIGONOMETRIC_OFFSET UNITYSDK_OFFSET(0x1B3EA3B0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_STAGE1_OFFSET UNITYSDK_OFFSET(0x1B3EAA10)
#define ROOTMOTION_FINALIK_FBIKCHAIN_STAGE2_OFFSET UNITYSDK_OFFSET(0x1B3EB3F0)
#define ROOTMOTION_FINALIK_FBIKCHAIN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B3E86F0)
#define ROOTMOTION_FINALIK_FBIKCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E8640)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBIKChain_TypeDefinitionIndex = 36052;
