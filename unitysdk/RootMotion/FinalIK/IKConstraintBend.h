...
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_GETDIR_OFFSET UNITYSDK_OFFSET(0x1A8967A0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1A8953D0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_INITIATE_OFFSET UNITYSDK_OFFSET(0x1A895450)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A895130)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_LIMITBEND_OFFSET UNITYSDK_OFFSET(0x1A896060)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_ORTHOTOBONE1_OFFSET UNITYSDK_OFFSET(0x1A895BF0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_ORTHOTOLIMB_OFFSET UNITYSDK_OFFSET(0x1A895B30)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_SETBONES_OFFSET UNITYSDK_OFFSET(0x1A895440)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_SETLIMBORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A895CB0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1A8953E0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A895410)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8953F0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKConstraintBend_TypeDefinitionIndex = 35053;
