...
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_GETDIR_OFFSET UNITYSDK_OFFSET(0x1AE58600)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1AE57230)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_INITIATE_OFFSET UNITYSDK_OFFSET(0x1AE572B0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AE56F90)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_LIMITBEND_OFFSET UNITYSDK_OFFSET(0x1AE57EC0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_ORTHOTOBONE1_OFFSET UNITYSDK_OFFSET(0x1AE57A50)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_ORTHOTOLIMB_OFFSET UNITYSDK_OFFSET(0x1AE57990)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_SETBONES_OFFSET UNITYSDK_OFFSET(0x1AE572A0)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_SETLIMBORIENTATION_OFFSET UNITYSDK_OFFSET(0x1AE57B10)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1AE57240)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE57270)
#define ROOTMOTION_FINALIK_IKCONSTRAINTBEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE57250)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKConstraintBend_TypeDefinitionIndex = 36055;
