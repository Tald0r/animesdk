...
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1B08A490)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETLEGTRSLIST_OFFSET UNITYSDK_OFFSET(0x1B089E80)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1B089C00)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1B089BB0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETTOECONVEXPOSITION_OFFSET UNITYSDK_OFFSET(0x1B08BCB0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETTOECONVEXROTATION_OFFSET UNITYSDK_OFFSET(0x1B08BBC0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_BANFIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B089A80)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_GROUNDPANELNORMAL_OFFSET UNITYSDK_OFFSET(0x1B089A00)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_GROUNDPANELPOSITION_OFFSET UNITYSDK_OFFSET(0x1B089A40)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_IKROTATIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1B0899E0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1B0899C0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET__NOTTRIGONOMETRIC_OFFSET UNITYSDK_OFFSET(0x1B089A90)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B08A1C0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ONENABLED_OFFSET UNITYSDK_OFFSET(0x1B089AA0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1B08A9F0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B08AE10)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_GROUNDPANELNORMAL_OFFSET UNITYSDK_OFFSET(0x1B089A20)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_GROUNDPANELPOSITION_OFFSET UNITYSDK_OFFSET(0x1B089A60)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_IKROTATIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1B0899F0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1B0899D0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1B08A790)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B08BD20)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLegNap_TypeDefinitionIndex = 36081;
