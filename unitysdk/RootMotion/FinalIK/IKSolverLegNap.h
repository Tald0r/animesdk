...
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AA58B20)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETLEGTRSLIST_OFFSET UNITYSDK_OFFSET(0x1AA58510)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1AA58290)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1AA58240)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETTOECONVEXPOSITION_OFFSET UNITYSDK_OFFSET(0x1AA5A340)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GETTOECONVEXROTATION_OFFSET UNITYSDK_OFFSET(0x1AA5A250)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_BANFIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AA58110)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_GROUNDPANELNORMAL_OFFSET UNITYSDK_OFFSET(0x1AA58090)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_GROUNDPANELPOSITION_OFFSET UNITYSDK_OFFSET(0x1AA580D0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_IKROTATIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AA58070)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1AA58050)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_GET__NOTTRIGONOMETRIC_OFFSET UNITYSDK_OFFSET(0x1AA58120)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AA58850)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ONENABLED_OFFSET UNITYSDK_OFFSET(0x1AA58130)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1AA59080)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA594A0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_GROUNDPANELNORMAL_OFFSET UNITYSDK_OFFSET(0x1AA580B0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_GROUNDPANELPOSITION_OFFSET UNITYSDK_OFFSET(0x1AA580F0)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_IKROTATIONWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AA58080)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_SET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1AA58060)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1AA58E20)
#define ROOTMOTION_FINALIK_IKSOLVERLEGNAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA5A3B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverLegNap_TypeDefinitionIndex = 35079;
