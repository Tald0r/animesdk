...
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_INITIATE_OFFSET UNITYSDK_OFFSET(0x1A6EBD40)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ISREADYTOINITIATE_OFFSET UNITYSDK_OFFSET(0x1A6EBC20)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A6ECD50)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A6EC130)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ONPOSTSOLVERUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6ECA60)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ONSOLVERUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6EC190)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A6EBB90)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1A6EBB40)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A6EBBE0)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_SETLEGIK_OFFSET UNITYSDK_OFFSET(0x1A6EC940)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A6EBCE0)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6ECF10)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GrounderBipedIK_TypeDefinitionIndex = 35017;
