...
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_INITIATE_OFFSET UNITYSDK_OFFSET(0x1AC96F60)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ISREADYTOINITIATE_OFFSET UNITYSDK_OFFSET(0x1AC96E40)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AC97F80)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AC97350)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ONPOSTSOLVERUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC97C90)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_ONSOLVERUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC973B0)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AC96DB0)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AC96D60)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0x1AC96E00)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_SETLEGIK_OFFSET UNITYSDK_OFFSET(0x1AC97B60)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AC96F00)
#define ROOTMOTION_FINALIK_GROUNDERBIPEDIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC98150)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GrounderBipedIK_TypeDefinitionIndex = 36019;
