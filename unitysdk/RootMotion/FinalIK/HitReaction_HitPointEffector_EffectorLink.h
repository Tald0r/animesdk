...
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_EFFECTORLINK_APPLY_OFFSET UNITYSDK_OFFSET(0x1A561EE0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_EFFECTORLINK_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1A561F90)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_EFFECTORLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A561FA0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_HitPointEffector_EffectorLink_TypeDefinitionIndex = 35153;
