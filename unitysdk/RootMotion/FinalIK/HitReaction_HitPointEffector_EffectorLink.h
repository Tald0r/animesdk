...
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_EFFECTORLINK_APPLY_OFFSET UNITYSDK_OFFSET(0x1AB0D5B0)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_EFFECTORLINK_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1AB0D660)
#define ROOTMOTION_FINALIK_HITREACTION_HITPOINTEFFECTOR_EFFECTORLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0D670)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReaction_HitPointEffector_EffectorLink_TypeDefinitionIndex = 36155;
