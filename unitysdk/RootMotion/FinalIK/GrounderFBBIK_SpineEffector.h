...
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_SPINEEFFECTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEFBC60)
#define ROOTMOTION_FINALIK_GROUNDERFBBIK_SPINEEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEFBC50)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GrounderFBBIK_SpineEffector_TypeDefinitionIndex = 35019;
