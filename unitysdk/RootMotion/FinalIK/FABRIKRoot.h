...
#define ROOTMOTION_FINALIK_FABRIKROOT_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1AE87840)
#define ROOTMOTION_FINALIK_FABRIKROOT_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1AE87890)
#define ROOTMOTION_FINALIK_FABRIKROOT_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AE877A0)
#define ROOTMOTION_FINALIK_FABRIKROOT_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AE87750)
#define ROOTMOTION_FINALIK_FABRIKROOT_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1AE877F0)
#define ROOTMOTION_FINALIK_FABRIKROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE878A0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FABRIKRoot_TypeDefinitionIndex = 35035;
