...
#define ROOTMOTION_FINALIK_FABRIKROOT_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1B4A28A0)
#define ROOTMOTION_FINALIK_FABRIKROOT_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1B4A28F0)
#define ROOTMOTION_FINALIK_FABRIKROOT_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B4A2800)
#define ROOTMOTION_FINALIK_FABRIKROOT_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1B4A27B0)
#define ROOTMOTION_FINALIK_FABRIKROOT_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1B4A2850)
#define ROOTMOTION_FINALIK_FABRIKROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A2900)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FABRIKRoot_TypeDefinitionIndex = 36037;
