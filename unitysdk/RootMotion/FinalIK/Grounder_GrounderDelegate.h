...
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6BEC20)
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6BEC50)
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6BE980)
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6BE970)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounder_GrounderDelegate_TypeDefinitionIndex = 35016;
