...
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AC69E60)
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AC69E90)
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AC69BC0)
#define ROOTMOTION_FINALIK_GROUNDER_GROUNDERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC69BA0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Grounder_GrounderDelegate_TypeDefinitionIndex = 36018;
