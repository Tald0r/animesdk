...
#define ROOTMOTION_FINALIK_VRIK_AUTODETECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1B091470)
#define ROOTMOTION_FINALIK_VRIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1B0914D0)
#define ROOTMOTION_FINALIK_VRIK_GUESSHANDORIENTATIONS_OFFSET UNITYSDK_OFFSET(0x1B0914A0)
#define ROOTMOTION_FINALIK_VRIK_INITIATESOLVER_OFFSET UNITYSDK_OFFSET(0x1B0914E0)
#define ROOTMOTION_FINALIK_VRIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B0913D0)
#define ROOTMOTION_FINALIK_VRIK_OPENSETUPTUTORIAL_OFFSET UNITYSDK_OFFSET(0x1B091420)
#define ROOTMOTION_FINALIK_VRIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1B091380)
#define ROOTMOTION_FINALIK_VRIK_UPDATESOLVER_OFFSET UNITYSDK_OFFSET(0x1B0915B0)
#define ROOTMOTION_FINALIK_VRIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0917C0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VRIK_TypeDefinitionIndex = 36046;
