...
#define ROOTMOTION_FINALIK_VRIK_AUTODETECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1AA5FB00)
#define ROOTMOTION_FINALIK_VRIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1AA5FB60)
#define ROOTMOTION_FINALIK_VRIK_GUESSHANDORIENTATIONS_OFFSET UNITYSDK_OFFSET(0x1AA5FB30)
#define ROOTMOTION_FINALIK_VRIK_INITIATESOLVER_OFFSET UNITYSDK_OFFSET(0x1AA5FB70)
#define ROOTMOTION_FINALIK_VRIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AA5FA60)
#define ROOTMOTION_FINALIK_VRIK_OPENSETUPTUTORIAL_OFFSET UNITYSDK_OFFSET(0x1AA5FAB0)
#define ROOTMOTION_FINALIK_VRIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AA5FA10)
#define ROOTMOTION_FINALIK_VRIK_UPDATESOLVER_OFFSET UNITYSDK_OFFSET(0x1AA5FC40)
#define ROOTMOTION_FINALIK_VRIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA5FE50)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VRIK_TypeDefinitionIndex = 35044;
