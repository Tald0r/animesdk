...
#define ROOTMOTION_FINALIK_IKSOLVERVR_ADDPLATFORMMOTION_OFFSET UNITYSDK_OFFSET(0x1A24E350)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ADDPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1A249780)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ADDROTATIONOFFSET_1_OFFSET UNITYSDK_OFFSET(0x1A24E100)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ADDROTATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1A24E090)
#define ROOTMOTION_FINALIK_IKSOLVERVR_DEFAULTANIMATIONCURVES_OFFSET UNITYSDK_OFFSET(0x1A24DAF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A24FA60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x1A250040)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETPELVISOFFSET_OFFSET UNITYSDK_OFFSET(0x1A2582D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1A24FD00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1A24FDB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A254220)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1A254270)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETSINEKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1A24DFF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0x1A24C060)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x1A258CD0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GUESSHANDORIENTATIONS_OFFSET UNITYSDK_OFFSET(0x1A24DC90)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A24FE60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1A250380)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A250410)
#define ROOTMOTION_FINALIK_IKSOLVERVR_READ_OFFSET UNITYSDK_OFFSET(0x1A24EBF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_RESET_OFFSET UNITYSDK_OFFSET(0x1A24E700)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SETTOREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A24C080)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0x1A24C070)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x1A258CE0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SOLVE_OFFSET UNITYSDK_OFFSET(0x1A250FB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1A24F800)
#define ROOTMOTION_FINALIK_IKSOLVERVR_UPDATESOLVERTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A24E9A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_WRITETRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A253940)
#define ROOTMOTION_FINALIK_IKSOLVERVR_WRITE_OFFSET UNITYSDK_OFFSET(0x1A253770)
#define ROOTMOTION_FINALIK_IKSOLVERVR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A258CF0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_TypeDefinitionIndex = 35088;
