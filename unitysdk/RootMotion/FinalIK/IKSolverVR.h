...
#define ROOTMOTION_FINALIK_IKSOLVERVR_ADDPLATFORMMOTION_OFFSET UNITYSDK_OFFSET(0x1A815C70)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ADDPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1A8110A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ADDROTATIONOFFSET_1_OFFSET UNITYSDK_OFFSET(0x1A815A20)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ADDROTATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1A8159B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_DEFAULTANIMATIONCURVES_OFFSET UNITYSDK_OFFSET(0x1A815410)
#define ROOTMOTION_FINALIK_IKSOLVERVR_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A817380)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x1A817960)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETPELVISOFFSET_OFFSET UNITYSDK_OFFSET(0x1A81FBF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1A817620)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1A8176D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A81BB40)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1A81BB90)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GETSINEKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1A815910)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0x1A813980)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x1A8205F0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_GUESSHANDORIENTATIONS_OFFSET UNITYSDK_OFFSET(0x1A8155B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A817780)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1A817CA0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A817D30)
#define ROOTMOTION_FINALIK_IKSOLVERVR_READ_OFFSET UNITYSDK_OFFSET(0x1A816510)
#define ROOTMOTION_FINALIK_IKSOLVERVR_RESET_OFFSET UNITYSDK_OFFSET(0x1A816020)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SETTOREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A8139A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0x1A813990)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x1A820600)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SOLVE_OFFSET UNITYSDK_OFFSET(0x1A8188D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1A817120)
#define ROOTMOTION_FINALIK_IKSOLVERVR_UPDATESOLVERTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A8162C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_WRITETRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A81B260)
#define ROOTMOTION_FINALIK_IKSOLVERVR_WRITE_OFFSET UNITYSDK_OFFSET(0x1A81B090)
#define ROOTMOTION_FINALIK_IKSOLVERVR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A820610)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_TypeDefinitionIndex = 36090;
