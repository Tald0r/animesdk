...
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_GET_ISRIGID_OFFSET UNITYSDK_OFFSET(0x1B30E120)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_GET_NOMINALDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B30E100)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_INITIATE_OFFSET UNITYSDK_OFFSET(0x1B30E160)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_ONPRESOLVE_OFFSET UNITYSDK_OFFSET(0x1B30E1B0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_SET_ISRIGID_OFFSET UNITYSDK_OFFSET(0x1B30E130)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_SET_NOMINALDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B30E110)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_SOLVE_OFFSET UNITYSDK_OFFSET(0x1B30E490)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B30E140)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBIKChain_ChildConstraint_TypeDefinitionIndex = 36053;
