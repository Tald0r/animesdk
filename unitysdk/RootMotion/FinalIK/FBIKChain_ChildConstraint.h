...
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_GET_ISRIGID_OFFSET UNITYSDK_OFFSET(0x1ACFB540)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_GET_NOMINALDISTANCE_OFFSET UNITYSDK_OFFSET(0x1ACFB520)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_INITIATE_OFFSET UNITYSDK_OFFSET(0x1ACFB580)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_ONPRESOLVE_OFFSET UNITYSDK_OFFSET(0x1ACFB5D0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_SET_ISRIGID_OFFSET UNITYSDK_OFFSET(0x1ACFB550)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_SET_NOMINALDISTANCE_OFFSET UNITYSDK_OFFSET(0x1ACFB530)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT_SOLVE_OFFSET UNITYSDK_OFFSET(0x1ACFB8B0)
#define ROOTMOTION_FINALIK_FBIKCHAIN_CHILDCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACFB560)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBIKChain_ChildConstraint_TypeDefinitionIndex = 35051;
