...
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_APPLYOFFSETS_OFFSET UNITYSDK_OFFSET(0x1A564F20)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_APPLYPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1A564EB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_APPLYROTATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1A564A80)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_FIXTWISTROTATIONS_OFFSET UNITYSDK_OFFSET(0x1A5661E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_BENDNORMALRELTOPELVIS_OFFSET UNITYSDK_OFFSET(0x1A562C10)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_BENDNORMALRELTOTARGET_OFFSET UNITYSDK_OFFSET(0x1A562C50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_CALF_OFFSET UNITYSDK_OFFSET(0x1A562AC0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_FOOT_OFFSET UNITYSDK_OFFSET(0x1A562B00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_HASTOES_OFFSET UNITYSDK_OFFSET(0x1A562A60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_LASTBONE_OFFSET UNITYSDK_OFFSET(0x1A562B80)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A562A00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A562A40)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_THIGHRELATIVETOPELVIS_OFFSET UNITYSDK_OFFSET(0x1A562BD0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_THIGH_OFFSET UNITYSDK_OFFSET(0x1A562A80)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_TOES_OFFSET UNITYSDK_OFFSET(0x1A562B40)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_ONREAD_OFFSET UNITYSDK_OFFSET(0x1A562C90)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1A5639E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_RESETOFFSETS_OFFSET UNITYSDK_OFFSET(0x1A566E50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_BENDNORMALRELTOPELVIS_OFFSET UNITYSDK_OFFSET(0x1A562C30)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_BENDNORMALRELTOTARGET_OFFSET UNITYSDK_OFFSET(0x1A562C70)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_HASTOES_OFFSET UNITYSDK_OFFSET(0x1A562A70)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A562A20)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A562A50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_THIGHRELATIVETOPELVIS_OFFSET UNITYSDK_OFFSET(0x1A562BF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SOLVE_OFFSET UNITYSDK_OFFSET(0x1A565A10)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_STRETCHING_OFFSET UNITYSDK_OFFSET(0x1A565D30)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_WRITE_OFFSET UNITYSDK_OFFSET(0x1A566A10)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A566EA0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Leg_TypeDefinitionIndex = 35093;
