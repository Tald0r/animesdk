...
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_APPLYOFFSETS_OFFSET UNITYSDK_OFFSET(0x1AB105F0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_APPLYPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1AB10580)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_APPLYROTATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1AB10150)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_FIXTWISTROTATIONS_OFFSET UNITYSDK_OFFSET(0x1AB118B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_BENDNORMALRELTOPELVIS_OFFSET UNITYSDK_OFFSET(0x1AB0E2E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_BENDNORMALRELTOTARGET_OFFSET UNITYSDK_OFFSET(0x1AB0E320)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_CALF_OFFSET UNITYSDK_OFFSET(0x1AB0E190)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_FOOT_OFFSET UNITYSDK_OFFSET(0x1AB0E1D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_HASTOES_OFFSET UNITYSDK_OFFSET(0x1AB0E130)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_LASTBONE_OFFSET UNITYSDK_OFFSET(0x1AB0E250)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AB0E0D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1AB0E110)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_THIGHRELATIVETOPELVIS_OFFSET UNITYSDK_OFFSET(0x1AB0E2A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_THIGH_OFFSET UNITYSDK_OFFSET(0x1AB0E150)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_GET_TOES_OFFSET UNITYSDK_OFFSET(0x1AB0E210)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_ONREAD_OFFSET UNITYSDK_OFFSET(0x1AB0E360)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1AB0F0B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_RESETOFFSETS_OFFSET UNITYSDK_OFFSET(0x1AB12520)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_BENDNORMALRELTOPELVIS_OFFSET UNITYSDK_OFFSET(0x1AB0E300)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_BENDNORMALRELTOTARGET_OFFSET UNITYSDK_OFFSET(0x1AB0E340)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_HASTOES_OFFSET UNITYSDK_OFFSET(0x1AB0E140)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AB0E0F0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1AB0E120)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SET_THIGHRELATIVETOPELVIS_OFFSET UNITYSDK_OFFSET(0x1AB0E2C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_SOLVE_OFFSET UNITYSDK_OFFSET(0x1AB110E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_STRETCHING_OFFSET UNITYSDK_OFFSET(0x1AB11400)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG_WRITE_OFFSET UNITYSDK_OFFSET(0x1AB120E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_LEG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB12570)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Leg_TypeDefinitionIndex = 36095;
