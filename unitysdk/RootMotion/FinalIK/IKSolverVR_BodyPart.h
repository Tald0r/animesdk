...
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_GET_MAG_OFFSET UNITYSDK_OFFSET(0x1A561FD0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_GET_SQRMAG_OFFSET UNITYSDK_OFFSET(0x1A561FB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_MOVEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A562110)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_MOVEROTATION_OFFSET UNITYSDK_OFFSET(0x1A5621D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_READ_OFFSET UNITYSDK_OFFSET(0x1A562000)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_ROTATETO_OFFSET UNITYSDK_OFFSET(0x1A5625E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_SETLOD_OFFSET UNITYSDK_OFFSET(0x1A561FF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_SET_MAG_OFFSET UNITYSDK_OFFSET(0x1A561FE0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_SET_SQRMAG_OFFSET UNITYSDK_OFFSET(0x1A561FC0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_TRANSLATEROOT_OFFSET UNITYSDK_OFFSET(0x1A5623E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_TRANSLATE_OFFSET UNITYSDK_OFFSET(0x1A562390)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_VISUALIZE_1_OFFSET UNITYSDK_OFFSET(0x1A5629A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x1A562800)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5629C0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_BodyPart_TypeDefinitionIndex = 35091;
