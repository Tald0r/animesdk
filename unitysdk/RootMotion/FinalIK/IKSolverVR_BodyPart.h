...
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_GET_MAG_OFFSET UNITYSDK_OFFSET(0x1AB0D6A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_GET_SQRMAG_OFFSET UNITYSDK_OFFSET(0x1AB0D680)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_MOVEPOSITION_OFFSET UNITYSDK_OFFSET(0x1AB0D7E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_MOVEROTATION_OFFSET UNITYSDK_OFFSET(0x1AB0D8A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_READ_OFFSET UNITYSDK_OFFSET(0x1AB0D6D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_ROTATETO_OFFSET UNITYSDK_OFFSET(0x1AB0DCB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_SETLOD_OFFSET UNITYSDK_OFFSET(0x1AB0D6C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_SET_MAG_OFFSET UNITYSDK_OFFSET(0x1AB0D6B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_SET_SQRMAG_OFFSET UNITYSDK_OFFSET(0x1AB0D690)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_TRANSLATEROOT_OFFSET UNITYSDK_OFFSET(0x1AB0DAB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_TRANSLATE_OFFSET UNITYSDK_OFFSET(0x1AB0DA60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_VISUALIZE_1_OFFSET UNITYSDK_OFFSET(0x1AB0E070)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x1AB0DED0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_BODYPART__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0E090)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_BodyPart_TypeDefinitionIndex = 36093;
