...
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION_GET_DIRECTION3D_OFFSET UNITYSDK_OFFSET(0x1ACA10A0)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION_GET_OFFSET3D_OFFSET UNITYSDK_OFFSET(0x1ACA1080)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION_ISINRANGE_OFFSET UNITYSDK_OFFSET(0x1ACA1220)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACA20C0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionTrigger_CharacterPosition_TypeDefinitionIndex = 36121;
