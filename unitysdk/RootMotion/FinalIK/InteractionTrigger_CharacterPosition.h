...
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION_GET_DIRECTION3D_OFFSET UNITYSDK_OFFSET(0x1A6F5E40)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION_GET_OFFSET3D_OFFSET UNITYSDK_OFFSET(0x1A6F5E20)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION_ISINRANGE_OFFSET UNITYSDK_OFFSET(0x1A6F5FC0)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CHARACTERPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6F6E60)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionTrigger_CharacterPosition_TypeDefinitionIndex = 35119;
