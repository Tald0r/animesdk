...
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_RANGE_INTERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB7D520)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionTrigger_Range_Interaction_TypeDefinitionIndex = 35122;
