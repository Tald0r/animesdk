...
#define ROOTMOTION_FINALIK_LEGIKNAP_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1AE0DB90)
#define ROOTMOTION_FINALIK_LEGIKNAP_GET__ERRORMSG_OFFSET UNITYSDK_OFFSET(0x1AE0DBC0)
#define ROOTMOTION_FINALIK_LEGIKNAP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AE0DBA0)
#define ROOTMOTION_FINALIK_LEGIKNAP_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AE0DB70)
#define ROOTMOTION_FINALIK_LEGIKNAP_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AE0DB80)
#define ROOTMOTION_FINALIK_LEGIKNAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE0DC00)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int LegIKNap_TypeDefinitionIndex = 36042;
