...
#define ROOTMOTION_FINALIK_LEGIKNAP_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1A812050)
#define ROOTMOTION_FINALIK_LEGIKNAP_GET__ERRORMSG_OFFSET UNITYSDK_OFFSET(0x1A812080)
#define ROOTMOTION_FINALIK_LEGIKNAP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A812060)
#define ROOTMOTION_FINALIK_LEGIKNAP_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A812030)
#define ROOTMOTION_FINALIK_LEGIKNAP_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1A812040)
#define ROOTMOTION_FINALIK_LEGIKNAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8120C0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int LegIKNap_TypeDefinitionIndex = 35040;
