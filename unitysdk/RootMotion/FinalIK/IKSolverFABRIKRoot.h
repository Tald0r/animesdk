...
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ADDPOINTSTOARRAY_OFFSET UNITYSDK_OFFSET(0x1A3C9480)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A3C8A90)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_GETCENTROID_OFFSET UNITYSDK_OFFSET(0x1A3C9070)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1A3C9400)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1A3C9610)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ISROOT_OFFSET UNITYSDK_OFFSET(0x1A3C8D30)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A3C7F60)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1A3C8B50)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A3C8DC0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1A3C89C0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C96B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverFABRIKRoot_TypeDefinitionIndex = 35071;
