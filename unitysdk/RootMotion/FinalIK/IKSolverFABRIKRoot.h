...
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ADDPOINTSTOARRAY_OFFSET UNITYSDK_OFFSET(0x1A98DB20)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A98D130)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_GETCENTROID_OFFSET UNITYSDK_OFFSET(0x1A98D710)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_GETPOINTS_OFFSET UNITYSDK_OFFSET(0x1A98DAA0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1A98DCB0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ISROOT_OFFSET UNITYSDK_OFFSET(0x1A98D3D0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A98C600)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1A98D1F0)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A98D460)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1A98D060)
#define ROOTMOTION_FINALIK_IKSOLVERFABRIKROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A98DD50)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverFABRIKRoot_TypeDefinitionIndex = 36073;
