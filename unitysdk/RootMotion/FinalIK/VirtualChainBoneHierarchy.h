...
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_APPLYTOREALTRANSFORMSFROMINDEX_OFFSET UNITYSDK_OFFSET(0x1B5C33D0)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_BUILDCHAIN_OFFSET UNITYSDK_OFFSET(0x1B5C2F70)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x1B5C3560)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_EVALUATE_2_OFFSET UNITYSDK_OFFSET(0x1B5C3510)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1B5C34D0)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_GETBONEINDEX_OFFSET UNITYSDK_OFFSET(0x1B5C3030)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_INITHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1B5C2F50)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_UPDATEFORWARDFROMINDEX_OFFSET UNITYSDK_OFFSET(0x1B5C30B0)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C35F0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VirtualChainBoneHierarchy_TypeDefinitionIndex = 36194;
