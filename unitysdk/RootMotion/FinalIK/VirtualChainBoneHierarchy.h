...
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_APPLYTOREALTRANSFORMSFROMINDEX_OFFSET UNITYSDK_OFFSET(0x1AFB1B40)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_BUILDCHAIN_OFFSET UNITYSDK_OFFSET(0x1AFB16E0)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x1AFB1CD0)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_EVALUATE_2_OFFSET UNITYSDK_OFFSET(0x1AFB1C80)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1AFB1C40)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_GETBONEINDEX_OFFSET UNITYSDK_OFFSET(0x1AFB17A0)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_INITHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1AFB16C0)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY_UPDATEFORWARDFROMINDEX_OFFSET UNITYSDK_OFFSET(0x1AFB1820)
#define ROOTMOTION_FINALIK_VIRTUALCHAINBONEHIERARCHY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB1D60)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VirtualChainBoneHierarchy_TypeDefinitionIndex = 35192;
