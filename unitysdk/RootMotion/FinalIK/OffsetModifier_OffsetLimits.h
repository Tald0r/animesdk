...
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS_APPLY_OFFSET UNITYSDK_OFFSET(0x1AE13DB0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS_SPRINGAXIS_OFFSET UNITYSDK_OFFSET(0x1AE142A0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS_SPRING_OFFSET UNITYSDK_OFFSET(0x1AE14310)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE14370)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int OffsetModifier_OffsetLimits_TypeDefinitionIndex = 36170;
