...
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS_APPLY_OFFSET UNITYSDK_OFFSET(0x1A818270)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS_SPRINGAXIS_OFFSET UNITYSDK_OFFSET(0x1A818760)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS_SPRING_OFFSET UNITYSDK_OFFSET(0x1A8187D0)
#define ROOTMOTION_FINALIK_OFFSETMODIFIER_OFFSETLIMITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A818830)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int OffsetModifier_OffsetLimits_TypeDefinitionIndex = 35168;
