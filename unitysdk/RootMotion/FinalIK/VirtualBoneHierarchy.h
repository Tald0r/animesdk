...
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_ADDBONE_OFFSET UNITYSDK_OFFSET(0x1A89B8C0)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_APPLYTOREALTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A89C8D0)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_DEBUGDRAWVIRTUALBONE_OFFSET UNITYSDK_OFFSET(0x1A89D4F0)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A89D5C0)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_FINDBONE_OFFSET UNITYSDK_OFFSET(0x1A89BA20)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_GET_BONES_OFFSET UNITYSDK_OFFSET(0x1A89B8B0)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_INITHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1A89BAC0)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_SYNCANIMATIONTOVIRTUALBONES_OFFSET UNITYSDK_OFFSET(0x1A89CAB0)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_UPDATEBONETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A89BD40)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_UPDATESOLVERTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A89C040)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A89D5F0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VirtualBoneHierarchy_TypeDefinitionIndex = 35190;
