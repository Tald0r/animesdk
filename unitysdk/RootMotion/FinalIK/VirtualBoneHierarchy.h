...
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_ADDBONE_OFFSET UNITYSDK_OFFSET(0x1AE5D720)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_APPLYTOREALTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AE5E760)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_DEBUGDRAWVIRTUALBONE_OFFSET UNITYSDK_OFFSET(0x1AE5F380)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1AE5F450)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_FINDBONE_OFFSET UNITYSDK_OFFSET(0x1AE5D880)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_GET_BONES_OFFSET UNITYSDK_OFFSET(0x1AE5D710)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_INITHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1AE5D920)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_SYNCANIMATIONTOVIRTUALBONES_OFFSET UNITYSDK_OFFSET(0x1AE5E940)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_UPDATEBONETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AE5DBA0)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY_UPDATESOLVERTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AE5DEA0)
#define ROOTMOTION_FINALIK_VIRTUALBONEHIERARCHY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE5F480)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VirtualBoneHierarchy_TypeDefinitionIndex = 36192;
