...
#define ROOTMOTION_FINALIK_IKMAPPING_BONEISVALID_OFFSET UNITYSDK_OFFSET(0x1A811300)
#define ROOTMOTION_FINALIK_IKMAPPING_INITIATE_OFFSET UNITYSDK_OFFSET(0x1A8112F0)
#define ROOTMOTION_FINALIK_IKMAPPING_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A8112E0)
#define ROOTMOTION_FINALIK_IKMAPPING_SOLVEFABRIKJOINT_OFFSET UNITYSDK_OFFSET(0x1A811960)
#define ROOTMOTION_FINALIK_IKMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A811A50)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMapping_TypeDefinitionIndex = 36057;
