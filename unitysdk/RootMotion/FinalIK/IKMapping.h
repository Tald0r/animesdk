...
#define ROOTMOTION_FINALIK_IKMAPPING_BONEISVALID_OFFSET UNITYSDK_OFFSET(0x1A2499E0)
#define ROOTMOTION_FINALIK_IKMAPPING_INITIATE_OFFSET UNITYSDK_OFFSET(0x1A2499D0)
#define ROOTMOTION_FINALIK_IKMAPPING_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A2499C0)
#define ROOTMOTION_FINALIK_IKMAPPING_SOLVEFABRIKJOINT_OFFSET UNITYSDK_OFFSET(0x1A24A040)
#define ROOTMOTION_FINALIK_IKMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A24A130)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMapping_TypeDefinitionIndex = 35055;
