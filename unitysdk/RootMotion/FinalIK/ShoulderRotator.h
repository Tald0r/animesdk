...
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_GETPARENTBONEMAP_OFFSET UNITYSDK_OFFSET(0x1AC72BD0)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AC72C10)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_ROTATESHOULDERS_OFFSET UNITYSDK_OFFSET(0x1AC72410)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_ROTATESHOULDER_OFFSET UNITYSDK_OFFSET(0x1AC72570)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_START_OFFSET UNITYSDK_OFFSET(0x1AC722F0)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC72D40)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ShoulderRotator_TypeDefinitionIndex = 36183;
