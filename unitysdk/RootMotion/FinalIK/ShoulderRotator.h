...
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_GETPARENTBONEMAP_OFFSET UNITYSDK_OFFSET(0x1A6C7970)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A6C79B0)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_ROTATESHOULDERS_OFFSET UNITYSDK_OFFSET(0x1A6C71B0)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_ROTATESHOULDER_OFFSET UNITYSDK_OFFSET(0x1A6C7310)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR_START_OFFSET UNITYSDK_OFFSET(0x1A6C7090)
#define ROOTMOTION_FINALIK_SHOULDERROTATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6C7AE0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ShoulderRotator_TypeDefinitionIndex = 35181;
