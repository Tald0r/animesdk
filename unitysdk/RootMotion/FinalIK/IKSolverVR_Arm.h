...
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_APPLYOFFSETS_OFFSET UNITYSDK_OFFSET(0x1A7803D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_DAMPERVALUE_OFFSET UNITYSDK_OFFSET(0x1A783A00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GETBENDNORMAL_OFFSET UNITYSDK_OFFSET(0x1A783AC0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_FOREARM_OFFSET UNITYSDK_OFFSET(0x1A77EAC0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_HAND_OFFSET UNITYSDK_OFFSET(0x1A77EB10)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A77E9E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A77EA20)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_SHOULDER_OFFSET UNITYSDK_OFFSET(0x1A77EA40)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_UPPERARM_OFFSET UNITYSDK_OFFSET(0x1A77EA80)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_ONREAD_OFFSET UNITYSDK_OFFSET(0x1A77EB60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1A77FEC0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_RESETOFFSETS_OFFSET UNITYSDK_OFFSET(0x1A7848D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A77EA00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A77EA30)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_SOLVE_OFFSET UNITYSDK_OFFSET(0x1A780860)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_STRETCHING_OFFSET UNITYSDK_OFFSET(0x1A780410)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x1A784D90)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_WRITE_OFFSET UNITYSDK_OFFSET(0x1A7848F0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A784F90)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Arm_TypeDefinitionIndex = 35089;
