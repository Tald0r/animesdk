...
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_APPLYOFFSETS_OFFSET UNITYSDK_OFFSET(0x1AD1EC60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_DAMPERVALUE_OFFSET UNITYSDK_OFFSET(0x1AD22290)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GETBENDNORMAL_OFFSET UNITYSDK_OFFSET(0x1AD22350)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_FOREARM_OFFSET UNITYSDK_OFFSET(0x1AD1D350)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_HAND_OFFSET UNITYSDK_OFFSET(0x1AD1D3A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AD1D270)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1AD1D2B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_SHOULDER_OFFSET UNITYSDK_OFFSET(0x1AD1D2D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_GET_UPPERARM_OFFSET UNITYSDK_OFFSET(0x1AD1D310)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_ONREAD_OFFSET UNITYSDK_OFFSET(0x1AD1D3F0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1AD1E750)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_RESETOFFSETS_OFFSET UNITYSDK_OFFSET(0x1AD23160)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AD1D290)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1AD1D2C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_SOLVE_OFFSET UNITYSDK_OFFSET(0x1AD1F0F0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_STRETCHING_OFFSET UNITYSDK_OFFSET(0x1AD1ECA0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x1AD23620)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM_WRITE_OFFSET UNITYSDK_OFFSET(0x1AD23180)
#define ROOTMOTION_FINALIK_IKSOLVERVR_ARM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD23820)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Arm_TypeDefinitionIndex = 36091;
