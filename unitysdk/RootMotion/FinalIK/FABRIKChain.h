...
#define ROOTMOTION_FINALIK_FABRIKCHAIN_GETCENTROID_OFFSET UNITYSDK_OFFSET(0x1B1956C0)
#define ROOTMOTION_FINALIK_FABRIKCHAIN_INITIATE_OFFSET UNITYSDK_OFFSET(0x1B1954B0)
#define ROOTMOTION_FINALIK_FABRIKCHAIN_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B1953D0)
#define ROOTMOTION_FINALIK_FABRIKCHAIN_STAGE1_OFFSET UNITYSDK_OFFSET(0x1B1954E0)
#define ROOTMOTION_FINALIK_FABRIKCHAIN_STAGE2_OFFSET UNITYSDK_OFFSET(0x1B1959E0)
#define ROOTMOTION_FINALIK_FABRIKCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B195BC0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FABRIKChain_TypeDefinitionIndex = 36048;
