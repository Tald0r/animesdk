...
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A6EE970)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_GETBONEMAP_OFFSET UNITYSDK_OFFSET(0x1A6EDD10)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_INITIATE_OFFSET UNITYSDK_OFFSET(0x1A6EEAF0)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A6EDC90)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_READPOSE_OFFSET UNITYSDK_OFFSET(0x1A6EEE70)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_SETBONES_OFFSET UNITYSDK_OFFSET(0x1A6EE690)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_SETLIMBORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A6EDDE0)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1A6EE6B0)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1A6EEF20)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A6EE560)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6EE460)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMappingLimb_TypeDefinitionIndex = 35058;
