...
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AC99BD0)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_GETBONEMAP_OFFSET UNITYSDK_OFFSET(0x1AC98F70)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_INITIATE_OFFSET UNITYSDK_OFFSET(0x1AC99D50)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AC98EF0)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_READPOSE_OFFSET UNITYSDK_OFFSET(0x1AC9A0D0)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_SETBONES_OFFSET UNITYSDK_OFFSET(0x1AC998F0)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_SETLIMBORIENTATION_OFFSET UNITYSDK_OFFSET(0x1AC99040)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1AC99910)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB_WRITEPOSE_OFFSET UNITYSDK_OFFSET(0x1AC9A180)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AC997C0)
#define ROOTMOTION_FINALIK_IKMAPPINGLIMB__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC996C0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMappingLimb_TypeDefinitionIndex = 36060;
