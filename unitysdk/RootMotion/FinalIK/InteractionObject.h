...
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_APPLY_1_OFFSET UNITYSDK_OFFSET(0x1B313170)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_APPLY_OFFSET UNITYSDK_OFFSET(0x1B312A00)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1B3120F0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_CURVEUSED_OFFSET UNITYSDK_OFFSET(0x1B312740)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETMULTIPLIERINDEX_OFFSET UNITYSDK_OFFSET(0x1B313E80)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETTARGETS_OFFSET UNITYSDK_OFFSET(0x1B3127F0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETTARGET_1_OFFSET UNITYSDK_OFFSET(0x1B312800)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETTARGET_2_OFFSET UNITYSDK_OFFSET(0x1B312980)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETTARGET_OFFSET UNITYSDK_OFFSET(0x1B3125C0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1B313A10)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GETWEIGHTCURVEINDEX_OFFSET UNITYSDK_OFFSET(0x1B3139C0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GET_LASTUSEDINTERACTIONSYSTEM_OFFSET UNITYSDK_OFFSET(0x1B312160)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B312140)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x1B312540)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_GET_TARGETSROOT_OFFSET UNITYSDK_OFFSET(0x1B3124C0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_INITIATE_OFFSET UNITYSDK_OFFSET(0x1B312180)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ONSTARTINTERACTION_OFFSET UNITYSDK_OFFSET(0x1B3129F0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B311F10)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_OPENTUTORIAL1_OFFSET UNITYSDK_OFFSET(0x1B311F60)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_OPENTUTORIAL2_OFFSET UNITYSDK_OFFSET(0x1B311FB0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_OPENTUTORIAL3_OFFSET UNITYSDK_OFFSET(0x1B312000)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_OPENTUTORIAL4_OFFSET UNITYSDK_OFFSET(0x1B312050)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1B311EC0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_SET_LASTUSEDINTERACTIONSYSTEM_OFFSET UNITYSDK_OFFSET(0x1B312170)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B312150)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_START_OFFSET UNITYSDK_OFFSET(0x1B313E70)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1B3120A0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B313ED0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionObject_TypeDefinitionIndex = 36107;
