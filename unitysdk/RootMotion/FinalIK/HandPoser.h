...
#define ROOTMOTION_FINALIK_HANDPOSER_AUTOMAPPING_OFFSET UNITYSDK_OFFSET(0x1B30F040)
#define ROOTMOTION_FINALIK_HANDPOSER_FIXPOSERTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1B30F460)
#define ROOTMOTION_FINALIK_HANDPOSER_INITIATEPOSER_OFFSET UNITYSDK_OFFSET(0x1B30F1B0)
#define ROOTMOTION_FINALIK_HANDPOSER_STOREDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x1B30F260)
#define ROOTMOTION_FINALIK_HANDPOSER_UPDATEPOSER_OFFSET UNITYSDK_OFFSET(0x1B30F5E0)
#define ROOTMOTION_FINALIK_HANDPOSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B30FC10)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HandPoser_TypeDefinitionIndex = 36127;
