...
#define ROOTMOTION_FINALIK_FINGER_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AC95DF0)
#define ROOTMOTION_FINALIK_FINGER_GET_IKPOSITION_OFFSET UNITYSDK_OFFSET(0x1AC94DC0)
#define ROOTMOTION_FINALIK_FINGER_GET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1AC94E20)
#define ROOTMOTION_FINALIK_FINGER_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1AC94DA0)
#define ROOTMOTION_FINALIK_FINGER_INITIATE_OFFSET UNITYSDK_OFFSET(0x1AC95020)
#define ROOTMOTION_FINALIK_FINGER_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AC94E70)
#define ROOTMOTION_FINALIK_FINGER_SET_IKPOSITION_OFFSET UNITYSDK_OFFSET(0x1AC94DF0)
#define ROOTMOTION_FINALIK_FINGER_SET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1AC94E50)
#define ROOTMOTION_FINALIK_FINGER_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1AC94DB0)
#define ROOTMOTION_FINALIK_FINGER_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1AC95F40)
#define ROOTMOTION_FINALIK_FINGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AC96060)
#define ROOTMOTION_FINALIK_FINGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC96D50)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Finger_TypeDefinitionIndex = 36014;
