...
#define ROOTMOTION_FINALIK_FINGER_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A6EABD0)
#define ROOTMOTION_FINALIK_FINGER_GET_IKPOSITION_OFFSET UNITYSDK_OFFSET(0x1A6E9BA0)
#define ROOTMOTION_FINALIK_FINGER_GET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1A6E9C00)
#define ROOTMOTION_FINALIK_FINGER_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1A6E9B80)
#define ROOTMOTION_FINALIK_FINGER_INITIATE_OFFSET UNITYSDK_OFFSET(0x1A6E9E00)
#define ROOTMOTION_FINALIK_FINGER_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A6E9C50)
#define ROOTMOTION_FINALIK_FINGER_SET_IKPOSITION_OFFSET UNITYSDK_OFFSET(0x1A6E9BD0)
#define ROOTMOTION_FINALIK_FINGER_SET_IKROTATION_OFFSET UNITYSDK_OFFSET(0x1A6E9C30)
#define ROOTMOTION_FINALIK_FINGER_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1A6E9B90)
#define ROOTMOTION_FINALIK_FINGER_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1A6EAD20)
#define ROOTMOTION_FINALIK_FINGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A6EAE40)
#define ROOTMOTION_FINALIK_FINGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6EBB30)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Finger_TypeDefinitionIndex = 35012;
