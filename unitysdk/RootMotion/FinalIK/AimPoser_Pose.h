...
#define ROOTMOTION_FINALIK_AIMPOSER_POSE_ISINDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AB75210)
#define ROOTMOTION_FINALIK_AIMPOSER_POSE_SETANGLEBUFFER_OFFSET UNITYSDK_OFFSET(0x1AB755E0)
#define ROOTMOTION_FINALIK_AIMPOSER_POSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB755F0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int AimPoser_Pose_TypeDefinitionIndex = 35142;
