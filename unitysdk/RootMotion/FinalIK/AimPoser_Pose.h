...
#define ROOTMOTION_FINALIK_AIMPOSER_POSE_ISINDIRECTION_OFFSET UNITYSDK_OFFSET(0x1B194FD0)
#define ROOTMOTION_FINALIK_AIMPOSER_POSE_SETANGLEBUFFER_OFFSET UNITYSDK_OFFSET(0x1B1953A0)
#define ROOTMOTION_FINALIK_AIMPOSER_POSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1953B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int AimPoser_Pose_TypeDefinitionIndex = 36144;
