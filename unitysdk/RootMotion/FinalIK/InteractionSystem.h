...
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1A991500)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_CONTACTISINRANGE_OFFSET UNITYSDK_OFFSET(0x1A996780)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETCLOSESTINTERACTIONOBJECTINRANGE_OFFSET UNITYSDK_OFFSET(0x1A994A20)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETCLOSESTINTERACTIONOBJECTSINRANGE_OFFSET UNITYSDK_OFFSET(0x1A994B00)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETCLOSESTINTERACTIONRANGE_OFFSET UNITYSDK_OFFSET(0x1A994520)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETCLOSESTINTERACTIONTARGETINRANGE_OFFSET UNITYSDK_OFFSET(0x1A994A70)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETCLOSESTINTERACTIONTARGETSINRANGE_OFFSET UNITYSDK_OFFSET(0x1A994CA0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETCLOSESTTRIGGERINDEX_OFFSET UNITYSDK_OFFSET(0x1A9946F0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETINTERACTIONOBJECT_OFFSET UNITYSDK_OFFSET(0x1A992C50)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETMINACTIVEPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A992F80)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A992DA0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETTRIGGERRANGE_OFFSET UNITYSDK_OFFSET(0x1A995440)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GET_IK_OFFSET UNITYSDK_OFFSET(0x1A995620)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GET_ININTERACTION_OFFSET UNITYSDK_OFFSET(0x1A991550)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1A995660)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GET_TRIGGERSINRANGE_OFFSET UNITYSDK_OFFSET(0x1A995640)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONPAUSE_OFFSET UNITYSDK_OFFSET(0x1A996280)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONRESUME_OFFSET UNITYSDK_OFFSET(0x1A9962A0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONSTOP_OFFSET UNITYSDK_OFFSET(0x1A9962C0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ISININTERACTION_OFFSET UNITYSDK_OFFSET(0x1A991880)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ISINSYNC_OFFSET UNITYSDK_OFFSET(0x1A991EF0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ISPAUSED_1_OFFSET UNITYSDK_OFFSET(0x1A991CC0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1A991AA0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A991780)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_LOOKATINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A9962E0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A997330)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A996FE0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONFIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A997310)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONPOSTFBBIK_OFFSET UNITYSDK_OFFSET(0x1A997210)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONPREFBBIK_OFFSET UNITYSDK_OFFSET(0x1A997180)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1A9963A0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1A9965A0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A991320)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_OPENTUTORIAL1_OFFSET UNITYSDK_OFFSET(0x1A991370)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_OPENTUTORIAL2_OFFSET UNITYSDK_OFFSET(0x1A9913C0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_OPENTUTORIAL3_OFFSET UNITYSDK_OFFSET(0x1A991410)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_OPENTUTORIAL4_OFFSET UNITYSDK_OFFSET(0x1A991460)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1A9912D0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_PAUSEALL_OFFSET UNITYSDK_OFFSET(0x1A992940)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_PAUSEINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A992550)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_RAYCASTING_OFFSET UNITYSDK_OFFSET(0x1A996D20)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_RESUMEALL_OFFSET UNITYSDK_OFFSET(0x1A992A90)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_RESUMEINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A9926A0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_SET_IK_OFFSET UNITYSDK_OFFSET(0x1A995630)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1A995670)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_SET_TRIGGERSINRANGE_OFFSET UNITYSDK_OFFSET(0x1A995650)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_STARTINTERACTION_1_OFFSET UNITYSDK_OFFSET(0x1A992370)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_STARTINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A992190)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_START_OFFSET UNITYSDK_OFFSET(0x1A995680)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_STOPALL_OFFSET UNITYSDK_OFFSET(0x1A992BE0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_STOPINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A9927F0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1A9914B0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_TRIGGEREFFECTORSREADY_OFFSET UNITYSDK_OFFSET(0x1A995010)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_TRIGGERINDEXISVALID_OFFSET UNITYSDK_OFFSET(0x1A9937D0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_TRIGGERINTERACTION_1_OFFSET UNITYSDK_OFFSET(0x1A9938E0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_TRIGGERINTERACTION_2_OFFSET UNITYSDK_OFFSET(0x1A993EC0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_TRIGGERINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A993280)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_UPDATEEFFECTORS_OFFSET UNITYSDK_OFFSET(0x1A997000)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_UPDATETRIGGEREVENTBROADCASTING_OFFSET UNITYSDK_OFFSET(0x1A995C00)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A996A20)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A997690)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionSystem_TypeDefinitionIndex = 36114;
