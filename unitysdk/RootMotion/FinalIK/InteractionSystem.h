...
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1A3CCE60)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_CONTACTISINRANGE_OFFSET UNITYSDK_OFFSET(0x1A3D20E0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETCLOSESTINTERACTIONOBJECTINRANGE_OFFSET UNITYSDK_OFFSET(0x1A3D0380)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETCLOSESTINTERACTIONOBJECTSINRANGE_OFFSET UNITYSDK_OFFSET(0x1A3D0460)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETCLOSESTINTERACTIONRANGE_OFFSET UNITYSDK_OFFSET(0x1A3CFE80)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETCLOSESTINTERACTIONTARGETINRANGE_OFFSET UNITYSDK_OFFSET(0x1A3D03D0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETCLOSESTINTERACTIONTARGETSINRANGE_OFFSET UNITYSDK_OFFSET(0x1A3D0600)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETCLOSESTTRIGGERINDEX_OFFSET UNITYSDK_OFFSET(0x1A3D0050)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETINTERACTIONOBJECT_OFFSET UNITYSDK_OFFSET(0x1A3CE5B0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETMINACTIVEPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A3CE8E0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A3CE700)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GETTRIGGERRANGE_OFFSET UNITYSDK_OFFSET(0x1A3D0DA0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GET_IK_OFFSET UNITYSDK_OFFSET(0x1A3D0F80)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GET_ININTERACTION_OFFSET UNITYSDK_OFFSET(0x1A3CCEB0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1A3D0FC0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_GET_TRIGGERSINRANGE_OFFSET UNITYSDK_OFFSET(0x1A3D0FA0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONPAUSE_OFFSET UNITYSDK_OFFSET(0x1A3D1BE0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONRESUME_OFFSET UNITYSDK_OFFSET(0x1A3D1C00)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONSTOP_OFFSET UNITYSDK_OFFSET(0x1A3D1C20)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ISININTERACTION_OFFSET UNITYSDK_OFFSET(0x1A3CD1E0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ISINSYNC_OFFSET UNITYSDK_OFFSET(0x1A3CD850)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ISPAUSED_1_OFFSET UNITYSDK_OFFSET(0x1A3CD620)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1A3CD400)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A3CD0E0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_LOOKATINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A3D1C40)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A3D2C90)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A3D2940)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONFIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A3D2C70)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONPOSTFBBIK_OFFSET UNITYSDK_OFFSET(0x1A3D2B70)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONPREFBBIK_OFFSET UNITYSDK_OFFSET(0x1A3D2AE0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1A3D1D00)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1A3D1F00)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A3CCC80)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_OPENTUTORIAL1_OFFSET UNITYSDK_OFFSET(0x1A3CCCD0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_OPENTUTORIAL2_OFFSET UNITYSDK_OFFSET(0x1A3CCD20)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_OPENTUTORIAL3_OFFSET UNITYSDK_OFFSET(0x1A3CCD70)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_OPENTUTORIAL4_OFFSET UNITYSDK_OFFSET(0x1A3CCDC0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1A3CCC30)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_PAUSEALL_OFFSET UNITYSDK_OFFSET(0x1A3CE2A0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_PAUSEINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A3CDEB0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_RAYCASTING_OFFSET UNITYSDK_OFFSET(0x1A3D2680)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_RESUMEALL_OFFSET UNITYSDK_OFFSET(0x1A3CE3F0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_RESUMEINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A3CE000)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_SET_IK_OFFSET UNITYSDK_OFFSET(0x1A3D0F90)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1A3D0FD0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_SET_TRIGGERSINRANGE_OFFSET UNITYSDK_OFFSET(0x1A3D0FB0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_STARTINTERACTION_1_OFFSET UNITYSDK_OFFSET(0x1A3CDCD0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_STARTINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A3CDAF0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_START_OFFSET UNITYSDK_OFFSET(0x1A3D0FE0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_STOPALL_OFFSET UNITYSDK_OFFSET(0x1A3CE540)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_STOPINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A3CE150)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1A3CCE10)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_TRIGGEREFFECTORSREADY_OFFSET UNITYSDK_OFFSET(0x1A3D0970)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_TRIGGERINDEXISVALID_OFFSET UNITYSDK_OFFSET(0x1A3CF130)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_TRIGGERINTERACTION_1_OFFSET UNITYSDK_OFFSET(0x1A3CF240)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_TRIGGERINTERACTION_2_OFFSET UNITYSDK_OFFSET(0x1A3CF820)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_TRIGGERINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A3CEBE0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_UPDATEEFFECTORS_OFFSET UNITYSDK_OFFSET(0x1A3D2960)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_UPDATETRIGGEREVENTBROADCASTING_OFFSET UNITYSDK_OFFSET(0x1A3D1560)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A3D2380)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3D2FE0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionSystem_TypeDefinitionIndex = 35112;
