...
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_GETDIRECTIONTOBENDPOINT_OFFSET UNITYSDK_OFFSET(0x1AAB2950)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1AAB13E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_READ_OFFSET UNITYSDK_OFFSET(0x1AAB1080)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_ROTATEAROUNDPOINT_OFFSET UNITYSDK_OFFSET(0x1AAB1800)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_ROTATEBY_1_OFFSET UNITYSDK_OFFSET(0x1AAB1DB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_ROTATEBY_OFFSET UNITYSDK_OFFSET(0x1AAB1AC0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_ROTATETO_OFFSET UNITYSDK_OFFSET(0x1AAB2140)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SOLVECCD_OFFSET UNITYSDK_OFFSET(0x1AAB33B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SOLVEFABRIKJOINT_OFFSET UNITYSDK_OFFSET(0x1AAB32C0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SOLVEFABRIK_OFFSET UNITYSDK_OFFSET(0x1AAB2C50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SOLVETRIGONOMETRIC_OFFSET UNITYSDK_OFFSET(0x1AAB2310)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SWINGROTATION_OFFSET UNITYSDK_OFFSET(0x1AAB10B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAB1030)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_VirtualBone_TypeDefinitionIndex = 35099;
