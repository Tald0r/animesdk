...
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_GETDIRECTIONTOBENDPOINT_OFFSET UNITYSDK_OFFSET(0x1B0E9E40)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1B0E88D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_READ_OFFSET UNITYSDK_OFFSET(0x1B0E8570)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_ROTATEAROUNDPOINT_OFFSET UNITYSDK_OFFSET(0x1B0E8CF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_ROTATEBY_1_OFFSET UNITYSDK_OFFSET(0x1B0E92A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_ROTATEBY_OFFSET UNITYSDK_OFFSET(0x1B0E8FB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_ROTATETO_OFFSET UNITYSDK_OFFSET(0x1B0E9630)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SOLVECCD_OFFSET UNITYSDK_OFFSET(0x1B0EA8A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SOLVEFABRIKJOINT_OFFSET UNITYSDK_OFFSET(0x1B0EA7B0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SOLVEFABRIK_OFFSET UNITYSDK_OFFSET(0x1B0EA140)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SOLVETRIGONOMETRIC_OFFSET UNITYSDK_OFFSET(0x1B0E9800)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE_SWINGROTATION_OFFSET UNITYSDK_OFFSET(0x1B0E85A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_VIRTUALBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E8520)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_VirtualBone_TypeDefinitionIndex = 36101;
