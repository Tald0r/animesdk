...
#define ROOTMOTION_FINALIK_IKEFFECTOR_GETNODE_OFFSET UNITYSDK_OFFSET(0x1AE59100)
#define ROOTMOTION_FINALIK_IKEFFECTOR_GETPLANEROTATION_OFFSET UNITYSDK_OFFSET(0x1AE5A940)
#define ROOTMOTION_FINALIK_IKEFFECTOR_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1AE5B000)
#define ROOTMOTION_FINALIK_IKEFFECTOR_GET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AE59180)
#define ROOTMOTION_FINALIK_IKEFFECTOR_INITIATE_OFFSET UNITYSDK_OFFSET(0x1AE598C0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AE59420)
#define ROOTMOTION_FINALIK_IKEFFECTOR_ONPOSTWRITE_OFFSET UNITYSDK_OFFSET(0x1AE5A920)
#define ROOTMOTION_FINALIK_IKEFFECTOR_ONPRESOLVE_OFFSET UNITYSDK_OFFSET(0x1AE5A060)
#define ROOTMOTION_FINALIK_IKEFFECTOR_PINTOBONE_OFFSET UNITYSDK_OFFSET(0x1AE591A0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_RESETOFFSET_OFFSET UNITYSDK_OFFSET(0x1AE59E60)
#define ROOTMOTION_FINALIK_IKEFFECTOR_SETTOTARGET_OFFSET UNITYSDK_OFFSET(0x1AE59F60)
#define ROOTMOTION_FINALIK_IKEFFECTOR_SET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AE59190)
#define ROOTMOTION_FINALIK_IKEFFECTOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AE5AC60)
#define ROOTMOTION_FINALIK_IKEFFECTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE59350)
#define ROOTMOTION_FINALIK_IKEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE59290)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKEffector_TypeDefinitionIndex = 36056;
