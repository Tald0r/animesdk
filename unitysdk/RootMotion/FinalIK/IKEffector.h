...
#define ROOTMOTION_FINALIK_IKEFFECTOR_GETNODE_OFFSET UNITYSDK_OFFSET(0x1A8972A0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_GETPLANEROTATION_OFFSET UNITYSDK_OFFSET(0x1A898AE0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A8991A0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_GET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A897320)
#define ROOTMOTION_FINALIK_IKEFFECTOR_INITIATE_OFFSET UNITYSDK_OFFSET(0x1A897A60)
#define ROOTMOTION_FINALIK_IKEFFECTOR_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A8975C0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_ONPOSTWRITE_OFFSET UNITYSDK_OFFSET(0x1A898AC0)
#define ROOTMOTION_FINALIK_IKEFFECTOR_ONPRESOLVE_OFFSET UNITYSDK_OFFSET(0x1A898200)
#define ROOTMOTION_FINALIK_IKEFFECTOR_PINTOBONE_OFFSET UNITYSDK_OFFSET(0x1A897340)
#define ROOTMOTION_FINALIK_IKEFFECTOR_RESETOFFSET_OFFSET UNITYSDK_OFFSET(0x1A898000)
#define ROOTMOTION_FINALIK_IKEFFECTOR_SETTOTARGET_OFFSET UNITYSDK_OFFSET(0x1A898100)
#define ROOTMOTION_FINALIK_IKEFFECTOR_SET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1A897330)
#define ROOTMOTION_FINALIK_IKEFFECTOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A898E00)
#define ROOTMOTION_FINALIK_IKEFFECTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A8974F0)
#define ROOTMOTION_FINALIK_IKEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A897430)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKEffector_TypeDefinitionIndex = 35054;
