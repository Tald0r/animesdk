...
#define ROOTMOTION_FINALIK_FINGERRIG_ADDCHILDRENRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1A6BE0C0)
#define ROOTMOTION_FINALIK_FINGERRIG_ADDFINGER_OFFSET UNITYSDK_OFFSET(0x1A6BE220)
#define ROOTMOTION_FINALIK_FINGERRIG_AUTODETECT_OFFSET UNITYSDK_OFFSET(0x1A6BDE20)
#define ROOTMOTION_FINALIK_FINGERRIG_FIXFINGERTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A6BE700)
#define ROOTMOTION_FINALIK_FINGERRIG_FIXTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A6BE860)
#define ROOTMOTION_FINALIK_FINGERRIG_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1A6BDD80)
#define ROOTMOTION_FINALIK_FINGERRIG_INITIATESOLVER_OFFSET UNITYSDK_OFFSET(0x1A6BE5C0)
#define ROOTMOTION_FINALIK_FINGERRIG_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A6BDDA0)
#define ROOTMOTION_FINALIK_FINGERRIG_REMOVEFINGER_OFFSET UNITYSDK_OFFSET(0x1A6BE400)
#define ROOTMOTION_FINALIK_FINGERRIG_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x1A6BDD90)
#define ROOTMOTION_FINALIK_FINGERRIG_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1A6BE780)
#define ROOTMOTION_FINALIK_FINGERRIG_UPDATEFINGERSOLVERS_OFFSET UNITYSDK_OFFSET(0x1A6BE690)
#define ROOTMOTION_FINALIK_FINGERRIG_UPDATESOLVER_OFFSET UNITYSDK_OFFSET(0x1A6BE7F0)
#define ROOTMOTION_FINALIK_FINGERRIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6BE8E0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FingerRig_TypeDefinitionIndex = 35014;
