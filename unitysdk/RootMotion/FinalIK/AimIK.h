...
#define ROOTMOTION_FINALIK_AIMIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1A7755E0)
#define ROOTMOTION_FINALIK_AIMIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1A775630)
#define ROOTMOTION_FINALIK_AIMIK_GET_SHOULDSKIPANIMATORDELAYMODE_OFFSET UNITYSDK_OFFSET(0x1A775440)
#define ROOTMOTION_FINALIK_AIMIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A7754F0)
#define ROOTMOTION_FINALIK_AIMIK_OPENSETUPTUTORIAL_OFFSET UNITYSDK_OFFSET(0x1A775540)
#define ROOTMOTION_FINALIK_AIMIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1A7754A0)
#define ROOTMOTION_FINALIK_AIMIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1A775590)
#define ROOTMOTION_FINALIK_AIMIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A775640)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int AimIK_TypeDefinitionIndex = 35031;
