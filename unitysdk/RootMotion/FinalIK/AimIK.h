...
#define ROOTMOTION_FINALIK_AIMIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1AD13EE0)
#define ROOTMOTION_FINALIK_AIMIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1AD13F30)
#define ROOTMOTION_FINALIK_AIMIK_GET_SHOULDSKIPANIMATORDELAYMODE_OFFSET UNITYSDK_OFFSET(0x1AD13D40)
#define ROOTMOTION_FINALIK_AIMIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AD13DF0)
#define ROOTMOTION_FINALIK_AIMIK_OPENSETUPTUTORIAL_OFFSET UNITYSDK_OFFSET(0x1AD13E40)
#define ROOTMOTION_FINALIK_AIMIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AD13DA0)
#define ROOTMOTION_FINALIK_AIMIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1AD13E90)
#define ROOTMOTION_FINALIK_AIMIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD13F40)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int AimIK_TypeDefinitionIndex = 36033;
