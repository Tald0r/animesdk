...
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A5672B0)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A567330)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A566F60)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A566F50)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionSystem_InteractionDelegate_TypeDefinitionIndex = 35113;
