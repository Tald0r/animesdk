...
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB12990)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB12A10)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB12640)
#define ROOTMOTION_FINALIK_INTERACTIONSYSTEM_INTERACTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB12620)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionSystem_InteractionDelegate_TypeDefinitionIndex = 36115;
