...
#define ROOTMOTION_FINALIK_LOOKATIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1AB7D620)
#define ROOTMOTION_FINALIK_LOOKATIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1AB7D6D0)
#define ROOTMOTION_FINALIK_LOOKATIK_GET_SHOULDSKIPANIMATORDELAYMODE_OFFSET UNITYSDK_OFFSET(0x1AB7D670)
#define ROOTMOTION_FINALIK_LOOKATIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AB7D580)
#define ROOTMOTION_FINALIK_LOOKATIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AB7D530)
#define ROOTMOTION_FINALIK_LOOKATIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1AB7D5D0)
#define ROOTMOTION_FINALIK_LOOKATIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB7D6E0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int LookAtIK_TypeDefinitionIndex = 35042;
