...
#define ROOTMOTION_FINALIK_LOOKATIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1B19D3D0)
#define ROOTMOTION_FINALIK_LOOKATIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1B19D480)
#define ROOTMOTION_FINALIK_LOOKATIK_GET_SHOULDSKIPANIMATORDELAYMODE_OFFSET UNITYSDK_OFFSET(0x1B19D420)
#define ROOTMOTION_FINALIK_LOOKATIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B19D330)
#define ROOTMOTION_FINALIK_LOOKATIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1B19D2E0)
#define ROOTMOTION_FINALIK_LOOKATIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1B19D380)
#define ROOTMOTION_FINALIK_LOOKATIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B19D490)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int LookAtIK_TypeDefinitionIndex = 36044;
