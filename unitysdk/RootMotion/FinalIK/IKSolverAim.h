...
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GETANGLE_OFFSET UNITYSDK_OFFSET(0x1A6C13A0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GETCLAMPEDIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1A6C2BD0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_ALLOWCOMMONPARENT_OFFSET UNITYSDK_OFFSET(0x1A6C1390)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_LOCALDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A6C33C0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_MINBONES_OFFSET UNITYSDK_OFFSET(0x1A6C38F0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_TRANSFORMAXIS_OFFSET UNITYSDK_OFFSET(0x1A6C1630)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_TRANSFORMPOLEAXIS_OFFSET UNITYSDK_OFFSET(0x1A6C17A0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1A6C1910)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6C2080)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_ROTATETOTARGETVIRTUAL_OFFSET UNITYSDK_OFFSET(0x1A6C4640)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_ROTATETOTARGET_OFFSET UNITYSDK_OFFSET(0x1A6C3900)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_SOLVEVIRTUAL_OFFSET UNITYSDK_OFFSET(0x1A6C35E0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_SOLVE_OFFSET UNITYSDK_OFFSET(0x1A6C37E0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6C5160)
#define ROOTMOTION_FINALIK_IKSOLVERAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6C5040)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverAim_TypeDefinitionIndex = 35067;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(IKSolverAim_TypeDefinitionIndex)->GetStaticField(0x24CC0);
		}
