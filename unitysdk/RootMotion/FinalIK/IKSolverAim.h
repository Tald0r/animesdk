...
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GETANGLE_OFFSET UNITYSDK_OFFSET(0x1AC6C5E0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GETCLAMPEDIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1AC6DE10)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_ALLOWCOMMONPARENT_OFFSET UNITYSDK_OFFSET(0x1AC6C5D0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_LOCALDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AC6E600)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_MINBONES_OFFSET UNITYSDK_OFFSET(0x1AC6EB30)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_TRANSFORMAXIS_OFFSET UNITYSDK_OFFSET(0x1AC6C870)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_GET_TRANSFORMPOLEAXIS_OFFSET UNITYSDK_OFFSET(0x1AC6C9E0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_ONINITIATE_OFFSET UNITYSDK_OFFSET(0x1AC6CB50)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC6D2C0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_ROTATETOTARGETVIRTUAL_OFFSET UNITYSDK_OFFSET(0x1AC6F880)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_ROTATETOTARGET_OFFSET UNITYSDK_OFFSET(0x1AC6EB40)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_SOLVEVIRTUAL_OFFSET UNITYSDK_OFFSET(0x1AC6E820)
#define ROOTMOTION_FINALIK_IKSOLVERAIM_SOLVE_OFFSET UNITYSDK_OFFSET(0x1AC6EA20)
#define ROOTMOTION_FINALIK_IKSOLVERAIM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AC703A0)
#define ROOTMOTION_FINALIK_IKSOLVERAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC70280)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverAim_TypeDefinitionIndex = 36069;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(IKSolverAim_TypeDefinitionIndex)->GetStaticField(0x266F0);
		}
