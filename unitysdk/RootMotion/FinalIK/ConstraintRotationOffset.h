...
#define ROOTMOTION_FINALIK_CONSTRAINTROTATIONOFFSET_GET_ROTATIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A5615D0)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATIONOFFSET_UPDATECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A561350)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATIONOFFSET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A561650)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATIONOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A561640)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ConstraintRotationOffset_TypeDefinitionIndex = 35010;
