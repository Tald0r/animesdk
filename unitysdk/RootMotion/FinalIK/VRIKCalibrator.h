...
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATEBODY_OFFSET UNITYSDK_OFFSET(0x1AB1B770)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATEHANDS_OFFSET UNITYSDK_OFFSET(0x1AB1B450)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATEHAND_OFFSET UNITYSDK_OFFSET(0x1AB1BCB0)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATEHEAD_OFFSET UNITYSDK_OFFSET(0x1AB1A5C0)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATELEG_1_OFFSET UNITYSDK_OFFSET(0x1AB1A000)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATELEG_OFFSET UNITYSDK_OFFSET(0x1AB17D40)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATESCALE_1_OFFSET UNITYSDK_OFFSET(0x1AB15090)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATESCALE_OFFSET UNITYSDK_OFFSET(0x1AB15290)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATE_1_OFFSET UNITYSDK_OFFSET(0x1AB18AB0)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATE_2_OFFSET UNITYSDK_OFFSET(0x1AB1A350)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_CALIBRATE_OFFSET UNITYSDK_OFFSET(0x1AB152B0)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_GUESSPALMTOTHUMBAXIS_OFFSET UNITYSDK_OFFSET(0x1AB1C990)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_GUESSWRISTTOPALMAXIS_OFFSET UNITYSDK_OFFSET(0x1AB1C610)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_RECALIBRATESCALE_1_OFFSET UNITYSDK_OFFSET(0x1AB15010)
#define ROOTMOTION_FINALIK_VRIKCALIBRATOR_RECALIBRATESCALE_OFFSET UNITYSDK_OFFSET(0x1AB14F90)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int VRIKCalibrator_TypeDefinitionIndex = 36184;
