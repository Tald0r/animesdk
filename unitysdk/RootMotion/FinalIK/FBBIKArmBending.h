...
#define ROOTMOTION_FINALIK_FBBIKARMBENDING_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B195BF0)
#define ROOTMOTION_FINALIK_FBBIKARMBENDING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B196D40)
#define ROOTMOTION_FINALIK_FBBIKARMBENDING_ONPOSTFBBIK_OFFSET UNITYSDK_OFFSET(0x1B196960)
#define ROOTMOTION_FINALIK_FBBIKARMBENDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B196E70)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBBIKArmBending_TypeDefinitionIndex = 36049;
