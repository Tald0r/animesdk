...
#define ROOTMOTION_FINALIK_FBBIKARMBENDING_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB75E30)
#define ROOTMOTION_FINALIK_FBBIKARMBENDING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AB76F80)
#define ROOTMOTION_FINALIK_FBBIKARMBENDING_ONPOSTFBBIK_OFFSET UNITYSDK_OFFSET(0x1AB76BA0)
#define ROOTMOTION_FINALIK_FBBIKARMBENDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB770B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int FBBIKArmBending_TypeDefinitionIndex = 35047;
