...
#define ROOTMOTION_FINALIK_CONSTRAINTROTATION_UPDATECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1AE56E60)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE56F80)
#define ROOTMOTION_FINALIK_CONSTRAINTROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE56F70)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int ConstraintRotation_TypeDefinitionIndex = 36011;
