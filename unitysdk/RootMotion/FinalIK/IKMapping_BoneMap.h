...
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_FIXTONODE_OFFSET UNITYSDK_OFFSET(0x1B19BB80)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_FIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B19AD40)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GETPLANEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B19BCB0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GETTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1B19BE90)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GET_ISNODEBONE_OFFSET UNITYSDK_OFFSET(0x1B19ADA0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GET_LASTANIMATEDTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1B19B820)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GET_SWINGDIRECTION_OFFSET UNITYSDK_OFFSET(0x1B19AB50)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_INITIATE_OFFSET UNITYSDK_OFFSET(0x1B19AAD0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_MAINTAINROTATION_OFFSET UNITYSDK_OFFSET(0x1B19BB00)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_POSITIONTOPLANE_OFFSET UNITYSDK_OFFSET(0x1B19C030)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_ROTATETOEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1B19C9A0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_ROTATETOMAINTAIN_OFFSET UNITYSDK_OFFSET(0x1B19C8F0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_ROTATETOPLANE_OFFSET UNITYSDK_OFFSET(0x1B19C080)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1B19BAA0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1B19ADB0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLOCALSWINGAXIS_1_OFFSET UNITYSDK_OFFSET(0x1B19AEC0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLOCALSWINGAXIS_OFFSET UNITYSDK_OFFSET(0x1B19AEB0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLOCALTWISTAXIS_OFFSET UNITYSDK_OFFSET(0x1B19B160)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETPLANE_OFFSET UNITYSDK_OFFSET(0x1B19B2F0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETTOIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1B19BB40)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1B19ACB0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SWING_1_OFFSET UNITYSDK_OFFSET(0x1B19C2A0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SWING_OFFSET UNITYSDK_OFFSET(0x1B19C210)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_TWIST_OFFSET UNITYSDK_OFFSET(0x1B19C5D0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_UPDATEPLANE_OFFSET UNITYSDK_OFFSET(0x1B19B480)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B19CB00)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMapping_BoneMap_TypeDefinitionIndex = 36058;
