...
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_FIXTONODE_OFFSET UNITYSDK_OFFSET(0x1AB7BDD0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_FIXTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AB7AF90)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GETPLANEPOSITION_OFFSET UNITYSDK_OFFSET(0x1AB7BF00)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GETTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1AB7C0E0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GET_ISNODEBONE_OFFSET UNITYSDK_OFFSET(0x1AB7AFF0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GET_LASTANIMATEDTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1AB7BA70)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_GET_SWINGDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AB7ADA0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_INITIATE_OFFSET UNITYSDK_OFFSET(0x1AB7AD20)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_MAINTAINROTATION_OFFSET UNITYSDK_OFFSET(0x1AB7BD50)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_POSITIONTOPLANE_OFFSET UNITYSDK_OFFSET(0x1AB7C280)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_ROTATETOEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1AB7CBF0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_ROTATETOMAINTAIN_OFFSET UNITYSDK_OFFSET(0x1AB7CB40)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_ROTATETOPLANE_OFFSET UNITYSDK_OFFSET(0x1AB7C2D0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1AB7BCF0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1AB7B000)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLOCALSWINGAXIS_1_OFFSET UNITYSDK_OFFSET(0x1AB7B110)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLOCALSWINGAXIS_OFFSET UNITYSDK_OFFSET(0x1AB7B100)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETLOCALTWISTAXIS_OFFSET UNITYSDK_OFFSET(0x1AB7B3B0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETPLANE_OFFSET UNITYSDK_OFFSET(0x1AB7B540)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SETTOIKPOSITION_OFFSET UNITYSDK_OFFSET(0x1AB7BD90)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_STOREDEFAULTLOCALSTATE_OFFSET UNITYSDK_OFFSET(0x1AB7AF00)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SWING_1_OFFSET UNITYSDK_OFFSET(0x1AB7C4F0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_SWING_OFFSET UNITYSDK_OFFSET(0x1AB7C460)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_TWIST_OFFSET UNITYSDK_OFFSET(0x1AB7C820)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP_UPDATEPLANE_OFFSET UNITYSDK_OFFSET(0x1AB7B6D0)
#define ROOTMOTION_FINALIK_IKMAPPING_BONEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB7CD50)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKMapping_BoneMap_TypeDefinitionIndex = 35056;
