...
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_ADJUSTCHESTBYHANDS_OFFSET UNITYSDK_OFFSET(0x1AC9DC10)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_APPLYOFFSETS_OFFSET UNITYSDK_OFFSET(0x1AC9CC00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_BEND_1_OFFSET UNITYSDK_OFFSET(0x1AC9F9D0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_BEND_OFFSET UNITYSDK_OFFSET(0x1AC9FF50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_CALCULATECHESTTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1AC9D710)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_FABRIKPASS_OFFSET UNITYSDK_OFFSET(0x1AC9F730)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_ANCHORRELATIVETOHEAD_OFFSET UNITYSDK_OFFSET(0x1AC9ABB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_ANCHORROTATION_OFFSET UNITYSDK_OFFSET(0x1AC9AB90)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_CHEST_OFFSET UNITYSDK_OFFSET(0x1AC9AAA0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_FIRSTSPINEBONE_OFFSET UNITYSDK_OFFSET(0x1AC9AA60)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_HEAD_OFFSET UNITYSDK_OFFSET(0x1AC9AB10)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_NECK_OFFSET UNITYSDK_OFFSET(0x1AC9AB50)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_GET_PELVIS_OFFSET UNITYSDK_OFFSET(0x1AC9AA20)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_INVERSETRANSLATETOHEAD_OFFSET UNITYSDK_OFFSET(0x1AC9FE00)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_LIMITPELVISPOSITION_OFFSET UNITYSDK_OFFSET(0x1ACA0B30)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_ONREAD_OFFSET UNITYSDK_OFFSET(0x1AC9ABD0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_PRESOLVE_OFFSET UNITYSDK_OFFSET(0x1AC9BFF0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_RESETOFFSETS_OFFSET UNITYSDK_OFFSET(0x1ACA0AB0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_SET_ANCHORRELATIVETOHEAD_OFFSET UNITYSDK_OFFSET(0x1AC9ABC0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_SET_ANCHORROTATION_OFFSET UNITYSDK_OFFSET(0x1AC9ABA0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_SOLVEPELVIS_OFFSET UNITYSDK_OFFSET(0x1ACA02A0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_SOLVE_OFFSET UNITYSDK_OFFSET(0x1AC9E2E0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_TRANSLATEPELVIS_OFFSET UNITYSDK_OFFSET(0x1AC9EED0)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE_WRITE_OFFSET UNITYSDK_OFFSET(0x1ACA0780)
#define ROOTMOTION_FINALIK_IKSOLVERVR_SPINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACA0F40)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int IKSolverVR_Spine_TypeDefinitionIndex = 36098;
