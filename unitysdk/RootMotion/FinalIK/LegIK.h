...
#define ROOTMOTION_FINALIK_LEGIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1ACA21C0)
#define ROOTMOTION_FINALIK_LEGIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1ACA2210)
#define ROOTMOTION_FINALIK_LEGIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1ACA2120)
#define ROOTMOTION_FINALIK_LEGIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1ACA20D0)
#define ROOTMOTION_FINALIK_LEGIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1ACA2170)
#define ROOTMOTION_FINALIK_LEGIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACA2220)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int LegIK_TypeDefinitionIndex = 36041;
