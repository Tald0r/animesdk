...
#define ROOTMOTION_FINALIK_LEGIK_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1A6F6F60)
#define ROOTMOTION_FINALIK_LEGIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0x1A6F6FB0)
#define ROOTMOTION_FINALIK_LEGIK_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A6F6EC0)
#define ROOTMOTION_FINALIK_LEGIK_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1A6F6E70)
#define ROOTMOTION_FINALIK_LEGIK_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1A6F6F10)
#define ROOTMOTION_FINALIK_LEGIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6F6FC0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int LegIK_TypeDefinitionIndex = 35039;
