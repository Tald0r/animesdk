...
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1AE14470)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_BUILDREACHCONES_OFFSET UNITYSDK_OFFSET(0x1AE14540)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_GETREACHCONE_OFFSET UNITYSDK_OFFSET(0x1AE16A40)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_GETSCALAR_OFFSET UNITYSDK_OFFSET(0x1AE168B0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_LIMITROTATION_OFFSET UNITYSDK_OFFSET(0x1AE14BE0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_LIMITSWING_OFFSET UNITYSDK_OFFSET(0x1AE15100)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AE143D0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AE14380)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_POINTTOTANGENTPLANE_OFFSET UNITYSDK_OFFSET(0x1AE168E0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x1AE155E0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_SETLIMITPOINTS_OFFSET UNITYSDK_OFFSET(0x1AE144C0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_SMOOTHPOINTS_OFFSET UNITYSDK_OFFSET(0x1AE16060)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_START_OFFSET UNITYSDK_OFFSET(0x1AE14C90)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1AE14420)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_TANGENTPOINTTOSPHERE_OFFSET UNITYSDK_OFFSET(0x1AE16990)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE16BB0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLimitPolygonal_TypeDefinitionIndex = 36136;
