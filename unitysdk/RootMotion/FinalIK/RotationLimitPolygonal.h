...
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1A818930)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_BUILDREACHCONES_OFFSET UNITYSDK_OFFSET(0x1A818A00)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_GETREACHCONE_OFFSET UNITYSDK_OFFSET(0x1A81AF00)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_GETSCALAR_OFFSET UNITYSDK_OFFSET(0x1A81AD70)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_LIMITROTATION_OFFSET UNITYSDK_OFFSET(0x1A8190A0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_LIMITSWING_OFFSET UNITYSDK_OFFSET(0x1A8195C0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A818890)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1A818840)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_POINTTOTANGENTPLANE_OFFSET UNITYSDK_OFFSET(0x1A81ADA0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x1A819AA0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_SETLIMITPOINTS_OFFSET UNITYSDK_OFFSET(0x1A818980)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_SMOOTHPOINTS_OFFSET UNITYSDK_OFFSET(0x1A81A520)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_START_OFFSET UNITYSDK_OFFSET(0x1A819150)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1A8188E0)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL_TANGENTPOINTTOSPHERE_OFFSET UNITYSDK_OFFSET(0x1A81AE50)
#define ROOTMOTION_FINALIK_ROTATIONLIMITPOLYGONAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A81B070)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RotationLimitPolygonal_TypeDefinitionIndex = 35134;
