...
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_CROSSFADESTART_OFFSET UNITYSDK_OFFSET(0x1AEFE400)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1AEFE1C0)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET_ONAPPLY_OFFSET UNITYSDK_OFFSET(0x1AEFE470)
#define ROOTMOTION_FINALIK_HITREACTIONVRIK_POSITIONOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEFE8B0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int HitReactionVRIK_PositionOffset_TypeDefinitionIndex = 35158;
