...
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_DESTROYLEGS_OFFSET UNITYSDK_OFFSET(0x1AD17360)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_INITIATEFEET_OFFSET UNITYSDK_OFFSET(0x1AD14D00)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_INITIATE_OFFSET UNITYSDK_OFFSET(0x1AD147C0)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_ISREADYTOINITIATELEGS_OFFSET UNITYSDK_OFFSET(0x1AD144F0)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_ISREADYTOINITIATE_OFFSET UNITYSDK_OFFSET(0x1AD14310)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD15120)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AD17320)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AD146B0)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_ONPOSTSOLVERUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD16E70)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_ONSOLVERUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD15B50)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AD14010)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AD13FC0)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0x1AD14060)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_ROOTROTATION_OFFSET UNITYSDK_OFFSET(0x1AD151E0)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_SETFOOTIK_OFFSET UNITYSDK_OFFSET(0x1AD16CF0)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_UPDATEFOREFEETROOT_OFFSET UNITYSDK_OFFSET(0x1AD168B0)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AD14750)
#define ROOTMOTION_FINALIK_GROUNDERQUADRUPED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD17550)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int GrounderQuadruped_TypeDefinitionIndex = 36023;
