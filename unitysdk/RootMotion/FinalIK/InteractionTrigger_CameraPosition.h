...
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CAMERAPOSITION_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1B0EAAE0)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CAMERAPOSITION_ISINRANGE_OFFSET UNITYSDK_OFFSET(0x1B0EAF00)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CAMERAPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EB2D0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionTrigger_CameraPosition_TypeDefinitionIndex = 36122;
