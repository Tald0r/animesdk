...
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CAMERAPOSITION_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1AAB35F0)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CAMERAPOSITION_ISINRANGE_OFFSET UNITYSDK_OFFSET(0x1AAB3A10)
#define ROOTMOTION_FINALIK_INTERACTIONTRIGGER_CAMERAPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAB3DE0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionTrigger_CameraPosition_TypeDefinitionIndex = 35120;
