...
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_RIGIDBONE_RECORDVELOCITY_OFFSET UNITYSDK_OFFSET(0x1AE8B8D0)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_RIGIDBONE_WAKEUP_OFFSET UNITYSDK_OFFSET(0x1AE8BB30)
#define ROOTMOTION_FINALIK_RAGDOLLUTILITY_RIGIDBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE8B600)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int RagdollUtility_Rigidbone_TypeDefinitionIndex = 35128;
	...
	public:
		...
		::UnityEngine::Rigidbody* c; // 0x30
		::System::Boolean updateAnchor; // 0x38
		::UnityEngine::Vector3 lastPosition; // 0x3C
		::UnityEngine::Quaternion lastRotation; // 0x48
