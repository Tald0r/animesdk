...
#define ROOTMOTION_FINALIK_CONSTRAINTS_INITIATE_OFFSET UNITYSDK_OFFSET(0x1A80AEA0)
#define ROOTMOTION_FINALIK_CONSTRAINTS_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A80AE30)
#define ROOTMOTION_FINALIK_CONSTRAINTS_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A80AFF0)
#define ROOTMOTION_FINALIK_CONSTRAINTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80B610)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int Constraints_TypeDefinitionIndex = 35011;
