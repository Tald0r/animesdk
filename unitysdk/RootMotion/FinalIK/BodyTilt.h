...
#define ROOTMOTION_FINALIK_BODYTILT_ONMODIFYOFFSET_OFFSET UNITYSDK_OFFSET(0x1AE569E0)
#define ROOTMOTION_FINALIK_BODYTILT_START_OFFSET UNITYSDK_OFFSET(0x1AE56870)
#define ROOTMOTION_FINALIK_BODYTILT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE56E30)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int BodyTilt_TypeDefinitionIndex = 36148;
