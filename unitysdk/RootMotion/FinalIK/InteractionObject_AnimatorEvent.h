...
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT_ACTIVATE_1_OFFSET UNITYSDK_OFFSET(0x1B5C2470)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT_ACTIVATE_2_OFFSET UNITYSDK_OFFSET(0x1B5C2520)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1B5C22A0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C25E0)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionObject_AnimatorEvent_TypeDefinitionIndex = 36110;
