...
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT_ACTIVATE_1_OFFSET UNITYSDK_OFFSET(0x1AFB0BE0)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT_ACTIVATE_2_OFFSET UNITYSDK_OFFSET(0x1AFB0C90)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1AFB0A10)
#define ROOTMOTION_FINALIK_INTERACTIONOBJECT_ANIMATOREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB0D50)

namespace RootMotion::FinalIK
{
	inline static constexpr unsigned int InteractionObject_AnimatorEvent_TypeDefinitionIndex = 35108;
