...
#define ROOTMOTION_BIPEDLIMBORIENTATIONS_GET_MAXBIPED_OFFSET UNITYSDK_OFFSET(0x1AB0C0E0)
#define ROOTMOTION_BIPEDLIMBORIENTATIONS_GET_UMA_OFFSET UNITYSDK_OFFSET(0x1AB0BE70)
#define ROOTMOTION_BIPEDLIMBORIENTATIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0BE50)

namespace RootMotion
{
	inline static constexpr unsigned int BipedLimbOrientations_TypeDefinitionIndex = 35978;
