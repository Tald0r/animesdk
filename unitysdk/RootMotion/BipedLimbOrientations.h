...
#define ROOTMOTION_BIPEDLIMBORIENTATIONS_GET_MAXBIPED_OFFSET UNITYSDK_OFFSET(0x1A560A20)
#define ROOTMOTION_BIPEDLIMBORIENTATIONS_GET_UMA_OFFSET UNITYSDK_OFFSET(0x1A5607B0)
#define ROOTMOTION_BIPEDLIMBORIENTATIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A560790)

namespace RootMotion
{
	inline static constexpr unsigned int BipedLimbOrientations_TypeDefinitionIndex = 34976;
