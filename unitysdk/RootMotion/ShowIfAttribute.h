...
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_INDENT_OFFSET UNITYSDK_OFFSET(0x1AFB1E50)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1AFB1E70)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_OTHERPROPVALUE_OFFSET UNITYSDK_OFFSET(0x1AFB1E30)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_PROPNAME_OFFSET UNITYSDK_OFFSET(0x1AFB1DF0)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_PROPVALUE_OFFSET UNITYSDK_OFFSET(0x1AFB1E10)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_INDENT_OFFSET UNITYSDK_OFFSET(0x1AFB1E60)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1AFB1E80)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_OTHERPROPVALUE_OFFSET UNITYSDK_OFFSET(0x1AFB1E40)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_PROPNAME_OFFSET UNITYSDK_OFFSET(0x1AFB1E00)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_PROPVALUE_OFFSET UNITYSDK_OFFSET(0x1AFB1E20)
#define ROOTMOTION_SHOWIFATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB1E90)

namespace RootMotion
{
	inline static constexpr unsigned int ShowIfAttribute_TypeDefinitionIndex = 34991;

	class ShowIfAttribute : public ::UnityEngine::PropertyAttribute
	{
	public:
		::System::Object* _otherPropValue_k__BackingField; // 0x10
		::System::Object* _propValue_k__BackingField; // 0x18
		::System::String* _propName_k__BackingField; // 0x20
