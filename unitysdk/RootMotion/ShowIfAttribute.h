...
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_INDENT_OFFSET UNITYSDK_OFFSET(0x1B5C36E0)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1B5C3700)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_OTHERPROPVALUE_OFFSET UNITYSDK_OFFSET(0x1B5C36C0)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_PROPNAME_OFFSET UNITYSDK_OFFSET(0x1B5C3680)
#define ROOTMOTION_SHOWIFATTRIBUTE_GET_PROPVALUE_OFFSET UNITYSDK_OFFSET(0x1B5C36A0)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_INDENT_OFFSET UNITYSDK_OFFSET(0x1B5C36F0)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1B5C3710)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_OTHERPROPVALUE_OFFSET UNITYSDK_OFFSET(0x1B5C36D0)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_PROPNAME_OFFSET UNITYSDK_OFFSET(0x1B5C3690)
#define ROOTMOTION_SHOWIFATTRIBUTE_SET_PROPVALUE_OFFSET UNITYSDK_OFFSET(0x1B5C36B0)
#define ROOTMOTION_SHOWIFATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C3720)

namespace RootMotion
{
	inline static constexpr unsigned int ShowIfAttribute_TypeDefinitionIndex = 35993;
