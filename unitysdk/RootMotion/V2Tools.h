...
#define ROOTMOTION_V2TOOLS_DELTAANGLEXZ_OFFSET UNITYSDK_OFFSET(0x1AA607C0)
#define ROOTMOTION_V2TOOLS_DELTAANGLE_OFFSET UNITYSDK_OFFSET(0x1AA60710)
#define ROOTMOTION_V2TOOLS_LINECIRCLEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1AA60860)
#define ROOTMOTION_V2TOOLS_RAYCIRCLEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1AA60970)
#define ROOTMOTION_V2TOOLS_XZ_OFFSET UNITYSDK_OFFSET(0x1AA60700)

namespace RootMotion
{
	inline static constexpr unsigned int V2Tools_TypeDefinitionIndex = 35000;
