...
#define ROOTMOTION_V2TOOLS_DELTAANGLEXZ_OFFSET UNITYSDK_OFFSET(0x1B092130)
#define ROOTMOTION_V2TOOLS_DELTAANGLE_OFFSET UNITYSDK_OFFSET(0x1B092080)
#define ROOTMOTION_V2TOOLS_LINECIRCLEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1B0921D0)
#define ROOTMOTION_V2TOOLS_RAYCIRCLEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1B0922E0)
#define ROOTMOTION_V2TOOLS_XZ_OFFSET UNITYSDK_OFFSET(0x1B092070)

namespace RootMotion
{
	inline static constexpr unsigned int V2Tools_TypeDefinitionIndex = 36002;
