...
#define ROOTMOTION_BAKER_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1AB0BCD0)
#define ROOTMOTION_BAKER_BAKECLIP_OFFSET UNITYSDK_OFFSET(0x1AB0BD80)
#define ROOTMOTION_BAKER_GET_BAKINGPROGRESS_OFFSET UNITYSDK_OFFSET(0x1AB0BD40)
#define ROOTMOTION_BAKER_GET_CLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x1AB0BD60)
#define ROOTMOTION_BAKER_GET_ISBAKING_OFFSET UNITYSDK_OFFSET(0x1AB0BD20)
#define ROOTMOTION_BAKER_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AB0BC30)
#define ROOTMOTION_BAKER_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1AB0BBE0)
#define ROOTMOTION_BAKER_SET_BAKINGPROGRESS_OFFSET UNITYSDK_OFFSET(0x1AB0BD50)
#define ROOTMOTION_BAKER_SET_CLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x1AB0BD70)
#define ROOTMOTION_BAKER_SET_ISBAKING_OFFSET UNITYSDK_OFFSET(0x1AB0BD30)
#define ROOTMOTION_BAKER_STARTBAKING_OFFSET UNITYSDK_OFFSET(0x1AB0BD90)
#define ROOTMOTION_BAKER_STOPBAKING_OFFSET UNITYSDK_OFFSET(0x1AB0BDA0)
#define ROOTMOTION_BAKER_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1AB0BC80)
#define ROOTMOTION_BAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0BDB0)

namespace RootMotion
{
	inline static constexpr unsigned int Baker_TypeDefinitionIndex = 35961;
