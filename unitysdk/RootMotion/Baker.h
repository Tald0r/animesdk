...
#define ROOTMOTION_BAKER_ASTHREAD_OFFSET UNITYSDK_OFFSET(0x1A560610)
#define ROOTMOTION_BAKER_BAKECLIP_OFFSET UNITYSDK_OFFSET(0x1A5606C0)
#define ROOTMOTION_BAKER_GET_BAKINGPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A560680)
#define ROOTMOTION_BAKER_GET_CLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x1A5606A0)
#define ROOTMOTION_BAKER_GET_ISBAKING_OFFSET UNITYSDK_OFFSET(0x1A560660)
#define ROOTMOTION_BAKER_OPENSCRIPTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A560570)
#define ROOTMOTION_BAKER_OPENUSERMANUAL_OFFSET UNITYSDK_OFFSET(0x1A560520)
#define ROOTMOTION_BAKER_SET_BAKINGPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A560690)
#define ROOTMOTION_BAKER_SET_CLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x1A5606B0)
#define ROOTMOTION_BAKER_SET_ISBAKING_OFFSET UNITYSDK_OFFSET(0x1A560670)
#define ROOTMOTION_BAKER_STARTBAKING_OFFSET UNITYSDK_OFFSET(0x1A5606D0)
#define ROOTMOTION_BAKER_STOPBAKING_OFFSET UNITYSDK_OFFSET(0x1A5606E0)
#define ROOTMOTION_BAKER_SUPPORTGROUP_OFFSET UNITYSDK_OFFSET(0x1A5605C0)
#define ROOTMOTION_BAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5606F0)

namespace RootMotion
{
	inline static constexpr unsigned int Baker_TypeDefinitionIndex = 34959;
