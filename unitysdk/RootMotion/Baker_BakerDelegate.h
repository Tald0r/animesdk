...
#define ROOTMOTION_BAKER_BAKERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE4ED70)
#define ROOTMOTION_BAKER_BAKERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE4EDD0)
#define ROOTMOTION_BAKER_BAKERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE4E7D0)
#define ROOTMOTION_BAKER_BAKERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4E7B0)

namespace RootMotion
{
	inline static constexpr unsigned int Baker_BakerDelegate_TypeDefinitionIndex = 35963;
