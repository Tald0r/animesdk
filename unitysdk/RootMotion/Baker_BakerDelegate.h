...
#define ROOTMOTION_BAKER_BAKERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A88CF10)
#define ROOTMOTION_BAKER_BAKERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A88CF70)
#define ROOTMOTION_BAKER_BAKERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A88C970)
#define ROOTMOTION_BAKER_BAKERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A88C960)

namespace RootMotion
{
	inline static constexpr unsigned int Baker_BakerDelegate_TypeDefinitionIndex = 34961;
