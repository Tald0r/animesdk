...
#define ROOTMOTION_AXISTOOLS_GETAXISTODIRECTION_OFFSET UNITYSDK_OFFSET(0x1ACFA5D0)
#define ROOTMOTION_AXISTOOLS_GETAXISTOPOINT_OFFSET UNITYSDK_OFFSET(0x1ACFA3D0)
#define ROOTMOTION_AXISTOOLS_GETAXISVECTORTODIRECTION_1_OFFSET UNITYSDK_OFFSET(0x1ACFA760)
#define ROOTMOTION_AXISTOOLS_GETAXISVECTORTODIRECTION_OFFSET UNITYSDK_OFFSET(0x1ACFA6F0)
#define ROOTMOTION_AXISTOOLS_GETAXISVECTORTOPOINT_OFFSET UNITYSDK_OFFSET(0x1ACFA520)
#define ROOTMOTION_AXISTOOLS_TOAXIS_OFFSET UNITYSDK_OFFSET(0x1ACFA380)
#define ROOTMOTION_AXISTOOLS_TOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1ACFA320)
#define ROOTMOTION_AXISTOOLS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACFAAC0)

namespace RootMotion
{
	inline static constexpr unsigned int AxisTools_TypeDefinitionIndex = 34975;
