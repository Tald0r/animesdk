...
#define ROOTMOTION_AXISTOOLS_GETAXISTODIRECTION_OFFSET UNITYSDK_OFFSET(0x1B30D1B0)
#define ROOTMOTION_AXISTOOLS_GETAXISTOPOINT_OFFSET UNITYSDK_OFFSET(0x1B30CFB0)
#define ROOTMOTION_AXISTOOLS_GETAXISVECTORTODIRECTION_1_OFFSET UNITYSDK_OFFSET(0x1B30D340)
#define ROOTMOTION_AXISTOOLS_GETAXISVECTORTODIRECTION_OFFSET UNITYSDK_OFFSET(0x1B30D2D0)
#define ROOTMOTION_AXISTOOLS_GETAXISVECTORTOPOINT_OFFSET UNITYSDK_OFFSET(0x1B30D100)
#define ROOTMOTION_AXISTOOLS_TOAXIS_OFFSET UNITYSDK_OFFSET(0x1B30CF60)
#define ROOTMOTION_AXISTOOLS_TOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1B30CF00)
#define ROOTMOTION_AXISTOOLS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B30D6A0)

namespace RootMotion
{
	inline static constexpr unsigned int AxisTools_TypeDefinitionIndex = 35977;
