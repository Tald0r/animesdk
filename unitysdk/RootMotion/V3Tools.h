...
#define ROOTMOTION_V3TOOLS_CLAMPDIRECTION_1_OFFSET UNITYSDK_OFFSET(0x1AAB5AD0)
#define ROOTMOTION_V3TOOLS_CLAMPDIRECTION_2_OFFSET UNITYSDK_OFFSET(0x1AAB5E40)
#define ROOTMOTION_V3TOOLS_CLAMPDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AAB57A0)
#define ROOTMOTION_V3TOOLS_DIV_OFFSET UNITYSDK_OFFSET(0x1AAB6B30)
#define ROOTMOTION_V3TOOLS_EXTRACTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1AAB54C0)
#define ROOTMOTION_V3TOOLS_EXTRACTVERTICAL_OFFSET UNITYSDK_OFFSET(0x1AAB5360)
#define ROOTMOTION_V3TOOLS_FLATTEN_OFFSET UNITYSDK_OFFSET(0x1AAB5650)
#define ROOTMOTION_V3TOOLS_GETBANK_1_OFFSET UNITYSDK_OFFSET(0x1AAB4EB0)
#define ROOTMOTION_V3TOOLS_GETBANK_OFFSET UNITYSDK_OFFSET(0x1AAB4A60)
#define ROOTMOTION_V3TOOLS_GETPITCH_1_OFFSET UNITYSDK_OFFSET(0x1AAB4DC0)
#define ROOTMOTION_V3TOOLS_GETPITCH_OFFSET UNITYSDK_OFFSET(0x1AAB49C0)
#define ROOTMOTION_V3TOOLS_GETYAW_1_OFFSET UNITYSDK_OFFSET(0x1AAB4C20)
#define ROOTMOTION_V3TOOLS_GETYAW_OFFSET UNITYSDK_OFFSET(0x1AAB49A0)
#define ROOTMOTION_V3TOOLS_INVERSETRANSFORMPOINTUNSCALED_OFFSET UNITYSDK_OFFSET(0x1AAB66E0)
#define ROOTMOTION_V3TOOLS_INVERSETRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1AAB6920)
#define ROOTMOTION_V3TOOLS_LERP_OFFSET UNITYSDK_OFFSET(0x1AAB5240)
#define ROOTMOTION_V3TOOLS_LINETOPLANE_OFFSET UNITYSDK_OFFSET(0x1AAB61B0)
#define ROOTMOTION_V3TOOLS_POINTTOPLANE_OFFSET UNITYSDK_OFFSET(0x1AAB6350)
#define ROOTMOTION_V3TOOLS_SLERP_OFFSET UNITYSDK_OFFSET(0x1AAB52C0)
#define ROOTMOTION_V3TOOLS_TRANSFORMPOINTUNSCALED_OFFSET UNITYSDK_OFFSET(0x1AAB64F0)
#define ROOTMOTION_V3TOOLS_TRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1AAB6B60)

namespace RootMotion
{
	inline static constexpr unsigned int V3Tools_TypeDefinitionIndex = 35001;
