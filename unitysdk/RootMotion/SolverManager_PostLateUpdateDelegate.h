...
#define ROOTMOTION_SOLVERMANAGER_POSTLATEUPDATEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB1FB60)
#define ROOTMOTION_SOLVERMANAGER_POSTLATEUPDATEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB1FB90)
#define ROOTMOTION_SOLVERMANAGER_POSTLATEUPDATEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB1F8C0)
#define ROOTMOTION_SOLVERMANAGER_POSTLATEUPDATEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB1F8A0)

namespace RootMotion
{
	inline static constexpr unsigned int SolverManager_PostLateUpdateDelegate_TypeDefinitionIndex = 36000;
