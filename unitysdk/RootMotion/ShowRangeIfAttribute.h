...
#define ROOTMOTION_SHOWRANGEIFATTRIBUTE_GET_MAX_OFFSET UNITYSDK_OFFSET(0x1ADDB1F0)
#define ROOTMOTION_SHOWRANGEIFATTRIBUTE_GET_MIN_OFFSET UNITYSDK_OFFSET(0x1ADDB1D0)
#define ROOTMOTION_SHOWRANGEIFATTRIBUTE_SET_MAX_OFFSET UNITYSDK_OFFSET(0x1ADDB200)
#define ROOTMOTION_SHOWRANGEIFATTRIBUTE_SET_MIN_OFFSET UNITYSDK_OFFSET(0x1ADDB1E0)
#define ROOTMOTION_SHOWRANGEIFATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADDB210)

namespace RootMotion
{
	inline static constexpr unsigned int ShowRangeIfAttribute_TypeDefinitionIndex = 34992;
