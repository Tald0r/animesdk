...
#define ROOTMOTION_BAKERUTILITIES_ENSUREQUATERNIONCONTINUITY_OFFSET UNITYSDK_OFFSET(0x1ACFAF30)
#define ROOTMOTION_BAKERUTILITIES_GETREDUCEDKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1ACFAB20)
#define ROOTMOTION_BAKERUTILITIES_REDUCEKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1ACFAAE0)
#define ROOTMOTION_BAKERUTILITIES_SETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1ACFAE70)
#define ROOTMOTION_BAKERUTILITIES_SETTANGENTMODE_OFFSET UNITYSDK_OFFSET(0x1ACFAF20)

namespace RootMotion
{
	inline static constexpr unsigned int BakerUtilities_TypeDefinitionIndex = 34969;
