...
#define ROOTMOTION_BAKERUTILITIES_ENSUREQUATERNIONCONTINUITY_OFFSET UNITYSDK_OFFSET(0x1B30DB10)
#define ROOTMOTION_BAKERUTILITIES_GETREDUCEDKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1B30D700)
#define ROOTMOTION_BAKERUTILITIES_REDUCEKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1B30D6C0)
#define ROOTMOTION_BAKERUTILITIES_SETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1B30DA50)
#define ROOTMOTION_BAKERUTILITIES_SETTANGENTMODE_OFFSET UNITYSDK_OFFSET(0x1B30DB00)

namespace RootMotion
{
	inline static constexpr unsigned int BakerUtilities_TypeDefinitionIndex = 35971;
