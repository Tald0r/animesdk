...
#define ROOTMOTION_BAKERMUSCLE_MULTIPLYLENGTH_OFFSET UNITYSDK_OFFSET(0x1AA573C0)
#define ROOTMOTION_BAKERMUSCLE_MUSCLENAMETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1AA56DD0)
#define ROOTMOTION_BAKERMUSCLE_RESET_OFFSET UNITYSDK_OFFSET(0x1AA57390)
#define ROOTMOTION_BAKERMUSCLE_SETCURVES_OFFSET UNITYSDK_OFFSET(0x1AA574D0)
#define ROOTMOTION_BAKERMUSCLE_SETKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1AA57680)
#define ROOTMOTION_BAKERMUSCLE_SETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1AA576D0)
#define ROOTMOTION_BAKERMUSCLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA56D60)

namespace RootMotion
{
	inline static constexpr unsigned int BakerMuscle_TypeDefinitionIndex = 34971;
