...
#define ROOTMOTION_BAKERMUSCLE_MULTIPLYLENGTH_OFFSET UNITYSDK_OFFSET(0x1B088D30)
#define ROOTMOTION_BAKERMUSCLE_MUSCLENAMETOPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B088740)
#define ROOTMOTION_BAKERMUSCLE_RESET_OFFSET UNITYSDK_OFFSET(0x1B088D00)
#define ROOTMOTION_BAKERMUSCLE_SETCURVES_OFFSET UNITYSDK_OFFSET(0x1B088E40)
#define ROOTMOTION_BAKERMUSCLE_SETKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1B088FF0)
#define ROOTMOTION_BAKERMUSCLE_SETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1B089040)
#define ROOTMOTION_BAKERMUSCLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0886D0)

namespace RootMotion
{
	inline static constexpr unsigned int BakerMuscle_TypeDefinitionIndex = 35973;
