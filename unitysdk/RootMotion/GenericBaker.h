...
#define ROOTMOTION_GENERICBAKER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AE16C30)
#define ROOTMOTION_GENERICBAKER_BAKEPOSITION_OFFSET UNITYSDK_OFFSET(0x1AE173B0)
#define ROOTMOTION_GENERICBAKER_GETCHARACTERROOT_OFFSET UNITYSDK_OFFSET(0x1AE17540)
#define ROOTMOTION_GENERICBAKER_ISIGNORED_OFFSET UNITYSDK_OFFSET(0x1AE17220)
#define ROOTMOTION_GENERICBAKER_ONSETCURVES_OFFSET UNITYSDK_OFFSET(0x1AE17740)
#define ROOTMOTION_GENERICBAKER_ONSETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1AE177C0)
#define ROOTMOTION_GENERICBAKER_ONSETLOOPFRAME_OFFSET UNITYSDK_OFFSET(0x1AE176C0)
#define ROOTMOTION_GENERICBAKER_ONSTARTBAKING_OFFSET UNITYSDK_OFFSET(0x1AE17550)
#define ROOTMOTION_GENERICBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE17840)

namespace RootMotion
{
	inline static constexpr unsigned int GenericBaker_TypeDefinitionIndex = 35968;
