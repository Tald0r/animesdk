...
#define CRIWARE_CRIATOMTRANSCEIVER_SETCONTROLIDMETHOD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B38CE90)
#define CRIWARE_CRIATOMTRANSCEIVER_SETCONTROLIDMETHOD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B38CEE0)
#define CRIWARE_CRIATOMTRANSCEIVER_SETCONTROLIDMETHOD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B38CB90)
#define CRIWARE_CRIATOMTRANSCEIVER_SETCONTROLIDMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B38CB70)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomTransceiver_SetControlIdMethod_TypeDefinitionIndex = 32173;
