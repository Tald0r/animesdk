...
#define CRIWARE_CRIATOMTRANSCEIVER_APPLYCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x1ACF3BD0)
#define CRIWARE_CRIATOMTRANSCEIVER_APPLYPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1ACF46A0)
#define CRIWARE_CRIATOMTRANSCEIVER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1ACF3840)
#define CRIWARE_CRIATOMTRANSCEIVER_CRIINTERNALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1ACF4CE0)
#define CRIWARE_CRIATOMTRANSCEIVER_CRIINTERNALUPDATE_OFFSET UNITYSDK_OFFSET(0x1ACF4CD0)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_INPUTFRONT_OFFSET UNITYSDK_OFFSET(0x1ACF3320)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_INPUTPOS_OFFSET UNITYSDK_OFFSET(0x1ACF32F0)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_INPUTUP_OFFSET UNITYSDK_OFFSET(0x1ACF3350)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_REGION3D_OFFSET UNITYSDK_OFFSET(0x1ACF3380)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_TRANSCEIVERHN_OFFSET UNITYSDK_OFFSET(0x1ACF32D0)
#define CRIWARE_CRIATOMTRANSCEIVER_INITIALIZEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1ACF3B00)
#define CRIWARE_CRIATOMTRANSCEIVER_INTERNALFINALIZE_OFFSET UNITYSDK_OFFSET(0x1ACF3AA0)
#define CRIWARE_CRIATOMTRANSCEIVER_INTERNALINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1ACF3960)
#define CRIWARE_CRIATOMTRANSCEIVER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ACF3950)
#define CRIWARE_CRIATOMTRANSCEIVER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ACF38D0)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_INPUTFRONT_OFFSET UNITYSDK_OFFSET(0x1ACF3340)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_INPUTPOS_OFFSET UNITYSDK_OFFSET(0x1ACF3310)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_INPUTUP_OFFSET UNITYSDK_OFFSET(0x1ACF3370)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_REGION3D_OFFSET UNITYSDK_OFFSET(0x1ACF3390)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_TRANSCEIVERHN_OFFSET UNITYSDK_OFFSET(0x1ACF32E0)
#define CRIWARE_CRIATOMTRANSCEIVER_START_OFFSET UNITYSDK_OFFSET(0x1ACF3850)
#define CRIWARE_CRIATOMTRANSCEIVER_TRYSETAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x1ACF4CF0)
#define CRIWARE_CRIATOMTRANSCEIVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACF4E50)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomTransceiver_TypeDefinitionIndex = 31220;
