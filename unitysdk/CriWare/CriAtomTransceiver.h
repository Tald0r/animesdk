...
#define CRIWARE_CRIATOMTRANSCEIVER_APPLYCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x1B315390)
#define CRIWARE_CRIATOMTRANSCEIVER_APPLYPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B315E60)
#define CRIWARE_CRIATOMTRANSCEIVER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B315000)
#define CRIWARE_CRIATOMTRANSCEIVER_CRIINTERNALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B3164B0)
#define CRIWARE_CRIATOMTRANSCEIVER_CRIINTERNALUPDATE_OFFSET UNITYSDK_OFFSET(0x1B3164A0)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_INPUTFRONT_OFFSET UNITYSDK_OFFSET(0x1B314AE0)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_INPUTPOS_OFFSET UNITYSDK_OFFSET(0x1B314AB0)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_INPUTUP_OFFSET UNITYSDK_OFFSET(0x1B314B10)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_REGION3D_OFFSET UNITYSDK_OFFSET(0x1B314B40)
#define CRIWARE_CRIATOMTRANSCEIVER_GET_TRANSCEIVERHN_OFFSET UNITYSDK_OFFSET(0x1B314A90)
#define CRIWARE_CRIATOMTRANSCEIVER_INITIALIZEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B3152C0)
#define CRIWARE_CRIATOMTRANSCEIVER_INTERNALFINALIZE_OFFSET UNITYSDK_OFFSET(0x1B315260)
#define CRIWARE_CRIATOMTRANSCEIVER_INTERNALINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B315120)
#define CRIWARE_CRIATOMTRANSCEIVER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B315110)
#define CRIWARE_CRIATOMTRANSCEIVER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B315090)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_INPUTFRONT_OFFSET UNITYSDK_OFFSET(0x1B314B00)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_INPUTPOS_OFFSET UNITYSDK_OFFSET(0x1B314AD0)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_INPUTUP_OFFSET UNITYSDK_OFFSET(0x1B314B30)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_REGION3D_OFFSET UNITYSDK_OFFSET(0x1B314B50)
#define CRIWARE_CRIATOMTRANSCEIVER_SET_TRANSCEIVERHN_OFFSET UNITYSDK_OFFSET(0x1B314AA0)
#define CRIWARE_CRIATOMTRANSCEIVER_START_OFFSET UNITYSDK_OFFSET(0x1B315010)
#define CRIWARE_CRIATOMTRANSCEIVER_TRYSETAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x1B3164C0)
#define CRIWARE_CRIATOMTRANSCEIVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B316620)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomTransceiver_TypeDefinitionIndex = 32172;
