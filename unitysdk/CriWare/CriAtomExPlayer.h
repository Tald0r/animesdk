...
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYERPARAMETER_REMOVEPARAMETER_OFFSET UNITYSDK_OFFSET(0x1B646000)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_CREATE_OFFSET UNITYSDK_OFFSET(0x1B6439B0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B643ED0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETPARAMETERFLOAT32_OFFSET UNITYSDK_OFFSET(0x1B645BD0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETPARAMETERSINT32_OFFSET UNITYSDK_OFFSET(0x1B645CE0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETPLAYERPARAMETER_OFFSET UNITYSDK_OFFSET(0x1B645F80)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1B645AD0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETTIME_OFFSET UNITYSDK_OFFSET(0x1B6459D0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1B644690)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_LIMITLOOPCOUNT_OFFSET UNITYSDK_OFFSET(0x1B645F00)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_PAUSE_OFFSET UNITYSDK_OFFSET(0x1B644490)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_RESUME_OFFSET UNITYSDK_OFFSET(0x1B644590)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SET3DLISTENERHN_OFFSET UNITYSDK_OFFSET(0x1B6455D0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SET3DSOURCEHN_OFFSET UNITYSDK_OFFSET(0x1B6454B0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETAISACCONTROLBYID_OFFSET UNITYSDK_OFFSET(0x1B645380)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETAISACCONTROLBYNAME_OFFSET UNITYSDK_OFFSET(0x1B645240)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETBUSSENDLEVELBYNAME_OFFSET UNITYSDK_OFFSET(0x1B644D40)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETBUSSENDLEVELOFFSETBYNAME_OFFSET UNITYSDK_OFFSET(0x1B644FC0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETBUSSENDLEVELOFFSET_OFFSET UNITYSDK_OFFSET(0x1B645100)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETBUSSENDLEVEL_OFFSET UNITYSDK_OFFSET(0x1B644E80)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETCUEID_OFFSET UNITYSDK_OFFSET(0x1B644180)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETCUENAME_OFFSET UNITYSDK_OFFSET(0x1B644020)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETPAN3DANGLE_OFFSET UNITYSDK_OFFSET(0x1B6449E0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETPAN3DINTERIORDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B644B00)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETPANTYPE_OFFSET UNITYSDK_OFFSET(0x1B644C10)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETPITCH_OFFSET UNITYSDK_OFFSET(0x1B6448C0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1B6456D0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETVOLUME_OFFSET UNITYSDK_OFFSET(0x1B6447A0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_START_OFFSET UNITYSDK_OFFSET(0x1B644390)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_STOPWITHOUTRELEASETIME_OFFSET UNITYSDK_OFFSET(0x1B646280)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0x1B646180)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_UPDATEALL_OFFSET UNITYSDK_OFFSET(0x1B6458D0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B6457D0)
#define CRIWARE_CRIATOMEXPLAYER_CRIWARE348B99F2_OFFSET UNITYSDK_OFFSET(0x1B643E50)
#define CRIWARE_CRIATOMEXPLAYER_CRIWARE94DBB2A3_OFFSET UNITYSDK_OFFSET(0x1B646200)
#define CRIWARE_CRIATOMEXPLAYER_CRIWAREBAFBC575_OFFSET UNITYSDK_OFFSET(0x1B644310)
#define CRIWARE_CRIATOMEXPLAYER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B643A80)
#define CRIWARE_CRIATOMEXPLAYER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B646300)
#define CRIWARE_CRIATOMEXPLAYER_GETPARAMETERFLOAT32_OFFSET UNITYSDK_OFFSET(0x1B645B50)
#define CRIWARE_CRIATOMEXPLAYER_GETPARAMETERSINT32_OFFSET UNITYSDK_OFFSET(0x1B645C50)
#define CRIWARE_CRIATOMEXPLAYER_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1B645A50)
#define CRIWARE_CRIATOMEXPLAYER_GETTIME_OFFSET UNITYSDK_OFFSET(0x1B645950)
#define CRIWARE_CRIATOMEXPLAYER_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1B643720)
#define CRIWARE_CRIATOMEXPLAYER_GET_NATIVEHANDLE_OFFSET UNITYSDK_OFFSET(0x1B643710)
#define CRIWARE_CRIATOMEXPLAYER_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1B644610)
#define CRIWARE_CRIATOMEXPLAYER_LOOP_OFFSET UNITYSDK_OFFSET(0x1B645D70)
#define CRIWARE_CRIATOMEXPLAYER_ONBEATSYNCCALLBACKCHAININTERNAL_OFFSET UNITYSDK_OFFSET(0x1B646370)
#define CRIWARE_CRIATOMEXPLAYER_PAUSE_OFFSET UNITYSDK_OFFSET(0x1B644410)
#define CRIWARE_CRIATOMEXPLAYER_RESUME_OFFSET UNITYSDK_OFFSET(0x1B644510)
#define CRIWARE_CRIATOMEXPLAYER_SET3DLISTENER_OFFSET UNITYSDK_OFFSET(0x1B645530)
#define CRIWARE_CRIATOMEXPLAYER_SET3DSOURCE_OFFSET UNITYSDK_OFFSET(0x1B645410)
#define CRIWARE_CRIATOMEXPLAYER_SETAISACCONTROL_1_OFFSET UNITYSDK_OFFSET(0x1B6452F0)
#define CRIWARE_CRIATOMEXPLAYER_SETAISACCONTROL_OFFSET UNITYSDK_OFFSET(0x1B645190)
#define CRIWARE_CRIATOMEXPLAYER_SETBUSSENDLEVELOFFSET_1_OFFSET UNITYSDK_OFFSET(0x1B645070)
#define CRIWARE_CRIATOMEXPLAYER_SETBUSSENDLEVELOFFSET_OFFSET UNITYSDK_OFFSET(0x1B644F10)
#define CRIWARE_CRIATOMEXPLAYER_SETBUSSENDLEVEL_1_OFFSET UNITYSDK_OFFSET(0x1B644DF0)
#define CRIWARE_CRIATOMEXPLAYER_SETBUSSENDLEVEL_OFFSET UNITYSDK_OFFSET(0x1B644C90)
#define CRIWARE_CRIATOMEXPLAYER_SETCUE_1_OFFSET UNITYSDK_OFFSET(0x1B6440D0)
#define CRIWARE_CRIATOMEXPLAYER_SETCUE_OFFSET UNITYSDK_OFFSET(0x1B643F50)
#define CRIWARE_CRIATOMEXPLAYER_SETPAN3DANGLE_OFFSET UNITYSDK_OFFSET(0x1B644950)
#define CRIWARE_CRIATOMEXPLAYER_SETPAN3DINTERIORDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B644A70)
#define CRIWARE_CRIATOMEXPLAYER_SETPANTYPE_OFFSET UNITYSDK_OFFSET(0x1B644B90)
#define CRIWARE_CRIATOMEXPLAYER_SETPITCH_OFFSET UNITYSDK_OFFSET(0x1B644830)
#define CRIWARE_CRIATOMEXPLAYER_SETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1B645650)
#define CRIWARE_CRIATOMEXPLAYER_SETVOLUME_OFFSET UNITYSDK_OFFSET(0x1B644710)
#define CRIWARE_CRIATOMEXPLAYER_START_OFFSET UNITYSDK_OFFSET(0x1B644210)
#define CRIWARE_CRIATOMEXPLAYER_STOPWITHOUTRELEASETIME_OFFSET UNITYSDK_OFFSET(0x1B643D50)
#define CRIWARE_CRIATOMEXPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0x1B646080)
#define CRIWARE_CRIATOMEXPLAYER_UPDATEALL_OFFSET UNITYSDK_OFFSET(0x1B645850)
#define CRIWARE_CRIATOMEXPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B645750)
#define CRIWARE_CRIATOMEXPLAYER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B643990)
#define CRIWARE_CRIATOMEXPLAYER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B643750)
#define CRIWARE_CRIATOMEXPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B643730)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExPlayer_TypeDefinitionIndex = 32219;
