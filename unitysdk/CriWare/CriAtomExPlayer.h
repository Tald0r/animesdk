...
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYERPARAMETER_REMOVEPARAMETER_OFFSET UNITYSDK_OFFSET(0x1B035F90)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_CREATE_OFFSET UNITYSDK_OFFSET(0x1B033950)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B033E60)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETPARAMETERFLOAT32_OFFSET UNITYSDK_OFFSET(0x1B035B60)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETPARAMETERSINT32_OFFSET UNITYSDK_OFFSET(0x1B035C70)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETPLAYERPARAMETER_OFFSET UNITYSDK_OFFSET(0x1B035F10)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1B035A60)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_GETTIME_OFFSET UNITYSDK_OFFSET(0x1B035960)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1B034620)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_LIMITLOOPCOUNT_OFFSET UNITYSDK_OFFSET(0x1B035E90)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_PAUSE_OFFSET UNITYSDK_OFFSET(0x1B034420)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_RESUME_OFFSET UNITYSDK_OFFSET(0x1B034520)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SET3DLISTENERHN_OFFSET UNITYSDK_OFFSET(0x1B035560)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SET3DSOURCEHN_OFFSET UNITYSDK_OFFSET(0x1B035440)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETAISACCONTROLBYID_OFFSET UNITYSDK_OFFSET(0x1B035310)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETAISACCONTROLBYNAME_OFFSET UNITYSDK_OFFSET(0x1B0351D0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETBUSSENDLEVELBYNAME_OFFSET UNITYSDK_OFFSET(0x1B034CD0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETBUSSENDLEVELOFFSETBYNAME_OFFSET UNITYSDK_OFFSET(0x1B034F50)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETBUSSENDLEVELOFFSET_OFFSET UNITYSDK_OFFSET(0x1B035090)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETBUSSENDLEVEL_OFFSET UNITYSDK_OFFSET(0x1B034E10)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETCUEID_OFFSET UNITYSDK_OFFSET(0x1B034110)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETCUENAME_OFFSET UNITYSDK_OFFSET(0x1B033FB0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETPAN3DANGLE_OFFSET UNITYSDK_OFFSET(0x1B034970)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETPAN3DINTERIORDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B034A90)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETPANTYPE_OFFSET UNITYSDK_OFFSET(0x1B034BA0)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETPITCH_OFFSET UNITYSDK_OFFSET(0x1B034850)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1B035660)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_SETVOLUME_OFFSET UNITYSDK_OFFSET(0x1B034730)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_START_OFFSET UNITYSDK_OFFSET(0x1B034320)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_STOPWITHOUTRELEASETIME_OFFSET UNITYSDK_OFFSET(0x1B036210)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0x1B036110)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_UPDATEALL_OFFSET UNITYSDK_OFFSET(0x1B035860)
#define CRIWARE_CRIATOMEXPLAYER_CRIATOMEXPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B035760)
#define CRIWARE_CRIATOMEXPLAYER_CRIWARE348B99F2_OFFSET UNITYSDK_OFFSET(0x1B033DE0)
#define CRIWARE_CRIATOMEXPLAYER_CRIWARE94DBB2A3_OFFSET UNITYSDK_OFFSET(0x1B036190)
#define CRIWARE_CRIATOMEXPLAYER_CRIWAREBAFBC575_OFFSET UNITYSDK_OFFSET(0x1B0342A0)
#define CRIWARE_CRIATOMEXPLAYER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B033A20)
#define CRIWARE_CRIATOMEXPLAYER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B036290)
#define CRIWARE_CRIATOMEXPLAYER_GETPARAMETERFLOAT32_OFFSET UNITYSDK_OFFSET(0x1B035AE0)
#define CRIWARE_CRIATOMEXPLAYER_GETPARAMETERSINT32_OFFSET UNITYSDK_OFFSET(0x1B035BE0)
#define CRIWARE_CRIATOMEXPLAYER_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1B0359E0)
#define CRIWARE_CRIATOMEXPLAYER_GETTIME_OFFSET UNITYSDK_OFFSET(0x1B0358E0)
#define CRIWARE_CRIATOMEXPLAYER_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1B0336D0)
#define CRIWARE_CRIATOMEXPLAYER_GET_NATIVEHANDLE_OFFSET UNITYSDK_OFFSET(0x1B0336C0)
#define CRIWARE_CRIATOMEXPLAYER_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1B0345A0)
#define CRIWARE_CRIATOMEXPLAYER_LOOP_OFFSET UNITYSDK_OFFSET(0x1B035D00)
#define CRIWARE_CRIATOMEXPLAYER_ONBEATSYNCCALLBACKCHAININTERNAL_OFFSET UNITYSDK_OFFSET(0x1B036300)
#define CRIWARE_CRIATOMEXPLAYER_PAUSE_OFFSET UNITYSDK_OFFSET(0x1B0343A0)
#define CRIWARE_CRIATOMEXPLAYER_RESUME_OFFSET UNITYSDK_OFFSET(0x1B0344A0)
#define CRIWARE_CRIATOMEXPLAYER_SET3DLISTENER_OFFSET UNITYSDK_OFFSET(0x1B0354C0)
#define CRIWARE_CRIATOMEXPLAYER_SET3DSOURCE_OFFSET UNITYSDK_OFFSET(0x1B0353A0)
#define CRIWARE_CRIATOMEXPLAYER_SETAISACCONTROL_1_OFFSET UNITYSDK_OFFSET(0x1B035280)
#define CRIWARE_CRIATOMEXPLAYER_SETAISACCONTROL_OFFSET UNITYSDK_OFFSET(0x1B035120)
#define CRIWARE_CRIATOMEXPLAYER_SETBUSSENDLEVELOFFSET_1_OFFSET UNITYSDK_OFFSET(0x1B035000)
#define CRIWARE_CRIATOMEXPLAYER_SETBUSSENDLEVELOFFSET_OFFSET UNITYSDK_OFFSET(0x1B034EA0)
#define CRIWARE_CRIATOMEXPLAYER_SETBUSSENDLEVEL_1_OFFSET UNITYSDK_OFFSET(0x1B034D80)
#define CRIWARE_CRIATOMEXPLAYER_SETBUSSENDLEVEL_OFFSET UNITYSDK_OFFSET(0x1B034C20)
#define CRIWARE_CRIATOMEXPLAYER_SETCUE_1_OFFSET UNITYSDK_OFFSET(0x1B034060)
#define CRIWARE_CRIATOMEXPLAYER_SETCUE_OFFSET UNITYSDK_OFFSET(0x1B033EE0)
#define CRIWARE_CRIATOMEXPLAYER_SETPAN3DANGLE_OFFSET UNITYSDK_OFFSET(0x1B0348E0)
#define CRIWARE_CRIATOMEXPLAYER_SETPAN3DINTERIORDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B034A00)
#define CRIWARE_CRIATOMEXPLAYER_SETPANTYPE_OFFSET UNITYSDK_OFFSET(0x1B034B20)
#define CRIWARE_CRIATOMEXPLAYER_SETPITCH_OFFSET UNITYSDK_OFFSET(0x1B0347C0)
#define CRIWARE_CRIATOMEXPLAYER_SETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1B0355E0)
#define CRIWARE_CRIATOMEXPLAYER_SETVOLUME_OFFSET UNITYSDK_OFFSET(0x1B0346A0)
#define CRIWARE_CRIATOMEXPLAYER_START_OFFSET UNITYSDK_OFFSET(0x1B0341A0)
#define CRIWARE_CRIATOMEXPLAYER_STOPWITHOUTRELEASETIME_OFFSET UNITYSDK_OFFSET(0x1B033CE0)
#define CRIWARE_CRIATOMEXPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0x1B036010)
#define CRIWARE_CRIATOMEXPLAYER_UPDATEALL_OFFSET UNITYSDK_OFFSET(0x1B0357E0)
#define CRIWARE_CRIATOMEXPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B0356E0)
#define CRIWARE_CRIATOMEXPLAYER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B033930)
#define CRIWARE_CRIATOMEXPLAYER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B033700)
#define CRIWARE_CRIATOMEXPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0336E0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExPlayer_TypeDefinitionIndex = 31267;
