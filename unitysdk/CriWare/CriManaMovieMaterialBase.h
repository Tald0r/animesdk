...
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B4F26C0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_CREATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B4F2550)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_CRIINTERNALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B4F2BC0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_CRIINTERNALUPDATE_OFFSET UNITYSDK_OFFSET(0x1B4F2B90)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_GET_HAVERENDEREROWNER_OFFSET UNITYSDK_OFFSET(0x1B4F1CA0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_GET_ISMATERIALAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1B4F1A70)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1B4F1AB0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_GET_MAXFRAMEDROP_OFFSET UNITYSDK_OFFSET(0x1B4F1A40)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0x1B4F1A90)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_GET_TIMERTYPE_OFFSET UNITYSDK_OFFSET(0x1B4F1BF0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x1B4F2C10)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B4F2B00)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B4F2990)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B4F26D0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONMATERIALAVAILABLECHANGED_OFFSET UNITYSDK_OFFSET(0x1B4F1F50)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONMATERIALUPDATED_OFFSET UNITYSDK_OFFSET(0x1B4F1F60)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_ONWILLRENDEROBJECT_OFFSET UNITYSDK_OFFSET(0x1B4F2BE0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PAUSE_OFFSET UNITYSDK_OFFSET(0x1B4F1E20)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PLAYERMANUALFINALIZE_OFFSET UNITYSDK_OFFSET(0x1B4F21E0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PLAYERMANUALINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4F1F70)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PLAYERMANUALSETUP_OFFSET UNITYSDK_OFFSET(0x1B4F2320)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PLAYERMANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x1B4F2600)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PLAY_OFFSET UNITYSDK_OFFSET(0x1B4F1CC0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_PROCESSAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x1B4F2C20)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_RENDERMOVIE_OFFSET UNITYSDK_OFFSET(0x1B4F2BA0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_RENDERTARGETMANUALFINALIZE_OFFSET UNITYSDK_OFFSET(0x1B4F25F0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_RENDERTARGETMANUALSETUP_OFFSET UNITYSDK_OFFSET(0x1B4F25E0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_RESTARTPLAYERROUTINE_OFFSET UNITYSDK_OFFSET(0x1B4F2940)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_SET_HAVERENDEREROWNER_OFFSET UNITYSDK_OFFSET(0x1B4F1CB0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_SET_ISMATERIALAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1B4F1A80)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1B4F1AC0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_SET_MAXFRAMEDROP_OFFSET UNITYSDK_OFFSET(0x1B4F1A50)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_SET_PLAYER_OFFSET UNITYSDK_OFFSET(0x1B4F1AA0)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_SET_TIMERTYPE_OFFSET UNITYSDK_OFFSET(0x1B4F1C00)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_START_OFFSET UNITYSDK_OFFSET(0x1B4F2B20)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE_STOP_OFFSET UNITYSDK_OFFSET(0x1B4F1D00)
#define CRIWARE_CRIMANAMOVIEMATERIALBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F2E40)

namespace CriWare
{
	inline static constexpr unsigned int CriManaMovieMaterialBase_TypeDefinitionIndex = 32251;
