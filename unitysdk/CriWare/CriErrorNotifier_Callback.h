...
#define CRIWARE_CRIERRORNOTIFIER_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AED1400)
#define CRIWARE_CRIERRORNOTIFIER_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AED1430)
#define CRIWARE_CRIERRORNOTIFIER_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AED0F00)
#define CRIWARE_CRIERRORNOTIFIER_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AED0EF0)

namespace CriWare
{
	inline static constexpr unsigned int CriErrorNotifier_Callback_TypeDefinitionIndex = 31311;
