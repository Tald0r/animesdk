...
#define CRIWARE_CRIATOMOUTPUTDEVICEOBSERVER_DEVICECONNECTIONCHANGECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B7138B0)
#define CRIWARE_CRIATOMOUTPUTDEVICEOBSERVER_DEVICECONNECTIONCHANGECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B713940)
#define CRIWARE_CRIATOMOUTPUTDEVICEOBSERVER_DEVICECONNECTIONCHANGECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B713590)
#define CRIWARE_CRIATOMOUTPUTDEVICEOBSERVER_DEVICECONNECTIONCHANGECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B713570)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomOutputDeviceObserver_DeviceConnectionChangeCallback_TypeDefinitionIndex = 32165;
