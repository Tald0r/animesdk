...
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_ATTACHAISAC_OFFSET UNITYSDK_OFFSET(0x1B712BE0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_CREATE_OFFSET UNITYSDK_OFFSET(0x1B712510)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B7125A0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SET3DREGIONHN_OFFSET UNITYSDK_OFFSET(0x1B712F90)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETDISTANCEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x1B712D10)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETINPUTCROSSFADEFIELD_OFFSET UNITYSDK_OFFSET(0x1B712AB0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETINPUTORIENTATION_OFFSET UNITYSDK_OFFSET(0x1B7127A0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETINPUTPOSITION_OFFSET UNITYSDK_OFFSET(0x1B7126A0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETLISTENERBASEDAZIMUTHANGLEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x1B712D90)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETLISTENERBASEDELEVATIONANGLEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x1B712E10)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETMAXANGLEAISACDELTA_OFFSET UNITYSDK_OFFSET(0x1B712C80)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTCONEPARAMETER_OFFSET UNITYSDK_OFFSET(0x1B7128C0)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTINTERIORPANFIELD_OFFSET UNITYSDK_OFFSET(0x1B712A10)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTMINMAXATTENUATIONDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B712970)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTORIENTATION_OFFSET UNITYSDK_OFFSET(0x1B712830)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTPOSITION_OFFSET UNITYSDK_OFFSET(0x1B712720)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETOUTPUTVOLUME_OFFSET UNITYSDK_OFFSET(0x1B712B50)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETTRANSCEIVEROUTPUTBASEDAZIMUTHANGLEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x1B712E90)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_SETTRANSCEIVEROUTPUTBASEDELEVATIONANGLEAISACCONTROLID_OFFSET UNITYSDK_OFFSET(0x1B712F10)
#define CRIWARE_CRIATOMEX3DTRANSCEIVER_UNSAFENATIVEMETHODS_CRIATOMEX3DTRANSCEIVER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B712620)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomEx3dTransceiver_UnsafeNativeMethods_TypeDefinitionIndex = 32207;
