...
#define CRIWARE_CRIATOMPLUGIN_CRIWARE009CE561_OFFSET UNITYSDK_OFFSET(0x1B37BFC0)
#define CRIWARE_CRIATOMPLUGIN_CRIWARE15B0037A_OFFSET UNITYSDK_OFFSET(0x1B37AF40)
#define CRIWARE_CRIATOMPLUGIN_CRIWARE15F30D07_OFFSET UNITYSDK_OFFSET(0x1B37B180)
#define CRIWARE_CRIATOMPLUGIN_CRIWARE237CA5E3_OFFSET UNITYSDK_OFFSET(0x1B37C3A0)
#define CRIWARE_CRIATOMPLUGIN_CRIWARE2626EF5B_OFFSET UNITYSDK_OFFSET(0x1B37C9F0)
#define CRIWARE_CRIATOMPLUGIN_CRIWARE28E5ABA4_OFFSET UNITYSDK_OFFSET(0x1B37AFE0)
#define CRIWARE_CRIATOMPLUGIN_CRIWARE2F034134_OFFSET UNITYSDK_OFFSET(0x1B37C710)
#define CRIWARE_CRIATOMPLUGIN_CRIWARE5B1C5B3B_OFFSET UNITYSDK_OFFSET(0x1B37CDF0)
#define CRIWARE_CRIATOMPLUGIN_CRIWARE63E1F278_OFFSET UNITYSDK_OFFSET(0x1B37CAF0)
#define CRIWARE_CRIATOMPLUGIN_CRIWARE70981A20_OFFSET UNITYSDK_OFFSET(0x1B37C890)
#define CRIWARE_CRIATOMPLUGIN_CRIWARE7581CF8C_OFFSET UNITYSDK_OFFSET(0x1B37B670)
#define CRIWARE_CRIATOMPLUGIN_CRIWARE780E6ED2_OFFSET UNITYSDK_OFFSET(0x1B37C4C0)
#define CRIWARE_CRIATOMPLUGIN_CRIWARE8384362B_OFFSET UNITYSDK_OFFSET(0x1B37C270)
#define CRIWARE_CRIATOMPLUGIN_CRIWARE88175F19_OFFSET UNITYSDK_OFFSET(0x1B37AC40)
#define CRIWARE_CRIATOMPLUGIN_CRIWAREB64E0C3B_OFFSET UNITYSDK_OFFSET(0x1B37CC50)
#define CRIWARE_CRIATOMPLUGIN_CRIWAREC176B113_OFFSET UNITYSDK_OFFSET(0x1B37CA70)
#define CRIWARE_CRIATOMPLUGIN_CRIWARECCA1268B_OFFSET UNITYSDK_OFFSET(0x1B37B550)
#define CRIWARE_CRIATOMPLUGIN_CRIWARED1FD92AA_OFFSET UNITYSDK_OFFSET(0x1B37B430)
#define CRIWARE_CRIATOMPLUGIN_CRIWAREE996B258_OFFSET UNITYSDK_OFFSET(0x1B37C5E0)
#define CRIWARE_CRIATOMPLUGIN_EXECUTEQUEUEDBEATSYNCCALLBACKS_OFFSET UNITYSDK_OFFSET(0x1B37B5D0)
#define CRIWARE_CRIATOMPLUGIN_EXECUTEQUEUEDCUELINKCALLBACKS_OFFSET UNITYSDK_OFFSET(0x1B37B390)
#define CRIWARE_CRIATOMPLUGIN_EXECUTEQUEUEDEVENTCALLBACKS_OFFSET UNITYSDK_OFFSET(0x1B37B4B0)
#define CRIWARE_CRIATOMPLUGIN_FINALIZELIBRARY_OFFSET UNITYSDK_OFFSET(0x1B379D50)
#define CRIWARE_CRIATOMPLUGIN_GETAUDIOEFFECTINTERFACELIST_OFFSET UNITYSDK_OFFSET(0x1B37B6F0)
#define CRIWARE_CRIATOMPLUGIN_GETLOOPCOUNTPARAMETERID_OFFSET UNITYSDK_OFFSET(0x1B37CCD0)
#define CRIWARE_CRIATOMPLUGIN_GETREQUIREDMAXVIRTUALVOICES_OFFSET UNITYSDK_OFFSET(0x1B37C9B0)
#define CRIWARE_CRIATOMPLUGIN_GETSPATIALIZERCOREINTERFACEFROMATOMOCULUSAUDIOBRIDGE_OFFSET UNITYSDK_OFFSET(0x1B37B950)
#define CRIWARE_CRIATOMPLUGIN_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1B37B360)
#define CRIWARE_CRIATOMPLUGIN_INITIALIZELIBRARY_OFFSET UNITYSDK_OFFSET(0x1B3798F0)
#define CRIWARE_CRIATOMPLUGIN_ISLIBRARYINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1B37B8B0)
#define CRIWARE_CRIATOMPLUGIN_PAUSE_OFFSET UNITYSDK_OFFSET(0x1B37CB70)
#define CRIWARE_CRIATOMPLUGIN_SETCONFIGADDITIONALPARAMETERS_ANDROID_OFFSET UNITYSDK_OFFSET(0x1B37C7A0)
#define CRIWARE_CRIATOMPLUGIN_SETCONFIGADDITIONALPARAMETERS_EDITOR_OFFSET UNITYSDK_OFFSET(0x1B37C300)
#define CRIWARE_CRIATOMPLUGIN_SETCONFIGADDITIONALPARAMETERS_IOS_OFFSET UNITYSDK_OFFSET(0x1B37C660)
#define CRIWARE_CRIATOMPLUGIN_SETCONFIGADDITIONALPARAMETERS_LINUX_OFFSET UNITYSDK_OFFSET(0x1B37C540)
#define CRIWARE_CRIATOMPLUGIN_SETCONFIGADDITIONALPARAMETERS_PC_OFFSET UNITYSDK_OFFSET(0x1B37C420)
#define CRIWARE_CRIATOMPLUGIN_SETCONFIGADDITIONALPARAMETERS_PS4_OFFSET UNITYSDK_OFFSET(0x1B37C970)
#define CRIWARE_CRIATOMPLUGIN_SETCONFIGADDITIONALPARAMETERS_PS5_OFFSET UNITYSDK_OFFSET(0x1B37C980)
#define CRIWARE_CRIATOMPLUGIN_SETCONFIGADDITIONALPARAMETERS_SWITCH_OFFSET UNITYSDK_OFFSET(0x1B37C990)
#define CRIWARE_CRIATOMPLUGIN_SETCONFIGADDITIONALPARAMETERS_VITA_OFFSET UNITYSDK_OFFSET(0x1B37C960)
#define CRIWARE_CRIATOMPLUGIN_SETCONFIGADDITIONALPARAMETERS_WEBGL_OFFSET UNITYSDK_OFFSET(0x1B37C9A0)
#define CRIWARE_CRIATOMPLUGIN_SETCONFIGMONITORPARAMETES_OFFSET UNITYSDK_OFFSET(0x1B37C1C0)
#define CRIWARE_CRIATOMPLUGIN_SETCONFIGPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B37BD60)
#define CRIWARE_CRIATOMPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B37CE70)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomPlugin_TypeDefinitionIndex = 32156;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::IntPtr>**)Il2CppClass::FromTypeDefinitionIndex(CriAtomPlugin_TypeDefinitionIndex)->GetStaticField(0x253F0);
		}
		static ::System::Single* StaticGet_timeSinceStartup()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(CriAtomPlugin_TypeDefinitionIndex)->GetStaticField(0x7E50);
		}
		static ::System::UInt16* StaticGet_CRIATOMPARAMETER2_ID_INVALID()
		{
			return (::System::UInt16*)Il2CppClass::FromTypeDefinitionIndex(CriAtomPlugin_TypeDefinitionIndex)->GetStaticField(0x7E54);
		}
		static ::System::Boolean* StaticGet_isConfigured()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(CriAtomPlugin_TypeDefinitionIndex)->GetStaticField(0x7E56);
		}
		static ::System::UInt64* StaticGet_temporalStorage()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(CriAtomPlugin_TypeDefinitionIndex)->GetStaticField(0x7E58);
		}
		static ::System::Int32* StaticGet_initializationCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CriAtomPlugin_TypeDefinitionIndex)->GetStaticField(0x7E60);
		}
		static ::System::Int32* StaticGet_CRIATOMUNITY_PARAMETER_ID_LOOP_COUNT()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CriAtomPlugin_TypeDefinitionIndex)->GetStaticField(0x7E64);
		}
