...
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0B50E0)
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0B5110)
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0B4BE0)
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B4BD0)

namespace CriWare::CriMana
{
	inline static constexpr unsigned int Player_LoopPointCallback_TypeDefinitionIndex = 31374;
