...
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6C1A60)
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6C1A90)
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6C1560)
#define CRIWARE_CRIMANA_PLAYER_LOOPPOINTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C1540)

namespace CriWare::CriMana
{
	inline static constexpr unsigned int Player_LoopPointCallback_TypeDefinitionIndex = 32326;
