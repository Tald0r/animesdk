...
#define CRIWARE_CRIMANA_PLAYER_SUBTITLECHANGECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0B5430)
#define CRIWARE_CRIMANA_PLAYER_SUBTITLECHANGECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0B5480)
#define CRIWARE_CRIMANA_PLAYER_SUBTITLECHANGECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0B5130)
#define CRIWARE_CRIMANA_PLAYER_SUBTITLECHANGECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B5120)

namespace CriWare::CriMana
{
	inline static constexpr unsigned int Player_SubtitleChangeCallback_TypeDefinitionIndex = 31375;
