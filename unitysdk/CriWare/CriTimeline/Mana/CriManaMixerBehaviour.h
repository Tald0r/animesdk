...
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_FORCESYNCEDSTOP_OFFSET UNITYSDK_OFFSET(0x1ACF8370)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_GET_ISEDITMODE_OFFSET UNITYSDK_OFFSET(0x1ACF6FC0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ISPLAYERERROR_OFFSET UNITYSDK_OFFSET(0x1ACF8150)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ISPLAYERPREPARING_OFFSET UNITYSDK_OFFSET(0x1ACF8050)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ISPLAYERREADYORPLAYING_OFFSET UNITYSDK_OFFSET(0x1ACF81F0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ISPLAYERSTOPPED_OFFSET UNITYSDK_OFFSET(0x1ACF80F0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_KEEPAUDIOVOLUME_OFFSET UNITYSDK_OFFSET(0x1ACF6FD0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1ACF99B0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1ACF9880)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x1ACF9AF0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1ACFA080)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1ACFA1E0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1ACFA250)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PAUSEPLAYER_OFFSET UNITYSDK_OFFSET(0x1ACF9680)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PLAYMOVIE_OFFSET UNITYSDK_OFFSET(0x1ACF71D0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PREPAREMOVIE_OFFSET UNITYSDK_OFFSET(0x1ACF76D0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PROCESSFRAMEONSEEKING_OFFSET UNITYSDK_OFFSET(0x1ACF82E0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1ACF8570)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_SEEKPLAYBACKENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1ACF9830)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_STOPMOVIE_OFFSET UNITYSDK_OFFSET(0x1ACF7CE0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ACFA2E0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACFA2B0)

namespace CriWare::CriTimeline::Mana
{
	inline static constexpr unsigned int CriManaMixerBehaviour_TypeDefinitionIndex = 31347;
	...
	public:
		...
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(CriManaMixerBehaviour_TypeDefinitionIndex)->GetStaticField(0x7B00);
		}
