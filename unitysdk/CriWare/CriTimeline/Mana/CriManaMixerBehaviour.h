...
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_FORCESYNCEDSTOP_OFFSET UNITYSDK_OFFSET(0x1B319B60)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_GET_ISEDITMODE_OFFSET UNITYSDK_OFFSET(0x1B318780)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ISPLAYERERROR_OFFSET UNITYSDK_OFFSET(0x1B319940)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ISPLAYERPREPARING_OFFSET UNITYSDK_OFFSET(0x1B319840)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ISPLAYERREADYORPLAYING_OFFSET UNITYSDK_OFFSET(0x1B3199E0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ISPLAYERSTOPPED_OFFSET UNITYSDK_OFFSET(0x1B3198E0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_KEEPAUDIOVOLUME_OFFSET UNITYSDK_OFFSET(0x1B318790)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1B31B1A0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B31B070)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x1B31B2E0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1B31B870)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1B31B9D0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1B31BA40)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PAUSEPLAYER_OFFSET UNITYSDK_OFFSET(0x1B31AE70)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PLAYMOVIE_OFFSET UNITYSDK_OFFSET(0x1B318990)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PREPAREMOVIE_OFFSET UNITYSDK_OFFSET(0x1B318EA0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PROCESSFRAMEONSEEKING_OFFSET UNITYSDK_OFFSET(0x1B319AD0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B319D60)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_SEEKPLAYBACKENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B31B020)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR_STOPMOVIE_OFFSET UNITYSDK_OFFSET(0x1B3194C0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B31BAD0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANAMIXERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B31BAA0)

namespace CriWare::CriTimeline::Mana
{
	inline static constexpr unsigned int CriManaMixerBehaviour_TypeDefinitionIndex = 32299;
	...
	public:
		...
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(CriManaMixerBehaviour_TypeDefinitionIndex)->GetStaticField(0x7E30);
		}
