...
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIP_GET_DATAID_OFFSET UNITYSDK_OFFSET(0x1B6EC2F0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIP_GET_MOVIEDATA_OFFSET UNITYSDK_OFFSET(0x1B6EC1A0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIP_GET_MOVIENAME_OFFSET UNITYSDK_OFFSET(0x1B6EC230)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIP_GET_MOVIEPATH_OFFSET UNITYSDK_OFFSET(0x1B6EC190)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EC4F0)

namespace CriWare::CriTimeline::Mana
{
	inline static constexpr unsigned int CriManaClip_TypeDefinitionIndex = 32296;
