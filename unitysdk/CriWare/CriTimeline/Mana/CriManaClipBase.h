...
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B3181D0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_GETSEEKFRAME_OFFSET UNITYSDK_OFFSET(0x1B318560)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B3181C0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1B3186A0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_GET_ISMOVIEINFOREADY_OFFSET UNITYSDK_OFFSET(0x1B318550)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_ISSAMEMOVIE_OFFSET UNITYSDK_OFFSET(0x1B318490)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_REPLACEMOVIEINFO_OFFSET UNITYSDK_OFFSET(0x1B3182A0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_STRUCTTOMOVIEINFO_OFFSET UNITYSDK_OFFSET(0x1B318170)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3186D0)

namespace CriWare::CriTimeline::Mana
{
	inline static constexpr unsigned int CriManaClipBase_TypeDefinitionIndex = 32297;
