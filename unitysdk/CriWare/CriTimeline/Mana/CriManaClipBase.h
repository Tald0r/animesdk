...
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1ACF6A00)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_GETSEEKFRAME_OFFSET UNITYSDK_OFFSET(0x1ACF6DA0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1ACF69F0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1ACF6EE0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_GET_ISMOVIEINFOREADY_OFFSET UNITYSDK_OFFSET(0x1ACF6D90)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_ISSAMEMOVIE_OFFSET UNITYSDK_OFFSET(0x1ACF6CD0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_REPLACEMOVIEINFO_OFFSET UNITYSDK_OFFSET(0x1ACF6AE0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE_STRUCTTOMOVIEINFO_OFFSET UNITYSDK_OFFSET(0x1ACF69A0)
#define CRIWARE_CRITIMELINE_MANA_CRIMANACLIPBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACF6F10)

namespace CriWare::CriTimeline::Mana
{
	inline static constexpr unsigned int CriManaClipBase_TypeDefinitionIndex = 31345;
