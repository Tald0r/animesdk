...
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIP_GETACB_OFFSET UNITYSDK_OFFSET(0x1ACBA570)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIP_GETCUESHEET_OFFSET UNITYSDK_OFFSET(0x1ACBA580)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIP_GET_ACBPATH_OFFSET UNITYSDK_OFFSET(0x1ACBA590)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIP_GET_AWBPATH_OFFSET UNITYSDK_OFFSET(0x1ACBA5F0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIP_GET_CUENAME_OFFSET UNITYSDK_OFFSET(0x1ACBA560)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIP_SETCUEFROMATOMSOURCE_OFFSET UNITYSDK_OFFSET(0x1ACBA650)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACBA720)

namespace CriWare::CriTimeline::Atom
{
	inline static constexpr unsigned int CriAtomClip_TypeDefinitionIndex = 31355;
