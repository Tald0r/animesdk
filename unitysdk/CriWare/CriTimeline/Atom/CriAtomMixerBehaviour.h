...
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR_GET_ISEDITOR_OFFSET UNITYSDK_OFFSET(0x1AED3F30)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR_GET_M_GUID_OFFSET UNITYSDK_OFFSET(0x1AED3EC0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1AED3F40)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1AED3EE0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1AED40E0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR_SET_M_GUID_OFFSET UNITYSDK_OFFSET(0x1AED3ED0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMMIXERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AED4C20)

namespace CriWare::CriTimeline::Atom
{
	inline static constexpr unsigned int CriAtomMixerBehaviour_TypeDefinitionIndex = 31357;
