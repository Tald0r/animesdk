...
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIPBASE_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1AF45850)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIPBASE_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1AF45840)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIPBASE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1AF45940)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIPBASE_SETCLIPDURATION_OFFSET UNITYSDK_OFFSET(0x1AF45930)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMCLIPBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF45970)

namespace CriWare::CriTimeline::Atom
{
	inline static constexpr unsigned int CriAtomClipBase_TypeDefinitionIndex = 31356;
