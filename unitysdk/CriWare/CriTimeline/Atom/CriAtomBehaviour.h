...
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_GETCUELENGTHSEC_OFFSET UNITYSDK_OFFSET(0x1B0CF8A0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_GET_CUELENGTH_OFFSET UNITYSDK_OFFSET(0x1B0CF310)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_GET_ISCLIPPLAYING_OFFSET UNITYSDK_OFFSET(0x1B0CF2F0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_GET_PLAYBACK_OFFSET UNITYSDK_OFFSET(0x1B0CF2D0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1B0CF330)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_PLAY_OFFSET UNITYSDK_OFFSET(0x1B0CF340)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_PREVIEWPLAY_OFFSET UNITYSDK_OFFSET(0x1B0CF910)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_SET_CUELENGTH_OFFSET UNITYSDK_OFFSET(0x1B0CF320)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_SET_ISCLIPPLAYING_OFFSET UNITYSDK_OFFSET(0x1B0CF300)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_SET_PLAYBACK_OFFSET UNITYSDK_OFFSET(0x1B0CF2E0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_STOP_OFFSET UNITYSDK_OFFSET(0x1B0D0150)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_WAITANDSTOP_OFFSET UNITYSDK_OFFSET(0x1B0D00D0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0D0190)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0D0180)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR__WAITANDSTOP_B__21_0_OFFSET UNITYSDK_OFFSET(0x1B0D01D0)

namespace CriWare::CriTimeline::Atom
{
	inline static constexpr unsigned int CriAtomBehaviour_TypeDefinitionIndex = 31354;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CriAtomBehaviour_TypeDefinitionIndex)->GetStaticField(0x7B70);
		}
