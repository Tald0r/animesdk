...
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_GETCUELENGTHSEC_OFFSET UNITYSDK_OFFSET(0x1B6DD960)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_GET_CUELENGTH_OFFSET UNITYSDK_OFFSET(0x1B6DD3D0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_GET_ISCLIPPLAYING_OFFSET UNITYSDK_OFFSET(0x1B6DD3B0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_GET_PLAYBACK_OFFSET UNITYSDK_OFFSET(0x1B6DD390)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1B6DD3F0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_PLAY_OFFSET UNITYSDK_OFFSET(0x1B6DD400)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_PREVIEWPLAY_OFFSET UNITYSDK_OFFSET(0x1B6DD9D0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_SET_CUELENGTH_OFFSET UNITYSDK_OFFSET(0x1B6DD3E0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_SET_ISCLIPPLAYING_OFFSET UNITYSDK_OFFSET(0x1B6DD3C0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_SET_PLAYBACK_OFFSET UNITYSDK_OFFSET(0x1B6DD3A0)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_STOP_OFFSET UNITYSDK_OFFSET(0x1B6DE220)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR_WAITANDSTOP_OFFSET UNITYSDK_OFFSET(0x1B6DE190)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6DE260)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6DE250)
#define CRIWARE_CRITIMELINE_ATOM_CRIATOMBEHAVIOUR__WAITANDSTOP_B__21_0_OFFSET UNITYSDK_OFFSET(0x1B6DE2A0)

namespace CriWare::CriTimeline::Atom
{
	inline static constexpr unsigned int CriAtomBehaviour_TypeDefinitionIndex = 32306;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CriAtomBehaviour_TypeDefinitionIndex)->GetStaticField(0x7EA0);
		}
