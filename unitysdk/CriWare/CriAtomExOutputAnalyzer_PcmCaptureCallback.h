...
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_PCMCAPTURECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6C0A30)
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_PCMCAPTURECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6C0AB0)
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_PCMCAPTURECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6C0390)
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_PCMCAPTURECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C0370)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExOutputAnalyzer_PcmCaptureCallback_TypeDefinitionIndex = 32216;
