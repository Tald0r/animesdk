...
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_PCMCAPTURECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0B40C0)
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_PCMCAPTURECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0B4140)
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_PCMCAPTURECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0B3A20)
#define CRIWARE_CRIATOMEXOUTPUTANALYZER_PCMCAPTURECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B3A10)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExOutputAnalyzer_PcmCaptureCallback_TypeDefinitionIndex = 31264;
