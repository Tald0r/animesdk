...
#define CRIWARE_CRIMANAMOVIECONTROLLERFORUI_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B646790)
#define CRIWARE_CRIMANAMOVIECONTROLLERFORUI_CRIINTERNALUPDATE_OFFSET UNITYSDK_OFFSET(0x1B6467B0)
#define CRIWARE_CRIMANAMOVIECONTROLLERFORUI_ONMATERIALAVAILABLECHANGED_OFFSET UNITYSDK_OFFSET(0x1B646BD0)
#define CRIWARE_CRIMANAMOVIECONTROLLERFORUI_RENDERTARGETMANUALFINALIZE_OFFSET UNITYSDK_OFFSET(0x1B646B00)
#define CRIWARE_CRIMANAMOVIECONTROLLERFORUI_RENDERTARGETMANUALSETUP_OFFSET UNITYSDK_OFFSET(0x1B6468A0)
#define CRIWARE_CRIMANAMOVIECONTROLLERFORUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B646CF0)

namespace CriWare
{
	inline static constexpr unsigned int CriManaMovieControllerForUI_TypeDefinitionIndex = 32249;
