...
#define CRIWARE_CRIATOMEXSEQUENCER_EVENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ACB3AC0)
#define CRIWARE_CRIATOMEXSEQUENCER_EVENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ACB3B30)
#define CRIWARE_CRIATOMEXSEQUENCER_EVENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ACB3780)
#define CRIWARE_CRIATOMEXSEQUENCER_EVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACB3770)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExSequencer_EventCallback_TypeDefinitionIndex = 31239;
