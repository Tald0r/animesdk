...
#define CRIWARE_CRIATOMEXSEQUENCER_EVENTCBFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B063D90)
#define CRIWARE_CRIATOMEXSEQUENCER_EVENTCBFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B063DC0)
#define CRIWARE_CRIATOMEXSEQUENCER_EVENTCBFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B063890)
#define CRIWARE_CRIATOMEXSEQUENCER_EVENTCBFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B063880)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomExSequencer_EventCbFunc_TypeDefinitionIndex = 31238;
