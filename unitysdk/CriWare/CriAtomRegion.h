...
#define CRIWARE_CRIATOMREGION_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B6BA9E0)
#define CRIWARE_CRIATOMREGION_CRIINTERNALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B6BADD0)
#define CRIWARE_CRIATOMREGION_CRIINTERNALUPDATE_OFFSET UNITYSDK_OFFSET(0x1B6BADC0)
#define CRIWARE_CRIATOMREGION_GET_REGION3DHN_OFFSET UNITYSDK_OFFSET(0x1B6BA9C0)
#define CRIWARE_CRIATOMREGION_INITIALIZEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B6BAD00)
#define CRIWARE_CRIATOMREGION_INTERNALFINALIZE_OFFSET UNITYSDK_OFFSET(0x1B6BABC0)
#define CRIWARE_CRIATOMREGION_INTERNALINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6BAA80)
#define CRIWARE_CRIATOMREGION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B6BAA70)
#define CRIWARE_CRIATOMREGION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B6BA9F0)
#define CRIWARE_CRIATOMREGION_SET_REGION3DHN_OFFSET UNITYSDK_OFFSET(0x1B6BA9D0)
#define CRIWARE_CRIATOMREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6BADE0)

namespace CriWare
{
	inline static constexpr unsigned int CriAtomRegion_TypeDefinitionIndex = 32166;
