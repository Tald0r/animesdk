...
#define CRIWARE_CRIATOM__LOADACBFILECOROUTINE_D__62_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B3882E0)
#define CRIWARE_CRIATOM__LOADACBFILECOROUTINE_D__62_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B388630)
#define CRIWARE_CRIATOM__LOADACBFILECOROUTINE_D__62_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B388690)
#define CRIWARE_CRIATOM__LOADACBFILECOROUTINE_D__62_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B388640)
#define CRIWARE_CRIATOM__LOADACBFILECOROUTINE_D__62_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B388210)
#define CRIWARE_CRIATOM__LOADACBFILECOROUTINE_D__62__CTOR_OFFSET UNITYSDK_OFFSET(0x1B388200)
#define CRIWARE_CRIATOM__LOADACBFILECOROUTINE_D__62___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B388280)

namespace CriWare
{
	inline static constexpr unsigned int CriAtom__LoadAcbFileCoroutine_d__62_TypeDefinitionIndex = 32160;
