...
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x80C5C10)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x80C5D70)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x80C5DD0)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x80C5D80)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x80C5C00)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x80C5BF0)

inline static constexpr unsigned int CustomSkin_PhoneBind__CountDown_d__19_TypeDefinitionIndex = 51247;
