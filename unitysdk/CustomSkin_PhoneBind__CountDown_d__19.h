...
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x98DD140)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x98DD2A0)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x98DD300)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x98DD2B0)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x98DD130)
#define CUSTOMSKIN_PHONEBIND__COUNTDOWN_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x98DD120)

inline static constexpr unsigned int CustomSkin_PhoneBind__CountDown_d__19_TypeDefinitionIndex = 47488;
