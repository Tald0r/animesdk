...
#define AKRTPCPLAYABLEBEHAVIOUR_GET_OVERRIDETRACKOBJECT_OFFSET UNITYSDK_OFFSET(0x1B062550)
#define AKRTPCPLAYABLEBEHAVIOUR_GET_PARAMETER_OFFSET UNITYSDK_OFFSET(0x1B062590)
#define AKRTPCPLAYABLEBEHAVIOUR_GET_RTPCOBJECT_OFFSET UNITYSDK_OFFSET(0x1B062570)
#define AKRTPCPLAYABLEBEHAVIOUR_GET_SETRTPCGLOBALLY_OFFSET UNITYSDK_OFFSET(0x1B062530)
#define AKRTPCPLAYABLEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B0625A0)
#define AKRTPCPLAYABLEBEHAVIOUR_SET_OVERRIDETRACKOBJECT_OFFSET UNITYSDK_OFFSET(0x1B062540)
#define AKRTPCPLAYABLEBEHAVIOUR_SET_PARAMETER_OFFSET UNITYSDK_OFFSET(0x1B062580)
#define AKRTPCPLAYABLEBEHAVIOUR_SET_RTPCOBJECT_OFFSET UNITYSDK_OFFSET(0x1B062560)
#define AKRTPCPLAYABLEBEHAVIOUR_SET_SETRTPCGLOBALLY_OFFSET UNITYSDK_OFFSET(0x1B062520)
#define AKRTPCPLAYABLEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B062720)

inline static constexpr unsigned int AkRTPCPlayableBehaviour_TypeDefinitionIndex = 30130;
