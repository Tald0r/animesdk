...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__LATEPLAYITEMANIM_D__61_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x93AC0D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__LATEPLAYITEMANIM_D__61_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x93AC7A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__LATEPLAYITEMANIM_D__61_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x93AC800)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__LATEPLAYITEMANIM_D__61_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x93AC7B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__LATEPLAYITEMANIM_D__61_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x93AC0C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__LATEPLAYITEMANIM_D__61__CTOR_OFFSET UNITYSDK_OFFSET(0x93AC0B0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginItemFade__LatePlayItemAnim_d__61_TypeDefinitionIndex = 43845;
