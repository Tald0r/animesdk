...
#define IKPOSTPROCESSOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x6AA04E0)
#define IKPOSTPROCESSOR_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x6AA0AF0)
#define IKPOSTPROCESSOR_ONLATEANIMAGEIK_OFFSET UNITYSDK_OFFSET(0x6AA0C00)
#define IKPOSTPROCESSOR_START_OFFSET UNITYSDK_OFFSET(0x6AA0370)
#define IKPOSTPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6AA11D0)

inline static constexpr unsigned int IKPostProcessor_TypeDefinitionIndex = 65319;
