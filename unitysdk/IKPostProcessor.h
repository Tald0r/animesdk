...
#define IKPOSTPROCESSOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xB0A2A10)
#define IKPOSTPROCESSOR_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0xB0A3020)
#define IKPOSTPROCESSOR_ONLATEANIMAGEIK_OFFSET UNITYSDK_OFFSET(0xB0A3130)
#define IKPOSTPROCESSOR_START_OFFSET UNITYSDK_OFFSET(0xB0A28A0)
#define IKPOSTPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB0A3700)

inline static constexpr unsigned int IKPostProcessor_TypeDefinitionIndex = 40749;
