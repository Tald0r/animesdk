...
#define NPCSOFTMATERIALPATHLIST_GETPATHS_OFFSET UNITYSDK_OFFSET(0x8494E20)
#define NPCSOFTMATERIALPATHLIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8494E10)
#define NPCSOFTMATERIALPATHLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x8494DD0)

inline static constexpr unsigned int NPCSoftMaterialPathList_TypeDefinitionIndex = 80746;
