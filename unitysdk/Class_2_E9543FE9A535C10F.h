...
#define CLASS_2_E9543FE9A535C10F_METHOD_2_2D8360ADEC831C05_OFFSET UNITYSDK_OFFSET(0x772FB90)
#define CLASS_2_E9543FE9A535C10F_METHOD_2_9DE87B16AD0A605E_OFFSET UNITYSDK_OFFSET(0x772FDC0)
#define CLASS_2_E9543FE9A535C10F_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0x772FEB0)
#define CLASS_2_E9543FE9A535C10F__CTOR_OFFSET UNITYSDK_OFFSET(0x772FEA0)

inline static constexpr unsigned int Class_2_E9543FE9A535C10F_TypeDefinitionIndex = 66044;

class Class_2_E9543FE9A535C10F : public ::Class_1_EEA0111A28582B57
{
public:
	::Class_3_A2BF74BADF6F7D16<::MoleMole::UIBabeltowerMenuBtnWidgetController*>* Field_2_2; // 0x18
	...
	::Class_3_A2BF74BADF6F7D16<::MoleMole::UIBabeltowerMenuBtnWidgetController*>* Field_2_1; // 0x38
