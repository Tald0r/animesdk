...
#define AKMEMBANKLOADER_ALLOCATEALIGNEDBUFFER_OFFSET UNITYSDK_OFFSET(0x1B0E9A30)
#define AKMEMBANKLOADER_DOLOADBANK_OFFSET UNITYSDK_OFFSET(0x1B0E9970)
#define AKMEMBANKLOADER_LOADFILE_OFFSET UNITYSDK_OFFSET(0x1B0E9BE0)
#define AKMEMBANKLOADER_LOADLOCALIZEDBANK_OFFSET UNITYSDK_OFFSET(0x1B0E9710)
#define AKMEMBANKLOADER_LOADNONLOCALIZEDBANK_OFFSET UNITYSDK_OFFSET(0x1B0E9860)
#define AKMEMBANKLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B0E9C30)
#define AKMEMBANKLOADER_START_OFFSET UNITYSDK_OFFSET(0x1B0E96F0)
#define AKMEMBANKLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E9D40)

inline static constexpr unsigned int AkMemBankLoader_TypeDefinitionIndex = 30125;
