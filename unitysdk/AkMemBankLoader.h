...
#define AKMEMBANKLOADER_ALLOCATEALIGNEDBUFFER_OFFSET UNITYSDK_OFFSET(0x1B6FA680)
#define AKMEMBANKLOADER_DOLOADBANK_OFFSET UNITYSDK_OFFSET(0x1B6FA5C0)
#define AKMEMBANKLOADER_LOADFILE_OFFSET UNITYSDK_OFFSET(0x1B6FA830)
#define AKMEMBANKLOADER_LOADLOCALIZEDBANK_OFFSET UNITYSDK_OFFSET(0x1B6FA360)
#define AKMEMBANKLOADER_LOADNONLOCALIZEDBANK_OFFSET UNITYSDK_OFFSET(0x1B6FA4B0)
#define AKMEMBANKLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B6FA880)
#define AKMEMBANKLOADER_START_OFFSET UNITYSDK_OFFSET(0x1B6FA340)
#define AKMEMBANKLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6FA990)

inline static constexpr unsigned int AkMemBankLoader_TypeDefinitionIndex = 31078;
