...
class Class_2_6E4CFE4F6939B4A6_Class_2_E89DC7541B30248D_15;
...
#define CLASS_2_6E4CFE4F6939B4A6_METHOD_2_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x646ADD0)
#define CLASS_2_6E4CFE4F6939B4A6_METHOD_2_B74D3688C9F7FE4B_OFFSET UNITYSDK_OFFSET(0x646ADE0)
#define CLASS_2_6E4CFE4F6939B4A6_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x646B0D0)
#define CLASS_2_6E4CFE4F6939B4A6_METHOD_2_D737CD2779D51A4E_OFFSET UNITYSDK_OFFSET(0x646AEB0)
#define CLASS_2_6E4CFE4F6939B4A6__CTOR_OFFSET UNITYSDK_OFFSET(0x646B0C0)

inline static constexpr unsigned int Class_2_6E4CFE4F6939B4A6_TypeDefinitionIndex = 55662;

class Class_2_6E4CFE4F6939B4A6 : public ::Class_1_9E50DA0647A3ACF0
{
public:
	::MoleMole::UIInLevelSkillButtonBangBooAChildWindowController* Field_2_4; // 0x28
	::MoleMole::UIInLevelSkillButtonBangbooDChildWindowController* Field_2_1; // 0x30
	::Class_2_6E4CFE4F6939B4A6_Class_2_E89DC7541B30248D_15* Field_2_0; // 0x38
	::MoleMole::UIInLevelSkillButtonBangbooBranchChildWindowController* Field_2_2; // 0x40
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_136*, ::MoleMole::UIWindowController*))((::PBYTE)hIl2Cpp + CLASS_2_6E4CFE4F6939B4A6_METHOD_2_B74D3688C9F7FE4B_OFFSET))(this, a1, a2);
	}
