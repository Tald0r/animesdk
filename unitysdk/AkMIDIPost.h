...
#define AKMIDIPOST_CLONE_OFFSET UNITYSDK_OFFSET(0x1B5A4CA0)
#define AKMIDIPOST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B5A47E0)
#define AKMIDIPOST_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1B5A4700)
#define AKMIDIPOST_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1B5A4D40)
#define AKMIDIPOST_GET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x1B5A49D0)
#define AKMIDIPOST_POSTONEVENT_OFFSET UNITYSDK_OFFSET(0x1B5A4A50)
#define AKMIDIPOST_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1B5A4710)
#define AKMIDIPOST_SET_UOFFSET_OFFSET UNITYSDK_OFFSET(0x1B5A4950)
#define AKMIDIPOST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B5A4DC0)
#define AKMIDIPOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A4670)

inline static constexpr unsigned int AkMIDIPost_TypeDefinitionIndex = 30907;
