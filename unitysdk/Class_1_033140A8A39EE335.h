...
#define CLASS_1_033140A8A39EE335_METHOD_1_420C3F78C7C174BB_OFFSET UNITYSDK_OFFSET(0x627C530)
#define CLASS_1_033140A8A39EE335_METHOD_1_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x627C7D0)
#define CLASS_1_033140A8A39EE335_METHOD_1_F8C7231308CD2C82_OFFSET UNITYSDK_OFFSET(0x627C4A0)
#define CLASS_1_033140A8A39EE335__CCTOR_OFFSET UNITYSDK_OFFSET(0x627C490)

inline static constexpr unsigned int Class_1_033140A8A39EE335_TypeDefinitionIndex = 78753;
...
public:
	...
	{
		return (::MoleMole::Config::ConfigVideoQualitySetting**)Il2CppClass::FromTypeDefinitionIndex(Class_1_033140A8A39EE335_TypeDefinitionIndex)->GetStaticField(0x43090);
	}
