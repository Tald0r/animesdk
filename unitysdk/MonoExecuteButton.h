...
#define MONOEXECUTEBUTTON_AWAKE_OFFSET UNITYSDK_OFFSET(0x73F9EC0)
#define MONOEXECUTEBUTTON_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x73F9C90)
#define MONOEXECUTEBUTTON_ONLOCKCORECHANGE_OFFSET UNITYSDK_OFFSET(0x73F9890)
#define MONOEXECUTEBUTTON_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x73F9E00)
#define MONOEXECUTEBUTTON_REFRESHBUTTON_OFFSET UNITYSDK_OFFSET(0x73F9800)
#define MONOEXECUTEBUTTON_UPDATEFORKEYBORADINPUT_OFFSET UNITYSDK_OFFSET(0x73F9CF0)
#define MONOEXECUTEBUTTON_UPDATEKEYBORADINPUT_OFFSET UNITYSDK_OFFSET(0x73F9B80)
#define MONOEXECUTEBUTTON_UPDATE_OFFSET UNITYSDK_OFFSET(0x73F9F40)
#define MONOEXECUTEBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x73F9FB0)

inline static constexpr unsigned int MonoExecuteButton_TypeDefinitionIndex = 52923;
