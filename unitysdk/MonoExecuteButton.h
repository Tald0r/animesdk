...
#define MONOEXECUTEBUTTON_AWAKE_OFFSET UNITYSDK_OFFSET(0x7BF07D0)
#define MONOEXECUTEBUTTON_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x7BF05A0)
#define MONOEXECUTEBUTTON_ONLOCKCORECHANGE_OFFSET UNITYSDK_OFFSET(0x7BF01A0)
#define MONOEXECUTEBUTTON_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x7BF0710)
#define MONOEXECUTEBUTTON_REFRESHBUTTON_OFFSET UNITYSDK_OFFSET(0x7BF0110)
#define MONOEXECUTEBUTTON_UPDATEFORKEYBORADINPUT_OFFSET UNITYSDK_OFFSET(0x7BF0600)
#define MONOEXECUTEBUTTON_UPDATEKEYBORADINPUT_OFFSET UNITYSDK_OFFSET(0x7BF0490)
#define MONOEXECUTEBUTTON_UPDATE_OFFSET UNITYSDK_OFFSET(0x7BF0850)
#define MONOEXECUTEBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x7BF08C0)

inline static constexpr unsigned int MonoExecuteButton_TypeDefinitionIndex = 56394;
