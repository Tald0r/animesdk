...
#define SCREENSPACEQUADRENDERER_GENERATEQUADMESH_OFFSET UNITYSDK_OFFSET(0x1A552350)
#define SCREENSPACEQUADRENDERER_GETPROJECTEDWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x1A5538D0)
#define SCREENSPACEQUADRENDERER_INIT_OFFSET UNITYSDK_OFFSET(0x1A553100)
#define SCREENSPACEQUADRENDERER_ONBEGINCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0x1A5522D0)
#define SCREENSPACEQUADRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A552260)
#define SCREENSPACEQUADRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A552100)
#define SCREENSPACEQUADRENDERER_REGISTERRENDERING_OFFSET UNITYSDK_OFFSET(0x1A552170)
#define SCREENSPACEQUADRENDERER_SETUPTARGET_OFFSET UNITYSDK_OFFSET(0x1A553090)
#define SCREENSPACEQUADRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A553A60)

inline static constexpr unsigned int ScreenSpaceQuadRenderer_TypeDefinitionIndex = 50064;
