...
#define SCREENSPACEQUADRENDERER_GENERATEQUADMESH_OFFSET UNITYSDK_OFFSET(0xD6102E0)
#define SCREENSPACEQUADRENDERER_GETPROJECTEDWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xD611860)
#define SCREENSPACEQUADRENDERER_INIT_OFFSET UNITYSDK_OFFSET(0xD611090)
#define SCREENSPACEQUADRENDERER_ONBEGINCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0xD610260)
#define SCREENSPACEQUADRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD6101F0)
#define SCREENSPACEQUADRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD610090)
#define SCREENSPACEQUADRENDERER_REGISTERRENDERING_OFFSET UNITYSDK_OFFSET(0xD610100)
#define SCREENSPACEQUADRENDERER_SETUPTARGET_OFFSET UNITYSDK_OFFSET(0xD611020)
#define SCREENSPACEQUADRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0xD6119F0)

inline static constexpr unsigned int ScreenSpaceQuadRenderer_TypeDefinitionIndex = 59082;
