...
#define NAPRENDERENTITY_ADDINDICATEDLIGHT_OFFSET UNITYSDK_OFFSET(0x185C58E0)
#define NAPRENDERENTITY_APPLYSHADOWPROXYDITHERALPHAIFDIRTY_OFFSET UNITYSDK_OFFSET(0x185C5580)
#define NAPRENDERENTITY_ATTACHNATIVERENDERERHANDLES_OFFSET UNITYSDK_OFFSET(0x185B5BD0)
#define NAPRENDERENTITY_BUILDINDICATEDNAPLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x185C5CE0)
#define NAPRENDERENTITY_CREATEMATCAPTEXTUREARRAYLEGACY_OFFSET UNITYSDK_OFFSET(0x185BF9C0)
#define NAPRENDERENTITY_CREATEMATCAPTEXTUREARRAYSIMPLIFY_OFFSET UNITYSDK_OFFSET(0x185BDE30)
#define NAPRENDERENTITY_FINDNAPMATERIAL_OFFSET UNITYSDK_OFFSET(0x185C67B0)
#define NAPRENDERENTITY_GETLODPARTID_OFFSET UNITYSDK_OFFSET(0x185C4D30)
#define NAPRENDERENTITY_GETPEROBJECTSHADOWGIZMOS_OFFSET UNITYSDK_OFFSET(0x185B82D0)
#define NAPRENDERENTITY_GETPEROBJECTSHADOWRENDERER_OFFSET UNITYSDK_OFFSET(0x185B8310)
#define NAPRENDERENTITY_GETRENDERERAT_OFFSET UNITYSDK_OFFSET(0x185C2FB0)
#define NAPRENDERENTITY_GETRENDERERCOUNT_OFFSET UNITYSDK_OFFSET(0x185C2F50)
#define NAPRENDERENTITY_GET_BAKEDOBJECTSPACECULLINGSPHERE_OFFSET UNITYSDK_OFFSET(0x185B7410)
#define NAPRENDERENTITY_GET_CACHEBOUNDSWHENSTAYS_OFFSET UNITYSDK_OFFSET(0x185B72B0)
#define NAPRENDERENTITY_GET_CACHEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x185B7310)
#define NAPRENDERENTITY_GET_CACHEDLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x185B7350)
#define NAPRENDERENTITY_GET_CLIPVERTICESUNDERCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x185B6A80)
#define NAPRENDERENTITY_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x185B72A0)
#define NAPRENDERENTITY_GET_CUSTOMBLENDEDDIRECTIONALLIGHTSIZE_OFFSET UNITYSDK_OFFSET(0x185B6F00)
#define NAPRENDERENTITY_GET_CUSTOMLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x185B7A70)
#define NAPRENDERENTITY_GET_DISABLESPHERECULLING_OFFSET UNITYSDK_OFFSET(0x185B6B30)
#define NAPRENDERENTITY_GET_DISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x185B7550)
#define NAPRENDERENTITY_GET_DONTOPTIMIZESHADOWPROXYBOUNDS_OFFSET UNITYSDK_OFFSET(0x185B89B0)
#define NAPRENDERENTITY_GET_ENTITYTYPE_OFFSET UNITYSDK_OFFSET(0x185B6D30)
#define NAPRENDERENTITY_GET_FIXRED_OFFSET UNITYSDK_OFFSET(0x185B6F20)
#define NAPRENDERENTITY_GET_FIXSHADOWCOVERAGEOUTOFFRUSTUM_OFFSET UNITYSDK_OFFSET(0x185B6FD0)
#define NAPRENDERENTITY_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x185B67C0)
#define NAPRENDERENTITY_GET_FORCEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x185B7280)
#define NAPRENDERENTITY_GET_HASCHARACTERMATERIAL_OFFSET UNITYSDK_OFFSET(0x185B6710)
#define NAPRENDERENTITY_GET_HASREGULARRENDERER_OFFSET UNITYSDK_OFFSET(0x185B6410)
#define NAPRENDERENTITY_GET_HEADBONEFORWARD_OFFSET UNITYSDK_OFFSET(0x185B6C20)
#define NAPRENDERENTITY_GET_HEADBONEPOSITION_OFFSET UNITYSDK_OFFSET(0x185B6C00)
#define NAPRENDERENTITY_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x185B5EE0)
#define NAPRENDERENTITY_GET_ISAVATARPARTICLEDIRTY_OFFSET UNITYSDK_OFFSET(0x185B8850)
#define NAPRENDERENTITY_GET_ISCURFRAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x185B64C0)
#define NAPRENDERENTITY_GET_ISCUTSCENEMODE_OFFSET UNITYSDK_OFFSET(0x185B67E0)
#define NAPRENDERENTITY_GET_ISFIRSTTIMECALCULATERADIAN_OFFSET UNITYSDK_OFFSET(0x185B8900)
#define NAPRENDERENTITY_GET_ISGPUCROWD_OFFSET UNITYSDK_OFFSET(0x185B6700)
#define NAPRENDERENTITY_GET_ISNAPCBBOUND_OFFSET UNITYSDK_OFFSET(0x185B69C0)
#define NAPRENDERENTITY_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x185B8770)
#define NAPRENDERENTITY_GET_ISVISIBLEINCURRENTCAM_OFFSET UNITYSDK_OFFSET(0x185B6120)
#define NAPRENDERENTITY_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x185B6360)
#define NAPRENDERENTITY_GET_LASTFRAMEPOSITION_OFFSET UNITYSDK_OFFSET(0x185B72D0)
#define NAPRENDERENTITY_GET_LIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x185B7430)
#define NAPRENDERENTITY_GET_LODGROUPS_OFFSET UNITYSDK_OFFSET(0x185B6C40)
#define NAPRENDERENTITY_GET_MAINLIGHTPARAMSOVERRIDEN_OFFSET UNITYSDK_OFFSET(0x185B6C60)
#define NAPRENDERENTITY_GET_MIDDLEPOINTPOSITION_OFFSET UNITYSDK_OFFSET(0x185B6BE0)
#define NAPRENDERENTITY_GET_NAPCBUFFER_OFFSET UNITYSDK_OFFSET(0x185B6A70)
#define NAPRENDERENTITY_GET_OFFSETFORRENDERING_OFFSET UNITYSDK_OFFSET(0x185B7530)
#define NAPRENDERENTITY_GET_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x185B5940)
#define NAPRENDERENTITY_GET_OVERRIDENMAINLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x185B6D10)
#define NAPRENDERENTITY_GET_PEROBJECTSHADOWALPHA_OFFSET UNITYSDK_OFFSET(0x185B73B0)
#define NAPRENDERENTITY_GET_PEROBJECTSHADOWCULLRESULT_OFFSET UNITYSDK_OFFSET(0x185B7390)
#define NAPRENDERENTITY_GET_PEROBJECTSHADOWFADETARGET_OFFSET UNITYSDK_OFFSET(0x185B73D0)
#define NAPRENDERENTITY_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x185B5980)
#define NAPRENDERENTITY_GET_RAYCASTFORCULLINGSPHERE_OFFSET UNITYSDK_OFFSET(0x185B7290)
#define NAPRENDERENTITY_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x185B5960)
#define NAPRENDERENTITY_GET_SHADERUNIFORMPEROBJECTSHADOWDATA_OFFSET UNITYSDK_OFFSET(0x185B8390)
#define NAPRENDERENTITY_GET_SORTPRIORITY_OFFSET UNITYSDK_OFFSET(0x185B5D00)
#define NAPRENDERENTITY_GET_USEBAKEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x185B73F0)
#define NAPRENDERENTITY_GET_USECUSTOMBLENDEDDIRECTIONALLIGHTSIZE_OFFSET UNITYSDK_OFFSET(0x185B6E50)
#define NAPRENDERENTITY_GET_USECUSTOMLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x185B79C0)
#define NAPRENDERENTITY_GET_USEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x185B7080)
#define NAPRENDERENTITY_GET_XAXIS_OFFSET UNITYSDK_OFFSET(0x185B7470)
#define NAPRENDERENTITY_GET_YAXIS_OFFSET UNITYSDK_OFFSET(0x185B74B0)
#define NAPRENDERENTITY_GET_ZAXIS_OFFSET UNITYSDK_OFFSET(0x185B74F0)
#define NAPRENDERENTITY_GET_ZDISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x185B5D20)
#define NAPRENDERENTITY_HASFLAG_OFFSET UNITYSDK_OFFSET(0x185BB1B0)
#define NAPRENDERENTITY_MATCAPTEXTURECHECKRESULT_OFFSET UNITYSDK_OFFSET(0x185C2B10)
#define NAPRENDERENTITY_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x185C3030)
#define NAPRENDERENTITY_OVERRIDEMAINLIGHTPARAMS_OFFSET UNITYSDK_OFFSET(0x185C6400)
#define NAPRENDERENTITY_REBINDARRAYPROPERTYBUFFER_OFFSET UNITYSDK_OFFSET(0x185BAEA0)
#define NAPRENDERENTITY_REFRESHMATCAPDATA_OFFSET UNITYSDK_OFFSET(0x185C4BD0)
#define NAPRENDERENTITY_REFRESHMATCAPVECTORARRAYPROPERTIES_OFFSET UNITYSDK_OFFSET(0x185C6D20)
#define NAPRENDERENTITY_REFRESHSTATEPERFRAME_OFFSET UNITYSDK_OFFSET(0x185B8F30)
#define NAPRENDERENTITY_REFRESH_OFFSET UNITYSDK_OFFSET(0x185C3C10)
#define NAPRENDERENTITY_RELEASEMATCAPTEXTUREARRAY_OFFSET UNITYSDK_OFFSET(0x185C2960)
#define NAPRENDERENTITY_RELEASETEXTUREARRAYLIST_OFFSET UNITYSDK_OFFSET(0x185C2740)
#define NAPRENDERENTITY_RELEASE_OFFSET UNITYSDK_OFFSET(0x185C3130)
#define NAPRENDERENTITY_REMOVEINDICATEDLIGHT_OFFSET UNITYSDK_OFFSET(0x185C61C0)
#define NAPRENDERENTITY_RESET_OFFSET UNITYSDK_OFFSET(0x185C31A0)
#define NAPRENDERENTITY_REVERTOVERRIDENMAINLIGHTPARAMS_OFFSET UNITYSDK_OFFSET(0x185C65F0)
#define NAPRENDERENTITY_SETFLAG_OFFSET UNITYSDK_OFFSET(0x185BB200)
#define NAPRENDERENTITY_SETHAIRSHADOWOFFSETS_OFFSET UNITYSDK_OFFSET(0x185C5700)
#define NAPRENDERENTITY_SETSHADOWDATABLOCK_OFFSET UNITYSDK_OFFSET(0x185B7570)
#define NAPRENDERENTITY_SETSHADOWLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x185B7C20)
#define NAPRENDERENTITY_SETSHADOWPROXYDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x185C5010)
#define NAPRENDERENTITY_SETTRANSFORMGETTERS_OFFSET UNITYSDK_OFFSET(0x185C4CD0)
#define NAPRENDERENTITY_SETUP_OFFSET UNITYSDK_OFFSET(0x185BB3D0)
#define NAPRENDERENTITY_SET_BAKEDOBJECTSPACECULLINGSPHERE_OFFSET UNITYSDK_OFFSET(0x185B7420)
#define NAPRENDERENTITY_SET_CACHEBOUNDSWHENSTAYS_OFFSET UNITYSDK_OFFSET(0x185B72C0)
#define NAPRENDERENTITY_SET_CACHEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x185B7330)
#define NAPRENDERENTITY_SET_CACHEDLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x185B7370)
#define NAPRENDERENTITY_SET_CLIPVERTICESUNDERCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x185B6AD0)
#define NAPRENDERENTITY_SET_CUSTOMBLENDEDDIRECTIONALLIGHTSIZE_OFFSET UNITYSDK_OFFSET(0x185B6F10)
#define NAPRENDERENTITY_SET_DISABLESPHERECULLING_OFFSET UNITYSDK_OFFSET(0x185B6B80)
#define NAPRENDERENTITY_SET_DISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x185B7560)
#define NAPRENDERENTITY_SET_DONTOPTIMIZESHADOWPROXYBOUNDS_OFFSET UNITYSDK_OFFSET(0x185B89C0)
#define NAPRENDERENTITY_SET_ENTITYTYPE_OFFSET UNITYSDK_OFFSET(0x185B6DA0)
#define NAPRENDERENTITY_SET_FIXRED_OFFSET UNITYSDK_OFFSET(0x185B6F70)
#define NAPRENDERENTITY_SET_FIXSHADOWCOVERAGEOUTOFFRUSTUM_OFFSET UNITYSDK_OFFSET(0x185B7020)
#define NAPRENDERENTITY_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x185B67D0)
#define NAPRENDERENTITY_SET_HASCHARACTERMATERIAL_OFFSET UNITYSDK_OFFSET(0x185B6760)
#define NAPRENDERENTITY_SET_HASREGULARRENDERER_OFFSET UNITYSDK_OFFSET(0x185B6460)
#define NAPRENDERENTITY_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x185B60C0)
#define NAPRENDERENTITY_SET_ISAVATARPARTICLEDIRTY_OFFSET UNITYSDK_OFFSET(0x185B88A0)
#define NAPRENDERENTITY_SET_ISCURFRAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x185B66A0)
#define NAPRENDERENTITY_SET_ISCUTSCENEMODE_OFFSET UNITYSDK_OFFSET(0x185B67F0)
#define NAPRENDERENTITY_SET_ISFIRSTTIMECALCULATERADIAN_OFFSET UNITYSDK_OFFSET(0x185B8950)
#define NAPRENDERENTITY_SET_ISNAPCBBOUND_OFFSET UNITYSDK_OFFSET(0x185B6A10)
#define NAPRENDERENTITY_SET_ISVISIBLEINCURRENTCAM_OFFSET UNITYSDK_OFFSET(0x185B6300)
#define NAPRENDERENTITY_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x185B63B0)
#define NAPRENDERENTITY_SET_LASTFRAMEPOSITION_OFFSET UNITYSDK_OFFSET(0x185B72F0)
#define NAPRENDERENTITY_SET_LIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x185B7450)
#define NAPRENDERENTITY_SET_LODGROUPS_OFFSET UNITYSDK_OFFSET(0x185B6C50)
#define NAPRENDERENTITY_SET_MAINLIGHTPARAMSOVERRIDEN_OFFSET UNITYSDK_OFFSET(0x185B6CB0)
#define NAPRENDERENTITY_SET_OFFSETFORRENDERING_OFFSET UNITYSDK_OFFSET(0x185B7540)
#define NAPRENDERENTITY_SET_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x185B5950)
#define NAPRENDERENTITY_SET_OVERRIDENMAINLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x185B6D20)
#define NAPRENDERENTITY_SET_PEROBJECTSHADOWALPHA_OFFSET UNITYSDK_OFFSET(0x185B73C0)
#define NAPRENDERENTITY_SET_PEROBJECTSHADOWCULLRESULT_OFFSET UNITYSDK_OFFSET(0x185B73A0)
#define NAPRENDERENTITY_SET_PEROBJECTSHADOWFADETARGET_OFFSET UNITYSDK_OFFSET(0x185B73E0)
#define NAPRENDERENTITY_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x185B5990)
#define NAPRENDERENTITY_SET_ROOT_OFFSET UNITYSDK_OFFSET(0x185B5970)
#define NAPRENDERENTITY_SET_SHADERUNIFORMPEROBJECTSHADOWDATA_OFFSET UNITYSDK_OFFSET(0x185B8400)
#define NAPRENDERENTITY_SET_SHADERUNIFORMPEROBJECTSHADOWRESOLVEST_OFFSET UNITYSDK_OFFSET(0x185B8700)
#define NAPRENDERENTITY_SET_SHADERUNIFORMPEROBJECTSHADOWUVMATRIX_OFFSET UNITYSDK_OFFSET(0x185B8530)
#define NAPRENDERENTITY_SET_SHADERUNIFORMRECEIVESHADOW_OFFSET UNITYSDK_OFFSET(0x185B8470)
#define NAPRENDERENTITY_SET_SORTPRIORITY_OFFSET UNITYSDK_OFFSET(0x185B5D10)
#define NAPRENDERENTITY_SET_USEBAKEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x185B7400)
#define NAPRENDERENTITY_SET_USECUSTOMBLENDEDDIRECTIONALLIGHTSIZE_OFFSET UNITYSDK_OFFSET(0x185B6EA0)
#define NAPRENDERENTITY_SET_USEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x185B70D0)
#define NAPRENDERENTITY_SET_XAXIS_OFFSET UNITYSDK_OFFSET(0x185B7490)
#define NAPRENDERENTITY_SET_YAXIS_OFFSET UNITYSDK_OFFSET(0x185B74D0)
#define NAPRENDERENTITY_SET_ZAXIS_OFFSET UNITYSDK_OFFSET(0x185B7510)
#define NAPRENDERENTITY_SET_ZDISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x185B5ED0)
#define NAPRENDERENTITY_UPDATEVISIBILITY_OFFSET UNITYSDK_OFFSET(0x185B89D0)
#define NAPRENDERENTITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x185C6FE0)
#define NAPRENDERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x185B7E80)

inline static constexpr unsigned int NapRenderEntity_TypeDefinitionIndex = 28119;
...
public:
	...
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21BE0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CalculateCameraVisibility()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21BE8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTransforms()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21BF0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectFaceRendererNotSkinned()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21BF8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_SetFlags()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C00);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_RefreshStatePerFrame()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C08);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CalculateCullingSphere()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C10);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetHeadBoneTransform()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C18);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTransformsFromJob()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C20);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitNapRenderer()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C28);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_Part2()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C30);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitPropertyMode()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C38);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTransformsFromFunc()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C40);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_UpdateDistanceToCamera()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C48);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_Release()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C50);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectRenderingLayer()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C58);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CreateTextureArray()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C60);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectMapCapInfo()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C68);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitMaterialParticleArray()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C70);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTexture()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C78);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_UpdateRamp()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C80);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitLodGroup1()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C88);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CountMaterials()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C90);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectBounds()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21C98);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CheckMatCapEnabled()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21CA0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CopyTexture()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21CA8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitMatCapIDArray()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21CB0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_SetShadowProxyAlphas()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21CB8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitLodGroup2()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21CC0);
	}
	static ::System::Collections::Generic::List_1<::NapRenderEntity_MatCapInfo>** StaticGet_matCapInfos()
	{
		return (::System::Collections::Generic::List_1<::NapRenderEntity_MatCapInfo>**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21CC8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_LayerAndFrustumCulling()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21CD0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_Setup()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21CD8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_ApplyMaterialProperties()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21CE0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CharacterGI()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21CE8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CreateMatCapTextureArray()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21CF0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CheckMaterialValid()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21CF8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_FetchParamsFromMonoRenderEntity()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21D00);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTransformsCommon()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x21D08);
	}
