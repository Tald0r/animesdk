...
#define NAPRENDERENTITY_ADDINDICATEDLIGHT_OFFSET UNITYSDK_OFFSET(0x18B2E050)
#define NAPRENDERENTITY_APPLYSHADOWPROXYDITHERALPHAIFDIRTY_OFFSET UNITYSDK_OFFSET(0x18B2DCF0)
#define NAPRENDERENTITY_ATTACHNATIVERENDERERHANDLES_OFFSET UNITYSDK_OFFSET(0x18B1DBB0)
#define NAPRENDERENTITY_BATCHEDVISIBLECHECK_OFFSET UNITYSDK_OFFSET(0x18B211C0)
#define NAPRENDERENTITY_BUILDINDICATEDNAPLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x18B2E450)
#define NAPRENDERENTITY_CREATEMATCAPTEXTUREARRAYLEGACY_OFFSET UNITYSDK_OFFSET(0x18B28140)
#define NAPRENDERENTITY_CREATEMATCAPTEXTUREARRAYSIMPLIFY_OFFSET UNITYSDK_OFFSET(0x18B265C0)
#define NAPRENDERENTITY_FINDNAPMATERIAL_OFFSET UNITYSDK_OFFSET(0x18B2EF20)
#define NAPRENDERENTITY_GETLODPARTID_OFFSET UNITYSDK_OFFSET(0x18B2D4A0)
#define NAPRENDERENTITY_GETPEROBJECTSHADOWGIZMOS_OFFSET UNITYSDK_OFFSET(0x18B20530)
#define NAPRENDERENTITY_GETPEROBJECTSHADOWRENDERER_OFFSET UNITYSDK_OFFSET(0x18B20570)
#define NAPRENDERENTITY_GETRENDERERAT_OFFSET UNITYSDK_OFFSET(0x18B2B700)
#define NAPRENDERENTITY_GETRENDERERCOUNT_OFFSET UNITYSDK_OFFSET(0x18B2B6A0)
#define NAPRENDERENTITY_GET_BAKEDOBJECTSPACECULLINGSPHERE_OFFSET UNITYSDK_OFFSET(0x18B1F4A0)
#define NAPRENDERENTITY_GET_CACHEBOUNDSWHENSTAYS_OFFSET UNITYSDK_OFFSET(0x18B1F340)
#define NAPRENDERENTITY_GET_CACHEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x18B1F3A0)
#define NAPRENDERENTITY_GET_CACHEDLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x18B1F3E0)
#define NAPRENDERENTITY_GET_CLIPVERTICESUNDERCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x18B1EB10)
#define NAPRENDERENTITY_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x18B1F330)
#define NAPRENDERENTITY_GET_CUSTOMBLENDEDDIRECTIONALLIGHTSIZE_OFFSET UNITYSDK_OFFSET(0x18B1EF90)
#define NAPRENDERENTITY_GET_CUSTOMLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x18B1FCD0)
#define NAPRENDERENTITY_GET_DISABLESPHERECULLING_OFFSET UNITYSDK_OFFSET(0x18B1EBC0)
#define NAPRENDERENTITY_GET_DISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x18B1F5E0)
#define NAPRENDERENTITY_GET_DONTOPTIMIZESHADOWPROXYBOUNDS_OFFSET UNITYSDK_OFFSET(0x18B20C80)
#define NAPRENDERENTITY_GET_ENTITYTYPE_OFFSET UNITYSDK_OFFSET(0x18B1EDC0)
#define NAPRENDERENTITY_GET_FIXRED_OFFSET UNITYSDK_OFFSET(0x18B1EFB0)
#define NAPRENDERENTITY_GET_FIXSHADOWCOVERAGEOUTOFFRUSTUM_OFFSET UNITYSDK_OFFSET(0x18B1F060)
#define NAPRENDERENTITY_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x18B1E850)
#define NAPRENDERENTITY_GET_FORCEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x18B1F310)
#define NAPRENDERENTITY_GET_HASCHARACTERMATERIAL_OFFSET UNITYSDK_OFFSET(0x18B1E6F0)
#define NAPRENDERENTITY_GET_HASREGULARRENDERER_OFFSET UNITYSDK_OFFSET(0x18B1E3F0)
#define NAPRENDERENTITY_GET_HASVALIDMATERIAL_OFFSET UNITYSDK_OFFSET(0x18B1E7A0)
#define NAPRENDERENTITY_GET_HEADBONEFORWARD_OFFSET UNITYSDK_OFFSET(0x18B1ECB0)
#define NAPRENDERENTITY_GET_HEADBONEPOSITION_OFFSET UNITYSDK_OFFSET(0x18B1EC90)
#define NAPRENDERENTITY_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x18B1DEC0)
#define NAPRENDERENTITY_GET_ISAVATARPARTICLEDIRTY_OFFSET UNITYSDK_OFFSET(0x18B20B20)
#define NAPRENDERENTITY_GET_ISCURFRAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x18B1E4A0)
#define NAPRENDERENTITY_GET_ISCUTSCENEMODE_OFFSET UNITYSDK_OFFSET(0x18B1E870)
#define NAPRENDERENTITY_GET_ISFIRSTTIMECALCULATERADIAN_OFFSET UNITYSDK_OFFSET(0x18B20BD0)
#define NAPRENDERENTITY_GET_ISGPUCROWD_OFFSET UNITYSDK_OFFSET(0x18B1E6E0)
#define NAPRENDERENTITY_GET_ISNAPCBBOUND_OFFSET UNITYSDK_OFFSET(0x18B1EA50)
#define NAPRENDERENTITY_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x18B209D0)
#define NAPRENDERENTITY_GET_ISVISIBLEINCURRENTCAM_OFFSET UNITYSDK_OFFSET(0x18B1E100)
#define NAPRENDERENTITY_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x18B1E340)
#define NAPRENDERENTITY_GET_LASTFRAMEPOSITION_OFFSET UNITYSDK_OFFSET(0x18B1F360)
#define NAPRENDERENTITY_GET_LIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x18B1F4C0)
#define NAPRENDERENTITY_GET_LODGROUPS_OFFSET UNITYSDK_OFFSET(0x18B1ECD0)
#define NAPRENDERENTITY_GET_MAINLIGHTPARAMSOVERRIDEN_OFFSET UNITYSDK_OFFSET(0x18B1ECF0)
#define NAPRENDERENTITY_GET_MIDDLEPOINTPOSITION_OFFSET UNITYSDK_OFFSET(0x18B1EC70)
#define NAPRENDERENTITY_GET_NAPCBUFFER_OFFSET UNITYSDK_OFFSET(0x18B1EB00)
#define NAPRENDERENTITY_GET_OFFSETFORRENDERING_OFFSET UNITYSDK_OFFSET(0x18B1F5C0)
#define NAPRENDERENTITY_GET_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x18B1D920)
#define NAPRENDERENTITY_GET_OVERRIDENMAINLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x18B1EDA0)
#define NAPRENDERENTITY_GET_PEROBJECTSHADOWALPHA_OFFSET UNITYSDK_OFFSET(0x18B1F440)
#define NAPRENDERENTITY_GET_PEROBJECTSHADOWCULLRESULT_OFFSET UNITYSDK_OFFSET(0x18B1F420)
#define NAPRENDERENTITY_GET_PEROBJECTSHADOWFADETARGET_OFFSET UNITYSDK_OFFSET(0x18B1F460)
#define NAPRENDERENTITY_GET_PEROBJECTSHADOWRESOLVEALPHA_OFFSET UNITYSDK_OFFSET(0x18B1F600)
#define NAPRENDERENTITY_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x18B1D960)
#define NAPRENDERENTITY_GET_RAYCASTFORCULLINGSPHERE_OFFSET UNITYSDK_OFFSET(0x18B1F320)
#define NAPRENDERENTITY_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x18B1D940)
#define NAPRENDERENTITY_GET_SHADERUNIFORMPEROBJECTSHADOWDATA_OFFSET UNITYSDK_OFFSET(0x18B205F0)
#define NAPRENDERENTITY_GET_SORTPRIORITY_OFFSET UNITYSDK_OFFSET(0x18B1DCE0)
#define NAPRENDERENTITY_GET_USEBAKEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x18B1F480)
#define NAPRENDERENTITY_GET_USECUSTOMBLENDEDDIRECTIONALLIGHTSIZE_OFFSET UNITYSDK_OFFSET(0x18B1EEE0)
#define NAPRENDERENTITY_GET_USECUSTOMLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x18B1FC20)
#define NAPRENDERENTITY_GET_USEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x18B1F110)
#define NAPRENDERENTITY_GET_XAXIS_OFFSET UNITYSDK_OFFSET(0x18B1F500)
#define NAPRENDERENTITY_GET_YAXIS_OFFSET UNITYSDK_OFFSET(0x18B1F540)
#define NAPRENDERENTITY_GET_ZAXIS_OFFSET UNITYSDK_OFFSET(0x18B1F580)
#define NAPRENDERENTITY_GET_ZDISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x18B1DD00)
#define NAPRENDERENTITY_HASFLAG_OFFSET UNITYSDK_OFFSET(0x18B237D0)
#define NAPRENDERENTITY_LEGACYVISIBLECHECK_OFFSET UNITYSDK_OFFSET(0x18B212A0)
#define NAPRENDERENTITY_MATCAPTEXTURECHECKRESULT_OFFSET UNITYSDK_OFFSET(0x18B2B260)
#define NAPRENDERENTITY_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x18B2B780)
#define NAPRENDERENTITY_OVERRIDEMAINLIGHTPARAMS_OFFSET UNITYSDK_OFFSET(0x18B2EB70)
#define NAPRENDERENTITY_PUSHBONETRANSFORMSTONATIVE_OFFSET UNITYSDK_OFFSET(0x18B233B0)
#define NAPRENDERENTITY_REBINDARRAYPROPERTYBUFFER_OFFSET UNITYSDK_OFFSET(0x18B234C0)
#define NAPRENDERENTITY_REFRESHMATCAPDATA_OFFSET UNITYSDK_OFFSET(0x18B2D340)
#define NAPRENDERENTITY_REFRESHMATCAPVECTORARRAYPROPERTIES_OFFSET UNITYSDK_OFFSET(0x18B2F490)
#define NAPRENDERENTITY_REFRESHSTATEPERFRAME_OFFSET UNITYSDK_OFFSET(0x18B21350)
#define NAPRENDERENTITY_REFRESH_OFFSET UNITYSDK_OFFSET(0x18B2C3B0)
#define NAPRENDERENTITY_RELEASEMATCAPTEXTUREARRAY_OFFSET UNITYSDK_OFFSET(0x18B2B0B0)
#define NAPRENDERENTITY_RELEASETEXTUREARRAYLIST_OFFSET UNITYSDK_OFFSET(0x18B2AE90)
#define NAPRENDERENTITY_RELEASE_OFFSET UNITYSDK_OFFSET(0x18B2B880)
#define NAPRENDERENTITY_REMOVEINDICATEDLIGHT_OFFSET UNITYSDK_OFFSET(0x18B2E930)
#define NAPRENDERENTITY_RESET_OFFSET UNITYSDK_OFFSET(0x18B2B8F0)
#define NAPRENDERENTITY_REVERTOVERRIDENMAINLIGHTPARAMS_OFFSET UNITYSDK_OFFSET(0x18B2ED60)
#define NAPRENDERENTITY_SETFLAG_OFFSET UNITYSDK_OFFSET(0x18B23820)
#define NAPRENDERENTITY_SETHAIRSHADOWOFFSETS_OFFSET UNITYSDK_OFFSET(0x18B2DE70)
#define NAPRENDERENTITY_SETSHADOWDATABLOCK_OFFSET UNITYSDK_OFFSET(0x18B1F7D0)
#define NAPRENDERENTITY_SETSHADOWLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x18B1FE80)
#define NAPRENDERENTITY_SETSHADOWPROXYDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x18B2D780)
#define NAPRENDERENTITY_SETTRANSFORMGETTERS_OFFSET UNITYSDK_OFFSET(0x18B2D440)
#define NAPRENDERENTITY_SETUP_OFFSET UNITYSDK_OFFSET(0x18B239F0)
#define NAPRENDERENTITY_SET_BAKEDOBJECTSPACECULLINGSPHERE_OFFSET UNITYSDK_OFFSET(0x18B1F4B0)
#define NAPRENDERENTITY_SET_CACHEBOUNDSWHENSTAYS_OFFSET UNITYSDK_OFFSET(0x18B1F350)
#define NAPRENDERENTITY_SET_CACHEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x18B1F3C0)
#define NAPRENDERENTITY_SET_CACHEDLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x18B1F400)
#define NAPRENDERENTITY_SET_CLIPVERTICESUNDERCLIPPLANE_OFFSET UNITYSDK_OFFSET(0x18B1EB60)
#define NAPRENDERENTITY_SET_CUSTOMBLENDEDDIRECTIONALLIGHTSIZE_OFFSET UNITYSDK_OFFSET(0x18B1EFA0)
#define NAPRENDERENTITY_SET_DISABLESPHERECULLING_OFFSET UNITYSDK_OFFSET(0x18B1EC10)
#define NAPRENDERENTITY_SET_DISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x18B1F5F0)
#define NAPRENDERENTITY_SET_DONTOPTIMIZESHADOWPROXYBOUNDS_OFFSET UNITYSDK_OFFSET(0x18B20C90)
#define NAPRENDERENTITY_SET_ENTITYTYPE_OFFSET UNITYSDK_OFFSET(0x18B1EE30)
#define NAPRENDERENTITY_SET_FIXRED_OFFSET UNITYSDK_OFFSET(0x18B1F000)
#define NAPRENDERENTITY_SET_FIXSHADOWCOVERAGEOUTOFFRUSTUM_OFFSET UNITYSDK_OFFSET(0x18B1F0B0)
#define NAPRENDERENTITY_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x18B1E860)
#define NAPRENDERENTITY_SET_HASCHARACTERMATERIAL_OFFSET UNITYSDK_OFFSET(0x18B1E740)
#define NAPRENDERENTITY_SET_HASREGULARRENDERER_OFFSET UNITYSDK_OFFSET(0x18B1E440)
#define NAPRENDERENTITY_SET_HASVALIDMATERIAL_OFFSET UNITYSDK_OFFSET(0x18B1E7F0)
#define NAPRENDERENTITY_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x18B1E0A0)
#define NAPRENDERENTITY_SET_ISAVATARPARTICLEDIRTY_OFFSET UNITYSDK_OFFSET(0x18B20B70)
#define NAPRENDERENTITY_SET_ISCURFRAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x18B1E680)
#define NAPRENDERENTITY_SET_ISCUTSCENEMODE_OFFSET UNITYSDK_OFFSET(0x18B1E880)
#define NAPRENDERENTITY_SET_ISFIRSTTIMECALCULATERADIAN_OFFSET UNITYSDK_OFFSET(0x18B20C20)
#define NAPRENDERENTITY_SET_ISNAPCBBOUND_OFFSET UNITYSDK_OFFSET(0x18B1EAA0)
#define NAPRENDERENTITY_SET_ISVISIBLEINCURRENTCAM_OFFSET UNITYSDK_OFFSET(0x18B1E2E0)
#define NAPRENDERENTITY_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x18B1E390)
#define NAPRENDERENTITY_SET_LASTFRAMEPOSITION_OFFSET UNITYSDK_OFFSET(0x18B1F380)
#define NAPRENDERENTITY_SET_LIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x18B1F4E0)
#define NAPRENDERENTITY_SET_LODGROUPS_OFFSET UNITYSDK_OFFSET(0x18B1ECE0)
#define NAPRENDERENTITY_SET_MAINLIGHTPARAMSOVERRIDEN_OFFSET UNITYSDK_OFFSET(0x18B1ED40)
#define NAPRENDERENTITY_SET_OFFSETFORRENDERING_OFFSET UNITYSDK_OFFSET(0x18B1F5D0)
#define NAPRENDERENTITY_SET_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x18B1D930)
#define NAPRENDERENTITY_SET_OVERRIDENMAINLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x18B1EDB0)
#define NAPRENDERENTITY_SET_PEROBJECTSHADOWALPHA_OFFSET UNITYSDK_OFFSET(0x18B1F450)
#define NAPRENDERENTITY_SET_PEROBJECTSHADOWCULLRESULT_OFFSET UNITYSDK_OFFSET(0x18B1F430)
#define NAPRENDERENTITY_SET_PEROBJECTSHADOWFADETARGET_OFFSET UNITYSDK_OFFSET(0x18B1F470)
#define NAPRENDERENTITY_SET_PEROBJECTSHADOWRESOLVEALPHA_OFFSET UNITYSDK_OFFSET(0x18B1F6D0)
#define NAPRENDERENTITY_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x18B1D970)
#define NAPRENDERENTITY_SET_ROOT_OFFSET UNITYSDK_OFFSET(0x18B1D950)
#define NAPRENDERENTITY_SET_SHADERUNIFORMPEROBJECTSHADOWDATA_OFFSET UNITYSDK_OFFSET(0x18B20660)
#define NAPRENDERENTITY_SET_SHADERUNIFORMPEROBJECTSHADOWRESOLVEST_OFFSET UNITYSDK_OFFSET(0x18B20960)
#define NAPRENDERENTITY_SET_SHADERUNIFORMPEROBJECTSHADOWUVMATRIX_OFFSET UNITYSDK_OFFSET(0x18B20790)
#define NAPRENDERENTITY_SET_SHADERUNIFORMRECEIVESHADOW_OFFSET UNITYSDK_OFFSET(0x18B206D0)
#define NAPRENDERENTITY_SET_SORTPRIORITY_OFFSET UNITYSDK_OFFSET(0x18B1DCF0)
#define NAPRENDERENTITY_SET_USEBAKEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x18B1F490)
#define NAPRENDERENTITY_SET_USECUSTOMBLENDEDDIRECTIONALLIGHTSIZE_OFFSET UNITYSDK_OFFSET(0x18B1EF30)
#define NAPRENDERENTITY_SET_USEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x18B1F160)
#define NAPRENDERENTITY_SET_XAXIS_OFFSET UNITYSDK_OFFSET(0x18B1F520)
#define NAPRENDERENTITY_SET_YAXIS_OFFSET UNITYSDK_OFFSET(0x18B1F560)
#define NAPRENDERENTITY_SET_ZAXIS_OFFSET UNITYSDK_OFFSET(0x18B1F5A0)
#define NAPRENDERENTITY_SET_ZDISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x18B1DEB0)
#define NAPRENDERENTITY_UPDATEBONETRANSFORMSFORFRAME_OFFSET UNITYSDK_OFFSET(0x18B221F0)
#define NAPRENDERENTITY_UPDATEVISIBILITY_OFFSET UNITYSDK_OFFSET(0x18B20CA0)
#define NAPRENDERENTITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x18B2F750)
#define NAPRENDERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18B200E0)

inline static constexpr unsigned int NapRenderEntity_TypeDefinitionIndex = 29059;
...
public:
	...
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23530);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CopyTexture()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23538);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_LayerAndFrustumCulling()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23540);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitLodGroup1()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23548);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitMaterialParticleArray()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23550);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectLayer()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23558);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_SetFlags()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23560);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CountMaterials()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23568);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTransformsFromFunc()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23570);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitMatCapIDArray()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23578);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_ApplyMaterialProperties()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23580);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTransformsCommon()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23588);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CheckMatCapEnabled()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23590);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectFaceRendererNotSkinned()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23598);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_FetchParamsFromMonoRenderEntity()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x235A0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_Setup()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x235A8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CreateTextureArray()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x235B0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CalculateCameraVisibility()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x235B8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_Part2()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x235C0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_RefreshStatePerFrame()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x235C8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_UpdateRamp()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x235D0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_UpdateDistanceToCamera()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x235D8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTexture()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x235E0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CreateMatCapTextureArray()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x235E8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetHeadBoneTransform()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x235F0);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectBounds()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x235F8);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitLodGroup2()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23600);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTransformsFromJob()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23608);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CharacterGI()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23610);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CheckMaterialValid()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23618);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_SetShadowProxyAlphas()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23620);
	}
	static ::System::Collections::Generic::List_1<::NapRenderEntity_MatCapInfo>** StaticGet_matCapInfos()
	{
		return (::System::Collections::Generic::List_1<::NapRenderEntity_MatCapInfo>**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23628);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_Release()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23630);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectRenderingLayer()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23638);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_InitNapRenderer()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23640);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CollectMapCapInfo()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23648);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_GetTransforms()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23650);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_CalculateCullingSphere()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapRenderEntity_TypeDefinitionIndex)->GetStaticField(0x23658);
	}
