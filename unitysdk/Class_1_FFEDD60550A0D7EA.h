...
#define CLASS_1_FFEDD60550A0D7EA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x819FF70)
#define CLASS_1_FFEDD60550A0D7EA_METHOD_1_B556EADFE34BD60F_OFFSET UNITYSDK_OFFSET(0x81A0360)
#define CLASS_1_FFEDD60550A0D7EA_METHOD_1_DCAAE1005C7B2A2E_OFFSET UNITYSDK_OFFSET(0x81A00F0)
#define CLASS_1_FFEDD60550A0D7EA__CTOR_OFFSET UNITYSDK_OFFSET(0x819FE40)

inline static constexpr unsigned int Class_1_FFEDD60550A0D7EA_TypeDefinitionIndex = 66113;

class Class_1_FFEDD60550A0D7EA : public ::System::Object
{
public:
	::MoleMole::Config::MapIconTrait* Field_1_1; // 0x10
	::Class_2_126E26F0DF7D8CF7* Field_1_0; // 0x18
	::Class_2_000597E145D7A42A<::System::Boolean>* Field_1_3; // 0x20
	::Class_2_75527B5277EE1A90<::System::Boolean>* Field_1_4; // 0x28
	::Foundation::ViewObject::GroupMemberIdentifier Field_1_2; // 0x30
