...
#define INFLUXDB_ARGUMENTS_CHECKDURATION_OFFSET UNITYSDK_OFFSET(0x1AA5EEC0)
#define INFLUXDB_ARGUMENTS_CHECKNONEMPTYSTRING_OFFSET UNITYSDK_OFFSET(0x1AA5EDF0)
#define INFLUXDB_ARGUMENTS_CHECKNOTNEGATIVENUMBER_OFFSET UNITYSDK_OFFSET(0x1AA5F0F0)
#define INFLUXDB_ARGUMENTS_CHECKNOTNULL_OFFSET UNITYSDK_OFFSET(0x1AA5F1C0)
#define INFLUXDB_ARGUMENTS_CHECKPOSITIVENUMBER_OFFSET UNITYSDK_OFFSET(0x1AA5F020)

namespace InfluxDB
{
	inline static constexpr unsigned int Arguments_TypeDefinitionIndex = 7778;
