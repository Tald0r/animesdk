...
#define INFLUXDB_POINTDATA_BUILDER_FIELD_1_OFFSET UNITYSDK_OFFSET(0x1AB41F30)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_2_OFFSET UNITYSDK_OFFSET(0x1AB41FD0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_3_OFFSET UNITYSDK_OFFSET(0x1AB42070)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_4_OFFSET UNITYSDK_OFFSET(0x1AB42110)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_5_OFFSET UNITYSDK_OFFSET(0x1AB421B0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_6_OFFSET UNITYSDK_OFFSET(0x1AB42250)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_7_OFFSET UNITYSDK_OFFSET(0x1AB422F0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_8_OFFSET UNITYSDK_OFFSET(0x1AB42370)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_9_OFFSET UNITYSDK_OFFSET(0x1AB42410)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_OFFSET UNITYSDK_OFFSET(0x1AB41D80)
#define INFLUXDB_POINTDATA_BUILDER_HASFIELDS_OFFSET UNITYSDK_OFFSET(0x1AB42860)
#define INFLUXDB_POINTDATA_BUILDER_MEASUREMENT_OFFSET UNITYSDK_OFFSET(0x1AB41B50)
#define INFLUXDB_POINTDATA_BUILDER_PUTFIELD_OFFSET UNITYSDK_OFFSET(0x1AB41E20)
#define INFLUXDB_POINTDATA_BUILDER_TAG_OFFSET UNITYSDK_OFFSET(0x1AB41BF0)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_1_OFFSET UNITYSDK_OFFSET(0x1AB42580)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_2_OFFSET UNITYSDK_OFFSET(0x1AB42660)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_3_OFFSET UNITYSDK_OFFSET(0x1AB42780)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1AB42490)
#define INFLUXDB_POINTDATA_BUILDER_TOPOINTDATA_OFFSET UNITYSDK_OFFSET(0x1AB428E0)
#define INFLUXDB_POINTDATA_BUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB41A20)

namespace InfluxDB
{
	inline static constexpr unsigned int PointData_Builder_TypeDefinitionIndex = 7863;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* _tags; // 0x20
		::System::Nullable_1<::System::Numerics::BigInteger> _time; // 0x28
