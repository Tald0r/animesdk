...
#define INFLUXDB_POINTDATA_BUILDER_FIELD_1_OFFSET UNITYSDK_OFFSET(0x1B0F95F0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_2_OFFSET UNITYSDK_OFFSET(0x1B0F9690)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_3_OFFSET UNITYSDK_OFFSET(0x1B0F9730)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_4_OFFSET UNITYSDK_OFFSET(0x1B0F97D0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_5_OFFSET UNITYSDK_OFFSET(0x1B0F9870)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_6_OFFSET UNITYSDK_OFFSET(0x1B0F9910)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_7_OFFSET UNITYSDK_OFFSET(0x1B0F99B0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_8_OFFSET UNITYSDK_OFFSET(0x1B0F9A30)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_9_OFFSET UNITYSDK_OFFSET(0x1B0F9AD0)
#define INFLUXDB_POINTDATA_BUILDER_FIELD_OFFSET UNITYSDK_OFFSET(0x1B0F9450)
#define INFLUXDB_POINTDATA_BUILDER_HASFIELDS_OFFSET UNITYSDK_OFFSET(0x1B0F9F20)
#define INFLUXDB_POINTDATA_BUILDER_MEASUREMENT_OFFSET UNITYSDK_OFFSET(0x1B0F9230)
#define INFLUXDB_POINTDATA_BUILDER_PUTFIELD_OFFSET UNITYSDK_OFFSET(0x1B0F94F0)
#define INFLUXDB_POINTDATA_BUILDER_TAG_OFFSET UNITYSDK_OFFSET(0x1B0F92D0)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_1_OFFSET UNITYSDK_OFFSET(0x1B0F9C40)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_2_OFFSET UNITYSDK_OFFSET(0x1B0F9D20)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_3_OFFSET UNITYSDK_OFFSET(0x1B0F9E40)
#define INFLUXDB_POINTDATA_BUILDER_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1B0F9B50)
#define INFLUXDB_POINTDATA_BUILDER_TOPOINTDATA_OFFSET UNITYSDK_OFFSET(0x1B0F9FA0)
#define INFLUXDB_POINTDATA_BUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F9100)

namespace InfluxDB
{
	inline static constexpr unsigned int PointData_Builder_TypeDefinitionIndex = 7726;

	class PointData_Builder : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* _tags; // 0x10
