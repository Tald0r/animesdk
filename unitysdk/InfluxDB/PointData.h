...
#define INFLUXDB_POINTDATA_APPENDFIELDS_OFFSET UNITYSDK_OFFSET(0x19F10D20)
#define INFLUXDB_POINTDATA_APPENDTAGS_OFFSET UNITYSDK_OFFSET(0x19F10960)
#define INFLUXDB_POINTDATA_APPENDTIME_OFFSET UNITYSDK_OFFSET(0x19F11600)
#define INFLUXDB_POINTDATA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19F119F0)
#define INFLUXDB_POINTDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x19F11920)
#define INFLUXDB_POINTDATA_ESCAPEKEY_OFFSET UNITYSDK_OFFSET(0x19F10500)
#define INFLUXDB_POINTDATA_ESCAPEVALUE_OFFSET UNITYSDK_OFFSET(0x19F117F0)
#define INFLUXDB_POINTDATA_FIELD_1_OFFSET UNITYSDK_OFFSET(0x19F0F410)
#define INFLUXDB_POINTDATA_FIELD_2_OFFSET UNITYSDK_OFFSET(0x19F0F4B0)
#define INFLUXDB_POINTDATA_FIELD_3_OFFSET UNITYSDK_OFFSET(0x19F0F550)
#define INFLUXDB_POINTDATA_FIELD_4_OFFSET UNITYSDK_OFFSET(0x19F0F5F0)
#define INFLUXDB_POINTDATA_FIELD_5_OFFSET UNITYSDK_OFFSET(0x19F0F690)
#define INFLUXDB_POINTDATA_FIELD_6_OFFSET UNITYSDK_OFFSET(0x19F0F730)
#define INFLUXDB_POINTDATA_FIELD_7_OFFSET UNITYSDK_OFFSET(0x19F0F7D0)
#define INFLUXDB_POINTDATA_FIELD_8_OFFSET UNITYSDK_OFFSET(0x19F0F850)
#define INFLUXDB_POINTDATA_FIELD_9_OFFSET UNITYSDK_OFFSET(0x19F0F8F0)
#define INFLUXDB_POINTDATA_FIELD_OFFSET UNITYSDK_OFFSET(0x19F0F110)
#define INFLUXDB_POINTDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19F11ED0)
#define INFLUXDB_POINTDATA_HASFIELDS_OFFSET UNITYSDK_OFFSET(0x19F102F0)
#define INFLUXDB_POINTDATA_ISNOTDEFINED_OFFSET UNITYSDK_OFFSET(0x19F11740)
#define INFLUXDB_POINTDATA_MEASUREMENT_OFFSET UNITYSDK_OFFSET(0x19F0EC80)
#define INFLUXDB_POINTDATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19F11E00)
#define INFLUXDB_POINTDATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19F125C0)
#define INFLUXDB_POINTDATA_PUTFIELD_OFFSET UNITYSDK_OFFSET(0x19F0F1B0)
#define INFLUXDB_POINTDATA_TAG_OFFSET UNITYSDK_OFFSET(0x19F0EE80)
#define INFLUXDB_POINTDATA_TIMESPANTOBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x19F0FDD0)
#define INFLUXDB_POINTDATA_TIMESTAMP_1_OFFSET UNITYSDK_OFFSET(0x19F0FBA0)
#define INFLUXDB_POINTDATA_TIMESTAMP_2_OFFSET UNITYSDK_OFFSET(0x19F10020)
#define INFLUXDB_POINTDATA_TIMESTAMP_3_OFFSET UNITYSDK_OFFSET(0x19F10210)
#define INFLUXDB_POINTDATA_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x19F0F970)
#define INFLUXDB_POINTDATA_TOLINEPROTOCOL_OFFSET UNITYSDK_OFFSET(0x19F103E0)
#define INFLUXDB_POINTDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F12670)
#define INFLUXDB_POINTDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19F0ED20)
#define INFLUXDB_POINTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19F0EB50)
#define INFLUXDB_POINTDATA___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x19F126C0)
#define INFLUXDB_POINTDATA___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19F126D0)

namespace InfluxDB
{
	inline static constexpr unsigned int PointData_TypeDefinitionIndex = 7862;
	...
	public:
		...
		{
			return (::System::DateTime*)Il2CppClass::FromTypeDefinitionIndex(PointData_TypeDefinitionIndex)->GetStaticField(0x36F0);
		}
