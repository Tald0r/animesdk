...
#define INFLUXDB_POINTDATA_APPENDFIELDS_OFFSET UNITYSDK_OFFSET(0x1A67C1A0)
#define INFLUXDB_POINTDATA_APPENDTAGS_OFFSET UNITYSDK_OFFSET(0x1A67BDE0)
#define INFLUXDB_POINTDATA_APPENDTIME_OFFSET UNITYSDK_OFFSET(0x1A67CA70)
#define INFLUXDB_POINTDATA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A67CE60)
#define INFLUXDB_POINTDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A67CD90)
#define INFLUXDB_POINTDATA_ESCAPEKEY_OFFSET UNITYSDK_OFFSET(0x1A67B980)
#define INFLUXDB_POINTDATA_ESCAPEVALUE_OFFSET UNITYSDK_OFFSET(0x1A67CC60)
#define INFLUXDB_POINTDATA_FIELD_1_OFFSET UNITYSDK_OFFSET(0x1A67A890)
#define INFLUXDB_POINTDATA_FIELD_2_OFFSET UNITYSDK_OFFSET(0x1A67A930)
#define INFLUXDB_POINTDATA_FIELD_3_OFFSET UNITYSDK_OFFSET(0x1A67A9D0)
#define INFLUXDB_POINTDATA_FIELD_4_OFFSET UNITYSDK_OFFSET(0x1A67AA70)
#define INFLUXDB_POINTDATA_FIELD_5_OFFSET UNITYSDK_OFFSET(0x1A67AB10)
#define INFLUXDB_POINTDATA_FIELD_6_OFFSET UNITYSDK_OFFSET(0x1A67ABB0)
#define INFLUXDB_POINTDATA_FIELD_7_OFFSET UNITYSDK_OFFSET(0x1A67AC50)
#define INFLUXDB_POINTDATA_FIELD_8_OFFSET UNITYSDK_OFFSET(0x1A67ACD0)
#define INFLUXDB_POINTDATA_FIELD_9_OFFSET UNITYSDK_OFFSET(0x1A67AD70)
#define INFLUXDB_POINTDATA_FIELD_OFFSET UNITYSDK_OFFSET(0x1A67A590)
#define INFLUXDB_POINTDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A67D340)
#define INFLUXDB_POINTDATA_HASFIELDS_OFFSET UNITYSDK_OFFSET(0x1A67B770)
#define INFLUXDB_POINTDATA_ISNOTDEFINED_OFFSET UNITYSDK_OFFSET(0x1A67CBB0)
#define INFLUXDB_POINTDATA_MEASUREMENT_OFFSET UNITYSDK_OFFSET(0x1A67A0F0)
#define INFLUXDB_POINTDATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A67D270)
#define INFLUXDB_POINTDATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A67DA30)
#define INFLUXDB_POINTDATA_PUTFIELD_OFFSET UNITYSDK_OFFSET(0x1A67A630)
#define INFLUXDB_POINTDATA_TAG_OFFSET UNITYSDK_OFFSET(0x1A67A2F0)
#define INFLUXDB_POINTDATA_TIMESPANTOBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1A67B250)
#define INFLUXDB_POINTDATA_TIMESTAMP_1_OFFSET UNITYSDK_OFFSET(0x1A67B020)
#define INFLUXDB_POINTDATA_TIMESTAMP_2_OFFSET UNITYSDK_OFFSET(0x1A67B4A0)
#define INFLUXDB_POINTDATA_TIMESTAMP_3_OFFSET UNITYSDK_OFFSET(0x1A67B690)
#define INFLUXDB_POINTDATA_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1A67ADF0)
#define INFLUXDB_POINTDATA_TOLINEPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1A67B860)
#define INFLUXDB_POINTDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A67DAE0)
#define INFLUXDB_POINTDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A67A190)
#define INFLUXDB_POINTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A679FC0)
#define INFLUXDB_POINTDATA___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A67DB30)
#define INFLUXDB_POINTDATA___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A67DB40)

namespace InfluxDB
{
	inline static constexpr unsigned int PointData_TypeDefinitionIndex = 7725;
	...
	public:
		...
		{
			return (::System::DateTime*)Il2CppClass::FromTypeDefinitionIndex(PointData_TypeDefinitionIndex)->GetStaticField(0x3700);
		}
		::System::Collections::Generic::SortedDictionary_2<::System::String*, ::System::String*>* _tags; // 0x10
		::System::String* _measurementName; // 0x18
