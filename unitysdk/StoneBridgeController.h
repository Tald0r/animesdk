...
#define STONEBRIDGECONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18DF3420)
#define STONEBRIDGECONTROLLER_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x18DF3FC0)
#define STONEBRIDGECONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18DF3160)
#define STONEBRIDGECONTROLLER_ONLOCALAVATARCHANGE_OFFSET UNITYSDK_OFFSET(0x18DF3910)
#define STONEBRIDGECONTROLLER_SUBSCRIBEAVATARCHANGE_OFFSET UNITYSDK_OFFSET(0x18DF3740)
#define STONEBRIDGECONTROLLER_UNSUBSCRIBEAVATARCHANGE_OFFSET UNITYSDK_OFFSET(0x18DF3570)
#define STONEBRIDGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18DF3A80)
#define STONEBRIDGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF4590)

inline static constexpr unsigned int StoneBridgeController_TypeDefinitionIndex = 64622;
...
public:
	...
	::Class_3_F35B080B137ECC46* charModelComp; // 0xC0
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + STONEBRIDGECONTROLLER_ONDRAWGIZMOS_OFFSET))(this);
	}
};
