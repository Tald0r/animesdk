...
#define STONEBRIDGECONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x10BB0290)
#define STONEBRIDGECONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10BAFFD0)
#define STONEBRIDGECONTROLLER_ONLOCALAVATARCHANGE_OFFSET UNITYSDK_OFFSET(0x10BB0780)
#define STONEBRIDGECONTROLLER_SUBSCRIBEAVATARCHANGE_OFFSET UNITYSDK_OFFSET(0x10BB05B0)
#define STONEBRIDGECONTROLLER_UNSUBSCRIBEAVATARCHANGE_OFFSET UNITYSDK_OFFSET(0x10BB03E0)
#define STONEBRIDGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x10BB08E0)
#define STONEBRIDGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x10BB0E20)

inline static constexpr unsigned int StoneBridgeController_TypeDefinitionIndex = 38881;
