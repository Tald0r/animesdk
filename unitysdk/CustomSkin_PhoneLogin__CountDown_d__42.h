...
#define CUSTOMSKIN_PHONELOGIN__COUNTDOWN_D__42_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x84FFEC0)
#define CUSTOMSKIN_PHONELOGIN__COUNTDOWN_D__42_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x85000A0)
#define CUSTOMSKIN_PHONELOGIN__COUNTDOWN_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8500100)
#define CUSTOMSKIN_PHONELOGIN__COUNTDOWN_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x85000B0)
#define CUSTOMSKIN_PHONELOGIN__COUNTDOWN_D__42_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x84FFEB0)
#define CUSTOMSKIN_PHONELOGIN__COUNTDOWN_D__42__CTOR_OFFSET UNITYSDK_OFFSET(0x84FFEA0)

inline static constexpr unsigned int CustomSkin_PhoneLogin__CountDown_d__42_TypeDefinitionIndex = 52637;
