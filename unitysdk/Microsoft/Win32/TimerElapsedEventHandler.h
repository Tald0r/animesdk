...
#define MICROSOFT_WIN32_TIMERELAPSEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19232ED0)
#define MICROSOFT_WIN32_TIMERELAPSEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19232F10)
#define MICROSOFT_WIN32_TIMERELAPSEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19232E90)
#define MICROSOFT_WIN32_TIMERELAPSEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19232E50)
