...
#define MICROSOFT_WIN32_NATIVEMETHODS_CLOSEPROCESS_OFFSET UNITYSDK_OFFSET(0x1822A0D0)
#define MICROSOFT_WIN32_NATIVEMETHODS_DUPLICATEHANDLE_1_OFFSET UNITYSDK_OFFSET(0x18229A00)
#define MICROSOFT_WIN32_NATIVEMETHODS_DUPLICATEHANDLE_OFFSET UNITYSDK_OFFSET(0x18229880)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETCURRENTPROCESSID_OFFSET UNITYSDK_OFFSET(0x18229F60)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETCURRENTPROCESS_OFFSET UNITYSDK_OFFSET(0x18229AF0)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETEXITCODEPROCESS_1_OFFSET UNITYSDK_OFFSET(0x18229B20)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETEXITCODEPROCESS_OFFSET UNITYSDK_OFFSET(0x18229B00)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPRIORITYCLASS_1_OFFSET UNITYSDK_OFFSET(0x18229F80)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPRIORITYCLASS_OFFSET UNITYSDK_OFFSET(0x18229F70)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSTIMES_1_OFFSET UNITYSDK_OFFSET(0x18229EC0)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSTIMES_OFFSET UNITYSDK_OFFSET(0x18229EB0)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSWORKINGSETSIZE_1_OFFSET UNITYSDK_OFFSET(0x18229D60)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSWORKINGSETSIZE_OFFSET UNITYSDK_OFFSET(0x18229D50)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPRIORITYCLASS_1_OFFSET UNITYSDK_OFFSET(0x1822A030)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPRIORITYCLASS_OFFSET UNITYSDK_OFFSET(0x1822A020)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPROCESSWORKINGSETSIZE_1_OFFSET UNITYSDK_OFFSET(0x18229E10)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPROCESSWORKINGSETSIZE_OFFSET UNITYSDK_OFFSET(0x18229E00)
#define MICROSOFT_WIN32_NATIVEMETHODS_TERMINATEPROCESS_1_OFFSET UNITYSDK_OFFSET(0x18229C00)
#define MICROSOFT_WIN32_NATIVEMETHODS_TERMINATEPROCESS_OFFSET UNITYSDK_OFFSET(0x18229BF0)
#define MICROSOFT_WIN32_NATIVEMETHODS_WAITFORINPUTIDLE_1_OFFSET UNITYSDK_OFFSET(0x18229CB0)
#define MICROSOFT_WIN32_NATIVEMETHODS_WAITFORINPUTIDLE_OFFSET UNITYSDK_OFFSET(0x18229CA0)
