...
#define MICROSOFT_WIN32_NATIVEMETHODS_CLOSEPROCESS_OFFSET UNITYSDK_OFFSET(0x187C4480)
#define MICROSOFT_WIN32_NATIVEMETHODS_DUPLICATEHANDLE_1_OFFSET UNITYSDK_OFFSET(0x187C3DB0)
#define MICROSOFT_WIN32_NATIVEMETHODS_DUPLICATEHANDLE_OFFSET UNITYSDK_OFFSET(0x187C3C30)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETCURRENTPROCESSID_OFFSET UNITYSDK_OFFSET(0x187C4310)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETCURRENTPROCESS_OFFSET UNITYSDK_OFFSET(0x187C3EA0)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETEXITCODEPROCESS_1_OFFSET UNITYSDK_OFFSET(0x187C3ED0)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETEXITCODEPROCESS_OFFSET UNITYSDK_OFFSET(0x187C3EB0)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPRIORITYCLASS_1_OFFSET UNITYSDK_OFFSET(0x187C4330)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPRIORITYCLASS_OFFSET UNITYSDK_OFFSET(0x187C4320)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSTIMES_1_OFFSET UNITYSDK_OFFSET(0x187C4270)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSTIMES_OFFSET UNITYSDK_OFFSET(0x187C4260)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSWORKINGSETSIZE_1_OFFSET UNITYSDK_OFFSET(0x187C4110)
#define MICROSOFT_WIN32_NATIVEMETHODS_GETPROCESSWORKINGSETSIZE_OFFSET UNITYSDK_OFFSET(0x187C4100)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPRIORITYCLASS_1_OFFSET UNITYSDK_OFFSET(0x187C43E0)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPRIORITYCLASS_OFFSET UNITYSDK_OFFSET(0x187C43D0)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPROCESSWORKINGSETSIZE_1_OFFSET UNITYSDK_OFFSET(0x187C41C0)
#define MICROSOFT_WIN32_NATIVEMETHODS_SETPROCESSWORKINGSETSIZE_OFFSET UNITYSDK_OFFSET(0x187C41B0)
#define MICROSOFT_WIN32_NATIVEMETHODS_TERMINATEPROCESS_1_OFFSET UNITYSDK_OFFSET(0x187C3FB0)
#define MICROSOFT_WIN32_NATIVEMETHODS_TERMINATEPROCESS_OFFSET UNITYSDK_OFFSET(0x187C3FA0)
#define MICROSOFT_WIN32_NATIVEMETHODS_WAITFORINPUTIDLE_1_OFFSET UNITYSDK_OFFSET(0x187C4060)
#define MICROSOFT_WIN32_NATIVEMETHODS_WAITFORINPUTIDLE_OFFSET UNITYSDK_OFFSET(0x187C4050)
