...
#define MICROSOFT_WIN32_SESSIONENDINGEVENTARGS_GET_CANCEL_OFFSET UNITYSDK_OFFSET(0x187C4560)
#define MICROSOFT_WIN32_SESSIONENDINGEVENTARGS_GET_REASON_OFFSET UNITYSDK_OFFSET(0x187C45E0)
#define MICROSOFT_WIN32_SESSIONENDINGEVENTARGS_SET_CANCEL_OFFSET UNITYSDK_OFFSET(0x187C45A0)
#define MICROSOFT_WIN32_SESSIONENDINGEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x187C4520)
