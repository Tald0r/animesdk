...
#define MICROSOFT_WIN32_SESSIONENDINGEVENTARGS_GET_CANCEL_OFFSET UNITYSDK_OFFSET(0x1822A1B0)
#define MICROSOFT_WIN32_SESSIONENDINGEVENTARGS_GET_REASON_OFFSET UNITYSDK_OFFSET(0x1822A230)
#define MICROSOFT_WIN32_SESSIONENDINGEVENTARGS_SET_CANCEL_OFFSET UNITYSDK_OFFSET(0x1822A1F0)
#define MICROSOFT_WIN32_SESSIONENDINGEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1822A170)
