...
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_CLOSE_OFFSET UNITYSDK_OFFSET(0x1857B1E0)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_CREATESUBKEY_1_OFFSET UNITYSDK_OFFSET(0x1857B370)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_CREATESUBKEY_OFFSET UNITYSDK_OFFSET(0x1857B150)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_FLUSH_OFFSET UNITYSDK_OFFSET(0x1857B170)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_GETHANDLE_OFFSET UNITYSDK_OFFSET(0x1857B490)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_GETSUBKEYNAMES_OFFSET UNITYSDK_OFFSET(0x1857B2E0)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1857B240)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_ISWELLKNOWNKEY_OFFSET UNITYSDK_OFFSET(0x1857AC90)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_OPENSUBKEY_OFFSET UNITYSDK_OFFSET(0x1857B080)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1857B350)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_TOUNIX_OFFSET UNITYSDK_OFFSET(0x1857AA70)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI__CTOR_OFFSET UNITYSDK_OFFSET(0x1857B4E0)
