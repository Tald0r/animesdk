...
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_CLOSE_OFFSET UNITYSDK_OFFSET(0x17F46FC0)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_CREATESUBKEY_1_OFFSET UNITYSDK_OFFSET(0x17F47150)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_CREATESUBKEY_OFFSET UNITYSDK_OFFSET(0x17F46F30)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_FLUSH_OFFSET UNITYSDK_OFFSET(0x17F46F50)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_GETHANDLE_OFFSET UNITYSDK_OFFSET(0x17F47270)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_GETSUBKEYNAMES_OFFSET UNITYSDK_OFFSET(0x17F470C0)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_GETVALUE_OFFSET UNITYSDK_OFFSET(0x17F47020)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_ISWELLKNOWNKEY_OFFSET UNITYSDK_OFFSET(0x17F46A70)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_OPENSUBKEY_OFFSET UNITYSDK_OFFSET(0x17F46E60)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17F47130)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI_TOUNIX_OFFSET UNITYSDK_OFFSET(0x17F46850)
#define MICROSOFT_WIN32_UNIXREGISTRYAPI__CTOR_OFFSET UNITYSDK_OFFSET(0x17F472C0)
