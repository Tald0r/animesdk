...
#define MICROSOFT_WIN32_SAFEHANDLES_SAFEREGISTRYHANDLE_RELEASEHANDLE_OFFSET UNITYSDK_OFFSET(0x19846BB0)
#define MICROSOFT_WIN32_SAFEHANDLES_SAFEREGISTRYHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19846B40)
#define MICROSOFT_WIN32_SAFEHANDLES_SAFEREGISTRYHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19846B20)
