...
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_CLOSE_OFFSET UNITYSDK_OFFSET(0x19DC1C20)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_COMBINENAME_OFFSET UNITYSDK_OFFSET(0x19DC1AF0)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_FLUSH_OFFSET UNITYSDK_OFFSET(0x19DC1B20)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_GENERATEEXCEPTION_OFFSET UNITYSDK_OFFSET(0x19DC1560)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_GETBINARYVALUE_OFFSET UNITYSDK_OFFSET(0x19DC16E0)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_GETHANDLE_OFFSET UNITYSDK_OFFSET(0x19DC0A60)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_GETSUBKEYNAMES_OFFSET UNITYSDK_OFFSET(0x19DC1D60)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_GETVALUE_OFFSET UNITYSDK_OFFSET(0x19DC0B00)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_ISHANDLEVALID_OFFSET UNITYSDK_OFFSET(0x19DC0AE0)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_OPENSUBKEY_OFFSET UNITYSDK_OFFSET(0x19DC1930)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGCLOSEKEY_OFFSET UNITYSDK_OFFSET(0x19DBFE20)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGENUMKEYEX_OFFSET UNITYSDK_OFFSET(0x19DBFFD0)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGFLUSHKEY_OFFSET UNITYSDK_OFFSET(0x19DBFEA0)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGOPENKEYEX_OFFSET UNITYSDK_OFFSET(0x19DBFF20)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGQUERYINFOKEY_OFFSET UNITYSDK_OFFSET(0x19DC0730)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGQUERYVALUEEX_1_OFFSET UNITYSDK_OFFSET(0x19DC0350)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGQUERYVALUEEX_2_OFFSET UNITYSDK_OFFSET(0x19DC0590)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGQUERYVALUEEX_3_OFFSET UNITYSDK_OFFSET(0x19DC0660)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_REGQUERYVALUEEX_OFFSET UNITYSDK_OFFSET(0x19DC0280)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_SUBKEYCOUNT_OFFSET UNITYSDK_OFFSET(0x19DC17C0)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19DC2010)
#define MICROSOFT_WIN32_WIN32REGISTRYAPI__CTOR_OFFSET UNITYSDK_OFFSET(0x19DBEDF0)
