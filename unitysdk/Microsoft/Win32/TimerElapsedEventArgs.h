...
#define MICROSOFT_WIN32_TIMERELAPSEDEVENTARGS_GET_TIMERID_OFFSET UNITYSDK_OFFSET(0x1A32D7B0)
#define MICROSOFT_WIN32_TIMERELAPSEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A32D770)
