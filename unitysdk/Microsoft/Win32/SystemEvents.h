...
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_DISPLAYSETTINGSCHANGED_OFFSET UNITYSDK_OFFSET(0x188CEBE0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_DISPLAYSETTINGSCHANGING_OFFSET UNITYSDK_OFFSET(0x188CEC60)
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_EVENTSTHREADSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x188CECE0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_INSTALLEDFONTSCHANGED_OFFSET UNITYSDK_OFFSET(0x188CED60)
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_LOWMEMORY_OFFSET UNITYSDK_OFFSET(0x188CEDE0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_PALETTECHANGED_OFFSET UNITYSDK_OFFSET(0x188CEE60)
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_POWERMODECHANGED_OFFSET UNITYSDK_OFFSET(0x188CEEE0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_SESSIONENDED_OFFSET UNITYSDK_OFFSET(0x188CEF60)
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_SESSIONENDING_OFFSET UNITYSDK_OFFSET(0x188CEFE0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_SESSIONSWITCH_OFFSET UNITYSDK_OFFSET(0x188CF060)
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_TIMECHANGED_OFFSET UNITYSDK_OFFSET(0x188CF0E0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_TIMERELAPSED_OFFSET UNITYSDK_OFFSET(0x188CF160)
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_USERPREFERENCECHANGED_OFFSET UNITYSDK_OFFSET(0x188CF1E0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_ADD_USERPREFERENCECHANGING_OFFSET UNITYSDK_OFFSET(0x188CF260)
#define MICROSOFT_WIN32_SYSTEMEVENTS_CREATETIMER_OFFSET UNITYSDK_OFFSET(0x188CF2E0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_INVOKEONEVENTSTHREAD_OFFSET UNITYSDK_OFFSET(0x188CF320)
#define MICROSOFT_WIN32_SYSTEMEVENTS_KILLTIMER_OFFSET UNITYSDK_OFFSET(0x188CF360)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_DISPLAYSETTINGSCHANGED_OFFSET UNITYSDK_OFFSET(0x188CEC20)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_DISPLAYSETTINGSCHANGING_OFFSET UNITYSDK_OFFSET(0x188CECA0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_EVENTSTHREADSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x188CED20)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_INSTALLEDFONTSCHANGED_OFFSET UNITYSDK_OFFSET(0x188CEDA0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_LOWMEMORY_OFFSET UNITYSDK_OFFSET(0x188CEE20)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_PALETTECHANGED_OFFSET UNITYSDK_OFFSET(0x188CEEA0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_POWERMODECHANGED_OFFSET UNITYSDK_OFFSET(0x188CEF20)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_SESSIONENDED_OFFSET UNITYSDK_OFFSET(0x188CEFA0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_SESSIONENDING_OFFSET UNITYSDK_OFFSET(0x188CF020)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_SESSIONSWITCH_OFFSET UNITYSDK_OFFSET(0x188CF0A0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_TIMECHANGED_OFFSET UNITYSDK_OFFSET(0x188CF120)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_TIMERELAPSED_OFFSET UNITYSDK_OFFSET(0x188CF1A0)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_USERPREFERENCECHANGED_OFFSET UNITYSDK_OFFSET(0x188CF220)
#define MICROSOFT_WIN32_SYSTEMEVENTS_REMOVE_USERPREFERENCECHANGING_OFFSET UNITYSDK_OFFSET(0x188CF2A0)
#define MICROSOFT_WIN32_SYSTEMEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x188CEBA0)
