...
#define MICROSOFT_WIN32_SESSIONSWITCHEVENTARGS_GET_REASON_OFFSET UNITYSDK_OFFSET(0x191A92F0)
#define MICROSOFT_WIN32_SESSIONSWITCHEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x191A92B0)
