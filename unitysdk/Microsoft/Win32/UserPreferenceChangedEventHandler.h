...
#define MICROSOFT_WIN32_USERPREFERENCECHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x187C46A0)
#define MICROSOFT_WIN32_USERPREFERENCECHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187C46E0)
#define MICROSOFT_WIN32_USERPREFERENCECHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x187C4660)
#define MICROSOFT_WIN32_USERPREFERENCECHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x187C4620)
