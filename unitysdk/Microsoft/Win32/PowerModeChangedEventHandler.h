...
#define MICROSOFT_WIN32_POWERMODECHANGEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18FD6260)
#define MICROSOFT_WIN32_POWERMODECHANGEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18FD62A0)
#define MICROSOFT_WIN32_POWERMODECHANGEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18FD6220)
#define MICROSOFT_WIN32_POWERMODECHANGEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD61E0)
