...
#define MICROSOFT_WIN32_USERPREFERENCECHANGINGEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x182BA7C0)
#define MICROSOFT_WIN32_USERPREFERENCECHANGINGEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x182BA800)
#define MICROSOFT_WIN32_USERPREFERENCECHANGINGEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x182BA780)
#define MICROSOFT_WIN32_USERPREFERENCECHANGINGEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x182BA740)
