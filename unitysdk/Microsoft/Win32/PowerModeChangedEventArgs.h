...
#define MICROSOFT_WIN32_POWERMODECHANGEDEVENTARGS_GET_MODE_OFFSET UNITYSDK_OFFSET(0x187C44E0)
#define MICROSOFT_WIN32_POWERMODECHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x187C44A0)
