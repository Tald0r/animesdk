...
#define MICROSOFT_WIN32_REGISTRYKEYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x18EE9D20)
#define MICROSOFT_WIN32_REGISTRYKEYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18EE9E10)
#define MICROSOFT_WIN32_REGISTRYKEYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE9EC0)
