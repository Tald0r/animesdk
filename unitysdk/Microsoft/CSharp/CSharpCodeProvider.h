...
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_CREATECOMPILER_OFFSET UNITYSDK_OFFSET(0x18B88180)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_CREATEGENERATOR_OFFSET UNITYSDK_OFFSET(0x18B881C0)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_GENERATECODEFROMMEMBER_OFFSET UNITYSDK_OFFSET(0x18B88200)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x18B88240)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER_GET_FILEEXTENSION_OFFSET UNITYSDK_OFFSET(0x18B88140)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18B88100)
#define MICROSOFT_CSHARP_CSHARPCODEPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B880C0)
