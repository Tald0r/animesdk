...
#define CLASS_2_CA5AE22C0A4482A2_STRUCT_2_CEC3584FEE7B6D6D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3188C0)
#define CLASS_2_CA5AE22C0A4482A2_STRUCT_2_CEC3584FEE7B6D6D_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

inline static constexpr unsigned int Class_2_CA5AE22C0A4482A2_Struct_2_CEC3584FEE7B6D6D_TypeDefinitionIndex = 55447;

struct alignas(8) Class_2_CA5AE22C0A4482A2_Struct_2_CEC3584FEE7B6D6D
{
	::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::Collections::Generic::List_1<::MoleMole::UIUrbanMapTrackLineWidgetContext*>*> Field_2_4; // 0x10
