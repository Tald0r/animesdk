...
#define NAVMESHPREFABINSTANCE_ADDINSTANCE_OFFSET UNITYSDK_OFFSET(0x6FB3420)
#define NAVMESHPREFABINSTANCE_ADDTRACKING_OFFSET UNITYSDK_OFFSET(0x6FB3640)
#define NAVMESHPREFABINSTANCE_GET_FOLLOWTRANSFORM_OFFSET UNITYSDK_OFFSET(0x6FB3200)
#define NAVMESHPREFABINSTANCE_GET_NAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x6FB31E0)
#define NAVMESHPREFABINSTANCE_GET_TRACKEDINSTANCES_OFFSET UNITYSDK_OFFSET(0x6FB3330)
#define NAVMESHPREFABINSTANCE_HASMOVED_OFFSET UNITYSDK_OFFSET(0x6FB3A70)
#define NAVMESHPREFABINSTANCE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x6FB3800)
#define NAVMESHPREFABINSTANCE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x6FB3390)
#define NAVMESHPREFABINSTANCE_REMOVETRACKING_OFFSET UNITYSDK_OFFSET(0x6FB3870)
#define NAVMESHPREFABINSTANCE_SETFOLLOWTRANSFORM_OFFSET UNITYSDK_OFFSET(0x6FB32A0)
#define NAVMESHPREFABINSTANCE_SET_FOLLOWTRANSFORM_OFFSET UNITYSDK_OFFSET(0x6FB3210)
#define NAVMESHPREFABINSTANCE_SET_NAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x6FB31F0)
#define NAVMESHPREFABINSTANCE_UPDATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x6FB3A00)
#define NAVMESHPREFABINSTANCE_UPDATETRACKEDINSTANCES_OFFSET UNITYSDK_OFFSET(0x6FB3BF0)
#define NAVMESHPREFABINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x6FB3E20)
#define NAVMESHPREFABINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x6FB3E00)

inline static constexpr unsigned int NavMeshPrefabInstance_TypeDefinitionIndex = 54386;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::NavMeshPrefabInstance*>**)Il2CppClass::FromTypeDefinitionIndex(NavMeshPrefabInstance_TypeDefinitionIndex)->GetStaticField(0x326E0);
	}
