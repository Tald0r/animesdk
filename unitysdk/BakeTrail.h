...
#define BAKETRAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B1B4CF0)
#define BAKETRAIL_BAKE_OFFSET UNITYSDK_OFFSET(0x1B1B4DB0)
#define BAKETRAIL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B1B4D80)
#define BAKETRAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B5080)

inline static constexpr unsigned int BakeTrail_TypeDefinitionIndex = 30834;
