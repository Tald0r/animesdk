...
#define BAKETRAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1ABA6990)
#define BAKETRAIL_BAKE_OFFSET UNITYSDK_OFFSET(0x1ABA6A50)
#define BAKETRAIL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1ABA6A20)
#define BAKETRAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA6D20)

inline static constexpr unsigned int BakeTrail_TypeDefinitionIndex = 29881;
