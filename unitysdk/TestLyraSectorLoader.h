...
#define TESTLYRASECTORLOADER_AWAKE_OFFSET UNITYSDK_OFFSET(0x17B69FE0)
#define TESTLYRASECTORLOADER_CLEARASSETVISITSTAUS_OFFSET UNITYSDK_OFFSET(0x17B6A820)
#define TESTLYRASECTORLOADER_CLEARDATA_OFFSET UNITYSDK_OFFSET(0x17B6AA90)
#define TESTLYRASECTORLOADER_CLEARSERIALIZEDASSETREFERENCEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x17B6A080)
#define TESTLYRASECTORLOADER_GETDFASSETPATHFORMAT_OFFSET UNITYSDK_OFFSET(0x17B6A110)
#define TESTLYRASECTORLOADER_GETPACKEDASSETPATHFORMAT_OFFSET UNITYSDK_OFFSET(0x17B6A1F0)
#define TESTLYRASECTORLOADER_GETSVASSETPATHFORMAT_OFFSET UNITYSDK_OFFSET(0x17B6A180)
#define TESTLYRASECTORLOADER_HASASSETREFERENCE_OFFSET UNITYSDK_OFFSET(0x17B6A020)
#define TESTLYRASECTORLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17B6AA40)
#define TESTLYRASECTORLOADER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17B6AE30)
#define TESTLYRASECTORLOADER_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x17B6AE80)
#define TESTLYRASECTORLOADER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17B6A8B0)
#define TESTLYRASECTORLOADER_RECORDENABLE_OFFSET UNITYSDK_OFFSET(0x17B6A260)
#define TESTLYRASECTORLOADER_RECORDLOADED_OFFSET UNITYSDK_OFFSET(0x17B6A760)
#define TESTLYRASECTORLOADER_RECORDTYRLOAD_OFFSET UNITYSDK_OFFSET(0x17B6A2B0)
#define TESTLYRASECTORLOADER_RECORDUNLOAD_OFFSET UNITYSDK_OFFSET(0x17B6A7C0)
#define TESTLYRASECTORLOADER_SETSHOULDRELOADASSETS_OFFSET UNITYSDK_OFFSET(0x17B6B1A0)
#define TESTLYRASECTORLOADER_START_OFFSET UNITYSDK_OFFSET(0x17B6A870)
#define TESTLYRASECTORLOADER_UPDATE_OFFSET UNITYSDK_OFFSET(0x17B6AEC0)
#define TESTLYRASECTORLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x17B6B1E0)

inline static constexpr unsigned int TestLyraSectorLoader_TypeDefinitionIndex = 28096;
