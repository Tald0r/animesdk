...
#define MONOSPRITEFACETOCAMERA_SETFACINGCAMERA_OFFSET UNITYSDK_OFFSET(0x93A4180)
#define MONOSPRITEFACETOCAMERA_START_OFFSET UNITYSDK_OFFSET(0x93A42C0)
#define MONOSPRITEFACETOCAMERA_UPDATE_OFFSET UNITYSDK_OFFSET(0x93A4330)
#define MONOSPRITEFACETOCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x93A4770)

inline static constexpr unsigned int MonoSpriteFaceToCamera_TypeDefinitionIndex = 65132;
