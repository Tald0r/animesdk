...
#define QWER_CTHREADGROUP_CPOLLINRUNNER_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1B00F0A0)
#define QWER_CTHREADGROUP_CPOLLINRUNNER_POLL_OFFSET UNITYSDK_OFFSET(0x1B00F3E0)
#define QWER_CTHREADGROUP_CPOLLINRUNNER_POST_OFFSET UNITYSDK_OFFSET(0x1B012280)
#define QWER_CTHREADGROUP_CPOLLINRUNNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0120D0)

namespace QWER
{
	inline static constexpr unsigned int CThreadGroup_CPollInRunner_TypeDefinitionIndex = 84148;

	class CThreadGroup_CPollInRunner : public ::System::Object
	{
	public:
		::QWER::CMPSCQueue_1<::System::Action*>* m_oMPSCQueue; // 0x10
		::QWER::CMPMCQueue_1<::System::Action*>* m_oMPMCQueue; // 0x18
		::QWER::CThreadGroup* m_oOwner; // 0x20
