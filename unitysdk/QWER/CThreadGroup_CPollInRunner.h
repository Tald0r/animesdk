...
#define QWER_CTHREADGROUP_CPOLLINRUNNER_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1AA1F360)
#define QWER_CTHREADGROUP_CPOLLINRUNNER_POLL_OFFSET UNITYSDK_OFFSET(0x1AA1F6A0)
#define QWER_CTHREADGROUP_CPOLLINRUNNER_POST_OFFSET UNITYSDK_OFFSET(0x1AA22550)
#define QWER_CTHREADGROUP_CPOLLINRUNNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA223A0)

namespace QWER
{
	inline static constexpr unsigned int CThreadGroup_CPollInRunner_TypeDefinitionIndex = 82107;

	class CThreadGroup_CPollInRunner : public ::System::Object
	{
	public:
		::QWER::CThreadGroup* m_oOwner; // 0x10
		::QWER::CMPSCQueue_1<::System::Action*>* m_oMPSCQueue; // 0x18
		::QWER::CMPMCQueue_1<::System::Action*>* m_oMPMCQueue; // 0x20
