...
#define QWER_CDEFAULTLOGPRINTER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1AA1D2A0)
#define QWER_CDEFAULTLOGPRINTER_QWER_ILOGPRINTER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1AA1D9B0)
#define QWER_CDEFAULTLOGPRINTER_QWER_ILOGPRINTER_PRINT_OFFSET UNITYSDK_OFFSET(0x1AA1DD10)
#define QWER_CDEFAULTLOGPRINTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA1D4A0)
#define QWER_CDEFAULTLOGPRINTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA1D490)

namespace QWER
{
	inline static constexpr unsigned int CDefaultLogPrinter_TypeDefinitionIndex = 82073;
	...
	public:
		...
		{
			return (::QWER::CDefaultLogPrinter**)Il2CppClass::FromTypeDefinitionIndex(CDefaultLogPrinter_TypeDefinitionIndex)->GetStaticField(0x47630);
		}
		static ::QWER::CThreadGroup** StaticGet_m_oThreadGroup()
		{
			return (::QWER::CThreadGroup**)Il2CppClass::FromTypeDefinitionIndex(CDefaultLogPrinter_TypeDefinitionIndex)->GetStaticField(0x47638);
		}
		static ::System::Object** StaticGet_m_oMutex()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(CDefaultLogPrinter_TypeDefinitionIndex)->GetStaticField(0x47640);
		}
