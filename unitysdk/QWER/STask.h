...
#define QWER_STASK_EQUALS_OFFSET UNITYSDK_OFFSET(0x950550)
#define QWER_STASK_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x719370)
#define QWER_STASK_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define QWER_STASK_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x2C3A90)
#define QWER_STASK_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA22D40)
#define QWER_STASK_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AA22D50)
#define QWER_STASK_WHENDONE_OFFSET UNITYSDK_OFFSET(0x950540)
#define QWER_STASK__CTOR_OFFSET UNITYSDK_OFFSET(0x2D6E20)

namespace QWER
{
	inline static constexpr unsigned int STask_TypeDefinitionIndex = 82095;
