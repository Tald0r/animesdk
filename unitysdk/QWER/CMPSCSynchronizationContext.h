...
#define QWER_CMPSCSYNCHRONIZATIONCONTEXT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B00E9A0)
#define QWER_CMPSCSYNCHRONIZATIONCONTEXT_GET_FUTEX_OFFSET UNITYSDK_OFFSET(0x1B00E9C0)
#define QWER_CMPSCSYNCHRONIZATIONCONTEXT_POLL_OFFSET UNITYSDK_OFFSET(0x1B00EB40)
#define QWER_CMPSCSYNCHRONIZATIONCONTEXT_POST_OFFSET UNITYSDK_OFFSET(0x1B00E9D0)
#define QWER_CMPSCSYNCHRONIZATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B00C780)

namespace QWER
{
	inline static constexpr unsigned int CMPSCSynchronizationContext_TypeDefinitionIndex = 84122;
