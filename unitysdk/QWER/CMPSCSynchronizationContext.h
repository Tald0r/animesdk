...
#define QWER_CMPSCSYNCHRONIZATIONCONTEXT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AA1EC60)
#define QWER_CMPSCSYNCHRONIZATIONCONTEXT_GET_FUTEX_OFFSET UNITYSDK_OFFSET(0x1AA1EC80)
#define QWER_CMPSCSYNCHRONIZATIONCONTEXT_POLL_OFFSET UNITYSDK_OFFSET(0x1AA1EE00)
#define QWER_CMPSCSYNCHRONIZATIONCONTEXT_POST_OFFSET UNITYSDK_OFFSET(0x1AA1EC90)
#define QWER_CMPSCSYNCHRONIZATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA1CA40)

namespace QWER
{
	inline static constexpr unsigned int CMPSCSynchronizationContext_TypeDefinitionIndex = 82081;
