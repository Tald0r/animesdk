...
#define QWER_CRUNNERLOGGERIMPL_ADDLOGPRINTER_OFFSET UNITYSDK_OFFSET(0x1AA20800)
#define QWER_CRUNNERLOGGERIMPL_DISABLEPREFIX_OFFSET UNITYSDK_OFFSET(0x1AA20600)
#define QWER_CRUNNERLOGGERIMPL_ENABLEPREFIX_OFFSET UNITYSDK_OFFSET(0x1AA20400)
#define QWER_CRUNNERLOGGERIMPL_FLUSH_OFFSET UNITYSDK_OFFSET(0x1AA20D20)
#define QWER_CRUNNERLOGGERIMPL_GET_GETCURDATETIME_OFFSET UNITYSDK_OFFSET(0x1AA21620)
#define QWER_CRUNNERLOGGERIMPL_PRINT_1_OFFSET UNITYSDK_OFFSET(0x1AA21090)
#define QWER_CRUNNERLOGGERIMPL_PRINT_OFFSET UNITYSDK_OFFSET(0x1AA20F50)
#define QWER_CRUNNERLOGGERIMPL_SETLOGLEVEL_OFFSET UNITYSDK_OFFSET(0x1AA20B50)
#define QWER_CRUNNERLOGGERIMPL_SET_GETCURDATETIME_OFFSET UNITYSDK_OFFSET(0x1AA21630)
#define QWER_CRUNNERLOGGERIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA20200)

namespace QWER
{
	inline static constexpr unsigned int CRunnerLoggerImpl_TypeDefinitionIndex = 82090;

	class CRunnerLoggerImpl : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::QWER::ILogPrinter*>* m_oLogPrinter; // 0x10
		::System::Collections::Generic::HashSet_1<::QWER::ILogPrinter*>* m_oSet; // 0x18
		::System::Func_1<::System::DateTimeOffset>* _GetCurDateTime_k__BackingField; // 0x20
		::System::Object* m_oMutex; // 0x28
