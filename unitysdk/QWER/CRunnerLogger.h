...
#define QWER_CRUNNERLOGGER_ADDLOGPRINTER_OFFSET UNITYSDK_OFFSET(0x1B010340)
#define QWER_CRUNNERLOGGER_DISABLEPREFIX_OFFSET UNITYSDK_OFFSET(0x1B010140)
#define QWER_CRUNNERLOGGER_ENABLEPREFIX_OFFSET UNITYSDK_OFFSET(0x1B00FD40)
#define QWER_CRUNNERLOGGER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B010890)
#define QWER_CRUNNERLOGGER_PRINT_1_OFFSET UNITYSDK_OFFSET(0x1B010D00)
#define QWER_CRUNNERLOGGER_PRINT_OFFSET UNITYSDK_OFFSET(0x1B010B50)
#define QWER_CRUNNERLOGGER_SETCURDATETIMEFUNC_OFFSET UNITYSDK_OFFSET(0x1B011110)
#define QWER_CRUNNERLOGGER_SETLOGLEVEL_OFFSET UNITYSDK_OFFSET(0x1B010690)
#define QWER_CRUNNERLOGGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B011300)

namespace QWER
{
	inline static constexpr unsigned int CRunnerLogger_TypeDefinitionIndex = 84130;
	...
	public:
		...
		{
			return (::Il2CppArray<::QWER::CRunnerLoggerImpl*>**)Il2CppClass::FromTypeDefinitionIndex(CRunnerLogger_TypeDefinitionIndex)->GetStaticField(0x49070);
		}
