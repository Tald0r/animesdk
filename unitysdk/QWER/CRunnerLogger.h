...
#define QWER_CRUNNERLOGGER_ADDLOGPRINTER_OFFSET UNITYSDK_OFFSET(0x1AA20610)
#define QWER_CRUNNERLOGGER_DISABLEPREFIX_OFFSET UNITYSDK_OFFSET(0x1AA20410)
#define QWER_CRUNNERLOGGER_ENABLEPREFIX_OFFSET UNITYSDK_OFFSET(0x1AA20010)
#define QWER_CRUNNERLOGGER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1AA20B60)
#define QWER_CRUNNERLOGGER_PRINT_1_OFFSET UNITYSDK_OFFSET(0x1AA20FD0)
#define QWER_CRUNNERLOGGER_PRINT_OFFSET UNITYSDK_OFFSET(0x1AA20E20)
#define QWER_CRUNNERLOGGER_SETCURDATETIMEFUNC_OFFSET UNITYSDK_OFFSET(0x1AA213E0)
#define QWER_CRUNNERLOGGER_SETLOGLEVEL_OFFSET UNITYSDK_OFFSET(0x1AA20960)
#define QWER_CRUNNERLOGGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA215D0)

namespace QWER
{
	inline static constexpr unsigned int CRunnerLogger_TypeDefinitionIndex = 82089;
	...
	public:
		...
		{
			return (::Il2CppArray<::QWER::CRunnerLoggerImpl*>**)Il2CppClass::FromTypeDefinitionIndex(CRunnerLogger_TypeDefinitionIndex)->GetStaticField(0x47660);
		}
