...
#define QWER_CTIMERMGR_GETNEXTPOLLTIME_OFFSET UNITYSDK_OFFSET(0x1B64ACD0)
#define QWER_CTIMERMGR_GET_CURTIME_OFFSET UNITYSDK_OFFSET(0x1B64A4F0)
#define QWER_CTIMERMGR_POLL_OFFSET UNITYSDK_OFFSET(0x1B64A5D0)
#define QWER_CTIMERMGR_STARTTIMER_1_OFFSET UNITYSDK_OFFSET(0x1B64AB70)
#define QWER_CTIMERMGR_STARTTIMER_2_OFFSET UNITYSDK_OFFSET(0x1B64AAA0)
#define QWER_CTIMERMGR_STARTTIMER_OFFSET UNITYSDK_OFFSET(0x1B64A9E0)
#define QWER_CTIMERMGR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B64A530)

namespace QWER
{
	inline static constexpr unsigned int CTimerMgr_TypeDefinitionIndex = 82516;
