...
#define QWER_CTIMERMGR_GETNEXTPOLLTIME_OFFSET UNITYSDK_OFFSET(0x1B03AC40)
#define QWER_CTIMERMGR_GET_CURTIME_OFFSET UNITYSDK_OFFSET(0x1B03A460)
#define QWER_CTIMERMGR_POLL_OFFSET UNITYSDK_OFFSET(0x1B03A540)
#define QWER_CTIMERMGR_STARTTIMER_1_OFFSET UNITYSDK_OFFSET(0x1B03AAE0)
#define QWER_CTIMERMGR_STARTTIMER_2_OFFSET UNITYSDK_OFFSET(0x1B03AA10)
#define QWER_CTIMERMGR_STARTTIMER_OFFSET UNITYSDK_OFFSET(0x1B03A950)
#define QWER_CTIMERMGR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B03A4A0)

namespace QWER
{
	inline static constexpr unsigned int CTimerMgr_TypeDefinitionIndex = 80474;

	class CTimerMgr : public ::System::Object
	{
	public:
		::QWER::CSkipListTimerMgr* m_oSkipListTimerMgr; // 0x10
		::QWER::CWheelTimerMgr* m_oWheelTimerMgr; // 0x18
