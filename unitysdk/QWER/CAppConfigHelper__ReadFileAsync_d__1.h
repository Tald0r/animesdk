...
#define QWER_CAPPCONFIGHELPER__READFILEASYNC_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AA1B680)
#define QWER_CAPPCONFIGHELPER__READFILEASYNC_D__1_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x1AA1BA10)
#define QWER_CAPPCONFIGHELPER__READFILEASYNC_D__1__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA1A2C0)

namespace QWER
{
	inline static constexpr unsigned int CAppConfigHelper__ReadFileAsync_d__1_TypeDefinitionIndex = 82067;
