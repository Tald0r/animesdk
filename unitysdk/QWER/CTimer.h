...
#define QWER_CTIMER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B03A3E0)
#define QWER_CTIMER_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B03A3C0)
#define QWER_CTIMER_GET_ISRUNNING_OFFSET UNITYSDK_OFFSET(0x1B03A190)
#define QWER_CTIMER_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B03A3F0)
#define QWER_CTIMER_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B03A3D0)
#define QWER_CTIMER_STOP_OFFSET UNITYSDK_OFFSET(0x1B03A400)
#define QWER_CTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B039C10)

namespace QWER
{
	inline static constexpr unsigned int CTimer_TypeDefinitionIndex = 80473;
	...
	public:
		...
		::System::Boolean m_bAutoFix; // 0x28
		::System::UInt64 m_qwFirstTimeoutTime; // 0x30
		::System::UInt64 m_qwIntervalMilliSeconds; // 0x38
		::System::UInt32 _Current_k__BackingField; // 0x40
		::System::UInt32 _Count_k__BackingField; // 0x44
