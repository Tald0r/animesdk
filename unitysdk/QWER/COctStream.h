...
#define QWER_COCTSTREAM_CLONETO_OFFSET UNITYSDK_OFFSET(0x1B14D310)
#define QWER_COCTSTREAM_CLONE_OFFSET UNITYSDK_OFFSET(0x1B14D8C0)
#define QWER_COCTSTREAM_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1B14D3C0)
#define QWER_COCTSTREAM_GET_POPINDEX_OFFSET UNITYSDK_OFFSET(0x1B14D3B0)
#define QWER_COCTSTREAM_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B14D390)
#define QWER_COCTSTREAM_POP_1_OFFSET UNITYSDK_OFFSET(0x1B14D7E0)
#define QWER_COCTSTREAM_POP_OFFSET UNITYSDK_OFFSET(0x1B14D720)
#define QWER_COCTSTREAM_PUSH_1_OFFSET UNITYSDK_OFFSET(0x1B14D640)
#define QWER_COCTSTREAM_PUSH_OFFSET UNITYSDK_OFFSET(0x1B14D530)
#define QWER_COCTSTREAM_RESERVE_OFFSET UNITYSDK_OFFSET(0x1B14D490)
#define QWER_COCTSTREAM_RESIZE_OFFSET UNITYSDK_OFFSET(0x1B14D3E0)
#define QWER_COCTSTREAM_SET_DATA_OFFSET UNITYSDK_OFFSET(0x1B14D3D0)
#define QWER_COCTSTREAM_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B14D3A0)
#define QWER_COCTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14D2E0)

namespace QWER
{
	inline static constexpr unsigned int COctStream_TypeDefinitionIndex = 8568;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(COctStream_TypeDefinitionIndex)->GetStaticField(0xC870);
		}
