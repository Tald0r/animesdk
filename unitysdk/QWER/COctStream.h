...
#define QWER_COCTSTREAM_CLONETO_OFFSET UNITYSDK_OFFSET(0x1B76C2C0)
#define QWER_COCTSTREAM_CLONE_OFFSET UNITYSDK_OFFSET(0x1B76C870)
#define QWER_COCTSTREAM_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1B76C370)
#define QWER_COCTSTREAM_GET_POPINDEX_OFFSET UNITYSDK_OFFSET(0x1B76C360)
#define QWER_COCTSTREAM_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B76C340)
#define QWER_COCTSTREAM_POP_1_OFFSET UNITYSDK_OFFSET(0x1B76C790)
#define QWER_COCTSTREAM_POP_OFFSET UNITYSDK_OFFSET(0x1B76C6D0)
#define QWER_COCTSTREAM_PUSH_1_OFFSET UNITYSDK_OFFSET(0x1B76C5F0)
#define QWER_COCTSTREAM_PUSH_OFFSET UNITYSDK_OFFSET(0x1B76C4E0)
#define QWER_COCTSTREAM_RESERVE_OFFSET UNITYSDK_OFFSET(0x1B76C440)
#define QWER_COCTSTREAM_RESIZE_OFFSET UNITYSDK_OFFSET(0x1B76C390)
#define QWER_COCTSTREAM_SET_DATA_OFFSET UNITYSDK_OFFSET(0x1B76C380)
#define QWER_COCTSTREAM_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B76C350)
#define QWER_COCTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76C290)

namespace QWER
{
	inline static constexpr unsigned int COctStream_TypeDefinitionIndex = 8579;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(COctStream_TypeDefinitionIndex)->GetStaticField(0xDE10);
		}
