...
#define QWER_CPROPERTYOBJECTMODULE_ONFIELDCHANGED_OFFSET UNITYSDK_OFFSET(0x1B754ED0)
#define QWER_CPROPERTYOBJECTMODULE_SETCHANGEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B754F40)
#define QWER_CPROPERTYOBJECTMODULE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B754EC0)
#define QWER_CPROPERTYOBJECTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B754EB0)

namespace QWER
{
	inline static constexpr unsigned int CPropertyObjectModule_TypeDefinitionIndex = 9669;
