...
#define QWER_CPROPERTYOBJECTMODULE_ONFIELDCHANGED_OFFSET UNITYSDK_OFFSET(0x1B138860)
#define QWER_CPROPERTYOBJECTMODULE_SETCHANGEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B1388D0)
#define QWER_CPROPERTYOBJECTMODULE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B138850)
#define QWER_CPROPERTYOBJECTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B138840)

namespace QWER
{
	inline static constexpr unsigned int CPropertyObjectModule_TypeDefinitionIndex = 9667;
