...
#define QWER_DONPROPERTYMODULECHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B1391F0)
#define QWER_DONPROPERTYMODULECHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B139250)
#define QWER_DONPROPERTYMODULECHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B138240)
#define QWER_DONPROPERTYMODULECHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B138830)

namespace QWER
{
	inline static constexpr unsigned int DOnPropertyModuleChanged_TypeDefinitionIndex = 9664;
