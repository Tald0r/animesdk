...
#define QWER_DONPROPERTYMODULECHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B755860)
#define QWER_DONPROPERTYMODULECHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B7558C0)
#define QWER_DONPROPERTYMODULECHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B754890)
#define QWER_DONPROPERTYMODULECHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B754E90)

namespace QWER
{
	inline static constexpr unsigned int DOnPropertyModuleChanged_TypeDefinitionIndex = 9666;
