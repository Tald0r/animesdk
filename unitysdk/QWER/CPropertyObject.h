...
#define QWER_CPROPERTYOBJECT_SETCHANGEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B1387A0)
#define QWER_CPROPERTYOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B138210)
#define QWER_CPROPERTYOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B138200)
#define QWER_CPROPERTYOBJECT__FIRECHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1B138220)

namespace QWER
{
	inline static constexpr unsigned int CPropertyObject_TypeDefinitionIndex = 9666;
