...
#define QWER_CPROPERTYOBJECT_SETCHANGEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1B754E00)
#define QWER_CPROPERTYOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B754860)
#define QWER_CPROPERTYOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B754850)
#define QWER_CPROPERTYOBJECT__FIRECHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1B754870)

namespace QWER
{
	inline static constexpr unsigned int CPropertyObject_TypeDefinitionIndex = 9668;
