...
#define QWER_CAPPLICATION___EXIT_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AA1CFD0)
#define QWER_CAPPLICATION___EXIT_D__13_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x1AA1D270)
#define QWER_CAPPLICATION___EXIT_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA1CF20)

namespace QWER
{
	inline static constexpr unsigned int CApplication___Exit_d__13_TypeDefinitionIndex = 82071;
	...
	public:
		...
		::QWER::CApplication* __4__this; // 0x30
