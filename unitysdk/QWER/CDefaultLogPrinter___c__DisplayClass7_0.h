...
#define QWER_CDEFAULTLOGPRINTER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA1DDE0)
#define QWER_CDEFAULTLOGPRINTER___C__DISPLAYCLASS7_0__QWER_ILOGPRINTER_PRINT_G__TMP_0_OFFSET UNITYSDK_OFFSET(0x1AA1DE40)

namespace QWER
{
	inline static constexpr unsigned int CDefaultLogPrinter___c__DisplayClass7_0_TypeDefinitionIndex = 82075;
