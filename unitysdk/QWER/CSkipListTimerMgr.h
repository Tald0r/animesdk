...
#define QWER_CSKIPLISTTIMERMGR_GETNEXTPOLLTIME_OFFSET UNITYSDK_OFFSET(0x1B64A3A0)
#define QWER_CSKIPLISTTIMERMGR_GET_CURTIME_OFFSET UNITYSDK_OFFSET(0x1B649820)
#define QWER_CSKIPLISTTIMERMGR_GET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0x1B649840)
#define QWER_CSKIPLISTTIMERMGR_POLL_OFFSET UNITYSDK_OFFSET(0x1B6498C0)
#define QWER_CSKIPLISTTIMERMGR_SET_CURTIME_OFFSET UNITYSDK_OFFSET(0x1B649830)
#define QWER_CSKIPLISTTIMERMGR_STARTTIMER_OFFSET UNITYSDK_OFFSET(0x1B649BB0)
#define QWER_CSKIPLISTTIMERMGR__ADDTIMER_1_OFFSET UNITYSDK_OFFSET(0x1B64A240)
#define QWER_CSKIPLISTTIMERMGR__ADDTIMER_OFFSET UNITYSDK_OFFSET(0x1B649CB0)
#define QWER_CSKIPLISTTIMERMGR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B649850)
#define QWER_CSKIPLISTTIMERMGR__EXECTIMER_OFFSET UNITYSDK_OFFSET(0x1B649960)

namespace QWER
{
	inline static constexpr unsigned int CSkipListTimerMgr_TypeDefinitionIndex = 82514;
