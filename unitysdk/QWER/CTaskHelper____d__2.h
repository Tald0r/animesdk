...
#define QWER_CTASKHELPER____D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AA22130)
#define QWER_CTASKHELPER____D__2_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x1AA22330)
#define QWER_CTASKHELPER____D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA21BD0)

namespace QWER
{
	inline static constexpr unsigned int CTaskHelper____d__2_TypeDefinitionIndex = 82102;
