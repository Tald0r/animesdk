...
#define QWER_CTASKHELPER____D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B011E60)
#define QWER_CTASKHELPER____D__2_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x1B012060)
#define QWER_CTASKHELPER____D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B011900)

namespace QWER
{
	inline static constexpr unsigned int CTaskHelper____d__2_TypeDefinitionIndex = 84143;
