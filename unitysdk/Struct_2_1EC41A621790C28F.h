...
#define STRUCT_2_1EC41A621790C28F_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3A0490)
#define STRUCT_2_1EC41A621790C28F_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A0400)
#define STRUCT_2_1EC41A621790C28F_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3A04A0)
#define STRUCT_2_1EC41A621790C28F_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x3A0520)
#define STRUCT_2_1EC41A621790C28F_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x3A0590)
#define STRUCT_2_1EC41A621790C28F_METHOD_2_E7BBB2182629E9E8_1_OFFSET UNITYSDK_OFFSET(0xABF67E0)
#define STRUCT_2_1EC41A621790C28F_METHOD_2_E7BBB2182629E9E8_OFFSET UNITYSDK_OFFSET(0xABF6680)
#define STRUCT_2_1EC41A621790C28F__CCTOR_OFFSET UNITYSDK_OFFSET(0xABF65F0)
#define STRUCT_2_1EC41A621790C28F__CTOR_OFFSET UNITYSDK_OFFSET(0x3A03E0)

inline static constexpr unsigned int Struct_2_1EC41A621790C28F_TypeDefinitionIndex = 72566;

struct alignas(4) Struct_2_1EC41A621790C28F
{
	static ::Struct_2_1EC41A621790C28F* StaticGet_Field_2_0()
	{
		return (::Struct_2_1EC41A621790C28F*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_1EC41A621790C28F_TypeDefinitionIndex)->GetStaticField(0xD5A0);
	}
