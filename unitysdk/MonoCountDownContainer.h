...
#define MONOCOUNTDOWNCONTAINER_AWAKE_OFFSET UNITYSDK_OFFSET(0x7BEF4A0)
#define MONOCOUNTDOWNCONTAINER_CLOSETIMER_OFFSET UNITYSDK_OFFSET(0x7BEFB80)
#define MONOCOUNTDOWNCONTAINER_FORMATTIME_OFFSET UNITYSDK_OFFSET(0x7BEF860)
#define MONOCOUNTDOWNCONTAINER_OPENTIMER_OFFSET UNITYSDK_OFFSET(0x7BEFA40)
#define MONOCOUNTDOWNCONTAINER_PAUSE_OFFSET UNITYSDK_OFFSET(0x7BEFC30)
#define MONOCOUNTDOWNCONTAINER_TICKTIMER_OFFSET UNITYSDK_OFFSET(0x7BEF590)
#define MONOCOUNTDOWNCONTAINER_UPDATE_OFFSET UNITYSDK_OFFSET(0x7BEF510)
#define MONOCOUNTDOWNCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x7BEFCA0)

inline static constexpr unsigned int MonoCountDownContainer_TypeDefinitionIndex = 41605;
