...
#define TRAMROADMESHGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17CCCB20)

inline static constexpr unsigned int TramroadMeshGenerator_TypeDefinitionIndex = 56881;
