...
#define PSFOLLOWOWNERSHAPE_ATTACHTOOWNERMODELRENDERSHAPE_OFFSET UNITYSDK_OFFSET(0x1388A520)
#define PSFOLLOWOWNERSHAPE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1388A440)
#define PSFOLLOWOWNERSHAPE_REFRESHOWNERRENDERSHAPE_OFFSET UNITYSDK_OFFSET(0x1388A2F0)
#define PSFOLLOWOWNERSHAPE_RESET_OFFSET UNITYSDK_OFFSET(0x1388A4B0)
#define PSFOLLOWOWNERSHAPE_START_OFFSET UNITYSDK_OFFSET(0x1388A280)
#define PSFOLLOWOWNERSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1388A620)

inline static constexpr unsigned int PSFollowOwnerShape_TypeDefinitionIndex = 65302;
