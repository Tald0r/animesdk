...
#define PSFOLLOWOWNERSHAPE_ATTACHTOOWNERMODELRENDERSHAPE_OFFSET UNITYSDK_OFFSET(0x1919BA20)
#define PSFOLLOWOWNERSHAPE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1919B940)
#define PSFOLLOWOWNERSHAPE_REFRESHOWNERRENDERSHAPE_OFFSET UNITYSDK_OFFSET(0x1919B7F0)
#define PSFOLLOWOWNERSHAPE_RESET_OFFSET UNITYSDK_OFFSET(0x1919B9B0)
#define PSFOLLOWOWNERSHAPE_START_OFFSET UNITYSDK_OFFSET(0x1919B780)
#define PSFOLLOWOWNERSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1919BB20)

inline static constexpr unsigned int PSFollowOwnerShape_TypeDefinitionIndex = 45322;
