...
#define SIMPLEJSON_JSONARRAY__GETENUMERATOR_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B0FAAD0)
#define SIMPLEJSON_JSONARRAY__GETENUMERATOR_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B0FAC50)
#define SIMPLEJSON_JSONARRAY__GETENUMERATOR_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B0FACB0)
#define SIMPLEJSON_JSONARRAY__GETENUMERATOR_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B0FAC60)
#define SIMPLEJSON_JSONARRAY__GETENUMERATOR_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B0FAAA0)
#define SIMPLEJSON_JSONARRAY__GETENUMERATOR_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0FAA90)
#define SIMPLEJSON_JSONARRAY__GETENUMERATOR_D__15___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B0FAAC0)

namespace SimpleJSON
{
	inline static constexpr unsigned int JSONArray__GetEnumerator_d__15_TypeDefinitionIndex = 7821;
