...
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1ABB9700)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SIMPLEJSON_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1ABB9900)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SIMPLEJSON_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ABB9890)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__14_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1ABB9980)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ABB98F0)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1ABB98A0)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ABB96D0)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABB96B0)
#define SIMPLEJSON_JSONARRAY__GET_CHILDS_D__14___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1ABB96F0)

namespace SimpleJSON
{
	inline static constexpr unsigned int JSONArray__get_Childs_d__14_TypeDefinitionIndex = 7855;
