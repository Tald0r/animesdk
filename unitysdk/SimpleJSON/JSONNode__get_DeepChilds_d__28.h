...
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A9992C0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SIMPLEJSON_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A999950)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SIMPLEJSON_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A9998E0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__28_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A9999D0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A999940)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A9998F0)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A998F80)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0x1A998F60)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__28___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1A999210)
#define SIMPLEJSON_JSONNODE__GET_DEEPCHILDS_D__28___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1A999160)

namespace SimpleJSON
{
	inline static constexpr unsigned int JSONNode__get_DeepChilds_d__28_TypeDefinitionIndex = 7816;
