...
#define SCENEPLANETPATH_SINGLEPATH_ADDPATHPOINT_OFFSET UNITYSDK_OFFSET(0x18654EC0)
#define SCENEPLANETPATH_SINGLEPATH_DELETEPOINT_OFFSET UNITYSDK_OFFSET(0x18655150)
#define SCENEPLANETPATH_SINGLEPATH_GETLOCALTOWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0x18654990)
#define SCENEPLANETPATH_SINGLEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x186552B0)

inline static constexpr unsigned int ScenePlanetPath_SinglePath_TypeDefinitionIndex = 28975;
