...
#define SCENEPLANETPATH_SINGLEPATH_ADDPATHPOINT_OFFSET UNITYSDK_OFFSET(0x180331D0)
#define SCENEPLANETPATH_SINGLEPATH_DELETEPOINT_OFFSET UNITYSDK_OFFSET(0x18033460)
#define SCENEPLANETPATH_SINGLEPATH_GETLOCALTOWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0x18032CA0)
#define SCENEPLANETPATH_SINGLEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x180335C0)

inline static constexpr unsigned int ScenePlanetPath_SinglePath_TypeDefinitionIndex = 28035;
