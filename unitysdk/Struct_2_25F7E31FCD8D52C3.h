...
#define STRUCT_2_25F7E31FCD8D52C3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x351C50)
#define STRUCT_2_25F7E31FCD8D52C3_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x351D40)
#define STRUCT_2_25F7E31FCD8D52C3_METHOD_2_3105EAD418A897C1_OFFSET UNITYSDK_OFFSET(0x351E10)
#define STRUCT_2_25F7E31FCD8D52C3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x351CB0)
#define STRUCT_2_25F7E31FCD8D52C3_RESET_OFFSET UNITYSDK_OFFSET(0x351CC0)
#define STRUCT_2_25F7E31FCD8D52C3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x351D60)
#define STRUCT_2_25F7E31FCD8D52C3__CTOR_OFFSET UNITYSDK_OFFSET(0x351C20)

inline static constexpr unsigned int Struct_2_25F7E31FCD8D52C3_TypeDefinitionIndex = 38581;
