...
#define STRUCT_2_25F7E31FCD8D52C3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x383910)
#define STRUCT_2_25F7E31FCD8D52C3_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x383A00)
#define STRUCT_2_25F7E31FCD8D52C3_METHOD_2_3105EAD418A897C1_OFFSET UNITYSDK_OFFSET(0x383AD0)
#define STRUCT_2_25F7E31FCD8D52C3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x383970)
#define STRUCT_2_25F7E31FCD8D52C3_RESET_OFFSET UNITYSDK_OFFSET(0x383980)
#define STRUCT_2_25F7E31FCD8D52C3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x383A20)
#define STRUCT_2_25F7E31FCD8D52C3__CTOR_OFFSET UNITYSDK_OFFSET(0x3838E0)

inline static constexpr unsigned int Struct_2_25F7E31FCD8D52C3_TypeDefinitionIndex = 39068;
