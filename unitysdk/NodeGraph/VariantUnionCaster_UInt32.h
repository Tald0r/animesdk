...
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x7823B00)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_CASTFROM_OFFSET UNITYSDK_OFFSET(0x78239C0)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_UINT32__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x7823D90)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x7823CE0)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32__CTOR_OFFSET UNITYSDK_OFFSET(0x7823D80)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_UInt32_TypeDefinitionIndex = 41769;
