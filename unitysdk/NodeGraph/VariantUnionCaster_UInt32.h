...
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x6B6FE80)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_CASTFROM_OFFSET UNITYSDK_OFFSET(0x6B6FD40)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_UINT32__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x6B70110)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x6B70060)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32__CTOR_OFFSET UNITYSDK_OFFSET(0x6B70100)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_UInt32_TypeDefinitionIndex = 37134;
