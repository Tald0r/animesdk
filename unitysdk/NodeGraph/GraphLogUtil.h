...
#define NODEGRAPH_GRAPHLOGUTIL_LOGEXCEPTION_1_OFFSET UNITYSDK_OFFSET(0x63B5D00)
#define NODEGRAPH_GRAPHLOGUTIL_LOGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x63B5C90)
#define NODEGRAPH_GRAPHLOGUTIL_LOG_1_OFFSET UNITYSDK_OFFSET(0x63B5C20)
#define NODEGRAPH_GRAPHLOGUTIL_LOG_OFFSET UNITYSDK_OFFSET(0x63B5BB0)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphLogUtil_TypeDefinitionIndex = 79059;
