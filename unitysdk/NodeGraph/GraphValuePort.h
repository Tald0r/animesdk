...
#define NODEGRAPH_GRAPHVALUEPORT_GET_PORTTYPE_OFFSET UNITYSDK_OFFSET(0x6363060)
#define NODEGRAPH_GRAPHVALUEPORT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x6363080)
#define NODEGRAPH_GRAPHVALUEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x6363070)
#define NODEGRAPH_GRAPHVALUEPORT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x6363190)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphValuePort_TypeDefinitionIndex = 62950;
