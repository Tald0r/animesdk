...
#define NODEGRAPH_GRAPHVALUEPORT_GET_PORTTYPE_OFFSET UNITYSDK_OFFSET(0x5E1FDB0)
#define NODEGRAPH_GRAPHVALUEPORT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x5E1FDD0)
#define NODEGRAPH_GRAPHVALUEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x5E1FDC0)
#define NODEGRAPH_GRAPHVALUEPORT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x5E1FEE0)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphValuePort_TypeDefinitionIndex = 72547;
