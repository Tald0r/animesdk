...
#define NODEGRAPH_IGRAPHNODE_ACTIVENODE_OFFSET UNITYSDK_OFFSET(0x7E16390)
#define NODEGRAPH_IGRAPHNODE_CLEARNODE_OFFSET UNITYSDK_OFFSET(0x7E168C0)
#define NODEGRAPH_IGRAPHNODE_ENDNODE_OFFSET UNITYSDK_OFFSET(0x7E169F0)
#define NODEGRAPH_IGRAPHNODE_GET_GRAPHID_OFFSET UNITYSDK_OFFSET(0x7E16230)
#define NODEGRAPH_IGRAPHNODE_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x7E162F0)
#define NODEGRAPH_IGRAPHNODE_GET_NODEGRAPH_OFFSET UNITYSDK_OFFSET(0x7E162C0)
#define NODEGRAPH_IGRAPHNODE_GET_NODEID_OFFSET UNITYSDK_OFFSET(0x7E162A0)
#define NODEGRAPH_IGRAPHNODE_GET_NODENAME_OFFSET UNITYSDK_OFFSET(0x7E16220)
#define NODEGRAPH_IGRAPHNODE_GET_STATE_OFFSET UNITYSDK_OFFSET(0x7E162D0)
#define NODEGRAPH_IGRAPHNODE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7E16790)
#define NODEGRAPH_IGRAPHNODE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7E166B0)
#define NODEGRAPH_IGRAPHNODE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7E16990)
#define NODEGRAPH_IGRAPHNODE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x7E16A70)
#define NODEGRAPH_IGRAPHNODE_ONNODEPAUSE_OFFSET UNITYSDK_OFFSET(0x7E16800)
#define NODEGRAPH_IGRAPHNODE_ONNODERESUME_OFFSET UNITYSDK_OFFSET(0x7E16860)
#define NODEGRAPH_IGRAPHNODE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x7E16BE0)
#define NODEGRAPH_IGRAPHNODE_PAUSENODE_OFFSET UNITYSDK_OFFSET(0x7E165D0)
#define NODEGRAPH_IGRAPHNODE_RESUMENODE_OFFSET UNITYSDK_OFFSET(0x7E16640)
#define NODEGRAPH_IGRAPHNODE_SETNODEDONE_OFFSET UNITYSDK_OFFSET(0x7E16550)
#define NODEGRAPH_IGRAPHNODE_SETNODEID_OFFSET UNITYSDK_OFFSET(0x7E16320)
#define NODEGRAPH_IGRAPHNODE_SETNODESTATE_OFFSET UNITYSDK_OFFSET(0x7E161B0)
#define NODEGRAPH_IGRAPHNODE_SET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x7E16300)
#define NODEGRAPH_IGRAPHNODE_SET_NODEID_OFFSET UNITYSDK_OFFSET(0x7E162B0)
#define NODEGRAPH_IGRAPHNODE_SET_STATE_OFFSET UNITYSDK_OFFSET(0x7E162E0)
#define NODEGRAPH_IGRAPHNODE_UPDATENODE_OFFSET UNITYSDK_OFFSET(0x7E16AD0)
#define NODEGRAPH_IGRAPHNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x7E16310)

namespace NodeGraph
{
	inline static constexpr unsigned int IGraphNode_TypeDefinitionIndex = 56375;

	class IGraphNode : public ::System::Object
	{
	public:
		::System::String* _NodeName_k__BackingField; // 0x10
		::NodeGraph::NodeGraphBase* _nodeGraph; // 0x18
