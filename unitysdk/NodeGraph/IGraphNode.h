...
#define NODEGRAPH_IGRAPHNODE_ACTIVENODE_OFFSET UNITYSDK_OFFSET(0x65351C0)
#define NODEGRAPH_IGRAPHNODE_CLEARNODE_OFFSET UNITYSDK_OFFSET(0x65356F0)
#define NODEGRAPH_IGRAPHNODE_ENDNODE_OFFSET UNITYSDK_OFFSET(0x6535820)
#define NODEGRAPH_IGRAPHNODE_GET_GRAPHID_OFFSET UNITYSDK_OFFSET(0x6535060)
#define NODEGRAPH_IGRAPHNODE_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x6535120)
#define NODEGRAPH_IGRAPHNODE_GET_NODEGRAPH_OFFSET UNITYSDK_OFFSET(0x65350F0)
#define NODEGRAPH_IGRAPHNODE_GET_NODEID_OFFSET UNITYSDK_OFFSET(0x65350D0)
#define NODEGRAPH_IGRAPHNODE_GET_NODENAME_OFFSET UNITYSDK_OFFSET(0x6535050)
#define NODEGRAPH_IGRAPHNODE_GET_STATE_OFFSET UNITYSDK_OFFSET(0x6535100)
#define NODEGRAPH_IGRAPHNODE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x65355C0)
#define NODEGRAPH_IGRAPHNODE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x65354E0)
#define NODEGRAPH_IGRAPHNODE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x65357C0)
#define NODEGRAPH_IGRAPHNODE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x65358A0)
#define NODEGRAPH_IGRAPHNODE_ONNODEPAUSE_OFFSET UNITYSDK_OFFSET(0x6535630)
#define NODEGRAPH_IGRAPHNODE_ONNODERESUME_OFFSET UNITYSDK_OFFSET(0x6535690)
#define NODEGRAPH_IGRAPHNODE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x6535A10)
#define NODEGRAPH_IGRAPHNODE_PAUSENODE_OFFSET UNITYSDK_OFFSET(0x6535400)
#define NODEGRAPH_IGRAPHNODE_RESUMENODE_OFFSET UNITYSDK_OFFSET(0x6535470)
#define NODEGRAPH_IGRAPHNODE_SETNODEDONE_OFFSET UNITYSDK_OFFSET(0x6535380)
#define NODEGRAPH_IGRAPHNODE_SETNODEID_OFFSET UNITYSDK_OFFSET(0x6535150)
#define NODEGRAPH_IGRAPHNODE_SETNODESTATE_OFFSET UNITYSDK_OFFSET(0x6534FE0)
#define NODEGRAPH_IGRAPHNODE_SET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x6535130)
#define NODEGRAPH_IGRAPHNODE_SET_NODEID_OFFSET UNITYSDK_OFFSET(0x65350E0)
#define NODEGRAPH_IGRAPHNODE_SET_STATE_OFFSET UNITYSDK_OFFSET(0x6535110)
#define NODEGRAPH_IGRAPHNODE_UPDATENODE_OFFSET UNITYSDK_OFFSET(0x6535900)
#define NODEGRAPH_IGRAPHNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6535140)

namespace NodeGraph
{
	inline static constexpr unsigned int IGraphNode_TypeDefinitionIndex = 42328;
	...
	public:
		...
		::NodeGraph::IGraphNode_NodeState _State_k__BackingField; // 0x28
