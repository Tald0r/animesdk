...
#define NODEGRAPH_VARIANTUNIONCASTER_STRING_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x642A760)
#define NODEGRAPH_VARIANTUNIONCASTER_STRING_CASTFROM_OFFSET UNITYSDK_OFFSET(0x642A620)
#define NODEGRAPH_VARIANTUNIONCASTER_STRING_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_STRING__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x642A9E0)
#define NODEGRAPH_VARIANTUNIONCASTER_STRING_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x642A940)
#define NODEGRAPH_VARIANTUNIONCASTER_STRING__CTOR_OFFSET UNITYSDK_OFFSET(0x642A9D0)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_String_TypeDefinitionIndex = 75037;
