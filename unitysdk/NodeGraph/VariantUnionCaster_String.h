...
#define NODEGRAPH_VARIANTUNIONCASTER_STRING_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x6A2FA90)
#define NODEGRAPH_VARIANTUNIONCASTER_STRING_CASTFROM_OFFSET UNITYSDK_OFFSET(0x6A2F950)
#define NODEGRAPH_VARIANTUNIONCASTER_STRING_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_STRING__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x6A2FD10)
#define NODEGRAPH_VARIANTUNIONCASTER_STRING_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x6A2FC70)
#define NODEGRAPH_VARIANTUNIONCASTER_STRING__CTOR_OFFSET UNITYSDK_OFFSET(0x6A2FD00)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_String_TypeDefinitionIndex = 62259;
