...
#define NODEGRAPH_GRAPHPORT_GET_PORTTYPE_OFFSET UNITYSDK_OFFSET(0x6A2BC50)
#define NODEGRAPH_GRAPHPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x6A2BC60)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphPort_TypeDefinitionIndex = 51927;
