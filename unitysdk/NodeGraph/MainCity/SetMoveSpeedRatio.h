...
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x698B8D0)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x698BBE0)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x698BE10)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x698B6E0)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x698B540)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x698C040)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x698C070)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x698C0A0)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x698C0B0)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x698C110)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x698C170)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetMoveSpeedRatio_TypeDefinitionIndex = 53455;
