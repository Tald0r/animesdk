...
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x630AA30)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x630AD40)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x630AF70)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x630A840)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x630A6A0)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x630B1A0)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x630B1D0)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x630B200)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x630B210)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x630B270)
#define NODEGRAPH_MAINCITY_SETMOVESPEEDRATIO___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x630B2D0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetMoveSpeedRatio_TypeDefinitionIndex = 72592;
