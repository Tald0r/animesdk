...
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6A2E170)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6A2E900)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6A2E000)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI__CTOR_OFFSET UNITYSDK_OFFSET(0x6A2DEB0)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x6A2EDF0)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6A2EE20)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6A2EE30)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6A2EE90)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int HideMainCityUI_TypeDefinitionIndex = 63970;
