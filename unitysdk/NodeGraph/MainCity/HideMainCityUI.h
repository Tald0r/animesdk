...
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6428E50)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x64295D0)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6428CE0)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI__CTOR_OFFSET UNITYSDK_OFFSET(0x6428B90)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x6429AC0)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6429AF0)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6429B00)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6429B60)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int HideMainCityUI_TypeDefinitionIndex = 41550;
