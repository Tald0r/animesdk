...
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x8CE39C0)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8CE37D0)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x8CE3700)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE__ONREGISTERPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0x8CE3C30)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE__ONREGISTERPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0x8CE3C60)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x8CE3C90)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8CE3CA0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SwitchPlayerNpcDistance_TypeDefinitionIndex = 57981;
