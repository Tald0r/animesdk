...
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x9BDE5C0)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x9BDE3D0)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x9BDE300)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE__ONREGISTERPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0x9BDE840)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE__ONREGISTERPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0x9BDE870)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x9BDE8A0)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x9BDE8B0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SwitchPlayerNpcDistance_TypeDefinitionIndex = 54635;
