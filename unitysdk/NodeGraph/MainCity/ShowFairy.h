...
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ADDIK_OFFSET UNITYSDK_OFFSET(0x7820E70)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_CLOSEIK_OFFSET UNITYSDK_OFFSET(0x7820C70)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONFAIRYDESTROYHANDLE_OFFSET UNITYSDK_OFFSET(0x7821070)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONFAIRYFADEOUTHANDLE_OFFSET UNITYSDK_OFFSET(0x7821A70)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x781FF40)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7821EC0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x78215E0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x781FBE0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_REALSTART_OFFSET UNITYSDK_OFFSET(0x7820340)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_SHOWSINGLEFAIRY_OFFSET UNITYSDK_OFFSET(0x78208D0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__CTOR_OFFSET UNITYSDK_OFFSET(0x781FAF0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_0_OFFSET UNITYSDK_OFFSET(0x7822480)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_1_OFFSET UNITYSDK_OFFSET(0x7822C50)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_2_OFFSET UNITYSDK_OFFSET(0x7823060)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_3_OFFSET UNITYSDK_OFFSET(0x7823090)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_4_OFFSET UNITYSDK_OFFSET(0x78230C0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__SHOWSINGLEFAIRY_B__19_0_OFFSET UNITYSDK_OFFSET(0x7823230)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__SHOWSINGLEFAIRY_B__19_1_OFFSET UNITYSDK_OFFSET(0x78230F0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7823390)
#define NODEGRAPH_MAINCITY_SHOWFAIRY___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7823400)
#define NODEGRAPH_MAINCITY_SHOWFAIRY___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x7823460)
#define NODEGRAPH_MAINCITY_SHOWFAIRY___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x78234E0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int ShowFairy_TypeDefinitionIndex = 68586;

	class ShowFairy : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::NodeGraph::GraphOutputPort* _onFairyEnd; // 0x58
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::System::Int32>*>* fairyIdList; // 0x60
		::System::Collections::Generic::List_1<::System::Int32>* ikFairyList; // 0x68
		::NodeGraph::GraphInputValuePort* _fairyIdListPort; // 0x70
		::System::Action* _callback; // 0x78
		::System::Collections::Generic::List_1<::System::Int32>* _currentIdList; // 0x80
		::System::Single _timer; // 0x88
		::System::Int32 _currentIndex; // 0x8C
		::System::Int32 ikNpcTag; // 0x90
		::System::Boolean pushedIk; // 0x94
		::System::Boolean _started; // 0x95
		::System::Boolean _fairyFadeOut; // 0x96
		::System::Boolean _fairyFinish; // 0x97
		::System::Boolean useFairy; // 0x98
		::System::Boolean inPhotoPage; // 0x99
