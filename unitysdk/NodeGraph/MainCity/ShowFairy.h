...
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ADDIK_OFFSET UNITYSDK_OFFSET(0x6B6D1D0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_CLOSEIK_OFFSET UNITYSDK_OFFSET(0x6B6CFD0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONFAIRYDESTROYHANDLE_OFFSET UNITYSDK_OFFSET(0x6B6D3D0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONFAIRYFADEOUTHANDLE_OFFSET UNITYSDK_OFFSET(0x6B6DDD0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x6B6C2A0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6B6E220)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x6B6D940)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6B6BF40)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_REALSTART_OFFSET UNITYSDK_OFFSET(0x6B6C6A0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_SHOWSINGLEFAIRY_OFFSET UNITYSDK_OFFSET(0x6B6CC30)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__CTOR_OFFSET UNITYSDK_OFFSET(0x6B6BE50)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_0_OFFSET UNITYSDK_OFFSET(0x6B6E7F0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_1_OFFSET UNITYSDK_OFFSET(0x6B6EFC0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_2_OFFSET UNITYSDK_OFFSET(0x6B6F3D0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_3_OFFSET UNITYSDK_OFFSET(0x6B6F400)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_4_OFFSET UNITYSDK_OFFSET(0x6B6F430)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__SHOWSINGLEFAIRY_B__19_0_OFFSET UNITYSDK_OFFSET(0x6B6F5A0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__SHOWSINGLEFAIRY_B__19_1_OFFSET UNITYSDK_OFFSET(0x6B6F460)
#define NODEGRAPH_MAINCITY_SHOWFAIRY___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x6B6F700)
#define NODEGRAPH_MAINCITY_SHOWFAIRY___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6B6F770)
#define NODEGRAPH_MAINCITY_SHOWFAIRY___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x6B6F7D0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6B6F850)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int ShowFairy_TypeDefinitionIndex = 65461;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::Int32>* _currentIdList; // 0x68
		::System::Action* _callback; // 0x70
		...
		::System::Int32 ikNpcTag; // 0x8C
		::System::Boolean _fairyFinish; // 0x90
		::System::Boolean _fairyFadeOut; // 0x91
		::System::Boolean _started; // 0x92
		::System::Boolean inPhotoPage; // 0x93
		::System::Int32 _currentIndex; // 0x94
		::System::Boolean useFairy; // 0x98
		::System::Boolean pushedIk; // 0x99
