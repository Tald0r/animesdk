...
#define NODEGRAPH_MAINCITY_SETPOSITION_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x9BDD710)
#define NODEGRAPH_MAINCITY_SETPOSITION_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x9BDDFD0)
#define NODEGRAPH_MAINCITY_SETPOSITION_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x9BDD4A0)
#define NODEGRAPH_MAINCITY_SETPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x9BDD350)
#define NODEGRAPH_MAINCITY_SETPOSITION__ONREGISTERPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0x9BDE110)
#define NODEGRAPH_MAINCITY_SETPOSITION__ONREGISTERPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0x9BDE140)
#define NODEGRAPH_MAINCITY_SETPOSITION__ONREGISTERPARAM_B__5_2_OFFSET UNITYSDK_OFFSET(0x9BDE170)
#define NODEGRAPH_MAINCITY_SETPOSITION___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x9BDE1A0)
#define NODEGRAPH_MAINCITY_SETPOSITION___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x9BDE210)
#define NODEGRAPH_MAINCITY_SETPOSITION___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x9BDE290)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetPosition_TypeDefinitionIndex = 59524;
