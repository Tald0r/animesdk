...
#define NODEGRAPH_MAINCITY_SETPOSITION_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x8CE2B20)
#define NODEGRAPH_MAINCITY_SETPOSITION_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x8CE33D0)
#define NODEGRAPH_MAINCITY_SETPOSITION_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8CE28B0)
#define NODEGRAPH_MAINCITY_SETPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x8CE2760)
#define NODEGRAPH_MAINCITY_SETPOSITION__ONREGISTERPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0x8CE3510)
#define NODEGRAPH_MAINCITY_SETPOSITION__ONREGISTERPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0x8CE3540)
#define NODEGRAPH_MAINCITY_SETPOSITION__ONREGISTERPARAM_B__5_2_OFFSET UNITYSDK_OFFSET(0x8CE3570)
#define NODEGRAPH_MAINCITY_SETPOSITION___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x8CE35A0)
#define NODEGRAPH_MAINCITY_SETPOSITION___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x8CE3610)
#define NODEGRAPH_MAINCITY_SETPOSITION___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8CE3690)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetPosition_TypeDefinitionIndex = 70734;
