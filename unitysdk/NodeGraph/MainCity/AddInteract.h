...
#define NODEGRAPH_MAINCITY_ADDINTERACT_ACTIVEINTERACT_OFFSET UNITYSDK_OFFSET(0x8632EB0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_CHECKFEATUREPOINT_OFFSET UNITYSDK_OFFSET(0x8633930)
#define NODEGRAPH_MAINCITY_ADDINTERACT_CLEARINTERACT_OFFSET UNITYSDK_OFFSET(0x8633CF0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_CREATEINTERACTTRIGGER_OFFSET UNITYSDK_OFFSET(0x86322C0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_GETUID_OFFSET UNITYSDK_OFFSET(0x86332C0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_MATCHPARENT_OFFSET UNITYSDK_OFFSET(0x86327A0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONINTERACT_1_OFFSET UNITYSDK_OFFSET(0x8634C30)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONINTERACT_OFFSET UNITYSDK_OFFSET(0x8634750)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x8633ED0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x8634DD0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0x8635000)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x8633700)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x86320D0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONREMOVEINTERACTHANDLE_OFFSET UNITYSDK_OFFSET(0x8634990)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONTRIGGERENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x8632470)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONTRIGGEREXITCALLBACK_OFFSET UNITYSDK_OFFSET(0x8632B80)
#define NODEGRAPH_MAINCITY_ADDINTERACT_UNACTIVEINTERACT_OFFSET UNITYSDK_OFFSET(0x8633550)
#define NODEGRAPH_MAINCITY_ADDINTERACT__ACTIVEINTERACT_B__15_0_OFFSET UNITYSDK_OFFSET(0x8635250)
#define NODEGRAPH_MAINCITY_ADDINTERACT__CREATEINTERACTTRIGGER_B__11_0_OFFSET UNITYSDK_OFFSET(0x8635230)
#define NODEGRAPH_MAINCITY_ADDINTERACT__CREATEINTERACTTRIGGER_B__11_1_OFFSET UNITYSDK_OFFSET(0x8635240)
#define NODEGRAPH_MAINCITY_ADDINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x8631F30)
#define NODEGRAPH_MAINCITY_ADDINTERACT__ONREGISTERPARAM_B__10_0_OFFSET UNITYSDK_OFFSET(0x86351D0)
#define NODEGRAPH_MAINCITY_ADDINTERACT__ONREGISTERPARAM_B__10_1_OFFSET UNITYSDK_OFFSET(0x8635200)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x8635260)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x86352D0)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0x8635330)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x8635340)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x86353C0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int AddInteract_TypeDefinitionIndex = 65595;

	class AddInteract : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::MoleMole::FeaturePoint* _currentPoint; // 0x58
		::MoleMole::MonoFeaturePoint* _featurePoints; // 0x60
		::NodeGraph::MainCity::InteractiveNavigateContainer* _interactiveNavigateContainer; // 0x68
		::NodeGraph::GraphOutputPort* _onInteract; // 0x70
		::MoleMole::Battle::Entity* _triggerEntity; // 0x78
		::System::Boolean _addedInteract; // 0x80
		::System::Boolean _inTrigger; // 0x81
		::System::Int32 interactId; // 0x84
		::System::Int32 targetNpcTag; // 0x88
		...
		::System::Void CreateInteractTrigger(::MoleMole::Battle::Entity* entity, ::Class_1_6DA7B27D0F38CD4F* interactConfig)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::Battle::Entity*, ::Class_1_6DA7B27D0F38CD4F*))((::PBYTE)hIl2Cpp + NODEGRAPH_MAINCITY_ADDINTERACT_CREATEINTERACTTRIGGER_OFFSET))(this, entity, interactConfig);
		}
