...
#define NODEGRAPH_MAINCITY_ADDINTERACT_ACTIVEINTERACT_OFFSET UNITYSDK_OFFSET(0x7652E50)
#define NODEGRAPH_MAINCITY_ADDINTERACT_CHECKFEATUREPOINT_OFFSET UNITYSDK_OFFSET(0x76538D0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_CLEARINTERACT_OFFSET UNITYSDK_OFFSET(0x7653C90)
#define NODEGRAPH_MAINCITY_ADDINTERACT_CREATEINTERACTTRIGGER_OFFSET UNITYSDK_OFFSET(0x7652260)
#define NODEGRAPH_MAINCITY_ADDINTERACT_GETUID_OFFSET UNITYSDK_OFFSET(0x7653260)
#define NODEGRAPH_MAINCITY_ADDINTERACT_MATCHPARENT_OFFSET UNITYSDK_OFFSET(0x7652740)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONINTERACT_1_OFFSET UNITYSDK_OFFSET(0x7654BD0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONINTERACT_OFFSET UNITYSDK_OFFSET(0x7654700)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7653E70)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7654D70)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0x7654FA0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x76536A0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7652070)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONREMOVEINTERACTHANDLE_OFFSET UNITYSDK_OFFSET(0x7654930)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONTRIGGERENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x7652410)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONTRIGGEREXITCALLBACK_OFFSET UNITYSDK_OFFSET(0x7652B20)
#define NODEGRAPH_MAINCITY_ADDINTERACT_UNACTIVEINTERACT_OFFSET UNITYSDK_OFFSET(0x76534F0)
#define NODEGRAPH_MAINCITY_ADDINTERACT__ACTIVEINTERACT_B__15_0_OFFSET UNITYSDK_OFFSET(0x76551F0)
#define NODEGRAPH_MAINCITY_ADDINTERACT__CREATEINTERACTTRIGGER_B__11_0_OFFSET UNITYSDK_OFFSET(0x76551D0)
#define NODEGRAPH_MAINCITY_ADDINTERACT__CREATEINTERACTTRIGGER_B__11_1_OFFSET UNITYSDK_OFFSET(0x76551E0)
#define NODEGRAPH_MAINCITY_ADDINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x7651ED0)
#define NODEGRAPH_MAINCITY_ADDINTERACT__ONREGISTERPARAM_B__10_0_OFFSET UNITYSDK_OFFSET(0x7655170)
#define NODEGRAPH_MAINCITY_ADDINTERACT__ONREGISTERPARAM_B__10_1_OFFSET UNITYSDK_OFFSET(0x76551A0)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7655200)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7655270)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0x76552D0)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x76552E0)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7655360)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int AddInteract_TypeDefinitionIndex = 41506;

	class AddInteract : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::NodeGraph::GraphOutputPort* _onInteract; // 0x58
		::MoleMole::FeaturePoint* _currentPoint; // 0x60
		...
		::System::Int32 targetNpcTag; // 0x80
