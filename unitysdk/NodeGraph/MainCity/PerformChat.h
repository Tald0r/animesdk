...
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x6FB72E0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6FB7D20)
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x6FB7850)
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONPERFORMCALLBACK_OFFSET UNITYSDK_OFFSET(0x6FB78D0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6FB6F80)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__CTOR_OFFSET UNITYSDK_OFFSET(0x6FB6DD0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONNODEACTIVEWITHSTATE_B__9_0_OFFSET UNITYSDK_OFFSET(0x6FB84B0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONNODEACTIVEWITHSTATE_B__9_1_OFFSET UNITYSDK_OFFSET(0x6FB8650)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_0_OFFSET UNITYSDK_OFFSET(0x6FB8060)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_1_OFFSET UNITYSDK_OFFSET(0x6FB8090)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_2_OFFSET UNITYSDK_OFFSET(0x6FB80C0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_3_OFFSET UNITYSDK_OFFSET(0x6FB8450)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_4_OFFSET UNITYSDK_OFFSET(0x6FB8480)
#define NODEGRAPH_MAINCITY_PERFORMCHAT___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x6FB87F0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6FB8860)
#define NODEGRAPH_MAINCITY_PERFORMCHAT___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x6FB88C0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6FB8940)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int PerformChat_TypeDefinitionIndex = 79183;
	...
	public:
		...
		::System::Boolean _end; // 0x68
		::System::Boolean waitTransitionFadeOut; // 0x69
		::System::Int32 performId; // 0x6C
		::System::Int32 targetNpcTag; // 0x70
