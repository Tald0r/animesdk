...
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7459100)
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7459B40)
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x7459670)
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONPERFORMCALLBACK_OFFSET UNITYSDK_OFFSET(0x74596F0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7458DA0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__CTOR_OFFSET UNITYSDK_OFFSET(0x7458BF0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONNODEACTIVEWITHSTATE_B__9_0_OFFSET UNITYSDK_OFFSET(0x745A2D0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONNODEACTIVEWITHSTATE_B__9_1_OFFSET UNITYSDK_OFFSET(0x745A460)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_0_OFFSET UNITYSDK_OFFSET(0x7459E80)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_1_OFFSET UNITYSDK_OFFSET(0x7459EB0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_2_OFFSET UNITYSDK_OFFSET(0x7459EE0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_3_OFFSET UNITYSDK_OFFSET(0x745A270)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_4_OFFSET UNITYSDK_OFFSET(0x745A2A0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x745A600)
#define NODEGRAPH_MAINCITY_PERFORMCHAT___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x745A670)
#define NODEGRAPH_MAINCITY_PERFORMCHAT___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x745A6D0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x745A750)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int PerformChat_TypeDefinitionIndex = 78989;
	...
	public:
		...
		::System::Boolean waitTransitionFadeOut; // 0x68
		::System::Boolean _end; // 0x69
		::System::Int32 performId; // 0x6C
		::System::Single blackFadeInTime; // 0x70
		::System::Int32 targetNpcTag; // 0x74
		...
		::System::Void OnPerformCallback(::Class_1_BC9D27E6028F322B* obj)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_BC9D27E6028F322B*))((::PBYTE)hIl2Cpp + NODEGRAPH_MAINCITY_PERFORMCHAT_ONPERFORMCALLBACK_OFFSET))(this, obj);
		}
