...
#define NODEGRAPH_MAINCITY_SETAIACTIVE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x9BDCA80)
#define NODEGRAPH_MAINCITY_SETAIACTIVE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x9BDCE70)
#define NODEGRAPH_MAINCITY_SETAIACTIVE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x9BDCC70)
#define NODEGRAPH_MAINCITY_SETAIACTIVE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x9BDC890)
#define NODEGRAPH_MAINCITY_SETAIACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9BDC740)
#define NODEGRAPH_MAINCITY_SETAIACTIVE__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x9BDD130)
#define NODEGRAPH_MAINCITY_SETAIACTIVE__ONREGISTERPARAM_B__3_1_OFFSET UNITYSDK_OFFSET(0x9BDD160)
#define NODEGRAPH_MAINCITY_SETAIACTIVE___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x9BDD190)
#define NODEGRAPH_MAINCITY_SETAIACTIVE___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x9BDD200)
#define NODEGRAPH_MAINCITY_SETAIACTIVE___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x9BDD260)
#define NODEGRAPH_MAINCITY_SETAIACTIVE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x9BDD2E0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetAIActive_TypeDefinitionIndex = 57342;
