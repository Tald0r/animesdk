...
#define NODEGRAPH_MAINCITY_SETAIACTIVE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x8CE1E90)
#define NODEGRAPH_MAINCITY_SETAIACTIVE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x8CE2280)
#define NODEGRAPH_MAINCITY_SETAIACTIVE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x8CE2080)
#define NODEGRAPH_MAINCITY_SETAIACTIVE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8CE1CA0)
#define NODEGRAPH_MAINCITY_SETAIACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x8CE1B50)
#define NODEGRAPH_MAINCITY_SETAIACTIVE__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x8CE2540)
#define NODEGRAPH_MAINCITY_SETAIACTIVE__ONREGISTERPARAM_B__3_1_OFFSET UNITYSDK_OFFSET(0x8CE2570)
#define NODEGRAPH_MAINCITY_SETAIACTIVE___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x8CE25A0)
#define NODEGRAPH_MAINCITY_SETAIACTIVE___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x8CE2610)
#define NODEGRAPH_MAINCITY_SETAIACTIVE___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x8CE2670)
#define NODEGRAPH_MAINCITY_SETAIACTIVE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8CE26F0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetAIActive_TypeDefinitionIndex = 75980;
