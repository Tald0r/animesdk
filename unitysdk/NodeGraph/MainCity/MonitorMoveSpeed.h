...
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONANIMATORSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x76571E0)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONLOCALAVATARANIMATORSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x7656B30)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7656550)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7657770)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x7657820)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x76563E0)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x7656290)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x76578D0)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7657900)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7657910)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x7657970)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x76579D0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int MonitorMoveSpeed_TypeDefinitionIndex = 43382;
