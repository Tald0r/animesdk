...
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONANIMATORSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x8637230)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONLOCALAVATARANIMATORSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x8636B80)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x86365A0)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x86377C0)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x8637870)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8636430)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x86362E0)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x8637920)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x8637950)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x8637960)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x86379C0)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8637A20)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int MonitorMoveSpeed_TypeDefinitionIndex = 44980;
