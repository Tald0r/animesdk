...
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONENTITYREADYCALLBACK_OFFSET UNITYSDK_OFFSET(0x7FC3A70)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7FC2D80)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7FC45F0)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x7FC3000)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7FC2B90)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x7FC2980)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x7FC4A00)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x7FC4ED0)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7FC4F00)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7FC4F70)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x7FC4FD0)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7FC5050)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CreateMainCityNpc_TypeDefinitionIndex = 41374;
