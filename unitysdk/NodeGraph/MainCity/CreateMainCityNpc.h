...
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONENTITYREADYCALLBACK_OFFSET UNITYSDK_OFFSET(0x6BC46E0)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x6BC3A00)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6BC5200)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x6BC3C80)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6BC3810)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x6BC3600)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x6BC5610)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x6BC5AE0)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x6BC5B10)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6BC5B80)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x6BC5BE0)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6BC5C60)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CreateMainCityNpc_TypeDefinitionIndex = 63094;

	class CreateMainCityNpc : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::System::Collections::Generic::List_1<::NodeGraph::MainCity::CreateMainCityNpc_SNpcInfo>* mainCityNpcTagList; // 0x58
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* _entity; // 0x60
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* _delEntity; // 0x68
