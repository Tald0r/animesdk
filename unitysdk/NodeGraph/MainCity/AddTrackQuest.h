...
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7458320)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7457FC0)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x7457E20)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x7458A80)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x7458AB0)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_2_OFFSET UNITYSDK_OFFSET(0x7458AE0)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_3_OFFSET UNITYSDK_OFFSET(0x7458B10)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_4_OFFSET UNITYSDK_OFFSET(0x7458B40)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7458B70)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7458B80)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int AddTrackQuest_TypeDefinitionIndex = 37594;
