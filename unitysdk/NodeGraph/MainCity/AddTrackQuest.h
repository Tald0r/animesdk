...
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6FB6350)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6FB5FF0)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x6FB5E50)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x6FB6AB0)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x6FB6AE0)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_2_OFFSET UNITYSDK_OFFSET(0x6FB6B10)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_3_OFFSET UNITYSDK_OFFSET(0x6FB6B40)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_4_OFFSET UNITYSDK_OFFSET(0x6FB6B70)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6FB6BA0)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6FB6BB0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int AddTrackQuest_TypeDefinitionIndex = 38377;
