...
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x78660F0)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7866320)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x78665F0)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7865F00)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS__CTOR_OFFSET UNITYSDK_OFFSET(0x7865DB0)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x7866830)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS__ONREGISTERPARAM_B__3_1_OFFSET UNITYSDK_OFFSET(0x7866860)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7866890)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x78668A0)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x7866900)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7866960)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetRigidbodyMass_TypeDefinitionIndex = 67533;
