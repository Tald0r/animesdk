...
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6EDD350)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6EDD580)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x6EDD860)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6EDD160)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS__CTOR_OFFSET UNITYSDK_OFFSET(0x6EDD010)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x6EDDAA0)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS__ONREGISTERPARAM_B__3_1_OFFSET UNITYSDK_OFFSET(0x6EDDAD0)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6EDDB00)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6EDDB10)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x6EDDB70)
#define NODEGRAPH_MAINCITY_SETRIGIDBODYMASS___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6EDDBD0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetRigidbodyMass_TypeDefinitionIndex = 61400;
