...
#define NODEGRAPH_MAINCITY_CHECKCROWDDITHER_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x698A2F0)
#define NODEGRAPH_MAINCITY_CHECKCROWDDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x698A1E0)
#define NODEGRAPH_MAINCITY_CHECKCROWDDITHER___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x698A860)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckCrowdDither_TypeDefinitionIndex = 64617;
