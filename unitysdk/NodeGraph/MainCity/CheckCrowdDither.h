...
#define NODEGRAPH_MAINCITY_CHECKCROWDDITHER_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x6309450)
#define NODEGRAPH_MAINCITY_CHECKCROWDDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x6309340)
#define NODEGRAPH_MAINCITY_CHECKCROWDDITHER___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x63099C0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckCrowdDither_TypeDefinitionIndex = 37977;
