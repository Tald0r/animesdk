...
#define NODEGRAPH_MAINCITY_WAITNAVMESH_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7E1C380)
#define NODEGRAPH_MAINCITY_WAITNAVMESH_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x7E1C410)
#define NODEGRAPH_MAINCITY_WAITNAVMESH_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7E1C190)
#define NODEGRAPH_MAINCITY_WAITNAVMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x7E1BFD0)
#define NODEGRAPH_MAINCITY_WAITNAVMESH__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x7E1C950)
#define NODEGRAPH_MAINCITY_WAITNAVMESH__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x7E1C980)
#define NODEGRAPH_MAINCITY_WAITNAVMESH___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7E1C9B0)
#define NODEGRAPH_MAINCITY_WAITNAVMESH___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x7E1CA20)
#define NODEGRAPH_MAINCITY_WAITNAVMESH___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7E1CAA0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitNavMesh_TypeDefinitionIndex = 70777;
