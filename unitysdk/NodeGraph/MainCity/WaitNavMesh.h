...
#define NODEGRAPH_MAINCITY_WAITNAVMESH_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x653B180)
#define NODEGRAPH_MAINCITY_WAITNAVMESH_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x653B210)
#define NODEGRAPH_MAINCITY_WAITNAVMESH_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x653AF90)
#define NODEGRAPH_MAINCITY_WAITNAVMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x653ADD0)
#define NODEGRAPH_MAINCITY_WAITNAVMESH__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x653B740)
#define NODEGRAPH_MAINCITY_WAITNAVMESH__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x653B770)
#define NODEGRAPH_MAINCITY_WAITNAVMESH___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x653B7A0)
#define NODEGRAPH_MAINCITY_WAITNAVMESH___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x653B810)
#define NODEGRAPH_MAINCITY_WAITNAVMESH___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x653B890)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitNavMesh_TypeDefinitionIndex = 41914;
	...
	public:
		...
		::System::Single _timer; // 0x68
		::System::Single seconds; // 0x6C
