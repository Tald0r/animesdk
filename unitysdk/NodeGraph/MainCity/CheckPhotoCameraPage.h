...
#define NODEGRAPH_MAINCITY_CHECKPHOTOCAMERAPAGE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0xC302EB0)
#define NODEGRAPH_MAINCITY_CHECKPHOTOCAMERAPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC3020C0)
#define NODEGRAPH_MAINCITY_CHECKPHOTOCAMERAPAGE___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0xC303000)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckPhotoCameraPage_TypeDefinitionIndex = 39159;
