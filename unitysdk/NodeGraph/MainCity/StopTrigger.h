...
#define NODEGRAPH_MAINCITY_STOPTRIGGER_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7E1B200)
#define NODEGRAPH_MAINCITY_STOPTRIGGER_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7E1B090)
#define NODEGRAPH_MAINCITY_STOPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x7E1AF40)
#define NODEGRAPH_MAINCITY_STOPTRIGGER__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x7E1B540)
#define NODEGRAPH_MAINCITY_STOPTRIGGER___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7E1B570)
#define NODEGRAPH_MAINCITY_STOPTRIGGER___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7E1B650)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int StopTrigger_TypeDefinitionIndex = 41036;
