...
#define NODEGRAPH_MAINCITY_STOPTRIGGER_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x653A000)
#define NODEGRAPH_MAINCITY_STOPTRIGGER_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6539E90)
#define NODEGRAPH_MAINCITY_STOPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x6539D40)
#define NODEGRAPH_MAINCITY_STOPTRIGGER__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x653A340)
#define NODEGRAPH_MAINCITY_STOPTRIGGER___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x653A370)
#define NODEGRAPH_MAINCITY_STOPTRIGGER___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x653A450)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int StopTrigger_TypeDefinitionIndex = 79472;
