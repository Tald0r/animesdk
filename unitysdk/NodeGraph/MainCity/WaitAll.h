...
#define NODEGRAPH_MAINCITY_WAITALL_CLEARDIC_OFFSET UNITYSDK_OFFSET(0x7657F10)
#define NODEGRAPH_MAINCITY_WAITALL_ONACTIVEPORT_OFFSET UNITYSDK_OFFSET(0x7657C60)
#define NODEGRAPH_MAINCITY_WAITALL_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7657C00)
#define NODEGRAPH_MAINCITY_WAITALL_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x76582D0)
#define NODEGRAPH_MAINCITY_WAITALL_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x7658380)
#define NODEGRAPH_MAINCITY_WAITALL_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7657A90)
#define NODEGRAPH_MAINCITY_WAITALL__CTOR_OFFSET UNITYSDK_OFFSET(0x7657A40)
#define NODEGRAPH_MAINCITY_WAITALL__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x7658430)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONACTIVEPORT_OFFSET UNITYSDK_OFFSET(0x7658830)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x76588A0)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7658910)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x7658970)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x76589D0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitAll_TypeDefinitionIndex = 64075;
