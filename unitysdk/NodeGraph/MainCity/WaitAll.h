...
#define NODEGRAPH_MAINCITY_WAITALL_CLEARDIC_OFFSET UNITYSDK_OFFSET(0x8637F50)
#define NODEGRAPH_MAINCITY_WAITALL_ONACTIVEPORT_OFFSET UNITYSDK_OFFSET(0x8637CB0)
#define NODEGRAPH_MAINCITY_WAITALL_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x8637C50)
#define NODEGRAPH_MAINCITY_WAITALL_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x8638310)
#define NODEGRAPH_MAINCITY_WAITALL_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x86383C0)
#define NODEGRAPH_MAINCITY_WAITALL_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8637AE0)
#define NODEGRAPH_MAINCITY_WAITALL__CTOR_OFFSET UNITYSDK_OFFSET(0x8637A90)
#define NODEGRAPH_MAINCITY_WAITALL__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x8638470)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONACTIVEPORT_OFFSET UNITYSDK_OFFSET(0x8638870)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x86388E0)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x8638950)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x86389B0)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8638A10)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitAll_TypeDefinitionIndex = 47974;
