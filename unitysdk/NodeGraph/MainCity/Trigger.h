...
#define NODEGRAPH_MAINCITY_TRIGGER_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x6309A20)
#define NODEGRAPH_MAINCITY_TRIGGER_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x630BBA0)
#define NODEGRAPH_MAINCITY_TRIGGER_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x630BEE0)
#define NODEGRAPH_MAINCITY_TRIGGER_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x630B7D0)
#define NODEGRAPH_MAINCITY_TRIGGER_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0x630C540)
#define NODEGRAPH_MAINCITY_TRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x6309350)
#define NODEGRAPH_MAINCITY_TRIGGER__ONREGISTERPARAM_B__13_0_OFFSET UNITYSDK_OFFSET(0x630C5A0)
#define NODEGRAPH_MAINCITY_TRIGGER__ONREGISTERPARAM_B__13_1_OFFSET UNITYSDK_OFFSET(0x630C5D0)
#define NODEGRAPH_MAINCITY_TRIGGER__ONREGISTERPARAM_B__13_2_OFFSET UNITYSDK_OFFSET(0x630C600)
#define NODEGRAPH_MAINCITY_TRIGGER__ONREGISTERPARAM_B__13_3_OFFSET UNITYSDK_OFFSET(0x630C640)
#define NODEGRAPH_MAINCITY_TRIGGER__ONREGISTERPARAM_B__13_4_OFFSET UNITYSDK_OFFSET(0x630C670)
#define NODEGRAPH_MAINCITY_TRIGGER__ONREGISTERPARAM_B__13_5_OFFSET UNITYSDK_OFFSET(0x630C6A0)
#define NODEGRAPH_MAINCITY_TRIGGER___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x630C6D0)
#define NODEGRAPH_MAINCITY_TRIGGER___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x630C7B0)
#define NODEGRAPH_MAINCITY_TRIGGER___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x630C740)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int Trigger_TypeDefinitionIndex = 64860;
	...
	public:
		...
		::System::Single triggerDelta; // 0x68
		::System::Int32 _triggerLocalCount; // 0x6C
		::System::Single _triggerTimer; // 0x70
		::System::Int32 repeatCount; // 0x74
		::System::Single _cdTimer; // 0x78
		::System::Boolean InGroup; // 0x7C
		::System::Boolean invert; // 0x7D
		::System::Boolean saveToSpecial; // 0x7E
		::System::Boolean CheckResultByGroup; // 0x7F
		::System::Single conditionDuration; // 0x80
