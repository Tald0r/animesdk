...
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x752C700)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x752C940)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x752C490)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x752C340)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONNODEACTIVEWITHSTATE_B__7_0_OFFSET UNITYSDK_OFFSET(0x752CB60)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONREGISTERPARAM_B__6_0_OFFSET UNITYSDK_OFFSET(0x752CAD0)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONREGISTERPARAM_B__6_1_OFFSET UNITYSDK_OFFSET(0x752CB00)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONREGISTERPARAM_B__6_2_OFFSET UNITYSDK_OFFSET(0x752CB30)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x752CB70)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x752CBE0)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x752CC60)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetBlackCurtain_TypeDefinitionIndex = 55559;
