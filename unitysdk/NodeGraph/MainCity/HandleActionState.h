...
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x99B1620)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x99B1430)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x99B1290)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x99B18E0)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x99B1910)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x99B1940)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x99B1950)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int HandleActionState_TypeDefinitionIndex = 63456;
