...
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x9B0D7E0)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x9B0D5F0)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B0D450)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x9B0DAA0)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x9B0DAD0)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x9B0DB00)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x9B0DB10)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int HandleActionState_TypeDefinitionIndex = 70072;
