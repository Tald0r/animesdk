...
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR_GETTARGETFORWARD_OFFSET UNITYSDK_OFFSET(0x630A230)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR_GETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x6309F60)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x6309C30)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6309A90)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x6309A80)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x630A5C0)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR__ONREGISTERPARAM_B__3_1_OFFSET UNITYSDK_OFFSET(0x630A5F0)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR___BASE_GETTARGETFORWARD_OFFSET UNITYSDK_OFFSET(0x630A620)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR___BASE_GETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x630A650)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x630A680)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x630A690)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RotateToLocalAvatar_TypeDefinitionIndex = 53766;
