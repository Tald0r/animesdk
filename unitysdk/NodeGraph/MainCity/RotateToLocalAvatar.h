...
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR_GETTARGETFORWARD_OFFSET UNITYSDK_OFFSET(0x698B0D0)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR_GETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x698AE00)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x698AAD0)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x698A930)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x698A920)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x698B460)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR__ONREGISTERPARAM_B__3_1_OFFSET UNITYSDK_OFFSET(0x698B490)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR___BASE_GETTARGETFORWARD_OFFSET UNITYSDK_OFFSET(0x698B4C0)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR___BASE_GETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x698B4F0)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x698B520)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x698B530)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RotateToLocalAvatar_TypeDefinitionIndex = 64866;
