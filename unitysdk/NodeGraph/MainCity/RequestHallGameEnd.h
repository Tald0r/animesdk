...
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x99B1D60)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x99B1B70)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x99B19C0)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND__ONREGISTERPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0x99B2760)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND__ONREGISTERPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0x99B27C0)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x99B27F0)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x99B2800)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RequestHallGameEnd_TypeDefinitionIndex = 72825;

	class RequestHallGameEnd : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::NodeGraph::GraphInputValuePort* _specialInput; // 0x58
		::NodeGraph::GraphInputValuePort* _specialInput2; // 0x60
