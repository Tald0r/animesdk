...
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x9B0DF20)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x9B0DD30)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x9B0DB80)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND__ONREGISTERPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0x9B0E910)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND__ONREGISTERPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0x9B0E970)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x9B0E9A0)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x9B0E9B0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RequestHallGameEnd_TypeDefinitionIndex = 72519;
