...
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST_ONCLICKPHOTOCLOSE_OFFSET UNITYSDK_OFFSET(0x6A2D070)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST_ONFINISHHANDLE_OFFSET UNITYSDK_OFFSET(0x6A2C4C0)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x6A2C050)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6A2CA80)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0x6A2CDB0)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6A2BD70)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x6A2BC70)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST__ONCLICKPHOTOCLOSE_B__12_0_OFFSET UNITYSDK_OFFSET(0x6A2D3F0)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST__ONCLICKPHOTOCLOSE_B__12_1_OFFSET UNITYSDK_OFFSET(0x6A2D7F0)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x6A2D330)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x6A2D360)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST__ONREGISTERPARAM_B__7_2_OFFSET UNITYSDK_OFFSET(0x6A2D390)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST__ONREGISTERPARAM_B__7_3_OFFSET UNITYSDK_OFFSET(0x6A2D3C0)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x6A2D810)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6A2D880)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST___BASE_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0x6A2D8E0)
#define NODEGRAPH_MAINCITY_ADDPHOTOQUEST___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6A2D8F0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int AddPhotoQuest_TypeDefinitionIndex = 63074;
	...
	public:
		...
		::System::Single DelayTime; // 0x68
		::System::Single FadeTime; // 0x6C
		::System::Int32 photoQuestId; // 0x70
