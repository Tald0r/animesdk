...
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x7655500)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x76553E0)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x76553D0)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x76556B0)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x76556E0)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7655740)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckEntityReady_TypeDefinitionIndex = 78721;
