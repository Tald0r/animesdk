...
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x8635560)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8635440)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x8635430)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x8635710)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x8635740)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x86357A0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckEntityReady_TypeDefinitionIndex = 42784;
