...
#define NODEGRAPH_MAINCITY_SPLIT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x74B86A0)
#define NODEGRAPH_MAINCITY_SPLIT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x74B8530)
#define NODEGRAPH_MAINCITY_SPLIT__CTOR_OFFSET UNITYSDK_OFFSET(0x74B8480)
#define NODEGRAPH_MAINCITY_SPLIT__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x74B8860)
#define NODEGRAPH_MAINCITY_SPLIT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x74B8C20)
#define NODEGRAPH_MAINCITY_SPLIT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x74B8C30)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int Split_TypeDefinitionIndex = 73841;
