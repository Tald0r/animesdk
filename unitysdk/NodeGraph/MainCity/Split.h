...
#define NODEGRAPH_MAINCITY_SPLIT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6FBD420)
#define NODEGRAPH_MAINCITY_SPLIT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6FBD2B0)
#define NODEGRAPH_MAINCITY_SPLIT__CTOR_OFFSET UNITYSDK_OFFSET(0x6FBD200)
#define NODEGRAPH_MAINCITY_SPLIT__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x6FBD5E0)
#define NODEGRAPH_MAINCITY_SPLIT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6FBD9A0)
#define NODEGRAPH_MAINCITY_SPLIT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6FBD9B0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int Split_TypeDefinitionIndex = 62563;
