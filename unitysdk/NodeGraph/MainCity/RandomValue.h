...
#define NODEGRAPH_MAINCITY_RANDOMVALUE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6B6B7E0)
#define NODEGRAPH_MAINCITY_RANDOMVALUE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6B6B670)
#define NODEGRAPH_MAINCITY_RANDOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x6B6B4D0)
#define NODEGRAPH_MAINCITY_RANDOMVALUE__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x6B6BA40)
#define NODEGRAPH_MAINCITY_RANDOMVALUE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6B6BDD0)
#define NODEGRAPH_MAINCITY_RANDOMVALUE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6B6BDE0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RandomValue_TypeDefinitionIndex = 59236;
