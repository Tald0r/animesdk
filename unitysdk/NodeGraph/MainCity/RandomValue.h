...
#define NODEGRAPH_MAINCITY_RANDOMVALUE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x781F480)
#define NODEGRAPH_MAINCITY_RANDOMVALUE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x781F310)
#define NODEGRAPH_MAINCITY_RANDOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x781F170)
#define NODEGRAPH_MAINCITY_RANDOMVALUE__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x781F6E0)
#define NODEGRAPH_MAINCITY_RANDOMVALUE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x781FA70)
#define NODEGRAPH_MAINCITY_RANDOMVALUE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x781FA80)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RandomValue_TypeDefinitionIndex = 56848;
