...
#define NODEGRAPH_MAINCITY_WAITAIACTIVE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x653A780)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x653A9D0)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x653A610)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x653A4C0)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x653AC40)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x653AC70)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x653ACE0)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x653AD60)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitAIActive_TypeDefinitionIndex = 61172;
