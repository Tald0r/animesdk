...
#define NODEGRAPH_MAINCITY_WAITAIACTIVE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7E1B980)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x7E1BBD0)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7E1B810)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x7E1B6C0)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x7E1BE40)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7E1BE70)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x7E1BEE0)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7E1BF60)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitAIActive_TypeDefinitionIndex = 71760;
