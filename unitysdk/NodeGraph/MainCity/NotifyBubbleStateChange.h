...
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6429F10)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x642A260)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6429D20)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x6429BD0)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x642A4E0)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE__ONREGISTERPARAM_B__3_1_OFFSET UNITYSDK_OFFSET(0x642A510)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x642A540)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x642A550)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x642A5B0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int NotifyBubbleStateChange_TypeDefinitionIndex = 41877;
