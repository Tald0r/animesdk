...
#define NODEGRAPH_MAINCITY_ADDEFFECT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6535E50)
#define NODEGRAPH_MAINCITY_ADDEFFECT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6535BE0)
#define NODEGRAPH_MAINCITY_ADDEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x6535A90)
#define NODEGRAPH_MAINCITY_ADDEFFECT__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x65361B0)
#define NODEGRAPH_MAINCITY_ADDEFFECT__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x65361E0)
#define NODEGRAPH_MAINCITY_ADDEFFECT__ONREGISTERPARAM_B__4_2_OFFSET UNITYSDK_OFFSET(0x6536210)
#define NODEGRAPH_MAINCITY_ADDEFFECT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6536240)
#define NODEGRAPH_MAINCITY_ADDEFFECT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6536320)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int AddEffect_TypeDefinitionIndex = 50046;
