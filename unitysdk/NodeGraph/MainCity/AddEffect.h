...
#define NODEGRAPH_MAINCITY_ADDEFFECT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7E17020)
#define NODEGRAPH_MAINCITY_ADDEFFECT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7E16DB0)
#define NODEGRAPH_MAINCITY_ADDEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x7E16C60)
#define NODEGRAPH_MAINCITY_ADDEFFECT__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x7E17380)
#define NODEGRAPH_MAINCITY_ADDEFFECT__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x7E173B0)
#define NODEGRAPH_MAINCITY_ADDEFFECT__ONREGISTERPARAM_B__4_2_OFFSET UNITYSDK_OFFSET(0x7E173E0)
#define NODEGRAPH_MAINCITY_ADDEFFECT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7E17410)
#define NODEGRAPH_MAINCITY_ADDEFFECT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7E174F0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int AddEffect_TypeDefinitionIndex = 38840;
