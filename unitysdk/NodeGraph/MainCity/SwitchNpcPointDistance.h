...
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6051380)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6051110)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x6051040)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x60516C0)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x60516F0)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE__ONREGISTERPARAM_B__7_2_OFFSET UNITYSDK_OFFSET(0x6051720)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6051850)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6051860)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SwitchNpcPointDistance_TypeDefinitionIndex = 73061;

	class SwitchNpcPointDistance : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::NodeGraph::GraphOutputPort* False; // 0x58
		::System::String* centerPos; // 0x60
		::NodeGraph::GraphOutputPort* True; // 0x68
		::NodeGraph::GraphInputValuePort* _centerPort; // 0x70
