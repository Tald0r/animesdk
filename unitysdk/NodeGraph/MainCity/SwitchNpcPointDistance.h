...
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6A174C0)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6A17250)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x6A17180)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x6A17800)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x6A17830)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE__ONREGISTERPARAM_B__7_2_OFFSET UNITYSDK_OFFSET(0x6A17860)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6A17990)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6A179A0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SwitchNpcPointDistance_TypeDefinitionIndex = 71402;
