...
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x6EDA640)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_ISMATCHIDLESTANDBYCONDITION_OFFSET UNITYSDK_OFFSET(0x6EDACA0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x6EDA4F0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6EDA3D0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x6EDA3C0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x6EDAEB0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x6EDAEE0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x6EDAF40)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6EDAF50)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckPlayerIdle_TypeDefinitionIndex = 72320;
