...
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x78633E0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_ISMATCHIDLESTANDBYCONDITION_OFFSET UNITYSDK_OFFSET(0x7863A40)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7863290)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7863170)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x7863160)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x7863C50)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x7863C80)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7863CE0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7863CF0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckPlayerIdle_TypeDefinitionIndex = 67736;
