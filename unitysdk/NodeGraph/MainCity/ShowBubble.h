...
#define NODEGRAPH_MAINCITY_SHOWBUBBLE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x99B2D00)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x99B2A20)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x99B2870)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x99B3890)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x99B38C0)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__ONREGISTERPARAM_B__7_2_OFFSET UNITYSDK_OFFSET(0x99B3CA0)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__ONREGISTERPARAM_B__7_3_OFFSET UNITYSDK_OFFSET(0x99B3CD0)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x99B3D00)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x99B3D10)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int ShowBubble_TypeDefinitionIndex = 44612;
	...
	public:
		...
		::NodeGraph::GraphInputValuePort* _bubbleInput; // 0x68
