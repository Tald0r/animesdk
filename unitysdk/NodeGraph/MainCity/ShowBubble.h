...
#define NODEGRAPH_MAINCITY_SHOWBUBBLE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x9B0EEB0)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x9B0EBD0)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B0EA20)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x9B0FA40)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x9B0FA70)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__ONREGISTERPARAM_B__7_2_OFFSET UNITYSDK_OFFSET(0x9B0FE50)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__ONREGISTERPARAM_B__7_3_OFFSET UNITYSDK_OFFSET(0x9B0FE80)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x9B0FEB0)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x9B0FEC0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int ShowBubble_TypeDefinitionIndex = 60297;

	class ShowBubble : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::NodeGraph::GraphInputValuePort* _npcTagInput; // 0x58
