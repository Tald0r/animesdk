...
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONACTIVATECAMERAMODE_OFFSET UNITYSDK_OFFSET(0x6EDC970)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONDEACTIVATECAMERAMODE_OFFSET UNITYSDK_OFFSET(0x6EDC540)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x6EDB320)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6EDC200)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x6EDBEC0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x6EDBBD0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6EDB0B0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI__CTOR_OFFSET UNITYSDK_OFFSET(0x6EDAF60)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI__ONREGISTERPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0x6EDCD60)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI__ONREGISTERPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0x6EDCD90)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI__ONREGISTERPARAM_B__5_2_OFFSET UNITYSDK_OFFSET(0x6EDCDC0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x6EDCDF0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6EDCE60)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x6EDCEC0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x6EDCF20)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6EDCFA0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int EnableBehaviourAI_TypeDefinitionIndex = 59750;
