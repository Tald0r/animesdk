...
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONACTIVATECAMERAMODE_OFFSET UNITYSDK_OFFSET(0x7865710)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONDEACTIVATECAMERAMODE_OFFSET UNITYSDK_OFFSET(0x78652E0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x78640C0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7864FA0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x7864C60)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x7864970)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7863E50)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI__CTOR_OFFSET UNITYSDK_OFFSET(0x7863D00)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI__ONREGISTERPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0x7865B00)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI__ONREGISTERPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0x7865B30)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI__ONREGISTERPARAM_B__5_2_OFFSET UNITYSDK_OFFSET(0x7865B60)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x7865B90)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7865C00)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x7865C60)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x7865CC0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7865D40)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int EnableBehaviourAI_TypeDefinitionIndex = 44631;
