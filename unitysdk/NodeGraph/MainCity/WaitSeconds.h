...
#define NODEGRAPH_MAINCITY_WAITSECONDS_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x63642B0)
#define NODEGRAPH_MAINCITY_WAITSECONDS_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x6364320)
#define NODEGRAPH_MAINCITY_WAITSECONDS_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x63640C0)
#define NODEGRAPH_MAINCITY_WAITSECONDS__CTOR_OFFSET UNITYSDK_OFFSET(0x6363FD0)
#define NODEGRAPH_MAINCITY_WAITSECONDS__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x6364580)
#define NODEGRAPH_MAINCITY_WAITSECONDS__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x63645B0)
#define NODEGRAPH_MAINCITY_WAITSECONDS___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x63645E0)
#define NODEGRAPH_MAINCITY_WAITSECONDS___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x6364650)
#define NODEGRAPH_MAINCITY_WAITSECONDS___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x63646D0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitSeconds_TypeDefinitionIndex = 54977;
