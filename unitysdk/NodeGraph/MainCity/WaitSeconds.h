...
#define NODEGRAPH_MAINCITY_WAITSECONDS_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x5E21010)
#define NODEGRAPH_MAINCITY_WAITSECONDS_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x5E21080)
#define NODEGRAPH_MAINCITY_WAITSECONDS_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x5E20E20)
#define NODEGRAPH_MAINCITY_WAITSECONDS__CTOR_OFFSET UNITYSDK_OFFSET(0x5E20D30)
#define NODEGRAPH_MAINCITY_WAITSECONDS__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x5E212E0)
#define NODEGRAPH_MAINCITY_WAITSECONDS__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x5E21310)
#define NODEGRAPH_MAINCITY_WAITSECONDS___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x5E21340)
#define NODEGRAPH_MAINCITY_WAITSECONDS___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x5E213B0)
#define NODEGRAPH_MAINCITY_WAITSECONDS___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x5E21430)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitSeconds_TypeDefinitionIndex = 51361;
	...
	public:
		...
		::System::Single seconds; // 0x70
		::System::Int32 npcDummyTag; // 0x74
		::System::Single _timer; // 0x78
