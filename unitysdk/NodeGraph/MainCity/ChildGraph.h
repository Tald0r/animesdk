...
#define NODEGRAPH_MAINCITY_CHILDGRAPH_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x76559D0)
#define NODEGRAPH_MAINCITY_CHILDGRAPH_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x7655C20)
#define NODEGRAPH_MAINCITY_CHILDGRAPH_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x76558C0)
#define NODEGRAPH_MAINCITY_CHILDGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x7655750)
#define NODEGRAPH_MAINCITY_CHILDGRAPH__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x7655E20)
#define NODEGRAPH_MAINCITY_CHILDGRAPH___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x76561B0)
#define NODEGRAPH_MAINCITY_CHILDGRAPH___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x76561C0)
#define NODEGRAPH_MAINCITY_CHILDGRAPH___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7656220)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int ChildGraph_TypeDefinitionIndex = 65224;
