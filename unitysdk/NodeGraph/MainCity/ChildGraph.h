...
#define NODEGRAPH_MAINCITY_CHILDGRAPH_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x8635A20)
#define NODEGRAPH_MAINCITY_CHILDGRAPH_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x8635C70)
#define NODEGRAPH_MAINCITY_CHILDGRAPH_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8635910)
#define NODEGRAPH_MAINCITY_CHILDGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x86357B0)
#define NODEGRAPH_MAINCITY_CHILDGRAPH__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x8635E70)
#define NODEGRAPH_MAINCITY_CHILDGRAPH___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x8636200)
#define NODEGRAPH_MAINCITY_CHILDGRAPH___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x8636210)
#define NODEGRAPH_MAINCITY_CHILDGRAPH___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8636270)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int ChildGraph_TypeDefinitionIndex = 53426;
