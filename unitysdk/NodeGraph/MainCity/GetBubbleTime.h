...
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_GETGALCONFIG_OFFSET UNITYSDK_OFFSET(0xA1210C0)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_GETPERFORMCHATSTORYNODELIST_OFFSET UNITYSDK_OFFSET(0xA121840)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xA120CF0)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xA120B80)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME__CTOR_OFFSET UNITYSDK_OFFSET(0xA120A10)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0xA121D90)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xA121DC0)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xA121DD0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int GetBubbleTime_TypeDefinitionIndex = 57599;
