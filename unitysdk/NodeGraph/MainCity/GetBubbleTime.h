...
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_GETGALCONFIG_OFFSET UNITYSDK_OFFSET(0x76E75A0)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_GETPERFORMCHATSTORYNODELIST_OFFSET UNITYSDK_OFFSET(0x76E7D20)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x76E71D0)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x76E7060)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME__CTOR_OFFSET UNITYSDK_OFFSET(0x76E6EF0)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x76E8270)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x76E82A0)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x76E82B0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int GetBubbleTime_TypeDefinitionIndex = 47205;
