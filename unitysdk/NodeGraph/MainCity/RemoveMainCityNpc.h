...
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7FC5380)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7FC5210)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x7FC50C0)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x7FC55A0)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7FC55D0)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7FC55E0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RemoveMainCityNpc_TypeDefinitionIndex = 41331;
