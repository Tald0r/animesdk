...
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6BC5F90)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6BC5E20)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x6BC5CD0)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x6BC61B0)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6BC61E0)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6BC61F0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RemoveMainCityNpc_TypeDefinitionIndex = 49422;
