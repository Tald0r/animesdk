...
#define NODEGRAPH_MAINCITY_RESETTRIGGER_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x758AB80)
#define NODEGRAPH_MAINCITY_RESETTRIGGER_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x758AA10)
#define NODEGRAPH_MAINCITY_RESETTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x758A8C0)
#define NODEGRAPH_MAINCITY_RESETTRIGGER__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x758AC70)
#define NODEGRAPH_MAINCITY_RESETTRIGGER___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x758ACA0)
#define NODEGRAPH_MAINCITY_RESETTRIGGER___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x758ACB0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int ResetTrigger_TypeDefinitionIndex = 43528;
