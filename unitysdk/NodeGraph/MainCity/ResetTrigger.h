...
#define NODEGRAPH_MAINCITY_RESETTRIGGER_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x752C1A0)
#define NODEGRAPH_MAINCITY_RESETTRIGGER_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x752C030)
#define NODEGRAPH_MAINCITY_RESETTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x752BEE0)
#define NODEGRAPH_MAINCITY_RESETTRIGGER__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x752C290)
#define NODEGRAPH_MAINCITY_RESETTRIGGER___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x752C2C0)
#define NODEGRAPH_MAINCITY_RESETTRIGGER___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x752C2D0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int ResetTrigger_TypeDefinitionIndex = 38901;
