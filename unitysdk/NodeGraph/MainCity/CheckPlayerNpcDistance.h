...
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x781E760)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_HANDLE_OFFSET UNITYSDK_OFFSET(0x781E640)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x781E280)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x781EAF0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x781ED00)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x781DFF0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0x781E6B0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x781DFE0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE__ONREGISTERPARAM_B__8_0_OFFSET UNITYSDK_OFFSET(0x781EF10)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE__ONREGISTERPARAM_B__8_1_OFFSET UNITYSDK_OFFSET(0x781EF40)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE__ONREGISTERPARAM_B__8_2_OFFSET UNITYSDK_OFFSET(0x781EF70)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE__ONREGISTERPARAM_B__8_3_OFFSET UNITYSDK_OFFSET(0x781EFA0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x781EFD0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x781F030)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x781F040)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x781F0A0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x781F100)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE___BASE_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0x781F110)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckPlayerNpcDistance_TypeDefinitionIndex = 69502;
	...
	public:
		...
		::System::Boolean _thisPhotoPageChecked; // 0x9C
		::System::Boolean nearDis; // 0x9D
		::System::Boolean checkInPhotoPage; // 0x9E
