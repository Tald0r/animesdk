...
#define NODEGRAPH_MAINCITY_CHECKFAIRY_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x99B0ED0)
#define NODEGRAPH_MAINCITY_CHECKFAIRY__CTOR_OFFSET UNITYSDK_OFFSET(0x99B0EC0)
#define NODEGRAPH_MAINCITY_CHECKFAIRY___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x99B1230)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckFairy_TypeDefinitionIndex = 37412;
