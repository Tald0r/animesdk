...
#define NODEGRAPH_MAINCITY_SWITCHBOOL_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x77E1AA0)
#define NODEGRAPH_MAINCITY_SWITCHBOOL_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x77E18B0)
#define NODEGRAPH_MAINCITY_SWITCHBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x77E0C40)
#define NODEGRAPH_MAINCITY_SWITCHBOOL__ONREGISTERPARAM_B__10_0_OFFSET UNITYSDK_OFFSET(0x77E1CF0)
#define NODEGRAPH_MAINCITY_SWITCHBOOL__ONREGISTERPARAM_B__10_1_OFFSET UNITYSDK_OFFSET(0x77E1D20)
#define NODEGRAPH_MAINCITY_SWITCHBOOL___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x77E1D50)
#define NODEGRAPH_MAINCITY_SWITCHBOOL___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x77E1D60)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SwitchBool_TypeDefinitionIndex = 76743;

	class SwitchBool : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::NodeGraph::GraphOutputPort* Index1; // 0x58
		::NodeGraph::GraphOutputPort* True; // 0x60
		::NodeGraph::GraphOutputPort* Index2; // 0x68
		::NodeGraph::GraphInputValuePort* ValuePort; // 0x70
		::NodeGraph::GraphOutputPort* Index3; // 0x78
		::NodeGraph::GraphOutputPort* False; // 0x80
		::NodeGraph::GraphInputValuePort* IndexValuePort; // 0x88
