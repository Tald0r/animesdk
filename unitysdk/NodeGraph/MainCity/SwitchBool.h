...
#define NODEGRAPH_MAINCITY_SWITCHBOOL_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xC3039D0)
#define NODEGRAPH_MAINCITY_SWITCHBOOL_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xC3037E0)
#define NODEGRAPH_MAINCITY_SWITCHBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0xC302B70)
#define NODEGRAPH_MAINCITY_SWITCHBOOL__ONREGISTERPARAM_B__10_0_OFFSET UNITYSDK_OFFSET(0xC303C20)
#define NODEGRAPH_MAINCITY_SWITCHBOOL__ONREGISTERPARAM_B__10_1_OFFSET UNITYSDK_OFFSET(0xC303C50)
#define NODEGRAPH_MAINCITY_SWITCHBOOL___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xC303C80)
#define NODEGRAPH_MAINCITY_SWITCHBOOL___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xC303C90)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SwitchBool_TypeDefinitionIndex = 69452;

	class SwitchBool : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::NodeGraph::GraphOutputPort* True; // 0x58
		::NodeGraph::GraphOutputPort* Index2; // 0x60
		::NodeGraph::GraphOutputPort* False; // 0x68
		::NodeGraph::GraphInputValuePort* ValuePort; // 0x70
		::NodeGraph::GraphOutputPort* Index1; // 0x78
