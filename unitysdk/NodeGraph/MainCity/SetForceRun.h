...
#define NODEGRAPH_MAINCITY_SETFORCERUN_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x758BA70)
#define NODEGRAPH_MAINCITY_SETFORCERUN_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x758B800)
#define NODEGRAPH_MAINCITY_SETFORCERUN__CTOR_OFFSET UNITYSDK_OFFSET(0x758B6B0)
#define NODEGRAPH_MAINCITY_SETFORCERUN__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x758BE70)
#define NODEGRAPH_MAINCITY_SETFORCERUN__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x758BEA0)
#define NODEGRAPH_MAINCITY_SETFORCERUN__ONREGISTERPARAM_B__4_2_OFFSET UNITYSDK_OFFSET(0x758BED0)
#define NODEGRAPH_MAINCITY_SETFORCERUN___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x758BF00)
#define NODEGRAPH_MAINCITY_SETFORCERUN___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x758BF10)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetForceRun_TypeDefinitionIndex = 76773;
