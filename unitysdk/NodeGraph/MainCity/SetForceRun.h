...
#define NODEGRAPH_MAINCITY_SETFORCERUN_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x752D090)
#define NODEGRAPH_MAINCITY_SETFORCERUN_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x752CE20)
#define NODEGRAPH_MAINCITY_SETFORCERUN__CTOR_OFFSET UNITYSDK_OFFSET(0x752CCD0)
#define NODEGRAPH_MAINCITY_SETFORCERUN__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x752D490)
#define NODEGRAPH_MAINCITY_SETFORCERUN__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x752D4C0)
#define NODEGRAPH_MAINCITY_SETFORCERUN__ONREGISTERPARAM_B__4_2_OFFSET UNITYSDK_OFFSET(0x752D4F0)
#define NODEGRAPH_MAINCITY_SETFORCERUN___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x752D520)
#define NODEGRAPH_MAINCITY_SETFORCERUN___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x752D530)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetForceRun_TypeDefinitionIndex = 59793;

	class SetForceRun : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::System::Int32 NpcTag; // 0x58
		::System::Boolean Disable; // 0x5C
		::System::Boolean ForceRun; // 0x5D
