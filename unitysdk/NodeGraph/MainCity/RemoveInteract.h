...
#define NODEGRAPH_MAINCITY_REMOVEINTERACT_GETUID_OFFSET UNITYSDK_OFFSET(0x76E97A0)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x76E9A30)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x76E95B0)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x76E9460)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x76E9BE0)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT__ONREGISTERPARAM_B__3_1_OFFSET UNITYSDK_OFFSET(0x76E9C10)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x76E9C40)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x76E9C50)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RemoveInteract_TypeDefinitionIndex = 37544;
