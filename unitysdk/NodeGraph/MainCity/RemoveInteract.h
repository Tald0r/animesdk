...
#define NODEGRAPH_MAINCITY_REMOVEINTERACT_GETUID_OFFSET UNITYSDK_OFFSET(0xA123240)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xA1234D0)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xA123050)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0xA122F00)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0xA123680)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT__ONREGISTERPARAM_B__3_1_OFFSET UNITYSDK_OFFSET(0xA1236B0)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xA1236E0)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xA1236F0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RemoveInteract_TypeDefinitionIndex = 42028;
