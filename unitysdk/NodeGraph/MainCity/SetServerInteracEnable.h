...
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE_GETUID_OFFSET UNITYSDK_OFFSET(0x6FBC5A0)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6FBC830)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6FBCD80)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0x6FBCAE0)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6FBC330)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x6FBC1E0)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x6FBD080)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x6FBD0B0)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE__ONREGISTERPARAM_B__4_2_OFFSET UNITYSDK_OFFSET(0x6FBD0E0)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6FBD110)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x6FBD120)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE___BASE_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0x6FBD180)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6FBD190)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetServerInteracEnable_TypeDefinitionIndex = 70766;
