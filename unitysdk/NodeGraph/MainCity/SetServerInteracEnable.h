...
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE_GETUID_OFFSET UNITYSDK_OFFSET(0x745E3D0)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x74B7AB0)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x74B8000)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0x74B7D60)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x745E160)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x745E010)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x74B8300)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x74B8330)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE__ONREGISTERPARAM_B__4_2_OFFSET UNITYSDK_OFFSET(0x74B8360)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x74B8390)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x74B83A0)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE___BASE_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0x74B8400)
#define NODEGRAPH_MAINCITY_SETSERVERINTERACENABLE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x74B8410)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetServerInteracEnable_TypeDefinitionIndex = 77891;
