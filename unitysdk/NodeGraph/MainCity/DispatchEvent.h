...
#define NODEGRAPH_MAINCITY_DISPATCHEVENT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6428900)
#define NODEGRAPH_MAINCITY_DISPATCHEVENT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6428790)
#define NODEGRAPH_MAINCITY_DISPATCHEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x6428640)
#define NODEGRAPH_MAINCITY_DISPATCHEVENT__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x6428A50)
#define NODEGRAPH_MAINCITY_DISPATCHEVENT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6428B10)
#define NODEGRAPH_MAINCITY_DISPATCHEVENT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6428B20)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int DispatchEvent_TypeDefinitionIndex = 52743;

	class DispatchEvent : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::Enum_3_3A45E918E5024074 eventType; // 0x58
