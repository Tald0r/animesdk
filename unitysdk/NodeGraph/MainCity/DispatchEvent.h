...
#define NODEGRAPH_MAINCITY_DISPATCHEVENT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6A2DC20)
#define NODEGRAPH_MAINCITY_DISPATCHEVENT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6A2DAB0)
#define NODEGRAPH_MAINCITY_DISPATCHEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x6A2D960)
#define NODEGRAPH_MAINCITY_DISPATCHEVENT__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x6A2DD70)
#define NODEGRAPH_MAINCITY_DISPATCHEVENT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6A2DE30)
#define NODEGRAPH_MAINCITY_DISPATCHEVENT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6A2DE40)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int DispatchEvent_TypeDefinitionIndex = 44282;

	class DispatchEvent : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::Enum_3_53C4A418F34F74D8 eventType; // 0x58
