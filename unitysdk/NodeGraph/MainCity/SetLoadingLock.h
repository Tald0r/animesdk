...
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xC303400)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xC303460)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xC303190)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xC3023E0)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0xC3035B0)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0xC3035E0)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK__ONREGISTERPARAM_B__7_2_OFFSET UNITYSDK_OFFSET(0xC303630)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xC303680)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xC3036F0)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xC303770)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetLoadingLock_TypeDefinitionIndex = 40178;
	...
	public:
		...
		::System::Int32 id; // 0x64
		::System::Int32 idValue; // 0x68
		::System::Boolean isLock; // 0x6C
		::System::Boolean processed; // 0x6D
