...
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x77E14D0)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x77E1530)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x77E1260)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x77E04B0)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x77E1680)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x77E16B0)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK__ONREGISTERPARAM_B__7_2_OFFSET UNITYSDK_OFFSET(0x77E1700)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x77E1750)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x77E17C0)
#define NODEGRAPH_MAINCITY_SETLOADINGLOCK___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x77E1840)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetLoadingLock_TypeDefinitionIndex = 50297;
	...
	public:
		...
		::System::Boolean isLock; // 0x68
		::System::Boolean processed; // 0x69
