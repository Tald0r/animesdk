...
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x5E203C0)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x5E201C0)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x5E1FF30)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x5E1FF20)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__ONREGISTERPARAM_B__6_0_OFFSET UNITYSDK_OFFSET(0x5E20BF0)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__ONREGISTERPARAM_B__6_1_OFFSET UNITYSDK_OFFSET(0x5E20C20)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__ONREGISTERPARAM_B__6_2_OFFSET UNITYSDK_OFFSET(0x5E20C50)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__ONREGISTERPARAM_B__6_3_OFFSET UNITYSDK_OFFSET(0x5E20C80)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x5E20CB0)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x5E20D10)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x5E20D20)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckCameraFocusNpc_TypeDefinitionIndex = 67370;

	class CheckCameraFocusNpc : public ::NodeGraph::MainCity::Trigger
	{
	public:
		::MoleMole::Battle::Entity* _npc; // 0x88
		::System::Single checknpcFowardAngle; // 0x90
		::System::Single checkDis; // 0x94
