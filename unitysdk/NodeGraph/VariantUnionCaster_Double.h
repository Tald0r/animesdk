...
#define NODEGRAPH_VARIANTUNIONCASTER_DOUBLE_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x99B3EE0)
#define NODEGRAPH_VARIANTUNIONCASTER_DOUBLE_CASTFROM_OFFSET UNITYSDK_OFFSET(0x99B3D80)
#define NODEGRAPH_VARIANTUNIONCASTER_DOUBLE_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_DOUBLE__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x99B41A0)
#define NODEGRAPH_VARIANTUNIONCASTER_DOUBLE_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x99B4100)
#define NODEGRAPH_VARIANTUNIONCASTER_DOUBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x99B4190)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_Double_TypeDefinitionIndex = 49768;
