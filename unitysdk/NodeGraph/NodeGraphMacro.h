...
#define NODEGRAPH_NODEGRAPHMACRO_CREATEGRAPH_OFFSET UNITYSDK_OFFSET(0x698D6F0)
#define NODEGRAPH_NODEGRAPHMACRO_CREATESUBGRAPH_OFFSET UNITYSDK_OFFSET(0x698D8B0)
#define NODEGRAPH_NODEGRAPHMACRO_GET_ROOTGRAPH_OFFSET UNITYSDK_OFFSET(0x698D6E0)
#define NODEGRAPH_NODEGRAPHMACRO_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x698D6D0)
#define NODEGRAPH_NODEGRAPHMACRO__CTOR_OFFSET UNITYSDK_OFFSET(0x698D820)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphMacro_TypeDefinitionIndex = 36925;
