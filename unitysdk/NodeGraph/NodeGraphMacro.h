...
#define NODEGRAPH_NODEGRAPHMACRO_CREATEGRAPH_OFFSET UNITYSDK_OFFSET(0x630C850)
#define NODEGRAPH_NODEGRAPHMACRO_CREATESUBGRAPH_OFFSET UNITYSDK_OFFSET(0x630CA10)
#define NODEGRAPH_NODEGRAPHMACRO_GET_ROOTGRAPH_OFFSET UNITYSDK_OFFSET(0x630C840)
#define NODEGRAPH_NODEGRAPHMACRO_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x630C830)
#define NODEGRAPH_NODEGRAPHMACRO__CTOR_OFFSET UNITYSDK_OFFSET(0x630C980)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphMacro_TypeDefinitionIndex = 69190;
