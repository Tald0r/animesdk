...
#define NODEGRAPH_GRAPHCONNECTION_ADDOUTPORT_OFFSET UNITYSDK_OFFSET(0x7FC2730)
#define NODEGRAPH_GRAPHCONNECTION_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x7FC28B0)
#define NODEGRAPH_GRAPHCONNECTION_REMOVEOUTPORT_OFFSET UNITYSDK_OFFSET(0x7FC2800)
#define NODEGRAPH_GRAPHCONNECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x7FC2670)
#define NODEGRAPH_GRAPHCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x7FC25B0)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphConnection_TypeDefinitionIndex = 67570;
