...
#define NODEGRAPH_NODEGRAPHLOCALVARIABLES_GET_SCOPE_OFFSET UNITYSDK_OFFSET(0x5E214A0)
#define NODEGRAPH_NODEGRAPHLOCALVARIABLES__CTOR_OFFSET UNITYSDK_OFFSET(0x5E214B0)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphLocalVariables_TypeDefinitionIndex = 40959;
