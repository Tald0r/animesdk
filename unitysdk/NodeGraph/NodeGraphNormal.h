...
#define NODEGRAPH_NODEGRAPHNORMAL_CREATEGRAPH_OFFSET UNITYSDK_OFFSET(0x76E9CE0)
#define NODEGRAPH_NODEGRAPHNORMAL_CREATESUBGRAPH_OFFSET UNITYSDK_OFFSET(0x76E9EA0)
#define NODEGRAPH_NODEGRAPHNORMAL_GET_ROOTGRAPH_OFFSET UNITYSDK_OFFSET(0x76E9CD0)
#define NODEGRAPH_NODEGRAPHNORMAL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x76E9CC0)
#define NODEGRAPH_NODEGRAPHNORMAL__CTOR_OFFSET UNITYSDK_OFFSET(0x76E9E10)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphNormal_TypeDefinitionIndex = 40077;
