...
#define NODEGRAPH_GRAPHTASK_GET_GRAPH_OFFSET UNITYSDK_OFFSET(0x7651D00)
#define NODEGRAPH_GRAPHTASK_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x7651D80)
#define NODEGRAPH_GRAPHTASK_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x7651B40)
#define NODEGRAPH_GRAPHTASK_ONSTART_OFFSET UNITYSDK_OFFSET(0x7651D20)
#define NODEGRAPH_GRAPHTASK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x7651DE0)
#define NODEGRAPH_GRAPHTASK_SETPARAM_OFFSET UNITYSDK_OFFSET(0x7651BB0)
#define NODEGRAPH_GRAPHTASK_SET_GRAPH_OFFSET UNITYSDK_OFFSET(0x7651D10)
#define NODEGRAPH_GRAPHTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x7651E40)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphTask_TypeDefinitionIndex = 37178;
