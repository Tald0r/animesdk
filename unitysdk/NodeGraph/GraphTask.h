...
#define NODEGRAPH_GRAPHTASK_GET_GRAPH_OFFSET UNITYSDK_OFFSET(0x8631D60)
#define NODEGRAPH_GRAPHTASK_ONCLEAR_OFFSET UNITYSDK_OFFSET(0x8631DE0)
#define NODEGRAPH_GRAPHTASK_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x8631BA0)
#define NODEGRAPH_GRAPHTASK_ONSTART_OFFSET UNITYSDK_OFFSET(0x8631D80)
#define NODEGRAPH_GRAPHTASK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x8631E40)
#define NODEGRAPH_GRAPHTASK_SETPARAM_OFFSET UNITYSDK_OFFSET(0x8631C10)
#define NODEGRAPH_GRAPHTASK_SET_GRAPH_OFFSET UNITYSDK_OFFSET(0x8631D70)
#define NODEGRAPH_GRAPHTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x8631EA0)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphTask_TypeDefinitionIndex = 39384;
