...
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_1_OFFSET UNITYSDK_OFFSET(0x7E1F8C0)
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_2_OFFSET UNITYSDK_OFFSET(0x7E1FBC0)
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_3_OFFSET UNITYSDK_OFFSET(0x7E1FEC0)
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_4_OFFSET UNITYSDK_OFFSET(0x7E20130)
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_5_OFFSET UNITYSDK_OFFSET(0x7E20420)
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_6_OFFSET UNITYSDK_OFFSET(0x7E205F0)
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_OFFSET UNITYSDK_OFFSET(0x7E1F530)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCasterHelper_TypeDefinitionIndex = 55319;
