...
#define NODEGRAPH_GRAPHNODEMACROOUTPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x7862C30)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphNodeMacroOutput_TypeDefinitionIndex = 69953;
