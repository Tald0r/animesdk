...
#define NODEGRAPH_GRAPHNODEMACROOUTPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x6ED9E90)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphNodeMacroOutput_TypeDefinitionIndex = 44065;
