...
#define NODEGRAPH_GRAPHNODEAUTOADD_GET_NODENAME_OFFSET UNITYSDK_OFFSET(0x7651600)
#define NODEGRAPH_GRAPHNODEAUTOADD_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x76517A0)
#define NODEGRAPH_GRAPHNODEAUTOADD__CTOR_OFFSET UNITYSDK_OFFSET(0x7651640)
#define NODEGRAPH_GRAPHNODEAUTOADD___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7651A60)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphNodeAutoAdd_TypeDefinitionIndex = 39205;
