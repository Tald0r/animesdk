...
#define NODEGRAPH_GRAPHNODEAUTOADD_GET_NODENAME_OFFSET UNITYSDK_OFFSET(0x8631660)
#define NODEGRAPH_GRAPHNODEAUTOADD_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x8631800)
#define NODEGRAPH_GRAPHNODEAUTOADD__CTOR_OFFSET UNITYSDK_OFFSET(0x86316A0)
#define NODEGRAPH_GRAPHNODEAUTOADD___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x8631AC0)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphNodeAutoAdd_TypeDefinitionIndex = 80737;
