...
#define NODEGRAPH_GRAPHNODEOPERATIONNODE2_GET_NODENAME_OFFSET UNITYSDK_OFFSET(0x6426620)
#define NODEGRAPH_GRAPHNODEOPERATIONNODE2_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6426810)
#define NODEGRAPH_GRAPHNODEOPERATIONNODE2__CTOR_OFFSET UNITYSDK_OFFSET(0x6426660)
#define NODEGRAPH_GRAPHNODEOPERATIONNODE2___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x6426920)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphNodeOperationNode2_TypeDefinitionIndex = 38258;
