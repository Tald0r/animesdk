...
#define NODEGRAPH_VARIANTUNIONCASTER_INT32_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x8CE3E50)
#define NODEGRAPH_VARIANTUNIONCASTER_INT32_CASTFROM_OFFSET UNITYSDK_OFFSET(0x8CE3D10)
#define NODEGRAPH_VARIANTUNIONCASTER_INT32_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_INT32__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x8CE40D0)
#define NODEGRAPH_VARIANTUNIONCASTER_INT32_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x8CE4030)
#define NODEGRAPH_VARIANTUNIONCASTER_INT32__CTOR_OFFSET UNITYSDK_OFFSET(0x8CE40C0)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_Int32_TypeDefinitionIndex = 57655;
