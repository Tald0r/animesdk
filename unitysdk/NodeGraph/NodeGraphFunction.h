...
#define NODEGRAPH_NODEGRAPHFUNCTION_CREATEGRAPH_OFFSET UNITYSDK_OFFSET(0x7866BA0)
#define NODEGRAPH_NODEGRAPHFUNCTION_CREATESUBGRAPH_OFFSET UNITYSDK_OFFSET(0x7866CE0)
#define NODEGRAPH_NODEGRAPHFUNCTION_GET_ROOTGRAPH_OFFSET UNITYSDK_OFFSET(0x7866AE0)
#define NODEGRAPH_NODEGRAPHFUNCTION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x7866AD0)
#define NODEGRAPH_NODEGRAPHFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x7866B10)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphFunction_TypeDefinitionIndex = 42169;
