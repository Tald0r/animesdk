...
#define NODEGRAPH_NODEGRAPHFUNCTION_CREATEGRAPH_OFFSET UNITYSDK_OFFSET(0x6EDDE20)
#define NODEGRAPH_NODEGRAPHFUNCTION_CREATESUBGRAPH_OFFSET UNITYSDK_OFFSET(0x6EDDF60)
#define NODEGRAPH_NODEGRAPHFUNCTION_GET_ROOTGRAPH_OFFSET UNITYSDK_OFFSET(0x6EDDD50)
#define NODEGRAPH_NODEGRAPHFUNCTION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x6EDDD40)
#define NODEGRAPH_NODEGRAPHFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x6EDDD80)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphFunction_TypeDefinitionIndex = 60586;
