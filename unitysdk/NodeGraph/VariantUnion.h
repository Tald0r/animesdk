...
#define NODEGRAPH_VARIANTUNION_CASTFROMOBJECT_OFFSET UNITYSDK_OFFSET(0x6364E80)
#define NODEGRAPH_VARIANTUNION_CASTFROM_OFFSET UNITYSDK_OFFSET(0x6365E60)
#define NODEGRAPH_VARIANTUNION_CHECKEDBOOL_OFFSET UNITYSDK_OFFSET(0x2F6990)
#define NODEGRAPH_VARIANTUNION_CHECKEDDOUBLE_OFFSET UNITYSDK_OFFSET(0x2F6B70)
#define NODEGRAPH_VARIANTUNION_CHECKEDFLOAT_OFFSET UNITYSDK_OFFSET(0x2F6B00)
#define NODEGRAPH_VARIANTUNION_CHECKEDINT64_OFFSET UNITYSDK_OFFSET(0x2F6A80)
#define NODEGRAPH_VARIANTUNION_CHECKEDINT_OFFSET UNITYSDK_OFFSET(0x2F6A10)
#define NODEGRAPH_VARIANTUNION_CHECKEDOBJECT_OFFSET UNITYSDK_OFFSET(0x2F6C60)
#define NODEGRAPH_VARIANTUNION_CHECKEDSTRING_OFFSET UNITYSDK_OFFSET(0x2F6BE0)
#define NODEGRAPH_VARIANTUNION_EQUALS_OFFSET UNITYSDK_OFFSET(0x2F6970)
#define NODEGRAPH_VARIANTUNION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2F6960)
#define NODEGRAPH_VARIANTUNION_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x2F6550)
#define NODEGRAPH_VARIANTUNION_GET_STRINGWITHTYPE_OFFSET UNITYSDK_OFFSET(0x2F6860)
#define NODEGRAPH_VARIANTUNION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x2F6540)
#define NODEGRAPH_VARIANTUNION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x6365780)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_10_OFFSET UNITYSDK_OFFSET(0x6365520)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x6364FD0)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x6365070)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x63650F0)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x63651A0)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_5_OFFSET UNITYSDK_OFFSET(0x6365230)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_6_OFFSET UNITYSDK_OFFSET(0x63652E0)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_7_OFFSET UNITYSDK_OFFSET(0x63653A0)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_8_OFFSET UNITYSDK_OFFSET(0x6365440)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_9_OFFSET UNITYSDK_OFFSET(0x63654B0)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x6364F20)
#define NODEGRAPH_VARIANTUNION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x6365DD0)
#define NODEGRAPH_VARIANTUNION_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x2F67C0)
#define NODEGRAPH_VARIANTUNION_TOFLOAT_OFFSET UNITYSDK_OFFSET(0x2F6730)
#define NODEGRAPH_VARIANTUNION_TOINT32_IGNORELONG_OFFSET UNITYSDK_OFFSET(0x2F6710)
#define NODEGRAPH_VARIANTUNION_TOINT32_OFFSET UNITYSDK_OFFSET(0x2F6560)
#define NODEGRAPH_VARIANTUNION_TOINT64_OFFSET UNITYSDK_OFFSET(0x2F6680)
#define NODEGRAPH_VARIANTUNION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2F6850)
#define NODEGRAPH_VARIANTUNION_TOUINT32_IGNORELONG_OFFSET UNITYSDK_OFFSET(0x2F6720)
#define NODEGRAPH_VARIANTUNION_TOUINT32_OFFSET UNITYSDK_OFFSET(0x2F65F0)
#define NODEGRAPH_VARIANTUNION__CCTOR_OFFSET UNITYSDK_OFFSET(0x6366490)
#define NODEGRAPH_VARIANTUNION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2F6890)
#define NODEGRAPH_VARIANTUNION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2F68B0)
#define NODEGRAPH_VARIANTUNION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x2F68D0)
#define NODEGRAPH_VARIANTUNION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x2F68F0)
#define NODEGRAPH_VARIANTUNION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x2F6920)
#define NODEGRAPH_VARIANTUNION__CTOR_6_OFFSET UNITYSDK_OFFSET(0x2F6940)
#define NODEGRAPH_VARIANTUNION__CTOR_OFFSET UNITYSDK_OFFSET(0x2F6870)
#define NODEGRAPH_VARIANTUNION___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2F6D50)
#define NODEGRAPH_VARIANTUNION___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2F6CD0)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnion_TypeDefinitionIndex = 73302;

	struct alignas(8) VariantUnion
	{
		static ::NodeGraph::VariantUnion* StaticGet_NullVariantUnion()
		{
			return (::NodeGraph::VariantUnion*)Il2CppClass::FromTypeDefinitionIndex(VariantUnion_TypeDefinitionIndex)->GetStaticField(0x2E410);
		}
