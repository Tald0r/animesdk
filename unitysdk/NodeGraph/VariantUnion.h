...
#define NODEGRAPH_VARIANTUNION_CASTFROMOBJECT_OFFSET UNITYSDK_OFFSET(0x5E21BE0)
#define NODEGRAPH_VARIANTUNION_CASTFROM_OFFSET UNITYSDK_OFFSET(0x5E22BC0)
#define NODEGRAPH_VARIANTUNION_CHECKEDBOOL_OFFSET UNITYSDK_OFFSET(0x2C5500)
#define NODEGRAPH_VARIANTUNION_CHECKEDDOUBLE_OFFSET UNITYSDK_OFFSET(0x2C56E0)
#define NODEGRAPH_VARIANTUNION_CHECKEDFLOAT_OFFSET UNITYSDK_OFFSET(0x2C5670)
#define NODEGRAPH_VARIANTUNION_CHECKEDINT64_OFFSET UNITYSDK_OFFSET(0x2C55F0)
#define NODEGRAPH_VARIANTUNION_CHECKEDINT_OFFSET UNITYSDK_OFFSET(0x2C5580)
#define NODEGRAPH_VARIANTUNION_CHECKEDOBJECT_OFFSET UNITYSDK_OFFSET(0x2C57D0)
#define NODEGRAPH_VARIANTUNION_CHECKEDSTRING_OFFSET UNITYSDK_OFFSET(0x2C5750)
#define NODEGRAPH_VARIANTUNION_EQUALS_OFFSET UNITYSDK_OFFSET(0x2C54E0)
#define NODEGRAPH_VARIANTUNION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2C54D0)
#define NODEGRAPH_VARIANTUNION_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x2C50C0)
#define NODEGRAPH_VARIANTUNION_GET_STRINGWITHTYPE_OFFSET UNITYSDK_OFFSET(0x2C53D0)
#define NODEGRAPH_VARIANTUNION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x2C50B0)
#define NODEGRAPH_VARIANTUNION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x5E224E0)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_10_OFFSET UNITYSDK_OFFSET(0x5E22280)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x5E21D30)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x5E21DD0)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x5E21E50)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x5E21F00)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_5_OFFSET UNITYSDK_OFFSET(0x5E21F90)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_6_OFFSET UNITYSDK_OFFSET(0x5E22040)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_7_OFFSET UNITYSDK_OFFSET(0x5E22100)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_8_OFFSET UNITYSDK_OFFSET(0x5E221A0)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_9_OFFSET UNITYSDK_OFFSET(0x5E22210)
#define NODEGRAPH_VARIANTUNION_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x5E21C80)
#define NODEGRAPH_VARIANTUNION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x5E22B30)
#define NODEGRAPH_VARIANTUNION_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x2C5330)
#define NODEGRAPH_VARIANTUNION_TOFLOAT_OFFSET UNITYSDK_OFFSET(0x2C52A0)
#define NODEGRAPH_VARIANTUNION_TOINT32_IGNORELONG_OFFSET UNITYSDK_OFFSET(0x2C5280)
#define NODEGRAPH_VARIANTUNION_TOINT32_OFFSET UNITYSDK_OFFSET(0x2C50D0)
#define NODEGRAPH_VARIANTUNION_TOINT64_OFFSET UNITYSDK_OFFSET(0x2C51F0)
#define NODEGRAPH_VARIANTUNION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2C53C0)
#define NODEGRAPH_VARIANTUNION_TOUINT32_IGNORELONG_OFFSET UNITYSDK_OFFSET(0x2C5290)
#define NODEGRAPH_VARIANTUNION_TOUINT32_OFFSET UNITYSDK_OFFSET(0x2C5160)
#define NODEGRAPH_VARIANTUNION__CCTOR_OFFSET UNITYSDK_OFFSET(0x5E231F0)
#define NODEGRAPH_VARIANTUNION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2C5400)
#define NODEGRAPH_VARIANTUNION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2C5420)
#define NODEGRAPH_VARIANTUNION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x2C5440)
#define NODEGRAPH_VARIANTUNION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x2C5460)
#define NODEGRAPH_VARIANTUNION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x2C5490)
#define NODEGRAPH_VARIANTUNION__CTOR_6_OFFSET UNITYSDK_OFFSET(0x2C54B0)
#define NODEGRAPH_VARIANTUNION__CTOR_OFFSET UNITYSDK_OFFSET(0x2C53E0)
#define NODEGRAPH_VARIANTUNION___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2C58C0)
#define NODEGRAPH_VARIANTUNION___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2C5840)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnion_TypeDefinitionIndex = 78687;

	struct alignas(8) VariantUnion
	{
		static ::NodeGraph::VariantUnion* StaticGet_NullVariantUnion()
		{
			return (::NodeGraph::VariantUnion*)Il2CppClass::FromTypeDefinitionIndex(VariantUnion_TypeDefinitionIndex)->GetStaticField(0x2D010);
		}
