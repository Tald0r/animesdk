...
#define NODEGRAPH_NODEGRAPHVARIABLES_CLEAR_OFFSET UNITYSDK_OFFSET(0x653E230)
#define NODEGRAPH_NODEGRAPHVARIABLES_GETVALUE_OFFSET UNITYSDK_OFFSET(0x653DF10)
#define NODEGRAPH_NODEGRAPHVARIABLES_SETVALUE_OFFSET UNITYSDK_OFFSET(0x653E090)
#define NODEGRAPH_NODEGRAPHVARIABLES__CTOR_OFFSET UNITYSDK_OFFSET(0x653E2F0)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphVariables_TypeDefinitionIndex = 71295;
