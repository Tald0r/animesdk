...
#define NODEGRAPH_NODEGRAPHVARIABLES_CLEAR_OFFSET UNITYSDK_OFFSET(0x7E1F460)
#define NODEGRAPH_NODEGRAPHVARIABLES_GETVALUE_OFFSET UNITYSDK_OFFSET(0x7E1F130)
#define NODEGRAPH_NODEGRAPHVARIABLES_SETVALUE_OFFSET UNITYSDK_OFFSET(0x7E1F2B0)
#define NODEGRAPH_NODEGRAPHVARIABLES__CTOR_OFFSET UNITYSDK_OFFSET(0x7E1F520)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphVariables_TypeDefinitionIndex = 42174;
