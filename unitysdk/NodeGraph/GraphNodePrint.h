...
#define NODEGRAPH_GRAPHNODEPRINT_GET_NODENAME_OFFSET UNITYSDK_OFFSET(0x7457B10)
#define NODEGRAPH_GRAPHNODEPRINT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7457CF0)
#define NODEGRAPH_GRAPHNODEPRINT__CTOR_OFFSET UNITYSDK_OFFSET(0x7457B50)
#define NODEGRAPH_GRAPHNODEPRINT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x7457E10)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphNodePrint_TypeDefinitionIndex = 42453;
