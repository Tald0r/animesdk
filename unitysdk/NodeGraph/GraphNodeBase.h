...
#define NODEGRAPH_GRAPHNODEBASE_BUILDEXINPUTPORT_OFFSET UNITYSDK_OFFSET(0x6308940)
#define NODEGRAPH_GRAPHNODEBASE_BUILDEXOUTPUTPORT_OFFSET UNITYSDK_OFFSET(0x6308C40)
#define NODEGRAPH_GRAPHNODEBASE_BUILDINPUTPORT_OFFSET UNITYSDK_OFFSET(0x63088A0)
#define NODEGRAPH_GRAPHNODEBASE_BUILDINPUTVALUEPORT_OFFSET UNITYSDK_OFFSET(0x6308A70)
#define NODEGRAPH_GRAPHNODEBASE_BUILDOUTPUTPORT_OFFSET UNITYSDK_OFFSET(0x6308BA0)
#define NODEGRAPH_GRAPHNODEBASE_BUILDOUTPUTVALUEPORT_OFFSET UNITYSDK_OFFSET(0x6308D70)
#define NODEGRAPH_GRAPHNODEBASE_GETPORT_1_OFFSET UNITYSDK_OFFSET(0x63087D0)
#define NODEGRAPH_GRAPHNODEBASE_GETPORT_2_OFFSET UNITYSDK_OFFSET(0x6308630)
#define NODEGRAPH_GRAPHNODEBASE_GETPORT_OFFSET UNITYSDK_OFFSET(0x6308530)
#define NODEGRAPH_GRAPHNODEBASE_ONACTIVEPORT_OFFSET UNITYSDK_OFFSET(0x6309130)
#define NODEGRAPH_GRAPHNODEBASE_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0x6308EA0)
#define NODEGRAPH_GRAPHNODEBASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6308F70)
#define NODEGRAPH_GRAPHNODEBASE_SETPARAM_OFFSET UNITYSDK_OFFSET(0x6308FE0)
#define NODEGRAPH_GRAPHNODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x6308480)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphNodeBase_TypeDefinitionIndex = 66899;
	...
	public:
		...
		::NodeGraph::GraphInputPort* _in; // 0x40
		::NodeGraph::GraphOutputPort* _out; // 0x48
