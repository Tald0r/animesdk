...
#define NODEGRAPH_GRAPHNODEBASE_BUILDEXINPUTPORT_OFFSET UNITYSDK_OFFSET(0x69897E0)
#define NODEGRAPH_GRAPHNODEBASE_BUILDEXOUTPUTPORT_OFFSET UNITYSDK_OFFSET(0x6989AE0)
#define NODEGRAPH_GRAPHNODEBASE_BUILDINPUTPORT_OFFSET UNITYSDK_OFFSET(0x6989740)
#define NODEGRAPH_GRAPHNODEBASE_BUILDINPUTVALUEPORT_OFFSET UNITYSDK_OFFSET(0x6989910)
#define NODEGRAPH_GRAPHNODEBASE_BUILDOUTPUTPORT_OFFSET UNITYSDK_OFFSET(0x6989A40)
#define NODEGRAPH_GRAPHNODEBASE_BUILDOUTPUTVALUEPORT_OFFSET UNITYSDK_OFFSET(0x6989C10)
#define NODEGRAPH_GRAPHNODEBASE_GETPORT_1_OFFSET UNITYSDK_OFFSET(0x6989670)
#define NODEGRAPH_GRAPHNODEBASE_GETPORT_2_OFFSET UNITYSDK_OFFSET(0x69894D0)
#define NODEGRAPH_GRAPHNODEBASE_GETPORT_OFFSET UNITYSDK_OFFSET(0x69893D0)
#define NODEGRAPH_GRAPHNODEBASE_ONACTIVEPORT_OFFSET UNITYSDK_OFFSET(0x6989FD0)
#define NODEGRAPH_GRAPHNODEBASE_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0x6989D40)
#define NODEGRAPH_GRAPHNODEBASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x6989E10)
#define NODEGRAPH_GRAPHNODEBASE_SETPARAM_OFFSET UNITYSDK_OFFSET(0x6989E80)
#define NODEGRAPH_GRAPHNODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x6989320)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphNodeBase_TypeDefinitionIndex = 74905;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Action_1<::SimpleJSON::JSONNode*>*>* _paramRegister; // 0x40
