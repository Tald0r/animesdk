...
#define NODEGRAPH_GRAPHINPUTVALUEPORT_GETVALUE_OFFSET UNITYSDK_OFFSET(0x63083A0)
#define NODEGRAPH_GRAPHINPUTVALUEPORT_GET_PORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x6308270)
#define NODEGRAPH_GRAPHINPUTVALUEPORT_GET_VALUEGETTER_OFFSET UNITYSDK_OFFSET(0x6308280)
#define NODEGRAPH_GRAPHINPUTVALUEPORT_SETVALUE_OFFSET UNITYSDK_OFFSET(0x63082B0)
#define NODEGRAPH_GRAPHINPUTVALUEPORT_SET_VALUEGETTER_OFFSET UNITYSDK_OFFSET(0x6308290)
#define NODEGRAPH_GRAPHINPUTVALUEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x63082A0)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphInputValuePort_TypeDefinitionIndex = 63150;
