...
#define NODEGRAPH_GRAPHINPUTVALUEPORT_GETVALUE_OFFSET UNITYSDK_OFFSET(0x6989240)
#define NODEGRAPH_GRAPHINPUTVALUEPORT_GET_PORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x6989110)
#define NODEGRAPH_GRAPHINPUTVALUEPORT_GET_VALUEGETTER_OFFSET UNITYSDK_OFFSET(0x6989120)
#define NODEGRAPH_GRAPHINPUTVALUEPORT_SETVALUE_OFFSET UNITYSDK_OFFSET(0x6989150)
#define NODEGRAPH_GRAPHINPUTVALUEPORT_SET_VALUEGETTER_OFFSET UNITYSDK_OFFSET(0x6989130)
#define NODEGRAPH_GRAPHINPUTVALUEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x6989140)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphInputValuePort_TypeDefinitionIndex = 36948;
