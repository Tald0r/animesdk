...
#define NODEGRAPH_NODEGRAPHMANAGER_CLEARALL_OFFSET UNITYSDK_OFFSET(0x630DE90)
#define NODEGRAPH_NODEGRAPHMANAGER_CLEARSPECIALNODECOUNT_OFFSET UNITYSDK_OFFSET(0x630E550)
#define NODEGRAPH_NODEGRAPHMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x630E070)
#define NODEGRAPH_NODEGRAPHMANAGER_GETFORCERUN_OFFSET UNITYSDK_OFFSET(0x630E9B0)
#define NODEGRAPH_NODEGRAPHMANAGER_GETSPECIALNODECOUNT_OFFSET UNITYSDK_OFFSET(0x630BD90)
#define NODEGRAPH_NODEGRAPHMANAGER_GET_GLOBALVARIABLES_OFFSET UNITYSDK_OFFSET(0x630CAE0)
#define NODEGRAPH_NODEGRAPHMANAGER_GET_NODEGRAPHMAP_OFFSET UNITYSDK_OFFSET(0x630CB00)
#define NODEGRAPH_NODEGRAPHMANAGER_ISLOCK_OFFSET UNITYSDK_OFFSET(0x630E3B0)
#define NODEGRAPH_NODEGRAPHMANAGER_ONCREATE_OFFSET UNITYSDK_OFFSET(0x630E1B0)
#define NODEGRAPH_NODEGRAPHMANAGER_SETFORCERUN_OFFSET UNITYSDK_OFFSET(0x630E920)
#define NODEGRAPH_NODEGRAPHMANAGER_SETLOCK_OFFSET UNITYSDK_OFFSET(0x630E450)
#define NODEGRAPH_NODEGRAPHMANAGER_SETSPECIALNODECOUNT_OFFSET UNITYSDK_OFFSET(0x630C350)
#define NODEGRAPH_NODEGRAPHMANAGER_SET_GLOBALVARIABLES_OFFSET UNITYSDK_OFFSET(0x630CAF0)
#define NODEGRAPH_NODEGRAPHMANAGER_STARTGRAPH_OFFSET UNITYSDK_OFFSET(0x630CB10)
#define NODEGRAPH_NODEGRAPHMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x630E210)
#define NODEGRAPH_NODEGRAPHMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x630EA70)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphManager_TypeDefinitionIndex = 41137;

	class NodeGraphManager : public ::Foundation::SingletonDisposable_1<::NodeGraph::NodeGraphManager*>
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Boolean>* ForceRunState; // 0x10
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::NodeGraph::NodeGraphNormal*>* _nodeGraphMap; // 0x48
