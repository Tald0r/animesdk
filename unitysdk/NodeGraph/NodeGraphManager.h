...
#define NODEGRAPH_NODEGRAPHMANAGER_CLEARALL_OFFSET UNITYSDK_OFFSET(0x698ED40)
#define NODEGRAPH_NODEGRAPHMANAGER_CLEARSPECIALNODECOUNT_OFFSET UNITYSDK_OFFSET(0x698F400)
#define NODEGRAPH_NODEGRAPHMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x698EF20)
#define NODEGRAPH_NODEGRAPHMANAGER_GETFORCERUN_OFFSET UNITYSDK_OFFSET(0x698F860)
#define NODEGRAPH_NODEGRAPHMANAGER_GETSPECIALNODECOUNT_OFFSET UNITYSDK_OFFSET(0x698CC30)
#define NODEGRAPH_NODEGRAPHMANAGER_GET_GLOBALVARIABLES_OFFSET UNITYSDK_OFFSET(0x698D980)
#define NODEGRAPH_NODEGRAPHMANAGER_GET_NODEGRAPHMAP_OFFSET UNITYSDK_OFFSET(0x698D9A0)
#define NODEGRAPH_NODEGRAPHMANAGER_ISLOCK_OFFSET UNITYSDK_OFFSET(0x698F260)
#define NODEGRAPH_NODEGRAPHMANAGER_ONCREATE_OFFSET UNITYSDK_OFFSET(0x698F060)
#define NODEGRAPH_NODEGRAPHMANAGER_SETFORCERUN_OFFSET UNITYSDK_OFFSET(0x698F7D0)
#define NODEGRAPH_NODEGRAPHMANAGER_SETLOCK_OFFSET UNITYSDK_OFFSET(0x698F300)
#define NODEGRAPH_NODEGRAPHMANAGER_SETSPECIALNODECOUNT_OFFSET UNITYSDK_OFFSET(0x698D1F0)
#define NODEGRAPH_NODEGRAPHMANAGER_SET_GLOBALVARIABLES_OFFSET UNITYSDK_OFFSET(0x698D990)
#define NODEGRAPH_NODEGRAPHMANAGER_STARTGRAPH_OFFSET UNITYSDK_OFFSET(0x698D9B0)
#define NODEGRAPH_NODEGRAPHMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x698F0C0)
#define NODEGRAPH_NODEGRAPHMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x698F920)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphManager_TypeDefinitionIndex = 67867;

	class NodeGraphManager : public ::Foundation::SingletonDisposable_1<::NodeGraph::NodeGraphManager*>
	{
	public:
		::NodeGraph::NodeGraphGlobalVariables* _GlobalVariables_k__BackingField; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Boolean>* NpcReadyState; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>*>* nodeRepeatCount; // 0x20
		::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>* _handles; // 0x28
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* LoadingLock; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Boolean>* ShowFairyBlocking; // 0x48
