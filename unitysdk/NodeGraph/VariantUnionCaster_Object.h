...
#define NODEGRAPH_VARIANTUNIONCASTER_OBJECT_CASTFROM_OFFSET UNITYSDK_OFFSET(0x8638A80)
#define NODEGRAPH_VARIANTUNIONCASTER_OBJECT_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_OBJECT__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x8638BC0)
#define NODEGRAPH_VARIANTUNIONCASTER_OBJECT_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x8638B20)
#define NODEGRAPH_VARIANTUNIONCASTER_OBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x8638BB0)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_Object_TypeDefinitionIndex = 73041;
