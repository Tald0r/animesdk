...
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x653F5E0)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64_CASTFROM_OFFSET UNITYSDK_OFFSET(0x653F490)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_UINT64__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x653F880)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x653F7D0)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64__CTOR_OFFSET UNITYSDK_OFFSET(0x653F870)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_UInt64_TypeDefinitionIndex = 51538;
