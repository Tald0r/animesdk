...
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x7E20810)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64_CASTFROM_OFFSET UNITYSDK_OFFSET(0x7E206C0)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_UINT64__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x7E20AB0)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x7E20A00)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64__CTOR_OFFSET UNITYSDK_OFFSET(0x7E20AA0)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_UInt64_TypeDefinitionIndex = 59311;
