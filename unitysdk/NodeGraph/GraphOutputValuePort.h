...
#define NODEGRAPH_GRAPHOUTPUTVALUEPORT_GETVALUE_OFFSET UNITYSDK_OFFSET(0x7651AB0)
#define NODEGRAPH_GRAPHOUTPUTVALUEPORT_GET_BEFOREGETVALUE_OFFSET UNITYSDK_OFFSET(0x7651A80)
#define NODEGRAPH_GRAPHOUTPUTVALUEPORT_GET_PORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x7651A70)
#define NODEGRAPH_GRAPHOUTPUTVALUEPORT_SETVALUE_OFFSET UNITYSDK_OFFSET(0x76519D0)
#define NODEGRAPH_GRAPHOUTPUTVALUEPORT_SET_BEFOREGETVALUE_OFFSET UNITYSDK_OFFSET(0x7651A90)
#define NODEGRAPH_GRAPHOUTPUTVALUEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x7651AA0)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphOutputValuePort_TypeDefinitionIndex = 76317;

	class GraphOutputValuePort : public ::NodeGraph::GraphValuePort
	{
	public:
		::Struct_2_A47ACAABA9AAFE92 _value; // 0x20
		::System::Action* _BeforeGetValue_k__BackingField; // 0x38
