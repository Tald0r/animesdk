...
#define NODEGRAPH_GRAPHOUTPUTVALUEPORT_GETVALUE_OFFSET UNITYSDK_OFFSET(0x8631B10)
#define NODEGRAPH_GRAPHOUTPUTVALUEPORT_GET_BEFOREGETVALUE_OFFSET UNITYSDK_OFFSET(0x8631AE0)
#define NODEGRAPH_GRAPHOUTPUTVALUEPORT_GET_PORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x8631AD0)
#define NODEGRAPH_GRAPHOUTPUTVALUEPORT_SETVALUE_OFFSET UNITYSDK_OFFSET(0x8631A30)
#define NODEGRAPH_GRAPHOUTPUTVALUEPORT_SET_BEFOREGETVALUE_OFFSET UNITYSDK_OFFSET(0x8631AF0)
#define NODEGRAPH_GRAPHOUTPUTVALUEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x8631B00)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphOutputValuePort_TypeDefinitionIndex = 40158;
