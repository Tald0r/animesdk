...
#define NODEGRAPH_VARIANTUNIONCASTER_INT64_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x7866E90)
#define NODEGRAPH_VARIANTUNIONCASTER_INT64_CASTFROM_OFFSET UNITYSDK_OFFSET(0x7866D40)
#define NODEGRAPH_VARIANTUNIONCASTER_INT64_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_INT64__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x7867120)
#define NODEGRAPH_VARIANTUNIONCASTER_INT64_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x7867080)
#define NODEGRAPH_VARIANTUNIONCASTER_INT64__CTOR_OFFSET UNITYSDK_OFFSET(0x7867110)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_Int64_TypeDefinitionIndex = 59349;
