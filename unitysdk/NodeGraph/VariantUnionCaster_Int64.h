...
#define NODEGRAPH_VARIANTUNIONCASTER_INT64_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x6EDE110)
#define NODEGRAPH_VARIANTUNIONCASTER_INT64_CASTFROM_OFFSET UNITYSDK_OFFSET(0x6EDDFC0)
#define NODEGRAPH_VARIANTUNIONCASTER_INT64_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_INT64__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x6EDE3A0)
#define NODEGRAPH_VARIANTUNIONCASTER_INT64_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x6EDE300)
#define NODEGRAPH_VARIANTUNIONCASTER_INT64__CTOR_OFFSET UNITYSDK_OFFSET(0x6EDE390)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_Int64_TypeDefinitionIndex = 62409;
