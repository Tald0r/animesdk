...
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x752D6F0)
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT_CASTFROM_OFFSET UNITYSDK_OFFSET(0x752D5A0)
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_SINGLE__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x752D9A0)
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x752D900)
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x752D990)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_Float_TypeDefinitionIndex = 61196;
