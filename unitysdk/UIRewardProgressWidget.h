...
#define UIREWARDPROGRESSWIDGET_CONVERTPROGRESS_OFFSET UNITYSDK_OFFSET(0xAEA5E00)
#define UIREWARDPROGRESSWIDGET_GETMAXVAL_OFFSET UNITYSDK_OFFSET(0xAEA5E80)
#define UIREWARDPROGRESSWIDGET_INITPROGRESS_OFFSET UNITYSDK_OFFSET(0xAEA56C0)
#define UIREWARDPROGRESSWIDGET_SETPROGERSS_OFFSET UNITYSDK_OFFSET(0xAEA5750)
#define UIREWARDPROGRESSWIDGET_SETREWARD_OFFSET UNITYSDK_OFFSET(0xAEA5EE0)
#define UIREWARDPROGRESSWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0xAEA6110)

inline static constexpr unsigned int UIRewardProgressWidget_TypeDefinitionIndex = 71536;
