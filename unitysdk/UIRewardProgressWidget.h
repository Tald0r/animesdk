...
#define UIREWARDPROGRESSWIDGET_CONVERTPROGRESS_OFFSET UNITYSDK_OFFSET(0x16C5C8C0)
#define UIREWARDPROGRESSWIDGET_GETMAXVAL_OFFSET UNITYSDK_OFFSET(0x16C5C940)
#define UIREWARDPROGRESSWIDGET_INITPROGRESS_OFFSET UNITYSDK_OFFSET(0x16C5C180)
#define UIREWARDPROGRESSWIDGET_SETPROGERSS_OFFSET UNITYSDK_OFFSET(0x16C5C210)
#define UIREWARDPROGRESSWIDGET_SETREWARD_OFFSET UNITYSDK_OFFSET(0x16C5C9A0)
#define UIREWARDPROGRESSWIDGET_START_OFFSET UNITYSDK_OFFSET(0x16C5C0C0)
#define UIREWARDPROGRESSWIDGET_UPDATE_OFFSET UNITYSDK_OFFSET(0x16C5C120)
#define UIREWARDPROGRESSWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0x16C5CBD0)

inline static constexpr unsigned int UIRewardProgressWidget_TypeDefinitionIndex = 61219;
...
public:
	...
	::System::Void Start()
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + UIREWARDPROGRESSWIDGET_START_OFFSET))(this);
	}

	::System::Void Update()
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + UIREWARDPROGRESSWIDGET_UPDATE_OFFSET))(this);
	}
