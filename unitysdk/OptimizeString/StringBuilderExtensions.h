...
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_1_OFFSET UNITYSDK_OFFSET(0x1B142E20)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_2_OFFSET UNITYSDK_OFFSET(0x1B142EE0)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_3_OFFSET UNITYSDK_OFFSET(0x1B142DA0)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_4_OFFSET UNITYSDK_OFFSET(0x1B142FF0)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_5_OFFSET UNITYSDK_OFFSET(0x1B143150)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_6_OFFSET UNITYSDK_OFFSET(0x1B1431D0)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_7_OFFSET UNITYSDK_OFFSET(0x1B1433D0)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_8_OFFSET UNITYSDK_OFFSET(0x1B1435F0)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_CONCAT_OFFSET UNITYSDK_OFFSET(0x1B142CE0)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS_EMPTY_OFFSET UNITYSDK_OFFSET(0x1B143EB0)
#define OPTIMIZESTRING_STRINGBUILDEREXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B143EE0)

namespace OptimizeString
{
	inline static constexpr unsigned int StringBuilderExtensions_TypeDefinitionIndex = 7117;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(StringBuilderExtensions_TypeDefinitionIndex)->GetStaticField(0x5FB0);
		}
		static ::System::Char* StaticGet_ms_default_pad_char()
		{
			return (::System::Char*)Il2CppClass::FromTypeDefinitionIndex(StringBuilderExtensions_TypeDefinitionIndex)->GetStaticField(0x3210);
		}
		static ::System::UInt32* StaticGet_ms_default_decimal_places()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(StringBuilderExtensions_TypeDefinitionIndex)->GetStaticField(0x3214);
		}
