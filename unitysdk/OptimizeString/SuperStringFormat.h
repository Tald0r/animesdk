...
#define OPTIMIZESTRING_SUPERSTRINGFORMAT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B7616E0)
#define OPTIMIZESTRING_SUPERSTRINGFORMAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7616D0)
