...
#define MONOUILOOPTEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0x64502A0)
#define MONOUILOOPTEXT_CLEARLOOPTEXT_OFFSET UNITYSDK_OFFSET(0x6452170)
#define MONOUILOOPTEXT_CLEARTEXTKEY_OFFSET UNITYSDK_OFFSET(0x6452200)
#define MONOUILOOPTEXT_GETMOVEDELAY_OFFSET UNITYSDK_OFFSET(0x6450C80)
#define MONOUILOOPTEXT_GETPREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x64523F0)
#define MONOUILOOPTEXT_GETRAWTEXT_OFFSET UNITYSDK_OFFSET(0x6451000)
#define MONOUILOOPTEXT_GETSINGLELOOPTIME_OFFSET UNITYSDK_OFFSET(0x6450CE0)
#define MONOUILOOPTEXT_ISLOOPING_OFFSET UNITYSDK_OFFSET(0x6450F30)
#define MONOUILOOPTEXT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6452930)
#define MONOUILOOPTEXT_ONLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0x6452760)
#define MONOUILOOPTEXT_SETKEY_OFFSET UNITYSDK_OFFSET(0x6451DF0)
#define MONOUILOOPTEXT_SETLOOPONCECALL_OFFSET UNITYSDK_OFFSET(0x6450F90)
#define MONOUILOOPTEXT_SETTEXTINNER_OFFSET UNITYSDK_OFFSET(0x64511B0)
#define MONOUILOOPTEXT_SETTEXT_OFFSET UNITYSDK_OFFSET(0x64504C0)
#define MONOUILOOPTEXT_SHOWTEXT_OFFSET UNITYSDK_OFFSET(0x6451060)
#define MONOUILOOPTEXT_START_OFFSET UNITYSDK_OFFSET(0x64506C0)
#define MONOUILOOPTEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0x6450720)
#define MONOUILOOPTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x64529A0)

inline static constexpr unsigned int MonoUILoopText_TypeDefinitionIndex = 37670;
...
public:
	...
	::System::Void Start()
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MONOUILOOPTEXT_START_OFFSET))(this);
	}
