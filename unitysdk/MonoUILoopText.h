...
#define MONOUILOOPTEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0x7927B30)
#define MONOUILOOPTEXT_CLEARLOOPTEXT_OFFSET UNITYSDK_OFFSET(0x79299A0)
#define MONOUILOOPTEXT_CLEARTEXTKEY_OFFSET UNITYSDK_OFFSET(0x7929A30)
#define MONOUILOOPTEXT_GETMOVEDELAY_OFFSET UNITYSDK_OFFSET(0x79284B0)
#define MONOUILOOPTEXT_GETPREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x7929C20)
#define MONOUILOOPTEXT_GETRAWTEXT_OFFSET UNITYSDK_OFFSET(0x7928830)
#define MONOUILOOPTEXT_GETSINGLELOOPTIME_OFFSET UNITYSDK_OFFSET(0x7928510)
#define MONOUILOOPTEXT_ISLOOPING_OFFSET UNITYSDK_OFFSET(0x7928760)
#define MONOUILOOPTEXT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x792A160)
#define MONOUILOOPTEXT_ONLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0x7929F90)
#define MONOUILOOPTEXT_SETKEY_OFFSET UNITYSDK_OFFSET(0x7929620)
#define MONOUILOOPTEXT_SETLOOPONCECALL_OFFSET UNITYSDK_OFFSET(0x79287C0)
#define MONOUILOOPTEXT_SETTEXTINNER_OFFSET UNITYSDK_OFFSET(0x79289E0)
#define MONOUILOOPTEXT_SETTEXT_OFFSET UNITYSDK_OFFSET(0x7927D50)
#define MONOUILOOPTEXT_SHOWTEXT_OFFSET UNITYSDK_OFFSET(0x7928890)
#define MONOUILOOPTEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0x7927F50)
#define MONOUILOOPTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x792A1D0)

inline static constexpr unsigned int MonoUILoopText_TypeDefinitionIndex = 67116;
