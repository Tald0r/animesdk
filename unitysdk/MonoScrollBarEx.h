...
#define MONOSCROLLBAREX_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x9A32F90)
#define MONOSCROLLBAREX_ONDRAG_OFFSET UNITYSDK_OFFSET(0x9A33150)
#define MONOSCROLLBAREX_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x9A33210)
#define MONOSCROLLBAREX_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x9A33050)
#define MONOSCROLLBAREX__CTOR_OFFSET UNITYSDK_OFFSET(0x9A332D0)
#define MONOSCROLLBAREX___BASE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x9A33400)
#define MONOSCROLLBAREX___BASE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x9A33410)
#define MONOSCROLLBAREX___BASE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x9A33420)
#define MONOSCROLLBAREX___BASE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x9A33430)

inline static constexpr unsigned int MonoScrollBarEx_TypeDefinitionIndex = 46705;
