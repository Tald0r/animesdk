...
#define MONOSCROLLBAREX_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xAD00760)
#define MONOSCROLLBAREX_ONDRAG_OFFSET UNITYSDK_OFFSET(0xAD00920)
#define MONOSCROLLBAREX_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xAD009E0)
#define MONOSCROLLBAREX_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xAD00820)
#define MONOSCROLLBAREX__CTOR_OFFSET UNITYSDK_OFFSET(0xAD00AA0)
#define MONOSCROLLBAREX___BASE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xAD00BD0)
#define MONOSCROLLBAREX___BASE_ONDRAG_OFFSET UNITYSDK_OFFSET(0xAD00BE0)
#define MONOSCROLLBAREX___BASE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xAD00BF0)
#define MONOSCROLLBAREX___BASE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xAD00C00)

inline static constexpr unsigned int MonoScrollBarEx_TypeDefinitionIndex = 58859;
