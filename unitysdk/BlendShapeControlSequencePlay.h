...
#define BLENDSHAPECONTROLSEQUENCEPLAY_GETCURRENTUVSHIFT_OFFSET UNITYSDK_OFFSET(0xB0151F0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_GETNAPRENDERER_OFFSET UNITYSDK_OFFSET(0xB014A50)
#define BLENDSHAPECONTROLSEQUENCEPLAY_GETSEQUENCEMATERIAL_OFFSET UNITYSDK_OFFSET(0xB014700)
#define BLENDSHAPECONTROLSEQUENCEPLAY_INITSEQUENCEMATERIALDATA_OFFSET UNITYSDK_OFFSET(0xB013970)
#define BLENDSHAPECONTROLSEQUENCEPLAY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB013DF0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB014590)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xB013C20)
#define BLENDSHAPECONTROLSEQUENCEPLAY_RESETDATA_OFFSET UNITYSDK_OFFSET(0xB014660)
#define BLENDSHAPECONTROLSEQUENCEPLAY_SEARCHMONORENDERENTITY_OFFSET UNITYSDK_OFFSET(0xB014FB0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_SETSEQUENCEMATERIAL_OFFSET UNITYSDK_OFFSET(0xB013E60)
#define BLENDSHAPECONTROLSEQUENCEPLAY_START_OFFSET UNITYSDK_OFFSET(0xB013900)
#define BLENDSHAPECONTROLSEQUENCEPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0xB015320)

inline static constexpr unsigned int BlendShapeControlSequencePlay_TypeDefinitionIndex = 50383;
