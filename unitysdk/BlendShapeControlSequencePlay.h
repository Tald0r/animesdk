...
#define BLENDSHAPECONTROLSEQUENCEPLAY_GETCURRENTUVSHIFT_OFFSET UNITYSDK_OFFSET(0x70273B0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_GETNAPRENDERER_OFFSET UNITYSDK_OFFSET(0x7026C10)
#define BLENDSHAPECONTROLSEQUENCEPLAY_GETSEQUENCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x70268C0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_INITSEQUENCEMATERIALDATA_OFFSET UNITYSDK_OFFSET(0x7025C00)
#define BLENDSHAPECONTROLSEQUENCEPLAY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7026080)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x7025980)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x7025B10)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x7025A40)
#define BLENDSHAPECONTROLSEQUENCEPLAY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x7025EB0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_RESETDATA_OFFSET UNITYSDK_OFFSET(0x7026820)
#define BLENDSHAPECONTROLSEQUENCEPLAY_SEARCHMONORENDERENTITY_OFFSET UNITYSDK_OFFSET(0x7027170)
#define BLENDSHAPECONTROLSEQUENCEPLAY_SETSEQUENCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x70260F0)
#define BLENDSHAPECONTROLSEQUENCEPLAY_START_OFFSET UNITYSDK_OFFSET(0x7025B90)
#define BLENDSHAPECONTROLSEQUENCEPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x70274E0)

inline static constexpr unsigned int BlendShapeControlSequencePlay_TypeDefinitionIndex = 54534;
