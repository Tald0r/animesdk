...
#define AKITERATOR_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B705B90)
#define AKITERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B705AD0)
#define AKITERATOR_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B705B20)
#define AKITERATOR_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1B705A60)
#define AKITERATOR_GETITEM_OFFSET UNITYSDK_OFFSET(0x1B706010)
#define AKITERATOR_GET_PITEM_OFFSET UNITYSDK_OFFSET(0x1B705D90)
#define AKITERATOR_ISDIFFERENTFROM_OFFSET UNITYSDK_OFFSET(0x1B706190)
#define AKITERATOR_ISEQUALTO_OFFSET UNITYSDK_OFFSET(0x1B7060E0)
#define AKITERATOR_NEXTITER_OFFSET UNITYSDK_OFFSET(0x1B705E70)
#define AKITERATOR_PREVITER_OFFSET UNITYSDK_OFFSET(0x1B705F40)
#define AKITERATOR_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1B705A70)
#define AKITERATOR_SET_PITEM_OFFSET UNITYSDK_OFFSET(0x1B705CF0)
#define AKITERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B706240)
#define AKITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B705A50)

inline static constexpr unsigned int AkIterator_TypeDefinitionIndex = 30895;
