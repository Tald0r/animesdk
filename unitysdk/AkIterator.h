...
#define AKITERATOR_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B0EF0A0)
#define AKITERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B0EEFE0)
#define AKITERATOR_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B0EF030)
#define AKITERATOR_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1B0EEF70)
#define AKITERATOR_GETITEM_OFFSET UNITYSDK_OFFSET(0x1B0EF520)
#define AKITERATOR_GET_PITEM_OFFSET UNITYSDK_OFFSET(0x1B0EF2A0)
#define AKITERATOR_ISDIFFERENTFROM_OFFSET UNITYSDK_OFFSET(0x1B0EF6A0)
#define AKITERATOR_ISEQUALTO_OFFSET UNITYSDK_OFFSET(0x1B0EF5F0)
#define AKITERATOR_NEXTITER_OFFSET UNITYSDK_OFFSET(0x1B0EF380)
#define AKITERATOR_PREVITER_OFFSET UNITYSDK_OFFSET(0x1B0EF450)
#define AKITERATOR_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1B0EEF80)
#define AKITERATOR_SET_PITEM_OFFSET UNITYSDK_OFFSET(0x1B0EF200)
#define AKITERATOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0EF750)
#define AKITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EEF60)

inline static constexpr unsigned int AkIterator_TypeDefinitionIndex = 29942;
