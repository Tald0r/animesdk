...
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_COMPUTESHADER_OFFSET UNITYSDK_OFFSET(0x13919A60)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_GLAREMATERIAL1_OFFSET UNITYSDK_OFFSET(0x13919AC0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_GLAREMATERIAL2_OFFSET UNITYSDK_OFFSET(0x13919AD0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_GLAREMATERIAL3_OFFSET UNITYSDK_OFFSET(0x13919AE0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_GLAREMATERIAL4_OFFSET UNITYSDK_OFFSET(0x13919AF0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_LENSFLARECOLORRAMPDEFAULT_OFFSET UNITYSDK_OFFSET(0x139199F0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_LENSSURFACEDIFFRACTIONTEXTUREDEFAULT_OFFSET UNITYSDK_OFFSET(0x139199E0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_LENSSURFACEDIRTTEXTUREDEFAULT_OFFSET UNITYSDK_OFFSET(0x139199D0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SELECTIVERENDERSHADER_OFFSET UNITYSDK_OFFSET(0x13919A00)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM20SHADER_OFFSET UNITYSDK_OFFSET(0x13919A10)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM25SHADER_OFFSET UNITYSDK_OFFSET(0x13919A20)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM35SHADER_OFFSET UNITYSDK_OFFSET(0x13919A30)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM40GEOMETRYSHADER_OFFSET UNITYSDK_OFFSET(0x13919A50)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM45SHADER_OFFSET UNITYSDK_OFFSET(0x13919A40)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x13919B00)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int MKGlowResources_TypeDefinitionIndex = 28210;
