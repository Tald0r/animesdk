...
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_COMPUTESHADER_OFFSET UNITYSDK_OFFSET(0x151A0D00)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_GLAREMATERIAL1_OFFSET UNITYSDK_OFFSET(0x151A0D60)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_GLAREMATERIAL2_OFFSET UNITYSDK_OFFSET(0x151A0D70)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_GLAREMATERIAL3_OFFSET UNITYSDK_OFFSET(0x151A0D80)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_GLAREMATERIAL4_OFFSET UNITYSDK_OFFSET(0x151A0D90)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_LENSFLARECOLORRAMPDEFAULT_OFFSET UNITYSDK_OFFSET(0x151A0C90)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_LENSSURFACEDIFFRACTIONTEXTUREDEFAULT_OFFSET UNITYSDK_OFFSET(0x151A0C80)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_LENSSURFACEDIRTTEXTUREDEFAULT_OFFSET UNITYSDK_OFFSET(0x151A0C70)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SELECTIVERENDERSHADER_OFFSET UNITYSDK_OFFSET(0x151A0CA0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM20SHADER_OFFSET UNITYSDK_OFFSET(0x151A0CB0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM25SHADER_OFFSET UNITYSDK_OFFSET(0x151A0CC0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM35SHADER_OFFSET UNITYSDK_OFFSET(0x151A0CD0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM40GEOMETRYSHADER_OFFSET UNITYSDK_OFFSET(0x151A0CF0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES_GET_SM45SHADER_OFFSET UNITYSDK_OFFSET(0x151A0CE0)
#define POSTPROCESS_MKGLOW_MKGLOWRESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x151A0DA0)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int MKGlowResources_TypeDefinitionIndex = 29151;
