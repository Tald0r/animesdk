...
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_1_OFFSET UNITYSDK_OFFSET(0x17B64EA0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_2_OFFSET UNITYSDK_OFFSET(0x17B65090)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_3_OFFSET UNITYSDK_OFFSET(0x17B65130)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_OFFSET UNITYSDK_OFFSET(0x17B64CB0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_GETTEMPORARY_OFFSET UNITYSDK_OFFSET(0x17B65530)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_GET_SCREENMESH_OFFSET UNITYSDK_OFFSET(0x17B64880)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_SETKEYWORD_1_OFFSET UNITYSDK_OFFSET(0x17B64C50)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_SETKEYWORD_OFFSET UNITYSDK_OFFSET(0x17B64BD0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_SINGLEPASSSTEREODOWNSCALE_OFFSET UNITYSDK_OFFSET(0x17B651B0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_UPDATEMIPRENDERCONTEXT_OFFSET UNITYSDK_OFFSET(0x17B652C0)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int PipelineExtensions_TypeDefinitionIndex = 28200;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(PipelineExtensions_TypeDefinitionIndex)->GetStaticField(0x211B0);
		}
