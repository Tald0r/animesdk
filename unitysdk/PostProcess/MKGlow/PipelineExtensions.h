...
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_1_OFFSET UNITYSDK_OFFSET(0x177FB4B0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_2_OFFSET UNITYSDK_OFFSET(0x177FB6A0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_3_OFFSET UNITYSDK_OFFSET(0x177FB740)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_DRAW_OFFSET UNITYSDK_OFFSET(0x177FB2C0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_GETTEMPORARY_OFFSET UNITYSDK_OFFSET(0x177FBB40)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_GET_SCREENMESH_OFFSET UNITYSDK_OFFSET(0x177FAE90)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_SETKEYWORD_1_OFFSET UNITYSDK_OFFSET(0x177FB260)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_SETKEYWORD_OFFSET UNITYSDK_OFFSET(0x177FB1E0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_SINGLEPASSSTEREODOWNSCALE_OFFSET UNITYSDK_OFFSET(0x177FB7C0)
#define POSTPROCESS_MKGLOW_PIPELINEEXTENSIONS_UPDATEMIPRENDERCONTEXT_OFFSET UNITYSDK_OFFSET(0x177FB8D0)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int PipelineExtensions_TypeDefinitionIndex = 29141;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(PipelineExtensions_TypeDefinitionIndex)->GetStaticField(0x22830);
		}
