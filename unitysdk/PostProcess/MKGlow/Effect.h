...
#define POSTPROCESS_MKGLOW_EFFECT_AFTERCOMPOSITECLEANUP_OFFSET UNITYSDK_OFFSET(0x16D86F10)
#define POSTPROCESS_MKGLOW_EFFECT_ANGLETODIRECTION_OFFSET UNITYSDK_OFFSET(0x16D85620)
#define POSTPROCESS_MKGLOW_EFFECT_ATTACHCARGBUFFERTOCOMPUTEKERNEL_OFFSET UNITYSDK_OFFSET(0x16D859E0)
#define POSTPROCESS_MKGLOW_EFFECT_BEGINPROFILESAMPLE_OFFSET UNITYSDK_OFFSET(0x16D7D710)
#define POSTPROCESS_MKGLOW_EFFECT_BUILD_OFFSET UNITYSDK_OFFSET(0x16D7D7D0)
#define POSTPROCESS_MKGLOW_EFFECT_CHECKFEATURESUPPORT_OFFSET UNITYSDK_OFFSET(0x16D7D520)
#define POSTPROCESS_MKGLOW_EFFECT_COMPOSITE_OFFSET UNITYSDK_OFFSET(0x16D847B0)
#define POSTPROCESS_MKGLOW_EFFECT_CONVERTGAMMAVALUE_1_OFFSET UNITYSDK_OFFSET(0x16D85320)
#define POSTPROCESS_MKGLOW_EFFECT_CONVERTGAMMAVALUE_OFFSET UNITYSDK_OFFSET(0x16D85120)
#define POSTPROCESS_MKGLOW_EFFECT_DISABLEDEBUGKEYWORDS_OFFSET UNITYSDK_OFFSET(0x16D86E60)
#define POSTPROCESS_MKGLOW_EFFECT_DISABLERENDERKEYWORDS_OFFSET UNITYSDK_OFFSET(0x16D86500)
#define POSTPROCESS_MKGLOW_EFFECT_DISABLE_OFFSET UNITYSDK_OFFSET(0x16D7B650)
#define POSTPROCESS_MKGLOW_EFFECT_DOWNSAMPLE_OFFSET UNITYSDK_OFFSET(0x16D82C70)
#define POSTPROCESS_MKGLOW_EFFECT_DRAW_OFFSET UNITYSDK_OFFSET(0x16D86AA0)
#define POSTPROCESS_MKGLOW_EFFECT_ENABLE_OFFSET UNITYSDK_OFFSET(0x16D7B470)
#define POSTPROCESS_MKGLOW_EFFECT_ENDPROFILESAMPLE_OFFSET UNITYSDK_OFFSET(0x16D7D770)
#define POSTPROCESS_MKGLOW_EFFECT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x16D7B640)
#define POSTPROCESS_MKGLOW_EFFECT_GET_CURRENTRENDERINDEX_OFFSET UNITYSDK_OFFSET(0x16D7A6B0)
#define POSTPROCESS_MKGLOW_EFFECT_GET_RENDERTEXTUREFORMAT_OFFSET UNITYSDK_OFFSET(0x16D7A6C0)
#define POSTPROCESS_MKGLOW_EFFECT_GET_SELECTIVEGLOWCAMERAOBJECT_OFFSET UNITYSDK_OFFSET(0x16D7D040)
#define POSTPROCESS_MKGLOW_EFFECT_GET_SELECTIVEGLOWCAMERA_OFFSET UNITYSDK_OFFSET(0x16D7D1E0)
#define POSTPROCESS_MKGLOW_EFFECT_GET_SOURCEFRAMEBUFFER_OFFSET UNITYSDK_OFFSET(0x16D7A590)
#define POSTPROCESS_MKGLOW_EFFECT_PREPAREDRAW_1_OFFSET UNITYSDK_OFFSET(0x16D865B0)
#define POSTPROCESS_MKGLOW_EFFECT_PREPAREDRAW_OFFSET UNITYSDK_OFFSET(0x16D86120)
#define POSTPROCESS_MKGLOW_EFFECT_PREPARESCATTERING_OFFSET UNITYSDK_OFFSET(0x16D7B700)
#define POSTPROCESS_MKGLOW_EFFECT_PRESAMPLE_OFFSET UNITYSDK_OFFSET(0x16D823A0)
#define POSTPROCESS_MKGLOW_EFFECT_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x16D84ED0)
#define POSTPROCESS_MKGLOW_EFFECT_SETKEYWORD_OFFSET UNITYSDK_OFFSET(0x16D856B0)
#define POSTPROCESS_MKGLOW_EFFECT_SETRENDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x16D86370)
#define POSTPROCESS_MKGLOW_EFFECT_SETTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x16D85E50)
#define POSTPROCESS_MKGLOW_EFFECT_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x16D85BB0)
#define POSTPROCESS_MKGLOW_EFFECT_SETUPSELECTIVEGLOWCAMERA_OFFSET UNITYSDK_OFFSET(0x16D7D360)
#define POSTPROCESS_MKGLOW_EFFECT_SETVECTOR_1_OFFSET UNITYSDK_OFFSET(0x16D851C0)
#define POSTPROCESS_MKGLOW_EFFECT_SETVECTOR_2_OFFSET UNITYSDK_OFFSET(0x16D84DC0)
#define POSTPROCESS_MKGLOW_EFFECT_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x16D84FB0)
#define POSTPROCESS_MKGLOW_EFFECT_UPDATECOMPUTESHADERTHREADGROUPS_OFFSET UNITYSDK_OFFSET(0x16D85800)
#define POSTPROCESS_MKGLOW_EFFECT_UPDATECONSTANTBUFFERS_OFFSET UNITYSDK_OFFSET(0x16D7E230)
#define POSTPROCESS_MKGLOW_EFFECT_UPDATERENDERBUFFERS_OFFSET UNITYSDK_OFFSET(0x16D7B810)
#define POSTPROCESS_MKGLOW_EFFECT_UPDATERENDERINDEX_1_OFFSET UNITYSDK_OFFSET(0x16D85950)
#define POSTPROCESS_MKGLOW_EFFECT_UPDATERENDERINDEX_OFFSET UNITYSDK_OFFSET(0x16D85900)
#define POSTPROCESS_MKGLOW_EFFECT_UPSAMPLE_OFFSET UNITYSDK_OFFSET(0x16D839B0)
#define POSTPROCESS_MKGLOW_EFFECT__CCTOR_OFFSET UNITYSDK_OFFSET(0x16D87070)
#define POSTPROCESS_MKGLOW_EFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D7A6D0)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int Effect_TypeDefinitionIndex = 28191;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Effect_TypeDefinitionIndex)->GetStaticField(0x22590);
		}
		static ::PostProcess::MKGlow::MKGlowResources** StaticGet__resources()
		{
			return (::PostProcess::MKGlow::MKGlowResources**)Il2CppClass::FromTypeDefinitionIndex(Effect_TypeDefinitionIndex)->GetStaticField(0x22598);
		}
		static ::System::String** StaticGet__selectiveReplacementTag()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Effect_TypeDefinitionIndex)->GetStaticField(0x225A0);
		}
		static ::System::Int32* StaticGet__cArgBufferSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_TypeDefinitionIndex)->GetStaticField(0x7050);
		}
		static ::System::Single* StaticGet__referenceAspectRatio()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Effect_TypeDefinitionIndex)->GetStaticField(0x7054);
		}
		static ::System::Int32* StaticGet__glareIterationsBase()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_TypeDefinitionIndex)->GetStaticField(0x7058);
		}
		static ::UnityEngine::Vector2* StaticGet__selectiveWorkflowThreshold()
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(Effect_TypeDefinitionIndex)->GetStaticField(0x705C);
		}
		static ::PostProcess::MKGlow::RenderDimension* StaticGet__directComputeSize()
		{
			return (::PostProcess::MKGlow::RenderDimension*)Il2CppClass::FromTypeDefinitionIndex(Effect_TypeDefinitionIndex)->GetStaticField(0x7064);
		}
		static ::UnityEngine::Vector2* StaticGet__referenceResolution()
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(Effect_TypeDefinitionIndex)->GetStaticField(0x706C);
		}
		static ::System::Single* StaticGet_naturalIntensityMult()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Effect_TypeDefinitionIndex)->GetStaticField(0x7074);
		}
		::UnityEngine::Rendering::CommandBuffer* _commandBuffer; // 0x10
		::PostProcess::MKGlow::RenderTarget _selectiveRenderTarget; // 0x18
		::PostProcess::MKGlow::MipBuffer* _glareUpsampleBuffer2; // 0x50
		::Il2CppArray<::PostProcess::MKGlow::Effect_Keyword>* _shaderKeywords; // 0x58
		::Il2CppArray<::UnityEngine::Vector2>* glareAngles; // 0x60
		::PostProcess::MKGlow::RenderContext* _selectiveRenderContext; // 0x68
		::PostProcess::MKGlow::MipBuffer* _glareUpsampleBuffer0; // 0x70
		::PostProcess::MKGlow::RenderTarget _destinationFrameBuffer; // 0x78
		::PostProcess::MKGlow::MipBuffer* _bloomUpsampleBuffer; // 0xB0
		::UnityEngine::Material* _renderMaterialNoGeometry; // 0xB8
		::UnityEngine::Camera* _selectiveGlowCamera; // 0xC0
		::Il2CppArray<::PostProcess::MKGlow::RenderContext*>* _sourceContext; // 0xC8
		::PostProcess::MKGlow::ISettings* _settings; // 0xD0
		::PostProcess::MKGlow::MipBuffer* _glareDownsampleBuffer1; // 0xD8
		::PostProcess::MKGlow::RenderTarget _sourceFrameBuffer; // 0xE0
		::PostProcess::MKGlow::MipBuffer* _lensFlareDownsampleBuffer; // 0x118
		::UnityEngine::ComputeBuffer* _cArgsComputeBuffer; // 0x120
		::UnityEngine::Camera* _renderingCamera; // 0x128
		::System::Collections::Generic::List_1<::PostProcess::MKGlow::RenderTarget>* _renderTargetsBundle; // 0x130
		::Il2CppArray<::PostProcess::MKGlow::MipBuffer*>* packedGlareupsampleBuffers; // 0x138
		::PostProcess::MKGlow::MipBuffer* _lensFlareUpsampleBuffer; // 0x140
		::Il2CppArray<::PostProcess::MKGlow::RenderContext*>* _renderContext; // 0x148
		::Il2CppArray<::PostProcess::MKGlow::MipBuffer*>* packedGlareDownsampleBuffers; // 0x150
		::PostProcess::MKGlow::MipBuffer* _glareDownsampleBuffer2; // 0x158
		::PostProcess::MKGlow::ICameraData* _cameraData; // 0x160
		::Il2CppArray<::System::Single>* _cArgArray; // 0x168
		::UnityEngine::Material* _renderMaterialGeometry; // 0x170
		::PostProcess::MKGlow::MipBuffer* _glareDownsampleBuffer0; // 0x178
		::PostProcess::MKGlow::MipBuffer* _glareUpsampleBuffer1; // 0x180
		::UnityEngine::GameObject* _selectiveGlowCameraObject; // 0x188
		::PostProcess::MKGlow::MipBuffer* _glareDownsampleBuffer3; // 0x190
		::PostProcess::MKGlow::MipBuffer* _bloomDownsampleBuffer; // 0x198
		::System::Collections::Generic::List_1<::PostProcess::MKGlow::Effect_MaterialKeywords>* _renderKeywordsBundle; // 0x1A0
		::PostProcess::MKGlow::MipBuffer* _glareUpsampleBuffer3; // 0x1A8
		::PostProcess::MKGlow::RenderDimension _computeThreadGroups; // 0x1B0
		::UnityEngine::Vector2 _resolutionScale; // 0x1B8
		::System::Int32 _glareIterations; // 0x1C0
		::PostProcess::MKGlow::DebugView _debugView; // 0x1C4
		::System::Boolean _useGeometryShaders; // 0x1C8
		::System::Boolean _finalBlit; // 0x1C9
		::System::Single _lensFlareUpsampleSpread; // 0x1CC
		::System::Int32 _minIterations; // 0x1D0
		::UnityEngine::RenderTextureFormat _renderTextureFormat; // 0x1D4
		::System::Boolean _useGlare; // 0x1D8
		::System::Boolean _useComputeShaders; // 0x1D9
		::System::Boolean _useLensFlare; // 0x1DA
		::System::Boolean _useLensSurface; // 0x1DB
		::System::Int32 _bloomIterations; // 0x1DC
		::System::Int32 _lensFlareIterations; // 0x1E0
		::System::Single bloomUpsampleSpread; // 0x1E4
		::System::Int32 _currentRenderIndex; // 0x1E8
		::System::Single _glareScatteringMult; // 0x1EC
