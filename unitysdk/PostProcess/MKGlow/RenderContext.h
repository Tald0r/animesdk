...
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x16D87120)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_ENABLERANDOMWRITE_OFFSET UNITYSDK_OFFSET(0x16D87150)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x16D7D030)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_RENDERDIMENSION_OFFSET UNITYSDK_OFFSET(0x16D7E1F0)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x16D7D020)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_SINGLEPASSSTEREOADJUSTWIDTH_OFFSET UNITYSDK_OFFSET(0x16D7CF40)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_UPDATERENDERCONTEXT_OFFSET UNITYSDK_OFFSET(0x16D7C770)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D7B390)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int RenderContext_TypeDefinitionIndex = 28207;
