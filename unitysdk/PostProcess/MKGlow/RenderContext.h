...
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x173EE290)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_ENABLERANDOMWRITE_OFFSET UNITYSDK_OFFSET(0x173EE2C0)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x173E4220)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_RENDERDIMENSION_OFFSET UNITYSDK_OFFSET(0x173E53E0)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x173E4210)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_SINGLEPASSSTEREOADJUSTWIDTH_OFFSET UNITYSDK_OFFSET(0x173E4130)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT_UPDATERENDERCONTEXT_OFFSET UNITYSDK_OFFSET(0x173E3960)
#define POSTPROCESS_MKGLOW_RENDERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x173E2580)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int RenderContext_TypeDefinitionIndex = 29148;
