...
#define POSTPROCESS_MKGLOW_PIPELINEPROPERTIES_SHADERPROPERTIES_DEFAULTPROPERTY_GET_ID_OFFSET UNITYSDK_OFFSET(0x185CA2C0)
#define POSTPROCESS_MKGLOW_PIPELINEPROPERTIES_SHADERPROPERTIES_DEFAULTPROPERTY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x185CA2B0)
#define POSTPROCESS_MKGLOW_PIPELINEPROPERTIES_SHADERPROPERTIES_DEFAULTPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x185CA2D0)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int PipelineProperties_ShaderProperties_DefaultProperty_TypeDefinitionIndex = 28203;
