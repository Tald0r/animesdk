...
#define POSTPROCESS_MKGLOW_PIPELINEPROPERTIES_SHADERPROPERTIES_DEFAULTPROPERTY_GET_ID_OFFSET UNITYSDK_OFFSET(0x18B32A40)
#define POSTPROCESS_MKGLOW_PIPELINEPROPERTIES_SHADERPROPERTIES_DEFAULTPROPERTY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18B32A30)
#define POSTPROCESS_MKGLOW_PIPELINEPROPERTIES_SHADERPROPERTIES_DEFAULTPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18B32A50)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int PipelineProperties_ShaderProperties_DefaultProperty_TypeDefinitionIndex = 29144;
