...
#define POSTPROCESS_MKGLOW_RENDERDIMENSION_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x2D38E0)
#define POSTPROCESS_MKGLOW_RENDERDIMENSION_GET_RENDERDIMENSION_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define POSTPROCESS_MKGLOW_RENDERDIMENSION_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define POSTPROCESS_MKGLOW_RENDERDIMENSION_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x2D38F0)
#define POSTPROCESS_MKGLOW_RENDERDIMENSION_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x2D3600)
#define POSTPROCESS_MKGLOW_RENDERDIMENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3730)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int RenderDimension_TypeDefinitionIndex = 28184;
