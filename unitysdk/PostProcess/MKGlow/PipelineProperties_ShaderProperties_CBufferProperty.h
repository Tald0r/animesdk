...
#define POSTPROCESS_MKGLOW_PIPELINEPROPERTIES_SHADERPROPERTIES_CBUFFERPROPERTY_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x17BED650)
#define POSTPROCESS_MKGLOW_PIPELINEPROPERTIES_SHADERPROPERTIES_CBUFFERPROPERTY_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x17BED660)
#define POSTPROCESS_MKGLOW_PIPELINEPROPERTIES_SHADERPROPERTIES_CBUFFERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x17BED670)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int PipelineProperties_ShaderProperties_CBufferProperty_TypeDefinitionIndex = 28204;
