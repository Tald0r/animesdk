...
#define POSTPROCESS_MKGLOW_EFFECT_KEYWORD__CTOR_OFFSET UNITYSDK_OFFSET(0x2D5CF0)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int Effect_Keyword_TypeDefinitionIndex = 28194;
