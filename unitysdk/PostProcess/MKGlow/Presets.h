...
#define POSTPROCESS_MKGLOW_PRESETS_SETGLAREPRESET_OFFSET UNITYSDK_OFFSET(0x180312B0)
#define POSTPROCESS_MKGLOW_PRESETS_SETLENSFLAREPRESET_OFFSET UNITYSDK_OFFSET(0x18030A40)
#define POSTPROCESS_MKGLOW_PRESETS__CTOR_OFFSET UNITYSDK_OFFSET(0x18032B50)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int Presets_TypeDefinitionIndex = 28206;
