...
#define POSTPROCESS_MKGLOW_MIPBUFFER_CLEARTEMPORARY_OFFSET UNITYSDK_OFFSET(0x17632A30)
#define POSTPROCESS_MKGLOW_MIPBUFFER_CREATETEMPORARY_OFFSET UNITYSDK_OFFSET(0x176328E0)
#define POSTPROCESS_MKGLOW_MIPBUFFER_GET_RENDERTARGETS_OFFSET UNITYSDK_OFFSET(0x17632680)
#define POSTPROCESS_MKGLOW_MIPBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x17632690)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int MipBuffer_TypeDefinitionIndex = 29140;
