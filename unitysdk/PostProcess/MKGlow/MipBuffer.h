...
#define POSTPROCESS_MKGLOW_MIPBUFFER_CLEARTEMPORARY_OFFSET UNITYSDK_OFFSET(0x16F5E790)
#define POSTPROCESS_MKGLOW_MIPBUFFER_CREATETEMPORARY_OFFSET UNITYSDK_OFFSET(0x16F5E640)
#define POSTPROCESS_MKGLOW_MIPBUFFER_GET_RENDERTARGETS_OFFSET UNITYSDK_OFFSET(0x16F5E3E0)
#define POSTPROCESS_MKGLOW_MIPBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5E3F0)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int MipBuffer_TypeDefinitionIndex = 28199;
