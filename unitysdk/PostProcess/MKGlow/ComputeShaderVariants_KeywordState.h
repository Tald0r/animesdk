...
#define POSTPROCESS_MKGLOW_COMPUTESHADERVARIANTS_KEYWORDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x33BF20)

namespace PostProcess::MKGlow
{
	inline static constexpr unsigned int ComputeShaderVariants_KeywordState_TypeDefinitionIndex = 28190;
