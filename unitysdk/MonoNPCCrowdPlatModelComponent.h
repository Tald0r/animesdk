...
#define MONONPCCROWDPLATMODELCOMPONENT_GET_CACHEMATERIALPROPBLOCK_OFFSET UNITYSDK_OFFSET(0x852D800)
#define MONONPCCROWDPLATMODELCOMPONENT_GET_GPUMESHRENDER_OFFSET UNITYSDK_OFFSET(0x852D7F0)
#define MONONPCCROWDPLATMODELCOMPONENT_INITMATERIALPARAMS_OFFSET UNITYSDK_OFFSET(0x852D890)
#define MONONPCCROWDPLATMODELCOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x852DFB0)
#define MONONPCCROWDPLATMODELCOMPONENT_ONFRAMEINDEXCHANGED_OFFSET UNITYSDK_OFFSET(0x852E440)
#define MONONPCCROWDPLATMODELCOMPONENT_TRIGGERDITHER_OFFSET UNITYSDK_OFFSET(0x852E260)
#define MONONPCCROWDPLATMODELCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x852E750)
#define MONONPCCROWDPLATMODELCOMPONENT__INITMATERIALPARAMS_B__19_0_OFFSET UNITYSDK_OFFSET(0x852E790)

inline static constexpr unsigned int MonoNPCCrowdPlatModelComponent_TypeDefinitionIndex = 68439;
