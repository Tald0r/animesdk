...
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x6060090)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x60608E0)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x6060940)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x60608F0)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6060080)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0x6060070)

inline static constexpr unsigned int MonoUIAnimScroll__GetUIElementInfo_d__6_TypeDefinitionIndex = 44085;
