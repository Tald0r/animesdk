...
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7BF5280)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x7BF5AD0)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x7BF5B30)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x7BF5AE0)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7BF5270)
#define MONOUIANIMSCROLL__GETUIELEMENTINFO_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0x7BF5260)

inline static constexpr unsigned int MonoUIAnimScroll__GetUIElementInfo_d__6_TypeDefinitionIndex = 51772;
