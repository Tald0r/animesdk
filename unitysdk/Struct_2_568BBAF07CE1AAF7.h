...
#define STRUCT_2_568BBAF07CE1AAF7_METHOD_2_70A3CDBA9B3C8E31_OFFSET UNITYSDK_OFFSET(0x340520)
#define STRUCT_2_568BBAF07CE1AAF7_METHOD_2_9C12A00315CAECCE_OFFSET UNITYSDK_OFFSET(0x340450)
#define STRUCT_2_568BBAF07CE1AAF7_METHOD_2_9D83DCE9853BC392_OFFSET UNITYSDK_OFFSET(0x340510)

inline static constexpr unsigned int Struct_2_568BBAF07CE1AAF7_TypeDefinitionIndex = 51056;
...
struct alignas(8) Struct_2_568BBAF07CE1AAF7
{
	...
	::SimpleJSON::JSONNode* Method_2_9D83DCE9853BC392()
	{
		return ((::SimpleJSON::JSONNode*(*)(::PVOID))((::PBYTE)hIl2Cpp + STRUCT_2_568BBAF07CE1AAF7_METHOD_2_9D83DCE9853BC392_OFFSET))(this);
	}
