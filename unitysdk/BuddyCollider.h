...
#define BUDDYCOLLIDER_CALCONTAINSGRIDS_OFFSET UNITYSDK_OFFSET(0x6AACC30)
#define BUDDYCOLLIDER_GETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x6AAC4F0)
#define BUDDYCOLLIDER_GET_CONTAINSGRIDLIST_OFFSET UNITYSDK_OFFSET(0x6AAB690)
#define BUDDYCOLLIDER_GET_GRIDSCALE_OFFSET UNITYSDK_OFFSET(0x6AAB6B0)
#define BUDDYCOLLIDER_GET_ISCANPUTDOWN_OFFSET UNITYSDK_OFFSET(0x6AAB6C0)
#define BUDDYCOLLIDER_GET_MESH_OFFSET UNITYSDK_OFFSET(0x6AAB670)
#define BUDDYCOLLIDER_GET_RECTS_OFFSET UNITYSDK_OFFSET(0x6AAB650)
#define BUDDYCOLLIDER_ISFULLENCIRCLEMENT_OFFSET UNITYSDK_OFFSET(0x6AACA00)
#define BUDDYCOLLIDER_ISINGRIDMAP_OFFSET UNITYSDK_OFFSET(0x6AAC700)
#define BUDDYCOLLIDER_REBUILDCOLLIDERMESH_OFFSET UNITYSDK_OFFSET(0x6AAB970)
#define BUDDYCOLLIDER_ROTATE2_OFFSET UNITYSDK_OFFSET(0x6AAC0E0)
#define BUDDYCOLLIDER_ROTATEPOINT_OFFSET UNITYSDK_OFFSET(0x6AAC390)
#define BUDDYCOLLIDER_ROTATE_OFFSET UNITYSDK_OFFSET(0x6AABF40)
#define BUDDYCOLLIDER_SETRCTPOSITION_OFFSET UNITYSDK_OFFSET(0x6AABD20)
#define BUDDYCOLLIDER_SET_CONTAINSGRIDLIST_OFFSET UNITYSDK_OFFSET(0x6AAB6A0)
#define BUDDYCOLLIDER_SET_ISCANPUTDOWN_OFFSET UNITYSDK_OFFSET(0x6AAB6D0)
#define BUDDYCOLLIDER_SET_MESH_OFFSET UNITYSDK_OFFSET(0x6AAB680)
#define BUDDYCOLLIDER_SET_RECTS_OFFSET UNITYSDK_OFFSET(0x6AAB660)
#define BUDDYCOLLIDER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x6AABEA0)
#define BUDDYCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x6AAB6E0)

inline static constexpr unsigned int BuddyCollider_TypeDefinitionIndex = 67333;

class BuddyCollider : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* _Mesh_k__BackingField; // 0x10
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* initMesh; // 0x18
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* _ContainsGridList_k__BackingField; // 0x20
	::System::Collections::Generic::List_1<::UnityEngine::Vector2>* initLocalPos; // 0x28
	::System::Collections::Generic::List_1<::Struct_2_143B7A497B890286>* _Rects_k__BackingField; // 0x30
	::System::Boolean _IsCanPutDown_k__BackingField; // 0x38
	::System::Int32 gridScale; // 0x3C
	::UnityEngine::Vector2 gridMin; // 0x40
	::Struct_2_143B7A497B890286 outLineRect; // 0x48
	::System::Int32 currentAngle; // 0x60
	::UnityEngine::Vector2 center; // 0x64
	::UnityEngine::Vector2 gridMax; // 0x6C
	::UnityEngine::Vector2 Spacing; // 0x74
	::UnityEngine::Vector2 centerOffset; // 0x7C
	::UnityEngine::Vector2 outLineSize; // 0x84
