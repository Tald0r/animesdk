...
#define RUNTIMESTATSWINDOW_CLEARTEXTURE_OFFSET UNITYSDK_OFFSET(0xC4CC240)
#define RUNTIMESTATSWINDOW_DRAWLINE_OFFSET UNITYSDK_OFFSET(0xC4CCE80)
#define RUNTIMESTATSWINDOW_DRAWWINDOW_OFFSET UNITYSDK_OFFSET(0xC4CD3B0)
#define RUNTIMESTATSWINDOW_ENTITYINFODUMP_OFFSET UNITYSDK_OFFSET(0xC4CDCE0)
#define RUNTIMESTATSWINDOW_INITIALIZETEXTURES_OFFSET UNITYSDK_OFFSET(0xC4CC0D0)
#define RUNTIMESTATSWINDOW_MAXVALUE_OFFSET UNITYSDK_OFFSET(0xC4CE600)
#define RUNTIMESTATSWINDOW_ONGUI_OFFSET UNITYSDK_OFFSET(0xC4CD290)
#define RUNTIMESTATSWINDOW_START_OFFSET UNITYSDK_OFFSET(0xC4CC060)
#define RUNTIMESTATSWINDOW_UPDATEGRAPHTEXTURES_OFFSET UNITYSDK_OFFSET(0xC4CC980)
#define RUNTIMESTATSWINDOW_UPDATEGRAPHTEXTURE_OFFSET UNITYSDK_OFFSET(0xC4CCA20)
#define RUNTIMESTATSWINDOW_UPDATE_OFFSET UNITYSDK_OFFSET(0xC4CC4C0)
#define RUNTIMESTATSWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0xC4CE860)
#define RUNTIMESTATSWINDOW__ENTITYINFODUMP_G__CHILDSTARTWITHNAME_18_0_OFFSET UNITYSDK_OFFSET(0xC4CE710)

inline static constexpr unsigned int RuntimeStatsWindow_TypeDefinitionIndex = 39418;
