...
#define RUNTIMESTATSWINDOW_CLEARTEXTURE_OFFSET UNITYSDK_OFFSET(0x19C1F5C0)
#define RUNTIMESTATSWINDOW_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x19C20210)
#define RUNTIMESTATSWINDOW_DRAWWINDOW_OFFSET UNITYSDK_OFFSET(0x19C20740)
#define RUNTIMESTATSWINDOW_ENTITYINFODUMP_OFFSET UNITYSDK_OFFSET(0x19C21070)
#define RUNTIMESTATSWINDOW_INITIALIZETEXTURES_OFFSET UNITYSDK_OFFSET(0x19C1F450)
#define RUNTIMESTATSWINDOW_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x19C219A0)
#define RUNTIMESTATSWINDOW_ONGUI_OFFSET UNITYSDK_OFFSET(0x19C20620)
#define RUNTIMESTATSWINDOW_START_OFFSET UNITYSDK_OFFSET(0x19C1F3E0)
#define RUNTIMESTATSWINDOW_UPDATEGRAPHTEXTURES_OFFSET UNITYSDK_OFFSET(0x19C1FD10)
#define RUNTIMESTATSWINDOW_UPDATEGRAPHTEXTURE_OFFSET UNITYSDK_OFFSET(0x19C1FDB0)
#define RUNTIMESTATSWINDOW_UPDATE_OFFSET UNITYSDK_OFFSET(0x19C1F840)
#define RUNTIMESTATSWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x19C21C00)
#define RUNTIMESTATSWINDOW__ENTITYINFODUMP_G__CHILDSTARTWITHNAME_18_0_OFFSET UNITYSDK_OFFSET(0x19C21AB0)

inline static constexpr unsigned int RuntimeStatsWindow_TypeDefinitionIndex = 69266;
