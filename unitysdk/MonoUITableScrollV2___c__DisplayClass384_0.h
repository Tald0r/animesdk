...
inline static constexpr unsigned int MonoUITableScrollV2___c__DisplayClass384_0_TypeDefinitionIndex = 64385;

struct alignas(8) MonoUITableScrollV2___c__DisplayClass384_0
{
	::UnityEngine::UI::VerticalLayoutGroup* layout; // 0x10
	::UnityEngine::UI::HorizontalLayoutGroup* hlayout; // 0x18
	::MonoUITableScrollV2* __4__this; // 0x20
	::UnityEngine::UI::GridLayoutGroup* gridLayout; // 0x28
