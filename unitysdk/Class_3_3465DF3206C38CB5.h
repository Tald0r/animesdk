...
#define CLASS_3_3465DF3206C38CB5_METHOD_3_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x645A870)
#define CLASS_3_3465DF3206C38CB5_METHOD_3_ADBEBCA2DD8E6E7A_OFFSET UNITYSDK_OFFSET(0x645AA50)
#define CLASS_3_3465DF3206C38CB5_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x645AC70)
#define CLASS_3_3465DF3206C38CB5__CTOR_OFFSET UNITYSDK_OFFSET(0x645AB50)

inline static constexpr unsigned int Class_3_3465DF3206C38CB5_TypeDefinitionIndex = 41822;

class Class_3_3465DF3206C38CB5 : public ::Class_2_52F82E04F7FEE529
{
public:
	::Class_4_D0B094D0B900A9F0<::System::Int64>* Field_3_2; // 0x18
