...
#define DYNAMICBONEV2_AFTERSWITCHLOD_OFFSET UNITYSDK_OFFSET(0x1AB6A0D0)
#define DYNAMICBONEV2_APPENDPARTICLESV2_OFFSET UNITYSDK_OFFSET(0x1AB6D2A0)
#define DYNAMICBONEV2_APPENDPARTICLES_OFFSET UNITYSDK_OFFSET(0x1AB6DA40)
#define DYNAMICBONEV2_APPLYPARTICLESTOTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AB6CEE0)
#define DYNAMICBONEV2_BINDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AB6A0C0)
#define DYNAMICBONEV2_CACHEANIMPOSE_OFFSET UNITYSDK_OFFSET(0x1AB6AE00)
#define DYNAMICBONEV2_CHECKDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AB6AB70)
#define DYNAMICBONEV2_GETLABELTEXT_OFFSET UNITYSDK_OFFSET(0x1AB69DC0)
#define DYNAMICBONEV2_GETPATH_OFFSET UNITYSDK_OFFSET(0x1AB6A000)
#define DYNAMICBONEV2_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AB6A6D0)
#define DYNAMICBONEV2_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1AB6A6F0)
#define DYNAMICBONEV2_GET_M_COLLIDERS_OFFSET UNITYSDK_OFFSET(0x1AB69FC0)
#define DYNAMICBONEV2_GET_M_DISTANCETOOBJECT_OFFSET UNITYSDK_OFFSET(0x1AB69FA0)
#define DYNAMICBONEV2_GET_M_DISTANTDISABLE_OFFSET UNITYSDK_OFFSET(0x1AB69F60)
#define DYNAMICBONEV2_GET_M_EXCLUSIONS_OFFSET UNITYSDK_OFFSET(0x1AB69FE0)
#define DYNAMICBONEV2_GET_M_FREEZEAXIS_OFFSET UNITYSDK_OFFSET(0x1AB69F40)
#define DYNAMICBONEV2_GET_M_REFERENCEOBJECT_OFFSET UNITYSDK_OFFSET(0x1AB69F80)
#define DYNAMICBONEV2_GET_M_ROOT_OFFSET UNITYSDK_OFFSET(0x1AB69DA0)
#define DYNAMICBONEV2_GET_M_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1AB69F20)
#define DYNAMICBONEV2_GET_M_UPDATERATE_OFFSET UNITYSDK_OFFSET(0x1AB69EE0)
#define DYNAMICBONEV2_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AB6A6E0)
#define DYNAMICBONEV2_INITTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AB6A360)
#define DYNAMICBONEV2_MANUALFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB6AA50)
#define DYNAMICBONEV2_MANUALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB6B2E0)
#define DYNAMICBONEV2_MANUALONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AB6A7E0)
#define DYNAMICBONEV2_MANUALONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1AB6B480)
#define DYNAMICBONEV2_MANUALONENABLE_OFFSET UNITYSDK_OFFSET(0x1AB6A780)
#define DYNAMICBONEV2_MANUALONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AB6B380)
#define DYNAMICBONEV2_MANUALSTART_OFFSET UNITYSDK_OFFSET(0x1AB6A7F0)
#define DYNAMICBONEV2_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB6B2D0)
#define DYNAMICBONEV2_MANUALWAITFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB6AAD0)
#define DYNAMICBONEV2_MIRRORVECTOR_OFFSET UNITYSDK_OFFSET(0x1AB6F000)
#define DYNAMICBONEV2_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB6AA90)
#define DYNAMICBONEV2_REBINDTRANSFORMTOPARTICLES_OFFSET UNITYSDK_OFFSET(0x1AB6A0E0)
#define DYNAMICBONEV2_RECURSIONPROCESSPARTICLES_OFFSET UNITYSDK_OFFSET(0x1AB6E8A0)
#define DYNAMICBONEV2_RECURSIONSETUPPARTICLES_OFFSET UNITYSDK_OFFSET(0x1AB6D940)
#define DYNAMICBONEV2_RESETPARTICLESPOSITION_OFFSET UNITYSDK_OFFSET(0x1AB6A4A0)
#define DYNAMICBONEV2_SETTIMESCALE_OFFSET UNITYSDK_OFFSET(0x1AB6A300)
#define DYNAMICBONEV2_SETUPPARTICLES_1_OFFSET UNITYSDK_OFFSET(0x1AB6E320)
#define DYNAMICBONEV2_SETUPPARTICLES_OFFSET UNITYSDK_OFFSET(0x1AB6A800)
#define DYNAMICBONEV2_SETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AB6A310)
#define DYNAMICBONEV2_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1AB6A700)
#define DYNAMICBONEV2_SET_M_UPDATERATE_OFFSET UNITYSDK_OFFSET(0x1AB69F00)
#define DYNAMICBONEV2_SKIPUPDATEPARTICLES_OFFSET UNITYSDK_OFFSET(0x1AB6C7E0)
#define DYNAMICBONEV2_UPDATEDYNAMICBONES_1_OFFSET UNITYSDK_OFFSET(0x1AB6B020)
#define DYNAMICBONEV2_UPDATEDYNAMICBONES_OFFSET UNITYSDK_OFFSET(0x1AB6B770)
#define DYNAMICBONEV2_UPDATEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1AB6D3D0)
#define DYNAMICBONEV2_UPDATEPARTICLES1_OFFSET UNITYSDK_OFFSET(0x1AB6B780)
#define DYNAMICBONEV2_UPDATEPARTICLES2_OFFSET UNITYSDK_OFFSET(0x1AB6BAE0)
#define DYNAMICBONEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB6F060)
#define DYNAMICBONEV2__RECURSIONSETUPPARTICLES_B__70_0_OFFSET UNITYSDK_OFFSET(0x1AB6F180)

inline static constexpr unsigned int DynamicBoneV2_TypeDefinitionIndex = 31584;
