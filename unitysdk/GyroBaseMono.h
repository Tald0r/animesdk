...
#define GYROBASEMONO_ENABLEGYRO_OFFSET UNITYSDK_OFFSET(0x1A8612B0)
#define GYROBASEMONO_GET_CURRENTGRAVITY_OFFSET UNITYSDK_OFFSET(0x1A861140)
#define GYROBASEMONO_START_OFFSET UNITYSDK_OFFSET(0x1A861240)
#define GYROBASEMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A861420)

inline static constexpr unsigned int GyroBaseMono_TypeDefinitionIndex = 7758;
