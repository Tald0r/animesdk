...
#define GYROBASEMONO_ENABLEGYRO_OFFSET UNITYSDK_OFFSET(0x1AA5EC30)
#define GYROBASEMONO_GET_CURRENTGRAVITY_OFFSET UNITYSDK_OFFSET(0x1AA5EAC0)
#define GYROBASEMONO_START_OFFSET UNITYSDK_OFFSET(0x1AA5EBC0)
#define GYROBASEMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA5EDA0)

inline static constexpr unsigned int GyroBaseMono_TypeDefinitionIndex = 8206;
