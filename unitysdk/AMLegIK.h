...
#define AMLEGIK_APPLYPLAYERMOTION_OFFSET UNITYSDK_OFFSET(0x9F9D790)
#define AMLEGIK_CALCULATEFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x9FA6710)
#define AMLEGIK_CALCULATEPELVISTARGETADCANCE_OFFSET UNITYSDK_OFFSET(0x9FA7930)
#define AMLEGIK_CALCULATEPELVISTARGETLEGACY_OFFSET UNITYSDK_OFFSET(0x9FA75A0)
#define AMLEGIK_CALCULATEPELVISTARGET_OFFSET UNITYSDK_OFFSET(0x9FA7D00)
#define AMLEGIK_CALCULATEPREDICTFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x9F9E4C0)
#define AMLEGIK_CROSSCHECK_OFFSET UNITYSDK_OFFSET(0x9F9FEC0)
#define AMLEGIK_DEBUGFOCUSEDFOOT_OFFSET UNITYSDK_OFFSET(0x9F9D710)
#define AMLEGIK_DOCALCULATETARGET_OFFSET UNITYSDK_OFFSET(0x9FA5620)
#define AMLEGIK_FINALIZEFOOTIK_OFFSET UNITYSDK_OFFSET(0x9FA6EE0)
#define AMLEGIK_GETDELTAFROMRIGIDBODYTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9FA1A80)
#define AMLEGIK_GETRAYCASTHIT_OFFSET UNITYSDK_OFFSET(0x9FA18B0)
#define AMLEGIK_GETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x9F9BE30)
#define AMLEGIK_GET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C080)
#define AMLEGIK_GET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C020)
#define AMLEGIK_GET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9BFC0)
#define AMLEGIK_GET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9BFA0)
#define AMLEGIK_GET_ENABLELOCKFOOTREAL_OFFSET UNITYSDK_OFFSET(0x9F9BC30)
#define AMLEGIK_GET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9BFE0)
#define AMLEGIK_GET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9BF80)
#define AMLEGIK_GET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C0A0)
#define AMLEGIK_GET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C000)
#define AMLEGIK_GET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C0C0)
#define AMLEGIK_GET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C060)
#define AMLEGIK_GET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C040)
#define AMLEGIK_GET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x9F9C100)
#define AMLEGIK_GET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x9F9C0E0)
#define AMLEGIK_GET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x9F9BA50)
#define AMLEGIK_GET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x9F9BA30)
#define AMLEGIK_GET_REALPREDICTRAYCASTHEIGHT_OFFSET UNITYSDK_OFFSET(0x9F9B910)
#define AMLEGIK_GET_REALRAYCASTHEIGHT_OFFSET UNITYSDK_OFFSET(0x9F9B7F0)
#define AMLEGIK_HIPHEIGHTLIFTINGDELTABYMINDIST_OFFSET UNITYSDK_OFFSET(0x9FA0FF0)
#define AMLEGIK_HIPHEIGHTLIFTINGDELTA_OFFSET UNITYSDK_OFFSET(0x9FA0E30)
#define AMLEGIK_HITGROUNDIMPL_OFFSET UNITYSDK_OFFSET(0x9FA2B10)
#define AMLEGIK_HITGROUNDSIMPLEIMPL_OFFSET UNITYSDK_OFFSET(0x9FA1CA0)
#define AMLEGIK_HITGROUND_OFFSET UNITYSDK_OFFSET(0x9F9F820)
#define AMLEGIK_INITIALIZEFOOTLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x9F9D240)
#define AMLEGIK_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x9F9C120)
#define AMLEGIK_INITSCENEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x9F9D530)
#define AMLEGIK_ISFOOTMOVING_OFFSET UNITYSDK_OFFSET(0x9FA12A0)
#define AMLEGIK_ISINPIKSTATE_OFFSET UNITYSDK_OFFSET(0x9F9FAC0)
#define AMLEGIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9FA99D0)
#define AMLEGIK_LOCKFOOT_OFFSET UNITYSDK_OFFSET(0x9FA00C0)
#define AMLEGIK_MAXHIPSDELTA_OFFSET UNITYSDK_OFFSET(0x9FA74A0)
#define AMLEGIK_MINHIPSDELTA_OFFSET UNITYSDK_OFFSET(0x9FA73A0)
#define AMLEGIK_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x9FA9410)
#define AMLEGIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9FA8DC0)
#define AMLEGIK_ONFOOTPLANT_OFFSET UNITYSDK_OFFSET(0x9FA8990)
#define AMLEGIK_ORDINARYIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x9FA41E0)
#define AMLEGIK_PREDICTDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9FA20)
#define AMLEGIK_PREDICTFOOT_OFFSET UNITYSDK_OFFSET(0x9F9ED60)
#define AMLEGIK_PREDICTIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x9FA4540)
#define AMLEGIK_PREPARE_OFFSET UNITYSDK_OFFSET(0x9F9D980)
#define AMLEGIK_PREPROCESSANIMPOS_OFFSET UNITYSDK_OFFSET(0x9FA0A20)
#define AMLEGIK_PREPROCESSPREDICTIONIK_OFFSET UNITYSDK_OFFSET(0x9F9FDA0)
#define AMLEGIK_RESETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x9F9BEF0)
#define AMLEGIK_SETFOOTCONTROLPARAM_OFFSET UNITYSDK_OFFSET(0x9FA6C80)
#define AMLEGIK_SETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x9F9BCE0)
#define AMLEGIK_SET_DISABLEDAMPING_OFFSET UNITYSDK_OFFSET(0x9F9BA90)
#define AMLEGIK_SET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C090)
#define AMLEGIK_SET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C030)
#define AMLEGIK_SET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9BFD0)
#define AMLEGIK_SET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9BFB0)
#define AMLEGIK_SET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9BFF0)
#define AMLEGIK_SET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9BF90)
#define AMLEGIK_SET_ENABLEPELVISIKROT_OFFSET UNITYSDK_OFFSET(0x9F9BCB0)
#define AMLEGIK_SET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C0B0)
#define AMLEGIK_SET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C010)
#define AMLEGIK_SET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C0D0)
#define AMLEGIK_SET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C070)
#define AMLEGIK_SET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x9F9C050)
#define AMLEGIK_SET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x9F9C110)
#define AMLEGIK_SET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x9F9C0F0)
#define AMLEGIK_SET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x9F9BA70)
#define AMLEGIK_SET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x9F9BA40)
#define AMLEGIK_SET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0x9F9BAA0)
#define AMLEGIK_SET_PELVISCASTDIST_OFFSET UNITYSDK_OFFSET(0x9F9BCD0)
#define AMLEGIK_SET_PELVISIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x9F9BCC0)
#define AMLEGIK_START_OFFSET UNITYSDK_OFFSET(0x9FA8C50)
#define AMLEGIK_UPDATE_OFFSET UNITYSDK_OFFSET(0x9FA8F30)
#define AMLEGIK__CCTOR_OFFSET UNITYSDK_OFFSET(0x9FA9B70)
#define AMLEGIK__CTOR_OFFSET UNITYSDK_OFFSET(0x9FA9A50)

inline static constexpr unsigned int AMLegIK_TypeDefinitionIndex = 75574;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(AMLegIK_TypeDefinitionIndex)->GetStaticField(0x30D50);
	}
	static ::System::Single* StaticGet_RayCastHeightOnMovingPlatform()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(AMLegIK_TypeDefinitionIndex)->GetStaticField(0xBDF0);
	}
