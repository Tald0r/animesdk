...
#define AMLEGIK_APPLYPLAYERMOTION_OFFSET UNITYSDK_OFFSET(0xCBB3110)
#define AMLEGIK_CALCULATEFOOTTARGET_OFFSET UNITYSDK_OFFSET(0xCBBC090)
#define AMLEGIK_CALCULATEPELVISTARGETADCANCE_OFFSET UNITYSDK_OFFSET(0xCBBD2B0)
#define AMLEGIK_CALCULATEPELVISTARGETLEGACY_OFFSET UNITYSDK_OFFSET(0xCBBCF20)
#define AMLEGIK_CALCULATEPELVISTARGET_OFFSET UNITYSDK_OFFSET(0xCBBD680)
#define AMLEGIK_CALCULATEPREDICTFOOTTARGET_OFFSET UNITYSDK_OFFSET(0xCBB3E40)
#define AMLEGIK_CROSSCHECK_OFFSET UNITYSDK_OFFSET(0xCBB5840)
#define AMLEGIK_DEBUGFOCUSEDFOOT_OFFSET UNITYSDK_OFFSET(0xCBB3090)
#define AMLEGIK_DOCALCULATETARGET_OFFSET UNITYSDK_OFFSET(0xCBBAFA0)
#define AMLEGIK_FINALIZEFOOTIK_OFFSET UNITYSDK_OFFSET(0xCBBC860)
#define AMLEGIK_GETDELTAFROMRIGIDBODYTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCBB7400)
#define AMLEGIK_GETRAYCASTHIT_OFFSET UNITYSDK_OFFSET(0xCBB7230)
#define AMLEGIK_GETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0xCBB17A0)
#define AMLEGIK_GET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1A00)
#define AMLEGIK_GET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB19A0)
#define AMLEGIK_GET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1940)
#define AMLEGIK_GET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1920)
#define AMLEGIK_GET_ENABLELOCKFOOTREAL_OFFSET UNITYSDK_OFFSET(0xCBB15A0)
#define AMLEGIK_GET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1960)
#define AMLEGIK_GET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1900)
#define AMLEGIK_GET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1A20)
#define AMLEGIK_GET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1980)
#define AMLEGIK_GET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1A40)
#define AMLEGIK_GET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB19E0)
#define AMLEGIK_GET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB19C0)
#define AMLEGIK_GET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0xCBB1A80)
#define AMLEGIK_GET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0xCBB1A60)
#define AMLEGIK_GET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0xCBB13C0)
#define AMLEGIK_GET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0xCBB13A0)
#define AMLEGIK_GET_REALPREDICTRAYCASTHEIGHT_OFFSET UNITYSDK_OFFSET(0xCBB1280)
#define AMLEGIK_GET_REALRAYCASTHEIGHT_OFFSET UNITYSDK_OFFSET(0xCBB1160)
#define AMLEGIK_HIPHEIGHTLIFTINGDELTABYMINDIST_OFFSET UNITYSDK_OFFSET(0xCBB6970)
#define AMLEGIK_HIPHEIGHTLIFTINGDELTA_OFFSET UNITYSDK_OFFSET(0xCBB67B0)
#define AMLEGIK_HITGROUNDIMPL_OFFSET UNITYSDK_OFFSET(0xCBB8490)
#define AMLEGIK_HITGROUNDSIMPLEIMPL_OFFSET UNITYSDK_OFFSET(0xCBB7620)
#define AMLEGIK_HITGROUND_OFFSET UNITYSDK_OFFSET(0xCBB51A0)
#define AMLEGIK_INITIALIZEFOOTLOCKSTATE_OFFSET UNITYSDK_OFFSET(0xCBB2BC0)
#define AMLEGIK_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xCBB1AA0)
#define AMLEGIK_INITSCENEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0xCBB2EB0)
#define AMLEGIK_ISFOOTMOVING_OFFSET UNITYSDK_OFFSET(0xCBB6C20)
#define AMLEGIK_ISINPIKSTATE_OFFSET UNITYSDK_OFFSET(0xCBB5440)
#define AMLEGIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCBBF360)
#define AMLEGIK_LOCKFOOT_OFFSET UNITYSDK_OFFSET(0xCBB5A40)
#define AMLEGIK_MAXHIPSDELTA_OFFSET UNITYSDK_OFFSET(0xCBBCE20)
#define AMLEGIK_MINHIPSDELTA_OFFSET UNITYSDK_OFFSET(0xCBBCD20)
#define AMLEGIK_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0xCBBED90)
#define AMLEGIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCBBE740)
#define AMLEGIK_ONFOOTPLANT_OFFSET UNITYSDK_OFFSET(0xCBBE310)
#define AMLEGIK_ORDINARYIKHITGROUND_OFFSET UNITYSDK_OFFSET(0xCBB9B60)
#define AMLEGIK_PREDICTDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB53A0)
#define AMLEGIK_PREDICTFOOT_OFFSET UNITYSDK_OFFSET(0xCBB46E0)
#define AMLEGIK_PREDICTIKHITGROUND_OFFSET UNITYSDK_OFFSET(0xCBB9EC0)
#define AMLEGIK_PREPARE_OFFSET UNITYSDK_OFFSET(0xCBB3300)
#define AMLEGIK_PREPROCESSANIMPOS_OFFSET UNITYSDK_OFFSET(0xCBB63A0)
#define AMLEGIK_PREPROCESSPREDICTIONIK_OFFSET UNITYSDK_OFFSET(0xCBB5720)
#define AMLEGIK_RESETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0xCBB1870)
#define AMLEGIK_SETFOOTCONTROLPARAM_OFFSET UNITYSDK_OFFSET(0xCBBC600)
#define AMLEGIK_SETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0xCBB1650)
#define AMLEGIK_SET_DISABLEDAMPING_OFFSET UNITYSDK_OFFSET(0xCBB1400)
#define AMLEGIK_SET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1A10)
#define AMLEGIK_SET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB19B0)
#define AMLEGIK_SET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1950)
#define AMLEGIK_SET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1930)
#define AMLEGIK_SET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1970)
#define AMLEGIK_SET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1910)
#define AMLEGIK_SET_ENABLEPELVISIKROT_OFFSET UNITYSDK_OFFSET(0xCBB1620)
#define AMLEGIK_SET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1A30)
#define AMLEGIK_SET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1990)
#define AMLEGIK_SET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB1A50)
#define AMLEGIK_SET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB19F0)
#define AMLEGIK_SET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0xCBB19D0)
#define AMLEGIK_SET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0xCBB1A90)
#define AMLEGIK_SET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0xCBB1A70)
#define AMLEGIK_SET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0xCBB13E0)
#define AMLEGIK_SET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0xCBB13B0)
#define AMLEGIK_SET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0xCBB1410)
#define AMLEGIK_SET_PELVISCASTDIST_OFFSET UNITYSDK_OFFSET(0xCBB1640)
#define AMLEGIK_SET_PELVISIKWEIGHT_OFFSET UNITYSDK_OFFSET(0xCBB1630)
#define AMLEGIK_START_OFFSET UNITYSDK_OFFSET(0xCBBE5D0)
#define AMLEGIK_UPDATE_OFFSET UNITYSDK_OFFSET(0xCBBE8B0)
#define AMLEGIK__CCTOR_OFFSET UNITYSDK_OFFSET(0xCBBF500)
#define AMLEGIK__CTOR_OFFSET UNITYSDK_OFFSET(0xCBBF3E0)

inline static constexpr unsigned int AMLegIK_TypeDefinitionIndex = 43332;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(AMLegIK_TypeDefinitionIndex)->GetStaticField(0x32E00);
	}
	static ::System::Single* StaticGet_RayCastHeightOnMovingPlatform()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(AMLegIK_TypeDefinitionIndex)->GetStaticField(0xCA00);
	}
