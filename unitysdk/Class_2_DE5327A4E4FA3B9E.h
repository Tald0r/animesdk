...
#define CLASS_2_DE5327A4E4FA3B9E_METHOD_2_9D455FE4693966A8_1_OFFSET UNITYSDK_OFFSET(0x9472830)
#define CLASS_2_DE5327A4E4FA3B9E_METHOD_2_9D455FE4693966A8_OFFSET UNITYSDK_OFFSET(0x9472760)
#define CLASS_2_DE5327A4E4FA3B9E__CTOR_OFFSET UNITYSDK_OFFSET(0x94727F0)

inline static constexpr unsigned int Class_2_DE5327A4E4FA3B9E_TypeDefinitionIndex = 66762;

class Class_2_DE5327A4E4FA3B9E : public ::Class_1_BDDDDB46A99CFF4C
{
public:
	::MoleMole::Config::AnimatorStateTimeSegment* Field_2_2; // 0x80
	::Class_3_BD1C1745FBC83F51* Field_2_3; // 0x88
