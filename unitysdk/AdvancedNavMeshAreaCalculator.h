...
#define ADVANCEDNAVMESHAREACALCULATOR_ADDNEWNAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x9FB1D60)
#define ADVANCEDNAVMESHAREACALCULATOR_CALCULATECURRENTNAVMESHAREA_OFFSET UNITYSDK_OFFSET(0x9FB1AC0)
#define ADVANCEDNAVMESHAREACALCULATOR_CALCULATETOTALAREA_OFFSET UNITYSDK_OFFSET(0x9FB1360)
#define ADVANCEDNAVMESHAREACALCULATOR_CLEARALLDATA_OFFSET UNITYSDK_OFFSET(0x9FB21F0)
#define ADVANCEDNAVMESHAREACALCULATOR_GETNAVMESHDATAINFOLDER_OFFSET UNITYSDK_OFFSET(0x9FB2300)
#define ADVANCEDNAVMESHAREACALCULATOR_GET_TOTALAREA_OFFSET UNITYSDK_OFFSET(0x9FB1130)
#define ADVANCEDNAVMESHAREACALCULATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9FB1150)
#define ADVANCEDNAVMESHAREACALCULATOR_REMOVENAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x9FB1E90)
#define ADVANCEDNAVMESHAREACALCULATOR_SET_TOTALAREA_OFFSET UNITYSDK_OFFSET(0x9FB1140)
#define ADVANCEDNAVMESHAREACALCULATOR_TOGGLENAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x9FB1F70)
#define ADVANCEDNAVMESHAREACALCULATOR_UNLOADALLNAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x9FB11C0)
#define ADVANCEDNAVMESHAREACALCULATOR_UPDATENAVMESHDATAASSET_OFFSET UNITYSDK_OFFSET(0x9FB2120)
#define ADVANCEDNAVMESHAREACALCULATOR_UPDATENAVMESHDATANAME_OFFSET UNITYSDK_OFFSET(0x9FB2040)
#define ADVANCEDNAVMESHAREACALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9FB23D0)

inline static constexpr unsigned int AdvancedNavMeshAreaCalculator_TypeDefinitionIndex = 40124;
