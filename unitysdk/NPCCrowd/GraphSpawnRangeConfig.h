...
#define NPCCROWD_GRAPHSPAWNRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x65268C0)

namespace NPCCrowd
{
	inline static constexpr unsigned int GraphSpawnRangeConfig_TypeDefinitionIndex = 57260;
