...
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_CREATEFILTERS_OFFSET UNITYSDK_OFFSET(0x780AA50)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_INITACCESSORYINFO_OFFSET UNITYSDK_OFFSET(0x780B4D0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_INITANIMATION_OFFSET UNITYSDK_OFFSET(0x780B680)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_INITAUDIO_OFFSET UNITYSDK_OFFSET(0x780B5F0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_INITLOOKATIK_OFFSET UNITYSDK_OFFSET(0x780D040)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_INIT_OFFSET UNITYSDK_OFFSET(0x780A980)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_ONENTITYADD_OFFSET UNITYSDK_OFFSET(0x780ACE0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_ONENTITYREADY_OFFSET UNITYSDK_OFFSET(0x780BF70)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_ONENTITYREMOVE_OFFSET UNITYSDK_OFFSET(0x780D440)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_RELEASEAUDIO_OFFSET UNITYSDK_OFFSET(0x780DB60)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_UPDATEAUDIO_OFFSET UNITYSDK_OFFSET(0x780EBC0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_UPDATEDITHERSTATE_OFFSET UNITYSDK_OFFSET(0x780E9A0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x780E630)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x780F310)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM__INITANIMATION_G__PLAYANIMATION_8_0_OFFSET UNITYSDK_OFFSET(0x780E7D0)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM___BASE_CREATEFILTERS_OFFSET UNITYSDK_OFFSET(0x780F320)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x780F330)
#define NPCCROWD_AVATAR_NPCAVATARSUBSYSTEM___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x780F390)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCAvatarSubSystem_TypeDefinitionIndex = 43125;
	...
	public:
		...
		{
			return (::NPCCrowd::NPCIDGeneratorInt**)Il2CppClass::FromTypeDefinitionIndex(NPCAvatarSubSystem_TypeDefinitionIndex)->GetStaticField(0x3F550);
		}
