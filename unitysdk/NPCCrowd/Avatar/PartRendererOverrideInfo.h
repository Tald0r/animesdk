...
#define NPCCROWD_AVATAR_PARTRENDEREROVERRIDEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA110E30)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int PartRendererOverrideInfo_TypeDefinitionIndex = 62716;
