...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__SETUPAVATARPARTINFOASYNC_D__43_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x327690)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__SETUPAVATARPARTINFOASYNC_D__43_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager__SetupAvatarPartInfoAsync_d__43_TypeDefinitionIndex = 75890;
	...
	struct alignas(8) NPCCrowdAvatarManager__SetupAvatarPartInfoAsync_d__43
	{
		...
		::NPCCrowd::Avatar::NPCAvatarGOReferenceComponentInfo* partGoInfo; // 0x28
		::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder __t__builder; // 0x30
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::Il2CppArray<::UnityEngine::Material*>*> __u__1; // 0x40
		::NPCCrowd::Animation::NPCCrowdAnimator* gpuAnimator; // 0x58
		::UnityEngine::GameObject* avatarGo; // 0x60
