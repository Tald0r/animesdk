...
#define NPCCROWD_AVATAR_NPCLODDITHERMANAGER_ADDDITHERTASK_OFFSET UNITYSDK_OFFSET(0x7584560)
#define NPCCROWD_AVATAR_NPCLODDITHERMANAGER_FORCEDITHERTASK_OFFSET UNITYSDK_OFFSET(0x75849E0)
#define NPCCROWD_AVATAR_NPCLODDITHERMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x7584160)
#define NPCCROWD_AVATAR_NPCLODDITHERMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x7584300)
#define NPCCROWD_AVATAR_NPCLODDITHERMANAGER_POSTLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x75853F0)
#define NPCCROWD_AVATAR_NPCLODDITHERMANAGER_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x7584DC0)
#define NPCCROWD_AVATAR_NPCLODDITHERMANAGER_REMOVETASK_OFFSET UNITYSDK_OFFSET(0x7584890)
#define NPCCROWD_AVATAR_NPCLODDITHERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x7585990)
#define NPCCROWD_AVATAR_NPCLODDITHERMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x75859A0)
#define NPCCROWD_AVATAR_NPCLODDITHERMANAGER___BASE_POSTLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7585A00)
#define NPCCROWD_AVATAR_NPCLODDITHERMANAGER___BASE_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x7585A70)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCLODDitherManager_TypeDefinitionIndex = 46417;
