...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CREATEAVATARPARTSANDACCESSORIESGALGAMEASYNC_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3163A0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CREATEAVATARPARTSANDACCESSORIESGALGAMEASYNC_D__28_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager__CreateAvatarPartsAndAccessoriesGalgameAsync_d__28_TypeDefinitionIndex = 51683;
	...
	struct alignas(8) NPCCrowdAvatarManager__CreateAvatarPartsAndAccessoriesGalgameAsync_d__28
	{
		...
		::UnityEngine::GameObject* avatarGo; // 0x28
		::System::Action_1<::UnityEngine::GameObject*>* callback; // 0x30
		...
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::ValueTuple_2<::System::Collections::Generic::List_1<::NPCCrowd::Avatar::NPCAvatarGOReferenceComponentInfo*>*, ::System::Collections::Generic::List_1<::NPCCrowd::Accessories::NPCAccessory*>*>> __u__1; // 0x48
		::System::Threading::CancellationToken cancellationToken; // 0x68
		::System::Int32 avatarParamsID; // 0x70
		::System::Boolean enableLookIK; // 0x74
