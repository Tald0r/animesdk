...
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_GETALLPARTS_OFFSET UNITYSDK_OFFSET(0x6ED32C0)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_GETANIMATOR_OFFSET UNITYSDK_OFFSET(0x6ED3320)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x6ED31F0)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x6ED3080)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x6ED3380)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCAvatarGOReferenceComponent_TypeDefinitionIndex = 57142;
