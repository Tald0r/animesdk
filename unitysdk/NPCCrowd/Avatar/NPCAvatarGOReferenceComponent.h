...
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_GETALLPARTS_OFFSET UNITYSDK_OFFSET(0x78583B0)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_GETANIMATOR_OFFSET UNITYSDK_OFFSET(0x7858410)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x78582E0)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x7858170)
#define NPCCROWD_AVATAR_NPCAVATARGOREFERENCECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x7858470)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCAvatarGOReferenceComponent_TypeDefinitionIndex = 77900;
