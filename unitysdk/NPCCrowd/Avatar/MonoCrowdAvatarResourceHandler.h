...
#define NPCCROWD_AVATAR_MONOCROWDAVATARRESOURCEHANDLER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x63B1040)
#define NPCCROWD_AVATAR_MONOCROWDAVATARRESOURCEHANDLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x63B0E90)
#define NPCCROWD_AVATAR_MONOCROWDAVATARRESOURCEHANDLER_SETPARTSANDACCESSORIES_OFFSET UNITYSDK_OFFSET(0x63B0E10)
#define NPCCROWD_AVATAR_MONOCROWDAVATARRESOURCEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x63B1050)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int MonoCrowdAvatarResourceHandler_TypeDefinitionIndex = 54297;
