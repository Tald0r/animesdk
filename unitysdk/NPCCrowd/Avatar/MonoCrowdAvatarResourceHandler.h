...
#define NPCCROWD_AVATAR_MONOCROWDAVATARRESOURCEHANDLER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x9EBFA10)
#define NPCCROWD_AVATAR_MONOCROWDAVATARRESOURCEHANDLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9EBF860)
#define NPCCROWD_AVATAR_MONOCROWDAVATARRESOURCEHANDLER_SETPARTSANDACCESSORIES_OFFSET UNITYSDK_OFFSET(0x9EBF7E0)
#define NPCCROWD_AVATAR_MONOCROWDAVATARRESOURCEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9EBFA20)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int MonoCrowdAvatarResourceHandler_TypeDefinitionIndex = 45911;
