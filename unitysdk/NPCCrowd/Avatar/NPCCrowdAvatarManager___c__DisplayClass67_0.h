...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS67_0__CTOR_OFFSET UNITYSDK_OFFSET(0x6A1F740)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS67_0__INITACCESSORYMDBCOMPONENT_B__0_OFFSET UNITYSDK_OFFSET(0x6A1F750)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS67_0__INITACCESSORYMDBCOMPONENT_G__GETMDBSTATE_1_OFFSET UNITYSDK_OFFSET(0x6A1F760)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager___c__DisplayClass67_0_TypeDefinitionIndex = 75872;
