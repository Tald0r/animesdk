...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS29_0__BINDBONESLOTSGALGAME_B__0_OFFSET UNITYSDK_OFFSET(0x6352860)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS29_0__BINDBONESLOTSGALGAME_B__1_OFFSET UNITYSDK_OFFSET(0x6352880)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS29_0__CTOR_OFFSET UNITYSDK_OFFSET(0x6352850)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager___c__DisplayClass29_0_TypeDefinitionIndex = 51672;
