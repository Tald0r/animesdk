...
#define NPCCROWD_AVATAR_NPCAVATARPARTOVERRIDEPROPERTIESCOMPONENT_APPLYAVATARPARTOVERRIDEPROP_OFFSET UNITYSDK_OFFSET(0x697BFF0)
#define NPCCROWD_AVATAR_NPCAVATARPARTOVERRIDEPROPERTIESCOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x697BF80)
#define NPCCROWD_AVATAR_NPCAVATARPARTOVERRIDEPROPERTIESCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x697C1E0)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCAvatarPartOverridePropertiesComponent_TypeDefinitionIndex = 40597;
