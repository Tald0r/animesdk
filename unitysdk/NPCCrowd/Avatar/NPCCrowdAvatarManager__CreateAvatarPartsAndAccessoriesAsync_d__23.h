...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CREATEAVATARPARTSANDACCESSORIESASYNC_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x32DE50)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CREATEAVATARPARTSANDACCESSORIESASYNC_D__23_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager__CreateAvatarPartsAndAccessoriesAsync_d__23_TypeDefinitionIndex = 75885;
	...
	struct alignas(8) NPCCrowdAvatarManager__CreateAvatarPartsAndAccessoriesAsync_d__23
	{
		...
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::Collections::Generic::List_1<::NPCCrowd::Avatar::NPCAvatarGOReferenceComponentInfo*>*> __u__2; // 0x48
		...
		::Cysharp::Threading::Tasks::UniTask_1<::System::Collections::Generic::List_1<::NPCCrowd::Accessories::NPCAccessory*>*> _accessoryTask_5__3; // 0x70
		::NPCCrowd::Animation::NPCUnionAnimator* unionAnimator; // 0x88
		::System::Collections::Generic::List_1<::NPCCrowd::Avatar::NPCAvatarGOReferenceComponentInfo*>* _parts_5__4; // 0x90
		::System::Threading::CancellationToken cancellationToken; // 0x98
		::Il2CppArray<::FNpcAvatarGenericParams_PartInfo*>* partInfos; // 0xA0
		::NPCCrowd::Avatar::NPCCrowdAvatarManager* __4__this; // 0xA8
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::Collections::Generic::List_1<::NPCCrowd::Accessories::NPCAccessory*>*> __u__3; // 0xB0
		::Cysharp::Threading::Tasks::UniTask_1<::System::Collections::Generic::List_1<::NPCCrowd::Avatar::NPCAvatarGOReferenceComponentInfo*>*> _partTask_5__2; // 0xC8
