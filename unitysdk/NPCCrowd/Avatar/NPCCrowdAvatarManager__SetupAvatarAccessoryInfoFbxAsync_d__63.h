...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__SETUPAVATARACCESSORYINFOFBXASYNC_D__63_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x32DE60)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__SETUPAVATARACCESSORYINFOFBXASYNC_D__63_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager__SetupAvatarAccessoryInfoFbxAsync_d__63_TypeDefinitionIndex = 75875;
	...
	struct alignas(8) NPCCrowdAvatarManager__SetupAvatarAccessoryInfoFbxAsync_d__63
	{
		...
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::UnityEngine::Avatar*> __u__2; // 0x28
