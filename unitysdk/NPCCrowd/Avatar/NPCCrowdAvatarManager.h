...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_BINDBONESLOTSGALGAME_OFFSET UNITYSDK_OFFSET(0x78151E0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARACCESSORIESASYNC_OFFSET UNITYSDK_OFFSET(0x781B2E0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARBODYPARTSASYNC_OFFSET UNITYSDK_OFFSET(0x7819D30)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARGO_1_OFFSET UNITYSDK_OFFSET(0x7810D70)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARGO_OFFSET UNITYSDK_OFFSET(0x7810AA0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARPARTSANDACCESSORIESASYNC_1_OFFSET UNITYSDK_OFFSET(0x7811E70)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARPARTSANDACCESSORIESASYNC_2_OFFSET UNITYSDK_OFFSET(0x7811FF0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARPARTSANDACCESSORIESASYNC_OFFSET UNITYSDK_OFFSET(0x7811B10)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATARPARTSANDACCESSORIESGALGAMEASYNC_OFFSET UNITYSDK_OFFSET(0x7815040)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATEAVATAR_OFFSET UNITYSDK_OFFSET(0x78100C0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARANIMATOR_OFFSET UNITYSDK_OFFSET(0x7811980)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARCOLLIDER_OFFSET UNITYSDK_OFFSET(0x7810F50)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARGOGALGAMEASYNC_OFFSET UNITYSDK_OFFSET(0x7814A60)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x781AC10)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOFEATUREPOINT_OFFSET UNITYSDK_OFFSET(0x7811570)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOINTERACTPOINT_OFFSET UNITYSDK_OFFSET(0x7811710)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARMONOITEMSTATE_OFFSET UNITYSDK_OFFSET(0x78118B0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_CREATENPCAVATARNAVMESHOBSTACLE_OFFSET UNITYSDK_OFFSET(0x78113C0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_ENABLEIKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x7816EA0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_GETAVATARSHAREDGPUMATERIALS_OFFSET UNITYSDK_OFFSET(0x781A870)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_GETAVATARSHAREDGPUMATERIAL_OFFSET UNITYSDK_OFFSET(0x7813210)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x780E000)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_GPUMATPARAMPROCESSOR_OFFSET UNITYSDK_OFFSET(0x7813530)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYANIMATORCULLINGMODEASYNC_OFFSET UNITYSDK_OFFSET(0x7814770)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYANIMATOR_OFFSET UNITYSDK_OFFSET(0x7813980)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYDEVICENUMBERPLATECOMPONENT_OFFSET UNITYSDK_OFFSET(0x7814460)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYMDBCOMPONENT_OFFSET UNITYSDK_OFFSET(0x7813BB0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYMDBPOSE_OFFSET UNITYSDK_OFFSET(0x781B9A0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITACCESSORYSCENEOBJECT_OFFSET UNITYSDK_OFFSET(0x7814220)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITCPUMATERIALCOLORS_OFFSET UNITYSDK_OFFSET(0x780C940)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITGPUMATERIALCOLORS_OFFSET UNITYSDK_OFFSET(0x781AEA0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITGPUMATERIALS_OFFSET UNITYSDK_OFFSET(0x781AD60)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INITLOGICTAGS_OFFSET UNITYSDK_OFFSET(0x7814800)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x780F400)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x780FEA0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_PLAYMDBREFERENCEPOSECLIP_OFFSET UNITYSDK_OFFSET(0x781BC40)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_POSTLOADAVATARACCESSORYGALGAME_OFFSET UNITYSDK_OFFSET(0x78178C0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_POSTLOADAVATARACCESSORY_OFFSET UNITYSDK_OFFSET(0x7813720)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_POSTLOADAVATARGOGALGAME_OFFSET UNITYSDK_OFFSET(0x7815A40)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_POSTLOADAVATARGO_OFFSET UNITYSDK_OFFSET(0x7812220)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RANDOMSPAWNNPCFROMLIB_OFFSET UNITYSDK_OFFSET(0x7810770)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATARPARTS_OFFSET UNITYSDK_OFFSET(0x7817E90)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATARROOTCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x78195B0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATARSHADOWPROXY_OFFSET UNITYSDK_OFFSET(0x7818D20)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATARSIMPLEMODEL_OFFSET UNITYSDK_OFFSET(0x7818A40)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASEAVATAR_OFFSET UNITYSDK_OFFSET(0x780E170)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_RELEASENPCFORRANDOMLIB_OFFSET UNITYSDK_OFFSET(0x7819B60)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPAVATARACCESSORYINFOFBXASYNC_OFFSET UNITYSDK_OFFSET(0x781B450)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPAVATARACCESSORYINFOMATERIALASYNC_OFFSET UNITYSDK_OFFSET(0x781B5C0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPAVATARACCESSORYINFOMATERIALFORDEVICENUMBERPLATE_OFFSET UNITYSDK_OFFSET(0x781B7D0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPAVATARPARTINFOASYNC_OFFSET UNITYSDK_OFFSET(0x7819EE0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPCPUPARTINFO_OFFSET UNITYSDK_OFFSET(0x781A050)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPGPUPARTINFO_OFFSET UNITYSDK_OFFSET(0x781A620)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_SETUPNPCAVATARLOD0MESH_OFFSET UNITYSDK_OFFSET(0x7816660)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER_UPDATENPCAVATARANIMATORFORGALGAME_OFFSET UNITYSDK_OFFSET(0x781AA20)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x781BDD0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x781BDC0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER__SETUPCPUPARTINFO_G__GETPARTBOUNDINGBOXBYPARTTYPE_44_0_OFFSET UNITYSDK_OFFSET(0x781A4F0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x781BEA0)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x781BF00)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager_TypeDefinitionIndex = 51668;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>**)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdAvatarManager_TypeDefinitionIndex)->GetStaticField(0x37AC0);
		}
		static ::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>** StaticGet_AvatarAsyncLoadTasks()
		{
			return (::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>**)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdAvatarManager_TypeDefinitionIndex)->GetStaticField(0x37AC8);
		}
		static ::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>** StaticGet_AvatarPartAsyncLoadTasks()
		{
			return (::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>**)Il2CppClass::FromTypeDefinitionIndex(NPCCrowdAvatarManager_TypeDefinitionIndex)->GetStaticField(0x37AD0);
		}
		// static const ::System::Int32 MaxPoolNum = 0x32; // 0x0
		// static const ::System::String* _IK_POINT_NAME; // 0x0
		::Il2CppArray<::MoleMole::ECrowdShadowFineness>* lodShadowFineness; // 0x18
		::NPCCrowd::NPCGoPool* rootGoPool; // 0x20
		::NPCCrowd::NPCGoPool* simpleModelGoPool; // 0x28
		::NPCCrowd::NPCGoPool* gpuPartGoPool; // 0x30
		::NPCCrowd::NPCGoPool* shadowProxyStaticGoPool; // 0x38
		::Foundation::AssetRequestHandle _deviceNumberPlateAssetHandle; // 0x40
		::NPCCrowd::NPCGoPool* shadowProxySkinnedGoPool; // 0x60
		::MonoNotRelateGameLogic::DynamicCarPlateAssetCfg* _deviceNumberPlateAssetSo; // 0x68
		::NPCCrowd::NPCGoPool* cpuPartGoPool; // 0x70
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*>* _npcRandomLibTagPools; // 0x78
		::System::Boolean bCreateStaticShadowProxy; // 0x80
		::System::Boolean bUseShadowProxy; // 0x81
		::System::Boolean bCreateSkinnedShadowProxy; // 0x82
