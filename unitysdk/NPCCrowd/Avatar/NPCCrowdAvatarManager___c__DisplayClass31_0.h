...
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS31_0__CTOR_OFFSET UNITYSDK_OFFSET(0x7451200)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS31_0__POSTLOADAVATARGOGALGAME_B__1_OFFSET UNITYSDK_OFFSET(0x7451210)
#define NPCCROWD_AVATAR_NPCCROWDAVATARMANAGER___C__DISPLAYCLASS31_0__POSTLOADAVATARGOGALGAME_B__2_OFFSET UNITYSDK_OFFSET(0x7451230)

namespace NPCCrowd::Avatar
{
	inline static constexpr unsigned int NPCCrowdAvatarManager___c__DisplayClass31_0_TypeDefinitionIndex = 75873;
