...
#define NPCCROWD_ACCESSORIES_MONODEVICENUMBERPLATE_CLEARRANDOMPOOL_OFFSET UNITYSDK_OFFSET(0x648D020)
#define NPCCROWD_ACCESSORIES_MONODEVICENUMBERPLATE_DESPAWNINDEXTOPOOL_OFFSET UNITYSDK_OFFSET(0x648CB50)
#define NPCCROWD_ACCESSORIES_MONODEVICENUMBERPLATE_INITRANDOMPOOL_OFFSET UNITYSDK_OFFSET(0x648CCD0)
#define NPCCROWD_ACCESSORIES_MONODEVICENUMBERPLATE_INIT_OFFSET UNITYSDK_OFFSET(0x648C120)
#define NPCCROWD_ACCESSORIES_MONODEVICENUMBERPLATE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x648C950)
#define NPCCROWD_ACCESSORIES_MONODEVICENUMBERPLATE_SPAWNRANDOMINDEXFROMPOOL_OFFSET UNITYSDK_OFFSET(0x648C370)
#define NPCCROWD_ACCESSORIES_MONODEVICENUMBERPLATE_UPDATEDEBUGINFO_OFFSET UNITYSDK_OFFSET(0x648C8F0)
#define NPCCROWD_ACCESSORIES_MONODEVICENUMBERPLATE_UPDATEMESH_OFFSET UNITYSDK_OFFSET(0x648C580)
#define NPCCROWD_ACCESSORIES_MONODEVICENUMBERPLATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x648D1E0)
#define NPCCROWD_ACCESSORIES_MONODEVICENUMBERPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x648D1C0)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int MonoDeviceNumberPlate_TypeDefinitionIndex = 43373;
	...
	public:
		...
		{
			return (::MonoNotRelateGameLogic::DynamicCarPlateAssetCfg**)Il2CppClass::FromTypeDefinitionIndex(MonoDeviceNumberPlate_TypeDefinitionIndex)->GetStaticField(0x3ADC0);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::MonoNotRelateGameLogic::DeviceCarType, ::NPCCrowd::Accessories::MonoDeviceNumberPlate_RandomPool>**)Il2CppClass::FromTypeDefinitionIndex(MonoDeviceNumberPlate_TypeDefinitionIndex)->GetStaticField(0x3ADC8);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::NPCCrowd::Accessories::MonoDeviceNumberPlate_Handle>**)Il2CppClass::FromTypeDefinitionIndex(MonoDeviceNumberPlate_TypeDefinitionIndex)->GetStaticField(0x3ADD0);
		}
