...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9AFE680)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS23_0__ENABLEEXTRAACCESSORIESBYOVERRIDEPARAM_B__0_OFFSET UNITYSDK_OFFSET(0x9AFE690)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryUtils___c__DisplayClass23_0_TypeDefinitionIndex = 44652;
