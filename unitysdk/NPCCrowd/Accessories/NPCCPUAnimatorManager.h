...
#define NPCCROWD_ACCESSORIES_NPCCPUANIMATORMANAGER_CREATECPUANIMATOR_OFFSET UNITYSDK_OFFSET(0x6023FB0)
#define NPCCROWD_ACCESSORIES_NPCCPUANIMATORMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x6023CF0)
#define NPCCROWD_ACCESSORIES_NPCCPUANIMATORMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x6023E60)
#define NPCCROWD_ACCESSORIES_NPCCPUANIMATORMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6024330)
#define NPCCROWD_ACCESSORIES_NPCCPUANIMATORMANAGER_RELEASEUNIONANIMATOR_OFFSET UNITYSDK_OFFSET(0x6024130)
#define NPCCROWD_ACCESSORIES_NPCCPUANIMATORMANAGER_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x6023F10)
#define NPCCROWD_ACCESSORIES_NPCCPUANIMATORMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x60241D0)
#define NPCCROWD_ACCESSORIES_NPCCPUANIMATORMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x60244A0)
#define NPCCROWD_ACCESSORIES_NPCCPUANIMATORMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x60244C0)
#define NPCCROWD_ACCESSORIES_NPCCPUANIMATORMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6024580)
#define NPCCROWD_ACCESSORIES_NPCCPUANIMATORMANAGER___BASE_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x6024640)
#define NPCCROWD_ACCESSORIES_NPCCPUANIMATORMANAGER___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x6024700)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCCPUAnimatorManager_TypeDefinitionIndex = 76209;
