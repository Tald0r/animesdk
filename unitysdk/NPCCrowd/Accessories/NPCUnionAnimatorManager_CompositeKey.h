...
#define NPCCROWD_ACCESSORIES_NPCUNIONANIMATORMANAGER_COMPOSITEKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x32DFF0)
#define NPCCROWD_ACCESSORIES_NPCUNIONANIMATORMANAGER_COMPOSITEKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x32E070)
#define NPCCROWD_ACCESSORIES_NPCUNIONANIMATORMANAGER_COMPOSITEKEY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x32E0E0)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCUnionAnimatorManager_CompositeKey_TypeDefinitionIndex = 62299;
