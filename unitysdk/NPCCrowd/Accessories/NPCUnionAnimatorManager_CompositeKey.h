...
#define NPCCROWD_ACCESSORIES_NPCUNIONANIMATORMANAGER_COMPOSITEKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x326BD0)
#define NPCCROWD_ACCESSORIES_NPCUNIONANIMATORMANAGER_COMPOSITEKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x326C50)
#define NPCCROWD_ACCESSORIES_NPCUNIONANIMATORMANAGER_COMPOSITEKEY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x326CC0)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCUnionAnimatorManager_CompositeKey_TypeDefinitionIndex = 44866;
