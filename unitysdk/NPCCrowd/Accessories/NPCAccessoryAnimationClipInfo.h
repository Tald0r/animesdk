...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONCLIPINFO_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x751B1A0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONCLIPINFO_UNLOADASSET_OFFSET UNITYSDK_OFFSET(0x751B2F0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONCLIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x751B420)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAnimationClipInfo_TypeDefinitionIndex = 66770;
