...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONCLIPINFO_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x757BB90)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONCLIPINFO_UNLOADASSET_OFFSET UNITYSDK_OFFSET(0x757BCE0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONCLIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x757BE10)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAnimationClipInfo_TypeDefinitionIndex = 71528;
