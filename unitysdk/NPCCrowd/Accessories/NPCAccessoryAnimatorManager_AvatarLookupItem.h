...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_ADD_OFFSET UNITYSDK_OFFSET(0x5E04280)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_BUILDSAMPLEPOSEJOB_OFFSET UNITYSDK_OFFSET(0x5E04630)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_CLEARJOBDATA_OFFSET UNITYSDK_OFFSET(0x5E04990)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_CONSUMEJOBDATA_OFFSET UNITYSDK_OFFSET(0x5E04A30)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_DISPATCHSAMPLEPOSEJOB_OFFSET UNITYSDK_OFFSET(0x5E04300)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_GENERATESAMPLEDATA_OFFSET UNITYSDK_OFFSET(0x5E04C60)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_GETROOTINDEX_OFFSET UNITYSDK_OFFSET(0x5E03CC0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x5E04080)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_NEW_OFFSET UNITYSDK_OFFSET(0x5E040B0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_REMOVE_OFFSET UNITYSDK_OFFSET(0x5E042B0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x5E035D0)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAnimatorManager_AvatarLookupItem_TypeDefinitionIndex = 75528;

	class NPCAccessoryAnimatorManager_AvatarLookupItem : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Int32>* _rootIndex; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::Animation::NPCAnimationLib_AnimationId>* _lookupTable; // 0x18
