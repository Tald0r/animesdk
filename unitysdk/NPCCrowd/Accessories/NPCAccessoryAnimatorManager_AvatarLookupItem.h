...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_ADD_OFFSET UNITYSDK_OFFSET(0x6345A60)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_BUILDSAMPLEPOSEJOB_OFFSET UNITYSDK_OFFSET(0x6345E10)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_CLEARJOBDATA_OFFSET UNITYSDK_OFFSET(0x6346170)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_CONSUMEJOBDATA_OFFSET UNITYSDK_OFFSET(0x6346210)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_DISPATCHSAMPLEPOSEJOB_OFFSET UNITYSDK_OFFSET(0x6345AE0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_GENERATESAMPLEDATA_OFFSET UNITYSDK_OFFSET(0x6346440)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_GETROOTINDEX_OFFSET UNITYSDK_OFFSET(0x63454A0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x6345860)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_NEW_OFFSET UNITYSDK_OFFSET(0x6345890)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM_REMOVE_OFFSET UNITYSDK_OFFSET(0x6345A90)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_AVATARLOOKUPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x6344DC0)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAnimatorManager_AvatarLookupItem_TypeDefinitionIndex = 40918;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::Animation::NPCAnimationLib_AnimationId>* _lookupTable; // 0x30
