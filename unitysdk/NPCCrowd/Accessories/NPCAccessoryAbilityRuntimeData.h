...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_CREATEBUFFER_OFFSET UNITYSDK_OFFSET(0x76D2B90)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_INITENTITY_OFFSET UNITYSDK_OFFSET(0x76D2C70)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_INIT_OFFSET UNITYSDK_OFFSET(0x76D2A60)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0x76D2D00)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x76D2DA0)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAbilityRuntimeData_TypeDefinitionIndex = 46548;
