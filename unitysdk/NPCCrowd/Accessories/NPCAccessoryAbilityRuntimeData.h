...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_CREATEBUFFER_OFFSET UNITYSDK_OFFSET(0xA10A410)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_INITENTITY_OFFSET UNITYSDK_OFFSET(0xA10A4F0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_INIT_OFFSET UNITYSDK_OFFSET(0xA10A2E0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0xA10A580)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYABILITYRUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA10A620)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAbilityRuntimeData_TypeDefinitionIndex = 46884;
