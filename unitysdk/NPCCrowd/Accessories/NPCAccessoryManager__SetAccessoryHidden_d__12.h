...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMANAGER__SETACCESSORYHIDDEN_D__12_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x2C4800)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMANAGER__SETACCESSORYHIDDEN_D__12_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryManager__SetAccessoryHidden_d__12_TypeDefinitionIndex = 47603;
	...
	struct alignas(8) NPCAccessoryManager__SetAccessoryHidden_d__12
	{
		...
		::System::Boolean fade; // 0x34
		::System::Boolean bIsHidden; // 0x35
