...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_SAMPLEPOSEJOB_BUILDREQUESTS_OFFSET UNITYSDK_OFFSET(0x33C7A0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_SAMPLEPOSEJOB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x33C800)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_SAMPLEPOSEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x33C790)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATORMANAGER_SAMPLEPOSEJOB_REMOVEROOTMOTION_OFFSET UNITYSDK_OFFSET(0x33C7E0)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAnimatorManager_SamplePoseJob_TypeDefinitionIndex = 75527;
