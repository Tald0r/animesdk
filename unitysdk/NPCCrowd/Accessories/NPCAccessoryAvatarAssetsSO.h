...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYAVATARASSETSSO_GET_BNEEDREADGPUSLOTDATA_OFFSET UNITYSDK_OFFSET(0x62E0FE0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYAVATARASSETSSO_REFRESHASSETS_OFFSET UNITYSDK_OFFSET(0x62E0F80)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYAVATARASSETSSO_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x62E1070)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYAVATARASSETSSO__CTOR_OFFSET UNITYSDK_OFFSET(0x62E1280)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAvatarAssetsSO_TypeDefinitionIndex = 73899;
