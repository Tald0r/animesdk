...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_GET_ALLFOLLOWANIMATIONCLIPSETTINGS_OFFSET UNITYSDK_OFFSET(0x8479890)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_GET_MDBCLOTHS_OFFSET UNITYSDK_OFFSET(0x8479AA0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_GET_MDBCONTROLLER_OFFSET UNITYSDK_OFFSET(0x8479D40)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_GET_MDBHUMAN_OFFSET UNITYSDK_OFFSET(0x8479930)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_REFRESHANIMDATA_OFFSET UNITYSDK_OFFSET(0x8479EA0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_REFRESH_OFFSET UNITYSDK_OFFSET(0x847A490)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x847A630)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO__CTOR_OFFSET UNITYSDK_OFFSET(0x847A900)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAnimationAssetsSO_TypeDefinitionIndex = 71317;
