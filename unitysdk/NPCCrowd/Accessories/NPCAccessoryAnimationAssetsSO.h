...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_GET_ALLFOLLOWANIMATIONCLIPSETTINGS_OFFSET UNITYSDK_OFFSET(0x648D300)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_GET_MDBCLOTHS_OFFSET UNITYSDK_OFFSET(0x648D510)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_GET_MDBCONTROLLER_OFFSET UNITYSDK_OFFSET(0x648D7B0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_GET_MDBHUMAN_OFFSET UNITYSDK_OFFSET(0x648D3A0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_REFRESHANIMDATA_OFFSET UNITYSDK_OFFSET(0x648D910)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_REFRESH_OFFSET UNITYSDK_OFFSET(0x648DF10)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x648E0B0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYANIMATIONASSETSSO__CTOR_OFFSET UNITYSDK_OFFSET(0x648E380)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryAnimationAssetsSO_TypeDefinitionIndex = 62050;
