...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_GETACCESSORYAVATARASSET_OFFSET UNITYSDK_OFFSET(0x5E06760)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_GETACCESSORYMESHASSET_OFFSET UNITYSDK_OFFSET(0x5E06630)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_GETALLLODMESH_OFFSET UNITYSDK_OFFSET(0x5E056F0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x5E05460)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x5E055D0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x5E06D70)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0x5E05A80)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_PRELOADASSETS_OFFSET UNITYSDK_OFFSET(0x5E05750)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_RELEASERESOURCES_OFFSET UNITYSDK_OFFSET(0x5E06C30)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_SETAVATARASSETS_OFFSET UNITYSDK_OFFSET(0x5E06210)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x5E06F70)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x5E06F80)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x5E06FE0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER___BASE_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0x5E07040)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryMeshManager_TypeDefinitionIndex = 65046;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>**)Il2CppClass::FromTypeDefinitionIndex(NPCAccessoryMeshManager_TypeDefinitionIndex)->GetStaticField(0x44250);
		}
