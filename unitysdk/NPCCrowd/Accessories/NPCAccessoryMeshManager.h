...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_GETACCESSORYAVATARASSET_OFFSET UNITYSDK_OFFSET(0x6347F40)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_GETACCESSORYMESHASSET_OFFSET UNITYSDK_OFFSET(0x6347E10)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_GETALLLODMESH_OFFSET UNITYSDK_OFFSET(0x6346ED0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x6346C40)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x6346DB0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6348550)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0x6347260)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_PRELOADASSETS_OFFSET UNITYSDK_OFFSET(0x6346F30)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_RELEASERESOURCES_OFFSET UNITYSDK_OFFSET(0x6348410)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER_SETAVATARASSETS_OFFSET UNITYSDK_OFFSET(0x63479F0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x6348750)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x6348760)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x63487C0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYMESHMANAGER___BASE_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0x6348820)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryMeshManager_TypeDefinitionIndex = 62903;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>**)Il2CppClass::FromTypeDefinitionIndex(NPCAccessoryMeshManager_TypeDefinitionIndex)->GetStaticField(0x45450);
		}
