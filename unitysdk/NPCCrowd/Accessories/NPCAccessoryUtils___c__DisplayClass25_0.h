...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x72268C0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS25_0__GENERATEGALGAMENPCACCESSORYINFO_B__0_OFFSET UNITYSDK_OFFSET(0x72268D0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS25_0__GENERATEGALGAMENPCACCESSORYINFO_B__1_OFFSET UNITYSDK_OFFSET(0x7226900)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS25_0__GENERATEGALGAMENPCACCESSORYINFO_B__2_OFFSET UNITYSDK_OFFSET(0x7226910)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryUtils___c__DisplayClass25_0_TypeDefinitionIndex = 75210;
