...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9AFE700)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS25_0__GENERATEGALGAMENPCACCESSORYINFO_B__0_OFFSET UNITYSDK_OFFSET(0x9AFE710)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS25_0__GENERATEGALGAMENPCACCESSORYINFO_B__1_OFFSET UNITYSDK_OFFSET(0x9AFE740)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS25_0__GENERATEGALGAMENPCACCESSORYINFO_B__2_OFFSET UNITYSDK_OFFSET(0x9AFE750)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryUtils___c__DisplayClass25_0_TypeDefinitionIndex = 44651;
