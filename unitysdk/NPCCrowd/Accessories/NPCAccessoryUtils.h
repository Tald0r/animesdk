...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_CLEARUSEDSHAREDMATERIALS_OFFSET UNITYSDK_OFFSET(0x695D110)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_ENABLEEXTRAACCESSORIESBYOVERRIDEPARAM_OFFSET UNITYSDK_OFFSET(0x6960BF0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GENERATEACCESSORYINFO_OFFSET UNITYSDK_OFFSET(0x6961C60)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GENERATEGALGAMENPCACCESSORYINFO_OFFSET UNITYSDK_OFFSET(0x69613A0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GENERATENPCACCESSORYINFO_OFFSET UNITYSDK_OFFSET(0x6961010)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GENERATEOVERRIDEACCESSORYPAIRS_OFFSET UNITYSDK_OFFSET(0x69608B0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYANIMATIONNUMBERBYANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0x69601B0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYFOLLOWANIMATIONID_OFFSET UNITYSDK_OFFSET(0x695FF90)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYFREEANIMATIONID_OFFSET UNITYSDK_OFFSET(0x6960130)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYID_OFFSET UNITYSDK_OFFSET(0x695FB70)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYINFOBYAVATARNAME_OFFSET UNITYSDK_OFFSET(0x6960310)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYITEMOVERRIDEID_OFFSET UNITYSDK_OFFSET(0x695FD10)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYMDBPOSEID_OFFSET UNITYSDK_OFFSET(0x695FE50)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GET_FORCESHOWEDACCESSORYITEMTYPES_OFFSET UNITYSDK_OFFSET(0x6961950)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETACCESSORYGPUSLOTLOD_OFFSET UNITYSDK_OFFSET(0x695E1D0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETACCESSORYMDBLOD_OFFSET UNITYSDK_OFFSET(0x695E7D0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETACCITEMOVERRIDEMATPARAMSCOMMON_OFFSET UNITYSDK_OFFSET(0x695E920)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETANIMATORLOD_OFFSET UNITYSDK_OFFSET(0x695E880)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETGPUSLOTANIMATIONMATPARAMS_OFFSET UNITYSDK_OFFSET(0x695EC90)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETLODASSET_OFFSET UNITYSDK_OFFSET(0x695D350)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETMESHLOD_OFFSET UNITYSDK_OFFSET(0x695D2A0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SPLITACCESSORYID_OFFSET UNITYSDK_OFFSET(0x695FC00)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SPLITACCESSORYITEMOVERRIDEID_OFFSET UNITYSDK_OFFSET(0x695FD80)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SPLITACCESSORYMDBPOSEID_OFFSET UNITYSDK_OFFSET(0x695FEC0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SPLITFOLLOWACCESSORYID_OFFSET UNITYSDK_OFFSET(0x6960020)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x6962430)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x6962420)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryUtils_TypeDefinitionIndex = 75204;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(NPCAccessoryUtils_TypeDefinitionIndex)->GetStaticField(0x392C0);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MonoNotRelateGameLogic::DeviceCarType>**)Il2CppClass::FromTypeDefinitionIndex(NPCAccessoryUtils_TypeDefinitionIndex)->GetStaticField(0x392C8);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Material*>** StaticGet_TmpMats()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(NPCAccessoryUtils_TypeDefinitionIndex)->GetStaticField(0x392D0);
		}
		static ::Il2CppArray<::NPCCrowd::Accessories::ENPCAccessoryItemType>** StaticGet__forceShowedAccessoryItemTypes()
		{
			return (::Il2CppArray<::NPCCrowd::Accessories::ENPCAccessoryItemType>**)Il2CppClass::FromTypeDefinitionIndex(NPCAccessoryUtils_TypeDefinitionIndex)->GetStaticField(0x392D8);
		}
		static ::UnityEngine::MaterialPropertyBlock** StaticGet_EmptyMpb()
		{
			return (::UnityEngine::MaterialPropertyBlock**)Il2CppClass::FromTypeDefinitionIndex(NPCAccessoryUtils_TypeDefinitionIndex)->GetStaticField(0x392E0);
		}
