...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_CLEARUSEDSHAREDMATERIALS_OFFSET UNITYSDK_OFFSET(0x62E13E0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_ENABLEEXTRAACCESSORIESBYOVERRIDEPARAM_OFFSET UNITYSDK_OFFSET(0x62E4EC0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GENERATEACCESSORYINFO_OFFSET UNITYSDK_OFFSET(0x62E5F40)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GENERATEGALGAMENPCACCESSORYINFO_OFFSET UNITYSDK_OFFSET(0x62E5680)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GENERATENPCACCESSORYINFO_OFFSET UNITYSDK_OFFSET(0x62E52F0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GENERATEOVERRIDEACCESSORYPAIRS_OFFSET UNITYSDK_OFFSET(0x62E4B80)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYANIMATIONNUMBERBYANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0x62E4480)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYFOLLOWANIMATIONID_OFFSET UNITYSDK_OFFSET(0x62E4260)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYFREEANIMATIONID_OFFSET UNITYSDK_OFFSET(0x62E4400)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYID_OFFSET UNITYSDK_OFFSET(0x62E3E40)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYINFOBYAVATARNAME_OFFSET UNITYSDK_OFFSET(0x62E45E0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYITEMOVERRIDEID_OFFSET UNITYSDK_OFFSET(0x62E3FE0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GETACCESSORYMDBPOSEID_OFFSET UNITYSDK_OFFSET(0x62E4120)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_GET_FORCESHOWEDACCESSORYITEMTYPES_OFFSET UNITYSDK_OFFSET(0x62E5C30)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETACCESSORYGPUSLOTLOD_OFFSET UNITYSDK_OFFSET(0x62E24B0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETACCESSORYMDBLOD_OFFSET UNITYSDK_OFFSET(0x62E2AB0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETACCITEMOVERRIDEMATPARAMSCOMMON_OFFSET UNITYSDK_OFFSET(0x62E2BF0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETANIMATORLOD_OFFSET UNITYSDK_OFFSET(0x62E2B50)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETGPUSLOTANIMATIONMATPARAMS_OFFSET UNITYSDK_OFFSET(0x62E2F60)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETLODASSET_OFFSET UNITYSDK_OFFSET(0x62E1620)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SETMESHLOD_OFFSET UNITYSDK_OFFSET(0x62E1570)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SPLITACCESSORYID_OFFSET UNITYSDK_OFFSET(0x62E3ED0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SPLITACCESSORYITEMOVERRIDEID_OFFSET UNITYSDK_OFFSET(0x62E4050)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SPLITACCESSORYMDBPOSEID_OFFSET UNITYSDK_OFFSET(0x62E4190)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS_SPLITFOLLOWACCESSORYID_OFFSET UNITYSDK_OFFSET(0x62E42F0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x62E6710)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x62E6700)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryUtils_TypeDefinitionIndex = 44650;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MonoNotRelateGameLogic::DeviceCarType>**)Il2CppClass::FromTypeDefinitionIndex(NPCAccessoryUtils_TypeDefinitionIndex)->GetStaticField(0x3BE30);
		}
		static ::Il2CppArray<::UnityEngine::Material*>** StaticGet_EmptyMaterials()
		{
			return (::Il2CppArray<::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(NPCAccessoryUtils_TypeDefinitionIndex)->GetStaticField(0x3BE38);
		}
		static ::Il2CppArray<::NPCCrowd::Accessories::ENPCAccessoryItemType>** StaticGet__forceShowedAccessoryItemTypes()
		{
			return (::Il2CppArray<::NPCCrowd::Accessories::ENPCAccessoryItemType>**)Il2CppClass::FromTypeDefinitionIndex(NPCAccessoryUtils_TypeDefinitionIndex)->GetStaticField(0x3BE40);
		}
		static ::UnityEngine::MaterialPropertyBlock** StaticGet_EmptyMpb()
		{
			return (::UnityEngine::MaterialPropertyBlock**)Il2CppClass::FromTypeDefinitionIndex(NPCAccessoryUtils_TypeDefinitionIndex)->GetStaticField(0x3BE48);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Material*>** StaticGet_TmpMats()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(NPCAccessoryUtils_TypeDefinitionIndex)->GetStaticField(0x3BE50);
		}
