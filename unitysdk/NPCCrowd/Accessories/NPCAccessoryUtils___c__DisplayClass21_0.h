...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9AFE570)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS21_0__GETACCESSORYINFOBYAVATARNAME_B__0_OFFSET UNITYSDK_OFFSET(0x9AFE580)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS21_0__GETACCESSORYINFOBYAVATARNAME_B__1_OFFSET UNITYSDK_OFFSET(0x9AFE600)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryUtils___c__DisplayClass21_0_TypeDefinitionIndex = 44654;
