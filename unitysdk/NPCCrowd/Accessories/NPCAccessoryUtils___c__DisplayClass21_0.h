...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0x7226730)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS21_0__GETACCESSORYINFOBYAVATARNAME_B__0_OFFSET UNITYSDK_OFFSET(0x7226740)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYUTILS___C__DISPLAYCLASS21_0__GETACCESSORYINFOBYAVATARNAME_B__1_OFFSET UNITYSDK_OFFSET(0x72267C0)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryUtils___c__DisplayClass21_0_TypeDefinitionIndex = 75211;
