...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYLODMESHASSETS_GETMESH_OFFSET UNITYSDK_OFFSET(0x6023430)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYLODMESHASSETS_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x60237A0)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYLODMESHASSETS__CTOR_OFFSET UNITYSDK_OFFSET(0x6023810)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryLodMeshAssets_TypeDefinitionIndex = 77209;
