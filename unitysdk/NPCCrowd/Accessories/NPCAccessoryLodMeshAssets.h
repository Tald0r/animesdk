...
#define NPCCROWD_ACCESSORIES_NPCACCESSORYLODMESHASSETS_GETMESH_OFFSET UNITYSDK_OFFSET(0x69E7810)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYLODMESHASSETS_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x69E7B80)
#define NPCCROWD_ACCESSORIES_NPCACCESSORYLODMESHASSETS__CTOR_OFFSET UNITYSDK_OFFSET(0x69E7BF0)

namespace NPCCrowd::Accessories
{
	inline static constexpr unsigned int NPCAccessoryLodMeshAssets_TypeDefinitionIndex = 54728;
