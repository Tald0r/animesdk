...
#define NPCCROWD_LOD_TARGETPAIR_EQUALS_OFFSET UNITYSDK_OFFSET(0x305F80)
#define NPCCROWD_LOD_TARGETPAIR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x305F90)
#define NPCCROWD_LOD_TARGETPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x2D6E20)
#define NPCCROWD_LOD_TARGETPAIR___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x305FA0)
#define NPCCROWD_LOD_TARGETPAIR___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x306010)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int TargetPair_TypeDefinitionIndex = 78432;
