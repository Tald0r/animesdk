...
#define NPCCROWD_LOD_TARGETPAIR_EQUALS_OFFSET UNITYSDK_OFFSET(0x301720)
#define NPCCROWD_LOD_TARGETPAIR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x301730)
#define NPCCROWD_LOD_TARGETPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x301710)
#define NPCCROWD_LOD_TARGETPAIR___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x301740)
#define NPCCROWD_LOD_TARGETPAIR___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3017B0)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int TargetPair_TypeDefinitionIndex = 40800;
