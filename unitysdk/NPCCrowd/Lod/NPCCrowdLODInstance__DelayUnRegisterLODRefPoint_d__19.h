...
#define NPCCROWD_LOD_NPCCROWDLODINSTANCE__DELAYUNREGISTERLODREFPOINT_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x311C50)
#define NPCCROWD_LOD_NPCCROWDLODINSTANCE__DELAYUNREGISTERLODREFPOINT_D__19_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCCrowdLODInstance__DelayUnRegisterLODRefPoint_d__19_TypeDefinitionIndex = 77369;
