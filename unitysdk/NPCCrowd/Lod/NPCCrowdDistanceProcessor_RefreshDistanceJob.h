...
#define NPCCROWD_LOD_NPCCROWDDISTANCEPROCESSOR_REFRESHDISTANCEJOB_CHECKDISTANCE2D_OFFSET UNITYSDK_OFFSET(0x641C190)
#define NPCCROWD_LOD_NPCCROWDDISTANCEPROCESSOR_REFRESHDISTANCEJOB_CHECKDISTANCE_OFFSET UNITYSDK_OFFSET(0x641C100)
#define NPCCROWD_LOD_NPCCROWDDISTANCEPROCESSOR_REFRESHDISTANCEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x3016B0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEPROCESSOR_REFRESHDISTANCEJOB_UPDATECALLBACK_OFFSET UNITYSDK_OFFSET(0x641C210)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCCrowdDistanceProcessor_RefreshDistanceJob_TypeDefinitionIndex = 59397;
