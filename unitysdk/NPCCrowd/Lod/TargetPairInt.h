...
#define NPCCROWD_LOD_TARGETPAIRINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x36CF70)
#define NPCCROWD_LOD_TARGETPAIRINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x36CF80)
#define NPCCROWD_LOD_TARGETPAIRINT__CTOR_OFFSET UNITYSDK_OFFSET(0x36CF50)
#define NPCCROWD_LOD_TARGETPAIRINT___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x36D000)
#define NPCCROWD_LOD_TARGETPAIRINT___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x36D060)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int TargetPairInt_TypeDefinitionIndex = 38769;
