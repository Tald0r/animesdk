...
#define NPCCROWD_LOD_NPCLODRENDERERITEM_REFRESHMESHNAME_OFFSET UNITYSDK_OFFSET(0x305F50)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCLODRendererItem_TypeDefinitionIndex = 41991;
