...
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_CHECK_OFFSET UNITYSDK_OFFSET(0x6ED6080)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_COMMONREGISTERUPDATE_OFFSET UNITYSDK_OFFSET(0x6ED3C80)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_DISPOSECOMMONAGENTS_OFFSET UNITYSDK_OFFSET(0x6ED77E0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x6ED33A0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_INITCOMMONAGENTS_OFFSET UNITYSDK_OFFSET(0x6ED3730)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x6ED3540)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_INTERNALUNREGISTERUPDATE_OFFSET UNITYSDK_OFFSET(0x6ED5030)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x6ED6650)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6ED75C0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_POSTLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x6ED6990)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_REGISTERTARGET_OFFSET UNITYSDK_OFFSET(0x6ED4520)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_REGISTERUPDATE_OFFSET UNITYSDK_OFFSET(0x6ED3E90)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_TRYGETREGISTRYHANDLERSBYTASKIDX_OFFSET UNITYSDK_OFFSET(0x6ED3910)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_TRYGETREGISTRY_OFFSET UNITYSDK_OFFSET(0x6ED3A10)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_TRYGETTARGET_OFFSET UNITYSDK_OFFSET(0x6ED37E0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_TRYSETREGISTRY_OFFSET UNITYSDK_OFFSET(0x6ED3B40)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_UNREGISTERUPDATE_OFFSET UNITYSDK_OFFSET(0x6ED4F80)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_UPDATEREGISTRYCONDITION_OFFSET UNITYSDK_OFFSET(0x6ED4D10)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_UPDATETARGET_OFFSET UNITYSDK_OFFSET(0x6ED4940)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_WAIT_OFFSET UNITYSDK_OFFSET(0x6ED44A0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x6ED7850)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x6ED7AC0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER___BASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x6ED7B20)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6ED7B90)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER___BASE_POSTLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x6ED7BF0)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCCrowdDistanceManager_TypeDefinitionIndex = 53071;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::NPCCrowd::Lod::INPCCrowdDistanceCheckInterface*, ::System::ValueTuple_2<::System::Int32, ::System::Int32>>* _targetIdxCache; // 0x20
		::System::Collections::Generic::HashSet_1<::System::Int32>* _delayDeleteRegistry; // 0x28
		::Il2CppArray<::NPCCrowd::Lod::Registry>* _registries; // 0x30
		::System::Collections::Generic::Stack_1<::System::Int32>* _availiableTargetIdx; // 0x38
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*>* _taskIdx2handlers; // 0x40
		::System::Collections::Generic::Dictionary_2<::NPCCrowd::Lod::TargetPairInt, ::System::Int32>* _taskIdxCache; // 0x48
		::NPCCrowd::Lod::NPCCrowdPlayerAgent* playerAgent; // 0x50
		::NPCCrowd::Lod::NPCCrowdCameraAgent* cameraAgent; // 0x58
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::Lod::INPCCrowdDistanceCheckInterface*>* _idxTargetCache; // 0x60
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _registryHandlers; // 0x68
		::Unity::Jobs::JobHandle _jobHandle; // 0x70
		::Unity::Collections::NativeArray_1<::System::Single> movements; // 0x80
		::Unity::Collections::NativeArray_1<::NPCCrowd::Lod::NPCCrowdDistanceProcessor_TaskRuntime> tasks; // 0x90
		::System::Int32 registryCount; // 0xA0
		::System::Int32 taskCount; // 0xA4
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> positions; // 0xA8
