...
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_CHECK_OFFSET UNITYSDK_OFFSET(0x785B150)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_COMMONREGISTERUPDATE_OFFSET UNITYSDK_OFFSET(0x7858D70)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_DISPOSECOMMONAGENTS_OFFSET UNITYSDK_OFFSET(0x785C8A0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x7858490)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_INITCOMMONAGENTS_OFFSET UNITYSDK_OFFSET(0x7858820)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x7858630)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_INTERNALUNREGISTERUPDATE_OFFSET UNITYSDK_OFFSET(0x785A110)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x785B720)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x785C680)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_POSTLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x785BA50)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_REGISTERTARGET_OFFSET UNITYSDK_OFFSET(0x7859600)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_REGISTERUPDATE_OFFSET UNITYSDK_OFFSET(0x7858F80)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_TRYGETREGISTRYHANDLERSBYTASKIDX_OFFSET UNITYSDK_OFFSET(0x7858A00)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_TRYGETREGISTRY_OFFSET UNITYSDK_OFFSET(0x7858B00)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_TRYGETTARGET_OFFSET UNITYSDK_OFFSET(0x78588D0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_TRYSETREGISTRY_OFFSET UNITYSDK_OFFSET(0x7858C30)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_UNREGISTERUPDATE_OFFSET UNITYSDK_OFFSET(0x785A060)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_UPDATEREGISTRYCONDITION_OFFSET UNITYSDK_OFFSET(0x7859DF0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_UPDATETARGET_OFFSET UNITYSDK_OFFSET(0x7859A20)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_WAIT_OFFSET UNITYSDK_OFFSET(0x7859580)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x785C910)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x785CB80)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER___BASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x785CBE0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x785CC50)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER___BASE_POSTLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x785CCB0)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCCrowdDistanceManager_TypeDefinitionIndex = 77739;
	...
	public:
		...
		::System::Collections::Generic::Stack_1<::System::Int32>* _availiableTargetIdx; // 0x18
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::Lod::INPCCrowdDistanceCheckInterface*>* _idxTargetCache; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _registryHandlers; // 0x38
		::NPCCrowd::Lod::NPCCrowdPlayerAgent* playerAgent; // 0x40
		::System::Collections::Generic::Dictionary_2<::NPCCrowd::Lod::TargetPairInt, ::System::Int32>* _taskIdxCache; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*>* _taskIdx2handlers; // 0x50
		::System::Collections::Generic::Dictionary_2<::NPCCrowd::Lod::INPCCrowdDistanceCheckInterface*, ::System::ValueTuple_2<::System::Int32, ::System::Int32>>* _targetIdxCache; // 0x58
		::Il2CppArray<::NPCCrowd::Lod::Registry>* _registries; // 0x60
		::NPCCrowd::NPCIDGeneratorInt* IDGen; // 0x68
		::System::Int32 taskCount; // 0x70
		::System::Int32 registryCount; // 0x74
		::Unity::Collections::NativeArray_1<::NPCCrowd::Lod::NPCCrowdDistanceProcessor_TaskRuntime> tasks; // 0x78
