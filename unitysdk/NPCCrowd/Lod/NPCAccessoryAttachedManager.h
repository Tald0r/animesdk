...
#define NPCCROWD_LOD_NPCACCESSORYATTACHEDMANAGER_CREATEFILTERS_OFFSET UNITYSDK_OFFSET(0x5E13C50)
#define NPCCROWD_LOD_NPCACCESSORYATTACHEDMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x5E13D80)
#define NPCCROWD_LOD_NPCACCESSORYATTACHEDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x5E14060)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCAccessoryAttachedManager_TypeDefinitionIndex = 68046;
