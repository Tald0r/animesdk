...
#define NPCCROWD_LOD_NPCACCESSORYATTACHEDMANAGER_CREATEFILTERS_OFFSET UNITYSDK_OFFSET(0x6355510)
#define NPCCROWD_LOD_NPCACCESSORYATTACHEDMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x6355640)
#define NPCCROWD_LOD_NPCACCESSORYATTACHEDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x6355920)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCAccessoryAttachedManager_TypeDefinitionIndex = 65573;
