...
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_NPCCROWDDISTANCECHECK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x6ED7C70)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_NPCCROWDDISTANCECHECK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x6ED7D20)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_NPCCROWDDISTANCECHECK_INVOKE_OFFSET UNITYSDK_OFFSET(0x6ED7020)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_NPCCROWDDISTANCECHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x6ED7C60)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCCrowdDistanceManager_NpcCrowdDistanceCheck_TypeDefinitionIndex = 53072;
