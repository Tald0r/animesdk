...
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_NPCCROWDDISTANCECHECK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x785CD40)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_NPCCROWDDISTANCECHECK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x785CDF0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_NPCCROWDDISTANCECHECK_INVOKE_OFFSET UNITYSDK_OFFSET(0x785C0E0)
#define NPCCROWD_LOD_NPCCROWDDISTANCEMANAGER_NPCCROWDDISTANCECHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x785CD20)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCCrowdDistanceManager_NpcCrowdDistanceCheck_TypeDefinitionIndex = 77740;
