...
#define NPCCROWD_LOD_NPCCROWDCAMERAAGENT_GETMOVEMENTMAG_OFFSET UNITYSDK_OFFSET(0x7FBADC0)
#define NPCCROWD_LOD_NPCCROWDCAMERAAGENT_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x7FBAFF0)
#define NPCCROWD_LOD_NPCCROWDCAMERAAGENT_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x7FBB0A0)
#define NPCCROWD_LOD_NPCCROWDCAMERAAGENT__CTOR_OFFSET UNITYSDK_OFFSET(0x7FBB2F0)

namespace NPCCrowd::Lod
{
	inline static constexpr unsigned int NPCCrowdCameraAgent_TypeDefinitionIndex = 67238;
