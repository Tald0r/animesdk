...
#define NPCCROWD_AI_TRIGGEREVENTSTIMULUSITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x5DF7B20)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int TriggerEventStimulusItem_TypeDefinitionIndex = 66281;
