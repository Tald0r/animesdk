...
#define NPCCROWD_AI_TRIGGEREVENTSTIMULUSITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x63381A0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int TriggerEventStimulusItem_TypeDefinitionIndex = 80602;
