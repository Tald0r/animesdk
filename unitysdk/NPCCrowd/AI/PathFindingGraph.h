...
#define NPCCROWD_AI_PATHFINDINGGRAPH_CALHEURISTICDISTANCE_OFFSET UNITYSDK_OFFSET(0xA0DCEF0)
#define NPCCROWD_AI_PATHFINDINGGRAPH_CLEAR_OFFSET UNITYSDK_OFFSET(0xA0DC3D0)
#define NPCCROWD_AI_PATHFINDINGGRAPH_FINDSHORTESTPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0xA0DC730)
#define NPCCROWD_AI_PATHFINDINGGRAPH_FINDSHORTESTPATH_OFFSET UNITYSDK_OFFSET(0xA0DC4A0)
#define NPCCROWD_AI_PATHFINDINGGRAPH_GETPATHGRAPHNODEINDEX_OFFSET UNITYSDK_OFFSET(0xA0DC650)
#define NPCCROWD_AI_PATHFINDINGGRAPH_INITPATHFINDINGNODES_OFFSET UNITYSDK_OFFSET(0xA0DACB0)
#define NPCCROWD_AI_PATHFINDINGGRAPH_INIT_OFFSET UNITYSDK_OFFSET(0xA0DAC40)
#define NPCCROWD_AI_PATHFINDINGGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0xA0DD120)
#define NPCCROWD_AI_PATHFINDINGGRAPH__INITPATHFINDINGNODES_G__GETSPLINEPATHFINDINGNODEBYPOSITION_3_1_OFFSET UNITYSDK_OFFSET(0xA0DC340)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathFindingGraph_TypeDefinitionIndex = 46319;
