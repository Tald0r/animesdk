...
#define NPCCROWD_AI_PATHFINDINGGRAPH_CALHEURISTICDISTANCE_OFFSET UNITYSDK_OFFSET(0xC2E5190)
#define NPCCROWD_AI_PATHFINDINGGRAPH_CLEAR_OFFSET UNITYSDK_OFFSET(0xC2E4670)
#define NPCCROWD_AI_PATHFINDINGGRAPH_FINDSHORTESTPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0xC2E49D0)
#define NPCCROWD_AI_PATHFINDINGGRAPH_FINDSHORTESTPATH_OFFSET UNITYSDK_OFFSET(0xC2E4740)
#define NPCCROWD_AI_PATHFINDINGGRAPH_GETPATHGRAPHNODEINDEX_OFFSET UNITYSDK_OFFSET(0xC2E48F0)
#define NPCCROWD_AI_PATHFINDINGGRAPH_INITPATHFINDINGNODES_OFFSET UNITYSDK_OFFSET(0xC2E2B90)
#define NPCCROWD_AI_PATHFINDINGGRAPH_INIT_OFFSET UNITYSDK_OFFSET(0xC2E2B20)
#define NPCCROWD_AI_PATHFINDINGGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0xC2E53C0)
#define NPCCROWD_AI_PATHFINDINGGRAPH__INITPATHFINDINGNODES_G__GETSPLINEPATHFINDINGNODEBYPOSITION_3_1_OFFSET UNITYSDK_OFFSET(0xC2E45E0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathFindingGraph_TypeDefinitionIndex = 57145;
