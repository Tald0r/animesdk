...
#define NPCCROWD_AI_AIACTIONCONFIGASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x6B3B240)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionConfigAssetSO_TypeDefinitionIndex = 65726;
