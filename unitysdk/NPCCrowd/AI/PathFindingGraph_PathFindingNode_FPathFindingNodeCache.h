...
#define NPCCROWD_AI_PATHFINDINGGRAPH_PATHFINDINGNODE_FPATHFINDINGNODECACHE_CLEAR_OFFSET UNITYSDK_OFFSET(0x2C3DC0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathFindingGraph_PathFindingNode_FPathFindingNodeCache_TypeDefinitionIndex = 46321;
