...
#define NPCCROWD_AI_INTVALUEGETTERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x76C1700)
#define NPCCROWD_AI_INTVALUEGETTERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x76C1730)
#define NPCCROWD_AI_INTVALUEGETTERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x76C1460)
#define NPCCROWD_AI_INTVALUEGETTERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x76C1440)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int IntValueGetterDelegate_TypeDefinitionIndex = 59917;
