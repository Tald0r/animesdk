...
#define NPCCROWD_AI_INTVALUEGETTERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA0FA890)
#define NPCCROWD_AI_INTVALUEGETTERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA0FA8C0)
#define NPCCROWD_AI_INTVALUEGETTERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA0FA5F0)
#define NPCCROWD_AI_INTVALUEGETTERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xA0FA5E0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int IntValueGetterDelegate_TypeDefinitionIndex = 39791;
