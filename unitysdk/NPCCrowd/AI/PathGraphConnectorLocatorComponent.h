...
#define NPCCROWD_AI_PATHGRAPHCONNECTORLOCATORCOMPONENT_GET_NEARESTCONNECTORNODEINDEX_OFFSET UNITYSDK_OFFSET(0x6486040)
#define NPCCROWD_AI_PATHGRAPHCONNECTORLOCATORCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x6486050)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphConnectorLocatorComponent_TypeDefinitionIndex = 60088;
