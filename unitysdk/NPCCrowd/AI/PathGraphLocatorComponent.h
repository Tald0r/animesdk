...
#define NPCCROWD_AI_PATHGRAPHLOCATORCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x763F3E0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphLocatorComponent_TypeDefinitionIndex = 43159;
