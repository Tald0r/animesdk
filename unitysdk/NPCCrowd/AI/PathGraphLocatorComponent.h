...
#define NPCCROWD_AI_PATHGRAPHLOCATORCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x861EDD0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphLocatorComponent_TypeDefinitionIndex = 65423;
