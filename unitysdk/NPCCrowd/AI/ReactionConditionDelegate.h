...
#define NPCCROWD_AI_REACTIONCONDITIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x62D08E0)
#define NPCCROWD_AI_REACTIONCONDITIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x62D0970)
#define NPCCROWD_AI_REACTIONCONDITIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x62D0110)
#define NPCCROWD_AI_REACTIONCONDITIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x62D00F0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int ReactionConditionDelegate_TypeDefinitionIndex = 59534;
