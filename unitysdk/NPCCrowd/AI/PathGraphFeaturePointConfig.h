...
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG_GET_NEARESTCONNECTORNODEINDEX_OFFSET UNITYSDK_OFFSET(0xC2E5710)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG_GET_NEARESTSPLINENODEINDEX_OFFSET UNITYSDK_OFFSET(0xC2E5700)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG_GET_POINTINDEX_OFFSET UNITYSDK_OFFSET(0xC2E5680)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC2E5620)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphFeaturePointConfig_TypeDefinitionIndex = 81261;
