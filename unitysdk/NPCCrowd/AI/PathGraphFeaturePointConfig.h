...
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG_GET_NEARESTCONNECTORNODEINDEX_OFFSET UNITYSDK_OFFSET(0xA0DD2B0)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG_GET_NEARESTSPLINENODEINDEX_OFFSET UNITYSDK_OFFSET(0xA0DD2A0)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG_GET_POINTINDEX_OFFSET UNITYSDK_OFFSET(0xA0DD220)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA0DD1C0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphFeaturePointConfig_TypeDefinitionIndex = 68320;
