...
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_PATHGRAPHLANE_GET_ALLOWEDMAXCROWD_OFFSET UNITYSDK_OFFSET(0x7EEF440)
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_PATHGRAPHLANE_REFRESHRUNTIMEDATA_OFFSET UNITYSDK_OFFSET(0x7EEF680)
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_PATHGRAPHLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x7EEF6E0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineConfig_PathGraphLane_TypeDefinitionIndex = 74093;
