...
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_PATHGRAPHLANE_GET_ALLOWEDMAXCROWD_OFFSET UNITYSDK_OFFSET(0x6B9DE30)
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_PATHGRAPHLANE_REFRESHRUNTIMEDATA_OFFSET UNITYSDK_OFFSET(0x6B9E070)
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_PATHGRAPHLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x6B9E0D0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineConfig_PathGraphLane_TypeDefinitionIndex = 62028;
