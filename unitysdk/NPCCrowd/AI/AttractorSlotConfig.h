...
#define NPCCROWD_AI_ATTRACTORSLOTCONFIG_RESETDATA_OFFSET UNITYSDK_OFFSET(0x3260B0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorSlotConfig_TypeDefinitionIndex = 64961;
