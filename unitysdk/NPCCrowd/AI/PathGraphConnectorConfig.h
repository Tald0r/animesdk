...
#define NPCCROWD_AI_PATHGRAPHCONNECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x77ECB60)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphConnectorConfig_TypeDefinitionIndex = 65375;
