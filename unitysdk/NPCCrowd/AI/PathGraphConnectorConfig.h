...
#define NPCCROWD_AI_PATHGRAPHCONNECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6B3BFC0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphConnectorConfig_TypeDefinitionIndex = 38398;
