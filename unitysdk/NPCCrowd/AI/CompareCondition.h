...
#define NPCCROWD_AI_COMPARECONDITION_CHECKBOOL_OFFSET UNITYSDK_OFFSET(0x174A6B40)
#define NPCCROWD_AI_COMPARECONDITION_CHECKFLOAT_OFFSET UNITYSDK_OFFSET(0x174A69D0)
#define NPCCROWD_AI_COMPARECONDITION_CHECKINT_OFFSET UNITYSDK_OFFSET(0x174A6BC0)
#define NPCCROWD_AI_COMPARECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x174A69C0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int CompareCondition_TypeDefinitionIndex = 40136;
