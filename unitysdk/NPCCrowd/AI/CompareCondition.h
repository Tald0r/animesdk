...
#define NPCCROWD_AI_COMPARECONDITION_CHECKBOOL_OFFSET UNITYSDK_OFFSET(0x609B140)
#define NPCCROWD_AI_COMPARECONDITION_CHECKFLOAT_OFFSET UNITYSDK_OFFSET(0x609AFD0)
#define NPCCROWD_AI_COMPARECONDITION_CHECKINT_OFFSET UNITYSDK_OFFSET(0x609B1C0)
#define NPCCROWD_AI_COMPARECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x609AFC0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int CompareCondition_TypeDefinitionIndex = 46965;
