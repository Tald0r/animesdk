...
#define NPCCROWD_AI_ATTRACTORCONFIGASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x6B3B680)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorConfigAssetSO_TypeDefinitionIndex = 63699;
