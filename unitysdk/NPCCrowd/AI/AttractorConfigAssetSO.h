...
#define NPCCROWD_AI_ATTRACTORCONFIGASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x77EC220)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorConfigAssetSO_TypeDefinitionIndex = 75187;
