...
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x6F981B0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphGuidePointComponent_TypeDefinitionIndex = 67389;
