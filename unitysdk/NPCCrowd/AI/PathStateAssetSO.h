...
#define NPCCROWD_AI_PATHSTATEASSETSO_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x7EEF830)
#define NPCCROWD_AI_PATHSTATEASSETSO_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x7EEF7D0)
#define NPCCROWD_AI_PATHSTATEASSETSO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x7EEF770)
#define NPCCROWD_AI_PATHSTATEASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x7EEF890)
#define NPCCROWD_AI_PATHSTATEASSETSO___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x7EEFC50)
#define NPCCROWD_AI_PATHSTATEASSETSO___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x7EEFC60)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathStateAssetSO_TypeDefinitionIndex = 56294;
