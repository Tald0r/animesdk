...
#define NPCCROWD_AI_PATHSTATEASSETSO_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x6B9E220)
#define NPCCROWD_AI_PATHSTATEASSETSO_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x6B9E1C0)
#define NPCCROWD_AI_PATHSTATEASSETSO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x6B9E160)
#define NPCCROWD_AI_PATHSTATEASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x6B9E280)
#define NPCCROWD_AI_PATHSTATEASSETSO___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x6B9E640)
#define NPCCROWD_AI_PATHSTATEASSETSO___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x6B9E650)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathStateAssetSO_TypeDefinitionIndex = 47223;
