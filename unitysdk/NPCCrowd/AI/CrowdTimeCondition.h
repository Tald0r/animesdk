...
#define NPCCROWD_AI_CROWDTIMECONDITION_CHECK_OFFSET UNITYSDK_OFFSET(0x60145F0)
#define NPCCROWD_AI_CROWDTIMECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x60145E0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int CrowdTimeCondition_TypeDefinitionIndex = 53535;
