...
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETALLENTERNODE_OFFSET UNITYSDK_OFFSET(0x63392F0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETNODEBYIDX_OFFSET UNITYSDK_OFFSET(0x6338F30)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETNODECALMEMORYBYIDX_OFFSET UNITYSDK_OFFSET(0x6338FD0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETNODECALMEMORY_OFFSET UNITYSDK_OFFSET(0x6339060)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETNODECFG_OFFSET UNITYSDK_OFFSET(0x6339200)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETNODEINDEX_OFFSET UNITYSDK_OFFSET(0x6339140)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETNODE_OFFSET UNITYSDK_OFFSET(0x6338B30)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETPATHBETWEEN_1_OFFSET UNITYSDK_OFFSET(0x63397A0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETPATHBETWEEN_OFFSET UNITYSDK_OFFSET(0x6339660)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETPATHCFG_OFFSET UNITYSDK_OFFSET(0x6339570)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETPATH_OFFSET UNITYSDK_OFFSET(0x6338C20)
#define NPCCROWD_AI_WPGRAPHRUNTIME_GETSTATEID_OFFSET UNITYSDK_OFFSET(0x6338D30)
#define NPCCROWD_AI_WPGRAPHRUNTIME_HASSTATE_OFFSET UNITYSDK_OFFSET(0x6338DA0)
#define NPCCROWD_AI_WPGRAPHRUNTIME_SETSTATEID_OFFSET UNITYSDK_OFFSET(0x6338650)
#define NPCCROWD_AI_WPGRAPHRUNTIME_TRYGETNODECOPY_OFFSET UNITYSDK_OFFSET(0x6338E20)
#define NPCCROWD_AI_WPGRAPHRUNTIME_TRYGETPATH_OFFSET UNITYSDK_OFFSET(0x6339460)
#define NPCCROWD_AI_WPGRAPHRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x6338240)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WPGraphRuntime_TypeDefinitionIndex = 37701;

	class WPGraphRuntime : public ::System::Object
	{
	public:
		::Il2CppArray<::NPCCrowd::AI::FPathRuntime>* paths; // 0x10
		::NPCCrowd::AI::WPGraphDataStateAssetSO* wpGraphStateCfg; // 0x18
		::NPCCrowd::AI::WPPathSetting* graphPathSetting; // 0x20
		...
		::Il2CppArray<::System::UInt16>* nodeIds; // 0x48
		::Il2CppArray<::NPCCrowd::AI::NodeCaluateMemory*>* nodeCalMemory; // 0x50
