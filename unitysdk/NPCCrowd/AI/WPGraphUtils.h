...
#define NPCCROWD_AI_WPGRAPHUTILS_CHECKISFORWARD_OFFSET UNITYSDK_OFFSET(0x69FF3C0)
#define NPCCROWD_AI_WPGRAPHUTILS_GETARANDOMNODEWAY_OFFSET UNITYSDK_OFFSET(0x69FF530)
#define NPCCROWD_AI_WPGRAPHUTILS_GETNODEPOSITIONWITHOFFSET_1_OFFSET UNITYSDK_OFFSET(0x69FFD70)
#define NPCCROWD_AI_WPGRAPHUTILS_GETNODEPOSITIONWITHOFFSET_2_OFFSET UNITYSDK_OFFSET(0x69FFF30)
#define NPCCROWD_AI_WPGRAPHUTILS_GETNODEPOSITIONWITHOFFSET_3_OFFSET UNITYSDK_OFFSET(0x69FFB70)
#define NPCCROWD_AI_WPGRAPHUTILS_GETNODEPOSITIONWITHOFFSET_OFFSET UNITYSDK_OFFSET(0x69FF9B0)
#define NPCCROWD_AI_WPGRAPHUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x6A000E0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WPGraphUtils_TypeDefinitionIndex = 74461;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(WPGraphUtils_TypeDefinitionIndex)->GetStaticField(0xA3F0);
		}
