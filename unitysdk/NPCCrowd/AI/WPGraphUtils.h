...
#define NPCCROWD_AI_WPGRAPHUTILS_CHECKISFORWARD_OFFSET UNITYSDK_OFFSET(0x63F62D0)
#define NPCCROWD_AI_WPGRAPHUTILS_GETARANDOMNODEWAY_OFFSET UNITYSDK_OFFSET(0x63F6440)
#define NPCCROWD_AI_WPGRAPHUTILS_GETNODEPOSITIONWITHOFFSET_1_OFFSET UNITYSDK_OFFSET(0x63F6C80)
#define NPCCROWD_AI_WPGRAPHUTILS_GETNODEPOSITIONWITHOFFSET_2_OFFSET UNITYSDK_OFFSET(0x63F6E40)
#define NPCCROWD_AI_WPGRAPHUTILS_GETNODEPOSITIONWITHOFFSET_3_OFFSET UNITYSDK_OFFSET(0x63F6A80)
#define NPCCROWD_AI_WPGRAPHUTILS_GETNODEPOSITIONWITHOFFSET_OFFSET UNITYSDK_OFFSET(0x63F68C0)
#define NPCCROWD_AI_WPGRAPHUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x63F6FF0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WPGraphUtils_TypeDefinitionIndex = 69704;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(WPGraphUtils_TypeDefinitionIndex)->GetStaticField(0xAA40);
		}
