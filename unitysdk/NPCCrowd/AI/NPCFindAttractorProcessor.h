...
#define NPCCROWD_AI_NPCFINDATTRACTORPROCESSOR_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x69D6660)
#define NPCCROWD_AI_NPCFINDATTRACTORPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x69D58F0)
#define NPCCROWD_AI_NPCFINDATTRACTORPROCESSOR_RETURNTOINITSTATE_OFFSET UNITYSDK_OFFSET(0x69D5770)
#define NPCCROWD_AI_NPCFINDATTRACTORPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x69D6880)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCFindAttractorProcessor_TypeDefinitionIndex = 48603;
