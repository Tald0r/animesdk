...
#define NPCCROWD_AI_NPCFINDATTRACTORPROCESSOR_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x6015690)
#define NPCCROWD_AI_NPCFINDATTRACTORPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x6014910)
#define NPCCROWD_AI_NPCFINDATTRACTORPROCESSOR_RETURNTOINITSTATE_OFFSET UNITYSDK_OFFSET(0x6014790)
#define NPCCROWD_AI_NPCFINDATTRACTORPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x60158A0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCFindAttractorProcessor_TypeDefinitionIndex = 51951;
