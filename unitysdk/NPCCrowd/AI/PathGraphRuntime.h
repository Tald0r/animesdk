...
#define NPCCROWD_AI_PATHGRAPHRUNTIME_CLEARNODES_OFFSET UNITYSDK_OFFSET(0x76C35A0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_CLEARPATHFINDING_OFFSET UNITYSDK_OFFSET(0x76C3790)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x76C3460)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_FINDPATH_1_OFFSET UNITYSDK_OFFSET(0x76C3E90)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_FINDPATH_OFFSET UNITYSDK_OFFSET(0x76C3C80)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_GETNODE_OFFSET UNITYSDK_OFFSET(0x76C2C30)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_INITNODES_OFFSET UNITYSDK_OFFSET(0x76C2DB0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_INITPATHFINDING_OFFSET UNITYSDK_OFFSET(0x76C3310)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x76C2D40)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_REFRESH_OFFSET UNITYSDK_OFFSET(0x76C3810)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_SETPATHGRAPHSTATE_OFFSET UNITYSDK_OFFSET(0x76C3C10)
#define NPCCROWD_AI_PATHGRAPHRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x76C4140)
#define NPCCROWD_AI_PATHGRAPHRUNTIME__FINDPATH_B__15_0_OFFSET UNITYSDK_OFFSET(0x76C41D0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME__FINDPATH_B__16_0_OFFSET UNITYSDK_OFFSET(0x76C42B0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphRuntime_TypeDefinitionIndex = 39503;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::AI::PathGraphNodeRuntime*>* _nodeDictionary; // 0x30
