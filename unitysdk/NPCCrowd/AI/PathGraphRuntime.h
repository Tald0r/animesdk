...
#define NPCCROWD_AI_PATHGRAPHRUNTIME_CLEARNODES_OFFSET UNITYSDK_OFFSET(0xA0FC740)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_CLEARPATHFINDING_OFFSET UNITYSDK_OFFSET(0xA0FC930)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0xA0FC600)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_FINDPATH_1_OFFSET UNITYSDK_OFFSET(0xA0FD030)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_FINDPATH_OFFSET UNITYSDK_OFFSET(0xA0FCE20)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_GETNODE_OFFSET UNITYSDK_OFFSET(0xA0FBDD0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_INITNODES_OFFSET UNITYSDK_OFFSET(0xA0FBF50)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_INITPATHFINDING_OFFSET UNITYSDK_OFFSET(0xA0FC4B0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0xA0FBEE0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_REFRESH_OFFSET UNITYSDK_OFFSET(0xA0FC9B0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME_SETPATHGRAPHSTATE_OFFSET UNITYSDK_OFFSET(0xA0FCDB0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xA0FD2E0)
#define NPCCROWD_AI_PATHGRAPHRUNTIME__FINDPATH_B__15_0_OFFSET UNITYSDK_OFFSET(0xA0FD370)
#define NPCCROWD_AI_PATHGRAPHRUNTIME__FINDPATH_B__16_0_OFFSET UNITYSDK_OFFSET(0xA0FD450)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphRuntime_TypeDefinitionIndex = 67728;

	class PathGraphRuntime : public ::System::Object
	{
	public:
		::NPCCrowd::AI::PathGraphConfig* Config; // 0x10
		::NPCCrowd::AI::PathFindingGraph* _pathFindingGraph; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::AI::PathGraphNodeRuntime*>* _nodeDictionary; // 0x20
		::NPCCrowd::AI::PathGraphStateRuntime* _stateRuntime; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::AI::PathGraphRuntime_PathFindingResult*>* _pathCache; // 0x30
