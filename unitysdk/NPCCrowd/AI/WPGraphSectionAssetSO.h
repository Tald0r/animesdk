...
#define NPCCROWD_AI_WPGRAPHSECTIONASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x7640290)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WPGraphSectionAssetSO_TypeDefinitionIndex = 58433;
