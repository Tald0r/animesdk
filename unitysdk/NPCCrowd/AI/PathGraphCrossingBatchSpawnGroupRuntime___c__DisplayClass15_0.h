...
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME___C__DISPLAYCLASS15_0__BATCHSTARTMOVING_B__0_OFFSET UNITYSDK_OFFSET(0x6486070)
#define NPCCROWD_AI_PATHGRAPHCROSSINGBATCHSPAWNGROUPRUNTIME___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x6486060)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphCrossingBatchSpawnGroupRuntime___c__DisplayClass15_0_TypeDefinitionIndex = 40857;
