...
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_CHECKPATHFINDINGRESULT_OFFSET UNITYSDK_OFFSET(0x694C320)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x694B740)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_GETSPAWNEDNPCCOUNT_OFFSET UNITYSDK_OFFSET(0x694B880)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_GETTIME_OFFSET UNITYSDK_OFFSET(0x694C450)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x694B6E0)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_RANDRANGE_1_OFFSET UNITYSDK_OFFSET(0x694C540)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_RANDRANGE_OFFSET UNITYSDK_OFFSET(0x694C4B0)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_REMOVECROWDNPC_OFFSET UNITYSDK_OFFSET(0x694BC60)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_SETENABLED_OFFSET UNITYSDK_OFFSET(0x694B810)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_SPAWNCROWDNPC_OFFSET UNITYSDK_OFFSET(0x694B930)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_STARTPATHFOLLOW_OFFSET UNITYSDK_OFFSET(0x694BDA0)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_UPDATE_OFFSET UNITYSDK_OFFSET(0x694B7A0)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x694C5B0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSpawnGroupRuntime_TypeDefinitionIndex = 60773;
	...
	public:
		...
		::System::Collections::Generic::List_1<::NPCCrowd::AI::PathGraphFeaturePointRuntime*>* FeaturePointRuntimeList; // 0x18
