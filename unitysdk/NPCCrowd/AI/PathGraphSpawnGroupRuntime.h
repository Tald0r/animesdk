...
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_CHECKPATHFINDINGRESULT_OFFSET UNITYSDK_OFFSET(0x62CFA60)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x62CEE80)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_GETSPAWNEDNPCCOUNT_OFFSET UNITYSDK_OFFSET(0x62CEFC0)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_GETTIME_OFFSET UNITYSDK_OFFSET(0x62CFB90)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x62CEE20)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_RANDRANGE_1_OFFSET UNITYSDK_OFFSET(0x62CFC80)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_RANDRANGE_OFFSET UNITYSDK_OFFSET(0x62CFBF0)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_REMOVECROWDNPC_OFFSET UNITYSDK_OFFSET(0x62CF3A0)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_SETENABLED_OFFSET UNITYSDK_OFFSET(0x62CEF50)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_SPAWNCROWDNPC_OFFSET UNITYSDK_OFFSET(0x62CF070)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_STARTPATHFOLLOW_OFFSET UNITYSDK_OFFSET(0x62CF4E0)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME_UPDATE_OFFSET UNITYSDK_OFFSET(0x62CEEE0)
#define NPCCROWD_AI_PATHGRAPHSPAWNGROUPRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x62CFCF0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSpawnGroupRuntime_TypeDefinitionIndex = 52488;
	...
	public:
		...
		::NPCCrowd::AI::PathGraphSpawnGroupConfig* Config; // 0x18
		::System::Collections::Generic::List_1<::NPCCrowd::AI::PathGraphFeaturePointPathConfig*>* FeaturePointPathConfigList; // 0x20
		::System::Collections::Generic::List_1<::NPCCrowd::AI::PathGraphFeaturePointV2Config*>* FeaturePointConfigList; // 0x28
