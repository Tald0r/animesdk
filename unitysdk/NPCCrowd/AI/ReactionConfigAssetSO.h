...
#define NPCCROWD_AI_REACTIONCONFIGASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x861F4C0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int ReactionConfigAssetSO_TypeDefinitionIndex = 48052;
