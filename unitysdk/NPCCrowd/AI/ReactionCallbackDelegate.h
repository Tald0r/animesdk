...
#define NPCCROWD_AI_REACTIONCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x6018950)
#define NPCCROWD_AI_REACTIONCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x60189C0)
#define NPCCROWD_AI_REACTIONCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x6018610)
#define NPCCROWD_AI_REACTIONCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x6018600)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int ReactionCallbackDelegate_TypeDefinitionIndex = 71483;
