...
#define NPCCROWD_AI_REACTIONCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x69D9970)
#define NPCCROWD_AI_REACTIONCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x69D99E0)
#define NPCCROWD_AI_REACTIONCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x69D9630)
#define NPCCROWD_AI_REACTIONCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x69D9610)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int ReactionCallbackDelegate_TypeDefinitionIndex = 63196;
