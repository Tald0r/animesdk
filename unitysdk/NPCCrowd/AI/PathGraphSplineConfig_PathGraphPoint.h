...
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_PATHGRAPHPOINT_DEEPCOPY_OFFSET UNITYSDK_OFFSET(0xA0FD4E0)
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_PATHGRAPHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xA0FD5D0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineConfig_PathGraphPoint_TypeDefinitionIndex = 74091;
