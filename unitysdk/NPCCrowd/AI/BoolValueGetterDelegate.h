...
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x76C1150)
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x76C1180)
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x76C0EB0)
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x76C0E90)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int BoolValueGetterDelegate_TypeDefinitionIndex = 41084;
