...
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA0FA2F0)
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA0FA320)
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA0FA050)
#define NPCCROWD_AI_BOOLVALUEGETTERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xA0FA040)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int BoolValueGetterDelegate_TypeDefinitionIndex = 63846;
