...
#define NPCCROWD_AI_PATHGRAPHCONNECTORCONFIG_PATHGRAPHCONNECTION_GET_ENDNODEINDEX_OFFSET UNITYSDK_OFFSET(0x7578490)
#define NPCCROWD_AI_PATHGRAPHCONNECTORCONFIG_PATHGRAPHCONNECTION_GET_STARTNODEINDEX_OFFSET UNITYSDK_OFFSET(0x7578480)
#define NPCCROWD_AI_PATHGRAPHCONNECTORCONFIG_PATHGRAPHCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x75784A0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphConnectorConfig_PathGraphConnection_TypeDefinitionIndex = 38400;
