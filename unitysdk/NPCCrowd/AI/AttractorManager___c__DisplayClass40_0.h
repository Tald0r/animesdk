...
#define NPCCROWD_AI_ATTRACTORMANAGER___C__DISPLAYCLASS40_0__CTOR_OFFSET UNITYSDK_OFFSET(0x688F6F0)
#define NPCCROWD_AI_ATTRACTORMANAGER___C__DISPLAYCLASS40_0__INITHANDLECONFLICT_B__1_OFFSET UNITYSDK_OFFSET(0x688F700)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorManager___c__DisplayClass40_0_TypeDefinitionIndex = 77306;
