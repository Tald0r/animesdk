...
#define NPCCROWD_AI_EVENTSTIMULUSITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x861D7E0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int EventStimulusItem_TypeDefinitionIndex = 77581;
