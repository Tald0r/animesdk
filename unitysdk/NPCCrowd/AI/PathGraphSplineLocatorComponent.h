...
#define NPCCROWD_AI_PATHGRAPHSPLINELOCATORCOMPONENT_GET_NEARESTSPLINENODEINDEX_OFFSET UNITYSDK_OFFSET(0x5DF7B00)
#define NPCCROWD_AI_PATHGRAPHSPLINELOCATORCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x5DF7B10)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineLocatorComponent_TypeDefinitionIndex = 61412;
