...
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR_EXECUTEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x2F3E50)
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR_EXECUTEJOB_FINDCLOSESTENTITYBYTAG_OFFSET UNITYSDK_OFFSET(0x2F3E60)
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR_EXECUTEJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x2F3E40)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorQueryEntityProcessor_ExecuteJob_TypeDefinitionIndex = 79232;
