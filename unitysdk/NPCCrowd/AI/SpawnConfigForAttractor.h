...
#define NPCCROWD_AI_SPAWNCONFIGFORATTRACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x77ECFB0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int SpawnConfigForAttractor_TypeDefinitionIndex = 51129;
