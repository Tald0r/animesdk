...
#define NPCCROWD_AI_ATTRACTORTEMPLATEASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x6B9D560)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorTemplateAssetSO_TypeDefinitionIndex = 75975;
