...
#define NPCCROWD_AI_AIACTIONRANDOMCHATCONFIG_GETBASEACTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x34F3E0)
#define NPCCROWD_AI_AIACTIONRANDOMCHATCONFIG_ISMULTITHREAD_OFFSET UNITYSDK_OFFSET(0x34F450)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionRandomChatConfig_TypeDefinitionIndex = 75550;
