...
#define NPCCROWD_AI_AIACTIONRANDOMCHATCONFIG_GETBASEACTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x2D4200)
#define NPCCROWD_AI_AIACTIONRANDOMCHATCONFIG_ISMULTITHREAD_OFFSET UNITYSDK_OFFSET(0x2D4270)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionRandomChatConfig_TypeDefinitionIndex = 39495;
