...
#define NPCCROWD_AI_CONDITIONACTIONITEM_CHECKCONDITIONS_OFFSET UNITYSDK_OFFSET(0x2D4300)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int ConditionActionItem_TypeDefinitionIndex = 69795;
