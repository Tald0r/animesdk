...
#define NPCCROWD_AI_CONDITIONACTIONITEM_CHECKCONDITIONS_OFFSET UNITYSDK_OFFSET(0x34F4E0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int ConditionActionItem_TypeDefinitionIndex = 78453;
