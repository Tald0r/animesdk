...
#define NPCCROWD_AI_PATHGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC2E5590)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphConfig_TypeDefinitionIndex = 54485;
