...
#define NPCCROWD_AI_PATHGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA0DD130)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphConfig_TypeDefinitionIndex = 77309;
