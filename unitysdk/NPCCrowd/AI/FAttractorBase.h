...
#define NPCCROWD_AI_FATTRACTORBASE_GETENABLE_OFFSET UNITYSDK_OFFSET(0x3202D0)
#define NPCCROWD_AI_FATTRACTORBASE_QUERYENABLE_OFFSET UNITYSDK_OFFSET(0x320340)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int FAttractorBase_TypeDefinitionIndex = 65758;
