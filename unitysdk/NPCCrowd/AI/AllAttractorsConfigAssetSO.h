...
#define NPCCROWD_AI_ALLATTRACTORSCONFIGASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x7439060)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AllAttractorsConfigAssetSO_TypeDefinitionIndex = 40613;
