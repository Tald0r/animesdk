...
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_CHECKGRAPHLIMIT_OFFSET UNITYSDK_OFFSET(0xA0DE870)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_CHECKGROUPLIMIT_OFFSET UNITYSDK_OFFSET(0xA0DE0A0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0xA0DD770)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_GETLANEINDEXHALFWAY_OFFSET UNITYSDK_OFFSET(0x77C7A20)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_GETSPAWNEDNPCCOUNT_OFFSET UNITYSDK_OFFSET(0xA0DDF10)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xA0DD310)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0xA0DD380)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_RANDOMPATHINLIST_OFFSET UNITYSDK_OFFSET(0xA0DE190)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_RANDOMSPAWNPOINTINPATHLIST_OFFSET UNITYSDK_OFFSET(0xA0DEC10)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_SPAWNIMMEDIATELYFORPATH_OFFSET UNITYSDK_OFFSET(0x77C77C0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_SPAWNINITIALNPC_OFFSET UNITYSDK_OFFSET(0xA0DED70)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_SPAWNTAG_OFFSET UNITYSDK_OFFSET(0xA0DEA70)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_TRYREMOVENPC_OFFSET UNITYSDK_OFFSET(0xA0DDB20)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_TRYSPAWNNPC_OFFSET UNITYSDK_OFFSET(0xA0DDD50)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_UPDATE_OFFSET UNITYSDK_OFFSET(0xA0DDA90)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x77C7C90)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME__INIT_B__7_0_OFFSET UNITYSDK_OFFSET(0x77C7CA0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME__INIT_B__7_1_OFFSET UNITYSDK_OFFSET(0x77C7D80)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x77C7EA0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___BASE_GETSPAWNEDNPCCOUNT_OFFSET UNITYSDK_OFFSET(0x77C7F00)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x77C7F10)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x77C7F70)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphGuidePointPathSpawnGroupRuntime_TypeDefinitionIndex = 79007;
	...
	public:
		...
		::System::Collections::Generic::List_1<::NPCCrowd::AI::PathGraphSpawnPointComponentRuntime*>* _pathSpawnPointList; // 0x58
