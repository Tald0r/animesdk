...
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_CHECKGRAPHLIMIT_OFFSET UNITYSDK_OFFSET(0xC2E6CD0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_CHECKGROUPLIMIT_OFFSET UNITYSDK_OFFSET(0xC2E6500)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0xC2E5BD0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_GETLANEINDEXHALFWAY_OFFSET UNITYSDK_OFFSET(0xC2E7BA0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_GETSPAWNEDNPCCOUNT_OFFSET UNITYSDK_OFFSET(0xC2E6370)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xC2E5770)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0xC2E57E0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_RANDOMPATHINLIST_OFFSET UNITYSDK_OFFSET(0xC2E65F0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_RANDOMSPAWNPOINTINPATHLIST_OFFSET UNITYSDK_OFFSET(0xC2E7070)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_SPAWNIMMEDIATELYFORPATH_OFFSET UNITYSDK_OFFSET(0xC2E7940)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_SPAWNINITIALNPC_OFFSET UNITYSDK_OFFSET(0xC2E71D0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_SPAWNTAG_OFFSET UNITYSDK_OFFSET(0xC2E6ED0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_TRYREMOVENPC_OFFSET UNITYSDK_OFFSET(0xC2E5F80)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_TRYSPAWNNPC_OFFSET UNITYSDK_OFFSET(0xC2E61B0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME_UPDATE_OFFSET UNITYSDK_OFFSET(0xC2E5EF0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xC2E7E10)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME__INIT_B__7_0_OFFSET UNITYSDK_OFFSET(0xC2E7E20)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME__INIT_B__7_1_OFFSET UNITYSDK_OFFSET(0xC2E7F00)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0xC2E8020)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___BASE_GETSPAWNEDNPCCOUNT_OFFSET UNITYSDK_OFFSET(0xC2E8080)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0xC2E8090)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xC2E80F0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphGuidePointPathSpawnGroupRuntime_TypeDefinitionIndex = 63040;

	class PathGraphGuidePointPathSpawnGroupRuntime : public ::NPCCrowd::AI::PathGraphSpawnGroupRuntime
	{
	public:
		::System::Collections::Generic::List_1<::NPCCrowd::AI::PathGraphGuidePointPathSpawnGroupRuntime_SpawnedNpcInfo*>* _spawnedNpcList; // 0x40
		::System::Collections::Generic::List_1<::NPCCrowd::AI::PathGraphSpawnPointComponentRuntime*>* _pathSpawnPointList; // 0x48
		::NPCCrowd::AI::PopulationRuntime* _populationRuntime; // 0x50
