...
#define NPCCROWD_AI_WPGRAPHDATASTATEASSETSO___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x5DF7B30)
#define NPCCROWD_AI_WPGRAPHDATASTATEASSETSO___C__CTOR_OFFSET UNITYSDK_OFFSET(0x5DF7B70)
#define NPCCROWD_AI_WPGRAPHDATASTATEASSETSO___C__REFRESH_B__6_0_OFFSET UNITYSDK_OFFSET(0x5DF7B80)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WPGraphDataStateAssetSO___c_TypeDefinitionIndex = 43107;
	...
	public:
		...
		{
			return (::NPCCrowd::AI::WPGraphDataStateAssetSO___c**)Il2CppClass::FromTypeDefinitionIndex(WPGraphDataStateAssetSO___c_TypeDefinitionIndex)->GetStaticField(0x44240);
		}
		static ::System::Comparison_1<::NPCCrowd::AI::WPGraphDataStateAssetSO_WPGraphDataState*>** StaticGet___9__6_0()
		{
			return (::System::Comparison_1<::NPCCrowd::AI::WPGraphDataStateAssetSO_WPGraphDataState*>**)Il2CppClass::FromTypeDefinitionIndex(WPGraphDataStateAssetSO___c_TypeDefinitionIndex)->GetStaticField(0x44248);
		}
