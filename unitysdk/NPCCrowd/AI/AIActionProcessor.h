...
#define NPCCROWD_AI_AIACTIONPROCESSOR_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x721F030)
#define NPCCROWD_AI_AIACTIONPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x721E5D0)
#define NPCCROWD_AI_AIACTIONPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x721F2C0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionProcessor_TypeDefinitionIndex = 63016;
