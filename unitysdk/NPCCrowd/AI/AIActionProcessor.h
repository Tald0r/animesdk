...
#define NPCCROWD_AI_AIACTIONPROCESSOR_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x9AF3A20)
#define NPCCROWD_AI_AIACTIONPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x9AF2FC0)
#define NPCCROWD_AI_AIACTIONPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9AF3CB0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionProcessor_TypeDefinitionIndex = 40532;
