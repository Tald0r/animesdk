...
#define NPCCROWD_AI_AIACTIONDELAYDESTROYCONFIG_GETBASEACTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x30FE80)
#define NPCCROWD_AI_AIACTIONDELAYDESTROYCONFIG_ISMULTITHREAD_OFFSET UNITYSDK_OFFSET(0x30FEF0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionDelayDestroyConfig_TypeDefinitionIndex = 46819;
