...
#define NPCCROWD_AI_AIACTIONDELAYDESTROYCONFIG_GETBASEACTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x2C9210)
#define NPCCROWD_AI_AIACTIONDELAYDESTROYCONFIG_ISMULTITHREAD_OFFSET UNITYSDK_OFFSET(0x2C9280)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionDelayDestroyConfig_TypeDefinitionIndex = 74759;
