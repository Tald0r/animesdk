...
#define NPCCROWD_AI_PATHGRAPHSPLINELISTPAIRLOCATORCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x7578510)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineListPairLocatorComponent_TypeDefinitionIndex = 39268;
