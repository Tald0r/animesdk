...
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x783CF20)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x783CE70)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME_PAIRITEMSFROMTWOLISTSRANDOMLYKEEPINGORDER_OFFSET UNITYSDK_OFFSET(0x783D270)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME_SPAWNBATCH_OFFSET UNITYSDK_OFFSET(0x783CF90)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x783D580)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x783D590)
#define NPCCROWD_AI_PATHGRAPHBATCHSPAWNPOINTCOMPONENTRUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x783D5F0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphBatchSpawnPointComponentRuntime_TypeDefinitionIndex = 65413;
