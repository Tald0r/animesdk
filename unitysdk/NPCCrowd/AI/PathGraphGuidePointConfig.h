...
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9361910)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphGuidePointConfig_TypeDefinitionIndex = 58553;
