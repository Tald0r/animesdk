...
#define NPCCROWD_AI_FLOATVALUEGETTERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x7439860)
#define NPCCROWD_AI_FLOATVALUEGETTERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x7439890)
#define NPCCROWD_AI_FLOATVALUEGETTERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x74395C0)
#define NPCCROWD_AI_FLOATVALUEGETTERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x74395B0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int FloatValueGetterDelegate_TypeDefinitionIndex = 75416;
