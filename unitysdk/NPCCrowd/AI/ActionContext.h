...
#define NPCCROWD_AI_ACTIONCONTEXT_SETFORCEEXIT_OFFSET UNITYSDK_OFFSET(0x2D7A30)
#define NPCCROWD_AI_ACTIONCONTEXT_SETJOBDATA_OFFSET UNITYSDK_OFFSET(0x2D7B10)
#define NPCCROWD_AI_ACTIONCONTEXT_SETSTATE_OFFSET UNITYSDK_OFFSET(0x2D7AA0)
#define NPCCROWD_AI_ACTIONCONTEXT_SETTIMECONTROL_OFFSET UNITYSDK_OFFSET(0x2D7BD0)
#define NPCCROWD_AI_ACTIONCONTEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0x2D7C40)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int ActionContext_TypeDefinitionIndex = 44934;
