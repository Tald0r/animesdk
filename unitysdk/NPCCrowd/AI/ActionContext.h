...
#define NPCCROWD_AI_ACTIONCONTEXT_SETFORCEEXIT_OFFSET UNITYSDK_OFFSET(0x304280)
#define NPCCROWD_AI_ACTIONCONTEXT_SETJOBDATA_OFFSET UNITYSDK_OFFSET(0x304360)
#define NPCCROWD_AI_ACTIONCONTEXT_SETSTATE_OFFSET UNITYSDK_OFFSET(0x3042F0)
#define NPCCROWD_AI_ACTIONCONTEXT_SETTIMECONTROL_OFFSET UNITYSDK_OFFSET(0x304420)
#define NPCCROWD_AI_ACTIONCONTEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0x304490)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int ActionContext_TypeDefinitionIndex = 70614;
