...
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x63371A0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_ENABLESPAWN_OFFSET UNITYSDK_OFFSET(0x6337450)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_GET_ISIDLE_OFFSET UNITYSDK_OFFSET(0x63374C0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x6337050)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_ISINAVATARDISTANCERANGE_OFFSET UNITYSDK_OFFSET(0x63379D0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_ISINMAINCAMERAFRUSTUM_OFFSET UNITYSDK_OFFSET(0x6337BA0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_PROCESSLIMITCONDITIONS_OFFSET UNITYSDK_OFFSET(0x6337670)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_REMOVESPAWNEDNPC_OFFSET UNITYSDK_OFFSET(0x6337950)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_SPAWNIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x63377A0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_SPAWNQUEUED_OFFSET UNITYSDK_OFFSET(0x6337530)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_UPDATESPAWNQUEUE_OFFSET UNITYSDK_OFFSET(0x6337330)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME_UPDATE_OFFSET UNITYSDK_OFFSET(0x63372B0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x6337C80)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x6337CC0)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x6337D20)
#define NPCCROWD_AI_PATHGRAPHSPAWNPOINTCOMPONENTRUNTIME___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x6337D80)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSpawnPointComponentRuntime_TypeDefinitionIndex = 74888;
	...
	public:
		...
		::NPCCrowd::AI::PathGraphSpawnPointComponent* _config; // 0x20
		::System::Collections::Generic::List_1<::System::Int32>* _spawnedTags; // 0x28
		::System::Collections::Generic::Queue_1<::NPCCrowd::AI::PathGraphSpawnPointComponentRuntime_SpawnAction*>* _spawnQueue; // 0x30
		::System::Single _leftTimeToSpawn; // 0x38
		::System::Boolean _enableSpawn; // 0x3C
