...
#define NPCCROWD_AI_WPGRAPHDATASTATEASSETSO_GETSTATEBYID_OFFSET UNITYSDK_OFFSET(0x9AF9590)
#define NPCCROWD_AI_WPGRAPHDATASTATEASSETSO_REFRESH_OFFSET UNITYSDK_OFFSET(0x9AF9400)
#define NPCCROWD_AI_WPGRAPHDATASTATEASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x9AF93B0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WPGraphDataStateAssetSO_TypeDefinitionIndex = 52339;
