...
#define NPCCROWD_AI_WPGRAPHDATASTATEASSETSO_GETSTATEBYID_OFFSET UNITYSDK_OFFSET(0x7224BC0)
#define NPCCROWD_AI_WPGRAPHDATASTATEASSETSO_REFRESH_OFFSET UNITYSDK_OFFSET(0x7224A30)
#define NPCCROWD_AI_WPGRAPHDATASTATEASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x72249E0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WPGraphDataStateAssetSO_TypeDefinitionIndex = 43105;
