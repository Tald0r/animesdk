...
#define NPCCROWD_AI_AIACTIONSIMPLEMOVETOCONFIG_GETBASEACTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x2CB6F0)
#define NPCCROWD_AI_AIACTIONSIMPLEMOVETOCONFIG_ISMULTITHREAD_OFFSET UNITYSDK_OFFSET(0x2CB760)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionSimpleMoveToConfig_TypeDefinitionIndex = 78412;
