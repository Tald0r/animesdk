...
#define NPCCROWD_AI_PATHGRAPHCONNECTORNODERUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x6511330)
#define NPCCROWD_AI_PATHGRAPHCONNECTORNODERUNTIME_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0x6511410)
#define NPCCROWD_AI_PATHGRAPHCONNECTORNODERUNTIME_GETNEXTSPLINELANEINDEX_OFFSET UNITYSDK_OFFSET(0x6511500)
#define NPCCROWD_AI_PATHGRAPHCONNECTORNODERUNTIME_GETRANDOMNEXTNODELANE_OFFSET UNITYSDK_OFFSET(0x6511990)
#define NPCCROWD_AI_PATHGRAPHCONNECTORNODERUNTIME_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x6511260)
#define NPCCROWD_AI_PATHGRAPHCONNECTORNODERUNTIME_GET_HEURISTICPOSITION_OFFSET UNITYSDK_OFFSET(0x6511390)
#define NPCCROWD_AI_PATHGRAPHCONNECTORNODERUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x65112D0)
#define NPCCROWD_AI_PATHGRAPHCONNECTORNODERUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x6512430)
#define NPCCROWD_AI_PATHGRAPHCONNECTORNODERUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x6512440)
#define NPCCROWD_AI_PATHGRAPHCONNECTORNODERUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x65124A0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphConnectorNodeRuntime_TypeDefinitionIndex = 64217;
