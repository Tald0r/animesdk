...
#define NPCCROWD_AI_ATTRACTORTEMPLATEREFITEM_SETATTRACTORID_OFFSET UNITYSDK_OFFSET(0x33C370)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorTemplateRefItem_TypeDefinitionIndex = 48013;
