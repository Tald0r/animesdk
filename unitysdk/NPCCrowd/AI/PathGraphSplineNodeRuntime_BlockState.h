...
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_BLOCKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x6B3C300)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineNodeRuntime_BlockState_TypeDefinitionIndex = 66726;
