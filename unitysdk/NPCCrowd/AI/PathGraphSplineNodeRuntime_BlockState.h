...
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_BLOCKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x77ECEA0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineNodeRuntime_BlockState_TypeDefinitionIndex = 46461;
