...
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x9360EB0)
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR_GETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0x9360CC0)
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x93610A0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorQueryEntityProcessor_TypeDefinitionIndex = 61807;
