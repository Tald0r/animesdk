...
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x783CBF0)
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR_GETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0x783CAF0)
#define NPCCROWD_AI_ATTRACTORQUERYENTITYPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x783CDE0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorQueryEntityProcessor_TypeDefinitionIndex = 79231;
