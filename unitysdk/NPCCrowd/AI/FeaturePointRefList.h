...
#define NPCCROWD_AI_FEATUREPOINTREFLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x6F97C30)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int FeaturePointRefList_TypeDefinitionIndex = 62083;
