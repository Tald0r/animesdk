...
#define NPCCROWD_AI_NPCPOPULATIONCONFIGSO__CTOR_OFFSET UNITYSDK_OFFSET(0x72239D0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCPopulationConfigSO_TypeDefinitionIndex = 44769;
