...
#define NPCCROWD_AI_NPCPOPULATIONCONFIGSO__CTOR_OFFSET UNITYSDK_OFFSET(0x9AF83A0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCPopulationConfigSO_TypeDefinitionIndex = 45969;
