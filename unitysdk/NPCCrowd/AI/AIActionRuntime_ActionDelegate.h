...
#define NPCCROWD_AI_AIACTIONRUNTIME_ACTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x69D5530)
#define NPCCROWD_AI_AIACTIONRUNTIME_ACTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x69D55A0)
#define NPCCROWD_AI_AIACTIONRUNTIME_ACTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x69D51F0)
#define NPCCROWD_AI_AIACTIONRUNTIME_ACTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x69D51D0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionRuntime_ActionDelegate_TypeDefinitionIndex = 63282;
