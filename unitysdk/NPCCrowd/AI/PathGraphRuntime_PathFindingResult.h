...
#define NPCCROWD_AI_PATHGRAPHRUNTIME_PATHFINDINGRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x7DF2A50)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphRuntime_PathFindingResult_TypeDefinitionIndex = 67729;
