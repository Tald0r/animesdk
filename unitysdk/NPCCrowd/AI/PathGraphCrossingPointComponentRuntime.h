...
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x60178F0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME_GET_GM_SWITCHOFF_OFFSET UNITYSDK_OFFSET(0x60179D0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x60176C0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME_SETSWITCHOFF_OFFSET UNITYSDK_OFFSET(0x60179E0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x6018300)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME__SETSWITCHOFF_G__GETSTARTBLOCKSTATE_9_1_OFFSET UNITYSDK_OFFSET(0x60182E0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME__SETSWITCHOFF_G__GETSTOPBLOCKSTATE_9_0_OFFSET UNITYSDK_OFFSET(0x60182C0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x6018310)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x6018370)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphCrossingPointComponentRuntime_TypeDefinitionIndex = 62129;
	...
	public:
		...
		::NPCCrowd::Ability::InteractWaitingSlot* _waitingSlot; // 0x28
		::System::Collections::Generic::List_1<::NPCCrowd::AI::PathGraphSplineLocatorComponent*>* _toLocators; // 0x30
