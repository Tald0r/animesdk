...
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x69D88F0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME_GET_GM_SWITCHOFF_OFFSET UNITYSDK_OFFSET(0x69D89D0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x69D86D0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME_SETSWITCHOFF_OFFSET UNITYSDK_OFFSET(0x69D89E0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x69D9310)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME__SETSWITCHOFF_G__GETSTARTBLOCKSTATE_9_1_OFFSET UNITYSDK_OFFSET(0x69D92F0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME__SETSWITCHOFF_G__GETSTOPBLOCKSTATE_9_0_OFFSET UNITYSDK_OFFSET(0x69D92D0)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x69D9320)
#define NPCCROWD_AI_PATHGRAPHCROSSINGPOINTCOMPONENTRUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x69D9380)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphCrossingPointComponentRuntime_TypeDefinitionIndex = 53188;

	class PathGraphCrossingPointComponentRuntime : public ::NPCCrowd::AI::PathGraphFeaturePointComponentRuntime
	{
	public:
		::NPCCrowd::Ability::InteractWaitingSlot* _waitingSlot; // 0x18
		...
		::NPCCrowd::AI::PathGraphCrossingPointComponent* _config; // 0x30
