...
#define NPCCROWD_AI_REACTIONCONFIGASSETSO_REACTIONCONFIGASSETSO_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x763FBB0)
#define NPCCROWD_AI_REACTIONCONFIGASSETSO_REACTIONCONFIGASSETSO_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x763FBC0)
#define NPCCROWD_AI_REACTIONCONFIGASSETSO_REACTIONCONFIGASSETSO_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x763FDC0)
#define NPCCROWD_AI_REACTIONCONFIGASSETSO_REACTIONCONFIGASSETSO_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x763FF80)
#define NPCCROWD_AI_REACTIONCONFIGASSETSO_REACTIONCONFIGASSETSO_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x763FF40)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int ReactionConfigAssetSO_ReactionConfigAssetSO_UnityGeneratedFormatter_TypeDefinitionIndex = 71034;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::NPCCrowd::AI::ReactionConfig>*>**)Il2CppClass::FromTypeDefinitionIndex(ReactionConfigAssetSO_ReactionConfigAssetSO_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x35090);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::NPCCrowd::AI::EventStimulusConfig>*>**)Il2CppClass::FromTypeDefinitionIndex(ReactionConfigAssetSO_ReactionConfigAssetSO_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x35098);
		}
