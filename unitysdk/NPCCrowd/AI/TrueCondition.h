...
#define NPCCROWD_AI_TRUECONDITION_CHECK_OFFSET UNITYSDK_OFFSET(0x7578590)
#define NPCCROWD_AI_TRUECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x7578580)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int TrueCondition_TypeDefinitionIndex = 66415;
