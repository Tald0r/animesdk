...
#define NPCCROWD_AI_AIACTIONPROCESSOR_JOBDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x30B960)
#define NPCCROWD_AI_AIACTIONPROCESSOR_JOBDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x30B7D0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionProcessor_JobData_TypeDefinitionIndex = 63017;
