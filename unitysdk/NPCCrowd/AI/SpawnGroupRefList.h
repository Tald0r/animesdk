...
#define NPCCROWD_AI_SPAWNGROUPREFLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x7EF0180)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int SpawnGroupRefList_TypeDefinitionIndex = 78277;
