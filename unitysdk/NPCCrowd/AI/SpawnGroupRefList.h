...
#define NPCCROWD_AI_SPAWNGROUPREFLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x6B9EB70)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int SpawnGroupRefList_TypeDefinitionIndex = 61502;
