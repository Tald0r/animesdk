...
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x76C2070)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___C__CTOR_OFFSET UNITYSDK_OFFSET(0x76C20B0)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___C__INIT_B__7_2_OFFSET UNITYSDK_OFFSET(0x76C20C0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphGuidePointPathSpawnGroupRuntime___c_TypeDefinitionIndex = 63041;
	...
	public:
		...
		{
			return (::NPCCrowd::AI::PathGraphGuidePointPathSpawnGroupRuntime___c**)Il2CppClass::FromTypeDefinitionIndex(PathGraphGuidePointPathSpawnGroupRuntime___c_TypeDefinitionIndex)->GetStaticField(0x46E90);
		}
		...
		{
			return (::System::Func_2<::NPCCrowd::AI::PathGraphFeaturePointRuntime*, ::NPCCrowd::AI::PathGraphSpawnPointComponentRuntime*>**)Il2CppClass::FromTypeDefinitionIndex(PathGraphGuidePointPathSpawnGroupRuntime___c_TypeDefinitionIndex)->GetStaticField(0x46E98);
		}
