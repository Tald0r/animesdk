...
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xA0FB210)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___C__CTOR_OFFSET UNITYSDK_OFFSET(0xA0FB250)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___C__INIT_B__7_2_OFFSET UNITYSDK_OFFSET(0xA0FB260)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphGuidePointPathSpawnGroupRuntime___c_TypeDefinitionIndex = 79010;
	...
	public:
		...
		{
			return (::NPCCrowd::AI::PathGraphGuidePointPathSpawnGroupRuntime___c**)Il2CppClass::FromTypeDefinitionIndex(PathGraphGuidePointPathSpawnGroupRuntime___c_TypeDefinitionIndex)->GetStaticField(0x404B0);
		}
		...
		{
			return (::System::Func_2<::NPCCrowd::AI::PathGraphFeaturePointRuntime*, ::NPCCrowd::AI::PathGraphSpawnPointComponentRuntime*>**)Il2CppClass::FromTypeDefinitionIndex(PathGraphGuidePointPathSpawnGroupRuntime___c_TypeDefinitionIndex)->GetStaticField(0x404B8);
		}
