...
#define NPCCROWD_AI_INTERACTEVENTSTIMULUSITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x69D5750)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int InteractEventStimulusItem_TypeDefinitionIndex = 50672;
