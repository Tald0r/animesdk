...
#define NPCCROWD_AI_PATHGRAPHSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x7DF2A70)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphStateConfig_TypeDefinitionIndex = 65916;
