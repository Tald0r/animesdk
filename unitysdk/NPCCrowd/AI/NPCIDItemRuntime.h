...
#define NPCCROWD_AI_NPCIDITEMRUNTIME_ADDITEM_OFFSET UNITYSDK_OFFSET(0x609B810)
#define NPCCROWD_AI_NPCIDITEMRUNTIME_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x609B7B0)
#define NPCCROWD_AI_NPCIDITEMRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x609B9B0)
#define NPCCROWD_AI_NPCIDITEMRUNTIME___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x609BA30)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCIDItemRuntime_TypeDefinitionIndex = 41246;
