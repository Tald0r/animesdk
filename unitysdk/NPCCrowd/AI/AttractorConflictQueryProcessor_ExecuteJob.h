...
#define NPCCROWD_AI_ATTRACTORCONFLICTQUERYPROCESSOR_EXECUTEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x33C340)
#define NPCCROWD_AI_ATTRACTORCONFLICTQUERYPROCESSOR_EXECUTEJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x33C330)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorConflictQueryProcessor_ExecuteJob_TypeDefinitionIndex = 66762;
