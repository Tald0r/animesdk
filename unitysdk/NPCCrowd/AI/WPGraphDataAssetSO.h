...
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_GETNODE_OFFSET UNITYSDK_OFFSET(0x7223E90)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_GETPATHBETWEEN_1_OFFSET UNITYSDK_OFFSET(0x7224210)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_GETPATHBETWEEN_OFFSET UNITYSDK_OFFSET(0x7224070)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_GETPATH_OFFSET UNITYSDK_OFFSET(0x7223F70)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_REGENERATEIDS_OFFSET UNITYSDK_OFFSET(0x72242B0)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x7223CB0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WPGraphDataAssetSO_TypeDefinitionIndex = 37606;
