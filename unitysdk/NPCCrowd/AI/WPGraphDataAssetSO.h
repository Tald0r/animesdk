...
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_GETNODE_OFFSET UNITYSDK_OFFSET(0x9AF8860)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_GETPATHBETWEEN_1_OFFSET UNITYSDK_OFFSET(0x9AF8BE0)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_GETPATHBETWEEN_OFFSET UNITYSDK_OFFSET(0x9AF8A40)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_GETPATH_OFFSET UNITYSDK_OFFSET(0x9AF8940)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO_REGENERATEIDS_OFFSET UNITYSDK_OFFSET(0x9AF8C80)
#define NPCCROWD_AI_WPGRAPHDATAASSETSO__CTOR_OFFSET UNITYSDK_OFFSET(0x9AF8680)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WPGraphDataAssetSO_TypeDefinitionIndex = 73967;
