...
#define NPCCROWD_AI_NPCIDITEM_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3C1200)
#define NPCCROWD_AI_NPCIDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x3C1270)
#define NPCCROWD_AI_NPCIDITEM___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3C1280)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCIDItem_TypeDefinitionIndex = 80514;
