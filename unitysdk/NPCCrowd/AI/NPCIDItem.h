...
#define NPCCROWD_AI_NPCIDITEM_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x37A5E0)
#define NPCCROWD_AI_NPCIDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x37A650)
#define NPCCROWD_AI_NPCIDITEM___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x37A660)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int NPCIDItem_TypeDefinitionIndex = 66072;
