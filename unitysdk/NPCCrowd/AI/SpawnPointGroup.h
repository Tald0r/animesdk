...
#define NPCCROWD_AI_SPAWNPOINTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x7EF0200)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int SpawnPointGroup_TypeDefinitionIndex = 36900;
