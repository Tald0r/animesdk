...
#define NPCCROWD_AI_POPULATIONRUNTIME___C__DISPLAYCLASS38_0__CTOR_OFFSET UNITYSDK_OFFSET(0x7578550)
#define NPCCROWD_AI_POPULATIONRUNTIME___C__DISPLAYCLASS38_0__INITIALIZE_B__0_OFFSET UNITYSDK_OFFSET(0x7578560)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PopulationRuntime___c__DisplayClass38_0_TypeDefinitionIndex = 46817;
