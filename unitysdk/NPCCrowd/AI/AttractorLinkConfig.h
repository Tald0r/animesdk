...
#define NPCCROWD_AI_ATTRACTORLINKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x75156D0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorLinkConfig_TypeDefinitionIndex = 45172;
