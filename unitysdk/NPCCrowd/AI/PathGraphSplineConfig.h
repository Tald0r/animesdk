...
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_GET_NEXTCONNECTORNODEINDEX_OFFSET UNITYSDK_OFFSET(0x6338130)
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_GET_PREVCONNECTORNODEINDEX_OFFSET UNITYSDK_OFFSET(0x6338120)
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_TRYSAMPLELANEPOINT_OFFSET UNITYSDK_OFFSET(0x6337F40)
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6337DF0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineConfig_TypeDefinitionIndex = 62027;
