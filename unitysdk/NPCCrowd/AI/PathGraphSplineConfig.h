...
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_GET_NEXTCONNECTORNODEINDEX_OFFSET UNITYSDK_OFFSET(0x5DF7AB0)
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_GET_PREVCONNECTORNODEINDEX_OFFSET UNITYSDK_OFFSET(0x5DF7AA0)
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG_TRYSAMPLELANEPOINT_OFFSET UNITYSDK_OFFSET(0x5DF78C0)
#define NPCCROWD_AI_PATHGRAPHSPLINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x5DF7770)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineConfig_TypeDefinitionIndex = 74090;
