...
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x76C28C0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_CONNECTORCONFIG_OFFSET UNITYSDK_OFFSET(0x76C2A30)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_HEURISTICPOSITION_OFFSET UNITYSDK_OFFSET(0x76C2B00)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_ISCONNECTORNODE_OFFSET UNITYSDK_OFFSET(0x76C2A10)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_ISSPLINENODE_OFFSET UNITYSDK_OFFSET(0x76C2920)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_SPLINECONFIG_OFFSET UNITYSDK_OFFSET(0x76C2940)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x76C2860)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_RANDRANGE_1_OFFSET UNITYSDK_OFFSET(0x76C2BB0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_RANDRANGE_OFFSET UNITYSDK_OFFSET(0x76C2B20)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x76C2C20)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphNodeRuntime_TypeDefinitionIndex = 58951;
