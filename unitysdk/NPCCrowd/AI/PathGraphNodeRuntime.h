...
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0xA0FBA60)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_CONNECTORCONFIG_OFFSET UNITYSDK_OFFSET(0xA0FBBD0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_HEURISTICPOSITION_OFFSET UNITYSDK_OFFSET(0xA0FBCA0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_ISCONNECTORNODE_OFFSET UNITYSDK_OFFSET(0xA0FBBB0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_ISSPLINENODE_OFFSET UNITYSDK_OFFSET(0xA0FBAC0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_GET_SPLINECONFIG_OFFSET UNITYSDK_OFFSET(0xA0FBAE0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0xA0FBA00)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_RANDRANGE_1_OFFSET UNITYSDK_OFFSET(0xA0FBD50)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME_RANDRANGE_OFFSET UNITYSDK_OFFSET(0xA0FBCC0)
#define NPCCROWD_AI_PATHGRAPHNODERUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xA0FBDC0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphNodeRuntime_TypeDefinitionIndex = 46597;
