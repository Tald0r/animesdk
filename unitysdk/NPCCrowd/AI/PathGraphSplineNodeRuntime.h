...
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0xA0FD6E0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETAFTERVERTICALSEGMENT_OFFSET UNITYSDK_OFFSET(0xA0FF690)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETCONTROLPOINTPOS_OFFSET UNITYSDK_OFFSET(0xA0FE640)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETDIRECTIONBYPOSITION_OFFSET UNITYSDK_OFFSET(0xA0FFAF0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANECENTEROFFSET_OFFSET UNITYSDK_OFFSET(0xA0FE3C0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANEPOSITION_1_OFFSET UNITYSDK_OFFSET(0xA0FE0F0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANEPOSITION_OFFSET UNITYSDK_OFFSET(0xA0FDFC0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xA0FD750)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETMAXLANEINNEROFFSET_OFFSET UNITYSDK_OFFSET(0xA0FDE70)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETNEXTCONNECTORNODEID_OFFSET UNITYSDK_OFFSET(0xA0FDA60)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETOTHERINVERSELANE_OFFSET UNITYSDK_OFFSET(0xA100210)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPATHDISTANCEBYPOINTINDEX_OFFSET UNITYSDK_OFFSET(0xA0FFFD0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTROTATION_1_OFFSET UNITYSDK_OFFSET(0xA0FEA00)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTROTATION_OFFSET UNITYSDK_OFFSET(0xA0FE820)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTSLOPETYPE_OFFSET UNITYSDK_OFFSET(0xA0FF510)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTSTAIRTRANSITIONDISTANCE_OFFSET UNITYSDK_OFFSET(0xA0FF190)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTSTAIRTYPE_OFFSET UNITYSDK_OFFSET(0xA0FEDC0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTUPAXIS_OFFSET UNITYSDK_OFFSET(0xA0FEC50)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETRANDOMLANEINDEX_OFFSET UNITYSDK_OFFSET(0xA0FDB60)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETRANDOMLANEINNEROFFSET_OFFSET UNITYSDK_OFFSET(0xA0FDCA0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETSLOPEANGLECOSINE_OFFSET UNITYSDK_OFFSET(0xA0FF840)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETTANGENT_1_OFFSET UNITYSDK_OFFSET(0xA0FFEF0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETTANGENT_OFFSET UNITYSDK_OFFSET(0xA0FFD40)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETVERTICALDIRECTION_OFFSET UNITYSDK_OFFSET(0xA0FEF90)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xA0FCD40)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GET_CONTROLPOINTCOUNT_OFFSET UNITYSDK_OFFSET(0xA0FD610)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GET_HEURISTICPOSITION_OFFSET UNITYSDK_OFFSET(0xA0FD8C0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0xA0FD640)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xA0FC5C0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0xA1007E0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME___BASE_GET_HEURISTICPOSITION_OFFSET UNITYSDK_OFFSET(0xA100840)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0xA100860)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineNodeRuntime_TypeDefinitionIndex = 66725;
