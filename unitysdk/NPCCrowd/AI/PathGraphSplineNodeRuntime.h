...
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0x76C4540)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETAFTERVERTICALSEGMENT_OFFSET UNITYSDK_OFFSET(0x76C64F0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETCONTROLPOINTPOS_OFFSET UNITYSDK_OFFSET(0x76C54A0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETDIRECTIONBYPOSITION_OFFSET UNITYSDK_OFFSET(0x76C6950)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANECENTEROFFSET_OFFSET UNITYSDK_OFFSET(0x76C5220)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANEPOSITION_1_OFFSET UNITYSDK_OFFSET(0x76C4F50)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETLANEPOSITION_OFFSET UNITYSDK_OFFSET(0x76C4E20)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETMAXCOUNT_OFFSET UNITYSDK_OFFSET(0x76C45B0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETMAXLANEINNEROFFSET_OFFSET UNITYSDK_OFFSET(0x76C4CD0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETNEXTCONNECTORNODEID_OFFSET UNITYSDK_OFFSET(0x76C48C0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETOTHERINVERSELANE_OFFSET UNITYSDK_OFFSET(0x76C7070)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPATHDISTANCEBYPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x76C6E30)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTROTATION_1_OFFSET UNITYSDK_OFFSET(0x76C5860)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTROTATION_OFFSET UNITYSDK_OFFSET(0x76C5680)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTSLOPETYPE_OFFSET UNITYSDK_OFFSET(0x76C6370)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTSTAIRTRANSITIONDISTANCE_OFFSET UNITYSDK_OFFSET(0x76C5FF0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTSTAIRTYPE_OFFSET UNITYSDK_OFFSET(0x76C5C20)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETPOINTUPAXIS_OFFSET UNITYSDK_OFFSET(0x76C5AB0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETRANDOMLANEINDEX_OFFSET UNITYSDK_OFFSET(0x76C49C0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETRANDOMLANEINNEROFFSET_OFFSET UNITYSDK_OFFSET(0x76C4B00)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETSLOPEANGLECOSINE_OFFSET UNITYSDK_OFFSET(0x76C66A0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETTANGENT_1_OFFSET UNITYSDK_OFFSET(0x76C6D50)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x76C6BA0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GETVERTICALDIRECTION_OFFSET UNITYSDK_OFFSET(0x76C5DF0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x76C3BA0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GET_CONTROLPOINTCOUNT_OFFSET UNITYSDK_OFFSET(0x76C4470)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_GET_HEURISTICPOSITION_OFFSET UNITYSDK_OFFSET(0x76C4720)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0x76C44A0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x76C3420)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME___BASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x76C7640)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME___BASE_GET_HEURISTICPOSITION_OFFSET UNITYSDK_OFFSET(0x76C76A0)
#define NPCCROWD_AI_PATHGRAPHSPLINENODERUNTIME___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x76C76C0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineNodeRuntime_TypeDefinitionIndex = 46460;

	class PathGraphSplineNodeRuntime : public ::NPCCrowd::AI::PathGraphNodeRuntime
	{
	public:
		::System::Collections::Generic::List_1<::System::Int32>* cache; // 0x20
		::NPCCrowd::AI::PathGraphSplineNodeRuntime_BlockState* BlockForward; // 0x28
		::NPCCrowd::AI::PathGraphSplineNodeRuntime_BlockState* BlockBackward; // 0x30
		::System::Boolean OverrideUpAxis; // 0x38
		::System::Int32 overrideMaxCount; // 0x3C
