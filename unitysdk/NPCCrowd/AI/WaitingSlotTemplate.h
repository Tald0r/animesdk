...
#define NPCCROWD_AI_WAITINGSLOTTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x93619A0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int WaitingSlotTemplate_TypeDefinitionIndex = 74929;
