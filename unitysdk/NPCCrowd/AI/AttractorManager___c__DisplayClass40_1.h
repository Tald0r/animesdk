...
#define NPCCROWD_AI_ATTRACTORMANAGER___C__DISPLAYCLASS40_1__CTOR_OFFSET UNITYSDK_OFFSET(0x688F720)
#define NPCCROWD_AI_ATTRACTORMANAGER___C__DISPLAYCLASS40_1__INITHANDLECONFLICT_B__0_OFFSET UNITYSDK_OFFSET(0x688F730)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AttractorManager___c__DisplayClass40_1_TypeDefinitionIndex = 77304;
