...
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x7EEF120)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___C__DISPLAYCLASS20_0__SPAWNIMMEDIATELYFORPATH_B__0_OFFSET UNITYSDK_OFFSET(0x7EEF130)
#define NPCCROWD_AI_PATHGRAPHGUIDEPOINTPATHSPAWNGROUPRUNTIME___C__DISPLAYCLASS20_0__SPAWNIMMEDIATELYFORPATH_B__1_OFFSET UNITYSDK_OFFSET(0x7EEF400)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphGuidePointPathSpawnGroupRuntime___c__DisplayClass20_0_TypeDefinitionIndex = 79011;
	...
	public:
		...
		::NPCCrowd::AI::PathGraphFeaturePointV2Config* pointConfig; // 0x28
		::System::Predicate_1<::NPCCrowd::AI::PathGraphRuntime_PathFindingResult_FPathFindingResultNode>* __9__1; // 0x30
		::NPCCrowd::AI::PathGraphGuidePointPathSpawnGroupRuntime* __4__this; // 0x38
