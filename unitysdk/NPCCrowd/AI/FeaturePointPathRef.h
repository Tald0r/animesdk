...
#define NPCCROWD_AI_FEATUREPOINTPATHREF_GET_PATHINDEX_OFFSET UNITYSDK_OFFSET(0x763DDF0)
#define NPCCROWD_AI_FEATUREPOINTPATHREF__CTOR_OFFSET UNITYSDK_OFFSET(0x763DE70)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int FeaturePointPathRef_TypeDefinitionIndex = 44970;
