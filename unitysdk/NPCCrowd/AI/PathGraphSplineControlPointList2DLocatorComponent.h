...
#define NPCCROWD_AI_PATHGRAPHSPLINECONTROLPOINTLIST2DLOCATORCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x5DF7AC0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphSplineControlPointList2DLocatorComponent_TypeDefinitionIndex = 68205;
