...
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTRUNTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0xA0FAEB0)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTRUNTIME_INITCOMPONENTS_OFFSET UNITYSDK_OFFSET(0xA0FAB70)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTRUNTIME_INIT_OFFSET UNITYSDK_OFFSET(0xA0FAB00)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTRUNTIME_UPDATE_OFFSET UNITYSDK_OFFSET(0xA0FB060)
#define NPCCROWD_AI_PATHGRAPHFEATUREPOINTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xA0FB1F0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int PathGraphFeaturePointRuntime_TypeDefinitionIndex = 42409;
