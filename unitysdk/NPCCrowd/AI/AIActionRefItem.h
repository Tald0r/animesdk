...
#define NPCCROWD_AI_AIACTIONREFITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA0F9F70)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionRefItem_TypeDefinitionIndex = 54597;
