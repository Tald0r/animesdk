...
#define NPCCROWD_AI_AIACTIONREFITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x76C0DC0)

namespace NPCCrowd::AI
{
	inline static constexpr unsigned int AIActionRefItem_TypeDefinitionIndex = 48620;
