...
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_GETVALIDBATCH_OFFSET UNITYSDK_OFFSET(0x381740)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_RECYCLEVALIDBATCH_OFFSET UNITYSDK_OFFSET(0x381750)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_REFRESHVALIDBATCH_OFFSET UNITYSDK_OFFSET(0x3816B0)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_UPDATEBATCHTICK_OFFSET UNITYSDK_OFFSET(0x3817D0)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x3816A0)

namespace NPCCrowd
{
	inline static constexpr unsigned int CrowdTickControlInstance_LODData_TypeDefinitionIndex = 54519;
