...
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_GETVALIDBATCH_OFFSET UNITYSDK_OFFSET(0x36CE40)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_RECYCLEVALIDBATCH_OFFSET UNITYSDK_OFFSET(0x36CE50)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_REFRESHVALIDBATCH_OFFSET UNITYSDK_OFFSET(0x36CDB0)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA_UPDATEBATCHTICK_OFFSET UNITYSDK_OFFSET(0x36CED0)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_LODDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x36CDA0)

namespace NPCCrowd
{
	inline static constexpr unsigned int CrowdTickControlInstance_LODData_TypeDefinitionIndex = 69324;
