...
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_NEEDUPDATE_OFFSET UNITYSDK_OFFSET(0x76496E0)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_ONCHANGELOD_OFFSET UNITYSDK_OFFSET(0x7649010)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_ONREMOVELOD_OFFSET UNITYSDK_OFFSET(0x7649310)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_UPDATEBATCH_OFFSET UNITYSDK_OFFSET(0x7649530)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x7648DC0)

namespace NPCCrowd
{
	inline static constexpr unsigned int CrowdTickControlInstance_TypeDefinitionIndex = 69323;
