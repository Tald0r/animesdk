...
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_NEEDUPDATE_OFFSET UNITYSDK_OFFSET(0x862BAE0)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_ONCHANGELOD_OFFSET UNITYSDK_OFFSET(0x862B410)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_ONREMOVELOD_OFFSET UNITYSDK_OFFSET(0x862B710)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE_UPDATEBATCH_OFFSET UNITYSDK_OFFSET(0x862B930)
#define NPCCROWD_CROWDTICKCONTROLINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x862B1C0)

namespace NPCCrowd
{
	inline static constexpr unsigned int CrowdTickControlInstance_TypeDefinitionIndex = 54518;
