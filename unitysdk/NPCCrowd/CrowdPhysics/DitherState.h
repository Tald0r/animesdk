...
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_CLEAN_OFFSET UNITYSDK_OFFSET(0x301510)
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_UPDATEDITHER_OFFSET UNITYSDK_OFFSET(0x3016A0)
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_UPDATEFADEIN_OFFSET UNITYSDK_OFFSET(0x301610)
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_UPDATEFADEOUT_OFFSET UNITYSDK_OFFSET(0x301580)

namespace NPCCrowd::CrowdPhysics
{
	inline static constexpr unsigned int DitherState_TypeDefinitionIndex = 54271;
