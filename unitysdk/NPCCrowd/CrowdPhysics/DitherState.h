...
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_CLEAN_OFFSET UNITYSDK_OFFSET(0x305D80)
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_UPDATEDITHER_OFFSET UNITYSDK_OFFSET(0x305F10)
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_UPDATEFADEIN_OFFSET UNITYSDK_OFFSET(0x305E80)
#define NPCCROWD_CROWDPHYSICS_DITHERSTATE_UPDATEFADEOUT_OFFSET UNITYSDK_OFFSET(0x305DF0)

namespace NPCCrowd::CrowdPhysics
{
	inline static constexpr unsigned int DitherState_TypeDefinitionIndex = 58319;
