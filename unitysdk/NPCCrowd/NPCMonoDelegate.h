...
#define NPCCROWD_NPCMONODELEGATE_ADD_ONBECAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x75251A0)
#define NPCCROWD_NPCMONODELEGATE_ONBECAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x75252A0)
#define NPCCROWD_NPCMONODELEGATE_REMOVE_ONBECAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x7525220)
#define NPCCROWD_NPCMONODELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x7525310)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCMonoDelegate_TypeDefinitionIndex = 40666;
