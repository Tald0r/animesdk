...
#define NPCCROWD_SPAWNRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6B69120)

namespace NPCCrowd
{
	inline static constexpr unsigned int SpawnRangeConfig_TypeDefinitionIndex = 54379;
