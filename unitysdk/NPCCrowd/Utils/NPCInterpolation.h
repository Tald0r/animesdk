...
#define NPCCROWD_UTILS_NPCINTERPOLATION_CALCULATECATMULLROMCENTRIPETALTANGENT_OFFSET UNITYSDK_OFFSET(0x7E111B0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_CALCULATECENTRIPETALPARAMETERS_OFFSET UNITYSDK_OFFSET(0x7E10FC0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_CATMULLROMCENTRIPETAL_OFFSET UNITYSDK_OFFSET(0x7E10BA0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_CATMULLROMTANGENT_OFFSET UNITYSDK_OFFSET(0x7E108F0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_CATMULLROM_OFFSET UNITYSDK_OFFSET(0x7E106C0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_CUBIC_OFFSET UNITYSDK_OFFSET(0x7E104F0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_EASEINOUTCUBIC_OFFSET UNITYSDK_OFFSET(0x7E115B0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_INTERPOLATETOWARDS_OFFSET UNITYSDK_OFFSET(0x7E116B0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPEXPN_OFFSET UNITYSDK_OFFSET(0x7E120A0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS2_1_OFFSET UNITYSDK_OFFSET(0x7E11BE0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS2_2_OFFSET UNITYSDK_OFFSET(0x7E11CF0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS2_OFFSET UNITYSDK_OFFSET(0x7E11B10)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS3_1_OFFSET UNITYSDK_OFFSET(0x7E11EA0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS3_2_OFFSET UNITYSDK_OFFSET(0x7E11F80)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS3_OFFSET UNITYSDK_OFFSET(0x7E11DD0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS_1_OFFSET UNITYSDK_OFFSET(0x7E11900)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS_2_OFFSET UNITYSDK_OFFSET(0x7E119F0)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERPS_OFFSET UNITYSDK_OFFSET(0x7E11830)
#define NPCCROWD_UTILS_NPCINTERPOLATION_LERP_OFFSET UNITYSDK_OFFSET(0x7E11780)

namespace NPCCrowd::Utils
{
	inline static constexpr unsigned int NPCInterpolation_TypeDefinitionIndex = 44949;
