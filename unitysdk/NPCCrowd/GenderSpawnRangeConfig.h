...
#define NPCCROWD_GENDERSPAWNRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6355500)

namespace NPCCrowd
{
	inline static constexpr unsigned int GenderSpawnRangeConfig_TypeDefinitionIndex = 52982;
