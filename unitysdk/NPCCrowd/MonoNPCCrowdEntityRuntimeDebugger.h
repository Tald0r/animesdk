...
#define NPCCROWD_MONONPCCROWDENTITYRUNTIMEDEBUGGER_SETNPCENTITY_OFFSET UNITYSDK_OFFSET(0x6300910)
#define NPCCROWD_MONONPCCROWDENTITYRUNTIMEDEBUGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x6300980)

namespace NPCCrowd
{
	inline static constexpr unsigned int MonoNPCCrowdEntityRuntimeDebugger_TypeDefinitionIndex = 75936;
