...
#define NPCCROWD_NPCWPPATHFINDERMANAGER_DRAWRUNTIMEDEBUGGER_OFFSET UNITYSDK_OFFSET(0x6A09D80)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_FINDPATH_OFFSET UNITYSDK_OFFSET(0x6A0A6C0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETALLENTERNODE_OFFSET UNITYSDK_OFFSET(0x6A0A0E0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETARANDOMNODEOFFSET_1_OFFSET UNITYSDK_OFFSET(0x6A0A330)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETARANDOMNODEOFFSET_2_OFFSET UNITYSDK_OFFSET(0x6A0A540)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETARANDOMNODEOFFSET_OFFSET UNITYSDK_OFFSET(0x6A0A190)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETARANDOMSTARTANDEXITPATH_OFFSET UNITYSDK_OFFSET(0x6A0ACE0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETISJOINTNODE_OFFSET UNITYSDK_OFFSET(0x6A0A050)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETNODEPOS_OFFSET UNITYSDK_OFFSET(0x6A09F90)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETNODE_OFFSET UNITYSDK_OFFSET(0x6A09DF0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETPATHSTATE_OFFSET UNITYSDK_OFFSET(0x6A09AF0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETPATH_OFFSET UNITYSDK_OFFSET(0x6A09F00)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x6A08A20)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_HASPATHSTATE_OFFSET UNITYSDK_OFFSET(0x6A09BB0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x6A08B90)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6A09900)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0x6A09080)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_PRELOADASSETS_OFFSET UNITYSDK_OFFSET(0x6A08EA0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_SETPATHSTATE_OFFSET UNITYSDK_OFFSET(0x6A09A70)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_SETWPGRAPHDATA_OFFSET UNITYSDK_OFFSET(0x6A09850)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x6A08E00)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_TRYGETNODECOPY_OFFSET UNITYSDK_OFFSET(0x6A09E70)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_TRYLOADSECTIONPATHDATA_OFFSET UNITYSDK_OFFSET(0x6A094E0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x6A09C80)
#define NPCCROWD_NPCWPPATHFINDERMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x6A0B3E0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x6A0B3D0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x6A0B4B0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6A0B510)
#define NPCCROWD_NPCWPPATHFINDERMANAGER___BASE_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0x6A0B570)
#define NPCCROWD_NPCWPPATHFINDERMANAGER___BASE_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x6A0B5D0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x6A0B630)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCWPPathFinderManager_TypeDefinitionIndex = 74423;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::NPCCrowd::AI::Node*>**)Il2CppClass::FromTypeDefinitionIndex(NPCWPPathFinderManager_TypeDefinitionIndex)->GetStaticField(0x420A0);
		}
		static ::Foundation::AssetRequestHandle* StaticGet_sectionAssetRequest()
		{
			return (::Foundation::AssetRequestHandle*)Il2CppClass::FromTypeDefinitionIndex(NPCWPPathFinderManager_TypeDefinitionIndex)->GetStaticField(0x420A8);
		}
		static ::System::Collections::Generic::List_1<::NPCCrowd::AI::Path*>** StaticGet_resultPathTemp()
		{
			return (::System::Collections::Generic::List_1<::NPCCrowd::AI::Path*>**)Il2CppClass::FromTypeDefinitionIndex(NPCWPPathFinderManager_TypeDefinitionIndex)->GetStaticField(0x420C8);
		}
		static ::UnityEngine::Vector3* StaticGet_Gravity()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(NPCWPPathFinderManager_TypeDefinitionIndex)->GetStaticField(0xFE30);
		}
		::Foundation::AssetRequestHandle _graphHandle; // 0x18
		::NPCCrowd::AI::WPGraphSectionAssetSO* _sectionAssetSo; // 0x38
		::NPCCrowd::AI::WPGraphRuntime* wpGraphRuntime; // 0x40
		::Foundation::AssetRequestHandle _stateHandle; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::NPCWPPathFinderManager_FindPathOfNodesCache*>* pathCaches; // 0x68
		::System::Collections::Generic::Stack_1<::NPCCrowd::NPCWPPathFinderManager_FindPathOfNodesCache*>* pathResultCaches; // 0x70
		::System::Collections::Generic::List_1<::System::UInt16>* ushortCache; // 0x78
		::NPCCrowd::NPCIDGeneratorInt* randPathIDGen; // 0x80
