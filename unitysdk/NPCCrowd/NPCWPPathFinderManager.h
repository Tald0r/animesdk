...
#define NPCCROWD_NPCWPPATHFINDERMANAGER_DRAWRUNTIMEDEBUGGER_OFFSET UNITYSDK_OFFSET(0x60443A0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_FINDPATH_OFFSET UNITYSDK_OFFSET(0x6044CE0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETALLENTERNODE_OFFSET UNITYSDK_OFFSET(0x6044700)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETARANDOMNODEOFFSET_1_OFFSET UNITYSDK_OFFSET(0x6044950)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETARANDOMNODEOFFSET_2_OFFSET UNITYSDK_OFFSET(0x6044B60)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETARANDOMNODEOFFSET_OFFSET UNITYSDK_OFFSET(0x60447B0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETARANDOMSTARTANDEXITPATH_OFFSET UNITYSDK_OFFSET(0x6045300)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETISJOINTNODE_OFFSET UNITYSDK_OFFSET(0x6044670)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETNODEPOS_OFFSET UNITYSDK_OFFSET(0x60445B0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETNODE_OFFSET UNITYSDK_OFFSET(0x6044410)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETPATHSTATE_OFFSET UNITYSDK_OFFSET(0x6044110)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GETPATH_OFFSET UNITYSDK_OFFSET(0x6044520)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x6043050)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_HASPATHSTATE_OFFSET UNITYSDK_OFFSET(0x60441D0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x60431C0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6043F20)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0x60436A0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_PRELOADASSETS_OFFSET UNITYSDK_OFFSET(0x60434C0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_SETPATHSTATE_OFFSET UNITYSDK_OFFSET(0x6044090)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_SETWPGRAPHDATA_OFFSET UNITYSDK_OFFSET(0x6043E70)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x6043420)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_TRYGETNODECOPY_OFFSET UNITYSDK_OFFSET(0x6044490)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_TRYLOADSECTIONPATHDATA_OFFSET UNITYSDK_OFFSET(0x6043B00)
#define NPCCROWD_NPCWPPATHFINDERMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x60442A0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x6045A00)
#define NPCCROWD_NPCWPPATHFINDERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x60459F0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x6045AD0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6045B30)
#define NPCCROWD_NPCWPPATHFINDERMANAGER___BASE_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0x6045B90)
#define NPCCROWD_NPCWPPATHFINDERMANAGER___BASE_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x6045BF0)
#define NPCCROWD_NPCWPPATHFINDERMANAGER___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x6045C50)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCWPPathFinderManager_TypeDefinitionIndex = 62578;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::NPCCrowd::AI::Node*>**)Il2CppClass::FromTypeDefinitionIndex(NPCWPPathFinderManager_TypeDefinitionIndex)->GetStaticField(0x3F2C0);
		}
		static ::System::Collections::Generic::List_1<::NPCCrowd::AI::Path*>** StaticGet_resultPathTemp()
		{
			return (::System::Collections::Generic::List_1<::NPCCrowd::AI::Path*>**)Il2CppClass::FromTypeDefinitionIndex(NPCWPPathFinderManager_TypeDefinitionIndex)->GetStaticField(0x3F2C8);
		}
		static ::Foundation::AssetRequestHandle* StaticGet_sectionAssetRequest()
		{
			return (::Foundation::AssetRequestHandle*)Il2CppClass::FromTypeDefinitionIndex(NPCWPPathFinderManager_TypeDefinitionIndex)->GetStaticField(0x3F2D0);
		}
		static ::UnityEngine::Vector3* StaticGet_Gravity()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(NPCWPPathFinderManager_TypeDefinitionIndex)->GetStaticField(0xFAF0);
		}
		::NPCCrowd::AI::WPGraphRuntime* wpGraphRuntime; // 0x18
		::NPCCrowd::NPCIDGeneratorInt* randPathIDGen; // 0x20
		::NPCCrowd::AI::WPGraphSectionAssetSO* _sectionAssetSo; // 0x28
		::Foundation::AssetRequestHandle _graphHandle; // 0x30
		::System::Collections::Generic::Stack_1<::NPCCrowd::NPCWPPathFinderManager_FindPathOfNodesCache*>* pathResultCaches; // 0x50
		::System::Collections::Generic::List_1<::System::UInt16>* ushortCache; // 0x58
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::NPCCrowd::NPCWPPathFinderManager_FindPathOfNodesCache*>* pathCaches; // 0x60
		::Foundation::AssetRequestHandle _stateHandle; // 0x68
