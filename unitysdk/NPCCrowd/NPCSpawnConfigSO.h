...
#define NPCCROWD_NPCSPAWNCONFIGSO__CTOR_OFFSET UNITYSDK_OFFSET(0x63B1DF0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCSpawnConfigSO_TypeDefinitionIndex = 41535;
