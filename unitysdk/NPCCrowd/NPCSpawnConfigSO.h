...
#define NPCCROWD_NPCSPAWNCONFIGSO__CTOR_OFFSET UNITYSDK_OFFSET(0x9EC0830)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCSpawnConfigSO_TypeDefinitionIndex = 51417;
