...
#define NPCCROWD_RNG_GETSEQUENCE_1_OFFSET UNITYSDK_OFFSET(0x764B120)
#define NPCCROWD_RNG_GETSEQUENCE_OFFSET UNITYSDK_OFFSET(0x32A070)
#define NPCCROWD_RNG_SHUFFLE_OFFSET UNITYSDK_OFFSET(0x32A060)
#define NPCCROWD_RNG__CTOR_1_OFFSET UNITYSDK_OFFSET(0x32A000)
#define NPCCROWD_RNG__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3600)

namespace NPCCrowd
{
	inline static constexpr unsigned int Rng_TypeDefinitionIndex = 68362;
