...
#define NPCCROWD_RNG_GETSEQUENCE_1_OFFSET UNITYSDK_OFFSET(0x862D510)
#define NPCCROWD_RNG_GETSEQUENCE_OFFSET UNITYSDK_OFFSET(0x3560D0)
#define NPCCROWD_RNG_SHUFFLE_OFFSET UNITYSDK_OFFSET(0x3560C0)
#define NPCCROWD_RNG__CTOR_1_OFFSET UNITYSDK_OFFSET(0x356060)
#define NPCCROWD_RNG__CTOR_OFFSET UNITYSDK_OFFSET(0x302300)

namespace NPCCrowd
{
	inline static constexpr unsigned int Rng_TypeDefinitionIndex = 49630;
