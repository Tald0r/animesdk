...
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x3075A0)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTFLOAT_1_OFFSET UNITYSDK_OFFSET(0x307600)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x3075F0)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTINT_1_OFFSET UNITYSDK_OFFSET(0x3075E0)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTINT_OFFSET UNITYSDK_OFFSET(0x3075D0)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTSTATE_OFFSET UNITYSDK_OFFSET(0x3074F0)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTUINT_1_OFFSET UNITYSDK_OFFSET(0x3075C0)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTUINT_OFFSET UNITYSDK_OFFSET(0x3075B0)
#define NPCCROWD_RNG_RNGSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x3074E0)

namespace NPCCrowd
{
	inline static constexpr unsigned int Rng_RngSequence_TypeDefinitionIndex = 49631;
