...
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x33AE60)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTFLOAT_1_OFFSET UNITYSDK_OFFSET(0x33AEC0)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x33AEB0)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTINT_1_OFFSET UNITYSDK_OFFSET(0x33AEA0)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTINT_OFFSET UNITYSDK_OFFSET(0x33AE90)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTSTATE_OFFSET UNITYSDK_OFFSET(0x33ADB0)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTUINT_1_OFFSET UNITYSDK_OFFSET(0x33AE80)
#define NPCCROWD_RNG_RNGSEQUENCE_NEXTUINT_OFFSET UNITYSDK_OFFSET(0x33AE70)
#define NPCCROWD_RNG_RNGSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x2C3980)

namespace NPCCrowd
{
	inline static constexpr unsigned int Rng_RngSequence_TypeDefinitionIndex = 68364;
