...
#define NPCCROWD_RNGTOOLKIT_ASBOOL_OFFSET UNITYSDK_OFFSET(0x862D620)
#define NPCCROWD_RNGTOOLKIT_ASFLOAT_1_OFFSET UNITYSDK_OFFSET(0x862D8B0)
#define NPCCROWD_RNGTOOLKIT_ASFLOAT_OFFSET UNITYSDK_OFFSET(0x862D840)
#define NPCCROWD_RNGTOOLKIT_ASINT_1_OFFSET UNITYSDK_OFFSET(0x862D6E0)
#define NPCCROWD_RNGTOOLKIT_ASINT_OFFSET UNITYSDK_OFFSET(0x862D680)
#define NPCCROWD_RNGTOOLKIT_ASUINT_1_OFFSET UNITYSDK_OFFSET(0x862D7E0)
#define NPCCROWD_RNGTOOLKIT_ASUINT_OFFSET UNITYSDK_OFFSET(0x862D760)

namespace NPCCrowd
{
	inline static constexpr unsigned int RngToolkit_TypeDefinitionIndex = 43838;
