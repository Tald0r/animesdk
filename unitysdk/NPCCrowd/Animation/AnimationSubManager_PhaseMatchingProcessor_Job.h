...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_BUILDREQUEST_OFFSET UNITYSDK_OFFSET(0x640CBF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x64095F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x2FBB60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_FETCHSECTION_OFFSET UNITYSDK_OFFSET(0x2FBC70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_FOOTMATCHING_OFFSET UNITYSDK_OFFSET(0x640B450)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_GETADDITIONALANIMATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x2FBDD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_GETCURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0x2FBC30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_GETSAMPLETIME_OFFSET UNITYSDK_OFFSET(0x640C0E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x2FBB40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_ISCHUNKVALID_OFFSET UNITYSDK_OFFSET(0x2FBB50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_PHASEMATCHINGADDITIONALANIMATION_OFFSET UNITYSDK_OFFSET(0x2FBD60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_PHASEMATCHINGANIMATION_OFFSET UNITYSDK_OFFSET(0x2FBC80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_PHASEMATCHINGDEFAULTANIMATION_OFFSET UNITYSDK_OFFSET(0x2FBD20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_PHASEMATCHINGINSTANCE_OFFSET UNITYSDK_OFFSET(0x2FBCC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_PHASEMATCHING_OFFSET UNITYSDK_OFFSET(0x2FBB70)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PhaseMatchingProcessor_Job_TypeDefinitionIndex = 59657;
