...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_BUILDREQUEST_OFFSET UNITYSDK_OFFSET(0x6A114E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x6A0E4A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x3003E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_FETCHSECTION_OFFSET UNITYSDK_OFFSET(0x3004F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_FOOTMATCHING_OFFSET UNITYSDK_OFFSET(0x6A10310)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_GETADDITIONALANIMATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x300650)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_GETCURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0x3004B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_GETSAMPLETIME_OFFSET UNITYSDK_OFFSET(0x6A10E20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x3003C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_ISCHUNKVALID_OFFSET UNITYSDK_OFFSET(0x3003D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_PHASEMATCHINGADDITIONALANIMATION_OFFSET UNITYSDK_OFFSET(0x3005E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_PHASEMATCHINGANIMATION_OFFSET UNITYSDK_OFFSET(0x300500)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_PHASEMATCHINGDEFAULTANIMATION_OFFSET UNITYSDK_OFFSET(0x3005A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_PHASEMATCHINGINSTANCE_OFFSET UNITYSDK_OFFSET(0x300540)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_JOB_PHASEMATCHING_OFFSET UNITYSDK_OFFSET(0x3003F0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PhaseMatchingProcessor_Job_TypeDefinitionIndex = 71143;
