...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x5E09710)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_FINDORADDINSTANCELIST_OFFSET UNITYSDK_OFFSET(0x5E09C40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_FREE_OFFSET UNITYSDK_OFFSET(0x5E09AE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x5E08FF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x5E08FE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x5E09050)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x5E09150)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x5E09E80)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_SpawnInstanceProcessor_TypeDefinitionIndex = 71106;
