...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x634B290)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_FINDORADDINSTANCELIST_OFFSET UNITYSDK_OFFSET(0x634B7C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_FREE_OFFSET UNITYSDK_OFFSET(0x634B660)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x634AB70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x634AB60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x634ABD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x634ACD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SPAWNINSTANCEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x634BA00)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_SpawnInstanceProcessor_TypeDefinitionIndex = 59644;
