...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x307090)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x307050)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x307040)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_GET_STATE_OFFSET UNITYSDK_OFFSET(0x307020)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_SET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x307060)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA_SET_STATE_OFFSET UNITYSDK_OFFSET(0x307030)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x651B9B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONINSTANCEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x307010)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PoseInertializationInstanceData_TypeDefinitionIndex = 59712;
	...
	struct alignas(4) AnimationSubManager_PoseInertializationInstanceData
	{
		...
		{
			return (::NPCCrowd::Animation::AnimationSubManager_PoseInertializationInstanceData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_PoseInertializationInstanceData_TypeDefinitionIndex)->GetStaticField(0xAA60);
		}
