...
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_APPLYTRANSITION_OFFSET UNITYSDK_OFFSET(0x6973E80)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_BLENDANIMATIONS_OFFSET UNITYSDK_OFFSET(0x6977700)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCLIPDATA_OFFSET UNITYSDK_OFFSET(0x6978370)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCLIPFRAME_1_OFFSET UNITYSDK_OFFSET(0x697B670)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCLIPFRAME_OFFSET UNITYSDK_OFFSET(0x697B580)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCLIPTIME_OFFSET UNITYSDK_OFFSET(0x6979B40)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCLIPTOTALTIME_OFFSET UNITYSDK_OFFSET(0x697B150)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCPUSYNCMAINCLIPSEED_OFFSET UNITYSDK_OFFSET(0x697B470)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCPUSYNCMAINCLIPTIMEPROGRESS_OFFSET UNITYSDK_OFFSET(0x697AE40)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCURRENTCLIPINDEX_OFFSET UNITYSDK_OFFSET(0x697B050)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETCURRENTCLIPSPEEDS_OFFSET UNITYSDK_OFFSET(0x697B3B0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETMAINCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x697AD80)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETSLOTLOCALPRS_1_OFFSET UNITYSDK_OFFSET(0x697BE10)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETSLOTLOCALPRS_OFFSET UNITYSDK_OFFSET(0x697BC90)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETSLOTTRANSFORMINDEX_OFFSET UNITYSDK_OFFSET(0x697BD60)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETSPEEDRELATIVESTARTTIME_OFFSET UNITYSDK_OFFSET(0x697A350)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_GETSTATESYNCMAINCLIPTIMEPROGRESS_OFFSET UNITYSDK_OFFSET(0x697B310)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_REMOVEFROMTRANSITIONINGANIMATORSSWAPBACK_OFFSET UNITYSDK_OFFSET(0x697ABF0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_RESETANIMATOR_OFFSET UNITYSDK_OFFSET(0x6976160)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETANIMATIONMANUALLY_OFFSET UNITYSDK_OFFSET(0x6976F80)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETANIMATIONSPEEDS_OFFSET UNITYSDK_OFFSET(0x697A450)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETANIMATIONSPEED_1_OFFSET UNITYSDK_OFFSET(0x6979D00)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETANIMATIONSPEED_OFFSET UNITYSDK_OFFSET(0x6979C60)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETCLIPTIME_1_OFFSET UNITYSDK_OFFSET(0x697B880)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETCLIPTIME_OFFSET UNITYSDK_OFFSET(0x697B730)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SETLAYERFLAGS_OFFSET UNITYSDK_OFFSET(0x697BEE0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_STARTANIMATION_1_OFFSET UNITYSDK_OFFSET(0x6976590)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_STARTANIMATION_2_OFFSET UNITYSDK_OFFSET(0x69767D0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_STARTANIMATION_OFFSET UNITYSDK_OFFSET(0x6976490)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_STARTBLEND_1_OFFSET UNITYSDK_OFFSET(0x69784C0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_STARTBLEND_OFFSET UNITYSDK_OFFSET(0x6978190)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_SYNCSTATUSMANUALLY_OFFSET UNITYSDK_OFFSET(0x69775B0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_TRYGETANIMATION_OFFSET UNITYSDK_OFFSET(0x69773A0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR_UPDATEINDEX_OFFSET UNITYSDK_OFFSET(0x697BB80)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6976150)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCrowdAnimator_TypeDefinitionIndex = 39743;
	...
	public:
		...
		::Il2CppArray<::Il2CppArray<::System::Single>*>* currentLayerClipSpeeds; // 0x70
		::NPCCrowd::Animation::NPCCrowdAnimationInstancerRuntimeData* crowdRuntimeData; // 0x78
		::Il2CppArray<::UnityEngine::Vector4>* currentLayerAnimationClipDataWeights; // 0x80
		::Il2CppArray<::NPCCrowd::Animation::GPUIAnimationClipData>* newAnimationClipData; // 0x88
		::Il2CppArray<::UnityEngine::Vector4>* newLayerClipStartTimes; // 0x90
		::NPCCrowd::Animation::GPUICrowdTransition* transition; // 0x98
		::System::Boolean bIsNeedFlushMBGPUID; // 0xA0
		::System::UInt32 layerFlags; // 0xA4
		::UnityEngine::Vector4 currentAnimationFrames; // 0xA8
		::System::Int32 activeClipCount; // 0xB8
		::System::Int32 gpuAnimationInstanceID; // 0xBC
		::System::Int32 transitionIndex; // 0xC0
