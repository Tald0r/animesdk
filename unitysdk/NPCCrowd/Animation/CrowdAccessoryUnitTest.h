...
#define NPCCROWD_ANIMATION_CROWDACCESSORYUNITTEST_GETCROWDNPCTESTCASES_OFFSET UNITYSDK_OFFSET(0xA10D6B0)
#define NPCCROWD_ANIMATION_CROWDACCESSORYUNITTEST_GET_UNITTESTCASENAME_OFFSET UNITYSDK_OFFSET(0xA10D670)
#define NPCCROWD_ANIMATION_CROWDACCESSORYUNITTEST__CTOR_OFFSET UNITYSDK_OFFSET(0xA10D8F0)
#define NPCCROWD_ANIMATION_CROWDACCESSORYUNITTEST___BASE_GETCROWDNPCTESTCASES_OFFSET UNITYSDK_OFFSET(0xA10D950)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int CrowdAccessoryUnitTest_TypeDefinitionIndex = 53323;
