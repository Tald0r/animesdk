...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERSTATEOVERRIDEITEM_ASSIGNTO_OFFSET UNITYSDK_OFFSET(0x9AFE850)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERSTATEOVERRIDEITEM_HASANIMATION_OFFSET UNITYSDK_OFFSET(0x9AFE7A0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERSTATEOVERRIDEITEM_ISSAMEITEM_OFFSET UNITYSDK_OFFSET(0x9AFE8E0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERSTATEOVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9AFE950)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerStateOverrideItem_TypeDefinitionIndex = 48221;
