...
#define NPCCROWD_ANIMATION_PROCESSITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x5E10ED0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int ProcessItem_TypeDefinitionIndex = 44680;
