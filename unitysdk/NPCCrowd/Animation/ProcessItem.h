...
#define NPCCROWD_ANIMATION_PROCESSITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x6352780)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int ProcessItem_TypeDefinitionIndex = 53933;
	...
	public:
		...
		::System::Collections::Generic::Queue_1<::NPCCrowd::Animation::AnimatorZoneSegmentWrap*>* readyZones; // 0x28
