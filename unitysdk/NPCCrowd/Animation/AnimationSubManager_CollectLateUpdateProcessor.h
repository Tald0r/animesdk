...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x63A4E80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x63A4E70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x63A4EE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x63A4F50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x63A4FC0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_CollectLateUpdateProcessor_TypeDefinitionIndex = 59728;
