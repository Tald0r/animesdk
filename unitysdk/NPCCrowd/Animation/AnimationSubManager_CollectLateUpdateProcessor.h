...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x60B1AE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x60B1AD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x60B1B40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x60B1BB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTLATEUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x60B1C20)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_CollectLateUpdateProcessor_TypeDefinitionIndex = 71163;
