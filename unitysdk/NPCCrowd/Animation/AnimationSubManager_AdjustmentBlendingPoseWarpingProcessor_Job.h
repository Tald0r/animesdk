...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_CLEARCONTROLDATA_1_OFFSET UNITYSDK_OFFSET(0x30C7E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_CLEARCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x30C7D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x6B4EAE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x30C380)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_GETPOSE_OFFSET UNITYSDK_OFFSET(0x30C470)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x30C370)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_ISVALID_OFFSET UNITYSDK_OFFSET(0x30C7F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_SAMPLEPOSE_1_OFFSET UNITYSDK_OFFSET(0x30C390)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_SAMPLEPOSE_OFFSET UNITYSDK_OFFSET(0x6B513B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_SETBONEDATA_OFFSET UNITYSDK_OFFSET(0x30C660)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_SETCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x30C720)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_WARPPOSE_OFFSET UNITYSDK_OFFSET(0x30C580)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingPoseWarpingProcessor_Job_TypeDefinitionIndex = 71146;
