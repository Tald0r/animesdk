...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_CLEARCONTROLDATA_1_OFFSET UNITYSDK_OFFSET(0x33A6A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_CLEARCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x33A690)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x78013B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x33A240)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_GETPOSE_OFFSET UNITYSDK_OFFSET(0x33A330)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x33A230)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_ISVALID_OFFSET UNITYSDK_OFFSET(0x33A6B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_SAMPLEPOSE_1_OFFSET UNITYSDK_OFFSET(0x33A250)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_SAMPLEPOSE_OFFSET UNITYSDK_OFFSET(0x7804620)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_SETBONEDATA_OFFSET UNITYSDK_OFFSET(0x33A520)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_SETCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x33A5E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_WARPPOSE_OFFSET UNITYSDK_OFFSET(0x33A440)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingPoseWarpingProcessor_Job_TypeDefinitionIndex = 59708;
