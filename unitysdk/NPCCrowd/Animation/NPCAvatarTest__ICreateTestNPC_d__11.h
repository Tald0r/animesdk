...
#define NPCCROWD_ANIMATION_NPCAVATARTEST__ICREATETESTNPC_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x6971C30)
#define NPCCROWD_ANIMATION_NPCAVATARTEST__ICREATETESTNPC_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x69720C0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST__ICREATETESTNPC_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x6972120)
#define NPCCROWD_ANIMATION_NPCAVATARTEST__ICREATETESTNPC_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x69720D0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST__ICREATETESTNPC_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6971C20)
#define NPCCROWD_ANIMATION_NPCAVATARTEST__ICREATETESTNPC_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0x6971C10)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAvatarTest__ICreateTestNPC_d__11_TypeDefinitionIndex = 47072;
	...
	public:
		...
		::NPCCrowd::Animation::NPCAvatarTest* __4__this; // 0x20
		::MoleMole::Battle::Entity* _entity_5__2; // 0x28
		::System::Int32 __1__state; // 0x30
		::System::Int32 sectionID; // 0x34
