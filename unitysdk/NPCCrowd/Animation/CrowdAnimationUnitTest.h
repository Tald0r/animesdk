...
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST_GETCROWDNPCTESTCASES_OFFSET UNITYSDK_OFFSET(0x6520CC0)
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST_GETGENDERSIZEANIMATIONS_OFFSET UNITYSDK_OFFSET(0x6520860)
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST_GET_UNITTESTCASENAME_OFFSET UNITYSDK_OFFSET(0x6520820)
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST__CTOR_OFFSET UNITYSDK_OFFSET(0x6520E90)
#define NPCCROWD_ANIMATION_CROWDANIMATIONUNITTEST___BASE_GETCROWDNPCTESTCASES_OFFSET UNITYSDK_OFFSET(0x6520F10)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int CrowdAnimationUnitTest_TypeDefinitionIndex = 75854;
