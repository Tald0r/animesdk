...
#define NPCCROWD_ANIMATION_NPCAVATARTEST_CHECKINIT_OFFSET UNITYSDK_OFFSET(0xC2F8990)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_CREATETESTNPC_OFFSET UNITYSDK_OFFSET(0xC2F8EC0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_ICREATETESTNPC_OFFSET UNITYSDK_OFFSET(0xC2F8FD0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_OPENDEBUGINSPECTOR_OFFSET UNITYSDK_OFFSET(0xC2F8D60)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_PLAYANIM_OFFSET UNITYSDK_OFFSET(0xC2F9270)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_PLAYGRAPH_OFFSET UNITYSDK_OFFSET(0xC2F9520)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_REBUILDGRAPH_OFFSET UNITYSDK_OFFSET(0xC2F94C0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_SETCLIPSPEED_OFFSET UNITYSDK_OFFSET(0xC2F9420)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_SETPATHSTATE_OFFSET UNITYSDK_OFFSET(0xC2F8AF0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_SPAWNCOLLECTION_OFFSET UNITYSDK_OFFSET(0xC2F8BD0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_STARTSPAWNNPC_OFFSET UNITYSDK_OFFSET(0xC2F9080)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_STOPANIM_OFFSET UNITYSDK_OFFSET(0xC2F9310)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_STOPSPAWN_OFFSET UNITYSDK_OFFSET(0xC2F9210)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_TEST500ABILITY_OFFSET UNITYSDK_OFFSET(0xC2F9580)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_UPDATE_OFFSET UNITYSDK_OFFSET(0xC2F8920)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_WHILESPAWN_OFFSET UNITYSDK_OFFSET(0xC2F9170)
#define NPCCROWD_ANIMATION_NPCAVATARTEST__CTOR_OFFSET UNITYSDK_OFFSET(0xC2F9640)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAvatarTest_TypeDefinitionIndex = 50398;
