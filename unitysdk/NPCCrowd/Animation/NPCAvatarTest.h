...
#define NPCCROWD_ANIMATION_NPCAVATARTEST_CHECKINIT_OFFSET UNITYSDK_OFFSET(0x77D7210)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_CREATETESTNPC_OFFSET UNITYSDK_OFFSET(0x77D7740)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_ICREATETESTNPC_OFFSET UNITYSDK_OFFSET(0x77D7860)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_OPENDEBUGINSPECTOR_OFFSET UNITYSDK_OFFSET(0x77D75E0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x77D7B00)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_PLAYGRAPH_OFFSET UNITYSDK_OFFSET(0x77D7DA0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_REBUILDGRAPH_OFFSET UNITYSDK_OFFSET(0x77D7D40)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_SETCLIPSPEED_OFFSET UNITYSDK_OFFSET(0x77D7CA0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_SETPATHSTATE_OFFSET UNITYSDK_OFFSET(0x77D7370)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_SPAWNCOLLECTION_OFFSET UNITYSDK_OFFSET(0x77D7450)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_STARTSPAWNNPC_OFFSET UNITYSDK_OFFSET(0x77D7910)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_STOPANIM_OFFSET UNITYSDK_OFFSET(0x77D7BA0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_STOPSPAWN_OFFSET UNITYSDK_OFFSET(0x77D7AA0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_TEST500ABILITY_OFFSET UNITYSDK_OFFSET(0x77D7E00)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_UPDATE_OFFSET UNITYSDK_OFFSET(0x77D71A0)
#define NPCCROWD_ANIMATION_NPCAVATARTEST_WHILESPAWN_OFFSET UNITYSDK_OFFSET(0x77D7A00)
#define NPCCROWD_ANIMATION_NPCAVATARTEST__CTOR_OFFSET UNITYSDK_OFFSET(0x77D7EC0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAvatarTest_TypeDefinitionIndex = 47070;
