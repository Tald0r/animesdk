...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERANIMATIONCLIPOVERRIDEITEM_ASSIGNTO_OFFSET UNITYSDK_OFFSET(0x751B580)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERANIMATIONCLIPOVERRIDEITEM_ISSAMEITEM_OFFSET UNITYSDK_OFFSET(0x751B600)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERANIMATIONCLIPOVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x751B6A0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerAnimationClipOverrideItem_TypeDefinitionIndex = 55277;
