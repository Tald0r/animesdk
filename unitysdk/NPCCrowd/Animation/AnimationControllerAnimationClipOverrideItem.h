...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERANIMATIONCLIPOVERRIDEITEM_ASSIGNTO_OFFSET UNITYSDK_OFFSET(0x757BF70)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERANIMATIONCLIPOVERRIDEITEM_ISSAMEITEM_OFFSET UNITYSDK_OFFSET(0x757BFF0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERANIMATIONCLIPOVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x757C090)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerAnimationClipOverrideItem_TypeDefinitionIndex = 56702;
