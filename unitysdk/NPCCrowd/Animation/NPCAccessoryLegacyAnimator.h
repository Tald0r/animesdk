...
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_BINDBONETRANSFORM_OFFSET UNITYSDK_OFFSET(0x60BA800)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_FORCESYNCANIMATOR_OFFSET UNITYSDK_OFFSET(0x60B9FE0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_FORCESYNC_OFFSET UNITYSDK_OFFSET(0x60B99A0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETANIMATORDATA_1_OFFSET UNITYSDK_OFFSET(0x60B8980)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETANIMATORDATA_OFFSET UNITYSDK_OFFSET(0x60B88A0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETANIMATORTRANSFORM_OFFSET UNITYSDK_OFFSET(0x60BA640)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETANIMATOR_OFFSET UNITYSDK_OFFSET(0x60BA5E0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETAVATAR_OFFSET UNITYSDK_OFFSET(0x60B9E70)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETBINDEDBONETRANSFORM_OFFSET UNITYSDK_OFFSET(0x60BA720)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_GETWORLDTIME_OFFSET UNITYSDK_OFFSET(0x60B9290)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_INIT_OFFSET UNITYSDK_OFFSET(0x60B81A0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_LATEUPDATE_1_OFFSET UNITYSDK_OFFSET(0x60B9DF0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x60B9D10)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x60BA4E0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_PLAYANIMATIONCLIPBYID_OFFSET UNITYSDK_OFFSET(0x60B8DF0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_PLAYANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0x60B9300)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_REFRESHBINDBONETRANSFORM_OFFSET UNITYSDK_OFFSET(0x60BAA40)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETANIMATIONSPEED_OFFSET UNITYSDK_OFFSET(0x60B8CF0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETANIMATORLOD_OFFSET UNITYSDK_OFFSET(0x60B9F50)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETATTACHMENTPOSITION_OFFSET UNITYSDK_OFFSET(0x60B89F0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETATTACHMENTROTATION_OFFSET UNITYSDK_OFFSET(0x60B8AA0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETATTACHMENTSCALE_OFFSET UNITYSDK_OFFSET(0x60B8B50)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETHIGHQUALITYCULLMODE_OFFSET UNITYSDK_OFFSET(0x60BA560)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SETTICKPAUSESTATE_OFFSET UNITYSDK_OFFSET(0x60B8C00)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_STOPMAINANIMATION_OFFSET UNITYSDK_OFFSET(0x60B9400)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_SYNCMAINCLIPTIME_OFFSET UNITYSDK_OFFSET(0x60BA1C0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_UPDATEANIMATORDATA_OFFSET UNITYSDK_OFFSET(0x60B95F0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x60B9CA0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x60B94F0)
#define NPCCROWD_ANIMATION_NPCACCESSORYLEGACYANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x60BAD30)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAccessoryLegacyAnimator_TypeDefinitionIndex = 67050;
	...
	public:
		...
		::System::Boolean bNeedForceSync; // 0x68
		::System::Boolean bIsEnableUpdate; // 0x69
		::System::Boolean bWasVisible; // 0x6A
		::System::Boolean bInited; // 0x6B
		::NPCCrowd::Animation::FNPCAnimatorRuntimeInstanceAnimClipData animatorBufferData_Cur; // 0x6C
