...
#define NPCCROWD_ANIMATION_PHASESECTION_CALCULATELOSSFUNCTIONVALUE_OFFSET UNITYSDK_OFFSET(0x3815F0)
#define NPCCROWD_ANIMATION_PHASESECTION_CALCULATELOSSFUNCTION_OFFSET UNITYSDK_OFFSET(0x3813F0)
#define NPCCROWD_ANIMATION_PHASESECTION_COULDMATCHPHASE_OFFSET UNITYSDK_OFFSET(0x9B09520)
#define NPCCROWD_ANIMATION_PHASESECTION_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x381270)
#define NPCCROWD_ANIMATION_PHASESECTION_ENSURETIME01_OFFSET UNITYSDK_OFFSET(0x9B08DB0)
#define NPCCROWD_ANIMATION_PHASESECTION_EVALUATEPHASE_OFFSET UNITYSDK_OFFSET(0x381300)
#define NPCCROWD_ANIMATION_PHASESECTION_EVALUATETIME_OFFSET UNITYSDK_OFFSET(0x381350)
#define NPCCROWD_ANIMATION_PHASESECTION_EVALUATE_OFFSET UNITYSDK_OFFSET(0x381260)
#define NPCCROWD_ANIMATION_PHASESECTION_GENERATELOSSFUNCTIONDERIVATIVEZEROEQUATION_OFFSET UNITYSDK_OFFSET(0x3814C0)
#define NPCCROWD_ANIMATION_PHASESECTION_GETZEROEQUATIONINPUTRANGE_OFFSET UNITYSDK_OFFSET(0x3814A0)
#define NPCCROWD_ANIMATION_PHASESECTION_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x381140)
#define NPCCROWD_ANIMATION_PHASESECTION_GET_FOOTSTATUS_OFFSET UNITYSDK_OFFSET(0x381180)
#define NPCCROWD_ANIMATION_PHASESECTION_GET_ISZEROSECTION_OFFSET UNITYSDK_OFFSET(0x381370)
#define NPCCROWD_ANIMATION_PHASESECTION_ISSINGLEFOOT_OFFSET UNITYSDK_OFFSET(0x9B09510)
#define NPCCROWD_ANIMATION_PHASESECTION_MATCHZEROSECTION_OFFSET UNITYSDK_OFFSET(0x381390)
#define NPCCROWD_ANIMATION_PHASESECTION_MATCH_OFFSET UNITYSDK_OFFSET(0x3813C0)
#define NPCCROWD_ANIMATION_PHASESECTION_SELECT_OFFSET UNITYSDK_OFFSET(0x381360)
#define NPCCROWD_ANIMATION_PHASESECTION_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x381150)
#define NPCCROWD_ANIMATION_PHASESECTION_SET_FOOTSTATUS_OFFSET UNITYSDK_OFFSET(0x381190)
#define NPCCROWD_ANIMATION_PHASESECTION_SLICE_OFFSET UNITYSDK_OFFSET(0x381240)
#define NPCCROWD_ANIMATION_PHASESECTION_UPDATEBYLOSSFUNCTIONEXTREME_OFFSET UNITYSDK_OFFSET(0x381440)
#define NPCCROWD_ANIMATION_PHASESECTION_UPDATELOSSFUNCTIONRESULT_OFFSET UNITYSDK_OFFSET(0x381550)
#define NPCCROWD_ANIMATION_PHASESECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x9B0B4B0)
#define NPCCROWD_ANIMATION_PHASESECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x381210)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int PhaseSection_TypeDefinitionIndex = 61588;

	struct alignas(4) PhaseSection
	{
		static ::Foundation::Unreal::Interval_1<::System::Single>* StaticGet_DecelerateDecreasing()
		{
			return (::Foundation::Unreal::Interval_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(PhaseSection_TypeDefinitionIndex)->GetStaticField(0x10D00);
		}
		static ::Foundation::Unreal::Interval_1<::System::Single>* StaticGet_AccelerateDecreasing()
		{
			return (::Foundation::Unreal::Interval_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(PhaseSection_TypeDefinitionIndex)->GetStaticField(0x10D10);
		}
		static ::Foundation::Unreal::Interval_1<::System::Single>* StaticGet_DecelerateIncreasing()
		{
			return (::Foundation::Unreal::Interval_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(PhaseSection_TypeDefinitionIndex)->GetStaticField(0x10D20);
		}
		static ::Foundation::Unreal::Interval_1<::System::Single>* StaticGet_AccelerateIncreasing()
		{
			return (::Foundation::Unreal::Interval_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(PhaseSection_TypeDefinitionIndex)->GetStaticField(0x10D30);
		}
