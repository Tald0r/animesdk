...
#define NPCCROWD_ANIMATION_PHASESECTION_CALCULATELOSSFUNCTIONVALUE_OFFSET UNITYSDK_OFFSET(0x36CCF0)
#define NPCCROWD_ANIMATION_PHASESECTION_CALCULATELOSSFUNCTION_OFFSET UNITYSDK_OFFSET(0x36CAF0)
#define NPCCROWD_ANIMATION_PHASESECTION_COULDMATCHPHASE_OFFSET UNITYSDK_OFFSET(0x72315B0)
#define NPCCROWD_ANIMATION_PHASESECTION_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x320DE0)
#define NPCCROWD_ANIMATION_PHASESECTION_ENSURETIME01_OFFSET UNITYSDK_OFFSET(0x7230E40)
#define NPCCROWD_ANIMATION_PHASESECTION_EVALUATEPHASE_OFFSET UNITYSDK_OFFSET(0x320E70)
#define NPCCROWD_ANIMATION_PHASESECTION_EVALUATETIME_OFFSET UNITYSDK_OFFSET(0x320EC0)
#define NPCCROWD_ANIMATION_PHASESECTION_EVALUATE_OFFSET UNITYSDK_OFFSET(0x320DD0)
#define NPCCROWD_ANIMATION_PHASESECTION_GENERATELOSSFUNCTIONDERIVATIVEZEROEQUATION_OFFSET UNITYSDK_OFFSET(0x36CBC0)
#define NPCCROWD_ANIMATION_PHASESECTION_GETZEROEQUATIONINPUTRANGE_OFFSET UNITYSDK_OFFSET(0x36CBA0)
#define NPCCROWD_ANIMATION_PHASESECTION_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x320CB0)
#define NPCCROWD_ANIMATION_PHASESECTION_GET_FOOTSTATUS_OFFSET UNITYSDK_OFFSET(0x320CF0)
#define NPCCROWD_ANIMATION_PHASESECTION_GET_ISZEROSECTION_OFFSET UNITYSDK_OFFSET(0x320EE0)
#define NPCCROWD_ANIMATION_PHASESECTION_ISSINGLEFOOT_OFFSET UNITYSDK_OFFSET(0x72315A0)
#define NPCCROWD_ANIMATION_PHASESECTION_MATCHZEROSECTION_OFFSET UNITYSDK_OFFSET(0x320F00)
#define NPCCROWD_ANIMATION_PHASESECTION_MATCH_OFFSET UNITYSDK_OFFSET(0x36CAC0)
#define NPCCROWD_ANIMATION_PHASESECTION_SELECT_OFFSET UNITYSDK_OFFSET(0x320ED0)
#define NPCCROWD_ANIMATION_PHASESECTION_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x320CC0)
#define NPCCROWD_ANIMATION_PHASESECTION_SET_FOOTSTATUS_OFFSET UNITYSDK_OFFSET(0x320D00)
#define NPCCROWD_ANIMATION_PHASESECTION_SLICE_OFFSET UNITYSDK_OFFSET(0x320DB0)
#define NPCCROWD_ANIMATION_PHASESECTION_UPDATEBYLOSSFUNCTIONEXTREME_OFFSET UNITYSDK_OFFSET(0x36CB40)
#define NPCCROWD_ANIMATION_PHASESECTION_UPDATELOSSFUNCTIONRESULT_OFFSET UNITYSDK_OFFSET(0x36CC50)
#define NPCCROWD_ANIMATION_PHASESECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x99AF9B0)
#define NPCCROWD_ANIMATION_PHASESECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x320D80)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int PhaseSection_TypeDefinitionIndex = 68007;

	struct alignas(4) PhaseSection
	{
		static ::Foundation::Unreal::Interval_1<::System::Single>* StaticGet_DecelerateIncreasing()
		{
			return (::Foundation::Unreal::Interval_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(PhaseSection_TypeDefinitionIndex)->GetStaticField(0x11790);
		}
		static ::Foundation::Unreal::Interval_1<::System::Single>* StaticGet_DecelerateDecreasing()
		{
			return (::Foundation::Unreal::Interval_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(PhaseSection_TypeDefinitionIndex)->GetStaticField(0x117A0);
		}
		static ::Foundation::Unreal::Interval_1<::System::Single>* StaticGet_AccelerateIncreasing()
		{
			return (::Foundation::Unreal::Interval_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(PhaseSection_TypeDefinitionIndex)->GetStaticField(0x117B0);
		}
		static ::Foundation::Unreal::Interval_1<::System::Single>* StaticGet_AccelerateDecreasing()
		{
			return (::Foundation::Unreal::Interval_1<::System::Single>*)Il2CppClass::FromTypeDefinitionIndex(PhaseSection_TypeDefinitionIndex)->GetStaticField(0x117C0);
		}
