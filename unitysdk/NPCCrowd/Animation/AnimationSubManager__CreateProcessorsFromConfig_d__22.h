...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER__CREATEPROCESSORSFROMCONFIG_D__22_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x6EC72C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER__CREATEPROCESSORSFROMCONFIG_D__22_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_IANIMATIONPROCESSOR__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x6EC7600)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER__CREATEPROCESSORSFROMCONFIG_D__22_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_IANIMATIONPROCESSOR__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x6EC7590)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER__CREATEPROCESSORSFROMCONFIG_D__22_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x6EC7680)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER__CREATEPROCESSORSFROMCONFIG_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x6EC75F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER__CREATEPROCESSORSFROMCONFIG_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x6EC75A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER__CREATEPROCESSORSFROMCONFIG_D__22_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6EC72B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER__CREATEPROCESSORSFROMCONFIG_D__22__CTOR_OFFSET UNITYSDK_OFFSET(0x6EC7290)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager__CreateProcessorsFromConfig_d__22_TypeDefinitionIndex = 71207;
	...
	public:
		...
		::NPCCrowd::Animation::AnimationSubManager* manager; // 0x18
		::NPCCrowd::Animation::AnimationSubManager_IAnimationProcessor* __2__current; // 0x20
