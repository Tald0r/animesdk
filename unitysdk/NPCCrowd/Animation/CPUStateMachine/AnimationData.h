...
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_EXTRACTROOTMOTION_OFFSET UNITYSDK_OFFSET(0x33D020)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GETNORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0x33CFA0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GETSAMPLETIME_OFFSET UNITYSDK_OFFSET(0x33CFD0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_HASADJUSTMENTBLENDING_OFFSET UNITYSDK_OFFSET(0x33CF30)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_HASPHASEMATCHING_OFFSET UNITYSDK_OFFSET(0x33CF20)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_HASROOTMOTION_OFFSET UNITYSDK_OFFSET(0x33CF10)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_ISLOOPING_OFFSET UNITYSDK_OFFSET(0x33CF00)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_STRIPBIPMOTION_OFFSET UNITYSDK_OFFSET(0x33CF40)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x33CF50)

namespace NPCCrowd::Animation::CPUStateMachine
{
	inline static constexpr unsigned int AnimationData_TypeDefinitionIndex = 63367;
