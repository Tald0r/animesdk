...
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_EXTRACTROOTMOTION_OFFSET UNITYSDK_OFFSET(0x317DC0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GETNORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0x317D40)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GETSAMPLETIME_OFFSET UNITYSDK_OFFSET(0x317D70)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_HASADJUSTMENTBLENDING_OFFSET UNITYSDK_OFFSET(0x317CD0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_HASPHASEMATCHING_OFFSET UNITYSDK_OFFSET(0x317CC0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_HASROOTMOTION_OFFSET UNITYSDK_OFFSET(0x317CB0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_ISLOOPING_OFFSET UNITYSDK_OFFSET(0x317CA0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA_GET_STRIPBIPMOTION_OFFSET UNITYSDK_OFFSET(0x317CE0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x317CF0)

namespace NPCCrowd::Animation::CPUStateMachine
{
	inline static constexpr unsigned int AnimationData_TypeDefinitionIndex = 40180;
