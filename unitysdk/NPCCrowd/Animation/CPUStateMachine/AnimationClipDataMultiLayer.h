...
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATAMULTILAYER_CLEARMASK_OFFSET UNITYSDK_OFFSET(0x380E70)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATAMULTILAYER_GETLAYERCLIPDATA_OFFSET UNITYSDK_OFFSET(0x380F60)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATAMULTILAYER_INITDATA_OFFSET UNITYSDK_OFFSET(0x380E40)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATAMULTILAYER_SETVALIDLAYERMASK_OFFSET UNITYSDK_OFFSET(0x380EE0)

namespace NPCCrowd::Animation::CPUStateMachine
{
	inline static constexpr unsigned int AnimationClipDataMultiLayer_TypeDefinitionIndex = 41498;
