...
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATA_GET_HASADDITIONALANIMATION_OFFSET UNITYSDK_OFFSET(0x2C9F90)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATA_GET_SAMPLETIME_OFFSET UNITYSDK_OFFSET(0x2C9F40)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2C9FE0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONCLIPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x2C9FB0)

namespace NPCCrowd::Animation::CPUStateMachine
{
	inline static constexpr unsigned int AnimationClipData_TypeDefinitionIndex = 39603;
