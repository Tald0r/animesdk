...
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONFOOTAREAMATCHINGRESULT_GET_DELTAAREA_OFFSET UNITYSDK_OFFSET(0x2C4B10)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONFOOTAREAMATCHINGRESULT_GET_DELTADERIVATIVE_OFFSET UNITYSDK_OFFSET(0x2C4B30)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONFOOTAREAMATCHINGRESULT_GET_TIME_OFFSET UNITYSDK_OFFSET(0x2C4AF0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONFOOTAREAMATCHINGRESULT_NEW_OFFSET UNITYSDK_OFFSET(0x5E09FE0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONFOOTAREAMATCHINGRESULT_SET_DELTAAREA_OFFSET UNITYSDK_OFFSET(0x2C4B20)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONFOOTAREAMATCHINGRESULT_SET_DELTADERIVATIVE_OFFSET UNITYSDK_OFFSET(0x2C4B40)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONFOOTAREAMATCHINGRESULT_SET_TIME_OFFSET UNITYSDK_OFFSET(0x2C4B00)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONFOOTAREAMATCHINGRESULT_UPDATE_OFFSET UNITYSDK_OFFSET(0x2C4B50)

namespace NPCCrowd::Animation::CPUStateMachine
{
	inline static constexpr unsigned int AnimationFootAreaMatchingResult_TypeDefinitionIndex = 53468;
