...
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONTICKDATA_GET_HASROOTMOTION_OFFSET UNITYSDK_OFFSET(0x3160C0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONTICKDATA_GET_ISLOOP_OFFSET UNITYSDK_OFFSET(0x316090)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONTICKDATA_GET_PLAYMODE_OFFSET UNITYSDK_OFFSET(0x316080)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONTICKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x3160A0)

namespace NPCCrowd::Animation::CPUStateMachine
{
	inline static constexpr unsigned int AnimationTickData_TypeDefinitionIndex = 46633;
