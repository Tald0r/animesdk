...
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONTICKDATA_GET_HASROOTMOTION_OFFSET UNITYSDK_OFFSET(0x33CA00)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONTICKDATA_GET_ISLOOP_OFFSET UNITYSDK_OFFSET(0x33C9D0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONTICKDATA_GET_PLAYMODE_OFFSET UNITYSDK_OFFSET(0x33C9C0)
#define NPCCROWD_ANIMATION_CPUSTATEMACHINE_ANIMATIONTICKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x33C9E0)

namespace NPCCrowd::Animation::CPUStateMachine
{
	inline static constexpr unsigned int AnimationTickData_TypeDefinitionIndex = 71331;
