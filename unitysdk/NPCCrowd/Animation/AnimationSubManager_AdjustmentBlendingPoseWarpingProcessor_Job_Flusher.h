...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_FLUSHER_APPLYLOOPCOUNT_OFFSET UNITYSDK_OFFSET(0x33C820)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_FLUSHER_FOUNDATION_IIN_OFFSET UNITYSDK_OFFSET(0x33C810)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPOSEWARPINGPROCESSOR_JOB_FLUSHER__CTOR_OFFSET UNITYSDK_OFFSET(0x33C6F0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingPoseWarpingProcessor_Job_Flusher_TypeDefinitionIndex = 59709;
