...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6EC7260)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerData_TypeDefinitionIndex = 44454;
