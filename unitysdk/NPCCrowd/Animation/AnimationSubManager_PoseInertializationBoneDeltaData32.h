...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_APPLYTOROTATION_OFFSET UNITYSDK_OFFSET(0x31D8D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_APPLYTOSCALE_OFFSET UNITYSDK_OFFSET(0x31DA80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_APPLYTOTRANSLATION_OFFSET UNITYSDK_OFFSET(0x31D760)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_APPLYTO_OFFSET UNITYSDK_OFFSET(0x31DD00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_EVALUATE_OFFSET UNITYSDK_OFFSET(0x6FA56B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GENERATE_OFFSET UNITYSDK_OFFSET(0x6FA5830)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_ROTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x2F2ED0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_ROTATIONDURATION_OFFSET UNITYSDK_OFFSET(0x2F2F70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_ROTATIONPOLYNOMIAL_OFFSET UNITYSDK_OFFSET(0x31D5B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_SCALEAXIS_OFFSET UNITYSDK_OFFSET(0x2F2F10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_SCALEDURATION_OFFSET UNITYSDK_OFFSET(0x2F2F90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_SCALEPOLYNOMIAL_OFFSET UNITYSDK_OFFSET(0x31D670)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_TRANSLATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x2F2E90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_TRANSLATIONDURATION_OFFSET UNITYSDK_OFFSET(0x2F2F50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_GET_TRANSLATIONPOLYNOMIAL_OFFSET UNITYSDK_OFFSET(0x31D4F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_INITROTATION_OFFSET UNITYSDK_OFFSET(0x31D740)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_INITSCALE_OFFSET UNITYSDK_OFFSET(0x31D750)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_INITTRANSLATION_OFFSET UNITYSDK_OFFSET(0x31D730)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_INIT_OFFSET UNITYSDK_OFFSET(0x31DBF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_IPOSEINERTIALIZATIONBONEDELTADATA_INIT_OFFSET UNITYSDK_OFFSET(0x31E1F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_SET_ROTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x2F2EF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_SET_ROTATIONDURATION_OFFSET UNITYSDK_OFFSET(0x2F2F80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_SET_SCALEAXIS_OFFSET UNITYSDK_OFFSET(0x2F2F30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_SET_SCALEDURATION_OFFSET UNITYSDK_OFFSET(0x2F2FA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_SET_TRANSLATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x2F2EB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA32_SET_TRANSLATIONDURATION_OFFSET UNITYSDK_OFFSET(0x2F2F60)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PoseInertializationBoneDeltaData32_TypeDefinitionIndex = 59719;
