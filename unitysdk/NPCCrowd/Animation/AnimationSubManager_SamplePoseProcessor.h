...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x640D940)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_DISPATCH_OFFSET UNITYSDK_OFFSET(0x640CEB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x640CCE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_GET_MAXPHASE_OFFSET UNITYSDK_OFFSET(0x640CCD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_GET_MINPHASE_OFFSET UNITYSDK_OFFSET(0x640CCC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x640CD40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x640DD40)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_SamplePoseProcessor_TypeDefinitionIndex = 59723;
