...
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_BUILDCURVEID_OFFSET UNITYSDK_OFFSET(0x74480D0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7447EA0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_FINDANIMATION_OFFSET UNITYSDK_OFFSET(0x74476F0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_FINDGENERICCURVE_OFFSET UNITYSDK_OFFSET(0x7447C10)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_FINDORADDANIMATION_OFFSET UNITYSDK_OFFSET(0x7447930)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GETBONEINDEX_OFFSET UNITYSDK_OFFSET(0x7447DB0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GETSKELETON_OFFSET UNITYSDK_OFFSET(0x7447D10)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GET_BONECOUNT_OFFSET UNITYSDK_OFFSET(0x74475B0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x7447570)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x7447590)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0x7447550)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_SET_BONECOUNT_OFFSET UNITYSDK_OFFSET(0x74475C0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x7447580)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_SET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x74475A0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_SET_SKELETON_OFFSET UNITYSDK_OFFSET(0x7447560)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE__CCTOR_OFFSET UNITYSDK_OFFSET(0x7448100)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x74475D0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAnimationLib_AvatarAnimatorCache_TypeDefinitionIndex = 74738;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(NPCAnimationLib_AvatarAnimatorCache_TypeDefinitionIndex)->GetStaticField(0xBB50);
		}
		...
		::System::Collections::Generic::Dictionary_2<::UnityEngine::NapAnimator_GenericCurveID, ::System::Int32>* _curveLookupTable; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>* _boneIndexLookupTable; // 0x28
		::System::Collections::Generic::Dictionary_2<::UnityEngine::AnimationClip*, ::System::Int32>* _clipLookupTable; // 0x30
		::UnityEngine::NapAnimator* _animator; // 0x38
		::System::Int32 _InstanceId_k__BackingField; // 0x40
		::System::Int32 _BoneCount_k__BackingField; // 0x44
		...
		{
			return ((::NPCCrowd::Animation::NPCAnimationLib_AnimationId(*)(::PVOID, ::UnityEngine::AnimationClip*))((::PBYTE)hIl2Cpp + NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_FINDORADDANIMATION_OFFSET))(this, clip);
		}
