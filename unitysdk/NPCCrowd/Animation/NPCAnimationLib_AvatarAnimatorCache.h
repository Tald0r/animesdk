...
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_BUILDCURVEID_OFFSET UNITYSDK_OFFSET(0x6FA75C0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6FA7390)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_FINDANIMATION_OFFSET UNITYSDK_OFFSET(0x6FA6BC0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_FINDGENERICCURVE_OFFSET UNITYSDK_OFFSET(0x6FA7100)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_FINDORADDANIMATION_OFFSET UNITYSDK_OFFSET(0x6FA6E00)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GETBONEINDEX_OFFSET UNITYSDK_OFFSET(0x6FA72A0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GETSKELETON_OFFSET UNITYSDK_OFFSET(0x6FA7200)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GET_BONECOUNT_OFFSET UNITYSDK_OFFSET(0x6FA6A80)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x6FA6A40)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x6FA6A60)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0x6FA6A20)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_SET_BONECOUNT_OFFSET UNITYSDK_OFFSET(0x6FA6A90)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x6FA6A50)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_SET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x6FA6A70)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE_SET_SKELETON_OFFSET UNITYSDK_OFFSET(0x6FA6A30)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE__CCTOR_OFFSET UNITYSDK_OFFSET(0x6FA75F0)
#define NPCCROWD_ANIMATION_NPCANIMATIONLIB_AVATARANIMATORCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x6FA6AA0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAnimationLib_AvatarAnimatorCache_TypeDefinitionIndex = 54262;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>* _boneIndexLookupTable; // 0x10
		...
		::NPCCrowd::Animation::AnimationControllerInstanceConfig* _Config_k__BackingField; // 0x28
		::UnityEngine::Avatar* _Skeleton_k__BackingField; // 0x30
