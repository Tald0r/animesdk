...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPREUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x6ECBF40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPREUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x6ECBF30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPREUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x6ECBFA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPREUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x6ECC0A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHPREUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6ECC250)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FlushPreUpdateProcessor_TypeDefinitionIndex = 71128;
