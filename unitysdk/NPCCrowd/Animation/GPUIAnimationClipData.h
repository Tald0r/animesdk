...
#define NPCCROWD_ANIMATION_GPUIANIMATIONCLIPDATA_HASROOTMOTION_OFFSET UNITYSDK_OFFSET(0x33CAC0)
#define NPCCROWD_ANIMATION_GPUIANIMATIONCLIPDATA_ISCLIPLOOPING_OFFSET UNITYSDK_OFFSET(0x33CBA0)
#define NPCCROWD_ANIMATION_GPUIANIMATIONCLIPDATA_ISLOOPDISABLED_OFFSET UNITYSDK_OFFSET(0x33CB30)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int GPUIAnimationClipData_TypeDefinitionIndex = 78745;
