...
#define NPCCROWD_ANIMATION_GPUIANIMATIONCLIPDATA_HASROOTMOTION_OFFSET UNITYSDK_OFFSET(0x316180)
#define NPCCROWD_ANIMATION_GPUIANIMATIONCLIPDATA_ISCLIPLOOPING_OFFSET UNITYSDK_OFFSET(0x316260)
#define NPCCROWD_ANIMATION_GPUIANIMATIONCLIPDATA_ISLOOPDISABLED_OFFSET UNITYSDK_OFFSET(0x3161F0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int GPUIAnimationClipData_TypeDefinitionIndex = 74939;
