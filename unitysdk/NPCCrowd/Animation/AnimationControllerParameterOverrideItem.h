...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_APPLY_1_OFFSET UNITYSDK_OFFSET(0x6349200)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_APPLY_OFFSET UNITYSDK_OFFSET(0x6348B70)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_ASSIGNTO_OFFSET UNITYSDK_OFFSET(0x6349330)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0x63490E0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_ISSAMEITEM_OFFSET UNITYSDK_OFFSET(0x63493D0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_MATCHES_OFFSET UNITYSDK_OFFSET(0x6348AD0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x6348DF0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x6349470)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerParameterOverrideItem_TypeDefinitionIndex = 75087;
