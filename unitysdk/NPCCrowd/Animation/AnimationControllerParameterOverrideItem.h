...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_APPLY_1_OFFSET UNITYSDK_OFFSET(0x5E07A20)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_APPLY_OFFSET UNITYSDK_OFFSET(0x5E07390)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_ASSIGNTO_OFFSET UNITYSDK_OFFSET(0x5E07B50)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0x5E07900)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_ISSAMEITEM_OFFSET UNITYSDK_OFFSET(0x5E07BF0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_MATCHES_OFFSET UNITYSDK_OFFSET(0x5E072F0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x5E07610)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMETEROVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x5E07C90)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerParameterOverrideItem_TypeDefinitionIndex = 71684;
