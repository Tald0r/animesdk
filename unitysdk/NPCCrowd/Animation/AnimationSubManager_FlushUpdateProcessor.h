...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x63FF530)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x63FF520)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x63FF590)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_PROCESSWARPINGCOMPENSATE_OFFSET UNITYSDK_OFFSET(0x6400CE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x63FF6D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_SYNCSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x6400360)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6401620)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FlushUpdateProcessor_TypeDefinitionIndex = 59704;
