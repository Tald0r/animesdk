...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x6A03750)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x6A03740)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x6A037B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_PROCESSWARPINGCOMPENSATE_OFFSET UNITYSDK_OFFSET(0x6A04EE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x6A038F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR_SYNCSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x6A04570)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6A05820)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FlushUpdateProcessor_TypeDefinitionIndex = 71200;
