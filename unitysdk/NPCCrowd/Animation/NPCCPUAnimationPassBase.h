...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONPASSBASE_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x780A8B0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONPASSBASE_CONNECT_OFFSET UNITYSDK_OFFSET(0x780A3B0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONPASSBASE_DESTROY_OFFSET UNITYSDK_OFFSET(0x780A850)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONPASSBASE_DISCONNECT_OFFSET UNITYSDK_OFFSET(0x780A550)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONPASSBASE_GETOUTPUTPLAYABLE_OFFSET UNITYSDK_OFFSET(0x780A330)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONPASSBASE_INIT_OFFSET UNITYSDK_OFFSET(0x780A790)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONPASSBASE_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x780A700)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONPASSBASE_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x780A670)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONPASSBASE_RESET_OFFSET UNITYSDK_OFFSET(0x780A7F0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONPASSBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x780A940)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationPassBase_TypeDefinitionIndex = 55210;
