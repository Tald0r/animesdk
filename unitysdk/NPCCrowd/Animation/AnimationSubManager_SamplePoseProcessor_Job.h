...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_JOB_BONEEXTRACT_OFFSET UNITYSDK_OFFSET(0x7581360)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x3273B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_JOB_EXTRACTPOSE_OFFSET UNITYSDK_OFFSET(0x757F870)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x3273A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_JOB__CTOR_OFFSET UNITYSDK_OFFSET(0x326FE0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_SamplePoseProcessor_Job_TypeDefinitionIndex = 71167;
