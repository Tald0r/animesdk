...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_JOB_BONEEXTRACT_OFFSET UNITYSDK_OFFSET(0x75209C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x32E5F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_JOB_EXTRACTPOSE_OFFSET UNITYSDK_OFFSET(0x751EF70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x32E5E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEPOSEPROCESSOR_JOB__CTOR_OFFSET UNITYSDK_OFFSET(0x32E400)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_SamplePoseProcessor_Job_TypeDefinitionIndex = 59724;
