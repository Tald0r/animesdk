...
#define NPCCROWD_ANIMATION_NPCCROWDMONTAGETEMPLATECONFIGSO__CTOR_OFFSET UNITYSDK_OFFSET(0x7230CB0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCrowdMontageTemplateConfigSO_TypeDefinitionIndex = 49096;
