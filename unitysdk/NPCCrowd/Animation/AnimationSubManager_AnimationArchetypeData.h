...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_COLLECTAVATARARCHETYPEDATA_OFFSET UNITYSDK_OFFSET(0x7EFABF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_COLLECTCOUNT_OFFSET UNITYSDK_OFFSET(0x7EFA240)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_COLLECTMONTAGEARCHETYPEDATA_OFFSET UNITYSDK_OFFSET(0x7EFA400)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_COLLECTSTATEMACHINEARCHETYPEDATA_OFFSET UNITYSDK_OFFSET(0x7EF9B70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7EF7690)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_FREE_OFFSET UNITYSDK_OFFSET(0x7EF9420)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_GETREDIRECTVALUE_OFFSET UNITYSDK_OFFSET(0x7EFC570)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_GET_INSTANCECOUNT_OFFSET UNITYSDK_OFFSET(0x7EF5F60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x7EF7BA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_GET_VISIBLEINSTANCECOUNT_OFFSET UNITYSDK_OFFSET(0x7EF5F80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_ISSAMELENGTH_OFFSET UNITYSDK_OFFSET(0x7EFAB10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_NEWINSTANCE_OFFSET UNITYSDK_OFFSET(0x7EF7F70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0x7EFAA20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_SET_INSTANCECOUNT_OFFSET UNITYSDK_OFFSET(0x7EF5F70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA_SET_VISIBLEINSTANCECOUNT_OFFSET UNITYSDK_OFFSET(0x7EF5F90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONARCHETYPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x7EF5FA0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AnimationArchetypeData_TypeDefinitionIndex = 71135;
	...
	public:
		...
		::Foundation::Adapter::ChunkList2D_1<::System::Int32>* BlendShapeCurves; // 0x10
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::AnimationSubManager_PoseInertializationCacheAdditionalData>* _inertializationAdditional2; // 0x18
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::CPUStateMachine::AnimationClipDataMultiLayer>* ClipData; // 0x20
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::AnimationSubManager_PoseInertializationRequest>* _inertializationRequest; // 0x28
		::Foundation::Adapter::ChunkList2D_1<::UnityEngine::Quaternion>* BoneAdjustMasterBoneAnimRotList; // 0x30
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::AnimationSubManager_AdjustmentBlendingWarpingTickData>* AdjustmentBlendingTickData; // 0x38
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::BlendShapeSampleData>* BlendShapeData; // 0x40
		::Foundation::Adapter::ChunkList2D_1<::NPCCrowd::Animation::AnimationSubManager_PoseInertializationBoneDeltaData16>* _inertializationDelta; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Single>* SlopeSpeedScaleLookupTable; // 0x50
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::CPUStateMachine::AnimationStateDataMultiLayer>* States; // 0x58
		::Foundation::Adapter::ChunkList2D_1<::UnityEngine::NapTransformData>* Bones; // 0x60
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::CPUStateMachine::AnimationTickData>* TickData; // 0x68
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::AnimationSubManager_PoseInertializationCacheAdditionalData>* _inertializationAdditional1; // 0x70
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::AnimationSubManager_AdjustmentBlendingMotionTarget>* AdjustmentBlendingWarpingTarget; // 0x78
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::MontageTickLayerData>* MontageData; // 0x80
		::Foundation::Adapter::ChunkList2D_1<::UnityEngine::NapTransformData>* _inertializationPose1; // 0x88
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* _redirectMap; // 0x90
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::AnimationSubManager_FootStepControlData>* FootStepControlDataList; // 0x98
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::AnimationSubManager_MotionControlData>* MotionControlDatas; // 0xA0
		::Foundation::Adapter::ChunkList2D_1<::Foundation::StateMachine::Parameter>* Params; // 0xA8
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Lod::ELODLevel>* EntityLODs; // 0xB0
		::Foundation::Adapter::ChunkList2D_1<::UnityEngine::NapTransformData>* BoneAdjustAnimDrivenPoseList; // 0xB8
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::AnimationSubManager_PoseInertializationInstanceData>* _inertializationInstances; // 0xC0
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::AnimationSubManager_AdjustmentBlendingControlData>* AdjustmentBlendingControlData; // 0xC8
		::Foundation::Adapter::ManagedChunkList_1<::Class_3_F2DAD7F45F518868*>* NpcComponents; // 0xD0
		::Foundation::Adapter::ChunkList2D_1<::UnityEngine::NapTransformData>* _inertializationPose2; // 0xD8
		::Foundation::Adapter::ChunkList_1<::System::Boolean>* BoneAdjustEnabledList; // 0xE0
		::Foundation::Adapter::ChunkList2D_1<::System::Single>* BlendShapeValues; // 0xE8
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::AnimationSubManager_IKControlData>* _ikControlData; // 0xF0
		::Foundation::Adapter::ChunkList_1<::UnityEngine::NapTransformData>* RootMotions; // 0xF8
		::Foundation::Adapter::ChunkList_1<::System::UInt32>* Instances; // 0x100
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Foundation::StateMachine::ParameterId>* ParamLookupTable; // 0x108
		::Foundation::Adapter::ChunkList_1<::UnityEngine::NapTransformData>* Transforms; // 0x110
		::Foundation::Adapter::ChunkList2D_1<::UnityEngine::NapTransformData>* BoneAdjustIkDrivenPoseList; // 0x118
		::System::Int32 _VisibleInstanceCount_k__BackingField; // 0x120
		::System::Int32 _InstanceCount_k__BackingField; // 0x124
