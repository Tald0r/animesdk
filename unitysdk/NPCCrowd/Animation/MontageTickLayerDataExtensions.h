...
#define NPCCROWD_ANIMATION_MONTAGETICKLAYERDATAEXTENSIONS_GETLAYERMONTAGEDATAREF_OFFSET UNITYSDK_OFFSET(0x722DDD0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int MontageTickLayerDataExtensions_TypeDefinitionIndex = 52116;
