...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_CREATEDAMPINGIKBUFFER_OFFSET UNITYSDK_OFFSET(0x603B6D0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_DESTROY_OFFSET UNITYSDK_OFFSET(0x603AE00)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_DISABLEDAMPINGIK_OFFSET UNITYSDK_OFFSET(0x603B940)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_ENABLEDAMPINGIK_OFFSET UNITYSDK_OFFSET(0x603B0E0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x603B070)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_GETMAINANIMCLIPSTATUES_OFFSET UNITYSDK_OFFSET(0x603AB90)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_GETMAINANIMCLIPTIME_OFFSET UNITYSDK_OFFSET(0x603AAB0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_INIT_OFFSET UNITYSDK_OFFSET(0x603AC20)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_PLAY_OFFSET UNITYSDK_OFFSET(0x603A700)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_REBUILDGRAPH_OFFSET UNITYSDK_OFFSET(0x603A140)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_RELEASEDAMPINGIKBUFFER_OFFSET UNITYSDK_OFFSET(0x603AEE0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_SETDAMPINGROOTTRANS_OFFSET UNITYSDK_OFFSET(0x603B9C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_SETMAINANIMCLIPTIME_OFFSET UNITYSDK_OFFSET(0x603A960)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_SETMAINANIMCLIP_OFFSET UNITYSDK_OFFSET(0x603A4C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_SETMAINCLIPSPEED_OFFSET UNITYSDK_OFFSET(0x603A780)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_STOPMAINANIMATION_OFFSET UNITYSDK_OFFSET(0x603A880)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x603BBF0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x603BBE0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE___BASE_DESTROY_OFFSET UNITYSDK_OFFSET(0x603BC30)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationGraphScript_SimpleOneState_TypeDefinitionIndex = 56137;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(NPCCPUAnimationGraphScript_SimpleOneState_TypeDefinitionIndex)->GetStaticField(0x3F290);
		}
		::UnityEngine::AnimationClip* clip; // 0x40
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> damping_LocalPositions; // 0x48
		::Unity::Collections::NativeArray_1<::System::Single> damping_rootParams; // 0x58
		::NPCCrowd::Animation::Job::DampingJob dampingJob; // 0x68
		::Unity::Collections::NativeArray_1<::UnityEngine::Animations::TransformStreamHandle> damping_Handles; // 0xF0
		::UnityEngine::Animations::AnimationClipPlayable mainClipPlayable; // 0x100
		::UnityEngine::Animations::AnimationScriptPlayable dampingPlayable; // 0x110
		::System::Boolean bIsEnableDampingIK; // 0x120
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> damping_Velocities; // 0x128
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> damping_Positions; // 0x138
		::Unity::Collections::NativeArray_1<::System::Single> damping_smooths; // 0x148
		::Unity::Collections::NativeArray_1<::UnityEngine::Quaternion> damping_LocalRotations; // 0x158
