...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_CREATEDAMPINGIKBUFFER_OFFSET UNITYSDK_OFFSET(0x6A00C00)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_DESTROY_OFFSET UNITYSDK_OFFSET(0x6A00320)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_DISABLEDAMPINGIK_OFFSET UNITYSDK_OFFSET(0x6A00E70)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_ENABLEDAMPINGIK_OFFSET UNITYSDK_OFFSET(0x6A00600)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x6A00590)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_GETMAINANIMCLIPSTATUES_OFFSET UNITYSDK_OFFSET(0x6A000B0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_GETMAINANIMCLIPTIME_OFFSET UNITYSDK_OFFSET(0x69FFFD0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_INIT_OFFSET UNITYSDK_OFFSET(0x6A00140)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_PLAY_OFFSET UNITYSDK_OFFSET(0x69FFC40)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_REBUILDGRAPH_OFFSET UNITYSDK_OFFSET(0x69FF690)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_RELEASEDAMPINGIKBUFFER_OFFSET UNITYSDK_OFFSET(0x6A00400)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_SETDAMPINGROOTTRANS_OFFSET UNITYSDK_OFFSET(0x6A00EF0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_SETMAINANIMCLIPTIME_OFFSET UNITYSDK_OFFSET(0x69FFE80)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_SETMAINANIMCLIP_OFFSET UNITYSDK_OFFSET(0x69FFA00)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_SETMAINCLIPSPEED_OFFSET UNITYSDK_OFFSET(0x69FFCC0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE_STOPMAINANIMATION_OFFSET UNITYSDK_OFFSET(0x69FFDB0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x6A01130)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x6A01120)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_SIMPLEONESTATE___BASE_DESTROY_OFFSET UNITYSDK_OFFSET(0x6A01170)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationGraphScript_SimpleOneState_TypeDefinitionIndex = 56773;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(NPCCPUAnimationGraphScript_SimpleOneState_TypeDefinitionIndex)->GetStaticField(0x42070);
		}
		::UnityEngine::AnimationClip* clip; // 0x40
		::Unity::Collections::NativeArray_1<::UnityEngine::Quaternion> damping_LocalRotations; // 0x48
		::Unity::Collections::NativeArray_1<::System::Single> damping_rootParams; // 0x58
		::UnityEngine::Animations::AnimationClipPlayable mainClipPlayable; // 0x68
		...
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> damping_Velocities; // 0xA8
		::Unity::Collections::NativeArray_1<::UnityEngine::Animations::TransformStreamHandle> damping_Handles; // 0xB8
		::NPCCrowd::Animation::Job::DampingJob dampingJob; // 0xC8
		::System::Boolean bIsEnableDampingIK; // 0x150
		::Unity::Collections::NativeArray_1<::UnityEngine::Vector3> damping_LocalPositions; // 0x158
