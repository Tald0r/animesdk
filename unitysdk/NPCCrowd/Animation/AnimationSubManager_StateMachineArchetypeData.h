...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_ADDADDITIONALANIMATION_OFFSET UNITYSDK_OFFSET(0x60B5110)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_ADDSHAREDDATA_OFFSET UNITYSDK_OFFSET(0x60B4730)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_CHECKSHAREDSTATEDATA_OFFSET UNITYSDK_OFFSET(0x60B5990)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_CLEARCOLLECTDATA_OFFSET UNITYSDK_OFFSET(0x60B5F30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_COLLECT_OFFSET UNITYSDK_OFFSET(0x60B6050)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x60B6310)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_FINDORADDSHAREDDATA_OFFSET UNITYSDK_OFFSET(0x60B4440)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GETSHAREDDATA_OFFSET UNITYSDK_OFFSET(0x60B5BC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GETSHAREDPARAMDATA_OFFSET UNITYSDK_OFFSET(0x60B5E00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GETSHAREDSTATEDATA_OFFSET UNITYSDK_OFFSET(0x60B5CD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GET_ISCHUNKVALID_OFFSET UNITYSDK_OFFSET(0x60B4390)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x60B4260)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GET_SHAREDDATAVIEW_OFFSET UNITYSDK_OFFSET(0x60B6280)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GET_SHAREDSTATEDATAVIEW_OFFSET UNITYSDK_OFFSET(0x60B61E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x60B6070)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x60B3770)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_StateMachineArchetypeData_TypeDefinitionIndex = 71120;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_StateMachineArchetypeData_TypeDefinitionIndex)->GetStaticField(0x36E70);
		}
		// static const ::System::Int32 ChunkSizeBit = 0x4; // 0x0
		// static const ::System::String* NormalizedTimeLayer; // 0x0
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::CPUStateMachine::SharedData>* _sharedData; // 0x10
		::Foundation::Adapter::ChunkList2D_1<::Foundation::StateMachine::Parameter>* _sharedParamData; // 0x18
		::Foundation::Adapter::ChunkList2D_1<::NPCCrowd::Animation::CPUStateMachine::SharedStateData>* _sharedStateData; // 0x20
		::Il2CppArray<::Foundation::StateMachine::StateId>* DefaultState; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::UInt64, ::System::Int32>* _sharedDataMap; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* StateLookupTable; // 0x38
		::Il2CppArray<::Foundation::Container::NativeVector_1<::System::IntPtr>>* _chunkData; // 0x40
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Foundation::StateMachine::ParameterId>* ParamLookupTable; // 0x58
		::Foundation::Container::NativeVector_1<::System::Int32> _dimensions; // 0x60
		::Foundation::Container::NativeVector_1<::System::Int32> _count; // 0x70
		::Foundation::StateMachine::Machine MachineData; // 0x80
		::Foundation::Container::NativeVector_1<::Foundation::StateMachine::ParameterId> NormalizedTimeIds; // 0x138
