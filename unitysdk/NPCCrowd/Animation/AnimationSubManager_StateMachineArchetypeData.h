...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_ADDADDITIONALANIMATION_OFFSET UNITYSDK_OFFSET(0x63A8390)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_ADDSHAREDDATA_OFFSET UNITYSDK_OFFSET(0x63A79B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_CHECKSHAREDSTATEDATA_OFFSET UNITYSDK_OFFSET(0x63A8D00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_CLEARCOLLECTDATA_OFFSET UNITYSDK_OFFSET(0x63A92A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_COLLECT_OFFSET UNITYSDK_OFFSET(0x63A93C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x63A9620)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_FINDORADDSHAREDDATA_OFFSET UNITYSDK_OFFSET(0x63A76C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GETSHAREDDATA_OFFSET UNITYSDK_OFFSET(0x63A8F30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GETSHAREDPARAMDATA_OFFSET UNITYSDK_OFFSET(0x63A9170)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GETSHAREDSTATEDATA_OFFSET UNITYSDK_OFFSET(0x63A9040)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GET_ISCHUNKVALID_OFFSET UNITYSDK_OFFSET(0x63A7610)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x63A74E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GET_SHAREDDATAVIEW_OFFSET UNITYSDK_OFFSET(0x63A9590)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_GET_SHAREDSTATEDATAVIEW_OFFSET UNITYSDK_OFFSET(0x63A94F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x63A93E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEARCHETYPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x63A6AF0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_StateMachineArchetypeData_TypeDefinitionIndex = 59637;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_StateMachineArchetypeData_TypeDefinitionIndex)->GetStaticField(0x39C90);
		}
		// static const ::System::Int32 ChunkSizeBit = 0x4; // 0x0
		// static const ::System::String* NormalizedTimeLayer; // 0x0
		::NPCCrowd::Animation::AnimationControllerTemplateConfig* _templateConfig; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* StateLookupTable; // 0x18
		...
		::System::Collections::Generic::List_1<::NPCCrowd::Animation::AnimationControllerInstanceConfig*>* _instanceConfigs; // 0x38
		::Foundation::Adapter::ChunkList2D_1<::Foundation::StateMachine::Parameter>* _sharedParamData; // 0x40
		::Foundation::Adapter::ChunkList_1<::NPCCrowd::Animation::CPUStateMachine::SharedData>* _sharedData; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Foundation::StateMachine::ParameterId>* ParamLookupTable; // 0x50
		::Foundation::Adapter::ChunkList2D_1<::NPCCrowd::Animation::CPUStateMachine::SharedStateData>* _sharedStateData; // 0x58
		...
		::Foundation::StateMachine::Machine MachineData; // 0x80
