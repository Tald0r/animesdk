...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCONTROLDATA_CONTAINS_OFFSET UNITYSDK_OFFSET(0x37BA50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCONTROLDATA_GETBONEFLAGS_OFFSET UNITYSDK_OFFSET(0x37BA40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCONTROLDATA_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x359650)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCONTROLDATA_RESET_OFFSET UNITYSDK_OFFSET(0x37B870)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCONTROLDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xA10AAE0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingControlData_TypeDefinitionIndex = 71102;
	...
	struct alignas(8) AnimationSubManager_AdjustmentBlendingControlData
	{
		...
		{
			return (::NPCCrowd::Animation::AnimationSubManager_AdjustmentBlendingControlData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_AdjustmentBlendingControlData_TypeDefinitionIndex)->GetStaticField(0xA810);
		}
