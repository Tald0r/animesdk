...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEPROCESSOR_JOB_ADVANCEANIMATION_OFFSET UNITYSDK_OFFSET(0x33C950)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x7EFC640)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x33C9A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEPROCESSOR_JOB_GETSHAREDDATA_OFFSET UNITYSDK_OFFSET(0x33C940)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x33C930)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEPROCESSOR_JOB_UPDATESTATE_OFFSET UNITYSDK_OFFSET(0x33C990)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_StateMachineProcessor_Job_TypeDefinitionIndex = 71170;
