...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEPROCESSOR_JOB_ADVANCEANIMATION_OFFSET UNITYSDK_OFFSET(0x315F70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x6BB0260)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x315FC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEPROCESSOR_JOB_GETSHAREDDATA_OFFSET UNITYSDK_OFFSET(0x315F60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x315F50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_STATEMACHINEPROCESSOR_JOB_UPDATESTATE_OFFSET UNITYSDK_OFFSET(0x315FB0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_StateMachineProcessor_Job_TypeDefinitionIndex = 59738;
