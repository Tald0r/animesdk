...
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_CREATE_1_OFFSET UNITYSDK_OFFSET(0xC2F81B0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_CREATE_2_OFFSET UNITYSDK_OFFSET(0xC2F8220)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_CREATE_3_OFFSET UNITYSDK_OFFSET(0xC2F82A0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_CREATE_OFFSET UNITYSDK_OFFSET(0xC2F8130)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_1_OFFSET UNITYSDK_OFFSET(0x3C2560)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_2_OFFSET UNITYSDK_OFFSET(0x3C2620)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_ISBOOL_OFFSET UNITYSDK_OFFSET(0x316020)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_ISFLOAT_OFFSET UNITYSDK_OFFSET(0x315FE0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_ISINTEGER_OFFSET UNITYSDK_OFFSET(0x316000)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x316040)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_OFFSET UNITYSDK_OFFSET(0x3C2490)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_RESET_OFFSET UNITYSDK_OFFSET(0x3C28D0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_SET_1_OFFSET UNITYSDK_OFFSET(0x3C2760)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_SET_2_OFFSET UNITYSDK_OFFSET(0x3C27E0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_SET_OFFSET UNITYSDK_OFFSET(0x3C26E0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_TRIGGER_OFFSET UNITYSDK_OFFSET(0x3C2860)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimatorControllerParamEntry_TypeDefinitionIndex = 46118;
