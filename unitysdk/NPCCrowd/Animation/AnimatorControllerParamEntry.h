...
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_CREATE_1_OFFSET UNITYSDK_OFFSET(0x77D6A40)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_CREATE_2_OFFSET UNITYSDK_OFFSET(0x77D6AB0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_CREATE_3_OFFSET UNITYSDK_OFFSET(0x77D6B30)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_CREATE_OFFSET UNITYSDK_OFFSET(0x77D69C0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_1_OFFSET UNITYSDK_OFFSET(0x32DAC0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_2_OFFSET UNITYSDK_OFFSET(0x32DB80)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_ISBOOL_OFFSET UNITYSDK_OFFSET(0x32D9B0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_ISFLOAT_OFFSET UNITYSDK_OFFSET(0x32D970)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_ISINTEGER_OFFSET UNITYSDK_OFFSET(0x32D990)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x32D9D0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_GET_OFFSET UNITYSDK_OFFSET(0x32D9F0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_RESET_OFFSET UNITYSDK_OFFSET(0x32DE30)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_SET_1_OFFSET UNITYSDK_OFFSET(0x32DCC0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_SET_2_OFFSET UNITYSDK_OFFSET(0x32DD40)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_SET_OFFSET UNITYSDK_OFFSET(0x32DC40)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMENTRY_TRIGGER_OFFSET UNITYSDK_OFFSET(0x32DDC0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimatorControllerParamEntry_TypeDefinitionIndex = 62505;
