...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_DISPATCH_OFFSET UNITYSDK_OFFSET(0x6038D00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_GET_ISDISPATCHABLE_OFFSET UNITYSDK_OFFSET(0x6038CF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_GET_MAXPHASE_OFFSET UNITYSDK_OFFSET(0x6038DF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_GET_MINPHASE_OFFSET UNITYSDK_OFFSET(0x6038DE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x60359F0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_NoDispatchable_TypeDefinitionIndex = 71101;
