...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_DISPATCH_OFFSET UNITYSDK_OFFSET(0x69FE240)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_GET_ISDISPATCHABLE_OFFSET UNITYSDK_OFFSET(0x69FE230)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_GET_MAXPHASE_OFFSET UNITYSDK_OFFSET(0x69FE330)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE_GET_MINPHASE_OFFSET UNITYSDK_OFFSET(0x69FE320)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_NODISPATCHABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x69FA3F0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_NoDispatchable_TypeDefinitionIndex = 59714;
