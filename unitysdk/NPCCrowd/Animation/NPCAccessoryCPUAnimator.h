...
#define NPCCROWD_ANIMATION_NPCACCESSORYCPUANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6B57120)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCAccessoryCPUAnimator_TypeDefinitionIndex = 53371;
