...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x640E510)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_FREE_OFFSET UNITYSDK_OFFSET(0x640E4D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x640DD60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x640DD50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x640DDC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x640DE30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x640E580)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_UnSpawnInstanceProcessor_TypeDefinitionIndex = 59733;

	class AnimationSubManager_UnSpawnInstanceProcessor : public ::NPCCrowd::Animation::AnimationSubManager_NoDispatchable
	{
	public:
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _instanceIdSet; // 0x10
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::System::UInt32>*>* _cache; // 0x18
