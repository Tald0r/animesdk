...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x6A12D50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_FREE_OFFSET UNITYSDK_OFFSET(0x6A12D10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x6A125A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x6A12590)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x6A12600)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x6A12670)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_UNSPAWNINSTANCEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6A12DC0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_UnSpawnInstanceProcessor_TypeDefinitionIndex = 71213;
