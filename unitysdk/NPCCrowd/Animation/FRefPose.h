...
#define NPCCROWD_ANIMATION_FREFPOSE_GETGLOBALSPACETRANSFORM_OFFSET UNITYSDK_OFFSET(0x301470)
#define NPCCROWD_ANIMATION_FREFPOSE_GETGLOBALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x302730)
#define NPCCROWD_ANIMATION_FREFPOSE_GETLOCALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x301C20)
#define NPCCROWD_ANIMATION_FREFPOSE_GETMESHSPACETRANSFORM_OFFSET UNITYSDK_OFFSET(0x300E10)
#define NPCCROWD_ANIMATION_FREFPOSE_GETMESHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x301DE0)
#define NPCCROWD_ANIMATION_FREFPOSE_GETPARENT_OFFSET UNITYSDK_OFFSET(0x301A70)
#define NPCCROWD_ANIMATION_FREFPOSE_GET_BONECOUNT_OFFSET UNITYSDK_OFFSET(0x300AE0)
#define NPCCROWD_ANIMATION_FREFPOSE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x300AC0)
#define NPCCROWD_ANIMATION_FREFPOSE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x300B00)
#define NPCCROWD_ANIMATION_FREFPOSE_ISVALIDBONE_OFFSET UNITYSDK_OFFSET(0x301BA0)
#define NPCCROWD_ANIMATION_FREFPOSE_SETGLOBALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x3047F0)
#define NPCCROWD_ANIMATION_FREFPOSE_SETLOCALTRANSFORM_OFFSET UNITYSDK_OFFSET(0x303660)
#define NPCCROWD_ANIMATION_FREFPOSE_SETMESHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x3037B0)
#define NPCCROWD_ANIMATION_FREFPOSE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x300CC0)
#define NPCCROWD_ANIMATION_FREFPOSE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x300DD0)
#define NPCCROWD_ANIMATION_FREFPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x300C40)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int FRefPose_TypeDefinitionIndex = 50170;
