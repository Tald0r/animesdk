...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG_COLLECT_OFFSET UNITYSDK_OFFSET(0x6B4EF90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG_FETCHCURVEID_OFFSET UNITYSDK_OFFSET(0x30C840)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG_FETCHCURVEVALUE_OFFSET UNITYSDK_OFFSET(0x30C870)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG__COLLECT_G__GENERATEPERBONECONFIG_5_0_OFFSET UNITYSDK_OFFSET(0x6B56560)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x30C820)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingWarpingPerBoneConfig_TypeDefinitionIndex = 71195;
