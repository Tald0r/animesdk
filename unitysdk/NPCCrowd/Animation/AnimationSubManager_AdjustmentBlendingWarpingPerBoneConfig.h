...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG_COLLECT_OFFSET UNITYSDK_OFFSET(0x7801860)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG_FETCHCURVEID_OFFSET UNITYSDK_OFFSET(0x33A700)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG_FETCHCURVEVALUE_OFFSET UNITYSDK_OFFSET(0x33A730)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG__COLLECT_G__GENERATEPERBONECONFIG_5_0_OFFSET UNITYSDK_OFFSET(0x7809760)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x33A6E0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingWarpingPerBoneConfig_TypeDefinitionIndex = 59725;
