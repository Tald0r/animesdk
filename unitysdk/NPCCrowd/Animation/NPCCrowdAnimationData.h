...
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_BONESETPARENT_OFFSET UNITYSDK_OFFSET(0x848F660)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETBONEBYTRANSFORM_OFFSET UNITYSDK_OFFSET(0x848F260)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETBONEEXPORTINDEXBYBONEID_OFFSET UNITYSDK_OFFSET(0x848F5C0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETBONEINDEXBYTRANSFORM_OFFSET UNITYSDK_OFFSET(0x848F540)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETSKINNEDMESHDATABYNAME_OFFSET UNITYSDK_OFFSET(0x848F700)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GET_ANIMATIONTEXTURE_OFFSET UNITYSDK_OFFSET(0x848EED0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x848F130)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x848F020)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCrowdAnimationData_TypeDefinitionIndex = 59342;
