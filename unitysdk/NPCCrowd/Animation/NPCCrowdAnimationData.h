...
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_BONESETPARENT_OFFSET UNITYSDK_OFFSET(0x9BCD2B0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETBONEBYTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9BCCEB0)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETBONEEXPORTINDEXBYBONEID_OFFSET UNITYSDK_OFFSET(0x9BCD210)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETBONEINDEXBYTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9BCD190)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GETSKINNEDMESHDATABYNAME_OFFSET UNITYSDK_OFFSET(0x9BCD350)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_GET_ANIMATIONTEXTURE_OFFSET UNITYSDK_OFFSET(0x9BCCB20)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x9BCCD80)
#define NPCCROWD_ANIMATION_NPCCROWDANIMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9BCCC70)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCrowdAnimationData_TypeDefinitionIndex = 47051;
