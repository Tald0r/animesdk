...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xA10E780)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET___C__CTOR_OFFSET UNITYSDK_OFFSET(0xA10E7C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET___C__NPCCROWD_ANIMATION_IANIMATIONLIB_GETANIMATIONS_B__33_0_OFFSET UNITYSDK_OFFSET(0xA10E7D0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationGraphDataset___c_TypeDefinitionIndex = 73820;
	...
	public:
		...
		{
			return (::System::Func_2<::NPCCrowd::Animation::NPCCPUAnimationClipInfo*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(NPCCPUAnimationGraphDataset___c_TypeDefinitionIndex)->GetStaticField(0x30820);
		}
		static ::NPCCrowd::Animation::NPCCPUAnimationGraphDataset___c** StaticGet___9()
		{
			return (::NPCCrowd::Animation::NPCCPUAnimationGraphDataset___c**)Il2CppClass::FromTypeDefinitionIndex(NPCCPUAnimationGraphDataset___c_TypeDefinitionIndex)->GetStaticField(0x30828);
		}
