...
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_APPLYCACHEDBONES_OFFSET UNITYSDK_OFFSET(0x5E10820)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_BINDALLSLOTBONETRANSFORM_OFFSET UNITYSDK_OFFSET(0x5E0BCB0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_CACHEBONES_OFFSET UNITYSDK_OFFSET(0x5E10750)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_CLEARLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x5E10450)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_DISABLELOOKATIK_OFFSET UNITYSDK_OFFSET(0x5E0FEF0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_DISABLE_OFFSET UNITYSDK_OFFSET(0x5E0E8A0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_ENABLELOOKATIK_OFFSET UNITYSDK_OFFSET(0x5E0FC30)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_ENDLOOKATIKJOB_OFFSET UNITYSDK_OFFSET(0x5E10380)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_GETANIMATORTRANSFORM_OFFSET UNITYSDK_OFFSET(0x5E0F8C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_GETBINDEDBONETRANSFORM_OFFSET UNITYSDK_OFFSET(0x5E0F9A0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_GETCLIPINFO_OFFSET UNITYSDK_OFFSET(0x5E0D950)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_GETCULLINGMODE_OFFSET UNITYSDK_OFFSET(0x5E0B230)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_GETLOOKATATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x5E0FBA0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_GETLOOKATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x5E10620)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_GETSLOTLOCALPRS_OFFSET UNITYSDK_OFFSET(0x5E0EE00)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_GETSLOTTRANSFORMONLYFORUI_OFFSET UNITYSDK_OFFSET(0x5E0ECA0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_GETSLOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x5E0F7E0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_GETSLOTWORLDPRS_OFFSET UNITYSDK_OFFSET(0x5E0F2F0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_GETWORLDTIME_OFFSET UNITYSDK_OFFSET(0x5E0E4B0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_GET_DATASET_OFFSET UNITYSDK_OFFSET(0x5E0B220)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_INIT_OFFSET UNITYSDK_OFFSET(0x5E0B340)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_ISRUNNINGLOOKATIK_OFFSET UNITYSDK_OFFSET(0x5E0FA80)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x5E0EB40)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x5E0E930)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_PLAYANIMATIONCLIPBYIDNORMALIZED_OFFSET UNITYSDK_OFFSET(0x5E0D630)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_PLAYANIMATIONCLIPBYID_1_OFFSET UNITYSDK_OFFSET(0x5E0CEC0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_PLAYANIMATIONCLIPBYID_OFFSET UNITYSDK_OFFSET(0x5E0CD80)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_REFRESHANIMTAGS_OFFSET UNITYSDK_OFFSET(0x5E0D7B0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_REFRESHAVATARTAGS_OFFSET UNITYSDK_OFFSET(0x5E0D850)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_REFRESHCONFIGIK_OFFSET UNITYSDK_OFFSET(0x5E0D8E0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_REGISTERMONODELEGATE_OFFSET UNITYSDK_OFFSET(0x5E10BF0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_RESUME_OFFSET UNITYSDK_OFFSET(0x5E0E520)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_SETANIMATIONSPEED_OFFSET UNITYSDK_OFFSET(0x5E0DFC0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_SETBONES_OFFSET UNITYSDK_OFFSET(0x5E106A0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_SETCLIPSPEED_OFFSET UNITYSDK_OFFSET(0x5E0DBC0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_SETLOOKATIKPROCESSORTARGET_OFFSET UNITYSDK_OFFSET(0x5E0FFC0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_SETLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x5E10510)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_SETROUTER_OFFSET UNITYSDK_OFFSET(0x5E10940)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_SETTICKPAUSESTATE_OFFSET UNITYSDK_OFFSET(0x5E0DE20)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_STARTLOOKATIKJOB_OFFSET UNITYSDK_OFFSET(0x5E102C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_STOPANIMATION_OFFSET UNITYSDK_OFFSET(0x5E0DA50)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_TRYGETMAINANIMATION_OFFSET UNITYSDK_OFFSET(0x5E0E270)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_UNREGISTERMONODELEGATE_OFFSET UNITYSDK_OFFSET(0x5E10CE0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x5E0DD30)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x5E10E50)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimator_TypeDefinitionIndex = 61853;
	...
	public:
		...
		::UnityEngine::Animator* unityAnimator; // 0x18
		::NPCCrowd::Animation::NPCCPUAnimationGraphScript_Core* coreGraph; // 0x20
		::NPCCrowd::Animation::NPCCPUAnimationGraphDataset* dataset; // 0x28
		::Il2CppArray<::UnityEngine::NapTransformData>* _curFrameBones; // 0x30
		::NPCCrowd::Animation::NPCCPUAnimatorControllerFKPass* AnimatorPass; // 0x38
		::NPCCrowd::NPCMonoDelegate* _monoDelegate; // 0x40
		::NPCCrowd::Animation::NPCCPUNormalFKPass* FKPass; // 0x48
		::UnityEngine::Transform* lookAtTarget; // 0x50
		::NPCCrowd::Animation::NPCCPULookAtPass* LookAtPass; // 0x58
		::System::Nullable_1<::System::ValueTuple_2<::System::Int32, ::NPCCrowd::Animation::NPCCPUAnimationClipInfo*>> _mainAnimationCache; // 0x60
		::NPCCrowd::NPCMonoDelegate_EventDelegate* ApplyCachedBonesAction; // 0x78
		::System::Collections::Generic::List_1<::System::Int32>* curAnimLogicTags; // 0x80
		...
		::System::Collections::Generic::List_1<::System::String*>* blendShapePaths; // 0x90
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::Transform*>* bindedTransforms; // 0x98
		...
		::System::Boolean isLookAtIKLocked; // 0xA7
		::System::Boolean configEnableLookatIK; // 0xA8
		::System::Boolean bInited; // 0xA9
