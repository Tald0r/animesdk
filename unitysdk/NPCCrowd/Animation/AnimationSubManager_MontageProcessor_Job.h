...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x60B2510)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x2CC7B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x2CC7A0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_MontageProcessor_Job_TypeDefinitionIndex = 71140;
