...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x63A58B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x2F85B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MONTAGEPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x2F85A0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_MontageProcessor_Job_TypeDefinitionIndex = 59649;
