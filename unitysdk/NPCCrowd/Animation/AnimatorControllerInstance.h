...
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_ISBUFFERVALID_OFFSET UNITYSDK_OFFSET(0x329C10)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x329B60)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x329C20)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_PLAYABLE_OFFSET UNITYSDK_OFFSET(0x2CA610)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_STATES_OFFSET UNITYSDK_OFFSET(0x329C40)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_RESET_1_OFFSET UNITYSDK_OFFSET(0x329CC0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_RESET_OFFSET UNITYSDK_OFFSET(0x329CB0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_SETBOOL_OFFSET UNITYSDK_OFFSET(0x329C90)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x329C70)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_SETINTEGER_OFFSET UNITYSDK_OFFSET(0x329C80)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_SETSTATE_OFFSET UNITYSDK_OFFSET(0x329C60)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_TRIGGER_OFFSET UNITYSDK_OFFSET(0x329CA0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimatorControllerInstance_TypeDefinitionIndex = 48028;
