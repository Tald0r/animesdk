...
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_ISBUFFERVALID_OFFSET UNITYSDK_OFFSET(0x355C00)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x355BF0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x355C80)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_PLAYABLE_OFFSET UNITYSDK_OFFSET(0x2EC7C0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_GET_STATES_OFFSET UNITYSDK_OFFSET(0x355CA0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_RESET_1_OFFSET UNITYSDK_OFFSET(0x355D20)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_RESET_OFFSET UNITYSDK_OFFSET(0x355D10)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_SETBOOL_OFFSET UNITYSDK_OFFSET(0x355CF0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x355CD0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_SETINTEGER_OFFSET UNITYSDK_OFFSET(0x355CE0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_SETSTATE_OFFSET UNITYSDK_OFFSET(0x355CC0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERINSTANCE_TRIGGER_OFFSET UNITYSDK_OFFSET(0x355D00)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimatorControllerInstance_TypeDefinitionIndex = 66793;
