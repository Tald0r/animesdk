...
#define NPCCROWD_ANIMATION_NPCCROWDMONTAGEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x6B57750)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCrowdMontageAsset_TypeDefinitionIndex = 60833;
