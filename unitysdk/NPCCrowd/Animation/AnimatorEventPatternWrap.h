...
#define NPCCROWD_ANIMATION_ANIMATOREVENTPATTERNWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0x722AAA0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimatorEventPatternWrap_TypeDefinitionIndex = 70731;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::Config::AnimatorEvent*>* normalEvent; // 0x28
