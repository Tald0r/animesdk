...
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_CLEARTARGET_OFFSET UNITYSDK_OFFSET(0x31E610)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_END_OFFSET UNITYSDK_OFFSET(0x31E440)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_GETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x31E6B0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_INIT_OFFSET UNITYSDK_OFFSET(0x31E2E0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_ISCREATED_OFFSET UNITYSDK_OFFSET(0x31E4C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_ISEND_OFFSET UNITYSDK_OFFSET(0x31E450)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_SETPOSTARGET_OFFSET UNITYSDK_OFFSET(0x31E540)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_SETTRANSFORMTARGET_OFFSET UNITYSDK_OFFSET(0x31E530)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_START_OFFSET UNITYSDK_OFFSET(0x31E3D0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATEGRAPHTARGET_OFFSET UNITYSDK_OFFSET(0x31E720)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATELOCK_OFFSET UNITYSDK_OFFSET(0x31E700)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATETARGET_OFFSET UNITYSDK_OFFSET(0x31E710)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATEWEIGHT_OFFSET UNITYSDK_OFFSET(0x31E6F0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x31E6E0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATE_OFFSET UNITYSDK_OFFSET(0x31E6D0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB__CCTOR_OFFSET UNITYSDK_OFFSET(0x6FB0110)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimator_LookAtIKFadeJob_TypeDefinitionIndex = 55829;
