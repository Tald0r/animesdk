...
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_CLEARTARGET_OFFSET UNITYSDK_OFFSET(0x324D10)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_END_OFFSET UNITYSDK_OFFSET(0x324B40)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_GETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x324DB0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_INIT_OFFSET UNITYSDK_OFFSET(0x3249E0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_ISCREATED_OFFSET UNITYSDK_OFFSET(0x324BC0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_ISEND_OFFSET UNITYSDK_OFFSET(0x324B50)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_SETPOSTARGET_OFFSET UNITYSDK_OFFSET(0x324C40)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_SETTRANSFORMTARGET_OFFSET UNITYSDK_OFFSET(0x324C30)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_START_OFFSET UNITYSDK_OFFSET(0x324AD0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATEGRAPHTARGET_OFFSET UNITYSDK_OFFSET(0x324E20)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATELOCK_OFFSET UNITYSDK_OFFSET(0x324E00)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATETARGET_OFFSET UNITYSDK_OFFSET(0x324E10)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATEWEIGHT_OFFSET UNITYSDK_OFFSET(0x324DF0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x324DE0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB_UPDATE_OFFSET UNITYSDK_OFFSET(0x324DD0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATOR_LOOKATIKFADEJOB__CCTOR_OFFSET UNITYSDK_OFFSET(0x7450C70)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimator_LookAtIKFadeJob_TypeDefinitionIndex = 70921;

	struct alignas(8) NPCCPUAnimator_LookAtIKFadeJob
	{
		static ::System::Single* StaticGet__minLookAtWeight()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCCPUAnimator_LookAtIKFadeJob_TypeDefinitionIndex)->GetStaticField(0xBB60);
		}
