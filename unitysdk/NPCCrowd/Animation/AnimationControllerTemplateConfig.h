...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_CLEARSERIALIZEDATA_OFFSET UNITYSDK_OFFSET(0x69E8E40)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_FETCHSTATEID_OFFSET UNITYSDK_OFFSET(0x69E8EE0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_ANIMCLIPS_OFFSET UNITYSDK_OFFSET(0x69E8BC0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTAREACURVE_OFFSET UNITYSDK_OFFSET(0x69E8D40)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTAREADERIVATIVECURVE_OFFSET UNITYSDK_OFFSET(0x69E8D80)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTAREASECTIONCURVE_OFFSET UNITYSDK_OFFSET(0x69E8DC0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTLOCKSTATUS_OFFSET UNITYSDK_OFFSET(0x69E8E00)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_LEFTFOOTIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x69E8CC0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_RIGHTFOOTIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x69E8D00)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x69E9000)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x69E9160)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x69E9190)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerTemplateConfig_TypeDefinitionIndex = 50128;
