...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_CLEARSERIALIZEDATA_OFFSET UNITYSDK_OFFSET(0x6024A60)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_FETCHSTATEID_OFFSET UNITYSDK_OFFSET(0x6024B00)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_ANIMCLIPS_OFFSET UNITYSDK_OFFSET(0x60247E0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTAREACURVE_OFFSET UNITYSDK_OFFSET(0x6024960)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTAREADERIVATIVECURVE_OFFSET UNITYSDK_OFFSET(0x60249A0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTAREASECTIONCURVE_OFFSET UNITYSDK_OFFSET(0x60249E0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_FOOTLOCKSTATUS_OFFSET UNITYSDK_OFFSET(0x6024A20)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_LEFTFOOTIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x60248E0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_GET_RIGHTFOOTIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x6024920)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x6024C20)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6024D80)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERTEMPLATECONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x6024DB0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerTemplateConfig_TypeDefinitionIndex = 39258;
