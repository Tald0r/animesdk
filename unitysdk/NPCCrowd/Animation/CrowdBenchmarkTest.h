...
#define NPCCROWD_ANIMATION_CROWDBENCHMARKTEST_GETCROWDNPCTESTCASES_OFFSET UNITYSDK_OFFSET(0xC2F8350)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKTEST_GET_UNITTESTCASENAME_OFFSET UNITYSDK_OFFSET(0xC2F8310)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKTEST__CTOR_OFFSET UNITYSDK_OFFSET(0xC2F8690)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKTEST__GETCROWDNPCTESTCASES_B__7_0_OFFSET UNITYSDK_OFFSET(0xC2F8820)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKTEST___BASE_GETCROWDNPCTESTCASES_OFFSET UNITYSDK_OFFSET(0xC2F8910)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int CrowdBenchmarkTest_TypeDefinitionIndex = 70711;
