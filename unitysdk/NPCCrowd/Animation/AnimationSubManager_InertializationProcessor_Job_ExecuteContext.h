...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_ADJUSTROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x69FD000)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_ADVANCETIME_1_OFFSET UNITYSDK_OFFSET(0x69FC5D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_ADVANCETIME_OFFSET UNITYSDK_OFFSET(0x311A00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_APPLY_1_OFFSET UNITYSDK_OFFSET(0x69FDAD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_APPLY_OFFSET UNITYSDK_OFFSET(0x311A20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_CALCROOTINERTIALIZATIONSPACE_OFFSET UNITYSDK_OFFSET(0x69FD790)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_CAPTURE_1_OFFSET UNITYSDK_OFFSET(0x69FDD60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_CAPTURE_OFFSET UNITYSDK_OFFSET(0x311A30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_GENERATEDELTADATA_OFFSET UNITYSDK_OFFSET(0x69FCAC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_HANDLEREQUEST_1_OFFSET UNITYSDK_OFFSET(0x69FC530)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_HANDLEREQUEST_OFFSET UNITYSDK_OFFSET(0x3119F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_START_1_OFFSET UNITYSDK_OFFSET(0x69FC690)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT_START_OFFSET UNITYSDK_OFFSET(0x311A10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_INERTIALIZATIONPROCESSOR_JOB_EXECUTECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x311790)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_InertializationProcessor_Job_ExecuteContext_TypeDefinitionIndex = 59718;
