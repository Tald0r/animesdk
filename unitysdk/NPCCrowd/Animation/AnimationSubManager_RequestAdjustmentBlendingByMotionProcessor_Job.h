...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_BUILDCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x33A850)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_CLEARCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x7DFEE70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x7DFBE80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x33A6F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_FETCHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x7DFEEE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x33A6E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_HANDLE_OFFSET UNITYSDK_OFFSET(0x33A710)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_ISVALID_OFFSET UNITYSDK_OFFSET(0x33A700)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_RequestAdjustmentBlendingByMotionProcessor_Job_TypeDefinitionIndex = 71152;
