...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_BUILDCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x307240)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_CLEARCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x651E990)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x651B9E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x3070E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_FETCHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x651EA00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x3070D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_HANDLE_OFFSET UNITYSDK_OFFSET(0x307100)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_REQUESTADJUSTMENTBLENDINGBYMOTIONPROCESSOR_JOB_ISVALID_OFFSET UNITYSDK_OFFSET(0x3070F0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_RequestAdjustmentBlendingByMotionProcessor_Job_TypeDefinitionIndex = 59748;
