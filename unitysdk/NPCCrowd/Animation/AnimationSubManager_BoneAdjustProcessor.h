...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_BONEADJUSTPROCESSOR_DISPATCH_OFFSET UNITYSDK_OFFSET(0x60ABED0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_BONEADJUSTPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x60ABD30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_BONEADJUSTPROCESSOR_GET_MAXPHASE_OFFSET UNITYSDK_OFFSET(0x60ABD20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_BONEADJUSTPROCESSOR_GET_MINPHASE_OFFSET UNITYSDK_OFFSET(0x60ABD10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_BONEADJUSTPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x60ABD90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_BONEADJUSTPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x60AC930)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_BoneAdjustProcessor_TypeDefinitionIndex = 71161;
