...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONCLIPINFO_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x6A18CD0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONCLIPINFO_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x6A18E20)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONCLIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x6A18F50)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationClipInfo_TypeDefinitionIndex = 43447;
