...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONCLIPINFO_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x6414480)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONCLIPINFO_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x64145D0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONCLIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x6414700)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationClipInfo_TypeDefinitionIndex = 53062;
