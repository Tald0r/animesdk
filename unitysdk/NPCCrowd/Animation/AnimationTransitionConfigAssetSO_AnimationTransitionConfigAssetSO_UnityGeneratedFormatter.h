...
#define NPCCROWD_ANIMATION_ANIMATIONTRANSITIONCONFIGASSETSO_ANIMATIONTRANSITIONCONFIGASSETSO_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x7EFE7C0)
#define NPCCROWD_ANIMATION_ANIMATIONTRANSITIONCONFIGASSETSO_ANIMATIONTRANSITIONCONFIGASSETSO_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x7EFE7D0)
#define NPCCROWD_ANIMATION_ANIMATIONTRANSITIONCONFIGASSETSO_ANIMATIONTRANSITIONCONFIGASSETSO_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x7EFE9F0)
#define NPCCROWD_ANIMATION_ANIMATIONTRANSITIONCONFIGASSETSO_ANIMATIONTRANSITIONCONFIGASSETSO_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7EFEBD0)
#define NPCCROWD_ANIMATION_ANIMATIONTRANSITIONCONFIGASSETSO_ANIMATIONTRANSITIONCONFIGASSETSO_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x7EFEB90)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationTransitionConfigAssetSO_AnimationTransitionConfigAssetSO_UnityGeneratedFormatter_TypeDefinitionIndex = 69561;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::NPCCrowd::Animation::MontageTransitionConfig>**)Il2CppClass::FromTypeDefinitionIndex(AnimationTransitionConfigAssetSO_AnimationTransitionConfigAssetSO_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2D900);
		}
		static ::Sirenix::Serialization::Serializer_1<::NPCCrowd::Animation::StateMachineTransitionConfig>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::NPCCrowd::Animation::StateMachineTransitionConfig>**)Il2CppClass::FromTypeDefinitionIndex(AnimationTransitionConfigAssetSO_AnimationTransitionConfigAssetSO_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2D908);
		}
