...
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER_COMBINEHASH_OFFSET UNITYSDK_OFFSET(0x7446F90)
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x7446F00)
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7446FB0)
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x7447040)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int GenericCurveIDEqualityComparer_TypeDefinitionIndex = 41997;
