...
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER_COMBINEHASH_OFFSET UNITYSDK_OFFSET(0x6FA6460)
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x6FA63D0)
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x6FA6480)
#define NPCCROWD_ANIMATION_GENERICCURVEIDEQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x6FA6510)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int GenericCurveIDEqualityComparer_TypeDefinitionIndex = 49537;
