...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETCURRENTFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x33A360)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETFOOTGROUNDNORMAL_OFFSET UNITYSDK_OFFSET(0x33A200)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETFOOTHEIGHT_OFFSET UNITYSDK_OFFSET(0x33A160)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETGROUNDEDSTATE_OFFSET UNITYSDK_OFFSET(0x33A4A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETHITHEIGHT_OFFSET UNITYSDK_OFFSET(0x33A2B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x33A270)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETISGROUNDEDFORFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x33A520)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETNEXTFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x33A430)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETPREDICTENABLE_OFFSET UNITYSDK_OFFSET(0x33A4F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETPREDICTTARGETHEIGHT_OFFSET UNITYSDK_OFFSET(0x33A3D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GET_TARGETENABLE_OFFSET UNITYSDK_OFFSET(0x2D71A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETCURRENTFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x33A330)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETFOOTGROUNDNORMAL_OFFSET UNITYSDK_OFFSET(0x33A240)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETFOOTHEIGHT_OFFSET UNITYSDK_OFFSET(0x33A1E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETGROUNDEDSTATE_OFFSET UNITYSDK_OFFSET(0x33A480)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETHITHEIGHT_OFFSET UNITYSDK_OFFSET(0x33A2D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x33A290)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETISGROUNDEDFORFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x33A5B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETNEXTFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x33A400)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETPREDICTENABLE_OFFSET UNITYSDK_OFFSET(0x33A4D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETPREDICTTARGETHEIGHT_OFFSET UNITYSDK_OFFSET(0x33A3B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SET_TARGETENABLE_OFFSET UNITYSDK_OFFSET(0x33A0E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_UPDATEFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x33A2F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x7DFBC10)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FootStepControlData_TypeDefinitionIndex = 71122;

	struct alignas(4) AnimationSubManager_FootStepControlData
	{
		static ::UnityEngine::NapTransformData* StaticGet_DummyTransform()
		{
			return (::UnityEngine::NapTransformData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_FootStepControlData_TypeDefinitionIndex)->GetStaticField(0xAC10);
		}
		static ::NPCCrowd::Animation::AnimationSubManager_FootStepControlData* StaticGet_Default()
		{
			return (::NPCCrowd::Animation::AnimationSubManager_FootStepControlData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_FootStepControlData_TypeDefinitionIndex)->GetStaticField(0xAC40);
		}
