...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETCURRENTFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x306D30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETFOOTGROUNDNORMAL_OFFSET UNITYSDK_OFFSET(0x306BD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETFOOTHEIGHT_OFFSET UNITYSDK_OFFSET(0x306B30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETGROUNDEDSTATE_OFFSET UNITYSDK_OFFSET(0x306E70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETHITHEIGHT_OFFSET UNITYSDK_OFFSET(0x306C80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x306C40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETISGROUNDEDFORFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x306EF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETNEXTFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x306E00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETPREDICTENABLE_OFFSET UNITYSDK_OFFSET(0x306EC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GETPREDICTTARGETHEIGHT_OFFSET UNITYSDK_OFFSET(0x306DA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_GET_TARGETENABLE_OFFSET UNITYSDK_OFFSET(0x306AA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETCURRENTFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x306D00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETFOOTGROUNDNORMAL_OFFSET UNITYSDK_OFFSET(0x306C10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETFOOTHEIGHT_OFFSET UNITYSDK_OFFSET(0x306BB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETGROUNDEDSTATE_OFFSET UNITYSDK_OFFSET(0x306E50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETHITHEIGHT_OFFSET UNITYSDK_OFFSET(0x306CA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETIKWEIGHT_OFFSET UNITYSDK_OFFSET(0x306C60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETISGROUNDEDFORFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x306F80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETNEXTFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x306DD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETPREDICTENABLE_OFFSET UNITYSDK_OFFSET(0x306EA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SETPREDICTTARGETHEIGHT_OFFSET UNITYSDK_OFFSET(0x306D80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_SET_TARGETENABLE_OFFSET UNITYSDK_OFFSET(0x306AB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA_UPDATEFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x306CC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPCONTROLDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x651B770)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FootStepControlData_TypeDefinitionIndex = 59679;

	struct alignas(4) AnimationSubManager_FootStepControlData
	{
		static ::UnityEngine::NapTransformData* StaticGet_DummyTransform()
		{
			return (::UnityEngine::NapTransformData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_FootStepControlData_TypeDefinitionIndex)->GetStaticField(0xB230);
		}
		static ::NPCCrowd::Animation::AnimationSubManager_FootStepControlData* StaticGet_Default()
		{
			return (::NPCCrowd::Animation::AnimationSubManager_FootStepControlData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_FootStepControlData_TypeDefinitionIndex)->GetStaticField(0xB260);
		}
