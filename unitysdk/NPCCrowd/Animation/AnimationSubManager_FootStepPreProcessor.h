...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_DISPATCH_OFFSET UNITYSDK_OFFSET(0x5E08040)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_GETANIMINDEX_OFFSET UNITYSDK_OFFSET(0x5E08670)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x5E07E40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_GET_MAXPHASE_OFFSET UNITYSDK_OFFSET(0x5E07E30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_GET_MINPHASE_OFFSET UNITYSDK_OFFSET(0x5E07E20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x5E07EA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x5E08740)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FootStepPreProcessor_TypeDefinitionIndex = 71124;
