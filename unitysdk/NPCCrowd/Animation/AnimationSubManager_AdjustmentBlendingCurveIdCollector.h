...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCURVEIDCOLLECTOR_FOUNDATION_IINVOCABLEBYREF_NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGWARPINGPERBONECONFIG__INVOKE_OFFSET UNITYSDK_OFFSET(0x2F8060)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCURVEIDCOLLECTOR_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x223870)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCURVEIDCOLLECTOR_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x2EC6E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGCURVEIDCOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x2F8050)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingCurveIdCollector_TypeDefinitionIndex = 59681;
