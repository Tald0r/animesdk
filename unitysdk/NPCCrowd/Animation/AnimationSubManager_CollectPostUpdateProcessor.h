...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTPOSTUPDATEPROCESSOR_COLLECTROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x63FF090)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTPOSTUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x63FE720)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTPOSTUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x63FE710)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTPOSTUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x63FE780)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTPOSTUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x63FE7F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_COLLECTPOSTUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x63FF510)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_CollectPostUpdateProcessor_TypeDefinitionIndex = 59683;
