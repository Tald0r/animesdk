...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_GETAVATARMASK_OFFSET UNITYSDK_OFFSET(0x6FAD270)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_GETBLENDSHAPEATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x6FAD8C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0x6FACDE0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_NPCCROWD_ANIMATION_IANIMATIONLIB_GETANIMATIONS_OFFSET UNITYSDK_OFFSET(0x6FADA40)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_NPCCROWD_ANIMATION_ICPUANIMATIONLIB_GETAVATAR_OFFSET UNITYSDK_OFFSET(0x6FADEA0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_NPCCROWD_ANIMATION_ICPUANIMATIONLIB_GETGENDER_OFFSET UNITYSDK_OFFSET(0x6FADF10)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_NPCCROWD_ANIMATION_ICPUANIMATIONLIB_GETSIZE_OFFSET UNITYSDK_OFFSET(0x6FADF70)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_NPCCROWD_ANIMATION_ICPUANIMATIONLIB_ISANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0x6FADCF0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_NPCCROWD_ANIMATION_ICPUANIMATIONLIB_RESOLVE_OFFSET UNITYSDK_OFFSET(0x6FADB90)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_REFRESHANIMDATA_OFFSET UNITYSDK_OFFSET(0x6FAD320)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x6FAD0C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET__CTOR_OFFSET UNITYSDK_OFFSET(0x6FADFD0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationGraphDataset_TypeDefinitionIndex = 58663;
