...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_GETAVATARMASK_OFFSET UNITYSDK_OFFSET(0x744DDB0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_GETBLENDSHAPEATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x744E410)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0x744D920)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_NPCCROWD_ANIMATION_IANIMATIONLIB_GETANIMATIONS_OFFSET UNITYSDK_OFFSET(0x744E5A0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_NPCCROWD_ANIMATION_ICPUANIMATIONLIB_GETAVATAR_OFFSET UNITYSDK_OFFSET(0x744EA00)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_NPCCROWD_ANIMATION_ICPUANIMATIONLIB_GETGENDER_OFFSET UNITYSDK_OFFSET(0x744EA70)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_NPCCROWD_ANIMATION_ICPUANIMATIONLIB_GETSIZE_OFFSET UNITYSDK_OFFSET(0x744EAD0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_NPCCROWD_ANIMATION_ICPUANIMATIONLIB_ISANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0x744E850)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_NPCCROWD_ANIMATION_ICPUANIMATIONLIB_RESOLVE_OFFSET UNITYSDK_OFFSET(0x744E6F0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_REFRESHANIMDATA_OFFSET UNITYSDK_OFFSET(0x744DE60)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x744DC00)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHDATASET__CTOR_OFFSET UNITYSDK_OFFSET(0x744EB30)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationGraphDataset_TypeDefinitionIndex = 73819;
