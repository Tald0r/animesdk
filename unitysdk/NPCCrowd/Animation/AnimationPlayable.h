...
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_ADDLAYER_OFFSET UNITYSDK_OFFSET(0x69E9570)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_GETLAYERMAINCLIPTIME_OFFSET UNITYSDK_OFFSET(0x69E9E00)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_GETLAYER_OFFSET UNITYSDK_OFFSET(0x69E99C0)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x69E91A0)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x69E9380)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_PLAYCLIP_OFFSET UNITYSDK_OFFSET(0x69E9880)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x69E9460)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_SETLAYERMAINCLIPTIME_OFFSET UNITYSDK_OFFSET(0x69E9CC0)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_SETLAYERMASK_OFFSET UNITYSDK_OFFSET(0x69E9C20)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE_SETLAYERSPEED_OFFSET UNITYSDK_OFFSET(0x69E9A60)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x69E9F60)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE___BASE_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x69E9FA0)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE___BASE_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x69E9FB0)
#define NPCCROWD_ANIMATION_ANIMATIONPLAYABLE___BASE_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x69E9FC0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationPlayable_TypeDefinitionIndex = 75598;
	...
	public:
		...
		::UnityEngine::Playables::PlayableGraph graph; // 0x18
		::UnityEngine::Animations::AnimationLayerMixerPlayable layerMixer; // 0x28
