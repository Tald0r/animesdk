...
#define NPCCROWD_ANIMATION_ZONEEVENTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x36F8D0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int ZoneEventItem_TypeDefinitionIndex = 77559;
