...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_BUILDREQUEST_OFFSET UNITYSDK_OFFSET(0x6406AB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_CALCULATEGROUNDNORMAL_OFFSET UNITYSDK_OFFSET(0x2FBAA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_CHECKANDUPDATEFOOTSEGMENTS_OFFSET UNITYSDK_OFFSET(0x2FBA40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x6401630)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_DOORDINARYRAYCAST_OFFSET UNITYSDK_OFFSET(0x2FB920)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_DOPREDICTRAYCAST_OFFSET UNITYSDK_OFFSET(0x2FB930)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_DORAYCASTONSTAIR_OFFSET UNITYSDK_OFFSET(0x2FB8B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_DORAYCAST_OFFSET UNITYSDK_OFFSET(0x2FB6E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x2FB6D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x2FB6B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_HITGROUNDFORSLOPE_OFFSET UNITYSDK_OFFSET(0x2FBA00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_HITGROUND_OFFSET UNITYSDK_OFFSET(0x2FB9C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_ISVALID_OFFSET UNITYSDK_OFFSET(0x2FB6C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x2FB8A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_PROCESSFADEINOUT_OFFSET UNITYSDK_OFFSET(0x2FB7C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_RESET_OFFSET UNITYSDK_OFFSET(0x2FB7D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_SAMPLECURVE_OFFSET UNITYSDK_OFFSET(0x2FB800)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_TRYINITIALIZE_OFFSET UNITYSDK_OFFSET(0x2FB840)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FootStepPreProcessor_Job_TypeDefinitionIndex = 59659;
