...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_BUILDREQUEST_OFFSET UNITYSDK_OFFSET(0x6A079E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_CALCULATEGROUNDNORMAL_OFFSET UNITYSDK_OFFSET(0x300320)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_CHECKANDUPDATEFOOTSEGMENTS_OFFSET UNITYSDK_OFFSET(0x3002C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x6A05830)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_DOORDINARYRAYCAST_OFFSET UNITYSDK_OFFSET(0x3001A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_DOPREDICTRAYCAST_OFFSET UNITYSDK_OFFSET(0x3001B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_DORAYCASTONSTAIR_OFFSET UNITYSDK_OFFSET(0x300130)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_DORAYCAST_OFFSET UNITYSDK_OFFSET(0x2FFF60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x2FFF50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x2FFF30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_HITGROUNDFORSLOPE_OFFSET UNITYSDK_OFFSET(0x300280)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_HITGROUND_OFFSET UNITYSDK_OFFSET(0x300240)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_ISVALID_OFFSET UNITYSDK_OFFSET(0x2FFF40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x300120)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_PROCESSFADEINOUT_OFFSET UNITYSDK_OFFSET(0x300040)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_RESET_OFFSET UNITYSDK_OFFSET(0x300050)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_SAMPLECURVE_OFFSET UNITYSDK_OFFSET(0x300080)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPREPROCESSOR_JOB_TRYINITIALIZE_OFFSET UNITYSDK_OFFSET(0x3000C0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FootStepPreProcessor_Job_TypeDefinitionIndex = 71125;
