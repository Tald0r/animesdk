...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTOROTATION_OFFSET UNITYSDK_OFFSET(0x2F34C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTOSCALE_OFFSET UNITYSDK_OFFSET(0x2F3810)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTOTRANSLATION_OFFSET UNITYSDK_OFFSET(0x2F3190)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTO_OFFSET UNITYSDK_OFFSET(0x2F3140)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_CALCULATEINERTIALIZATIONFLOAT_OFFSET UNITYSDK_OFFSET(0x62F5910)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_ROTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x2F2ED0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_ROTATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2F2F90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_ROTATIONSPEED_OFFSET UNITYSDK_OFFSET(0x2F2FB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_SCALEAXIS_OFFSET UNITYSDK_OFFSET(0x2F2F10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_SCALEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2F2FD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_SCALESPEED_OFFSET UNITYSDK_OFFSET(0x2F2FF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_TRANSLATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x2F2E90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_TRANSLATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2F2F50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_TRANSLATIONSPEED_OFFSET UNITYSDK_OFFSET(0x2F2F70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INITROTATION_OFFSET UNITYSDK_OFFSET(0x2F3120)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INITSCALE_OFFSET UNITYSDK_OFFSET(0x2F3130)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INITTRANSLATION_OFFSET UNITYSDK_OFFSET(0x2F3110)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INIT_OFFSET UNITYSDK_OFFSET(0x2F3010)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_IPOSEINERTIALIZATIONBONEDELTADATA_INIT_OFFSET UNITYSDK_OFFSET(0x2F3B40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_ROTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x2F2EF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_ROTATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2F2FA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_ROTATIONSPEED_OFFSET UNITYSDK_OFFSET(0x2F2FC0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_SCALEAXIS_OFFSET UNITYSDK_OFFSET(0x2F2F30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_SCALEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2F2FE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_SCALESPEED_OFFSET UNITYSDK_OFFSET(0x2F3000)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_TRANSLATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x2F2EB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_TRANSLATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2F2F60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_TRANSLATIONSPEED_OFFSET UNITYSDK_OFFSET(0x2F2F80)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PoseInertializationBoneDeltaData16_TypeDefinitionIndex = 59694;
