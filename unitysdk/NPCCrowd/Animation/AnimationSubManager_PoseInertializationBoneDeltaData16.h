...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTOROTATION_OFFSET UNITYSDK_OFFSET(0x2FDAE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTOSCALE_OFFSET UNITYSDK_OFFSET(0x2FDE30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTOTRANSLATION_OFFSET UNITYSDK_OFFSET(0x2FD7B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_APPLYTO_OFFSET UNITYSDK_OFFSET(0x2FD760)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_CALCULATEINERTIALIZATIONFLOAT_OFFSET UNITYSDK_OFFSET(0x6971500)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_ROTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x2FD4F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_ROTATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2FD5B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_ROTATIONSPEED_OFFSET UNITYSDK_OFFSET(0x2FD5D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_SCALEAXIS_OFFSET UNITYSDK_OFFSET(0x2FD530)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_SCALEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2FD5F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_SCALESPEED_OFFSET UNITYSDK_OFFSET(0x2FD610)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_TRANSLATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x2FD4B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_TRANSLATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2FD570)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_GET_TRANSLATIONSPEED_OFFSET UNITYSDK_OFFSET(0x2FD590)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INITROTATION_OFFSET UNITYSDK_OFFSET(0x2FD740)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INITSCALE_OFFSET UNITYSDK_OFFSET(0x2FD750)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INITTRANSLATION_OFFSET UNITYSDK_OFFSET(0x2FD730)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_INIT_OFFSET UNITYSDK_OFFSET(0x2FD630)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_IPOSEINERTIALIZATIONBONEDELTADATA_INIT_OFFSET UNITYSDK_OFFSET(0x2FE160)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_ROTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x2FD510)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_ROTATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2FD5C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_ROTATIONSPEED_OFFSET UNITYSDK_OFFSET(0x2FD5E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_SCALEAXIS_OFFSET UNITYSDK_OFFSET(0x2FD550)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_SCALEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2FD600)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_SCALESPEED_OFFSET UNITYSDK_OFFSET(0x2FD620)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_TRANSLATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x2FD4D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_TRANSLATIONMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x2FD580)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_POSEINERTIALIZATIONBONEDELTADATA16_SET_TRANSLATIONSPEED_OFFSET UNITYSDK_OFFSET(0x2FD5A0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PoseInertializationBoneDeltaData16_TypeDefinitionIndex = 71112;
