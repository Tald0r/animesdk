...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_DISPATCHABLE_GET_ISDISPATCHABLE_OFFSET UNITYSDK_OFFSET(0x77CA930)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_DISPATCHABLE_PROCESS_OFFSET UNITYSDK_OFFSET(0x77CA940)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_DISPATCHABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x77CA9F0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_Dispatchable_TypeDefinitionIndex = 71208;
