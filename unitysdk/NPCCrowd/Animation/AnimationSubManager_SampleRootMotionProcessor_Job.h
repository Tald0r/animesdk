...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEROOTMOTIONPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x3073D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEROOTMOTIONPROCESSOR_JOB_EXTRACTROOTMOTION_OFFSET UNITYSDK_OFFSET(0x6520170)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEROOTMOTIONPROCESSOR_JOB_FETCHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x651FFA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEROOTMOTIONPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x3073C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_SAMPLEROOTMOTIONPROCESSOR_JOB__CTOR_OFFSET UNITYSDK_OFFSET(0x307340)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_SampleRootMotionProcessor_Job_TypeDefinitionIndex = 59746;
