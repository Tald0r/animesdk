...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_ADDDEPENDENCY_OFFSET UNITYSDK_OFFSET(0x62E8440)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_BEGINFRAME_OFFSET UNITYSDK_OFFSET(0x62E7B10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x62E8270)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_ENSUREOPERATIONBUFFEREMPTY_OFFSET UNITYSDK_OFFSET(0x62E7E70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_ENSUREOPERATIONBUFFER_OFFSET UNITYSDK_OFFSET(0x62E7CB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_FORCECOMPLETEALL_OFFSET UNITYSDK_OFFSET(0x62E82E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_GETMAXPHASEEVENTNODEINDEX_OFFSET UNITYSDK_OFFSET(0x62E85E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_GETMINPHASEEVENTNODEINDEX_OFFSET UNITYSDK_OFFSET(0x62E8530)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_GETPHASEEVENTNODEINDEX_OFFSET UNITYSDK_OFFSET(0x62E8520)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_INITIALIZEPHASEEVENT_OFFSET UNITYSDK_OFFSET(0x62E7A20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_SCHEDULE_OFFSET UNITYSDK_OFFSET(0x62E8080)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER__CCTOR_OFFSET UNITYSDK_OFFSET(0x62E8690)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER__CTOR_OFFSET UNITYSDK_OFFSET(0x62E79A0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AnimationScheduler_TypeDefinitionIndex = 59661;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_AnimationScheduler_TypeDefinitionIndex)->GetStaticField(0x11DC0);
		}
		...
		::Il2CppArray<::NPCCrowd::Animation::AnimationSubManager_IAnimationProcessor*>* _processors; // 0x18
		::Il2CppArray<::NPCCrowd::Animation::AnimationSubManager_AnimationScheduler_Node>* _nodes; // 0x20
