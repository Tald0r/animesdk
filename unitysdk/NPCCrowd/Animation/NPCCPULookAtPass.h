...
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_CLEARLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xC2FB6D0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_DESTROY_OFFSET UNITYSDK_OFFSET(0xC2FB840)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_DISABLELOOKATIK_OFFSET UNITYSDK_OFFSET(0xC2FB100)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_ENABLELOOKATIK_OFFSET UNITYSDK_OFFSET(0xC2FA8A0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_ENDLOOKATIKJOB_OFFSET UNITYSDK_OFFSET(0xC2FB4F0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_INITIKJOBS_OFFSET UNITYSDK_OFFSET(0xC2FA010)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_INIT_OFFSET UNITYSDK_OFFSET(0xC2FAC50)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_INNERDISABLELOOKATIK_OFFSET UNITYSDK_OFFSET(0xC2FAAA0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_ISRUNNINGLOOKATIK_OFFSET UNITYSDK_OFFSET(0xC2FB360)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_SETLOOKATTARGET_1_OFFSET UNITYSDK_OFFSET(0xC2FB7C0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_SETLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xC2FABB0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_SETLOOKATWEIGHT_OFFSET UNITYSDK_OFFSET(0xC2FAB10)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_STARTLOOKATIKJOB_OFFSET UNITYSDK_OFFSET(0xC2FB3D0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS_UPDATE_OFFSET UNITYSDK_OFFSET(0xC2FAEC0)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS__CTOR_OFFSET UNITYSDK_OFFSET(0xC2F9A60)
#define NPCCROWD_ANIMATION_NPCCPULOOKATPASS___BASE_DESTROY_OFFSET UNITYSDK_OFFSET(0xC2FB900)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPULookAtPass_TypeDefinitionIndex = 52965;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::Transform*>* eyeBones; // 0x58
		::NPCCrowd::Animation::NPCCPUAnimator_LookAtIKFadeJob lookAtIKAnimStateJob; // 0x60
		::System::Boolean bIsRunningLookAtIK; // 0xF0
		::System::Boolean bPendingDisableLookAtIK; // 0xF1
		::System::Boolean _bIsEnableLookAtIK; // 0xF2
