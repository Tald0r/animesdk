...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_GET_BOOLVALUE_OFFSET UNITYSDK_OFFSET(0x2D4920)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_GET_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0x2D4920)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_NEW_1_OFFSET UNITYSDK_OFFSET(0x648E940)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_NEW_2_OFFSET UNITYSDK_OFFSET(0x648E950)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_NEW_3_OFFSET UNITYSDK_OFFSET(0x648E960)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_NEW_OFFSET UNITYSDK_OFFSET(0x648E930)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_RESETTRIGGER_OFFSET UNITYSDK_OFFSET(0x2D4950)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_SETTRIGGER_OFFSET UNITYSDK_OFFSET(0x2D4940)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERPARAMVALUE_SET_BOOLVALUE_OFFSET UNITYSDK_OFFSET(0x2D4930)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerParamValue_TypeDefinitionIndex = 68825;
