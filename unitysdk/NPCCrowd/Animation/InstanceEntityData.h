...
#define NPCCROWD_ANIMATION_INSTANCEENTITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x33CC30)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int InstanceEntityData_TypeDefinitionIndex = 48460;
