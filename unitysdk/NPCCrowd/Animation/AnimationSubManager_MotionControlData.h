...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_MOTIONCONTROLDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x6FA2910)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_MotionControlData_TypeDefinitionIndex = 59642;
	...
	struct alignas(8) AnimationSubManager_MotionControlData
	{
		...
		{
			return (::NPCCrowd::Animation::AnimationSubManager_MotionControlData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_MotionControlData_TypeDefinitionIndex)->GetStaticField(0xAA70);
		}
