...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_ENSURECURVECOUNT_OFFSET UNITYSDK_OFFSET(0x2FD460)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_ENSURESECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x2FD470)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_CURVECOUNT_OFFSET UNITYSDK_OFFSET(0x2FD3E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_CURVETIMEPTR_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_CURVEVALUEPTR_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_SECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x2FD450)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_SECTIONPTR_OFFSET UNITYSDK_OFFSET(0x2FC120)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_NEW_OFFSET UNITYSDK_OFFSET(0x696EF70)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_SLICESECTION_OFFSET UNITYSDK_OFFSET(0x2FD480)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PhaseMatchingProcessor_Buffer_TypeDefinitionIndex = 71142;
