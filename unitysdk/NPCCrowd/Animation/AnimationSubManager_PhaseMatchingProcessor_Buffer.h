...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_ENSURECURVECOUNT_OFFSET UNITYSDK_OFFSET(0x2F2E40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_ENSURESECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x2F2E50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_CURVECOUNT_OFFSET UNITYSDK_OFFSET(0x2F2DA0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_CURVETIMEPTR_OFFSET UNITYSDK_OFFSET(0x223870)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_CURVEVALUEPTR_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_SECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x2F2E30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_GET_SECTIONPTR_OFFSET UNITYSDK_OFFSET(0x2F2E20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_NEW_OFFSET UNITYSDK_OFFSET(0x62F3380)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_PHASEMATCHINGPROCESSOR_BUFFER_SLICESECTION_OFFSET UNITYSDK_OFFSET(0x2F2E60)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_PhaseMatchingProcessor_Buffer_TypeDefinitionIndex = 59656;
