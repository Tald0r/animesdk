...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x6EC9C00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x6EC9BF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x6EC9C60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x6EC9D60)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_WRITEBACKBLENDSHAPE_OFFSET UNITYSDK_OFFSET(0x6ECB590)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR_WRITEBACKPOSE_OFFSET UNITYSDK_OFFSET(0x6ECB230)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FLUSHLATEUPDATEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6ECBF20)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FlushLateUpdateProcessor_TypeDefinitionIndex = 71155;
