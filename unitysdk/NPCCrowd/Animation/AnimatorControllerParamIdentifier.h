...
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_EQUALS_OFFSET UNITYSDK_OFFSET(0x317C60)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_GET_ISBOOL_OFFSET UNITYSDK_OFFSET(0x32D9B0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_GET_ISFLOAT_OFFSET UNITYSDK_OFFSET(0x32D970)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_GET_ISINTEGER_OFFSET UNITYSDK_OFFSET(0x32D990)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x33C9B0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x32D9D0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_NEWBOOLPARAM_OFFSET UNITYSDK_OFFSET(0x7EFECE0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_NEWFLOATPARAM_OFFSET UNITYSDK_OFFSET(0x7EFECC0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_NEWINTPARAM_OFFSET UNITYSDK_OFFSET(0x7EFECD0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER_NEWTRIGGERPARAM_OFFSET UNITYSDK_OFFSET(0x7EFECF0)
#define NPCCROWD_ANIMATION_ANIMATORCONTROLLERPARAMIDENTIFIER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7EFED00)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimatorControllerParamIdentifier_TypeDefinitionIndex = 69879;
	...
	struct alignas(4) AnimatorControllerParamIdentifier
	{
		...
		{
			return (::NPCCrowd::Animation::AnimatorControllerParamIdentifier*)Il2CppClass::FromTypeDefinitionIndex(AnimatorControllerParamIdentifier_TypeDefinitionIndex)->GetStaticField(0xAD60);
		}
