...
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_CREATREQUESTJOB_BUILDSAMPLEPOSEREQUEST_OFFSET UNITYSDK_OFFSET(0x335560)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_CREATREQUESTJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x335550)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_CREATREQUESTJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x335500)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCustomIdleManager_CreatRequestJob_TypeDefinitionIndex = 69749;
