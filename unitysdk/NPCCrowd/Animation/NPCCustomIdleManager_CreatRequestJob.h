...
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_CREATREQUESTJOB_BUILDSAMPLEPOSEREQUEST_OFFSET UNITYSDK_OFFSET(0x37BE30)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_CREATREQUESTJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x37BE20)
#define NPCCROWD_ANIMATION_NPCCUSTOMIDLEMANAGER_CREATREQUESTJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x37BDD0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCustomIdleManager_CreatRequestJob_TypeDefinitionIndex = 47434;
