...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_COMPLETE_OFFSET UNITYSDK_OFFSET(0x3115F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_DISPATCH_OFFSET UNITYSDK_OFFSET(0x311630)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x311570)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_NEWCOMPLETEOPERATION_OFFSET UNITYSDK_OFFSET(0x69EE440)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_NEWDISPATCHOPERATION_OFFSET UNITYSDK_OFFSET(0x69EE9C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_NEWPROCESSOPERATION_OFFSET UNITYSDK_OFFSET(0x69EE2A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION_PROCESS_OFFSET UNITYSDK_OFFSET(0x3115B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x311500)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AnimationScheduler_Operation_TypeDefinitionIndex = 59676;
