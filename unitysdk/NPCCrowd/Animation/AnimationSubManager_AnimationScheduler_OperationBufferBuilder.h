...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATIONBUFFERBUILDER_COMMIT_OFFSET UNITYSDK_OFFSET(0x9AFF470)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATIONBUFFERBUILDER_COMPLETE_OFFSET UNITYSDK_OFFSET(0x9AFF710)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATIONBUFFERBUILDER_DISPATCH_OFFSET UNITYSDK_OFFSET(0x9AFF8F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATIONBUFFERBUILDER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9AFF510)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATIONBUFFERBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x9AFFAD0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AnimationScheduler_OperationBufferBuilder_TypeDefinitionIndex = 59667;
