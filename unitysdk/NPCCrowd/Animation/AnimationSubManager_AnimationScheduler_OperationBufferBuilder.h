...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATIONBUFFERBUILDER_COMMIT_OFFSET UNITYSDK_OFFSET(0x7227630)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATIONBUFFERBUILDER_COMPLETE_OFFSET UNITYSDK_OFFSET(0x72278D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATIONBUFFERBUILDER_DISPATCH_OFFSET UNITYSDK_OFFSET(0x7227AB0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATIONBUFFERBUILDER_PROCESS_OFFSET UNITYSDK_OFFSET(0x72276D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ANIMATIONSCHEDULER_OPERATIONBUFFERBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x7227C90)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AnimationScheduler_OperationBufferBuilder_TypeDefinitionIndex = 71191;
