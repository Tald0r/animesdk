...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_ADDANIMATIONPASS_OFFSET UNITYSDK_OFFSET(0x634BF70)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x634C4A0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_DESTROY_OFFSET UNITYSDK_OFFSET(0x634CA20)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x634C930)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_INIT_OFFSET UNITYSDK_OFFSET(0x634BD70)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_PLAY_OFFSET UNITYSDK_OFFSET(0x634C820)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_REBUILD_OFFSET UNITYSDK_OFFSET(0x634C040)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_SETTICKPAUSESTATE_OFFSET UNITYSDK_OFFSET(0x634C890)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_SORTSTABLE_OFFSET UNITYSDK_OFFSET(0x634C520)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE__CCTOR_OFFSET UNITYSDK_OFFSET(0x634CCC0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE__CTOR_OFFSET UNITYSDK_OFFSET(0x634CC40)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE___BASE_DESTROY_OFFSET UNITYSDK_OFFSET(0x634CD00)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationGraphScript_Core_TypeDefinitionIndex = 47576;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(NPCCPUAnimationGraphScript_Core_TypeDefinitionIndex)->GetStaticField(0x45470);
		}
