...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_ADDANIMATIONPASS_OFFSET UNITYSDK_OFFSET(0x5E0A3F0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x5E0A920)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_DESTROY_OFFSET UNITYSDK_OFFSET(0x5E0AEA0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x5E0ADB0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_INIT_OFFSET UNITYSDK_OFFSET(0x5E0A1F0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_PLAY_OFFSET UNITYSDK_OFFSET(0x5E0ACA0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_REBUILD_OFFSET UNITYSDK_OFFSET(0x5E0A4C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_SETTICKPAUSESTATE_OFFSET UNITYSDK_OFFSET(0x5E0AD10)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE_SORTSTABLE_OFFSET UNITYSDK_OFFSET(0x5E0A9A0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE__CCTOR_OFFSET UNITYSDK_OFFSET(0x5E0B140)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE__CTOR_OFFSET UNITYSDK_OFFSET(0x5E0B0C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_CORE___BASE_DESTROY_OFFSET UNITYSDK_OFFSET(0x5E0B180)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationGraphScript_Core_TypeDefinitionIndex = 43233;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(NPCCPUAnimationGraphScript_Core_TypeDefinitionIndex)->GetStaticField(0x44260);
		}
