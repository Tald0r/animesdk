...
#define NPCCROWD_ANIMATION_CROWDUNITTESTBASE_GETANYNPCTAGID_1_OFFSET UNITYSDK_OFFSET(0x7581EF0)
#define NPCCROWD_ANIMATION_CROWDUNITTESTBASE_GETANYNPCTAGID_OFFSET UNITYSDK_OFFSET(0x7581C10)
#define NPCCROWD_ANIMATION_CROWDUNITTESTBASE_GETANYPREFABIDWHICHOWNACCESSORY_OFFSET UNITYSDK_OFFSET(0x7582080)
#define NPCCROWD_ANIMATION_CROWDUNITTESTBASE_GETCROWDNPCTESTCASES_OFFSET UNITYSDK_OFFSET(0x75822E0)
#define NPCCROWD_ANIMATION_CROWDUNITTESTBASE_GET_UNITTESTCASENAME_OFFSET UNITYSDK_OFFSET(0x75818C0)
#define NPCCROWD_ANIMATION_CROWDUNITTESTBASE_INIT_OFFSET UNITYSDK_OFFSET(0x75818D0)
#define NPCCROWD_ANIMATION_CROWDUNITTESTBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x7582390)
#define NPCCROWD_ANIMATION_CROWDUNITTESTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x7582380)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int CrowdUnitTestBase_TypeDefinitionIndex = 78063;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(CrowdUnitTestBase_TypeDefinitionIndex)->GetStaticField(0x3DAE0);
		}
		static ::System::Collections::Generic::HashSet_1<::System::Int32>** StaticGet_allAvatarParams()
		{
			return (::System::Collections::Generic::HashSet_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(CrowdUnitTestBase_TypeDefinitionIndex)->GetStaticField(0x3DAE8);
		}
