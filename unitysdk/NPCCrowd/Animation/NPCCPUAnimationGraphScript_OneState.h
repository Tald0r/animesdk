...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_DESTROY_OFFSET UNITYSDK_OFFSET(0x6A1AE50)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_DISABLELOOKATIK_OFFSET UNITYSDK_OFFSET(0x6A1BA20)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_ENABLELOOKATIK_OFFSET UNITYSDK_OFFSET(0x6A1B170)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x6A1B0E0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x6A1B070)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_GETMAINANIMCLIPSTATUES_OFFSET UNITYSDK_OFFSET(0x6A1A480)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_GETMAINANIMCLIPTIME_OFFSET UNITYSDK_OFFSET(0x6A1A510)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_INIT_OFFSET UNITYSDK_OFFSET(0x6A1ABE0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_PLAY_OFFSET UNITYSDK_OFFSET(0x6A19FF0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_REBUILDGRAPH_OFFSET UNITYSDK_OFFSET(0x6A18FD0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETBLENDANIMATION_OFFSET UNITYSDK_OFFSET(0x6A1A5F0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETBLENDCLIPSPEED_OFFSET UNITYSDK_OFFSET(0x6A1A9C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETBLENDWEIGHT_OFFSET UNITYSDK_OFFSET(0x6A1AF30)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x6A1BB40)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETLOOKATWEIGHT_OFFSET UNITYSDK_OFFSET(0x6A1BAA0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETMAINANIMATIONMANUALLY_OFFSET UNITYSDK_OFFSET(0x6A1A250)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETMAINANIMCLIPSPEED_OFFSET UNITYSDK_OFFSET(0x6A1A390)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETMAINANIMCLIPTIME_OFFSET UNITYSDK_OFFSET(0x6A1A160)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETMAINANIMCLIP_OFFSET UNITYSDK_OFFSET(0x6A19D90)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_SETMAINCLIPSPEED_OFFSET UNITYSDK_OFFSET(0x6A1A070)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_STOPBLENDANIMATION1_OFFSET UNITYSDK_OFFSET(0x6A1AB30)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x6A1ADC0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x6A1BBF0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x6A1BBE0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPT_ONESTATE___BASE_DESTROY_OFFSET UNITYSDK_OFFSET(0x6A1BC30)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationGraphScript_OneState_TypeDefinitionIndex = 77447;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(NPCCPUAnimationGraphScript_OneState_TypeDefinitionIndex)->GetStaticField(0x32D90);
		}
		::UnityEngine::AnimationClip* _blendClip1; // 0x40
		::UnityEngine::AnimationClip* _blendClip2; // 0x48
		::UnityEngine::AvatarMask* _blendAvatarMask2; // 0x50
		::UnityEngine::AnimationClip* _mainClip; // 0x58
		::UnityEngine::AvatarMask* _blendAvatarMask1; // 0x60
		::UnityEngine::Animations::AnimationClipPlayable _mainClipPlayable; // 0x68
		::NPCCrowd::Animation::Job::LookAtJob _lookAtJob; // 0x78
		::System::Boolean _isUsingBlendClip1; // 0x148
		::System::Boolean _bIsEnableLookAtIK; // 0x149
		::System::Boolean _isUsingBlendClip2; // 0x14A
		::UnityEngine::Animations::AnimationLayerMixerPlayable _mixerPlayable; // 0x150
		::UnityEngine::Animations::AnimationScriptPlayable _lookAtPlayable; // 0x160
