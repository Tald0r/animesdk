...
#define NPCCROWD_ANIMATION_PHASESECTIONFLAG_GET_FOOTSTATUS_OFFSET UNITYSDK_OFFSET(0x329DA0)
#define NPCCROWD_ANIMATION_PHASESECTIONFLAG_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x329D60)
#define NPCCROWD_ANIMATION_PHASESECTIONFLAG_SET_FOOTSTATUS_OFFSET UNITYSDK_OFFSET(0x329DB0)
#define NPCCROWD_ANIMATION_PHASESECTIONFLAG_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x329D70)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int PhaseSectionFlag_TypeDefinitionIndex = 47186;
