...
#define NPCCROWD_ANIMATION_PHASESECTIONFLAG_GET_FOOTSTATUS_OFFSET UNITYSDK_OFFSET(0x355E00)
#define NPCCROWD_ANIMATION_PHASESECTIONFLAG_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x355DC0)
#define NPCCROWD_ANIMATION_PHASESECTIONFLAG_SET_FOOTSTATUS_OFFSET UNITYSDK_OFFSET(0x355E10)
#define NPCCROWD_ANIMATION_PHASESECTIONFLAG_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x355DD0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int PhaseSectionFlag_TypeDefinitionIndex = 38201;
