...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_CALCULATEFOOTTARGETFORPREDICT_OFFSET UNITYSDK_OFFSET(0x3C2220)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_CALCULATEFOOTTARGETONSLOPE_OFFSET UNITYSDK_OFFSET(0x3C2190)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_CALCULATEFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x3C20B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_CALCULATEPELVISDELTA_OFFSET UNITYSDK_OFFSET(0x3C2410)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_CHECKCURRENTFOOTSTEPSEGMENT_OFFSET UNITYSDK_OFFSET(0x3C1BE0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0xC2EC130)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_DOFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x3C1B50)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_DOFOOTSTEPFORPREDICT_OFFSET UNITYSDK_OFFSET(0x3C1F90)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_DOFOOTSTEPIK_OFFSET UNITYSDK_OFFSET(0x3C1C40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_DOFOOTSTEPONSLOPE_OFFSET UNITYSDK_OFFSET(0x3C1E80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_DOFOOTSTEPONSTAIR_OFFSET UNITYSDK_OFFSET(0x3C1CF0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x3C1B30)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_GETFOOTPRINTSPAWNERTYPE_OFFSET UNITYSDK_OFFSET(0x3C1BD0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x3C1B20)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_HIPHEIGHTLIFTINGDELTABYLIMITDIST_OFFSET UNITYSDK_OFFSET(0xC2F6B80)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_ISVALID_OFFSET UNITYSDK_OFFSET(0x3C1B40)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_PELVISPD_OFFSET UNITYSDK_OFFSET(0x3C22B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_PRECALCULATEPELVISDELTA_OFFSET UNITYSDK_OFFSET(0x3C23A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_RESET_OFFSET UNITYSDK_OFFSET(0x3C20A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_SAMPLEPARABOLA_OFFSET UNITYSDK_OFFSET(0x3C22C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_SETCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x3C2360)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FootStepProcessor_Job_TypeDefinitionIndex = 59751;
