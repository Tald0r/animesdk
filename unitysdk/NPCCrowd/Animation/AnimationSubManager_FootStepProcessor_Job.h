...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_CALCULATEFOOTTARGETFORPREDICT_OFFSET UNITYSDK_OFFSET(0x32D700)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_CALCULATEFOOTTARGETONSLOPE_OFFSET UNITYSDK_OFFSET(0x32D670)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_CALCULATEFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x32D590)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_CALCULATEPELVISDELTA_OFFSET UNITYSDK_OFFSET(0x32D8F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_CHECKCURRENTFOOTSTEPSEGMENT_OFFSET UNITYSDK_OFFSET(0x32D0C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_CREATEJOB_OFFSET UNITYSDK_OFFSET(0x77CAA00)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_DOFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x32D030)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_DOFOOTSTEPFORPREDICT_OFFSET UNITYSDK_OFFSET(0x32D470)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_DOFOOTSTEPIK_OFFSET UNITYSDK_OFFSET(0x32D120)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_DOFOOTSTEPONSLOPE_OFFSET UNITYSDK_OFFSET(0x32D360)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_DOFOOTSTEPONSTAIR_OFFSET UNITYSDK_OFFSET(0x32D1D0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x32D010)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_GETFOOTPRINTSPAWNERTYPE_OFFSET UNITYSDK_OFFSET(0x32D0B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_GET_CHUNKCOUNT_OFFSET UNITYSDK_OFFSET(0x32D000)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_HIPHEIGHTLIFTINGDELTABYLIMITDIST_OFFSET UNITYSDK_OFFSET(0x77D5410)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_ISVALID_OFFSET UNITYSDK_OFFSET(0x32D020)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_PELVISPD_OFFSET UNITYSDK_OFFSET(0x32D790)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_PRECALCULATEPELVISDELTA_OFFSET UNITYSDK_OFFSET(0x32D880)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_RESET_OFFSET UNITYSDK_OFFSET(0x32D580)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_SAMPLEPARABOLA_OFFSET UNITYSDK_OFFSET(0x32D7A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_FOOTSTEPPROCESSOR_JOB_SETCONTROLDATA_OFFSET UNITYSDK_OFFSET(0x32D840)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_FootStepProcessor_Job_TypeDefinitionIndex = 71118;
