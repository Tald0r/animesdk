...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_CLAMPANGLE_OFFSET UNITYSDK_OFFSET(0x784C670)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_GET_ISNOTNULL_OFFSET UNITYSDK_OFFSET(0x33C4A0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_ISAPPLICABLE_OFFSET UNITYSDK_OFFSET(0x33C510)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_MAKE_OFFSET UNITYSDK_OFFSET(0x784C830)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_PROCESSCOMPENSATEROTATION_OFFSET UNITYSDK_OFFSET(0x33C5F0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_PROCESS_OFFSET UNITYSDK_OFFSET(0x33C560)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x784D820)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x33C3C0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingPerBoneControlData_TypeDefinitionIndex = 59703;
	...
	struct alignas(4) AnimationSubManager_AdjustmentBlendingPerBoneControlData
	{
		...
		{
			return (::NPCCrowd::Animation::AnimationSubManager_AdjustmentBlendingPerBoneControlData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_AdjustmentBlendingPerBoneControlData_TypeDefinitionIndex)->GetStaticField(0x11F30);
		}
