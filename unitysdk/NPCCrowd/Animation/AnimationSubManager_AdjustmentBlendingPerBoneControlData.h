...
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_CLAMPANGLE_OFFSET UNITYSDK_OFFSET(0x6EC7700)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_GET_ISNOTNULL_OFFSET UNITYSDK_OFFSET(0x317220)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_ISAPPLICABLE_OFFSET UNITYSDK_OFFSET(0x317290)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_MAKE_OFFSET UNITYSDK_OFFSET(0x6EC78C0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_PROCESSCOMPENSATEROTATION_OFFSET UNITYSDK_OFFSET(0x317370)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA_PROCESS_OFFSET UNITYSDK_OFFSET(0x3172E0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x6EC88B0)
#define NPCCROWD_ANIMATION_ANIMATIONSUBMANAGER_ADJUSTMENTBLENDINGPERBONECONTROLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x317140)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationSubManager_AdjustmentBlendingPerBoneControlData_TypeDefinitionIndex = 71114;
	...
	struct alignas(4) AnimationSubManager_AdjustmentBlendingPerBoneControlData
	{
		...
		{
			return (::NPCCrowd::Animation::AnimationSubManager_AdjustmentBlendingPerBoneControlData*)Il2CppClass::FromTypeDefinitionIndex(AnimationSubManager_AdjustmentBlendingPerBoneControlData_TypeDefinitionIndex)->GetStaticField(0x11E60);
		}
