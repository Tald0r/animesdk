...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_GETANIMATIONID_OFFSET UNITYSDK_OFFSET(0x9BCBF40)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_SPLITANIMATIONINFO_OFFSET UNITYSDK_OFFSET(0x9BCBFD0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_SPLITMONTAGEINFOBYID_OFFSET UNITYSDK_OFFSET(0x9BCC470)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_TRYPARSEANIMATIONIDBYNAME_OFFSET UNITYSDK_OFFSET(0x9BCC1C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_TRYPARSEANIMATIONID_OFFSET UNITYSDK_OFFSET(0x9BCC0F0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_TRYPARSEMONTAGEIDBYNAME_OFFSET UNITYSDK_OFFSET(0x9BCC310)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x9BCC560)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationDefine_TypeDefinitionIndex = 78924;
