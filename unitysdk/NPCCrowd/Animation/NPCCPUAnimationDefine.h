...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_GETANIMATIONID_OFFSET UNITYSDK_OFFSET(0x848E2F0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_SPLITANIMATIONINFO_OFFSET UNITYSDK_OFFSET(0x848E380)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_SPLITMONTAGEINFOBYID_OFFSET UNITYSDK_OFFSET(0x848E820)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_TRYPARSEANIMATIONIDBYNAME_OFFSET UNITYSDK_OFFSET(0x848E570)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_TRYPARSEANIMATIONID_OFFSET UNITYSDK_OFFSET(0x848E4A0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE_TRYPARSEMONTAGEIDBYNAME_OFFSET UNITYSDK_OFFSET(0x848E6C0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x848E910)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationDefine_TypeDefinitionIndex = 45483;
