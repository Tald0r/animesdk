...
#define NPCCROWD_ANIMATION_CROWDBENCHMARKBEHAVIOR_CHECKINIT_OFFSET UNITYSDK_OFFSET(0x9BC8B40)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKBEHAVIOR_CLOSESHADOW_OFFSET UNITYSDK_OFFSET(0x9BC9F90)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKBEHAVIOR_GETALLCROWDUNITTESTCASES_OFFSET UNITYSDK_OFFSET(0x9BC7650)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKBEHAVIOR_ONGUI_OFFSET UNITYSDK_OFFSET(0x9BC9940)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKBEHAVIOR_RANDOMPLAYANIM_OFFSET UNITYSDK_OFFSET(0x9BC8DD0)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKBEHAVIOR_RESPAWNCROWDENTITIES_OFFSET UNITYSDK_OFFSET(0x9BC8E60)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKBEHAVIOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x9BC7BE0)
#define NPCCROWD_ANIMATION_CROWDBENCHMARKBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9BCA0C0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int CrowdBenchmarkBehavior_TypeDefinitionIndex = 39036;
