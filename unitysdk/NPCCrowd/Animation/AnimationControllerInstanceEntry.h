...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_APPLYPARAMTO_OFFSET UNITYSDK_OFFSET(0x757CB10)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_CREATEANIMATORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x757D060)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_FETCHEXPOSEDPARAM_1_OFFSET UNITYSDK_OFFSET(0x757C900)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_FETCHEXPOSEDPARAM_OFFSET UNITYSDK_OFFSET(0x757C7E0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_FETCHSTATE_OFFSET UNITYSDK_OFFSET(0x757D5B0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_GETEXPOSEDPARAMCOUNT_OFFSET UNITYSDK_OFFSET(0x757C740)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_GET_ISANIMATIONCONFIG_OFFSET UNITYSDK_OFFSET(0x757C0A0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_INSTANTIATE_1_OFFSET UNITYSDK_OFFSET(0x757C660)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x757C170)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_ISMATCH_OFFSET UNITYSDK_OFFSET(0x757C0B0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x757D790)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerInstanceEntry_TypeDefinitionIndex = 44497;
