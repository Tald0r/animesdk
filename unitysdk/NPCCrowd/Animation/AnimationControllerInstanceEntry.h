...
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_APPLYPARAMTO_OFFSET UNITYSDK_OFFSET(0x751C120)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_CREATEANIMATORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x751C670)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_FETCHEXPOSEDPARAM_1_OFFSET UNITYSDK_OFFSET(0x751BF10)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_FETCHEXPOSEDPARAM_OFFSET UNITYSDK_OFFSET(0x751BDF0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_FETCHSTATE_OFFSET UNITYSDK_OFFSET(0x751CBC0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_GETEXPOSEDPARAMCOUNT_OFFSET UNITYSDK_OFFSET(0x751BD50)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_GET_ISANIMATIONCONFIG_OFFSET UNITYSDK_OFFSET(0x751B6B0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_INSTANTIATE_1_OFFSET UNITYSDK_OFFSET(0x751BC70)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x751B780)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY_ISMATCH_OFFSET UNITYSDK_OFFSET(0x751B6C0)
#define NPCCROWD_ANIMATION_ANIMATIONCONTROLLERINSTANCEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x751CDA0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int AnimationControllerInstanceEntry_TypeDefinitionIndex = 43498;
