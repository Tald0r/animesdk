...
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPTBASE_DESTROY_OFFSET UNITYSDK_OFFSET(0x77D8220)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPTBASE_GETBISCREATED_OFFSET UNITYSDK_OFFSET(0x77D8040)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPTBASE_GETGRAPH_OFFSET UNITYSDK_OFFSET(0x77D80B0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPTBASE_PAUSEGRAPH_OFFSET UNITYSDK_OFFSET(0x77D81A0)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPTBASE_PLAYGRAPH_OFFSET UNITYSDK_OFFSET(0x77D8120)
#define NPCCROWD_ANIMATION_NPCCPUANIMATIONGRAPHSCRIPTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x77D82B0)

namespace NPCCrowd::Animation
{
	inline static constexpr unsigned int NPCCPUAnimationGraphScriptBase_TypeDefinitionIndex = 78668;
