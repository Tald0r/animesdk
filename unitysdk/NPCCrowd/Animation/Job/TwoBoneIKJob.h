...
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x307440)
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x307400)
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_SETUP_OFFSET UNITYSDK_OFFSET(0x3073F0)
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_SOLVE_OFFSET UNITYSDK_OFFSET(0x65222D0)
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_TRIANGLEANGLE_OFFSET UNITYSDK_OFFSET(0x6522D00)

namespace NPCCrowd::Animation::Job
{
	inline static constexpr unsigned int TwoBoneIKJob_TypeDefinitionIndex = 78915;
