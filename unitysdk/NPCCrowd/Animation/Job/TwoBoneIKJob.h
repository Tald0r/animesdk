...
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x33AD10)
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x33ACD0)
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_SETUP_OFFSET UNITYSDK_OFFSET(0x33ACC0)
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_SOLVE_OFFSET UNITYSDK_OFFSET(0x7E026D0)
#define NPCCROWD_ANIMATION_JOB_TWOBONEIKJOB_TRIANGLEANGLE_OFFSET UNITYSDK_OFFSET(0x7E03100)

namespace NPCCrowd::Animation::Job
{
	inline static constexpr unsigned int TwoBoneIKJob_TypeDefinitionIndex = 56136;
