...
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_COMPUTEDAMPEDPOSITIONS_OFFSET UNITYSDK_OFFSET(0x351080)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_COMPUTEJOINTLOCALROTATIONS_OFFSET UNITYSDK_OFFSET(0x3510C0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTLOCALPOS_OFFSET UNITYSDK_OFFSET(0x350F10)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x350F30)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTLOC_OFFSET UNITYSDK_OFFSET(0x350ED0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTROT_OFFSET UNITYSDK_OFFSET(0x350EF0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTWORLDPOS_OFFSET UNITYSDK_OFFSET(0x350F50)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTWORLDROTATION_OFFSET UNITYSDK_OFFSET(0x350F70)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_INIT_OFFSET UNITYSDK_OFFSET(0x350F90)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x351040)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x351000)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_SETROOTLOCANDROT_OFFSET UNITYSDK_OFFSET(0x350E60)

namespace NPCCrowd::Animation::Job
{
	inline static constexpr unsigned int DampingJob_TypeDefinitionIndex = 64533;
