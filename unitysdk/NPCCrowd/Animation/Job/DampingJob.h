...
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_COMPUTEDAMPEDPOSITIONS_OFFSET UNITYSDK_OFFSET(0x36F4E0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_COMPUTEJOINTLOCALROTATIONS_OFFSET UNITYSDK_OFFSET(0x36F520)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTLOCALPOS_OFFSET UNITYSDK_OFFSET(0x36F370)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x36F390)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTLOC_OFFSET UNITYSDK_OFFSET(0x36F330)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTROT_OFFSET UNITYSDK_OFFSET(0x36F350)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTWORLDPOS_OFFSET UNITYSDK_OFFSET(0x36F3B0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_GETROOTWORLDROTATION_OFFSET UNITYSDK_OFFSET(0x36F3D0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_INIT_OFFSET UNITYSDK_OFFSET(0x36F3F0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x36F4A0)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x36F460)
#define NPCCROWD_ANIMATION_JOB_DAMPINGJOB_SETROOTLOCANDROT_OFFSET UNITYSDK_OFFSET(0x36F2C0)

namespace NPCCrowd::Animation::Job
{
	inline static constexpr unsigned int DampingJob_TypeDefinitionIndex = 76389;
