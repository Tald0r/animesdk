...
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x380FA0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_GETFORWARDS_OFFSET UNITYSDK_OFFSET(0x9B05490)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_INITJOINTS_OFFSET UNITYSDK_OFFSET(0x381000)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_INITPARAMBUFFER_OFFSET UNITYSDK_OFFSET(0x380FB0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_LOOKATDIRECTION_OFFSET UNITYSDK_OFFSET(0x9B059B0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x381100)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x3810C0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETCLAMPWEIGHTS_OFFSET UNITYSDK_OFFSET(0x3810B0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETTARGET_OFFSET UNITYSDK_OFFSET(0x380FC0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETWEIGHTS_OFFSET UNITYSDK_OFFSET(0x3810A0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETWEIGHT_OFFSET UNITYSDK_OFFSET(0x380FF0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SOLVEEYES_OFFSET UNITYSDK_OFFSET(0x9B04DC0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SOLVEHEAD_OFFSET UNITYSDK_OFFSET(0x9B046D0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SOLVESPINE_OFFSET UNITYSDK_OFFSET(0x9B04060)

namespace NPCCrowd::Animation::Job
{
	inline static constexpr unsigned int LookAtJob_TypeDefinitionIndex = 70762;
