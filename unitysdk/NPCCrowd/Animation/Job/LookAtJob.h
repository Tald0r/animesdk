...
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x320B10)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_GETFORWARDS_OFFSET UNITYSDK_OFFSET(0x722D570)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_INITJOINTS_OFFSET UNITYSDK_OFFSET(0x320B70)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_INITPARAMBUFFER_OFFSET UNITYSDK_OFFSET(0x320B20)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_LOOKATDIRECTION_OFFSET UNITYSDK_OFFSET(0x722DA90)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x320C70)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x320C30)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETCLAMPWEIGHTS_OFFSET UNITYSDK_OFFSET(0x320C20)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETTARGET_OFFSET UNITYSDK_OFFSET(0x320B30)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETWEIGHTS_OFFSET UNITYSDK_OFFSET(0x320C10)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SETWEIGHT_OFFSET UNITYSDK_OFFSET(0x320B60)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SOLVEEYES_OFFSET UNITYSDK_OFFSET(0x722CEA0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SOLVEHEAD_OFFSET UNITYSDK_OFFSET(0x722C7B0)
#define NPCCROWD_ANIMATION_JOB_LOOKATJOB_SOLVESPINE_OFFSET UNITYSDK_OFFSET(0x722C140)

namespace NPCCrowd::Animation::Job
{
	inline static constexpr unsigned int LookAtJob_TypeDefinitionIndex = 68095;
