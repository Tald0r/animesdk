...
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_GETEFFECTORHANDLE_OFFSET UNITYSDK_OFFSET(0x317EF0)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_GETIKLIMBHANDLE_OFFSET UNITYSDK_OFFSET(0x317F10)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_PREPARESOLVEPULL_OFFSET UNITYSDK_OFFSET(0x318070)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x318190)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x318150)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SETBODYEFFECTOR_OFFSET UNITYSDK_OFFSET(0x317FF0)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SETEFFECTOR_OFFSET UNITYSDK_OFFSET(0x317F30)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SETHINTEFFECTOR_OFFSET UNITYSDK_OFFSET(0x317F70)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SETLOOKATEFFECTOR_OFFSET UNITYSDK_OFFSET(0x317FB0)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SETMAXIMUMEXTENSION_OFFSET UNITYSDK_OFFSET(0x318030)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SOLVEPULL_OFFSET UNITYSDK_OFFSET(0x3180C0)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SOLVE_OFFSET UNITYSDK_OFFSET(0x318110)

namespace NPCCrowd::Animation::Job
{
	inline static constexpr unsigned int FullBodyIKJob_TypeDefinitionIndex = 74097;
