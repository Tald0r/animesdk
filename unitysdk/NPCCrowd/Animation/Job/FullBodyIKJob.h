...
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_GETEFFECTORHANDLE_OFFSET UNITYSDK_OFFSET(0x33D150)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_GETIKLIMBHANDLE_OFFSET UNITYSDK_OFFSET(0x33D170)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_PREPARESOLVEPULL_OFFSET UNITYSDK_OFFSET(0x33D2D0)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x33D3F0)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x33D3B0)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SETBODYEFFECTOR_OFFSET UNITYSDK_OFFSET(0x33D250)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SETEFFECTOR_OFFSET UNITYSDK_OFFSET(0x33D190)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SETHINTEFFECTOR_OFFSET UNITYSDK_OFFSET(0x33D1D0)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SETLOOKATEFFECTOR_OFFSET UNITYSDK_OFFSET(0x33D210)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SETMAXIMUMEXTENSION_OFFSET UNITYSDK_OFFSET(0x33D290)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SOLVEPULL_OFFSET UNITYSDK_OFFSET(0x33D320)
#define NPCCROWD_ANIMATION_JOB_FULLBODYIKJOB_SOLVE_OFFSET UNITYSDK_OFFSET(0x33D370)

namespace NPCCrowd::Animation::Job
{
	inline static constexpr unsigned int FullBodyIKJob_TypeDefinitionIndex = 62089;
