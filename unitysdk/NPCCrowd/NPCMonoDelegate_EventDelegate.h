...
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x6425080)
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x64250B0)
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x6424DE0)
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x6424DC0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCMonoDelegate_EventDelegate_TypeDefinitionIndex = 40667;
