...
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x6A29BB0)
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x6A29BE0)
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x6A29910)
#define NPCCROWD_NPCMONODELEGATE_EVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x6A29900)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCMonoDelegate_EventDelegate_TypeDefinitionIndex = 59290;
