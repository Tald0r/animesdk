...
#define NPCCROWD_ABILITY_NPCABILITYDITHERPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x6950530)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityDitherParameters_TypeDefinitionIndex = 48535;
