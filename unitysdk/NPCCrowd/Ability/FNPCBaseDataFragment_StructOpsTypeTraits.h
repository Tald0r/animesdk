...
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x6BA2440)
#define NPCCROWD_ABILITY_FNPCBASEDATAFRAGMENT_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x6BA2450)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCBaseDataFragment_StructOpsTypeTraits_TypeDefinitionIndex = 70663;
