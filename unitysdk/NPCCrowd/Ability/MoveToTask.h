...
#define NPCCROWD_ABILITY_MOVETOTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_MOVETOTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x310FB0)
#define NPCCROWD_ABILITY_MOVETOTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x69E0C40)
#define NPCCROWD_ABILITY_MOVETOTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x310F90)
#define NPCCROWD_ABILITY_MOVETOTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_MOVETOTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x69DFDB0)
#define NPCCROWD_ABILITY_MOVETOTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x69E00E0)
#define NPCCROWD_ABILITY_MOVETOTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x69DFCF0)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F4290)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x310A30)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x311010)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F4310)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_MOVETOTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x310A20)
#define NPCCROWD_ABILITY_MOVETOTASK_LINK_OFFSET UNITYSDK_OFFSET(0x69DFA30)
#define NPCCROWD_ABILITY_MOVETOTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_MOVETOTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x310FB0)
#define NPCCROWD_ABILITY_MOVETOTASK_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x310E10)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x310EF0)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x310E80)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x310DA0)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x310CC0)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x310B70)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x310B00)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x310C50)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x310BE0)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x310A90)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x310D30)
#define NPCCROWD_ABILITY_MOVETOTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x3109B0)
#define NPCCROWD_ABILITY_MOVETOTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x69E0150)
#define NPCCROWD_ABILITY_MOVETOTASK_TICK_OFFSET UNITYSDK_OFFSET(0x69E0330)
#define NPCCROWD_ABILITY_MOVETOTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_MOVETOTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x311070)
#define NPCCROWD_ABILITY_MOVETOTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x69E10E0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int MoveToTask_TypeDefinitionIndex = 60692;

	struct alignas(4) MoveToTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(MoveToTask_TypeDefinitionIndex)->GetStaticField(0x41F80);
		}
