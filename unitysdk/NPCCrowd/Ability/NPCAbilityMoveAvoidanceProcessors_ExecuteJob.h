...
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_COLLECTCLOSESTOBSTACLE_OFFSET UNITYSDK_OFFSET(0x355210)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_COMPUTECLOSESTPOINTOFAPPROACH_OFFSET UNITYSDK_OFFSET(0x3552E0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x355240)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_FINDCLOSESTOBSTACLES_OFFSET UNITYSDK_OFFSET(0x355140)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETAVOIDANCEFORCE_OFFSET UNITYSDK_OFFSET(0x355280)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETLOCATIONXZ_OFFSET UNITYSDK_OFFSET(0x3551B0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0x3551D0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETSEPARATIONFORCE_OFFSET UNITYSDK_OFFSET(0x355250)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB_GETVELOCITYXZ_OFFSET UNITYSDK_OFFSET(0x3551F0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_EXECUTEJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x355130)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityMoveAvoidanceProcessors_ExecuteJob_TypeDefinitionIndex = 60176;
