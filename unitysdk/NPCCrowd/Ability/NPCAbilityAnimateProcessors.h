...
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x7642390)
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x7641CF0)
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS_INITDEFAULTANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0x7641970)
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS_INITPATHFOLLOWANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0x76415C0)
#define NPCCROWD_ABILITY_NPCABILITYANIMATEPROCESSORS__CTOR_OFFSET UNITYSDK_OFFSET(0x7642590)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityAnimateProcessors_TypeDefinitionIndex = 42856;
