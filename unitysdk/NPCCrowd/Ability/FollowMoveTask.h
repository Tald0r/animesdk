...
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x339F30)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_CREATE_OFFSET UNITYSDK_OFFSET(0x77F0090)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x339F10)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x77EE770)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x77EF2F0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x77EE6B0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GETPREDICTOFFSETS_OFFSET UNITYSDK_OFFSET(0x77EF5E0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F4290)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x3399B0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x339F90)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F4310)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x3399A0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_LINK_OFFSET UNITYSDK_OFFSET(0x77EE2D0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x339F30)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x339D90)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x339E70)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x339E00)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x339D20)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x339C40)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x339AF0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x339A80)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x339BD0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x339B60)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x339A10)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x339CB0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x339930)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x77EF360)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_TICKLOGIC_OFFSET UNITYSDK_OFFSET(0x77EE830)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_TICK_OFFSET UNITYSDK_OFFSET(0x77EF500)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FOLLOWMOVETASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x339FF0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x77F0530)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FollowMoveTask_TypeDefinitionIndex = 73838;

	struct alignas(4) FollowMoveTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FollowMoveTask_TypeDefinitionIndex)->GetStaticField(0x3F450);
		}
