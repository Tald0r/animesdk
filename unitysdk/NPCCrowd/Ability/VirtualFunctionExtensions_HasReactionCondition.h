...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_HASREACTIONCONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0x751A9C0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_HASREACTIONCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x751AA80)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_HASREACTIONCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x751AA10)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_HASREACTIONCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x751AB10)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_HasReactionCondition_TypeDefinitionIndex = 49972;
