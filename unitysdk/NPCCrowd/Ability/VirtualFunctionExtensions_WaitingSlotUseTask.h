...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_WAITINGSLOTUSETASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x751ACA0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_WAITINGSLOTUSETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x751AC10)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_WAITINGSLOTUSETASK_LINK_OFFSET UNITYSDK_OFFSET(0x751ABA0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_WAITINGSLOTUSETASK_TICK_OFFSET UNITYSDK_OFFSET(0x751AD40)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_WaitingSlotUseTask_TypeDefinitionIndex = 58558;
