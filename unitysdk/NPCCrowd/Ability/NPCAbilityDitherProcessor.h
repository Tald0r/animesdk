...
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x633E910)
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x633D3C0)
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR_FINDCLOSESTENTITY_OFFSET UNITYSDK_OFFSET(0x633E1E0)
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR_GETCLOSESTENTITYDISTANCE_OFFSET UNITYSDK_OFFSET(0x633D6C0)
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR_GETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0x633D5C0)
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x633EB10)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityDitherProcessor_TypeDefinitionIndex = 69063;
