...
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x5DFDE50)
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x5DFC6A0)
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR_FINDCLOSESTENTITY_OFFSET UNITYSDK_OFFSET(0x5DFD740)
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR_GETCLOSESTENTITYDISTANCE_OFFSET UNITYSDK_OFFSET(0x5DFCA90)
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR_GETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0x5DFC8A0)
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x5DFE050)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityDitherProcessor_TypeDefinitionIndex = 67710;
