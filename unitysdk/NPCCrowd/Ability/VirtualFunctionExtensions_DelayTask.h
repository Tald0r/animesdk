...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_DELAYTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x6BA49B0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_DELAYTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x6BA4920)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_DELAYTASK_TICK_OFFSET UNITYSDK_OFFSET(0x6BA4AA0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_DelayTask_TypeDefinitionIndex = 38594;
