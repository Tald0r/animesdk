...
#define NPCCROWD_ABILITY_AFTERNAVMESHCOMBINEPROCESSOR_EXECUTEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x31CEA0)
#define NPCCROWD_ABILITY_AFTERNAVMESHCOMBINEPROCESSOR_EXECUTEJOB_SETMOVEMENTPARAMETERS_OFFSET UNITYSDK_OFFSET(0x31CEB0)
#define NPCCROWD_ABILITY_AFTERNAVMESHCOMBINEPROCESSOR_EXECUTEJOB_SETORIENTATIONPARAMETERS_OFFSET UNITYSDK_OFFSET(0x31CEC0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int AfterNavMeshCombineProcessor_ExecuteJob_TypeDefinitionIndex = 61229;
