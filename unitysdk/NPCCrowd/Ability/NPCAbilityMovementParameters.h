...
#define NPCCROWD_ABILITY_NPCABILITYMOVEMENTPARAMETERS_GETMOVEMENTPARAMBYANIMID_OFFSET UNITYSDK_OFFSET(0x5DFF500)
#define NPCCROWD_ABILITY_NPCABILITYMOVEMENTPARAMETERS_RANDDESIREDMOVESPEED_OFFSET UNITYSDK_OFFSET(0x5DFE740)
#define NPCCROWD_ABILITY_NPCABILITYMOVEMENTPARAMETERS_REFRESH_OFFSET UNITYSDK_OFFSET(0x5DFE140)
#define NPCCROWD_ABILITY_NPCABILITYMOVEMENTPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x5E03160)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityMovementParameters_TypeDefinitionIndex = 36953;
