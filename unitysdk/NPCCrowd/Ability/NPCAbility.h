...
#define NPCCROWD_ABILITY_NPCABILITY_CLEAR_OFFSET UNITYSDK_OFFSET(0x69E11C0)
#define NPCCROWD_ABILITY_NPCABILITY_GETCURRENTACTIONID_OFFSET UNITYSDK_OFFSET(0x69E18B0)
#define NPCCROWD_ABILITY_NPCABILITY_GETCURRENTACTIONTYPE_OFFSET UNITYSDK_OFFSET(0x69E19F0)
#define NPCCROWD_ABILITY_NPCABILITY_GETMOVEMENTMAG_OFFSET UNITYSDK_OFFSET(0x69E2570)
#define NPCCROWD_ABILITY_NPCABILITY_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x69E2640)
#define NPCCROWD_ABILITY_NPCABILITY_GETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x69E1280)
#define NPCCROWD_ABILITY_NPCABILITY_ISPATHFOLLOWFINISHED_OFFSET UNITYSDK_OFFSET(0x69D75C0)
#define NPCCROWD_ABILITY_NPCABILITY_ISPATHFOLLOWHUMAN_1_OFFSET UNITYSDK_OFFSET(0x69E2030)
#define NPCCROWD_ABILITY_NPCABILITY_ISPATHFOLLOWHUMAN_2_OFFSET UNITYSDK_OFFSET(0x69E20D0)
#define NPCCROWD_ABILITY_NPCABILITY_ISPATHFOLLOWHUMAN_OFFSET UNITYSDK_OFFSET(0x69E1F30)
#define NPCCROWD_ABILITY_NPCABILITY_ISPATHFOLLOWSTARTED_OFFSET UNITYSDK_OFFSET(0x69E1950)
#define NPCCROWD_ABILITY_NPCABILITY_ISSTARTMOVEPROCESS_OFFSET UNITYSDK_OFFSET(0x69E1A90)
#define NPCCROWD_ABILITY_NPCABILITY_MOVETO_OFFSET UNITYSDK_OFFSET(0x69E1330)
#define NPCCROWD_ABILITY_NPCABILITY_ONABILITYREMOVED_OFFSET UNITYSDK_OFFSET(0x69E1780)
#define NPCCROWD_ABILITY_NPCABILITY_PATHFOLLOW_1_OFFSET UNITYSDK_OFFSET(0x69E1540)
#define NPCCROWD_ABILITY_NPCABILITY_PATHFOLLOW_OFFSET UNITYSDK_OFFSET(0x69E1440)
#define NPCCROWD_ABILITY_NPCABILITY_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x69E26D0)
#define NPCCROWD_ABILITY_NPCABILITY_SETBORNTRANSFORM_OFFSET UNITYSDK_OFFSET(0x69E21D0)
#define NPCCROWD_ABILITY_NPCABILITY_SMOOTHROTATIONTO_OFFSET UNITYSDK_OFFSET(0x69E1D30)
#define NPCCROWD_ABILITY_NPCABILITY_STARTSTANDTURN_OFFSET UNITYSDK_OFFSET(0x69E16C0)
#define NPCCROWD_ABILITY_NPCABILITY_STARTSTATETREE_1_OFFSET UNITYSDK_OFFSET(0x69E2980)
#define NPCCROWD_ABILITY_NPCABILITY_STARTSTATETREE_OFFSET UNITYSDK_OFFSET(0x69E27D0)
#define NPCCROWD_ABILITY_NPCABILITY_STOPCURRENTMOVEACTION_OFFSET UNITYSDK_OFFSET(0x69E1C70)
#define NPCCROWD_ABILITY_NPCABILITY_STOPMOVEACTION_OFFSET UNITYSDK_OFFSET(0x69E1BC0)
#define NPCCROWD_ABILITY_NPCABILITY_STOPSTATETREE_OFFSET UNITYSDK_OFFSET(0x69E2B30)
#define NPCCROWD_ABILITY_NPCABILITY_TELEPORTTO_OFFSET UNITYSDK_OFFSET(0x69E1E30)
#define NPCCROWD_ABILITY_NPCABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x69E2C80)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbility_TypeDefinitionIndex = 61602;

	class NPCAbility : public ::System::Object
	{
	public:
		// static const ::System::Int32 INVALID_ABILITY_IDX = 0xFFFFFFFF; // 0x0
		::NPCCrowd::Ability::FNPCAbilityMovementStyleSpeedParameters movementParams; // 0x10
		::NPCCrowd::Ability::NPCAbilityRuntimeData* runtimeData; // 0xA0
		::NPCCrowd::Ability::NPCAbilityBridgeData* bridgeData; // 0xA8
		::System::Boolean usePathFollow; // 0xB0
		::System::Int32 abilityIdx; // 0xB4
		::NPCCrowd::NPCPhysicsManager_PhysicsHandle physicsHandle; // 0xB8
		::UnityEngine::Vector3 posCache; // 0xBC
		::UnityEngine::Vector3 lastPosCache; // 0xC8
