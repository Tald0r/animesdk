...
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENT_ADDNODE_OFFSET UNITYSDK_OFFSET(0x2FFBC0)
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENT_CLEARNODE_OFFSET UNITYSDK_OFFSET(0x2FFC40)
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENT_GETNODE_OFFSET UNITYSDK_OFFSET(0x2FFAC0)
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENT_SETNODE_OFFSET UNITYSDK_OFFSET(0x2FFB40)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCAbilityPathFollowFragment_TypeDefinitionIndex = 64951;
