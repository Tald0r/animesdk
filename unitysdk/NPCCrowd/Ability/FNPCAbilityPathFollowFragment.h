...
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENT_ADDNODE_OFFSET UNITYSDK_OFFSET(0x2FB320)
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENT_CLEARNODE_OFFSET UNITYSDK_OFFSET(0x2FB3A0)
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENT_GETNODE_OFFSET UNITYSDK_OFFSET(0x2FB220)
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENT_SETNODE_OFFSET UNITYSDK_OFFSET(0x2FB2A0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCAbilityPathFollowFragment_TypeDefinitionIndex = 43827;
