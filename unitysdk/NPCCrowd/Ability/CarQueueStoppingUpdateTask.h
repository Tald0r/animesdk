...
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x306510)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_CREATE_OFFSET UNITYSDK_OFFSET(0x7517050)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x32D270)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x7515E30)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0x7516720)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F4290)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x32CD10)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x32D290)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F4310)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x32CD00)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_LINK_OFFSET UNITYSDK_OFFSET(0x7515C90)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x306510)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x32D0F0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x32D1D0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x32D160)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x32D080)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x32CFA0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x32CE50)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x32CDE0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x32CF30)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x32CEC0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x32CD70)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x32D010)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x32CC90)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_TICK_OFFSET UNITYSDK_OFFSET(0x7515EF0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x32D2F0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x75174D0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int CarQueueStoppingUpdateTask_TypeDefinitionIndex = 64672;

	struct alignas(4) CarQueueStoppingUpdateTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(CarQueueStoppingUpdateTask_TypeDefinitionIndex)->GetStaticField(0x40A90);
		}
