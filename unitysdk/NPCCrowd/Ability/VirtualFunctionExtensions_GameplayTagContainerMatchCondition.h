...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_GAMEPLAYTAGCONTAINERMATCHCONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0x62E0700)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_GAMEPLAYTAGCONTAINERMATCHCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x62E0810)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_GAMEPLAYTAGCONTAINERMATCHCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x62E0750)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_GAMEPLAYTAGCONTAINERMATCHCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x62E08A0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_GameplayTagContainerMatchCondition_TypeDefinitionIndex = 80898;
