...
#define NPCCROWD_ABILITY_VIRTUALPROXY_SETSTATEMACHINEPARAMTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xC2EBE00)
#define NPCCROWD_ABILITY_VIRTUALPROXY_SETSTATEMACHINEPARAMTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xC2EBDA0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_SETSTATEMACHINEPARAMTASK_LINK_OFFSET UNITYSDK_OFFSET(0xC2EBD30)
#define NPCCROWD_ABILITY_VIRTUALPROXY_SETSTATEMACHINEPARAMTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0xC2EBE70)
#define NPCCROWD_ABILITY_VIRTUALPROXY_SETSTATEMACHINEPARAMTASK__CTOR_OFFSET UNITYSDK_OFFSET(0xC2EBF30)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_SetStateMachineParamTask_TypeDefinitionIndex = 61861;
