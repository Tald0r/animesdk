...
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0x76D0DE0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F2490)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x3342C0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_CREATE_OFFSET UNITYSDK_OFFSET(0x76D1870)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x334D90)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x76D0FF0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x3349F0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x334DB0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x3349E0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x76D0E50)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F2490)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x3342C0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_RESET_OFFSET UNITYSDK_OFFSET(0x2F24D0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x334C10)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x334AC0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x334B30)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x334CF0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x334C80)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x334BA0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_OPERAND_OFFSET UNITYSDK_OFFSET(0x334A50)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x334970)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x76D10B0)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x334E10)
#define NPCCROWD_ABILITY_PLAYERAVATARDISTANCECONDITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x76D1CD0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int PlayerAvatarDistanceCondition_TypeDefinitionIndex = 77344;

	struct alignas(4) PlayerAvatarDistanceCondition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(PlayerAvatarDistanceCondition_TypeDefinitionIndex)->GetStaticField(0x47B20);
		}
