...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_FOLLOWMOVETASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xC2EBA20)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_FOLLOWMOVETASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0xC2EBAD0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_FOLLOWMOVETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xC2EB980)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_FOLLOWMOVETASK_LINK_OFFSET UNITYSDK_OFFSET(0xC2EB910)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_FOLLOWMOVETASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0xC2EBBC0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_FOLLOWMOVETASK_TICK_OFFSET UNITYSDK_OFFSET(0xC2EBC70)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_FollowMoveTask_TypeDefinitionIndex = 68583;
