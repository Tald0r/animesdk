...
#define NPCCROWD_ABILITY_DELAYTASK_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x6F99340)
#define NPCCROWD_ABILITY_DELAYTASK_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x6F99350)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int DelayTask_StructOpsTypeTraits_TypeDefinitionIndex = 45725;
