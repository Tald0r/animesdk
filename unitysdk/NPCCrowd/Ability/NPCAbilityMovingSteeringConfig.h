...
#define NPCCROWD_ABILITY_NPCABILITYMOVINGSTEERINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x601FA90)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityMovingSteeringConfig_TypeDefinitionIndex = 68501;
