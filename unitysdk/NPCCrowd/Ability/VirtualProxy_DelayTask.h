...
#define NPCCROWD_ABILITY_VIRTUALPROXY_DELAYTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x751AFA0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_DELAYTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x751AF40)
#define NPCCROWD_ABILITY_VIRTUALPROXY_DELAYTASK_TICK_OFFSET UNITYSDK_OFFSET(0x751B070)
#define NPCCROWD_ABILITY_VIRTUALPROXY_DELAYTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x751A4A0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_DelayTask_TypeDefinitionIndex = 48808;
