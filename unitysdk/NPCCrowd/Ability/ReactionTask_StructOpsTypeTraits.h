...
#define NPCCROWD_ABILITY_REACTIONTASK_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x6518260)
#define NPCCROWD_ABILITY_REACTIONTASK_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x6518270)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int ReactionTask_StructOpsTypeTraits_TypeDefinitionIndex = 59034;
