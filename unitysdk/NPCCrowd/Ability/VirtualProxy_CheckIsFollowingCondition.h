...
#define NPCCROWD_ABILITY_VIRTUALPROXY_CHECKISFOLLOWINGCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x751AE60)
#define NPCCROWD_ABILITY_VIRTUALPROXY_CHECKISFOLLOWINGCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x751ADF0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_CHECKISFOLLOWINGCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x751AEC0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_CHECKISFOLLOWINGCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x751AF30)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_CheckIsFollowingCondition_TypeDefinitionIndex = 49616;
