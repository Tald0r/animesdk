...
#define NPCCROWD_ABILITY_VIRTUALPROXY_CARQUEUEUPDATEENVIRONMENTTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x62E09A0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_CARQUEUEUPDATEENVIRONMENTTASK_LINK_OFFSET UNITYSDK_OFFSET(0x62E0930)
#define NPCCROWD_ABILITY_VIRTUALPROXY_CARQUEUEUPDATEENVIRONMENTTASK_TICK_OFFSET UNITYSDK_OFFSET(0x62E0A00)
#define NPCCROWD_ABILITY_VIRTUALPROXY_CARQUEUEUPDATEENVIRONMENTTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x62E0A80)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_CarQueueUpdateEnvironmentTask_TypeDefinitionIndex = 43081;
