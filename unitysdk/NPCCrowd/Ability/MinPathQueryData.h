...
#define NPCCROWD_ABILITY_MINPATHQUERYDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x31D320)
#define NPCCROWD_ABILITY_MINPATHQUERYDATA_GETNEARESTPOS_OFFSET UNITYSDK_OFFSET(0x31D4B0)
#define NPCCROWD_ABILITY_MINPATHQUERYDATA_INITDATA_OFFSET UNITYSDK_OFFSET(0x31D310)
#define NPCCROWD_ABILITY_MINPATHQUERYDATA_QUERYFINISHED_OFFSET UNITYSDK_OFFSET(0x31D330)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int MinPathQueryData_TypeDefinitionIndex = 60322;
