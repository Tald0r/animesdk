...
#define NPCCROWD_ABILITY_MINPATHQUERYDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x323A20)
#define NPCCROWD_ABILITY_MINPATHQUERYDATA_GETNEARESTPOS_OFFSET UNITYSDK_OFFSET(0x323BB0)
#define NPCCROWD_ABILITY_MINPATHQUERYDATA_INITDATA_OFFSET UNITYSDK_OFFSET(0x323A10)
#define NPCCROWD_ABILITY_MINPATHQUERYDATA_QUERYFINISHED_OFFSET UNITYSDK_OFFSET(0x323A30)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int MinPathQueryData_TypeDefinitionIndex = 45107;
