...
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2F72F0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x174A82C0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x7C4D80)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x174A7700)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x174A7640)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F4290)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x7C4820)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x2F7350)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F4310)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x7C4810)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_LINK_OFFSET UNITYSDK_OFFSET(0x174A74A0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2F72F0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x7C4C00)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x7C4CE0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x7C4C70)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x7C4B90)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x7C4AB0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x7C4960)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x7C48F0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x7C4A40)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x7C49D0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x7C4880)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x7C4B20)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x7C47A0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_TICK_OFFSET UNITYSDK_OFFSET(0x174A7770)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_ATTRACTORFINDTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F73B0)
#define NPCCROWD_ABILITY_ATTRACTORFINDTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x638E470)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int AttractorFindTask_TypeDefinitionIndex = 41406;

	struct alignas(4) AttractorFindTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(AttractorFindTask_TypeDefinitionIndex)->GetStaticField(0x39B50);
		}
