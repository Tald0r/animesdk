...
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2FA720)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x8475B40)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x350510)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x8474970)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x8474E60)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x84748B0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F4290)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x34FFB0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x350530)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F4310)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x34FFA0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_LINK_OFFSET UNITYSDK_OFFSET(0x84747B0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2FA720)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x350390)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x350470)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x350400)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x350320)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x350240)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x3500F0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x350080)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x3501D0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x350160)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x350010)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x3502B0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x34FF30)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_TICK_OFFSET UNITYSDK_OFFSET(0x84752A0)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x350590)
#define NPCCROWD_ABILITY_UIBUBBLEPERFORMTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x8475FB0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int UIBubblePerformTask_TypeDefinitionIndex = 61378;

	struct alignas(8) UIBubblePerformTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(UIBubblePerformTask_TypeDefinitionIndex)->GetStaticField(0x3DBB0);
		}
