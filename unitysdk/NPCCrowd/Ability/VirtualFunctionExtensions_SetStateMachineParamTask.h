...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_SETSTATEMACHINEPARAMTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x84768E0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_SETSTATEMACHINEPARAMTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x8476850)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_SETSTATEMACHINEPARAMTASK_LINK_OFFSET UNITYSDK_OFFSET(0x84767E0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_SETSTATEMACHINEPARAMTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x8476980)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_SetStateMachineParamTask_TypeDefinitionIndex = 59228;
