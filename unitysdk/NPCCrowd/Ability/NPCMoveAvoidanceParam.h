...
#define NPCCROWD_ABILITY_NPCMOVEAVOIDANCEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x77CA460)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCMoveAvoidanceParam_TypeDefinitionIndex = 69016;
