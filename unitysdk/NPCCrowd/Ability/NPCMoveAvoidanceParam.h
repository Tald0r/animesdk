...
#define NPCCROWD_ABILITY_NPCMOVEAVOIDANCEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC2EAAD0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCMoveAvoidanceParam_TypeDefinitionIndex = 50381;
