...
#define NPCCROWD_ABILITY_ATTRACTORCANDIDATECONDITION_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x77ECFE0)
#define NPCCROWD_ABILITY_ATTRACTORCANDIDATECONDITION_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x77ECFF0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int AttractorCandidateCondition_StructOpsTypeTraits_TypeDefinitionIndex = 39349;
