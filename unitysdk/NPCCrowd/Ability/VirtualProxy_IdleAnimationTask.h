...
#define NPCCROWD_ABILITY_VIRTUALPROXY_IDLEANIMATIONTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x76D2670)
#define NPCCROWD_ABILITY_VIRTUALPROXY_IDLEANIMATIONTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x76D26E0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_IDLEANIMATIONTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x76D2610)
#define NPCCROWD_ABILITY_VIRTUALPROXY_IDLEANIMATIONTASK_LINK_OFFSET UNITYSDK_OFFSET(0x76D25A0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_IDLEANIMATIONTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x76D2750)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_IdleAnimationTask_TypeDefinitionIndex = 46440;
