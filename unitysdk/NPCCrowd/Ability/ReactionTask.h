...
#define NPCCROWD_ABILITY_REACTIONTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_REACTIONTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2F58E0)
#define NPCCROWD_ABILITY_REACTIONTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x86265B0)
#define NPCCROWD_ABILITY_REACTIONTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x355900)
#define NPCCROWD_ABILITY_REACTIONTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_REACTIONTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x8625A80)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F4290)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x3553A0)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x355920)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F4310)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_REACTIONTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x355390)
#define NPCCROWD_ABILITY_REACTIONTASK_LINK_OFFSET UNITYSDK_OFFSET(0x8625980)
#define NPCCROWD_ABILITY_REACTIONTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_REACTIONTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2F58E0)
#define NPCCROWD_ABILITY_REACTIONTASK_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x355780)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x355860)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x3557F0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x355710)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x355630)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x3554E0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x355470)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x3555C0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x355550)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x355400)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x3556A0)
#define NPCCROWD_ABILITY_REACTIONTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x355320)
#define NPCCROWD_ABILITY_REACTIONTASK_TICK_OFFSET UNITYSDK_OFFSET(0x8625B40)
#define NPCCROWD_ABILITY_REACTIONTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_REACTIONTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x355980)
#define NPCCROWD_ABILITY_REACTIONTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x8626A40)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int ReactionTask_TypeDefinitionIndex = 59033;

	struct alignas(4) ReactionTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(ReactionTask_TypeDefinitionIndex)->GetStaticField(0x379E0);
		}
