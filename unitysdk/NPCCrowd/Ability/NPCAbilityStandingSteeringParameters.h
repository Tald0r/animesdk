...
#define NPCCROWD_ABILITY_NPCABILITYSTANDINGSTEERINGPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x7644EA0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityStandingSteeringParameters_TypeDefinitionIndex = 47205;
