...
#define NPCCROWD_ABILITY_NPCABILITYOBSTACLEFLUSHPROCESSOR_CLEAN_OFFSET UNITYSDK_OFFSET(0x7518B50)
#define NPCCROWD_ABILITY_NPCABILITYOBSTACLEFLUSHPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x7518660)
#define NPCCROWD_ABILITY_NPCABILITYOBSTACLEFLUSHPROCESSOR_PREPARE_OFFSET UNITYSDK_OFFSET(0x7518930)
#define NPCCROWD_ABILITY_NPCABILITYOBSTACLEFLUSHPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x7518BB0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityObstacleFlushProcessor_TypeDefinitionIndex = 79658;
