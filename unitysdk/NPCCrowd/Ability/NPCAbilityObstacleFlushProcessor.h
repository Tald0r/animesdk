...
#define NPCCROWD_ABILITY_NPCABILITYOBSTACLEFLUSHPROCESSOR_CLEAN_OFFSET UNITYSDK_OFFSET(0x757A840)
#define NPCCROWD_ABILITY_NPCABILITYOBSTACLEFLUSHPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x757A350)
#define NPCCROWD_ABILITY_NPCABILITYOBSTACLEFLUSHPROCESSOR_PREPARE_OFFSET UNITYSDK_OFFSET(0x757A620)
#define NPCCROWD_ABILITY_NPCABILITYOBSTACLEFLUSHPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x757A8A0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityObstacleFlushProcessor_TypeDefinitionIndex = 75891;
