...
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x33C230)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x9AFE020)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x380BC0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x9AFCE00)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x9AFD1B0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x9AFCD40)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F4290)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x380660)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x380BE0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F4310)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x380650)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_LINK_OFFSET UNITYSDK_OFFSET(0x9AFCA80)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x33C230)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x380A40)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x380B20)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x380AB0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x3809D0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x3808F0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x3807A0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x380730)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x380880)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x380810)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x3806C0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x380960)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x3805E0)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_TICK_OFFSET UNITYSDK_OFFSET(0x9AFD290)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x380C40)
#define NPCCROWD_ABILITY_WAITINGSLOTMOVETOSLOTTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x9AFE490)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int WaitingSlotMoveToSlotTask_TypeDefinitionIndex = 72638;

	struct alignas(4) WaitingSlotMoveToSlotTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(WaitingSlotMoveToSlotTask_TypeDefinitionIndex)->GetStaticField(0x44640);
		}
