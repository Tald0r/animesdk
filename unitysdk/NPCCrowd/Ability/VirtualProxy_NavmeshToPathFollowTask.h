...
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x76D2830)
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x76D28A0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x76D27D0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK_LINK_OFFSET UNITYSDK_OFFSET(0x76D2760)
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x76D2910)
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK_TICK_OFFSET UNITYSDK_OFFSET(0x76D29D0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_NAVMESHTOPATHFOLLOWTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x76D2A50)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_NavmeshToPathFollowTask_TypeDefinitionIndex = 69776;
