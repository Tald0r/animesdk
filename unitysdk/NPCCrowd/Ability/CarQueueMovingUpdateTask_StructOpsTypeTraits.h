...
#define NPCCROWD_ABILITY_CARQUEUEMOVINGUPDATETASK_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x6BA2420)
#define NPCCROWD_ABILITY_CARQUEUEMOVINGUPDATETASK_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x6BA2430)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int CarQueueMovingUpdateTask_StructOpsTypeTraits_TypeDefinitionIndex = 41294;
