...
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x86218A0)
#define NPCCROWD_ABILITY_CARQUEUESTOPPINGUPDATETASK_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x86218B0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int CarQueueStoppingUpdateTask_StructOpsTypeTraits_TypeDefinitionIndex = 64673;
