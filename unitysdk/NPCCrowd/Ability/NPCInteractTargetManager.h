...
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x65156B0)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x6515AC0)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0x65159A0)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER_PRELOADASSETS_OFFSET UNITYSDK_OFFSET(0x65158F0)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER_REGISTERINTERACTTARGET_OFFSET UNITYSDK_OFFSET(0x6515D10)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x6515850)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER_TRYGETINTERACTTARGET_OFFSET UNITYSDK_OFFSET(0x65169A0)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER_TRYINTERACTINTERACTTARGET_OFFSET UNITYSDK_OFFSET(0x6515E90)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER_TRYRELEASEINTERACTTARGET_OFFSET UNITYSDK_OFFSET(0x65166A0)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER_UNREGISTERINTERACTTARGET_OFFSET UNITYSDK_OFFSET(0x6515DE0)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x6516E80)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x6516DC0)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER___BASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x6516F20)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER___BASE_ONPRELOADFINISHED_OFFSET UNITYSDK_OFFSET(0x6516F90)
#define NPCCROWD_ABILITY_NPCINTERACTTARGETMANAGER___BASE_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x6516FF0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCInteractTargetManager_TypeDefinitionIndex = 72824;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::NPCCrowd::Ability::InteractTargetBase*>**)Il2CppClass::FromTypeDefinitionIndex(NPCInteractTargetManager_TypeDefinitionIndex)->GetStaticField(0x43590);
		}
