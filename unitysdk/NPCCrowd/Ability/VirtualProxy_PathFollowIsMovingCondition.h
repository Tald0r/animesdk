...
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWISMOVINGCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x63FE450)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWISMOVINGCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x63FE3E0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWISMOVINGCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x63FE4B0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWISMOVINGCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x63FE520)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_PathFollowIsMovingCondition_TypeDefinitionIndex = 73698;
