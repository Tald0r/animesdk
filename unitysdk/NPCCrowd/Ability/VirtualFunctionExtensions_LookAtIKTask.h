...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_LOOKATIKTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x86279B0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_LOOKATIKTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x8627920)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_LOOKATIKTASK_LINK_OFFSET UNITYSDK_OFFSET(0x86278B0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_LOOKATIKTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x8627A50)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_LOOKATIKTASK_TICK_OFFSET UNITYSDK_OFFSET(0x8627B40)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_LookAtIKTask_TypeDefinitionIndex = 45778;
