...
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x37FEB0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTEJOB_PROCESSMOVEACTION_OFFSET UNITYSDK_OFFSET(0x9AF9EA0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTEJOB_SETMOVEACTION_OFFSET UNITYSDK_OFFSET(0x9AF9DB0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityPathFollowProcessors_ExecuteJob_TypeDefinitionIndex = 44240;
