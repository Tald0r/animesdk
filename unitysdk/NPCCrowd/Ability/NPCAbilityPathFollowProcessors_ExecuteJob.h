...
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x3205C0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTEJOB_PROCESSMOVEACTION_OFFSET UNITYSDK_OFFSET(0x7225260)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTEJOB_SETMOVEACTION_OFFSET UNITYSDK_OFFSET(0x7225170)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityPathFollowProcessors_ExecuteJob_TypeDefinitionIndex = 37121;
