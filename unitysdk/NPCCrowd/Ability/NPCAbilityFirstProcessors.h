...
#define NPCCROWD_ABILITY_NPCABILITYFIRSTPROCESSORS_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x6F9AC20)
#define NPCCROWD_ABILITY_NPCABILITYFIRSTPROCESSORS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x6F9AAC0)
#define NPCCROWD_ABILITY_NPCABILITYFIRSTPROCESSORS__CTOR_OFFSET UNITYSDK_OFFSET(0x6F9AE20)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityFirstProcessors_TypeDefinitionIndex = 43725;
