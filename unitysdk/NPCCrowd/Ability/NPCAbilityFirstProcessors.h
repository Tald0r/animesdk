...
#define NPCCROWD_ABILITY_NPCABILITYFIRSTPROCESSORS_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x743C600)
#define NPCCROWD_ABILITY_NPCABILITYFIRSTPROCESSORS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x743C4A0)
#define NPCCROWD_ABILITY_NPCABILITYFIRSTPROCESSORS__CTOR_OFFSET UNITYSDK_OFFSET(0x743C7F0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityFirstProcessors_TypeDefinitionIndex = 76652;
