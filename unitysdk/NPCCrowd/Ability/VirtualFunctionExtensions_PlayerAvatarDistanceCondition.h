...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_PLAYERAVATARDISTANCECONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0x8627C30)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_PLAYERAVATARDISTANCECONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x8627CF0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_PLAYERAVATARDISTANCECONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x8627C80)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_PLAYERAVATARDISTANCECONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x8627D80)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_PlayerAvatarDistanceCondition_TypeDefinitionIndex = 74146;
