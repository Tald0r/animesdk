...
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x76CDA10)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASK_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x76CDA20)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int IdleAnimationTask_StructOpsTypeTraits_TypeDefinitionIndex = 45592;
