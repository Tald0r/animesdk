...
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x75181F0)
#define NPCCROWD_ABILITY_FOLLOWMOVETASK_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x7518200)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FollowMoveTask_StructOpsTypeTraits_TypeDefinitionIndex = 73839;
