...
#define NPCCROWD_ABILITY_VIRTUALPROXY_GAMEPLAYTAGCONTAINERMATCHCONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0x7800B80)
#define NPCCROWD_ABILITY_VIRTUALPROXY_GAMEPLAYTAGCONTAINERMATCHCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x7800D00)
#define NPCCROWD_ABILITY_VIRTUALPROXY_GAMEPLAYTAGCONTAINERMATCHCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x7800C40)
#define NPCCROWD_ABILITY_VIRTUALPROXY_GAMEPLAYTAGCONTAINERMATCHCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x7800D60)
#define NPCCROWD_ABILITY_VIRTUALPROXY_GAMEPLAYTAGCONTAINERMATCHCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x7800DD0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_GameplayTagContainerMatchCondition_TypeDefinitionIndex = 63847;
