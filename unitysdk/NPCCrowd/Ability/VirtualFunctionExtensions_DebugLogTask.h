...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_DEBUGLOGTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x78007F0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_DEBUGLOGTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x7800760)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_DEBUGLOGTASK_LINK_OFFSET UNITYSDK_OFFSET(0x78006F0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_DebugLogTask_TypeDefinitionIndex = 39139;
