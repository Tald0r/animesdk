...
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR_EXECUTEJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x37B4F0)
#define NPCCROWD_ABILITY_NPCABILITYDITHERPROCESSOR_EXECUTEJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x37B4E0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityDitherProcessor_ExecuteJob_TypeDefinitionIndex = 67711;
