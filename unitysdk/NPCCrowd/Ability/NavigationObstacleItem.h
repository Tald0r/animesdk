...
#define NPCCROWD_ABILITY_NAVIGATIONOBSTACLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3600)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NavigationObstacleItem_TypeDefinitionIndex = 72170;
