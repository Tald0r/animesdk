...
#define NPCCROWD_ABILITY_WAITINGSLOTRUNTIME_ONRELEASED_OFFSET UNITYSDK_OFFSET(0x639AC70)
#define NPCCROWD_ABILITY_WAITINGSLOTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x639A850)
#define NPCCROWD_ABILITY_WAITINGSLOTRUNTIME___BASE_ONRELEASED_OFFSET UNITYSDK_OFFSET(0x639AD20)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int WaitingSlotRuntime_TypeDefinitionIndex = 79984;
