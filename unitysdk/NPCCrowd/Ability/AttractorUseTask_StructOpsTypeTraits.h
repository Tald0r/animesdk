...
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x7515C70)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x7515C80)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int AttractorUseTask_StructOpsTypeTraits_TypeDefinitionIndex = 77176;
