...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_MOVETOTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x69E69B0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_MOVETOTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x69E6A80)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_MOVETOTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x69E6910)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_MOVETOTASK_LINK_OFFSET UNITYSDK_OFFSET(0x69E68C0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_MOVETOTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x69E6B50)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_MOVETOTASK_TICK_OFFSET UNITYSDK_OFFSET(0x69E6C00)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_MoveToTask_TypeDefinitionIndex = 79421;
