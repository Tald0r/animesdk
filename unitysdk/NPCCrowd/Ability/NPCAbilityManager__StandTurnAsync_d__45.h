...
#define NPCCROWD_ABILITY_NPCABILITYMANAGER__STANDTURNASYNC_D__45_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x32DF10)
#define NPCCROWD_ABILITY_NPCABILITYMANAGER__STANDTURNASYNC_D__45_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityManager__StandTurnAsync_d__45_TypeDefinitionIndex = 68786;
