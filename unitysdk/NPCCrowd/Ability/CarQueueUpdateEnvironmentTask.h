...
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x306510)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_CREATE_OFFSET UNITYSDK_OFFSET(0xC2E9190)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x3C18C0)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0xC2E8690)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F4290)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x3C1360)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x3C18E0)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F4310)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x3C1350)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_LINK_OFFSET UNITYSDK_OFFSET(0xC2E84F0)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x306510)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x3C1740)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x3C1820)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x3C17B0)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x3C16D0)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x3C15F0)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x3C14A0)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x3C1430)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x3C1580)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x3C1510)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x3C13C0)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x3C1660)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x3C12E0)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_TICK_OFFSET UNITYSDK_OFFSET(0xC2E8750)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x3C1940)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0xC2E9610)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int CarQueueUpdateEnvironmentTask_TypeDefinitionIndex = 41995;

	struct alignas(4) CarQueueUpdateEnvironmentTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(CarQueueUpdateEnvironmentTask_TypeDefinitionIndex)->GetStaticField(0x46EA0);
		}
