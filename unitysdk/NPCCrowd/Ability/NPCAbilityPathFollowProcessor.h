...
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x6B4B1F0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x6B45910)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_EXITINTERACTSPLINE_OFFSET UNITYSDK_OFFSET(0x6B4AC40)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETEXITSPLINEPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x6B4A190)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x6B45810)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0x6B4C830)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETNEARESTCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x6B44AA0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETNEARESTLANE_OFFSET UNITYSDK_OFFSET(0x6B44390)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETNEARESTPOINTINPATH_OFFSET UNITYSDK_OFFSET(0x6B42880)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETNEARESTPOINT_OFFSET UNITYSDK_OFFSET(0x6B44000)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETPATHFOLLOWAIMPOS_OFFSET UNITYSDK_OFFSET(0x6B45510)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETPATHNEARESTDATA_OFFSET UNITYSDK_OFFSET(0x6B44D90)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETPATHPOINTSCOUNTINCLUDELANE_OFFSET UNITYSDK_OFFSET(0x6B437E0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETPATHPOINTSINCLUDELANE_OFFSET UNITYSDK_OFFSET(0x6B43A50)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETPATHPOINTS_1_OFFSET UNITYSDK_OFFSET(0x6B43570)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETPATHPOINTS_OFFSET UNITYSDK_OFFSET(0x6B432A0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x6B45780)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETPREVABILITY_OFFSET UNITYSDK_OFFSET(0x6B4C610)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETREFPOINTRATIO_OFFSET UNITYSDK_OFFSET(0x6B44F00)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETSPLINEMERGETARGETPOS_OFFSET UNITYSDK_OFFSET(0x6B45200)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x6B41430)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETSTARTROTATION_OFFSET UNITYSDK_OFFSET(0x6B41770)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_GETSTARTSPLINEPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x6B41CF0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_HANDLENODECHANGED_OFFSET UNITYSDK_OFFSET(0x6B3FCC0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_INITDEFAULTDATA_OFFSET UNITYSDK_OFFSET(0x6B41F90)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_INITPATHPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6B3FE80)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_ISPASSEDAIM_OFFSET UNITYSDK_OFFSET(0x6B41C00)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_ISPATHFOLLOWMOVING_OFFSET UNITYSDK_OFFSET(0x6B3F930)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_ISPATHFOLLOWSTARTED_OFFSET UNITYSDK_OFFSET(0x6B3F9E0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_ONDESTROYPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6B3FA80)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_PREEXECUTEBEFOREJOB_OFFSET UNITYSDK_OFFSET(0x6B46B40)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_PREPARESTAIRSPEEDBLEND_OFFSET UNITYSDK_OFFSET(0x6B47ED0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_SETINTERACTSPLINE_OFFSET UNITYSDK_OFFSET(0x6B4A630)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_SETPATHFOLLOWFINDRESULT_OFFSET UNITYSDK_OFFSET(0x6B424F0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_STARTSLOPESPEEDBLEND_OFFSET UNITYSDK_OFFSET(0x6B480A0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_STARTSTAIRSPEEDBLEND_OFFSET UNITYSDK_OFFSET(0x6B469E0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_TELEPORTPATHFOLLOWPOINT_OFFSET UNITYSDK_OFFSET(0x6B42D30)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_TRYEXITSPLINENODE_OFFSET UNITYSDK_OFFSET(0x6B47A40)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_TRYFADEOUTMOVE_OFFSET UNITYSDK_OFFSET(0x6B4A350)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_UPDATEBEHAVIOURS_OFFSET UNITYSDK_OFFSET(0x6B4B420)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_UPDATECOMMONBLOCK_OFFSET UNITYSDK_OFFSET(0x6B4B5C0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_UPDATEEXITINTERACTTARGET_OFFSET UNITYSDK_OFFSET(0x6B4D990)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_UPDATEFIRSTABILITYINNODE_OFFSET UNITYSDK_OFFSET(0x6B4CA20)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_UPDATEFOLLOWPREV_OFFSET UNITYSDK_OFFSET(0x6B4CD30)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_UPDATEINTERACTTARGET_OFFSET UNITYSDK_OFFSET(0x6B4D3D0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_UPDATENEXTLANE_OFFSET UNITYSDK_OFFSET(0x6B49BD0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_UPDATEPATHFOLLOWAIM_OFFSET UNITYSDK_OFFSET(0x6B47180)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_UPDATEPATHFOLLOW_OFFSET UNITYSDK_OFFSET(0x6B46EB0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_UPDATESPEEDCONTROL_OFFSET UNITYSDK_OFFSET(0x6B4BA20)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_UPDATESPLINENODECONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x6B48160)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_UPDATESPLINENODE_OFFSET UNITYSDK_OFFSET(0x6B487B0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR_UPDATEWAITINGBEHAVIOURS_OFFSET UNITYSDK_OFFSET(0x6B4D050)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x6B4DDD0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6B4DDC0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityPathFollowProcessor_TypeDefinitionIndex = 40160;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCAbilityPathFollowProcessor_TypeDefinitionIndex)->GetStaticField(0xEF50);
		}
		static ::System::Single* StaticGet_StairPrepareDistance()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCAbilityPathFollowProcessor_TypeDefinitionIndex)->GetStaticField(0xEF54);
		}
		static ::System::Single* StaticGet__upAxisInterpolationFactor()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCAbilityPathFollowProcessor_TypeDefinitionIndex)->GetStaticField(0xEF58);
		}
		static ::System::Single* StaticGet_FOLLOW_SCALE()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCAbilityPathFollowProcessor_TypeDefinitionIndex)->GetStaticField(0xEF5C);
		}
		static ::System::Single* StaticGet_SpeedScale()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCAbilityPathFollowProcessor_TypeDefinitionIndex)->GetStaticField(0xEF60);
		}
