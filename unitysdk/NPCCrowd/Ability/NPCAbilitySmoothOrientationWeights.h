...
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONWEIGHTS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x7DF7D00)
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONWEIGHTS__CTOR_OFFSET UNITYSDK_OFFSET(0x7DF7CF0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilitySmoothOrientationWeights_TypeDefinitionIndex = 65524;
