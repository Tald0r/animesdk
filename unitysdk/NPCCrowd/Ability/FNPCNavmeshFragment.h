...
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F50C0)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2F4F00)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0x633B5B0)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x2F4EE0)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2F5210)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x2F4E80)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x2F5270)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F5130)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2F4FE0)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x2F51A0)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F52D0)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x633BBA0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCNavmeshFragment_TypeDefinitionIndex = 56040;

	struct alignas(4) FNPCNavmeshFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FNPCNavmeshFragment_TypeDefinitionIndex)->GetStaticField(0x45410);
		}
