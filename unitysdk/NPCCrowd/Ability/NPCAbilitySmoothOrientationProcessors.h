...
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONPROCESSORS_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x69E4140)
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONPROCESSORS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x69E3220)
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONPROCESSORS_INITPROCESSOR_OFFSET UNITYSDK_OFFSET(0x69E2F80)
#define NPCCROWD_ABILITY_NPCABILITYSMOOTHORIENTATIONPROCESSORS__CTOR_OFFSET UNITYSDK_OFFSET(0x69E4440)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilitySmoothOrientationProcessors_TypeDefinitionIndex = 46073;
