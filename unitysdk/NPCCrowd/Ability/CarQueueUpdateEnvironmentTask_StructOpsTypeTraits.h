...
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0xC2E9700)
#define NPCCROWD_ABILITY_CARQUEUEUPDATEENVIRONMENTTASK_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0xC2E9650)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int CarQueueUpdateEnvironmentTask_StructOpsTypeTraits_TypeDefinitionIndex = 41996;
