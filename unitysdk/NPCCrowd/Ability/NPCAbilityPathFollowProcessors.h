...
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x695B360)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x695A610)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_INITPATHPROCESSOR_OFFSET UNITYSDK_OFFSET(0x69529B0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_INITPOINTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6951720)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_ISPATHFOLLOWMOVING_OFFSET UNITYSDK_OFFSET(0x6955620)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_PREEXECUTEBEFOREJOB_OFFSET UNITYSDK_OFFSET(0x6958A70)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS__CCTOR_OFFSET UNITYSDK_OFFSET(0x695B570)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS__CTOR_OFFSET UNITYSDK_OFFSET(0x6950FE0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityPathFollowProcessors_TypeDefinitionIndex = 37120;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCAbilityPathFollowProcessors_TypeDefinitionIndex)->GetStaticField(0xE2B0);
		}
