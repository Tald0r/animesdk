...
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x62DF2A0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x62DE550)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_INITPATHPROCESSOR_OFFSET UNITYSDK_OFFSET(0x62D6B30)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_INITPOINTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x62D58A0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_ISPATHFOLLOWMOVING_OFFSET UNITYSDK_OFFSET(0x62D97A0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS_PREEXECUTEBEFOREJOB_OFFSET UNITYSDK_OFFSET(0x62DC9D0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS__CCTOR_OFFSET UNITYSDK_OFFSET(0x62DF4B0)
#define NPCCROWD_ABILITY_NPCABILITYPATHFOLLOWPROCESSORS__CTOR_OFFSET UNITYSDK_OFFSET(0x62D5160)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityPathFollowProcessors_TypeDefinitionIndex = 44239;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCAbilityPathFollowProcessors_TypeDefinitionIndex)->GetStaticField(0xE7E0);
		}
