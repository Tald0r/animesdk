...
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC_COMPARE_OFFSET UNITYSDK_OFFSET(0x339B10)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC_FOUNDATION_CONTAINER_IHIERARCHICALHASHGRIDCOMPAREKEYFUNC_NPCCROWD_ABILITY_NAVIGATIONOBSTACLEITEM__GETKEY_OFFSET UNITYSDK_OFFSET(0x339B70)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC_GETCELLKEY_OFFSET UNITYSDK_OFFSET(0x3398A0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC_GETKEY_OFFSET UNITYSDK_OFFSET(0x339900)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x3397F0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityMoveAvoidanceProcessors_NavigationObstacleCellCompareKeyFunc_TypeDefinitionIndex = 78489;
