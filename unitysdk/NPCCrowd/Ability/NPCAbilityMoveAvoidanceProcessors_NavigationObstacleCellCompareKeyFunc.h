...
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC_COMPARE_OFFSET UNITYSDK_OFFSET(0x305EA0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC_FOUNDATION_CONTAINER_IHIERARCHICALHASHGRIDCOMPAREKEYFUNC_NPCCROWD_ABILITY_NAVIGATIONOBSTACLEITEM__GETKEY_OFFSET UNITYSDK_OFFSET(0x305F00)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC_GETCELLKEY_OFFSET UNITYSDK_OFFSET(0x305C80)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC_GETKEY_OFFSET UNITYSDK_OFFSET(0x305D90)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_NAVIGATIONOBSTACLECELLCOMPAREKEYFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x305B10)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityMoveAvoidanceProcessors_NavigationObstacleCellCompareKeyFunc_TypeDefinitionIndex = 60174;
