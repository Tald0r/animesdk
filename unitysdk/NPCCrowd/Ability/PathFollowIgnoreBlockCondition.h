...
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F2490)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2F2440)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_CREATE_OFFSET UNITYSDK_OFFSET(0x6399580)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x2F7C80)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x6398DB0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x2F78E0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x2F7CA0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x2F78D0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x6398CB0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F2490)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2F2440)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_RESET_OFFSET UNITYSDK_OFFSET(0x2F24D0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F7B00)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x2F79B0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x2F7A20)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F7BE0)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F7B70)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x2F7A90)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_OPERAND_OFFSET UNITYSDK_OFFSET(0x2F7940)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F7860)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x6398E70)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F7D00)
#define NPCCROWD_ABILITY_PATHFOLLOWIGNOREBLOCKCONDITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x63999F0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int PathFollowIgnoreBlockCondition_TypeDefinitionIndex = 79111;

	struct alignas(4) PathFollowIgnoreBlockCondition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(PathFollowIgnoreBlockCondition_TypeDefinitionIndex)->GetStaticField(0x39BC0);
		}
