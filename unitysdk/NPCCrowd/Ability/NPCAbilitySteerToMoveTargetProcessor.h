...
#define NPCCROWD_ABILITY_NPCABILITYSTEERTOMOVETARGETPROCESSOR_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x7841AA0)
#define NPCCROWD_ABILITY_NPCABILITYSTEERTOMOVETARGETPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x783F9A0)
#define NPCCROWD_ABILITY_NPCABILITYSTEERTOMOVETARGETPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x7841E90)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilitySteerToMoveTargetProcessor_TypeDefinitionIndex = 41573;
