...
#define NPCCROWD_ABILITY_NPCABILITYSTEERTOMOVETARGETPROCESSOR_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x6EBE570)
#define NPCCROWD_ABILITY_NPCABILITYSTEERTOMOVETARGETPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x6EBC470)
#define NPCCROWD_ABILITY_NPCABILITYSTEERTOMOVETARGETPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6EBE950)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilitySteerToMoveTargetProcessor_TypeDefinitionIndex = 42755;
