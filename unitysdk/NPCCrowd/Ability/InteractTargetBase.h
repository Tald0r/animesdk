...
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_CHECKINTERACTVALID_OFFSET UNITYSDK_OFFSET(0xC2E9780)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_INITSLOTS_OFFSET UNITYSDK_OFFSET(0xC2E9710)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_ONSTARTINTERACT_OFFSET UNITYSDK_OFFSET(0xC2E98E0)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_TRYOCCUPYVALIDSLOT_OFFSET UNITYSDK_OFFSET(0xC2E9830)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_TRYRELEASESLOT_OFFSET UNITYSDK_OFFSET(0xC2E99C0)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_UPDATESLOTS_OFFSET UNITYSDK_OFFSET(0xC2E9950)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2E9A30)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int InteractTargetBase_TypeDefinitionIndex = 51309;
