...
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_CHECKINTERACTVALID_OFFSET UNITYSDK_OFFSET(0x77C9160)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_INITSLOTS_OFFSET UNITYSDK_OFFSET(0x77C90F0)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_ONSTARTINTERACT_OFFSET UNITYSDK_OFFSET(0x77C92C0)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_TRYOCCUPYVALIDSLOT_OFFSET UNITYSDK_OFFSET(0x77C9210)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_TRYRELEASESLOT_OFFSET UNITYSDK_OFFSET(0x77C93A0)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE_UPDATESLOTS_OFFSET UNITYSDK_OFFSET(0x77C9330)
#define NPCCROWD_ABILITY_INTERACTTARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x77C9410)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int InteractTargetBase_TypeDefinitionIndex = 66136;

	class InteractTargetBase : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::NPCCrowd::Ability::InteractSlot*>* slots; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::NPCCrowd::Ability::InteractSlot*>* slotMap; // 0x18
