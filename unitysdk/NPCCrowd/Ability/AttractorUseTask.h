...
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2FA720)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_CREATE_OFFSET UNITYSDK_OFFSET(0x63FBD50)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x2FA700)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x63FA340)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x63FA7F0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x63FA280)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F4290)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x2FA1A0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x2FA780)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F4310)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x2FA190)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_LINK_OFFSET UNITYSDK_OFFSET(0x63F9FC0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2FA720)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_REALEXITACTION_OFFSET UNITYSDK_OFFSET(0x63FB250)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2FA580)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2FA660)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2FA5F0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x2FA510)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2FA430)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2FA2E0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2FA270)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2FA3C0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2FA350)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2FA200)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2FA4A0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2FA120)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_TICK_OFFSET UNITYSDK_OFFSET(0x63FAB60)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_ATTRACTORUSETASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2FA7E0)
#define NPCCROWD_ABILITY_ATTRACTORUSETASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x63FC1C0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int AttractorUseTask_TypeDefinitionIndex = 77175;

	struct alignas(4) AttractorUseTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(AttractorUseTask_TypeDefinitionIndex)->GetStaticField(0x34CA0);
		}
