...
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x9AFBAA0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x9AFBAB0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int PathFollowBlockedCondition_StructOpsTypeTraits_TypeDefinitionIndex = 38819;
