...
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x638E9D0)
#define NPCCROWD_ABILITY_FTRANSFORMFRAGMENT_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x638E9E0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FTransformFragment_StructOpsTypeTraits_TypeDefinitionIndex = 52116;
