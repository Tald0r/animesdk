...
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x62D1A40)
#define NPCCROWD_ABILITY_HASREACTIONCONDITION_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x62D1A50)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int HasReactionCondition_StructOpsTypeTraits_TypeDefinitionIndex = 79505;
