...
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x6BA2460)
#define NPCCROWD_ABILITY_FNPCNAVMESHFRAGMENT_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x6BA2470)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCNavmeshFragment_StructOpsTypeTraits_TypeDefinitionIndex = 56041;
