...
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2F9FB0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x63F99D0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x2F9F90)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x63F7570)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x63F8250)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F4290)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x2F96A0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x2FA010)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F4310)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x2F9690)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_LINK_OFFSET UNITYSDK_OFFSET(0x63F7260)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2F9FB0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_REALEXITACTION_OFFSET UNITYSDK_OFFSET(0x63F7F20)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SETSTAIRBLEND_OFFSET UNITYSDK_OFFSET(0x63F81C0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F9D00)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F9E80)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F9DC0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x2F9C40)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F9AC0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F9880)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F97C0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F9A00)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F9940)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F9700)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F9B80)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F95D0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_TICK_OFFSET UNITYSDK_OFFSET(0x63F84A0)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_ATTRACTORMOVETOTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2FA070)
#define NPCCROWD_ABILITY_ATTRACTORMOVETOTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x63F9EE0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int AttractorMoveToTask_TypeDefinitionIndex = 56141;

	struct alignas(4) AttractorMoveToTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(AttractorMoveToTask_TypeDefinitionIndex)->GetStaticField(0x34C80);
		}
