...
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENTV2_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x633AEB0)
#define NPCCROWD_ABILITY_FNPCABILITYPATHFOLLOWFRAGMENTV2_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x633AEC0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCAbilityPathFollowFragmentV2_StructOpsTypeTraits_TypeDefinitionIndex = 54839;
