...
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWIGNOREBLOCKCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x63FE300)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWIGNOREBLOCKCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x63FE290)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWIGNOREBLOCKCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x63FE360)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PATHFOLLOWIGNOREBLOCKCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x63FE3D0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_PathFollowIgnoreBlockCondition_TypeDefinitionIndex = 78818;
