...
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x32DBB0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x32D9D0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_CREATENEWACTION_OFFSET UNITYSDK_OFFSET(0x32D8B0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0x7517AD0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x32D9B0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x32DD00)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_ENABLEWARPING_OFFSET UNITYSDK_OFFSET(0x32D5B0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETCURRENTACTIONID_OFFSET UNITYSDK_OFFSET(0x32D840)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETCURRENTACTIONSERVERSTARTTIME_OFFSET UNITYSDK_OFFSET(0x32D7D0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETCURRENTACTIONSTARTTIME_OFFSET UNITYSDK_OFFSET(0x32D760)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETCURRENTMOVEACTIONTYPE_OFFSET UNITYSDK_OFFSET(0x32D6F0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GETPREVIOUSACTION_OFFSET UNITYSDK_OFFSET(0x32D680)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x32D950)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x32DD60)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x32DC20)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x32DAC0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_POPWARPINGTARGET_OFFSET UNITYSDK_OFFSET(0x32D520)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_PUSHWARPINGTARGET_OFFSET UNITYSDK_OFFSET(0x32D4E0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x32DC90)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x32DDC0)
#define NPCCROWD_ABILITY_FNPCABILITYMOVETARGETFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x7518100)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int FNPCAbilityMoveTargetFragment_TypeDefinitionIndex = 69589;

	struct alignas(4) FNPCAbilityMoveTargetFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FNPCAbilityMoveTargetFragment_TypeDefinitionIndex)->GetStaticField(0x40AA0);
		}
		static ::System::Boolean* StaticGet_DebugEnableWarping()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(FNPCAbilityMoveTargetFragment_TypeDefinitionIndex)->GetStaticField(0xF910);
		}
