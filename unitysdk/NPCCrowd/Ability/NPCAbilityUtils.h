...
#define NPCCROWD_ABILITY_NPCABILITYUTILS_ISNODEBLOCKEDSTART_OFFSET UNITYSDK_OFFSET(0x77C9D10)
#define NPCCROWD_ABILITY_NPCABILITYUTILS_ISNODEBLOCKEDSTOP_OFFSET UNITYSDK_OFFSET(0x77C9B10)
#define NPCCROWD_ABILITY_NPCABILITYUTILS_ISNODEBLOCKED_1_OFFSET UNITYSDK_OFFSET(0x77C98F0)
#define NPCCROWD_ABILITY_NPCABILITYUTILS_ISNODEBLOCKED_OFFSET UNITYSDK_OFFSET(0x77C96F0)
#define NPCCROWD_ABILITY_NPCABILITYUTILS_ISPATHFOLLOWBLOCKED_OFFSET UNITYSDK_OFFSET(0x77C9F00)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityUtils_TypeDefinitionIndex = 53903;
