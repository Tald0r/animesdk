...
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_CHANGENAVMESHTOPATHFOLLOW_1_OFFSET UNITYSDK_OFFSET(0x63925D0)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_CHANGENAVMESHTOPATHFOLLOW_OFFSET UNITYSDK_OFFSET(0x6394FD0)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x6393680)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x638E9F0)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_GETCROWDCOMPONENT_OFFSET UNITYSDK_OFFSET(0x6394700)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_GETMAXTURNINGANGLEFORHOTFIX_OFFSET UNITYSDK_OFFSET(0x63921F0)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_GETMINTURNINGANGLEFORHOTFIX_OFFSET UNITYSDK_OFFSET(0x6392150)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_NAVMESHTOPOS_1_OFFSET UNITYSDK_OFFSET(0x6394A60)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_NAVMESHTOPOS_2_OFFSET UNITYSDK_OFFSET(0x63926B0)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_NAVMESHTOPOS_3_OFFSET UNITYSDK_OFFSET(0x6394DE0)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_NAVMESHTOPOS_OFFSET UNITYSDK_OFFSET(0x6394960)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_ONINIT_OFFSET UNITYSDK_OFFSET(0x6393A70)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_PATHFOLLOWSETNEARESTDATA_OFFSET UNITYSDK_OFFSET(0x6392290)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_PREEXECUTEBEFOREJOBAFTERPATHFOLLOW_OFFSET UNITYSDK_OFFSET(0x6393FC0)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_PREEXECUTEBEFOREJOB_OFFSET UNITYSDK_OFFSET(0x6393AD0)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_PROCESSMOVEACTION_OFFSET UNITYSDK_OFFSET(0x63928E0)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_SETATTRACTORENTITYRETURNTOWANDERINGDATA_OFFSET UNITYSDK_OFFSET(0x6395C80)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_SETMOVEACTION_OFFSET UNITYSDK_OFFSET(0x6392780)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_SETPATHFOLLOWTARGETDATA_OFFSET UNITYSDK_OFFSET(0x6395230)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_SIMPLEMOVETO_1_OFFSET UNITYSDK_OFFSET(0x63959F0)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_SIMPLEMOVETO_OFFSET UNITYSDK_OFFSET(0x6395740)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_STOPNAVMESH_OFFSET UNITYSDK_OFFSET(0x63956E0)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_STOPSIMPLEMOVE_OFFSET UNITYSDK_OFFSET(0x6395BA0)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_TRYNAVMESHTOPATHFOLLOW_1_OFFSET UNITYSDK_OFFSET(0x6393CD0)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_TRYNAVMESHTOPATHFOLLOW_2_OFFSET UNITYSDK_OFFSET(0x6394130)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR_TRYNAVMESHTOPATHFOLLOW_OFFSET UNITYSDK_OFFSET(0x6393C00)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x6396020)
#define NPCCROWD_ABILITY_NPCAIPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6396010)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAIProcessor_TypeDefinitionIndex = 58218;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCAIProcessor_TypeDefinitionIndex)->GetStaticField(0xE230);
		}
		static ::System::Single* StaticGet_MaxTurningAngleForHotFix()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCAIProcessor_TypeDefinitionIndex)->GetStaticField(0xE234);
		}
