...
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x3334D0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x8472770)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x34F6D0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x34F730)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x3334D0)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x2F7610)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x34F790)
#define NPCCROWD_ABILITY_IDLEANIMATIONTASKINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x84728A0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int IdleAnimationTaskInstanceData_TypeDefinitionIndex = 41973;

	struct alignas(4) IdleAnimationTaskInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(IdleAnimationTaskInstanceData_TypeDefinitionIndex)->GetStaticField(0x3DB00);
		}
