...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_UIBUBBLEPERFORMTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x6F9BE70)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_UIBUBBLEPERFORMTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x6F9BF10)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_UIBUBBLEPERFORMTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x6F9BDE0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_UIBUBBLEPERFORMTASK_LINK_OFFSET UNITYSDK_OFFSET(0x6F9BD70)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_UIBUBBLEPERFORMTASK_TICK_OFFSET UNITYSDK_OFFSET(0x6F9BFB0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_UIBubblePerformTask_TypeDefinitionIndex = 37417;
