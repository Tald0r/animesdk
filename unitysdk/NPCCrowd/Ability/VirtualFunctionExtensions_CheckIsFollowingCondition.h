...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_CHECKISFOLLOWINGCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x7845F40)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_CHECKISFOLLOWINGCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x7845ED0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_CHECKISFOLLOWINGCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x7845FD0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_CheckIsFollowingCondition_TypeDefinitionIndex = 63889;
