...
#define NPCCROWD_ABILITY_VIRTUALPROXY_CARQUEUEMOVINGUPDATETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x9AFC780)
#define NPCCROWD_ABILITY_VIRTUALPROXY_CARQUEUEMOVINGUPDATETASK_LINK_OFFSET UNITYSDK_OFFSET(0x9AFC710)
#define NPCCROWD_ABILITY_VIRTUALPROXY_CARQUEUEMOVINGUPDATETASK_TICK_OFFSET UNITYSDK_OFFSET(0x9AFC7E0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_CARQUEUEMOVINGUPDATETASK__CTOR_OFFSET UNITYSDK_OFFSET(0x9AFC860)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_CarQueueMovingUpdateTask_TypeDefinitionIndex = 51308;
