...
#define NPCCROWD_ABILITY_VIRTUALPROXY_ATTRACTORMOVETOTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x6518910)
#define NPCCROWD_ABILITY_VIRTUALPROXY_ATTRACTORMOVETOTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x6518980)
#define NPCCROWD_ABILITY_VIRTUALPROXY_ATTRACTORMOVETOTASK_LINK_OFFSET UNITYSDK_OFFSET(0x65188A0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_ATTRACTORMOVETOTASK_TICK_OFFSET UNITYSDK_OFFSET(0x65189F0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_ATTRACTORMOVETOTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x6518A70)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_AttractorMoveToTask_TypeDefinitionIndex = 53997;
