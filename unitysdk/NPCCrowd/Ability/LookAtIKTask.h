...
#define NPCCROWD_ABILITY_LOOKATIKTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_LOOKATIKTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2F58E0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x633CE30)
#define NPCCROWD_ABILITY_LOOKATIKTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x2F58C0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x633BE50)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x633BD90)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F4290)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x2F5360)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x2F5940)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F4310)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_LOOKATIKTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x2F5350)
#define NPCCROWD_ABILITY_LOOKATIKTASK_LINK_OFFSET UNITYSDK_OFFSET(0x633BC90)
#define NPCCROWD_ABILITY_LOOKATIKTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_LOOKATIKTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2F58E0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F5740)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F5820)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F57B0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x2F56D0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F55F0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F54A0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F5430)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F5580)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F5510)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F53C0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F5660)
#define NPCCROWD_ABILITY_LOOKATIKTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F52E0)
#define NPCCROWD_ABILITY_LOOKATIKTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x633C510)
#define NPCCROWD_ABILITY_LOOKATIKTASK_TICK_OFFSET UNITYSDK_OFFSET(0x633C590)
#define NPCCROWD_ABILITY_LOOKATIKTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_LOOKATIKTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F59A0)
#define NPCCROWD_ABILITY_LOOKATIKTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x633D2C0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int LookAtIKTask_TypeDefinitionIndex = 68432;

	struct alignas(4) LookAtIKTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(LookAtIKTask_TypeDefinitionIndex)->GetStaticField(0x45420);
		}
