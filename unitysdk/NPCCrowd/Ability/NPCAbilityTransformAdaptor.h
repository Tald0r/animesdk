...
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_GET_ACCESSARRAY_OFFSET UNITYSDK_OFFSET(0x6F9B070)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x6F9B330)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_REBUILD_OFFSET UNITYSDK_OFFSET(0x6F9B0E0)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_REPLACE_OFFSET UNITYSDK_OFFSET(0x6F9B1B0)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_SAFEDISPOSE_OFFSET UNITYSDK_OFFSET(0x6F9B2A0)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6F9B040)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityTransformAdaptor_TypeDefinitionIndex = 77994;
