...
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_GET_ACCESSARRAY_OFFSET UNITYSDK_OFFSET(0x743CA40)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x743CD00)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_REBUILD_OFFSET UNITYSDK_OFFSET(0x743CAB0)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_REPLACE_OFFSET UNITYSDK_OFFSET(0x743CB80)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR_SAFEDISPOSE_OFFSET UNITYSDK_OFFSET(0x743CC70)
#define NPCCROWD_ABILITY_NPCABILITYTRANSFORMADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x743CA10)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityTransformAdaptor_TypeDefinitionIndex = 60156;
