...
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x33C230)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x9AFB550)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x3804B0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x9AFA500)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x9AFAAD0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x9AFA440)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F4290)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x37FF50)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x3804D0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F4310)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x37FF40)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_LINK_OFFSET UNITYSDK_OFFSET(0x9AFA180)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x33C230)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x380330)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x380410)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x3803A0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x3802C0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x3801E0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x380090)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x380020)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x380170)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x380100)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x37FFB0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x380250)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x37FED0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x9AFABB0)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_TICK_OFFSET UNITYSDK_OFFSET(0x9AFAC30)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_TRYNAVMESHTOPATHFOLLOW_OFFSET UNITYSDK_OFFSET(0x9AFA830)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x380530)
#define NPCCROWD_ABILITY_NAVMESHTOPATHFOLLOWTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x9AFB9C0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NavmeshToPathFollowTask_TypeDefinitionIndex = 55274;

	struct alignas(4) NavmeshToPathFollowTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(NavmeshToPathFollowTask_TypeDefinitionIndex)->GetStaticField(0x445E0);
		}
