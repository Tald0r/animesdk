...
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0x6BA2870)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F2490)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2F2440)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_CREATE_OFFSET UNITYSDK_OFFSET(0x6BA31C0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x315D90)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x6BA29E0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x3159F0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x315DB0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x3159E0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x6BA28E0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F2490)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2F2440)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_RESET_OFFSET UNITYSDK_OFFSET(0x2F24D0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x315C10)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x315AC0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x315B30)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x315CF0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x315C80)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x315BA0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_OPERAND_OFFSET UNITYSDK_OFFSET(0x315A50)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x315970)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x6BA2AA0)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x315E10)
#define NPCCROWD_ABILITY_PATHFOLLOWBLOCKEDCONDITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x6BA3630)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int PathFollowBlockedCondition_TypeDefinitionIndex = 38818;

	struct alignas(4) PathFollowBlockedCondition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(PathFollowBlockedCondition_TypeDefinitionIndex)->GetStaticField(0x2ED50);
		}
