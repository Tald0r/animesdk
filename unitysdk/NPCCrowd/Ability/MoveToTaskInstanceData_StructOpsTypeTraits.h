...
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x63FD410)
#define NPCCROWD_ABILITY_MOVETOTASKINSTANCEDATA_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x63FD420)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int MoveToTaskInstanceData_StructOpsTypeTraits_TypeDefinitionIndex = 70736;
