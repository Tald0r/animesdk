...
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F2490)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2F2440)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_CREATE_OFFSET UNITYSDK_OFFSET(0x62D14F0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x2F2420)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x62D0D20)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_OPERAND_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x2F2000)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x2F2550)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x2F1FF0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x62D0C20)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F2490)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2F2440)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_RESET_OFFSET UNITYSDK_OFFSET(0x2F24D0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2270)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_DELTAINDENT_OFFSET UNITYSDK_OFFSET(0x2F20F0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_EVALUATIONMODE_OFFSET UNITYSDK_OFFSET(0x2F2170)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2380)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22F0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21F0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_OPERAND_OFFSET UNITYSDK_OFFSET(0x2F2070)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F80)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x62D0DE0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F25B0)
#define NPCCROWD_ABILITY_CHECKISFOLLOWINGCONDITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x62D1960)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int CheckIsFollowingCondition_TypeDefinitionIndex = 65108;

	struct alignas(4) CheckIsFollowingCondition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(CheckIsFollowingCondition_TypeDefinitionIndex)->GetStaticField(0x3BD80);
		}
