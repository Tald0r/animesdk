...
#define NPCCROWD_ABILITY_NPCAGENTPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x77CA450)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAgentParameters_TypeDefinitionIndex = 54724;
