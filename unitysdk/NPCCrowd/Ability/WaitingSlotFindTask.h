...
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2FA720)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_CREATE_OFFSET UNITYSDK_OFFSET(0x8478160)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x350C20)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x84774D0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x8477300)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x2F4290)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x2F20E0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x3506C0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x350C40)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x2F4310)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x3506B0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_LINK_OFFSET UNITYSDK_OFFSET(0x8477070)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2FA720)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x350AA0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x350B80)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x350B10)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_NAME_OFFSET UNITYSDK_OFFSET(0x350A30)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_SHOULDAFFECTTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x350950)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_SHOULDCALLTICKONLYONEVENTS_OFFSET UNITYSDK_OFFSET(0x350800)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_SHOULDCALLTICK_OFFSET UNITYSDK_OFFSET(0x350790)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_SHOULDCOPYBOUNDPROPERTIESONEXITSTATE_OFFSET UNITYSDK_OFFSET(0x3508E0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_SHOULDCOPYBOUNDPROPERTIESONTICK_OFFSET UNITYSDK_OFFSET(0x350870)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_SHOULDSTATECHANGEONRESELECT_OFFSET UNITYSDK_OFFSET(0x350720)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_TASKENABLED_OFFSET UNITYSDK_OFFSET(0x3509C0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x350640)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_TICKLOGIC_OFFSET UNITYSDK_OFFSET(0x84775A0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK_UNREALTYPES_ISTRUCT_NPCCROWD_ABILITY_WAITINGSLOTFINDTASK__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x350CA0)
#define NPCCROWD_ABILITY_WAITINGSLOTFINDTASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x84785D0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int WaitingSlotFindTask_TypeDefinitionIndex = 49328;

	struct alignas(4) WaitingSlotFindTask
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(WaitingSlotFindTask_TypeDefinitionIndex)->GetStaticField(0x3DBC0);
		}
