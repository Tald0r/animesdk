...
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_OBSTACLE_GET_CANAVOID_OFFSET UNITYSDK_OFFSET(0x2C4590)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_OBSTACLE_GET_ISMOVING_OFFSET UNITYSDK_OFFSET(0x2C45B0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_OBSTACLE_SET_CANAVOID_OFFSET UNITYSDK_OFFSET(0x2C45A0)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_OBSTACLE_SET_ISMOVING_OFFSET UNITYSDK_OFFSET(0x2C45C0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityMoveAvoidanceProcessors_Obstacle_TypeDefinitionIndex = 78491;
