...
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_OBSTACLE_GET_CANAVOID_OFFSET UNITYSDK_OFFSET(0x2F5A60)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_OBSTACLE_GET_ISMOVING_OFFSET UNITYSDK_OFFSET(0x2F5A80)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_OBSTACLE_SET_CANAVOID_OFFSET UNITYSDK_OFFSET(0x2F5A70)
#define NPCCROWD_ABILITY_NPCABILITYMOVEAVOIDANCEPROCESSORS_OBSTACLE_SET_ISMOVING_OFFSET UNITYSDK_OFFSET(0x2F5A90)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityMoveAvoidanceProcessors_Obstacle_TypeDefinitionIndex = 60173;
