...
#define NPCCROWD_ABILITY_VIRTUALPROXY_PLAYERAVATARDISTANCECONDITION_COMPILE_OFFSET UNITYSDK_OFFSET(0x9AFC870)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PLAYERAVATARDISTANCECONDITION_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x9AFC9A0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PLAYERAVATARDISTANCECONDITION_LINK_OFFSET UNITYSDK_OFFSET(0x9AFC930)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PLAYERAVATARDISTANCECONDITION_TESTCONDITION_OFFSET UNITYSDK_OFFSET(0x9AFCA00)
#define NPCCROWD_ABILITY_VIRTUALPROXY_PLAYERAVATARDISTANCECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x9AFCA70)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_PlayerAvatarDistanceCondition_TypeDefinitionIndex = 73059;
