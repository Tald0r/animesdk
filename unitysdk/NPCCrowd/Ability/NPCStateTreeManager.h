...
#define NPCCROWD_ABILITY_NPCSTATETREEMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x62DF4C0)
#define NPCCROWD_ABILITY_NPCSTATETREEMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x62DF660)
#define NPCCROWD_ABILITY_NPCSTATETREEMANAGER_LOADORGETSTATETREE_OFFSET UNITYSDK_OFFSET(0x62DF950)
#define NPCCROWD_ABILITY_NPCSTATETREEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x62DF860)
#define NPCCROWD_ABILITY_NPCSTATETREEMANAGER_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x62DF7C0)
#define NPCCROWD_ABILITY_NPCSTATETREEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x62DFED0)
#define NPCCROWD_ABILITY_NPCSTATETREEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x62DFE50)
#define NPCCROWD_ABILITY_NPCSTATETREEMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x62DFF10)
#define NPCCROWD_ABILITY_NPCSTATETREEMANAGER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x62DFF70)
#define NPCCROWD_ABILITY_NPCSTATETREEMANAGER___BASE_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x62DFFD0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCStateTreeManager_TypeDefinitionIndex = 48333;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NPCStateTreeManager_TypeDefinitionIndex)->GetStaticField(0xE7F0);
		}
