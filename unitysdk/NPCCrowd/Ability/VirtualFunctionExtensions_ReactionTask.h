...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_REACTIONTASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x84766B0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_REACTIONTASK_LINK_OFFSET UNITYSDK_OFFSET(0x8476640)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_REACTIONTASK_TICK_OFFSET UNITYSDK_OFFSET(0x8476740)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_ReactionTask_TypeDefinitionIndex = 40817;
