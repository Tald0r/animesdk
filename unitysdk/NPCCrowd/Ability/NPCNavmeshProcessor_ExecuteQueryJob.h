...
#define NPCCROWD_ABILITY_NPCNAVMESHPROCESSOR_EXECUTEQUERYJOB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x2C97E0)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCNavmeshProcessor_ExecuteQueryJob_TypeDefinitionIndex = 40807;
