...
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_CARQUEUEMOVINGUPDATETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x7845DA0)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_CARQUEUEMOVINGUPDATETASK_LINK_OFFSET UNITYSDK_OFFSET(0x7845D30)
#define NPCCROWD_ABILITY_VIRTUALFUNCTIONEXTENSIONS_CARQUEUEMOVINGUPDATETASK_TICK_OFFSET UNITYSDK_OFFSET(0x7845E30)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualFunctionExtensions_CarQueueMovingUpdateTask_TypeDefinitionIndex = 46576;
