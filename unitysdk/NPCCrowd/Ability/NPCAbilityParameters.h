...
#define NPCCROWD_ABILITY_NPCABILITYPARAMETERS_REFRESH_OFFSET UNITYSDK_OFFSET(0x743C800)
#define NPCCROWD_ABILITY_NPCABILITYPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x743C870)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int NPCAbilityParameters_TypeDefinitionIndex = 60623;
