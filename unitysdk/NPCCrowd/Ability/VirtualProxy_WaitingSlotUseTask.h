...
#define NPCCROWD_ABILITY_VIRTUALPROXY_WAITINGSLOTUSETASK_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x6519690)
#define NPCCROWD_ABILITY_VIRTUALPROXY_WAITINGSLOTUSETASK_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x6519630)
#define NPCCROWD_ABILITY_VIRTUALPROXY_WAITINGSLOTUSETASK_LINK_OFFSET UNITYSDK_OFFSET(0x65195C0)
#define NPCCROWD_ABILITY_VIRTUALPROXY_WAITINGSLOTUSETASK_TICK_OFFSET UNITYSDK_OFFSET(0x6519700)
#define NPCCROWD_ABILITY_VIRTUALPROXY_WAITINGSLOTUSETASK__CTOR_OFFSET UNITYSDK_OFFSET(0x6519780)

namespace NPCCrowd::Ability
{
	inline static constexpr unsigned int VirtualProxy_WaitingSlotUseTask_TypeDefinitionIndex = 80914;
