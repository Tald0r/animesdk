...
#define NPCCROWD_NPCMATHF_ARRIVALSPEEDENVELOPE_OFFSET UNITYSDK_OFFSET(0x697D940)
#define NPCCROWD_NPCMATHF_CALCDIRECTIONALSPEEDSCALE_OFFSET UNITYSDK_OFFSET(0x697D9D0)
#define NPCCROWD_NPCMATHF_CLAMP_OFFSET UNITYSDK_OFFSET(0x697CE10)
#define NPCCROWD_NPCMATHF_DISTANCE_OFFSET UNITYSDK_OFFSET(0x697CCB0)
#define NPCCROWD_NPCMATHF_DISTSQUARED_OFFSET UNITYSDK_OFFSET(0x697CD50)
#define NPCCROWD_NPCMATHF_EXPONENTIALSMOOTHINGANGLE_OFFSET UNITYSDK_OFFSET(0x697C750)
#define NPCCROWD_NPCMATHF_FMOD_OFFSET UNITYSDK_OFFSET(0x697C970)
#define NPCCROWD_NPCMATHF_FRAC_OFFSET UNITYSDK_OFFSET(0x697C8F0)
#define NPCCROWD_NPCMATHF_FRANDINT_OFFSET UNITYSDK_OFFSET(0x697D770)
#define NPCCROWD_NPCMATHF_FRAND_OFFSET UNITYSDK_OFFSET(0x697D570)
#define NPCCROWD_NPCMATHF_FREEZEAXIS_OFFSET UNITYSDK_OFFSET(0x697D2D0)
#define NPCCROWD_NPCMATHF_GETBOOL3_OFFSET UNITYSDK_OFFSET(0x697DDF0)
#define NPCCROWD_NPCMATHF_GETYAWFROMDIRECTION_OFFSET UNITYSDK_OFFSET(0x697CC10)
#define NPCCROWD_NPCMATHF_INVEXPAPPROX_OFFSET UNITYSDK_OFFSET(0x697C6A0)
#define NPCCROWD_NPCMATHF_LERPANGLE_OFFSET UNITYSDK_OFFSET(0x697CB40)
#define NPCCROWD_NPCMATHF_MAKEBOOL3_OFFSET UNITYSDK_OFFSET(0x697DD70)
#define NPCCROWD_NPCMATHF_MULTI_OFFSET UNITYSDK_OFFSET(0x697C5D0)
#define NPCCROWD_NPCMATHF_RANDRANGE_1_OFFSET UNITYSDK_OFFSET(0x697D6D0)
#define NPCCROWD_NPCMATHF_RANDRANGE_2_OFFSET UNITYSDK_OFFSET(0x697D800)
#define NPCCROWD_NPCMATHF_RANDRANGE_3_OFFSET UNITYSDK_OFFSET(0x697D8B0)
#define NPCCROWD_NPCMATHF_RANDRANGE_OFFSET UNITYSDK_OFFSET(0x697D610)
#define NPCCROWD_NPCMATHF_SQUARE_OFFSET UNITYSDK_OFFSET(0x697D490)
#define NPCCROWD_NPCMATHF_UPZERO_OFFSET UNITYSDK_OFFSET(0x697D500)
#define NPCCROWD_NPCMATHF_VECTORDAMPERSPRINTCRITICAL_OFFSET UNITYSDK_OFFSET(0x697CF50)
#define NPCCROWD_NPCMATHF_WRAPANGLE_OFFSET UNITYSDK_OFFSET(0x697CA00)
#define NPCCROWD_NPCMATHF__CCTOR_OFFSET UNITYSDK_OFFSET(0x697DE80)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCMathf_TypeDefinitionIndex = 56774;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NPCMathf_TypeDefinitionIndex)->GetStaticField(0xAE80);
		}
