...
#define NPCCROWD_NPCMATHF_ARRIVALSPEEDENVELOPE_OFFSET UNITYSDK_OFFSET(0x6301D20)
#define NPCCROWD_NPCMATHF_CALCDIRECTIONALSPEEDSCALE_OFFSET UNITYSDK_OFFSET(0x6301DB0)
#define NPCCROWD_NPCMATHF_CLAMP_OFFSET UNITYSDK_OFFSET(0x63011F0)
#define NPCCROWD_NPCMATHF_DISTANCE_OFFSET UNITYSDK_OFFSET(0x6301090)
#define NPCCROWD_NPCMATHF_DISTSQUARED_OFFSET UNITYSDK_OFFSET(0x6301130)
#define NPCCROWD_NPCMATHF_EXPONENTIALSMOOTHINGANGLE_OFFSET UNITYSDK_OFFSET(0x6300B30)
#define NPCCROWD_NPCMATHF_FMOD_OFFSET UNITYSDK_OFFSET(0x6300D50)
#define NPCCROWD_NPCMATHF_FRAC_OFFSET UNITYSDK_OFFSET(0x6300CD0)
#define NPCCROWD_NPCMATHF_FRANDINT_OFFSET UNITYSDK_OFFSET(0x6301B50)
#define NPCCROWD_NPCMATHF_FRAND_OFFSET UNITYSDK_OFFSET(0x6301950)
#define NPCCROWD_NPCMATHF_FREEZEAXIS_OFFSET UNITYSDK_OFFSET(0x63016B0)
#define NPCCROWD_NPCMATHF_GETBOOL3_OFFSET UNITYSDK_OFFSET(0x63021D0)
#define NPCCROWD_NPCMATHF_GETYAWFROMDIRECTION_OFFSET UNITYSDK_OFFSET(0x6300FF0)
#define NPCCROWD_NPCMATHF_INVEXPAPPROX_OFFSET UNITYSDK_OFFSET(0x6300A80)
#define NPCCROWD_NPCMATHF_LERPANGLE_OFFSET UNITYSDK_OFFSET(0x6300F20)
#define NPCCROWD_NPCMATHF_MAKEBOOL3_OFFSET UNITYSDK_OFFSET(0x6302150)
#define NPCCROWD_NPCMATHF_MULTI_OFFSET UNITYSDK_OFFSET(0x63009B0)
#define NPCCROWD_NPCMATHF_RANDRANGE_1_OFFSET UNITYSDK_OFFSET(0x6301AB0)
#define NPCCROWD_NPCMATHF_RANDRANGE_2_OFFSET UNITYSDK_OFFSET(0x6301BE0)
#define NPCCROWD_NPCMATHF_RANDRANGE_3_OFFSET UNITYSDK_OFFSET(0x6301C90)
#define NPCCROWD_NPCMATHF_RANDRANGE_OFFSET UNITYSDK_OFFSET(0x63019F0)
#define NPCCROWD_NPCMATHF_SQUARE_OFFSET UNITYSDK_OFFSET(0x6301870)
#define NPCCROWD_NPCMATHF_UPZERO_OFFSET UNITYSDK_OFFSET(0x63018E0)
#define NPCCROWD_NPCMATHF_VECTORDAMPERSPRINTCRITICAL_OFFSET UNITYSDK_OFFSET(0x6301330)
#define NPCCROWD_NPCMATHF_WRAPANGLE_OFFSET UNITYSDK_OFFSET(0x6300DE0)
#define NPCCROWD_NPCMATHF__CCTOR_OFFSET UNITYSDK_OFFSET(0x6302260)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCMathf_TypeDefinitionIndex = 56980;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NPCMathf_TypeDefinitionIndex)->GetStaticField(0xB480);
		}
