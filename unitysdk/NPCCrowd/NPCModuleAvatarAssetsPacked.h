...
#define NPCCROWD_NPCMODULEAVATARASSETSPACKED__CTOR_OFFSET UNITYSDK_OFFSET(0x8494D70)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCModuleAvatarAssetsPacked_TypeDefinitionIndex = 80603;
