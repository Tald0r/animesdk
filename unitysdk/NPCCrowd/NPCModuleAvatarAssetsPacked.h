...
#define NPCCROWD_NPCMODULEAVATARASSETSPACKED__CTOR_OFFSET UNITYSDK_OFFSET(0x9BD39C0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCModuleAvatarAssetsPacked_TypeDefinitionIndex = 72768;
