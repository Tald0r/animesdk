...
#define NPCCROWD_NPCCITYPOPULATIONMANAGER_FINDNODECOMPARE_OFFSET UNITYSDK_OFFSET(0x7FBE930)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER_GETPOPULATIONNODERUNTIME_OFFSET UNITYSDK_OFFSET(0x7FBE880)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x7FBE510)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x7FBE680)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7FC0790)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER_SETWPGRAPHSTATE_OFFSET UNITYSDK_OFFSET(0x7FBE9B0)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x7FBE7E0)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER_SPAWNNPCFORNODE_OFFSET UNITYSDK_OFFSET(0x7FBF420)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER_UPDATESPAWNPOINT_OFFSET UNITYSDK_OFFSET(0x7FC01A0)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x7FC0120)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7FC0810)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x7FC0800)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER__SETWPGRAPHSTATE_G__CLEARPOPULATION_11_0_OFFSET UNITYSDK_OFFSET(0x7FBF020)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x7FC0820)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER___BASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7FC0880)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER___BASE_SHOULDTICK_OFFSET UNITYSDK_OFFSET(0x7FC08F0)
#define NPCCROWD_NPCCITYPOPULATIONMANAGER___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x7FC0950)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCCityPopulationManager_TypeDefinitionIndex = 67649;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NPCCityPopulationManager_TypeDefinitionIndex)->GetStaticField(0xAE90);
		}
