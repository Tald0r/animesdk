...
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_ADDTASKREADYFORACTIVATION_OFFSET UNITYSDK_OFFSET(0x6A01B70)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_ADDTASKTOPRIORITYQUEUE_OFFSET UNITYSDK_OFFSET(0x6A04480)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_CANPROCESSEVENTS_OFFSET UNITYSDK_OFFSET(0x6A03B00)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_ENDEVENTLOCK_OFFSET UNITYSDK_OFFSET(0x6A03260)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_EVENTLOCK_OFFSET UNITYSDK_OFFSET(0x6A03200)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_GETSHOULDTICK_OFFSET UNITYSDK_OFFSET(0x6A038A0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_HASACTIVETASKS_OFFSET UNITYSDK_OFFSET(0x6A041E0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_INIT_OFFSET UNITYSDK_OFFSET(0x6A032C0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x6A03A30)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_ONGAMEPLAYTASKACTIVATED_OFFSET UNITYSDK_OFFSET(0x6A02C00)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_ONGAMEPLAYTASKDEACTIVATED_OFFSET UNITYSDK_OFFSET(0x6A02440)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_PROCESSTASKEVENTS_OFFSET UNITYSDK_OFFSET(0x6A03B70)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_REMOVETASKFROMPRIORITYQUEUE_OFFSET UNITYSDK_OFFSET(0x6A042D0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_REQUESTTICKING_OFFSET UNITYSDK_OFFSET(0x6A03910)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x6A03A90)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_TICK_OFFSET UNITYSDK_OFFSET(0x6A03440)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_UPDATESHOULDTICK_OFFSET UNITYSDK_OFFSET(0x6A03770)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_UPDATETASKACTIVATIONS_OFFSET UNITYSDK_OFFSET(0x6A04530)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x6A048F0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x6A048E0)

namespace NPCCrowd::GameplayTask
{
	inline static constexpr unsigned int NPCGameplayTaskContainer_TypeDefinitionIndex = 78680;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::NPCCrowd::GameplayTask::NPCGameplayTaskBase*>**)Il2CppClass::FromTypeDefinitionIndex(NPCGameplayTaskContainer_TypeDefinitionIndex)->GetStaticField(0x42080);
		}
		static ::System::Int32* StaticGet_MaxIterations()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NPCGameplayTaskContainer_TypeDefinitionIndex)->GetStaticField(0xFDC0);
		}
		static ::System::Int32* StaticGet_INDEX_NONE()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NPCGameplayTaskContainer_TypeDefinitionIndex)->GetStaticField(0xFDC4);
		}
		::System::Collections::Generic::List_1<::NPCCrowd::GameplayTask::FGameplayTaskEventData>* TaskEvents; // 0x10
		::System::Collections::Generic::List_1<::NPCCrowd::GameplayTask::NPCGameplayTaskBase*>* KnownTasks; // 0x18
		::System::Collections::Generic::List_1<::NPCCrowd::GameplayTask::NPCGameplayTaskBase*>* TaskPriorityQueue; // 0x20
		::System::Collections::Generic::List_1<::NPCCrowd::GameplayTask::NPCGameplayTaskBase*>* TickingTasks; // 0x28
