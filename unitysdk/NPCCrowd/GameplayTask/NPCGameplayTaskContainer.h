...
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_ADDTASKREADYFORACTIVATION_OFFSET UNITYSDK_OFFSET(0x603C640)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_ADDTASKTOPRIORITYQUEUE_OFFSET UNITYSDK_OFFSET(0x603EF50)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_CANPROCESSEVENTS_OFFSET UNITYSDK_OFFSET(0x603E5D0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_ENDEVENTLOCK_OFFSET UNITYSDK_OFFSET(0x603DD30)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_EVENTLOCK_OFFSET UNITYSDK_OFFSET(0x603DCD0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_GETSHOULDTICK_OFFSET UNITYSDK_OFFSET(0x603E370)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_HASACTIVETASKS_OFFSET UNITYSDK_OFFSET(0x603ECB0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_INIT_OFFSET UNITYSDK_OFFSET(0x603DD90)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x603E500)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_ONGAMEPLAYTASKACTIVATED_OFFSET UNITYSDK_OFFSET(0x603D6D0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_ONGAMEPLAYTASKDEACTIVATED_OFFSET UNITYSDK_OFFSET(0x603CF10)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_PROCESSTASKEVENTS_OFFSET UNITYSDK_OFFSET(0x603E640)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_REMOVETASKFROMPRIORITYQUEUE_OFFSET UNITYSDK_OFFSET(0x603EDA0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_REQUESTTICKING_OFFSET UNITYSDK_OFFSET(0x603E3E0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x603E560)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_TICK_OFFSET UNITYSDK_OFFSET(0x603DF10)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_UPDATESHOULDTICK_OFFSET UNITYSDK_OFFSET(0x603E240)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER_UPDATETASKACTIVATIONS_OFFSET UNITYSDK_OFFSET(0x603F000)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x603F3C0)
#define NPCCROWD_GAMEPLAYTASK_NPCGAMEPLAYTASKCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x603F3B0)

namespace NPCCrowd::GameplayTask
{
	inline static constexpr unsigned int NPCGameplayTaskContainer_TypeDefinitionIndex = 40394;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::NPCCrowd::GameplayTask::NPCGameplayTaskBase*>**)Il2CppClass::FromTypeDefinitionIndex(NPCGameplayTaskContainer_TypeDefinitionIndex)->GetStaticField(0x3F2A0);
		}
		static ::System::Int32* StaticGet_MaxIterations()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NPCGameplayTaskContainer_TypeDefinitionIndex)->GetStaticField(0xFA80);
		}
		static ::System::Int32* StaticGet_INDEX_NONE()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NPCGameplayTaskContainer_TypeDefinitionIndex)->GetStaticField(0xFA84);
		}
		...
		::System::Boolean bInEventProcessingInProgress; // 0x36
