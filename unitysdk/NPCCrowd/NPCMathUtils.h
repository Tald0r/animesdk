...
#define NPCCROWD_NPCMATHUTILS_DISTSQUARED_OFFSET UNITYSDK_OFFSET(0xA111640)
#define NPCCROWD_NPCMATHUTILS_GETFORWARDVECTOR_OFFSET UNITYSDK_OFFSET(0xA111220)
#define NPCCROWD_NPCMATHUTILS_GETUPVECTOR_OFFSET UNITYSDK_OFFSET(0xA1113E0)
#define NPCCROWD_NPCMATHUTILS_LENGTH_OFFSET UNITYSDK_OFFSET(0xA1115A0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCMathUtils_TypeDefinitionIndex = 54849;
