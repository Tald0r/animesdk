...
#define NPCCROWD_NPCMATHUTILS_DISTSQUARED_OFFSET UNITYSDK_OFFSET(0x76D9D60)
#define NPCCROWD_NPCMATHUTILS_GETFORWARDVECTOR_OFFSET UNITYSDK_OFFSET(0x76D9940)
#define NPCCROWD_NPCMATHUTILS_GETUPVECTOR_OFFSET UNITYSDK_OFFSET(0x76D9B00)
#define NPCCROWD_NPCMATHUTILS_LENGTH_OFFSET UNITYSDK_OFFSET(0x76D9CC0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCMathUtils_TypeDefinitionIndex = 49195;
