...
#define NPCCROWD_NPCIDGENERATORINT_GENID_OFFSET UNITYSDK_OFFSET(0x639AC00)
#define NPCCROWD_NPCIDGENERATORINT_SETIDSTART_OFFSET UNITYSDK_OFFSET(0x63B1D70)
#define NPCCROWD_NPCIDGENERATORINT__CTOR_OFFSET UNITYSDK_OFFSET(0x63B1DE0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCIDGeneratorInt_TypeDefinitionIndex = 77118;
