...
#define NPCCROWD_NPCDEVICEPERFORMANCECONFIGSO__CTOR_OFFSET UNITYSDK_OFFSET(0xA111170)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCDevicePerformanceConfigSO_TypeDefinitionIndex = 38519;
