...
#define NPCCROWD_NPCPHYSICSMANAGER_PHYSICSJOBDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x781C2B0)
#define NPCCROWD_NPCPHYSICSMANAGER_PHYSICSJOBDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x781C300)
#define NPCCROWD_NPCPHYSICSMANAGER_PHYSICSJOBDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x781BFC0)
#define NPCCROWD_NPCPHYSICSMANAGER_PHYSICSJOBDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x781BFA0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCPhysicsManager_PhysicsJobDelegate_TypeDefinitionIndex = 48355;
