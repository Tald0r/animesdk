...
#define NPCCROWD_NPCPHYSICSMANAGER_PHYSICSJOBDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x6B690C0)
#define NPCCROWD_NPCPHYSICSMANAGER_PHYSICSJOBDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x6B69110)
#define NPCCROWD_NPCPHYSICSMANAGER_PHYSICSJOBDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x6B68DC0)
#define NPCCROWD_NPCPHYSICSMANAGER_PHYSICSJOBDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x6B68DB0)

namespace NPCCrowd
{
	inline static constexpr unsigned int NPCPhysicsManager_PhysicsJobDelegate_TypeDefinitionIndex = 55834;
