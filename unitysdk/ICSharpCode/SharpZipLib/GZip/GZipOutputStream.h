...
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B09CC60)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_FINISH_OFFSET UNITYSDK_OFFSET(0x1B09CD00)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_GETLEVEL_OFFSET UNITYSDK_OFFSET(0x1B09C980)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1B09C900)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x1B09CA70)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1B09C9A0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B09C880)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09C800)

namespace ICSharpCode::SharpZipLib::GZip
{
	inline static constexpr unsigned int GZipOutputStream_TypeDefinitionIndex = 6671;
