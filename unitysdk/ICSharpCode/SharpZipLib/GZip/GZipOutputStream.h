...
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B6AAAB0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_FINISH_OFFSET UNITYSDK_OFFSET(0x1B6AAB50)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_GETLEVEL_OFFSET UNITYSDK_OFFSET(0x1B6AA7D0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1B6AA750)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x1B6AA8C0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1B6AA7F0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6AA6D0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPOUTPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6AA650)
