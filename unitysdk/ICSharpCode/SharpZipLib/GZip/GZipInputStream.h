...
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM_READFOOTER_OFFSET UNITYSDK_OFFSET(0x1AD960F0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM_READHEADER_OFFSET UNITYSDK_OFFSET(0x1AD95970)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1AD958C0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD957E0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD95700)

namespace ICSharpCode::SharpZipLib::GZip
{
	inline static constexpr unsigned int GZipInputStream_TypeDefinitionIndex = 6669;
