...
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM_READFOOTER_OFFSET UNITYSDK_OFFSET(0x1B39E640)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM_READHEADER_OFFSET UNITYSDK_OFFSET(0x1B39DEC0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1B39DE10)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B39DD30)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B39DC50)
