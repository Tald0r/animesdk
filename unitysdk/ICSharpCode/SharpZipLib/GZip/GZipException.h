...
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE93F50)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AE93FF0)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AE94060)
#define ICSHARPCODE_SHARPZIPLIB_GZIP_GZIPEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE93F00)

namespace ICSharpCode::SharpZipLib::GZip
{
	inline static constexpr unsigned int GZipException_TypeDefinitionIndex = 6667;
