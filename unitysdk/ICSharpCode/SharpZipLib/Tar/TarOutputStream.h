...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_CLOSEENTRY_OFFSET UNITYSDK_OFFSET(0x1AEC0C30)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1AEC0D80)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_FINISH_OFFSET UNITYSDK_OFFSET(0x1AEC0BD0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1AEC0BA0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GETRECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1AEC0E60)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1AEC09C0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1AEC09F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1AEC0A20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_ISENTRYOPEN_OFFSET UNITYSDK_OFFSET(0x1AEC0C20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1AEC0980)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1AEC0A50)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AEC0A80)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_GET_RECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1AEC0E40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_PUTNEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1AEC0E80)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1AEC0B40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1AEC0B70)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1AEC0AE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1AEC0B10)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1AEC09A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AEC0AB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1AEC12B0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_WRITEEOFBLOCK_OFFSET UNITYSDK_OFFSET(0x1AEC0D40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1AEC1310)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEC08B0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAROUTPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEC08A0)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int TarOutputStream_TypeDefinitionIndex = 6686;

	class TarOutputStream : public ::System::IO::Stream
	{
	public:
		::Il2CppArray<::System::Byte>* assemblyBuffer; // 0x28
		::Il2CppArray<::System::Byte>* blockBuffer; // 0x30
		::System::IO::Stream* outputStream; // 0x38
		::ICSharpCode::SharpZipLib::Tar::TarBuffer* buffer; // 0x40
		::System::Int64 currSize; // 0x48
		::System::Int64 currBytes; // 0x50
		::System::Int32 assemblyBufferLength; // 0x58
		::System::Boolean isClosed; // 0x5C
