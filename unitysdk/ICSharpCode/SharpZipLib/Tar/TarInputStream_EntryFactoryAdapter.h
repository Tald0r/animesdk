...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_ENTRYFACTORYADAPTER_CREATEENTRYFROMFILE_OFFSET UNITYSDK_OFFSET(0x1B6AC460)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_ENTRYFACTORYADAPTER_CREATEENTRY_1_OFFSET UNITYSDK_OFFSET(0x1B6AC4F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_ENTRYFACTORYADAPTER_CREATEENTRY_OFFSET UNITYSDK_OFFSET(0x1B6AC3D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_ENTRYFACTORYADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6AC580)
