...
#define ICSHARPCODE_SHARPZIPLIB_TAR_PROGRESSMESSAGEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE99D00)
#define ICSHARPCODE_SHARPZIPLIB_TAR_PROGRESSMESSAGEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE99D40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_PROGRESSMESSAGEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE996E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_PROGRESSMESSAGEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE996D0)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int ProgressMessageHandler_TypeDefinitionIndex = 6678;
