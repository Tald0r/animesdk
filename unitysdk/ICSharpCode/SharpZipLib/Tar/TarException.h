...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAREXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0A76D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAREXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B0A7770)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAREXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B0A77E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TAREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A7680)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int TarException_TypeDefinitionIndex = 6676;
