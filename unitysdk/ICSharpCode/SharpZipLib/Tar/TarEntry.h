...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_ADJUSTENTRYNAME_OFFSET UNITYSDK_OFFSET(0x1B09E500)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_CLONE_OFFSET UNITYSDK_OFFSET(0x1B09D0D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_CREATEENTRYFROMFILE_OFFSET UNITYSDK_OFFSET(0x1B09D640)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_CREATETARENTRY_OFFSET UNITYSDK_OFFSET(0x1B09D360)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B09DCC0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GETDIRECTORYENTRIES_OFFSET UNITYSDK_OFFSET(0x1B09E280)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GETFILETARHEADER_OFFSET UNITYSDK_OFFSET(0x1B09D6D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B09DD80)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_FILE_OFFSET UNITYSDK_OFFSET(0x1B09E100)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1B09DF00)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_GROUPNAME_OFFSET UNITYSDK_OFFSET(0x1B09DFC0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_ISDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1B09E1B0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_MODTIME_OFFSET UNITYSDK_OFFSET(0x1B09E0C0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B09D2C0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B09E110)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_TARHEADER_OFFSET UNITYSDK_OFFSET(0x1B09DEB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_USERID_OFFSET UNITYSDK_OFFSET(0x1B09DEC0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1B09DF40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_ISDESCENDENT_OFFSET UNITYSDK_OFFSET(0x1B09DE10)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_NAMETARHEADER_OFFSET UNITYSDK_OFFSET(0x1B09D3F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SETIDS_OFFSET UNITYSDK_OFFSET(0x1B09E010)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SETNAMES_OFFSET UNITYSDK_OFFSET(0x1B09E030)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1B09DF20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_GROUPNAME_OFFSET UNITYSDK_OFFSET(0x1B09DFE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_MODTIME_OFFSET UNITYSDK_OFFSET(0x1B09E0E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B09D2E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B09E130)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_USERID_OFFSET UNITYSDK_OFFSET(0x1B09DEE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1B09DF60)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_WRITEENTRYHEADER_OFFSET UNITYSDK_OFFSET(0x1B09E4E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B09CF20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B09CF90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09CED0)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int TarEntry_TypeDefinitionIndex = 6681;
