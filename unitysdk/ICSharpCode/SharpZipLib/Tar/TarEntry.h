...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_ADJUSTENTRYNAME_OFFSET UNITYSDK_OFFSET(0x1B6AC360)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_CLONE_OFFSET UNITYSDK_OFFSET(0x1B6AAF20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_CREATEENTRYFROMFILE_OFFSET UNITYSDK_OFFSET(0x1B6AB4A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_CREATETARENTRY_OFFSET UNITYSDK_OFFSET(0x1B6AB1B0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B6ABB20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GETDIRECTORYENTRIES_OFFSET UNITYSDK_OFFSET(0x1B6AC0E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GETFILETARHEADER_OFFSET UNITYSDK_OFFSET(0x1B6AB530)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B6ABBE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_FILE_OFFSET UNITYSDK_OFFSET(0x1B6ABF60)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1B6ABD60)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_GROUPNAME_OFFSET UNITYSDK_OFFSET(0x1B6ABE20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_ISDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1B6AC010)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_MODTIME_OFFSET UNITYSDK_OFFSET(0x1B6ABF20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B6AB110)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B6ABF70)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_TARHEADER_OFFSET UNITYSDK_OFFSET(0x1B6ABD10)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_USERID_OFFSET UNITYSDK_OFFSET(0x1B6ABD20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1B6ABDA0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_ISDESCENDENT_OFFSET UNITYSDK_OFFSET(0x1B6ABC70)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_NAMETARHEADER_OFFSET UNITYSDK_OFFSET(0x1B6AB240)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SETIDS_OFFSET UNITYSDK_OFFSET(0x1B6ABE70)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SETNAMES_OFFSET UNITYSDK_OFFSET(0x1B6ABE90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1B6ABD80)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_GROUPNAME_OFFSET UNITYSDK_OFFSET(0x1B6ABE40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_MODTIME_OFFSET UNITYSDK_OFFSET(0x1B6ABF40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B6AB130)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B6ABF90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_USERID_OFFSET UNITYSDK_OFFSET(0x1B6ABD40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_SET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1B6ABDC0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY_WRITEENTRYHEADER_OFFSET UNITYSDK_OFFSET(0x1B6AC340)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6AAD70)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B6AADE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6AAD20)
