...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1AE94E20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_CREATEINPUTTARBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1AE94230)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_CREATEINPUTTARBUFFER_OFFSET UNITYSDK_OFFSET(0x1AE94140)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_CREATEOUTPUTTARBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1AE94470)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_CREATEOUTPUTTARBUFFER_OFFSET UNITYSDK_OFFSET(0x1AE94380)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GETBLOCKFACTOR_OFFSET UNITYSDK_OFFSET(0x1AE94110)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GETCURRENTBLOCKNUM_OFFSET UNITYSDK_OFFSET(0x1AE94990)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GETCURRENTRECORDNUM_OFFSET UNITYSDK_OFFSET(0x1AE949B0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GETRECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1AE940F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GET_BLOCKFACTOR_OFFSET UNITYSDK_OFFSET(0x1AE94100)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GET_CURRENTBLOCK_OFFSET UNITYSDK_OFFSET(0x1AE94960)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GET_CURRENTRECORD_OFFSET UNITYSDK_OFFSET(0x1AE949A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1AE94970)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_GET_RECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1AE940E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AE94330)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_ISENDOFARCHIVEBLOCK_OFFSET UNITYSDK_OFFSET(0x1AE94670)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_ISEOFBLOCK_OFFSET UNITYSDK_OFFSET(0x1AE94570)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_READBLOCK_OFFSET UNITYSDK_OFFSET(0x1AE948B0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_READRECORD_OFFSET UNITYSDK_OFFSET(0x1AE947F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1AE94980)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_SKIPBLOCK_OFFSET UNITYSDK_OFFSET(0x1AE94770)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_WRITEBLOCK_1_OFFSET UNITYSDK_OFFSET(0x1AE94BC0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_WRITEBLOCK_OFFSET UNITYSDK_OFFSET(0x1AE949C0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_WRITEFINALRECORD_OFFSET UNITYSDK_OFFSET(0x1AE94D70)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER_WRITERECORD_OFFSET UNITYSDK_OFFSET(0x1AE94B10)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE94120)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int TarBuffer_TypeDefinitionIndex = 6680;
	...
	public:
		...
		::System::Boolean isStreamOwner_; // 0x28
		::System::Int32 recordSize; // 0x2C
		::System::Int32 currentRecordIndex; // 0x30
		::System::Int32 currentBlockIndex; // 0x34
