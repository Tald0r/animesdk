...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1AE9D160)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_COPYENTRYCONTENTS_OFFSET UNITYSDK_OFFSET(0x1AE9D700)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1AE9D3C0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GETNEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1AE9AD10)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GETRECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1AE9D5B0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0x1AE9D5D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1AE9D2C0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1AE9D2F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1AE9D300)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_ISMARKSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1AE9D650)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1AE9D2A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1AE9D310)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AE9D340)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_RECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1AE9ABD0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_MARK_OFFSET UNITYSDK_OFFSET(0x1AE9D660)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1AE9D530)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1AE9BF20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_RESET_OFFSET UNITYSDK_OFFSET(0x1AE9D670)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1AE9D3F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SETENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1AE9D5A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1AE9D440)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1AE9AC30)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AE9D370)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SKIPTONEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1AE9D680)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SKIP_OFFSET UNITYSDK_OFFSET(0x1AE9D5E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1AE9D4E0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1AE9D490)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE9A190)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE9D260)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int TarInputStream_TypeDefinitionIndex = 6683;

	class TarInputStream : public ::System::IO::Stream
	{
	public:
		::ICSharpCode::SharpZipLib::Tar::TarInputStream_IEntryFactory* entryFactory; // 0x28
		::ICSharpCode::SharpZipLib::Tar::TarEntry* currentEntry; // 0x30
		::Il2CppArray<::System::Byte>* readBuffer; // 0x38
