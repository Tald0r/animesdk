...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B4B9D50)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_COPYENTRYCONTENTS_OFFSET UNITYSDK_OFFSET(0x1B4BA2F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B4B9FB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GETNEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1B4B7910)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GETRECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1B4BA1A0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0x1B4BA1C0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1B4B9EB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1B4B9EE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1B4B9EF0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_ISMARKSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1B4BA240)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1B4B9E90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B4B9F00)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B4B9F30)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_GET_RECORDSIZE_OFFSET UNITYSDK_OFFSET(0x1B4B77D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_MARK_OFFSET UNITYSDK_OFFSET(0x1B4BA250)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1B4BA120)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1B4B8B20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_RESET_OFFSET UNITYSDK_OFFSET(0x1B4BA260)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1B4B9FE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SETENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1B4BA190)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1B4BA030)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1B4B7830)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B4B9F60)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SKIPTONEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1B4BA270)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_SKIP_OFFSET UNITYSDK_OFFSET(0x1B4BA1D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1B4BA0D0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1B4BA080)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4B6D90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4B9E50)
...
namespace ICSharpCode::SharpZipLib::Tar
{
	...
	public:
		...
		::ICSharpCode::SharpZipLib::Tar::TarBuffer* tarBuffer; // 0x38
		::ICSharpCode::SharpZipLib::Tar::TarInputStream_IEntryFactory* entryFactory; // 0x40
