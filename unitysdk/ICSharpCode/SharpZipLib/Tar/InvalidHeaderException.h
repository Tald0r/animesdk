...
#define ICSHARPCODE_SHARPZIPLIB_TAR_INVALIDHEADEREXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFFCCB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_INVALIDHEADEREXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AFFCD50)
#define ICSHARPCODE_SHARPZIPLIB_TAR_INVALIDHEADEREXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AFFCDC0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_INVALIDHEADEREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFCC60)

namespace ICSharpCode::SharpZipLib::Tar
{
	inline static constexpr unsigned int InvalidHeaderException_TypeDefinitionIndex = 6677;
