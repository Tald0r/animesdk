...
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_CLONE_OFFSET UNITYSDK_OFFSET(0x1A847DF0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_COMPUTECHECKSUM_OFFSET UNITYSDK_OFFSET(0x1A84AB00)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A84ACD0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETASCIIBYTES_OFFSET UNITYSDK_OFFSET(0x1A84A980)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETCHECKSUMOCTALBYTES_OFFSET UNITYSDK_OFFSET(0x1A84ABC0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETCTIME_OFFSET UNITYSDK_OFFSET(0x1A84A8F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETDATETIMEFROMCTIME_OFFSET UNITYSDK_OFFSET(0x1A849B60)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A84AC40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETLONGOCTALBYTES_OFFSET UNITYSDK_OFFSET(0x1A84A880)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETNAMEBYTES_1_OFFSET UNITYSDK_OFFSET(0x1A84B030)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETNAMEBYTES_2_OFFSET UNITYSDK_OFFSET(0x1A84B220)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETNAMEBYTES_3_OFFSET UNITYSDK_OFFSET(0x1A84A660)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETNAMEBYTES_OFFSET UNITYSDK_OFFSET(0x1A84AF50)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETNAME_OFFSET UNITYSDK_OFFSET(0x1A847A00)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GETOCTALBYTES_OFFSET UNITYSDK_OFFSET(0x1A84A730)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_CHECKSUM_OFFSET UNITYSDK_OFFSET(0x1A847D20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_DEVMAJOR_OFFSET UNITYSDK_OFFSET(0x1A847DB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_DEVMINOR_OFFSET UNITYSDK_OFFSET(0x1A847DD0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1A847A50)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_GROUPNAME_OFFSET UNITYSDK_OFFSET(0x1A847DA0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_ISCHECKSUMVALID_OFFSET UNITYSDK_OFFSET(0x1A847D30)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_LINKNAME_OFFSET UNITYSDK_OFFSET(0x1A847D60)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_MAGIC_OFFSET UNITYSDK_OFFSET(0x1A847D70)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1A847A10)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_MODTIME_OFFSET UNITYSDK_OFFSET(0x1A847A80)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A8479F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1A847A70)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_TYPEFLAG_OFFSET UNITYSDK_OFFSET(0x1A847D40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_USERID_OFFSET UNITYSDK_OFFSET(0x1A847A30)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1A847D90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1A847D80)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_MAKECHECKSUM_OFFSET UNITYSDK_OFFSET(0x1A849CB0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_PARSEBUFFER_OFFSET UNITYSDK_OFFSET(0x1A847E90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_PARSENAME_OFFSET UNITYSDK_OFFSET(0x1A849890)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_PARSEOCTAL_OFFSET UNITYSDK_OFFSET(0x1A849A70)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_RESTORESETVALUES_OFFSET UNITYSDK_OFFSET(0x1A84AED0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SETVALUEDEFAULTS_OFFSET UNITYSDK_OFFSET(0x1A84AE30)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_DEVMAJOR_OFFSET UNITYSDK_OFFSET(0x1A847DC0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_DEVMINOR_OFFSET UNITYSDK_OFFSET(0x1A847DE0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1A847A60)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_GROUPNAME_OFFSET UNITYSDK_OFFSET(0x1A847960)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_LINKNAME_OFFSET UNITYSDK_OFFSET(0x1A847890)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_MAGIC_OFFSET UNITYSDK_OFFSET(0x1A847740)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1A847A20)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_MODTIME_OFFSET UNITYSDK_OFFSET(0x1A847A90)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A847820)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1A847980)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_TYPEFLAG_OFFSET UNITYSDK_OFFSET(0x1A847D50)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_USERID_OFFSET UNITYSDK_OFFSET(0x1A847A40)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1A847900)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1A8477B0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER_WRITEHEADER_OFFSET UNITYSDK_OFFSET(0x1A84A0F0)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A84B300)
#define ICSHARPCODE_SHARPZIPLIB_TAR_TARHEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A847490)
...
namespace ICSharpCode::SharpZipLib::Tar
{
	...
	public:
		...
		{
			return (::System::DateTime*)Il2CppClass::FromTypeDefinitionIndex(TarHeader_TypeDefinitionIndex)->GetStaticField(0x3130);
		}
		...
		::System::String* magic; // 0x38
		::System::Int64 size; // 0x40
		::System::DateTime modTime; // 0x48
		::System::Int32 devMinor; // 0x50
		::System::Int32 checksum; // 0x54
		::System::Boolean isChecksumValid; // 0x58
		::System::Byte typeFlag; // 0x59
		::System::Int32 mode; // 0x5C
		::System::Int32 userId; // 0x60
