...
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_COMPUTECRC32_OFFSET UNITYSDK_OFFSET(0x1B14B4C0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B14B560)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_RESET_OFFSET UNITYSDK_OFFSET(0x1B14B580)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B14B570)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1B14B640)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1B14B6C0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B14B590)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B14B8F0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14B8E0)

namespace ICSharpCode::SharpZipLib::Checksums
{
	inline static constexpr unsigned int Crc32_TypeDefinitionIndex = 6638;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Crc32_TypeDefinitionIndex)->GetStaticField(0x5AA0);
		}
