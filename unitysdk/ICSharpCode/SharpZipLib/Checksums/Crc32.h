...
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_COMPUTECRC32_OFFSET UNITYSDK_OFFSET(0x1B769CE0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B769D80)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_RESET_OFFSET UNITYSDK_OFFSET(0x1B769DA0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B769D90)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1B769E60)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1B769EE0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B769DB0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B76A110)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_CRC32__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76A100)
