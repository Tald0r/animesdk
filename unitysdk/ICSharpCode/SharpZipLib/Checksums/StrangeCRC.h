...
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A276350)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_RESET_OFFSET UNITYSDK_OFFSET(0x1A276340)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1A276410)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1A276490)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A276360)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2765F0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A26D940)

namespace ICSharpCode::SharpZipLib::Checksums
{
	inline static constexpr unsigned int StrangeCRC_TypeDefinitionIndex = 6639;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(StrangeCRC_TypeDefinitionIndex)->GetStaticField(0x5B30);
		}
