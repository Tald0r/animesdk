...
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A847160)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_RESET_OFFSET UNITYSDK_OFFSET(0x1A847150)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1A847220)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1A8472A0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A847170)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A847400)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_STRANGECRC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A83E790)
