...
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B7529D0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_RESET_OFFSET UNITYSDK_OFFSET(0x1B7529F0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1B752A50)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1B752AD0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B752A00)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7529E0)
