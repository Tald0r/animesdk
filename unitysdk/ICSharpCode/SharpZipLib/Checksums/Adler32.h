...
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B136390)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_RESET_OFFSET UNITYSDK_OFFSET(0x1B1363B0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1B136410)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1B136490)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B1363C0)
#define ICSHARPCODE_SHARPZIPLIB_CHECKSUMS_ADLER32__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1363A0)

namespace ICSharpCode::SharpZipLib::Checksums
{
	inline static constexpr unsigned int Adler32_TypeDefinitionIndex = 6637;
