...
#define ICSHARPCODE_SHARPZIPLIB_CORE_COMPLETEDFILEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A3F1E90)
#define ICSHARPCODE_SHARPZIPLIB_CORE_COMPLETEDFILEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A3F1ED0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_COMPLETEDFILEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A3F1910)
#define ICSHARPCODE_SHARPZIPLIB_CORE_COMPLETEDFILEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F1900)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int CompletedFileHandler_TypeDefinitionIndex = 6647;
