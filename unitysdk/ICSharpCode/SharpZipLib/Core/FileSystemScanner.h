...
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONCOMPLETEFILE_OFFSET UNITYSDK_OFFSET(0x1B4B51A0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONDIRECTORYFAILURE_OFFSET UNITYSDK_OFFSET(0x1B4B4FC0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONFILEFAILURE_OFFSET UNITYSDK_OFFSET(0x1B4B5060)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONPROCESSDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1B4B5230)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONPROCESSFILE_OFFSET UNITYSDK_OFFSET(0x1B4B5110)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_SCANDIR_OFFSET UNITYSDK_OFFSET(0x1B4B52E0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_SCAN_OFFSET UNITYSDK_OFFSET(0x1B4B52D0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4B4F20)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B4B4FA0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B4B4FB0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4B4ED0)
...
namespace ICSharpCode::SharpZipLib::Core
{
	...
	{
	public:
		::ICSharpCode::SharpZipLib::Core::DirectoryFailureHandler* DirectoryFailure; // 0x10
		::ICSharpCode::SharpZipLib::Core::IScanFilter* fileFilter_; // 0x18
		::ICSharpCode::SharpZipLib::Core::IScanFilter* directoryFilter_; // 0x20
		...
		::ICSharpCode::SharpZipLib::Core::ProcessFileHandler* ProcessFile; // 0x40
