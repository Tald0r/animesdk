...
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONCOMPLETEFILE_OFFSET UNITYSDK_OFFSET(0x1AE985C0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONDIRECTORYFAILURE_OFFSET UNITYSDK_OFFSET(0x1AE983E0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONFILEFAILURE_OFFSET UNITYSDK_OFFSET(0x1AE98480)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONPROCESSDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1AE98650)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_ONPROCESSFILE_OFFSET UNITYSDK_OFFSET(0x1AE98530)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_SCANDIR_OFFSET UNITYSDK_OFFSET(0x1AE98700)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER_SCAN_OFFSET UNITYSDK_OFFSET(0x1AE986F0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE98340)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AE983C0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AE983D0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILESYSTEMSCANNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE982F0)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int FileSystemScanner_TypeDefinitionIndex = 6650;

	class FileSystemScanner : public ::System::Object
	{
	public:
		::ICSharpCode::SharpZipLib::Core::IScanFilter* fileFilter_; // 0x10
		...
		::ICSharpCode::SharpZipLib::Core::IScanFilter* directoryFilter_; // 0x38
