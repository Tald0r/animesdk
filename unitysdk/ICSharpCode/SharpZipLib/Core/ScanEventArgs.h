...
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANEVENTARGS_GET_CONTINUERUNNING_OFFSET UNITYSDK_OFFSET(0x1B10F870)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANEVENTARGS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B10F860)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANEVENTARGS_SET_CONTINUERUNNING_OFFSET UNITYSDK_OFFSET(0x1B10F880)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B10F820)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int ScanEventArgs_TypeDefinitionIndex = 6640;
