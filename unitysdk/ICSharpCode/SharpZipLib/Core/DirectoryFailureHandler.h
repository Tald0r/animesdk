...
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0ECCF0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0ECD30)
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0EC770)
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EC760)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int DirectoryFailureHandler_TypeDefinitionIndex = 6648;
