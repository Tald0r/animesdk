...
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B7037E0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B703820)
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B703260)
#define ICSHARPCODE_SHARPZIPLIB_CORE_DIRECTORYFAILUREHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B703240)
