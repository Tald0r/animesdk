...
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B09C290)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B09C2D0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B09BD10)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROGRESSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09BD00)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int ProgressHandler_TypeDefinitionIndex = 6646;
