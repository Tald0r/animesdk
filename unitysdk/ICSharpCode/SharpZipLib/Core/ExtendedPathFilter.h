...
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_GET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x1B6B54B0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_GET_MAXSIZE_OFFSET UNITYSDK_OFFSET(0x1B6B5490)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_GET_MINDATE_OFFSET UNITYSDK_OFFSET(0x1B6B54A0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_GET_MINSIZE_OFFSET UNITYSDK_OFFSET(0x1B6B5480)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1B6B5260)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_SET_MAXDATE_OFFSET UNITYSDK_OFFSET(0x1B6B4FB0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_SET_MAXSIZE_OFFSET UNITYSDK_OFFSET(0x1B6B4D80)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_SET_MINDATE_OFFSET UNITYSDK_OFFSET(0x1B6B4F20)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER_SET_MINSIZE_OFFSET UNITYSDK_OFFSET(0x1B6B4D10)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6B4DF0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B6B5040)
#define ICSHARPCODE_SHARPZIPLIB_CORE_EXTENDEDPATHFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B4C10)
