...
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANFAILUREEVENTARGS_GET_CONTINUERUNNING_OFFSET UNITYSDK_OFFSET(0x1B0ECEE0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANFAILUREEVENTARGS_GET_EXCEPTION_OFFSET UNITYSDK_OFFSET(0x1B0ECED0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANFAILUREEVENTARGS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B0ECEC0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANFAILUREEVENTARGS_SET_CONTINUERUNNING_OFFSET UNITYSDK_OFFSET(0x1B0ECEF0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_SCANFAILUREEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0ECE80)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int ScanFailureEventArgs_TypeDefinitionIndex = 6643;
