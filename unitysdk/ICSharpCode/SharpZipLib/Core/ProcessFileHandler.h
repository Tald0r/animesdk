...
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSFILEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B10F7D0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSFILEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B10F810)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSFILEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B10F250)
#define ICSHARPCODE_SHARPZIPLIB_CORE_PROCESSFILEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B10F240)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int ProcessFileHandler_TypeDefinitionIndex = 6645;
