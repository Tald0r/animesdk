...
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILEFAILUREHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B104450)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILEFAILUREHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B104490)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILEFAILUREHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B103ED0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_FILEFAILUREHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B103EC0)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int FileFailureHandler_TypeDefinitionIndex = 6649;
