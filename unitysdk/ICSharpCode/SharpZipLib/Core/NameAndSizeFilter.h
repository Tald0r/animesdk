...
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_GET_MAXSIZE_OFFSET UNITYSDK_OFFSET(0x1B141800)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_GET_MINSIZE_OFFSET UNITYSDK_OFFSET(0x1B1417F0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1B141690)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_SET_MAXSIZE_OFFSET UNITYSDK_OFFSET(0x1B141620)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER_SET_MINSIZE_OFFSET UNITYSDK_OFFSET(0x1B1415B0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_NAMEANDSIZEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1414C0)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int NameAndSizeFilter_TypeDefinitionIndex = 6656;
