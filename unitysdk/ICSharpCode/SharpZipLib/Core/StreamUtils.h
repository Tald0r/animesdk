...
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_COPY_1_OFFSET UNITYSDK_OFFSET(0x1AE990F0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_COPY_2_OFFSET UNITYSDK_OFFSET(0x1AE99120)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_COPY_OFFSET UNITYSDK_OFFSET(0x1AE98F60)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_READFULLY_1_OFFSET UNITYSDK_OFFSET(0x1AE98DD0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_READFULLY_OFFSET UNITYSDK_OFFSET(0x1AE98DB0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE996C0)

namespace ICSharpCode::SharpZipLib::Core
{
	inline static constexpr unsigned int StreamUtils_TypeDefinitionIndex = 6657;
