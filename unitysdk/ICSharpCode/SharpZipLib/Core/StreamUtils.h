...
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_COPY_1_OFFSET UNITYSDK_OFFSET(0x1B4B5CD0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_COPY_2_OFFSET UNITYSDK_OFFSET(0x1B4B5D00)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_COPY_OFFSET UNITYSDK_OFFSET(0x1B4B5B40)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_READFULLY_1_OFFSET UNITYSDK_OFFSET(0x1B4B59B0)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS_READFULLY_OFFSET UNITYSDK_OFFSET(0x1B4B5990)
#define ICSHARPCODE_SHARPZIPLIB_CORE_STREAMUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4B62A0)
