...
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2CONSTANTS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B09BC20)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2CONSTANTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09BC10)

namespace ICSharpCode::SharpZipLib::BZip2
{
	inline static constexpr unsigned int BZip2Constants_TypeDefinitionIndex = 6630;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(BZip2Constants_TypeDefinitionIndex)->GetStaticField(0x5B20);
		}
