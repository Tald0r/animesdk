...
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_ALLOCATECOMPRESSSTRUCTURES_OFFSET UNITYSDK_OFFSET(0x1A83E7C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSFINISHEDWITHSTREAM_OFFSET UNITYSDK_OFFSET(0x1A840690)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSPUTINTVS_OFFSET UNITYSDK_OFFSET(0x1A840700)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSPUTINT_OFFSET UNITYSDK_OFFSET(0x1A840350)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSPUTUCHAR_OFFSET UNITYSDK_OFFSET(0x1A840180)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSSETSTREAM_OFFSET UNITYSDK_OFFSET(0x1A83E7A0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_BSW_OFFSET UNITYSDK_OFFSET(0x1A840550)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A83F720)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A83EC60)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_DOREVERSIBLETRANSFORMATION_OFFSET UNITYSDK_OFFSET(0x1A840220)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_ENDBLOCK_OFFSET UNITYSDK_OFFSET(0x1A83F870)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_ENDCOMPRESSION_OFFSET UNITYSDK_OFFSET(0x1A83FE00)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A83EBF0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A840150)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_FULLGTU_OFFSET UNITYSDK_OFFSET(0x1A845170)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GENERATEMTFVALUES_OFFSET UNITYSDK_OFFSET(0x1A844600)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_BYTESWRITTEN_OFFSET UNITYSDK_OFFSET(0x1A83FDF0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1A83ED80)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1A83ED90)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1A83EDA0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1A83ED60)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A83EDD0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A83EE00)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_HBASSIGNCODES_OFFSET UNITYSDK_OFFSET(0x1A844520)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_HBMAKECODELENGTHS_OFFSET UNITYSDK_OFFSET(0x1A8438D0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_INITBLOCK_OFFSET UNITYSDK_OFFSET(0x1A83EA70)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A83E850)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_MAINSORT_OFFSET UNITYSDK_OFFSET(0x1A8460B0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_MAKEMAPS_OFFSET UNITYSDK_OFFSET(0x1A83F7A0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_MED3_OFFSET UNITYSDK_OFFSET(0x1A846090)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_MOVETOFRONTCODEANDSEND_OFFSET UNITYSDK_OFFSET(0x1A8405F0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_PANIC_OFFSET UNITYSDK_OFFSET(0x1A843880)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_QSORT3_OFFSET UNITYSDK_OFFSET(0x1A845730)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_RANDOMISEBLOCK_OFFSET UNITYSDK_OFFSET(0x1A846F10)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1A83EF20)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1A83EF70)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1A83EE80)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SENDMTFVALUES_OFFSET UNITYSDK_OFFSET(0x1A8407A0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1A83EED0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1A83ED70)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A83EE30)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_SIMPLESORT_OFFSET UNITYSDK_OFFSET(0x1A844C80)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_VSWAP_OFFSET UNITYSDK_OFFSET(0x1A8455E0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1A83F1A0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_WRITERUN_OFFSET UNITYSDK_OFFSET(0x1A83F220)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1A83EFC0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A83E550)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2OUTPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A83E780)
...
namespace ICSharpCode::SharpZipLib::BZip2
{
	...
	public:
		...
		::Il2CppArray<::System::Char>* selector; // 0x48
		::Il2CppArray<::System::Int32>* increments; // 0x50
		::System::IO::Stream* baseStream; // 0x58
		::Il2CppArray<::System::Int32>* mtfFreq; // 0x60
		::Il2CppArray<::System::Int32>* quadrant; // 0x68
		::Il2CppArray<::System::Int32>* ftab; // 0x70
		::Il2CppArray<::System::Char>* selectorMtf; // 0x78
		::Il2CppArray<::System::Char>* unseqToSeq; // 0x80
		::Il2CppArray<::System::Char>* seqToUnseq; // 0x88
		::Il2CppArray<::System::Boolean>* inUse; // 0x90
		::System::Int32 runLength; // 0x98
		::System::Int32 origPtr; // 0x9C
		::System::Int32 allowableBlockSize; // 0xA0
		::System::Int32 currentChar; // 0xA4
		::System::Int32 blockSize100k; // 0xA8
		::System::Int32 workDone; // 0xAC
		::System::UInt32 blockCRC; // 0xB0
		::System::Boolean blockRandomised; // 0xB4
		::System::Boolean isStreamOwner; // 0xB5
		::System::Boolean disposed_; // 0xB6
		::System::Boolean firstAttempt; // 0xB7
		::System::Int32 nInUse; // 0xB8
		::System::Int32 workLimit; // 0xBC
		::System::Int32 workFactor; // 0xC0
		::System::Int32 last; // 0xC4
		::System::Int32 nMTF; // 0xC8
		::System::Int32 bsBuff; // 0xCC
		::System::Int32 bytesOut; // 0xD0
		::System::Int32 nBlocksRandomised; // 0xD4
		::System::UInt32 combinedCRC; // 0xD8
		::System::Int32 bsLive; // 0xDC
