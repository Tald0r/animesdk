...
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BADBLOCKHEADER_OFFSET UNITYSDK_OFFSET(0x1A9B2C90)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BLOCKOVERRUN_OFFSET UNITYSDK_OFFSET(0x1A9B5B20)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BSGETINT32_OFFSET UNITYSDK_OFFSET(0x1A9B2CE0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BSGETINTVS_OFFSET UNITYSDK_OFFSET(0x1A9B41D0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BSGETUCHAR_OFFSET UNITYSDK_OFFSET(0x1A9B2B10)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BSR_OFFSET UNITYSDK_OFFSET(0x1A9B2E00)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BSSETSTREAM_OFFSET UNITYSDK_OFFSET(0x1A9B1940)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A9B24E0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1A9B2C10)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_COMPRESSEDSTREAMEOF_OFFSET UNITYSDK_OFFSET(0x1A9B4180)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_CRCERROR_OFFSET UNITYSDK_OFFSET(0x1A9B4060)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_ENDBLOCK_OFFSET UNITYSDK_OFFSET(0x1A9B3F20)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_FILLBUFFER_OFFSET UNITYSDK_OFFSET(0x1A9B40B0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A9B21B0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GETANDMOVETOFRONTDECODE_OFFSET UNITYSDK_OFFSET(0x1A9B2E60)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1A9B2090)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1A9B20C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1A9B20F0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1A9B2070)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A9B2100)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A9B2130)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_HBCREATEDECODETABLES_OFFSET UNITYSDK_OFFSET(0x1A9B5320)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_INITBLOCK_OFFSET UNITYSDK_OFFSET(0x1A9B1A90)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A9B1960)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_MAKEMAPS_OFFSET UNITYSDK_OFFSET(0x1A9B2A40)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1A9B2470)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1A9B2310)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_RECVDECODINGTABLES_OFFSET UNITYSDK_OFFSET(0x1A9B4230)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1A9B21D0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETDECOMPRESSSTRUCTURESIZES_OFFSET UNITYSDK_OFFSET(0x1A9B2B60)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1A9B2220)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPBLOCK_OFFSET UNITYSDK_OFFSET(0x1A9B1E30)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPNORANDPARTA_OFFSET UNITYSDK_OFFSET(0x1A9B5DC0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPNORANDPARTB_OFFSET UNITYSDK_OFFSET(0x1A9B2820)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPNORANDPARTC_OFFSET UNITYSDK_OFFSET(0x1A9B2900)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPRANDPARTA_OFFSET UNITYSDK_OFFSET(0x1A9B5B70)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPRANDPARTB_OFFSET UNITYSDK_OFFSET(0x1A9B2510)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPRANDPARTC_OFFSET UNITYSDK_OFFSET(0x1A9B26E0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1A9B2080)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A9B2160)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1A9B22C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1A9B2270)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B1590)
...
namespace ICSharpCode::SharpZipLib::BZip2
{
	...
	public:
		...
		::Il2CppArray<::Il2CppArray<::System::Int32>*>* baseArray; // 0x28
		::Il2CppArray<::System::Byte>* selectorMtf; // 0x30
		::Il2CppArray<::System::Boolean>* inUse; // 0x38
		::Il2CppArray<::Il2CppArray<::System::Int32>*>* perm; // 0x40
		::Il2CppArray<::System::Byte>* selector; // 0x48
		::System::IO::Stream* baseStream; // 0x50
		::Il2CppArray<::System::Int32>* unzftab; // 0x58
		::Il2CppArray<::System::Byte>* seqToUnseq; // 0x60
		::Il2CppArray<::System::Int32>* tt; // 0x68
		::Il2CppArray<::System::Byte>* unseqToSeq; // 0x70
		::Il2CppArray<::System::Byte>* ll8; // 0x78
		::Il2CppArray<::Il2CppArray<::System::Int32>*>* limit; // 0x80
		::ICSharpCode::SharpZipLib::Checksums::IChecksum* mCrc; // 0x88
		::Il2CppArray<::System::Int32>* minLens; // 0x90
		::System::Int32 bsLive; // 0x98
		::System::Int32 ch2; // 0x9C
		::System::UInt32 computedCombinedCRC; // 0xA0
		::System::Int32 storedCombinedCRC; // 0xA4
		::System::Int32 rTPos; // 0xA8
		::System::Int32 origPtr; // 0xAC
		::System::Int32 currentChar; // 0xB0
		::System::Int32 j2; // 0xB4
		::System::Int32 chPrev; // 0xB8
		::System::Int32 nInUse; // 0xBC
		::System::Int32 blockSize100k; // 0xC0
		::System::Int32 storedBlockCRC; // 0xC4
		::System::Int32 i2; // 0xC8
		::System::Int32 tPos; // 0xCC
		::System::Int32 bsBuff; // 0xD0
		::System::Int32 computedBlockCRC; // 0xD4
		::System::Boolean blockRandomised; // 0xD8
		::System::Boolean isStreamOwner; // 0xD9
		::System::Boolean streamEnd; // 0xDA
		::System::Byte z; // 0xDB
		::System::Int32 count; // 0xDC
		::System::Int32 last; // 0xE0
		::System::Int32 rNToGo; // 0xE4
		::System::Int32 currentState; // 0xE8
