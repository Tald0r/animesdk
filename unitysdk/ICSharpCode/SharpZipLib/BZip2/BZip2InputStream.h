...
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BADBLOCKHEADER_OFFSET UNITYSDK_OFFSET(0x1A3EE630)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BLOCKOVERRUN_OFFSET UNITYSDK_OFFSET(0x1A3F14C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BSGETINT32_OFFSET UNITYSDK_OFFSET(0x1A3EE680)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BSGETINTVS_OFFSET UNITYSDK_OFFSET(0x1A3EFB70)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BSGETUCHAR_OFFSET UNITYSDK_OFFSET(0x1A3EE4B0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BSR_OFFSET UNITYSDK_OFFSET(0x1A3EE7A0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_BSSETSTREAM_OFFSET UNITYSDK_OFFSET(0x1A3ED2E0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A3EDE70)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1A3EE5B0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_COMPRESSEDSTREAMEOF_OFFSET UNITYSDK_OFFSET(0x1A3EFB20)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_CRCERROR_OFFSET UNITYSDK_OFFSET(0x1A3EFA00)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_ENDBLOCK_OFFSET UNITYSDK_OFFSET(0x1A3EF8C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_FILLBUFFER_OFFSET UNITYSDK_OFFSET(0x1A3EFA50)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A3EDB40)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GETANDMOVETOFRONTDECODE_OFFSET UNITYSDK_OFFSET(0x1A3EE800)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1A3EDA20)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1A3EDA50)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1A3EDA80)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1A3EDA00)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A3EDA90)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A3EDAC0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_HBCREATEDECODETABLES_OFFSET UNITYSDK_OFFSET(0x1A3F0CC0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_INITBLOCK_OFFSET UNITYSDK_OFFSET(0x1A3ED430)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3ED300)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_MAKEMAPS_OFFSET UNITYSDK_OFFSET(0x1A3EE3D0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1A3EDE00)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1A3EDCA0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_RECVDECODINGTABLES_OFFSET UNITYSDK_OFFSET(0x1A3EFBD0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1A3EDB60)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETDECOMPRESSSTRUCTURESIZES_OFFSET UNITYSDK_OFFSET(0x1A3EE500)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1A3EDBB0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPBLOCK_OFFSET UNITYSDK_OFFSET(0x1A3ED7C0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPNORANDPARTA_OFFSET UNITYSDK_OFFSET(0x1A3F1760)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPNORANDPARTB_OFFSET UNITYSDK_OFFSET(0x1A3EE1B0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPNORANDPARTC_OFFSET UNITYSDK_OFFSET(0x1A3EE290)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPRANDPARTA_OFFSET UNITYSDK_OFFSET(0x1A3F1510)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPRANDPARTB_OFFSET UNITYSDK_OFFSET(0x1A3EDEA0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SETUPRANDPARTC_OFFSET UNITYSDK_OFFSET(0x1A3EE070)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1A3EDA10)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A3EDAF0)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1A3EDC50)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1A3EDC00)
#define ICSHARPCODE_SHARPZIPLIB_BZIP2_BZIP2INPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3ECF40)

namespace ICSharpCode::SharpZipLib::BZip2
{
	inline static constexpr unsigned int BZip2InputStream_TypeDefinitionIndex = 6633;
	...
	public:
		...
		::Il2CppArray<::Il2CppArray<::System::Int32>*>* limit; // 0x28
		::ICSharpCode::SharpZipLib::Checksums::IChecksum* mCrc; // 0x30
		::Il2CppArray<::System::Byte>* ll8; // 0x38
		::Il2CppArray<::System::Int32>* tt; // 0x40
		::Il2CppArray<::System::Byte>* selectorMtf; // 0x48
		::Il2CppArray<::System::Int32>* minLens; // 0x50
		::Il2CppArray<::System::Byte>* unseqToSeq; // 0x58
		::Il2CppArray<::System::Byte>* seqToUnseq; // 0x60
		::Il2CppArray<::System::Int32>* unzftab; // 0x68
		::Il2CppArray<::System::Byte>* selector; // 0x70
		::Il2CppArray<::Il2CppArray<::System::Int32>*>* perm; // 0x78
		::Il2CppArray<::Il2CppArray<::System::Int32>*>* baseArray; // 0x80
		::System::IO::Stream* baseStream; // 0x88
		::Il2CppArray<::System::Boolean>* inUse; // 0x90
		::System::Int32 computedBlockCRC; // 0x98
		::System::Int32 currentChar; // 0x9C
		::System::Int32 bsLive; // 0xA0
		::System::Int32 blockSize100k; // 0xA4
		::System::Int32 rNToGo; // 0xA8
		::System::Byte z; // 0xAC
		::System::Boolean blockRandomised; // 0xAD
		::System::Boolean streamEnd; // 0xAE
		::System::Boolean isStreamOwner; // 0xAF
		::System::Int32 last; // 0xB0
		::System::Int32 count; // 0xB4
		::System::Int32 chPrev; // 0xB8
		::System::Int32 origPtr; // 0xBC
		::System::Int32 storedBlockCRC; // 0xC0
		::System::UInt32 computedCombinedCRC; // 0xC4
		::System::Int32 bsBuff; // 0xC8
		::System::Int32 i2; // 0xCC
		::System::Int32 j2; // 0xD0
		::System::Int32 rTPos; // 0xD4
		::System::Int32 tPos; // 0xD8
		::System::Int32 currentState; // 0xDC
		::System::Int32 ch2; // 0xE0
		::System::Int32 storedCombinedCRC; // 0xE4
		::System::Int32 nInUse; // 0xE8
