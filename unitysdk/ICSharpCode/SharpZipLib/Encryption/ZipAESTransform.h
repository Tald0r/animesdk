...
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A9B6CC0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GETAUTHCODE_OFFSET UNITYSDK_OFFSET(0x1A9B6BD0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_CANREUSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A9B6CB0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_CANTRANSFORMMULTIPLEBLOCKS_OFFSET UNITYSDK_OFFSET(0x1A9B6CA0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_INPUTBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1A9B6C80)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_OUTPUTBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1A9B6C90)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_PWDVERIFIER_OFFSET UNITYSDK_OFFSET(0x1A9B6BC0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_TRANSFORMBLOCK_OFFSET UNITYSDK_OFFSET(0x1A9B68F0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_TRANSFORMFINALBLOCK_OFFSET UNITYSDK_OFFSET(0x1A9B6C30)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B6550)
...
namespace ICSharpCode::SharpZipLib::Encryption
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* _pwdVerifier; // 0x10
		::System::Security::Cryptography::ICryptoTransform* _encryptor; // 0x18
