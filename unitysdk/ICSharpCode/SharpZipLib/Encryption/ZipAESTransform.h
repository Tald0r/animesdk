...
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A3F2650)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GETAUTHCODE_OFFSET UNITYSDK_OFFSET(0x1A3F2560)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_CANREUSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A3F2640)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_CANTRANSFORMMULTIPLEBLOCKS_OFFSET UNITYSDK_OFFSET(0x1A3F2630)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_INPUTBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1A3F2610)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_OUTPUTBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1A3F2620)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_GET_PWDVERIFIER_OFFSET UNITYSDK_OFFSET(0x1A3F2550)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_TRANSFORMBLOCK_OFFSET UNITYSDK_OFFSET(0x1A3F2280)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM_TRANSFORMFINALBLOCK_OFFSET UNITYSDK_OFFSET(0x1A3F25C0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F1EE0)

namespace ICSharpCode::SharpZipLib::Encryption
{
	inline static constexpr unsigned int ZipAESTransform_TypeDefinitionIndex = 6665;
	...
	public:
		...
		::Il2CppArray<::System::Byte>* _counterNonce; // 0x28
		::Il2CppArray<::System::Byte>* _pwdVerifier; // 0x30
		::System::Int32 _encrPos; // 0x38
		::System::Int32 _blockSize; // 0x3C
		::System::Boolean _writeMode; // 0x40
		::System::Boolean _finalised; // 0x41
