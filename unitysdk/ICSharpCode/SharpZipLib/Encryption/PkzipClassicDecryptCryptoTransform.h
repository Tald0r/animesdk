...
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B75E7B0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_GET_CANREUSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B75E770)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_GET_CANTRANSFORMMULTIPLEBLOCKS_OFFSET UNITYSDK_OFFSET(0x1B75E7A0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_GET_INPUTBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1B75E780)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_GET_OUTPUTBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1B75E790)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_TRANSFORMBLOCK_OFFSET UNITYSDK_OFFSET(0x1B75E660)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM_TRANSFORMFINALBLOCK_OFFSET UNITYSDK_OFFSET(0x1B75E600)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICDECRYPTCRYPTOTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75E5F0)
