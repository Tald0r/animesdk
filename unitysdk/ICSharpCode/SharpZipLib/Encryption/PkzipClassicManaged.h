...
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_CREATEDECRYPTOR_OFFSET UNITYSDK_OFFSET(0x1AFFCBF0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_CREATEENCRYPTOR_OFFSET UNITYSDK_OFFSET(0x1AFFCB90)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_GENERATEIV_OFFSET UNITYSDK_OFFSET(0x1AFFC7B0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_GENERATEKEY_OFFSET UNITYSDK_OFFSET(0x1AFFC990)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_GET_BLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1AFFC6D0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1AFFC830)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_GET_LEGALBLOCKSIZES_OFFSET UNITYSDK_OFFSET(0x1AFFC7C0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_GET_LEGALKEYSIZES_OFFSET UNITYSDK_OFFSET(0x1AFFC740)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_SET_BLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1AFFC6E0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1AFFCA30)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_PKZIPCLASSICMANAGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFCC50)

namespace ICSharpCode::SharpZipLib::Encryption
{
	inline static constexpr unsigned int PkzipClassicManaged_TypeDefinitionIndex = 6663;
