...
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1B09C380)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1B09C7B0)
#define ICSHARPCODE_SHARPZIPLIB_ENCRYPTION_ZIPAESSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09C2E0)

namespace ICSharpCode::SharpZipLib::Encryption
{
	inline static constexpr unsigned int ZipAESStream_TypeDefinitionIndex = 6664;
	...
	public:
		...
		::Il2CppArray<::System::Byte>* _slideBuffer; // 0x60
		...
		::System::Int32 _slideBufFreePos; // 0x7C
		::System::Int32 _slideBufStartPos; // 0x80
