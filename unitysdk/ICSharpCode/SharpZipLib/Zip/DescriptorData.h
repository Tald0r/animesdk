...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_GET_COMPRESSEDSIZE_OFFSET UNITYSDK_OFFSET(0x1B4B3B70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_GET_CRC_OFFSET UNITYSDK_OFFSET(0x1B4B3BB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B4B3B90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_SET_COMPRESSEDSIZE_OFFSET UNITYSDK_OFFSET(0x1B4B3B80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_SET_CRC_OFFSET UNITYSDK_OFFSET(0x1B4B3BC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B4B3BA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DESCRIPTORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4B3BD0)
...
namespace ICSharpCode::SharpZipLib::Zip
{
	...
	{
	public:
		::System::Int64 compressedSize; // 0x10
		::System::Int64 crc; // 0x18
		::System::Int64 size; // 0x20
