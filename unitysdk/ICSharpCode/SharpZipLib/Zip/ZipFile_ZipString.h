...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_GET_ISSOURCESTRING_OFFSET UNITYSDK_OFFSET(0x1B71D4F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_GET_RAWCOMMENT_OFFSET UNITYSDK_OFFSET(0x1B71D5F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_GET_RAWLENGTH_OFFSET UNITYSDK_OFFSET(0x1B71D500)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_MAKEBYTESAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1B71D580)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_MAKETEXTAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1B71D740)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B71D800)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_RESET_OFFSET UNITYSDK_OFFSET(0x1B71D730)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B71D4E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71D4D0)
