...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_GET_ISSOURCESTRING_OFFSET UNITYSDK_OFFSET(0x1B105A00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_GET_RAWCOMMENT_OFFSET UNITYSDK_OFFSET(0x1B105B00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_GET_RAWLENGTH_OFFSET UNITYSDK_OFFSET(0x1B105A10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_MAKEBYTESAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1B105A90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_MAKETEXTAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1B105C50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B105D10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING_RESET_OFFSET UNITYSDK_OFFSET(0x1B105C40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1059F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1059E0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_ZipString_TypeDefinitionIndex = 6737;
