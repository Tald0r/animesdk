...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_WINDOWSNAMETRANSFORM_GET_BASEDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1B727280)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_WINDOWSNAMETRANSFORM_GET_REPLACEMENT_OFFSET UNITYSDK_OFFSET(0x1B727890)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_WINDOWSNAMETRANSFORM_GET_TRIMINCOMINGPATHS_OFFSET UNITYSDK_OFFSET(0x1B727290)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_WINDOWSNAMETRANSFORM_ISVALIDNAME_OFFSET UNITYSDK_OFFSET(0x1B727710)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_WINDOWSNAMETRANSFORM_MAKEVALIDNAME_OFFSET UNITYSDK_OFFSET(0x1B727480)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_WINDOWSNAMETRANSFORM_SET_BASEDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1B7271F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_WINDOWSNAMETRANSFORM_SET_REPLACEMENT_OFFSET UNITYSDK_OFFSET(0x1B7278A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_WINDOWSNAMETRANSFORM_SET_TRIMINCOMINGPATHS_OFFSET UNITYSDK_OFFSET(0x1B7272A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_WINDOWSNAMETRANSFORM_TRANSFORMDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1B7272B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_WINDOWSNAMETRANSFORM_TRANSFORMFILE_OFFSET UNITYSDK_OFFSET(0x1B7273F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_WINDOWSNAMETRANSFORM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B727790)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_WINDOWSNAMETRANSFORM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B727270)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_WINDOWSNAMETRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B727150)
