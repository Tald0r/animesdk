...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GETDATA_OFFSET UNITYSDK_OFFSET(0x1B3A1EE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GET_CREATETIME_OFFSET UNITYSDK_OFFSET(0x1B3A2370)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GET_LASTACCESSTIME_OFFSET UNITYSDK_OFFSET(0x1B3A2420)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GET_LASTMODIFICATIONTIME_OFFSET UNITYSDK_OFFSET(0x1B3A22C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_GET_TAGID_OFFSET UNITYSDK_OFFSET(0x1B3A1B60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_ISVALIDVALUE_OFFSET UNITYSDK_OFFSET(0x1B3A2260)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_SETDATA_OFFSET UNITYSDK_OFFSET(0x1B3A1B70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_SET_CREATETIME_OFFSET UNITYSDK_OFFSET(0x1B3A2380)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_SET_LASTACCESSTIME_OFFSET UNITYSDK_OFFSET(0x1B3A2430)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA_SET_LASTMODIFICATIONTIME_OFFSET UNITYSDK_OFFSET(0x1B3A22D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_NTTAGGEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A24D0)
