...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0A9C40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B0A78E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B0A9CE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A9BF0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipException_TypeDefinitionIndex = 6717;
