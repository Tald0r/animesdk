...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPTESTRESULTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AEC4D40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPTESTRESULTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AEC4D80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPTESTRESULTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AEC47C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPTESTRESULTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEC47B0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipTestResultHandler_TypeDefinitionIndex = 6729;
