...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPENTRYENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B09E740)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPENTRYENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B09E790)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPENTRYENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B09E780)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPENTRYENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09E730)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_ZipEntryEnumerator_TypeDefinitionIndex = 6738;
