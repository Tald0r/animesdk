...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_ADDERROR_OFFSET UNITYSDK_OFFSET(0x1B71C640)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_GET_BYTESTESTED_OFFSET UNITYSDK_OFFSET(0x1B71C620)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_GET_ENTRYVALID_OFFSET UNITYSDK_OFFSET(0x1B71C630)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x1B71C600)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_GET_ERRORCOUNT_OFFSET UNITYSDK_OFFSET(0x1B71C610)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_GET_FILE_OFFSET UNITYSDK_OFFSET(0x1B71C5F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_GET_OPERATION_OFFSET UNITYSDK_OFFSET(0x1B71C5E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_SETBYTESTESTED_OFFSET UNITYSDK_OFFSET(0x1B71C680)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_SETENTRY_OFFSET UNITYSDK_OFFSET(0x1B71C660)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS_SETOPERATION_OFFSET UNITYSDK_OFFSET(0x1B71C650)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_TESTSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71C5D0)
...
namespace ICSharpCode::SharpZipLib::Zip
{
	...
	public:
		...
		::ICSharpCode::SharpZipLib::Zip::TestOperation operation_; // 0x28
