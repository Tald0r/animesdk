...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_CLEANNAME_OFFSET UNITYSDK_OFFSET(0x1B0A9B40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_CLONE_OFFSET UNITYSDK_OFFSET(0x1B0A99E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_FORCEZIP64_OFFSET UNITYSDK_OFFSET(0x1B0A8CE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_AESENCRYPTIONSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1B0A9150)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_AESKEYSIZE_OFFSET UNITYSDK_OFFSET(0x1B0A8B00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_AESOVERHEADSIZE_OFFSET UNITYSDK_OFFSET(0x1B0A9180)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_AESSALTLEN_OFFSET UNITYSDK_OFFSET(0x1B0A9160)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_CANDECOMPRESS_OFFSET UNITYSDK_OFFSET(0x1B0A8C60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_CENTRALHEADERREQUIRESZIP64_OFFSET UNITYSDK_OFFSET(0x1B0A8BA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_COMMENT_OFFSET UNITYSDK_OFFSET(0x1B0A98E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_COMPRESSEDSIZE_OFFSET UNITYSDK_OFFSET(0x1B0A8E90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_COMPRESSIONMETHODFORHEADER_OFFSET UNITYSDK_OFFSET(0x1B0A8FB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_COMPRESSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1B0A8F20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_CRC_OFFSET UNITYSDK_OFFSET(0x1B0A8EC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_CRYPTOCHECKVALUE_OFFSET UNITYSDK_OFFSET(0x1B0A88A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_DATETIME_OFFSET UNITYSDK_OFFSET(0x1B0A8D80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_DOSTIME_OFFSET UNITYSDK_OFFSET(0x1B0A8D60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_EXTERNALFILEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B0A8920)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_EXTRADATA_OFFSET UNITYSDK_OFFSET(0x1B0A8FE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1B0A88C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_HASCRC_OFFSET UNITYSDK_OFFSET(0x1B0A8840)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_HOSTSYSTEM_OFFSET UNITYSDK_OFFSET(0x1B0A8970)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_ISCRYPTED_OFFSET UNITYSDK_OFFSET(0x1B0A8850)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_ISDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1B0A8C00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_ISDOSENTRY_OFFSET UNITYSDK_OFFSET(0x1B0A8950)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_ISFILE_OFFSET UNITYSDK_OFFSET(0x1B0A9970)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_ISUNICODETEXT_OFFSET UNITYSDK_OFFSET(0x1B0A8870)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_LOCALHEADERREQUIRESZIP64_OFFSET UNITYSDK_OFFSET(0x1B0A8D00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B0A8E50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1B0A8900)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B0A8E60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_VERSIONMADEBY_OFFSET UNITYSDK_OFFSET(0x1B0A8940)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B0A89C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_GET_ZIPFILEINDEX_OFFSET UNITYSDK_OFFSET(0x1B0A88E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_HASDOSATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B0A8980)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_ISCOMPRESSIONMETHODSUPPORTED_1_OFFSET UNITYSDK_OFFSET(0x1B0A8FA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_ISCOMPRESSIONMETHODSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1B0A8CD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_ISZIP64FORCED_OFFSET UNITYSDK_OFFSET(0x1B0A8CF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_PROCESSAESEXTRADATA_OFFSET UNITYSDK_OFFSET(0x1B0A9770)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_PROCESSEXTRADATA_OFFSET UNITYSDK_OFFSET(0x1B0A91A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_AESKEYSIZE_OFFSET UNITYSDK_OFFSET(0x1B0A90A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_COMMENT_OFFSET UNITYSDK_OFFSET(0x1B0A98F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_COMPRESSEDSIZE_OFFSET UNITYSDK_OFFSET(0x1B0A8EB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_COMPRESSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1B0A8F30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_CRC_OFFSET UNITYSDK_OFFSET(0x1B0A8EE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_CRYPTOCHECKVALUE_OFFSET UNITYSDK_OFFSET(0x1B0A88B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_DATETIME_OFFSET UNITYSDK_OFFSET(0x1B0A84E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_DOSTIME_OFFSET UNITYSDK_OFFSET(0x1B0A8D70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_EXTERNALFILEATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B0A8930)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_EXTRADATA_OFFSET UNITYSDK_OFFSET(0x1B0A8FF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1B0A88D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_HOSTSYSTEM_OFFSET UNITYSDK_OFFSET(0x1B0A89B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_ISCRYPTED_OFFSET UNITYSDK_OFFSET(0x1B0A8860)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_ISUNICODETEXT_OFFSET UNITYSDK_OFFSET(0x1B0A8880)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1B0A8910)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1B0A8E80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_SET_ZIPFILEINDEX_OFFSET UNITYSDK_OFFSET(0x1B0A88F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B0A9B30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0A84C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B0A8300)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B0A8720)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A82E0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipEntry_TypeDefinitionIndex = 6713;
	...
	public:
		...
		::System::Int32 externalFileAttributes; // 0x28
		::System::Int32 _aesEncryptionStrength; // 0x2C
		::System::UInt32 dosTime; // 0x30
		::System::Int32 _aesVer; // 0x34
		::System::UInt32 crc; // 0x38
		::System::UInt16 versionToExtract; // 0x3C
		::System::Boolean forceZip64_; // 0x3E
		::System::UInt64 compressedSize; // 0x40
		::System::UInt16 versionMadeBy; // 0x48
		::ICSharpCode::SharpZipLib::Zip::ZipEntry_Known known; // 0x4A
		::System::Byte cryptoCheckValue_; // 0x4B
		::System::Int64 offset; // 0x50
		::ICSharpCode::SharpZipLib::Zip::CompressionMethod method; // 0x58
		::System::Int32 flags; // 0x5C
