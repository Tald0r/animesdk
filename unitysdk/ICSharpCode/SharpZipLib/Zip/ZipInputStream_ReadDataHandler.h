...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATAHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE9E0C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATAHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE9E140)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATAHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE9DAE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATAHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE9DAD0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipInputStream_ReadDataHandler_TypeDefinitionIndex = 6753;
