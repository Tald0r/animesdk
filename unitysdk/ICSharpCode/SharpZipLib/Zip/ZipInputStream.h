...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_BODYREAD_OFFSET UNITYSDK_OFFSET(0x1AD9BF50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_CLOSEENTRY_OFFSET UNITYSDK_OFFSET(0x1AD9B010)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1AD9B1E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_COMPLETECLOSEENTRY_OFFSET UNITYSDK_OFFSET(0x1AD9B620)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_GETNEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1AD9A750)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0x1AD9B8E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_GET_CANDECOMPRESSENTRY_OFFSET UNITYSDK_OFFSET(0x1AD9A730)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1AD9B8F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_GET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1AD9A710)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_INITIALREAD_OFFSET UNITYSDK_OFFSET(0x1AD9BAB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1AD9B9A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READDATADESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AD9B270)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READINGNOTAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1AD9BA10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READINGNOTSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1AD9BA60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1AD9B7A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1AD9A720)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD9A5F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD9A4D0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipInputStream_TypeDefinitionIndex = 6752;
	...
	public:
		...
		::System::String* password; // 0x60
		::ICSharpCode::SharpZipLib::Zip::ZipInputStream_ReadDataHandler* internalReader; // 0x68
		::System::Int64 size; // 0x70
		::System::Int32 method; // 0x78
