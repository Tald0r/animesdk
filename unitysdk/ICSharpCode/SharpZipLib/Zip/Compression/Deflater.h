...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_DEFLATE_1_OFFSET UNITYSDK_OFFSET(0x1AEC1A00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_DEFLATE_OFFSET UNITYSDK_OFFSET(0x1AEC19E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_FINISH_OFFSET UNITYSDK_OFFSET(0x1AEC18B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1AEC18A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GETLEVEL_OFFSET UNITYSDK_OFFSET(0x1AEC19D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_ADLER_OFFSET UNITYSDK_OFFSET(0x1AEC1840)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1AEC18C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_ISNEEDINGINPUT_OFFSET UNITYSDK_OFFSET(0x1AEC18F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_TOTALIN_OFFSET UNITYSDK_OFFSET(0x1AEC1870)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_TOTALOUT_OFFSET UNITYSDK_OFFSET(0x1AEC1890)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_RESET_OFFSET UNITYSDK_OFFSET(0x1AEC17F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETDICTIONARY_1_OFFSET UNITYSDK_OFFSET(0x1AEC1DC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1AEC1D20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETINPUT_1_OFFSET UNITYSDK_OFFSET(0x1AEC1940)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETINPUT_OFFSET UNITYSDK_OFFSET(0x1AEC1920)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1AEC1750)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETSTRATEGY_OFFSET UNITYSDK_OFFSET(0x1AEC1730)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEC1720)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AEC15F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEC15E0)

namespace ICSharpCode::SharpZipLib::Zip::Compression
{
	inline static constexpr unsigned int Deflater_TypeDefinitionIndex = 6690;
