...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_DEFLATE_1_OFFSET UNITYSDK_OFFSET(0x1B4E08A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_DEFLATE_OFFSET UNITYSDK_OFFSET(0x1B4E0880)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_FINISH_OFFSET UNITYSDK_OFFSET(0x1B4E0750)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B4E0740)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GETLEVEL_OFFSET UNITYSDK_OFFSET(0x1B4E0870)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_ADLER_OFFSET UNITYSDK_OFFSET(0x1B4E06E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1B4E0760)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_ISNEEDINGINPUT_OFFSET UNITYSDK_OFFSET(0x1B4E0790)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_TOTALIN_OFFSET UNITYSDK_OFFSET(0x1B4E0710)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_GET_TOTALOUT_OFFSET UNITYSDK_OFFSET(0x1B4E0730)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_RESET_OFFSET UNITYSDK_OFFSET(0x1B4E0690)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETDICTIONARY_1_OFFSET UNITYSDK_OFFSET(0x1B4E0C60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1B4E0BC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETINPUT_1_OFFSET UNITYSDK_OFFSET(0x1B4E07E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETINPUT_OFFSET UNITYSDK_OFFSET(0x1B4E07C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1B4E05F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER_SETSTRATEGY_OFFSET UNITYSDK_OFFSET(0x1B4E05D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4E05C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B4E04A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E0490)
