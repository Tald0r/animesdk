...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODECHKSUM_OFFSET UNITYSDK_OFFSET(0x1B4B22B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODEDICT_OFFSET UNITYSDK_OFFSET(0x1B4B1D20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODEHEADER_OFFSET UNITYSDK_OFFSET(0x1B4B1C00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODEHUFFMAN_OFFSET UNITYSDK_OFFSET(0x1B4B1DA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODE_OFFSET UNITYSDK_OFFSET(0x1B4B2470)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_ADLER_OFFSET UNITYSDK_OFFSET(0x1B4B2F80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1B4B2F20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_ISNEEDINGDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1B4B2C20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_ISNEEDINGINPUT_OFFSET UNITYSDK_OFFSET(0x1B4B2F50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_REMAININGINPUT_OFFSET UNITYSDK_OFFSET(0x1B4B3010)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_TOTALIN_OFFSET UNITYSDK_OFFSET(0x1B4B2FD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_TOTALOUT_OFFSET UNITYSDK_OFFSET(0x1B4B2FC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_INFLATE_1_OFFSET UNITYSDK_OFFSET(0x1B4B2D30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_INFLATE_OFFSET UNITYSDK_OFFSET(0x1B4B2CB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_RESET_OFFSET UNITYSDK_OFFSET(0x1B4B1B80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_SETDICTIONARY_1_OFFSET UNITYSDK_OFFSET(0x1B4B29D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_SETDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1B4B29B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_SETINPUT_1_OFFSET UNITYSDK_OFFSET(0x1B4B2C80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_SETINPUT_OFFSET UNITYSDK_OFFSET(0x1B4B2C40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4B3040)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4B1AF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4B1A60)
...
namespace ICSharpCode::SharpZipLib::Zip::Compression
{
	...
	public:
		...
		::ICSharpCode::SharpZipLib::Zip::Compression::Streams::StreamManipulator* input; // 0x18
		::ICSharpCode::SharpZipLib::Zip::Compression::InflaterDynHeader* dynHeader; // 0x20
		...
		::System::Int32 repDist; // 0x40
		::System::Boolean noHeader; // 0x44
		::System::Boolean isLastBlock; // 0x45
		::System::Int64 totalOut; // 0x48
		::System::Int32 uncomprLen; // 0x50
		::System::Int32 readAdler; // 0x54
		::System::Int32 repLength; // 0x58
		::System::Int64 totalIn; // 0x60
		::System::Int32 neededBits; // 0x68
		::System::Int32 mode; // 0x6C
