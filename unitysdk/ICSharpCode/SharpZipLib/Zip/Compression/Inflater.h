...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODECHKSUM_OFFSET UNITYSDK_OFFSET(0x1AE956D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODEDICT_OFFSET UNITYSDK_OFFSET(0x1AE95140)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODEHEADER_OFFSET UNITYSDK_OFFSET(0x1AE95020)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODEHUFFMAN_OFFSET UNITYSDK_OFFSET(0x1AE951C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_DECODE_OFFSET UNITYSDK_OFFSET(0x1AE95890)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_ADLER_OFFSET UNITYSDK_OFFSET(0x1AE963A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1AE96340)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_ISNEEDINGDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1AE96040)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_ISNEEDINGINPUT_OFFSET UNITYSDK_OFFSET(0x1AE96370)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_REMAININGINPUT_OFFSET UNITYSDK_OFFSET(0x1AE96430)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_TOTALIN_OFFSET UNITYSDK_OFFSET(0x1AE963F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_GET_TOTALOUT_OFFSET UNITYSDK_OFFSET(0x1AE963E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_INFLATE_1_OFFSET UNITYSDK_OFFSET(0x1AE96150)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_INFLATE_OFFSET UNITYSDK_OFFSET(0x1AE960D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_RESET_OFFSET UNITYSDK_OFFSET(0x1AE94FA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_SETDICTIONARY_1_OFFSET UNITYSDK_OFFSET(0x1AE95DF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_SETDICTIONARY_OFFSET UNITYSDK_OFFSET(0x1AE95DD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_SETINPUT_1_OFFSET UNITYSDK_OFFSET(0x1AE960A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER_SETINPUT_OFFSET UNITYSDK_OFFSET(0x1AE96060)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE96460)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE94F10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_INFLATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE94E80)

namespace ICSharpCode::SharpZipLib::Zip::Compression
{
	inline static constexpr unsigned int Inflater_TypeDefinitionIndex = 6698;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Inflater_TypeDefinitionIndex)->GetStaticField(0x5AF0);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_CPLEXT()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Inflater_TypeDefinitionIndex)->GetStaticField(0x5AF8);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_CPLENS()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Inflater_TypeDefinitionIndex)->GetStaticField(0x5B00);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_CPDIST()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Inflater_TypeDefinitionIndex)->GetStaticField(0x5B08);
		}
		...
		::ICSharpCode::SharpZipLib::Zip::Compression::InflaterDynHeader* dynHeader; // 0x10
		::ICSharpCode::SharpZipLib::Zip::Compression::InflaterHuffmanTree* distTree; // 0x18
		::ICSharpCode::SharpZipLib::Zip::Compression::Streams::StreamManipulator* input; // 0x20
		::ICSharpCode::SharpZipLib::Zip::Compression::Streams::OutputWindow* outputWindow; // 0x28
		::ICSharpCode::SharpZipLib::Zip::Compression::InflaterHuffmanTree* litlenTree; // 0x30
		::ICSharpCode::SharpZipLib::Checksums::Adler32* adler; // 0x38
		::System::Int64 totalOut; // 0x40
		::System::Int32 readAdler; // 0x48
		::System::Boolean noHeader; // 0x4C
		::System::Boolean isLastBlock; // 0x4D
		::System::Int64 totalIn; // 0x50
		::System::Int32 repLength; // 0x58
		::System::Int32 repDist; // 0x5C
		::System::Int32 neededBits; // 0x60
		::System::Int32 uncomprLen; // 0x64
		::System::Int32 mode; // 0x68
