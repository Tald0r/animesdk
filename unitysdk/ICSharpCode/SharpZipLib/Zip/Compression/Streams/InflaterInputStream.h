...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x1AE96DA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1AE96DF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_FILL_OFFSET UNITYSDK_OFFSET(0x1AE96A60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1AE96C30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0x1AE96A20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1AE96B40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1AE96B70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1AE96B80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1AE96890)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1AE96B90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AE96BB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1AE96E30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1AE96C60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1AE96CB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1AE968A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AE96BE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_SKIP_OFFSET UNITYSDK_OFFSET(0x1AE968B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_STOPDECRYPTING_OFFSET UNITYSDK_OFFSET(0x1AE969F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1AE96D50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1AE96D00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE96880)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AE96720)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_INFLATERINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE96640)

namespace ICSharpCode::SharpZipLib::Zip::Compression::Streams
{
	inline static constexpr unsigned int InflaterInputStream_TypeDefinitionIndex = 6668;
