...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_COPYDICT_OFFSET UNITYSDK_OFFSET(0x1AFFD930)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_COPYOUTPUT_OFFSET UNITYSDK_OFFSET(0x1AFFDA30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_COPYSTORED_OFFSET UNITYSDK_OFFSET(0x1AFFD880)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_GETAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1AFFDA20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_GETFREESPACE_OFFSET UNITYSDK_OFFSET(0x1AFFDA10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_REPEAT_OFFSET UNITYSDK_OFFSET(0x1AFFD6D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_RESET_OFFSET UNITYSDK_OFFSET(0x1AFFDB00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_SLOWREPEAT_OFFSET UNITYSDK_OFFSET(0x1AFFD630)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW_WRITE_OFFSET UNITYSDK_OFFSET(0x1AFFD580)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_STREAMS_OUTPUTWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFDB10)

namespace ICSharpCode::SharpZipLib::Zip::Compression::Streams
{
	inline static constexpr unsigned int OutputWindow_TypeDefinitionIndex = 6688;
