...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_BITREVERSE_OFFSET UNITYSDK_OFFSET(0x1A27AC10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_COMPRESSBLOCK_OFFSET UNITYSDK_OFFSET(0x1A27B8D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_DCODE_OFFSET UNITYSDK_OFFSET(0x1A27BC10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_FLUSHBLOCK_OFFSET UNITYSDK_OFFSET(0x1A27BD00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_FLUSHSTOREDBLOCK_OFFSET UNITYSDK_OFFSET(0x1A27BC40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_ISFULL_OFFSET UNITYSDK_OFFSET(0x1A27D100)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_LCODE_OFFSET UNITYSDK_OFFSET(0x1A27BB50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_RESET_OFFSET UNITYSDK_OFFSET(0x1A27AF00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_SENDALLTREES_OFFSET UNITYSDK_OFFSET(0x1A27B060)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TALLYDIST_OFFSET UNITYSDK_OFFSET(0x1A27D1C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TALLYLIT_OFFSET UNITYSDK_OFFSET(0x1A27D110)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A27A5B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A27AD50)

namespace ICSharpCode::SharpZipLib::Zip::Compression
{
	inline static constexpr unsigned int DeflaterHuffman_TypeDefinitionIndex = 6694;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(DeflaterHuffman_TypeDefinitionIndex)->GetStaticField(0x5B60);
		}
		static ::Il2CppArray<::System::Int16>** StaticGet_staticLCodes()
		{
			return (::Il2CppArray<::System::Int16>**)Il2CppClass::FromTypeDefinitionIndex(DeflaterHuffman_TypeDefinitionIndex)->GetStaticField(0x5B68);
		}
		static ::Il2CppArray<::System::Byte>** StaticGet_staticDLength()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(DeflaterHuffman_TypeDefinitionIndex)->GetStaticField(0x5B70);
		}
		static ::Il2CppArray<::System::Byte>** StaticGet_staticLLength()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(DeflaterHuffman_TypeDefinitionIndex)->GetStaticField(0x5B78);
		}
		static ::Il2CppArray<::System::Int16>** StaticGet_staticDCodes()
		{
			return (::Il2CppArray<::System::Int16>**)Il2CppClass::FromTypeDefinitionIndex(DeflaterHuffman_TypeDefinitionIndex)->GetStaticField(0x5B80);
		}
		static ::Il2CppArray<::System::Byte>** StaticGet_bit4Reverse()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(DeflaterHuffman_TypeDefinitionIndex)->GetStaticField(0x5B88);
		}
		...
		::Il2CppArray<::System::Byte>* l_buf; // 0x10
		::ICSharpCode::SharpZipLib::Zip::Compression::DeflaterHuffman_Tree* blTree; // 0x18
		::ICSharpCode::SharpZipLib::Zip::Compression::DeflaterPending* pending; // 0x20
		::Il2CppArray<::System::Int16>* d_buf; // 0x28
		::ICSharpCode::SharpZipLib::Zip::Compression::DeflaterHuffman_Tree* literalTree; // 0x30
