...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_BUILDCODES_OFFSET UNITYSDK_OFFSET(0x1A27B2A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_BUILDLENGTH_OFFSET UNITYSDK_OFFSET(0x1A27D550)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_BUILDTREE_OFFSET UNITYSDK_OFFSET(0x1A27C510)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_CALCBLFREQ_OFFSET UNITYSDK_OFFSET(0x1A27CDA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_CHECKEMPTY_OFFSET UNITYSDK_OFFSET(0x1A27D400)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_GETENCODEDLENGTH_OFFSET UNITYSDK_OFFSET(0x1A27D070)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_RESET_OFFSET UNITYSDK_OFFSET(0x1A27B010)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_SETSTATICCODES_OFFSET UNITYSDK_OFFSET(0x1A27D0F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_WRITESYMBOL_OFFSET UNITYSDK_OFFSET(0x1A27BB90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE_WRITETREE_OFFSET UNITYSDK_OFFSET(0x1A27B4F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_DEFLATERHUFFMAN_TREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A27AEB0)

namespace ICSharpCode::SharpZipLib::Zip::Compression
{
	inline static constexpr unsigned int DeflaterHuffman_Tree_TypeDefinitionIndex = 6695;

	class DeflaterHuffman_Tree : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Byte>* length; // 0x10
		::Il2CppArray<::System::Int32>* bl_counts; // 0x18
		::Il2CppArray<::System::Int16>* codes; // 0x20
		::Il2CppArray<::System::Int16>* freqs; // 0x28
		::ICSharpCode::SharpZipLib::Zip::Compression::DeflaterHuffman* dh; // 0x30
		::System::Int32 maxLength; // 0x38
		::System::Int32 numCodes; // 0x3C
		::System::Int32 minNumCodes; // 0x40
