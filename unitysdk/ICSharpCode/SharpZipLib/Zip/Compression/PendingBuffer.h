...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_ALIGNTOBYTE_OFFSET UNITYSDK_OFFSET(0x1B752F50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B753100)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_GET_BITCOUNT_OFFSET UNITYSDK_OFFSET(0x1B752F40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_GET_ISFLUSHED_OFFSET UNITYSDK_OFFSET(0x1B7530F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_RESET_OFFSET UNITYSDK_OFFSET(0x1B752D70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1B7531A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITEBITS_OFFSET UNITYSDK_OFFSET(0x1B752FE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITEBLOCK_OFFSET UNITYSDK_OFFSET(0x1B752F10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1B752D80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITEINT_OFFSET UNITYSDK_OFFSET(0x1B752E30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITESHORTMSB_OFFSET UNITYSDK_OFFSET(0x1B753080)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITESHORT_OFFSET UNITYSDK_OFFSET(0x1B752DC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B752D50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B752D20)
