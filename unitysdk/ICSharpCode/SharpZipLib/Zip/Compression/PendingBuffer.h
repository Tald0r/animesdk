...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_ALIGNTOBYTE_OFFSET UNITYSDK_OFFSET(0x1B136910)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B136AC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_GET_BITCOUNT_OFFSET UNITYSDK_OFFSET(0x1B136900)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_GET_ISFLUSHED_OFFSET UNITYSDK_OFFSET(0x1B136AB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_RESET_OFFSET UNITYSDK_OFFSET(0x1B136730)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_TOBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1B136B60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITEBITS_OFFSET UNITYSDK_OFFSET(0x1B1369A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITEBLOCK_OFFSET UNITYSDK_OFFSET(0x1B1368D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1B136740)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITEINT_OFFSET UNITYSDK_OFFSET(0x1B1367F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITESHORTMSB_OFFSET UNITYSDK_OFFSET(0x1B136A40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER_WRITESHORT_OFFSET UNITYSDK_OFFSET(0x1B136780)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B136710)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_COMPRESSION_PENDINGBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1366E0)

namespace ICSharpCode::SharpZipLib::Zip::Compression
{
	inline static constexpr unsigned int PendingBuffer_TypeDefinitionIndex = 6696;
