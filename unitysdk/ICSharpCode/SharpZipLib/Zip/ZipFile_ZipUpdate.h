...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GETSOURCE_OFFSET UNITYSDK_OFFSET(0x1AD9A460)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_COMMAND_OFFSET UNITYSDK_OFFSET(0x1AD9A3E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_CRCPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1AD9A420)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x1AD9A340)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1AD9A3F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_OFFSETBASEDSIZE_OFFSET UNITYSDK_OFFSET(0x1AD9A440)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_OUTENTRY_OFFSET UNITYSDK_OFFSET(0x1AD9A350)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_SIZEPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1AD9A400)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_SET_CRCPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1AD9A430)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_SET_OFFSETBASEDSIZE_OFFSET UNITYSDK_OFFSET(0x1AD9A450)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_SET_SIZEPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1AD9A410)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD99ED0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AD99FD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AD9A080)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1AD9A180)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1AD9A1B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1AD9A220)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1AD9A2B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD99EA0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_ZipUpdate_TypeDefinitionIndex = 6736;

	class ZipFile_ZipUpdate : public ::System::Object
	{
	public:
		::ICSharpCode::SharpZipLib::Zip::ZipEntry* entry_; // 0x10
		::ICSharpCode::SharpZipLib::Zip::IStaticDataSource* dataSource_; // 0x18
		...
		::System::Int64 sizePatchOffset_; // 0x40
