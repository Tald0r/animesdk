...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GETSOURCE_OFFSET UNITYSDK_OFFSET(0x1B3A2AC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_COMMAND_OFFSET UNITYSDK_OFFSET(0x1B3A2A40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_CRCPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1B3A2A80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x1B3A29A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1B3A2A50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_OFFSETBASEDSIZE_OFFSET UNITYSDK_OFFSET(0x1B3A2AA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_OUTENTRY_OFFSET UNITYSDK_OFFSET(0x1B3A29B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_GET_SIZEPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1B3A2A60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_SET_CRCPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1B3A2A90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_SET_OFFSETBASEDSIZE_OFFSET UNITYSDK_OFFSET(0x1B3A2AB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE_SET_SIZEPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1B3A2A70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B3A2530)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B3A2630)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B3A26E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B3A27E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1B3A2810)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1B3A2880)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1B3A2910)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ZIPUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A2500)
...
namespace ICSharpCode::SharpZipLib::Zip
{
	...
	public:
		...
		::ICSharpCode::SharpZipLib::Zip::ZipEntry* outEntry_; // 0x28
