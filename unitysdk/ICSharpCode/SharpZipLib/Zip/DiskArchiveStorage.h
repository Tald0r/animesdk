...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE_CONVERTTEMPORARYTOFINAL_OFFSET UNITYSDK_OFFSET(0x1B6B5EE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B6B61D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE_GETTEMPFILENAME_OFFSET UNITYSDK_OFFSET(0x1B6B5970)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE_GETTEMPORARYOUTPUT_OFFSET UNITYSDK_OFFSET(0x1B6B58F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE_MAKETEMPORARYCOPY_OFFSET UNITYSDK_OFFSET(0x1B6B6090)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE_OPENFORDIRECTUPDATE_OFFSET UNITYSDK_OFFSET(0x1B6B6140)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6B5860)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_DISKARCHIVESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B5760)
