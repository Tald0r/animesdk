...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_FIXEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1B71CC40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B71CC50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_ISUNICODETEXT_OFFSET UNITYSDK_OFFSET(0x1B71CC90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B71CBC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_SETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B71CC70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_GET_SETTING_OFFSET UNITYSDK_OFFSET(0x1B71CC20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_MAKEDIRECTORYENTRY_1_OFFSET UNITYSDK_OFFSET(0x1B71D160)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_MAKEDIRECTORYENTRY_OFFSET UNITYSDK_OFFSET(0x1B71D150)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_MAKEFILEENTRY_1_OFFSET UNITYSDK_OFFSET(0x1B71CCC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_MAKEFILEENTRY_OFFSET UNITYSDK_OFFSET(0x1B71CCB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_FIXEDDATETIME_OFFSET UNITYSDK_OFFSET(0x1B71CA70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B71CC60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_ISUNICODETEXT_OFFSET UNITYSDK_OFFSET(0x1B71CCA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B71CBD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_SETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B71CC80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY_SET_SETTING_OFFSET UNITYSDK_OFFSET(0x1B71CC30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B71C770)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B71C850)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPENTRYFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71C690)
...
namespace ICSharpCode::SharpZipLib::Zip
{
	...
	public:
		...
		::System::Boolean isUnicodeText_; // 0x18
		::System::Int32 setAttributes_; // 0x1C
		::System::DateTime fixedDateTime_; // 0x20
		::ICSharpCode::SharpZipLib::Zip::ZipEntryFactory_TimeSetting timeSetting_; // 0x28
		::System::Int32 getAttributes_; // 0x2C
