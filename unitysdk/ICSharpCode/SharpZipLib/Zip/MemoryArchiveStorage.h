...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_CONVERTTEMPORARYTOFINAL_OFFSET UNITYSDK_OFFSET(0x1B110160)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B1103F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_GETTEMPORARYOUTPUT_OFFSET UNITYSDK_OFFSET(0x1B1100F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_GET_FINALSTREAM_OFFSET UNITYSDK_OFFSET(0x1B1100E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_MAKETEMPORARYCOPY_OFFSET UNITYSDK_OFFSET(0x1B110270)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_OPENFORDIRECTUPDATE_OFFSET UNITYSDK_OFFSET(0x1B110320)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1100D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1100C0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int MemoryArchiveStorage_TypeDefinitionIndex = 6748;
