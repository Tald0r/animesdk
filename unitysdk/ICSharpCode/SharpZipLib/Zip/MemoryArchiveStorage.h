...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_CONVERTTEMPORARYTOFINAL_OFFSET UNITYSDK_OFFSET(0x1B726E60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B7270F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_GETTEMPORARYOUTPUT_OFFSET UNITYSDK_OFFSET(0x1B726DF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_GET_FINALSTREAM_OFFSET UNITYSDK_OFFSET(0x1B726DE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_MAKETEMPORARYCOPY_OFFSET UNITYSDK_OFFSET(0x1B726F70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE_OPENFORDIRECTUPDATE_OFFSET UNITYSDK_OFFSET(0x1B727020)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B726DD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_MEMORYARCHIVESTORAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B726DC0)
