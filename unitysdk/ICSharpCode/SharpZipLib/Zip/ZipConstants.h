...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOARRAY_1_OFFSET UNITYSDK_OFFSET(0x1AEC45C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOARRAY_OFFSET UNITYSDK_OFFSET(0x1AEC3670)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRINGEXT_1_OFFSET UNITYSDK_OFFSET(0x1AEC44A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRINGEXT_OFFSET UNITYSDK_OFFSET(0x1AEC4380)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1AEC4310)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRING_OFFSET UNITYSDK_OFFSET(0x1AEC4210)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_GET_DEFAULTCODEPAGE_OFFSET UNITYSDK_OFFSET(0x1AEC4150)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_SET_DEFAULTCODEPAGE_OFFSET UNITYSDK_OFFSET(0x1AEC41B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AEC46E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEC46D0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipConstants_TypeDefinitionIndex = 6711;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZipConstants_TypeDefinitionIndex)->GetStaticField(0x3150);
		}
