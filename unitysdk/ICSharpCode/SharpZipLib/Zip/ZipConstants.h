...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOARRAY_1_OFFSET UNITYSDK_OFFSET(0x1B4E3460)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOARRAY_OFFSET UNITYSDK_OFFSET(0x1B4E2510)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRINGEXT_1_OFFSET UNITYSDK_OFFSET(0x1B4E3340)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRINGEXT_OFFSET UNITYSDK_OFFSET(0x1B4E3220)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1B4E31B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_CONVERTTOSTRING_OFFSET UNITYSDK_OFFSET(0x1B4E30B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_GET_DEFAULTCODEPAGE_OFFSET UNITYSDK_OFFSET(0x1B4E2FF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS_SET_DEFAULTCODEPAGE_OFFSET UNITYSDK_OFFSET(0x1B4E3050)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4E3580)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPCONSTANTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4E3570)
