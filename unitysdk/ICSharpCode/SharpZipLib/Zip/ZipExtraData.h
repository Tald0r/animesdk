...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDDATA_1_OFFSET UNITYSDK_OFFSET(0x1AE97C40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDDATA_OFFSET UNITYSDK_OFFSET(0x1AE97C10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDENTRY_1_OFFSET UNITYSDK_OFFSET(0x1AE977B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDENTRY_OFFSET UNITYSDK_OFFSET(0x1AE97620)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDLEINT_OFFSET UNITYSDK_OFFSET(0x1AE97D20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDLELONG_OFFSET UNITYSDK_OFFSET(0x1AE97DB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDLESHORT_OFFSET UNITYSDK_OFFSET(0x1AE97CD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_ADDNEWENTRY_OFFSET UNITYSDK_OFFSET(0x1AE97BD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AE97030)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1AE97330)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_DELETE_OFFSET UNITYSDK_OFFSET(0x1AE97A50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AE980C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_FIND_OFFSET UNITYSDK_OFFSET(0x1AE97250)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GETDATA_OFFSET UNITYSDK_OFFSET(0x1AE972F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GETENTRYDATA_OFFSET UNITYSDK_OFFSET(0x1AE97090)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GETSTREAMFORTAG_OFFSET UNITYSDK_OFFSET(0x1AE971F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GET_CURRENTREADINDEX_OFFSET UNITYSDK_OFFSET(0x1AE974D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1AE971D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GET_UNREADCOUNT_OFFSET UNITYSDK_OFFSET(0x1AE974E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_GET_VALUELENGTH_OFFSET UNITYSDK_OFFSET(0x1AE974C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_READBYTE_OFFSET UNITYSDK_OFFSET(0x1AE98040)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_READCHECK_OFFSET UNITYSDK_OFFSET(0x1AE97E20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_READINT_OFFSET UNITYSDK_OFFSET(0x1AE97F10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_READLONG_OFFSET UNITYSDK_OFFSET(0x1AE97DE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_READSHORTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AE97560)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_READSHORT_OFFSET UNITYSDK_OFFSET(0x1AE97FD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_SETSHORT_OFFSET UNITYSDK_OFFSET(0x1AE97AF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_SKIP_OFFSET UNITYSDK_OFFSET(0x1AE980A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA_STARTNEWENTRY_OFFSET UNITYSDK_OFFSET(0x1AE97B60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE97060)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPEXTRADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE97000)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipExtraData_TypeDefinitionIndex = 6724;
