...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_GET_TRIMPREFIX_OFFSET UNITYSDK_OFFSET(0x1A27FAF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_ISVALIDNAME_1_OFFSET UNITYSDK_OFFSET(0x1A27FBE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_ISVALIDNAME_OFFSET UNITYSDK_OFFSET(0x1A27FB00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_MAKEVALIDNAME_OFFSET UNITYSDK_OFFSET(0x1A27F970)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_SET_TRIMPREFIX_OFFSET UNITYSDK_OFFSET(0x1A27F4E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_TRANSFORMDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1A27F6E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_TRANSFORMFILE_OFFSET UNITYSDK_OFFSET(0x1A27F790)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A27F510)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A27F4B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A27F4A0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipNameTransform_TypeDefinitionIndex = 6754;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(ZipNameTransform_TypeDefinitionIndex)->GetStaticField(0x5BB0);
		}
		static ::Il2CppArray<::System::Char>** StaticGet_InvalidEntryCharsRelaxed()
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(ZipNameTransform_TypeDefinitionIndex)->GetStaticField(0x5BB8);
		}
