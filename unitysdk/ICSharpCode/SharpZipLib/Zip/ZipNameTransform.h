...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_GET_TRIMPREFIX_OFFSET UNITYSDK_OFFSET(0x1A8508C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_ISVALIDNAME_1_OFFSET UNITYSDK_OFFSET(0x1A8509B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_ISVALIDNAME_OFFSET UNITYSDK_OFFSET(0x1A8508D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_MAKEVALIDNAME_OFFSET UNITYSDK_OFFSET(0x1A850740)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_SET_TRIMPREFIX_OFFSET UNITYSDK_OFFSET(0x1A8502B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_TRANSFORMDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1A8504B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM_TRANSFORMFILE_OFFSET UNITYSDK_OFFSET(0x1A850560)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8502E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A850280)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPNAMETRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A850270)
