...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ENTRYPATCHDATA_GET_CRCPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1A27E260)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ENTRYPATCHDATA_GET_SIZEPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1A27E240)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ENTRYPATCHDATA_SET_CRCPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1A27E270)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ENTRYPATCHDATA_SET_SIZEPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1A27E250)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ENTRYPATCHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A27E280)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int EntryPatchData_TypeDefinitionIndex = 6750;

	class EntryPatchData : public ::System::Object
	{
	public:
		::System::Int64 sizePatchOffset_; // 0x10
		::System::Int64 crcPatchOffset_; // 0x18
