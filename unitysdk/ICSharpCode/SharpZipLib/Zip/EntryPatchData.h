...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ENTRYPATCHDATA_GET_CRCPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1A84F030)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ENTRYPATCHDATA_GET_SIZEPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1A84F010)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ENTRYPATCHDATA_SET_CRCPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1A84F040)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ENTRYPATCHDATA_SET_SIZEPATCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1A84F020)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ENTRYPATCHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A84F050)
