...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ABORTUPDATE_OFFSET UNITYSDK_OFFSET(0x1A9BFBB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ADDDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1A9C0DC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ADDENTRY_OFFSET UNITYSDK_OFFSET(0x1A9C3890)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ADDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A9BFE60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ADD_1_OFFSET UNITYSDK_OFFSET(0x1A9C0250)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ADD_2_OFFSET UNITYSDK_OFFSET(0x1A9C0400)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ADD_3_OFFSET UNITYSDK_OFFSET(0x1A9C0530)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ADD_4_OFFSET UNITYSDK_OFFSET(0x1A9C06A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ADD_5_OFFSET UNITYSDK_OFFSET(0x1A9C0810)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ADD_6_OFFSET UNITYSDK_OFFSET(0x1A9C09F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ADD_7_OFFSET UNITYSDK_OFFSET(0x1A9C0BF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ADD_OFFSET UNITYSDK_OFFSET(0x1A9C0050)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_BEGINUPDATE_1_OFFSET UNITYSDK_OFFSET(0x1A9BD820)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_BEGINUPDATE_2_OFFSET UNITYSDK_OFFSET(0x1A9BD870)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_BEGINUPDATE_OFFSET UNITYSDK_OFFSET(0x1A9BD100)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_CHECKCLASSICPASSWORD_OFFSET UNITYSDK_OFFSET(0x1A9C5070)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_CHECKUPDATING_OFFSET UNITYSDK_OFFSET(0x1A9BDD10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A9B8940)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_COMMITUPDATE_OFFSET UNITYSDK_OFFSET(0x1A9BD960)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_COPYBYTES_OFFSET UNITYSDK_OFFSET(0x1A9C2AB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_COPYDESCRIPTORBYTESDIRECT_OFFSET UNITYSDK_OFFSET(0x1A9C2EC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_COPYDESCRIPTORBYTES_OFFSET UNITYSDK_OFFSET(0x1A9C2810)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_COPYENTRYDATADIRECT_OFFSET UNITYSDK_OFFSET(0x1A9C30C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_COPYENTRYDIRECT_OFFSET UNITYSDK_OFFSET(0x1A9C48D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_COPYENTRY_OFFSET UNITYSDK_OFFSET(0x1A9C4B30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_CREATEANDINITDECRYPTIONSTREAM_OFFSET UNITYSDK_OFFSET(0x1A9B97C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_CREATEANDINITENCRYPTIONSTREAM_OFFSET UNITYSDK_OFFSET(0x1A9C3630)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1A9B8BC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_CREATE_OFFSET UNITYSDK_OFFSET(0x1A9B89C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_DELETE_1_OFFSET UNITYSDK_OFFSET(0x1A9C10D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_DELETE_OFFSET UNITYSDK_OFFSET(0x1A9C0F60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_DISPOSEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A9B8150)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A9C4E70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A9B88D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_FINDENTRY_OFFSET UNITYSDK_OFFSET(0x1A9B8FF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_FINDEXISTINGUPDATE_1_OFFSET UNITYSDK_OFFSET(0x1A9BFF80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_FINDEXISTINGUPDATE_OFFSET UNITYSDK_OFFSET(0x1A9C1210)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x1A9C27D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GETDESCRIPTORSIZE_OFFSET UNITYSDK_OFFSET(0x1A9C2A10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GETENTRY_OFFSET UNITYSDK_OFFSET(0x1A9B9210)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A9B8F60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GETINPUTSTREAM_1_OFFSET UNITYSDK_OFFSET(0x1A9B94A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GETINPUTSTREAM_OFFSET UNITYSDK_OFFSET(0x1A9B9320)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GETOUTPUTSTREAM_OFFSET UNITYSDK_OFFSET(0x1A9C34E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GETTRANSFORMEDDIRECTORYNAME_OFFSET UNITYSDK_OFFSET(0x1A9C26D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GETTRANSFORMEDFILENAME_OFFSET UNITYSDK_OFFSET(0x1A9C25E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_BUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1A9BD030)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A9B8E90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_ENTRYBYINDEX_OFFSET UNITYSDK_OFFSET(0x1A9B8EB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_ENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1A9BCF00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_HAVEKEYS_OFFSET UNITYSDK_OFFSET(0x1A9B7480)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_ISEMBEDDEDARCHIVE_OFFSET UNITYSDK_OFFSET(0x1A9B8E30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_ISNEWARCHIVE_OFFSET UNITYSDK_OFFSET(0x1A9B8E40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1A9B8E10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_ISUPDATING_OFFSET UNITYSDK_OFFSET(0x1A9BD0D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1A9B73F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A9BCE80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A9B8E60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1A9B8E70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1A9BD0E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_GET_ZIPFILECOMMENT_OFFSET UNITYSDK_OFFSET(0x1A9B8E50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_LOCATEBLOCKWITHSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1A9C4EE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_LOCATEENTRY_OFFSET UNITYSDK_OFFSET(0x1A9B97B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_MODIFYENTRY_OFFSET UNITYSDK_OFFSET(0x1A9C4460)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_ONKEYSREQUIRED_OFFSET UNITYSDK_OFFSET(0x1A9B7350)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_POSTUPDATECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A9BFAC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_READENTRIES_OFFSET UNITYSDK_OFFSET(0x1A9B76B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_READLEUINT_OFFSET UNITYSDK_OFFSET(0x1A9BCD80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_READLEULONG_OFFSET UNITYSDK_OFFSET(0x1A9C4E80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_READLEUSHORT_OFFSET UNITYSDK_OFFSET(0x1A9BCDB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_REOPEN_1_OFFSET UNITYSDK_OFFSET(0x1A9C4CD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_REOPEN_OFFSET UNITYSDK_OFFSET(0x1A9C4C50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_RUNUPDATES_OFFSET UNITYSDK_OFFSET(0x1A9BDD80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_SETCOMMENT_OFFSET UNITYSDK_OFFSET(0x1A9BFCA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_SET_BUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x1A9BD040)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_SET_ENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1A9BCF10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1A9B8E20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1A9B7400)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_SET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A9BCEA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1A9B7410)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_SET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1A9BD0F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A9C4DF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_TESTARCHIVE_1_OFFSET UNITYSDK_OFFSET(0x1A9B9DD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_TESTARCHIVE_OFFSET UNITYSDK_OFFSET(0x1A9B9DC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_TESTLOCALHEADER_OFFSET UNITYSDK_OFFSET(0x1A9BA640)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_UPDATECOMMENTONLY_OFFSET UNITYSDK_OFFSET(0x1A9BF3F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_WRITECENTRALDIRECTORYHEADER_OFFSET UNITYSDK_OFFSET(0x1A9C1D30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_WRITEENCRYPTIONHEADER_OFFSET UNITYSDK_OFFSET(0x1A9C5130)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_WRITELEINT_OFFSET UNITYSDK_OFFSET(0x1A9C1390)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_WRITELELONG_OFFSET UNITYSDK_OFFSET(0x1A9C14B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_WRITELESHORT_OFFSET UNITYSDK_OFFSET(0x1A9C12F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_WRITELEUINT_OFFSET UNITYSDK_OFFSET(0x1A9C1420)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_WRITELEULONG_OFFSET UNITYSDK_OFFSET(0x1A9C14E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_WRITELEUSHORT_OFFSET UNITYSDK_OFFSET(0x1A9C1340)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_WRITELOCALENTRYHEADER_OFFSET UNITYSDK_OFFSET(0x1A9C1510)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9B8330)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A9B8540)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A9B8790)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B7490)
...
namespace ICSharpCode::SharpZipLib::Zip
{
	...
	public:
		...
		::System::IO::Stream* baseStream_; // 0x10
		::ICSharpCode::SharpZipLib::Zip::IArchiveStorage* archiveStorage_; // 0x18
		::ICSharpCode::SharpZipLib::Zip::ZipFile_KeysRequiredEventHandler* KeysRequired; // 0x20
		::System::String* rawPassword_; // 0x28
		::ICSharpCode::SharpZipLib::Zip::ZipFile_ZipString* newComment_; // 0x30
		::Il2CppArray<::System::Byte>* key; // 0x38
		::Il2CppArray<::ICSharpCode::SharpZipLib::Zip::ZipEntry*>* entries_; // 0x40
		::System::String* comment_; // 0x48
		::System::Collections::ArrayList* updates_; // 0x50
		::System::String* name_; // 0x58
		::ICSharpCode::SharpZipLib::Zip::IEntryFactory* updateEntryFactory_; // 0x60
		::Il2CppArray<::System::Byte>* copyBuffer_; // 0x68
		::ICSharpCode::SharpZipLib::Zip::IDynamicDataSource* updateDataSource_; // 0x70
		::System::Collections::Hashtable* updateIndex_; // 0x78
		::System::Int64 updateCount_; // 0x80
		::System::Int64 offsetOfFirstEntry; // 0x88
		::System::Boolean isNewArchive_; // 0x90
		::System::Boolean isStreamOwner; // 0x91
		::System::Int32 bufferSize_; // 0x94
		::ICSharpCode::SharpZipLib::Zip::UseZip64 useZip64_; // 0x98
		::System::Boolean contentsEdited_; // 0x9C
		::System::Boolean commentEdited_; // 0x9D
		::System::Boolean isDisposed_; // 0x9E
