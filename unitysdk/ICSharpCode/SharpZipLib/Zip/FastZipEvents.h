...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_GET_PROGRESSINTERVAL_OFFSET UNITYSDK_OFFSET(0x1AE9DAA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONCOMPLETEDFILE_OFFSET UNITYSDK_OFFSET(0x1AE9D970)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONDIRECTORYFAILURE_OFFSET UNITYSDK_OFFSET(0x1AE9D7A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONFILEFAILURE_OFFSET UNITYSDK_OFFSET(0x1AE9D840)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONPROCESSDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1AE9DA00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONPROCESSFILE_OFFSET UNITYSDK_OFFSET(0x1AE9D8E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_SET_PROGRESSINTERVAL_OFFSET UNITYSDK_OFFSET(0x1AE9DAB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE9DAC0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int FastZipEvents_TypeDefinitionIndex = 6701;

	class FastZipEvents : public ::System::Object
	{
	public:
		::ICSharpCode::SharpZipLib::Core::ProgressHandler* Progress; // 0x10
		...
		::ICSharpCode::SharpZipLib::Core::FileFailureHandler* FileFailure; // 0x28
		::ICSharpCode::SharpZipLib::Core::CompletedFileHandler* CompletedFile; // 0x30
		::ICSharpCode::SharpZipLib::Core::ProcessFileHandler* ProcessFile; // 0x38
