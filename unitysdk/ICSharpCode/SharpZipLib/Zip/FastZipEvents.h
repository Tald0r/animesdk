...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_GET_PROGRESSINTERVAL_OFFSET UNITYSDK_OFFSET(0x1B4BA690)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONCOMPLETEDFILE_OFFSET UNITYSDK_OFFSET(0x1B4BA560)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONDIRECTORYFAILURE_OFFSET UNITYSDK_OFFSET(0x1B4BA390)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONFILEFAILURE_OFFSET UNITYSDK_OFFSET(0x1B4BA430)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONPROCESSDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1B4BA5F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_ONPROCESSFILE_OFFSET UNITYSDK_OFFSET(0x1B4BA4D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS_SET_PROGRESSINTERVAL_OFFSET UNITYSDK_OFFSET(0x1B4BA6A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIPEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4BA6B0)
...
namespace ICSharpCode::SharpZipLib::Zip
{
	...
	public:
		...
		::ICSharpCode::SharpZipLib::Core::ProgressHandler* Progress; // 0x30
		::ICSharpCode::SharpZipLib::Core::DirectoryFailureHandler* DirectoryFailure; // 0x38
