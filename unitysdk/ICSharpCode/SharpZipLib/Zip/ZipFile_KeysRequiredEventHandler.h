...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_KEYSREQUIREDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B1371F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_KEYSREQUIREDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B137230)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_KEYSREQUIREDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B136C70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_KEYSREQUIREDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B136C60)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_KeysRequiredEventHandler_TypeDefinitionIndex = 6732;
