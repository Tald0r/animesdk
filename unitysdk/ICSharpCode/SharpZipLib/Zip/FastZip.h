...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_ADDFILECONTENTS_OFFSET UNITYSDK_OFFSET(0x1B6116C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CREATEZIP_1_OFFSET UNITYSDK_OFFSET(0x1B610510)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CREATEZIP_2_OFFSET UNITYSDK_OFFSET(0x1B6101D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CREATEZIP_OFFSET UNITYSDK_OFFSET(0x1B610150)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTENTRY_OFFSET UNITYSDK_OFFSET(0x1B610EA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTFILEENTRY_OFFSET UNITYSDK_OFFSET(0x1B611850)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTZIP_1_OFFSET UNITYSDK_OFFSET(0x1B610650)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTZIP_2_OFFSET UNITYSDK_OFFSET(0x1B610710)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTZIP_OFFSET UNITYSDK_OFFSET(0x1B6105A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_CREATEEMPTYDIRECTORIES_OFFSET UNITYSDK_OFFSET(0x1B60FF00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_ENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1B60FFC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B60FF40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1B60FF20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_RESTOREATTRIBUTESONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1B610130)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_RESTOREDATETIMEONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1B610110)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1B6100F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_MAKEEXTERNALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B611EA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_NAMEISVALID_OFFSET UNITYSDK_OFFSET(0x1B611F30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_PROCESSDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1B611380)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_PROCESSFILE_OFFSET UNITYSDK_OFFSET(0x1B6114C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_CREATEEMPTYDIRECTORIES_OFFSET UNITYSDK_OFFSET(0x1B60FF10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_ENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1B60FFD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B60FF60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1B60FF30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_RESTOREATTRIBUTESONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1B610140)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_RESTOREDATETIMEONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1B610120)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1B610100)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B60FDE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B60FCC0)
...
namespace ICSharpCode::SharpZipLib::Zip
{
	...
	public:
		...
		::ICSharpCode::SharpZipLib::Core::INameTransform* extractNameTransform_; // 0x18
		::ICSharpCode::SharpZipLib::Zip::ZipFile* zipFile_; // 0x20
		::ICSharpCode::SharpZipLib::Core::NameFilter* directoryFilter_; // 0x28
		::Il2CppArray<::System::Byte>* buffer_; // 0x30
		::ICSharpCode::SharpZipLib::Zip::IEntryFactory* entryFactory_; // 0x38
		::System::String* password_; // 0x40
		::ICSharpCode::SharpZipLib::Zip::FastZipEvents* events_; // 0x48
		::System::String* sourceDirectory_; // 0x50
		::ICSharpCode::SharpZipLib::Zip::ZipOutputStream* outputStream_; // 0x58
		::ICSharpCode::SharpZipLib::Core::NameFilter* fileFilter_; // 0x60
		::ICSharpCode::SharpZipLib::Zip::UseZip64 useZip64_; // 0x68
		...
		::ICSharpCode::SharpZipLib::Zip::FastZip_Overwrite overwrite_; // 0x70
