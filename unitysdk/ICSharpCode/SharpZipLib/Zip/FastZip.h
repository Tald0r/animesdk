...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_ADDFILECONTENTS_OFFSET UNITYSDK_OFFSET(0x1AFFF540)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CREATEZIP_1_OFFSET UNITYSDK_OFFSET(0x1AFFE390)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CREATEZIP_2_OFFSET UNITYSDK_OFFSET(0x1AFFE050)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_CREATEZIP_OFFSET UNITYSDK_OFFSET(0x1AFFDFD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTENTRY_OFFSET UNITYSDK_OFFSET(0x1AFFED20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTFILEENTRY_OFFSET UNITYSDK_OFFSET(0x1AFFF6D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTZIP_1_OFFSET UNITYSDK_OFFSET(0x1AFFE4D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTZIP_2_OFFSET UNITYSDK_OFFSET(0x1AFFE590)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_EXTRACTZIP_OFFSET UNITYSDK_OFFSET(0x1AFFE420)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_CREATEEMPTYDIRECTORIES_OFFSET UNITYSDK_OFFSET(0x1AFFDD80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_ENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1AFFDE40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AFFDDC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1AFFDDA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_RESTOREATTRIBUTESONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1AFFDFB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_RESTOREDATETIMEONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1AFFDF90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_GET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1AFFDF70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_MAKEEXTERNALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AFFFD20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_NAMEISVALID_OFFSET UNITYSDK_OFFSET(0x1AFFFDB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_PROCESSDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1AFFF200)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_PROCESSFILE_OFFSET UNITYSDK_OFFSET(0x1AFFF340)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_CREATEEMPTYDIRECTORIES_OFFSET UNITYSDK_OFFSET(0x1AFFDD90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_ENTRYFACTORY_OFFSET UNITYSDK_OFFSET(0x1AFFDE50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_NAMETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AFFDDE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1AFFDDB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_RESTOREATTRIBUTESONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1AFFDFC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_RESTOREDATETIMEONEXTRACT_OFFSET UNITYSDK_OFFSET(0x1AFFDFA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP_SET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1AFFDF80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFFDC60)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_FASTZIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFDB40)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int FastZip_TypeDefinitionIndex = 6702;

	class FastZip : public ::System::Object
	{
	public:
		::ICSharpCode::SharpZipLib::Core::NameFilter* directoryFilter_; // 0x10
		::ICSharpCode::SharpZipLib::Core::NameFilter* fileFilter_; // 0x18
		::ICSharpCode::SharpZipLib::Zip::IEntryFactory* entryFactory_; // 0x20
		::ICSharpCode::SharpZipLib::Core::INameTransform* extractNameTransform_; // 0x28
		::ICSharpCode::SharpZipLib::Zip::FastZipEvents* events_; // 0x30
		::ICSharpCode::SharpZipLib::Zip::ZipFile* zipFile_; // 0x38
		::ICSharpCode::SharpZipLib::Zip::FastZip_ConfirmOverwriteDelegate* confirmDelegate_; // 0x40
		::ICSharpCode::SharpZipLib::Zip::ZipOutputStream* outputStream_; // 0x48
		::System::String* sourceDirectory_; // 0x50
		::Il2CppArray<::System::Byte>* buffer_; // 0x58
		::System::String* password_; // 0x60
		::ICSharpCode::SharpZipLib::Zip::FastZip_Overwrite overwrite_; // 0x68
		::System::Boolean restoreDateTimeOnExtract_; // 0x6C
		::System::Boolean createEmptyDirectories_; // 0x6D
		::System::Boolean continueRunning_; // 0x6E
		::System::Boolean restoreAttributesOnExtract_; // 0x6F
