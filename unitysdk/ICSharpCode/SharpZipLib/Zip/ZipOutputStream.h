...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_ADDEXTRADATAAES_OFFSET UNITYSDK_OFFSET(0x1B6AE1E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_CLOSEENTRY_OFFSET UNITYSDK_OFFSET(0x1B6AD7A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_COPYANDENCRYPT_OFFSET UNITYSDK_OFFSET(0x1B6AE940)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_FINISH_OFFSET UNITYSDK_OFFSET(0x1B6AEAA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_GETLEVEL_OFFSET UNITYSDK_OFFSET(0x1B6ACA50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1B6AC960)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_GET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1B6ACA70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_PUTNEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1B6ACBA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_SETCOMMENT_OFFSET UNITYSDK_OFFSET(0x1B6AC970)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1B6ACA20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_SET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1B6ACA80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITEAESHEADER_OFFSET UNITYSDK_OFFSET(0x1B6AE370)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITEENCRYPTIONHEADER_OFFSET UNITYSDK_OFFSET(0x1B6AE420)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITELEINT_OFFSET UNITYSDK_OFFSET(0x1B6ACAE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITELELONG_OFFSET UNITYSDK_OFFSET(0x1B6ACB70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITELESHORT_OFFSET UNITYSDK_OFFSET(0x1B6ACA90)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1B6AE5E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6AC850)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6AC740)
...
namespace ICSharpCode::SharpZipLib::Zip
{
	...
	public:
		...
		::ICSharpCode::SharpZipLib::Zip::ZipEntry* curEntry; // 0x68
		::ICSharpCode::SharpZipLib::Checksums::Crc32* crc; // 0x70
		::System::Collections::ArrayList* entries; // 0x78
		::System::Int64 size; // 0x80
		::System::Int64 crcPatchPos; // 0x88
		::System::Int64 offset; // 0x90
		::System::Int32 defaultCompressionLevel; // 0x98
