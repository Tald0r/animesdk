...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_ADDEXTRADATAAES_OFFSET UNITYSDK_OFFSET(0x1B0A0380)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_CLOSEENTRY_OFFSET UNITYSDK_OFFSET(0x1B09F940)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_COPYANDENCRYPT_OFFSET UNITYSDK_OFFSET(0x1B0A0AE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_FINISH_OFFSET UNITYSDK_OFFSET(0x1B0A0C40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_GETLEVEL_OFFSET UNITYSDK_OFFSET(0x1B09EBF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1B09EB00)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_GET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1B09EC10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_PUTNEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1B09ED40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_SETCOMMENT_OFFSET UNITYSDK_OFFSET(0x1B09EB10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_SETLEVEL_OFFSET UNITYSDK_OFFSET(0x1B09EBC0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_SET_USEZIP64_OFFSET UNITYSDK_OFFSET(0x1B09EC20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITEAESHEADER_OFFSET UNITYSDK_OFFSET(0x1B0A0510)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITEENCRYPTIONHEADER_OFFSET UNITYSDK_OFFSET(0x1B0A05C0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITELEINT_OFFSET UNITYSDK_OFFSET(0x1B09EC80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITELELONG_OFFSET UNITYSDK_OFFSET(0x1B09ED10)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITELESHORT_OFFSET UNITYSDK_OFFSET(0x1B09EC30)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1B0A0780)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B09E9F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPOUTPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09E8E0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipOutputStream_TypeDefinitionIndex = 6755;
	...
	public:
		...
		::ICSharpCode::SharpZipLib::Checksums::Crc32* crc; // 0x78
		::System::Boolean patchEntryHeader; // 0x80
		::System::Int32 defaultCompressionLevel; // 0x84
		::System::Int64 crcPatchPos; // 0x88
		::System::Int64 size; // 0x90
		::System::Int64 offset; // 0x98
		::ICSharpCode::SharpZipLib::Zip::UseZip64 useZip64_; // 0xA0
		::ICSharpCode::SharpZipLib::Zip::CompressionMethod curMethod; // 0xA4
