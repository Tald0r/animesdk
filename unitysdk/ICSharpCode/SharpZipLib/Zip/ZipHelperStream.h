...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B0ED230)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B0ED140)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1B0ECFF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1B0ED020)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1B0ED050)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1B0ED110)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1B0ECFD0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B0ED080)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B0ED0B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_LOCATEBLOCKWITHSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B0ED8F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READDATADESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B0EE2E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READLEINT_OFFSET UNITYSDK_OFFSET(0x1B0ED9B0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READLELONG_OFFSET UNITYSDK_OFFSET(0x1B0EE0D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READLESHORT_OFFSET UNITYSDK_OFFSET(0x1B0EE000)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1B0ED1D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1B0ED170)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1B0ED1A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_SET_ISSTREAMOWNER_OFFSET UNITYSDK_OFFSET(0x1B0ECFE0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B0ED0E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITEDATADESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1B0EE150)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITEENDOFCENTRALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1B0EDBB0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELEINT_OFFSET UNITYSDK_OFFSET(0x1B0ED810)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELELONG_OFFSET UNITYSDK_OFFSET(0x1B0EDB80)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELESHORT_OFFSET UNITYSDK_OFFSET(0x1B0ED8A0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELEUINT_OFFSET UNITYSDK_OFFSET(0x1B0EDF70)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELEULONG_OFFSET UNITYSDK_OFFSET(0x1B0EE120)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELEUSHORT_OFFSET UNITYSDK_OFFSET(0x1B0EDF20)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITELOCALHEADER_OFFSET UNITYSDK_OFFSET(0x1B0ED260)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITEZIP64ENDOFCENTRALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1B0ED9E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1B0ED200)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0ECFA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPHELPERSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0ECF00)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipHelperStream_TypeDefinitionIndex = 6751;
