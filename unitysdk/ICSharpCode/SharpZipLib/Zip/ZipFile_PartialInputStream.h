...
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B141D40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B142010)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1B142100)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1B1420F0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1B142110)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1B1420E0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B1420D0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B142020)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1B141C40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1B141D50)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1B141F40)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1B141EF0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B142030)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1B141EA0)
#define ICSHARPCODE_SHARPZIPLIB_ZIP_ZIPFILE_PARTIALINPUTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B141BE0)

namespace ICSharpCode::SharpZipLib::Zip
{
	inline static constexpr unsigned int ZipFile_PartialInputStream_TypeDefinitionIndex = 6740;
	...
	public:
		...
		::System::Int64 end_; // 0x38
		::System::Int64 start_; // 0x40
		::System::Int64 readPos_; // 0x48
