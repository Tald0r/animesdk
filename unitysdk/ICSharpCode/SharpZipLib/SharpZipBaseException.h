...
#define ICSHARPCODE_SHARPZIPLIB_SHARPZIPBASEEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B10FF40)
#define ICSHARPCODE_SHARPZIPLIB_SHARPZIPBASEEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B10FFE0)
#define ICSHARPCODE_SHARPZIPLIB_SHARPZIPBASEEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B110050)
#define ICSHARPCODE_SHARPZIPLIB_SHARPZIPBASEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B10FEF0)

namespace ICSharpCode::SharpZipLib
{
	inline static constexpr unsigned int SharpZipBaseException_TypeDefinitionIndex = 6631;
