...
#define CURVEINTERPOLATOR_CATMULL3_OFFSET UNITYSDK_OFFSET(0x73DE7F0)
#define CURVEINTERPOLATOR_CATMULLN_OFFSET UNITYSDK_OFFSET(0x73DEB60)
#define CURVEINTERPOLATOR_CATMULLROM_OFFSET UNITYSDK_OFFSET(0x73DED30)
#define CURVEINTERPOLATOR_EVALUATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x73DE390)
#define CURVEINTERPOLATOR_EVALUATE_OFFSET UNITYSDK_OFFSET(0x73DE2B0)
#define CURVEINTERPOLATOR_LERP2_OFFSET UNITYSDK_OFFSET(0x73DE6A0)
#define CURVEINTERPOLATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x73DE240)

inline static constexpr unsigned int CurveInterpolator_TypeDefinitionIndex = 62228;
