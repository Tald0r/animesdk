...
#define CURVEINTERPOLATOR_CATMULL3_OFFSET UNITYSDK_OFFSET(0x714E530)
#define CURVEINTERPOLATOR_CATMULLN_OFFSET UNITYSDK_OFFSET(0x714E8A0)
#define CURVEINTERPOLATOR_CATMULLROM_OFFSET UNITYSDK_OFFSET(0x714EA70)
#define CURVEINTERPOLATOR_EVALUATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x714E0D0)
#define CURVEINTERPOLATOR_EVALUATE_OFFSET UNITYSDK_OFFSET(0x714DFF0)
#define CURVEINTERPOLATOR_LERP2_OFFSET UNITYSDK_OFFSET(0x714E3E0)
#define CURVEINTERPOLATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x714DF80)

inline static constexpr unsigned int CurveInterpolator_TypeDefinitionIndex = 39349;
