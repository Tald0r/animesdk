...
#define TOUCHEVENTDISPATCHER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1388C4F0)
#define TOUCHEVENTDISPATCHER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1388CB50)
#define TOUCHEVENTDISPATCHER_ONDROP_OFFSET UNITYSDK_OFFSET(0x1388D1B0)
#define TOUCHEVENTDISPATCHER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1388CE80)
#define TOUCHEVENTDISPATCHER_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0x1388C820)
#define TOUCHEVENTDISPATCHER_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x1388BB60)
#define TOUCHEVENTDISPATCHER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1388D810)
#define TOUCHEVENTDISPATCHER_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x1388BE90)
#define TOUCHEVENTDISPATCHER_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x1388C1C0)
#define TOUCHEVENTDISPATCHER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1388DB40)
#define TOUCHEVENTDISPATCHER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1388D4E0)
#define TOUCHEVENTDISPATCHER_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x1388BAF0)
#define TOUCHEVENTDISPATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1388DE70)

inline static constexpr unsigned int TouchEventDispatcher_TypeDefinitionIndex = 62793;
