...
#define TOUCHEVENTDISPATCHER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1919DF80)
#define TOUCHEVENTDISPATCHER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1919E5E0)
#define TOUCHEVENTDISPATCHER_ONDROP_OFFSET UNITYSDK_OFFSET(0x1919EC40)
#define TOUCHEVENTDISPATCHER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1919E910)
#define TOUCHEVENTDISPATCHER_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0x1919E2B0)
#define TOUCHEVENTDISPATCHER_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x1919D5F0)
#define TOUCHEVENTDISPATCHER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1919F2A0)
#define TOUCHEVENTDISPATCHER_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x1919D920)
#define TOUCHEVENTDISPATCHER_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x1919DC50)
#define TOUCHEVENTDISPATCHER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1919F5D0)
#define TOUCHEVENTDISPATCHER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1919EF70)
#define TOUCHEVENTDISPATCHER_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x1919D580)
#define TOUCHEVENTDISPATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1919F900)

inline static constexpr unsigned int TouchEventDispatcher_TypeDefinitionIndex = 40276;
