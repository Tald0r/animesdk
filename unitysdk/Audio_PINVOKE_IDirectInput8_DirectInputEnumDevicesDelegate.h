...
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x681C5D0)
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x681C630)
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x681C290)
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x681C280)

inline static constexpr unsigned int Audio_PINVOKE_IDirectInput8_DirectInputEnumDevicesDelegate_TypeDefinitionIndex = 70694;
