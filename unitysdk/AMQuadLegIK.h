...
#define AMQUADLEGIK_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x9CB0DE0)
#define AMQUADLEGIK_GET_ENABLEDEBUGHIPHIT_OFFSET UNITYSDK_OFFSET(0x9CAF1F0)
#define AMQUADLEGIK_GET_ENABLEDEBUGNOTLOCKFOOT_OFFSET UNITYSDK_OFFSET(0x9CAF210)
#define AMQUADLEGIK_GET_ENABLEDEBUGSHOWSKELETON_OFFSET UNITYSDK_OFFSET(0x9CAF1D0)
#define AMQUADLEGIK_GET_LASTFRAMETHETA_OFFSET UNITYSDK_OFFSET(0x9CAF1B0)
#define AMQUADLEGIK_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x9CAF300)
#define AMQUADLEGIK_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x9CB0D10)
#define AMQUADLEGIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9CAF6B0)
#define AMQUADLEGIK_QUADAMLEGIKPASS_OFFSET UNITYSDK_OFFSET(0x9CAF830)
#define AMQUADLEGIK_SET_ENABLEDEBUGHIPHIT_OFFSET UNITYSDK_OFFSET(0x9CAF200)
#define AMQUADLEGIK_SET_ENABLEDEBUGNOTLOCKFOOT_OFFSET UNITYSDK_OFFSET(0x9CAF220)
#define AMQUADLEGIK_SET_ENABLEDEBUGSHOWSKELETON_OFFSET UNITYSDK_OFFSET(0x9CAF1E0)
#define AMQUADLEGIK_SET_LASTFRAMETHETA_OFFSET UNITYSDK_OFFSET(0x9CAF1C0)
#define AMQUADLEGIK_START_OFFSET UNITYSDK_OFFSET(0x9CAF230)
#define AMQUADLEGIK_UPDATE_OFFSET UNITYSDK_OFFSET(0x9CAF780)
#define AMQUADLEGIK__CTOR_OFFSET UNITYSDK_OFFSET(0x9CB1100)

inline static constexpr unsigned int AMQuadLegIK_TypeDefinitionIndex = 76833;
