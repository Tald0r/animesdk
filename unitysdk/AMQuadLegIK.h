...
#define AMQUADLEGIK_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x903B550)
#define AMQUADLEGIK_GET_ENABLEDEBUGHIPHIT_OFFSET UNITYSDK_OFFSET(0x9039960)
#define AMQUADLEGIK_GET_ENABLEDEBUGNOTLOCKFOOT_OFFSET UNITYSDK_OFFSET(0x9039980)
#define AMQUADLEGIK_GET_ENABLEDEBUGSHOWSKELETON_OFFSET UNITYSDK_OFFSET(0x9039940)
#define AMQUADLEGIK_GET_LASTFRAMETHETA_OFFSET UNITYSDK_OFFSET(0x9039920)
#define AMQUADLEGIK_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x9039A70)
#define AMQUADLEGIK_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x903B480)
#define AMQUADLEGIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9039E20)
#define AMQUADLEGIK_QUADAMLEGIKPASS_OFFSET UNITYSDK_OFFSET(0x9039FA0)
#define AMQUADLEGIK_SET_ENABLEDEBUGHIPHIT_OFFSET UNITYSDK_OFFSET(0x9039970)
#define AMQUADLEGIK_SET_ENABLEDEBUGNOTLOCKFOOT_OFFSET UNITYSDK_OFFSET(0x9039990)
#define AMQUADLEGIK_SET_ENABLEDEBUGSHOWSKELETON_OFFSET UNITYSDK_OFFSET(0x9039950)
#define AMQUADLEGIK_SET_LASTFRAMETHETA_OFFSET UNITYSDK_OFFSET(0x9039930)
#define AMQUADLEGIK_START_OFFSET UNITYSDK_OFFSET(0x90399A0)
#define AMQUADLEGIK_UPDATE_OFFSET UNITYSDK_OFFSET(0x9039EF0)
#define AMQUADLEGIK__CTOR_OFFSET UNITYSDK_OFFSET(0x903B870)

inline static constexpr unsigned int AMQuadLegIK_TypeDefinitionIndex = 79170;
