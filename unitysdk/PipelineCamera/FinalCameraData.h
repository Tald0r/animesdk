...
#define PIPELINECAMERA_FINALCAMERADATA_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x923A30)
#define PIPELINECAMERA_FINALCAMERADATA_CHECKLOCATION_OFFSET UNITYSDK_OFFSET(0x923970)
#define PIPELINECAMERA_FINALCAMERADATA_CHECKROTATION_OFFSET UNITYSDK_OFFSET(0x9239D0)
#define PIPELINECAMERA_FINALCAMERADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A5CA2A0)
#define PIPELINECAMERA_FINALCAMERADATA_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x8FF150)
#define PIPELINECAMERA_FINALCAMERADATA_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x31DD30)
#define PIPELINECAMERA_FINALCAMERADATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x37BFB0)
#define PIPELINECAMERA_FINALCAMERADATA_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x923880)
#define PIPELINECAMERA_FINALCAMERADATA_SETLOCATION_OFFSET UNITYSDK_OFFSET(0x923680)
#define PIPELINECAMERA_FINALCAMERADATA_SETROTATION_OFFSET UNITYSDK_OFFSET(0x923750)

namespace PipelineCamera
{
	inline static constexpr unsigned int FinalCameraData_TypeDefinitionIndex = 34443;
