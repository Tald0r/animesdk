...
#define PIPELINECAMERA_FINALCAMERADATA_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x951A70)
#define PIPELINECAMERA_FINALCAMERADATA_CHECKLOCATION_OFFSET UNITYSDK_OFFSET(0x9519B0)
#define PIPELINECAMERA_FINALCAMERADATA_CHECKROTATION_OFFSET UNITYSDK_OFFSET(0x951A10)
#define PIPELINECAMERA_FINALCAMERADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1AB94070)
#define PIPELINECAMERA_FINALCAMERADATA_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x929B40)
#define PIPELINECAMERA_FINALCAMERADATA_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x2EA460)
#define PIPELINECAMERA_FINALCAMERADATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x35A5F0)
#define PIPELINECAMERA_FINALCAMERADATA_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x9518C0)
#define PIPELINECAMERA_FINALCAMERADATA_SETLOCATION_OFFSET UNITYSDK_OFFSET(0x9516C0)
#define PIPELINECAMERA_FINALCAMERADATA_SETROTATION_OFFSET UNITYSDK_OFFSET(0x951790)

namespace PipelineCamera
{
	inline static constexpr unsigned int FinalCameraData_TypeDefinitionIndex = 35445;
