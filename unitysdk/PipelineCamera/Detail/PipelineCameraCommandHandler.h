...
#define PIPELINECAMERA_DETAIL_PIPELINECAMERACOMMANDHANDLER_PIPELINEVALUETOPIPELINEINDEX_OFFSET UNITYSDK_OFFSET(0x1A736660)
#define PIPELINECAMERA_DETAIL_PIPELINECAMERACOMMANDHANDLER_SENDCAMERACOMMAND_OFFSET UNITYSDK_OFFSET(0x1A736540)
#define PIPELINECAMERA_DETAIL_PIPELINECAMERACOMMANDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A736510)

namespace PipelineCamera::Detail
{
	inline static constexpr unsigned int PipelineCameraCommandHandler_TypeDefinitionIndex = 35883;
