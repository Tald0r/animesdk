...
#define PIPELINECAMERA_DETAIL_EXTERNALVALUECOUNTER_DECREMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x8803B0)
#define PIPELINECAMERA_DETAIL_EXTERNALVALUECOUNTER_GET_COUNTER_OFFSET UNITYSDK_OFFSET(0x8803C0)
#define PIPELINECAMERA_DETAIL_EXTERNALVALUECOUNTER_GET_MASK_OFFSET UNITYSDK_OFFSET(0x880450)
#define PIPELINECAMERA_DETAIL_EXTERNALVALUECOUNTER_INCREMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x8803A0)

namespace PipelineCamera::Detail
{
	inline static constexpr unsigned int ExternalValueCounter_TypeDefinitionIndex = 34880;
