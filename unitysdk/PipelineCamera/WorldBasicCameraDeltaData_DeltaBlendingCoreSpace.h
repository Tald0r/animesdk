...
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGCORESPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x9A0410)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGCORESPACE__INVOKE_G__APPLY_6_0_OFFSET UNITYSDK_OFFSET(0x1B5682A0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGCORESPACE__INVOKE_G__UPDATEASCURRENT_6_1_OFFSET UNITYSDK_OFFSET(0x1B567DC0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGCORESPACE__INVOKE_G__UPDATEASSOURCE_6_2_OFFSET UNITYSDK_OFFSET(0x1B567800)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraDeltaData_DeltaBlendingCoreSpace_TypeDefinitionIndex = 35453;
