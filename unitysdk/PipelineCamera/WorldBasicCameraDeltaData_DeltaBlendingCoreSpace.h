...
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGCORESPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x96D5B0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGCORESPACE__INVOKE_G__APPLY_6_0_OFFSET UNITYSDK_OFFSET(0x1AF41EC0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGCORESPACE__INVOKE_G__UPDATEASCURRENT_6_1_OFFSET UNITYSDK_OFFSET(0x1AF419E0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGCORESPACE__INVOKE_G__UPDATEASSOURCE_6_2_OFFSET UNITYSDK_OFFSET(0x1AF41420)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraDeltaData_DeltaBlendingCoreSpace_TypeDefinitionIndex = 34451;
