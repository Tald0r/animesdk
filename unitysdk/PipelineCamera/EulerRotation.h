...
#define PIPELINECAMERA_EULERROTATION_CREATE_OFFSET UNITYSDK_OFFSET(0x1A44BC90)
#define PIPELINECAMERA_EULERROTATION_GET_MAXPITCH_OFFSET UNITYSDK_OFFSET(0x2C4B30)
#define PIPELINECAMERA_EULERROTATION_GET_MINPITCH_OFFSET UNITYSDK_OFFSET(0x2C4B10)
#define PIPELINECAMERA_EULERROTATION_GET_PITCH_OFFSET UNITYSDK_OFFSET(0x2C4AF0)
#define PIPELINECAMERA_EULERROTATION_GET_ROLL_OFFSET UNITYSDK_OFFSET(0x2FD5D0)
#define PIPELINECAMERA_EULERROTATION_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x9137D0)
#define PIPELINECAMERA_EULERROTATION_GET_YAW_OFFSET UNITYSDK_OFFSET(0x308880)
#define PIPELINECAMERA_EULERROTATION_SET_PITCH_OFFSET UNITYSDK_OFFSET(0x9137A0)
#define PIPELINECAMERA_EULERROTATION_SET_ROLL_OFFSET UNITYSDK_OFFSET(0x9137C0)
#define PIPELINECAMERA_EULERROTATION_SET_YAW_OFFSET UNITYSDK_OFFSET(0x9137B0)

namespace PipelineCamera
{
	inline static constexpr unsigned int EulerRotation_TypeDefinitionIndex = 34516;
