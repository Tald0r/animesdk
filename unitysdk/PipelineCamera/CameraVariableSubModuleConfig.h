...
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG_GET_ACTIVECHANNEL_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG_GET_PROCESSCHANNELMASK_OFFSET UNITYSDK_OFFSET(0x2D38E0)
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x87D830)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraVariableSubModuleConfig_TypeDefinitionIndex = 34385;
