...
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG_GET_ACTIVECHANNEL_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x2EC6E0)
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG_GET_PROCESSCHANNELMASK_OFFSET UNITYSDK_OFFSET(0x302230)
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8B1950)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraVariableSubModuleConfig_TypeDefinitionIndex = 35387;
