...
#define PIPELINECAMERA_SERIALIZABLETYPECLASS_GETTYPECLASS_OFFSET UNITYSDK_OFFSET(0x1A39D920)
#define PIPELINECAMERA_SERIALIZABLETYPECLASS_SETTYPECLASS_OFFSET UNITYSDK_OFFSET(0x1A39D9D0)
#define PIPELINECAMERA_SERIALIZABLETYPECLASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A39DA70)

namespace PipelineCamera
{
	inline static constexpr unsigned int SerializableTypeClass_TypeDefinitionIndex = 34550;
