...
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_GENERATEINITIALVALUE_OFFSET UNITYSDK_OFFSET(0x913A30)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_GENERATERELAXOFFSET_OFFSET UNITYSDK_OFFSET(0x913920)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_GET_STIFFNESS_OFFSET UNITYSDK_OFFSET(0x9138A0)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_PIPELINECAMERA_IVELOCITYBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x913AE0)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x913910)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x2C4B00)

namespace PipelineCamera
{
	inline static constexpr unsigned int PhysicalCriticalSpringDamper_TypeDefinitionIndex = 34503;
