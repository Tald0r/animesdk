...
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_GENERATEINITIALVALUE_OFFSET UNITYSDK_OFFSET(0x941C20)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_GENERATERELAXOFFSET_OFFSET UNITYSDK_OFFSET(0x941B10)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_GET_STIFFNESS_OFFSET UNITYSDK_OFFSET(0x941A90)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_PIPELINECAMERA_IVELOCITYBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x941CD0)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x941B00)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x2F60B0)

namespace PipelineCamera
{
	inline static constexpr unsigned int PhysicalCriticalSpringDamper_TypeDefinitionIndex = 35505;
