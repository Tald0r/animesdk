...
#define PIPELINECAMERA_CAMERACOMMANDSPAWNSUBMODULES_ADD_OFFSET UNITYSDK_OFFSET(0x1AF3E9A0)
#define PIPELINECAMERA_CAMERACOMMANDSPAWNSUBMODULES_PIPELINECAMERA_ICAMERACOMMAND_GET_COMMANDTYPE_OFFSET UNITYSDK_OFFSET(0x1AF3E7D0)
#define PIPELINECAMERA_CAMERACOMMANDSPAWNSUBMODULES_PIPELINECAMERA_ICAMERACOMMAND_GET_PIPELINE_OFFSET UNITYSDK_OFFSET(0x1AF3E830)
#define PIPELINECAMERA_CAMERACOMMANDSPAWNSUBMODULES__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF3E890)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraCommandSpawnSubModules_TypeDefinitionIndex = 34323;
