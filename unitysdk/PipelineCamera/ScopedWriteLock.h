...
#define PIPELINECAMERA_SCOPEDWRITELOCK_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9451B0)
#define PIPELINECAMERA_SCOPEDWRITELOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x9450E0)

namespace PipelineCamera
{
	inline static constexpr unsigned int ScopedWriteLock_TypeDefinitionIndex = 34541;
