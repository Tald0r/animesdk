...
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AB93AB0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_VECTOR2__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AB93BF0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_VECTOR2__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AB93B60)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AB93C70)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AB93BC0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AB93B70)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AB93AA0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB93A80)

namespace PipelineCamera
{
	inline static constexpr unsigned int Extension___GetEllipseDirections_g__GenerateList_8_1_d_TypeDefinitionIndex = 35424;

	class Extension___GetEllipseDirections_g__GenerateList_8_1_d : public ::System::Object
	{
	public:
		::System::Single _current_5__3; // 0x10
		::System::Int32 _i_5__4; // 0x14
		::System::Int32 __l__initialThreadId; // 0x18
		::System::Single _step_5__2; // 0x1C
		::System::Int32 segment; // 0x20
