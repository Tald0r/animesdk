...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EASEINOUT_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x905650)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EASEINOUT_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x905640)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EASEINOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x2C4B00)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int EaseInOut_TypeDefinitionIndex = 34560;
