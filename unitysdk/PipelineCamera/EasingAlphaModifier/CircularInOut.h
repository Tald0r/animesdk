...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARINOUT_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x98C260)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARINOUT_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x98C250)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int CircularInOut_TypeDefinitionIndex = 35568;
