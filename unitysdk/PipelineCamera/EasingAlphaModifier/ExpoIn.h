...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOIN_DODERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1AE7BED0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOIN_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x1AE7BE30)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOIN_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x974AA0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOIN_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9749A0)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int ExpoIn_TypeDefinitionIndex = 35563;
