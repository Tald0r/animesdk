...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_STEP_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x905900)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_STEP_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x905850)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_STEP__CTOR_OFFSET UNITYSDK_OFFSET(0x9059B0)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int Step_TypeDefinitionIndex = 34554;
