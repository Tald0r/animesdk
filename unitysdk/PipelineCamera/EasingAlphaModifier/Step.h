...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_STEP_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x930D60)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_STEP_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x930CB0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_STEP__CTOR_OFFSET UNITYSDK_OFFSET(0x930E10)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int Step_TypeDefinitionIndex = 35556;
