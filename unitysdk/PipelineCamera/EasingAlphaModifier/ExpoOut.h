...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOOUT_DODERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1A95FBE0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOOUT_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x1A95FB20)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOOUT_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x93DCC0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOOUT_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x93DBA0)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int ExpoOut_TypeDefinitionIndex = 35564;
