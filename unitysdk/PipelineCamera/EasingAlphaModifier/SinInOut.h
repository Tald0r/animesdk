...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_SININOUT_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x9516B0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_SININOUT_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9516A0)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int SinInOut_TypeDefinitionIndex = 35559;
