...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARIN_DODERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1A736770)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARIN_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x1A7366D0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARIN_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x9377F0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARIN_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9376F0)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int CircularIn_TypeDefinitionIndex = 35566;
