...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARIN_DODERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1A1A88B0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARIN_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x1A1A8810)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARIN_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x90BB30)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARIN_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x90BA30)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int CircularIn_TypeDefinitionIndex = 34564;
