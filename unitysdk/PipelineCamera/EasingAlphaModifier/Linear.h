...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_LINEAR_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x968580)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_LINEAR_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x968620)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int Linear_TypeDefinitionIndex = 35555;
