...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_SININ_DODERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1A619A60)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_SININ_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x1A6199D0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_SININ_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x930BB0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_SININ_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x930AC0)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int SinIn_TypeDefinitionIndex = 35557;
