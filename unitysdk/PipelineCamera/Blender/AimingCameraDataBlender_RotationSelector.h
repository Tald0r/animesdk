...
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR_COMPARE_OFFSET UNITYSDK_OFFSET(0x913530)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR_GET_MAXPITCH_OFFSET UNITYSDK_OFFSET(0x319420)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR_GET_MINPITCH_OFFSET UNITYSDK_OFFSET(0x319410)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x319320)

namespace PipelineCamera::Blender
{
	inline static constexpr unsigned int AimingCameraDataBlender_RotationSelector_TypeDefinitionIndex = 34833;
