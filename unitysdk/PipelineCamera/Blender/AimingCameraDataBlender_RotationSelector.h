...
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR_COMPARE_OFFSET UNITYSDK_OFFSET(0x941720)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR_GET_MAXPITCH_OFFSET UNITYSDK_OFFSET(0x388C40)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR_GET_MINPITCH_OFFSET UNITYSDK_OFFSET(0x388C30)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x388B40)

namespace PipelineCamera::Blender
{
	inline static constexpr unsigned int AimingCameraDataBlender_RotationSelector_TypeDefinitionIndex = 35835;
