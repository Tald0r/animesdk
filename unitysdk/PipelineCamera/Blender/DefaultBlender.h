...
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_ANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1A644FA0)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_EASING_OFFSET UNITYSDK_OFFSET(0x1A644C60)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_GETDEBUGNAME_OFFSET UNITYSDK_OFFSET(0x1A644C00)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_GETREVERSEKEY_OFFSET UNITYSDK_OFFSET(0x1A642890)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_INTERPCURVE_OFFSET UNITYSDK_OFFSET(0x1A644DF0)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1A642830)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A642610)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_COLLECT_OFFSET UNITYSDK_OFFSET(0x1A642A40)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A6427C0)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A642AB0)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A644A20)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_TOUCH_OFFSET UNITYSDK_OFFSET(0x1A644B10)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_REVERSED_OFFSET UNITYSDK_OFFSET(0x1A6428F0)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A642A30)

namespace PipelineCamera::Blender
{
	inline static constexpr unsigned int DefaultBlender_TypeDefinitionIndex = 35840;
	...
	public:
		...
		::System::Nullable_1<::System::Int32> _reverseKey; // 0x24
		::PipelineCamera::WorldBasicCameraDataDeltaFlag _deltaFlag; // 0x2C
		::System::Nullable_1<::PipelineCamera::WorldBasicCameraDeltaData> _deltaCameraData; // 0x30
		::Foundation::Unreal::FName _debugName; // 0x6C
		::PipelineCamera::WorldBasicCameraData _lastCameraData; // 0x74
