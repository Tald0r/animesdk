...
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x19D04790)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_DAMPINGROTATION_OFFSET UNITYSDK_OFFSET(0x19D027E0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_DAMP_1_OFFSET UNITYSDK_OFFSET(0x19D02120)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_DAMP_OFFSET UNITYSDK_OFFSET(0x19D02030)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_EASING_OFFSET UNITYSDK_OFFSET(0x19D04430)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_INTERPCURVE_OFFSET UNITYSDK_OFFSET(0x19D045D0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x19D032B0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_COLLECT_OFFSET UNITYSDK_OFFSET(0x19D034D0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x19D03460)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_EVALUATE_OFFSET UNITYSDK_OFFSET(0x19D038D0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_FLUSH_OFFSET UNITYSDK_OFFSET(0x19D036A0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_TOUCH_OFFSET UNITYSDK_OFFSET(0x19D037E0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDER_GETDEBUGNAME_OFFSET UNITYSDK_OFFSET(0x19D03240)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDER_GETREVERSEKEY_OFFSET UNITYSDK_OFFSET(0x19D03170)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDER_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x19D03100)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDER_REVERSED_OFFSET UNITYSDK_OFFSET(0x19D031D0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETAIMINGENABLED_OFFSET UNITYSDK_OFFSET(0x19D02DC0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETAIMINGTARGETSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x19D02E50)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETAIMINGTARGET_OFFSET UNITYSDK_OFFSET(0x19D02D30)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETDAMPINGVALUE_OFFSET UNITYSDK_OFFSET(0x19D02ED0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETFIXEDASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x19D02F50)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETPITCHCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x19D03060)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETPOSTEVALUATE_OFFSET UNITYSDK_OFFSET(0x19D02FF0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D04400)

namespace PipelineCamera::Blender
{
	inline static constexpr unsigned int AimingCameraDataBlender_TypeDefinitionIndex = 34832;
	...
	public:
		...
		::System::Action_2<::System::Single, ::PipelineCamera::WorldBasicCameraData>* _postEvaluate; // 0x50
		::PipelineCamera::TimeBasedAlphaGenerator* _alphaGenerator; // 0x58
		::System::Single _maxPitch; // 0x60
		::System::Single _deltaTime; // 0x64
		::UnityEngine::Vector2 _aimingTargetScreenOffset; // 0x68
		::System::Nullable_1<::UnityEngine::Vector3> _aimingTargetValue; // 0x70
		::Foundation::Unreal::FName _debugName; // 0x80
		::System::Boolean _isAimingAllowedValue; // 0x88
		::System::Boolean _isFinished; // 0x89
		::System::Nullable_1<::PipelineCamera::WorldBasicCameraDeltaData> _deltaCameraData; // 0x8C
		::PipelineCamera::WorldBasicCameraData _lastCameraData; // 0xC8
		::System::Single _rotationDampingValue; // 0xF4
		::System::Single _minPitch; // 0xF8
		::System::Nullable_1<::System::Single> _fixedAspectRatio; // 0xFC
		::PipelineCamera::WorldBasicCameraDataDeltaFlag _deltaFlag; // 0x104
		::System::Single _timestamp; // 0x108
