...
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1A30A8F0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_DAMPINGROTATION_OFFSET UNITYSDK_OFFSET(0x1A308910)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_DAMP_1_OFFSET UNITYSDK_OFFSET(0x1A308250)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_DAMP_OFFSET UNITYSDK_OFFSET(0x1A308160)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_EASING_OFFSET UNITYSDK_OFFSET(0x1A30A590)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_INTERPCURVE_OFFSET UNITYSDK_OFFSET(0x1A30A730)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A3093E0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_COLLECT_OFFSET UNITYSDK_OFFSET(0x1A309610)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A3095A0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A309A20)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A3097F0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_TOUCH_OFFSET UNITYSDK_OFFSET(0x1A309930)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDER_GETDEBUGNAME_OFFSET UNITYSDK_OFFSET(0x1A309370)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDER_GETREVERSEKEY_OFFSET UNITYSDK_OFFSET(0x1A3092A0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDER_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1A309230)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_PIPELINECAMERA_ICAMERADATABLENDER_REVERSED_OFFSET UNITYSDK_OFFSET(0x1A309300)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETAIMINGENABLED_OFFSET UNITYSDK_OFFSET(0x1A308EF0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETAIMINGTARGETSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x1A308F80)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETAIMINGTARGET_OFFSET UNITYSDK_OFFSET(0x1A308E60)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETDAMPINGVALUE_OFFSET UNITYSDK_OFFSET(0x1A309000)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETFIXEDASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x1A309080)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETPITCHCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1A309190)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_SETPOSTEVALUATE_OFFSET UNITYSDK_OFFSET(0x1A309120)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A30A560)

namespace PipelineCamera::Blender
{
	inline static constexpr unsigned int AimingCameraDataBlender_TypeDefinitionIndex = 35834;
	...
	public:
		...
		::System::Action_2<::System::Single, ::PipelineCamera::WorldBasicCameraData>* _postEvaluate; // 0x38
		::Foundation::Variable_1<::UnityEngine::Vector3> _aimingTarget; // 0x40
		::UnityEngine::Vector2 _aimingTargetScreenOffset; // 0x60
		::PipelineCamera::WorldBasicCameraData _lastCameraData; // 0x68
		::PipelineCamera::WorldBasicCameraDataDeltaFlag _deltaFlag; // 0x94
		::System::Nullable_1<::System::Single> _fixedAspectRatio; // 0x98
		::System::Single _deltaTime; // 0xA0
		::System::Nullable_1<::UnityEngine::Vector3> _aimingTargetValue; // 0xA4
		::System::Single _minPitch; // 0xB4
		::System::Single _timestamp; // 0xB8
		::System::Nullable_1<::PipelineCamera::WorldBasicCameraDeltaData> _deltaCameraData; // 0xBC
		::System::Single _rotationDampingValue; // 0xF8
		::Foundation::Unreal::FName _debugName; // 0xFC
		::System::Boolean _isFinished; // 0x104
		::System::Boolean _isAimingAllowedValue; // 0x105
		::System::Single _maxPitch; // 0x108
