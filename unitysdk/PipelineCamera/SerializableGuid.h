...
#define PIPELINECAMERA_SERIALIZABLEGUID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x951BC0)
#define PIPELINECAMERA_SERIALIZABLEGUID_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x8CC5E0)
#define PIPELINECAMERA_SERIALIZABLEGUID_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x951C40)
#define PIPELINECAMERA_SERIALIZABLEGUID_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1AB94810)
#define PIPELINECAMERA_SERIALIZABLEGUID_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AB947A0)
#define PIPELINECAMERA_SERIALIZABLEGUID_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x951B30)
#define PIPELINECAMERA_SERIALIZABLEGUID_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x951AD0)
#define PIPELINECAMERA_SERIALIZABLEGUID___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x951D30)

namespace PipelineCamera
{
	inline static constexpr unsigned int SerializableGuid_TypeDefinitionIndex = 35544;
