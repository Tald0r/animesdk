...
#define PIPELINECAMERA_SERIALIZABLEGUID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x923B80)
#define PIPELINECAMERA_SERIALIZABLEGUID_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x8A1540)
#define PIPELINECAMERA_SERIALIZABLEGUID_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x923C00)
#define PIPELINECAMERA_SERIALIZABLEGUID_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A5CAA40)
#define PIPELINECAMERA_SERIALIZABLEGUID_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A5CA9D0)
#define PIPELINECAMERA_SERIALIZABLEGUID_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x923AF0)
#define PIPELINECAMERA_SERIALIZABLEGUID_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x923A90)
#define PIPELINECAMERA_SERIALIZABLEGUID___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x923CF0)

namespace PipelineCamera
{
	inline static constexpr unsigned int SerializableGuid_TypeDefinitionIndex = 34542;
