...
#define PIPELINECAMERA_METHOD_ADVANCETIME_OFFSET UNITYSDK_OFFSET(0x197C8CB0)
#define PIPELINECAMERA_METHOD_AVERAGE_1_OFFSET UNITYSDK_OFFSET(0x197C9500)
#define PIPELINECAMERA_METHOD_AVERAGE_OFFSET UNITYSDK_OFFSET(0x197C9490)
#define PIPELINECAMERA_METHOD_CALCULATECOSANGLE_OFFSET UNITYSDK_OFFSET(0x197CABC0)
#define PIPELINECAMERA_METHOD_CLAMPRELATIVEANGLEXZ_OFFSET UNITYSDK_OFFSET(0x197C4D00)
#define PIPELINECAMERA_METHOD_DOWNWARDALIGNMENT_1_OFFSET UNITYSDK_OFFSET(0x197C9330)
#define PIPELINECAMERA_METHOD_DOWNWARDALIGNMENT_OFFSET UNITYSDK_OFFSET(0x197C92C0)
#define PIPELINECAMERA_METHOD_EULERDISTANCE_OFFSET UNITYSDK_OFFSET(0x197C39F0)
#define PIPELINECAMERA_METHOD_FASTATAN_OFFSET UNITYSDK_OFFSET(0x197C91D0)
#define PIPELINECAMERA_METHOD_FASTNEGEXP_OFFSET UNITYSDK_OFFSET(0x197C9130)
#define PIPELINECAMERA_METHOD_GETDESIREDRADIUSBYENTITYSHAPE_OFFSET UNITYSDK_OFFSET(0x197C51C0)
#define PIPELINECAMERA_METHOD_GETNEXTLARGESTPOWERTWO_OFFSET UNITYSDK_OFFSET(0x197C9620)
#define PIPELINECAMERA_METHOD_GETNUMBITSET_OFFSET UNITYSDK_OFFSET(0x197C96A0)
#define PIPELINECAMERA_METHOD_HALFFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x197C4440)
#define PIPELINECAMERA_METHOD_INTERPCONSTANTTO_1_OFFSET UNITYSDK_OFFSET(0x197CA950)
#define PIPELINECAMERA_METHOD_INTERPCONSTANTTO_2_OFFSET UNITYSDK_OFFSET(0x197CB030)
#define PIPELINECAMERA_METHOD_INTERPCONSTANTTO_3_OFFSET UNITYSDK_OFFSET(0x197CB380)
#define PIPELINECAMERA_METHOD_INTERPCONSTANTTO_OFFSET UNITYSDK_OFFSET(0x197C9AF0)
#define PIPELINECAMERA_METHOD_INTERPTO_1_OFFSET UNITYSDK_OFFSET(0x197CA730)
#define PIPELINECAMERA_METHOD_INTERPTO_2_OFFSET UNITYSDK_OFFSET(0x197CAEE0)
#define PIPELINECAMERA_METHOD_INTERPTO_3_OFFSET UNITYSDK_OFFSET(0x197CB270)
#define PIPELINECAMERA_METHOD_INTERPTO_OFFSET UNITYSDK_OFFSET(0x197C9A00)
#define PIPELINECAMERA_METHOD_INTERSECTIONOFANGLE_OFFSET UNITYSDK_OFFSET(0x197C5290)
#define PIPELINECAMERA_METHOD_INTERSECTIONOFPERIODIC_OFFSET UNITYSDK_OFFSET(0x197C7150)
#define PIPELINECAMERA_METHOD_INTERSECTIONOFRADIAN_OFFSET UNITYSDK_OFFSET(0x197C6FA0)
#define PIPELINECAMERA_METHOD_LERPPERCHANNEL_OFFSET UNITYSDK_OFFSET(0x197CADE0)
#define PIPELINECAMERA_METHOD_MINMAX_1_OFFSET UNITYSDK_OFFSET(0x197CA2C0)
#define PIPELINECAMERA_METHOD_MINMAX_OFFSET UNITYSDK_OFFSET(0x197CA220)
#define PIPELINECAMERA_METHOD_OFFSETTOSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x197C49D0)
#define PIPELINECAMERA_METHOD_OFFSETTOUNIFORMSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x197C4B70)
#define PIPELINECAMERA_METHOD_PRINT_OFFSET UNITYSDK_OFFSET(0x197C3C40)
#define PIPELINECAMERA_METHOD_RELATIVEALPHA_OFFSET UNITYSDK_OFFSET(0x197C9760)
#define PIPELINECAMERA_METHOD_REVERSE_OFFSET UNITYSDK_OFFSET(0x197C9580)
#define PIPELINECAMERA_METHOD_SAMPLECIRCLE_OFFSET UNITYSDK_OFFSET(0x197C4EE0)
#define PIPELINECAMERA_METHOD_SAMPLEDEFAULTRESOLVERCURVE_OFFSET UNITYSDK_OFFSET(0x197C4F90)
#define PIPELINECAMERA_METHOD_SCREENALIGNEDOFFSET_OFFSET UNITYSDK_OFFSET(0x197C3F60)
#define PIPELINECAMERA_METHOD_SCREENOFFSETTOOFFSET_OFFSET UNITYSDK_OFFSET(0x197C4590)
#define PIPELINECAMERA_METHOD_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x197C4270)
#define PIPELINECAMERA_METHOD_SINCOSDEGREE_OFFSET UNITYSDK_OFFSET(0x197C9960)
#define PIPELINECAMERA_METHOD_SINCOS_OFFSET UNITYSDK_OFFSET(0x197C98C0)
#define PIPELINECAMERA_METHOD_SINRANGE_OFFSET UNITYSDK_OFFSET(0x197CA3F0)
#define PIPELINECAMERA_METHOD_SOLVEQUADRATICEQUATION_OFFSET UNITYSDK_OFFSET(0x197C3DA0)
#define PIPELINECAMERA_METHOD_SQRTSQUARESUM_1_OFFSET UNITYSDK_OFFSET(0x197C9F20)
#define PIPELINECAMERA_METHOD_SQRTSQUARESUM_2_OFFSET UNITYSDK_OFFSET(0x197CA090)
#define PIPELINECAMERA_METHOD_SQRTSQUARESUM_OFFSET UNITYSDK_OFFSET(0x197C9DE0)
#define PIPELINECAMERA_METHOD_SQUARESUM_1_OFFSET UNITYSDK_OFFSET(0x197C9C70)
#define PIPELINECAMERA_METHOD_SQUARESUM_2_OFFSET UNITYSDK_OFFSET(0x197C9D20)
#define PIPELINECAMERA_METHOD_SQUARESUM_OFFSET UNITYSDK_OFFSET(0x197C9BE0)
#define PIPELINECAMERA_METHOD_TANGENTHALFFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x197C4390)
#define PIPELINECAMERA_METHOD_TOLOOPINTERVAL_OFFSET UNITYSDK_OFFSET(0x197C8E40)
#define PIPELINECAMERA_METHOD_UNIFORMSCREENOFFSETTOOFFSET_OFFSET UNITYSDK_OFFSET(0x197C4700)
#define PIPELINECAMERA_METHOD_UNIFORMSCREENOFFSETTOSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x197C4820)
#define PIPELINECAMERA_METHOD_UPWARDALIGNMENT_1_OFFSET UNITYSDK_OFFSET(0x197C9410)
#define PIPELINECAMERA_METHOD_UPWARDALIGNMENT_OFFSET UNITYSDK_OFFSET(0x197C93A0)
#define PIPELINECAMERA_METHOD__CCTOR_OFFSET UNITYSDK_OFFSET(0x197CB5A0)
#define PIPELINECAMERA_METHOD__SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_OFFSET UNITYSDK_OFFSET(0x197CB660)

namespace PipelineCamera
{
	inline static constexpr unsigned int Method_TypeDefinitionIndex = 35335;
	...
	public:
		...
		{
			return (::System::Action_5<::PipelineCamera::Method_CameraLogCategory, ::System::Boolean, ::System::String*, ::UnityEngine::Color, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x26390);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_ValidCircleSegments()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x26398);
		}
		static ::Il2CppArray<::System::ValueTuple_2<::System::Single, ::System::Single>>** StaticGet__sinCosIntegralAngle()
		{
			return (::Il2CppArray<::System::ValueTuple_2<::System::Single, ::System::Single>>**)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x263A0);
		}
		static ::System::Int32* StaticGet_SizeOfInt64()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x84A0);
		}
		static ::System::Int32* StaticGet_SizeofChar()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x84A4);
		}
		static ::System::Double* StaticGet_Log2D()
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x84A8);
		}
		static ::System::Single* StaticGet_Log2F()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x84B0);
		}
		static ::System::Int32* StaticGet_SizeOfInt32()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x84B4);
		}
