...
#define PIPELINECAMERA_METHOD_ADVANCETIME_OFFSET UNITYSDK_OFFSET(0x19315B50)
#define PIPELINECAMERA_METHOD_AVERAGE_1_OFFSET UNITYSDK_OFFSET(0x193163A0)
#define PIPELINECAMERA_METHOD_AVERAGE_OFFSET UNITYSDK_OFFSET(0x19316330)
#define PIPELINECAMERA_METHOD_CALCULATECOSANGLE_OFFSET UNITYSDK_OFFSET(0x19317A60)
#define PIPELINECAMERA_METHOD_CLAMPRELATIVEANGLEXZ_OFFSET UNITYSDK_OFFSET(0x19311B90)
#define PIPELINECAMERA_METHOD_DOWNWARDALIGNMENT_1_OFFSET UNITYSDK_OFFSET(0x193161D0)
#define PIPELINECAMERA_METHOD_DOWNWARDALIGNMENT_OFFSET UNITYSDK_OFFSET(0x19316160)
#define PIPELINECAMERA_METHOD_EULERDISTANCE_OFFSET UNITYSDK_OFFSET(0x19310890)
#define PIPELINECAMERA_METHOD_FASTATAN_OFFSET UNITYSDK_OFFSET(0x19316070)
#define PIPELINECAMERA_METHOD_FASTNEGEXP_OFFSET UNITYSDK_OFFSET(0x19315FD0)
#define PIPELINECAMERA_METHOD_GETDESIREDRADIUSBYENTITYSHAPE_OFFSET UNITYSDK_OFFSET(0x19312060)
#define PIPELINECAMERA_METHOD_GETNEXTLARGESTPOWERTWO_OFFSET UNITYSDK_OFFSET(0x193164C0)
#define PIPELINECAMERA_METHOD_GETNUMBITSET_OFFSET UNITYSDK_OFFSET(0x19316540)
#define PIPELINECAMERA_METHOD_HALFFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x193112E0)
#define PIPELINECAMERA_METHOD_INTERPCONSTANTTO_1_OFFSET UNITYSDK_OFFSET(0x193177F0)
#define PIPELINECAMERA_METHOD_INTERPCONSTANTTO_2_OFFSET UNITYSDK_OFFSET(0x19317ED0)
#define PIPELINECAMERA_METHOD_INTERPCONSTANTTO_3_OFFSET UNITYSDK_OFFSET(0x19318220)
#define PIPELINECAMERA_METHOD_INTERPCONSTANTTO_OFFSET UNITYSDK_OFFSET(0x19316990)
#define PIPELINECAMERA_METHOD_INTERPTO_1_OFFSET UNITYSDK_OFFSET(0x193175D0)
#define PIPELINECAMERA_METHOD_INTERPTO_2_OFFSET UNITYSDK_OFFSET(0x19317D80)
#define PIPELINECAMERA_METHOD_INTERPTO_3_OFFSET UNITYSDK_OFFSET(0x19318110)
#define PIPELINECAMERA_METHOD_INTERPTO_OFFSET UNITYSDK_OFFSET(0x193168A0)
#define PIPELINECAMERA_METHOD_INTERSECTIONOFANGLE_OFFSET UNITYSDK_OFFSET(0x19312130)
#define PIPELINECAMERA_METHOD_INTERSECTIONOFPERIODIC_OFFSET UNITYSDK_OFFSET(0x19313FF0)
#define PIPELINECAMERA_METHOD_INTERSECTIONOFRADIAN_OFFSET UNITYSDK_OFFSET(0x19313E40)
#define PIPELINECAMERA_METHOD_LERPPERCHANNEL_OFFSET UNITYSDK_OFFSET(0x19317C80)
#define PIPELINECAMERA_METHOD_MINMAX_1_OFFSET UNITYSDK_OFFSET(0x19317160)
#define PIPELINECAMERA_METHOD_MINMAX_OFFSET UNITYSDK_OFFSET(0x193170C0)
#define PIPELINECAMERA_METHOD_OFFSETTOSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x19311870)
#define PIPELINECAMERA_METHOD_OFFSETTOUNIFORMSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x19311A10)
#define PIPELINECAMERA_METHOD_PRINT_OFFSET UNITYSDK_OFFSET(0x19310AE0)
#define PIPELINECAMERA_METHOD_RELATIVEALPHA_OFFSET UNITYSDK_OFFSET(0x19316600)
#define PIPELINECAMERA_METHOD_REVERSE_OFFSET UNITYSDK_OFFSET(0x19316420)
#define PIPELINECAMERA_METHOD_SAMPLECIRCLE_OFFSET UNITYSDK_OFFSET(0x19311D70)
#define PIPELINECAMERA_METHOD_SAMPLEDEFAULTRESOLVERCURVE_OFFSET UNITYSDK_OFFSET(0x19311E20)
#define PIPELINECAMERA_METHOD_SCREENALIGNEDOFFSET_OFFSET UNITYSDK_OFFSET(0x19310E00)
#define PIPELINECAMERA_METHOD_SCREENOFFSETTOOFFSET_OFFSET UNITYSDK_OFFSET(0x19311430)
#define PIPELINECAMERA_METHOD_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x19311110)
#define PIPELINECAMERA_METHOD_SINCOSDEGREE_OFFSET UNITYSDK_OFFSET(0x19316800)
#define PIPELINECAMERA_METHOD_SINCOS_OFFSET UNITYSDK_OFFSET(0x19316760)
#define PIPELINECAMERA_METHOD_SINRANGE_OFFSET UNITYSDK_OFFSET(0x19317290)
#define PIPELINECAMERA_METHOD_SOLVEQUADRATICEQUATION_OFFSET UNITYSDK_OFFSET(0x19310C40)
#define PIPELINECAMERA_METHOD_SQRTSQUARESUM_1_OFFSET UNITYSDK_OFFSET(0x19316DC0)
#define PIPELINECAMERA_METHOD_SQRTSQUARESUM_2_OFFSET UNITYSDK_OFFSET(0x19316F30)
#define PIPELINECAMERA_METHOD_SQRTSQUARESUM_OFFSET UNITYSDK_OFFSET(0x19316C80)
#define PIPELINECAMERA_METHOD_SQUARESUM_1_OFFSET UNITYSDK_OFFSET(0x19316B10)
#define PIPELINECAMERA_METHOD_SQUARESUM_2_OFFSET UNITYSDK_OFFSET(0x19316BC0)
#define PIPELINECAMERA_METHOD_SQUARESUM_OFFSET UNITYSDK_OFFSET(0x19316A80)
#define PIPELINECAMERA_METHOD_TANGENTHALFFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x19311230)
#define PIPELINECAMERA_METHOD_TOLOOPINTERVAL_OFFSET UNITYSDK_OFFSET(0x19315CE0)
#define PIPELINECAMERA_METHOD_UNIFORMSCREENOFFSETTOOFFSET_OFFSET UNITYSDK_OFFSET(0x193115A0)
#define PIPELINECAMERA_METHOD_UNIFORMSCREENOFFSETTOSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x193116C0)
#define PIPELINECAMERA_METHOD_UPWARDALIGNMENT_1_OFFSET UNITYSDK_OFFSET(0x193162B0)
#define PIPELINECAMERA_METHOD_UPWARDALIGNMENT_OFFSET UNITYSDK_OFFSET(0x19316240)
#define PIPELINECAMERA_METHOD__CCTOR_OFFSET UNITYSDK_OFFSET(0x19318440)
#define PIPELINECAMERA_METHOD__SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_OFFSET UNITYSDK_OFFSET(0x19318500)

namespace PipelineCamera
{
	inline static constexpr unsigned int Method_TypeDefinitionIndex = 34333;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::ValueTuple_2<::System::Single, ::System::Single>>**)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x24960);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_ValidCircleSegments()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x24968);
		}
		...
		{
			return (::System::Action_5<::PipelineCamera::Method_CameraLogCategory, ::System::Boolean, ::System::String*, ::UnityEngine::Color, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x24970);
		}
		static ::System::Int32* StaticGet_SizeofChar()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x8140);
		}
		static ::System::Int32* StaticGet_SizeOfInt64()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x8144);
		}
		static ::System::Double* StaticGet_Log2D()
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x8148);
		}
		static ::System::Single* StaticGet_Log2F()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x8150);
		}
		static ::System::Int32* StaticGet_SizeOfInt32()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x8154);
		}
