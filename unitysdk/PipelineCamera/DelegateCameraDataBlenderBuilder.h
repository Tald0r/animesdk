...
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_GET_CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1930C890)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_GET_ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1930C8A0)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1930C8B0)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_PIPELINECAMERA_ICAMERADATABLENDERBUILDER_CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1930C8D0)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_PIPELINECAMERA_ICAMERADATABLENDERBUILDER_GET_BLENDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1930CA30)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_PIPELINECAMERA_ICAMERADATABLENDERBUILDER_ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1930C980)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1930C8C0)

namespace PipelineCamera
{
	inline static constexpr unsigned int DelegateCameraDataBlenderBuilder_TypeDefinitionIndex = 34424;
