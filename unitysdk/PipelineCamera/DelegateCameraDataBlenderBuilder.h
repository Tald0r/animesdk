...
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_GET_CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x197BF9F0)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_GET_ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x197BFA00)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x197BFA10)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_PIPELINECAMERA_ICAMERADATABLENDERBUILDER_CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x197BFA30)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_PIPELINECAMERA_ICAMERADATABLENDERBUILDER_GET_BLENDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x197BFB90)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_PIPELINECAMERA_ICAMERADATABLENDERBUILDER_ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x197BFAE0)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x197BFA20)

namespace PipelineCamera
{
	inline static constexpr unsigned int DelegateCameraDataBlenderBuilder_TypeDefinitionIndex = 35426;
