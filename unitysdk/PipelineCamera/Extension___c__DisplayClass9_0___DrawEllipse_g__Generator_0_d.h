...
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AB04920)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_VECTOR2__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AB04C10)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_VECTOR2__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AB04B80)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AB04C90)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AB04BE0)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AB04B90)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AB04910)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB048F0)

namespace PipelineCamera
{
	inline static constexpr unsigned int Extension___c__DisplayClass9_0___DrawEllipse_g__Generator_0_d_TypeDefinitionIndex = 34418;
