...
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB93CF0)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0__DRAWELLIPSE_G__GENERATOR_0_OFFSET UNITYSDK_OFFSET(0x1AB93D00)

namespace PipelineCamera
{
	inline static constexpr unsigned int Extension___c__DisplayClass9_0_TypeDefinitionIndex = 35419;
