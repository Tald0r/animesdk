...
#define PIPELINECAMERA_CRITICALSPRINGDAMPER_GET_STIFFNESS_OFFSET UNITYSDK_OFFSET(0x8F3CE0)
#define PIPELINECAMERA_CRITICALSPRINGDAMPER_PIPELINECAMERA_IVELOCITYBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x8F3D60)
#define PIPELINECAMERA_CRITICALSPRINGDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x8F3D50)
#define PIPELINECAMERA_CRITICALSPRINGDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x2C4B00)

namespace PipelineCamera
{
	inline static constexpr unsigned int CriticalSpringDamper_TypeDefinitionIndex = 34505;
