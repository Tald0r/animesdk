...
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A39C6D0)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE__SYSTEM_SINGLESIN_SYSTEM_SINGLECOS___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A39C810)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR__SYSTEM_SINGLESIN_SYSTEM_SINGLECOS___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A39C760)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A39C880)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A39C7C0)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A39C770)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A39C6C0)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A39C6A0)

namespace PipelineCamera
{
	inline static constexpr unsigned int Method___SampleCircle_g__GetSinCosEnumerable_38_1_d_TypeDefinitionIndex = 34341;
