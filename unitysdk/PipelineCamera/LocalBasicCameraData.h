...
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKALL_OFFSET UNITYSDK_OFFSET(0x906660)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x906540)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x9064E0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKOFFSET_OFFSET UNITYSDK_OFFSET(0x906600)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x906420)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKPIVOTROTATION_OFFSET UNITYSDK_OFFSET(0x906480)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKRADIUS_OFFSET UNITYSDK_OFFSET(0x9065A0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A03B790)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GETLOCALCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x9063F0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x2FD610)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x9059C0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x2F7FC0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_PIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x31DD30)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x2FD5B0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x880560)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x906350)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETLOCALCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x906410)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x906090)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETLOCATION_OFFSET UNITYSDK_OFFSET(0x9059E0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETOFFSET_OFFSET UNITYSDK_OFFSET(0x906290)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x905E90)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETPIVOTROTATION_OFFSET UNITYSDK_OFFSET(0x905F60)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETRADIUS_OFFSET UNITYSDK_OFFSET(0x9061C0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETROTATION_OFFSET UNITYSDK_OFFSET(0x905C70)

namespace PipelineCamera
{
	inline static constexpr unsigned int LocalBasicCameraData_TypeDefinitionIndex = 34444;
