...
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKALL_OFFSET UNITYSDK_OFFSET(0x931AC0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x9319A0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x931940)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKOFFSET_OFFSET UNITYSDK_OFFSET(0x931A60)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x931880)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKPIVOTROTATION_OFFSET UNITYSDK_OFFSET(0x9318E0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKRADIUS_OFFSET UNITYSDK_OFFSET(0x931A00)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A61B860)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GETLOCALCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x931850)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x2F2FF0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x930E20)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x318750)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_PIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x2EA460)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x2F2F90)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x8B4680)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x9317B0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETLOCALCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x931870)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x9314F0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETLOCATION_OFFSET UNITYSDK_OFFSET(0x930E40)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETOFFSET_OFFSET UNITYSDK_OFFSET(0x9316F0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x9312F0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETPIVOTROTATION_OFFSET UNITYSDK_OFFSET(0x9313C0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETRADIUS_OFFSET UNITYSDK_OFFSET(0x931620)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETROTATION_OFFSET UNITYSDK_OFFSET(0x9310D0)

namespace PipelineCamera
{
	inline static constexpr unsigned int LocalBasicCameraData_TypeDefinitionIndex = 35446;
