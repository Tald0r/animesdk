...
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x931BA0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE__INVOKE_G__APPLY_5_0_OFFSET UNITYSDK_OFFSET(0x1A61EEF0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE__INVOKE_G__UPDATEASCURRENT_5_1_OFFSET UNITYSDK_OFFSET(0x1A61EBB0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE__INVOKE_G__UPDATEASSOURCE_5_2_OFFSET UNITYSDK_OFFSET(0x1A61E750)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraDeltaData_DeltaBlendingFinalSpace_TypeDefinitionIndex = 35451;
