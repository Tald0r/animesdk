...
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x906740)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE__INVOKE_G__APPLY_5_0_OFFSET UNITYSDK_OFFSET(0x1A03EE20)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE__INVOKE_G__UPDATEASCURRENT_5_1_OFFSET UNITYSDK_OFFSET(0x1A03EAE0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE__INVOKE_G__UPDATEASSOURCE_5_2_OFFSET UNITYSDK_OFFSET(0x1A03E680)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraDeltaData_DeltaBlendingFinalSpace_TypeDefinitionIndex = 34449;
