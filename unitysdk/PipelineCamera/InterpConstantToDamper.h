...
#define PIPELINECAMERA_INTERPCONSTANTTODAMPER_PIPELINECAMERA_IVALUEBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x93B950)
#define PIPELINECAMERA_INTERPCONSTANTTODAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x93B940)
#define PIPELINECAMERA_INTERPCONSTANTTODAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x2C4B00)

namespace PipelineCamera
{
	inline static constexpr unsigned int InterpConstantToDamper_TypeDefinitionIndex = 34501;
