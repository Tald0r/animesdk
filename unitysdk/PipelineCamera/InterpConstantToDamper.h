...
#define PIPELINECAMERA_INTERPCONSTANTTODAMPER_PIPELINECAMERA_IVALUEBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9686B0)
#define PIPELINECAMERA_INTERPCONSTANTTODAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9686A0)
#define PIPELINECAMERA_INTERPCONSTANTTODAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x2F60B0)

namespace PipelineCamera
{
	inline static constexpr unsigned int InterpConstantToDamper_TypeDefinitionIndex = 35503;
