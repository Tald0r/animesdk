...
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_COMPOSE_1_OFFSET UNITYSDK_OFFSET(0x96E0B0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_COMPOSE_OFFSET UNITYSDK_OFFSET(0x96DFC0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1AD4EB20)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_CREATE_OFFSET UNITYSDK_OFFSET(0x1AD4E830)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_DECOMPOSE_1_OFFSET UNITYSDK_OFFSET(0x96DEA0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_DECOMPOSE_OFFSET UNITYSDK_OFFSET(0x96DDE0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_OVERRIDE_OFFSET UNITYSDK_OFFSET(0x96E0C0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER__CTOR_OFFSET UNITYSDK_OFFSET(0x96DDB0)

namespace PipelineCamera
{
	inline static constexpr unsigned int PositionAxisDecomposer_TypeDefinitionIndex = 35508;
