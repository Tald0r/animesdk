...
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_COMPOSE_1_OFFSET UNITYSDK_OFFSET(0x93FFB0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_COMPOSE_OFFSET UNITYSDK_OFFSET(0x93FEC0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1A791090)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_CREATE_OFFSET UNITYSDK_OFFSET(0x1A790DA0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_DECOMPOSE_1_OFFSET UNITYSDK_OFFSET(0x93FDA0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_DECOMPOSE_OFFSET UNITYSDK_OFFSET(0x93FCE0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_OVERRIDE_OFFSET UNITYSDK_OFFSET(0x93FFC0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER__CTOR_OFFSET UNITYSDK_OFFSET(0x93FCB0)

namespace PipelineCamera
{
	inline static constexpr unsigned int PositionAxisDecomposer_TypeDefinitionIndex = 34506;
