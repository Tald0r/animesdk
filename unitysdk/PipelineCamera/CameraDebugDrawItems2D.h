...
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_COMMIT_OFFSET UNITYSDK_OFFSET(0x19D055F0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWLINESTRIP_OFFSET UNITYSDK_OFFSET(0x19D04CF0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x19D04C20)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWPOINT_OFFSET UNITYSDK_OFFSET(0x19D04B50)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWRECTANGLE_OFFSET UNITYSDK_OFFSET(0x19D04FD0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWTRIANGLESTRIP_OFFSET UNITYSDK_OFFSET(0x19D04ED0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWTRIANGLE_OFFSET UNITYSDK_OFFSET(0x19D04DE0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_RESET_OFFSET UNITYSDK_OFFSET(0x19D05490)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D__CTOR_OFFSET UNITYSDK_OFFSET(0x19D04910)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawItems2D_TypeDefinitionIndex = 34457;
