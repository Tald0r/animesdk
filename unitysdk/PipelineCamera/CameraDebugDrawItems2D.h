...
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_COMMIT_OFFSET UNITYSDK_OFFSET(0x1A30B750)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWLINESTRIP_OFFSET UNITYSDK_OFFSET(0x1A30AE50)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x1A30AD80)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWPOINT_OFFSET UNITYSDK_OFFSET(0x1A30ACB0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1A30B130)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWTRIANGLESTRIP_OFFSET UNITYSDK_OFFSET(0x1A30B030)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1A30AF40)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_RESET_OFFSET UNITYSDK_OFFSET(0x1A30B5F0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A30AA70)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawItems2D_TypeDefinitionIndex = 35459;
