...
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPIPELINECONFIG_BUILDFOLLOWTARGET_PIPELINECAMERA_ICAMERASUBMODULEBUILDER_PIPELINECAMERA_CAMERAFOLLOWTARGETPARAM__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1A1A8270)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPIPELINECONFIG_BUILDFOLLOWTARGET_PIPELINECAMERA_ICAMERASUBMODULEBUILDER_PIPELINECAMERA_CAMERAFOLLOWTARGETPARAM__ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1A1A8430)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPIPELINECONFIG_BUILDFOLLOWTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A6B30)

namespace PipelineCamera::Demo::Pipeline
{
	inline static constexpr unsigned int DemoFollowPipelineConfig_BuildFollowTarget_TypeDefinitionIndex = 34617;
