...
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPIPELINECONFIG_BUILDFOLLOWTARGET_PIPELINECAMERA_ICAMERASUBMODULEBUILDER_PIPELINECAMERA_CAMERAFOLLOWTARGETPARAM__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1A736130)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPIPELINECONFIG_BUILDFOLLOWTARGET_PIPELINECAMERA_ICAMERASUBMODULEBUILDER_PIPELINECAMERA_CAMERAFOLLOWTARGETPARAM__ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1A7362F0)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPIPELINECONFIG_BUILDFOLLOWTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7349F0)

namespace PipelineCamera::Demo::Pipeline
{
	inline static constexpr unsigned int DemoFollowPipelineConfig_BuildFollowTarget_TypeDefinitionIndex = 35619;
