...
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPIPELINECONFIG_BUILDFOLLOWSETTING_PIPELINECAMERA_ICAMERASUBMODULEBUILDER_PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTINGPARAM__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1A038F00)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPIPELINECONFIG_BUILDFOLLOWSETTING_PIPELINECAMERA_ICAMERASUBMODULEBUILDER_PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTINGPARAM__ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1A039010)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPIPELINECONFIG_BUILDFOLLOWSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A038EF0)

namespace PipelineCamera::Demo::Pipeline
{
	inline static constexpr unsigned int DemoFollowPipelineConfig_BuildFollowSetting_TypeDefinitionIndex = 34616;
