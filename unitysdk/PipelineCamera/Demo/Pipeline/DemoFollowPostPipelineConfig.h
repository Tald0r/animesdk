...
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPOSTPIPELINECONFIG_INITPIPELINE_OFFSET UNITYSDK_OFFSET(0x1A0394B0)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPOSTPIPELINECONFIG_PIPELINECAMERA_ICAMERAPIPELINECONFIG_PIPELINECAMERA_MODULE_INPLACEBLENDER__INITMODULE1_OFFSET UNITYSDK_OFFSET(0x1A039390)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPOSTPIPELINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A039590)

namespace PipelineCamera::Demo::Pipeline
{
	inline static constexpr unsigned int DemoFollowPostPipelineConfig_TypeDefinitionIndex = 34613;
