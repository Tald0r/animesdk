...
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPOSTPIPELINECONFIG_INITPIPELINE_OFFSET UNITYSDK_OFFSET(0x1A619580)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPOSTPIPELINECONFIG_PIPELINECAMERA_ICAMERAPIPELINECONFIG_PIPELINECAMERA_MODULE_INPLACEBLENDER__INITMODULE1_OFFSET UNITYSDK_OFFSET(0x1A619460)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPOSTPIPELINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A619660)

namespace PipelineCamera::Demo::Pipeline
{
	inline static constexpr unsigned int DemoFollowPostPipelineConfig_TypeDefinitionIndex = 35615;
