...
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINCORECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A038DF0)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINCORECOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A038E50)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINCORECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A038EB0)

namespace PipelineCamera::Demo
{
	inline static constexpr unsigned int LookAtByRotationInCoreComponent_TypeDefinitionIndex = 34597;
