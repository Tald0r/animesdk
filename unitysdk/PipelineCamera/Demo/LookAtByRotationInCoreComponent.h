...
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINCORECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A618EB0)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINCORECOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A618F10)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINCORECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A618F70)

namespace PipelineCamera::Demo
{
	inline static constexpr unsigned int LookAtByRotationInCoreComponent_TypeDefinitionIndex = 35599;
