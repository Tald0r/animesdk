...
#define PIPELINECAMERA_DEMO_DATA_BASICCAMERADATACOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A647000)
#define PIPELINECAMERA_DEMO_DATA_BASICCAMERADATACOMPONENT_PROCESSINPUT_OFFSET UNITYSDK_OFFSET(0x1A647060)
#define PIPELINECAMERA_DEMO_DATA_BASICCAMERADATACOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A6471F0)
#define PIPELINECAMERA_DEMO_DATA_BASICCAMERADATACOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A647250)

namespace PipelineCamera::Demo::Data
{
	inline static constexpr unsigned int BasicCameraDataComponent_TypeDefinitionIndex = 35603;
