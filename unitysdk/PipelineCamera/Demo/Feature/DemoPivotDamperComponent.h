...
#define PIPELINECAMERA_DEMO_FEATURE_DEMOPIVOTDAMPERCOMPONENT_PIPELINECAMERA_ICAMERASUBMODULEBUILDER_PIPELINECAMERA_WORLDBASICCAMERADATA__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1A766FF0)
#define PIPELINECAMERA_DEMO_FEATURE_DEMOPIVOTDAMPERCOMPONENT_PIPELINECAMERA_ICAMERASUBMODULEBUILDER_PIPELINECAMERA_WORLDBASICCAMERADATA__ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1A7670D0)
#define PIPELINECAMERA_DEMO_FEATURE_DEMOPIVOTDAMPERCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7671F0)

namespace PipelineCamera::Demo::Feature
{
	inline static constexpr unsigned int DemoPivotDamperComponent_TypeDefinitionIndex = 34600;
