...
#define PIPELINECAMERA_DEMO_FEATURE_AIMINGSETTINGCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A6800)

namespace PipelineCamera::Demo::Feature
{
	inline static constexpr unsigned int AimingSettingComponent_TypeDefinitionIndex = 34599;
