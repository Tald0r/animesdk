...
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINFINALCOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B565980)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINFINALCOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B5659E0)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINFINALCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B565A40)

namespace PipelineCamera::Demo
{
	inline static constexpr unsigned int LookAtByRotationInFinalComponent_TypeDefinitionIndex = 35600;
