...
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCEFINALSPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x952150)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCEFINALSPACE__INVOKE_G__UPDATEASCURRENT_3_0_OFFSET UNITYSDK_OFFSET(0x1AB96570)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCEFINALSPACE__INVOKE_G__UPDATEASSOURCE_3_1_OFFSET UNITYSDK_OFFSET(0x1AB96100)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraDeltaData_LockSourceFinalSpace_TypeDefinitionIndex = 35455;
