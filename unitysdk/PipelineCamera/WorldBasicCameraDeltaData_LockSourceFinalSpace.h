...
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCEFINALSPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x924110)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCEFINALSPACE__INVOKE_G__UPDATEASCURRENT_3_0_OFFSET UNITYSDK_OFFSET(0x1A5CC7A0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCEFINALSPACE__INVOKE_G__UPDATEASSOURCE_3_1_OFFSET UNITYSDK_OFFSET(0x1A5CC330)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraDeltaData_LockSourceFinalSpace_TypeDefinitionIndex = 34453;
