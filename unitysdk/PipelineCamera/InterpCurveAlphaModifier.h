...
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_BEZIER_OFFSET UNITYSDK_OFFSET(0x1A30FD40)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_CONSTANT_OFFSET UNITYSDK_OFFSET(0x1A30FB20)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_CUBIC_OFFSET UNITYSDK_OFFSET(0x1A30FC20)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_LINEAR_OFFSET UNITYSDK_OFFSET(0x1A30FA20)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x9203C0)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9202D0)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x4681A0)

namespace PipelineCamera
{
	inline static constexpr unsigned int InterpCurveAlphaModifier_TypeDefinitionIndex = 35521;
