...
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_BEZIER_OFFSET UNITYSDK_OFFSET(0x19D09BE0)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_CONSTANT_OFFSET UNITYSDK_OFFSET(0x19D099C0)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_CUBIC_OFFSET UNITYSDK_OFFSET(0x19D09AC0)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_LINEAR_OFFSET UNITYSDK_OFFSET(0x19D098C0)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x8F3F80)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x8F3E90)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x4677F0)

namespace PipelineCamera
{
	inline static constexpr unsigned int InterpCurveAlphaModifier_TypeDefinitionIndex = 34519;
