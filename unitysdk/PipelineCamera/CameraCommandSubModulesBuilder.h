...
#define PIPELINECAMERA_CAMERACOMMANDSUBMODULESBUILDER_ADD_OFFSET UNITYSDK_OFFSET(0x1A7630D0)
#define PIPELINECAMERA_CAMERACOMMANDSUBMODULESBUILDER_END_OFFSET UNITYSDK_OFFSET(0x1A7632B0)
#define PIPELINECAMERA_CAMERACOMMANDSUBMODULESBUILDER_ISRECORDING_OFFSET UNITYSDK_OFFSET(0x1A7633C0)
#define PIPELINECAMERA_CAMERACOMMANDSUBMODULESBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A763440)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraCommandSubModulesBuilder_TypeDefinitionIndex = 34329;
