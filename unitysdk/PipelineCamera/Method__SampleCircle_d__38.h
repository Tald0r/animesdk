...
#define PIPELINECAMERA_METHOD__SAMPLECIRCLE_D__38_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A767260)
#define PIPELINECAMERA_METHOD__SAMPLECIRCLE_D__38_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE__SYSTEM_SINGLESIN_SYSTEM_SINGLECOS___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A7675A0)
#define PIPELINECAMERA_METHOD__SAMPLECIRCLE_D__38_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR__SYSTEM_SINGLESIN_SYSTEM_SINGLECOS___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7674F0)
#define PIPELINECAMERA_METHOD__SAMPLECIRCLE_D__38_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A767620)
#define PIPELINECAMERA_METHOD__SAMPLECIRCLE_D__38_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A767550)
#define PIPELINECAMERA_METHOD__SAMPLECIRCLE_D__38_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A767500)
#define PIPELINECAMERA_METHOD__SAMPLECIRCLE_D__38_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A767250)
#define PIPELINECAMERA_METHOD__SAMPLECIRCLE_D__38__CTOR_OFFSET UNITYSDK_OFFSET(0x1A767230)

namespace PipelineCamera
{
	inline static constexpr unsigned int Method__SampleCircle_d__38_TypeDefinitionIndex = 34340;
	...
	public:
		...
		::System::Int32 __3__segmentHint; // 0x20
		::System::Int32 __1__state; // 0x24
		::System::Int32 _step_5__3; // 0x28
