...
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_COMMIT_OFFSET UNITYSDK_OFFSET(0x1A30D090)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0x1A30CD10)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINESTRIP_1_OFFSET UNITYSDK_OFFSET(0x1A30C500)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINESTRIP_2_OFFSET UNITYSDK_OFFSET(0x1A30CAE0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINESTRIP_OFFSET UNITYSDK_OFFSET(0x1A30C080)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINE_1_OFFSET UNITYSDK_OFFSET(0x1A30B9A0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINE_2_OFFSET UNITYSDK_OFFSET(0x1A30BD10)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x1A30B8F0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWPOINT_OFFSET UNITYSDK_OFFSET(0x1A30B830)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_RESET_OFFSET UNITYSDK_OFFSET(0x1A30CF60)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A30D200)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawItems3D_TypeDefinitionIndex = 35468;
