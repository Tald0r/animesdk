...
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_COMMIT_OFFSET UNITYSDK_OFFSET(0x19D06F30)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0x19D06BB0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINESTRIP_1_OFFSET UNITYSDK_OFFSET(0x19D063A0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINESTRIP_2_OFFSET UNITYSDK_OFFSET(0x19D06980)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINESTRIP_OFFSET UNITYSDK_OFFSET(0x19D05F20)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINE_1_OFFSET UNITYSDK_OFFSET(0x19D05840)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINE_2_OFFSET UNITYSDK_OFFSET(0x19D05BB0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x19D05790)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWPOINT_OFFSET UNITYSDK_OFFSET(0x19D056D0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_RESET_OFFSET UNITYSDK_OFFSET(0x19D06E00)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D__CTOR_OFFSET UNITYSDK_OFFSET(0x19D070A0)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawItems3D_TypeDefinitionIndex = 34466;
