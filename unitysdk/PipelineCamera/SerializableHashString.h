...
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x940160)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x93FFF0)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A792250)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A7921F0)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x940060)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9400D0)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x940070)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x940170)

namespace PipelineCamera
{
	inline static constexpr unsigned int SerializableHashString_TypeDefinitionIndex = 34487;
