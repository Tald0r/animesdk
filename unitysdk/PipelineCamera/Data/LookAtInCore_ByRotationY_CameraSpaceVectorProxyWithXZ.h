...
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CAMERASPACEVECTORPROXYWITHXZ_CREATE_OFFSET UNITYSDK_OFFSET(0x1A1A4780)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CAMERASPACEVECTORPROXYWITHXZ__CTOR_OFFSET UNITYSDK_OFFSET(0x90ACE0)

namespace PipelineCamera::Data
{
	inline static constexpr unsigned int LookAtInCore_ByRotationY_CameraSpaceVectorProxyWithXZ_TypeDefinitionIndex = 34623;
