...
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_CALCULATEYAWRADIAN_OFFSET UNITYSDK_OFFSET(0x880360)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_CONSTANT_OFFSET UNITYSDK_OFFSET(0x87FF40)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x87FFD0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_GETCLOSESTINDECREASINGINTERVAL_OFFSET UNITYSDK_OFFSET(0x8801E0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_GETCLOSESTININCREASINGINTERVAL_OFFSET UNITYSDK_OFFSET(0x880060)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_GETCLOSEST_OFFSET UNITYSDK_OFFSET(0x880010)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_GETMONOTONICALLYINTERVAL_OFFSET UNITYSDK_OFFSET(0x87FFF0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_RESOLVE_OFFSET UNITYSDK_OFFSET(0x87FFC0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x87FED0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION__GETCLOSEST_G__UPDATERESULT_9_0_OFFSET UNITYSDK_OFFSET(0x1930BDE0)

namespace PipelineCamera::Data
{
	inline static constexpr unsigned int LookAtInCore_ByRotationY_HorizontalAlignedLengthFunction_TypeDefinitionIndex = 34624;
