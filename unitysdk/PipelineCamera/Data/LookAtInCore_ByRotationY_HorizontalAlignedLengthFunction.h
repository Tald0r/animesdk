...
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_CALCULATEYAWRADIAN_OFFSET UNITYSDK_OFFSET(0x8B4480)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_CONSTANT_OFFSET UNITYSDK_OFFSET(0x8B4060)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x8B40F0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_GETCLOSESTINDECREASINGINTERVAL_OFFSET UNITYSDK_OFFSET(0x8B4300)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_GETCLOSESTININCREASINGINTERVAL_OFFSET UNITYSDK_OFFSET(0x8B4180)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_GETCLOSEST_OFFSET UNITYSDK_OFFSET(0x8B4130)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_GETMONOTONICALLYINTERVAL_OFFSET UNITYSDK_OFFSET(0x8B4110)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_RESOLVE_OFFSET UNITYSDK_OFFSET(0x8B40E0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x8B3FF0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION__GETCLOSEST_G__UPDATERESULT_9_0_OFFSET UNITYSDK_OFFSET(0x197BEF40)

namespace PipelineCamera::Data
{
	inline static constexpr unsigned int LookAtInCore_ByRotationY_HorizontalAlignedLengthFunction_TypeDefinitionIndex = 35626;
