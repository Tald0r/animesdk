...
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_BUILDCACHEINTERNAL_OFFSET UNITYSDK_OFFSET(0x937660)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKALL_OFFSET UNITYSDK_OFFSET(0x937530)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x9374D0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKCAMERALOCATION_OFFSET UNITYSDK_OFFSET(0x937350)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x937470)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKLOOKATLOCATION_OFFSET UNITYSDK_OFFSET(0x9373B0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKLOOKATSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x937410)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CREATE_OFFSET UNITYSDK_OFFSET(0x1A733400)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x937610)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x937590)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x8B27E0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x937630)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_MARKDIRTY_OFFSET UNITYSDK_OFFSET(0x937670)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x9370F0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETCAMERALOCATION_OFFSET UNITYSDK_OFFSET(0x936A40)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x936F60)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETLOOKATLOCATION_OFFSET UNITYSDK_OFFSET(0x936BD0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETLOOKATSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x936D60)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETROTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x937280)

namespace PipelineCamera::Data
{
	inline static constexpr unsigned int LookAtInFinal_ByRotation_TypeDefinitionIndex = 35629;
