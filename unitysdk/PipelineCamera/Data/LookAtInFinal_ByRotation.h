...
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_BUILDCACHEINTERNAL_OFFSET UNITYSDK_OFFSET(0x90B9A0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKALL_OFFSET UNITYSDK_OFFSET(0x90B870)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x90B810)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKCAMERALOCATION_OFFSET UNITYSDK_OFFSET(0x90B690)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x90B7B0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKLOOKATLOCATION_OFFSET UNITYSDK_OFFSET(0x90B6F0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKLOOKATSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x90B750)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CREATE_OFFSET UNITYSDK_OFFSET(0x1A1A5540)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x90B950)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x90B8D0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x87E6C0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x90B970)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_MARKDIRTY_OFFSET UNITYSDK_OFFSET(0x90B9B0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x90B430)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETCAMERALOCATION_OFFSET UNITYSDK_OFFSET(0x90AD80)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x90B2A0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETLOOKATLOCATION_OFFSET UNITYSDK_OFFSET(0x90AF10)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETLOOKATSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x90B0A0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETROTATIONTYPE_OFFSET UNITYSDK_OFFSET(0x90B5C0)

namespace PipelineCamera::Data
{
	inline static constexpr unsigned int LookAtInFinal_ByRotation_TypeDefinitionIndex = 34627;
