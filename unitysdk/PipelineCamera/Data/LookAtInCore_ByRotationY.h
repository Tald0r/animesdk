...
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_BUILDCACHEINTERNAL_OFFSET UNITYSDK_OFFSET(0x8B3BA0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKALL_OFFSET UNITYSDK_OFFSET(0x8B3700)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x8B3940)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKDELTARADIAN_OFFSET UNITYSDK_OFFSET(0x8B3A00)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x8B38E0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKLOOKATLOCATION_OFFSET UNITYSDK_OFFSET(0x8B3820)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKLOOKATSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x8B3880)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKMAINLOCATION_OFFSET UNITYSDK_OFFSET(0x8B3760)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKMAINRADIUS_OFFSET UNITYSDK_OFFSET(0x8B39A0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKMAINSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x8B37C0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKPITCH_OFFSET UNITYSDK_OFFSET(0x8B3A60)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKROLL_OFFSET UNITYSDK_OFFSET(0x8B3AC0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CREATE_OFFSET UNITYSDK_OFFSET(0x197B90C0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_DESIREDRANGEBYPOSITIVEFORWARD_OFFSET UNITYSDK_OFFSET(0x197BC1D0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_DESIREDRANGEBYSETTING_OFFSET UNITYSDK_OFFSET(0x8B3BC0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GETDESIREDOFFSET_OFFSET UNITYSDK_OFFSET(0x8B3BB0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x8B3D50)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x8B3BE0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x8B3C60)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x8B3F20)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_PIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x8B3DE0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x8B3E90)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x8B3C80)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_MARKDIRTY_OFFSET UNITYSDK_OFFSET(0x8B3B20)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x8B2DA0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETDELTARADIAN_OFFSET UNITYSDK_OFFSET(0x8B3080)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x8B2C10)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETLOOKATLOCATION_OFFSET UNITYSDK_OFFSET(0x8B2A80)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETLOOKATSCREENOFFSETX_OFFSET UNITYSDK_OFFSET(0x8B2A90)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETMAINLOCATION_OFFSET UNITYSDK_OFFSET(0x8B2870)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETMAINRADIUS_OFFSET UNITYSDK_OFFSET(0x8B2F10)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETMAINSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x8B2880)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETPITCH_OFFSET UNITYSDK_OFFSET(0x8B3350)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETROLL_OFFSET UNITYSDK_OFFSET(0x8B34E0)

namespace PipelineCamera::Data
{
	inline static constexpr unsigned int LookAtInCore_ByRotationY_TypeDefinitionIndex = 35624;
