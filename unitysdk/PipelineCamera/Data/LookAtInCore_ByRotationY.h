...
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_BUILDCACHEINTERNAL_OFFSET UNITYSDK_OFFSET(0x87FA80)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKALL_OFFSET UNITYSDK_OFFSET(0x87F5E0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x87F820)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKDELTARADIAN_OFFSET UNITYSDK_OFFSET(0x87F8E0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x87F7C0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKLOOKATLOCATION_OFFSET UNITYSDK_OFFSET(0x87F700)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKLOOKATSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x87F760)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKMAINLOCATION_OFFSET UNITYSDK_OFFSET(0x87F640)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKMAINRADIUS_OFFSET UNITYSDK_OFFSET(0x87F880)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKMAINSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x87F6A0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKPITCH_OFFSET UNITYSDK_OFFSET(0x87F940)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CHECKROLL_OFFSET UNITYSDK_OFFSET(0x87F9A0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_CREATE_OFFSET UNITYSDK_OFFSET(0x19305F60)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_DESIREDRANGEBYPOSITIVEFORWARD_OFFSET UNITYSDK_OFFSET(0x19309070)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_DESIREDRANGEBYSETTING_OFFSET UNITYSDK_OFFSET(0x87FAA0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GETDESIREDOFFSET_OFFSET UNITYSDK_OFFSET(0x87FA90)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x87FC30)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x87FAC0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x87FB40)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x87FE00)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_PIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x87FCC0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x87FD70)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x87FB60)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_MARKDIRTY_OFFSET UNITYSDK_OFFSET(0x87FA00)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x87EC80)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETDELTARADIAN_OFFSET UNITYSDK_OFFSET(0x87EF60)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x87EAF0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETLOOKATLOCATION_OFFSET UNITYSDK_OFFSET(0x87E960)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETLOOKATSCREENOFFSETX_OFFSET UNITYSDK_OFFSET(0x87E970)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETMAINLOCATION_OFFSET UNITYSDK_OFFSET(0x87E750)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETMAINRADIUS_OFFSET UNITYSDK_OFFSET(0x87EDF0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETMAINSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x87E760)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETPITCH_OFFSET UNITYSDK_OFFSET(0x87F230)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_SETROLL_OFFSET UNITYSDK_OFFSET(0x87F3C0)

namespace PipelineCamera::Data
{
	inline static constexpr unsigned int LookAtInCore_ByRotationY_TypeDefinitionIndex = 34622;
