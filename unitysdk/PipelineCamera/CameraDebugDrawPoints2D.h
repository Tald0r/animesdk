...
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x1A72EBB0)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A72EC90)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D_DRAW_OFFSET UNITYSDK_OFFSET(0x1A72ED50)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D_ENSURE_OFFSET UNITYSDK_OFFSET(0x1A72E9E0)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A72F1B0)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawPoints2D_TypeDefinitionIndex = 35460;
