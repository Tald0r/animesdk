...
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x1A1A0D00)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A1A0DE0)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D_DRAW_OFFSET UNITYSDK_OFFSET(0x1A1A0EA0)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D_ENSURE_OFFSET UNITYSDK_OFFSET(0x1A1A0B30)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A1300)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawPoints2D_TypeDefinitionIndex = 34458;
