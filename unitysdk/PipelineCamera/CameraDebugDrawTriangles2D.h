...
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D_ADDTRIANGLESTRIP_OFFSET UNITYSDK_OFFSET(0x1A6129B0)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D_ADDTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1A6128B0)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A612B10)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D_DRAW_OFFSET UNITYSDK_OFFSET(0x1A612C10)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D_ENSURE_OFFSET UNITYSDK_OFFSET(0x1A612680)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A613520)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D__DRAW_G__DRAWTRIANGLESTRIP_8_1_OFFSET UNITYSDK_OFFSET(0x1A613130)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D__DRAW_G__DRAWTRIANGLE_8_0_OFFSET UNITYSDK_OFFSET(0x1A612DC0)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawTriangles2D_TypeDefinitionIndex = 35465;
