...
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D_ADDTRIANGLESTRIP_OFFSET UNITYSDK_OFFSET(0x1A0328F0)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D_ADDTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1A0327F0)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A032A50)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D_DRAW_OFFSET UNITYSDK_OFFSET(0x1A032B50)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D_ENSURE_OFFSET UNITYSDK_OFFSET(0x1A0325C0)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A033460)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D__DRAW_G__DRAWTRIANGLESTRIP_8_1_OFFSET UNITYSDK_OFFSET(0x1A033070)
#define PIPELINECAMERA_CAMERADEBUGDRAWTRIANGLES2D__DRAW_G__DRAWTRIANGLE_8_0_OFFSET UNITYSDK_OFFSET(0x1A032D00)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawTriangles2D_TypeDefinitionIndex = 34463;
