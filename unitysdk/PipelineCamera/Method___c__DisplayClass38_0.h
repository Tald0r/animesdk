...
#define PIPELINECAMERA_METHOD___C__DISPLAYCLASS38_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A44C5E0)
#define PIPELINECAMERA_METHOD___C__DISPLAYCLASS38_0__SAMPLECIRCLE_B__0_OFFSET UNITYSDK_OFFSET(0x1A44C5F0)

namespace PipelineCamera
{
	inline static constexpr unsigned int Method___c__DisplayClass38_0_TypeDefinitionIndex = 34339;
