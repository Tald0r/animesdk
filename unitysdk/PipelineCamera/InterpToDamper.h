...
#define PIPELINECAMERA_INTERPTODAMPER_PIPELINECAMERA_IVALUEBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9A0290)
#define PIPELINECAMERA_INTERPTODAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9A0280)
#define PIPELINECAMERA_INTERPTODAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x2F60B0)

namespace PipelineCamera
{
	inline static constexpr unsigned int InterpToDamper_TypeDefinitionIndex = 35502;
