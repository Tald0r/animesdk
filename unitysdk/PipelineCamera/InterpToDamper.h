...
#define PIPELINECAMERA_INTERPTODAMPER_PIPELINECAMERA_IVALUEBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x96D430)
#define PIPELINECAMERA_INTERPTODAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x96D420)
#define PIPELINECAMERA_INTERPTODAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x2C4B00)

namespace PipelineCamera
{
	inline static constexpr unsigned int InterpToDamper_TypeDefinitionIndex = 34500;
