...
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_CHECKALL_OFFSET UNITYSDK_OFFSET(0x93BC70)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_CHECKASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x93BBB0)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x93BC10)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_CHECKPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x93BA30)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_CHECKRADIUS_OFFSET UNITYSDK_OFFSET(0x93BAF0)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_CHECKROTATION_OFFSET UNITYSDK_OFFSET(0x93BA90)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_CHECKSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x93BB50)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A7378B0)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_GETCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x93C420)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x2FD5B0)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x93BCD0)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x93BD30)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_GET_PIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x31DD30)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x8FF150)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x37BFB0)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_GET_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x2FC120)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_SETASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x93C330)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_SETCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x93C440)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x93BFD0)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_SETLOCATION_OFFSET UNITYSDK_OFFSET(0x93BE00)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_SETOFFSET_OFFSET UNITYSDK_OFFSET(0x93C260)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_SETPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x93C0C0)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_SETRADIUS_OFFSET UNITYSDK_OFFSET(0x93C190)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_SETROTATION_OFFSET UNITYSDK_OFFSET(0x93BEA0)
#define PIPELINECAMERA_WORLDSCREENCAMERADATA_SETSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x93C270)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldScreenCameraData_TypeDefinitionIndex = 34456;
