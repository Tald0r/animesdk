...
#define PIPELINECAMERA_METHOD_LOOPINTERVAL_GET_INTERVALINLOOP_OFFSET UNITYSDK_OFFSET(0x9066E0)

namespace PipelineCamera
{
	inline static constexpr unsigned int Method_LoopInterval_TypeDefinitionIndex = 34336;
