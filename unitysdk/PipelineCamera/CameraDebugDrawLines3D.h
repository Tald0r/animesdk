...
#define PIPELINECAMERA_CAMERADEBUGDRAWLINES3D_ADDLINE_OFFSET UNITYSDK_OFFSET(0x192FFBB0)
#define PIPELINECAMERA_CAMERADEBUGDRAWLINES3D_CLEAR_OFFSET UNITYSDK_OFFSET(0x192FFCD0)
#define PIPELINECAMERA_CAMERADEBUGDRAWLINES3D_DRAW_OFFSET UNITYSDK_OFFSET(0x192FFD60)
#define PIPELINECAMERA_CAMERADEBUGDRAWLINES3D__CTOR_OFFSET UNITYSDK_OFFSET(0x19300120)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawLines3D_TypeDefinitionIndex = 34476;
