...
#define PIPELINECAMERA_CAMERADEBUGDRAWLINES3D_ADDLINE_OFFSET UNITYSDK_OFFSET(0x197B2D20)
#define PIPELINECAMERA_CAMERADEBUGDRAWLINES3D_CLEAR_OFFSET UNITYSDK_OFFSET(0x197B2E40)
#define PIPELINECAMERA_CAMERADEBUGDRAWLINES3D_DRAW_OFFSET UNITYSDK_OFFSET(0x197B2ED0)
#define PIPELINECAMERA_CAMERADEBUGDRAWLINES3D__CTOR_OFFSET UNITYSDK_OFFSET(0x197B3290)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawLines3D_TypeDefinitionIndex = 35478;
