...
#define PIPELINECAMERA_CAMERAEXTERNALVALUECOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x910FE0)
#define PIPELINECAMERA_CAMERAEXTERNALVALUECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x911080)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraExternalValueCollection_TypeDefinitionIndex = 34365;
