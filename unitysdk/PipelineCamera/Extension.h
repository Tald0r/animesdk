...
#define PIPELINECAMERA_EXTENSION_ASEULER_OFFSET UNITYSDK_OFFSET(0x1A8B3930)
#define PIPELINECAMERA_EXTENSION_ASPERIODIC_1_OFFSET UNITYSDK_OFFSET(0x1A8B3020)
#define PIPELINECAMERA_EXTENSION_ASPERIODIC_OFFSET UNITYSDK_OFFSET(0x1A8B2F40)
#define PIPELINECAMERA_EXTENSION_CLAMPTO_OFFSET UNITYSDK_OFFSET(0x1A8B2DC0)
#define PIPELINECAMERA_EXTENSION_CONTAINNAN_OFFSET UNITYSDK_OFFSET(0x1A8B30F0)
#define PIPELINECAMERA_EXTENSION_DRAWARROW_OFFSET UNITYSDK_OFFSET(0x1A8B11C0)
#define PIPELINECAMERA_EXTENSION_DRAWELLIPSE_OFFSET UNITYSDK_OFFSET(0x1A8B0A10)
#define PIPELINECAMERA_EXTENSION_DRAWRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1A8B01C0)
#define PIPELINECAMERA_EXTENSION_ENSUREINRANGE_OFFSET UNITYSDK_OFFSET(0x1A8B2E70)
#define PIPELINECAMERA_EXTENSION_ENSURENOTZERO_OFFSET UNITYSDK_OFFSET(0x1A8B2BE0)
#define PIPELINECAMERA_EXTENSION_FORWARD_OFFSET UNITYSDK_OFFSET(0x1A8B3810)
#define PIPELINECAMERA_EXTENSION_GETBLENDINGCATEGORY_OFFSET UNITYSDK_OFFSET(0x1A8B2360)
#define PIPELINECAMERA_EXTENSION_GETELLIPSEDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1A8B0720)
#define PIPELINECAMERA_EXTENSION_GETSECTIONSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1A8B2820)
#define PIPELINECAMERA_EXTENSION_HORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1A8B3B40)
#define PIPELINECAMERA_EXTENSION_ISNEARLYEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1A8B32A0)
#define PIPELINECAMERA_EXTENSION_ISNEARLYEQUAL_2_OFFSET UNITYSDK_OFFSET(0x1A8B3450)
#define PIPELINECAMERA_EXTENSION_ISNEARLYEQUAL_OFFSET UNITYSDK_OFFSET(0x1A8B2C80)
#define PIPELINECAMERA_EXTENSION_ISNEARLYZERO_1_OFFSET UNITYSDK_OFFSET(0x1A8B3380)
#define PIPELINECAMERA_EXTENSION_ISNEARLYZERO_2_OFFSET UNITYSDK_OFFSET(0x1A8B3510)
#define PIPELINECAMERA_EXTENSION_ISNEARLYZERO_OFFSET UNITYSDK_OFFSET(0x1A8B2D30)
#define PIPELINECAMERA_EXTENSION_LERPEULERROTATION_OFFSET UNITYSDK_OFFSET(0x1A8B1EA0)
#define PIPELINECAMERA_EXTENSION_LERPEULER_OFFSET UNITYSDK_OFFSET(0x1A8B20E0)
#define PIPELINECAMERA_EXTENSION_LERPFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x1A8B1DE0)
#define PIPELINECAMERA_EXTENSION_LERPOFFSET_OFFSET UNITYSDK_OFFSET(0x1A8B1CE0)
#define PIPELINECAMERA_EXTENSION_LERPPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x1A8B1AE0)
#define PIPELINECAMERA_EXTENSION_LERPRADIUS_OFFSET UNITYSDK_OFFSET(0x1A8B1C20)
#define PIPELINECAMERA_EXTENSION_MEMBERWISEMULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1A8B3640)
#define PIPELINECAMERA_EXTENSION_MEMBERWISEMULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A8B35B0)
#define PIPELINECAMERA_EXTENSION_MINMAX_OFFSET UNITYSDK_OFFSET(0x1A8B3C00)
#define PIPELINECAMERA_EXTENSION_MIRROR_OFFSET UNITYSDK_OFFSET(0x1A8B23C0)
#define PIPELINECAMERA_EXTENSION_PROJECTON_OFFSET UNITYSDK_OFFSET(0x1A8B3170)
#define PIPELINECAMERA_EXTENSION_REALASPECT_OFFSET UNITYSDK_OFFSET(0x1A8B2AC0)
#define PIPELINECAMERA_EXTENSION_RIGHT_1_OFFSET UNITYSDK_OFFSET(0x1A8B3A80)
#define PIPELINECAMERA_EXTENSION_RIGHT_OFFSET UNITYSDK_OFFSET(0x1A8B3870)
#define PIPELINECAMERA_EXTENSION_ROTATEBYSHORTESTPATH_OFFSET UNITYSDK_OFFSET(0x1A8B1A70)
#define PIPELINECAMERA_EXTENSION_SIZEXZ_OFFSET UNITYSDK_OFFSET(0x1A8B39F0)
#define PIPELINECAMERA_EXTENSION_TESTACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A8B12C0)
#define PIPELINECAMERA_EXTENSION_TESTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1A8B13F0)
#define PIPELINECAMERA_EXTENSION_TESTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A8B1320)
#define PIPELINECAMERA_EXTENSION_TESTEVALUATE_OFFSET UNITYSDK_OFFSET(0x1A8B14D0)
#define PIPELINECAMERA_EXTENSION_TESTFLUSH_OFFSET UNITYSDK_OFFSET(0x1A8B1540)
#define PIPELINECAMERA_EXTENSION_TESTPOSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1A8B1460)
#define PIPELINECAMERA_EXTENSION_TESTPREPARE_OFFSET UNITYSDK_OFFSET(0x1A8B1380)
#define PIPELINECAMERA_EXTENSION_TESTTOUCH_OFFSET UNITYSDK_OFFSET(0x1A8B15B0)
#define PIPELINECAMERA_EXTENSION_TESTTRACKINCOLLECT_OFFSET UNITYSDK_OFFSET(0x1A8B1610)
#define PIPELINECAMERA_EXTENSION_TOPRECISESTRING_OFFSET UNITYSDK_OFFSET(0x1A8B36F0)
#define PIPELINECAMERA_EXTENSION_TOTRANSLATIONROTATIONSCALE_OFFSET UNITYSDK_OFFSET(0x1A8B2630)
#define PIPELINECAMERA_EXTENSION_UPDATED_OFFSET UNITYSDK_OFFSET(0x1A8B0020)
#define PIPELINECAMERA_EXTENSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A8B1680)
#define PIPELINECAMERA_EXTENSION_UP_1_OFFSET UNITYSDK_OFFSET(0x1A8B3AE0)
#define PIPELINECAMERA_EXTENSION_UP_OFFSET UNITYSDK_OFFSET(0x1A8B38D0)
#define PIPELINECAMERA_EXTENSION_VERTICAL_OFFSET UNITYSDK_OFFSET(0x1A8B3BA0)
#define PIPELINECAMERA_EXTENSION__GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_OFFSET UNITYSDK_OFFSET(0x1A8B09C0)
#define PIPELINECAMERA_EXTENSION__GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_OFFSET UNITYSDK_OFFSET(0x1A8B0960)

namespace PipelineCamera
{
	inline static constexpr unsigned int Extension_TypeDefinitionIndex = 35416;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::UnityEngine::Vector2>*>**)Il2CppClass::FromTypeDefinitionIndex(Extension_TypeDefinitionIndex)->GetStaticField(0x26560);
		}
