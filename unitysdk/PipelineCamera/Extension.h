...
#define PIPELINECAMERA_EXTENSION_ASEULER_OFFSET UNITYSDK_OFFSET(0x1A2E9B30)
#define PIPELINECAMERA_EXTENSION_ASPERIODIC_1_OFFSET UNITYSDK_OFFSET(0x1A2E9220)
#define PIPELINECAMERA_EXTENSION_ASPERIODIC_OFFSET UNITYSDK_OFFSET(0x1A2E9140)
#define PIPELINECAMERA_EXTENSION_CLAMPTO_OFFSET UNITYSDK_OFFSET(0x1A2E8FC0)
#define PIPELINECAMERA_EXTENSION_CONTAINNAN_OFFSET UNITYSDK_OFFSET(0x1A2E92F0)
#define PIPELINECAMERA_EXTENSION_DRAWARROW_OFFSET UNITYSDK_OFFSET(0x1A2E73C0)
#define PIPELINECAMERA_EXTENSION_DRAWELLIPSE_OFFSET UNITYSDK_OFFSET(0x1A2E6C10)
#define PIPELINECAMERA_EXTENSION_DRAWRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1A2E63C0)
#define PIPELINECAMERA_EXTENSION_ENSUREINRANGE_OFFSET UNITYSDK_OFFSET(0x1A2E9070)
#define PIPELINECAMERA_EXTENSION_ENSURENOTZERO_OFFSET UNITYSDK_OFFSET(0x1A2E8DE0)
#define PIPELINECAMERA_EXTENSION_FORWARD_OFFSET UNITYSDK_OFFSET(0x1A2E9A10)
#define PIPELINECAMERA_EXTENSION_GETBLENDINGCATEGORY_OFFSET UNITYSDK_OFFSET(0x1A2E8560)
#define PIPELINECAMERA_EXTENSION_GETELLIPSEDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1A2E6920)
#define PIPELINECAMERA_EXTENSION_GETSECTIONSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1A2E8A20)
#define PIPELINECAMERA_EXTENSION_HORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1A2E9D40)
#define PIPELINECAMERA_EXTENSION_ISNEARLYEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1A2E94A0)
#define PIPELINECAMERA_EXTENSION_ISNEARLYEQUAL_2_OFFSET UNITYSDK_OFFSET(0x1A2E9650)
#define PIPELINECAMERA_EXTENSION_ISNEARLYEQUAL_OFFSET UNITYSDK_OFFSET(0x1A2E8E80)
#define PIPELINECAMERA_EXTENSION_ISNEARLYZERO_1_OFFSET UNITYSDK_OFFSET(0x1A2E9580)
#define PIPELINECAMERA_EXTENSION_ISNEARLYZERO_2_OFFSET UNITYSDK_OFFSET(0x1A2E9710)
#define PIPELINECAMERA_EXTENSION_ISNEARLYZERO_OFFSET UNITYSDK_OFFSET(0x1A2E8F30)
#define PIPELINECAMERA_EXTENSION_LERPEULERROTATION_OFFSET UNITYSDK_OFFSET(0x1A2E80A0)
#define PIPELINECAMERA_EXTENSION_LERPEULER_OFFSET UNITYSDK_OFFSET(0x1A2E82E0)
#define PIPELINECAMERA_EXTENSION_LERPFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x1A2E7FE0)
#define PIPELINECAMERA_EXTENSION_LERPOFFSET_OFFSET UNITYSDK_OFFSET(0x1A2E7EE0)
#define PIPELINECAMERA_EXTENSION_LERPPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x1A2E7CE0)
#define PIPELINECAMERA_EXTENSION_LERPRADIUS_OFFSET UNITYSDK_OFFSET(0x1A2E7E20)
#define PIPELINECAMERA_EXTENSION_MEMBERWISEMULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1A2E9840)
#define PIPELINECAMERA_EXTENSION_MEMBERWISEMULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A2E97B0)
#define PIPELINECAMERA_EXTENSION_MINMAX_OFFSET UNITYSDK_OFFSET(0x1A2E9E00)
#define PIPELINECAMERA_EXTENSION_MIRROR_OFFSET UNITYSDK_OFFSET(0x1A2E85C0)
#define PIPELINECAMERA_EXTENSION_PROJECTON_OFFSET UNITYSDK_OFFSET(0x1A2E9370)
#define PIPELINECAMERA_EXTENSION_REALASPECT_OFFSET UNITYSDK_OFFSET(0x1A2E8CC0)
#define PIPELINECAMERA_EXTENSION_RIGHT_1_OFFSET UNITYSDK_OFFSET(0x1A2E9C80)
#define PIPELINECAMERA_EXTENSION_RIGHT_OFFSET UNITYSDK_OFFSET(0x1A2E9A70)
#define PIPELINECAMERA_EXTENSION_ROTATEBYSHORTESTPATH_OFFSET UNITYSDK_OFFSET(0x1A2E7C70)
#define PIPELINECAMERA_EXTENSION_SIZEXZ_OFFSET UNITYSDK_OFFSET(0x1A2E9BF0)
#define PIPELINECAMERA_EXTENSION_TESTACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A2E74C0)
#define PIPELINECAMERA_EXTENSION_TESTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1A2E75F0)
#define PIPELINECAMERA_EXTENSION_TESTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A2E7520)
#define PIPELINECAMERA_EXTENSION_TESTEVALUATE_OFFSET UNITYSDK_OFFSET(0x1A2E76D0)
#define PIPELINECAMERA_EXTENSION_TESTFLUSH_OFFSET UNITYSDK_OFFSET(0x1A2E7740)
#define PIPELINECAMERA_EXTENSION_TESTPOSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1A2E7660)
#define PIPELINECAMERA_EXTENSION_TESTPREPARE_OFFSET UNITYSDK_OFFSET(0x1A2E7580)
#define PIPELINECAMERA_EXTENSION_TESTTOUCH_OFFSET UNITYSDK_OFFSET(0x1A2E77B0)
#define PIPELINECAMERA_EXTENSION_TESTTRACKINCOLLECT_OFFSET UNITYSDK_OFFSET(0x1A2E7810)
#define PIPELINECAMERA_EXTENSION_TOPRECISESTRING_OFFSET UNITYSDK_OFFSET(0x1A2E98F0)
#define PIPELINECAMERA_EXTENSION_TOTRANSLATIONROTATIONSCALE_OFFSET UNITYSDK_OFFSET(0x1A2E8830)
#define PIPELINECAMERA_EXTENSION_UPDATED_OFFSET UNITYSDK_OFFSET(0x1A2E6220)
#define PIPELINECAMERA_EXTENSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A2E7880)
#define PIPELINECAMERA_EXTENSION_UP_1_OFFSET UNITYSDK_OFFSET(0x1A2E9CE0)
#define PIPELINECAMERA_EXTENSION_UP_OFFSET UNITYSDK_OFFSET(0x1A2E9AD0)
#define PIPELINECAMERA_EXTENSION_VERTICAL_OFFSET UNITYSDK_OFFSET(0x1A2E9DA0)
#define PIPELINECAMERA_EXTENSION__GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_OFFSET UNITYSDK_OFFSET(0x1A2E6BC0)
#define PIPELINECAMERA_EXTENSION__GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_OFFSET UNITYSDK_OFFSET(0x1A2E6B60)

namespace PipelineCamera
{
	inline static constexpr unsigned int Extension_TypeDefinitionIndex = 34414;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::UnityEngine::Vector2>*>**)Il2CppClass::FromTypeDefinitionIndex(Extension_TypeDefinitionIndex)->GetStaticField(0x24B30);
		}
