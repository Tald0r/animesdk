...
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORECONFIG_GET_ACTIVECHANNEL_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORECONFIG_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORECONFIG_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x2D38E0)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORECONFIG_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x945250)

namespace PipelineCamera::SubModule
{
	inline static constexpr unsigned int LerpToTargetInCoreConfig_TypeDefinitionIndex = 34869;
