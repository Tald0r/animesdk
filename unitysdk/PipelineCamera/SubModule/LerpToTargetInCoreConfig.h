...
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORECONFIG_GET_ACTIVECHANNEL_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORECONFIG_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0x272280)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORECONFIG_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x302230)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORECONFIG_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x974DB0)

namespace PipelineCamera::SubModule
{
	inline static constexpr unsigned int LerpToTargetInCoreConfig_TypeDefinitionIndex = 35871;
