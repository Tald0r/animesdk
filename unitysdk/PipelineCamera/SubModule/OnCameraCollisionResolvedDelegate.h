...
#define PIPELINECAMERA_SUBMODULE_ONCAMERACOLLISIONRESOLVEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A8A0AA0)
#define PIPELINECAMERA_SUBMODULE_ONCAMERACOLLISIONRESOLVEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A8A0AF0)
#define PIPELINECAMERA_SUBMODULE_ONCAMERACOLLISIONRESOLVEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A8A0760)
#define PIPELINECAMERA_SUBMODULE_ONCAMERACOLLISIONRESOLVEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8A0750)

namespace PipelineCamera::SubModule
{
	inline static constexpr unsigned int OnCameraCollisionResolvedDelegate_TypeDefinitionIndex = 34866;
