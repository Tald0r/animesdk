...
#define PIPELINECAMERA_SUBMODULE_ONCAMERACOLLISIONRESOLVEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE7DA10)
#define PIPELINECAMERA_SUBMODULE_ONCAMERACOLLISIONRESOLVEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE7DA60)
#define PIPELINECAMERA_SUBMODULE_ONCAMERACOLLISIONRESOLVEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE7D6D0)
#define PIPELINECAMERA_SUBMODULE_ONCAMERACOLLISIONRESOLVEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE7D6B0)

namespace PipelineCamera::SubModule
{
	inline static constexpr unsigned int OnCameraCollisionResolvedDelegate_TypeDefinitionIndex = 35868;
