...
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_GET_CURRENTTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1AE7C9A0)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_LERP_1_OFFSET UNITYSDK_OFFSET(0x1AE7C480)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_LERP_2_OFFSET UNITYSDK_OFFSET(0x1AE7C5A0)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_LERP_3_OFFSET UNITYSDK_OFFSET(0x1AE7C6C0)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_LERP_4_OFFSET UNITYSDK_OFFSET(0x1AE7C7D0)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_LERP_5_OFFSET UNITYSDK_OFFSET(0x1AE7C8C0)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_LERP_OFFSET UNITYSDK_OFFSET(0x1AE7C350)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_PIPELINECAMERA_ICAMERASUBMODULEINTERNAL_PIPELINECAMERA_WORLDBASICCAMERADATA__ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1AE7CB70)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_PIPELINECAMERA_ICAMERASUBMODULEINTERNAL_PIPELINECAMERA_WORLDBASICCAMERADATA__COLLECT_OFFSET UNITYSDK_OFFSET(0x1AE7CCC0)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_PIPELINECAMERA_ICAMERASUBMODULEINTERNAL_PIPELINECAMERA_WORLDBASICCAMERADATA__DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1AE7CBE0)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_PIPELINECAMERA_ICAMERASUBMODULEINTERNAL_PIPELINECAMERA_WORLDBASICCAMERADATA__EVALUATE_OFFSET UNITYSDK_OFFSET(0x1AE7CD50)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_PIPELINECAMERA_ICAMERASUBMODULEINTERNAL_PIPELINECAMERA_WORLDBASICCAMERADATA__FLUSH_OFFSET UNITYSDK_OFFSET(0x1AE7D530)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_PIPELINECAMERA_ICAMERASUBMODULEINTERNAL_PIPELINECAMERA_WORLDBASICCAMERADATA__PREPARE_OFFSET UNITYSDK_OFFSET(0x1AE7CC50)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_PIPELINECAMERA_ICAMERASUBMODULEINTERNAL_PIPELINECAMERA_WORLDBASICCAMERADATA__TOUCH_OFFSET UNITYSDK_OFFSET(0x1AE7D5B0)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_PIPELINECAMERA_ICAMERASUBMODULE_PIPELINECAMERA_WORLDBASICCAMERADATA__GETACTIVECHANNEL_OFFSET UNITYSDK_OFFSET(0x1AE7CA20)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_PIPELINECAMERA_ICAMERASUBMODULE_PIPELINECAMERA_WORLDBASICCAMERADATA__GETDEBUGNAME_OFFSET UNITYSDK_OFFSET(0x1AE7CB00)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_PIPELINECAMERA_ICAMERASUBMODULE_PIPELINECAMERA_WORLDBASICCAMERADATA__GETPRIORITY_OFFSET UNITYSDK_OFFSET(0x1AE7C9B0)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE_PIPELINECAMERA_ICAMERASUBMODULE_PIPELINECAMERA_WORLDBASICCAMERADATA__PROCESSACTIVECHANNEL_OFFSET UNITYSDK_OFFSET(0x1AE7CA90)
#define PIPELINECAMERA_SUBMODULE_LERPTOTARGETINCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE7C2F0)

namespace PipelineCamera::SubModule
{
	inline static constexpr unsigned int LerpToTargetInCore_TypeDefinitionIndex = 35872;
