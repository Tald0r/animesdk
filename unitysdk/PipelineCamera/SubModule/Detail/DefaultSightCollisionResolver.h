...
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_EVALUATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x951EC0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_GETDESIREDDISTANCE_OFFSET UNITYSDK_OFFSET(0x951EE0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_GETSPHERERADIUS_OFFSET UNITYSDK_OFFSET(0x951EF0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_GET_HITCACHE_OFFSET UNITYSDK_OFFSET(0x1AB94960)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_GROWCACHE_OFFSET UNITYSDK_OFFSET(0x1AB94A80)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x951F00)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_COLLECT_OFFSET UNITYSDK_OFFSET(0x951FF0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x951F10)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_EVALUATE_OFFSET UNITYSDK_OFFSET(0x9520B0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_FLUSH_OFFSET UNITYSDK_OFFSET(0x9520D0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_PREPARE_OFFSET UNITYSDK_OFFSET(0x951F80)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_TOUCH_OFFSET UNITYSDK_OFFSET(0x952140)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x951E80)

namespace PipelineCamera::SubModule::Detail
{
	inline static constexpr unsigned int DefaultSightCollisionResolver_TypeDefinitionIndex = 35880;
