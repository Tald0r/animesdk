...
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x941D80)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_COLLECT_OFFSET UNITYSDK_OFFSET(0x941ED0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x941DF0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_EVALUATE_OFFSET UNITYSDK_OFFSET(0x941F40)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_FLUSH_OFFSET UNITYSDK_OFFSET(0x941FE0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_PREPARE_OFFSET UNITYSDK_OFFSET(0x941E60)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_TOUCH_OFFSET UNITYSDK_OFFSET(0x942050)

namespace PipelineCamera::SubModule::Detail
{
	inline static constexpr unsigned int DefaultVolumeCollisionResolver_TypeDefinitionIndex = 35881;
