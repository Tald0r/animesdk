...
#define PIPELINECAMERA_VECTOR2MATHOP_FROMTO_OFFSET UNITYSDK_OFFSET(0x1B5665C0)
#define PIPELINECAMERA_VECTOR2MATHOP_LINEARCOMBINE_1_OFFSET UNITYSDK_OFFSET(0x1B566720)
#define PIPELINECAMERA_VECTOR2MATHOP_LINEARCOMBINE_2_OFFSET UNITYSDK_OFFSET(0x1B566830)
#define PIPELINECAMERA_VECTOR2MATHOP_LINEARCOMBINE_OFFSET UNITYSDK_OFFSET(0x1B566650)
#define PIPELINECAMERA_VECTOR2MATHOP_MULTIPLYFLOATADD_OFFSET UNITYSDK_OFFSET(0x1B566520)
#define PIPELINECAMERA_VECTOR2MATHOP_MULTIPLYFLOAT_OFFSET UNITYSDK_OFFSET(0x1B566480)
#define PIPELINECAMERA_VECTOR2MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR2__FROMTO_OFFSET UNITYSDK_OFFSET(0x1B566FB0)
#define PIPELINECAMERA_VECTOR2MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR2__LINEARCOMBINE_1_OFFSET UNITYSDK_OFFSET(0x1B566CB0)
#define PIPELINECAMERA_VECTOR2MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR2__LINEARCOMBINE_2_OFFSET UNITYSDK_OFFSET(0x1B566E00)
#define PIPELINECAMERA_VECTOR2MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR2__LINEARCOMBINE_OFFSET UNITYSDK_OFFSET(0x1B566BA0)
#define PIPELINECAMERA_VECTOR2MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR2__MULTIPLYFLOATADD_OFFSET UNITYSDK_OFFSET(0x1B566AC0)
#define PIPELINECAMERA_VECTOR2MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR2__MULTIPLYFLOAT_OFFSET UNITYSDK_OFFSET(0x1B5669E0)
#define PIPELINECAMERA_VECTOR2MATHOP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5669B0)
#define PIPELINECAMERA_VECTOR2MATHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5669A0)

namespace PipelineCamera
{
	inline static constexpr unsigned int Vector2MathOp_TypeDefinitionIndex = 35550;
	...
	public:
		...
		{
			return (::PipelineCamera::Vector2MathOp**)Il2CppClass::FromTypeDefinitionIndex(Vector2MathOp_TypeDefinitionIndex)->GetStaticField(0x26500);
		}
