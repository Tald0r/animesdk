...
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCECORESPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x8B5500)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCECORESPACE__INVOKE_G__UPDATEASCURRENT_2_0_OFFSET UNITYSDK_OFFSET(0x197CBD80)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCECORESPACE__INVOKE_G__UPDATEASSOURCE_2_1_OFFSET UNITYSDK_OFFSET(0x197CB7D0)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraDeltaData_LockSourceCoreSpace_TypeDefinitionIndex = 35456;
