...
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCECORESPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x8813E0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCECORESPACE__INVOKE_G__UPDATEASCURRENT_2_0_OFFSET UNITYSDK_OFFSET(0x19318C20)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCECORESPACE__INVOKE_G__UPDATEASSOURCE_2_1_OFFSET UNITYSDK_OFFSET(0x19318670)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraDeltaData_LockSourceCoreSpace_TypeDefinitionIndex = 34454;
