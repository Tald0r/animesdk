...
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__FROMTO_OFFSET UNITYSDK_OFFSET(0x1B567600)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__LINEARCOMBINE_1_OFFSET UNITYSDK_OFFSET(0x1B567300)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__LINEARCOMBINE_2_OFFSET UNITYSDK_OFFSET(0x1B567450)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__LINEARCOMBINE_OFFSET UNITYSDK_OFFSET(0x1B567210)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__MULTIPLYFLOATADD_OFFSET UNITYSDK_OFFSET(0x1B567140)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__MULTIPLYFLOAT_OFFSET UNITYSDK_OFFSET(0x1B567080)
#define PIPELINECAMERA_VECTOR3MATHOP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5676C0)
#define PIPELINECAMERA_VECTOR3MATHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5676B0)

namespace PipelineCamera
{
	inline static constexpr unsigned int Vector3MathOp_TypeDefinitionIndex = 35551;
	...
	public:
		...
		{
			return (::PipelineCamera::Vector3MathOp**)Il2CppClass::FromTypeDefinitionIndex(Vector3MathOp_TypeDefinitionIndex)->GetStaticField(0x26510);
		}
