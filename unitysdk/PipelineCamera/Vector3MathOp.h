...
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__FROMTO_OFFSET UNITYSDK_OFFSET(0x1AF41220)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__LINEARCOMBINE_1_OFFSET UNITYSDK_OFFSET(0x1AF40F20)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__LINEARCOMBINE_2_OFFSET UNITYSDK_OFFSET(0x1AF41070)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__LINEARCOMBINE_OFFSET UNITYSDK_OFFSET(0x1AF40E30)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__MULTIPLYFLOATADD_OFFSET UNITYSDK_OFFSET(0x1AF40D60)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__MULTIPLYFLOAT_OFFSET UNITYSDK_OFFSET(0x1AF40CA0)
#define PIPELINECAMERA_VECTOR3MATHOP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AF412E0)
#define PIPELINECAMERA_VECTOR3MATHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF412D0)

namespace PipelineCamera
{
	inline static constexpr unsigned int Vector3MathOp_TypeDefinitionIndex = 34549;
	...
	public:
		...
		{
			return (::PipelineCamera::Vector3MathOp**)Il2CppClass::FromTypeDefinitionIndex(Vector3MathOp_TypeDefinitionIndex)->GetStaticField(0x24AE0);
		}
