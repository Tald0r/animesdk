...
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_EQUALS_OFFSET UNITYSDK_OFFSET(0x96CF90)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96D0D0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_GET_ISALL_OFFSET UNITYSDK_OFFSET(0x96CD10)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_GET_ISNONE_OFFSET UNITYSDK_OFFSET(0x96CC90)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x96CD90)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_NUMBITSET_OFFSET UNITYSDK_OFFSET(0x96D160)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_OP_BITWISEAND_OFFSET UNITYSDK_OFFSET(0x1AF3EF70)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_OP_BITWISEOR_OFFSET UNITYSDK_OFFSET(0x1AF3EEE0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AF3F000)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AF3F080)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_OP_ONESCOMPLEMENT_OFFSET UNITYSDK_OFFSET(0x1AF3EE60)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x96CE10)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AF3F4A0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128__CTOR_1_OFFSET UNITYSDK_OFFSET(0x96CEC0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128__CTOR_OFFSET UNITYSDK_OFFSET(0x2D6E20)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x96D350)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96D3C0)

namespace PipelineCamera::DataOrientated
{
	inline static constexpr unsigned int BitSet128_TypeDefinitionIndex = 34573;

	struct alignas(8) BitSet128
	{
		static ::PipelineCamera::DataOrientated::BitSet128* StaticGet_Empty()
		{
			return (::PipelineCamera::DataOrientated::BitSet128*)Il2CppClass::FromTypeDefinitionIndex(BitSet128_TypeDefinitionIndex)->GetStaticField(0x82F0);
		}
		static ::PipelineCamera::DataOrientated::BitSet128* StaticGet_Full()
		{
			return (::PipelineCamera::DataOrientated::BitSet128*)Il2CppClass::FromTypeDefinitionIndex(BitSet128_TypeDefinitionIndex)->GetStaticField(0x8300);
		}
