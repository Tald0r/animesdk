...
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_EQUALS_OFFSET UNITYSDK_OFFSET(0x99FDF0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x99FF30)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_GET_ISALL_OFFSET UNITYSDK_OFFSET(0x99FB70)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_GET_ISNONE_OFFSET UNITYSDK_OFFSET(0x99FAF0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x99FBF0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_NUMBITSET_OFFSET UNITYSDK_OFFSET(0x99FFC0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_OP_BITWISEAND_OFFSET UNITYSDK_OFFSET(0x1B565350)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_OP_BITWISEOR_OFFSET UNITYSDK_OFFSET(0x1B5652C0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B5653E0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B565460)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_OP_ONESCOMPLEMENT_OFFSET UNITYSDK_OFFSET(0x1B565240)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x99FC70)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B565880)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128__CTOR_1_OFFSET UNITYSDK_OFFSET(0x99FD20)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128__CTOR_OFFSET UNITYSDK_OFFSET(0x301710)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9A01B0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET128___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9A0220)

namespace PipelineCamera::DataOrientated
{
	inline static constexpr unsigned int BitSet128_TypeDefinitionIndex = 35575;

	struct alignas(8) BitSet128
	{
		static ::PipelineCamera::DataOrientated::BitSet128* StaticGet_Empty()
		{
			return (::PipelineCamera::DataOrientated::BitSet128*)Il2CppClass::FromTypeDefinitionIndex(BitSet128_TypeDefinitionIndex)->GetStaticField(0x8650);
		}
		static ::PipelineCamera::DataOrientated::BitSet128* StaticGet_Full()
		{
			return (::PipelineCamera::DataOrientated::BitSet128*)Il2CppClass::FromTypeDefinitionIndex(BitSet128_TypeDefinitionIndex)->GetStaticField(0x8660);
		}
