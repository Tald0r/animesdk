...
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_EQUALS_OFFSET UNITYSDK_OFFSET(0x930470)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9305E0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_GET_ISALL_OFFSET UNITYSDK_OFFSET(0x930300)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_GET_ISNONE_OFFSET UNITYSDK_OFFSET(0x930280)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x930380)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_NUMBITSET_OFFSET UNITYSDK_OFFSET(0x9306A0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_OP_BITWISEAND_OFFSET UNITYSDK_OFFSET(0x1A6186B0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_OP_BITWISEOR_OFFSET UNITYSDK_OFFSET(0x1A618610)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A618750)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A6187E0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_OP_ONESCOMPLEMENT_OFFSET UNITYSDK_OFFSET(0x1A618570)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x930430)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A618D90)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256__CTOR_1_OFFSET UNITYSDK_OFFSET(0x930440)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256__CTOR_OFFSET UNITYSDK_OFFSET(0x3B6380)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9309C0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x930A30)

namespace PipelineCamera::DataOrientated
{
	inline static constexpr unsigned int BitSet256_TypeDefinitionIndex = 35574;

	struct alignas(8) BitSet256
	{
		static ::PipelineCamera::DataOrientated::BitSet256* StaticGet_Full()
		{
			return (::PipelineCamera::DataOrientated::BitSet256*)Il2CppClass::FromTypeDefinitionIndex(BitSet256_TypeDefinitionIndex)->GetStaticField(0x8520);
		}
		static ::PipelineCamera::DataOrientated::BitSet256* StaticGet_Empty()
		{
			return (::PipelineCamera::DataOrientated::BitSet256*)Il2CppClass::FromTypeDefinitionIndex(BitSet256_TypeDefinitionIndex)->GetStaticField(0x8540);
		}
