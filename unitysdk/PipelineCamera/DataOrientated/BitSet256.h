...
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_EQUALS_OFFSET UNITYSDK_OFFSET(0x905010)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x905180)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_GET_ISALL_OFFSET UNITYSDK_OFFSET(0x904EA0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_GET_ISNONE_OFFSET UNITYSDK_OFFSET(0x904E20)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x904F20)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_NUMBITSET_OFFSET UNITYSDK_OFFSET(0x905240)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_OP_BITWISEAND_OFFSET UNITYSDK_OFFSET(0x1A0385F0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_OP_BITWISEOR_OFFSET UNITYSDK_OFFSET(0x1A038550)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A038690)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A038720)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_OP_ONESCOMPLEMENT_OFFSET UNITYSDK_OFFSET(0x1A0384B0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x904FD0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A038CD0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256__CTOR_1_OFFSET UNITYSDK_OFFSET(0x904FE0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256__CTOR_OFFSET UNITYSDK_OFFSET(0x38AAB0)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x905560)
#define PIPELINECAMERA_DATAORIENTATED_BITSET256___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9055D0)

namespace PipelineCamera::DataOrientated
{
	inline static constexpr unsigned int BitSet256_TypeDefinitionIndex = 34572;

	struct alignas(8) BitSet256
	{
		static ::PipelineCamera::DataOrientated::BitSet256* StaticGet_Empty()
		{
			return (::PipelineCamera::DataOrientated::BitSet256*)Il2CppClass::FromTypeDefinitionIndex(BitSet256_TypeDefinitionIndex)->GetStaticField(0x81C0);
		}
		static ::PipelineCamera::DataOrientated::BitSet256* StaticGet_Full()
		{
			return (::PipelineCamera::DataOrientated::BitSet256*)Il2CppClass::FromTypeDefinitionIndex(BitSet256_TypeDefinitionIndex)->GetStaticField(0x81E0);
		}
