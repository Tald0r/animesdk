...
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS3D_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x1AD30D30)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS3D_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AD30E20)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS3D_DRAW_OFFSET UNITYSDK_OFFSET(0x1AD30EB0)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS3D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD31240)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawPoints3D_TypeDefinitionIndex = 35475;
