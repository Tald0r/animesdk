...
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS3D_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x1A763450)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS3D_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A763540)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS3D_DRAW_OFFSET UNITYSDK_OFFSET(0x1A7635D0)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS3D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A763960)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawPoints3D_TypeDefinitionIndex = 34473;
