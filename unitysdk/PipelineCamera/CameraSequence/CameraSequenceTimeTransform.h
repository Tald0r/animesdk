...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_CREATE_OFFSET UNITYSDK_OFFSET(0x1A78D0A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_GETINVERSED_OFFSET UNITYSDK_OFFSET(0x93F8C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_ISIDENTITY_OFFSET UNITYSDK_OFFSET(0x93F820)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A78D390)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_TRANSFORMTIMEINTERVAL_OFFSET UNITYSDK_OFFSET(0x93F960)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_TRANSFORMTIME_OFFSET UNITYSDK_OFFSET(0x93F8D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A78D8C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM__TRANSFORMTIMEINTERVAL_G__TRANSFORMBOUND_8_0_OFFSET UNITYSDK_OFFSET(0x1A78D6E0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceTimeTransform_TypeDefinitionIndex = 34715;
	...
	struct alignas(4) CameraSequenceTimeTransform
	{
		...
		{
			return (::PipelineCamera::CameraSequence::CameraSequenceTimeTransform*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceTimeTransform_TypeDefinitionIndex)->GetStaticField(0x8370);
		}
