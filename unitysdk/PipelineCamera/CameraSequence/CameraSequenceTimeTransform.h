...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_CREATE_OFFSET UNITYSDK_OFFSET(0x1AD4AB30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_GETINVERSED_OFFSET UNITYSDK_OFFSET(0x96D890)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_ISIDENTITY_OFFSET UNITYSDK_OFFSET(0x96D7F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1AD4AE20)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_TRANSFORMTIMEINTERVAL_OFFSET UNITYSDK_OFFSET(0x96D930)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_TRANSFORMTIME_OFFSET UNITYSDK_OFFSET(0x96D8A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD4B350)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM__TRANSFORMTIMEINTERVAL_G__TRANSFORMBOUND_8_0_OFFSET UNITYSDK_OFFSET(0x1AD4B170)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceTimeTransform_TypeDefinitionIndex = 35717;
	...
	struct alignas(4) CameraSequenceTimeTransform
	{
		...
		{
			return (::PipelineCamera::CameraSequence::CameraSequenceTimeTransform*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceTimeTransform_TypeDefinitionIndex)->GetStaticField(0x86D0);
		}
