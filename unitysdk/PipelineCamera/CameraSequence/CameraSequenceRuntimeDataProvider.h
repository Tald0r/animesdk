...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCERUNTIMEDATAPROVIDER_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x19D08960)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCERUNTIMEDATAPROVIDER_GET_DATAPATH_OFFSET UNITYSDK_OFFSET(0x19D08870)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCERUNTIMEDATAPROVIDER_SETPATH_OFFSET UNITYSDK_OFFSET(0x19D088F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCERUNTIMEDATAPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D089F0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceRuntimeDataProvider_TypeDefinitionIndex = 34693;
