...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GETENDTIME_OFFSET UNITYSDK_OFFSET(0x1A079740)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1A0796D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_BEGINOFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A0794D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x1A079440)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1A0797F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_ENDOFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A0795D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1A079460)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_NOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x1A07A4E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_NOTIFYEND_OFFSET UNITYSDK_OFFSET(0x1A07AD30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_NOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x1A07A900)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_SET_BEGINOFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A079560)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_SET_ENDOFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A079660)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1A079800)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A07B150)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceNotifyStateEvent_TypeDefinitionIndex = 34677;
