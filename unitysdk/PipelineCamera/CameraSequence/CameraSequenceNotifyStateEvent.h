...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GETENDTIME_OFFSET UNITYSDK_OFFSET(0x1A645580)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1A645510)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_BEGINOFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A645310)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x1A645280)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1A645630)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_ENDOFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A645410)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1A6452A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_NOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x1A646320)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_NOTIFYEND_OFFSET UNITYSDK_OFFSET(0x1A646B70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_NOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x1A646740)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_SET_BEGINOFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A6453A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_SET_ENDOFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A6454A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1A645640)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A646F90)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceNotifyStateEvent_TypeDefinitionIndex = 35679;
