...
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A2E5530)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_FETCH_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x1A2E56F0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A2E4D10)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A2E5460)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A2E5470)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2E5800)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E57D0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A2E5840)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A2E5900)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FrameOnePointInFinalPolicy_LookAtByRotation_TypeDefinitionIndex = 34745;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInFinalPolicy_LookAtByRotation_TypeDefinitionIndex)->GetStaticField(0x8460);
		}
