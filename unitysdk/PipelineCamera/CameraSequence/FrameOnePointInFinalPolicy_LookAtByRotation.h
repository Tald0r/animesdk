...
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A8AF330)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_FETCH_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x1A8AF4F0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A8AEB10)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A8AF260)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A8AF270)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8AF600)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8AF5D0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A8AF640)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A8AF700)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FrameOnePointInFinalPolicy_LookAtByRotation_TypeDefinitionIndex = 35747;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInFinalPolicy_LookAtByRotation_TypeDefinitionIndex)->GetStaticField(0x87C0);
		}
