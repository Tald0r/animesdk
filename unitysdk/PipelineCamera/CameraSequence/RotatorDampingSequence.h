...
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATORDAMPINGSEQUENCE_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x1AA45AF0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATORDAMPINGSEQUENCE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AA45B80)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATORDAMPINGSEQUENCE_FETCH_LASTCAMERADATA_OFFSET UNITYSDK_OFFSET(0x1AA45D00)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATORDAMPINGSEQUENCE_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x1AA45E90)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATORDAMPINGSEQUENCE_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AA45F70)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATORDAMPINGSEQUENCE_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x1AA45E30)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATORDAMPINGSEQUENCE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1AA45F60)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATORDAMPINGSEQUENCE_ISLOOP_OFFSET UNITYSDK_OFFSET(0x1AA45F00)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATORDAMPINGSEQUENCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA46DD0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATORDAMPINGSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA46D90)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int RotatorDampingSequence_TypeDefinitionIndex = 35821;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(RotatorDampingSequence_TypeDefinitionIndex)->GetStaticField(0x8600);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_LastCameraData()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(RotatorDampingSequence_TypeDefinitionIndex)->GetStaticField(0x8608);
		}
