...
#define PIPELINECAMERA_CAMERASEQUENCE_IDENTITYSEQUENCE_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x183588C0)
#define PIPELINECAMERA_CAMERASEQUENCE_IDENTITYSEQUENCE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x18358780)
#define PIPELINECAMERA_CAMERASEQUENCE_IDENTITYSEQUENCE_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x183586A0)
#define PIPELINECAMERA_CAMERASEQUENCE_IDENTITYSEQUENCE_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x18358810)
#define PIPELINECAMERA_CAMERASEQUENCE_IDENTITYSEQUENCE_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x18358630)
#define PIPELINECAMERA_CAMERASEQUENCE_IDENTITYSEQUENCE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x18358770)
#define PIPELINECAMERA_CAMERASEQUENCE_IDENTITYSEQUENCE_ISLOOP_OFFSET UNITYSDK_OFFSET(0x18358710)
#define PIPELINECAMERA_CAMERASEQUENCE_IDENTITYSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18358920)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int IdentitySequence_TypeDefinitionIndex = 35833;
