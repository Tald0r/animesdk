...
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE_GET_ISROOT_OFFSET UNITYSDK_OFFSET(0x1B14C040)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE_GET_VARIABLE_OFFSET UNITYSDK_OFFSET(0x1B14C030)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B14C060)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B14C070)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14C050)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int ContextDependentAttribute_TypeDefinitionIndex = 35780;
