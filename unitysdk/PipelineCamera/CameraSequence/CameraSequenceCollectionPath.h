...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_CREATE_OFFSET UNITYSDK_OFFSET(0x1A39A9B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x911360)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_EQUALS_OFFSET UNITYSDK_OFFSET(0x911300)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x911430)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_GET_VARIABLE_OFFSET UNITYSDK_OFFSET(0x9112D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_GET_WORKSPACE_OFFSET UNITYSDK_OFFSET(0x3B9170)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_TOVARIABLESTRING_OFFSET UNITYSDK_OFFSET(0x9112F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x911440)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9114C0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceCollectionPath_TypeDefinitionIndex = 34777;
