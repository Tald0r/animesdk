...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_CREATE_OFFSET UNITYSDK_OFFSET(0x1A95E860)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x93D9D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_EQUALS_OFFSET UNITYSDK_OFFSET(0x93D970)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x93DAA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_GET_VARIABLE_OFFSET UNITYSDK_OFFSET(0x93D940)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_GET_WORKSPACE_OFFSET UNITYSDK_OFFSET(0x43BA20)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_TOVARIABLESTRING_OFFSET UNITYSDK_OFFSET(0x93D960)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x93DAB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x93DB30)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceCollectionPath_TypeDefinitionIndex = 35779;
