...
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x18358510)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_COLLECTTIMEATTENUATION_OFFSET UNITYSDK_OFFSET(0x18355F20)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x183568A0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETFORWARDTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x183556C0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETPITCHTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x18355800)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x183567D0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETRIGHTTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x18355720)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETROLLTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x183558F0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x18356A20)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x18356770)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x18355970)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETUPTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x18355790)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETYAWTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x18355870)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x18356890)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISFORWARDACTIVE_OFFSET UNITYSDK_OFFSET(0x183553C0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISPITCHACTIVE_OFFSET UNITYSDK_OFFSET(0x18355540)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISRIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x18355440)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISROLLACTIVE_OFFSET UNITYSDK_OFFSET(0x18355640)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISUPACTIVE_OFFSET UNITYSDK_OFFSET(0x183554C0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISYAWACTIVE_OFFSET UNITYSDK_OFFSET(0x183555C0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_ISLOOP_OFFSET UNITYSDK_OFFSET(0x18356830)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_PROCESSTIMEATTENUATION_OFFSET UNITYSDK_OFFSET(0x18356460)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x183585A0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int DefaultShakeSequence_TypeDefinitionIndex = 35829;
