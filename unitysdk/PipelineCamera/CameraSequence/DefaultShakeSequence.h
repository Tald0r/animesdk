...
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x17C6FE10)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_COLLECTTIMEATTENUATION_OFFSET UNITYSDK_OFFSET(0x17C6D820)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x17C6E1A0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETFORWARDTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x17C6CFC0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETPITCHTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x17C6D100)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x17C6E0D0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETRIGHTTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x17C6D020)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETROLLTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x17C6D1F0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x17C6E320)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x17C6E070)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x17C6D270)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETUPTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x17C6D090)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETYAWTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x17C6D170)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x17C6E190)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISFORWARDACTIVE_OFFSET UNITYSDK_OFFSET(0x17C6CCC0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISPITCHACTIVE_OFFSET UNITYSDK_OFFSET(0x17C6CE40)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISRIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x17C6CD40)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISROLLACTIVE_OFFSET UNITYSDK_OFFSET(0x17C6CF40)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISUPACTIVE_OFFSET UNITYSDK_OFFSET(0x17C6CDC0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISYAWACTIVE_OFFSET UNITYSDK_OFFSET(0x17C6CEC0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_ISLOOP_OFFSET UNITYSDK_OFFSET(0x17C6E130)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_PROCESSTIMEATTENUATION_OFFSET UNITYSDK_OFFSET(0x17C6DD60)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17C6FEA0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int DefaultShakeSequence_TypeDefinitionIndex = 34827;
