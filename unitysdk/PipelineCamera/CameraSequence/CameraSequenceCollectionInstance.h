...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_ADVANCE_OFFSET UNITYSDK_OFFSET(0x17C6AF90)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_COLLECTEVENTINTERNAL_OFFSET UNITYSDK_OFFSET(0x17C67470)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_CONSUMEDELTATIME_OFFSET UNITYSDK_OFFSET(0x17C68870)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_CONSUMEONINTERRUPT_OFFSET UNITYSDK_OFFSET(0x17C695A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_CONSUMEONSTOP_OFFSET UNITYSDK_OFFSET(0x17C69610)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETCURRENTSECTION_OFFSET UNITYSDK_OFFSET(0x17C6A790)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETINSTANCEID_OFFSET UNITYSDK_OFFSET(0x17C6A570)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETNEXTSECTIONINDEX_OFFSET UNITYSDK_OFFSET(0x17C6AC90)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETNEXTSECTIONNAME_OFFSET UNITYSDK_OFFSET(0x17C6AD30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETNEXTSECTION_OFFSET UNITYSDK_OFFSET(0x17C6A9F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETPLAYRATE_OFFSET UNITYSDK_OFFSET(0x17C6A630)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x17C6A5D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x17C67090)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_INITIALIZE_1_OFFSET UNITYSDK_OFFSET(0x17C69A20)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x17C69740)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x17C6A4A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_ISSTOPPED_OFFSET UNITYSDK_OFFSET(0x17C692B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_ISVALID_OFFSET UNITYSDK_OFFSET(0x17C673F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_JUMPTOSECTION_1_OFFSET UNITYSDK_OFFSET(0x17C69FA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_JUMPTOSECTION_OFFSET UNITYSDK_OFFSET(0x17C69BC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_PAUSE_OFFSET UNITYSDK_OFFSET(0x17C69680)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_PLAY_1_OFFSET UNITYSDK_OFFSET(0x17C68AF0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_PLAY_OFFSET UNITYSDK_OFFSET(0x17C68970)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_REBUILDSECTIONGRAPH_OFFSET UNITYSDK_OFFSET(0x17C670A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_RESUME_OFFSET UNITYSDK_OFFSET(0x17C696E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETNEXTSECTIONBYID_OFFSET UNITYSDK_OFFSET(0x17C6A300)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETNEXTSECTIONBYNAME_OFFSET UNITYSDK_OFFSET(0x17C6A100)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETNEXTSECTIONGRAPH_OFFSET UNITYSDK_OFFSET(0x17C6A3C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETONSTOPPED_OFFSET UNITYSDK_OFFSET(0x17C68C90)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETPLAYRATE_OFFSET UNITYSDK_OFFSET(0x17C6A710)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x17C6A690)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETTIMESCALE_OFFSET UNITYSDK_OFFSET(0x17C68D10)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_STEPOVERSECTION_OFFSET UNITYSDK_OFFSET(0x17C683C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_STOP_1_OFFSET UNITYSDK_OFFSET(0x17C68EE0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_STOP_OFFSET UNITYSDK_OFFSET(0x17C68D80)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE__ADVANCE_B__57_0_OFFSET UNITYSDK_OFFSET(0x17C6C0C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x17C6C060)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17C6BE60)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceCollectionInstance_TypeDefinitionIndex = 34649;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceCollectionInstance_TypeDefinitionIndex)->GetStaticField(0x8200);
		}
		static ::System::Int32* StaticGet__instanceCounter()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceCollectionInstance_TypeDefinitionIndex)->GetStaticField(0x8208);
		}
		...
		::PipelineCamera::CameraSequence::ICameraSequenceCollectionPlayer* _player; // 0x18
		::PipelineCamera::CameraSequence::CameraSequenceEventQueue* _eventQueue; // 0x20
		::System::Action* _onStopped; // 0x28
		::System::Collections::Generic::List_1<::PipelineCamera::CameraSequence::CameraSequenceEventOperation>* _operationBuffer; // 0x30
		::PipelineCamera::CameraSequence::CameraSequenceContext* _context; // 0x38
		::Il2CppArray<::System::Int32>* _nextSections; // 0x40
		::System::Action* _onInterrupted; // 0x48
		::System::Func_1<::System::Single>* _timeScale; // 0x50
		::System::Boolean _isPlaying; // 0x58
		::System::Single _playRate; // 0x5C
		::System::Single _remainingTime; // 0x60
		::System::Single _remainingTimeToPlay; // 0x64
		::System::Single _position; // 0x68
		::Foundation::Unreal::FName _sectionGraph; // 0x6C
