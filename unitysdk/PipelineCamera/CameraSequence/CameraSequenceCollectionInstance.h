...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_ADVANCE_OFFSET UNITYSDK_OFFSET(0x18353690)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_COLLECTEVENTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1834FB80)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_CONSUMEDELTATIME_OFFSET UNITYSDK_OFFSET(0x18350F70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_CONSUMEONINTERRUPT_OFFSET UNITYSDK_OFFSET(0x18351CA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_CONSUMEONSTOP_OFFSET UNITYSDK_OFFSET(0x18351D10)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETCURRENTSECTION_OFFSET UNITYSDK_OFFSET(0x18352E90)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETINSTANCEID_OFFSET UNITYSDK_OFFSET(0x18352C70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETNEXTSECTIONINDEX_OFFSET UNITYSDK_OFFSET(0x18353390)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETNEXTSECTIONNAME_OFFSET UNITYSDK_OFFSET(0x18353430)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETNEXTSECTION_OFFSET UNITYSDK_OFFSET(0x183530F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETPLAYRATE_OFFSET UNITYSDK_OFFSET(0x18352D30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x18352CD0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1834F7A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_INITIALIZE_1_OFFSET UNITYSDK_OFFSET(0x18352120)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x18351E40)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x18352BA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_ISSTOPPED_OFFSET UNITYSDK_OFFSET(0x183519B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_ISVALID_OFFSET UNITYSDK_OFFSET(0x1834FB00)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_JUMPTOSECTION_1_OFFSET UNITYSDK_OFFSET(0x183526A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_JUMPTOSECTION_OFFSET UNITYSDK_OFFSET(0x183522C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_PAUSE_OFFSET UNITYSDK_OFFSET(0x18351D80)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_PLAY_1_OFFSET UNITYSDK_OFFSET(0x183511F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_PLAY_OFFSET UNITYSDK_OFFSET(0x18351070)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_REBUILDSECTIONGRAPH_OFFSET UNITYSDK_OFFSET(0x1834F7B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_RESUME_OFFSET UNITYSDK_OFFSET(0x18351DE0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETNEXTSECTIONBYID_OFFSET UNITYSDK_OFFSET(0x18352A00)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETNEXTSECTIONBYNAME_OFFSET UNITYSDK_OFFSET(0x18352800)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETNEXTSECTIONGRAPH_OFFSET UNITYSDK_OFFSET(0x18352AC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETONSTOPPED_OFFSET UNITYSDK_OFFSET(0x18351390)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETPLAYRATE_OFFSET UNITYSDK_OFFSET(0x18352E10)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x18352D90)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETTIMESCALE_OFFSET UNITYSDK_OFFSET(0x18351410)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_STEPOVERSECTION_OFFSET UNITYSDK_OFFSET(0x18350AC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_STOP_1_OFFSET UNITYSDK_OFFSET(0x183515E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_STOP_OFFSET UNITYSDK_OFFSET(0x18351480)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE__ADVANCE_B__57_0_OFFSET UNITYSDK_OFFSET(0x183547C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18354760)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18354560)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceCollectionInstance_TypeDefinitionIndex = 35651;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceCollectionInstance_TypeDefinitionIndex)->GetStaticField(0x8560);
		}
		static ::Foundation::Unreal::FName* StaticGet_SequencePlayerContext()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceCollectionInstance_TypeDefinitionIndex)->GetStaticField(0x8564);
		}
		// static const ::System::Int32 MaxStepsPerFrame = 0x10; // 0x0
		// static const ::System::String* SequencePlayerContextName; // 0x0
		::Il2CppArray<::System::Int32>* _nextSections; // 0x10
		::PipelineCamera::CameraSequence::ICameraSequenceCollection* _collection; // 0x18
		::System::Action* _onInterrupted; // 0x20
		::System::Collections::Generic::List_1<::PipelineCamera::CameraSequence::CameraSequenceEventOperation>* _operationBuffer; // 0x28
		::PipelineCamera::CameraSequence::ICameraSequenceCollectionPlayer* _player; // 0x30
		::System::Func_1<::System::Single>* _timeScale; // 0x38
		::PipelineCamera::CameraSequence::CameraSequenceContext* _context; // 0x40
		::System::Action* _onStopped; // 0x48
		::PipelineCamera::CameraSequence::CameraSequenceEventQueue* _eventQueue; // 0x50
		::System::Single _remainingTime; // 0x58
		::System::Single _remainingTimeToPlay; // 0x5C
		::Foundation::Unreal::FName _sectionGraph; // 0x60
		::System::Boolean _isPlaying; // 0x68
		::System::Single _position; // 0x6C
		::System::Single _playRate; // 0x70
		::System::Int32 _instanceId; // 0x74
