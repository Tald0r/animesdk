...
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x1A790130)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A7901C0)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_FETCH_VARIABLE_OFFSET UNITYSDK_OFFSET(0x1A790340)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x1A7904F0)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A7905D0)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x1A790480)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A7905C0)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_ISLOOP_OFFSET UNITYSDK_OFFSET(0x1A790560)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A790D00)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A790C80)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int VariableSequence_TypeDefinitionIndex = 34820;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(VariableSequence_TypeDefinitionIndex)->GetStaticField(0x83B0);
		}
