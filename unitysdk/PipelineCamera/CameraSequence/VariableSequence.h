...
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x1AD4DBC0)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AD4DC50)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_FETCH_VARIABLE_OFFSET UNITYSDK_OFFSET(0x1AD4DDD0)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x1AD4DF80)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD4E060)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x1AD4DF10)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1AD4E050)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_ISLOOP_OFFSET UNITYSDK_OFFSET(0x1AD4DFF0)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD4E790)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD4E710)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int VariableSequence_TypeDefinitionIndex = 35822;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(VariableSequence_TypeDefinitionIndex)->GetStaticField(0x8710);
		}
