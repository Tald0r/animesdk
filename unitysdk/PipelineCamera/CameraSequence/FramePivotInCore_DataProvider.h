...
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEPIVOTINCORE_DATAPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA45AD0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FramePivotInCore_DataProvider_TypeDefinitionIndex = 35817;
