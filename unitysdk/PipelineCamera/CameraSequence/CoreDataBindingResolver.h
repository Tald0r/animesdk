...
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_GETCONTEXTTYPE_OFFSET UNITYSDK_OFFSET(0x1A735410)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_GET_CONTEXTTYPECLASS_OFFSET UNITYSDK_OFFSET(0x1A7350C0)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_PIPELINECAMERA_CAMERASEQUENCE_ICAMERASEQUENCEBINDINGRESOLVER_RESOLVEDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A7356D0)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_PIPELINECAMERA_CAMERASEQUENCE_ICAMERASEQUENCEBINDINGRESOLVER_RESOLVEEXTERNAL_OFFSET UNITYSDK_OFFSET(0x1A735550)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_RESOLVEDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A7352D0)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_RESOLVEEXTERNAL_OFFSET UNITYSDK_OFFSET(0x1A735190)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_SET_CONTEXTTYPECLASS_OFFSET UNITYSDK_OFFSET(0x1A7350E0)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A735480)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CoreDataBindingResolver_TypeDefinitionIndex = 34718;
