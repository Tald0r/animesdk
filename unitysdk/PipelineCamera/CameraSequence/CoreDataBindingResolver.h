...
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_GETCONTEXTTYPE_OFFSET UNITYSDK_OFFSET(0x1ACD8B50)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_GET_CONTEXTTYPECLASS_OFFSET UNITYSDK_OFFSET(0x1ACD8800)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_PIPELINECAMERA_CAMERASEQUENCE_ICAMERASEQUENCEBINDINGRESOLVER_RESOLVEDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1ACD8E10)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_PIPELINECAMERA_CAMERASEQUENCE_ICAMERASEQUENCEBINDINGRESOLVER_RESOLVEEXTERNAL_OFFSET UNITYSDK_OFFSET(0x1ACD8C90)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_RESOLVEDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1ACD8A10)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_RESOLVEEXTERNAL_OFFSET UNITYSDK_OFFSET(0x1ACD88D0)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_SET_CONTEXTTYPECLASS_OFFSET UNITYSDK_OFFSET(0x1ACD8820)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACD8BC0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CoreDataBindingResolver_TypeDefinitionIndex = 35720;
