...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_COLLECTEVENTS_OFFSET UNITYSDK_OFFSET(0x1B14B810)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_GET_EVENTS_OFFSET UNITYSDK_OFFSET(0x1B14B3B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_LINK_OFFSET UNITYSDK_OFFSET(0x1B14B6D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_ONTRACKCHANGED_OFFSET UNITYSDK_OFFSET(0x1B14B5A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_SORTEVENTS_OFFSET UNITYSDK_OFFSET(0x1B14B3C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14BB90)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEventTrack_TypeDefinitionIndex = 35683;
