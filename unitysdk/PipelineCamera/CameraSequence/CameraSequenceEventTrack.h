...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_COLLECTEVENTS_OFFSET UNITYSDK_OFFSET(0x1AB03320)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_GET_EVENTS_OFFSET UNITYSDK_OFFSET(0x1AB02EC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_LINK_OFFSET UNITYSDK_OFFSET(0x1AB031E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_ONTRACKCHANGED_OFFSET UNITYSDK_OFFSET(0x1AB030B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_SORTEVENTS_OFFSET UNITYSDK_OFFSET(0x1AB02ED0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB036B0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEventTrack_TypeDefinitionIndex = 34681;
