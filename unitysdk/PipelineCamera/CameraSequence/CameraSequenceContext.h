...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_CLEARENVIRONMENT_OFFSET UNITYSDK_OFFSET(0x1B14AFF0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_ENSUREWORKSPACEID_OFFSET UNITYSDK_OFFSET(0x1B14A980)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_GETBLENDINSETTING_OFFSET UNITYSDK_OFFSET(0x1B14B240)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_GETBLENDOUTSETTING_OFFSET UNITYSDK_OFFSET(0x1B14B2B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_GETINTERNALENVIRONMENT_OFFSET UNITYSDK_OFFSET(0x1B14AC20)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_GETINTERNALIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1B14AB40)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_ISSHAREDCONTEXT_OFFSET UNITYSDK_OFFSET(0x1B14AAE0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SCOPEDWORKSPACE_1_OFFSET UNITYSDK_OFFSET(0x1B14AE80)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SCOPEDWORKSPACE_OFFSET UNITYSDK_OFFSET(0x1B14ACB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SETBINDINGRESOLVER_OFFSET UNITYSDK_OFFSET(0x1B14B1D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14A590)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceContext_TypeDefinitionIndex = 35786;
	...
	public:
		...
		::Il2CppArray<::PipelineCamera::CameraSequence::CameraSequenceEnvironment*>* _environment; // 0x20
