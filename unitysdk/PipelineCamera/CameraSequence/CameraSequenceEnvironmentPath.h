...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x90A9F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_EQUALS_OFFSET UNITYSDK_OFFSET(0x90A9B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x90AAA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_GETPOPPED_OFFSET UNITYSDK_OFFSET(0x90A8E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_GETPUSHED_OFFSET UNITYSDK_OFFSET(0x90A890)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x90A7D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x90A9A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x90A990)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_POP_OFFSET UNITYSDK_OFFSET(0x90A8C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_PUSH_OFFSET UNITYSDK_OFFSET(0x90A7E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1A32F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x90ABB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x90AB60)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEnvironmentPath_TypeDefinitionIndex = 34805;
	...
	struct alignas(8) CameraSequenceEnvironmentPath
	{
		...
		{
			return (::PipelineCamera::CameraSequence::CameraSequenceEnvironmentPath*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceEnvironmentPath_TypeDefinitionIndex)->GetStaticField(0x24980);
		}
