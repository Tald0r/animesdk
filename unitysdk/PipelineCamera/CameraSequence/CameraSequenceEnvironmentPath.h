...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9366B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_EQUALS_OFFSET UNITYSDK_OFFSET(0x936670)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x936760)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_GETPOPPED_OFFSET UNITYSDK_OFFSET(0x9365A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_GETPUSHED_OFFSET UNITYSDK_OFFSET(0x936550)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x936490)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x936660)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x936650)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_POP_OFFSET UNITYSDK_OFFSET(0x936580)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_PUSH_OFFSET UNITYSDK_OFFSET(0x9364A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7311A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x936870)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x936820)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEnvironmentPath_TypeDefinitionIndex = 35807;
	...
	struct alignas(8) CameraSequenceEnvironmentPath
	{
		...
		{
			return (::PipelineCamera::CameraSequence::CameraSequenceEnvironmentPath*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceEnvironmentPath_TypeDefinitionIndex)->GetStaticField(0x263B0);
		}
