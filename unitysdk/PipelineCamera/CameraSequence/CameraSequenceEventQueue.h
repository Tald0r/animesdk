...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_ADDNOTIFYTRIGGEREVENT_OFFSET UNITYSDK_OFFSET(0x18355220)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_ADDSTATEBEGINEVENT_OFFSET UNITYSDK_OFFSET(0x183550A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_ADDSTATEENDEVENT_OFFSET UNITYSDK_OFFSET(0x18355160)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_ADDSTATETICKEVENT_OFFSET UNITYSDK_OFFSET(0x183552E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_CONSUMEACTIVESTATES_OFFSET UNITYSDK_OFFSET(0x18351A20)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_HANDLEEXPIREOPERATION_OFFSET UNITYSDK_OFFSET(0x18354AC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_HANDLETRIGGEROPERATION_OFFSET UNITYSDK_OFFSET(0x18354C80)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_INVOKE_OFFSET UNITYSDK_OFFSET(0x183547F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1834FD50)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18354600)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEventQueue_TypeDefinitionIndex = 35685;
	...
	public:
		...
		::System::Collections::Generic::List_1<::PipelineCamera::CameraSequence::CameraSequenceEventQueue_Operation>* _buffer; // 0x20
