...
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_SEQUENCESEGMENTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B1500A0)
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_SEQUENCESEGMENTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B150130)
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_SEQUENCESEGMENTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B150140)

namespace PipelineCamera::CameraSequence::Timeline
{
	inline static constexpr unsigned int SequenceSegmentClip_TypeDefinitionIndex = 81151;
