...
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_EVENTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B14FD10)
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_EVENTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14FDA0)

namespace PipelineCamera::CameraSequence::Timeline
{
	inline static constexpr unsigned int EventClip_TypeDefinitionIndex = 81143;
