...
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_EVENTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B76ECC0)
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_EVENTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76ED50)

namespace PipelineCamera::CameraSequence::Timeline
{
	inline static constexpr unsigned int EventClip_TypeDefinitionIndex = 83184;
