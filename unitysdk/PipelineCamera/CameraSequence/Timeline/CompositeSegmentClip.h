...
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_COMPOSITESEGMENTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B14FC40)
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_COMPOSITESEGMENTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B14FCD0)
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_COMPOSITESEGMENTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14FCE0)

namespace PipelineCamera::CameraSequence::Timeline
{
	inline static constexpr unsigned int CompositeSegmentClip_TypeDefinitionIndex = 81142;
