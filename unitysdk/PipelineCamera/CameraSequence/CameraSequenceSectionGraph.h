...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONGRAPH_CHECKGRAPHNAME_OFFSET UNITYSDK_OFFSET(0x197B4980)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONGRAPH_GETALLVERTICES_OFFSET UNITYSDK_OFFSET(0x197B48D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONGRAPH_GETFROMREMAININGVERTICES_OFFSET UNITYSDK_OFFSET(0x197B4820)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONGRAPH_GETFROMVERTICES_OFFSET UNITYSDK_OFFSET(0x197B4580)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONGRAPH_GETGRAPHNAME_OFFSET UNITYSDK_OFFSET(0x197B3F50)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONGRAPH_GETSECTIONINDEX_OFFSET UNITYSDK_OFFSET(0x197B4420)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONGRAPH_GETSECTIONNAME_OFFSET UNITYSDK_OFFSET(0x197B4290)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONGRAPH_GETTOVERTICES_OFFSET UNITYSDK_OFFSET(0x197B46D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONGRAPH_LINK_OFFSET UNITYSDK_OFFSET(0x197B4000)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONGRAPH_ONEDGECHANGED_OFFSET UNITYSDK_OFFSET(0x197B40D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x197B4AA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONGRAPH__LINK_B__4_0_OFFSET UNITYSDK_OFFSET(0x197B4B00)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceSectionGraph_TypeDefinitionIndex = 35711;
