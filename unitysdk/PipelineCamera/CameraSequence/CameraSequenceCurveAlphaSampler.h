...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER_CHECKEXTERNALVARIABLES_OFFSET UNITYSDK_OFFSET(0x1AD4A820)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AD4A930)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1AD4A6B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER_GETEXTERNALVARIABLES_OFFSET UNITYSDK_OFFSET(0x1AD4A7B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1AD4A920)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER_SETPATH_OFFSET UNITYSDK_OFFSET(0x1AD4A8A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD4A9C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AD4AA00)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1AD4AAC0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceCurveAlphaSampler_TypeDefinitionIndex = 35707;
