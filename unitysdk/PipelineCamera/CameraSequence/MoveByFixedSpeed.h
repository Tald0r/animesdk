...
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYFIXEDSPEED_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x197B4BB0)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYFIXEDSPEED_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x197B4C40)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYFIXEDSPEED_FETCH_SPEED_OFFSET UNITYSDK_OFFSET(0x197B4DC0)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYFIXEDSPEED_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x197B4F60)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYFIXEDSPEED_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x197B5020)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYFIXEDSPEED_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x197B4EF0)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYFIXEDSPEED_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x197B5430)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYFIXEDSPEED_ISLOOP_OFFSET UNITYSDK_OFFSET(0x197B4FC0)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYFIXEDSPEED__CCTOR_OFFSET UNITYSDK_OFFSET(0x197B5480)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYFIXEDSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x197B5440)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int MoveByFixedSpeed_TypeDefinitionIndex = 35812;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(MoveByFixedSpeed_TypeDefinitionIndex)->GetStaticField(0x8590);
		}
