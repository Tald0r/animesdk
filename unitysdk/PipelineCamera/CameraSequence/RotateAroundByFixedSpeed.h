...
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEAROUNDBYFIXEDSPEED_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x1AB92A80)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEAROUNDBYFIXEDSPEED_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AB92B10)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEAROUNDBYFIXEDSPEED_FETCH_ANGLESPEED_OFFSET UNITYSDK_OFFSET(0x1AB92C90)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEAROUNDBYFIXEDSPEED_FETCH_AXIS_OFFSET UNITYSDK_OFFSET(0x1AB92D70)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEAROUNDBYFIXEDSPEED_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x1AB92F10)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEAROUNDBYFIXEDSPEED_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AB92FE0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEAROUNDBYFIXEDSPEED_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x1AB92EA0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEAROUNDBYFIXEDSPEED_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1AB93690)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEAROUNDBYFIXEDSPEED_ISLOOP_OFFSET UNITYSDK_OFFSET(0x1AB92F80)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEAROUNDBYFIXEDSPEED__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB936F0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEAROUNDBYFIXEDSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB936A0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int RotateAroundByFixedSpeed_TypeDefinitionIndex = 35813;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(RotateAroundByFixedSpeed_TypeDefinitionIndex)->GetStaticField(0x8750);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_axis()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(RotateAroundByFixedSpeed_TypeDefinitionIndex)->GetStaticField(0x8758);
		}
