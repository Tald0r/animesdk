...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GETENDTIME_OFFSET UNITYSDK_OFFSET(0x1A30E050)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1A30DFE0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1A30E0C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A30DEE0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GET_TRIGGERTIME_OFFSET UNITYSDK_OFFSET(0x1A30DEC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1A30E5A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_SET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A30DF70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1A30E0D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A30E9B0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceInternalNotifyEvent_TypeDefinitionIndex = 35678;
