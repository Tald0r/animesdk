...
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATACOMPOSITESEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A89E740)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CoreDataCompositeSegment_TypeDefinitionIndex = 34721;
