...
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AE7AF10)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_FETCH_BIAS_OFFSET UNITYSDK_OFFSET(0x1AE7B290)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_FETCH_PERIOD_OFFSET UNITYSDK_OFFSET(0x1AE7B0D0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_FETCH_PHASE_OFFSET UNITYSDK_OFFSET(0x1AE7B1B0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_GETDATA_OFFSET UNITYSDK_OFFSET(0x1AE7A620)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1AE7AE40)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_SETPATH_OFFSET UNITYSDK_OFFSET(0x1AE7AE50)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE7B380)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE7B370)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AE7B430)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1AE7B4F0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int AlphaGeneratorPolicy_Sinusoidal_TypeDefinitionIndex = 35733;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Sinusoidal_TypeDefinitionIndex)->GetStaticField(0x87D0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_phase()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Sinusoidal_TypeDefinitionIndex)->GetStaticField(0x87D8);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_bias()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Sinusoidal_TypeDefinitionIndex)->GetStaticField(0x87E0);
		}
