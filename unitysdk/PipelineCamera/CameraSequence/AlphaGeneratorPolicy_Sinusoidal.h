...
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A89DFC0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_FETCH_BIAS_OFFSET UNITYSDK_OFFSET(0x1A89E340)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_FETCH_PERIOD_OFFSET UNITYSDK_OFFSET(0x1A89E180)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_FETCH_PHASE_OFFSET UNITYSDK_OFFSET(0x1A89E260)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A89D6D0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A89DEF0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A89DF00)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A89E430)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A89E420)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A89E4E0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A89E5A0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int AlphaGeneratorPolicy_Sinusoidal_TypeDefinitionIndex = 34731;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Sinusoidal_TypeDefinitionIndex)->GetStaticField(0x8470);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_period()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Sinusoidal_TypeDefinitionIndex)->GetStaticField(0x8478);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_phase()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Sinusoidal_TypeDefinitionIndex)->GetStaticField(0x8480);
		}
