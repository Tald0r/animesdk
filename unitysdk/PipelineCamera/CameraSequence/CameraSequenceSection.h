...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTION_GETSECTIONNAME_OFFSET UNITYSDK_OFFSET(0x1A30EE30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTION_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1A30EBA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTION_GET_LINKEDCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1A30EB60)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTION_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1A30EE20)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTION_ONLINKTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x1A30EEE0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A30F040)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceSection_TypeDefinitionIndex = 35708;
