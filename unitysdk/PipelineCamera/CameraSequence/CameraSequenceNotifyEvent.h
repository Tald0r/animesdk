...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GETENDTIME_OFFSET UNITYSDK_OFFSET(0x1A39B2C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1A39B250)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1A39B330)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A39B150)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GET_TRIGGERTIME_OFFSET UNITYSDK_OFFSET(0x1A39B130)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1A39B810)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_SET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A39B1E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1A39B340)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A39BC30)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceNotifyEvent_TypeDefinitionIndex = 34675;
