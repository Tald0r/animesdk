...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GETENDTIME_OFFSET UNITYSDK_OFFSET(0x1A95F170)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1A95F100)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1A95F1E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A95F000)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GET_TRIGGERTIME_OFFSET UNITYSDK_OFFSET(0x1A95EFE0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1A95F6C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_SET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1A95F090)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1A95F1F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A95FAE0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceNotifyEvent_TypeDefinitionIndex = 35677;
