...
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x183585F0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int DeltaEulerPolicy_TypeDefinitionIndex = 35762;
