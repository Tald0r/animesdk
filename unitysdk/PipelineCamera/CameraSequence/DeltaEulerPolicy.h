...
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x17C6FEF0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int DeltaEulerPolicy_TypeDefinitionIndex = 34760;
