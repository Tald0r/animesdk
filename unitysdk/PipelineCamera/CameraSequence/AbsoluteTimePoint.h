...
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x1A448AD0)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_GETTIME_OFFSET UNITYSDK_OFFSET(0x1A4486B0)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_GET_PLAYLENGTH_OFFSET UNITYSDK_OFFSET(0x1A448620)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1A448610)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_GET_TIME_OFFSET UNITYSDK_OFFSET(0x1A448570)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_ONTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x1A448630)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_SETSEGMENT_OFFSET UNITYSDK_OFFSET(0x1A448830)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_SETTIME_OFFSET UNITYSDK_OFFSET(0x1A448930)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_SET_TIME_OFFSET UNITYSDK_OFFSET(0x1A448580)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A448B30)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int AbsoluteTimePoint_TypeDefinitionIndex = 34690;
