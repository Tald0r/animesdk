...
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A766B20)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_FETCH_LASTCAMERADATA_OFFSET UNITYSDK_OFFSET(0x1A766CE0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_GETDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A766200)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A766300)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A766810)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A766A60)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A766940)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A766820)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A766E30)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A766E10)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A766EC0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A766F80)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FrameOnePointInCorePolicy_Freeze_TypeDefinitionIndex = 34744;
	...
	public:
		...
		{
			return (::System::Func_3<::PipelineCamera::WorldBasicCameraData, ::UnityEngine::Vector3, ::PipelineCamera::WorldBasicCameraData>**)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x24950);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_LastCameraData()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x8130);
		}
