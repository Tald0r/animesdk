...
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AD34400)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_FETCH_LASTCAMERADATA_OFFSET UNITYSDK_OFFSET(0x1AD345C0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_GETDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD33AE0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_GETDATA_OFFSET UNITYSDK_OFFSET(0x1AD33BE0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1AD340F0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1AD34340)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AD34220)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AD34100)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD34710)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD346F0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AD347A0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1AD34860)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FrameOnePointInCorePolicy_Freeze_TypeDefinitionIndex = 35746;
	...
	public:
		...
		{
			return (::System::Func_3<::PipelineCamera::WorldBasicCameraData, ::UnityEngine::Vector3, ::PipelineCamera::WorldBasicCameraData>**)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x26380);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_LastCameraData()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x8490);
		}
