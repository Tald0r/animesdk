...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1ACD6B20)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_CONVERTTO_1_OFFSET UNITYSDK_OFFSET(0x1ACD6A60)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1ACD69D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_LINK_OFFSET UNITYSDK_OFFSET(0x1ACD6750)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_ONLINKTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x1ACD68B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACD6DA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT___BASE_LINK_OFFSET UNITYSDK_OFFSET(0x1ACD6DC0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEvent_TypeDefinitionIndex = 35676;
