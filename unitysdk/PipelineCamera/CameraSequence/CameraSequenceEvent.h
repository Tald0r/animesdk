...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A7333E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_CONVERTTO_1_OFFSET UNITYSDK_OFFSET(0x1A733320)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1A733290)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_LINK_OFFSET UNITYSDK_OFFSET(0x1A733010)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_ONLINKTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x1A733170)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A733660)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT___BASE_LINK_OFFSET UNITYSDK_OFFSET(0x1A733680)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEvent_TypeDefinitionIndex = 34674;
