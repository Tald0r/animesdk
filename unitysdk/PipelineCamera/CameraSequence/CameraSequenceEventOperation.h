...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_EXPIREAT_OFFSET UNITYSDK_OFFSET(0x1A1A36C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_GET_OPERATIONTYPE_OFFSET UNITYSDK_OFFSET(0x2F7B90)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_GET_SEQUENCEEVENT_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x2FD610)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_SET_OPERATIONTYPE_OFFSET UNITYSDK_OFFSET(0x391460)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_SET_SEQUENCEEVENT_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_SET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x90AC30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_TRIGGERAT_OFFSET UNITYSDK_OFFSET(0x1A1A3470)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEventOperation_TypeDefinitionIndex = 34680;
