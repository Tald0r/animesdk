...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_EXPIREAT_OFFSET UNITYSDK_OFFSET(0x1A731570)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_GET_OPERATIONTYPE_OFFSET UNITYSDK_OFFSET(0x36D470)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_GET_SEQUENCEEVENT_OFFSET UNITYSDK_OFFSET(0x223870)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x2F2FF0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_SET_OPERATIONTYPE_OFFSET UNITYSDK_OFFSET(0x53B920)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_SET_SEQUENCEEVENT_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_SET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x9368F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_TRIGGERAT_OFFSET UNITYSDK_OFFSET(0x1A731320)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEventOperation_TypeDefinitionIndex = 35682;
