...
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATASEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB03FE0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CoreDataSequence_TypeDefinitionIndex = 34720;
