...
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A2E44E0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_FETCH_BEGINCAMERADATA_OFFSET UNITYSDK_OFFSET(0x1A2E49C0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_FETCH_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x1A2E48E0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_FETCH_LOCATION_OFFSET UNITYSDK_OFFSET(0x1A2E46A0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_FETCH_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A2E47D0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A2E3220)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A2E4410)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A2E4420)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2E4B00)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E4AF0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A2E4BE0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A2E4CA0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FixedInFinalPolicy_Freeze_TypeDefinitionIndex = 34743;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedInFinalPolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x8440);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_BeginCameraData()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedInFinalPolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x8448);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_rotation()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedInFinalPolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x8450);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_fieldOfView()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedInFinalPolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x8458);
		}
