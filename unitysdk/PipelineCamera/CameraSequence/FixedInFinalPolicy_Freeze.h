...
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A8AE2E0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_FETCH_BEGINCAMERADATA_OFFSET UNITYSDK_OFFSET(0x1A8AE7C0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_FETCH_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x1A8AE6E0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_FETCH_LOCATION_OFFSET UNITYSDK_OFFSET(0x1A8AE4A0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_FETCH_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A8AE5D0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A8AD020)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A8AE210)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A8AE220)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8AE900)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8AE8F0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A8AE9E0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDINFINALPOLICY_FREEZE___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A8AEAA0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FixedInFinalPolicy_Freeze_TypeDefinitionIndex = 35745;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedInFinalPolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x87A0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_BeginCameraData()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedInFinalPolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x87A8);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_rotation()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedInFinalPolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x87B0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_location()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedInFinalPolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x87B8);
		}
