...
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x1B14C5C0)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_GETTIME_OFFSET UNITYSDK_OFFSET(0x1B14C730)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_GET_PLAYLENGTH_OFFSET UNITYSDK_OFFSET(0x1B14C5B0)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_GET_RELATIVETIME_OFFSET UNITYSDK_OFFSET(0x1B14C500)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1B14C5A0)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_SETSEGMENT_OFFSET UNITYSDK_OFFSET(0x1B14C620)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_SETTIME_OFFSET UNITYSDK_OFFSET(0x1B14C8A0)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_SET_RELATIVETIME_OFFSET UNITYSDK_OFFSET(0x1B14C510)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14CA10)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int RelativeTimePoint_TypeDefinitionIndex = 35693;
