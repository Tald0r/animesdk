...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A734260)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x93B640)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH_EQUALS_OFFSET UNITYSDK_OFFSET(0x93B540)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x93B650)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x93B290)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x93B760)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x93B750)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH_PUSH_OFFSET UNITYSDK_OFFSET(0x93B380)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A733F50)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH_STEPINTO_1_OFFSET UNITYSDK_OFFSET(0x93B420)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH_STEPINTO_OFFSET UNITYSDK_OFFSET(0x93B400)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH_TOVARIABLESTRING_OFFSET UNITYSDK_OFFSET(0x93B300)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A734580)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x93B7C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEMEMBERPATH___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x93B770)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceMemberPath_TypeDefinitionIndex = 34806;

	struct alignas(8) CameraSequenceMemberPath
	{
		static ::System::Text::StringBuilder** StaticGet__stringBuilder()
		{
			return (::System::Text::StringBuilder**)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceMemberPath_TypeDefinitionIndex)->GetStaticField(0x249E0);
		}
