...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B14BCC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B14BD50)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x1B14BC70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1B14BCB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_RECEIVENOTIFY_OFFSET UNITYSDK_OFFSET(0x1B14BED0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14C000)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceInternalEvent_JumpToSection_TypeDefinitionIndex = 35823;
