...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AB037E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AB03870)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x1AB03790)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1AB037D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_RECEIVENOTIFY_OFFSET UNITYSDK_OFFSET(0x1AB039F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB03B20)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceInternalEvent_JumpToSection_TypeDefinitionIndex = 34821;
