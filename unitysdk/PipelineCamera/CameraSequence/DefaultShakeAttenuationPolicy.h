...
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKEATTENUATIONPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A037350)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int DefaultShakeAttenuationPolicy_TypeDefinitionIndex = 34826;
