...
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x1A1A4290)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GETTIME_OFFSET UNITYSDK_OFFSET(0x1A1A42F0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GET_PLAYLENGTH_OFFSET UNITYSDK_OFFSET(0x1A1A4200)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GET_RATIO_OFFSET UNITYSDK_OFFSET(0x1A1A4150)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1A1A41F0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_ONTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x1A1A4210)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_SETSEGMENT_OFFSET UNITYSDK_OFFSET(0x1A1A4440)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_SETTIME_OFFSET UNITYSDK_OFFSET(0x1A1A4530)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_SET_RATIO_OFFSET UNITYSDK_OFFSET(0x1A1A4160)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A4720)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int ProportionalTimePoint_TypeDefinitionIndex = 34692;
