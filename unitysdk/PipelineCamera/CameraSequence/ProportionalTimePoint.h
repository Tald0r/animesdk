...
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x1A732140)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GETTIME_OFFSET UNITYSDK_OFFSET(0x1A7321A0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GET_PLAYLENGTH_OFFSET UNITYSDK_OFFSET(0x1A7320B0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GET_RATIO_OFFSET UNITYSDK_OFFSET(0x1A732000)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1A7320A0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_ONTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x1A7320C0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_SETSEGMENT_OFFSET UNITYSDK_OFFSET(0x1A7322F0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_SETTIME_OFFSET UNITYSDK_OFFSET(0x1A7323E0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_SET_RATIO_OFFSET UNITYSDK_OFFSET(0x1A732010)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7325D0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int ProportionalTimePoint_TypeDefinitionIndex = 35694;
