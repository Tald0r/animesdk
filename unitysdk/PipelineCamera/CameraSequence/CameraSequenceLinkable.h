...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE_GETLINKTIME_OFFSET UNITYSDK_OFFSET(0x19300B30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE_GET_LINKTIME_OFFSET UNITYSDK_OFFSET(0x19300500)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x193004F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE_LINK_OFFSET UNITYSDK_OFFSET(0x193006D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE_SETLINKTIME_OFFSET UNITYSDK_OFFSET(0x19300C70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE_SET_LINKTIME_OFFSET UNITYSDK_OFFSET(0x19300630)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19300DC0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceLinkable_TypeDefinitionIndex = 34687;
