...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE7B560)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE7B5A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE___C___CTOR_B__13_0_OFFSET UNITYSDK_OFFSET(0x1AE7B5B0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEventQueue___c_TypeDefinitionIndex = 35688;
	...
	public:
		...
		{
			return (::System::Func_1<::System::Collections::Generic::Dictionary_2<::PipelineCamera::CameraSequence::CameraSequenceEnvironmentPath, ::PipelineCamera::CameraSequence::CameraSequenceEvent*>*>**)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceEventQueue___c_TypeDefinitionIndex)->GetStaticField(0x26480);
		}
		static ::PipelineCamera::CameraSequence::CameraSequenceEventQueue___c** StaticGet___9()
		{
			return (::PipelineCamera::CameraSequence::CameraSequenceEventQueue___c**)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceEventQueue___c_TypeDefinitionIndex)->GetStaticField(0x26488);
		}
