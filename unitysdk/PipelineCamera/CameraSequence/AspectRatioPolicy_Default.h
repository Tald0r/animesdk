...
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A8AB9C0)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_FETCH_ASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x1A8ABB80)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_GETASPECTRATIOINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A8AB720)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A8AB860)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A8AB8F0)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A8AB900)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8ABC60)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8ABC50)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A8ABCA0)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A8ABD60)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int AspectRatioPolicy_Default_TypeDefinitionIndex = 35737;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AspectRatioPolicy_Default_TypeDefinitionIndex)->GetStaticField(0x8770);
		}
