...
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A2E1BC0)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_FETCH_ASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x1A2E1D80)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_GETASPECTRATIOINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A2E1920)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A2E1A60)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A2E1AF0)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A2E1B00)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2E1E60)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E1E50)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A2E1EA0)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A2E1F60)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int AspectRatioPolicy_Default_TypeDefinitionIndex = 34735;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AspectRatioPolicy_Default_TypeDefinitionIndex)->GetStaticField(0x8410);
		}
