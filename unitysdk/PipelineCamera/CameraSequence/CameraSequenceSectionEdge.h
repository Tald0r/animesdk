...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GETFROMSECTION_OFFSET UNITYSDK_OFFSET(0x1A734AC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GETTOSECTION_OFFSET UNITYSDK_OFFSET(0x1A734C40)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GET_FROMSECTIONINDEX_OFFSET UNITYSDK_OFFSET(0x1A734AA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GET_FROMSECTION_OFFSET UNITYSDK_OFFSET(0x1A7346A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GET_TOSECTIONINDEX_OFFSET UNITYSDK_OFFSET(0x1A734AB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GET_TOSECTION_OFFSET UNITYSDK_OFFSET(0x1A734930)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_LINK_OFFSET UNITYSDK_OFFSET(0x1A734CF0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_SET_FROMSECTION_OFFSET UNITYSDK_OFFSET(0x1A734750)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_SET_TOSECTION_OFFSET UNITYSDK_OFFSET(0x1A7349E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A734D70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE__GETFROMSECTION_B__15_0_OFFSET UNITYSDK_OFFSET(0x1A734D80)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceSectionEdge_TypeDefinitionIndex = 34707;
