...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GETFROMSECTION_OFFSET UNITYSDK_OFFSET(0x1ACD8200)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GETTOSECTION_OFFSET UNITYSDK_OFFSET(0x1ACD8380)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GET_FROMSECTIONINDEX_OFFSET UNITYSDK_OFFSET(0x1ACD81E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GET_FROMSECTION_OFFSET UNITYSDK_OFFSET(0x1ACD7DE0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GET_TOSECTIONINDEX_OFFSET UNITYSDK_OFFSET(0x1ACD81F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GET_TOSECTION_OFFSET UNITYSDK_OFFSET(0x1ACD8070)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_LINK_OFFSET UNITYSDK_OFFSET(0x1ACD8430)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_SET_FROMSECTION_OFFSET UNITYSDK_OFFSET(0x1ACD7E90)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_SET_TOSECTION_OFFSET UNITYSDK_OFFSET(0x1ACD8120)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACD84B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE__GETFROMSECTION_B__15_0_OFFSET UNITYSDK_OFFSET(0x1ACD84C0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceSectionEdge_TypeDefinitionIndex = 35709;
