...
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A8AC650)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_FETCH_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x1A8AC810)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_FETCH_OFFSET_OFFSET UNITYSDK_OFFSET(0x1A8AC9D0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_FETCH_RADIUS_OFFSET UNITYSDK_OFFSET(0x1A8AC8F0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A8ACAB0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A8ACE30)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A8AC590)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8ACE60)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8ACE40)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A8ACEF0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A8ACFB0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FixedFramePivotDataInCore_TypeDefinitionIndex = 35819;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedFramePivotDataInCore_TypeDefinitionIndex)->GetStaticField(0x8780);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_fieldOfView()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedFramePivotDataInCore_TypeDefinitionIndex)->GetStaticField(0x8788);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_radius()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedFramePivotDataInCore_TypeDefinitionIndex)->GetStaticField(0x8790);
		}
