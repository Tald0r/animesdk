...
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A2E2850)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_FETCH_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x1A2E2A10)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_FETCH_OFFSET_OFFSET UNITYSDK_OFFSET(0x1A2E2BD0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_FETCH_RADIUS_OFFSET UNITYSDK_OFFSET(0x1A2E2AF0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A2E2CB0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A2E3030)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A2E2790)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2E3060)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E3040)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A2E30F0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A2E31B0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FixedFramePivotDataInCore_TypeDefinitionIndex = 34817;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedFramePivotDataInCore_TypeDefinitionIndex)->GetStaticField(0x8420);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_radius()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedFramePivotDataInCore_TypeDefinitionIndex)->GetStaticField(0x8428);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_fieldOfView()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedFramePivotDataInCore_TypeDefinitionIndex)->GetStaticField(0x8430);
		}
