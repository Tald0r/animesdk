...
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x17C70A20)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x17C70AB0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_FETCH_ANGLESPEED_OFFSET UNITYSDK_OFFSET(0x17C70C30)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x17C70DD0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x17C70E90)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x17C70D60)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x17C71550)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_ISLOOP_OFFSET UNITYSDK_OFFSET(0x17C70E30)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED__CCTOR_OFFSET UNITYSDK_OFFSET(0x17C715A0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x17C71560)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int RotateEulerByFixedSpeed_TypeDefinitionIndex = 34812;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(RotateEulerByFixedSpeed_TypeDefinitionIndex)->GetStaticField(0x8220);
		}
