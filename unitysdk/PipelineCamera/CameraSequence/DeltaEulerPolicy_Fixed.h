...
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AD4C0F0)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_FETCH_OFFSET_OFFSET UNITYSDK_OFFSET(0x1AD4C2B0)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_GETDATA_OFFSET UNITYSDK_OFFSET(0x1AD4BE70)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1AD4C020)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_GET_PITCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1AD4BC60)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_GET_ROLLOFFSET_OFFSET UNITYSDK_OFFSET(0x1AD4BDC0)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_GET_YAWOFFSET_OFFSET UNITYSDK_OFFSET(0x1AD4BD10)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_SETPATH_OFFSET UNITYSDK_OFFSET(0x1AD4C030)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_SET_PITCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1AD4BC70)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_SET_ROLLOFFSET_OFFSET UNITYSDK_OFFSET(0x1AD4BDD0)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_SET_YAWOFFSET_OFFSET UNITYSDK_OFFSET(0x1AD4BD20)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD4C400)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD4C3E0)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1AD4C440)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1AD4C500)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int DeltaEulerPolicy_Fixed_TypeDefinitionIndex = 35740;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(DeltaEulerPolicy_Fixed_TypeDefinitionIndex)->GetStaticField(0x86E0);
		}
