...
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A8AB2E0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE_FETCH_CURVE_OFFSET UNITYSDK_OFFSET(0x1A8AB4A0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A8AB070)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1A8AB210)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A8AB220)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8AB5B0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8AB580)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A8AB5F0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1A8AB6B0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int AlphaGeneratorPolicy_Curve_TypeDefinitionIndex = 35732;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Curve_TypeDefinitionIndex)->GetStaticField(0x8760);
		}
