...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SCOPEDWORKSPACEHANDLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x957FF0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SCOPEDWORKSPACEHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x957F90)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SCOPEDWORKSPACEHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x957F00)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceContext_ScopedWorkspaceHandle_TypeDefinitionIndex = 34785;
