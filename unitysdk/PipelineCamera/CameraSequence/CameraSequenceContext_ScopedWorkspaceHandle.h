...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SCOPEDWORKSPACEHANDLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x98C1B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SCOPEDWORKSPACEHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x98C150)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SCOPEDWORKSPACEHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x98C0C0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceContext_ScopedWorkspaceHandle_TypeDefinitionIndex = 35787;
