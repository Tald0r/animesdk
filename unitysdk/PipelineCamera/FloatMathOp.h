...
#define PIPELINECAMERA_FLOATMATHOP_FROMTO_OFFSET UNITYSDK_OFFSET(0x1B14D300)
#define PIPELINECAMERA_FLOATMATHOP_LINEARCOMBINE_1_OFFSET UNITYSDK_OFFSET(0x1B14D430)
#define PIPELINECAMERA_FLOATMATHOP_LINEARCOMBINE_2_OFFSET UNITYSDK_OFFSET(0x1B14D510)
#define PIPELINECAMERA_FLOATMATHOP_LINEARCOMBINE_OFFSET UNITYSDK_OFFSET(0x1B14D380)
#define PIPELINECAMERA_FLOATMATHOP_MULTIPLYFLOATADD_OFFSET UNITYSDK_OFFSET(0x1B14D270)
#define PIPELINECAMERA_FLOATMATHOP_MULTIPLYFLOAT_OFFSET UNITYSDK_OFFSET(0x1B14D1F0)
#define PIPELINECAMERA_FLOATMATHOP_PIPELINECAMERA_IMATHOPERATION_SYSTEM_SINGLE__FROMTO_OFFSET UNITYSDK_OFFSET(0x1B14DB80)
#define PIPELINECAMERA_FLOATMATHOP_PIPELINECAMERA_IMATHOPERATION_SYSTEM_SINGLE__LINEARCOMBINE_1_OFFSET UNITYSDK_OFFSET(0x1B14D8F0)
#define PIPELINECAMERA_FLOATMATHOP_PIPELINECAMERA_IMATHOPERATION_SYSTEM_SINGLE__LINEARCOMBINE_2_OFFSET UNITYSDK_OFFSET(0x1B14DA10)
#define PIPELINECAMERA_FLOATMATHOP_PIPELINECAMERA_IMATHOPERATION_SYSTEM_SINGLE__LINEARCOMBINE_OFFSET UNITYSDK_OFFSET(0x1B14D800)
#define PIPELINECAMERA_FLOATMATHOP_PIPELINECAMERA_IMATHOPERATION_SYSTEM_SINGLE__MULTIPLYFLOATADD_OFFSET UNITYSDK_OFFSET(0x1B14D730)
#define PIPELINECAMERA_FLOATMATHOP_PIPELINECAMERA_IMATHOPERATION_SYSTEM_SINGLE__MULTIPLYFLOAT_OFFSET UNITYSDK_OFFSET(0x1B14D670)
#define PIPELINECAMERA_FLOATMATHOP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B14D640)
#define PIPELINECAMERA_FLOATMATHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14D630)

namespace PipelineCamera
{
	inline static constexpr unsigned int FloatMathOp_TypeDefinitionIndex = 35549;
	...
	public:
		...
		{
			return (::PipelineCamera::FloatMathOp**)Il2CppClass::FromTypeDefinitionIndex(FloatMathOp_TypeDefinitionIndex)->GetStaticField(0x26450);
		}
