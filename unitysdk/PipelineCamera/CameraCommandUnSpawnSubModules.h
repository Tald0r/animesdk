...
#define PIPELINECAMERA_CAMERACOMMANDUNSPAWNSUBMODULES_ADD_OFFSET UNITYSDK_OFFSET(0x1A95E610)
#define PIPELINECAMERA_CAMERACOMMANDUNSPAWNSUBMODULES_PIPELINECAMERA_ICAMERACOMMAND_GET_COMMANDTYPE_OFFSET UNITYSDK_OFFSET(0x1A95E440)
#define PIPELINECAMERA_CAMERACOMMANDUNSPAWNSUBMODULES_PIPELINECAMERA_ICAMERACOMMAND_GET_PIPELINE_OFFSET UNITYSDK_OFFSET(0x1A95E4A0)
#define PIPELINECAMERA_CAMERACOMMANDUNSPAWNSUBMODULES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A95E500)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraCommandUnSpawnSubModules_TypeDefinitionIndex = 35328;
