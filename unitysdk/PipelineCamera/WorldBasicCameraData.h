...
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKALL_OFFSET UNITYSDK_OFFSET(0x907A20)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x9079C0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKOFFSET_OFFSET UNITYSDK_OFFSET(0x907960)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x907840)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKRADIUS_OFFSET UNITYSDK_OFFSET(0x907900)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKROTATION_OFFSET UNITYSDK_OFFSET(0x9078A0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A07BF60)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GETCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x907820)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x2FD590)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x907380)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x2FC120)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_PIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x31DD30)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x8FF150)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x37BFB0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_INTERPTO_OFFSET UNITYSDK_OFFSET(0x1A07CDE0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x907810)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x9075B0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETLOCATION_OFFSET UNITYSDK_OFFSET(0x9073E0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETOFFSET_OFFSET UNITYSDK_OFFSET(0x9077A0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x9076A0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETRADIUS_OFFSET UNITYSDK_OFFSET(0x907720)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETROTATION_OFFSET UNITYSDK_OFFSET(0x907480)
#define PIPELINECAMERA_WORLDBASICCAMERADATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A07D7F0)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraData_TypeDefinitionIndex = 34446;

	struct alignas(4) WorldBasicCameraData
	{
		static ::PipelineCamera::WorldBasicCameraData* StaticGet_Fallback()
		{
			return (::PipelineCamera::WorldBasicCameraData*)Il2CppClass::FromTypeDefinitionIndex(WorldBasicCameraData_TypeDefinitionIndex)->GetStaticField(0x82C0);
		}
