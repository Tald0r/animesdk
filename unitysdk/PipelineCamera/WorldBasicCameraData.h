...
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKALL_OFFSET UNITYSDK_OFFSET(0x932990)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x932930)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKOFFSET_OFFSET UNITYSDK_OFFSET(0x9328D0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x9327B0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKRADIUS_OFFSET UNITYSDK_OFFSET(0x932870)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKROTATION_OFFSET UNITYSDK_OFFSET(0x932810)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A647DA0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GETCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x932790)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x2F2F70)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x9322F0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x2F2E20)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_PIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x2EA460)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x929B40)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x35A5F0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_INTERPTO_OFFSET UNITYSDK_OFFSET(0x1A648C20)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x932780)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x932520)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETLOCATION_OFFSET UNITYSDK_OFFSET(0x932350)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETOFFSET_OFFSET UNITYSDK_OFFSET(0x932710)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x932610)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETRADIUS_OFFSET UNITYSDK_OFFSET(0x932690)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETROTATION_OFFSET UNITYSDK_OFFSET(0x9323F0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A649630)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraData_TypeDefinitionIndex = 35448;

	struct alignas(4) WorldBasicCameraData
	{
		static ::PipelineCamera::WorldBasicCameraData* StaticGet_Fallback()
		{
			return (::PipelineCamera::WorldBasicCameraData*)Il2CppClass::FromTypeDefinitionIndex(WorldBasicCameraData_TypeDefinitionIndex)->GetStaticField(0x8620);
		}
