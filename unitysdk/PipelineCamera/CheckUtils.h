...
#define PIPELINECAMERA_CHECKUTILS_ENSURENORMALIZED_1_OFFSET UNITYSDK_OFFSET(0x1A8AFD90)
#define PIPELINECAMERA_CHECKUTILS_ENSURENORMALIZED_OFFSET UNITYSDK_OFFSET(0x1A8AFD20)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_1_OFFSET UNITYSDK_OFFSET(0x1A8AFA50)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_2_OFFSET UNITYSDK_OFFSET(0x1A8AFAB0)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_3_OFFSET UNITYSDK_OFFSET(0x1A8AFB20)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_4_OFFSET UNITYSDK_OFFSET(0x1A8AFB80)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_5_OFFSET UNITYSDK_OFFSET(0x1A8AFBF0)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_6_OFFSET UNITYSDK_OFFSET(0x1A8AFC50)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_7_OFFSET UNITYSDK_OFFSET(0x1A8AFCC0)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_OFFSET UNITYSDK_OFFSET(0x1A8AF9E0)
#define PIPELINECAMERA_CHECKUTILS_ENSUREPARTIALORDER_OFFSET UNITYSDK_OFFSET(0x1A8AFE90)
#define PIPELINECAMERA_CHECKUTILS_ENSURERANGE_OFFSET UNITYSDK_OFFSET(0x1A8AFE00)

namespace PipelineCamera
{
	inline static constexpr unsigned int CheckUtils_TypeDefinitionIndex = 35527;
