...
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_BUILDBLENDER_OFFSET UNITYSDK_OFFSET(0x1A61E1F0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CANCELBLENDINGREQUEST_OFFSET UNITYSDK_OFFSET(0x1A61CF50)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CANCELBLENDING_OFFSET UNITYSDK_OFFSET(0x1A61CFC0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CLEARBLENDER_OFFSET UNITYSDK_OFFSET(0x1A61E4C0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CONSUMEBLENDERBUILDER_OFFSET UNITYSDK_OFFSET(0x1A61E5E0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CREATE_OFFSET UNITYSDK_OFFSET(0x1A61DBE0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_GET_LASTOUTPUT_OFFSET UNITYSDK_OFFSET(0x1A61CEB0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_HANDLECURRENTBLENDER_OFFSET UNITYSDK_OFFSET(0x1A61E040)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_HANDLENEWBLENDER_OFFSET UNITYSDK_OFFSET(0x1A61DC80)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A61D140)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1A61D320)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A61D1C0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A61D7D0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A61D990)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1A61D0E0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1A61D020)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1A61D080)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1A61D4D0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1A61D270)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1A61DAA0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_REQUESTBLENDING_OFFSET UNITYSDK_OFFSET(0x1A61CED0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A61DBB0)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int InPlaceBlender_TypeDefinitionIndex = 35850;
