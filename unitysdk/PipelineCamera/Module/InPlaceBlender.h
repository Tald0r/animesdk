...
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_BUILDBLENDER_OFFSET UNITYSDK_OFFSET(0x1A03E120)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CANCELBLENDINGREQUEST_OFFSET UNITYSDK_OFFSET(0x1A03CE80)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CANCELBLENDING_OFFSET UNITYSDK_OFFSET(0x1A03CEF0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CLEARBLENDER_OFFSET UNITYSDK_OFFSET(0x1A03E3F0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CONSUMEBLENDERBUILDER_OFFSET UNITYSDK_OFFSET(0x1A03E510)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CREATE_OFFSET UNITYSDK_OFFSET(0x1A03DB10)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_GET_LASTOUTPUT_OFFSET UNITYSDK_OFFSET(0x1A03CDE0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_HANDLECURRENTBLENDER_OFFSET UNITYSDK_OFFSET(0x1A03DF70)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_HANDLENEWBLENDER_OFFSET UNITYSDK_OFFSET(0x1A03DBB0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A03D070)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1A03D250)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A03D0F0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A03D700)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A03D8C0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1A03D010)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1A03CF50)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1A03CFB0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1A03D400)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1A03D1A0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1A03D9D0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_REQUESTBLENDING_OFFSET UNITYSDK_OFFSET(0x1A03CE00)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A03DAE0)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int InPlaceBlender_TypeDefinitionIndex = 34848;
	...
	public:
		...
		::System::Boolean _cancelBlending; // 0x20
		::System::Nullable_1<::PipelineCamera::WorldBasicCameraData> _cachedOutput; // 0x24
