...
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1B14DCD0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1B14E0C0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1B14E2A0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1B14E170)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1B14EAD0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B14EEE0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1B14E060)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1B14DFA0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1B14E000)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1B14EA20)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1B14E220)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1B14EF60)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14DC40)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultFollowInitializer_TypeDefinitionIndex = 35843;
	...
	public:
		...
		::System::Nullable_1<::PipelineCamera::Module::DefaultFollowInitialParam> _initialValue; // 0x1C
