...
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1AB057F0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1AB05BE0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1AB05DC0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1AB05C90)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1AB065F0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1AB06A00)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1AB05B80)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1AB05AC0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1AB05B20)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1AB06540)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1AB05D40)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1AB06A80)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB05760)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultFollowInitializer_TypeDefinitionIndex = 34841;
	...
	public:
		...
		::System::Nullable_1<::PipelineCamera::Module::DefaultFollowInitialParam> _initialValue; // 0x20
