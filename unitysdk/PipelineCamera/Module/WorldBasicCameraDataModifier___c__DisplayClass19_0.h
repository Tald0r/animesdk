...
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER___C__DISPLAYCLASS19_0__BUILDCAMERACOMMANDHANDLER_B__0_OFFSET UNITYSDK_OFFSET(0x1AA47D10)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER___C__DISPLAYCLASS19_0__BUILDCAMERACOMMANDHANDLER_B__1_OFFSET UNITYSDK_OFFSET(0x1AA47E00)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA47D00)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int WorldBasicCameraDataModifier___c__DisplayClass19_0_TypeDefinitionIndex = 35856;
