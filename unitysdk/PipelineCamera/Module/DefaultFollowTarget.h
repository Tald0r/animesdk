...
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1A1A8C60)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x1A1A8BB0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_INITSUTMODULE_OFFSET UNITYSDK_OFFSET(0x1A1A8F30)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A1A9400)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1A1A96D0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A1A9520)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A1A9970)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A1A9A10)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1A1A93A0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1A1A92E0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1A1A9340)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1A1A98C0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1A1A9650)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1A1A9A90)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A8BD0)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultFollowTarget_TypeDefinitionIndex = 34860;
	...
	public:
		...
		::System::Nullable_1<::PipelineCamera::CameraFollowTargetParam> _cachedValue; // 0x24
