...
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1AB06DD0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_GET_ROTATIONINPUT_OFFSET UNITYSDK_OFFSET(0x1AB064B0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1AB071D0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1AB073B0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1AB07280)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1AB07680)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1AB07760)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1AB07170)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1AB070A0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1AB07110)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1AB075D0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1AB07330)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1AB077E0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB06CE0)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultRotationInput_TypeDefinitionIndex = 34845;
	...
	public:
		...
		::UnityEngine::Vector3 _defaultRotationSpeed; // 0x70
		::System::Int32 _pipelineId; // 0x7C
		::System::Nullable_1<::UnityEngine::Quaternion> _cachedRotationInput; // 0x80
		::Foundation::Unreal::FName _moduleId; // 0x94
