...
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1B14F2B0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_GET_ROTATIONINPUT_OFFSET UNITYSDK_OFFSET(0x1B14E990)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1B14F6D0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1B14F8B0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1B14F780)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1B14FB80)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B14FC60)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1B14F670)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1B14F590)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1B14F600)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1B14FAD0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1B14F830)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1B14FCE0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14F1C0)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultRotationInput_TypeDefinitionIndex = 35847;
