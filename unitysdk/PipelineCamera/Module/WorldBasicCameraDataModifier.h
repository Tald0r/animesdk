...
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1A9613A0)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_INITSUTMODULE_OFFSET UNITYSDK_OFFSET(0x1A960990)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A960E60)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1A961040)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A960F10)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A961180)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A961240)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1A960E00)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1A960D40)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1A960DA0)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1A9610D0)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1A960FC0)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1A9612C0)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A961340)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int WorldBasicCameraDataModifier_TypeDefinitionIndex = 35855;
