...
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_CREATE_OFFSET UNITYSDK_OFFSET(0x1A737A30)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_GETLASTDATACACHE_OFFSET UNITYSDK_OFFSET(0x1A737B10)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A737CC0)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1A737EA0)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A737D40)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A738000)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A7380C0)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1A737C60)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1A737BA0)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1A737C00)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1A737F50)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1A737DF0)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1A738170)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7379E0)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int SimpleLastDataCache_TypeDefinitionIndex = 35852;

	class SimpleLastDataCache : public ::System::Object
	{
	public:
		::System::Int32 _pipelineId; // 0x10
		::Foundation::Unreal::FName _moduleId; // 0x14
		::System::Nullable_1<::PipelineCamera::WorldBasicCameraData> _lastData; // 0x1C
