...
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTINGPARAM_GET_ASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTINGPARAM_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x3456B0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTINGPARAM_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x2F60A0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTINGPARAM_SET_ASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x98C330)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTINGPARAM_SET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x98C290)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTINGPARAM_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x98C3D0)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultFollowSettingParam_TypeDefinitionIndex = 35857;
