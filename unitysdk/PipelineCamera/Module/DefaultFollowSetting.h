...
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1AD35040)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_GET_SETTING_OFFSET UNITYSDK_OFFSET(0x1AD34F80)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_INITSUBMODULE_OFFSET UNITYSDK_OFFSET(0x1AD35310)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1AD357E0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1AD359C0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1AD35890)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1AD35B40)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1AD35C20)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1AD35780)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1AD356C0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1AD35720)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1AD35A90)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1AD35940)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1AD35CA0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD34FA0)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultFollowSetting_TypeDefinitionIndex = 35859;
	...
	public:
		...
		::PipelineCamera::Module::DefaultFollowSettingParam _defaultDefaultFollowSetting; // 0x18
		::PipelineCamera::Module::DefaultFollowSettingParam _cachedOutput; // 0x30
