...
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_ANIMATIONCURVEREVERSED_OFFSET UNITYSDK_OFFSET(0x1A39F380)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_ANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1A39F190)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_EASINGINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A39DDF0)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_EASINGREVERSED_OFFSET UNITYSDK_OFFSET(0x1A39DC00)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_EASING_OFFSET UNITYSDK_OFFSET(0x1A39DA80)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_INTERPCURVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A39EA10)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_INTERPCURVEREVERSED_OFFSET UNITYSDK_OFFSET(0x1A39E810)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_INTERPCURVE_OFFSET UNITYSDK_OFFSET(0x1A39E680)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A39F5E0)

namespace PipelineCamera
{
	inline static constexpr unsigned int TimeBasedAlphaGenerator_TypeDefinitionIndex = 34521;
