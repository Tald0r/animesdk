...
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_ANIMATIONCURVEREVERSED_OFFSET UNITYSDK_OFFSET(0x1A963220)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_ANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1A963040)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_EASINGINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A961CB0)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_EASINGREVERSED_OFFSET UNITYSDK_OFFSET(0x1A961AC0)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_EASING_OFFSET UNITYSDK_OFFSET(0x1A961940)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_INTERPCURVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A9628E0)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_INTERPCURVEREVERSED_OFFSET UNITYSDK_OFFSET(0x1A9626E0)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_INTERPCURVE_OFFSET UNITYSDK_OFFSET(0x1A962550)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A963470)

namespace PipelineCamera
{
	inline static constexpr unsigned int TimeBasedAlphaGenerator_TypeDefinitionIndex = 35523;
