...
#define PIPELINECAMERA_ANIMCURVEALPHAMODIFIER_CURVE_OFFSET UNITYSDK_OFFSET(0x1A448050)
#define PIPELINECAMERA_ANIMCURVEALPHAMODIFIER_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x913480)
#define PIPELINECAMERA_ANIMCURVEALPHAMODIFIER_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9133F0)
#define PIPELINECAMERA_ANIMCURVEALPHAMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x2C3980)

namespace PipelineCamera
{
	inline static constexpr unsigned int AnimCurveAlphaModifier_TypeDefinitionIndex = 34520;
