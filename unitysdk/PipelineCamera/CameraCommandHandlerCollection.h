...
#define PIPELINECAMERA_CAMERACOMMANDHANDLERCOLLECTION_SENDCAMERACOMMAND_OFFSET UNITYSDK_OFFSET(0x93B200)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraCommandHandlerCollection_TypeDefinitionIndex = 34322;
