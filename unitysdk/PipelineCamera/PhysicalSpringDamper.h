...
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_GENERATEINITIALVALUE_OFFSET UNITYSDK_OFFSET(0x79EA20)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_GENERATERELAXOFFSET_OFFSET UNITYSDK_OFFSET(0x79E980)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_PIPELINECAMERA_IVELOCITYBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x79EAD0)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x79E970)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x413380)

namespace PipelineCamera
{
	inline static constexpr unsigned int PhysicalSpringDamper_TypeDefinitionIndex = 34502;
