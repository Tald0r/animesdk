...
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_GENERATEINITIALVALUE_OFFSET UNITYSDK_OFFSET(0x7D6760)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_GENERATERELAXOFFSET_OFFSET UNITYSDK_OFFSET(0x7D66C0)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_PIPELINECAMERA_IVELOCITYBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x7D6810)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x7D66B0)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x7D66A0)

namespace PipelineCamera
{
	inline static constexpr unsigned int PhysicalSpringDamper_TypeDefinitionIndex = 35504;
