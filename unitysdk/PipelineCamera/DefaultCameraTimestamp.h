...
#define PIPELINECAMERA_DEFAULTCAMERATIMESTAMP_PIPELINECAMERA_ICAMERATIMESTAMP_GETDELTATIME_OFFSET UNITYSDK_OFFSET(0x18359E00)
#define PIPELINECAMERA_DEFAULTCAMERATIMESTAMP_PIPELINECAMERA_ICAMERATIMESTAMP_GETTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x18359CE0)
#define PIPELINECAMERA_DEFAULTCAMERATIMESTAMP_PIPELINECAMERA_ICAMERATIMESTAMP_ISTHREADSAFEINWORKTHREAD_OFFSET UNITYSDK_OFFSET(0x18359F30)
#define PIPELINECAMERA_DEFAULTCAMERATIMESTAMP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1835A070)
#define PIPELINECAMERA_DEFAULTCAMERATIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1835A060)

namespace PipelineCamera
{
	inline static constexpr unsigned int DefaultCameraTimestamp_TypeDefinitionIndex = 35386;
	...
	public:
		...
		{
			return (::PipelineCamera::ICameraTimestamp**)Il2CppClass::FromTypeDefinitionIndex(DefaultCameraTimestamp_TypeDefinitionIndex)->GetStaticField(0x26460);
		}
