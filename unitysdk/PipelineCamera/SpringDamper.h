...
#define PIPELINECAMERA_SPRINGDAMPER_PIPELINECAMERA_IVELOCITYBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9A0360)
#define PIPELINECAMERA_SPRINGDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9A0350)
#define PIPELINECAMERA_SPRINGDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A0340)

namespace PipelineCamera
{
	inline static constexpr unsigned int SpringDamper_TypeDefinitionIndex = 35506;
