...
#define PIPELINECAMERA_SPRINGDAMPER_PIPELINECAMERA_IVELOCITYBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x96D500)
#define PIPELINECAMERA_SPRINGDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x96D4F0)
#define PIPELINECAMERA_SPRINGDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x96D4E0)

namespace PipelineCamera
{
	inline static constexpr unsigned int SpringDamper_TypeDefinitionIndex = 34504;
