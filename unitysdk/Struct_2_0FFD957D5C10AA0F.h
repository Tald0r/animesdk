...
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_1F8314262457963A_OFFSET UNITYSDK_OFFSET(0x53A460)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_5489F9CD0AA85DE6_OFFSET UNITYSDK_OFFSET(0x53A3E0)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_77E6E3DA1F0E9CCC_OFFSET UNITYSDK_OFFSET(0x53A4A0)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_9C72894CB5D45A5A_OFFSET UNITYSDK_OFFSET(0x53A450)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_C3B21C74C45D6F86_OFFSET UNITYSDK_OFFSET(0x53A410)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_F088209CA8D65638_OFFSET UNITYSDK_OFFSET(0x53A480)
#define STRUCT_2_0FFD957D5C10AA0F_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x53A360)
#define STRUCT_2_0FFD957D5C10AA0F_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x53A3A0)
#define STRUCT_2_0FFD957D5C10AA0F__CCTOR_OFFSET UNITYSDK_OFFSET(0xE96C5B0)
#define STRUCT_2_0FFD957D5C10AA0F__CTOR_OFFSET UNITYSDK_OFFSET(0x53A2D0)

inline static constexpr unsigned int Struct_2_0FFD957D5C10AA0F_TypeDefinitionIndex = 68419;

struct alignas(8) Struct_2_0FFD957D5C10AA0F
{
	static ::Struct_2_0FFD957D5C10AA0F* StaticGet_Field_2_6()
	{
		return (::Struct_2_0FFD957D5C10AA0F*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_0FFD957D5C10AA0F_TypeDefinitionIndex)->GetStaticField(0xDCA0);
	}
