...
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_1F8314262457963A_OFFSET UNITYSDK_OFFSET(0x2FBC20)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_5489F9CD0AA85DE6_OFFSET UNITYSDK_OFFSET(0x2FBBA0)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_77E6E3DA1F0E9CCC_OFFSET UNITYSDK_OFFSET(0x2FBC60)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_9C72894CB5D45A5A_OFFSET UNITYSDK_OFFSET(0x2FBC10)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_C3B21C74C45D6F86_OFFSET UNITYSDK_OFFSET(0x2FBBD0)
#define STRUCT_2_0FFD957D5C10AA0F_METHOD_2_F088209CA8D65638_OFFSET UNITYSDK_OFFSET(0x2FBC40)
#define STRUCT_2_0FFD957D5C10AA0F_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x2FBB20)
#define STRUCT_2_0FFD957D5C10AA0F_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x2FBB60)
#define STRUCT_2_0FFD957D5C10AA0F__CCTOR_OFFSET UNITYSDK_OFFSET(0x6880E60)
#define STRUCT_2_0FFD957D5C10AA0F__CTOR_OFFSET UNITYSDK_OFFSET(0x2FBA90)

inline static constexpr unsigned int Struct_2_0FFD957D5C10AA0F_TypeDefinitionIndex = 73611;

struct alignas(8) Struct_2_0FFD957D5C10AA0F
{
	static ::Struct_2_0FFD957D5C10AA0F* StaticGet_Field_2_6()
	{
		return (::Struct_2_0FFD957D5C10AA0F*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_0FFD957D5C10AA0F_TypeDefinitionIndex)->GetStaticField(0xE1A0);
	}
