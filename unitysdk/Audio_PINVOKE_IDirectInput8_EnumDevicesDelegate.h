...
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA097820)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA0978F0)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA097400)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xA0973E0)

inline static constexpr unsigned int Audio_PINVOKE_IDirectInput8_EnumDevicesDelegate_TypeDefinitionIndex = 59820;
