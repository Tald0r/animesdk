...
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x7FAEF60)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x7FAF030)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x7FAEB40)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x7FAEB30)

inline static constexpr unsigned int Audio_PINVOKE_IDirectInput8_EnumDevicesDelegate_TypeDefinitionIndex = 70695;
