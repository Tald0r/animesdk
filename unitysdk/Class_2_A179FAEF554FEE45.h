...
#define CLASS_2_A179FAEF554FEE45_METHOD_2_24981F8F00B30705_OFFSET UNITYSDK_OFFSET(0x9B5CC10)
#define CLASS_2_A179FAEF554FEE45_METHOD_2_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x9B5C7D0)
#define CLASS_2_A179FAEF554FEE45_METHOD_2_5F6B6215290C17D3_OFFSET UNITYSDK_OFFSET(0x9B5BA80)
#define CLASS_2_A179FAEF554FEE45_METHOD_2_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0x9B5CBA0)
#define CLASS_2_A179FAEF554FEE45_METHOD_2_9F459089AD62C6AA_OFFSET UNITYSDK_OFFSET(0x9B5CA50)
#define CLASS_2_A179FAEF554FEE45_METHOD_2_F29D407ED9229B14_OFFSET UNITYSDK_OFFSET(0x9B5C9C0)
#define CLASS_2_A179FAEF554FEE45__CTOR_OFFSET UNITYSDK_OFFSET(0x9B5B710)

inline static constexpr unsigned int Class_2_A179FAEF554FEE45_TypeDefinitionIndex = 77296;

class Class_2_A179FAEF554FEE45 : public ::Class_1_8D2204756685FA3A
{
public:
	::MoleMole::EntityHandle Field_2_1; // 0x50
	::Class_1_434D96DFAAFA5488* Field_2_2; // 0x60
	::System::Collections::Generic::Dictionary_2<::MoleMole::UI::FlowerShop::ESlotType, ::MoleMole::EntityHandle>* Field_2_0; // 0x68

	::System::Void _ctor(::Class_0_16E4307DCC419505_106* a1, ::Class_2_777A5D016ADC7368* a2, ::UnityEngine::Transform* a3)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_106*, ::Class_2_777A5D016ADC7368*, ::UnityEngine::Transform*))((::PBYTE)hIl2Cpp + CLASS_2_A179FAEF554FEE45__CTOR_OFFSET))(this, a1, a2, a3);
	}
