...
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x187AB710)
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187AB780)
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX_INVOKE_OFFSET UNITYSDK_OFFSET(0x187AB3D0)
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x187AB3C0)

inline static constexpr unsigned int NapRenderEntity_RelativeVectorGetterWithMatrix_TypeDefinitionIndex = 28121;
