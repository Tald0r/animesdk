...
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D0A5D0)
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D0A640)
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D0A290)
#define NAPRENDERENTITY_RELATIVEVECTORGETTERWITHMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x18D0A270)

inline static constexpr unsigned int NapRenderEntity_RelativeVectorGetterWithMatrix_TypeDefinitionIndex = 29061;
