...
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x173DDDD0)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x173DE3B0)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x173DDE70)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_UPDATEMATERIALPROPS_OFFSET UNITYSDK_OFFSET(0x173DE4C0)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x173DE410)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x173DE810)

inline static constexpr unsigned int CountDownNumberMaterialAnimController_TypeDefinitionIndex = 28980;
