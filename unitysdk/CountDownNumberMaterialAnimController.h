...
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16D77420)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_UPDATEMATERIALPROPS_OFFSET UNITYSDK_OFFSET(0x16D77A10)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16D77960)
#define COUNTDOWNNUMBERMATERIALANIMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16D77D60)

inline static constexpr unsigned int CountDownNumberMaterialAnimController_TypeDefinitionIndex = 28040;
