...
#define ADBEXECUTOR_CONNECTDEVICE_OFFSET UNITYSDK_OFFSET(0x1A7A7110)
#define ADBEXECUTOR_GETFIRSTCONNECTEDANDROIDDEVICE_OFFSET UNITYSDK_OFFSET(0x1A7A6950)
#define ADBEXECUTOR_ISFORWARDING_OFFSET UNITYSDK_OFFSET(0x1A7A6940)
#define ADBEXECUTOR_LOADADBPATH_OFFSET UNITYSDK_OFFSET(0x1A7A6840)
#define ADBEXECUTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7A6620)

inline static constexpr unsigned int ADBExecutor_TypeDefinitionIndex = 34921;
