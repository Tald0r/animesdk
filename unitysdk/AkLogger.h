...
#define AKLOGGER_ERROR_OFFSET UNITYSDK_OFFSET(0x1B69B120)
#define AKLOGGER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B69AE00)
#define AKLOGGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B69ADD0)
#define AKLOGGER_INIT_OFFSET UNITYSDK_OFFSET(0x1B69AF50)
#define AKLOGGER_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1B69AF60)
#define AKLOGGER_WARNING_OFFSET UNITYSDK_OFFSET(0x1B69B040)
#define AKLOGGER_WWISEINTERNALLOGERROR_OFFSET UNITYSDK_OFFSET(0x1B69ABA0)
#define AKLOGGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B69B200)
#define AKLOGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B69AC80)

inline static constexpr unsigned int AkLogger_TypeDefinitionIndex = 30991;
...
public:
	...
	{
		return (::AkLogger**)Il2CppClass::FromTypeDefinitionIndex(AkLogger_TypeDefinitionIndex)->GetStaticField(0x24C50);
	}
