...
#define AKLOGGER_ERROR_OFFSET UNITYSDK_OFFSET(0x1B08C950)
#define AKLOGGER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B08C630)
#define AKLOGGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B08C600)
#define AKLOGGER_INIT_OFFSET UNITYSDK_OFFSET(0x1B08C780)
#define AKLOGGER_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1B08C790)
#define AKLOGGER_WARNING_OFFSET UNITYSDK_OFFSET(0x1B08C870)
#define AKLOGGER_WWISEINTERNALLOGERROR_OFFSET UNITYSDK_OFFSET(0x1B08C3E0)
#define AKLOGGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B08CA30)
#define AKLOGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B08C4C0)

inline static constexpr unsigned int AkLogger_TypeDefinitionIndex = 30038;
...
public:
	...
	{
		return (::AkLogger**)Il2CppClass::FromTypeDefinitionIndex(AkLogger_TypeDefinitionIndex)->GetStaticField(0x23330);
	}
