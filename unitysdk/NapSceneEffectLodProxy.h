...
#define NAPSCENEEFFECTLODPROXY_INITBIND_OFFSET UNITYSDK_OFFSET(0x173DF840)
#define NAPSCENEEFFECTLODPROXY_ISONETIMELODPROXY_OFFSET UNITYSDK_OFFSET(0x173DFDA0)
#define NAPSCENEEFFECTLODPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x173DF5D0)
#define NAPSCENEEFFECTLODPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x173DF480)
#define NAPSCENEEFFECTLODPROXY_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x173DF720)
#define NAPSCENEEFFECTLODPROXY_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x173DF7B0)
#define NAPSCENEEFFECTLODPROXY_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x173DF6C0)
#define NAPSCENEEFFECTLODPROXY_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x173DF570)
#define NAPSCENEEFFECTLODPROXY_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x173DFDE0)
#define NAPSCENEEFFECTLODPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x173E0410)
#define NAPSCENEEFFECTLODPROXY___BASE_ISONETIMELODPROXY_OFFSET UNITYSDK_OFFSET(0x173E04D0)

inline static constexpr unsigned int NapSceneEffectLodProxy_TypeDefinitionIndex = 29025;
