...
#define MIHOYOEMOTION_PHONEMESHAPELISTWRAPPER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x18FE0A30)
#define MIHOYOEMOTION_PHONEMESHAPELISTWRAPPER_GET_LIST_OFFSET UNITYSDK_OFFSET(0x18FE0A20)
#define MIHOYOEMOTION_PHONEMESHAPELISTWRAPPER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x18FE0A90)
#define MIHOYOEMOTION_PHONEMESHAPELISTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE0B30)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int PhonemeShapeListWrapper_TypeDefinitionIndex = 37208;
