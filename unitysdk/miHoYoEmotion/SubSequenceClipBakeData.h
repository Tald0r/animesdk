...
#define MIHOYOEMOTION_SUBSEQUENCECLIPBAKEDATA_GET_BAKEDATA_OFFSET UNITYSDK_OFFSET(0x18AF7E40)
#define MIHOYOEMOTION_SUBSEQUENCECLIPBAKEDATA_SET_BAKEDATA_OFFSET UNITYSDK_OFFSET(0x18AF7E50)
#define MIHOYOEMOTION_SUBSEQUENCECLIPBAKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18AF7EF0)
#define MIHOYOEMOTION_SUBSEQUENCECLIPBAKEDATA___BASE_SET_BAKEDATA_OFFSET UNITYSDK_OFFSET(0x18AF7F20)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int SubSequenceClipBakeData_TypeDefinitionIndex = 36215;
