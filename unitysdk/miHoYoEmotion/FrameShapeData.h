...
#define MIHOYOEMOTION_FRAMESHAPEDATA_UPDATEELEMENTS_OFFSET UNITYSDK_OFFSET(0x18AF2E10)
#define MIHOYOEMOTION_FRAMESHAPEDATA_UPDATETYPEELEMENT_OFFSET UNITYSDK_OFFSET(0x18AF2E70)
#define MIHOYOEMOTION_FRAMESHAPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18AF2F10)
#define MIHOYOEMOTION_FRAMESHAPEDATA___BASE_UPDATEELEMENTS_OFFSET UNITYSDK_OFFSET(0x18AF2F60)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameShapeData_TypeDefinitionIndex = 36184;
