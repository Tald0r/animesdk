...
#define MIHOYOEMOTION_FRAMESHAPEDATA_UPDATEELEMENTS_OFFSET UNITYSDK_OFFSET(0x18FDD7B0)
#define MIHOYOEMOTION_FRAMESHAPEDATA_UPDATETYPEELEMENT_OFFSET UNITYSDK_OFFSET(0x18FDD810)
#define MIHOYOEMOTION_FRAMESHAPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDD8B0)
#define MIHOYOEMOTION_FRAMESHAPEDATA___BASE_UPDATEELEMENTS_OFFSET UNITYSDK_OFFSET(0x18FDD900)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameShapeData_TypeDefinitionIndex = 37204;
