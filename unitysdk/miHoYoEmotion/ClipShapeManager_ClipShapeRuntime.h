...
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CLIPSHAPERUNTIME_UPDATERUNTIMEINDEX_OFFSET UNITYSDK_OFFSET(0x18AE3BE0)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CLIPSHAPERUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE4640)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipShapeManager_ClipShapeRuntime_TypeDefinitionIndex = 36144;
