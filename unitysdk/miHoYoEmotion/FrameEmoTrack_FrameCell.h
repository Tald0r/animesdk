...
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_ADDELEMENT_OFFSET UNITYSDK_OFFSET(0x876D10)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_ADDINDEX_OFFSET UNITYSDK_OFFSET(0x876BE0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_APPLY_OFFSET UNITYSDK_OFFSET(0x876D30)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_CLEARCELL_OFFSET UNITYSDK_OFFSET(0x876CC0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_GETELEMENTCELL_OFFSET UNITYSDK_OFFSET(0x876CA0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_GETINDEX_OFFSET UNITYSDK_OFFSET(0x876BF0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_GET_ELEMENTCELLS_OFFSET UNITYSDK_OFFSET(0x272280)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_GET_ELEMENTCNT_OFFSET UNITYSDK_OFFSET(0x876C00)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_SETELEMENTCELL_OFFSET UNITYSDK_OFFSET(0x876CD0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_UPDATE_OFFSET UNITYSDK_OFFSET(0x876D20)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameEmoTrack_FrameCell_TypeDefinitionIndex = 37155;
