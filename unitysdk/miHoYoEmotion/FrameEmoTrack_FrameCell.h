...
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_ADDELEMENT_OFFSET UNITYSDK_OFFSET(0x8483F0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_ADDINDEX_OFFSET UNITYSDK_OFFSET(0x8482C0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_APPLY_OFFSET UNITYSDK_OFFSET(0x848410)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_CLEARCELL_OFFSET UNITYSDK_OFFSET(0x8483A0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_GETELEMENTCELL_OFFSET UNITYSDK_OFFSET(0x848380)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_GETINDEX_OFFSET UNITYSDK_OFFSET(0x8482D0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_GET_ELEMENTCELLS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_GET_ELEMENTCNT_OFFSET UNITYSDK_OFFSET(0x8482E0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_SETELEMENTCELL_OFFSET UNITYSDK_OFFSET(0x8483B0)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMECELL_UPDATE_OFFSET UNITYSDK_OFFSET(0x848400)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameEmoTrack_FrameCell_TypeDefinitionIndex = 36135;
