...
#define MIHOYOEMOTION_BASEEMOANIMATION_ADDTRACK_OFFSET UNITYSDK_OFFSET(0x18FBAA10)
#define MIHOYOEMOTION_BASEEMOANIMATION_APPENDSHAPE_OFFSET UNITYSDK_OFFSET(0x18FBB7D0)
#define MIHOYOEMOTION_BASEEMOANIMATION_APPLY_OFFSET UNITYSDK_OFFSET(0x18FBACF0)
#define MIHOYOEMOTION_BASEEMOANIMATION_CALLALLFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x18FBB330)
#define MIHOYOEMOTION_BASEEMOANIMATION_CALLFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x18FBB270)
#define MIHOYOEMOTION_BASEEMOANIMATION_CLEARSHAPEONLY_OFFSET UNITYSDK_OFFSET(0x18FBB980)
#define MIHOYOEMOTION_BASEEMOANIMATION_CLEARSHAPE_OFFSET UNITYSDK_OFFSET(0x18FBB8C0)
#define MIHOYOEMOTION_BASEEMOANIMATION_ENABLESHAPE_OFFSET UNITYSDK_OFFSET(0x18FBB600)
#define MIHOYOEMOTION_BASEEMOANIMATION_GETCURSHAPE_OFFSET UNITYSDK_OFFSET(0x18FBB410)
#define MIHOYOEMOTION_BASEEMOANIMATION_GETTRACK_OFFSET UNITYSDK_OFFSET(0x18FBAAF0)
#define MIHOYOEMOTION_BASEEMOANIMATION_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x18FBAA00)
#define MIHOYOEMOTION_BASEEMOANIMATION_INIT_OFFSET UNITYSDK_OFFSET(0x18FBAB60)
#define MIHOYOEMOTION_BASEEMOANIMATION_INTERRUPTBLINK_OFFSET UNITYSDK_OFFSET(0x18FBC190)
#define MIHOYOEMOTION_BASEEMOANIMATION_INTERRUPT_OFFSET UNITYSDK_OFFSET(0x18FBC6A0)
#define MIHOYOEMOTION_BASEEMOANIMATION_ISTRACKPLAYING_OFFSET UNITYSDK_OFFSET(0x18FBBA40)
#define MIHOYOEMOTION_BASEEMOANIMATION_PLAYATTIME_OFFSET UNITYSDK_OFFSET(0x18FBC270)
#define MIHOYOEMOTION_BASEEMOANIMATION_PLAYBAKEDSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18FBBB00)
#define MIHOYOEMOTION_BASEEMOANIMATION_PLAYDEFAULT_OFFSET UNITYSDK_OFFSET(0x18FBB6F0)
#define MIHOYOEMOTION_BASEEMOANIMATION_PLAYTRACKATTIME_OFFSET UNITYSDK_OFFSET(0x18FBC4D0)
#define MIHOYOEMOTION_BASEEMOANIMATION_REFRESHSTOPSHAPEVALUES_OFFSET UNITYSDK_OFFSET(0x18FBAE10)
#define MIHOYOEMOTION_BASEEMOANIMATION_REGISTERFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x18FBB0D0)
#define MIHOYOEMOTION_BASEEMOANIMATION_SETCURSHAPE_OFFSET UNITYSDK_OFFSET(0x18FBB530)
#define MIHOYOEMOTION_BASEEMOANIMATION_SETEMOTIONSTOPPED_OFFSET UNITYSDK_OFFSET(0x18FBC050)
#define MIHOYOEMOTION_BASEEMOANIMATION_SETFACIALKEY_OFFSET UNITYSDK_OFFSET(0x18FBBDE0)
#define MIHOYOEMOTION_BASEEMOANIMATION_SETPOSEKEY_OFFSET UNITYSDK_OFFSET(0x18FBBCE0)
#define MIHOYOEMOTION_BASEEMOANIMATION_STOPSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18FBC570)
#define MIHOYOEMOTION_BASEEMOANIMATION_TOGGLEEYECTRL_OFFSET UNITYSDK_OFFSET(0x18FBBEE0)
#define MIHOYOEMOTION_BASEEMOANIMATION_TOGGLEPAUSEBLINK_OFFSET UNITYSDK_OFFSET(0x18FBBFA0)
#define MIHOYOEMOTION_BASEEMOANIMATION_TOGGLEPAUSE_OFFSET UNITYSDK_OFFSET(0x18FBBBE0)
#define MIHOYOEMOTION_BASEEMOANIMATION_UNREGISTERFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x18FBB1A0)
#define MIHOYOEMOTION_BASEEMOANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x18FBABB0)
#define MIHOYOEMOTION_BASEEMOANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18FBC7E0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int BaseEmoAnimation_TypeDefinitionIndex = 37145;
