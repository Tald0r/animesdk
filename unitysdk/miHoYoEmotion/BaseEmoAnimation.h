...
#define MIHOYOEMOTION_BASEEMOANIMATION_ADDTRACK_OFFSET UNITYSDK_OFFSET(0x18AD0350)
#define MIHOYOEMOTION_BASEEMOANIMATION_APPENDSHAPE_OFFSET UNITYSDK_OFFSET(0x18AD1110)
#define MIHOYOEMOTION_BASEEMOANIMATION_APPLY_OFFSET UNITYSDK_OFFSET(0x18AD0630)
#define MIHOYOEMOTION_BASEEMOANIMATION_CALLALLFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x18AD0C70)
#define MIHOYOEMOTION_BASEEMOANIMATION_CALLFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x18AD0BB0)
#define MIHOYOEMOTION_BASEEMOANIMATION_CLEARSHAPEONLY_OFFSET UNITYSDK_OFFSET(0x18AD12C0)
#define MIHOYOEMOTION_BASEEMOANIMATION_CLEARSHAPE_OFFSET UNITYSDK_OFFSET(0x18AD1200)
#define MIHOYOEMOTION_BASEEMOANIMATION_ENABLESHAPE_OFFSET UNITYSDK_OFFSET(0x18AD0F40)
#define MIHOYOEMOTION_BASEEMOANIMATION_GETCURSHAPE_OFFSET UNITYSDK_OFFSET(0x18AD0D50)
#define MIHOYOEMOTION_BASEEMOANIMATION_GETTRACK_OFFSET UNITYSDK_OFFSET(0x18AD0430)
#define MIHOYOEMOTION_BASEEMOANIMATION_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x18AD0340)
#define MIHOYOEMOTION_BASEEMOANIMATION_INIT_OFFSET UNITYSDK_OFFSET(0x18AD04A0)
#define MIHOYOEMOTION_BASEEMOANIMATION_INTERRUPTBLINK_OFFSET UNITYSDK_OFFSET(0x18AD1AD0)
#define MIHOYOEMOTION_BASEEMOANIMATION_INTERRUPT_OFFSET UNITYSDK_OFFSET(0x18AD1FE0)
#define MIHOYOEMOTION_BASEEMOANIMATION_ISTRACKPLAYING_OFFSET UNITYSDK_OFFSET(0x18AD1380)
#define MIHOYOEMOTION_BASEEMOANIMATION_PLAYATTIME_OFFSET UNITYSDK_OFFSET(0x18AD1BB0)
#define MIHOYOEMOTION_BASEEMOANIMATION_PLAYBAKEDSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18AD1440)
#define MIHOYOEMOTION_BASEEMOANIMATION_PLAYDEFAULT_OFFSET UNITYSDK_OFFSET(0x18AD1030)
#define MIHOYOEMOTION_BASEEMOANIMATION_PLAYTRACKATTIME_OFFSET UNITYSDK_OFFSET(0x18AD1E10)
#define MIHOYOEMOTION_BASEEMOANIMATION_REFRESHSTOPSHAPEVALUES_OFFSET UNITYSDK_OFFSET(0x18AD0750)
#define MIHOYOEMOTION_BASEEMOANIMATION_REGISTERFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x18AD0A10)
#define MIHOYOEMOTION_BASEEMOANIMATION_SETCURSHAPE_OFFSET UNITYSDK_OFFSET(0x18AD0E70)
#define MIHOYOEMOTION_BASEEMOANIMATION_SETEMOTIONSTOPPED_OFFSET UNITYSDK_OFFSET(0x18AD1990)
#define MIHOYOEMOTION_BASEEMOANIMATION_SETFACIALKEY_OFFSET UNITYSDK_OFFSET(0x18AD1720)
#define MIHOYOEMOTION_BASEEMOANIMATION_SETPOSEKEY_OFFSET UNITYSDK_OFFSET(0x18AD1620)
#define MIHOYOEMOTION_BASEEMOANIMATION_STOPSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18AD1EB0)
#define MIHOYOEMOTION_BASEEMOANIMATION_TOGGLEEYECTRL_OFFSET UNITYSDK_OFFSET(0x18AD1820)
#define MIHOYOEMOTION_BASEEMOANIMATION_TOGGLEPAUSEBLINK_OFFSET UNITYSDK_OFFSET(0x18AD18E0)
#define MIHOYOEMOTION_BASEEMOANIMATION_TOGGLEPAUSE_OFFSET UNITYSDK_OFFSET(0x18AD1520)
#define MIHOYOEMOTION_BASEEMOANIMATION_UNREGISTERFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x18AD0AE0)
#define MIHOYOEMOTION_BASEEMOANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x18AD04F0)
#define MIHOYOEMOTION_BASEEMOANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD2120)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int BaseEmoAnimation_TypeDefinitionIndex = 36125;
