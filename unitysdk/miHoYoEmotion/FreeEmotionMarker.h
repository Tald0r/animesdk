...
#define MIHOYOEMOTION_FREEEMOTIONMARKER_ADDORSETWEIGHT_OFFSET UNITYSDK_OFFSET(0x18AF3FC0)
#define MIHOYOEMOTION_FREEEMOTIONMARKER_CREATENOTFREEMARKER_OFFSET UNITYSDK_OFFSET(0x18AF3E30)
#define MIHOYOEMOTION_FREEEMOTIONMARKER_CREATE_OFFSET UNITYSDK_OFFSET(0x18AF3D10)
#define MIHOYOEMOTION_FREEEMOTIONMARKER_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x18AF3F20)
#define MIHOYOEMOTION_FREEEMOTIONMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18AEA750)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FreeEmotionMarker_TypeDefinitionIndex = 36182;
