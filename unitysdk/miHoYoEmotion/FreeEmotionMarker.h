...
#define MIHOYOEMOTION_FREEEMOTIONMARKER_ADDORSETWEIGHT_OFFSET UNITYSDK_OFFSET(0x18FDE960)
#define MIHOYOEMOTION_FREEEMOTIONMARKER_CREATENOTFREEMARKER_OFFSET UNITYSDK_OFFSET(0x18FDE7D0)
#define MIHOYOEMOTION_FREEEMOTIONMARKER_CREATE_OFFSET UNITYSDK_OFFSET(0x18FDE6B0)
#define MIHOYOEMOTION_FREEEMOTIONMARKER_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x18FDE8C0)
#define MIHOYOEMOTION_FREEEMOTIONMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD5120)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FreeEmotionMarker_TypeDefinitionIndex = 37202;
