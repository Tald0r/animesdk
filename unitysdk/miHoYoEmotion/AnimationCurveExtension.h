...
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_AREPOINTSCOLINEAR_OFFSET UNITYSDK_OFFSET(0x18ACFAC0)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_CHECKTANGENTCONSISTENCY_OFFSET UNITYSDK_OFFSET(0x18ACFEB0)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_GETDURATION_OFFSET UNITYSDK_OFFSET(0x18AD02B0)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_KEYFRAMEREDUCTIONWITHCOLINEARITY_OFFSET UNITYSDK_OFFSET(0x18ACF690)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_KEYFRAMEREDUCTION_OFFSET UNITYSDK_OFFSET(0x18AD0020)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int AnimationCurveExtension_TypeDefinitionIndex = 36165;
