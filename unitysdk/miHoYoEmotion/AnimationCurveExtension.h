...
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_AREPOINTSCOLINEAR_OFFSET UNITYSDK_OFFSET(0x18FBA180)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_CHECKTANGENTCONSISTENCY_OFFSET UNITYSDK_OFFSET(0x18FBA570)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_GETDURATION_OFFSET UNITYSDK_OFFSET(0x18FBA970)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_KEYFRAMEREDUCTIONWITHCOLINEARITY_OFFSET UNITYSDK_OFFSET(0x18FB9D50)
#define MIHOYOEMOTION_ANIMATIONCURVEEXTENSION_KEYFRAMEREDUCTION_OFFSET UNITYSDK_OFFSET(0x18FBA6E0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int AnimationCurveExtension_TypeDefinitionIndex = 37185;
