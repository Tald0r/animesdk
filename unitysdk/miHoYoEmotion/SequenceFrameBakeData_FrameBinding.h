...
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING_APPLY_OFFSET UNITYSDK_OFFSET(0x18FDCBF0)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING_GETBINDINGBYKEY_OFFSET UNITYSDK_OFFSET(0x18FDCC70)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING_RESETFRAME_OFFSET UNITYSDK_OFFSET(0x18FDC410)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING_UPDATEFRAME_OFFSET UNITYSDK_OFFSET(0x18FDC980)
#define MIHOYOEMOTION_SEQUENCEFRAMEBAKEDATA_FRAMEBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE1760)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int SequenceFrameBakeData_FrameBinding_TypeDefinitionIndex = 37216;
