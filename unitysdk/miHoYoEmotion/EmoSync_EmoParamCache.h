...
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_CLEAR_OFFSET UNITYSDK_OFFSET(0x18FD3650)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_GET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x18FD4AE0)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x18FD4B00)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SETEMOTIONCACHE_OFFSET UNITYSDK_OFFSET(0x18FD2660)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SETPHONEMECACHE_OFFSET UNITYSDK_OFFSET(0x18FD1E20)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SETSEQDATACACHE_OFFSET UNITYSDK_OFFSET(0x18FD4B40)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x18FD4AF0)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD4300)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoSync_EmoParamCache_TypeDefinitionIndex = 37170;

	class EmoSync_EmoParamCache : public ::System::Object
	{
	public:
		::System::String* emotionName; // 0x10
		::System::String* phonemeName; // 0x18
