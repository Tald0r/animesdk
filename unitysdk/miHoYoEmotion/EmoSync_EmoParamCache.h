...
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_CLEAR_OFFSET UNITYSDK_OFFSET(0x18AE8CD0)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_GET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x18AEA120)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x18AEA140)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SETEMOTIONCACHE_OFFSET UNITYSDK_OFFSET(0x18AE7CE0)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SETPHONEMECACHE_OFFSET UNITYSDK_OFFSET(0x18AE7490)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SETSEQDATACACHE_OFFSET UNITYSDK_OFFSET(0x18AEA180)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE_SET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x18AEA130)
#define MIHOYOEMOTION_EMOSYNC_EMOPARAMCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE9950)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoSync_EmoParamCache_TypeDefinitionIndex = 36150;

	class EmoSync_EmoParamCache : public ::System::Object
	{
	public:
		::miHoYoEmotion::SequenceBakeData* seqData; // 0x10
