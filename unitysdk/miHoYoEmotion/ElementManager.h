...
#define MIHOYOEMOTION_ELEMENTMANAGER_ADDSHAPERUNTIME_OFFSET UNITYSDK_OFFSET(0x18FCDFF0)
#define MIHOYOEMOTION_ELEMENTMANAGER_GET_EMOANIM_OFFSET UNITYSDK_OFFSET(0x18FCFC10)
#define MIHOYOEMOTION_ELEMENTMANAGER_GET_PREVIEWMODE_OFFSET UNITYSDK_OFFSET(0x18FCFBB0)
#define MIHOYOEMOTION_ELEMENTMANAGER_GET_SHAPEDATA_OFFSET UNITYSDK_OFFSET(0x18FCFBF0)
#define MIHOYOEMOTION_ELEMENTMANAGER_GET_STATEMGR_OFFSET UNITYSDK_OFFSET(0x18FCFC20)
#define MIHOYOEMOTION_ELEMENTMANAGER_GET_TICKABLE_OFFSET UNITYSDK_OFFSET(0x18FCFBD0)
#define MIHOYOEMOTION_ELEMENTMANAGER_INITEMOANIM_OFFSET UNITYSDK_OFFSET(0x18FCDB10)
#define MIHOYOEMOTION_ELEMENTMANAGER_INITSTATEMGR_OFFSET UNITYSDK_OFFSET(0x18FCFC40)
#define MIHOYOEMOTION_ELEMENTMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18FCFA30)
#define MIHOYOEMOTION_ELEMENTMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18FCF990)
#define MIHOYOEMOTION_ELEMENTMANAGER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x18FCFAD0)
#define MIHOYOEMOTION_ELEMENTMANAGER_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x18FCFB40)
#define MIHOYOEMOTION_ELEMENTMANAGER_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x18FCFE80)
#define MIHOYOEMOTION_ELEMENTMANAGER_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x18FCFE40)
#define MIHOYOEMOTION_ELEMENTMANAGER_SET_PREVIEWMODE_OFFSET UNITYSDK_OFFSET(0x18FCFBC0)
#define MIHOYOEMOTION_ELEMENTMANAGER_SET_SHAPEDATA_OFFSET UNITYSDK_OFFSET(0x18FCFC00)
#define MIHOYOEMOTION_ELEMENTMANAGER_SET_TICKABLE_OFFSET UNITYSDK_OFFSET(0x18FCFBE0)
#define MIHOYOEMOTION_ELEMENTMANAGER_SET_TIMECHECKPOINT_OFFSET UNITYSDK_OFFSET(0x18FCFC30)
#define MIHOYOEMOTION_ELEMENTMANAGER_START_OFFSET UNITYSDK_OFFSET(0x18FCAA10)
#define MIHOYOEMOTION_ELEMENTMANAGER_UPDATESHAPEDATA_OFFSET UNITYSDK_OFFSET(0x18FCDB50)
#define MIHOYOEMOTION_ELEMENTMANAGER_UPDATESHAPERUNTIME_OFFSET UNITYSDK_OFFSET(0x18FCDF50)
#define MIHOYOEMOTION_ELEMENTMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18FCFEC0)
#define MIHOYOEMOTION_ELEMENTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCE670)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ElementManager_TypeDefinitionIndex = 37165;
