...
#define MIHOYOEMOTION_STOPSHAPEDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x18AF72B0)
#define MIHOYOEMOTION_STOPSHAPEDATA_GET_INFOMESSAGE_OFFSET UNITYSDK_OFFSET(0x18AF7240)
#define MIHOYOEMOTION_STOPSHAPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18AF79F0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int StopShapeData_TypeDefinitionIndex = 36209;
