...
#define MIHOYOEMOTION_BLENDSHAPEBIND__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD28A0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int BlendShapeBind_TypeDefinitionIndex = 36208;
