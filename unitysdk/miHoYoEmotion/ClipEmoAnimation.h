...
#define MIHOYOEMOTION_CLIPEMOANIMATION_INIT_OFFSET UNITYSDK_OFFSET(0x18FBD9D0)
#define MIHOYOEMOTION_CLIPEMOANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18FBDE30)
#define MIHOYOEMOTION_CLIPEMOANIMATION___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x18FBDE90)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipEmoAnimation_TypeDefinitionIndex = 37146;
