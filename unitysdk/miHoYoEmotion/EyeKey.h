...
#define MIHOYOEMOTION_EYEKEY_APPLYBONEDATA_OFFSET UNITYSDK_OFFSET(0x18AE2DB0)
#define MIHOYOEMOTION_EYEKEY_APPLYBONEVALUE_OFFSET UNITYSDK_OFFSET(0x18AE49F0)
#define MIHOYOEMOTION_EYEKEY_APPLY_1_OFFSET UNITYSDK_OFFSET(0x18AEDF90)
#define MIHOYOEMOTION_EYEKEY_APPLY_OFFSET UNITYSDK_OFFSET(0x18AEE120)
#define MIHOYOEMOTION_EYEKEY_CHECKINIT_1_OFFSET UNITYSDK_OFFSET(0x18AEDAA0)
#define MIHOYOEMOTION_EYEKEY_CHECKINIT_OFFSET UNITYSDK_OFFSET(0x18AED880)
#define MIHOYOEMOTION_EYEKEY_CHECKRESET_OFFSET UNITYSDK_OFFSET(0x18AEE4E0)
#define MIHOYOEMOTION_EYEKEY_CLEAR_OFFSET UNITYSDK_OFFSET(0x18AEE630)
#define MIHOYOEMOTION_EYEKEY_GETBONEVALUE_OFFSET UNITYSDK_OFFSET(0x18AE4B90)
#define MIHOYOEMOTION_EYEKEY_GET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0x18AED1A0)
#define MIHOYOEMOTION_EYEKEY_GET_PREVIEWMODE_OFFSET UNITYSDK_OFFSET(0x18AED2B0)
#define MIHOYOEMOTION_EYEKEY_GET_SCRIPTENABLE_OFFSET UNITYSDK_OFFSET(0x18AED2F0)
#define MIHOYOEMOTION_EYEKEY_GET_TICKABLE_OFFSET UNITYSDK_OFFSET(0x18AED2D0)
#define MIHOYOEMOTION_EYEKEY_INITBONEDATA_OFFSET UNITYSDK_OFFSET(0x18AE0B80)
#define MIHOYOEMOTION_EYEKEY_INIT_OFFSET UNITYSDK_OFFSET(0x18AED730)
#define MIHOYOEMOTION_EYEKEY_LATETICK_OFFSET UNITYSDK_OFFSET(0x18AEDD60)
#define MIHOYOEMOTION_EYEKEY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18AEDD10)
#define MIHOYOEMOTION_EYEKEY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18AEEA50)
#define MIHOYOEMOTION_EYEKEY_RESET_OFFSET UNITYSDK_OFFSET(0x18AEE370)
#define MIHOYOEMOTION_EYEKEY_SETTARGETROT_OFFSET UNITYSDK_OFFSET(0x18AECE60)
#define MIHOYOEMOTION_EYEKEY_SETTARGETSCALE_OFFSET UNITYSDK_OFFSET(0x18AED4A0)
#define MIHOYOEMOTION_EYEKEY_SET_PREVIEWMODE_OFFSET UNITYSDK_OFFSET(0x18AED2C0)
#define MIHOYOEMOTION_EYEKEY_SET_SCRIPTENABLE_OFFSET UNITYSDK_OFFSET(0x18AED300)
#define MIHOYOEMOTION_EYEKEY_SET_TICKABLE_OFFSET UNITYSDK_OFFSET(0x18AED2E0)
#define MIHOYOEMOTION_EYEKEY_TICKTARGETROT_OFFSET UNITYSDK_OFFSET(0x18AED310)
#define MIHOYOEMOTION_EYEKEY_TICKTARGETSCALE_OFFSET UNITYSDK_OFFSET(0x18AED5D0)
#define MIHOYOEMOTION_EYEKEY__CCTOR_OFFSET UNITYSDK_OFFSET(0x18AEEE70)
#define MIHOYOEMOTION_EYEKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x18AEEBD0)
#define MIHOYOEMOTION_EYEKEY__INITBONEDATA_G__FINDBONE_93_0_OFFSET UNITYSDK_OFFSET(0x18AEE6E0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EyeKey_TypeDefinitionIndex = 36153;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(EyeKey_TypeDefinitionIndex)->GetStaticField(0x26D10);
		}
