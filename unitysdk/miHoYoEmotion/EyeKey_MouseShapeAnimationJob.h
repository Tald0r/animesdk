...
#define MIHOYOEMOTION_EYEKEY_MOUSESHAPEANIMATIONJOB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x848290)
#define MIHOYOEMOTION_EYEKEY_MOUSESHAPEANIMATIONJOB_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x848210)
#define MIHOYOEMOTION_EYEKEY_MOUSESHAPEANIMATIONJOB_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x848250)
#define MIHOYOEMOTION_EYEKEY_MOUSESHAPEANIMATIONJOB__CTOR_OFFSET UNITYSDK_OFFSET(0x848200)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EyeKey_MouseShapeAnimationJob_TypeDefinitionIndex = 36157;
