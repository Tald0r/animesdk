...
#define MIHOYOEMOTION_FRAMESHAPEELEMENT_GET_BLINKDURATION_OFFSET UNITYSDK_OFFSET(0x18FDD9F0)
#define MIHOYOEMOTION_FRAMESHAPEELEMENT_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x18FDD910)
#define MIHOYOEMOTION_FRAMESHAPEELEMENT_GET_POSTDURATION_OFFSET UNITYSDK_OFFSET(0x18FDD980)
#define MIHOYOEMOTION_FRAMESHAPEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDDA60)
#define MIHOYOEMOTION_FRAMESHAPEELEMENT___BASE_GET_BLINKDURATION_OFFSET UNITYSDK_OFFSET(0x18FDDA80)
#define MIHOYOEMOTION_FRAMESHAPEELEMENT___BASE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x18FDDAA0)
#define MIHOYOEMOTION_FRAMESHAPEELEMENT___BASE_GET_POSTDURATION_OFFSET UNITYSDK_OFFSET(0x18FDDAB0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameShapeElement_TypeDefinitionIndex = 37226;
