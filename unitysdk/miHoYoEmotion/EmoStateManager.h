...
#define MIHOYOEMOTION_EMOSTATEMANAGER_CALLSTATECLEARHANDLER_OFFSET UNITYSDK_OFFSET(0x18AE60E0)
#define MIHOYOEMOTION_EMOSTATEMANAGER_CLEARSTATECLEARHANDLER_OFFSET UNITYSDK_OFFSET(0x18AE63B0)
#define MIHOYOEMOTION_EMOSTATEMANAGER_CLEARSTATE_OFFSET UNITYSDK_OFFSET(0x18AE5E60)
#define MIHOYOEMOTION_EMOSTATEMANAGER_INSTATE_OFFSET UNITYSDK_OFFSET(0x18AE6010)
#define MIHOYOEMOTION_EMOSTATEMANAGER_SETSTATECLEARHANDLER_OFFSET UNITYSDK_OFFSET(0x18AE61E0)
#define MIHOYOEMOTION_EMOSTATEMANAGER_SETSTATE_OFFSET UNITYSDK_OFFSET(0x18AE5D70)
#define MIHOYOEMOTION_EMOSTATEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE54F0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoStateManager_TypeDefinitionIndex = 36163;
