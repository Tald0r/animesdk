...
#define MIHOYOEMOTION_EMOSTATEMANAGER_CALLSTATECLEARHANDLER_OFFSET UNITYSDK_OFFSET(0x18FD0A70)
#define MIHOYOEMOTION_EMOSTATEMANAGER_CLEARSTATECLEARHANDLER_OFFSET UNITYSDK_OFFSET(0x18FD0D40)
#define MIHOYOEMOTION_EMOSTATEMANAGER_CLEARSTATE_OFFSET UNITYSDK_OFFSET(0x18FD07F0)
#define MIHOYOEMOTION_EMOSTATEMANAGER_INSTATE_OFFSET UNITYSDK_OFFSET(0x18FD09A0)
#define MIHOYOEMOTION_EMOSTATEMANAGER_SETSTATECLEARHANDLER_OFFSET UNITYSDK_OFFSET(0x18FD0B70)
#define MIHOYOEMOTION_EMOSTATEMANAGER_SETSTATE_OFFSET UNITYSDK_OFFSET(0x18FD0700)
#define MIHOYOEMOTION_EMOSTATEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCFD70)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoStateManager_TypeDefinitionIndex = 37183;
