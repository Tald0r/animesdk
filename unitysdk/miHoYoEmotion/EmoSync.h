...
#define MIHOYOEMOTION_EMOSYNC_ADD_ONPHOFINISHEVENT_OFFSET UNITYSDK_OFFSET(0x18AE6840)
#define MIHOYOEMOTION_EMOSYNC_CLEAREMOTION_OFFSET UNITYSDK_OFFSET(0x18AE8C50)
#define MIHOYOEMOTION_EMOSYNC_CLEARSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18AE8BC0)
#define MIHOYOEMOTION_EMOSYNC_EMOFINISH_OFFSET UNITYSDK_OFFSET(0x18AE8D20)
#define MIHOYOEMOTION_EMOSYNC_ENDSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18AE89E0)
#define MIHOYOEMOTION_EMOSYNC_GETEMOTION_OFFSET UNITYSDK_OFFSET(0x18AE6E40)
#define MIHOYOEMOTION_EMOSYNC_GETPHONEME_OFFSET UNITYSDK_OFFSET(0x18AE6D70)
#define MIHOYOEMOTION_EMOSYNC_GET_SETDATA_OFFSET UNITYSDK_OFFSET(0x18AE6820)
#define MIHOYOEMOTION_EMOSYNC_INTERRUPTSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18AE8A40)
#define MIHOYOEMOTION_EMOSYNC_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18AE9D30)
#define MIHOYOEMOTION_EMOSYNC_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18AE9CB0)
#define MIHOYOEMOTION_EMOSYNC_PERFORMCACHE_OFFSET UNITYSDK_OFFSET(0x18AE9350)
#define MIHOYOEMOTION_EMOSYNC_PHOFINISH_OFFSET UNITYSDK_OFFSET(0x18AE8DB0)
#define MIHOYOEMOTION_EMOSYNC_PLAYATTIME_OFFSET UNITYSDK_OFFSET(0x18AE8880)
#define MIHOYOEMOTION_EMOSYNC_PLAYSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18AE8410)
#define MIHOYOEMOTION_EMOSYNC_REMOVE_ONPHOFINISHEVENT_OFFSET UNITYSDK_OFFSET(0x18AE68C0)
#define MIHOYOEMOTION_EMOSYNC_RESETEMOTION_OFFSET UNITYSDK_OFFSET(0x18AE7D80)
#define MIHOYOEMOTION_EMOSYNC_RESETPHONEME_OFFSET UNITYSDK_OFFSET(0x18AE6F00)
#define MIHOYOEMOTION_EMOSYNC_RESETSTATE_OFFSET UNITYSDK_OFFSET(0x18AE8AA0)
#define MIHOYOEMOTION_EMOSYNC_SETDEFAULTEMOTION_OFFSET UNITYSDK_OFFSET(0x18AE9970)
#define MIHOYOEMOTION_EMOSYNC_SETDEFAULTPHONEME_OFFSET UNITYSDK_OFFSET(0x18AE9B80)
#define MIHOYOEMOTION_EMOSYNC_SETEMOTION_OFFSET UNITYSDK_OFFSET(0x18AE7F00)
#define MIHOYOEMOTION_EMOSYNC_SETPHONEMEANDEMOTION_OFFSET UNITYSDK_OFFSET(0x18AE7530)
#define MIHOYOEMOTION_EMOSYNC_SETPHONEME_OFFSET UNITYSDK_OFFSET(0x18AE7090)
#define MIHOYOEMOTION_EMOSYNC_SETPOSEFACIALKEY_OFFSET UNITYSDK_OFFSET(0x18AE82F0)
#define MIHOYOEMOTION_EMOSYNC_SET_SETDATA_OFFSET UNITYSDK_OFFSET(0x18AE6830)
#define MIHOYOEMOTION_EMOSYNC_START_OFFSET UNITYSDK_OFFSET(0x18AE9640)
#define MIHOYOEMOTION_EMOSYNC_TOGGLE_OFFSET UNITYSDK_OFFSET(0x18AE8800)
#define MIHOYOEMOTION_EMOSYNC_UPDATECACHE_OFFSET UNITYSDK_OFFSET(0x18AE6D20)
#define MIHOYOEMOTION_EMOSYNC_UPDATEEMOTIONCACHE_OFFSET UNITYSDK_OFFSET(0x18AE6B30)
#define MIHOYOEMOTION_EMOSYNC_UPDATEPHONEMECACHE_OFFSET UNITYSDK_OFFSET(0x18AE6940)
#define MIHOYOEMOTION_EMOSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE9E00)
#define MIHOYOEMOTION_EMOSYNC___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18AEA000)
#define MIHOYOEMOTION_EMOSYNC___BASE_START_OFFSET UNITYSDK_OFFSET(0x18AEA090)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoSync_TypeDefinitionIndex = 36149;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MIHOYOEMOTION_EMOSYNC_ONENABLE_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MIHOYOEMOTION_EMOSYNC___BASE_ONENABLE_OFFSET))(this);
		}
