...
#define MIHOYOEMOTION_EMOSYNC_ADD_ONPHOFINISHEVENT_OFFSET UNITYSDK_OFFSET(0x18FD11D0)
#define MIHOYOEMOTION_EMOSYNC_CLEAREMOTION_OFFSET UNITYSDK_OFFSET(0x18FD35D0)
#define MIHOYOEMOTION_EMOSYNC_CLEARSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18FD3540)
#define MIHOYOEMOTION_EMOSYNC_EMOFINISH_OFFSET UNITYSDK_OFFSET(0x18FD36B0)
#define MIHOYOEMOTION_EMOSYNC_ENDSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18FD3360)
#define MIHOYOEMOTION_EMOSYNC_GETEMOTION_OFFSET UNITYSDK_OFFSET(0x18FD17D0)
#define MIHOYOEMOTION_EMOSYNC_GETPHONEME_OFFSET UNITYSDK_OFFSET(0x18FD1700)
#define MIHOYOEMOTION_EMOSYNC_GET_SETDATA_OFFSET UNITYSDK_OFFSET(0x18FD11B0)
#define MIHOYOEMOTION_EMOSYNC_INTERRUPTSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18FD33C0)
#define MIHOYOEMOTION_EMOSYNC_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18FD46F0)
#define MIHOYOEMOTION_EMOSYNC_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x18FD4670)
#define MIHOYOEMOTION_EMOSYNC_PERFORMCACHE_OFFSET UNITYSDK_OFFSET(0x18FD3CE0)
#define MIHOYOEMOTION_EMOSYNC_PHOFINISH_OFFSET UNITYSDK_OFFSET(0x18FD3740)
#define MIHOYOEMOTION_EMOSYNC_PLAYATTIME_OFFSET UNITYSDK_OFFSET(0x18FD3200)
#define MIHOYOEMOTION_EMOSYNC_PLAYSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18FD2D90)
#define MIHOYOEMOTION_EMOSYNC_REMOVE_ONPHOFINISHEVENT_OFFSET UNITYSDK_OFFSET(0x18FD1250)
#define MIHOYOEMOTION_EMOSYNC_RESETEMOTION_OFFSET UNITYSDK_OFFSET(0x18FD2700)
#define MIHOYOEMOTION_EMOSYNC_RESETPHONEME_OFFSET UNITYSDK_OFFSET(0x18FD1890)
#define MIHOYOEMOTION_EMOSYNC_RESETSTATE_OFFSET UNITYSDK_OFFSET(0x18FD3420)
#define MIHOYOEMOTION_EMOSYNC_SETDEFAULTEMOTION_OFFSET UNITYSDK_OFFSET(0x18FD4330)
#define MIHOYOEMOTION_EMOSYNC_SETDEFAULTPHONEME_OFFSET UNITYSDK_OFFSET(0x18FD4540)
#define MIHOYOEMOTION_EMOSYNC_SETEMOTION_OFFSET UNITYSDK_OFFSET(0x18FD2880)
#define MIHOYOEMOTION_EMOSYNC_SETPHONEMEANDEMOTION_OFFSET UNITYSDK_OFFSET(0x18FD1EC0)
#define MIHOYOEMOTION_EMOSYNC_SETPHONEME_OFFSET UNITYSDK_OFFSET(0x18FD1A20)
#define MIHOYOEMOTION_EMOSYNC_SETPOSEFACIALKEY_OFFSET UNITYSDK_OFFSET(0x18FD2C70)
#define MIHOYOEMOTION_EMOSYNC_SET_SETDATA_OFFSET UNITYSDK_OFFSET(0x18FD11C0)
#define MIHOYOEMOTION_EMOSYNC_START_OFFSET UNITYSDK_OFFSET(0x18FD3FE0)
#define MIHOYOEMOTION_EMOSYNC_TOGGLE_OFFSET UNITYSDK_OFFSET(0x18FD3180)
#define MIHOYOEMOTION_EMOSYNC_UPDATECACHE_OFFSET UNITYSDK_OFFSET(0x18FD16B0)
#define MIHOYOEMOTION_EMOSYNC_UPDATEEMOTIONCACHE_OFFSET UNITYSDK_OFFSET(0x18FD14C0)
#define MIHOYOEMOTION_EMOSYNC_UPDATEPHONEMECACHE_OFFSET UNITYSDK_OFFSET(0x18FD12D0)
#define MIHOYOEMOTION_EMOSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD47C0)
#define MIHOYOEMOTION_EMOSYNC___BASE_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x18FD49C0)
#define MIHOYOEMOTION_EMOSYNC___BASE_START_OFFSET UNITYSDK_OFFSET(0x18FD4A50)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoSync_TypeDefinitionIndex = 37169;
