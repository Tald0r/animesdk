...
#define MIHOYOEMOTION_FREERDPHONEMEMARKER_ADDORSETWEIGHT_OFFSET UNITYSDK_OFFSET(0x18FDEE90)
#define MIHOYOEMOTION_FREERDPHONEMEMARKER_CREATENOTFREEMARKER_OFFSET UNITYSDK_OFFSET(0x18FDEC60)
#define MIHOYOEMOTION_FREERDPHONEMEMARKER_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x18FDEDD0)
#define MIHOYOEMOTION_FREERDPHONEMEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDEAB0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FreeRDPhonemeMarker_TypeDefinitionIndex = 37201;
