...
#define MIHOYOEMOTION_EYECTRLMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD7B10)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EyeCtrlMarker_TypeDefinitionIndex = 37196;
