...
#define MIHOYOEMOTION_EMOMGRUSER_CLEARSTATE_OFFSET UNITYSDK_OFFSET(0x18FD0790)
#define MIHOYOEMOTION_EMOMGRUSER_GET_EMOANIM_OFFSET UNITYSDK_OFFSET(0x18FD0080)
#define MIHOYOEMOTION_EMOMGRUSER_GET_EMOSTATE_OFFSET UNITYSDK_OFFSET(0x18FD00B0)
#define MIHOYOEMOTION_EMOMGRUSER_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x18FD0090)
#define MIHOYOEMOTION_EMOMGRUSER_GET_TICKABLE_OFFSET UNITYSDK_OFFSET(0x18FD00C0)
#define MIHOYOEMOTION_EMOMGRUSER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x18FD0060)
#define MIHOYOEMOTION_EMOMGRUSER_ISSTATE_OFFSET UNITYSDK_OFFSET(0x18FD08D0)
#define MIHOYOEMOTION_EMOMGRUSER_LATETICK_OFFSET UNITYSDK_OFFSET(0x18FD0640)
#define MIHOYOEMOTION_EMOMGRUSER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18FCFF50)
#define MIHOYOEMOTION_EMOMGRUSER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x18FCFFF0)
#define MIHOYOEMOTION_EMOMGRUSER_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x18FD05F0)
#define MIHOYOEMOTION_EMOMGRUSER_SETSTATE_OFFSET UNITYSDK_OFFSET(0x18FD06A0)
#define MIHOYOEMOTION_EMOMGRUSER_SET_TICKABLE_OFFSET UNITYSDK_OFFSET(0x18FD00D0)
#define MIHOYOEMOTION_EMOMGRUSER_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x18FD0070)
#define MIHOYOEMOTION_EMOMGRUSER_START_OFFSET UNITYSDK_OFFSET(0x18FD01A0)
#define MIHOYOEMOTION_EMOMGRUSER_UPDATEMANGER_OFFSET UNITYSDK_OFFSET(0x18FD01F0)
#define MIHOYOEMOTION_EMOMGRUSER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD0A40)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoMgrUser_TypeDefinitionIndex = 37168;
