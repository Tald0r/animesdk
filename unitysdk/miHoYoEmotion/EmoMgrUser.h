...
#define MIHOYOEMOTION_EMOMGRUSER_CLEARSTATE_OFFSET UNITYSDK_OFFSET(0x18AE5E00)
#define MIHOYOEMOTION_EMOMGRUSER_GET_EMOANIM_OFFSET UNITYSDK_OFFSET(0x18AE56F0)
#define MIHOYOEMOTION_EMOMGRUSER_GET_EMOSTATE_OFFSET UNITYSDK_OFFSET(0x18AE5720)
#define MIHOYOEMOTION_EMOMGRUSER_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x18AE5700)
#define MIHOYOEMOTION_EMOMGRUSER_GET_TICKABLE_OFFSET UNITYSDK_OFFSET(0x18AE5730)
#define MIHOYOEMOTION_EMOMGRUSER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x18AE56D0)
#define MIHOYOEMOTION_EMOMGRUSER_ISSTATE_OFFSET UNITYSDK_OFFSET(0x18AE5F40)
#define MIHOYOEMOTION_EMOMGRUSER_LATETICK_OFFSET UNITYSDK_OFFSET(0x18AE5CB0)
#define MIHOYOEMOTION_EMOMGRUSER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18AE5C60)
#define MIHOYOEMOTION_EMOMGRUSER_SETSTATE_OFFSET UNITYSDK_OFFSET(0x18AE5D10)
#define MIHOYOEMOTION_EMOMGRUSER_SET_TICKABLE_OFFSET UNITYSDK_OFFSET(0x18AE5740)
#define MIHOYOEMOTION_EMOMGRUSER_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x18AE56E0)
#define MIHOYOEMOTION_EMOMGRUSER_START_OFFSET UNITYSDK_OFFSET(0x18AE5810)
#define MIHOYOEMOTION_EMOMGRUSER_UPDATEMANGER_OFFSET UNITYSDK_OFFSET(0x18AE5860)
#define MIHOYOEMOTION_EMOMGRUSER__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE60B0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoMgrUser_TypeDefinitionIndex = 36148;
