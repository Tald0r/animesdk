...
#define MIHOYOEMOTION_RDPHONEMEMARKER_CLONETOFREEMARKER_OFFSET UNITYSDK_OFFSET(0x18AF67F0)
#define MIHOYOEMOTION_RDPHONEMEMARKER_CREATECOPY_OFFSET UNITYSDK_OFFSET(0x18AF62C0)
#define MIHOYOEMOTION_RDPHONEMEMARKER_GETTIME_OFFSET UNITYSDK_OFFSET(0x18AF69E0)
#define MIHOYOEMOTION_RDPHONEMEMARKER_ISFREEMARKER_OFFSET UNITYSDK_OFFSET(0x18AF6240)
#define MIHOYOEMOTION_RDPHONEMEMARKER_SETTOOTHERMARKER_OFFSET UNITYSDK_OFFSET(0x18AF43B0)
#define MIHOYOEMOTION_RDPHONEMEMARKER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18AF4290)
#define MIHOYOEMOTION_RDPHONEMEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18AF43A0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int RDPhonemeMarker_TypeDefinitionIndex = 36180;
