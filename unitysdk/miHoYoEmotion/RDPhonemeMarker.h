...
#define MIHOYOEMOTION_RDPHONEMEMARKER_CLONETOFREEMARKER_OFFSET UNITYSDK_OFFSET(0x18FE1160)
#define MIHOYOEMOTION_RDPHONEMEMARKER_CREATECOPY_OFFSET UNITYSDK_OFFSET(0x18FE0C30)
#define MIHOYOEMOTION_RDPHONEMEMARKER_GETTIME_OFFSET UNITYSDK_OFFSET(0x18FE1350)
#define MIHOYOEMOTION_RDPHONEMEMARKER_ISFREEMARKER_OFFSET UNITYSDK_OFFSET(0x18FE0BB0)
#define MIHOYOEMOTION_RDPHONEMEMARKER_SETTOOTHERMARKER_OFFSET UNITYSDK_OFFSET(0x18FDED50)
#define MIHOYOEMOTION_RDPHONEMEMARKER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18FDEC30)
#define MIHOYOEMOTION_RDPHONEMEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDED40)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int RDPhonemeMarker_TypeDefinitionIndex = 37200;
