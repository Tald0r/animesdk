...
#define MIHOYOEMOTION_BASESHAPEDATA_ADDSHAPEELEMENT_OFFSET UNITYSDK_OFFSET(0x18FBCC30)
#define MIHOYOEMOTION_BASESHAPEDATA_INITELEMENTDIC_OFFSET UNITYSDK_OFFSET(0x18FBCB80)
#define MIHOYOEMOTION_BASESHAPEDATA_UPDATEELEMENTS_OFFSET UNITYSDK_OFFSET(0x18FBCDD0)
#define MIHOYOEMOTION_BASESHAPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18FBCF30)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int BaseShapeData_TypeDefinitionIndex = 37186;
