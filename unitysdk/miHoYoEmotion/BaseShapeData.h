...
#define MIHOYOEMOTION_BASESHAPEDATA_ADDSHAPEELEMENT_OFFSET UNITYSDK_OFFSET(0x18AD2570)
#define MIHOYOEMOTION_BASESHAPEDATA_INITELEMENTDIC_OFFSET UNITYSDK_OFFSET(0x18AD24C0)
#define MIHOYOEMOTION_BASESHAPEDATA_UPDATEELEMENTS_OFFSET UNITYSDK_OFFSET(0x18AD2710)
#define MIHOYOEMOTION_BASESHAPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD2870)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int BaseShapeData_TypeDefinitionIndex = 36166;
