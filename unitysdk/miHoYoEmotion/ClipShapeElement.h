...
#define MIHOYOEMOTION_CLIPSHAPEELEMENT_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x18AE00B0)
#define MIHOYOEMOTION_CLIPSHAPEELEMENT_GET_POSTDURATION_OFFSET UNITYSDK_OFFSET(0x18AE0120)
#define MIHOYOEMOTION_CLIPSHAPEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE0190)
#define MIHOYOEMOTION_CLIPSHAPEELEMENT___BASE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x18AE01B0)
#define MIHOYOEMOTION_CLIPSHAPEELEMENT___BASE_GET_POSTDURATION_OFFSET UNITYSDK_OFFSET(0x18AE01D0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipShapeElement_TypeDefinitionIndex = 36202;
