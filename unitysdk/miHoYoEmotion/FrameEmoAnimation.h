...
#define MIHOYOEMOTION_FRAMEEMOANIMATION_INIT_OFFSET UNITYSDK_OFFSET(0x18FDA140)
#define MIHOYOEMOTION_FRAMEEMOANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDA360)
#define MIHOYOEMOTION_FRAMEEMOANIMATION___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x18FDA3C0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameEmoAnimation_TypeDefinitionIndex = 37157;
