...
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK_BUILDFRAMES_OFFSET UNITYSDK_OFFSET(0x18AEFDB0)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK_ENABLESHAPE_OFFSET UNITYSDK_OFFSET(0x18AEFA80)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18AEF960)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK___BASE_BUILDFRAMES_OFFSET UNITYSDK_OFFSET(0x18AF0A60)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK___BASE_ENABLESHAPE_OFFSET UNITYSDK_OFFSET(0x18AF1460)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameEmoBlinkTrack_TypeDefinitionIndex = 36136;
