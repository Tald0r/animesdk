...
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK_BUILDFRAMES_OFFSET UNITYSDK_OFFSET(0x18FDA770)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK_ENABLESHAPE_OFFSET UNITYSDK_OFFSET(0x18FDA450)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18FDA330)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK___BASE_BUILDFRAMES_OFFSET UNITYSDK_OFFSET(0x18FDB420)
#define MIHOYOEMOTION_FRAMEEMOBLINKTRACK___BASE_ENABLESHAPE_OFFSET UNITYSDK_OFFSET(0x18FDBE20)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameEmoBlinkTrack_TypeDefinitionIndex = 37156;
