...
#define MIHOYOEMOTION_EMOTRACK_APPENDSHAPE_OFFSET UNITYSDK_OFFSET(0x18AEA390)
#define MIHOYOEMOTION_EMOTRACK_APPLY_OFFSET UNITYSDK_OFFSET(0x18AD44E0)
#define MIHOYOEMOTION_EMOTRACK_CALLFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x18ADE450)
#define MIHOYOEMOTION_EMOTRACK_CLEARSHAPEONLY_OFFSET UNITYSDK_OFFSET(0x18AD8810)
#define MIHOYOEMOTION_EMOTRACK_CLEARSHAPE_OFFSET UNITYSDK_OFFSET(0x18AD84E0)
#define MIHOYOEMOTION_EMOTRACK_ENABLESHAPE_OFFSET UNITYSDK_OFFSET(0x18ADEE60)
#define MIHOYOEMOTION_EMOTRACK_EVALUATE_OFFSET UNITYSDK_OFFSET(0x18ADEF70)
#define MIHOYOEMOTION_EMOTRACK_GETCURSHAPE_OFFSET UNITYSDK_OFFSET(0x18AD0E30)
#define MIHOYOEMOTION_EMOTRACK_INIT_OFFSET UNITYSDK_OFFSET(0x18AD3AE0)
#define MIHOYOEMOTION_EMOTRACK_INTERRUPT_OFFSET UNITYSDK_OFFSET(0x18AEA3F0)
#define MIHOYOEMOTION_EMOTRACK_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x18ADF100)
#define MIHOYOEMOTION_EMOTRACK_PLAYBAKEDSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18ADF1D0)
#define MIHOYOEMOTION_EMOTRACK_PLAYDEFAULT_OFFSET UNITYSDK_OFFSET(0x18AD4FF0)
#define MIHOYOEMOTION_EMOTRACK_REGISTERFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x18AEA250)
#define MIHOYOEMOTION_EMOTRACK_SETCURSHAPE_OFFSET UNITYSDK_OFFSET(0x18AEA330)
#define MIHOYOEMOTION_EMOTRACK_STOPSEQUENCE_OFFSET UNITYSDK_OFFSET(0x18ADDA20)
#define MIHOYOEMOTION_EMOTRACK_UNREGISTERFINISHHANDLER_OFFSET UNITYSDK_OFFSET(0x18AEA2C0)
#define MIHOYOEMOTION_EMOTRACK_UPDATE_OFFSET UNITYSDK_OFFSET(0x18AD4660)
#define MIHOYOEMOTION_EMOTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD4400)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoTrack_TypeDefinitionIndex = 36131;
	...
	public:
		...
		::miHoYoEmotion::EmoTrack_EmoVoidHandler* _finishHandler; // 0x10
		::System::String* currFacial; // 0x18
		::miHoYoEmotion::ElementManager* _manager; // 0x20
		::System::String* currPose; // 0x28
		::miHoYoEmotion::BaseShape* _curShape; // 0x30
		::System::String* _curTag; // 0x38
		::miHoYoEmotion::BaseShape* _preShape; // 0x40
		::System::Boolean isPaused; // 0x48
		::System::Boolean isStopped; // 0x49
		::System::Boolean isInterrupted; // 0x4A
		::System::Boolean _isTobeFinished; // 0x4B
