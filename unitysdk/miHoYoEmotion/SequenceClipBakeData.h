...
#define MIHOYOEMOTION_SEQUENCECLIPBAKEDATA_GET_PHONEMEBAKEDATA_OFFSET UNITYSDK_OFFSET(0x18FE1420)
#define MIHOYOEMOTION_SEQUENCECLIPBAKEDATA_SET_PHONEMEBAKEDATA_OFFSET UNITYSDK_OFFSET(0x18FE1430)
#define MIHOYOEMOTION_SEQUENCECLIPBAKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE14D0)
#define MIHOYOEMOTION_SEQUENCECLIPBAKEDATA___BASE_SET_PHONEMEBAKEDATA_OFFSET UNITYSDK_OFFSET(0x18FE1500)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int SequenceClipBakeData_TypeDefinitionIndex = 37210;
