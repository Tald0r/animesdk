...
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18FD4E00)
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18FD4E30)
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18FD0F10)
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD4310)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoTrack_EmoVoidHandler_TypeDefinitionIndex = 37152;
