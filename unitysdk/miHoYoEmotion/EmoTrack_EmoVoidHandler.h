...
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18AEA430)
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18AEA460)
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18AE6580)
#define MIHOYOEMOTION_EMOTRACK_EMOVOIDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE9960)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmoTrack_EmoVoidHandler_TypeDefinitionIndex = 36132;
