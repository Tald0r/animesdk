...
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_GETCURVEBINDING_OFFSET UNITYSDK_OFFSET(0x18ADF540)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_GETINDEX_OFFSET UNITYSDK_OFFSET(0x18AE51A0)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_GET_INDEXRES2INDEXRUNTIMEDIC_OFFSET UNITYSDK_OFFSET(0x18AE5100)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_PUTCURVEBINDING_OFFSET UNITYSDK_OFFSET(0x18AE4F20)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_UPDATERUNTIMEINDEX_OFFSET UNITYSDK_OFFSET(0x18AE43E0)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP__CTOR_OFFSET UNITYSDK_OFFSET(0x18AE52C0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipShapeManager_CurveBindingGrp_TypeDefinitionIndex = 36142;
