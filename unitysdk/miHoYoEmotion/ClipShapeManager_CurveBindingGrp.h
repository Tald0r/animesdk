...
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_GETCURVEBINDING_OFFSET UNITYSDK_OFFSET(0x18FC9BB0)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_GETINDEX_OFFSET UNITYSDK_OFFSET(0x18FCF800)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_GET_INDEXRES2INDEXRUNTIMEDIC_OFFSET UNITYSDK_OFFSET(0x18FCF760)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_PUTCURVEBINDING_OFFSET UNITYSDK_OFFSET(0x18FCF580)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP_UPDATERUNTIMEINDEX_OFFSET UNITYSDK_OFFSET(0x18FCEA40)
#define MIHOYOEMOTION_CLIPSHAPEMANAGER_CURVEBINDINGGRP__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCF920)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipShapeManager_CurveBindingGrp_TypeDefinitionIndex = 37162;
