...
#define MIHOYOEMOTION_CLIPSHAPECURVECELL__CTOR_OFFSET UNITYSDK_OFFSET(0x18FCA250)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipShapeCurveCell_TypeDefinitionIndex = 37223;
