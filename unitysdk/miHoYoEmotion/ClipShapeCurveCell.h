...
#define MIHOYOEMOTION_CLIPSHAPECURVECELL__CTOR_OFFSET UNITYSDK_OFFSET(0x18ADFBE0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int ClipShapeCurveCell_TypeDefinitionIndex = 36203;
