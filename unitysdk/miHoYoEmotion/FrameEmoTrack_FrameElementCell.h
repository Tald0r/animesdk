...
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMEELEMENTCELL_ADDFRAME_OFFSET UNITYSDK_OFFSET(0x876E40)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMEELEMENTCELL_APPLY_OFFSET UNITYSDK_OFFSET(0x876F40)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMEELEMENTCELL_CLEARFRAME_OFFSET UNITYSDK_OFFSET(0x876D60)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMEELEMENTCELL_UPDATE_OFFSET UNITYSDK_OFFSET(0x876E50)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameEmoTrack_FrameElementCell_TypeDefinitionIndex = 37154;
