...
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMEELEMENTCELL_ADDFRAME_OFFSET UNITYSDK_OFFSET(0x848520)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMEELEMENTCELL_APPLY_OFFSET UNITYSDK_OFFSET(0x848620)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMEELEMENTCELL_CLEARFRAME_OFFSET UNITYSDK_OFFSET(0x848440)
#define MIHOYOEMOTION_FRAMEEMOTRACK_FRAMEELEMENTCELL_UPDATE_OFFSET UNITYSDK_OFFSET(0x848530)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int FrameEmoTrack_FrameElementCell_TypeDefinitionIndex = 36134;
