...
#define MIHOYOEMOTION_EYECTRL_APPLYEYETARGET_1_OFFSET UNITYSDK_OFFSET(0x18AEC8F0)
#define MIHOYOEMOTION_EYECTRL_APPLYEYETARGET_OFFSET UNITYSDK_OFFSET(0x18AECB10)
#define MIHOYOEMOTION_EYECTRL_BLINKFINISH_OFFSET UNITYSDK_OFFSET(0x18AEC150)
#define MIHOYOEMOTION_EYECTRL_BLINK_OFFSET UNITYSDK_OFFSET(0x18AEBFA0)
#define MIHOYOEMOTION_EYECTRL_CHECKMINANGLE_OFFSET UNITYSDK_OFFSET(0x18AECD30)
#define MIHOYOEMOTION_EYECTRL_CLEARLOOKAT_OFFSET UNITYSDK_OFFSET(0x18AEC280)
#define MIHOYOEMOTION_EYECTRL_FORCEUPDATELOOKTARGET_OFFSET UNITYSDK_OFFSET(0x18AEC200)
#define MIHOYOEMOTION_EYECTRL_GET_LEFTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x18AEA8C0)
#define MIHOYOEMOTION_EYECTRL_GET_RIGHTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x18AEA9D0)
#define MIHOYOEMOTION_EYECTRL_INITEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x18AEAF30)
#define MIHOYOEMOTION_EYECTRL_INTERRUPTBLINK_OFFSET UNITYSDK_OFFSET(0x18AEC100)
#define MIHOYOEMOTION_EYECTRL_LATETICK_OFFSET UNITYSDK_OFFSET(0x18AEB580)
#define MIHOYOEMOTION_EYECTRL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18AEB4D0)
#define MIHOYOEMOTION_EYECTRL_SET_LEFTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x18AEA8D0)
#define MIHOYOEMOTION_EYECTRL_SET_RIGHTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x18AEA9E0)
#define MIHOYOEMOTION_EYECTRL_START_OFFSET UNITYSDK_OFFSET(0x18AEAAE0)
#define MIHOYOEMOTION_EYECTRL_TOGGLEBLINK_OFFSET UNITYSDK_OFFSET(0x18AEC0A0)
#define MIHOYOEMOTION_EYECTRL_UPDATEBLINK_OFFSET UNITYSDK_OFFSET(0x18AEB670)
#define MIHOYOEMOTION_EYECTRL_UPDATEEYETARGET_OFFSET UNITYSDK_OFFSET(0x18AEC2D0)
#define MIHOYOEMOTION_EYECTRL_UPDATELOOKTARGET_OFFSET UNITYSDK_OFFSET(0x18AEB7D0)
#define MIHOYOEMOTION_EYECTRL__CTOR_OFFSET UNITYSDK_OFFSET(0x18AECFB0)
#define MIHOYOEMOTION_EYECTRL___BASE_LATETICK_OFFSET UNITYSDK_OFFSET(0x18AED010)
#define MIHOYOEMOTION_EYECTRL___BASE_START_OFFSET UNITYSDK_OFFSET(0x18AED0B0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EyeCtrl_TypeDefinitionIndex = 36152;
