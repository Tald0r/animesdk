...
#define MIHOYOEMOTION_EYECTRL_APPLYEYETARGET_1_OFFSET UNITYSDK_OFFSET(0x18FD72C0)
#define MIHOYOEMOTION_EYECTRL_APPLYEYETARGET_OFFSET UNITYSDK_OFFSET(0x18FD74E0)
#define MIHOYOEMOTION_EYECTRL_BLINKFINISH_OFFSET UNITYSDK_OFFSET(0x18FD6B20)
#define MIHOYOEMOTION_EYECTRL_BLINK_OFFSET UNITYSDK_OFFSET(0x18FD6970)
#define MIHOYOEMOTION_EYECTRL_CHECKMINANGLE_OFFSET UNITYSDK_OFFSET(0x18FD7700)
#define MIHOYOEMOTION_EYECTRL_CLEARLOOKAT_OFFSET UNITYSDK_OFFSET(0x18FD6C50)
#define MIHOYOEMOTION_EYECTRL_FORCEUPDATELOOKTARGET_OFFSET UNITYSDK_OFFSET(0x18FD6BD0)
#define MIHOYOEMOTION_EYECTRL_GET_LEFTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x18FD5290)
#define MIHOYOEMOTION_EYECTRL_GET_RIGHTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x18FD53A0)
#define MIHOYOEMOTION_EYECTRL_INITEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x18FD5900)
#define MIHOYOEMOTION_EYECTRL_INTERRUPTBLINK_OFFSET UNITYSDK_OFFSET(0x18FD6AD0)
#define MIHOYOEMOTION_EYECTRL_LATETICK_OFFSET UNITYSDK_OFFSET(0x18FD5F50)
#define MIHOYOEMOTION_EYECTRL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18FD5EA0)
#define MIHOYOEMOTION_EYECTRL_SET_LEFTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x18FD52A0)
#define MIHOYOEMOTION_EYECTRL_SET_RIGHTEYELOOKATBONE_OFFSET UNITYSDK_OFFSET(0x18FD53B0)
#define MIHOYOEMOTION_EYECTRL_START_OFFSET UNITYSDK_OFFSET(0x18FD54B0)
#define MIHOYOEMOTION_EYECTRL_TOGGLEBLINK_OFFSET UNITYSDK_OFFSET(0x18FD6A70)
#define MIHOYOEMOTION_EYECTRL_UPDATEBLINK_OFFSET UNITYSDK_OFFSET(0x18FD6040)
#define MIHOYOEMOTION_EYECTRL_UPDATEEYETARGET_OFFSET UNITYSDK_OFFSET(0x18FD6CA0)
#define MIHOYOEMOTION_EYECTRL_UPDATELOOKTARGET_OFFSET UNITYSDK_OFFSET(0x18FD61A0)
#define MIHOYOEMOTION_EYECTRL__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD7980)
#define MIHOYOEMOTION_EYECTRL___BASE_LATETICK_OFFSET UNITYSDK_OFFSET(0x18FD79E0)
#define MIHOYOEMOTION_EYECTRL___BASE_START_OFFSET UNITYSDK_OFFSET(0x18FD7A80)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EyeCtrl_TypeDefinitionIndex = 37172;
