...
#define MIHOYOEMOTION_EMOTIONMARKER_CREATECOPY_OFFSET UNITYSDK_OFFSET(0x18FD4F00)
#define MIHOYOEMOTION_EMOTIONMARKER_ISFREEMARKER_OFFSET UNITYSDK_OFFSET(0x18FD4E80)
#define MIHOYOEMOTION_EMOTIONMARKER_SETTOOTHERMARKER_OFFSET UNITYSDK_OFFSET(0x18FD51D0)
#define MIHOYOEMOTION_EMOTIONMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD51C0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmotionMarker_TypeDefinitionIndex = 37194;
