...
#define MIHOYOEMOTION_EMOTIONGROUPEDPHONEMES__CTOR_OFFSET UNITYSDK_OFFSET(0x18FD4E40)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmotionGroupedPhonemes_TypeDefinitionIndex = 37207;
