...
#define MIHOYOEMOTION_EMOTIONGROUPEDPHONEMES__CTOR_OFFSET UNITYSDK_OFFSET(0x18AEA470)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int EmotionGroupedPhonemes_TypeDefinitionIndex = 36187;
