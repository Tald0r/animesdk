...
#define MIHOYOEMOTION_BASEMARKER_GETTIME_OFFSET UNITYSDK_OFFSET(0x18AD23A0)
#define MIHOYOEMOTION_BASEMARKER_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x18AD2180)
#define MIHOYOEMOTION_BASEMARKER_UPDATEBOTHTIMEBYEND_OFFSET UNITYSDK_OFFSET(0x18AD2270)
#define MIHOYOEMOTION_BASEMARKER_UPDATEBOTHTIMEBYSTART_OFFSET UNITYSDK_OFFSET(0x18AD2190)
#define MIHOYOEMOTION_BASEMARKER_UPDATEENDTIME_OFFSET UNITYSDK_OFFSET(0x18AD2340)
#define MIHOYOEMOTION_BASEMARKER_UPDATESTARTTIME_OFFSET UNITYSDK_OFFSET(0x18AD22E0)
#define MIHOYOEMOTION_BASEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD23F0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int BaseMarker_TypeDefinitionIndex = 36172;
