...
#define MIHOYOEMOTION_BASEMARKER_GETTIME_OFFSET UNITYSDK_OFFSET(0x18FBCA60)
#define MIHOYOEMOTION_BASEMARKER_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x18FBC840)
#define MIHOYOEMOTION_BASEMARKER_UPDATEBOTHTIMEBYEND_OFFSET UNITYSDK_OFFSET(0x18FBC930)
#define MIHOYOEMOTION_BASEMARKER_UPDATEBOTHTIMEBYSTART_OFFSET UNITYSDK_OFFSET(0x18FBC850)
#define MIHOYOEMOTION_BASEMARKER_UPDATEENDTIME_OFFSET UNITYSDK_OFFSET(0x18FBCA00)
#define MIHOYOEMOTION_BASEMARKER_UPDATESTARTTIME_OFFSET UNITYSDK_OFFSET(0x18FBC9A0)
#define MIHOYOEMOTION_BASEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FBCAB0)

namespace miHoYoEmotion
{
	inline static constexpr unsigned int BaseMarker_TypeDefinitionIndex = 37192;
