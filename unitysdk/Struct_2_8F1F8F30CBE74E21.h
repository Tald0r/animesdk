...
#define STRUCT_2_8F1F8F30CBE74E21_METHOD_2_0A0296D150EB9DA4_OFFSET UNITYSDK_OFFSET(0x3249E0)
#define STRUCT_2_8F1F8F30CBE74E21_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x324920)
#define STRUCT_2_8F1F8F30CBE74E21_METHOD_2_CED7A2E9A352C6FD_OFFSET UNITYSDK_OFFSET(0x324850)
#define STRUCT_2_8F1F8F30CBE74E21_METHOD_2_D126582672457EA7_OFFSET UNITYSDK_OFFSET(0x324800)

inline static constexpr unsigned int Struct_2_8F1F8F30CBE74E21_TypeDefinitionIndex = 45983;
...
struct alignas(8) Struct_2_8F1F8F30CBE74E21
{
	...
	*/
	...
	{
		return ((::UnityEngine::Quaternion(*)(::PVOID))((::PBYTE)hIl2Cpp + STRUCT_2_8F1F8F30CBE74E21_METHOD_2_0A0296D150EB9DA4_OFFSET))(this);
	}
	*/
};
