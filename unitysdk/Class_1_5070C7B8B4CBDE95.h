...
#define CLASS_1_5070C7B8B4CBDE95_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x76DAB50)
#define CLASS_1_5070C7B8B4CBDE95_METHOD_1_1F1CE5D7A38CBFA3_OFFSET UNITYSDK_OFFSET(0x76DAB80)
#define CLASS_1_5070C7B8B4CBDE95_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x76DAB60)
#define CLASS_1_5070C7B8B4CBDE95__CTOR_OFFSET UNITYSDK_OFFSET(0x76DAB70)

inline static constexpr unsigned int Class_1_5070C7B8B4CBDE95_TypeDefinitionIndex = 73247;
