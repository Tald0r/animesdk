...
#define CUSTOMSKIN_OVERSEABINDACCOUNT_CLICKBACK_OFFSET UNITYSDK_OFFSET(0x6E5D0A0)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_CLICKCLOSE_OFFSET UNITYSDK_OFFSET(0x6E5D140)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_CLICKFORGOT_OFFSET UNITYSDK_OFFSET(0x6E5D1E0)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_INSTANCE_OFFSET UNITYSDK_OFFSET(0x6E5C0F0)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_ONBINDCLICKED_OFFSET UNITYSDK_OFFSET(0x6E5D2A0)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x6E5C270)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_ONCONSOLECANCEL_OFFSET UNITYSDK_OFFSET(0x6E5D950)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_ONFORGETPASSWORDCALLBACK_OFFSET UNITYSDK_OFFSET(0x6E5D5E0)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6E5C2F0)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_REGISTTEXTACTION_OFFSET UNITYSDK_OFFSET(0x6E5CFB0)
#define CUSTOMSKIN_OVERSEABINDACCOUNT_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x6E5CD00)
#define CUSTOMSKIN_OVERSEABINDACCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x6E5C1F0)
#define CUSTOMSKIN_OVERSEABINDACCOUNT__REGISTTEXTACTION_B__7_0_OFFSET UNITYSDK_OFFSET(0x6E5DB80)
#define CUSTOMSKIN_OVERSEABINDACCOUNT__REGISTTEXTACTION_B__7_1_OFFSET UNITYSDK_OFFSET(0x6E5DC00)

inline static constexpr unsigned int CustomSkin_OverseaBindAccount_TypeDefinitionIndex = 51244;
...
public:
	...
	{
		return (::CustomSkin_OverseaBindAccount**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_OverseaBindAccount_TypeDefinitionIndex)->GetStaticField(0x2E4C0);
	}
