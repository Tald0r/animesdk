...
struct alignas(8) Struct_2_69AE4F0A725C1E2D
{
	...
	{
		return ((::System::Void(*)(::PVOID, ::MoleMole::Cameras::CameraTrackSetting*, ::System::Func_1<::System::Single>*, ::PipelineCamera::TimeBasedAlphaGenerator*))((::PBYTE)hIl2Cpp + STRUCT_2_69AE4F0A725C1E2D__CTOR_OFFSET))(this, a1, a2, a3);
	}

	/*
	static ::System::String* Method_2_4B2801D2080295DD(::MoleMole::CameraOrbit& a1)
	{
		return ((::System::String*(*)(::MoleMole::CameraOrbit&))((::PBYTE)hIl2Cpp + STRUCT_2_69AE4F0A725C1E2D_METHOD_2_4B2801D2080295DD_OFFSET))(a1);
	}
	*/
