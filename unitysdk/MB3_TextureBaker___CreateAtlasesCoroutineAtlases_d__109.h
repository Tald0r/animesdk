...
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19D6EB00)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19D6F2A0)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19D6F300)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19D6F2B0)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19D6EAF0)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109__CTOR_OFFSET UNITYSDK_OFFSET(0x19D6EAE0)

inline static constexpr unsigned int MB3_TextureBaker___CreateAtlasesCoroutineAtlases_d__109_TypeDefinitionIndex = 81211;
...
public:
	...
	::DigitalOpus::MB::Core::MB3_TextureCombiner_CreateAtlasesCoroutineResult* coroutineResult; // 0x40
