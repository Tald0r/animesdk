...
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A32CF60)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A32D700)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A32D760)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A32D710)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A32CF50)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINEATLASES_D__109__CTOR_OFFSET UNITYSDK_OFFSET(0x1A32CF40)

inline static constexpr unsigned int MB3_TextureBaker___CreateAtlasesCoroutineAtlases_d__109_TypeDefinitionIndex = 83252;

class MB3_TextureBaker___CreateAtlasesCoroutineAtlases_d__109 : public ::System::Object
{
public:
	::DigitalOpus::MB::Core::MB3_TextureCombiner_CombineTexturesIntoAtlasesCoroutineResult* _coroutineResult2_5__3; // 0x10
	...
	::MB3_TextureBaker* __4__this; // 0x38
	::System::Object* __2__current; // 0x40
	::System::Int32 __1__state; // 0x48
	::System::Single maxTimePerFrame; // 0x4C
