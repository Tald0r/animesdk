...
#define MONOROOTMOTION_CACHECOMPONENTS_OFFSET UNITYSDK_OFFSET(0x7BF46B0)
#define MONOROOTMOTION_CANSKIPCURRENTANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0x7BF4E10)
#define MONOROOTMOTION_GET_MUTEROOTMOTION_OFFSET UNITYSDK_OFFSET(0x7BF4590)
#define MONOROOTMOTION_ONANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0x7BF49E0)
#define MONOROOTMOTION_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x7BF5060)
#define MONOROOTMOTION_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x7BF5140)
#define MONOROOTMOTION_SETOWNER_OFFSET UNITYSDK_OFFSET(0x7BF4630)
#define MONOROOTMOTION_SET_MUTEROOTMOTION_OFFSET UNITYSDK_OFFSET(0x7BF45A0)
#define MONOROOTMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x7BF5220)

inline static constexpr unsigned int MonoRootMotion_TypeDefinitionIndex = 41976;
...
public:
	...
	::Class_3_F35B080B137ECC46* modelComponent; // 0x30
	::Class_3_F33F9DC5F4112336* animatorComponent; // 0x38
	::Class_3_757A5862D4BBEE41_1* finalMoveComponent; // 0x40
