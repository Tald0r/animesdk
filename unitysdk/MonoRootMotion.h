...
#define MONOROOTMOTION_CACHECOMPONENTS_OFFSET UNITYSDK_OFFSET(0x605F4C0)
#define MONOROOTMOTION_CANSKIPCURRENTANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0x605FC20)
#define MONOROOTMOTION_GET_MUTEROOTMOTION_OFFSET UNITYSDK_OFFSET(0x605F3A0)
#define MONOROOTMOTION_ONANIMATORMOVE_OFFSET UNITYSDK_OFFSET(0x605F7F0)
#define MONOROOTMOTION_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x605FE70)
#define MONOROOTMOTION_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x605FF50)
#define MONOROOTMOTION_SETOWNER_OFFSET UNITYSDK_OFFSET(0x605F440)
#define MONOROOTMOTION_SET_MUTEROOTMOTION_OFFSET UNITYSDK_OFFSET(0x605F3B0)
#define MONOROOTMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x6060030)

inline static constexpr unsigned int MonoRootMotion_TypeDefinitionIndex = 53047;
