...
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCC25010)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER___C__DISPLAYCLASS35_0__DELAYSWITCHNEARSCREEN_B__0_OFFSET UNITYSDK_OFFSET(0xCC25020)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER___C__DISPLAYCLASS35_0__DELAYSWITCHNEARSCREEN_B__1_OFFSET UNITYSDK_OFFSET(0xCC250B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeMachineUnit3DModelController___c__DisplayClass35_0_TypeDefinitionIndex = 59326;
