...
#define MOLEMOLE_UIPHOTOSETTINGFRAMEROWWIDGETCONTROLLER_ISUSING_OFFSET UNITYSDK_OFFSET(0x8EF2D30)
#define MOLEMOLE_UIPHOTOSETTINGFRAMEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EF26D0)
#define MOLEMOLE_UIPHOTOSETTINGFRAMEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8EF2850)
#define MOLEMOLE_UIPHOTOSETTINGFRAMEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EF2770)
#define MOLEMOLE_UIPHOTOSETTINGFRAMEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EF24B0)
#define MOLEMOLE_UIPHOTOSETTINGFRAMEROWWIDGETCONTROLLER_SHOWFILTERROW_OFFSET UNITYSDK_OFFSET(0x8EF29D0)
#define MOLEMOLE_UIPHOTOSETTINGFRAMEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8EF2DB0)
#define MOLEMOLE_UIPHOTOSETTINGFRAMEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EF2DC0)
#define MOLEMOLE_UIPHOTOSETTINGFRAMEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8EF2E30)
#define MOLEMOLE_UIPHOTOSETTINGFRAMEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EF2EB0)
#define MOLEMOLE_UIPHOTOSETTINGFRAMEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EF2F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoSettingFrameRowWidgetController_TypeDefinitionIndex = 75869;
