...
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS37_0__CHANGETOWATCHMODE_B__0_OFFSET UNITYSDK_OFFSET(0xD284B40)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS37_0__CHANGETOWATCHMODE_B__1_OFFSET UNITYSDK_OFFSET(0xD2855F0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS37_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD284B30)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWallPageController___c__DisplayClass37_0_TypeDefinitionIndex = 78388;
