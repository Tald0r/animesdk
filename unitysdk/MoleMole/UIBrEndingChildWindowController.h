...
class Class_2_75FB4A09078427E5_6;
class Class_2_A2F24078995C103E;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }
namespace MoleMole::MiniGame { class BallRaceMiniGameWorld; }

#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1ACB12A0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1ACB1740)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_ONFADEOUT_OFFSET UNITYSDK_OFFSET(0x1ACB1D50)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1ACB1840)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1ACB17D0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1ACB12B0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1ACB1300)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1ACB14A0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x1ACB1CC0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACB1DB0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER__RESET_B__11_0_OFFSET UNITYSDK_OFFSET(0x1ACB1DC0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1ACB2010)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1ACB2080)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1ACB20B0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1ACB20C0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1ACB20D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBrEndingChildWindowController_TypeDefinitionIndex = 80160;

	class UIBrEndingChildWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_75FB4A09078427E5_6* _view; // 0x2F8
		::MoleMole::MiniGame::BallRaceMiniGameWorld* miniWorld; // 0x300
		::Class_2_A2F24078995C103E* gameLogic; // 0x308
