...
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1AFAA7C0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1AFAAC60)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_ONFADEOUT_OFFSET UNITYSDK_OFFSET(0x1AFAB270)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1AFAAD60)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1AFAACF0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1AFAA7D0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1AFAA820)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1AFAA9C0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x1AFAB1E0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFAB2D0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER__RESET_B__11_0_OFFSET UNITYSDK_OFFSET(0x1AFAB2E0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1AFAB530)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1AFAB5A0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1AFAB5D0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1AFAB5E0)
#define MOLEMOLE_UIBRENDINGCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1AFAB5F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBrEndingChildWindowController_TypeDefinitionIndex = 82239;

	class UIBrEndingChildWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_75FB4A09078427E5_5* _view; // 0x2F8
