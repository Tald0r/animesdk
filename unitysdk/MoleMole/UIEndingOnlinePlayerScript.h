...
#define MOLEMOLE_UIENDINGONLINEPLAYERSCRIPT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B0B0470)
#define MOLEMOLE_UIENDINGONLINEPLAYERSCRIPT_PLAYRESULTANIM_OFFSET UNITYSDK_OFFSET(0x1B0B0570)
#define MOLEMOLE_UIENDINGONLINEPLAYERSCRIPT_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1B0B04E0)
#define MOLEMOLE_UIENDINGONLINEPLAYERSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B06E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEndingOnlinePlayerScript_TypeDefinitionIndex = 81665;
