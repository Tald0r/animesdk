...
#define MOLEMOLE_UIENDINGONLINEPLAYERSCRIPT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1ADEE7B0)
#define MOLEMOLE_UIENDINGONLINEPLAYERSCRIPT_PLAYRESULTANIM_OFFSET UNITYSDK_OFFSET(0x1ADEE8B0)
#define MOLEMOLE_UIENDINGONLINEPLAYERSCRIPT_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1ADEE820)
#define MOLEMOLE_UIENDINGONLINEPLAYERSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADEEA20)

namespace MoleMole
{
	inline static constexpr unsigned int UIEndingOnlinePlayerScript_TypeDefinitionIndex = 83731;
