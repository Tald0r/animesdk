...
#define MOLEMOLE_CINEMAOPENPAGEPOPMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x9BADAD0)
#define MOLEMOLE_CINEMAOPENPAGEPOPMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x9BADAF0)
#define MOLEMOLE_CINEMAOPENPAGEPOPMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x9BADAE0)

namespace MoleMole
{
	inline static constexpr unsigned int CinemaOpenPagePopMessage_TypeDefinitionIndex = 69910;
