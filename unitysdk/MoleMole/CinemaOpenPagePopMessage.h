...
#define MOLEMOLE_CINEMAOPENPAGEPOPMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xC325F90)
#define MOLEMOLE_CINEMAOPENPAGEPOPMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xC325FB0)
#define MOLEMOLE_CINEMAOPENPAGEPOPMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC325FA0)

namespace MoleMole
{
	inline static constexpr unsigned int CinemaOpenPagePopMessage_TypeDefinitionIndex = 57558;
