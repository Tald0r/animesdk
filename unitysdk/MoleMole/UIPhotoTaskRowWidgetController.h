...
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x86788E0)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8678B80)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8678980)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8678AA0)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8678840)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_SETSHOWBG_OFFSET UNITYSDK_OFFSET(0x8678E40)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER_SHOWRECORD_OFFSET UNITYSDK_OFFSET(0x8678D00)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8678ED0)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8678EE0)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8678F50)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8678FD0)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8679040)
#define MOLEMOLE_UIPHOTOTASKROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x86790C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoTaskRowWidgetController_TypeDefinitionIndex = 80878;

	class UIPhotoTaskRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_E17D44E1D4CD83D1_3* _view; // 0x2D0
		::MoleMole::PhotoTaskRowContext* _context; // 0x2D8
