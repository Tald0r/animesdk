...
#define MOLEMOLE_MONOLAYOUTTWEEN_AWAKE_OFFSET UNITYSDK_OFFSET(0xC7CBE00)
#define MOLEMOLE_MONOLAYOUTTWEEN_CANCELTWEEN_OFFSET UNITYSDK_OFFSET(0xC7CCC80)
#define MOLEMOLE_MONOLAYOUTTWEEN_INSERTCELL_OFFSET UNITYSDK_OFFSET(0xC7CC070)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xC7CCF10)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_2C9E083DC9C549F9_OFFSET UNITYSDK_OFFSET(0xC7CC350)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xC7CBF30)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_33DA6F0040BBF55E_OFFSET UNITYSDK_OFFSET(0xC7CD830)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0xC7CDCC0)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_3B0663FD9C55AEE7_OFFSET UNITYSDK_OFFSET(0xC7CD190)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0xC7CD170)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_73D53181899B6743_OFFSET UNITYSDK_OFFSET(0xC7CC980)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_7C2C2820B36B9508_OFFSET UNITYSDK_OFFSET(0xC7CD320)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_81315664A1EE985E_OFFSET UNITYSDK_OFFSET(0xC7CC410)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_9C5A319E8B95E884_OFFSET UNITYSDK_OFFSET(0xC7CD620)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_A8F30D3692AA24D3_OFFSET UNITYSDK_OFFSET(0xC7CD9D0)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_C114A1F8E08B6F92_1_OFFSET UNITYSDK_OFFSET(0xC7CD300)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0xC7CD180)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_C30425B4F86A9FA8_OFFSET UNITYSDK_OFFSET(0xC7CDC20)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_C74CF020AA42ED85_1_OFFSET UNITYSDK_OFFSET(0xC7CDC90)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0xC7CD2F0)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0xC7CDCB0)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0xC7CDBB0)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_D8F3C6B2E2C5586E_OFFSET UNITYSDK_OFFSET(0xC7CCFA0)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0xC7CD310)
#define MOLEMOLE_MONOLAYOUTTWEEN_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xC7CDCA0)
#define MOLEMOLE_MONOLAYOUTTWEEN_NEEDINSERTTWEEN_OFFSET UNITYSDK_OFFSET(0xC7CC270)
#define MOLEMOLE_MONOLAYOUTTWEEN_NEEDREMOVETWEEN_OFFSET UNITYSDK_OFFSET(0xC7CC8A0)
#define MOLEMOLE_MONOLAYOUTTWEEN_REMOVECELL_OFFSET UNITYSDK_OFFSET(0xC7CC670)
#define MOLEMOLE_MONOLAYOUTTWEEN_SETDURATION_OFFSET UNITYSDK_OFFSET(0xC7CCC00)
#define MOLEMOLE_MONOLAYOUTTWEEN_SETSLOTHELPER_OFFSET UNITYSDK_OFFSET(0xC7CC000)
#define MOLEMOLE_MONOLAYOUTTWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0xC7CCF80)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLayoutTween_TypeDefinitionIndex = 46515;
