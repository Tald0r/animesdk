...
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFFE920)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCFFEAA0)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFFE9C0)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFFE880)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCFFEC60)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER_SETPARTNERID_OFFSET UNITYSDK_OFFSET(0xCFFEBF0)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFEF60)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFFEF70)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCFFEFE0)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFFF060)
#define MOLEMOLE_UINAVIGATIONAREADETAILWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFFF0E0)

namespace MoleMole
{
	inline static constexpr unsigned int UINavigationAreaDetailWidgetController_TypeDefinitionIndex = 63071;
