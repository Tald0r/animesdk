...
#define MOLEMOLE_YOROZUYARALLYQUESTITEMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x65C6200)

namespace MoleMole
{
	inline static constexpr unsigned int YorozuyaRallyQuestItemContext_TypeDefinitionIndex = 62254;
