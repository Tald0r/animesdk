...
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONCLICKGENERAL_OFFSET UNITYSDK_OFFSET(0xAF8F610)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONCLICKOVERLORD_OFFSET UNITYSDK_OFFSET(0xAF8F000)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF8D930)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAF8F730)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAF8DAB0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF8D9D0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF8D7E0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF8D880)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_SETBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xAF8E460)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xAF8EE70)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_SETGENERALQUEST_OFFSET UNITYSDK_OFFSET(0xAF8E4F0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER_SETQUEST_OFFSET UNITYSDK_OFFSET(0xAF8DD10)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAF8F7C0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF8F7D0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAF8F840)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAF8F8B0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF8F930)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF8F9B0)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF8FA10)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastTodoListWidgetController_TypeDefinitionIndex = 65293;
