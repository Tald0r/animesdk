...
#define MOLEMOLE_MONOHOLLOWEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8B24270)

namespace MoleMole
{
	inline static constexpr unsigned int MonoHollowEffectConfig_TypeDefinitionIndex = 47394;
