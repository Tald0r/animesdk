...
#define MOLEMOLE_UILOGINPAGECONTROLLER___C__DISPLAYCLASS41_0__CLOSELOGIN_B__0_OFFSET UNITYSDK_OFFSET(0x9E76160)
#define MOLEMOLE_UILOGINPAGECONTROLLER___C__DISPLAYCLASS41_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9E76150)

namespace MoleMole
{
	inline static constexpr unsigned int UILoginPageController___c__DisplayClass41_0_TypeDefinitionIndex = 47651;
