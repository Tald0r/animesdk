...
class Class_2_340B2AAA6C37DD6E_4;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIItemInfoRowWidgetController; }
namespace System { class Object; }

#define MOLEMOLE_UIGENERALCHALLENGEINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x80837E0)
#define MOLEMOLE_UIGENERALCHALLENGEINFOROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8083960)
#define MOLEMOLE_UIGENERALCHALLENGEINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8083880)
#define MOLEMOLE_UIGENERALCHALLENGEINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8083600)
#define MOLEMOLE_UIGENERALCHALLENGEINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8083DE0)
#define MOLEMOLE_UIGENERALCHALLENGEINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8083DF0)
#define MOLEMOLE_UIGENERALCHALLENGEINFOROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8083E60)
#define MOLEMOLE_UIGENERALCHALLENGEINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8083EE0)
#define MOLEMOLE_UIGENERALCHALLENGEINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8083F60)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralChallengeInfoRowWidgetController_TypeDefinitionIndex = 50702;

	class UIGeneralChallengeInfoRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_340B2AAA6C37DD6E_4* _view; // 0x2D0
