...
#define MOLEMOLE_UICAMERAATOM_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x4AEB70)
#define MOLEMOLE_UICAMERAATOM_EQUALS_OFFSET UNITYSDK_OFFSET(0x4AEB40)
#define MOLEMOLE_UICAMERAATOM_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x4AEC10)
#define MOLEMOLE_UICAMERAATOM_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0xDC6F990)
#define MOLEMOLE_UICAMERAATOM_GET_FOV_OFFSET UNITYSDK_OFFSET(0x2C4AF0)
#define MOLEMOLE_UICAMERAATOM_GET_POS_OFFSET UNITYSDK_OFFSET(0x3101C0)
#define MOLEMOLE_UICAMERAATOM_GET_ROT_OFFSET UNITYSDK_OFFSET(0x44C6D0)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_128A3A066D9C08E3_1_OFFSET UNITYSDK_OFFSET(0xDC70CD0)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_128A3A066D9C08E3_OFFSET UNITYSDK_OFFSET(0xDC70010)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_27AF3C8987EB39AF_OFFSET UNITYSDK_OFFSET(0xDC70710)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_4321AFA5981896E4_OFFSET UNITYSDK_OFFSET(0x4AEDD0)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_6695159C43613292_OFFSET UNITYSDK_OFFSET(0xDC70420)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_ACFC02CB143DEFAA_OFFSET UNITYSDK_OFFSET(0xDC709F0)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_B2FBAC43FA08C2C9_OFFSET UNITYSDK_OFFSET(0x4AED60)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_E7C75C4FE7D6D7C8_OFFSET UNITYSDK_OFFSET(0x4AECB0)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_F24A112B56A2E4B4_OFFSET UNITYSDK_OFFSET(0x4AED00)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_F5599B7DA8E7E53C_OFFSET UNITYSDK_OFFSET(0x4AED90)
#define MOLEMOLE_UICAMERAATOM_METHOD_2_F7514505158903D4_OFFSET UNITYSDK_OFFSET(0xDC70D80)
#define MOLEMOLE_UICAMERAATOM_SET_FOV_OFFSET UNITYSDK_OFFSET(0x2C4B00)
#define MOLEMOLE_UICAMERAATOM_SET_POS_OFFSET UNITYSDK_OFFSET(0x3101F0)
#define MOLEMOLE_UICAMERAATOM_SET_ROT_OFFSET UNITYSDK_OFFSET(0x44C5D0)
#define MOLEMOLE_UICAMERAATOM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x4AECA0)

namespace MoleMole
{
	inline static constexpr unsigned int UICameraAtom_TypeDefinitionIndex = 70613;
