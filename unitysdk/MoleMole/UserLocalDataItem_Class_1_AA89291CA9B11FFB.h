...
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_ADD_1_OFFSET UNITYSDK_OFFSET(0x939AFF0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_ADD_OFFSET UNITYSDK_OFFSET(0x939A7C0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_CLEAR_OFFSET UNITYSDK_OFFSET(0x939A910)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x939B140)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_CONTAINS_OFFSET UNITYSDK_OFFSET(0x939AA40)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_COPYTO_OFFSET UNITYSDK_OFFSET(0x939AB90)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x939A5A0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x939AE30)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x939AF10)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x939BBD0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x939C5C0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x939C6A0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x939B280)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_REMOVE_OFFSET UNITYSDK_OFFSET(0x939ACE0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x939C470)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x939A6C0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x939B3C0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_AA89291CA9B11FFB__CTOR_OFFSET UNITYSDK_OFFSET(0x939A590)

namespace MoleMole
{
	inline static constexpr unsigned int UserLocalDataItem_Class_1_AA89291CA9B11FFB_TypeDefinitionIndex = 60256;
