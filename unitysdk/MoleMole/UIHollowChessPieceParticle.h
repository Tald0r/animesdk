...
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0xC026E80)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_BINDPROXY_OFFSET UNITYSDK_OFFSET(0xC026FD0)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_CHANGESCALE_OFFSET UNITYSDK_OFFSET(0xC026D10)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_DESTRUCTOR_OFFSET UNITYSDK_OFFSET(0xC026DC0)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GETANIMATIONTIME_OFFSET UNITYSDK_OFFSET(0xC028240)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GETTEXTURESHEETFRAMEINDEX_OFFSET UNITYSDK_OFFSET(0xC026150)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GETTIME_OFFSET UNITYSDK_OFFSET(0xC027E90)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_ATTACHPOINTTYPE_OFFSET UNITYSDK_OFFSET(0xC025FB0)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_DURATIONSECONDS_OFFSET UNITYSDK_OFFSET(0xC0262B0)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_HASTEXTURESHEETANIMATION_OFFSET UNITYSDK_OFFSET(0xC026010)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_ISLOOP_OFFSET UNITYSDK_OFFSET(0xC028480)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xC025FF0)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_ORIGINPATH_OFFSET UNITYSDK_OFFSET(0xC028450)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_PARTICLEINSTANCE_OFFSET UNITYSDK_OFFSET(0xC028470)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_PARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0xC026130)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_PARTICLETRANSFORMTYPE_OFFSET UNITYSDK_OFFSET(0xC025FD0)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_PATHHASH_OFFSET UNITYSDK_OFFSET(0xC0284F0)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_PATH_OFFSET UNITYSDK_OFFSET(0xC028440)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_RAWTRANS_OFFSET UNITYSDK_OFFSET(0xC0264E0)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_TRANSFORMADDITIVE_OFFSET UNITYSDK_OFFSET(0xC028580)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_INIT_OFFSET UNITYSDK_OFFSET(0xC026500)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xC027FB0)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_PLAY_OFFSET UNITYSDK_OFFSET(0xC027050)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_RESETLOCALTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC026570)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_SET_ATTACHPOINTTYPE_OFFSET UNITYSDK_OFFSET(0xC025FC0)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_SET_ORIGINPATH_OFFSET UNITYSDK_OFFSET(0xC028460)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_SET_PARTICLETRANSFORMTYPE_OFFSET UNITYSDK_OFFSET(0xC025FE0)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_SET_TRANSFORMADDITIVE_OFFSET UNITYSDK_OFFSET(0xC0285A0)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_SIMULATE_OFFSET UNITYSDK_OFFSET(0xC027D10)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_STOP_OFFSET UNITYSDK_OFFSET(0xC027280)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_TRYCHANGETRANSFORMPARENT_1_OFFSET UNITYSDK_OFFSET(0xC027350)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_TRYCHANGETRANSFORMPARENT_OFFSET UNITYSDK_OFFSET(0xC026A90)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE__CCTOR_OFFSET UNITYSDK_OFFSET(0xC0285C0)
#define MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0xC0263E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessPieceParticle_TypeDefinitionIndex = 39891;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceParticle_TypeDefinitionIndex)->GetStaticField(0xB240);
		}
		static ::UnityEngine::Vector3* StaticGet_InvalidPos()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceParticle_TypeDefinitionIndex)->GetStaticField(0xB24C);
		}
		::Class_3_B2CEFC27844059B6* _particleInstance; // 0x10
		...
		::System::Void _ctor(::Class_3_B2CEFC27844059B6* particleInstance, ::System::String* path)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_B2CEFC27844059B6*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE__CTOR_OFFSET))(this, particleInstance, path);
		}
		...
		::System::Void BindProxy(::Class_5_2169ABC757988FED* proxy)
		{
			return ((::System::Void(*)(::PVOID, ::Class_5_2169ABC757988FED*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_BINDPROXY_OFFSET))(this, proxy);
		}
		...
		::Class_3_B2CEFC27844059B6* get_ParticleInstance()
		{
			return ((::Class_3_B2CEFC27844059B6*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWCHESSPIECEPARTICLE_GET_PARTICLEINSTANCE_OFFSET))(this);
		}
