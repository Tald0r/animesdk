...
#define MOLEMOLE_MONOGAMEPADSPACETARGET_DOCOPYRESET_OFFSET UNITYSDK_OFFSET(0xB9A1D90)
#define MOLEMOLE_MONOGAMEPADSPACETARGET_GETNAVIGATEFORBID_OFFSET UNITYSDK_OFFSET(0xB9A1CE0)
#define MOLEMOLE_MONOGAMEPADSPACETARGET_GETNAVIGATEOBJ_OFFSET UNITYSDK_OFFSET(0xB9A1C30)
#define MOLEMOLE_MONOGAMEPADSPACETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A1E00)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadSpaceTarget_TypeDefinitionIndex = 40616;
