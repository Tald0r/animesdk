...
class Class_2_C7387D40D4120A48_17_Class_2_0D5D8405826EE6F8_31;
class Class_2_C7387D40D4120A48_17_Class_2_EF16346D79C18F15_11;
...
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0xC09AE90)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC09A950)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_INITBUFF_OFFSET UNITYSDK_OFFSET(0xC09B7C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_ONCARDSET_OFFSET UNITYSDK_OFFSET(0xC09CBB0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC09C2B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_ONNEWBIECLOSE_OFFSET UNITYSDK_OFFSET(0xC09ADD0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC09C350)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC09A960)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC09AAA0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_REFRESHBUFFSET_OFFSET UNITYSDK_OFFSET(0xC09C4C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_SETCANCELCALLBACK_OFFSET UNITYSDK_OFFSET(0xC09C450)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_SETCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0xC09C3E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_TRIGGERNEWBIE_OFFSET UNITYSDK_OFFSET(0xC09AF20)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER_UPDATEFLOORINDEX_OFFSET UNITYSDK_OFFSET(0xC09B190)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC09CE10)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER__INITBUFF_G__SETATTR_9_1_OFFSET UNITYSDK_OFFSET(0xC09CED0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER__INITBUFF_G__UPDATEATTRIBUTE_9_0_OFFSET UNITYSDK_OFFSET(0xC09B9C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER__ONUIOPEN_B__4_0_OFFSET UNITYSDK_OFFSET(0xC09CEA0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC09CFB0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC09D020)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC09D030)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC09D040)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerFightingBuffPopWindowController_TypeDefinitionIndex = 68013;
	...
	public:
		...
		::Class_2_C7387D40D4120A48_17* _view; // 0x2F8
		::System::Action* cancel; // 0x300
		::System::Action* callback; // 0x308
		::System::Int32 towerid; // 0x310
		::System::UInt32 currentFloor; // 0x314
		::Class_2_08E43914789BE5F3* babelTowerModel; // 0x318
		::System::Collections::Generic::List_1<::MoleMole::UIBabeltowerFightingBuffItemWidgetController*>* buffs; // 0x320
		...
		static ::System::Void _InitBuff_g__SetAttr_9_1(::Class_2_0D31A1661D004892<::Class_2_C7387D40D4120A48_17_Class_2_EF16346D79C18F15_11*>* iconView, ::Class_2_0D31A1661D004892<::Class_2_C7387D40D4120A48_17_Class_2_0D5D8405826EE6F8_31*>* nameView, ::Class_2_208CC9941471731A_999* template_)
		{
			return ((::System::Void(*)(::Class_2_0D31A1661D004892<::Class_2_C7387D40D4120A48_17_Class_2_EF16346D79C18F15_11*>*, ::Class_2_0D31A1661D004892<::Class_2_C7387D40D4120A48_17_Class_2_0D5D8405826EE6F8_31*>*, ::Class_2_208CC9941471731A_999*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER__INITBUFF_G__SETATTR_9_1_OFFSET))(iconView, nameView, template_);
		}
