...
class Class_2_151D990416311EA2_Class_2_47F94C3827CAB3BB_8;
...
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0xB6B8140)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_GETONLINETOPBARAIDINGMAT_OFFSET UNITYSDK_OFFSET(0xB6B7DB0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_GETONLINETOPBARDYINGMAT_OFFSET UNITYSDK_OFFSET(0xB6B7C20)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xB6B7910)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6B7A10)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6B7AB0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6B7740)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB6B7860)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHAIDINGVIEW_OFFSET UNITYSDK_OFFSET(0xB6B88A0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHHELPERS_OFFSET UNITYSDK_OFFSET(0xB6B90C0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHLEFTTIME_OFFSET UNITYSDK_OFFSET(0xB6B8DB0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHPLAYER_OFFSET UNITYSDK_OFFSET(0xB6B92F0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0xB6B8AD0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHRATIO_OFFSET UNITYSDK_OFFSET(0xB6B8F60)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_SETUPAVATARICON_OFFSET UNITYSDK_OFFSET(0xB6B8520)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_SETUPENTITY_OFFSET UNITYSDK_OFFSET(0xB6B7F40)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER__BUILDDATABINDING_B__19_0_OFFSET UNITYSDK_OFFSET(0xB6B9630)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER__BUILDDATABINDING_B__19_1_OFFSET UNITYSDK_OFFSET(0xB6B9A00)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER__BUILDDATABINDING_B__19_2_OFFSET UNITYSDK_OFFSET(0xB6B9B20)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB6B9600)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xB6B9C40)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6B9CA0)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6B9D10)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6B9D90)
#define MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB6B9DF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnlineTopBarWidgetController_TypeDefinitionIndex = 54390;
	...
	public:
		...
		::System::Void RefreshPlayer(::MoleMole::EntityHandle entity, ::Class_2_0D31A1661D004892<::Class_2_151D990416311EA2_Class_2_47F94C3827CAB3BB_8*>* Player)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::EntityHandle, ::Class_2_0D31A1661D004892<::Class_2_151D990416311EA2_Class_2_47F94C3827CAB3BB_8*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIONLINETOPBARWIDGETCONTROLLER_REFRESHPLAYER_OFFSET))(this, entity, Player);
		}
