...
#define MOLEMOLE_ENUMSETTINGENTRY_GETDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0xC25BCE0)
#define MOLEMOLE_ENUMSETTINGENTRY_GETSETTINGCONTEXTBYINDEX_OFFSET UNITYSDK_OFFSET(0xC25BC40)
#define MOLEMOLE_ENUMSETTINGENTRY_GET_SETTINGWIDGETTYPE_OFFSET UNITYSDK_OFFSET(0xC25BC30)
#define MOLEMOLE_ENUMSETTINGENTRY_GET__ISHIDEDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0xC25BC20)
#define MOLEMOLE_ENUMSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xC25BD40)

namespace MoleMole
{
	inline static constexpr unsigned int EnumSettingEntry_TypeDefinitionIndex = 67065;
