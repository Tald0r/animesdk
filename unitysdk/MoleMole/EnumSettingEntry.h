...
#define MOLEMOLE_ENUMSETTINGENTRY_GETDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0x6E0C790)
#define MOLEMOLE_ENUMSETTINGENTRY_GETSETTINGCONTEXTBYINDEX_OFFSET UNITYSDK_OFFSET(0x6E0C6F0)
#define MOLEMOLE_ENUMSETTINGENTRY_GET_SETTINGWIDGETTYPE_OFFSET UNITYSDK_OFFSET(0x6E0C6E0)
#define MOLEMOLE_ENUMSETTINGENTRY_GET__ISHIDEDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0x6E0C6D0)
#define MOLEMOLE_ENUMSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x6E0C7F0)

namespace MoleMole
{
	inline static constexpr unsigned int EnumSettingEntry_TypeDefinitionIndex = 55996;
