...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS299_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAD5C7E0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS299_0__SHOWPAGEUISTARTANIM_B__0_OFFSET UNITYSDK_OFFSET(0xAD5C7F0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS299_0__SHOWPAGEUISTARTANIM_B__1_OFFSET UNITYSDK_OFFSET(0xAD5C8C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController___c__DisplayClass299_0_TypeDefinitionIndex = 49557;
