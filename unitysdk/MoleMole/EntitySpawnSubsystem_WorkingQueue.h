...
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_ADD_OFFSET UNITYSDK_OFFSET(0xB9FBDF0)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xB9FBDD0)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_PEEK_OFFSET UNITYSDK_OFFSET(0xB9FBFE0)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_POP_OFFSET UNITYSDK_OFFSET(0xB9FC090)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_REMOVE_OFFSET UNITYSDK_OFFSET(0xB9FBF30)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0xB9FC170)

namespace MoleMole
{
	inline static constexpr unsigned int EntitySpawnSubsystem_WorkingQueue_TypeDefinitionIndex = 40147;
