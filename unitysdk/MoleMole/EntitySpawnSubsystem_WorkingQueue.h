...
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_ADD_OFFSET UNITYSDK_OFFSET(0xC9B73F0)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xC9B73D0)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_PEEK_OFFSET UNITYSDK_OFFSET(0xC9B75E0)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_POP_OFFSET UNITYSDK_OFFSET(0xC9B7690)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE_REMOVE_OFFSET UNITYSDK_OFFSET(0xC9B7530)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_WORKINGQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9B7770)

namespace MoleMole
{
	inline static constexpr unsigned int EntitySpawnSubsystem_WorkingQueue_TypeDefinitionIndex = 55042;
