...
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE3DAA0)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAE3DC20)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE3DB40)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE3D950)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE3D9F0)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAE3DCF0)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE3E360)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE3E370)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAE3E3E0)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE3E460)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE3E4E0)
#define MOLEMOLE_UIREWARDBUFFROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE3E540)

namespace MoleMole
{
	inline static constexpr unsigned int UIRewardBuffRowWidgetController_TypeDefinitionIndex = 72464;
