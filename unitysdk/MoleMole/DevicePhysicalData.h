...
#define MOLEMOLE_DEVICEPHYSICALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8F60C80)

namespace MoleMole
{
	inline static constexpr unsigned int DevicePhysicalData_TypeDefinitionIndex = 68586;
