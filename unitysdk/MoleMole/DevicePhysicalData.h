...
#define MOLEMOLE_DEVICEPHYSICALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD0C0550)

namespace MoleMole
{
	inline static constexpr unsigned int DevicePhysicalData_TypeDefinitionIndex = 80740;
