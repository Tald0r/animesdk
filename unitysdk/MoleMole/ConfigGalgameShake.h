...
#define MOLEMOLE_CONFIGGALGAMESHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0xACDBE30)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigGalgameShake_TypeDefinitionIndex = 56372;
