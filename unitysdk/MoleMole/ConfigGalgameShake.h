...
#define MOLEMOLE_CONFIGGALGAMESHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0xCCACF40)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigGalgameShake_TypeDefinitionIndex = 76535;
