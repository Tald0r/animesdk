...
#define MOLEMOLE_UIINLEVELCOATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_BTN_OFFSET UNITYSDK_OFFSET(0xB128AC0)
#define MOLEMOLE_UIINLEVELCOATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_BUTTONAREA_OFFSET UNITYSDK_OFFSET(0x8EF82D0)
#define MOLEMOLE_UIINLEVELCOATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_BUTTONROOT_OFFSET UNITYSDK_OFFSET(0x8EF8060)
#define MOLEMOLE_UIINLEVELCOATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_MAXDRAGAREA_OFFSET UNITYSDK_OFFSET(0x8EF8130)
#define MOLEMOLE_UIINLEVELCOATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_MINDRAGAREA_OFFSET UNITYSDK_OFFSET(0x8EF8200)
#define MOLEMOLE_UIINLEVELCOATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x8EF83A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCoAttackBtnChildWindowController_UIButtonView_TypeDefinitionIndex = 73858;
	...
	public:
		...
		{
			return ((::Class_2_60DDD9C206686F44*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELCOATTACKBTNCHILDWINDOWCONTROLLER_UIBUTTONVIEW_GET_BTN_OFFSET))(this);
		}
