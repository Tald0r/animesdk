...
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CANCELSHOWCURTAPE_OFFSET UNITYSDK_OFFSET(0xA113BB0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CIRCLEINDEX_OFFSET UNITYSDK_OFFSET(0xA118C60)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CIRCLETAPEGROUP_OFFSET UNITYSDK_OFFSET(0xA111FD0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CIRCLETAPE_OFFSET UNITYSDK_OFFSET(0xA112E20)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CLAMPDRAGDELTA_OFFSET UNITYSDK_OFFSET(0xA118530)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CREATESCROLLTAPES_OFFSET UNITYSDK_OFFSET(0xA1113C0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CREATETAPESNOPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xA1107C0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CREATETAPESWITHPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xA10EAE0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_DOCREATETAPES_OFFSET UNITYSDK_OFFSET(0xA1150D0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_DOFIXTAPEPOS_OFFSET UNITYSDK_OFFSET(0xA118680)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_DOSHOWTAPE_OFFSET UNITYSDK_OFFSET(0xA113700)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_FILTERCENTERTAPE_OFFSET UNITYSDK_OFFSET(0xA10D750)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_FIXTAPEPOS_OFFSET UNITYSDK_OFFSET(0xA118BE0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GETALLTAPES_OFFSET UNITYSDK_OFFSET(0xA113FD0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GETSHOWINGVHSTEMPLATEIDS_OFFSET UNITYSDK_OFFSET(0xA114680)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GETSINGLEPRESSSPEED_OFFSET UNITYSDK_OFFSET(0xA118470)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GETTAPEBYTEMPLATE_OFFSET UNITYSDK_OFFSET(0xA113E10)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GET_GETCURSHOWINGTAPEINDEX_OFFSET UNITYSDK_OFFSET(0xA10C360)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GET_TAPESCOUNT_OFFSET UNITYSDK_OFFSET(0xA10C2E0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_INITDUMMYSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xA115C20)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ISSHOWINGONETAPE_OFFSET UNITYSDK_OFFSET(0xA111F60)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA10DB20)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_LIFTTAPES_OFFSET UNITYSDK_OFFSET(0xA117280)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0xA112360)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xA112270)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONCLICKTAPE_OFFSET UNITYSDK_OFFSET(0xA113250)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA10C500)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xA111E50)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xA1123D0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONGAMEPADMOVE_OFFSET UNITYSDK_OFFSET(0xA117B50)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA117C70)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONPERFORMANCEDONE_OFFSET UNITYSDK_OFFSET(0xA117080)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONPOINTUP_OFFSET UNITYSDK_OFFSET(0xA1130C0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA10C940)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA10C9B0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA10C5A0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA10C870)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_PERFORMANCEEXPAND_OFFSET UNITYSDK_OFFSET(0xA116330)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_PERFORMANCESHRINK_OFFSET UNITYSDK_OFFSET(0xA116A60)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_REDIRECTTAPE_OFFSET UNITYSDK_OFFSET(0xA1142A0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_REFRESHCOVERVIEW_OFFSET UNITYSDK_OFFSET(0xA116180)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SELECTEASINGSTARTTAPE_OFFSET UNITYSDK_OFFSET(0xA112B40)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SHOWTAPEBYINDEX_OFFSET UNITYSDK_OFFSET(0xA114470)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SHOWTAPEBYTEMPLATEID_OFFSET UNITYSDK_OFFSET(0xA114040)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_STARTPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xA110550)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SWITCHARCHIVETYPE_OFFSET UNITYSDK_OFFSET(0xA10DBA0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SWITCHPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xA10DCE0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_TRYLOADTAPES_OFFSET UNITYSDK_OFFSET(0xA10F5E0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_UPDATECIRCLECORDON_OFFSET UNITYSDK_OFFSET(0xA1158B0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_UPDATESHRINKTAPESTATE_OFFSET UNITYSDK_OFFSET(0xA1148A0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_UPDATETAPESTATE_OFFSET UNITYSDK_OFFSET(0xA10D090)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA10CAD0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__CANCELSHOWCURTAPE_B__24_0_OFFSET UNITYSDK_OFFSET(0xA118F70)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__CANCELSHOWCURTAPE_B__24_1_OFFSET UNITYSDK_OFFSET(0xA118FE0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA118F30)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA118D10)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__DOSHOWTAPE_B__56_0_OFFSET UNITYSDK_OFFSET(0xA1193E0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__INITDUMMYSCROLLVIEW_B__36_0_OFFSET UNITYSDK_OFFSET(0xA119030)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__INITDUMMYSCROLLVIEW_B__36_1_OFFSET UNITYSDK_OFFSET(0xA1190E0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__ONINPUTACTION_B__46_0_OFFSET UNITYSDK_OFFSET(0xA1193D0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__ONINPUTACTION_B__46_1_OFFSET UNITYSDK_OFFSET(0xA1193C0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__ONPERFORMANCEDONE_B__43_0_OFFSET UNITYSDK_OFFSET(0xA119210)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA119430)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA1194A0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA1194B0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA1194C0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA1194D0)

namespace MoleMole
{
	inline static constexpr unsigned int UITapesGroup3DModelController_TypeDefinitionIndex = 53113;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITapesGroup3DModelController_TypeDefinitionIndex)->GetStaticField(0xD0A0);
		}
