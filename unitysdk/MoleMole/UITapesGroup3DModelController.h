...
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CANCELSHOWCURTAPE_OFFSET UNITYSDK_OFFSET(0xC3E6360)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CIRCLEINDEX_OFFSET UNITYSDK_OFFSET(0xC3EB400)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CIRCLETAPEGROUP_OFFSET UNITYSDK_OFFSET(0xC3E4790)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CIRCLETAPE_OFFSET UNITYSDK_OFFSET(0xC3E55E0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CLAMPDRAGDELTA_OFFSET UNITYSDK_OFFSET(0xC3EACD0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CREATESCROLLTAPES_OFFSET UNITYSDK_OFFSET(0xC3E3B70)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CREATETAPESNOPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xC3E2F60)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_CREATETAPESWITHPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xC3E1270)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_DOCREATETAPES_OFFSET UNITYSDK_OFFSET(0xC3E7880)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_DOFIXTAPEPOS_OFFSET UNITYSDK_OFFSET(0xC3EAE20)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_DOSHOWTAPE_OFFSET UNITYSDK_OFFSET(0xC3E5EB0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_FILTERCENTERTAPE_OFFSET UNITYSDK_OFFSET(0xC3DFED0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_FIXTAPEPOS_OFFSET UNITYSDK_OFFSET(0xC3EB380)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GETALLTAPES_OFFSET UNITYSDK_OFFSET(0xC3E6780)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GETSHOWINGVHSTEMPLATEIDS_OFFSET UNITYSDK_OFFSET(0xC3E6E30)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GETSINGLEPRESSSPEED_OFFSET UNITYSDK_OFFSET(0xC3EAC10)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GETTAPEBYTEMPLATE_OFFSET UNITYSDK_OFFSET(0xC3E65C0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GET_GETCURSHOWINGTAPEINDEX_OFFSET UNITYSDK_OFFSET(0xC3DEAC0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_GET_TAPESCOUNT_OFFSET UNITYSDK_OFFSET(0xC3DEA40)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_INITDUMMYSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xC3E83D0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ISSHOWINGONETAPE_OFFSET UNITYSDK_OFFSET(0xC3E4720)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC3E02A0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_LIFTTAPES_OFFSET UNITYSDK_OFFSET(0xC3E9A20)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0xC3E4B20)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xC3E4A30)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONCLICKTAPE_OFFSET UNITYSDK_OFFSET(0xC3E5A00)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC3DEC60)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xC3E4610)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xC3E4B90)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONGAMEPADMOVE_OFFSET UNITYSDK_OFFSET(0xC3EA2F0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC3EA410)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONPERFORMANCEDONE_OFFSET UNITYSDK_OFFSET(0xC3E9820)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONPOINTUP_OFFSET UNITYSDK_OFFSET(0xC3E5870)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC3DF0A0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC3DF110)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC3DED00)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC3DEFD0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_PERFORMANCEEXPAND_OFFSET UNITYSDK_OFFSET(0xC3E8AE0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_PERFORMANCESHRINK_OFFSET UNITYSDK_OFFSET(0xC3E9200)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_REDIRECTTAPE_OFFSET UNITYSDK_OFFSET(0xC3E6A50)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_REFRESHCOVERVIEW_OFFSET UNITYSDK_OFFSET(0xC3E8930)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SELECTEASINGSTARTTAPE_OFFSET UNITYSDK_OFFSET(0xC3E5300)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SHOWTAPEBYINDEX_OFFSET UNITYSDK_OFFSET(0xC3E6C20)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SHOWTAPEBYTEMPLATEID_OFFSET UNITYSDK_OFFSET(0xC3E67F0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_STARTPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xC3E2CF0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SWITCHARCHIVETYPE_OFFSET UNITYSDK_OFFSET(0xC3E0320)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_SWITCHPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xC3E0460)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_TRYLOADTAPES_OFFSET UNITYSDK_OFFSET(0xC3E1D70)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_UPDATECIRCLECORDON_OFFSET UNITYSDK_OFFSET(0xC3E8060)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_UPDATESHRINKTAPESTATE_OFFSET UNITYSDK_OFFSET(0xC3E7050)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_UPDATETAPESTATE_OFFSET UNITYSDK_OFFSET(0xC3DF810)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC3DF230)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__CANCELSHOWCURTAPE_B__24_0_OFFSET UNITYSDK_OFFSET(0xC3EB710)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__CANCELSHOWCURTAPE_B__24_1_OFFSET UNITYSDK_OFFSET(0xC3EB780)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC3EB6D0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC3EB4B0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__DOSHOWTAPE_B__56_0_OFFSET UNITYSDK_OFFSET(0xC3EBB80)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__INITDUMMYSCROLLVIEW_B__36_0_OFFSET UNITYSDK_OFFSET(0xC3EB7D0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__INITDUMMYSCROLLVIEW_B__36_1_OFFSET UNITYSDK_OFFSET(0xC3EB880)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__ONINPUTACTION_B__46_0_OFFSET UNITYSDK_OFFSET(0xC3EBB70)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__ONINPUTACTION_B__46_1_OFFSET UNITYSDK_OFFSET(0xC3EBB60)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER__ONPERFORMANCEDONE_B__43_0_OFFSET UNITYSDK_OFFSET(0xC3EB9B0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC3EBBD0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC3EBC40)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC3EBC50)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC3EBC60)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC3EBC70)

namespace MoleMole
{
	inline static constexpr unsigned int UITapesGroup3DModelController_TypeDefinitionIndex = 69969;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITapesGroup3DModelController_TypeDefinitionIndex)->GetStaticField(0xC4A0);
		}
		// static const ::System::String* SwitchArchiveTypePerformKey; // 0x0
		::System::Single TestNormalizedTime; // 0x340
		::MoleMole::UITapesGroup3DModelController_Context* _context; // 0x348
		::Class_2_33EA27A25F076E07* mainStoryModel; // 0x350
		::Class_2_A0D395A24A28DAE3* _view; // 0x358
		::Class_1_E16AAB011063882E* _commonUiCamera; // 0x360
		::MoleMole::Config::MainStoryConfigPageCamera* _cameraConfig; // 0x368
		::System::Int32 CurVhsTemplateID; // 0x370
		::System::Collections::Generic::List_1<::System::Int32>* _archiveTypes; // 0x378
		::System::Int32 _archiveTypeIdx; // 0x380
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::UITapesGroup3DModelController_ArchiveTapes*>* _allArchiveTapes; // 0x388
		::MoleMole::UITapesGroup3DModelController_ArchiveTapes* _curArchiveTapes; // 0x390
		::System::Boolean _isDraggingTapes; // 0x398
		::System::Boolean _isPerformance; // 0x399
		::MoleMole::TapesBackgroundDrag* wallDrag; // 0x3A0
		::UnityEngine::Vector3 kDefaultTapeRotation; // 0x3A8
		::System::Collections::Generic::List_1<::MoleMole::UITape3DModelController*>* selectedTapes; // 0x3B8
		::System::Single soundPlayDisInteval; // 0x3C0
		::System::Single currentDragDistance; // 0x3C4
		::System::Boolean _canGamePadMove; // 0x3C8
		::Foundation::Coroutine::CoroutineHandle _gamePadDelayHandle; // 0x3CC
		::System::Single intevalTime; // 0x3D0
		::System::Boolean playDragTapesSound; // 0x3D4
		::Class_1_F50B5EAC0B6702FB* _scriptableAnimationPlayer; // 0x3D8
		::System::Single _tapeOrigLocalScaleX; // 0x3E0
		::UnityEngine::Vector3 _camDir; // 0x3E4
		::System::Single _cachedCamPosY; // 0x3F0
		::System::Single _cachedFlipLightsPosY; // 0x3F4
		::System::Single _cachedShowLightsPosY; // 0x3F8
		::System::Boolean _liftLightTransform; // 0x3FC
		::System::Collections::Generic::List_1<::MoleMole::UIMainStoryTapeDummyWidgetController_Context*>* _dummyTapeData; // 0x400
		...
		::System::Void DoCreateTapes(::MoleMole::UITapesGroup3DModelController_ArchiveTapes* archiveTapes, ::System::Collections::Generic::List_1<::Class_2_BD718685F2AA7978*>* vhsConfigList, ::System::Int32 totalNum, ::UnityEngine::Transform* parent, ::UnityEngine::Vector3 startTapePos, ::System::Single tapeWidth, ::System::Int32 targetDataIndex)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::UITapesGroup3DModelController_ArchiveTapes*, ::System::Collections::Generic::List_1<::Class_2_BD718685F2AA7978*>*, ::System::Int32, ::UnityEngine::Transform*, ::UnityEngine::Vector3, ::System::Single, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER_DOCREATETAPES_OFFSET))(this, archiveTapes, vhsConfigList, totalNum, parent, startTapePos, tapeWidth, targetDataIndex);
		}
