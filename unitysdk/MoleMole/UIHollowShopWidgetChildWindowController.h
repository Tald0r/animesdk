...
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_BUYHOLLOWITEM_OFFSET UNITYSDK_OFFSET(0xA1B6F70)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_BUYPCFUNC_OFFSET UNITYSDK_OFFSET(0xA1A8030)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_CANBUY_OFFSET UNITYSDK_OFFSET(0xA1B68C0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_CLEAREFFECT_OFFSET UNITYSDK_OFFSET(0xA1B3260)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_CLOSEPANEL_OFFSET UNITYSDK_OFFSET(0xA1A79B0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_DIRECTCLOSEPANEL_OFFSET UNITYSDK_OFFSET(0xA1A7640)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_FORCEREBUILD_OFFSET UNITYSDK_OFFSET(0xA1AAFC0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETANIMLENGTH_OFFSET UNITYSDK_OFFSET(0xA1A81D0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETCURRENCYCOUNT_OFFSET UNITYSDK_OFFSET(0xA1AC570)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETCURRENCYTYPE_OFFSET UNITYSDK_OFFSET(0xA1AD030)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETCURRENTSHOPITEMS_OFFSET UNITYSDK_OFFSET(0xA1AC360)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETDICBYCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0xA1B2BD0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETGOODSVALUE_OFFSET UNITYSDK_OFFSET(0xA1ABFC0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETITEMBYSHOPTYPE_OFFSET UNITYSDK_OFFSET(0xA1ABD80)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETPOSITION_OFFSET UNITYSDK_OFFSET(0xA1AB400)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETSHOPICON_OFFSET UNITYSDK_OFFSET(0xA1AC0B0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETSHOPTYPEBYCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0xA1ACF70)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GETSHOPTYPEBYPOSITION_OFFSET UNITYSDK_OFFSET(0xA1B2B60)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA1A45B0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GET__POSITION_OFFSET UNITYSDK_OFFSET(0xA1B7B00)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOBACKTOMAIN_OFFSET UNITYSDK_OFFSET(0xA1AB470)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTOCARDSHOP_OFFSET UNITYSDK_OFFSET(0xA1B30F0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTOCURSESHOP_OFFSET UNITYSDK_OFFSET(0xA1B2E10)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTODISCOUNTSHOP_OFFSET UNITYSDK_OFFSET(0xA1B29F0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTOGACHASHOP_OFFSET UNITYSDK_OFFSET(0xA1B1570)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTOHOLLOWITEMSHOP_OFFSET UNITYSDK_OFFSET(0xA1B2F80)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTOITEMSHOP_OFFSET UNITYSDK_OFFSET(0xA1A7120)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_GOTOUPGRADESHOP_OFFSET UNITYSDK_OFFSET(0xA1A6FB0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_INITDETIAL_OFFSET UNITYSDK_OFFSET(0xA1A6BF0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_INITSHOP_OFFSET UNITYSDK_OFFSET(0xA1A8A10)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_INITTRANSFERCONFIG_OFFSET UNITYSDK_OFFSET(0xA1A4980)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_INITUPGRADECARD_OFFSET UNITYSDK_OFFSET(0xA1A4D50)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xA1A5CF0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xA1A5880)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ISHPCURRENCY_OFFSET UNITYSDK_OFFSET(0xA1A88C0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ISITEMSOLDOUT_OFFSET UNITYSDK_OFFSET(0xA1B2CF0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA1A7290)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONEVENTCLICK_OFFSET UNITYSDK_OFFSET(0xA1A7F30)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA1A8430)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONTEXTSHOWFINISH_OFFSET UNITYSDK_OFFSET(0xA1A83C0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA1A7330)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA1A45C0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA1A5130)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_OPENINI_OFFSET UNITYSDK_OFFSET(0xA1B6BF0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_REALGOTOSHOP_OFFSET UNITYSDK_OFFSET(0xA1B16E0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_REFRESHALL_OFFSET UNITYSDK_OFFSET(0xA1B69E0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_REFRESHCONTEXT_OFFSET UNITYSDK_OFFSET(0xA1B6940)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_REFRESHGOODS_OFFSET UNITYSDK_OFFSET(0xA1B3630)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_REFRESHSHOPTITLE_OFFSET UNITYSDK_OFFSET(0xA1A9BC0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_RESETARCANAANIM_OFFSET UNITYSDK_OFFSET(0xA1AF370)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_RESETBUYANIM_OFFSET UNITYSDK_OFFSET(0xA1AB8F0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_RESTSHOPBTNANIM_OFFSET UNITYSDK_OFFSET(0xA1ABC50)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETARCANAANIM_OFFSET UNITYSDK_OFFSET(0xA1AF870)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETDISCOUNT_OFFSET UNITYSDK_OFFSET(0xA1AD0C0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETITEMSOLDOUTSTATE_OFFSET UNITYSDK_OFFSET(0xA1B0730)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETMAINSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xA1A6E40)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETPRICECOLOR_OFFSET UNITYSDK_OFFSET(0xA1AD7B0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETPRICETXT_OFFSET UNITYSDK_OFFSET(0xA1AD850)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SETVERTICALLAYOUTSTATE_OFFSET UNITYSDK_OFFSET(0xA1AB160)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SET__POSITION_OFFSET UNITYSDK_OFFSET(0xA1B7B10)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_SHOWTEXT_OFFSET UNITYSDK_OFFSET(0xA1A7C40)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_UPDATEALLPAYPANEL_OFFSET UNITYSDK_OFFSET(0xA1AFF90)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER_UPDATEPRICE_OFFSET UNITYSDK_OFFSET(0xA1B7940)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__BUY_OFFSET UNITYSDK_OFFSET(0xA1B7260)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__CLOSEPANEL_B__11_0_OFFSET UNITYSDK_OFFSET(0xA1B7E50)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA1B7B20)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__GOBACKTOMAIN_B__23_0_OFFSET UNITYSDK_OFFSET(0xA1B7F90)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__GOBACKTOMAIN_B__23_1_OFFSET UNITYSDK_OFFSET(0xA1B7FE0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__INIT_B__21_0_OFFSET UNITYSDK_OFFSET(0xA1B7F80)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__INTERNALCLOSE_OFFSET UNITYSDK_OFFSET(0xA1A7900)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__ISPLACEHOLDER_OFFSET UNITYSDK_OFFSET(0xA1AF2C0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__ONARCANAANIM_OFFSET UNITYSDK_OFFSET(0xA1AFED0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__ONUIOPEN_B__6_0_OFFSET UNITYSDK_OFFSET(0xA1B7DB0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__WAITBEFOREANIMEXIT_OFFSET UNITYSDK_OFFSET(0xA1ABB70)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER__WAITHIDEDETIAL_OFFSET UNITYSDK_OFFSET(0xA1A8130)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA1B7FF0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA1B8060)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA1B8090)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA1B80A0)
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA1B80B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowShopWidgetChildWindowController_TypeDefinitionIndex = 75943;
	...
	public:
		...
		::Class_1_7807B2B04302CD7B_22* translateRatio; // 0x2F8
		...
		::Class_2_1B1C05BC0A38A2D5_5* _view; // 0x310
