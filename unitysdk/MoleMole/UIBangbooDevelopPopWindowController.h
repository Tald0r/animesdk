...
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xD5285B0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD5285A0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_LEFTBTNCALL_OFFSET UNITYSDK_OFFSET(0xD52A810)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSOLECHECKCONSUMEBTN_OFFSET UNITYSDK_OFFSET(0xD52B300)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSUMEICONBTN_OFFSET UNITYSDK_OFFSET(0xD52B240)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD528C30)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONINFOCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xD529A90)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONLEVELUPRSP_OFFSET UNITYSDK_OFFSET(0xD529F90)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD528F90)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD529C50)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD5285C0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_RESETCONTEXT_OFFSET UNITYSDK_OFFSET(0xD529740)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_RIGHTBTNCALL_OFFSET UNITYSDK_OFFSET(0xD52A730)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETATTRIBUTEUI_OFFSET UNITYSDK_OFFSET(0xD52A8F0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETSTARUPORTOPLIMITATT_OFFSET UNITYSDK_OFFSET(0xD52AE10)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETTITLE_OFFSET UNITYSDK_OFFSET(0xD52A110)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETUPGRADESTATE_OFFSET UNITYSDK_OFFSET(0xD52B1C0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SHOWBACKITEMLISTDIALOG_OFFSET UNITYSDK_OFFSET(0xD529E60)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xD529310)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD52B410)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER__SHOWBACKITEMLISTDIALOG_B__12_0_OFFSET UNITYSDK_OFFSET(0xD52B4F0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD52B5B0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD52B620)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD52B630)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD52B640)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooDevelopPopWindowController_TypeDefinitionIndex = 54992;

	class UIBangbooDevelopPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_95* _view; // 0x2F8
		::MoleMole::UIWidgetController* _curSubController; // 0x300
		::MoleMole::UIBangbooDevelopDialogContext* _context; // 0x308
		::System::Collections::Generic::List_1<::MoleMole::BangbooBaseWidget*>* _subControllers; // 0x310
		::System::Collections::Generic::List_1<::Class_1_BDEEA5009A8A636E*>* _curPropertyItemViews; // 0x318
		::Struct_2_928A3C549784FC97 currentUpgradeAniState; // 0x320
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* backItemList; // 0x328
		::System::Collections::Generic::List_1<::MoleMole::ScrollViewItemWidgetController*>* starAttributes; // 0x330
