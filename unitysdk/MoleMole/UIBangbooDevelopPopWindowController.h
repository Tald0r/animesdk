...
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xC906750)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC906740)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_LEFTBTNCALL_OFFSET UNITYSDK_OFFSET(0xC9089B0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSOLECHECKCONSUMEBTN_OFFSET UNITYSDK_OFFSET(0xC9094A0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSUMEICONBTN_OFFSET UNITYSDK_OFFSET(0xC9093E0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC906DC0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONINFOCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xC907C20)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONLEVELUPRSP_OFFSET UNITYSDK_OFFSET(0xC908120)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC907120)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC907DE0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC906760)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_RESETCONTEXT_OFFSET UNITYSDK_OFFSET(0xC9078D0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_RIGHTBTNCALL_OFFSET UNITYSDK_OFFSET(0xC9088D0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETATTRIBUTEUI_OFFSET UNITYSDK_OFFSET(0xC908A90)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETSTARUPORTOPLIMITATT_OFFSET UNITYSDK_OFFSET(0xC908FB0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETTITLE_OFFSET UNITYSDK_OFFSET(0xC9082A0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SETUPGRADESTATE_OFFSET UNITYSDK_OFFSET(0xC909360)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_SHOWBACKITEMLISTDIALOG_OFFSET UNITYSDK_OFFSET(0xC907FF0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xC9074A0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC9095B0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER__SHOWBACKITEMLISTDIALOG_B__12_0_OFFSET UNITYSDK_OFFSET(0xC9096A0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC909760)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC9097D0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC9097E0)
#define MOLEMOLE_UIBANGBOODEVELOPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC9097F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooDevelopPopWindowController_TypeDefinitionIndex = 65994;
