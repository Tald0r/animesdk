...
#define MOLEMOLE_UIURBANMAPPOINTSUBAREAWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD6EAFA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapPointSubAreaWidgetController_TypeDefinitionIndex = 46693;
