...
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER__REFRESHMAP_D__12_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x35E920)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER__REFRESHMAP_D__12_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapRefreshPageController__RefreshMap_d__12_TypeDefinitionIndex = 67304;

	struct alignas(8) UIAbyssS2MapRefreshPageController__RefreshMap_d__12
	{
		::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder __t__builder; // 0x10
		::Struct_2_32BC8A3A2B32C8F9 ___5__3; // 0x20
		::System::Threading::CancellationTokenSource* __7__wrap1; // 0x28
