...
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ADDREDAURAEFFECT_OFFSET UNITYSDK_OFFSET(0xAB0E390)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_COUNTDOWNEND_OFFSET UNITYSDK_OFFSET(0xAB0DA10)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_CREATEAVATARSKILLBTN_OFFSET UNITYSDK_OFFSET(0xAB09790)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ENTERUISTORYMODE_OFFSET UNITYSDK_OFFSET(0xAB0DC30)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_EXITUISTORYMODE_OFFSET UNITYSDK_OFFSET(0xAB0DCF0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_GETBONUSTIME_OFFSET UNITYSDK_OFFSET(0xAB0E200)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xAB09170)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_GET_IMPORTANTPUSHMESSAGECTRL_OFFSET UNITYSDK_OFFSET(0xAB09190)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0xAB09180)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0xAB09160)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAB09150)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ISBLENDINGTIMETOSCORE_OFFSET UNITYSDK_OFFSET(0xAB0D160)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAB0B850)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONAMMOCHANGE_OFFSET UNITYSDK_OFFSET(0xAB0CE10)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0xAB0C3C0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONCOMBOCHANGE_OFFSET UNITYSDK_OFFSET(0xAB0D1D0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB091A0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONEXITTPSMODE_OFFSET UNITYSDK_OFFSET(0xAB0D6C0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONFREESHOOTTIME_OFFSET UNITYSDK_OFFSET(0xAB0CAF0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAB0A470)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONHITTARGET_OFFSET UNITYSDK_OFFSET(0xAB0CCC0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAB0BD10)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xAB0C4B0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONLOGICINLEVELCAMERAMOVE_OFFSET UNITYSDK_OFFSET(0xAB0C030)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONMAGAZINESIZECHANGE_OFFSET UNITYSDK_OFFSET(0xAB0D600)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONPAUSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xAB0BDD0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONSCORECHANGE_OFFSET UNITYSDK_OFFSET(0xAB0CF60)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONSHOWSCOREPOPUP_OFFSET UNITYSDK_OFFSET(0xAB0C5E0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB09A30)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB0BC70)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB09240)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONWAVEEND_OFFSET UNITYSDK_OFFSET(0xAB0E040)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONWAVESTART_OFFSET UNITYSDK_OFFSET(0xAB0DDB0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONZOOMIN_OFFSET UNITYSDK_OFFSET(0xAB0D730)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_ONZOOMOUT_OFFSET UNITYSDK_OFFSET(0xAB0D7F0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_PREPAREGAMESTART_OFFSET UNITYSDK_OFFSET(0xAB0DA80)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_SETRANK_OFFSET UNITYSDK_OFFSET(0xAB0A0F0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xAB0BBA0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_SHOWMONSTERWAVEFAIRY_OFFSET UNITYSDK_OFFSET(0xAB0DEA0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0xAB0D8B0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_STARTTIMETOSCOREBLEND_OFFSET UNITYSDK_OFFSET(0xAB0E0C0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_TRIGGERLEVELGAMEREALSTART_OFFSET UNITYSDK_OFFSET(0xAB0AA90)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_UPDATETIMELEFTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0xAB0B210)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_UPDATETIMETOSCOREBLEND_OFFSET UNITYSDK_OFFSET(0xAB0ABA0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAB0A580)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_WAITCOROUTINE_OFFSET UNITYSDK_OFFSET(0xAB0D540)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB0E550)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER__ONUIINIT_B__42_0_OFFSET UNITYSDK_OFFSET(0xAB0E630)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB0E640)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAB0E6B0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAB0E710)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xAB0E740)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB0E7A0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB0E7B0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB0E7C0)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xAB0E7D0)

namespace MoleMole
{
	inline static constexpr unsigned int UITriggerShootMainPageController_TypeDefinitionIndex = 81122;
