...
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x893DCF0)
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x893DD00)
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER_ONLOGICINIT_OFFSET UNITYSDK_OFFSET(0x893DE30)
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x893DDA0)
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x893E020)
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x893E030)
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x893E0A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHoundGameEndPageController_TypeDefinitionIndex = 41762;

	class UIHoundGameEndPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_44* _view; // 0x2F8
