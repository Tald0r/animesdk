...
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9807AC0)
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9807AD0)
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER_ONLOGICINIT_OFFSET UNITYSDK_OFFSET(0x9807C00)
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9807B70)
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9807DF0)
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9807E00)
#define MOLEMOLE_UIHOUNDGAMEENDPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9807E70)

namespace MoleMole
{
	inline static constexpr unsigned int UIHoundGameEndPageController_TypeDefinitionIndex = 53699;
	...
	public:
		...
		::MoleMole::UISoulHoundsIIIEndingChildWindowController* endingCtrl; // 0x308
