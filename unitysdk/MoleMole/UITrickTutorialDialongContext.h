...
#define MOLEMOLE_UITRICKTUTORIALDIALONGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xDF53BA0)

namespace MoleMole
{
	inline static constexpr unsigned int UITrickTutorialDialongContext_TypeDefinitionIndex = 79967;

	class UITrickTutorialDialongContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_52BC70FDA339CCD0*>* skills; // 0x28
		::System::Collections::Generic::List_1<::System::UInt32>* avatarList; // 0x30
		::Class_0_16E4307DCC419505_350* TutorialGetter; // 0x38
