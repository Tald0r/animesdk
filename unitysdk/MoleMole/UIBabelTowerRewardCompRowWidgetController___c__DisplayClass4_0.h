...
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB90D4B0)
#define MOLEMOLE_UIBABELTOWERREWARDCOMPROWWIDGETCONTROLLER___C__DISPLAYCLASS4_0__REFRESHREWARDINFO_B__0_OFFSET UNITYSDK_OFFSET(0xB90D4C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabelTowerRewardCompRowWidgetController___c__DisplayClass4_0_TypeDefinitionIndex = 51790;
