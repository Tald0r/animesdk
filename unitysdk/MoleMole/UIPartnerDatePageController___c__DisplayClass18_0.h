...
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD393C40)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___C__DISPLAYCLASS18_0__SHOWSELECTWIDGET_B__0_OFFSET UNITYSDK_OFFSET(0xD393C50)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___C__DISPLAYCLASS18_0__SHOWSELECTWIDGET_B__1_OFFSET UNITYSDK_OFFSET(0xD394140)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___C__DISPLAYCLASS18_0__SHOWSELECTWIDGET_G__SETSTATE_2_OFFSET UNITYSDK_OFFSET(0xD393CC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPartnerDatePageController___c__DisplayClass18_0_TypeDefinitionIndex = 46004;
