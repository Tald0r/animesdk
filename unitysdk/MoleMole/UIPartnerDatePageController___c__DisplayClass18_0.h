...
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC82C270)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___C__DISPLAYCLASS18_0__SHOWSELECTWIDGET_B__0_OFFSET UNITYSDK_OFFSET(0xC82C280)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___C__DISPLAYCLASS18_0__SHOWSELECTWIDGET_B__1_OFFSET UNITYSDK_OFFSET(0xC82C760)
#define MOLEMOLE_UIPARTNERDATEPAGECONTROLLER___C__DISPLAYCLASS18_0__SHOWSELECTWIDGET_G__SETSTATE_2_OFFSET UNITYSDK_OFFSET(0xC82C2F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPartnerDatePageController___c__DisplayClass18_0_TypeDefinitionIndex = 71417;
