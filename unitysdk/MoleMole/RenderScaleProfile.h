...
#define MOLEMOLE_RENDERSCALEPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xB9AF4A0)
#define MOLEMOLE_RENDERSCALEPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xB9AF620)
#define MOLEMOLE_RENDERSCALEPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0xB9AF3C0)
#define MOLEMOLE_RENDERSCALEPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xB9AF580)
#define MOLEMOLE_RENDERSCALEPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xB9AF3B0)
#define MOLEMOLE_RENDERSCALEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xB9AF750)
#define MOLEMOLE_RENDERSCALEPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xB9AF7E0)
#define MOLEMOLE_RENDERSCALEPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xB9AF850)
#define MOLEMOLE_RENDERSCALEPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xB9AF8C0)

namespace MoleMole
{
	inline static constexpr unsigned int RenderScaleProfile_TypeDefinitionIndex = 37791;
