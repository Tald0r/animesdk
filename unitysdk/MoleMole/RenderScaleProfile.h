...
#define MOLEMOLE_RENDERSCALEPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xD81EE90)
#define MOLEMOLE_RENDERSCALEPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xD81F010)
#define MOLEMOLE_RENDERSCALEPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0xD81EDB0)
#define MOLEMOLE_RENDERSCALEPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xD81EF70)
#define MOLEMOLE_RENDERSCALEPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xD81EDA0)
#define MOLEMOLE_RENDERSCALEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xD81F140)
#define MOLEMOLE_RENDERSCALEPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xD81F1D0)
#define MOLEMOLE_RENDERSCALEPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xD81F240)
#define MOLEMOLE_RENDERSCALEPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xD81F2B0)

namespace MoleMole
{
	inline static constexpr unsigned int RenderScaleProfile_TypeDefinitionIndex = 69147;
