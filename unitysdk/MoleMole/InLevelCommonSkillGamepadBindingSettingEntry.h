...
#define MOLEMOLE_INLEVELCOMMONSKILLGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x8F864D0)
#define MOLEMOLE_INLEVELCOMMONSKILLGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x8F864E0)
#define MOLEMOLE_INLEVELCOMMONSKILLGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x8F864F0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelCommonSkillGamepadBindingSettingEntry_TypeDefinitionIndex = 78317;
