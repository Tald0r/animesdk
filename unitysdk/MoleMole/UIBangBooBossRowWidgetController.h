...
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF37540)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBF36FE0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF375E0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF36AE0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF36B80)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0xBF36D60)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_SETCLICK_OFFSET UNITYSDK_OFFSET(0xBF37210)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF376C0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__6_0_OFFSET UNITYSDK_OFFSET(0xBF376F0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0xBF376D0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER__UPDATECARD_OFFSET UNITYSDK_OFFSET(0xBF37280)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF37710)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBF37780)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF37800)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF37880)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF378E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooBossRowWidgetController_TypeDefinitionIndex = 44457;

	class UIBangBooBossRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_EC707217DE7794EF_2* _view; // 0x2D0
