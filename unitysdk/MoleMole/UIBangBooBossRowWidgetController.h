...
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBED4E40)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBED48E0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBED4EE0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBED43F0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBED4490)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0xBED4660)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER_SETCLICK_OFFSET UNITYSDK_OFFSET(0xBED4B10)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBED4FC0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__6_0_OFFSET UNITYSDK_OFFSET(0xBED4FF0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0xBED4FD0)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER__UPDATECARD_OFFSET UNITYSDK_OFFSET(0xBED4B80)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBED5010)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBED5080)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBED5100)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBED5180)
#define MOLEMOLE_UIBANGBOOBOSSROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBED51E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooBossRowWidgetController_TypeDefinitionIndex = 49256;

	class UIBangBooBossRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_EC707217DE7794EF_3* _view; // 0x2D0
