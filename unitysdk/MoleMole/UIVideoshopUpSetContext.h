...
#define MOLEMOLE_UIVIDEOSHOPUPSETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8821260)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoshopUpSetContext_TypeDefinitionIndex = 46614;
