...
#define MOLEMOLE_UIVIDEOSHOPUPSETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xABCE490)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoshopUpSetContext_TypeDefinitionIndex = 57674;
