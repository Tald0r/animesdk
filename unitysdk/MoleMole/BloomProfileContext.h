...
#define MOLEMOLE_BLOOMPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x94E50C0)

namespace MoleMole
{
	inline static constexpr unsigned int BloomProfileContext_TypeDefinitionIndex = 64028;
