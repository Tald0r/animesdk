...
#define MOLEMOLE_BLOOMPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x848CF30)

namespace MoleMole
{
	inline static constexpr unsigned int BloomProfileContext_TypeDefinitionIndex = 67023;
