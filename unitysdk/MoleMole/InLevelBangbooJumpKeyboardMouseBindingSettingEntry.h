...
#define MOLEMOLE_INLEVELBANGBOOJUMPKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xF1B78A0)
#define MOLEMOLE_INLEVELBANGBOOJUMPKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xF1B78B0)
#define MOLEMOLE_INLEVELBANGBOOJUMPKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xF1B78C0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelBangbooJumpKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 65725;
