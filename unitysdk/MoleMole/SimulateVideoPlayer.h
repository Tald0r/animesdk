...
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_CLIPDATA_OFFSET UNITYSDK_OFFSET(0xB9B8830)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xB9B84B0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0xB9B98F0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_ENABLEUPDATELOG_OFFSET UNITYSDK_OFFSET(0xB9B8440)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0xB9B9400)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_FRAMERATE_OFFSET UNITYSDK_OFFSET(0xB9B94A0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_FRAME_OFFSET UNITYSDK_OFFSET(0xB9B9360)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xB9B9650)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_ISCANRENDER_OFFSET UNITYSDK_OFFSET(0xB9B99B0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_ISLOOPING_OFFSET UNITYSDK_OFFSET(0xB9B8FE0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0xB9B8F80)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xB9B8F50)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_ISPREPARED_OFFSET UNITYSDK_OFFSET(0xB9B8FB0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0xB9B9220)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_PLAYBACKSPEED_OFFSET UNITYSDK_OFFSET(0xB9B9540)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0xB9B8F20)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_PLAYONAWAKE_OFFSET UNITYSDK_OFFSET(0xB9B90A0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0xB9B99E0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_SIMULATEVIDEOPLAYBACK_OFFSET UNITYSDK_OFFSET(0xB9B8870)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_TARGETMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0xB9B9830)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_TARGETMATERIALRENDERER_OFFSET UNITYSDK_OFFSET(0xB9B96B0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_TARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0xB9B9770)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0xB9B9680)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_TIME_OFFSET UNITYSDK_OFFSET(0xB9B92C0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_URL_OFFSET UNITYSDK_OFFSET(0xB9B8F40)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_USESIMULATE_OFFSET UNITYSDK_OFFSET(0xB9B8850)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_WAITFORFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0xB9B9160)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0xB9B9620)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB9BB220)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_LOGERROR_OFFSET UNITYSDK_OFFSET(0xB9B8750)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_LOGUPDATE_OFFSET UNITYSDK_OFFSET(0xB9B8660)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_LOG_OFFSET UNITYSDK_OFFSET(0xB9B86E0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_NATIVEPLAYERONPLAYSTART_OFFSET UNITYSDK_OFFSET(0xB9BB460)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_NATIVEPLAYERONPREPARECOMPLETED_OFFSET UNITYSDK_OFFSET(0xB9BB3D0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB9BB2D0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_ONSIMULATELOOPPOINTREACHED_OFFSET UNITYSDK_OFFSET(0xB9B8990)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_ONSIMULATEONPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xB9B8900)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_ONSIMULATESEEKCOMPLETED_OFFSET UNITYSDK_OFFSET(0xB9B8890)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_PAUSE_OFFSET UNITYSDK_OFFSET(0xB9B9C40)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_PLAY_OFFSET UNITYSDK_OFFSET(0xB9B9BC0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_PREPARE_OFFSET UNITYSDK_OFFSET(0xB9B9B20)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_PRINTONSCREEN_OFFSET UNITYSDK_OFFSET(0xB9B87C0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SEEKFRAME_OFFSET UNITYSDK_OFFSET(0xB9BAF60)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SEEKTIME_OFFSET UNITYSDK_OFFSET(0xB9BB010)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SETAUDIOMODENONE_OFFSET UNITYSDK_OFFSET(0xB9B9AA0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SETURL_OFFSET UNITYSDK_OFFSET(0xB9B9D80)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SETVIDEOCLIP_OFFSET UNITYSDK_OFFSET(0xB9BB110)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_CLIPDATA_OFFSET UNITYSDK_OFFSET(0xB9B8840)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0xB9B9920)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_ENABLEUPDATELOG_OFFSET UNITYSDK_OFFSET(0xB9B8480)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_ISLOOPING_OFFSET UNITYSDK_OFFSET(0xB9B8FF0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_PLAYBACKSPEED_OFFSET UNITYSDK_OFFSET(0xB9B9570)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_PLAYER_OFFSET UNITYSDK_OFFSET(0xB9B8F30)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_PLAYONAWAKE_OFFSET UNITYSDK_OFFSET(0xB9B90D0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0xB9B9A10)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_SIMULATEVIDEOPLAYBACK_OFFSET UNITYSDK_OFFSET(0xB9B8880)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_TARGETMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0xB9B9860)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_TARGETMATERIALRENDERER_OFFSET UNITYSDK_OFFSET(0xB9B96E0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_TARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0xB9B97A0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_USESIMULATE_OFFSET UNITYSDK_OFFSET(0xB9B8860)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SET_WAITFORFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0xB9B9190)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_STEPFORWARD_OFFSET UNITYSDK_OFFSET(0xB9BB1A0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0xB9B9CE0)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SWITCHPLAYER_OFFSET UNITYSDK_OFFSET(0xB9BA860)
#define MOLEMOLE_SIMULATEVIDEOPLAYER_SWITCHSIMULATE_OFFSET UNITYSDK_OFFSET(0xB9BA010)
#define MOLEMOLE_SIMULATEVIDEOPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xB9B8A00)
#define MOLEMOLE_SIMULATEVIDEOPLAYER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB9BB4F0)

namespace MoleMole
{
	inline static constexpr unsigned int SimulateVideoPlayer_TypeDefinitionIndex = 40018;

	class SimulateVideoPlayer : public ::MoleMole::IVideoPlayer
	{
	public:
		::Struct_2_A11167748A3D1C6F videoFileUrl; // 0x48
		::System::String* _url; // 0x68
		::Class_1_E0A05564B7F916C1* _SimulateVideoPlayback_k__BackingField; // 0x70
		::MoleMole::IVideoPlayer* _Player_k__BackingField; // 0x78
		::System::Boolean _UseSimulate_k__BackingField; // 0x80
		::System::Boolean _Looping; // 0x81
