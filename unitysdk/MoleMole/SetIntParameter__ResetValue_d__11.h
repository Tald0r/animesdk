...
#define MOLEMOLE_SETINTPARAMETER__RESETVALUE_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA610540)
#define MOLEMOLE_SETINTPARAMETER__RESETVALUE_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA6105E0)
#define MOLEMOLE_SETINTPARAMETER__RESETVALUE_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA610640)
#define MOLEMOLE_SETINTPARAMETER__RESETVALUE_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA6105F0)
#define MOLEMOLE_SETINTPARAMETER__RESETVALUE_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA610530)
#define MOLEMOLE_SETINTPARAMETER__RESETVALUE_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0xA610520)

namespace MoleMole
{
	inline static constexpr unsigned int SetIntParameter__ResetValue_d__11_TypeDefinitionIndex = 54320;
	...
	public:
		...
		::Class_3_F33F9DC5F4112336* animatorComponent; // 0x20
