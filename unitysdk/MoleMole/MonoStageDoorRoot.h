...
#define MOLEMOLE_MONOSTAGEDOORROOT_AWAKE_OFFSET UNITYSDK_OFFSET(0x7A948B0)
#define MOLEMOLE_MONOSTAGEDOORROOT_GET_ROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x7A94920)
#define MOLEMOLE_MONOSTAGEDOORROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x7A94930)

namespace MoleMole
{
	inline static constexpr unsigned int MonoStageDoorRoot_TypeDefinitionIndex = 40099;
