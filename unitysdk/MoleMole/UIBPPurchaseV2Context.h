...
#define MOLEMOLE_UIBPPURCHASEV2CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD51F500)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPPurchaseV2Context_TypeDefinitionIndex = 63687;
