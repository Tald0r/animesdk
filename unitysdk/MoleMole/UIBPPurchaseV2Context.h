...
#define MOLEMOLE_UIBPPURCHASEV2CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC8FD720)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPPurchaseV2Context_TypeDefinitionIndex = 68716;
