...
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS48_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBF2A4B0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS48_0__ENTERPLAYGAMEPHASEFROMARCADEMACHINE_B__0_OFFSET UNITYSDK_OFFSET(0xBF2A4C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadePageController___c__DisplayClass48_0_TypeDefinitionIndex = 57171;
