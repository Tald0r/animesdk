...
#define MOLEMOLE_CONFIGCHESSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0xB480100)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigChessEntity_TypeDefinitionIndex = 51433;
