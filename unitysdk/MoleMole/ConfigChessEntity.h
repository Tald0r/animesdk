...
#define MOLEMOLE_CONFIGCHESSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0xE82B9A0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigChessEntity_TypeDefinitionIndex = 48214;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::Share::GridDir, ::MoleMole::ConfigChessEntity_StateMachineParamsWrapper>* exitMoveState; // 0x18
