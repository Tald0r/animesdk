...
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xA639BF0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ISNEW_OFFSET UNITYSDK_OFFSET(0xA63AD50)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA63A050)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONMANUALADD_OFFSET UNITYSDK_OFFSET(0xA63A620)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONTRACKQUESTUPDATE_OFFSET UNITYSDK_OFFSET(0xA63A2A0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA63A0F0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA639C10)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA639FA0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_PLAYSELECT_OFFSET UNITYSDK_OFFSET(0xA63A7F0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_READNEW_OFFSET UNITYSDK_OFFSET(0xA63ADD0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0xA63A690)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REFRESHTRACK_OFFSET UNITYSDK_OFFSET(0xA63A310)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA63B000)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REGISTERCLICKCB_OFFSET UNITYSDK_OFFSET(0xA63A780)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_RESELECT_OFFSET UNITYSDK_OFFSET(0xA63AC50)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SETINDEX_OFFSET UNITYSDK_OFFSET(0xA63B340)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SETNAMETEXT_OFFSET UNITYSDK_OFFSET(0xA63AA20)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0xA63A990)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xA639C00)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_TRIGGERBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xA63AE30)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA63B470)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA63B440)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__ONUIINIT_B__8_0_OFFSET UNITYSDK_OFFSET(0xA63B4C0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__REFRESHTRACK_G__SETTRACKED_26_0_OFFSET UNITYSDK_OFFSET(0xA63B3B0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA63B520)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA63B590)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA63B610)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA63B670)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotMissionItemWidgetController_TypeDefinitionIndex = 52974;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotMissionItemWidgetController_TypeDefinitionIndex)->GetStaticField(0xF360);
		}
		static ::System::Int32* StaticGet_RampColorB()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotMissionItemWidgetController_TypeDefinitionIndex)->GetStaticField(0xF364);
		}
