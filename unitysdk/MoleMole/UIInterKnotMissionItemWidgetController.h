...
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xBD2E530)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ISNEW_OFFSET UNITYSDK_OFFSET(0xBD2F690)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD2E990)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONMANUALADD_OFFSET UNITYSDK_OFFSET(0xBD2EF60)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONTRACKQUESTUPDATE_OFFSET UNITYSDK_OFFSET(0xBD2EBE0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD2EA30)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD2E550)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD2E8E0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_PLAYSELECT_OFFSET UNITYSDK_OFFSET(0xBD2F130)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_READNEW_OFFSET UNITYSDK_OFFSET(0xBD2F710)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0xBD2EFD0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REFRESHTRACK_OFFSET UNITYSDK_OFFSET(0xBD2EC50)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBD2F940)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_REGISTERCLICKCB_OFFSET UNITYSDK_OFFSET(0xBD2F0C0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_RESELECT_OFFSET UNITYSDK_OFFSET(0xBD2F590)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SETINDEX_OFFSET UNITYSDK_OFFSET(0xBD2FC80)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SETNAMETEXT_OFFSET UNITYSDK_OFFSET(0xBD2F360)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0xBD2F2D0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xBD2E540)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER_TRIGGERBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xBD2F770)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xBD2FDB0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBD2FD80)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__ONUIINIT_B__8_0_OFFSET UNITYSDK_OFFSET(0xBD2FE00)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER__REFRESHTRACK_G__SETTRACKED_26_0_OFFSET UNITYSDK_OFFSET(0xBD2FCF0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD2FE60)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD2FED0)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD2FF50)
#define MOLEMOLE_UIINTERKNOTMISSIONITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD2FFB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotMissionItemWidgetController_TypeDefinitionIndex = 73587;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotMissionItemWidgetController_TypeDefinitionIndex)->GetStaticField(0xF850);
		}
		static ::System::Int32* StaticGet_RampColorA()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotMissionItemWidgetController_TypeDefinitionIndex)->GetStaticField(0xF854);
		}
		::Class_2_79AE422BA06F6D26* _view; // 0x2A0
		::MoleMole::UIInterKnotPageConfig* _Config_k__BackingField; // 0x2A8
		::MoleMole::UIInterKnotPageConfig_MainCityQuestTypeRowConfig* _rowConfig; // 0x2B0
		::DG::Tweening::Tweener* tweener; // 0x2B8
		::System::Action_1<::System::Int32>* _onClick; // 0x2C0
		::System::Int32 _index; // 0x2C8
		::UnityEngine::UI::Image* _img; // 0x2D0
		::UnityEngine::Material* _allocMaterial; // 0x2D8
		::Class_1_2181504E881DDEE4* _manual; // 0x2E0
