...
#define MOLEMOLE_CARDOPTIONBGCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6BDD780)

namespace MoleMole
{
	inline static constexpr unsigned int CardOptionBgColor_TypeDefinitionIndex = 47965;
