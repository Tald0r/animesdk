...
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_GET_ICON_OFFSET UNITYSDK_OFFSET(0x8715910)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_GET_PRESSURE_OFFSET UNITYSDK_OFFSET(0x8715930)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_HANDLEPOPUP_OFFSET UNITYSDK_OFFSET(0x8715190)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_HIDEPROGRESSVALUE_OFFSET UNITYSDK_OFFSET(0x8715890)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_MARKCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x8715090)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8714F10)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8714FB0)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8714C80)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8714E60)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_SETONCLICKBACK_OFFSET UNITYSDK_OFFSET(0x8715120)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER_SHOWPROGRESSVALUE_OFFSET UNITYSDK_OFFSET(0x8715600)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8715950)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0x8715980)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x87159A0)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8715A10)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8715A90)
#define MOLEMOLE_UIGENERALREWARDLISTBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8715AF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralRewardListBtnWidgetController_TypeDefinitionIndex = 71873;
