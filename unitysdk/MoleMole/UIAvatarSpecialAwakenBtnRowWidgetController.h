...
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8BAF150)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8BAF1C0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8BAF370)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8BAF2C0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8BAF4C0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8BAF4D0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8BAF540)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8BAF5C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarSpecialAwakenBtnRowWidgetController_TypeDefinitionIndex = 52066;
