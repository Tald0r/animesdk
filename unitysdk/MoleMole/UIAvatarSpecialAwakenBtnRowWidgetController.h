...
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7F5BAF0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7F5BB60)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x7F5BD10)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7F5BC60)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F5BE60)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7F5BE70)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x7F5BEE0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENBTNROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7F5BF60)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarSpecialAwakenBtnRowWidgetController_TypeDefinitionIndex = 78759;
