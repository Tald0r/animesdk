...
#define MOLEMOLE_UIURBANMAPRIGHTSTREETINFOCONTROLLER_LEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0xA121EF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapRightStreetInfoController_Level_TypeDefinitionIndex = 78057;
