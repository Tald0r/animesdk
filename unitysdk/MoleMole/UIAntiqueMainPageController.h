...
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_GETLEVELASSETPATH_OFFSET UNITYSDK_OFFSET(0xDEF1340)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDEEF8E0)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ISTASKLOCK_OFFSET UNITYSDK_OFFSET(0xDEF1450)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONANTIQUELEVELCHANGE_OFFSET UNITYSDK_OFFSET(0xDEF1C80)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONCOLLECTBUTTONFINISH_OFFSET UNITYSDK_OFFSET(0xDEF1B90)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONCOLLECTBUTTON_OFFSET UNITYSDK_OFFSET(0xDEF1A10)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEEF8F0)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONEXPCHANGE_OFFSET UNITYSDK_OFFSET(0xDEF1C10)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONHANDBOOKBUTTONFINISH_OFFSET UNITYSDK_OFFSET(0xDEF1840)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONHANDBOOKBUTTON_OFFSET UNITYSDK_OFFSET(0xDEF1790)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONINFOBUTTON_OFFSET UNITYSDK_OFFSET(0xDEF1210)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONLEVELBUTTONFINISH_OFFSET UNITYSDK_OFFSET(0xDEF1710)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONLEVELBUTTON_OFFSET UNITYSDK_OFFSET(0xDEF14C0)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONREFRESHREWARDSTATE_OFFSET UNITYSDK_OFFSET(0xDEF1CF0)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONTASKBUTTONFINISH_OFFSET UNITYSDK_OFFSET(0xDEF1990)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONTASKBUTTON_OFFSET UNITYSDK_OFFSET(0xDEF18C0)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEF1180)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEEFCC0)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_PLAYOUTANIMATION_OFFSET UNITYSDK_OFFSET(0xDEF1640)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_REFRESHCOLLECTRATE_OFFSET UNITYSDK_OFFSET(0xDEF0B00)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_REFRESHHANDBOOKRATE_OFFSET UNITYSDK_OFFSET(0xDEF0C20)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_REFRESHLEFTEXPINFO_OFFSET UNITYSDK_OFFSET(0xDEF12B0)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_REFRESHLEVELINFO_OFFSET UNITYSDK_OFFSET(0xDEF0370)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_REFRESHTASK_OFFSET UNITYSDK_OFFSET(0xDEF0910)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER_SHOWINFOTIPSONFIRSTOPEN_OFFSET UNITYSDK_OFFSET(0xDEF0EA0)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDEF1D60)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEF1DB0)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEF1E20)
#define MOLEMOLE_UIANTIQUEMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEF1E30)

namespace MoleMole
{
	inline static constexpr unsigned int UIAntiqueMainPageController_TypeDefinitionIndex = 40758;
