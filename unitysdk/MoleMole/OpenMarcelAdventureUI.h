...
#define MOLEMOLE_OPENMARCELADVENTUREUI_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0xB9AE610)
#define MOLEMOLE_OPENMARCELADVENTUREUI_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xB9AE630)
#define MOLEMOLE_OPENMARCELADVENTUREUI__CTOR_OFFSET UNITYSDK_OFFSET(0xB9AE620)

namespace MoleMole
{
	inline static constexpr unsigned int OpenMarcelAdventureUI_TypeDefinitionIndex = 46718;
