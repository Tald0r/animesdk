...
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__ASYNCCALCPATH_D__33_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x335400)
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__ASYNCCALCPATH_D__33_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapTrackLineWidgetContext__AsyncCalcPath_d__33_TypeDefinitionIndex = 62888;
	...
	struct alignas(8) UIUrbanMapTrackLineWidgetContext__AsyncCalcPath_d__33
	{
		...
		::System::Collections::Generic::List_1<::UnityEngine::Vector3>* result; // 0x30
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__1; // 0x38
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::Boolean> __u__2; // 0x48
		::Class_1_A00B784DE48ED0A8* _wrapper_5__2; // 0x58
