...
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__ASYNCCALCPATH_D__33_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x38F690)
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__ASYNCCALCPATH_D__33_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapTrackLineWidgetContext__AsyncCalcPath_d__33_TypeDefinitionIndex = 45732;

	struct alignas(8) UIUrbanMapTrackLineWidgetContext__AsyncCalcPath_d__33
	{
		::System::Collections::Generic::List_1<::UnityEngine::Vector3>* result; // 0x10
		...
		::Class_1_A00B784DE48ED0A8* _wrapper_5__2; // 0x38
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::Boolean> __u__2; // 0x40
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__1; // 0x50
		::UnityEngine::Vector3 sourcePosition; // 0x60
		::System::Int32 __1__state; // 0x6C
		::UnityEngine::Vector3 targetPosition; // 0x70
