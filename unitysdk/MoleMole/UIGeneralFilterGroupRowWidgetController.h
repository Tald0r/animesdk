...
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_ACTIVEITEMROOT_OFFSET UNITYSDK_OFFSET(0xA29C0F0)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_DEALSHOWTYPE_OFFSET UNITYSDK_OFFSET(0xA29AB60)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_GETACTIVEGAMEPADSELECTABLE_OFFSET UNITYSDK_OFFSET(0xA29C410)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_GETCHILDITEMSIZE_OFFSET UNITYSDK_OFFSET(0xA29BB30)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_GET_ONITEMCLICK_OFFSET UNITYSDK_OFFSET(0xA299670)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA299810)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA29B750)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xA29B8E0)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA29B650)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA29BA70)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA299990)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA2998B0)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA299770)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_REFRESHITEMS_OFFSET UNITYSDK_OFFSET(0xA299D80)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_SET_ONITEMCLICK_OFFSET UNITYSDK_OFFSET(0xA299680)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_SET_TITLE_OFFSET UNITYSDK_OFFSET(0xA299690)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_TOGGLEITEMROOTDISPLAY_OFFSET UNITYSDK_OFFSET(0xA29C070)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_UPDATEBTNTEXT_OFFSET UNITYSDK_OFFSET(0xA29BE70)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_UPDATEFILTERITEMSTATE_OFFSET UNITYSDK_OFFSET(0xA29A9D0)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_UPDATEFOLDDISPLAY_1_OFFSET UNITYSDK_OFFSET(0xA29C4C0)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER_UPDATEFOLDDISPLAY_OFFSET UNITYSDK_OFFSET(0xA29AF10)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA29C9E0)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER__GETCHILDITEMSIZE_G__GETSPACE_23_0_OFFSET UNITYSDK_OFFSET(0xA29BD20)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA29CAD0)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA29CB40)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xA29CBB0)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA29CC20)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA29CCA0)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA29CCD0)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA29CD50)
#define MOLEMOLE_UIGENERALFILTERGROUPROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA29CDD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralFilterGroupRowWidgetController_TypeDefinitionIndex = 50158;
	...
	public:
		...
		::Enum_3_190E3717882702BE typedDataShowType; // 0x300
