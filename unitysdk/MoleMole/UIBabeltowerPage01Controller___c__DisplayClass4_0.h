...
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA31F020)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER___C__DISPLAYCLASS4_0__ONPOSTREFRESHVIEW_B__0_OFFSET UNITYSDK_OFFSET(0xA31F030)
#define MOLEMOLE_UIBABELTOWERPAGE01CONTROLLER___C__DISPLAYCLASS4_0__ONPOSTREFRESHVIEW_B__1_OFFSET UNITYSDK_OFFSET(0xA31F2B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerPage01Controller___c__DisplayClass4_0_TypeDefinitionIndex = 38150;
