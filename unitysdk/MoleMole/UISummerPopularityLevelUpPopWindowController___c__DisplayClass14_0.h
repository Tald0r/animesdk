...
#define MOLEMOLE_UISUMMERPOPULARITYLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x7C47720)
#define MOLEMOLE_UISUMMERPOPULARITYLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__REFRESHLEVELTXTVIEW_B__10_OFFSET UNITYSDK_OFFSET(0x7C47780)
#define MOLEMOLE_UISUMMERPOPULARITYLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__REFRESHLEVELTXTVIEW_B__3_OFFSET UNITYSDK_OFFSET(0x7C47730)
#define MOLEMOLE_UISUMMERPOPULARITYLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__REFRESHLEVELTXTVIEW_B__7_OFFSET UNITYSDK_OFFSET(0x7C47860)
#define MOLEMOLE_UISUMMERPOPULARITYLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__REFRESHLEVELTXTVIEW_G__ONPROGRESS_0_OFFSET UNITYSDK_OFFSET(0x7C47880)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerPopularityLevelUpPopWindowController___c__DisplayClass14_0_TypeDefinitionIndex = 77063;

	class UISummerPopularityLevelUpPopWindowController___c__DisplayClass14_0 : public ::System::Object
	{
	public:
		::System::Action* __9__10; // 0x10
		::MoleMole::UISummerPopularityLevelUpPopWindowController* __4__this; // 0x18
