...
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MAPICONFILTER_CANSHOW_OFFSET UNITYSDK_OFFSET(0x6CD3BF0)
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MAPICONFILTER_ISCURRENTSTATEANDRES_OFFSET UNITYSDK_OFFSET(0x6CD40B0)
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MAPICONFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x6CD3BE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniScapeMapPage_MapWidgetController_MapIconFilter_TypeDefinitionIndex = 66534;
