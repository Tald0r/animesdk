...
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0xF226440)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xF226180)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xF2261F0)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xF2267B0)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER_SETHEADSLOTVIEW_OFFSET UNITYSDK_OFFSET(0xF226340)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__7_0_OFFSET UNITYSDK_OFFSET(0xF226890)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__7_1_OFFSET UNITYSDK_OFFSET(0xF226A10)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__7_2_OFFSET UNITYSDK_OFFSET(0xF226BA0)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xF226880)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xF226D30)
#define MOLEMOLE_UIGENERALHEADSLOTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xF226DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralHeadSlotWidgetController_TypeDefinitionIndex = 47209;
