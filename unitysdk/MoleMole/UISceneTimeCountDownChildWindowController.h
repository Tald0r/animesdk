...
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA3FD0E0)
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA3FD0F0)
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA3FD420)
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3FD5A0)
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA3FD5B0)

namespace MoleMole
{
	inline static constexpr unsigned int UISceneTimeCountDownChildWindowController_TypeDefinitionIndex = 44185;

	class UISceneTimeCountDownChildWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::System::UInt32 _startTime; // 0x2F8
		::System::UInt32 _endTime; // 0x2FC
		::MoleMole::UIGeneralNewsBubbleRowWidgetController* _tipController; // 0x300
