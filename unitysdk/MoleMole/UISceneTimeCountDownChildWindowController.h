...
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x96F9EC0)
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x96F9ED0)
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x96FA200)
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x96FA380)
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x96FA390)

namespace MoleMole
{
	inline static constexpr unsigned int UISceneTimeCountDownChildWindowController_TypeDefinitionIndex = 79694;
