...
#define MOLEMOLE_UIMAINCITYPHOTOPOPWINDOWCONTROLLER__SAVETEXTURETOGALLERYUNITASK_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x385DB0)
#define MOLEMOLE_UIMAINCITYPHOTOPOPWINDOWCONTROLLER__SAVETEXTURETOGALLERYUNITASK_D__21_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityPhotoPopWindowController__SaveTextureToGalleryUniTask_d__21_TypeDefinitionIndex = 78633;
	...
	struct alignas(8) UIMainCityPhotoPopWindowController__SaveTextureToGalleryUniTask_d__21
	{
		...
		::UnityEngine::RenderTexture* rt; // 0x28
