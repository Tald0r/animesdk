...
#define MOLEMOLE_UIFISHINGCONTESTTIPSPOPWINDOWCONTROLLER_STARINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA8F6800)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishingContestTipsPopWindowController_StarInfo_TypeDefinitionIndex = 65277;
