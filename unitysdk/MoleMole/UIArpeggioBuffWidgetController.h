...
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB5F5CC0)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB5F5E40)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB5F5D60)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB5F5C20)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB5F5F70)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB5F5F80)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB5F5FF0)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB5F6070)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB5F60F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArpeggioBuffWidgetController_TypeDefinitionIndex = 76700;

	class UIArpeggioBuffWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_8127D35606966C67_27* _view; // 0x2D0
