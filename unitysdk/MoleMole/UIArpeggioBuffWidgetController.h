...
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDD9B9E0)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDD9BB60)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDD9BA80)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDD9B940)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDD9BC90)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDD9BCA0)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDD9BD10)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDD9BD90)
#define MOLEMOLE_UIARPEGGIOBUFFWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDD9BE10)

namespace MoleMole
{
	inline static constexpr unsigned int UIArpeggioBuffWidgetController_TypeDefinitionIndex = 40038;
