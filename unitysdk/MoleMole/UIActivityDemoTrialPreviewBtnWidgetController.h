...
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER_GET_GETVIEW_OFFSET UNITYSDK_OFFSET(0xC359920)
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC359D20)
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER_ONPREVIEWBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC35A710)
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC359DC0)
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC359930)
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC359C70)
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER_SETDEMOTRIALPREVIEWBTN_OFFSET UNITYSDK_OFFSET(0xC359EA0)
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER_SETPREVIEWBANGBOO_OFFSET UNITYSDK_OFFSET(0xC35A2D0)
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER_SETPREVIEWWEAPON_OFFSET UNITYSDK_OFFSET(0xC35A490)
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC35A7C0)
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC35A7F0)
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC35A860)
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC35A8E0)
#define MOLEMOLE_UIACTIVITYDEMOTRIALPREVIEWBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC35A940)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityDemoTrialPreviewBtnWidgetController_TypeDefinitionIndex = 72975;
