...
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__PRELOADITEMSTAGE_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xAD2BEF0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__PRELOADITEMSTAGE_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAD2C1A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__PRELOADITEMSTAGE_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAD2C200)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__PRELOADITEMSTAGE_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xAD2C1B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__PRELOADITEMSTAGE_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAD2BEE0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__PRELOADITEMSTAGE_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0xAD2BED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStage3DModelControllerBase__PreloadItemStage_d__17_TypeDefinitionIndex = 45128;

	class UIGachaStage3DModelControllerBase__PreloadItemStage_d__17 : public ::System::Object
	{
	public:
		::System::Action* completeCb; // 0x10
		::MoleMole::UIGachaStage3DModelControllerBase___c__DisplayClass17_0* __8__1; // 0x18
		::System::Object* __2__current; // 0x20
		::MoleMole::UIGachaStage3DModelControllerBase* __4__this; // 0x28
		::Il2CppArray<::Foundation::AssetPath>* preloadAssets; // 0x30
