...
#define MOLEMOLE_CONFIGUIURBANMAP_GETCONFIGBYKEY_OFFSET UNITYSDK_OFFSET(0xC1E8900)
#define MOLEMOLE_CONFIGUIURBANMAP_TRYGETURBANMAPMESHLAYERINFO_OFFSET UNITYSDK_OFFSET(0xC1E8430)
#define MOLEMOLE_CONFIGUIURBANMAP_TRYGETURBANMAPMESHLAYEROVERRIDEBOUNDS_OFFSET UNITYSDK_OFFSET(0xC1E8270)
#define MOLEMOLE_CONFIGUIURBANMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xC1E8AD0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIUrbanMap_TypeDefinitionIndex = 44062;
