...
#define MOLEMOLE_CONFIGUIURBANMAP_GETCONFIGBYKEY_OFFSET UNITYSDK_OFFSET(0x81FF6F0)
#define MOLEMOLE_CONFIGUIURBANMAP_TRYGETURBANMAPMESHLAYERINFO_OFFSET UNITYSDK_OFFSET(0x81FF230)
#define MOLEMOLE_CONFIGUIURBANMAP_TRYGETURBANMAPMESHLAYEROVERRIDEBOUNDS_OFFSET UNITYSDK_OFFSET(0x81FF070)
#define MOLEMOLE_CONFIGUIURBANMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x81FF8C0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIUrbanMap_TypeDefinitionIndex = 71649;
