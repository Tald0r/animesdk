...
#define MOLEMOLE_UICOOPPAGECONTROLLER_BINDBADGE_OFFSET UNITYSDK_OFFSET(0xB2BFE00)
#define MOLEMOLE_UICOOPPAGECONTROLLER_BINDBTNS_OFFSET UNITYSDK_OFFSET(0xB2BF510)
#define MOLEMOLE_UICOOPPAGECONTROLLER_BINDEVENTS_OFFSET UNITYSDK_OFFSET(0xB2BFD10)
#define MOLEMOLE_UICOOPPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0xB2C16C0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB2BF080)
#define MOLEMOLE_UICOOPPAGECONTROLLER_GOTOMAPQUEST_OFFSET UNITYSDK_OFFSET(0xB2C2A20)
#define MOLEMOLE_UICOOPPAGECONTROLLER_INITSPACELISTDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0xB2BF2C0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKBATTLE_OFFSET UNITYSDK_OFFSET(0xB2C1B30)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKCLUEBOARD_OFFSET UNITYSDK_OFFSET(0xB2C1D90)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKEMOJI_OFFSET UNITYSDK_OFFSET(0xB2C1EF0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKEQUIP_OFFSET UNITYSDK_OFFSET(0xB2C2070)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKINFO_OFFSET UNITYSDK_OFFSET(0xB2C2220)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKLEVELREWARD_OFFSET UNITYSDK_OFFSET(0xB2C1940)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKSETTING_OFFSET UNITYSDK_OFFSET(0xB2C1790)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKSTORY_OFFSET UNITYSDK_OFFSET(0xB2C22C0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCLICKTASK_OFFSET UNITYSDK_OFFSET(0xB2C2420)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB2BF090)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONLEVELREWARDNOTIFICATIONNODECHANGE_OFFSET UNITYSDK_OFFSET(0xB2C1AA0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB2C14D0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2C2EB0)
#define MOLEMOLE_UICOOPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB2BF130)
#define MOLEMOLE_UICOOPPAGECONTROLLER_OPENMAP_OFFSET UNITYSDK_OFFSET(0xB2C2D40)
#define MOLEMOLE_UICOOPPAGECONTROLLER_REFRESHCONTRIBUTION_OFFSET UNITYSDK_OFFSET(0xB2C0850)
#define MOLEMOLE_UICOOPPAGECONTROLLER_REFRESHCOOPLOCK_OFFSET UNITYSDK_OFFSET(0xB2C1630)
#define MOLEMOLE_UICOOPPAGECONTROLLER_REFRESHCOOPTIPS_OFFSET UNITYSDK_OFFSET(0xB2C1250)
#define MOLEMOLE_UICOOPPAGECONTROLLER_REFRESHLEVEL_OFFSET UNITYSDK_OFFSET(0xB2C0400)
#define MOLEMOLE_UICOOPPAGECONTROLLER_REFRESHREWARDBTN_OFFSET UNITYSDK_OFFSET(0xB2C0F10)
#define MOLEMOLE_UICOOPPAGECONTROLLER_REFRESHTASK_OFFSET UNITYSDK_OFFSET(0xB2C0DB0)
#define MOLEMOLE_UICOOPPAGECONTROLLER__BINDEVENTS_B__17_0_OFFSET UNITYSDK_OFFSET(0xB2C3320)
#define MOLEMOLE_UICOOPPAGECONTROLLER__BINDEVENTS_B__17_1_OFFSET UNITYSDK_OFFSET(0xB2C3330)
#define MOLEMOLE_UICOOPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB2C3060)
#define MOLEMOLE_UICOOPPAGECONTROLLER__ONCLICKBATTLE_B__26_0_OFFSET UNITYSDK_OFFSET(0xB2C3340)
#define MOLEMOLE_UICOOPPAGECONTROLLER__ONCLICKBATTLE_B__26_1_OFFSET UNITYSDK_OFFSET(0xB2C3650)
#define MOLEMOLE_UICOOPPAGECONTROLLER__ONCLICKBATTLE_B__26_2_OFFSET UNITYSDK_OFFSET(0xB2C33A0)
#define MOLEMOLE_UICOOPPAGECONTROLLER__ONCLICKCLUEBOARD_B__27_0_OFFSET UNITYSDK_OFFSET(0xB2C36F0)
#define MOLEMOLE_UICOOPPAGECONTROLLER__ONCLICKLEVELREWARD_B__16_0_OFFSET UNITYSDK_OFFSET(0xB2C3070)
#define MOLEMOLE_UICOOPPAGECONTROLLER__ONCLICKSTORY_B__31_0_OFFSET UNITYSDK_OFFSET(0xB2C39A0)
#define MOLEMOLE_UICOOPPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB2C3C50)
#define MOLEMOLE_UICOOPPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB2C3CC0)
#define MOLEMOLE_UICOOPPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2C3D30)
#define MOLEMOLE_UICOOPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB2C3D40)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopPageController_TypeDefinitionIndex = 51557;
	...
	public:
		...
		::Class_2_60638234271CCDB8_11* _view; // 0x308
