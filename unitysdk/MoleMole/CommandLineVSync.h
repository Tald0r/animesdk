...
#define MOLEMOLE_COMMANDLINEVSYNC_METHOD_2_BBEB22AFF699E501_OFFSET UNITYSDK_OFFSET(0x8492960)
#define MOLEMOLE_COMMANDLINEVSYNC_METHOD_2_F7068DE2A441A97B_OFFSET UNITYSDK_OFFSET(0x8492AA0)
#define MOLEMOLE_COMMANDLINEVSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x8492A60)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineVSync_TypeDefinitionIndex = 42524;
