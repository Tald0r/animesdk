...
#define MOLEMOLE_UIROLEINFODETAILSCOREDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAE42CC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoDetailScoreDialogContext_TypeDefinitionIndex = 60497;
	...
	public:
		...
		::Enum_3_CAE10C54ABAE6FAF weaponScore; // 0x30
		::Enum_3_CAE10C54ABAE6FAF totalScore; // 0x34
		::Enum_3_CAE10C54ABAE6FAF levelScore; // 0x38
		::Enum_3_CAE10C54ABAE6FAF skillScore; // 0x3C
