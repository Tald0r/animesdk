...
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_BINDEVENT_BUTTON_OFFSET UNITYSDK_OFFSET(0x95392A0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_BINDEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x9539A00)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_BINDEVENT_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x9539620)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_BUILDUNLOCKEDCOLLECTIONS_OFFSET UNITYSDK_OFFSET(0x953B9B0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_GET_CURRENTFOCUSVHSCOLLECTIONID_OFFSET UNITYSDK_OFFSET(0x953B820)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_GET_TYPESELECTHEIGHT_OFFSET UNITYSDK_OFFSET(0x953C160)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_GET_TYPESELECTWIDTH_OFFSET UNITYSDK_OFFSET(0x953C0C0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9538F10)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0x9539D30)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x953A880)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ISSELECTEDVHSCOLLECTION_OFFSET UNITYSDK_OFFSET(0x953B120)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ISSELECTFULLVHS_OFFSET UNITYSDK_OFFSET(0x953B250)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONAFTERCURRENTSELECTCOLLECTIONIDCHANGED_OFFSET UNITYSDK_OFFSET(0x9539B70)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONAFTERVHSSELECTCHANGE_OFFSET UNITYSDK_OFFSET(0x953B3E0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONAUTOSELECTBTNCLICK_OFFSET UNITYSDK_OFFSET(0x953BF90)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9538F20)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x953AF00)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x953AD00)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONOKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x953BF10)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x953AC00)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x953AC70)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9538FC0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95397D0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_REFRESHOKBTN_OFFSET UNITYSDK_OFFSET(0x953B450)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_REFRESHTAGSPREVIEW_OFFSET UNITYSDK_OFFSET(0x953B930)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_SELECTVHSCOLLECTION_OFFSET UNITYSDK_OFFSET(0x953B7B0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_SETOPTIONTEXT_OFFSET UNITYSDK_OFFSET(0x953B090)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__BINDEVENT_NOTIFY_B__13_0_OFFSET UNITYSDK_OFFSET(0x953C700)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__BINDEVENT_NOTIFY_B__13_1_OFFSET UNITYSDK_OFFSET(0x953C8A0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x953C200)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__INITDATA_G__GETALLLEVELTAG_21_1_OFFSET UNITYSDK_OFFSET(0x953CA40)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x953C400)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0x953C670)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x953CAC0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x953CB30)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x953CBB0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x953CBE0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x953CBF0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x953CC00)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x953CC10)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreDialogV2PopWindowController_TypeDefinitionIndex = 77178;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_40* _view; // 0x310
		...
		static ::System::Int32 _InitData_g__GetAllLevelTag_21_1(::Class_2_208CC9941471731A_836* collectionTemplateExt)
		{
			return ((::System::Int32(*)(::Class_2_208CC9941471731A_836*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER__INITDATA_G__GETALLLEVELTAG_21_1_OFFSET))(collectionTemplateExt);
		}
