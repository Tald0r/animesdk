...
#define MOLEMOLE_UIGENERALOPTIONLISTROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBFF53D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralOptionListRowContext_TypeDefinitionIndex = 49617;

	class UIGeneralOptionListRowContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Action_2<::System::Int32, ::System::Int32>* OnDropDownSelect; // 0x28
		...
		::System::Boolean IgnoreGamepadLeftStickButtonClose; // 0x55
