...
#define MOLEMOLE_ANTIALIASPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x9B2B910)
#define MOLEMOLE_ANTIALIASPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x9B2BA90)
#define MOLEMOLE_ANTIALIASPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x9B2B830)
#define MOLEMOLE_ANTIALIASPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x9B2B9F0)
#define MOLEMOLE_ANTIALIASPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x9B2B820)
#define MOLEMOLE_ANTIALIASPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B2BBC0)
#define MOLEMOLE_ANTIALIASPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x9B2BC50)
#define MOLEMOLE_ANTIALIASPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x9B2BCC0)
#define MOLEMOLE_ANTIALIASPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x9B2BD30)

namespace MoleMole
{
	inline static constexpr unsigned int AntiAliasProfile_TypeDefinitionIndex = 66188;
