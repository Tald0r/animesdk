...
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_GETBINDMODULES_OFFSET UNITYSDK_OFFSET(0xBFC5F60)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_GETNESTEDLISTDELEGATEGOLIST_OFFSET UNITYSDK_OFFSET(0xBFC6040)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFC5DE0)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFC5E80)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFC3B60)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFC5D30)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBFC3DF0)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFC63C0)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFC64B0)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFC6520)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFC65A0)
#define MOLEMOLE_UIBABELTOWERPAUSEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFC6600)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerPauseWidgetController_TypeDefinitionIndex = 63976;

	class UIBabeltowerPauseWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_1A8A1E31747C749E* _view; // 0x2A0
		::Class_2_9C39822136DA5684* scoreData; // 0x2A8
		::System::Boolean isUnfold; // 0x2B0
		...
		::Class_2_08E43914789BE5F3* babelTowerModel; // 0x2C8
