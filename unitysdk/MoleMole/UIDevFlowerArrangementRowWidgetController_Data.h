...
#define MOLEMOLE_UIDEVFLOWERARRANGEMENTROWWIDGETCONTROLLER_DATA_GET_FLOWERFEATUREDATA_OFFSET UNITYSDK_OFFSET(0xA918010)
#define MOLEMOLE_UIDEVFLOWERARRANGEMENTROWWIDGETCONTROLLER_DATA_SET_FLOWERFEATUREDATA_OFFSET UNITYSDK_OFFSET(0xA918020)
#define MOLEMOLE_UIDEVFLOWERARRANGEMENTROWWIDGETCONTROLLER_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA918030)

namespace MoleMole
{
	inline static constexpr unsigned int UIDevFlowerArrangementRowWidgetController_Data_TypeDefinitionIndex = 39153;
