...
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_SETACTIVEDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA72CCC0)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_SETACTIVEDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA72CD50)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_SETACTIVEDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0xA72C9A0)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_SETACTIVEDEL__CTOR_OFFSET UNITYSDK_OFFSET(0xA72C990)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoSkillChildWindowController_SubViewDefine_SetActiveDel_TypeDefinitionIndex = 49312;
