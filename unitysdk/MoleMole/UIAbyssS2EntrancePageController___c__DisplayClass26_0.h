...
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___C__DISPLAYCLASS26_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD1B8E00)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___C__DISPLAYCLASS26_0__TRYPLAYANIM_B__0_OFFSET UNITYSDK_OFFSET(0xD1B8E10)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2EntrancePageController___c__DisplayClass26_0_TypeDefinitionIndex = 69598;
	...
	public:
		...
		::System::Int32 reminderID; // 0x2C
		::System::Int32 reqPointLimitNum; // 0x30
