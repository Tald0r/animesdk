...
#define MOLEMOLE_ANISOTROPICSAMPLINGPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x62104C0)

namespace MoleMole
{
	inline static constexpr unsigned int AnisotropicSamplingProfileContext_TypeDefinitionIndex = 44944;
