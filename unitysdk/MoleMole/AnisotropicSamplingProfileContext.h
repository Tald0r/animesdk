...
#define MOLEMOLE_ANISOTROPICSAMPLINGPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x84E3E70)

namespace MoleMole
{
	inline static constexpr unsigned int AnisotropicSamplingProfileContext_TypeDefinitionIndex = 73590;
