...
#define MOLEMOLE_EXPEDITIONAREANAVCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x7569C00)

namespace MoleMole
{
	inline static constexpr unsigned int ExpeditionAreaNavConfig_TypeDefinitionIndex = 80957;
