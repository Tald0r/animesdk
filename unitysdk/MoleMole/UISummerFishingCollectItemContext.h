...
#define MOLEMOLE_UISUMMERFISHINGCOLLECTITEMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA750D00)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishingCollectItemContext_TypeDefinitionIndex = 44136;
