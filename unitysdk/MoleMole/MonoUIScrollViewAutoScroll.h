...
#define MOLEMOLE_MONOUISCROLLVIEWAUTOSCROLL_AWAKE_OFFSET UNITYSDK_OFFSET(0x7F1D700)
#define MOLEMOLE_MONOUISCROLLVIEWAUTOSCROLL_BEGINSCROLL_OFFSET UNITYSDK_OFFSET(0x7F1D940)
#define MOLEMOLE_MONOUISCROLLVIEWAUTOSCROLL_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x7F1D810)
#define MOLEMOLE_MONOUISCROLLVIEWAUTOSCROLL_STOPSUBTITLESSCROLL_OFFSET UNITYSDK_OFFSET(0x7F1D8D0)
#define MOLEMOLE_MONOUISCROLLVIEWAUTOSCROLL_UPDATE_OFFSET UNITYSDK_OFFSET(0x7F1DB30)
#define MOLEMOLE_MONOUISCROLLVIEWAUTOSCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x7F1DE90)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIScrollViewAutoScroll_TypeDefinitionIndex = 52791;
