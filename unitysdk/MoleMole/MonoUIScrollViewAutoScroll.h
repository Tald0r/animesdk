...
#define MOLEMOLE_MONOUISCROLLVIEWAUTOSCROLL_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD68340)
#define MOLEMOLE_MONOUISCROLLVIEWAUTOSCROLL_BEGINSCROLL_OFFSET UNITYSDK_OFFSET(0xCD68580)
#define MOLEMOLE_MONOUISCROLLVIEWAUTOSCROLL_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xCD68450)
#define MOLEMOLE_MONOUISCROLLVIEWAUTOSCROLL_STOPSUBTITLESSCROLL_OFFSET UNITYSDK_OFFSET(0xCD68510)
#define MOLEMOLE_MONOUISCROLLVIEWAUTOSCROLL_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD68770)
#define MOLEMOLE_MONOUISCROLLVIEWAUTOSCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0xCD68AD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIScrollViewAutoScroll_TypeDefinitionIndex = 70321;
