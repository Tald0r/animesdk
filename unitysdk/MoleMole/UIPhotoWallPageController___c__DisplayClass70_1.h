...
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS70_1__CTOR_OFFSET UNITYSDK_OFFSET(0xBE7DB40)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___C__DISPLAYCLASS70_1__ONCLICKLEFTCALLBACK_B__1_OFFSET UNITYSDK_OFFSET(0xBE7DB50)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWallPageController___c__DisplayClass70_1_TypeDefinitionIndex = 36589;
