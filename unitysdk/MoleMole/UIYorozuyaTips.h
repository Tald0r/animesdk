...
#define MOLEMOLE_UIYOROZUYATIPS_GET_LOOPBROADCAST_OFFSET UNITYSDK_OFFSET(0x7557030)
#define MOLEMOLE_UIYOROZUYATIPS_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x7557150)
#define MOLEMOLE_UIYOROZUYATIPS__CTOR_OFFSET UNITYSDK_OFFSET(0x75570D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaTips_TypeDefinitionIndex = 48663;

	class UIYorozuyaTips : public ::MoleMole::TipShowObj
	{
	public:
		::Class_2_208CC9941471731A_838* template_; // 0x30
