...
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCB4BC30)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER___C__DISPLAYCLASS3_0__SETURL_B__0_OFFSET UNITYSDK_OFFSET(0xCB4BC40)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER___C__DISPLAYCLASS3_0__SETURL_B__1_OFFSET UNITYSDK_OFFSET(0xCB4BD50)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralClickToProceed02WidgetController___c__DisplayClass3_0_TypeDefinitionIndex = 39469;
