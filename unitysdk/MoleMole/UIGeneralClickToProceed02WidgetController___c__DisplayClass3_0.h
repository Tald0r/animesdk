...
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCAC5820)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER___C__DISPLAYCLASS3_0__SETURL_B__0_OFFSET UNITYSDK_OFFSET(0xCAC5830)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER___C__DISPLAYCLASS3_0__SETURL_B__1_OFFSET UNITYSDK_OFFSET(0xCAC5940)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralClickToProceed02WidgetController___c__DisplayClass3_0_TypeDefinitionIndex = 63216;
