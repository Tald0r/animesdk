...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS22_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9E7C660)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS22_0__INITLEVEL_B__2_OFFSET UNITYSDK_OFFSET(0x9E7C670)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController___c__DisplayClass22_0_TypeDefinitionIndex = 71464;
	...
	public:
		...
		::MoleMole::UIMainStoryRow03ChildWindowController* ctrl; // 0x18
