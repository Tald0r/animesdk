...
#define MOLEMOLE_MONOMODELTOWBONESCAPSULE_GET_FLAG_OFFSET UNITYSDK_OFFSET(0x993C700)
#define MOLEMOLE_MONOMODELTOWBONESCAPSULE_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0x993C2C0)
#define MOLEMOLE_MONOMODELTOWBONESCAPSULE__CTOR_OFFSET UNITYSDK_OFFSET(0x993C710)

namespace MoleMole
{
	inline static constexpr unsigned int MonoModelTowBonesCapsule_TypeDefinitionIndex = 44328;
