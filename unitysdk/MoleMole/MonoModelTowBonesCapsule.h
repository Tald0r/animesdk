...
#define MOLEMOLE_MONOMODELTOWBONESCAPSULE_GET_FLAG_OFFSET UNITYSDK_OFFSET(0xC7CF7D0)
#define MOLEMOLE_MONOMODELTOWBONESCAPSULE_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0xC7CF390)
#define MOLEMOLE_MONOMODELTOWBONESCAPSULE__CTOR_OFFSET UNITYSDK_OFFSET(0xC7CF7E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoModelTowBonesCapsule_TypeDefinitionIndex = 67059;
