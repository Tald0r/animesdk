...
#define MOLEMOLE_UIGENERALINTERACTINGCONTAINERCONTROLLER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8A14B50)
#define MOLEMOLE_UIGENERALINTERACTINGCONTAINERCONTROLLER___C__DISPLAYCLASS16_0__DOINTERACT_B__0_OFFSET UNITYSDK_OFFSET(0x8A14B60)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralInteractingContainerController___c__DisplayClass16_0_TypeDefinitionIndex = 54381;
