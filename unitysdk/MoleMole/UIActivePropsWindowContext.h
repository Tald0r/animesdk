...
#define MOLEMOLE_UIACTIVEPROPSWINDOWCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC80D660)
#define MOLEMOLE_UIACTIVEPROPSWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC80D630)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivePropsWindowContext_TypeDefinitionIndex = 37396;
	...
	public:
		...
		::Il2CppArray<::Enum_3_3A1DCD22526CC6D0>* sortTypes; // 0x38
		::System::Func_2<::System::Int32, ::System::Boolean>* buddyLockCheckFunc; // 0x40
		::Il2CppArray<::System::Int32>* multiBuddySelects; // 0x48
		::System::Collections::Generic::HashSet_1<::System::Int32>* whitelist; // 0x50
		::System::Collections::Generic::List_1<::System::Int32>* hideBuddy; // 0x58
		...
		::System::Collections::Generic::List_1<::System::Int32>* InsertBuddys; // 0x78
		::System::Func_2<::System::Int32, ::System::ValueTuple_2<::System::Boolean, ::System::String*>>* CheckCustomSelectStr; // 0x80
		::Il2CppArray<::Enum_3_3A1DCD22526CC6D0>* highPrioritySortTypes; // 0x88
		::Enum_3_32F22BA3DADD2A84 ShowBuddyMode; // 0x90
		::System::Int32 GachaID; // 0x94
		::Enum_3_F4E08D0E9B554572 SelectType; // 0x98
		::System::Int32 GachaOptionalSelectItemID; // 0x9C
		::System::Int32 OpenSelectBuddyID; // 0xA0
		::System::Boolean IsPreview; // 0xA4
		::System::Boolean IsGachaOptionalSelect; // 0xA5
		::System::Boolean selectIsEmpty; // 0xA6
