...
class Class_2_36A75844930847DF;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD3DC320)
#define MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAA5D420)
#define MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAA5D7F0)
#define MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAA5D660)
#define MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAA5D520)
#define MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xAA5DA20)
#define MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0xAA5DB40)
#define MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAA5D960)
#define MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAA5DBA0)
#define MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAA5DBD0)
#define MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAA5DC40)
#define MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAA5DCA0)
#define MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAA5DD10)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishingRodWidgetController_TypeDefinitionIndex = 49454;
	...
	public:
		...
		::Class_2_36A75844930847DF* get__viewModel()
		{
			return ((::Class_2_36A75844930847DF*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISUMMERFISHINGRODWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
