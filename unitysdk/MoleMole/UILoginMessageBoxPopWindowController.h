...
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_BTNCONFIRMACTION_OFFSET UNITYSDK_OFFSET(0x86FE190)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_BTNCONFIRM_OFFSET UNITYSDK_OFFSET(0x86FE220)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x86FC050)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_GET_ISFORCEIGNORESDKPANEL_OFFSET UNITYSDK_OFFSET(0x86FC070)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x86FC060)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_HIDECANCEL_OFFSET UNITYSDK_OFFSET(0x86FDF50)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_HIDECONFIRM_OFFSET UNITYSDK_OFFSET(0x86FDFE0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x86FC970)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x86FC5F0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x86FC8C0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x86FC720)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x86FC690)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x86FC080)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETCANCELBTNTEXT_OFFSET UNITYSDK_OFFSET(0x86FDB00)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETCANCELINTERACT_OFFSET UNITYSDK_OFFSET(0x86FE070)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETCONFIRMINTERACT_OFFSET UNITYSDK_OFFSET(0x86FE100)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETOKBTN_OFFSET UNITYSDK_OFFSET(0x86FD870)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETTITLECONTENTTEXT_OFFSET UNITYSDK_OFFSET(0x86FDD90)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SHOWERRORCODE_OFFSET UNITYSDK_OFFSET(0x86FCB50)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SHOWMESSAGEBOX_OFFSET UNITYSDK_OFFSET(0x86FCEE0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x86FE310)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER__ONUIINIT_B__10_0_OFFSET UNITYSDK_OFFSET(0x86FE320)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER__ONUIINIT_B__10_1_OFFSET UNITYSDK_OFFSET(0x86FE340)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x86FE360)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x86FE3D0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x86FE440)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x86FE470)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x86FE480)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x86FE490)

namespace MoleMole
{
	inline static constexpr unsigned int UILoginMessageBoxPopWindowController_TypeDefinitionIndex = 59624;

	class UILoginMessageBoxPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_124* _view; // 0x2F8
		::System::Action* okBtnCb; // 0x300
		::System::Action* cancelBtnCb; // 0x308
		::System::Boolean _isClicked; // 0x310
