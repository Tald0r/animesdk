...
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_BTNCONFIRMACTION_OFFSET UNITYSDK_OFFSET(0x9AA1590)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_BTNCONFIRM_OFFSET UNITYSDK_OFFSET(0x9AA1620)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x9A9F440)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_GET_ISFORCEIGNORESDKPANEL_OFFSET UNITYSDK_OFFSET(0x9A9F460)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9A9F450)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_HIDECANCEL_OFFSET UNITYSDK_OFFSET(0x9AA1350)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_HIDECONFIRM_OFFSET UNITYSDK_OFFSET(0x9AA13E0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x9A9FD60)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A9F9E0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9A9FCB0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9A9FB10)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A9FA80)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9A9F470)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETCANCELBTNTEXT_OFFSET UNITYSDK_OFFSET(0x9AA0EF0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETCANCELINTERACT_OFFSET UNITYSDK_OFFSET(0x9AA1470)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETCONFIRMINTERACT_OFFSET UNITYSDK_OFFSET(0x9AA1500)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETOKBTN_OFFSET UNITYSDK_OFFSET(0x9AA0C60)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SETTITLECONTENTTEXT_OFFSET UNITYSDK_OFFSET(0x9AA1180)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SHOWERRORCODE_OFFSET UNITYSDK_OFFSET(0x9A9FF40)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER_SHOWMESSAGEBOX_OFFSET UNITYSDK_OFFSET(0x9AA02D0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA1710)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER__ONUIINIT_B__10_0_OFFSET UNITYSDK_OFFSET(0x9AA1720)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER__ONUIINIT_B__10_1_OFFSET UNITYSDK_OFFSET(0x9AA1740)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x9AA1760)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9AA17D0)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9AA1840)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9AA1870)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9AA1880)
#define MOLEMOLE_UILOGINMESSAGEBOXPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9AA1890)

namespace MoleMole
{
	inline static constexpr unsigned int UILoginMessageBoxPopWindowController_TypeDefinitionIndex = 79875;
