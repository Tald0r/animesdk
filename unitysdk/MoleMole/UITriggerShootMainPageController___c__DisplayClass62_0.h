...
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___C__DISPLAYCLASS62_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCA83220)
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER___C__DISPLAYCLASS62_0__ONCOMBOCHANGE_B__0_OFFSET UNITYSDK_OFFSET(0xCA83230)

namespace MoleMole
{
	inline static constexpr unsigned int UITriggerShootMainPageController___c__DisplayClass62_0_TypeDefinitionIndex = 46536;
