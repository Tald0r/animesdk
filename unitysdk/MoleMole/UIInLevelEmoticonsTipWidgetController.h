...
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER_ENABLEINPUT_OFFSET UNITYSDK_OFFSET(0xBD1EEF0)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER_INITSELECTINDEXONSHOW_OFFSET UNITYSDK_OFFSET(0xBD1F3B0)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER_ONCLICKSELECTITEM_OFFSET UNITYSDK_OFFSET(0xBD1F820)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD1F410)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBD1EFB0)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD1F740)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD1E7D0)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD1EE40)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER_REFRESHBUTTONCDVIEW_OFFSET UNITYSDK_OFFSET(0xBD1F520)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBD1F080)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER_SETONCLICKBUTTON_OFFSET UNITYSDK_OFFSET(0xBD1F4B0)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBD1F8D0)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD1F9A0)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBD1FA10)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD1FA80)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD1FB00)
#define MOLEMOLE_UIINLEVELEMOTICONSTIPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD1FB60)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelEmoticonsTipWidgetController_TypeDefinitionIndex = 74860;
	...
	public:
		...
		::Class_2_68A5E7EF823C92F4_1* _view; // 0x2A0
		::System::Action_1<::System::Int32>* _onClickButton; // 0x2A8
		::System::Collections::Generic::List_1<::Class_1_82297B6AFFE49354_1*>* _emoticonsIdList; // 0x2B0
