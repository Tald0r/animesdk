...
#define MOLEMOLE_UIACTIVITYFIGHTUI_REWARDGROUP_MAINPAGECONTROLLER_REWARDGROUP_MAINCONTEXT_GET_FOCUSTABINDEX_OFFSET UNITYSDK_OFFSET(0xDC33A40)
#define MOLEMOLE_UIACTIVITYFIGHTUI_REWARDGROUP_MAINPAGECONTROLLER_REWARDGROUP_MAINCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xDC33AB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityFightUI_RewardGroup_MainPageController_RewardGroup_MainContext_TypeDefinitionIndex = 59841;

	class UIActivityFightUI_RewardGroup_MainPageController_RewardGroup_MainContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::String* LeftTabName; // 0x28
		::System::String* RightTabName; // 0x30
		::System::String* PopularityRes; // 0x38
		::System::Action* OnClickPopularityGetInfo; // 0x40
		::System::Int32 CurrencyItemID; // 0x48
		::System::Int32 PopularityNowNum; // 0x4C
		::System::Int32 GeneralDetailDialogID; // 0x50
		::System::Int32 FocusGroup; // 0x54
		::System::Int32 PopularityItemMaxNum; // 0x58
