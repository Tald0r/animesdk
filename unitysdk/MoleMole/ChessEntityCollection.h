...
#define MOLEMOLE_CHESSENTITYCOLLECTION_ADDENTITY_OFFSET UNITYSDK_OFFSET(0x15E9AF30)
#define MOLEMOLE_CHESSENTITYCOLLECTION_COUNT_OFFSET UNITYSDK_OFFSET(0x15E9B6C0)
#define MOLEMOLE_CHESSENTITYCOLLECTION_GETCOUNTINNER_OFFSET UNITYSDK_OFFSET(0x15E9B530)
#define MOLEMOLE_CHESSENTITYCOLLECTION_GETENTITY_OFFSET UNITYSDK_OFFSET(0x15E9B220)
#define MOLEMOLE_CHESSENTITYCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x15E9B730)
#define MOLEMOLE_CHESSENTITYCOLLECTION_GETVALUE_OFFSET UNITYSDK_OFFSET(0x15E9B3D0)
#define MOLEMOLE_CHESSENTITYCOLLECTION_GET_TOREMOVECHESSENTITY_OFFSET UNITYSDK_OFFSET(0x15E9AE30)
#define MOLEMOLE_CHESSENTITYCOLLECTION_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x15E9B4C0)
#define MOLEMOLE_CHESSENTITYCOLLECTION_REMOVEENTITY_OFFSET UNITYSDK_OFFSET(0x15E9B0C0)
#define MOLEMOLE_CHESSENTITYCOLLECTION_SETMODIFY_OFFSET UNITYSDK_OFFSET(0x15E9B810)
#define MOLEMOLE_CHESSENTITYCOLLECTION_SETVALUE_OFFSET UNITYSDK_OFFSET(0x15E9B440)
#define MOLEMOLE_CHESSENTITYCOLLECTION_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x15E9B880)
#define MOLEMOLE_CHESSENTITYCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x15E9B8F0)

namespace MoleMole
{
	inline static constexpr unsigned int ChessEntityCollection_TypeDefinitionIndex = 38523;
	...
	public:
		...
		::Class_0_16E4307DCC419505_214* _modify; // 0x28
		...
		::System::Void SetModify(::Class_0_16E4307DCC419505_214* modify)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_214*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSENTITYCOLLECTION_SETMODIFY_OFFSET))(this, modify);
		}
