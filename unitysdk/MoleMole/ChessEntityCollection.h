...
#define MOLEMOLE_CHESSENTITYCOLLECTION_ADDENTITY_OFFSET UNITYSDK_OFFSET(0xE2ACD80)
#define MOLEMOLE_CHESSENTITYCOLLECTION_COUNT_OFFSET UNITYSDK_OFFSET(0xE2AD500)
#define MOLEMOLE_CHESSENTITYCOLLECTION_GETCOUNTINNER_OFFSET UNITYSDK_OFFSET(0xE2AD370)
#define MOLEMOLE_CHESSENTITYCOLLECTION_GETENTITY_OFFSET UNITYSDK_OFFSET(0xE2AD060)
#define MOLEMOLE_CHESSENTITYCOLLECTION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xE2AD570)
#define MOLEMOLE_CHESSENTITYCOLLECTION_GETVALUE_OFFSET UNITYSDK_OFFSET(0xE2AD210)
#define MOLEMOLE_CHESSENTITYCOLLECTION_GET_TOREMOVECHESSENTITY_OFFSET UNITYSDK_OFFSET(0xE2ACC80)
#define MOLEMOLE_CHESSENTITYCOLLECTION_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xE2AD300)
#define MOLEMOLE_CHESSENTITYCOLLECTION_REMOVEENTITY_OFFSET UNITYSDK_OFFSET(0xE2ACF10)
#define MOLEMOLE_CHESSENTITYCOLLECTION_SETMODIFY_OFFSET UNITYSDK_OFFSET(0xE2AD650)
#define MOLEMOLE_CHESSENTITYCOLLECTION_SETVALUE_OFFSET UNITYSDK_OFFSET(0xE2AD280)
#define MOLEMOLE_CHESSENTITYCOLLECTION_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xE2AD6C0)
#define MOLEMOLE_CHESSENTITYCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xE2AD730)

namespace MoleMole
{
	inline static constexpr unsigned int ChessEntityCollection_TypeDefinitionIndex = 44551;
	...
	public:
		...
		::Class_0_16E4307DCC419505_312* _modify; // 0x28
		...
		::System::Void SetModify(::Class_0_16E4307DCC419505_312* modify)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_312*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSENTITYCOLLECTION_SETMODIFY_OFFSET))(this, modify);
		}
