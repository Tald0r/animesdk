...
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x69ACE20)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x69ACE10)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x69ACFD0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x69AD040)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x69AD620)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_SETCANVASDIRTY_OFFSET UNITYSDK_OFFSET(0x69AD760)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x69ACE30)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x69AD7D0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER__ONUIOPEN_B__6_0_OFFSET UNITYSDK_OFFSET(0x69AD7E0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER__ONUIOPEN_B__6_1_OFFSET UNITYSDK_OFFSET(0x69AD850)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x69AD8C0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x69AD930)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorldContainerController_TypeDefinitionIndex = 39971;
