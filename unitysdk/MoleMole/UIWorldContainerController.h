...
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0xA1385C0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA1385B0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA138770)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA1387E0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA138DB0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_SETCANVASDIRTY_OFFSET UNITYSDK_OFFSET(0xA138EF0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xA1385D0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA138F60)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER__ONUIOPEN_B__6_0_OFFSET UNITYSDK_OFFSET(0xA138F70)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER__ONUIOPEN_B__6_1_OFFSET UNITYSDK_OFFSET(0xA138FE0)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA139050)
#define MOLEMOLE_UIWORLDCONTAINERCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xA1390C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorldContainerController_TypeDefinitionIndex = 47649;

	class UIWorldContainerController : public ::MoleMole::UIWindowController
	{
	public:
		::System::Boolean _isDirty; // 0x2F8
		::UnityEngine::Vector3 _lastCameraPos; // 0x2FC
