...
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD1BB9A0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER___C__DISPLAYCLASS18_0__SENDREFRESHMAPREQ_B__0_OFFSET UNITYSDK_OFFSET(0xD1BB9B0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER___C__DISPLAYCLASS18_0__SENDREFRESHMAPREQ_B__1_OFFSET UNITYSDK_OFFSET(0xD1BBA60)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapRefreshPageController___c__DisplayClass18_0_TypeDefinitionIndex = 65194;
