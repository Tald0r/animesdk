...
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER_BINDBUTTON_OFFSET UNITYSDK_OFFSET(0xA83B930)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER_BINDDATA_OFFSET UNITYSDK_OFFSET(0xA83B730)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0xA83C4B0)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER_BUILDFAKEDATA_OFFSET UNITYSDK_OFFSET(0xA83BFD0)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0xA83B990)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER_CREATESUBWIDGET_OFFSET UNITYSDK_OFFSET(0xA83C030)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA83B5C0)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA83C5D0)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA83B5D0)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA83C540)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA83B670)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA83BBC0)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER__BUILDVIEWMODELDATABINDING_B__13_0_OFFSET UNITYSDK_OFFSET(0xA83C7F0)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER__BUILDVIEWMODELDATABINDING_B__13_1_OFFSET UNITYSDK_OFFSET(0xA83C810)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA83C6B0)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA83C830)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA83C890)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA83C900)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA83C910)
#define MOLEMOLE_UIMINISCAPEMAPPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA83C920)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeMapPageController_TypeDefinitionIndex = 50707;
