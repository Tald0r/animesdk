...
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER_CHESSBOARDBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x97F7800)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboard3DModelController_ChessboardBehavior_TypeDefinitionIndex = 42985;

	class UIHollowChessboard3DModelController_ChessboardBehavior : public ::System::Object
	{
	public:
		::System::Action_1<::Class_1_3E8AD0E270DD5616*>* handler; // 0x10
		::Class_1_3E8AD0E270DD5616* args; // 0x18
