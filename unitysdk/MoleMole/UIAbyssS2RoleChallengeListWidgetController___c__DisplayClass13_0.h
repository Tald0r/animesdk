...
#define MOLEMOLE_UIABYSSS2ROLECHALLENGELISTWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBD7E3D0)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGELISTWIDGETCONTROLLER___C__DISPLAYCLASS13_0__INITDATA_B__0_OFFSET UNITYSDK_OFFSET(0xBD7E3E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RoleChallengeListWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 67800;
