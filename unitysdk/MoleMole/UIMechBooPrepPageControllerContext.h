...
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8ECF700)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooPrepPageControllerContext_TypeDefinitionIndex = 77480;
