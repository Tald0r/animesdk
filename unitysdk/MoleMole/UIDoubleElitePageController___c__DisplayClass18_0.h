...
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD11EDB0)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__0_OFFSET UNITYSDK_OFFSET(0xD11EDC0)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__1_OFFSET UNITYSDK_OFFSET(0xD11EEC0)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__2_OFFSET UNITYSDK_OFFSET(0xD11F070)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__3_OFFSET UNITYSDK_OFFSET(0xD11F090)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__5_OFFSET UNITYSDK_OFFSET(0xD11F0B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleElitePageController___c__DisplayClass18_0_TypeDefinitionIndex = 64075;
