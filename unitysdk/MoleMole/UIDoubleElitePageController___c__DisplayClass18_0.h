...
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA354DE0)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__0_OFFSET UNITYSDK_OFFSET(0xA354DF0)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__1_OFFSET UNITYSDK_OFFSET(0xA354EF0)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__2_OFFSET UNITYSDK_OFFSET(0xA3550A0)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__3_OFFSET UNITYSDK_OFFSET(0xA3550C0)
#define MOLEMOLE_UIDOUBLEELITEPAGECONTROLLER___C__DISPLAYCLASS18_0__ONUIOPEN_B__5_OFFSET UNITYSDK_OFFSET(0xA3550E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleElitePageController___c__DisplayClass18_0_TypeDefinitionIndex = 73358;
