...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS22_2__CTOR_OFFSET UNITYSDK_OFFSET(0xB6A5620)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS22_2__INITLEVEL_B__3_OFFSET UNITYSDK_OFFSET(0xB6A5630)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS22_2__INITLEVEL_B__4_OFFSET UNITYSDK_OFFSET(0xB6A5690)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController___c__DisplayClass22_2_TypeDefinitionIndex = 40403;
