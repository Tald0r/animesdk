...
#define MOLEMOLE_COMMANDLINEANISOTROPICSAMPLING_METHOD_2_ABACFB27553ACD1B_OFFSET UNITYSDK_OFFSET(0x6FC0B50)
#define MOLEMOLE_COMMANDLINEANISOTROPICSAMPLING_METHOD_2_E6607C8AAE89B36D_OFFSET UNITYSDK_OFFSET(0x6FC0C90)
#define MOLEMOLE_COMMANDLINEANISOTROPICSAMPLING__CTOR_OFFSET UNITYSDK_OFFSET(0x6FC0C50)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineAnisotropicSampling_TypeDefinitionIndex = 37989;
