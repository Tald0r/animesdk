...
#define MOLEMOLE_CUSTOMDAMPERUTILITY_CRITICAL_FREQUENCY_OFFSET UNITYSDK_OFFSET(0xACE24D0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_CRITICAL_HALFLIFE_OFFSET UNITYSDK_OFFSET(0xACE22A0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_1_OFFSET UNITYSDK_OFFSET(0xACE0C60)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_OFFSET UNITYSDK_OFFSET(0xACE0A30)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_CRITICAL_NOGOALSPEED_1_OFFSET UNITYSDK_OFFSET(0xACE1D80)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_CRITICAL_NOGOALSPEED_OFFSET UNITYSDK_OFFSET(0xACE1B40)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_CRITICAL_OFFSET UNITYSDK_OFFSET(0xACE18D0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_OFFSET UNITYSDK_OFFSET(0xACE0EB0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPING_TO_HALFLIFE_OFFSET UNITYSDK_OFFSET(0xACE2450)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DOUBLE_SPRING_DAMPER_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0xACE21A0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DOUBLE_SPRING_DAMPER_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xACE2070)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_FAST_NEGEXP_OFFSET UNITYSDK_OFFSET(0xACE0BB0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_FREQUENCY_TO_STIFFNESS_OFFSET UNITYSDK_OFFSET(0xACE1790)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_HALFLIFE_TO_DAMPING_OFFSET UNITYSDK_OFFSET(0xACE1850)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_SQUAREF_OFFSET UNITYSDK_OFFSET(0xACE0E40)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_STIFFNESS_TO_FREQUENCY_OFFSET UNITYSDK_OFFSET(0xACE26C0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0xACE2750)

namespace MoleMole
{
	inline static constexpr unsigned int CustomDamperUtility_TypeDefinitionIndex = 43026;
