...
#define MOLEMOLE_CUSTOMDAMPERUTILITY_CRITICAL_FREQUENCY_OFFSET UNITYSDK_OFFSET(0xCCB35E0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_CRITICAL_HALFLIFE_OFFSET UNITYSDK_OFFSET(0xCCB33B0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_1_OFFSET UNITYSDK_OFFSET(0xCCB1D70)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_OFFSET UNITYSDK_OFFSET(0xCCB1B40)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_CRITICAL_NOGOALSPEED_1_OFFSET UNITYSDK_OFFSET(0xCCB2E90)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_CRITICAL_NOGOALSPEED_OFFSET UNITYSDK_OFFSET(0xCCB2C50)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_CRITICAL_OFFSET UNITYSDK_OFFSET(0xCCB29E0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPER_SPRING_OFFSET UNITYSDK_OFFSET(0xCCB1FC0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DAMPING_TO_HALFLIFE_OFFSET UNITYSDK_OFFSET(0xCCB3560)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DOUBLE_SPRING_DAMPER_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0xCCB32B0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_DOUBLE_SPRING_DAMPER_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xCCB3180)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_FAST_NEGEXP_OFFSET UNITYSDK_OFFSET(0xCCB1CC0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_FREQUENCY_TO_STIFFNESS_OFFSET UNITYSDK_OFFSET(0xCCB28A0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_HALFLIFE_TO_DAMPING_OFFSET UNITYSDK_OFFSET(0xCCB2960)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_SQUAREF_OFFSET UNITYSDK_OFFSET(0xCCB1F50)
#define MOLEMOLE_CUSTOMDAMPERUTILITY_STIFFNESS_TO_FREQUENCY_OFFSET UNITYSDK_OFFSET(0xCCB37D0)
#define MOLEMOLE_CUSTOMDAMPERUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0xCCB3860)

namespace MoleMole
{
	inline static constexpr unsigned int CustomDamperUtility_TypeDefinitionIndex = 65988;
