...
#define MOLEMOLE_UIABYSSENTRANCEPAGECONTROLLER___C__DISPLAYCLASS46_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBF0E1E0)
#define MOLEMOLE_UIABYSSENTRANCEPAGECONTROLLER___C__DISPLAYCLASS46_0__SHOWENDTIMETIP_UNITASK_B__0_OFFSET UNITYSDK_OFFSET(0xBF0E1F0)
#define MOLEMOLE_UIABYSSENTRANCEPAGECONTROLLER___C__DISPLAYCLASS46_0__SHOWENDTIMETIP_UNITASK_B__1_OFFSET UNITYSDK_OFFSET(0xBF0E450)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssEntrancePageController___c__DisplayClass46_0_TypeDefinitionIndex = 49416;
