...
class Class_2_BFE1A5062E431B57;
...
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_ANIMATIONFINISH_OFFSET UNITYSDK_OFFSET(0xA3FB040)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xA3FB490)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_GETCANVASINFO_OFFSET UNITYSDK_OFFSET(0xA3FB0E0)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_GETFADEININFO_OFFSET UNITYSDK_OFFSET(0xA3FAFA0)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA3FA0D0)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_INITUIANIMATION_OFFSET UNITYSDK_OFFSET(0xA3FA4E0)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA3FA150)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA3FA670)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA3FB3B0)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA3FB420)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA3FA0E0)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA3FB300)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0xA3FAD90)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_SETAVATARID_OFFSET UNITYSDK_OFFSET(0xA3FA990)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_SETCOMPLETEACT_OFFSET UNITYSDK_OFFSET(0xA3FA8B0)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_SETELEMENTCOLOR_OFFSET UNITYSDK_OFFSET(0xA3FAA60)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_SETMIRRORX_OFFSET UNITYSDK_OFFSET(0xA3FAE00)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_SETUISTOPACT_OFFSET UNITYSDK_OFFSET(0xA3FA920)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xA3FA710)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3FBAB0)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA3FBAC0)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA3FBB30)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA3FBB40)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA3FBB50)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA3FBB60)
#define MOLEMOLE_UIROLESELECTFADEINCHILDWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xA3FBBD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectFadeInChildWindowController_TypeDefinitionIndex = 40093;
	...
	public:
		...
		::Class_2_BFE1A5062E431B57* _view; // 0x300
