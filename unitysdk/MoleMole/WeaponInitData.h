...
#define MOLEMOLE_WEAPONINITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAA96940)

namespace MoleMole
{
	inline static constexpr unsigned int WeaponInitData_TypeDefinitionIndex = 38108;

	class WeaponInitData : public ::System::Object
	{
	public:
		::System::Int32 weaponRefineLevel; // 0x10
