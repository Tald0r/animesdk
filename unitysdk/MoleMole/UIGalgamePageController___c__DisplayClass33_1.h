...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_1__CTOR_OFFSET UNITYSDK_OFFSET(0xA361EC0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_1__PLAYSTORYNODE_B__8_OFFSET UNITYSDK_OFFSET(0xA361ED0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_1__PLAYSTORYNODE_B__9_OFFSET UNITYSDK_OFFSET(0xA361FB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass33_1_TypeDefinitionIndex = 54643;
