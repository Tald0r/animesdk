...
#define MOLEMOLE_BLADEILLUSIONNPCDISPLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCD908C0)

namespace MoleMole
{
	inline static constexpr unsigned int BladeIllusionNPCDisplayConfig_TypeDefinitionIndex = 56794;
