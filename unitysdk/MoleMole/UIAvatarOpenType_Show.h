...
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GETSETTINGTYPES_OFFSET UNITYSDK_OFFSET(0xE939890)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GETUIFROM_OFFSET UNITYSDK_OFFSET(0xE9392B0)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GETUISHOWSETTINGDROPDOWNVALUE_OFFSET UNITYSDK_OFFSET(0xE939970)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GETUISHOWSETTINGTYPENAME_OFFSET UNITYSDK_OFFSET(0xE9395C0)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GET_UIFROM_OFFSET UNITYSDK_OFFSET(0xE9390C0)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GET_UISHOWSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0xE9395B0)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_ONUIFROMVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xE939520)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_SET_UIFROM_OFFSET UNITYSDK_OFFSET(0xE939220)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_SET_UISHOWSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0xE9396B0)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW__CCTOR_OFFSET UNITYSDK_OFFSET(0xE939A50)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xE939A40)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarOpenType_Show_TypeDefinitionIndex = 38402;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIAvatarOpenType_Show_TypeDefinitionIndex)->GetStaticField(0x44310);
		}
