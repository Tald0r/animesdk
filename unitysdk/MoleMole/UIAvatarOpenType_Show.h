...
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GETSETTINGTYPES_OFFSET UNITYSDK_OFFSET(0xBF32920)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GETUIFROM_OFFSET UNITYSDK_OFFSET(0xBF32340)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GETUISHOWSETTINGDROPDOWNVALUE_OFFSET UNITYSDK_OFFSET(0xBF32A00)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GETUISHOWSETTINGTYPENAME_OFFSET UNITYSDK_OFFSET(0xBF32650)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GET_UIFROM_OFFSET UNITYSDK_OFFSET(0xBF32150)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_GET_UISHOWSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0xBF32640)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_ONUIFROMVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xBF325B0)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_SET_UIFROM_OFFSET UNITYSDK_OFFSET(0xBF322B0)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW_SET_UISHOWSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0xBF32740)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW__CCTOR_OFFSET UNITYSDK_OFFSET(0xBF32AE0)
#define MOLEMOLE_UIAVATAROPENTYPE_SHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xBF32AD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarOpenType_Show_TypeDefinitionIndex = 73593;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIAvatarOpenType_Show_TypeDefinitionIndex)->GetStaticField(0x44C70);
		}
		::System::String* UIFromName; // 0x20
		::System::Type* _UIFrom; // 0x28
