...
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xAA795C0)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAA78B50)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0xAA79B90)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAA78F20)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAA78E40)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHBG_OFFSET UNITYSDK_OFFSET(0xAA79150)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHDATAINFOLIST_OFFSET UNITYSDK_OFFSET(0xAA7B810)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHDATALOCKPROGRESS_OFFSET UNITYSDK_OFFSET(0xAA7AEA0)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0xAA7A3D0)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHLIST_OFFSET UNITYSDK_OFFSET(0xAA79630)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHTAB_OFFSET UNITYSDK_OFFSET(0xAA79200)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHVIRUSINFOLIST_OFFSET UNITYSDK_OFFSET(0xAA7AA60)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHVIRUS_OFFSET UNITYSDK_OFFSET(0xAA79D50)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHWIDGET_OFFSET UNITYSDK_OFFSET(0xAA790D0)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAA7B9A0)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAA7BA40)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAA7BAB0)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAA7BB20)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusCollectWidgetController_TypeDefinitionIndex = 42821;

	class UIVirusCollectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_42* _view; // 0x2A0
		::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317 _levelType; // 0x2A8
		...
		::System::Void RefreshWidget(::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317 levelType)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHWIDGET_OFFSET))(this, levelType);
		}

		::System::Void RefreshBg(::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317 levelType)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHBG_OFFSET))(this, levelType);
		}
