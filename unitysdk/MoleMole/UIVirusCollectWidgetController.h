...
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xEE52820)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xEE51DB0)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0xEE52DE0)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xEE52180)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xEE520A0)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHBG_OFFSET UNITYSDK_OFFSET(0xEE523B0)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHDATAINFOLIST_OFFSET UNITYSDK_OFFSET(0xEE54A70)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHDATALOCKPROGRESS_OFFSET UNITYSDK_OFFSET(0xEE54100)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0xEE53620)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHLIST_OFFSET UNITYSDK_OFFSET(0xEE52890)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHTAB_OFFSET UNITYSDK_OFFSET(0xEE52460)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHVIRUSINFOLIST_OFFSET UNITYSDK_OFFSET(0xEE53CB0)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHVIRUS_OFFSET UNITYSDK_OFFSET(0xEE52FA0)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHWIDGET_OFFSET UNITYSDK_OFFSET(0xEE52330)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xEE54C00)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xEE54CA0)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xEE54D10)
#define MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xEE54D80)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusCollectWidgetController_TypeDefinitionIndex = 47863;

	class UIVirusCollectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_29* _view; // 0x2A0
		::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 _levelType; // 0x2A8
		::System::Int32 _selectID; // 0x2AC
		::MoleMole::UIVirusCollectWidgetController_CollectTabType _tabType; // 0x2B0
		::System::Collections::Generic::List_1<::MoleMole::UIVirusSelectRowWidgetController_Data*>* _dataList; // 0x2B8
		...
		::System::Void RefreshWidget(::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 levelType)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHWIDGET_OFFSET))(this, levelType);
		}

		::System::Void RefreshBg(::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 levelType)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSCOLLECTWIDGETCONTROLLER_REFRESHBG_OFFSET))(this, levelType);
		}
