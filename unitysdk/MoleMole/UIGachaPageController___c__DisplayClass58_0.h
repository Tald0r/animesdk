...
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS58_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBF12A80)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS58_0__GACHA_B__1_OFFSET UNITYSDK_OFFSET(0xBF12C40)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS58_0__GACHA_G__QUICKBUYORGACHA_0_OFFSET UNITYSDK_OFFSET(0xBF12A90)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPageController___c__DisplayClass58_0_TypeDefinitionIndex = 39386;
