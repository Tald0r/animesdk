...
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS58_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA97A340)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS58_0__GACHA_B__1_OFFSET UNITYSDK_OFFSET(0xA97A500)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS58_0__GACHA_G__QUICKBUYORGACHA_0_OFFSET UNITYSDK_OFFSET(0xA97A350)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPageController___c__DisplayClass58_0_TypeDefinitionIndex = 55229;
