...
#define MOLEMOLE_MONOACTIVITYRESSETTING_TRYGETSETTINGCOLOR_OFFSET UNITYSDK_OFFSET(0x7A8B460)
#define MOLEMOLE_MONOACTIVITYRESSETTING_TRYGETSETTINGMATERIAL_OFFSET UNITYSDK_OFFSET(0x7A8B5A0)
#define MOLEMOLE_MONOACTIVITYRESSETTING_TRYSETCOLORGROUP_OFFSET UNITYSDK_OFFSET(0x7A8B710)
#define MOLEMOLE_MONOACTIVITYRESSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x7A8B980)

namespace MoleMole
{
	inline static constexpr unsigned int MonoActivityResSetting_TypeDefinitionIndex = 38970;
