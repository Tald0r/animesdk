...
#define MOLEMOLE_MONOACTIVITYRESSETTING_TRYGETSETTINGCOLOR_OFFSET UNITYSDK_OFFSET(0xA484720)
#define MOLEMOLE_MONOACTIVITYRESSETTING_TRYGETSETTINGMATERIAL_OFFSET UNITYSDK_OFFSET(0xA484860)
#define MOLEMOLE_MONOACTIVITYRESSETTING_TRYSETCOLORGROUP_OFFSET UNITYSDK_OFFSET(0xA4849D0)
#define MOLEMOLE_MONOACTIVITYRESSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xA484C40)

namespace MoleMole
{
	inline static constexpr unsigned int MonoActivityResSetting_TypeDefinitionIndex = 49782;
