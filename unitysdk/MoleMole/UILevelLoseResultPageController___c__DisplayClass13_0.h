...
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8A67F80)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___C__DISPLAYCLASS13_0__PLAYEXIT_B__0_OFFSET UNITYSDK_OFFSET(0x8A689B0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___C__DISPLAYCLASS13_0__PLAYEXIT_B__1_OFFSET UNITYSDK_OFFSET(0x8A689C0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelLoseResultPageController___c__DisplayClass13_0_TypeDefinitionIndex = 74808;
