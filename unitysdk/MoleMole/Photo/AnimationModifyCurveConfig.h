...
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0xA47CA10)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xA47C9F0)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0xA47D330)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA47D670)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationModifyCurveConfig_TypeDefinitionIndex = 77941;
