...
#define MOLEMOLE_PHOTO_ROTATIONCURVE_CREATE_OFFSET UNITYSDK_OFFSET(0x9941E10)
#define MOLEMOLE_PHOTO_ROTATIONCURVE_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x9942540)
#define MOLEMOLE_PHOTO_ROTATIONCURVE_REQUEST_OFFSET UNITYSDK_OFFSET(0x9942550)
#define MOLEMOLE_PHOTO_ROTATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x99426B0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int RotationCurve_TypeDefinitionIndex = 46697;
