...
#define MOLEMOLE_PHOTO_ROTATIONCURVE_CREATE_OFFSET UNITYSDK_OFFSET(0xC7D4AD0)
#define MOLEMOLE_PHOTO_ROTATIONCURVE_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xC7D5200)
#define MOLEMOLE_PHOTO_ROTATIONCURVE_REQUEST_OFFSET UNITYSDK_OFFSET(0xC7D5210)
#define MOLEMOLE_PHOTO_ROTATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC7D5370)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int RotationCurve_TypeDefinitionIndex = 44470;
