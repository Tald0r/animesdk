...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHCLIPCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0xD4422E0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHCLIPCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xD442460)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHCLIPCONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0xD442470)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHCLIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD442510)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphClipConfig_TypeDefinitionIndex = 76690;
