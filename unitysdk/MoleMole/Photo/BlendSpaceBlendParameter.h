...
#define MOLEMOLE_PHOTO_BLENDSPACEBLENDPARAMETER_GETNORMALIZED_OFFSET UNITYSDK_OFFSET(0x398080)
#define MOLEMOLE_PHOTO_BLENDSPACEBLENDPARAMETER_GETUNCLAMPNORMALIZED_OFFSET UNITYSDK_OFFSET(0x398090)
#define MOLEMOLE_PHOTO_BLENDSPACEBLENDPARAMETER_GET_MIN_OFFSET UNITYSDK_OFFSET(0x398250)
#define MOLEMOLE_PHOTO_BLENDSPACEBLENDPARAMETER_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x398260)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int BlendSpaceBlendParameter_TypeDefinitionIndex = 56959;
