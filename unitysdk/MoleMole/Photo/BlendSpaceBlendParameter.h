...
#define MOLEMOLE_PHOTO_BLENDSPACEBLENDPARAMETER_GETNORMALIZED_OFFSET UNITYSDK_OFFSET(0x38F420)
#define MOLEMOLE_PHOTO_BLENDSPACEBLENDPARAMETER_GETUNCLAMPNORMALIZED_OFFSET UNITYSDK_OFFSET(0x38F430)
#define MOLEMOLE_PHOTO_BLENDSPACEBLENDPARAMETER_GET_MIN_OFFSET UNITYSDK_OFFSET(0x38F5F0)
#define MOLEMOLE_PHOTO_BLENDSPACEBLENDPARAMETER_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x38F600)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int BlendSpaceBlendParameter_TypeDefinitionIndex = 45633;
