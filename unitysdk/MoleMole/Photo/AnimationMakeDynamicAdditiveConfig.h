...
#define MOLEMOLE_PHOTO_ANIMATIONMAKEDYNAMICADDITIVECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0xD441630)
#define MOLEMOLE_PHOTO_ANIMATIONMAKEDYNAMICADDITIVECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xD441620)
#define MOLEMOLE_PHOTO_ANIMATIONMAKEDYNAMICADDITIVECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0xD441790)
#define MOLEMOLE_PHOTO_ANIMATIONMAKEDYNAMICADDITIVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD441830)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationMakeDynamicAdditiveConfig_TypeDefinitionIndex = 62420;
