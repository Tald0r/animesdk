...
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG_BUILDPROPERTYHANDLES_OFFSET UNITYSDK_OFFSET(0x6B1A0A0)
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG_CREATEPLAYABLEUNIT_OFFSET UNITYSDK_OFFSET(0x6B19670)
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG_GETBLENDSHAPEPARAMCOUNT_OFFSET UNITYSDK_OFFSET(0x6B1B030)
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG_GETSKINNEDMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0x6B1ADA0)
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x6B19660)
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x6B1A4E0)
#define MOLEMOLE_PHOTO_PLAYABLEUNITBLENDSHAPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6B1B220)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableUnitBlendShapeConfig_TypeDefinitionIndex = 42785;
