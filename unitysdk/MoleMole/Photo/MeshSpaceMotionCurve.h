...
#define MOLEMOLE_PHOTO_MESHSPACEMOTIONCURVE_CREATE_OFFSET UNITYSDK_OFFSET(0xBD4A410)
#define MOLEMOLE_PHOTO_MESHSPACEMOTIONCURVE_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xBD4B080)
#define MOLEMOLE_PHOTO_MESHSPACEMOTIONCURVE_REQUEST_OFFSET UNITYSDK_OFFSET(0xBD4B100)
#define MOLEMOLE_PHOTO_MESHSPACEMOTIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xBD4B260)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int MeshSpaceMotionCurve_TypeDefinitionIndex = 71720;
