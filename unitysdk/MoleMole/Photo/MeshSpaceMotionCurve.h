...
#define MOLEMOLE_PHOTO_MESHSPACEMOTIONCURVE_CREATE_OFFSET UNITYSDK_OFFSET(0xB1BAE70)
#define MOLEMOLE_PHOTO_MESHSPACEMOTIONCURVE_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xB1BBAE0)
#define MOLEMOLE_PHOTO_MESHSPACEMOTIONCURVE_REQUEST_OFFSET UNITYSDK_OFFSET(0xB1BBB60)
#define MOLEMOLE_PHOTO_MESHSPACEMOTIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xB1BBCC0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int MeshSpaceMotionCurve_TypeDefinitionIndex = 48922;
