...
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x8F3B9E0)
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x8F3BE00)
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x8F3BE10)
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8F3BF00)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationApplyDynamicAdditiveConfig_TypeDefinitionIndex = 39127;
