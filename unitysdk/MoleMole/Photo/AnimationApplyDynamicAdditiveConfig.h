...
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x9851870)
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x9851C90)
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x9851CA0)
#define MOLEMOLE_PHOTO_ANIMATIONAPPLYDYNAMICADDITIVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9851D90)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationApplyDynamicAdditiveConfig_TypeDefinitionIndex = 50496;
