...
#define MOLEMOLE_PHOTO_REFERENCESKELETONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB2FC380)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int ReferenceSkeletonConfig_TypeDefinitionIndex = 78165;
