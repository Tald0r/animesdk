...
#define MOLEMOLE_PHOTO_ANIMATIONTWOBONEIKCONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0xA656FA0)
#define MOLEMOLE_PHOTO_ANIMATIONTWOBONEIKCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xA656F90)
#define MOLEMOLE_PHOTO_ANIMATIONTWOBONEIKCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0xA657FD0)
#define MOLEMOLE_PHOTO_ANIMATIONTWOBONEIKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA658430)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationTwoBoneIKConfig_TypeDefinitionIndex = 76346;
