...
#define MOLEMOLE_PHOTO_ANIMATIONTWOBONEIKCONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0xB3BE7F0)
#define MOLEMOLE_PHOTO_ANIMATIONTWOBONEIKCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xB3BE7E0)
#define MOLEMOLE_PHOTO_ANIMATIONTWOBONEIKCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0xB3BF820)
#define MOLEMOLE_PHOTO_ANIMATIONTWOBONEIKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB3BFC80)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationTwoBoneIKConfig_TypeDefinitionIndex = 78121;
