...
#define MOLEMOLE_PHOTO_ANIMATIONSAVECACHEDPOSECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x6B189A0)
#define MOLEMOLE_PHOTO_ANIMATIONSAVECACHEDPOSECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x6B18990)
#define MOLEMOLE_PHOTO_ANIMATIONSAVECACHEDPOSECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x6B19100)
#define MOLEMOLE_PHOTO_ANIMATIONSAVECACHEDPOSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6B19400)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationSaveCachedPoseConfig_TypeDefinitionIndex = 46549;
