...
#define MOLEMOLE_PHOTO_PLAYABLEUNITSLOTCONFIG_CREATEPLAYABLEUNIT_OFFSET UNITYSDK_OFFSET(0x830ECD0)
#define MOLEMOLE_PHOTO_PLAYABLEUNITSLOTCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x830F370)
#define MOLEMOLE_PHOTO_PLAYABLEUNITSLOTCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x830F390)
#define MOLEMOLE_PHOTO_PLAYABLEUNITSLOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x830F600)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableUnitSlotConfig_TypeDefinitionIndex = 46823;
