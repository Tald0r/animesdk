...
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x8A88D10)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x8A88B60)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG_GET_NAMES_OFFSET UNITYSDK_OFFSET(0x8A89640)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0x8A893B0)
#define MOLEMOLE_PHOTO_ANIMATIONMODIFYCURVEVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8A89790)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationModifyCurveValueConfig_TypeDefinitionIndex = 38685;
