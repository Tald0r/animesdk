...
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0xA607480)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xA607470)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_INITEYES_OFFSET UNITYSDK_OFFSET(0xA6089B0)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_INITSOLVER_OFFSET UNITYSDK_OFFSET(0xA608C20)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_INITSPINES_OFFSET UNITYSDK_OFFSET(0xA6086B0)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0xA608E10)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA609680)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationLookAtIKConfig_TypeDefinitionIndex = 61265;
