...
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0xA7F1880)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xA7F1870)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_INITEYES_OFFSET UNITYSDK_OFFSET(0xA7F2DB0)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_INITSOLVER_OFFSET UNITYSDK_OFFSET(0xA7F3020)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_INITSPINES_OFFSET UNITYSDK_OFFSET(0xA7F2AB0)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0xA7F3210)
#define MOLEMOLE_PHOTO_ANIMATIONLOOKATIKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA7F3A80)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationLookAtIKConfig_TypeDefinitionIndex = 61957;
