...
#define MOLEMOLE_PHOTO_PLAYABLEBLENDSPACE1DCONFIG_CREATEBLENDSPACE_OFFSET UNITYSDK_OFFSET(0xB870330)
#define MOLEMOLE_PHOTO_PLAYABLEBLENDSPACE1DCONFIG_CREATEPLAYABLEBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0xB86E2B0)
#define MOLEMOLE_PHOTO_PLAYABLEBLENDSPACE1DCONFIG_GET_ALLOCCOUNT_OFFSET UNITYSDK_OFFSET(0xB870D50)
#define MOLEMOLE_PHOTO_PLAYABLEBLENDSPACE1DCONFIG_GET_BLENDINPUTALLOCINDEX_OFFSET UNITYSDK_OFFSET(0xB870D10)
#define MOLEMOLE_PHOTO_PLAYABLEBLENDSPACE1DCONFIG_GET_BLENDSAMPLESALLOCINDEX_OFFSET UNITYSDK_OFFSET(0xB870D20)
#define MOLEMOLE_PHOTO_PLAYABLEBLENDSPACE1DCONFIG_GET_BLENDSEGMENTSALLOCINDEX_OFFSET UNITYSDK_OFFSET(0xB870D30)
#define MOLEMOLE_PHOTO_PLAYABLEBLENDSPACE1DCONFIG_GET_BLENDWEIGHTALLOCINDEX_OFFSET UNITYSDK_OFFSET(0xB870D40)
#define MOLEMOLE_PHOTO_PLAYABLEBLENDSPACE1DCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xB86AA80)
#define MOLEMOLE_PHOTO_PLAYABLEBLENDSPACE1DCONFIG_INITIALIZE_1_OFFSET UNITYSDK_OFFSET(0xB86FF10)
#define MOLEMOLE_PHOTO_PLAYABLEBLENDSPACE1DCONFIG_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xB86FBB0)
#define MOLEMOLE_PHOTO_PLAYABLEBLENDSPACE1DCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0xB870620)
#define MOLEMOLE_PHOTO_PLAYABLEBLENDSPACE1DCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB86DAB0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableBlendSpace1DConfig_TypeDefinitionIndex = 51839;
