...
#define MOLEMOLE_PHOTO_ANIMATIONINERTIALIZATIONCONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x6EC1260)
#define MOLEMOLE_PHOTO_ANIMATIONINERTIALIZATIONCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x6EC1E20)
#define MOLEMOLE_PHOTO_ANIMATIONINERTIALIZATIONCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x6EC1E30)
#define MOLEMOLE_PHOTO_ANIMATIONINERTIALIZATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6EC2570)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationInertializationConfig_TypeDefinitionIndex = 45230;
