...
#define MOLEMOLE_PHOTO_ANIMATIONINERTIALIZATIONCONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x6E4EB40)
#define MOLEMOLE_PHOTO_ANIMATIONINERTIALIZATIONCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x6E4F700)
#define MOLEMOLE_PHOTO_ANIMATIONINERTIALIZATIONCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x6E4F710)
#define MOLEMOLE_PHOTO_ANIMATIONINERTIALIZATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6E4FE50)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationInertializationConfig_TypeDefinitionIndex = 58160;
