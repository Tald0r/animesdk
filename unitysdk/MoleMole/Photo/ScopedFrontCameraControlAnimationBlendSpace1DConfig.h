...
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLANIMATIONBLENDSPACE1DCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0xA609A50)
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLANIMATIONBLENDSPACE1DCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xA60A9F0)
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLANIMATIONBLENDSPACE1DCONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0xA60ABF0)
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLANIMATIONBLENDSPACE1DCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA60C0C0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int ScopedFrontCameraControlAnimationBlendSpace1DConfig_TypeDefinitionIndex = 78890;
