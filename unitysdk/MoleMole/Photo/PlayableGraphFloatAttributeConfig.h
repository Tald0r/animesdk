...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHFLOATATTRIBUTECONFIG_APPLY_OFFSET UNITYSDK_OFFSET(0x830E8A0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHFLOATATTRIBUTECONFIG_GETMULTIPLIERCURVENAME_OFFSET UNITYSDK_OFFSET(0x830E7B0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHFLOATATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x830ECC0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphFloatAttributeConfig_TypeDefinitionIndex = 40362;
