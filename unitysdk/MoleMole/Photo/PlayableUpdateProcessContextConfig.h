...
#define MOLEMOLE_PHOTO_PLAYABLEUPDATEPROCESSCONTEXTCONFIG_CREATEPLAYABLEBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0xC326F70)
#define MOLEMOLE_PHOTO_PLAYABLEUPDATEPROCESSCONTEXTCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xC326F60)
#define MOLEMOLE_PHOTO_PLAYABLEUPDATEPROCESSCONTEXTCONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0xC327170)
#define MOLEMOLE_PHOTO_PLAYABLEUPDATEPROCESSCONTEXTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC327210)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableUpdateProcessContextConfig_TypeDefinitionIndex = 39339;
