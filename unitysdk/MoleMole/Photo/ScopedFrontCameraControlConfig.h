...
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLCONFIG_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x6E53170)
#define MOLEMOLE_PHOTO_SCOPEDFRONTCAMERACONTROLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6E531F0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int ScopedFrontCameraControlConfig_TypeDefinitionIndex = 50493;
