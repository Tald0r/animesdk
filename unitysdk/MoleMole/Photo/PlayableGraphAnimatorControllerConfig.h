...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0xA7F3B30)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xA7F3D80)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERCONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0xA7F3D90)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA7F3E30)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphAnimatorControllerConfig_TypeDefinitionIndex = 61021;
