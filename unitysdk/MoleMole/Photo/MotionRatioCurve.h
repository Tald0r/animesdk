...
#define MOLEMOLE_PHOTO_MOTIONRATIOCURVE_CREATE_OFFSET UNITYSDK_OFFSET(0xA497F80)
#define MOLEMOLE_PHOTO_MOTIONRATIOCURVE_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xA498980)
#define MOLEMOLE_PHOTO_MOTIONRATIOCURVE_REQUEST_OFFSET UNITYSDK_OFFSET(0xA498A00)
#define MOLEMOLE_PHOTO_MOTIONRATIOCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xA498BD0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int MotionRatioCurve_TypeDefinitionIndex = 77189;
