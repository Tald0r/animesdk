...
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0xB867CE0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xB86A7E0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE01_OFFSET UNITYSDK_OFFSET(0xB86D660)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE02_OFFSET UNITYSDK_OFFSET(0xB86D670)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE03_OFFSET UNITYSDK_OFFSET(0xB86D680)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE04_OFFSET UNITYSDK_OFFSET(0xB86D690)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE05_OFFSET UNITYSDK_OFFSET(0xB86D6A0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE06_OFFSET UNITYSDK_OFFSET(0xB86D6B0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE07_OFFSET UNITYSDK_OFFSET(0xB86D6C0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE08_OFFSET UNITYSDK_OFFSET(0xB86D6D0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE09_OFFSET UNITYSDK_OFFSET(0xB86D6E0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE10_OFFSET UNITYSDK_OFFSET(0xB86D6F0)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE11_OFFSET UNITYSDK_OFFSET(0xB86D700)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE12_OFFSET UNITYSDK_OFFSET(0xB86D710)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE13_OFFSET UNITYSDK_OFFSET(0xB86D720)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE14_OFFSET UNITYSDK_OFFSET(0xB86D730)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE15_OFFSET UNITYSDK_OFFSET(0xB86D740)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE16_OFFSET UNITYSDK_OFFSET(0xB86D750)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE17_OFFSET UNITYSDK_OFFSET(0xB86D760)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_GET_NODE18_OFFSET UNITYSDK_OFFSET(0xB86D770)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0xB86AA90)
#define MOLEMOLE_PHOTO_FRONTCAMERAANIMATIONGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB86D780)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int FrontCameraAnimationGraphConfig_TypeDefinitionIndex = 68782;
