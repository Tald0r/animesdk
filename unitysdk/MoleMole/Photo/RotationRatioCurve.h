...
#define MOLEMOLE_PHOTO_ROTATIONRATIOCURVE_CREATE_OFFSET UNITYSDK_OFFSET(0x7F1FB10)
#define MOLEMOLE_PHOTO_ROTATIONRATIOCURVE_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x7F1FD80)
#define MOLEMOLE_PHOTO_ROTATIONRATIOCURVE_REQUEST_OFFSET UNITYSDK_OFFSET(0x7F1FD90)
#define MOLEMOLE_PHOTO_ROTATIONRATIOCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x7F1FE50)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int RotationRatioCurve_TypeDefinitionIndex = 38556;
