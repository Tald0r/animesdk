...
#define MOLEMOLE_PHOTO_ANIMATIONBLENDPOSEPERBONECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x7A99CA0)
#define MOLEMOLE_PHOTO_ANIMATIONBLENDPOSEPERBONECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x7A9AAB0)
#define MOLEMOLE_PHOTO_ANIMATIONBLENDPOSEPERBONECONFIG_INITIALIZEWEIGHT_OFFSET UNITYSDK_OFFSET(0x7A9AE00)
#define MOLEMOLE_PHOTO_ANIMATIONBLENDPOSEPERBONECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x7A9AAC0)
#define MOLEMOLE_PHOTO_ANIMATIONBLENDPOSEPERBONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x7A9B4F0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationBlendPosePerBoneConfig_TypeDefinitionIndex = 62130;
