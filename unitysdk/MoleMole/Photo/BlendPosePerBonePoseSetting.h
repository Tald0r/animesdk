...
#define MOLEMOLE_PHOTO_BLENDPOSEPERBONEPOSESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xA6096E0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int BlendPosePerBonePoseSetting_TypeDefinitionIndex = 61207;
