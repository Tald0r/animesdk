...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHREFERENCECURVECONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x6E4FE70)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHREFERENCECURVECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x6E51B50)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHREFERENCECURVECONFIG_METHOD_1_4A12AA2BEAE67A2D_1_OFFSET UNITYSDK_OFFSET(0x6E52280)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHREFERENCECURVECONFIG_METHOD_1_4A12AA2BEAE67A2D_2_OFFSET UNITYSDK_OFFSET(0x6E527A0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHREFERENCECURVECONFIG_METHOD_1_4A12AA2BEAE67A2D_OFFSET UNITYSDK_OFFSET(0x6E52100)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHREFERENCECURVECONFIG_METHOD_1_A87ABB37A2265E8F_OFFSET UNITYSDK_OFFSET(0x6E53050)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHREFERENCECURVECONFIG_METHOD_1_AF5D1137CF44E9F3_OFFSET UNITYSDK_OFFSET(0x6E52C60)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHREFERENCECURVECONFIG_METHOD_1_E30C9EDC8C6E490C_1_OFFSET UNITYSDK_OFFSET(0x6E528F0)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHREFERENCECURVECONFIG_METHOD_1_E30C9EDC8C6E490C_OFFSET UNITYSDK_OFFSET(0x6E52430)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHREFERENCECURVECONFIG_REQUEST_OFFSET UNITYSDK_OFFSET(0x6E51B60)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHREFERENCECURVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6E520F0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphReferenceCurveConfig_TypeDefinitionIndex = 63907;
