...
#define MOLEMOLE_PHOTO_ANIMATIONUSECACHEDPOSECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x9AC56B0)
#define MOLEMOLE_PHOTO_ANIMATIONUSECACHEDPOSECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x9AC5640)
#define MOLEMOLE_PHOTO_ANIMATIONUSECACHEDPOSECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x9AC5EF0)
#define MOLEMOLE_PHOTO_ANIMATIONUSECACHEDPOSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9AC61F0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int AnimationUseCachedPoseConfig_TypeDefinitionIndex = 73936;
