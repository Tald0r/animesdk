...
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSBLENDSPACEPOSECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0x830D810)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSBLENDSPACEPOSECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0x830D800)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSBLENDSPACEPOSECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0x830E120)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSBLENDSPACEPOSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x830E2B0)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int FrontCameraProcessBlendSpacePoseConfig_TypeDefinitionIndex = 41037;
