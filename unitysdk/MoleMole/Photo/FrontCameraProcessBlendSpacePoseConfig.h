...
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSBLENDSPACEPOSECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0xB92B780)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSBLENDSPACEPOSECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xB92B770)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSBLENDSPACEPOSECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0xB92C090)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSBLENDSPACEPOSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB92C220)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int FrontCameraProcessBlendSpacePoseConfig_TypeDefinitionIndex = 65995;
