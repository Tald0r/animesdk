...
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERINT_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0xBD4B470)
#define MOLEMOLE_PHOTO_PLAYABLEGRAPHANIMATORCONTROLLERINT__CTOR_OFFSET UNITYSDK_OFFSET(0xBD4B510)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int PlayableGraphAnimatorControllerInt_TypeDefinitionIndex = 52407;
