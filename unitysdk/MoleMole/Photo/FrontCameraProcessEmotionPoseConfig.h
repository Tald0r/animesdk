...
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSEMOTIONPOSECONFIG_CREATEJOBDATA_OFFSET UNITYSDK_OFFSET(0xB86DB10)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSEMOTIONPOSECONFIG_GET_DYNAMICMEMORYCOUNT_OFFSET UNITYSDK_OFFSET(0xB86DB00)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSEMOTIONPOSECONFIG_REQUESTMEMORY_OFFSET UNITYSDK_OFFSET(0xB86E150)
#define MOLEMOLE_PHOTO_FRONTCAMERAPROCESSEMOTIONPOSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB86E290)

namespace MoleMole::Photo
{
	inline static constexpr unsigned int FrontCameraProcessEmotionPoseConfig_TypeDefinitionIndex = 52843;
