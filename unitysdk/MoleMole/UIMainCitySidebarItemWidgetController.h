...
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0xD778FF0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD778F80)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD7791B0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD7792B0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD779110)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD779400)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD779410)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD779480)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD779500)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySidebarItemWidgetController_TypeDefinitionIndex = 46767;
