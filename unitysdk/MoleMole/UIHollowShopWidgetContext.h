...
#define MOLEMOLE_UIHOLLOWSHOPWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA1B8120)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowShopWidgetContext_TypeDefinitionIndex = 56848;
	...
	public:
		...
		::Class_5_49230FCDC9826905* shopNode; // 0x40
