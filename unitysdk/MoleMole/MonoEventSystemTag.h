...
#define MOLEMOLE_MONOEVENTSYSTEMTAG__CTOR_OFFSET UNITYSDK_OFFSET(0xC233C40)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEventSystemTag_TypeDefinitionIndex = 40596;
