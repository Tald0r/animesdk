...
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_INITPLATFORMUI_OFFSET UNITYSDK_OFFSET(0xCC261E0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xCC25280)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCC253E0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCC25560)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCC25480)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCC251D0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCC25330)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_REFRESHCOMMONVIEW_OFFSET UNITYSDK_OFFSET(0xCC25E50)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_REFRESHTOPSELFVIEW_OFFSET UNITYSDK_OFFSET(0xCC25690)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_REFRESHUSERVIEW_OFFSET UNITYSDK_OFFSET(0xCC25AB0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_SWITCHACCOUNTNAMEINFO_OFFSET UNITYSDK_OFFSET(0xCC26130)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC26910)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCC26920)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCC26990)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCC26A10)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCC26A90)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCC26AF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeMainRankListRowWidgetController_TypeDefinitionIndex = 40172;

	class UIArcadeMainRankListRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_19206BC47BA92FC3_1* _view; // 0x2D0
		::System::Int32 _playerID; // 0x2D8
		::System::Boolean _allowShowPlatform; // 0x2DC
		::System::Boolean _canSwitchPlatformInfo; // 0x2DD
		::System::Boolean _isShowingPlatform; // 0x2DE
		::UnityEngine::UI::Extension::UILocalizationText* displayNameText; // 0x2E0
		::System::String* _inGameName; // 0x2E8
		::System::String* _otherPlatformName; // 0x2F0
