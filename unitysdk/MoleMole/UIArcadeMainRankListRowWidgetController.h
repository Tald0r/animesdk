...
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_INITPLATFORMUI_OFFSET UNITYSDK_OFFSET(0x8CD7FA0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x8CD7040)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8CD71A0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8CD7320)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8CD7240)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8CD6F90)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8CD70F0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_REFRESHCOMMONVIEW_OFFSET UNITYSDK_OFFSET(0x8CD7C10)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_REFRESHTOPSELFVIEW_OFFSET UNITYSDK_OFFSET(0x8CD7450)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_REFRESHUSERVIEW_OFFSET UNITYSDK_OFFSET(0x8CD7870)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER_SWITCHACCOUNTNAMEINFO_OFFSET UNITYSDK_OFFSET(0x8CD7EF0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8CD86D0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8CD86E0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8CD8750)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8CD87D0)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8CD8850)
#define MOLEMOLE_UIARCADEMAINRANKLISTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8CD88B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeMainRankListRowWidgetController_TypeDefinitionIndex = 64916;

	class UIArcadeMainRankListRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_19206BC47BA92FC3* _view; // 0x2D0
