...
#define MOLEMOLE_GENERALBUFFDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB8AEB40)

namespace MoleMole
{
	inline static constexpr unsigned int GeneralBuffDialogContext_TypeDefinitionIndex = 60180;
