...
#define MOLEMOLE_GENERALBUFFDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC2D30A0)

namespace MoleMole
{
	inline static constexpr unsigned int GeneralBuffDialogContext_TypeDefinitionIndex = 73719;
