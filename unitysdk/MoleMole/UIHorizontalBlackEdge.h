...
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x8C4B160)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_GETPIXELSCREENSIZEEXCLUDEHORIZONTALBLACKEDGE_OFFSET UNITYSDK_OFFSET(0x8C4C180)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_INIT_OFFSET UNITYSDK_OFFSET(0x8C4AF00)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_0B08B4F8E959C85E_OFFSET UNITYSDK_OFFSET(0x8C4C000)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_4F2CA7891A6E0E62_OFFSET UNITYSDK_OFFSET(0x8C4C330)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x8C4C320)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8C4C2C0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x8C4C3E0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8C4B090)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8C4AE70)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x8C4C2A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHorizontalBlackEdge_TypeDefinitionIndex = 49134;
	...
	public:
		...
		::UnityEngine::Canvas* Method_5_0B08B4F8E959C85E()
		{
			return ((::UnityEngine::Canvas*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_0B08B4F8E959C85E_OFFSET))(this);
		}
		...
		::System::Void Method_5_4F2CA7891A6E0E62(::System::Int32 a1, ::System::Int32 a2, ::System::Single a3)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::Int32, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_4F2CA7891A6E0E62_OFFSET))(this, a1, a2, a3);
		}
