...
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x9626900)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_GETPIXELSCREENSIZEEXCLUDEHORIZONTALBLACKEDGE_OFFSET UNITYSDK_OFFSET(0x9627920)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_INIT_OFFSET UNITYSDK_OFFSET(0x96266A0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_0B08B4F8E959C85E_OFFSET UNITYSDK_OFFSET(0x96277A0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_4F2CA7891A6E0E62_OFFSET UNITYSDK_OFFSET(0x9627AC0)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x9627B70)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9627A60)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x9627B80)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9626830)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9626610)
#define MOLEMOLE_UIHORIZONTALBLACKEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x9627A40)

namespace MoleMole
{
	inline static constexpr unsigned int UIHorizontalBlackEdge_TypeDefinitionIndex = 64269;
