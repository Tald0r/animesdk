...
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_CLEARITEMDATA_OFFSET UNITYSDK_OFFSET(0xC0C31B0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_GETITEMDATA_OFFSET UNITYSDK_OFFSET(0xC0BD7E0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_GETRECYCLEMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xC0C1880)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_GETSELECTITEMDATA_OFFSET UNITYSDK_OFFSET(0xC0C2BA0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_GETVIEWLIST_OFFSET UNITYSDK_OFFSET(0xC0BF550)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_GETWIDGET_OFFSET UNITYSDK_OFFSET(0xC0C1F70)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC0BC120)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_HANDLECONSUMESHOW_OFFSET UNITYSDK_OFFSET(0xC0BEE50)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xC0BC720)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC0BC9B0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONCLICKCONFIRM_OFFSET UNITYSDK_OFFSET(0xC0C22F0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONCLICKCONSUMEICONBTN_OFFSET UNITYSDK_OFFSET(0xC0C2CF0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONCLICKITEMINFOBTN_OFFSET UNITYSDK_OFFSET(0xC0C2DB0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xC0C0000)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xC0BDF90)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0BDDE0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC0BDB30)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONSORTORFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0xC0C3370)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0BDE80)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0BC130)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0BCED0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0xC0C3120)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_RESELECTITEM_OFFSET UNITYSDK_OFFSET(0xC0BE630)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SELECTITEM_OFFSET UNITYSDK_OFFSET(0xC0BDA10)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SENDDATA_OFFSET UNITYSDK_OFFSET(0xC0C2E80)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SETCONFIRMBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xC0C17D0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SETCOUNT_OFFSET UNITYSDK_OFFSET(0xC0C1610)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SETCURTAB_OFFSET UNITYSDK_OFFSET(0xC0BE010)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SETLIMITTEXT_OFFSET UNITYSDK_OFFSET(0xC0C1690)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xC0BDF10)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SHOWCOMPOSEITEM_OFFSET UNITYSDK_OFFSET(0xC0C0190)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SHOWDECOMPOSEITEM_OFFSET UNITYSDK_OFFSET(0xC0C07C0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SHOWEMPTYITEM_OFFSET UNITYSDK_OFFSET(0xC0C1240)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SHOWPRICE_OFFSET UNITYSDK_OFFSET(0xC0C19F0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SHOWRECYCLEITEM_OFFSET UNITYSDK_OFFSET(0xC0C0E00)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_SHOWSUBITEMS_OFFSET UNITYSDK_OFFSET(0xC0C1BD0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_UPDATECOMPOSEITEMLIST_OFFSET UNITYSDK_OFFSET(0xC0BFB30)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_UPDATECURRENCY_OFFSET UNITYSDK_OFFSET(0xC0C12F0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_UPDATEDECOMPOSEITEMLIST_OFFSET UNITYSDK_OFFSET(0xC0BFC90)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_UPDATEITEMLIST_OFFSET UNITYSDK_OFFSET(0xC0BEFC0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER_UPDATERECYCLEITEMLIST_OFFSET UNITYSDK_OFFSET(0xC0BFDF0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C3400)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER__INITSCROLLVIEW_B__26_0_OFFSET UNITYSDK_OFFSET(0xC0C3590)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER__SELECTITEM_G__DOSELECTITEM_33_0_OFFSET UNITYSDK_OFFSET(0xC0BFA20)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0C3670)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC0C36E0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0C36F0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0C3700)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0C3710)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xC0C3780)

namespace MoleMole
{
	inline static constexpr unsigned int UIComposeItemPopWindowController_TypeDefinitionIndex = 53222;
	...
	public:
		...
		::Class_2_60638234271CCDB8_26* _view; // 0x300
		...
		::Class_2_2BD3078077E999CE<::Class_1_0D6706375CDAAE8C*>* _sorter; // 0x368
