...
#define MOLEMOLE_SHADINGQUALITYPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x67CC870)
#define MOLEMOLE_SHADINGQUALITYPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x67CC9F0)
#define MOLEMOLE_SHADINGQUALITYPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x67CC760)
#define MOLEMOLE_SHADINGQUALITYPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x67CC950)
#define MOLEMOLE_SHADINGQUALITYPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x67CC750)
#define MOLEMOLE_SHADINGQUALITYPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x67CCB50)
#define MOLEMOLE_SHADINGQUALITYPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x67CCBE0)
#define MOLEMOLE_SHADINGQUALITYPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x67CCC50)
#define MOLEMOLE_SHADINGQUALITYPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x67CCCC0)

namespace MoleMole
{
	inline static constexpr unsigned int ShadingQualityProfile_TypeDefinitionIndex = 60408;
