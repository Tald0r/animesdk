...
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC5FFFE0)
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS35_0__ONCLICKSTARTBATTLE_B__0_OFFSET UNITYSDK_OFFSET(0xC6003D0)
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS35_0__ONCLICKSTARTBATTLE_B__1_OFFSET UNITYSDK_OFFSET(0xC5FFFF0)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdlePageController___c__DisplayClass35_0_TypeDefinitionIndex = 71291;
