...
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_GETBUILDER_OFFSET UNITYSDK_OFFSET(0xBD45B50)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_GET_PLATFORMBOUNDS_OFFSET UNITYSDK_OFFSET(0xBD45B30)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xBD45E70)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xBD45C10)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xBD47B50)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_ONENTITYREADY_OFFSET UNITYSDK_OFFSET(0xBD465D0)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xBD464F0)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_ONRESET_OFFSET UNITYSDK_OFFSET(0xBD45DF0)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xBD46980)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xBD46240)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_TRYGETNEXTCONTEXT_OFFSET UNITYSDK_OFFSET(0xBD47670)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_UPDATEMOVINGWALLCONTEXT_OFFSET UNITYSDK_OFFSET(0xBD468B0)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_UPDATEMOVINGWALLS_OFFSET UNITYSDK_OFFSET(0xBD47380)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM_UPDATEWALLBUILDERS_OFFSET UNITYSDK_OFFSET(0xBD469F0)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0xBD48020)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xBD48040)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xBD480A0)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xBD48110)
#define MOLEMOLE_MOVINGWALLSUBSYSTEM___BASE_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xBD48170)

namespace MoleMole
{
	inline static constexpr unsigned int MovingWallSubsystem_TypeDefinitionIndex = 45239;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* _entityIDToBuildIndex; // 0x18
		::System::Collections::Generic::List_1<::Class_1_2582D22C0BC976C3*>* _contents; // 0x20
		::System::Collections::Generic::List_1<::Class_1_D276261F488D3DEB*>* _movingWalls; // 0x28
		::MoleMole::Vector2Int _baseSlotCount; // 0x30
		::UnityEngine::Bounds _platformBounds; // 0x38
		::System::Int32 _buildIndex; // 0x50
		::System::Int32 _baseMaxHeightIndex; // 0x54
		::UnityEngine::Vector2 _basePrecision; // 0x58
		...
		::System::Void Initialize(::Class_3_1A345EAE5F749316_119* notify)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_1A345EAE5F749316_119*))((::PBYTE)hIl2Cpp + MOLEMOLE_MOVINGWALLSUBSYSTEM_INITIALIZE_OFFSET))(this, notify);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MOVINGWALLSUBSYSTEM_ONDRAWGIZMOS_OFFSET))(this);
		}
