...
#define MOLEMOLE_UIINTERKNOWCOURSEPOINTREWARDWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x8F133F0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINTREWARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8F13250)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINTREWARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8F132F0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINTREWARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8F13080)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINTREWARDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8F13120)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINTREWARDWIDGETCONTROLLER_PLAYNODEUIANIM_OFFSET UNITYSDK_OFFSET(0x8F13460)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINTREWARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F13640)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINTREWARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8F13670)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINTREWARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8F136E0)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINTREWARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8F13760)
#define MOLEMOLE_UIINTERKNOWCOURSEPOINTREWARDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8F137C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnowCoursePointRewardWidgetController_TypeDefinitionIndex = 44381;

	class UIInterKnowCoursePointRewardWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_58* _view; // 0x2A0
		...
		::Class_2_79F6D62CE30E3F8E_58* GetView()
		{
			return ((::Class_2_79F6D62CE30E3F8E_58*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINTERKNOWCOURSEPOINTREWARDWIDGETCONTROLLER_GETVIEW_OFFSET))(this);
		}
