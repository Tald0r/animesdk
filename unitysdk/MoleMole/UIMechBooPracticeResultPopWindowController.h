...
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER_DELAYRECOVERHP_OFFSET UNITYSDK_OFFSET(0x8978BF0)
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0x8978B30)
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8978AB0)
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8979540)
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x89795E0)
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8978AC0)
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8978E50)
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8979690)
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8979670)
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER__ONUIOPEN_B__15_0_OFFSET UNITYSDK_OFFSET(0x8979710)
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8979740)
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x89797B0)
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x89797C0)
#define MOLEMOLE_UIMECHBOOPRACTICERESULTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x89797D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooPracticeResultPopWindowController_TypeDefinitionIndex = 54129;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMechBooPracticeResultPopWindowController_TypeDefinitionIndex)->GetStaticField(0x10CA0);
		}
		static ::System::Int32* StaticGet_RampColorFShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMechBooPracticeResultPopWindowController_TypeDefinitionIndex)->GetStaticField(0x10CA4);
		}
		static ::System::Int32* StaticGet_UseHPScaleOffsetShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMechBooPracticeResultPopWindowController_TypeDefinitionIndex)->GetStaticField(0x10CA8);
		}
		static ::System::Int32* StaticGet_RecoverPercentShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMechBooPracticeResultPopWindowController_TypeDefinitionIndex)->GetStaticField(0x10CAC);
		}
		::Class_2_4902A2CD45674E62* _view; // 0x2F8
