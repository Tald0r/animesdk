...
#define MOLEMOLE_UIINLEVELASTRACHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8A3AA20)
#define MOLEMOLE_UIINLEVELASTRACHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8A3AB50)
#define MOLEMOLE_UIINLEVELASTRACHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8A3ABF0)
#define MOLEMOLE_UIINLEVELASTRACHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8A3AA30)
#define MOLEMOLE_UIINLEVELASTRACHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8A3AAA0)
#define MOLEMOLE_UIINLEVELASTRACHILDWINDOWCONTROLLER_REFRESHCURCHARGETIMES_OFFSET UNITYSDK_OFFSET(0x8A3AC80)
#define MOLEMOLE_UIINLEVELASTRACHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8A3AD20)
#define MOLEMOLE_UIINLEVELASTRACHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8A3AD30)
#define MOLEMOLE_UIINLEVELASTRACHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8A3ADA0)
#define MOLEMOLE_UIINLEVELASTRACHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8A3ADB0)
#define MOLEMOLE_UIINLEVELASTRACHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8A3ADC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelAstraChildWindowController_TypeDefinitionIndex = 56606;

	class UIInLevelAstraChildWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_3F751654DB473886_6* _view; // 0x2F8
