...
class Class_2_E3B74E53F7AC003C_1;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER_APPLYITEMREF2BASECTRLER_OFFSET UNITYSDK_OFFSET(0x8C3E6A0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C3E570)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C3E610)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C3E450)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C3E500)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C3F5F0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C3F600)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C3F670)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C3F680)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C3F6F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStageTv3DModelController_TypeDefinitionIndex = 68208;

	class UIGachaStageTv3DModelController : public ::MoleMole::UIGachaStageTv3DModelControllerBase
	{
	public:
		::Class_2_E3B74E53F7AC003C_1* _view; // 0x690
