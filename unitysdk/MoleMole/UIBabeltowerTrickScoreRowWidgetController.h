...
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_BINDCLICK_OFFSET UNITYSDK_OFFSET(0xD523120)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_GETLANGUAGENUMSTR_OFFSET UNITYSDK_OFFSET(0xD525020)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_ONCLICKINFOICONBTN_OFFSET UNITYSDK_OFFSET(0xD5247F0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD522ED0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD523040)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD522D80)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD522E20)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHINFOICONBTN_OFFSET UNITYSDK_OFFSET(0xD523370)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHNUM_1_OFFSET UNITYSDK_OFFSET(0xD523BD0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHNUM_OFFSET UNITYSDK_OFFSET(0xD523760)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHRATINGICON_OFFSET UNITYSDK_OFFSET(0xD523950)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHSTYLISHNOHIT_OFFSET UNITYSDK_OFFSET(0xD5241D0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHSTYLISHSKILL_OFFSET UNITYSDK_OFFSET(0xD523E50)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHTITLE_OFFSET UNITYSDK_OFFSET(0xD523430)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHVIEW_1_OFFSET UNITYSDK_OFFSET(0xD523AC0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHVIEW_2_OFFSET UNITYSDK_OFFSET(0xD523D80)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHVIEW_3_OFFSET UNITYSDK_OFFSET(0xD524C50)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD5231C0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REPLACEINFOCONTENT_OFFSET UNITYSDK_OFFSET(0xD524AD0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xD5232C0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_SETNUMSTRCOLOR_OFFSET UNITYSDK_OFFSET(0xD524F60)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_SETNUMSTRPREFIX_OFFSET UNITYSDK_OFFSET(0xD524E10)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_SHOULDIGNORE_OFFSET UNITYSDK_OFFSET(0xD524A10)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD525100)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD5254F0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD525560)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD5255E0)
#define MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD525640)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerTrickScoreRowWidgetController_TypeDefinitionIndex = 54806;

	class UIBabeltowerTrickScoreRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_BE69379A14124A86_2* _view; // 0x2A0
		...
		::System::Void RefreshView_2(::Enum_3_4DE39DF26DB99449 s3RatingType)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_4DE39DF26DB99449))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHVIEW_2_OFFSET))(this, s3RatingType);
		}
		...
		::System::Void RefreshTitle(::Enum_3_B511486FFFFCE718 scoreType, ::Enum_3_4DE39DF26DB99449 s3RatingType)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_B511486FFFFCE718, ::Enum_3_4DE39DF26DB99449))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHTITLE_OFFSET))(this, scoreType, s3RatingType);
		}
		...
		::System::Void RefreshRatingIcon(::Enum_3_B511486FFFFCE718 scoreType, ::Enum_3_4DE39DF26DB99449 s3RatingType)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_B511486FFFFCE718, ::Enum_3_4DE39DF26DB99449))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERTRICKSCOREROWWIDGETCONTROLLER_REFRESHRATINGICON_OFFSET))(this, scoreType, s3RatingType);
		}
