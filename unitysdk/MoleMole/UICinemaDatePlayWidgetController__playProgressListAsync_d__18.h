...
#define MOLEMOLE_UICINEMADATEPLAYWIDGETCONTROLLER__PLAYPROGRESSLISTASYNC_D__18_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3B67D0)
#define MOLEMOLE_UICINEMADATEPLAYWIDGETCONTROLLER__PLAYPROGRESSLISTASYNC_D__18_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaDatePlayWidgetController__playProgressListAsync_d__18_TypeDefinitionIndex = 39215;
	...
	struct alignas(8) UICinemaDatePlayWidgetController__playProgressListAsync_d__18
	{
		...
		::System::Collections::Generic::List_1<::System::Int32>* numPoints; // 0x28
