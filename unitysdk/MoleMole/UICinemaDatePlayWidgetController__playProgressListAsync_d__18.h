...
#define MOLEMOLE_UICINEMADATEPLAYWIDGETCONTROLLER__PLAYPROGRESSLISTASYNC_D__18_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3A8C50)
#define MOLEMOLE_UICINEMADATEPLAYWIDGETCONTROLLER__PLAYPROGRESSLISTASYNC_D__18_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaDatePlayWidgetController__playProgressListAsync_d__18_TypeDefinitionIndex = 48517;
