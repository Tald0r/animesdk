...
#define MOLEMOLE_MAPCHANGELAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x67AAE40)

namespace MoleMole
{
	inline static constexpr unsigned int MapChangeLayerConfig_TypeDefinitionIndex = 48023;
