...
#define MOLEMOLE_MAPCHANGELAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x75A8700)

namespace MoleMole
{
	inline static constexpr unsigned int MapChangeLayerConfig_TypeDefinitionIndex = 58187;
