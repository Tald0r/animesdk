...
#define MOLEMOLE_UIGENERALENHANCEBUFFWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDFBD990)
#define MOLEMOLE_UIGENERALENHANCEBUFFWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDFBDC70)
#define MOLEMOLE_UIGENERALENHANCEBUFFWIDGETCONTROLLER_ONSCROLLITEMREUSE_OFFSET UNITYSDK_OFFSET(0xDFBDF60)
#define MOLEMOLE_UIGENERALENHANCEBUFFWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDFBDD70)
#define MOLEMOLE_UIGENERALENHANCEBUFFWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDFBDA00)
#define MOLEMOLE_UIGENERALENHANCEBUFFWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDFBE0A0)
#define MOLEMOLE_UIGENERALENHANCEBUFFWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDFBE0B0)
#define MOLEMOLE_UIGENERALENHANCEBUFFWIDGETCONTROLLER___BASE_ONSCROLLITEMREUSE_OFFSET UNITYSDK_OFFSET(0xDFBE120)
#define MOLEMOLE_UIGENERALENHANCEBUFFWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDFBE180)
#define MOLEMOLE_UIGENERALENHANCEBUFFWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDFBE200)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralEnhanceBuffWidgetController_TypeDefinitionIndex = 53131;
