...
#define MOLEMOLE_UIBOUNTYMISSIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD9B1D50)
#define MOLEMOLE_UIBOUNTYMISSIONWIDGETCONTROLLER_ONQUESTCOUNTDOWNEND_OFFSET UNITYSDK_OFFSET(0xD9B26B0)
#define MOLEMOLE_UIBOUNTYMISSIONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD9B1ED0)
#define MOLEMOLE_UIBOUNTYMISSIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD9B1DF0)
#define MOLEMOLE_UIBOUNTYMISSIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD9B1C00)
#define MOLEMOLE_UIBOUNTYMISSIONWIDGETCONTROLLER_SHOWUNLOCK_OFFSET UNITYSDK_OFFSET(0xD9B1FF0)
#define MOLEMOLE_UIBOUNTYMISSIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD9B27E0)
#define MOLEMOLE_UIBOUNTYMISSIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD9B27F0)
#define MOLEMOLE_UIBOUNTYMISSIONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD9B2860)
#define MOLEMOLE_UIBOUNTYMISSIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD9B28E0)
#define MOLEMOLE_UIBOUNTYMISSIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD9B2960)

namespace MoleMole
{
	inline static constexpr unsigned int UIBountyMissionWidgetController_TypeDefinitionIndex = 63294;

	class UIBountyMissionWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_0F81C900BF7F52E0_2* _view; // 0x2D0
