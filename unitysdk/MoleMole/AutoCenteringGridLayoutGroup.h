...
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x84E56D0)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP_METHOD_8_78FBED8F1829A87D_OFFSET UNITYSDK_OFFSET(0x84E57B0)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x84E5740)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x84E5FA0)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x84E6010)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP___BASE_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x84E6040)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP___BASE_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x84E60D0)
#define MOLEMOLE_AUTOCENTERINGGRIDLAYOUTGROUP___BASE_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x84E6160)

namespace MoleMole
{
	inline static constexpr unsigned int AutoCenteringGridLayoutGroup_TypeDefinitionIndex = 49033;
