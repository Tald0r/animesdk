...
#define MOLEMOLE_SCENESOUNDDATA_SUBAREACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA60F4F0)

namespace MoleMole
{
	inline static constexpr unsigned int SceneSoundData_SubAreaConfig_TypeDefinitionIndex = 59683;
