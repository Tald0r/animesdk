...
#define MOLEMOLE_MONOEFFECTPLUGINTRANSFORM_CLASS_1_D15846DA6A50C310_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB5F6320)
#define MOLEMOLE_MONOEFFECTPLUGINTRANSFORM_CLASS_1_D15846DA6A50C310__CTOR_OFFSET UNITYSDK_OFFSET(0xB5F6310)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginTransform_Class_1_D15846DA6A50C310_TypeDefinitionIndex = 77760;

	class MonoEffectPluginTransform_Class_1_D15846DA6A50C310 : public ::System::Object
	{
	public:
		::UnityEngine::ParticleSystemRenderer* Field_1_3; // 0x10
		::UnityEngine::ParticleSystem* Field_1_2; // 0x18
