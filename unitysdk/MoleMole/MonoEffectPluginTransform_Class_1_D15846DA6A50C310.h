...
#define MOLEMOLE_MONOEFFECTPLUGINTRANSFORM_CLASS_1_D15846DA6A50C310_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC9DF6C0)
#define MOLEMOLE_MONOEFFECTPLUGINTRANSFORM_CLASS_1_D15846DA6A50C310__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DF6B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginTransform_Class_1_D15846DA6A50C310_TypeDefinitionIndex = 55572;
