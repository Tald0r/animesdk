...
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONRESET_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC610180)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONRESET_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC610500)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONRESET_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC610560)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONRESET_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC610510)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONRESET_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC610170)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONRESET_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0xC610160)

namespace MoleMole
{
	inline static constexpr unsigned int UIDataFixOuterRenderWidgetController__OnReset_d__17_TypeDefinitionIndex = 58368;
	...
	public:
		...
		::System::Single _panelStartY_5__2; // 0x18
		::System::Int32 _i_5__6; // 0x1C
		::System::Single _ratio_5__5; // 0x20
		::System::Single _nodeHeight_5__4; // 0x24
