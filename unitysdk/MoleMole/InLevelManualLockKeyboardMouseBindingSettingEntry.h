...
#define MOLEMOLE_INLEVELMANUALLOCKKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xC226C20)
#define MOLEMOLE_INLEVELMANUALLOCKKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xC226C30)
#define MOLEMOLE_INLEVELMANUALLOCKKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xC226C40)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelManualLockKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 52170;
