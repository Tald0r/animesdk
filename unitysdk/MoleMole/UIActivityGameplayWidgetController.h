...
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_CLOSEOVERHANDLE_OFFSET UNITYSDK_OFFSET(0xDEDA5F0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_GETDEFAULTSELECT_OFFSET UNITYSDK_OFFSET(0xDED9570)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_GETHASDIFFICUTYUNLOCK_OFFSET UNITYSDK_OFFSET(0xDED8C50)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xDED7F10)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_GOTOPLAY_OFFSET UNITYSDK_OFFSET(0xDEDAAC0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_LOADBACKGROUND_OFFSET UNITYSDK_OFFSET(0xDED8270)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONBACKCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xDED9860)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONCLICKDIFFICUTYBTN_OFFSET UNITYSDK_OFFSET(0xDED9EA0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONCLICKNORMALBTN_OFFSET UNITYSDK_OFFSET(0xDEDA530)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDED8F70)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONMAINCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xDEDA690)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONQUESTROWSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0xDEDAA00)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONTOGGLEHANDLE_OFFSET UNITYSDK_OFFSET(0xDEDA150)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEDAD70)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDED7580)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDED7F80)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_OPENHISTORYVIEW_OFFSET UNITYSDK_OFFSET(0xDEDA780)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_RECORDTABCLICK_OFFSET UNITYSDK_OFFSET(0xDED9F60)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_RECORDTABSHOW_OFFSET UNITYSDK_OFFSET(0xDED9010)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xDED8630)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_SETBACKGROUND_OFFSET UNITYSDK_OFFSET(0xDED9340)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_SETISREAD_OFFSET UNITYSDK_OFFSET(0xDED9930)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_SETQUESTROWLIST_OFFSET UNITYSDK_OFFSET(0xDED9470)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER_SETTOGGLEANISTATE_OFFSET UNITYSDK_OFFSET(0xDED9200)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER__CREATEDIFFICUTYROW_OFFSET UNITYSDK_OFFSET(0xDED7E30)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER__CREATEROW_OFFSET UNITYSDK_OFFSET(0xDED7D50)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDEDAE50)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEDAE80)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEDAEF0)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEDAF70)
#define MOLEMOLE_UIACTIVITYGAMEPLAYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDEDAFD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityGameplayWidgetController_TypeDefinitionIndex = 58063;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_202*>* _showQuestList; // 0x2B8
		::Class_2_208CC9941471731A_202* selectHollowEntranceCfg; // 0x2C0
