...
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER_MARKTIPSACTIVE_OFFSET UNITYSDK_OFFSET(0xA337900)
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER_ONCLICKCAMERABTN_OFFSET UNITYSDK_OFFSET(0xA337240)
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA3375B0)
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA337650)
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA337060)
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA3374A0)
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xA337970)
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER_SETTIPSACTIVE_OFFSET UNITYSDK_OFFSET(0xA3377A0)
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA337730)
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA337A00)
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA337A30)
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA337AA0)
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA337B20)
#define MOLEMOLE_UICONSOLECAMERABTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA337B80)

namespace MoleMole
{
	inline static constexpr unsigned int UIConsoleCameraBtnWidgetController_TypeDefinitionIndex = 64548;
