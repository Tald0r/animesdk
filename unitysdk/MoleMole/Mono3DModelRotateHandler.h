...
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x6EA1B40)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_BINDIMGEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0x6EA12D0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_BINDMODELPROVIDER_OFFSET UNITYSDK_OFFSET(0x6EA1260)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_BINDROTATEPOS_OFFSET UNITYSDK_OFFSET(0x6EA11E0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_GET_ISDRAGING_OFFSET UNITYSDK_OFFSET(0x6EA29F0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_GET_ROTATEAXIS_OFFSET UNITYSDK_OFFSET(0x6EA1730)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_ISCONTENTOUTOFRANGE_OFFSET UNITYSDK_OFFSET(0x6EA2A00)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x6EA1990)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_0B63A0EF42BD601E_OFFSET UNITYSDK_OFFSET(0x6EA2DA0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_128774387667156B_OFFSET UNITYSDK_OFFSET(0x6EA3E20)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_1D004332A41EA62A_OFFSET UNITYSDK_OFFSET(0x6EA1FD0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x6EA41F0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x6EA2AE0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0x6EA3840)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x6EA27E0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x6EA1A60)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_4549F884A7412971_OFFSET UNITYSDK_OFFSET(0x6EA2E70)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_5A124CAF1E48B74F_OFFSET UNITYSDK_OFFSET(0x6EA1500)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0x6EA2B40)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_9ACDED94382FBB80_OFFSET UNITYSDK_OFFSET(0x6EA3DB0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_9AD90DEC7E116B80_1_OFFSET UNITYSDK_OFFSET(0x6EA43D0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_9AD90DEC7E116B80_OFFSET UNITYSDK_OFFSET(0x6EA3770)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_A2DEBE149A58BBB9_OFFSET UNITYSDK_OFFSET(0x6EA3C60)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_A36150C5DCC8409E_1_OFFSET UNITYSDK_OFFSET(0x6EA3F00)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x6EA3BF0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_A698503049613B5B_1_OFFSET UNITYSDK_OFFSET(0x6EA4350)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_A698503049613B5B_OFFSET UNITYSDK_OFFSET(0x6EA36F0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x6EA1EF0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_B8968E62A435FE6D_OFFSET UNITYSDK_OFFSET(0x6EA44A0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_BF972395CC722BF9_OFFSET UNITYSDK_OFFSET(0x6EA3B40)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_D77B9BAF12E64B4B_OFFSET UNITYSDK_OFFSET(0x6EA4260)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_D93EC3DDD756C47C_OFFSET UNITYSDK_OFFSET(0x6EA1880)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_DE2BC44ACB86CE8C_OFFSET UNITYSDK_OFFSET(0x6EA3E60)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_E4D7C1998AA82588_OFFSET UNITYSDK_OFFSET(0x6EA38E0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_METHOD_5_E7B5077360A6CAAD_OFFSET UNITYSDK_OFFSET(0x6EA3F70)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6EA1BC0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x6EA1D00)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x6EA2860)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x6EA1C90)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_RESETTODEFAULTROTATE_OFFSET UNITYSDK_OFFSET(0x6EA2480)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_ROTATE_OFFSET UNITYSDK_OFFSET(0x6EA1DA0)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_SET_ROTATEAXIS_OFFSET UNITYSDK_OFFSET(0x6EA1740)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x6EA1750)
#define MOLEMOLE_MONO3DMODELROTATEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6EA2A60)

namespace MoleMole
{
	inline static constexpr unsigned int Mono3DModelRotateHandler_TypeDefinitionIndex = 58463;
