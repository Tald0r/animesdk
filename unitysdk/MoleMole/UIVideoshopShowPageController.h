...
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER_GETBGANIM_OFFSET UNITYSDK_OFFSET(0x9EED110)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER_GETBLACKMASKANIM_OFFSET UNITYSDK_OFFSET(0x9EED1F0)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER_GETCONTENTGO_OFFSET UNITYSDK_OFFSET(0x9EED260)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER_GETINFOANIM_OFFSET UNITYSDK_OFFSET(0x9EED180)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER_GETSKIPBTNANIM_OFFSET UNITYSDK_OFFSET(0x9EED0A0)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9EEC780)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x9EEC9D0)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9EEC790)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER_ONSKIPBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x9EED2E0)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9EED010)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9EEC830)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9EEC8A0)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9EED410)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9EED420)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9EED490)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9EED4A0)
#define MOLEMOLE_UIVIDEOSHOPSHOWPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9EED4B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoshopShowPageController_TypeDefinitionIndex = 67292;
