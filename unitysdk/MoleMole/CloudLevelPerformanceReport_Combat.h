...
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_GET_LEVELID_OFFSET UNITYSDK_OFFSET(0xF2B88B0)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_GET_SCENENAME_OFFSET UNITYSDK_OFFSET(0xF2B8890)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_METHOD_1_2A887DFC7A5BB2CB_OFFSET UNITYSDK_OFFSET(0xF2B88D0)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_METHOD_1_CB48A40E2FBB5B47_OFFSET UNITYSDK_OFFSET(0xF2B8DB0)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_SET_LEVELID_OFFSET UNITYSDK_OFFSET(0xF2B88C0)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_SET_SCENENAME_OFFSET UNITYSDK_OFFSET(0xF2B88A0)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0xF2B8EF0)

namespace MoleMole
{
	inline static constexpr unsigned int CloudLevelPerformanceReport_Combat_TypeDefinitionIndex = 55084;
