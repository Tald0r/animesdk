...
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_GET_LEVELID_OFFSET UNITYSDK_OFFSET(0x13F80360)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_GET_SCENENAME_OFFSET UNITYSDK_OFFSET(0x13F80340)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_METHOD_1_2A887DFC7A5BB2CB_OFFSET UNITYSDK_OFFSET(0x13F80380)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_METHOD_1_CB48A40E2FBB5B47_OFFSET UNITYSDK_OFFSET(0x13F80860)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_SET_LEVELID_OFFSET UNITYSDK_OFFSET(0x13F80370)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_SET_SCENENAME_OFFSET UNITYSDK_OFFSET(0x13F80350)
#define MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x13F809A0)

namespace MoleMole
{
	inline static constexpr unsigned int CloudLevelPerformanceReport_Combat_TypeDefinitionIndex = 54906;
	...
	public:
		...
		{
			return ((::Il2CppArray<::System::Byte>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_CLOUDLEVELPERFORMANCEREPORT_COMBAT_METHOD_1_CB48A40E2FBB5B47_OFFSET))(this);
		}
	};
}
