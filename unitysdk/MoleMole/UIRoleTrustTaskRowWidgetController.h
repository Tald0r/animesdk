...
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A09F80)
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9A0A100)
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A0A020)
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A0A8A0)
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A0A8B0)
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9A0A920)
#define MOLEMOLE_UIROLETRUSTTASKROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A0A9A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleTrustTaskRowWidgetController_TypeDefinitionIndex = 67191;
