...
#define MOLEMOLE_UICOMICPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA336CF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageContext_TypeDefinitionIndex = 41620;
	...
	public:
		...
		::System::Action* executeWhenFadeOutStart; // 0x50
		::System::String* IntroKey; // 0x58
		::System::String* FadeInParam; // 0x60
		::System::Int32 PerformId; // 0x68
		::System::Boolean overrideFadeOutByOuside; // 0x6C
		::System::Boolean ConnectCutScene; // 0x6D
		::System::Boolean connectExitHollow; // 0x6E
