...
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDC73110)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_INITEMOJIUI_OFFSET UNITYSDK_OFFSET(0xDC734F0)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_ONCLICKEMOJIICON_OFFSET UNITYSDK_OFFSET(0xDC73BF0)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDC73AC0)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDC73B60)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDC73120)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDC73A10)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC740E0)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0xDC74220)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDC743B0)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDC74420)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDC74430)
#define MOLEMOLE_UICHATEMOJICOLLECTIONPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDC74440)

namespace MoleMole
{
	inline static constexpr unsigned int UIChatEmojiCollectionPopWindowController_TypeDefinitionIndex = 64239;
