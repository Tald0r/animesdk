...
#define MOLEMOLE_MONOEFFECTPLUGINSTATEANIMATION_GET_STATEPLAYMESSAGE_OFFSET UNITYSDK_OFFSET(0x75B1BB0)
#define MOLEMOLE_MONOEFFECTPLUGINSTATEANIMATION_ISTRANSITIONALLOWED_OFFSET UNITYSDK_OFFSET(0x75B2220)
#define MOLEMOLE_MONOEFFECTPLUGINSTATEANIMATION_METHOD_7_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x75B24A0)
#define MOLEMOLE_MONOEFFECTPLUGINSTATEANIMATION_METHOD_7_6E6F865C6BBBA8DD_OFFSET UNITYSDK_OFFSET(0x75B1CF0)
#define MOLEMOLE_MONOEFFECTPLUGINSTATEANIMATION_METHOD_7_8DB98345F9A815B2_OFFSET UNITYSDK_OFFSET(0x75B2750)
#define MOLEMOLE_MONOEFFECTPLUGINSTATEANIMATION_METHOD_7_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x75B2910)
#define MOLEMOLE_MONOEFFECTPLUGINSTATEANIMATION_METHOD_7_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x75B1B40)
#define MOLEMOLE_MONOEFFECTPLUGINSTATEANIMATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x75B19E0)
#define MOLEMOLE_MONOEFFECTPLUGINSTATEANIMATION_ONSTATEMESSAGE_OFFSET UNITYSDK_OFFSET(0x75B1BF0)
#define MOLEMOLE_MONOEFFECTPLUGINSTATEANIMATION_PLAYANIMATIONBYSTATE_OFFSET UNITYSDK_OFFSET(0x75B1F10)
#define MOLEMOLE_MONOEFFECTPLUGINSTATEANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x75B2630)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginStateAnimation_TypeDefinitionIndex = 76012;
