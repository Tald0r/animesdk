...
#define MOLEMOLE_UISOCIALCIRCLEINVITEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAE64F30)
#define MOLEMOLE_UISOCIALCIRCLEINVITEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAE65040)
#define MOLEMOLE_UISOCIALCIRCLEINVITEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAE65140)
#define MOLEMOLE_UISOCIALCIRCLEINVITEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE64FA0)
#define MOLEMOLE_UISOCIALCIRCLEINVITEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE65290)
#define MOLEMOLE_UISOCIALCIRCLEINVITEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAE652A0)
#define MOLEMOLE_UISOCIALCIRCLEINVITEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAE65310)
#define MOLEMOLE_UISOCIALCIRCLEINVITEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE65390)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleInviteRowWidgetController_TypeDefinitionIndex = 67540;
