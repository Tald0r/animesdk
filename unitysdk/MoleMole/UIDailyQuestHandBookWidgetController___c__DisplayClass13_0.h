...
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA26EC00)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS13_0__TRYTAKEVITALITYREWARDS_B__0_OFFSET UNITYSDK_OFFSET(0xA26EC10)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS13_0__TRYTAKEVITALITYREWARDS_B__1_OFFSET UNITYSDK_OFFSET(0xA26EE00)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS13_0__TRYTAKEVITALITYREWARDS_B__2_OFFSET UNITYSDK_OFFSET(0xA26EDA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestHandBookWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 73746;
