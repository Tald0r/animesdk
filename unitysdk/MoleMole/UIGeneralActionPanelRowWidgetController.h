...
#define MOLEMOLE_UIGENERALACTIONPANELROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x911BC90)
#define MOLEMOLE_UIGENERALACTIONPANELROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x911BD00)
#define MOLEMOLE_UIGENERALACTIONPANELROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x911BDC0)
#define MOLEMOLE_UIGENERALACTIONPANELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x911BFA0)
#define MOLEMOLE_UIGENERALACTIONPANELROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x911BFB0)
#define MOLEMOLE_UIGENERALACTIONPANELROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x911C020)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralActionPanelRowWidgetController_TypeDefinitionIndex = 43981;
