...
#define MOLEMOLE_MONOHOLLOWEFFANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xD814010)

namespace MoleMole
{
	inline static constexpr unsigned int MonoHollowEffAnim_TypeDefinitionIndex = 58407;
