...
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA4D14E0)
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER_SHOWAVATARHEAD_OFFSET UNITYSDK_OFFSET(0xA4D15D0)
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA4D1BB0)
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4D1BA0)
#define MOLEMOLE_UIAVATARHEADWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA4D1BC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarHeadWidgetController_TypeDefinitionIndex = 76211;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIAvatarHeadWidgetController_TypeDefinitionIndex)->GetStaticField(0xFE70);
		}
