...
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_GETBADGE_OFFSET UNITYSDK_OFFSET(0xD259D90)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_GETTABBUTTON_OFFSET UNITYSDK_OFFSET(0xD259BA0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD259B00)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD259C10)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD2599B0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD259A50)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0xD259CF0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD259E00)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD259E30)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD259EA0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD259F20)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD259F80)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVTabBtnRowWidgetController_TypeDefinitionIndex = 40211;
