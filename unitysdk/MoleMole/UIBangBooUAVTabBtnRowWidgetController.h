...
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_GETBADGE_OFFSET UNITYSDK_OFFSET(0xA257640)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_GETTABBUTTON_OFFSET UNITYSDK_OFFSET(0xA257450)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA2573B0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA2574C0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA257260)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA257300)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0xA2575A0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA2576B0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA2576E0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA257750)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA2577D0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA257830)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVTabBtnRowWidgetController_TypeDefinitionIndex = 65102;

	class UIBangBooUAVTabBtnRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_181FF645A3E1F2C4* _view; // 0x2A0
