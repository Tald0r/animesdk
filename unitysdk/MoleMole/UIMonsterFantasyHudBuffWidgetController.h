...
#define MOLEMOLE_UIMONSTERFANTASYHUDBUFFWIDGETCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB511840)
#define MOLEMOLE_UIMONSTERFANTASYHUDBUFFWIDGETCONTROLLER_GET_BUFFROOT2_OFFSET UNITYSDK_OFFSET(0xB5114F0)
#define MOLEMOLE_UIMONSTERFANTASYHUDBUFFWIDGETCONTROLLER_GET_BUFFROOT_OFFSET UNITYSDK_OFFSET(0xB511470)
#define MOLEMOLE_UIMONSTERFANTASYHUDBUFFWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB5116C0)
#define MOLEMOLE_UIMONSTERFANTASYHUDBUFFWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB511760)
#define MOLEMOLE_UIMONSTERFANTASYHUDBUFFWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB511570)
#define MOLEMOLE_UIMONSTERFANTASYHUDBUFFWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB511610)
#define MOLEMOLE_UIMONSTERFANTASYHUDBUFFWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB5118B0)
#define MOLEMOLE_UIMONSTERFANTASYHUDBUFFWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB5118E0)
#define MOLEMOLE_UIMONSTERFANTASYHUDBUFFWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB511950)
#define MOLEMOLE_UIMONSTERFANTASYHUDBUFFWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB5119D0)
#define MOLEMOLE_UIMONSTERFANTASYHUDBUFFWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB511A30)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyHudBuffWidgetController_TypeDefinitionIndex = 37601;

	class UIMonsterFantasyHudBuffWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_69CBB7FF0BE6A673* _view; // 0x2A0
