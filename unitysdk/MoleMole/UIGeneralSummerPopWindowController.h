...
class Class_2_C18465D44B43E388;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UIGENERALSUMMERPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9600AF0)
#define MOLEMOLE_UIGENERALSUMMERPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9600BD0)
#define MOLEMOLE_UIGENERALSUMMERPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9600C40)
#define MOLEMOLE_UIGENERALSUMMERPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9600D40)
#define MOLEMOLE_UIGENERALSUMMERPOPWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x9600B00)
#define MOLEMOLE_UIGENERALSUMMERPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9600E80)
#define MOLEMOLE_UIGENERALSUMMERPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9600E90)
#define MOLEMOLE_UIGENERALSUMMERPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9600F00)
#define MOLEMOLE_UIGENERALSUMMERPOPWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x9600F70)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSummerPopWindowController_TypeDefinitionIndex = 57694;
	...
	public:
		...
		::Class_2_C18465D44B43E388* get__viewModel()
		{
			return ((::Class_2_C18465D44B43E388*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALSUMMERPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
