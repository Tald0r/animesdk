...
#define MOLEMOLE_UIGENERALSMALLTIPSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xDFC4B10)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSmallTipsContext_TypeDefinitionIndex = 69048;
