...
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_CHANGELIGHTMAT_OFFSET UNITYSDK_OFFSET(0x99F3C10)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_CHANGEMATERIAL_OFFSET UNITYSDK_OFFSET(0x99F3E60)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x99F3A00)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x99F2810)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x99F2D40)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x99F2EC0)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x99F2990)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x99F2820)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x99F28C0)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_SETTHRESHOLDLINEPOSITION_OFFSET UNITYSDK_OFFSET(0x99F2B90)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x99F3EC0)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x99F3ED0)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x99F3F30)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x99F3FA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelEvelynPanelChildWindowController_TypeDefinitionIndex = 77629;
	...
	public:
		...
		::Class_2_F79521A937A96176* _view; // 0x330
