...
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_CHANGELIGHTMAT_OFFSET UNITYSDK_OFFSET(0x9430140)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_CHANGEMATERIAL_OFFSET UNITYSDK_OFFSET(0x9430390)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x942FF30)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x942ED30)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x942F260)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x942F3E0)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x942EEB0)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x942ED40)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x942EDE0)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER_SETTHRESHOLDLINEPOSITION_OFFSET UNITYSDK_OFFSET(0x942F0B0)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x94303F0)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x9430400)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9430460)
#define MOLEMOLE_UIINLEVELEVELYNPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x94304D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelEvelynPanelChildWindowController_TypeDefinitionIndex = 54122;
