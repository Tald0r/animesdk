...
#define MOLEMOLE_COMICCLIPBASEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A747B40)

namespace MoleMole
{
	inline static constexpr unsigned int ComicClipBaseInfo_TypeDefinitionIndex = 29091;
