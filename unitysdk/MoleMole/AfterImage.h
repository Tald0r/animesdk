...
#define MOLEMOLE_AFTERIMAGE_ACTIVATEAFTERIMAGE_OFFSET UNITYSDK_OFFSET(0x89DA370)
#define MOLEMOLE_AFTERIMAGE_AWAKE_OFFSET UNITYSDK_OFFSET(0x89D7F00)
#define MOLEMOLE_AFTERIMAGE_DEACTIVATEAFTERIMAGE_OFFSET UNITYSDK_OFFSET(0x89DAFA0)
#define MOLEMOLE_AFTERIMAGE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x89D86A0)
#define MOLEMOLE_AFTERIMAGE_GENERALTRANSDICT_OFFSET UNITYSDK_OFFSET(0x89D7F70)
#define MOLEMOLE_AFTERIMAGE_GET_IMAGELIFETIME_OFFSET UNITYSDK_OFFSET(0x89D7E80)
#define MOLEMOLE_AFTERIMAGE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x89D9530)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_0817012C9B9D8577_OFFSET UNITYSDK_OFFSET(0x89DB1F0)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_21B23FB7F45D62F4_OFFSET UNITYSDK_OFFSET(0x89DB070)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x89D96E0)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_749607E7C46D8CFE_OFFSET UNITYSDK_OFFSET(0x89D9760)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0x89D8710)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_CD28994AFE636FFF_OFFSET UNITYSDK_OFFSET(0x89DA5E0)
#define MOLEMOLE_AFTERIMAGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x89D8620)
#define MOLEMOLE_AFTERIMAGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x89D85B0)
#define MOLEMOLE_AFTERIMAGE_SET_IMAGELIFETIME_OFFSET UNITYSDK_OFFSET(0x89D7EF0)
#define MOLEMOLE_AFTERIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x89DB010)

namespace MoleMole
{
	inline static constexpr unsigned int AfterImage_TypeDefinitionIndex = 73130;
	...
	public:
		...
		::UnityEngine::Material* Method_5_21B23FB7F45D62F4()
		{
			return ((::UnityEngine::Material*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_AFTERIMAGE_METHOD_5_21B23FB7F45D62F4_OFFSET))(this);
		}

		::System::Void Method_5_749607E7C46D8CFE(::System::Int32 a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_AFTERIMAGE_METHOD_5_749607E7C46D8CFE_OFFSET))(this, a1);
		}
