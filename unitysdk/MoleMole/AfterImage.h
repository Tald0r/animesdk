...
#define MOLEMOLE_AFTERIMAGE_ACTIVATEAFTERIMAGE_OFFSET UNITYSDK_OFFSET(0xB379CB0)
#define MOLEMOLE_AFTERIMAGE_AWAKE_OFFSET UNITYSDK_OFFSET(0xB377840)
#define MOLEMOLE_AFTERIMAGE_DEACTIVATEAFTERIMAGE_OFFSET UNITYSDK_OFFSET(0xB37A8E0)
#define MOLEMOLE_AFTERIMAGE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xB377FE0)
#define MOLEMOLE_AFTERIMAGE_GENERALTRANSDICT_OFFSET UNITYSDK_OFFSET(0xB3778B0)
#define MOLEMOLE_AFTERIMAGE_GET_IMAGELIFETIME_OFFSET UNITYSDK_OFFSET(0xB3777C0)
#define MOLEMOLE_AFTERIMAGE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB378E70)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_0817012C9B9D8577_OFFSET UNITYSDK_OFFSET(0xB37A9B0)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_21B23FB7F45D62F4_OFFSET UNITYSDK_OFFSET(0xB37ACB0)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB379020)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_749607E7C46D8CFE_OFFSET UNITYSDK_OFFSET(0xB3790A0)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0xB378050)
#define MOLEMOLE_AFTERIMAGE_METHOD_5_CD28994AFE636FFF_OFFSET UNITYSDK_OFFSET(0xB379F20)
#define MOLEMOLE_AFTERIMAGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB377F60)
#define MOLEMOLE_AFTERIMAGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB377EF0)
#define MOLEMOLE_AFTERIMAGE_SET_IMAGELIFETIME_OFFSET UNITYSDK_OFFSET(0xB377830)
#define MOLEMOLE_AFTERIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB37A950)

namespace MoleMole
{
	inline static constexpr unsigned int AfterImage_TypeDefinitionIndex = 60795;
