...
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA_GET_BADGESUBID_OFFSET UNITYSDK_OFFSET(0xAAB8FC0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA_GET_BADGETYPE_OFFSET UNITYSDK_OFFSET(0xAAB8FB0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xAAB8F10)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAAB90A0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA___BASE_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xAAB9140)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchTrustDegreePageController_PartnerCampTypeTemplateData_TypeDefinitionIndex = 64164;
