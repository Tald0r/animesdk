...
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA_GET_BADGESUBID_OFFSET UNITYSDK_OFFSET(0x95B8860)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA_GET_BADGETYPE_OFFSET UNITYSDK_OFFSET(0x95B8850)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x95B87B0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x95B8940)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTYPETEMPLATEDATA___BASE_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x95B89D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchTrustDegreePageController_PartnerCampTypeTemplateData_TypeDefinitionIndex = 80398;
