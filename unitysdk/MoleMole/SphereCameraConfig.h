...
#define MOLEMOLE_SPHERECAMERACONFIG_GET_OVERRIDEFOCUSPOINTHEIGHTVALUE_OFFSET UNITYSDK_OFFSET(0x9ACD6A0)
#define MOLEMOLE_SPHERECAMERACONFIG_SET_OVERRIDEFOCUSPOINTHEIGHTVALUE_OFFSET UNITYSDK_OFFSET(0x9ACD6B0)
#define MOLEMOLE_SPHERECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9ACD730)

namespace MoleMole
{
	inline static constexpr unsigned int SphereCameraConfig_TypeDefinitionIndex = 41198;
