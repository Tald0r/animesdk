...
#define MOLEMOLE_MONOINLEVELLOCK_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x6E41850)
#define MOLEMOLE_MONOINLEVELLOCK_METHOD_5_DEC8270AEB6D885D_OFFSET UNITYSDK_OFFSET(0x6E41AB0)
#define MOLEMOLE_MONOINLEVELLOCK_METHOD_5_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0x6E41D90)
#define MOLEMOLE_MONOINLEVELLOCK_METHOD_5_FA0119DD445A672F_OFFSET UNITYSDK_OFFSET(0x6E41D20)
#define MOLEMOLE_MONOINLEVELLOCK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6E41630)
#define MOLEMOLE_MONOINLEVELLOCK_RESET_OFFSET UNITYSDK_OFFSET(0x6E419F0)
#define MOLEMOLE_MONOINLEVELLOCK_SETLOCKFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x6E41980)
#define MOLEMOLE_MONOINLEVELLOCK_START_OFFSET UNITYSDK_OFFSET(0x6E413E0)
#define MOLEMOLE_MONOINLEVELLOCK_UPDATEPOSITION_OFFSET UNITYSDK_OFFSET(0x6E418D0)
#define MOLEMOLE_MONOINLEVELLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x6E41A80)

namespace MoleMole
{
	inline static constexpr unsigned int MonoInlevelLock_TypeDefinitionIndex = 68813;
