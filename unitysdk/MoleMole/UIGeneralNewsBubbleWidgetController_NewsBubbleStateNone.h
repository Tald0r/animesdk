...
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATENONE_GET_STATE_OFFSET UNITYSDK_OFFSET(0xB2BD140)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATENONE_ONCHANGESTATE_OFFSET UNITYSDK_OFFSET(0xB2BD150)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATENONE__CTOR_OFFSET UNITYSDK_OFFSET(0xB2BD130)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATENONE___BASE_ONCHANGESTATE_OFFSET UNITYSDK_OFFSET(0xB2BD610)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleWidgetController_NewsBubbleStateNone_TypeDefinitionIndex = 68360;
