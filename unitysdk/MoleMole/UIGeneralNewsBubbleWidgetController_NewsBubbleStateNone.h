...
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATENONE_GET_STATE_OFFSET UNITYSDK_OFFSET(0x8A16D10)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATENONE_ONCHANGESTATE_OFFSET UNITYSDK_OFFSET(0x8A16D20)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATENONE__CTOR_OFFSET UNITYSDK_OFFSET(0x8A16D00)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATENONE___BASE_ONCHANGESTATE_OFFSET UNITYSDK_OFFSET(0x8A171E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleWidgetController_NewsBubbleStateNone_TypeDefinitionIndex = 75078;
