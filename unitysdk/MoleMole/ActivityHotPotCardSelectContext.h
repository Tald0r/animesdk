...
#define MOLEMOLE_ACTIVITYHOTPOTCARDSELECTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x94DA710)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityHotPotCardSelectContext_TypeDefinitionIndex = 68835;

	class ActivityHotPotCardSelectContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Int32 DialogType; // 0x28
