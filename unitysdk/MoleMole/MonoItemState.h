...
#define MOLEMOLE_MONOITEMSTATE_GETTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD8140D0)
#define MOLEMOLE_MONOITEMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xD814250)

namespace MoleMole
{
	inline static constexpr unsigned int MonoItemState_TypeDefinitionIndex = 63335;
