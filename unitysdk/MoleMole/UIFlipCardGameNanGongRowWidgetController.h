...
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER_GETCARDID_OFFSET UNITYSDK_OFFSET(0xAC55EC0)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xAC561F0)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC55790)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER_ONREQUESTFLIPCARDSUCCESS_OFFSET UNITYSDK_OFFSET(0xAC564E0)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC55910)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC55830)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC55460)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAC55A00)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER_SHOWFLIPEDCARDREWARDPOPWINDOW_OFFSET UNITYSDK_OFFSET(0xAC55F70)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC566B0)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER__ONREQUESTFLIPCARDSUCCESS_B__16_0_OFFSET UNITYSDK_OFFSET(0xAC566C0)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xAC56700)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC56710)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC56780)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC56800)
#define MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC56880)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlipCardGameNanGongRowWidgetController_TypeDefinitionIndex = 61775;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFLIPCARDGAMENANGONGROWWIDGETCONTROLLER_ONREQUESTFLIPCARDSUCCESS_OFFSET))(this, rcvmessage);
		}
