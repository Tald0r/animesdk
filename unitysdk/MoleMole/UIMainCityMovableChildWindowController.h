...
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_CLEARMOVESPEED_OFFSET UNITYSDK_OFFSET(0x8EC7350)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_GETPOS_OFFSET UNITYSDK_OFFSET(0x8EC7E90)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8EC5660)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_INITCONTEXT_OFFSET UNITYSDK_OFFSET(0x8EC5EA0)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_MOVEOBJ_OFFSET UNITYSDK_OFFSET(0x8EC7A30)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EC6F20)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x8EC7520)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONMOVEOBJ_OFFSET UNITYSDK_OFFSET(0x8EC7740)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8EC5E30)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EC6FC0)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EC5670)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8EC6960)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_SETCAMBYKEY_OFFSET UNITYSDK_OFFSET(0x8EC6180)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_SETDATABYVO_OFFSET UNITYSDK_OFFSET(0x8EC62D0)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_SETUPTAB_OFFSET UNITYSDK_OFFSET(0x8EC6A90)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_SWITCHOBJ_OFFSET UNITYSDK_OFFSET(0x8EC7F90)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_TRYSENDEVENTTOOPENVO_OFFSET UNITYSDK_OFFSET(0x8EC7470)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_TRYSENDEVENT_OFFSET UNITYSDK_OFFSET(0x8EC7DF0)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8EC8070)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EC8080)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x8EC80F0)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8EC8120)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EC8130)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EC8140)
#define MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8EC8150)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMovableChildWindowController_TypeDefinitionIndex = 52004;
	...
	public:
		...
		::Enum_3_E36C894DCA3F304A_1 curObjDir; // 0x368
		...
		::System::Void TrySendEvent(::Enum_3_BB0E1DD4C880324C graphEvent)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_BB0E1DD4C880324C))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_TRYSENDEVENT_OFFSET))(this, graphEvent);
		}

		::System::Void TrySendEventToOpenVo(::Enum_3_BB0E1DD4C880324C graphEvent)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_BB0E1DD4C880324C))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYMOVABLECHILDWINDOWCONTROLLER_TRYSENDEVENTTOOPENVO_OFFSET))(this, graphEvent);
		}
