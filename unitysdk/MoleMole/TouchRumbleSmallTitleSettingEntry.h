...
#define MOLEMOLE_TOUCHRUMBLESMALLTITLESETTINGENTRY_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xA4AE940)
#define MOLEMOLE_TOUCHRUMBLESMALLTITLESETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AEA00)
#define MOLEMOLE_TOUCHRUMBLESMALLTITLESETTINGENTRY___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xA4AEA20)

namespace MoleMole
{
	inline static constexpr unsigned int TouchRumbleSmallTitleSettingEntry_TypeDefinitionIndex = 47858;
