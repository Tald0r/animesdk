...
#define MOLEMOLE_TOUCHRUMBLESMALLTITLESETTINGENTRY_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xD224990)
#define MOLEMOLE_TOUCHRUMBLESMALLTITLESETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xD224A50)
#define MOLEMOLE_TOUCHRUMBLESMALLTITLESETTINGENTRY___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xD224A70)

namespace MoleMole
{
	inline static constexpr unsigned int TouchRumbleSmallTitleSettingEntry_TypeDefinitionIndex = 80481;
