...
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS82_0__CTOR_OFFSET UNITYSDK_OFFSET(0xDDD71A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS82_0__SHOWCLEARALLBUBBLE_B__0_OFFSET UNITYSDK_OFFSET(0xDDD71B0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS82_0__SHOWCLEARALLBUBBLE_B__1_OFFSET UNITYSDK_OFFSET(0xDDD7590)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS82_0__SHOWCLEARALLBUBBLE_B__2_OFFSET UNITYSDK_OFFSET(0xDDD7690)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS82_0__SHOWCLEARALLBUBBLE_B__3_OFFSET UNITYSDK_OFFSET(0xDDD7520)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS82_0__SHOWCLEARALLBUBBLE_B__4_OFFSET UNITYSDK_OFFSET(0xDDD7640)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS82_0__SHOWCLEARALLBUBBLE_B__5_OFFSET UNITYSDK_OFFSET(0xDDD78B0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSinglePlayWidgetController___c__DisplayClass82_0_TypeDefinitionIndex = 38048;
	...
	public:
		...
		::MoleMole::UICinemaSingleClearAllBubbleWidgetController* bubbleWidget; // 0x30
