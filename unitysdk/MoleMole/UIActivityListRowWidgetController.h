...
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFA9B20)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0xBFA9D90)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xBFA9CA0)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFA9E70)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFA9BC0)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFA9980)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_SHOWQUESTLISTDATA_OFFSET UNITYSDK_OFFSET(0xBFAA010)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFAA1E0)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFAA1F0)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER___BASE_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0xBFAA260)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xBFAA2C0)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFAA330)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFAA3B0)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFAA430)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityListRowWidgetController_TypeDefinitionIndex = 50359;
