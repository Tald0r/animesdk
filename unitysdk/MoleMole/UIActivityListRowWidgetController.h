...
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBADD0A0)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0xBADD310)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xBADD220)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBADD3F0)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBADD140)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBADCF00)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER_SHOWQUESTLISTDATA_OFFSET UNITYSDK_OFFSET(0xBADD590)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBADD760)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBADD770)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER___BASE_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0xBADD7E0)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xBADD840)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBADD8B0)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBADD930)
#define MOLEMOLE_UIACTIVITYLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBADD9B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityListRowWidgetController_TypeDefinitionIndex = 72426;

	class UIActivityListRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_334F241D84137A22* _view; // 0x2D0
		::Class_1_6D028104A2786020* _activityQuestListData; // 0x2D8
