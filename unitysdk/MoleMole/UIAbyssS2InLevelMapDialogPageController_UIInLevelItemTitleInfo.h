...
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMTITLEINFO_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xC278410)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMTITLEINFO_SETBRIEF_OFFSET UNITYSDK_OFFSET(0xC278470)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMTITLEINFO_SETSELECT_OFFSET UNITYSDK_OFFSET(0xC2784E0)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMTITLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC273B40)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2InLevelMapDialogPageController_UIInLevelItemTitleInfo_TypeDefinitionIndex = 44693;
