...
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_BINDBUTTON_OFFSET UNITYSDK_OFFSET(0xDFA15B0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0xDFA1A80)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0xDFA1610)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_CREATESUBWIDGET_OFFSET UNITYSDK_OFFSET(0xDFA1B30)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_GET_CURRENTNUM_OFFSET UNITYSDK_OFFSET(0xDFA2030)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_GET_MAXNUM_OFFSET UNITYSDK_OFFSET(0xDFA1DF0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xDFA1C30)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDFA1B90)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDFA18F0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDFA1D10)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDFA1490)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_SET_CURRENTNUM_OFFSET UNITYSDK_OFFSET(0xDFA2120)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_SET_MAXNUM_OFFSET UNITYSDK_OFFSET(0xDFA1EE0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__14_0_OFFSET UNITYSDK_OFFSET(0xDFA23A0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__14_1_OFFSET UNITYSDK_OFFSET(0xDFA2AD0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__14_2_OFFSET UNITYSDK_OFFSET(0xDFA2C80)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__14_3_OFFSET UNITYSDK_OFFSET(0xDFA28E0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__14_4_OFFSET UNITYSDK_OFFSET(0xDFA29D0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xDFA2340)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDFA2270)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xDFA2DA0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDFA2E00)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDFA2E70)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDFA2EE0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDFA2F60)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMainTagWidgetController_TypeDefinitionIndex = 42374;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIFlowerMainTagWidgetController_TypeDefinitionIndex)->GetStaticField(0x479F0);
		}
		static ::System::String** StaticGet__fillUp()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIFlowerMainTagWidgetController_TypeDefinitionIndex)->GetStaticField(0x479F8);
		}
		static ::System::Single* StaticGet__animTime()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIFlowerMainTagWidgetController_TypeDefinitionIndex)->GetStaticField(0x118A0);
		}
