...
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_BINDBUTTON_OFFSET UNITYSDK_OFFSET(0xC636620)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0xC636AF0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0xC636680)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_CREATESUBWIDGET_OFFSET UNITYSDK_OFFSET(0xC636BA0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_GET_CURRENTNUM_OFFSET UNITYSDK_OFFSET(0xC6370A0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_GET_MAXNUM_OFFSET UNITYSDK_OFFSET(0xC636E60)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xC636CA0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC636C00)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC636960)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC636D80)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC636500)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_SET_CURRENTNUM_OFFSET UNITYSDK_OFFSET(0xC637190)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER_SET_MAXNUM_OFFSET UNITYSDK_OFFSET(0xC636F50)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__14_0_OFFSET UNITYSDK_OFFSET(0xC637410)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__14_1_OFFSET UNITYSDK_OFFSET(0xC637B40)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__14_2_OFFSET UNITYSDK_OFFSET(0xC637CF0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__14_3_OFFSET UNITYSDK_OFFSET(0xC637950)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__14_4_OFFSET UNITYSDK_OFFSET(0xC637A40)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC6373B0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC6372E0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xC637E10)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC637E70)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC637EE0)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC637F50)
#define MOLEMOLE_UIFLOWERMAINTAGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC637FD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMainTagWidgetController_TypeDefinitionIndex = 75967;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIFlowerMainTagWidgetController_TypeDefinitionIndex)->GetStaticField(0x41710);
		}
		static ::System::String** StaticGet__fillUp()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIFlowerMainTagWidgetController_TypeDefinitionIndex)->GetStaticField(0x41718);
		}
		static ::System::Single* StaticGet__animTime()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIFlowerMainTagWidgetController_TypeDefinitionIndex)->GetStaticField(0x101B0);
		}
		::Class_2_3E1A0459A6647B99_5* _view; // 0x2A0
		::MoleMole::UIFlowerMainTagWidgetController_Context* _context; // 0x2A8
		::MoleMole::UIFlowerMainTagWidgetController_ViewModel* _viewModel; // 0x2B0
		::Class_1_48D56DACBE4271BC* _propertySyncHelper; // 0x2B8
		::Class_1_48D56DACBE4271BC* _propertySyncHelper_ViewModel; // 0x2C0
		::DG::Tweening::Tweener* _fillTweener; // 0x2C8
