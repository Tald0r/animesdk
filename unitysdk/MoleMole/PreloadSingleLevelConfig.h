...
#define MOLEMOLE_PRELOADSINGLELEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC7D53E0)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadSingleLevelConfig_TypeDefinitionIndex = 74258;
