...
#define MOLEMOLE_PRELOADSINGLELEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9942720)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadSingleLevelConfig_TypeDefinitionIndex = 64684;
