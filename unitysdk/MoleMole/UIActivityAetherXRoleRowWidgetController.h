...
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER_BINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xDC2ECF0)
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER_INITROLEINDEX_OFFSET UNITYSDK_OFFSET(0xDC2EAB0)
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDC2E930)
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDC2E9D0)
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDC2E6A0)
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDC2E880)
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xDC2EC60)
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0xDC2EB20)
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC2ED60)
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0xDC2ED90)
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDC2EDF0)
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDC2EE60)
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDC2EEE0)
#define MOLEMOLE_UIACTIVITYAETHERXROLEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDC2EF40)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityAetherXRoleRowWidgetController_TypeDefinitionIndex = 72840;
