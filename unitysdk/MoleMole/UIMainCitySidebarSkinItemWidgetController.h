...
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8F3EBD0)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8F3EC40)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8F3ED00)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8F3EDE0)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F3EF80)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8F3EF90)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8F3F000)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySidebarSkinItemWidgetController_TypeDefinitionIndex = 64684;
