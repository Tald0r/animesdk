...
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA82C480)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA82C4F0)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA82C5B0)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA82C690)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA82C830)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA82C840)
#define MOLEMOLE_UIMAINCITYSIDEBARSKINITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA82C8B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySidebarSkinItemWidgetController_TypeDefinitionIndex = 50262;
