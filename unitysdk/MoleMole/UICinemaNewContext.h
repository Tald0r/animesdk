...
#define MOLEMOLE_UICINEMANEWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCB2FCA0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaNewContext_TypeDefinitionIndex = 69734;
