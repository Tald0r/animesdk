...
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_ADDCONTEXT_OFFSET UNITYSDK_OFFSET(0x6C615B0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_GETINTIMACYUPWIDGET_OFFSET UNITYSDK_OFFSET(0x6C61800)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x6C60F00)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x6C60EF0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C612E0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C61520)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6C60F10)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_ONUIOPENINNER_OFFSET UNITYSDK_OFFSET(0x6C61210)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6C61150)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x6C619C0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x6C61380)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6C61C60)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER__REFRESHVIEW_G__SETUPWIDGET_14_0_OFFSET UNITYSDK_OFFSET(0x6C61B30)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C61C70)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C61CE0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6C61CF0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6C61D00)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x6C61D70)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralIntimacyUpPopWindowController_TypeDefinitionIndex = 77641;
