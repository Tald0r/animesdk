...
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_ADDCONTEXT_OFFSET UNITYSDK_OFFSET(0x8C084B0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_GETINTIMACYUPWIDGET_OFFSET UNITYSDK_OFFSET(0x8C08700)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x8C07E00)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8C07DF0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C081E0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C08420)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C07E10)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_ONUIOPENINNER_OFFSET UNITYSDK_OFFSET(0x8C08110)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C08050)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8C088C0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x8C08280)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C08B60)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER__REFRESHVIEW_G__SETUPWIDGET_14_0_OFFSET UNITYSDK_OFFSET(0x8C08A30)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C08B70)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C08BE0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C08BF0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C08C00)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x8C08C70)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralIntimacyUpPopWindowController_TypeDefinitionIndex = 39702;

	class UIGeneralIntimacyUpPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_222675B5E8E17837* _view; // 0x2F8
		::MoleMole::UIGeneralIntimacyUpPopWindowController_Context* _context; // 0x300
		::MoleMole::UIGeneralIntimacyChangeWidgetController* _intimacyUpWidget01; // 0x308
		::MoleMole::UIGeneralIntimacyChangeWidgetController* _intimacyUpWidget02; // 0x310
		::MoleMole::UIGeneralIntimacyChangeWidgetController* _intimacyUpWidget03; // 0x318
		::MoleMole::UIGeneralIntimacyChangeWidgetController* _intimacyUpWidget04; // 0x320
		::MoleMole::UIGeneralIntimacyChangeWidgetController* _intimacyDownWidget; // 0x328
		::System::Collections::Generic::List_1<::MoleMole::UIGeneralIntimacyUpPopWindowController_Context*>* _contextQueue; // 0x330
