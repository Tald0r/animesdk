...
#define MOLEMOLE_MONOCINEMACAMERALIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC232F10)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCinemaCameraLightConfig_TypeDefinitionIndex = 40308;
