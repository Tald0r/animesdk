...
#define MOLEMOLE_COMICSCREENINFO_ANIMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A437800)

namespace MoleMole
{
	inline static constexpr unsigned int ComicScreenInfo_AnimInfo_TypeDefinitionIndex = 29103;
