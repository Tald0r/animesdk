...
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER___C__DISPLAYCLASS94_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBE7F560)
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER___C__DISPLAYCLASS94_0__ONCLICKSWITCHSKININDEX_B__0_OFFSET UNITYSDK_OFFSET(0xBE7F570)
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER___C__DISPLAYCLASS94_0__ONCLICKSWITCHSKININDEX_B__1_OFFSET UNITYSDK_OFFSET(0xBE7F690)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerAccessoryPageController___c__DisplayClass94_0_TypeDefinitionIndex = 77125;
