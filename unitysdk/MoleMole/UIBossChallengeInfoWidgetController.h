...
class Class_2_79AE422BA06F6D26_176_Class_2_FA228B66D064C2D1;
...
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_APPLYBOSSCHALLENGETEAMINFOS_OFFSET UNITYSDK_OFFSET(0xDC69CB0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_CALCLINEUPSELECTIONFROMRECORD_OFFSET UNITYSDK_OFFSET(0xDC668C0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_CHECKBUDDYCUSTOMSELECTSTR_OFFSET UNITYSDK_OFFSET(0xDC68F60)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_CUSTOMGETMULTIINDEXSTR_OFFSET UNITYSDK_OFFSET(0xDC68710)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_CUSTOMGETOTHERTEAMSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xDC68500)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_GETRESISTLIST_OFFSET UNITYSDK_OFFSET(0xDC65310)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_GETSHOWINGLAYERINDEX_OFFSET UNITYSDK_OFFSET(0xDC67010)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_GET__LAYERRECORD_OFFSET UNITYSDK_OFFSET(0xDC62DF0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_INITENDTIMER_OFFSET UNITYSDK_OFFSET(0xDC662C0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_INITROLE_OFFSET UNITYSDK_OFFSET(0xDC63760)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ISLAYERLINEUPCHANGED_OFFSET UNITYSDK_OFFSET(0xDC68210)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ISLAYERROLESLOCKED_OFFSET UNITYSDK_OFFSET(0xDC6A3B0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ISLINEUPSELECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0xDC68080)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDC64860)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ONGETROLESELECTCONTEXT_OFFSET UNITYSDK_OFFSET(0xDC688C0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xDC64BE0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ONPOSTGETBUDDYSELECTCONTEXT_OFFSET UNITYSDK_OFFSET(0xDC68EA0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ONRESETSUCCESS_OFFSET UNITYSDK_OFFSET(0xDC67B90)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ONSELECTCHECKHANDLE_OFFSET UNITYSDK_OFFSET(0xDC67930)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ONSELECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0xDC691A0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDC649E0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDC64900)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDC62EF0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDC639F0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_OPENBUFFDIALOG_OFFSET UNITYSDK_OFFSET(0xDC67C00)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_OPENSELECTROLEPAGE_OFFSET UNITYSDK_OFFSET(0xDC67080)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_RECONFIRMSELECTIONCHANGEDONLINEUPCLOSE_OFFSET UNITYSDK_OFFSET(0xDC67E90)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_REFRESHROLES_OFFSET UNITYSDK_OFFSET(0xDC65670)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_REFRESHSCORES_OFFSET UNITYSDK_OFFSET(0xDC64DD0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_REFRESHSELECTEDBUFF_OFFSET UNITYSDK_OFFSET(0xDC65AF0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xDC63DA0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_SETQUICKEDITORCONTEXTHANDLE_OFFSET UNITYSDK_OFFSET(0xDC67AA0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_SHOWELEMENT_OFFSET UNITYSDK_OFFSET(0xDC66420)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_SHOWRESIST_OFFSET UNITYSDK_OFFSET(0xDC65510)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_SHOWTARGETITEM_OFFSET UNITYSDK_OFFSET(0xDC65DA0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_SHOWWEEKNESS_OFFSET UNITYSDK_OFFSET(0xDC651C0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC6A520)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER__INITROLE_B__30_0_OFFSET UNITYSDK_OFFSET(0xDC6A920)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER__ONSELECTIONCHANGED_G__GETAVATAROCCUPINDEX_47_0_OFFSET UNITYSDK_OFFSET(0xDC699D0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER__ONSELECTIONCHANGED_G__GETBUDDYLAYERINDEX_47_1_OFFSET UNITYSDK_OFFSET(0xDC69B60)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER__ONUIINIT_B__16_0_OFFSET UNITYSDK_OFFSET(0xDC6A650)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER__ONUIINIT_B__16_1_OFFSET UNITYSDK_OFFSET(0xDC6A660)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER__ONUIINIT_B__16_2_OFFSET UNITYSDK_OFFSET(0xDC6A7D0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDC6A930)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xDC6A9A0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDC6AA00)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDC6AA70)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDC6AAF0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDC6AB50)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeInfoWidgetController_TypeDefinitionIndex = 72586;
	...
	public:
		...
		// static const ::System::String* GOLDEN_STAR_ICON_PATH; // 0x0
		// static const ::System::String* GREY_STAR_ICON_PATH; // 0x0
		::Class_2_79AE422BA06F6D26_176* _view; // 0x2A0
		::MoleMole::UIBossChallengePageController_RoomInfoData _roomData; // 0x2A8
		::Class_1_5DA2E7556103D5A3_122* _entranceInfoTemplate; // 0x2B8
		::Class_1_5DA2E7556103D5A3_280* _zoneTemplate; // 0x2C0
		::Class_1_5DA2E7556103D5A3_288* _layerTemplate; // 0x2C8
		::Class_1_5DA2E7556103D5A3_173* _roomTemplate; // 0x2D0
		...
		::System::Void ShowTargetItem(::System::Int32 starNum, ::Class_2_79AE422BA06F6D26_176_Class_2_FA228B66D064C2D1* tgtItemView)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Class_2_79AE422BA06F6D26_176_Class_2_FA228B66D064C2D1*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_SHOWTARGETITEM_OFFSET))(this, starNum, tgtItemView);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_BE16AD5EE326FCBB*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER_ONSELECTIONCHANGED_OFFSET))(this, data);
		}
