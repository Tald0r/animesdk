...
#define MOLEMOLE_UIIMAGETIMECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA39F070)
#define MOLEMOLE_UIIMAGETIMECONTROLLER_SETTIME_OFFSET UNITYSDK_OFFSET(0xA39E770)
#define MOLEMOLE_UIIMAGETIMECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA39F120)
#define MOLEMOLE_UIIMAGETIMECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA39F140)

namespace MoleMole
{
	inline static constexpr unsigned int UIImageTimeController_TypeDefinitionIndex = 48127;
