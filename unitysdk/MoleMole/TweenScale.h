...
#define MOLEMOLE_TWEENSCALE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xA6881D0)
#define MOLEMOLE_TWEENSCALE_METHOD_7_08B7287B59325288_OFFSET UNITYSDK_OFFSET(0xA6883D0)
#define MOLEMOLE_TWEENSCALE_METHOD_7_626C719A884DEF9A_OFFSET UNITYSDK_OFFSET(0xA688320)
#define MOLEMOLE_TWEENSCALE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xA6881F0)
#define MOLEMOLE_TWEENSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0xA6884A0)
#define MOLEMOLE_TWEENSCALE___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xA6884C0)

namespace MoleMole
{
	inline static constexpr unsigned int TweenScale_TypeDefinitionIndex = 40876;
