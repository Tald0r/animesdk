...
#define MOLEMOLE_TWEENSCALE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xB3EF470)
#define MOLEMOLE_TWEENSCALE_METHOD_7_08B7287B59325288_OFFSET UNITYSDK_OFFSET(0xB3EF670)
#define MOLEMOLE_TWEENSCALE_METHOD_7_626C719A884DEF9A_OFFSET UNITYSDK_OFFSET(0xB3EF5C0)
#define MOLEMOLE_TWEENSCALE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xB3EF490)
#define MOLEMOLE_TWEENSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0xB3EF740)
#define MOLEMOLE_TWEENSCALE___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xB3EF760)

namespace MoleMole
{
	inline static constexpr unsigned int TweenScale_TypeDefinitionIndex = 67914;
