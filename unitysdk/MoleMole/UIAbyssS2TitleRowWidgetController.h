...
class Class_2_8127D35606966C67_41;
...
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0xE8FAC50)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE8FA920)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xE8FAAA0)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0xE8FACB0)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE8FA9C0)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE8FA7D0)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE8FA870)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0xE8FAB60)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE8FAD20)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE8FAD30)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xE8FADA0)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE8FAE20)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE8FAEA0)
#define MOLEMOLE_UIABYSSS2TITLEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE8FAF00)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2TitleRowWidgetController_TypeDefinitionIndex = 77439;

	class UIAbyssS2TitleRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_8127D35606966C67_41* _view; // 0x2D0
