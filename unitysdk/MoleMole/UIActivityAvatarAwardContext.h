...
#define MOLEMOLE_UIACTIVITYAVATARAWARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xDECE260)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityAvatarAwardContext_TypeDefinitionIndex = 66929;
