...
#define MOLEMOLE_AFTERALLPOPUP_GET_ISBLOCKCENTER_OFFSET UNITYSDK_OFFSET(0xBAD3780)
#define MOLEMOLE_AFTERALLPOPUP_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0xBAD37A0)
#define MOLEMOLE_AFTERALLPOPUP_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xBAD3790)
#define MOLEMOLE_AFTERALLPOPUP_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xBAD37E0)
#define MOLEMOLE_AFTERALLPOPUP__CTOR_OFFSET UNITYSDK_OFFSET(0xBAD37B0)

namespace MoleMole
{
	inline static constexpr unsigned int AfterAllPopup_TypeDefinitionIndex = 54048;
