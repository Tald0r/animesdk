...
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x6E47450)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_INITQTEAVATARBTNPANEL_OFFSET UNITYSDK_OFFSET(0x6E483D0)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x6E48E60)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONLEFTCHARBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E49BE0)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONQTEWINDOWCLOSED_OFFSET UNITYSDK_OFFSET(0x6E49400)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONQTEWINDOWOPENED_OFFSET UNITYSDK_OFFSET(0x6E49370)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONRIGHTCHARBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E49C80)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONSWITCHBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x6E492F0)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6E482D0)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x6E48A70)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_PLAYFADEOUTANIMEND_OFFSET UNITYSDK_OFFSET(0x6E48B10)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_SECONDSTODATATIMEFORMAT_OFFSET UNITYSDK_OFFSET(0x6E49540)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_SETAVATARICONINFO_OFFSET UNITYSDK_OFFSET(0x6E49720)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_SETDEFAULTTIMERTWEENBAR_OFFSET UNITYSDK_OFFSET(0x6E48CE0)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_SETQTEEFFECTACTIVE_OFFSET UNITYSDK_OFFSET(0x6E48B80)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_STARTPLAYLOOPANIM_OFFSET UNITYSDK_OFFSET(0x6E48A00)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_STARTPLAYTWEERBAR_OFFSET UNITYSDK_OFFSET(0x6E48750)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_START_OFFSET UNITYSDK_OFFSET(0x6E47460)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_SWITCHAVATAR_OFFSET UNITYSDK_OFFSET(0x6E49D20)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_TWEENQTETIMEBAR_OFFSET UNITYSDK_OFFSET(0x6E487C0)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL_UPDATEQTEBTNCOUNTDOWNPANEL_OFFSET UNITYSDK_OFFSET(0x6E49000)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x6E49E10)
#define MOLEMOLE_MONOQTESWITCHAVATARPANEL___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6E49E20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoQTESwitchAvatarPanel_TypeDefinitionIndex = 52970;
