...
#define MOLEMOLE_UISENDPROTOPAGECONTROLLER_CLOSEMAINCITYSTOREPAGE_OFFSET UNITYSDK_OFFSET(0xAB9C810)
#define MOLEMOLE_UISENDPROTOPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAB9C730)
#define MOLEMOLE_UISENDPROTOPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xAB9C740)
#define MOLEMOLE_UISENDPROTOPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB9C8B0)
#define MOLEMOLE_UISENDPROTOPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xAB9C8C0)

namespace MoleMole
{
	inline static constexpr unsigned int UISendProtoPageController_TypeDefinitionIndex = 45293;
