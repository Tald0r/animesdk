...
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER_CONVERTUIPROGRESSBAR_OFFSET UNITYSDK_OFFSET(0x91467D0)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x91450E0)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x91450F0)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9145B80)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x91459A0)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9145190)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x91452F0)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9145710)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x9145D80)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9146880)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9146890)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9146900)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x9146930)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9146940)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9146950)
#define MOLEMOLE_UIHOLLOWTASKDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9146960)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowTaskDialogPopWindowController_TypeDefinitionIndex = 80858;
	...
	public:
		...
		::HollowInfoProgressParam* _param; // 0x300
		::Class_2_6998B76DE2AD2577* _view; // 0x308
		::UnityEngine::Material* _fillMaterial; // 0x310
		::System::Int32 _missionID; // 0x318
