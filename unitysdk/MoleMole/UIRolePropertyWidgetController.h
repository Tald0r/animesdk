...
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA4FF40)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA4FFE0)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA4FDF0)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA4FE90)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCA500C0)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA50120)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA50150)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA501C0)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA50240)
#define MOLEMOLE_UIROLEPROPERTYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA502A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRolePropertyWidgetController_TypeDefinitionIndex = 75809;

	class UIRolePropertyWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_129* _view; // 0x2A0
