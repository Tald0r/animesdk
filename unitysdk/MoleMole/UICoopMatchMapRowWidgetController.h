...
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA339E40)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA339EB0)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA33A0F0)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA33A1C0)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA33A360)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER__ONCREATEVIEWMODEL_B__3_0_OFFSET UNITYSDK_OFFSET(0xA33A370)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA33A760)
#define MOLEMOLE_UICOOPMATCHMAPROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA33A7D0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopMatchMapRowWidgetController_TypeDefinitionIndex = 75117;
