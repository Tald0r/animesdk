...
#define MOLEMOLE_ZHENZHENWEAPONVIDEOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x954DB90)

namespace MoleMole
{
	inline static constexpr unsigned int ZhenzhenWeaponVideoConfig_TypeDefinitionIndex = 81065;
