...
#define MOLEMOLE_ZHENZHENWEAPONVIDEOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x939EDA0)

namespace MoleMole
{
	inline static constexpr unsigned int ZhenzhenWeaponVideoConfig_TypeDefinitionIndex = 55812;
