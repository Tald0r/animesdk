...
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_1__ADDREPLYTOBOTTOM_B__0_OFFSET UNITYSDK_OFFSET(0x8F10A50)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_1__ADDREPLYTOBOTTOM_B__1_OFFSET UNITYSDK_OFFSET(0x8F10AE0)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_1__ADDREPLYTOBOTTOM_B__2_OFFSET UNITYSDK_OFFSET(0x8F10F70)
#define MOLEMOLE_UIINTERKNOTPOSTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_1__CTOR_OFFSET UNITYSDK_OFFSET(0x8F10A40)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotPostDialogPopWindowController___c__DisplayClass17_1_TypeDefinitionIndex = 79622;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::UIInterKnotMessageRowWidgetController*>* animCtrl; // 0x28
