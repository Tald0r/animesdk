...
#define MOLEMOLE_UIDISPLAYCASEPREVIEWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0xDF7B790)
#define MOLEMOLE_UIDISPLAYCASEPREVIEWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__SWITCHFRIEND_B__0_OFFSET UNITYSDK_OFFSET(0xDF7B7A0)
#define MOLEMOLE_UIDISPLAYCASEPREVIEWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__SWITCHFRIEND_B__1_OFFSET UNITYSDK_OFFSET(0xDF7B9F0)
#define MOLEMOLE_UIDISPLAYCASEPREVIEWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__SWITCHFRIEND_G__ONFAIL_2_OFFSET UNITYSDK_OFFSET(0xDF7B880)

namespace MoleMole
{
	inline static constexpr unsigned int UIDisplayCasePreviewWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 40815;
