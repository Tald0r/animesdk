...
#define MOLEMOLE_GLITCH01FORUISCALE_ADAPTATION_OFFSET UNITYSDK_OFFSET(0xA394B50)
#define MOLEMOLE_GLITCH01FORUISCALE_GETDURATION_OFFSET UNITYSDK_OFFSET(0xA395200)
#define MOLEMOLE_GLITCH01FORUISCALE_METHOD_6_8DCEB3A6D547AA3A_OFFSET UNITYSDK_OFFSET(0xA394F50)
#define MOLEMOLE_GLITCH01FORUISCALE__CTOR_OFFSET UNITYSDK_OFFSET(0xA3957C0)
#define MOLEMOLE_GLITCH01FORUISCALE___BASE_GETDURATION_OFFSET UNITYSDK_OFFSET(0xA3957E0)

namespace MoleMole
{
	inline static constexpr unsigned int Glitch01ForUIScale_TypeDefinitionIndex = 78406;
