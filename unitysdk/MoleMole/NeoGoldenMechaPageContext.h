...
#define MOLEMOLE_NEOGOLDENMECHAPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB8660D0)

namespace MoleMole
{
	inline static constexpr unsigned int NeoGoldenMechaPageContext_TypeDefinitionIndex = 43578;
