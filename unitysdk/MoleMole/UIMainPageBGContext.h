...
#define MOLEMOLE_UIMAINPAGEBGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8ECBBB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainPageBGContext_TypeDefinitionIndex = 48791;
