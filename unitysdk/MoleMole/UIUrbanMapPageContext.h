...
#define MOLEMOLE_UIURBANMAPPAGECONTEXT_COPYTO_OFFSET UNITYSDK_OFFSET(0x73E7C90)
#define MOLEMOLE_UIURBANMAPPAGECONTEXT_EQUALS_OFFSET UNITYSDK_OFFSET(0x73E7D40)
#define MOLEMOLE_UIURBANMAPPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x73E7F70)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapPageContext_TypeDefinitionIndex = 40010;

	class UIUrbanMapPageContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::MoleMole::UIUrbanMapPageContext_SDefaultFocusInfo DefaultFocusInfo; // 0x28
		::System::Action* OnManulClose; // 0x40
		::System::Action* AfterOpenMap; // 0x48
		::System::String* TeleportAudio; // 0x50
		::System::Int32 Map3dAreaId; // 0x58
		::Struct_2_B679E4D914A10080 FromSectionOrFloor; // 0x5C
		::Enum_3_AB9CCA0B2E05A401 DefaultPeriod; // 0x64
		::Struct_2_B679E4D914A10080 SectionOrFloor; // 0x68
