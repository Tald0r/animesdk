...
#define MOLEMOLE_PRELOADSHADERVARIANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x7F1FE80)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadShaderVariantConfig_TypeDefinitionIndex = 77534;
