...
#define MOLEMOLE_PRELOADSHADERVARIANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8B72210)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadShaderVariantConfig_TypeDefinitionIndex = 45382;
