...
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ANIMDAEMON_OFFSET UNITYSDK_OFFSET(0xD398620)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ENQUEUEANIM_OFFSET UNITYSDK_OFFSET(0xD3981B0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_INPUT2NUMIMAGEKEY_OFFSET UNITYSDK_OFFSET(0xD3957F0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_INPUT2NUMTEXTIMAGEKEY_OFFSET UNITYSDK_OFFSET(0xD395900)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_INPUT2POS_OFFSET UNITYSDK_OFFSET(0xD395670)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONBACKSPACE_OFFSET UNITYSDK_OFFSET(0xD395DD0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD395420)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONHINT_OFFSET UNITYSDK_OFFSET(0xD395E50)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONINFO_OFFSET UNITYSDK_OFFSET(0xD396BC0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONRESET_OFFSET UNITYSDK_OFFSET(0xD396C60)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3954C0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3945D0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD3951C0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_POS2INPUT_OFFSET UNITYSDK_OFFSET(0xD395740)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_REFRESHHINTBTN_OFFSET UNITYSDK_OFFSET(0xD396090)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_REFRESHINPUTSCREEN_OFFSET UNITYSDK_OFFSET(0xD396280)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_REFRESHSELECTEDBUTTON_OFFSET UNITYSDK_OFFSET(0xD397FF0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETANIMNONCALLBACK_OFFSET UNITYSDK_OFFSET(0xD397900)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETBACKSPACEBTN_OFFSET UNITYSDK_OFFSET(0xD397020)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETBTNBINDING_OFFSET UNITYSDK_OFFSET(0xD3974E0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETINPUTSCREEN_OFFSET UNITYSDK_OFFSET(0xD3970D0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETNUMBERBTN_OFFSET UNITYSDK_OFFSET(0xD396CD0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETVIEW_OFFSET UNITYSDK_OFFSET(0xD395280)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0xD398470)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_SIMULATEHINTBTN_OFFSET UNITYSDK_OFFSET(0xD395C00)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_SIMULATESELECTINPUTBTN_OFFSET UNITYSDK_OFFSET(0xD3959D0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD3986C0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__REFRESHINPUTSCREEN_B__36_0_OFFSET UNITYSDK_OFFSET(0xD3988B0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__REFRESHINPUTSCREEN_B__36_1_OFFSET UNITYSDK_OFFSET(0xD398A70)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__REFRESHINPUTSCREEN_B__36_2_OFFSET UNITYSDK_OFFSET(0xD398AE0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__REFRESHINPUTSCREEN_B__36_3_OFFSET UNITYSDK_OFFSET(0xD398CA0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD398CC0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD398D30)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD398DB0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD398E10)

namespace MoleMole
{
	inline static constexpr unsigned int UIPasswordGameWidgetController_TypeDefinitionIndex = 70292;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_175* _view; // 0x2B0
