...
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ANIMDAEMON_OFFSET UNITYSDK_OFFSET(0xC830C20)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ENQUEUEANIM_OFFSET UNITYSDK_OFFSET(0xC8307B0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_INPUT2NUMIMAGEKEY_OFFSET UNITYSDK_OFFSET(0xC82DE10)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_INPUT2NUMTEXTIMAGEKEY_OFFSET UNITYSDK_OFFSET(0xC82DF20)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_INPUT2POS_OFFSET UNITYSDK_OFFSET(0xC82DC90)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONBACKSPACE_OFFSET UNITYSDK_OFFSET(0xC82E3F0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC82DA40)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONHINT_OFFSET UNITYSDK_OFFSET(0xC82E470)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONINFO_OFFSET UNITYSDK_OFFSET(0xC82F1C0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONRESET_OFFSET UNITYSDK_OFFSET(0xC82F260)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC82DAE0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC82CBF0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC82D7E0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_POS2INPUT_OFFSET UNITYSDK_OFFSET(0xC82DD60)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_REFRESHHINTBTN_OFFSET UNITYSDK_OFFSET(0xC82E6B0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_REFRESHINPUTSCREEN_OFFSET UNITYSDK_OFFSET(0xC82E8A0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_REFRESHSELECTEDBUTTON_OFFSET UNITYSDK_OFFSET(0xC8305F0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETANIMNONCALLBACK_OFFSET UNITYSDK_OFFSET(0xC82FF00)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETBACKSPACEBTN_OFFSET UNITYSDK_OFFSET(0xC82F620)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETBTNBINDING_OFFSET UNITYSDK_OFFSET(0xC82FAD0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETINPUTSCREEN_OFFSET UNITYSDK_OFFSET(0xC82F6D0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETNUMBERBTN_OFFSET UNITYSDK_OFFSET(0xC82F2D0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_RESETVIEW_OFFSET UNITYSDK_OFFSET(0xC82D8A0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0xC830A70)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_SIMULATEHINTBTN_OFFSET UNITYSDK_OFFSET(0xC82E220)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER_SIMULATESELECTINPUTBTN_OFFSET UNITYSDK_OFFSET(0xC82DFF0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC830CC0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__REFRESHINPUTSCREEN_B__36_0_OFFSET UNITYSDK_OFFSET(0xC830EB0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__REFRESHINPUTSCREEN_B__36_1_OFFSET UNITYSDK_OFFSET(0xC831060)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__REFRESHINPUTSCREEN_B__36_2_OFFSET UNITYSDK_OFFSET(0xC8310D0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER__REFRESHINPUTSCREEN_B__36_3_OFFSET UNITYSDK_OFFSET(0xC831280)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC8312A0)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC831310)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC831390)
#define MOLEMOLE_UIPASSWORDGAMEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC8313F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPasswordGameWidgetController_TypeDefinitionIndex = 60727;

	class UIPasswordGameWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		// static const ::System::String* PasswordGameNumPathPattern; // 0x0
		// static const ::System::String* PasswordGameNumTextPathPattern; // 0x0
		// static const ::System::String* PasswordGameScreenCorrectFadeInAnimClip; // 0x0
		// static const ::System::String* PasswordGameScreenErrorFadeInAnimClip; // 0x0
		// static const ::System::String* PasswordGameScreenErrorFadeOutAnimClip; // 0x0
		// static const ::System::String* PasswordGameHintBtnActivation; // 0x0
		::Il2CppArray<::Foundation::AssetPath>* _passwordGameNumTextPaths; // 0x2A0
		::System::Single _animDelayWhenInputCompleted; // 0x2A8
		::Class_2_79F6D62CE30E3F8E_22* _view; // 0x2B0
		::Class_3_E6A377784A0B8569* _model; // 0x2B8
		::System::Collections::Generic::Dictionary_2<::System::Char, ::MoleMole::UIPasswordGameNumberButtonWidgetController*>* _numberButtons; // 0x2C0
		::System::Collections::Generic::List_1<::MoleMole::UIPasswordGameNumberDisplayWidgetController*>* _inputNumbers; // 0x2C8
		::System::Char _currSelectedInput; // 0x2D0
		::System::Boolean _isHintShown; // 0x2D2
		::System::Collections::Generic::Dictionary_2<::Enum_3_70DF2F2181957C70, ::System::Collections::Generic::Queue_1<::Struct_2_FEBA7E1A1FC0D70F>*>* _queuedAnim; // 0x2D8
		::UnityEngine::Coroutine* _animeDaemon; // 0x2E0
		::System::Collections::Generic::Dictionary_2<::Enum_3_70DF2F2181957C70, ::Class_1_2299A0FE2E8FD63C*>* _animInProgress; // 0x2E8
		::System::Collections::Generic::List_1<::Enum_3_70DF2F2181957C70>* _animDaemonChannelToRemove; // 0x2F0
		::System::Collections::Generic::List_1<::System::Action*>* _animDaemonCallbackToInvoke; // 0x2F8
