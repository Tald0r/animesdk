...
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBA1FBC0)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_METHOD_5_39FD7185C859CEAD_OFFSET UNITYSDK_OFFSET(0xBA202D0)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_METHOD_5_6E6682ED9FD6F719_OFFSET UNITYSDK_OFFSET(0xBA1FC90)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_METHOD_5_870AF3CD1D0A67B1_OFFSET UNITYSDK_OFFSET(0xBA1FF50)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_METHOD_5_8F7825DAFFB9B517_OFFSET UNITYSDK_OFFSET(0xBA1FD40)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0xBA1FD20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoAttachmentCenterDither_TypeDefinitionIndex = 70315;
