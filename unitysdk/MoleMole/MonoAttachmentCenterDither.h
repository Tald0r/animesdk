...
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC9DA310)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_METHOD_5_39FD7185C859CEAD_OFFSET UNITYSDK_OFFSET(0xC9DAA40)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_METHOD_5_6E6682ED9FD6F719_OFFSET UNITYSDK_OFFSET(0xC9DA3E0)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_METHOD_5_870AF3CD1D0A67B1_OFFSET UNITYSDK_OFFSET(0xC9DA6C0)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER_METHOD_5_8F7825DAFFB9B517_OFFSET UNITYSDK_OFFSET(0xC9DA490)
#define MOLEMOLE_MONOATTACHMENTCENTERDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DA470)

namespace MoleMole
{
	inline static constexpr unsigned int MonoAttachmentCenterDither_TypeDefinitionIndex = 68041;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOATTACHMENTCENTERDITHER_METHOD_5_6E6682ED9FD6F719_OFFSET))(this);
		}
	};
}
