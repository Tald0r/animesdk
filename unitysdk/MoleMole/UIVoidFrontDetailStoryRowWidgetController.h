...
#define MOLEMOLE_UIVOIDFRONTDETAILSTORYROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7C5BF30)
#define MOLEMOLE_UIVOIDFRONTDETAILSTORYROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7C5BFA0)
#define MOLEMOLE_UIVOIDFRONTDETAILSTORYROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7C5C0A0)
#define MOLEMOLE_UIVOIDFRONTDETAILSTORYROWWIDGETCONTROLLER_SETCHOICE_OFFSET UNITYSDK_OFFSET(0x7C5C1A0)
#define MOLEMOLE_UIVOIDFRONTDETAILSTORYROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7C5C5F0)
#define MOLEMOLE_UIVOIDFRONTDETAILSTORYROWWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x7C5C620)
#define MOLEMOLE_UIVOIDFRONTDETAILSTORYROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7C5C690)
#define MOLEMOLE_UIVOIDFRONTDETAILSTORYROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7C5C700)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontDetailStoryRowWidgetController_TypeDefinitionIndex = 71073;
