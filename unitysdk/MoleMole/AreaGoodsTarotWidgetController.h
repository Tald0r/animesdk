...
#define MOLEMOLE_AREAGOODSTAROTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9CCAA40)
#define MOLEMOLE_AREAGOODSTAROTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9CCAD10)
#define MOLEMOLE_AREAGOODSTAROTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9CCAD40)

namespace MoleMole
{
	inline static constexpr unsigned int AreaGoodsTarotWidgetController_TypeDefinitionIndex = 46821;
