...
#define MOLEMOLE_AREAGOODSTAROTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8015CD0)
#define MOLEMOLE_AREAGOODSTAROTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8015FA0)
#define MOLEMOLE_AREAGOODSTAROTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8015FD0)

namespace MoleMole
{
	inline static constexpr unsigned int AreaGoodsTarotWidgetController_TypeDefinitionIndex = 62619;
