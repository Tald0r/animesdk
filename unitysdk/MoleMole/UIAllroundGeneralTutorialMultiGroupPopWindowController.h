...
#define MOLEMOLE_UIALLROUNDGENERALTUTORIALMULTIGROUPPOPWINDOWCONTROLLER_GET__LOGICDELEGATE_OFFSET UNITYSDK_OFFSET(0xBF23870)
#define MOLEMOLE_UIALLROUNDGENERALTUTORIALMULTIGROUPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF23880)
#define MOLEMOLE_UIALLROUNDGENERALTUTORIALMULTIGROUPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF238F0)
#define MOLEMOLE_UIALLROUNDGENERALTUTORIALMULTIGROUPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF23960)
#define MOLEMOLE_UIALLROUNDGENERALTUTORIALMULTIGROUPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF239F0)
#define MOLEMOLE_UIALLROUNDGENERALTUTORIALMULTIGROUPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF23A00)

namespace MoleMole
{
	inline static constexpr unsigned int UIAllroundGeneralTutorialMultiGroupPopWindowController_TypeDefinitionIndex = 79174;
