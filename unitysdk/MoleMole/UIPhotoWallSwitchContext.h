...
#define MOLEMOLE_UIPHOTOWALLSWITCHCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAF77640)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWallSwitchContext_TypeDefinitionIndex = 39570;
