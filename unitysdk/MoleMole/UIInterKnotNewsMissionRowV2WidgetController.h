...
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_GETMISSIONLISTQUESTICON_OFFSET UNITYSDK_OFFSET(0xAD8D2A0)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_GETSELECTMANUAL_OFFSET UNITYSDK_OFFSET(0xAD8DA40)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xAD8B570)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xAD8DD70)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD8B930)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAD8DE00)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_ONMANUALADD_OFFSET UNITYSDK_OFFSET(0xAD8D090)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_ONMISSIONITEMCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xAD8DB20)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAD8BAB0)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_ONTRACKQUESTUPDATE_OFFSET UNITYSDK_OFFSET(0xAD8CC80)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD8B9D0)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD8B590)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_PLAYSELECT_OFFSET UNITYSDK_OFFSET(0xAD8E270)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0xAD8D110)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_REFRESHTRACK_OFFSET UNITYSDK_OFFSET(0xAD8CD10)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAD8BDB0)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_SETMISSIONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAD8DBA0)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_SETMISSIONLISTSELECT_OFFSET UNITYSDK_OFFSET(0xAD8D5F0)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_SETNAMETEXT_OFFSET UNITYSDK_OFFSET(0xAD8D830)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xAD8B580)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xAD8E4F0)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD8E460)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER__REFRESHTRACK_G__SETTRACKED_20_0_OFFSET UNITYSDK_OFFSET(0xAD8D9B0)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD8E540)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAD8E5B0)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAD8E620)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD8E6A0)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD8E720)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotNewsMissionRowV2WidgetController_TypeDefinitionIndex = 47645;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotNewsMissionRowV2WidgetController_TypeDefinitionIndex)->GetStaticField(0xEFD0);
		}
		static ::System::Int32* StaticGet_RampColorA()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotNewsMissionRowV2WidgetController_TypeDefinitionIndex)->GetStaticField(0xEFD4);
		}
		::Class_2_79F6D62CE30E3F8E_34* _view; // 0x2D0
