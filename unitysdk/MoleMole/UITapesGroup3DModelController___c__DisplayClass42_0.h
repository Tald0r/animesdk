...
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9EE39B0)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS42_0__PERFORMANCESHRINK_B__2_OFFSET UNITYSDK_OFFSET(0x9EE3B30)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS42_0__PERFORMANCESHRINK_G__GETOFFSET_0_OFFSET UNITYSDK_OFFSET(0x9EE39C0)

namespace MoleMole
{
	inline static constexpr unsigned int UITapesGroup3DModelController___c__DisplayClass42_0_TypeDefinitionIndex = 53119;
