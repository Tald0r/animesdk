...
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAE92690)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS42_0__PERFORMANCESHRINK_B__2_OFFSET UNITYSDK_OFFSET(0xAE92810)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS42_0__PERFORMANCESHRINK_G__GETOFFSET_0_OFFSET UNITYSDK_OFFSET(0xAE926A0)

namespace MoleMole
{
	inline static constexpr unsigned int UITapesGroup3DModelController___c__DisplayClass42_0_TypeDefinitionIndex = 69984;
	...
	public:
		...
		::System::Int32 totalNum; // 0x3C
		::UnityEngine::Vector3 centerTapePosition; // 0x40
		::System::Int32 finishCount; // 0x4C
