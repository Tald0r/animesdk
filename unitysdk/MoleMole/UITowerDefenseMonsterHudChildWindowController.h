...
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_DETACH_OFFSET UNITYSDK_OFFSET(0x95A3050)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_FIXPOSITION_OFFSET UNITYSDK_OFFSET(0x95A40A0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0x95A2700)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x95A2470)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_INITIALIZEFILL_OFFSET UNITYSDK_OFFSET(0x95A2E40)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_INITUIDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x95A2850)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95A3850)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x95A3290)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_ONPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0x95A3360)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95A3EA0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95A2480)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95A24F0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x95A2F00)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_SHOWTIP_OFFSET UNITYSDK_OFFSET(0x95A37C0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER_UPDATEPOSITION_OFFSET UNITYSDK_OFFSET(0x95A38F0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x95A42A0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x95A41F0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95A42E0)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95A4350)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95A4360)
#define MOLEMOLE_UITOWERDEFENSEMONSTERHUDCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95A4370)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefenseMonsterHudChildWindowController_TypeDefinitionIndex = 70761;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITowerDefenseMonsterHudChildWindowController_TypeDefinitionIndex)->GetStaticField(0xF5D0);
		}
