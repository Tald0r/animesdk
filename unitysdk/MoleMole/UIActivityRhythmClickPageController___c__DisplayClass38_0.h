...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS38_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBADFA10)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS38_0__TRIGGERCLICKGUIDESTARTFADEINUIACTIONWHENAUDIOVIDEOMODIFY_B__0_OFFSET UNITYSDK_OFFSET(0xBADFA20)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS38_0__TRIGGERCLICKGUIDESTARTFADEINUIACTIONWHENAUDIOVIDEOMODIFY_B__1_OFFSET UNITYSDK_OFFSET(0xBADFA70)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController___c__DisplayClass38_0_TypeDefinitionIndex = 41476;
