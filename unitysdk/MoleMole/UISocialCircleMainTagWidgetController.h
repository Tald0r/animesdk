...
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAB77600)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAB77710)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAB77810)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB77A90)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB77670)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAB778F0)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB77B60)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAB77B70)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAB77BE0)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB77C60)
#define MOLEMOLE_UISOCIALCIRCLEMAINTAGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB77CD0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleMainTagWidgetController_TypeDefinitionIndex = 60830;
