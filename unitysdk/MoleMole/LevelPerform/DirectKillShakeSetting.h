...
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING_ASSIGN_OFFSET UNITYSDK_OFFSET(0xBA1B7E0)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING_GET_LOCATIONOFFSET_OFFSET UNITYSDK_OFFSET(0xBA1B720)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING_GET_ROTATIONOFFSET_OFFSET UNITYSDK_OFFSET(0xBA1B740)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING_HASVALIDDATA_OFFSET UNITYSDK_OFFSET(0xBA1B900)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING__CCTOR_OFFSET UNITYSDK_OFFSET(0xBA1B9A0)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xBA1B990)

namespace MoleMole::LevelPerform
{
	inline static constexpr unsigned int DirectKillShakeSetting_TypeDefinitionIndex = 40092;
	...
	public:
		...
		{
			return (::MoleMole::LevelPerform::DirectKillShakeSetting**)Il2CppClass::FromTypeDefinitionIndex(DirectKillShakeSetting_TypeDefinitionIndex)->GetStaticField(0x2DEB0);
		}
