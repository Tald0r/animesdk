...
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING_ASSIGN_OFFSET UNITYSDK_OFFSET(0xC9D5F40)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING_GET_LOCATIONOFFSET_OFFSET UNITYSDK_OFFSET(0xC9D5E80)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING_GET_ROTATIONOFFSET_OFFSET UNITYSDK_OFFSET(0xC9D5EA0)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING_HASVALIDDATA_OFFSET UNITYSDK_OFFSET(0xC9D6060)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING__CCTOR_OFFSET UNITYSDK_OFFSET(0xC9D6100)
#define MOLEMOLE_LEVELPERFORM_DIRECTKILLSHAKESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D60F0)

namespace MoleMole::LevelPerform
{
	inline static constexpr unsigned int DirectKillShakeSetting_TypeDefinitionIndex = 76755;
	...
	public:
		...
		{
			return (::MoleMole::LevelPerform::DirectKillShakeSetting**)Il2CppClass::FromTypeDefinitionIndex(DirectKillShakeSetting_TypeDefinitionIndex)->GetStaticField(0x2C860);
		}
