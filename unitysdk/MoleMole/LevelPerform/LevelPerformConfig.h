...
#define MOLEMOLE_LEVELPERFORM_LEVELPERFORMCONFIG_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x6E2C2B0)
#define MOLEMOLE_LEVELPERFORM_LEVELPERFORMCONFIG_RELOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0x6E2C550)
#define MOLEMOLE_LEVELPERFORM_LEVELPERFORMCONFIG_RELOADFROMFILE_OFFSET UNITYSDK_OFFSET(0x6E2C2D0)
#define MOLEMOLE_LEVELPERFORM_LEVELPERFORMCONFIG_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x6E2C2C0)
#define MOLEMOLE_LEVELPERFORM_LEVELPERFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6E2C660)

namespace MoleMole::LevelPerform
{
	inline static constexpr unsigned int LevelPerformConfig_TypeDefinitionIndex = 43172;
	...
	public:
		...
		{
			return (::MoleMole::LevelPerform::LevelPerformConfig**)Il2CppClass::FromTypeDefinitionIndex(LevelPerformConfig_TypeDefinitionIndex)->GetStaticField(0x30CD0);
		}
