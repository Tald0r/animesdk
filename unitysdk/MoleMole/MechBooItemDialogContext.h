...
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXT_GETPARTITEMDATA_OFFSET UNITYSDK_OFFSET(0xD80A550)
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXT_ISVALIDTEMPLATE_OFFSET UNITYSDK_OFFSET(0xD80A4D0)
#define MOLEMOLE_MECHBOOITEMDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD80A8E0)

namespace MoleMole
{
	inline static constexpr unsigned int MechBooItemDialogContext_TypeDefinitionIndex = 57566;
