...
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_DESTROYFILLMATERIAL_OFFSET UNITYSDK_OFFSET(0xC080220)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_INITFILLMATERIAL_OFFSET UNITYSDK_OFFSET(0xC080EA0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC07FF40)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC080090)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC080130)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC07FE90)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC07FFE0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0xC080900)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_PLAYFADEOUTANIM02_OFFSET UNITYSDK_OFFSET(0xC080CA0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_PLAYFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0xC080AA0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_REFRESHPROGRESSTEXT_OFFSET UNITYSDK_OFFSET(0xC0805B0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC0806E0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC080350)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC081070)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC081040)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER__PLAYFADEOUTANIM02_B__11_0_OFFSET UNITYSDK_OFFSET(0xC081120)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER__PLAYFADEOUTANIM_B__10_0_OFFSET UNITYSDK_OFFSET(0xC0810B0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC081170)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0811E0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC081260)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0812C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelChainMeterWidgetController_TypeDefinitionIndex = 69180;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelChainMeterWidgetController_TypeDefinitionIndex)->GetStaticField(0x113D0);
		}
		// static const ::System::String* FADE_IN_ANIM_NAME; // 0x0
		// static const ::System::String* FADE_OUT_ANIM_NAME; // 0x0
		// static const ::System::String* FADE_OUT_ANIM_NAME_02; // 0x0
		// static const ::System::String* FULL_ENERGY_LOOP_ANIM_NAME; // 0x0
		::Class_2_39F1CEBBBCF30652* _view; // 0x2A0
		::System::Single _curProgress; // 0x2A8
		::System::Single _targetProgress; // 0x2AC
		::System::Boolean _isShow; // 0x2B0
		::Foundation::Coroutine::CoroutineHandle _fadeOutCoroutineHandle; // 0x2B4
		::UnityEngine::Material* _fillMaterial; // 0x2B8
		::System::Boolean _isMax; // 0x2C0
		::System::Boolean _isInitSet; // 0x2C1
