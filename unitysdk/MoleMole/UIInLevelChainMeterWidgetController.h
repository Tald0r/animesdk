...
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_DESTROYFILLMATERIAL_OFFSET UNITYSDK_OFFSET(0x873D9E0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_INITFILLMATERIAL_OFFSET UNITYSDK_OFFSET(0x873E650)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x873D700)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x873D850)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x873D8F0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x873D650)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x873D7A0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x873E0B0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_PLAYFADEOUTANIM02_OFFSET UNITYSDK_OFFSET(0x873E450)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_PLAYFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x873E250)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_REFRESHPROGRESSTEXT_OFFSET UNITYSDK_OFFSET(0x873DD70)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x873DEA0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x873DB10)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x873E810)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x873E7E0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER__PLAYFADEOUTANIM02_B__11_0_OFFSET UNITYSDK_OFFSET(0x873E8C0)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER__PLAYFADEOUTANIM_B__10_0_OFFSET UNITYSDK_OFFSET(0x873E850)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x873E910)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x873E980)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x873EA00)
#define MOLEMOLE_UIINLEVELCHAINMETERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x873EA60)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelChainMeterWidgetController_TypeDefinitionIndex = 38991;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelChainMeterWidgetController_TypeDefinitionIndex)->GetStaticField(0x110A0);
		}
