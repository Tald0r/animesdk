...
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9C12170)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS12_0__INITSWITCHHOLLOWITEM_B__0_OFFSET UNITYSDK_OFFSET(0x9C12180)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS12_0__INITSWITCHHOLLOWITEM_B__1_OFFSET UNITYSDK_OFFSET(0x9C125F0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS12_0__INITSWITCHHOLLOWITEM_B__2_OFFSET UNITYSDK_OFFSET(0x9C12440)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS12_0__INITSWITCHHOLLOWITEM_B__3_OFFSET UNITYSDK_OFFSET(0x9C12580)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS12_0__INITSWITCHHOLLOWITEM_B__4_OFFSET UNITYSDK_OFFSET(0x9C12690)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowTipsDialogPopWindowController___c__DisplayClass12_0_TypeDefinitionIndex = 78594;
	...
	public:
		...
		::System::Action_1<::System::Int32>* switchCallback; // 0x20
		::MoleMole::UIHollowTipsDialogPopWindowController* __4__this; // 0x28
