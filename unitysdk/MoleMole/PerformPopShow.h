...
#define MOLEMOLE_PERFORMPOPSHOW_DOWAIT_OFFSET UNITYSDK_OFFSET(0xBD49BC0)
#define MOLEMOLE_PERFORMPOPSHOW_ENABLESTATE_OFFSET UNITYSDK_OFFSET(0xBD4A310)
#define MOLEMOLE_PERFORMPOPSHOW_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0xBD49990)
#define MOLEMOLE_PERFORMPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xBD499A0)
#define MOLEMOLE_PERFORMPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xBD49AF0)
#define MOLEMOLE_PERFORMPOPSHOW_PLAY_OFFSET UNITYSDK_OFFSET(0xBD49DC0)
#define MOLEMOLE_PERFORMPOPSHOW__CTOR_1_OFFSET UNITYSDK_OFFSET(0xBD49A30)
#define MOLEMOLE_PERFORMPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xBD499B0)
#define MOLEMOLE_PERFORMPOPSHOW__ONPROCESS_B__13_0_OFFSET UNITYSDK_OFFSET(0xBD4A400)

namespace MoleMole
{
	inline static constexpr unsigned int PerformPopShow_TypeDefinitionIndex = 70348;
	...
	public:
		...
		::System::Int32 _waitTime; // 0x40
		::System::Int32 transitionID; // 0x44
		::System::Boolean _useBlackMaskFadeOut; // 0x48
		::System::Boolean _blackMaskFadein; // 0x49
		...
		static ::System::Void DoWait(::System::Int32 waitTime, ::Class_1_8CAF6558A3C0E096_Enum_3_ADB48E3C0DC0EC24 stopSource, ::System::Action* onPlay)
		{
			return ((::System::Void(*)(::System::Int32, ::Class_1_8CAF6558A3C0E096_Enum_3_ADB48E3C0DC0EC24, ::System::Action*))((::PBYTE)hIl2Cpp + MOLEMOLE_PERFORMPOPSHOW_DOWAIT_OFFSET))(waitTime, stopSource, onPlay);
		}
		...
		::System::Void _OnProcess_b__13_0()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_PERFORMPOPSHOW__ONPROCESS_B__13_0_OFFSET))(this);
		}
	};
}
