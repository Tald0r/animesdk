...
#define MOLEMOLE_PERFORMPOPSHOW_DOWAIT_OFFSET UNITYSDK_OFFSET(0xB1BA600)
#define MOLEMOLE_PERFORMPOPSHOW_ENABLESTATE_OFFSET UNITYSDK_OFFSET(0xB1BAD70)
#define MOLEMOLE_PERFORMPOPSHOW_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0xB1BA3B0)
#define MOLEMOLE_PERFORMPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xB1BA3C0)
#define MOLEMOLE_PERFORMPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xB1BA530)
#define MOLEMOLE_PERFORMPOPSHOW_PLAY_OFFSET UNITYSDK_OFFSET(0xB1BA800)
#define MOLEMOLE_PERFORMPOPSHOW__CTOR_1_OFFSET UNITYSDK_OFFSET(0xB1BA460)
#define MOLEMOLE_PERFORMPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xB1BA3D0)
#define MOLEMOLE_PERFORMPOPSHOW__ONPROCESS_B__14_0_OFFSET UNITYSDK_OFFSET(0xB1BAE60)

namespace MoleMole
{
	inline static constexpr unsigned int PerformPopShow_TypeDefinitionIndex = 53961;

	class PerformPopShow : public ::MoleMole::DisplayMessageBase
	{
	public:
		::System::Action* executeWhenStartFadeOutAction; // 0x28
		::System::Action* finishCallback; // 0x30
		::System::Collections::Generic::List_1<::System::Int32>* performIDs; // 0x38
		::System::Int32 transitionID; // 0x40
		::System::Int32 _waitTime; // 0x44
		::System::Boolean _useBlackMaskFadeOut; // 0x48
		::System::Boolean _blackMaskFadein; // 0x49
		::System::Int32 _triggerGroupID; // 0x4C
