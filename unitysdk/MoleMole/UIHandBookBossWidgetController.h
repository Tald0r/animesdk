...
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD58A270)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0xD58B110)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD589AC0)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD58A310)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD588E30)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD589350)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_REFRESHBOSSREWARD_OFFSET UNITYSDK_OFFSET(0xD58A3F0)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0xD589610)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER_REFRESHREWARDBUFFVIEW_OFFSET UNITYSDK_OFFSET(0xD589CF0)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD58B180)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0xD58B220)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0xD58B240)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD58B260)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD58B2D0)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD58B340)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD58B3C0)
#define MOLEMOLE_UIHANDBOOKBOSSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD58B420)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookBossWidgetController_TypeDefinitionIndex = 50739;

	class UIHandBookBossWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_208CC9941471731A_96* _entry; // 0x2A0
		::Class_2_3B0594C973D57E5F* _view; // 0x2A8
