...
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_DELAYCLOSE_OFFSET UNITYSDK_OFFSET(0x8948530)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_GET_ISBUSYING_OFFSET UNITYSDK_OFFSET(0x8948720)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONCHALLENGEUPDATE_OFFSET UNITYSDK_OFFSET(0x893ADD0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x89480C0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8948160)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x89481D0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8947C60)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8947D00)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_PLAYCLOSE_OFFSET UNITYSDK_OFFSET(0x89485D0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_PLAYCOMPLETE_OFFSET UNITYSDK_OFFSET(0x8948450)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_REGISTERCHALLENGE_OFFSET UNITYSDK_OFFSET(0x893B7A0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_REPLAY_OFFSET UNITYSDK_OFFSET(0x893B630)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_SETICONTYPE_OFFSET UNITYSDK_OFFSET(0x8947F80)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x893B4E0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x89487C0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER__DELAYCLOSE_B__22_0_OFFSET UNITYSDK_OFFSET(0x8948BA0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER__GETSTAYDURATION_OFFSET UNITYSDK_OFFSET(0x89482B0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER__REGISTERCHALLENGE_B__21_0_OFFSET UNITYSDK_OFFSET(0x89487F0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8948BB0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8948C20)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8948C30)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8948CB0)
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8948D10)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelRankingSABInfoRowWidgetController_TypeDefinitionIndex = 76753;

	class UIInLevelRankingSABInfoRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_EA00FF79749FF75E* _view; // 0x2A0
		::System::Int32 ListenChallengeId; // 0x2A8
		::Enum_3_BD9BD7E290475B28 _iconType; // 0x2AC
		::MoleMole::UIInLevelRankingSABInfoRowConfig* _config; // 0x2B0
		::MoleMole::UICommonTimeCoolDownWidgetController* SwitchTeamBattleTime; // 0x2B8
		::System::Boolean isInReplay; // 0x2C0
