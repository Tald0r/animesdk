...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS385_1__CTOR_OFFSET UNITYSDK_OFFSET(0xAD2E9E0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS385_1__PLAYPICTUREDISPLAYACTION_B__4_OFFSET UNITYSDK_OFFSET(0xAD2E9F0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS385_1__PLAYPICTUREDISPLAYACTION_B__5_OFFSET UNITYSDK_OFFSET(0xAD2EC30)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass385_1_TypeDefinitionIndex = 58941;
