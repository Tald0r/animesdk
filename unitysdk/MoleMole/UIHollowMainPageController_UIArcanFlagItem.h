...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_UIARCANFLAGITEM_GETITEMDATA_OFFSET UNITYSDK_OFFSET(0x80B22C0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_UIARCANFLAGITEM_INITITEM_OFFSET UNITYSDK_OFFSET(0x80B1E20)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_UIARCANFLAGITEM_PLAY_OFFSET UNITYSDK_OFFSET(0x80B2500)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_UIARCANFLAGITEM_SETARCANAITEMDATA_OFFSET UNITYSDK_OFFSET(0x80B2320)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_UIARCANFLAGITEM_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x80B25E0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_UIARCANFLAGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x80B1E10)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController_UIArcanFlagItem_TypeDefinitionIndex = 52615;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_349ADC1104AA6944_4*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER_UIARCANFLAGITEM_SETARCANAITEMDATA_OFFSET))(this, itemData);
		}
