...
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__MOVETOLEVELPROCESS_D__30_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x73EBC90)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__MOVETOLEVELPROCESS_D__30_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x73EBE20)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__MOVETOLEVELPROCESS_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x73EBE80)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__MOVETOLEVELPROCESS_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x73EBE30)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__MOVETOLEVELPROCESS_D__30_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x73EBC80)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__MOVETOLEVELPROCESS_D__30__CTOR_OFFSET UNITYSDK_OFFSET(0x73EBC70)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusMainWidgetController__MoveToLevelProcess_d__30_TypeDefinitionIndex = 57591;
