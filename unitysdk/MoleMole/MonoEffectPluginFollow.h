...
#define MOLEMOLE_MONOEFFECTPLUGINFOLLOW_GET_FOLLOWATTACHTOBONE_OFFSET UNITYSDK_OFFSET(0x7F177A0)
#define MOLEMOLE_MONOEFFECTPLUGINFOLLOW_RUNTIMEBAKE_OFFSET UNITYSDK_OFFSET(0x7F177C0)
#define MOLEMOLE_MONOEFFECTPLUGINFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x7F17950)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginFollow_TypeDefinitionIndex = 53524;
