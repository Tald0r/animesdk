...
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0xA12D610)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_CANSHOWTHISELEMENTDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xA12EF90)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_CHECKDAMAGEELEMENT_OFFSET UNITYSDK_OFFSET(0xA12EB30)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_GET_DAMAGERESISTTHESHOLD_OFFSET UNITYSDK_OFFSET(0xA131810)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_GET_ELEMENTABNORMALSWITCHICONCDTIME_OFFSET UNITYSDK_OFFSET(0xA130A70)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA12DC30)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA12DB90)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_ONELEMENTABNORMALLOCKSTATECHANGE_OFFSET UNITYSDK_OFFSET(0xA130CE0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_ONELEMENTABNORMALTRIGGERED_1_OFFSET UNITYSDK_OFFSET(0xA12F260)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_ONELEMENTABNORMALTRIGGERED_OFFSET UNITYSDK_OFFSET(0xA12F040)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_ONEVTCHANGEELEMENTABNORMALACCUMULATION_1_OFFSET UNITYSDK_OFFSET(0xA130310)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_ONEVTCHANGEELEMENTABNORMALACCUMULATION_2_OFFSET UNITYSDK_OFFSET(0xA1305E0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_ONEVTCHANGEELEMENTABNORMALACCUMULATION_OFFSET UNITYSDK_OFFSET(0xA12F770)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA12DCE0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA12D360)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA12DAE0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_PLAYRESETANIM_OFFSET UNITYSDK_OFFSET(0xA130BA0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0xA12E6A0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_SETELEMENTABNORMALLOCKSTATE_OFFSET UNITYSDK_OFFSET(0xA1312E0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_SETELEMENTABNORMALUNLOCKSTATE_OFFSET UNITYSDK_OFFSET(0xA12FBA0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_SETENTITY_OFFSET UNITYSDK_OFFSET(0xA12DF40)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_SHOWWITHANIM_OFFSET UNITYSDK_OFFSET(0xA12EA40)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA130C50)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__10_0_OFFSET UNITYSDK_OFFSET(0xA1319B0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__10_1_OFFSET UNITYSDK_OFFSET(0xA131B50)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__10_2_OFFSET UNITYSDK_OFFSET(0xA131CF0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__10_3_OFFSET UNITYSDK_OFFSET(0xA131E40)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__10_4_OFFSET UNITYSDK_OFFSET(0xA131FC0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA131970)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA1318D0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER__SETENTITY_G__FINDFIRSTELEMENTABNORMAL_6_0_OFFSET UNITYSDK_OFFSET(0xA12E720)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA1320E0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA132140)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA1321B0)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA132230)
#define MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA132290)

namespace MoleMole
{
	inline static constexpr unsigned int UIWeakPanelWidgetWidgetController_TypeDefinitionIndex = 45539;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIWeakPanelWidgetWidgetController_TypeDefinitionIndex)->GetStaticField(0xD0E0);
		}
		...
		::System::Boolean CheckDamageElement(::MoleMole::Config::DamageElementType key, ::Class_1_30670D995B76EFF5* value)
		{
			return ((::System::Boolean(*)(::PVOID, ::MoleMole::Config::DamageElementType, ::Class_1_30670D995B76EFF5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIWEAKPANELWIDGETWIDGETCONTROLLER_CHECKDAMAGEELEMENT_OFFSET))(this, key, value);
		}
