...
#define MOLEMOLE_UICHATEMOJIITEMWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA25C7E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIChatEmojiItemWidgetController_Context_TypeDefinitionIndex = 74662;
