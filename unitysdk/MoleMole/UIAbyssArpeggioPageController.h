...
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_GETOVERRIDEFADEINANIM_OFFSET UNITYSDK_OFFSET(0x8FB1B30)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x8FB0BE0)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8FB0BD0)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_GOTOMAINCITY_OFFSET UNITYSDK_OFFSET(0x8FB2940)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_INITTOKEN_OFFSET UNITYSDK_OFFSET(0x8FB17F0)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_ONARPEGGIOROWCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x8FB2380)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8FB0BF0)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_ONDUNGEONSWEEP_OFFSET UNITYSDK_OFFSET(0x8FB21F0)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_ONINFOBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x8FB1BF0)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_ONLEVELCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x8FB25C0)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8FB1AC0)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_ONTALENTCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x8FB1E00)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_ONTOTALREWARDCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x8FB2050)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8FB2A90)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8FB0C90)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8FB13B0)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_PLAYBMFADEOUT_OFFSET UNITYSDK_OFFSET(0x8FB1F60)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8FB2B20)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER__ONTALENTCLICKHANDLE_B__20_0_OFFSET UNITYSDK_OFFSET(0x8FB2B30)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER___BASE_GETOVERRIDEFADEINANIM_OFFSET UNITYSDK_OFFSET(0x8FB2D10)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8FB2D20)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8FB2D90)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8FB2DA0)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8FB2DB0)
#define MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8FB2DC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssArpeggioPageController_TypeDefinitionIndex = 76108;

	class UIAbyssArpeggioPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79AE422BA06F6D26_174* _view; // 0x2F8
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_117*>* _chapterList; // 0x300
		::MoleMole::UIAbyssArpeggioLevelWidgetController* _levelWidgetCtrl; // 0x308
		::Class_2_208CC9941471731A_117* _selectChapterCfg; // 0x310
		...
		{
			return ((::System::String*(*)(::PVOID, ::MoleMole::UIFadeConfig*, ::Enum_3_B90C1A15EA6E3C2B))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER_GETOVERRIDEFADEINANIM_OFFSET))(this, fadeData, fromCtrl);
		}
		...
		{
			return ((::System::String*(*)(::PVOID, ::MoleMole::UIFadeConfig*, ::Enum_3_B90C1A15EA6E3C2B))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSARPEGGIOPAGECONTROLLER___BASE_GETOVERRIDEFADEINANIM_OFFSET))(this, P0, P1);
		}
