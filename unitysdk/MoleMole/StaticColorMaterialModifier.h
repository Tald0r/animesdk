...
#define MOLEMOLE_STATICCOLORMATERIALMODIFIER_METHOD_2_3750F4A9FEA7F5EF_OFFSET UNITYSDK_OFFSET(0x3B84A0)
#define MOLEMOLE_STATICCOLORMATERIALMODIFIER_METHOD_2_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x3B8520)
#define MOLEMOLE_STATICCOLORMATERIALMODIFIER_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x3B84B0)
#define MOLEMOLE_STATICCOLORMATERIALMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x3B8470)

namespace MoleMole
{
	inline static constexpr unsigned int StaticColorMaterialModifier_TypeDefinitionIndex = 74534;
