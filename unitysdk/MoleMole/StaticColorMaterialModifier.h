...
#define MOLEMOLE_STATICCOLORMATERIALMODIFIER_METHOD_2_3750F4A9FEA7F5EF_OFFSET UNITYSDK_OFFSET(0x4762F0)
#define MOLEMOLE_STATICCOLORMATERIALMODIFIER_METHOD_2_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x476300)
#define MOLEMOLE_STATICCOLORMATERIALMODIFIER_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x476370)
#define MOLEMOLE_STATICCOLORMATERIALMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x4762C0)

namespace MoleMole
{
	inline static constexpr unsigned int StaticColorMaterialModifier_TypeDefinitionIndex = 39298;
	...
	struct alignas(8) StaticColorMaterialModifier
	{
		...
		{
			return ((::Class_1_A0B58236B258B7B2*(*)(::PVOID, ::Enum_3_8855AD768EB2675C, ::MoleMole::MonoRenderHandler*))((::PBYTE)hIl2Cpp + MOLEMOLE_STATICCOLORMATERIALMODIFIER_METHOD_2_3750F4A9FEA7F5EF_OFFSET))(this, a1, a2);
		}
