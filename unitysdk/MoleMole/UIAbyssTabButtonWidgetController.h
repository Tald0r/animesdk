...
#define MOLEMOLE_UIABYSSTABBUTTONWIDGETCONTROLLER_GET_BUTTON_OFFSET UNITYSDK_OFFSET(0xBAD55E0)
#define MOLEMOLE_UIABYSSTABBUTTONWIDGETCONTROLLER_INITICON_OFFSET UNITYSDK_OFFSET(0xBAD58D0)
#define MOLEMOLE_UIABYSSTABBUTTONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBAD5750)
#define MOLEMOLE_UIABYSSTABBUTTONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBAD57F0)
#define MOLEMOLE_UIABYSSTABBUTTONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBAD5600)
#define MOLEMOLE_UIABYSSTABBUTTONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBAD56A0)
#define MOLEMOLE_UIABYSSTABBUTTONWIDGETCONTROLLER_REFRESHTEXT_OFFSET UNITYSDK_OFFSET(0xBAD59E0)
#define MOLEMOLE_UIABYSSTABBUTTONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBAD5AC0)
#define MOLEMOLE_UIABYSSTABBUTTONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBAD5AF0)
#define MOLEMOLE_UIABYSSTABBUTTONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBAD5B60)
#define MOLEMOLE_UIABYSSTABBUTTONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBAD5BE0)
#define MOLEMOLE_UIABYSSTABBUTTONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBAD5C40)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssTabButtonWidgetController_TypeDefinitionIndex = 70944;

	class UIAbyssTabButtonWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_8924D38FEB4DA006* _view; // 0x2A0
