...
#define MOLEMOLE_MONOBUDDYCLIMBOBSTANCLE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xB5F4360)
#define MOLEMOLE_MONOBUDDYCLIMBOBSTANCLE_METHOD_5_4D2DD9E068C43271_OFFSET UNITYSDK_OFFSET(0xB5F4AE0)
#define MOLEMOLE_MONOBUDDYCLIMBOBSTANCLE_METHOD_5_CB74603E77CF9AD9_OFFSET UNITYSDK_OFFSET(0xB5F5100)
#define MOLEMOLE_MONOBUDDYCLIMBOBSTANCLE_METHOD_5_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xB5F4F40)
#define MOLEMOLE_MONOBUDDYCLIMBOBSTANCLE_METHOD_5_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0xB5F5440)
#define MOLEMOLE_MONOBUDDYCLIMBOBSTANCLE_START_OFFSET UNITYSDK_OFFSET(0xB5F41D0)
#define MOLEMOLE_MONOBUDDYCLIMBOBSTANCLE__CTOR_OFFSET UNITYSDK_OFFSET(0xB5F5640)

namespace MoleMole
{
	inline static constexpr unsigned int MonoBuddyClimbObstancle_TypeDefinitionIndex = 60281;
