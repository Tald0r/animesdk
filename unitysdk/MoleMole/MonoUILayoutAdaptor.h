...
#define MOLEMOLE_MONOUILAYOUTADAPTOR_AUTOADAPTORUIBYSCREENRATE_OFFSET UNITYSDK_OFFSET(0xA52C630)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_CALDRIVENTRANSFORMPROPERTIES_OFFSET UNITYSDK_OFFSET(0xA52D4D0)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_DOINITLAYOUT_OFFSET UNITYSDK_OFFSET(0xA52BC80)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_FORCEREFRESHLAYOUT_OFFSET UNITYSDK_OFFSET(0xA52BBE0)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_INITTRANSFORM_OFFSET UNITYSDK_OFFSET(0xA52BEF0)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_ISCONTAINPLATFORMUIPARAMS_OFFSET UNITYSDK_OFFSET(0xA52BB00)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_ISPLATFORMUIPARAMSEMPTY_OFFSET UNITYSDK_OFFSET(0xA52BA40)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_RELOADDATAFROMJSON_OFFSET UNITYSDK_OFFSET(0xA52D1B0)
#define MOLEMOLE_MONOUILAYOUTADAPTOR__CALDRIVENTRANSFORMPROPERTIES_G__CANBEIGNORE_10_0_OFFSET UNITYSDK_OFFSET(0xA52DA60)
#define MOLEMOLE_MONOUILAYOUTADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA52DBD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUILayoutAdaptor_TypeDefinitionIndex = 74024;
