...
#define MOLEMOLE_MONOUILAYOUTADAPTOR_AUTOADAPTORUIBYSCREENRATE_OFFSET UNITYSDK_OFFSET(0x9AB96A0)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_CALDRIVENTRANSFORMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x9ABA540)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_DOINITLAYOUT_OFFSET UNITYSDK_OFFSET(0x9AB8CF0)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_FORCEREFRESHLAYOUT_OFFSET UNITYSDK_OFFSET(0x9AB8C50)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_INITTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9AB8F60)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_ISCONTAINPLATFORMUIPARAMS_OFFSET UNITYSDK_OFFSET(0x9AB8B70)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_ISPLATFORMUIPARAMSEMPTY_OFFSET UNITYSDK_OFFSET(0x9AB8AB0)
#define MOLEMOLE_MONOUILAYOUTADAPTOR_RELOADDATAFROMJSON_OFFSET UNITYSDK_OFFSET(0x9ABA220)
#define MOLEMOLE_MONOUILAYOUTADAPTOR__CALDRIVENTRANSFORMPROPERTIES_G__CANBEIGNORE_10_0_OFFSET UNITYSDK_OFFSET(0x9ABAAD0)
#define MOLEMOLE_MONOUILAYOUTADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9ABAC40)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUILayoutAdaptor_TypeDefinitionIndex = 76202;
