...
#define MOLEMOLE_FILTERANCHORBYAABBCOLLIDER_CREATEBOUNDS_OFFSET UNITYSDK_OFFSET(0xC208C80)
#define MOLEMOLE_FILTERANCHORBYAABBCOLLIDER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xC208390)
#define MOLEMOLE_FILTERANCHORBYAABBCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xC208FD0)
#define MOLEMOLE_FILTERANCHORBYAABBCOLLIDER___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xC209010)

namespace MoleMole
{
	inline static constexpr unsigned int FilterAnchorByAABBCollider_TypeDefinitionIndex = 46685;
