...
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER_EXPENDVIEW_OFFSET UNITYSDK_OFFSET(0xD227670)
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xD227AC0)
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER_ONBTNREGIONCLICK_OFFSET UNITYSDK_OFFSET(0xD2275F0)
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD227850)
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD2279D0)
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD2278F0)
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD227410)
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD2277A0)
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD227CB0)
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD227CC0)
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD227D30)
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD227D40)
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD227DC0)
#define MOLEMOLE_UIABYSSMAPDETAILINFOROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD227E20)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssMapDetailInfoRowWidgetController_TypeDefinitionIndex = 70037;

	class UIAbyssMapDetailInfoRowWidgetController : public ::MoleMole::ScrollExpendAbleView
	{
	public:
		::Class_2_BB18B5C1205C80C6_4* _view; // 0x2D8
