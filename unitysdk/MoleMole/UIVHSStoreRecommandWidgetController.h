...
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_CHECKVALID_OFFSET UNITYSDK_OFFSET(0xC3F8520)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_CHECKVHSINCD_OFFSET UNITYSDK_OFFSET(0xC3F8A10)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0xC3F9750)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_GET__SELECTEDVHS_OFFSET UNITYSDK_OFFSET(0xC3F96D0)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_INITROLEWIDGET_OFFSET UNITYSDK_OFFSET(0xC3F7C90)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_INITSLOTFORLIMIT_OFFSET UNITYSDK_OFFSET(0xC3F7E50)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_ONAFTERVHSSELECTCHANGEFORLIMIT_OFFSET UNITYSDK_OFFSET(0xC3F8590)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_ONAFTERVHSSELECTCHANGEINNER_OFFSET UNITYSDK_OFFSET(0xC3F8310)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_ONCONTEXTCHANGE_OFFSET UNITYSDK_OFFSET(0xC3F8BE0)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC3F83A0)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC3F8440)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC3F7AB0)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_ONVHSMODULECURRENTTAGLISTUPDATE_OFFSET UNITYSDK_OFFSET(0xC3F8E70)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_ONVHSSTORELIMITSUBMITED_OFFSET UNITYSDK_OFFSET(0xC3F8D10)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_ONVHSSTORELIMITSUBMITTING_OFFSET UNITYSDK_OFFSET(0xC3F8C40)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0xC3F9760)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC3F9910)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC3F9860)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER__INITSLOTFORLIMIT_B__8_0_OFFSET UNITYSDK_OFFSET(0xC3F99A0)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER__INITSLOTFORLIMIT_B__8_1_OFFSET UNITYSDK_OFFSET(0xC3FA040)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER__ONAFTERVHSSELECTCHANGEINNER_G__REFRESHSLOT_7_0_OFFSET UNITYSDK_OFFSET(0xC3F86F0)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC3FA060)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC3FA0D0)
#define MOLEMOLE_UIVHSSTORERECOMMANDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC3FA150)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreRecommandWidgetController_TypeDefinitionIndex = 71960;
	...
	public:
		...
		{
			return (::System::Func_1<::System::Collections::Generic::IReadOnlyList_1<::Class_2_CE905445948732C1_Class_1_A6660CA21D7C1066_Class_1_C277D6FBDA93149D*>*>**)Il2CppClass::FromTypeDefinitionIndex(UIVHSStoreRecommandWidgetController_TypeDefinitionIndex)->GetStaticField(0x32B30);
		}
		...
		::Class_2_208CC9941471731A_357* _activityRPQuestTemplate; // 0x2B8
