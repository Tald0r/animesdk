...
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER__REFRESHTASK_D__59_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x45CA80)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER__REFRESHTASK_D__59_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionsAbyssS2DialogPopWindowController__RefreshTask_d__59_TypeDefinitionIndex = 71669;
