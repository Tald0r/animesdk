...
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x748CCB0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x748D190)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x748D230)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x748CCC0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x748CEC0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x748CFF0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x748D2C0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x748D2D0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER__ONUIINIT_B__4_1_OFFSET UNITYSDK_OFFSET(0x748D350)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x748D360)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x748D3D0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x748D3E0)
#define MOLEMOLE_UIPARTNERDATEREWARDPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x748D3F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPartnerDateRewardPopWindowController_TypeDefinitionIndex = 47874;
