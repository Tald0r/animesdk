...
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_CREATEREWARDITEMSCROLL_OFFSET UNITYSDK_OFFSET(0x8096640)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_GET_CURREWARDTAKESTATE_OFFSET UNITYSDK_OFFSET(0x80964C0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x80962C0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8096440)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8096360)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8096220)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_REFRESHTAKEBTNSTATE_OFFSET UNITYSDK_OFFSET(0x80969F0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8096CF0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8096DB0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8096E20)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8096EA0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8096F20)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookAvatarAwakenRewardItemWidgetController_TypeDefinitionIndex = 63012;
