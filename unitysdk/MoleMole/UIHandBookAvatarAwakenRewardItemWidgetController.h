...
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_CREATEREWARDITEMSCROLL_OFFSET UNITYSDK_OFFSET(0xAC74620)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_GET_CURREWARDTAKESTATE_OFFSET UNITYSDK_OFFSET(0xAC744A0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC742A0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC74420)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC74340)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC74200)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER_REFRESHTAKEBTNSTATE_OFFSET UNITYSDK_OFFSET(0xAC749D0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC74CD0)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC74D90)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC74E00)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC74E80)
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC74F00)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookAvatarAwakenRewardItemWidgetController_TypeDefinitionIndex = 43042;
	...
	public:
		...
		::MoleMole::UIHandBookAwakenItemRewardContext* m_ctx; // 0x2D8
