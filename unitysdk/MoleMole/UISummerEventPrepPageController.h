...
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_GETFIXEDGYROROTATION_OFFSET UNITYSDK_OFFSET(0xC3D5110)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC3CF450)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_GET__SPACETYPE_OFFSET UNITYSDK_OFFSET(0xC3D3F90)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_INITBIND_OFFSET UNITYSDK_OFFSET(0xC3CFAD0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_INITREDPOINT_OFFSET UNITYSDK_OFFSET(0xC3D01E0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONALICETASKBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC3D7370)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONALICETASKLOCKBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC3D7860)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC3CF460)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xC3D3690)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONFULLSCREENBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC3D80F0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONHIDEBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC3D3890)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONMAINTASKBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC3D6A10)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONMAINTASKLOCKBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC3D6E20)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONOPENTIPSPANELBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xC3D6850)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONQUESTCHANGE_OFFSET UNITYSDK_OFFSET(0xC3D6740)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONREFRESHPOPULARITY_OFFSET UNITYSDK_OFFSET(0xC3D67B0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONREWARDBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC3D8030)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC3D3A80)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC3D3AF0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC3CF500)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC3D08F0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONYUZUHATASKBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC3D79D0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_ONYUZUHATASKLOCKBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC3D7EC0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_OPENMAP_OFFSET UNITYSDK_OFFSET(0xC3D6F90)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0xC3D09A0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_PRECHECKINPUTBLOCK_OFFSET UNITYSDK_OFFSET(0xC3D3770)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_PROCESS_OFFSET UNITYSDK_OFFSET(0xC3D5D60)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_RECORDBUTTONCLICKACTION_OFFSET UNITYSDK_OFFSET(0xC3D70F0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC3D0C10)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_RESETATTITUDE_OFFSET UNITYSDK_OFFSET(0xC3D3470)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xC3D3EA0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_UPDATEDEBUG_OFFSET UNITYSDK_OFFSET(0xC3D50B0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_UPDATEGYRO_OFFSET UNITYSDK_OFFSET(0xC3D40E0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC3D4030)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC3D82B0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC3D8160)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER__ONHIDEBTNCLICK_B__54_0_OFFSET UNITYSDK_OFFSET(0xC3D84C0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER__ONREWARDBTNCLICK_B__53_0_OFFSET UNITYSDK_OFFSET(0xC3D82C0)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC3D8590)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xC3D8600)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC3D8610)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC3D8620)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC3D8630)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC3D8640)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER___BASE_PRECHECKINPUTBLOCK_OFFSET UNITYSDK_OFFSET(0xC3D8650)
#define MOLEMOLE_UISUMMEREVENTPREPPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xC3D86E0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerEventPrepPageController_TypeDefinitionIndex = 46893;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UISummerEventPrepPageController_TypeDefinitionIndex)->GetStaticField(0x11DA0);
		}
		::Class_2_C7387D40D4120A48_12* _view; // 0x308
		::Class_2_DF4F3CC24695652C* _model; // 0x310
		::Class_2_5EA04932F3E7FC4B* _timelineTask; // 0x318
