...
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD25C8F0)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONCLICKCONSOLEBLACKLISTTAB_OFFSET UNITYSDK_OFFSET(0xD25DBE0)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONCLICKINGAMEBLACKLISTTAB_OFFSET UNITYSDK_OFFSET(0xD25DC50)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD25D120)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONRECEIVEBLACKLIST_OFFSET UNITYSDK_OFFSET(0xD25D250)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONREMOVEFROMBLACKLIST_OFFSET UNITYSDK_OFFSET(0xD25D7F0)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD25D1C0)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD25C900)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD25D070)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_PLATFORM_ONRECEIVEBLACKLIST_OFFSET UNITYSDK_OFFSET(0xD25D930)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER_SHOWEMPTYCONTENT_OFFSET UNITYSDK_OFFSET(0xD25D4E0)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD25DD20)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0xD25DD90)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER__ONUIINIT_B__4_1_OFFSET UNITYSDK_OFFSET(0xD25DE10)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER__ONUIINIT_B__4_2_OFFSET UNITYSDK_OFFSET(0xD25DE90)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER__ONUIINIT_B__4_3_OFFSET UNITYSDK_OFFSET(0xD25DEA0)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD25DF10)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD25DF80)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD25DF90)
#define MOLEMOLE_UIBLACKLISTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD25DFA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBlackListPopWindowController_TypeDefinitionIndex = 67704;
