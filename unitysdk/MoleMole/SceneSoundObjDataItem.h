...
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0xA49C5B0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0xA49C580)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xA49C570)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_INIT_OFFSET UNITYSDK_OFFSET(0xA49C680)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_METHOD_5_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0xA49CC20)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_METHOD_5_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xA49CE40)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA49C6E0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_ONITEMACTIVECHANGED_OFFSET UNITYSDK_OFFSET(0xA49C790)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_ONSCENELEAVE_OFFSET UNITYSDK_OFFSET(0xA49CA80)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_ONSCENETAGCHANGED_OFFSET UNITYSDK_OFFSET(0xA49C810)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_RUNTIMERESET_OFFSET UNITYSDK_OFFSET(0xA49D010)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_RUNTIMETOGGLEACTIVE_OFFSET UNITYSDK_OFFSET(0xA49D090)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_SETDEACTIVEBYBINDINGOBJECT_OFFSET UNITYSDK_OFFSET(0xA49CB30)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA49D160)

namespace MoleMole
{
	inline static constexpr unsigned int SceneSoundObjDataItem_TypeDefinitionIndex = 38813;
