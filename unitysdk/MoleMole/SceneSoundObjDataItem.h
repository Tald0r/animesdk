...
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x7A9FC10)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x7A9FBE0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x7A9FBD0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_INIT_OFFSET UNITYSDK_OFFSET(0x7A9FCE0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_METHOD_5_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0x7AA0280)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_METHOD_5_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x7AA0490)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x7A9FD40)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_ONITEMACTIVECHANGED_OFFSET UNITYSDK_OFFSET(0x7A9FDF0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_ONSCENELEAVE_OFFSET UNITYSDK_OFFSET(0x7AA00E0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_ONSCENETAGCHANGED_OFFSET UNITYSDK_OFFSET(0x7A9FE70)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_RUNTIMERESET_OFFSET UNITYSDK_OFFSET(0x7AA0660)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_RUNTIMETOGGLEACTIVE_OFFSET UNITYSDK_OFFSET(0x7AA06E0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_SETDEACTIVEBYBINDINGOBJECT_OFFSET UNITYSDK_OFFSET(0x7AA0190)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x7AA07B0)

namespace MoleMole
{
	inline static constexpr unsigned int SceneSoundObjDataItem_TypeDefinitionIndex = 80780;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_SCENESOUNDOBJDATAITEM_METHOD_5_0076C796B2045359_OFFSET))(this);
		}

		::System::Void Method_5_18982EFD3B740683()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_SCENESOUNDOBJDATAITEM_METHOD_5_18982EFD3B740683_OFFSET))(this);
		}
	};
}
