...
#define MOLEMOLE_LEVELPERFORMCAMERASUBSYSTEM___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0x6E98C10)
#define MOLEMOLE_LEVELPERFORMCAMERASUBSYSTEM___C__DISPLAYCLASS23_0__REFRESHLEVELPERFORMCAMERA_B__0_OFFSET UNITYSDK_OFFSET(0x6E98C80)
#define MOLEMOLE_LEVELPERFORMCAMERASUBSYSTEM___C__DISPLAYCLASS23_0__REFRESHLEVELPERFORMCAMERA_B__1_OFFSET UNITYSDK_OFFSET(0x6E98C90)
#define MOLEMOLE_LEVELPERFORMCAMERASUBSYSTEM___C__DISPLAYCLASS23_0__REFRESHLEVELPERFORMCAMERA_B__2_OFFSET UNITYSDK_OFFSET(0x6E98CC0)
#define MOLEMOLE_LEVELPERFORMCAMERASUBSYSTEM___C__DISPLAYCLASS23_0__REFRESHLEVELPERFORMCAMERA_B__3_OFFSET UNITYSDK_OFFSET(0x6E98C20)

namespace MoleMole
{
	inline static constexpr unsigned int LevelPerformCameraSubSystem___c__DisplayClass23_0_TypeDefinitionIndex = 54341;
