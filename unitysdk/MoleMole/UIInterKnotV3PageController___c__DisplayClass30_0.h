...
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0x6CAC960)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___C__DISPLAYCLASS30_0__DOEXPANIMATION_B__0_OFFSET UNITYSDK_OFFSET(0x6CAC970)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___C__DISPLAYCLASS30_0__DOEXPANIMATION_B__1_OFFSET UNITYSDK_OFFSET(0x6CAC980)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___C__DISPLAYCLASS30_0__DOEXPANIMATION_B__2_OFFSET UNITYSDK_OFFSET(0x6CAC9D0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___C__DISPLAYCLASS30_0__DOEXPANIMATION_B__3_OFFSET UNITYSDK_OFFSET(0x6CACA50)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___C__DISPLAYCLASS30_0__DOEXPANIMATION_B__4_OFFSET UNITYSDK_OFFSET(0x6CACA60)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___C__DISPLAYCLASS30_0__DOEXPANIMATION_B__5_OFFSET UNITYSDK_OFFSET(0x6CACAB0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___C__DISPLAYCLASS30_0__DOEXPANIMATION_B__6_OFFSET UNITYSDK_OFFSET(0x6CACD10)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTROLLER___C__DISPLAYCLASS30_0__DOEXPANIMATION_B__7_OFFSET UNITYSDK_OFFSET(0x6CACD20)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotV3PageController___c__DisplayClass30_0_TypeDefinitionIndex = 63894;
	...
	public:
		...
		::MoleMole::UIInterKnotV3PageController* __4__this; // 0x20
