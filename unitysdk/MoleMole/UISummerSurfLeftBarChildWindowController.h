...
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xACD0F30)
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER_GET_FILLMAT_OFFSET UNITYSDK_OFFSET(0xACD0F20)
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xACD0CD0)
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xACD0E90)
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xACD0F50)
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xACD0FB0)
#define MOLEMOLE_UISUMMERSURFLEFTBARCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xACD1020)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerSurfLeftBarChildWindowController_TypeDefinitionIndex = 78683;
