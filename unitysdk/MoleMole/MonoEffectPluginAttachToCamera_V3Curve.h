...
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x318750)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_GET_STARTVALUE_OFFSET UNITYSDK_OFFSET(0x32FB90)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_GET_STOPVALUE_OFFSET UNITYSDK_OFFSET(0x32FBC0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_METHOD_2_932BC234D35144E8_OFFSET UNITYSDK_OFFSET(0x32FC10)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_METHOD_2_B4859502A23E740B_OFFSET UNITYSDK_OFFSET(0x75B0CC0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_METHOD_2_D7F0936662AC1A47_OFFSET UNITYSDK_OFFSET(0x32FBF0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_SET_DURATION_OFFSET UNITYSDK_OFFSET(0x318740)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_SET_STARTVALUE_OFFSET UNITYSDK_OFFSET(0x32FBB0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_V3CURVE_SET_STOPVALUE_OFFSET UNITYSDK_OFFSET(0x32FBE0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAttachToCamera_V3Curve_TypeDefinitionIndex = 40389;
