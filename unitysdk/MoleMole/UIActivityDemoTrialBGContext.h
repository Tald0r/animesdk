...
#define MOLEMOLE_UIACTIVITYDEMOTRIALBGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC25DE20)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityDemoTrialBGContext_TypeDefinitionIndex = 60074;
