...
#define MOLEMOLE_UITITLESELECTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x7C4D420)
#define MOLEMOLE_UITITLESELECTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS20_0__ONCLICKAPPLYMEDALSETTINGBTN_B__2_OFFSET UNITYSDK_OFFSET(0x7C50380)

namespace MoleMole
{
	inline static constexpr unsigned int UITitleSelectDialogPopWindowController___c__DisplayClass20_0_TypeDefinitionIndex = 73041;
