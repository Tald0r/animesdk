...
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_GET_ISCORNERSVALID_OFFSET UNITYSDK_OFFSET(0x8A7DD40)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_GET_REFRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x8A7DC50)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_METHOD_5_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0x8A7E2A0)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_METHOD_5_737220D2233A9067_OFFSET UNITYSDK_OFFSET(0x8A7DE70)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x8A7DF50)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x8A7DDC0)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x8A7DEE0)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8A7E1E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMindscapeController_TypeDefinitionIndex = 76364;
