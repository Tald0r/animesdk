...
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_GET_ISCORNERSVALID_OFFSET UNITYSDK_OFFSET(0x8C868F0)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_GET_REFRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x8C86800)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_METHOD_5_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0x8C86E50)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_METHOD_5_737220D2233A9067_OFFSET UNITYSDK_OFFSET(0x8C86A20)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x8C86B00)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x8C86970)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x8C86A90)
#define MOLEMOLE_MONOMINDSCAPECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C86D90)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMindscapeController_TypeDefinitionIndex = 73891;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOMINDSCAPECONTROLLER_METHOD_5_737220D2233A9067_OFFSET))(this);
		}

		::System::Void Method_5_0CC4BC19C602BCD0()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOMINDSCAPECONTROLLER_METHOD_5_0CC4BC19C602BCD0_OFFSET))(this);
		}
	};
}
