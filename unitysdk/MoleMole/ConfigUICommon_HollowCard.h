...
#define MOLEMOLE_CONFIGUICOMMON_HOLLOWCARD__CTOR_OFFSET UNITYSDK_OFFSET(0xC1E7CE0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_HollowCard_TypeDefinitionIndex = 47645;
