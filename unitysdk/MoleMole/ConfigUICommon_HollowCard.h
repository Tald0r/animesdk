...
#define MOLEMOLE_CONFIGUICOMMON_HOLLOWCARD__CTOR_OFFSET UNITYSDK_OFFSET(0x81FEAE0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_HollowCard_TypeDefinitionIndex = 79894;
