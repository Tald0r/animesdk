...
#define MOLEMOLE_UIBLURCONFIGCURVEDATAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA25B740)

namespace MoleMole
{
	inline static constexpr unsigned int UIBlurConfigCurveDataInfo_TypeDefinitionIndex = 41391;
