...
#define MOLEMOLE_UIBLURCONFIGCURVEDATAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD25E010)

namespace MoleMole
{
	inline static constexpr unsigned int UIBlurConfigCurveDataInfo_TypeDefinitionIndex = 61082;
