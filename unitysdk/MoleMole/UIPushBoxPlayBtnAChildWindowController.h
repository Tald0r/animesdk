...
#define MOLEMOLE_UIPUSHBOXPLAYBTNACHILDWINDOWCONTROLLER_GET_VIRTUALLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xB6D9F50)
#define MOLEMOLE_UIPUSHBOXPLAYBTNACHILDWINDOWCONTROLLER_INITPLAYBTN_OFFSET UNITYSDK_OFFSET(0xB6DA280)
#define MOLEMOLE_UIPUSHBOXPLAYBTNACHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6DA150)
#define MOLEMOLE_UIPUSHBOXPLAYBTNACHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6DA1F0)
#define MOLEMOLE_UIPUSHBOXPLAYBTNACHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6D9F60)
#define MOLEMOLE_UIPUSHBOXPLAYBTNACHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB6DA020)
#define MOLEMOLE_UIPUSHBOXPLAYBTNACHILDWINDOWCONTROLLER_REFRESHBTNINFO_OFFSET UNITYSDK_OFFSET(0xB6DA0E0)
#define MOLEMOLE_UIPUSHBOXPLAYBTNACHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB6DA300)
#define MOLEMOLE_UIPUSHBOXPLAYBTNACHILDWINDOWCONTROLLER___BASE_INITPLAYBTN_OFFSET UNITYSDK_OFFSET(0xB6DA360)
#define MOLEMOLE_UIPUSHBOXPLAYBTNACHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6DA370)
#define MOLEMOLE_UIPUSHBOXPLAYBTNACHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6DA3E0)
#define MOLEMOLE_UIPUSHBOXPLAYBTNACHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6DA3F0)
#define MOLEMOLE_UIPUSHBOXPLAYBTNACHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB6DA400)

namespace MoleMole
{
	inline static constexpr unsigned int UIPushBoxPlayBtnAChildWindowController_TypeDefinitionIndex = 43565;

	class UIPushBoxPlayBtnAChildWindowController : public ::MoleMole::UIVirtualPlayBtnBaseController
	{
	public:
		::Class_2_8469E7523673A92C_4* _view; // 0x310
