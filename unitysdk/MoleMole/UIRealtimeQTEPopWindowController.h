...
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_DOCHECKCLOSESTATE_OFFSET UNITYSDK_OFFSET(0xCFD73D0)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_GETREALTIMEQTEWIDGETROOT_OFFSET UNITYSDK_OFFSET(0xCFD7C00)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_GET_ISENABLEFADEINPUTBLOCKING_OFFSET UNITYSDK_OFFSET(0xCFD6CD0)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0xCFD6CF0)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0xCFD6CE0)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xCFD6CC0)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xCFD6F70)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCFD7310)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFD71D0)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_ONREALTIMEQTEDESTROY_OFFSET UNITYSDK_OFFSET(0xCFD78B0)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_ONREALTIMEQTEEND_OFFSET UNITYSDK_OFFSET(0xCFD7450)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFD7270)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFD6D70)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFD6DE0)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_TRYCLOSEREALTIMEQTE_OFFSET UNITYSDK_OFFSET(0xCFD7540)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER_TRYCREATEBUTTONQTE_OFFSET UNITYSDK_OFFSET(0xCFD79A0)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD7CD0)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER__TRYCLOSEREALTIMEQTE_B__16_0_OFFSET UNITYSDK_OFFSET(0xCFD7CE0)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER__TRYCLOSEREALTIMEQTE_B__16_1_OFFSET UNITYSDK_OFFSET(0xCFD7CF0)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER___BASE_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0xCFD7D00)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFD7D10)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFD7D80)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFD7D90)
#define MOLEMOLE_UIREALTIMEQTEPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFD7DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRealtimeQTEPopWindowController_TypeDefinitionIndex = 60978;

	class UIRealtimeQTEPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_69CBB7FF0BE6A673_37* _view; // 0x2F8
