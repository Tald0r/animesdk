...
#define MOLEMOLE_MONOINLEVELDOORPARTICLESYSTEM_ONPARTICLESYSTEMSTOPPED_OFFSET UNITYSDK_OFFSET(0x8A7DA40)
#define MOLEMOLE_MONOINLEVELDOORPARTICLESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x8A7DB40)

namespace MoleMole
{
	inline static constexpr unsigned int MonoInLevelDoorParticleSystem_TypeDefinitionIndex = 70096;
