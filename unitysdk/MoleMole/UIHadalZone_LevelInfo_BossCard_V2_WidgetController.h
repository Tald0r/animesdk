...
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC73DF0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC73890)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC73E90)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC73390)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC73430)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0xAC73610)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER_SETCLICK_OFFSET UNITYSDK_OFFSET(0xAC73AC0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC73F70)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__6_0_OFFSET UNITYSDK_OFFSET(0xAC73FA0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0xAC73F80)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER__UPDATECARD_OFFSET UNITYSDK_OFFSET(0xAC73B30)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC73FC0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC74030)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC740B0)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC74130)
#define MOLEMOLE_UIHADALZONE_LEVELINFO_BOSSCARD_V2_WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC74190)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_LevelInfo_BossCard_V2_WidgetController_TypeDefinitionIndex = 66044;

	class UIHadalZone_LevelInfo_BossCard_V2_WidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_EC707217DE7794EF_7* _view; // 0x2D0
