...
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER__ROTATENODE_D__43_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xCB33F80)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER__ROTATENODE_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xCB34350)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER__ROTATENODE_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xCB343B0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER__ROTATENODE_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xCB34360)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER__ROTATENODE_D__43_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCB33F70)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER__ROTATENODE_D__43__CTOR_OFFSET UNITYSDK_OFFSET(0xCB33F60)

namespace MoleMole
{
	inline static constexpr unsigned int UIDataFixNodeWidgetController__RotateNode_d__43_TypeDefinitionIndex = 60152;
	...
	public:
		...
		::MoleMole::UIDataFixNodeWidgetController___c__DisplayClass43_0* __8__1; // 0x18
		::System::Single _time_5__2; // 0x20
		::System::Single __2__current; // 0x24
		::System::Single _prevRate_5__3; // 0x28
