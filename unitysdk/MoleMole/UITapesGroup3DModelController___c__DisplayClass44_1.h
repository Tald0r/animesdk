...
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS44_1__CTOR_OFFSET UNITYSDK_OFFSET(0x9EE3E80)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS44_1__LIFTTAPES_B__0_OFFSET UNITYSDK_OFFSET(0x9EE3E90)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS44_1__LIFTTAPES_B__1_OFFSET UNITYSDK_OFFSET(0x9EE4020)

namespace MoleMole
{
	inline static constexpr unsigned int UITapesGroup3DModelController___c__DisplayClass44_1_TypeDefinitionIndex = 53116;

	class UITapesGroup3DModelController___c__DisplayClass44_1 : public ::System::Object
	{
	public:
		::MoleMole::UITapesGroup3DModelController___c__DisplayClass44_0* CS___8__locals1; // 0x10
		::MoleMole::UITape3DModelController* leftTape; // 0x18
		::MoleMole::UITape3DModelController* rightTape; // 0x20
