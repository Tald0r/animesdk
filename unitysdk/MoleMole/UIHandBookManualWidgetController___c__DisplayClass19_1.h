...
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER___C__DISPLAYCLASS19_1__CTOR_OFFSET UNITYSDK_OFFSET(0x7D07D60)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER___C__DISPLAYCLASS19_1__INITTAB_B__2_OFFSET UNITYSDK_OFFSET(0x7D07D70)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookManualWidgetController___c__DisplayClass19_1_TypeDefinitionIndex = 49197;
