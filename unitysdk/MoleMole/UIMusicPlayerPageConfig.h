...
#define MOLEMOLE_UIMUSICPLAYERPAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB2498F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicPlayerPageConfig_TypeDefinitionIndex = 56985;
