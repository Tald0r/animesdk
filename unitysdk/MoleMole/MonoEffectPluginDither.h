...
#define MOLEMOLE_MONOEFFECTPLUGINDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0xA643000)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginDither_TypeDefinitionIndex = 67539;
