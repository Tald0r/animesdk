...
#define MOLEMOLE_MONOEFFECTPLUGINDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0xB3ABD60)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginDither_TypeDefinitionIndex = 47065;
