...
#define MOLEMOLE_UISKILLRECOMMENDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF3A120)
#define MOLEMOLE_UISKILLRECOMMENDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF3A340)
#define MOLEMOLE_UISKILLRECOMMENDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF39FD0)
#define MOLEMOLE_UISKILLRECOMMENDROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF3A070)
#define MOLEMOLE_UISKILLRECOMMENDROWWIDGETCONTROLLER_REFRESHSKILLICON_OFFSET UNITYSDK_OFFSET(0xDF3A1C0)
#define MOLEMOLE_UISKILLRECOMMENDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF3A420)
#define MOLEMOLE_UISKILLRECOMMENDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF3A450)
#define MOLEMOLE_UISKILLRECOMMENDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF3A4C0)
#define MOLEMOLE_UISKILLRECOMMENDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF3A540)
#define MOLEMOLE_UISKILLRECOMMENDROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF3A5A0)

namespace MoleMole
{
	inline static constexpr unsigned int UISkillRecommendRowWidgetController_TypeDefinitionIndex = 55108;

	class UISkillRecommendRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_F565C1781196F0E8* _view; // 0x2A0
