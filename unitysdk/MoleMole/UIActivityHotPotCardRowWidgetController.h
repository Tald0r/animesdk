...
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER_ONCHANGEELITEMODE_OFFSET UNITYSDK_OFFSET(0xDEDDD30)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEDDA20)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xDEDD270)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDEDD360)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEDDAC0)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEDCF70)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDEDD1C0)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xDEDD4B0)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xDEDDC10)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0xDEDDCA0)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER_SETSHOWSELECT_OFFSET UNITYSDK_OFFSET(0xDEDDBA0)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDEDDF10)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER__ONCHANGEELITEMODE_B__16_0_OFFSET UNITYSDK_OFFSET(0xDEDDF20)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEDDF50)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xDEDDFC0)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDEDE030)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEDE0B0)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEDE130)
#define MOLEMOLE_UIACTIVITYHOTPOTCARDROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDEDE190)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotPotCardRowWidgetController_TypeDefinitionIndex = 68160;
	...
	public:
		...
		::System::Boolean _isEliteMode; // 0x2E0
		::System::Boolean _showSelect; // 0x2E1
		::Foundation::Coroutine::CoroutineHandle _eliteCoroutine; // 0x2E4
