...
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_ISFUNCTIONENABLED_OFFSET UNITYSDK_OFFSET(0xB84C430)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_ISTEMPWORKABLE_OFFSET UNITYSDK_OFFSET(0xB84C340)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_MANUALCHECKFOCUSSTATE_OFFSET UNITYSDK_OFFSET(0xB84AEB0)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_0C97146C76A4CBA8_OFFSET UNITYSDK_OFFSET(0xB84CA10)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_14014646206E49EF_OFFSET UNITYSDK_OFFSET(0xB84B000)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_209EFD130889B83A_OFFSET UNITYSDK_OFFSET(0xB84CC10)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_3215AC64FF8F0B10_OFFSET UNITYSDK_OFFSET(0xB84CF30)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_543C1BD7BEC7BBEB_OFFSET UNITYSDK_OFFSET(0xB84D2C0)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_6B754E4371E63B47_OFFSET UNITYSDK_OFFSET(0xB84ACB0)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_86D9A88811BF5A61_OFFSET UNITYSDK_OFFSET(0xB84BB80)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_88D8A119ADE8170D_OFFSET UNITYSDK_OFFSET(0xB84B4D0)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_8C748714EA118F16_OFFSET UNITYSDK_OFFSET(0xB84C540)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_944155B538471569_OFFSET UNITYSDK_OFFSET(0xB84BCD0)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xB84C280)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_C495FC84AA2302E0_OFFSET UNITYSDK_OFFSET(0xB84B090)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB84D700)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB84D800)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_E2F53DB7A99BFA85_OFFSET UNITYSDK_OFFSET(0xB84B780)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0xB84C1D0)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_METHOD_6_FBF2CB29FD3B55E6_OFFSET UNITYSDK_OFFSET(0xB84D770)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP_SETSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xB84BDD0)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xB84CCB0)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP___BASE_ISFUNCTIONENABLED_OFFSET UNITYSDK_OFFSET(0xB84CCF0)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP___BASE_ISTEMPWORKABLE_OFFSET UNITYSDK_OFFSET(0xB84CD60)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP___BASE_ISWORKABLEINNER_OFFSET UNITYSDK_OFFSET(0xB84CDC0)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xB84CE20)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP___BASE_ONMODULECLEAR_OFFSET UNITYSDK_OFFSET(0xB84CEB0)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP___BASE_ONMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xB84CF10)
#define MOLEMOLE_MONOGAMEPADTABBUTTONGROUP___BASE_ONMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xB84CF20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadTabButtonGroup_TypeDefinitionIndex = 48521;
