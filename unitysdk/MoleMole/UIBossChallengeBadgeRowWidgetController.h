...
#define MOLEMOLE_UIBOSSCHALLENGEBADGEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFD1CE0)
#define MOLEMOLE_UIBOSSCHALLENGEBADGEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFD1D50)
#define MOLEMOLE_UIBOSSCHALLENGEBADGEROWWIDGETCONTROLLER_SETISHADAL_OFFSET UNITYSDK_OFFSET(0xBFD1E50)
#define MOLEMOLE_UIBOSSCHALLENGEBADGEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFD1FF0)
#define MOLEMOLE_UIBOSSCHALLENGEBADGEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFD2020)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeBadgeRowWidgetController_TypeDefinitionIndex = 54547;
