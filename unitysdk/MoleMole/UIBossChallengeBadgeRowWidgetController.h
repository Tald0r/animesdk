...
#define MOLEMOLE_UIBOSSCHALLENGEBADGEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB05280)
#define MOLEMOLE_UIBOSSCHALLENGEBADGEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB052F0)
#define MOLEMOLE_UIBOSSCHALLENGEBADGEROWWIDGETCONTROLLER_SETISHADAL_OFFSET UNITYSDK_OFFSET(0xBB053F0)
#define MOLEMOLE_UIBOSSCHALLENGEBADGEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB05590)
#define MOLEMOLE_UIBOSSCHALLENGEBADGEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB055C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeBadgeRowWidgetController_TypeDefinitionIndex = 79065;
