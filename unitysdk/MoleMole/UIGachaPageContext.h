...
#define MOLEMOLE_UIGACHAPAGECONTEXT_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0xD059C50)
#define MOLEMOLE_UIGACHAPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD059DE0)
#define MOLEMOLE_UIGACHAPAGECONTEXT___BASE_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0xD059DF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPageContext_TypeDefinitionIndex = 71842;
	...
	public:
		...
		::System::Int32 GachaScheduleIdForUIGroup; // 0x30
