...
#define MOLEMOLE_UIGENERALOPTIONDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA99A510)
#define MOLEMOLE_UIGENERALOPTIONDIALOGPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA99A520)
#define MOLEMOLE_UIGENERALOPTIONDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA99A590)
#define MOLEMOLE_UIGENERALOPTIONDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA99A690)
#define MOLEMOLE_UIGENERALOPTIONDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA99A8D0)
#define MOLEMOLE_UIGENERALOPTIONDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA99A8E0)
#define MOLEMOLE_UIGENERALOPTIONDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA99A950)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralOptionDialogPopWindowController_TypeDefinitionIndex = 55271;
