...
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEEBB20)
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEEBBC0)
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEEB980)
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDEEBA20)
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER_REFRESHPROGRESSBAR_OFFSET UNITYSDK_OFFSET(0xDEEBFC0)
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER_REFRESHPROGRESSLIST_OFFSET UNITYSDK_OFFSET(0xDEEBDE0)
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER_REFRESHPROGRESSPOINTVIEW_OFFSET UNITYSDK_OFFSET(0xDEEC930)
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xDEEBCA0)
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xDEECC90)
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDEECC60)
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEECCD0)
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEECD40)
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEECDC0)
#define MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDEECE20)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityWinterPage03WidgetController_TypeDefinitionIndex = 44058;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIActivityWinterPage03WidgetController_TypeDefinitionIndex)->GetStaticField(0x34280);
		}
		...
		::System::Void RefreshProgressPointView(::Class_2_54E12A858AE85617_Class_2_657518773CBED714* view, ::Class_3_AE02BC8285203464_22* task)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_54E12A858AE85617_Class_2_657518773CBED714*, ::Class_3_AE02BC8285203464_22*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYWINTERPAGE03WIDGETCONTROLLER_REFRESHPROGRESSPOINTVIEW_OFFSET))(this, view, task);
		}
