...
#define MOLEMOLE_UIFORGEUPDETAILITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCABC9A0)
#define MOLEMOLE_UIFORGEUPDETAILITEMWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xCABCAF0)
#define MOLEMOLE_UIFORGEUPDETAILITEMWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCABCA40)
#define MOLEMOLE_UIFORGEUPDETAILITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCABCB90)
#define MOLEMOLE_UIFORGEUPDETAILITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCABCC70)
#define MOLEMOLE_UIFORGEUPDETAILITEMWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0xCABCDA0)
#define MOLEMOLE_UIFORGEUPDETAILITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCABD190)
#define MOLEMOLE_UIFORGEUPDETAILITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCABD1C0)
#define MOLEMOLE_UIFORGEUPDETAILITEMWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xCABD230)
#define MOLEMOLE_UIFORGEUPDETAILITEMWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCABD290)
#define MOLEMOLE_UIFORGEUPDETAILITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCABD300)
#define MOLEMOLE_UIFORGEUPDETAILITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCABD380)

namespace MoleMole
{
	inline static constexpr unsigned int UIForgeUPDetailItemWidgetController_TypeDefinitionIndex = 56288;

	class UIForgeUPDetailItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_193* _view; // 0x2A0
