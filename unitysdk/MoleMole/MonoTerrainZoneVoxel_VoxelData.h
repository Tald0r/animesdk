...
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_GET_BASEMATTYPE_OFFSET UNITYSDK_OFFSET(0x8C898F0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_GET_COVERMATTYPE_OFFSET UNITYSDK_OFFSET(0x8C89A00)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_METHOD_1_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0x8C89B70)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_METHOD_1_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0x8C89EF0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA_METHOD_1_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x8C89C10)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_VOXELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8C89B10)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTerrainZoneVoxel_VoxelData_TypeDefinitionIndex = 40527;
