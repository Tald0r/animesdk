...
#define MOLEMOLE_UIJOURNEYTREELAYOUT_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x9E6B870)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x9E6B8F0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETCHILDPOS_OFFSET UNITYSDK_OFFSET(0x9E6BE40)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETCHILDSITEBYPOSX_OFFSET UNITYSDK_OFFSET(0x9E6C130)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETHORIZONMINMAX_OFFSET UNITYSDK_OFFSET(0x9E6C000)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETLASTCELLMINMAX_OFFSET UNITYSDK_OFFSET(0x9E6BF80)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETCHILDPOS_OFFSET UNITYSDK_OFFSET(0x9E6BA20)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x9E6B960)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x9E6BB60)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETLISTMAXSIZE_OFFSET UNITYSDK_OFFSET(0x9E6BBC0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x9E6C1E0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT___BASE_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x9E6C250)

namespace MoleMole
{
	inline static constexpr unsigned int UIJourneyTreeLayout_TypeDefinitionIndex = 58652;
