...
#define MOLEMOLE_UIJOURNEYTREELAYOUT_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x98418B0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x9841930)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETCHILDPOS_OFFSET UNITYSDK_OFFSET(0x9841E80)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETCHILDSITEBYPOSX_OFFSET UNITYSDK_OFFSET(0x9842170)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETHORIZONMINMAX_OFFSET UNITYSDK_OFFSET(0x9842040)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_GETLASTCELLMINMAX_OFFSET UNITYSDK_OFFSET(0x9841FC0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETCHILDPOS_OFFSET UNITYSDK_OFFSET(0x9841A60)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x98419A0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x9841BA0)
#define MOLEMOLE_UIJOURNEYTREELAYOUT_SETLISTMAXSIZE_OFFSET UNITYSDK_OFFSET(0x9841C00)
#define MOLEMOLE_UIJOURNEYTREELAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x9842220)
#define MOLEMOLE_UIJOURNEYTREELAYOUT___BASE_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x9842290)

namespace MoleMole
{
	inline static constexpr unsigned int UIJourneyTreeLayout_TypeDefinitionIndex = 60130;
