...
#define MOLEMOLE_UIHADALZONE_LAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xBFC4560)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_LayerConfig_TypeDefinitionIndex = 54484;
