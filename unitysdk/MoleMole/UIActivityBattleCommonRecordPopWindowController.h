...
class Class_2_39A589ABA157FE19;
...
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER_GETMEDALRANKICON_OFFSET UNITYSDK_OFFSET(0xC2524C0)
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC251470)
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xC251A30)
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC251480)
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC251660)
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC2516F0)
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER_REFRESHRECORDDATA_OFFSET UNITYSDK_OFFSET(0xC251AA0)
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER_REFRESHRECORDINFOLIST_OFFSET UNITYSDK_OFFSET(0xC251FF0)
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER_REFRESHRECORDINFO_OFFSET UNITYSDK_OFFSET(0xC2521D0)
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0xC251870)
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC252600)
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC252610)
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC252680)
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC252690)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityBattleCommonRecordPopWindowController_TypeDefinitionIndex = 50112;

	class UIActivityBattleCommonRecordPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_39A589ABA157FE19* _view; // 0x2F8
		::MoleMole::UIActivityBattleCommonRecordPopWindowController_Context* _context; // 0x300
		...
		::Foundation::AssetPath GetMedalRankIcon(::Class_4_D06919D0930604DE_Enum_3_ABEED6B2F204867D medalRank)
		{
			return ((::Foundation::AssetPath(*)(::PVOID, ::Class_4_D06919D0930604DE_Enum_3_ABEED6B2F204867D))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER_GETMEDALRANKICON_OFFSET))(this, medalRank);
		}
