...
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x50F280)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x50F1F0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x50F290)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0xE454DA0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xE454FF0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xE455100)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x2CA8F0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x50F310)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x50F380)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_Input_MobileButtonPositionInfo_TypeDefinitionIndex = 46462;
