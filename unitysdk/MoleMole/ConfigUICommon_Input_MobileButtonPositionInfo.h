...
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x471F60)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x471ED0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x471F70)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0xD7DB980)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xD7DBBD0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xD7DBCE0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x37EE40)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x471FF0)
#define MOLEMOLE_CONFIGUICOMMON_INPUT_MOBILEBUTTONPOSITIONINFO___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x472060)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_Input_MobileButtonPositionInfo_TypeDefinitionIndex = 63107;
