...
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0x8069790)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8069780)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x80697A0)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_ONINITMINIWORLD_OFFSET UNITYSDK_OFFSET(0x8069940)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x80699B0)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x80698B0)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8069840)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8069B90)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8069BA0)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x8069C10)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8069C40)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8069C50)

namespace MoleMole
{
	inline static constexpr unsigned int UICompanionGamePageController_TypeDefinitionIndex = 72039;

	class UICompanionGamePageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_133* _view; // 0x2F8
		::MoleMole::MiniGame::CompanionMiniGameWorld* miniWorld; // 0x300
		...
		{
			return ((::Enum_3_F4705266FB2007C7(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET))(this);
		}
