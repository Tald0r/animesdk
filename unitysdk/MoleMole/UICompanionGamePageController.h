...
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0xAC47310)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAC47300)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC47320)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_ONINITMINIWORLD_OFFSET UNITYSDK_OFFSET(0xAC474C0)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAC47530)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC47430)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC473C0)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC47710)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC47720)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAC47790)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC477C0)
#define MOLEMOLE_UICOMPANIONGAMEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC477D0)

namespace MoleMole
{
	inline static constexpr unsigned int UICompanionGamePageController_TypeDefinitionIndex = 72737;

	class UICompanionGamePageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_94* _view; // 0x2F8
