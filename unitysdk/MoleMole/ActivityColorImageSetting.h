...
#define MOLEMOLE_ACTIVITYCOLORIMAGESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xCAC28A0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityColorImageSetting_TypeDefinitionIndex = 59844;
