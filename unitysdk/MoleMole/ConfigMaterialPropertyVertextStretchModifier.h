...
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER_DOAFTERONENTER_OFFSET UNITYSDK_OFFSET(0xEC4C6D0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER_DOONENTER_OFFSET UNITYSDK_OFFSET(0xEC4C620)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER_DOWARMUP_OFFSET UNITYSDK_OFFSET(0xEC4EBB0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER_PREPAREONENTER_OFFSET UNITYSDK_OFFSET(0xEC4C470)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER_PREPAREONEXIT_OFFSET UNITYSDK_OFFSET(0xEC4C880)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER_PROCESSENTER_OFFSET UNITYSDK_OFFSET(0xEC4C790)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER_PROCESSEXIT_OFFSET UNITYSDK_OFFSET(0xEC4C920)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER_PROCESSKEEP_OFFSET UNITYSDK_OFFSET(0xEC4DB50)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER_SYNCENABLES_OFFSET UNITYSDK_OFFSET(0xEC4D290)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER_SYNCVALUES_OFFSET UNITYSDK_OFFSET(0xEC4CAA0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0xEC4ECD0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER___BASE_DOAFTERONENTER_OFFSET UNITYSDK_OFFSET(0xEC4ECE0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER___BASE_DOONENTER_OFFSET UNITYSDK_OFFSET(0xEC4ECF0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER___BASE_DOWARMUP_OFFSET UNITYSDK_OFFSET(0xEC4ED00)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER___BASE_PREPAREONENTER_OFFSET UNITYSDK_OFFSET(0xEC4ED60)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER___BASE_PREPAREONEXIT_OFFSET UNITYSDK_OFFSET(0xEC4EDC0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER___BASE_PROCESSENTER_OFFSET UNITYSDK_OFFSET(0xEC4EE30)
#define MOLEMOLE_CONFIGMATERIALPROPERTYVERTEXTSTRETCHMODIFIER___BASE_PROCESSEXIT_OFFSET UNITYSDK_OFFSET(0xEC4EEE0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigMaterialPropertyVertextStretchModifier_TypeDefinitionIndex = 64775;
	...
	public:
		...
		::MoleMole::MaterialPropertyModifierValueFloat _MatCapColorBurstFx; // 0x78
		...
		::MoleMole::MaterialPropertyModifierValueFloat _NormalThreshold; // 0xC8
		::MoleMole::MaterialPropertyModifierValueFloat _StretchDistance; // 0xD0
		::MoleMole::MaterialPropertyModifierValueFloat _MatCapAlphaBurstFx; // 0xD8
		::MoleMole::MaterialPropertyModifierValueFloat _MatCapNormalUSpeedFx; // 0xE0
		::MoleMole::MaterialPropertyModifierValueVector _StretchVector; // 0xE8
