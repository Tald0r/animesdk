...
#define MOLEMOLE_UIMAINCITYSIDEBARITEMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6CCF1F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySidebarItemContext_TypeDefinitionIndex = 64444;
