...
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0xC00D8C0)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0xC00D9F0)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC00D850)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_ICONTYPE_OFFSET UNITYSDK_OFFSET(0xC00D890)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_REDDOTINFO_OFFSET UNITYSDK_OFFSET(0xC00D8A0)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xC00D790)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_SET_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0xC00DA00)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_SET_REDDOTINFO_OFFSET UNITYSDK_OFFSET(0xC00D8B0)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM_SHOWTAB_OFFSET UNITYSDK_OFFSET(0xC00DA10)
#define MOLEMOLE_UIHANDBOOKPRIMERWIDGETCONTROLLER_TABITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC00DF00)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookPrimerWidgetController_TabItem_TypeDefinitionIndex = 40338;
	...
	public:
		...
		::Class_2_208CC9941471731A_187* entryTemplate; // 0x18
		::MoleMole::UIBaseController* _controller; // 0x20
		::System::Boolean _isFirstShow; // 0x28
		::System::ValueTuple_2<::Share::ENotificationBadgeType, ::System::UInt32> _RedDotInfo_k__BackingField; // 0x2C
