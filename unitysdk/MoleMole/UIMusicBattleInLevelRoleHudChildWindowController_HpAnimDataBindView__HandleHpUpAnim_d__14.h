...
#define MOLEMOLE_UIMUSICBATTLEINLEVELROLEHUDCHILDWINDOWCONTROLLER_HPANIMDATABINDVIEW__HANDLEHPUPANIM_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3B68F0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELROLEHUDCHILDWINDOWCONTROLLER_HPANIMDATABINDVIEW__HANDLEHPUPANIM_D__14_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelRoleHudChildWindowController_HpAnimDataBindView__HandleHpUpAnim_d__14_TypeDefinitionIndex = 71549;

	struct alignas(8) UIMusicBattleInLevelRoleHudChildWindowController_HpAnimDataBindView__HandleHpUpAnim_d__14
	{
		::MoleMole::UIMusicBattleInLevelRoleHudChildWindowController_HpAnimDataBindView* __4__this; // 0x10
