...
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x911C330)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x911C3D0)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x911C0A0)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x911C280)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_REFRESHVIEW_1_OFFSET UNITYSDK_OFFSET(0x911C540)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x911C4B0)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER_SETQUESTFIRSTREWARD_OFFSET UNITYSDK_OFFSET(0x911CAC0)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x911CD50)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x911CDF0)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x911CE10)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x911CE80)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x911CF00)
#define MOLEMOLE_UIGENERALBOTTOMREWARDINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x911CF60)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralBottomRewardInfoWidgetController_TypeDefinitionIndex = 59525;
