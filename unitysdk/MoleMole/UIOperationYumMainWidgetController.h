...
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0x98EDAF0)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x98EDE50)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER_ONGOBTNCLICK_OFFSET UNITYSDK_OFFSET(0x98EEB20)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x98EDFD0)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98EDEF0)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98EDB00)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98EDDA0)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x98EE200)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER_TRYPLAYANIMATION_1_OFFSET UNITYSDK_OFFSET(0x98EF4F0)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER_TRYPLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x98EEE70)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98EFB60)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER__ONUIINIT_B__7_0_OFFSET UNITYSDK_OFFSET(0x98EFB90)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x98EFBD0)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x98EFC40)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98EFCB0)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98EFD30)
#define MOLEMOLE_UIOPERATIONYUMMAINWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98EFD90)

namespace MoleMole
{
	inline static constexpr unsigned int UIOperationYumMainWidgetController_TypeDefinitionIndex = 68048;
	...
	public:
		...
		::Class_2_208CC9941471731A_579* _config; // 0x2B0
