...
#define MOLEMOLE_SURFCAMERACONTEXT_RESET_OFFSET UNITYSDK_OFFSET(0x382020)

namespace MoleMole
{
	inline static constexpr unsigned int SurfCameraContext_TypeDefinitionIndex = 73768;
