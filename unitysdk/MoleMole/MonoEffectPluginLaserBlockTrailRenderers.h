...
#define MOLEMOLE_MONOEFFECTPLUGINLASERBLOCKTRAILRENDERERS__CTOR_OFFSET UNITYSDK_OFFSET(0x8F1D250)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginLaserBlockTrailRenderers_TypeDefinitionIndex = 41516;
