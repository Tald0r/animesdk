...
#define MOLEMOLE_MONOEFFECTPLUGINLASERBLOCKTRAILRENDERERS__CTOR_OFFSET UNITYSDK_OFFSET(0xA02ED70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginLaserBlockTrailRenderers_TypeDefinitionIndex = 67179;
