...
#define MOLEMOLE_HUDITEMBASECONTROLLER_DODESTROY_OFFSET UNITYSDK_OFFSET(0xB83CD60)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0xB83C4B0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xB83C490)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_FOLLOWPOSITION_OFFSET UNITYSDK_OFFSET(0xB83C7B0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xB83C7A0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_HEIGHTOFFSET_OFFSET UNITYSDK_OFFSET(0xB83C4A0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB83C340)
#define MOLEMOLE_HUDITEMBASECONTROLLER_GET__RECTTRANSFORMREF_OFFSET UNITYSDK_OFFSET(0xB83C350)
#define MOLEMOLE_HUDITEMBASECONTROLLER_ISINCAMERAVISIBLERANGE_OFFSET UNITYSDK_OFFSET(0xB83D040)
#define MOLEMOLE_HUDITEMBASECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB83CA00)
#define MOLEMOLE_HUDITEMBASECONTROLLER_SETDISABLE_OFFSET UNITYSDK_OFFSET(0xB83CC90)
#define MOLEMOLE_HUDITEMBASECONTROLLER_SETUNACTIVE_OFFSET UNITYSDK_OFFSET(0xB83CBC0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xB83CA70)
#define MOLEMOLE_HUDITEMBASECONTROLLER_SET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xB83C610)
#define MOLEMOLE_HUDITEMBASECONTROLLER_UPDATEHUDPOSITION_OFFSET UNITYSDK_OFFSET(0xB83CDD0)
#define MOLEMOLE_HUDITEMBASECONTROLLER_UPDATEHUD_OFFSET UNITYSDK_OFFSET(0xB83CE60)
#define MOLEMOLE_HUDITEMBASECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xB83D370)
#define MOLEMOLE_HUDITEMBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB83D360)
#define MOLEMOLE_HUDITEMBASECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB83D3B0)

namespace MoleMole
{
	inline static constexpr unsigned int HudItemBaseController_TypeDefinitionIndex = 38356;
	...
	public:
		...
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(HudItemBaseController_TypeDefinitionIndex)->GetStaticField(0x10FC0);
		}
		::UnityEngine::RectTransform* _rectTrans; // 0x2F8
		::System::Single _offset; // 0x300
		::UnityEngine::GameObject* _followTarget; // 0x308
		::System::UInt32 _entityID; // 0x310
		::UnityEngine::Transform* _followSpine; // 0x318
		::Class_3_F35B080B137ECC46* modelComponent; // 0x320
		::Class_3_F97B015544BE936B* dataComponent; // 0x328
		::Class_3_7472FB6CC4015359* hudComponent; // 0x330
		::Class_3_F41D242A20F8FE06* abilityComponent; // 0x338
		::System::Boolean _enable; // 0x340
		::System::String* spineName; // 0x348
