...
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER__UPDATEMAPANDPROPS_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x38C0B0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER__UPDATEMAPANDPROPS_D__14_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapRefreshPageController__UpdateMapAndProps_d__14_TypeDefinitionIndex = 67301;
	...
	struct alignas(8) UIAbyssS2MapRefreshPageController__UpdateMapAndProps_d__14
	{
		...
		::MoleMole::UIAbyssS2MapRefreshPageController* __4__this; // 0x38
