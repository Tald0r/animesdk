...
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER__UPDATEMAPANDPROPS_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x380F60)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER__UPDATEMAPANDPROPS_D__14_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapRefreshPageController__UpdateMapAndProps_d__14_TypeDefinitionIndex = 65196;
