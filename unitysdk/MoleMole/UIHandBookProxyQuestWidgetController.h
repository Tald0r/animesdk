...
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDFD0D40)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER_ONGET_OFFSET UNITYSDK_OFFSET(0xDFD2730)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER_ONLEVELREWARDCLAIMED_OFFSET UNITYSDK_OFFSET(0xDFD2980)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER_ONMISSIONMODIFY_OFFSET UNITYSDK_OFFSET(0xDFD2660)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDFD0B70)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDFD1190)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDFD08F0)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDFD0A20)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER_REFRESHPROXYLEVEL_OFFSET UNITYSDK_OFFSET(0xDFD14F0)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER_REFRESHPROXYQUEST_OFFSET UNITYSDK_OFFSET(0xDFD1A00)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER_REFRESHQUESTDATA_OFFSET UNITYSDK_OFFSET(0xDFD1270)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0xDFD1BF0)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xDFD0CC0)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDFD2A90)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER__ONGET_B__12_0_OFFSET UNITYSDK_OFFSET(0xDFD2AC0)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDFD2AD0)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDFD2B40)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDFD2BB0)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDFD2C30)
#define MOLEMOLE_UIHANDBOOKPROXYQUESTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDFD2C90)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookProxyQuestWidgetController_TypeDefinitionIndex = 67379;

	class UIHandBookProxyQuestWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_06EAD40543027897* _view; // 0x2A0
