...
#define MOLEMOLE_URBANNEWMAPKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x64478D0)
#define MOLEMOLE_URBANNEWMAPKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x64478E0)
#define MOLEMOLE_URBANNEWMAPKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x64478F0)

namespace MoleMole
{
	inline static constexpr unsigned int UrbanNewMapKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 41697;
