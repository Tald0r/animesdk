...
#define MOLEMOLE_VEHICLESPLINEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0xF0C7760)

namespace MoleMole
{
	inline static constexpr unsigned int VehicleSplinePath_TypeDefinitionIndex = 67143;
