...
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA6DF70)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA6DFE0)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA6E0A0)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA6E410)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0xCA6E440)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA6EB50)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA6EBC0)

namespace MoleMole
{
	inline static constexpr unsigned int UISimpleParkourNodeWidgetController_TypeDefinitionIndex = 60730;

	class UISimpleParkourNodeWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_1_48D56DACBE4271BC* _syncHelper; // 0x2A0
		::Class_3_2CBAA1B7A86535B9* _model; // 0x2A8
		::UnityEngine::CanvasGroup* _canvasGroup; // 0x2B0
		...
		{
			return ((::Class_2_EC28E1D3A39EE7DE_16*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
