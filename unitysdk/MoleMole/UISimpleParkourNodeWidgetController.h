...
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x78F3670)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x78F36E0)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x78F37A0)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x78F3B10)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x78F3B40)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x78F4250)
#define MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x78F42C0)

namespace MoleMole
{
	inline static constexpr unsigned int UISimpleParkourNodeWidgetController_TypeDefinitionIndex = 39386;
	...
	public:
		...
		{
			return ((::Class_2_EC28E1D3A39EE7DE_2*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISIMPLEPARKOURNODEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
