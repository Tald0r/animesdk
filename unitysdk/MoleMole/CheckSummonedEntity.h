...
#define MOLEMOLE_CHECKSUMMONEDENTITY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x848FC90)
#define MOLEMOLE_CHECKSUMMONEDENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x848FEC0)
#define MOLEMOLE_CHECKSUMMONEDENTITY___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x848FF00)

namespace MoleMole
{
	inline static constexpr unsigned int CheckSummonedEntity_TypeDefinitionIndex = 49047;
