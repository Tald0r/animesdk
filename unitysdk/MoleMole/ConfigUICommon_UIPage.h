...
#define MOLEMOLE_CONFIGUICOMMON_UIPAGE_INITINTERKNOTPOSTHEIGHT_OFFSET UNITYSDK_OFFSET(0xE0D50D0)
#define MOLEMOLE_CONFIGUICOMMON_UIPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xE0D5670)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_UIPage_TypeDefinitionIndex = 61473;
