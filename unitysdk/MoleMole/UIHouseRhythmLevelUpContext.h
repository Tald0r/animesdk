...
#define MOLEMOLE_UIHOUSERHYTHMLEVELUPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7450200)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmLevelUpContext_TypeDefinitionIndex = 75675;
