...
#define MOLEMOLE_UIHOUSERHYTHMLEVELUPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x80B3E70)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmLevelUpContext_TypeDefinitionIndex = 72517;
