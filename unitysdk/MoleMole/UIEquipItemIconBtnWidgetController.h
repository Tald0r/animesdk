...
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER_GETISMATERIAL_OFFSET UNITYSDK_OFFSET(0xD534560)
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0xD534190)
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD5341A0)
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD5345D0)
#define MOLEMOLE_UIEQUIPITEMICONBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD5345F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipItemIconBtnWidgetController_TypeDefinitionIndex = 41674;
