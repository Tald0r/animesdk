...
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C540C0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x8C545E0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONGET_OFFSET UNITYSDK_OFFSET(0x8C56040)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONLEVELREWARDCLAIMED_OFFSET UNITYSDK_OFFSET(0x8C56290)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONMISSIONMODIFY_OFFSET UNITYSDK_OFFSET(0x8C55F70)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8C53EF0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C54500)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C53C70)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C53DA0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_REFRESHPROXYLEVEL_OFFSET UNITYSDK_OFFSET(0x8C54BB0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_REFRESHPROXYQUEST_OFFSET UNITYSDK_OFFSET(0x8C55460)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_REFRESHQUESTDATA_OFFSET UNITYSDK_OFFSET(0x8C54930)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x8C55650)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8C54040)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C563A0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER__ONGET_B__13_0_OFFSET UNITYSDK_OFFSET(0x8C563D0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C563E0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x8C56450)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8C564C0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C56530)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C565B0)
#define MOLEMOLE_UIHANDBOOKROPEMAKERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C56610)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookRopeMakerWidgetController_TypeDefinitionIndex = 55610;

	class UIHandBookRopeMakerWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_148* _view; // 0x2A0
