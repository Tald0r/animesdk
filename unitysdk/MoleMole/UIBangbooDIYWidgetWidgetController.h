...
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_CLEARBAGITEMSELECT_OFFSET UNITYSDK_OFFSET(0xA325FA0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_CLEAREDITORSTATECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA3253E0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_CLEARPACKAGEENABLE_OFFSET UNITYSDK_OFFSET(0xA3286C0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_CREATECOMPONENTWIDGET_OFFSET UNITYSDK_OFFSET(0xA326910)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ENABLEMASKSELECT_OFFSET UNITYSDK_OFFSET(0xA326100)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ENABLESELECTWIDGET_OFFSET UNITYSDK_OFFSET(0xA324770)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_FORCEFOUCSSELECTITEM_OFFSET UNITYSDK_OFFSET(0xA3294E0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_FORCEFOUCSSELELCTBAG_OFFSET UNITYSDK_OFFSET(0xA329220)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_GETBAGFIRSTCOMPONENT_OFFSET UNITYSDK_OFFSET(0xA322D20)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_GETCOMPONENTWIDGET_OFFSET UNITYSDK_OFFSET(0xA322C30)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_GETFILTEINDEX_OFFSET UNITYSDK_OFFSET(0xA327FF0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_GETGAMEPADSELECT_OFFSET UNITYSDK_OFFSET(0xA329060)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_GETTOUCHCOMPONENT_OFFSET UNITYSDK_OFFSET(0xA328A40)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_GET_DIYCOMPONENTWIDGETCONTROLLERS_OFFSET UNITYSDK_OFFSET(0xA3299D0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_INITBAGCOMPONENT_OFFSET UNITYSDK_OFFSET(0xA322DB0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_INITCURRENTPAGEINSTALLCOMPONENT_OFFSET UNITYSDK_OFFSET(0xA323330)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_INITGRIDS_OFFSET UNITYSDK_OFFSET(0xA3221A0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xA321C80)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ISBAGSCROLLDRAGING_OFFSET UNITYSDK_OFFSET(0xA329190)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA325260)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONBAGCOMPONENTUPDATE_OFFSET UNITYSDK_OFFSET(0xA321B80)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONBAGITEMSELECT_OFFSET UNITYSDK_OFFSET(0xA325F30)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONBUDDYCOMPONENTDELETE_OFFSET UNITYSDK_OFFSET(0xA326A40)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONBUDDYCOMPONENTINSTALLFROMBAG_OFFSET UNITYSDK_OFFSET(0xA3263A0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONBUDDYEDITOR_OFFSET UNITYSDK_OFFSET(0xA324BC0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONBUDDYSWITCHPACKAGESCRSP_OFFSET UNITYSDK_OFFSET(0xA328800)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONCLICKCURRENTPACAKGEENABLE_OFFSET UNITYSDK_OFFSET(0xA3281C0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONCLICKINSTALLBTN_OFFSET UNITYSDK_OFFSET(0xA3255B0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONCLICKRIGHTMASK_OFFSET UNITYSDK_OFFSET(0xA3248C0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONCOMPONENTEDITOR_OFFSET UNITYSDK_OFFSET(0xA326010)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA3241E0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONDELETEBTN_OFFSET UNITYSDK_OFFSET(0xA327250)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONDRAGEND_OFFSET UNITYSDK_OFFSET(0xA328EA0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONDRAGITEM_OFFSET UNITYSDK_OFFSET(0xA3283B0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONDRAGSTART_OFFSET UNITYSDK_OFFSET(0xA328E00)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONFILTERDROPCHANGE_OFFSET UNITYSDK_OFFSET(0xA3250E0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA329830)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xA329950)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA323BD0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA3290D0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONINPUTNAME_OFFSET UNITYSDK_OFFSET(0xA327100)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONLONGPRESSBAGITEM_OFFSET UNITYSDK_OFFSET(0xA328F40)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONOPENCOMPONENTSHOP_OFFSET UNITYSDK_OFFSET(0xA327670)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONPACKAGECLEAR_OFFSET UNITYSDK_OFFSET(0xA328490)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONPACKAGEENABLE_OFFSET UNITYSDK_OFFSET(0xA327440)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONRENAMEBTN_OFFSET UNITYSDK_OFFSET(0xA326D70)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONRENAME_OFFSET UNITYSDK_OFFSET(0xA328420)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONSELECTITEMTOEDITOR_OFFSET UNITYSDK_OFFSET(0xA325880)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONSERVERCONFRIMCOMPONENTINSTALL_OFFSET UNITYSDK_OFFSET(0xA326320)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONTEMPLATEDROPCHANGE_OFFSET UNITYSDK_OFFSET(0xA3280B0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONTVTOUCHCLICKDOWN_OFFSET UNITYSDK_OFFSET(0xA328970)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONTVTOUCHCLICKUP_OFFSET UNITYSDK_OFFSET(0xA328D20)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONTVTOUCHDRAG_OFFSET UNITYSDK_OFFSET(0xA328870)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA324480)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA320820)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_ONUNINSTALLCOMPONENT_OFFSET UNITYSDK_OFFSET(0xA3285F0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0xA322090)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_SETSELECTCOMPONENTATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xA323D00)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_SETTVTARGET_OFFSET UNITYSDK_OFFSET(0xA3235D0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_SHOWFILTERDROPDOWN_OFFSET UNITYSDK_OFFSET(0xA327C00)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_SHOWTEMPLATEDROPDOWN_OFFSET UNITYSDK_OFFSET(0xA327880)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_UPDATECURRENTBAGM_OFFSET UNITYSDK_OFFSET(0xA328660)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_UPDATEPAKAGETEMPLATEDESC_OFFSET UNITYSDK_OFFSET(0xA323990)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xA321CF0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA3262C0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3299E0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0xA329D10)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER__ONUIINIT_B__1_1_OFFSET UNITYSDK_OFFSET(0xA329DA0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA32A020)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA32A090)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xA32A100)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA32A170)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA32A1F0)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA32A220)
#define MOLEMOLE_UIBANGBOODIYWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA32A2A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooDIYWidgetWidgetController_TypeDefinitionIndex = 47664;

	class UIBangbooDIYWidgetWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		// static const ::System::Int32 ShopId = 0x2; // 0x0
		::Class_2_79AE422BA06F6D26_118* _view; // 0x2A0
