...
#define MOLEMOLE_LOCKGAMEOBJROTATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x6E9FAB0)
#define MOLEMOLE_LOCKGAMEOBJROTATION_DISABLELOCK_OFFSET UNITYSDK_OFFSET(0x6E9FD60)
#define MOLEMOLE_LOCKGAMEOBJROTATION_ENBALELOCK_OFFSET UNITYSDK_OFFSET(0x6E9FC50)
#define MOLEMOLE_LOCKGAMEOBJROTATION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x6E9FB50)
#define MOLEMOLE_LOCKGAMEOBJROTATION_RESET_OFFSET UNITYSDK_OFFSET(0x6E9FDD0)
#define MOLEMOLE_LOCKGAMEOBJROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x6E9FED0)

namespace MoleMole
{
	inline static constexpr unsigned int LockGameObjRotation_TypeDefinitionIndex = 70719;
