...
#define MOLEMOLE_LOCKGAMEOBJROTATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x6E334D0)
#define MOLEMOLE_LOCKGAMEOBJROTATION_DISABLELOCK_OFFSET UNITYSDK_OFFSET(0x6E33780)
#define MOLEMOLE_LOCKGAMEOBJROTATION_ENBALELOCK_OFFSET UNITYSDK_OFFSET(0x6E33670)
#define MOLEMOLE_LOCKGAMEOBJROTATION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x6E33570)
#define MOLEMOLE_LOCKGAMEOBJROTATION_RESET_OFFSET UNITYSDK_OFFSET(0x6E337F0)
#define MOLEMOLE_LOCKGAMEOBJROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x6E338F0)

namespace MoleMole
{
	inline static constexpr unsigned int LockGameObjRotation_TypeDefinitionIndex = 45248;
