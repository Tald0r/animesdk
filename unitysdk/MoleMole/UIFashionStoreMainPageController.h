...
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CLEARALLPRODUCTNEWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0xCAB0B00)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CONVERTLISTIDXTOPAIRIDX_OFFSET UNITYSDK_OFFSET(0xCAB2980)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CONVERTPAIRIDXTOLISTIDX_OFFSET UNITYSDK_OFFSET(0xCAB1A70)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CONVERTPRODUCTLISTINTOSHIELFLIST_OFFSET UNITYSDK_OFFSET(0xCAB0CD0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xCAAFED0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xCAB0300)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONCLICKBUYBTN_OFFSET UNITYSDK_OFFSET(0xCAB20F0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONCLICKCOSTITEMBTN_OFFSET UNITYSDK_OFFSET(0xCAB1EE0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCAAFEE0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONFAILBUYINGPRODUCT_OFFSET UNITYSDK_OFFSET(0xCAB2920)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONSELECTPRODUCT_OFFSET UNITYSDK_OFFSET(0xCAB10E0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCAB0750)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONSUCCESSBUYINGPRODUCT_OFFSET UNITYSDK_OFFSET(0xCAB2710)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONTIMELINEPERFORMSTART_OFFSET UNITYSDK_OFFSET(0xCAB2A30)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCAB0A70)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCAAFF80)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCAB0220)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_SHOWFIRSTOPENPERFORM_OFFSET UNITYSDK_OFFSET(0xCAB0890)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_UPDATECOSTMATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0xCAB1B30)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCAB2C90)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0xCAB2CA0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER__SHOWFIRSTOPENPERFORM_B__21_0_OFFSET UNITYSDK_OFFSET(0xCAB2E90)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCAB3200)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCAB3270)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCAB32E0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCAB32F0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCAB3300)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreMainPageController_TypeDefinitionIndex = 42140;

	class UIFashionStoreMainPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_EE5C3D8646C28032* _view; // 0x308
		::MoleMole::UIFashionStoreSellDetailWidgetController* _detailController; // 0x310
		::Class_2_3F6C09E90314E9AB* _model; // 0x318
		::MoleMole::UIFashionStore3DModelController* _3DModelController; // 0x320
		::System::Collections::Generic::List_1<::Class_1_BD2BE7927F889C7B*>* _productList; // 0x328
		::System::Int32 _currSelectIdx; // 0x330
		::System::Boolean _isTimelinePlayed; // 0x334
