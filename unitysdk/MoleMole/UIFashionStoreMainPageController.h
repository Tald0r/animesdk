...
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CLEARALLPRODUCTNEWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0xCB36ED0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CONVERTLISTIDXTOPAIRIDX_OFFSET UNITYSDK_OFFSET(0xCB38D50)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CONVERTPAIRIDXTOLISTIDX_OFFSET UNITYSDK_OFFSET(0xCB37E40)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_CONVERTPRODUCTLISTINTOSHIELFLIST_OFFSET UNITYSDK_OFFSET(0xCB370A0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xCB36290)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xCB366C0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONCLICKBUYBTN_OFFSET UNITYSDK_OFFSET(0xCB384C0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONCLICKCOSTITEMBTN_OFFSET UNITYSDK_OFFSET(0xCB382B0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCB362A0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONFAILBUYINGPRODUCT_OFFSET UNITYSDK_OFFSET(0xCB38CF0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONSELECTPRODUCT_OFFSET UNITYSDK_OFFSET(0xCB374B0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCB36B10)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONSUCCESSBUYINGPRODUCT_OFFSET UNITYSDK_OFFSET(0xCB38AE0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONTIMELINEPERFORMSTART_OFFSET UNITYSDK_OFFSET(0xCB38E00)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCB36E40)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCB36340)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCB365E0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_SHOWFIRSTOPENPERFORM_OFFSET UNITYSDK_OFFSET(0xCB36C50)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER_UPDATECOSTMATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0xCB37F00)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCB39060)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0xCB39070)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER__SHOWFIRSTOPENPERFORM_B__21_0_OFFSET UNITYSDK_OFFSET(0xCB39260)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCB395D0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCB39640)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCB396B0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCB396C0)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCB396D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreMainPageController_TypeDefinitionIndex = 62471;
