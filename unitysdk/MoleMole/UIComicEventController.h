...
#define MOLEMOLE_UICOMICEVENTCONTROLLER_ENDPLAY_OFFSET UNITYSDK_OFFSET(0xD5518E0)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0xD551880)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_GETFADEOUTANIMTIME_OFFSET UNITYSDK_OFFSET(0xD5519A0)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0xD551220)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xD550DC0)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_ISDELAYING_OFFSET UNITYSDK_OFFSET(0xD551640)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xD551740)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xD5516C0)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD550F50)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD550D10)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0xD551820)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_PLAYFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0xD551940)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0xD551A70)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_SETACTIVE_OFFSET UNITYSDK_OFFSET(0xD5514C0)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_SETBELONGPART_OFFSET UNITYSDK_OFFSET(0xD5511B0)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_SETFINALSTATEPARAMS_OFFSET UNITYSDK_OFFSET(0xD551A00)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_SETKEY_OFFSET UNITYSDK_OFFSET(0xD551140)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_SETPARENT_OFFSET UNITYSDK_OFFSET(0xD5513B0)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_SETPREFABPARAMS_OFFSET UNITYSDK_OFFSET(0xD551010)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_STARTPLAY_OFFSET UNITYSDK_OFFSET(0xD5517C0)
#define MOLEMOLE_UICOMICEVENTCONTROLLER_UPDATETIME_OFFSET UNITYSDK_OFFSET(0xD5515D0)
#define MOLEMOLE_UICOMICEVENTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD551AE0)
#define MOLEMOLE_UICOMICEVENTCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD551B70)
#define MOLEMOLE_UICOMICEVENTCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD551B10)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicEventController_TypeDefinitionIndex = 42832;
