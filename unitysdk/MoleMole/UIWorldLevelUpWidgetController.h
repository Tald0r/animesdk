...
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7C66A40)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x7C66BC0)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_ONINTERRUPT_OFFSET UNITYSDK_OFFSET(0x7C66CE0)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7C66AE0)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7C66230)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7C66370)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x7C664A0)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7C66DA0)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER__ONFADEPLAYFINISH_B__6_0_OFFSET UNITYSDK_OFFSET(0x7C66DD0)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER__ONFADEPLAYFINISH_B__6_1_OFFSET UNITYSDK_OFFSET(0x7C66E30)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER__ONINTERRUPT_B__8_0_OFFSET UNITYSDK_OFFSET(0x7C66E50)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7C66E70)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x7C66EE0)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7C66EF0)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7C66F70)
#define MOLEMOLE_UIWORLDLEVELUPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7C66FD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorldLevelUpWidgetController_TypeDefinitionIndex = 49536;

	class UIWorldLevelUpWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_E9BF1A81C797C171* _view; // 0x2A0
		::MoleMole::UIWorldLevelUpWidgetController_Context* _context; // 0x2A8
