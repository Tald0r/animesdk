...
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ADDBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0xEA39A20)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ADDPENDINGTIP_OFFSET UNITYSDK_OFFSET(0xEA39EE0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ADDTAGGRAPHNODEDATA_OFFSET UNITYSDK_OFFSET(0xEA37FC0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_DELALLBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0xEA39E10)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_DELBLACKCURTAIN_1_OFFSET UNITYSDK_OFFSET(0xEA39CF0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_DELBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0xEA39B10)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_DOFORCEREFRESHALLGUIDEPOSTARGET_OFFSET UNITYSDK_OFFSET(0xEA3E930)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GET_ISTELEPORTING_OFFSET UNITYSDK_OFFSET(0xEA3E780)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_HIDE_GUIDEPOSTARGET_OFFSET UNITYSDK_OFFSET(0xEA3DE90)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ISCONTAINSNODEDATABYKEY_OFFSET UNITYSDK_OFFSET(0xEA37BB0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ISGUIDEPOSTARGETEXIST_OFFSET UNITYSDK_OFFSET(0xEA3E010)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_CLEARALLNAMEPANEL_OFFSET UNITYSDK_OFFSET(0xEA3BF20)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_GETVOCONFIGNAMESHOWTYPE_OFFSET UNITYSDK_OFFSET(0xEA3BA00)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_HIDEBUBBLEBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0xEA3C5C0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_HIDEICONBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0xEA3BBB0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_HIDENAMEBYENTITYID_OFFSET UNITYSDK_OFFSET(0xEA3CBC0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWBUBBLEBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0xEA3C330)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWICONBYVOCONFIGID_1_OFFSET UNITYSDK_OFFSET(0xEA3B850)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWICONBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0xEA3B5F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWNAMEBYENTITYID_OFFSET UNITYSDK_OFFSET(0xEA3C690)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWNAMEBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0xEA3B260)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xEA38430)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xEA384D0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONTELEPORTFINISH_OFFSET UNITYSDK_OFFSET(0xEA3E800)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONTELEPORTSTARTED_OFFSET UNITYSDK_OFFSET(0xEA3E7A0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xEA38570)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_QUERYTIPINFO_OFFSET UNITYSDK_OFFSET(0xEA3A050)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_REMOVEALLBLACKCURTAINBYTRANSITION_OFFSET UNITYSDK_OFFSET(0xEA39170)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_REMOVETAGGRAPHNODEDATA_OFFSET UNITYSDK_OFFSET(0xEA38320)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_SET_ISTELEPORTING_OFFSET UNITYSDK_OFFSET(0xEA3E790)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_SHOW_GUIDEPOSTARGETBYPOS_OFFSET UNITYSDK_OFFSET(0xEA3D7F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_SHOW_GUIDEPOSTARGET_OFFSET UNITYSDK_OFFSET(0xEA3DCE0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYGETGUIDEPOSTARGETROUTEINFO_OFFSET UNITYSDK_OFFSET(0xEA3E0F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYGETTAGGRAPHNODEDATA_OFFSET UNITYSDK_OFFSET(0xEA38200)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYGETUNWALKGUIDEPOSTARGETROUTEINFO_OFFSET UNITYSDK_OFFSET(0xEA3E3F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYREMOVEALLTIPINFO_OFFSET UNITYSDK_OFFSET(0xEA3A820)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYREMOVETIPINFO_OFFSET UNITYSDK_OFFSET(0xEA3A400)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYSPLIT_GUIDEPOS_OFFSET UNITYSDK_OFFSET(0xEA3D750)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_UNLOADSAVEDATASBYGROUPID_OFFSET UNITYSDK_OFFSET(0xEA37C90)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_UPDATETIPINFO_OFFSET UNITYSDK_OFFSET(0xEA3ABF0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__ATTACHRUNNINGDATA_OFFSET UNITYSDK_OFFSET(0xEA3CF40)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__CLOSEBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0xEA394B0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0xEA3EB20)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__LOGERROR_OFFSET UNITYSDK_OFFSET(0xEA3DE20)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__LOG_OFFSET UNITYSDK_OFFSET(0xEA3EAB0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__NPC_ADDDELAYQUEUE_1_OFFSET UNITYSDK_OFFSET(0xEA3CE30)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__NPC_ADDDELAYQUEUE_OFFSET UNITYSDK_OFFSET(0xEA3B4D0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPENBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0xEA39210)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATENPCENTITYICONBYENTITYID_1_OFFSET UNITYSDK_OFFSET(0xEA3BC70)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATENPCENTITYICONBYENTITYID_OFFSET UNITYSDK_OFFSET(0xEA3B770)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATENPCENTITYNAMEBYCONFIG_OFFSET UNITYSDK_OFFSET(0xEA3B400)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATENPCENTITYNAMEBYENTITY_OFFSET UNITYSDK_OFFSET(0xEA3C910)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATE_GUIDEPOSTARGET_OFFSET UNITYSDK_OFFSET(0xEA3D150)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__REFRESHBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0xEA39750)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__SETBACK_OFFSET UNITYSDK_OFFSET(0xEA3AAD0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__SHOW_GUIDEPOSTARGET_IMPL_OFFSET UNITYSDK_OFFSET(0xEA3D9A0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__TICKDELAYNPCNAMES_OFFSET UNITYSDK_OFFSET(0xEA38A50)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__TICKPENDINGTIP_OFFSET UNITYSDK_OFFSET(0xEA38630)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__TICKSPLITGUIDETARGETPOS_OFFSET UNITYSDK_OFFSET(0xEA38FF0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xEA3F0D0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xEA3F130)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xEA3F190)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___OPENBLACKCURTAIN_B__12_0_OFFSET UNITYSDK_OFFSET(0xEA3EE10)

namespace MoleMole
{
	inline static constexpr unsigned int VOPerformSubSystem_TypeDefinitionIndex = 55331;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::VOPerformSubSystem_VoTipInfo>* handledTipList; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_534AF681CC2BD5FD_233_Class_1_E94508B0188204C3*>* _targetGuideInfoMap; // 0x20
		::MoleMole::VOPerformSubSystem_CurtainSetInfo _waitPendingCurtainSet; // 0x28
		::System::Collections::Generic::List_1<::Class_1_534AF681CC2BD5FD_233_Class_1_E94508B0188204C3*>* _splitGuideInfoList; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::System::Int32>*>* _targetFocusIconMapResults; // 0x48
		::System::Collections::Generic::List_1<::MoleMole::VOPerformSubSystem_NpcNameShowInfo>* _delayNpcNameCmdList; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::MoleMole::VOPerformSubSystem_NpcNameShowInfo>* _npcCurrentNameShowType; // 0x58
		::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::VOPerformSubSystem_GraphSaveDataBase*>* _saveDatas; // 0x60
		::System::Collections::Generic::List_1<::MoleMole::VOPerformSubSystem_CurtainSetInfo>* waitBlackCurtainList; // 0x68
		::System::Int32 _tickIndex; // 0x70
		::System::Boolean _IsTeleporting_k__BackingField; // 0x74
		::System::Int32 _lazyGuideTick; // 0x78
		::System::Int32 currentTipID; // 0x7C
		...
		::System::Void TrySplit_GuidePos(::Class_1_534AF681CC2BD5FD_233_Class_1_E94508B0188204C3* runtimeData)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_534AF681CC2BD5FD_233_Class_1_E94508B0188204C3*))((::PBYTE)hIl2Cpp + MOLEMOLE_VOPERFORMSUBSYSTEM_TRYSPLIT_GUIDEPOS_OFFSET))(this, runtimeData);
		}
