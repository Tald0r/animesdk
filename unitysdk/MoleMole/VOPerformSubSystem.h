...
class Class_1_534AF681CC2BD5FD_183_Class_1_481A253ED6F79F1A;
...
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ADDBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0xF0C1F60)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ADDPENDINGTIP_OFFSET UNITYSDK_OFFSET(0xF0C2420)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ADDTAGGRAPHNODEDATA_OFFSET UNITYSDK_OFFSET(0xF0C0500)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_DELALLBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0xF0C2350)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_DELBLACKCURTAIN_1_OFFSET UNITYSDK_OFFSET(0xF0C2230)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_DELBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0xF0C2050)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_DOFORCEREFRESHALLGUIDEPOSTARGET_OFFSET UNITYSDK_OFFSET(0xF0C6E90)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GET_ISTELEPORTING_OFFSET UNITYSDK_OFFSET(0xF0C6CE0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_HIDE_GUIDEPOSTARGET_OFFSET UNITYSDK_OFFSET(0xF0C63F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ISCONTAINSNODEDATABYKEY_OFFSET UNITYSDK_OFFSET(0xF0C00F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ISGUIDEPOSTARGETEXIST_OFFSET UNITYSDK_OFFSET(0xF0C6570)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_CLEARALLNAMEPANEL_OFFSET UNITYSDK_OFFSET(0xF0C4460)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_GETVOCONFIGNAMESHOWTYPE_OFFSET UNITYSDK_OFFSET(0xF0C3F40)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_HIDEBUBBLEBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0xF0C4B00)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_HIDEICONBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0xF0C40F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_HIDENAMEBYENTITYID_OFFSET UNITYSDK_OFFSET(0xF0C5100)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWBUBBLEBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0xF0C4870)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWICONBYVOCONFIGID_1_OFFSET UNITYSDK_OFFSET(0xF0C3D90)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWICONBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0xF0C3B30)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWNAMEBYENTITYID_OFFSET UNITYSDK_OFFSET(0xF0C4BD0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_NPC_SHOWNAMEBYVOCONFIGID_OFFSET UNITYSDK_OFFSET(0xF0C37A0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xF0C0980)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xF0C0A20)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONTELEPORTFINISH_OFFSET UNITYSDK_OFFSET(0xF0C6D60)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONTELEPORTSTARTED_OFFSET UNITYSDK_OFFSET(0xF0C6D00)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xF0C0AC0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_QUERYTIPINFO_OFFSET UNITYSDK_OFFSET(0xF0C2590)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_REMOVEALLBLACKCURTAINBYTRANSITION_OFFSET UNITYSDK_OFFSET(0xF0C16C0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_REMOVETAGGRAPHNODEDATA_OFFSET UNITYSDK_OFFSET(0xF0C0870)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_SET_ISTELEPORTING_OFFSET UNITYSDK_OFFSET(0xF0C6CF0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_SHOW_GUIDEPOSTARGETBYPOS_OFFSET UNITYSDK_OFFSET(0xF0C5D50)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_SHOW_GUIDEPOSTARGET_OFFSET UNITYSDK_OFFSET(0xF0C6240)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYGETGUIDEPOSTARGETROUTEINFO_OFFSET UNITYSDK_OFFSET(0xF0C6650)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYGETTAGGRAPHNODEDATA_OFFSET UNITYSDK_OFFSET(0xF0C0740)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYGETUNWALKGUIDEPOSTARGETROUTEINFO_OFFSET UNITYSDK_OFFSET(0xF0C6950)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYREMOVEALLTIPINFO_OFFSET UNITYSDK_OFFSET(0xF0C2D60)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYREMOVETIPINFO_OFFSET UNITYSDK_OFFSET(0xF0C2940)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_TRYSPLIT_GUIDEPOS_OFFSET UNITYSDK_OFFSET(0xF0C5CB0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_UNLOADSAVEDATASBYGROUPID_OFFSET UNITYSDK_OFFSET(0xF0C01D0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_UPDATETIPINFO_OFFSET UNITYSDK_OFFSET(0xF0C3130)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__ATTACHRUNNINGDATA_OFFSET UNITYSDK_OFFSET(0xF0C5490)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__CLOSEBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0xF0C19F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0xF0C7080)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__LOGERROR_OFFSET UNITYSDK_OFFSET(0xF0C6380)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__LOG_OFFSET UNITYSDK_OFFSET(0xF0C7010)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__NPC_ADDDELAYQUEUE_1_OFFSET UNITYSDK_OFFSET(0xF0C5380)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__NPC_ADDDELAYQUEUE_OFFSET UNITYSDK_OFFSET(0xF0C3A10)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPENBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0xF0C1760)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATENPCENTITYICONBYENTITYID_1_OFFSET UNITYSDK_OFFSET(0xF0C41B0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATENPCENTITYICONBYENTITYID_OFFSET UNITYSDK_OFFSET(0xF0C3CB0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATENPCENTITYNAMEBYCONFIG_OFFSET UNITYSDK_OFFSET(0xF0C3940)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATENPCENTITYNAMEBYENTITY_OFFSET UNITYSDK_OFFSET(0xF0C4E50)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__OPERATE_GUIDEPOSTARGET_OFFSET UNITYSDK_OFFSET(0xF0C56A0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__REFRESHBLACKCURTAIN_OFFSET UNITYSDK_OFFSET(0xF0C1C90)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__SETBACK_OFFSET UNITYSDK_OFFSET(0xF0C3010)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__SHOW_GUIDEPOSTARGET_IMPL_OFFSET UNITYSDK_OFFSET(0xF0C5F00)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__TICKDELAYNPCNAMES_OFFSET UNITYSDK_OFFSET(0xF0C0FA0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__TICKPENDINGTIP_OFFSET UNITYSDK_OFFSET(0xF0C0B80)
#define MOLEMOLE_VOPERFORMSUBSYSTEM__TICKSPLITGUIDETARGETPOS_OFFSET UNITYSDK_OFFSET(0xF0C1540)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xF0C7630)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xF0C7690)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xF0C76F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM___OPENBLACKCURTAIN_B__12_0_OFFSET UNITYSDK_OFFSET(0xF0C7370)

namespace MoleMole
{
	inline static constexpr unsigned int VOPerformSubSystem_TypeDefinitionIndex = 62426;

	class VOPerformSubSystem : public ::MoleMole::GameSubsystemBaseEx_1<::MoleMole::VOPerformSubSystem*>
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::VOPerformSubSystem_VoTipInfo>* handledTipList; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_534AF681CC2BD5FD_183_Class_1_481A253ED6F79F1A*>* _targetGuideInfoMap; // 0x18
		::System::Collections::Generic::List_1<::MoleMole::VOPerformSubSystem_NpcNameShowInfo>* _delayNpcNameCmdList; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::VOPerformSubSystem_GraphSaveDataBase*>* _saveDatas; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::MoleMole::VOPerformSubSystem_NpcNameShowInfo>* _npcCurrentNameShowType; // 0x30
		::MoleMole::VOPerformSubSystem_CurtainSetInfo _waitPendingCurtainSet; // 0x38
		::System::Collections::Generic::List_1<::Class_1_534AF681CC2BD5FD_183_Class_1_481A253ED6F79F1A*>* _splitGuideInfoList; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::System::Int32>*>* _targetFocusIconMapResults; // 0x58
		::System::Collections::Generic::List_1<::MoleMole::VOPerformSubSystem_CurtainSetInfo>* waitBlackCurtainList; // 0x60
		::System::Collections::Generic::List_1<::MoleMole::VOPerformSubSystem_VoTipInfo>* pendingTipList; // 0x68
		::System::Int32 _lazyGuideTick; // 0x70
		::System::Int32 currentTipID; // 0x74
		::System::Boolean _IsTeleporting_k__BackingField; // 0x78
		::System::Int32 _tickIndex; // 0x7C
		...
		::System::Void TrySplit_GuidePos(::Class_1_534AF681CC2BD5FD_183_Class_1_481A253ED6F79F1A* runtimeData)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_534AF681CC2BD5FD_183_Class_1_481A253ED6F79F1A*))((::PBYTE)hIl2Cpp + MOLEMOLE_VOPERFORMSUBSYSTEM_TRYSPLIT_GUIDEPOS_OFFSET))(this, runtimeData);
		}
		...
		::System::Void __OpenBlackCurtain_b__12_0(::Class_1_FC3A9C07FC781527_Enum_3_6E0E8267CDDC65CF reason)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_FC3A9C07FC781527_Enum_3_6E0E8267CDDC65CF))((::PBYTE)hIl2Cpp + MOLEMOLE_VOPERFORMSUBSYSTEM___OPENBLACKCURTAIN_B__12_0_OFFSET))(this, reason);
		}
