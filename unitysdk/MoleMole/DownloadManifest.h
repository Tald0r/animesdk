...
#define MOLEMOLE_DOWNLOADMANIFEST_METHOD_1_92C46EC231D398A9_OFFSET UNITYSDK_OFFSET(0xF18C440)
#define MOLEMOLE_DOWNLOADMANIFEST_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xF18C230)
#define MOLEMOLE_DOWNLOADMANIFEST_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xF18C1D0)
#define MOLEMOLE_DOWNLOADMANIFEST__CTOR_OFFSET UNITYSDK_OFFSET(0xF18C430)

namespace MoleMole
{
	inline static constexpr unsigned int DownloadManifest_TypeDefinitionIndex = 47663;
