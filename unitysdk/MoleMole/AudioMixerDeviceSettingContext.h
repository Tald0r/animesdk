...
#define MOLEMOLE_AUDIOMIXERDEVICESETTINGCONTEXT_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xC309540)
#define MOLEMOLE_AUDIOMIXERDEVICESETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC309770)
#define MOLEMOLE_AUDIOMIXERDEVICESETTINGCONTEXT___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xC309790)

namespace MoleMole
{
	inline static constexpr unsigned int AudioMixerDeviceSettingContext_TypeDefinitionIndex = 44183;
