...
#define MOLEMOLE_AUDIOMIXERDEVICESETTINGCONTEXT_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x9B91A80)
#define MOLEMOLE_AUDIOMIXERDEVICESETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9B91CB0)
#define MOLEMOLE_AUDIOMIXERDEVICESETTINGCONTEXT___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x9B91CD0)

namespace MoleMole
{
	inline static constexpr unsigned int AudioMixerDeviceSettingContext_TypeDefinitionIndex = 56712;
