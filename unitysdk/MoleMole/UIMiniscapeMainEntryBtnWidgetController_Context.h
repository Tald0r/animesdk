...
#define MOLEMOLE_UIMINISCAPEMAINENTRYBTNWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAB73600)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeMainEntryBtnWidgetController_Context_TypeDefinitionIndex = 68357;
