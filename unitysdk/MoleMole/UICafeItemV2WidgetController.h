...
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB91FE90)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x8066040)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x80655E0)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8065500)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_SETTRANSGRAY_OFFSET UNITYSDK_OFFSET(0x8065D70)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x80661B0)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER__ONCREATEVIEW_B__2_0_OFFSET UNITYSDK_OFFSET(0x80661C0)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x80661D0)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x8066240)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x80662B0)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8066330)

namespace MoleMole
{
	inline static constexpr unsigned int UICafeItemV2WidgetController_TypeDefinitionIndex = 40139;
