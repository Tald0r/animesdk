...
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC407E0)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAC41480)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC40A30)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC40950)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER_SETTRANSGRAY_OFFSET UNITYSDK_OFFSET(0xAC411B0)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC415F0)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER__ONCREATEVIEW_B__2_0_OFFSET UNITYSDK_OFFSET(0xAC41600)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC41610)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAC41680)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC416F0)
#define MOLEMOLE_UICAFEITEMV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC41770)

namespace MoleMole
{
	inline static constexpr unsigned int UICafeItemV2WidgetController_TypeDefinitionIndex = 77134;

	class UICafeItemV2WidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_94D5884806027679_2* _view; // 0x2D0
