...
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_CREATESCORE_OFFSET UNITYSDK_OFFSET(0xB60CCD0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_GETTRICKSCORECONTROLLER_OFFSET UNITYSDK_OFFSET(0xD021240)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_GETTRICKSCOREROWCONTROLLER_OFFSET UNITYSDK_OFFSET(0xD020400)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB60B540)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_INITSIZE_OFFSET UNITYSDK_OFFSET(0xD0205F0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB60B550)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB60BC40)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB60B5F0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_OPENMONSTER_OFFSET UNITYSDK_OFFSET(0xD023140)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_REFRESHAVATARFIGHTSCORE_OFFSET UNITYSDK_OFFSET(0xD021420)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_REFRESHAVATAR_OFFSET UNITYSDK_OFFSET(0xD023C50)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_REFRESHBUDDY_OFFSET UNITYSDK_OFFSET(0xD0240E0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_REFRESHBUFF_OFFSET UNITYSDK_OFFSET(0xB60C250)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_REFRESHDURATION_OFFSET UNITYSDK_OFFSET(0xB60C500)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_REFRESHMONSTER_OFFSET UNITYSDK_OFFSET(0xD022B40)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_REFRESHRECORD_1_OFFSET UNITYSDK_OFFSET(0xD0237F0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_REFRESHRECORD_OFFSET UNITYSDK_OFFSET(0xD0233D0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_REFRESHSTATISTIC_OFFSET UNITYSDK_OFFSET(0xD021AE0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_REFRESHTRICKLEVELSCORE_OFFSET UNITYSDK_OFFSET(0xD020D80)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_REFRESHTRICKSCORE_OFFSET UNITYSDK_OFFSET(0xD01FD10)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB60BCD0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_SETFOLDSTATE_OFFSET UNITYSDK_OFFSET(0xB60BBE0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_SHOWBESTRECORD_OFFSET UNITYSDK_OFFSET(0xD023770)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_SHOWFASTRECORD_OFFSET UNITYSDK_OFFSET(0xD023B50)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_SHOWLATESTRECORD_OFFSET UNITYSDK_OFFSET(0xD023BD0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD024170)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0xD0244F0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER__ONUIINIT_B__6_1_OFFSET UNITYSDK_OFFSET(0xD0245F0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER__ONUIINIT_B__6_2_OFFSET UNITYSDK_OFFSET(0xD024670)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER__ONUIINIT_B__6_3_OFFSET UNITYSDK_OFFSET(0xD0246F0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER__ONUIINIT_B__6_4_OFFSET UNITYSDK_OFFSET(0xD024770)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER__REFRESHMONSTER_B__18_0_OFFSET UNITYSDK_OFFSET(0xD0247E0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD0247F0)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD024860)
#define MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD024870)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerRecordPageController_TypeDefinitionIndex = 68736;

	class UIBabeltowerRecordPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79AE422BA06F6D26_3* _view; // 0x2F8
		...
		::Class_3_36FF8167703D4259_1* curRecord; // 0x368
		::System::Collections::Generic::List_1<::Class_3_36FF8167703D4259_1*>* records; // 0x370
		...
		::Class_2_9C39822136DA5684* CreateScore(::Class_3_4666E61F66433B1E_1* battleRecord)
		{
			return ((::Class_2_9C39822136DA5684*(*)(::PVOID, ::Class_3_4666E61F66433B1E_1*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERRECORDPAGECONTROLLER_CREATESCORE_OFFSET))(this, battleRecord);
		}
