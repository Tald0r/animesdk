...
#define MOLEMOLE_COMICCHAPTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A437740)

namespace MoleMole
{
	inline static constexpr unsigned int ComicChapterInfo_TypeDefinitionIndex = 29096;

	class ComicChapterInfo : public ::MoleMole::ComicClipBaseInfo
	{
	public:
		::System::Collections::Generic::List_1<::UnityEngine::Timeline::ImageTrack*>* imageTracks; // 0x38
		...
		::MoleMole::ComicImgSplitScreenGroup* imgGroup; // 0x58
		::UnityEngine::Sprite* defaultSprite; // 0x60
		::System::Collections::Generic::List_1<::MoleMole::ComicClipBaseInfo*>* pauseWaitZones; // 0x68
		::System::String* pageBGMState; // 0x70
		::System::String* pageTransitionSoundKey; // 0x78
