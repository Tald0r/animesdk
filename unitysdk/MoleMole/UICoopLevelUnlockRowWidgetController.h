...
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xADC5ED0)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xADC5F40)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xADC6040)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xADC62C0)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xADC6120)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xADC6390)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xADC63A0)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xADC6410)
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xADC6490)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelUnlockRowWidgetController_TypeDefinitionIndex = 43276;
