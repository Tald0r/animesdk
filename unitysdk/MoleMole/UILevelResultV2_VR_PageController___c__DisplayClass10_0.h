...
#define MOLEMOLE_UILEVELRESULTV2_VR_PAGECONTROLLER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x68B7C50)
#define MOLEMOLE_UILEVELRESULTV2_VR_PAGECONTROLLER___C__DISPLAYCLASS10_0__REFRESHFAIRYBTNSTATE_B__15_OFFSET UNITYSDK_OFFSET(0x68B7C60)
#define MOLEMOLE_UILEVELRESULTV2_VR_PAGECONTROLLER___C__DISPLAYCLASS10_0__REFRESHFAIRYBTNSTATE_B__16_OFFSET UNITYSDK_OFFSET(0x68B7C90)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultV2_VR_PageController___c__DisplayClass10_0_TypeDefinitionIndex = 46054;
