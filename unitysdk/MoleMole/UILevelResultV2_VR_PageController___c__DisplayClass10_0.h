...
#define MOLEMOLE_UILEVELRESULTV2_VR_PAGECONTROLLER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x7FAD770)
#define MOLEMOLE_UILEVELRESULTV2_VR_PAGECONTROLLER___C__DISPLAYCLASS10_0__REFRESHFAIRYBTNSTATE_B__15_OFFSET UNITYSDK_OFFSET(0x7FAD780)
#define MOLEMOLE_UILEVELRESULTV2_VR_PAGECONTROLLER___C__DISPLAYCLASS10_0__REFRESHFAIRYBTNSTATE_B__16_OFFSET UNITYSDK_OFFSET(0x7FAD7B0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultV2_VR_PageController___c__DisplayClass10_0_TypeDefinitionIndex = 58399;
