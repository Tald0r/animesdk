...
#define MOLEMOLE_UIVIDEOSHOPSHOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xDF750C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoshopShowContext_TypeDefinitionIndex = 46914;
