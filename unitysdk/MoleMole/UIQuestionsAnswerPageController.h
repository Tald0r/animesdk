...
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_BACKTOSELECT_OFFSET UNITYSDK_OFFSET(0xA434770)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_CREATEUIQUESTIONSANSWER3D3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0xA432200)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_CREATEUIQUESTIONSANSWERWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0xA432130)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_CREATEUIQUESTIONSLISTWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0xA432060)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xA431F90)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_GET_THREEDWIDGET_OFFSET UNITYSDK_OFFSET(0xA431FB0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA431F80)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONBACKCALLBACK_OFFSET UNITYSDK_OFFSET(0xA432550)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA431FC0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xA432A40)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA433230)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA432E40)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4322B0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0xA433E50)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_SETBACKBTNACTIVE_OFFSET UNITYSDK_OFFSET(0xA4349B0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xA431E90)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_STARTGAMETASK_OFFSET UNITYSDK_OFFSET(0xA4346C0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_STARTGAME_OFFSET UNITYSDK_OFFSET(0xA4342F0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA434560)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA434A40)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_0_OFFSET UNITYSDK_OFFSET(0xA434A50)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_1_OFFSET UNITYSDK_OFFSET(0xA434AB0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_2_OFFSET UNITYSDK_OFFSET(0xA434B30)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_3_OFFSET UNITYSDK_OFFSET(0xA434B60)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_4_OFFSET UNITYSDK_OFFSET(0xA434B20)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA434B90)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xA434C00)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA434C60)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA434CD0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA434CE0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xA434CF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerPageController_TypeDefinitionIndex = 78272;
	...
	public:
		...
		::Class_2_A944C35C433158AC* _currentTask; // 0x338
