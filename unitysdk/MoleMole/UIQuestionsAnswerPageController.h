...
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_BACKTOSELECT_OFFSET UNITYSDK_OFFSET(0x946C410)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_CREATEUIQUESTIONSANSWER3D3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9469EB0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_CREATEUIQUESTIONSANSWERWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9469DE0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_CREATEUIQUESTIONSLISTWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9469D10)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x9469C40)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_GET_THREEDWIDGET_OFFSET UNITYSDK_OFFSET(0x9469C60)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9469C30)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONBACKCALLBACK_OFFSET UNITYSDK_OFFSET(0x946A200)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9469C70)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x946A6F0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x946AEE0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x946AAF0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9469F60)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0x946BB00)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_SETBACKBTNACTIVE_OFFSET UNITYSDK_OFFSET(0x946C650)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x9469B40)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_STARTGAMETASK_OFFSET UNITYSDK_OFFSET(0x946C360)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_STARTGAME_OFFSET UNITYSDK_OFFSET(0x946BFA0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x946C200)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x946C6E0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_0_OFFSET UNITYSDK_OFFSET(0x946C6F0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_1_OFFSET UNITYSDK_OFFSET(0x946C750)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_2_OFFSET UNITYSDK_OFFSET(0x946C7D0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_3_OFFSET UNITYSDK_OFFSET(0x946C800)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER__ONBACKCALLBACK_B__19_4_OFFSET UNITYSDK_OFFSET(0x946C7C0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x946C830)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x946C8A0)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x946C900)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x946C970)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x946C980)
#define MOLEMOLE_UIQUESTIONSANSWERPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x946C990)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerPageController_TypeDefinitionIndex = 56216;

	class UIQuestionsAnswerPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_0ECAB02340C0C43A* _view; // 0x308
		::MoleMole::UIQuestionsAnswerWidgetController* _gameWidget; // 0x310
		::MoleMole::UIQuestionsListWidgetController* _listWidget; // 0x318
		::MoleMole::UIQuestionsAnswer3D3DModelController* _3dWidget; // 0x320
		::UnityEngine::Rendering::Universal::VisualEnvironmentE* _environment; // 0x328
		::System::Int32 CurrentStageId; // 0x330
		::Class_2_5EA04932F3E7FC4B* _currentTask; // 0x338
