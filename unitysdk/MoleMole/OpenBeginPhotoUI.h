...
#define MOLEMOLE_OPENBEGINPHOTOUI_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0x8A88970)
#define MOLEMOLE_OPENBEGINPHOTOUI_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x8A88960)
#define MOLEMOLE_OPENBEGINPHOTOUI_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x8A889B0)
#define MOLEMOLE_OPENBEGINPHOTOUI__CTOR_OFFSET UNITYSDK_OFFSET(0x8A88980)

namespace MoleMole
{
	inline static constexpr unsigned int OpenBeginPhotoUI_TypeDefinitionIndex = 51040;
