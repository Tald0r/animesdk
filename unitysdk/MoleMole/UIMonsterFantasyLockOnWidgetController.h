...
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_GET_ISTARGETINVIEWPORT_OFFSET UNITYSDK_OFFSET(0xCFBC980)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCFBC910)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xCFBCC20)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_ISINVIEWPORT_OFFSET UNITYSDK_OFFSET(0xCFBDED0)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCFBD790)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCFBCE80)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFBD540)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_ONUNITSELECTED_OFFSET UNITYSDK_OFFSET(0xCFBEA30)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER_ONUNITTURNSTART_OFFSET UNITYSDK_OFFSET(0xCFBE740)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFBED70)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER__INITAUTODISPOSEDATABIND_B__12_0_OFFSET UNITYSDK_OFFSET(0xCFBEDA0)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER__ONCREATEVIEWMODEL_B__13_0_OFFSET UNITYSDK_OFFSET(0xCFBEFA0)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xCFBF1C0)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCFBF220)
#define MOLEMOLE_UIMONSTERFANTASYLOCKONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFBF290)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyLockOnWidgetController_TypeDefinitionIndex = 76978;
