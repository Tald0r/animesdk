...
#define MOLEMOLE_CONFIGGALGAMEEFFECTDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0xF177B00)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigGalgameEffectDictionary_TypeDefinitionIndex = 53082;
