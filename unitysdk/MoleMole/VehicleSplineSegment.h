...
#define MOLEMOLE_VEHICLESPLINESEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x71F6CB0)

namespace MoleMole
{
	inline static constexpr unsigned int VehicleSplineSegment_TypeDefinitionIndex = 51726;
