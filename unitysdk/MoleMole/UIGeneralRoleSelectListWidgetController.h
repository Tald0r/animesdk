...
class Class_2_7681E34099AFEF1E;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8919360)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x89193D0)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x8919A20)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8919490)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x89195E0)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_SETMODE_OFFSET UNITYSDK_OFFSET(0x8919840)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_SETROLEFOCUS_OFFSET UNITYSDK_OFFSET(0x8919930)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8919AE0)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8919B10)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x8919B80)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8919BE0)
#define MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8919C50)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralRoleSelectListWidgetController_TypeDefinitionIndex = 52225;
	...
	public:
		...
		::Class_2_7681E34099AFEF1E* get__viewModel()
		{
			return ((::Class_2_7681E34099AFEF1E*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALROLESELECTLISTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
