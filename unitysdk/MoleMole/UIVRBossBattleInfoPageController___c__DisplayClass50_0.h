...
#define MOLEMOLE_UIVRBOSSBATTLEINFOPAGECONTROLLER___C__DISPLAYCLASS50_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAE9A130)
#define MOLEMOLE_UIVRBOSSBATTLEINFOPAGECONTROLLER___C__DISPLAYCLASS50_0__GOSINGLEPLAYREAL_B__1_OFFSET UNITYSDK_OFFSET(0xAE9A140)
#define MOLEMOLE_UIVRBOSSBATTLEINFOPAGECONTROLLER___C__DISPLAYCLASS50_0__GOSINGLEPLAYREAL_G__CONTINUE_0_OFFSET UNITYSDK_OFFSET(0xAE9A150)

namespace MoleMole
{
	inline static constexpr unsigned int UIVRBossBattleInfoPageController___c__DisplayClass50_0_TypeDefinitionIndex = 37384;
	...
	public:
		...
		::System::Void _GoSinglePlayReal_g__Continue_0(::Enum_3_DB663931210BBC27_38 noReward)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_38))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVRBOSSBATTLEINFOPAGECONTROLLER___C__DISPLAYCLASS50_0__GOSINGLEPLAYREAL_G__CONTINUE_0_OFFSET))(this, noReward);
		}
	};
}
