...
class Class_2_69CBB7FF0BE6A673_39;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }
namespace System::Collections::Generic { template <typename T> class IEnumerator_1; }

#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREPROGRESSWIDGETCONTROLLER_ACTIVATEFEVER_OFFSET UNITYSDK_OFFSET(0xB6B4EB0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREPROGRESSWIDGETCONTROLLER_INITSCOREWIDGET_OFFSET UNITYSDK_OFFSET(0xB6B43A0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREPROGRESSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6B4770)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREPROGRESSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6B4810)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREPROGRESSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB6B42E0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREPROGRESSWIDGETCONTROLLER_UPDATEFEVERDISPLAY_OFFSET UNITYSDK_OFFSET(0xB6B4C70)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREPROGRESSWIDGETCONTROLLER_UPDATEFEVERPROGRESS_OFFSET UNITYSDK_OFFSET(0xB6B4E00)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREPROGRESSWIDGETCONTROLLER_UPDATEFILLPROGRESSINTERNAL_OFFSET UNITYSDK_OFFSET(0xB6B4980)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREPROGRESSWIDGETCONTROLLER_UPDATEFILLPROGRESS_OFFSET UNITYSDK_OFFSET(0xB6B4CE0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREPROGRESSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB6B5050)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREPROGRESSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6B5080)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREPROGRESSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6B50F0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREPROGRESSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB6B5170)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelScoreProgressWidgetController_TypeDefinitionIndex = 67847;

	class UIMusicBattleInLevelScoreProgressWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_69CBB7FF0BE6A673_39* _view; // 0x2A0
