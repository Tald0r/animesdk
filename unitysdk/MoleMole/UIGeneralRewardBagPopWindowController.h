...
#define MOLEMOLE_UIGENERALREWARDBAGPOPWINDOWCONTROLLER_CLICKTAKE_OFFSET UNITYSDK_OFFSET(0xDFC1A10)
#define MOLEMOLE_UIGENERALREWARDBAGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDFC0F50)
#define MOLEMOLE_UIGENERALREWARDBAGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDFC1340)
#define MOLEMOLE_UIGENERALREWARDBAGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDFC13E0)
#define MOLEMOLE_UIGENERALREWARDBAGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDFC0F60)
#define MOLEMOLE_UIGENERALREWARDBAGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDFC0FD0)
#define MOLEMOLE_UIGENERALREWARDBAGPOPWINDOWCONTROLLER_SETGROCERYACTIVITYREWARDS_OFFSET UNITYSDK_OFFSET(0xDFC1470)
#define MOLEMOLE_UIGENERALREWARDBAGPOPWINDOWCONTROLLER_SETGROYCERYACTIVITYSTATUS_OFFSET UNITYSDK_OFFSET(0xDFC1650)
#define MOLEMOLE_UIGENERALREWARDBAGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDFC1A90)
#define MOLEMOLE_UIGENERALREWARDBAGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDFC1AA0)
#define MOLEMOLE_UIGENERALREWARDBAGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDFC1B10)
#define MOLEMOLE_UIGENERALREWARDBAGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDFC1B20)
#define MOLEMOLE_UIGENERALREWARDBAGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDFC1B30)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralRewardBagPopWindowController_TypeDefinitionIndex = 54972;
