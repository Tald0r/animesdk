...
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER_GETISEMPTY_OFFSET UNITYSDK_OFFSET(0xA413C80)
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA412E10)
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER_ONSKINBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xA412EB0)
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA413D20)
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA412AD0)
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA412D60)
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER_REFRESHAVATAR_OFFSET UNITYSDK_OFFSET(0xA412F60)
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER_REFRESHBUDDY_OFFSET UNITYSDK_OFFSET(0xA413830)
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER_SETANISTATE_OFFSET UNITYSDK_OFFSET(0xA413BE0)
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA413EE0)
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA413F10)
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA413F80)
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA414000)
#define MOLEMOLE_UITEAMEDITICONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA414060)

namespace MoleMole
{
	inline static constexpr unsigned int UITeamEditIconWidgetController_TypeDefinitionIndex = 72609;
