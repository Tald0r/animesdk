...
#define MOLEMOLE_UIGENERALFRIENDINVITEGAMEPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9123360)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralFriendInviteGamePopWindowController_Context_TypeDefinitionIndex = 45156;
