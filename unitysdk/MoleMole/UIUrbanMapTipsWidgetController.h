...
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9913970)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9913AD0)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x99142B0)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9913BE0)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x99139E0)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER_ONURBANMAPENABLEUPDATE_OFFSET UNITYSDK_OFFSET(0x9913F20)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER_RELEASEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9914250)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER_SETCONSOLEACTIVE_OFFSET UNITYSDK_OFFSET(0x9913FF0)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER_TRIGGERMAPBTNCLICK_OFFSET UNITYSDK_OFFSET(0x99140C0)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9914180)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x99145D0)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9914600)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9914670)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x99146A0)
#define MOLEMOLE_UIURBANMAPTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9914710)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapTipsWidgetController_TypeDefinitionIndex = 48585;
