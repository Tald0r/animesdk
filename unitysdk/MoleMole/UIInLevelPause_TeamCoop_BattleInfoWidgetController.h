...
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_GETBINDMODULES_OFFSET UNITYSDK_OFFSET(0x6895D10)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_GETNESTEDLISTDELEGATEGOLIST_OFFSET UNITYSDK_OFFSET(0x68960A0)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x6895650)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_REFRESHSCOREINFO_OFFSET UNITYSDK_OFFSET(0x6895700)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER_REFRESHTRICK_OFFSET UNITYSDK_OFFSET(0x6895BE0)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6896540)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER___BASE_GETBINDMODULES_OFFSET UNITYSDK_OFFSET(0x6896550)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER___BASE_GETNESTEDLISTDELEGATEGOLIST_OFFSET UNITYSDK_OFFSET(0x68965B0)
#define MOLEMOLE_UIINLEVELPAUSE_TEAMCOOP_BATTLEINFOWIDGETCONTROLLER___BASE_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x6896610)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPause_TeamCoop_BattleInfoWidgetController_TypeDefinitionIndex = 42686;
