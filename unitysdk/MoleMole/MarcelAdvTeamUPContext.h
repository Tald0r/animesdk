...
#define MOLEMOLE_MARCELADVTEAMUPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F9F00)

namespace MoleMole
{
	inline static constexpr unsigned int MarcelAdvTeamUPContext_TypeDefinitionIndex = 42213;
