...
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA37380)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA37420)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA37230)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA372D0)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_REFRESHITEMVIEW_OFFSET UNITYSDK_OFFSET(0xCA37500)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_REFRESHPLAYERSTATUS_OFFSET UNITYSDK_OFFSET(0xCA379E0)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA37D40)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA37D70)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA37DE0)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA37E60)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA37EC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnlinePlayerItemWidgetController_TypeDefinitionIndex = 77322;
