...
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD798830)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD7988D0)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD7986E0)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD798780)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_REFRESHITEMVIEW_OFFSET UNITYSDK_OFFSET(0xD7989B0)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER_REFRESHPLAYERSTATUS_OFFSET UNITYSDK_OFFSET(0xD798E90)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD7991F0)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD799220)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD799290)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD799310)
#define MOLEMOLE_UIONLINEPLAYERITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD799370)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnlinePlayerItemWidgetController_TypeDefinitionIndex = 56500;

	class UIOnlinePlayerItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D6BCF098B26738D7_2* _view; // 0x2A0
