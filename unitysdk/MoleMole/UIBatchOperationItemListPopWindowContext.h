...
#define MOLEMOLE_UIBATCHOPERATIONITEMLISTPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC90EC90)

namespace MoleMole
{
	inline static constexpr unsigned int UIBatchOperationItemListPopWindowContext_TypeDefinitionIndex = 42684;
