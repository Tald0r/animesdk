...
#define MOLEMOLE_SUMMEREVENTFREESHOOTABILITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xBD60940)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventFreeShootAbilityParam_TypeDefinitionIndex = 41449;
