...
#define MOLEMOLE_SUMMEREVENTFREESHOOTABILITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xB1CFAB0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventFreeShootAbilityParam_TypeDefinitionIndex = 75922;
