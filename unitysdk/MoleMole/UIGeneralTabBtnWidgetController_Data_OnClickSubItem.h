...
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x6C689F0)
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x6C68A20)
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM_INVOKE_OFFSET UNITYSDK_OFFSET(0x6C684F0)
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x6C684D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTabBtnWidgetController_Data_OnClickSubItem_TypeDefinitionIndex = 53973;
