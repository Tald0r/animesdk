...
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x8C0F970)
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x8C0F9A0)
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM_INVOKE_OFFSET UNITYSDK_OFFSET(0x8C0F470)
#define MOLEMOLE_UIGENERALTABBTNWIDGETCONTROLLER_DATA_ONCLICKSUBITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x8C0F460)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTabBtnWidgetController_Data_OnClickSubItem_TypeDefinitionIndex = 41126;
