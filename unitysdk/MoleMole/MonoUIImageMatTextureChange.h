...
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_APPLY_OFFSET UNITYSDK_OFFSET(0x9850550)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_GET_CHANGETAG_OFFSET UNITYSDK_OFFSET(0x9850540)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x9850810)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_METHOD_5_73EC6127976493E2_OFFSET UNITYSDK_OFFSET(0x9850680)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x98508C0)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9850820)
#define MOLEMOLE_MONOUIIMAGEMATTEXTURECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x9850960)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIImageMatTextureChange_TypeDefinitionIndex = 58250;
