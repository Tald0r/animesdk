...
#define MOLEMOLE_HOUSERHYTHMAVATARUNLOCKCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6E97970)

namespace MoleMole
{
	inline static constexpr unsigned int HouseRhythmAvatarUnlockContext_TypeDefinitionIndex = 80887;
