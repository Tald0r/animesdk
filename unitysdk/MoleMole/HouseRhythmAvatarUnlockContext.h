...
#define MOLEMOLE_HOUSERHYTHMAVATARUNLOCKCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6E2B430)

namespace MoleMole
{
	inline static constexpr unsigned int HouseRhythmAvatarUnlockContext_TypeDefinitionIndex = 42021;
