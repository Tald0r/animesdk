...
#define MOLEMOLE_MONOGAMEPADBASELIST_ADDITEMSELECTOPERATION_OFFSET UNITYSDK_OFFSET(0xBA26510)
#define MOLEMOLE_MONOGAMEPADBASELIST_CHANGERESETINDEXONFOCUS_OFFSET UNITYSDK_OFFSET(0xBA24460)
#define MOLEMOLE_MONOGAMEPADBASELIST_CLEARCACHESELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0xBA247F0)
#define MOLEMOLE_MONOGAMEPADBASELIST_GETINDEX_OFFSET UNITYSDK_OFFSET(0xBA263A0)
#define MOLEMOLE_MONOGAMEPADBASELIST_GET_CACHEDSELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0xBA24450)
#define MOLEMOLE_MONOGAMEPADBASELIST_GET_ISHANDLEBYNESTEDLISTDELEGATE_OFFSET UNITYSDK_OFFSET(0xBA24500)
#define MOLEMOLE_MONOGAMEPADBASELIST_GET_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xBA244F0)
#define MOLEMOLE_MONOGAMEPADBASELIST_ISALLOWLOOPBYINPUT_OFFSET UNITYSDK_OFFSET(0xBA256E0)
#define MOLEMOLE_MONOGAMEPADBASELIST_ISDRIVENBYSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xBA255C0)
#define MOLEMOLE_MONOGAMEPADBASELIST_ISLISTTAB_OFFSET UNITYSDK_OFFSET(0xBA25430)
#define MOLEMOLE_MONOGAMEPADBASELIST_ISUSESELECTEDINDEXFROMSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xBA254A0)
#define MOLEMOLE_MONOGAMEPADBASELIST_LISTISEMPTY_OFFSET UNITYSDK_OFFSET(0xBA24520)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_0DCA1F6DF2059BE8_OFFSET UNITYSDK_OFFSET(0xBA24900)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_126EC2032660D76C_OFFSET UNITYSDK_OFFSET(0xBA27320)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_1DC460290C5CAF79_OFFSET UNITYSDK_OFFSET(0xBA26D30)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_1F4AE5211F501EF3_OFFSET UNITYSDK_OFFSET(0xBA270F0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_23A91AD216EE3DAE_OFFSET UNITYSDK_OFFSET(0xBA25AC0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_26149566CA32D329_OFFSET UNITYSDK_OFFSET(0xBA27210)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xBA24C70)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_491D44226596AEA3_OFFSET UNITYSDK_OFFSET(0xBA24CE0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_49D3E821006373F3_OFFSET UNITYSDK_OFFSET(0xBA26EB0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_4AFA5C30A1F6BEFB_1_OFFSET UNITYSDK_OFFSET(0xBA27710)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_4AFA5C30A1F6BEFB_OFFSET UNITYSDK_OFFSET(0xBA26410)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_59DB8EB44B0C6988_OFFSET UNITYSDK_OFFSET(0xBA24F20)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_6A7DFCE9E3822F30_OFFSET UNITYSDK_OFFSET(0xBA253B0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_6B707ED7E427E085_OFFSET UNITYSDK_OFFSET(0xBA24DE0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_7353BFACAE10F610_OFFSET UNITYSDK_OFFSET(0xBA278B0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_8201F5F8C4C03034_OFFSET UNITYSDK_OFFSET(0xBA26DB0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_898C9A3FDCAD7F6C_1_OFFSET UNITYSDK_OFFSET(0xBA26210)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_898C9A3FDCAD7F6C_OFFSET UNITYSDK_OFFSET(0xBA26C10)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_93EFEB86D9B52A95_OFFSET UNITYSDK_OFFSET(0xBA26F70)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_AD83718567C29017_OFFSET UNITYSDK_OFFSET(0xBA251B0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xBA245F0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_C50A2293958CA940_OFFSET UNITYSDK_OFFSET(0xBA24B80)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_CBE6C06BFBD16B25_OFFSET UNITYSDK_OFFSET(0xBA26090)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_D8B63DBB24B374A4_OFFSET UNITYSDK_OFFSET(0xBA25FC0)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_E8B56723988BA453_1_OFFSET UNITYSDK_OFFSET(0xBA27810)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_E8B56723988BA453_OFFSET UNITYSDK_OFFSET(0xBA24860)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_E93BF8A8AD023FC5_OFFSET UNITYSDK_OFFSET(0xBA27500)
#define MOLEMOLE_MONOGAMEPADBASELIST_METHOD_6_F8FC8D22EEE4EB41_OFFSET UNITYSDK_OFFSET(0xBA24E80)
#define MOLEMOLE_MONOGAMEPADBASELIST_MUTECACHESELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0xBA266B0)
#define MOLEMOLE_MONOGAMEPADBASELIST_RESETKEEPINDEX_OFFSET UNITYSDK_OFFSET(0xBA265C0)
#define MOLEMOLE_MONOGAMEPADBASELIST_SETALLOWLOOP_OFFSET UNITYSDK_OFFSET(0xBA24580)
#define MOLEMOLE_MONOGAMEPADBASELIST_SETCACHESELECTEDINDEXENABLED_OFFSET UNITYSDK_OFFSET(0xBA24770)
#define MOLEMOLE_MONOGAMEPADBASELIST_SETMUTESELECTAUTOCLICKITEM_OFFSET UNITYSDK_OFFSET(0xBA26330)
#define MOLEMOLE_MONOGAMEPADBASELIST_SETSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xBA26640)
#define MOLEMOLE_MONOGAMEPADBASELIST_SETSELECTEDINDEXFORUSER_OFFSET UNITYSDK_OFFSET(0xBA26170)
#define MOLEMOLE_MONOGAMEPADBASELIST_SET_ISHANDLEBYNESTEDLISTDELEGATE_OFFSET UNITYSDK_OFFSET(0xBA24510)
#define MOLEMOLE_MONOGAMEPADBASELIST_TRYCACHESELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0xBA267F0)
#define MOLEMOLE_MONOGAMEPADBASELIST_UPDATENAVEVENT_OFFSET UNITYSDK_OFFSET(0xBA26880)
#define MOLEMOLE_MONOGAMEPADBASELIST__CCTOR_OFFSET UNITYSDK_OFFSET(0xBA26A80)
#define MOLEMOLE_MONOGAMEPADBASELIST__CTOR_OFFSET UNITYSDK_OFFSET(0xBA26950)
#define MOLEMOLE_MONOGAMEPADBASELIST___BASE_GETGAMEPADSELECTABLE_OFFSET UNITYSDK_OFFSET(0xBA26AC0)
#define MOLEMOLE_MONOGAMEPADBASELIST___BASE_LOGICEVENTTONAVDIR_OFFSET UNITYSDK_OFFSET(0xBA26B30)
#define MOLEMOLE_MONOGAMEPADBASELIST___BASE_ONMODULECLEAR_OFFSET UNITYSDK_OFFSET(0xBA26BA0)
#define MOLEMOLE_MONOGAMEPADBASELIST___BASE_SETBTNFOCUSSTATE_OFFSET UNITYSDK_OFFSET(0xBA26C00)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadBaseList_TypeDefinitionIndex = 61918;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MonoGamepadBaseList_TypeDefinitionIndex)->GetStaticField(0xA5D0);
		}
		static ::System::Boolean* StaticGet_GlobalDrivenByScrollView()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MonoGamepadBaseList_TypeDefinitionIndex)->GetStaticField(0xA5D1);
		}
