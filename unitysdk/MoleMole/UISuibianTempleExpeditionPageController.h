...
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_BUILDMAP_OFFSET UNITYSDK_OFFSET(0xAAE3910)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_CANCELAREAFOCUS_OFFSET UNITYSDK_OFFSET(0xAAE66D0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_CREATETEAM_OFFSET UNITYSDK_OFFSET(0xAAE3DB0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ENABLETEAMLIST_OFFSET UNITYSDK_OFFSET(0xAAE6AF0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_FINDAREAGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xAAE4A40)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xAAE2C20)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAAE2C10)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_INITGAMEPADNAV_OFFSET UNITYSDK_OFFSET(0xAAE3F20)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_MOVETOCENTER_OFFSET UNITYSDK_OFFSET(0xAAE4C50)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONCHANGEEXPEITIONDAREA_OFFSET UNITYSDK_OFFSET(0xAAE6640)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAAE2C30)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONDISPATCHINGAREA_OFFSET UNITYSDK_OFFSET(0xAAE5D00)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONFOCUSAREA_1_OFFSET UNITYSDK_OFFSET(0xAAE5C40)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONFOCUSAREA_OFFSET UNITYSDK_OFFSET(0xAAE41D0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xAAE4980)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xAAE69C0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0xAAE48C0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xAAE5EE0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAAE35A0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONSUCCESSDISPATCHING_OFFSET UNITYSDK_OFFSET(0xAAE6460)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONTEMPLEJUMPDATASTORE_OFFSET UNITYSDK_OFFSET(0xAAE3430)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAAE46E0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAAE2CD0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_OPENINFOBTN_OFFSET UNITYSDK_OFFSET(0xAAE6ED0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_OPENINFO_OFFSET UNITYSDK_OFFSET(0xAAE5440)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_OPENTEAMPREVIEW_OFFSET UNITYSDK_OFFSET(0xAAE4F60)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xAAE70A0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_RESTOREPARAS_OFFSET UNITYSDK_OFFSET(0xAAE7110)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER_SETTEAMINFO_OFFSET UNITYSDK_OFFSET(0xAAE3C70)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xAAE7360)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAAE7210)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__ENABLETEAMLIST_B__35_0_OFFSET UNITYSDK_OFFSET(0xAAE7550)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__ONUIINIT_B__18_0_OFFSET UNITYSDK_OFFSET(0xAAE73A0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__ONUIINIT_B__18_1_OFFSET UNITYSDK_OFFSET(0xAAE74A0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__ONUIINIT_B__18_2_OFFSET UNITYSDK_OFFSET(0xAAE74B0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER__ONUIINIT_B__18_3_OFFSET UNITYSDK_OFFSET(0xAAE7540)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAAE7680)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xAAE76F0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xAAE7770)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0xAAE7860)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xAAE77E0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAAE78E0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAAE78F0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAAE7900)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleExpeditionPageController_TypeDefinitionIndex = 58227;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UISuibianTempleExpeditionPageController_TypeDefinitionIndex)->GetStaticField(0xC5F0);
		}
		// static const ::System::String* TeamListAniFadeIn; // 0x0
		// static const ::System::String* TeamListAniFadeOut; // 0x0
		::Class_2_79AE422BA06F6D26_169* _view; // 0x2F8
