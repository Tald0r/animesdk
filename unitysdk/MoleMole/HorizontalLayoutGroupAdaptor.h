...
#define MOLEMOLE_HORIZONTALLAYOUTGROUPADAPTOR_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x8F86190)
#define MOLEMOLE_HORIZONTALLAYOUTGROUPADAPTOR_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x8F861B0)
#define MOLEMOLE_HORIZONTALLAYOUTGROUPADAPTOR_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x8F86330)
#define MOLEMOLE_HORIZONTALLAYOUTGROUPADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x8F86230)

namespace MoleMole
{
	inline static constexpr unsigned int HorizontalLayoutGroupAdaptor_TypeDefinitionIndex = 74681;
