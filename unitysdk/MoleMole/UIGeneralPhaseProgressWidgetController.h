...
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_INITPROGRESSVIEW_OFFSET UNITYSDK_OFFSET(0xAD338E0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_MAINICONANIM_OFFSET UNITYSDK_OFFSET(0xAD34DB0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD33840)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD35710)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD336F0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD33790)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_PLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0xAD344D0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_PROGRESSBARANIM_OFFSET UNITYSDK_OFFSET(0xAD345B0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER_SETPROGRESSIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xAD35380)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD35820)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD35850)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD358C0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD35940)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD359A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralPhaseProgressWidgetController_TypeDefinitionIndex = 59485;

	class UIGeneralPhaseProgressWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_69CBB7FF0BE6A673_33* _view; // 0x2A0
