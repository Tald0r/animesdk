...
#define MOLEMOLE_INLEVELNORMALATTACKKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x9918E80)
#define MOLEMOLE_INLEVELNORMALATTACKKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x9918E90)
#define MOLEMOLE_INLEVELNORMALATTACKKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x9918EA0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelNormalAttackKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 56015;
