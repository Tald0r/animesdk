...
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB3F7B60)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONTABCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xB3F7A00)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB3F85E0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB3F7850)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB3F7AB0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETAVATARCOLOR_OFFSET UNITYSDK_OFFSET(0xB3F7FD0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETAVATARID_OFFSET UNITYSDK_OFFSET(0xB3F7CE0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xB3F7C00)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETTABINDEX_OFFSET UNITYSDK_OFFSET(0xB3F7C70)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETTABSTATE_OFFSET UNITYSDK_OFFSET(0xB3F82B0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB3F86C0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB3F86F0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB3F8760)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB3F87E0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB3F8840)

namespace MoleMole
{
	inline static constexpr unsigned int UIMindscapeSwitchBtnRowWidgetController_TypeDefinitionIndex = 73692;

	class UIMindscapeSwitchBtnRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_BB9188D18E53A5DA* _view; // 0x2A0
		::System::Action_1<::System::Int32>* _clickHandle; // 0x2A8
		::System::Int32 _tabIndex; // 0x2B0
		::System::Boolean isNowOpen; // 0x2B4
