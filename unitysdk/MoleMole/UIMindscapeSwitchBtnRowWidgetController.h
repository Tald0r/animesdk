...
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF43E60)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONTABCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xAF43D00)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF448E0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF43B50)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF43DB0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETAVATARCOLOR_OFFSET UNITYSDK_OFFSET(0xAF442D0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETAVATARID_OFFSET UNITYSDK_OFFSET(0xAF43FE0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xAF43F00)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETTABINDEX_OFFSET UNITYSDK_OFFSET(0xAF43F70)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER_SETTABSTATE_OFFSET UNITYSDK_OFFSET(0xAF445B0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAF449C0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF449F0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF44A60)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF44AE0)
#define MOLEMOLE_UIMINDSCAPESWITCHBTNROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF44B40)

namespace MoleMole
{
	inline static constexpr unsigned int UIMindscapeSwitchBtnRowWidgetController_TypeDefinitionIndex = 76667;
