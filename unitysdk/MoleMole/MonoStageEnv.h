...
#define MOLEMOLE_MONOSTAGEENV_AWAKE_OFFSET UNITYSDK_OFFSET(0x8F32D60)
#define MOLEMOLE_MONOSTAGEENV_BUILDSTAGEENV_OFFSET UNITYSDK_OFFSET(0x8F32E50)
#define MOLEMOLE_MONOSTAGEENV_CLEAR_OFFSET UNITYSDK_OFFSET(0x8F37780)
#define MOLEMOLE_MONOSTAGEENV_CREATEDYNAMICSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0x8F37E80)
#define MOLEMOLE_MONOSTAGEENV_CREATESPAWNPOINTMASKREGION_OFFSET UNITYSDK_OFFSET(0x8F38800)
#define MOLEMOLE_MONOSTAGEENV_FINDMARKNODEBYSHORTNAME_OFFSET UNITYSDK_OFFSET(0x8F36820)
#define MOLEMOLE_MONOSTAGEENV_GETALLCURVEMOVEOBJECTS_OFFSET UNITYSDK_OFFSET(0x8F32A80)
#define MOLEMOLE_MONOSTAGEENV_GETALLDESTRUCTIONOBJECTS_OFFSET UNITYSDK_OFFSET(0x8F32A20)
#define MOLEMOLE_MONOSTAGEENV_GETALLINTERESTPOINTS_OFFSET UNITYSDK_OFFSET(0x8F32730)
#define MOLEMOLE_MONOSTAGEENV_GETALLMAINCITYSCENEOBJECTS_OFFSET UNITYSDK_OFFSET(0x8F329C0)
#define MOLEMOLE_MONOSTAGEENV_GETALLPARTYSCENEOBJECTS_OFFSET UNITYSDK_OFFSET(0x8F32BB0)
#define MOLEMOLE_MONOSTAGEENV_GETALLSCENEFINDWAYOBJECTS_OFFSET UNITYSDK_OFFSET(0x8F32B40)
#define MOLEMOLE_MONOSTAGEENV_GETALLSCENEMOVEOBJECTS_OFFSET UNITYSDK_OFFSET(0x8F32900)
#define MOLEMOLE_MONOSTAGEENV_GETALLSCENEOBJECTS_OFFSET UNITYSDK_OFFSET(0x8F328A0)
#define MOLEMOLE_MONOSTAGEENV_GETALLSIMPLERIGIDBODYOBJECTS_OFFSET UNITYSDK_OFFSET(0x8F32AE0)
#define MOLEMOLE_MONOSTAGEENV_GETALLSTAGEDOORS_OFFSET UNITYSDK_OFFSET(0x8F367B0)
#define MOLEMOLE_MONOSTAGEENV_GETALLVEHICLEOBJECTS_OFFSET UNITYSDK_OFFSET(0x8F32960)
#define MOLEMOLE_MONOSTAGEENV_GETALLWAYPATHSNOALLOC_OFFSET UNITYSDK_OFFSET(0x8F36230)
#define MOLEMOLE_MONOSTAGEENV_GETCOLLIDEREVENTDISPATCHER_OFFSET UNITYSDK_OFFSET(0x8F35BC0)
#define MOLEMOLE_MONOSTAGEENV_GETCURVYSPLINE_OFFSET UNITYSDK_OFFSET(0x8F365C0)
#define MOLEMOLE_MONOSTAGEENV_GETDOOR_OFFSET UNITYSDK_OFFSET(0x8F366D0)
#define MOLEMOLE_MONOSTAGEENV_GETDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x8F363C0)
#define MOLEMOLE_MONOSTAGEENV_GETENTITYMODELMODIFIERBYSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0x8F37700)
#define MOLEMOLE_MONOSTAGEENV_GETRANDOMSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0x8F35D60)
#define MOLEMOLE_MONOSTAGEENV_GETSPAWNMONSTERCONFIGBYSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0x8F371F0)
#define MOLEMOLE_MONOSTAGEENV_GETSPAWNPOINTGROUPLIST_OFFSET UNITYSDK_OFFSET(0x8F36B60)
#define MOLEMOLE_MONOSTAGEENV_GETSPAWNPOINTMASKREGION_OFFSET UNITYSDK_OFFSET(0x8F38D00)
#define MOLEMOLE_MONOSTAGEENV_GETSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0x8F37810)
#define MOLEMOLE_MONOSTAGEENV_GETVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x8F32790)
#define MOLEMOLE_MONOSTAGEENV_GETWAYENTITYLIST_OFFSET UNITYSDK_OFFSET(0x8F386E0)
#define MOLEMOLE_MONOSTAGEENV_GETWAYPATH_OFFSET UNITYSDK_OFFSET(0x8F36140)
#define MOLEMOLE_MONOSTAGEENV_GET_DYNAMICOBJECTMANAGER_OFFSET UNITYSDK_OFFSET(0x8F32700)
#define MOLEMOLE_MONOSTAGEENV_GET_EVNDESIGNGO_OFFSET UNITYSDK_OFFSET(0x8F326F0)
#define MOLEMOLE_MONOSTAGEENV_GET_MONOSTAGECAMERACONFIG_OFFSET UNITYSDK_OFFSET(0x8F32720)
#define MOLEMOLE_MONOSTAGEENV_GET_SPAWNPOINTMASKREGIONS_OFFSET UNITYSDK_OFFSET(0x8F387F0)
#define MOLEMOLE_MONOSTAGEENV_GET_SPAWNPOINTS_OFFSET UNITYSDK_OFFSET(0x8F37800)
#define MOLEMOLE_MONOSTAGEENV_GET_STAGEPREHITBOUNDS_OFFSET UNITYSDK_OFFSET(0x8F32710)
#define MOLEMOLE_MONOSTAGEENV_GET_TERRAINVOXEL_OFFSET UNITYSDK_OFFSET(0x8F1CF80)
#define MOLEMOLE_MONOSTAGEENV_GET_TERRAINZONE_OFFSET UNITYSDK_OFFSET(0x8F32C20)
#define MOLEMOLE_MONOSTAGEENV_INITSPAWNPOINTMASKREGIONS_OFFSET UNITYSDK_OFFSET(0x8F353C0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_102BA849186931FD_OFFSET UNITYSDK_OFFSET(0x8F393C0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_17B2C3617EF488DC_OFFSET UNITYSDK_OFFSET(0x8F391D0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_1C3A83F41FF8C386_OFFSET UNITYSDK_OFFSET(0x8F37960)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_1C82E9956F02E977_OFFSET UNITYSDK_OFFSET(0x8F37270)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_1FFEDE59BF3576E8_OFFSET UNITYSDK_OFFSET(0x8F37070)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_6621DB22A5F9E4F4_OFFSET UNITYSDK_OFFSET(0x8F333F0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_7C010FCBCD5D2A0B_OFFSET UNITYSDK_OFFSET(0x8F33540)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x8F39680)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_8DC652D916C182B2_OFFSET UNITYSDK_OFFSET(0x8F33970)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_8E9E3E0D1D6E6E24_OFFSET UNITYSDK_OFFSET(0x8F35810)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_9755255E23633868_OFFSET UNITYSDK_OFFSET(0x8F391C0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_A40475C44AA8CEAB_OFFSET UNITYSDK_OFFSET(0x8F33750)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0x8F35220)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_B3133298950D768C_OFFSET UNITYSDK_OFFSET(0x8F34D00)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_C9A3013DD208C696_OFFSET UNITYSDK_OFFSET(0x8F34EB0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_F04C04E6DB6D6224_OFFSET UNITYSDK_OFFSET(0x8F343F0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0x8F348E0)
#define MOLEMOLE_MONOSTAGEENV_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8F369A0)
#define MOLEMOLE_MONOSTAGEENV_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8F32DC0)
#define MOLEMOLE_MONOSTAGEENV_QUERYALLSPAWNPOINTBYPREFIX_OFFSET UNITYSDK_OFFSET(0x8F37A90)
#define MOLEMOLE_MONOSTAGEENV_REBUILDSPAWNPOINTS_OFFSET UNITYSDK_OFFSET(0x8F35A90)
#define MOLEMOLE_MONOSTAGEENV_REGISTERSPAWNPOINTENTITY_OFFSET UNITYSDK_OFFSET(0x8F38390)
#define MOLEMOLE_MONOSTAGEENV_RESETDYNAMICOBJECTLAYER_OFFSET UNITYSDK_OFFSET(0x8F36540)
#define MOLEMOLE_MONOSTAGEENV_SETDYNAMICOBJECTLAYERACTIVE_OFFSET UNITYSDK_OFFSET(0x8F364B0)
#define MOLEMOLE_MONOSTAGEENV_UPDATE_OFFSET UNITYSDK_OFFSET(0x8F368A0)
#define MOLEMOLE_MONOSTAGEENV__CCTOR_OFFSET UNITYSDK_OFFSET(0x8F39140)
#define MOLEMOLE_MONOSTAGEENV__CTOR_OFFSET UNITYSDK_OFFSET(0x8F38E10)

namespace MoleMole
{
	inline static constexpr unsigned int MonoStageEnv_TypeDefinitionIndex = 40233;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(MonoStageEnv_TypeDefinitionIndex)->GetStaticField(0x36810);
		}
		static ::MoleMole::MonoStageEnv** StaticGet_S_AdditiveStageEnv()
		{
			return (::MoleMole::MonoStageEnv**)Il2CppClass::FromTypeDefinitionIndex(MonoStageEnv_TypeDefinitionIndex)->GetStaticField(0x36818);
		}
		static ::System::Collections::Generic::List_1<::MoleMole::MonoSpawnPoint*>** StaticGet_Field_5_35()
		{
			return (::System::Collections::Generic::List_1<::MoleMole::MonoSpawnPoint*>**)Il2CppClass::FromTypeDefinitionIndex(MonoStageEnv_TypeDefinitionIndex)->GetStaticField(0x36820);
		}
		...
		::Il2CppArray<::Class_1_F22D9EE165F4F112*>* Field_5_18; // 0x98
		...
		::Class_0_16E4307DCC419505_264* GetDynamicObject(::System::String* a1)
		{
			return ((::Class_0_16E4307DCC419505_264*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_GETDYNAMICOBJECT_OFFSET))(this, a1);
		}
		...
		::Class_1_F22D9EE165F4F112* GetDoor(::System::String* a1)
		{
			return ((::Class_1_F22D9EE165F4F112*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_GETDOOR_OFFSET))(this, a1);
		}

		::Il2CppArray<::Class_1_F22D9EE165F4F112*>* GetAllStageDoors()
		{
			return ((::Il2CppArray<::Class_1_F22D9EE165F4F112*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_GETALLSTAGEDOORS_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_METHOD_5_F7300E87EC49A206_OFFSET))(this);
		}

		::System::Void Method_5_17B2C3617EF488DC(::Class_1_F22D9EE165F4F112* a1, ::MoleMole::SceneMark::DoorMark* a2)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_F22D9EE165F4F112*, ::MoleMole::SceneMark::DoorMark*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_METHOD_5_17B2C3617EF488DC_OFFSET))(this, a1, a2);
		}

		::System::Void Method_5_A40475C44AA8CEAB()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_METHOD_5_A40475C44AA8CEAB_OFFSET))(this);
		}

		::System::Void Method_5_102BA849186931FD()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_METHOD_5_102BA849186931FD_OFFSET))(this);
		}

		::System::Void Method_5_7C010FCBCD5D2A0B(::UnityEngine::GameObject* a1)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::GameObject*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_METHOD_5_7C010FCBCD5D2A0B_OFFSET))(this, a1);
		}

		::UnityEngine::Transform* Method_5_1FFEDE59BF3576E8(::System::String* a1)
		{
			return ((::UnityEngine::Transform*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_METHOD_5_1FFEDE59BF3576E8_OFFSET))(this, a1);
		}

		::System::Void Method_5_6621DB22A5F9E4F4(::Il2CppArray<::MoleMole::MonoSpawnPoint*>* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Il2CppArray<::MoleMole::MonoSpawnPoint*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_METHOD_5_6621DB22A5F9E4F4_OFFSET))(this, a1);
		}

		::System::Void Method_5_8DC652D916C182B2()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_METHOD_5_8DC652D916C182B2_OFFSET))(this);
		}

		::System::Void Method_5_8E9E3E0D1D6E6E24()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_METHOD_5_8E9E3E0D1D6E6E24_OFFSET))(this);
		}
		...
		::System::Void Method_5_B3133298950D768C(::UnityEngine::GameObject* a1)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::GameObject*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_METHOD_5_B3133298950D768C_OFFSET))(this, a1);
		}
