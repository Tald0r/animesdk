...
#define MOLEMOLE_MONOSTAGEENV_AWAKE_OFFSET UNITYSDK_OFFSET(0xA044E60)
#define MOLEMOLE_MONOSTAGEENV_BUILDSTAGEENV_OFFSET UNITYSDK_OFFSET(0xA044F50)
#define MOLEMOLE_MONOSTAGEENV_CLEAR_OFFSET UNITYSDK_OFFSET(0xA0492A0)
#define MOLEMOLE_MONOSTAGEENV_CREATEDYNAMICSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0xA049860)
#define MOLEMOLE_MONOSTAGEENV_CREATESPAWNPOINTMASKREGION_OFFSET UNITYSDK_OFFSET(0xA04A1E0)
#define MOLEMOLE_MONOSTAGEENV_FINDMARKNODEBYSHORTNAME_OFFSET UNITYSDK_OFFSET(0xA048350)
#define MOLEMOLE_MONOSTAGEENV_GETALLCURVEMOVEOBJECTS_OFFSET UNITYSDK_OFFSET(0xA044B80)
#define MOLEMOLE_MONOSTAGEENV_GETALLDESTRUCTIONOBJECTS_OFFSET UNITYSDK_OFFSET(0xA044B20)
#define MOLEMOLE_MONOSTAGEENV_GETALLINTERESTPOINTS_OFFSET UNITYSDK_OFFSET(0xA044830)
#define MOLEMOLE_MONOSTAGEENV_GETALLMAINCITYSCENEOBJECTS_OFFSET UNITYSDK_OFFSET(0xA044AC0)
#define MOLEMOLE_MONOSTAGEENV_GETALLPARTYSCENEOBJECTS_OFFSET UNITYSDK_OFFSET(0xA044CB0)
#define MOLEMOLE_MONOSTAGEENV_GETALLSCENEFINDWAYOBJECTS_OFFSET UNITYSDK_OFFSET(0xA044C40)
#define MOLEMOLE_MONOSTAGEENV_GETALLSCENEMOVEOBJECTS_OFFSET UNITYSDK_OFFSET(0xA044A00)
#define MOLEMOLE_MONOSTAGEENV_GETALLSCENEOBJECTS_OFFSET UNITYSDK_OFFSET(0xA0449A0)
#define MOLEMOLE_MONOSTAGEENV_GETALLSIMPLERIGIDBODYOBJECTS_OFFSET UNITYSDK_OFFSET(0xA044BE0)
#define MOLEMOLE_MONOSTAGEENV_GETALLSTAGEDOORS_OFFSET UNITYSDK_OFFSET(0xA0482E0)
#define MOLEMOLE_MONOSTAGEENV_GETALLVEHICLEOBJECTS_OFFSET UNITYSDK_OFFSET(0xA044A60)
#define MOLEMOLE_MONOSTAGEENV_GETALLWAYPATHSNOALLOC_OFFSET UNITYSDK_OFFSET(0xA047D60)
#define MOLEMOLE_MONOSTAGEENV_GETCOLLIDEREVENTDISPATCHER_OFFSET UNITYSDK_OFFSET(0xA0476F0)
#define MOLEMOLE_MONOSTAGEENV_GETCURVYSPLINE_OFFSET UNITYSDK_OFFSET(0xA0480F0)
#define MOLEMOLE_MONOSTAGEENV_GETDOOR_OFFSET UNITYSDK_OFFSET(0xA048200)
#define MOLEMOLE_MONOSTAGEENV_GETDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0xA047EF0)
#define MOLEMOLE_MONOSTAGEENV_GETENTITYMODELMODIFIERBYSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0xA049220)
#define MOLEMOLE_MONOSTAGEENV_GETRANDOMSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0xA047890)
#define MOLEMOLE_MONOSTAGEENV_GETSPAWNMONSTERCONFIGBYSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0xA048D10)
#define MOLEMOLE_MONOSTAGEENV_GETSPAWNPOINTGROUPLIST_OFFSET UNITYSDK_OFFSET(0xA048690)
#define MOLEMOLE_MONOSTAGEENV_GETSPAWNPOINTMASKREGION_OFFSET UNITYSDK_OFFSET(0xA04A6E0)
#define MOLEMOLE_MONOSTAGEENV_GETSPAWNPOINT_OFFSET UNITYSDK_OFFSET(0xA049330)
#define MOLEMOLE_MONOSTAGEENV_GETVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0xA044890)
#define MOLEMOLE_MONOSTAGEENV_GETWAYENTITYLIST_OFFSET UNITYSDK_OFFSET(0xA04A0C0)
#define MOLEMOLE_MONOSTAGEENV_GETWAYPATH_OFFSET UNITYSDK_OFFSET(0xA047C70)
#define MOLEMOLE_MONOSTAGEENV_GET_DYNAMICOBJECTMANAGER_OFFSET UNITYSDK_OFFSET(0xA044800)
#define MOLEMOLE_MONOSTAGEENV_GET_EVNDESIGNGO_OFFSET UNITYSDK_OFFSET(0xA0447F0)
#define MOLEMOLE_MONOSTAGEENV_GET_MONOSTAGECAMERACONFIG_OFFSET UNITYSDK_OFFSET(0xA044820)
#define MOLEMOLE_MONOSTAGEENV_GET_SPAWNPOINTMASKREGIONS_OFFSET UNITYSDK_OFFSET(0xA04A1D0)
#define MOLEMOLE_MONOSTAGEENV_GET_SPAWNPOINTS_OFFSET UNITYSDK_OFFSET(0xA049320)
#define MOLEMOLE_MONOSTAGEENV_GET_STAGEPREHITBOUNDS_OFFSET UNITYSDK_OFFSET(0xA044810)
#define MOLEMOLE_MONOSTAGEENV_GET_TERRAINVOXEL_OFFSET UNITYSDK_OFFSET(0xA02E580)
#define MOLEMOLE_MONOSTAGEENV_GET_TERRAINZONE_OFFSET UNITYSDK_OFFSET(0xA044D20)
#define MOLEMOLE_MONOSTAGEENV_INITSPAWNPOINTMASKREGIONS_OFFSET UNITYSDK_OFFSET(0xA046EF0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_102BA849186931FD_OFFSET UNITYSDK_OFFSET(0xA04ADB0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_17B2C3617EF488DC_OFFSET UNITYSDK_OFFSET(0xA04ABB0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_1C3A83F41FF8C386_OFFSET UNITYSDK_OFFSET(0x984F3F0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_1C82E9956F02E977_OFFSET UNITYSDK_OFFSET(0xA048D90)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_1FFEDE59BF3576E8_OFFSET UNITYSDK_OFFSET(0xA048B90)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_6621DB22A5F9E4F4_OFFSET UNITYSDK_OFFSET(0xA0454F0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_7C010FCBCD5D2A0B_OFFSET UNITYSDK_OFFSET(0xA045640)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0xA04ADA0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_8DC652D916C182B2_OFFSET UNITYSDK_OFFSET(0xA045A60)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_8E9E3E0D1D6E6E24_OFFSET UNITYSDK_OFFSET(0xA047340)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_9755255E23633868_OFFSET UNITYSDK_OFFSET(0xA04ABA0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_A40475C44AA8CEAB_OFFSET UNITYSDK_OFFSET(0xA045850)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0x984F250)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_B3133298950D768C_OFFSET UNITYSDK_OFFSET(0xA0469D0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_C9A3013DD208C696_OFFSET UNITYSDK_OFFSET(0xA046B80)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_F04C04E6DB6D6224_OFFSET UNITYSDK_OFFSET(0xA0464E0)
#define MOLEMOLE_MONOSTAGEENV_METHOD_5_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0x984EE30)
#define MOLEMOLE_MONOSTAGEENV_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA0484D0)
#define MOLEMOLE_MONOSTAGEENV_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA044EC0)
#define MOLEMOLE_MONOSTAGEENV_QUERYALLSPAWNPOINTBYPREFIX_OFFSET UNITYSDK_OFFSET(0xA049480)
#define MOLEMOLE_MONOSTAGEENV_REBUILDSPAWNPOINTS_OFFSET UNITYSDK_OFFSET(0xA0475C0)
#define MOLEMOLE_MONOSTAGEENV_REGISTERSPAWNPOINTENTITY_OFFSET UNITYSDK_OFFSET(0xA049D70)
#define MOLEMOLE_MONOSTAGEENV_RESETDYNAMICOBJECTLAYER_OFFSET UNITYSDK_OFFSET(0xA048070)
#define MOLEMOLE_MONOSTAGEENV_SETDYNAMICOBJECTLAYERACTIVE_OFFSET UNITYSDK_OFFSET(0xA047FE0)
#define MOLEMOLE_MONOSTAGEENV_UPDATE_OFFSET UNITYSDK_OFFSET(0xA0483D0)
#define MOLEMOLE_MONOSTAGEENV__CCTOR_OFFSET UNITYSDK_OFFSET(0xA04AB20)
#define MOLEMOLE_MONOSTAGEENV__CTOR_OFFSET UNITYSDK_OFFSET(0xA04A7F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoStageEnv_TypeDefinitionIndex = 64661;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MoleMole::MonoSpawnPoint*>**)Il2CppClass::FromTypeDefinitionIndex(MonoStageEnv_TypeDefinitionIndex)->GetStaticField(0x306C0);
		}
		static ::MoleMole::MonoStageEnv** StaticGet_S_AdditiveStageEnv()
		{
			return (::MoleMole::MonoStageEnv**)Il2CppClass::FromTypeDefinitionIndex(MonoStageEnv_TypeDefinitionIndex)->GetStaticField(0x306C8);
		}
		static ::Il2CppArray<::UnityEngine::Collider*>** StaticGet_Field_5_1()
		{
			return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(MonoStageEnv_TypeDefinitionIndex)->GetStaticField(0x306D0);
		}
		...
		::Class_0_16E4307DCC419505_183* GetDynamicObject(::System::String* a1)
		{
			return ((::Class_0_16E4307DCC419505_183*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSTAGEENV_GETDYNAMICOBJECT_OFFSET))(this, a1);
		}
