...
#define MOLEMOLE_LOOPSUBDIVISIONSETTINGENTRY_GET_PROFILETYPE_OFFSET UNITYSDK_OFFSET(0xA7E3B40)
#define MOLEMOLE_LOOPSUBDIVISIONSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xA7E3B30)
#define MOLEMOLE_LOOPSUBDIVISIONSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xA7E3B50)

namespace MoleMole
{
	inline static constexpr unsigned int LoopSubdivisionSettingEntry_TypeDefinitionIndex = 42003;
