...
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_DOHIDE_OFFSET UNITYSDK_OFFSET(0x6B0E6F0)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_DOREALRESET_OFFSET UNITYSDK_OFFSET(0x6B0EB60)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_DOSHOW_OFFSET UNITYSDK_OFFSET(0x6B0DFD0)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_DOSTARTRESET_OFFSET UNITYSDK_OFFSET(0x6B0E760)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_DOUPDATE_OFFSET UNITYSDK_OFFSET(0x6B0E830)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_METHOD_7_0CD27CF81DAA9C4A_OFFSET UNITYSDK_OFFSET(0x6B105D0)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_METHOD_7_513522A29644217D_OFFSET UNITYSDK_OFFSET(0x6B0F720)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_METHOD_7_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0x6B0E060)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_METHOD_7_980ADFEE2E32342D_OFFSET UNITYSDK_OFFSET(0x6B11510)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_METHOD_7_AC57C1C4868FD160_OFFSET UNITYSDK_OFFSET(0x6B11250)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_METHOD_7_CCF1D6419B23EEE1_OFFSET UNITYSDK_OFFSET(0x6B0F260)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_METHOD_7_EBF9BBCF4D808246_OFFSET UNITYSDK_OFFSET(0x6B119D0)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_METHOD_7_F5586C5D862C8EF0_OFFSET UNITYSDK_OFFSET(0x6B102D0)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_METHOD_7_F9B8047F726FEAA7_OFFSET UNITYSDK_OFFSET(0x6B12260)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6B0EC70)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x6B0EEC0)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_SETTOMAT_OFFSET UNITYSDK_OFFSET(0x6B0E560)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT_UPDATEWAYPOINTSSTARTEND_OFFSET UNITYSDK_OFFSET(0x6B0EDD0)
#define MOLEMOLE_MONOSCENEFINDWAYOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x6B0F1C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSceneFindWayObject_TypeDefinitionIndex = 68218;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSCENEFINDWAYOBJECT_ONDRAWGIZMOS_OFFSET))(this);
		}
