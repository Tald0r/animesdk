...
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0xCC54460)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_ONCLICKMOVIE_OFFSET UNITYSDK_OFFSET(0xCC544D0)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCC53F00)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCC54080)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCC53FA0)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCC53C80)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCC53D20)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_SETMOVIESELECT_OFFSET UNITYSDK_OFFSET(0xCC54610)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_SETMOVIESTATE_OFFSET UNITYSDK_OFFSET(0xCC54230)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC546A0)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCC546B0)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCC54720)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCC547A0)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCC54820)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCC54880)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaMovieWidgetController_TypeDefinitionIndex = 52721;

	class UICinemaMovieWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_D40DAE97CB89A74B* _view; // 0x2D0
		::Class_0_16E4307DCC419505_480* singleLevelData; // 0x2D8
