...
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0xD9B4720)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_ONCLICKMOVIE_OFFSET UNITYSDK_OFFSET(0xD9B4790)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD9B41B0)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD9B4330)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD9B4250)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD9B3F30)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD9B3FD0)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_SETMOVIESELECT_OFFSET UNITYSDK_OFFSET(0xD9B48D0)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER_SETMOVIESTATE_OFFSET UNITYSDK_OFFSET(0xD9B44E0)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD9B4960)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD9B4970)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD9B49E0)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD9B4A60)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD9B4AE0)
#define MOLEMOLE_UICINEMAMOVIEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD9B4B40)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaMovieWidgetController_TypeDefinitionIndex = 76794;

	class UICinemaMovieWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_D40DAE97CB89A74B* _view; // 0x2D0
		::Class_0_16E4307DCC419505_306* singleLevelData; // 0x2D8
