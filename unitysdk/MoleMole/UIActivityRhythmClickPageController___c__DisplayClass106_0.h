...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS106_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA30B300)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS106_0__PLAYBANGBOOEFFECT_B__0_OFFSET UNITYSDK_OFFSET(0xA30B310)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS106_0__PLAYBANGBOOEFFECT_B__1_OFFSET UNITYSDK_OFFSET(0xA30B3B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController___c__DisplayClass106_0_TypeDefinitionIndex = 41480;
