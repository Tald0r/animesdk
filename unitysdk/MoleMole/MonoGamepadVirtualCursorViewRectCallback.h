...
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK_GET_ONMOVECONTENT_OFFSET UNITYSDK_OFFSET(0xA48C020)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK_MOVECONTENT_1_OFFSET UNITYSDK_OFFSET(0xA48C0F0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK_MOVECONTENT_OFFSET UNITYSDK_OFFSET(0xA48C040)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK_SET_ONMOVECONTENT_OFFSET UNITYSDK_OFFSET(0xA48C030)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA48C1B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadVirtualCursorViewRectCallback_TypeDefinitionIndex = 77324;
