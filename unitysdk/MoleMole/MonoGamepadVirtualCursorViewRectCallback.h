...
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK_GET_ONMOVECONTENT_OFFSET UNITYSDK_OFFSET(0x7A91D20)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK_MOVECONTENT_1_OFFSET UNITYSDK_OFFSET(0x7A91DF0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK_MOVECONTENT_OFFSET UNITYSDK_OFFSET(0x7A91D40)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK_SET_ONMOVECONTENT_OFFSET UNITYSDK_OFFSET(0x7A91D30)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSORVIEWRECTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x7A91EB0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadVirtualCursorViewRectCallback_TypeDefinitionIndex = 47031;
