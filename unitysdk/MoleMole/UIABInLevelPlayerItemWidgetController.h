...
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0x6EE59E0)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER_CHECKSHOWTOAST_OFFSET UNITYSDK_OFFSET(0x6EE6680)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER_GETMOVESCRIPT_OFFSET UNITYSDK_OFFSET(0x6EE62D0)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER_GETPLAYERENTITYID_OFFSET UNITYSDK_OFFSET(0x6EE6540)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x6EE6470)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xE8E63A0)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x6EE5FB0)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6EE5710)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x6EE6040)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x6EE5910)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6EE5830)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6EE5460)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER_TOGGLEAUTHORITY_OFFSET UNITYSDK_OFFSET(0x6EE6200)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER__BINDVIEW_B__26_0_OFFSET UNITYSDK_OFFSET(0xE8E65B0)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER__BINDVIEW_B__26_1_OFFSET UNITYSDK_OFFSET(0xE8E6B40)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER__BINDVIEW_B__26_2_OFFSET UNITYSDK_OFFSET(0xE8E6F60)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER__BINDVIEW_B__26_3_OFFSET UNITYSDK_OFFSET(0xE8E72D0)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER__BINDVIEW_B__26_4_OFFSET UNITYSDK_OFFSET(0xE8E7630)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER__CHECKSHOWTOAST_B__28_0_OFFSET UNITYSDK_OFFSET(0xE8E7BE0)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER__CHECKSHOWTOAST_B__28_1_OFFSET UNITYSDK_OFFSET(0xE8E7C50)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER__CHECKSHOWTOAST_B__28_2_OFFSET UNITYSDK_OFFSET(0xE8E7CF0)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE8E6520)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xE8E7D60)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE8E7D70)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xE8E7DE0)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xE8E7E50)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE8E7ED0)
#define MOLEMOLE_UIABINLEVELPLAYERITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE8E7F50)

namespace MoleMole
{
	inline static constexpr unsigned int UIABInLevelPlayerItemWidgetController_TypeDefinitionIndex = 61993;

	class UIABInLevelPlayerItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_A00C43D6DDE43DC2* _view; // 0x2D0
		...
		::Class_2_A00C43D6DDE43DC2_Class_2_B2B3577F24704706* _normalView; // 0x2F8
		::Class_2_A00C43D6DDE43DC2_Class_2_0EF245B87F02A5C0_5* _deathView; // 0x300
