...
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOW_CONFIGGALGAMEAVATARSHOW_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xEC49C20)
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOW_CONFIGGALGAMEAVATARSHOW_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xEC49C30)
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOW_CONFIGGALGAMEAVATARSHOW_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xEC49EF0)
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOW_CONFIGGALGAMEAVATARSHOW_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xEC4A100)
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOW_CONFIGGALGAMEAVATARSHOW_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xEC4A0C0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigGalGameAvatarShow_ConfigGalGameAvatarShow_UnityGeneratedFormatter_TypeDefinitionIndex = 60504;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::UIAvatarCommonLightSetting*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigGalGameAvatarShow_ConfigGalGameAvatarShow_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43440);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::GalGameFacialSetting*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigGalGameAvatarShow_ConfigGalGameAvatarShow_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43448);
		}
