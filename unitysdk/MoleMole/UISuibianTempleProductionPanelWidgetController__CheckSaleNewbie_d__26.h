...
#define MOLEMOLE_UISUIBIANTEMPLEPRODUCTIONPANELWIDGETCONTROLLER__CHECKSALENEWBIE_D__26_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x37F350)
#define MOLEMOLE_UISUIBIANTEMPLEPRODUCTIONPANELWIDGETCONTROLLER__CHECKSALENEWBIE_D__26_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleProductionPanelWidgetController__CheckSaleNewbie_d__26_TypeDefinitionIndex = 77462;
