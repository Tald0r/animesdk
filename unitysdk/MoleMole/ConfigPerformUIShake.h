...
#define MOLEMOLE_CONFIGPERFORMUISHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0xF18A420)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigPerformUIShake_TypeDefinitionIndex = 73184;
