...
#define MOLEMOLE_CONFIGPERFORMUISHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC6AB20)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigPerformUIShake_TypeDefinitionIndex = 73962;

	class ConfigPerformUIShake : public ::System::Object
	{
	public:
		::MoleMole::Config::ConfigHollowCameraShake_ShakeAtom AmplitudeAtomX; // 0x10
		::MoleMole::Config::ConfigHollowCameraShake_ShakeAtom AmplitudeAtomY; // 0x30
