...
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC46CB0)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC46F50)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC46E70)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC46B60)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER_REFRESHROWSTATE_OFFSET UNITYSDK_OFFSET(0xAC470A0)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC47120)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC47190)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC47200)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC47280)
#define MOLEMOLE_UICOMMONWEEKREWARDCOMPROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC47130)

namespace MoleMole
{
	inline static constexpr unsigned int UICommonWeekRewardCompRowWidgetController_TypeDefinitionIndex = 63887;

	class UICommonWeekRewardCompRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_155* _view; // 0x2D0
