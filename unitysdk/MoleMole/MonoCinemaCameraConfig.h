...
#define MOLEMOLE_MONOCINEMACAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA485590)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCinemaCameraConfig_TypeDefinitionIndex = 77443;
