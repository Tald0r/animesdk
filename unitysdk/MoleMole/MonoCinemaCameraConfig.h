...
#define MOLEMOLE_MONOCINEMACAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x7A8C2D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCinemaCameraConfig_TypeDefinitionIndex = 43371;
