...
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xAD45460)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAD43E00)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD44F00)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAD458A0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD44FA0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD43E10)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD43F50)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__CREATEROWLAYERREWARD_OFFSET UNITYSDK_OFFSET(0xAD45780)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__CREATEROWLAYERTITLE_OFFSET UNITYSDK_OFFSET(0xAD456A0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x99AE5E0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__GAMEPADITEMSUBMIT_OFFSET UNITYSDK_OFFSET(0xAD45CC0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__GAMEPADSELECTNAVLISTITEM_OFFSET UNITYSDK_OFFSET(0xAD459C0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__GETCURGAMEPADSELECTROW_OFFSET UNITYSDK_OFFSET(0xAD45D40)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__INITGAMEPADSELECT_OFFSET UNITYSDK_OFFSET(0x99AE540)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONEKEYGETREWARD_OFFSET UNITYSDK_OFFSET(0xAD45030)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONSCROLLEND_OFFSET UNITYSDK_OFFSET(0xAD45640)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONSCROLL_OFFSET UNITYSDK_OFFSET(0xAD455B0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0x99AE650)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONUIOPEN_B__5_1_OFFSET UNITYSDK_OFFSET(0x99AE660)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__UPDATEONEKEYSTATUS_OFFSET UNITYSDK_OFFSET(0xAD44B60)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__UPDATEREWARDS_OFFSET UNITYSDK_OFFSET(0xAD441F0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x99AE840)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x99AE8B0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x99AE8E0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x99AE8F0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x99AE900)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___CREATEROWLAYERREWARD_B__16_0_OFFSET UNITYSDK_OFFSET(0x99AE830)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___ONEKEYGETREWARD_B__9_0_OFFSET UNITYSDK_OFFSET(0x99AE670)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_RewardV2_PopWindowController_TypeDefinitionIndex = 41491;
	...
	public:
		...
		::System::Void __OneKeyGetReward_b__9_0(::Class_3_025FF4981524A424_43* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_025FF4981524A424_43*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___ONEKEYGETREWARD_B__9_0_OFFSET))(this, rsp);
		}
