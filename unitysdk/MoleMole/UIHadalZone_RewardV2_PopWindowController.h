...
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xC007140)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC005AE0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC006BE0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC007620)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC006C80)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC005AF0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC005C30)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__CREATEROWLAYERREWARD_OFFSET UNITYSDK_OFFSET(0xC007500)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__CREATEROWLAYERTITLE_OFFSET UNITYSDK_OFFSET(0xC007420)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC007D50)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__GAMEPADITEMSUBMIT_OFFSET UNITYSDK_OFFSET(0xC007A40)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__GAMEPADSELECTNAVLISTITEM_OFFSET UNITYSDK_OFFSET(0xC007740)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__GETCURGAMEPADSELECTROW_OFFSET UNITYSDK_OFFSET(0xC007AC0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__INITGAMEPADSELECT_OFFSET UNITYSDK_OFFSET(0xC007290)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONEKEYGETREWARD_OFFSET UNITYSDK_OFFSET(0xC006D10)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONSCROLLEND_OFFSET UNITYSDK_OFFSET(0xC0073C0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONSCROLL_OFFSET UNITYSDK_OFFSET(0xC007330)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0xC007DC0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__ONUIOPEN_B__5_1_OFFSET UNITYSDK_OFFSET(0xC007DD0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__UPDATEONEKEYSTATUS_OFFSET UNITYSDK_OFFSET(0xC006830)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER__UPDATEREWARDS_OFFSET UNITYSDK_OFFSET(0xC005ED0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC007FB0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC008020)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC008050)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC008060)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC008070)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___CREATEROWLAYERREWARD_B__16_0_OFFSET UNITYSDK_OFFSET(0xC007FA0)
#define MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___ONEKEYGETREWARD_B__9_0_OFFSET UNITYSDK_OFFSET(0xC007DE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_RewardV2_PopWindowController_TypeDefinitionIndex = 39976;
	...
	public:
		...
		::Class_2_C6E5760570AAB360* _view; // 0x2F8
		::Class_2_468A4FBF2E9F527C* _hadalZoneModel; // 0x300
		::System::Collections::Generic::List_1<::MoleMole::UIHadalZone_RewardV2_PopWindowController_HadalRewardData>* listData; // 0x308
		...
		::System::Void __OneKeyGetReward_b__9_0(::Class_3_025FF4981524A424_518* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_025FF4981524A424_518*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_REWARDV2_POPWINDOWCONTROLLER___ONEKEYGETREWARD_B__9_0_OFFSET))(this, rsp);
		}
