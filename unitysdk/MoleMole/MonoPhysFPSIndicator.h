...
#define MOLEMOLE_MONOPHYSFPSINDICATOR_METHOD_5_2B152328DABB4A03_OFFSET UNITYSDK_OFFSET(0xB3B9C80)
#define MOLEMOLE_MONOPHYSFPSINDICATOR_METHOD_5_91E51879C0028BD4_OFFSET UNITYSDK_OFFSET(0xB3B9C10)
#define MOLEMOLE_MONOPHYSFPSINDICATOR_START_OFFSET UNITYSDK_OFFSET(0xB3B9580)
#define MOLEMOLE_MONOPHYSFPSINDICATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0xB3B97A0)
#define MOLEMOLE_MONOPHYSFPSINDICATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xB3B9C00)
#define MOLEMOLE_MONOPHYSFPSINDICATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB3B9BB0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoPhysFPSIndicator_TypeDefinitionIndex = 48024;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MonoPhysFPSIndicator_TypeDefinitionIndex)->GetStaticField(0x11DB0);
		}
