...
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_CREATEITEMROW_1_OFFSET UNITYSDK_OFFSET(0xD84D680)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_CREATEITEMROW_OFFSET UNITYSDK_OFFSET(0xD84CC90)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_CREATERELICROW_OFFSET UNITYSDK_OFFSET(0xD84CEC0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_CREATETITLEROW_OFFSET UNITYSDK_OFFSET(0xD84D5A0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xD84B620)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD84B610)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD84D760)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD84D1D0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONLEVELCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xD84D0F0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONTOGGLEVALUE_OFFSET UNITYSDK_OFFSET(0xD84C560)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD84D800)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD84B630)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD84BB50)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0xD84C110)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD84C810)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_SWITCHSELECTEDAVATAR_OFFSET UNITYSDK_OFFSET(0xD84BF90)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD84D890)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD84D980)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD84D9F0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD84DA70)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD84DA80)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD84DA90)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssLineupPopWindowController_TypeDefinitionIndex = 68221;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_451*>* _itemCtrl; // 0x308
