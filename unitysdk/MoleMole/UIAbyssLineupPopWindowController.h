...
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_CREATEITEMROW_1_OFFSET UNITYSDK_OFFSET(0xCFEE3C0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_CREATEITEMROW_OFFSET UNITYSDK_OFFSET(0xCFED9D0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_CREATERELICROW_OFFSET UNITYSDK_OFFSET(0xCFEDC00)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_CREATETITLEROW_OFFSET UNITYSDK_OFFSET(0xCFEE2E0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xCFEC070)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xCFEC060)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFEE4A0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xCFEDF10)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONLEVELCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xCFEDE30)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONTOGGLEVALUE_OFFSET UNITYSDK_OFFSET(0xCFED110)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFEE540)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFEC080)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFEC5B0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0xCFECCC0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCFED3C0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER_SWITCHSELECTEDAVATAR_OFFSET UNITYSDK_OFFSET(0xCFECAA0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFEE5D0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFEE6B0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xCFEE720)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFEE7A0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFEE7B0)
#define MOLEMOLE_UIABYSSLINEUPPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFEE7C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssLineupPopWindowController_TypeDefinitionIndex = 76665;
	...
	public:
		...
		::Class_2_3EE9E219E96FD648* _view; // 0x2F8
		::System::Collections::Generic::List_1<::MoleMole::UIAbyssS2InLevelMapDialogPageController_IUIInLevelItemPackageInfoBase*>* _backData; // 0x300
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_146*>* _itemCtrl; // 0x308
		::System::Collections::Generic::List_1<::System::Int32>* _avatarList; // 0x310
		::System::Collections::Generic::List_1<::Class_2_D89CCC627A66D0AD*>* _avatarItemList; // 0x318
		::System::Collections::Generic::List_1<::Enum_3_80565EDC4420BFE0>* _buildTypeList; // 0x320
		::System::Int32 _currSelectIndex; // 0x328
		::MoleMole::UIGeneralToggleWidgetControllerWithModel* _toggle; // 0x330
		::Class_2_D89CCC627A66D0AD* CurDisPlayAvatarItem; // 0x338
