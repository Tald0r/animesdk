...
#define MOLEMOLE_UICINEMAPLAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCC548F0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaPlayContext_TypeDefinitionIndex = 77967;
