...
#define MOLEMOLE_UICINEMAPLAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD9B4BB0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaPlayContext_TypeDefinitionIndex = 76452;
