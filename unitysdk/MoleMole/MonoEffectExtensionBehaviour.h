...
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR_AWAKE_OFFSET UNITYSDK_OFFSET(0xA488870)
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR_GET_ANIMATORS_OFFSET UNITYSDK_OFFSET(0xA4884E0)
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR_GET_ISALLCOMPONENTSCACHED_OFFSET UNITYSDK_OFFSET(0xA488460)
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR_GET_XWEAPONS_OFFSET UNITYSDK_OFFSET(0xA4886A0)
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xA488AB0)
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR_UPDATECACHESERIALIZEDATA_OFFSET UNITYSDK_OFFSET(0xA488950)
#define MOLEMOLE_MONOEFFECTEXTENSIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA488BA0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectExtensionBehaviour_TypeDefinitionIndex = 50272;
