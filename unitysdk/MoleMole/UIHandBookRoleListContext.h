...
#define MOLEMOLE_UIHANDBOOKROLELISTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8099650)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookRoleListContext_TypeDefinitionIndex = 60967;
