...
#define MOLEMOLE_UILOGINPAGECONTROLLER___C__DISPLAYCLASS23_1__CTOR_OFFSET UNITYSDK_OFFSET(0x8EC3D70)
#define MOLEMOLE_UILOGINPAGECONTROLLER___C__DISPLAYCLASS23_1__REQUESTSERVERLIST_B__3_OFFSET UNITYSDK_OFFSET(0x8EC3F50)

namespace MoleMole
{
	inline static constexpr unsigned int UILoginPageController___c__DisplayClass23_1_TypeDefinitionIndex = 52012;
