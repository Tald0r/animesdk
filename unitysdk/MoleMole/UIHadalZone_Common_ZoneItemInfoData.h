...
#define MOLEMOLE_UIHADALZONE_COMMON_ZONEITEMINFODATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB0FB860)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_Common_ZoneItemInfoData_TypeDefinitionIndex = 40923;
	...
	public:
		...
		::System::Int32 curZoneID; // 0x30
		::System::Int32 entranceID; // 0x34
		::System::Boolean isValid; // 0x38
		::System::Boolean isLockButCanClick; // 0x39
		::System::Boolean isSelected; // 0x3A
