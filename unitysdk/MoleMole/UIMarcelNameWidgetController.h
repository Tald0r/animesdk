...
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_FIXPOSITION_OFFSET UNITYSDK_OFFSET(0x8ECDC70)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_HIDETEAMGOOD_OFFSET UNITYSDK_OFFSET(0x8ECC490)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_INITIALIZEINFO_OFFSET UNITYSDK_OFFSET(0x8ECCD60)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8ECE160)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONTEAMMESSAGE_OFFSET UNITYSDK_OFFSET(0x8ECD490)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8ECE200)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8ECC690)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_SETINFO_OFFSET UNITYSDK_OFFSET(0x8ECCF70)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_SHOWNAME_OFFSET UNITYSDK_OFFSET(0x8ECC3F0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_UPDATEEMOJISCALE_OFFSET UNITYSDK_OFFSET(0x8ECD9E0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8ECE2E0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER__ONTEAMMESSAGE_G__HIDEEMOTIONICON_14_0_OFFSET UNITYSDK_OFFSET(0x8ECE310)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8ECE350)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8ECE3C0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8ECE440)

namespace MoleMole
{
	inline static constexpr unsigned int UIMarcelNameWidgetController_TypeDefinitionIndex = 53782;
