...
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_FIXPOSITION_OFFSET UNITYSDK_OFFSET(0x7D51AC0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_HIDETEAMGOOD_OFFSET UNITYSDK_OFFSET(0x7D502E0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_INITIALIZEINFO_OFFSET UNITYSDK_OFFSET(0x7D50BB0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7D51FB0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONTEAMMESSAGE_OFFSET UNITYSDK_OFFSET(0x7D512E0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7D52050)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7D504E0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_SETINFO_OFFSET UNITYSDK_OFFSET(0x7D50DC0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_SHOWNAME_OFFSET UNITYSDK_OFFSET(0x7D50240)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER_UPDATEEMOJISCALE_OFFSET UNITYSDK_OFFSET(0x7D51830)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7D52130)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER__ONTEAMMESSAGE_G__HIDEEMOTIONICON_14_0_OFFSET UNITYSDK_OFFSET(0x7D52160)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7D521A0)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7D52210)
#define MOLEMOLE_UIMARCELNAMEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7D52290)

namespace MoleMole
{
	inline static constexpr unsigned int UIMarcelNameWidgetController_TypeDefinitionIndex = 63864;

	class UIMarcelNameWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_7B42B6FF00235964* _view; // 0x2A0
		::UnityEngine::RectTransform* _selfTransform; // 0x2A8
		::UnityEngine::RectTransform* _parentTransform; // 0x2B0
		::UnityEngine::Transform* _targetTransform; // 0x2B8
		::UnityEngine::Vector2 _lastPosition; // 0x2C0
		::MoleMole::UIMarcelNameWidgetController_Display _display; // 0x2C8
		::System::UInt32 _entityID; // 0x2CC
		::Class_1_BE6BF7909AD9D940* _info; // 0x2D0
		::Foundation::Coroutine::CoroutineHandle _emojiHandle; // 0x2D8
