...
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x7CFDCB0)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x7D00030)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7CFFAD0)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7CFFB70)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7CFDCC0)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7CFDFF0)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_REFRESHRANKRULEPANEL_OFFSET UNITYSDK_OFFSET(0x7CFFC10)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x7CFE0F0)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7D000A0)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7D00260)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7D002D0)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7D002E0)
#define MOLEMOLE_UIGRANDMARCELRULEDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7D002F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGrandMarcelRuleDialogPopWindowController_TypeDefinitionIndex = 38081;

	class UIGrandMarcelRuleDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_16* _view; // 0x2F8
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_628*>* _curRaceConfigs; // 0x310
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_628*>* _curSurviveConfigs; // 0x318
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_628*>* _rankType1Configs; // 0x320
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_628*>* _rankType2Configs; // 0x328
