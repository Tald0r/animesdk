...
#define MOLEMOLE_GENERALGRAPHICQUALITYSETTINGCONTEXT_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xC9D0840)
#define MOLEMOLE_GENERALGRAPHICQUALITYSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D08B0)
#define MOLEMOLE_GENERALGRAPHICQUALITYSETTINGCONTEXT___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xC9D08D0)

namespace MoleMole
{
	inline static constexpr unsigned int GeneralGraphicQualitySettingContext_TypeDefinitionIndex = 72854;
