...
#define MOLEMOLE_GENERALGRAPHICQUALITYSETTINGCONTEXT_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xBA15DF0)
#define MOLEMOLE_GENERALGRAPHICQUALITYSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBA15E60)
#define MOLEMOLE_GENERALGRAPHICQUALITYSETTINGCONTEXT___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xBA15E80)

namespace MoleMole
{
	inline static constexpr unsigned int GeneralGraphicQualitySettingContext_TypeDefinitionIndex = 40709;
