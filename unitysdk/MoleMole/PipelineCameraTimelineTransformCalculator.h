...
#define MOLEMOLE_PIPELINECAMERATIMELINETRANSFORMCALCULATOR_PROCESSS_OFFSET UNITYSDK_OFFSET(0xBD4B590)
#define MOLEMOLE_PIPELINECAMERATIMELINETRANSFORMCALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xBD4B930)
#define MOLEMOLE_PIPELINECAMERATIMELINETRANSFORMCALCULATOR___BASE_PROCESSS_OFFSET UNITYSDK_OFFSET(0xBD4B940)

namespace MoleMole
{
	inline static constexpr unsigned int PipelineCameraTimelineTransformCalculator_TypeDefinitionIndex = 38765;
