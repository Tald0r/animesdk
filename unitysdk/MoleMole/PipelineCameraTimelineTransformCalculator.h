...
#define MOLEMOLE_PIPELINECAMERATIMELINETRANSFORMCALCULATOR_PROCESSS_OFFSET UNITYSDK_OFFSET(0xB1BBFF0)
#define MOLEMOLE_PIPELINECAMERATIMELINETRANSFORMCALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB1BC370)
#define MOLEMOLE_PIPELINECAMERATIMELINETRANSFORMCALCULATOR___BASE_PROCESSS_OFFSET UNITYSDK_OFFSET(0xB1BC380)

namespace MoleMole
{
	inline static constexpr unsigned int PipelineCameraTimelineTransformCalculator_TypeDefinitionIndex = 52318;
