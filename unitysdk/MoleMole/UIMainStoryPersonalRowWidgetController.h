...
class Class_2_60638234271CCDB8_51_Class_2_E6639369F71E31AF;
...
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_CLEARSUBWIDGETS_OFFSET UNITYSDK_OFFSET(0xD77C5B0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_CREATESUBWIDGETS_OFFSET UNITYSDK_OFFSET(0xD77C1D0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_CREATESUBWIDGET_OFFSET UNITYSDK_OFFSET(0xD77C8D0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_DOALPHAOFFSET_OFFSET UNITYSDK_OFFSET(0xD77D890)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_GETSUBGOBYSUBID_OFFSET UNITYSDK_OFFSET(0xD77D960)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_GET_HASSUBITEM_OFFSET UNITYSDK_OFFSET(0xD77DD90)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_GET_ROWDATA_OFFSET UNITYSDK_OFFSET(0xD77C190)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_GET_SELFSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xD77C1A0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_INVOKESUBITEM_OFFSET UNITYSDK_OFFSET(0xD77C0C0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_OK_OFFSET UNITYSDK_OFFSET(0xD77B0A0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD779F30)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0xD77CE40)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD779FD0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD7798E0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD779E80)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_ONUNSELECT_OFFSET UNITYSDK_OFFSET(0xD77CB60)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_READNEW_OFFSET UNITYSDK_OFFSET(0xD77BCE0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_REFRESHSCROLLVIEWCONTENTACTIVE_OFFSET UNITYSDK_OFFSET(0xD77CAC0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0xD77A560)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD77A1B0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_SELECT_OFFSET UNITYSDK_OFFSET(0xD77D4C0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_SETALPHAOFFSET_OFFSET UNITYSDK_OFFSET(0xD77D7B0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_SETROOTSELECTED_OFFSET UNITYSDK_OFFSET(0xD77CCC0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_SETSTAR_OFFSET UNITYSDK_OFFSET(0xD77C750)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_SETSUBITEM_OFFSET UNITYSDK_OFFSET(0xD77AD20)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0xD77DB80)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_TRIGGERBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xD77BB10)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER_TRIGGERSELECT_OFFSET UNITYSDK_OFFSET(0xD77BE70)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER__CREATESUBWIDGETS_B__20_0_OFFSET UNITYSDK_OFFSET(0xD77E290)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD77DDA0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER__OK_B__7_0_OFFSET UNITYSDK_OFFSET(0xD77E010)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER__OK_B__7_1_OFFSET UNITYSDK_OFFSET(0xD77E150)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER__OK_B__7_2_OFFSET UNITYSDK_OFFSET(0xD77DED0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0xD77DEC0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER__SETSUBITEM_B__22_0_OFFSET UNITYSDK_OFFSET(0xD77E420)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER__SETSUBITEM_G__HIDESUBITEMS_22_2_OFFSET UNITYSDK_OFFSET(0xD77E460)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER__SETSUBITEM_G__SHOWINFO_22_1_OFFSET UNITYSDK_OFFSET(0xD77CC50)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD77E4C0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD77E530)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD77E5B0)
#define MOLEMOLE_UIMAINSTORYPERSONALROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD77E610)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPersonalRowWidgetController_TypeDefinitionIndex = 44729;

	class UIMainStoryPersonalRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_51* _view; // 0x2A0
		...
		::Class_2_60638234271CCDB8_51_Class_2_E6639369F71E31AF* _extendInfoWidgetView; // 0x2D0
