...
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_GETAVATARID_OFFSET UNITYSDK_OFFSET(0x73B6FA0)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_GETBTN1TEXT_OFFSET UNITYSDK_OFFSET(0x73B7400)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_GETCONSUMEITEMID_OFFSET UNITYSDK_OFFSET(0x73B94E0)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_GETEXTRAPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x73B92A0)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x73B5B70)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_ONAVATARBREAKTHROUGH_OFFSET UNITYSDK_OFFSET(0x73B7520)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_ONBREAKANIMATIONFINISH_OFFSET UNITYSDK_OFFSET(0x73B7870)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_ONCLICKBTN1_OFFSET UNITYSDK_OFFSET(0x73B7020)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_ONITEMCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0x73B6D90)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x73B60D0)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x73B7960)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x73B5F80)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x73B6310)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_SETCONSUME_OFFSET UNITYSDK_OFFSET(0x73B7BE0)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_SETMAXSTAR_OFFSET UNITYSDK_OFFSET(0x73B90A0)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_SETPARENTVIEW_OFFSET UNITYSDK_OFFSET(0x73B5AA0)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x73B9550)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER__ONBREAKANIMATIONFINISH_B__33_0_OFFSET UNITYSDK_OFFSET(0x73B96D0)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER__ONCLICKBTN1_B__30_0_OFFSET UNITYSDK_OFFSET(0x73B96A0)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER__SETCONSUME_B__35_0_OFFSET UNITYSDK_OFFSET(0x73B9790)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x73B97B0)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x73B9820)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x73B98A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleBreakThroughController_TypeDefinitionIndex = 40030;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_38* _view; // 0x2C0
		...
		::System::Collections::Generic::List_1<::Share::EPropertyType>* GetExtraPropertyType(::Class_2_208CC9941471731A_335* template_)
		{
			return ((::System::Collections::Generic::List_1<::Share::EPropertyType>*(*)(::PVOID, ::Class_2_208CC9941471731A_335*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER_GETEXTRAPROPERTYTYPE_OFFSET))(this, template_);
		}
