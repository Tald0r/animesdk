...
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_BIND_OFFSET UNITYSDK_OFFSET(0x7A494C0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_CHANGEONSTATEWITHCHECK_OFFSET UNITYSDK_OFFSET(0x7A49260)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_GETUISTATEISON_OFFSET UNITYSDK_OFFSET(0x7A49770)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x7A49630)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7A498B0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7A49350)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_REFRESHVIEWWITHMODEL_OFFSET UNITYSDK_OFFSET(0x7A48D30)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x7A48FD0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL__BIND_B__5_0_OFFSET UNITYSDK_OFFSET(0x7A49DA0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x7A49920)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x7A499F0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0x7A49C40)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL__ONUIINIT_B__3_2_OFFSET UNITYSDK_OFFSET(0x7A49CF0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x7A49EA0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7A49F00)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7A49F10)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___BASE_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x7A49F20)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralToggleWidgetControllerWithModel_TypeDefinitionIndex = 49994;

	class UIGeneralToggleWidgetControllerWithModel : public ::MoleMole::UIGeneralToggleWidgetController
	{
	public:
		::MoleMole::UIGeneralToggleWidgetControllerWithModel_ViewModel* _viewModel; // 0x2B8
		::Class_2_F58E1814EA419801* _helper; // 0x2C0
		::Class_1_48D56DACBE4271BC* _modelBindHelper; // 0x2C8
		...
		::System::Void RefreshViewWithModel(::Class_0_16E4307DCC419505_103<::System::Boolean>* model, ::System::Func_1<::System::Boolean>* CheckCanToggle, ::System::Action_1<::System::Boolean>* OnUIStateChange)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_103<::System::Boolean>*, ::System::Func_1<::System::Boolean>*, ::System::Action_1<::System::Boolean>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_REFRESHVIEWWITHMODEL_OFFSET))(this, model, CheckCanToggle, OnUIStateChange);
		}
