...
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_BIND_OFFSET UNITYSDK_OFFSET(0xA9A02E0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_CHANGEONSTATEWITHCHECK_OFFSET UNITYSDK_OFFSET(0xA9A0080)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_GETUISTATEISON_OFFSET UNITYSDK_OFFSET(0xA9A0590)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA9A0450)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA9A06C0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA9A0170)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_REFRESHVIEWWITHMODEL_OFFSET UNITYSDK_OFFSET(0xA99FB50)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA99FDF0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL__BIND_B__5_0_OFFSET UNITYSDK_OFFSET(0xA9A0BB0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xA9A0730)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0xA9A0800)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0xA9A0A50)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL__ONUIINIT_B__3_2_OFFSET UNITYSDK_OFFSET(0xA9A0B00)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA9A0CB0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA9A0D10)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA9A0D20)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___BASE_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA9A0D30)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralToggleWidgetControllerWithModel_TypeDefinitionIndex = 46496;
