...
#define MOLEMOLE_TRIGGERATTACK__RESETVALUE_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8F4D850)
#define MOLEMOLE_TRIGGERATTACK__RESETVALUE_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8F4D880)
#define MOLEMOLE_TRIGGERATTACK__RESETVALUE_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8F4D8E0)
#define MOLEMOLE_TRIGGERATTACK__RESETVALUE_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x8F4D890)
#define MOLEMOLE_TRIGGERATTACK__RESETVALUE_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F4D840)
#define MOLEMOLE_TRIGGERATTACK__RESETVALUE_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0x8F4D830)

namespace MoleMole
{
	inline static constexpr unsigned int TriggerAttack__ResetValue_d__11_TypeDefinitionIndex = 72055;
