...
#define MOLEMOLE_DICEROTADJUSTER_METHOD_5_4C288C0C3DC7B4CA_OFFSET UNITYSDK_OFFSET(0xF18B9B0)
#define MOLEMOLE_DICEROTADJUSTER_METHOD_5_7E015B837E1981C0_OFFSET UNITYSDK_OFFSET(0xF18BB30)
#define MOLEMOLE_DICEROTADJUSTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xF18B640)
#define MOLEMOLE_DICEROTADJUSTER_SETCTRLDICERESULT_OFFSET UNITYSDK_OFFSET(0xF18B8D0)
#define MOLEMOLE_DICEROTADJUSTER__CTOR_OFFSET UNITYSDK_OFFSET(0xF18C110)

namespace MoleMole
{
	inline static constexpr unsigned int DiceRotAdjuster_TypeDefinitionIndex = 56715;
