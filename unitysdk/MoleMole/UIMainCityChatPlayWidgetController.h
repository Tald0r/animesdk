...
class Class_2_79AE422BA06F6D26_38_Class_2_99BC69CB30FB4283;
...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ADDONFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x6CBA010)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_CHECKAVATARGREY_OFFSET UNITYSDK_OFFSET(0x6CBB340)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_DOSTARTSKIPCHAT_OFFSET UNITYSDK_OFFSET(0x6CB6590)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ENSUREPREVIOUSNODEFADEOUT_OFFSET UNITYSDK_OFFSET(0x6CBD030)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_FINISH_OFFSET UNITYSDK_OFFSET(0x6CB9230)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_GETORCREATECHATBTN_OFFSET UNITYSDK_OFFSET(0x6CBA6B0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_GET_INPUTHANDLELAYER_OFFSET UNITYSDK_OFFSET(0x6CB5B60)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x6CB5B70)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x6CB6C60)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_INLEVELPLAYSTORYNODE_OFFSET UNITYSDK_OFFSET(0x6CBE5C0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_JUMPSECTIONFORBRANCH_OFFSET UNITYSDK_OFFSET(0x6CBC5D0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_MANUALSTART_OFFSET UNITYSDK_OFFSET(0x6CB6BD0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONAUTOBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x6CB91C0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONCONTINUEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x6CB8F50)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6CB7350)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x6CB8990)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONINTERACTFINISH_OFFSET UNITYSDK_OFFSET(0x6CB9DD0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x6CB8D70)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONNODERUN_OFFSET UNITYSDK_OFFSET(0x6CB6930)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6CB6A50)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONTRANSITIONFADEIN_OFFSET UNITYSDK_OFFSET(0x6CB9D60)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x6CB7980)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6CB8450)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6CB5B80)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6CB6160)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_PLAYCHATPANELFADEIN_OFFSET UNITYSDK_OFFSET(0x6CB9EB0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_PLAYCHATPANELFADEOUT_OFFSET UNITYSDK_OFFSET(0x6CB9F60)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_PLAYFADEOUTEFFECT_OFFSET UNITYSDK_OFFSET(0x6CB9800)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_PLAYLASTNODEFINISH_OFFSET UNITYSDK_OFFSET(0x6CBC970)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_PLAYSTORYNODE_OFFSET UNITYSDK_OFFSET(0x6CBD4A0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_PLAYTEXT_OFFSET UNITYSDK_OFFSET(0x6CBE720)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_POSTSOUND_OFFSET UNITYSDK_OFFSET(0x6CBD7D0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_POSTVOICE_OFFSET UNITYSDK_OFFSET(0x6CBD620)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_REPLACEAVATARNAME_OFFSET UNITYSDK_OFFSET(0x6CBA0D0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETBLACKSCREENSTATENOANIM_OFFSET UNITYSDK_OFFSET(0x6CBDEE0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETBLACKSCREENSTATE_OFFSET UNITYSDK_OFFSET(0x6CBE0E0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETEXITTRANSITION_OFFSET UNITYSDK_OFFSET(0x6CBDE70)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETFINISHWITHNEXTINDEX_OFFSET UNITYSDK_OFFSET(0x6CBA560)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETSHOWNAMEFORSLOT_OFFSET UNITYSDK_OFFSET(0x6CBA470)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETTRANSITIONICON_OFFSET UNITYSDK_OFFSET(0x6CBB4E0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SHOW3DMODEL_OFFSET UNITYSDK_OFFSET(0x6CBD3A0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SHOWCUSTOMTRANSITION_OFFSET UNITYSDK_OFFSET(0x6CBBB10)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SHOWNARRATORSCREEN_OFFSET UNITYSDK_OFFSET(0x6CBDCB0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SHOWQUESTRECOMMEND_OFFSET UNITYSDK_OFFSET(0x6CBD290)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SHOWTRANSITION_OFFSET UNITYSDK_OFFSET(0x6CBAC90)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SKIPSTORYPLAY_OFFSET UNITYSDK_OFFSET(0x6CB67C0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_STARTSKIPCHAT_OFFSET UNITYSDK_OFFSET(0x6CB6610)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_STOPCURRENTSOUND_OFFSET UNITYSDK_OFFSET(0x6CBDB40)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_STOPCURRENTVOICE_OFFSET UNITYSDK_OFFSET(0x6CBD9D0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_TRYNEXT_OFFSET UNITYSDK_OFFSET(0x6CB9CB0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_TRYSKIPTRANSITION_OFFSET UNITYSDK_OFFSET(0x6CBA850)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_UPDATEPLAY_OFFSET UNITYSDK_OFFSET(0x6CB8880)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_UPDATESKIPSTATE_OFFSET UNITYSDK_OFFSET(0x6CB69A0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x6CB86C0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_WAITINTERACT_OFFSET UNITYSDK_OFFSET(0x6CBCF80)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6CBE880)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__INITVIEW_B__71_0_OFFSET UNITYSDK_OFFSET(0x6CBEDE0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__ONCONTINUEBTNCLICKED_B__32_0_OFFSET UNITYSDK_OFFSET(0x6CBEB00)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__ONUIINIT_B__17_0_OFFSET UNITYSDK_OFFSET(0x6CBEAD0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__ONUIOPEN_B__18_0_OFFSET UNITYSDK_OFFSET(0x6CBEAE0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__ONUIOPEN_B__18_1_OFFSET UNITYSDK_OFFSET(0x6CBEAF0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__PLAYFADEOUTEFFECT_B__40_0_OFFSET UNITYSDK_OFFSET(0x6CBEB90)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__PLAYLASTNODEFINISH_B__52_0_OFFSET UNITYSDK_OFFSET(0x6CBEBA0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__PLAYLASTNODEFINISH_B__52_1_OFFSET UNITYSDK_OFFSET(0x6CBEBD0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__PLAYLASTNODEFINISH_B__52_2_OFFSET UNITYSDK_OFFSET(0x6CBEC10)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__SETBLACKSCREENSTATE_B__67_0_OFFSET UNITYSDK_OFFSET(0x6CBEDA0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__SHOW3DMODEL_G__GETMODELTEMPLATE_56_1_OFFSET UNITYSDK_OFFSET(0x6CBEC40)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__SHOW3DMODEL_G__GETTEXTMAPKEY_56_2_OFFSET UNITYSDK_OFFSET(0x6CBED50)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__SHOWTRANSITION_G__SETTEXT_47_0_OFFSET UNITYSDK_OFFSET(0x6CBB840)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_FINISH_OFFSET UNITYSDK_OFFSET(0x6CBEDF0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6CBEE50)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x6CBEEC0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x6CBEEF0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONNODERUN_OFFSET UNITYSDK_OFFSET(0x6CBEF50)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6CBEFC0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x6CBEFD0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6CBEFE0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6CBEFF0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6CBF000)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_STARTSKIPCHAT_OFFSET UNITYSDK_OFFSET(0x6CBF070)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_UPDATESKIPSTATE_OFFSET UNITYSDK_OFFSET(0x6CBF0F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController_TypeDefinitionIndex = 53829;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_38* _view; // 0x378
		::System::Collections::Generic::List_1<::UnityEngine::UI::Extension::UILocalizationText*>* _trackTexts; // 0x380
		::System::Collections::Generic::List_1<::Class_2_60DDD9C206686F44*>* _trackInfoButtons; // 0x388
		::System::Collections::Generic::List_1<::Class_2_60DDD9C206686F44*>* _trackConfirmButtons; // 0x390
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* _trackInfoGameObjects; // 0x398
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* _trackEmptyGameObjects; // 0x3A0
		::System::Collections::Generic::List_1<::UnityEngine::Animation*>* _trackAcceptAnims; // 0x3A8
		::System::Int32 _interactNpcTag; // 0x3B0
		::System::Boolean _isInteractSuccess; // 0x3B4
		::System::UInt32 _currentPendingVoice; // 0x3B8
		::System::UInt32 _currentPendingSound; // 0x3BC
		::Class_1_84CF578163D09572* _chatSkipBtnItem; // 0x3C0
		::Foundation::Coroutine::CoroutineHandle _playStoryPlayAvatarDelay; // 0x3C8
		::Foundation::Coroutine::CoroutineHandle _contentAniFadeInDelay; // 0x3CC
		::Foundation::Coroutine::CoroutineHandle _inLevelCharacterAnimatorDelay; // 0x3D0
		::System::Single _btnTimer; // 0x3D4
		::System::Action_1<::Class_1_BC9D27E6028F322B*>* _callback; // 0x3D8
		::System::String* replaceTextMapTD; // 0x3E0
		::System::String* leftName; // 0x3E8
		::System::String* rightName; // 0x3F0
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* galTalkRealTextDic; // 0x3F8
		::System::Boolean _playAnimation; // 0x400
		::System::Int32 _exitTransitionID; // 0x404
		::System::Boolean _showBlackScreen; // 0x408
		::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::System::Int32, ::System::Int32>, ::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::System::Int32>*>*>* _branchNodeHistory; // 0x410
		::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::System::Int32, ::System::Int32>, ::System::Collections::Generic::List_1<::System::Int32>*>* _transitionNodeHistory; // 0x418
		::System::Boolean withoutPlayFadeIn; // 0x420
		::System::Collections::Generic::Dictionary_2<::MoleMole::GalGame::InLevelChatEntitySlot, ::System::String*>* _slotNames; // 0x428
		::System::String* CurrentTimelineKey; // 0x430
		::System::Collections::Generic::List_1<::Class_2_0D31A1661D004892<::Class_2_79AE422BA06F6D26_38_Class_2_99BC69CB30FB4283*>*>* _selectChatBtnList; // 0x438
		::System::Int64 _currChatUid; // 0x440
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Action_1<::Class_1_BC9D27E6028F322B*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ADDONFINISHCALLBACK_OFFSET))(this, _action);
		}
		...
		::Class_2_79AE422BA06F6D26_38_Class_2_99BC69CB30FB4283* GetOrCreateChatBtn(::System::Int32 index)
		{
			return ((::Class_2_79AE422BA06F6D26_38_Class_2_99BC69CB30FB4283*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_GETORCREATECHATBTN_OFFSET))(this, index);
		}
		...
		::System::Void SetTransitionIcon(::Class_2_79AE422BA06F6D26_38_Class_2_99BC69CB30FB4283* go, ::MoleMole::GalGame::MainCityChatTransitionDisplayItem* config, ::System::Boolean greyText)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_79AE422BA06F6D26_38_Class_2_99BC69CB30FB4283*, ::MoleMole::GalGame::MainCityChatTransitionDisplayItem*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETTRANSITIONICON_OFFSET))(this, go, config, greyText);
		}
		...
		::System::Void ShowQuestRecommend(::Class_2_091D3562DE6F17FD* node)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_091D3562DE6F17FD*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SHOWQUESTRECOMMEND_OFFSET))(this, node);
		}
		...
		static ::System::Void _ShowTransition_g__SetText_47_0(::Class_2_79AE422BA06F6D26_38_Class_2_99BC69CB30FB4283* go, ::MoleMole::GalGame::MainCityChatTransitionDisplayItem* config)
		{
			return ((::System::Void(*)(::Class_2_79AE422BA06F6D26_38_Class_2_99BC69CB30FB4283*, ::MoleMole::GalGame::MainCityChatTransitionDisplayItem*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__SHOWTRANSITION_G__SETTEXT_47_0_OFFSET))(go, config);
		}
		...
		static ::Class_0_16E4307DCC419505_26* _Show3DModel_g__GetModelTemplate_56_1(::System::Int32 id, ::MoleMole::GalGame::ModelConfigTemplateType type)
		{
			return ((::Class_0_16E4307DCC419505_26*(*)(::System::Int32, ::MoleMole::GalGame::ModelConfigTemplateType))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__SHOW3DMODEL_G__GETMODELTEMPLATE_56_1_OFFSET))(id, type);
		}
