...
class Class_2_79AE422BA06F6D26_33_Class_2_99BC69CB30FB4283_1;
...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ADDONFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x6CAF6D0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_CHECKAVATARGREY_OFFSET UNITYSDK_OFFSET(0xB4E8770)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_DOSTARTSKIPCHAT_OFFSET UNITYSDK_OFFSET(0x6CAC550)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ENSUREPREVIOUSNODEFADEOUT_OFFSET UNITYSDK_OFFSET(0xB4EA450)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_FINISH_OFFSET UNITYSDK_OFFSET(0x6CAE8F0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_GETORCREATECHATBTN_OFFSET UNITYSDK_OFFSET(0x6CAFD70)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_GET_INPUTHANDLELAYER_OFFSET UNITYSDK_OFFSET(0x6CABB10)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x6CABB20)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xB4EBCD0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_INLEVELPLAYSTORYNODE_OFFSET UNITYSDK_OFFSET(0xB4EBA10)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_JUMPSECTIONFORBRANCH_OFFSET UNITYSDK_OFFSET(0xB4E99F0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_MANUALSTART_OFFSET UNITYSDK_OFFSET(0x6CACB90)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONAUTOBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x6CAE880)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONCONTINUEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x6CAE610)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6CACC20)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x6CAE050)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONINTERACTFINISH_OFFSET UNITYSDK_OFFSET(0x6CAF490)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x6CAE430)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONNODERUN_OFFSET UNITYSDK_OFFSET(0x6CAC8F0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6CACA10)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONTRANSITIONFADEIN_OFFSET UNITYSDK_OFFSET(0x6CAF420)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x6CAD250)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6CADD10)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6CABB30)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6CAC120)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_PLAYCHATPANELFADEIN_OFFSET UNITYSDK_OFFSET(0x6CAF570)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_PLAYCHATPANELFADEOUT_OFFSET UNITYSDK_OFFSET(0x6CAF620)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_PLAYFADEOUTEFFECT_OFFSET UNITYSDK_OFFSET(0x6CAEEC0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_PLAYLASTNODEFINISH_OFFSET UNITYSDK_OFFSET(0xB4E9D90)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_PLAYSTORYNODE_OFFSET UNITYSDK_OFFSET(0xB4EA8D0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_PLAYTEXT_OFFSET UNITYSDK_OFFSET(0xB4EBB70)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_POSTSOUND_OFFSET UNITYSDK_OFFSET(0xB4EAC00)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_POSTVOICE_OFFSET UNITYSDK_OFFSET(0xB4EAA50)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_REPLACEAVATARNAME_OFFSET UNITYSDK_OFFSET(0x6CAF790)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETBLACKSCREENSTATENOANIM_OFFSET UNITYSDK_OFFSET(0xB4EB310)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETBLACKSCREENSTATE_OFFSET UNITYSDK_OFFSET(0xB4EB520)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETEXITTRANSITION_OFFSET UNITYSDK_OFFSET(0xB4EB2A0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETFINISHWITHNEXTINDEX_OFFSET UNITYSDK_OFFSET(0x6CAFC20)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETSHOWNAMEFORSLOT_OFFSET UNITYSDK_OFFSET(0x6CAFB30)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETTRANSITIONICON_OFFSET UNITYSDK_OFFSET(0xB4E8910)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SHOW3DMODEL_OFFSET UNITYSDK_OFFSET(0xB4EA7D0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SHOWCUSTOMTRANSITION_OFFSET UNITYSDK_OFFSET(0xB4E8F40)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SHOWNARRATORSCREEN_OFFSET UNITYSDK_OFFSET(0xB4EB0E0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SHOWQUESTRECOMMEND_OFFSET UNITYSDK_OFFSET(0xB4EA6B0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SHOWTRANSITION_OFFSET UNITYSDK_OFFSET(0xB4E80C0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SKIPSTORYPLAY_OFFSET UNITYSDK_OFFSET(0x6CAC780)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_STARTSKIPCHAT_OFFSET UNITYSDK_OFFSET(0x6CAC5D0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_STOPCURRENTSOUND_OFFSET UNITYSDK_OFFSET(0xB4EAF70)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_STOPCURRENTVOICE_OFFSET UNITYSDK_OFFSET(0xB4EAE00)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_TRYNEXT_OFFSET UNITYSDK_OFFSET(0x6CAF370)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_TRYSKIPTRANSITION_OFFSET UNITYSDK_OFFSET(0xB4E7C80)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_UPDATEPLAY_OFFSET UNITYSDK_OFFSET(0xB4EC3C0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_UPDATESKIPSTATE_OFFSET UNITYSDK_OFFSET(0x6CAC960)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x6CADF80)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_WAITINTERACT_OFFSET UNITYSDK_OFFSET(0xB4EA3A0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB4EC4D0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__INITVIEW_B__71_0_OFFSET UNITYSDK_OFFSET(0xB4ECA30)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__ONCONTINUEBTNCLICKED_B__32_0_OFFSET UNITYSDK_OFFSET(0xB4EC750)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__ONUIINIT_B__17_0_OFFSET UNITYSDK_OFFSET(0xB4EC720)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__ONUIOPEN_B__18_0_OFFSET UNITYSDK_OFFSET(0xB4EC730)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__ONUIOPEN_B__18_1_OFFSET UNITYSDK_OFFSET(0xB4EC740)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__PLAYFADEOUTEFFECT_B__40_0_OFFSET UNITYSDK_OFFSET(0xB4EC7E0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__PLAYLASTNODEFINISH_B__52_0_OFFSET UNITYSDK_OFFSET(0xB4EC7F0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__PLAYLASTNODEFINISH_B__52_1_OFFSET UNITYSDK_OFFSET(0xB4EC820)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__PLAYLASTNODEFINISH_B__52_2_OFFSET UNITYSDK_OFFSET(0xB4EC860)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__SETBLACKSCREENSTATE_B__67_0_OFFSET UNITYSDK_OFFSET(0xB4EC9F0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__SHOW3DMODEL_G__GETMODELTEMPLATE_56_1_OFFSET UNITYSDK_OFFSET(0xB4EC890)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__SHOW3DMODEL_G__GETTEXTMAPKEY_56_2_OFFSET UNITYSDK_OFFSET(0xB4EC9A0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__SHOWTRANSITION_G__SETTEXT_47_0_OFFSET UNITYSDK_OFFSET(0xB4E8C70)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_FINISH_OFFSET UNITYSDK_OFFSET(0xB4ECA40)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB4ECAA0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xB4ECB10)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xB4ECB40)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONNODERUN_OFFSET UNITYSDK_OFFSET(0xB4ECBA0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB4ECC10)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB4ECC20)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB4ECC30)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB4ECC40)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB4ECC50)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_STARTSKIPCHAT_OFFSET UNITYSDK_OFFSET(0xB4ECCC0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___BASE_UPDATESKIPSTATE_OFFSET UNITYSDK_OFFSET(0xB4ECD40)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController_TypeDefinitionIndex = 68991;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_33* _view; // 0x378
		...
		::System::Collections::Generic::List_1<::Class_2_0D31A1661D004892<::Class_2_79AE422BA06F6D26_33_Class_2_99BC69CB30FB4283_1*>*>* _selectChatBtnList; // 0x438
		...
		::Class_2_79AE422BA06F6D26_33_Class_2_99BC69CB30FB4283_1* GetOrCreateChatBtn(::System::Int32 index)
		{
			return ((::Class_2_79AE422BA06F6D26_33_Class_2_99BC69CB30FB4283_1*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_GETORCREATECHATBTN_OFFSET))(this, index);
		}
		...
		::System::Void SetTransitionIcon(::Class_2_79AE422BA06F6D26_33_Class_2_99BC69CB30FB4283_1* go, ::MoleMole::GalGame::MainCityChatTransitionDisplayItem* config, ::System::Boolean greyText)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_79AE422BA06F6D26_33_Class_2_99BC69CB30FB4283_1*, ::MoleMole::GalGame::MainCityChatTransitionDisplayItem*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER_SETTRANSITIONICON_OFFSET))(this, go, config, greyText);
		}
		...
		static ::System::Void _ShowTransition_g__SetText_47_0(::Class_2_79AE422BA06F6D26_33_Class_2_99BC69CB30FB4283_1* go, ::MoleMole::GalGame::MainCityChatTransitionDisplayItem* config)
		{
			return ((::System::Void(*)(::Class_2_79AE422BA06F6D26_33_Class_2_99BC69CB30FB4283_1*, ::MoleMole::GalGame::MainCityChatTransitionDisplayItem*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__SHOWTRANSITION_G__SETTEXT_47_0_OFFSET))(go, config);
		}
		...
		static ::Class_0_16E4307DCC419505_30* _Show3DModel_g__GetModelTemplate_56_1(::System::Int32 id, ::MoleMole::GalGame::ModelConfigTemplateType type)
		{
			return ((::Class_0_16E4307DCC419505_30*(*)(::System::Int32, ::MoleMole::GalGame::ModelConfigTemplateType))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__SHOW3DMODEL_G__GETMODELTEMPLATE_56_1_OFFSET))(id, type);
		}
