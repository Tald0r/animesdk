...
#define MOLEMOLE_MONOEFFECTPLUGINHITWALLBULLET__CTOR_OFFSET UNITYSDK_OFFSET(0xC2ECAD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginHitWallBullet_TypeDefinitionIndex = 64019;
