...
#define MOLEMOLE_UIACTIVITYSERIESNORMALREWARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB8FA070)
#define MOLEMOLE_UIACTIVITYSERIESNORMALREWARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB8FA110)
#define MOLEMOLE_UIACTIVITYSERIESNORMALREWARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB8F9DF0)
#define MOLEMOLE_UIACTIVITYSERIESNORMALREWARDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB8F9FC0)
#define MOLEMOLE_UIACTIVITYSERIESNORMALREWARDWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB8FA4B0)
#define MOLEMOLE_UIACTIVITYSERIESNORMALREWARDWIDGETCONTROLLER_TAKEREWARD_OFFSET UNITYSDK_OFFSET(0xB8FA1F0)
#define MOLEMOLE_UIACTIVITYSERIESNORMALREWARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB8FA9D0)
#define MOLEMOLE_UIACTIVITYSERIESNORMALREWARDWIDGETCONTROLLER__TAKEREWARD_B__9_0_OFFSET UNITYSDK_OFFSET(0xB8FAA00)
#define MOLEMOLE_UIACTIVITYSERIESNORMALREWARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB8FAA20)
#define MOLEMOLE_UIACTIVITYSERIESNORMALREWARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB8FAA90)
#define MOLEMOLE_UIACTIVITYSERIESNORMALREWARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB8FAB10)
#define MOLEMOLE_UIACTIVITYSERIESNORMALREWARDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB8FAB70)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySeriesNormalRewardWidgetController_TypeDefinitionIndex = 69069;
	...
	public:
		...
		::Class_3_BE75AAF0F7C40C75_3* _task; // 0x2B0
		...
		::System::Void RefreshView(::Class_3_BE75AAF0F7C40C75_3* task, ::System::Action* takeRewardCallback, ::System::String* tagText)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_BE75AAF0F7C40C75_3*, ::System::Action*, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYSERIESNORMALREWARDWIDGETCONTROLLER_REFRESHVIEW_OFFSET))(this, task, takeRewardCallback, tagText);
		}
