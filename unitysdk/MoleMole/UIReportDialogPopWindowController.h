...
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDF22D30)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_INITPHOTOWALLUIVIEW_OFFSET UNITYSDK_OFFSET(0xDF25E40)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_INITREPORTCONTENTBYINDEX_OFFSET UNITYSDK_OFFSET(0xDF25570)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_INITREPORTVIEW_OFFSET UNITYSDK_OFFSET(0xDF24090)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_INITSUBTYPES_OFFSET UNITYSDK_OFFSET(0xDF25030)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_ONCLICKLEFTTAB_OFFSET UNITYSDK_OFFSET(0xDF254F0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_ONCLICKSELECTCHATHISTORY_OFFSET UNITYSDK_OFFSET(0xDF260B0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF24A90)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDF249C0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_ONINPUTFIELDDESELECT_OFFSET UNITYSDK_OFFSET(0xDF26E00)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_ONINPUTFIELDSELECT_OFFSET UNITYSDK_OFFSET(0xDF26D80)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_ONTEXTVALIDATEINPUT_OFFSET UNITYSDK_OFFSET(0xDF26C20)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF24B30)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF22D40)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF23900)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_RESETCHEATREPORTSUBTYPES_OFFSET UNITYSDK_OFFSET(0xDF25300)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_RESETINFOREPORTSUBTYPES_OFFSET UNITYSDK_OFFSET(0xDF24BF0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_RESETREPORTITEM_OFFSET UNITYSDK_OFFSET(0xDF24DE0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_RESETREPORTTAGDATA_OFFSET UNITYSDK_OFFSET(0xDF23EE0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER_SUBMITREPORT_OFFSET UNITYSDK_OFFSET(0xDF26440)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF26F20)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER__INITREPORTVIEW_B__12_0_OFFSET UNITYSDK_OFFSET(0xDF270F0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER__INITSUBTYPES_B__16_0_OFFSET UNITYSDK_OFFSET(0xDF271F0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF273F0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDF27460)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF27490)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF274A0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF274B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIReportDialogPopWindowController_TypeDefinitionIndex = 60490;

	class UIReportDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::System::Collections::Generic::Dictionary_2<::Enum_3_DFCB42601400F441_1, ::System::String*>* mainTextDic; // 0x2F8
		::System::Collections::Generic::Dictionary_2<::Enum_3_9D0DA3B61DDF2467, ::System::String*>* subTextDic; // 0x300
		::System::Collections::Generic::Dictionary_2<::Enum_3_DFCB42601400F441_1, ::System::String*>* reportInputTextDic; // 0x308
		::Class_2_79AE422BA06F6D26_51* _view; // 0x310
		...
		::System::Collections::Generic::List_1<::Enum_3_DFCB42601400F441_1>* _leftTabReportType; // 0x338
		...
		::Enum_3_DFCB42601400F441_1 currSelectedType; // 0x350
		...
		::System::Collections::Generic::List_1<::Class_1_89120A467F7A010D_1*>* _reportMsgDataList; // 0x380
