...
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9A06140)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONCLICKGETBTN_OFFSET UNITYSDK_OFFSET(0x9A0B320)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONCLICKSCROLLITEM_OFFSET UNITYSDK_OFFSET(0x9A0BA10)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A06150)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x9A0ADE0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x9A0B0B0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9A09F60)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONSCROLLMOVE_OFFSET UNITYSDK_OFFSET(0x9A0BAE0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x9A0ABF0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A0AC60)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9A061F0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9A09EB0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_REFRESHALLMAILS_OFFSET UNITYSDK_OFFSET(0x9A0C030)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_REFRESHCOUNT_OFFSET UNITYSDK_OFFSET(0x9A07740)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_REFRESHRECEIVEALLBTNSTATE_OFFSET UNITYSDK_OFFSET(0x9A0A620)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_REFRESHSCROLLVIEWCONFIG_OFFSET UNITYSDK_OFFSET(0x9A07930)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_REPLACETEXT_OFFSET UNITYSDK_OFFSET(0x9A0C730)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_SETACCESSINFO_OFFSET UNITYSDK_OFFSET(0x9A0C800)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_SETEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0x9A06D30)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_SETNEEDUPDATEMAIL_OFFSET UNITYSDK_OFFSET(0x9A0B9A0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_SETREWARDINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x9A0B040)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_SETREWARDMODULEINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x9A0C650)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_TRYGETMAILAWARD_OFFSET UNITYSDK_OFFSET(0x9A0B680)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_UPDATEDETAIL_OFFSET UNITYSDK_OFFSET(0x9A07C20)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER_UPDATEMAILDETAILS_OFFSET UNITYSDK_OFFSET(0x9A07B70)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A0CC00)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONCLICKGETBTN_B__13_0_OFFSET UNITYSDK_OFFSET(0xA4106A0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONCLICKGETBTN_B__13_1_OFFSET UNITYSDK_OFFSET(0xA410800)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0x9A0CCE0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_10_OFFSET UNITYSDK_OFFSET(0xA410540)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_1_OFFSET UNITYSDK_OFFSET(0x9A0CD40)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_2_OFFSET UNITYSDK_OFFSET(0x9A0D0B0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_3_OFFSET UNITYSDK_OFFSET(0x9A0D130)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_4_OFFSET UNITYSDK_OFFSET(0x9A0D1B0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_6_OFFSET UNITYSDK_OFFSET(0xA410650)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_7_OFFSET UNITYSDK_OFFSET(0xA410680)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_8_OFFSET UNITYSDK_OFFSET(0x9A0CF60)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__4_9_OFFSET UNITYSDK_OFFSET(0x9A0D080)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__SETACCESSINFO_B__24_0_OFFSET UNITYSDK_OFFSET(0xA410AC0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER__UPDATEDETAIL_B__22_0_OFFSET UNITYSDK_OFFSET(0xA4109B0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA410B60)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA410BD0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xA410C40)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA410CB0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA410CE0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA410CF0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA410D00)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA410D10)

namespace MoleMole
{
	inline static constexpr unsigned int UIMailDialogPopWindowController_TypeDefinitionIndex = 69846;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_0A0B50D6899733CD*>* _cacheMails; // 0x310
		::Class_1_0A0B50D6899733CD* _currentMail; // 0x318
