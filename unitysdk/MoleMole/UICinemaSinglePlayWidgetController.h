...
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_CHANGEFEVERUICOLOR_OFFSET UNITYSDK_OFFSET(0xA8E9A70)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_CHECKLOCATIONMISSCLICKABLE_OFFSET UNITYSDK_OFFSET(0xA8E7FD0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_DESTORYEFFECTENTITY_OFFSET UNITYSDK_OFFSET(0xA8DF900)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_DESTROYMATERIALS_OFFSET UNITYSDK_OFFSET(0xA8E04B0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_DISPATCHGRAPHEVENT_OFFSET UNITYSDK_OFFSET(0xA8E7EB0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ENDFEVEREFFECT_OFFSET UNITYSDK_OFFSET(0xA8DF170)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ENDSUPERBUBBLEEFFECT_OFFSET UNITYSDK_OFFSET(0xA8DF790)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ENSUREINPUTACTIONISDOWN_OFFSET UNITYSDK_OFFSET(0xA8E1B60)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GENERATEBADBUBBLECONTEXT_OFFSET UNITYSDK_OFFSET(0xA8E5060)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GENERATEGOODBUBBLECONTEXT_OFFSET UNITYSDK_OFFSET(0xA8E4CA0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETCOMBOIMGBYINT_OFFSET UNITYSDK_OFFSET(0xA8E9240)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETENTITYEFFECTBYTYPE_OFFSET UNITYSDK_OFFSET(0xA8E0820)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETLOCATIONVIEWBYLOCATION_OFFSET UNITYSDK_OFFSET(0xA8E5590)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETMULTICLICKBUBBLEWIDGETBYSIDE_OFFSET UNITYSDK_OFFSET(0xA8E62C0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETNORMALBUBBLEWIDGETBYSIDE_OFFSET UNITYSDK_OFFSET(0xA8E57D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0xA8E3190)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GET_ISTICKING_OFFSET UNITYSDK_OFFSET(0xA8DFB50)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GET_MAINCAM_OFFSET UNITYSDK_OFFSET(0xA8DFAC0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_HIDEFEVERUI_OFFSET UNITYSDK_OFFSET(0xA8E99B0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_INITBACKGROUNDBTNGROUP_OFFSET UNITYSDK_OFFSET(0xA8E12A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_INITSCREENEFFECTPARAMS_OFFSET UNITYSDK_OFFSET(0xA8DEDF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_INITTUTORIALLIST_OFFSET UNITYSDK_OFFSET(0xA8E13F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_INITUIMATERIALPARAMS_OFFSET UNITYSDK_OFFSET(0xA8DFBF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA8E1570)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA8E1710)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA8E1610)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA8E0F70)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA8E1150)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PAUSEALLEVENT_OFFSET UNITYSDK_OFFSET(0xA8E2180)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYCOMBOINCREASEANIM_OFFSET UNITYSDK_OFFSET(0xA8E8C50)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYFEVERSTARTEFFECT_OFFSET UNITYSDK_OFFSET(0xA8DF0C0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYFEVERWIDGETFADEANIM_OFFSET UNITYSDK_OFFSET(0xA8E9710)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYFEVERWIDGETFEVERANIM_OFFSET UNITYSDK_OFFSET(0xA8E97F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYSUPERBUBBLESTARTEFFECT_OFFSET UNITYSDK_OFFSET(0xA8DF490)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYTIMEBARFEVERANIM_OFFSET UNITYSDK_OFFSET(0xA8E98D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_REFRESHCOMBO_OFFSET UNITYSDK_OFFSET(0xA8E8AF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETALLBUBBLE_OFFSET UNITYSDK_OFFSET(0xA8E3DB0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETBUBBLEDIC_OFFSET UNITYSDK_OFFSET(0xA8E4570)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETDATAWHENRESTART_OFFSET UNITYSDK_OFFSET(0xA8E3200)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETFEVERAPPEARPARAMSWHENRESTART_OFFSET UNITYSDK_OFFSET(0xA8E3430)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETLOCATIONCLICKABLEDIC_OFFSET UNITYSDK_OFFSET(0xA8E37A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETSOSETTING_OFFSET UNITYSDK_OFFSET(0xA8E3620)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETTIMEBARUI_OFFSET UNITYSDK_OFFSET(0xA8E4BF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETTIMEUI_OFFSET UNITYSDK_OFFSET(0xA8E3BA0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETUI_OFFSET UNITYSDK_OFFSET(0xA8E3B30)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESUMEALLEVENT_OFFSET UNITYSDK_OFFSET(0xA8E2370)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SETNEWSCORE_OFFSET UNITYSDK_OFFSET(0xA8E8700)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SETTIMEPROGRESS_OFFSET UNITYSDK_OFFSET(0xA8E2E60)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWBADBUBBLE_1_OFFSET UNITYSDK_OFFSET(0xA8E6760)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWBADBUBBLE_OFFSET UNITYSDK_OFFSET(0xA8E66A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCLEARALLBUBBLE_1_OFFSET UNITYSDK_OFFSET(0xA8E7580)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCLEARALLBUBBLE_OFFSET UNITYSDK_OFFSET(0xA8E74C0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCOMBOATLOCATION_OFFSET UNITYSDK_OFFSET(0xA8E7BF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCOMBOUI_INNER_OFFSET UNITYSDK_OFFSET(0xA8E7C80)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWENTEREFFECT_OFFSET UNITYSDK_OFFSET(0xA8E08D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWFEVEREFFECT_OFFSET UNITYSDK_OFFSET(0xA8DF2E0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWFEVERTIPSDIALOG_OFFSET UNITYSDK_OFFSET(0xA8DEFD0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWFEVERUI_OFFSET UNITYSDK_OFFSET(0xA8E95A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWMULTICLICKBUBBLE_1_OFFSET UNITYSDK_OFFSET(0xA8E5FA0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWMULTICLICKBUBBLE_OFFSET UNITYSDK_OFFSET(0xA8E5ED0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWNORMALBUBBLE_1_OFFSET UNITYSDK_OFFSET(0xA8E5280)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWNORMALBUBBLE_OFFSET UNITYSDK_OFFSET(0xA8E51C0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWPLAYEREFFECT_OFFSET UNITYSDK_OFFSET(0xA8E0770)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSCOREATLOCATION_OFFSET UNITYSDK_OFFSET(0xA8E7AD0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSUPERBUBBLEEFFECT_OFFSET UNITYSDK_OFFSET(0xA8DF5E0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSUPERBUBBLE_1_OFFSET UNITYSDK_OFFSET(0xA8E6DD0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSUPERBUBBLE_OFFSET UNITYSDK_OFFSET(0xA8E6D20)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_STARTFEVERAPPEARUPDATE_OFFSET UNITYSDK_OFFSET(0xA8E83D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_STARTFEVERAPPEAR_OFFSET UNITYSDK_OFFSET(0xA8E9440)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_STARTFEVERUPDATE_OFFSET UNITYSDK_OFFSET(0xA8E8310)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SWITCHGOODBUBBLESOUNDSTATE_OFFSET UNITYSDK_OFFSET(0xA8E4E10)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SWITCHLOCATIONMISSCLICKABLE_OFFSET UNITYSDK_OFFSET(0xA8E8150)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SWITCHUISHOW_OFFSET UNITYSDK_OFFSET(0xA8E3950)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRIGGERAVATARANIMFINISH_OFFSET UNITYSDK_OFFSET(0xA8E3580)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRIGGERFEVEREND_OFFSET UNITYSDK_OFFSET(0xA8E34D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRYTRIGGERAVATARANIMCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0xA8E9BE0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRYTRIGGERLOGICEVENTWITHLOCATION_OFFSET UNITYSDK_OFFSET(0xA8E1950)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRYUPDATETIMELINEMANAGER_OFFSET UNITYSDK_OFFSET(0xA8E20A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEAVATARANIM_OFFSET UNITYSDK_OFFSET(0xA8E2680)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEBUBBLEDICT_OFFSET UNITYSDK_OFFSET(0xA8E5CA0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEBUBBLES_OFFSET UNITYSDK_OFFSET(0xA8E27A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATECOMBOCOUNT_OFFSET UNITYSDK_OFFSET(0xA8E8BC0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATECOMBOMULTIPLIER_OFFSET UNITYSDK_OFFSET(0xA8E8D50)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEEVENTANIM_OFFSET UNITYSDK_OFFSET(0xA8E2560)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEFEVERAPPEAR_OFFSET UNITYSDK_OFFSET(0xA8E2D60)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEFEVER_OFFSET UNITYSDK_OFFSET(0xA8E2C10)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATESCORE_OFFSET UNITYSDK_OFFSET(0xA8E8520)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATESCREENEFFECT_OFFSET UNITYSDK_OFFSET(0xA8DFB60)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATETIMEBAR_OFFSET UNITYSDK_OFFSET(0xA8E25F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA8E1D50)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_WAITUNTILTIMECURSOR_OFFSET UNITYSDK_OFFSET(0xA8DF9D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__CHANGEFEVERUICOLOR_B__123_0_OFFSET UNITYSDK_OFFSET(0xA8EA120)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__CHANGEFEVERUICOLOR_B__123_1_OFFSET UNITYSDK_OFFSET(0xA8EA190)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA8E9C90)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__HIDEFEVERUI_B__122_0_OFFSET UNITYSDK_OFFSET(0xA8EA110)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__SHOWPLAYEREFFECT_B__36_0_OFFSET UNITYSDK_OFFSET(0xA8EA050)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__STARTFEVERAPPEAR_B__117_0_OFFSET UNITYSDK_OFFSET(0xA8EA0F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__STARTFEVERAPPEAR_B__117_1_OFFSET UNITYSDK_OFFSET(0xA8EA100)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA8EA200)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA8EA270)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA8EA2A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA8EA320)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA8EA380)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSinglePlayWidgetController_TypeDefinitionIndex = 64967;

	class UICinemaSinglePlayWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		// static const ::System::String* _SCORE_DEFAULT_EMPTY_MATERIAL_PATH; // 0x0
		// static const ::System::String* _SCORE_LEVEL_X_MATERIAL_PATH; // 0x0
		// static const ::System::String* _SCORE_LEVEL_B_MATERIAL_PATH; // 0x0
		// static const ::System::String* _SCORE_LEVEL_A_MATERIAL_PATH; // 0x0
		// static const ::System::String* _SCORE_LEVEL_S_MATERIAL_PATH; // 0x0
		// static const ::System::String* _SCORE_LEVEL_SPLUS_MATERIAL_PATH; // 0x0
		// static const ::System::String* _COMBO_NORMAL_MATERIAL_PATH; // 0x0
		// static const ::System::String* _COMBO_COMBO_MATERIAL_PATH; // 0x0
		// static const ::System::String* _COMBO_FEVER_MATERIAL_PATH; // 0x0
		// static const ::System::String* _COMBO_ANIM_NAME; // 0x0
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_0_16E4307DCC419505_236*>* _displayBubbleDic; // 0x408
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _locationEmptyClickableDic; // 0x410
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_236*>* _toBeRemovedList; // 0x418
		...
		::System::Void ShowNormalBubble(::Class_2_3F802DF1B3FAD67A_4* bubbleEvent, ::System::String* textmapText, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>* onClick)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A_4*, ::System::String*, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWNORMALBUBBLE_OFFSET))(this, bubbleEvent, textmapText, onClick);
		}

		::System::Void ShowNormalBubble_1(::Class_2_3F802DF1B3FAD67A_4* bubbleEvent, ::System::String* textmapText, ::System::Int32 bubbleLocation, ::System::Single timeDuration, ::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem item, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>* onClick)
		{
		...
		::Class_0_16E4307DCC419505_236* GetNormalBubbleWidgetBySide(::System::Boolean isRightSide, ::UnityEngine::Transform* parentLocation, ::MoleMole::UICinemaBubbleBaseContext* context)
		{
			return ((::Class_0_16E4307DCC419505_236*(*)(::PVOID, ::System::Boolean, ::UnityEngine::Transform*, ::MoleMole::UICinemaBubbleBaseContext*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETNORMALBUBBLEWIDGETBYSIDE_OFFSET))(this, isRightSide, parentLocation, context);
		}
		...
		::Class_0_16E4307DCC419505_236* GetMultiClickBubbleWidgetBySide(::System::Boolean isRightSide, ::UnityEngine::Transform* parentLocation, ::MoleMole::UICinemaBubbleBaseContext* context)
		{
			return ((::Class_0_16E4307DCC419505_236*(*)(::PVOID, ::System::Boolean, ::UnityEngine::Transform*, ::MoleMole::UICinemaBubbleBaseContext*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETMULTICLICKBUBBLEWIDGETBYSIDE_OFFSET))(this, isRightSide, parentLocation, context);
		}

		::System::Void ShowBadBubble(::Class_2_3F802DF1B3FAD67A* bubbleEvent, ::System::String* textmapText, ::System::Func_1<::System::Int32>* onClick)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A*, ::System::String*, ::System::Func_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWBADBUBBLE_OFFSET))(this, bubbleEvent, textmapText, onClick);
		}

		::System::Void ShowBadBubble_1(::Class_2_3F802DF1B3FAD67A* bubbleEvent, ::System::String* textmapText, ::System::Int32 bubbleLocation, ::System::Single timeDuration, ::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem item, ::System::Func_1<::System::Int32>* onClick)
		{
		...
		::System::Void UpdateBubbleDict(::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem item, ::System::Int32 location, ::System::Boolean willShow, ::Class_0_16E4307DCC419505_236* bubble)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem, ::System::Int32, ::System::Boolean, ::Class_0_16E4307DCC419505_236*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEBUBBLEDICT_OFFSET))(this, item, location, willShow, bubble);
		}
