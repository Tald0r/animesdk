...
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_CHANGEFEVERUICOLOR_OFFSET UNITYSDK_OFFSET(0xA9136D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_CHECKLOCATIONMISSCLICKABLE_OFFSET UNITYSDK_OFFSET(0xA911C40)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_DESTORYEFFECTENTITY_OFFSET UNITYSDK_OFFSET(0xA909580)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_DESTROYMATERIALS_OFFSET UNITYSDK_OFFSET(0xA90A130)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_DISPATCHGRAPHEVENT_OFFSET UNITYSDK_OFFSET(0xA911B20)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ENDFEVEREFFECT_OFFSET UNITYSDK_OFFSET(0xA908DF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ENDSUPERBUBBLEEFFECT_OFFSET UNITYSDK_OFFSET(0xA909410)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ENSUREINPUTACTIONISDOWN_OFFSET UNITYSDK_OFFSET(0xA90B7E0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GENERATEBADBUBBLECONTEXT_OFFSET UNITYSDK_OFFSET(0xA90ECF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GENERATEGOODBUBBLECONTEXT_OFFSET UNITYSDK_OFFSET(0xA90E930)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETCOMBOIMGBYINT_OFFSET UNITYSDK_OFFSET(0xA912EA0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETENTITYEFFECTBYTYPE_OFFSET UNITYSDK_OFFSET(0xA90A4A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETLOCATIONVIEWBYLOCATION_OFFSET UNITYSDK_OFFSET(0xA90F220)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETMULTICLICKBUBBLEWIDGETBYSIDE_OFFSET UNITYSDK_OFFSET(0xA90FF50)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETNORMALBUBBLEWIDGETBYSIDE_OFFSET UNITYSDK_OFFSET(0xA90F460)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0xA90CE10)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GET_ISTICKING_OFFSET UNITYSDK_OFFSET(0xA9097D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GET_MAINCAM_OFFSET UNITYSDK_OFFSET(0xA909740)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_HIDEFEVERUI_OFFSET UNITYSDK_OFFSET(0xA913610)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_INITBACKGROUNDBTNGROUP_OFFSET UNITYSDK_OFFSET(0xA90AF20)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_INITSCREENEFFECTPARAMS_OFFSET UNITYSDK_OFFSET(0xA908A70)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_INITTUTORIALLIST_OFFSET UNITYSDK_OFFSET(0xA90B070)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_INITUIMATERIALPARAMS_OFFSET UNITYSDK_OFFSET(0xA909870)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA90B1F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA90B390)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA90B290)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA90ABF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA90ADD0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PAUSEALLEVENT_OFFSET UNITYSDK_OFFSET(0xA90BE00)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYCOMBOINCREASEANIM_OFFSET UNITYSDK_OFFSET(0xA9128C0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYFEVERSTARTEFFECT_OFFSET UNITYSDK_OFFSET(0xA908D30)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYFEVERWIDGETFADEANIM_OFFSET UNITYSDK_OFFSET(0xA913370)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYFEVERWIDGETFEVERANIM_OFFSET UNITYSDK_OFFSET(0xA913450)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYSUPERBUBBLESTARTEFFECT_OFFSET UNITYSDK_OFFSET(0xA909110)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_PLAYTIMEBARFEVERANIM_OFFSET UNITYSDK_OFFSET(0xA913530)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_REFRESHCOMBO_OFFSET UNITYSDK_OFFSET(0xA912760)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETALLBUBBLE_OFFSET UNITYSDK_OFFSET(0xA90DA30)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETBUBBLEDIC_OFFSET UNITYSDK_OFFSET(0xA90E200)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETDATAWHENRESTART_OFFSET UNITYSDK_OFFSET(0xA90CE80)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETFEVERAPPEARPARAMSWHENRESTART_OFFSET UNITYSDK_OFFSET(0xA90D0B0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETLOCATIONCLICKABLEDIC_OFFSET UNITYSDK_OFFSET(0xA90D420)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETSOSETTING_OFFSET UNITYSDK_OFFSET(0xA90D2A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETTIMEBARUI_OFFSET UNITYSDK_OFFSET(0xA90E880)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETTIMEUI_OFFSET UNITYSDK_OFFSET(0xA90D820)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESETUI_OFFSET UNITYSDK_OFFSET(0xA90D7B0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_RESUMEALLEVENT_OFFSET UNITYSDK_OFFSET(0xA90BFF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SETNEWSCORE_OFFSET UNITYSDK_OFFSET(0xA912370)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SETTIMEPROGRESS_OFFSET UNITYSDK_OFFSET(0xA90CAE0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWBADBUBBLE_1_OFFSET UNITYSDK_OFFSET(0xA9103F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWBADBUBBLE_OFFSET UNITYSDK_OFFSET(0xA910330)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCLEARALLBUBBLE_1_OFFSET UNITYSDK_OFFSET(0xA9111F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCLEARALLBUBBLE_OFFSET UNITYSDK_OFFSET(0xA911130)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCOMBOATLOCATION_OFFSET UNITYSDK_OFFSET(0xA911860)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCOMBOUI_INNER_OFFSET UNITYSDK_OFFSET(0xA9118F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWENTEREFFECT_OFFSET UNITYSDK_OFFSET(0xA90A550)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWFEVEREFFECT_OFFSET UNITYSDK_OFFSET(0xA908F60)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWFEVERTIPSDIALOG_OFFSET UNITYSDK_OFFSET(0xA908C40)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWFEVERUI_OFFSET UNITYSDK_OFFSET(0xA913200)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWMULTICLICKBUBBLE_1_OFFSET UNITYSDK_OFFSET(0xA90FC30)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWMULTICLICKBUBBLE_OFFSET UNITYSDK_OFFSET(0xA90FB60)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWNORMALBUBBLE_1_OFFSET UNITYSDK_OFFSET(0xA90EF10)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWNORMALBUBBLE_OFFSET UNITYSDK_OFFSET(0xA90EE50)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWPLAYEREFFECT_OFFSET UNITYSDK_OFFSET(0xA90A3F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSCOREATLOCATION_OFFSET UNITYSDK_OFFSET(0xA911740)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSUPERBUBBLEEFFECT_OFFSET UNITYSDK_OFFSET(0xA909260)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSUPERBUBBLE_1_OFFSET UNITYSDK_OFFSET(0xA910A50)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSUPERBUBBLE_OFFSET UNITYSDK_OFFSET(0xA9109A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_STARTFEVERAPPEARUPDATE_OFFSET UNITYSDK_OFFSET(0xA912040)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_STARTFEVERAPPEAR_OFFSET UNITYSDK_OFFSET(0xA9130A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_STARTFEVERUPDATE_OFFSET UNITYSDK_OFFSET(0xA911F80)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SWITCHGOODBUBBLESOUNDSTATE_OFFSET UNITYSDK_OFFSET(0xA90EAA0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SWITCHLOCATIONMISSCLICKABLE_OFFSET UNITYSDK_OFFSET(0xA911DC0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SWITCHUISHOW_OFFSET UNITYSDK_OFFSET(0xA90D5D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRIGGERAVATARANIMFINISH_OFFSET UNITYSDK_OFFSET(0xA90D200)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRIGGERFEVEREND_OFFSET UNITYSDK_OFFSET(0xA90D150)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRYTRIGGERAVATARANIMCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0xA913840)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRYTRIGGERLOGICEVENTWITHLOCATION_OFFSET UNITYSDK_OFFSET(0xA90B5D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_TRYUPDATETIMELINEMANAGER_OFFSET UNITYSDK_OFFSET(0xA90BD20)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEAVATARANIM_OFFSET UNITYSDK_OFFSET(0xA90C300)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEBUBBLEDICT_OFFSET UNITYSDK_OFFSET(0xA90F930)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEBUBBLES_OFFSET UNITYSDK_OFFSET(0xA90C420)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATECOMBOCOUNT_OFFSET UNITYSDK_OFFSET(0xA912830)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATECOMBOMULTIPLIER_OFFSET UNITYSDK_OFFSET(0xA9129C0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEEVENTANIM_OFFSET UNITYSDK_OFFSET(0xA90C1E0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEFEVERAPPEAR_OFFSET UNITYSDK_OFFSET(0xA90C9E0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEFEVER_OFFSET UNITYSDK_OFFSET(0xA90C890)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATESCORE_OFFSET UNITYSDK_OFFSET(0xA912190)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATESCREENEFFECT_OFFSET UNITYSDK_OFFSET(0xA9097E0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATETIMEBAR_OFFSET UNITYSDK_OFFSET(0xA90C270)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA90B9D0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_WAITUNTILTIMECURSOR_OFFSET UNITYSDK_OFFSET(0xA909650)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__CHANGEFEVERUICOLOR_B__123_0_OFFSET UNITYSDK_OFFSET(0xA913D80)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__CHANGEFEVERUICOLOR_B__123_1_OFFSET UNITYSDK_OFFSET(0xA913DF0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9138F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__HIDEFEVERUI_B__122_0_OFFSET UNITYSDK_OFFSET(0xA913D70)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__SHOWPLAYEREFFECT_B__36_0_OFFSET UNITYSDK_OFFSET(0xA913CB0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__STARTFEVERAPPEAR_B__117_0_OFFSET UNITYSDK_OFFSET(0xA913D50)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__STARTFEVERAPPEAR_B__117_1_OFFSET UNITYSDK_OFFSET(0xA913D60)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA913E60)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA913ED0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA913F00)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA913F80)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA913FE0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSinglePlayWidgetController_TypeDefinitionIndex = 38047;

	class UICinemaSinglePlayWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Threading::CancellationTokenSource* m_originalSource; // 0x2A0
		::UnityEngine::Material* _currLevelMaterial; // 0x2A8
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::Material*>* materialDic; // 0x2B0
		::System::Collections::Generic::Dictionary_2<::MoleMole::UICinemaSinglePlayWidgetController_ComboStateEnum, ::UnityEngine::Material*>* comboMaterialDic; // 0x2B8
		::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>* handlers; // 0x2C0
		::MoleMole::UICinemaFeverTipsWidgetController* m_feverTipsDialog; // 0x2C8
		::System::Single m_curTimeCursor; // 0x2D0
		::System::Boolean m_isTicking; // 0x2D4
		::MoleMole::Battle::Entity* PlayerEffectEntity; // 0x2D8
		::MoleMole::Battle::Entity* EnterEffectEntity; // 0x2E0
		::Class_2_7341BF3E408F4DA8* _view; // 0x2E8
		::Class_2_0E3D561C72111316* _playController; // 0x2F0
		::Class_2_7341BF3E408F4DA8_Class_2_32FA89503EEFC4EE* _scoreWidgetView; // 0x2F8
		::Class_2_7341BF3E408F4DA8_Class_2_9CB8F5C48DA81A47* _bubbleWidgetView; // 0x300
		::Class_2_7341BF3E408F4DA8_Class_2_7205AB2C0A9DC1BA* _timeWidgetView; // 0x308
		::MoleMole::UICinemaSingleSuperBubbleWidgetController* _superBubble; // 0x310
		::MoleMole::UICinemaSinglePlayWidgetController_ComboShowState m_comboShowState; // 0x318
		::System::String* m_comboFadeout; // 0x320
		::System::String* m_comboFadein; // 0x328
		::System::String* animComboNumChange; // 0x330
		::System::String* animGetScoreFadein; // 0x338
		::System::String* comboImg; // 0x340
		::System::Int32 _currScore; // 0x348
		::Enum_3_E2714210413A69CA _currLevel; // 0x34C
		::System::Int32 _comboCount; // 0x350
		::System::Single _comboMultiplier; // 0x354
		::UnityEngine::Material* _comboMaterial; // 0x358
		::System::Boolean _isTimeUIInited; // 0x360
		::UnityEngine::RectTransform* timerFillProgressRect; // 0x368
		::System::Single currPassedTime; // 0x370
		::System::Single totalLevelTime; // 0x374
		::System::Single _maxTimerProgressValue; // 0x378
		::System::Boolean isInFeverAppear; // 0x37C
		::System::Single currFeverAppearPassedTime; // 0x380
		::System::Single totalFeverAppearTime; // 0x384
		::System::Single totalToFeverTime; // 0x388
		::System::Action* _onFeverStartWhenAppear; // 0x390
		::System::Action* _onFeverAppearEnd; // 0x398
		::System::Single currFeverPassedTime; // 0x3A0
		::System::Single totalFeverTime; // 0x3A4
		::System::String* feverStartEventStr; // 0x3A8
		::System::String* feverEndEventStr; // 0x3B0
		::System::Action* _onFeverEnd; // 0x3B8
		::System::Boolean isSwitchingPose; // 0x3C0
		::System::Single currAnimSwitchPassedTime; // 0x3C4
		::System::Single totalAnimSwitchTime; // 0x3C8
		::System::Action* _onPoseSwitchEnd; // 0x3D0
		::System::Collections::Generic::List_1<::MoleMole::UICinemaPlayBubble01WidgetController*>* normalBubbleList; // 0x3D8
		::System::Collections::Generic::List_1<::MoleMole::UICinemaPlayBubble01RightWidgetController*>* normalBubbleRightList; // 0x3E0
		::System::Collections::Generic::List_1<::MoleMole::UICinemaSingleMultiClickBubbleWidgetController*>* multiClickBubbleList; // 0x3E8
		::System::Collections::Generic::List_1<::MoleMole::UICinemaSingleMultiClickBubbleRightWidgetController*>* multiClickRightBubbleList; // 0x3F0
		::System::Collections::Generic::List_1<::MoleMole::UICinemaSingleBadBubbleWidgetController*>* badBubbleList; // 0x3F8
		::System::Collections::Generic::List_1<::MoleMole::UICinemaSingleClearAllBubbleWidgetController*>* clearAllBubbleList; // 0x400
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_0_16E4307DCC419505_153*>* _displayBubbleDic; // 0x408
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _locationEmptyClickableDic; // 0x410
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_153*>* _toBeRemovedList; // 0x418
		::System::Single _protectTimeAfterBubbleDisappear; // 0x420
		::System::Single _protectTimeAfterClickMiss; // 0x424
		...
		::Class_0_16E4307DCC419505_153* GetNormalBubbleWidgetBySide(::System::Boolean isRightSide, ::UnityEngine::Transform* parentLocation, ::MoleMole::UICinemaBubbleBaseContext* context)
		{
			return ((::Class_0_16E4307DCC419505_153*(*)(::PVOID, ::System::Boolean, ::UnityEngine::Transform*, ::MoleMole::UICinemaBubbleBaseContext*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETNORMALBUBBLEWIDGETBYSIDE_OFFSET))(this, isRightSide, parentLocation, context);
		}
		...
		::Class_0_16E4307DCC419505_153* GetMultiClickBubbleWidgetBySide(::System::Boolean isRightSide, ::UnityEngine::Transform* parentLocation, ::MoleMole::UICinemaBubbleBaseContext* context)
		{
			return ((::Class_0_16E4307DCC419505_153*(*)(::PVOID, ::System::Boolean, ::UnityEngine::Transform*, ::MoleMole::UICinemaBubbleBaseContext*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_GETMULTICLICKBUBBLEWIDGETBYSIDE_OFFSET))(this, isRightSide, parentLocation, context);
		}

		::System::Void ShowBadBubble(::Class_2_3F802DF1B3FAD67A_2* bubbleEvent, ::System::String* textmapText, ::System::Func_1<::System::Int32>* onClick)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A_2*, ::System::String*, ::System::Func_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWBADBUBBLE_OFFSET))(this, bubbleEvent, textmapText, onClick);
		}

		::System::Void ShowBadBubble_1(::Class_2_3F802DF1B3FAD67A_2* bubbleEvent, ::System::String* textmapText, ::System::Int32 bubbleLocation, ::System::Single timeDuration, ::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem item, ::System::Func_1<::System::Int32>* onClick)
		{
		...
		::System::Void ShowSuperBubble(::Class_2_3F802DF1B3FAD67A_3* bubbleEvent, ::System::String* textmapText, ::System::Int32 hitNum, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>* onClick)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A_3*, ::System::String*, ::System::Int32, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSUPERBUBBLE_OFFSET))(this, bubbleEvent, textmapText, hitNum, onClick);
		}

		::System::Void ShowSuperBubble_1(::Class_2_3F802DF1B3FAD67A_3* bubbleEvent, ::System::String* textmapText, ::System::Int32 hitNum, ::System::Single timeDuration, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>* onClick)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A_3*, ::System::String*, ::System::Int32, ::System::Single, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWSUPERBUBBLE_1_OFFSET))(this, bubbleEvent, textmapText, hitNum, timeDuration, onClick);
		}

		::System::Void ShowClearAllBubble(::Class_2_3F802DF1B3FAD67A_4* bubbleEvent, ::System::String* textmapText, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>* onClick)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A_4*, ::System::String*, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_SHOWCLEARALLBUBBLE_OFFSET))(this, bubbleEvent, textmapText, onClick);
		}

		::System::Void ShowClearAllBubble_1(::Class_2_3F802DF1B3FAD67A_4* bubbleEvent, ::System::String* textmapText, ::System::Int32 bubbleLocation, ::System::Single timeDuration, ::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem item, ::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>* onClick)
		{
		...
		::System::Void UpdateBubbleDict(::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem item, ::System::Int32 location, ::System::Boolean willShow, ::Class_0_16E4307DCC419505_153* bubble)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::CinemaSingleBeatMapConfig_BeatMap_BeatItem, ::System::Int32, ::System::Boolean, ::Class_0_16E4307DCC419505_153*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_UPDATEBUBBLEDICT_OFFSET))(this, item, location, willShow, bubble);
		}
		...
		::System::Void StartFeverUpdate(::Class_2_3F802DF1B3FAD67A_5* feverEvent, ::System::Action* onFeverEnd)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_3F802DF1B3FAD67A_5*, ::System::Action*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER_STARTFEVERUPDATE_OFFSET))(this, feverEvent, onFeverEnd);
		}
