...
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xAE59A50)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE596D0)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_ONSETTINGONUIDISABLESTATECHANGED_OFFSET UNITYSDK_OFFSET(0xAE5AF70)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_ONSLIDERVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xAE5AB80)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE59E80)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE59770)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_OVERRIDESOUNDCONFIG_OFFSET UNITYSDK_OFFSET(0xAE5A840)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_REFRESHNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0xAE59F60)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_REFRESHSETTINGONUIDISABLESTATE_OFFSET UNITYSDK_OFFSET(0xAE5A620)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAE5A0F0)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE5B040)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0xAE5B070)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE5B0E0)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE5B150)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE5B1D0)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingNumberWidgetController_TypeDefinitionIndex = 46905;
