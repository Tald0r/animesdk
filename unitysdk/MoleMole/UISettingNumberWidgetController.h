...
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xD29BC70)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD29B8F0)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_ONSETTINGONUIDISABLESTATECHANGED_OFFSET UNITYSDK_OFFSET(0xD29D1A0)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_ONSLIDERVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xD29CDB0)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD29C0B0)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD29B990)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_OVERRIDESOUNDCONFIG_OFFSET UNITYSDK_OFFSET(0xD29CA70)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_REFRESHNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0xD29C190)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_REFRESHSETTINGONUIDISABLESTATE_OFFSET UNITYSDK_OFFSET(0xD29C850)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD29C320)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD29D270)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0xD29D2A0)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD29D310)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD29D380)
#define MOLEMOLE_UISETTINGNUMBERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD29D400)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingNumberWidgetController_TypeDefinitionIndex = 37782;

	class UISettingNumberWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_76BDA31962EF0DA3* _view; // 0x2A0
		::System::Boolean _isSettingOnUIDisable; // 0x2A8
		::Enum_3_62971080CDAAC791 _UISettingNumberType; // 0x2AC
		::Enum_3_543B6B88E17BAFE0 _settingContentType; // 0x2B0
		::MoleMole::ESystemSettingType _settingType; // 0x2B4
		::System::Single _minValue; // 0x2B8
		::System::Single _maxValue; // 0x2BC
		::System::Int32 _hintVersion; // 0x2C0
