...
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE9423F0)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER_ONGAMEPADDESELECT_OFFSET UNITYSDK_OFFSET(0xB2734D0)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER_ONGAMEPADSELECT_OFFSET UNITYSDK_OFFSET(0xB273440)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xB2732B0)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER_ONMOVESELECT_OFFSET UNITYSDK_OFFSET(0xB2733B0)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xE942540)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0xE942490)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xE942030)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE9420A0)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE941F80)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER_SETCURSESTATE_OFFSET UNITYSDK_OFFSET(0xE9430D0)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER_SETEFFECT_OFFSET UNITYSDK_OFFSET(0xE9434C0)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB273560)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER__ONSCROLLITEMUPDATE_B__5_0_OFFSET UNITYSDK_OFFSET(0xB273570)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB273580)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xB2735F0)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB273660)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB2736E0)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2736F0)
#define MOLEMOLE_UIBADGEITEMICONHOLLOWWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB273770)

namespace MoleMole
{
	inline static constexpr unsigned int UIBadgeItemIconHollowWidgetChildWindowController_TypeDefinitionIndex = 73662;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_76* _view; // 0x2F0
