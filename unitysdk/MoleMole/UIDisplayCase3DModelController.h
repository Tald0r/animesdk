...
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_CANMOVECAMERA_OFFSET UNITYSDK_OFFSET(0x8BEF230)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_CANROTATECAM_OFFSET UNITYSDK_OFFSET(0x8BEF840)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x8BED680)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_GETMOVEDELTA_OFFSET UNITYSDK_OFFSET(0x8BEEF80)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_GET_CASEFWD_OFFSET UNITYSDK_OFFSET(0x8BECB80)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_GET_CASERIGHT_OFFSET UNITYSDK_OFFSET(0x8BECA30)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_GET_CASEUP_OFFSET UNITYSDK_OFFSET(0x8BEC8F0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_GET_PIVOTPOS_OFFSET UNITYSDK_OFFSET(0x8BEC7A0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0x8BEC8E0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_INITCAMPOS_OFFSET UNITYSDK_OFFSET(0x8BED7A0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_INITFROMCAMERACFG_OFFSET UNITYSDK_OFFSET(0x8BEE6A0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_INITMAINVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x8BECF00)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ISCAMERADIRTY_OFFSET UNITYSDK_OFFSET(0x8BEE970)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_MOVECAMERA_OFFSET UNITYSDK_OFFSET(0x8BEEDF0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BED3E0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BED480)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BECCC0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BED370)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_REPOSITIONCAMERA_OFFSET UNITYSDK_OFFSET(0x8BEEC70)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0x8BED5C0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ROTATECAMERA_OFFSET UNITYSDK_OFFSET(0x8BEF650)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_SETPIVOTPOS_OFFSET UNITYSDK_OFFSET(0x8BEF490)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER_ZOOMCAMERA_OFFSET UNITYSDK_OFFSET(0x8BEF8B0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8BEF960)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER__INITCAMPOS_B__31_0_OFFSET UNITYSDK_OFFSET(0x8BEF9F0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER__INITMAINVIRTUALCAMERA_B__26_0_OFFSET UNITYSDK_OFFSET(0x8BEF9D0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER___BASE_INITMAINVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x8BEFA10)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BEFA70)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BEFAE0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BEFAF0)
#define MOLEMOLE_UIDISPLAYCASE3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BEFB00)

namespace MoleMole
{
	inline static constexpr unsigned int UIDisplayCase3DModelController_TypeDefinitionIndex = 71592;
	...
	public:
		...
		::MoleMole::UIDisplayCase3DModelController_CameraCfg CameraData; // 0x340
		::Class_2_C74B331EF3E6062C* _view; // 0x428
		::Class_2_168CE6BD23375D6E* _model; // 0x430
		::UnityEngine::Vector3 originPos; // 0x438
		::UnityEngine::Vector3 originPivotPos; // 0x444
		::UnityEngine::Quaternion originRot; // 0x450
		::UnityEngine::Quaternion caseRot; // 0x460
		::Foundation::Unreal::FTransform attachPoint; // 0x470
		::UnityEngine::Transform* pivot; // 0x490
		::System::Single distance; // 0x498
		::UnityEngine::Bounds camBounds; // 0x49C
		::Cinemachine::CinemachineCollider* camCol; // 0x4B8
