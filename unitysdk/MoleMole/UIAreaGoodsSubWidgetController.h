...
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER_GETDESC_OFFSET UNITYSDK_OFFSET(0x8CDAD50)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER_INITINFO_OFFSET UNITYSDK_OFFSET(0x8CDB6B0)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER_ONCARDDESCBRIEFSWITCH_OFFSET UNITYSDK_OFFSET(0x8CDB880)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8CDB940)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8CD9080)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8CD91C0)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER_REFRESHCARDNUM_OFFSET UNITYSDK_OFFSET(0x8CD9C10)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER_REFRESHITEMCONTENT_OFFSET UNITYSDK_OFFSET(0x8CDB3C0)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0x8CDB250)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER_REFRESHSHOPDETAIL_OFFSET UNITYSDK_OFFSET(0x8CDA510)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER_REFRESHSHOPGOODSBG_OFFSET UNITYSDK_OFFSET(0x8CD93D0)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER_REFRESHSHOPGOODSVIEW_OFFSET UNITYSDK_OFFSET(0x8CD9300)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER_SETDESCSTATE_OFFSET UNITYSDK_OFFSET(0x8CDA490)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8CDB9D0)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER___BASE_ONCARDDESCBRIEFSWITCH_OFFSET UNITYSDK_OFFSET(0x8CDB9F0)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8CDBA60)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8CDBA70)
#define MOLEMOLE_UIAREAGOODSSUBWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8CDBA80)

namespace MoleMole
{
	inline static constexpr unsigned int UIAreaGoodsSubWidgetController_TypeDefinitionIndex = 52640;
