...
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_GET_ALLFINISHED_OFFSET UNITYSDK_OFFSET(0xB4F0270)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_ONBEFOREREWARDWINDOWCLOSE_OFFSET UNITYSDK_OFFSET(0xB4F20C0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB4EF3E0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0xB4F2220)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_ONREWARDWINDOWCLOSED_OFFSET UNITYSDK_OFFSET(0xB4F21B0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB4EFDC0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB4EF4C0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB4EF8B0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0xB4EF990)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_REFRESHDELIVERBTN_OFFSET UNITYSDK_OFFSET(0xB4F1470)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_REFRESHMATERIALPROGRESSVIEW_OFFSET UNITYSDK_OFFSET(0xB4F0F40)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_REFRESHMATERIALVIEW_OFFSET UNITYSDK_OFFSET(0xB4F05A0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0xB4F0AA0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB4EFE50)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_SETALLFINISHEDVIEW_OFFSET UNITYSDK_OFFSET(0xB4F02F0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0xB4F15E0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xB4EFCD0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_SHOWGETITEMLIST_OFFSET UNITYSDK_OFFSET(0xB4F1D50)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_SUBMITLANDITEMS_OFFSET UNITYSDK_OFFSET(0xB4F1A70)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB4F2530)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0xB4F25F0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER__REFRESHVIEW_B__27_0_OFFSET UNITYSDK_OFFSET(0xB4F2750)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER__SUBMITLANDITEMS_B__31_0_OFFSET UNITYSDK_OFFSET(0xB4F2A00)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB4F2A60)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB4F2AD0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB4F2AE0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB4F2AF0)
#define MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xB4F2B00)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityRevivalPageController_TypeDefinitionIndex = 71993;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_153* _view; // 0x308
		...
		::Class_3_D0B68EB9E337E202_1* _rewardedItems; // 0x350
		...
		::System::Void RefreshView(::Class_2_208CC9941471731A_968* landTemplate, ::System::Boolean init)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_968*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER_REFRESHVIEW_OFFSET))(this, landTemplate, init);
		}
		...
		::System::Void _SubmitLandItems_b__31_0(::Class_0_16E4307DCC419505_5* message)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYREVIVALPAGECONTROLLER__SUBMITLANDITEMS_B__31_0_OFFSET))(this, message);
		}
