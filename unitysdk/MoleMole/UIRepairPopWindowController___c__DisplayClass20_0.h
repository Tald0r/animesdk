...
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAE51BF0)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER___C__DISPLAYCLASS20_0__SHOWREPAIRSUCCESS_B__0_OFFSET UNITYSDK_OFFSET(0xAE51C00)

namespace MoleMole
{
	inline static constexpr unsigned int UIRepairPopWindowController___c__DisplayClass20_0_TypeDefinitionIndex = 72791;
