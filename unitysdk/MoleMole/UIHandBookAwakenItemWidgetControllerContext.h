...
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_JUMPID_OFFSET UNITYSDK_OFFSET(0xAD475E0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_NAME_OFFSET UNITYSDK_OFFSET(0xAD47540)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_PICINDEX_OFFSET UNITYSDK_OFFSET(0xAD47600)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_QUESTGROUPID_OFFSET UNITYSDK_OFFSET(0xAD475C0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_QUESTS_OFFSET UNITYSDK_OFFSET(0xAD47560)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_REFRESHREMAINTIME_OFFSET UNITYSDK_OFFSET(0xAD47580)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_GET_SHOWREFRESHREMAINTIME_OFFSET UNITYSDK_OFFSET(0xAD475A0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_JUMPID_OFFSET UNITYSDK_OFFSET(0xAD475F0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_NAME_OFFSET UNITYSDK_OFFSET(0xAD47550)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_PICINDEX_OFFSET UNITYSDK_OFFSET(0xAD47610)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_QUESTGROUPID_OFFSET UNITYSDK_OFFSET(0xAD475D0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_QUESTS_OFFSET UNITYSDK_OFFSET(0xAD47570)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_REFRESHREMAINTIME_OFFSET UNITYSDK_OFFSET(0xAD47590)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT_SET_SHOWREFRESHREMAINTIME_OFFSET UNITYSDK_OFFSET(0xAD475B0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAD47620)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookAwakenItemWidgetControllerContext_TypeDefinitionIndex = 54770;
