...
#define MOLEMOLE_TLSTARTENDENTITYANIMATORPARAMCONTROL_ISBLENDINVALID_OFFSET UNITYSDK_OFFSET(0x7F28C70)
#define MOLEMOLE_TLSTARTENDENTITYANIMATORPARAMCONTROL_ISBLENDOUTVALID_OFFSET UNITYSDK_OFFSET(0x7F28CF0)
#define MOLEMOLE_TLSTARTENDENTITYANIMATORPARAMCONTROL_ISENABLEANIMBLENDTARGETV2_OFFSET UNITYSDK_OFFSET(0x7F28D70)
#define MOLEMOLE_TLSTARTENDENTITYANIMATORPARAMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x7F28ED0)

namespace MoleMole
{
	inline static constexpr unsigned int TLStartEndEntityAnimatorParamControl_TypeDefinitionIndex = 37088;
