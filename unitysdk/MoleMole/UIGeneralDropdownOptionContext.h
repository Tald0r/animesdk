...
#define MOLEMOLE_UIGENERALDROPDOWNOPTIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8913670)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralDropdownOptionContext_TypeDefinitionIndex = 47937;

	class UIGeneralDropdownOptionContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_1_0EB9C77975304C39* loginParam; // 0x28
		::System::Action_1<::System::Int32>* onLockedClick; // 0x30
		::Struct_2_A47ACAABA9AAFE92 otherInfo; // 0x38
		::Foundation::AssetPath iconPath; // 0x50
		::System::String* descKey; // 0x60
		::Foundation::AssetPath redImagePath; // 0x68
		::System::String* desc; // 0x78
		::Enum_3_1920A05BA1489633 iconType; // 0x80
		::MoleMole::LanguageType languageType; // 0x84
		::System::Int32 index; // 0x88
		::System::Boolean isRed; // 0x8C
		::System::Boolean isNew; // 0x8D
