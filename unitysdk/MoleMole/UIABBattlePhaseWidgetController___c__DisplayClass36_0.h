...
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA9E00)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___C__DISPLAYCLASS36_0__ONCAMPCHANGE_B__1_OFFSET UNITYSDK_OFFSET(0x8FA9E10)

namespace MoleMole
{
	inline static constexpr unsigned int UIABBattlePhaseWidgetController___c__DisplayClass36_0_TypeDefinitionIndex = 68913;

	class UIABBattlePhaseWidgetController___c__DisplayClass36_0 : public ::System::Object
	{
	public:
		::System::Collections::Generic::IEnumerable_1<::Class_2_208CC9941471731A_717*>* curList; // 0x10
