...
#define MOLEMOLE_SUMMEREVENTSHOOTINGGAMEPLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8A8D830)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventShootingGamePlayConfig_TypeDefinitionIndex = 53134;
