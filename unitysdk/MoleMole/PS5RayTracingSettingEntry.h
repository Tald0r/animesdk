...
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY_GETDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0xC326920)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0xC326880)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xC326870)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY_GET__ISHIDEDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0xC326860)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY_ISDEFAULTENABLED_OFFSET UNITYSDK_OFFSET(0xC326A20)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xC326DC0)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY___BASE_GETDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0xC326E60)
#define MOLEMOLE_PS5RAYTRACINGSETTINGENTRY___BASE_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0xC326EC0)

namespace MoleMole
{
	inline static constexpr unsigned int PS5RayTracingSettingEntry_TypeDefinitionIndex = 49944;
