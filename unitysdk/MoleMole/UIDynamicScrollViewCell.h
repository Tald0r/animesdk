...
#define MOLEMOLE_UIDYNAMICSCROLLVIEWCELL_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xBF6F100)
#define MOLEMOLE_UIDYNAMICSCROLLVIEWCELL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF6F210)

namespace MoleMole
{
	inline static constexpr unsigned int UIDynamicScrollViewCell_TypeDefinitionIndex = 60381;
