...
#define MOLEMOLE_UIDYNAMICSCROLLVIEWCELL_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xB2A5C80)
#define MOLEMOLE_UIDYNAMICSCROLLVIEWCELL__CTOR_OFFSET UNITYSDK_OFFSET(0xB2A5D90)

namespace MoleMole
{
	inline static constexpr unsigned int UIDynamicScrollViewCell_TypeDefinitionIndex = 43638;
