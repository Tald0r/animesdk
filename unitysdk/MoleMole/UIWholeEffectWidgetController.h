...
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0x7546EA0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_CLEARCARDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x754A450)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_CREATESORT_OFFSET UNITYSDK_OFFSET(0x7548B90)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GETCHILDBOUNDS_OFFSET UNITYSDK_OFFSET(0x7548660)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x754A740)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GET_ISCARDFOLD_OFFSET UNITYSDK_OFFSET(0x754A620)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GET_ISCURSEFOLD_OFFSET UNITYSDK_OFFSET(0x754B0A0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GET_ISEFFECTFOLD_OFFSET UNITYSDK_OFFSET(0x754AF80)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_INITCARD_OFFSET UNITYSDK_OFFSET(0x7549960)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_INITCURSE_OFFSET UNITYSDK_OFFSET(0x7547480)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_INITFOLDBTNSTATE_OFFSET UNITYSDK_OFFSET(0x75473F0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_INITHEAT_OFFSET UNITYSDK_OFFSET(0x7547940)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x75484E0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONFILTERDROPCHANGE_OFFSET UNITYSDK_OFFSET(0x75496E0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7548580)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7546B90)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7546C30)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_SETFOLDSTATE_OFFSET UNITYSDK_OFFSET(0x754A9C0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__BIND_B__9_0_OFFSET UNITYSDK_OFFSET(0x754B470)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__BIND_B__9_1_OFFSET UNITYSDK_OFFSET(0x754B4A0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__BIND_B__9_2_OFFSET UNITYSDK_OFFSET(0x754B4D0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__CREATESORT_B__7_0_OFFSET UNITYSDK_OFFSET(0x754B3F0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x754B1C0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x754B500)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x754B570)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x754B5F0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x754B650)

namespace MoleMole
{
	inline static constexpr unsigned int UIWholeEffectWidgetController_TypeDefinitionIndex = 76768;

	class UIWholeEffectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_10* _view; // 0x2A0
