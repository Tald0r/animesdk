...
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0x9921CB0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_CLEARCARDCONTROLLERS_OFFSET UNITYSDK_OFFSET(0x9925260)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_CREATESORT_OFFSET UNITYSDK_OFFSET(0x9923990)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GETCHILDBOUNDS_OFFSET UNITYSDK_OFFSET(0x9923460)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9925550)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GET_ISCARDFOLD_OFFSET UNITYSDK_OFFSET(0x9925430)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GET_ISCURSEFOLD_OFFSET UNITYSDK_OFFSET(0x9925EC0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_GET_ISEFFECTFOLD_OFFSET UNITYSDK_OFFSET(0x9925DA0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_INITCARD_OFFSET UNITYSDK_OFFSET(0x9924760)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_INITCURSE_OFFSET UNITYSDK_OFFSET(0x9922290)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_INITFOLDBTNSTATE_OFFSET UNITYSDK_OFFSET(0x9922200)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_INITHEAT_OFFSET UNITYSDK_OFFSET(0x9922750)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x99232E0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONFILTERDROPCHANGE_OFFSET UNITYSDK_OFFSET(0x99244E0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9923380)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x99219A0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9921A40)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER_SETFOLDSTATE_OFFSET UNITYSDK_OFFSET(0x99257E0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__BIND_B__9_0_OFFSET UNITYSDK_OFFSET(0x9926290)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__BIND_B__9_1_OFFSET UNITYSDK_OFFSET(0x99262C0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__BIND_B__9_2_OFFSET UNITYSDK_OFFSET(0x99262F0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__CREATESORT_B__7_0_OFFSET UNITYSDK_OFFSET(0x9926210)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9925FE0)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9926320)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9926390)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9926410)
#define MOLEMOLE_UIWHOLEEFFECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9926470)

namespace MoleMole
{
	inline static constexpr unsigned int UIWholeEffectWidgetController_TypeDefinitionIndex = 68788;

	class UIWholeEffectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_171* _view; // 0x2A0
		::System::Collections::Generic::List_1<::MoleMole::UIHollowCardItemBtnWidgetController*>* itemCtrls; // 0x2A8
		::System::Int32 curBlessCount; // 0x2B0
		::System::Collections::Generic::Dictionary_2<::MoleMole::UIWholeEffectWidgetController_FoldType, ::System::Boolean>* foldState; // 0x2B8
		::MoleMole::UIWholeEffectWidgetController_FoldType currentType; // 0x2C0
		::MoleMole::UIWholeEffectWidgetController_SortType currentSortType; // 0x2C4
		::MoleMole::UIGeneralDynamicTipsPopWindowController* _dropdownSelect; // 0x2C8
		::Il2CppArray<::Struct_2_037D21AC29ED1130>* sortParams; // 0x2D0
		::System::Collections::Generic::List_1<::MoleMole::UIHollowCardItemBtnWidgetController*>* itemWidgets; // 0x2D8
		::System::Collections::Generic::List_1<::MoleMole::UIHollowHotEffectInfoWidgetWidgetController*>* hoteffectWidgets; // 0x2E0
		::System::Collections::Generic::List_1<::MoleMole::UIHollowDamnationWidgetController*>* damnationWidgets; // 0x2E8
