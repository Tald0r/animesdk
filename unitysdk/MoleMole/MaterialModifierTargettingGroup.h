...
#define MOLEMOLE_MATERIALMODIFIERTARGETTINGGROUP_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA5F9F10)
#define MOLEMOLE_MATERIALMODIFIERTARGETTINGGROUP_METHOD_1_1DA658F42F780D13_OFFSET UNITYSDK_OFFSET(0xA5FA360)
#define MOLEMOLE_MATERIALMODIFIERTARGETTINGGROUP_METHOD_1_43A478BA01FE29B7_OFFSET UNITYSDK_OFFSET(0xA5FA1B0)
#define MOLEMOLE_MATERIALMODIFIERTARGETTINGGROUP_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA5FA3D0)
#define MOLEMOLE_MATERIALMODIFIERTARGETTINGGROUP_METHOD_1_DD58D7555070DEA2_OFFSET UNITYSDK_OFFSET(0xA5FA430)
#define MOLEMOLE_MATERIALMODIFIERTARGETTINGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xA5FA130)

namespace MoleMole
{
	inline static constexpr unsigned int MaterialModifierTargettingGroup_TypeDefinitionIndex = 58587;
