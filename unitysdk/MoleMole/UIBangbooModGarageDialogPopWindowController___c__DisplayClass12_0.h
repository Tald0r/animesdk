...
#define MOLEMOLE_UIBANGBOOMODGARAGEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0xDC5BD80)
#define MOLEMOLE_UIBANGBOOMODGARAGEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS12_0__DOBUY_B__0_OFFSET UNITYSDK_OFFSET(0xDC5BD90)
#define MOLEMOLE_UIBANGBOOMODGARAGEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS12_0__DOBUY_B__1_OFFSET UNITYSDK_OFFSET(0xDC5BE30)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooModGarageDialogPopWindowController___c__DisplayClass12_0_TypeDefinitionIndex = 78717;
