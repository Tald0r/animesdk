...
#define MOLEMOLE_NAPSUBPASSOPTBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6E4D850)
#define MOLEMOLE_NAPSUBPASSOPTBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E4D8E0)
#define MOLEMOLE_NAPSUBPASSOPTBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6E4D940)

namespace MoleMole
{
	inline static constexpr unsigned int NapSubpassOptByGPUModelPostProcessorProfile_TypeDefinitionIndex = 66490;
