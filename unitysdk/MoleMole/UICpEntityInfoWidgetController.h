...
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A357760)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A3577F0)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A357630)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A3576C0)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0x1A3578C0)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A357DD0)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A357E00)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A357E70)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A357EF0)
#define MOLEMOLE_UICPENTITYINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A357F50)

namespace MoleMole
{
	inline static constexpr unsigned int UICpEntityInfoWidgetController_TypeDefinitionIndex = 81505;

	class UICpEntityInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_C9DDE9730C6BE395_10* _view; // 0x2A0
