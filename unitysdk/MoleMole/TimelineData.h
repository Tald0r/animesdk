...
#define MOLEMOLE_TIMELINEDATA_GETDEFAULTNEEDDISPLAYTIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0xB5BCDF0)
#define MOLEMOLE_TIMELINEDATA_GETIGNORETIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0xB5BCD90)
#define MOLEMOLE_TIMELINEDATA_GET_AUDIORESPATH_OFFSET UNITYSDK_OFFSET(0xB5BCC10)
#define MOLEMOLE_TIMELINEDATA_GET_FINALTIMELINERESPATH_OFFSET UNITYSDK_OFFSET(0xB5BCC20)
#define MOLEMOLE_TIMELINEDATA_GET_RESPATH_OFFSET UNITYSDK_OFFSET(0xB5BCC00)
#define MOLEMOLE_TIMELINEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xB5BCE60)
#define MOLEMOLE_TIMELINEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB5BCE50)

namespace MoleMole
{
	inline static constexpr unsigned int TimelineData_TypeDefinitionIndex = 79079;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(TimelineData_TypeDefinitionIndex)->GetStaticField(0x34680);
		}
