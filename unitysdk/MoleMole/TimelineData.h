...
#define MOLEMOLE_TIMELINEDATA_GETDEFAULTNEEDDISPLAYTIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0xC7F56E0)
#define MOLEMOLE_TIMELINEDATA_GETIGNORETIMELINERESOVERRIDE_OFFSET UNITYSDK_OFFSET(0xC7F5680)
#define MOLEMOLE_TIMELINEDATA_GET_AUDIORESPATH_OFFSET UNITYSDK_OFFSET(0xC7F5500)
#define MOLEMOLE_TIMELINEDATA_GET_FINALTIMELINERESPATH_OFFSET UNITYSDK_OFFSET(0xC7F5510)
#define MOLEMOLE_TIMELINEDATA_GET_RESPATH_OFFSET UNITYSDK_OFFSET(0xC7F54F0)
#define MOLEMOLE_TIMELINEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xC7F5750)
#define MOLEMOLE_TIMELINEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC7F5740)

namespace MoleMole
{
	inline static constexpr unsigned int TimelineData_TypeDefinitionIndex = 53204;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(TimelineData_TypeDefinitionIndex)->GetStaticField(0x36FE0);
		}
