...
#define MOLEMOLE_INLEVELMOVEUPKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x8F86590)
#define MOLEMOLE_INLEVELMOVEUPKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x8F865A0)
#define MOLEMOLE_INLEVELMOVEUPKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x8F865B0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelMoveUpKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 69384;
