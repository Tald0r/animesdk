...
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_CREATEFUNC_OFFSET UNITYSDK_OFFSET(0xB6BBB00)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_CREATEITEMFUNC_OFFSET UNITYSDK_OFFSET(0xB6BC8E0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_GETDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0xB6BC6A0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_GETITEMWIDGET_OFFSET UNITYSDK_OFFSET(0xB6BBCC0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB6BA870)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONCLICKSUBLIMEBTN_OFFSET UNITYSDK_OFFSET(0xB6BC9C0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6BA880)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xB6BB5E0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONSELECTCHILD_OFFSET UNITYSDK_OFFSET(0xB6BBBE0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6BB910)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6BA920)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB6BAE60)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_REFRESHMESSAGELIST_OFFSET UNITYSDK_OFFSET(0xB6BB420)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_REFRESHRIGHTINFO_OFFSET UNITYSDK_OFFSET(0xB6BBE80)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_REFRESHTOKENITEM_OFFSET UNITYSDK_OFFSET(0xB6BAF90)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB6BCC40)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER__ONCLICKSUBLIMEBTN_B__21_0_OFFSET UNITYSDK_OFFSET(0xB6BCED0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER__REFRESHMESSAGELIST_B__18_0_OFFSET UNITYSDK_OFFSET(0xB6BCCD0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6BD170)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xB6BD1E0)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6BD250)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6BD260)
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB6BD270)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastMessagePageController_TypeDefinitionIndex = 56516;
	...
	public:
		...
		::Class_2_736D160283864BFA* _view; // 0x2F8
		::Class_2_B1555FA59A3F87CE* _model; // 0x300
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_95*>* _curList; // 0x308
		::MoleMole::UIOverlordFeastMessageRowWidgetController* _curSelectRow; // 0x310
		::MoleMole::UIOverlordFeastMessagePageContext* _context; // 0x318
		::MoleMole::UIGeneralTokenWidgetController* _tokenWidget; // 0x320
		...
		{
			return ((::MoleMole::ScrollViewItemWidgetController*(*)(::PVOID, ::Enum_3_340DE32BA097F66C, ::System::Func_1<::MoleMole::UIControlReference*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_CREATEFUNC_OFFSET))(this, arg1, arg2);
		}
		...
		::System::Void RefreshRightInfo(::Class_2_208CC9941471731A_95* devConfig)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_95*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER_REFRESHRIGHTINFO_OFFSET))(this, devConfig);
		}
		...
		::System::Int32 _RefreshMessageList_b__18_0(::Class_2_208CC9941471731A_95* a, ::Class_2_208CC9941471731A_95* b)
		{
			return ((::System::Int32(*)(::PVOID, ::Class_2_208CC9941471731A_95*, ::Class_2_208CC9941471731A_95*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTROLLER__REFRESHMESSAGELIST_B__18_0_OFFSET))(this, a, b);
		}
