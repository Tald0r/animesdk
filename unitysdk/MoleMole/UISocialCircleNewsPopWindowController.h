...
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA401AC0)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA401AD0)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA401B40)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA401C40)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER_TRYOVERRIDESHOULDIGNOREITEM_OFFSET UNITYSDK_OFFSET(0xA401D80)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA401EB0)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA401EC0)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA401F30)
#define MOLEMOLE_UISOCIALCIRCLENEWSPOPWINDOWCONTROLLER___BASE_TRYOVERRIDESHOULDIGNOREITEM_OFFSET UNITYSDK_OFFSET(0xA401F40)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleNewsPopWindowController_TypeDefinitionIndex = 73667;
