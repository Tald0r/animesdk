...
#define MOLEMOLE_ENTITYHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x417EC0)
#define MOLEMOLE_ENTITYHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x417EB0)
#define MOLEMOLE_ENTITYHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x417E40)
#define MOLEMOLE_ENTITYHANDLE_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x2EC6E0)
#define MOLEMOLE_ENTITYHANDLE_GET_ENTITYTYPE_OFFSET UNITYSDK_OFFSET(0x417D00)
#define MOLEMOLE_ENTITYHANDLE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x417D20)
#define MOLEMOLE_ENTITYHANDLE_GET_ISPRELOAD_OFFSET UNITYSDK_OFFSET(0x417DA0)
#define MOLEMOLE_ENTITYHANDLE_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x417DB0)
#define MOLEMOLE_ENTITYHANDLE_GET_OFFSET UNITYSDK_OFFSET(0x417C80)
#define MOLEMOLE_ENTITYHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x417D10)
#define MOLEMOLE_ENTITYHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xCD2EB30)
#define MOLEMOLE_ENTITYHANDLE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0xCD2E790)
#define MOLEMOLE_ENTITYHANDLE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0xCD2E840)
#define MOLEMOLE_ENTITYHANDLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xCD2E700)
#define MOLEMOLE_ENTITYHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xCD2EC30)
#define MOLEMOLE_ENTITYHANDLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x417DC0)
#define MOLEMOLE_ENTITYHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD2ED30)
#define MOLEMOLE_ENTITYHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x417C20)
#define MOLEMOLE_ENTITYHANDLE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x417C40)
#define MOLEMOLE_ENTITYHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x417C10)
#define MOLEMOLE_ENTITYHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x417F50)
#define MOLEMOLE_ENTITYHANDLE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x417F90)

namespace MoleMole
{
	inline static constexpr unsigned int EntityHandle_TypeDefinitionIndex = 68508;

	struct alignas(8) EntityHandle
	{
		static ::MoleMole::EntityHandle* StaticGet_Empty()
		{
			return (::MoleMole::EntityHandle*)Il2CppClass::FromTypeDefinitionIndex(EntityHandle_TypeDefinitionIndex)->GetStaticField(0x2A750);
		}
