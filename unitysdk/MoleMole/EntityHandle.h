...
#define MOLEMOLE_ENTITYHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x539E30)
#define MOLEMOLE_ENTITYHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x539E20)
#define MOLEMOLE_ENTITYHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x539DB0)
#define MOLEMOLE_ENTITYHANDLE_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define MOLEMOLE_ENTITYHANDLE_GET_ENTITYTYPE_OFFSET UNITYSDK_OFFSET(0x539C70)
#define MOLEMOLE_ENTITYHANDLE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x539C90)
#define MOLEMOLE_ENTITYHANDLE_GET_ISPRELOAD_OFFSET UNITYSDK_OFFSET(0x539D10)
#define MOLEMOLE_ENTITYHANDLE_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x539D20)
#define MOLEMOLE_ENTITYHANDLE_GET_OFFSET UNITYSDK_OFFSET(0x539BF0)
#define MOLEMOLE_ENTITYHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x539C80)
#define MOLEMOLE_ENTITYHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xE85FE80)
#define MOLEMOLE_ENTITYHANDLE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0xE85FBB0)
#define MOLEMOLE_ENTITYHANDLE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0xE827440)
#define MOLEMOLE_ENTITYHANDLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xE85FB20)
#define MOLEMOLE_ENTITYHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xE85FF80)
#define MOLEMOLE_ENTITYHANDLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x539D30)
#define MOLEMOLE_ENTITYHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0xE860080)
#define MOLEMOLE_ENTITYHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x539B90)
#define MOLEMOLE_ENTITYHANDLE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x539BB0)
#define MOLEMOLE_ENTITYHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x539B80)
#define MOLEMOLE_ENTITYHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x539EC0)
#define MOLEMOLE_ENTITYHANDLE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x539F00)

namespace MoleMole
{
	inline static constexpr unsigned int EntityHandle_TypeDefinitionIndex = 64387;

	struct alignas(8) EntityHandle
	{
		static ::MoleMole::EntityHandle* StaticGet_Empty()
		{
			return (::MoleMole::EntityHandle*)Il2CppClass::FromTypeDefinitionIndex(EntityHandle_TypeDefinitionIndex)->GetStaticField(0x2A980);
		}
