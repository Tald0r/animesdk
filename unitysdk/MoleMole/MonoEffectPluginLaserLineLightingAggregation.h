...
#define MOLEMOLE_MONOEFFECTPLUGINLASERLINELIGHTINGAGGREGATION_AWAKE_OFFSET UNITYSDK_OFFSET(0xB99D080)
#define MOLEMOLE_MONOEFFECTPLUGINLASERLINELIGHTINGAGGREGATION_INIT_OFFSET UNITYSDK_OFFSET(0xB99B870)
#define MOLEMOLE_MONOEFFECTPLUGINLASERLINELIGHTINGAGGREGATION_METHOD_6_4254ECBCC8032C4E_OFFSET UNITYSDK_OFFSET(0xB99D210)
#define MOLEMOLE_MONOEFFECTPLUGINLASERLINELIGHTINGAGGREGATION_METHOD_6_D077B047AF68F451_OFFSET UNITYSDK_OFFSET(0xB99C430)
#define MOLEMOLE_MONOEFFECTPLUGINLASERLINELIGHTINGAGGREGATION_METHOD_6_F64151D2A05822C3_OFFSET UNITYSDK_OFFSET(0xB99BE30)
#define MOLEMOLE_MONOEFFECTPLUGINLASERLINELIGHTINGAGGREGATION_SETBLOCKEFFECTS_OFFSET UNITYSDK_OFFSET(0xB99C7F0)
#define MOLEMOLE_MONOEFFECTPLUGINLASERLINELIGHTINGAGGREGATION_SETENDEFFECTS_OFFSET UNITYSDK_OFFSET(0xB99C5A0)
#define MOLEMOLE_MONOEFFECTPLUGINLASERLINELIGHTINGAGGREGATION_SETSTARTEFFECTS_OFFSET UNITYSDK_OFFSET(0xB99C1E0)
#define MOLEMOLE_MONOEFFECTPLUGINLASERLINELIGHTINGAGGREGATION_SETTRANSFORMPOSITION_OFFSET UNITYSDK_OFFSET(0xB99BC50)
#define MOLEMOLE_MONOEFFECTPLUGINLASERLINELIGHTINGAGGREGATION_SHOWBLOCKEFFECTS_OFFSET UNITYSDK_OFFSET(0xB99BBB0)
#define MOLEMOLE_MONOEFFECTPLUGINLASERLINELIGHTINGAGGREGATION_SHOWENDEFFECTS_OFFSET UNITYSDK_OFFSET(0xB99BB10)
#define MOLEMOLE_MONOEFFECTPLUGINLASERLINELIGHTINGAGGREGATION_SHOWSTARTEFFECTS_OFFSET UNITYSDK_OFFSET(0xB99BA70)
#define MOLEMOLE_MONOEFFECTPLUGINLASERLINELIGHTINGAGGREGATION__CTOR_OFFSET UNITYSDK_OFFSET(0xB99D470)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginLaserLineLightingAggregation_TypeDefinitionIndex = 54867;
