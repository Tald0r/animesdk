...
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_CHECKTARGETTABISAVAILABLE_OFFSET UNITYSDK_OFFSET(0xADE5930)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_CLOSEBTNSPOPUP_OFFSET UNITYSDK_OFFSET(0xADE5290)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_FINDCHATIDXBYBRIEFINFO_OFFSET UNITYSDK_OFFSET(0xADE9D80)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_FINDCHATTINGBRIEFINFOBYUID_OFFSET UNITYSDK_OFFSET(0xADE9C50)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GETCIRCLESHOWTITLETOGGLE_OFFSET UNITYSDK_OFFSET(0xADE7610)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GETFIRSTAVAILABLETAB_OFFSET UNITYSDK_OFFSET(0xADE5A50)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GETLASTSELECTTABINFO_OFFSET UNITYSDK_OFFSET(0xADE69E0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GET_CURRSELECTTAB_OFFSET UNITYSDK_OFFSET(0xADE75F0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GET_ISBTNSPOPUPOPEN_OFFSET UNITYSDK_OFFSET(0xADE7600)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GET_ISCIRCLEPANELREADY_OFFSET UNITYSDK_OFFSET(0xADE90E0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GET_ISFRIENDPANELREADY_OFFSET UNITYSDK_OFFSET(0xADE74E0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xADE3810)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_INITBTNSPOPUP_OFFSET UNITYSDK_OFFSET(0xADE4590)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONCHATITEMSELECT_OFFSET UNITYSDK_OFFSET(0xADE85A0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONCIRCLECHATITEMSELECT_OFFSET UNITYSDK_OFFSET(0xADE8830)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONCLICKGOTOCIRCLEMAINPAGE_OFFSET UNITYSDK_OFFSET(0xADE4E50)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONCLICKHIDECHATBTN_OFFSET UNITYSDK_OFFSET(0xADEA1C0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONCLICKREPORTCIRCLE_OFFSET UNITYSDK_OFFSET(0xADE9590)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADE70A0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xADE4D80)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONDONTDISTURBTOGGLESWITCH_OFFSET UNITYSDK_OFFSET(0xADE8F60)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONFRIENDCHATITEMSELECT_OFFSET UNITYSDK_OFFSET(0xADE8670)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONINITCIRCLEPANEL_OFFSET UNITYSDK_OFFSET(0xADE4C50)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONINITFRIENDPANEL_OFFSET UNITYSDK_OFFSET(0xADE4890)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONRECEIVECHATHISTORYMSG_OFFSET UNITYSDK_OFFSET(0xADEA970)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONRECEIVEFRIENDCHATLIST_OFFSET UNITYSDK_OFFSET(0xADEA430)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONRECEIVEUNREADCHATLIST_OFFSET UNITYSDK_OFFSET(0xADEA8F0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONTABBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xADE54F0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONTOGGLESWITCH_OFFSET UNITYSDK_OFFSET(0xADE8B20)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADE7140)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADE3820)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADE6780)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONUPDATEFRIENDINFO_OFFSET UNITYSDK_OFFSET(0xADE9F20)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_OPENBTNSPOPUP_OFFSET UNITYSDK_OFFSET(0xADE4F30)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_PLAYSWITCHTABANIM_OFFSET UNITYSDK_OFFSET(0xADE5E80)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_PREPARECIRCLEPANELDATA_OFFSET UNITYSDK_OFFSET(0xADE6C20)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_PREPAREFRIENDPANELDATA_OFFSET UNITYSDK_OFFSET(0xADE6AE0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_REALSELECTCHATITEM_OFFSET UNITYSDK_OFFSET(0xADE8360)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_REBUILDCHATITEMUI_OFFSET UNITYSDK_OFFSET(0xADE9980)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_RECORDCURRENTSELECTTABINFO_OFFSET UNITYSDK_OFFSET(0xADE5AE0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SAVECIRCLESHOWTITLETOGGLE_OFFSET UNITYSDK_OFFSET(0xADE8CA0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SHOWCIRCLEITEM_OFFSET UNITYSDK_OFFSET(0xADE77E0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SHOWCIRCLEPANELUI_OFFSET UNITYSDK_OFFSET(0xADE6610)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SHOWFRIENDPANELUI_OFFSET UNITYSDK_OFFSET(0xADE5F40)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SWITCHCHATWINDOWCONTENT_OFFSET UNITYSDK_OFFSET(0xADE7560)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SWITCHCIRCLEPANELUI_OFFSET UNITYSDK_OFFSET(0xADE5DA0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SWITCHFRIENDPANELUI_OFFSET UNITYSDK_OFFSET(0xADE5CE0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_TRYSHOWELEMENTS_OFFSET UNITYSDK_OFFSET(0xADE7280)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_UPDATECHATPAGEBYCIRCLEWHENNEWMSGCOME_OFFSET UNITYSDK_OFFSET(0xADE9270)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_UPDATECHATPAGEBYCIRCLE_OFFSET UNITYSDK_OFFSET(0xADE90F0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_UPDATECHATPAGE_OFFSET UNITYSDK_OFFSET(0xADEAA00)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__CLOSEBTNSPOPUP_B__10_0_OFFSET UNITYSDK_OFFSET(0xADEAE10)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xADEAAF0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__ONCLICKGOTOCIRCLEMAINPAGE_B__7_0_OFFSET UNITYSDK_OFFSET(0xADEAC60)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__ONCLICKHIDECHATBTN_B__69_0_OFFSET UNITYSDK_OFFSET(0xADEAFF0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__ONCLICKHIDECHATBTN_B__69_1_OFFSET UNITYSDK_OFFSET(0xADEB0A0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__ONCLICKHIDECHATBTN_B__69_2_OFFSET UNITYSDK_OFFSET(0xADEB110)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__ONINITFRIENDPANEL_B__62_0_OFFSET UNITYSDK_OFFSET(0xADEAEE0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__OPENBTNSPOPUP_B__9_0_OFFSET UNITYSDK_OFFSET(0xADEAD70)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__PREPAREFRIENDPANELDATA_B__63_0_OFFSET UNITYSDK_OFFSET(0xADEAFE0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__UPDATECHATPAGE_B__76_0_OFFSET UNITYSDK_OFFSET(0xADEB5C0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADEB5E0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xADEB650)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADEB660)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADEB670)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADEB680)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatPopWindowController_TypeDefinitionIndex = 63187;
	...
	public:
		...
		::Class_2_60638234271CCDB8_80* _view; // 0x2F8
		::MoleMole::UIChatWindowWidgetController* _chatWindowController; // 0x300
		::Class_2_2F3C7D4EFC74D485* _model; // 0x308
		::Class_2_01A9580380D362EF* _circleModel; // 0x310
		::System::Boolean _isFirstSelect; // 0x318
		::System::Boolean _isPlayingTabAnim; // 0x319
		::Enum_3_5F152DBF108B0858_1 _currSelectTab; // 0x31C
		::System::Collections::Generic::Dictionary_2<::Enum_3_5F152DBF108B0858_1, ::System::Boolean>* _chatTabUnlockStateDic; // 0x320
		::System::Collections::Generic::Dictionary_2<::Enum_3_5F152DBF108B0858_1, ::System::String*>* _chatTabUnlockTipsDic; // 0x328
		::System::Int32 _currSelectIdx; // 0x330
		::System::Collections::Generic::List_1<::Class_1_E87F7C93CB0CC57E*>* _currChatItemDataList; // 0x338
		::System::Collections::Generic::List_1<::MoleMole::UIFriendChatItemContext*>* _currUIChatItemList; // 0x340
		::System::Collections::Generic::List_1<::MoleMole::UITabBtn01RowWidgetController*>* _tabsList; // 0x348
		::MoleMole::UIGeneralToggleWidgetController* _dontDisturbToggle; // 0x350
		::System::Boolean _isBtnsPopupOpen; // 0x358
		::MoleMole::UIGeneralToggleWidgetController* _circleToggle; // 0x360
		::System::Boolean _isCirclePanelReady; // 0x368
		::Class_2_DF2C726EEEEC912D* currSelectedCircleData; // 0x370
		::System::Collections::Generic::List_1<::Class_1_A48B3771FE1DF659*>* _currCircleChatItemDataList; // 0x378
		::System::Boolean _isChatReady; // 0x380
		::System::Boolean _isUnreadListReady; // 0x381
		::System::Boolean _isFirstMsgReceived; // 0x382
		::Class_1_BE6BF7909AD9D940* initSelectedInfo; // 0x388
		::Class_1_BE6BF7909AD9D940* currSelectedInfo; // 0x390
		...
		::Enum_3_5F152DBF108B0858_1 get_CurrSelectTab()
		{
			return ((::Enum_3_5F152DBF108B0858_1(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GET_CURRSELECTTAB_OFFSET))(this);
		}
