...
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_CHECKTARGETTABISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x9D79DD0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_CLOSEBTNSPOPUP_OFFSET UNITYSDK_OFFSET(0x9D79730)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_FINDCHATIDXBYBRIEFINFO_OFFSET UNITYSDK_OFFSET(0x9D7E190)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_FINDCHATTINGBRIEFINFOBYUID_OFFSET UNITYSDK_OFFSET(0x9D7E060)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GETCIRCLESHOWTITLETOGGLE_OFFSET UNITYSDK_OFFSET(0x9D7BA20)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GETFIRSTAVAILABLETAB_OFFSET UNITYSDK_OFFSET(0x9D79EF0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GETLASTSELECTTABINFO_OFFSET UNITYSDK_OFFSET(0x9D7ADF0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GET_CURRSELECTTAB_OFFSET UNITYSDK_OFFSET(0x9D7BA00)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GET_ISBTNSPOPUPOPEN_OFFSET UNITYSDK_OFFSET(0x9D7BA10)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GET_ISCIRCLEPANELREADY_OFFSET UNITYSDK_OFFSET(0x9D7D4F0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GET_ISFRIENDPANELREADY_OFFSET UNITYSDK_OFFSET(0x9D7B8F0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9D77CD0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_INITBTNSPOPUP_OFFSET UNITYSDK_OFFSET(0x9D78A50)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONCHATITEMSELECT_OFFSET UNITYSDK_OFFSET(0x9D7C9B0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONCIRCLECHATITEMSELECT_OFFSET UNITYSDK_OFFSET(0x9D7CC40)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONCLICKGOTOCIRCLEMAINPAGE_OFFSET UNITYSDK_OFFSET(0x9D79300)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONCLICKHIDECHATBTN_OFFSET UNITYSDK_OFFSET(0x9D7E5D0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONCLICKREPORTCIRCLE_OFFSET UNITYSDK_OFFSET(0x9D7D9A0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9D7B4B0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9D79230)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONDONTDISTURBTOGGLESWITCH_OFFSET UNITYSDK_OFFSET(0x9D7D370)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONFRIENDCHATITEMSELECT_OFFSET UNITYSDK_OFFSET(0x9D7CA80)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONINITCIRCLEPANEL_OFFSET UNITYSDK_OFFSET(0x9D79100)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONINITFRIENDPANEL_OFFSET UNITYSDK_OFFSET(0x9D78D40)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONRECEIVECHATHISTORYMSG_OFFSET UNITYSDK_OFFSET(0x9D7ED80)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONRECEIVEFRIENDCHATLIST_OFFSET UNITYSDK_OFFSET(0x9D7E840)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONRECEIVEUNREADCHATLIST_OFFSET UNITYSDK_OFFSET(0x9D7ED00)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONTABBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x9D79990)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONTOGGLESWITCH_OFFSET UNITYSDK_OFFSET(0x9D7CF30)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9D7B550)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9D77CE0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9D7AB90)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_ONUPDATEFRIENDINFO_OFFSET UNITYSDK_OFFSET(0x9D7E330)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_OPENBTNSPOPUP_OFFSET UNITYSDK_OFFSET(0x9D793E0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_PLAYSWITCHTABANIM_OFFSET UNITYSDK_OFFSET(0x9D7A320)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_PREPARECIRCLEPANELDATA_OFFSET UNITYSDK_OFFSET(0x9D7B030)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_PREPAREFRIENDPANELDATA_OFFSET UNITYSDK_OFFSET(0x9D7AEF0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_REALSELECTCHATITEM_OFFSET UNITYSDK_OFFSET(0x9D7C770)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_REBUILDCHATITEMUI_OFFSET UNITYSDK_OFFSET(0x9D7DD90)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_RECORDCURRENTSELECTTABINFO_OFFSET UNITYSDK_OFFSET(0x9D79F80)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SAVECIRCLESHOWTITLETOGGLE_OFFSET UNITYSDK_OFFSET(0x9D7D0B0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SHOWCIRCLEITEM_OFFSET UNITYSDK_OFFSET(0x9D7BBF0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SHOWCIRCLEPANELUI_OFFSET UNITYSDK_OFFSET(0x9D7AA20)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SHOWFRIENDPANELUI_OFFSET UNITYSDK_OFFSET(0x9D7A3E0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SWITCHCHATWINDOWCONTENT_OFFSET UNITYSDK_OFFSET(0x9D7B970)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SWITCHCIRCLEPANELUI_OFFSET UNITYSDK_OFFSET(0x9D7A240)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_SWITCHFRIENDPANELUI_OFFSET UNITYSDK_OFFSET(0x9D7A180)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_TRYSHOWELEMENTS_OFFSET UNITYSDK_OFFSET(0x9D7B690)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_UPDATECHATPAGEBYCIRCLEWHENNEWMSGCOME_OFFSET UNITYSDK_OFFSET(0x9D7D680)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_UPDATECHATPAGEBYCIRCLE_OFFSET UNITYSDK_OFFSET(0x9D7D500)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER_UPDATECHATPAGE_OFFSET UNITYSDK_OFFSET(0x9D7EE10)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__CLOSEBTNSPOPUP_B__10_0_OFFSET UNITYSDK_OFFSET(0x9D7F210)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D7EEF0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__ONCLICKGOTOCIRCLEMAINPAGE_B__7_0_OFFSET UNITYSDK_OFFSET(0x9D7F060)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__ONCLICKHIDECHATBTN_B__69_0_OFFSET UNITYSDK_OFFSET(0x9D7F3F0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__ONCLICKHIDECHATBTN_B__69_1_OFFSET UNITYSDK_OFFSET(0x9D7F4A0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__ONCLICKHIDECHATBTN_B__69_2_OFFSET UNITYSDK_OFFSET(0x9D7F510)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__ONINITFRIENDPANEL_B__62_0_OFFSET UNITYSDK_OFFSET(0x9D7F2E0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__OPENBTNSPOPUP_B__9_0_OFFSET UNITYSDK_OFFSET(0x9D7F170)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__PREPAREFRIENDPANELDATA_B__63_0_OFFSET UNITYSDK_OFFSET(0x9D7F3E0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER__UPDATECHATPAGE_B__76_0_OFFSET UNITYSDK_OFFSET(0x9D7F9C0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9D7F9E0)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9D7FA50)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9D7FA60)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9D7FA70)
#define MOLEMOLE_UIFRIENDCHATPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9D7FA80)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatPopWindowController_TypeDefinitionIndex = 39139;
	...
	public:
		...
		::Class_2_60638234271CCDB8_18* _view; // 0x2F8
		...
		::Enum_3_5F152DBF108B0858 _currSelectTab; // 0x31C
		::System::Collections::Generic::Dictionary_2<::Enum_3_5F152DBF108B0858, ::System::Boolean>* _chatTabUnlockStateDic; // 0x320
		::System::Collections::Generic::Dictionary_2<::Enum_3_5F152DBF108B0858, ::System::String*>* _chatTabUnlockTipsDic; // 0x328
