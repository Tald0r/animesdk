...
#define MOLEMOLE_MONOINTERESTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD62DB0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoInterestPoint_TypeDefinitionIndex = 63076;
