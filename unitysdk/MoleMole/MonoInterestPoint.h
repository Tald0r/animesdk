...
#define MOLEMOLE_MONOINTERESTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x7F18260)

namespace MoleMole
{
	inline static constexpr unsigned int MonoInterestPoint_TypeDefinitionIndex = 44150;
