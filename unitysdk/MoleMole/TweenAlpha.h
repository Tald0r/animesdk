...
#define MOLEMOLE_TWEENALPHA_BEGIN_OFFSET UNITYSDK_OFFSET(0xC334660)
#define MOLEMOLE_TWEENALPHA_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xC3341E0)
#define MOLEMOLE_TWEENALPHA_METHOD_7_0455744A788080C5_OFFSET UNITYSDK_OFFSET(0xC3340F0)
#define MOLEMOLE_TWEENALPHA_METHOD_7_0B99C03107E8A6B9_OFFSET UNITYSDK_OFFSET(0xC3343C0)
#define MOLEMOLE_TWEENALPHA_METHOD_7_50C397B5C3CE86EA_OFFSET UNITYSDK_OFFSET(0xC3348C0)
#define MOLEMOLE_TWEENALPHA_METHOD_7_5C0BDCAA1FC45B61_OFFSET UNITYSDK_OFFSET(0xC334280)
#define MOLEMOLE_TWEENALPHA_METHOD_7_71AD79076E016A6C_OFFSET UNITYSDK_OFFSET(0xC334540)
#define MOLEMOLE_TWEENALPHA_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xC3341F0)
#define MOLEMOLE_TWEENALPHA_START_OFFSET UNITYSDK_OFFSET(0xC333FB0)
#define MOLEMOLE_TWEENALPHA__CTOR_OFFSET UNITYSDK_OFFSET(0xC334820)
#define MOLEMOLE_TWEENALPHA___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xC334840)
#define MOLEMOLE_TWEENALPHA___BASE_START_OFFSET UNITYSDK_OFFSET(0xC334850)

namespace MoleMole
{
	inline static constexpr unsigned int TweenAlpha_TypeDefinitionIndex = 71618;
