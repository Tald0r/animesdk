...
#define MOLEMOLE_UISOCIALCIRCLEAPPLYWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9A0EB60)
#define MOLEMOLE_UISOCIALCIRCLEAPPLYWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9A0EBD0)
#define MOLEMOLE_UISOCIALCIRCLEAPPLYWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9A0ECD0)
#define MOLEMOLE_UISOCIALCIRCLEAPPLYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A0EE80)
#define MOLEMOLE_UISOCIALCIRCLEAPPLYWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9A0EEB0)
#define MOLEMOLE_UISOCIALCIRCLEAPPLYWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9A0EF20)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleApplyWidgetController_TypeDefinitionIndex = 45079;
