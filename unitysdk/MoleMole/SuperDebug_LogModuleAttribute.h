...
#define MOLEMOLE_SUPERDEBUG_LOGMODULEATTRIBUTE_GET_DEFAULTENABLE_OFFSET UNITYSDK_OFFSET(0x1B0FA370)
#define MOLEMOLE_SUPERDEBUG_LOGMODULEATTRIBUTE_GET_MODULECOLOR_OFFSET UNITYSDK_OFFSET(0x1B0FA360)
#define MOLEMOLE_SUPERDEBUG_LOGMODULEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0FA330)
#define MOLEMOLE_SUPERDEBUG_LOGMODULEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0FA180)

namespace MoleMole
{
	inline static constexpr unsigned int SuperDebug_LogModuleAttribute_TypeDefinitionIndex = 8154;
