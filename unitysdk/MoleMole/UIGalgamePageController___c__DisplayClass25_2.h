...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS25_2__CTOR_OFFSET UNITYSDK_OFFSET(0xA294B70)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS25_2__PLAYSUBNARRATORNODE_B__7_OFFSET UNITYSDK_OFFSET(0xA294B80)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS25_2__PLAYSUBNARRATORNODE_B__8_OFFSET UNITYSDK_OFFSET(0xA294C60)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass25_2_TypeDefinitionIndex = 54669;
