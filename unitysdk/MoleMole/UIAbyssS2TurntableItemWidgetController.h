...
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD850890)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD84FF50)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD850930)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD84FE30)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER_SETGETSTATUS_OFFSET UNITYSDK_OFFSET(0xD850800)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD850A10)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD850A20)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD850A90)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD850B10)
#define MOLEMOLE_UIABYSSS2TURNTABLEITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD850B90)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2TurntableItemWidgetController_TypeDefinitionIndex = 48610;
