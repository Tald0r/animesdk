...
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER_GET_BTNMAIN_OFFSET UNITYSDK_OFFSET(0xB6E3040)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER_GET_KEYPOS_OFFSET UNITYSDK_OFFSET(0xB6E2D80)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xB6E3790)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER_ONCHANGEMASK_OFFSET UNITYSDK_OFFSET(0xB6E3260)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER_ONCLICKBTNEMPTY_OFFSET UNITYSDK_OFFSET(0xB6E2FE0)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER_ONCLICKSKILL_OFFSET UNITYSDK_OFFSET(0xB6E37B0)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6E3060)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB6E31E0)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6E3100)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6E2D90)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0xB6E33D0)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER_SETHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xB6E3340)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB6E38A0)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6E38E0)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB6E3950)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6E39D0)
#define MOLEMOLE_UIRIDUSGOTBOOSKILLWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6E3A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooSkillWidgetController_TypeDefinitionIndex = 57962;
	...
	public:
		...
		::Class_2_208CC9941471731A_471* m_skillCfg; // 0x2E0
