...
#define MOLEMOLE_UISHUNGUANGEVENTSCRATCHCARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD3B56E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIShunguangEventScratchCardContext_TypeDefinitionIndex = 70275;
