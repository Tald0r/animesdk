...
#define MOLEMOLE_UISHUNGUANGEVENTSCRATCHCARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC84DC80)

namespace MoleMole
{
	inline static constexpr unsigned int UIShunguangEventScratchCardContext_TypeDefinitionIndex = 68056;
