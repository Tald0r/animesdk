...
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_CALPREVYOROZUYALV_OFFSET UNITYSDK_OFFSET(0xBD29BE0)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD29560)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0xBD2A9F0)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD29600)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD293A0)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD294B0)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_REFRESHLEVELTXTVIEW_1_OFFSET UNITYSDK_OFFSET(0xBD29CD0)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_REFRESHLEVELTXTVIEW_2_OFFSET UNITYSDK_OFFSET(0xBD2ACC0)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_REFRESHLEVELTXTVIEW_OFFSET UNITYSDK_OFFSET(0xBD29800)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_SETADDEXP_OFFSET UNITYSDK_OFFSET(0xBD2A900)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER_SETLEVELTEXT_OFFSET UNITYSDK_OFFSET(0xBD2B860)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBD2B900)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD2B940)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD2B9B0)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD2BA30)
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD2BA90)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotLevelWidgetController_TypeDefinitionIndex = 71775;
