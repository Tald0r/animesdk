...
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB2D85B0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___C__DISPLAYCLASS23_0__ONCLICKFINISHBUTTON_B__0_OFFSET UNITYSDK_OFFSET(0xB2D85C0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___C__DISPLAYCLASS23_0__ONCLICKFINISHBUTTON_B__1_OFFSET UNITYSDK_OFFSET(0xB2D85F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMainPageController___c__DisplayClass23_0_TypeDefinitionIndex = 66257;
