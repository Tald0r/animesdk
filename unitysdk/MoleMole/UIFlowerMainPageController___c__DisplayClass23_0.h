...
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAD11D20)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___C__DISPLAYCLASS23_0__ONCLICKFINISHBUTTON_B__0_OFFSET UNITYSDK_OFFSET(0xAD11D30)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___C__DISPLAYCLASS23_0__ONCLICKFINISHBUTTON_B__1_OFFSET UNITYSDK_OFFSET(0xAD11D60)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMainPageController___c__DisplayClass23_0_TypeDefinitionIndex = 69437;
