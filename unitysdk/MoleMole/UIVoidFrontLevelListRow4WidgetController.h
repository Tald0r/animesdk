...
class Class_2_C0785A1B7C50A21E;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW4WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA8F150)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW4WIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA8F1C0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW4WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCA8F420)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW4WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCA8F2C0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW4WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA8F5A0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW4WIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA8F5B0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW4WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCA8F620)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW4WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCA8F690)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontLevelListRow4WidgetController_TypeDefinitionIndex = 68835;
	...
	public:
		...
		::Class_2_C0785A1B7C50A21E* get__viewModel()
		{
			return ((::Class_2_C0785A1B7C50A21E*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVOIDFRONTLEVELLISTROW4WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
