...
#define MOLEMOLE_WEAPONATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x9A44F60)

namespace MoleMole
{
	inline static constexpr unsigned int WeaponAttachPoint_TypeDefinitionIndex = 58074;
