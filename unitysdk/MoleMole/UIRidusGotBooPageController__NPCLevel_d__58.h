...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__NPCLEVEL_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3226D0)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__NPCLEVEL_D__58_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__NPCLevel_d__58_TypeDefinitionIndex = 66341;
	...
	struct alignas(8) UIRidusGotBooPageController__NPCLevel_d__58
	{
		...
		::System::Int32 _interval_5__3; // 0x44
