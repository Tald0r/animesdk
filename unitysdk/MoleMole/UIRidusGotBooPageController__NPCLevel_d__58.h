...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__NPCLEVEL_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3A3D40)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__NPCLEVEL_D__58_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__NPCLevel_d__58_TypeDefinitionIndex = 44132;
	...
	struct alignas(8) UIRidusGotBooPageController__NPCLevel_d__58
	{
		...
		::System::Collections::Generic::List_1<::Class_1_B9D6E7E76075C6E2*>* _popups_5__2; // 0x38
		::System::Boolean _firstSkillPlayed_5__4; // 0x40
		::System::Int32 _i_5__5; // 0x44
