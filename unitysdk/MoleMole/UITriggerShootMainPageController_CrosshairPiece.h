...
#define MOLEMOLE_UITRIGGERSHOOTMAINPAGECONTROLLER_CROSSHAIRPIECE__CTOR_OFFSET UNITYSDK_OFFSET(0x379780)

namespace MoleMole
{
	inline static constexpr unsigned int UITriggerShootMainPageController_CrosshairPiece_TypeDefinitionIndex = 46535;
