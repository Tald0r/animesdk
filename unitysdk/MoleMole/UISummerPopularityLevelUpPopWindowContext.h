...
#define MOLEMOLE_UISUMMERPOPULARITYLEVELUPPOPWINDOWCONTEXT_GET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0xCAA9AA0)
#define MOLEMOLE_UISUMMERPOPULARITYLEVELUPPOPWINDOWCONTEXT_SET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0xCAA9AB0)
#define MOLEMOLE_UISUMMERPOPULARITYLEVELUPPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCAA9AC0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerPopularityLevelUpPopWindowContext_TypeDefinitionIndex = 71390;
