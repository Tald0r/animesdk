...
class Class_2_9760011945436DFC_1;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }
namespace MoleMole { class UIGeneralOptionTitleRowContext; }

#define MOLEMOLE_UIGENERALOPTIONTITLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x808FD10)
#define MOLEMOLE_UIGENERALOPTIONTITLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x808FDB0)
#define MOLEMOLE_UIGENERALOPTIONTITLEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x808FA70)
#define MOLEMOLE_UIGENERALOPTIONTITLEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x808FB10)
#define MOLEMOLE_UIGENERALOPTIONTITLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x808FE90)
#define MOLEMOLE_UIGENERALOPTIONTITLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x808FEC0)
#define MOLEMOLE_UIGENERALOPTIONTITLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x808FF30)
#define MOLEMOLE_UIGENERALOPTIONTITLEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x808FFB0)
#define MOLEMOLE_UIGENERALOPTIONTITLEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8090010)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralOptionTitleRowWidgetController_TypeDefinitionIndex = 68490;

	class UIGeneralOptionTitleRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_9760011945436DFC_1* _view; // 0x2A0
