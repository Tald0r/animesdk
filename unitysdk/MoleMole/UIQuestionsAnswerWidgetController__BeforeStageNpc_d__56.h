...
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__BEFORESTAGENPC_D__56_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3B6750)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__BEFORESTAGENPC_D__56_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerWidgetController__BeforeStageNpc_d__56_TypeDefinitionIndex = 70200;
	...
	struct alignas(8) UIQuestionsAnswerWidgetController__BeforeStageNpc_d__56
	{
		...
		::Class_3_C3F0E3B5AB5977AE_46* _next_5__2; // 0x18
