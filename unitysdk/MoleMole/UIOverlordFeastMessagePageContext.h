...
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAF8D750)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastMessagePageContext_TypeDefinitionIndex = 42925;
