...
#define MOLEMOLE_UIOVERLORDFEASTMESSAGEPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7399A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastMessagePageContext_TypeDefinitionIndex = 67569;
