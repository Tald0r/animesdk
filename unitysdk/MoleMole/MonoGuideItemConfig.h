...
#define MOLEMOLE_MONOGUIDEITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x82F9210)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGuideItemConfig_TypeDefinitionIndex = 60637;
