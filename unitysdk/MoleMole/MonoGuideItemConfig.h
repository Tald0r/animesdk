...
#define MOLEMOLE_MONOGUIDEITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA3B3600)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGuideItemConfig_TypeDefinitionIndex = 51100;
