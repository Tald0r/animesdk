...
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_BATTLEREDPOINTPOPWINDOWINFOUPDATE_OFFSET UNITYSDK_OFFSET(0x9283000)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_INITBATTLEPOPUPSORTDATA_OFFSET UNITYSDK_OFFSET(0x9281E10)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_INITEXTERNALPOPUPS_OFFSET UNITYSDK_OFFSET(0x92815B0)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_INITHOLLOWINFO_OFFSET UNITYSDK_OFFSET(0x9282160)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_INITPOPUPDATA_OFFSET UNITYSDK_OFFSET(0x9280090)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_INITREDPOINTDATAS_OFFSET UNITYSDK_OFFSET(0x92828C0)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_INITTACTICSPOPUPSORTDATA_OFFSET UNITYSDK_OFFSET(0x9281910)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_INITTUTORIAL_OFFSET UNITYSDK_OFFSET(0x9280280)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_INITWIDGET_OFFSET UNITYSDK_OFFSET(0x927FC40)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9280BF0)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x9280D80)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9280C90)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x927FB90)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x927FF60)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_SELECTEDPOPUP_OFFSET UNITYSDK_OFFSET(0x9280DF0)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x92833D0)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9283230)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER__INITBATTLEPOPUPSORTDATA_B__14_0_OFFSET UNITYSDK_OFFSET(0x9283410)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x92835C0)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x9283630)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x92836A0)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9283720)
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9283780)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseTutorialWidgetController_TypeDefinitionIndex = 36791;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseTutorialWidgetController_TypeDefinitionIndex)->GetStaticField(0xB100);
		}
		...
		::Class_1_EDBF989FCD2F91A5_Class_1_9E89B2D44593C915* _emptyPopUpGroupData; // 0x2C8
