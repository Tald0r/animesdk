...
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_CHECKINITCALLBACKGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x7A9DB00)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_GETPHOTOPERMISSIONSTATE_OFFSET UNITYSDK_OFFSET(0x7A9E660)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_HASPHOTOPERMISSIONBYMHYSDK_OFFSET UNITYSDK_OFFSET(0x7A9EBD0)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_HASPHOTOPERMISSION_OFFSET UNITYSDK_OFFSET(0x7A9E4D0)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_INIT_OFFSET UNITYSDK_OFFSET(0x7A9DA10)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_ISNEEDCHECKPERMISSION_ANDROID_OFFSET UNITYSDK_OFFSET(0x7A9E740)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_ONSAVEDPHOTOSALBUMFAILED_OFFSET UNITYSDK_OFFSET(0x7A9D8C0)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_ONSAVEDPHOTOSALBUMSUCCESS_OFFSET UNITYSDK_OFFSET(0x7A9D970)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_REQUESTPHOTOPERMISSIONBYMHYSDK_OFFSET UNITYSDK_OFFSET(0x7A9EFC0)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_REQUESTPHOTOPERMISSION_1_OFFSET UNITYSDK_OFFSET(0x7A9E590)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_REQUESTPHOTOPERMISSION_OFFSET UNITYSDK_OFFSET(0x7A9E530)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_SAVEDPHOTOSALBUM_ANDROID_OFFSET UNITYSDK_OFFSET(0x7A9DE40)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_SAVEDPHOTOSALBUM_OFFSET UNITYSDK_OFFSET(0x7A9DB80)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI_SAVEPHOTOSALBUM_IOS_OFFSET UNITYSDK_OFFSET(0x7A9E3F0)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI__CTOR_OFFSET UNITYSDK_OFFSET(0x7A9F450)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x7A9F480)

namespace MoleMole
{
	inline static constexpr unsigned int SavePhotosAlbumAPI_TypeDefinitionIndex = 60277;
