...
#define MOLEMOLE_UIURBANMAPLEFTLOCATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAE97B20)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapLeftLocationContext_TypeDefinitionIndex = 52240;

	class UIUrbanMapLeftLocationContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Action_1<::MoleMole::UIUrbanMapLeftLocationRowContext*>* OnConsoleSelect; // 0x28
