...
#define MOLEMOLE_MAINVOLUMESETTINGENTRY_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0xA02AAE0)
#define MOLEMOLE_MAINVOLUMESETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xA02AAD0)
#define MOLEMOLE_MAINVOLUMESETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xA02AC00)
#define MOLEMOLE_MAINVOLUMESETTINGENTRY___BASE_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0xA02AC20)

namespace MoleMole
{
	inline static constexpr unsigned int MainVolumeSettingEntry_TypeDefinitionIndex = 75839;
