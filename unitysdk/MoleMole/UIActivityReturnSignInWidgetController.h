...
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER_CREATENORMALITEMROW_OFFSET UNITYSDK_OFFSET(0xCFFF690)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER_CREATESPECIALITEMROW_OFFSET UNITYSDK_OFFSET(0xCFFF770)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0xCFFF430)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER_ONBACKFLOWTASKCHANGED_OFFSET UNITYSDK_OFFSET(0xCFFF850)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER_ONCLICKRETURNREWARDBTN_OFFSET UNITYSDK_OFFSET(0xCFFFA10)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFFF2B0)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xCFFF170)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCFFEF30)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFFF350)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFFE900)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFFEAD0)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER_OPENRETURNSIGNINWIDGET_OFFSET UNITYSDK_OFFSET(0xCFFEC90)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER_REFRESHSIGNINITEM_OFFSET UNITYSDK_OFFSET(0xCFFF0B0)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFFA90)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFFFAC0)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xCFFFB30)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCFFFB90)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFFFC00)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFFFC80)
#define MOLEMOLE_UIACTIVITYRETURNSIGNINWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFFFC90)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityReturnSignInWidgetController_TypeDefinitionIndex = 65134;
