...
#define MOLEMOLE_MONOMASKSLIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA472D10)
#define MOLEMOLE_MONOMASKSLIDER_GETRATIO_OFFSET UNITYSDK_OFFSET(0xA4732A0)
#define MOLEMOLE_MONOMASKSLIDER_INITIALIZED_OFFSET UNITYSDK_OFFSET(0xA472D80)
#define MOLEMOLE_MONOMASKSLIDER_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0xA472EB0)
#define MOLEMOLE_MONOMASKSLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xA473330)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMaskSlider_TypeDefinitionIndex = 43320;
