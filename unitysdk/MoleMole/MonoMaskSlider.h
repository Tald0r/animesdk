...
#define MOLEMOLE_MONOMASKSLIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0x67BE700)
#define MOLEMOLE_MONOMASKSLIDER_GETRATIO_OFFSET UNITYSDK_OFFSET(0x67BEC90)
#define MOLEMOLE_MONOMASKSLIDER_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x67BE770)
#define MOLEMOLE_MONOMASKSLIDER_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0x67BE8A0)
#define MOLEMOLE_MONOMASKSLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x67BED20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMaskSlider_TypeDefinitionIndex = 68719;
