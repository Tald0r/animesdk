...
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY_GETDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0xA495E20)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY_GET_SHOWGENERALDETAILDIALOGID_OFFSET UNITYSDK_OFFSET(0xA495E00)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY_GET__ISHIDEDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0xA495E10)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY_ISSETTINGWORKABLE_OFFSET UNITYSDK_OFFSET(0xA4960E0)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xA496380)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xA4963F0)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY___BASE_GETDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0xA496580)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xA4965E0)

namespace MoleMole
{
	inline static constexpr unsigned int PCAdvancedGraphicsEnumSettingEntry_TypeDefinitionIndex = 55550;
	...
	public:
		...
		::System::Int32 CustomDefaultIndex; // 0x54
		::System::Boolean CustomDefaultWorkable; // 0x58
