...
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY_GETDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0x7A99480)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY_GET_SHOWGENERALDETAILDIALOGID_OFFSET UNITYSDK_OFFSET(0x7A99460)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY_GET__ISHIDEDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0x7A99470)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY_ISSETTINGWORKABLE_OFFSET UNITYSDK_OFFSET(0x7A99740)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x7A999E0)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x7A99A50)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY___BASE_GETDEFAULTINDEX_OFFSET UNITYSDK_OFFSET(0x7A99BE0)
#define MOLEMOLE_PCADVANCEDGRAPHICSENUMSETTINGENTRY___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x7A99C40)

namespace MoleMole
{
	inline static constexpr unsigned int PCAdvancedGraphicsEnumSettingEntry_TypeDefinitionIndex = 49106;
	...
	public:
		...
		::System::Boolean CustomDefaultWorkable; // 0x50
		::System::Int32 GeneralDetailDialogID; // 0x54
