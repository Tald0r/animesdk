...
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ASPECTFORHEIGHT_OFFSET UNITYSDK_OFFSET(0xCA86C30)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_CHECKENDPAUSE_OFFSET UNITYSDK_OFFSET(0xCA87AA0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_CLOSEREADYMASK_OFFSET UNITYSDK_OFFSET(0xCA89510)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ENABLEROOTNOSKIPBTN_OFFSET UNITYSDK_OFFSET(0xCA87540)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_FULLSCREENVIDEOFADEOUT_OFFSET UNITYSDK_OFFSET(0xCA875F0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_GENERALBLACKMASKFADEIN_OFFSET UNITYSDK_OFFSET(0xCA868C0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_GETDURATION_OFFSET UNITYSDK_OFFSET(0xCA879C0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0xCA88F50)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA86660)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ONERROR_OFFSET UNITYSDK_OFFSET(0xCA894A0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ONFINISHED_OFFSET UNITYSDK_OFFSET(0xCA88850)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xCA87C40)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ONPREPARECOMPLETED_OFFSET UNITYSDK_OFFSET(0xCA895A0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ONSTARTED_OFFSET UNITYSDK_OFFSET(0xCA89A60)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ONSTARTPLAYEVIDEO_OFFSET UNITYSDK_OFFSET(0xCA88FC0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA86E60)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA86040)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA861E0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_OPENREADYMASK_OFFSET UNITYSDK_OFFSET(0xCA865D0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_PAUSE_OFFSET UNITYSDK_OFFSET(0xCA87810)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_PLAYMOVIEBARFADEIN_OFFSET UNITYSDK_OFFSET(0xCA86700)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_PLAYMOVIEBARFADEOUT_OFFSET UNITYSDK_OFFSET(0xCA86960)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0xCA87770)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_RECOVER_OFFSET UNITYSDK_OFFSET(0xCA878E0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_REGISTEREVENTHANDLER_OFFSET UNITYSDK_OFFSET(0xCA89200)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_SETPLAYANIMODE_OFFSET UNITYSDK_OFFSET(0xCA86410)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_SETUPSCREENASPECTRATIO_OFFSET UNITYSDK_OFFSET(0xCA86B10)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_STARTPLAYEVIDEO_OFFSET UNITYSDK_OFFSET(0xCA88B80)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_STEPFORWARD_OFFSET UNITYSDK_OFFSET(0xCA876F0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_STOP_OFFSET UNITYSDK_OFFSET(0xCA871B0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_TRYSETSPEED_OFFSET UNITYSDK_OFFSET(0xCA87D30)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCA87FD0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA89AD0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER__UPDATE_G___ACCELERATE_22_0_OFFSET UNITYSDK_OFFSET(0xCA88840)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA89B10)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xCA89B80)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA89BB0)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA89C30)
#define MOLEMOLE_UIVIDEOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA89C90)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoWidgetController_TypeDefinitionIndex = 77336;
	...
	public:
		...
		::Class_2_5EA04932F3E7FC4B* _audioTimelineTask; // 0x2E0
		...
		::System::Void StartPlayeVideo()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIDEOWIDGETCONTROLLER_STARTPLAYEVIDEO_OFFSET))(this);
		}

		::System::Void OnApplicationFocus(::System::Boolean isFocus)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ONAPPLICATIONFOCUS_OFFSET))(this, isFocus);
		}

		::System::Void OnStartPlayeVideo(::UnityEngine::Transform* trans)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Transform*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIDEOWIDGETCONTROLLER_ONSTARTPLAYEVIDEO_OFFSET))(this, trans);
		}
