...
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_ADDMONSTERIDTOLISTBYCFGID_OFFSET UNITYSDK_OFFSET(0x8EDB060)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_GETBOSSLEVEL_OFFSET UNITYSDK_OFFSET(0x8EDB4F0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_GETHOLLOWMONSTERIDLIST_OFFSET UNITYSDK_OFFSET(0x8EDA520)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_GETLEVELSTRBYID_OFFSET UNITYSDK_OFFSET(0x8EDB430)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_UPDATEBOSSCFGLIST_OFFSET UNITYSDK_OFFSET(0x8EDA350)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x8EDB680)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW___BASE_GETBOSSLEVEL_OFFSET UNITYSDK_OFFSET(0x8EDB700)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW___BASE_UPDATEBOSSCFGLIST_OFFSET UNITYSDK_OFFSET(0x8EDB760)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterCardInfoPopWindowController_Hollow_TypeDefinitionIndex = 40611;

	class UIMonsterCardInfoPopWindowController_Hollow : public ::MoleMole::UIMonsterCardInfoPopWindowController
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*>* HollowMonsterIDToAppearLevelDict; // 0x348
