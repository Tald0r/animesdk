...
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_ADDMONSTERIDTOLISTBYCFGID_OFFSET UNITYSDK_OFFSET(0xA3C7280)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_GETBOSSLEVEL_OFFSET UNITYSDK_OFFSET(0xA3C7710)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_GETHOLLOWMONSTERIDLIST_OFFSET UNITYSDK_OFFSET(0xA3C6740)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_GETLEVELSTRBYID_OFFSET UNITYSDK_OFFSET(0xA3C7650)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW_UPDATEBOSSCFGLIST_OFFSET UNITYSDK_OFFSET(0xA3C6570)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0xA3C78A0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW___BASE_GETBOSSLEVEL_OFFSET UNITYSDK_OFFSET(0xA3C7920)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_HOLLOW___BASE_UPDATEBOSSCFGLIST_OFFSET UNITYSDK_OFFSET(0xA3C7980)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterCardInfoPopWindowController_Hollow_TypeDefinitionIndex = 72060;
