...
#define MOLEMOLE_UIREDEEMREWARDDIALOGPOPWINDOWCONTROLLER__ASYNCREDEEMREWARDCODE_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x472A60)
#define MOLEMOLE_UIREDEEMREWARDDIALOGPOPWINDOWCONTROLLER__ASYNCREDEEMREWARDCODE_D__23_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2CA890)

namespace MoleMole
{
	inline static constexpr unsigned int UIRedeemRewardDialogPopWindowController__AsyncRedeemRewardCode_d__23_TypeDefinitionIndex = 41584;
	...
	struct alignas(8) UIRedeemRewardDialogPopWindowController__AsyncRedeemRewardCode_d__23
	{
		...
		::System::Net::WebResponse* _resp_5__2; // 0x18
		::System::IO::StreamReader* _reader_5__3; // 0x20
		::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder; // 0x28
		::System::Runtime::CompilerServices::TaskAwaiter_1<::System::Net::WebResponse*> __u__1; // 0x48
		::System::String* convertUrl; // 0x50
