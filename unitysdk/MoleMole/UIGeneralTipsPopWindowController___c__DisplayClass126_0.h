...
#define MOLEMOLE_UIGENERALTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS126_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC0587D0)
#define MOLEMOLE_UIGENERALTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS126_0__INITINSUFFICIENTITEMSSCROLLVIEW_B__0_OFFSET UNITYSDK_OFFSET(0xC0587E0)
#define MOLEMOLE_UIGENERALTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS126_0__INITINSUFFICIENTITEMSSCROLLVIEW_B__1_OFFSET UNITYSDK_OFFSET(0xC058910)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTipsPopWindowController___c__DisplayClass126_0_TypeDefinitionIndex = 73921;
