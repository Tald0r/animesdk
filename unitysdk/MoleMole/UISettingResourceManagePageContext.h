...
#define MOLEMOLE_UISETTINGRESOURCEMANAGEPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAE471A0)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingResourceManagePageContext_TypeDefinitionIndex = 74396;
