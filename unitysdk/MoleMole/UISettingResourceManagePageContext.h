...
#define MOLEMOLE_UISETTINGRESOURCEMANAGEPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7512EE0)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingResourceManagePageContext_TypeDefinitionIndex = 43161;
