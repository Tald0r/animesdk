...
#define MOLEMOLE_UIAVATARSTORYSPECAILINFOCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xADB3E00)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarStorySpecailInfoContext_TypeDefinitionIndex = 49060;
