...
#define MOLEMOLE_UICIRCLEREPORTSELECTDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC0BA200)

namespace MoleMole
{
	inline static constexpr unsigned int UICircleReportSelectDialogPopWindowController_Context_TypeDefinitionIndex = 56911;
