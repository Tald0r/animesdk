...
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ABS_1_OFFSET UNITYSDK_OFFSET(0x8F88880)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ABS_OFFSET UNITYSDK_OFFSET(0x8F88820)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CHECKHASBITID_OFFSET UNITYSDK_OFFSET(0x8F899C0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CHECKHASBITMASK_OFFSET UNITYSDK_OFFSET(0x8F89A80)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CLAMP01_OFFSET UNITYSDK_OFFSET(0x8F88A30)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x8F88980)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_CLAMP_OFFSET UNITYSDK_OFFSET(0x8F88900)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_DIV_OFFSET UNITYSDK_OFFSET(0x8F87BC0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_FINDMAXBIT_OFFSET UNITYSDK_OFFSET(0x8F89780)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_FINDMINBIT_OFFSET UNITYSDK_OFFSET(0x8F89540)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_FRAMETOTIME_OFFSET UNITYSDK_OFFSET(0x8F883A0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_GETEPS_OFFSET UNITYSDK_OFFSET(0x8F87CE0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_GETFRACTIONALPART_OFFSET UNITYSDK_OFFSET(0x8F89100)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_HERMITEINTERPOLATE_OFFSET UNITYSDK_OFFSET(0x8F89340)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISEQUAL_1_OFFSET UNITYSDK_OFFSET(0x8F89470)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISEQUAL_OFFSET UNITYSDK_OFFSET(0x8F87D70)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISGREATEROREQUAL_OFFSET UNITYSDK_OFFSET(0x8F88160)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISGREATER_OFFSET UNITYSDK_OFFSET(0x8F87F90)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISINT_OFFSET UNITYSDK_OFFSET(0x8F89060)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISLESSOREQUAL_OFFSET UNITYSDK_OFFSET(0x8F880A0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISLESS_OFFSET UNITYSDK_OFFSET(0x8F87E80)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_ISZERO_OFFSET UNITYSDK_OFFSET(0x8F88220)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_NICEFY_OFFSET UNITYSDK_OFFSET(0x8F88C70)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_POWOF_OFFSET UNITYSDK_OFFSET(0x8F88BC0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_SIGN_1_OFFSET UNITYSDK_OFFSET(0x8F885C0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_SIGN_OFFSET UNITYSDK_OFFSET(0x8F88550)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_SQRT_OFFSET UNITYSDK_OFFSET(0x8F88B30)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_SQUARE_OFFSET UNITYSDK_OFFSET(0x8F88AC0)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_TIMETOFRAME_OFFSET UNITYSDK_OFFSET(0x8F88310)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_TOFLOAT_OFFSET UNITYSDK_OFFSET(0x8F87C80)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_TUBESPLINE_OFFSET UNITYSDK_OFFSET(0x8F89180)
#define MOLEMOLE_MATHUTIL_FLOATEXTENSION_UPCASEOF_OFFSET UNITYSDK_OFFSET(0x8F88D90)

namespace MoleMole::MathUtil
{
	inline static constexpr unsigned int FloatExtension_TypeDefinitionIndex = 66847;
