...
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__WAITCLICKCONTINUEBTN_D__94_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x392CD0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__WAITCLICKCONTINUEBTN_D__94_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerWidgetController__WaitClickContinueBtn_d__94_TypeDefinitionIndex = 70197;
