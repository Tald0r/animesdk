...
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__WAITCLICKCONTINUEBTN_D__94_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3AAAF0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__WAITCLICKCONTINUEBTN_D__94_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerWidgetController__WaitClickContinueBtn_d__94_TypeDefinitionIndex = 66346;
