...
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA3DE680)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___C__DISPLAYCLASS8_0__REFRESHSELFIEMOTIONDATA_B__0_OFFSET UNITYSDK_OFFSET(0xA3DE690)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoSettingChildWindowController___c__DisplayClass8_0_TypeDefinitionIndex = 76828;
