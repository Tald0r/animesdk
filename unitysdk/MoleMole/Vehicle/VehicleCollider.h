...
#include "unitysdk/MoleMole/Vehicle/VehicleCollider_Enum_3_86FE569E9DF85315.h"
...
#define MOLEMOLE_VEHICLE_VEHICLECOLLIDER_GETRADIUS_OFFSET UNITYSDK_OFFSET(0x88A0C40)
#define MOLEMOLE_VEHICLE_VEHICLECOLLIDER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x88A0480)
#define MOLEMOLE_VEHICLE_VEHICLECOLLIDER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x88A08B0)
#define MOLEMOLE_VEHICLE_VEHICLECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x88A0E20)

namespace MoleMole::Vehicle
{
	inline static constexpr unsigned int VehicleCollider_TypeDefinitionIndex = 70105;

	class VehicleCollider : public ::UnityEngine::MonoBehaviour
	{
	public:
		::MoleMole::Vehicle::VehicleCollider_Enum_3_86FE569E9DF85315 ColliderType; // 0x18
