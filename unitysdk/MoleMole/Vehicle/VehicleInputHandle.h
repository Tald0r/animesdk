...
#define MOLEMOLE_VEHICLE_VEHICLEINPUTHANDLE_METHOD_1_27D1E4F4A131E859_OFFSET UNITYSDK_OFFSET(0x7C6F680)
#define MOLEMOLE_VEHICLE_VEHICLEINPUTHANDLE_METHOD_1_F74E03079DF2932E_OFFSET UNITYSDK_OFFSET(0x7C6F560)
#define MOLEMOLE_VEHICLE_VEHICLEINPUTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x7C6F550)

namespace MoleMole::Vehicle
{
	inline static constexpr unsigned int VehicleInputHandle_TypeDefinitionIndex = 44938;
