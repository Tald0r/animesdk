...
#define MOLEMOLE_VEHICLE_VEHICLEMONO_ENTERVOLUME_OFFSET UNITYSDK_OFFSET(0x6B00710)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_EXCLUDESOUNDOBJECT_OFFSET UNITYSDK_OFFSET(0x6B00890)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_EXITVOLUME_OFFSET UNITYSDK_OFFSET(0x6B007E0)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_GETHITCOUNT_OFFSET UNITYSDK_OFFSET(0x6AFF2D0)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_GET_HITCOUNT_OFFSET UNITYSDK_OFFSET(0x6AFF250)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_GET_PREVIEW_OFFSET UNITYSDK_OFFSET(0x6AFEFB0)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_GET_VEHICLEUNIT_OFFSET UNITYSDK_OFFSET(0x6AFF350)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_INITENTITY_OFFSET UNITYSDK_OFFSET(0x6B00030)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x6AFFD80)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x6AFF3E0)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_METHOD_5_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x6B00430)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_METHOD_5_BA80D36BDA3B5115_OFFSET UNITYSDK_OFFSET(0x6AFF180)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_ONTIMESCALECHANGED_OFFSET UNITYSDK_OFFSET(0x6B00AF0)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x6AFFFC0)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_OVERRIDEMAXSPEED_OFFSET UNITYSDK_OFFSET(0x6B00920)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_STARTRUN_OFFSET UNITYSDK_OFFSET(0x6B005F0)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_START_OFFSET UNITYSDK_OFFSET(0x6AFF360)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_TRYGETVEHICLECOMPONENT_OFFSET UNITYSDK_OFFSET(0x6B00CC0)
#define MOLEMOLE_VEHICLE_VEHICLEMONO_UPDATE_OFFSET UNITYSDK_OFFSET(0x6AFF600)
#define MOLEMOLE_VEHICLE_VEHICLEMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x6B00DE0)

namespace MoleMole::Vehicle
{
	inline static constexpr unsigned int VehicleMono_TypeDefinitionIndex = 73502;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_VEHICLE_VEHICLEMONO_METHOD_5_B7F8E0B4AF22DEA3_OFFSET))(this);
		}
