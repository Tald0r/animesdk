...
#define MOLEMOLE_VEHICLE_VEHICLECONFIG_METHOD_1_623160C745FC10C0_OFFSET UNITYSDK_OFFSET(0x73F7850)
#define MOLEMOLE_VEHICLE_VEHICLECONFIG_METHOD_1_8C97CA3BAB7FB2D7_OFFSET UNITYSDK_OFFSET(0x73F7910)
#define MOLEMOLE_VEHICLE_VEHICLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x73F6EE0)

namespace MoleMole::Vehicle
{
	inline static constexpr unsigned int VehicleConfig_TypeDefinitionIndex = 53430;
