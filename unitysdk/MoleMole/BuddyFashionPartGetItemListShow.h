...
#define MOLEMOLE_BUDDYFASHIONPARTGETITEMLISTSHOW_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x81CE060)
#define MOLEMOLE_BUDDYFASHIONPARTGETITEMLISTSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x81CE050)
#define MOLEMOLE_BUDDYFASHIONPARTGETITEMLISTSHOW___BASE_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x81CE380)

namespace MoleMole
{
	inline static constexpr unsigned int BuddyFashionPartGetItemListShow_TypeDefinitionIndex = 48811;
