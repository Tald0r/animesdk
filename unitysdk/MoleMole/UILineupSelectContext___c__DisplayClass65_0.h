...
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS65_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8F162A0)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS65_0__SETHOLLOWQUESTCONTEXT_B__0_OFFSET UNITYSDK_OFFSET(0x8F162B0)
#define MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS65_0__SETHOLLOWQUESTCONTEXT_G__ONPOSTGETBUDDYSELECTCONTEXT_1_OFFSET UNITYSDK_OFFSET(0x8F16600)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectContext___c__DisplayClass65_0_TypeDefinitionIndex = 56007;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_44EFB945CAE441A3*))((::PBYTE)hIl2Cpp + MOLEMOLE_UILINEUPSELECTCONTEXT___C__DISPLAYCLASS65_0__SETHOLLOWQUESTCONTEXT_B__0_OFFSET))(this, data);
		}
