...
#define MOLEMOLE_GENERALGRAPHICQUALITYPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xE1087A0)

namespace MoleMole
{
	inline static constexpr unsigned int GeneralGraphicQualityProfileContext_TypeDefinitionIndex = 40092;
