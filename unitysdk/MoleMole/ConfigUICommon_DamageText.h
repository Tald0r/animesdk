...
#define MOLEMOLE_CONFIGUICOMMON_DAMAGETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD33140)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_DamageText_TypeDefinitionIndex = 61697;
