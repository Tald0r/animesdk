...
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_BINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xAAD4100)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_GETBTNTEXT_OFFSET UNITYSDK_OFFSET(0xAAD6200)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xAAD3F10)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAAD3F00)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONCLICKCONSOLECHECKCONSUMEBTN_OFFSET UNITYSDK_OFFSET(0xAAD6B20)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONCLICKCONSUMEICONBTN_OFFSET UNITYSDK_OFFSET(0xAAD6A60)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAAD3F20)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONINFOCLICKED_OFFSET UNITYSDK_OFFSET(0xAAD6410)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONITEMCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0xAAD60E0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONLEVELUPOKCLICKED_OFFSET UNITYSDK_OFFSET(0xAAD65B0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAAD4810)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAAD45F0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAAD3FC0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAAD4700)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAAD4900)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER_SHOWLEVELUPERRORHINT_OFFSET UNITYSDK_OFFSET(0xAAD6320)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAAD6C30)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER__ONLEVELUPOKCLICKED_B__37_0_OFFSET UNITYSDK_OFFSET(0xAAD6E00)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER__ONLEVELUPOKCLICKED_B__37_1_OFFSET UNITYSDK_OFFSET(0xAAD6DC0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAAD6F70)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAAD6FE0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAAD6FF0)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAAD7000)
#define MOLEMOLE_UIROLESKILLLEVELUPPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAAD7010)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSkillLevelUpPopWindowController_TypeDefinitionIndex = 70562;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_114* _view; // 0x2F8
