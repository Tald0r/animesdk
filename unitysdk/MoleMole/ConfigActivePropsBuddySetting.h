...
#define MOLEMOLE_CONFIGACTIVEPROPSBUDDYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x14197C60)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigActivePropsBuddySetting_TypeDefinitionIndex = 48672;
