...
#define MOLEMOLE_CONFIGACTIVEPROPSBUDDYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xBB053D0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigActivePropsBuddySetting_TypeDefinitionIndex = 57151;
