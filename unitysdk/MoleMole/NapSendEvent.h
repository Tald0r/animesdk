...
#define MOLEMOLE_NAPSENDEVENT_ONRESET_OFFSET UNITYSDK_OFFSET(0x67C8260)
#define MOLEMOLE_NAPSENDEVENT_ONSTART_OFFSET UNITYSDK_OFFSET(0x67C7910)
#define MOLEMOLE_NAPSENDEVENT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x67C7A50)
#define MOLEMOLE_NAPSENDEVENT_RESOLVETARGET_OFFSET UNITYSDK_OFFSET(0x67C82E0)
#define MOLEMOLE_NAPSENDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x67C8580)
#define MOLEMOLE_NAPSENDEVENT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x67C85C0)
#define MOLEMOLE_NAPSENDEVENT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x67C8650)
#define MOLEMOLE_NAPSENDEVENT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x67C86E0)

namespace MoleMole
{
	inline static constexpr unsigned int NapSendEvent_TypeDefinitionIndex = 73154;
