...
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7517C10)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7517CB0)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7517AC0)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7517B60)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_REFRESHFINISH_OFFSET UNITYSDK_OFFSET(0x7517E40)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x7517EF0)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_SHOWPARTICLE_OFFSET UNITYSDK_OFFSET(0x7517D90)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_TRYPLAYGETANIM_OFFSET UNITYSDK_OFFSET(0x7517FA0)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7518150)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7518180)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x75181F0)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7518270)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x75182D0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianStartRow02WidgetController_TypeDefinitionIndex = 65329;

	class UISuibianStartRow02WidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_BCA11629035BC7F2_3* _view; // 0x2A0
