...
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE4B990)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE4BA30)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE4B840)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE4B8E0)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_REFRESHFINISH_OFFSET UNITYSDK_OFFSET(0xAE4BBC0)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xAE4BC70)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_SHOWPARTICLE_OFFSET UNITYSDK_OFFSET(0xAE4BB10)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER_TRYPLAYGETANIM_OFFSET UNITYSDK_OFFSET(0xAE4BD20)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE4BED0)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE4BF00)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE4BF70)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE4BFF0)
#define MOLEMOLE_UISUIBIANSTARTROW02WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE4C050)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianStartRow02WidgetController_TypeDefinitionIndex = 69866;

	class UISuibianStartRow02WidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_BCA11629035BC7F2_4* _view; // 0x2A0
