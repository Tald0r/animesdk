...
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS63_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA4CD7F0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___C__DISPLAYCLASS63_0__SHOWINVITE_B__0_OFFSET UNITYSDK_OFFSET(0xA4CD800)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadePageController___c__DisplayClass63_0_TypeDefinitionIndex = 66638;
