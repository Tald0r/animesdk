...
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_DOPLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0xD789E80)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD786790)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_INITANDPLAYVIDEO_OFFSET UNITYSDK_OFFSET(0xD788DA0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_INITENTRYBTNS_OFFSET UNITYSDK_OFFSET(0xD7885B0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_INITGAMEPADCUSTOMLIST_OFFSET UNITYSDK_OFFSET(0xD786390)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xD7868B0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_NEEDPLAYLEVELUPGRADE_OFFSET UNITYSDK_OFFSET(0xD7871E0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD7867A0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xD786FC0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xD788500)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD7876F0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD786EB0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD786840)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD786E00)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_OPENINFO_OFFSET UNITYSDK_OFFSET(0xD7890D0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_OPENMISSIONPAGE_OFFSET UNITYSDK_OFFSET(0xD7892B0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_PLAYLEVELUPGRADE_OFFSET UNITYSDK_OFFSET(0xD7874B0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD787770)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_SETACTIVITYAVATARREWARDBTNS_OFFSET UNITYSDK_OFFSET(0xD7889C0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_SETLEVELANDEXP_OFFSET UNITYSDK_OFFSET(0xD789430)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0xD7898D0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD78A1E0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER__INITANDPLAYVIDEO_B__19_0_OFFSET UNITYSDK_OFFSET(0xD78AA20)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER__INITVIEW_B__11_0_OFFSET UNITYSDK_OFFSET(0xD78A240)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER__INITVIEW_B__11_2_OFFSET UNITYSDK_OFFSET(0xD78A2A0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER__INITVIEW_B__11_3_OFFSET UNITYSDK_OFFSET(0xD78A460)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER__REFRESHVIEW_B__14_0_OFFSET UNITYSDK_OFFSET(0xD78A780)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD78AA40)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xD78AAB0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xD78AAC0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD78AB20)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD78AB30)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD78AB40)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD78AB50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeMainPageController_TypeDefinitionIndex = 55553;

	class UIMiniscapeMainPageController : public ::MoleMole::UIWindowController
	{
	public:
		// static const ::System::String* BackVideoUrl; // 0x0
		::Class_2_60638234271CCDB8_93* _view; // 0x2F8
		::Class_1_7ECB9691B142D586* _videoPlayerHelper; // 0x300
		::System::Collections::Generic::List_1<::MoleMole::UIWidgetController*>* _entryBtns; // 0x308
		::MoleMole::UIActivityCompWeekRewardBtnWidgetController* _rewardBtn01; // 0x310
		::MoleMole::UIActivityCompWeekRewardBtnWidgetController* _rewardBtn02; // 0x318
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7ECB9691B142D586*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER__INITANDPLAYVIDEO_B__19_0_OFFSET))(this, helper);
		}
