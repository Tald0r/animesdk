...
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_DOPLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0xC141E40)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC13E740)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_INITANDPLAYVIDEO_OFFSET UNITYSDK_OFFSET(0xC140D60)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_INITENTRYBTNS_OFFSET UNITYSDK_OFFSET(0xC140570)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_INITGAMEPADCUSTOMLIST_OFFSET UNITYSDK_OFFSET(0xC13E340)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC13E860)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_NEEDPLAYLEVELUPGRADE_OFFSET UNITYSDK_OFFSET(0xC13F190)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC13E750)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xC13EF70)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xC1404C0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC13F6B0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC13EE60)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC13E7F0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC13EDB0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_OPENINFO_OFFSET UNITYSDK_OFFSET(0xC141090)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_OPENMISSIONPAGE_OFFSET UNITYSDK_OFFSET(0xC141270)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_PLAYLEVELUPGRADE_OFFSET UNITYSDK_OFFSET(0xC13F470)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC13F730)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_SETACTIVITYAVATARREWARDBTNS_OFFSET UNITYSDK_OFFSET(0xC140980)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_SETLEVELANDEXP_OFFSET UNITYSDK_OFFSET(0xC1413F0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0xC141890)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC1421A0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER__INITANDPLAYVIDEO_B__19_0_OFFSET UNITYSDK_OFFSET(0xC1429E0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER__INITVIEW_B__11_0_OFFSET UNITYSDK_OFFSET(0xC142200)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER__INITVIEW_B__11_2_OFFSET UNITYSDK_OFFSET(0xC142260)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER__INITVIEW_B__11_3_OFFSET UNITYSDK_OFFSET(0xC142420)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER__REFRESHVIEW_B__14_0_OFFSET UNITYSDK_OFFSET(0xC142740)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC142A00)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xC142A70)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xC142A80)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC142AE0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC142AF0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC142B00)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC142B10)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeMainPageController_TypeDefinitionIndex = 40658;

	class UIMiniscapeMainPageController : public ::MoleMole::UIWindowController
	{
	public:
		// static const ::System::String* BackVideoUrl; // 0x0
		::Class_2_60638234271CCDB8_36* _view; // 0x2F8
