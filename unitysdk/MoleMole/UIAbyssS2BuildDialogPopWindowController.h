...
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_BUILDINLEVELITEMPACKAGEINFO_OFFSET UNITYSDK_OFFSET(0xC247D50)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_CREATEITEMROW_OFFSET UNITYSDK_OFFSET(0xC247B90)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_CREATERELICROW_OFFSET UNITYSDK_OFFSET(0xC247C70)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_CREATETITLEROW_OFFSET UNITYSDK_OFFSET(0xC247AB0)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_GETITEMCTRL_OFFSET UNITYSDK_OFFSET(0xC2488F0)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0xC247950)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_GETVALIDINDEX_OFFSET UNITYSDK_OFFSET(0xC249690)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC246B00)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_GET__ISBRIEFDESC_OFFSET UNITYSDK_OFFSET(0xC247F20)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_GET__MAXINDEX_OFFSET UNITYSDK_OFFSET(0xC246E20)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_INITBRIEFTOGGLE_OFFSET UNITYSDK_OFFSET(0xC246E40)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC2475F0)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xC249150)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC248320)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xC249220)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xC248E90)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_ONTOGGLECHANGE_OFFSET UNITYSDK_OFFSET(0xC247720)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC247690)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC246B10)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC246C80)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_REFRESHITEMVIEW_OFFSET UNITYSDK_OFFSET(0xC247290)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_SELECTITEM_OFFSET UNITYSDK_OFFSET(0xC248550)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_SETDEFAULTSELECTEDITEM_OFFSET UNITYSDK_OFFSET(0xC248190)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_SETITEMSCROLLWIDGETFUNC_OFFSET UNITYSDK_OFFSET(0xC2470C0)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2498B0)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER__SETDEFAULTSELECTEDITEM_B__20_0_OFFSET UNITYSDK_OFFSET(0xC249940)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC249950)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xC2499C0)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC249A40)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xC249A70)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC249AD0)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC249AE0)
#define MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC249AF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2BuildDialogPopWindowController_TypeDefinitionIndex = 71228;

	class UIAbyssS2BuildDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79AE422BA06F6D26_195* _view; // 0x2F8
		...
		{
			return ((::Class_0_16E4307DCC419505_451*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2BUILDDIALOGPOPWINDOWCONTROLLER_GETITEMCTRL_OFFSET))(this, index);
		}
