...
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_CHANGETOSTATE_OFFSET UNITYSDK_OFFSET(0xAE90CF0)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_CLICKQTEFF_OFFSET UNITYSDK_OFFSET(0xAE91870)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_GETBUTTON_OFFSET UNITYSDK_OFFSET(0xAE90720)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_GET_BUTTONSTATE_OFFSET UNITYSDK_OFFSET(0xAE90300)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_HIDETIPS_OFFSET UNITYSDK_OFFSET(0xAE91460)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE90960)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_ONDOWNCALL_OFFSET UNITYSDK_OFFSET(0xAE907A0)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE90A00)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE90310)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_ONUPCALL_OFFSET UNITYSDK_OFFSET(0xAE90880)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAE90F40)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_SETLONGEFFECTONPRESS_OFFSET UNITYSDK_OFFSET(0xAE91900)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_SHOWTIPS_OFFSET UNITYSDK_OFFSET(0xAE913A0)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_UPDATEBATTLEPROGRESS_OFFSET UNITYSDK_OFFSET(0xAE917D0)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER_UPDATEQTECIRCLE_OFFSET UNITYSDK_OFFSET(0xAE91520)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER__CHANGETOSTATE_B__20_0_OFFSET UNITYSDK_OFFSET(0xAE91BB0)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE91B80)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE91BC0)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE91C30)
#define MOLEMOLE_UISUMMERFISHCLICKBUTTONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE91CB0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishClickButtonWidgetController_TypeDefinitionIndex = 38938;
	...
	public:
		...
		::Class_2_60638234271CCDB8_17* _view; // 0x2A0
