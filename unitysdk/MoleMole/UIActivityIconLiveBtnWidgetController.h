...
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFF9110)
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xCFF9840)
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFF91B0)
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFF8E90)
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFF9060)
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCFF9290)
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF99C0)
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFF99F0)
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xCFF9A60)
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFF9AC0)
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFF9B40)
#define MOLEMOLE_UIACTIVITYICONLIVEBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFF9BA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityIconLiveBtnWidgetController_TypeDefinitionIndex = 42301;

	class UIActivityIconLiveBtnWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_74EAE7375772B9FE* _view; // 0x2A0
		::Class_1_D375C91CCE5D3999* _rootActivity; // 0x2A8
		::Class_1_D375C91CCE5D3999* _curActivity; // 0x2B0
		::System::Boolean _isSelect; // 0x2B8
