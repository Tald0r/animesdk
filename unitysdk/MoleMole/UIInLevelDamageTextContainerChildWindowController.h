...
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ADDENTITYDAMAGECOUNT_OFFSET UNITYSDK_OFFSET(0x9D55720)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_CLEARDAMAGETEXTDATA_OFFSET UNITYSDK_OFFSET(0x9D54CB0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_CLEARMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0x9D54DF0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_COMBINEDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x9D4EC00)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_CREATESPECIALDAMAGETEXTCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9D5B120)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_DESTROYALLCOMBINETEXT_OFFSET UNITYSDK_OFFSET(0x9D51E90)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_DESTROYSPECIALDAMAGETEXTV3CACHE_OFFSET UNITYSDK_OFFSET(0x9D551C0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_DOPREBATTLEPREFABWARMUP_OFFSET UNITYSDK_OFFSET(0x9D53BF0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_DOSHOWONEDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x9D58470)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GENERATECOMBINEGPUDAMAGETEXTITEM_OFFSET UNITYSDK_OFFSET(0x9D4F480)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GENERATEGPUDAMAGETEXTITEM_OFFSET UNITYSDK_OFFSET(0x9D51030)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETCOMBINEDAMAGETEXTMISCPOSOFFSETINFO_OFFSET UNITYSDK_OFFSET(0x9D4DFB0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETDAMAGETEXTSHOWINFO_OFFSET UNITYSDK_OFFSET(0x9D57C60)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETEFFECTCOLORINDEX_OFFSET UNITYSDK_OFFSET(0x9D5D160)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETENTITYDAMAGECOUNT_OFFSET UNITYSDK_OFFSET(0x9D55AF0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETENTITYDAMAGETEXTLENGTH_OFFSET UNITYSDK_OFFSET(0x9D55BB0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETFACEINDEX_OFFSET UNITYSDK_OFFSET(0x9D5CF40)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETGPUTEXTSCREENSPACERATIO_OFFSET UNITYSDK_OFFSET(0x9D4F690)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETMAXDAMAGE_OFFSET UNITYSDK_OFFSET(0x9D55C80)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETROOTALPHA_OFFSET UNITYSDK_OFFSET(0x9D556A0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETSCREENSPACEPOSOFFSET_OFFSET UNITYSDK_OFFSET(0x9D4F840)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETSPECIALDAMAGETEXTLANGUAGETYPE_OFFSET UNITYSDK_OFFSET(0x9D5D280)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETSPECIALDAMAGEV3TEXTPATHDICT_OFFSET UNITYSDK_OFFSET(0x9D5D320)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETTARGETFOLLOWTYPE_OFFSET UNITYSDK_OFFSET(0x9D56230)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GETTMPFONTMATERIAL_OFFSET UNITYSDK_OFFSET(0x9D5B4D0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9D527C0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_INITCOMBINETEXT_OFFSET UNITYSDK_OFFSET(0x9D4DD50)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_INITDAMAGETEXTFOLLOWDAMPING_OFFSET UNITYSDK_OFFSET(0x9D53F60)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_INITMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0x9D530E0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_INITSPECIALDAMAGETEXTV3CACHE_OFFSET UNITYSDK_OFFSET(0x9D53AA0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x9D52C10)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ISDAMAGETEXTVALID_OFFSET UNITYSDK_OFFSET(0x9D5A710)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ISDAMAGETOAVATARCOMP_OFFSET UNITYSDK_OFFSET(0x9D57FB0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ISENABLEDAMAGETEXTCOMBINE_OFFSET UNITYSDK_OFFSET(0x9D4DDB0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ISINVIEW_OFFSET UNITYSDK_OFFSET(0x9D571A0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONAFTERCAMERALATEUPDATENOTIFY_OFFSET UNITYSDK_OFFSET(0x9D55CE0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONCHARACTERULTPERFORMSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x9D56390)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9D527D0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONDAMAGETEXTEND_OFFSET UNITYSDK_OFFSET(0x9D5D1F0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONPAUSEGAMESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x9D562B0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONQTEWINDOWTYPECHANGED_OFFSET UNITYSDK_OFFSET(0x9D56320)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONSHOWDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x9D56400)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONSHOWONLYSPECIALDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x9D56B20)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x9D547B0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9D54820)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9D52870)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9D54280)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONUPDATETEXTAFTERCAMERAUPDATE_OFFSET UNITYSDK_OFFSET(0x9D55D50)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_ONUPDATETEXT_OFFSET UNITYSDK_OFFSET(0x9D55290)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_PLAYSPECIALDAMAGETEXTV3AUDIO_OFFSET UNITYSDK_OFFSET(0x9D5A780)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_QUERYDAMAGETEXTINFO_OFFSET UNITYSDK_OFFSET(0x9D5B630)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_REFRESHPAUSESTATE_OFFSET UNITYSDK_OFFSET(0x9D54340)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_REFRESHSPECIALDAMAGETEXTV3CACHE_OFFSET UNITYSDK_OFFSET(0x9D58870)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_REMOVEENTITYDAMAGECOUNT_1_OFFSET UNITYSDK_OFFSET(0x9D55940)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_REMOVEENTITYDAMAGECOUNT_OFFSET UNITYSDK_OFFSET(0x9D558A0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETDAMAGERANDOMCHANGEDEBUG_OFFSET UNITYSDK_OFFSET(0x9D554E0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETDAMAGETEXTCRITICALDEBUG_OFFSET UNITYSDK_OFFSET(0x9D55470)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETDAMAGETEXTRANDOMENABLED_OFFSET UNITYSDK_OFFSET(0x9D55400)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETDAMAGETEXTRESISTTYPEDEBUG_OFFSET UNITYSDK_OFFSET(0x9D555C0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETDAMAGETEXTTARGETFOLLOWTYPEDEBUG_OFFSET UNITYSDK_OFFSET(0x9D55630)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETDEBUGENABLESPECIALDAMAGETEXTV3_OFFSET UNITYSDK_OFFSET(0x9D55320)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETDEBUGSCREENSPACEYOFFSET_OFFSET UNITYSDK_OFFSET(0x9D5DA10)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETDEBUGSPECIALDAMAGETEXTLANGUAGETYPE_OFFSET UNITYSDK_OFFSET(0x9D5D910)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETDEBUGSPECIALDAMAGETEXTTYPE_OFFSET UNITYSDK_OFFSET(0x9D5D9A0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETFORCEISSKIPDEFATTACKDEBUG_OFFSET UNITYSDK_OFFSET(0x9D55550)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETMULTITEXTDEBUG_OFFSET UNITYSDK_OFFSET(0x9D55390)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETUPDAMAGETEXTGPUVIEW_OFFSET UNITYSDK_OFFSET(0x9D5A1F0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETUPDAMAGETEXTTMPVIEW_OFFSET UNITYSDK_OFFSET(0x9D59B20)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETUPSPECIALDAMAGETEXTV2VIEW_OFFSET UNITYSDK_OFFSET(0x9D5AB00)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SETUPSPECIALDAMAGETEXTV3VIEW_OFFSET UNITYSDK_OFFSET(0x9D59020)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SHOWDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x9D56690)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SHOWONEDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x9D57390)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_SHOWONLYSPECIALDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x9D56D90)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_TICKCOMBINETEXT_OFFSET UNITYSDK_OFFSET(0x9D4CF60)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_TRYSHOWDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x9D57220)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER_USETMPDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x9D57F40)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9D5DDF0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D5DA90)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9D5DE50)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x9D5DEC0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9D5DED0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9D5DEE0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTCONTAINERCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9D5DEF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelDamageTextContainerChildWindowController_TypeDefinitionIndex = 50663;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Foundation::AssetPath>**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelDamageTextContainerChildWindowController_TypeDefinitionIndex)->GetStaticField(0x3B910);
		}
		static ::System::Int32* StaticGet_DebugCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelDamageTextContainerChildWindowController_TypeDefinitionIndex)->GetStaticField(0xE740);
		}
		...
		::Class_2_B2D7C9A580953038_1* _view; // 0x310
		...
		::Enum_3_9C193B7FFD286787 _damageTextWidgetType; // 0x338
