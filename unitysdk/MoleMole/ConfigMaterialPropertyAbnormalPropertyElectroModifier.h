...
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER_DOAFTERONENTER_OFFSET UNITYSDK_OFFSET(0xE0C5350)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER_DOONENTER_OFFSET UNITYSDK_OFFSET(0xE0C5230)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER_DOWARMUP_OFFSET UNITYSDK_OFFSET(0xE0C8310)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER_PREPAREONENTER_OFFSET UNITYSDK_OFFSET(0xE0C4B50)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER_PREPAREONEXIT_OFFSET UNITYSDK_OFFSET(0xE0C55D0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER_PROCESSENTER_OFFSET UNITYSDK_OFFSET(0xE0C5410)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER_PROCESSEXIT_OFFSET UNITYSDK_OFFSET(0xE0C56B0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER_PROCESSKEEP_OFFSET UNITYSDK_OFFSET(0xE0C6DC0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER_SYNCENABLES_OFFSET UNITYSDK_OFFSET(0xE0C6310)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER_SYNCVALUES_OFFSET UNITYSDK_OFFSET(0xE0C5940)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0xE0C84B0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER___BASE_DOAFTERONENTER_OFFSET UNITYSDK_OFFSET(0xE0C84F0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER___BASE_DOONENTER_OFFSET UNITYSDK_OFFSET(0xE0C8500)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER___BASE_DOWARMUP_OFFSET UNITYSDK_OFFSET(0xE0C8510)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER___BASE_PREPAREONENTER_OFFSET UNITYSDK_OFFSET(0xE0C8570)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER___BASE_PREPAREONEXIT_OFFSET UNITYSDK_OFFSET(0xE0C85D0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER___BASE_PROCESSENTER_OFFSET UNITYSDK_OFFSET(0xE0C8640)
#define MOLEMOLE_CONFIGMATERIALPROPERTYABNORMALPROPERTYELECTROMODIFIER___BASE_PROCESSEXIT_OFFSET UNITYSDK_OFFSET(0xE0C86F0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigMaterialPropertyAbnormalPropertyElectroModifier_TypeDefinitionIndex = 73257;
	...
	public:
		...
		::MoleMole::MaterialPropertyModifierValueFloat _FresnelWidth; // 0xA8
		::UnityEngine::Color _DetailColorRef; // 0xB0
		::MoleMole::MaterialPropertyModifierValueFloat _PropertyTexUVFlipSpeed; // 0xC0
		::MoleMole::MaterialPropertyModifierValueFloat _PropertyMaskUVFlipSpeed; // 0xC8
		::MoleMole::MaterialPropertyModifierValueFloat _PropertyTexUseUV2; // 0xD0
		::UnityEngine::Color _PropertyColorRef; // 0xD8
		::System::Single _FresnelFlashingRef; // 0xE8
		::MoleMole::MaterialPropertyModifierValueVector _PropertyTexUVSpeed; // 0xEC
		::UnityEngine::Color _PropertyColorDefault; // 0x104
		::MoleMole::MaterialPropertyModifierValueFloat _FresnelFlashing; // 0x114
		::MoleMole::MaterialPropertyModifierValueColor _DetailColor; // 0x11C
		::MoleMole::MaterialPropertyModifierValueColor _PropertyColor; // 0x130
		::UnityEngine::Color _FresnelColorDefault; // 0x144
		::MoleMole::MaterialPropertyModifierValueBool _AbnormalPropertyElectro; // 0x154
		::MoleMole::MaterialPropertyModifierEnumDefine::MaterialPropertyModifierValueMaskChannelType _PropertyMaskChannel; // 0x157
		::MoleMole::MaterialPropertyModifierValueFloat _FresnelMaskWidth; // 0x15C
		::UnityEngine::Color _FresnelColorRef; // 0x164
		::UnityEngine::Color _DetailColorDefault; // 0x174
		::MoleMole::MaterialPropertyModifierValueColor _FresnelColor; // 0x184
		::MoleMole::MaterialPropertyModifierValueVector _PropertyMaskUVSpeed; // 0x198
		::System::Single _FresnelFlashingDefault; // 0x1B0
