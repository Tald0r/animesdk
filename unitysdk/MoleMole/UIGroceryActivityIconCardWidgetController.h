...
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C49010)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8C49190)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C490B0)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C48F70)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_SHOWTIPS_OFFSET UNITYSDK_OFFSET(0x8C49800)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C49890)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C498A0)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8C49910)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C49990)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C49A10)

namespace MoleMole
{
	inline static constexpr unsigned int UIGroceryActivityIconCardWidgetController_TypeDefinitionIndex = 63288;

	class UIGroceryActivityIconCardWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_8DFAD49526A3038A* _view; // 0x2D0
		::Class_1_47F263CB5C51B1A3_1* refRewardData; // 0x2D8
