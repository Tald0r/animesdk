...
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB0FA450)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB0FA5D0)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB0FA4F0)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB0FA3B0)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER_SHOWTIPS_OFFSET UNITYSDK_OFFSET(0xB0FAC40)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB0FACD0)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB0FACE0)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB0FAD50)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB0FADD0)
#define MOLEMOLE_UIGROCERYACTIVITYICONCARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB0FAE50)

namespace MoleMole
{
	inline static constexpr unsigned int UIGroceryActivityIconCardWidgetController_TypeDefinitionIndex = 50625;
