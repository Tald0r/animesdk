...
class Class_2_56AF18CD74DA940A_12;
...
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ADDITEMCOLLECTBYINDEX_1_OFFSET UNITYSDK_OFFSET(0x892F5D0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ADDITEMCOLLECTBYINDEX_OFFSET UNITYSDK_OFFSET(0x892F2E0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GETFADEOUTEFFECTPARTICLE_OFFSET UNITYSDK_OFFSET(0x8931870)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GETPIECEINDEXUIPOS_OFFSET UNITYSDK_OFFSET(0x8931340)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GET_BOTTOMCTRL_OFFSET UNITYSDK_OFFSET(0x8930830)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GET_CHESSBOARD3DCTRL_OFFSET UNITYSDK_OFFSET(0x892F420)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GET_HOLLOWMAINPAGE_OFFSET UNITYSDK_OFFSET(0x8931BB0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_INITMOVEFINALPOS_OFFSET UNITYSDK_OFFSET(0x892E8D0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8931660)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x892E750)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x892E7F0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x892E1B0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x892E6A0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_PLAYGRIDCOLLECTIONDATA_OFFSET UNITYSDK_OFFSET(0x892FC90)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_POPEFFECT_OFFSET UNITYSDK_OFFSET(0x8931080)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_PROLOADEFFECTPOOL_OFFSET UNITYSDK_OFFSET(0x892E600)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_RECYCLEEFFECT_OFFSET UNITYSDK_OFFSET(0x8931730)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_RECYCLEFADEOUTEFFECTPARTICLE_OFFSET UNITYSDK_OFFSET(0x8931A90)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_SHOWEFFECTATPOS_OFFSET UNITYSDK_OFFSET(0x8930980)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_TRYTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x892FA00)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8931D60)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8931FE0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8932050)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x89320D0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8932130)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemCollectWidgetController_TypeDefinitionIndex = 62666;

	class UIHollowItemCollectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_56AF18CD74DA940A_12* _view; // 0x2A0
