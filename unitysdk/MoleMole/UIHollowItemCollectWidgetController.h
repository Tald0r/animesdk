...
class Class_2_56AF18CD74DA940A_11;
...
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ADDITEMCOLLECTBYINDEX_1_OFFSET UNITYSDK_OFFSET(0x97F9B40)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ADDITEMCOLLECTBYINDEX_OFFSET UNITYSDK_OFFSET(0x97F9850)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GETFADEOUTEFFECTPARTICLE_OFFSET UNITYSDK_OFFSET(0x97FBDE0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GETPIECEINDEXUIPOS_OFFSET UNITYSDK_OFFSET(0x97FB8B0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GET_BOTTOMCTRL_OFFSET UNITYSDK_OFFSET(0x97FAD90)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GET_CHESSBOARD3DCTRL_OFFSET UNITYSDK_OFFSET(0x97F9990)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_GET_HOLLOWMAINPAGE_OFFSET UNITYSDK_OFFSET(0x97FC120)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_INITMOVEFINALPOS_OFFSET UNITYSDK_OFFSET(0x97F8E40)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x97FBBD0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x97F8CC0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x97F8D60)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x97F8720)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x97F8C10)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_PLAYGRIDCOLLECTIONDATA_OFFSET UNITYSDK_OFFSET(0x97FA200)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_POPEFFECT_OFFSET UNITYSDK_OFFSET(0x97FB5F0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_PROLOADEFFECTPOOL_OFFSET UNITYSDK_OFFSET(0x97F8B70)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_RECYCLEEFFECT_OFFSET UNITYSDK_OFFSET(0x97FBCA0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_RECYCLEFADEOUTEFFECTPARTICLE_OFFSET UNITYSDK_OFFSET(0x97FC000)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_SHOWEFFECTATPOS_OFFSET UNITYSDK_OFFSET(0x97FAEE0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER_TRYTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x97F9F70)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x97FC2D0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x97FC550)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x97FC5C0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x97FC640)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x97FC6A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemCollectWidgetController_TypeDefinitionIndex = 60071;

	class UIHollowItemCollectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_56AF18CD74DA940A_11* _view; // 0x2A0
		::Foundation::ObjectPool_1<::MoleMole::UIHollowItemCollectWidgetController_GridCollectionData*>* _gridCollectionPool; // 0x2A8
		::System::Collections::Generic::Dictionary_2<::MoleMole::HollowChessboard::HollowCell, ::MoleMole::UIHollowItemCollectWidgetController_GridCollectionData*>* _collectionData; // 0x2B0
		::System::Collections::Generic::Dictionary_2<::MoleMole::HollowChessboard::HollowCell, ::UnityEngine::Vector3>* _index2PosCacheDic; // 0x2B8
		::System::Collections::Generic::List_1<::MoleMole::UIHollowItemCollectEffectWidgetController*>* _activeEffects; // 0x2C0
		::System::Collections::Generic::List_1<::MoleMole::UIHollowItemCollectEffectWidgetController*>* _itemCollectEffectPool; // 0x2C8
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::UnityEngine::ParticleSystem*>*>* _fadeOutParticlePoolDic; // 0x2D0
		::UnityEngine::Vector3 _coinFinalPos; // 0x2D8
		::UnityEngine::Vector3 _dinyFinalPos; // 0x2E4
		::UnityEngine::Vector3 _itemFinalPos; // 0x2F0
		::UnityEngine::GameObject* _coinTargetGo; // 0x300
		::UnityEngine::GameObject* _dinyTargetGo; // 0x308
		::UnityEngine::GameObject* _itemTargetGo; // 0x310
		::MoleMole::Config::ConfigHollowChessboard_ItemCollectConfigData* _itemCollectConfig; // 0x318
		::MoleMole::UIHollowMainPageController* _mainPage; // 0x320
		::MoleMole::UIHollowChessboard3DModelController* _chessboard3DCtrl; // 0x328
		::UnityEngine::RectTransform* _uiRect; // 0x330
