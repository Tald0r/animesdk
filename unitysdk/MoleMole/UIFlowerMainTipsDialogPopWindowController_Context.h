...
#define MOLEMOLE_UIFLOWERMAINTIPSDIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_FLOWERQUESTDETAILDATA_OFFSET UNITYSDK_OFFSET(0xA356C90)
#define MOLEMOLE_UIFLOWERMAINTIPSDIALOGPOPWINDOWCONTROLLER_CONTEXT_SET_FLOWERQUESTDETAILDATA_OFFSET UNITYSDK_OFFSET(0xA356CA0)
#define MOLEMOLE_UIFLOWERMAINTIPSDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA356CB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMainTipsDialogPopWindowController_Context_TypeDefinitionIndex = 58078;
