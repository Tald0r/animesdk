...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS59_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8A104D0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS59_0__PLAYVOICE_B__0_OFFSET UNITYSDK_OFFSET(0x8A104E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass59_0_TypeDefinitionIndex = 54682;

	class UIGalgamePageController___c__DisplayClass59_0 : public ::System::Object
	{
	public:
		::System::String* voiceKey; // 0x10
		::System::String* facialKey; // 0x18
