...
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_ONCLICKSHOWREWARD_OFFSET UNITYSDK_OFFSET(0x8A26B60)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_ONCLICKTELEPORT_OFFSET UNITYSDK_OFFSET(0x8A26A50)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8A26430)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8A265B0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8A264D0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8A25E70)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x8A260B0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x8A26690)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8A26D00)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER__ONCLICKTELEPORT_B__8_0_OFFSET UNITYSDK_OFFSET(0x8A26D10)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8A26DE0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8A26E50)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8A26ED0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8A26F50)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookAwakenItemWidgetController_TypeDefinitionIndex = 71262;

	class UIHandBookAwakenItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_146* _view; // 0x2D0
