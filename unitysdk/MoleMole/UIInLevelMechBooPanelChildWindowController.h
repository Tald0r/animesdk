...
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_CHANGEMATERIAL_OFFSET UNITYSDK_OFFSET(0x7A7F9A0)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x7A7F8E0)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x7A7E6D0)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x7A7E850)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x7A7E990)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x7A7F660)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7A7E6E0)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7A7E780)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER_SETTHRESHOLDLINEPOSITION_OFFSET UNITYSDK_OFFSET(0x7A7F600)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7A7FA00)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x7A7FA10)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7A7FA70)
#define MOLEMOLE_UIINLEVELMECHBOOPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7A7FAE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelMechBooPanelChildWindowController_TypeDefinitionIndex = 38001;
	...
	public:
		...
		::Class_2_71CF00AF09C72A79_1* _view; // 0x330
