...
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC11C520)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__SHOWSPECIALBTNPANEL_B__0_OFFSET UNITYSDK_OFFSET(0xC11C530)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___C__DISPLAYCLASS9_0__SHOWSPECIALBTNPANEL_B__1_OFFSET UNITYSDK_OFFSET(0xC11C5A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemUsePopWindowController___c__DisplayClass9_0_TypeDefinitionIndex = 77886;
