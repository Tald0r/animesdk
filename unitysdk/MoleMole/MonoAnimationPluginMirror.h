...
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_0089E869E2D4144B_OFFSET UNITYSDK_OFFSET(0xD80B690)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_0EE1F7F192FB3754_OFFSET UNITYSDK_OFFSET(0xD80BAD0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_4DFE64B6A1B8E9ED_OFFSET UNITYSDK_OFFSET(0xD80B4A0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xD80BAC0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xD80B900)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_PLAY_1_OFFSET UNITYSDK_OFFSET(0xD80AFF0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_PLAY_OFFSET UNITYSDK_OFFSET(0xD80ADA0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0xD80B740)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_STOPCURFADE_OFFSET UNITYSDK_OFFSET(0xD80AEB0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_STOP_OFFSET UNITYSDK_OFFSET(0xD80BC10)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR__CTOR_OFFSET UNITYSDK_OFFSET(0xD80BDB0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoAnimationPluginMirror_TypeDefinitionIndex = 38560;
	...
	public:
		...
		::System::Void Method_6_0EE1F7F192FB3754()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_0EE1F7F192FB3754_OFFSET))(this);
		}
