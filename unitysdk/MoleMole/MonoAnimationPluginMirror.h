...
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_0089E869E2D4144B_OFFSET UNITYSDK_OFFSET(0xB9990F0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_0EE1F7F192FB3754_OFFSET UNITYSDK_OFFSET(0xB999530)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_4DFE64B6A1B8E9ED_OFFSET UNITYSDK_OFFSET(0xB998F00)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xB999520)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xB999360)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_PLAY_1_OFFSET UNITYSDK_OFFSET(0xB998A50)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_PLAY_OFFSET UNITYSDK_OFFSET(0xB998800)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0xB9991A0)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_STOPCURFADE_OFFSET UNITYSDK_OFFSET(0xB998910)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR_STOP_OFFSET UNITYSDK_OFFSET(0xB999670)
#define MOLEMOLE_MONOANIMATIONPLUGINMIRROR__CTOR_OFFSET UNITYSDK_OFFSET(0xB999810)

namespace MoleMole
{
	inline static constexpr unsigned int MonoAnimationPluginMirror_TypeDefinitionIndex = 51720;
