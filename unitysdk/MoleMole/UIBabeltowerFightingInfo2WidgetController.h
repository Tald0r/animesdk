...
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0xA31BCB0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_INITBUDDY_OFFSET UNITYSDK_OFFSET(0xA31B0F0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_INITPOOLDATA_OFFSET UNITYSDK_OFFSET(0xA31AF60)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA319FC0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA31A280)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_ONNEWBIECLOSE_OFFSET UNITYSDK_OFFSET(0xA31A1C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA31A8A0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_ONPOSTSETROLECARDDATA_OFFSET UNITYSDK_OFFSET(0xA31A3F0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_ONPOWERBTNCLICK_OFFSET UNITYSDK_OFFSET(0xA31AE50)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA31A100)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_OPENDETAILDIALOG_OFFSET UNITYSDK_OFFSET(0xA31B290)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_REFRESHBUFFSTATE_OFFSET UNITYSDK_OFFSET(0xA31A550)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_REFRESHPOWERGET_OFFSET UNITYSDK_OFFSET(0xA31ABC0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_REFRESHPOWERTEXT_OFFSET UNITYSDK_OFFSET(0xA31B5C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_REQBABELTOWERBEGINFIGHT_OFFSET UNITYSDK_OFFSET(0xA31B6A0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER_UPDATEFLOORINDEX_OFFSET UNITYSDK_OFFSET(0xA31BA00)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA31BEE0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER__ONNEWBIECLOSE_B__3_0_OFFSET UNITYSDK_OFFSET(0xA31BEF0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER__ONPOSTREFRESHVIEW_B__7_0_OFFSET UNITYSDK_OFFSET(0xA31BF10)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER___BASE_INITBUDDY_OFFSET UNITYSDK_OFFSET(0xA31BF20)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER___BASE_INITPOOLDATA_OFFSET UNITYSDK_OFFSET(0xA31BF30)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA31BF40)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA31BFE0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER___BASE_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA31C020)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER___BASE_ONPOSTSETROLECARDDATA_OFFSET UNITYSDK_OFFSET(0xA31C080)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA31C090)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER___BASE_OPENDETAILDIALOG_OFFSET UNITYSDK_OFFSET(0xA31C0A0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER___BASE_REFRESHBUFFSTATE_OFFSET UNITYSDK_OFFSET(0xA31C0B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER___BASE_REQBABELTOWERBEGINFIGHT_OFFSET UNITYSDK_OFFSET(0xA31C0C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER___BASE_UPDATEFLOORINDEX_OFFSET UNITYSDK_OFFSET(0xA31C0D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerFightingInfo2WidgetController_TypeDefinitionIndex = 42569;

	class UIBabeltowerFightingInfo2WidgetController : public ::MoleMole::UIBabeltowerFightingInfoWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_50* _view; // 0x380
		...
		::System::Void __base_ReqBabelTowerBeginFight(::System::Int32 P0, ::System::UInt32 P1, ::System::Int32 P2, ::System::Collections::Generic::List_1<::System::Int32>* P3, ::System::Collections::Generic::List_1<::System::Int32>* P4, ::System::Collections::Generic::List_1<::System::Int32>* P5, ::System::Boolean P6, ::System::Int32 P7, ::System::Action_2<::System::Boolean, ::Class_3_025FF4981524A424_488*>* P8)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::UInt32, ::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*, ::System::Collections::Generic::List_1<::System::Int32>*, ::System::Collections::Generic::List_1<::System::Int32>*, ::System::Boolean, ::System::Int32, ::System::Action_2<::System::Boolean, ::Class_3_025FF4981524A424_488*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERFIGHTINGINFO2WIDGETCONTROLLER___BASE_REQBABELTOWERBEGINFIGHT_OFFSET))(this, P0, P1, P2, P3, P4, P5, P6, P7, P8);
		}
