...
#define MOLEMOLE_UIGENERALCLAIMPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD568250)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralClaimPopWindowController_Context_TypeDefinitionIndex = 48142;
	...
	public:
		...
		::System::Int32 SourceItemID; // 0x48
