...
#define MOLEMOLE_MONOGENETALCOUNTDOWN_HASTIMESWITCHING_OFFSET UNITYSDK_OFFSET(0xA3AB1E0)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_METHOD_5_BA724052783C600E_OFFSET UNITYSDK_OFFSET(0xA3AA040)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA3AB4F0)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_RESET_OFFSET UNITYSDK_OFFSET(0xA3A9D70)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_SETTIMEFORCE_OFFSET UNITYSDK_OFFSET(0xA3A9F40)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_SETTIMEICONFORCE_OFFSET UNITYSDK_OFFSET(0xA3AA2A0)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_SETTIMEICON_OFFSET UNITYSDK_OFFSET(0xA3AAB80)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_SETTIME_OFFSET UNITYSDK_OFFSET(0xA3AAA60)
#define MOLEMOLE_MONOGENETALCOUNTDOWN_WILLCHANGETIMEICON_OFFSET UNITYSDK_OFFSET(0xA3AA6E0)
#define MOLEMOLE_MONOGENETALCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0xA3AB710)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGenetalCountDown_TypeDefinitionIndex = 77966;
	...
	public:
		...
		::System::Boolean HasTimeSwitching(::Class_2_208CC9941471731A_186*& a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_186*&))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGENETALCOUNTDOWN_HASTIMESWITCHING_OFFSET))(this, a1);
		}
