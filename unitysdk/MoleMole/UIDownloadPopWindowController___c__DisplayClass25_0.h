...
#define MOLEMOLE_UIDOWNLOADPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCC84800)
#define MOLEMOLE_UIDOWNLOADPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__SHOWDOWNLOADSUCCESS_B__0_OFFSET UNITYSDK_OFFSET(0xCC84920)
#define MOLEMOLE_UIDOWNLOADPOPWINDOWCONTROLLER___C__DISPLAYCLASS25_0__SHOWDOWNLOADSUCCESS_B__1_OFFSET UNITYSDK_OFFSET(0xCC84950)

namespace MoleMole
{
	inline static constexpr unsigned int UIDownloadPopWindowController___c__DisplayClass25_0_TypeDefinitionIndex = 51867;
