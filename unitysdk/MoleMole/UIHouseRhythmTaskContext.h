...
#define MOLEMOLE_UIHOUSERHYTHMTASKCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBB55D10)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmTaskContext_TypeDefinitionIndex = 68688;
