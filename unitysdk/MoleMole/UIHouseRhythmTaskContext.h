...
#define MOLEMOLE_UIHOUSERHYTHMTASKCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA39E760)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmTaskContext_TypeDefinitionIndex = 75218;
