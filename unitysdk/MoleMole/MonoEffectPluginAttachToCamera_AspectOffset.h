...
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_ASPECTOFFSET_GET_SUBISSHOWADDFOVMINMAX_OFFSET UNITYSDK_OFFSET(0x35D950)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAttachToCamera_AspectOffset_TypeDefinitionIndex = 62231;
