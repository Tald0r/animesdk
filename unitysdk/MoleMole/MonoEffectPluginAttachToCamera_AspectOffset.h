...
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_ASPECTOFFSET_GET_SUBISSHOWADDFOVMINMAX_OFFSET UNITYSDK_OFFSET(0x2F2060)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAttachToCamera_AspectOffset_TypeDefinitionIndex = 40386;
