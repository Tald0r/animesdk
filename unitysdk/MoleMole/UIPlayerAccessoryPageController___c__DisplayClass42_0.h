...
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD398FF0)
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER___C__DISPLAYCLASS42_0__SENDCHANGESKIN_B__1_OFFSET UNITYSDK_OFFSET(0xD399020)
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER___C__DISPLAYCLASS42_0__SENDCHANGESKIN_B__4_OFFSET UNITYSDK_OFFSET(0xD399000)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerAccessoryPageController___c__DisplayClass42_0_TypeDefinitionIndex = 39871;
