...
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC8315D0)
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER___C__DISPLAYCLASS42_0__SENDCHANGESKIN_B__1_OFFSET UNITYSDK_OFFSET(0xC831600)
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER___C__DISPLAYCLASS42_0__SENDCHANGESKIN_B__4_OFFSET UNITYSDK_OFFSET(0xC8315E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerAccessoryPageController___c__DisplayClass42_0_TypeDefinitionIndex = 77119;
