...
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CLEARNOWTABREGIST_OFFSET UNITYSDK_OFFSET(0xA34EA20)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CLOSE_OFFSET UNITYSDK_OFFSET(0xA34F570)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CREATEFILTERANDSORTDATA_OFFSET UNITYSDK_OFFSET(0xA34D4D0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xA353910)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CURITEMHASJUMPITEMS_OFFSET UNITYSDK_OFFSET(0xA3530C0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GETCURRENTFILTER_OFFSET UNITYSDK_OFFSET(0xA3546E0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GETITEMSONUSEACTION_OFFSET UNITYSDK_OFFSET(0xA353800)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA34F0B0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GOTODETAIL_OFFSET UNITYSDK_OFFSET(0xA353320)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_INITDEPOSITORYPREVIEWWIDGET_OFFSET UNITYSDK_OFFSET(0xA353860)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA34FAF0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ISCURRENTTYPEITEM_OFFSET UNITYSDK_OFFSET(0xA352C00)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA34F0C0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONDEPOSITORYITEMDELNEWUPDATEBADGE_OFFSET UNITYSDK_OFFSET(0xA3504B0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA353010)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA352DE0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA34F630)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0xA34EB00)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONITEMCREATEDORDESTROYED_OFFSET UNITYSDK_OFFSET(0xA350BA0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONONSYNCBGPOS_OFFSET UNITYSDK_OFFSET(0xA350D30)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONSHOWEQUIPWEAPON_OFFSET UNITYSDK_OFFSET(0xA353710)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA350520)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONSORTERMARKDELETECLICK_OFFSET UNITYSDK_OFFSET(0xA354050)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONSORTORFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0xA353FD0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONTABBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xA350E30)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA34F410)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA34F160)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA34F830)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA34F1F0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_OPENCOMPOSEUI_OFFSET UNITYSDK_OFFSET(0xA353C00)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_OPENDISMANTLEUI_OFFSET UNITYSDK_OFFSET(0xA353E40)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_OPENRECYCLEUI_OFFSET UNITYSDK_OFFSET(0xA353CB0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_OPENSUITFILTERPOPUP_OFFSET UNITYSDK_OFFSET(0xA354530)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHCURTABITEMNUM_OFFSET UNITYSDK_OFFSET(0xA351FB0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHCURTABITEMSDATA_OFFSET UNITYSDK_OFFSET(0xA350EC0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHFETCHBTN_OFFSET UNITYSDK_OFFSET(0xA34EF90)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0xA34ED60)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHPREVIEWBYITEMDATA_OFFSET UNITYSDK_OFFSET(0xA3524A0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHTABNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0xA34E410)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA3506B0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REQUIREREFRESHONSHOW_OFFSET UNITYSDK_OFFSET(0xA34ECE0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_RESETFOCUS_OFFSET UNITYSDK_OFFSET(0xA350AF0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SAVEJUMPPARASBYINDEX_OFFSET UNITYSDK_OFFSET(0xA352A70)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SAVEJUMPPARAS_OFFSET UNITYSDK_OFFSET(0xA3534D0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SELECTITEMBYINDEXONITEMUIDCHANGE_OFFSET UNITYSDK_OFFSET(0xA353B90)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SELECTITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0xA351E40)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SETCURRENTTABINDEX_OFFSET UNITYSDK_OFFSET(0xA34E610)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SETSCROLLSELECTBYINDEX_OFFSET UNITYSDK_OFFSET(0xA352840)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SETUPTAB_OFFSET UNITYSDK_OFFSET(0xA34CFF0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA354780)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__INITVIEW_B__67_0_OFFSET UNITYSDK_OFFSET(0xA354820)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__INITVIEW_B__67_1_OFFSET UNITYSDK_OFFSET(0xA354830)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__INITVIEW_B__67_2_OFFSET UNITYSDK_OFFSET(0xA354840)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__REFRESHCURTABITEMSDATA_G__ADDITEMTOICONLIST_52_0_OFFSET UNITYSDK_OFFSET(0xA352330)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_CLOSE_OFFSET UNITYSDK_OFFSET(0xA354940)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA354950)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA3549C0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA354A30)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA354AB0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA354AE0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA354AF0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA354B00)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA354B10)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA354B20)

namespace MoleMole
{
	inline static constexpr unsigned int UIDepositoryPageController_TypeDefinitionIndex = 61042;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_201* _view; // 0x300
		...
		::Class_2_7AE1A22930C1CD01<::Class_1_1685EC66FBD28897*>* _sorter; // 0x370
		::MoleMole::UIControllerContextBase* _cachedContext; // 0x378
		::Il2CppArray<::Enum_3_F4064C0F9CEA5153>* _tabSorters; // 0x380
		::Il2CppArray<::Class_1_C8F9732D07C3EF21<::Class_1_1685EC66FBD28897*>*>* _filterDataList; // 0x388
		::Class_0_16E4307DCC41950C_13<::Class_1_1685EC66FBD28897*>* suitFilterGroupData; // 0x390
		...
		{
			return ((::System::ValueTuple_2<::Class_1_C8F9732D07C3EF21<::Class_1_1685EC66FBD28897*>*, ::Il2CppArray<::Struct_2_6AB58C5477BF48DC>*>(*)(::PVOID, ::System::Collections::Generic::List_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CREATEFILTERANDSORTDATA_OFFSET))(this, classTypes);
		}
		...
		::Class_1_C8F9732D07C3EF21<::Class_1_1685EC66FBD28897*>* GetCurrentFilter()
		{
			return ((::Class_1_C8F9732D07C3EF21<::Class_1_1685EC66FBD28897*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GETCURRENTFILTER_OFFSET))(this);
		}
