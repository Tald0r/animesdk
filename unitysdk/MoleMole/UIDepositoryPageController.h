...
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CLEARNOWTABREGIST_OFFSET UNITYSDK_OFFSET(0xD1189C0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CLOSE_OFFSET UNITYSDK_OFFSET(0xD119510)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CREATEFILTERANDSORTDATA_OFFSET UNITYSDK_OFFSET(0xD117450)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xD11D8E0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CURITEMHASJUMPITEMS_OFFSET UNITYSDK_OFFSET(0xD11D090)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GETCURRENTFILTER_OFFSET UNITYSDK_OFFSET(0xD11E6B0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GETITEMSONUSEACTION_OFFSET UNITYSDK_OFFSET(0xD11D7D0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD119050)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GOTODETAIL_OFFSET UNITYSDK_OFFSET(0xD11D2F0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_INITDEPOSITORYPREVIEWWIDGET_OFFSET UNITYSDK_OFFSET(0xD11D830)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xD119AA0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ISCURRENTTYPEITEM_OFFSET UNITYSDK_OFFSET(0xD11CBD0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD119060)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONDEPOSITORYITEMDELNEWUPDATEBADGE_OFFSET UNITYSDK_OFFSET(0xD11A470)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xD11CFE0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD11CDB0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD1195D0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0xD118AA0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONITEMCREATEDORDESTROYED_OFFSET UNITYSDK_OFFSET(0xD11AB60)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONONSYNCBGPOS_OFFSET UNITYSDK_OFFSET(0xD11ACF0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONSHOWEQUIPWEAPON_OFFSET UNITYSDK_OFFSET(0xD11D6E0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD11A4E0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONSORTERMARKDELETECLICK_OFFSET UNITYSDK_OFFSET(0xD11E020)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONSORTORFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0xD11DFA0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONTABBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xD11ADF0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD1193B0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD119100)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD1197D0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD119190)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_OPENCOMPOSEUI_OFFSET UNITYSDK_OFFSET(0xD11DBD0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_OPENDISMANTLEUI_OFFSET UNITYSDK_OFFSET(0xD11DE10)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_OPENRECYCLEUI_OFFSET UNITYSDK_OFFSET(0xD11DC80)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_OPENSUITFILTERPOPUP_OFFSET UNITYSDK_OFFSET(0xD11E500)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHCURTABITEMNUM_OFFSET UNITYSDK_OFFSET(0xD11BF60)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHCURTABITEMSDATA_OFFSET UNITYSDK_OFFSET(0xD11AE80)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHFETCHBTN_OFFSET UNITYSDK_OFFSET(0xD118F30)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0xD118D00)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHPREVIEWBYITEMDATA_OFFSET UNITYSDK_OFFSET(0xD11C470)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHTABNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0xD1183A0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD11A670)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_REQUIREREFRESHONSHOW_OFFSET UNITYSDK_OFFSET(0xD118C80)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_RESETFOCUS_OFFSET UNITYSDK_OFFSET(0xD11AAB0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SAVEJUMPPARASBYINDEX_OFFSET UNITYSDK_OFFSET(0xD11CA40)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SAVEJUMPPARAS_OFFSET UNITYSDK_OFFSET(0xD11D4A0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SELECTITEMBYINDEXONITEMUIDCHANGE_OFFSET UNITYSDK_OFFSET(0xD11DB60)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SELECTITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0xD11BDF0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SETCURRENTTABINDEX_OFFSET UNITYSDK_OFFSET(0xD1185A0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SETSCROLLSELECTBYINDEX_OFFSET UNITYSDK_OFFSET(0xD11C810)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_SETUPTAB_OFFSET UNITYSDK_OFFSET(0xD116F70)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD11E750)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__INITVIEW_B__67_0_OFFSET UNITYSDK_OFFSET(0xD11E7F0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__INITVIEW_B__67_1_OFFSET UNITYSDK_OFFSET(0xD11E800)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__INITVIEW_B__67_2_OFFSET UNITYSDK_OFFSET(0xD11E810)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER__REFRESHCURTABITEMSDATA_G__ADDITEMTOICONLIST_52_0_OFFSET UNITYSDK_OFFSET(0xD11C2F0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_CLOSE_OFFSET UNITYSDK_OFFSET(0xD11E910)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD11E920)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xD11E990)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD11EA00)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD11EA80)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD11EAB0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD11EAC0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD11EAD0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD11EAE0)
#define MOLEMOLE_UIDEPOSITORYPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD11EAF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDepositoryPageController_TypeDefinitionIndex = 51945;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::Int32>* registClassType; // 0x2F8
		::Class_2_79AE422BA06F6D26_121* _view; // 0x300
		::System::Int32 _curTabIndex; // 0x308
		::MoleMole::UIDepositoryPageController_ERefreshType _onShowRefreshType; // 0x30C
		::System::Collections::Generic::List_1<::MoleMole::UITabBtn01RowWidgetController*>* _tabsList; // 0x310
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*>* _tabClassTypeDict; // 0x318
		::Class_2_9D9172C07F82DDAE* _itemModel; // 0x320
		::System::Int32 _tabItemsNum; // 0x328
		::System::Collections::Generic::List_1<::Class_1_1685EC66FBD28897*>* _tabItems; // 0x330
		::System::Collections::Generic::List_1<::Class_1_1685EC66FBD28897*>* _filteredTabItems; // 0x338
		::System::Collections::Generic::List_1<::System::Boolean>* _tabShowComposeBtns; // 0x340
		::System::Collections::Generic::List_1<::System::Boolean>* _tabShowRecycleBtns; // 0x348
		::System::Collections::Generic::List_1<::System::Boolean>* _tabShowDismantleBtns; // 0x350
		::MonoUITableScrollV2* _scrollRectEx; // 0x358
		::UnityEngine::UI::Extension::UITabButtonGroup* _tabButtonGroup; // 0x360
		::UnityEngine::Transform* _tabContentRoot; // 0x368
		::Class_2_2BD3078077E999CE<::Class_1_1685EC66FBD28897*>* _sorter; // 0x370
		::MoleMole::UIControllerContextBase* _cachedContext; // 0x378
		::Il2CppArray<::Enum_3_F4064C0F9CEA5153>* _tabSorters; // 0x380
		::Il2CppArray<::Class_1_859934EE40ACBAD7<::Class_1_1685EC66FBD28897*>*>* _filterDataList; // 0x388
		::Class_0_16E4307DCC41950C_15<::Class_1_1685EC66FBD28897*>* suitFilterGroupData; // 0x390
		::MoleMole::UIDepositoryPreviewWidgetController* previewWidget; // 0x398
		::System::Int32 m_weaponTabIndex; // 0x3A0
		::System::Int32 m_equipTabIndex; // 0x3A4
		::System::Int32 m_weaponMaxNum; // 0x3A8
		::System::Int32 m_equipMaxNum; // 0x3AC
		::System::Int32 m_curSelectIndex; // 0x3B0
		::System::UInt64 m_curItemUID; // 0x3B8
		...
		::System::ValueTuple_2<::Class_1_859934EE40ACBAD7<::Class_1_1685EC66FBD28897*>*, ::Il2CppArray<::Struct_2_6AB58C5477BF48DC>*> CreateFilterAndSortData(::System::Collections::Generic::List_1<::System::Int32>* classTypes)
		{
			return ((::System::ValueTuple_2<::Class_1_859934EE40ACBAD7<::Class_1_1685EC66FBD28897*>*, ::Il2CppArray<::Struct_2_6AB58C5477BF48DC>*>(*)(::PVOID, ::System::Collections::Generic::List_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_CREATEFILTERANDSORTDATA_OFFSET))(this, classTypes);
		}
		...
		::Class_1_859934EE40ACBAD7<::Class_1_1685EC66FBD28897*>* GetCurrentFilter()
		{
			return ((::Class_1_859934EE40ACBAD7<::Class_1_1685EC66FBD28897*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDEPOSITORYPAGECONTROLLER_GETCURRENTFILTER_OFFSET))(this);
		}
