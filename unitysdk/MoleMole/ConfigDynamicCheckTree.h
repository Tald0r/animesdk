...
#define MOLEMOLE_CONFIGDYNAMICCHECKTREE__CTOR_OFFSET UNITYSDK_OFFSET(0xCCACEC0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigDynamicCheckTree_TypeDefinitionIndex = 68416;
