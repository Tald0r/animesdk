...
#define MOLEMOLE_INLEVELCUSTOMIZEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x7F13110)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelCustomizedData_TypeDefinitionIndex = 49314;
