...
#define MOLEMOLE_INLEVELCUSTOMIZEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD5D590)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelCustomizedData_TypeDefinitionIndex = 68580;
