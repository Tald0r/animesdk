...
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMECONSTANT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B1390E0)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMECONSTANT_GET_INS_OFFSET UNITYSDK_OFFSET(0x1B139060)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMECONSTANT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B139150)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMECONSTANT_SET_INS_OFFSET UNITYSDK_OFFSET(0x1B1390A0)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMECONSTANT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1391C0)

namespace MoleMole::Arcade::BallsRace::Client
{
	inline static constexpr unsigned int BRGameConstant_TypeDefinitionIndex = 82240;
	...
	public:
		...
		{
			return (::MoleMole::Arcade::BallsRace::Client::BRGameConstant**)Il2CppClass::FromTypeDefinitionIndex(BRGameConstant_TypeDefinitionIndex)->GetStaticField(0x47DD0);
		}
