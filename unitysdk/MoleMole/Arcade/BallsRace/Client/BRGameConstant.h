...
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMECONSTANT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AF917B0)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMECONSTANT_GET_INS_OFFSET UNITYSDK_OFFSET(0x1AF91730)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMECONSTANT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AF91820)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMECONSTANT_SET_INS_OFFSET UNITYSDK_OFFSET(0x1AF91770)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRGAMECONSTANT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF91890)

namespace MoleMole::Arcade::BallsRace::Client
{
	inline static constexpr unsigned int BRGameConstant_TypeDefinitionIndex = 80153;
	...
	public:
		...
		{
			return (::MoleMole::Arcade::BallsRace::Client::BRGameConstant**)Il2CppClass::FromTypeDefinitionIndex(BRGameConstant_TypeDefinitionIndex)->GetStaticField(0x44F70);
		}
