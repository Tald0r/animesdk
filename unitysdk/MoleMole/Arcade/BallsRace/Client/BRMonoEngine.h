...
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRMONOENGINE_METHOD_6_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x1AEF8930)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRMONOENGINE_METHOD_6_DF2A78D8DB25ED05_OFFSET UNITYSDK_OFFSET(0x1AEF8890)
#define MOLEMOLE_ARCADE_BALLSRACE_CLIENT_BRMONOENGINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEF8A60)

namespace MoleMole::Arcade::BallsRace::Client
{
	inline static constexpr unsigned int BRMonoEngine_TypeDefinitionIndex = 82169;
