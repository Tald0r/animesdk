...
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONBEHAVIOUR_METHOD_6_2340068C22DFE332_OFFSET UNITYSDK_OFFSET(0x17B5D2D0)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONBEHAVIOUR_METHOD_6_DF2A78D8DB25ED05_OFFSET UNITYSDK_OFFSET(0x17B5D220)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x17B5D360)

namespace MoleMole::Arcade::CompanionProject::Client
{
	inline static constexpr unsigned int CompanionBehaviour_TypeDefinitionIndex = 81574;
