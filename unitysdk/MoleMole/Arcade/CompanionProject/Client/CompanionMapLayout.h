...
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B418D20)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_DESTROYTEMPALTEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B419070)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B418CE0)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_INSTANTIATESELECTTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1B419340)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_INSTANTIATETEMPLATE_OFFSET UNITYSDK_OFFSET(0x1B418E10)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B418D90)
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CLIENT_COMPANIONMAPLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B419470)

namespace MoleMole::Arcade::CompanionProject::Client
{
	inline static constexpr unsigned int CompanionMapLayout_TypeDefinitionIndex = 83513;
	...
	public:
		...
		{
			return (::MoleMole::Arcade::CompanionProject::Client::CompanionMapLayout**)Il2CppClass::FromTypeDefinitionIndex(CompanionMapLayout_TypeDefinitionIndex)->GetStaticField(0x481F0);
		}
