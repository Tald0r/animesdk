...
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CPSKILLEFFECTMOVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x191E9D50)

namespace MoleMole::Arcade::CompanionProject
{
	inline static constexpr unsigned int CpSkillEffectMoveData_TypeDefinitionIndex = 79980;
	...
	public:
		...
		::Struct_2_4C8453486C91E3A1_14 posParam; // 0x30
