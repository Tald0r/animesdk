...
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CPSKILLEFFECTMOVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19F3B900)

namespace MoleMole::Arcade::CompanionProject
{
	inline static constexpr unsigned int CpSkillEffectMoveData_TypeDefinitionIndex = 82138;
	...
	public:
		...
		::Struct_2_4C8453486C91E3A1_13 posParam; // 0x30
