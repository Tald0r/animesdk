...
#define MOLEMOLE_ARCADE_COMPANIONPROJECT_CPSKILLEFFECTBULLETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x193EB2F0)

namespace MoleMole::Arcade::CompanionProject
{
	inline static constexpr unsigned int CpSkillEffectBulletData_TypeDefinitionIndex = 79928;
