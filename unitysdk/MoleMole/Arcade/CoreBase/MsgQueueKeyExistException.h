...
#define MOLEMOLE_ARCADE_COREBASE_MSGQUEUEKEYEXISTEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ACE9630)
#define MOLEMOLE_ARCADE_COREBASE_MSGQUEUEKEYEXISTEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1ACE9690)
#define MOLEMOLE_ARCADE_COREBASE_MSGQUEUEKEYEXISTEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACE95D0)

namespace MoleMole::Arcade::CoreBase
{
	inline static constexpr unsigned int MsgQueueKeyExistException_TypeDefinitionIndex = 24889;
