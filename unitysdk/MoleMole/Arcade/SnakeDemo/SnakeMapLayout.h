...
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_AWAKE_OFFSET UNITYSDK_OFFSET(0x19BF3950)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_CONVERTLOGICPOSTOLAYOUTPOS_1_OFFSET UNITYSDK_OFFSET(0x19BF4130)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_CONVERTLOGICPOSTOLAYOUTPOS_OFFSET UNITYSDK_OFFSET(0x19BF4080)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GETCELLITEM_OFFSET UNITYSDK_OFFSET(0x19BF3D80)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GETCELLROOT_OFFSET UNITYSDK_OFFSET(0x19BF3E00)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GETHOSTMARK_OFFSET UNITYSDK_OFFSET(0x19BF3CB0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GETMAPEFFBOMB_OFFSET UNITYSDK_OFFSET(0x19BF3FE0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GETMAPEFFEAT_OFFSET UNITYSDK_OFFSET(0x19BF3EF0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GETMAPEFFHITBACK_OFFSET UNITYSDK_OFFSET(0x19BF3F90)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GETMAPEFFITEMIDLE_OFFSET UNITYSDK_OFFSET(0x19BF3F40)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GETMAPEFFROOT_OFFSET UNITYSDK_OFFSET(0x19BF4030)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GETSHADOWROOT_OFFSET UNITYSDK_OFFSET(0x19BF3EA0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GETSHADOW_OFFSET UNITYSDK_OFFSET(0x19BF3DC0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GETSNAKEBODY_OFFSET UNITYSDK_OFFSET(0x19BF3D40)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GETSNAKEHEAD_OFFSET UNITYSDK_OFFSET(0x19BF3D00)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GETSNAKEROOT_OFFSET UNITYSDK_OFFSET(0x19BF3E50)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19BF3890)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19BF38D0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_SNAKEMAPLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF41E0)

namespace MoleMole::Arcade::SnakeDemo
{
	inline static constexpr unsigned int SnakeMapLayout_TypeDefinitionIndex = 83712;
	...
	public:
		...
		{
			return (::MoleMole::Arcade::SnakeDemo::SnakeMapLayout**)Il2CppClass::FromTypeDefinitionIndex(SnakeMapLayout_TypeDefinitionIndex)->GetStaticField(0x48310);
		}
