...
namespace MoleMole::Arcade::SnakeDemo { class UIMapSnakeBombAnimScript_Class_1_47551F410DEF390A; }
...
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_AWAKE_OFFSET UNITYSDK_OFFSET(0x19B3C220)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CALALPHA_OFFSET UNITYSDK_OFFSET(0x19B3C7A0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CALDISTRATIO_OFFSET UNITYSDK_OFFSET(0x19B3C690)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CALDIST_OFFSET UNITYSDK_OFFSET(0x19B3C630)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CALLOGICPOS_OFFSET UNITYSDK_OFFSET(0x19B3C850)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CALSCALE_OFFSET UNITYSDK_OFFSET(0x19B3C6F0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19B3D8E0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_GET_TEMPLATEIMAGE_OFFSET UNITYSDK_OFFSET(0x19B3C1A0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_INIT_OFFSET UNITYSDK_OFFSET(0x19B3C360)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_METHOD_5_96C50D1FFFF02B8F_OFFSET UNITYSDK_OFFSET(0x19B3D780)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_METHOD_5_ACF6105ACE2643C6_OFFSET UNITYSDK_OFFSET(0x19B3CCA0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_METHOD_5_B7DBAFD3FC8E9209_OFFSET UNITYSDK_OFFSET(0x19B3DC10)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_METHOD_5_C5769C74973D9290_OFFSET UNITYSDK_OFFSET(0x19B3CD30)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_METHOD_5_E22DF78D30208914_OFFSET UNITYSDK_OFFSET(0x19B3CC30)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_PLAY_OFFSET UNITYSDK_OFFSET(0x19B3C8D0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_RECYCLEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19B3C540)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_RELEASE_OFFSET UNITYSDK_OFFSET(0x19B3C3C0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_RESETCENTERPOS_OFFSET UNITYSDK_OFFSET(0x19B3D160)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B3DAE0)

namespace MoleMole::Arcade::SnakeDemo
{
	inline static constexpr unsigned int UIMapSnakeBombAnimScript_TypeDefinitionIndex = 81660;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::Arcade::SnakeDemo::UIMapSnakeBombAnimScript_Class_1_47551F410DEF390A*>* Field_5_9; // 0x50
		::System::Boolean Field_5_10; // 0x58
		::UnityEngine::GameObject* template_; // 0x60
		::System::Collections::Generic::Queue_1<::MoleMole::Arcade::SnakeDemo::UIMapSnakeBombAnimScript_Class_1_47551F410DEF390A*>* Field_5_12; // 0x68
		...
		::MoleMole::Arcade::SnakeDemo::UIMapSnakeBombAnimScript_Class_1_47551F410DEF390A* CreateInstance()
		{
			return ((::MoleMole::Arcade::SnakeDemo::UIMapSnakeBombAnimScript_Class_1_47551F410DEF390A*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CREATEINSTANCE_OFFSET))(this);
		}

		::System::Void RecycleInstance(::MoleMole::Arcade::SnakeDemo::UIMapSnakeBombAnimScript_Class_1_47551F410DEF390A* a1)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::Arcade::SnakeDemo::UIMapSnakeBombAnimScript_Class_1_47551F410DEF390A*))((::PBYTE)hIl2Cpp + MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_RECYCLEINSTANCE_OFFSET))(this, a1);
		}
		...
		::MoleMole::Arcade::SnakeDemo::UIMapSnakeBombAnimScript_Class_1_47551F410DEF390A* Method_5_ACF6105ACE2643C6(::System::Int32 a1, ::System::Int32 a2)
		{
			return ((::MoleMole::Arcade::SnakeDemo::UIMapSnakeBombAnimScript_Class_1_47551F410DEF390A*(*)(::PVOID, ::System::Int32, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_METHOD_5_ACF6105ACE2643C6_OFFSET))(this, a1, a2);
		}
	};
}
