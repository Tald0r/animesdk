...
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_AWAKE_OFFSET UNITYSDK_OFFSET(0x19F14B80)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CALALPHA_OFFSET UNITYSDK_OFFSET(0x19F15100)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CALDISTRATIO_OFFSET UNITYSDK_OFFSET(0x19F14FF0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CALDIST_OFFSET UNITYSDK_OFFSET(0x19F14F90)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CALLOGICPOS_OFFSET UNITYSDK_OFFSET(0x19F151B0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CALSCALE_OFFSET UNITYSDK_OFFSET(0x19F15050)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19F16250)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_GET_TEMPLATEIMAGE_OFFSET UNITYSDK_OFFSET(0x19F14B00)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_INIT_OFFSET UNITYSDK_OFFSET(0x19F14CC0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_METHOD_5_96C50D1FFFF02B8F_OFFSET UNITYSDK_OFFSET(0x19F160F0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_METHOD_5_ACF6105ACE2643C6_OFFSET UNITYSDK_OFFSET(0x19F15600)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_METHOD_5_B7DBAFD3FC8E9209_OFFSET UNITYSDK_OFFSET(0x19F16580)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_METHOD_5_C5769C74973D9290_OFFSET UNITYSDK_OFFSET(0x19F15690)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_METHOD_5_E22DF78D30208914_OFFSET UNITYSDK_OFFSET(0x19F15590)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_PLAY_OFFSET UNITYSDK_OFFSET(0x19F15230)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_RECYCLEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19F14EA0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_RELEASE_OFFSET UNITYSDK_OFFSET(0x19F14D20)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT_RESETCENTERPOS_OFFSET UNITYSDK_OFFSET(0x19F15AC0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UIMAPSNAKEBOMBANIMSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F16450)

namespace MoleMole::Arcade::SnakeDemo
{
	inline static constexpr unsigned int UIMapSnakeBombAnimScript_TypeDefinitionIndex = 83723;
