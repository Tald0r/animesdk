...
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19F1E8F0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19F1ED40)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19F1E900)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19F1EDD0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F1EE40)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19F1EE50)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x19F1EEC0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEGAMEENDPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19F1EED0)

namespace MoleMole::Arcade::SnakeDemo
{
	inline static constexpr unsigned int UISnakeGameEndPageController_TypeDefinitionIndex = 83710;

	class UISnakeGameEndPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_147* _view; // 0x2F8
