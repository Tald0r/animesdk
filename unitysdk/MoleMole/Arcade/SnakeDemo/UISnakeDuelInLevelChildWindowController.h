...
#include "unitysdk/Enum_3_5C1A2ADDC337BA65.h"
...
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_CALENEMYFACETYPE_OFFSET UNITYSDK_OFFSET(0x19B42800)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_CALFACETYPE_OFFSET UNITYSDK_OFFSET(0x19B42860)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_CALTIPSPOS_OFFSET UNITYSDK_OFFSET(0x19B43470)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_CONVERTTIME_OFFSET UNITYSDK_OFFSET(0x19B42FF0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_CREATESCORETIP_OFFSET UNITYSDK_OFFSET(0x19B43D10)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ENDCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19B429B0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ENDREDCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19B430D0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_GETIMAGE_OFFSET UNITYSDK_OFFSET(0x19B428E0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x19B3DDA0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_INITADDSCORE_OFFSET UNITYSDK_OFFSET(0x19B444A0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_INITREDUCESCORE_OFFSET UNITYSDK_OFFSET(0x19B445B0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_LOADFUNC_OFFSET UNITYSDK_OFFSET(0x19B3E460)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_LOAD_OFFSET UNITYSDK_OFFSET(0x19B3EF70)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONADDSCORE_OFFSET UNITYSDK_OFFSET(0x19B43B80)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONALLPLAYERREADY_OFFSET UNITYSDK_OFFSET(0x19B3E4C0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONCREATEITEM_OFFSET UNITYSDK_OFFSET(0x19B441D0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19B3E8A0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONDESTROYITEM_OFFSET UNITYSDK_OFFSET(0x19B44080)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONINITLOGIC_OFFSET UNITYSDK_OFFSET(0x19B3EFD0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONKILLNUM_OFFSET UNITYSDK_OFFSET(0x19B432F0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONPLAYERINPUTTIMEOUT_OFFSET UNITYSDK_OFFSET(0x19B3E160)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONSNAKEDEADBOMB_OFFSET UNITYSDK_OFFSET(0x19B44390)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONSNAKEEATSOMETHING_OFFSET UNITYSDK_OFFSET(0x19B43E60)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONSNAKEHITBACK_OFFSET UNITYSDK_OFFSET(0x19B43F50)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19B3E960)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19B3DDB0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19B3E800)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_PLAYSCORETIPS_OFFSET UNITYSDK_OFFSET(0x19B435F0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_REFRESHFACEANIM_OFFSET UNITYSDK_OFFSET(0x19B41E30)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_REFRESHFILLBAR_OFFSET UNITYSDK_OFFSET(0x19B41640)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_REFRESHSCORE_OFFSET UNITYSDK_OFFSET(0x19B41000)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_REFRESHSTARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19B415D0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_REFRESHTIMER_OFFSET UNITYSDK_OFFSET(0x19B400E0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_SHOWGAMEOVERTIP_OFFSET UNITYSDK_OFFSET(0x19B40540)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19B43080)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_UPDATEADDSCORE_OFFSET UNITYSDK_OFFSET(0x19B446C0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_UPDATEREDUCESCORE_OFFSET UNITYSDK_OFFSET(0x19B44FC0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19B40C80)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B459B0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B45810)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER__ONINITLOGIC_B__54_0_OFFSET UNITYSDK_OFFSET(0x19B45B60)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER__ONINITLOGIC_B__54_3_OFFSET UNITYSDK_OFFSET(0x19B45DA0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER__ONPLAYERINPUTTIMEOUT_B__45_0_OFFSET UNITYSDK_OFFSET(0x19B45AB0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x19B45EE0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x19B45F50)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x19B45F60)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x19B45F70)

namespace MoleMole::Arcade::SnakeDemo
{
	inline static constexpr unsigned int UISnakeDuelInLevelChildWindowController_TypeDefinitionIndex = 81647;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UISnakeDuelInLevelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x11B00);
		}
		static ::System::Int32* StaticGet_LeftDamageColor()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UISnakeDuelInLevelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x11B04);
		}
		static ::System::Int32* StaticGet_LeftOverrideColor()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UISnakeDuelInLevelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x11B08);
		}
		static ::System::Int32* StaticGet_TeamARatio()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UISnakeDuelInLevelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x11B0C);
		}
		static ::System::Int32* StaticGet_RightDamageLength()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UISnakeDuelInLevelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x11B10);
		}
		static ::UnityEngine::Color* StaticGet_TargetOverrideColor()
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(UISnakeDuelInLevelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x11B14);
		}
		static ::System::Int32* StaticGet_RightBurst()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UISnakeDuelInLevelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x11B24);
		}
		static ::System::Int32* StaticGet_RightOverrideColor()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UISnakeDuelInLevelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x11B28);
		}
		static ::System::Int32* StaticGet_LeftBurst()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UISnakeDuelInLevelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x11B2C);
		}
		static ::System::Int32* StaticGet_LeftDamageLength()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UISnakeDuelInLevelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x11B30);
		}
		static ::UnityEngine::Color* StaticGet_InitOverrideColor()
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(UISnakeDuelInLevelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x11B34);
		}
		...
		::Class_2_A2F3E9148C4D7095* _gameLogic; // 0x300
		::System::Boolean _isSingle; // 0x308
		::System::Func_2<::Foundation::AssetPath, ::UnityEngine::Sprite*>* _loadSprite; // 0x310
		::UnityEngine::Transform* _scoreRoot; // 0x318
		::System::Collections::Generic::Queue_1<::UnityEngine::GameObject*>* _scoreQueue; // 0x320
		::System::String* _numRedAnim; // 0x328
		::System::Int32 _endBgCountDown; // 0x330
		::System::Int32 _endRedCountDown; // 0x334
		::Class_2_9CE3D9AFC0601365_1* _configTemplateManager; // 0x338
		::System::UInt64 _startBgCountDown; // 0x340
		::System::Single _startBgCountDownTimer; // 0x348
		::System::Int32 _curStartCountDown; // 0x34C
		::System::Boolean _isRealStart; // 0x350
		::System::Boolean _isGameOver; // 0x351
		::System::Single _reviveTime; // 0x354
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Single>* reviveDict; // 0x358
		::Class_2_DD0812B7B232D3F6* _arcadeModel; // 0x360
		::Class_1_C504EE57A5080FE1* _snakeFaceFrame; // 0x368
		::Enum_3_D6975E78EC694A05 hostTeamType; // 0x370
		::Class_1_163D707FB4753028* _mapEffectFrameAnim; // 0x378
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* itemAnimsStore; // 0x380
		::Class_1_06AF9B854C9B5A46* _snakeDeadBombMapAnim; // 0x388
		::Class_2_1663C87C07AC42DA* modelHelper; // 0x390
		::System::Collections::Generic::List_1<::Foundation::Coroutine::CoroutineHandle>* _coroutineHandles; // 0x398
		::MoleMole::UIGeneralTipsPopWindowController* ctrl; // 0x3A0
		::System::Boolean _endRedCountDownSound; // 0x3A8
		::System::Boolean _endBgCountDownSound; // 0x3A9
		::System::Int32 countdown1; // 0x3AC
		::System::Int32 countdown2; // 0x3B0
		::MoleMole::Arcade::SnakeDemo::SnakeScoreFillBarParam* _scoreFillBarParam; // 0x3B8
		::System::Single _curRatio; // 0x3C0
		::System::Single _normalChangeTime; // 0x3C4
		::System::Single _bigBlinkTime; // 0x3C8
		::System::Single _blinkSpeed; // 0x3CC
		::System::Single _bigChangeWitheTime; // 0x3D0
		::System::Single lerpTime; // 0x3D4
		::System::Single lerpTimer; // 0x3D8
		::System::Single _whiteSpace; // 0x3DC
		::System::Boolean _needChangeScore; // 0x3E0
		::System::Single _targetRatio; // 0x3E4
		::System::Single _curDiff; // 0x3E8
		::System::Boolean _isBigChange; // 0x3EC
		::System::Boolean _isFirstChange; // 0x3ED
		::System::Single _bigChangeRatio; // 0x3F0
		::System::Single _tempCurRatio; // 0x3F4
		::System::Single _tempWithe; // 0x3F8
		::System::Boolean _isScoreAdd; // 0x3FC
		::System::Single _isScoreFightingTimer; // 0x400
		::UnityEngine::Color _overrideColor; // 0x404
		::System::Boolean playSnakeDeathEffect; // 0x414
		...
		::Class_2_A8F5ABF31E066ED4* GetImage(::Enum_3_5C1A2ADDC337BA65 type)
		{
			return ((::Class_2_A8F5ABF31E066ED4*(*)(::PVOID, ::Enum_3_5C1A2ADDC337BA65))((::PBYTE)hIl2Cpp + MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER_GETIMAGE_OFFSET))(this, type);
		}
