...
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AAD12E0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1AAD12A0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_METHOD_5_8A59953ECEBCBE80_OFFSET UNITYSDK_OFFSET(0x1AAD1810)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_METHOD_5_A8DD56714A34681F_OFFSET UNITYSDK_OFFSET(0x1AAD1450)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_REFRESHDELAY_OFFSET UNITYSDK_OFFSET(0x1AAD15B0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_REFRESHENTITYMSG_OFFSET UNITYSDK_OFFSET(0x1AAD1620)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE_REFRESHWORLDPASSTIME_OFFSET UNITYSDK_OFFSET(0x1AAD1350)
#define MOLEMOLE_ARCADE_SNAKEDEMO_DEBUGFORSNAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD1710)

namespace MoleMole::Arcade::SnakeDemo
{
	inline static constexpr unsigned int DebugForSnake_TypeDefinitionIndex = 81645;
	...
	public:
		...
		{
			return (::MoleMole::Arcade::SnakeDemo::DebugForSnake**)Il2CppClass::FromTypeDefinitionIndex(DebugForSnake_TypeDefinitionIndex)->GetStaticField(0x469B0);
		}
