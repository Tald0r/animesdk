...
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER___C__DISPLAYCLASS72_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF198F0)
#define MOLEMOLE_ARCADE_SNAKEDEMO_UISNAKEDUELINLEVELCHILDWINDOWCONTROLLER___C__DISPLAYCLASS72_0__PLAYSCORETIPS_B__0_OFFSET UNITYSDK_OFFSET(0x1AF19900)

namespace MoleMole::Arcade::SnakeDemo
{
	inline static constexpr unsigned int UISnakeDuelInLevelChildWindowController___c__DisplayClass72_0_TypeDefinitionIndex = 81650;
