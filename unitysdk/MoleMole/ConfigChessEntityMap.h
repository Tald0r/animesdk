...
#define MOLEMOLE_CONFIGCHESSENTITYMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xCD284C0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigChessEntityMap_TypeDefinitionIndex = 70719;
