...
#define MOLEMOLE_UILOGINPAGECONTROLLER___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8970F40)
#define MOLEMOLE_UILOGINPAGECONTROLLER___C__DISPLAYCLASS36_0__STARTLOGINANDLOADRESOURCE_B__0_OFFSET UNITYSDK_OFFSET(0x8970F50)

namespace MoleMole
{
	inline static constexpr unsigned int UILoginPageController___c__DisplayClass36_0_TypeDefinitionIndex = 52010;
