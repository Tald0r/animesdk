...
#define MOLEMOLE_INLEVELNORMALATTACKGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x6AFD470)
#define MOLEMOLE_INLEVELNORMALATTACKGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x6AFD480)
#define MOLEMOLE_INLEVELNORMALATTACKGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x6AFD490)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelNormalAttackGamepadBindingSettingEntry_TypeDefinitionIndex = 61340;
