...
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199E55B0)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199E5640)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199E5480)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199E5510)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x199E5710)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0x199E5780)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x199E5AF0)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x199E5B20)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x199E5B90)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x199E5C10)
#define MOLEMOLE_UICPPROPDATASHOTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x199E5C70)

namespace MoleMole
{
	inline static constexpr unsigned int UICpPropDataShotRowWidgetController_TypeDefinitionIndex = 83612;

	class UICpPropDataShotRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_3688AEE03FC427B3* _view; // 0x2A0
