...
#define MOLEMOLE_UIHOLLOWITEMOPTIONSUPGRADECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7D11750)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemOptionsUpGradeControllerContext_TypeDefinitionIndex = 62467;
