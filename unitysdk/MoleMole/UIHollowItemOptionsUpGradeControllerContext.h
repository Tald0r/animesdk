...
#define MOLEMOLE_UIHOLLOWITEMOPTIONSUPGRADECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9140630)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemOptionsUpGradeControllerContext_TypeDefinitionIndex = 39236;

	class UIHollowItemOptionsUpGradeControllerContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Action* OnConfirm; // 0x28
		::System::Collections::Generic::List_1<::Class_1_4F9417780723166C*>* ItemDatas; // 0x30
		::System::Action* OnCancel; // 0x38
