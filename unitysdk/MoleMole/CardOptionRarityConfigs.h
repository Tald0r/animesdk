...
#define MOLEMOLE_CARDOPTIONRARITYCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0xCD91F70)

namespace MoleMole
{
	inline static constexpr unsigned int CardOptionRarityConfigs_TypeDefinitionIndex = 42575;
