...
#define MOLEMOLE_CARDOPTIONRARITYCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0xB8FE300)

namespace MoleMole
{
	inline static constexpr unsigned int CardOptionRarityConfigs_TypeDefinitionIndex = 48359;
