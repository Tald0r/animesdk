...
#define MOLEMOLE_UITRICKDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCA831A0)

namespace MoleMole
{
	inline static constexpr unsigned int UITrickDialogContext_TypeDefinitionIndex = 43967;
