...
#define MOLEMOLE_UITRICKDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7909960)

namespace MoleMole
{
	inline static constexpr unsigned int UITrickDialogContext_TypeDefinitionIndex = 62915;
