...
#define MOLEMOLE_UIMECHBOOREFORMTASKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB3F74D0)
#define MOLEMOLE_UIMECHBOOREFORMTASKROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB3F7570)
#define MOLEMOLE_UIMECHBOOREFORMTASKROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB3F6F70)
#define MOLEMOLE_UIMECHBOOREFORMTASKROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB3F7010)
#define MOLEMOLE_UIMECHBOOREFORMTASKROWWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0xB3F70C0)
#define MOLEMOLE_UIMECHBOOREFORMTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB3F7650)
#define MOLEMOLE_UIMECHBOOREFORMTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB3F7680)
#define MOLEMOLE_UIMECHBOOREFORMTASKROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB3F76F0)
#define MOLEMOLE_UIMECHBOOREFORMTASKROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB3F7770)
#define MOLEMOLE_UIMECHBOOREFORMTASKROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB3F77D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooReformTaskRowWidgetController_TypeDefinitionIndex = 53633;

	class UIMechBooReformTaskRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D6BCF098B26738D7_1* _view; // 0x2A0
