...
#define MOLEMOLE_SUMMEREVENTRESULTCONTEXT_ADD_OFFSET UNITYSDK_OFFSET(0x8FA1D50)
#define MOLEMOLE_SUMMEREVENTRESULTCONTEXT_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8FA1E00)
#define MOLEMOLE_SUMMEREVENTRESULTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA1CB0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventResultContext_TypeDefinitionIndex = 55085;

	class SummerEventResultContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Action* _exit; // 0x28
		::System::Collections::Generic::List_1<::MoleMole::SummerEventResultRowContext*>* _rowContexts; // 0x30
		::Class_0_16E4307DCC419505_543* _title; // 0x38

		::System::Void _ctor(::Class_0_16E4307DCC419505_543* title, ::System::Action* exit)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_543*, ::System::Action*))((::PBYTE)hIl2Cpp + MOLEMOLE_SUMMEREVENTRESULTCONTEXT__CTOR_OFFSET))(this, title, exit);
		}
