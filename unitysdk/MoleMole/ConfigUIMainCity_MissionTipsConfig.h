...
#define MOLEMOLE_CONFIGUIMAINCITY_MISSIONTIPSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x13FAF9D0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainCity_MissionTipsConfig_TypeDefinitionIndex = 45764;
	...
	public:
		...
		::System::Single CharacterTipDuration; // 0x1C
