...
#define MOLEMOLE_CONFIGUIMAINCITY_MISSIONTIPSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xF2E9700)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainCity_MissionTipsConfig_TypeDefinitionIndex = 45454;
	...
	public:
		...
		::System::Single IntervalShow; // 0x18
