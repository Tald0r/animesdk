...
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8ED57C0)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_GETAVATARCOLOR_OFFSET UNITYSDK_OFFSET(0x8ED2C90)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_GETMINDSCAPELENTICULAR_OFFSET UNITYSDK_OFFSET(0x8ED5310)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_HIDEMASKANI_OFFSET UNITYSDK_OFFSET(0x8ED39A0)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x8ED0E90)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_ONLEVELROWCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x8ED2EA0)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_ONTALENTUNLOCKHANDLE_OFFSET UNITYSDK_OFFSET(0x8ED34D0)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8ED59B0)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_PLAYBGFADEIN_OFFSET UNITYSDK_OFFSET(0x8ED4D10)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_PLAYBGUNLOCKANI_OFFSET UNITYSDK_OFFSET(0x8ED36A0)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_PLAYCHANGEAVATARFADEIN_OFFSET UNITYSDK_OFFSET(0x8ED4E50)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_PLAYLEVELROWUNLOCK_OFFSET UNITYSDK_OFFSET(0x8ED4F90)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8ED3B40)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_RESETCUSTOMLISTMANAGEITEMS_OFFSET UNITYSDK_OFFSET(0x8ED4000)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_SETAVATARCOLOR_OFFSET UNITYSDK_OFFSET(0x8ED2D10)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_SETAVATAR_OFFSET UNITYSDK_OFFSET(0x8ED3AA0)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_SETLENTICULARSTATE_1_OFFSET UNITYSDK_OFFSET(0x8ED2B20)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_SETLENTICULARSTATE_OFFSET UNITYSDK_OFFSET(0x8ED5380)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_SETLEVELROWSTATE_OFFSET UNITYSDK_OFFSET(0x8ED3130)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_SETMASKBGSTATE_1_OFFSET UNITYSDK_OFFSET(0x8ED4450)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_SETMASKBGSTATE_OFFSET UNITYSDK_OFFSET(0x8ED4090)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_SETUNLOCKOVERHANDLE_OFFSET UNITYSDK_OFFSET(0x8ED3460)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x8ED52B0)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8ED5AB0)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8ED5D50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMindscapeCutBgController_TypeDefinitionIndex = 40086;
	...
	public:
		...
		::Class_2_D89CCC627A66D0AD* _avatarData; // 0x128
		...
		::System::Void SetAvatar(::Class_2_D89CCC627A66D0AD* _avatar, ::System::Boolean previewMode, ::System::Boolean friendPreviewMode)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_D89CCC627A66D0AD*, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER_SETAVATAR_OFFSET))(this, _avatar, previewMode, friendPreviewMode);
		}
