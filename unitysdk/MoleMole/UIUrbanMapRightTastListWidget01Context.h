...
#define MOLEMOLE_UIURBANMAPRIGHTTASTLISTWIDGET01CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA767DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapRightTastListWidget01Context_TypeDefinitionIndex = 47255;
