...
#define MOLEMOLE_UICOMICPAGECONTROLLER__STARTWAITPLAYBGM_D__334_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC0BA2D0)
#define MOLEMOLE_UICOMICPAGECONTROLLER__STARTWAITPLAYBGM_D__334_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC0BA3C0)
#define MOLEMOLE_UICOMICPAGECONTROLLER__STARTWAITPLAYBGM_D__334_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC0BA420)
#define MOLEMOLE_UICOMICPAGECONTROLLER__STARTWAITPLAYBGM_D__334_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC0BA3D0)
#define MOLEMOLE_UICOMICPAGECONTROLLER__STARTWAITPLAYBGM_D__334_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC0BA2C0)
#define MOLEMOLE_UICOMICPAGECONTROLLER__STARTWAITPLAYBGM_D__334__CTOR_OFFSET UNITYSDK_OFFSET(0xC0BA2B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController__StartWaitPlayBGM_d__334_TypeDefinitionIndex = 62536;
