...
#define MOLEMOLE_UIINTERKNOTV3PAGECONTEXT_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0x689C750)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x689C7B0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTEXT___BASE_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0x689C7C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotV3PageContext_TypeDefinitionIndex = 78335;
