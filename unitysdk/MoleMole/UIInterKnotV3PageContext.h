...
#define MOLEMOLE_UIINTERKNOTV3PAGECONTEXT_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0x7F91E80)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7F91EE0)
#define MOLEMOLE_UIINTERKNOTV3PAGECONTEXT___BASE_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0x7F91EF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotV3PageContext_TypeDefinitionIndex = 57006;
