...
#define MOLEMOLE_UIANNOUNCECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBAE0910)

namespace MoleMole
{
	inline static constexpr unsigned int UIAnnounceContext_TypeDefinitionIndex = 47224;
