...
#define MOLEMOLE_MONOPARTYROTATEOBJ_AWAKE_OFFSET UNITYSDK_OFFSET(0xA7EC3D0)
#define MOLEMOLE_MONOPARTYROTATEOBJ_CALCURROTVALUE_OFFSET UNITYSDK_OFFSET(0xA7EC700)
#define MOLEMOLE_MONOPARTYROTATEOBJ_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xA7EC5B0)
#define MOLEMOLE_MONOPARTYROTATEOBJ_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0xA7EC790)
#define MOLEMOLE_MONOPARTYROTATEOBJ_SYNCROTATION_OFFSET UNITYSDK_OFFSET(0xA7EC440)
#define MOLEMOLE_MONOPARTYROTATEOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0xA7ECA70)
#define MOLEMOLE_MONOPARTYROTATEOBJ___BASE_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0xA7ECAC0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoPartyRotateObj_TypeDefinitionIndex = 62606;
