...
#define MOLEMOLE_MONOPARTYROTATEOBJ_AWAKE_OFFSET UNITYSDK_OFFSET(0xA602010)
#define MOLEMOLE_MONOPARTYROTATEOBJ_CALCURROTVALUE_OFFSET UNITYSDK_OFFSET(0xA602340)
#define MOLEMOLE_MONOPARTYROTATEOBJ_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xA6021F0)
#define MOLEMOLE_MONOPARTYROTATEOBJ_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0xA6023D0)
#define MOLEMOLE_MONOPARTYROTATEOBJ_SYNCROTATION_OFFSET UNITYSDK_OFFSET(0xA602080)
#define MOLEMOLE_MONOPARTYROTATEOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0xA6026B0)
#define MOLEMOLE_MONOPARTYROTATEOBJ___BASE_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0xA602700)

namespace MoleMole
{
	inline static constexpr unsigned int MonoPartyRotateObj_TypeDefinitionIndex = 66546;
