...
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_GET_FADEANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0xD6DBD20)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_GET_FADEINTIME_OFFSET UNITYSDK_OFFSET(0xD6DBD40)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_GET_FADEOUTTIME_OFFSET UNITYSDK_OFFSET(0xD6DBD30)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONENTERDETAIL_OFFSET UNITYSDK_OFFSET(0xD6DC420)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONEXITDETAIL_OFFSET UNITYSDK_OFFSET(0xD6DC480)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONOPENMANAGEINFO_OFFSET UNITYSDK_OFFSET(0xD6DC4E0)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONTEMPLEFADEINFINISHED_OFFSET UNITYSDK_OFFSET(0xD6DC230)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_ONTEMPLEFADEOUTFINISHED_OFFSET UNITYSDK_OFFSET(0xD6DC3C0)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_PLAYTEMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0xD6DBE80)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_PLAYTEMPLEFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0xD6DBD50)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER_PLAYTEMPLEFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0xD6DC290)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD6DC550)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER__PLAYTEMPLEFADEINANIMATION_B__11_0_OFFSET UNITYSDK_OFFSET(0xD6DC590)
#define MOLEMOLE_UISUIBIANTEMPLESIMWIDGETCONTROLLER__PLAYTEMPLEFADEOUTANIMATION_B__13_0_OFFSET UNITYSDK_OFFSET(0xD6DC5B0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleSimWidgetController_TypeDefinitionIndex = 51079;
