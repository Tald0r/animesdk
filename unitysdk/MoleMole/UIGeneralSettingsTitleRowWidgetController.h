...
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x9BEBE90)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9BEBF40)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9BEBFE0)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9BEBD30)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9BEC0C0)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9BEC0F0)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9BEC160)
#define MOLEMOLE_UIGENERALSETTINGSTITLEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9BEC1E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSettingsTitleRowWidgetController_TypeDefinitionIndex = 62004;

	class UIGeneralSettingsTitleRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_8127D35606966C67_15* _view; // 0x2A0
