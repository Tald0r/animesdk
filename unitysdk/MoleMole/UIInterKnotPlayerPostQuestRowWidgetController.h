...
class Class_2_6766B8BA5509E097_1;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UIINTERKNOTPLAYERPOSTQUESTROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x943BC60)
#define MOLEMOLE_UIINTERKNOTPLAYERPOSTQUESTROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x943BCD0)
#define MOLEMOLE_UIINTERKNOTPLAYERPOSTQUESTROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x943BF70)
#define MOLEMOLE_UIINTERKNOTPLAYERPOSTQUESTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x943BDD0)
#define MOLEMOLE_UIINTERKNOTPLAYERPOSTQUESTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x943C120)
#define MOLEMOLE_UIINTERKNOTPLAYERPOSTQUESTROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x943C150)
#define MOLEMOLE_UIINTERKNOTPLAYERPOSTQUESTROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x943C1C0)
#define MOLEMOLE_UIINTERKNOTPLAYERPOSTQUESTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x943C230)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotPlayerPostQuestRowWidgetController_TypeDefinitionIndex = 49112;
	...
	public:
		...
		::Class_2_6766B8BA5509E097_1* get__viewModel()
		{
			return ((::Class_2_6766B8BA5509E097_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINTERKNOTPLAYERPOSTQUESTROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
