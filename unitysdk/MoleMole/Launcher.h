...
#define MOLEMOLE_LAUNCHER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9919690)
#define MOLEMOLE_LAUNCHER_GET_ISSTARTGAMEPRELOADMODE_OFFSET UNITYSDK_OFFSET(0x99193E0)
#define MOLEMOLE_LAUNCHER_METHOD_5_261DF843E298B71B_1_OFFSET UNITYSDK_OFFSET(0x991B780)
#define MOLEMOLE_LAUNCHER_METHOD_5_261DF843E298B71B_OFFSET UNITYSDK_OFFSET(0x991B6E0)
#define MOLEMOLE_LAUNCHER_METHOD_5_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x9919C70)
#define MOLEMOLE_LAUNCHER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x991AC90)
#define MOLEMOLE_LAUNCHER_METHOD_5_5EBE23180774F4D5_OFFSET UNITYSDK_OFFSET(0x991A730)
#define MOLEMOLE_LAUNCHER_METHOD_5_6BA7BB45F0BA72F4_OFFSET UNITYSDK_OFFSET(0x991A070)
#define MOLEMOLE_LAUNCHER_METHOD_5_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x991B4F0)
#define MOLEMOLE_LAUNCHER_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x991AF50)
#define MOLEMOLE_LAUNCHER_METHOD_5_8B5E3014AFF7F8EA_OFFSET UNITYSDK_OFFSET(0x991C520)
#define MOLEMOLE_LAUNCHER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x991B880)
#define MOLEMOLE_LAUNCHER_METHOD_5_9D8CB5E47C1952BD_OFFSET UNITYSDK_OFFSET(0x9919E00)
#define MOLEMOLE_LAUNCHER_METHOD_5_A239DF324AF4215C_OFFSET UNITYSDK_OFFSET(0x991B920)
#define MOLEMOLE_LAUNCHER_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x991E740)
#define MOLEMOLE_LAUNCHER_METHOD_5_BA1BB49741CFDFE1_OFFSET UNITYSDK_OFFSET(0x991A920)
#define MOLEMOLE_LAUNCHER_METHOD_5_BE4EBC8FF4054312_OFFSET UNITYSDK_OFFSET(0x991E810)
#define MOLEMOLE_LAUNCHER_METHOD_5_C666E9B499068D1A_OFFSET UNITYSDK_OFFSET(0x991BCA0)
#define MOLEMOLE_LAUNCHER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x991A8B0)
#define MOLEMOLE_LAUNCHER_METHOD_5_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x991B820)
#define MOLEMOLE_LAUNCHER_METHOD_5_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x991BB90)
#define MOLEMOLE_LAUNCHER_METHOD_5_CA373AA1C7054598_4_OFFSET UNITYSDK_OFFSET(0x991C4C0)
#define MOLEMOLE_LAUNCHER_METHOD_5_CA373AA1C7054598_5_OFFSET UNITYSDK_OFFSET(0x991E6E0)
#define MOLEMOLE_LAUNCHER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x991A850)
#define MOLEMOLE_LAUNCHER_METHOD_5_CB85C990DB613548_OFFSET UNITYSDK_OFFSET(0x991E280)
#define MOLEMOLE_LAUNCHER_METHOD_5_CE88B0F22673B36A_OFFSET UNITYSDK_OFFSET(0x991BBF0)
#define MOLEMOLE_LAUNCHER_START_OFFSET UNITYSDK_OFFSET(0x991A6C0)
#define MOLEMOLE_LAUNCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x991AD00)

namespace MoleMole
{
	inline static constexpr unsigned int Launcher_TypeDefinitionIndex = 51057;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Launcher_TypeDefinitionIndex)->GetStaticField(0x11DC0);
		}
		static ::System::Boolean* StaticGet_StatEventCategoryEnabled()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Launcher_TypeDefinitionIndex)->GetStaticField(0x11DC1);
		}
