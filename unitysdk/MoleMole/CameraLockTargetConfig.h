...
#define MOLEMOLE_CAMERALOCKTARGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6533FC0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraLockTargetConfig_TypeDefinitionIndex = 68619;
