...
#define MOLEMOLE_CAMERALOCKTARGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x81CE430)

namespace MoleMole
{
	inline static constexpr unsigned int CameraLockTargetConfig_TypeDefinitionIndex = 55527;
