...
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_INITPLATFORMUIVIEW_OFFSET UNITYSDK_OFFSET(0x95F2440)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95F1780)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x95F1900)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x95F2B90)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95F1820)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95F1680)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER_SHOWPLATFORMUI_OFFSET UNITYSDK_OFFSET(0x95F2880)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x95F2C60)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER__INITPLATFORMUIVIEW_G__SETUPPLATFORMUI_6_0_OFFSET UNITYSDK_OFFSET(0x95F2AF0)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95F2C70)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x95F2CE0)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95F2D60)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95F2DE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendInviteRowWidgetController_TypeDefinitionIndex = 65407;

	class UIFriendInviteRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79433D17E9DE75DE* _view; // 0x2D0
		::Class_1_81D34D116310A358* _inviteRequest; // 0x2D8
		::Class_1_BE6BF7909AD9D940* _briefInfo; // 0x2E0
