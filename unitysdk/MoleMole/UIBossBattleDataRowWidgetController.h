...
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB04690)
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB04700)
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBB047C0)
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBB048A0)
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB04AB0)
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB04AC0)
#define MOLEMOLE_UIBOSSBATTLEDATAROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBB04B30)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossBattleDataRowWidgetController_TypeDefinitionIndex = 69937;
