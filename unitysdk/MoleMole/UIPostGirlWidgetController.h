...
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_CLEARPOSTGIRLIDS_OFFSET UNITYSDK_OFFSET(0xAF97D70)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_DOCLICKITEM_OFFSET UNITYSDK_OFFSET(0xAF98120)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_FORCEREFRESHSELECTITEM_OFFSET UNITYSDK_OFFSET(0xAF97720)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_GETITEMWIDGETBYPOSTGIRLID_OFFSET UNITYSDK_OFFSET(0xAF986A0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_GETITEMWIDGET_OFFSET UNITYSDK_OFFSET(0xAF984E0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xAF98350)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF97460)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xAF975E0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONSELECTPOSTGIRLFROMTYPE_OFFSET UNITYSDK_OFFSET(0xAF97DE0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONSETSELECTTYPECHANGE_OFFSET UNITYSDK_OFFSET(0xAF97A60)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONSETSELECTTYPE_OFFSET UNITYSDK_OFFSET(0xAF979E0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF97500)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF97040)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF973B0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0xAF97960)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_REFRESHSELECTITEM_OFFSET UNITYSDK_OFFSET(0xAF98740)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAF97840)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_SETONCLICK_OFFSET UNITYSDK_OFFSET(0xAF977D0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_TRIGGERCURRENTCLICK_OFFSET UNITYSDK_OFFSET(0xAF980B0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_TRYREADNEW_OFFSET UNITYSDK_OFFSET(0xAF97F70)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAF98970)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER__ONSETSELECTTYPECHANGE_G__ONSUCCESS_19_0_OFFSET UNITYSDK_OFFSET(0xAF98A40)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0xAF989B0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER__ONUIINIT_B__1_1_OFFSET UNITYSDK_OFFSET(0xAF98A30)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF98C20)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xAF98C90)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF98CF0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF98D70)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF98DD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPostGirlWidgetController_TypeDefinitionIndex = 80197;

	class UIPostGirlWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_8B36B2DB492DBF9B_9* _view; // 0x2A0
		::System::Action_2<::System::Int32, ::System::Boolean>* _onClick; // 0x2A8
		::System::Collections::Generic::List_1<::System::Int32>* _postGirlIDs; // 0x2B0
		::System::Int32 _selectIdx; // 0x2B8
		::Enum_3_F4E08D0E9B554572 _selectType; // 0x2BC
