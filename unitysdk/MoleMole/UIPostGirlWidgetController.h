...
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_CLEARPOSTGIRLIDS_OFFSET UNITYSDK_OFFSET(0x73A4280)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_DOCLICKITEM_OFFSET UNITYSDK_OFFSET(0x73A4630)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_FORCEREFRESHSELECTITEM_OFFSET UNITYSDK_OFFSET(0x73A3C30)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_GETITEMWIDGETBYPOSTGIRLID_OFFSET UNITYSDK_OFFSET(0x73A4BB0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_GETITEMWIDGET_OFFSET UNITYSDK_OFFSET(0x73A49F0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x73A4860)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x73A3970)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x73A3AF0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONSELECTPOSTGIRLFROMTYPE_OFFSET UNITYSDK_OFFSET(0x73A42F0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONSETSELECTTYPECHANGE_OFFSET UNITYSDK_OFFSET(0x73A3F70)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONSETSELECTTYPE_OFFSET UNITYSDK_OFFSET(0x73A3EF0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x73A3A10)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x73A3550)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x73A38C0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x73A3E70)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_REFRESHSELECTITEM_OFFSET UNITYSDK_OFFSET(0x73A4C50)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x73A3D50)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_SETONCLICK_OFFSET UNITYSDK_OFFSET(0x73A3CE0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_TRIGGERCURRENTCLICK_OFFSET UNITYSDK_OFFSET(0x73A45C0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER_TRYREADNEW_OFFSET UNITYSDK_OFFSET(0x73A4480)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x73A4E80)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER__ONSETSELECTTYPECHANGE_G__ONSUCCESS_19_0_OFFSET UNITYSDK_OFFSET(0x73A4F50)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x73A4EC0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER__ONUIINIT_B__1_1_OFFSET UNITYSDK_OFFSET(0x73A4F40)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x73A5130)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x73A51A0)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x73A5200)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x73A5280)
#define MOLEMOLE_UIPOSTGIRLWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x73A52E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPostGirlWidgetController_TypeDefinitionIndex = 46318;
