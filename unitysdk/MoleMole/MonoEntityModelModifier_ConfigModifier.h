...
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER_GET_CONTROLPOINT_HEIGHT_OFFSET UNITYSDK_OFFSET(0xB5F6D20)
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER_GET_MODELHEIGHT_OFFSET UNITYSDK_OFFSET(0xB5F6DB0)
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER_GET_MODELWIDTH_OFFSET UNITYSDK_OFFSET(0xB5F6DA0)
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0xB5F6CA0)
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0xB5F6DC0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEntityModelModifier_ConfigModifier_TypeDefinitionIndex = 77115;
