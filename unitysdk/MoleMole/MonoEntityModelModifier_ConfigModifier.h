...
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER_GET_CONTROLPOINT_HEIGHT_OFFSET UNITYSDK_OFFSET(0x6B06EB0)
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER_GET_MODELHEIGHT_OFFSET UNITYSDK_OFFSET(0x6B06F40)
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER_GET_MODELWIDTH_OFFSET UNITYSDK_OFFSET(0x6B06F30)
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x6B06E30)
#define MOLEMOLE_MONOENTITYMODELMODIFIER_CONFIGMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x6B06F50)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEntityModelModifier_ConfigModifier_TypeDefinitionIndex = 50057;
