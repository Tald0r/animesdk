...
#define MOLEMOLE_SERVERLISTINFO_GETSERVERHOST_OFFSET UNITYSDK_OFFSET(0xB8C62F0)
#define MOLEMOLE_SERVERLISTINFO_GETSERVERNAME_OFFSET UNITYSDK_OFFSET(0xB8C6230)
#define MOLEMOLE_SERVERLISTINFO_GETSERVERTITLE_OFFSET UNITYSDK_OFFSET(0xB8C6290)
#define MOLEMOLE_SERVERLISTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB8C6450)

namespace MoleMole
{
	inline static constexpr unsigned int ServerListInfo_TypeDefinitionIndex = 48077;
