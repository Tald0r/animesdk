...
#define MOLEMOLE_UIINLEVELPAUSEBATTLEAVATARDEMOWIDGETCONTROLLER_REFRESHSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x6C98DF0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEAVATARDEMOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6C99860)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEAVATARDEMOWIDGETCONTROLLER___BASE_REFRESHSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x6C99870)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBattleAvatarDemoWidgetController_TypeDefinitionIndex = 66079;
