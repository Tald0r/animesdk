...
#define MOLEMOLE_UIGACHAROLEPOOLDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9BDF3B0)
#define MOLEMOLE_UIGACHAROLEPOOLDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS3_0__ONUIINIT_B__2_OFFSET UNITYSDK_OFFSET(0x9BDF3C0)
#define MOLEMOLE_UIGACHAROLEPOOLDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS3_0__ONUIINIT_B__3_OFFSET UNITYSDK_OFFSET(0x9BDF5A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaRolePoolDialogPopWindowController___c__DisplayClass3_0_TypeDefinitionIndex = 43706;
