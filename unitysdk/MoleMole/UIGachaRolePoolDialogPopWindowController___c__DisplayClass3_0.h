...
#define MOLEMOLE_UIGACHAROLEPOOLDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBFA3CE0)
#define MOLEMOLE_UIGACHAROLEPOOLDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS3_0__ONUIINIT_B__2_OFFSET UNITYSDK_OFFSET(0xBFA3CF0)
#define MOLEMOLE_UIGACHAROLEPOOLDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS3_0__ONUIINIT_B__3_OFFSET UNITYSDK_OFFSET(0xBFA3ED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaRolePoolDialogPopWindowController___c__DisplayClass3_0_TypeDefinitionIndex = 42967;
