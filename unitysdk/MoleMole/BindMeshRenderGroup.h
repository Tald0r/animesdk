...
#define MOLEMOLE_BINDMESHRENDERGROUP_GETBINDMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0xCCE8690)
#define MOLEMOLE_BINDMESHRENDERGROUP_GETMATERIALSLISTBYRENDERS_OFFSET UNITYSDK_OFFSET(0xCCE86F0)
#define MOLEMOLE_BINDMESHRENDERGROUP_GETOVERRIDERDITHERKEY_OFFSET UNITYSDK_OFFSET(0xCCE8630)
#define MOLEMOLE_BINDMESHRENDERGROUP_METHOD_1_35942D7A8A374AB0_OFFSET UNITYSDK_OFFSET(0xCCE8B50)
#define MOLEMOLE_BINDMESHRENDERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xCCE8B40)

namespace MoleMole
{
	inline static constexpr unsigned int BindMeshRenderGroup_TypeDefinitionIndex = 67864;
