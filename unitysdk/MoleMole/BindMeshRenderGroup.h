...
#define MOLEMOLE_BINDMESHRENDERGROUP_GETBINDMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0x7BB5090)
#define MOLEMOLE_BINDMESHRENDERGROUP_GETMATERIALSLISTBYRENDERS_OFFSET UNITYSDK_OFFSET(0x7BB50F0)
#define MOLEMOLE_BINDMESHRENDERGROUP_GETOVERRIDERDITHERKEY_OFFSET UNITYSDK_OFFSET(0x7BB5030)
#define MOLEMOLE_BINDMESHRENDERGROUP_METHOD_1_35942D7A8A374AB0_OFFSET UNITYSDK_OFFSET(0x7BB5550)
#define MOLEMOLE_BINDMESHRENDERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x7BB5540)

namespace MoleMole
{
	inline static constexpr unsigned int BindMeshRenderGroup_TypeDefinitionIndex = 40437;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_BINDMESHRENDERGROUP_METHOD_1_35942D7A8A374AB0_OFFSET))(this);
		}
	};
}
