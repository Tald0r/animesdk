...
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAD16BF0)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__0_OFFSET UNITYSDK_OFFSET(0xAD16C00)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__1_OFFSET UNITYSDK_OFFSET(0xAD16C20)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__3_OFFSET UNITYSDK_OFFSET(0xAD16C40)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__4_OFFSET UNITYSDK_OFFSET(0xAD16CD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendSystemPlayerLevelPopWindowController___c__DisplayClass7_0_TypeDefinitionIndex = 73875;
