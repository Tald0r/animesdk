...
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB2DD5F0)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__0_OFFSET UNITYSDK_OFFSET(0xB2DD600)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__1_OFFSET UNITYSDK_OFFSET(0xB2DD620)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__3_OFFSET UNITYSDK_OFFSET(0xB2DD640)
#define MOLEMOLE_UIFRIENDSYSTEMPLAYERLEVELPOPWINDOWCONTROLLER___C__DISPLAYCLASS7_0__INITINTERKNOTREWARDS_B__4_OFFSET UNITYSDK_OFFSET(0xB2DD6D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendSystemPlayerLevelPopWindowController___c__DisplayClass7_0_TypeDefinitionIndex = 38017;
