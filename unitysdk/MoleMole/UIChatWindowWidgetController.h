...
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_BUILDCHATMSGITEM_OFFSET UNITYSDK_OFFSET(0xDDCCE20)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0xDDCF920)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_CHECKCIRCLEALLOWCOMM_OFFSET UNITYSDK_OFFSET(0xDDCE6D0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_CHECKFRIENDALLOWCOMM_OFFSET UNITYSDK_OFFSET(0xDDCE5C0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_CHECKINSERTDETECTOR_OFFSET UNITYSDK_OFFSET(0xDDCE150)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_CHECKSENDMOVEVALID_OFFSET UNITYSDK_OFFSET(0xDDCE4A0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_CHOPNOWMESSAGES_OFFSET UNITYSDK_OFFSET(0xDDCD3F0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_CLEARALLMSGITEMS_OFFSET UNITYSDK_OFFSET(0xDDCA8E0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_CREATECHATLOADING_OFFSET UNITYSDK_OFFSET(0xDDCBB60)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_CREATECHATMESSAGE_OFFSET UNITYSDK_OFFSET(0xDDCB8C0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_CREATECHATSHARETEAM_OFFSET UNITYSDK_OFFSET(0xDDCBA80)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_CREATECHATSPECIAL_OFFSET UNITYSDK_OFFSET(0xDDCB9A0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_FINISHSCROLL_OFFSET UNITYSDK_OFFSET(0xDDD1520)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_FORCESCROLLTOBOTTOM_OFFSET UNITYSDK_OFFSET(0xDDCC350)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0xDDCB620)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_GET_ISSHOWINGEMPTYCIRCLECONTENT_OFFSET UNITYSDK_OFFSET(0xDDCEDA0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_INITCIRCLEINFO_OFFSET UNITYSDK_OFFSET(0xDDCF1D0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_INITEMPTYCIRCLECONTENT_OFFSET UNITYSDK_OFFSET(0xDDCB050)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_INITFRIENDINFO_OFFSET UNITYSDK_OFFSET(0xDDCA660)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_INITPLATFORMSETTING_OFFSET UNITYSDK_OFFSET(0xDDC8130)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_INITSCROLLTOBOTTOM_OFFSET UNITYSDK_OFFSET(0xDDCE1B0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xDDC8550)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ISSENDTEXTVALID_OFFSET UNITYSDK_OFFSET(0xDDCE790)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ISTIMEINSAMEDAY_OFFSET UNITYSDK_OFFSET(0xDDCD650)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_LOOPADD_OFFSET UNITYSDK_OFFSET(0xDDCD1A0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONCLICKCHILDITEM_OFFSET UNITYSDK_OFFSET(0xDDCB1C0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONCLICKEMOJIBTN_OFFSET UNITYSDK_OFFSET(0xDDCE8E0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONCLICKSCROLLTOBOTTOMBTN_OFFSET UNITYSDK_OFFSET(0xDDCC290)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONCLICKSENDBTN_OFFSET UNITYSDK_OFFSET(0xDDC9D50)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONCLICKSENDCIRCLEEMOJI_OFFSET UNITYSDK_OFFSET(0xDDCEB20)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONCLICKSENDCIRCLEMSG_OFFSET UNITYSDK_OFFSET(0xDDCE3F0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONCLICKSENDFRIENDEMOJI_OFFSET UNITYSDK_OFFSET(0xDDCEA10)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONCLICKSENDFRIENDMSG_OFFSET UNITYSDK_OFFSET(0xDDCE340)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDDC9B20)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONDESELECTINPUTFIELD_OFFSET UNITYSDK_OFFSET(0xDDCC4D0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDDC9BC0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONINPUTCHANGED_OFFSET UNITYSDK_OFFSET(0xDDCC7E0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONSCROLLEND_OFFSET UNITYSDK_OFFSET(0xDDD1340)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xDDD0FF0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONSELECTEMOJI_OFFSET UNITYSDK_OFFSET(0xDDCE970)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONSELECTINPUTFIELD_OFFSET UNITYSDK_OFFSET(0xDDCC3E0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDDC9750)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xDDC9180)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONSWITCHTAB_OFFSET UNITYSDK_OFFSET(0xDDCD5E0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONTEXTVALIDATEINPUT_OFFSET UNITYSDK_OFFSET(0xDDCC680)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xDDC9950)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDDC9DE0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDDC7BD0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_ONUPDATECIRCLEHISTORYMESSAGE_OFFSET UNITYSDK_OFFSET(0xDDCFB80)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_PLAYSWITCHCHATITEMANIM_OFFSET UNITYSDK_OFFSET(0xDDCAF90)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_PLAYVOICE_OFFSET UNITYSDK_OFFSET(0xDDCB260)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_RECOVERLASTINPUTTEXT_OFFSET UNITYSDK_OFFSET(0xDDCD8C0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_REFRESHALLCIRCLEMESSAGES_OFFSET UNITYSDK_OFFSET(0xDDCF9D0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_REFRESHCIRCLEHISTORYMESSAGES_OFFSET UNITYSDK_OFFSET(0xDDCFDA0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_REFRESHCIRCLENEWMESSAGES_OFFSET UNITYSDK_OFFSET(0xDDD0530)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_RESETCIRCLEPARAM_OFFSET UNITYSDK_OFFSET(0xDDCF300)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xDDCEF10)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_RESTORELASTINPUTTEXT_OFFSET UNITYSDK_OFFSET(0xDDCA1C0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_SETPLATFORMBTNSHOWSTATE_OFFSET UNITYSDK_OFFSET(0xDDC98C0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_SET_ISSHOWINGEMPTYCIRCLECONTENT_OFFSET UNITYSDK_OFFSET(0xDDCEDB0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_SHOWCHAT_1_OFFSET UNITYSDK_OFFSET(0xDDCEDC0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_SHOWCHAT_OFFSET UNITYSDK_OFFSET(0xDDCA080)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_SHOWCIRCLEMESSAGE_OFFSET UNITYSDK_OFFSET(0xDDCF850)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_SHOWEFFECT_OFFSET UNITYSDK_OFFSET(0xDDD1480)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_SHOWEMPTYCIRCLECONTENT_OFFSET UNITYSDK_OFFSET(0xDDCF370)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_SHOWEMPTYCONTENT_OFFSET UNITYSDK_OFFSET(0xDDCA7E0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_SHOWMESSAGE_OFFSET UNITYSDK_OFFSET(0xDDCDD30)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_STAYNOWPOSITION_OFFSET UNITYSDK_OFFSET(0xDDD0C90)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_STOPVOICE_OFFSET UNITYSDK_OFFSET(0xDDC99C0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_SWITCHCIRCLESHOWTITLESTATE_OFFSET UNITYSDK_OFFSET(0xDDCF4B0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_SWITCHCONTENTPANELSHOWSTATE_OFFSET UNITYSDK_OFFSET(0xDDCAA00)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_SWITCHFRIENDPLATFORMNAME_OFFSET UNITYSDK_OFFSET(0xDDC9260)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_SWITCHWINDOWUI_OFFSET UNITYSDK_OFFSET(0xDDCAA90)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_UPDATECHATWINDOWINFO_CIRCLE_OFFSET UNITYSDK_OFFSET(0xDDCEF90)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_UPDATECHATWINDOWINFO_FRIEND_OFFSET UNITYSDK_OFFSET(0xDDCA490)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_UPDATECIRCLEHISTORYMESSAGES_OFFSET UNITYSDK_OFFSET(0xDDCCAB0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_UPDATECIRCLENEWMESSAGES_OFFSET UNITYSDK_OFFSET(0xDDD0490)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_UPDATECIRCLE_OFFSET UNITYSDK_OFFSET(0xDDCBCB0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_UPDATECURRENTCHATMESSAGEANDSHOW_OFFSET UNITYSDK_OFFSET(0xDDCA510)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_UPDATEMAXINPUTHINTSHOWSTATE_OFFSET UNITYSDK_OFFSET(0xDDCC950)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_UPDATESCROLLTOBOTTOMBTN_OFFSET UNITYSDK_OFFSET(0xDDCBFE0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xDDCBC40)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDDD1650)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER__INITEMPTYCIRCLECONTENT_B__77_0_OFFSET UNITYSDK_OFFSET(0xDDD1E60)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER__ONCLICKSENDCIRCLEMSG_B__82_0_OFFSET UNITYSDK_OFFSET(0xDDD1F70)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER__ONCLICKSENDCIRCLEMSG_B__82_3_OFFSET UNITYSDK_OFFSET(0xDDD22C0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER__ONCLICKSENDCIRCLEMSG_G__SENDMSG_82_1_OFFSET UNITYSDK_OFFSET(0xDDD1F80)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER__ONCLICKSENDFRIENDMSG_B__46_0_OFFSET UNITYSDK_OFFSET(0xDDD1AE0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER__ONCLICKSENDFRIENDMSG_B__46_3_OFFSET UNITYSDK_OFFSET(0xDDD1DB0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER__ONCLICKSENDFRIENDMSG_G__SENDMSG_46_1_OFFSET UNITYSDK_OFFSET(0xDDD1AF0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0xDDD1770)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0xDDD18B0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDDD2370)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDDD23E0)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDDD2410)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xDDD2480)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDDD2490)
#define MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDDD2510)

namespace MoleMole
{
	inline static constexpr unsigned int UIChatWindowWidgetController_TypeDefinitionIndex = 44636;
	...
	public:
		...
		::System::String* RecoverLastInputText(::Enum_3_5F152DBF108B0858_1 currChatType)
		{
			return ((::System::String*(*)(::PVOID, ::Enum_3_5F152DBF108B0858_1))((::PBYTE)hIl2Cpp + MOLEMOLE_UICHATWINDOWWIDGETCONTROLLER_RECOVERLASTINPUTTEXT_OFFSET))(this, currChatType);
		}
