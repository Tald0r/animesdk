...
#define MOLEMOLE_EMPTYVIDEOPLAYER_CALLBACK_ONPREPARECOMPLETED_OFFSET UNITYSDK_OFFSET(0xA002E40)
#define MOLEMOLE_EMPTYVIDEOPLAYER_CALLBACK_ONSEEKCOMPLETED_OFFSET UNITYSDK_OFFSET(0xA002F40)
#define MOLEMOLE_EMPTYVIDEOPLAYER_CALLBACK_PLAYFINISH_OFFSET UNITYSDK_OFFSET(0xA002ED0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_CALLBACK_PLAYSTART_OFFSET UNITYSDK_OFFSET(0xA003240)
#define MOLEMOLE_EMPTYVIDEOPLAYER_CHECKINITMOVIECONTROLLER_OFFSET UNITYSDK_OFFSET(0xA0019A0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_CHECKLOGVIDEOVALID_OFFSET UNITYSDK_OFFSET(0xA003D90)
#define MOLEMOLE_EMPTYVIDEOPLAYER_CLIPCHANGED_OFFSET UNITYSDK_OFFSET(0xA004380)
#define MOLEMOLE_EMPTYVIDEOPLAYER_DESTROYMOVIE_OFFSET UNITYSDK_OFFSET(0xA0021F0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GETTARGETRENDER_OFFSET UNITYSDK_OFFSET(0xA004DB0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_CLIPDATA_OFFSET UNITYSDK_OFFSET(0xA0018D0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xA0016F0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0xA003CE0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ENABLEUPDATELOG_OFFSET UNITYSDK_OFFSET(0xA001680)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0xA003780)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_FRAMERATE_OFFSET UNITYSDK_OFFSET(0xA0037A0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_FRAME_OFFSET UNITYSDK_OFFSET(0xA003760)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xA003830)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ISCANRENDER_OFFSET UNITYSDK_OFFSET(0xA003440)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ISLOOPING_OFFSET UNITYSDK_OFFSET(0xA0036B0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0xA002EB0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xA003420)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_ISPREPARED_OFFSET UNITYSDK_OFFSET(0xA0034C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0xA003710)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_PLAYBACKSPEED_OFFSET UNITYSDK_OFFSET(0xA002140)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_PLAYONAWAKE_OFFSET UNITYSDK_OFFSET(0xA0036D0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0xA0038D0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_SIMULATE_OFFSET UNITYSDK_OFFSET(0xA0018F0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_TARGETMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0xA003910)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_TARGETMATERIALRENDERER_OFFSET UNITYSDK_OFFSET(0xA0038B0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_TARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0xA0038F0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0xA0038A0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_TIME_OFFSET UNITYSDK_OFFSET(0xA003740)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_URL_OFFSET UNITYSDK_OFFSET(0xA0036A0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_WAITFORFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0xA0036F0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0xA0037C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_INTERNALCALLPLAYEND_OFFSET UNITYSDK_OFFSET(0xA0025F0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_INTERNALCALLPREPARED_OFFSET UNITYSDK_OFFSET(0xA002720)
#define MOLEMOLE_EMPTYVIDEOPLAYER_INTERNALCALLSTOP_OFFSET UNITYSDK_OFFSET(0xA002490)
#define MOLEMOLE_EMPTYVIDEOPLAYER_INTERNALPLAY_OFFSET UNITYSDK_OFFSET(0xA0032B0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ISERROR_OFFSET UNITYSDK_OFFSET(0xA004560)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ISINITMOVIE_OFFSET UNITYSDK_OFFSET(0xA001AF0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ISREADY_OFFSET UNITYSDK_OFFSET(0xA0044A0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ISVIDEOSOURCEVALID_OFFSET UNITYSDK_OFFSET(0xA0050B0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA0045C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_LOGERROR_OFFSET UNITYSDK_OFFSET(0xA0017F0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_LOGUPDATE_OFFSET UNITYSDK_OFFSET(0xA001700)
#define MOLEMOLE_EMPTYVIDEOPLAYER_LOG_OFFSET UNITYSDK_OFFSET(0xA001780)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA004BE0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ONLOOPPOINTREACHED_OFFSET UNITYSDK_OFFSET(0xA0026B0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ONSTATUSPLAYEND_OFFSET UNITYSDK_OFFSET(0xA002580)
#define MOLEMOLE_EMPTYVIDEOPLAYER_ONSTATUSSTOP_OFFSET UNITYSDK_OFFSET(0xA002420)
#define MOLEMOLE_EMPTYVIDEOPLAYER_PAUSE_1_OFFSET UNITYSDK_OFFSET(0xA0035C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_PAUSE_OFFSET UNITYSDK_OFFSET(0xA003540)
#define MOLEMOLE_EMPTYVIDEOPLAYER_PLAY_OFFSET UNITYSDK_OFFSET(0xA0030A0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_PREPARE_OFFSET UNITYSDK_OFFSET(0xA002FB0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_PRINTONSCREEN_OFFSET UNITYSDK_OFFSET(0xA001860)
#define MOLEMOLE_EMPTYVIDEOPLAYER_RELEASETEXTURE_OFFSET UNITYSDK_OFFSET(0xA004CB0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SEEKFRAME_OFFSET UNITYSDK_OFFSET(0xA003D00)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SEEKTIME_OFFSET UNITYSDK_OFFSET(0xA004080)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETAUDIOMODENONE_OFFSET UNITYSDK_OFFSET(0xA001B50)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETCALLBACK_OFFSET UNITYSDK_OFFSET(0xA001E90)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETDEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0xA001CB0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETFILEINTERNAL_OFFSET UNITYSDK_OFFSET(0xA001BB0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETRENDERPROPERTY_OFFSET UNITYSDK_OFFSET(0xA003920)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0xA0027E0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETURL_OFFSET UNITYSDK_OFFSET(0xA004270)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SETVIDEOCLIP_OFFSET UNITYSDK_OFFSET(0xA004120)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_CLIPDATA_OFFSET UNITYSDK_OFFSET(0xA0018E0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0xA003CF0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_ENABLEUPDATELOG_OFFSET UNITYSDK_OFFSET(0xA0016C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_ISLOOPING_OFFSET UNITYSDK_OFFSET(0xA0020C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_PLAYBACKSPEED_OFFSET UNITYSDK_OFFSET(0xA002160)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_PLAYONAWAKE_OFFSET UNITYSDK_OFFSET(0xA0036E0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0xA0038E0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_SIMULATE_OFFSET UNITYSDK_OFFSET(0xA001900)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_TARGETMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0xA002050)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_TARGETMATERIALRENDERER_OFFSET UNITYSDK_OFFSET(0xA0038C0)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_TARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0xA003900)
#define MOLEMOLE_EMPTYVIDEOPLAYER_SET_WAITFORFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0xA003700)
#define MOLEMOLE_EMPTYVIDEOPLAYER_STATUSCHANGEEVENTFUNC_OFFSET UNITYSDK_OFFSET(0xA005130)
#define MOLEMOLE_EMPTYVIDEOPLAYER_STEPFORWARD_OFFSET UNITYSDK_OFFSET(0xA004210)
#define MOLEMOLE_EMPTYVIDEOPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0xA004A90)
#define MOLEMOLE_EMPTYVIDEOPLAYER_UNSETCALLBACK_OFFSET UNITYSDK_OFFSET(0xA002260)
#define MOLEMOLE_EMPTYVIDEOPLAYER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA005260)
#define MOLEMOLE_EMPTYVIDEOPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xA001910)
#define MOLEMOLE_EMPTYVIDEOPLAYER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA005270)

namespace MoleMole
{
	inline static constexpr unsigned int EmptyVideoPlayer_TypeDefinitionIndex = 74425;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(EmptyVideoPlayer_TypeDefinitionIndex)->GetStaticField(0xDF40);
		}
		::System::String* m_url; // 0x48
		::UnityEngine::Renderer* _targetMaterialRenderer; // 0x50
		::Class_1_E0A05564B7F916C1* _Simulate_k__BackingField; // 0x58
		::UnityEngine::RenderTexture* _texture; // 0x60
		::UnityEngine::RenderTexture* _targetTexture; // 0x68
		::System::String* m_movieFile; // 0x70
		::System::String* _targetMaterialProperty; // 0x78
		::UnityEngine::Video::VideoRenderMode _renderMode_k__BackingField; // 0x80
		::System::Boolean m_PrepareInProgress; // 0x84
		::System::Boolean m_CanStartRendering; // 0x85
		::System::Boolean m_isFileExist; // 0x86
		::System::Boolean isInitCallback; // 0x87
		::System::Int64 currentFrameNo; // 0x88
		::System::Single _playbackSpeed; // 0x90
		::System::Int32 seekFrame; // 0x94
		::System::Boolean _waitForFirstFrame_k__BackingField; // 0x98
		::System::Boolean m_PlayPending; // 0x99
		::System::Boolean m_CanStartPlaying; // 0x9A
		::System::Boolean isCallStop; // 0x9B
		::System::Boolean isSeeking; // 0x9C
		::System::Boolean _playOnAwake; // 0x9D
		::System::Boolean isStopAndCallPlay; // 0x9E
		::System::Boolean isStopAndCallPrepare; // 0x9F
		::System::Boolean _isLoop; // 0xA0
		::System::Boolean _isCallPause; // 0xA1
		::System::Boolean _enabled; // 0xA2
		...
		::System::Void StatusChangeEventFunc(::Class_1_E0A05564B7F916C1_Enum_3_C2258C71DA000E08 status)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_E0A05564B7F916C1_Enum_3_C2258C71DA000E08))((::PBYTE)hIl2Cpp + MOLEMOLE_EMPTYVIDEOPLAYER_STATUSCHANGEEVENTFUNC_OFFSET))(this, status);
		}
