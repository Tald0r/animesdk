...
#define MOLEMOLE_UIBLACKEDGE_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0xA32BA60)
#define MOLEMOLE_UIBLACKEDGE_GETPIXELSCREENSIZEEXCLUDEBLACKEDGE_OFFSET UNITYSDK_OFFSET(0xA32CA80)
#define MOLEMOLE_UIBLACKEDGE_INIT_OFFSET UNITYSDK_OFFSET(0xA32B770)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_0B08B4F8E959C85E_OFFSET UNITYSDK_OFFSET(0xA32C900)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_BC94745F1DDE0B4C_OFFSET UNITYSDK_OFFSET(0xA32CBD0)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0xA32CBC0)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA32CCB0)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xA32CCA0)
#define MOLEMOLE_UIBLACKEDGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA32B990)
#define MOLEMOLE_UIBLACKEDGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA32B6E0)
#define MOLEMOLE_UIBLACKEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA32CBA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBlackEdge_TypeDefinitionIndex = 48010;
	...
	public:
		...
		::System::Void Method_5_BC94745F1DDE0B4C(::System::Int32 a1, ::System::Int32 a2, ::System::Single a3)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::Int32, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBLACKEDGE_METHOD_5_BC94745F1DDE0B4C_OFFSET))(this, a1, a2, a3);
		}
		...
		{
			return ((::UnityEngine::Canvas*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBLACKEDGE_METHOD_5_0B08B4F8E959C85E_OFFSET))(this);
		}
	};
}
