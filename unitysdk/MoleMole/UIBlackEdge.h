...
#define MOLEMOLE_UIBLACKEDGE_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0xB756AD0)
#define MOLEMOLE_UIBLACKEDGE_GETPIXELSCREENSIZEEXCLUDEBLACKEDGE_OFFSET UNITYSDK_OFFSET(0xD0F3750)
#define MOLEMOLE_UIBLACKEDGE_INIT_OFFSET UNITYSDK_OFFSET(0xB7567E0)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_0B08B4F8E959C85E_OFFSET UNITYSDK_OFFSET(0xD0F39D0)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_BC94745F1DDE0B4C_OFFSET UNITYSDK_OFFSET(0xD0F38A0)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0xD0F3B50)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD0F3970)
#define MOLEMOLE_UIBLACKEDGE_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xD0F3890)
#define MOLEMOLE_UIBLACKEDGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB756A00)
#define MOLEMOLE_UIBLACKEDGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB756750)
#define MOLEMOLE_UIBLACKEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0F3870)

namespace MoleMole
{
	inline static constexpr unsigned int UIBlackEdge_TypeDefinitionIndex = 63840;
