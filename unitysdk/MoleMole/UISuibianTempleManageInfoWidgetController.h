...
class Class_1_DCC2F111274F58BD;
...
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_CLEARPRODUCTBIND_OFFSET UNITYSDK_OFFSET(0xAB96600)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_CLOSEINFOALL_OFFSET UNITYSDK_OFFSET(0xAB96CD0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_CLOSETEMPLEPRODUCTINFO_OFFSET UNITYSDK_OFFSET(0xAB9B5E0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_CREATEPRODUCTTAB_OFFSET UNITYSDK_OFFSET(0xAB99BB0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_GETDEFAULTSELECTPRODUCTID_OFFSET UNITYSDK_OFFSET(0xAB98D10)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xAB9B9B0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xAB95E00)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_INITLOGO_OFFSET UNITYSDK_OFFSET(0xAB98430)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_INITORIFILTER_OFFSET UNITYSDK_OFFSET(0xAB97AA0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_INITPRODUCTTAB_OFFSET UNITYSDK_OFFSET(0xAB97C30)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_INITPROPERTYBIND_OFFSET UNITYSDK_OFFSET(0xAB97400)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_INITSELECTPRODUCT_OFFSET UNITYSDK_OFFSET(0xAB98A60)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_ONCLICKRESEARCHSUBTAB_OFFSET UNITYSDK_OFFSET(0xAB99AD0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB959E0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_ONSELECTBUDDY_OFFSET UNITYSDK_OFFSET(0xAB9A8A0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_ONSELECTROWITEM_OFFSET UNITYSDK_OFFSET(0xAB95BA0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_ONTEMPLESIMPRODUCTSELECTPANELSYNCBLOCK_OFFSET UNITYSDK_OFFSET(0xAB960E0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB96260)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB95F10)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB96690)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_OPENRIGHTWIDGET_OFFSET UNITYSDK_OFFSET(0xAB97650)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_REFRESHBOTTOMTIPS_OFFSET UNITYSDK_OFFSET(0xAB98610)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_REFRESHCONSOLE_OFFSET UNITYSDK_OFFSET(0xAB99A40)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_REFRESHPRODUCTSBYFILTER_OFFSET UNITYSDK_OFFSET(0xAB9A260)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_REFRESHPRODUCTSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xAB9AA30)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_REFRESHPRODUCTSELECTCURSHELVEID_OFFSET UNITYSDK_OFFSET(0xAB96F10)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_REFRESHPRODUCTTAB_OFFSET UNITYSDK_OFFSET(0xAB98020)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_REFRESHREPLACETITLE_OFFSET UNITYSDK_OFFSET(0xAB971D0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_REFRESHSORTMODULE_OFFSET UNITYSDK_OFFSET(0xAB98210)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_REFRESHTABNOTIFICATION_OFFSET UNITYSDK_OFFSET(0xAB99E40)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_REFRESHTABSELECT_OFFSET UNITYSDK_OFFSET(0xAB9A0F0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAB96920)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xAB9B650)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_RESTOREPARAS_OFFSET UNITYSDK_OFFSET(0xAB9B6C0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_SELECTPRODUCTTYPE_OFFSET UNITYSDK_OFFSET(0xAB9A060)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_SETLINKSTATUS_OFFSET UNITYSDK_OFFSET(0xAB967C0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xAB9BB00)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB9B9C0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER__ONCREATEVIEW_B__7_0_OFFSET UNITYSDK_OFFSET(0xAB9BC90)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER__REFRESHSORTMODULE_B__35_0_OFFSET UNITYSDK_OFFSET(0xAB9BD10)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xAB9C140)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB9C1A0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB9C210)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB9C290)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB9C2F0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleManageInfoWidgetController_TypeDefinitionIndex = 40169;
	...
	public:
		...
		{
			return (::Class_2_97B8C5560BEC00CB<::Class_2_1E89A1A01EA84819*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(UISuibianTempleManageInfoWidgetController_TypeDefinitionIndex)->GetStaticField(0x41E10);
		}
		// static const ::System::Int32 AllProductType = 0x0; // 0x0
		::Class_2_D7C82C373A53D1D3* _view; // 0x2A0
		::Class_2_2BD3078077E999CE<::Class_2_1E89A1A01EA84819*>* _sort; // 0x2A8
		::Class_1_DCC2F111274F58BD* sortModule; // 0x2B0
		...
		::Enum_3_CC3BC82D2D2360D0 linkType; // 0x328
