...
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_CLEARFOCUS_OFFSET UNITYSDK_OFFSET(0xDF5EFF0)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_GET_VHSCOLLECTIONID_OFFSET UNITYSDK_OFFSET(0xDF5FBF0)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_GET__DATA_OFFSET UNITYSDK_OFFSET(0xDF5F690)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_ONAFTERVHSSELECTCHANGE_OFFSET UNITYSDK_OFFSET(0xDF5F960)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF5E260)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xDF5EDF0)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_ONSCROLLITEMUPDATEINNER_OFFSET UNITYSDK_OFFSET(0xDF5E8B0)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDF5E7D0)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xDF5E680)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF5E6F0)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF5E300)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF5E5D0)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_ONVHSSTORELIMITSUBMITED_OFFSET UNITYSDK_OFFSET(0xDF5FB70)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_ONVHSSTORELIMITSUBMITTING_OFFSET UNITYSDK_OFFSET(0xDF5FB00)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_SETBGLOCK_OFFSET UNITYSDK_OFFSET(0xDF5F100)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_SETBUTTONNOINTERACTIVE_OFFSET UNITYSDK_OFFSET(0xDF5F080)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_SETCANTSELECT_OFFSET UNITYSDK_OFFSET(0xDF5F7D0)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_SETCLICK_OFFSET UNITYSDK_OFFSET(0xDF5F190)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_SETDATAID_OFFSET UNITYSDK_OFFSET(0xDF5F200)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xDF5F710)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_SETFOCUS_OFFSET UNITYSDK_OFFSET(0xDF5EF60)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_SETMULTISELECTFULL_OFFSET UNITYSDK_OFFSET(0xDF5FA70)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0xDF5F9E0)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_SET_VHSCOLLECTIONID_OFFSET UNITYSDK_OFFSET(0xDF5FC00)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_SHOWFIRSTLIGHT_OFFSET UNITYSDK_OFFSET(0xDF5F880)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF5FC10)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0xDF5FC20)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF5FC80)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xDF5FCF0)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDF5FD60)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xDF5FDE0)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF5FDF0)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF5FE70)
#define MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF5FED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStorePicBtnWidgetController_TypeDefinitionIndex = 49298;
	...
	public:
		...
		::Class_2_208CC9941471731A_836* get__data()
		{
			return ((::Class_2_208CC9941471731A_836*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVHSSTOREPICBTNWIDGETCONTROLLER_GET__DATA_OFFSET))(this);
		}
