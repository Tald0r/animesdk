...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_CHECKUSELAZYLOADING_OFFSET UNITYSDK_OFFSET(0x3B8CA0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x3B8C90)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_ONTEXPATHCHANGE_OFFSET UNITYSDK_OFFSET(0x3B8D60)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_TRYLOADTEXTURE_OFFSET UNITYSDK_OFFSET(0x3B8D50)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_WARMUP_OFFSET UNITYSDK_OFFSET(0x3B8DC0)

namespace MoleMole
{
	inline static constexpr unsigned int MaterialPropertyModifierValueTexture_TypeDefinitionIndex = 65546;
