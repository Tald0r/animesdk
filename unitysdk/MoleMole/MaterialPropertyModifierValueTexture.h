...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_CHECKUSELAZYLOADING_OFFSET UNITYSDK_OFFSET(0x3F21F0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x3F21E0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_ONTEXPATHCHANGE_OFFSET UNITYSDK_OFFSET(0x3F22B0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_TRYLOADTEXTURE_OFFSET UNITYSDK_OFFSET(0x3F22A0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUETEXTURE_WARMUP_OFFSET UNITYSDK_OFFSET(0x3F2310)

namespace MoleMole
{
	inline static constexpr unsigned int MaterialPropertyModifierValueTexture_TypeDefinitionIndex = 55538;
