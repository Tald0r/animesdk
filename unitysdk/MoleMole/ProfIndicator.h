...
#define MOLEMOLE_PROFINDICATOR_AWAKE_OFFSET UNITYSDK_OFFSET(0x6EC5930)
#define MOLEMOLE_PROFINDICATOR_CHECKGENERALUI_OFFSET UNITYSDK_OFFSET(0x6EC67E0)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_0747954DF3B63AAB_OFFSET UNITYSDK_OFFSET(0x6EC8FC0)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0x6EC7F00)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_2FDE0CE02EC294DE_OFFSET UNITYSDK_OFFSET(0x6EC9040)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x6EC7DF0)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_36971FC3F16E2CEB_OFFSET UNITYSDK_OFFSET(0x6EC82C0)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x6EC6B70)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_C521AF86F7597260_OFFSET UNITYSDK_OFFSET(0x6EC9560)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_DCD9FE8382DA243A_OFFSET UNITYSDK_OFFSET(0x6EC8F20)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x6EC7670)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x6EC7490)
#define MOLEMOLE_PROFINDICATOR_ONANIMATIONCLIPBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6EC7880)
#define MOLEMOLE_PROFINDICATOR_ONMATERIALBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6EC78F0)
#define MOLEMOLE_PROFINDICATOR_ONMESHBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6EC7810)
#define MOLEMOLE_PROFINDICATOR_ONRENDERTEXTUREBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6EC77A0)
#define MOLEMOLE_PROFINDICATOR_ONSTREAMASBCLICK_OFFSET UNITYSDK_OFFSET(0x6EC7960)
#define MOLEMOLE_PROFINDICATOR_ONTEXTUREBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6EC7600)
#define MOLEMOLE_PROFINDICATOR_ONTOTALBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6EC7580)
#define MOLEMOLE_PROFINDICATOR_ONUPLOADBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6EC7BE0)
#define MOLEMOLE_PROFINDICATOR_RECORDMEMORY_OFFSET UNITYSDK_OFFSET(0x6EC6F00)
#define MOLEMOLE_PROFINDICATOR_RESETMAXMEMORY_OFFSET UNITYSDK_OFFSET(0x6EC79D0)
#define MOLEMOLE_PROFINDICATOR_START_OFFSET UNITYSDK_OFFSET(0x6EC6AE0)
#define MOLEMOLE_PROFINDICATOR_TRACKCURMEM_OFFSET UNITYSDK_OFFSET(0x6EC7B40)
#define MOLEMOLE_PROFINDICATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x6EC6D40)
#define MOLEMOLE_PROFINDICATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x6EC7DB0)
#define MOLEMOLE_PROFINDICATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6EC7C40)

namespace MoleMole
{
	inline static constexpr unsigned int ProfIndicator_TypeDefinitionIndex = 64677;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ProfIndicator_TypeDefinitionIndex)->GetStaticField(0x44270);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_PROFINDICATOR_METHOD_5_C521AF86F7597260_OFFSET))(this, a1);
		}
	};
}
