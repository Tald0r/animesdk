...
#define MOLEMOLE_PROFINDICATOR_AWAKE_OFFSET UNITYSDK_OFFSET(0x6E53210)
#define MOLEMOLE_PROFINDICATOR_CHECKGENERALUI_OFFSET UNITYSDK_OFFSET(0x6E540C0)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_0747954DF3B63AAB_OFFSET UNITYSDK_OFFSET(0x6E55A40)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0x6E55B60)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_2FDE0CE02EC294DE_OFFSET UNITYSDK_OFFSET(0x6E56B80)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x6E55930)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_36971FC3F16E2CEB_OFFSET UNITYSDK_OFFSET(0x6E55F20)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x6E54450)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_C521AF86F7597260_OFFSET UNITYSDK_OFFSET(0x6E556E0)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_DCD9FE8382DA243A_OFFSET UNITYSDK_OFFSET(0x6E55AC0)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x6E54F50)
#define MOLEMOLE_PROFINDICATOR_METHOD_5_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x6E54D70)
#define MOLEMOLE_PROFINDICATOR_ONANIMATIONCLIPBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E55160)
#define MOLEMOLE_PROFINDICATOR_ONMATERIALBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E551D0)
#define MOLEMOLE_PROFINDICATOR_ONMESHBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E550F0)
#define MOLEMOLE_PROFINDICATOR_ONRENDERTEXTUREBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E55080)
#define MOLEMOLE_PROFINDICATOR_ONSTREAMASBCLICK_OFFSET UNITYSDK_OFFSET(0x6E55240)
#define MOLEMOLE_PROFINDICATOR_ONTEXTUREBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E54EE0)
#define MOLEMOLE_PROFINDICATOR_ONTOTALBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E54E60)
#define MOLEMOLE_PROFINDICATOR_ONUPLOADBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E554C0)
#define MOLEMOLE_PROFINDICATOR_RECORDMEMORY_OFFSET UNITYSDK_OFFSET(0x6E547E0)
#define MOLEMOLE_PROFINDICATOR_RESETMAXMEMORY_OFFSET UNITYSDK_OFFSET(0x6E552B0)
#define MOLEMOLE_PROFINDICATOR_START_OFFSET UNITYSDK_OFFSET(0x6E543C0)
#define MOLEMOLE_PROFINDICATOR_TRACKCURMEM_OFFSET UNITYSDK_OFFSET(0x6E55420)
#define MOLEMOLE_PROFINDICATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x6E54620)
#define MOLEMOLE_PROFINDICATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x6E556A0)
#define MOLEMOLE_PROFINDICATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6E55520)

namespace MoleMole
{
	inline static constexpr unsigned int ProfIndicator_TypeDefinitionIndex = 64962;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ProfIndicator_TypeDefinitionIndex)->GetStaticField(0x44C10);
		}
