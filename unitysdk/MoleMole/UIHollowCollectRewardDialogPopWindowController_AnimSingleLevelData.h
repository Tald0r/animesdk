...
#define MOLEMOLE_UIHOLLOWCOLLECTREWARDDIALOGPOPWINDOWCONTROLLER_ANIMSINGLELEVELDATA_GET_RATIO_OFFSET UNITYSDK_OFFSET(0x7A715F0)
#define MOLEMOLE_UIHOLLOWCOLLECTREWARDDIALOGPOPWINDOWCONTROLLER_ANIMSINGLELEVELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x7A71670)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCollectRewardDialogPopWindowController_AnimSingleLevelData_TypeDefinitionIndex = 55179;

	class UIHollowCollectRewardDialogPopWindowController_AnimSingleLevelData : public ::System::Object
	{
	public:
		::System::Int32 m_leftNum; // 0x10
