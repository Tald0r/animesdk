...
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_DEALFRIENDINVITEMSG_OFFSET UNITYSDK_OFFSET(0x6C6A710)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_DNAUTOOPEN_OFFSET UNITYSDK_OFFSET(0x6C6AE80)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x6C69730)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ISALLOWJUMPTOINVITETEAMROOM_OFFSET UNITYSDK_OFFSET(0x6C6D140)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ISALLOWSHOWINVITE_OFFSET UNITYSDK_OFFSET(0x6C6D020)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONCLICKMARCELADVENTURE_OFFSET UNITYSDK_OFFSET(0x6C6C5E0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONCLICKREWARDPANEL_OFFSET UNITYSDK_OFFSET(0x6C6C480)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONCLICKRIDUBOO_OFFSET UNITYSDK_OFFSET(0x6C6C8E0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C69740)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONGOLDMININGDAYACTIVITYSYNC_OFFSET UNITYSDK_OFFSET(0x6C6A410)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x6C6CB90)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6C6A1C0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C6CE00)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6C697E0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6C6ADB0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SETTIME_OFFSET UNITYSDK_OFFSET(0x6C6C1C0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SHOWALLPROGRESSBTN_OFFSET UNITYSDK_OFFSET(0x6C6BD90)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SHOWCOLLECTIONBTN_OFFSET UNITYSDK_OFFSET(0x6C6AFF0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SHOWINVITE_OFFSET UNITYSDK_OFFSET(0x6C6D1A0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SHOWMARCELADVENTUREBTN_OFFSET UNITYSDK_OFFSET(0x6C6B060)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SHOWRIDUBOOBTN_OFFSET UNITYSDK_OFFSET(0x6C6B780)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_SHOWTODOLISTBTN_OFFSET UNITYSDK_OFFSET(0x6C6AF80)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER_TRYJOINMARCELADVENTURE_OFFSET UNITYSDK_OFFSET(0x6C6D2C0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6C6DB70)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER__ISALLOWSHOWINVITE_B__22_0_OFFSET UNITYSDK_OFFSET(0x6C6DCC0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER__ONUIINIT_B__10_1_OFFSET UNITYSDK_OFFSET(0x6C6DB80)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER__SETTIME_B__14_0_OFFSET UNITYSDK_OFFSET(0x6C6DC80)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C6DCD0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x6C6DD40)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6C6DDA0)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C6DE10)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6C6DE20)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6C6DE30)

namespace MoleMole
{
	inline static constexpr unsigned int UIGoldMiningDayMainPageController_TypeDefinitionIndex = 58978;

	class UIGoldMiningDayMainPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_C7387D40D4120A48_11* _view; // 0x308
