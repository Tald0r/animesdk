...
#define MOLEMOLE_TOWERDEFENSENEWBIEDISPLAYMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xC242ED0)
#define MOLEMOLE_TOWERDEFENSENEWBIEDISPLAYMESSAGE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0xC242E50)
#define MOLEMOLE_TOWERDEFENSENEWBIEDISPLAYMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC242E20)
#define MOLEMOLE_TOWERDEFENSENEWBIEDISPLAYMESSAGE___BASE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0xC243160)

namespace MoleMole
{
	inline static constexpr unsigned int TowerDefenseNewbieDisplayMessage_TypeDefinitionIndex = 48455;
