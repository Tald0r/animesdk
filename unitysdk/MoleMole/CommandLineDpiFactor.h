...
#define MOLEMOLE_COMMANDLINEDPIFACTOR_METHOD_2_636A411572909B7F_OFFSET UNITYSDK_OFFSET(0x6FC0FB0)
#define MOLEMOLE_COMMANDLINEDPIFACTOR_METHOD_2_96BB3F4580463B05_OFFSET UNITYSDK_OFFSET(0x6FC0E70)
#define MOLEMOLE_COMMANDLINEDPIFACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6FC0F70)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineDpiFactor_TypeDefinitionIndex = 72163;
