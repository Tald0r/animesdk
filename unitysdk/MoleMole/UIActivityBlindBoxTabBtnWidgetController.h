...
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBF0EF40)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBF0EFB0)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBF0F070)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF0F240)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBF0F270)
#define MOLEMOLE_UIACTIVITYBLINDBOXTABBTNWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBF0F2E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityBlindBoxTabBtnWidgetController_TypeDefinitionIndex = 69366;
