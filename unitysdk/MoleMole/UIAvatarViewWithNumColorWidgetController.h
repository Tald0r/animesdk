...
class Class_3_19EF277AF5D11235_8;
...
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB909560)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_ONCOOPMATCHMESSAGE_OFFSET UNITYSDK_OFFSET(0xB90A620)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB9095D0)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB9098B0)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xB90A330)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB909690)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0xB90A2A0)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_SHOWPLATFORMUI_OFFSET UNITYSDK_OFFSET(0xB90A400)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_SHOWUIVIEW_OFFSET UNITYSDK_OFFSET(0xB90B4B0)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB90AD40)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB90B9A0)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER__SHOWUIVIEW_G__SETUPPLATFORMUI_13_0_OFFSET UNITYSDK_OFFSET(0xB90B8F0)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB90B9D0)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB90BA40)
#define MOLEMOLE_UIAVATARVIEWWITHNUMCOLORWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB90BAB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarViewWithNumColorWidgetController_TypeDefinitionIndex = 42046;

	class UIAvatarViewWithNumColorWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_3_19EF277AF5D11235_8* _view; // 0x2A0
		::Class_2_2F3C7D4EFC74D485* _model; // 0x2A8
		::MoleMole::UIAvatarViewWithNumColorWidgetController_Context* _context; // 0x2B0
		::System::Boolean _allowShowPlatform; // 0x2B8
		::System::Boolean _canSwitchPlatformInfo; // 0x2B9
		::System::Boolean _isShowingPlatform; // 0x2BA
		::UnityEngine::UI::Extension::UILocalizationText* displayNameText; // 0x2C0
