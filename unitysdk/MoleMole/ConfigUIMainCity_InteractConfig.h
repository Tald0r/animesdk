...
#define MOLEMOLE_CONFIGUIMAINCITY_INTERACTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD0B4840)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainCity_InteractConfig_TypeDefinitionIndex = 45453;
