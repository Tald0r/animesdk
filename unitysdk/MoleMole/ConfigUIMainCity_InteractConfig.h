...
#define MOLEMOLE_CONFIGUIMAINCITY_INTERACTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCDCF8A0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainCity_InteractConfig_TypeDefinitionIndex = 45767;
