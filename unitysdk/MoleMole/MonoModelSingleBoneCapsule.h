...
#define MOLEMOLE_MONOMODELSINGLEBONECAPSULE_GET_FLAG_OFFSET UNITYSDK_OFFSET(0x6B0D0F0)
#define MOLEMOLE_MONOMODELSINGLEBONECAPSULE_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0x6B0D100)
#define MOLEMOLE_MONOMODELSINGLEBONECAPSULE_METHOD_2_0A9F8627F6BE695B_OFFSET UNITYSDK_OFFSET(0x6B0D710)
#define MOLEMOLE_MONOMODELSINGLEBONECAPSULE__CTOR_OFFSET UNITYSDK_OFFSET(0x6B0D700)

namespace MoleMole
{
	inline static constexpr unsigned int MonoModelSingleBoneCapsule_TypeDefinitionIndex = 40918;
