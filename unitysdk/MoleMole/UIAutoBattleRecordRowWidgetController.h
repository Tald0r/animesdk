...
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER_CREATEARCADELIST_OFFSET UNITYSDK_OFFSET(0xBF30020)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER_CREATEBANGBOOWIDGETROW_OFFSET UNITYSDK_OFFSET(0xBF2FBB0)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF2E750)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER_ONDETAILBTNCLICK_OFFSET UNITYSDK_OFFSET(0xBF2FCA0)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER_ONGETFIGHTRECORDPLAYERLIST_OFFSET UNITYSDK_OFFSET(0xBF2FE40)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBF2E8D0)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF2E7F0)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF2E460)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER_REBUILDEQUIPLIST_OFFSET UNITYSDK_OFFSET(0xBF2F770)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER_REFRESHEMPTY_OFFSET UNITYSDK_OFFSET(0xBF2F660)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER__CREATEARCADELIST_G__CREATEINFO_12_1_OFFSET UNITYSDK_OFFSET(0xBF30210)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER__CREATEARCADELIST_G__GETGAMEICONPATH_12_0_OFFSET UNITYSDK_OFFSET(0xBF302C0)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF302B0)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF303F0)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBF30460)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF304E0)
#define MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF30560)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattleRecordRowWidgetController_TypeDefinitionIndex = 78061;
	...
	public:
		...
		::Class_3_B324A8064F8B45CE* _info; // 0x2E0
		...
		::System::Void OnGetFightRecordPlayerList(::Class_0_16E4307DCC419505_7* obj)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_7*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIAUTOBATTLERECORDROWWIDGETCONTROLLER_ONGETFIGHTRECORDPLAYERLIST_OFFSET))(this, obj);
		}
