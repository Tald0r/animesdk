...
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_DOWIDGETHIDE_OFFSET UNITYSDK_OFFSET(0x8BC3350)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x8BC3100)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BC2F80)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BC3020)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BC2E30)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BC2ED0)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_PLAYBUBBLEANIMATION_OFFSET UNITYSDK_OFFSET(0x8BC3170)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER_PLAYRIGHTSTATEANIMATION_OFFSET UNITYSDK_OFFSET(0x8BC3220)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8BC3450)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BC3480)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BC34F0)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BC3570)
#define MOLEMOLE_UICINEMAPLAYBUBBLE04WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BC35D0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaPlayBubble04WidgetController_TypeDefinitionIndex = 78508;
