...
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_INITPARENTCONTROLLER_OFFSET UNITYSDK_OFFSET(0xB6DDD80)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONCLICKRECENTCONNECTTAB_OFFSET UNITYSDK_OFFSET(0xB6DD770)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONCLICKRECOMMENDFRIENDTAB_OFFSET UNITYSDK_OFFSET(0xB6DD650)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6DD890)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xB6DDBE0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONRECEIVEPLAYERLIST_OFFSET UNITYSDK_OFFSET(0xB6DDED0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONRECEIVERECENTPLAYERLIST_OFFSET UNITYSDK_OFFSET(0xB6DE600)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONRECEIVERECOMMENDFRIENDLIST_OFFSET UNITYSDK_OFFSET(0xB6DE690)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB6DD930)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6DDCA0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6DD0D0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_TRIGGERRECOMMENDMORE_OFFSET UNITYSDK_OFFSET(0xB6DDDF0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB6DE720)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONSHOW_B__7_0_OFFSET UNITYSDK_OFFSET(0xB6DE870)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0xB6DE750)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0xB6DE760)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONUIINIT_B__3_2_OFFSET UNITYSDK_OFFSET(0xB6DE770)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONUIINIT_B__3_3_OFFSET UNITYSDK_OFFSET(0xB6DE7F0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6DE8D0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xB6DE940)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB6DE9A0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6DEA10)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6DEA90)

namespace MoleMole
{
	inline static constexpr unsigned int UIRecentPlayerWidgetController_TypeDefinitionIndex = 41879;
