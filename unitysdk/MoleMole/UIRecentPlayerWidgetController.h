...
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_INITPARENTCONTROLLER_OFFSET UNITYSDK_OFFSET(0x9EB4CB0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONCLICKRECENTCONNECTTAB_OFFSET UNITYSDK_OFFSET(0x9EB46A0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONCLICKRECOMMENDFRIENDTAB_OFFSET UNITYSDK_OFFSET(0x9EB4580)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9EB47C0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x9EB4B10)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONRECEIVEPLAYERLIST_OFFSET UNITYSDK_OFFSET(0x9EB4E00)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONRECEIVERECENTPLAYERLIST_OFFSET UNITYSDK_OFFSET(0x9EB5510)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONRECEIVERECOMMENDFRIENDLIST_OFFSET UNITYSDK_OFFSET(0x9EB55A0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9EB4860)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9EB4BD0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9EB4000)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_TRIGGERRECOMMENDMORE_OFFSET UNITYSDK_OFFSET(0x9EB4D20)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9EB5630)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONSHOW_B__7_0_OFFSET UNITYSDK_OFFSET(0x9EB5780)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x9EB5660)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0x9EB5670)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONUIINIT_B__3_2_OFFSET UNITYSDK_OFFSET(0x9EB5680)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER__ONUIINIT_B__3_3_OFFSET UNITYSDK_OFFSET(0x9EB5700)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9EB57E0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x9EB5850)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9EB58B0)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9EB5920)
#define MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9EB59A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRecentPlayerWidgetController_TypeDefinitionIndex = 76492;
	...
	public:
		...
		::MoleMole::UIRecentPlayerWidgetController_TabType _currSelectTab; // 0x2B0
		::MoleMole::UIFriendSystemWidgetController* _parentWidgetController; // 0x2B8
		...
		::System::Void OnReceivePlayerList(::System::Collections::Generic::List_1<::Class_1_BE6BF7909AD9D940*>* list, ::Enum_3_AA67334306B34AB0 tabType)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_1_BE6BF7909AD9D940*>*, ::Enum_3_AA67334306B34AB0))((::PBYTE)hIl2Cpp + MOLEMOLE_UIRECENTPLAYERWIDGETCONTROLLER_ONRECEIVEPLAYERLIST_OFFSET))(this, list, tabType);
		}
