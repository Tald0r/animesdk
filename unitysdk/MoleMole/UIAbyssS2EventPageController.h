...
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER_GET_ISLISTOPEN_OFFSET UNITYSDK_OFFSET(0xC24B910)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC24AD20)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER_ONABYSSS2EVENTSELECT_OFFSET UNITYSDK_OFFSET(0xC24C820)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER_ONBACKBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC24B7F0)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC24AD30)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER_ONMAINBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC24BDC0)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC24B760)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC24ADD0)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC24B3D0)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER_REFRESHINFOVIEW_OFFSET UNITYSDK_OFFSET(0xC24C030)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER_REFRESHLISTVIEW_OFFSET UNITYSDK_OFFSET(0xC24C360)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC24B5A0)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC24C930)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC24C940)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC24C9B0)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC24C9C0)
#define MOLEMOLE_UIABYSSS2EVENTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC24C9D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2EventPageController_TypeDefinitionIndex = 73340;

	class UIAbyssS2EventPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_125* _view; // 0x2F8
		...
		::Class_2_208CC9941471731A_677* _entranceConfig; // 0x328
		::System::Collections::Generic::List_1<::Class_2_14E7CE92E8A3183F*>* _dungeonConfigs; // 0x330
		::Class_2_0A55B5A82A61DAFA_1* _currSelectQuestConfig; // 0x338
