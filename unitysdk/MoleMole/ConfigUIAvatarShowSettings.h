...
#define MOLEMOLE_CONFIGUIAVATARSHOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x13FAF810)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAvatarShowSettings_TypeDefinitionIndex = 77973;
