...
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER___C__DISPLAYCLASS100_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8714210)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER___C__DISPLAYCLASS100_0__PLAYCHANGETRACK_B__0_OFFSET UNITYSDK_OFFSET(0x8714220)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER___C__DISPLAYCLASS100_0__PLAYCHANGETRACK_B__1_OFFSET UNITYSDK_OFFSET(0x8714250)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER___C__DISPLAYCLASS100_0__PLAYCHANGETRACK_B__2_OFFSET UNITYSDK_OFFSET(0x8714280)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsRowWidgetController___c__DisplayClass100_0_TypeDefinitionIndex = 58130;
