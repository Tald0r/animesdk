...
class Class_2_0C505066109FB1C7_Class_2_EF16346D79C18F15_12;
...
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_CLONEMATERIALS_OFFSET UNITYSDK_OFFSET(0xCA9A8A0)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_DISPOSEMATERIALS_OFFSET UNITYSDK_OFFSET(0xCA9A7E0)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xCA9B4C0)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0xCA9A590)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA9AFD0)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA9B070)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA9A5A0)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA9AB00)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_ONUIREUSE_OFFSET UNITYSDK_OFFSET(0xCA9B160)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_PLAYANIMFORCAMP_OFFSET UNITYSDK_OFFSET(0xCA9B5D0)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_REFRESHVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA9AD80)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_RELEASEUI_OFFSET UNITYSDK_OFFSET(0xCA9B3D0)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_SETICON_OFFSET UNITYSDK_OFFSET(0xCA9B870)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_TOGGLEDRAG_OFFSET UNITYSDK_OFFSET(0xCA9BA40)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_TOGGLEFOCUS_OFFSET UNITYSDK_OFFSET(0xCA9B540)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCA9B450)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA9BB90)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER__PLAYANIMFORCAMP_B__24_0_OFFSET UNITYSDK_OFFSET(0xCA9BBC0)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA9BC10)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA9BC80)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA9BD00)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA9BD60)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER___BASE_ONUIREUSE_OFFSET UNITYSDK_OFFSET(0xCA9BDD0)
#define MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER___BASE_RELEASEUI_OFFSET UNITYSDK_OFFSET(0xCA9BE30)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattleMonsterHudWidgetController_TypeDefinitionIndex = 52447;
	...
	public:
		...
		::System::Void SetIcon(::Class_2_0C505066109FB1C7_Class_2_EF16346D79C18F15_12* icon, ::System::Int32 campId)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_0C505066109FB1C7_Class_2_EF16346D79C18F15_12*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIAUTOBATTLEMONSTERHUDWIDGETCONTROLLER_SETICON_OFFSET))(this, icon, campId);
		}
