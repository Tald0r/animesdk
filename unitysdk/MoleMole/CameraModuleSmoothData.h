...
#define MOLEMOLE_CAMERAMODULESMOOTHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6D33BD0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraModuleSmoothData_TypeDefinitionIndex = 75935;
