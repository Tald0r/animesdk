...
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0xB1C0200)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_CREATESPINERENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0xB1C04B0)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xB1C0670)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_METHOD_5_78A816EDF045E4C8_OFFSET UNITYSDK_OFFSET(0xB1C0CE0)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_METHOD_5_DFFF3EBEA7DBE379_OFFSET UNITYSDK_OFFSET(0xB1C0E20)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB1C02C0)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE_RELEASESPINERENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0xB1C0420)
#define MOLEMOLE_SPINESKELETONRENDERTEXTUREBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xB1C0640)

namespace MoleMole
{
	inline static constexpr unsigned int SpineSkeletonRenderTextureBase_TypeDefinitionIndex = 71456;
