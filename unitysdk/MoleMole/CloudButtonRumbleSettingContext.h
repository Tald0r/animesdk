...
#define MOLEMOLE_CLOUDBUTTONRUMBLESETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBADB7E0)

namespace MoleMole
{
	inline static constexpr unsigned int CloudButtonRumbleSettingContext_TypeDefinitionIndex = 63221;
