...
#define MOLEMOLE_CLOUDBUTTONRUMBLESETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6D3A840)

namespace MoleMole
{
	inline static constexpr unsigned int CloudButtonRumbleSettingContext_TypeDefinitionIndex = 77540;
