...
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS356_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA52C5C0)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS356_0__SHOWSPLITSCREENPERFORMANCE_B__0_OFFSET UNITYSDK_OFFSET(0xA52C5D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController___c__DisplayClass356_0_TypeDefinitionIndex = 45632;
