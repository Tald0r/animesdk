...
#define MOLEMOLE_CONFIGBUDDYAVATARSHOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0xCD28490)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigBuddyAvatarShowSettings_TypeDefinitionIndex = 48521;
