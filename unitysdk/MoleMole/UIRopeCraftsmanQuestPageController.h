...
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD7B6AD0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_INITANDNPCREDSIGN_OFFSET UNITYSDK_OFFSET(0xD7B8AC0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ISCANSHOWENDDESC_OFFSET UNITYSDK_OFFSET(0xD7B8220)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONCLICKTASK_OFFSET UNITYSDK_OFFSET(0xD7B7900)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD7B6AE0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD7B77C0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONGOMAPBUTTON_OFFSET UNITYSDK_OFFSET(0xD7B8530)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONINFOBTN_OFFSET UNITYSDK_OFFSET(0xD7B8440)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD7B71E0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD7B75D0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD7B7560)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD7B6ED0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_OPENPANEL_OFFSET UNITYSDK_OFFSET(0xD7B86E0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_REFRESHPANEL_OFFSET UNITYSDK_OFFSET(0xD7B7000)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_SETGOTOTASKBUTTONENABLE_OFFSET UNITYSDK_OFFSET(0xD7B83B0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_SHOWGOTOACTIVITYBUTTON_OFFSET UNITYSDK_OFFSET(0xD7B7660)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD7B8D60)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER__ONGOMAPBUTTON_B__18_0_OFFSET UNITYSDK_OFFSET(0xD7B8D70)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD7B8F50)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD7B8FC0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD7B9080)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD7B9090)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD7B90A0)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD7B90B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRopeCraftsmanQuestPageController_TypeDefinitionIndex = 54069;

	class UIRopeCraftsmanQuestPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79EB9A268E300B2A* _view; // 0x2F8
		::MoleMole::UIRopeCraftsmanQuestPageController_PanelData* _panelData; // 0x300
		::UIWidgetGroup* _itemGroup; // 0x308
		::MoleMole::UIRopeCraftsmanQuestPageController_ItemData* _currentItemData; // 0x310
		::MoleMole::UIActivityCompRewardBtnGroupWidgetController* _gotoActivityButtonGroup; // 0x318
