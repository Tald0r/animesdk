...
#define MOLEMOLE_EDITORTIMEPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC1E9510)

namespace MoleMole
{
	inline static constexpr unsigned int EditorTimePopWindowContext_TypeDefinitionIndex = 64440;
	...
	public:
		...
		::System::Action_1<::System::Int32>* ApplyCallback; // 0x30
