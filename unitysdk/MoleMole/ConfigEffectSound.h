...
#define MOLEMOLE_CONFIGEFFECTSOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x15ECAA20)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigEffectSound_TypeDefinitionIndex = 74604;
