...
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB8B42C0)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB8B4380)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB8B43E0)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB8B4390)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB8B42B0)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95__CTOR_OFFSET UNITYSDK_OFFSET(0xB8B42A0)

namespace MoleMole
{
	inline static constexpr unsigned int Launcher_Class_1_2BEF04B0321A2B95_TypeDefinitionIndex = 79548;
