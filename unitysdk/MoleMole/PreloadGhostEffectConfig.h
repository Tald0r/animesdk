...
#define MOLEMOLE_PRELOADGHOSTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8A89840)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadGhostEffectConfig_TypeDefinitionIndex = 52625;
