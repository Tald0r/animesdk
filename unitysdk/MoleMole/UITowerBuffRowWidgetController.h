...
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_BINDNOTFICATION_OFFSET UNITYSDK_OFFSET(0x7533250)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7532D90)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7532E30)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7532B00)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7532CE0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x7533320)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x7532FA0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0x75334D0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x7533540)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER_SETLOCK_OFFSET UNITYSDK_OFFSET(0x7532F10)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7533770)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x75337A0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x75337C0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7533830)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x75338B0)
#define MOLEMOLE_UITOWERBUFFROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7533910)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerBuffRowWidgetController_TypeDefinitionIndex = 41767;

	class UITowerBuffRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_124142F81A078603* _view; // 0x2A0
		::System::Int32 itemid; // 0x2A8
		::System::Action* callback; // 0x2B0
