...
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_CUSTOMVIEW_OFFSET UNITYSDK_OFFSET(0xB92D630)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB92D6D0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_PHOTOLOGO_CLOUDGAME_OFFSET UNITYSDK_OFFSET(0xB92D8D0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_PHOTOLOGO_OFFSET UNITYSDK_OFFSET(0xB92D850)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0xB92D750)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0xB92D650)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_VERID_TEXT_OFFSET UNITYSDK_OFFSET(0xB92D7D0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB92F650)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xB92F540)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONPHOTOPLAYERINFOCHANGE_OFFSET UNITYSDK_OFFSET(0xB92DAE0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB92DFE0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB92F5E0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB92D950)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB92DF30)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SETPHOTOLOGO_OFFSET UNITYSDK_OFFSET(0xB92F6C0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SET_CUSTOMVIEW_OFFSET UNITYSDK_OFFSET(0xB92D640)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SHOWNICKNAME_OFFSET UNITYSDK_OFFSET(0xB92E120)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SHOWUID_OFFSET UNITYSDK_OFFSET(0xB92E510)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SHOWWITHCONTEXT_OFFSET UNITYSDK_OFFSET(0xB92E880)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_UPDATEPLAYERINFO_OFFSET UNITYSDK_OFFSET(0xB92DB60)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB92FE40)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB92FE70)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xB92FE80)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB92FEE0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB92FF50)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB92FF60)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB92FFC0)

namespace MoleMole
{
	inline static constexpr unsigned int PhotoFrameCustomWidgetController_TypeDefinitionIndex = 42312;

	class PhotoFrameCustomWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::MoleMole::PhotoFrameCustomWidgetView* _CustomView_k__BackingField; // 0x2A0
		::MoleMole::UIControllerContextBase* _context; // 0x2A8
