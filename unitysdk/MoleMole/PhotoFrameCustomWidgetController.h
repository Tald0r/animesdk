...
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_CUSTOMVIEW_OFFSET UNITYSDK_OFFSET(0x830F6C0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x830F760)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_PHOTOLOGO_CLOUDGAME_OFFSET UNITYSDK_OFFSET(0x830F960)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_PHOTOLOGO_OFFSET UNITYSDK_OFFSET(0x830F8E0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0x830F7E0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0x830F6E0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_GET_VERID_TEXT_OFFSET UNITYSDK_OFFSET(0x830F860)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8311710)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x8311600)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONPHOTOPLAYERINFOCHANGE_OFFSET UNITYSDK_OFFSET(0x830FB70)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8310070)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x83116A0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x830F9E0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x830FFC0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SETPHOTOLOGO_OFFSET UNITYSDK_OFFSET(0x8311780)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SET_CUSTOMVIEW_OFFSET UNITYSDK_OFFSET(0x830F6D0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SHOWNICKNAME_OFFSET UNITYSDK_OFFSET(0x83101B0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SHOWUID_OFFSET UNITYSDK_OFFSET(0x83105B0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_SHOWWITHCONTEXT_OFFSET UNITYSDK_OFFSET(0x8310930)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER_UPDATEPLAYERINFO_OFFSET UNITYSDK_OFFSET(0x830FBF0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8311F00)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8311F30)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x8311F40)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8311FA0)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8312010)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8312020)
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8312080)

namespace MoleMole
{
	inline static constexpr unsigned int PhotoFrameCustomWidgetController_TypeDefinitionIndex = 72098;
