...
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_GETLOGICBUTTONNEWKEYCODE_OFFSET UNITYSDK_OFFSET(0x9EC07A0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x9EC00F0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9EBFF70)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9EC0010)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9EBFD80)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9EBFE20)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x9EC0B50)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9EC0C00)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0x9EC0C30)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER__ONUIOPEN_B__2_1_OFFSET UNITYSDK_OFFSET(0x9EC0C40)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9EC0C50)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9EC0CC0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9EC0D40)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9EC0DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIKeyBindingConflictRowWidgetController_TypeDefinitionIndex = 64695;

	class UIKeyBindingConflictRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_100* _view; // 0x2A0
