...
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_GETLOGICBUTTONNEWKEYCODE_OFFSET UNITYSDK_OFFSET(0xC880FE0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC880930)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC8807B0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC880850)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8805C0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC880660)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC881390)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC881440)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0xC881470)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER__ONUIOPEN_B__2_1_OFFSET UNITYSDK_OFFSET(0xC881480)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC881490)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC881500)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC881580)
#define MOLEMOLE_UIKEYBINDINGCONFLICTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC8815E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIKeyBindingConflictRowWidgetController_TypeDefinitionIndex = 62111;

	class UIKeyBindingConflictRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		// static const ::System::String* HIGHLIGHT_TEXT_COLOR; // 0x0
		::Class_2_79F6D62CE30E3F8E_68* _view; // 0x2A0
		::MoleMole::UIKeyBindingContext* _context; // 0x2A8
		::Class_1_00CE3360E2CE5BB6* _keyPanelItem; // 0x2B0
		::Class_1_00CE3360E2CE5BB6* _keyPanelItem02; // 0x2B8
		::Class_1_00CE3360E2CE5BB6* _comboKeyPanelItem; // 0x2C0
		::Class_1_00CE3360E2CE5BB6* _comboKeyPanelItem02; // 0x2C8
