...
class Class_2_33EB9318F7850887_1;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBEA9570)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBEA96F0)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBEA9610)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBEA93D0)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBEA9770)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBEA9780)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBEA97F0)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBEA9870)
#define MOLEMOLE_UISEARCHOBJECTTASKWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBEA98F0)

namespace MoleMole
{
	inline static constexpr unsigned int UISearchObjectTaskWidgetController_TypeDefinitionIndex = 73449;

	class UISearchObjectTaskWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_33EB9318F7850887_1* _view; // 0x2D0
