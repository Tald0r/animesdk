...
#define MOLEMOLE_UIROLESKILLATTRIBUTEROWCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBEA8070)
#define MOLEMOLE_UIROLESKILLATTRIBUTEROWCHILDWINDOWCONTROLLER_SHOWATTRIBUTEVIEW_OFFSET UNITYSDK_OFFSET(0xBEA8110)
#define MOLEMOLE_UIROLESKILLATTRIBUTEROWCHILDWINDOWCONTROLLER_SHOWBUDDYATTRIBUTEVIEW_OFFSET UNITYSDK_OFFSET(0xBEA8400)
#define MOLEMOLE_UIROLESKILLATTRIBUTEROWCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBEA87B0)
#define MOLEMOLE_UIROLESKILLATTRIBUTEROWCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBEA8860)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSkillAttributeRowChildWindowController_TypeDefinitionIndex = 43287;
