...
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_BACKTOLIST_OFFSET UNITYSDK_OFFSET(0xC08D8A0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_CLEARHEADSTATE_OFFSET UNITYSDK_OFFSET(0xC08F7A0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_CLOSEMENUPOP_OFFSET UNITYSDK_OFFSET(0xC087BC0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ENTERPLAYGAMEPHASE_OFFSET UNITYSDK_OFFSET(0xC0895F0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_GETPLAYERBYPOS_OFFSET UNITYSDK_OFFSET(0xC08C830)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC087350)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_INITGAMEINFO_OFFSET UNITYSDK_OFFSET(0xC0885D0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC0873D0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ISBLOCKINPUT_OFFSET UNITYSDK_OFFSET(0xC08D7C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONACHIEVEMENTBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xC08DBC0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONASKCHANGEPOSRESULT_OFFSET UNITYSDK_OFFSET(0xC08E9B0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONBATTLEABORT_OFFSET UNITYSDK_OFFSET(0xC0901A0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONBATTLEREADY_OFFSET UNITYSDK_OFFSET(0xC08F930)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONBEASKCHANGEPOS_OFFSET UNITYSDK_OFFSET(0xC08ECA0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCLICKINVITEHANDLER_OFFSET UNITYSDK_OFFSET(0xC08D1B0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCLICKKICKOFFHANDLER_OFFSET UNITYSDK_OFFSET(0xC08CDE0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCLICKSWITCHHANDLER_OFFSET UNITYSDK_OFFSET(0xC08D340)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xC08D650)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC088010)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONINFOBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC0882E0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC088240)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONMAINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xC08DD50)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONPLAYERHEADROWBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xC08BF20)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONRANKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xC08DA30)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONREADYBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xC08DF10)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONROOMINFOSYNC_OFFSET UNITYSDK_OFFSET(0xC08F020)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC087A30)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0880B0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC087360)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0878E0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYALLFADEINANIM_OFFSET UNITYSDK_OFFSET(0xC089740)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYALLFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0xC08B860)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYMATCHINGANIM_OFFSET UNITYSDK_OFFSET(0xC08E390)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYMATCHINGSOUND_OFFSET UNITYSDK_OFFSET(0xC08E4E0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYROOTANIM_OFFSET UNITYSDK_OFFSET(0xC08A040)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYSPECIALFADEINPOSTANIM_OFFSET UNITYSDK_OFFSET(0xC08B600)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYSPECIALFADEINPREANIM_OFFSET UNITYSDK_OFFSET(0xC08B470)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYSPECIALFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0xC08B900)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_REFRESHCONSUME_OFFSET UNITYSDK_OFFSET(0xC08BA30)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_REFRESHHEAD_OFFSET UNITYSDK_OFFSET(0xC08A200)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_REFRESHMATCHBTN_OFFSET UNITYSDK_OFFSET(0xC08CA00)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC088A20)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SAMPLEALLFADEINANIM_OFFSET UNITYSDK_OFFSET(0xC08B220)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETBOTTOMAREAACTIVE_OFFSET UNITYSDK_OFFSET(0xC08B9A0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETHEADINFOLOCK_OFFSET UNITYSDK_OFFSET(0xC08F5B0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETREADYSTATEWITHMATCHINGANIM_OFFSET UNITYSDK_OFFSET(0xC087F70)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETREADYSTATE_OFFSET UNITYSDK_OFFSET(0xC08BB00)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETREFCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC0884F0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SHOWERRORMESSAGEWITHTIMEOUT_OFFSET UNITYSDK_OFFSET(0xC090630)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SHOWERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0xC090470)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SHOWFRIENDINVITEPOPWINDOW_OFFSET UNITYSDK_OFFSET(0xC08D220)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__BACKTOLIST_B__45_0_OFFSET UNITYSDK_OFFSET(0xC091260)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC090930)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC090810)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ENTERPLAYGAMEPHASE_B__37_0_OFFSET UNITYSDK_OFFSET(0xC090F30)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__INITVIEW_B__21_0_OFFSET UNITYSDK_OFFSET(0xC090A80)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ONASKCHANGEPOSRESULT_B__46_0_OFFSET UNITYSDK_OFFSET(0xC091290)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ONBATTLEREADY_G__COMATCHREADY_49_0_OFFSET UNITYSDK_OFFSET(0xC090150)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ONREADYBTNCLICKED_B__36_0_OFFSET UNITYSDK_OFFSET(0xC090D10)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ONREADYBTNCLICKED_B__36_1_OFFSET UNITYSDK_OFFSET(0xC090E60)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYMATCHINGANIM_G__COSTARTMATCHING_41_2_OFFSET UNITYSDK_OFFSET(0xC091210)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYMATCHINGANIM_G__PLAYMATCHINGANIMINTERNAL_41_0_OFFSET UNITYSDK_OFFSET(0xC08E730)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYMATCHINGANIM_G__STOPMATCHINGANIMINTERNAL_41_1_OFFSET UNITYSDK_OFFSET(0xC08E800)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYSPECIALFADEINPOSTANIM_B__17_0_OFFSET UNITYSDK_OFFSET(0xC090970)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYSPECIALFADEINPOSTANIM_G__COPLAYANIMSEQUENCE_17_1_OFFSET UNITYSDK_OFFSET(0xC090A30)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0912A0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC091310)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC091340)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC091350)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC091360)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC091370)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeTeamChildWindowController_TypeDefinitionIndex = 50882;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIArcadeTeamChildWindowController_TypeDefinitionIndex)->GetStaticField(0xFD20);
		}
		...
		::Class_3_B1D468EB8CD6587A* GetPlayerByPos(::Class_3_6837F89516FFCB7B* roomInfo, ::System::Int32 pos)
		{
			return ((::Class_3_B1D468EB8CD6587A*(*)(::PVOID, ::Class_3_6837F89516FFCB7B*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_GETPLAYERBYPOS_OFFSET))(this, roomInfo, pos);
		}
