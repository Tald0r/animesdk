...
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_BACKTOLIST_OFFSET UNITYSDK_OFFSET(0xDC4B940)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_CLEARHEADSTATE_OFFSET UNITYSDK_OFFSET(0xDC4D840)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_CLOSEMENUPOP_OFFSET UNITYSDK_OFFSET(0xDC45C40)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ENTERPLAYGAMEPHASE_OFFSET UNITYSDK_OFFSET(0xDC47660)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_GETPLAYERBYPOS_OFFSET UNITYSDK_OFFSET(0xDC4A8C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDC453D0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_INITGAMEINFO_OFFSET UNITYSDK_OFFSET(0xDC46650)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xDC45450)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ISBLOCKINPUT_OFFSET UNITYSDK_OFFSET(0xDC4B860)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONACHIEVEMENTBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xDC4BC60)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONASKCHANGEPOSRESULT_OFFSET UNITYSDK_OFFSET(0xDC4CA50)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONBATTLEABORT_OFFSET UNITYSDK_OFFSET(0xDC4E240)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONBATTLEREADY_OFFSET UNITYSDK_OFFSET(0xDC4D9D0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONBEASKCHANGEPOS_OFFSET UNITYSDK_OFFSET(0xDC4CD40)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCLICKINVITEHANDLER_OFFSET UNITYSDK_OFFSET(0xDC4B250)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCLICKKICKOFFHANDLER_OFFSET UNITYSDK_OFFSET(0xDC4AE80)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCLICKSWITCHHANDLER_OFFSET UNITYSDK_OFFSET(0xDC4B3E0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xDC4B6F0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDC46090)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONINFOBTNCLICK_OFFSET UNITYSDK_OFFSET(0xDC46360)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDC462C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONMAINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xDC4BDF0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONPLAYERHEADROWBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xDC49FB0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONRANKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xDC4BAD0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONREADYBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xDC4BFB0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONROOMINFOSYNC_OFFSET UNITYSDK_OFFSET(0xDC4D0C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xDC45AB0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDC46130)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDC453E0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDC45960)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYALLFADEINANIM_OFFSET UNITYSDK_OFFSET(0xDC477B0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYALLFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0xDC498E0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYMATCHINGANIM_OFFSET UNITYSDK_OFFSET(0xDC4C430)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYMATCHINGSOUND_OFFSET UNITYSDK_OFFSET(0xDC4C580)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYROOTANIM_OFFSET UNITYSDK_OFFSET(0xDC480B0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYSPECIALFADEINPOSTANIM_OFFSET UNITYSDK_OFFSET(0xDC49680)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYSPECIALFADEINPREANIM_OFFSET UNITYSDK_OFFSET(0xDC494F0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_PLAYSPECIALFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0xDC49980)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_REFRESHCONSUME_OFFSET UNITYSDK_OFFSET(0xDC49AB0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_REFRESHHEAD_OFFSET UNITYSDK_OFFSET(0xDC48270)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_REFRESHMATCHBTN_OFFSET UNITYSDK_OFFSET(0xDC4AA90)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xDC46AA0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SAMPLEALLFADEINANIM_OFFSET UNITYSDK_OFFSET(0xDC492A0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETBOTTOMAREAACTIVE_OFFSET UNITYSDK_OFFSET(0xDC49A20)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETHEADINFOLOCK_OFFSET UNITYSDK_OFFSET(0xDC4D650)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETREADYSTATEWITHMATCHINGANIM_OFFSET UNITYSDK_OFFSET(0xDC45FF0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETREADYSTATE_OFFSET UNITYSDK_OFFSET(0xDC49B80)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SETREFCONTROLLER_OFFSET UNITYSDK_OFFSET(0xDC46570)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SHOWERRORMESSAGEWITHTIMEOUT_OFFSET UNITYSDK_OFFSET(0xDC4E6D0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SHOWERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0xDC4E510)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_SHOWFRIENDINVITEPOPWINDOW_OFFSET UNITYSDK_OFFSET(0xDC4B2C0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__BACKTOLIST_B__45_0_OFFSET UNITYSDK_OFFSET(0xDC4F300)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xDC4E9D0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC4E8B0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ENTERPLAYGAMEPHASE_B__37_0_OFFSET UNITYSDK_OFFSET(0xDC4EFD0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__INITVIEW_B__21_0_OFFSET UNITYSDK_OFFSET(0xDC4EB20)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ONASKCHANGEPOSRESULT_B__46_0_OFFSET UNITYSDK_OFFSET(0xDC4F330)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ONBATTLEREADY_G__COMATCHREADY_49_0_OFFSET UNITYSDK_OFFSET(0xDC4E1F0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ONREADYBTNCLICKED_B__36_0_OFFSET UNITYSDK_OFFSET(0xDC4EDB0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__ONREADYBTNCLICKED_B__36_1_OFFSET UNITYSDK_OFFSET(0xDC4EF00)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYMATCHINGANIM_G__COSTARTMATCHING_41_2_OFFSET UNITYSDK_OFFSET(0xDC4F2B0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYMATCHINGANIM_G__PLAYMATCHINGANIMINTERNAL_41_0_OFFSET UNITYSDK_OFFSET(0xDC4C7D0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYMATCHINGANIM_G__STOPMATCHINGANIMINTERNAL_41_1_OFFSET UNITYSDK_OFFSET(0xDC4C8A0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYSPECIALFADEINPOSTANIM_B__17_0_OFFSET UNITYSDK_OFFSET(0xDC4EA10)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER__PLAYSPECIALFADEINPOSTANIM_G__COPLAYANIMSEQUENCE_17_1_OFFSET UNITYSDK_OFFSET(0xDC4EAD0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDC4F340)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDC4F3B0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xDC4F3E0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDC4F3F0)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDC4F400)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDC4F410)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeTeamChildWindowController_TypeDefinitionIndex = 50926;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIArcadeTeamChildWindowController_TypeDefinitionIndex)->GetStaticField(0xF960);
		}
		...
		::Class_2_79AE422BA06F6D26_149* _view; // 0x2F8
		::System::Boolean _matchingSoundPlaying; // 0x300
		::MoleMole::UIArcadeMenuSelectRowWidgetController* _titleMenuWidget; // 0x308
		...
		::MoleMole::UIArcadeTeamChildWindowController_ReadyState _readyState; // 0x324
		::System::Collections::Generic::List_1<::MoleMole::UIGeneralHeadRowWidgetController*>* _playerHeadRowWidgetList; // 0x328
		::System::Collections::Generic::List_1<::MoleMole::UIGeneralHeadRowWidgetController*>* _playerHeadRowWidgetCacheList; // 0x330
		::UnityEngine::Coroutine* _coroutineMatchingAnim; // 0x338
		::System::Boolean _isPlayingReadyAnim; // 0x340
		::System::Boolean _isPlayingFadeOut; // 0x341
		::System::Single _arrowAnimTime; // 0x344
		::System::Boolean _isMatchingLockBattleInfoUpdate; // 0x348
		::System::Collections::Generic::List_1<::System::Int32>* _matchIndexList; // 0x350
		::MoleMole::UIGeneralDynamicTipsPopWindowController* _menuPopWindow; // 0x358
		::MoleMole::UIGeneralTipsPopWindowController* _tipPop; // 0x360
		::MoleMole::UIArcadeFriendInvitePopWindowController* _inviteFriendPop; // 0x368
		::System::Int32 _changingPosTargetPos; // 0x370
		...
		::System::Void ClearHeadState(::Class_3_B46FF0A74020A4F6* roomInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_B46FF0A74020A4F6*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_CLEARHEADSTATE_OFFSET))(this, roomInfo);
		}

		::System::Void RefreshHead(::Class_3_B46FF0A74020A4F6* roomInfo, ::System::Boolean force)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_B46FF0A74020A4F6*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_REFRESHHEAD_OFFSET))(this, roomInfo, force);
		}

		::Class_3_0F3D5EC707ADF550* GetPlayerByPos(::Class_3_B46FF0A74020A4F6* roomInfo, ::System::Int32 pos)
		{
			return ((::Class_3_0F3D5EC707ADF550*(*)(::PVOID, ::Class_3_B46FF0A74020A4F6*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER_GETPLAYERBYPOS_OFFSET))(this, roomInfo, pos);
		}
