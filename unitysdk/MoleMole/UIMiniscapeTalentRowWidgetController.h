...
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER_GETTALENTTEMPLATEBYINDEX_OFFSET UNITYSDK_OFFSET(0xC8C7D20)
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC8C7480)
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC8C7600)
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC8C7520)
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8C7330)
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC8C73D0)
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER_SHOWTALENTLINE_OFFSET UNITYSDK_OFFSET(0xC8C7A90)
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER_TRIGGERONETALENTCLICK_OFFSET UNITYSDK_OFFSET(0xC8C7DE0)
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC8C7EA0)
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC8C7F30)
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC8C7FA0)
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC8C8020)
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8C80A0)
#define MOLEMOLE_UIMINISCAPETALENTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC8C8100)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeTalentRowWidgetController_TypeDefinitionIndex = 58092;

	class UIMiniscapeTalentRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_113* _view; // 0x2D0
