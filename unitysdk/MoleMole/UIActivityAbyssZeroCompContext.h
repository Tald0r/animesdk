...
#define MOLEMOLE_UIACTIVITYABYSSZEROCOMPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC355680)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityAbyssZeroCompContext_TypeDefinitionIndex = 38188;
