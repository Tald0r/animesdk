...
#define MOLEMOLE_UICHATPLUSPAGECONTROLLER___C__DISPLAYCLASS52_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBF4B7F0)
#define MOLEMOLE_UICHATPLUSPAGECONTROLLER___C__DISPLAYCLASS52_0__PLAYMASKFADEIN_B__0_OFFSET UNITYSDK_OFFSET(0xBF4B800)

namespace MoleMole
{
	inline static constexpr unsigned int UIChatPlusPageController___c__DisplayClass52_0_TypeDefinitionIndex = 46034;
