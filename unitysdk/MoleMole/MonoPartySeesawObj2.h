...
#define MOLEMOLE_MONOPARTYSEESAWOBJ2_AWAKE_OFFSET UNITYSDK_OFFSET(0x82FF4A0)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2_METHOD_8_852D8F76817124D8_OFFSET UNITYSDK_OFFSET(0x82FF700)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2_METHOD_8_9C260A5B78AFA0A5_OFFSET UNITYSDK_OFFSET(0x82FEA00)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x82FE820)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2__CCTOR_OFFSET UNITYSDK_OFFSET(0x82FF640)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2__CTOR_OFFSET UNITYSDK_OFFSET(0x82FF5E0)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2___BASE_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x82FF690)

namespace MoleMole
{
	inline static constexpr unsigned int MonoPartySeesawObj2_TypeDefinitionIndex = 37723;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(MonoPartySeesawObj2_TypeDefinitionIndex)->GetStaticField(0x3C1D0);
		}
