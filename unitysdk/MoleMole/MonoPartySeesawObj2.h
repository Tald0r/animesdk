...
#define MOLEMOLE_MONOPARTYSEESAWOBJ2_AWAKE_OFFSET UNITYSDK_OFFSET(0xA3B99D0)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2_METHOD_8_852D8F76817124D8_OFFSET UNITYSDK_OFFSET(0xA3B9C30)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2_METHOD_8_9C260A5B78AFA0A5_OFFSET UNITYSDK_OFFSET(0xA3B8F30)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0xA3B8D50)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2__CCTOR_OFFSET UNITYSDK_OFFSET(0xA3B9B70)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2__CTOR_OFFSET UNITYSDK_OFFSET(0xA3B9B10)
#define MOLEMOLE_MONOPARTYSEESAWOBJ2___BASE_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0xA3B9BC0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoPartySeesawObj2_TypeDefinitionIndex = 43384;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(MonoPartySeesawObj2_TypeDefinitionIndex)->GetStaticField(0x3EEF0);
		}
