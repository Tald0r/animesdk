...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS88_5__CTOR_OFFSET UNITYSDK_OFFSET(0xB23FBE0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS88_5__GOTOSUBITEM_B__5_OFFSET UNITYSDK_OFFSET(0xB23FD60)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController___c__DisplayClass88_5_TypeDefinitionIndex = 71435;
