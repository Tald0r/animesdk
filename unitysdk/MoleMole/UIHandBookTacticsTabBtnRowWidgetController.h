...
#define MOLEMOLE_UIHANDBOOKTACTICSTABBTNROWWIDGETCONTROLLER_GETTABBUTTON_OFFSET UNITYSDK_OFFSET(0x8C367B0)
#define MOLEMOLE_UIHANDBOOKTACTICSTABBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C365B0)
#define MOLEMOLE_UIHANDBOOKTACTICSTABBTNROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8C36730)
#define MOLEMOLE_UIHANDBOOKTACTICSTABBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C36650)
#define MOLEMOLE_UIHANDBOOKTACTICSTABBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C36510)
#define MOLEMOLE_UIHANDBOOKTACTICSTABBTNROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8C36820)
#define MOLEMOLE_UIHANDBOOKTACTICSTABBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C36ED0)
#define MOLEMOLE_UIHANDBOOKTACTICSTABBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C36EE0)
#define MOLEMOLE_UIHANDBOOKTACTICSTABBTNROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8C36F50)
#define MOLEMOLE_UIHANDBOOKTACTICSTABBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C36FD0)
#define MOLEMOLE_UIHANDBOOKTACTICSTABBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C37050)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookTacticsTabBtnRowWidgetController_TypeDefinitionIndex = 49962;

	class UIHandBookTacticsTabBtnRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_6BB4B294B3105A78* _view; // 0x2D0
