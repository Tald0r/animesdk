...
#define MOLEMOLE_UIGENERALDROPDOWNCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD12D3C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralDropDownControllerContext_TypeDefinitionIndex = 66314;
	...
	public:
		...
		::System::Boolean autoDirection; // 0x44
		::System::Boolean useLocalYHeight; // 0x45
		::System::Boolean inverseDropDirection; // 0x46
		::System::Boolean IgnoreGamepadLeftStickButtonClose; // 0x47
		::UnityEngine::Vector2 positionOffset; // 0x48
		::System::Int32 maxHeight; // 0x50
		::UnityEngine::Vector2 cellSize; // 0x54
		::System::Boolean AutoClose; // 0x5C
		::System::Boolean isUp; // 0x5D
		::System::Boolean IsAutoCloseWhenLayoutPlatformChanged; // 0x5E
