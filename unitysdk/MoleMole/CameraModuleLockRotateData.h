...
#define MOLEMOLE_CAMERAMODULELOCKROTATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6D33BC0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraModuleLockRotateData_TypeDefinitionIndex = 74780;
