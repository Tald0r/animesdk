...
#define MOLEMOLE_CAMERAMODULELOCKROTATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBAD57A0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraModuleLockRotateData_TypeDefinitionIndex = 54556;
