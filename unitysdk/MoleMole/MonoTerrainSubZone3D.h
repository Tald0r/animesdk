...
#define MOLEMOLE_MONOTERRAINSUBZONE3D_CONTAINS_OFFSET UNITYSDK_OFFSET(0xB929760)
#define MOLEMOLE_MONOTERRAINSUBZONE3D_METHOD_6_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xB929810)
#define MOLEMOLE_MONOTERRAINSUBZONE3D__CTOR_OFFSET UNITYSDK_OFFSET(0xB929990)
#define MOLEMOLE_MONOTERRAINSUBZONE3D___BASE_CONTAINS_OFFSET UNITYSDK_OFFSET(0xB9299C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTerrainSubZone3D_TypeDefinitionIndex = 78841;
