...
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ADD__ONAFTERIMGRECTCHANGE_OFFSET UNITYSDK_OFFSET(0x9A36430)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_GETCOLOR_OFFSET UNITYSDK_OFFSET(0x9A375A0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_GET_ANCHOREDPOSITIONFOREXPANDANIM_OFFSET UNITYSDK_OFFSET(0x9A38200)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_GET_ANCHOREDPOSITIONFORSCROLLITEM_OFFSET UNITYSDK_OFFSET(0x9A381F0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_GET_WIDTHFOREXPANDANIM_OFFSET UNITYSDK_OFFSET(0x9A381E0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_GET_WIDTHFORSCROLLITEM_OFFSET UNITYSDK_OFFSET(0x9A381D0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONAFTEREXPANDCONTROLLERWIDTHCHANGE_OFFSET UNITYSDK_OFFSET(0x9A36B60)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONAFTERIMGRECTCHANGE_OFFSET UNITYSDK_OFFSET(0x9A38080)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A364A0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9A36650)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONSCROLLVIEWITEMMOVE_OFFSET UNITYSDK_OFFSET(0x9A369F0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A36540)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9A362E0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_PLAYEXPANDANIM_OFFSET UNITYSDK_OFFSET(0x9A37650)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_PLAYSHRINKANIM_OFFSET UNITYSDK_OFFSET(0x9A379D0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_REFRESHSIZE_OFFSET UNITYSDK_OFFSET(0x9A37050)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_REMOVE__ONAFTERIMGRECTCHANGE_OFFSET UNITYSDK_OFFSET(0x9A37C10)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_RESETANIM_OFFSET UNITYSDK_OFFSET(0x9A37C80)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_SET_ANCHOREDPOSITIONFOREXPANDANIM_OFFSET UNITYSDK_OFFSET(0x9A36AD0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_SET_ANCHOREDPOSITIONFORSCROLLITEM_OFFSET UNITYSDK_OFFSET(0x9A37F50)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_SET_WIDTHFOREXPANDANIM_OFFSET UNITYSDK_OFFSET(0x9A37930)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_SET_WIDTHFORSCROLLITEM_OFFSET UNITYSDK_OFFSET(0x9A37FE0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A38210)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER__ONSCROLLITEMUPDATE_G__GETBGCOLORNAME_4_0_OFFSET UNITYSDK_OFFSET(0x9A36970)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER__PLAYEXPANDANIM_B__7_0_OFFSET UNITYSDK_OFFSET(0x9A38220)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER__PLAYEXPANDANIM_B__7_1_OFFSET UNITYSDK_OFFSET(0x9A38230)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A382D0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9A38340)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER___BASE_ONSCROLLVIEWITEMMOVE_OFFSET UNITYSDK_OFFSET(0x9A383C0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A38420)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9A384A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchAppBgWidgetController_TypeDefinitionIndex = 52332;

	class UIWorkBenchAppBgWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_52BF5A8E97668B1D_8* _view; // 0x2D0
