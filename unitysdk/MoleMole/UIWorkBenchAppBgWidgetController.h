...
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ADD__ONAFTERIMGRECTCHANGE_OFFSET UNITYSDK_OFFSET(0x8893A90)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_GETCOLOR_OFFSET UNITYSDK_OFFSET(0x8894C00)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_GET_ANCHOREDPOSITIONFOREXPANDANIM_OFFSET UNITYSDK_OFFSET(0x8895860)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_GET_ANCHOREDPOSITIONFORSCROLLITEM_OFFSET UNITYSDK_OFFSET(0x8895850)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_GET_WIDTHFOREXPANDANIM_OFFSET UNITYSDK_OFFSET(0x8895840)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_GET_WIDTHFORSCROLLITEM_OFFSET UNITYSDK_OFFSET(0x8895830)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONAFTEREXPANDCONTROLLERWIDTHCHANGE_OFFSET UNITYSDK_OFFSET(0x88941C0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONAFTERIMGRECTCHANGE_OFFSET UNITYSDK_OFFSET(0x88956E0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8893B00)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8893CB0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONSCROLLVIEWITEMMOVE_OFFSET UNITYSDK_OFFSET(0x8894050)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8893BA0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8893940)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_PLAYEXPANDANIM_OFFSET UNITYSDK_OFFSET(0x8894CB0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_PLAYSHRINKANIM_OFFSET UNITYSDK_OFFSET(0x8895030)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_REFRESHSIZE_OFFSET UNITYSDK_OFFSET(0x88946B0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_REMOVE__ONAFTERIMGRECTCHANGE_OFFSET UNITYSDK_OFFSET(0x8895270)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_RESETANIM_OFFSET UNITYSDK_OFFSET(0x88952E0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_SET_ANCHOREDPOSITIONFOREXPANDANIM_OFFSET UNITYSDK_OFFSET(0x8894130)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_SET_ANCHOREDPOSITIONFORSCROLLITEM_OFFSET UNITYSDK_OFFSET(0x88955B0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_SET_WIDTHFOREXPANDANIM_OFFSET UNITYSDK_OFFSET(0x8894F90)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER_SET_WIDTHFORSCROLLITEM_OFFSET UNITYSDK_OFFSET(0x8895640)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8895870)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER__ONSCROLLITEMUPDATE_G__GETBGCOLORNAME_4_0_OFFSET UNITYSDK_OFFSET(0x8893FD0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER__PLAYEXPANDANIM_B__7_0_OFFSET UNITYSDK_OFFSET(0x8895880)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER__PLAYEXPANDANIM_B__7_1_OFFSET UNITYSDK_OFFSET(0x8895890)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8895930)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x88959A0)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER___BASE_ONSCROLLVIEWITEMMOVE_OFFSET UNITYSDK_OFFSET(0x8895A20)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8895A80)
#define MOLEMOLE_UIWORKBENCHAPPBGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8895B00)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchAppBgWidgetController_TypeDefinitionIndex = 61581;

	class UIWorkBenchAppBgWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_52BF5A8E97668B1D_10* _view; // 0x2D0
		::System::Single _widthForScrollItem; // 0x2D8
		::System::Single _widthForExpandAnim; // 0x2DC
		::UnityEngine::Vector2 _anchoredPositionForScrollItem; // 0x2E0
		::UnityEngine::Vector2 _anchoredPositionForExpandAnim; // 0x2E8
		::System::Action* _onAfterImgRectChange; // 0x2F0
		::MoleMole::UIWorkBenchAppBgWidgetController* _expandController; // 0x2F8
		::DG::Tweening::Tweener* _tweener; // 0x300
