...
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GENERATESORTERLIST_OFFSET UNITYSDK_OFFSET(0x8090260)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GETFILTERBTN_OFFSET UNITYSDK_OFFSET(0x8090300)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x8090370)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GET_POPWINDOW_OFFSET UNITYSDK_OFFSET(0x8090140)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GET_SELECTEDSORTOPTIONSTATE_OFFSET UNITYSDK_OFFSET(0x8090120)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GET_SELECTEDSORTOPTIONSUBTYPE_OFFSET UNITYSDK_OFFSET(0x8090100)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GET_SELECTEDSORTOPTION_OFFSET UNITYSDK_OFFSET(0x80900E0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_ISFILTERACTIVE_OFFSET UNITYSDK_OFFSET(0x80910F0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x80915F0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_ONFILTERBTNCLICK_OFFSET UNITYSDK_OFFSET(0x8091770)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8091690)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8091220)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8091480)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_REFRESHSORTOPTIONS_OFFSET UNITYSDK_OFFSET(0x80901C0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8090930)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_RESETALL_OFFSET UNITYSDK_OFFSET(0x8090EB0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_SETCHILDSIZE_OFFSET UNITYSDK_OFFSET(0x8090380)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_SETCONSOLEKEY_OFFSET UNITYSDK_OFFSET(0x80904B0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_SETFILTERINSTANCE_OFFSET UNITYSDK_OFFSET(0x8090150)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_SETFILTERSTATE_OFFSET UNITYSDK_OFFSET(0x8091A30)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8091CF0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER__ONUIINIT_B__29_0_OFFSET UNITYSDK_OFFSET(0x8091DD0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8091E00)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8091E70)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8091EF0)
#define MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8091F50)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSortWidgetController_TypeDefinitionIndex = 68769;

	class UIGeneralSortWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_DE782794730406DC_5* _view; // 0x2A0
		...
		::Class_0_16E4307DCC419505_407* _filterInstance; // 0x2C8
		...
		::Class_1_5FF6FCF71CF2DE2C* _data; // 0x2E8
		...
		::Enum_3_2187E7700BED0850 get_SelectedSortOption()
		{
			return ((::Enum_3_2187E7700BED0850(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GET_SELECTEDSORTOPTION_OFFSET))(this);
		}
		...
		::System::Void SetFilterInstance(::Class_0_16E4307DCC419505_407* instance)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_407*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_SETFILTERINSTANCE_OFFSET))(this, instance);
		}
		...
		::System::Collections::Generic::List_1<::Enum_3_2187E7700BED0850>* GenerateSorterList(::System::Collections::Generic::IList_1<::Enum_3_2187E7700BED0850>* confignedSorters, ::Enum_3_2187E7700BED0850& inverseSort, ::System::Collections::Generic::IList_1<::Enum_3_2187E7700BED0850>* highPriorityConfignedSorters)
		{
			return ((::System::Collections::Generic::List_1<::Enum_3_2187E7700BED0850>*(*)(::PVOID, ::System::Collections::Generic::IList_1<::Enum_3_2187E7700BED0850>*, ::Enum_3_2187E7700BED0850&, ::System::Collections::Generic::IList_1<::Enum_3_2187E7700BED0850>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GENERATESORTERLIST_OFFSET))(this, confignedSorters, inverseSort, highPriorityConfignedSorters);
		}
		...
		::Class_0_16E4307DCC419505_407* get_Instance()
		{
			return ((::Class_0_16E4307DCC419505_407*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALSORTWIDGETCONTROLLER_GET_INSTANCE_OFFSET))(this);
		}
