...
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0xDF2A840)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER_GET_QUESTMAP_OFFSET UNITYSDK_OFFSET(0xDF2B210)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDF2A350)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER_ONCLICKRESTART_OFFSET UNITYSDK_OFFSET(0xDF2B2D0)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER_ONCLICKRETURNSELECTLEVEL_OFFSET UNITYSDK_OFFSET(0xDF2B420)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF2A360)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF2B4D0)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF2A400)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF2A900)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xDF2B620)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF2B560)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER__ONCLICKRETURNSELECTLEVEL_B__23_0_OFFSET UNITYSDK_OFFSET(0xDF2B660)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF2B7B0)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF2B820)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF2B830)
#define MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF2B840)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooResultPageController_TypeDefinitionIndex = 47124;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIRidusGotBooResultPageController_TypeDefinitionIndex)->GetStaticField(0xE780);
		}
		...
		{
			return ((::Class_1_B2FA515E693E9E34*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIRIDUSGOTBOORESULTPAGECONTROLLER_GET_QUESTMAP_OFFSET))(this);
		}
