...
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE_AWAKE_OFFSET UNITYSDK_OFFSET(0xDDC45F0)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE_GET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0xDDC4590)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xDDC4760)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xDDC4700)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE_SET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0xDDC45C0)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xDDC47C0)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0xDDC4820)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xDDC4830)
#define MOLEMOLE_UIBLURBACKGROUNDIMAGE___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xDDC4910)

namespace MoleMole
{
	inline static constexpr unsigned int UIBlurBackgroundImage_TypeDefinitionIndex = 77516;
