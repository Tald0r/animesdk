...
#define MOLEMOLE_BATTLE_MONOSTEERSEPARATE_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0xC30BFD0)
#define MOLEMOLE_BATTLE_MONOSTEERSEPARATE_ONSTEERCREATE_OFFSET UNITYSDK_OFFSET(0xC30BEC0)
#define MOLEMOLE_BATTLE_MONOSTEERSEPARATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC30C110)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MonoSteerSeparate_TypeDefinitionIndex = 73396;
