...
#define MOLEMOLE_BATTLE_MONOSTEERSEPARATE_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x9B944F0)
#define MOLEMOLE_BATTLE_MONOSTEERSEPARATE_ONSTEERCREATE_OFFSET UNITYSDK_OFFSET(0x9B94400)
#define MOLEMOLE_BATTLE_MONOSTEERSEPARATE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B94630)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MonoSteerSeparate_TypeDefinitionIndex = 73037;
