...
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL_ADDBOOLEAN_OFFSET UNITYSDK_OFFSET(0x94DD640)
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL_ADDINTEGER_OFFSET UNITYSDK_OFFSET(0x94DD5B0)
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL_ADDTRIGGER_OFFSET UNITYSDK_OFFSET(0x94DD520)
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL_PROCESSANIMATORPARAMCONTROL_OFFSET UNITYSDK_OFFSET(0x94DD6D0)
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x94DD4D0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int AnimatorButtonControl_TypeDefinitionIndex = 57880;
