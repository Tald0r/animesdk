...
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL_ADDBOOLEAN_OFFSET UNITYSDK_OFFSET(0x8485540)
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL_ADDINTEGER_OFFSET UNITYSDK_OFFSET(0x84854B0)
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL_ADDTRIGGER_OFFSET UNITYSDK_OFFSET(0x8485420)
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL_PROCESSANIMATORPARAMCONTROL_OFFSET UNITYSDK_OFFSET(0x84855D0)
#define MOLEMOLE_BATTLE_ANIMATORBUTTONCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x84853D0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int AnimatorButtonControl_TypeDefinitionIndex = 53970;

	class AnimatorButtonControl : public ::System::Object
	{
	public:
		::MoleMole::Battle::AnimatorParamControl* animatorParamControl; // 0x10
		::System::String* activeSkillName; // 0x18
