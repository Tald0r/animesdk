...
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_BULLETTRIGGERDESTRUCTIBLEHIT_OFFSET UNITYSDK_OFFSET(0x78E4A90)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_CHECKENTITYINRUSH_OFFSET UNITYSDK_OFFSET(0x78E5B10)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_CHECKRESVALID_OFFSET UNITYSDK_OFFSET(0x78E3E40)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x78E6160)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_GETRUNTIMEDATA_OFFSET UNITYSDK_OFFSET(0x78E5CC0)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_HITDESTRUCTIBLE_OFFSET UNITYSDK_OFFSET(0x78E3A00)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_06877FEFA5F65462_OFFSET UNITYSDK_OFFSET(0x78E4280)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_0D311F29BE4A7A28_OFFSET UNITYSDK_OFFSET(0x78E63C0)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_0F7D6A50D70ADC31_OFFSET UNITYSDK_OFFSET(0xF2A30F0)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_112F0AC12B1FD790_OFFSET UNITYSDK_OFFSET(0xF2A2050)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xF2A23F0)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_464B80C09A37526F_OFFSET UNITYSDK_OFFSET(0xF2A0860)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_4D2A473556700CDC_OFFSET UNITYSDK_OFFSET(0x78E70C0)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_8E235C789FEC971B_OFFSET UNITYSDK_OFFSET(0xF2A2460)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_9B44B7D17918410A_OFFSET UNITYSDK_OFFSET(0xF2A1020)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xF2A0E20)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0x78E7790)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_AF0FC2A3AC3D7460_OFFSET UNITYSDK_OFFSET(0xF2A3340)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_B2AF81294D9C69C7_1_OFFSET UNITYSDK_OFFSET(0xF2A1E10)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_B2AF81294D9C69C7_OFFSET UNITYSDK_OFFSET(0x78E6630)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_B7240A3598D00B4E_OFFSET UNITYSDK_OFFSET(0xF2A0250)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_BFB5E31B9FB68E3D_OFFSET UNITYSDK_OFFSET(0x78E4810)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_D1289BD4E2C7FF87_OFFSET UNITYSDK_OFFSET(0xF2A0610)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0xF2A35E0)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_D3206EC93EE606A4_OFFSET UNITYSDK_OFFSET(0xF29FF60)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_E5D087CB526C8BC7_OFFSET UNITYSDK_OFFSET(0xF2A4420)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_EA88F2ACA61540E3_OFFSET UNITYSDK_OFFSET(0xF2A2EA0)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_FE72BF2F281C4FA8_OFFSET UNITYSDK_OFFSET(0xF29F9A0)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x78E7050)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_PROCESSDESTROY_OFFSET UNITYSDK_OFFSET(0x78E6DB0)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_PROCESSGROUNDED_OFFSET UNITYSDK_OFFSET(0x78E6B70)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_PROCESSHITBREAK_OFFSET UNITYSDK_OFFSET(0x78E6920)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_START_OFFSET UNITYSDK_OFFSET(0x78E6FE0)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER_TRIGGERCOLLIDERASYNC_OFFSET UNITYSDK_OFFSET(0x78E4F00)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x78E7560)
#define MOLEMOLE_BATTLE_RBDBATTLEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x78E7480)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int RBDBattleManager_TypeDefinitionIndex = 79129;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(RBDBattleManager_TypeDefinitionIndex)->GetStaticField(0x39E40);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::Queue_1<::Class_1_66BE267322CE07F6*>*>**)Il2CppClass::FromTypeDefinitionIndex(RBDBattleManager_TypeDefinitionIndex)->GetStaticField(0x39E48);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Battle::RBDBattleData*>** StaticGet_m_dicRuntimeDatas()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Battle::RBDBattleData*>**)Il2CppClass::FromTypeDefinitionIndex(RBDBattleManager_TypeDefinitionIndex)->GetStaticField(0x39E50);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Battle::RBDEffectInfo*>** StaticGet_m_dicEffectLimits()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Battle::RBDEffectInfo*>**)Il2CppClass::FromTypeDefinitionIndex(RBDBattleManager_TypeDefinitionIndex)->GetStaticField(0x39E58);
		}
		static ::System::Collections::Generic::List_1<::Class_1_CEB3A2AC6A2FFA68*>** StaticGet_m_lstRuntimeAudioInfos()
		{
			return (::System::Collections::Generic::List_1<::Class_1_CEB3A2AC6A2FFA68*>**)Il2CppClass::FromTypeDefinitionIndex(RBDBattleManager_TypeDefinitionIndex)->GetStaticField(0x39E60);
		}
		static ::Unity::Collections::NativeArray_1<::System::Int32>* StaticGet__hitCounts()
		{
			return (::Unity::Collections::NativeArray_1<::System::Int32>*)Il2CppClass::FromTypeDefinitionIndex(RBDBattleManager_TypeDefinitionIndex)->GetStaticField(0xE300);
		}
		...
		{
			return (::Unity::Collections::NativeArray_1<::MoleMole::Battle::RBDBattleManager_Struct_2_FB463563CC2FB07B>*)Il2CppClass::FromTypeDefinitionIndex(RBDBattleManager_TypeDefinitionIndex)->GetStaticField(0xE310);
		}
		...
		{
			return (::Unity::Collections::NativeArray_1<::MoleMole::Battle::RBDBattleManager_Struct_2_0781496C6B531BAB>*)Il2CppClass::FromTypeDefinitionIndex(RBDBattleManager_TypeDefinitionIndex)->GetStaticField(0xE320);
		}
		static ::System::Int32* StaticGet_m_nArrayCurIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(RBDBattleManager_TypeDefinitionIndex)->GetStaticField(0xE330);
		}
		static ::System::Boolean* StaticGet_ENABLE_HIT_DESTRUCTIBLE()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(RBDBattleManager_TypeDefinitionIndex)->GetStaticField(0xE334);
		}
		static ::Unity::Collections::NativeArray_1<::UnityEngine::RaycastHit>* StaticGet__hitResults()
		{
			return (::Unity::Collections::NativeArray_1<::UnityEngine::RaycastHit>*)Il2CppClass::FromTypeDefinitionIndex(RBDBattleManager_TypeDefinitionIndex)->GetStaticField(0xE338);
		}
		...
		static ::System::Single Method_5_06877FEFA5F65462(::System::Int32 a1, ::Enum_3_2A23A633D4312D81 a2, ::System::UInt32 a3)
		{
			return ((::System::Single(*)(::System::Int32, ::Enum_3_2A23A633D4312D81, ::System::UInt32))((::PBYTE)hIl2Cpp + MOLEMOLE_BATTLE_RBDBATTLEMANAGER_METHOD_5_06877FEFA5F65462_OFFSET))(a1, a2, a3);
		}
