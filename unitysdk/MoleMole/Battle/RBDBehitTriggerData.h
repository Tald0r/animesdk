...
#define MOLEMOLE_BATTLE_RBDBEHITTRIGGERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6532B00)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int RBDBehitTriggerData_TypeDefinitionIndex = 36619;
