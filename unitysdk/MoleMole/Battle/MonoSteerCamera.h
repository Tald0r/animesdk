...
#define MOLEMOLE_BATTLE_MONOSTEERCAMERA_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0xCD8E5D0)
#define MOLEMOLE_BATTLE_MONOSTEERCAMERA_ONSTEERCREATE_OFFSET UNITYSDK_OFFSET(0xCD8E4A0)
#define MOLEMOLE_BATTLE_MONOSTEERCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD8E710)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MonoSteerCamera_TypeDefinitionIndex = 68184;
