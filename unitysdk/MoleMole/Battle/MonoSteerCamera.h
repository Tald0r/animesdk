...
#define MOLEMOLE_BATTLE_MONOSTEERCAMERA_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0xB8FA970)
#define MOLEMOLE_BATTLE_MONOSTEERCAMERA_ONSTEERCREATE_OFFSET UNITYSDK_OFFSET(0xB8FA830)
#define MOLEMOLE_BATTLE_MONOSTEERCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xB8FAAB0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MonoSteerCamera_TypeDefinitionIndex = 38763;
