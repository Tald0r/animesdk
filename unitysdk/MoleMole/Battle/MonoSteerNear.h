...
#define MOLEMOLE_BATTLE_MONOSTEERNEAR_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x6FB9B50)
#define MOLEMOLE_BATTLE_MONOSTEERNEAR_ONSTEERCREATE_OFFSET UNITYSDK_OFFSET(0x6FB9A40)
#define MOLEMOLE_BATTLE_MONOSTEERNEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x6FB9C90)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MonoSteerNear_TypeDefinitionIndex = 71663;
