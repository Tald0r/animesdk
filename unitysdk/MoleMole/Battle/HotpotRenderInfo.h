...
#define MOLEMOLE_BATTLE_HOTPOTRENDERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x81CCEF0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int HotpotRenderInfo_TypeDefinitionIndex = 46631;
