...
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_DOCHECKCLOSEEVADE_OFFSET UNITYSDK_OFFSET(0xE2A5300)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_DOCHECKOPENEVADE_OFFSET UNITYSDK_OFFSET(0xE2A5150)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_DOCLOSEINPUT_OFFSET UNITYSDK_OFFSET(0xE2A5400)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_DOHINT_OFFSET UNITYSDK_OFFSET(0xE2A4FB0)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_DOOPENINPUT_OFFSET UNITYSDK_OFFSET(0xE2A5250)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_GETNEEDWAIT_OFFSET UNITYSDK_OFFSET(0xE2A4F30)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO_GETRESULT_OFFSET UNITYSDK_OFFSET(0xE2A4D50)
#define MOLEMOLE_BATTLE_MUSICBATTLESUBSYSTEM_LEVELPRESSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xE2A54B0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MusicBattleSubSystem_LevelPressInfo_TypeDefinitionIndex = 46838;

	class MusicBattleSubSystem_LevelPressInfo : public ::System::Object
	{
	public:
		::MoleMole::Config::MusicBattleMarkerNodeType nodeType; // 0x10
		::System::Double recordClickTime; // 0x18
		::System::Double hintTime; // 0x20
		::System::Double perfectTime; // 0x28
		::System::Double earliestCheckTime; // 0x30
		::MoleMole::LogicButtonInputType inputType; // 0x38
		::System::Boolean needCloseEvadeInput; // 0x3C
		::System::Boolean CheckedOpen; // 0x3D
		::System::Boolean needOpenEvadeInput; // 0x3E
		::System::Boolean CheckedClose; // 0x3F
