...
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE_GETCURRENTCOUNT_OFFSET UNITYSDK_OFFSET(0x81CAC70)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE_GETPROGRESSSTRING_OFFSET UNITYSDK_OFFSET(0x81CAD50)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x81CACD0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE_GET_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0x81CAC00)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x81CAAF0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x81CAA90)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x81CAE50)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int ChallengeSubTypeOccupyInteractive_TypeDefinitionIndex = 45444;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_776*))((::PBYTE)hIl2Cpp + MOLEMOLE_BATTLE_CHALLENGESUBTYPEOCCUPYINTERACTIVE__CTOR_OFFSET))(this, inTemplate);
		}
