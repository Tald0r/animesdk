...
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_CREATEFROMCONFIG_OFFSET UNITYSDK_OFFSET(0x94DE9A0)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_EQUALS_OFFSET UNITYSDK_OFFSET(0x376270)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x376280)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x94DE4D0)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x94DE5E0)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x376290)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x376300)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MaterialPropertyModifierExtraParams_TypeDefinitionIndex = 43836;
