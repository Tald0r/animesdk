...
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_CREATEFROMCONFIG_OFFSET UNITYSDK_OFFSET(0x84867E0)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_EQUALS_OFFSET UNITYSDK_OFFSET(0x34A280)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x34A290)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x8486310)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x8486420)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x34A2A0)
#define MOLEMOLE_BATTLE_MATERIALPROPERTYMODIFIEREXTRAPARAMS___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x34A310)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MaterialPropertyModifierExtraParams_TypeDefinitionIndex = 47658;
