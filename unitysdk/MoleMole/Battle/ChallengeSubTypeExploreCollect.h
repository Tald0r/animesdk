...
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEEXPLORECOLLECT_GETPROGRESSSTRING_OFFSET UNITYSDK_OFFSET(0x6FB8D20)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEEXPLORECOLLECT_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x6FB8CA0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEEXPLORECOLLECT_GET_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0x6FB8C30)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEEXPLORECOLLECT_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x6FB8B20)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEEXPLORECOLLECT__CTOR_OFFSET UNITYSDK_OFFSET(0x6FB8970)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEEXPLORECOLLECT___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x6FB8E20)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int ChallengeSubTypeExploreCollect_TypeDefinitionIndex = 46986;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_236*))((::PBYTE)hIl2Cpp + MOLEMOLE_BATTLE_CHALLENGESUBTYPEEXPLORECOLLECT__CTOR_OFFSET))(this, inTemplate);
		}
