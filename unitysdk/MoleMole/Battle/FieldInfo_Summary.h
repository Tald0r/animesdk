...
#define MOLEMOLE_BATTLE_FIELDINFO_SUMMARY__CTOR_OFFSET UNITYSDK_OFFSET(0x2D0570)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int FieldInfo_Summary_TypeDefinitionIndex = 67573;
