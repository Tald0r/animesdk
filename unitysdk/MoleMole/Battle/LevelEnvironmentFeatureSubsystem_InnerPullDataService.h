...
#define MOLEMOLE_BATTLE_LEVELENVIRONMENTFEATURESUBSYSTEM_INNERPULLDATASERVICE_GET_PULLDATA_OFFSET UNITYSDK_OFFSET(0x65326A0)
#define MOLEMOLE_BATTLE_LEVELENVIRONMENTFEATURESUBSYSTEM_INNERPULLDATASERVICE_SET_PULLDATA_OFFSET UNITYSDK_OFFSET(0x65326B0)
#define MOLEMOLE_BATTLE_LEVELENVIRONMENTFEATURESUBSYSTEM_INNERPULLDATASERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x65326C0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int LevelEnvironmentFeatureSubsystem_InnerPullDataService_TypeDefinitionIndex = 65403;
