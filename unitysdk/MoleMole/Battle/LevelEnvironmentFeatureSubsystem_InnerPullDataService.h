...
#define MOLEMOLE_BATTLE_LEVELENVIRONMENTFEATURESUBSYSTEM_INNERPULLDATASERVICE_GET_PULLDATA_OFFSET UNITYSDK_OFFSET(0x81CCF10)
#define MOLEMOLE_BATTLE_LEVELENVIRONMENTFEATURESUBSYSTEM_INNERPULLDATASERVICE_SET_PULLDATA_OFFSET UNITYSDK_OFFSET(0x81CCF20)
#define MOLEMOLE_BATTLE_LEVELENVIRONMENTFEATURESUBSYSTEM_INNERPULLDATASERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x81CCF30)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int LevelEnvironmentFeatureSubsystem_InnerPullDataService_TypeDefinitionIndex = 76817;
