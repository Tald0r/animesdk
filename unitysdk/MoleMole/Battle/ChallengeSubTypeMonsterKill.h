...
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_GETPROGRESSSTRING_OFFSET UNITYSDK_OFFSET(0x95C5C60)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x95C5BF0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_GET_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0x95C5B80)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x95C6270)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x95C6100)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__CREATECOUNTER_OFFSET UNITYSDK_OFFSET(0x95C6050)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x95C5A30)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__INCREASECOUNTER_OFFSET UNITYSDK_OFFSET(0x95C5D70)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__TRYCALCKILLCOUNT_OFFSET UNITYSDK_OFFSET(0x95C5E20)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x95C70D0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x95C7140)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int ChallengeSubTypeMonsterKill_TypeDefinitionIndex = 54844;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_236*))((::PBYTE)hIl2Cpp + MOLEMOLE_BATTLE_CHALLENGESUBTYPEMONSTERKILL__CTOR_OFFSET))(this, inTemplate);
		}
