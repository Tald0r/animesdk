...
#define MOLEMOLE_BATTLE_ENTITY_GET_ISAUTHORITY_OFFSET UNITYSDK_OFFSET(0x9167110)
#define MOLEMOLE_BATTLE_ENTITY_GET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0x91677E0)
#define MOLEMOLE_BATTLE_ENTITY_GET_ROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9167100)
#define MOLEMOLE_BATTLE_ENTITY_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x9167010)
#define MOLEMOLE_BATTLE_ENTITY_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x9167930)
#define MOLEMOLE_BATTLE_ENTITY_SETAUTHORITY_OFFSET UNITYSDK_OFFSET(0x9167120)
#define MOLEMOLE_BATTLE_ENTITY_SETDISABLEBYALIVESTATUS_OFFSET UNITYSDK_OFFSET(0x9167850)
#define MOLEMOLE_BATTLE_ENTITY_SETDISABLEBYNET_OFFSET UNITYSDK_OFFSET(0x91678C0)
#define MOLEMOLE_BATTLE_ENTITY_SET_ROOT_OFFSET UNITYSDK_OFFSET(0x9167020)
#define MOLEMOLE_BATTLE_ENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x9167B10)
#define MOLEMOLE_BATTLE_ENTITY___BASE_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x9167B60)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int Entity_TypeDefinitionIndex = 63338;
	...
	public:
		...
		::System::Boolean _isDisableByAliveStatus; // 0x50
		::System::Boolean _isDisableByNet; // 0x51
		::System::Boolean _isAuthority; // 0x52
