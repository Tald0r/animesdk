...
#define MOLEMOLE_BATTLE_ENTITY_GET_ISAUTHORITY_OFFSET UNITYSDK_OFFSET(0x6FB8F90)
#define MOLEMOLE_BATTLE_ENTITY_GET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0x6FB9660)
#define MOLEMOLE_BATTLE_ENTITY_GET_ROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x6FB8F80)
#define MOLEMOLE_BATTLE_ENTITY_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x6FB8E90)
#define MOLEMOLE_BATTLE_ENTITY_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x6FB97B0)
#define MOLEMOLE_BATTLE_ENTITY_SETAUTHORITY_OFFSET UNITYSDK_OFFSET(0x6FB8FA0)
#define MOLEMOLE_BATTLE_ENTITY_SETDISABLEBYALIVESTATUS_OFFSET UNITYSDK_OFFSET(0x6FB96D0)
#define MOLEMOLE_BATTLE_ENTITY_SETDISABLEBYNET_OFFSET UNITYSDK_OFFSET(0x6FB9740)
#define MOLEMOLE_BATTLE_ENTITY_SET_ROOT_OFFSET UNITYSDK_OFFSET(0x6FB8EA0)
#define MOLEMOLE_BATTLE_ENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x6FB9990)
#define MOLEMOLE_BATTLE_ENTITY___BASE_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x6FB99E0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int Entity_TypeDefinitionIndex = 59961;
	...
	public:
		...
		::MoleMole::Config::EntityType entityType; // 0x50
		::System::Boolean _isDisableByAliveStatus; // 0x54
		::System::Boolean _isDisableByNet; // 0x55
		::System::Boolean _isAuthority; // 0x56
