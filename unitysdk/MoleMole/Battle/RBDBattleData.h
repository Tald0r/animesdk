...
#define MOLEMOLE_BATTLE_RBDBATTLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9167E50)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int RBDBattleData_TypeDefinitionIndex = 50369;
