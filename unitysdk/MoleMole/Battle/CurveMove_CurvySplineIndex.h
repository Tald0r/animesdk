...
#define MOLEMOLE_BATTLE_CURVEMOVE_CURVYSPLINEINDEX_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x414A30)
#define MOLEMOLE_BATTLE_CURVEMOVE_CURVYSPLINEINDEX_METHOD_2_7458A09AF41B5037_1_OFFSET UNITYSDK_OFFSET(0xCAC4B30)
#define MOLEMOLE_BATTLE_CURVEMOVE_CURVYSPLINEINDEX_METHOD_2_7458A09AF41B5037_OFFSET UNITYSDK_OFFSET(0xCAC4900)
#define MOLEMOLE_BATTLE_CURVEMOVE_CURVYSPLINEINDEX_METHOD_2_A43044913126BD48_1_OFFSET UNITYSDK_OFFSET(0xCAC4A50)
#define MOLEMOLE_BATTLE_CURVEMOVE_CURVYSPLINEINDEX_METHOD_2_A43044913126BD48_2_OFFSET UNITYSDK_OFFSET(0xCAC4AC0)
#define MOLEMOLE_BATTLE_CURVEMOVE_CURVYSPLINEINDEX_METHOD_2_A43044913126BD48_3_OFFSET UNITYSDK_OFFSET(0xCAC4B90)
#define MOLEMOLE_BATTLE_CURVEMOVE_CURVYSPLINEINDEX_METHOD_2_A43044913126BD48_4_OFFSET UNITYSDK_OFFSET(0xCAC4C00)
#define MOLEMOLE_BATTLE_CURVEMOVE_CURVYSPLINEINDEX_METHOD_2_A43044913126BD48_5_OFFSET UNITYSDK_OFFSET(0xCAC4C70)
#define MOLEMOLE_BATTLE_CURVEMOVE_CURVYSPLINEINDEX_METHOD_2_A43044913126BD48_OFFSET UNITYSDK_OFFSET(0xCAC49E0)
#define MOLEMOLE_BATTLE_CURVEMOVE_CURVYSPLINEINDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x414980)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int CurveMove_CurvySplineIndex_TypeDefinitionIndex = 62270;
