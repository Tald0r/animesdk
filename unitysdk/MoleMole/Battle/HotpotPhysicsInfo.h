...
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ASSUREEDGECOLLIDER_OFFSET UNITYSDK_OFFSET(0x81CAF20)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_CHECKBOUNDSVALID_OFFSET UNITYSDK_OFFSET(0x81CAEC0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0x81CC700)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_DRAWCOLLISIONEDGE_OFFSET UNITYSDK_OFFSET(0x81CBE90)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_DRAWGENERATEDPOINTS_OFFSET UNITYSDK_OFFSET(0x81CCA80)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GENERATECOLLISIONAREA_OFFSET UNITYSDK_OFFSET(0x81CB040)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GENERATEPOINTSINRING_1_OFFSET UNITYSDK_OFFSET(0x81CB400)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GENERATEPOINTSINRING_OFFSET UNITYSDK_OFFSET(0x81CB350)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GETCIRCLEPOINT_OFFSET UNITYSDK_OFFSET(0x81CCC60)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GETFOODAABB_OFFSET UNITYSDK_OFFSET(0x81CBCF0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_GETWORLDRADIUS_OFFSET UNITYSDK_OFFSET(0x81CCD60)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ISFOODINCIRCLE_OFFSET UNITYSDK_OFFSET(0x81CB790)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ISFOODOUTOFCIRCLE_OFFSET UNITYSDK_OFFSET(0x81CB9D0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ISINBOUND_OFFSET UNITYSDK_OFFSET(0x81CB700)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ISINCIRCLE_OFFSET UNITYSDK_OFFSET(0x81CBBF0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x81CBDC0)
#define MOLEMOLE_BATTLE_HOTPOTPHYSICSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x81CCEC0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int HotpotPhysicsInfo_TypeDefinitionIndex = 72812;
