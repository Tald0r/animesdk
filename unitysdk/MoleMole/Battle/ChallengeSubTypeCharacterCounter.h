...
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER_GETCURRENTCOUNT_OFFSET UNITYSDK_OFFSET(0xB440AB0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER_GETPROGRESSSTRING_OFFSET UNITYSDK_OFFSET(0xB440B80)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0xB440B10)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER_GET_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0xB440A40)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER_ONANIMATORZONETAGCHANGED_OFFSET UNITYSDK_OFFSET(0xB4409E0)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xB43FD80)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB43FC50)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER__LISTENHITCALLBACK_OFFSET UNITYSDK_OFFSET(0xB440550)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER__ONANIMATORZONECHANGED_OFFSET UNITYSDK_OFFSET(0xB440810)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER__UNLISTENHITCALLBACK_OFFSET UNITYSDK_OFFSET(0xB440670)
#define MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xB440C90)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int ChallengeSubTypeCharacterCounter_TypeDefinitionIndex = 42313;
	...
	public:
		...
		::System::UInt32 _attackerID; // 0x40
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_776*))((::PBYTE)hIl2Cpp + MOLEMOLE_BATTLE_CHALLENGESUBTYPECHARACTERCOUNTER__CTOR_OFFSET))(this, inTemplate);
		}
