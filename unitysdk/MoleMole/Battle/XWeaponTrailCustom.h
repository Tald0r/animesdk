...
#define MOLEMOLE_BATTLE_XWEAPONTRAILCUSTOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5D6360)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int XWeaponTrailCustom_TypeDefinitionIndex = 37128;
