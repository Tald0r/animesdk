...
#define MOLEMOLE_BATTLE_XWEAPONTRAILCUSTOM__CTOR_OFFSET UNITYSDK_OFFSET(0x19FBD440)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int XWeaponTrailCustom_TypeDefinitionIndex = 36108;
