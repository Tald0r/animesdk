...
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_AWAKE_OFFSET UNITYSDK_OFFSET(0x62131B0)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_GET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0x62130F0)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_GET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x62131A0)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_GET_OBSERVETAG_OFFSET UNITYSDK_OFFSET(0x6213120)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_GET_SELFCOLLIDER_OFFSET UNITYSDK_OFFSET(0x6213110)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_METHOD_5_7E88248D094440C0_OFFSET UNITYSDK_OFFSET(0x62133B0)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x62132E0)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x6213A70)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6213280)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x6213B40)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x6213BF0)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_SETCOLLIDERENABLE_OFFSET UNITYSDK_OFFSET(0x6213CA0)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_SET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0x6213100)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_SET_OBSERVETAG_OFFSET UNITYSDK_OFFSET(0x6213130)
#define MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x6213D20)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int ColliderEventDispatcher_TypeDefinitionIndex = 42233;
	...
	public:
		...
		::System::Boolean Method_5_7E88248D094440C0(::UnityEngine::Collider* a1, ::Enum_3_CE3B674D22BBFC73 a2)
		{
			return ((::System::Boolean(*)(::PVOID, ::UnityEngine::Collider*, ::Enum_3_CE3B674D22BBFC73))((::PBYTE)hIl2Cpp + MOLEMOLE_BATTLE_COLLIDEREVENTDISPATCHER_METHOD_5_7E88248D094440C0_OFFSET))(this, a1, a2);
		}
	};
}
