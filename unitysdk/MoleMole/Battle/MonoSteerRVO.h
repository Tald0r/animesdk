...
#define MOLEMOLE_BATTLE_MONOSTEERRVO_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0xB37E580)
#define MOLEMOLE_BATTLE_MONOSTEERRVO_ONSTEERCREATE_OFFSET UNITYSDK_OFFSET(0xB37E4A0)
#define MOLEMOLE_BATTLE_MONOSTEERRVO__CTOR_OFFSET UNITYSDK_OFFSET(0xB37E6C0)

namespace MoleMole::Battle
{
	inline static constexpr unsigned int MonoSteerRVO_TypeDefinitionIndex = 69639;
