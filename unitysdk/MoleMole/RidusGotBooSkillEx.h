...
#define MOLEMOLE_RIDUSGOTBOOSKILLEX_BUILD_OFFSET UNITYSDK_OFFSET(0x7A9D860)
#define MOLEMOLE_RIDUSGOTBOOSKILLEX_GET_INHISTORY_OFFSET UNITYSDK_OFFSET(0x7A9D7B0)
#define MOLEMOLE_RIDUSGOTBOOSKILLEX_GET_INMYSKILL_OFFSET UNITYSDK_OFFSET(0x7A9D7C0)
#define MOLEMOLE_RIDUSGOTBOOSKILLEX_GET_INNPCSKILL_OFFSET UNITYSDK_OFFSET(0x7A9D7D0)
#define MOLEMOLE_RIDUSGOTBOOSKILLEX__CTOR_OFFSET UNITYSDK_OFFSET(0x7A9D7E0)

namespace MoleMole
{
	inline static constexpr unsigned int RidusGotBooSkillEx_TypeDefinitionIndex = 43100;
	...
	public:
		...
		::System::Single AnimSampleTime; // 0x38
		::System::Single QTEDoneTime; // 0x3C
		::System::Boolean IsFeverKey; // 0x40
		::System::Boolean IsNext; // 0x41
		::System::Boolean PlayFadein; // 0x42
		::Enum_3_6689CFCCDBE24211 QTEResult; // 0x44
		::Enum_3_A54EADDA5F8725D8 Type; // 0x48
