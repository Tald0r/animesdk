...
#define MOLEMOLE_UICONTROLLERCONTEXTBASE_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0xC6048B0)
#define MOLEMOLE_UICONTROLLERCONTEXTBASE_GET_FROMCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC6046E0)
#define MOLEMOLE_UICONTROLLERCONTEXTBASE_GET_HIDEFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0xC6046A0)
#define MOLEMOLE_UICONTROLLERCONTEXTBASE_GET__REFFROMCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC6046C0)
#define MOLEMOLE_UICONTROLLERCONTEXTBASE_ISVALIDARGS_OFFSET UNITYSDK_OFFSET(0xC604910)
#define MOLEMOLE_UICONTROLLERCONTEXTBASE_SETFROMCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC6047D0)
#define MOLEMOLE_UICONTROLLERCONTEXTBASE_SETOPERATIONPARAM_OFFSET UNITYSDK_OFFSET(0xC604840)
#define MOLEMOLE_UICONTROLLERCONTEXTBASE_SET_HIDEFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0xC6046B0)
#define MOLEMOLE_UICONTROLLERCONTEXTBASE_SET__REFFROMCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC6046D0)
#define MOLEMOLE_UICONTROLLERCONTEXTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xC5FFFD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIControllerContextBase_TypeDefinitionIndex = 43140;
