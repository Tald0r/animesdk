...
#define MOLEMOLE_UISUIBIANTEMPLEDAILYPAPERROWWIDGETCONTROLLER_GETDAYTEXT_OFFSET UNITYSDK_OFFSET(0x7BCE8A0)
#define MOLEMOLE_UISUIBIANTEMPLEDAILYPAPERROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7BCE340)
#define MOLEMOLE_UISUIBIANTEMPLEDAILYPAPERROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7BCE3E0)
#define MOLEMOLE_UISUIBIANTEMPLEDAILYPAPERROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7BCE1F0)
#define MOLEMOLE_UISUIBIANTEMPLEDAILYPAPERROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7BCE290)
#define MOLEMOLE_UISUIBIANTEMPLEDAILYPAPERROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x7BCE4C0)
#define MOLEMOLE_UISUIBIANTEMPLEDAILYPAPERROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7BCE9A0)
#define MOLEMOLE_UISUIBIANTEMPLEDAILYPAPERROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7BCE9D0)
#define MOLEMOLE_UISUIBIANTEMPLEDAILYPAPERROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7BCEA40)
#define MOLEMOLE_UISUIBIANTEMPLEDAILYPAPERROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7BCEAC0)
#define MOLEMOLE_UISUIBIANTEMPLEDAILYPAPERROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7BCEB20)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleDailyPaperRowWidgetController_TypeDefinitionIndex = 39901;
