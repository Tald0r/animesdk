...
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x96FA770)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x96FAE30)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x96FAA30)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONKEYBINDINGDIALOGCLOSE_OFFSET UNITYSDK_OFFSET(0x96FB000)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONSETTINGONUIDISABLESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x96FB090)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x96FAAD0)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x96FA410)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x96FA540)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_REFRESHSETTINGONUIDISABLESTATE_OFFSET UNITYSDK_OFFSET(0x96FAC40)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x96FABB0)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x96FB170)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0x96FB1B0)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER__ONUIOPEN_B__2_1_OFFSET UNITYSDK_OFFSET(0x96FB240)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER__ONUIOPEN_B__2_2_OFFSET UNITYSDK_OFFSET(0x96FB2D0)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER__ONUIOPEN_B__2_3_OFFSET UNITYSDK_OFFSET(0x96FB370)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x96FB4F0)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x96FB560)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x96FB5E0)
#define MOLEMOLE_UISETTINGKEYBINDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x96FB640)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingKeyBindWidgetController_TypeDefinitionIndex = 55651;
