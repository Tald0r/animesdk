...
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_FILLQUESTIDTOEXTINFO_OFFSET UNITYSDK_OFFSET(0xD78C6F0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_GETBOSSLEVEL_OFFSET UNITYSDK_OFFSET(0xD78D110)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_GETDESCLABELTEXT_OFFSET UNITYSDK_OFFSET(0xD78D900)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0xD78BA10)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xD78ACF0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_GET_NEEDSHOWCAMP_OFFSET UNITYSDK_OFFSET(0xD78BCA0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_GET_NEEDSHOWMONSTERTYPE_OFFSET UNITYSDK_OFFSET(0xD78BCB0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_GET_NEEDSHOWTARGET_OFFSET UNITYSDK_OFFSET(0xD78BA90)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_GET_WAVECOUNT_OFFSET UNITYSDK_OFFSET(0xD78C550)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD78AD00)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_ISMONSTERLOCKED_OFFSET UNITYSDK_OFFSET(0xD78BD30)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_ISMONSTERSHOWDESC_OFFSET UNITYSDK_OFFSET(0xD78BAB0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xD78D5C0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD78B8E0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_ONSCROLLVIEWSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0xD78C870)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD78B980)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD78AD10)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD78AE50)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_OUTPUTDEBUGSTRING_OFFSET UNITYSDK_OFFSET(0xD78BCC0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_REFRESHEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0xD78C560)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_REFRESHROOTSSTATE_OFFSET UNITYSDK_OFFSET(0xD78B690)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_REFRESHWAVECOUNT_OFFSET UNITYSDK_OFFSET(0xD78C3E0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_SETMONSTERDESC_OFFSET UNITYSDK_OFFSET(0xD78C150)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_SETMONSTERLOCKED_OFFSET UNITYSDK_OFFSET(0xD78BF10)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_SETMONSTERPLAYDESCLABEL_OFFSET UNITYSDK_OFFSET(0xD78D170)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_UPDATEBOSSCFGLIST_OFFSET UNITYSDK_OFFSET(0xD78C380)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_UPDATECAMP_OFFSET UNITYSDK_OFFSET(0xD78E060)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_UPDATETARGETPOSITION_OFFSET UNITYSDK_OFFSET(0xD78E1A0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_UPDATETYPE_OFFSET UNITYSDK_OFFSET(0xD78E100)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER__BINDBTNS_OFFSET UNITYSDK_OFFSET(0xD78AF90)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER__CLEARPATCH_OFFSET UNITYSDK_OFFSET(0xD78D990)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD78E980)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER__GETONEWEAK_OFFSET UNITYSDK_OFFSET(0xD78E250)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER__ONUIINIT_B__7_0_OFFSET UNITYSDK_OFFSET(0xD78EA60)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER__UPDATEBOSSCARDS_OFFSET UNITYSDK_OFFSET(0xD78B100)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER__UPDATEELEMENTPROP_OFFSET UNITYSDK_OFFSET(0xD78DAE0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER__UPDATEELEPROPTEXT_OFFSET UNITYSDK_OFFSET(0xD78E420)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER__UPDATESELECTCARDINFO_OFFSET UNITYSDK_OFFSET(0xD78CBA0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD78EAF0)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD78EB60)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD78EB70)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD78EB80)
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER___BINDBTNS_B__11_0_OFFSET UNITYSDK_OFFSET(0xD78EAE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterCardInfoPopWindowController_TypeDefinitionIndex = 47517;
	...
	public:
		...
		::System::Void UpdateCamp(::Class_1_5DA2E7556103D5A3_300* cfg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_300*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_UPDATECAMP_OFFSET))(this, cfg);
		}

		::System::Void UpdateType(::Class_1_5DA2E7556103D5A3_300* cfg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_300*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_UPDATETYPE_OFFSET))(this, cfg);
		}
