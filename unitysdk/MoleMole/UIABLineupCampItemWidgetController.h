...
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_HIDENUM_OFFSET UNITYSDK_OFFSET(0xD84AD50)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xD84ADD0)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD84A7A0)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xD84AEE0)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD84A920)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD84A840)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD84A3D0)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD84AA10)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xD84AC80)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD84B120)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0xD84B130)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xD84B190)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD84B1A0)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xD84B210)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD84B280)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD84B300)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD84B380)

namespace MoleMole
{
	inline static constexpr unsigned int UIABLineupCampItemWidgetController_TypeDefinitionIndex = 60847;
