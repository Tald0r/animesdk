...
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_HIDENUM_OFFSET UNITYSDK_OFFSET(0xCFEB7A0)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xCFEB820)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFEB1F0)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCFEB930)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCFEB370)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFEB290)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFEAE20)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCFEB460)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xCFEB6D0)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFEBB70)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0xCFEBB80)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xCFEBBE0)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFEBBF0)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCFEBC60)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCFEBCD0)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFEBD50)
#define MOLEMOLE_UIABLINEUPCAMPITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFEBDD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIABLineupCampItemWidgetController_TypeDefinitionIndex = 66805;

	class UIABLineupCampItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_1B0A36368606660E_3* _view; // 0x2D0
