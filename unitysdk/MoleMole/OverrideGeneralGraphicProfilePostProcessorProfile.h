...
#define MOLEMOLE_OVERRIDEGENERALGRAPHICPROFILEPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6E4E5A0)
#define MOLEMOLE_OVERRIDEGENERALGRAPHICPROFILEPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E4E630)
#define MOLEMOLE_OVERRIDEGENERALGRAPHICPROFILEPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6E4E720)

namespace MoleMole
{
	inline static constexpr unsigned int OverrideGeneralGraphicProfilePostProcessorProfile_TypeDefinitionIndex = 52005;
