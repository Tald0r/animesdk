...
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER_GETSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0xA45E560)
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER_REFRESHACTCHALLENGELIST_OFFSET UNITYSDK_OFFSET(0xA45E080)
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0xA45DA50)
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA45E870)
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER___BASE_GETSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0xA45E880)
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER___BASE_REFRESHACTCHALLENGELIST_OFFSET UNITYSDK_OFFSET(0xA45E890)
#define MOLEMOLE_UISMASHBROINLEVELPAUSEBATTLEWIDGETCONTROLLER___BASE_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0xA45E8A0)

namespace MoleMole
{
	inline static constexpr unsigned int UISmashBroInLevelPauseBattleWidgetController_TypeDefinitionIndex = 40542;

	class UISmashBroInLevelPauseBattleWidgetController : public ::MoleMole::UIInLevelPauseBattleInfoWidgetController
	{
	public:
		::Class_1_BF64A3E806610DD3_5_Class_0_16E7307DCC43CB2C_5* _challengeFetcher; // 0x2C8
