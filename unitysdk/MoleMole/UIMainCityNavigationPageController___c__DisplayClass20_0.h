...
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA411120)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS20_0__ONUIOPEN_B__0_OFFSET UNITYSDK_OFFSET(0xA411130)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS20_0__ONUIOPEN_B__1_OFFSET UNITYSDK_OFFSET(0xA4111F0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS20_0__ONUIOPEN_B__2_OFFSET UNITYSDK_OFFSET(0xA4112C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityNavigationPageController___c__DisplayClass20_0_TypeDefinitionIndex = 64296;
