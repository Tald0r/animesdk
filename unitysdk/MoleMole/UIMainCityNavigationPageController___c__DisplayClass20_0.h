...
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x94497D0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS20_0__ONUIOPEN_B__0_OFFSET UNITYSDK_OFFSET(0x94497E0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS20_0__ONUIOPEN_B__1_OFFSET UNITYSDK_OFFSET(0x94498A0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS20_0__ONUIOPEN_B__2_OFFSET UNITYSDK_OFFSET(0x9449970)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityNavigationPageController___c__DisplayClass20_0_TypeDefinitionIndex = 41272;
