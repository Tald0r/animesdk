...
#define MOLEMOLE_UIACTIVITYGRANDREWARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC813320)
#define MOLEMOLE_UIACTIVITYGRANDREWARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC8134A0)
#define MOLEMOLE_UIACTIVITYGRANDREWARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC8133C0)
#define MOLEMOLE_UIACTIVITYGRANDREWARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC813140)
#define MOLEMOLE_UIACTIVITYGRANDREWARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC813840)
#define MOLEMOLE_UIACTIVITYGRANDREWARDROWWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0xC813850)
#define MOLEMOLE_UIACTIVITYGRANDREWARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC813980)
#define MOLEMOLE_UIACTIVITYGRANDREWARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC8139F0)
#define MOLEMOLE_UIACTIVITYGRANDREWARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC813A70)
#define MOLEMOLE_UIACTIVITYGRANDREWARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC813AF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityGrandRewardRowWidgetController_TypeDefinitionIndex = 45845;
	...
	public:
		...
		::Class_3_1699D6295DC3F818* _rewardItem; // 0x2D8
