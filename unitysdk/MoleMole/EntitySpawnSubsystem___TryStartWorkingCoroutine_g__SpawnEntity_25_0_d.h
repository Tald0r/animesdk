...
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM___TRYSTARTWORKINGCOROUTINE_G__SPAWNENTITY_25_0_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC2B4C10)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM___TRYSTARTWORKINGCOROUTINE_G__SPAWNENTITY_25_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC2B4F20)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM___TRYSTARTWORKINGCOROUTINE_G__SPAWNENTITY_25_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC2B4F80)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM___TRYSTARTWORKINGCOROUTINE_G__SPAWNENTITY_25_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC2B4F30)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM___TRYSTARTWORKINGCOROUTINE_G__SPAWNENTITY_25_0_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC2B4C00)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM___TRYSTARTWORKINGCOROUTINE_G__SPAWNENTITY_25_0_D__CTOR_OFFSET UNITYSDK_OFFSET(0xC2B4BF0)

namespace MoleMole
{
	inline static constexpr unsigned int EntitySpawnSubsystem___TryStartWorkingCoroutine_g__SpawnEntity_25_0_d_TypeDefinitionIndex = 55041;
