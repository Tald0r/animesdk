...
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_BTN_OFFSET UNITYSDK_OFFSET(0xAD75040)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_BUTTONAREA_OFFSET UNITYSDK_OFFSET(0xAD752E0)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_BUTTONROOT_OFFSET UNITYSDK_OFFSET(0xAD75070)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_MAXDRAGAREA_OFFSET UNITYSDK_OFFSET(0xAD75140)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT_GET_MINDRAGAREA_OFFSET UNITYSDK_OFFSET(0xAD75210)
#define MOLEMOLE_UIINLEVELQTEBTNPANELCHILDWINDOWCONTROLLER_UIBUTTONVIEW_LEFT__CTOR_OFFSET UNITYSDK_OFFSET(0xAD753B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelQTEBtnPanelChildWindowController_UIButtonView_Left_TypeDefinitionIndex = 53100;
