...
#define MOLEMOLE_MONOONEWAYDOORSENSOR_METHOD_5_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0xD8149E0)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD814F40)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xD814550)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xD814D10)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_SYNCSIZE_OFFSET UNITYSDK_OFFSET(0xD814DD0)
#define MOLEMOLE_MONOONEWAYDOORSENSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD814F20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoOneWayDoorSensor_TypeDefinitionIndex = 49843;
