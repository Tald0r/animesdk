...
#define MOLEMOLE_MONOONEWAYDOORSENSOR_METHOD_5_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0xB9A4FC0)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB9A5520)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xB9A4B30)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xB9A52F0)
#define MOLEMOLE_MONOONEWAYDOORSENSOR_SYNCSIZE_OFFSET UNITYSDK_OFFSET(0xB9A53B0)
#define MOLEMOLE_MONOONEWAYDOORSENSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A5500)

namespace MoleMole
{
	inline static constexpr unsigned int MonoOneWayDoorSensor_TypeDefinitionIndex = 49403;
