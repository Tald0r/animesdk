...
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ISUSING_OFFSET UNITYSDK_OFFSET(0x8BF6A30)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BF6560)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8BF66E0)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BF6600)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BF6340)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER_SHOWFILTERROW_OFFSET UNITYSDK_OFFSET(0x8BF6860)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8BF6AB0)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BF6AC0)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8BF6B30)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BF6BB0)
#define MOLEMOLE_UIFILTERROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BF6C30)

namespace MoleMole
{
	inline static constexpr unsigned int UIFilterRowWidgetController_TypeDefinitionIndex = 71641;

	class UIFilterRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_FB90F8F234309AE5_1* _view; // 0x2D0
		::Class_1_03687BAE461D2A08* _filter; // 0x2D8
