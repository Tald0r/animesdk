...
#define MOLEMOLE_NAPSPLITSERIALIZED_BRANCHSCRIPTABLEOBJECT_ONCONVERTTOSPLIT_OFFSET UNITYSDK_OFFSET(0xA531AF0)
#define MOLEMOLE_NAPSPLITSERIALIZED_BRANCHSCRIPTABLEOBJECT_ONMERGESPLIT_OFFSET UNITYSDK_OFFSET(0xA531A80)
#define MOLEMOLE_NAPSPLITSERIALIZED_BRANCHSCRIPTABLEOBJECT_ONRUNTIMEPREPARE_OFFSET UNITYSDK_OFFSET(0xA531C30)
#define MOLEMOLE_NAPSPLITSERIALIZED_BRANCHSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA531D00)
#define MOLEMOLE_NAPSPLITSERIALIZED_BRANCHSCRIPTABLEOBJECT__LOGERR_OFFSET UNITYSDK_OFFSET(0xA531BC0)

namespace MoleMole
{
	inline static constexpr unsigned int NapSplitSerialized_BranchScriptableObject_TypeDefinitionIndex = 44869;
