...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_CANNOTDRAGHANDLER_OFFSET UNITYSDK_OFFSET(0xAB50DD0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_CHECKPRESSCLAMP_OFFSET UNITYSDK_OFFSET(0xAB57420)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_CLEARARCHIVEFILES_OFFSET UNITYSDK_OFFSET(0xAB59010)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_CLEARLEVEL_OFFSET UNITYSDK_OFFSET(0xAB53160)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_CLEARPERSONALLINE_OFFSET UNITYSDK_OFFSET(0xAB5B6B0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_CLEARSTICKVAL_OFFSET UNITYSDK_OFFSET(0xAB59680)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_CLOSEVIDEO_OFFSET UNITYSDK_OFFSET(0xAB5A2D0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_DESELECTLASTSELECTROW_OFFSET UNITYSDK_OFFSET(0xAB544B0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_DONTSHOWTAPE_OFFSET UNITYSDK_OFFSET(0xAB55C90)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ENABLESHOWTAPEUIANIM_OFFSET UNITYSDK_OFFSET(0xAB55E50)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ENABLEUIMANIPULATE_OFFSET UNITYSDK_OFFSET(0xAB4FB70)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_FADEOUTDECKINFO_OFFSET UNITYSDK_OFFSET(0xAB56FC0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_FINISHPERSONALLINE_OFFSET UNITYSDK_OFFSET(0xAB4ED10)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_GETSHOWCOUNT_OFFSET UNITYSDK_OFFSET(0xAB52F00)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_GETSTICKVAL_OFFSET UNITYSDK_OFFSET(0xAB59570)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_GET_ISSHOW2DUI_OFFSET UNITYSDK_OFFSET(0xAB5E3F0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0xAB52550)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAB4DD40)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_GOTOBATTLE_OFFSET UNITYSDK_OFFSET(0xAB5D390)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_GOTOSUBITEM_OFFSET UNITYSDK_OFFSET(0xAB5CA70)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_HANDLEPERSONALFINISHFAIRY_OFFSET UNITYSDK_OFFSET(0xAB5D560)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_HIDESCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xAB4F020)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_HIDETAPEDECKINFO_OFFSET UNITYSDK_OFFSET(0xAB528E0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_HIDETAPGROUP_OFFSET UNITYSDK_OFFSET(0xAB56C00)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_INITARCHIVEFILES_OFFSET UNITYSDK_OFFSET(0xAB59090)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_INITLEVELID_OFFSET UNITYSDK_OFFSET(0xAB52A80)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_INITLEVEL_OFFSET UNITYSDK_OFFSET(0xAB53360)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_INITPERSONALLINE_OFFSET UNITYSDK_OFFSET(0xAB5AC10)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_INITSELECTCTRL_OFFSET UNITYSDK_OFFSET(0xAB54100)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ISANYSCROLLVIEWPLAYINGANIM_OFFSET UNITYSDK_OFFSET(0xAB589F0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ISINSELECTZONE_OFFSET UNITYSDK_OFFSET(0xAB57270)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ITEMSFADEOUT_OFFSET UNITYSDK_OFFSET(0xAB563A0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAB58050)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xAB5A570)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONCLICKDIFFICULTY_OFFSET UNITYSDK_OFFSET(0xAB58EB0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONCLICKOKREAL_OFFSET UNITYSDK_OFFSET(0xAB59320)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONCLICKOK_OFFSET UNITYSDK_OFFSET(0xAB59250)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB4DD50)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONDONTSHOWTAPEANIMFINISH_OFFSET UNITYSDK_OFFSET(0xAB5E0A0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xAB5A440)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xAB5A6C0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONENDNEWBIE_OFFSET UNITYSDK_OFFSET(0xAB52250)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xAB57CC0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xAB57720)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAB4F9E0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAB574B0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONMAINSTORYSTARTPERFORMFINISH_OFFSET UNITYSDK_OFFSET(0xAB51990)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONOPENNEWBIE_OFFSET UNITYSDK_OFFSET(0xAB51FC0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONPOINTUP_OFFSET UNITYSDK_OFFSET(0xAB5A830)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0xAB524E0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONSHOWTAPE_OFFSET UNITYSDK_OFFSET(0xAB52560)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB4DDF0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB514D0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB4FBE0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xAB56DC0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_PLAYBMFADEINANIM_OFFSET UNITYSDK_OFFSET(0xAB530C0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_PLAYBMFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0xAB53020)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHARCHIVEBTNS_OFFSET UNITYSDK_OFFSET(0xAB56180)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHARCHIVETYPEBTNS_OFFSET UNITYSDK_OFFSET(0xAB4F0B0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHBOTTOMREWARD_OFFSET UNITYSDK_OFFSET(0xAB4EA70)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHINFOMEDIAVIEW_OFFSET UNITYSDK_OFFSET(0xAB55640)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHINVISIBLEAREANOTIFYHINT_OFFSET UNITYSDK_OFFSET(0xAB59DB0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHLEFTVIEW_OFFSET UNITYSDK_OFFSET(0xAB54B20)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHNOTIFYHINTFORARCHIVETYPES_OFFSET UNITYSDK_OFFSET(0xAB59990)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHNOTIFYHINTFORCURVHS_OFFSET UNITYSDK_OFFSET(0xAB596F0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHNOTIFYHINT_OFFSET UNITYSDK_OFFSET(0xAB4F960)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHPERSONALLEFTVIEW_OFFSET UNITYSDK_OFFSET(0xAB5B870)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0xAB53D10)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHRECOMMENDEDHITTYPES_OFFSET UNITYSDK_OFFSET(0xAB545D0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHSCROLLVIEWARROW_OFFSET UNITYSDK_OFFSET(0xAB5A9D0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SCROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0xAB57C40)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SETARCHIVETYPE_OFFSET UNITYSDK_OFFSET(0xAB570E0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SETCOMPLEXITYINFO_OFFSET UNITYSDK_OFFSET(0xAB5C530)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SETIMGNOISE_OFFSET UNITYSDK_OFFSET(0xAB55B70)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SETNOISE_OFFSET UNITYSDK_OFFSET(0xAB51180)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xAB51420)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SETVHSTEMPLATEID_OFFSET UNITYSDK_OFFSET(0xAB57150)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SET_ISSHOW2DUI_OFFSET UNITYSDK_OFFSET(0xAB5E3E0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SHOWINFOBTN_OFFSET UNITYSDK_OFFSET(0xAB50B40)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0xAB5C860)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SHOWSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xAB5A940)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SHOWTAPEDECKINFO_OFFSET UNITYSDK_OFFSET(0xAB55FB0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SHOWTAPGROUP_OFFSET UNITYSDK_OFFSET(0xAB56CE0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_TICKCENTERCHOOSEINDEX_OFFSET UNITYSDK_OFFSET(0xAB580D0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_TICKSCROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0xAB583A0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_TICKSCROLLVIEWSCROLLTOTARGETRESULT_OFFSET UNITYSDK_OFFSET(0xAB588C0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_TRYOPENNEWTIPS_OFFSET UNITYSDK_OFFSET(0xAB5D9E0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_TRYOPENTIPS_OFFSET UNITYSDK_OFFSET(0xAB51EE0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER_TRYREADALLPERSONALENTRY_OFFSET UNITYSDK_OFFSET(0xAB51810)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__CLOSEVIDEO_B__70_0_OFFSET UNITYSDK_OFFSET(0xAB5F1F0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB5E400)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__INITLEVEL_B__22_0_OFFSET UNITYSDK_OFFSET(0xAB5F0B0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__ITEMSFADEOUT_B__35_0_OFFSET UNITYSDK_OFFSET(0xAB5F170)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__ONMAINSTORYSTARTPERFORMFINISH_G__TRIGGERNEWBIE_10_0_OFFSET UNITYSDK_OFFSET(0xAB51DE0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0xAB5E530)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__ONUIINIT_B__5_1_OFFSET UNITYSDK_OFFSET(0xAB5EB50)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__ONUIINIT_B__5_2_OFFSET UNITYSDK_OFFSET(0xAB5EDE0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__ONUIINIT_B__5_3_OFFSET UNITYSDK_OFFSET(0xAB5EF60)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__ONUIINIT_B__5_4_OFFSET UNITYSDK_OFFSET(0xAB5EF70)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__REFRESHBOTTOMREWARD_G__GETGENERALCHALLENGEREWARDLIST_96_0_OFFSET UNITYSDK_OFFSET(0xAB5E260)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__REFRESHBOTTOMREWARD_G__GETREWARDINFODATALIST_96_2_OFFSET UNITYSDK_OFFSET(0xAB5F4C0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__REFRESHBOTTOMREWARD_G__ONREWARDINFOCLICKHANDLE_96_1_OFFSET UNITYSDK_OFFSET(0xAB5F230)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__REFRESHINFOMEDIAVIEW_B__30_0_OFFSET UNITYSDK_OFFSET(0xAB5F120)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__SETCOMPLEXITYINFO_G__SETTIMECOST_95_0_OFFSET UNITYSDK_OFFSET(0xAB5E130)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__SETIMGNOISE_B__32_0_OFFSET UNITYSDK_OFFSET(0xAB5F130)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__SHOWINFOBTN_B__29_0_OFFSET UNITYSDK_OFFSET(0xAB5F0C0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__TRYOPENNEWTIPS_G__WITHSHOWTIPSOFTAG_93_0_OFFSET UNITYSDK_OFFSET(0xAB5DEB0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER__VIDEOPLAYER_PREPARECOMPLETED_OFFSET UNITYSDK_OFFSET(0xAB51110)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB5F770)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___BASE_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xAB5F7E0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xAB5F860)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAB5F8E0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAB5F940)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___BASE_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0xAB5F970)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB5F980)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB5F990)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB5F9A0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xAB5F9B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController_TypeDefinitionIndex = 71434;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_246* _view; // 0x330
		...
		{
			return ((::Enum_3_205E43D40B9E7AEA(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET))(this);
		}
		...
		::System::Void RefreshPersonalLeftView(::Class_2_208CC9941471731A_162* template_)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_162*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYPAGECONTROLLER_REFRESHPERSONALLEFTVIEW_OFFSET))(this, template_);
		}

		::System::Void ShowInfo(::System::Int32 battleID, ::Class_2_208CC9941471731A_569* template_)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Class_2_208CC9941471731A_569*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYPAGECONTROLLER_SHOWINFO_OFFSET))(this, battleID, template_);
		}

		::System::Void GoToSubItem(::Class_2_208CC9941471731A_569* fileTemplate, ::System::Int32 subID)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_569*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYPAGECONTROLLER_GOTOSUBITEM_OFFSET))(this, fileTemplate, subID);
		}
