...
#define MOLEMOLE_UIACTIVITYHOTPOTPAGECONTROLLER__TRYTRIGGERNEWBIE_D__12_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x37D1D0)
#define MOLEMOLE_UIACTIVITYHOTPOTPAGECONTROLLER__TRYTRIGGERNEWBIE_D__12_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x30F550)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotPotPageController__TryTriggerNewBie_d__12_TypeDefinitionIndex = 44733;
	...
	struct alignas(8) UIActivityHotPotPageController__TryTriggerNewBie_d__12
	{
		...
		::Class_2_47F3EABB6C9CDECD* _newbieModel_5__2; // 0x48
