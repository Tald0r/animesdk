...
#define MOLEMOLE_DEVICESETTINGDEVICEMODELPREDICATE_GETPREDICATESTRING_OFFSET UNITYSDK_OFFSET(0x139B0DC0)
#define MOLEMOLE_DEVICESETTINGDEVICEMODELPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x139B0E30)
#define MOLEMOLE_DEVICESETTINGDEVICEMODELPREDICATE___BASE_GETPREDICATESTRING_OFFSET UNITYSDK_OFFSET(0x139B0EB0)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingDeviceModelPredicate_TypeDefinitionIndex = 77899;
