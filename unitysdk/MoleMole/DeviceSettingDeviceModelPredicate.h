...
#define MOLEMOLE_DEVICESETTINGDEVICEMODELPREDICATE_GETPREDICATESTRING_OFFSET UNITYSDK_OFFSET(0x91A33D0)
#define MOLEMOLE_DEVICESETTINGDEVICEMODELPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x91A3440)
#define MOLEMOLE_DEVICESETTINGDEVICEMODELPREDICATE___BASE_GETPREDICATESTRING_OFFSET UNITYSDK_OFFSET(0x91A34C0)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingDeviceModelPredicate_TypeDefinitionIndex = 41864;
