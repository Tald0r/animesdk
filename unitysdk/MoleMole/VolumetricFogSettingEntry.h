...
#define MOLEMOLE_VOLUMETRICFOGSETTINGENTRY_GET_PROFILETYPE_OFFSET UNITYSDK_OFFSET(0x71F6CD0)
#define MOLEMOLE_VOLUMETRICFOGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x71F6CC0)
#define MOLEMOLE_VOLUMETRICFOGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x71F6CE0)

namespace MoleMole
{
	inline static constexpr unsigned int VolumetricFogSettingEntry_TypeDefinitionIndex = 37195;
