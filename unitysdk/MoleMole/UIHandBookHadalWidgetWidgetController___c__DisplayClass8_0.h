...
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x871C610)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER___C__DISPLAYCLASS8_0__ONSHOPBTNCLICK_B__0_OFFSET UNITYSDK_OFFSET(0x871C620)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER___C__DISPLAYCLASS8_0__ONSHOPBTNCLICK_B__1_OFFSET UNITYSDK_OFFSET(0x871C900)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookHadalWidgetWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 45718;
