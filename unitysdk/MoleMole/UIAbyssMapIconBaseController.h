...
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SETAFFIXICON_OFFSET UNITYSDK_OFFSET(0xE8EA090)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SETICON_OFFSET UNITYSDK_OFFSET(0xE8E9F90)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SETMUTEICONINTERNAL_OFFSET UNITYSDK_OFFSET(0xE8EA110)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SETMUTEICON_OFFSET UNITYSDK_OFFSET(0xE8EA010)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER_SWITCHSTYLE_OFFSET UNITYSDK_OFFSET(0xE8E9EF0)
#define MOLEMOLE_UIABYSSMAPICONBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE8E9D00)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssMapIconBaseController_TypeDefinitionIndex = 72380;
