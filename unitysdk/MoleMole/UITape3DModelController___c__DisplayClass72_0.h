...
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS72_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA412A00)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS72_0__ROTATE_B__0_OFFSET UNITYSDK_OFFSET(0xA412A10)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS72_0__ROTATE_B__1_OFFSET UNITYSDK_OFFSET(0xA412A20)

namespace MoleMole
{
	inline static constexpr unsigned int UITape3DModelController___c__DisplayClass72_0_TypeDefinitionIndex = 54195;
