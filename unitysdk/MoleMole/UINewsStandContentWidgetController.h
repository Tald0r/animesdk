...
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER_CREATESTYLEWIDGETNEW_OFFSET UNITYSDK_OFFSET(0x92BD260)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER_ENABLEFOCUS_OFFSET UNITYSDK_OFFSET(0x92BD710)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x92BD520)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x92BD5C0)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x92BD020)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER_SHOWDETAILWINDOW_OFFSET UNITYSDK_OFFSET(0x92BD6A0)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x73932B0)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x73932E0)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7393350)
#define MOLEMOLE_UINEWSSTANDCONTENTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x73933D0)

namespace MoleMole
{
	inline static constexpr unsigned int UINewsStandContentWidgetController_TypeDefinitionIndex = 59081;

	class UINewsStandContentWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_949134FE88CA671F* _view; // 0x2A0
		::MoleMole::UINewsStyleWidgetController* _styleWidget; // 0x2A8
