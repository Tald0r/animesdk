...
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBE76240)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__SETGENERALQUEST_B__0_OFFSET UNITYSDK_OFFSET(0xBE76250)
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__SETGENERALQUEST_B__1_OFFSET UNITYSDK_OFFSET(0xBE76270)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastTodoListWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 75533;
