...
#define MOLEMOLE_UIGYROTESTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xBFC1560)
#define MOLEMOLE_UIGYROTESTPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFC1570)
#define MOLEMOLE_UIGYROTESTPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFC15E0)
#define MOLEMOLE_UIGYROTESTPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBFC17E0)
#define MOLEMOLE_UIGYROTESTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFC16E0)
#define MOLEMOLE_UIGYROTESTPOPWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBFC1850)
#define MOLEMOLE_UIGYROTESTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFC1910)
#define MOLEMOLE_UIGYROTESTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFC1920)
#define MOLEMOLE_UIGYROTESTPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBFC1990)
#define MOLEMOLE_UIGYROTESTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFC19A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGyroTestPopWindowController_TypeDefinitionIndex = 50562;
