...
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF034E0)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBF03660)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF03580)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF032C0)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF03870)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF03880)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBF038F0)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF03970)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF039F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFoodTruckItemWidgetController_TypeDefinitionIndex = 62539;

	class UIFoodTruckItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_C9DDE9730C6BE395* _view; // 0x2D0
