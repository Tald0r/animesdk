...
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA973AE0)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA973C60)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA973B80)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA9738C0)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA973E70)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA973E80)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA973EF0)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA973F70)
#define MOLEMOLE_UIFOODTRUCKITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA973FF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFoodTruckItemWidgetController_TypeDefinitionIndex = 54313;
