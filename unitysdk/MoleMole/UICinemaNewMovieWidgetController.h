...
#define MOLEMOLE_UICINEMANEWMOVIEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDDD3F10)
#define MOLEMOLE_UICINEMANEWMOVIEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDDD3FB0)
#define MOLEMOLE_UICINEMANEWMOVIEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDDD3DC0)
#define MOLEMOLE_UICINEMANEWMOVIEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDDD3E60)
#define MOLEMOLE_UICINEMANEWMOVIEWIDGETCONTROLLER_REFRESHMOVIE_OFFSET UNITYSDK_OFFSET(0xDDD4090)
#define MOLEMOLE_UICINEMANEWMOVIEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDDD42D0)
#define MOLEMOLE_UICINEMANEWMOVIEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDDD4300)
#define MOLEMOLE_UICINEMANEWMOVIEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDDD4370)
#define MOLEMOLE_UICINEMANEWMOVIEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDDD43F0)
#define MOLEMOLE_UICINEMANEWMOVIEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDDD4450)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaNewMovieWidgetController_TypeDefinitionIndex = 41629;
