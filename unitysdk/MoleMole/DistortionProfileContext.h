...
#define MOLEMOLE_DISTORTIONPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16BBD580)

namespace MoleMole
{
	inline static constexpr unsigned int DistortionProfileContext_TypeDefinitionIndex = 36550;
