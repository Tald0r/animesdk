...
#define MOLEMOLE_UIFINISHACHIEVEMENTPOP_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xC6304D0)
#define MOLEMOLE_UIFINISHACHIEVEMENTPOP_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xC630520)
#define MOLEMOLE_UIFINISHACHIEVEMENTPOP__CTOR_OFFSET UNITYSDK_OFFSET(0xC6304E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFinishAchievementPop_TypeDefinitionIndex = 75291;
