...
#define MOLEMOLE_MONOUIENABLESOUNDPLAYER_METHOD_5_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0x7A94B90)
#define MOLEMOLE_MONOUIENABLESOUNDPLAYER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x7A94B20)
#define MOLEMOLE_MONOUIENABLESOUNDPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x7A94E20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIEnableSoundPlayer_TypeDefinitionIndex = 46479;
