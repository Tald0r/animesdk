...
#define MOLEMOLE_MONOUIENABLESOUNDPLAYER_METHOD_5_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0xA491530)
#define MOLEMOLE_MONOUIENABLESOUNDPLAYER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA4914C0)
#define MOLEMOLE_MONOUIENABLESOUNDPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4917C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIEnableSoundPlayer_TypeDefinitionIndex = 41066;
