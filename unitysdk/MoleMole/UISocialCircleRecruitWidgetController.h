...
class Class_2_652238A4D7B694FD;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }
namespace System { class String; }

#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDF3AB10)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_INPUTACTIONCHECK_OFFSET UNITYSDK_OFFSET(0xDF3B850)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDF3AB80)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONINPUTCHANGED_OFFSET UNITYSDK_OFFSET(0xDF3C0E0)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONINPUTFIELDDESELECT_OFFSET UNITYSDK_OFFSET(0xDF3BC20)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONINPUTFIELDSELECT_OFFSET UNITYSDK_OFFSET(0xDF3B8F0)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDF3B180)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF3B780)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF3C460)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER__ONCREATEVIEWMODEL_B__4_0_OFFSET UNITYSDK_OFFSET(0xDF3C490)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDF3C540)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDF3C5B0)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF3C620)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleRecruitWidgetController_TypeDefinitionIndex = 64609;

	class UISocialCircleRecruitWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_1_1BC290F9827A1BD7* handler; // 0x2A0
		::Class_2_19B7C5138FC90FBC* TextValidate; // 0x2A8
		...
		::Class_2_652238A4D7B694FD* get__viewModel()
		{
			return ((::Class_2_652238A4D7B694FD*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
