...
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6CB900)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_INPUTACTIONCHECK_OFFSET UNITYSDK_OFFSET(0xD6CC630)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6CB970)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONINPUTCHANGED_OFFSET UNITYSDK_OFFSET(0xD6CCEC0)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONINPUTFIELDDESELECT_OFFSET UNITYSDK_OFFSET(0xD6CCA00)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONINPUTFIELDSELECT_OFFSET UNITYSDK_OFFSET(0xD6CC6D0)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD6CBF60)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD6CC560)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD6CD240)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER__ONCREATEVIEWMODEL_B__4_0_OFFSET UNITYSDK_OFFSET(0xD6CD270)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6CD320)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD6CD390)
#define MOLEMOLE_UISOCIALCIRCLERECRUITWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD6CD400)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleRecruitWidgetController_TypeDefinitionIndex = 40592;
