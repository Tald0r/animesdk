...
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9EB0350)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS14_0__ONSCROLLITEMUPDATE_B__0_OFFSET UNITYSDK_OFFSET(0x9EB0360)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS14_0__ONSCROLLITEMUPDATE_G__GETFINALREPLYTYPE_1_OFFSET UNITYSDK_OFFSET(0x9EB0430)

namespace MoleMole
{
	inline static constexpr unsigned int UIPrivateMessageReplyWidgetController___c__DisplayClass14_0_TypeDefinitionIndex = 48101;
