...
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB6D9440)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS14_0__ONSCROLLITEMUPDATE_B__0_OFFSET UNITYSDK_OFFSET(0xB6D9450)
#define MOLEMOLE_UIPRIVATEMESSAGEREPLYWIDGETCONTROLLER___C__DISPLAYCLASS14_0__ONSCROLLITEMUPDATE_G__GETFINALREPLYTYPE_1_OFFSET UNITYSDK_OFFSET(0xB6D9520)

namespace MoleMole
{
	inline static constexpr unsigned int UIPrivateMessageReplyWidgetController___c__DisplayClass14_0_TypeDefinitionIndex = 57811;
