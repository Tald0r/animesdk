...
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xC9CE420)
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW_INITIGNOREPOPCTRL_OFFSET UNITYSDK_OFFSET(0xC9CE4D0)
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xC9CE540)
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9CE430)

namespace MoleMole
{
	inline static constexpr unsigned int ForbiddenAreaInsightLevelUpShow_TypeDefinitionIndex = 61514;
