...
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xBA137E0)
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW_INITIGNOREPOPCTRL_OFFSET UNITYSDK_OFFSET(0xBA13890)
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xBA13900)
#define MOLEMOLE_FORBIDDENAREAINSIGHTLEVELUPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xBA137F0)

namespace MoleMole
{
	inline static constexpr unsigned int ForbiddenAreaInsightLevelUpShow_TypeDefinitionIndex = 71453;
