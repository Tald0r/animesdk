...
#define MOLEMOLE_UILEVELRESULTDELAYEVENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCFC51A0)
#define MOLEMOLE_UILEVELRESULTDELAYEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCFC4FB0)
#define MOLEMOLE_UILEVELRESULTDELAYEVENT_TRYFIREEVENT_OFFSET UNITYSDK_OFFSET(0xCFC5010)
#define MOLEMOLE_UILEVELRESULTDELAYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xCFC5200)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultDelayEvent_TypeDefinitionIndex = 45155;
