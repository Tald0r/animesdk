...
#define MOLEMOLE_BLENDTEXTURESHEETDATA_CREATEPLAYER_OFFSET UNITYSDK_OFFSET(0x6FBA340)
#define MOLEMOLE_BLENDTEXTURESHEETDATA_GET_HASONEPLAYSLOT_OFFSET UNITYSDK_OFFSET(0x6FBA180)
#define MOLEMOLE_BLENDTEXTURESHEETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6FBA3B0)

namespace MoleMole
{
	inline static constexpr unsigned int BlendTextureSheetData_TypeDefinitionIndex = 56182;
	...
	public:
		...
		{
			return ((::Class_1_5A6771CD0CA2718D*(*)(::PVOID, ::Class_0_16E4307DCC419505_269*))((::PBYTE)hIl2Cpp + MOLEMOLE_BLENDTEXTURESHEETDATA_CREATEPLAYER_OFFSET))(this, textureSheetImpl);
		}
	};
}
