...
#define MOLEMOLE_SUIBIANSELLRIGHTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC32E020)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianSellRightContext_TypeDefinitionIndex = 57086;
