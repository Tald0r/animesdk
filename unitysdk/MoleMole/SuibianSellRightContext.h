...
#define MOLEMOLE_SUIBIANSELLRIGHTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA1C80)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianSellRightContext_TypeDefinitionIndex = 42616;
