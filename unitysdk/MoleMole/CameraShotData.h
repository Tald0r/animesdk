...
#define MOLEMOLE_CAMERASHOTDATA_GET_ADDTYPE_OFFSET UNITYSDK_OFFSET(0x6216A50)
#define MOLEMOLE_CAMERASHOTDATA_GET_APPLYENTITYTIMESCALE_OFFSET UNITYSDK_OFFSET(0x6216AA0)
#define MOLEMOLE_CAMERASHOTDATA_GET_BLENDDEFINITIONENTER_OFFSET UNITYSDK_OFFSET(0x6216AF0)
#define MOLEMOLE_CAMERASHOTDATA_GET_BLENDDEFINITIONEXIT_OFFSET UNITYSDK_OFFSET(0x6216B00)
#define MOLEMOLE_CAMERASHOTDATA_GET_CINEPREFABPATH_OFFSET UNITYSDK_OFFSET(0x6216A10)
#define MOLEMOLE_CAMERASHOTDATA_GET_DURATIONBYEVENT_OFFSET UNITYSDK_OFFSET(0x6216A80)
#define MOLEMOLE_CAMERASHOTDATA_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x6216A70)
#define MOLEMOLE_CAMERASHOTDATA_GET_FOLLOWROOTROT_OFFSET UNITYSDK_OFFSET(0x6216AD0)
#define MOLEMOLE_CAMERASHOTDATA_GET_INGORECAMCOLLIDERDETECT_OFFSET UNITYSDK_OFFSET(0x6216AB0)
#define MOLEMOLE_CAMERASHOTDATA_GET_INGORETIMESCALE_OFFSET UNITYSDK_OFFSET(0x6216A90)
#define MOLEMOLE_CAMERASHOTDATA_GET_LOOKATTYPE_OFFSET UNITYSDK_OFFSET(0x6216AE0)
#define MOLEMOLE_CAMERASHOTDATA_GET_LOOPINITTIME_OFFSET UNITYSDK_OFFSET(0x6216A60)
#define MOLEMOLE_CAMERASHOTDATA_GET_PARENTTYPE_OFFSET UNITYSDK_OFFSET(0x6216AC0)
#define MOLEMOLE_CAMERASHOTDATA_GET_SKIPBANNERFADEIN_OFFSET UNITYSDK_OFFSET(0x6216A30)
#define MOLEMOLE_CAMERASHOTDATA_GET_USEBANNER_OFFSET UNITYSDK_OFFSET(0x6216A20)
#define MOLEMOLE_CAMERASHOTDATA_GET_VIDEOTYPE_OFFSET UNITYSDK_OFFSET(0x6216A40)
#define MOLEMOLE_CAMERASHOTDATA_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x6216BF0)
#define MOLEMOLE_CAMERASHOTDATA_METHOD_1_BE0C2A5B39FEF128_OFFSET UNITYSDK_OFFSET(0x6216E20)
#define MOLEMOLE_CAMERASHOTDATA_METHOD_1_CA8D2C39D135A2C2_OFFSET UNITYSDK_OFFSET(0x6216D00)
#define MOLEMOLE_CAMERASHOTDATA_METHOD_1_DB546B80269157CF_OFFSET UNITYSDK_OFFSET(0x6216C90)
#define MOLEMOLE_CAMERASHOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6216B10)

namespace MoleMole
{
	inline static constexpr unsigned int CameraShotData_TypeDefinitionIndex = 43196;
