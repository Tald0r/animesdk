...
#define MOLEMOLE_CAMERASHOTDATA_GET_ADDTYPE_OFFSET UNITYSDK_OFFSET(0x84EAB30)
#define MOLEMOLE_CAMERASHOTDATA_GET_APPLYENTITYTIMESCALE_OFFSET UNITYSDK_OFFSET(0x84EAB80)
#define MOLEMOLE_CAMERASHOTDATA_GET_BLENDDEFINITIONENTER_OFFSET UNITYSDK_OFFSET(0x84EABD0)
#define MOLEMOLE_CAMERASHOTDATA_GET_BLENDDEFINITIONEXIT_OFFSET UNITYSDK_OFFSET(0x84EABE0)
#define MOLEMOLE_CAMERASHOTDATA_GET_CINEPREFABPATH_OFFSET UNITYSDK_OFFSET(0x84EAAF0)
#define MOLEMOLE_CAMERASHOTDATA_GET_DURATIONBYEVENT_OFFSET UNITYSDK_OFFSET(0x84EAB60)
#define MOLEMOLE_CAMERASHOTDATA_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x84EAB50)
#define MOLEMOLE_CAMERASHOTDATA_GET_FOLLOWROOTROT_OFFSET UNITYSDK_OFFSET(0x84EABB0)
#define MOLEMOLE_CAMERASHOTDATA_GET_INGORECAMCOLLIDERDETECT_OFFSET UNITYSDK_OFFSET(0x84EAB90)
#define MOLEMOLE_CAMERASHOTDATA_GET_INGORETIMESCALE_OFFSET UNITYSDK_OFFSET(0x84EAB70)
#define MOLEMOLE_CAMERASHOTDATA_GET_LOOKATTYPE_OFFSET UNITYSDK_OFFSET(0x84EABC0)
#define MOLEMOLE_CAMERASHOTDATA_GET_LOOPINITTIME_OFFSET UNITYSDK_OFFSET(0x84EAB40)
#define MOLEMOLE_CAMERASHOTDATA_GET_PARENTTYPE_OFFSET UNITYSDK_OFFSET(0x84EABA0)
#define MOLEMOLE_CAMERASHOTDATA_GET_SKIPBANNERFADEIN_OFFSET UNITYSDK_OFFSET(0x84EAB10)
#define MOLEMOLE_CAMERASHOTDATA_GET_USEBANNER_OFFSET UNITYSDK_OFFSET(0x84EAB00)
#define MOLEMOLE_CAMERASHOTDATA_GET_VIDEOTYPE_OFFSET UNITYSDK_OFFSET(0x84EAB20)
#define MOLEMOLE_CAMERASHOTDATA_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x84EACD0)
#define MOLEMOLE_CAMERASHOTDATA_METHOD_1_BE0C2A5B39FEF128_OFFSET UNITYSDK_OFFSET(0x84EAD70)
#define MOLEMOLE_CAMERASHOTDATA_METHOD_1_CA8D2C39D135A2C2_OFFSET UNITYSDK_OFFSET(0x84EAE00)
#define MOLEMOLE_CAMERASHOTDATA_METHOD_1_DB546B80269157CF_OFFSET UNITYSDK_OFFSET(0x84EAF20)
#define MOLEMOLE_CAMERASHOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x84EABF0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraShotData_TypeDefinitionIndex = 75763;
