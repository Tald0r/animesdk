...
#define MOLEMOLE_COMMANDLINEVOLUMETRICCLOUD_METHOD_2_B3DA9A06401542DD_OFFSET UNITYSDK_OFFSET(0x6FC11B0)
#define MOLEMOLE_COMMANDLINEVOLUMETRICCLOUD_METHOD_2_EE1E6C2EB9760399_OFFSET UNITYSDK_OFFSET(0x6FC1070)
#define MOLEMOLE_COMMANDLINEVOLUMETRICCLOUD__CTOR_OFFSET UNITYSDK_OFFSET(0x6FC1170)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineVolumetricCloud_TypeDefinitionIndex = 42310;
