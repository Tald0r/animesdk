...
#define MOLEMOLE_SIMPLEGAMEPLAYTAGTABLE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB9B8310)
#define MOLEMOLE_SIMPLEGAMEPLAYTAGTABLE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB9B8380)
#define MOLEMOLE_SIMPLEGAMEPLAYTAGTABLE_REGISTERROWTOSPACE_OFFSET UNITYSDK_OFFSET(0xB9B7A70)
#define MOLEMOLE_SIMPLEGAMEPLAYTAGTABLE_SETSPACE_OFFSET UNITYSDK_OFFSET(0xB9B7F90)
#define MOLEMOLE_SIMPLEGAMEPLAYTAGTABLE_UNREGISTERROWFROMSPACE_OFFSET UNITYSDK_OFFSET(0xB9B7D20)
#define MOLEMOLE_SIMPLEGAMEPLAYTAGTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xB9B83F0)
#define MOLEMOLE_SIMPLEGAMEPLAYTAGTABLE___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB9B8420)
#define MOLEMOLE_SIMPLEGAMEPLAYTAGTABLE___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB9B8430)

namespace MoleMole
{
	inline static constexpr unsigned int SimpleGameplayTagTable_TypeDefinitionIndex = 68832;
