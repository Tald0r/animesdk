...
#define MOLEMOLE_QUICKGRAPH_QUICKGRAPHEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B5254B0)
#define MOLEMOLE_QUICKGRAPH_QUICKGRAPHEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B525580)
#define MOLEMOLE_QUICKGRAPH_QUICKGRAPHEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B525640)
#define MOLEMOLE_QUICKGRAPH_QUICKGRAPHEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5253F0)

namespace MoleMole::QuickGraph
{
	inline static constexpr unsigned int QuickGraphException_TypeDefinitionIndex = 25014;
