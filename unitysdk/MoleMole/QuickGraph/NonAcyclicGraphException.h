...
#define MOLEMOLE_QUICKGRAPH_NONACYCLICGRAPHEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B525450)
#define MOLEMOLE_QUICKGRAPH_NONACYCLICGRAPHEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B525510)
#define MOLEMOLE_QUICKGRAPH_NONACYCLICGRAPHEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B5255F0)
#define MOLEMOLE_QUICKGRAPH_NONACYCLICGRAPHEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B525390)

namespace MoleMole::QuickGraph
{
	inline static constexpr unsigned int NonAcyclicGraphException_TypeDefinitionIndex = 25102;
