...
{
	inline static constexpr unsigned int SourceFirstBidirectionalTopologicalSortAlgorithm_2_TypeDefinitionIndex = 24408;

	template <typename TVertex, typename TEdge>
	class SourceFirstBidirectionalTopologicalSortAlgorithm_2 : public ::MoleMole::QuickGraph::Algorithm::AlgorithmBase_1<::Class_0_16E4307DCC41950C_1<TVertex, TEdge>*>
	{
	public:
