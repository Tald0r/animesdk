...
{
	inline static constexpr unsigned int SourceFirstBidirectionalTopologicalSortAlgorithm_2_TypeDefinitionIndex = 25184;

	template <typename TVertex, typename TEdge>
	class SourceFirstBidirectionalTopologicalSortAlgorithm_2 : public ::MoleMole::QuickGraph::Algorithm::AlgorithmBase_1<::Class_0_16E4307DCC41950C_7<TVertex, TEdge>*>
	{
	public:
		...
		::Class_3_B60F6C2F126D2E26_1<TVertex>* AddVertex; // 0x0
	};
}
