...
{
	inline static constexpr unsigned int SourceFirstTopologicalSortAlgorithm_2_TypeDefinitionIndex = 25204;

	template <typename TVertex, typename TEdge>
	class SourceFirstTopologicalSortAlgorithm_2 : public ::MoleMole::QuickGraph::Algorithm::AlgorithmBase_1<::Class_0_16E4307DCC41950C_5<TVertex, TEdge>*>
	{
	public:
