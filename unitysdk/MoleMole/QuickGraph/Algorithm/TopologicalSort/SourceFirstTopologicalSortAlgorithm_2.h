...
{
	inline static constexpr unsigned int SourceFirstTopologicalSortAlgorithm_2_TypeDefinitionIndex = 24187;

	template <typename TVertex, typename TEdge>
	class SourceFirstTopologicalSortAlgorithm_2 : public ::MoleMole::QuickGraph::Algorithm::AlgorithmBase_1<::Class_0_16E4307DCC41950C_2<TVertex, TEdge>*>
	{
	public:
