...
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABMAPCONFIGTEMPLATE_CLEAR_OFFSET UNITYSDK_OFFSET(0x189B3950)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABMAPCONFIGTEMPLATE_GET_BALLPARK_OFFSET UNITYSDK_OFFSET(0x189B3100)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABMAPCONFIGTEMPLATE_GET_ID_OFFSET UNITYSDK_OFFSET(0x189B2FB0)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABMAPCONFIGTEMPLATE_GET_ISLOADALL_OFFSET UNITYSDK_OFFSET(0x189B2F80)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABMAPCONFIGTEMPLATE_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0x189B33D0)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABMAPCONFIGTEMPLATE_GET_VALIDAREA_OFFSET UNITYSDK_OFFSET(0x189B34E0)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABMAPCONFIGTEMPLATE_LOADANDCHECK_OFFSET UNITYSDK_OFFSET(0x189B3860)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABMAPCONFIGTEMPLATE_SET_ISLOADALL_OFFSET UNITYSDK_OFFSET(0x189B2F90)
#define MOLEMOLE_FLATBUFFERS_CONFIG_ABMAPCONFIGTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x189B2FA0)

namespace MoleMole::FlatBuffers::Config
{
	inline static constexpr unsigned int ABMapConfigTemplate_TypeDefinitionIndex = 11919;

	class ABMapConfigTemplate : public ::System::Object
	{
	public:
		// static const ::System::String* Hash; // 0x0
		// static const ::System::Byte VAR_MAX_COUNT = 0x4; // 0x0
		::Struct_2_3E75877A2888D88A_618 m_Data; // 0x10
		::System::String* m_StageName; // 0x20
		::System::Collections::Generic::List_1<::Struct_2_3659D99D9E0DCBB9_14>* m_ValidArea; // 0x28
		...
		{
			return ((::System::Void(*)(::PVOID, ::Struct_2_3E75877A2888D88A_618, ::Class_0_16E4307DCC419505_13*))((::PBYTE)hIl2Cpp + MOLEMOLE_FLATBUFFERS_CONFIG_ABMAPCONFIGTEMPLATE__CTOR_OFFSET))(this, data, notify);
		}
		...
		::System::Collections::Generic::List_1<::Struct_2_3659D99D9E0DCBB9_14>* get_ValidArea()
		{
			return ((::System::Collections::Generic::List_1<::Struct_2_3659D99D9E0DCBB9_14>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_FLATBUFFERS_CONFIG_ABMAPCONFIGTEMPLATE_GET_VALIDAREA_OFFSET))(this);
		}
