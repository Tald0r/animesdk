...
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW_GET_HPIMGMAT_OFFSET UNITYSDK_OFFSET(0xB512890)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW_ONBUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0xB5129D0)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW_ONINIT_OFFSET UNITYSDK_OFFSET(0xB512960)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW_SET_HPIMGMAT_OFFSET UNITYSDK_OFFSET(0xB5128A0)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0xB512B10)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xB5128B0)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_SHIELDHPDATABINDVIEW__ONBUILDDATABINDING_B__6_0_OFFSET UNITYSDK_OFFSET(0xB512B50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyRoleItemWidgetController_ShieldHpDataBindView_TypeDefinitionIndex = 42509;

	class UIMonsterFantasyRoleItemWidgetController_ShieldHpDataBindView : public ::Class_2_3BEB019E352B28D9_Class_2_190E8D2E48A46BE5_2
	{
	public:
		static ::System::Int32* StaticGet_ShieldPercentShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasyRoleItemWidgetController_ShieldHpDataBindView_TypeDefinitionIndex)->GetStaticField(0xFD50);
		}
