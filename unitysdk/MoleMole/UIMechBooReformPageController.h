...
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GETCOMPONENTSBYTABINDEX_OFFSET UNITYSDK_OFFSET(0x8F41BC0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0x8F41EA0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GET_M_ALLCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x8F41D80)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8F403A0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_INITTABS_OFFSET UNITYSDK_OFFSET(0x8F40BE0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ISTABSELECTED_OFFSET UNITYSDK_OFFSET(0x8F42870)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCLICKREFORM_OFFSET UNITYSDK_OFFSET(0x8F419F0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCLICKSETASTARGET_OFFSET UNITYSDK_OFFSET(0x8F41B60)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x8F424D0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8F403B0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONSELECTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x8F41CE0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONSERVERDATAUPDATE_OFFSET UNITYSDK_OFFSET(0x8F41300)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8F428E0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8F40450)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8F404C0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHITEMS_OFFSET UNITYSDK_OFFSET(0x8F41840)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHPERFORMENCE_OFFSET UNITYSDK_OFFSET(0x8F42380)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHPROPERTIES_OFFSET UNITYSDK_OFFSET(0x8F41F60)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHTABSELECTED_OFFSET UNITYSDK_OFFSET(0x8F42690)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x8F41380)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F42970)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER__ONCLICKTAB_B__22_0_OFFSET UNITYSDK_OFFSET(0x8F42B40)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8F42BC0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8F42C30)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8F42C40)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8F42C50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooReformPageController_TypeDefinitionIndex = 80135;

	class UIMechBooReformPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_8600CAA49EEC9D0F* _view; // 0x2F8
		::System::Int32 m_scriptID; // 0x300
		::MoleMole::Project::Config::MechaConfigTemplateExt* m_scriptCfg; // 0x308
		::Class_3_54181161AD221142_1* m_levelInfo; // 0x310
		::Class_2_35EE3F274435ACD1* m_curComponent; // 0x318
		::System::Collections::Generic::List_1<::MoleMole::UIMechBooReformTaskRowWidgetController*>* m_propertyCtrlList; // 0x320
		::System::Collections::Generic::List_1<::Class_2_31D08DC027B35B8F_Enum_3_BCA662D3210575AB>* m_propertyTypeList; // 0x328
		::Class_2_31D08DC027B35B8F_Enum_3_94F3E8DA9C14F011 m_curTabIndex; // 0x330
		::System::Collections::Generic::Dictionary_2<::Class_2_31D08DC027B35B8F_Enum_3_94F3E8DA9C14F011, ::Il2CppArray<::Class_2_35EE3F274435ACD1*>*>* m_allComponentsDict; // 0x338
		::System::Collections::Generic::List_1<::MoleMole::UIMechBooTabWidgetController*>* m_tabs; // 0x340
		::Class_2_31D08DC027B35B8F* _model; // 0x348
