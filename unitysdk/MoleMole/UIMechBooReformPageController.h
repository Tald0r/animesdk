...
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GETCOMPONENTSBYTABINDEX_OFFSET UNITYSDK_OFFSET(0xA82F0D0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0xA82F3B0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GET_M_ALLCOMPONENTS_OFFSET UNITYSDK_OFFSET(0xA82F290)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA82D8A0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_INITTABS_OFFSET UNITYSDK_OFFSET(0xA82E0D0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ISTABSELECTED_OFFSET UNITYSDK_OFFSET(0xA82FD90)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCLICKREFORM_OFFSET UNITYSDK_OFFSET(0xA82EEF0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCLICKSETASTARGET_OFFSET UNITYSDK_OFFSET(0xA82F070)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xA82F9F0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA82D8B0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONSELECTCOMPONENT_OFFSET UNITYSDK_OFFSET(0xA82F1F0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONSERVERDATAUPDATE_OFFSET UNITYSDK_OFFSET(0xA82E800)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA82FE00)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA82D950)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA82D9C0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHITEMS_OFFSET UNITYSDK_OFFSET(0xA82ED40)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHPERFORMENCE_OFFSET UNITYSDK_OFFSET(0xA82F8A0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHPROPERTIES_OFFSET UNITYSDK_OFFSET(0xA82F480)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHTABSELECTED_OFFSET UNITYSDK_OFFSET(0xA82FBB0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0xA82E880)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA82FE90)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER__ONCLICKTAB_B__22_0_OFFSET UNITYSDK_OFFSET(0xA830060)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA8300E0)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA830150)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA830160)
#define MOLEMOLE_UIMECHBOOREFORMPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA830170)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooReformPageController_TypeDefinitionIndex = 55864;
	...
	public:
		...
		::Class_3_21D82EB44ADE164C* m_levelInfo; // 0x310
