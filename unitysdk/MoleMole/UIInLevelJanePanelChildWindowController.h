...
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER_CHANGEMATERIAL_OFFSET UNITYSDK_OFFSET(0x7F853B0)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x7F85280)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x7F83D30)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x7F84070)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x7F841F0)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x7F83EB0)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F83D40)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F83DE0)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F85680)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER__HANDLECUSTOMPROPERTY_B__15_0_OFFSET UNITYSDK_OFFSET(0x7F85690)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER__HANDLECUSTOMPROPERTY_B__15_1_OFFSET UNITYSDK_OFFSET(0x7F85730)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER__HANDLECUSTOMPROPERTY_B__15_2_OFFSET UNITYSDK_OFFSET(0x7F857D0)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x7F85870)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F858D0)
#define MOLEMOLE_UIINLEVELJANEPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F85940)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelJanePanelChildWindowController_TypeDefinitionIndex = 43170;
