...
#define MOLEMOLE_UIGENERALMISSIONCOMPLETEPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA998930)
#define MOLEMOLE_UIGENERALMISSIONCOMPLETEPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_0__INITITEMLIST_B__0_OFFSET UNITYSDK_OFFSET(0xA998940)
#define MOLEMOLE_UIGENERALMISSIONCOMPLETEPOPWINDOWCONTROLLER___C__DISPLAYCLASS19_0__INITITEMLIST_B__1_OFFSET UNITYSDK_OFFSET(0xA998A80)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralMissionCompletePopWindowController___c__DisplayClass19_0_TypeDefinitionIndex = 41558;
