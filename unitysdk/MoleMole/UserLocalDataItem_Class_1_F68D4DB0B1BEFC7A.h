...
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_ADD_1_OFFSET UNITYSDK_OFFSET(0x9A42B70)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_ADD_OFFSET UNITYSDK_OFFSET(0x9A42340)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_CLEAR_OFFSET UNITYSDK_OFFSET(0x9A42490)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x9A42CC0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_CONTAINS_OFFSET UNITYSDK_OFFSET(0x9A425C0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_COPYTO_OFFSET UNITYSDK_OFFSET(0x9A42710)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x9A42120)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x9A429B0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x9A42A90)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x9A43220)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x9A43700)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x9A437E0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x9A42E00)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_REMOVE_OFFSET UNITYSDK_OFFSET(0x9A42860)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x9A435B0)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x9A42240)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x9A42F40)
#define MOLEMOLE_USERLOCALDATAITEM_CLASS_1_F68D4DB0B1BEFC7A__CTOR_OFFSET UNITYSDK_OFFSET(0x9A42110)

namespace MoleMole
{
	inline static constexpr unsigned int UserLocalDataItem_Class_1_F68D4DB0B1BEFC7A_TypeDefinitionIndex = 60253;
