...
#define MOLEMOLE_DITHEROPTBYGPUMODELPOSTPROCESSPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0xC256060)
#define MOLEMOLE_DITHEROPTBYGPUMODELPOSTPROCESSPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2560F0)
#define MOLEMOLE_DITHEROPTBYGPUMODELPOSTPROCESSPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0xC256150)

namespace MoleMole
{
	inline static constexpr unsigned int DitherOptByGPUModelPostProcessProfile_TypeDefinitionIndex = 72911;
