...
#define MOLEMOLE_DITHEROPTBYGPUMODELPOSTPROCESSPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6E06DC0)
#define MOLEMOLE_DITHEROPTBYGPUMODELPOSTPROCESSPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E06E50)
#define MOLEMOLE_DITHEROPTBYGPUMODELPOSTPROCESSPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6E06EB0)

namespace MoleMole
{
	inline static constexpr unsigned int DitherOptByGPUModelPostProcessProfile_TypeDefinitionIndex = 66459;
