...
#define MOLEMOLE_INLEVELQTELEFTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x75A5FA0)
#define MOLEMOLE_INLEVELQTELEFTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x75A5FB0)
#define MOLEMOLE_INLEVELQTELEFTKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x75A5FC0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelQTELeftKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 50077;
