...
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER_CREATEBANGBOOWIDGETROW_OFFSET UNITYSDK_OFFSET(0x989F5A0)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER_CREATECAMPWIDGETROW_OFFSET UNITYSDK_OFFSET(0x989F480)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER_CREATEITEMWIDGETROW_OFFSET UNITYSDK_OFFSET(0x989F6C0)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x989DD90)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER_ONINFOBTNCLICK_OFFSET UNITYSDK_OFFSET(0x989F890)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x989F7E0)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x989DF10)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x989DE30)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x989D840)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x989DCE0)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER_REFRESHAPPLYSTATUS_OFFSET UNITYSDK_OFFSET(0x989F090)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x989E060)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER__CREATEBANGBOOWIDGETROW_B__14_0_OFFSET UNITYSDK_OFFSET(0x989FB80)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER__CREATECAMPWIDGETROW_B__13_0_OFFSET UNITYSDK_OFFSET(0x989FB20)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER__CREATEITEMWIDGETROW_B__15_0_OFFSET UNITYSDK_OFFSET(0x989FBE0)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x989FAA0)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x989FAB0)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x989FC40)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x989FCB0)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x989FD20)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x989FDA0)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x989FE20)
#define MOLEMOLE_UIAUTOBATTLELINEUPROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x989FE80)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattleLineUpRowWidgetController_TypeDefinitionIndex = 66000;
	...
	public:
		...
		::Class_2_208CC9941471731A_664* _config; // 0x2F0
