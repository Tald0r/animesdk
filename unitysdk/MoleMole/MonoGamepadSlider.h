...
#define MOLEMOLE_MONOGAMEPADSLIDER_ISFUNCTIONENABLED_OFFSET UNITYSDK_OFFSET(0x82ED840)
#define MOLEMOLE_MONOGAMEPADSLIDER_ISTEMPWORKABLE_OFFSET UNITYSDK_OFFSET(0x82ED750)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_1EB21A58DE184521_OFFSET UNITYSDK_OFFSET(0x82EF760)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_270FB166A0A47324_OFFSET UNITYSDK_OFFSET(0x82EE4A0)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_2A2B4A2E0BDAAF15_OFFSET UNITYSDK_OFFSET(0x82ED510)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_3306F24AC967FE79_OFFSET UNITYSDK_OFFSET(0x82EDAB0)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_4852C8351A25DF62_OFFSET UNITYSDK_OFFSET(0x82EC9B0)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_5F08B426ADF31FF5_1_OFFSET UNITYSDK_OFFSET(0x82EF880)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_5F08B426ADF31FF5_OFFSET UNITYSDK_OFFSET(0x82EF790)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_64EB95A9F2FF32EC_OFFSET UNITYSDK_OFFSET(0x82EE930)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0x82ECAF0)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_686221D5DF498040_OFFSET UNITYSDK_OFFSET(0x82ED000)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0x82ED5F0)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_8B1D1F4F3D0E01CB_OFFSET UNITYSDK_OFFSET(0x82EED60)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_9B97A7966B23A4A7_OFFSET UNITYSDK_OFFSET(0x82EDB90)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_9CD277022FA67BA6_OFFSET UNITYSDK_OFFSET(0x82EEF10)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_A86A455D6AB5B836_OFFSET UNITYSDK_OFFSET(0x82EF6F0)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_B00A1D822E6F5C31_OFFSET UNITYSDK_OFFSET(0x82ECF40)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_BA7CD4E316D99D30_OFFSET UNITYSDK_OFFSET(0x82EDF00)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x82ECA80)
#define MOLEMOLE_MONOGAMEPADSLIDER_METHOD_6_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x82EE420)
#define MOLEMOLE_MONOGAMEPADSLIDER_SETOVERRIDESLIDESTEP_OFFSET UNITYSDK_OFFSET(0x82EC920)
#define MOLEMOLE_MONOGAMEPADSLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x82EEAB0)
#define MOLEMOLE_MONOGAMEPADSLIDER___BASE_ISFUNCTIONENABLED_OFFSET UNITYSDK_OFFSET(0x82EEAF0)
#define MOLEMOLE_MONOGAMEPADSLIDER___BASE_ISTEMPWORKABLE_OFFSET UNITYSDK_OFFSET(0x82EEB60)
#define MOLEMOLE_MONOGAMEPADSLIDER___BASE_ISWORKABLEINNER_OFFSET UNITYSDK_OFFSET(0x82EEBC0)
#define MOLEMOLE_MONOGAMEPADSLIDER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x82EEC20)
#define MOLEMOLE_MONOGAMEPADSLIDER___BASE_ONMODULEDISABLE_OFFSET UNITYSDK_OFFSET(0x82EECB0)
#define MOLEMOLE_MONOGAMEPADSLIDER___BASE_ONMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x82EECC0)
#define MOLEMOLE_MONOGAMEPADSLIDER___BASE_ONMODULELATEUPDATE_OFFSET UNITYSDK_OFFSET(0x82EECD0)
#define MOLEMOLE_MONOGAMEPADSLIDER___BASE_ONMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x82EED50)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadSlider_TypeDefinitionIndex = 75545;
