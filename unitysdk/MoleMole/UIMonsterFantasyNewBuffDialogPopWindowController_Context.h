...
#define MOLEMOLE_UIMONSTERFANTASYNEWBUFFDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAF511E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyNewBuffDialogPopWindowController_Context_TypeDefinitionIndex = 42138;
