...
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_CLEARRUNTIMEDATA_OFFSET UNITYSDK_OFFSET(0xB37B880)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_GETMODELPREFABASSETPATHBYTEMPLATEID_OFFSET UNITYSDK_OFFSET(0xB37CB40)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_GET_ROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xB37B580)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_ISMODELRECYCLETARGET_OFFSET UNITYSDK_OFFSET(0xB37BFA0)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB37B5A0)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB37B6D0)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_PRELOADMAINCHARACTERMODELPREFAB_OFFSET UNITYSDK_OFFSET(0xB37CE30)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_REGISTERAVATARMODELRECYCLE_OFFSET UNITYSDK_OFFSET(0xB37BCB0)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_SET_ROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xB37B590)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_SWAPBUFFER_OFFSET UNITYSDK_OFFSET(0xB37C430)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_TRYGETCACHEDENTITYMODEL_1_OFFSET UNITYSDK_OFFSET(0xB37CA70)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_TRYGETCACHEDENTITYMODEL_OFFSET UNITYSDK_OFFSET(0xB37C6F0)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_TRYRECYCLEENTITYMODEL_OFFSET UNITYSDK_OFFSET(0xB37C4A0)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_UNLOADMAINCHARACTERMODELPREFAB_OFFSET UNITYSDK_OFFSET(0xB37D420)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM_UNREGISTERAVATARMODELRECYCLE_OFFSET UNITYSDK_OFFSET(0xB37C030)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB37D4D0)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB37D680)
#define MOLEMOLE_AVATARMODELRECYCLESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB37D6E0)

namespace MoleMole
{
	inline static constexpr unsigned int AvatarModelRecycleSubsystem_TypeDefinitionIndex = 48869;

	class AvatarModelRecycleSubsystem : public ::MoleMole::GameSubsystemBaseEx_1<::MoleMole::AvatarModelRecycleSubsystem*>
	{
	public:
		::System::Collections::Generic::Dictionary_2<::Foundation::AssetPath, ::UnityEngine::GameObject*>* _cachedBufferFront; // 0x10
		::Foundation::AssetPath _preloadAssetPath; // 0x18
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _modelRecycleTargetEntity; // 0x28
