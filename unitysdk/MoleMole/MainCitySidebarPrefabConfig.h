...
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG_GET_DEFAULTICONWIDGETPREFAB_OFFSET UNITYSDK_OFFSET(0x8B18D80)
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG_GET_GATHERPREFAB_OFFSET UNITYSDK_OFFSET(0x8B18D70)
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG_GET_PARENTFOLDER_OFFSET UNITYSDK_OFFSET(0x8B18D50)
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG_GET_TITLEPREFAB_OFFSET UNITYSDK_OFFSET(0x8B18D60)
#define MOLEMOLE_MAINCITYSIDEBARPREFABCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8B18D90)

namespace MoleMole
{
	inline static constexpr unsigned int MainCitySidebarPrefabConfig_TypeDefinitionIndex = 70417;
