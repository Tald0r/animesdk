...
#define MOLEMOLE_INLEVELEVADEKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xB8B2B50)
#define MOLEMOLE_INLEVELEVADEKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xB8B2B60)
#define MOLEMOLE_INLEVELEVADEKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xB8B2B70)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelEvadeKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 57681;
