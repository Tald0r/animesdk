...
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB284000)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB284010)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB284080)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB284180)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB284230)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB284310)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB284320)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB284390)
#define MOLEMOLE_UISUIBIANTEMPLEPAWNSHOPPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB2843A0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTemplePawnShopPageController_TypeDefinitionIndex = 66399;
