...
#define MOLEMOLE_UIPHYSICALPOSHANDLER_APPLYLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0x98F8EA0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x98F6850)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x98F6BB0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_GETLAYOUTRESULT_1_OFFSET UNITYSDK_OFFSET(0x98F7290)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_GETLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0x98F9270)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_GETPOSHANDLER_OFFSET UNITYSDK_OFFSET(0x98F6570)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x98F6A90)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_0B08B4F8E959C85E_OFFSET UNITYSDK_OFFSET(0x98F9440)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_15E224C23D482CD3_OFFSET UNITYSDK_OFFSET(0x98F9350)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_1CCA9681CE0AE7A7_OFFSET UNITYSDK_OFFSET(0x98F95D0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x98FA230)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x98FA300)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x98F9900)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_D3CDDBF95A81E584_1_OFFSET UNITYSDK_OFFSET(0x98FA090)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_D3CDDBF95A81E584_OFFSET UNITYSDK_OFFSET(0x98F9EF0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_D64FD9A228A1C4E0_1_OFFSET UNITYSDK_OFFSET(0x98F71C0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x98F70F0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_DFF98536D8B4074F_OFFSET UNITYSDK_OFFSET(0x98F6DA0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_E70BA3D6E1473C4F_OFFSET UNITYSDK_OFFSET(0x98F9990)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x98F98F0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_F4ADC37B63F4E9EF_1_OFFSET UNITYSDK_OFFSET(0x98FA310)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_METHOD_6_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0x98F6EC0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x98F69E0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x98F6920)
#define MOLEMOLE_UIPHYSICALPOSHANDLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x98F96C0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98F96A0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x98F9740)
#define MOLEMOLE_UIPHYSICALPOSHANDLER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x98F97D0)
#define MOLEMOLE_UIPHYSICALPOSHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x98F9860)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhysicalPosHandler_TypeDefinitionIndex = 66220;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MoleMole::UIPhysicalPosHandler*>**)Il2CppClass::FromTypeDefinitionIndex(UIPhysicalPosHandler_TypeDefinitionIndex)->GetStaticField(0x44110);
		}
		static ::System::Single* StaticGet_Field_6_14()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIPhysicalPosHandler_TypeDefinitionIndex)->GetStaticField(0x11410);
		}
		static ::UnityEngine::Vector2* StaticGet_Field_6_13()
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(UIPhysicalPosHandler_TypeDefinitionIndex)->GetStaticField(0x11414);
		}
