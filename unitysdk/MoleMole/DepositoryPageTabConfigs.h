...
#define MOLEMOLE_DEPOSITORYPAGETABCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0xB488830)

namespace MoleMole
{
	inline static constexpr unsigned int DepositoryPageTabConfigs_TypeDefinitionIndex = 48075;
