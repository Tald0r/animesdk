...
#define MOLEMOLE_DEPOSITORYPAGETABCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0xE833E50)

namespace MoleMole
{
	inline static constexpr unsigned int DepositoryPageTabConfigs_TypeDefinitionIndex = 52497;
