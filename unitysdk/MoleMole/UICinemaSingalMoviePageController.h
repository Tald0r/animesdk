...
#define MOLEMOLE_UICINEMASINGALMOVIEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB2876F0)
#define MOLEMOLE_UICINEMASINGALMOVIEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB287700)
#define MOLEMOLE_UICINEMASINGALMOVIEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB287810)
#define MOLEMOLE_UICINEMASINGALMOVIEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB2877A0)
#define MOLEMOLE_UICINEMASINGALMOVIEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB2878A0)
#define MOLEMOLE_UICINEMASINGALMOVIEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB2878B0)
#define MOLEMOLE_UICINEMASINGALMOVIEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB287920)
#define MOLEMOLE_UICINEMASINGALMOVIEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB287930)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSingalMoviePageController_TypeDefinitionIndex = 44472;
