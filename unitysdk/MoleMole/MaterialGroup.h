...
#define MOLEMOLE_MATERIALGROUP_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE117320)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0xE119090)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_1A5AA449A88E439B_OFFSET UNITYSDK_OFFSET(0xE118F20)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_448D681F941AC0C7_OFFSET UNITYSDK_OFFSET(0xE117720)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_51B9C64C69C57DB4_OFFSET UNITYSDK_OFFSET(0xE1190D0)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_53710757CEBC23D3_OFFSET UNITYSDK_OFFSET(0xE117E40)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_68B853BDAE85D2AF_OFFSET UNITYSDK_OFFSET(0xE118520)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_6BA6F9DEB121DE8F_OFFSET UNITYSDK_OFFSET(0xE117B80)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_6EEC9BD778F98414_OFFSET UNITYSDK_OFFSET(0xE118C30)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_73848A1A591EE38C_OFFSET UNITYSDK_OFFSET(0xE117910)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_816ED7FC0A7FCCD1_OFFSET UNITYSDK_OFFSET(0xE117990)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_9B1F2653496E5C47_OFFSET UNITYSDK_OFFSET(0xE1173B0)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_C3F5B006C922A2D1_OFFSET UNITYSDK_OFFSET(0xE117FC0)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE119160)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_DA3A9E7E08E62787_OFFSET UNITYSDK_OFFSET(0xE1186E0)
#define MOLEMOLE_MATERIALGROUP_METHOD_1_E866E78CAA8884E1_OFFSET UNITYSDK_OFFSET(0xE118490)
#define MOLEMOLE_MATERIALGROUP_TOSTRING_OFFSET UNITYSDK_OFFSET(0xE1172A0)
#define MOLEMOLE_MATERIALGROUP__CCTOR_OFFSET UNITYSDK_OFFSET(0xE1176F0)
#define MOLEMOLE_MATERIALGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xE117260)

namespace MoleMole
{
	inline static constexpr unsigned int MaterialGroup_TypeDefinitionIndex = 75238;
	...
	public:
		...
		{
			return (::Il2CppArray<::MoleMole::MaterialGroup_RendererMaterials*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialGroup_TypeDefinitionIndex)->GetStaticField(0x400E0);
		}
