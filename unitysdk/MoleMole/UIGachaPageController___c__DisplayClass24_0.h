...
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA28E4E0)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS24_0__REFRESHGACHATABS_G__CREATETABBTN_0_OFFSET UNITYSDK_OFFSET(0xA28E4F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPageController___c__DisplayClass24_0_TypeDefinitionIndex = 39381;

	class UIGachaPageController___c__DisplayClass24_0 : public ::System::Object
	{
	public:
		::Class_3_4666E61F66433B1E_2* selectedGacha; // 0x10
		::MoleMole::UIGachaPageController* __4__this; // 0x18
		::MoleMole::UIGachaBtnWidgetController* selectedTab; // 0x20
