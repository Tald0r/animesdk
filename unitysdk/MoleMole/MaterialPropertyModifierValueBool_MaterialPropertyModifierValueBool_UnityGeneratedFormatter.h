...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x7F14520)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x7F14530)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x7F147C0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7F149D0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F14970)

namespace MoleMole
{
	inline static constexpr unsigned int MaterialPropertyModifierValueBool_MaterialPropertyModifierValueBool_UnityGeneratedFormatter_TypeDefinitionIndex = 61152;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueBool_MaterialPropertyModifierValueBool_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x415E0);
		}
