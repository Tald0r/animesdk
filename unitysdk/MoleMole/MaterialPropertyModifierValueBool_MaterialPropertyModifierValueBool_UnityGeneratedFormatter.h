...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCD5E7E0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCD5E7F0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCD5EA80)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD5EC90)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERVALUEBOOL_MATERIALPROPERTYMODIFIERVALUEBOOL_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD5EC30)

namespace MoleMole
{
	inline static constexpr unsigned int MaterialPropertyModifierValueBool_MaterialPropertyModifierValueBool_UnityGeneratedFormatter_TypeDefinitionIndex = 64053;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueBool_MaterialPropertyModifierValueBool_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x47940);
		}
