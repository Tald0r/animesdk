...
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_BIND3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0xA922C70)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_BINDBUTTON_OFFSET UNITYSDK_OFFSET(0xA921760)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_BINDGAMEPLAYDATA_OFFSET UNITYSDK_OFFSET(0xA9231F0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_BUILDDATABINDING_NETWORK_OFFSET UNITYSDK_OFFSET(0xA923810)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0xA9226F0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_BUILDVIEWMODELDATABINDING_FLOWERSTATEEXT_OFFSET UNITYSDK_OFFSET(0xA922050)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0xA921B30)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_CALJUDGE_OFFSET UNITYSDK_OFFSET(0xA926320)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_CREATESUBWIDGET_OFFSET UNITYSDK_OFFSET(0xA9219E0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_FINISHFLOWER_OFFSET UNITYSDK_OFFSET(0xA926930)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA9210E0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA927090)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA921190)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0xA924740)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_MUTEROTATEAUDIO_OFFSET UNITYSDK_OFFSET(0xA925600)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_ONCLICKFINISHBUTTON_OFFSET UNITYSDK_OFFSET(0xA9259E0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_ONCLICKTIPSBUTTON_OFFSET UNITYSDK_OFFSET(0xA925830)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA9210F0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA924420)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA924390)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA9214F0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA922450)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_PREBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA921670)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_SHOWSUBWIDGET_OFFSET UNITYSDK_OFFSET(0xA923F00)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA924880)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER__BINDBUTTON_B__18_0_OFFSET UNITYSDK_OFFSET(0xA9298C0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER__BUILDDATABINDING_B__13_0_OFFSET UNITYSDK_OFFSET(0xA927180)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER__BUILDDATABINDING_NETWORK_B__15_0_OFFSET UNITYSDK_OFFSET(0xA9285B0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER__BUILDDATABINDING_NETWORK_B__15_1_OFFSET UNITYSDK_OFFSET(0xA928A70)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER__BUILDDATABINDING_NETWORK_B__15_2_OFFSET UNITYSDK_OFFSET(0xA928D80)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER__BUILDDATABINDING_NETWORK_B__15_3_OFFSET UNITYSDK_OFFSET(0xA929540)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER__BUILDVIEWMODELDATABINDING_B__14_0_OFFSET UNITYSDK_OFFSET(0xA927360)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER__BUILDVIEWMODELDATABINDING_B__14_1_OFFSET UNITYSDK_OFFSET(0xA927890)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER__BUILDVIEWMODELDATABINDING_B__14_2_OFFSET UNITYSDK_OFFSET(0xA927C40)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER__BUILDVIEWMODELDATABINDING_B__14_3_OFFSET UNITYSDK_OFFSET(0xA9285A0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9270A0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA929930)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___BASE_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0xA929990)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA929A00)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA929A70)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA929A80)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA929A90)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA929AA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMainPageController_TypeDefinitionIndex = 69434;
	...
	public:
		...
		::Class_2_F40975C062E8BF5C* __viewModel; // 0x308
		...
		::Class_0_16E4307DCC419505_485* get__viewModel()
		{
			return ((::Class_0_16E4307DCC419505_485*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFLOWERMAINPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
