...
#define MOLEMOLE_UIVHSSTORETYPEV2WIDGETCONTROLLER_GET_TAGID_OFFSET UNITYSDK_OFFSET(0x95A9DA0)
#define MOLEMOLE_UIVHSSTORETYPEV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95A9950)
#define MOLEMOLE_UIVHSSTORETYPEV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95A99F0)
#define MOLEMOLE_UIVHSSTORETYPEV2WIDGETCONTROLLER_REFRESHLAYER_OFFSET UNITYSDK_OFFSET(0x95A9CA0)
#define MOLEMOLE_UIVHSSTORETYPEV2WIDGETCONTROLLER_SETTAGID_OFFSET UNITYSDK_OFFSET(0x95A9AD0)
#define MOLEMOLE_UIVHSSTORETYPEV2WIDGETCONTROLLER_SET_TAGID_OFFSET UNITYSDK_OFFSET(0x95A9DB0)
#define MOLEMOLE_UIVHSSTORETYPEV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x95A9DC0)
#define MOLEMOLE_UIVHSSTORETYPEV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95A9DF0)
#define MOLEMOLE_UIVHSSTORETYPEV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95A9E60)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreTypeV2WidgetController_TypeDefinitionIndex = 65747;
