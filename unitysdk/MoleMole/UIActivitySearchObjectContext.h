...
#define MOLEMOLE_UIACTIVITYSEARCHOBJECTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD3C5850)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySearchObjectContext_TypeDefinitionIndex = 51806;
