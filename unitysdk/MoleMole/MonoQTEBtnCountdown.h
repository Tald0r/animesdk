...
#define MOLEMOLE_MONOQTEBTNCOUNTDOWN_PLAYQTEFADEINOVERANIMEVENT_OFFSET UNITYSDK_OFFSET(0xB9A5730)
#define MOLEMOLE_MONOQTEBTNCOUNTDOWN_PLAYQTEFADEOUTOVERANIMEVENT_OFFSET UNITYSDK_OFFSET(0xB9A5880)
#define MOLEMOLE_MONOQTEBTNCOUNTDOWN_PLAYQTETWEENBARANIMEVENT_OFFSET UNITYSDK_OFFSET(0xB9A55F0)
#define MOLEMOLE_MONOQTEBTNCOUNTDOWN_SETMONOQTESWITCHAVATARPANEL_OFFSET UNITYSDK_OFFSET(0xB9A5580)
#define MOLEMOLE_MONOQTEBTNCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A59C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoQTEBtnCountdown_TypeDefinitionIndex = 75333;
