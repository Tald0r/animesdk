...
#define MOLEMOLE_MONOZHENZHENWEAPONVIDEOSCREENPLAYER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC3254F0)
#define MOLEMOLE_MONOZHENZHENWEAPONVIDEOSCREENPLAYER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC325B90)
#define MOLEMOLE_MONOZHENZHENWEAPONVIDEOSCREENPLAYER_METHOD_5_C8EED11299FD17DB_OFFSET UNITYSDK_OFFSET(0xC324BF0)
#define MOLEMOLE_MONOZHENZHENWEAPONVIDEOSCREENPLAYER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC325560)
#define MOLEMOLE_MONOZHENZHENWEAPONVIDEOSCREENPLAYER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC3259E0)
#define MOLEMOLE_MONOZHENZHENWEAPONVIDEOSCREENPLAYER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC325830)
#define MOLEMOLE_MONOZHENZHENWEAPONVIDEOSCREENPLAYER_SETACTIVESCENETAG_OFFSET UNITYSDK_OFFSET(0xC325030)
#define MOLEMOLE_MONOZHENZHENWEAPONVIDEOSCREENPLAYER_SETLOOKATCAMERATRANSFORM_OFFSET UNITYSDK_OFFSET(0xC324B70)
#define MOLEMOLE_MONOZHENZHENWEAPONVIDEOSCREENPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xC325C00)

namespace MoleMole
{
	inline static constexpr unsigned int MonoZhenzhenWeaponVideoScreenPlayer_TypeDefinitionIndex = 56621;
