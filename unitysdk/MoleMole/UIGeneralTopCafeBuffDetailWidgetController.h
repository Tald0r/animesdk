...
#define MOLEMOLE_UIGENERALTOPCAFEBUFFDETAILWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x891CD40)
#define MOLEMOLE_UIGENERALTOPCAFEBUFFDETAILWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x891CDE0)
#define MOLEMOLE_UIGENERALTOPCAFEBUFFDETAILWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x891CAB0)
#define MOLEMOLE_UIGENERALTOPCAFEBUFFDETAILWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x891CC90)
#define MOLEMOLE_UIGENERALTOPCAFEBUFFDETAILWIDGETCONTROLLER_OPENBUFFDETAILS_OFFSET UNITYSDK_OFFSET(0x891DD30)
#define MOLEMOLE_UIGENERALTOPCAFEBUFFDETAILWIDGETCONTROLLER_REFRESHBUFFEXTRADESC_OFFSET UNITYSDK_OFFSET(0x891DB60)
#define MOLEMOLE_UIGENERALTOPCAFEBUFFDETAILWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x891CEC0)
#define MOLEMOLE_UIGENERALTOPCAFEBUFFDETAILWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x891DED0)
#define MOLEMOLE_UIGENERALTOPCAFEBUFFDETAILWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x891DF00)
#define MOLEMOLE_UIGENERALTOPCAFEBUFFDETAILWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x891DF70)
#define MOLEMOLE_UIGENERALTOPCAFEBUFFDETAILWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x891DFF0)
#define MOLEMOLE_UIGENERALTOPCAFEBUFFDETAILWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x891E050)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTopCafeBuffDetailWidgetController_TypeDefinitionIndex = 62849;
