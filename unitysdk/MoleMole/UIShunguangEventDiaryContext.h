...
#define MOLEMOLE_UISHUNGUANGEVENTDIARYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC3C59E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIShunguangEventDiaryContext_TypeDefinitionIndex = 49085;
