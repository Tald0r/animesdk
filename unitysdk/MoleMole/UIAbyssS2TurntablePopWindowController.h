...
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xD228480)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD228490)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER_ONCLICKCLOSEBTN_OFFSET UNITYSDK_OFFSET(0xD229D50)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER_ONCLICKPAYBTN_OFFSET UNITYSDK_OFFSET(0xD22AAD0)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER_ONCLICKPREVIEWBTN_OFFSET UNITYSDK_OFFSET(0xD22A020)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD229870)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD229A90)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD229CC0)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD229910)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD2284A0)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD228D30)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER_TESTRESULT_OFFSET UNITYSDK_OFFSET(0xD22A1B0)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER_WAITFORROLL_OFFSET UNITYSDK_OFFSET(0xD229440)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD22AE00)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD22AE80)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD22AEF0)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD22AF20)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD22AF30)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD22AF40)
#define MOLEMOLE_UIABYSSS2TURNTABLEPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD22AF50)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2TurntablePopWindowController_TypeDefinitionIndex = 48123;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_3_6EF456A21AE85EEC_84*>* _rollList; // 0x340
