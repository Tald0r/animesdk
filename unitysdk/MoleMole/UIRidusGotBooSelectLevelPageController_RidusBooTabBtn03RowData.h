...
#define MOLEMOLE_UIRIDUSGOTBOOSELECTLEVELPAGECONTROLLER_RIDUSBOOTABBTN03ROWDATA_CREATETABDATA_OFFSET UNITYSDK_OFFSET(0x96EB910)
#define MOLEMOLE_UIRIDUSGOTBOOSELECTLEVELPAGECONTROLLER_RIDUSBOOTABBTN03ROWDATA_GETRARITYICONPATH_OFFSET UNITYSDK_OFFSET(0x96EBD30)
#define MOLEMOLE_UIRIDUSGOTBOOSELECTLEVELPAGECONTROLLER_RIDUSBOOTABBTN03ROWDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x96EBEF0)
#define MOLEMOLE_UIRIDUSGOTBOOSELECTLEVELPAGECONTROLLER_RIDUSBOOTABBTN03ROWDATA_GET_ICONTYPE_OFFSET UNITYSDK_OFFSET(0x96EBF00)
#define MOLEMOLE_UIRIDUSGOTBOOSELECTLEVELPAGECONTROLLER_RIDUSBOOTABBTN03ROWDATA_GET_REDDOTINFO_OFFSET UNITYSDK_OFFSET(0x96EBF10)
#define MOLEMOLE_UIRIDUSGOTBOOSELECTLEVELPAGECONTROLLER_RIDUSBOOTABBTN03ROWDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x96EBEE0)
#define MOLEMOLE_UIRIDUSGOTBOOSELECTLEVELPAGECONTROLLER_RIDUSBOOTABBTN03ROWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x96EBF20)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooSelectLevelPageController_RidusBooTabBtn03RowData_TypeDefinitionIndex = 62724;
	...
	public:
		...
		::System::Void CreateTabData(::Class_2_208CC9941471731A_442* cfg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_442*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIRIDUSGOTBOOSELECTLEVELPAGECONTROLLER_RIDUSBOOTABBTN03ROWDATA_CREATETABDATA_OFFSET))(this, cfg);
		}
