...
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_CLEARSELECT_OFFSET UNITYSDK_OFFSET(0x8823040)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x88225A0)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0x8822720)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8822640)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8822280)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x88224F0)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x88227C0)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_SETITEMCLICKEDACT_OFFSET UNITYSDK_OFFSET(0x8823160)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0x88230D0)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x88231D0)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8823200)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8823270)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x88232F0)
#define MOLEMOLE_UIWISHLISTSUITPLANWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8823350)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistSuitPlanWidgetController_TypeDefinitionIndex = 75778;

	class UIWishlistSuitPlanWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_4F0F14F359F48E68* _view; // 0x2A0
