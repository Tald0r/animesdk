...
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER___C__DISPLAYCLASS15_0__CLICKSCRIPTACTION_B__3_OFFSET UNITYSDK_OFFSET(0x8979860)
#define MOLEMOLE_UIMECHBOOPREPPAGECONTROLLER___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8979850)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooPrepPageController___c__DisplayClass15_0_TypeDefinitionIndex = 50534;
	...
	public:
		...
		::MoleMole::UIMechBooPrepPageController* __4__this; // 0x18
		::Class_0_16E4307DCC419505_158* levelInfo; // 0x20
