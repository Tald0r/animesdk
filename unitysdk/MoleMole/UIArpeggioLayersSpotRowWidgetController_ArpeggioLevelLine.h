...
#define MOLEMOLE_UIARPEGGIOLAYERSSPOTROWWIDGETCONTROLLER_ARPEGGIOLEVELLINE_SETACTIVE_OFFSET UNITYSDK_OFFSET(0xDEF5D90)
#define MOLEMOLE_UIARPEGGIOLAYERSSPOTROWWIDGETCONTROLLER_ARPEGGIOLEVELLINE_SETL1STATE_OFFSET UNITYSDK_OFFSET(0xDEF5E10)
#define MOLEMOLE_UIARPEGGIOLAYERSSPOTROWWIDGETCONTROLLER_ARPEGGIOLEVELLINE_SETL2STATE_OFFSET UNITYSDK_OFFSET(0xDEF5ED0)
#define MOLEMOLE_UIARPEGGIOLAYERSSPOTROWWIDGETCONTROLLER_ARPEGGIOLEVELLINE_SETSKIN_OFFSET UNITYSDK_OFFSET(0xDEF58A0)
#define MOLEMOLE_UIARPEGGIOLAYERSSPOTROWWIDGETCONTROLLER_ARPEGGIOLEVELLINE__CTOR_OFFSET UNITYSDK_OFFSET(0xDEF5F90)

namespace MoleMole
{
	inline static constexpr unsigned int UIArpeggioLayersSpotRowWidgetController_ArpeggioLevelLine_TypeDefinitionIndex = 67285;

	class UIArpeggioLayersSpotRowWidgetController_ArpeggioLevelLine : public ::System::Object
	{
	public:
		::UnityEngine::GameObject* Skin; // 0x10
		::UnityEngine::GameObject* L2_Lock; // 0x18
		::UnityEngine::GameObject* L1_Unlock; // 0x20
		::UnityEngine::GameObject* L1; // 0x28
		::UnityEngine::GameObject* L2_Unlock; // 0x30
		::UnityEngine::GameObject* L1_Lock; // 0x38
		::UnityEngine::GameObject* L2; // 0x40
