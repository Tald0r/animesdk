...
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0xBB17940)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_INITOPTIONGIFT_OFFSET UNITYSDK_OFFSET(0xBB18740)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_INITPERMANENTREWARDS_OFFSET UNITYSDK_OFFSET(0xBB18920)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ISITEMOWNED_OFFSET UNITYSDK_OFFSET(0xBB19460)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONCLICKGETREWARD_ASYNC_OFFSET UNITYSDK_OFFSET(0xBB193A0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONCLICKGETREWARD_OFFSET UNITYSDK_OFFSET(0xBB18E40)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB195A0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBB17D20)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB19640)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB17A10)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBB17F70)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_REFRESHBYCACHE_OFFSET UNITYSDK_OFFSET(0xBB18020)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0xBB17EF0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB19720)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0xBB19730)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__ONUIINIT_B__4_1_OFFSET UNITYSDK_OFFSET(0xBB19740)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__REFRESHBYCACHE_B__9_0_OFFSET UNITYSDK_OFFSET(0xBB19750)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB19760)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBB197D0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB19850)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB198D0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBB19930)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelRewardRowWidgetController_TypeDefinitionIndex = 59532;
	...
	public:
		...
		::Class_2_208CC9941471731A_78* _cachedCfg; // 0x2D8
