...
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0xBFE48C0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_INITOPTIONGIFT_OFFSET UNITYSDK_OFFSET(0xBFE56C0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_INITPERMANENTREWARDS_OFFSET UNITYSDK_OFFSET(0xBFE58A0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ISITEMOWNED_OFFSET UNITYSDK_OFFSET(0xBFE63C0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONCLICKGETREWARD_ASYNC_OFFSET UNITYSDK_OFFSET(0xBFE6300)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONCLICKGETREWARD_OFFSET UNITYSDK_OFFSET(0xBFE5DB0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFE6500)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFE4CA0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFE65A0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFE4980)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFE4EF0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_REFRESHBYCACHE_OFFSET UNITYSDK_OFFSET(0xBFE4FA0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0xBFE4E70)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFE6680)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0xBFE6690)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__ONUIINIT_B__4_1_OFFSET UNITYSDK_OFFSET(0xBFE66A0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__REFRESHBYCACHE_B__9_0_OFFSET UNITYSDK_OFFSET(0xBFE66B0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFE66C0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFE6730)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFE67B0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFE6830)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFE6890)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelRewardRowWidgetController_TypeDefinitionIndex = 80163;

	class UICoopLevelRewardRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_AFA01A100E02E0CD* _view; // 0x2D0
		::Class_2_208CC9941471731A_622* _cachedCfg; // 0x2D8
		::MoleMole::UIItemIconBtnWidgetController* m_rewardItem; // 0x2E0
