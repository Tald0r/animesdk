...
#define MOLEMOLE_UIQUESTIONSANSWERCONFIGMONO_GET_SPECIALNPCCAMERAOFFSETDIC_OFFSET UNITYSDK_OFFSET(0xA3E4850)
#define MOLEMOLE_UIQUESTIONSANSWERCONFIGMONO_GET_SPECIALNPCEMOJIPOSDIC_OFFSET UNITYSDK_OFFSET(0xA3E4A60)
#define MOLEMOLE_UIQUESTIONSANSWERCONFIGMONO_SET_SPECIALNPCCAMERAOFFSETDIC_OFFSET UNITYSDK_OFFSET(0xA3E4A50)
#define MOLEMOLE_UIQUESTIONSANSWERCONFIGMONO__CTOR_OFFSET UNITYSDK_OFFSET(0xA3E4C80)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerConfigMono_TypeDefinitionIndex = 55134;
