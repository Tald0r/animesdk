...
#define MOLEMOLE_UIQUESTIONSANSWERCONFIGMONO_GET_SPECIALNPCCAMERAOFFSETDIC_OFFSET UNITYSDK_OFFSET(0x8EF7E60)
#define MOLEMOLE_UIQUESTIONSANSWERCONFIGMONO_GET_SPECIALNPCEMOJIPOSDIC_OFFSET UNITYSDK_OFFSET(0x96E1670)
#define MOLEMOLE_UIQUESTIONSANSWERCONFIGMONO_SET_SPECIALNPCCAMERAOFFSETDIC_OFFSET UNITYSDK_OFFSET(0x96E1660)
#define MOLEMOLE_UIQUESTIONSANSWERCONFIGMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x96E1890)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerConfigMono_TypeDefinitionIndex = 66652;
