...
#define MOLEMOLE_UIGACHAPANELWIDGET_GET_IGNOREFADING_OFFSET UNITYSDK_OFFSET(0xBF12CB0)
#define MOLEMOLE_UIGACHAPANELWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0xBF12CC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPanelWidget_TypeDefinitionIndex = 50357;
