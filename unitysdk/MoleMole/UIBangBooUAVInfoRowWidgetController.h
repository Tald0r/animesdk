...
#define MOLEMOLE_UIBANGBOOUAVINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB74A8B0)
#define MOLEMOLE_UIBANGBOOUAVINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB74A950)
#define MOLEMOLE_UIBANGBOOUAVINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB74A760)
#define MOLEMOLE_UIBANGBOOUAVINFOROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB74A800)
#define MOLEMOLE_UIBANGBOOUAVINFOROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB74AA30)
#define MOLEMOLE_UIBANGBOOUAVINFOROWWIDGETCONTROLLER_UPDATEICON_OFFSET UNITYSDK_OFFSET(0xB74AC80)
#define MOLEMOLE_UIBANGBOOUAVINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB74AD30)
#define MOLEMOLE_UIBANGBOOUAVINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB74AD60)
#define MOLEMOLE_UIBANGBOOUAVINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB74ADD0)
#define MOLEMOLE_UIBANGBOOUAVINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB74AE50)
#define MOLEMOLE_UIBANGBOOUAVINFOROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB74AEB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVInfoRowWidgetController_TypeDefinitionIndex = 51955;
