...
#define MOLEMOLE_UIRESOURCELOADWIDGETCONTROLLER___C__DISPLAYCLASS39_1__CTOR_OFFSET UNITYSDK_OFFSET(0xD293CF0)
#define MOLEMOLE_UIRESOURCELOADWIDGETCONTROLLER___C__DISPLAYCLASS39_1__STARTLOADGAMECONFIGASSETSBYLOADER_B__1_OFFSET UNITYSDK_OFFSET(0xD293D00)

namespace MoleMole
{
	inline static constexpr unsigned int UIResourceLoadWidgetController___c__DisplayClass39_1_TypeDefinitionIndex = 66022;
