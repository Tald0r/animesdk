...
#define MOLEMOLE_MONOVIEWPOINTTOUCH_CLEARTOUCH_OFFSET UNITYSDK_OFFSET(0x7A96590)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_METHOD_5_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0x7A96720)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_METHOD_5_54D0944981A1E075_OFFSET UNITYSDK_OFFSET(0x7A97890)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_METHOD_5_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0x7A96EE0)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x7A97A50)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x7A96C20)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x7A96510)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_ONVIEWPOINTPANELDRAG_OFFSET UNITYSDK_OFFSET(0x7A97020)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_ONVIEWPOINTPANELINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0x7A97B80)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_ONVIEWPOINTPANELPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x7A96950)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_ONVIEWPOINTPANELPOINTERUP_OFFSET UNITYSDK_OFFSET(0x7A96C90)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_START_OFFSET UNITYSDK_OFFSET(0x7A96390)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_UPDATE_OFFSET UNITYSDK_OFFSET(0x7A96680)
#define MOLEMOLE_MONOVIEWPOINTTOUCH__CTOR_OFFSET UNITYSDK_OFFSET(0x7A97C30)

namespace MoleMole
{
	inline static constexpr unsigned int MonoViewPointTouch_TypeDefinitionIndex = 37866;
