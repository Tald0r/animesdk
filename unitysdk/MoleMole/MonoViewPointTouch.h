...
#define MOLEMOLE_MONOVIEWPOINTTOUCH_CLEARTOUCH_OFFSET UNITYSDK_OFFSET(0xA492F30)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_METHOD_5_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0xA4930C0)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_METHOD_5_54D0944981A1E075_OFFSET UNITYSDK_OFFSET(0xA494230)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_METHOD_5_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0xA493880)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xA4943F0)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA4935C0)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0xA492EB0)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_ONVIEWPOINTPANELDRAG_OFFSET UNITYSDK_OFFSET(0xA4939C0)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_ONVIEWPOINTPANELINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0xA494520)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_ONVIEWPOINTPANELPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xA4932F0)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_ONVIEWPOINTPANELPOINTERUP_OFFSET UNITYSDK_OFFSET(0xA493630)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_START_OFFSET UNITYSDK_OFFSET(0xA492D30)
#define MOLEMOLE_MONOVIEWPOINTTOUCH_UPDATE_OFFSET UNITYSDK_OFFSET(0xA493020)
#define MOLEMOLE_MONOVIEWPOINTTOUCH__CTOR_OFFSET UNITYSDK_OFFSET(0xA4945D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoViewPointTouch_TypeDefinitionIndex = 72032;
