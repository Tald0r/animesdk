...
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_EXITPREPPAGE_OFFSET UNITYSDK_OFFSET(0xB2897E0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB288460)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_INITFIRSTSELECTLEVEL_OFFSET UNITYSDK_OFFSET(0xB288EE0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xB288880)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONCLICKSINGLELEVELMOVIE_OFFSET UNITYSDK_OFFSET(0xB2894B0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONCLICKSTARTSINGLELEVEL_OFFSET UNITYSDK_OFFSET(0xB289520)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB288470)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xB288DD0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB288C90)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB288D40)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB288510)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_REFRESHDIFFICULT_OFFSET UNITYSDK_OFFSET(0xB287D90)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_REFRESHMOVIEINFO_OFFSET UNITYSDK_OFFSET(0xB287C80)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_REFRESHRANKINFO_OFFSET UNITYSDK_OFFSET(0xB287EA0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_REFRESHRIGHTINFO_OFFSET UNITYSDK_OFFSET(0xB287940)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_RESETCLICKMASK_OFFSET UNITYSDK_OFFSET(0xB2899B0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER_SETNOWINDEX_OFFSET UNITYSDK_OFFSET(0xB2891D0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB289A20)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB289AB0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xB289B20)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB289BE0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB289BF0)
#define MOLEMOLE_UICINEMASINGLEMOVIEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB289C00)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSingleMoviePageController_TypeDefinitionIndex = 52091;

	class UICinemaSingleMoviePageController : public ::MoleMole::UIWindowController
	{
	public:
		::Il2CppArray<::Enum_3_E2714210413A69CA>* pointLevels; // 0x2F8
		::Class_2_26F71DED66AFE0B6* _view; // 0x300
		::System::Collections::Generic::List_1<::Class_2_4B74629A4EA5100A*>* movieLevelList; // 0x308
		::Class_2_4B74629A4EA5100A* nowSelectLevelData; // 0x310
		::System::Collections::Generic::List_1<::MoleMole::UICinemaRewardLevelRowWidgetController*>* rewardLevelRowList; // 0x318
		::System::Boolean _isClickedEnterGame; // 0x320
		::System::Int32 nowIndex; // 0x324
