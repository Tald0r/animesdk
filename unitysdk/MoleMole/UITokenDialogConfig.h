...
#define MOLEMOLE_UITOKENDIALOGCONFIG_GET_UITYPE_OFFSET UNITYSDK_OFFSET(0x9EE77F0)
#define MOLEMOLE_UITOKENDIALOGCONFIG_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9EE7990)
#define MOLEMOLE_UITOKENDIALOGCONFIG_METHOD_1_AC258D21B34819E7_OFFSET UNITYSDK_OFFSET(0x9EE7A20)
#define MOLEMOLE_UITOKENDIALOGCONFIG_SET_UITYPE_OFFSET UNITYSDK_OFFSET(0x9EE78F0)
#define MOLEMOLE_UITOKENDIALOGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9EE7980)

namespace MoleMole
{
	inline static constexpr unsigned int UITokenDialogConfig_TypeDefinitionIndex = 80627;
