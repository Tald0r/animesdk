...
#define MOLEMOLE_UITOKENDIALOGCONFIG_GET_UITYPE_OFFSET UNITYSDK_OFFSET(0xAE964E0)
#define MOLEMOLE_UITOKENDIALOGCONFIG_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xAE96680)
#define MOLEMOLE_UITOKENDIALOGCONFIG_METHOD_1_AC258D21B34819E7_OFFSET UNITYSDK_OFFSET(0xAE96710)
#define MOLEMOLE_UITOKENDIALOGCONFIG_SET_UITYPE_OFFSET UNITYSDK_OFFSET(0xAE965E0)
#define MOLEMOLE_UITOKENDIALOGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xAE96670)

namespace MoleMole
{
	inline static constexpr unsigned int UITokenDialogConfig_TypeDefinitionIndex = 70311;
