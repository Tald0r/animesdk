...
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER_CLEARREWARDS_OFFSET UNITYSDK_OFFSET(0xDF08170)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER_GERREWARDREQ_OFFSET UNITYSDK_OFFSET(0xDF07150)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF07030)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xDF07C10)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDF07DF0)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER_ONTAKEREWARDHANDLE_OFFSET UNITYSDK_OFFSET(0xDF07300)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF07D10)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF06E80)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER_REFRESHREWARDBTNREDPOINT_OFFSET UNITYSDK_OFFSET(0xDF07FD0)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER_REFRESHREWARDS_OFFSET UNITYSDK_OFFSET(0xDF07440)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xDF07930)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF08310)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF083A0)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xDF08410)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDF08480)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF08500)
#define MOLEMOLE_UIBABELTOWERREWARDLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF08580)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabelTowerRewardListRowWidgetController_TypeDefinitionIndex = 61360;
