...
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETAVATARSHOWSETTINGCOMMON_OFFSET UNITYSDK_OFFSET(0xE8304A0)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETCOMMONLIGHTSETTINGBYTYPE_OFFSET UNITYSDK_OFFSET(0xE82FB80)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETDEFAULTUIAVATARSHOWSETTING_OFFSET UNITYSDK_OFFSET(0xE82FA00)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETHOLLOWCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0xE82EB20)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETPAGESWITCHINTERVAL_OFFSET UNITYSDK_OFFSET(0xE82F930)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETRENDERLAYERBYUIRTSHOWLAYER_OFFSET UNITYSDK_OFFSET(0xE82F210)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETUI3DMODELSHOWSETTING_OFFSET UNITYSDK_OFFSET(0xE8320C0)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETUIAVATARMAINPAGEPREFABPATH_OFFSET UNITYSDK_OFFSET(0xE831040)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETUIAVATARSHOWSETTING_OFFSET UNITYSDK_OFFSET(0xE830190)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETUIBUDDYMAINPAGEPREFABPATH_OFFSET UNITYSDK_OFFSET(0xE831940)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETUIBUDDYSHOWSETTING_OFFSET UNITYSDK_OFFSET(0xE831260)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETUIEQUIPSHOWSETTING_OFFSET UNITYSDK_OFFSET(0xE831E60)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETUIVOLUMEASSETPATH_OFFSET UNITYSDK_OFFSET(0xE82FEA0)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_GETUIWEAPONSHOWSETTING_OFFSET UNITYSDK_OFFSET(0xE831C00)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_REBUILDUIAVATARSHOWSETTINGDATA_OFFSET UNITYSDK_OFFSET(0xE82F2E0)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_REBUILDUIBUDDYSHOWSETTINGDATA_OFFSET UNITYSDK_OFFSET(0xE82EBC0)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_RELOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0xE82E680)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_RELOADFROMFILE_OFFSET UNITYSDK_OFFSET(0xE82E7C0)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_RELOADUIAVATARDATAFROMFILE_OFFSET UNITYSDK_OFFSET(0xE82E8C0)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_TRYGETAVATARUIMAINPAGERUNTIMEINFO_OFFSET UNITYSDK_OFFSET(0xE830DE0)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA_TRYGETBUDDYUIMAINPAGERUNTIMEINFO_OFFSET UNITYSDK_OFFSET(0xE831630)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xE832320)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAvatarShowData_TypeDefinitionIndex = 44825;
	...
	public:
		...
		{
			return (::MoleMole::ConfigUIAvatarShow**)Il2CppClass::FromTypeDefinitionIndex(ConfigUIAvatarShowData_TypeDefinitionIndex)->GetStaticField(0x2C5D0);
		}
		static ::System::Collections::Generic::List_1<::MoleMole::UIAvatarShowSetting*>** StaticGet_templist()
		{
			return (::System::Collections::Generic::List_1<::MoleMole::UIAvatarShowSetting*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigUIAvatarShowData_TypeDefinitionIndex)->GetStaticField(0x2C5D8);
		}
