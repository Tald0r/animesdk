...
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_ACQUIRETITLETEXT_OFFSET UNITYSDK_OFFSET(0xB22B280)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_GETBUTTONCOMBINESTATE_OFFSET UNITYSDK_OFFSET(0xB22B380)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_GETPANELSTATE_OFFSET UNITYSDK_OFFSET(0xB22B3E0)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_ONPOPSHOWED_OFFSET UNITYSDK_OFFSET(0xB22B440)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB22B1B0)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB22B560)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER__ONPOPSHOWED_B__7_0_OFFSET UNITYSDK_OFFSET(0xB22B590)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER__ONPOPSHOWED_B__7_1_OFFSET UNITYSDK_OFFSET(0xB22B5B0)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER__ONUIOPEN_B__3_0_OFFSET UNITYSDK_OFFSET(0xB22B570)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB22B5D0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevel_MpResult_PopWindowController_TypeDefinitionIndex = 55032;
	...
	public:
		...
		::MoleMole::UILevel_MpResult_PopWindowController_ExitMpGameProgress* _exitProgress; // 0x358
		...
		{
			return ((::Class_1_87D98DA5C1AD6384_Enum_3_3DCE6AAF7E47B319(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_GETBUTTONCOMBINESTATE_OFFSET))(this);
		}

		::Class_1_87D98DA5C1AD6384_Enum_3_A188519F532ACB95 GetPanelState()
		{
			return ((::Class_1_87D98DA5C1AD6384_Enum_3_A188519F532ACB95(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_GETPANELSTATE_OFFSET))(this);
		}
