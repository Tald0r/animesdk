...
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_ACQUIRETITLETEXT_OFFSET UNITYSDK_OFFSET(0x7460180)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_GETBUTTONCOMBINESTATE_OFFSET UNITYSDK_OFFSET(0x7460280)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_GETPANELSTATE_OFFSET UNITYSDK_OFFSET(0x74602E0)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_ONPOPSHOWED_OFFSET UNITYSDK_OFFSET(0x7460340)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x74600B0)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7460460)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER__ONPOPSHOWED_B__7_0_OFFSET UNITYSDK_OFFSET(0x7460490)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER__ONPOPSHOWED_B__7_1_OFFSET UNITYSDK_OFFSET(0x74604B0)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER__ONUIOPEN_B__3_0_OFFSET UNITYSDK_OFFSET(0x7460470)
#define MOLEMOLE_UILEVEL_MPRESULT_POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x74604D0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevel_MpResult_PopWindowController_TypeDefinitionIndex = 64285;
