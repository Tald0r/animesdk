...
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x6EBD390)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x6EBDAC0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x6EBDB20)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x6EBDAD0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6EBD380)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_CLASS_1_117D5B6A04BC9CED__CTOR_OFFSET UNITYSDK_OFFSET(0x6EBD370)

namespace MoleMole
{
	inline static constexpr unsigned int MonoScrollerFadeManager_Class_1_117D5B6A04BC9CED_TypeDefinitionIndex = 69792;

	class MonoScrollerFadeManager_Class_1_117D5B6A04BC9CED : public ::System::Object
	{
	public:
		::MoleMole::MonoScrollerFadeManager* Field_1_3; // 0x10
