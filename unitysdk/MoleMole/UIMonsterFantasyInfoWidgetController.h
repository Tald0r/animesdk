...
#define MOLEMOLE_UIMONSTERFANTASYINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC0BF50)
#define MOLEMOLE_UIMONSTERFANTASYINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC0BFF0)
#define MOLEMOLE_UIMONSTERFANTASYINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC0B8B0)
#define MOLEMOLE_UIMONSTERFANTASYINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC0B950)
#define MOLEMOLE_UIMONSTERFANTASYINFOWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0xAC0BA70)
#define MOLEMOLE_UIMONSTERFANTASYINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC0C0D0)
#define MOLEMOLE_UIMONSTERFANTASYINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC0C100)
#define MOLEMOLE_UIMONSTERFANTASYINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC0C170)
#define MOLEMOLE_UIMONSTERFANTASYINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC0C1F0)
#define MOLEMOLE_UIMONSTERFANTASYINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC0C250)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyInfoWidgetController_TypeDefinitionIndex = 47560;
