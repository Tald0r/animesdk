...
#define MOLEMOLE_UICOOPSETTINGPAGECONTROLLER_GETSHOWSETTINGTYPES_OFFSET UNITYSDK_OFFSET(0xBF58F70)
#define MOLEMOLE_UICOOPSETTINGPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF58E30)
#define MOLEMOLE_UICOOPSETTINGPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF59030)
#define MOLEMOLE_UICOOPSETTINGPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF590C0)
#define MOLEMOLE_UICOOPSETTINGPAGECONTROLLER___BASE_GETSHOWSETTINGTYPES_OFFSET UNITYSDK_OFFSET(0xBF590D0)
#define MOLEMOLE_UICOOPSETTINGPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF590E0)
#define MOLEMOLE_UICOOPSETTINGPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF59180)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopSettingPageController_TypeDefinitionIndex = 40960;

	class UICoopSettingPageController : public ::MoleMole::UISettingPageController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_47* _view; // 0x330
