...
#define MOLEMOLE_UIAVATARANIMATIONSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xE939090)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarAnimationSetting_TypeDefinitionIndex = 71922;
