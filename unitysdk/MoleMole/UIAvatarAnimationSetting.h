...
#define MOLEMOLE_UIAVATARANIMATIONSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xBF32120)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarAnimationSetting_TypeDefinitionIndex = 72907;
