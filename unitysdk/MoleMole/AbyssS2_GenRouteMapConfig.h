...
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_GETROUTEMAPTEMPLATE_OFFSET UNITYSDK_OFFSET(0xC3087F0)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_ONCHANGED_OFFSET UNITYSDK_OFFSET(0xC308FC0)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_REFRESHROUTECOUNT_OFFSET UNITYSDK_OFFSET(0xC3086A0)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_RUNTIMERELOADBYCONFIG_OFFSET UNITYSDK_OFFSET(0xC308930)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_VALIDATE_OFFSET UNITYSDK_OFFSET(0xC3085D0)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0xC309080)
#define MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC3085B0)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_GenRouteMapConfig_TypeDefinitionIndex = 68792;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AbyssS2_GenRouteMapConfig_TypeDefinitionIndex)->GetStaticField(0x104B0);
		}
		...
		::Class_2_208CC9941471731A_841* GetRouteMapTemplate()
		{
			return ((::Class_2_208CC9941471731A_841*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_ABYSSS2_GENROUTEMAPCONFIG_GETROUTEMAPTEMPLATE_OFFSET))(this);
		}
