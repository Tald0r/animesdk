...
#define MOLEMOLE_UIBABELTOWERRESULTWIDGET03WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB2A6130)
#define MOLEMOLE_UIBABELTOWERRESULTWIDGET03WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2A61D0)
#define MOLEMOLE_UIBABELTOWERRESULTWIDGET03WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB2A5FE0)
#define MOLEMOLE_UIBABELTOWERRESULTWIDGET03WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB2A6080)
#define MOLEMOLE_UIBABELTOWERRESULTWIDGET03WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB2A62B0)
#define MOLEMOLE_UIBABELTOWERRESULTWIDGET03WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB2A64B0)
#define MOLEMOLE_UIBABELTOWERRESULTWIDGET03WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB2A64E0)
#define MOLEMOLE_UIBABELTOWERRESULTWIDGET03WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2A6550)
#define MOLEMOLE_UIBABELTOWERRESULTWIDGET03WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB2A65D0)
#define MOLEMOLE_UIBABELTOWERRESULTWIDGET03WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB2A6630)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerResultWidget03WidgetController_TypeDefinitionIndex = 73665;
