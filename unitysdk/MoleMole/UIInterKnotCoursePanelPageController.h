...
#define MOLEMOLE_UIINTERKNOTCOURSEPANELPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x99FDE70)
#define MOLEMOLE_UIINTERKNOTCOURSEPANELPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x99FDE80)
#define MOLEMOLE_UIINTERKNOTCOURSEPANELPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x99FDEF0)
#define MOLEMOLE_UIINTERKNOTCOURSEPANELPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x99FDFB0)
#define MOLEMOLE_UIINTERKNOTCOURSEPANELPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x99FE080)
#define MOLEMOLE_UIINTERKNOTCOURSEPANELPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x99FE2E0)
#define MOLEMOLE_UIINTERKNOTCOURSEPANELPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x99FE2F0)
#define MOLEMOLE_UIINTERKNOTCOURSEPANELPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x99FE360)
#define MOLEMOLE_UIINTERKNOTCOURSEPANELPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x99FE370)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotCoursePanelPageController_TypeDefinitionIndex = 63273;
