...
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_FORMATGAMETIME_OFFSET UNITYSDK_OFFSET(0xD2AC950)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_GETNIKENAMEBYPLAYERIDX_OFFSET UNITYSDK_OFFSET(0xD2ACBB0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD2A8870)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_INITDOGTEXTURESHEET_OFFSET UNITYSDK_OFFSET(0xD2AA430)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_INITRANKDETAIL_OFFSET UNITYSDK_OFFSET(0xD2AC730)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONCLICKINFOBTN_OFFSET UNITYSDK_OFFSET(0xD2ACE40)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD2A9400)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD2A9A80)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONLOGICINIT_OFFSET UNITYSDK_OFFSET(0xD2AA250)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD2A94A0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD2A8880)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD2A8AB0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_PLAYDOGANIMSTATE_OFFSET UNITYSDK_OFFSET(0xD2ABEC0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xD2A9200)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0xD2AA1A0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_REFRESHRETURNIMG_OFFSET UNITYSDK_OFFSET(0xD2A8C80)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_REFRESHUIBYGAMETYPE_OFFSET UNITYSDK_OFFSET(0xD2AA2D0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_SETPVPDETAILINFO_OFFSET UNITYSDK_OFFSET(0xD2AACF0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_SETSCOREINFO_OFFSET UNITYSDK_OFFSET(0xD2ABA70)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_SWITCHACCOUNTNAMEINFO_OFFSET UNITYSDK_OFFSET(0xD2ACC40)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_TICKFADEIN_OFFSET UNITYSDK_OFFSET(0xD2A9920)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_TICKFADEOUT_OFFSET UNITYSDK_OFFSET(0xD2A99C0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_TRYFADEOUT_OFFSET UNITYSDK_OFFSET(0xD2AA110)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD2A9700)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD2ACFE0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER__SETPVPDETAILINFO_B__15_0_OFFSET UNITYSDK_OFFSET(0xD2AD000)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER__SETPVPDETAILINFO_B__15_1_OFFSET UNITYSDK_OFFSET(0xD2AD010)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD2AD020)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD2AD090)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD2AD0C0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD2AD0D0)
#define MOLEMOLE_UISOULHOUNDSIIIENDINGCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD2AD0E0)

namespace MoleMole
{
	inline static constexpr unsigned int UISoulHoundsIIIEndingChildWindowController_TypeDefinitionIndex = 57427;
	...
	public:
		...
		::Class_2_60638234271CCDB8_66* _view; // 0x2F8
