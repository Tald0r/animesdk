...
#define MOLEMOLE_UIARCADEBASEPLAYCHILDWINDOWCONTROLLER___C__DISPLAYCLASS18_0__CREATEMINIGAMEWORLD_B__0_OFFSET UNITYSDK_OFFSET(0xD246060)
#define MOLEMOLE_UIARCADEBASEPLAYCHILDWINDOWCONTROLLER___C__DISPLAYCLASS18_0__CREATEMINIGAMEWORLD_B__2_OFFSET UNITYSDK_OFFSET(0xD2460F0)
#define MOLEMOLE_UIARCADEBASEPLAYCHILDWINDOWCONTROLLER___C__DISPLAYCLASS18_0__CREATEMINIGAMEWORLD_B__3_OFFSET UNITYSDK_OFFSET(0xD246270)
#define MOLEMOLE_UIARCADEBASEPLAYCHILDWINDOWCONTROLLER___C__DISPLAYCLASS18_0__CREATEMINIGAMEWORLD_B__4_OFFSET UNITYSDK_OFFSET(0xD246300)
#define MOLEMOLE_UIARCADEBASEPLAYCHILDWINDOWCONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD246050)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeBasePlayChildWindowController___c__DisplayClass18_0_TypeDefinitionIndex = 61755;

	class UIArcadeBasePlayChildWindowController___c__DisplayClass18_0 : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_88* arcadeConfig; // 0x10
