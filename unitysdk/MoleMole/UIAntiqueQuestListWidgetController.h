...
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB1E4A0)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB1E510)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCB1E790)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCB1E5D0)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCB1E860)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB1E870)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCB1E8E0)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCB1E950)

namespace MoleMole
{
	inline static constexpr unsigned int UIAntiqueQuestListWidgetController_TypeDefinitionIndex = 78352;
