...
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA98100)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA98170)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCA983F0)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCA98230)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA984C0)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA984D0)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCA98540)
#define MOLEMOLE_UIANTIQUEQUESTLISTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCA985B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAntiqueQuestListWidgetController_TypeDefinitionIndex = 38435;
