...
#define MOLEMOLE_MONOUIINTERACTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xBD3F060)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIInteractGroup_TypeDefinitionIndex = 52482;
