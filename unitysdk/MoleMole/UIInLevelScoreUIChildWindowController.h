...
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_CLOSESCORETIP_OFFSET UNITYSDK_OFFSET(0x8C87A50)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_GET_INLEVELSCOREUIRATINGCONFIGASSETPATH_OFFSET UNITYSDK_OFFSET(0x8C86570)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_GET_ISSCORETIPACTIVATED_OFFSET UNITYSDK_OFFSET(0x8C865F0)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_GET_TIPCONTROLLER_OFFSET UNITYSDK_OFFSET(0x8C86600)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8C865E0)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_INITRATINGONOPEN_OFFSET UNITYSDK_OFFSET(0x8C875A0)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8C86960)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C86830)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_ONHIDEMIDDLETIP_OFFSET UNITYSDK_OFFSET(0x8C86D40)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_ONMIDDLETIPSSHOW_OFFSET UNITYSDK_OFFSET(0x8C86CD0)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C868D0)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C86610)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C86710)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_OPENSCORETIP_OFFSET UNITYSDK_OFFSET(0x8C86DB0)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x8C87E90)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_POPUPSCOREINFO_1_OFFSET UNITYSDK_OFFSET(0x8C87E00)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_POPUPSCOREINFO_OFFSET UNITYSDK_OFFSET(0x8C87D60)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_RESTARTSCORETIP_OFFSET UNITYSDK_OFFSET(0x8C87BE0)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0x8C86AC0)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_UPDATERANKING_OFFSET UNITYSDK_OFFSET(0x8C869F0)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER_UPDATESCORE_OFFSET UNITYSDK_OFFSET(0x8C86B80)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C87F30)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C87F40)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C87FB0)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C87FC0)
#define MOLEMOLE_UIINLEVELSCOREUICHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C87FD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelScoreUIChildWindowController_TypeDefinitionIndex = 67420;
	...
	public:
		...
		::Class_2_60638234271CCDB8_102* _view; // 0x2F8
		...
		::Class_0_16E4307DCC419505_373* _rowContainer; // 0x310
