...
#define MOLEMOLE_UIFASHIONSTOREKEYROWTRACKWIDGETCONTROLLER_DATA_ADD_OFFSET UNITYSDK_OFFSET(0xA96A200)
#define MOLEMOLE_UIFASHIONSTOREKEYROWTRACKWIDGETCONTROLLER_DATA_GET_FASHIONSTOREDATA_OFFSET UNITYSDK_OFFSET(0xA969DB0)
#define MOLEMOLE_UIFASHIONSTOREKEYROWTRACKWIDGETCONTROLLER_DATA_GET_NOTES_OFFSET UNITYSDK_OFFSET(0xA969D90)
#define MOLEMOLE_UIFASHIONSTOREKEYROWTRACKWIDGETCONTROLLER_DATA_RESET_OFFSET UNITYSDK_OFFSET(0xA969DD0)
#define MOLEMOLE_UIFASHIONSTOREKEYROWTRACKWIDGETCONTROLLER_DATA_SET_FASHIONSTOREDATA_OFFSET UNITYSDK_OFFSET(0xA969DC0)
#define MOLEMOLE_UIFASHIONSTOREKEYROWTRACKWIDGETCONTROLLER_DATA_SET_NOTES_OFFSET UNITYSDK_OFFSET(0xA969DA0)
#define MOLEMOLE_UIFASHIONSTOREKEYROWTRACKWIDGETCONTROLLER_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA96A4C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreKeyRowTrackWidgetController_Data_TypeDefinitionIndex = 46186;

	class UIFashionStoreKeyRowTrackWidgetController_Data : public ::System::Object
	{
	public:
		::Class_2_6C100683412065D7_Class_0_16E7307DCC43CB2C* _FashionStoreData_k__BackingField; // 0x10
		::System::Action_1<::Class_2_6C100683412065D7_Class_2_9092C869224DF735*>* OnTrackItemClick; // 0x18
		::System::Collections::Generic::List_1<::Class_2_6C100683412065D7_Class_2_9092C869224DF735*>* _Notes_k__BackingField; // 0x20
