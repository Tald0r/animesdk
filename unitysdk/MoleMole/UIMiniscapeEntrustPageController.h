...
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_GETGENERALCHALLENGEREWARDLIST_OFFSET UNITYSDK_OFFSET(0xA2214C0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_GETREWARDINFODATALIST_OFFSET UNITYSDK_OFFSET(0xA221EA0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA21FAD0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_GOTOTASK_OFFSET UNITYSDK_OFFSET(0xA2226B0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_INITGAMEPADCUSTOMLIST_OFFSET UNITYSDK_OFFSET(0xA2209B0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA21FBF0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA21FAE0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONREWARDINFOCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xA221C20)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA220D10)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA21FB80)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA21FF60)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_REFRESHGAINDESC_OFFSET UNITYSDK_OFFSET(0xA220E90)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA220030)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_TAKEREWARDS_OFFSET UNITYSDK_OFFSET(0xA2221B0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA222930)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_0_OFFSET UNITYSDK_OFFSET(0xA2229C0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_1_OFFSET UNITYSDK_OFFSET(0xA222A10)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_2_OFFSET UNITYSDK_OFFSET(0xA222A20)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_3_OFFSET UNITYSDK_OFFSET(0xA222A30)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_4_OFFSET UNITYSDK_OFFSET(0xA222AA0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA222BD0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA222C40)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA222C50)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA222C60)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeEntrustPageController_TypeDefinitionIndex = 59977;

	class UIMiniscapeEntrustPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_2F788DFAB5136192* _view; // 0x2F8
		::System::Collections::Generic::List_1<::MoleMole::UIMiniscapeEntrustBtnWidgetController*>* _taskWidgets; // 0x300
