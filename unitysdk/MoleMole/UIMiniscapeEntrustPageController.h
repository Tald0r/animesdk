...
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_GETGENERALCHALLENGEREWARDLIST_OFFSET UNITYSDK_OFFSET(0xAB70A40)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_GETREWARDINFODATALIST_OFFSET UNITYSDK_OFFSET(0xAB71440)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAB6F050)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_GOTOTASK_OFFSET UNITYSDK_OFFSET(0xAB71C60)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_INITGAMEPADCUSTOMLIST_OFFSET UNITYSDK_OFFSET(0xAB6FF30)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xAB6F170)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB6F060)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONREWARDINFOCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xAB711B0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB70290)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB6F100)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB6F4E0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_REFRESHGAINDESC_OFFSET UNITYSDK_OFFSET(0xAB70410)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAB6F5B0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER_TAKEREWARDS_OFFSET UNITYSDK_OFFSET(0xAB71750)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB71EE0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_0_OFFSET UNITYSDK_OFFSET(0xAB71F70)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_1_OFFSET UNITYSDK_OFFSET(0xAB71FC0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_2_OFFSET UNITYSDK_OFFSET(0xAB71FD0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_3_OFFSET UNITYSDK_OFFSET(0xAB71FE0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER__INITVIEW_B__7_4_OFFSET UNITYSDK_OFFSET(0xAB72050)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB72180)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB721F0)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB72200)
#define MOLEMOLE_UIMINISCAPEENTRUSTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB72210)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeEntrustPageController_TypeDefinitionIndex = 72115;
