...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER_UIEVENT_UIEVENTINNEREVENT_COMPARETO_OFFSET UNITYSDK_OFFSET(0x42F6A0)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER_UIEVENT_UIEVENTINNEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x42F690)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController_UIEvent_UIEventInnerEvent_TypeDefinitionIndex = 42753;
