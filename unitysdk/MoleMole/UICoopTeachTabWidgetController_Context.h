...
#define MOLEMOLE_UICOOPTEACHTABWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA8EBD10)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeachTabWidgetController_Context_TypeDefinitionIndex = 52353;
