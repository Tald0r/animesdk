...
#define MOLEMOLE_UIHOUSERHYTHMRESULTINFOWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7450220)
#define MOLEMOLE_UIHOUSERHYTHMRESULTINFOWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7450290)
#define MOLEMOLE_UIHOUSERHYTHMRESULTINFOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7450350)
#define MOLEMOLE_UIHOUSERHYTHMRESULTINFOWIDGETCONTROLLER_PROCESSONINTERACT_OFFSET UNITYSDK_OFFSET(0x7450520)
#define MOLEMOLE_UIHOUSERHYTHMRESULTINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7450630)
#define MOLEMOLE_UIHOUSERHYTHMRESULTINFOWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7450660)
#define MOLEMOLE_UIHOUSERHYTHMRESULTINFOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x74506D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmResultInfoWidgetController_TypeDefinitionIndex = 79897;
