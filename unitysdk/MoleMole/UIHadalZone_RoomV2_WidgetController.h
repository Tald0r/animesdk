...
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_CLEAROVERRIDESELECTHEROPAGE_OFFSET UNITYSDK_OFFSET(0x8C32BA0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_CURROOMCTX_OFFSET UNITYSDK_OFFSET(0x8C34530)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_FORCEOPENBUDDYPAGE_OFFSET UNITYSDK_OFFSET(0x8C32AC0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_FORCEOPENHEROPAGE_OFFSET UNITYSDK_OFFSET(0x8C32130)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_ISLINEUPSELECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x8C32C10)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_ONBOSSINFOBTN_OFFSET UNITYSDK_OFFSET(0x8C35260)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C30730)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_ONHADALROOMSELECTEDROLESCHANGED_OFFSET UNITYSDK_OFFSET(0x8C34490)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_ONLINEUPSELECTIONCHANGED_1_OFFSET UNITYSDK_OFFSET(0x8C33B20)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_ONLINEUPSELECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x8C33430)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C307D0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C30170)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C30320)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_PLAYTEAMSWITCHANI_OFFSET UNITYSDK_OFFSET(0x8C32030)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_RECONFIRMSELECTIONCHANGEDONLINEUPCLOSE_OFFSET UNITYSDK_OFFSET(0x8C33240)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_REFRESHTEAM_OFFSET UNITYSDK_OFFSET(0x8C31990)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_SETOVERRIDESELECTHEROPAGE_OFFSET UNITYSDK_OFFSET(0x8C32B30)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER_SHOWINFOCONSOLEBTN_OFFSET UNITYSDK_OFFSET(0x8C308B0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C354C0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__OPENSELECTHEROPAGE_OFFSET UNITYSDK_OFFSET(0x8C321A0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__REFRESHSELECTEDAVATAR_OFFSET UNITYSDK_OFFSET(0x8C31A90)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__REFRESHSELECTEDBUDDY_OFFSET UNITYSDK_OFFSET(0x8C31DF0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__SETROOMSTATE_OFFSET UNITYSDK_OFFSET(0x8C30490)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET UNITYSDK_OFFSET(0x8C351C0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__UPDATEROLES_OFFSET UNITYSDK_OFFSET(0x8C30940)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__UPDATEROOMBUFF_OFFSET UNITYSDK_OFFSET(0x8C345A0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__UPDATEROOMINFO_OFFSET UNITYSDK_OFFSET(0x8C31060)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__UPDATEROOMRESISTBYINDEX_OFFSET UNITYSDK_OFFSET(0x8C34950)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__UPDATEROOMRESIST_OFFSET UNITYSDK_OFFSET(0x8C34C50)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C357C0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C35830)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C358B0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C35910)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___UPDATEROLES_G____ONBUDDYHEADROWBTNCLICKED_13_1_OFFSET UNITYSDK_OFFSET(0x8C356C0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___UPDATEROLES_G____ONROLEHEADROWBTNCLICKED_13_0_OFFSET UNITYSDK_OFFSET(0x8C355C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_RoomV2_WidgetController_TypeDefinitionIndex = 76401;
	...
	public:
		...
		::Class_1_90F86E90A663D1B4* _initSelectionDataCache; // 0x2D0
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Class_1_5DA2E7556103D5A3_195*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__UPDATEROOMBUFF_OFFSET))(this, index, roomInfoTemplate);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_195*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__UPDATEROOMRESIST_OFFSET))(this, roomInfoTemplate);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_300*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET))(this, cardConfigTemplate);
		}
