...
#define MOLEMOLE_UICINEMAPREPV2PAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD0FA500)
#define MOLEMOLE_UICINEMAPREPV2PAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD0FA510)
#define MOLEMOLE_UICINEMAPREPV2PAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD0FA670)
#define MOLEMOLE_UICINEMAPREPV2PAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD0FAAA0)
#define MOLEMOLE_UICINEMAPREPV2PAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD0FABF0)
#define MOLEMOLE_UICINEMAPREPV2PAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD0FA730)
#define MOLEMOLE_UICINEMAPREPV2PAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xD0FA580)
#define MOLEMOLE_UICINEMAPREPV2PAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0FADB0)
#define MOLEMOLE_UICINEMAPREPV2PAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD0FADC0)
#define MOLEMOLE_UICINEMAPREPV2PAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD0FAE30)
#define MOLEMOLE_UICINEMAPREPV2PAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD0FAEA0)
#define MOLEMOLE_UICINEMAPREPV2PAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD0FAEB0)
#define MOLEMOLE_UICINEMAPREPV2PAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xD0FAEC0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaPrepV2PageController_TypeDefinitionIndex = 46246;
