...
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0xBD6BB00)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_CLONEMATERIALS_OFFSET UNITYSDK_OFFSET(0xBD6A4F0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_CREATEACTIVATEEFFECTFORCAMP_OFFSET UNITYSDK_OFFSET(0xBD6F1C0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_CREATEHUD_OFFSET UNITYSDK_OFFSET(0xBD6B150)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_DISPOSEMATERIALS_OFFSET UNITYSDK_OFFSET(0xBD6AF60)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_GETDMGTXTROOT_OFFSET UNITYSDK_OFFSET(0xBD6B650)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ISSTARTTIPSPLAYING_OFFSET UNITYSDK_OFFSET(0xBD6BE30)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBD6B000)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0xBD6BF00)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONCAMPCHANGE_OFFSET UNITYSDK_OFFSET(0xBD6EB20)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD6ABF0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONENTERBATTLEANIMFINISH_OFFSET UNITYSDK_OFFSET(0xBD6E9B0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xBD6CDD0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONENTERRESULT_OFFSET UNITYSDK_OFFSET(0xBD6CFA0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONHUDCHANGE_OFFSET UNITYSDK_OFFSET(0xBD6C210)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONSTAGECHANGE_OFFSET UNITYSDK_OFFSET(0xBD6C900)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD6AC90)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD6A2A0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD6A9F0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_REFRESHRESULTTIPSBASEINFO_OFFSET UNITYSDK_OFFSET(0xBD6E360)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_REFRESHSTARTTIPSBASEINFO_OFFSET UNITYSDK_OFFSET(0xBD6D010)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_SETPLAYERNAMEANDICON_OFFSET UNITYSDK_OFFSET(0xBD6D330)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_TOGGLEHUDDRAG_OFFSET UNITYSDK_OFFSET(0xBD6B9C0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_TOGGLEHUDFOCUS_OFFSET UNITYSDK_OFFSET(0xBD6B6C0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_UPDATEHUDRENDERORDER_OFFSET UNITYSDK_OFFSET(0xBD6B340)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xBD6FAF0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBD6F920)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER__ONSTAGECHANGE_B__26_0_OFFSET UNITYSDK_OFFSET(0xBD6FB30)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD6FBE0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD6FC50)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD6FCD0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD6FD30)

namespace MoleMole
{
	inline static constexpr unsigned int UIABBattlePhaseWidgetController_TypeDefinitionIndex = 68908;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIABBattlePhaseWidgetController_TypeDefinitionIndex)->GetStaticField(0xE6F0);
		}
		::Class_2_029B536AEC3836F4* _view; // 0x2A0
		::Class_1_F0E4E2848B1D52CE* _viewModel; // 0x2A8
		::Class_1_48D56DACBE4271BC* _syncHelper; // 0x2B0
		::MoleMole::UIInLevelDamageTextContainerChildWindowController* _damageTextContainerCtrl; // 0x2B8
		::MoleMole::UIABInLevelCountDownWidgetController* _countDownCtrl; // 0x2C0
		::MoleMole::UIBangBooAutoBattleInLevelPageController* _parentCtrl; // 0x2C8
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::MoleMole::UIAutoBattleMonsterHudWidgetController*>* _hudControllers; // 0x2D0
		::System::Collections::Generic::List_1<::MoleMole::UIAutoBattleMonsterHudWidgetController*>* _hudList; // 0x2D8
		::System::Collections::Generic::Queue_1<::MoleMole::UIAutoBattleMonsterHudWidgetController_Context*>* _unInitQueue; // 0x2E0
		::UnityEngine::Material* _selfHPMat; // 0x2E8
		::UnityEngine::Material* _otherHPMat; // 0x2F0
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _curAcitivated; // 0x2F8
		...
		static ::System::Void SetPlayerNameAndIcon(::Class_2_E71E286B10A21FB0* playerData, ::UnityEngine::UI::Extension::UILocalizationText* name, ::Class_2_A8F5ABF31E066ED4* icon, ::Class_2_A8F5ABF31E066ED4* deathIcon, ::UnityEngine::UI::Extension::UILocalizationText* hpNum, ::Class_2_A8F5ABF31E066ED4* HP, ::UnityEngine::UI::Extension::UILocalizationText* lvlText, ::System::Boolean isFoe, ::UnityEngine::UI::Extension::UILocalizationText* foeHPSub, ::System::Int32 expectedDmg)
		{
			return ((::System::Void(*)(::Class_2_E71E286B10A21FB0*, ::UnityEngine::UI::Extension::UILocalizationText*, ::Class_2_A8F5ABF31E066ED4*, ::Class_2_A8F5ABF31E066ED4*, ::UnityEngine::UI::Extension::UILocalizationText*, ::Class_2_A8F5ABF31E066ED4*, ::UnityEngine::UI::Extension::UILocalizationText*, ::System::Boolean, ::UnityEngine::UI::Extension::UILocalizationText*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_SETPLAYERNAMEANDICON_OFFSET))(playerData, name, icon, deathIcon, hpNum, HP, lvlText, isFoe, foeHPSub, expectedDmg);
		}
		...
		::System::Void CreateActivateEffectForCamp(::Class_2_208CC9941471731A_717* campCfg, ::System::Int32 camp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_717*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_CREATEACTIVATEEFFECTFORCAMP_OFFSET))(this, campCfg, camp);
		}
