...
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0xBEFC490)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_CLONEMATERIALS_OFFSET UNITYSDK_OFFSET(0xBEFAE90)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_CREATEACTIVATEEFFECTFORCAMP_OFFSET UNITYSDK_OFFSET(0xBEFFB20)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_CREATEHUD_OFFSET UNITYSDK_OFFSET(0xBEFBAE0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_DISPOSEMATERIALS_OFFSET UNITYSDK_OFFSET(0xBEFB8F0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_GETDMGTXTROOT_OFFSET UNITYSDK_OFFSET(0xBEFBFE0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ISSTARTTIPSPLAYING_OFFSET UNITYSDK_OFFSET(0xBEFC7C0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBEFB990)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0xBEFC890)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONCAMPCHANGE_OFFSET UNITYSDK_OFFSET(0xBEFF480)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBEFB580)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONENTERBATTLEANIMFINISH_OFFSET UNITYSDK_OFFSET(0xBEFF320)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xBEFD760)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONENTERRESULT_OFFSET UNITYSDK_OFFSET(0xBEFD930)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONHUDCHANGE_OFFSET UNITYSDK_OFFSET(0xBEFCBA0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONSTAGECHANGE_OFFSET UNITYSDK_OFFSET(0xBEFD290)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBEFB620)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBEFAC30)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBEFB370)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_REFRESHRESULTTIPSBASEINFO_OFFSET UNITYSDK_OFFSET(0xBEFECF0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_REFRESHSTARTTIPSBASEINFO_OFFSET UNITYSDK_OFFSET(0xBEFD9A0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_SETPLAYERNAMEANDICON_OFFSET UNITYSDK_OFFSET(0xBEFDCD0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_TOGGLEHUDDRAG_OFFSET UNITYSDK_OFFSET(0xBEFC350)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_TOGGLEHUDFOCUS_OFFSET UNITYSDK_OFFSET(0xBEFC050)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_UPDATEHUDRENDERORDER_OFFSET UNITYSDK_OFFSET(0xBEFBCD0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xBF00450)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF00280)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER__ONSTAGECHANGE_B__26_0_OFFSET UNITYSDK_OFFSET(0xBF00490)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF00540)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF005B0)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF00630)
#define MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF00690)

namespace MoleMole
{
	inline static constexpr unsigned int UIABBattlePhaseWidgetController_TypeDefinitionIndex = 51586;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIABBattlePhaseWidgetController_TypeDefinitionIndex)->GetStaticField(0xEF30);
		}
		...
		::System::Void CreateActivateEffectForCamp(::Class_2_208CC9941471731A_27* campCfg, ::System::Int32 camp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_27*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABBATTLEPHASEWIDGETCONTROLLER_CREATEACTIVATEEFFECTFORCAMP_OFFSET))(this, campCfg, camp);
		}
