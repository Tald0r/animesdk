...
#define MOLEMOLE_UIYOROZUYADIFFICULTYINFOWIDGETCONTROLLER_ABYSSHEATCONFIGTEMPLATEEXTANDNESTTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0xACFC750)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaDifficultyInfoWidgetController_AbyssHeatConfigTemplateExtAndNestType_TypeDefinitionIndex = 36652;

	class UIYorozuyaDifficultyInfoWidgetController_AbyssHeatConfigTemplateExtAndNestType : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_614* data; // 0x10
