...
#define MOLEMOLE_UIMAPTESTPLAYERICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4161C0)
#define MOLEMOLE_UIMAPTESTPLAYERICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA416260)
#define MOLEMOLE_UIMAPTESTPLAYERICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA416070)
#define MOLEMOLE_UIMAPTESTPLAYERICONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA416110)
#define MOLEMOLE_UIMAPTESTPLAYERICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA416340)
#define MOLEMOLE_UIMAPTESTPLAYERICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA416370)
#define MOLEMOLE_UIMAPTESTPLAYERICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4163E0)
#define MOLEMOLE_UIMAPTESTPLAYERICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA416460)
#define MOLEMOLE_UIMAPTESTPLAYERICONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA4164C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMapTestPlayerIconWidgetController_TypeDefinitionIndex = 71016;

	class UIMapTestPlayerIconWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_22FEBBA7FA4D4D4A_8* _view; // 0x2A0
