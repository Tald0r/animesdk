...
#define MOLEMOLE_MONOINLEVELBURSTITEMCOLORHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x8F937A0)
#define MOLEMOLE_MONOINLEVELBURSTITEMCOLORHANDLER_METHOD_6_67C978A17F4AADBB_OFFSET UNITYSDK_OFFSET(0x8F93D00)
#define MOLEMOLE_MONOINLEVELBURSTITEMCOLORHANDLER_METHOD_6_9CC926D36F34DBFF_OFFSET UNITYSDK_OFFSET(0x8F93D10)
#define MOLEMOLE_MONOINLEVELBURSTITEMCOLORHANDLER_METHOD_6_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x8F93950)
#define MOLEMOLE_MONOINLEVELBURSTITEMCOLORHANDLER_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x8F938E0)
#define MOLEMOLE_MONOINLEVELBURSTITEMCOLORHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F93BA0)
#define MOLEMOLE_MONOINLEVELBURSTITEMCOLORHANDLER___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x8F93BE0)
#define MOLEMOLE_MONOINLEVELBURSTITEMCOLORHANDLER___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x8F93C70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoInLevelBurstItemColorHandler_TypeDefinitionIndex = 60814;
