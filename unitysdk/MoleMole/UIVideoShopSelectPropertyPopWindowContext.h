...
#define MOLEMOLE_UIVIDEOSHOPSELECTPROPERTYPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAE9A610)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoShopSelectPropertyPopWindowContext_TypeDefinitionIndex = 45770;
	...
	public:
		...
		::System::Int32 SelectPosition; // 0x40
		::System::Int32 SelectUpSuitID; // 0x44
		::System::Int32 DefaultSelectPropertyID; // 0x48
