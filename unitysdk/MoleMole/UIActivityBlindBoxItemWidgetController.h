...
#define MOLEMOLE_UIACTIVITYBLINDBOXITEMWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xE8FF5E0)
#define MOLEMOLE_UIACTIVITYBLINDBOXITEMWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xE8FF650)
#define MOLEMOLE_UIACTIVITYBLINDBOXITEMWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xE8FF710)
#define MOLEMOLE_UIACTIVITYBLINDBOXITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE8FF8E0)
#define MOLEMOLE_UIACTIVITYBLINDBOXITEMWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xE8FF910)
#define MOLEMOLE_UIACTIVITYBLINDBOXITEMWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xE8FF980)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityBlindBoxItemWidgetController_TypeDefinitionIndex = 50194;
