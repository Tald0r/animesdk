...
#define MOLEMOLE_UISETTINGPAGECONTROLLER_CALSETTINGTYPEBYIDX_OFFSET UNITYSDK_OFFSET(0x868A500)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_CLEARNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x8688F90)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_CREATECONTENTAREABYTABTYPE_OFFSET UNITYSDK_OFFSET(0x868A5B0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_GETSHOWSETTINGTYPES_OFFSET UNITYSDK_OFFSET(0x8689C20)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x8688830)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8688820)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_HASCLOSED_OFFSET UNITYSDK_OFFSET(0x8689CD0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x8688990)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8688840)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x868AB90)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x8689BA0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONRESETBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x868A710)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8688EB0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x86888E0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8689160)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8689390)
#define MOLEMOLE_UISETTINGPAGECONTROLLER_SWITCHCONTENTAREA_OFFSET UNITYSDK_OFFSET(0x8689D30)
#define MOLEMOLE_UISETTINGPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x868AD90)
#define MOLEMOLE_UISETTINGPAGECONTROLLER__INITVIEW_B__12_1_OFFSET UNITYSDK_OFFSET(0x868AE60)
#define MOLEMOLE_UISETTINGPAGECONTROLLER__INITVIEW_B__12_2_OFFSET UNITYSDK_OFFSET(0x868AF00)
#define MOLEMOLE_UISETTINGPAGECONTROLLER__ONRESETBTNCLICKED_B__17_0_OFFSET UNITYSDK_OFFSET(0x868B000)
#define MOLEMOLE_UISETTINGPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x868B0D0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x868B150)
#define MOLEMOLE_UISETTINGPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x868B180)
#define MOLEMOLE_UISETTINGPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x868B1E0)
#define MOLEMOLE_UISETTINGPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x868B140)
#define MOLEMOLE_UISETTINGPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x868B1F0)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingPageController_TypeDefinitionIndex = 62516;

	class UISettingPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_131* _view; // 0x2F8
