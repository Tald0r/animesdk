...
#define MOLEMOLE_UIROLEATTRIBUTEINFODIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC3AAA50)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleAttributeInfoDialogContext_TypeDefinitionIndex = 69382;
	...
	public:
		...
		::System::Int32 InitSelectedIndex; // 0x44
