...
#define MOLEMOLE_ACTIVITYRHYTHMCLICKBEATMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x96E36C0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityRhythmClickBeatmapConfig_TypeDefinitionIndex = 49496;
