...
#define MOLEMOLE_ACTIVITYRHYTHMCLICKBEATMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB073ED0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityRhythmClickBeatmapConfig_TypeDefinitionIndex = 38162;
