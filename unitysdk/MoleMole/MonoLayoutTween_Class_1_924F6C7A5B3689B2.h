...
#define MOLEMOLE_MONOLAYOUTTWEEN_CLASS_1_924F6C7A5B3689B2_METHOD_1_3C927B51D2142A24_OFFSET UNITYSDK_OFFSET(0x82F97C0)
#define MOLEMOLE_MONOLAYOUTTWEEN_CLASS_1_924F6C7A5B3689B2_METHOD_1_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x82F9790)
#define MOLEMOLE_MONOLAYOUTTWEEN_CLASS_1_924F6C7A5B3689B2__CTOR_OFFSET UNITYSDK_OFFSET(0x82F9780)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLayoutTween_Class_1_924F6C7A5B3689B2_TypeDefinitionIndex = 66453;
