...
#define MOLEMOLE_UIACTIVITYWATERPROGRESSBARWIDGETCONTROLLER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0xDD8C3C0)
#define MOLEMOLE_UIACTIVITYWATERPROGRESSBARWIDGETCONTROLLER___C__DISPLAYCLASS10_0__GETREWARD_B__0_OFFSET UNITYSDK_OFFSET(0xDD8C3D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityWaterProgressBarWidgetController___c__DisplayClass10_0_TypeDefinitionIndex = 78863;
