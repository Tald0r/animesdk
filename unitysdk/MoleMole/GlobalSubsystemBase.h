...
#define MOLEMOLE_GLOBALSUBSYSTEMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD59A00)

namespace MoleMole
{
	inline static constexpr unsigned int GlobalSubsystemBase_TypeDefinitionIndex = 63304;
