...
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS134_1__CTOR_OFFSET UNITYSDK_OFFSET(0x92B47A0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS134_1__PLAYRECOMMENDTRACK_B__3_OFFSET UNITYSDK_OFFSET(0x92B47B0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS134_1__PLAYRECOMMENDTRACK_B__4_OFFSET UNITYSDK_OFFSET(0x92B4840)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsContainerWidgetController___c__DisplayClass134_1_TypeDefinitionIndex = 75712;
