...
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_CALMAXMATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0xD9A7BE0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_CLEARMATERIAL_OFFSET UNITYSDK_OFFSET(0xD9A7990)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_GETALLSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0xD9A4250)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_GETHASSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0xD9A4120)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_GETLEFTBTNTEXT_OFFSET UNITYSDK_OFFSET(0xD9A4FA0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_GETRIGHTBTNTEXT_OFFSET UNITYSDK_OFFSET(0xD9A5050)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_GETTIPSTEXT_OFFSET UNITYSDK_OFFSET(0xD9A5100)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_LEFTBTNCALL_OFFSET UNITYSDK_OFFSET(0xD9A3B90)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0xD9A63A0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONBUDDYLEVELUP_OFFSET UNITYSDK_OFFSET(0xD9A86E0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD9A4A70)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD9A5D80)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD9A6DF0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONITEMCHANGE_OFFSET UNITYSDK_OFFSET(0xD9A2FD0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONMATITEMCHANGED_OFFSET UNITYSDK_OFFSET(0xD9A7E80)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD9A3A20)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD9A4C10)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD9A2C80)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_REFRESHLEVELUPINPUTKEY_OFFSET UNITYSDK_OFFSET(0xD9A5F70)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_REQLEVELUP_OFFSET UNITYSDK_OFFSET(0xD9A4640)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_RIGHTBTNCALL_OFFSET UNITYSDK_OFFSET(0xD9A45D0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_SETCONSUME_OFFSET UNITYSDK_OFFSET(0xD9A52E0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_SETPROGRESSMAT_OFFSET UNITYSDK_OFFSET(0xD9A4870)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0xD9A51B0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_TRIGGERGAMEPADADDBTN_OFFSET UNITYSDK_OFFSET(0xD9A6470)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_TRIGGERGAMEPADREDUCEBTN_OFFSET UNITYSDK_OFFSET(0xD9A6930)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xD9A3040)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD9A8CA0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER__ONBUDDYLEVELUP_B__33_1_OFFSET UNITYSDK_OFFSET(0xD9A8D80)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER__ONBUDDYLEVELUP_B__33_2_OFFSET UNITYSDK_OFFSET(0xD9A8F00)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_GETLEFTBTNTEXT_OFFSET UNITYSDK_OFFSET(0xD9A8FE0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_GETRIGHTBTNTEXT_OFFSET UNITYSDK_OFFSET(0xD9A9050)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_GETTIPSTEXT_OFFSET UNITYSDK_OFFSET(0xD9A90C0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_LEFTBTNCALL_OFFSET UNITYSDK_OFFSET(0xD9A9130)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD9A9190)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD9A9200)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD9A9280)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD9A92B0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD9A9320)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD9A93A0)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_RIGHTBTNCALL_OFFSET UNITYSDK_OFFSET(0xD9A9400)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_SETPROGRESSMAT_OFFSET UNITYSDK_OFFSET(0xD9A9460)
#define MOLEMOLE_UIBANGBOOLEVELUPWIDGETCONTROLLER___BASE_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xD9A94C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooLevelUpWidgetController_TypeDefinitionIndex = 50992;

	class UIBangbooLevelUpWidgetController : public ::MoleMole::BangbooBaseWidget
	{
	public:
		::Class_2_DBC51CF79F50022E* _view; // 0x2C0
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnWidgetController*>* _expMatItems; // 0x2C8
		::System::Int32 _nowLv; // 0x2D0
		::System::Int32 roleToMaxLvNeedExp; // 0x2D4
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* hasMaterialDir; // 0x2D8
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* suggestMaterialDir; // 0x2E0
		::Class_2_9D9172C07F82DDAE* _itemDataProxy; // 0x2E8
		::System::Int32 tarLevel; // 0x2F0
		::Class_2_79F6D62CE30E3F8E_95* _ParentView; // 0x2F8
		::System::Int32 curToMaxLeftEXP; // 0x300
		::MoleMole::MonoGamepadCustomList* _monoGamepadCustomList; // 0x308
		::System::Int32 _gamepadAddSelectIndex; // 0x310
		::System::Int32 _gamepadReduceSelectIndex; // 0x314
		::System::Boolean _isGamepadAddBtnPressed; // 0x318
		::System::Boolean _isGamepadReduceBtnPressed; // 0x319
