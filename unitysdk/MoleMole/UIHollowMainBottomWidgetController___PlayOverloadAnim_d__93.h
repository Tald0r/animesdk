...
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___PLAYOVERLOADANIM_D__93_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD5B9B40)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___PLAYOVERLOADANIM_D__93_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD5B9F20)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___PLAYOVERLOADANIM_D__93_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD5B9F80)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___PLAYOVERLOADANIM_D__93_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD5B9F30)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___PLAYOVERLOADANIM_D__93_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD5B9B30)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___PLAYOVERLOADANIM_D__93__CTOR_OFFSET UNITYSDK_OFFSET(0xD5B9B20)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainBottomWidgetController___PlayOverloadAnim_d__93_TypeDefinitionIndex = 76060;
