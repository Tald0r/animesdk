...
#define MOLEMOLE_UIACTIVEPROPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS26_1__CTOR_OFFSET UNITYSDK_OFFSET(0xDC2E4C0)
#define MOLEMOLE_UIACTIVEPROPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS26_1__ONFAVORITEBTNCLICKED_B__0_OFFSET UNITYSDK_OFFSET(0xDC2E4D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivePropsPopWindowController___c__DisplayClass26_1_TypeDefinitionIndex = 78897;
