...
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER_CREATEITEMWIDGET_OFFSET UNITYSDK_OFFSET(0xA192E20)
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER_GETITEMHOLDER_OFFSET UNITYSDK_OFFSET(0xA193380)
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA192F90)
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA193110)
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA193030)
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA192D60)
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA192EE0)
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER_REFRESHITEMVIEW_OFFSET UNITYSDK_OFFSET(0xA1932C0)
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA1933F0)
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA193400)
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA193470)
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA1934F0)
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA193570)
#define MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA1935D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardUpGradeRowWidgetController_TypeDefinitionIndex = 50294;
	...
	public:
		...
		::Class_3_A2BF74BADF6F7D16<::MoleMole::UIHollowCardOptionItemWidgetController*>* GetItemHolder()
		{
			return ((::Class_3_A2BF74BADF6F7D16<::MoleMole::UIHollowCardOptionItemWidgetController*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWCARDUPGRADEROWWIDGETCONTROLLER_GETITEMHOLDER_OFFSET))(this);
		}
