...
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0x7A6C100)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___C__DISPLAYCLASS21_0__ONSHOPBTNCLICK_B__0_OFFSET UNITYSDK_OFFSET(0x7A6C110)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___C__DISPLAYCLASS21_0__ONSHOPBTNCLICK_B__1_OFFSET UNITYSDK_OFFSET(0x7A6C3F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookZeroWidgetController___c__DisplayClass21_0_TypeDefinitionIndex = 45426;
