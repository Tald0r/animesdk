...
#define MOLEMOLE_SKINMAPANIMATIONCLIPDATA_GETFORMATTOSERIALIZEAS_OFFSET UNITYSDK_OFFSET(0xB8C6780)
#define MOLEMOLE_SKINMAPANIMATIONCLIPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB8C67F0)

namespace MoleMole
{
	inline static constexpr unsigned int SkinMapAnimationClipData_TypeDefinitionIndex = 57532;
