...
#define MOLEMOLE_GLOBALILLUMINATIONPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC2D3AE0)

namespace MoleMole
{
	inline static constexpr unsigned int GlobalIlluminationProfileContext_TypeDefinitionIndex = 62205;
