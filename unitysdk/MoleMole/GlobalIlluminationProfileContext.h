...
#define MOLEMOLE_GLOBALILLUMINATIONPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB8AF700)

namespace MoleMole
{
	inline static constexpr unsigned int GlobalIlluminationProfileContext_TypeDefinitionIndex = 49978;
