...
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK_METHOD_6_3416FD11DD9200F8_OFFSET UNITYSDK_OFFSET(0xD80FC30)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK_METHOD_6_DB4F3E95D7CE1950_OFFSET UNITYSDK_OFFSET(0xD8105E0)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD80FB00)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD80FA30)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK_UPDATE_OFFSET UNITYSDK_OFFSET(0xD80FB60)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK__CCTOR_OFFSET UNITYSDK_OFFSET(0xD810590)
#define MOLEMOLE_MONOEFFECTPLUGINLINERENDERERSWITHBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xD810560)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginLineRenderersWithBlock_TypeDefinitionIndex = 37141;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(MonoEffectPluginLineRenderersWithBlock_TypeDefinitionIndex)->GetStaticField(0x42510);
		}
