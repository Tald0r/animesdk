...
#define MOLEMOLE_UIGENERALSUMMERPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8C48BD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSummerPopWindowController_Context_TypeDefinitionIndex = 57695;
