...
#define MOLEMOLE_INLEVELMOVERIGHTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xB8B2B90)
#define MOLEMOLE_INLEVELMOVERIGHTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xB8B2BA0)
#define MOLEMOLE_INLEVELMOVERIGHTKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xB8B2BB0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelMoveRightKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 47142;
