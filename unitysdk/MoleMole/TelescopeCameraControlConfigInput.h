...
#define MOLEMOLE_TELESCOPECAMERACONTROLCONFIGINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x6B216B0)

namespace MoleMole
{
	inline static constexpr unsigned int TelescopeCameraControlConfigInput_TypeDefinitionIndex = 55921;
