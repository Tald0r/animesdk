...
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA619400)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA6194A0)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA619170)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA619350)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA619580)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0xA6195B0)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA6195D0)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA619640)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA6196C0)
#define MOLEMOLE_UIHOLLOWSKILLBUTTONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA619720)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowSkillButtonWidgetController_TypeDefinitionIndex = 77808;

	class UIHollowSkillButtonWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_5BA0256FCCEF80F3_1* _view; // 0x2A0
		::UnityEngine::Events::UnityAction* OnClick; // 0x2A8
