...
#define MOLEMOLE_MONOMATCAPCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA473360)
#define MOLEMOLE_MONOMATCAPCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA473890)
#define MOLEMOLE_MONOMATCAPCONTROLLER_METHOD_5_3150507749BCEAEC_OFFSET UNITYSDK_OFFSET(0xA4742C0)
#define MOLEMOLE_MONOMATCAPCONTROLLER_METHOD_5_C41F5AE2DBAF3553_OFFSET UNITYSDK_OFFSET(0xA473730)
#define MOLEMOLE_MONOMATCAPCONTROLLER_METHOD_5_CD5EE90A9C78A32C_OFFSET UNITYSDK_OFFSET(0xA4741E0)
#define MOLEMOLE_MONOMATCAPCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA473820)
#define MOLEMOLE_MONOMATCAPCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xA473510)
#define MOLEMOLE_MONOMATCAPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA474320)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMatCapController_TypeDefinitionIndex = 69583;
