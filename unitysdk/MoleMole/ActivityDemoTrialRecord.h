...
#define MOLEMOLE_ACTIVITYDEMOTRIALRECORD_GET_RECORDVERSION_OFFSET UNITYSDK_OFFSET(0x6FA8EE0)
#define MOLEMOLE_ACTIVITYDEMOTRIALRECORD_METHOD_2_378D17F5AC4A22EE_OFFSET UNITYSDK_OFFSET(0x6FA8F00)
#define MOLEMOLE_ACTIVITYDEMOTRIALRECORD_METHOD_2_6A1DAFC0B1CFA8E3_OFFSET UNITYSDK_OFFSET(0x6FA8FF0)
#define MOLEMOLE_ACTIVITYDEMOTRIALRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x6FA8EF0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityDemoTrialRecord_TypeDefinitionIndex = 51230;
