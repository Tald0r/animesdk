...
#define MOLEMOLE_ACTIVITYDEMOTRIALRECORD_GET_RECORDVERSION_OFFSET UNITYSDK_OFFSET(0x9156F90)
#define MOLEMOLE_ACTIVITYDEMOTRIALRECORD_METHOD_2_378D17F5AC4A22EE_OFFSET UNITYSDK_OFFSET(0x9156FB0)
#define MOLEMOLE_ACTIVITYDEMOTRIALRECORD_METHOD_2_6A1DAFC0B1CFA8E3_OFFSET UNITYSDK_OFFSET(0x91570A0)
#define MOLEMOLE_ACTIVITYDEMOTRIALRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x9156FA0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityDemoTrialRecord_TypeDefinitionIndex = 43401;
