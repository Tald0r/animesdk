...
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR_LERP_OFFSET UNITYSDK_OFFSET(0x6CB2260)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR_WRITE_OFFSET UNITYSDK_OFFSET(0x30ED80)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x30EB30)
#define MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x30EB20)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupRoleSelectWidgetController_RoleBGColor_TypeDefinitionIndex = 76905;
	...
	struct alignas(4) UILineupRoleSelectWidgetController_RoleBGColor
	{
		...
		::System::Void _ctor(::Class_2_1CC0E2699D5FB1A6_1* bg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_1CC0E2699D5FB1A6_1*))((::PBYTE)hIl2Cpp + MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR__CTOR_OFFSET))(this, bg);
		}
		...
		*/
		...
		::System::Void Write(::Class_2_1CC0E2699D5FB1A6_1* bg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_1CC0E2699D5FB1A6_1*))((::PBYTE)hIl2Cpp + MOLEMOLE_UILINEUPROLESELECTWIDGETCONTROLLER_ROLEBGCOLOR_WRITE_OFFSET))(this, bg);
		}
	};
}
