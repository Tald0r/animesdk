...
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION___C__DISPLAYCLASS5_2__CTOR_OFFSET UNITYSDK_OFFSET(0x94E8710)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION___C__DISPLAYCLASS5_2__RUN_B__1_OFFSET UNITYSDK_OFFSET(0x94E8A20)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION___C__DISPLAYCLASS5_2__RUN_B__2_OFFSET UNITYSDK_OFFSET(0x94E8A50)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION___C__DISPLAYCLASS5_2__RUN_B__3_OFFSET UNITYSDK_OFFSET(0x94E8A00)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int GridEventEntityAction___c__DisplayClass5_2_TypeDefinitionIndex = 78309;
