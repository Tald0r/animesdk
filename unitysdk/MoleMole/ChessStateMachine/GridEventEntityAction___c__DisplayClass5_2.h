...
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION___C__DISPLAYCLASS5_2__CTOR_OFFSET UNITYSDK_OFFSET(0x8491180)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION___C__DISPLAYCLASS5_2__RUN_B__1_OFFSET UNITYSDK_OFFSET(0x8491490)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION___C__DISPLAYCLASS5_2__RUN_B__2_OFFSET UNITYSDK_OFFSET(0x84914C0)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION___C__DISPLAYCLASS5_2__RUN_B__3_OFFSET UNITYSDK_OFFSET(0x8491470)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int GridEventEntityAction___c__DisplayClass5_2_TypeDefinitionIndex = 69849;
