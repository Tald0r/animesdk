...
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVE_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x9B4F7E0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVE_RUN_OFFSET UNITYSDK_OFFSET(0x9B4EFA0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVE_TEXTURECALLBACK_OFFSET UNITYSDK_OFFSET(0x9B4F770)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B4FA20)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVE___BASE_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x9B4FA40)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVE___BASE_RUN_OFFSET UNITYSDK_OFFSET(0x9B4FAA0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int TextureSheetVE_TypeDefinitionIndex = 69936;
