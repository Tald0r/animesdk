...
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWLINKPATHVIEWACTION_RUN_OFFSET UNITYSDK_OFFSET(0x6D39070)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWLINKPATHVIEWACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x6D39C30)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWLINKPATHVIEWACTION___BASE_RUN_OFFSET UNITYSDK_OFFSET(0x6D39C40)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ShowLinkPathViewAction_TypeDefinitionIndex = 61656;
	...
	public:
		...
		::System::Boolean IsShowPathStamina; // 0x3A
