...
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0x94E87B0)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION_FINDBLENDTEXTURESHEETDATA_OFFSET UNITYSDK_OFFSET(0x94E8640)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION_FINDTEXTURESHEETDATABYKEY_OFFSET UNITYSDK_OFFSET(0x94E8720)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION_RANDOMTEXTURESHEETKEY_OFFSET UNITYSDK_OFFSET(0x94E8580)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION_RUN_OFFSET UNITYSDK_OFFSET(0x94E7AA0)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x94E8990)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION___BASE_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0x94E89A0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int GridEventEntityAction_TypeDefinitionIndex = 78308;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_22*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION_RUN_OFFSET))(this, context);
		}
