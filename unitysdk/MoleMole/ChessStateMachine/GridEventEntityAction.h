...
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0x8491220)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION_FINDBLENDTEXTURESHEETDATA_OFFSET UNITYSDK_OFFSET(0x84910B0)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION_FINDTEXTURESHEETDATABYKEY_OFFSET UNITYSDK_OFFSET(0x8491190)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION_RANDOMTEXTURESHEETKEY_OFFSET UNITYSDK_OFFSET(0x8490FF0)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION_RUN_OFFSET UNITYSDK_OFFSET(0x8490510)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x8491400)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION___BASE_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0x8491410)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int GridEventEntityAction_TypeDefinitionIndex = 69847;
