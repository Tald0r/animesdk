...
#define MOLEMOLE_CHESSSTATEMACHINE_CLEARMOVESTATEACTION_CLEARMOVESTATE_OFFSET UNITYSDK_OFFSET(0x81DA220)
#define MOLEMOLE_CHESSSTATEMACHINE_CLEARMOVESTATEACTION_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x81DA2E0)
#define MOLEMOLE_CHESSSTATEMACHINE_CLEARMOVESTATEACTION_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x81D9F90)
#define MOLEMOLE_CHESSSTATEMACHINE_CLEARMOVESTATEACTION_RUN_OFFSET UNITYSDK_OFFSET(0x81D9FA0)
#define MOLEMOLE_CHESSSTATEMACHINE_CLEARMOVESTATEACTION_STOP_OFFSET UNITYSDK_OFFSET(0x81DA280)
#define MOLEMOLE_CHESSSTATEMACHINE_CLEARMOVESTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x81DA490)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ClearMoveStateAction_TypeDefinitionIndex = 57101;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_22*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_CLEARMOVESTATEACTION_RUN_OFFSET))(this, context);
		}
