...
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSSMPATHMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x7BB85E0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ChessSMPathMap_TypeDefinitionIndex = 39491;
