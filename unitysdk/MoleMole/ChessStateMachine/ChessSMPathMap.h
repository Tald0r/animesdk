...
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSSMPATHMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xCCEBC30)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ChessSMPathMap_TypeDefinitionIndex = 60193;
