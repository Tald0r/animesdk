...
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSENTITYEVENTNODE_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x9CD8F90)
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSENTITYEVENTNODE_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x9CD9050)
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSENTITYEVENTNODE_RUN_OFFSET UNITYSDK_OFFSET(0x9CD8DD0)
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSENTITYEVENTNODE_STOP_OFFSET UNITYSDK_OFFSET(0x9CD8FF0)
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSENTITYEVENTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x9CD9060)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ChessEntityEventNode_TypeDefinitionIndex = 60265;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_22*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_CHESSENTITYEVENTNODE_RUN_OFFSET))(this, context);
		}
