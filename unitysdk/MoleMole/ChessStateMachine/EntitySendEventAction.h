...
#define MOLEMOLE_CHESSSTATEMACHINE_ENTITYSENDEVENTACTION_RUNINNER_OFFSET UNITYSDK_OFFSET(0x89E39C0)
#define MOLEMOLE_CHESSSTATEMACHINE_ENTITYSENDEVENTACTION_RUN_OFFSET UNITYSDK_OFFSET(0x89E3940)
#define MOLEMOLE_CHESSSTATEMACHINE_ENTITYSENDEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x89E3D00)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int EntitySendEventAction_TypeDefinitionIndex = 52037;
