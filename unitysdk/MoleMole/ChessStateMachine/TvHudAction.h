...
#define MOLEMOLE_CHESSSTATEMACHINE_TVHUDACTION_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x9B502E0)
#define MOLEMOLE_CHESSSTATEMACHINE_TVHUDACTION_RUN_OFFSET UNITYSDK_OFFSET(0x9B4FBF0)
#define MOLEMOLE_CHESSSTATEMACHINE_TVHUDACTION_STOP_OFFSET UNITYSDK_OFFSET(0x9B50350)
#define MOLEMOLE_CHESSSTATEMACHINE_TVHUDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x9B503C0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int TvHudAction_TypeDefinitionIndex = 41216;
