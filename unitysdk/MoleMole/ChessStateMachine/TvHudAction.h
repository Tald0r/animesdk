...
#define MOLEMOLE_CHESSSTATEMACHINE_TVHUDACTION_FORCESTOP_OFFSET UNITYSDK_OFFSET(0xB45F640)
#define MOLEMOLE_CHESSSTATEMACHINE_TVHUDACTION_RUN_OFFSET UNITYSDK_OFFSET(0xB45EF60)
#define MOLEMOLE_CHESSSTATEMACHINE_TVHUDACTION_STOP_OFFSET UNITYSDK_OFFSET(0xB45F6B0)
#define MOLEMOLE_CHESSSTATEMACHINE_TVHUDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xB45F720)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int TvHudAction_TypeDefinitionIndex = 75347;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_22*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_TVHUDACTION_RUN_OFFSET))(this, context);
		}
