...
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWLINKPATHVIEWACTION___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC323110)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWLINKPATHVIEWACTION___C__DISPLAYCLASS3_0__RUN_B__0_OFFSET UNITYSDK_OFFSET(0xC323120)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ShowLinkPathViewAction___c__DisplayClass3_0_TypeDefinitionIndex = 61657;
