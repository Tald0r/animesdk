...
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION___RUN_G____SENDTIMEROUTEVENT_2_0_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xACADC00)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION___RUN_G____SENDTIMEROUTEVENT_2_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xACAE130)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION___RUN_G____SENDTIMEROUTEVENT_2_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xACAE190)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION___RUN_G____SENDTIMEROUTEVENT_2_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xACAE140)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION___RUN_G____SENDTIMEROUTEVENT_2_0_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xACADBF0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION___RUN_G____SENDTIMEROUTEVENT_2_0_D__CTOR_OFFSET UNITYSDK_OFFSET(0xACADBE0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int PlayerOnAutoSleepAction___Run_g____sendTimerOutEvent_2_0_d_TypeDefinitionIndex = 48891;
	...
	public:
		...
		::System::Boolean _breakSleep_5__5; // 0x20
		::System::Single _sleepDelay_5__3; // 0x24
		::System::Single _effectTime_5__2; // 0x28
