...
#define MOLEMOLE_CHESSSTATEMACHINE_LAYERCONFIG_DEEPCOPY_OFFSET UNITYSDK_OFFSET(0x8025360)
#define MOLEMOLE_CHESSSTATEMACHINE_LAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x80253C0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int LayerConfig_TypeDefinitionIndex = 45524;
