...
#define MOLEMOLE_CHESSSTATEMACHINE_PARTICLEVE_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x62968F0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARTICLEVE_GETSTATEEFFECT_OFFSET UNITYSDK_OFFSET(0x6296880)
#define MOLEMOLE_CHESSSTATEMACHINE_PARTICLEVE_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x62969B0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARTICLEVE_RUN_OFFSET UNITYSDK_OFFSET(0x6296500)
#define MOLEMOLE_CHESSSTATEMACHINE_PARTICLEVE_STOP_OFFSET UNITYSDK_OFFSET(0x6296950)
#define MOLEMOLE_CHESSSTATEMACHINE_PARTICLEVE__CTOR_OFFSET UNITYSDK_OFFSET(0x62969C0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARTICLEVE__RUN_B__4_0_OFFSET UNITYSDK_OFFSET(0x62969D0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ParticleVE_TypeDefinitionIndex = 69331;

	class ParticleVE : public ::MoleMole::ChessStateMachine::StateMachineAction
	{
	public:
		::System::String* ParticlePath; // 0x28
		::System::Boolean NeedStopAll; // 0x30
		::System::Boolean SkipWait; // 0x31
		::System::Boolean IsInstantParticle; // 0x32
