...
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0xC322BC0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION_RUN_OFFSET UNITYSDK_OFFSET(0xC322AD0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC322CE0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION__RUN_G____SENDTIMEROUTEVENT_2_0_OFFSET UNITYSDK_OFFSET(0xC322B90)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION___BASE_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0xC322CF0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYERONAUTOSLEEPACTION___BASE_RUN_OFFSET UNITYSDK_OFFSET(0xC322D50)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int PlayerOnAutoSleepAction_TypeDefinitionIndex = 59529;
