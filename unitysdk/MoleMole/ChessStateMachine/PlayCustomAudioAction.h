...
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYCUSTOMAUDIOACTION_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x96F1DA0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYCUSTOMAUDIOACTION_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x96F1CE0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYCUSTOMAUDIOACTION_RUN_OFFSET UNITYSDK_OFFSET(0x96F1CF0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYCUSTOMAUDIOACTION_STOP_OFFSET UNITYSDK_OFFSET(0x96F1E00)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYCUSTOMAUDIOACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x96F1E60)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int PlayCustomAudioAction_TypeDefinitionIndex = 44496;
