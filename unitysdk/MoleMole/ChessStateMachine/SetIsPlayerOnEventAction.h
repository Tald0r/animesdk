...
#define MOLEMOLE_CHESSSTATEMACHINE_SETISPLAYERONEVENTACTION_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x89E55B0)
#define MOLEMOLE_CHESSSTATEMACHINE_SETISPLAYERONEVENTACTION_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x89E5530)
#define MOLEMOLE_CHESSSTATEMACHINE_SETISPLAYERONEVENTACTION_RUN_OFFSET UNITYSDK_OFFSET(0x89E5540)
#define MOLEMOLE_CHESSSTATEMACHINE_SETISPLAYERONEVENTACTION_STOP_OFFSET UNITYSDK_OFFSET(0x89E5610)
#define MOLEMOLE_CHESSSTATEMACHINE_SETISPLAYERONEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x89E5670)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int SetIsPlayerOnEventAction_TypeDefinitionIndex = 75380;
