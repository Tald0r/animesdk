...
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_1__CTOR_OFFSET UNITYSDK_OFFSET(0x9B4EF10)
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_1__RUN_B__3_OFFSET UNITYSDK_OFFSET(0x9B4EF40)
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_1__RUN_B__4_OFFSET UNITYSDK_OFFSET(0x9B4EF70)
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_1__RUN_B__5_OFFSET UNITYSDK_OFFSET(0x9B4EF20)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int SubStateFadeOutEntityAction___c__DisplayClass3_1_TypeDefinitionIndex = 37364;

	class SubStateFadeOutEntityAction___c__DisplayClass3_1 : public ::System::Object
	{
	public:
		::Class_1_3EDDC2D8D1854DED* pieceMultiPlayerHelper; // 0x10
