...
#define MOLEMOLE_CHESSSTATEMACHINE_GLOBALPARAMSCONFIG_CLEARCACHEDATA_OFFSET UNITYSDK_OFFSET(0xB07DF70)
#define MOLEMOLE_CHESSSTATEMACHINE_GLOBALPARAMSCONFIG_DEEPCOPY_OFFSET UNITYSDK_OFFSET(0xB07E120)
#define MOLEMOLE_CHESSSTATEMACHINE_GLOBALPARAMSCONFIG_INITPARAMSLIST_OFFSET UNITYSDK_OFFSET(0xB07D540)
#define MOLEMOLE_CHESSSTATEMACHINE_GLOBALPARAMSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB07E380)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int GlobalParamsConfig_TypeDefinitionIndex = 41642;

	class GlobalParamsConfig : public ::MoleMole::ChessStateMachine::ConfigBase
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::ChessStateMachine::ParamsClass*>* globalParams; // 0x28
