...
#define MOLEMOLE_CHESSSTATEMACHINE_GLOBALPARAMSCONFIG_CLEARCACHEDATA_OFFSET UNITYSDK_OFFSET(0x96EEF00)
#define MOLEMOLE_CHESSSTATEMACHINE_GLOBALPARAMSCONFIG_DEEPCOPY_OFFSET UNITYSDK_OFFSET(0x96EF0B0)
#define MOLEMOLE_CHESSSTATEMACHINE_GLOBALPARAMSCONFIG_INITPARAMSLIST_OFFSET UNITYSDK_OFFSET(0x96EE4C0)
#define MOLEMOLE_CHESSSTATEMACHINE_GLOBALPARAMSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x96EF310)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int GlobalParamsConfig_TypeDefinitionIndex = 46983;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::ChessStateMachine::ParamsClass*>*>* smParams; // 0x38
