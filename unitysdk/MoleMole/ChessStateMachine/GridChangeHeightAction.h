...
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION_DOCHANGESTRUCTANIM_OFFSET UNITYSDK_OFFSET(0xC3224F0)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION_NEEDCHANGESTRUCTBETWEENRISE_OFFSET UNITYSDK_OFFSET(0xC322470)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION_RUN_OFFSET UNITYSDK_OFFSET(0xC322320)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC322A40)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION__DOCHANGESTRUCTANIM_B__3_0_OFFSET UNITYSDK_OFFSET(0xC322A60)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int GridChangeHeightAction_TypeDefinitionIndex = 61581;
