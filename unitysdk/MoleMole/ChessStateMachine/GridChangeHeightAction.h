...
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION_DOCHANGESTRUCTANIM_OFFSET UNITYSDK_OFFSET(0x9BAA040)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION_NEEDCHANGESTRUCTBETWEENRISE_OFFSET UNITYSDK_OFFSET(0x9BA9FC0)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION_RUN_OFFSET UNITYSDK_OFFSET(0x9BA9E70)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x9BAA590)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDCHANGEHEIGHTACTION__DOCHANGESTRUCTANIM_B__3_0_OFFSET UNITYSDK_OFFSET(0x9BAA5B0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int GridChangeHeightAction_TypeDefinitionIndex = 39979;
