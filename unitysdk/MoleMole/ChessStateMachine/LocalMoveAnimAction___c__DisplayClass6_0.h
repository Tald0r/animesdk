...
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB45C680)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION___C__DISPLAYCLASS6_0__DORISEORSINKBYCONFIG_B__0_OFFSET UNITYSDK_OFFSET(0xB45C690)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION___C__DISPLAYCLASS6_0__DORISEORSINKBYCONFIG_B__1_OFFSET UNITYSDK_OFFSET(0xB45C730)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION___C__DISPLAYCLASS6_0__DORISEORSINKBYCONFIG_B__2_OFFSET UNITYSDK_OFFSET(0xB45C7D0)
#define MOLEMOLE_CHESSSTATEMACHINE_LOCALMOVEANIMACTION___C__DISPLAYCLASS6_0__DORISEORSINKBYCONFIG_B__3_OFFSET UNITYSDK_OFFSET(0xB45C870)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int LocalMoveAnimAction___c__DisplayClass6_0_TypeDefinitionIndex = 47130;

	class LocalMoveAnimAction___c__DisplayClass6_0 : public ::System::Object
	{
	public:
		::Class_5_0B648F1F8F6AC84A* chessPiece3dModel; // 0x10
