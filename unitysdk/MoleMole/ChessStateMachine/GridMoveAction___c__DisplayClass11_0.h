...
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDMOVEACTION___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x916CB90)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDMOVEACTION___C__DISPLAYCLASS11_0__DORISEORSINKBYCONFIG_B__0_OFFSET UNITYSDK_OFFSET(0x916CBA0)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDMOVEACTION___C__DISPLAYCLASS11_0__DORISEORSINKBYCONFIG_B__1_OFFSET UNITYSDK_OFFSET(0x916CC40)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDMOVEACTION___C__DISPLAYCLASS11_0__DORISEORSINKBYCONFIG_B__2_OFFSET UNITYSDK_OFFSET(0x916CCE0)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDMOVEACTION___C__DISPLAYCLASS11_0__DORISEORSINKBYCONFIG_B__3_OFFSET UNITYSDK_OFFSET(0x916CD80)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int GridMoveAction___c__DisplayClass11_0_TypeDefinitionIndex = 58239;

	class GridMoveAction___c__DisplayClass11_0 : public ::System::Object
	{
	public:
		::System::Action* onEnd; // 0x10
		::Class_5_0B648F1F8F6AC84A* chessPiece3dModel; // 0x18
