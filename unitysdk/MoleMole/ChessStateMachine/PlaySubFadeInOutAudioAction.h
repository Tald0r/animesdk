...
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYSUBFADEINOUTAUDIOACTION_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x10A7DCE0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYSUBFADEINOUTAUDIOACTION_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x10A7D930)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYSUBFADEINOUTAUDIOACTION_RUNINNER_OFFSET UNITYSDK_OFFSET(0x10A7DB70)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYSUBFADEINOUTAUDIOACTION_RUN_OFFSET UNITYSDK_OFFSET(0x10A7D940)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYSUBFADEINOUTAUDIOACTION_STOP_OFFSET UNITYSDK_OFFSET(0x10A7DD40)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYSUBFADEINOUTAUDIOACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x10A7DDA0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int PlaySubFadeInOutAudioAction_TypeDefinitionIndex = 80813;

	class PlaySubFadeInOutAudioAction : public ::MoleMole::ChessStateMachine::StateMachineAction
	{
	public:
		::System::Boolean NeedCustom; // 0x28
		::System::Boolean PlayDefaulOut; // 0x29
		::System::Boolean PlayDefaultIn; // 0x2A
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_22*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_PLAYSUBFADEINOUTAUDIOACTION_RUN_OFFSET))(this, context);
		}
