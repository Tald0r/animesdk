...
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYSUBFADEINOUTAUDIOACTION_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x89E5310)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYSUBFADEINOUTAUDIOACTION_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x89E4F60)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYSUBFADEINOUTAUDIOACTION_RUNINNER_OFFSET UNITYSDK_OFFSET(0x89E51A0)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYSUBFADEINOUTAUDIOACTION_RUN_OFFSET UNITYSDK_OFFSET(0x89E4F70)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYSUBFADEINOUTAUDIOACTION_STOP_OFFSET UNITYSDK_OFFSET(0x89E5370)
#define MOLEMOLE_CHESSSTATEMACHINE_PLAYSUBFADEINOUTAUDIOACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x89E53D0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int PlaySubFadeInOutAudioAction_TypeDefinitionIndex = 73138;

	class PlaySubFadeInOutAudioAction : public ::MoleMole::ChessStateMachine::StateMachineAction
	{
	public:
		::System::Boolean PlayDefaultIn; // 0x28
		::System::Boolean NeedCustom; // 0x29
		::System::Boolean PlayDefaulOut; // 0x2A
