...
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x81DA4A0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__RUN_B__1_OFFSET UNITYSDK_OFFSET(0x81DA4B0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__RUN_B__2_OFFSET UNITYSDK_OFFSET(0x81DA890)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__RUN_B__3_OFFSET UNITYSDK_OFFSET(0x81DA910)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETCONFIGACTION___C__DISPLAYCLASS7_0__RUN_B__4_OFFSET UNITYSDK_OFFSET(0x81DA990)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int TextureSheetConfigAction___c__DisplayClass7_0_TypeDefinitionIndex = 47029;
