...
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0x9BABD60)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_FINDBLENDTEXTURESHEETDATA_OFFSET UNITYSDK_OFFSET(0x9BAD350)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_GETTEXTURESHEETID_OFFSET UNITYSDK_OFFSET(0x9BABF90)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_HANDLENORMALVIEW_OFFSET UNITYSDK_OFFSET(0x9BAC630)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_PLAYADDITIVETEXTURE_OFFSET UNITYSDK_OFFSET(0x9BAB300)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_RUNINTERNAL_OFFSET UNITYSDK_OFFSET(0x9BAAD60)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_RUN_OFFSET UNITYSDK_OFFSET(0x9BAB690)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_UPDATECACHEDATA_OFFSET UNITYSDK_OFFSET(0x9BABA00)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x9BAB800)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x9BAD420)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION__RUN_OFFSET UNITYSDK_OFFSET(0x9BAB250)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION___BASE_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0x9BAD440)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION___BASE_RUN_OFFSET UNITYSDK_OFFSET(0x9BAD4A0)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x9BAD540)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ShowNpcMultiBodyNewAction_TypeDefinitionIndex = 76397;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_22*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_RUN_OFFSET))(this, context);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_22*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION___BASE_RUN_OFFSET))(this, P0);
		}
