...
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0xC324220)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_FINDBLENDTEXTURESHEETDATA_OFFSET UNITYSDK_OFFSET(0xC325810)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_GETTEXTURESHEETID_OFFSET UNITYSDK_OFFSET(0xC324450)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_HANDLENORMALVIEW_OFFSET UNITYSDK_OFFSET(0xC324AF0)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_PLAYADDITIVETEXTURE_OFFSET UNITYSDK_OFFSET(0xC3237B0)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_RUNINTERNAL_OFFSET UNITYSDK_OFFSET(0xC323210)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_RUN_OFFSET UNITYSDK_OFFSET(0xC323B50)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_UPDATECACHEDATA_OFFSET UNITYSDK_OFFSET(0xC323EC0)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION_UPDATE_OFFSET UNITYSDK_OFFSET(0xC323CC0)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC3258E0)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION__RUN_OFFSET UNITYSDK_OFFSET(0xC323700)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION___BASE_ACTIONOVER_OFFSET UNITYSDK_OFFSET(0xC325900)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION___BASE_RUN_OFFSET UNITYSDK_OFFSET(0xC325960)
#define MOLEMOLE_CHESSSTATEMACHINE_SHOWNPCMULTIBODYNEWACTION___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xC325A00)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ShowNpcMultiBodyNewAction_TypeDefinitionIndex = 76298;
