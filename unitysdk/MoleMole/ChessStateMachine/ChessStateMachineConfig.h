...
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSSTATEMACHINECONFIG_GETDEFAULTCONFIG_OFFSET UNITYSDK_OFFSET(0x653F600)
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSSTATEMACHINECONFIG_GETNODECONFIG_OFFSET UNITYSDK_OFFSET(0x653F4F0)
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSSTATEMACHINECONFIG_GET_GLOBALPARAMSCONFIG_OFFSET UNITYSDK_OFFSET(0x653F2F0)
#define MOLEMOLE_CHESSSTATEMACHINE_CHESSSTATEMACHINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x653F6F0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ChessStateMachineConfig_TypeDefinitionIndex = 76407;
	...
	public:
		...
		{
			return (::MoleMole::ChessStateMachine::GlobalParamsConfig**)Il2CppClass::FromTypeDefinitionIndex(ChessStateMachineConfig_TypeDefinitionIndex)->GetStaticField(0x43C60);
		}
