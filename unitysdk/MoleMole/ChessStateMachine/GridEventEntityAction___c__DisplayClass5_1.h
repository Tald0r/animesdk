...
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION___C__DISPLAYCLASS5_1__CTOR_OFFSET UNITYSDK_OFFSET(0x6BDF1A0)
#define MOLEMOLE_CHESSSTATEMACHINE_GRIDEVENTENTITYACTION___C__DISPLAYCLASS5_1__RUN_B__4_OFFSET UNITYSDK_OFFSET(0x6BDF1B0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int GridEventEntityAction___c__DisplayClass5_1_TypeDefinitionIndex = 69850;
