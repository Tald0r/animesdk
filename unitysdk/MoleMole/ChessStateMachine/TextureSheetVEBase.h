...
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_FINDBLENDTEXTURESHEETDATA_OFFSET UNITYSDK_OFFSET(0xB45E980)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_FINDTEXTURESHEETDATABYKEY_OFFSET UNITYSDK_OFFSET(0xB45EA50)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_FORCESTOP_OFFSET UNITYSDK_OFFSET(0xB45ED30)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0xB45EF50)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_RANDOMTEXTURESHEETKEY_OFFSET UNITYSDK_OFFSET(0xB45E8C0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_RUN_OFFSET UNITYSDK_OFFSET(0xB45EE80)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_STOP_OFFSET UNITYSDK_OFFSET(0xB45EEF0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xB45EDA0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int TextureSheetVEBase_TypeDefinitionIndex = 70422;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_22*))((::PBYTE)hIl2Cpp + MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_RUN_OFFSET))(this, context);
		}
