...
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_FINDBLENDTEXTURESHEETDATA_OFFSET UNITYSDK_OFFSET(0x9B4F610)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_FINDTEXTURESHEETDATABYKEY_OFFSET UNITYSDK_OFFSET(0x9B4F6E0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_FORCESTOP_OFFSET UNITYSDK_OFFSET(0x9B4F9C0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_GET_ISINSTANT_OFFSET UNITYSDK_OFFSET(0x9B4FBE0)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_RANDOMTEXTURESHEETKEY_OFFSET UNITYSDK_OFFSET(0x9B4F550)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_RUN_OFFSET UNITYSDK_OFFSET(0x9B4FB10)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE_STOP_OFFSET UNITYSDK_OFFSET(0x9B4FB80)
#define MOLEMOLE_CHESSSTATEMACHINE_TEXTURESHEETVEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B4FA30)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int TextureSheetVEBase_TypeDefinitionIndex = 53600;
