...
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x7BB8C60)
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_0__RUN_B__0_OFFSET UNITYSDK_OFFSET(0x7BB8C70)
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_0__RUN_B__2_OFFSET UNITYSDK_OFFSET(0x7BB8E30)
#define MOLEMOLE_CHESSSTATEMACHINE_SUBSTATEFADEOUTENTITYACTION___C__DISPLAYCLASS3_0__RUN_G____CLOSESUBSTATE_1_OFFSET UNITYSDK_OFFSET(0x7BB8CA0)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int SubStateFadeOutEntityAction___c__DisplayClass3_0_TypeDefinitionIndex = 61913;
	...
	public:
		...
		::Class_4_AC6D98911872E0CE* chessPieceProxy; // 0x18
