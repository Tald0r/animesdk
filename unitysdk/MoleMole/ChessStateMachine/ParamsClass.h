...
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CHECKTYPEVALID_OFFSET UNITYSDK_OFFSET(0x9B4E130)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CHECKVALUE_1_OFFSET UNITYSDK_OFFSET(0x9B4E540)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CHECKVALUE_2_OFFSET UNITYSDK_OFFSET(0x9B4E5B0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CHECKVALUE_OFFSET UNITYSDK_OFFSET(0x9B4E450)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_CLEARCACHEDATA_OFFSET UNITYSDK_OFFSET(0x9B4E690)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_DRAWVALUESET_OFFSET UNITYSDK_OFFSET(0x9B4E0D0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GETVALUE_1_OFFSET UNITYSDK_OFFSET(0x9B4E370)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GETVALUE_2_OFFSET UNITYSDK_OFFSET(0x9B4E3E0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GETVALUE_OFFSET UNITYSDK_OFFSET(0x9B4E300)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GET_PARAMSTYPE_1_OFFSET UNITYSDK_OFFSET(0x9B4E680)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GET_PARAMSTYPE_OFFSET UNITYSDK_OFFSET(0x9B4D9F0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x9B4DA70)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_INITVALUE_OFFSET UNITYSDK_OFFSET(0x9B4DA00)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_RESETAFTERCHECKVALID_OFFSET UNITYSDK_OFFSET(0x9B4E750)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_SETVALUE_1_OFFSET UNITYSDK_OFFSET(0x9B4E220)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_SETVALUE_2_OFFSET UNITYSDK_OFFSET(0x9B4E290)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS_SETVALUE_OFFSET UNITYSDK_OFFSET(0x9B4E1A0)
#define MOLEMOLE_CHESSSTATEMACHINE_PARAMSCLASS__CTOR_OFFSET UNITYSDK_OFFSET(0x9B4E810)

namespace MoleMole::ChessStateMachine
{
	inline static constexpr unsigned int ParamsClass_TypeDefinitionIndex = 36542;
