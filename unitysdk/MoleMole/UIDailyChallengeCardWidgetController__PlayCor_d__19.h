...
#define MOLEMOLE_UIDAILYCHALLENGECARDWIDGETCONTROLLER__PLAYCOR_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xAC4A4B0)
#define MOLEMOLE_UIDAILYCHALLENGECARDWIDGETCONTROLLER__PLAYCOR_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAC4A550)
#define MOLEMOLE_UIDAILYCHALLENGECARDWIDGETCONTROLLER__PLAYCOR_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAC4A5B0)
#define MOLEMOLE_UIDAILYCHALLENGECARDWIDGETCONTROLLER__PLAYCOR_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xAC4A560)
#define MOLEMOLE_UIDAILYCHALLENGECARDWIDGETCONTROLLER__PLAYCOR_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAC4A4A0)
#define MOLEMOLE_UIDAILYCHALLENGECARDWIDGETCONTROLLER__PLAYCOR_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0xAC4A490)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyChallengeCardWidgetController__PlayCor_d__19_TypeDefinitionIndex = 73452;

	class UIDailyChallengeCardWidgetController__PlayCor_d__19 : public ::System::Object
	{
	public:
		::MoleMole::UIDailyChallengeCardWidgetController* __4__this; // 0x10
