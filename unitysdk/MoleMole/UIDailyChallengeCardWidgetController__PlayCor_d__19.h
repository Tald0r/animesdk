...
#define MOLEMOLE_UIDAILYCHALLENGECARDWIDGETCONTROLLER__PLAYCOR_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x806C8E0)
#define MOLEMOLE_UIDAILYCHALLENGECARDWIDGETCONTROLLER__PLAYCOR_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x806C980)
#define MOLEMOLE_UIDAILYCHALLENGECARDWIDGETCONTROLLER__PLAYCOR_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x806C9E0)
#define MOLEMOLE_UIDAILYCHALLENGECARDWIDGETCONTROLLER__PLAYCOR_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x806C990)
#define MOLEMOLE_UIDAILYCHALLENGECARDWIDGETCONTROLLER__PLAYCOR_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x806C8D0)
#define MOLEMOLE_UIDAILYCHALLENGECARDWIDGETCONTROLLER__PLAYCOR_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x806C8C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyChallengeCardWidgetController__PlayCor_d__19_TypeDefinitionIndex = 65178;
