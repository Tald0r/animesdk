...
#define MOLEMOLE_GBUFFERPREZOPTBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x7F0F1E0)
#define MOLEMOLE_GBUFFERPREZOPTBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x7F0F270)
#define MOLEMOLE_GBUFFERPREZOPTBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x7F0F2D0)

namespace MoleMole
{
	inline static constexpr unsigned int GbufferPreZOptByGPUModelPostProcessorProfile_TypeDefinitionIndex = 51456;
