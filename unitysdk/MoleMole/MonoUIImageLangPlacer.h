...
#define MOLEMOLE_MONOUIIMAGELANGPLACER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA47A310)
#define MOLEMOLE_MONOUIIMAGELANGPLACER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA47A5C0)
#define MOLEMOLE_MONOUIIMAGELANGPLACER_SETIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xA47A7B0)
#define MOLEMOLE_MONOUIIMAGELANGPLACER_SETLANGUAGEIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xA47A3E0)
#define MOLEMOLE_MONOUIIMAGELANGPLACER__CTOR_OFFSET UNITYSDK_OFFSET(0xA47AA70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIImageLangPlacer_TypeDefinitionIndex = 61577;
