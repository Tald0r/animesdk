...
#define MOLEMOLE_MONOUIIMAGELANGPLACER_AWAKE_OFFSET UNITYSDK_OFFSET(0x67C6060)
#define MOLEMOLE_MONOUIIMAGELANGPLACER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x67C6310)
#define MOLEMOLE_MONOUIIMAGELANGPLACER_SETIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x67C6500)
#define MOLEMOLE_MONOUIIMAGELANGPLACER_SETLANGUAGEIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x67C6130)
#define MOLEMOLE_MONOUIIMAGELANGPLACER__CTOR_OFFSET UNITYSDK_OFFSET(0x67C67C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIImageLangPlacer_TypeDefinitionIndex = 63590;
