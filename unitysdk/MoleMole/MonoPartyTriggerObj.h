...
#define MOLEMOLE_MONOPARTYTRIGGEROBJ_ONDOCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x82FF840)
#define MOLEMOLE_MONOPARTYTRIGGEROBJ_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x82FF7D0)
#define MOLEMOLE_MONOPARTYTRIGGEROBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x82FFB60)

namespace MoleMole
{
	inline static constexpr unsigned int MonoPartyTriggerObj_TypeDefinitionIndex = 41676;
