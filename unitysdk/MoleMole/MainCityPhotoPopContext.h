...
#define MOLEMOLE_MAINCITYPHOTOPOPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBA1B9D0)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityPhotoPopContext_TypeDefinitionIndex = 37736;
	...
	public:
		...
		::System::Boolean IsCloseUIWithBlackCurtain; // 0x4C
		::Enum_3_9D236B7BC4C0A720 photoSourceType; // 0x50
