...
#define MOLEMOLE_UIPLAYERSKINSWITCHWIDGETCONTROLLER___C__DISPLAYCLASS37_0__CTOR_OFFSET UNITYSDK_OFFSET(0x68E1690)
#define MOLEMOLE_UIPLAYERSKINSWITCHWIDGETCONTROLLER___C__DISPLAYCLASS37_0__SWITCHTOAVATAR_B__0_OFFSET UNITYSDK_OFFSET(0x68E16A0)
#define MOLEMOLE_UIPLAYERSKINSWITCHWIDGETCONTROLLER___C__DISPLAYCLASS37_0__SWITCHTOAVATAR_B__1_OFFSET UNITYSDK_OFFSET(0x68E1810)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerSkinSwitchWidgetController___c__DisplayClass37_0_TypeDefinitionIndex = 59058;
