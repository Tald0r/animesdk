...
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER_ONCLICKBUTTON_OFFSET UNITYSDK_OFFSET(0xBF44D00)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF44B80)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF44C20)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF44640)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF446E0)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER_REFRESHITEMSTATE_OFFSET UNITYSDK_OFFSET(0xBF44810)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF44E90)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF44EC0)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF44F30)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF44FB0)
#define MOLEMOLE_UICINEMACOLLECTPROPOINTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF45010)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaCollectProPointWidgetController_TypeDefinitionIndex = 65468;

	class UICinemaCollectProPointWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_C5C76936C9D491E6* _view; // 0x2A0
