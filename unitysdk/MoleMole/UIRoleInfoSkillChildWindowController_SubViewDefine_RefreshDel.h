...
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_REFRESHDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAB94820)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_REFRESHDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAB94890)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_REFRESHDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0xAB94530)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_REFRESHDEL__CTOR_OFFSET UNITYSDK_OFFSET(0xAB94520)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoSkillChildWindowController_SubViewDefine_RefreshDel_TypeDefinitionIndex = 49311;
