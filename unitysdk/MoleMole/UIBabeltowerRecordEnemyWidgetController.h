...
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF0DDD0)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF0DE70)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF0DB70)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF0DC10)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER_REFRESHCARD_OFFSET UNITYSDK_OFFSET(0xDF0DF50)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF0E220)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET UNITYSDK_OFFSET(0xDF0E180)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF0E250)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF0E2C0)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF0E340)
#define MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF0E3A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerRecordEnemyWidgetController_TypeDefinitionIndex = 46502;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_300*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERRECORDENEMYWIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET))(this, cardConfigTemplate);
		}
