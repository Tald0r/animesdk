...
#define MOLEMOLE_PRELOADLEVELCONFIG_BUILDPRELOADLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0x83120F0)
#define MOLEMOLE_PRELOADLEVELCONFIG_SHOWLOWMEMORYEFFECTPATHS_OFFSET UNITYSDK_OFFSET(0xB8C3E10)
#define MOLEMOLE_PRELOADLEVELCONFIG_SHOWMAYINVALIDPATHS_OFFSET UNITYSDK_OFFSET(0xB8C3DB0)
#define MOLEMOLE_PRELOADLEVELCONFIG_VIEWCOMMONGROUP_OFFSET UNITYSDK_OFFSET(0xB8C3A80)
#define MOLEMOLE_PRELOADLEVELCONFIG_VIEWSINGLEGROUP_OFFSET UNITYSDK_OFFSET(0x83121E0)
#define MOLEMOLE_PRELOADLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB8C3E70)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadLevelConfig_TypeDefinitionIndex = 68702;
