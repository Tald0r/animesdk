...
#define MOLEMOLE_PRELOADLEVELCONFIG_BUILDPRELOADLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0xB930030)
#define MOLEMOLE_PRELOADLEVELCONFIG_SHOWLOWMEMORYEFFECTPATHS_OFFSET UNITYSDK_OFFSET(0xB931B60)
#define MOLEMOLE_PRELOADLEVELCONFIG_SHOWMAYINVALIDPATHS_OFFSET UNITYSDK_OFFSET(0xB931B00)
#define MOLEMOLE_PRELOADLEVELCONFIG_VIEWCOMMONGROUP_OFFSET UNITYSDK_OFFSET(0xB9317D0)
#define MOLEMOLE_PRELOADLEVELCONFIG_VIEWSINGLEGROUP_OFFSET UNITYSDK_OFFSET(0xB930120)
#define MOLEMOLE_PRELOADLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB931BC0)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadLevelConfig_TypeDefinitionIndex = 66674;
