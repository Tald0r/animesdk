...
#define MOLEMOLE_UIURBANMAPHOLLOWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA089090)
#define MOLEMOLE_UIURBANMAPHOLLOWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA089100)
#define MOLEMOLE_UIURBANMAPHOLLOWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA089200)
#define MOLEMOLE_UIURBANMAPHOLLOWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA089340)
#define MOLEMOLE_UIURBANMAPHOLLOWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA089370)
#define MOLEMOLE_UIURBANMAPHOLLOWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA0893E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapHollowWidgetController_TypeDefinitionIndex = 78319;
