...
#define MOLEMOLE_SLIDINGCONFIG_GETACCELERATION_OFFSET UNITYSDK_OFFSET(0xD1A2630)
#define MOLEMOLE_SLIDINGCONFIG_GETCHECKINGRAYCASTLENGTH_OFFSET UNITYSDK_OFFSET(0xD1A2BA0)
#define MOLEMOLE_SLIDINGCONFIG_GETFRICTION_OFFSET UNITYSDK_OFFSET(0xD1A2490)
#define MOLEMOLE_SLIDINGCONFIG_GETGRAVITY_OFFSET UNITYSDK_OFFSET(0xD1A2D80)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXDELTAANGLEPERSECONDINAIR_OFFSET UNITYSDK_OFFSET(0xD1A2B00)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXDELTAANGLEPERSECOND_OFFSET UNITYSDK_OFFSET(0xD1A29A0)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXXZSPEEDTHRESHOLD_OFFSET UNITYSDK_OFFSET(0xD1A2860)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXYSPEEDTHRESHOLD_OFFSET UNITYSDK_OFFSET(0xD1A2900)
#define MOLEMOLE_SLIDINGCONFIG_GETMINVELOCITYTHRESHOLD_OFFSET UNITYSDK_OFFSET(0xD1A27C0)
#define MOLEMOLE_SLIDINGCONFIG_GETSLIDINGDELTATHRESHOLD_OFFSET UNITYSDK_OFFSET(0xD1A2F80)
#define MOLEMOLE_SLIDINGCONFIG_GETSLIDINGRAYCASTLENGTH2_OFFSET UNITYSDK_OFFSET(0xD1A2C40)
#define MOLEMOLE_SLIDINGCONFIG_GETSLIDINGRAYCASTLENGTH_OFFSET UNITYSDK_OFFSET(0xD1A2CE0)
#define MOLEMOLE_SLIDINGCONFIG_RELOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0xD1A2380)
#define MOLEMOLE_SLIDINGCONFIG_RELOADFROMFILE_OFFSET UNITYSDK_OFFSET(0xD1A2130)
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGSMOOTHVALUE_OFFSET UNITYSDK_OFFSET(0xD1A2E20)
#define MOLEMOLE_SLIDINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD1A3020)

namespace MoleMole
{
	inline static constexpr unsigned int SlidingConfig_TypeDefinitionIndex = 46098;
	...
	public:
		...
		{
			return (::MoleMole::SlidingConfig**)Il2CppClass::FromTypeDefinitionIndex(SlidingConfig_TypeDefinitionIndex)->GetStaticField(0x3A6E0);
		}
