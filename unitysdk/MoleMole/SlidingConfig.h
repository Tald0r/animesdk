...
#define MOLEMOLE_SLIDINGCONFIG_GETACCELERATION_OFFSET UNITYSDK_OFFSET(0x6ED6860)
#define MOLEMOLE_SLIDINGCONFIG_GETCHECKINGRAYCASTLENGTH_OFFSET UNITYSDK_OFFSET(0x6ED6DD0)
#define MOLEMOLE_SLIDINGCONFIG_GETFRICTION_OFFSET UNITYSDK_OFFSET(0x6ED66C0)
#define MOLEMOLE_SLIDINGCONFIG_GETGRAVITY_OFFSET UNITYSDK_OFFSET(0x6ED6FB0)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXDELTAANGLEPERSECONDINAIR_OFFSET UNITYSDK_OFFSET(0x6ED6D30)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXDELTAANGLEPERSECOND_OFFSET UNITYSDK_OFFSET(0x6ED6BD0)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXXZSPEEDTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x6ED6A90)
#define MOLEMOLE_SLIDINGCONFIG_GETMAXYSPEEDTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x6ED6B30)
#define MOLEMOLE_SLIDINGCONFIG_GETMINVELOCITYTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x6ED69F0)
#define MOLEMOLE_SLIDINGCONFIG_GETSLIDINGDELTATHRESHOLD_OFFSET UNITYSDK_OFFSET(0x6ED71B0)
#define MOLEMOLE_SLIDINGCONFIG_GETSLIDINGRAYCASTLENGTH2_OFFSET UNITYSDK_OFFSET(0x6ED6E70)
#define MOLEMOLE_SLIDINGCONFIG_GETSLIDINGRAYCASTLENGTH_OFFSET UNITYSDK_OFFSET(0x6ED6F10)
#define MOLEMOLE_SLIDINGCONFIG_RELOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0x6ED65B0)
#define MOLEMOLE_SLIDINGCONFIG_RELOADFROMFILE_OFFSET UNITYSDK_OFFSET(0x6ED6360)
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGSMOOTHVALUE_OFFSET UNITYSDK_OFFSET(0x6ED7050)
#define MOLEMOLE_SLIDINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6ED7250)

namespace MoleMole
{
	inline static constexpr unsigned int SlidingConfig_TypeDefinitionIndex = 46261;
	...
	public:
		...
		{
			return (::MoleMole::SlidingConfig**)Il2CppClass::FromTypeDefinitionIndex(SlidingConfig_TypeDefinitionIndex)->GetStaticField(0x3D480);
		}
