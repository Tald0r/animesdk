...
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x98EC1D0)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x98EC240)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x98EC300)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98EC440)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x98EC470)
#define MOLEMOLE_UIMUSICALBATTLELEVELTASKROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x98EC4E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicalBattleLevelTaskRowWidgetController_TypeDefinitionIndex = 69290;
