...
#define MOLEMOLE_INLEVELCOMMONSKILLKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xA5F7590)
#define MOLEMOLE_INLEVELCOMMONSKILLKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xA5F75A0)
#define MOLEMOLE_INLEVELCOMMONSKILLKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F75B0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelCommonSkillKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 64256;
