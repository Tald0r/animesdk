...
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_EMPTYROWDATA_OFFSET UNITYSDK_OFFSET(0x870F020)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x870EE50)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x870F0D0)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x870ED90)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x870F680)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER_ROWDATA_OFFSET UNITYSDK_OFFSET(0x870EEE0)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8710260)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER___BASE_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x8710270)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER___BASE_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x87102A0)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8710300)
#define MOLEMOLE_UIMECHRESULTPAGECONTROLLER___BASE_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x8710310)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechResultPageController_TypeDefinitionIndex = 58391;
