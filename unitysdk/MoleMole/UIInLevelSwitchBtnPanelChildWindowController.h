...
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_CALBUTTONCENTERPOSITION_1_OFFSET UNITYSDK_OFFSET(0xC105310)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_CALBUTTONCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0xC1051C0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_CALTOUCHBUTTONUPTYPE_1_OFFSET UNITYSDK_OFFSET(0xC1059C0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_CALTOUCHBUTTONUPTYPE_OFFSET UNITYSDK_OFFSET(0xC1034C0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_CHECKBUTTONNEW_OFFSET UNITYSDK_OFFSET(0xC104510)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_CHECKBUTTONOLD_OFFSET UNITYSDK_OFFSET(0xC104E40)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_CLEARMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0xC101AE0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_DOAVATARAIDTRIGGER_OFFSET UNITYSDK_OFFSET(0xC102A90)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_DOAVATARENDAIDTRIGGER_OFFSET UNITYSDK_OFFSET(0xC102C50)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_GETUIHIDEITEMTAG_OFFSET UNITYSDK_OFFSET(0xC102750)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_GET_ENABLEDRAGINPUTINSKILLBUTTON_OFFSET UNITYSDK_OFFSET(0xC1026A0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_GET_LOGICTYPE_OFFSET UNITYSDK_OFFSET(0xC0FFD30)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC0FFF10)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_INITDRAGINPUTSUPPORT_OFFSET UNITYSDK_OFFSET(0xC100F50)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_INITMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0xC100050)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_INITSKILLBTNSPECIALFEEDBACK_OFFSET UNITYSDK_OFFSET(0xC100D40)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_INITSWITCHAVATARBTN_OFFSET UNITYSDK_OFFSET(0xC100660)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_INITSWITCHAVATARCOMPONENT_OFFSET UNITYSDK_OFFSET(0xC102A00)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ISLOCALAVATARSHOWPERFECTSWITCHENERGY_OFFSET UNITYSDK_OFFSET(0xC1076C0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0xC102570)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0xC106190)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0FFF20)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC101DD0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONPREUPDATE_OFFSET UNITYSDK_OFFSET(0xC103C60)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONQTEPOINTCHANGED_OFFSET UNITYSDK_OFFSET(0xC1072C0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONTOUCHPOINTERDOWN_LOGIC_WITHNOTHING_OFFSET UNITYSDK_OFFSET(0xC103730)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONTOUCHPOINTERDOWN_LOGIC_WITHPOINTERPOSITION_OFFSET UNITYSDK_OFFSET(0xC103070)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONTOUCHPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xC102F70)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONTOUCHPOINTERDRAGINNER_OFFSET UNITYSDK_OFFSET(0xC103870)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONTOUCHPOINTERDRAG_OFFSET UNITYSDK_OFFSET(0xC1037C0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONTOUCHPOINTERENTER_OFFSET UNITYSDK_OFFSET(0xC103AB0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONTOUCHPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0xC103B50)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONTOUCHPOINTERUP_LOGIC_WITHNOTHING_OFFSET UNITYSDK_OFFSET(0xC1026B0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONTOUCHPOINTERUP_LOGIC_WITHPOINTERPOSITION_OFFSET UNITYSDK_OFFSET(0xC1031A0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONTOUCHPOINTERUP_LOGIC_WITHTOUCHBUTTONUPTYPE_OFFSET UNITYSDK_OFFSET(0xC103680)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONTOUCHPOINTERUP_OFFSET UNITYSDK_OFFSET(0xC103110)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONTOUCHPOINTERUP_VIEW_OFFSET UNITYSDK_OFFSET(0xC103340)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC1016F0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC101760)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0FFFC0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC1013C0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_REFRESHAIDATTACKSTATE_OFFSET UNITYSDK_OFFSET(0xC107650)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_REFRESHQTEPOINT_OFFSET UNITYSDK_OFFSET(0xC107340)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_REFRESHSWITCHMATERIAL_OFFSET UNITYSDK_OFFSET(0xC107440)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_REGISTERONQTEPOINTCHANGED_OFFSET UNITYSDK_OFFSET(0xC102E10)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_RESETBUTTONROOTANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0xC103BF0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_SETBUTTONICON_OFFSET UNITYSDK_OFFSET(0xC101330)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_SET_LOGICTYPE_OFFSET UNITYSDK_OFFSET(0xC0FFEB0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_SWITCHAVATAR_OFFSET UNITYSDK_OFFSET(0xC102480)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_TRYFIRELOGICBUTTONINPUT_OFFSET UNITYSDK_OFFSET(0xC105E30)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_UNREGISTERONQTEPOINTCHANGED_OFFSET UNITYSDK_OFFSET(0xC101CE0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_UPDATEBUTTONVIEWNEW_OFFSET UNITYSDK_OFFSET(0xC104CD0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_UPDATEMUTESWITCHSTATE_OFFSET UNITYSDK_OFFSET(0xC1067D0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_UPDATEPERFECTSWITCH_OFFSET UNITYSDK_OFFSET(0xC106230)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_UPDATEQTETRIGGERMASK_OFFSET UNITYSDK_OFFSET(0xC107120)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_UPDATERECOVERYMASK_OFFSET UNITYSDK_OFFSET(0xC106F40)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_UPDATESWITCHBTNVIEWTYPE_OFFSET UNITYSDK_OFFSET(0xC103EA0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC107A20)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC1079A0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__INITDRAGINPUTSUPPORT_B__69_0_OFFSET UNITYSDK_OFFSET(0xC1080A0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__INITDRAGINPUTSUPPORT_B__69_1_OFFSET UNITYSDK_OFFSET(0xC108250)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__ONUIOPEN_B__18_0_OFFSET UNITYSDK_OFFSET(0xC107A60)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__ONUIOPEN_B__18_1_OFFSET UNITYSDK_OFFSET(0xC107AE0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__ONUIOPEN_B__18_2_OFFSET UNITYSDK_OFFSET(0xC107B60)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__ONUIOPEN_B__18_4_OFFSET UNITYSDK_OFFSET(0xC107BD0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__ONUIOPEN_B__18_5_OFFSET UNITYSDK_OFFSET(0xC108070)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__ONUIOPEN_B__18_6_OFFSET UNITYSDK_OFFSET(0xC107FF0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__ONUIOPEN_B__18_7_OFFSET UNITYSDK_OFFSET(0xC108030)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC108860)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC1088D0)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC108900)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC108910)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC108920)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC108930)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelSwitchBtnPanelChildWindowController_TypeDefinitionIndex = 48343;
	...
	public:
		...
		{
			return (::MoleMole::UIInLevelSwitchBtnPanelChildWindowController_TriggerType*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelSwitchBtnPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0xE770);
		}
		static ::MoleMole::UIInLevelSwitchBtnPanelChildWindowController_LogicType* StaticGet__logicType()
		{
			return (::MoleMole::UIInLevelSwitchBtnPanelChildWindowController_LogicType*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelSwitchBtnPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0xE774);
		}
		static ::MoleMole::UIInLevelSwitchBtnPanelChildWindowController_FadeOutType* StaticGet_fadeOutType()
		{
			return (::MoleMole::UIInLevelSwitchBtnPanelChildWindowController_FadeOutType*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelSwitchBtnPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0xE778);
		}
		static ::MoleMole::UIInLevelSwitchBtnPanelChildWindowController_FadeInType* StaticGet_fadeInType()
		{
			return (::MoleMole::UIInLevelSwitchBtnPanelChildWindowController_FadeInType*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelSwitchBtnPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0xE77C);
		}
		static ::MoleMole::UIInLevelSwitchBtnPanelChildWindowController_DragType* StaticGet_dragType()
		{
			return (::MoleMole::UIInLevelSwitchBtnPanelChildWindowController_DragType*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelSwitchBtnPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0xE780);
		}
		::System::String* _uiHideItemTag; // 0x2F8
		::System::Boolean _isMatDirty; // 0x300
		::Class_2_60638234271CCDB8_83* _view; // 0x308
		...
		static ::UnityEngine::Vector2 CalButtonCenterPosition(::Class_2_60638234271CCDB8_83* view, ::UnityEngine::Vector2 touchPosition, ::System::Nullable_1<::UnityEngine::Vector2> touchStartPosition)
		{
			return ((::UnityEngine::Vector2(*)(::Class_2_60638234271CCDB8_83*, ::UnityEngine::Vector2, ::System::Nullable_1<::UnityEngine::Vector2>))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_CALBUTTONCENTERPOSITION_OFFSET))(view, touchPosition, touchStartPosition);
		}

		static ::MoleMole::UIInLevelSwitchBtnPanelChildWindowController_TouchButtonUpType CalTouchButtonUpType(::Class_2_60638234271CCDB8_83* view, ::UnityEngine::Vector2 touchScreenPoint, ::System::Nullable_1<::UnityEngine::Vector2> dragStartScreenPoint)
		{
			return ((::MoleMole::UIInLevelSwitchBtnPanelChildWindowController_TouchButtonUpType(*)(::Class_2_60638234271CCDB8_83*, ::UnityEngine::Vector2, ::System::Nullable_1<::UnityEngine::Vector2>))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER_CALTOUCHBUTTONUPTYPE_OFFSET))(view, touchScreenPoint, dragStartScreenPoint);
		}
