...
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7FA8B20)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x7FA8BC0)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7FA8F00)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7FA88C0)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7FA8A70)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7FA8FE0)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7FA8FF0)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x7FA9060)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7FA90E0)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7FA9160)
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7FA91C0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelInfoWidgetController_TypeDefinitionIndex = 41343;

	class UILevelInfoWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_340B2AAA6C37DD6E_2* _view; // 0x2D0
