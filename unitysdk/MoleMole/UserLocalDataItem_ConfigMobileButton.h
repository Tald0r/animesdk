...
#define MOLEMOLE_USERLOCALDATAITEM_CONFIGMOBILEBUTTON_METHOD_1_D5D789CEDB33DF97_OFFSET UNITYSDK_OFFSET(0xEE6E810)
#define MOLEMOLE_USERLOCALDATAITEM_CONFIGMOBILEBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0xEE6E800)

namespace MoleMole
{
	inline static constexpr unsigned int UserLocalDataItem_ConfigMobileButton_TypeDefinitionIndex = 60254;
