...
#define MOLEMOLE_UIHOLLOWABYSSS2LAYERRESULTDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8A2B210)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowAbyssS2LayerResultDialogContext_TypeDefinitionIndex = 42291;
