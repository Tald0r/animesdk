...
#define MOLEMOLE_UIINTERKNOTOVERNIGHTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x745AA60)
#define MOLEMOLE_UIINTERKNOTOVERNIGHTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x745AA70)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotOverNightPopWindowController_TypeDefinitionIndex = 78727;
