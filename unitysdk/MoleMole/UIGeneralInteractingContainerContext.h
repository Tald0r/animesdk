...
#define MOLEMOLE_UIGENERALINTERACTINGCONTAINERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7A3FC40)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralInteractingContainerContext_TypeDefinitionIndex = 59653;
