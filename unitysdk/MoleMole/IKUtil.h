...
#define MOLEMOLE_IKUTIL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7F10900)
#define MOLEMOLE_IKUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x7F10AB0)

namespace MoleMole
{
	inline static constexpr unsigned int IKUtil_TypeDefinitionIndex = 76723;
