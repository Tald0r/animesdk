...
#define MOLEMOLE_DITHERCONFIGSEPARATE__CTOR_OFFSET UNITYSDK_OFFSET(0xE456FA0)

namespace MoleMole
{
	inline static constexpr unsigned int DitherConfigSeparate_TypeDefinitionIndex = 78616;
