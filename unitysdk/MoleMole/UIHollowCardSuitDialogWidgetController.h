...
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC83420)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC834C0)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC832D0)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC83370)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC835A0)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC835D0)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC83640)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC836C0)
#define MOLEMOLE_UIHOLLOWCARDSUITDIALOGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC83720)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardSuitDialogWidgetController_TypeDefinitionIndex = 72154;

	class UIHollowCardSuitDialogWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_879190EF9CE803C9* _view; // 0x2A0
