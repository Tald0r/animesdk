...
#define MOLEMOLE_MONOUIIMAGECOLORCHANGE_APPLY_OFFSET UNITYSDK_OFFSET(0x7A94E50)
#define MOLEMOLE_MONOUIIMAGECOLORCHANGE_GET_CHANGETAG_OFFSET UNITYSDK_OFFSET(0x7A94E40)
#define MOLEMOLE_MONOUIIMAGECOLORCHANGE_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x7A94FA0)
#define MOLEMOLE_MONOUIIMAGECOLORCHANGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x7A95050)
#define MOLEMOLE_MONOUIIMAGECOLORCHANGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x7A94FB0)
#define MOLEMOLE_MONOUIIMAGECOLORCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x7A950F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIImageColorChange_TypeDefinitionIndex = 46524;
