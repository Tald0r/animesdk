...
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD76DED0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__TRYGETMAILAWARD_B__0_OFFSET UNITYSDK_OFFSET(0xD76DEE0)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__TRYGETMAILAWARD_B__2_OFFSET UNITYSDK_OFFSET(0xD76E440)
#define MOLEMOLE_UIMAILDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__TRYGETMAILAWARD_G__TRYADDMAILTOGETAWARDLIST_1_OFFSET UNITYSDK_OFFSET(0xD76E460)

namespace MoleMole
{
	inline static constexpr unsigned int UIMailDialogPopWindowController___c__DisplayClass23_0_TypeDefinitionIndex = 69848;
