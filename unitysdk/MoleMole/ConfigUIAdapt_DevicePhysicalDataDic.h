...
#define MOLEMOLE_CONFIGUIADAPT_DEVICEPHYSICALDATADIC__CTOR_OFFSET UNITYSDK_OFFSET(0xB5A3050)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAdapt_DevicePhysicalDataDic_TypeDefinitionIndex = 51535;
