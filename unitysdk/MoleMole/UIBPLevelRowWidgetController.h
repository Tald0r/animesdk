...
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ANIMATEEXPNUMBER_OFFSET UNITYSDK_OFFSET(0xBF353C0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_INITLEVELWIDGET_OFFSET UNITYSDK_OFFSET(0xBF337A0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONBPPURCHASEDIALOGCLOSE_OFFSET UNITYSDK_OFFSET(0xBF35330)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF33CC0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONFIRSTINCREASEEND_OFFSET UNITYSDK_OFFSET(0xBF35970)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xBF33D60)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONLEVELINFOCHANGED_OFFSET UNITYSDK_OFFSET(0xBF350C0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBF33C10)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF33E80)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF334C0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF33B60)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_SETBPLEVELINFO_OFFSET UNITYSDK_OFFSET(0xBF34440)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_SETFINALSTATEVALUE_OFFSET UNITYSDK_OFFSET(0xBF35E40)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_SETLEVELTEXT_OFFSET UNITYSDK_OFFSET(0xBF34710)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0xBF34A90)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_SETUPPEREXPNUM_OFFSET UNITYSDK_OFFSET(0xBF344D0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_STARTBUYPOPWINDOW_OFFSET UNITYSDK_OFFSET(0xBF34BA0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_STARTSECONDINCREASE_OFFSET UNITYSDK_OFFSET(0xBF35D30)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_STARTUPPEREXPPOPWINDOW_OFFSET UNITYSDK_OFFSET(0xBF34E50)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_SYNCBPMODELINFO_OFFSET UNITYSDK_OFFSET(0xBF35140)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF35F00)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER__ONFIRSTINCREASEEND_B__33_0_OFFSET UNITYSDK_OFFSET(0xBF35F60)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER__STARTSECONDINCREASE_B__34_0_OFFSET UNITYSDK_OFFSET(0xBF36090)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF36320)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xBF36390)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBF363F0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF36460)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF364E0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF36540)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPLevelRowWidgetController_TypeDefinitionIndex = 56525;

	class UIBPLevelRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		// static const ::System::String* levelUPAnimName; // 0x0
		::Class_2_79AE422BA06F6D26_72* _view; // 0x2A0
		::System::Int32 showLevel; // 0x2A8
		::System::Int32 weeklyExp; // 0x2AC
		::System::Int32 exp; // 0x2B0
		::Foundation::Coroutine::CoroutineHandle animHandle; // 0x2B4
		::Foundation::Coroutine::CoroutineHandle secondAnimHandle; // 0x2B8
		::MoleMole::MonoBPLevelAnimation* bpLevelAnimation; // 0x2C0
		::System::Single preExpRatio; // 0x2C8
		::System::Single showExpRatio; // 0x2CC
		::System::Int32 startExpResidue; // 0x2D0
		::System::Single animTime; // 0x2D4
		::System::Single animProgress; // 0x2D8
		::System::Int32 animExpResidue; // 0x2DC
		::System::Int32 animNextLevel; // 0x2E0
		::System::Boolean expChangedDuringPurhcase; // 0x2E4
		::System::Boolean isInPurchaseDialog; // 0x2E5
