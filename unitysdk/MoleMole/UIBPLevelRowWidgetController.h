...
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ANIMATEEXPNUMBER_OFFSET UNITYSDK_OFFSET(0xE93C2F0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_INITLEVELWIDGET_OFFSET UNITYSDK_OFFSET(0xE93A700)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONBPPURCHASEDIALOGCLOSE_OFFSET UNITYSDK_OFFSET(0xE93C260)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE93AC10)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONFIRSTINCREASEEND_OFFSET UNITYSDK_OFFSET(0xE93C8A0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xE93ACB0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONLEVELINFOCHANGED_OFFSET UNITYSDK_OFFSET(0xE93BFF0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xE93AB60)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE93ADD0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE93A420)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE93AAB0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_SETBPLEVELINFO_OFFSET UNITYSDK_OFFSET(0xE93B390)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_SETFINALSTATEVALUE_OFFSET UNITYSDK_OFFSET(0xE93CD70)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_SETLEVELTEXT_OFFSET UNITYSDK_OFFSET(0xE93B660)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0xE93B9D0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_SETUPPEREXPNUM_OFFSET UNITYSDK_OFFSET(0xE93B420)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_STARTBUYPOPWINDOW_OFFSET UNITYSDK_OFFSET(0xE93BAD0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_STARTSECONDINCREASE_OFFSET UNITYSDK_OFFSET(0xE93CC60)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_STARTUPPEREXPPOPWINDOW_OFFSET UNITYSDK_OFFSET(0xE93BD80)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER_SYNCBPMODELINFO_OFFSET UNITYSDK_OFFSET(0xE93C070)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE93CE30)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER__ONFIRSTINCREASEEND_B__33_0_OFFSET UNITYSDK_OFFSET(0xE93CE90)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER__STARTSECONDINCREASE_B__34_0_OFFSET UNITYSDK_OFFSET(0xE93CFC0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE93D250)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xE93D2C0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xE93D320)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE93D390)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE93D410)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE93D470)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPLevelRowWidgetController_TypeDefinitionIndex = 79017;

	class UIBPLevelRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_248* _view; // 0x2A0
