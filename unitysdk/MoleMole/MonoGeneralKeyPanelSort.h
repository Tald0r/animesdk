...
#define MOLEMOLE_MONOGENERALKEYPANELSORT_METHOD_5_3E8B8757B7A354CC_OFFSET UNITYSDK_OFFSET(0xA7EAA70)
#define MOLEMOLE_MONOGENERALKEYPANELSORT_METHOD_5_D3700E59FA9F1C7C_OFFSET UNITYSDK_OFFSET(0xA7EB020)
#define MOLEMOLE_MONOGENERALKEYPANELSORT_METHOD_5_F4DD08A31BA3F883_OFFSET UNITYSDK_OFFSET(0xA7EA4B0)
#define MOLEMOLE_MONOGENERALKEYPANELSORT_SETCHANGEDIRTY_OFFSET UNITYSDK_OFFSET(0xA7EA850)
#define MOLEMOLE_MONOGENERALKEYPANELSORT_START_OFFSET UNITYSDK_OFFSET(0xA7EA440)
#define MOLEMOLE_MONOGENERALKEYPANELSORT__CCTOR_OFFSET UNITYSDK_OFFSET(0xA7EA9E0)
#define MOLEMOLE_MONOGENERALKEYPANELSORT__CTOR_OFFSET UNITYSDK_OFFSET(0xA7EA8C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGeneralKeyPanelSort_TypeDefinitionIndex = 39471;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MoleMole::InputLogicEventType>**)Il2CppClass::FromTypeDefinitionIndex(MonoGeneralKeyPanelSort_TypeDefinitionIndex)->GetStaticField(0x3B580);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGENERALKEYPANELSORT_METHOD_5_F4DD08A31BA3F883_OFFSET))(this);
		}
