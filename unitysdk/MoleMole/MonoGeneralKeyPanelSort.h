...
#define MOLEMOLE_MONOGENERALKEYPANELSORT_METHOD_5_3E8B8757B7A354CC_OFFSET UNITYSDK_OFFSET(0xA600870)
#define MOLEMOLE_MONOGENERALKEYPANELSORT_METHOD_5_D3700E59FA9F1C7C_OFFSET UNITYSDK_OFFSET(0xA600E20)
#define MOLEMOLE_MONOGENERALKEYPANELSORT_METHOD_5_F4DD08A31BA3F883_OFFSET UNITYSDK_OFFSET(0xA6002B0)
#define MOLEMOLE_MONOGENERALKEYPANELSORT_SETCHANGEDIRTY_OFFSET UNITYSDK_OFFSET(0xA600650)
#define MOLEMOLE_MONOGENERALKEYPANELSORT_START_OFFSET UNITYSDK_OFFSET(0xA600240)
#define MOLEMOLE_MONOGENERALKEYPANELSORT__CCTOR_OFFSET UNITYSDK_OFFSET(0xA6007E0)
#define MOLEMOLE_MONOGENERALKEYPANELSORT__CTOR_OFFSET UNITYSDK_OFFSET(0xA6006C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGeneralKeyPanelSort_TypeDefinitionIndex = 54848;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MoleMole::InputLogicEventType>**)Il2CppClass::FromTypeDefinitionIndex(MonoGeneralKeyPanelSort_TypeDefinitionIndex)->GetStaticField(0x38970);
		}
