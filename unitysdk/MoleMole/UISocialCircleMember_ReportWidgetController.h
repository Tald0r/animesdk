...
#define MOLEMOLE_UISOCIALCIRCLEMEMBER_REPORTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD3B6800)
#define MOLEMOLE_UISOCIALCIRCLEMEMBER_REPORTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD3B6870)
#define MOLEMOLE_UISOCIALCIRCLEMEMBER_REPORTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD3B6930)
#define MOLEMOLE_UISOCIALCIRCLEMEMBER_REPORTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD3B6B00)
#define MOLEMOLE_UISOCIALCIRCLEMEMBER_REPORTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD3B6B30)
#define MOLEMOLE_UISOCIALCIRCLEMEMBER_REPORTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD3B6BA0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleMember_ReportWidgetController_TypeDefinitionIndex = 55983;
