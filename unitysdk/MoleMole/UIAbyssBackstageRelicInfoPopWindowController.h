...
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA4A7780)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_GET__RELICDIC_OFFSET UNITYSDK_OFFSET(0xA4A9CE0)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_GET__RELICLIST_OFFSET UNITYSDK_OFFSET(0xA4AA210)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_INITTAB_OFFSET UNITYSDK_OFFSET(0xA4A7A90)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4A9170)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_ONLEFTTABCLICK_OFFSET UNITYSDK_OFFSET(0xA4A94F0)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_ONRIGHTBTNCLICK_OFFSET UNITYSDK_OFFSET(0xA4A9D80)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4A9210)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4A7790)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA4A7960)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_SETAVATARBTNSELECT_OFFSET UNITYSDK_OFFSET(0xA4A9F40)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER_TRYGETDEFAULTTABINDEXBYRELICID_OFFSET UNITYSDK_OFFSET(0xA4A92A0)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AA370)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER__ONLEFTTABCLICK_B__9_0_OFFSET UNITYSDK_OFFSET(0xA4AA4A0)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4AA4C0)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4AA530)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4AA540)
#define MOLEMOLE_UIABYSSBACKSTAGERELICINFOPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA4AA550)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssBackstageRelicInfoPopWindowController_TypeDefinitionIndex = 65788;
	...
	public:
		...
		::MoleMole::UIAbyssBackstageRelicInfoPopContext* _context; // 0x300
		::System::Int32 _pendingRightTabIndex; // 0x308
		::System::Int32 _leftTabIndex; // 0x30C
		::System::Int32 _rightTabIndex; // 0x310
		::System::Collections::Generic::List_1<::Class_2_541EA3F0D78A7596*>* _genreList; // 0x318
		::System::Collections::Generic::List_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*>*>* _relicDicList; // 0x320
		::System::Collections::Generic::List_1<::System::Int32>* _avatarList; // 0x328
		::System::Collections::Generic::List_1<::MoleMole::UIYorozuyaAbyssS3RoleBigItemRowWidgetController*>* _avatarBtnList; // 0x330
