...
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0x89629D0)
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8962B70)
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER_ONGET_OFFSET UNITYSDK_OFFSET(0x89644F0)
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER_ONMISSIONMODIFY_OFFSET UNITYSDK_OFFSET(0x8964480)
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8962D60)
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8962880)
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x8963D70)
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8962E40)
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER_REGISTERNOTIFY_OFFSET UNITYSDK_OFFSET(0x8963AB0)
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x8963920)
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8964810)
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8964820)
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8964890)
#define MOLEMOLE_UIINTERKNOTNEWSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8964910)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotNewsRowWidgetController_TypeDefinitionIndex = 47172;

	class UIInterKnotNewsRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_38* _view; // 0x2D0
		::System::Collections::Generic::List_1<::System::Int32>* knowledgeList; // 0x2D8
		::System::Int32 index; // 0x2E0
		::System::Int32 groupID; // 0x2E4
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_945*>* childQuestTemplates; // 0x2E8
