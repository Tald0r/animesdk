...
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELBLOCK_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x8F96210)
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELBLOCK_METHOD_5_261DF843E298B71B_OFFSET UNITYSDK_OFFSET(0x8F96920)
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELBLOCK_METHOD_5_A8E5FA6BCD56FEC4_OFFSET UNITYSDK_OFFSET(0x8F969C0)
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELBLOCK_METHOD_5_DAD17F595B040FAB_OFFSET UNITYSDK_OFFSET(0x8F96BD0)
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELBLOCK_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x8F96A60)
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELBLOCK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8F96690)
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELBLOCK_RESETBLOCK_OFFSET UNITYSDK_OFFSET(0x8F96550)
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELBLOCK__CCTOR_OFFSET UNITYSDK_OFFSET(0x8F968E0)
#define MOLEMOLE_MONOSTREAMINGGAMEMARCELBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x8F968C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoStreamingGameMarcelBlock_TypeDefinitionIndex = 64537;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoStreamingGameMarcelBlock_TypeDefinitionIndex)->GetStaticField(0xF910);
		}
