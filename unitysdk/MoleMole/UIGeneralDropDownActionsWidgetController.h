...
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_GETLOCATETRANSFORM_OFFSET UNITYSDK_OFFSET(0x8C44540)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_GETTEXTANCHOR_OFFSET UNITYSDK_OFFSET(0x8C44660)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_INITCHILDS_OFFSET UNITYSDK_OFFSET(0x8C43E80)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ISOVERCANVAS_OFFSET UNITYSDK_OFFSET(0x8C44A70)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C442F0)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x8C44490)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONREFRESHWIDGETROOTPOSITION_OFFSET UNITYSDK_OFFSET(0x8C44860)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONSELECTCHILDITEM_OFFSET UNITYSDK_OFFSET(0x8C44980)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8C43A90)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C44390)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C43800)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C43A20)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8C45270)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C451C0)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_GETLOCATETRANSFORM_OFFSET UNITYSDK_OFFSET(0x8C452C0)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C45320)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x8C45390)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONREFRESHWIDGETROOTPOSITION_OFFSET UNITYSDK_OFFSET(0x8C453C0)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8C45420)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C45490)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C45500)
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C45560)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralDropDownActionsWidgetController_TypeDefinitionIndex = 63337;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralDropDownActionsWidgetController_TypeDefinitionIndex)->GetStaticField(0x426C0);
		}
