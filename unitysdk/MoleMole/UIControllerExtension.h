...
#define MOLEMOLE_UICONTROLLEREXTENSION_CHECKCOLDDOWN_OFFSET UNITYSDK_OFFSET(0xBF55E10)
#define MOLEMOLE_UICONTROLLEREXTENSION_ENABLEMASKCLICK_OFFSET UNITYSDK_OFFSET(0xBF55200)
#define MOLEMOLE_UICONTROLLEREXTENSION_GETALLFADEANIMNAMESET_OFFSET UNITYSDK_OFFSET(0xBF553F0)
#define MOLEMOLE_UICONTROLLEREXTENSION_GETFADEDATA_OFFSET UNITYSDK_OFFSET(0xBF55380)
#define MOLEMOLE_UICONTROLLEREXTENSION_GETGENERALAUDIOCONFIG_OFFSET UNITYSDK_OFFSET(0xBF558B0)
#define MOLEMOLE_UICONTROLLEREXTENSION_GETPLAYMIXDROPDOWN_OFFSET UNITYSDK_OFFSET(0xBF54EC0)
#define MOLEMOLE_UICONTROLLEREXTENSION_ONCLICKMASK_OFFSET UNITYSDK_OFFSET(0xBF55B00)
#define MOLEMOLE_UICONTROLLEREXTENSION_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF55990)
#define MOLEMOLE_UICONTROLLEREXTENSION_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF55110)
#define MOLEMOLE_UICONTROLLEREXTENSION_VALIDATESTATEGROUP_OFFSET UNITYSDK_OFFSET(0xBF54E00)
#define MOLEMOLE_UICONTROLLEREXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0xBF55FC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIControllerExtension_TypeDefinitionIndex = 46282;
	...
	public:
		...
		::MoleMole::UIFadeConfig* GetFadeData(::Enum_3_B90C1A15EA6E3C2B uiCtrl)
		{
			return ((::MoleMole::UIFadeConfig*(*)(::PVOID, ::Enum_3_B90C1A15EA6E3C2B))((::PBYTE)hIl2Cpp + MOLEMOLE_UICONTROLLEREXTENSION_GETFADEDATA_OFFSET))(this, uiCtrl);
		}

		::System::Collections::Generic::HashSet_1<::System::String*>* GetAllFadeAnimNameSet(::Enum_3_B90C1A15EA6E3C2B uiCtrl)
		{
			return ((::System::Collections::Generic::HashSet_1<::System::String*>*(*)(::PVOID, ::Enum_3_B90C1A15EA6E3C2B))((::PBYTE)hIl2Cpp + MOLEMOLE_UICONTROLLEREXTENSION_GETALLFADEANIMNAMESET_OFFSET))(this, uiCtrl);
		}
