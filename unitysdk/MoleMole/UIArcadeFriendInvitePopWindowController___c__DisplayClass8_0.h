...
#define MOLEMOLE_UIARCADEFRIENDINVITEPOPWINDOWCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA4CCF70)
#define MOLEMOLE_UIARCADEFRIENDINVITEPOPWINDOWCONTROLLER___C__DISPLAYCLASS8_0__ONFRIENDTABCLICK_B__1_OFFSET UNITYSDK_OFFSET(0xA4CCF80)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeFriendInvitePopWindowController___c__DisplayClass8_0_TypeDefinitionIndex = 76207;
