...
class Class_2_60638234271CCDB8_39_Class_2_EF16346D79C18F15_7;
...
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB955B0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB94C80)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB95650)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB948A0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB94BD0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_OPENGACHAROLESELECTWINDOW_OFFSET UNITYSDK_OFFSET(0xAB95730)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAB94DB0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_SETPOINTVIEW_OFFSET UNITYSDK_OFFSET(0xAB95C90)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_SETPROGRESSFORGACHATIMES_OFFSET UNITYSDK_OFFSET(0xAB95D40)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB96330)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0xAB96360)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER__ONUIINIT_B__1_1_OFFSET UNITYSDK_OFFSET(0xAB96370)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER__SETPROGRESSFORGACHATIMES_G__DOSETPROGRESS_9_1_OFFSET UNITYSDK_OFFSET(0xAB95FF0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER__SETPROGRESSFORGACHATIMES_G__PLAYPROGRESSANIM_9_0_OFFSET UNITYSDK_OFFSET(0xAB95EC0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB96380)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB963F0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB96460)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB964E0)
#define MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB96540)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectPoolBtnWidgetController_TypeDefinitionIndex = 79129;
	...
	public:
		...
		::Class_2_60638234271CCDB8_39* _view; // 0x2A0
		...
		::System::Void SetPointView(::Class_2_60638234271CCDB8_39_Class_2_EF16346D79C18F15_7* pointView, ::System::Boolean isFull)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_60638234271CCDB8_39_Class_2_EF16346D79C18F15_7*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIROLESELECTPOOLBTNWIDGETCONTROLLER_SETPOINTVIEW_OFFSET))(this, pointView, isFull);
		}
