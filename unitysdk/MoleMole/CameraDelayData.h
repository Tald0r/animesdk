...
#define MOLEMOLE_CAMERADELAYDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x84E9EC0)
#define MOLEMOLE_CAMERADELAYDATA_LERP_OFFSET UNITYSDK_OFFSET(0x84E9A60)
#define MOLEMOLE_CAMERADELAYDATA_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x84E99D0)
#define MOLEMOLE_CAMERADELAYDATA_ZERO_OFFSET UNITYSDK_OFFSET(0x84E9960)
#define MOLEMOLE_CAMERADELAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x84E9E30)

namespace MoleMole
{
	inline static constexpr unsigned int CameraDelayData_TypeDefinitionIndex = 51393;
