...
#define MOLEMOLE_CAMERADELAYDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x6215DF0)
#define MOLEMOLE_CAMERADELAYDATA_LERP_OFFSET UNITYSDK_OFFSET(0x6215990)
#define MOLEMOLE_CAMERADELAYDATA_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x6215900)
#define MOLEMOLE_CAMERADELAYDATA_ZERO_OFFSET UNITYSDK_OFFSET(0x6215890)
#define MOLEMOLE_CAMERADELAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6215D60)

namespace MoleMole
{
	inline static constexpr unsigned int CameraDelayData_TypeDefinitionIndex = 37684;
