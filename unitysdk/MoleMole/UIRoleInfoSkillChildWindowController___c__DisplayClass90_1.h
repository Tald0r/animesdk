...
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER___C__DISPLAYCLASS90_1__CTOR_OFFSET UNITYSDK_OFFSET(0xA69CC10)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER___C__DISPLAYCLASS90_1__ONGOTOTUTORIAL_B__1_OFFSET UNITYSDK_OFFSET(0xA69CC20)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoSkillChildWindowController___c__DisplayClass90_1_TypeDefinitionIndex = 48914;
