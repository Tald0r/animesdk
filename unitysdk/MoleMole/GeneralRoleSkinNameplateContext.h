...
#define MOLEMOLE_GENERALROLESKINNAMEPLATECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8F13F80)

namespace MoleMole
{
	inline static constexpr unsigned int GeneralRoleSkinNameplateContext_TypeDefinitionIndex = 64672;
