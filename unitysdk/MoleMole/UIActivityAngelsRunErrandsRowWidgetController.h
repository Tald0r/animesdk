...
#define MOLEMOLE_UIACTIVITYANGELSRUNERRANDSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8AB3E80)
#define MOLEMOLE_UIACTIVITYANGELSRUNERRANDSROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8AB4000)
#define MOLEMOLE_UIACTIVITYANGELSRUNERRANDSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8AB3F20)
#define MOLEMOLE_UIACTIVITYANGELSRUNERRANDSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8AB3D30)
#define MOLEMOLE_UIACTIVITYANGELSRUNERRANDSROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8AB3DD0)
#define MOLEMOLE_UIACTIVITYANGELSRUNERRANDSROWWIDGETCONTROLLER_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x8AB4430)
#define MOLEMOLE_UIACTIVITYANGELSRUNERRANDSROWWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8AB4570)
#define MOLEMOLE_UIACTIVITYANGELSRUNERRANDSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8AB4560)
#define MOLEMOLE_UIACTIVITYANGELSRUNERRANDSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8AB45C0)
#define MOLEMOLE_UIACTIVITYANGELSRUNERRANDSROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8AB4630)
#define MOLEMOLE_UIACTIVITYANGELSRUNERRANDSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8AB46B0)
#define MOLEMOLE_UIACTIVITYANGELSRUNERRANDSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8AB4730)
#define MOLEMOLE_UIACTIVITYANGELSRUNERRANDSROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8AB4790)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityAngelsRunErrandsRowWidgetController_TypeDefinitionIndex = 68447;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIActivityAngelsRunErrandsRowWidgetController_TypeDefinitionIndex)->GetStaticField(0x2CAD0);
		}
		static ::System::String** StaticGet_PlayerFadeInAnim()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIActivityAngelsRunErrandsRowWidgetController_TypeDefinitionIndex)->GetStaticField(0x2CAD8);
		}
		::Class_2_2725B9A08E959D58* _view; // 0x2D0
		::System::Int32 _index; // 0x2D8
		::Class_2_208CC9941471731A_814* _config; // 0x2E0
