...
#define MOLEMOLE_EXITPERFORM_EXITPERFORMEVENTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xEC7ADB0)

namespace MoleMole::ExitPerform
{
	inline static constexpr unsigned int ExitPerformEventGroup_TypeDefinitionIndex = 65778;
