...
#define MOLEMOLE_EXITPERFORM_EXITPERFORMEVENTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xF198E90)

namespace MoleMole::ExitPerform
{
	inline static constexpr unsigned int ExitPerformEventGroup_TypeDefinitionIndex = 73144;
