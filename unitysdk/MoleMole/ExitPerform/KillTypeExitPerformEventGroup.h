...
#define MOLEMOLE_EXITPERFORM_KILLTYPEEXITPERFORMEVENTGROUP_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x6AD3850)
#define MOLEMOLE_EXITPERFORM_KILLTYPEEXITPERFORMEVENTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x6AD39E0)

namespace MoleMole::ExitPerform
{
	inline static constexpr unsigned int KillTypeExitPerformEventGroup_TypeDefinitionIndex = 69997;
