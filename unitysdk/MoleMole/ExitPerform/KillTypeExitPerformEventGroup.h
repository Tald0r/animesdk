...
#define MOLEMOLE_EXITPERFORM_KILLTYPEEXITPERFORMEVENTGROUP_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0xB5C2B40)
#define MOLEMOLE_EXITPERFORM_KILLTYPEEXITPERFORMEVENTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xB5C2CD0)

namespace MoleMole::ExitPerform
{
	inline static constexpr unsigned int KillTypeExitPerformEventGroup_TypeDefinitionIndex = 67892;
