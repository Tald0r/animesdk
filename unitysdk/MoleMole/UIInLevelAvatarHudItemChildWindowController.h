...
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_GETBUFFICONGAMEOBJECTBYBUFF_OFFSET UNITYSDK_OFFSET(0xB125E10)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_GETSTUNSTRING_OFFSET UNITYSDK_OFFSET(0xB126070)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB125840)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB125BA0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB125C10)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB1258E0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB125AF0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_REFRESHSHIELDARMORTEXT_OFFSET UNITYSDK_OFFSET(0xB126010)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_REORDERBUFFLIST_OFFSET UNITYSDK_OFFSET(0xB125FB0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_SETDISABLE_OFFSET UNITYSDK_OFFSET(0xB125D00)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB125CA0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB126110)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB126170)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB1261E0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB1261F0)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB126200)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB126270)
#define MOLEMOLE_UIINLEVELAVATARHUDITEMCHILDWINDOWCONTROLLER___BASE_SETDISABLE_OFFSET UNITYSDK_OFFSET(0xB1262E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelAvatarHudItemChildWindowController_TypeDefinitionIndex = 65110;
