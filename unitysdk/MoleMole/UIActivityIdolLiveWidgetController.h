...
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER_GETCURLIVESTATUS_OFFSET UNITYSDK_OFFSET(0xD1D3D20)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER_GETLIVESTATUS_OFFSET UNITYSDK_OFFSET(0xD1D38A0)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER_GET_CURSELECTACTIVITY_OFFSET UNITYSDK_OFFSET(0xD1D3380)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER_GET_CURSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD1D3540)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER_GOGUIDEANDTRYTAKEREWARD_OFFSET UNITYSDK_OFFSET(0xD1D3D90)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER_GOROOTACTIVITYGUIDE_OFFSET UNITYSDK_OFFSET(0xD1D4150)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD1D3BA0)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER_ONTABCLICK_OFFSET UNITYSDK_OFFSET(0xD1D3B10)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD1D3C40)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD1D3550)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD1D3720)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD1D4270)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD1D4DB0)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD1D4D70)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD1D4E70)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD1D4EE0)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD1D4F60)
#define MOLEMOLE_UIACTIVITYIDOLLIVEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD1D4FC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityIdolLiveWidgetController_TypeDefinitionIndex = 38248;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIActivityIdolLiveWidgetController_TypeDefinitionIndex)->GetStaticField(0x425E0);
		}
