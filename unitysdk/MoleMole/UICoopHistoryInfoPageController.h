...
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xBB16790)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB167A0)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB16810)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xBB16D90)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xBB16C50)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xBB16A70)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xBB16ED0)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBB168D0)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER_SETSELECTEDTAB_OFFSET UNITYSDK_OFFSET(0xBB169A0)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB17000)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB17010)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xBB17080)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xBB170F0)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xBB17160)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xBB17220)
#define MOLEMOLE_UICOOPHISTORYINFOPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBB17280)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopHistoryInfoPageController_TypeDefinitionIndex = 56399;
