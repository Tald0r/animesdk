...
#define MOLEMOLE_UIOVERLORDFEASTGUESTEVALUATEWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFF420)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastGuestEvaluateWidgetContext_TypeDefinitionIndex = 54362;
