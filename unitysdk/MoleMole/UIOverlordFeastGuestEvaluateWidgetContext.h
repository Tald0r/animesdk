...
#define MOLEMOLE_UIOVERLORDFEASTGUESTEVALUATEWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBE5DB40)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastGuestEvaluateWidgetContext_TypeDefinitionIndex = 63219;
