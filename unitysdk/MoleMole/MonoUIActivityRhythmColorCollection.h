...
#define MOLEMOLE_MONOUIACTIVITYRHYTHMCOLORCOLLECTION_SETDISKCOLOR_OFFSET UNITYSDK_OFFSET(0x9AB7B20)
#define MOLEMOLE_MONOUIACTIVITYRHYTHMCOLORCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB7C60)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIActivityRhythmColorCollection_TypeDefinitionIndex = 71682;
