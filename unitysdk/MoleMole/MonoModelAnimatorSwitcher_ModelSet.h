...
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_MODELSET_GET_DELAYDISABLEANIMATORREMAIN_OFFSET UNITYSDK_OFFSET(0x308880)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_MODELSET_SET_DELAYDISABLEANIMATORREMAIN_OFFSET UNITYSDK_OFFSET(0x308890)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_MODELSET__CTOR_OFFSET UNITYSDK_OFFSET(0x3088A0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoModelAnimatorSwitcher_ModelSet_TypeDefinitionIndex = 68940;
