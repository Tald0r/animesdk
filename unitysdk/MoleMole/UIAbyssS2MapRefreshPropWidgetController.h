...
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_GET_ONCLICKACTION_OFFSET UNITYSDK_OFFSET(0xC24D6C0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC24CB90)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0xC24D090)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC24CC00)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xC24D440)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC24D150)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC24CE80)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_SETONCLICK_OFFSET UNITYSDK_OFFSET(0xC24D650)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER_SET_ONCLICKACTION_OFFSET UNITYSDK_OFFSET(0xC24D6D0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC24D6E0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC24D6F0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xC24D760)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC24D7D0)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPROPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC24D850)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapRefreshPropWidgetController_TypeDefinitionIndex = 68366;

	class UIAbyssS2MapRefreshPropWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::System::Int32 _cacheIndex; // 0x2D0
		::System::Action_2<::System::Boolean, ::System::Int32>* _OnClickAction_k__BackingField; // 0x2D8
