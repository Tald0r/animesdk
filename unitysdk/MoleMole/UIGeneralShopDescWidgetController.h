...
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_CLICKSELECT_OFFSET UNITYSDK_OFFSET(0xA91D3C0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA91CC90)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA91CFC0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA91D030)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA91CD30)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA91CF10)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_SETARROW_OFFSET UNITYSDK_OFFSET(0xA91D1A0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_SETBYTEMPLATE_OFFSET UNITYSDK_OFFSET(0xA91D350)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_SETCB_OFFSET UNITYSDK_OFFSET(0xA91D2E0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER_SETSHOWCONTENT_OFFSET UNITYSDK_OFFSET(0xA91D110)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA91D570)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA91D540)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA91D5C0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA91D630)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA91D640)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA91D6C0)
#define MOLEMOLE_UIGENERALSHOPDESCWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA91D720)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralShopDescWidgetController_TypeDefinitionIndex = 50181;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIGeneralShopDescWidgetController_TypeDefinitionIndex)->GetStaticField(0xE0F0);
		}
		static ::UnityEngine::Vector3* StaticGet_noSelectArrow()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIGeneralShopDescWidgetController_TypeDefinitionIndex)->GetStaticField(0xE0FC);
		}
