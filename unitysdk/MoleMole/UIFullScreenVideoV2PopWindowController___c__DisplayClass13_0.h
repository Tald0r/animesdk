...
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9113F10)
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__INITVIDEOPLAYER_B__0_OFFSET UNITYSDK_OFFSET(0x9113F20)
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__INITVIDEOPLAYER_B__1_OFFSET UNITYSDK_OFFSET(0x9114020)

namespace MoleMole
{
	inline static constexpr unsigned int UIFullScreenVideoV2PopWindowController___c__DisplayClass13_0_TypeDefinitionIndex = 58868;
