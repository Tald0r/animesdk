...
#define MOLEMOLE_MONOUIGYRO_MOVABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xB3BCD30)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIGyro_Movable_TypeDefinitionIndex = 78287;
