...
#define MOLEMOLE_PROJECT_CONFIG_LEVELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x189B3970)

namespace MoleMole::Project::Config
{
	inline static constexpr unsigned int LevelData_TypeDefinitionIndex = 13916;
