...
#define MOLEMOLE_PROJECT_CONFIG_NODETECTIONPOINTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16CD5540)

namespace MoleMole::Project::Config
{
	inline static constexpr unsigned int NoDetectionPointData_TypeDefinitionIndex = 12558;
