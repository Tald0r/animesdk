...
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAAD8CE0)
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAAD8D50)
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAAD8E10)
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAAD8EF0)
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAAD9090)
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAAD90A0)
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAAD9110)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleLevelRowWidgetController_TypeDefinitionIndex = 39799;
