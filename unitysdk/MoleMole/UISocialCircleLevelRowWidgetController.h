...
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA731D10)
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA731D80)
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA731E40)
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA731F20)
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA7320C0)
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA7320D0)
#define MOLEMOLE_UISOCIALCIRCLELEVELROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA732140)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleLevelRowWidgetController_TypeDefinitionIndex = 56604;
