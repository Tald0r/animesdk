...
#define MOLEMOLE_UIFORGEUPDETAILITEMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA358320)

namespace MoleMole
{
	inline static constexpr unsigned int UIForgeUpDetailItemContext_TypeDefinitionIndex = 62425;
