...
#define MOLEMOLE_UIINTERKNOTLEVELWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA636EF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotLevelWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 48997;
	...
	public:
		...
		::System::Int32 maxExp; // 0x20
		::System::Int32 expNeededForNxtLv; // 0x24
		::System::Int32 curLv; // 0x28
