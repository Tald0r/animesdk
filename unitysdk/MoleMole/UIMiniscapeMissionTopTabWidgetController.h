...
#define MOLEMOLE_UIMINISCAPEMISSIONTOPTABWIDGETCONTROLLER_GET_TABBUTTON_OFFSET UNITYSDK_OFFSET(0xA224F60)
#define MOLEMOLE_UIMINISCAPEMISSIONTOPTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA224460)
#define MOLEMOLE_UIMINISCAPEMISSIONTOPTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA224500)
#define MOLEMOLE_UIMINISCAPEMISSIONTOPTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA224310)
#define MOLEMOLE_UIMINISCAPEMISSIONTOPTABWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA2243B0)
#define MOLEMOLE_UIMINISCAPEMISSIONTOPTABWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA2245E0)
#define MOLEMOLE_UIMINISCAPEMISSIONTOPTABWIDGETCONTROLLER_SETINFOVIEW_OFFSET UNITYSDK_OFFSET(0xA224B10)
#define MOLEMOLE_UIMINISCAPEMISSIONTOPTABWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0xA224D00)
#define MOLEMOLE_UIMINISCAPEMISSIONTOPTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA224F80)
#define MOLEMOLE_UIMINISCAPEMISSIONTOPTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA224FB0)
#define MOLEMOLE_UIMINISCAPEMISSIONTOPTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA225020)
#define MOLEMOLE_UIMINISCAPEMISSIONTOPTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA2250A0)
#define MOLEMOLE_UIMINISCAPEMISSIONTOPTABWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA225100)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeMissionTopTabWidgetController_TypeDefinitionIndex = 57480;

	class UIMiniscapeMissionTopTabWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_EF1144688AF190ED* _view; // 0x2A0
		::Class_2_208CC9941471731A_21* _chapterConfig; // 0x2A8
