...
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_INITSHAREPLAYERTEAMUIVIEW_OFFSET UNITYSDK_OFFSET(0x8C37EE0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_INITSHARESELFPLAYERTEAMUIVIEW_OFFSET UNITYSDK_OFFSET(0x8C37E60)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x8C37810)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C37550)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8C376D0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C375F0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C37270)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_ONUPDATECHATMESSAGEROW_OFFSET UNITYSDK_OFFSET(0x8C37BF0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_RESETSPECIALUI_OFFSET UNITYSDK_OFFSET(0x8C37DB0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_RESETUIVIEW_OFFSET UNITYSDK_OFFSET(0x8C37CA0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER_SETUPTEAMUIWITHCONTENT_OFFSET UNITYSDK_OFFSET(0x8C37F60)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C38920)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C38930)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8C389A0)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C38A20)
#define MOLEMOLE_UIFRIENDCHATTEAMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C38AA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatTeamWidgetController_TypeDefinitionIndex = 66936;
