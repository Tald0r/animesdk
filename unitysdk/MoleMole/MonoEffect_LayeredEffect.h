...
#define MOLEMOLE_MONOEFFECT_LAYEREDEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xD80D350)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffect_LayeredEffect_TypeDefinitionIndex = 54948;
