...
#define MOLEMOLE_UICOMICPAGECONTROLLER_COMICPAGEDELAYACTION_RESET_OFFSET UNITYSDK_OFFSET(0xBB15720)
#define MOLEMOLE_UICOMICPAGECONTROLLER_COMICPAGEDELAYACTION_TRIGGERED_OFFSET UNITYSDK_OFFSET(0xBB15840)
#define MOLEMOLE_UICOMICPAGECONTROLLER_COMICPAGEDELAYACTION_UPDATE_OFFSET UNITYSDK_OFFSET(0xBB157A0)
#define MOLEMOLE_UICOMICPAGECONTROLLER_COMICPAGEDELAYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xBB158A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController_ComicPageDelayAction_TypeDefinitionIndex = 45646;
