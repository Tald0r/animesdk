...
#define MOLEMOLE_CAMERADELAYDATAS_CLONE_OFFSET UNITYSDK_OFFSET(0xC30DF90)
#define MOLEMOLE_CAMERADELAYDATAS_LERP_OFFSET UNITYSDK_OFFSET(0xC30DE10)
#define MOLEMOLE_CAMERADELAYDATAS_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0xC30DB50)
#define MOLEMOLE_CAMERADELAYDATAS_POSTINIT_OFFSET UNITYSDK_OFFSET(0xC30DDB0)
#define MOLEMOLE_CAMERADELAYDATAS_ZERO_OFFSET UNITYSDK_OFFSET(0xC30D990)
#define MOLEMOLE_CAMERADELAYDATAS__CTOR_OFFSET UNITYSDK_OFFSET(0xC30D7A0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraDelayDatas_TypeDefinitionIndex = 54270;
