...
#define MOLEMOLE_CAMERADELAYDATAS_CLONE_OFFSET UNITYSDK_OFFSET(0x9B77A80)
#define MOLEMOLE_CAMERADELAYDATAS_LERP_OFFSET UNITYSDK_OFFSET(0x9B95D10)
#define MOLEMOLE_CAMERADELAYDATAS_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x9B77C60)
#define MOLEMOLE_CAMERADELAYDATAS_POSTINIT_OFFSET UNITYSDK_OFFSET(0x9B95CB0)
#define MOLEMOLE_CAMERADELAYDATAS_ZERO_OFFSET UNITYSDK_OFFSET(0x9B74900)
#define MOLEMOLE_CAMERADELAYDATAS__CTOR_OFFSET UNITYSDK_OFFSET(0x9B767E0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraDelayDatas_TypeDefinitionIndex = 46885;
