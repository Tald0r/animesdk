...
#define MOLEMOLE_UIAVATARANIMATORPARAMSSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xA51A9E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarAnimatorParamsSetting_TypeDefinitionIndex = 46593;
	...
	public:
		...
		::MoleMole::UIAvatarAnimationSetting* AvatarAnimationSetting; // 0x30
