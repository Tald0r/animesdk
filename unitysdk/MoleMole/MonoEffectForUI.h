...
#define MOLEMOLE_MONOEFFECTFORUI_AWAKE_OFFSET UNITYSDK_OFFSET(0xC2EB6F0)
#define MOLEMOLE_MONOEFFECTFORUI_GET_PARTICLESYS_OFFSET UNITYSDK_OFFSET(0xC2EB610)
#define MOLEMOLE_MONOEFFECTFORUI_GET_RENDERERS_OFFSET UNITYSDK_OFFSET(0xC2EB530)
#define MOLEMOLE_MONOEFFECTFORUI_METHOD_5_A5B6063FFC26FC8F_OFFSET UNITYSDK_OFFSET(0xC2EB810)
#define MOLEMOLE_MONOEFFECTFORUI_UPDATEALPHA_OFFSET UNITYSDK_OFFSET(0xC2EBE60)
#define MOLEMOLE_MONOEFFECTFORUI_UPDATE_OFFSET UNITYSDK_OFFSET(0xC2EB7A0)
#define MOLEMOLE_MONOEFFECTFORUI__CTOR_OFFSET UNITYSDK_OFFSET(0xC2EC280)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectForUI_TypeDefinitionIndex = 43037;
