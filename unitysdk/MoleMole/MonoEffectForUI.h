...
#define MOLEMOLE_MONOEFFECTFORUI_AWAKE_OFFSET UNITYSDK_OFFSET(0xB8C7C10)
#define MOLEMOLE_MONOEFFECTFORUI_GET_PARTICLESYS_OFFSET UNITYSDK_OFFSET(0xB8C7B30)
#define MOLEMOLE_MONOEFFECTFORUI_GET_RENDERERS_OFFSET UNITYSDK_OFFSET(0xB8C7A50)
#define MOLEMOLE_MONOEFFECTFORUI_METHOD_5_A5B6063FFC26FC8F_OFFSET UNITYSDK_OFFSET(0xB8C7D30)
#define MOLEMOLE_MONOEFFECTFORUI_UPDATEALPHA_OFFSET UNITYSDK_OFFSET(0xB8C8380)
#define MOLEMOLE_MONOEFFECTFORUI_UPDATE_OFFSET UNITYSDK_OFFSET(0xB8C7CC0)
#define MOLEMOLE_MONOEFFECTFORUI__CTOR_OFFSET UNITYSDK_OFFSET(0xB8C87A0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectForUI_TypeDefinitionIndex = 80584;
