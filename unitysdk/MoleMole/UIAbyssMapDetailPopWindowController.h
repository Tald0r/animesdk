...
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER_CREATEDATA_OFFSET UNITYSDK_OFFSET(0xCFEEE80)
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xCFEE830)
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xCFEECD0)
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xCFEEA80)
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER_ONCREATEICONTIP_OFFSET UNITYSDK_OFFSET(0xCFEF250)
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFEEBA0)
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFEEC40)
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFEE840)
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFEEAF0)
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFEF330)
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFEF340)
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFEF3B0)
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFEF3C0)
#define MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFEF3D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssMapDetailPopWindowController_TypeDefinitionIndex = 38817;

	class UIAbyssMapDetailPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_46B1304F31463D00* _view; // 0x2F8
		...
		::MoleMole::ScrollViewItemWidgetController* OnCreateIconTip(::Enum_3_340DE32BA097F66C ctrl, ::System::Func_1<::MoleMole::UIControlReference*>* arg)
		{
			return ((::MoleMole::ScrollViewItemWidgetController*(*)(::PVOID, ::Enum_3_340DE32BA097F66C, ::System::Func_1<::MoleMole::UIControlReference*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSMAPDETAILPOPWINDOWCONTROLLER_ONCREATEICONTIP_OFFSET))(this, ctrl, arg);
		}
