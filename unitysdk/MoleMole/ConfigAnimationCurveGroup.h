...
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP_CURRENTMAXLOOPOFFSETCOUNT_OFFSET UNITYSDK_OFFSET(0xCD28200)
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP_CURRENTMAXLOOPOFFSET_OFFSET UNITYSDK_OFFSET(0xCD28260)
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP_GETFIXEDTIMER_OFFSET UNITYSDK_OFFSET(0xCD28350)
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0xCD282D0)
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP_ONLOOPOFFSETCHANGED_OFFSET UNITYSDK_OFFSET(0xCD28120)
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP_ONLOOPOFFSETCOUNTCHANGED_OFFSET UNITYSDK_OFFSET(0xCD28190)
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xCD28410)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigAnimationCurveGroup_TypeDefinitionIndex = 52745;
	...
	public:
		...
		::System::Int32 loopOffsetCount; // 0x20
		::System::Single loopOffset; // 0x24
