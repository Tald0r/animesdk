...
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP_CURRENTMAXLOOPOFFSETCOUNT_OFFSET UNITYSDK_OFFSET(0xE3810C0)
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP_CURRENTMAXLOOPOFFSET_OFFSET UNITYSDK_OFFSET(0xE381120)
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP_GETFIXEDTIMER_OFFSET UNITYSDK_OFFSET(0xE381210)
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0xE381190)
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP_ONLOOPOFFSETCHANGED_OFFSET UNITYSDK_OFFSET(0xE380FE0)
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP_ONLOOPOFFSETCOUNTCHANGED_OFFSET UNITYSDK_OFFSET(0xE381050)
#define MOLEMOLE_CONFIGANIMATIONCURVEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xE3812D0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigAnimationCurveGroup_TypeDefinitionIndex = 39664;
