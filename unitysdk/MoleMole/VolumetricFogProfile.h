...
#define MOLEMOLE_VOLUMETRICFOGPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x9F16430)
#define MOLEMOLE_VOLUMETRICFOGPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x9F165B0)
#define MOLEMOLE_VOLUMETRICFOGPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x9F16350)
#define MOLEMOLE_VOLUMETRICFOGPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x9F16510)
#define MOLEMOLE_VOLUMETRICFOGPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x9F16340)
#define MOLEMOLE_VOLUMETRICFOGPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x9F166E0)
#define MOLEMOLE_VOLUMETRICFOGPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x9F16770)
#define MOLEMOLE_VOLUMETRICFOGPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x9F167E0)
#define MOLEMOLE_VOLUMETRICFOGPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x9F16850)

namespace MoleMole
{
	inline static constexpr unsigned int VolumetricFogProfile_TypeDefinitionIndex = 42583;
