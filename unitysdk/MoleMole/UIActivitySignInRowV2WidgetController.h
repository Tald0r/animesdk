...
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER_CANTAKETASKREWARD_OFFSET UNITYSDK_OFFSET(0xBF228D0)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER_ISCANGETREWARD_OFFSET UNITYSDK_OFFSET(0xBF238B0)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF220B0)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER_ONPREINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBF22600)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBF223E0)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF22150)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF21D50)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF22230)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER_SETDAYDATA_OFFSET UNITYSDK_OFFSET(0xBF224C0)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER_SETREWARDSTATE_OFFSET UNITYSDK_OFFSET(0xBF22E50)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER_TAKEREWARD_OFFSET UNITYSDK_OFFSET(0xBF229A0)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xBF22590)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF23980)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER__TAKEREWARD_B__12_0_OFFSET UNITYSDK_OFFSET(0xBF239A0)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER__TAKEREWARD_B__12_1_OFFSET UNITYSDK_OFFSET(0xBF239B0)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF23A80)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER___BASE_ONPREINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBF23AF0)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBF23B80)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF23C00)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF23C80)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF23CE0)
#define MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER___BASE_SETDAYDATA_OFFSET UNITYSDK_OFFSET(0xBF23D50)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySignInRowV2WidgetController_TypeDefinitionIndex = 39987;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_AE02BC8285203464_22*, ::Class_1_D375C91CCE5D3999*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER_SETDAYDATA_OFFSET))(this, task, activityData);
		}
		...
		::System::Void _TakeReward_b__12_0(::Class_0_16E4307DCC419505_5* rspMsg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER__TAKEREWARD_B__12_0_OFFSET))(this, rspMsg);
		}

		::System::Void _TakeReward_b__12_1(::Class_0_16E4307DCC419505_5* errorMsg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER__TAKEREWARD_B__12_1_OFFSET))(this, errorMsg);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_AE02BC8285203464_22*, ::Class_1_D375C91CCE5D3999*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYSIGNINROWV2WIDGETCONTROLLER___BASE_SETDAYDATA_OFFSET))(this, P0, P1);
		}
	};
}
