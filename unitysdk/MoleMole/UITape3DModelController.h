...
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_COLOR_OFFSET UNITYSDK_OFFSET(0x9382240)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_DONTSHOW_OFFSET UNITYSDK_OFFSET(0x9381660)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_EASINGSLIDE_OFFSET UNITYSDK_OFFSET(0x9381D10)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_FIRSTBOOKPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x937FBA0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_FLIP_OFFSET UNITYSDK_OFFSET(0x937F100)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_BASEROTATION_OFFSET UNITYSDK_OFFSET(0x937CBB0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x937CE70)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_CURANIMCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x937CBF0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_FLIPANIMLENGTH_OFFSET UNITYSDK_OFFSET(0x937CCD0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_FLIPANIMNORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0x937CBD0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_INDEXL_OFFSET UNITYSDK_OFFSET(0x937CB70)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_INDEXR_OFFSET UNITYSDK_OFFSET(0x937CB90)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x937CB50)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_ISDONTSHOWINGANIM_OFFSET UNITYSDK_OFFSET(0x937CE50)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_ISEASING_OFFSET UNITYSDK_OFFSET(0x937CDF0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_ISSHOWINGANIM_OFFSET UNITYSDK_OFFSET(0x937CE30)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_ISSHOWING_OFFSET UNITYSDK_OFFSET(0x937CE10)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_ISTAPELOCKED_OFFSET UNITYSDK_OFFSET(0x937CD60)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_MAINPAGE_OFFSET UNITYSDK_OFFSET(0x937CF30)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_GET_VHSTEMPLATEID_OFFSET UNITYSDK_OFFSET(0x937CB30)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_ISPLAYINGFLIPANIM_OFFSET UNITYSDK_OFFSET(0x937FFD0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x937CFF0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x937D190)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x937D200)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x937D090)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x937D120)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_PUSHBOOKPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x937FD40)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x937D980)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_ROTATE_1_OFFSET UNITYSDK_OFFSET(0x937F340)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_ROTATE_OFFSET UNITYSDK_OFFSET(0x937FEB0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SCALE_OFFSET UNITYSDK_OFFSET(0x937ED00)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SETDEFAULTROT_OFFSET UNITYSDK_OFFSET(0x937FA60)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SETLOCKVIEW_OFFSET UNITYSDK_OFFSET(0x937D2E0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SET_BASEROTATION_OFFSET UNITYSDK_OFFSET(0x937CBC0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x937CED0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SET_FLIPANIMNORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0x937CBE0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SET_INDEXL_OFFSET UNITYSDK_OFFSET(0x937CB80)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SET_INDEXR_OFFSET UNITYSDK_OFFSET(0x937CBA0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x937CB60)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SET_ISDONTSHOWINGANIM_OFFSET UNITYSDK_OFFSET(0x937CE60)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SET_ISEASING_OFFSET UNITYSDK_OFFSET(0x937CE00)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SET_ISSHOWINGANIM_OFFSET UNITYSDK_OFFSET(0x937CE40)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SET_ISSHOWING_OFFSET UNITYSDK_OFFSET(0x937CE20)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SET_MAINPAGE_OFFSET UNITYSDK_OFFSET(0x937CF90)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SET_VHSTEMPLATEID_OFFSET UNITYSDK_OFFSET(0x937CB40)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SHOWTAPE_OFFSET UNITYSDK_OFFSET(0x9380060)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SKIPSHOWANIM_OFFSET UNITYSDK_OFFSET(0x93803E0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SLIDE_OFFSET UNITYSDK_OFFSET(0x9381960)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_SYNCLOCALROTATIONANDSCALEFROMSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x937DFD0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_TRANSLATE_OFFSET UNITYSDK_OFFSET(0x937DCF0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9380450)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x93823C0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9382330)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9382670)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x93826E0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x93826F0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9382700)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9382710)

namespace MoleMole
{
	inline static constexpr unsigned int UITape3DModelController_TypeDefinitionIndex = 54190;
	...
	public:
		...
		{
			return (::UnityEngine::Texture2D**)Il2CppClass::FromTypeDefinitionIndex(UITape3DModelController_TypeDefinitionIndex)->GetStaticField(0x32A90);
		}
		static ::MoleMole::UIMainStoryPageController** StaticGet__MainPage_k__BackingField()
		{
			return (::MoleMole::UIMainStoryPageController**)Il2CppClass::FromTypeDefinitionIndex(UITape3DModelController_TypeDefinitionIndex)->GetStaticField(0x32A98);
		}
		static ::System::String** StaticGet_kShowAnim()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UITape3DModelController_TypeDefinitionIndex)->GetStaticField(0x32AA0);
		}
		static ::UnityEngine::Texture2D** StaticGet__coverLockTextureSide()
		{
			return (::UnityEngine::Texture2D**)Il2CppClass::FromTypeDefinitionIndex(UITape3DModelController_TypeDefinitionIndex)->GetStaticField(0x32AA8);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Single>** StaticGet_kAnimClipLengthDict()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(UITape3DModelController_TypeDefinitionIndex)->GetStaticField(0x32AB0);
		}
		static ::System::String** StaticGet_kFlipAnim()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UITape3DModelController_TypeDefinitionIndex)->GetStaticField(0x32AB8);
		}
		static ::System::String** StaticGet_kDontShowAnim()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UITape3DModelController_TypeDefinitionIndex)->GetStaticField(0x32AC0);
		}
		static ::UnityEngine::Texture2D** StaticGet__coverLockTextureFront1()
		{
			return (::UnityEngine::Texture2D**)Il2CppClass::FromTypeDefinitionIndex(UITape3DModelController_TypeDefinitionIndex)->GetStaticField(0x32AC8);
		}
		static ::MoleMole::UITapesConfig** StaticGet__Config_k__BackingField()
		{
			return (::MoleMole::UITapesConfig**)Il2CppClass::FromTypeDefinitionIndex(UITape3DModelController_TypeDefinitionIndex)->GetStaticField(0x32AD0);
		}
		static ::System::String** StaticGet_kBornAnim()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UITape3DModelController_TypeDefinitionIndex)->GetStaticField(0x32AD8);
		}
		static ::UnityEngine::Texture2D** StaticGet__coverLockTextureFront2()
		{
			return (::UnityEngine::Texture2D**)Il2CppClass::FromTypeDefinitionIndex(UITape3DModelController_TypeDefinitionIndex)->GetStaticField(0x32AE0);
		}
		static ::System::Single* StaticGet_ShowAnimStretchDistance()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UITape3DModelController_TypeDefinitionIndex)->GetStaticField(0xC490);
		}
		static ::System::Int32* StaticGet_CoverMap()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITape3DModelController_TypeDefinitionIndex)->GetStaticField(0xC494);
		}
