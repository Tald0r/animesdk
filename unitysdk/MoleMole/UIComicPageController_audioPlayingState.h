...
#define MOLEMOLE_UICOMICPAGECONTROLLER_AUDIOPLAYINGSTATE_RESET_OFFSET UNITYSDK_OFFSET(0xBF53B60)
#define MOLEMOLE_UICOMICPAGECONTROLLER_AUDIOPLAYINGSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xBF53BE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController_audioPlayingState_TypeDefinitionIndex = 45634;
