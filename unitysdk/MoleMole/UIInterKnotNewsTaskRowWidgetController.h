...
#define MOLEMOLE_UIINTERKNOTNEWSTASKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x98AC500)
#define MOLEMOLE_UIINTERKNOTNEWSTASKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x98AC5A0)
#define MOLEMOLE_UIINTERKNOTNEWSTASKROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98ACD60)
#define MOLEMOLE_UIINTERKNOTNEWSTASKROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98AC460)
#define MOLEMOLE_UIINTERKNOTNEWSTASKROWWIDGETCONTROLLER_REFRESHQUESTDESC_OFFSET UNITYSDK_OFFSET(0x98ACE40)
#define MOLEMOLE_UIINTERKNOTNEWSTASKROWWIDGETCONTROLLER_REFRESHRELATEDITEMBUTTON_OFFSET UNITYSDK_OFFSET(0x98AD370)
#define MOLEMOLE_UIINTERKNOTNEWSTASKROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x98AC6E0)
#define MOLEMOLE_UIINTERKNOTNEWSTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98AD750)
#define MOLEMOLE_UIINTERKNOTNEWSTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x98AD7A0)
#define MOLEMOLE_UIINTERKNOTNEWSTASKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x98AD810)
#define MOLEMOLE_UIINTERKNOTNEWSTASKROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98AD890)
#define MOLEMOLE_UIINTERKNOTNEWSTASKROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98AD910)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotNewsTaskRowWidgetController_TypeDefinitionIndex = 48707;
