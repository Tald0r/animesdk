...
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_CLEARDROPDOWN_OFFSET UNITYSDK_OFFSET(0xAE2BF80)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_GETDEFAULTSELECTIDX_OFFSET UNITYSDK_OFFSET(0xAE2D060)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_GETNOAVAILABLESECTIONTEXTKEY_OFFSET UNITYSDK_OFFSET(0xAE2CDD0)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAE2C000)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_INITDROPDOWN_OFFSET UNITYSDK_OFFSET(0xAE2BAD0)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE2CA20)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE2CAC0)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE2C010)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE2C360)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAE2C4A0)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER_SHOULDSHOWLIKEICON_OFFSET UNITYSDK_OFFSET(0xAE2CBC0)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE2D400)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER__INITDROPDOWN_B__0_0_OFFSET UNITYSDK_OFFSET(0xAE2D410)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER__ONUIINIT_B__8_0_OFFSET UNITYSDK_OFFSET(0xAE2D490)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER__ONUIINIT_B__8_1_OFFSET UNITYSDK_OFFSET(0xAE2D510)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER__ONUIINIT_B__8_2_OFFSET UNITYSDK_OFFSET(0xAE2D6E0)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE2E0F0)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE2E160)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE2E170)
#define MOLEMOLE_UIPARTNERDATEMAPLISTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE2E180)

namespace MoleMole
{
	inline static constexpr unsigned int UIPartnerDateMapListPopWindowController_TypeDefinitionIndex = 73022;

	class UIPartnerDateMapListPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_1_9F79166E94E6BD41* _dropDownViewModel; // 0x2F8
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_406*>* _partnerSections; // 0x318
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_652*>* _freeModeAimList; // 0x320
		::System::Int32 _curFreeModeAimIdx; // 0x328
		::Class_2_208CC9941471731A_652* _curFreeModeAim; // 0x330
