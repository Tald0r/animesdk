...
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA315E00)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA315F80)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA315EA0)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA315CE0)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA316190)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA3161A0)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA316210)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA316290)
#define MOLEMOLE_UIBPITEMICONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA316310)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPItemIconRowWidgetController_TypeDefinitionIndex = 46328;

	class UIBPItemIconRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_A0E8715294BAB4D5* _view; // 0x2D0
		::Class_1_451601B8BB62C38C_7* viewData; // 0x2D8
