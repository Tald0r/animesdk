...
#define MOLEMOLE_UICINEMAPREPV2PAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x95D3950)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaPrepV2PageContext_TypeDefinitionIndex = 45465;
