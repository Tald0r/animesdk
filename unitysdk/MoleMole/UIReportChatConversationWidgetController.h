...
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF21240)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDF213C0)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF212E0)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF21020)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF21750)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF21760)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDF217D0)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF21850)
#define MOLEMOLE_UIREPORTCHATCONVERSATIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF218D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIReportChatConversationWidgetController_TypeDefinitionIndex = 69895;
