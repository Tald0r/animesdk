...
#define MOLEMOLE_UIQUICKSETBUTTONWIDGETCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x749C470)
#define MOLEMOLE_UIQUICKSETBUTTONWIDGETCHILDWINDOWCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x749C510)
#define MOLEMOLE_UIQUICKSETBUTTONWIDGETCHILDWINDOWCONTROLLER_ONSKINBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x749CA20)
#define MOLEMOLE_UIQUICKSETBUTTONWIDGETCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x749CAD0)
#define MOLEMOLE_UIQUICKSETBUTTONWIDGETCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x749C1E0)
#define MOLEMOLE_UIQUICKSETBUTTONWIDGETCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x749C3C0)
#define MOLEMOLE_UIQUICKSETBUTTONWIDGETCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x749CBB0)
#define MOLEMOLE_UIQUICKSETBUTTONWIDGETCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x749CBC0)
#define MOLEMOLE_UIQUICKSETBUTTONWIDGETCHILDWINDOWCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x749CC30)
#define MOLEMOLE_UIQUICKSETBUTTONWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x749CCB0)
#define MOLEMOLE_UIQUICKSETBUTTONWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x749CD30)
#define MOLEMOLE_UIQUICKSETBUTTONWIDGETCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x749CD90)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuickSetButtonWidgetChildWindowController_TypeDefinitionIndex = 79980;
	...
	public:
		...
		::System::Action_2<::System::Int32, ::Class_2_208CC9941471731A_968*>* clickHandle; // 0x2D8
		::Class_2_208CC9941471731A_968* unlockCfg; // 0x2E0
