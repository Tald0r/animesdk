...
#define MOLEMOLE_INLEVELQTERIGHTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xB993230)
#define MOLEMOLE_INLEVELQTERIGHTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xB993240)
#define MOLEMOLE_INLEVELQTERIGHTKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xB993250)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelQTERightKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 80745;
