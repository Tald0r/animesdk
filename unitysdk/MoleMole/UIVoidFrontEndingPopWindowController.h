...
#define MOLEMOLE_UIVOIDFRONTENDINGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x71E57D0)
#define MOLEMOLE_UIVOIDFRONTENDINGPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x71E57E0)
#define MOLEMOLE_UIVOIDFRONTENDINGPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x71E5850)
#define MOLEMOLE_UIVOIDFRONTENDINGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x71E5950)
#define MOLEMOLE_UIVOIDFRONTENDINGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x71E5AF0)
#define MOLEMOLE_UIVOIDFRONTENDINGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x71E5B00)
#define MOLEMOLE_UIVOIDFRONTENDINGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x71E5B70)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontEndingPopWindowController_TypeDefinitionIndex = 51725;
