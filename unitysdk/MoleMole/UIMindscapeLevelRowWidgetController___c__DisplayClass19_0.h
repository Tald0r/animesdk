...
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAC08540)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___C__DISPLAYCLASS19_0__PLAYUNLOCKEFFECT_B__0_OFFSET UNITYSDK_OFFSET(0xAC08550)

namespace MoleMole
{
	inline static constexpr unsigned int UIMindscapeLevelRowWidgetController___c__DisplayClass19_0_TypeDefinitionIndex = 51031;
