...
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_BINDTWEENSLOT_OFFSET UNITYSDK_OFFSET(0xD030270)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_DISPATCHTOCHILD_OFFSET UNITYSDK_OFFSET(0xD0307E0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GETBOTTOMTIPSROOT_OFFSET UNITYSDK_OFFSET(0xD0300F0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GETBOTTOMTIPS_OFFSET UNITYSDK_OFFSET(0xD030780)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GETBUBBLEWIDGET_OFFSET UNITYSDK_OFFSET(0xD0301B0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GETLEVELUPROOT_OFFSET UNITYSDK_OFFSET(0xD030150)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GETMISSIONTIPS_OFFSET UNITYSDK_OFFSET(0xD02FE40)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GETREWARDTIPS_OFFSET UNITYSDK_OFFSET(0xD02FEB0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GET_CANPLAYONGOINGCHATIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xD02F260)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GET_COMMONEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0xD02F220)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GET_CONSOLEACTIVE_OFFSET UNITYSDK_OFFSET(0xD02F2D0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GET_HUDLOGICMANAGER_OFFSET UNITYSDK_OFFSET(0xD02F2B0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GET_INPUTACTIONHANDLER_OFFSET UNITYSDK_OFFSET(0xD02F330)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GET_ISBEFOREPAGEFADEOUTING_OFFSET UNITYSDK_OFFSET(0xD02F2F0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GET_ISINOPENOTHERPAGETRANSITION_OFFSET UNITYSDK_OFFSET(0xD02F310)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GET_ONGOINGCHATPLAYER_OFFSET UNITYSDK_OFFSET(0xD02F240)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GET_SCRIPTABLEANIMATIONPLAYER_OFFSET UNITYSDK_OFFSET(0xD02F270)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GET_UNITMANAGER_OFFSET UNITYSDK_OFFSET(0xD02F290)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_GET_WHEELSHORTCUTPOP_OFFSET UNITYSDK_OFFSET(0xD02F2E0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_HASANYBUBBLETIPEXCLUDECTRL_OFFSET UNITYSDK_OFFSET(0xD02FCF0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_INITSLOT_OFFSET UNITYSDK_OFFSET(0xD02FA40)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_MUTEMENUBTNCLICK_OFFSET UNITYSDK_OFFSET(0xD02FF10)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_ONBEFOREPAGEFADEIN_OFFSET UNITYSDK_OFFSET(0xD0306A0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_ONBEFOREPAGEFADEOUT_OFFSET UNITYSDK_OFFSET(0xD030630)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_ONFADETRANSITIONCHANGE_1_OFFSET UNITYSDK_OFFSET(0xD02F5F0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_ONFADETRANSITIONCHANGE_OFFSET UNITYSDK_OFFSET(0xD02F570)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xD02FF80)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_ONTIMELINEFORCESTOPONGOINGCHAT_OFFSET UNITYSDK_OFFSET(0xD02FAA0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD02F660)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD02F880)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD02F350)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD02F3F0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_OPENBUBBLEROW_OFFSET UNITYSDK_OFFSET(0xD030210)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_OPENMESSAGETIP_OFFSET UNITYSDK_OFFSET(0xD02FD60)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_PLAYBLOCKFAIRYFADEOUT_OFFSET UNITYSDK_OFFSET(0xD0305C0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_SETCONSOLEACTIVE_OFFSET UNITYSDK_OFFSET(0xD02FDD0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_SET_COMMONEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0xD02F230)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_SET_HUDLOGICMANAGER_OFFSET UNITYSDK_OFFSET(0xD02F2C0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_SET_INPUTACTIONHANDLER_OFFSET UNITYSDK_OFFSET(0xD02F340)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_SET_ISBEFOREPAGEFADEOUTING_OFFSET UNITYSDK_OFFSET(0xD02F300)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_SET_ISINOPENOTHERPAGETRANSITION_OFFSET UNITYSDK_OFFSET(0xD02F320)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_SET_ONGOINGCHATPLAYER_OFFSET UNITYSDK_OFFSET(0xD02F250)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_SET_SCRIPTABLEANIMATIONPLAYER_OFFSET UNITYSDK_OFFSET(0xD02F280)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_SET_UNITMANAGER_OFFSET UNITYSDK_OFFSET(0xD02F2A0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_SHOWCHAPTERFINISHEFFECT_OFFSET UNITYSDK_OFFSET(0xD02FC80)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_SHOWINLEVELTIMEREFFECT_OFFSET UNITYSDK_OFFSET(0xD02FBA0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_SHOWLEVELUPEFFECT_OFFSET UNITYSDK_OFFSET(0xD02FB30)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_SHOWWORLDLEVELUPEFFECT_OFFSET UNITYSDK_OFFSET(0xD02FC10)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER_TRYBLOCKFAIRY_OFFSET UNITYSDK_OFFSET(0xD030710)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0309D0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER__WARMUPWIDGETS_ONOPEN_OFFSET UNITYSDK_OFFSET(0xD02F9E0)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER___BASE_ONBEFOREPAGEFADEIN_OFFSET UNITYSDK_OFFSET(0xD030A20)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER___BASE_ONBEFOREPAGEFADEOUT_OFFSET UNITYSDK_OFFSET(0xD030A90)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xD030B00)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD030B60)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD030B70)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD030B80)
#define MOLEMOLE_UIBASESCENEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD030B90)

namespace MoleMole
{
	inline static constexpr unsigned int UIBaseScenePageController_TypeDefinitionIndex = 41605;
	...
	public:
		...
		::System::Void DispatchToChild(::Enum_3_53C4A418F34F74D8 eventNotifyType, ::Enum_3_A472E51DCF07A558 slotEvent)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_53C4A418F34F74D8, ::Enum_3_A472E51DCF07A558))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBASESCENEPAGECONTROLLER_DISPATCHTOCHILD_OFFSET))(this, eventNotifyType, slotEvent);
		}
