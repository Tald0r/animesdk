...
#define MOLEMOLE_MODELPARTBONESINFO_ANIMATORREBIND_OFFSET UNITYSDK_OFFSET(0x8B1E110)
#define MOLEMOLE_MODELPARTBONESINFO_EXPORTSKINNEDMESHRENDERERBONESINFO_OFFSET UNITYSDK_OFFSET(0x8B1D390)
#define MOLEMOLE_MODELPARTBONESINFO_METHOD_5_22C8CBC081801F98_OFFSET UNITYSDK_OFFSET(0x8B1DEB0)
#define MOLEMOLE_MODELPARTBONESINFO_REBINDBONES_1_OFFSET UNITYSDK_OFFSET(0x8B1DB20)
#define MOLEMOLE_MODELPARTBONESINFO_REBINDBONES_OFFSET UNITYSDK_OFFSET(0x8B1D700)
#define MOLEMOLE_MODELPARTBONESINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8B1E270)

namespace MoleMole
{
	inline static constexpr unsigned int ModelPartBonesInfo_TypeDefinitionIndex = 61292;
