...
#define MOLEMOLE_MODELPARTBONESINFO_ANIMATORREBIND_OFFSET UNITYSDK_OFFSET(0xB1A2940)
#define MOLEMOLE_MODELPARTBONESINFO_EXPORTSKINNEDMESHRENDERERBONESINFO_OFFSET UNITYSDK_OFFSET(0xB1A1BC0)
#define MOLEMOLE_MODELPARTBONESINFO_METHOD_5_22C8CBC081801F98_OFFSET UNITYSDK_OFFSET(0xB1A26E0)
#define MOLEMOLE_MODELPARTBONESINFO_REBINDBONES_1_OFFSET UNITYSDK_OFFSET(0xB1A2350)
#define MOLEMOLE_MODELPARTBONESINFO_REBINDBONES_OFFSET UNITYSDK_OFFSET(0xB1A1F30)
#define MOLEMOLE_MODELPARTBONESINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB1A2AA0)

namespace MoleMole
{
	inline static constexpr unsigned int ModelPartBonesInfo_TypeDefinitionIndex = 62931;
	...
	public:
		...
		::Il2CppArray<::UnityEngine::Transform*>* Method_5_22C8CBC081801F98(::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Transform*>* a1, ::System::Collections::Generic::List_1<::System::String*>* a2)
		{
			return ((::Il2CppArray<::UnityEngine::Transform*>*(*)(::PVOID, ::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Transform*>*, ::System::Collections::Generic::List_1<::System::String*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_MODELPARTBONESINFO_METHOD_5_22C8CBC081801F98_OFFSET))(this, a1, a2);
		}
	};
}
