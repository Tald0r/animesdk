...
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_GETMAXLEVEL_OFFSET UNITYSDK_OFFSET(0xCAC9060)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_INITEQUIPSTAR_OFFSET UNITYSDK_OFFSET(0xCAC8700)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_INITPROPERTYVIEW_OFFSET UNITYSDK_OFFSET(0xCAC8230)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xCAC7540)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCAC7920)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_ONEQUIPCHANGED_OFFSET UNITYSDK_OFFSET(0xCAC9160)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCAC77E0)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCAC79C0)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCAC7490)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCAC7730)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCAC7DD0)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETEQUIPINFO_OFFSET UNITYSDK_OFFSET(0xCAC94B0)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETITEMDATA_OFFSET UNITYSDK_OFFSET(0xCAC7B30)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETITEMINFO_OFFSET UNITYSDK_OFFSET(0xCACBEF0)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETROLEICON_OFFSET UNITYSDK_OFFSET(0xCAC9270)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETSTAR_OFFSET UNITYSDK_OFFSET(0xCAC8E40)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETTITLETEXTSTATE_OFFSET UNITYSDK_OFFSET(0xCAC8010)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETWEAPONINFO_OFFSET UNITYSDK_OFFSET(0xCACA7B0)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCACC200)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCACC230)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCACC2A0)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCACC310)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCACC390)
#define MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCACC3F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralEquipDetailV2WidgetController_TypeDefinitionIndex = 47173;
	...
	public:
		...
		::Class_2_1CC0E2699D5FB1A6_3* _view; // 0x2A0
		...
		::System::Void SetEquipInfo(::Class_2_A3CFC20DC3954F5C* equipmentData, ::Class_1_0D6706375CDAAE8C* currentSelectItemData, ::System::UInt32 currentAvatarId)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_A3CFC20DC3954F5C*, ::Class_1_0D6706375CDAAE8C*, ::System::UInt32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETEQUIPINFO_OFFSET))(this, equipmentData, currentSelectItemData, currentAvatarId);
		}

		::System::Void SetWeaponInfo(::Class_2_A3CFC20DC3954F5C_1* weaponData, ::System::UInt32 currentAvatarId, ::System::Int32 weaponID)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_A3CFC20DC3954F5C_1*, ::System::UInt32, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALEQUIPDETAILV2WIDGETCONTROLLER_SETWEAPONINFO_OFFSET))(this, weaponData, currentAvatarId, weaponID);
		}
