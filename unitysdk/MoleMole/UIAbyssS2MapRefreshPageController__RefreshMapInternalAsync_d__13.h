...
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER__REFRESHMAPINTERNALASYNC_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x355140)
#define MOLEMOLE_UIABYSSS2MAPREFRESHPAGECONTROLLER__REFRESHMAPINTERNALASYNC_D__13_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapRefreshPageController__RefreshMapInternalAsync_d__13_TypeDefinitionIndex = 65195;

	struct alignas(8) UIAbyssS2MapRefreshPageController__RefreshMapInternalAsync_d__13
	{
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::Class_3_991B96FD979B03A4_13*> __u__1; // 0x10
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::ValueTuple_2<::System::Boolean, ::Class_3_2159197412A91599*>> __u__2; // 0x28
		::MoleMole::UIAbyssS2MapRefreshPageController* __4__this; // 0x48
