...
#define MOLEMOLE_UICPENDINGCHILDWINDOWCONTROLLER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8E3B60)
#define MOLEMOLE_UICPENDINGCHILDWINDOWCONTROLLER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8E3BA0)
#define MOLEMOLE_UICPENDINGCHILDWINDOWCONTROLLER___C__SETITEMLISTINFO_B__19_0_OFFSET UNITYSDK_OFFSET(0x1A8E3BB0)
#define MOLEMOLE_UICPENDINGCHILDWINDOWCONTROLLER___C___CCTOR_B__33_0_OFFSET UNITYSDK_OFFSET(0x1A8E3BD0)

namespace MoleMole
{
	inline static constexpr unsigned int UICpEndingChildWindowController___c_TypeDefinitionIndex = 81496;
	...
	public:
		...
		{
			return (::MoleMole::UICpEndingChildWindowController___c**)Il2CppClass::FromTypeDefinitionIndex(UICpEndingChildWindowController___c_TypeDefinitionIndex)->GetStaticField(0x46880);
		}
		static ::System::Comparison_1<::MoleMole::UICpEndingChildWindowController_CpItemInfo>** StaticGet___9__19_0()
		{
			return (::System::Comparison_1<::MoleMole::UICpEndingChildWindowController_CpItemInfo>**)Il2CppClass::FromTypeDefinitionIndex(UICpEndingChildWindowController___c_TypeDefinitionIndex)->GetStaticField(0x46888);
		}
