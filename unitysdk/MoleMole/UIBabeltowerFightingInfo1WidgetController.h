...
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO1WIDGETCONTROLLER_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0xC2A4DD0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO1WIDGETCONTROLLER_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC2A4CF0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO1WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2A4E70)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFO1WIDGETCONTROLLER___BASE_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC2A4E80)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerFightingInfo1WidgetController_TypeDefinitionIndex = 72385;
