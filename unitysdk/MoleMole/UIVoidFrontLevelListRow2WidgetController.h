...
class Class_2_361E46FE0AB3D6E7;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA773550)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA7735C0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xA773820)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA7736C0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA7739A0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA7739B0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xA773A20)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA773A90)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontLevelListRow2WidgetController_TypeDefinitionIndex = 71216;
	...
	public:
		...
		::Class_2_361E46FE0AB3D6E7* get__viewModel()
		{
			return ((::Class_2_361E46FE0AB3D6E7*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
