...
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEA07C00)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEA07C70)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xEA07ED0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xEA07D70)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xEA08050)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEA08060)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xEA080D0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xEA08140)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontLevelListRow2WidgetController_TypeDefinitionIndex = 58163;
