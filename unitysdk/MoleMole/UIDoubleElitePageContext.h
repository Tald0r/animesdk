...
#define MOLEMOLE_UIDOUBLEELITEPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA95F520)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleElitePageContext_TypeDefinitionIndex = 78074;
