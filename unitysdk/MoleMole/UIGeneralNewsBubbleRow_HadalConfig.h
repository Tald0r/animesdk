...
#define MOLEMOLE_UIGENERALNEWSBUBBLEROW_HADALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8C45640)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleRow_HadalConfig_TypeDefinitionIndex = 55327;
