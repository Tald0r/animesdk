...
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB2DF3E0)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS12_0__REFRESHBANGBOOOPTIONALNAME_B__0_OFFSET UNITYSDK_OFFSET(0xB2DF3F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPageController___c__DisplayClass12_0_TypeDefinitionIndex = 39400;

	class UIGachaPageController___c__DisplayClass12_0 : public ::System::Object
	{
	public:
		::Class_1_B81AB3851AD916CA<::System::UInt32>* optionalUpItemList; // 0x10
