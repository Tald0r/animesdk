...
#define MOLEMOLE_DRAWATTACKRANGE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x8F614B0)
#define MOLEMOLE_DRAWATTACKRANGE_PAUSE_OFFSET UNITYSDK_OFFSET(0x8F61760)
#define MOLEMOLE_DRAWATTACKRANGE_PLAY_OFFSET UNITYSDK_OFFSET(0x8F616F0)
#define MOLEMOLE_DRAWATTACKRANGE_SETATTACKRANGE_OFFSET UNITYSDK_OFFSET(0x8F61630)
#define MOLEMOLE_DRAWATTACKRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F617E0)

namespace MoleMole
{
	inline static constexpr unsigned int DrawAttackRange_TypeDefinitionIndex = 74429;
