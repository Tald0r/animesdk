...
#define MOLEMOLE_DRAWATTACKRANGE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xD0C0D80)
#define MOLEMOLE_DRAWATTACKRANGE_PAUSE_OFFSET UNITYSDK_OFFSET(0xD0C1030)
#define MOLEMOLE_DRAWATTACKRANGE_PLAY_OFFSET UNITYSDK_OFFSET(0xD0C0FC0)
#define MOLEMOLE_DRAWATTACKRANGE_SETATTACKRANGE_OFFSET UNITYSDK_OFFSET(0xD0C0F00)
#define MOLEMOLE_DRAWATTACKRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0C10B0)

namespace MoleMole
{
	inline static constexpr unsigned int DrawAttackRange_TypeDefinitionIndex = 74995;
