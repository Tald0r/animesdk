...
#define MOLEMOLE_UIRIGIDBODYGAMEPAD_GET_UIRIGIDBODY_OFFSET UNITYSDK_OFFSET(0xA240290)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD_METHOD_6_0868EF727040C390_OFFSET UNITYSDK_OFFSET(0xA241890)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD_METHOD_6_348B4E17BD1317E0_OFFSET UNITYSDK_OFFSET(0xA240690)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD_METHOD_6_704FAC4600717444_OFFSET UNITYSDK_OFFSET(0xA240410)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD_METHOD_6_A205E8B23947BF16_OFFSET UNITYSDK_OFFSET(0xA240A20)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD_METHOD_6_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0xA240840)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD__CTOR_OFFSET UNITYSDK_OFFSET(0xA241A20)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA241AA0)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD___BASE_ONMODULEDESTROY_OFFSET UNITYSDK_OFFSET(0xA241B30)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD___BASE_ONMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA241B90)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD___BASE_ONMODULELATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA241BA0)
#define MOLEMOLE_UIRIGIDBODYGAMEPAD___BASE_ONMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xA241C20)

namespace MoleMole
{
	inline static constexpr unsigned int UIRigidbodyGamepad_TypeDefinitionIndex = 44471;
