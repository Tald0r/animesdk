...
#define MOLEMOLE_MONOSCENETOFINDOBJECT_DOREALRESET_OFFSET UNITYSDK_OFFSET(0x8309D50)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_DOSHOW_OFFSET UNITYSDK_OFFSET(0x8308700)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_DOSTARTRESET_OFFSET UNITYSDK_OFFSET(0x8309B40)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_DOUPDATE_OFFSET UNITYSDK_OFFSET(0x83096B0)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8309EB0)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_SETMAT_OFFSET UNITYSDK_OFFSET(0x8308780)
#define MOLEMOLE_MONOSCENETOFINDOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x830A0D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSceneToFindObject_TypeDefinitionIndex = 71072;
