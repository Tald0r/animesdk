...
#define MOLEMOLE_MONOSCENETOFINDOBJECT_DOREALRESET_OFFSET UNITYSDK_OFFSET(0xB9283F0)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_DOSHOW_OFFSET UNITYSDK_OFFSET(0xB926DB0)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_DOSTARTRESET_OFFSET UNITYSDK_OFFSET(0xB9281E0)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_DOUPDATE_OFFSET UNITYSDK_OFFSET(0xB927D50)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB928550)
#define MOLEMOLE_MONOSCENETOFINDOBJECT_SETMAT_OFFSET UNITYSDK_OFFSET(0xB926E30)
#define MOLEMOLE_MONOSCENETOFINDOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xB928770)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSceneToFindObject_TypeDefinitionIndex = 60957;
