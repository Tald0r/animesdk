...
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_BINDDATAPROPERTYLISTENER_OFFSET UNITYSDK_OFFSET(0xA9628C0)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_CHECKSHOWORHIDE_OFFSET UNITYSDK_OFFSET(0xA9637E0)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ENTEREMPTYFADEOUTMUTIPLAYERMODE_OFFSET UNITYSDK_OFFSET(0xA963660)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ENTEREMPTYFADEOUT_OFFSET UNITYSDK_OFFSET(0xA9654A0)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_GETFADEANIMDURATION_OFFSET UNITYSDK_OFFSET(0xA965090)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_HAVEFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0xA964430)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_INITSHOWORHIDE_OFFSET UNITYSDK_OFFSET(0xA9646F0)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ISPLAYINGFADEANIM_OFFSET UNITYSDK_OFFSET(0xA9645E0)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA962D00)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ONETHERINFECTIONVALUECHANGE_OFFSET UNITYSDK_OFFSET(0xA965620)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ONETHERINFECTIONVALUEEMPTY_OFFSET UNITYSDK_OFFSET(0xA965380)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ONETHERINFECTIONVALUEFULL_OFFSET UNITYSDK_OFFSET(0xA9652B0)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xA965990)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ONGETINFECTIONVALUE_OFFSET UNITYSDK_OFFSET(0xA964A20)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ONLOCALAVATARCHANGED_OFFSET UNITYSDK_OFFSET(0xA964840)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ONQTESTATECHANGE_OFFSET UNITYSDK_OFFSET(0xA965850)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA962DA0)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA961E80)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA962450)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_PLAYCUSTOMPROPERTYFULLFADEOUT_OFFSET UNITYSDK_OFFSET(0xA965140)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_PLAYFULLFADEOUT_OFFSET UNITYSDK_OFFSET(0xA964B60)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_REFRESHCUSTOMPROPERTYDISPLAY_OFFSET UNITYSDK_OFFSET(0xA962A50)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_REFRESHMULTIPLAYERDISPLAYMODE_OFFSET UNITYSDK_OFFSET(0xA9626D0)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_REFRESHPROGRESSVALUE_OFFSET UNITYSDK_OFFSET(0xA963B50)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_SETHIDE_OFFSET UNITYSDK_OFFSET(0xA964160)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_SETROOTSLOTACTIVESTATE_OFFSET UNITYSDK_OFFSET(0xA9658F0)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_SETVISIBLE_OFFSET UNITYSDK_OFFSET(0xA9656C0)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_TRYBINDCUSTOMPROPERTYLISTENERANDREFRESH_OFFSET UNITYSDK_OFFSET(0xA966000)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_UNBINDPROPERTYLISTENER_OFFSET UNITYSDK_OFFSET(0xA962EA0)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA9631C0)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9661F0)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER__INITSHOWORHIDE_B__11_0_OFFSET UNITYSDK_OFFSET(0xA966250)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER__ONGETINFECTIONVALUE_B__16_0_OFFSET UNITYSDK_OFFSET(0xA966340)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER__SETHIDE_B__30_0_OFFSET UNITYSDK_OFFSET(0xA966500)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER__SETVISIBLE_B__29_0_OFFSET UNITYSDK_OFFSET(0xA966420)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA966810)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA966880)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA966890)
#define MOLEMOLE_UIETHERINFECTIONPROGRESSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA9668F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEtherInfectionProgressWidgetController_TypeDefinitionIndex = 56081;
	...
	public:
		...
		::Class_2_84D60E5AA05E9C23_2* _view; // 0x2A8
		...
		::Class_1_7A5F167CAAA013FB* lastFighter; // 0x310
