...
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_AWAKE_OFFSET UNITYSDK_OFFSET(0xA3B3B70)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0xA3B5060)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_2DF7969B85DC261B_OFFSET UNITYSDK_OFFSET(0xA3B48F0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0xA3B5F70)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0xA3B3D30)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xA3B5D70)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA3B5F10)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0xA3B5EA0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA3B5450)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA3B4640)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA3B45D0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_RUNTIMESYNCSIZE_OFFSET UNITYSDK_OFFSET(0xA3B52B0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_RUNTIMESYNCWIDTH_OFFSET UNITYSDK_OFFSET(0xA3B4750)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_SETONEWAYDOORSENSORACTIVE_OFFSET UNITYSDK_OFFSET(0xA3B46B0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC__CCTOR_OFFSET UNITYSDK_OFFSET(0xA3B58A0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0xA3B55A0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLevelDoorWidthSync_TypeDefinitionIndex = 45181;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::MonoLevelDoorWidthSync_Class_1_991BEB3714D9D0F5*>**)Il2CppClass::FromTypeDefinitionIndex(MonoLevelDoorWidthSync_TypeDefinitionIndex)->GetStaticField(0x3EED0);
		}
