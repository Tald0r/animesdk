...
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_AWAKE_OFFSET UNITYSDK_OFFSET(0x82F97F0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0x82FACE0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_2DF7969B85DC261B_OFFSET UNITYSDK_OFFSET(0x82FA570)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0x82FBA00)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0x82F99B0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x82FBDF0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x82FBF20)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0x82FBD80)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x82FB0D0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x82FA2C0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_ONENABLE_OFFSET UNITYSDK_OFFSET(0x82FA250)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_RUNTIMESYNCSIZE_OFFSET UNITYSDK_OFFSET(0x82FAF30)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_RUNTIMESYNCWIDTH_OFFSET UNITYSDK_OFFSET(0x82FA3D0)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC_SETONEWAYDOORSENSORACTIVE_OFFSET UNITYSDK_OFFSET(0x82FA330)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC__CCTOR_OFFSET UNITYSDK_OFFSET(0x82FB520)
#define MOLEMOLE_MONOLEVELDOORWIDTHSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x82FB220)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLevelDoorWidthSync_TypeDefinitionIndex = 68414;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::MonoLevelDoorWidthSync_Class_1_991BEB3714D9D0F5*>**)Il2CppClass::FromTypeDefinitionIndex(MonoLevelDoorWidthSync_TypeDefinitionIndex)->GetStaticField(0x3C1B0);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_6D93101E4CE10A96_OFFSET))(this);
		}

		::System::Void Method_5_2DF7969B85DC261B(::System::Single a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_2DF7969B85DC261B_OFFSET))(this, a1);
		}

		::System::Void Method_5_CFE6FB160FFF5938()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_CFE6FB160FFF5938_OFFSET))(this);
		}

		::System::Void Method_5_0FD0EC313FAAB75A()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOLEVELDOORWIDTHSYNC_METHOD_5_0FD0EC313FAAB75A_OFFSET))(this);
		}
