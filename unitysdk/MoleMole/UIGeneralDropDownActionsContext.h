...
#define MOLEMOLE_UIGENERALDROPDOWNACTIONSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x95FB100)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralDropDownActionsContext_TypeDefinitionIndex = 63326;

	class UIGeneralDropDownActionsContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::UnityEngine::Transform* LocateLD; // 0x28
		::UnityEngine::Transform* LocateRD; // 0x30
		::UnityEngine::Transform* LocateLT; // 0x38
		::UnityEngine::Transform* LocateRT; // 0x40
		::System::Collections::Generic::IReadOnlyList_1<::Class_1_777EB91B86430809*>* ButtonContexts; // 0x48
