...
#define MOLEMOLE_UIFRIENDSYSTEMMEDALWIDGETCONTROLLER_GET_HASMEDAL_OFFSET UNITYSDK_OFFSET(0x9BDDF40)
#define MOLEMOLE_UIFRIENDSYSTEMMEDALWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9BDDC30)
#define MOLEMOLE_UIFRIENDSYSTEMMEDALWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9BDDCA0)
#define MOLEMOLE_UIFRIENDSYSTEMMEDALWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9BDDD60)
#define MOLEMOLE_UIFRIENDSYSTEMMEDALWIDGETCONTROLLER_REFRESHPLAYERMEDAL_OFFSET UNITYSDK_OFFSET(0x9BDE080)
#define MOLEMOLE_UIFRIENDSYSTEMMEDALWIDGETCONTROLLER_REFRESHSELFMEDAL_OFFSET UNITYSDK_OFFSET(0x9BDE150)
#define MOLEMOLE_UIFRIENDSYSTEMMEDALWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9BDE220)
#define MOLEMOLE_UIFRIENDSYSTEMMEDALWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9BDE250)
#define MOLEMOLE_UIFRIENDSYSTEMMEDALWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9BDE2C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendSystemMedalWidgetController_TypeDefinitionIndex = 60556;
