...
#define MOLEMOLE_CONFIGUICOMMON_INITINTERKNOTPOSTHEIGHT_OFFSET UNITYSDK_OFFSET(0xCDCDC60)
#define MOLEMOLE_CONFIGUICOMMON__CTOR_OFFSET UNITYSDK_OFFSET(0xCDCE200)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_TypeDefinitionIndex = 54996;
