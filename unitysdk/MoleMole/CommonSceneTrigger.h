...
#define MOLEMOLE_COMMONSCENETRIGGER_CREATEBOXTRIGGER_OFFSET UNITYSDK_OFFSET(0xE2AF4C0)
#define MOLEMOLE_COMMONSCENETRIGGER_CREATECAPSULETRIGGER_OFFSET UNITYSDK_OFFSET(0xE2AF7F0)
#define MOLEMOLE_COMMONSCENETRIGGER_CREATESPHERETRIGGER_OFFSET UNITYSDK_OFFSET(0xE2AFAE0)
#define MOLEMOLE_COMMONSCENETRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xE2AF120)
#define MOLEMOLE_COMMONSCENETRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xE2AF1D0)
#define MOLEMOLE_COMMONSCENETRIGGER_REGISTERTRIGGERENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0xE2AF280)
#define MOLEMOLE_COMMONSCENETRIGGER_REGISTERTRIGGEREXITCALLBACK_OFFSET UNITYSDK_OFFSET(0xE2AF310)
#define MOLEMOLE_COMMONSCENETRIGGER_UNREGISTERTRIGGERENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0xE2AF3A0)
#define MOLEMOLE_COMMONSCENETRIGGER_UNREGISTERTRIGGEREXITCALLBACK_OFFSET UNITYSDK_OFFSET(0xE2AF430)
#define MOLEMOLE_COMMONSCENETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xE2AFDC0)

namespace MoleMole
{
	inline static constexpr unsigned int CommonSceneTrigger_TypeDefinitionIndex = 38889;
