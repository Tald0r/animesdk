...
#define MOLEMOLE_THEGUNGOBATTLECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9947700)

namespace MoleMole
{
	inline static constexpr unsigned int TheGunGoBattleContext_TypeDefinitionIndex = 42942;
