...
#define MOLEMOLE_UIONRECTTRANSFORMDIMENSIONSCHANGEHANDLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAC182E0)
#define MOLEMOLE_UIONRECTTRANSFORMDIMENSIONSCHANGEHANDLER_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xAC18240)
#define MOLEMOLE_UIONRECTTRANSFORMDIMENSIONSCHANGEHANDLER_REGISTERONRECTTRANSFORMDIMENSIONSCHANGECALLBACK_OFFSET UNITYSDK_OFFSET(0xAC181D0)
#define MOLEMOLE_UIONRECTTRANSFORMDIMENSIONSCHANGEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC18350)
#define MOLEMOLE_UIONRECTTRANSFORMDIMENSIONSCHANGEHANDLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAC18370)
#define MOLEMOLE_UIONRECTTRANSFORMDIMENSIONSCHANGEHANDLER___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xAC18400)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnRectTransformDimensionsChangeHandler_TypeDefinitionIndex = 44688;
