...
#define MOLEMOLE_UISOCIALCIRCLEMAINNEWSROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA8CAC0)
#define MOLEMOLE_UISOCIALCIRCLEMAINNEWSROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA8CBD0)
#define MOLEMOLE_UISOCIALCIRCLEMAINNEWSROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCA8CCC0)
#define MOLEMOLE_UISOCIALCIRCLEMAINNEWSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA8CB30)
#define MOLEMOLE_UISOCIALCIRCLEMAINNEWSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA8CD40)
#define MOLEMOLE_UISOCIALCIRCLEMAINNEWSROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA8CD50)
#define MOLEMOLE_UISOCIALCIRCLEMAINNEWSROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCA8CDC0)
#define MOLEMOLE_UISOCIALCIRCLEMAINNEWSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA8CE40)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleMainNewsRowWidgetController_TypeDefinitionIndex = 62312;
	...
	public:
		...
		{
			return ((::Class_2_EC28E1D3A39EE7DE_18*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISOCIALCIRCLEMAINNEWSROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
