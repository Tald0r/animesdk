...
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER_ONCLICKBPITEM_OFFSET UNITYSDK_OFFSET(0xE93DB20)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE93D700)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xE93D880)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE93D7A0)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE93D4F0)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE93D650)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE93DBD0)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE93DBE0)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xE93DC50)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE93DCD0)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE93DD50)
#define MOLEMOLE_UIBPWEAPONLISTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE93DDB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPWeaponListRowWidgetController_TypeDefinitionIndex = 50285;
