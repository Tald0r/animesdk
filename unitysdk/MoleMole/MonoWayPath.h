...
#define MOLEMOLE_MONOWAYPATH_FINDCLOSESTWAYPOINT_OFFSET UNITYSDK_OFFSET(0xB1B25B0)
#define MOLEMOLE_MONOWAYPATH_FINDNEXTWAYPOINT_OFFSET UNITYSDK_OFFSET(0xB1B2740)
#define MOLEMOLE_MONOWAYPATH_GETWAYPOINTBYPOINTNAME_OFFSET UNITYSDK_OFFSET(0xB1B29D0)
#define MOLEMOLE_MONOWAYPATH_GETWAYPOINT_OFFSET UNITYSDK_OFFSET(0xB1B2940)
#define MOLEMOLE_MONOWAYPATH_INIT_OFFSET UNITYSDK_OFFSET(0xB1B2340)
#define MOLEMOLE_MONOWAYPATH_UPDATE_OFFSET UNITYSDK_OFFSET(0xB1B20B0)
#define MOLEMOLE_MONOWAYPATH__CTOR_OFFSET UNITYSDK_OFFSET(0xB1B2AD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoWayPath_TypeDefinitionIndex = 59861;
