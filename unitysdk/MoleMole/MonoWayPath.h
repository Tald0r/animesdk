...
#define MOLEMOLE_MONOWAYPATH_FINDCLOSESTWAYPOINT_OFFSET UNITYSDK_OFFSET(0xBD41650)
#define MOLEMOLE_MONOWAYPATH_FINDNEXTWAYPOINT_OFFSET UNITYSDK_OFFSET(0xBD417E0)
#define MOLEMOLE_MONOWAYPATH_GETWAYPOINTBYPOINTNAME_OFFSET UNITYSDK_OFFSET(0xBD41A70)
#define MOLEMOLE_MONOWAYPATH_GETWAYPOINT_OFFSET UNITYSDK_OFFSET(0xBD419E0)
#define MOLEMOLE_MONOWAYPATH_INIT_OFFSET UNITYSDK_OFFSET(0xBD413E0)
#define MOLEMOLE_MONOWAYPATH_UPDATE_OFFSET UNITYSDK_OFFSET(0xBD41150)
#define MOLEMOLE_MONOWAYPATH__CTOR_OFFSET UNITYSDK_OFFSET(0xBD41B70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoWayPath_TypeDefinitionIndex = 47389;
