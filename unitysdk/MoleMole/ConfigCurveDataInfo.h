...
#define MOLEMOLE_CONFIGCURVEDATAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCD28560)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigCurveDataInfo_TypeDefinitionIndex = 70682;
