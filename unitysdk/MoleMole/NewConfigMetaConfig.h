...
namespace MoleMole
{
	...
	public:
		...
		::Foundation::AssetPath SyncDevConfigDataPath; // 0x670
		::Foundation::AssetPath SpecailEffectHitDataConfigPath; // 0x680
		::Foundation::AssetPath DynamicBoneConfigMapPath; // 0x690
		::Foundation::AssetPath HollowEntityLayerMaskConfigPath; // 0x6A0
		::Foundation::AssetPath GroupVideoConfigPath; // 0x6B0
		::Foundation::AssetPath GachaPerformancePath; // 0x6C0
		::Foundation::AssetPath hollowCampTypePath; // 0x6D0
		::Foundation::AssetPath soundWavePath; // 0x6E0
		::Foundation::AssetPath soundWavePath_En; // 0x6F0
		::Foundation::AssetPath soundWavePath_Jp; // 0x700
		::Foundation::AssetPath soundWavePath_Kr; // 0x710
		::Foundation::AssetPath soundWavePath_Event; // 0x720
		::Foundation::AssetPath UIPortraitConfigPath; // 0x730
		::Foundation::AssetPath UIGachaPortraitConfigPath; // 0x740
		::Foundation::AssetPath LevelResultPerformsPath; // 0x750
		::Foundation::AssetPath DamageTextPrefabPath; // 0x760
		::Foundation::AssetPath GachaPerformanceLightsPath; // 0x770
		::Foundation::AssetPath levelPerformConfigPath; // 0x780
		::Foundation::AssetPath languageVideoConfigPath; // 0x790
		::Foundation::AssetPath LevelShootGameConfigPath; // 0x7A0
		::Foundation::AssetPath characterAimModeConfigPath; // 0x7B0
		::Foundation::AssetPath levelAddonConfigPath; // 0x7C0
		::Foundation::AssetPath weaponConfigPath; // 0x7D0
		::Foundation::AssetPath uiAvatarConfigPath; // 0x7E0
		::Foundation::AssetPath EffectPatternInfoConfigPath; // 0x7F0
		::Foundation::AssetPath GachaPerformanceEffectsPath; // 0x800
		::Foundation::AssetPath multiplayerConfigPath; // 0x810
		::Foundation::AssetPath UIConfigScriptsPath; // 0x820
		::Il2CppArray<::Foundation::AssetPath>* statisConfigPaths; // 0x830
		::Foundation::AssetPath MaterialPropertyExclusivityPath; // 0x838
		::Foundation::AssetPath ConfigHollowChessboardAtmosphere; // 0x848
		::Foundation::AssetPath EntityAttackEffectNamesPath; // 0x858
		::Foundation::AssetPath ConfigUIBuddySettingPath; // 0x868
		::Foundation::AssetPath ConfigMaterialPropertySettingsPath; // 0x878
		::Foundation::AssetPath ConfigBuddyMiscPath; // 0x888
		::Foundation::AssetPath ConfigIndicatedLightsPath; // 0x898
		::Foundation::AssetPath ConfigTagLibPath; // 0x8A8
		::Foundation::AssetPath ConfigWindFieldPath; // 0x8B8
		::Foundation::AssetPath ConfigInLevelCustomizedPath; // 0x8C8
		::Foundation::AssetPath ConfigSkillTypeToAttackTagsPath; // 0x8D8
		::Foundation::AssetPath ConfigSpecialEffectHitWallPath; // 0x8E8
		::Foundation::AssetPath ConfigAvatarDateTeleportPath; // 0x8F8
		::Foundation::AssetPath ConfigEnvironmentSound; // 0x908
		::Foundation::AssetPath ConfigEffectSound; // 0x918
		::Foundation::AssetPath ConfigLevelSound; // 0x928
		::Foundation::AssetPath ConfigDebugSound; // 0x938
		::Foundation::AssetPath ConfigRichtapSound; // 0x948
		::Foundation::AssetPath ConfigUIFishPath; // 0x958
		::Foundation::AssetPath ConfigUIFishV2Path; // 0x968
		::Foundation::AssetPath ConfigBattlePhotoActivityPath; // 0x978
		::Foundation::AssetPath ConfigGamepadTriggerEffectPath; // 0x988
		::Foundation::AssetPath MarcelConfigPath; // 0x998
		::Foundation::AssetPath ConfigShootingGroundPath; // 0x9A8
		::Foundation::AssetPath ConfigSurfMiniGamePath; // 0x9B8
		::Foundation::AssetPath ConfigFlowerShopActivityPath; // 0x9C8
		::Foundation::AssetPath UIMainPageBuddiesShowConfigPath; // 0x9D8
		::Foundation::AssetPath UIMainPageSkinShowConfigPath; // 0x9E8
		::Foundation::AssetPath UIMainPageShowConfigPath; // 0x9F8
		::Foundation::AssetPath AvatarScriptAndAnimOverrideDataPath; // 0xA08
		::Foundation::AssetPath ConfigNpcPrototypePath; // 0xA18
		::Foundation::AssetPath ConfigUINewMapPath; // 0xA28
		::Foundation::AssetPath ConfigPlayerAccessoryPath; // 0xA38
		::Foundation::AssetPath MonsterAlertsPath; // 0xA48
		::Foundation::AssetPath DitherConfigSeparatePath; // 0xA58
		::Foundation::AssetPath ConfigTempleLevelUpPath; // 0xA68
		::Foundation::AssetPath SummerEventMonsterSpawnConfigPath; // 0xA78
		::Foundation::AssetPath MonsterMappingConfigPath; // 0xA88
		::Foundation::AssetPath MonsterSpecialIdleConfigPath; // 0xA98
		::Foundation::AssetPath SlidingConfigPath; // 0xAA8
		::Foundation::AssetPath MovingWallConfigPath; // 0xAB8
		::Foundation::AssetPath HackerDroneConfigPath; // 0xAC8
		::Foundation::AssetPath SummerEventShootingGameplayConfigPath; // 0xAD8
		::Foundation::AssetPath ConfigPlayerAccessoryEffectDataPath; // 0xAE8
		::Foundation::AssetPath triDiceOracleConfigPath; // 0xAF8
		::Foundation::AssetPath ConfigViewObjectEntityDitherPath; // 0xB08
		::Foundation::AssetPath ConfigViewObjectMiscPath; // 0xB18
		::Foundation::AssetPath ConfigSkinPreviewPath; // 0xB28
		::Foundation::AssetPath ConfigSkinMdbPath; // 0xB38
		::Foundation::AssetPath ConfigAutoBattleAccessoryEffectDataPath; // 0xB48
		::Foundation::AssetPath ConfigActivityRhythmClickBeatmapPath; // 0xB58
		::Foundation::AssetPath ConfigOnGoingTypeDurationDataPath; // 0xB68
		::Foundation::AssetPath ConfigScaleCameraZPath; // 0xB78
		::Foundation::AssetPath ConfigTurnBaseBattlePath; // 0xB88
		::Foundation::AssetPath multiplayerConfigUIPath; // 0xB98
		::Foundation::AssetPath TeleportSelectionsPath; // 0xBA8
		::Foundation::AssetPath ConfigUICoopTeam3dPath; // 0xBB8
		::Foundation::AssetPath DynamicAccessoriesPath; // 0xBC8
		::Foundation::AssetPath ConfigHackPath; // 0xBD8
		::Foundation::AssetPath ConfigHackControllablePath; // 0xBE8
