...
#define MOLEMOLE_COINBRUSHINGWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xE2ADD50)

namespace MoleMole
{
	inline static constexpr unsigned int CoinBrushingWidgetContext_TypeDefinitionIndex = 43743;
