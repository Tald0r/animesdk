...
#define MOLEMOLE_COINBRUSHINGWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15E9BEB0)

namespace MoleMole
{
	inline static constexpr unsigned int CoinBrushingWidgetContext_TypeDefinitionIndex = 48560;
