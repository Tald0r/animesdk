...
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xB243590)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_METHOD_5_33E2FA8E6403B93D_OFFSET UNITYSDK_OFFSET(0xB243690)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_METHOD_5_674F73509924BD16_OFFSET UNITYSDK_OFFSET(0xB243410)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_METHOD_5_8CB9BDF340E2FC64_OFFSET UNITYSDK_OFFSET(0xB243C50)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB243BE0)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB243E10)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB243370)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB243620)
#define MOLEMOLE_UIMATERIALPARAMSCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB243E80)

namespace MoleMole
{
	inline static constexpr unsigned int UIMaterialParamsController_TypeDefinitionIndex = 46489;
