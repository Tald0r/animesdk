...
#define MOLEMOLE_MONOFISHPOLEDUMMY__CTOR_OFFSET UNITYSDK_OFFSET(0x9925D40)

namespace MoleMole
{
	inline static constexpr unsigned int MonoFishPoleDummy_TypeDefinitionIndex = 60401;
