...
#define MOLEMOLE_ANTIQUELEVELUPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xB499860)
#define MOLEMOLE_ANTIQUELEVELUPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xB499840)
#define MOLEMOLE_ANTIQUELEVELUPSHOW___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xB499B20)

namespace MoleMole
{
	inline static constexpr unsigned int AntiqueLevelUpShow_TypeDefinitionIndex = 41241;
