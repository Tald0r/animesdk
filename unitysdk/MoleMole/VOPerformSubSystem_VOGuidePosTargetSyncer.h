...
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOGUIDEPOSTARGETSYNCER_INIT_OFFSET UNITYSDK_OFFSET(0x88406F0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOGUIDEPOSTARGETSYNCER_TRYGETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x883FF70)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOGUIDEPOSTARGETSYNCER__CTOR_OFFSET UNITYSDK_OFFSET(0x8840760)

namespace MoleMole
{
	inline static constexpr unsigned int VOPerformSubSystem_VOGuidePosTargetSyncer_TypeDefinitionIndex = 62429;
