...
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOGUIDEPOSTARGETSYNCER_INIT_OFFSET UNITYSDK_OFFSET(0x6AFEF30)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOGUIDEPOSTARGETSYNCER_TRYGETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x6AFE7B0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOGUIDEPOSTARGETSYNCER__CTOR_OFFSET UNITYSDK_OFFSET(0x6AFEFA0)

namespace MoleMole
{
	inline static constexpr unsigned int VOPerformSubSystem_VOGuidePosTargetSyncer_TypeDefinitionIndex = 55342;
