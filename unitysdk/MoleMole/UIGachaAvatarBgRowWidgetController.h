...
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER_ISPLAYINGANIMATION_OFFSET UNITYSDK_OFFSET(0xD571120)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD570FA0)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER_ONENTERANIMATIONEND_OFFSET UNITYSDK_OFFSET(0xD5719A0)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER_ONENTEREXCHANGEANIMATIONEND_OFFSET UNITYSDK_OFFSET(0xD571A00)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD571040)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD5709A0)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD570AC0)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER_PLAYENTERANIMATION_OFFSET UNITYSDK_OFFSET(0xD5711A0)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0xD571290)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER_REFRESHUPAVATARS_OFFSET UNITYSDK_OFFSET(0xD5713E0)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD570BE0)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD571A60)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD571B00)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD571B70)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD571BF0)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD571C50)
#define MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER___BASE_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0xD571CC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaAvatarBgRowWidgetController_TypeDefinitionIndex = 49228;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_2_D89CCC627A66D0AD*>* _upAvatars; // 0x2B8
		...
		::System::Void RefreshUpAvatars(::Class_3_AE02BC8285203464_8* gacha, ::System::Boolean rebuildAll)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_AE02BC8285203464_8*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGACHAAVATARBGROWWIDGETCONTROLLER_REFRESHUPAVATARS_OFFSET))(this, gacha, rebuildAll);
		}
