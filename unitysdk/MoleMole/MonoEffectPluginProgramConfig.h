...
#define MOLEMOLE_MONOEFFECTPLUGINPROGRAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6E3FF70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginProgramConfig_TypeDefinitionIndex = 77535;
