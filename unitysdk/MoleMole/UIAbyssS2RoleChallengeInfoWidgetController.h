...
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_ONBUILDBTNCLICK_OFFSET UNITYSDK_OFFSET(0xE8F87D0)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE8F8570)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xE8F8420)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_ONMONSTERCARDBTNCLICK_OFFSET UNITYSDK_OFFSET(0xE8F8610)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE8F7FC0)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE8F8370)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHBUFFVIEW_OFFSET UNITYSDK_OFFSET(0xE8F8C50)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHCHALLENGEVIEW_OFFSET UNITYSDK_OFFSET(0xE8F8A40)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHGRADEVIEW_OFFSET UNITYSDK_OFFSET(0xE8F91E0)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHITEMVIEW_OFFSET UNITYSDK_OFFSET(0xE8F8F50)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHMONSTERCARDVIEW_OFFSET UNITYSDK_OFFSET(0xE8F9FA0)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHVIDEOINFOVIEW_OFFSET UNITYSDK_OFFSET(0xE8F9A90)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xE8FA360)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE8FA460)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE8FA560)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xE8FA5D0)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE8FA630)
#define MOLEMOLE_UIABYSSS2ROLECHALLENGEINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE8FA690)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RoleChallengeInfoWidgetController_TypeDefinitionIndex = 75750;
	...
	public:
		...
		::Class_2_0A55B5A82A61DAFA* _questConfig; // 0x2B8
