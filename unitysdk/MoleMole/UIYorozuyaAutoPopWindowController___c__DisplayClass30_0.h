...
#define MOLEMOLE_UIYOROZUYAAUTOPOPWINDOWCONTROLLER___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCA93510)
#define MOLEMOLE_UIYOROZUYAAUTOPOPWINDOWCONTROLLER___C__DISPLAYCLASS30_0__ONOKCLICKHANDLE_B__0_OFFSET UNITYSDK_OFFSET(0xCA93520)
#define MOLEMOLE_UIYOROZUYAAUTOPOPWINDOWCONTROLLER___C__DISPLAYCLASS30_0__ONOKCLICKHANDLE_B__1_OFFSET UNITYSDK_OFFSET(0xCA93650)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaAutoPopWindowController___c__DisplayClass30_0_TypeDefinitionIndex = 44742;
