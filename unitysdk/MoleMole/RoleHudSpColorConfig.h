...
#define MOLEMOLE_ROLEHUDSPCOLORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6B1E640)

namespace MoleMole
{
	inline static constexpr unsigned int RoleHudSpColorConfig_TypeDefinitionIndex = 51735;
