...
#define MOLEMOLE_ROLEHUDSPCOLORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD4474D0)

namespace MoleMole
{
	inline static constexpr unsigned int RoleHudSpColorConfig_TypeDefinitionIndex = 41070;
