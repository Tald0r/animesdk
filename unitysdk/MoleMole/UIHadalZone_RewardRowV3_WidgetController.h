...
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_GET_TAKEREWARDACTION_OFFSET UNITYSDK_OFFSET(0x8C4EA10)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C4D150)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x8C4E060)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8C4D480)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8C4D330)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C4D3A0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C4CED0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_REFRESHREWARDITEMS_OFFSET UNITYSDK_OFFSET(0x8C4D750)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER_SET_TAKEREWARDACTION_OFFSET UNITYSDK_OFFSET(0x8C4EA20)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER__CLEARPREVS_OFFSET UNITYSDK_OFFSET(0x8C4E100)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER__CREATEREWARDITEMSCROLL_OFFSET UNITYSDK_OFFSET(0x8C4E370)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C4EA30)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__12_0_OFFSET UNITYSDK_OFFSET(0x8C4EA40)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER__SETBTNCLICK_OFFSET UNITYSDK_OFFSET(0x8C4E2A0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER__TAKEREWARD_OFFSET UNITYSDK_OFFSET(0x8C4E720)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C4ECF0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x8C4ED60)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8C4EDC0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8C4EE40)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C4EE50)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C4EED0)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___SETBTNCLICK_B__15_0_OFFSET UNITYSDK_OFFSET(0x8C4EB00)
#define MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___TAKEREWARD_B__18_0_OFFSET UNITYSDK_OFFSET(0x8C4EBD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_RewardRowV3_WidgetController_TypeDefinitionIndex = 68126;
	...
	public:
		...
		::System::Void __TakeReward_b__18_0(::Class_3_025FF4981524A424_518* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_025FF4981524A424_518*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_REWARDROWV3_WIDGETCONTROLLER___TAKEREWARD_B__18_0_OFFSET))(this, rsp);
		}
