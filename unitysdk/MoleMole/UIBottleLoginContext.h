...
#define MOLEMOLE_UIBOTTLELOGINCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC294C20)

namespace MoleMole
{
	inline static constexpr unsigned int UIBottleLoginContext_TypeDefinitionIndex = 41580;
