...
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB0D7220)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB0D72C0)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB0D70D0)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB0D7170)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_REFRESHBUFFVIEW_1_OFFSET UNITYSDK_OFFSET(0xB0D7A50)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_REFRESHBUFFVIEW_OFFSET UNITYSDK_OFFSET(0xB0CEAE0)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_SETBGCOLOR_1_OFFSET UNITYSDK_OFFSET(0xB0D76F0)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER_SETBGCOLOR_OFFSET UNITYSDK_OFFSET(0xB0D73A0)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB0D7C10)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB0D7C40)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB0D7CB0)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB0D7D30)
#define MOLEMOLE_UIDOUBLETIPSINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB0D7D90)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleTipsInfoWidgetController_TypeDefinitionIndex = 40604;
