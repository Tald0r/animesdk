...
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC0769E0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__INITCHOICEOBJ_B__0_OFFSET UNITYSDK_OFFSET(0xC0769F0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__INITCHOICEOBJ_B__1_OFFSET UNITYSDK_OFFSET(0xC076EB0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__INITCHOICEOBJ_B__2_OFFSET UNITYSDK_OFFSET(0xC076F60)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__INITCHOICEOBJ_B__3_OFFSET UNITYSDK_OFFSET(0xC077010)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__INITCHOICEOBJ_B__4_OFFSET UNITYSDK_OFFSET(0xC077060)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMiniEventWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 46833;
