...
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8733990)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__INITCHOICEOBJ_B__0_OFFSET UNITYSDK_OFFSET(0x87339A0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__INITCHOICEOBJ_B__1_OFFSET UNITYSDK_OFFSET(0x8733E60)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__INITCHOICEOBJ_B__2_OFFSET UNITYSDK_OFFSET(0x8733F10)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__INITCHOICEOBJ_B__3_OFFSET UNITYSDK_OFFSET(0x8733FC0)
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER___C__DISPLAYCLASS8_0__INITCHOICEOBJ_B__4_OFFSET UNITYSDK_OFFSET(0x8734010)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMiniEventWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 37888;

	class UIHollowMiniEventWidgetController___c__DisplayClass8_0 : public ::System::Object
	{
	public:
		::System::Action* __9__2; // 0x10
		::MoleMole::Config::HollowPopInteractOption* currentChoice; // 0x18
		::MoleMole::UIHollowMiniEventWidgetController* __4__this; // 0x20
