...
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_HIDEREWARDROWGETREWARDEFFECT_OFFSET UNITYSDK_OFFSET(0xD98C130)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONCLIKLEVELREWARDROW_OFFSET UNITYSDK_OFFSET(0xD98C000)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD98B570)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD98BF00)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD98BDF0)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD98B700)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD98B610)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD98B210)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_REFRESHCONSOLEBTNSTATE_OFFSET UNITYSDK_OFFSET(0xD98BB60)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER_STARTREWARDROWGETREWARDEFFECT_OFFSET UNITYSDK_OFFSET(0xD98C090)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD98C1A0)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD98C1B0)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD98C220)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD98C2A0)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD98C320)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD98C3A0)
#define MOLEMOLE_UIBPLEVELREWARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD98C420)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPLevelRewardRowWidgetController_TypeDefinitionIndex = 50877;

	class UIBPLevelRewardRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_28* _view; // 0x2D0
		::Class_1_C24B693A39FF0505* levelRewardData; // 0x2D8
