...
#define MOLEMOLE_CURVEMOVEMETA_GET_IGNOREINCURVEMOVE_OFFSET UNITYSDK_OFFSET(0x6E067C0)
#define MOLEMOLE_CURVEMOVEMETA_GET_REVERTORIENTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x6E067D0)
#define MOLEMOLE_CURVEMOVEMETA_METHOD_7_BDBA00FB43D83ECB_OFFSET UNITYSDK_OFFSET(0x6E068A0)
#define MOLEMOLE_CURVEMOVEMETA_METHOD_7_E3A480FECDAD331E_OFFSET UNITYSDK_OFFSET(0x6E06930)
#define MOLEMOLE_CURVEMOVEMETA__CTOR_OFFSET UNITYSDK_OFFSET(0x6E06910)

namespace MoleMole
{
	inline static constexpr unsigned int CurveMoveMeta_TypeDefinitionIndex = 56588;
