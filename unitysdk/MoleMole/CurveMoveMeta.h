...
#define MOLEMOLE_CURVEMOVEMETA_GET_IGNOREINCURVEMOVE_OFFSET UNITYSDK_OFFSET(0xC255A60)
#define MOLEMOLE_CURVEMOVEMETA_GET_REVERTORIENTATIONAXIS_OFFSET UNITYSDK_OFFSET(0xC255A70)
#define MOLEMOLE_CURVEMOVEMETA_METHOD_7_BDBA00FB43D83ECB_OFFSET UNITYSDK_OFFSET(0xC255B40)
#define MOLEMOLE_CURVEMOVEMETA_METHOD_7_E3A480FECDAD331E_OFFSET UNITYSDK_OFFSET(0xC255BD0)
#define MOLEMOLE_CURVEMOVEMETA__CTOR_OFFSET UNITYSDK_OFFSET(0xC255BB0)

namespace MoleMole
{
	inline static constexpr unsigned int CurveMoveMeta_TypeDefinitionIndex = 62870;
	...
	public:
		...
		::System::Void Method_7_E3A480FECDAD331E(::Enum_3_539A5A7FAC22747B a1)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_539A5A7FAC22747B))((::PBYTE)hIl2Cpp + MOLEMOLE_CURVEMOVEMETA_METHOD_7_E3A480FECDAD331E_OFFSET))(this, a1);
		}
