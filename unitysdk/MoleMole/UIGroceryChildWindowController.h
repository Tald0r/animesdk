...
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0xC12EF20)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_DOBUY_OFFSET UNITYSDK_OFFSET(0xC12D7A0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_GETITEMGAMEPADLIST_OFFSET UNITYSDK_OFFSET(0xC12F7B0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC12C840)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xC12D300)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_INITTABBTNGROUP_OFFSET UNITYSDK_OFFSET(0xC12CEA0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC12C9A0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCLICKTABLEFT_OFFSET UNITYSDK_OFFSET(0xC12DCD0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCLICKTABRIGHT_OFFSET UNITYSDK_OFFSET(0xC12DEA0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xC12DD50)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCOSTREFRESHSHOP_OFFSET UNITYSDK_OFFSET(0xC12F060)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC12D180)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONTABDATAUPDATE_OFFSET UNITYSDK_OFFSET(0xC12DF30)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC12D220)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC12C850)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC12CD30)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_REQUESTNEWTIME_OFFSET UNITYSDK_OFFSET(0xC12EFD0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SELECTEDGOODS_OFFSET UNITYSDK_OFFSET(0xC12D670)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SETCURGOODSLIST_OFFSET UNITYSDK_OFFSET(0xC12E320)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SETLOCK_OFFSET UNITYSDK_OFFSET(0xC12D540)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0xC12EAD0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWGOODSLOCKTIPS_OFFSET UNITYSDK_OFFSET(0xC12D9D0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWREFRESH_OFFSET UNITYSDK_OFFSET(0xC12E840)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWTABLOCKTIPS_OFFSET UNITYSDK_OFFSET(0xC12E0B0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWTAB_OFFSET UNITYSDK_OFFSET(0xC12E630)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC12F820)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__INITSCROLLVIEW_B__20_0_OFFSET UNITYSDK_OFFSET(0xC12F970)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__INITVIEW_B__19_0_OFFSET UNITYSDK_OFFSET(0xC12F870)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC12FA00)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC12FA70)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC12FA80)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC12FA90)

namespace MoleMole
{
	inline static constexpr unsigned int UIGroceryChildWindowController_TypeDefinitionIndex = 74605;
