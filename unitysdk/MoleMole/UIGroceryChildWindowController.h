...
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0xD585FD0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_DOBUY_OFFSET UNITYSDK_OFFSET(0xD584850)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_GETITEMGAMEPADLIST_OFFSET UNITYSDK_OFFSET(0xA6116F0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD5838F0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xD5843B0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_INITTABBTNGROUP_OFFSET UNITYSDK_OFFSET(0xD583F50)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xD583A50)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCLICKTABLEFT_OFFSET UNITYSDK_OFFSET(0xD584D80)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCLICKTABRIGHT_OFFSET UNITYSDK_OFFSET(0xD584F50)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xD584E00)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCOSTREFRESHSHOP_OFFSET UNITYSDK_OFFSET(0xD586110)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD584230)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONTABDATAUPDATE_OFFSET UNITYSDK_OFFSET(0xD584FE0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD5842D0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD583900)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD583DE0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_REQUESTNEWTIME_OFFSET UNITYSDK_OFFSET(0xD586080)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SELECTEDGOODS_OFFSET UNITYSDK_OFFSET(0xD584720)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SETCURGOODSLIST_OFFSET UNITYSDK_OFFSET(0xD5853D0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SETLOCK_OFFSET UNITYSDK_OFFSET(0xD5845F0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0xD585B80)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWGOODSLOCKTIPS_OFFSET UNITYSDK_OFFSET(0xD584A80)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWREFRESH_OFFSET UNITYSDK_OFFSET(0xD5858F0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWTABLOCKTIPS_OFFSET UNITYSDK_OFFSET(0xD585160)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER_SHOWTAB_OFFSET UNITYSDK_OFFSET(0xD5856E0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA611760)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__INITSCROLLVIEW_B__20_0_OFFSET UNITYSDK_OFFSET(0xA6118B0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__INITVIEW_B__19_0_OFFSET UNITYSDK_OFFSET(0xA6117B0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA611940)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA6119B0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA6119C0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA6119D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGroceryChildWindowController_TypeDefinitionIndex = 39769;

	class UIGroceryChildWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_8FC1A7735F246865* _shopModel; // 0x2F8
		::Class_1_C8489A0F22314D2F* _shopEntity; // 0x300
		::System::Collections::Generic::List_1<::Class_1_7A0999DD62F5BF03*>* _shopTabList; // 0x308
		::System::Collections::Generic::List_1<::Class_1_F57D00757009D1EB*>* _curGoodsList; // 0x310
		::System::Int32 _curIndex; // 0x318
		::System::Int32 _curGoodsCount; // 0x31C
		::System::Int32 _curSelectGoodsIndex; // 0x320
		::Class_2_A3D4B0969489E4FC* _view; // 0x328
		::Class_2_A3D4B0969489E4FC_Class_2_024E742EE0CA8F62* _refreshView; // 0x330
		::Class_2_A3D4B0969489E4FC_Class_2_CBE3775889953650* _tabBtnView; // 0x338
		::UnityEngine::UI::Extension::UITimeWidget* _timeWidget; // 0x340
		::Foundation::Coroutine::CoroutineHandle _coroutine; // 0x348
		::MoleMole::UIGroceryChildContext* _context; // 0x350
