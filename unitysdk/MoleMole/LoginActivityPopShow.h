...
#define MOLEMOLE_LOGINACTIVITYPOPSHOW_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x75A74D0)
#define MOLEMOLE_LOGINACTIVITYPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x75A74C0)
#define MOLEMOLE_LOGINACTIVITYPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x75A7550)
#define MOLEMOLE_LOGINACTIVITYPOPSHOW_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x75A74E0)
#define MOLEMOLE_LOGINACTIVITYPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x75A8090)
#define MOLEMOLE_LOGINACTIVITYPOPSHOW___BASE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x75A80A0)

namespace MoleMole
{
	inline static constexpr unsigned int LoginActivityPopShow_TypeDefinitionIndex = 52360;
