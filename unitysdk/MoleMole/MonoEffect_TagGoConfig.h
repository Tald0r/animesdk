...
#define MOLEMOLE_MONOEFFECT_TAGGOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB99ADC0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffect_TagGoConfig_TypeDefinitionIndex = 38977;
