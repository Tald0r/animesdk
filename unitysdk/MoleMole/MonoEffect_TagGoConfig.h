...
#define MOLEMOLE_MONOEFFECT_TAGGOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD80D360)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffect_TagGoConfig_TypeDefinitionIndex = 54947;
