...
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC3D130)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAC3DBC0)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC3D2B0)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC3D1D0)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC3CD60)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC3D030)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_REFRESHREDPOINTBYDATA_OFFSET UNITYSDK_OFFSET(0xAC3DE80)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_REFRESHREDPOINT_OFFSET UNITYSDK_OFFSET(0xAC3DEF0)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER_SETBRANCHICON_OFFSET UNITYSDK_OFFSET(0xAC3D9C0)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC3E0D0)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC3E0E0)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAC3E150)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC3E1C0)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC3E240)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC3E2C0)
#define MOLEMOLE_UIBRANCHRELICWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC3E320)

namespace MoleMole
{
	inline static constexpr unsigned int UIBranchRelicWidgetController_TypeDefinitionIndex = 66863;
