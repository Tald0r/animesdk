...
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3B1EE0)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3B1F80)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3B1D10)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD3B1E30)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER_SETBOUNTYSNAPSHOTDATA_OFFSET UNITYSDK_OFFSET(0xD3B2060)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD3B2470)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3B24A0)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3B2510)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3B2590)
#define MOLEMOLE_UIACTIVITYCAMERABOUNTYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD3B25F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCameraBountyWidgetController_TypeDefinitionIndex = 60938;
