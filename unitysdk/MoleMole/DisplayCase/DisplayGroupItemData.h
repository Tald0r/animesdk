...
#define MOLEMOLE_DISPLAYCASE_DISPLAYGROUPITEMDATA_METHOD_1_A6E9594884C4CCF7_OFFSET UNITYSDK_OFFSET(0xD0C0A10)
#define MOLEMOLE_DISPLAYCASE_DISPLAYGROUPITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD0C0690)

namespace MoleMole::DisplayCase
{
	inline static constexpr unsigned int DisplayGroupItemData_TypeDefinitionIndex = 73053;
