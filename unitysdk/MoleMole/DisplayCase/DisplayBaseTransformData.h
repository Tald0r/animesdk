...
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x4D7340)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x4D7350)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xE38CD00)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xE38CEB0)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x4D7360)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x4D73D0)

namespace MoleMole::DisplayCase
{
	inline static constexpr unsigned int DisplayBaseTransformData_TypeDefinitionIndex = 59955;
