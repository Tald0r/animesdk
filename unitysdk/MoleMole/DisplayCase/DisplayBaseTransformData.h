...
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x3FADA0)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3FADB0)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xCD33E20)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xCD33FD0)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3FADC0)
#define MOLEMOLE_DISPLAYCASE_DISPLAYBASETRANSFORMDATA___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3FAE30)

namespace MoleMole::DisplayCase
{
	inline static constexpr unsigned int DisplayBaseTransformData_TypeDefinitionIndex = 74821;
