...
#define MOLEMOLE_DISPLAYCASE_DISPLAYITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD342F0)

namespace MoleMole::DisplayCase
{
	inline static constexpr unsigned int DisplayItemData_TypeDefinitionIndex = 68442;
	...
	public:
		...
		::Class_2_208CC9941471731A_692* Cfg; // 0x38
