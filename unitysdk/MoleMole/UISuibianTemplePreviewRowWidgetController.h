...
#define MOLEMOLE_UISUIBIANTEMPLEPREVIEWROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x936A8A0)
#define MOLEMOLE_UISUIBIANTEMPLEPREVIEWROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x936A940)
#define MOLEMOLE_UISUIBIANTEMPLEPREVIEWROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x936A750)
#define MOLEMOLE_UISUIBIANTEMPLEPREVIEWROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x936A7F0)
#define MOLEMOLE_UISUIBIANTEMPLEPREVIEWROWWIDGETCONTROLLER_REFRESHTAG_OFFSET UNITYSDK_OFFSET(0x936ABC0)
#define MOLEMOLE_UISUIBIANTEMPLEPREVIEWROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x936AA20)
#define MOLEMOLE_UISUIBIANTEMPLEPREVIEWROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x936AB10)
#define MOLEMOLE_UISUIBIANTEMPLEPREVIEWROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x936AD60)
#define MOLEMOLE_UISUIBIANTEMPLEPREVIEWROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x936AD90)
#define MOLEMOLE_UISUIBIANTEMPLEPREVIEWROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x936AE00)
#define MOLEMOLE_UISUIBIANTEMPLEPREVIEWROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x936AE80)
#define MOLEMOLE_UISUIBIANTEMPLEPREVIEWROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x936AEE0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTemplePreviewRowWidgetController_TypeDefinitionIndex = 59227;
