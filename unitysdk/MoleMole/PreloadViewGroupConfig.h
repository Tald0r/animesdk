...
#define MOLEMOLE_PRELOADVIEWGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xBD4BC40)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadViewGroupConfig_TypeDefinitionIndex = 40224;
