...
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8C25DD0)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_ONALLRECEIVEBTNCLICK_OFFSET UNITYSDK_OFFSET(0x8C26650)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C25DE0)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_ONGOLDMININGDAYSTATEREWARDGET_OFFSET UNITYSDK_OFFSET(0x8C26900)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8C26250)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C265C0)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C25E80)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER_UPDATEBTN_OFFSET UNITYSDK_OFFSET(0x8C26470)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C26A80)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C26A90)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8C26B00)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C26B10)
#define MOLEMOLE_UIGOLDMININGDAYREWARDPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C26B20)

namespace MoleMole
{
	inline static constexpr unsigned int UIGoldMiningDayRewardPageController_TypeDefinitionIndex = 76100;
