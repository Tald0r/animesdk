...
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT_GETCURRENTASPECTRATIO_OFFSET UNITYSDK_OFFSET(0xF0BFA80)
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xF0BF210)
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT_GET_CAMERACOLLISIONCONFIGDATA_OFFSET UNITYSDK_OFFSET(0xF0BF8D0)
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT_GET_INSTIGATORID_OFFSET UNITYSDK_OFFSET(0xF0BFA10)
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT_GET_LASTCAMERADATA_OFFSET UNITYSDK_OFFSET(0xF0BF340)
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT_GET_NEARCLIPPLANE_OFFSET UNITYSDK_OFFSET(0xF0BF790)
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xF0BFBE0)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int NapCameraSequenceContext_TypeDefinitionIndex = 52181;
