...
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_BUILDCONTEXT_OFFSET UNITYSDK_OFFSET(0x883F640)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_ELEVATIONRATIO_OFFSET UNITYSDK_OFFSET(0x883F4A0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x883F410)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_HEIGHTRATIO_OFFSET UNITYSDK_OFFSET(0x883F3F0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_MAINTAINROTATIONCHANNEL_OFFSET UNITYSDK_OFFSET(0x883F450)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_OVERRIDEEULER_OFFSET UNITYSDK_OFFSET(0x883F470)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_POLARANGLE_OFFSET UNITYSDK_OFFSET(0x883F570)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x883F430)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDINSETTING_OFFSET UNITYSDK_OFFSET(0x883F6E0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDOUTSETTING_OFFSET UNITYSDK_OFFSET(0x883F7F0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETDURATION_OFFSET UNITYSDK_OFFSET(0x883F900)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x883F420)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_HEIGHTRATIO_OFFSET UNITYSDK_OFFSET(0x883F400)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_MAINTAINROTATIONCHANNEL_OFFSET UNITYSDK_OFFSET(0x883F460)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_OVERRIDEEULER_OFFSET UNITYSDK_OFFSET(0x883F490)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x883F440)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x883F970)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int CloseUpDataTableEntry_TypeDefinitionIndex = 48977;
