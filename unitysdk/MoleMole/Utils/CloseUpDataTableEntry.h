...
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_BUILDCONTEXT_OFFSET UNITYSDK_OFFSET(0x6AFDE80)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_ELEVATIONRATIO_OFFSET UNITYSDK_OFFSET(0x6AFDCE0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x6AFDC50)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_HEIGHTRATIO_OFFSET UNITYSDK_OFFSET(0x6AFDC30)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_MAINTAINROTATIONCHANNEL_OFFSET UNITYSDK_OFFSET(0x6AFDC90)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_OVERRIDEEULER_OFFSET UNITYSDK_OFFSET(0x6AFDCB0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_POLARANGLE_OFFSET UNITYSDK_OFFSET(0x6AFDDB0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_GET_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x6AFDC70)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDINSETTING_OFFSET UNITYSDK_OFFSET(0x6AFDF20)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDOUTSETTING_OFFSET UNITYSDK_OFFSET(0x6AFE030)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETDURATION_OFFSET UNITYSDK_OFFSET(0x6AFE140)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x6AFDC60)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_HEIGHTRATIO_OFFSET UNITYSDK_OFFSET(0x6AFDC40)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_MAINTAINROTATIONCHANNEL_OFFSET UNITYSDK_OFFSET(0x6AFDCA0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_OVERRIDEEULER_OFFSET UNITYSDK_OFFSET(0x6AFDCD0)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY_SET_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x6AFDC80)
#define MOLEMOLE_UTILS_CLOSEUPDATATABLEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x6AFE1B0)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int CloseUpDataTableEntry_TypeDefinitionIndex = 44859;
