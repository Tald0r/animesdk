...
#define MOLEMOLE_UTILS_AUTORESETINTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_GETNEXTTASK_OFFSET UNITYSDK_OFFSET(0x95C4400)
#define MOLEMOLE_UTILS_AUTORESETINTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_GETTASK_OFFSET UNITYSDK_OFFSET(0x95C42F0)
#define MOLEMOLE_UTILS_AUTORESETINTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_TRYSETCANCELED_OFFSET UNITYSDK_OFFSET(0x95C41F0)
#define MOLEMOLE_UTILS_AUTORESETINTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_TRYSETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x95C4270)
#define MOLEMOLE_UTILS_AUTORESETINTERNALUNITASKCOMPLETIONSOURCE_MOLEMOLE_UTILS_ITYPEERASEDCOMPLETIONSOURCE_TRYSETRESULT_OFFSET UNITYSDK_OFFSET(0x95C4500)
#define MOLEMOLE_UTILS_AUTORESETINTERNALUNITASKCOMPLETIONSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x95C4570)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int AutoResetInternalUniTaskCompletionSource_TypeDefinitionIndex = 79070;
