...
#define MOLEMOLE_UTILS_VALUEORCURVEFLOAT_SAMPLECURVE_OFFSET UNITYSDK_OFFSET(0xA095280)
#define MOLEMOLE_UTILS_VALUEORCURVEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0xA095320)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int ValueOrCurveFloat_TypeDefinitionIndex = 53262;
