...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x9932A90)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x9932B20)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_FETCH_ELEVATION_OFFSET UNITYSDK_OFFSET(0x9932E60)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_FETCH_MAXELEVATION_OFFSET UNITYSDK_OFFSET(0x9932D80)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_FETCH_MINELEVATION_OFFSET UNITYSDK_OFFSET(0x9932CA0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x99320C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x9932100)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_RECEIVENOTIFY_OFFSET UNITYSDK_OFFSET(0x9932110)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x9932F60)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION__CTOR_OFFSET UNITYSDK_OFFSET(0x9932F40)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEvent_ModifyElevation_TypeDefinitionIndex = 46230;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceEvent_ModifyElevation_TypeDefinitionIndex)->GetStaticField(0x11110);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_elevation()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceEvent_ModifyElevation_TypeDefinitionIndex)->GetStaticField(0x11118);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_maxElevation()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceEvent_ModifyElevation_TypeDefinitionIndex)->GetStaticField(0x11120);
		}
