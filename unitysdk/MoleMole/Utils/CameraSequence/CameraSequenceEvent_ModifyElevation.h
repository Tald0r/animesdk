...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x7557C90)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x7557D20)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_FETCH_ELEVATION_OFFSET UNITYSDK_OFFSET(0x7558060)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_FETCH_MAXELEVATION_OFFSET UNITYSDK_OFFSET(0x7557F80)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_FETCH_MINELEVATION_OFFSET UNITYSDK_OFFSET(0x7557EA0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x75572C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x7557300)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION_RECEIVENOTIFY_OFFSET UNITYSDK_OFFSET(0x7557310)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x7558160)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_MODIFYELEVATION__CTOR_OFFSET UNITYSDK_OFFSET(0x7558140)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEvent_ModifyElevation_TypeDefinitionIndex = 63968;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceEvent_ModifyElevation_TypeDefinitionIndex)->GetStaticField(0x11440);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_elevation()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceEvent_ModifyElevation_TypeDefinitionIndex)->GetStaticField(0x11448);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_maxElevation()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceEvent_ModifyElevation_TypeDefinitionIndex)->GetStaticField(0x11450);
		}
