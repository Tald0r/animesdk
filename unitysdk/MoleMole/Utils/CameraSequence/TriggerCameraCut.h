...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_TRIGGERCAMERACUT_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x644DBD0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_TRIGGERCAMERACUT_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x644DD20)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_TRIGGERCAMERACUT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x644DB90)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_TRIGGERCAMERACUT_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x644DD10)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_TRIGGERCAMERACUT_RECEIVENOTIFY_OFFSET UNITYSDK_OFFSET(0x644DDB0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_TRIGGERCAMERACUT__CCTOR_OFFSET UNITYSDK_OFFSET(0x644DC30)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_TRIGGERCAMERACUT__CTOR_OFFSET UNITYSDK_OFFSET(0x644DE20)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int TriggerCameraCut_TypeDefinitionIndex = 45917;
