...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0xA6E46B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0xA6E4750)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xA6E4670)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xA6E4740)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xA6E48D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0xA6E4C10)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0xA6E4B90)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR__CCTOR_OFFSET UNITYSDK_OFFSET(0xA6E4F60)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA6E4F30)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_DisableMotionBlur_TypeDefinitionIndex = 72686;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DisableMotionBlur_TypeDefinitionIndex)->GetStaticField(0x11460);
		}
