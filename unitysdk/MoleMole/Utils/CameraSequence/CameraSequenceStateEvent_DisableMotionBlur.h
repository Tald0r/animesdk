...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x7C6EAD0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x7C6EB70)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x7C6EA90)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x7C6EB60)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x7C6ECF0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x7C6F030)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x7C6EFB0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR__CCTOR_OFFSET UNITYSDK_OFFSET(0x7C6F380)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DISABLEMOTIONBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x7C6F350)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_DisableMotionBlur_TypeDefinitionIndex = 48175;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DisableMotionBlur_TypeDefinitionIndex)->GetStaticField(0x10D00);
		}
