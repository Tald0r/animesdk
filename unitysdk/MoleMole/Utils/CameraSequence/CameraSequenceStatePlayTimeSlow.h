...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x9A31630)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x9A316C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_FETCH_TIMESLOWKEY_OFFSET UNITYSDK_OFFSET(0x9A31840)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x9A315E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x9A31620)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x9A312C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x9A31490)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x9A31410)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW__CCTOR_OFFSET UNITYSDK_OFFSET(0x9A31950)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x9A31920)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStatePlayTimeSlow_TypeDefinitionIndex = 47315;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStatePlayTimeSlow_TypeDefinitionIndex)->GetStaticField(0xDA10);
		}
