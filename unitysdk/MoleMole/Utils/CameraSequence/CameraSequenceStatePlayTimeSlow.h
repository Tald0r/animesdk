...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0xACFEE00)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0xACFEE90)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_FETCH_TIMESLOWKEY_OFFSET UNITYSDK_OFFSET(0xACFF010)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xACFEDB0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xACFEDF0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xACFEA90)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0xACFEC60)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0xACFEBE0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW__CCTOR_OFFSET UNITYSDK_OFFSET(0xACFF120)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOW__CTOR_OFFSET UNITYSDK_OFFSET(0xACFF0F0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStatePlayTimeSlow_TypeDefinitionIndex = 73319;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStatePlayTimeSlow_TypeDefinitionIndex)->GetStaticField(0xCEF0);
		}
