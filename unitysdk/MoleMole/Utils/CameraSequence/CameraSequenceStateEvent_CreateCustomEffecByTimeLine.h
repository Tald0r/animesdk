...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x73F1BC0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x73F1C60)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_CREATECUSTOMEFFECT_OFFSET UNITYSDK_OFFSET(0x73F17D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x73F1790)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x73F1C50)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x73F1DE0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x73F2120)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x73F1E70)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x73F2190)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_CreateCustomEffecByTimeLine_TypeDefinitionIndex = 39056;
