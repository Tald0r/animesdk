...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x7BE84D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x7BE8570)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_CREATECUSTOMEFFECT_OFFSET UNITYSDK_OFFSET(0x7BE80F0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x7BE80B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x7BE8560)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x7BE86F0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x7BE8A30)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x7BE8780)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_CREATECUSTOMEFFECBYTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x7BE8AA0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_CreateCustomEffecByTimeLine_TypeDefinitionIndex = 72164;
