...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x65C7990)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING_FETCH_LOCATIONINCAMERASEQUENCE_OFFSET UNITYSDK_OFFSET(0x65C7B50)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING_GETDATA_OFFSET UNITYSDK_OFFSET(0x65C7710)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x65C78C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING_SETPATH_OFFSET UNITYSDK_OFFSET(0x65C78D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING__CCTOR_OFFSET UNITYSDK_OFFSET(0x65C7CA0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x65C7C80)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x65C7D00)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_MOVETARGETBYSETTING___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x65C7DC0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int MoveTargetBySetting_TypeDefinitionIndex = 46356;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(MoveTargetBySetting_TypeDefinitionIndex)->GetStaticField(0x108B0);
		}
