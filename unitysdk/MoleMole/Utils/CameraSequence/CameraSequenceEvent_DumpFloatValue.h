...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x7C6E730)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x7C6E7C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE_FETCH_RESULT_OFFSET UNITYSDK_OFFSET(0x7C6E940)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x7C6E520)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x7C6E5D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE_RECEIVENOTIFY_OFFSET UNITYSDK_OFFSET(0x7C6E5E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE__CCTOR_OFFSET UNITYSDK_OFFSET(0x7C6EA30)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_DUMPFLOATVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x7C6EA10)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEvent_DumpFloatValue_TypeDefinitionIndex = 63809;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceEvent_DumpFloatValue_TypeDefinitionIndex)->GetStaticField(0x10CF0);
		}
