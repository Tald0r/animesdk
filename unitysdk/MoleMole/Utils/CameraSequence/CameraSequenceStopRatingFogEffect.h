...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPRATINGFOGEFFECT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xA094E00)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPRATINGFOGEFFECT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xA094E40)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPRATINGFOGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA094F70)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPRATINGFOGEFFECT___BASE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xA094FA0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStopRatingFogEffect_TypeDefinitionIndex = 48885;
