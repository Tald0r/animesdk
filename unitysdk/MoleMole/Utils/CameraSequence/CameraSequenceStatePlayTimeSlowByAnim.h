...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0xACFF780)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0xACFF7F0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_GETNOTIFYNAME_OFFSET UNITYSDK_OFFSET(0xACFF6B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_GETTIMESLOWKEY_OFFSET UNITYSDK_OFFSET(0xACFF160)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xACFF740)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xACFF7E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xACFF1F0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0xACFF420)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0xACFF3A0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM__CCTOR_OFFSET UNITYSDK_OFFSET(0xACFF8B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEPLAYTIMESLOWBYANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xACFF880)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStatePlayTimeSlowByAnim_TypeDefinitionIndex = 57024;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStatePlayTimeSlowByAnim_TypeDefinitionIndex)->GetStaticField(0xCF00);
		}
