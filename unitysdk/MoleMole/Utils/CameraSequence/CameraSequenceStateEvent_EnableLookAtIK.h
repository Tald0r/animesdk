...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x73F3600)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x73F3690)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_FETCH_ENABLELOOKAT_OFFSET UNITYSDK_OFFSET(0x73F3810)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_FETCH_ENTITYID_OFFSET UNITYSDK_OFFSET(0x73F38E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_FETCH_ENTITYWORLD_OFFSET UNITYSDK_OFFSET(0x73F3A80)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_FETCH_LOOKATENTITYID_OFFSET UNITYSDK_OFFSET(0x73F39B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x73F2C10)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x73F2C50)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x73F2C60)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x73F3210)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x73F3190)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK__CCTOR_OFFSET UNITYSDK_OFFSET(0x73F3B80)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK__CTOR_OFFSET UNITYSDK_OFFSET(0x73F3B50)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex = 68091;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex)->GetStaticField(0xDB70);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_enableLookAt()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex)->GetStaticField(0xDB78);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_EntityWorld()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex)->GetStaticField(0xDB80);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_entityID()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex)->GetStaticField(0xDB88);
		}
