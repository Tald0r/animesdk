...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x7BE9F10)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x7BE9FA0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_FETCH_ENABLELOOKAT_OFFSET UNITYSDK_OFFSET(0x7BEA120)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_FETCH_ENTITYID_OFFSET UNITYSDK_OFFSET(0x7BEA1F0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_FETCH_ENTITYWORLD_OFFSET UNITYSDK_OFFSET(0x7BEA390)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_FETCH_LOOKATENTITYID_OFFSET UNITYSDK_OFFSET(0x7BEA2C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x7BE9520)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x7BE9560)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x7BE9570)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x7BE9B20)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x7BE9AA0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK__CCTOR_OFFSET UNITYSDK_OFFSET(0x7BEA490)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_ENABLELOOKATIK__CTOR_OFFSET UNITYSDK_OFFSET(0x7BEA460)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex = 50103;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex)->GetStaticField(0xE200);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_enableLookAt()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex)->GetStaticField(0xE208);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_entityID()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex)->GetStaticField(0xE210);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_lookAtEntityID()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_EnableLookAtIK_TypeDefinitionIndex)->GetStaticField(0xE218);
		}
