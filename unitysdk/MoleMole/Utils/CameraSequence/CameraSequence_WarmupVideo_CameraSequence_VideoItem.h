...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO_CAMERASEQUENCE_VIDEOITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x33DE50)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO_CAMERASEQUENCE_VIDEOITEM___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x33DE60)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequence_WarmupVideo_CameraSequence_VideoItem_TypeDefinitionIndex = 56146;
