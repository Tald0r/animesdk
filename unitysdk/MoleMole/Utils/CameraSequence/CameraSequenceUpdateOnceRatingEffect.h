...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEUPDATEONCERATINGEFFECT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x883DA40)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEUPDATEONCERATINGEFFECT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x883DA80)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEUPDATEONCERATINGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x883DAF0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEUPDATEONCERATINGEFFECT___BASE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x883DB20)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceUpdateOnceRatingEffect_TypeDefinitionIndex = 70545;
