...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEUPDATEONCERATINGEFFECT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x6AFC2A0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEUPDATEONCERATINGEFFECT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x6AFC2E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEUPDATEONCERATINGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x6AFC350)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEUPDATEONCERATINGEFFECT___BASE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x6AFC380)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceUpdateOnceRatingEffect_TypeDefinitionIndex = 49471;
