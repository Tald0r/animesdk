...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_PLAYTIMESLOWUTILS_CHARACTERBASEDATAACCESSOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x386250)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_PLAYTIMESLOWUTILS_CHARACTERBASEDATAACCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x301710)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int PlayTimeSlowUtils_CharacterBaseDataAccessor_TypeDefinitionIndex = 79958;
