...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPSCREENEFFECT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xAAC5500)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPSCREENEFFECT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xAAC5540)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPSCREENEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xAAC5940)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTOPSCREENEFFECT___BASE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xAAC5970)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStopScreenEffect_TypeDefinitionIndex = 51320;
