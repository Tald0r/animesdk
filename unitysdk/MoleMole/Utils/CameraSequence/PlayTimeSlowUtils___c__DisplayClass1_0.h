...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_PLAYTIMESLOWUTILS___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x889F9B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_PLAYTIMESLOWUTILS___C__DISPLAYCLASS1_0__PROCESSMAXSTARTTIME_B__0_OFFSET UNITYSDK_OFFSET(0x889F9C0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int PlayTimeSlowUtils___c__DisplayClass1_0_TypeDefinitionIndex = 79959;
	...
	public:
		...
		::System::Single maxStartTime; // 0x20
