...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x7920500)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x7920590)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_FETCH_PLAYERID_OFFSET UNITYSDK_OFFSET(0x7920710)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_FETCH_TARGETID_OFFSET UNITYSDK_OFFSET(0x79207E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x791F200)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x791F240)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x791F250)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x7920490)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x7920410)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT__CCTOR_OFFSET UNITYSDK_OFFSET(0x79208E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEMONSTERRATINGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x79208B0)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceMonsterRatingEffect_TypeDefinitionIndex = 76142;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceMonsterRatingEffect_TypeDefinitionIndex)->GetStaticField(0xF000);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_PlayerID()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceMonsterRatingEffect_TypeDefinitionIndex)->GetStaticField(0xF008);
		}
