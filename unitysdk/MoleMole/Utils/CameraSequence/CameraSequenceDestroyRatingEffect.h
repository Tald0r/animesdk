...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEDESTROYRATINGEFFECT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xEE6EDF0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEDESTROYRATINGEFFECT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xEE6F120)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEDESTROYRATINGEFFECT_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0xEE6EE30)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEDESTROYRATINGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xEE6F190)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEDESTROYRATINGEFFECT___BASE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xEE6F1C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEDESTROYRATINGEFFECT___BASE_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0xEE6F230)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceDestroyRatingEffect_TypeDefinitionIndex = 61624;
