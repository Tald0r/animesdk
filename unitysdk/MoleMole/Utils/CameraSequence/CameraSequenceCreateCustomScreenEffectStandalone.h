...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCECREATECUSTOMSCREENEFFECTSTANDALONE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x7BE7E30)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCECREATECUSTOMSCREENEFFECTSTANDALONE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x7BE7E70)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCECREATECUSTOMSCREENEFFECTSTANDALONE__CTOR_OFFSET UNITYSDK_OFFSET(0x7BE8010)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCECREATECUSTOMSCREENEFFECTSTANDALONE___BASE_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x7BE8040)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceCreateCustomScreenEffectStandalone_TypeDefinitionIndex = 65825;
