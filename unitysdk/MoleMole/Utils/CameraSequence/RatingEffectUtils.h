...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_APPLYRATINGFOGEFFECTS_OFFSET UNITYSDK_OFFSET(0x644C0E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_APPLYRATINGFOGEFFECT_OFFSET UNITYSDK_OFFSET(0x644C460)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_APPLYRATINGSCREENEFFECTS_OFFSET UNITYSDK_OFFSET(0x644B550)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_APPLYRATINGSCREENEFFECT_OFFSET UNITYSDK_OFFSET(0x644B8E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_GETCAMERAEFFECTENTITY_OFFSET UNITYSDK_OFFSET(0x644D360)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_GETRATINGFOGEFFECTS_OFFSET UNITYSDK_OFFSET(0x644C5F0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_GETRATINGSCREENEFFECTS_OFFSET UNITYSDK_OFFSET(0x644B310)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_GETRATINGTEXTEFFECTMETA_OFFSET UNITYSDK_OFFSET(0x644CA50)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_GETRATINGTEXTEFFECTNAME_OFFSET UNITYSDK_OFFSET(0x644C830)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_GETRATINGTYPE_OFFSET UNITYSDK_OFFSET(0x6448930)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_INTERRUPTFOGEFFECTS_OFFSET UNITYSDK_OFFSET(0x644BCA0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_LOGERR_OFFSET UNITYSDK_OFFSET(0x644DAD0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_LOGWARN_OFFSET UNITYSDK_OFFSET(0x644DB30)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_LOG_OFFSET UNITYSDK_OFFSET(0x644DA70)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_TRYCREATERATINGEFFECT_OFFSET UNITYSDK_OFFSET(0x644D5A0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_RATINGEFFECTUTILS_UPDATEEFFECTONCE_OFFSET UNITYSDK_OFFSET(0x644D460)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int RatingEffectUtils_TypeDefinitionIndex = 52249;
