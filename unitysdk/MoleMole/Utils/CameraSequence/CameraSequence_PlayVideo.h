...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x73F3CA0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x73F3D80)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x73F3C60)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x73F3D70)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x73F3F00)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x73F4950)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x73F48D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__AUTOCHECK_OFFSET UNITYSDK_OFFSET(0x73F3D00)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0x73F49C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__ONFINISHED_OFFSET UNITYSDK_OFFSET(0x73F4780)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__RECEIVENOTIFYBEGIN_G___UPDATESETALPHA_13_0_OFFSET UNITYSDK_OFFSET(0x73F4730)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequence_PlayVideo_TypeDefinitionIndex = 61816;
