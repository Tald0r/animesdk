...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x7BEA5B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x7BEA690)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x7BEA570)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x7BEA680)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x7BEA810)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x7BEB260)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x7BEB1E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__AUTOCHECK_OFFSET UNITYSDK_OFFSET(0x7BEA610)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0x7BEB2D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__ONFINISHED_OFFSET UNITYSDK_OFFSET(0x7BEB090)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_PLAYVIDEO__RECEIVENOTIFYBEGIN_G___UPDATESETALPHA_13_0_OFFSET UNITYSDK_OFFSET(0x7BEB040)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequence_PlayVideo_TypeDefinitionIndex = 81184;
