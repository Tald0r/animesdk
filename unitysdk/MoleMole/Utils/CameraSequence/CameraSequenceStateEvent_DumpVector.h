...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x65C71E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x65C7270)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_FETCH_DUMPRESULT_OFFSET UNITYSDK_OFFSET(0x65C74A0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_FETCH_SHAKEOFFSET_OFFSET UNITYSDK_OFFSET(0x65C73F0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_FETCH_STARTOFFSET_OFFSET UNITYSDK_OFFSET(0x65C7570)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_GET_CURDUMPKEY_OFFSET UNITYSDK_OFFSET(0x65C6C90)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x65C6C40)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x65C6C80)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x65C6D20)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x65C7040)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x65C6FC0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x65C7680)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x65C7640)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_DumpVector_TypeDefinitionIndex = 43222;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DumpVector_TypeDefinitionIndex)->GetStaticField(0x10890);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_DumpResult()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DumpVector_TypeDefinitionIndex)->GetStaticField(0x10898);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_ShakeOffset()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DumpVector_TypeDefinitionIndex)->GetStaticField(0x108A0);
		}
