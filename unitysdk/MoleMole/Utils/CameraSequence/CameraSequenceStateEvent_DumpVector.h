...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x9F14E20)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x9F14EB0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_FETCH_DUMPRESULT_OFFSET UNITYSDK_OFFSET(0x9F150E0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_FETCH_SHAKEOFFSET_OFFSET UNITYSDK_OFFSET(0x9F15030)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_FETCH_STARTOFFSET_OFFSET UNITYSDK_OFFSET(0x9F151B0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_GET_CURDUMPKEY_OFFSET UNITYSDK_OFFSET(0x9F148D0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x9F14880)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x9F148C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x9F14960)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x9F14C80)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x9F14C00)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x9F152C0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_DUMPVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9F15280)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_DumpVector_TypeDefinitionIndex = 41282;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DumpVector_TypeDefinitionIndex)->GetStaticField(0x10850);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_DumpResult()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DumpVector_TypeDefinitionIndex)->GetStaticField(0x10858);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_StartOffset()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DumpVector_TypeDefinitionIndex)->GetStaticField(0x10860);
		}
