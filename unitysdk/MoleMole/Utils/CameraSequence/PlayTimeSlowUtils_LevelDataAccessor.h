...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_PLAYTIMESLOWUTILS_LEVELDATAACCESSOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x34D050)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_PLAYTIMESLOWUTILS_LEVELDATAACCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x2C3980)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int PlayTimeSlowUtils_LevelDataAccessor_TypeDefinitionIndex = 43569;
