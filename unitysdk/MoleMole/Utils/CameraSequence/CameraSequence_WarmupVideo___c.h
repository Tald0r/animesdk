...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x6449EC0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO___C__CTOR_OFFSET UNITYSDK_OFFSET(0x6449F00)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO___C___WARMUPVIDEO_B__10_0_OFFSET UNITYSDK_OFFSET(0x6449F10)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCE_WARMUPVIDEO___C___WARMUPVIDEO_B__10_1_OFFSET UNITYSDK_OFFSET(0x6449F20)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequence_WarmupVideo___c_TypeDefinitionIndex = 37964;
	...
	public:
		...
		{
			return (::System::Action_1<::MoleMole::MultipleVideoPlayerManager*>**)Il2CppClass::FromTypeDefinitionIndex(CameraSequence_WarmupVideo___c_TypeDefinitionIndex)->GetStaticField(0x3ACC0);
		}
		static ::MoleMole::Utils::CameraSequence::CameraSequence_WarmupVideo___c** StaticGet___9()
		{
			return (::MoleMole::Utils::CameraSequence::CameraSequence_WarmupVideo___c**)Il2CppClass::FromTypeDefinitionIndex(CameraSequence_WarmupVideo___c_TypeDefinitionIndex)->GetStaticField(0x3ACC8);
		}
		static ::System::Action_1<::MoleMole::MultipleVideoPlayerManager*>** StaticGet___9__10_1()
		{
			return (::System::Action_1<::MoleMole::MultipleVideoPlayerManager*>**)Il2CppClass::FromTypeDefinitionIndex(CameraSequence_WarmupVideo___c_TypeDefinitionIndex)->GetStaticField(0x3ACD0);
		}
