...
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x9727C50)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x9727CF0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x9727C10)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x9727CE0)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE_RECEIVENOTIFY_OFFSET UNITYSDK_OFFSET(0x9727E70)
#define MOLEMOLE_UTILS_CAMERASEQUENCE_CAMERASEQUENCEEVENT_STOPPLAYERMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9728050)

namespace MoleMole::Utils::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEvent_StopPlayerMove_TypeDefinitionIndex = 63501;
