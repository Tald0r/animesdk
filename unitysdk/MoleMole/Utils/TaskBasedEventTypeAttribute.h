...
#define MOLEMOLE_UTILS_TASKBASEDEVENTTYPEATTRIBUTE_GETCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x644DE40)
#define MOLEMOLE_UTILS_TASKBASEDEVENTTYPEATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x644E040)
#define MOLEMOLE_UTILS_TASKBASEDEVENTTYPEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x644DFA0)
#define MOLEMOLE_UTILS_TASKBASEDEVENTTYPEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x644DEE0)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int TaskBasedEventTypeAttribute_TypeDefinitionIndex = 42131;
	...
	public:
		...
		{
			return (::MoleMole::Utils::TaskBasedEventTypeAttribute**)Il2CppClass::FromTypeDefinitionIndex(TaskBasedEventTypeAttribute_TypeDefinitionIndex)->GetStaticField(0x3ACE0);
		}
