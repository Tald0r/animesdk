...
#define MOLEMOLE_UTILS_TASKBASEDEVENTTYPEATTRIBUTE_GETCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x79256F0)
#define MOLEMOLE_UTILS_TASKBASEDEVENTTYPEATTRIBUTE__CCTOR_OFFSET UNITYSDK_OFFSET(0x79258F0)
#define MOLEMOLE_UTILS_TASKBASEDEVENTTYPEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x7925850)
#define MOLEMOLE_UTILS_TASKBASEDEVENTTYPEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x7925790)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int TaskBasedEventTypeAttribute_TypeDefinitionIndex = 40008;
	...
	public:
		...
		{
			return (::MoleMole::Utils::TaskBasedEventTypeAttribute**)Il2CppClass::FromTypeDefinitionIndex(TaskBasedEventTypeAttribute_TypeDefinitionIndex)->GetStaticField(0x3DA30);
		}
