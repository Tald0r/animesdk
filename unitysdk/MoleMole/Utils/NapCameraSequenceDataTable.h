...
#define MOLEMOLE_UTILS_NAPCAMERASEQUENCEDATATABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x939E6E0)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int NapCameraSequenceDataTable_TypeDefinitionIndex = 55623;
