...
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_GET_FORWARDOFFSET_OFFSET UNITYSDK_OFFSET(0x9A32120)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_GET_UPOFFSET_OFFSET UNITYSDK_OFFSET(0x9A321B0)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_BUILDCONTEXT_OFFSET UNITYSDK_OFFSET(0x9A32240)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDINSETTING_OFFSET UNITYSDK_OFFSET(0x9A322E0)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETBLENDOUTSETTING_OFFSET UNITYSDK_OFFSET(0x9A323F0)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_MOLEMOLE_UTILS_INAPCAMERASEQUENCEDATATABLEENTRY_GETDURATION_OFFSET UNITYSDK_OFFSET(0x9A32500)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_SET_FORWARDOFFSET_OFFSET UNITYSDK_OFFSET(0x9A32130)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY_SET_UPOFFSET_OFFSET UNITYSDK_OFFSET(0x9A321C0)
#define MOLEMOLE_UTILS_STRETCHDATATABLEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x9A32570)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int StretchDataTableEntry_TypeDefinitionIndex = 75674;
