...
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE_GETOBJECTPATH_OFFSET UNITYSDK_OFFSET(0xAAC5A50)
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE_LOADASYNC_OFFSET UNITYSDK_OFFSET(0xAAC5B70)
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE_LOADSYNC_OFFSET UNITYSDK_OFFSET(0xAAC5AB0)
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE_SETOBJECTPATH_OFFSET UNITYSDK_OFFSET(0xAAC59E0)
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xAAC5C80)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int SoftScriptObjectReference_TypeDefinitionIndex = 46348;
