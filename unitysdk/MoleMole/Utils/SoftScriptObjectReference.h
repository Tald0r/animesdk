...
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE_GETOBJECTPATH_OFFSET UNITYSDK_OFFSET(0x95C52C0)
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE_LOADASYNC_OFFSET UNITYSDK_OFFSET(0x95C53E0)
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE_LOADSYNC_OFFSET UNITYSDK_OFFSET(0x95C5320)
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE_SETOBJECTPATH_OFFSET UNITYSDK_OFFSET(0x95C5250)
#define MOLEMOLE_UTILS_SOFTSCRIPTOBJECTREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x95C54F0)

namespace MoleMole::Utils
{
	inline static constexpr unsigned int SoftScriptObjectReference_TypeDefinitionIndex = 39676;
