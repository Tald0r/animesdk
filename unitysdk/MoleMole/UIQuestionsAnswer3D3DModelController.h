...
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_CHANGETOGAMEPREFAB_OFFSET UNITYSDK_OFFSET(0xB260F20)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0xB260E50)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_GET_AUTOPROCESSCAMERA_OFFSET UNITYSDK_OFFSET(0xB260E40)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_GET_SCREENWIDGET_OFFSET UNITYSDK_OFFSET(0xB260E20)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_GET_SHOW3DSCENEENTITIES_OFFSET UNITYSDK_OFFSET(0xB260E30)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB260E10)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB2622A0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB262340)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB261860)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB2620C0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_REVERTSCENEPREFAB_OFFSET UNITYSDK_OFFSET(0xB2616A0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_SETCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0xB262470)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB262130)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xB262610)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB262510)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB262650)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2626C0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB2626D0)
#define MOLEMOLE_UIQUESTIONSANSWER3D3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB2626E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswer3D3DModelController_TypeDefinitionIndex = 42405;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIQuestionsAnswer3D3DModelController_TypeDefinitionIndex)->GetStaticField(0xEEC0);
		}
		static ::System::Int32* StaticGet_RTHeight()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIQuestionsAnswer3D3DModelController_TypeDefinitionIndex)->GetStaticField(0xEEC4);
		}
