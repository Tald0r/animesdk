...
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_BUDDYFADEGROUP___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB245FC0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_BUDDYFADEGROUP___C__DISPLAYCLASS14_0__START_B__0_OFFSET UNITYSDK_OFFSET(0xB245FD0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_BUDDYFADEGROUP___C__DISPLAYCLASS14_0__START_B__1_OFFSET UNITYSDK_OFFSET(0xB2460C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIModificationShop3DModelController_BuddyFadeGroup___c__DisplayClass14_0_TypeDefinitionIndex = 39045;
