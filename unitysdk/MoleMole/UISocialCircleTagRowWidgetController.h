...
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xACB2B40)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xACB2BB0)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xACB2CB0)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xACB2D90)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xACB2F30)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xACB2F40)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xACB2FB0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleTagRowWidgetController_TypeDefinitionIndex = 69075;
