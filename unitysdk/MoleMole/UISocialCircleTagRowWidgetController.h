...
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8690E00)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8690E70)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8690F70)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8691050)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x86911F0)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8691200)
#define MOLEMOLE_UISOCIALCIRCLETAGROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8691270)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleTagRowWidgetController_TypeDefinitionIndex = 64237;
