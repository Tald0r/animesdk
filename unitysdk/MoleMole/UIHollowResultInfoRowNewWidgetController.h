...
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_BINDNOTIFICATION_OFFSET UNITYSDK_OFFSET(0xBB41A20)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_MARKANIMATIONNOTPLAY_OFFSET UNITYSDK_OFFSET(0xBB410F0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB41000)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB412B0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB40F60)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_PLAYANIMATIONFADEIN_OFFSET UNITYSDK_OFFSET(0xBB411D0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_REFRESHVIEW_1_OFFSET UNITYSDK_OFFSET(0xBB41AB0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBB413C0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB42380)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB423B0)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB42420)
#define MOLEMOLE_UIHOLLOWRESULTINFOROWNEWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB424A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultInfoRowNewWidgetController_TypeDefinitionIndex = 64192;
