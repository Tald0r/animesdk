...
#define MOLEMOLE_MONOLOGICMOVEMENT_GET_OWNER_OFFSET UNITYSDK_OFFSET(0xB9A4A60)
#define MOLEMOLE_MONOLOGICMOVEMENT_METHOD_5_AC7CD4175E0A3EF8_OFFSET UNITYSDK_OFFSET(0xB9A4930)
#define MOLEMOLE_MONOLOGICMOVEMENT_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0xB9A4A70)
#define MOLEMOLE_MONOLOGICMOVEMENT_SET_OWNER_OFFSET UNITYSDK_OFFSET(0xB9A48C0)
#define MOLEMOLE_MONOLOGICMOVEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A4B10)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLogicMovement_TypeDefinitionIndex = 68272;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOLOGICMOVEMENT_METHOD_5_AC7CD4175E0A3EF8_OFFSET))(this);
		}
	};
}
