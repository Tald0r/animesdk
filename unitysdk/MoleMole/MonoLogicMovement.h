...
#define MOLEMOLE_MONOLOGICMOVEMENT_GET_OWNER_OFFSET UNITYSDK_OFFSET(0xD814480)
#define MOLEMOLE_MONOLOGICMOVEMENT_METHOD_5_AC7CD4175E0A3EF8_OFFSET UNITYSDK_OFFSET(0xD814350)
#define MOLEMOLE_MONOLOGICMOVEMENT_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0xD814490)
#define MOLEMOLE_MONOLOGICMOVEMENT_SET_OWNER_OFFSET UNITYSDK_OFFSET(0xD8142E0)
#define MOLEMOLE_MONOLOGICMOVEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xD814530)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLogicMovement_TypeDefinitionIndex = 67251;
