...
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_CALCULATEDELAY_OFFSET UNITYSDK_OFFSET(0xC070B40)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_CREATECOMPLETIONTASK_OFFSET UNITYSDK_OFFSET(0xC070C30)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_DESTROYSTARTEFFECTS_OFFSET UNITYSDK_OFFSET(0xC06FE30)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC06B5F0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_GETCENTERPOSITIONS_OFFSET UNITYSDK_OFFSET(0xC070A80)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_HANDLEEFFECT_OFFSET UNITYSDK_OFFSET(0xC06FB40)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYBGEFFECT_OFFSET UNITYSDK_OFFSET(0xC070E80)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDANIMASYNC_OFFSET UNITYSDK_OFFSET(0xC0703E0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDANIM_OFFSET UNITYSDK_OFFSET(0xC071510)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDEFFECT_OFFSET UNITYSDK_OFFSET(0xC070F40)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDMERGEANIM_OFFSET UNITYSDK_OFFSET(0xC071020)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDSHOWANIM_OFFSET UNITYSDK_OFFSET(0xC0704D0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCOMBINEANIMATIONASYNC_OFFSET UNITYSDK_OFFSET(0xC06EA70)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PREPARECARD_OFFSET UNITYSDK_OFFSET(0xC06FFD0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PREPARECOMBINEEFFECT_OFFSET UNITYSDK_OFFSET(0xC06F290)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_SETPARTICLESPEED_OFFSET UNITYSDK_OFFSET(0xC06FD90)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_SHOWCOMBINECARD_OFFSET UNITYSDK_OFFSET(0xC06F1D0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0xC06E9C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionsAbyssS2DialogPopWindowController_CombineAnimationHelper_TypeDefinitionIndex = 55091;
