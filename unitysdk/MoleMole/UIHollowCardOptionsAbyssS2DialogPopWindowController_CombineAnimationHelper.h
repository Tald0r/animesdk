...
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_CALCULATEDELAY_OFFSET UNITYSDK_OFFSET(0x872E020)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_CREATECOMPLETIONTASK_OFFSET UNITYSDK_OFFSET(0x872E110)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_DESTROYSTARTEFFECTS_OFFSET UNITYSDK_OFFSET(0x872D310)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8728AF0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_GETCENTERPOSITIONS_OFFSET UNITYSDK_OFFSET(0x872DF60)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_HANDLEEFFECT_OFFSET UNITYSDK_OFFSET(0x872D020)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYBGEFFECT_OFFSET UNITYSDK_OFFSET(0x872E360)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDANIMASYNC_OFFSET UNITYSDK_OFFSET(0x872D8B0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDANIM_OFFSET UNITYSDK_OFFSET(0x872E9F0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDEFFECT_OFFSET UNITYSDK_OFFSET(0x872E420)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDMERGEANIM_OFFSET UNITYSDK_OFFSET(0x872E500)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCARDSHOWANIM_OFFSET UNITYSDK_OFFSET(0x872D9A0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PLAYCOMBINEANIMATIONASYNC_OFFSET UNITYSDK_OFFSET(0x872BF60)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PREPARECARD_OFFSET UNITYSDK_OFFSET(0x872D4B0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_PREPARECOMBINEEFFECT_OFFSET UNITYSDK_OFFSET(0x872C770)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_SETPARTICLESPEED_OFFSET UNITYSDK_OFFSET(0x872D270)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER_SHOWCOMBINECARD_OFFSET UNITYSDK_OFFSET(0x872C6B0)
#define MOLEMOLE_UIHOLLOWCARDOPTIONSABYSSS2DIALOGPOPWINDOWCONTROLLER_COMBINEANIMATIONHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x872BEB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardOptionsAbyssS2DialogPopWindowController_CombineAnimationHelper_TypeDefinitionIndex = 71660;

	class UIHollowCardOptionsAbyssS2DialogPopWindowController_CombineAnimationHelper : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* startEffects; // 0x10
		::MoleMole::UIHollowCardOptionsAbyssS2DialogPopWindowController* baseController; // 0x18
		::System::Threading::CancellationTokenSource* _cts; // 0x20
		::System::Boolean _disposed; // 0x28
		::System::Boolean InUpdating; // 0x29
