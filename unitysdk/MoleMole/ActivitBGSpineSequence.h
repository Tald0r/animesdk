...
#define MOLEMOLE_ACTIVITBGSPINESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x8481530)

namespace MoleMole
{
	inline static constexpr unsigned int ActivitBGSpineSequence_TypeDefinitionIndex = 72036;
