...
#define MOLEMOLE_LIVEHOUSESCENEANIMATORDATADICENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x6E334B0)

namespace MoleMole
{
	inline static constexpr unsigned int LiveHouseSceneAnimatorDataDicEntry_TypeDefinitionIndex = 79177;
