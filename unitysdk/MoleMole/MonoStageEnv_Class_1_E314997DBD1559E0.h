...
#define MOLEMOLE_MONOSTAGEENV_CLASS_1_E314997DBD1559E0__CTOR_OFFSET UNITYSDK_OFFSET(0xC322640)

namespace MoleMole
{
	inline static constexpr unsigned int MonoStageEnv_Class_1_E314997DBD1559E0_TypeDefinitionIndex = 64662;
