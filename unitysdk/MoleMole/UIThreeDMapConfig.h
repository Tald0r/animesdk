...
#define MOLEMOLE_UITHREEDMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD6DEF10)

namespace MoleMole
{
	inline static constexpr unsigned int UIThreeDMapConfig_TypeDefinitionIndex = 69287;
