...
#define MOLEMOLE_UIRESOURCELOADWIDGETCONTROLLER___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAE3D190)
#define MOLEMOLE_UIRESOURCELOADWIDGETCONTROLLER___C__DISPLAYCLASS39_0__STARTLOADGAMECONFIGASSETSBYLOADER_B__0_OFFSET UNITYSDK_OFFSET(0xAE3D1A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIResourceLoadWidgetController___c__DisplayClass39_0_TypeDefinitionIndex = 66023;
