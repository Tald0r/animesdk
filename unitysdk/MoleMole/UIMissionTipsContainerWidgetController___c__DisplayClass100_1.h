...
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS100_1__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE2120)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS100_1__PLAYINTERKNOTTIP_B__2_OFFSET UNITYSDK_OFFSET(0xCFEB7B0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS100_1__PLAYINTERKNOTTIP_B__3_OFFSET UNITYSDK_OFFSET(0xCFEB840)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsContainerWidgetController___c__DisplayClass100_1_TypeDefinitionIndex = 75694;
