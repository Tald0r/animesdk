...
#define MOLEMOLE_UIWISHLISTPROPERTYITEMWIDGETCONTROLLER_GETPROPERTYICON_OFFSET UNITYSDK_OFFSET(0x938E050)
#define MOLEMOLE_UIWISHLISTPROPERTYITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x938DED0)
#define MOLEMOLE_UIWISHLISTPROPERTYITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x938DF70)
#define MOLEMOLE_UIWISHLISTPROPERTYITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x938DD80)
#define MOLEMOLE_UIWISHLISTPROPERTYITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x938DE20)
#define MOLEMOLE_UIWISHLISTPROPERTYITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x938E170)
#define MOLEMOLE_UIWISHLISTPROPERTYITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x938E520)
#define MOLEMOLE_UIWISHLISTPROPERTYITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x938E550)
#define MOLEMOLE_UIWISHLISTPROPERTYITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x938E5C0)
#define MOLEMOLE_UIWISHLISTPROPERTYITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x938E640)
#define MOLEMOLE_UIWISHLISTPROPERTYITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x938E6A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistPropertyItemWidgetController_TypeDefinitionIndex = 78242;

	class UIWishlistPropertyItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_7BEEB90214042948_9* _view; // 0x2A0
