...
#define MOLEMOLE_UIMINDSCAPEWIDGETCONTROLLER___C__DISPLAYCLASS100_0__CHANGETABSTATE_B__2_OFFSET UNITYSDK_OFFSET(0x92B33C0)
#define MOLEMOLE_UIMINDSCAPEWIDGETCONTROLLER___C__DISPLAYCLASS100_0__CHANGETABSTATE_B__3_OFFSET UNITYSDK_OFFSET(0x92B3940)
#define MOLEMOLE_UIMINDSCAPEWIDGETCONTROLLER___C__DISPLAYCLASS100_0__CHANGETABSTATE_G__DOCHANGE_0_OFFSET UNITYSDK_OFFSET(0x92B3430)
#define MOLEMOLE_UIMINDSCAPEWIDGETCONTROLLER___C__DISPLAYCLASS100_0__CTOR_OFFSET UNITYSDK_OFFSET(0x92B33B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMindscapeWidgetController___c__DisplayClass100_0_TypeDefinitionIndex = 74117;
	...
	public:
		...
		::System::Boolean nowState; // 0x20
		::System::Boolean withAni; // 0x21
		::System::Boolean nextState; // 0x22
		::System::Int32 nextIndex; // 0x24
		::System::Int32 obj; // 0x28
