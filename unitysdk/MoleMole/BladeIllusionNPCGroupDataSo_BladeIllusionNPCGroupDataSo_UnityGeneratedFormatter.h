...
#define MOLEMOLE_BLADEILLUSIONNPCGROUPDATASO_BLADEILLUSIONNPCGROUPDATASO_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x65335F0)
#define MOLEMOLE_BLADEILLUSIONNPCGROUPDATASO_BLADEILLUSIONNPCGROUPDATASO_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x6533600)
#define MOLEMOLE_BLADEILLUSIONNPCGROUPDATASO_BLADEILLUSIONNPCGROUPDATASO_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x65338C0)
#define MOLEMOLE_BLADEILLUSIONNPCGROUPDATASO_BLADEILLUSIONNPCGROUPDATASO_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x6533AD0)
#define MOLEMOLE_BLADEILLUSIONNPCGROUPDATASO_BLADEILLUSIONNPCGROUPDATASO_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x6533A90)

namespace MoleMole
{
	inline static constexpr unsigned int BladeIllusionNPCGroupDataSo_BladeIllusionNPCGroupDataSo_UnityGeneratedFormatter_TypeDefinitionIndex = 66585;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::Il2CppArray<::MoleMole::BladeIllusionNPCInfo>*>**)Il2CppClass::FromTypeDefinitionIndex(BladeIllusionNPCGroupDataSo_BladeIllusionNPCGroupDataSo_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43C40);
		}
