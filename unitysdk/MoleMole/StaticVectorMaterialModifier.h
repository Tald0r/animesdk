...
#define MOLEMOLE_STATICVECTORMATERIALMODIFIER_GET_ISLOCAL_OFFSET UNITYSDK_OFFSET(0x31B120)
#define MOLEMOLE_STATICVECTORMATERIALMODIFIER_GET_OFFSETCONFIGS_OFFSET UNITYSDK_OFFSET(0x2F2E20)
#define MOLEMOLE_STATICVECTORMATERIALMODIFIER_GET_VECTORTYPE_OFFSET UNITYSDK_OFFSET(0x31B130)
#define MOLEMOLE_STATICVECTORMATERIALMODIFIER_METHOD_2_4E82DD85816A10CB_OFFSET UNITYSDK_OFFSET(0x31B1A0)
#define MOLEMOLE_STATICVECTORMATERIALMODIFIER_METHOD_2_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x31B1B0)
#define MOLEMOLE_STATICVECTORMATERIALMODIFIER_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x31B220)
#define MOLEMOLE_STATICVECTORMATERIALMODIFIER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x31B170)
#define MOLEMOLE_STATICVECTORMATERIALMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x31B140)

namespace MoleMole
{
	inline static constexpr unsigned int StaticVectorMaterialModifier_TypeDefinitionIndex = 72781;
