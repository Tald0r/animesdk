...
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_HASCOLLECTTHISCURSE_1_OFFSET UNITYSDK_OFFSET(0x961DE10)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_HASCOLLECTTHISCURSE_OFFSET UNITYSDK_OFFSET(0x961DC20)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x961DF70)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x961D3E0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x961D630)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x961E010)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x961D1C0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x961DCA0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_REFRESHREDPOINTBYDATA_OFFSET UNITYSDK_OFFSET(0x961DDA0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_REFRESHREDPOINT_OFFSET UNITYSDK_OFFSET(0x961DA30)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x961D710)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x961E0F0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x961E100)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x961E170)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x961E1E0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x961E260)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x961E2E0)
#define MOLEMOLE_UIHOLLOWEROSIONROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x961E340)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowErosionRowWidgetController_TypeDefinitionIndex = 45654;
	...
	public:
		...
		::Class_2_C9DDE9730C6BE395_5* _view; // 0x2D0
