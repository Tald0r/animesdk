...
#define MOLEMOLE_UIAVATARCAMERAANIMATIONSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xA314960)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarCameraAnimationSetting_TypeDefinitionIndex = 56554;
