...
#define MOLEMOLE_UIHOUSERHYTHMREWARDPAGECONTROLLER_CHECKLEVELUP_OFFSET UNITYSDK_OFFSET(0x873B7C0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x873B4B0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x873B4C0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x873B530)
#define MOLEMOLE_UIHOUSERHYTHMREWARDPAGECONTROLLER_ONITEMGET_OFFSET UNITYSDK_OFFSET(0x873C6D0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDPAGECONTROLLER_ONLIVEHOUSEGETREWARD_OFFSET UNITYSDK_OFFSET(0x873C600)
#define MOLEMOLE_UIHOUSERHYTHMREWARDPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x873C2F0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x873B5F0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x873C830)
#define MOLEMOLE_UIHOUSERHYTHMREWARDPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x873C840)
#define MOLEMOLE_UIHOUSERHYTHMREWARDPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x873C8B0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x873C8C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmRewardPageController_TypeDefinitionIndex = 67248;
