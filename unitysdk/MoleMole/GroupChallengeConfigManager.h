...
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0xA3968E0)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_222951B8BA7FC1B0_OFFSET UNITYSDK_OFFSET(0xA3962F0)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_44C6956149352354_OFFSET UNITYSDK_OFFSET(0xA396240)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_6156EF6FFD0A172B_OFFSET UNITYSDK_OFFSET(0xA396170)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_62167C28EC14CC63_OFFSET UNITYSDK_OFFSET(0xA396450)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_722BCE84FFA29122_OFFSET UNITYSDK_OFFSET(0xA395AE0)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_D12B7AF287E2C1C1_OFFSET UNITYSDK_OFFSET(0xA3960D0)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_EE0137E8EED79B71_OFFSET UNITYSDK_OFFSET(0xA395F70)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xA396440)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_RESET_OFFSET UNITYSDK_OFFSET(0xA395910)
#define MOLEMOLE_GROUPCHALLENGECONFIGMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA395A40)

namespace MoleMole
{
	inline static constexpr unsigned int GroupChallengeConfigManager_TypeDefinitionIndex = 70508;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_380E15D819BCBADA*>**)Il2CppClass::FromTypeDefinitionIndex(GroupChallengeConfigManager_TypeDefinitionIndex)->GetStaticField(0x36ED0);
		}
		...
		{
			return ((::System::Boolean(*)(::Foundation::AssetPath, ::Foundation::AssetRequestHandle&))((::PBYTE)hIl2Cpp + MOLEMOLE_GROUPCHALLENGECONFIGMANAGER_METHOD_1_722BCE84FFA29122_OFFSET))(a1, a2);
		}
