...
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0901E0)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC090280)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC08FE30)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC08FED0)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER_REFRESHTALENT_OFFSET UNITYSDK_OFFSET(0xC090360)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC090B80)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC090B40)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER__ONUIOPEN_B__3_0_OFFSET UNITYSDK_OFFSET(0xC090CE0)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC090DF0)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC090E60)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC090EE0)
#define MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC090F40)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseTalentRowWidgetController_TypeDefinitionIndex = 56407;
	...
	public:
		...
		{
			return (::Il2CppArray<::Foundation::AssetPath>**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseTalentRowWidgetController_TypeDefinitionIndex)->GetStaticField(0x440B0);
		}
		...
		::System::Void RefreshTalent(::Class_2_208CC9941471731A_419* template_, ::Class_2_D89CCC627A66D0AD* avatarItemData, ::System::Boolean unlock, ::System::Int32 index)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_419*, ::Class_2_D89CCC627A66D0AD*, ::System::Boolean, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELPAUSETALENTROWWIDGETCONTROLLER_REFRESHTALENT_OFFSET))(this, template_, avatarItemData, unlock, index);
		}
