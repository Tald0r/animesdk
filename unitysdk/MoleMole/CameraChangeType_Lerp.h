...
#define MOLEMOLE_CAMERACHANGETYPE_LERP__CTOR_OFFSET UNITYSDK_OFFSET(0x81CE420)

namespace MoleMole
{
	inline static constexpr unsigned int CameraChangeType_Lerp_TypeDefinitionIndex = 60489;
