...
#define MOLEMOLE_CAMERACHANGETYPE_LERP__CTOR_OFFSET UNITYSDK_OFFSET(0x6533FB0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraChangeType_Lerp_TypeDefinitionIndex = 72139;
