...
#define MOLEMOLE_CLOTHTORENDERERSDATADIC__CTOR_OFFSET UNITYSDK_OFFSET(0xBADB7A0)

namespace MoleMole
{
	inline static constexpr unsigned int ClothToRenderersDataDic_TypeDefinitionIndex = 57164;
