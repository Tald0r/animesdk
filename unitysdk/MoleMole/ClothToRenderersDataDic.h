...
#define MOLEMOLE_CLOTHTORENDERERSDATADIC__CTOR_OFFSET UNITYSDK_OFFSET(0x6D3A800)

namespace MoleMole
{
	inline static constexpr unsigned int ClothToRenderersDataDic_TypeDefinitionIndex = 40999;
