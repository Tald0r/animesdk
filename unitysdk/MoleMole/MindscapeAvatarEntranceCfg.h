...
#define MOLEMOLE_MINDSCAPEAVATARENTRANCECFG__CTOR_OFFSET UNITYSDK_OFFSET(0xC22C570)

namespace MoleMole
{
	inline static constexpr unsigned int MindscapeAvatarEntranceCfg_TypeDefinitionIndex = 47870;
