...
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB316A70)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___C__DISPLAYCLASS35_0__REFRESHSTATE_B__4_OFFSET UNITYSDK_OFFSET(0xB316A80)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___C__DISPLAYCLASS35_0__REFRESHSTATE_B__5_OFFSET UNITYSDK_OFFSET(0xB316B20)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___C__DISPLAYCLASS35_0__REFRESHSTATE_B__6_OFFSET UNITYSDK_OFFSET(0xB316BB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssLimboWidgetController___c__DisplayClass35_0_TypeDefinitionIndex = 48588;
