...
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER_MISSIONTIPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB2458F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsContainerWidgetController_MissionTipData_TypeDefinitionIndex = 75702;
	...
	public:
		...
		::System::Boolean IsFadeOut; // 0x1C
		::System::Boolean IsModified; // 0x1D
		::System::Boolean IsFromResume; // 0x1E
