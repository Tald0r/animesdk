...
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCAAF860)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCAAF8D0)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCAAF9D0)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_RESETPOS_OFFSET UNITYSDK_OFFSET(0xCAAFB80)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCAAFC40)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCAAFC70)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCAAFCE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapRightListRowScrollViewWidgetController_TypeDefinitionIndex = 76633;
