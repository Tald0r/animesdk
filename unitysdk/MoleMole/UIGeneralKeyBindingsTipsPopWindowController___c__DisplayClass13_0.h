...
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8A16290)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__TRYKEYBINDING_B__0_OFFSET UNITYSDK_OFFSET(0x8A162A0)
#define MOLEMOLE_UIGENERALKEYBINDINGSTIPSPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__TRYKEYBINDING_B__1_OFFSET UNITYSDK_OFFSET(0x8A162C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralKeyBindingsTipsPopWindowController___c__DisplayClass13_0_TypeDefinitionIndex = 47227;
