...
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_CHECKACTIVITYEND_OFFSET UNITYSDK_OFFSET(0xD231030)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_CREATEBOUNTY_OFFSET UNITYSDK_OFFSET(0xD22F030)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_CREATEEXPLORATION_OFFSET UNITYSDK_OFFSET(0xD22F110)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_GETDAYINDEX_OFFSET UNITYSDK_OFFSET(0xD22EB80)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_GETSELECTTABQUESTDAY_OFFSET UNITYSDK_OFFSET(0xD22F610)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xD22EFC0)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD230370)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xD22EE10)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_INITTAB_OFFSET UNITYSDK_OFFSET(0xD22F6D0)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xD230250)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD230470)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_ONNOTIFYACTIVITYEND_OFFSET UNITYSDK_OFFSET(0xD230830)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_ONPHOTOACTIVITYREFRESH_OFFSET UNITYSDK_OFFSET(0xD230A90)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_ONSETCLICKPRECHECKTAB_OFFSET UNITYSDK_OFFSET(0xD230140)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD230B50)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_ONTABSELECTED_OFFSET UNITYSDK_OFFSET(0xD2302D0)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD230960)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD230F20)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD230510)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_REFRESHSCROLLDATA_OFFSET UNITYSDK_OFFSET(0xD22E380)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_REFRESHSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xD22F1F0)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_REFRESHTABDAYUI_OFFSET UNITYSDK_OFFSET(0xD22F860)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_REFRESHTAB_OFFSET UNITYSDK_OFFSET(0xD22FCF0)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0xD230C20)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0xD2308F0)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_SELECTTAB_OFFSET UNITYSDK_OFFSET(0xD22FE40)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_SETACTIVITYREWARDBTN_OFFSET UNITYSDK_OFFSET(0xD230CE0)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xD230380)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_SHOWBOUNTYUI_OFFSET UNITYSDK_OFFSET(0xD22E2F0)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_SHOWEXPLORATIONUI_OFFSET UNITYSDK_OFFSET(0xD22ED00)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD230FB0)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD2310A0)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD231210)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD231280)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD2312F0)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD231300)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD231310)
#define MOLEMOLE_UIACTIVITYCAMERAPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xD231320)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCameraPageController_TypeDefinitionIndex = 79562;
