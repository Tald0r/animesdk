...
#define MOLEMOLE_TELEPORTTOAVATAR___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB703290)
#define MOLEMOLE_TELEPORTTOAVATAR___C__DISPLAYCLASS10_0__ONUPDATE_B__0_OFFSET UNITYSDK_OFFSET(0xB7032A0)

namespace MoleMole
{
	inline static constexpr unsigned int TeleportToAvatar___c__DisplayClass10_0_TypeDefinitionIndex = 43648;

	class TeleportToAvatar___c__DisplayClass10_0 : public ::System::Object
	{
	public:
		::MoleMole::TeleportToAvatar* __4__this; // 0x10
