...
#define MOLEMOLE_TELEPORTTOAVATAR___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB305130)
#define MOLEMOLE_TELEPORTTOAVATAR___C__DISPLAYCLASS10_0__ONUPDATE_B__0_OFFSET UNITYSDK_OFFSET(0xB305140)

namespace MoleMole
{
	inline static constexpr unsigned int TeleportToAvatar___c__DisplayClass10_0_TypeDefinitionIndex = 66191;
