...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER3_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0x8B203E0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER3__CTOR_OFFSET UNITYSDK_OFFSET(0x8B21050)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER3___BASE_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0x8B21070)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int GuidanceCore_Bezier3_TypeDefinitionIndex = 76218;
