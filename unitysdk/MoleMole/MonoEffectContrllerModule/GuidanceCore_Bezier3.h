...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER3_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0xB1A4E70)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER3__CTOR_OFFSET UNITYSDK_OFFSET(0xB1A5AE0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER3___BASE_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0xB1A5B00)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int GuidanceCore_Bezier3_TypeDefinitionIndex = 73958;
