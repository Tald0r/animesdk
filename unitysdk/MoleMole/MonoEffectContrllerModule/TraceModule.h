...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_EXECUTEFRAGMENT_OFFSET UNITYSDK_OFFSET(0x38B3D0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_EXECUTEFRAGMENT_RECURSION_OFFSET UNITYSDK_OFFSET(0x38B3E0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_GENERATEDNEXTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x38B400)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_GETCURBULLETPOSITION_OFFSET UNITYSDK_OFFSET(0x38B3A0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_INITNEXTFRAGMENT_OFFSET UNITYSDK_OFFSET(0x38B3F0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x38B240)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x38B250)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x38B2D0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSGUIDANCEMOVE_OFFSET UNITYSDK_OFFSET(0x38B360)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSRUNTIMETRACKMOVE_OFFSET UNITYSDK_OFFSET(0x38B390)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSRUNTIMETRACK_FIXEDSPEED_OFFSET UNITYSDK_OFFSET(0x38B440)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSRUNTIMETRACK_IMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x38B450)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_PROCESSTRACK_OFFSET UNITYSDK_OFFSET(0x38B370)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_SYNCPOSITIONFROMBULLET_OFFSET UNITYSDK_OFFSET(0x38B350)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_TRACEDATA_OFFSET UNITYSDK_OFFSET(0x38B3C0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEMODULE_UPDATETRACKSTATE_OFFSET UNITYSDK_OFFSET(0x38B380)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int TraceModule_TypeDefinitionIndex = 76842;
