...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PERLINNOISECONFIG_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0xB5F6050)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PERLINNOISECONFIG_NOISEPOINT_OFFSET UNITYSDK_OFFSET(0xB5F5E50)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PERLINNOISECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB5F6300)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int PerlinNoiseConfig_TypeDefinitionIndex = 70343;
