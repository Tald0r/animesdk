...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PERLINNOISECONFIG_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x6B06250)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PERLINNOISECONFIG_NOISEPOINT_OFFSET UNITYSDK_OFFSET(0x6B06050)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PERLINNOISECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6B06500)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int PerlinNoiseConfig_TypeDefinitionIndex = 57909;
