...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x3B3000)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x3B3010)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x3B3160)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int SetupModule_TypeDefinitionIndex = 79969;
