...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x3B7530)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x3B7540)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x3B7690)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int SetupModule_TypeDefinitionIndex = 72254;
