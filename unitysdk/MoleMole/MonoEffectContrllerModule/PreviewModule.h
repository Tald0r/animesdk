...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD0EDAE0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0xD0ED970)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0xD0ED9E0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0xD0EDA50)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_PREVIEWMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0EDAC0)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int PreviewModule_TypeDefinitionIndex = 69869;
