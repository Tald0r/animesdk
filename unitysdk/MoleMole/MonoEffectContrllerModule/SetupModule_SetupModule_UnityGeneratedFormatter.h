...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_SETUPMODULE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xD0EDB40)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_SETUPMODULE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xD0EDB50)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_SETUPMODULE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xD0EDBE0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_SETUPMODULE_SETUPMODULE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0EDC50)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int SetupModule_SetupModule_UnityGeneratedFormatter_TypeDefinitionIndex = 79970;
