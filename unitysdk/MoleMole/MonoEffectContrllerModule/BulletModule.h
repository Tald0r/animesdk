...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_BULLETMODULE_METHOD_2_CE9004FE1A9D4E66_OFFSET UNITYSDK_OFFSET(0xB99B080)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_BULLETMODULE_METHOD_2_EA15BE021E279EF5_1_OFFSET UNITYSDK_OFFSET(0x3B81A0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_BULLETMODULE_METHOD_2_EA15BE021E279EF5_2_OFFSET UNITYSDK_OFFSET(0x3B8210)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_BULLETMODULE_METHOD_2_EA15BE021E279EF5_OFFSET UNITYSDK_OFFSET(0x3B8130)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_BULLETMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x3B8020)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_BULLETMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x3B8030)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_BULLETMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x3B80C0)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int BulletModule_TypeDefinitionIndex = 37863;
