...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCEMODULE_GETCURRENTCONFIG_OFFSET UNITYSDK_OFFSET(0x2F8E10)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCEMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x2F8DB0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCEMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x2F8EA0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCEMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x2F8EB0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCEMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x2F8F30)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int GuidanceModule_TypeDefinitionIndex = 64811;
