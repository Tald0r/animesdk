...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER2_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0xCD614A0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER2__CTOR_OFFSET UNITYSDK_OFFSET(0xCD61670)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_GUIDANCECORE_BEZIER2___BASE_GENERATEPATH_OFFSET UNITYSDK_OFFSET(0xCD61680)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int GuidanceCore_Bezier2_TypeDefinitionIndex = 49459;
