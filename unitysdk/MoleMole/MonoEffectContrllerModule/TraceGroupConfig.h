...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPCONFIG_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x6EAA830)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPCONFIG_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x6EAA8D0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPCONFIG_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x6EAAA30)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6EAAB90)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int TraceGroupConfig_TypeDefinitionIndex = 59888;
