...
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPMODULE_ONCREATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x33DDC0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPMODULE_ONDESTROYCONTROLLER_OFFSET UNITYSDK_OFFSET(0x33DDD0)
#define MOLEMOLE_MONOEFFECTCONTRLLERMODULE_TRACEGROUPMODULE_ONUPDATECONTROLLER_OFFSET UNITYSDK_OFFSET(0x33DE60)

namespace MoleMole::MonoEffectContrllerModule
{
	inline static constexpr unsigned int TraceGroupModule_TypeDefinitionIndex = 38960;
