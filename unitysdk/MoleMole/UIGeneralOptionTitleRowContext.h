...
#define MOLEMOLE_UIGENERALOPTIONTITLEROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBFF53E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralOptionTitleRowContext_TypeDefinitionIndex = 37329;
