...
#define MOLEMOLE_UIPRIVATEMESSAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA858FD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPrivateMessageContext_TypeDefinitionIndex = 52455;
