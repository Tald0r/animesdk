...
#define MOLEMOLE_UIHANDBOOKCHANGEWISHLISTTARGETPOPWINDOWCONTROLLER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB2CDA50)
#define MOLEMOLE_UIHANDBOOKCHANGEWISHLISTTARGETPOPWINDOWCONTROLLER___C__DISPLAYCLASS16_0__ONCLICKSETTARGETBTN_B__0_OFFSET UNITYSDK_OFFSET(0xB2CDC40)
#define MOLEMOLE_UIHANDBOOKCHANGEWISHLISTTARGETPOPWINDOWCONTROLLER___C__DISPLAYCLASS16_0__ONCLICKSETTARGETBTN_B__1_OFFSET UNITYSDK_OFFSET(0xB2CDA60)
#define MOLEMOLE_UIHANDBOOKCHANGEWISHLISTTARGETPOPWINDOWCONTROLLER___C__DISPLAYCLASS16_0__ONCLICKSETTARGETBTN_B__2_OFFSET UNITYSDK_OFFSET(0xB2CDB90)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookChangeWishlistTargetPopWindowController___c__DisplayClass16_0_TypeDefinitionIndex = 39130;
