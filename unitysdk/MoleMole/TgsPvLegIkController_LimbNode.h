...
#define MOLEMOLE_TGSPVLEGIKCONTROLLER_LIMBNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x99476F0)

namespace MoleMole
{
	inline static constexpr unsigned int TgsPvLegIkController_LimbNode_TypeDefinitionIndex = 55949;
