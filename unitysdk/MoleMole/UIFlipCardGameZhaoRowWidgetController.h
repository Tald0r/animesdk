...
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_GETCARDID_OFFSET UNITYSDK_OFFSET(0xC0D9140)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xC0D93A0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0D8A40)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONREQUESTFLIPCARDSUCCESS_OFFSET UNITYSDK_OFFSET(0xC0D9620)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC0D8BC0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0D8AE0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0D8710)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC0D8CB0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_SHOWFLIPEDCARDREWARDPOPWINDOW_OFFSET UNITYSDK_OFFSET(0xC0D91F0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0D97D0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER__ONREQUESTFLIPCARDSUCCESS_B__16_0_OFFSET UNITYSDK_OFFSET(0xC0D97E0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xC0D9820)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0D9830)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC0D98A0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0D9920)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0D99A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlipCardGameZhaoRowWidgetController_TypeDefinitionIndex = 57859;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFLIPCARDGAMEZHAOROWWIDGETCONTROLLER_ONREQUESTFLIPCARDSUCCESS_OFFSET))(this, rcvmessage);
		}
