...
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x71E2AE0)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_ONRELATEDAVATARBTNCLICK_OFFSET UNITYSDK_OFFSET(0x71E3F20)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x71E2C60)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x71E2B80)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x71E2790)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_SETBURNTIP_OFFSET UNITYSDK_OFFSET(0x71E3C80)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_SETREWARDBUFFICON_OFFSET UNITYSDK_OFFSET(0x71E3AD0)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER_SETREWARDBUFFTIP_OFFSET UNITYSDK_OFFSET(0x71E3D10)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x71E3FB0)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x71E4040)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x71E40B0)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x71E4130)
#define MOLEMOLE_UIVRBOSSCARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x71E41B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVRBossCardWidgetController_TypeDefinitionIndex = 68807;
	...
	public:
		...
		::Class_2_208CC9941471731A_772* _quest; // 0x2E8
