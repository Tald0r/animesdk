...
#define MOLEMOLE_UITESTLAUNCHERINEDITOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD6DEEF0)

namespace MoleMole
{
	inline static constexpr unsigned int UITestLauncherInEditor_TypeDefinitionIndex = 48618;
