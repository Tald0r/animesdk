...
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_ATTACHEFFECT_OFFSET UNITYSDK_OFFSET(0x759FD20)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_CONSTRUCTNPCDATA_OFFSET UNITYSDK_OFFSET(0x759F080)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_EXECUTEDELAYEDLASER_OFFSET UNITYSDK_OFFSET(0x75A0290)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_DAMAGEWHENESCAPE_OFFSET UNITYSDK_OFFSET(0x759E810)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_DAMAGE_OFFSET UNITYSDK_OFFSET(0x759E7F0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ENTITYTAG_OFFSET UNITYSDK_OFFSET(0x759E8D0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_FEVERREWARD_OFFSET UNITYSDK_OFFSET(0x759E7D0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_MOVESPEED_OFFSET UNITYSDK_OFFSET(0x759E790)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_MOVETIMER_OFFSET UNITYSDK_OFFSET(0x759E830)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONBEFOREMOVEEVENT_OFFSET UNITYSDK_OFFSET(0x759E890)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONCREATEDEVENT_OFFSET UNITYSDK_OFFSET(0x759E8B0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONDAMAGEDCAMERASHAKEKEY_OFFSET UNITYSDK_OFFSET(0x759E930)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONDAMAGEDEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x759E8F0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONDAMAGEDEVENT_OFFSET UNITYSDK_OFFSET(0x759E850)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONDEATHBODYEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x759E950)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONDEATHEVENT_OFFSET UNITYSDK_OFFSET(0x759E870)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONESCAPEEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x759E990)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONFEVERDAMAGEDEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x759E910)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_ONFEVERDEATHBODYEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x759E970)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GET_REWARD_OFFSET UNITYSDK_OFFSET(0x759E7B0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GRIDDIRTOVECTOR2INT_OFFSET UNITYSDK_OFFSET(0x759EF30)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_GRIDLINKHELPER_OFFSET UNITYSDK_OFFSET(0x759F590)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_INIT_OFFSET UNITYSDK_OFFSET(0x759F660)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_MOVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x759EB30)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_MOVE_OFFSET UNITYSDK_OFFSET(0x759E9B0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_ONATTACHHACKSHARDEDINFO_OFFSET UNITYSDK_OFFSET(0x759FED0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_ONUPDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x75A0070)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SETEFFECT_OFFSET UNITYSDK_OFFSET(0x759FDF0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_DAMAGEWHENESCAPE_OFFSET UNITYSDK_OFFSET(0x759E820)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_DAMAGE_OFFSET UNITYSDK_OFFSET(0x759E800)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ENTITYTAG_OFFSET UNITYSDK_OFFSET(0x759E8E0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_FEVERREWARD_OFFSET UNITYSDK_OFFSET(0x759E7E0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_MOVESPEED_OFFSET UNITYSDK_OFFSET(0x759E7A0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_MOVETIMER_OFFSET UNITYSDK_OFFSET(0x759E840)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONBEFOREMOVEEVENT_OFFSET UNITYSDK_OFFSET(0x759E8A0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONCREATEDEVENT_OFFSET UNITYSDK_OFFSET(0x759E8C0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONDAMAGEDCAMERASHAKEKEY_OFFSET UNITYSDK_OFFSET(0x759E940)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONDAMAGEDEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x759E900)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONDAMAGEDEVENT_OFFSET UNITYSDK_OFFSET(0x759E860)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONDEATHBODYEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x759E960)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONDEATHEVENT_OFFSET UNITYSDK_OFFSET(0x759E880)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONESCAPEEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x759E9A0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONFEVERDAMAGEDEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x759E920)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_ONFEVERDEATHBODYEFFECTKEY_OFFSET UNITYSDK_OFFSET(0x759E980)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_SET_REWARD_OFFSET UNITYSDK_OFFSET(0x759E7C0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY_TAKEDAMAGE_OFFSET UNITYSDK_OFFSET(0x759F8F0)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x75A0330)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY___BASE_MOVE_OFFSET UNITYSDK_OFFSET(0x75A0380)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY___BASE_ONATTACHHACKSHARDEDINFO_OFFSET UNITYSDK_OFFSET(0x75A0390)
#define MOLEMOLE_HACKERGAMENPCCHESSENTITY___BASE_ONUPDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x75A0400)

namespace MoleMole
{
	inline static constexpr unsigned int HackerGameNpcChessEntity_TypeDefinitionIndex = 37506;

	class HackerGameNpcChessEntity : public ::MoleMole::HackerGameChessEntity
	{
	public:
		// static const ::System::Int32 playbackSpeedId = 0x1; // 0x0
		::System::String* _OnFeverDamagedEffectKey_k__BackingField; // 0x50
		::System::String* _OnDeathBodyEffectKey_k__BackingField; // 0x58
		::System::Collections::Generic::HashSet_1<::MoleMole::HollowChessboard::HollowCell>* DamagedBodyPart; // 0x60
		::System::String* _OnBeforeMoveEvent_k__BackingField; // 0x68
		::System::String* _EntityTag_k__BackingField; // 0x70
		::System::String* _OnDamagedCameraShakeKey_k__BackingField; // 0x78
		::System::String* _OnDamagedEffectKey_k__BackingField; // 0x80
		::System::String* _OnDeathEvent_k__BackingField; // 0x88
		::MoleMole::HackerGameBaseDamage* _Damage_k__BackingField; // 0x90
		::System::Collections::IEnumerator* DeathEnumerator; // 0x98
		::System::String* _OnDamagedEvent_k__BackingField; // 0xA0
		...
		::System::Int32 _MoveTimer_k__BackingField; // 0xC8
