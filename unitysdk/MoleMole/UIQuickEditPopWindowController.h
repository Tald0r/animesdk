...
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_CHECKTEAMHASLOCK_OFFSET UNITYSDK_OFFSET(0x749BC60)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_CREATTEAMEDITROW_OFFSET UNITYSDK_OFFSET(0x74982F0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_GETAVATARISLOCKED_OFFSET UNITYSDK_OFFSET(0x7499A30)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_GETBUDDYISLOCKED_OFFSET UNITYSDK_OFFSET(0x7499B20)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_GETTEAMDATA_OFFSET UNITYSDK_OFFSET(0x749B570)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x7497D40)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONBUDDYSELECT_OFFSET UNITYSDK_OFFSET(0x749A100)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONBUDYEDITORCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x7498E70)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONCLOSECLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x7498490)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7499EA0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONGOBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x749B180)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONQUICKTEAMUPDATE_OFFSET UNITYSDK_OFFSET(0x749B0F0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONREWARDFOCUSCHANGE_OFFSET UNITYSDK_OFFSET(0x74992F0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONROLEEDITORCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x7498780)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONSELECTAVATAR_OFFSET UNITYSDK_OFFSET(0x749A7E0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONSELECTBUDDYRSP_OFFSET UNITYSDK_OFFSET(0x749A650)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONTEAMCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x7499250)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONTEAMICONCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x74986F0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x749BEF0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7497D50)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7499C10)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_SETMUTISELECT_OFFSET UNITYSDK_OFFSET(0x74994F0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x749BF80)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER__ONCLOSECLICKHANDLE_B__16_0_OFFSET UNITYSDK_OFFSET(0x749C060)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER__ONCLOSECLICKHANDLE_B__16_1_OFFSET UNITYSDK_OFFSET(0x749C070)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x749C0E0)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x749C150)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x749C160)
#define MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x749C170)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuickEditPopWindowController_TypeDefinitionIndex = 55610;
	...
	public:
		...
		::Class_2_F69D29AB796376C2* QuestCfg; // 0x330
		...
		::System::Void OnSelectBuddyRsp(::Class_0_16E4307DCC419505_5* rcvMessage)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIQUICKEDITPOPWINDOWCONTROLLER_ONSELECTBUDDYRSP_OFFSET))(this, rcvMessage);
		}
