...
#define MOLEMOLE_UIREPELFIGHTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBE8DD80)

namespace MoleMole
{
	inline static constexpr unsigned int UIRepelFightingContext_TypeDefinitionIndex = 64908;
