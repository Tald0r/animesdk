...
#define MOLEMOLE_UIQUESTIONSANSWERSCREENDETAILCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xADF1BB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerScreenDetailContext_TypeDefinitionIndex = 45703;
