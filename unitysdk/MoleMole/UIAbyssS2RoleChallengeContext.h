...
#define MOLEMOLE_UIABYSSS2ROLECHALLENGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB31EBE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RoleChallengeContext_TypeDefinitionIndex = 58686;
