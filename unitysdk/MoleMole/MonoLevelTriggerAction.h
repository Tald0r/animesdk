...
#define MOLEMOLE_MONOLEVELTRIGGERACTION_METHOD_5_235F2F68A3E18565_OFFSET UNITYSDK_OFFSET(0xA7EB430)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_METHOD_5_4BEB176192B034ED_OFFSET UNITYSDK_OFFSET(0xA7EB9C0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_METHOD_5_710BCC0A64BE93CA_OFFSET UNITYSDK_OFFSET(0xA7EB5E0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0xA7EB6E0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0xA7EB760)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA7EB7E0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xA7EB3A0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xA7EB550)
#define MOLEMOLE_MONOLEVELTRIGGERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA7EB840)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLevelTriggerAction_TypeDefinitionIndex = 51797;
