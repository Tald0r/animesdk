...
#define MOLEMOLE_MONOLEVELTRIGGERACTION_METHOD_5_235F2F68A3E18565_OFFSET UNITYSDK_OFFSET(0xA601070)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_METHOD_5_4BEB176192B034ED_OFFSET UNITYSDK_OFFSET(0xA601600)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_METHOD_5_710BCC0A64BE93CA_OFFSET UNITYSDK_OFFSET(0xA601220)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0xA601320)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0xA6013A0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA601420)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xA600FE0)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xA601190)
#define MOLEMOLE_MONOLEVELTRIGGERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA601480)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLevelTriggerAction_TypeDefinitionIndex = 40886;
	...
	public:
		...
		::System::Void Method_5_710BCC0A64BE93CA(::UnityEngine::GameObject* a1)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::GameObject*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOLEVELTRIGGERACTION_METHOD_5_710BCC0A64BE93CA_OFFSET))(this, a1);
		}
