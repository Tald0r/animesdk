...
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_CUSTOMSORTACTION_OFFSET UNITYSDK_OFFSET(0xD5952B0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_GETCOLLECTEDSHOWITEMNUM_OFFSET UNITYSDK_OFFSET(0xD5951C0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_GET_CURFOCUSED_OFFSET UNITYSDK_OFFSET(0xD592EF0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_INITCARDLIST_OFFSET UNITYSDK_OFFSET(0xD593C00)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_INITSORT_OFFSET UNITYSDK_OFFSET(0xD593110)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_MATCHFUNCCOLLECTED_OFFSET UNITYSDK_OFFSET(0xD594E30)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_MATCHFUNC_OFFSET UNITYSDK_OFFSET(0xD594D40)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD594C30)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONSCROLLVIEWSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0xD595640)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD594B50)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONSORTORFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0xD594CD0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONTOGGLEVALUE_OFFSET UNITYSDK_OFFSET(0xD5958A0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD596390)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD5924C0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD593030)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_REFRESHITEMRARITY_OFFSET UNITYSDK_OFFSET(0xD5957A0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_REFRESHPROGRESSTITLETEXT_OFFSET UNITYSDK_OFFSET(0xD594680)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_REFRESHSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xD594770)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_REFRESHVIEWONFOCUSCHANGE_OFFSET UNITYSDK_OFFSET(0xD592950)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD5929C0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_TRYCANCELSELECTONLAYOUTCHANGETOCONSOLE_OFFSET UNITYSDK_OFFSET(0xD5950E0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER_TRYSELECTFIRSTITEMEXCEPTCONSOLELAYOUT_OFFSET UNITYSDK_OFFSET(0xD595000)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD596470)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD596620)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD596690)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD596700)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD596780)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD5967E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardCollectWidgetController_TypeDefinitionIndex = 75061;

	class UIHollowCardCollectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_30* _view; // 0x2A0
