...
#define MOLEMOLE_MONOENTITYEFFECTDEBUGGER_METHOD_5_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0xA646240)
#define MOLEMOLE_MONOENTITYEFFECTDEBUGGER_PLAYEFFECT_OFFSET UNITYSDK_OFFSET(0xA645FF0)
#define MOLEMOLE_MONOENTITYEFFECTDEBUGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA6461F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEntityEffectDebugger_TypeDefinitionIndex = 73625;
