...
#define MOLEMOLE_MONOENTITYEFFECTDEBUGGER_METHOD_5_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0xB3AE8D0)
#define MOLEMOLE_MONOENTITYEFFECTDEBUGGER_PLAYEFFECT_OFFSET UNITYSDK_OFFSET(0xB3AE680)
#define MOLEMOLE_MONOENTITYEFFECTDEBUGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xB3AE880)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEntityEffectDebugger_TypeDefinitionIndex = 65095;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOENTITYEFFECTDEBUGGER_METHOD_5_937F8473216A3162_OFFSET))(this);
		}
	};
}
