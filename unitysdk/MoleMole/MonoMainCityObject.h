...
#define MOLEMOLE_MONOMAINCITYOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC237E20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMainCityObject_TypeDefinitionIndex = 54475;
