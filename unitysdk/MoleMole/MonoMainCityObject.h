...
#define MOLEMOLE_MONOMAINCITYOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xB84E670)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMainCityObject_TypeDefinitionIndex = 78608;
