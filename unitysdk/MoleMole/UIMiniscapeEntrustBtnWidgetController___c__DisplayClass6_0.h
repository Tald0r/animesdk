...
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAF7D340)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER___C__DISPLAYCLASS6_0__PLAYREFRESHANIM_B__0_OFFSET UNITYSDK_OFFSET(0xAF7D350)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeEntrustBtnWidgetController___c__DisplayClass6_0_TypeDefinitionIndex = 59372;
