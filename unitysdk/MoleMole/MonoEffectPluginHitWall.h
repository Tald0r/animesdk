...
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL_CALCHITDIR_OFFSET UNITYSDK_OFFSET(0xB99B420)
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL_GET_EFFECTLENGTH_OFFSET UNITYSDK_OFFSET(0xB99B2B0)
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL_METHOD_6_871AC6DBEB0AF4F3_OFFSET UNITYSDK_OFFSET(0xB99B7A0)
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL__CTOR_OFFSET UNITYSDK_OFFSET(0xB99B780)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginHitWall_TypeDefinitionIndex = 73050;
