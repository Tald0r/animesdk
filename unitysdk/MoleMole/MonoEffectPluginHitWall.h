...
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL_CALCHITDIR_OFFSET UNITYSDK_OFFSET(0xD80D9C0)
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL_GET_EFFECTLENGTH_OFFSET UNITYSDK_OFFSET(0xD80D850)
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL_METHOD_6_871AC6DBEB0AF4F3_OFFSET UNITYSDK_OFFSET(0xD80DD40)
#define MOLEMOLE_MONOEFFECTPLUGINHITWALL__CTOR_OFFSET UNITYSDK_OFFSET(0xD80DD20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginHitWall_TypeDefinitionIndex = 40995;
