...
#define MOLEMOLE_UIACTIVITYCOREAWARDCOMPONENTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x987D290)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCoreAwardComponentContext_TypeDefinitionIndex = 58522;
