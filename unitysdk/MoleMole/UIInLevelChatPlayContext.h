...
#define MOLEMOLE_UIINLEVELCHATPLAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x980A640)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelChatPlayContext_TypeDefinitionIndex = 60610;
