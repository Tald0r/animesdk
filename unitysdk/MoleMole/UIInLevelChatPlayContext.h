...
#define MOLEMOLE_UIINLEVELCHATPLAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8940880)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelChatPlayContext_TypeDefinitionIndex = 64009;
