...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER__LOADNXTLEVELFAKELOADINGVIEW_D__302_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xAD5C940)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER__LOADNXTLEVELFAKELOADINGVIEW_D__302_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAD5CBE0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER__LOADNXTLEVELFAKELOADINGVIEW_D__302_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAD5CC40)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER__LOADNXTLEVELFAKELOADINGVIEW_D__302_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xAD5CBF0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER__LOADNXTLEVELFAKELOADINGVIEW_D__302_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAD5C930)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER__LOADNXTLEVELFAKELOADINGVIEW_D__302__CTOR_OFFSET UNITYSDK_OFFSET(0xAD5C920)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController__LoadNxtLevelFakeLoadingView_d__302_TypeDefinitionIndex = 49586;
