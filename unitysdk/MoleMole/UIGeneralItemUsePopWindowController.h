...
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_DOITEMUSE_OFFSET UNITYSDK_OFFSET(0x808CCF0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_DOPOWERACTION_OFFSET UNITYSDK_OFFSET(0x808CD80)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_DOPURCHASE_OFFSET UNITYSDK_OFFSET(0x808CC00)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x808A1C0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x808A1B0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_INITNUMINFOCONTENT_OFFSET UNITYSDK_OFFSET(0x808C630)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONCLICKSETTOMAX_OFFSET UNITYSDK_OFFSET(0x808D220)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x808A5B0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x808D810)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x808D9D0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONINPUTCHANGED_OFFSET UNITYSDK_OFFSET(0x808D5C0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONINPUTFIELDDESELECT_OFFSET UNITYSDK_OFFSET(0x808D3B0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONINPUTFIELDSELECT_OFFSET UNITYSDK_OFFSET(0x808D350)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x808CAA0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONTEXTVALIDATEINPUT_OFFSET UNITYSDK_OFFSET(0x808D540)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x808D2C0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x808A1D0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x808A650)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x808A8D0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETCONSOLEINFOBTN_OFFSET UNITYSDK_OFFSET(0x808C220)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETDETAILSICONBTN_OFFSET UNITYSDK_OFFSET(0x808BE40)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x808C470)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETMAXUSECOUNT_OFFSET UNITYSDK_OFFSET(0x808C400)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETSLIDERGREY_OFFSET UNITYSDK_OFFSET(0x808C520)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETSPECIALBTNTEXT_OFFSET UNITYSDK_OFFSET(0x808BBC0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETTITLEINFOBTN_OFFSET UNITYSDK_OFFSET(0x808C040)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SHOWSPECIAL02BTNTIP_OFFSET UNITYSDK_OFFSET(0x808BD70)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SHOWSPECIALBTNPANEL_OFFSET UNITYSDK_OFFSET(0x808B900)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SHOWUSEBTN_OFFSET UNITYSDK_OFFSET(0x808B870)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x808DCE0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__REFRESHVIEW_B__17_0_OFFSET UNITYSDK_OFFSET(0x808DCF0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__REFRESHVIEW_B__17_1_OFFSET UNITYSDK_OFFSET(0x808DF70)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__REFRESHVIEW_B__17_2_OFFSET UNITYSDK_OFFSET(0x808E010)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x808E070)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x808E0E0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x808E150)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x808E1C0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x808E1D0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x808E1E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemUsePopWindowController_TypeDefinitionIndex = 76192;
	...
	public:
		...
		::System::Int32 _maxUseCount; // 0x308
		::System::Boolean _showInputField; // 0x30C
		::System::Int32 _expectedInitCount; // 0x310
		::System::UInt32 useCount; // 0x314
		::UnityEngine::UI::Image* _sliderHandleImage; // 0x318
		::System::Action_1<::System::Int32>* useAction; // 0x320
		::System::Boolean isTextChanging; // 0x328
		::System::String* _titleText; // 0x330
