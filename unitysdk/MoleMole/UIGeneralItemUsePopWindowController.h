...
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_DOITEMUSE_OFFSET UNITYSDK_OFFSET(0xAC6A0A0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_DOPOWERACTION_OFFSET UNITYSDK_OFFSET(0xAC6A130)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_DOPURCHASE_OFFSET UNITYSDK_OFFSET(0xAC69FB0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xAC67570)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAC67560)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_INITNUMINFOCONTENT_OFFSET UNITYSDK_OFFSET(0xAC699F0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONCLICKSETTOMAX_OFFSET UNITYSDK_OFFSET(0xAC6A5D0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC67970)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xAC6ABC0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xAC6AD80)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONINPUTCHANGED_OFFSET UNITYSDK_OFFSET(0xAC6A970)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONINPUTFIELDDESELECT_OFFSET UNITYSDK_OFFSET(0xAC6A760)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONINPUTFIELDSELECT_OFFSET UNITYSDK_OFFSET(0xAC6A700)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0xAC69E50)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONTEXTVALIDATEINPUT_OFFSET UNITYSDK_OFFSET(0xAC6A8F0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC6A670)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC67580)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC67A10)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAC67C90)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETCONSOLEINFOBTN_OFFSET UNITYSDK_OFFSET(0xAC695E0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETDETAILSICONBTN_OFFSET UNITYSDK_OFFSET(0xAC69200)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xAC69830)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETMAXUSECOUNT_OFFSET UNITYSDK_OFFSET(0xAC697C0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETSLIDERGREY_OFFSET UNITYSDK_OFFSET(0xAC698E0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETSPECIALBTNTEXT_OFFSET UNITYSDK_OFFSET(0xAC68F80)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SETTITLEINFOBTN_OFFSET UNITYSDK_OFFSET(0xAC69400)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SHOWSPECIAL02BTNTIP_OFFSET UNITYSDK_OFFSET(0xAC69130)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SHOWSPECIALBTNPANEL_OFFSET UNITYSDK_OFFSET(0xAC68CC0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER_SHOWUSEBTN_OFFSET UNITYSDK_OFFSET(0xAC68C30)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC6B080)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__REFRESHVIEW_B__17_0_OFFSET UNITYSDK_OFFSET(0xAC6B090)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__REFRESHVIEW_B__17_1_OFFSET UNITYSDK_OFFSET(0xAC6B310)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER__REFRESHVIEW_B__17_2_OFFSET UNITYSDK_OFFSET(0xAC6B3B0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC6B410)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xAC6B480)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xAC6B4F0)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC6B560)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC6B570)
#define MOLEMOLE_UIGENERALITEMUSEPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC6B580)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemUsePopWindowController_TypeDefinitionIndex = 77880;
