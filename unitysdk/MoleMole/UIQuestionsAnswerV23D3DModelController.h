...
#define MOLEMOLE_UIQUESTIONSANSWERV23D3DMODELCONTROLLER_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0xA2360E0)
#define MOLEMOLE_UIQUESTIONSANSWERV23D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA2361B0)
#define MOLEMOLE_UIQUESTIONSANSWERV23D3DMODELCONTROLLER___BASE_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0xA236210)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerV23D3DModelController_TypeDefinitionIndex = 69243;
