...
#define MOLEMOLE_FRAMERATEPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x990FED0)
#define MOLEMOLE_FRAMERATEPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x9910050)
#define MOLEMOLE_FRAMERATEPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x990FDF0)
#define MOLEMOLE_FRAMERATEPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x990FFB0)
#define MOLEMOLE_FRAMERATEPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x990FDE0)
#define MOLEMOLE_FRAMERATEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x9910180)
#define MOLEMOLE_FRAMERATEPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x9910220)
#define MOLEMOLE_FRAMERATEPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x9910300)
#define MOLEMOLE_FRAMERATEPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x99103E0)

namespace MoleMole
{
	inline static constexpr unsigned int FrameRateProfile_TypeDefinitionIndex = 52153;
