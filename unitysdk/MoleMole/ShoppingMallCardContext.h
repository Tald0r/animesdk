...
#define MOLEMOLE_SHOPPINGMALLCARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA7FA990)

namespace MoleMole
{
	inline static constexpr unsigned int ShoppingMallCardContext_TypeDefinitionIndex = 38856;

	class ShoppingMallCardContext : public ::MoleMole::ShoppingMallBaseContextBase
	{
	public:
		::UnityEngine::UI::Extension::UITimeWidget* timer; // 0x58
		::Class_2_60DDD9C206686F44* infoBtn; // 0x60
		::UnityEngine::UI::Extension::UILocalizationText* buyText; // 0x68
		::Class_2_60DDD9C206686F44* buyBtn; // 0x70
		::Class_2_60DDD9C206686F44* infoConsoleBtn; // 0x78
		::UnityEngine::UI::Extension::UILocalizationText* priceText; // 0x80
