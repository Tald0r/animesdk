...
#define MOLEMOLE_MONSTER_SYMMETRYMATRIXLIST_METHOD_1_42A6A41AC7891AB7_OFFSET UNITYSDK_OFFSET(0xB3BD3C0)
#define MOLEMOLE_MONSTER_SYMMETRYMATRIXLIST_METHOD_1_6CB5060D47BF8A1B_OFFSET UNITYSDK_OFFSET(0xB3BD910)
#define MOLEMOLE_MONSTER_SYMMETRYMATRIXLIST_METHOD_1_7DE625BC49EA7910_OFFSET UNITYSDK_OFFSET(0xB3BD690)
#define MOLEMOLE_MONSTER_SYMMETRYMATRIXLIST_METHOD_1_A37026F5FDBACF68_OFFSET UNITYSDK_OFFSET(0xB3BD810)
#define MOLEMOLE_MONSTER_SYMMETRYMATRIXLIST_METHOD_1_E4B3C4AAF2EA0017_OFFSET UNITYSDK_OFFSET(0xB3BD990)
#define MOLEMOLE_MONSTER_SYMMETRYMATRIXLIST__CTOR_OFFSET UNITYSDK_OFFSET(0xB3BCED0)

namespace MoleMole::Monster
{
	inline static constexpr unsigned int SymmetryMatrixList_TypeDefinitionIndex = 50335;
