...
#define MOLEMOLE_MONSTER_SYMMETRYMATRIXLIST_METHOD_1_42A6A41AC7891AB7_OFFSET UNITYSDK_OFFSET(0xA655830)
#define MOLEMOLE_MONSTER_SYMMETRYMATRIXLIST_METHOD_1_6CB5060D47BF8A1B_OFFSET UNITYSDK_OFFSET(0xA6560C0)
#define MOLEMOLE_MONSTER_SYMMETRYMATRIXLIST_METHOD_1_7DE625BC49EA7910_OFFSET UNITYSDK_OFFSET(0xA655E40)
#define MOLEMOLE_MONSTER_SYMMETRYMATRIXLIST_METHOD_1_A37026F5FDBACF68_OFFSET UNITYSDK_OFFSET(0xA655FC0)
#define MOLEMOLE_MONSTER_SYMMETRYMATRIXLIST_METHOD_1_E4B3C4AAF2EA0017_OFFSET UNITYSDK_OFFSET(0xA656140)
#define MOLEMOLE_MONSTER_SYMMETRYMATRIXLIST__CTOR_OFFSET UNITYSDK_OFFSET(0xA655680)

namespace MoleMole::Monster
{
	inline static constexpr unsigned int SymmetryMatrixList_TypeDefinitionIndex = 50468;
