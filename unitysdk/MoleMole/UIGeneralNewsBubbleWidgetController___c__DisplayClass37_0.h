...
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___C__DISPLAYCLASS37_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA99A470)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___C__DISPLAYCLASS37_0__UPDATEPOSITION_B__1_OFFSET UNITYSDK_OFFSET(0xA99A480)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER___C__DISPLAYCLASS37_0__UPDATEPOSITION_B__2_OFFSET UNITYSDK_OFFSET(0xA99A4A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleWidgetController___c__DisplayClass37_0_TypeDefinitionIndex = 68357;
