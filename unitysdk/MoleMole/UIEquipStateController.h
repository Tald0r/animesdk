...
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xD534610)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_GET_CURITEMDATA_OFFSET UNITYSDK_OFFSET(0xD534600)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_HIDEBTNS_OFFSET UNITYSDK_OFFSET(0xD5312E0)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_REALDELETE_OFFSET UNITYSDK_OFFSET(0xD535070)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_REFRESHTOGGLESTATE_OFFSET UNITYSDK_OFFSET(0xD5354F0)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_SETITEMDATA_OFFSET UNITYSDK_OFFSET(0xD531250)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_SETONITEMDATANULLHIDEBTNS_OFFSET UNITYSDK_OFFSET(0xD535480)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_TOGGLEDELETE_OFFSET UNITYSDK_OFFSET(0xD534CF0)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_TOGGLELOCK_OFFSET UNITYSDK_OFFSET(0xD534860)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER_TRIGGERTOGGLEAUDIO_OFFSET UNITYSDK_OFFSET(0xD535260)
#define MOLEMOLE_UIEQUIPSTATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD536510)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipStateController_TypeDefinitionIndex = 70495;
	...
	public:
		...
		::System::Void RealDelete(::Class_2_A3CFC20DC3954F5C* equip, ::System::Boolean isNoShowTips)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_A3CFC20DC3954F5C*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIEQUIPSTATECONTROLLER_REALDELETE_OFFSET))(this, equip, isNoShowTips);
		}
