...
#define MOLEMOLE_UICOOPCLUELEVELTHEMETABWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8069CA0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopClueLevelThemeTabWidgetController_Context_TypeDefinitionIndex = 49446;
