...
#define MOLEMOLE_UICOOPCLUELEVELTHEMETABWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAC47820)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopClueLevelThemeTabWidgetController_Context_TypeDefinitionIndex = 47976;
