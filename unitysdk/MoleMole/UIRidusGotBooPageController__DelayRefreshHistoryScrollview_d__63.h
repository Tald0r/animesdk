...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__DELAYREFRESHHISTORYSCROLLVIEW_D__63_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x37F220)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__DELAYREFRESHHISTORYSCROLLVIEW_D__63_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__DelayRefreshHistoryScrollview_d__63_TypeDefinitionIndex = 66291;
