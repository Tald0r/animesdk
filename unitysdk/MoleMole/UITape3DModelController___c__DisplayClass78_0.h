...
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS78_0__CTOR_OFFSET UNITYSDK_OFFSET(0x970D9F0)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS78_0__EASINGSLIDE_B__0_OFFSET UNITYSDK_OFFSET(0x970DA00)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS78_0__EASINGSLIDE_B__1_OFFSET UNITYSDK_OFFSET(0x970DA50)

namespace MoleMole
{
	inline static constexpr unsigned int UITape3DModelController___c__DisplayClass78_0_TypeDefinitionIndex = 39058;
