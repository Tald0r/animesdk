...
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS78_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA412A30)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS78_0__EASINGSLIDE_B__0_OFFSET UNITYSDK_OFFSET(0xA412A40)
#define MOLEMOLE_UITAPE3DMODELCONTROLLER___C__DISPLAYCLASS78_0__EASINGSLIDE_B__1_OFFSET UNITYSDK_OFFSET(0xA412A90)

namespace MoleMole
{
	inline static constexpr unsigned int UITape3DModelController___c__DisplayClass78_0_TypeDefinitionIndex = 54194;

	class UITape3DModelController___c__DisplayClass78_0 : public ::System::Object
	{
	public:
		::MoleMole::UITape3DModelController* __4__this; // 0x10
		::System::Action* onEasingComplete; // 0x18
