...
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x8FA14C0)
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x8FA14D0)
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x8FA17A0)
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8FA19B0)
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA1970)

namespace MoleMole
{
	inline static constexpr unsigned int SlidingConfig_SlidingConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 46101;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::AnimationCurve*>*>**)Il2CppClass::FromTypeDefinitionIndex(SlidingConfig_SlidingConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3EE60);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(SlidingConfig_SlidingConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3EE68);
		}
