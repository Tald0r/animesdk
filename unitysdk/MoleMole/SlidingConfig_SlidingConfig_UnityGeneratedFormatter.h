...
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xC32D860)
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xC32D870)
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xC32DB40)
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC32DD50)
#define MOLEMOLE_SLIDINGCONFIG_SLIDINGCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC32DD10)

namespace MoleMole
{
	inline static constexpr unsigned int SlidingConfig_SlidingConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 46263;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::AnimationCurve*>*>**)Il2CppClass::FromTypeDefinitionIndex(SlidingConfig_SlidingConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x41AF0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(SlidingConfig_SlidingConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x41AF8);
		}
