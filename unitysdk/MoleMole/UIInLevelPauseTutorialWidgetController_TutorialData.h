...
#define MOLEMOLE_UIINLEVELPAUSETUTORIALWIDGETCONTROLLER_TUTORIALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9822D20)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseTutorialWidgetController_TutorialData_TypeDefinitionIndex = 61896;

	class UIInLevelPauseTutorialWidgetController_TutorialData : public ::System::Object
	{
	public:
		::Class_1_8C25B6E4C19F237F_Class_1_9E89B2D44593C915* data; // 0x10
