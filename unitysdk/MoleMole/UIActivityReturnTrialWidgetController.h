...
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_BINDPAGEBTN_OFFSET UNITYSDK_OFFSET(0xB8F7D80)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_CONFRIMSELECT_OFFSET UNITYSDK_OFFSET(0xB8F9120)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_CREATEBACKFLOWROLELIST_OFFSET UNITYSDK_OFFSET(0xB8F78F0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_GETSERVERSELECT_OFFSET UNITYSDK_OFFSET(0xB8F9610)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB8F7C10)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONSELECTTARGETROLEWIDGET_OFFSET UNITYSDK_OFFSET(0xB8F9940)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB8F7CB0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB8F8150)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB8F76C0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB8F7780)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_OPENPREVIEW_OFFSET UNITYSDK_OFFSET(0xB8F8BC0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_PLAYLEFTSELECT_OFFSET UNITYSDK_OFFSET(0xB8F9000)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_PLAYRIGHTSELECT_OFFSET UNITYSDK_OFFSET(0xB8F9090)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_UPDATEAVATARTEXT_OFFSET UNITYSDK_OFFSET(0xB8F8490)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xB8F8230)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB8F9B90)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER__ONUIINIT_B__9_0_OFFSET UNITYSDK_OFFSET(0xB8F9C60)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB8F9C70)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB8F9CE0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB8F9D50)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB8F9DD0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB8F9DE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityReturnTrialWidgetController_TypeDefinitionIndex = 51436;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_74* pageView; // 0x2F0
