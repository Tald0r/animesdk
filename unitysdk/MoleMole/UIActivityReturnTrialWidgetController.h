...
namespace MoleMole { class UIActivityTrialContext; }
...
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_BINDPAGEBTN_OFFSET UNITYSDK_OFFSET(0xB968700)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_CONFRIMSELECT_OFFSET UNITYSDK_OFFSET(0xB969AB0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_CREATEBACKFLOWROLELIST_OFFSET UNITYSDK_OFFSET(0xB968270)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_GETSERVERSELECT_OFFSET UNITYSDK_OFFSET(0xB969FA0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB968590)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONSELECTTARGETROLEWIDGET_OFFSET UNITYSDK_OFFSET(0xB96A2D0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB968630)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB968AE0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB968040)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB968100)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_OPENPREVIEW_OFFSET UNITYSDK_OFFSET(0xB969550)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_PLAYLEFTSELECT_OFFSET UNITYSDK_OFFSET(0xB969990)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_PLAYRIGHTSELECT_OFFSET UNITYSDK_OFFSET(0xB969A20)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_UPDATEAVATARTEXT_OFFSET UNITYSDK_OFFSET(0xB968E20)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xB968BC0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB96A520)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER__ONUIINIT_B__9_0_OFFSET UNITYSDK_OFFSET(0xB96A5F0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB96A600)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB96A670)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB96A6E0)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB96A760)
#define MOLEMOLE_UIACTIVITYRETURNTRIALWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB96A770)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityReturnTrialWidgetController_TypeDefinitionIndex = 52650;

	class UIActivityReturnTrialWidgetController : public ::MoleMole::BackFlowWidget
	{
	public:
		::Class_2_6D5460742E9C0095* _view; // 0x2C8
		::MoleMole::UIActivityTrialContext* _context; // 0x2D0
		::MoleMole::UIBackFlowActivitySelectAvatarWidgetController* current; // 0x2D8
		::MoleMole::UIBackFlowActivitySelectAvatarWidgetController* serverSelect; // 0x2E0
		::System::Collections::Generic::List_1<::MoleMole::UIBackFlowActivitySelectAvatarWidgetController*>* allSelectItem; // 0x2E8
		::Class_2_79AE422BA06F6D26_163* pageView; // 0x2F0
		::System::String* LeftAni; // 0x2F8
		::System::String* RightAni; // 0x300
		::System::Int32 lastIndex; // 0x308
