...
#define MOLEMOLE_LIVEHOUSESCENEGAMEOBJECTDATADIC__CTOR_OFFSET UNITYSDK_OFFSET(0xCD5D970)

namespace MoleMole
{
	inline static constexpr unsigned int LiveHouseSceneGameObjectDataDic_TypeDefinitionIndex = 69065;
