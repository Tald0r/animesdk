...
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0xAA3A8E0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAA39A10)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_HIDEVIEW_OFFSET UNITYSDK_OFFSET(0xAA3B4D0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xAA39F80)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAA3A080)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_ONHUDUPDATE_OFFSET UNITYSDK_OFFSET(0xAA3B550)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAA3A120)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAA39A20)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAA39DD0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_SETTEAMMATEINDEX_OFFSET UNITYSDK_OFFSET(0xAA3B2A0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_SETUPENTITY_OFFSET UNITYSDK_OFFSET(0xAA3AB20)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAA3A1B0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER__BUILDDATABINDING_B__27_0_OFFSET UNITYSDK_OFFSET(0xAA3C030)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xAA3BFD0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAA3BE60)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER__SETUPFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xAA3AE60)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER__UPDATEFOLLOWANDVISIBLE_OFFSET UNITYSDK_OFFSET(0xAA3B6C0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER__UPDATESCALE_OFFSET UNITYSDK_OFFSET(0xAA3A220)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xAA3C4B0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAA3C510)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAA3C580)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAA3C590)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAA3C5A0)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xAA3C610)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___UPDATEFOLLOWANDVISIBLE_G____AUTOVISIBLE_34_1_OFFSET UNITYSDK_OFFSET(0xAA3BC10)
#define MOLEMOLE_UIINLEVELMPTEAMMATEINFOCHILDWINDOWCONTROLLER___UPDATEFOLLOWANDVISIBLE_G____ISPOINTVISIBLE_34_0_OFFSET UNITYSDK_OFFSET(0xAA3B9B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelMPTeammateInfoChildWindowController_TypeDefinitionIndex = 39138;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelMPTeammateInfoChildWindowController_TypeDefinitionIndex)->GetStaticField(0xCE70);
		}
		static ::System::Int32* StaticGet_ProgressShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelMPTeammateInfoChildWindowController_TypeDefinitionIndex)->GetStaticField(0xCE74);
		}
		static ::System::Int32* StaticGet_StartColorShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelMPTeammateInfoChildWindowController_TypeDefinitionIndex)->GetStaticField(0xCE78);
		}
		::Class_2_C5C76936C9D491E6* _view; // 0x308
