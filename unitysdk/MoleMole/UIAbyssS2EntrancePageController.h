...
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_CHECKTABCLICKWITHTIPS_OFFSET UNITYSDK_OFFSET(0xDEC4320)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_DELTABLEVELNEW_OFFSET UNITYSDK_OFFSET(0xDEC4390)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_DOTRIGGERNEWBIE_UNITASK_OFFSET UNITYSDK_OFFSET(0xDEC0430)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_GETDUTYNUM_OFFSET UNITYSDK_OFFSET(0xDEC2CB0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_GETFILLAMOUNTBYEXPRATIO_OFFSET UNITYSDK_OFFSET(0xDEC1EC0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_GETTABANIM_OFFSET UNITYSDK_OFFSET(0xDEC4A50)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_GETTABINDEX_OFFSET UNITYSDK_OFFSET(0xDEC40C0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_GETTABTYPE_OFFSET UNITYSDK_OFFSET(0xDEBDB00)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xDEBCBB0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDEBCBC0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_GOTOMAINCITY_OFFSET UNITYSDK_OFFSET(0xDEC3960)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_INITENTRANCE_OFFSET UNITYSDK_OFFSET(0xDEBD6F0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_INITSHOWGROUP_OFFSET UNITYSDK_OFFSET(0xDEBD920)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ISCLOSETORESETTIME_OFFSET UNITYSDK_OFFSET(0xDEC1660)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xDEC4130)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONCLICKTALENTHANDLE_OFFSET UNITYSDK_OFFSET(0xDEC3710)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONCLOSEBTNCLICK_OFFSET UNITYSDK_OFFSET(0xDEC3880)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONCOLLECTBTNCLICK_OFFSET UNITYSDK_OFFSET(0xDEC3E00)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEBCBD0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONINFOBTNCLICK_OFFSET UNITYSDK_OFFSET(0xDEC3670)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDEBFEA0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONLIMBOENTRANCECLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xDEBE920)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONLIMBOENTRANCE_OFFSET UNITYSDK_OFFSET(0xDEBE9A0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONMAINBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xDEC38F0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0xDEC00A0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONREWARDBTNCLICK_OFFSET UNITYSDK_OFFSET(0xDEC3BF0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONREWARDCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0xDEC2DC0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONREWARDMISSIONBTNCLICK_OFFSET UNITYSDK_OFFSET(0xDEC3AC0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONSHOWPLAYTEXTUREFRAME_OFFSET UNITYSDK_OFFSET(0xDEBDA40)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDEBF240)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONSTOREBTNCLICK_OFFSET UNITYSDK_OFFSET(0xDEC3D40)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONTOTALREWARDBTNCLICK_OFFSET UNITYSDK_OFFSET(0xDEC3F90)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEC3310)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEBCC70)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDEBDB70)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_PLAYBMFADEOUT_1_OFFSET UNITYSDK_OFFSET(0xDEC3540)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_PLAYBMFADEOUT_OFFSET UNITYSDK_OFFSET(0xDEC33B0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_PLAYPOINTSANIM_OFFSET UNITYSDK_OFFSET(0xDEC2D50)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_PLAYTABFADEINANIM_OFFSET UNITYSDK_OFFSET(0xDEC4DE0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_PLAYTABFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0xDEC4BE0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_REFRESHENTRANCESTATE_OFFSET UNITYSDK_OFFSET(0xDEBFDA0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_REFRESHENTRANCE_OFFSET UNITYSDK_OFFSET(0xDEBFA20)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_REFRESHSTORENEW_OFFSET UNITYSDK_OFFSET(0xDEC2E30)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_REFRESHTABANIM_OFFSET UNITYSDK_OFFSET(0xDEC4400)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xDEBF330)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_SELECTTAB_OFFSET UNITYSDK_OFFSET(0xDEBE200)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_SETASLASTTIMEVIEW_OFFSET UNITYSDK_OFFSET(0xDEC1A50)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_SETLASTVIEWANDPLAYANIM_UNITASK_OFFSET UNITYSDK_OFFSET(0xDEC18F0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_SETMAINQUESTREAD_OFFSET UNITYSDK_OFFSET(0xDEC3210)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_SHOWDOUBLESWITCHTIP_UNITASK_OFFSET UNITYSDK_OFFSET(0xDEC0940)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_SHOWENDTIMETIP_UNITASK_OFFSET UNITYSDK_OFFSET(0xDEC0B70)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_SHOWVERSIONUPDATEREMINDER_WITHUNITASK_OFFSET UNITYSDK_OFFSET(0xDEC1110)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_STOPSWITCHANIM_OFFSET UNITYSDK_OFFSET(0xDEC4930)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_STOPTABANIM_OFFSET UNITYSDK_OFFSET(0xDEC4FE0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_TRYPLAYANIM_OFFSET UNITYSDK_OFFSET(0xDEC1F60)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_TRYPLAYEXPANIM_OFFSET UNITYSDK_OFFSET(0xDEC2360)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_TRYPLAYPOINTANIM_OFFSET UNITYSDK_OFFSET(0xDEC2760)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_TRYPLAYPOINTLIMITANIM_OFFSET UNITYSDK_OFFSET(0xDEC29E0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_TRYSHOWENDANIMSANDEFFECTS_UNITASK_OFFSET UNITYSDK_OFFSET(0xDEC13B0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_TRYSHOWTIPSWITHUNITASK_OFFSET UNITYSDK_OFFSET(0xDEC0350)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xDEC52C0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDEC51A0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER__ONCOLLECTBTNCLICK_B__58_0_OFFSET UNITYSDK_OFFSET(0xDEC5720)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER__REFRESHSTORENEW_B__39_0_OFFSET UNITYSDK_OFFSET(0xDEC54E0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEC57A0)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDEC5810)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___BASE_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0xDEC5840)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDEC5850)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEC5860)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEC5870)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDEC5880)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2EntrancePageController_TypeDefinitionIndex = 80144;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::MoleMole::UIAbyssS2EntrancePageController_LevelTabStatus, ::Il2CppArray<::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(UIAbyssS2EntrancePageController_TypeDefinitionIndex)->GetStaticField(0x341D0);
		}
		...
		::Class_2_208CC9941471731A_221* currentAbyssGroup; // 0x378
		...
		::System::Void OnLimboEntranceClickHandle(::Class_2_208CC9941471731A_538* obj)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_538*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONLIMBOENTRANCECLICKHANDLE_OFFSET))(this, obj);
		}

		::System::Void OnLimboEntrance(::Class_2_208CC9941471731A_538* entranceConfig, ::System::Int32 questId)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_538*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER_ONLIMBOENTRANCE_OFFSET))(this, entranceConfig, questId);
		}
