...
#define MOLEMOLE_UICOOPMESSAGEITEMWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xD047460)
#define MOLEMOLE_UICOOPMESSAGEITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD046EF0)
#define MOLEMOLE_UICOOPMESSAGEITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD047070)
#define MOLEMOLE_UICOOPMESSAGEITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD046F90)
#define MOLEMOLE_UICOOPMESSAGEITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD046CD0)
#define MOLEMOLE_UICOOPMESSAGEITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD047200)
#define MOLEMOLE_UICOOPMESSAGEITEMWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xD0473D0)
#define MOLEMOLE_UICOOPMESSAGEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD047690)
#define MOLEMOLE_UICOOPMESSAGEITEMWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xD0476A0)
#define MOLEMOLE_UICOOPMESSAGEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD0476B0)
#define MOLEMOLE_UICOOPMESSAGEITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD047720)
#define MOLEMOLE_UICOOPMESSAGEITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD0477A0)
#define MOLEMOLE_UICOOPMESSAGEITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD047820)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopMessageItemWidgetController_TypeDefinitionIndex = 65086;
	...
	public:
		...
		::Class_2_208CC9941471731A_779* messageData; // 0x2D8
