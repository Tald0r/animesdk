...
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_GET__MODEL_OFFSET UNITYSDK_OFFSET(0xD569A80)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD569D70)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0xD569ED0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xD569E10)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD56A120)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONSWITCHCIRCLEMUTEMSGBTN_OFFSET UNITYSDK_OFFSET(0xD569B40)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONSWITCHFRIENDMUTEMSGBTN_OFFSET UNITYSDK_OFFSET(0xD569900)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD56A040)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD569600)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_SHOWCIRCLEUIELEMENT_OFFSET UNITYSDK_OFFSET(0xD56B640)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_SHOWCIRCLEUI_OFFSET UNITYSDK_OFFSET(0xD56AB10)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_SHOWEMPTY_OFFSET UNITYSDK_OFFSET(0xD56A360)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_SHOWFRIENDUIELEMENT_OFFSET UNITYSDK_OFFSET(0xD56B790)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_SHOWFRIENDUI_OFFSET UNITYSDK_OFFSET(0xD56A4C0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER_SHOWUSERDATA_OFFSET UNITYSDK_OFFSET(0xD56A410)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD56B860)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD56B870)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER___BASE_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0xD56B8E0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xD56B940)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD56B9B0)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD56BA30)
#define MOLEMOLE_UIFRIENDCHATITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD56BAB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatItemWidgetController_TypeDefinitionIndex = 47242;

	class UIFriendChatItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_82* _view; // 0x2D0
