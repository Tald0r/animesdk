...
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_EMPTYROWDATA_OFFSET UNITYSDK_OFFSET(0xAE23BD0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xAE23D60)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xAE23340)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xAE24060)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE23130)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_ROWDATA_OFFSET UNITYSDK_OFFSET(0xAE23C80)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE245C0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___BASE_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xAE245D0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___BASE_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xAE24600)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___BASE_INITVIEW_OFFSET UNITYSDK_OFFSET(0xAE24660)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE24670)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleResultPopWindowController_TypeDefinitionIndex = 75976;

	class UIMusicBattleResultPopWindowController : public ::MoleMole::UIHollowLayerResultPageV2PopWindowController
	{
	public:
		::MoleMole::UIHollowHollowLayerResultDialogContext* context; // 0x378
