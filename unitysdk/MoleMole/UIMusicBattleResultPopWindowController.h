...
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_EMPTYROWDATA_OFFSET UNITYSDK_OFFSET(0x98EB130)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x98EB2C0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x98EA8A0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x98EB5C0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98EA6A0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER_ROWDATA_OFFSET UNITYSDK_OFFSET(0x98EB1E0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98EBB20)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___BASE_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x98EBB30)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___BASE_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x98EBB60)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___BASE_INITVIEW_OFFSET UNITYSDK_OFFSET(0x98EBBC0)
#define MOLEMOLE_UIMUSICBATTLERESULTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98EBBD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleResultPopWindowController_TypeDefinitionIndex = 37098;
