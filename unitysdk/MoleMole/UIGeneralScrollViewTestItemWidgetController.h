...
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA29FA60)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA29FBE0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA29FB00)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA29F9C0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA29FD20)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA29FD30)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA29FDA0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA29FE20)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA29FEA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralScrollViewTestItemWidgetController_TypeDefinitionIndex = 62541;

	class UIGeneralScrollViewTestItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_D68EC59F0214DAC2_3* _view; // 0x2D0
		::UnityEngine::Color _color; // 0x2D8
