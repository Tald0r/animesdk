...
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0xCB07300)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigGalGameAvatarShowSettings_TypeDefinitionIndex = 59581;
