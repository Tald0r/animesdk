...
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0xEC4A180)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigGalGameAvatarShowSettings_TypeDefinitionIndex = 39966;
