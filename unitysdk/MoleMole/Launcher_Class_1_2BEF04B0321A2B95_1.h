...
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xF1B8080)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xF1B8140)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xF1B81A0)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xF1B8150)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xF1B8070)
#define MOLEMOLE_LAUNCHER_CLASS_1_2BEF04B0321A2B95_1__CTOR_OFFSET UNITYSDK_OFFSET(0xF1B8060)

namespace MoleMole
{
	inline static constexpr unsigned int Launcher_Class_1_2BEF04B0321A2B95_1_TypeDefinitionIndex = 51061;
