...
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB5F6430)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5F6440)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5F64B0)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB5F65B0)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB5F6680)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB5F68F0)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5F6900)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB5F6970)
#define MOLEMOLE_UIAUTOBATTLELINEUPPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB5F6980)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattleLineUpPageController_TypeDefinitionIndex = 53629;
