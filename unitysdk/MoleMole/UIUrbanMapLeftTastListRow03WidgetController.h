...
#define MOLEMOLE_UIURBANMAPLEFTTASTLISTROW03WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA7672D0)
#define MOLEMOLE_UIURBANMAPLEFTTASTLISTROW03WIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA767340)
#define MOLEMOLE_UIURBANMAPLEFTTASTLISTROW03WIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA767440)
#define MOLEMOLE_UIURBANMAPLEFTTASTLISTROW03WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA7675E0)
#define MOLEMOLE_UIURBANMAPLEFTTASTLISTROW03WIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA767610)
#define MOLEMOLE_UIURBANMAPLEFTTASTLISTROW03WIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA767680)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapLeftTastListRow03WidgetController_TypeDefinitionIndex = 76708;
