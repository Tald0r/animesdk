...
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0xADADDB0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___C__DISPLAYCLASS18_0__REFRESHEXP_B__0_OFFSET UNITYSDK_OFFSET(0xADADDC0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___C__DISPLAYCLASS18_0__REFRESHEXP_B__1_OFFSET UNITYSDK_OFFSET(0xADADE30)

namespace MoleMole
{
	inline static constexpr unsigned int UIAntiqueRewardPagePageController___c__DisplayClass18_0_TypeDefinitionIndex = 39576;
