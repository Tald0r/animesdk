...
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA515310)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___C__DISPLAYCLASS18_0__REFRESHEXP_B__0_OFFSET UNITYSDK_OFFSET(0xA515320)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___C__DISPLAYCLASS18_0__REFRESHEXP_B__1_OFFSET UNITYSDK_OFFSET(0xA515390)

namespace MoleMole
{
	inline static constexpr unsigned int UIAntiqueRewardPagePageController___c__DisplayClass18_0_TypeDefinitionIndex = 36573;
