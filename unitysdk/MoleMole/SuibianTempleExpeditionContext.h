...
#define MOLEMOLE_SUIBIANTEMPLEEXPEDITIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9855C70)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianTempleExpeditionContext_TypeDefinitionIndex = 81059;
