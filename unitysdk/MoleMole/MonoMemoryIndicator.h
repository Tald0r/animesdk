...
#define MOLEMOLE_MONOMEMORYINDICATOR_AWAKE_OFFSET UNITYSDK_OFFSET(0x6E426A0)
#define MOLEMOLE_MONOMEMORYINDICATOR_CHECKGENERALUI_OFFSET UNITYSDK_OFFSET(0x6E43550)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0x6E44C10)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x6E46E60)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x6E44FD0)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x6E438E0)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_5FAD56E9E208220A_OFFSET UNITYSDK_OFFSET(0x6E46010)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0x6E46090)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_C521AF86F7597260_OFFSET UNITYSDK_OFFSET(0x6E46F70)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_DCD9FE8382DA243A_OFFSET UNITYSDK_OFFSET(0x6E44B70)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x6E443E0)
#define MOLEMOLE_MONOMEMORYINDICATOR_METHOD_5_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x6E44200)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONANIMATIONCLIPBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E445F0)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONMATERIALBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E44660)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONMESHBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E44580)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONRENDERTEXTUREBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E44510)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONSTREAMASBCLICK_OFFSET UNITYSDK_OFFSET(0x6E446D0)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONTEXTUREBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E44370)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONTOTALBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E442F0)
#define MOLEMOLE_MONOMEMORYINDICATOR_ONUPLOADBTNCLICK_OFFSET UNITYSDK_OFFSET(0x6E44950)
#define MOLEMOLE_MONOMEMORYINDICATOR_RECORDMEMORY_OFFSET UNITYSDK_OFFSET(0x6E43C70)
#define MOLEMOLE_MONOMEMORYINDICATOR_RESETMAXMEMORY_OFFSET UNITYSDK_OFFSET(0x6E44740)
#define MOLEMOLE_MONOMEMORYINDICATOR_START_OFFSET UNITYSDK_OFFSET(0x6E43850)
#define MOLEMOLE_MONOMEMORYINDICATOR_TRACKCURMEM_OFFSET UNITYSDK_OFFSET(0x6E448B0)
#define MOLEMOLE_MONOMEMORYINDICATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x6E43AB0)
#define MOLEMOLE_MONOMEMORYINDICATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x6E44B30)
#define MOLEMOLE_MONOMEMORYINDICATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6E449B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMemoryIndicator_TypeDefinitionIndex = 70671;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(MonoMemoryIndicator_TypeDefinitionIndex)->GetStaticField(0x44C00);
		}
