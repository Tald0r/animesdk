...
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ATLEASTONETABUNLOCK_OFFSET UNITYSDK_OFFSET(0xDECAB90)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_BACKTOMAIN_OFFSET UNITYSDK_OFFSET(0xDECBA80)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0xDECA020)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GETTABID_OFFSET UNITYSDK_OFFSET(0xDECB1E0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GETTABNAME_OFFSET UNITYSDK_OFFSET(0xDECB090)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GETTABUNLOCKID_OFFSET UNITYSDK_OFFSET(0xDECB2D0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDEC9C40)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_HASTABCONTENT_OFFSET UNITYSDK_OFFSET(0xDECAC70)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ISTABUNLOCK_OFFSET UNITYSDK_OFFSET(0xDECAF30)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONCLICKTABBTN_OFFSET UNITYSDK_OFFSET(0xDECBBE0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEC9C50)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xDECB960)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xDECB4C0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xDECB5B0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xDECB6A0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDECA8E0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDECAAE0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEC9CF0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_SORTTAB_OFFSET UNITYSDK_OFFSET(0xDECA250)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDECC110)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDECC1C0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xDECC230)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xDECC2B0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xDECC320)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xDECC390)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDECC410)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDECC440)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDECC450)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivePropsPageController_TypeDefinitionIndex = 78804;

	class UIActivePropsPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_2* _view; // 0x2F8
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_176*>* iniItemTemplates; // 0x300
