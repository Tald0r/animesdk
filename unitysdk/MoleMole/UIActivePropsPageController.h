...
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ATLEASTONETABUNLOCK_OFFSET UNITYSDK_OFFSET(0xD3AE620)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_BACKTOMAIN_OFFSET UNITYSDK_OFFSET(0xD3AF520)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0xD3ADAC0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GETTABID_OFFSET UNITYSDK_OFFSET(0xD3AEC80)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GETTABNAME_OFFSET UNITYSDK_OFFSET(0xD3AEB30)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GETTABUNLOCKID_OFFSET UNITYSDK_OFFSET(0xD3AED70)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD3AD6D0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_HASTABCONTENT_OFFSET UNITYSDK_OFFSET(0xD3AE700)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ISTABUNLOCK_OFFSET UNITYSDK_OFFSET(0xD3AE9D0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONCLICKTABBTN_OFFSET UNITYSDK_OFFSET(0xD3AF680)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3AD6E0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD3AF400)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xD3AEF60)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xD3AF050)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD3AF140)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD3AE370)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3AE570)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3AD780)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER_SORTTAB_OFFSET UNITYSDK_OFFSET(0xD3ADCF0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD3AFBB0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3AFC60)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD3AFCD0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xD3AFD50)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xD3AFDC0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD3AFE30)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD3AFEB0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3AFEE0)
#define MOLEMOLE_UIACTIVEPROPSPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3AFEF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivePropsPageController_TypeDefinitionIndex = 40281;

	class UIActivePropsPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_41* _view; // 0x2F8
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_884*>* iniItemTemplates; // 0x300
		::System::Int32 _curSelect; // 0x308
		::MoleMole::UIActivePropsItemIconWidgetController* _lastSelectItemCtrl; // 0x310
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_2BEA9D62D0D61789*>* widgets; // 0x318
		::Class_1_2BEA9D62D0D61789* currentOpenWiget; // 0x320
		::System::Collections::Generic::List_1<::UnityEngine::UI::Extension::UITabButton*>* _tabButtons; // 0x328
		::System::Collections::Generic::List_1<::MoleMole::NotificationBadge*>* _tabNotificationBadges; // 0x330
