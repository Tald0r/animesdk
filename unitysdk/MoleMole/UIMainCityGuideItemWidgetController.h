...
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_GET_FULLSCREENRECTTRANS_OFFSET UNITYSDK_OFFSET(0x8F1E250)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_GET_ISSHOWGUIDE_OFFSET UNITYSDK_OFFSET(0x8F1E220)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x8F1E230)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_HIDEVIEW_OFFSET UNITYSDK_OFFSET(0x8F1EC10)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8F1E4E0)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_ONPARTNERIDCHANGE_OFFSET UNITYSDK_OFFSET(0x8F1F150)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8F1E580)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8F1E270)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_RESETVIEWSTATE_OFFSET UNITYSDK_OFFSET(0x8F1E660)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_SETPARTNERID_OFFSET UNITYSDK_OFFSET(0x8F1F0C0)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_SET_FULLSCREENRECTTRANS_OFFSET UNITYSDK_OFFSET(0x8F1E260)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x8F1E240)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_SHOWVIEW_OFFSET UNITYSDK_OFFSET(0x8F1EAD0)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x8F1E770)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F1F2F0)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER__HIDEVIEW_B__17_0_OFFSET UNITYSDK_OFFSET(0x8F1F330)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER__TICK_G___UPDATEPOS_14_0_OFFSET UNITYSDK_OFFSET(0x8F1ED00)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER__TICK_G___UPDATEROT_14_1_OFFSET UNITYSDK_OFFSET(0x8F1EEF0)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8F1F520)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8F1F590)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8F1F610)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityGuideItemWidgetController_TypeDefinitionIndex = 42698;
	...
	public:
		...
		::Class_2_AF3C04A72D227C5A* _view; // 0x2B0
		::System::Boolean _prvShowGuide; // 0x2B8
		::System::Int32 _partnerID; // 0x2BC
