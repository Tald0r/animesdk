...
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_GET_FULLSCREENRECTTRANS_OFFSET UNITYSDK_OFFSET(0xA80B760)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_GET_ISSHOWGUIDE_OFFSET UNITYSDK_OFFSET(0xA80B730)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xA80B740)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_HIDEVIEW_OFFSET UNITYSDK_OFFSET(0xA80C120)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA80B9F0)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_ONPARTNERIDCHANGE_OFFSET UNITYSDK_OFFSET(0xA80C660)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA80BA90)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA80B780)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_RESETVIEWSTATE_OFFSET UNITYSDK_OFFSET(0xA80BB70)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_SETPARTNERID_OFFSET UNITYSDK_OFFSET(0xA80C5D0)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_SET_FULLSCREENRECTTRANS_OFFSET UNITYSDK_OFFSET(0xA80B770)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xA80B750)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_SHOWVIEW_OFFSET UNITYSDK_OFFSET(0xA80BFE0)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xA80BC80)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA80C800)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER__HIDEVIEW_B__17_0_OFFSET UNITYSDK_OFFSET(0xA80C840)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER__TICK_G___UPDATEPOS_14_0_OFFSET UNITYSDK_OFFSET(0xA80C210)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER__TICK_G___UPDATEROT_14_1_OFFSET UNITYSDK_OFFSET(0xA80C400)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA80CA30)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA80CAA0)
#define MOLEMOLE_UIMAINCITYGUIDEITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA80CB20)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityGuideItemWidgetController_TypeDefinitionIndex = 37934;
