...
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_BINDDATA_OFFSET UNITYSDK_OFFSET(0xB5C6CC0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_CHECKVALID_OFFSET UNITYSDK_OFFSET(0xB5C7640)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_GET_ACTIVATEDCAMPS_OFFSET UNITYSDK_OFFSET(0xB5C6B50)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_GET_SHOPMODULE_OFFSET UNITYSDK_OFFSET(0xB5C6AA0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_GET_SHOPNAVLIST_OFFSET UNITYSDK_OFFSET(0xB5C6AC0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONCLICKLOCK_OFFSET UNITYSDK_OFFSET(0xB5C7CF0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONCLICKREFRESH_OFFSET UNITYSDK_OFFSET(0xB5C78F0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB5C66A0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0xB5C6850)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xB5C6500)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONITEMCLICK_OFFSET UNITYSDK_OFFSET(0xB5C80E0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB5C6320)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB5C6740)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB5C5CE0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB5C6270)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_SETREFRESHBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xB5C8170)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB5C8520)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB5C8600)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0xB5C8670)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xB5C86F0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB5C8750)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB5C87C0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB5C8840)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB5C88A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIABInLevelShopWidgetController_TypeDefinitionIndex = 61395;

	class UIABInLevelShopWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_A0FAD1BA1AF1830A* _view; // 0x2A0
		::Class_2_A0FAD1BA1AF1830A_Class_2_DEF0CB5A049F1801* _refreshView; // 0x2A8
		::Class_2_A0FAD1BA1AF1830A_Class_2_DEF0CB5A049F1801_1* _refreshViewConsole; // 0x2B0
		::Class_1_48D56DACBE4271BC* _syncHelper; // 0x2B8
		::Class_1_48D56DACBE4271BC* _syncHelper_rank; // 0x2C0
		::Class_1_F0E4E2848B1D52CE* _viewModel; // 0x2C8
		::System::Boolean _isInNewbie1; // 0x2D0
		::UnityEngine::Color _refreshNormal; // 0x2D4
		::MoleMole::UIAutoBattleEquipIconWidgetController* _freeEquipIcon; // 0x2E8
		::System::Collections::Generic::HashSet_1<::System::Int32>* SuggestIds; // 0x2F0
