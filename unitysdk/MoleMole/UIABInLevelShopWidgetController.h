...
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_BINDDATA_OFFSET UNITYSDK_OFFSET(0xC7FF7E0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_CHECKVALID_OFFSET UNITYSDK_OFFSET(0xC800140)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_GET_ACTIVATEDCAMPS_OFFSET UNITYSDK_OFFSET(0xC7FF660)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_GET_SHOPMODULE_OFFSET UNITYSDK_OFFSET(0xC7FF5B0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_GET_SHOPNAVLIST_OFFSET UNITYSDK_OFFSET(0xC7FF5D0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONCLICKLOCK_OFFSET UNITYSDK_OFFSET(0xC8007F0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONCLICKREFRESH_OFFSET UNITYSDK_OFFSET(0xC8003F0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC7FF1B0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0xC7FF360)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xC7FF010)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONITEMCLICK_OFFSET UNITYSDK_OFFSET(0xC800BF0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC7FEE30)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC7FF250)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC7FE7E0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC7FED80)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER_SETREFRESHBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xC800C80)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC801030)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC801110)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0xC801180)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xC801200)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC801260)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC8012D0)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC801350)
#define MOLEMOLE_UIABINLEVELSHOPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC8013B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIABInLevelShopWidgetController_TypeDefinitionIndex = 69296;

	class UIABInLevelShopWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_A0FAD1BA1AF1830A* _view; // 0x2A0
		::Class_2_A0FAD1BA1AF1830A_Class_2_DEF0CB5A049F1801_1* _refreshView; // 0x2A8
		::Class_2_A0FAD1BA1AF1830A_Class_2_DEF0CB5A049F1801* _refreshViewConsole; // 0x2B0
