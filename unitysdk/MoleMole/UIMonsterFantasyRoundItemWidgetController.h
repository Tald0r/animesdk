...
#define MOLEMOLE_UIMONSTERFANTASYROUNDITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC1498E0)
#define MOLEMOLE_UIMONSTERFANTASYROUNDITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC149A60)
#define MOLEMOLE_UIMONSTERFANTASYROUNDITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC149980)
#define MOLEMOLE_UIMONSTERFANTASYROUNDITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC149790)
#define MOLEMOLE_UIMONSTERFANTASYROUNDITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC149830)
#define MOLEMOLE_UIMONSTERFANTASYROUNDITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC149B40)
#define MOLEMOLE_UIMONSTERFANTASYROUNDITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC149B50)
#define MOLEMOLE_UIMONSTERFANTASYROUNDITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC149BC0)
#define MOLEMOLE_UIMONSTERFANTASYROUNDITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC149C40)
#define MOLEMOLE_UIMONSTERFANTASYROUNDITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC149CC0)
#define MOLEMOLE_UIMONSTERFANTASYROUNDITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC149D20)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyRoundItemWidgetController_TypeDefinitionIndex = 64813;

	class UIMonsterFantasyRoundItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_8127D35606966C67_33* _view; // 0x2D0
