...
#define MOLEMOLE_MONOCURVEMOVEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x6E3BAA0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCurveMoveObject_TypeDefinitionIndex = 42406;
