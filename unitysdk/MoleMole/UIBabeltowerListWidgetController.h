...
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0xC5F2380)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONBABELTOWERFLOORFINISHANIMATION_OFFSET UNITYSDK_OFFSET(0xC5F1A20)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC5F1260)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xC5F3090)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC5F13E0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONSHOWBABELTOWERUNLOCK_OFFSET UNITYSDK_OFFSET(0xC5F18F0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC5F1300)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC5F0F60)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC5F1110)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC5F1510)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_SETCLICKFUNC_OFFSET UNITYSDK_OFFSET(0xC5F3210)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_UPDATEFLOOR_OFFSET UNITYSDK_OFFSET(0xC5F26B0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER_UPDATEOFFSET_OFFSET UNITYSDK_OFFSET(0xC5F2D00)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC5F3280)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER__REFRESHNORMALVIEW_OFFSET UNITYSDK_OFFSET(0xC5F1D50)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC5F3480)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xC5F34F0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC5F3560)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC5F35E0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC5F3660)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC5F36C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerListWidgetController_TypeDefinitionIndex = 73150;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_170* _view; // 0x2D0
		::System::UInt32 currentFloor; // 0x2D8
		::System::Boolean isSpecial; // 0x2DC
		::Class_2_08E43914789BE5F3* model; // 0x2E0
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>* rankPic; // 0x2E8
		::System::Action_3<::System::UInt32, ::System::UInt32, ::System::Int32>* onClick; // 0x2F0
		::System::Int32 floorID; // 0x2F8
		::System::Int32 towerID; // 0x2FC
		::System::Boolean isUnlimitSymbol; // 0x300
