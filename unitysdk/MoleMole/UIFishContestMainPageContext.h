...
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8BF8EB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishContestMainPageContext_TypeDefinitionIndex = 46748;
