...
#define MOLEMOLE_MONOTOWERHOLDEROBJECT_GETALL_OFFSET UNITYSDK_OFFSET(0xA6541B0)
#define MOLEMOLE_MONOTOWERHOLDEROBJECT_HASTAG_OFFSET UNITYSDK_OFFSET(0xA654400)
#define MOLEMOLE_MONOTOWERHOLDEROBJECT_ISALLOWED_OFFSET UNITYSDK_OFFSET(0xA654310)
#define MOLEMOLE_MONOTOWERHOLDEROBJECT_METHOD_7_BB5BE9EEA0111E72_OFFSET UNITYSDK_OFFSET(0xA654640)
#define MOLEMOLE_MONOTOWERHOLDEROBJECT_POPTAG_OFFSET UNITYSDK_OFFSET(0xA654520)
#define MOLEMOLE_MONOTOWERHOLDEROBJECT_PUSHTAG_OFFSET UNITYSDK_OFFSET(0xA654480)
#define MOLEMOLE_MONOTOWERHOLDEROBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA6545A0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTowerHolderObject_TypeDefinitionIndex = 44308;
