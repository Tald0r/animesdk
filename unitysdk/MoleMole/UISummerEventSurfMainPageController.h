...
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_CLOSECOUNTUPTIMER_OFFSET UNITYSDK_OFFSET(0xA74CCE0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_CREATENAVMAPCONTROLLER_OFFSET UNITYSDK_OFFSET(0xA74BAB0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GETMETALPATH_OFFSET UNITYSDK_OFFSET(0xA74A9E0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_CAMERADELTA_OFFSET UNITYSDK_OFFSET(0xA74A350)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_DRIFT_OFFSET UNITYSDK_OFFSET(0xA74A0F0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_MOVE_OFFSET UNITYSDK_OFFSET(0xA74A2A0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_ONGOINGCONTROLLER_OFFSET UNITYSDK_OFFSET(0xA74A040)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_SLOWDOWN_OFFSET UNITYSDK_OFFSET(0xA74A0E0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_SPEEDUP_OFFSET UNITYSDK_OFFSET(0xA74A060)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0xA74A030)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA74A020)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA74B280)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONEXITGAME_OFFSET UNITYSDK_OFFSET(0xA74C930)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA74C360)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONLOGICINLEVELCAMERAMOVE_OFFSET UNITYSDK_OFFSET(0xA74C5D0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONOPERATECOUNTTIMERSTATE_OFFSET UNITYSDK_OFFSET(0xA74CA90)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONPERFORMNOTIFY_OFFSET UNITYSDK_OFFSET(0xA74BDB0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONRESTARTGAME_OFFSET UNITYSDK_OFFSET(0xA74C9E0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA74BF90)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA74B320)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_OPENCOUNTUPTIMERWIDGET_OFFSET UNITYSDK_OFFSET(0xA74CD70)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_PAUSEGAME_OFFSET UNITYSDK_OFFSET(0xA74C8A0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_PLAYEQUIPEFFECT_OFFSET UNITYSDK_OFFSET(0xA74A1B0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_PLAYFINISHTIP_OFFSET UNITYSDK_OFFSET(0xA74A470)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_PLAYSTARTTIP_OFFSET UNITYSDK_OFFSET(0xA74A360)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_SET_ENABLESKILL_OFFSET UNITYSDK_OFFSET(0xA74A220)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_SET_ONGOINGCONTROLLER_OFFSET UNITYSDK_OFFSET(0xA74A050)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_SET_SKILLRATIO_OFFSET UNITYSDK_OFFSET(0xA74A120)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_SHOWMISSIONTIPIFREFRESHMINIMALTIMECOST_OFFSET UNITYSDK_OFFSET(0xA74AD00)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_SHOWMISSION_OFFSET UNITYSDK_OFFSET(0xA74A570)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_UPDATESPEED_OFFSET UNITYSDK_OFFSET(0xA74C230)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA74C050)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA74CFC0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER__PLAYSTARTTIP_G__STARTGAME_42_0_OFFSET UNITYSDK_OFFSET(0xA74D020)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA74D0E0)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA74D150)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA74D180)
#define MOLEMOLE_UISUMMEREVENTSURFMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA74D190)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerEventSurfMainPageController_TypeDefinitionIndex = 65442;
