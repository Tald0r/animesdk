...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYFEVERANIM_D__55_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x38F920)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYFEVERANIM_D__55_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__PlayFeverAnim_d__55_TypeDefinitionIndex = 66313;
