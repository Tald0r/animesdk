...
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA2305C0)
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0xA230520)
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER_REGISTERONTRANSFORMCHILDRENCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xA2304B0)
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA230630)
#define MOLEMOLE_UIONTRANSFORMCHILDRENCHANGEDHANDLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA230650)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnTransformChildrenChangedHandler_TypeDefinitionIndex = 61500;
