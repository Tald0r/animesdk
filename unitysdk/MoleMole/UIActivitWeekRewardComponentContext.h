...
#define MOLEMOLE_UIACTIVITWEEKREWARDCOMPONENTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB8EC110)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitWeekRewardComponentContext_TypeDefinitionIndex = 47764;
