...
#define MOLEMOLE_UIACTIVITWEEKREWARDCOMPONENTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB95AA00)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitWeekRewardComponentContext_TypeDefinitionIndex = 77877;
