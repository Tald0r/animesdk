...
#define MOLEMOLE_CHECKMONSTERENTERBATTLESTATE_GETCURRENTENTERBATTLESTATE_OFFSET UNITYSDK_OFFSET(0xCD923A0)
#define MOLEMOLE_CHECKMONSTERENTERBATTLESTATE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xCD92230)
#define MOLEMOLE_CHECKMONSTERENTERBATTLESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD92420)
#define MOLEMOLE_CHECKMONSTERENTERBATTLESTATE___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xCD92460)

namespace MoleMole
{
	inline static constexpr unsigned int CheckMonsterEnterBattleState_TypeDefinitionIndex = 47343;
