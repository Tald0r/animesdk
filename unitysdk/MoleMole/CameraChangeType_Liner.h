...
#define MOLEMOLE_CAMERACHANGETYPE_LINER__CTOR_OFFSET UNITYSDK_OFFSET(0xCCE8FD0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraChangeType_Liner_TypeDefinitionIndex = 49283;
