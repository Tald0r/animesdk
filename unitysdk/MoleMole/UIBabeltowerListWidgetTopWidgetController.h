...
#define MOLEMOLE_UIBABELTOWERLISTWIDGETTOPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF0BD80)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETTOPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF0BE20)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETTOPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF0BC30)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETTOPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF0BCD0)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETTOPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF0BF00)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETTOPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF0BF10)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETTOPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF0BF80)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETTOPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF0C000)
#define MOLEMOLE_UIBABELTOWERLISTWIDGETTOPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF0C060)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerListWidgetTopWidgetController_TypeDefinitionIndex = 70291;

	class UIBabeltowerListWidgetTopWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_135* _view; // 0x2D0
