...
#define MOLEMOLE_DPIFACTORPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1750AC80)
#define MOLEMOLE_DPIFACTORPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1750AE00)
#define MOLEMOLE_DPIFACTORPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x1750AB70)
#define MOLEMOLE_DPIFACTORPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1750AD60)
#define MOLEMOLE_DPIFACTORPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x1750AB60)
#define MOLEMOLE_DPIFACTORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1750AF60)
#define MOLEMOLE_DPIFACTORPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1750AFF0)
#define MOLEMOLE_DPIFACTORPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1750B060)
#define MOLEMOLE_DPIFACTORPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1750B0D0)

namespace MoleMole
{
	inline static constexpr unsigned int DpiFactorProfile_TypeDefinitionIndex = 40906;
