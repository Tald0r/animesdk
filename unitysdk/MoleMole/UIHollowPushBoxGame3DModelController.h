...
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_GETREFRT_OFFSET UNITYSDK_OFFSET(0xAA2B460)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_GET_ATMASTERPOS_OFFSET UNITYSDK_OFFSET(0xAA2AE00)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_GET_CHESSBOARDINDEX_OFFSET UNITYSDK_OFFSET(0xAA2AE20)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_GET_CHESSBOARD_OFFSET UNITYSDK_OFFSET(0xAA2AE40)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_GET_ISMOVEACTION_OFFSET UNITYSDK_OFFSET(0xAA2C2D0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_GET_SECTIONUID_OFFSET UNITYSDK_OFFSET(0xAA2ADE0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_INITCHESSBOARD_OFFSET UNITYSDK_OFFSET(0xAA2A330)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAA2C8F0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONFINISHGRAPH_OFFSET UNITYSDK_OFFSET(0xAA2C250)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONHOLLOWGRIDUPDATE_OFFSET UNITYSDK_OFFSET(0xAA2B5B0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONHOLLOWPUSHBACK_OFFSET UNITYSDK_OFFSET(0xAA2AFA0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONNPCUPDATE_OFFSET UNITYSDK_OFFSET(0xAA2B6A0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAA2C990)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAA2C2E0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAA2C690)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_PLAYFULLSCREENTEXTURE_OFFSET UNITYSDK_OFFSET(0xAA2C860)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_REFRESHPLAYERAPPEARANCE_OFFSET UNITYSDK_OFFSET(0xAA2B4D0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_REFRESHPLAYERPOS_OFFSET UNITYSDK_OFFSET(0xAA2B350)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_SETGAMERT_OFFSET UNITYSDK_OFFSET(0xAA2B3C0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_SETLASTMOVE_OFFSET UNITYSDK_OFFSET(0xAA2C1D0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_SET_ATMASTERPOS_OFFSET UNITYSDK_OFFSET(0xAA2AE10)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_SET_CHESSBOARDINDEX_OFFSET UNITYSDK_OFFSET(0xAA2AE30)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_SET_ISMOVEACTION_OFFSET UNITYSDK_OFFSET(0xAA2C2C0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_SET_SECTIONUID_OFFSET UNITYSDK_OFFSET(0xAA2ADF0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAA2AE50)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xAA2CC80)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAA2CC10)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER__ONNPCUPDATE_G____ISBALLNPC_27_0_OFFSET UNITYSDK_OFFSET(0xAA2C130)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAA2CD70)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAA2CDE0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAA2CDF0)
#define MOLEMOLE_UIHOLLOWPUSHBOXGAME3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAA2CE00)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowPushBoxGame3DModelController_TypeDefinitionIndex = 47831;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(UIHollowPushBoxGame3DModelController_TypeDefinitionIndex)->GetStaticField(0x34AA0);
		}
