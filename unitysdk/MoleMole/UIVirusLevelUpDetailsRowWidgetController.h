...
#define MOLEMOLE_UIVIRUSLEVELUPDETAILSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x71E44C0)
#define MOLEMOLE_UIVIRUSLEVELUPDETAILSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x71E4560)
#define MOLEMOLE_UIVIRUSLEVELUPDETAILSROWWIDGETCONTROLLER_REFRESHWIDGET_OFFSET UNITYSDK_OFFSET(0x71E4640)
#define MOLEMOLE_UIVIRUSLEVELUPDETAILSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x71E4E00)
#define MOLEMOLE_UIVIRUSLEVELUPDETAILSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x71E4E30)
#define MOLEMOLE_UIVIRUSLEVELUPDETAILSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x71E4EA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusLevelUpDetailsRowWidgetController_TypeDefinitionIndex = 48454;
