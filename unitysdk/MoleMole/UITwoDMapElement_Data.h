...
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GETICONSIZE_OFFSET UNITYSDK_OFFSET(0x9538C60)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_FORCEACTIVE_OFFSET UNITYSDK_OFFSET(0x9538C40)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_GETFORCEACTIVE_OFFSET UNITYSDK_OFFSET(0x9538C30)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x9538D10)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_ONDRAG_OFFSET UNITYSDK_OFFSET(0x9538D30)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x9538D50)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x9538CF0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_ONUPDATEELEMENTSIZE_OFFSET UNITYSDK_OFFSET(0x9538CD0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_SET_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x9538D20)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_SET_ONDRAG_OFFSET UNITYSDK_OFFSET(0x9538D40)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_SET_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x9538D60)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_SET_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x9538D00)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_SET_ONUPDATEELEMENTSIZE_OFFSET UNITYSDK_OFFSET(0x9538CE0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9538C50)

namespace MoleMole
{
	inline static constexpr unsigned int UITwoDMapElement_Data_TypeDefinitionIndex = 58357;

	class UITwoDMapElement_Data : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_0_16E4307DCC419505_192* _posProvider; // 0x28
		::UnityEngine::UI::Extension::UIImgEventTrigger_ScrollCallback* _OnScroll_k__BackingField; // 0x30
		::System::Action_2<::MoleMole::UITwoDMapElement_Data*, ::UnityEngine::Vector2>* _OnUpdateElementSize_k__BackingField; // 0x38
		...
		::System::Void _ctor(::Class_0_16E4307DCC419505_192* posProvider)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_192*))((::PBYTE)hIl2Cpp + MOLEMOLE_UITWODMAPELEMENT_DATA__CTOR_OFFSET))(this, posProvider);
		}
