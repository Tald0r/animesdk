...
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GETICONSIZE_OFFSET UNITYSDK_OFFSET(0x9387CA0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_FORCEACTIVE_OFFSET UNITYSDK_OFFSET(0x9387C80)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_GETFORCEACTIVE_OFFSET UNITYSDK_OFFSET(0x9387C70)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x9387D50)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_ONDRAG_OFFSET UNITYSDK_OFFSET(0x9387D70)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x9387D90)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x9387D30)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_GET_ONUPDATEELEMENTSIZE_OFFSET UNITYSDK_OFFSET(0x9387D10)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_SET_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x9387D60)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_SET_ONDRAG_OFFSET UNITYSDK_OFFSET(0x9387D80)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_SET_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x9387DA0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_SET_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x9387D40)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_SET_ONUPDATEELEMENTSIZE_OFFSET UNITYSDK_OFFSET(0x9387D20)
#define MOLEMOLE_UITWODMAPELEMENT_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9387C90)

namespace MoleMole
{
	inline static constexpr unsigned int UITwoDMapElement_Data_TypeDefinitionIndex = 67600;
	...
	public:
		...
		::Class_0_16E4307DCC419505_355* _posProvider; // 0x38
		::System::Action_1<::UnityEngine::EventSystems::PointerEventData*>* _OnDrag_k__BackingField; // 0x40
		...
		::System::Void _ctor(::Class_0_16E4307DCC419505_355* posProvider)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_355*))((::PBYTE)hIl2Cpp + MOLEMOLE_UITWODMAPELEMENT_DATA__CTOR_OFFSET))(this, posProvider);
		}
