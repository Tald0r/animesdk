...
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEWIDGETCONTROLLER___C__DISPLAYCLASS26_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD0EB500)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEWIDGETCONTROLLER___C__DISPLAYCLASS26_0__ONGAMESETTLED_B__0_OFFSET UNITYSDK_OFFSET(0xD0EB510)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEWIDGETCONTROLLER___C__DISPLAYCLASS26_0__ONGAMESETTLED_B__1_OFFSET UNITYSDK_OFFSET(0xD0EB540)

namespace MoleMole::MiniUIGame::BezierCurve
{
	inline static constexpr unsigned int UIBezierCurveGameWidgetController___c__DisplayClass26_0_TypeDefinitionIndex = 39216;
