...
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_ADDCOLLIDER_OFFSET UNITYSDK_OFFSET(0x67AD230)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_GETANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x67AD110)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_GET_POINTTYPE_OFFSET UNITYSDK_OFFSET(0x67AD3B0)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x67ACF00)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x67AD0B0)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER_SETANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x67AD1A0)
#define MOLEMOLE_MINIUIGAME_BEZIERCURVE_UIBEZIERCURVEGAMEPOINTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x67AD3C0)

namespace MoleMole::MiniUIGame::BezierCurve
{
	inline static constexpr unsigned int UIBezierCurveGamePointWidgetController_TypeDefinitionIndex = 51639;

	class UIBezierCurveGamePointWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::UnityEngine::RectTransform* _rect; // 0x2A0
		::MoleMole::MiniUIGame::BezierCurve::UIInLevelBezierCurveGameWidgetController* _inLevelWidget; // 0x2A8
