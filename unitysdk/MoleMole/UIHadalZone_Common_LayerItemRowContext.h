...
#define MOLEMOLE_UIHADALZONE_COMMON_LAYERITEMROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA9B4510)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_Common_LayerItemRowContext_TypeDefinitionIndex = 40925;
