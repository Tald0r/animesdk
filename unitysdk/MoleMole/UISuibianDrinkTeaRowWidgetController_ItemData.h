...
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ITEMDATA_ISCANFINISH_OFFSET UNITYSDK_OFFSET(0xAB8B430)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ITEMDATA_ONCEORDERSORTMETHOD_OFFSET UNITYSDK_OFFSET(0xAB8B6D0)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ITEMDATA_REFRESHORDERREDSIGNBYDATA_OFFSET UNITYSDK_OFFSET(0xAB8B3D0)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ITEMDATA_REPEATORDERSORTMETHOD_OFFSET UNITYSDK_OFFSET(0xAB8B7D0)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ITEMDATA_SETORDERDATA_OFFSET UNITYSDK_OFFSET(0xAB8AA30)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ITEMDATA_SETPERREWARDITEM_OFFSET UNITYSDK_OFFSET(0xAB8B2E0)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ITEMDATA_SETREPEATREWARDLIST_OFFSET UNITYSDK_OFFSET(0xAB8AD90)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAB8B890)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianDrinkTeaRowWidgetController_ItemData_TypeDefinitionIndex = 78527;

	class UISuibianDrinkTeaRowWidgetController_ItemData : public ::System::Object
	{
	public:
		::System::String* Description; // 0x10
		::System::Collections::Generic::List_1<::System::Int32>* NeedItemIdList; // 0x18
		::System::String* TargetDescription; // 0x20
		::System::Collections::Generic::List_1<::Class_1_C4CB11A2FD957208_Struct_2_98E057419FFAAB00>* RewardList; // 0x28
		::System::Collections::Generic::List_1<::System::Int32>* NeedItemCountList; // 0x30
		::System::String* Title; // 0x38
		::System::Int32 OrderType; // 0x40
		::System::Int32 Slot; // 0x44
		::System::Int32 Id; // 0x48
		::System::Int32 OrderClientId; // 0x4C
		::System::Int32 BigRewardTipsId; // 0x50
		::System::Boolean IsOnce; // 0x54
		::System::Boolean IsFinish; // 0x55
		::System::Boolean IsTask; // 0x56
		::System::Boolean IsNew; // 0x57
		::System::Int32 RewardCoinId; // 0x58
		::System::Int32 PrefixTitleId; // 0x5C
