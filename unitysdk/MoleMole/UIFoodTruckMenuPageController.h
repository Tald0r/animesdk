...
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_GETACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0xB2D8F70)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB2D89B0)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_ONCLOSECLICK_OFFSET UNITYSDK_OFFSET(0xB2DA3E0)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB2D8AB0)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_ONOKBTNCLICK_LOGIC_OFFSET UNITYSDK_OFFSET(0xB2DA5F0)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_ONOKBTNCLICK_OFFSET UNITYSDK_OFFSET(0xB2DA580)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0xB2DA320)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB2DA100)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2D8EE0)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB2D8B50)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB2D90F0)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_REFRESHORDER_OFFSET UNITYSDK_OFFSET(0xB2D9830)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xB2D89C0)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB2DA290)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB2DB330)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB2DB470)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB2DB4E0)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2DB4F0)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB2DB500)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB2DB510)
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xB2DB520)

namespace MoleMole
{
	inline static constexpr unsigned int UIFoodTruckMenuPageController_TypeDefinitionIndex = 71380;
	...
	public:
		...
		::Class_2_1CC0E2699D5FB1A6_10* _view; // 0x328
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_156*>* _dishList; // 0x330
		::System::Collections::Generic::List_1<::Class_2_1CC0E2699D5FB1A6_10_Class_2_EE8E92A941149506_6*>* _tagWidgetList; // 0x338
		::System::Int32 CurrentSelectIndex; // 0x340
		::System::Boolean Erroring; // 0x344
		::Class_3_32287D2997141DD8_3* _log; // 0x348
