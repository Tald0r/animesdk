...
#define MOLEMOLE_UIMAINCITYMENUSCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x68BE730)
#define MOLEMOLE_UIMAINCITYMENUSCONTEXT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x68BE740)
#define MOLEMOLE_UIMAINCITYMENUSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x68BE720)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMenusContext_TypeDefinitionIndex = 55960;
