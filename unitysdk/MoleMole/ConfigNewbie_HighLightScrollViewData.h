...
#define MOLEMOLE_CONFIGNEWBIE_HIGHLIGHTSCROLLVIEWDATA_GET_DATATYPE_OFFSET UNITYSDK_OFFSET(0xB482880)
#define MOLEMOLE_CONFIGNEWBIE_HIGHLIGHTSCROLLVIEWDATA_LOADFROMBYTES_OFFSET UNITYSDK_OFFSET(0xB482890)
#define MOLEMOLE_CONFIGNEWBIE_HIGHLIGHTSCROLLVIEWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB4829E0)
#define MOLEMOLE_CONFIGNEWBIE_HIGHLIGHTSCROLLVIEWDATA___BASE_LOADFROMBYTES_OFFSET UNITYSDK_OFFSET(0xB4829F0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigNewbie_HighLightScrollViewData_TypeDefinitionIndex = 73607;
