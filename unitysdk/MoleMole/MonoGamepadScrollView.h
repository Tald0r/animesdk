...
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_GETITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xD812F80)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_GET_SELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0xD8118E0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_ISTEMPWORKABLE_OFFSET UNITYSDK_OFFSET(0xD8119B0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_1293CB739F1151A1_OFFSET UNITYSDK_OFFSET(0xD813B10)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_542BC40870A64D2F_OFFSET UNITYSDK_OFFSET(0xD811AA0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_60AE49475362F13D_OFFSET UNITYSDK_OFFSET(0xD813860)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_6D7CB3E6CB4A7728_OFFSET UNITYSDK_OFFSET(0xD812B10)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_6E6682ED9FD6F719_OFFSET UNITYSDK_OFFSET(0xD812C50)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_7F7EAC60E1D93F7A_OFFSET UNITYSDK_OFFSET(0xD8128B0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_7F890042F480F391_OFFSET UNITYSDK_OFFSET(0xD8129D0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xD813A70)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_84516C3E776F194F_OFFSET UNITYSDK_OFFSET(0xD811F60)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_8BCB3191E6BEE7CB_OFFSET UNITYSDK_OFFSET(0xD812A90)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xD8118F0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_C9C55AB49F92AAA3_OFFSET UNITYSDK_OFFSET(0xD8135C0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xD813AA0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD813320)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_METHOD_6_E312062E144DB3CE_OFFSET UNITYSDK_OFFSET(0xD813390)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW_SELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD812DB0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD813010)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW___BASE_ISTEMPWORKABLE_OFFSET UNITYSDK_OFFSET(0xD813130)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW___BASE_ISWORKABLEINNER_OFFSET UNITYSDK_OFFSET(0xD813190)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD8131F0)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW___BASE_ONMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xD813280)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW___BASE_ONMODULELATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD813290)
#define MOLEMOLE_MONOGAMEPADSCROLLVIEW___BASE_ONMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xD813310)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadScrollView_TypeDefinitionIndex = 75183;
