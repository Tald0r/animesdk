...
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___C__DISPLAYCLASS22_1__CTOR_OFFSET UNITYSDK_OFFSET(0x897E2B0)
#define MOLEMOLE_UIMINISCAPEMAINPAGECONTROLLER___C__DISPLAYCLASS22_1__DOPLAYPROGRESSANIM_B__0_OFFSET UNITYSDK_OFFSET(0x897E2C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeMainPageController___c__DisplayClass22_1_TypeDefinitionIndex = 55556;
