...
#define MOLEMOLE_CONFIGTEXTURESHEET_GETFORMATTOSERIALIZEAS_OFFSET UNITYSDK_OFFSET(0xF18A680)
#define MOLEMOLE_CONFIGTEXTURESHEET_GETTEXTURECONFIGFOLDER_OFFSET UNITYSDK_OFFSET(0xF18A910)
#define MOLEMOLE_CONFIGTEXTURESHEET_GETTEXTURECONFIGPATH_OFFSET UNITYSDK_OFFSET(0xF18A770)
#define MOLEMOLE_CONFIGTEXTURESHEET__CTOR_OFFSET UNITYSDK_OFFSET(0xF18AAB0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTextureSheet_TypeDefinitionIndex = 73663;
