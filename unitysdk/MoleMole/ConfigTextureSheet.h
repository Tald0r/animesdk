...
#define MOLEMOLE_CONFIGTEXTURESHEET_GETFORMATTOSERIALIZEAS_OFFSET UNITYSDK_OFFSET(0xEC6AD80)
#define MOLEMOLE_CONFIGTEXTURESHEET_GETTEXTURECONFIGFOLDER_OFFSET UNITYSDK_OFFSET(0xEC6B010)
#define MOLEMOLE_CONFIGTEXTURESHEET_GETTEXTURECONFIGPATH_OFFSET UNITYSDK_OFFSET(0xEC6AE70)
#define MOLEMOLE_CONFIGTEXTURESHEET__CTOR_OFFSET UNITYSDK_OFFSET(0xEC6B1B0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTextureSheet_TypeDefinitionIndex = 64057;
