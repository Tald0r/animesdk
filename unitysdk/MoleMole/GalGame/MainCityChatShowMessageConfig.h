...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GETNEXTSHOW_OFFSET UNITYSDK_OFFSET(0xD0E2940)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_ANIMATIONID_OFFSET UNITYSDK_OFFSET(0xD0E2FB0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_CAMERA1POS_OFFSET UNITYSDK_OFFSET(0xD0E3100)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_CAMERA2POS_OFFSET UNITYSDK_OFFSET(0xD0E3180)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_CAMERARELAAVATAR_OFFSET UNITYSDK_OFFSET(0xD0E33C0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_CAMERARELANPCID_OFFSET UNITYSDK_OFFSET(0xD0E33B0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_FOVANDBLEND_OFFSET UNITYSDK_OFFSET(0xD0E3190)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_FOV_OFFSET UNITYSDK_OFFSET(0xD0E3210)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_NOISEDURATION_OFFSET UNITYSDK_OFFSET(0xD0E32D0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_NOISE_OFFSET UNITYSDK_OFFSET(0xD0E3220)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_OVERRIDECAMERANEARCLIP_OFFSET UNITYSDK_OFFSET(0xD0E3340)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_UICTRL_OFFSET UNITYSDK_OFFSET(0xD0E2930)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_ONOPEN_OFFSET UNITYSDK_OFFSET(0xD0E2B30)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD0E33D0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowMessageConfig_TypeDefinitionIndex = 68869;
	...
	public:
		...
		{
			return ((::Enum_3_340DE32BA097F66C(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGECONFIG_GET_UICTRL_OFFSET))(this);
		}
