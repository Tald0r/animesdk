...
#define MOLEMOLE_GALGAME_GALGAMEPICTUREDISPLAYACTION_GALGAMEPICTUREDISPLAYACTION_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x6AF9E10)
#define MOLEMOLE_GALGAME_GALGAMEPICTUREDISPLAYACTION_GALGAMEPICTUREDISPLAYACTION_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x6AF9E20)
#define MOLEMOLE_GALGAME_GALGAMEPICTUREDISPLAYACTION_GALGAMEPICTUREDISPLAYACTION_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x6AF9F70)
#define MOLEMOLE_GALGAME_GALGAMEPICTUREDISPLAYACTION_GALGAMEPICTUREDISPLAYACTION_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x6AFA0D0)
#define MOLEMOLE_GALGAME_GALGAMEPICTUREDISPLAYACTION_GALGAMEPICTUREDISPLAYACTION_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x6AFA090)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalGamePictureDisplayAction_GalGamePictureDisplayAction_UnityGeneratedFormatter_TypeDefinitionIndex = 78167;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(GalGamePictureDisplayAction_GalGamePictureDisplayAction_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x32200);
		}
