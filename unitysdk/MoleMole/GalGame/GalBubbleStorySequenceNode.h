...
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_GETDURATIONINSECEXCEPTCOMMONDELAY_OFFSET UNITYSDK_OFFSET(0x6E8D8E0)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E8D860)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalBubbleStorySequenceNode_TypeDefinitionIndex = 70208;
