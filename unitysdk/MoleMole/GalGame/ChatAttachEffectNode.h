...
#define MOLEMOLE_GALGAME_CHATATTACHEFFECTNODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0xBA13AA0)
#define MOLEMOLE_GALGAME_CHATATTACHEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xBA13A90)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int ChatAttachEffectNode_TypeDefinitionIndex = 71544;
