...
#define MOLEMOLE_GALGAME_MAINCITYCHATEDITORLIVEHOUSEFANSUPNODE_MAINCITYCHATEDITORLIVEHOUSEFANSUPNODE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x82D6980)
#define MOLEMOLE_GALGAME_MAINCITYCHATEDITORLIVEHOUSEFANSUPNODE_MAINCITYCHATEDITORLIVEHOUSEFANSUPNODE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x82D6990)
#define MOLEMOLE_GALGAME_MAINCITYCHATEDITORLIVEHOUSEFANSUPNODE_MAINCITYCHATEDITORLIVEHOUSEFANSUPNODE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x82D6C50)
#define MOLEMOLE_GALGAME_MAINCITYCHATEDITORLIVEHOUSEFANSUPNODE_MAINCITYCHATEDITORLIVEHOUSEFANSUPNODE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x82D6E60)
#define MOLEMOLE_GALGAME_MAINCITYCHATEDITORLIVEHOUSEFANSUPNODE_MAINCITYCHATEDITORLIVEHOUSEFANSUPNODE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x82D6E20)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatEditorLiveHouseFansUpNode_MainCityChatEditorLiveHouseFansUpNode_UnityGeneratedFormatter_TypeDefinitionIndex = 75283;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatEditorLiveHouseFansUpNode_MainCityChatEditorLiveHouseFansUpNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3C0A0);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Int32>** StaticGet_CachedSerializer2()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatEditorLiveHouseFansUpNode_MainCityChatEditorLiveHouseFansUpNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3C0A8);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatPlayableNodeType>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatPlayableNodeType>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatEditorLiveHouseFansUpNode_MainCityChatEditorLiveHouseFansUpNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3C0B0);
		}
