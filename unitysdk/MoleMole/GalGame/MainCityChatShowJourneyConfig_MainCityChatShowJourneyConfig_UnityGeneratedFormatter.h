...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xB194270)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xB194280)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xB194480)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xB194640)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB194600)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowJourneyConfig_MainCityChatShowJourneyConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 40670;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatShowJourneyConfig_MainCityChatShowJourneyConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3D340);
		}
