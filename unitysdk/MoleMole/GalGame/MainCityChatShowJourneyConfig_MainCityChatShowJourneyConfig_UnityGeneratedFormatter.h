...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x8B0F4E0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x8B0F4F0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x8B0F6F0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8B0F8B0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_MAINCITYCHATSHOWJOURNEYCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x8B0F870)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowJourneyConfig_MainCityChatShowJourneyConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 63836;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatShowJourneyConfig_MainCityChatShowJourneyConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3A5D0);
		}
