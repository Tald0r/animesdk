...
#define MOLEMOLE_GALGAME_GALSWITCHSCENEGROUPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9CF240)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalSwitchSceneGroupNode_TypeDefinitionIndex = 63437;
