...
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMFIXED_GENERATECAMERAFUNC_OFFSET UNITYSDK_OFFSET(0xC221C50)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMFIXED__CTOR_OFFSET UNITYSDK_OFFSET(0xC221D00)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMFIXED__GENERATECAMERAFUNC_B__3_0_OFFSET UNITYSDK_OFFSET(0xC221D10)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatCameraParamFixed_TypeDefinitionIndex = 39365;
