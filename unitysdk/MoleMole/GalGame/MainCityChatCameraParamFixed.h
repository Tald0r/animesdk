...
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMFIXED_GENERATECAMERAFUNC_OFFSET UNITYSDK_OFFSET(0xB8383C0)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMFIXED__CTOR_OFFSET UNITYSDK_OFFSET(0xB838470)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMFIXED__GENERATECAMERAFUNC_B__3_0_OFFSET UNITYSDK_OFFSET(0xB838480)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatCameraParamFixed_TypeDefinitionIndex = 66026;
