...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_GETOUTPUTNAME_OFFSET UNITYSDK_OFFSET(0x8B0F9A0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_GET_OUTPUTCOUNT_OFFSET UNITYSDK_OFFSET(0x8B0FA70)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONAFTERTRANSITION_OFFSET UNITYSDK_OFFSET(0x8B0FA80)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8B0FB10)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowUIConfig_TypeDefinitionIndex = 45509;
