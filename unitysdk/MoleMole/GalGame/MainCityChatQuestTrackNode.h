...
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKNODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x9911D50)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x9911D40)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatQuestTrackNode_TypeDefinitionIndex = 56978;
