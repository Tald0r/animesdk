...
#define MOLEMOLE_GALGAME_MAINCITYCHATBRANCHNODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0xE105380)
#define MOLEMOLE_GALGAME_MAINCITYCHATBRANCHNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE105370)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatBranchNode_TypeDefinitionIndex = 40903;
