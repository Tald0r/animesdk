...
#define MOLEMOLE_GALGAME_MAINCITYCHATNPCACTIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xE483550)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatNPCActionBase_TypeDefinitionIndex = 45338;
