...
#define MOLEMOLE_GALGAME_MAINCITYCHATNPCACTIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xD80B580)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatNPCActionBase_TypeDefinitionIndex = 61743;
