...
#define MOLEMOLE_GALGAME_CHATCHANGEEFFECTSTATENODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0xA38FC40)
#define MOLEMOLE_GALGAME_CHATCHANGEEFFECTSTATENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA38FC30)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int ChatChangeEffectStateNode_TypeDefinitionIndex = 76436;
