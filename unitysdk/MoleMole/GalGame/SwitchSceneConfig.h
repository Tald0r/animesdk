...
#define MOLEMOLE_GALGAME_SWITCHSCENECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC2238D0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int SwitchSceneConfig_TypeDefinitionIndex = 69336;
