...
#define MOLEMOLE_GALGAME_MAINCITYCHATBEGINUIGAMECONFIG___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9910CB0)
#define MOLEMOLE_GALGAME_MAINCITYCHATBEGINUIGAMECONFIG___C__DISPLAYCLASS9_0__ONAFTERTRANSITION_B__0_OFFSET UNITYSDK_OFFSET(0x9910CC0)
#define MOLEMOLE_GALGAME_MAINCITYCHATBEGINUIGAMECONFIG___C__DISPLAYCLASS9_0__ONAFTERTRANSITION_B__1_OFFSET UNITYSDK_OFFSET(0x9910DA0)
#define MOLEMOLE_GALGAME_MAINCITYCHATBEGINUIGAMECONFIG___C__DISPLAYCLASS9_0__ONAFTERTRANSITION_B__2_OFFSET UNITYSDK_OFFSET(0x9910F00)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatBeginUIGameConfig___c__DisplayClass9_0_TypeDefinitionIndex = 54610;
