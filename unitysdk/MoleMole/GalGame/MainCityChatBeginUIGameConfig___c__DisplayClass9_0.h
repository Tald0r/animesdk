...
#define MOLEMOLE_GALGAME_MAINCITYCHATBEGINUIGAMECONFIG___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA50BCE0)
#define MOLEMOLE_GALGAME_MAINCITYCHATBEGINUIGAMECONFIG___C__DISPLAYCLASS9_0__ONAFTERTRANSITION_B__0_OFFSET UNITYSDK_OFFSET(0xA50BCF0)
#define MOLEMOLE_GALGAME_MAINCITYCHATBEGINUIGAMECONFIG___C__DISPLAYCLASS9_0__ONAFTERTRANSITION_B__1_OFFSET UNITYSDK_OFFSET(0xA50BDD0)
#define MOLEMOLE_GALGAME_MAINCITYCHATBEGINUIGAMECONFIG___C__DISPLAYCLASS9_0__ONAFTERTRANSITION_B__2_OFFSET UNITYSDK_OFFSET(0xA50BF30)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatBeginUIGameConfig___c__DisplayClass9_0_TypeDefinitionIndex = 59002;

	class MainCityChatBeginUIGameConfig___c__DisplayClass9_0 : public ::System::Object
	{
	public:
		::System::Action* action; // 0x10
		::System::Action_1<::Class_1_FC3A9C07FC781527_Enum_3_6E0E8267CDDC65CF>* __9__2; // 0x18
