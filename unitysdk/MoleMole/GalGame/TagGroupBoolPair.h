...
#define MOLEMOLE_GALGAME_TAGGROUPBOOLPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x67927D0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int TagGroupBoolPair_TypeDefinitionIndex = 50550;
