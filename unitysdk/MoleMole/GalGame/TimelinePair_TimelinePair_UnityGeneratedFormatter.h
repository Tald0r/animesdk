...
#define MOLEMOLE_GALGAME_TIMELINEPAIR_TIMELINEPAIR_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x8F12720)
#define MOLEMOLE_GALGAME_TIMELINEPAIR_TIMELINEPAIR_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x8F12730)
#define MOLEMOLE_GALGAME_TIMELINEPAIR_TIMELINEPAIR_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x8F12880)
#define MOLEMOLE_GALGAME_TIMELINEPAIR_TIMELINEPAIR_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8F129E0)
#define MOLEMOLE_GALGAME_TIMELINEPAIR_TIMELINEPAIR_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F129A0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int TimelinePair_TimelinePair_UnityGeneratedFormatter_TypeDefinitionIndex = 75991;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(TimelinePair_TimelinePair_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x36600);
		}
