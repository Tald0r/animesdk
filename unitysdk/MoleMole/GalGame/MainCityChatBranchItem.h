...
#define MOLEMOLE_GALGAME_MAINCITYCHATBRANCHITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB5EA7A0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatBranchItem_TypeDefinitionIndex = 64144;
