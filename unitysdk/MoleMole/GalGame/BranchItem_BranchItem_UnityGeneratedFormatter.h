...
#define MOLEMOLE_GALGAME_BRANCHITEM_BRANCHITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xA5EF460)
#define MOLEMOLE_GALGAME_BRANCHITEM_BRANCHITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xA5EF470)
#define MOLEMOLE_GALGAME_BRANCHITEM_BRANCHITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xA5EF730)
#define MOLEMOLE_GALGAME_BRANCHITEM_BRANCHITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA5EF940)
#define MOLEMOLE_GALGAME_BRANCHITEM_BRANCHITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA5EF900)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int BranchItem_BranchItem_UnityGeneratedFormatter_TypeDefinitionIndex = 41781;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(BranchItem_BranchItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x38720);
		}
