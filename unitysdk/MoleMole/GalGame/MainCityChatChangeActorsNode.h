...
#define MOLEMOLE_GALGAME_MAINCITYCHATCHANGEACTORSNODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0xB5EA840)
#define MOLEMOLE_GALGAME_MAINCITYCHATCHANGEACTORSNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB5EA7B0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatChangeActorsNode_TypeDefinitionIndex = 75277;
	...
	public:
		...
		::System::Boolean ResetCamera; // 0x28
		::System::UInt32 CameraX; // 0x2C
		::System::Int32 TargetTag; // 0x30
		::System::Int32 TransitionID; // 0x34
		::System::UInt32 CameraY; // 0x38
