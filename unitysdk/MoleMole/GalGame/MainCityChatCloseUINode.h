...
#define MOLEMOLE_GALGAME_MAINCITYCHATCLOSEUINODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x8F82140)
#define MOLEMOLE_GALGAME_MAINCITYCHATCLOSEUINODE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F82130)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatCloseUINode_TypeDefinitionIndex = 68162;
