...
#define MOLEMOLE_GALGAME_MAINCITYCHATCLOSEUINODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0xD0E2730)
#define MOLEMOLE_GALGAME_MAINCITYCHATCLOSEUINODE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0E2720)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatCloseUINode_TypeDefinitionIndex = 48766;
