...
#define MOLEMOLE_GALGAME_GALPLAYBGMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6AFA140)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalPlayBGMNode_TypeDefinitionIndex = 43120;
