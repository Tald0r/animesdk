...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUIGENERALINTIMACYUPNODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x9913260)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUIGENERALINTIMACYUPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x9913250)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowUIGeneralIntimacyUpNode_TypeDefinitionIndex = 63585;
	...
	public:
		...
		::MoleMole::UIGeneralIntimacyUpPopWindowController_Context_Type ModTrustType; // 0x1C
		::System::Boolean usePopShowModel; // 0x20
		::System::Nullable_1<::System::Int32> CurTrustLevel; // 0x24
