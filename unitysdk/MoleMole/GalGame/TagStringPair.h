...
#define MOLEMOLE_GALGAME_TAGSTRINGPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0xC2D2890)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int TagStringPair_TypeDefinitionIndex = 37710;
