...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWRANKLISTCONFIG_MAINCITYCHATSHOWRANKLISTCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xA7DDA80)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWRANKLISTCONFIG_MAINCITYCHATSHOWRANKLISTCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xA7DDA90)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWRANKLISTCONFIG_MAINCITYCHATSHOWRANKLISTCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xA7DDBE0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWRANKLISTCONFIG_MAINCITYCHATSHOWRANKLISTCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA7DDD40)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWRANKLISTCONFIG_MAINCITYCHATSHOWRANKLISTCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA7DDD00)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowRankListConfig_MainCityChatShowRankListConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 57280;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatShowRankListConfig_MainCityChatShowRankListConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3B450);
		}
