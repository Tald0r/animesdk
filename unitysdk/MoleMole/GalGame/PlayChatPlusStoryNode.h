...
#define MOLEMOLE_GALGAME_PLAYCHATPLUSSTORYNODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x758FDE0)
#define MOLEMOLE_GALGAME_PLAYCHATPLUSSTORYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x758FCE0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int PlayChatPlusStoryNode_TypeDefinitionIndex = 77804;
	...
	public:
		...
		::System::String* SpeakerMember; // 0x28
