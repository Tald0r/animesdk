...
#define MOLEMOLE_GALGAME_PLAYCHATPLUSSTORYNODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x67926A0)
#define MOLEMOLE_GALGAME_PLAYCHATPLUSSTORYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x67925A0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int PlayChatPlusStoryNode_TypeDefinitionIndex = 51569;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::GalGame::TagGroupAniPair*>* GroupAniParams; // 0x28
		...
		::System::Collections::Generic::List_1<::MoleMole::GalGame::TagAniPair*>* TagAniParams; // 0x58
		::System::Single SpeakSpeed; // 0x60
		::System::Single ClickTime; // 0x64
		::System::Int32 SpeakerNpcTag; // 0x68
		::System::Boolean AutoDoNext; // 0x6C
		::System::Single AutoDoNextDelay; // 0x70
