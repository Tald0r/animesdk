...
#define MOLEMOLE_GALGAME_MAINCITYCHATMODIFYCAMERANODE_MAINCITYCHATMODIFYCAMERANODE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xC2D0C00)
#define MOLEMOLE_GALGAME_MAINCITYCHATMODIFYCAMERANODE_MAINCITYCHATMODIFYCAMERANODE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xC2D0C10)
#define MOLEMOLE_GALGAME_MAINCITYCHATMODIFYCAMERANODE_MAINCITYCHATMODIFYCAMERANODE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xC2D0F80)
#define MOLEMOLE_GALGAME_MAINCITYCHATMODIFYCAMERANODE_MAINCITYCHATMODIFYCAMERANODE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC2D11F0)
#define MOLEMOLE_GALGAME_MAINCITYCHATMODIFYCAMERANODE_MAINCITYCHATMODIFYCAMERANODE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2D11B0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatModifyCameraNode_MainCityChatModifyCameraNode_UnityGeneratedFormatter_TypeDefinitionIndex = 56693;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatModifyCameraNode_MainCityChatModifyCameraNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2FB70);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatCameraParam*>** StaticGet_CachedSerializer2()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatCameraParam*>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatModifyCameraNode_MainCityChatModifyCameraNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2FB78);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatPlayableNodeType>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatPlayableNodeType>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatModifyCameraNode_MainCityChatModifyCameraNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2FB80);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Cameras::CameraTrackBlending*>** StaticGet_CachedSerializer3()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Cameras::CameraTrackBlending*>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatModifyCameraNode_MainCityChatModifyCameraNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2FB88);
		}
