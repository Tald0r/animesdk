...
#define MOLEMOLE_GALGAME_MINIGAMERECORDNODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x6E27CA0)
#define MOLEMOLE_GALGAME_MINIGAMERECORDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E27C90)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MiniGameRecordNode_TypeDefinitionIndex = 60542;
