...
#define MOLEMOLE_GALGAME_MAINCITYCHATDELAYNODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0xC9CF8B0)
#define MOLEMOLE_GALGAME_MAINCITYCHATDELAYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9CF8A0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatDelayNode_TypeDefinitionIndex = 50960;
