...
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKNODE_MAINCITYCHATQUESTTRACKNODE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x9911DC0)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKNODE_MAINCITYCHATQUESTTRACKNODE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x9911DD0)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKNODE_MAINCITYCHATQUESTTRACKNODE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x9912090)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKNODE_MAINCITYCHATQUESTTRACKNODE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x99122A0)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKNODE_MAINCITYCHATQUESTTRACKNODE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9912260)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatQuestTrackNode_MainCityChatQuestTrackNode_UnityGeneratedFormatter_TypeDefinitionIndex = 56979;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatQuestTrackNode_MainCityChatQuestTrackNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x34500);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::MoleMole::GalGame::MainCityChatQuestTrackItem*>*>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatQuestTrackNode_MainCityChatQuestTrackNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x34508);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatPlayableNodeType>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatPlayableNodeType>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatQuestTrackNode_MainCityChatQuestTrackNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x34510);
		}
