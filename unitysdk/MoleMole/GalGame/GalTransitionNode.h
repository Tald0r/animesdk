...
#define MOLEMOLE_GALGAME_GALTRANSITIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6790200)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalTransitionNode_TypeDefinitionIndex = 37151;
