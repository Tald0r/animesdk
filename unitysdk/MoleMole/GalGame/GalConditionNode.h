...
#define MOLEMOLE_GALGAME_GALCONDITIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F01F0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalConditionNode_TypeDefinitionIndex = 66759;
