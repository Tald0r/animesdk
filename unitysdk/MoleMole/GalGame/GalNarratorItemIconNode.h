...
#define MOLEMOLE_GALGAME_GALNARRATORITEMICONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F10DB0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalNarratorItemIconNode_TypeDefinitionIndex = 74314;
