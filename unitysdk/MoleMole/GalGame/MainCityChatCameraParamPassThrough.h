...
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_GENERATECAMERAFUNC_OFFSET UNITYSDK_OFFSET(0x9911170)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH__CTOR_OFFSET UNITYSDK_OFFSET(0x9911230)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH__GENERATECAMERAFUNC_B__1_0_OFFSET UNITYSDK_OFFSET(0x9911240)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatCameraParamPassThrough_TypeDefinitionIndex = 75425;
