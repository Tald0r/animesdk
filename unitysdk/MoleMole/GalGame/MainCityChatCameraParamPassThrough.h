...
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_GENERATECAMERAFUNC_OFFSET UNITYSDK_OFFSET(0xA50C1A0)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH__CTOR_OFFSET UNITYSDK_OFFSET(0xA50C260)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH__GENERATECAMERAFUNC_B__1_0_OFFSET UNITYSDK_OFFSET(0xA50C270)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatCameraParamPassThrough_TypeDefinitionIndex = 75260;
