...
#define MOLEMOLE_GALGAME_MAINCITYCHATCHANGENPCNAMENODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0xA5F2970)
#define MOLEMOLE_GALGAME_MAINCITYCHATCHANGENPCNAMENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F2960)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatChangeNpcNameNode_TypeDefinitionIndex = 36401;
