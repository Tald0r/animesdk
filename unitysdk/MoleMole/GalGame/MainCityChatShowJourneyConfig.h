...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_GET_UICTRL_OFFSET UNITYSDK_OFFSET(0x82D7ED0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_ONOPEN_OFFSET UNITYSDK_OFFSET(0x82D7EE0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x82D83F0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowJourneyConfig_TypeDefinitionIndex = 63834;
	...
	public:
		...
		{
			return ((::Enum_3_B90C1A15EA6E3C2B(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG_GET_UICTRL_OFFSET))(this);
		}
