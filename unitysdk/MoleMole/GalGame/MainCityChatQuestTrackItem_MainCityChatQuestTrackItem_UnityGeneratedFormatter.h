...
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCD57860)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCD57870)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCD57B30)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD57D40)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD57D00)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatQuestTrackItem_MainCityChatQuestTrackItem_UnityGeneratedFormatter_TypeDefinitionIndex = 78209;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatQuestTrackItem_MainCityChatQuestTrackItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x478E0);
		}
