...
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x7F0D1D0)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x7F0D1E0)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x7F0D4A0)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7F0D6B0)
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM_MAINCITYCHATQUESTTRACKITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F0D670)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatQuestTrackItem_MainCityChatQuestTrackItem_UnityGeneratedFormatter_TypeDefinitionIndex = 76789;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatQuestTrackItem_MainCityChatQuestTrackItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x41580);
		}
