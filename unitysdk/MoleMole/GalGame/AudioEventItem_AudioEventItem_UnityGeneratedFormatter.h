...
#define MOLEMOLE_GALGAME_AUDIOEVENTITEM_AUDIOEVENTITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xC2CEF20)
#define MOLEMOLE_GALGAME_AUDIOEVENTITEM_AUDIOEVENTITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xC2CEF30)
#define MOLEMOLE_GALGAME_AUDIOEVENTITEM_AUDIOEVENTITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xC2CF2A0)
#define MOLEMOLE_GALGAME_AUDIOEVENTITEM_AUDIOEVENTITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC2CF510)
#define MOLEMOLE_GALGAME_AUDIOEVENTITEM_AUDIOEVENTITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2CF4D0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int AudioEventItem_AudioEventItem_UnityGeneratedFormatter_TypeDefinitionIndex = 76912;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(AudioEventItem_AudioEventItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2FB10);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::String*>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(AudioEventItem_AudioEventItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2FB18);
		}
