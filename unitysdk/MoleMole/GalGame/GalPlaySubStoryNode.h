...
#define MOLEMOLE_GALGAME_GALPLAYSUBSTORYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9CF1F0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalPlaySubStoryNode_TypeDefinitionIndex = 53771;
	...
	public:
		...
		::System::String* avatarShowingKey; // 0x48
		::MoleMole::GalGame::GalNPCLocation npcLocation; // 0x50
		::System::Boolean enableWhiteScreenShaking; // 0x54
		::System::Single whiteScreenShakeDelay; // 0x58
		::System::Int32 actorId; // 0x5C
