...
#define MOLEMOLE_GALGAME_GALPLAYSUBSTORYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xBA146E0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalPlaySubStoryNode_TypeDefinitionIndex = 51748;
	...
	public:
		...
		::System::Single whiteScreenShakeDelay; // 0x50
		::MoleMole::GalGame::GalNPCLocation npcLocation; // 0x54
		::System::Boolean enableWhiteScreenShaking; // 0x58
