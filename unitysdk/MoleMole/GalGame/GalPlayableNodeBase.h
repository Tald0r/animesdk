...
#define MOLEMOLE_GALGAME_GALPLAYABLENODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x7A69010)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalPlayableNodeBase_TypeDefinitionIndex = 64668;
