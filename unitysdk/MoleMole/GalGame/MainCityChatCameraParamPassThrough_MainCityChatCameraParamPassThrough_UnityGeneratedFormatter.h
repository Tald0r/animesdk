...
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xD80B0F0)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xD80B100)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xD80B250)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD80B3B0)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD80B370)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatCameraParamPassThrough_MainCityChatCameraParamPassThrough_UnityGeneratedFormatter_TypeDefinitionIndex = 75261;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatCameraPassThroughTarget>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatCameraParamPassThrough_MainCityChatCameraParamPassThrough_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x403A0);
		}
