...
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xE4830C0)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xE4830D0)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xE483220)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xE483380)
#define MOLEMOLE_GALGAME_MAINCITYCHATCAMERAPARAMPASSTHROUGH_MAINCITYCHATCAMERAPARAMPASSTHROUGH_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xE483340)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatCameraParamPassThrough_MainCityChatCameraParamPassThrough_UnityGeneratedFormatter_TypeDefinitionIndex = 75426;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatCameraPassThroughTarget>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatCameraParamPassThrough_MainCityChatCameraParamPassThrough_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3D420);
		}
