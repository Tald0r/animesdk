...
#define MOLEMOLE_GALGAME_GALJUMPCHAPTERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE104AE0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalJumpChapterNode_TypeDefinitionIndex = 55981;
