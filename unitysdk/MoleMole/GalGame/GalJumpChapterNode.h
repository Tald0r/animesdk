...
#define MOLEMOLE_GALGAME_GALJUMPCHAPTERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x7A69000)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalJumpChapterNode_TypeDefinitionIndex = 49969;
