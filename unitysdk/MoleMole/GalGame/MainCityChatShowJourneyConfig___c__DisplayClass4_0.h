...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F3B20)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWJOURNEYCONFIG___C__DISPLAYCLASS4_0__ONOPEN_B__0_OFFSET UNITYSDK_OFFSET(0xA5F3B30)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowJourneyConfig___c__DisplayClass4_0_TypeDefinitionIndex = 63835;
