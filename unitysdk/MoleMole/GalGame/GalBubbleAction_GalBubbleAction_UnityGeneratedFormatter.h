...
#define MOLEMOLE_GALGAME_GALBUBBLEACTION_GALBUBBLEACTION_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x8F7E540)
#define MOLEMOLE_GALGAME_GALBUBBLEACTION_GALBUBBLEACTION_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x8F7E550)
#define MOLEMOLE_GALGAME_GALBUBBLEACTION_GALBUBBLEACTION_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x8F7E750)
#define MOLEMOLE_GALGAME_GALBUBBLEACTION_GALBUBBLEACTION_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8F7E910)
#define MOLEMOLE_GALGAME_GALBUBBLEACTION_GALBUBBLEACTION_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F7E8D0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalBubbleAction_GalBubbleAction_UnityGeneratedFormatter_TypeDefinitionIndex = 71967;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(GalBubbleAction_GalBubbleAction_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3ECC0);
		}
		static ::Sirenix::Serialization::Serializer_1<::Share::EPerformInterruptType>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::Share::EPerformInterruptType>**)Il2CppClass::FromTypeDefinitionIndex(GalBubbleAction_GalBubbleAction_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3ECC8);
		}
