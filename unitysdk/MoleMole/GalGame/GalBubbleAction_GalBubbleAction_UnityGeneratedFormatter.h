...
#define MOLEMOLE_GALGAME_GALBUBBLEACTION_GALBUBBLEACTION_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xD0DEB30)
#define MOLEMOLE_GALGAME_GALBUBBLEACTION_GALBUBBLEACTION_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xD0DEB40)
#define MOLEMOLE_GALGAME_GALBUBBLEACTION_GALBUBBLEACTION_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xD0DED40)
#define MOLEMOLE_GALGAME_GALBUBBLEACTION_GALBUBBLEACTION_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD0DEF00)
#define MOLEMOLE_GALGAME_GALBUBBLEACTION_GALBUBBLEACTION_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0DEEC0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalBubbleAction_GalBubbleAction_UnityGeneratedFormatter_TypeDefinitionIndex = 55615;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::Share::EPerformInterruptType>**)Il2CppClass::FromTypeDefinitionIndex(GalBubbleAction_GalBubbleAction_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x41940);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Boolean>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(GalBubbleAction_GalBubbleAction_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x41948);
		}
