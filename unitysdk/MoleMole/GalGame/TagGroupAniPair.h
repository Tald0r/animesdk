...
#define MOLEMOLE_GALGAME_TAGGROUPANIPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0xF1B4BD0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int TagGroupAniPair_TypeDefinitionIndex = 56194;
