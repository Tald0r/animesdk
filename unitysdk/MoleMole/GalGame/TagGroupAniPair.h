...
#define MOLEMOLE_GALGAME_TAGGROUPANIPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0xB98EA90)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int TagGroupAniPair_TypeDefinitionIndex = 67015;
