...
#define MOLEMOLE_GALGAME_MAINCITYCHATQUESTTRACKITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x6AFBBE0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatQuestTrackItem_TypeDefinitionIndex = 76788;
