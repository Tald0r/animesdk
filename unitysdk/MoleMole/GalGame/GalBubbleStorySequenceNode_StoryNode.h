...
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE_GET_GETNPCSTIMULUSID_OFFSET UNITYSDK_OFFSET(0x8F10C20)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE_GET_GETTEXT_OFFSET UNITYSDK_OFFSET(0x8F10C30)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE_GET_GETVOICEOREVENT_OFFSET UNITYSDK_OFFSET(0x8F10C40)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F10D90)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalBubbleStorySequenceNode_StoryNode_TypeDefinitionIndex = 57259;
