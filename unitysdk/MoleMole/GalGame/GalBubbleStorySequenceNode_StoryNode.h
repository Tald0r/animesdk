...
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE_GET_GETNPCSTIMULUSID_OFFSET UNITYSDK_OFFSET(0xA0227A0)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE_GET_GETTEXT_OFFSET UNITYSDK_OFFSET(0xA0227B0)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE_GET_GETVOICEOREVENT_OFFSET UNITYSDK_OFFSET(0xA0227C0)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYSEQUENCENODE_STORYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA022910)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalBubbleStorySequenceNode_StoryNode_TypeDefinitionIndex = 70210;
