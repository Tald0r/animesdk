...
#define MOLEMOLE_GALGAME_MAINCITYCHATSYNCSERVERDATANODE_MAINCITYCHATSYNCSERVERDATANODE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x6E26910)
#define MOLEMOLE_GALGAME_MAINCITYCHATSYNCSERVERDATANODE_MAINCITYCHATSYNCSERVERDATANODE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x6E26920)
#define MOLEMOLE_GALGAME_MAINCITYCHATSYNCSERVERDATANODE_MAINCITYCHATSYNCSERVERDATANODE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x6E26BE0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSYNCSERVERDATANODE_MAINCITYCHATSYNCSERVERDATANODE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x6E26DF0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSYNCSERVERDATANODE_MAINCITYCHATSYNCSERVERDATANODE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x6E26DB0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatSyncServerDataNode_MainCityChatSyncServerDataNode_UnityGeneratedFormatter_TypeDefinitionIndex = 48638;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatSyncServerDataNode_MainCityChatSyncServerDataNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44B60);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatPlayableNodeType>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatPlayableNodeType>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatSyncServerDataNode_MainCityChatSyncServerDataNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44B68);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatSyncServerDataConfig*>** StaticGet_CachedSerializer2()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::MainCityChatSyncServerDataConfig*>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatSyncServerDataNode_MainCityChatSyncServerDataNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44B70);
		}
