...
#define MOLEMOLE_GALGAME_TIMELINEPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x6E285F0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int TimelinePair_TypeDefinitionIndex = 75990;
