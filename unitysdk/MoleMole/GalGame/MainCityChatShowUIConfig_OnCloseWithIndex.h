...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA3929D0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA392A20)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0xA392420)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xA3929B0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowUIConfig_OnCloseWithIndex_TypeDefinitionIndex = 51284;
