...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x82D8410)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x82D8460)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0x82D80F0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWUICONFIG_ONCLOSEWITHINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x82D8400)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowUIConfig_OnCloseWithIndex_TypeDefinitionIndex = 45510;
