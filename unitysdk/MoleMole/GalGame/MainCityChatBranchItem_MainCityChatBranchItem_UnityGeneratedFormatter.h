...
#define MOLEMOLE_GALGAME_MAINCITYCHATBRANCHITEM_MAINCITYCHATBRANCHITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xB98C590)
#define MOLEMOLE_GALGAME_MAINCITYCHATBRANCHITEM_MAINCITYCHATBRANCHITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xB98C5A0)
#define MOLEMOLE_GALGAME_MAINCITYCHATBRANCHITEM_MAINCITYCHATBRANCHITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xB98C7A0)
#define MOLEMOLE_GALGAME_MAINCITYCHATBRANCHITEM_MAINCITYCHATBRANCHITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xB98C960)
#define MOLEMOLE_GALGAME_MAINCITYCHATBRANCHITEM_MAINCITYCHATBRANCHITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB98C920)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatBranchItem_MainCityChatBranchItem_UnityGeneratedFormatter_TypeDefinitionIndex = 64145;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatBranchItem_MainCityChatBranchItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x42EB0);
		}
