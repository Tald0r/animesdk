...
#define MOLEMOLE_GALGAME_GALSOUNDACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA022940)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalSoundActionNode_TypeDefinitionIndex = 65604;
