...
#define MOLEMOLE_GALGAME_GALSWITCHSCENEGROUPNODE_GALSWITCHSCENEGROUPNODE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x6E23700)
#define MOLEMOLE_GALGAME_GALSWITCHSCENEGROUPNODE_GALSWITCHSCENEGROUPNODE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x6E23710)
#define MOLEMOLE_GALGAME_GALSWITCHSCENEGROUPNODE_GALSWITCHSCENEGROUPNODE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x6E23B30)
#define MOLEMOLE_GALGAME_GALSWITCHSCENEGROUPNODE_GALSWITCHSCENEGROUPNODE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x6E23DF0)
#define MOLEMOLE_GALGAME_GALSWITCHSCENEGROUPNODE_GALSWITCHSCENEGROUPNODE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x6E23DB0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalSwitchSceneGroupNode_GalSwitchSceneGroupNode_UnityGeneratedFormatter_TypeDefinitionIndex = 63438;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(GalSwitchSceneGroupNode_GalSwitchSceneGroupNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44AA0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::GalSwitchSceneGroupNode_AnimLength>**)Il2CppClass::FromTypeDefinitionIndex(GalSwitchSceneGroupNode_GalSwitchSceneGroupNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44AA8);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::MoleMole::GalGame::SwitchSceneConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(GalSwitchSceneGroupNode_GalSwitchSceneGroupNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44AB0);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::GalPlayableNodeType>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::GalPlayableNodeType>**)Il2CppClass::FromTypeDefinitionIndex(GalSwitchSceneGroupNode_GalSwitchSceneGroupNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44AB8);
		}
