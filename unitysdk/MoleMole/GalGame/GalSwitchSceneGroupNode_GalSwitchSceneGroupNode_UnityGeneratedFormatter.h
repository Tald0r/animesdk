...
#define MOLEMOLE_GALGAME_GALSWITCHSCENEGROUPNODE_GALSWITCHSCENEGROUPNODE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x6E8DEE0)
#define MOLEMOLE_GALGAME_GALSWITCHSCENEGROUPNODE_GALSWITCHSCENEGROUPNODE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x6E8DEF0)
#define MOLEMOLE_GALGAME_GALSWITCHSCENEGROUPNODE_GALSWITCHSCENEGROUPNODE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x6E8E310)
#define MOLEMOLE_GALGAME_GALSWITCHSCENEGROUPNODE_GALSWITCHSCENEGROUPNODE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x6E8E5D0)
#define MOLEMOLE_GALGAME_GALSWITCHSCENEGROUPNODE_GALSWITCHSCENEGROUPNODE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x6E8E590)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalSwitchSceneGroupNode_GalSwitchSceneGroupNode_UnityGeneratedFormatter_TypeDefinitionIndex = 38320;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(GalSwitchSceneGroupNode_GalSwitchSceneGroupNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44100);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::MoleMole::GalGame::SwitchSceneConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(GalSwitchSceneGroupNode_GalSwitchSceneGroupNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44108);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::GalSwitchSceneGroupNode_AnimLength>**)Il2CppClass::FromTypeDefinitionIndex(GalSwitchSceneGroupNode_GalSwitchSceneGroupNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44110);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::GalPlayableNodeType>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::GalGame::GalPlayableNodeType>**)Il2CppClass::FromTypeDefinitionIndex(GalSwitchSceneGroupNode_GalSwitchSceneGroupNode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44118);
		}
