...
#define MOLEMOLE_GALGAME_GALBUBBLESTORYNODE_GET_GETNPCSTIMULUSID_OFFSET UNITYSDK_OFFSET(0xA7D9F90)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYNODE_GET_GETTEXT_OFFSET UNITYSDK_OFFSET(0xA7D9F70)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYNODE_GET_GETVOICEOREVENT_OFFSET UNITYSDK_OFFSET(0xA7D9F80)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA7D9FA0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalBubbleStoryNode_TypeDefinitionIndex = 72775;
