...
#define MOLEMOLE_GALGAME_GALBUBBLESTORYNODE_GET_GETNPCSTIMULUSID_OFFSET UNITYSDK_OFFSET(0xA5F0050)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYNODE_GET_GETTEXT_OFFSET UNITYSDK_OFFSET(0xA5F0030)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYNODE_GET_GETVOICEOREVENT_OFFSET UNITYSDK_OFFSET(0xA5F0040)
#define MOLEMOLE_GALGAME_GALBUBBLESTORYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F0060)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalBubbleStoryNode_TypeDefinitionIndex = 54808;
