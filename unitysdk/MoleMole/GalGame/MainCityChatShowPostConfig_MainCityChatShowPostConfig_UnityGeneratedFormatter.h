...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_MAINCITYCHATSHOWPOSTCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x758ECD0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_MAINCITYCHATSHOWPOSTCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x758ECE0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_MAINCITYCHATSHOWPOSTCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x758F590)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_MAINCITYCHATSHOWPOSTCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x758FAD0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_MAINCITYCHATSHOWPOSTCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x758FA90)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowPostConfig_MainCityChatShowPostConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 79005;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatShowPostConfig_MainCityChatShowPostConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x45E90);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Single>** StaticGet_CachedSerializer3()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatShowPostConfig_MainCityChatShowPostConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x45E98);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Boolean>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatShowPostConfig_MainCityChatShowPostConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x45EA0);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Int32>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatShowPostConfig_MainCityChatShowPostConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x45EA8);
		}
