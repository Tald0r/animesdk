...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWTRIDICEINFODIALOGCONFIG_GET_UICTRL_OFFSET UNITYSDK_OFFSET(0xB8AD870)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWTRIDICEINFODIALOGCONFIG_ONOPEN_OFFSET UNITYSDK_OFFSET(0xB8AD880)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWTRIDICEINFODIALOGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB8ADBA0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowTriDiceInfoDialogConfig_TypeDefinitionIndex = 74076;
	...
	public:
		...
		{
			return ((::Enum_3_340DE32BA097F66C(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_GALGAME_MAINCITYCHATSHOWTRIDICEINFODIALOGCONFIG_GET_UICTRL_OFFSET))(this);
		}
