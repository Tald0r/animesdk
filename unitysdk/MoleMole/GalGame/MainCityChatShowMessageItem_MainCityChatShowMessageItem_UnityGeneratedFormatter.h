...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCD588A0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCD588B0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCD58A00)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD58B60)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD58B20)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowMessageItem_MainCityChatShowMessageItem_UnityGeneratedFormatter_TypeDefinitionIndex = 69856;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatShowMessageItem_MainCityChatShowMessageItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x47900);
		}
