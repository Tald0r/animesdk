...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x7F0E210)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x7F0E220)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x7F0E370)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7F0E4D0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWMESSAGEITEM_MAINCITYCHATSHOWMESSAGEITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F0E490)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowMessageItem_MainCityChatShowMessageItem_UnityGeneratedFormatter_TypeDefinitionIndex = 50130;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MainCityChatShowMessageItem_MainCityChatShowMessageItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x415A0);
		}
