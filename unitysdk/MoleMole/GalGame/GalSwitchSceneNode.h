...
#define MOLEMOLE_GALGAME_GALSWITCHSCENENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E8E710)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalSwitchSceneNode_TypeDefinitionIndex = 42891;
