...
#define MOLEMOLE_GALGAME_MAINCITYCHATSYNCMESSAGECONFIG___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x6E90FA0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSYNCMESSAGECONFIG___C__DISPLAYCLASS3_0__STARTSYNC_B__0_OFFSET UNITYSDK_OFFSET(0x6E90FB0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatSyncMessageConfig___c__DisplayClass3_0_TypeDefinitionIndex = 48282;
