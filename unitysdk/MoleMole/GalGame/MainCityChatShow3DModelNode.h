...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOW3DMODELNODE_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0xA0238D0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOW3DMODELNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA0238B0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShow3DModelNode_TypeDefinitionIndex = 69178;
