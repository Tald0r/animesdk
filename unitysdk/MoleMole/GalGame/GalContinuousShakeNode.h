...
#define MOLEMOLE_GALGAME_GALCONTINUOUSSHAKENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB5E91A0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalContinuousShakeNode_TypeDefinitionIndex = 66523;
