...
#define MOLEMOLE_GALGAME_GALCONTINUOUSSHAKENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6AF9E00)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int GalContinuousShakeNode_TypeDefinitionIndex = 55153;
