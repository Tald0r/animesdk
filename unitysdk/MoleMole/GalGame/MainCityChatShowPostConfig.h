...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_ANIMATIONID_OFFSET UNITYSDK_OFFSET(0x7F0EB20)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_CAMERA1POS_OFFSET UNITYSDK_OFFSET(0x7F0EB90)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_CAMERA2POS_OFFSET UNITYSDK_OFFSET(0x7F0EC10)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_CAMERARELAAVATAR_OFFSET UNITYSDK_OFFSET(0x7F0EE50)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_CAMERARELANPCID_OFFSET UNITYSDK_OFFSET(0x7F0EE40)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_FOVANDBLEND_OFFSET UNITYSDK_OFFSET(0x7F0EC20)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_FOV_OFFSET UNITYSDK_OFFSET(0x7F0ECA0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_NOISEDURATION_OFFSET UNITYSDK_OFFSET(0x7F0ED60)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_NOISE_OFFSET UNITYSDK_OFFSET(0x7F0ECB0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_OVERRIDECAMERANEARCLIP_OFFSET UNITYSDK_OFFSET(0x7F0EDD0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_UICTRL_OFFSET UNITYSDK_OFFSET(0x7F0E5C0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_ONOPEN_OFFSET UNITYSDK_OFFSET(0x7F0E5D0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x7F0EE60)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowPostConfig_TypeDefinitionIndex = 62631;
	...
	public:
		...
		{
			return ((::Enum_3_B90C1A15EA6E3C2B(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_UICTRL_OFFSET))(this);
		}
