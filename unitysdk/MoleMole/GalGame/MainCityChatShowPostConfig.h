...
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_ANIMATIONID_OFFSET UNITYSDK_OFFSET(0xCD591B0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_CAMERA1POS_OFFSET UNITYSDK_OFFSET(0xCD59220)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_CAMERA2POS_OFFSET UNITYSDK_OFFSET(0xCD592A0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_CAMERARELAAVATAR_OFFSET UNITYSDK_OFFSET(0xCD594E0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_CAMERARELANPCID_OFFSET UNITYSDK_OFFSET(0xCD594D0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_FOVANDBLEND_OFFSET UNITYSDK_OFFSET(0xCD592B0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_FOV_OFFSET UNITYSDK_OFFSET(0xCD59330)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_NOISEDURATION_OFFSET UNITYSDK_OFFSET(0xCD593F0)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_NOISE_OFFSET UNITYSDK_OFFSET(0xCD59340)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_OVERRIDECAMERANEARCLIP_OFFSET UNITYSDK_OFFSET(0xCD59460)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_UICTRL_OFFSET UNITYSDK_OFFSET(0xCD58C50)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_ONOPEN_OFFSET UNITYSDK_OFFSET(0xCD58C60)
#define MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCD594F0)

namespace MoleMole::GalGame
{
	inline static constexpr unsigned int MainCityChatShowPostConfig_TypeDefinitionIndex = 79003;
	...
	public:
		...
		{
			return ((::Enum_3_340DE32BA097F66C(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_GALGAME_MAINCITYCHATSHOWPOSTCONFIG_GET_UICTRL_OFFSET))(this);
		}
