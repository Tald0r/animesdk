...
#define MOLEMOLE_ANIMTILT_AWAKE_OFFSET UNITYSDK_OFFSET(0x8015700)
#define MOLEMOLE_ANIMTILT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8015760)
#define MOLEMOLE_ANIMTILT_METHOD_5_554208C84546EE8E_OFFSET UNITYSDK_OFFSET(0x80157D0)
#define MOLEMOLE_ANIMTILT_SETTILTANGLETARGET_OFFSET UNITYSDK_OFFSET(0x8015BE0)
#define MOLEMOLE_ANIMTILT__CTOR_OFFSET UNITYSDK_OFFSET(0x8015C90)

namespace MoleMole
{
	inline static constexpr unsigned int AnimTilt_TypeDefinitionIndex = 49341;
