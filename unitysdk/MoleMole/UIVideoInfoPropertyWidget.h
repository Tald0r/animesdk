...
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET_HIDEALLITEM_OFFSET UNITYSDK_OFFSET(0xEE50540)
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET_REFRESHDAMAGEELEMENTSVIEW_1_OFFSET UNITYSDK_OFFSET(0xEE50110)
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET_REFRESHDAMAGEELEMENTSVIEW_OFFSET UNITYSDK_OFFSET(0xEE4FF30)
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0xEE505C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoInfoPropertyWidget_TypeDefinitionIndex = 55902;
