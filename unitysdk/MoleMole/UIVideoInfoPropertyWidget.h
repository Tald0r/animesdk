...
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET_HIDEALLITEM_OFFSET UNITYSDK_OFFSET(0xAA772E0)
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET_REFRESHDAMAGEELEMENTSVIEW_1_OFFSET UNITYSDK_OFFSET(0xAA76EB0)
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET_REFRESHDAMAGEELEMENTSVIEW_OFFSET UNITYSDK_OFFSET(0xAA76CD0)
#define MOLEMOLE_UIVIDEOINFOPROPERTYWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0xAA77360)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoInfoPropertyWidget_TypeDefinitionIndex = 56835;
