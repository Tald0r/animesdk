...
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_BINDONCLICK_OFFSET UNITYSDK_OFFSET(0xD55A2F0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD559BF0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD55A170)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD559C90)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_UPDATECARDINFO_OFFSET UNITYSDK_OFFSET(0xD55A9C0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER_UPDATEINFO_OFFSET UNITYSDK_OFFSET(0xD55A410)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD55ADB0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER__UPDATEINFO_B__10_1_OFFSET UNITYSDK_OFFSET(0xD55ADE0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER__UPDATEINFO_G__INTERNALDOREFRESH_10_0_OFFSET UNITYSDK_OFFSET(0xD55A7C0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD55ADF0)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD55AE60)
#define MOLEMOLE_UIDOUBLEELITEMONSTERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD55AEE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleEliteMonsterWidgetController_TypeDefinitionIndex = 64865;
	...
	public:
		...
		::Class_2_208CC9941471731A_181* _cardInfoTempate; // 0x2D0
