...
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x689B690)
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER__GETINFOSTATUS_OFFSET UNITYSDK_OFFSET(0x689B0D0)
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER__REFRESHCUSTOM_OFFSET UNITYSDK_OFFSET(0x689B130)
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER___BASE__GETINFOSTATUS_OFFSET UNITYSDK_OFFSET(0x689B6A0)
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER___BASE__REFRESHCUSTOM_OFFSET UNITYSDK_OFFSET(0x689B700)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevel_AutoBattle_BattleInfo_WithProgress_WidgetController_TypeDefinitionIndex = 64675;
