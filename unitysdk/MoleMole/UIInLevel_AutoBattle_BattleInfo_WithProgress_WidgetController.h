...
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F90DF0)
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER__GETINFOSTATUS_OFFSET UNITYSDK_OFFSET(0x7F90830)
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER__REFRESHCUSTOM_OFFSET UNITYSDK_OFFSET(0x7F90890)
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER___BASE__GETINFOSTATUS_OFFSET UNITYSDK_OFFSET(0x7F90E00)
#define MOLEMOLE_UIINLEVEL_AUTOBATTLE_BATTLEINFO_WITHPROGRESS_WIDGETCONTROLLER___BASE__REFRESHCUSTOM_OFFSET UNITYSDK_OFFSET(0x7F90E60)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevel_AutoBattle_BattleInfo_WithProgress_WidgetController_TypeDefinitionIndex = 60269;
