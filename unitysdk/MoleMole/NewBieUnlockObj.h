...
#define MOLEMOLE_NEWBIEUNLOCKOBJ_ADDUNLOCKGROUP_OFFSET UNITYSDK_OFFSET(0x7A98430)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_ADDUNLOCKLIST_OFFSET UNITYSDK_OFFSET(0x7A984B0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_GET_FROMGM_OFFSET UNITYSDK_OFFSET(0x7A982B0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0x7A98290)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x7A982A0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x7A982D0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_HASUNLOCKNEWBIEID_1_OFFSET UNITYSDK_OFFSET(0x7A98690)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_HASUNLOCKNEWBIEID_OFFSET UNITYSDK_OFFSET(0x7A98610)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x7A98A50)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_SETFROMGM_OFFSET UNITYSDK_OFFSET(0x7A983D0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_SET_FROMGM_OFFSET UNITYSDK_OFFSET(0x7A982C0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x7A982E0)
#define MOLEMOLE_NEWBIEUNLOCKOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x7A982F0)

namespace MoleMole
{
	inline static constexpr unsigned int NewBieUnlockObj_TypeDefinitionIndex = 45162;
