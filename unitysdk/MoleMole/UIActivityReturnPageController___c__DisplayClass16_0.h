...
#define MOLEMOLE_UIACTIVITYRETURNPAGECONTROLLER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBF20BE0)
#define MOLEMOLE_UIACTIVITYRETURNPAGECONTROLLER___C__DISPLAYCLASS16_0__PLAYTRAILVIDEO_B__0_OFFSET UNITYSDK_OFFSET(0xBF20BF0)
#define MOLEMOLE_UIACTIVITYRETURNPAGECONTROLLER___C__DISPLAYCLASS16_0__PLAYTRAILVIDEO_B__1_OFFSET UNITYSDK_OFFSET(0xBF20C40)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityReturnPageController___c__DisplayClass16_0_TypeDefinitionIndex = 75740;
