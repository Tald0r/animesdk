...
#define MOLEMOLE_UISUIBIANTEMPLEPRODUCTIONPANELWIDGETCONTROLLER__CHECKGETPRODUCTNEWBIE_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3226E0)
#define MOLEMOLE_UISUIBIANTEMPLEPRODUCTIONPANELWIDGETCONTROLLER__CHECKGETPRODUCTNEWBIE_D__27_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleProductionPanelWidgetController__CheckGetProductNewBie_d__27_TypeDefinitionIndex = 77463;
