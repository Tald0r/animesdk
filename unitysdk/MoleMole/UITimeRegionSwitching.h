...
#define MOLEMOLE_UITIMEREGIONSWITCHING_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x79071D0)
#define MOLEMOLE_UITIMEREGIONSWITCHING__CTOR_OFFSET UNITYSDK_OFFSET(0x7907190)
#define MOLEMOLE_UITIMEREGIONSWITCHING___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x7907350)

namespace MoleMole
{
	inline static constexpr unsigned int UITimeRegionSwitching_TypeDefinitionIndex = 59159;
