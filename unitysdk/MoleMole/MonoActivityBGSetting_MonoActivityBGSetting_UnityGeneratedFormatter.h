...
#define MOLEMOLE_MONOACTIVITYBGSETTING_MONOACTIVITYBGSETTING_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xC230E20)
#define MOLEMOLE_MONOACTIVITYBGSETTING_MONOACTIVITYBGSETTING_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xC230E30)
#define MOLEMOLE_MONOACTIVITYBGSETTING_MONOACTIVITYBGSETTING_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xC231030)
#define MOLEMOLE_MONOACTIVITYBGSETTING_MONOACTIVITYBGSETTING_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC2311F0)
#define MOLEMOLE_MONOACTIVITYBGSETTING_MONOACTIVITYBGSETTING_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2311B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoActivityBGSetting_MonoActivityBGSetting_UnityGeneratedFormatter_TypeDefinitionIndex = 51957;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::MoleMole::ActivitBGSpineSequence*>*>**)Il2CppClass::FromTypeDefinitionIndex(MonoActivityBGSetting_MonoActivityBGSetting_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43FC0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::MoleMole::ActivitBGAnimationSequence*>*>**)Il2CppClass::FromTypeDefinitionIndex(MonoActivityBGSetting_MonoActivityBGSetting_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43FC8);
		}
