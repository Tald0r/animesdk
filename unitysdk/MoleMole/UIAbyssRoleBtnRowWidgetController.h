...
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x9AE6B10)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9AE6630)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9AE67B0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9AE66D0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9AE6410)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x9AE68A0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0x9AE6CC0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9AE6D90)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x9AE6DA0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9AE6DB0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9AE6E20)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9AE6EA0)
#define MOLEMOLE_UIABYSSROLEBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9AE6F20)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssRoleBtnRowWidgetController_TypeDefinitionIndex = 48012;

	class UIAbyssRoleBtnRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_4DCCADF9A0DA6BC6* _view; // 0x2D0
		::System::Int32 _avatarID; // 0x2D8
		::System::Int32 index; // 0x2DC
