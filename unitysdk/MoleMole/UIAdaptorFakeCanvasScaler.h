...
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_GET_RATIO_OFFSET UNITYSDK_OFFSET(0xDEEF650)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_GET_REFERENCERESOLUTION_OFFSET UNITYSDK_OFFSET(0xDEEF800)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_GET_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0xDEEF630)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_MARKVALUECHANGE_OFFSET UNITYSDK_OFFSET(0xDEEF820)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_SET_RATIO_OFFSET UNITYSDK_OFFSET(0xDEEF720)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_SET_REFERENCERESOLUTION_OFFSET UNITYSDK_OFFSET(0xDEEF810)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_SET_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0xDEEF640)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER__CTOR_OFFSET UNITYSDK_OFFSET(0xDEEF880)

namespace MoleMole
{
	inline static constexpr unsigned int UIAdaptorFakeCanvasScaler_TypeDefinitionIndex = 45431;
