...
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_GET_RATIO_OFFSET UNITYSDK_OFFSET(0xB287300)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_GET_REFERENCERESOLUTION_OFFSET UNITYSDK_OFFSET(0xB2874B0)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_GET_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0xB2872E0)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_MARKVALUECHANGE_OFFSET UNITYSDK_OFFSET(0xB2874D0)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_SET_RATIO_OFFSET UNITYSDK_OFFSET(0xB2873D0)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_SET_REFERENCERESOLUTION_OFFSET UNITYSDK_OFFSET(0xB2874C0)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER_SET_VALUECHANGED_OFFSET UNITYSDK_OFFSET(0xB2872F0)
#define MOLEMOLE_UIADAPTORFAKECANVASSCALER__CTOR_OFFSET UNITYSDK_OFFSET(0xB287530)

namespace MoleMole
{
	inline static constexpr unsigned int UIAdaptorFakeCanvasScaler_TypeDefinitionIndex = 51661;
