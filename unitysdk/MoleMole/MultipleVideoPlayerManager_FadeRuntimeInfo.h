...
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_FINISH_OFFSET UNITYSDK_OFFSET(0xC326630)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xC326740)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_INIT_OFFSET UNITYSDK_OFFSET(0xC325E50)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_RESET_OFFSET UNITYSDK_OFFSET(0xC325F60)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_SETALPHAUPDATE_OFFSET UNITYSDK_OFFSET(0xC326210)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xC326750)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_START_OFFSET UNITYSDK_OFFSET(0xC325FD0)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_STOP_OFFSET UNITYSDK_OFFSET(0xC3262D0)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_UPDATE_OFFSET UNITYSDK_OFFSET(0xC326380)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC325E40)

namespace MoleMole
{
	inline static constexpr unsigned int MultipleVideoPlayerManager_FadeRuntimeInfo_TypeDefinitionIndex = 49505;

	class MultipleVideoPlayerManager_FadeRuntimeInfo : public ::System::Object
	{
	public:
		::System::Action_2<::System::Boolean, ::System::Single>* SetAlpha; // 0x10
		::System::Collections::IEnumerator* _setAlphaUpdater; // 0x18
		::System::Func_1<::System::Double>* GetCurVideoTime; // 0x20
		::System::Single _fadeOutTime; // 0x28
		::System::Double _curFadeTime; // 0x30
		::System::Double _totalTime; // 0x38
		::System::Boolean _playedFadeIn; // 0x40
		::System::Boolean _playedFadeOut; // 0x41
		::System::Boolean _isLoop; // 0x42
		::System::Boolean _IsActive_k__BackingField; // 0x43
		::System::Single _fadeInTime; // 0x44
