...
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_FINISH_OFFSET UNITYSDK_OFFSET(0x8F9A250)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x8F9A360)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_INIT_OFFSET UNITYSDK_OFFSET(0x8F99A70)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_RESET_OFFSET UNITYSDK_OFFSET(0x8F99B80)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_SETALPHAUPDATE_OFFSET UNITYSDK_OFFSET(0x8F99E30)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x8F9A370)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_START_OFFSET UNITYSDK_OFFSET(0x8F99BF0)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_STOP_OFFSET UNITYSDK_OFFSET(0x8F99EF0)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO_UPDATE_OFFSET UNITYSDK_OFFSET(0x8F99FA0)
#define MOLEMOLE_MULTIPLEVIDEOPLAYERMANAGER_FADERUNTIMEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8F99A60)

namespace MoleMole
{
	inline static constexpr unsigned int MultipleVideoPlayerManager_FadeRuntimeInfo_TypeDefinitionIndex = 45547;
	...
	public:
		...
		::System::Single _fadeInTime; // 0x28
		::System::Boolean _playedFadeIn; // 0x2C
		::System::Boolean _playedFadeOut; // 0x2D
		::System::Boolean _isLoop; // 0x2E
		::System::Boolean _IsActive_k__BackingField; // 0x2F
		::System::Double _totalTime; // 0x30
		::System::Single _fadeOutTime; // 0x38
