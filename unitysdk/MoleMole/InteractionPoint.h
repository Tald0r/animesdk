...
#define MOLEMOLE_INTERACTIONPOINT_GETINTERACTDIRECTION_OFFSET UNITYSDK_OFFSET(0xE487270)
#define MOLEMOLE_INTERACTIONPOINT_GETPOINTPOS_OFFSET UNITYSDK_OFFSET(0xE4870F0)
#define MOLEMOLE_INTERACTIONPOINT_GET_ACCURATE_OFFSET UNITYSDK_OFFSET(0xE487540)
#define MOLEMOLE_INTERACTIONPOINT_GET_MAXANGLE_OFFSET UNITYSDK_OFFSET(0xE487560)
#define MOLEMOLE_INTERACTIONPOINT_GET_MINANGLE_OFFSET UNITYSDK_OFFSET(0xE487550)
#define MOLEMOLE_INTERACTIONPOINT_GET_NAME_OFFSET UNITYSDK_OFFSET(0xE4870B0)
#define MOLEMOLE_INTERACTIONPOINT_GET_RANGE_OFFSET UNITYSDK_OFFSET(0xE487580)
#define MOLEMOLE_INTERACTIONPOINT_GET_USENAVMESH_OFFSET UNITYSDK_OFFSET(0xE487570)
#define MOLEMOLE_INTERACTIONPOINT_METHOD_1_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0xE487590)
#define MOLEMOLE_INTERACTIONPOINT_SET_NAME_OFFSET UNITYSDK_OFFSET(0xE4870C0)
#define MOLEMOLE_INTERACTIONPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xE4870D0)

namespace MoleMole
{
	inline static constexpr unsigned int InteractionPoint_TypeDefinitionIndex = 40847;
