...
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__TRYNEXTNPC_D__57_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3226A0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__TRYNEXTNPC_D__57_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerWidgetController__TryNextNpc_d__57_TypeDefinitionIndex = 70193;

	struct alignas(8) UIQuestionsAnswerWidgetController__TryNextNpc_d__57
	{
		::MoleMole::UIQuestionsAnswerWidgetController___c__DisplayClass57_0* __8__1; // 0x10
		::Class_2_360F008FD42AEBAC* _stageConfig_5__2; // 0x18
		::Class_2_208CC9941471731A_551* _special_5__7; // 0x20
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__1; // 0x28
		::Class_2_360F008FD42AEBAC* _stage_5__6; // 0x38
		::MoleMole::UIQuestionsAnswerWidgetController* __4__this; // 0x40
		::Class_2_208CC9941471731A_735* _nextConfig_5__3; // 0x48
		::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder __t__builder; // 0x50
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::Boolean> __u__2; // 0x60
