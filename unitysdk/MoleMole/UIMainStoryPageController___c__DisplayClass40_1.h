...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS40_1__CTOR_OFFSET UNITYSDK_OFFSET(0x8ECC1F0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS40_1__SHOWTAPEDECKINFO_B__1_OFFSET UNITYSDK_OFFSET(0x8ECC200)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController___c__DisplayClass40_1_TypeDefinitionIndex = 40430;

	class UIMainStoryPageController___c__DisplayClass40_1 : public ::System::Object
	{
	public:
		::UnityEngine::Animation* deckInfoAnimation; // 0x10
		::System::String* fadeInAnimation; // 0x18
