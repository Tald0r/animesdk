...
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD585F30)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER_ONSELECTAVATAR_OFFSET UNITYSDK_OFFSET(0xD586580)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER_ONSELECTBUDDYHANDLE_OFFSET UNITYSDK_OFFSET(0xD586D10)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD585FD0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD5850E0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD585290)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD586DB0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER__OPENSELECTBUDDYPAGE_OFFSET UNITYSDK_OFFSET(0xD586AB0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER__OPENSELECTHEROPAGE_OFFSET UNITYSDK_OFFSET(0xD5860B0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER__REFRESHROLES_OFFSET UNITYSDK_OFFSET(0xD585420)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER__SETEMPTY_OFFSET UNITYSDK_OFFSET(0xD585E90)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD5870A0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD587110)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD587190)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD5871F0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER___REFRESHROLES_G____ONBUDDYHEADROWBTNCLICKED_12_1_OFFSET UNITYSDK_OFFSET(0xD586FB0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER___REFRESHROLES_G____ONROLEHEADROWBTNCLICKED_12_0_OFFSET UNITYSDK_OFFSET(0xD586EB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalLineUp_RoomSelectWidgetController_TypeDefinitionIndex = 77212;
	...
	public:
		...
		::Class_2_77D12983AB7F9492_3* _view; // 0x2A0
		::Class_2_468A4FBF2E9F527C* _hadalZoneModel; // 0x2A8
		::MoleMole::UIHadalZone_Common_HadalRoomSelectContext* _roomSelectContext; // 0x2B0
