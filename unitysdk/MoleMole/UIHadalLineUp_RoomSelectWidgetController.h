...
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9D99960)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER_ONSELECTAVATAR_OFFSET UNITYSDK_OFFSET(0x9D99FB0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER_ONSELECTBUDDYHANDLE_OFFSET UNITYSDK_OFFSET(0x9D9A7D0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9D99A00)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9D98B50)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9D98D00)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D9A870)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER__OPENSELECTBUDDYPAGE_OFFSET UNITYSDK_OFFSET(0x9D9A570)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER__OPENSELECTHEROPAGE_OFFSET UNITYSDK_OFFSET(0x9D99AE0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER__REFRESHROLES_OFFSET UNITYSDK_OFFSET(0x9D98E90)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER__SETEMPTY_OFFSET UNITYSDK_OFFSET(0x9D998C0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9D9AB60)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9D9ABD0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9D9AC50)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9D9ACB0)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER___REFRESHROLES_G____ONBUDDYHEADROWBTNCLICKED_12_1_OFFSET UNITYSDK_OFFSET(0x9D9AA70)
#define MOLEMOLE_UIHADALLINEUP_ROOMSELECTWIDGETCONTROLLER___REFRESHROLES_G____ONROLEHEADROWBTNCLICKED_12_0_OFFSET UNITYSDK_OFFSET(0x9D9A970)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalLineUp_RoomSelectWidgetController_TypeDefinitionIndex = 40757;
	...
	public:
		...
		::Class_2_77D12983AB7F9492_2* _view; // 0x2A0
