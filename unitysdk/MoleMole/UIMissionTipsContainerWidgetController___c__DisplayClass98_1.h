...
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS98_1__CTOR_OFFSET UNITYSDK_OFFSET(0x94566B0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS98_1__PLAYCHALLENGETIP_B__2_OFFSET UNITYSDK_OFFSET(0x94566C0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS98_1__PLAYCHALLENGETIP_B__3_OFFSET UNITYSDK_OFFSET(0x9456750)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsContainerWidgetController___c__DisplayClass98_1_TypeDefinitionIndex = 75722;
