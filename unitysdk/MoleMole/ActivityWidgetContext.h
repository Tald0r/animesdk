...
#define MOLEMOLE_ACTIVITYWIDGETCONTEXT_ADDACTIVITYCOMPONENTHANDLER_OFFSET UNITYSDK_OFFSET(0xB497BE0)
#define MOLEMOLE_ACTIVITYWIDGETCONTEXT_ADDCOMPONENTCONTROLTAG_OFFSET UNITYSDK_OFFSET(0xB498550)
#define MOLEMOLE_ACTIVITYWIDGETCONTEXT_CALLDORESET_OFFSET UNITYSDK_OFFSET(0xB4984C0)
#define MOLEMOLE_ACTIVITYWIDGETCONTEXT_CALLONDESTROY_OFFSET UNITYSDK_OFFSET(0xB4983B0)
#define MOLEMOLE_ACTIVITYWIDGETCONTEXT_CALLONHIDE_OFFSET UNITYSDK_OFFSET(0xB4982C0)
#define MOLEMOLE_ACTIVITYWIDGETCONTEXT_CALLONOPEN_OFFSET UNITYSDK_OFFSET(0xB497FF0)
#define MOLEMOLE_ACTIVITYWIDGETCONTEXT_CALLONSHOW_OFFSET UNITYSDK_OFFSET(0xB498130)
#define MOLEMOLE_ACTIVITYWIDGETCONTEXT_COPYBASE_OFFSET UNITYSDK_OFFSET(0xB497A30)
#define MOLEMOLE_ACTIVITYWIDGETCONTEXT_HASCOMPONENTCONTROLTAG_OFFSET UNITYSDK_OFFSET(0xB4986E0)
#define MOLEMOLE_ACTIVITYWIDGETCONTEXT_INITWIDGETACTIVITY_OFFSET UNITYSDK_OFFSET(0xB497990)
#define MOLEMOLE_ACTIVITYWIDGETCONTEXT_SETBASEACTIVITYUIPROXY_OFFSET UNITYSDK_OFFSET(0xB497AF0)
#define MOLEMOLE_ACTIVITYWIDGETCONTEXT_TRYADDGUIDEBUTTONCOMPONENT_OFFSET UNITYSDK_OFFSET(0xB497D60)
#define MOLEMOLE_ACTIVITYWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB497AE0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityWidgetContext_TypeDefinitionIndex = 64135;

	class ActivityWidgetContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_1_5CA3042B03E40C06* createProcessor; // 0x28
		::System::Collections::Generic::HashSet_1<::Enum_3_93ADA810875FF1BB>* controlTags; // 0x30
		::Class_1_D375C91CCE5D3999* activityData; // 0x38
		::Class_1_A7ED02430811372E* activityPageData; // 0x40
		::Class_1_AE0C440AAD48398A* pageCenter; // 0x48
		::Class_1_59919CA8B8CC259B* uiProxy; // 0x50
		::Class_1_59BC20CDF12D1A85* componentCenter; // 0x58
		::Class_1_59ACE1D68DDF9B15* componentFactory; // 0x60
		...
		::System::Void SetBaseActivityUIProxy(::Class_1_59919CA8B8CC259B* uiProxy)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_59919CA8B8CC259B*))((::PBYTE)hIl2Cpp + MOLEMOLE_ACTIVITYWIDGETCONTEXT_SETBASEACTIVITYUIPROXY_OFFSET))(this, uiProxy);
		}
		...
		::System::Void CallOnOpen(::MoleMole::UIBaseController* activityController, ::Class_1_EEA0111A28582B57* baseView, ::MoleMole::UIControllerContextBase* openCtrlContext)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::UIBaseController*, ::Class_1_EEA0111A28582B57*, ::MoleMole::UIControllerContextBase*))((::PBYTE)hIl2Cpp + MOLEMOLE_ACTIVITYWIDGETCONTEXT_CALLONOPEN_OFFSET))(this, activityController, baseView, openCtrlContext);
		}
