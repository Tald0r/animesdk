...
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_GETBINDMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0x75AF130)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_GETMATERIALSLISTBYRENDERS_OFFSET UNITYSDK_OFFSET(0x75AE7E0)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_GETOVERRIDERDITHERKEY_OFFSET UNITYSDK_OFFSET(0x75AF0D0)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_METHOD_5_35942D7A8A374AB0_OFFSET UNITYSDK_OFFSET(0x75AECA0)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x75AEC30)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS__CTOR_OFFSET UNITYSDK_OFFSET(0x75AF190)

namespace MoleMole
{
	inline static constexpr unsigned int MonoColliderBindMeshRenders_TypeDefinitionIndex = 77843;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_METHOD_5_35942D7A8A374AB0_OFFSET))(this);
		}
	};
}
