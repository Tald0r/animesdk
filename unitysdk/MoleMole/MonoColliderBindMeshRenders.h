...
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_GETBINDMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0x67B1620)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_GETMATERIALSLISTBYRENDERS_OFFSET UNITYSDK_OFFSET(0x67B0CD0)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_GETOVERRIDERDITHERKEY_OFFSET UNITYSDK_OFFSET(0x67B15C0)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_METHOD_5_35942D7A8A374AB0_OFFSET UNITYSDK_OFFSET(0x67B1190)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x67B1120)
#define MOLEMOLE_MONOCOLLIDERBINDMESHRENDERS__CTOR_OFFSET UNITYSDK_OFFSET(0x67B1680)

namespace MoleMole
{
	inline static constexpr unsigned int MonoColliderBindMeshRenders_TypeDefinitionIndex = 37270;
