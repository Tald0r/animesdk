...
#define MOLEMOLE_UICLOUDCONTROLLER_UIRTCITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xBB13A30)

namespace MoleMole
{
	inline static constexpr unsigned int UICloudController_UIRTCItem_TypeDefinitionIndex = 37913;
