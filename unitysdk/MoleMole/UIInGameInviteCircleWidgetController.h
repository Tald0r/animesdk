...
#define MOLEMOLE_UIINGAMEINVITECIRCLEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x893E930)
#define MOLEMOLE_UIINGAMEINVITECIRCLEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x893E9A0)
#define MOLEMOLE_UIINGAMEINVITECIRCLEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x893EAA0)
#define MOLEMOLE_UIINGAMEINVITECIRCLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x893EE00)
#define MOLEMOLE_UIINGAMEINVITECIRCLEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x893EE10)
#define MOLEMOLE_UIINGAMEINVITECIRCLEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x893EE80)

namespace MoleMole
{
	inline static constexpr unsigned int UIInGameInviteCircleWidgetController_TypeDefinitionIndex = 54982;
