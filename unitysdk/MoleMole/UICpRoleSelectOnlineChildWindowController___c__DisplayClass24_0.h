...
#define MOLEMOLE_UICPROLESELECTONLINECHILDWINDOWCONTROLLER___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB23E0)
#define MOLEMOLE_UICPROLESELECTONLINECHILDWINDOWCONTROLLER___C__DISPLAYCLASS24_0__ONENABLE_B__0_OFFSET UNITYSDK_OFFSET(0x1AFB23F0)

namespace MoleMole
{
	inline static constexpr unsigned int UICpRoleSelectOnlineChildWindowController___c__DisplayClass24_0_TypeDefinitionIndex = 81591;
