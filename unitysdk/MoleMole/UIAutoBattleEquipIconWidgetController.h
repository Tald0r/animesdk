...
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER_BINDITEMDATA_OFFSET UNITYSDK_OFFSET(0xDEF7540)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER_GETCFGID_OFFSET UNITYSDK_OFFSET(0xDEF7D50)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xDEF77D0)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEF7030)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xDEF7B10)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0xDEF70D0)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDEF7270)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEF7180)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEF6C70)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER_REFRESHICON_OFFSET UNITYSDK_OFFSET(0xDEF7E80)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xDEF7370)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDEF8300)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xDEF8310)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEF8320)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xDEF8390)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0xDEF8400)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDEF8460)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEF84E0)
#define MOLEMOLE_UIAUTOBATTLEEQUIPICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEF8560)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattleEquipIconWidgetController_TypeDefinitionIndex = 71767;
