...
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_FROMQUESTID_OFFSET UNITYSDK_OFFSET(0x99AEE60)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x99AF220)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_GET_ITEMNUM_OFFSET UNITYSDK_OFFSET(0x99AF3A0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x99AF0B0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_GET_REWARDPREVIEW_OFFSET UNITYSDK_OFFSET(0x99AEF10)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x99AEF00)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookAwakenItemRewardContext_TypeDefinitionIndex = 53536;
