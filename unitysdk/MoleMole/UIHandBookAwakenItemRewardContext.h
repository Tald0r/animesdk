...
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_FROMQUESTID_OFFSET UNITYSDK_OFFSET(0xC0085D0)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0xC008990)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_GET_ITEMNUM_OFFSET UNITYSDK_OFFSET(0xC008B10)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC008820)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT_GET_REWARDPREVIEW_OFFSET UNITYSDK_OFFSET(0xC008680)
#define MOLEMOLE_UIHANDBOOKAWAKENITEMREWARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC008670)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookAwakenItemRewardContext_TypeDefinitionIndex = 69365;
