...
#define MOLEMOLE_UIFRIENDSETTINGROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95F3000)
#define MOLEMOLE_UIFRIENDSETTINGROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x95F3180)
#define MOLEMOLE_UIFRIENDSETTINGROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95F30A0)
#define MOLEMOLE_UIFRIENDSETTINGROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95F2E50)
#define MOLEMOLE_UIFRIENDSETTINGROWWIDGETCONTROLLER_SWITCHSOCIALSETTING_OFFSET UNITYSDK_OFFSET(0x95F3440)
#define MOLEMOLE_UIFRIENDSETTINGROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x95F35A0)
#define MOLEMOLE_UIFRIENDSETTINGROWWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__5_0_OFFSET UNITYSDK_OFFSET(0x95F35B0)
#define MOLEMOLE_UIFRIENDSETTINGROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95F35C0)
#define MOLEMOLE_UIFRIENDSETTINGROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x95F3630)
#define MOLEMOLE_UIFRIENDSETTINGROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95F36B0)
#define MOLEMOLE_UIFRIENDSETTINGROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95F3730)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendSettingRowWidgetController_TypeDefinitionIndex = 52544;

	class UIFriendSettingRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_814741BDEE96A7A7* _view; // 0x2D0
		::Class_2_2F3C7D4EFC74D485* _model; // 0x2D8
		::MoleMole::UIGeneralToggleWidgetController* _toggle; // 0x2E0
		::Enum_3_E5FA93B9DBF71D99 settingType; // 0x2E8
