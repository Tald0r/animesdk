...
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC10C640)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC10C6B0)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC10C770)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC10C850)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC10CAB0)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC10CAC0)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC10CB30)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotCourseChapterWidgetController_TypeDefinitionIndex = 38621;
