...
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAD8B000)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAD8B070)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAD8B130)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAD8B210)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD8B470)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAD8B480)
#define MOLEMOLE_UIINTERKNOTCOURSECHAPTERWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAD8B4F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotCourseChapterWidgetController_TypeDefinitionIndex = 77426;
