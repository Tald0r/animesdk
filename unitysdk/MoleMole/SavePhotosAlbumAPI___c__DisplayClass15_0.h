...
#define MOLEMOLE_SAVEPHOTOSALBUMAPI___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB2FD9B0)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI___C__DISPLAYCLASS15_0__REQUESTPHOTOPERMISSIONBYMHYSDK_B__0_OFFSET UNITYSDK_OFFSET(0xB2FD9C0)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI___C__DISPLAYCLASS15_0__REQUESTPHOTOPERMISSIONBYMHYSDK_B__1_OFFSET UNITYSDK_OFFSET(0xB2FDA60)

namespace MoleMole
{
	inline static constexpr unsigned int SavePhotosAlbumAPI___c__DisplayClass15_0_TypeDefinitionIndex = 71948;
