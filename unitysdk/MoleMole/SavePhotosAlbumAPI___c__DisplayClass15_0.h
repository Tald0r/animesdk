...
#define MOLEMOLE_SAVEPHOTOSALBUMAPI___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB872380)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI___C__DISPLAYCLASS15_0__REQUESTPHOTOPERMISSIONBYMHYSDK_B__0_OFFSET UNITYSDK_OFFSET(0xB872390)
#define MOLEMOLE_SAVEPHOTOSALBUMAPI___C__DISPLAYCLASS15_0__REQUESTPHOTOPERMISSIONBYMHYSDK_B__1_OFFSET UNITYSDK_OFFSET(0xB872430)

namespace MoleMole
{
	inline static constexpr unsigned int SavePhotosAlbumAPI___c__DisplayClass15_0_TypeDefinitionIndex = 60278;
