...
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9E77CC0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS7_0__SHOWMISSIONFINISHANDHIDE_B__0_OFFSET UNITYSDK_OFFSET(0x9E77CD0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS7_0__SHOWMISSIONFINISHANDHIDE_B__1_OFFSET UNITYSDK_OFFSET(0x9E77D20)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMissionWidgetController___c__DisplayClass7_0_TypeDefinitionIndex = 64037;
