...
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x984DD40)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS7_0__SHOWMISSIONFINISHANDHIDE_B__0_OFFSET UNITYSDK_OFFSET(0x984DD50)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS7_0__SHOWMISSIONFINISHANDHIDE_B__1_OFFSET UNITYSDK_OFFSET(0x984DDA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMissionWidgetController___c__DisplayClass7_0_TypeDefinitionIndex = 53706;
