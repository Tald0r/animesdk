...
class Class_2_403404F5338DE6EE;
...
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_DOREFRESHTEXTALPHA_OFFSET UNITYSDK_OFFSET(0x99F1B10)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_DOREFRESHTEXTSCALE_OFFSET UNITYSDK_OFFSET(0x99F1820)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_GETDAMAGETEXTLENGTH_OFFSET UNITYSDK_OFFSET(0x99F12D0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_MANUALUPDATEANIMATION_OFFSET UNITYSDK_OFFSET(0x99F13A0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x99F0B70)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_ONPAUSEGAMESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x99F0F80)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x99F0D30)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x99F0DA0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x99F0C10)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x99F0C80)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_ONUPDATETEXT_OFFSET UNITYSDK_OFFSET(0x99F0E30)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_REFRESHCOMBINEDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x99F1610)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_SETADDALPHA_OFFSET UNITYSDK_OFFSET(0x99F1A00)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_SETADDSCALE_OFFSET UNITYSDK_OFFSET(0x99F17A0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_SETROOTALPHA_OFFSET UNITYSDK_OFFSET(0x99F1C30)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_SETROOTSCALE_OFFSET UNITYSDK_OFFSET(0x99F1BB0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_SETUPVIEWCOMBINE_OFFSET UNITYSDK_OFFSET(0x99F1480)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x99F10D0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x99F1D40)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER___BASE_GETDAMAGETEXTLENGTH_OFFSET UNITYSDK_OFFSET(0x99F1DD0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x99F1E40)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER___BASE_ONPAUSEGAMESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x99F1EB0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x99F1F20)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x99F1F30)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x99F1F40)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x99F1F50)
#define MOLEMOLE_UIINLEVELDAMAGETEXTTMPCHILDWINDOWCONTROLLER___BASE_ONUPDATETEXT_OFFSET UNITYSDK_OFFSET(0x99F1FC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelDamageTextTMPChildWindowController_TypeDefinitionIndex = 76259;

	class UIInLevelDamageTextTMPChildWindowController : public ::MoleMole::UIInLevelDamageTextBaseController
	{
	public:
		::System::Single _addScale; // 0x370
		::System::Single _addAlpha; // 0x374
		::System::Single _rootScale; // 0x378
		::System::Single _rootAlpha; // 0x37C
		::Class_2_403404F5338DE6EE* _view; // 0x380
