...
#define MOLEMOLE_UIINTERKNOTPAGECONFIG_GETCOLORCONFIGBYTYPE_OFFSET UNITYSDK_OFFSET(0x98AD970)
#define MOLEMOLE_UIINTERKNOTPAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x98ADB10)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotPageConfig_TypeDefinitionIndex = 45198;
