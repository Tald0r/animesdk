...
#define MOLEMOLE_COLORHSV_EQUALS_OFFSET UNITYSDK_OFFSET(0x4D11E0)
#define MOLEMOLE_COLORHSV_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x4D11F0)
#define MOLEMOLE_COLORHSV_METHOD_2_0BF8162BD55D7016_OFFSET UNITYSDK_OFFSET(0xE2AE000)
#define MOLEMOLE_COLORHSV_METHOD_2_1B3EDB277B9F7AE7_OFFSET UNITYSDK_OFFSET(0xE2AE7F0)
#define MOLEMOLE_COLORHSV_METHOD_2_214DF8B0A83E434D_OFFSET UNITYSDK_OFFSET(0xE2AE5E0)
#define MOLEMOLE_COLORHSV_METHOD_2_4DB3384D86E03AF1_OFFSET UNITYSDK_OFFSET(0xE2ADF30)
#define MOLEMOLE_COLORHSV_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x4D12B0)
#define MOLEMOLE_COLORHSV_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x4D1320)
#define MOLEMOLE_COLORHSV_METHOD_2_9ACADD854D7C1F45_OFFSET UNITYSDK_OFFSET(0xE2AE3A0)
#define MOLEMOLE_COLORHSV_METHOD_2_BFE62A4F0DBF4601_OFFSET UNITYSDK_OFFSET(0xE2AE110)
#define MOLEMOLE_COLORHSV_METHOD_2_F44F79F49F8F2E0B_OFFSET UNITYSDK_OFFSET(0xE2AE1F0)
#define MOLEMOLE_COLORHSV__CTOR_1_OFFSET UNITYSDK_OFFSET(0x4D11B0)
#define MOLEMOLE_COLORHSV__CTOR_OFFSET UNITYSDK_OFFSET(0x3B6F20)

namespace MoleMole
{
	inline static constexpr unsigned int ColorHSV_TypeDefinitionIndex = 40435;
