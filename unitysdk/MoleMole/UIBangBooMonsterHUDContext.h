...
#define MOLEMOLE_UIBANGBOOMONSTERHUDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xDC5BD70)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooMonsterHUDContext_TypeDefinitionIndex = 45904;
