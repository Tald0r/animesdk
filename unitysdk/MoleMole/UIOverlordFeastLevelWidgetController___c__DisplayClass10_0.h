...
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD385A00)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___C__DISPLAYCLASS10_0__DOREFRESHVIEWWITHLEVELUPGRADE_B__0_OFFSET UNITYSDK_OFFSET(0xD385A10)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___C__DISPLAYCLASS10_0__DOREFRESHVIEWWITHLEVELUPGRADE_B__1_OFFSET UNITYSDK_OFFSET(0xD385BB0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___C__DISPLAYCLASS10_0__DOREFRESHVIEWWITHLEVELUPGRADE_B__2_OFFSET UNITYSDK_OFFSET(0xD385C10)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastLevelWidgetController___c__DisplayClass10_0_TypeDefinitionIndex = 68843;
	...
	public:
		...
		::MoleMole::UIOverlordFeastLevelWidgetController* __4__this; // 0x20
