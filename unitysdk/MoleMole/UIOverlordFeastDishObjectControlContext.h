...
#define MOLEMOLE_UIOVERLORDFEASTDISHOBJECTCONTROLCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD799B10)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastDishObjectControlContext_TypeDefinitionIndex = 68140;
	...
	public:
		...
		::System::Action_2<::System::Int32, ::UnityEngine::EventSystems::PointerEventData*>* OnEndDrag; // 0x40
		::System::Action_2<::System::Int32, ::UnityEngine::EventSystems::PointerEventData*>* OnDrag; // 0x48
		::Class_2_208CC9941471731A_711* DishConfig; // 0x50
