...
#define MOLEMOLE_UIOVERLORDFEASTDISHOBJECTCONTROLCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCA38660)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastDishObjectControlContext_TypeDefinitionIndex = 64182;

	class UIOverlordFeastDishObjectControlContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_2_208CC9941471731A_246* DishConfig; // 0x28
		...
		::System::Action_1<::System::Int32>* OnRemove; // 0x48
