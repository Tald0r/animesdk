...
#define MOLEMOLE_UIACTIVITYTEMPLECOMPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC099A30)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityTempleCompContext_TypeDefinitionIndex = 72881;
