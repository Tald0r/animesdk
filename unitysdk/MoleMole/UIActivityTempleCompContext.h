...
#define MOLEMOLE_UIACTIVITYTEMPLECOMPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD003510)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityTempleCompContext_TypeDefinitionIndex = 62164;
