...
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER_CREATEREWARDITEMSCROLL_OFFSET UNITYSDK_OFFSET(0xBEDE1C0)
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER_GET_CURREWARDTAKESTATE_OFFSET UNITYSDK_OFFSET(0xBEDDFC0)
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBEDD510)
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBEDD690)
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBEDD5B0)
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBEDD470)
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER_REFRESHTAKEBTNSTATE_OFFSET UNITYSDK_OFFSET(0xBEDDCC0)
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBEDE570)
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__8_0_OFFSET UNITYSDK_OFFSET(0xBEDE630)
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__8_1_OFFSET UNITYSDK_OFFSET(0xBEDE8E0)
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBEDE9E0)
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBEDEA50)
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBEDEAD0)
#define MOLEMOLE_UIBOSSCHALLENGEREWARDITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBEDEB50)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeRewardItemWidgetController_TypeDefinitionIndex = 76320;
	...
	public:
		...
		::Class_1_C4544004F26734BD_82* _rewardTemplate; // 0x2D8
