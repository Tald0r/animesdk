...
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER___C__DISPLAYCLASS91_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA41E510)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER___C__DISPLAYCLASS91_0__SETQUESTTEXTFUNC_B__0_OFFSET UNITYSDK_OFFSET(0xA41E520)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsRowWidgetController___c__DisplayClass91_0_TypeDefinitionIndex = 70850;

	class UIMissionTipsRowWidgetController___c__DisplayClass91_0 : public ::System::Object
	{
	public:
		::Class_0_16E4307DCC419505_17* questCondition; // 0x10
