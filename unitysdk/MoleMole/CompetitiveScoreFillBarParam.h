...
#define MOLEMOLE_COMPETITIVESCOREFILLBARPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x6FC13A0)

namespace MoleMole
{
	inline static constexpr unsigned int CompetitiveScoreFillBarParam_TypeDefinitionIndex = 38246;
