...
#define MOLEMOLE_UIYOROZUYACONFIG_GETCOLORCONFIGBYTYPE_OFFSET UNITYSDK_OFFSET(0xACFC5B0)
#define MOLEMOLE_UIYOROZUYACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xACFC6B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaConfig_TypeDefinitionIndex = 48133;
