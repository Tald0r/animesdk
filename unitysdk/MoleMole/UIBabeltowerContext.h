...
#define MOLEMOLE_UIBABELTOWERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xDC589F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerContext_TypeDefinitionIndex = 55715;
