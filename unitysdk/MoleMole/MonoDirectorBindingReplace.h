...
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_AWAKE_OFFSET UNITYSDK_OFFSET(0x6EA7ED0)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_COLLECTBINDINGDICT_OFFSET UNITYSDK_OFFSET(0x6EA7F40)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_COLLECTBRANCHBINDINGDICT_OFFSET UNITYSDK_OFFSET(0x6EA8790)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_GETTRACKBINDING_OFFSET UNITYSDK_OFFSET(0x6EA95B0)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_GET_ISBRANCHTIMELINEV2_OFFSET UNITYSDK_OFFSET(0x6EA7E50)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_ISANIMATIONTRACK_OFFSET UNITYSDK_OFFSET(0x6EA9970)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_SETANIMATIONTRACKBLENDTARGET_OFFSET UNITYSDK_OFFSET(0x6EA9C70)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_SETANIMATIONTRACKOUTPUTWEIGHT_1_OFFSET UNITYSDK_OFFSET(0x6EAA130)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_SETANIMATIONTRACKOUTPUTWEIGHT_OFFSET UNITYSDK_OFFSET(0x6EA9FC0)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE_SETTRACKDYNAMIC_OFFSET UNITYSDK_OFFSET(0x6EA9200)
#define MOLEMOLE_MONODIRECTORBINDINGREPLACE__CTOR_OFFSET UNITYSDK_OFFSET(0x6EAA450)

namespace MoleMole
{
	inline static constexpr unsigned int MonoDirectorBindingReplace_TypeDefinitionIndex = 79476;
