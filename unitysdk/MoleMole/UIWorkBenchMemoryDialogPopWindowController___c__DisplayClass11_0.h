...
#define MOLEMOLE_UIWORKBENCHMEMORYDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x93925C0)
#define MOLEMOLE_UIWORKBENCHMEMORYDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS11_0__SELECTEDMEMORY_B__0_OFFSET UNITYSDK_OFFSET(0x93925D0)
#define MOLEMOLE_UIWORKBENCHMEMORYDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS11_0__SELECTEDMEMORY_B__1_OFFSET UNITYSDK_OFFSET(0x9392760)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchMemoryDialogPopWindowController___c__DisplayClass11_0_TypeDefinitionIndex = 76617;

	class UIWorkBenchMemoryDialogPopWindowController___c__DisplayClass11_0 : public ::System::Object
	{
	public:
		::System::Action* __9__1; // 0x10
		::Class_2_208CC9941471731A_655* templateData; // 0x18
		::MoleMole::UIWorkBenchMemoryDialogPopWindowController_Context* context; // 0x20
