...
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB71C090)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xB71C210)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB71C2A0)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB71C130)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB71BE30)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB71CCA0)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB71CCB0)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xB71CD20)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB71CD90)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB71CE10)
#define MOLEMOLE_UIABYSSS2REWARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB71CE90)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RewardWidgetController_TypeDefinitionIndex = 41441;

	class UIAbyssS2RewardWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_E3273D40BBA403A7* _view; // 0x2D0
		::Class_3_6EF456A21AE85EEC_84* TurntableItem; // 0x2D8
