...
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_BUILDSPHELPER_OFFSET UNITYSDK_OFFSET(0xAE1E500)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_CLEARSPBARSTEP_OFFSET UNITYSDK_OFFSET(0xAE1D770)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_GET_CURINFOCFG_OFFSET UNITYSDK_OFFSET(0xAE1FE20)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAE194C0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAE194D0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_HANDLEMOUSESCROLL_OFFSET UNITYSDK_OFFSET(0xAE1BA40)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_INITSP_OFFSET UNITYSDK_OFFSET(0xAE1CA20)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xAE19C50)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONBEFOREOPENNEWBIE_OFFSET UNITYSDK_OFFSET(0xAE1F7B0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAE19540)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xAE1FA80)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAE1A820)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xAE1C470)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONPREVIEWCHANGE_OFFSET UNITYSDK_OFFSET(0xAE1DAB0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0xAE1FB50)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONSKILLINPUTMUTE_OFFSET UNITYSDK_OFFSET(0xAE1F600)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE1A7B0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE19830)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE19640)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITCHANGE_OFFSET UNITYSDK_OFFSET(0xAE1BCC0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITCHANGE_PANEL_OFFSET UNITYSDK_OFFSET(0xAE1CCC0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITMODIFIED_OFFSET UNITYSDK_OFFSET(0xAE1E6D0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITSELECTED_OFFSET UNITYSDK_OFFSET(0xAE1F1F0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITTRYSELECT_OFFSET UNITYSDK_OFFSET(0xAE1ECD0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_RESETCAMERALOCK_OFFSET UNITYSDK_OFFSET(0xAE1B310)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xAE1D5E0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SETSPBARMATERIAL_OFFSET UNITYSDK_OFFSET(0xAE1E050)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SHOWSKILLINFO_OFFSET UNITYSDK_OFFSET(0xAE1B710)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SWITCHLOCKTARGET_OFFSET UNITYSDK_OFFSET(0xAE1B030)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAE1FCD0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xAE1FF30)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE1FE50)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER__HANDLEMOUSESCROLL_B__53_0_OFFSET UNITYSDK_OFFSET(0xAE20070)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAE20080)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAE200F0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE20120)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE20130)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE20140)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex = 49747;
	...
	public:
		...
		{
			return (::Il2CppArray<::MoleMole::LogicButtonInputType>**)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x452D0);
		}
		static ::Il2CppArray<::MoleMole::InputLogicEventType>** StaticGet_BUTTON_INPUT_EVENT()
		{
			return (::Il2CppArray<::MoleMole::InputLogicEventType>**)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x452D8);
		}
		static ::System::Int32* StaticGet_WaveHeightShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x110C0);
		}
		static ::System::Int32* StaticGet_StepColorBShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x110C4);
		}
		static ::System::Int32* StaticGet_StepColorAShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x110C8);
		}
		static ::System::Int32* StaticGet_StepPosShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x110CC);
		}
		...
		::Class_3_4CC9DF6D10E3002D_Class_4_70913AC4DAB8FEAC* _spBarView; // 0x318
		::UIControllerExtensionData* _extData; // 0x320
		::MoleMole::UIMonsterFantasyInLevelMainPageController* _parentCtrl; // 0x328
		::Class_1_7A5F167CAAA013FB* _curFighterData; // 0x330
		...
		::Class_2_208CC9941471731A_201* get_CurInfoCfg()
		{
			return ((::Class_2_208CC9941471731A_201*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_GET_CURINFOCFG_OFFSET))(this);
		}

		::System::Void ShowSkillInfo(::Class_2_208CC9941471731A_201* cfg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_201*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SHOWSKILLINFO_OFFSET))(this, cfg);
		}
