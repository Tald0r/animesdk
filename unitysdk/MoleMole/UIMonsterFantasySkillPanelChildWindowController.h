...
class Class_3_C629870C335D0378_Class_4_70913AC4DAB8FEAC_2;
...
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_BUILDSPHELPER_OFFSET UNITYSDK_OFFSET(0x98E5A30)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_CLEARSPBARSTEP_OFFSET UNITYSDK_OFFSET(0x98E4C80)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_GET_CURINFOCFG_OFFSET UNITYSDK_OFFSET(0x98E7360)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x98E09D0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x98E09E0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_HANDLEMOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x98E2F50)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_INITSP_OFFSET UNITYSDK_OFFSET(0x98E3F30)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x98E1150)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONBEFOREOPENNEWBIE_OFFSET UNITYSDK_OFFSET(0x98E6CE0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x98E0A50)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x98E6FC0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x98E1D30)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x98E3980)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONPREVIEWCHANGE_OFFSET UNITYSDK_OFFSET(0x98E4FD0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0x98E7090)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONSKILLINPUTMUTE_OFFSET UNITYSDK_OFFSET(0x98E6B30)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98E1CC0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98E0D30)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98E0B50)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITCHANGE_OFFSET UNITYSDK_OFFSET(0x98E31D0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITCHANGE_PANEL_OFFSET UNITYSDK_OFFSET(0x98E41D0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITMODIFIED_OFFSET UNITYSDK_OFFSET(0x98E5C00)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITSELECTED_OFFSET UNITYSDK_OFFSET(0x98E6720)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_ONUNITTRYSELECT_OFFSET UNITYSDK_OFFSET(0x98E6200)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_RESETCAMERALOCK_OFFSET UNITYSDK_OFFSET(0x98E2820)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x98E4AF0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SETSPBARMATERIAL_OFFSET UNITYSDK_OFFSET(0x98E5570)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SHOWSKILLINFO_OFFSET UNITYSDK_OFFSET(0x98E2C20)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SWITCHLOCKTARGET_OFFSET UNITYSDK_OFFSET(0x98E2540)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x98E7210)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x98E7470)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98E7390)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER__HANDLEMOUSESCROLL_B__53_0_OFFSET UNITYSDK_OFFSET(0x98E75B0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x98E75C0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x98E7630)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98E7660)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98E7670)
#define MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98E7680)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex = 45882;
	...
	public:
		...
		{
			return (::Il2CppArray<::MoleMole::InputLogicEventType>**)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x44100);
		}
		static ::Il2CppArray<::MoleMole::LogicButtonInputType>** StaticGet_BUTTON_INPUT_TYPE()
		{
			return (::Il2CppArray<::MoleMole::LogicButtonInputType>**)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x44108);
		}
		static ::System::Int32* StaticGet_WaveHeightShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x113F0);
		}
		static ::System::Int32* StaticGet_StepPosShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x113F4);
		}
		static ::System::Int32* StaticGet_StepColorBShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x113F8);
		}
		static ::System::Int32* StaticGet_StepColorAShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasySkillPanelChildWindowController_TypeDefinitionIndex)->GetStaticField(0x113FC);
		}
		// static const ::System::Int32 MAX_SKILL_COUNT = 0x3; // 0x0
		::System::String* FillMatPath_CurSP; // 0x2F8
		::UnityEngine::Material* spMat; // 0x300
		::Il2CppArray<::MoleMole::UIMonsterFantasySkillButtonChildWindowController*>* _skillBtns; // 0x308
		::Class_1_48D56DACBE4271BC* _syncHelper; // 0x310
		::Class_3_C629870C335D0378_Class_4_70913AC4DAB8FEAC_2* _spBarView; // 0x318
		::UIControllerExtensionData* _extData; // 0x320
		::MoleMole::UIMonsterFantasyInLevelMainPageController* _parentCtrl; // 0x328
		::Class_1_15CCFE77B9E12299* _curFighterData; // 0x330
		::Class_2_3BEB019E352B28D9_1* _hudHelper_sp; // 0x338
		::Class_2_3BEB019E352B28D9_1_Class_2_A56950714DAA0424* _spIDataBindModel; // 0x340
		::MoleMole::UIMonsterFantasySkillPanelChildWindowController_SpDataBindView* _spIDataBindView; // 0x348
		::MoleMole::UIMonsterFantasySkillInfoWidgetController* _infoCtrl; // 0x350
		::System::Boolean _scrollInCD; // 0x358
		...
		::Class_2_208CC9941471731A_867* get_CurInfoCfg()
		{
			return ((::Class_2_208CC9941471731A_867*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_GET_CURINFOCFG_OFFSET))(this);
		}

		::System::Void ShowSkillInfo(::Class_2_208CC9941471731A_867* cfg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_867*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMONSTERFANTASYSKILLPANELCHILDWINDOWCONTROLLER_SHOWSKILLINFO_OFFSET))(this, cfg);
		}
