...
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_GETABYSSPOINT_OFFSET UNITYSDK_OFFSET(0xB946C80)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_GET_HEADID_OFFSET UNITYSDK_OFFSET(0xB946660)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ISSELECT_OFFSET UNITYSDK_OFFSET(0xB9479E0)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xB946A50)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB946190)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB947940)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB946310)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB946230)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB945E50)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_REFRESHUIBYPOINTROOTSTATE_OFFSET UNITYSDK_OFFSET(0xB946680)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_SELECTHEATBUFF_OFFSET UNITYSDK_OFFSET(0xB946CF0)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_SETHEATID_OFFSET UNITYSDK_OFFSET(0xB9465D0)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_SETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xB947440)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xB947620)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB947A50)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB947A60)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB947AD0)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB947B50)
#define MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB947BD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2HeatRowWidgetController_TypeDefinitionIndex = 41950;
	...
	public:
		...
		::Class_2_208CC9941471731A_495* _config; // 0x308
		...
		::System::Void SetHeatID(::Class_2_208CC9941471731A_495* heatConfig, ::System::Int32 index)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_495*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2HEATROWWIDGETCONTROLLER_SETHEATID_OFFSET))(this, heatConfig, index);
		}
