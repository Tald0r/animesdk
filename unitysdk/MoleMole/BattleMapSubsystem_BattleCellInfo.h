...
#define MOLEMOLE_BATTLEMAPSUBSYSTEM_BATTLECELLINFO_ISEMPTYINFO_OFFSET UNITYSDK_OFFSET(0x3547E0)

namespace MoleMole
{
	inline static constexpr unsigned int BattleMapSubsystem_BattleCellInfo_TypeDefinitionIndex = 44205;
