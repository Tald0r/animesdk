...
#define MOLEMOLE_CONFIGUIMAINPAGESKINSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x139B0420)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainPageSkinShow_TypeDefinitionIndex = 47615;
