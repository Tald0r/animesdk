...
#define MOLEMOLE_CONFIGUIMAINPAGESKINSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x91A2A30)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainPageSkinShow_TypeDefinitionIndex = 65628;
