...
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ADDBANGBOOEXPECTSELF_OFFSET UNITYSDK_OFFSET(0x9CCB380)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_CREATEANDINITAIMANAGER_OFFSET UNITYSDK_OFFSET(0x9CCDE50)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_CREATEANDINITMOVINGWALLAIMANAGER_OFFSET UNITYSDK_OFFSET(0x9CCDF60)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_CREATEDEFAULTCHEATDETECTOR_OFFSET UNITYSDK_OFFSET(0x9CCE1C0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_CREATEORMODIFYCHEATDETECTOR_OFFSET UNITYSDK_OFFSET(0x9CCE0E0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_DESTROYMOVINGWALLAIMANAGER_OFFSET UNITYSDK_OFFSET(0x9CCE020)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_DOHIDEORIBUDDY_OFFSET UNITYSDK_OFFSET(0x9CCCEB0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_DOUNSETBATTLEINOUTSTATE_OFFSET UNITYSDK_OFFSET(0x9CCCCD0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GETBANGBOOEXPECTSELF_OFFSET UNITYSDK_OFFSET(0x9CCB4E0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GETQUESTID_OFFSET UNITYSDK_OFFSET(0x9CCE960)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_AIMANAGER_OFFSET UNITYSDK_OFFSET(0x9CCDD20)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_CHEATDETECTOR_OFFSET UNITYSDK_OFFSET(0x9CCDD40)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_EXITTELEPORTID_OFFSET UNITYSDK_OFFSET(0x9CCB340)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_GAMESTATE_OFFSET UNITYSDK_OFFSET(0x9CCD260)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_ISCOLLISIONENABLED_OFFSET UNITYSDK_OFFSET(0x9CCDCB0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_ISINHENSHINBUDDYSTATUS_OFFSET UNITYSDK_OFFSET(0x9CCB320)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_OFFSET UNITYSDK_OFFSET(0x9CCD160)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_GET_RESTARTTELEPORTID_OFFSET UNITYSDK_OFFSET(0x9CCB360)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_HANDLEPARTYGAMECHEATENOTIFY_OFFSET UNITYSDK_OFFSET(0x9CCF2B0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x9CCB570)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONCHANGETOAUTHORITY_OFFSET UNITYSDK_OFFSET(0x9CCE620)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9CCBF90)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONGAMESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x9CCD270)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONMARCELMOVETOPODIUM_OFFSET UNITYSDK_OFFSET(0x9CCEF80)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONMPPARTYGAMERESULTSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x9CCEB50)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONREBORN_OFFSET UNITYSDK_OFFSET(0x9CCE270)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONRESET_OFFSET UNITYSDK_OFFSET(0x9CCDD50)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x9CCC340)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_RECOVERDISPLAYENTITIES_OFFSET UNITYSDK_OFFSET(0x9CCC940)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_REGISTERAIBUDDY_OFFSET UNITYSDK_OFFSET(0x9CCE300)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SAVEBEREPLACEENTITY_OFFSET UNITYSDK_OFFSET(0x9CCC5C0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SETEXITTELEPORTID_OFFSET UNITYSDK_OFFSET(0x9CCD080)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SETHENSHINBUDDYSTATUS_OFFSET UNITYSDK_OFFSET(0x9CCCB90)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SETPLAYERMULTIPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x9CCB740)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SETRESTARTTELEPORTID_OFFSET UNITYSDK_OFFSET(0x9CCD0F0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SET_AIMANAGER_OFFSET UNITYSDK_OFFSET(0x9CCDD30)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SET_EXITTELEPORTID_OFFSET UNITYSDK_OFFSET(0x9CCB350)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SET_GAMESTATE_OFFSET UNITYSDK_OFFSET(0x9CCC540)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SET_ISINHENSHINBUDDYSTATUS_OFFSET UNITYSDK_OFFSET(0x9CCB330)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_SET_RESTARTTELEPORTID_OFFSET UNITYSDK_OFFSET(0x9CCB370)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM_UNREGISTERAIBUDDY_OFFSET UNITYSDK_OFFSET(0x9CCE490)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9CCF4E0)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x9CCF600)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9CCF660)
#define MOLEMOLE_BANGBOOGAMESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x9CCF6C0)

namespace MoleMole
{
	inline static constexpr unsigned int BangbooGameSubsystem_TypeDefinitionIndex = 59791;

	class BangbooGameSubsystem : public ::MoleMole::GameSubsystemBase
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::EntityHandle>* _bangBooExpectSelf; // 0x10
		::MoleMole::EntityHandle bangbooEntity; // 0x18
		::Class_1_E2E218F351383360* _cheatDetector; // 0x28
		::System::Collections::Generic::List_1<::MoleMole::EntityHandle>* refReplacedEntityHandles; // 0x30
		::MoleMole::EntityHandle beReplacedEntityHandle; // 0x38
		::System::Collections::Generic::HashSet_1<::System::UInt32>* quitPlayerSet; // 0x48
		::Class_1_33B50469231C7D95* _aiManager; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* rankInfo; // 0x58
		::System::Collections::Generic::HashSet_1<::System::UInt32>* reachedPlayers; // 0x60
		::System::Int32 levelEndTimeMs; // 0x68
		::System::Int32 _exitTeleportID_k__BackingField; // 0x6C
		::System::Int64 StartCountDownTime; // 0x70
		::Enum_3_C24BA36B4CDB26BB _gameState; // 0x78
		::Enum_3_C24BA36B4CDB26BB curState; // 0x7C
		::System::Int32 levelTotalTimeSeconds; // 0x80
		::MoleMole::Level::BangbooPlayType curPlayType; // 0x84
		::System::Int64 StopCountDownTime; // 0x88
		::System::Int64 StartTimelineTime; // 0x90
		::System::Int32 _restartTeleportID_k__BackingField; // 0x98
		::System::Boolean _isInHenshinBuddyStatus_k__BackingField; // 0x9C
		::System::Boolean IsInHenshinMazinger; // 0x9D
		::System::Boolean isSlideAILevel; // 0x9E
		...
		::System::Void CreateAndInitAIManager(::Enum_3_0A3761FE34514D6C_42 playType)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_0A3761FE34514D6C_42))((::PBYTE)hIl2Cpp + MOLEMOLE_BANGBOOGAMESUBSYSTEM_CREATEANDINITAIMANAGER_OFFSET))(this, playType);
		}
