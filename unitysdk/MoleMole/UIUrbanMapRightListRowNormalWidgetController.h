...
class Class_2_0C6B7F8AA81830C8;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }
namespace System { class Object; }

#define MOLEMOLE_UIURBANMAPRIGHTLISTROWNORMALWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x971E0B0)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWNORMALWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x971E120)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWNORMALWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x971E590)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWNORMALWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x971E3D0)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWNORMALWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x971E220)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWNORMALWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x971E800)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWNORMALWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x971E810)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWNORMALWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x971E880)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWNORMALWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x971E8E0)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWNORMALWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x971E960)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapRightListRowNormalWidgetController_TypeDefinitionIndex = 59973;
	...
	public:
		...
		::Class_2_0C6B7F8AA81830C8* get__viewModel()
		{
			return ((::Class_2_0C6B7F8AA81830C8*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIURBANMAPRIGHTLISTROWNORMALWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
