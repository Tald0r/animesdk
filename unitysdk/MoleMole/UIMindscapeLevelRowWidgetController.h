...
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7D5A110)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONPOPUPSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7D59D10)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONSKINCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x7D5A1B0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7D59C00)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7D5A4D0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7D59860)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7D59A80)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x7D584F0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x7D58750)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_PLAYUNLOCKEFFECT_OFFSET UNITYSDK_OFFSET(0x7D58CD0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x7D5A260)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0x7D56570)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x7D578D0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETLEVELROWCOLOR_OFFSET UNITYSDK_OFFSET(0x7D565E0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETUNLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x7D59D90)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7D5A660)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__PLAYFADEIN_B__21_0_OFFSET UNITYSDK_OFFSET(0x7D5A6C0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__SETDATA_B__17_0_OFFSET UNITYSDK_OFFSET(0x7D5A690)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7D5A730)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7D5A7A0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7D5A7B0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7D5A830)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7D5A890)

namespace MoleMole
{
	inline static constexpr unsigned int UIMindscapeLevelRowWidgetController_TypeDefinitionIndex = 51030;

	class UIMindscapeLevelRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		// static const ::System::String* UnLockAniName; // 0x0
		// static const ::System::String* FadeinAniName; // 0x0
		// static const ::System::String* FadeOutAniName; // 0x0
		::Class_2_79AE422BA06F6D26_150* _view; // 0x2A0
		::Class_2_D89CCC627A66D0AD* _avatarItemData; // 0x2A8
		::System::Int32 _currentSlot; // 0x2B0
		::Class_2_208CC9941471731A_419* _talentCfg; // 0x2B8
		::System::Action_1<::System::Int32>* _clickHandle; // 0x2C0
		::System::Boolean isShowRedPoint; // 0x2C8
		::System::Single fadeInLen; // 0x2CC
		::Foundation::Coroutine::CoroutineHandle fadeinHandle; // 0x2D0
		...
		::System::Void SetData(::Class_2_D89CCC627A66D0AD* avatarItem, ::System::Int32 talentSlot, ::System::Boolean _previewMode, ::System::Boolean _friendPreviewMode)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_D89CCC627A66D0AD*, ::System::Int32, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETDATA_OFFSET))(this, avatarItem, talentSlot, _previewMode, _friendPreviewMode);
		}
		...
		::System::Boolean _SetData_b__17_0(::Class_2_208CC9941471731A_419* o)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_419*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__SETDATA_B__17_0_OFFSET))(this, o);
		}
