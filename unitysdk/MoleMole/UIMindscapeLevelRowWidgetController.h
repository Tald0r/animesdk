...
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8ED6650)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONPOPUPSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8ED6260)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONSKINCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x8ED66F0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8ED6150)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8ED6A10)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8ED5DB0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8ED5FD0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x8ED4880)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x8ED4AE0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_PLAYUNLOCKEFFECT_OFFSET UNITYSDK_OFFSET(0x8ED5060)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8ED67A0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0x8ED28F0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x8ED3C50)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETLEVELROWCOLOR_OFFSET UNITYSDK_OFFSET(0x8ED2960)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER_SETUNLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x8ED62E0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8ED6BA0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__PLAYFADEIN_B__21_0_OFFSET UNITYSDK_OFFSET(0x8ED6C00)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__SETDATA_B__17_0_OFFSET UNITYSDK_OFFSET(0x8ED6BD0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8ED6C70)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8ED6CE0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8ED6CF0)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8ED6D70)
#define MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8ED6DD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMindscapeLevelRowWidgetController_TypeDefinitionIndex = 62315;

	class UIMindscapeLevelRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_218* _view; // 0x2A0
		::Class_2_D89CCC627A66D0AD* _avatarItemData; // 0x2A8
		::System::Int32 _currentSlot; // 0x2B0
		::Class_2_208CC9941471731A_681* _talentCfg; // 0x2B8
		...
		::System::Boolean _SetData_b__17_0(::Class_2_208CC9941471731A_681* o)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_681*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMINDSCAPELEVELROWWIDGETCONTROLLER__SETDATA_B__17_0_OFFSET))(this, o);
		}
