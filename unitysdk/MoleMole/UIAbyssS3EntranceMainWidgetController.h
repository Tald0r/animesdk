...
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB71CF00)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_ONCLICKBTN_OFFSET UNITYSDK_OFFSET(0xB71E0C0)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB71CF70)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB71D130)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0xB71D880)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB71E190)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB71E300)
#define MOLEMOLE_UIABYSSS3ENTRANCEMAINWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB71E370)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS3EntranceMainWidgetController_TypeDefinitionIndex = 67364;
	...
	public:
		...
		::Class_2_208CC9941471731A_538* _entranceConfig; // 0x2B0
		::System::Collections::Generic::List_1<::Class_2_14E7CE92E8A3183F*>* _dungeonConfigList; // 0x2B8
		::Class_2_0A55B5A82A61DAFA* _currSelectQuestConfig; // 0x2C0
		::Class_2_14E7CE92E8A3183F* _currSelectDungeonConfig; // 0x2C8
		::Class_2_F69D29AB796376C2* _questTemplate; // 0x2D0
