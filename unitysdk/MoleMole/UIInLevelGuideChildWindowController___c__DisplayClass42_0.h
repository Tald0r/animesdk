...
#define MOLEMOLE_UIINLEVELGUIDECHILDWINDOWCONTROLLER___C__DISPLAYCLASS42_0__COLLECTARROWITEM_B__0_OFFSET UNITYSDK_OFFSET(0x9C14C60)
#define MOLEMOLE_UIINLEVELGUIDECHILDWINDOWCONTROLLER___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9C14C50)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelGuideChildWindowController___c__DisplayClass42_0_TypeDefinitionIndex = 70580;

	class UIInLevelGuideChildWindowController___c__DisplayClass42_0 : public ::System::Object
	{
	public:
		::MoleMole::UIInLevelGuideItemChildWindowController* item; // 0x10
		::MoleMole::UIInLevelGuideChildWindowController* __4__this; // 0x18
