...
#define MOLEMOLE_UIVIEWMODELREFERENCE_COPYFROMOTHERREFERENCE_OFFSET UNITYSDK_OFFSET(0xEA06510)
#define MOLEMOLE_UIVIEWMODELREFERENCE_GET_BINDCLASSNAME_OFFSET UNITYSDK_OFFSET(0xEA06490)
#define MOLEMOLE_UIVIEWMODELREFERENCE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xEA06850)
#define MOLEMOLE_UIVIEWMODELREFERENCE_SHOWEXPORTDIR_OFFSET UNITYSDK_OFFSET(0xEA064A0)
#define MOLEMOLE_UIVIEWMODELREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xEA068C0)
#define MOLEMOLE_UIVIEWMODELREFERENCE___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xEA06900)
#define MOLEMOLE_UIVIEWMODELREFERENCE___BASE_SHOWEXPORTDIR_OFFSET UNITYSDK_OFFSET(0xEA06910)

namespace MoleMole
{
	inline static constexpr unsigned int UIViewModelReference_TypeDefinitionIndex = 38022;
