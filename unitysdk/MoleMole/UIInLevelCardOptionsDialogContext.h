...
#define MOLEMOLE_UIINLEVELCARDOPTIONSDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7D1EAA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCardOptionsDialogContext_TypeDefinitionIndex = 71270;
