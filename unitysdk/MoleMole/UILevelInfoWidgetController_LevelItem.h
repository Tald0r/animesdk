...
#define MOLEMOLE_UILEVELINFOWIDGETCONTROLLER_LEVELITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA802C10)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelInfoWidgetController_LevelItem_TypeDefinitionIndex = 50570;
	...
	public:
		...
		::System::Boolean changeColor; // 0x19
