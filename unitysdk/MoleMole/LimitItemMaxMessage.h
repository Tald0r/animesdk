...
#define MOLEMOLE_LIMITITEMMAXMESSAGE_DIRECTSHOW_OFFSET UNITYSDK_OFFSET(0x8B18650)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x8B186C0)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x8B18320)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x8B185E0)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_SHOWREWARDWINDOW_OFFSET UNITYSDK_OFFSET(0x8B18730)
#define MOLEMOLE_LIMITITEMMAXMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x8B18330)

namespace MoleMole
{
	inline static constexpr unsigned int LimitItemMaxMessage_TypeDefinitionIndex = 41953;
