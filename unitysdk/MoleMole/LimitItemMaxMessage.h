...
#define MOLEMOLE_LIMITITEMMAXMESSAGE_DIRECTSHOW_OFFSET UNITYSDK_OFFSET(0xB19CEA0)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_DOPROCESS_OFFSET UNITYSDK_OFFSET(0xB19CF10)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xB19CB70)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xB19CE30)
#define MOLEMOLE_LIMITITEMMAXMESSAGE_SHOWREWARDWINDOW_OFFSET UNITYSDK_OFFSET(0xB19CF80)
#define MOLEMOLE_LIMITITEMMAXMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB19CB80)

namespace MoleMole
{
	inline static constexpr unsigned int LimitItemMaxMessage_TypeDefinitionIndex = 63462;
