...
#define MOLEMOLE_UICPPROPDATAROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1AE81A60)
#define MOLEMOLE_UICPPROPDATAROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1AE81AF0)
#define MOLEMOLE_UICPPROPDATAROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1AE81930)
#define MOLEMOLE_UICPPROPDATAROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1AE819C0)
#define MOLEMOLE_UICPPROPDATAROWWIDGETCONTROLLER_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0x1AE81BC0)
#define MOLEMOLE_UICPPROPDATAROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE81F30)
#define MOLEMOLE_UICPPROPDATAROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1AE81F60)
#define MOLEMOLE_UICPPROPDATAROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1AE81FD0)
#define MOLEMOLE_UICPPROPDATAROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1AE82050)
#define MOLEMOLE_UICPPROPDATAROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1AE820B0)

namespace MoleMole
{
	inline static constexpr unsigned int UICpPropDataRowWidgetController_TypeDefinitionIndex = 83494;
