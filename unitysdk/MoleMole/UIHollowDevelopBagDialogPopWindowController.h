...
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_AUTOMOVE_OFFSET UNITYSDK_OFFSET(0x99DE8A0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x99D99A0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_CREATESORT_OFFSET UNITYSDK_OFFSET(0x99DADC0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_GETALLCARDS_OFFSET UNITYSDK_OFFSET(0x99D7770)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_GETCARDCONTENTINDEX_OFFSET UNITYSDK_OFFSET(0x99DCB80)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_GETCHILDBOUNDS_OFFSET UNITYSDK_OFFSET(0x99DBC30)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_GETITEMCTRL_OFFSET UNITYSDK_OFFSET(0x99D9700)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_GETUIELEMENTINFO_OFFSET UNITYSDK_OFFSET(0x99D7020)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x99D5DB0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x99D47C0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_HIDESELECT_OFFSET UNITYSDK_OFFSET(0x99DC4D0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x99DC460)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONCARDCLICK_OFFSET UNITYSDK_OFFSET(0x99DE520)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x99D5DC0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x99DC0C0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONFILTERDROPCHANGE_OFFSET UNITYSDK_OFFSET(0x99DB9B0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x99DA730)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x99DA930)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x99D47D0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONPAGEINDEXCHANGED_OFFSET UNITYSDK_OFFSET(0x99DC3B0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x99DA340)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x99DA5D0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x99D5E60)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x99D9CC0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x99DEFB0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_PREPAREALLITEM_OFFSET UNITYSDK_OFFSET(0x99D67F0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_REFRESHBANGBOOVIEW_OFFSET UNITYSDK_OFFSET(0x99D7900)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_REFRESHBOUNDS_OFFSET UNITYSDK_OFFSET(0x99DC5D0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_REFRESHCARDBAGVIEW_OFFSET UNITYSDK_OFFSET(0x99DAA00)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_REFRESHPAGEINDEX_OFFSET UNITYSDK_OFFSET(0x99D7420)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_REFRESHSIZE_OFFSET UNITYSDK_OFFSET(0x99D7530)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x99D4A60)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_RESETCONTENT_OFFSET UNITYSDK_OFFSET(0x99DEF10)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_RESETMAXPAGECOUNT_OFFSET UNITYSDK_OFFSET(0x99D7370)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_SHOWTIPS_OFFSET UNITYSDK_OFFSET(0x99DCC20)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_UPDATEARROWSTATE_OFFSET UNITYSDK_OFFSET(0x99DED20)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x99DECB0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER__AUTOMOVE_B__35_0_OFFSET UNITYSDK_OFFSET(0x99DF990)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER__AUTOMOVE_B__35_1_OFFSET UNITYSDK_OFFSET(0x99DF9A0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER__AUTOMOVE_B__35_2_OFFSET UNITYSDK_OFFSET(0x99DF9B0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER__CREATESORT_B__21_0_OFFSET UNITYSDK_OFFSET(0x99DF910)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x99DF440)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER__REFRESHBANGBOOVIEW_B__13_0_OFFSET UNITYSDK_OFFSET(0x99DF850)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER__REFRESHBANGBOOVIEW_B__13_1_OFFSET UNITYSDK_OFFSET(0x99DF8B0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x99DF9C0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x99DFA30)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x99DFA60)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x99DFAC0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x99DFAD0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x99DFAE0)
#define MOLEMOLE_UIHOLLOWDEVELOPBAGDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x99DFAF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowDevelopBagDialogPopWindowController_TypeDefinitionIndex = 55010;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::Int32>* bangbooSet; // 0x2F8
		::MoleMole::UIHollowDevelopBagDialogPopWindowController_SortType currentSortType; // 0x300
		::Il2CppArray<::Struct_2_037D21AC29ED1130>* sortParams; // 0x308
		::MoleMole::UIGeneralDynamicTipsPopWindowController* _dropdownSelect; // 0x310
		::Class_2_79F6D62CE30E3F8E_128* _view; // 0x318
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::UIHollowCardItemBtnWidgetController*>* allItems; // 0x320
		::UnityEngine::GameObject* lastSelectCard; // 0x328
		::Class_2_F5737224A0253470* _holloModel; // 0x330
		::Class_2_9D9172C07F82DDAE* _itemModel; // 0x338
		::Class_2_702D914FA95B6E36* _roleModel; // 0x340
		::Class_2_73836654F8931C75* _propertyModel; // 0x348
		::Class_2_61AC41B6DCFBC671* _questModel; // 0x350
		::MonoUIAnimScroll* _scrollRectEx; // 0x358
		::System::Single _dragThreshold; // 0x360
		::System::Int32 _curPageIndex; // 0x364
		::System::Int32 _maxPageIndex; // 0x368
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* _curShowItems; // 0x370
		::System::Int32 _curShowCount; // 0x378
		::System::Int32 _xcount; // 0x37C
		::System::Int32 _ycount; // 0x380
		::System::Collections::Generic::List_1<::MoleMole::UIHollowCardItemBtnWidgetController*>* _uiItemList; // 0x388
		::UnityEngine::RectTransform* _viewRect; // 0x390
		::UnityEngine::Bounds _viewBounds; // 0x398
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Byte>* _itemStatus; // 0x3B0
		::UnityEngine::Vector2 _contentCellSize; // 0x3B8
		::System::Collections::Generic::List_1<::MoleMole::UIHollowDevelopBagDialogPopWindowController_UIArcanFlagItem*>* _arcanFlagItems; // 0x3C0
		::System::Collections::Generic::List_1<::MoleMole::UIHollowDevelopBagDialogPopWindowController_UIArcanFlagItem*>* _bagArcanaFlagItems; // 0x3C8
		::UnityEngine::Animation* _anim; // 0x3D0
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Single>* _minPosition; // 0x3D8
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Single>* _maxPosition; // 0x3E0
		::System::String* EmptyBG; // 0x3E8
		::System::String* curBG; // 0x3F0
		::UnityEngine::GameObject* bgPrefab; // 0x3F8
		::DG::Tweening::Tweener* _autoTweener; // 0x400
		::System::Boolean inited; // 0x408
		::System::Collections::Generic::List_1<::System::Int32>* curItemIndexList; // 0x410
