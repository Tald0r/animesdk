...
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_CREATERT_OFFSET UNITYSDK_OFFSET(0x75AA280)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_GETARCADEGAMEID_OFFSET UNITYSDK_OFFSET(0x75AA660)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_GET_ARCADEGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x75A9880)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_GET_MINIGAMERT_OFFSET UNITYSDK_OFFSET(0x75AA260)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ISGAMEENDSTATE_OFFSET UNITYSDK_OFFSET(0x75A9EB0)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x75A9980)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x75A9D90)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ONENTER_OFFSET UNITYSDK_OFFSET(0x75A9AB0)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x75A9C40)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ONLOADFINISH_OFFSET UNITYSDK_OFFSET(0x75A9E50)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ONMULTIPLAYERINFOBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x75AA740)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ONTITLEVIDEOPLAYSTART_OFFSET UNITYSDK_OFFSET(0x75A9DF0)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ONUFIGHTCONNECTSUCCESS_OFFSET UNITYSDK_OFFSET(0x75A9F80)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ONUFIGHTDISCONNECT_OFFSET UNITYSDK_OFFSET(0x75A9FE0)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ONUFIGHTRECONNECTSUCCESS_OFFSET UNITYSDK_OFFSET(0x75AA0A0)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ONUFIGHTSTARTRECONNECT_OFFSET UNITYSDK_OFFSET(0x75AA040)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ONWILLEXIT_OFFSET UNITYSDK_OFFSET(0x75A9BE0)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_PAUSE_OFFSET UNITYSDK_OFFSET(0x75AA6D0)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_REGISTERLOADFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x75A9F10)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_REGISTERSWITCHARCADEUISHOWSTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0x75AA100)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_RELEASERT_OFFSET UNITYSDK_OFFSET(0x75AA490)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_SETARCADEGAMEID_OFFSET UNITYSDK_OFFSET(0x75AA5C0)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_SETGAMEFINISHACTION_OFFSET UNITYSDK_OFFSET(0x75A9910)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_SETGAMEOVERACTION_OFFSET UNITYSDK_OFFSET(0x75A98A0)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_SET_ARCADEGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x75A9890)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_SET_MINIGAMERT_OFFSET UNITYSDK_OFFSET(0x75AA270)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_SWITCHARCADEUISHOWSTAGE_OFFSET UNITYSDK_OFFSET(0x75AA170)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x75AAAB0)
#define MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x75AAAA0)

namespace MoleMole::MiniGame
{
	inline static constexpr unsigned int MiniGameWorldBase_TypeDefinitionIndex = 40489;

	class MiniGameWorldBase : public ::System::Object
	{
	public:
		static ::System::Collections::Generic::Dictionary_2<::System::Type*, ::Class_0_16E4307DCC419505_228*>** StaticGet_logicDic()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::Class_0_16E4307DCC419505_228*>**)Il2CppClass::FromTypeDefinitionIndex(MiniGameWorldBase_TypeDefinitionIndex)->GetStaticField(0x45F00);
		}
		::Class_2_208CC9941471731A_88* _ArcadeGameConfig_k__BackingField; // 0x10
		::MoleMole::MiniGame::MiniGameContext gameContext; // 0x18
		::System::Action_1<::System::Boolean>* gameOverAction; // 0x58
		::System::Action_3<::System::Boolean, ::System::Action_1<::System::Boolean>*, ::System::Action_1<::System::Boolean>*>* _onSwitchArcadeUIShowStageCB; // 0x60
		::Class_0_16E4307DCC419505_228* gameLogic; // 0x68
		::System::Action* gameFinishAction; // 0x70
		::UnityEngine::RenderTexture* _MiniGameRT_k__BackingField; // 0x78
		...
		::Class_2_208CC9941471731A_88* get_ArcadeGameConfig()
		{
			return ((::Class_2_208CC9941471731A_88*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_GET_ARCADEGAMECONFIG_OFFSET))(this);
		}

		::System::Void set_ArcadeGameConfig(::Class_2_208CC9941471731A_88* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_88*))((::PBYTE)hIl2Cpp + MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_SET_ARCADEGAMECONFIG_OFFSET))(this, value);
		}
		...
		::System::Void OnMultiPlayerInfoBtnClicked(::Enum_3_71AA90D596A09AC8_3 gameType)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_71AA90D596A09AC8_3))((::PBYTE)hIl2Cpp + MOLEMOLE_MINIGAME_MINIGAMEWORLDBASE_ONMULTIPLAYERINFOBTNCLICKED_OFFSET))(this, gameType);
		}
	};
}
