...
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_CHILDTRIGGERFORWARDER_INITIALIZESTREAMING_OFFSET UNITYSDK_OFFSET(0xC2D9C80)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_CHILDTRIGGERFORWARDER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC2D9A40)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_CHILDTRIGGERFORWARDER_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0xC2D9CF0)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_CHILDTRIGGERFORWARDER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2D9DA0)

namespace MoleMole::MiniGame::BangbooPartyGame
{
	inline static constexpr unsigned int ChildTriggerForwarder_TypeDefinitionIndex = 70680;
