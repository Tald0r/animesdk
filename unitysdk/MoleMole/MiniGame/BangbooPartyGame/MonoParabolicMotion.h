...
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION_METHOD_5_10867B69EFBCA83E_OFFSET UNITYSDK_OFFSET(0x67AB720)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x67AB5D0)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0x67AB670)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION_SIMULATEMOTION_OFFSET UNITYSDK_OFFSET(0x67AB480)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOPARABOLICMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x67AB700)

namespace MoleMole::MiniGame::BangbooPartyGame
{
	inline static constexpr unsigned int MonoParabolicMotion_TypeDefinitionIndex = 40965;
