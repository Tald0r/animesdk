...
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOBANGBOOPARTYDEMOPARA_EACHLAYERDATA_GETCENTERS_OFFSET UNITYSDK_OFFSET(0x6AFDD10)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOBANGBOOPARTYDEMOPARA_EACHLAYERDATA_GET_COLUMNNUM_OFFSET UNITYSDK_OFFSET(0x6AFDCF0)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOBANGBOOPARTYDEMOPARA_EACHLAYERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6AFDFF0)

namespace MoleMole::MiniGame::BangbooPartyGame
{
	inline static constexpr unsigned int MonoBangbooPartyDemoPara_EachLayerData_TypeDefinitionIndex = 76060;
