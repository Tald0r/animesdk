...
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOBANGBOOPARTYDEMOPARA_EACHLAYERDATA_GETCENTERS_OFFSET UNITYSDK_OFFSET(0xB5ED210)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOBANGBOOPARTYDEMOPARA_EACHLAYERDATA_GET_COLUMNNUM_OFFSET UNITYSDK_OFFSET(0xB5ED1F0)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONOBANGBOOPARTYDEMOPARA_EACHLAYERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB5ED4F0)

namespace MoleMole::MiniGame::BangbooPartyGame
{
	inline static constexpr unsigned int MonoBangbooPartyDemoPara_EachLayerData_TypeDefinitionIndex = 39223;
