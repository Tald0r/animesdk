...
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONODIGITCONFIG_SETDIGITWITHLEADINGZERO_OFFSET UNITYSDK_OFFSET(0xE1194C0)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONODIGITCONFIG_SETDIGIT_OFFSET UNITYSDK_OFFSET(0xE1192E0)
#define MOLEMOLE_MINIGAME_BANGBOOPARTYGAME_MONODIGITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE119600)

namespace MoleMole::MiniGame::BangbooPartyGame
{
	inline static constexpr unsigned int MonoDigitConfig_TypeDefinitionIndex = 43352;
