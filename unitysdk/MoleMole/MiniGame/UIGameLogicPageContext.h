...
#define MOLEMOLE_MINIGAME_UIGAMELOGICPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x67ACEF0)

namespace MoleMole::MiniGame
{
	inline static constexpr unsigned int UIGameLogicPageContext_TypeDefinitionIndex = 60747;
