...
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_GETMINIGAMELOGIC_OFFSET UNITYSDK_OFFSET(0xB5EDAE0)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_GETPREFABPATH_OFFSET UNITYSDK_OFFSET(0xB5EDA50)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_GETRTNAME_OFFSET UNITYSDK_OFFSET(0xB5ED960)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_ONENTER_OFFSET UNITYSDK_OFFSET(0xB5EDDB0)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_ONEXIT_OFFSET UNITYSDK_OFFSET(0xB5EDFD0)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_RTUSEALPHA_OFFSET UNITYSDK_OFFSET(0xB5ED9F0)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_SHOWROOTPAGEUI_OFFSET UNITYSDK_OFFSET(0xB5EDB80)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0xB5EE2C0)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD___BASE_ONENTER_OFFSET UNITYSDK_OFFSET(0xB5EE310)
#define MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD___BASE_ONEXIT_OFFSET UNITYSDK_OFFSET(0xB5EE320)

namespace MoleMole::MiniGame
{
	inline static constexpr unsigned int CompanionMiniGameWorld_TypeDefinitionIndex = 71949;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_228*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MINIGAME_COMPANIONMINIGAMEWORLD_GETMINIGAMELOGIC_OFFSET))(this);
		}
