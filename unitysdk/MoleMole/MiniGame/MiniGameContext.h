...
#define MOLEMOLE_MINIGAME_MINIGAMECONTEXT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x36B020)
#define MOLEMOLE_MINIGAME_MINIGAMECONTEXT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x36B030)

namespace MoleMole::MiniGame
{
	inline static constexpr unsigned int MiniGameContext_TypeDefinitionIndex = 51104;
