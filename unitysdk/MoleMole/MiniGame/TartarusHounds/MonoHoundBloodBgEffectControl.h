...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x7F157B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_FADETRAILANIMCO_OFFSET UNITYSDK_OFFSET(0x7F166E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x7F16790)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_PARAMCHECK_OFFSET UNITYSDK_OFFSET(0x7F15890)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_RESETTOSTART_OFFSET UNITYSDK_OFFSET(0x7F15C90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_SETGEAR_OFFSET UNITYSDK_OFFSET(0x7F160C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x7F16880)

namespace MoleMole::MiniGame::TartarusHounds
{
	inline static constexpr unsigned int MonoHoundBloodBgEffectControl_TypeDefinitionIndex = 73845;
