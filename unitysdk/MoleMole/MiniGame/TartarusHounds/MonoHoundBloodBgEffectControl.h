...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD5FA70)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_FADETRAILANIMCO_OFFSET UNITYSDK_OFFSET(0xCD609A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD60A50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_PARAMCHECK_OFFSET UNITYSDK_OFFSET(0xCD5FB50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_RESETTOSTART_OFFSET UNITYSDK_OFFSET(0xCD5FF50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL_SETGEAR_OFFSET UNITYSDK_OFFSET(0xCD60380)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDBLOODBGEFFECTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCD60B40)

namespace MoleMole::MiniGame::TartarusHounds
{
	inline static constexpr unsigned int MonoHoundBloodBgEffectControl_TypeDefinitionIndex = 69051;
