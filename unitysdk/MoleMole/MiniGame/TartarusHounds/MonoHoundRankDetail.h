...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDRANKDETAIL_INITNAMEVIEW_OFFSET UNITYSDK_OFFSET(0xC22C780)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDRANKDETAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC22CCB0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDRANKDETAIL_SWITCHACCOUNTNAMEINFO_OFFSET UNITYSDK_OFFSET(0xC22C6E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOHOUNDRANKDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0xC22D040)

namespace MoleMole::MiniGame::TartarusHounds
{
	inline static constexpr unsigned int MonoHoundRankDetail_TypeDefinitionIndex = 75013;
