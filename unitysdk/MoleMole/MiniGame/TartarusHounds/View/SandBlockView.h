...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xA51D100)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_GET_CANBERECYCLE_OFFSET UNITYSDK_OFFSET(0xA51DD50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_GET_SELFGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xA51DC20)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_GET_SELFTRANSFORM_OFFSET UNITYSDK_OFFSET(0xA51DB50)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_INITSHEETANIM_OFFSET UNITYSDK_OFFSET(0xA51D1A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_METHOD_5_0581090195E9C81F_OFFSET UNITYSDK_OFFSET(0xA51DD80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_METHOD_5_602B796CAD5DBEDB_OFFSET UNITYSDK_OFFSET(0xA51D570)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xA51D3F0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_PLAYDESTROYINGANIMATION_OFFSET UNITYSDK_OFFSET(0xA51D7B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_PLAYIDLEANIMATION_OFFSET UNITYSDK_OFFSET(0xA51D710)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_REFRESHSANVIEWANIMATION_OFFSET UNITYSDK_OFFSET(0xA51D9C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_RESET_OFFSET UNITYSDK_OFFSET(0xA51DCF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_SETSANDSTYLE_OFFSET UNITYSDK_OFFSET(0xA51D950)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_SETSORTINGORDERINDEX_OFFSET UNITYSDK_OFFSET(0xA51DAD0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW_SETSTATUS_OFFSET UNITYSDK_OFFSET(0xA51D8E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_SANDBLOCKVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA51DD60)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int SandBlockView_TypeDefinitionIndex = 64142;
