...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SOUNDDELAYPLAYITEM_TICK_OFFSET UNITYSDK_OFFSET(0xC2E1660)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SOUNDDELAYPLAYITEM_TIMEOUT_OFFSET UNITYSDK_OFFSET(0xC2E1480)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SOUNDDELAYPLAYITEM_TRIGGERSOUND_OFFSET UNITYSDK_OFFSET(0xC2E14F0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_SOUNDDELAYPLAYITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC2E16E0)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int ViewEntityGame_SoundDelayPlayItem_TypeDefinitionIndex = 59450;
