...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ATTACHCOMP_OFFSET UNITYSDK_OFFSET(0xB5EF0D0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ATTACH_OFFSET UNITYSDK_OFFSET(0xB5EF000)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_BASETICK_OFFSET UNITYSDK_OFFSET(0xB5F1F40)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_BLINKADDLIFE_OFFSET UNITYSDK_OFFSET(0xB5F37E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CHANGETOLIST_OFFSET UNITYSDK_OFFSET(0xB5F0250)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CHECKBUFFCHANGE_OFFSET UNITYSDK_OFFSET(0xB5F1930)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CHECKPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0xB5F14A0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CLEARPLAYERBLINK_OFFSET UNITYSDK_OFFSET(0xB5EEDE0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CLEARSTATE_OFFSET UNITYSDK_OFFSET(0xB5F0350)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CLOSESHADOW_OFFSET UNITYSDK_OFFSET(0xB5EFAC0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_CLOSEWOOLBLINK_OFFSET UNITYSDK_OFFSET(0xB5F3510)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_DEALAFTERATTACK_OFFSET UNITYSDK_OFFSET(0xB5F2860)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_DOINIT_OFFSET UNITYSDK_OFFSET(0xB5EE480)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_GET_ISPLAYATTACKING_OFFSET UNITYSDK_OFFSET(0xB5F01E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_HANDLERLOWHPANIMATION_OFFSET UNITYSDK_OFFSET(0xB5F3760)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_INITSHEETANIM_OFFSET UNITYSDK_OFFSET(0xB5EF180)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONATTACKFINISHED_OFFSET UNITYSDK_OFFSET(0xB5F2D40)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONCHANGE_OFFSET UNITYSDK_OFFSET(0xB5F3050)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONFAKEJUMPFINISHED_OFFSET UNITYSDK_OFFSET(0xB5F2E00)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONFALLLANDINGFINISHED_OFFSET UNITYSDK_OFFSET(0xB5F2F90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONFALLSLIPFINISHED_OFFSET UNITYSDK_OFFSET(0xB5F2EC0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONRESET_OFFSET UNITYSDK_OFFSET(0xB5EED70)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONTEXSHEETANIMEND_OFFSET UNITYSDK_OFFSET(0xB5EFB40)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONTIMESCALECHANGE_OFFSET UNITYSDK_OFFSET(0xB5F38E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xB5F0760)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_OPENSHADOW_OFFSET UNITYSDK_OFFSET(0xB5EFA30)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYANIMSTATE_1_OFFSET UNITYSDK_OFFSET(0xB5EF650)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYANIMSTATE_OFFSET UNITYSDK_OFFSET(0xB5EFD10)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0xB5EFDA0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYBASICMOVE_OFFSET UNITYSDK_OFFSET(0xB5F1C20)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYCURRENTSHEET_OFFSET UNITYSDK_OFFSET(0xB5EFBF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYPLAYERBLINK_OFFSET UNITYSDK_OFFSET(0xB5F2410)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_PLAYSOUND_OFFSET UNITYSDK_OFFSET(0xB5F0060)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SETBLINKPARAMBYINDEX_OFFSET UNITYSDK_OFFSET(0xB5F3580)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SETVIEWENTITYGAME_OFFSET UNITYSDK_OFFSET(0xB5EEF60)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SHOULDPLAYFALL_OFFSET UNITYSDK_OFFSET(0xB5F2C90)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SIMULATEPVPSWITCHPOS_OFFSET UNITYSDK_OFFSET(0xB5F03C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_STOPPLAYERBLINK_OFFSET UNITYSDK_OFFSET(0xB5F2530)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_SYNCTIMESCALEWITHSPEED_OFFSET UNITYSDK_OFFSET(0xB5EEC70)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_TICKTIMESCALECHANGE_OFFSET UNITYSDK_OFFSET(0xB5F1410)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_TRIGGERSTRUGGLE_OFFSET UNITYSDK_OFFSET(0xB5F3860)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_TRYPLAYREADYSTOPINVINCIBLE_OFFSET UNITYSDK_OFFSET(0xB5F3440)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_UPDATECLIMBSTATUS_OFFSET UNITYSDK_OFFSET(0xB5F29F0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_UPDATEDIVINGSHADOWSTATUS_OFFSET UNITYSDK_OFFSET(0xB5F26C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_UPDATEDYINGANIM_OFFSET UNITYSDK_OFFSET(0xB5F1B70)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER_UPDATEINJUREDSTATUS_OFFSET UNITYSDK_OFFSET(0xB5F2120)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xB5F39B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYPLAYER__ONCHANGE_B__93_0_OFFSET UNITYSDK_OFFSET(0xB5F3AB0)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int ViewEntityPlayer_TypeDefinitionIndex = 66160;
	...
	public:
		...
		::Enum_3_0A3761FE34514D6C_58 lastLifeStatus; // 0x16C
		::Enum_3_0A3761FE34514D6C_57 lastInjuredStatus; // 0x170
