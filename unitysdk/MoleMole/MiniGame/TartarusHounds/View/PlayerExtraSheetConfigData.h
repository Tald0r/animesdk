...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_PLAYEREXTRASHEETCONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x82E3FE0)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int PlayerExtraSheetConfigData_TypeDefinitionIndex = 41493;
