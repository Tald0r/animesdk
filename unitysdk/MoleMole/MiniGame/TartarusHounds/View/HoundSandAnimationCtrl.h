...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_AWAKE_OFFSET UNITYSDK_OFFSET(0xA47F520)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_INITSANDANIMATION_OFFSET UNITYSDK_OFFSET(0xA47F730)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA480280)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xA4800B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0xA47FC60)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_RESET_OFFSET UNITYSDK_OFFSET(0xA480140)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_TICKANIMATION_OFFSET UNITYSDK_OFFSET(0xA47FD80)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_TICKSAND_OFFSET UNITYSDK_OFFSET(0xA47F9E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_UPDATE_OFFSET UNITYSDK_OFFSET(0xA47FCF0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL__CTOR_OFFSET UNITYSDK_OFFSET(0xA480300)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int HoundSandAnimationCtrl_TypeDefinitionIndex = 43607;
