...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_AWAKE_OFFSET UNITYSDK_OFFSET(0x7A86150)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_INITSANDANIMATION_OFFSET UNITYSDK_OFFSET(0x7A86360)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x7A86EB0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x7A86CE0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x7A86890)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_RESET_OFFSET UNITYSDK_OFFSET(0x7A86D70)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_TICKANIMATION_OFFSET UNITYSDK_OFFSET(0x7A869B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_TICKSAND_OFFSET UNITYSDK_OFFSET(0x7A86610)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL_UPDATE_OFFSET UNITYSDK_OFFSET(0x7A86920)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_HOUNDSANDANIMATIONCTRL__CTOR_OFFSET UNITYSDK_OFFSET(0x7A86F30)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int HoundSandAnimationCtrl_TypeDefinitionIndex = 64759;
