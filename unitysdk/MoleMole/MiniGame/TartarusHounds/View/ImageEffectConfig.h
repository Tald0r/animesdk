...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_IMAGEEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD80AB20)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int ImageEffectConfig_TypeDefinitionIndex = 61621;
	...
	public:
		...
		::System::Single spawnTime; // 0x20
		::UnityEngine::Vector2 effectImgSizeRandomOffset; // 0x24
		::UnityEngine::Vector2 spawnTargetPosRandomOffset; // 0x2C
		::UnityEngine::Vector2 spawnTargetPos; // 0x34
