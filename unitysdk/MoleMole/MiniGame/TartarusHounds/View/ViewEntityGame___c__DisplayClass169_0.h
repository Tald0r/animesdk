...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME___C__DISPLAYCLASS169_0__CREATEWOOLBLOCK_B__0_OFFSET UNITYSDK_OFFSET(0xB8BD440)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME___C__DISPLAYCLASS169_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB8BD430)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int ViewEntityGame___c__DisplayClass169_0_TypeDefinitionIndex = 73071;
