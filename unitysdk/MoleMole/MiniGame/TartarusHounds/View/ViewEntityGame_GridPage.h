...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GRIDPAGE_CLEAR_OFFSET UNITYSDK_OFFSET(0xC2E13B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_VIEW_VIEWENTITYGAME_GRIDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2E1470)

namespace MoleMole::MiniGame::TartarusHounds::View
{
	inline static constexpr unsigned int ViewEntityGame_GridPage_TypeDefinitionIndex = 59451;

	class ViewEntityGame_GridPage : public ::System::Object
	{
	public:
		::UnityEngine::Transform* pageRoot; // 0x10
		::System::Collections::Generic::List_1<::MoleMole::MiniGame::TartarusHounds::View::SandBlockView*>* levelGapGrids; // 0x18
