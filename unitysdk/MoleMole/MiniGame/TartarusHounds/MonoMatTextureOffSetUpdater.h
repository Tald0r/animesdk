...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9921080)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9921860)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_TRANSITIONSPEED_OFFSET UNITYSDK_OFFSET(0x9921780)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_TWEENTARGETSPEED_OFFSET UNITYSDK_OFFSET(0x99216C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_UPDATEBYTIME_OFFSET UNITYSDK_OFFSET(0x9921250)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_UPDATE_OFFSET UNITYSDK_OFFSET(0x99215C0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER__CTOR_OFFSET UNITYSDK_OFFSET(0x9921950)

namespace MoleMole::MiniGame::TartarusHounds
{
	inline static constexpr unsigned int MonoMatTextureOffSetUpdater_TypeDefinitionIndex = 72691;
