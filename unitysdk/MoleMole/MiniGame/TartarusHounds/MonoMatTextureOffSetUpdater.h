...
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA51C7E0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA51CFC0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_TRANSITIONSPEED_OFFSET UNITYSDK_OFFSET(0xA51CEE0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_TWEENTARGETSPEED_OFFSET UNITYSDK_OFFSET(0xA51CE20)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_UPDATEBYTIME_OFFSET UNITYSDK_OFFSET(0xA51C9B0)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA51CD20)
#define MOLEMOLE_MINIGAME_TARTARUSHOUNDS_MONOMATTEXTUREOFFSETUPDATER__CTOR_OFFSET UNITYSDK_OFFSET(0xA51D0B0)

namespace MoleMole::MiniGame::TartarusHounds
{
	inline static constexpr unsigned int MonoMatTextureOffSetUpdater_TypeDefinitionIndex = 69261;
