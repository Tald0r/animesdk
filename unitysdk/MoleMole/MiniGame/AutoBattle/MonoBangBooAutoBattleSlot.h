...
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_GETALL_OFFSET UNITYSDK_OFFSET(0x8B1A3D0)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_METHOD_7_90A3FA24C88925BF_1_OFFSET UNITYSDK_OFFSET(0x8B1A6B0)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_METHOD_7_90A3FA24C88925BF_OFFSET UNITYSDK_OFFSET(0x8B1A580)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_METHOD_7_A1C7122184516C18_OFFSET UNITYSDK_OFFSET(0x8B19800)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_METHOD_7_BECD032E88F61273_OFFSET UNITYSDK_OFFSET(0x8B1A5F0)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_SETEFF_OFFSET UNITYSDK_OFFSET(0x8B1A030)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_SETISOVERLIMIT_OFFSET UNITYSDK_OFFSET(0x8B1A360)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_SETVALIDCOLOR_OFFSET UNITYSDK_OFFSET(0x8B1A2F0)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_START_OFFSET UNITYSDK_OFFSET(0x8B19710)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x8B1A530)

namespace MoleMole::MiniGame::AutoBattle
{
	inline static constexpr unsigned int MonoBangBooAutoBattleSlot_TypeDefinitionIndex = 57950;
