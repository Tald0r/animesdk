...
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_GETALL_OFFSET UNITYSDK_OFFSET(0xB19EC00)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_METHOD_7_90A3FA24C88925BF_1_OFFSET UNITYSDK_OFFSET(0xB19EEE0)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_METHOD_7_90A3FA24C88925BF_OFFSET UNITYSDK_OFFSET(0xB19EE70)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_METHOD_7_A1C7122184516C18_OFFSET UNITYSDK_OFFSET(0xB19E040)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_METHOD_7_BECD032E88F61273_OFFSET UNITYSDK_OFFSET(0xB19EDB0)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_SETEFF_OFFSET UNITYSDK_OFFSET(0xB19E870)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_SETISOVERLIMIT_OFFSET UNITYSDK_OFFSET(0xB19EB90)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_SETVALIDCOLOR_OFFSET UNITYSDK_OFFSET(0xB19EB20)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_START_OFFSET UNITYSDK_OFFSET(0xB19DF50)
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT__CTOR_OFFSET UNITYSDK_OFFSET(0xB19ED60)

namespace MoleMole::MiniGame::AutoBattle
{
	inline static constexpr unsigned int MonoBangBooAutoBattleSlot_TypeDefinitionIndex = 48488;
