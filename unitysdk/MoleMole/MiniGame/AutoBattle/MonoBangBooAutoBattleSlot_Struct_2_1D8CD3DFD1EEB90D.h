...
#define MOLEMOLE_MINIGAME_AUTOBATTLE_MONOBANGBOOAUTOBATTLESLOT_STRUCT_2_1D8CD3DFD1EEB90D__CTOR_OFFSET UNITYSDK_OFFSET(0x2D6E20)

namespace MoleMole::MiniGame::AutoBattle
{
	inline static constexpr unsigned int MonoBangBooAutoBattleSlot_Struct_2_1D8CD3DFD1EEB90D_TypeDefinitionIndex = 57953;
