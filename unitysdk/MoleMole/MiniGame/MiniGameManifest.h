...
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_CONVERTLOGICPOSTOGLOBALLAYOUTPOS_OFFSET UNITYSDK_OFFSET(0x82E2A10)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_CONVERTLOGICPOSTOLAYOUTPOS_1_OFFSET UNITYSDK_OFFSET(0x82E2820)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_CONVERTLOGICPOSTOLAYOUTPOS_2_OFFSET UNITYSDK_OFFSET(0x82E2910)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_CONVERTLOGICPOSTOLAYOUTPOS_OFFSET UNITYSDK_OFFSET(0x82E2720)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GETGAMEROOT_OFFSET UNITYSDK_OFFSET(0x82E2B90)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GET_LEFTDOWNGLOBALPOS_OFFSET UNITYSDK_OFFSET(0x82E2C90)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GET_LEFTDOWNPOS_OFFSET UNITYSDK_OFFSET(0x82E2BF0)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GET_RIGHTUPGLOBALPOS_OFFSET UNITYSDK_OFFSET(0x82E2CE0)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GET_RIGHTUPPOS_OFFSET UNITYSDK_OFFSET(0x82E2C40)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST__CTOR_OFFSET UNITYSDK_OFFSET(0x82E2D30)

namespace MoleMole::MiniGame
{
	inline static constexpr unsigned int MiniGameManifest_TypeDefinitionIndex = 71407;
