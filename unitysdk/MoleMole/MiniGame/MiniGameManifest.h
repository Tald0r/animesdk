...
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_CONVERTLOGICPOSTOGLOBALLAYOUTPOS_OFFSET UNITYSDK_OFFSET(0xA39D2F0)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_CONVERTLOGICPOSTOLAYOUTPOS_1_OFFSET UNITYSDK_OFFSET(0xA39D100)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_CONVERTLOGICPOSTOLAYOUTPOS_2_OFFSET UNITYSDK_OFFSET(0xA39D1F0)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_CONVERTLOGICPOSTOLAYOUTPOS_OFFSET UNITYSDK_OFFSET(0xA39D000)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GETGAMEROOT_OFFSET UNITYSDK_OFFSET(0xA39D470)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GET_LEFTDOWNGLOBALPOS_OFFSET UNITYSDK_OFFSET(0xA39D570)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GET_LEFTDOWNPOS_OFFSET UNITYSDK_OFFSET(0xA39D4D0)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GET_RIGHTUPGLOBALPOS_OFFSET UNITYSDK_OFFSET(0xA39D5C0)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST_GET_RIGHTUPPOS_OFFSET UNITYSDK_OFFSET(0xA39D520)
#define MOLEMOLE_MINIGAME_MINIGAMEMANIFEST__CTOR_OFFSET UNITYSDK_OFFSET(0xA39D610)

namespace MoleMole::MiniGame
{
	inline static constexpr unsigned int MiniGameManifest_TypeDefinitionIndex = 59531;
