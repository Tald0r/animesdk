...
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x71DA360)
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x71DA370)
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x71DA3E0)
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x71DA4E0)
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x71DA5C0)
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x71DA5D0)
#define MOLEMOLE_UISUMMERFISHINGCOLLECTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x71DA640)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishingCollectPageController_TypeDefinitionIndex = 61769;
