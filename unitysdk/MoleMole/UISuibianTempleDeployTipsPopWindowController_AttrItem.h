...
#define MOLEMOLE_UISUIBIANTEMPLEDEPLOYTIPSPOPWINDOWCONTROLLER_ATTRITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xCA91530)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleDeployTipsPopWindowController_AttrItem_TypeDefinitionIndex = 47230;

	class UISuibianTempleDeployTipsPopWindowController_AttrItem : public ::System::Object
	{
	public:
		::Enum_3_5F938359207CCDBD Ability; // 0x10
		::System::Int32 CurValue; // 0x14
