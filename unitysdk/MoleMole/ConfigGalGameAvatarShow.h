...
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x6DFB920)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigGalGameAvatarShow_TypeDefinitionIndex = 60503;
