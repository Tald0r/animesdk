...
#define MOLEMOLE_MONOUIHORIZONTALLAYOUTGROUPADAPTOR_DOINITLAYOUT_OFFSET UNITYSDK_OFFSET(0xC7D0D90)
#define MOLEMOLE_MONOUIHORIZONTALLAYOUTGROUPADAPTOR_INITLAYOUTELEMENT_OFFSET UNITYSDK_OFFSET(0xC7D0F70)
#define MOLEMOLE_MONOUIHORIZONTALLAYOUTGROUPADAPTOR_ISCONTAINPLATFORMUIPARAMS_OFFSET UNITYSDK_OFFSET(0xC7D0C80)
#define MOLEMOLE_MONOUIHORIZONTALLAYOUTGROUPADAPTOR_ISPLATFORMUIPARAMSEMPTY_OFFSET UNITYSDK_OFFSET(0xC7D0BC0)
#define MOLEMOLE_MONOUIHORIZONTALLAYOUTGROUPADAPTOR_RELOADDATAFROMJSON_OFFSET UNITYSDK_OFFSET(0xC7D1520)
#define MOLEMOLE_MONOUIHORIZONTALLAYOUTGROUPADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC7D1820)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIHorizontalLayoutGroupAdaptor_TypeDefinitionIndex = 74690;
