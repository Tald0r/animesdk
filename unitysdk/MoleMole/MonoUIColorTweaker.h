...
#define MOLEMOLE_MONOUICOLORTWEAKER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA604560)
#define MOLEMOLE_MONOUICOLORTWEAKER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA604620)
#define MOLEMOLE_MONOUICOLORTWEAKER_SETGROUPTARGETCOLOR_OFFSET UNITYSDK_OFFSET(0xA604380)
#define MOLEMOLE_MONOUICOLORTWEAKER__CTOR_OFFSET UNITYSDK_OFFSET(0xA604810)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIColorTweaker_TypeDefinitionIndex = 40957;
