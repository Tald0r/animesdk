...
#define MOLEMOLE_FOLLOWERMOVE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x8F7DDF0)
#define MOLEMOLE_FOLLOWERMOVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x8F7DF30)
#define MOLEMOLE_FOLLOWERMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F7DF90)
#define MOLEMOLE_FOLLOWERMOVE___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x8F7E000)
#define MOLEMOLE_FOLLOWERMOVE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x8F7E090)

namespace MoleMole
{
	inline static constexpr unsigned int FollowerMove_TypeDefinitionIndex = 47261;
	...
	public:
		...
		::System::Single forwardLerpRatio; // 0x68
		::System::Single aimHeightOffset; // 0x6C
		::MoleMole::FollowerMove_FORWARD_TYPE ForwardType; // 0x70
