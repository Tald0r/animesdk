...
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xA28AEF0)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER___C__CTOR_OFFSET UNITYSDK_OFFSET(0xA28AF30)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER___C__REFRESHFLOWERTEXT_B__19_0_OFFSET UNITYSDK_OFFSET(0xA28AF40)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerTimeLinePageController___c_TypeDefinitionIndex = 70374;
	...
	public:
		...
		{
			return (::System::Func_2<::System::Collections::Generic::KeyValuePair_2<::MoleMole::UI::FlowerShop::ESlotType, ::Class_2_D6FEE2A35B0F262A*>, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIFlowerTimeLinePageController___c_TypeDefinitionIndex)->GetStaticField(0x402D0);
		}
		static ::MoleMole::UIFlowerTimeLinePageController___c** StaticGet___9()
		{
			return (::MoleMole::UIFlowerTimeLinePageController___c**)Il2CppClass::FromTypeDefinitionIndex(UIFlowerTimeLinePageController___c_TypeDefinitionIndex)->GetStaticField(0x402D8);
		}
