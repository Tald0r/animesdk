...
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB2C6840)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_B__6_OFFSET UNITYSDK_OFFSET(0xB2C8CD0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_B__7_OFFSET UNITYSDK_OFFSET(0xB2C8D30)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__HASCOLORCHANGED_4_OFFSET UNITYSDK_OFFSET(0xB2C7300)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETCOLOR_2_OFFSET UNITYSDK_OFFSET(0xB2C7450)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETENDSTATE_5_OFFSET UNITYSDK_OFFSET(0xB2C82C0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETNODECOLOR_1_OFFSET UNITYSDK_OFFSET(0xB2C75F0)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETNULLCOLOR_0_OFFSET UNITYSDK_OFFSET(0xB2C6850)
#define MOLEMOLE_UIDATAFIXNODEWIDGETCONTROLLER___C__DISPLAYCLASS47_0__SETTERMCOLOR_G__SETUNCONNECTCOLOR_3_OFFSET UNITYSDK_OFFSET(0xB2C8120)

namespace MoleMole
{
	inline static constexpr unsigned int UIDataFixNodeWidgetController___c__DisplayClass47_0_TypeDefinitionIndex = 77779;
	...
	public:
		...
		::Enum_3_D0F2373931CC685D_2 flowDir; // 0x18
