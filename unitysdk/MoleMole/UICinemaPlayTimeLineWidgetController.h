...
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF45E30)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF45ED0)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF45CE0)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF45D80)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER_SETHIGHLIGHTEFFECT_OFFSET UNITYSDK_OFFSET(0xBF45FB0)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF460A0)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF460D0)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF46140)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF461C0)
#define MOLEMOLE_UICINEMAPLAYTIMELINEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF46220)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaPlayTimeLineWidgetController_TypeDefinitionIndex = 50823;
