...
#define MOLEMOLE_GENERALBOTTOMTIPSHOW_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0xA394160)
#define MOLEMOLE_GENERALBOTTOMTIPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xA393EA0)
#define MOLEMOLE_GENERALBOTTOMTIPSHOW_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0xA393E30)
#define MOLEMOLE_GENERALBOTTOMTIPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xA393BF0)
#define MOLEMOLE_GENERALBOTTOMTIPSHOW___BASE_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0xA394340)
#define MOLEMOLE_GENERALBOTTOMTIPSHOW___BASE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0xA394350)

namespace MoleMole
{
	inline static constexpr unsigned int GeneralBottomTipShow_TypeDefinitionIndex = 68660;

	class GeneralBottomTipShow : public ::MoleMole::DisplayMessageBase
	{
	public:
		::Class_2_208CC9941471731A_447* m_cfg; // 0x28
