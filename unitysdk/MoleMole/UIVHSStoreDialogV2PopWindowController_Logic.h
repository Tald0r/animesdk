...
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_GETISCDFUNC_OFFSET UNITYSDK_OFFSET(0x790BBA0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_GETISMULTISELECTFULLFUNC_OFFSET UNITYSDK_OFFSET(0x790BB40)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_GETISSELECTEDVHSCOLLECTIONFUNC_OFFSET UNITYSDK_OFFSET(0x790BAE0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_OKBTNISINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x790B930)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_OKBTNTEXTMAPKEY_OFFSET UNITYSDK_OFFSET(0x790B990)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_ONOKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x790BA80)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x790B8D0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC_REFRESHTAGSPREVIEW_OFFSET UNITYSDK_OFFSET(0x790BA20)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_LOGIC__CTOR_OFFSET UNITYSDK_OFFSET(0x790B8C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreDialogV2PopWindowController_Logic_TypeDefinitionIndex = 77181;
