...
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_GETCURRENTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xB28EB50)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_ONBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xB28EAA0)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB28ECE0)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB28ED80)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB28E620)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB28EC30)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_REFRESHSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xB28E9B0)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB28EE60)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0xB28EBC0)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_SETCURRENTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xB28E940)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER_UPDATESELECTALPHA_OFFSET UNITYSDK_OFFSET(0xB28EF50)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB28F040)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB28F0F0)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB28F160)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB28F1E0)
#define MOLEMOLE_UICOOPROULETTPANELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB28F240)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopRoulettPanelWidgetController_TypeDefinitionIndex = 50431;
