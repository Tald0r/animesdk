...
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GRAPHSAVEDATABASE_FINISH_OFFSET UNITYSDK_OFFSET(0x95C5640)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GRAPHSAVEDATABASE_GETTAGUNIQUEID_OFFSET UNITYSDK_OFFSET(0x95C55A0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GRAPHSAVEDATABASE_GET_TAGUNIQUEID_OFFSET UNITYSDK_OFFSET(0x95C5500)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GRAPHSAVEDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x95C5630)

namespace MoleMole
{
	inline static constexpr unsigned int VOPerformSubSystem_GraphSaveDataBase_TypeDefinitionIndex = 55336;
