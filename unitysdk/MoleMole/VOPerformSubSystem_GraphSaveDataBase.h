...
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GRAPHSAVEDATABASE_FINISH_OFFSET UNITYSDK_OFFSET(0xAAC5DD0)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GRAPHSAVEDATABASE_GETTAGUNIQUEID_OFFSET UNITYSDK_OFFSET(0xAAC5D30)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GRAPHSAVEDATABASE_GET_TAGUNIQUEID_OFFSET UNITYSDK_OFFSET(0xAAC5C90)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_GRAPHSAVEDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0xAAC5DC0)

namespace MoleMole
{
	inline static constexpr unsigned int VOPerformSubSystem_GraphSaveDataBase_TypeDefinitionIndex = 62431;
