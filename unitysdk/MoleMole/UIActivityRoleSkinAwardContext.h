...
#define MOLEMOLE_UIACTIVITYROLESKINAWARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBADFBD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRoleSkinAwardContext_TypeDefinitionIndex = 70614;
