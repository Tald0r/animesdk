...
#define MOLEMOLE_CONFIGUICOOPTEAM3D_GETPOSITIONBYAVARTARIDANDSLOTINDEX_OFFSET UNITYSDK_OFFSET(0x15ED7210)
#define MOLEMOLE_CONFIGUICOOPTEAM3D_GETSCENECAMERACONFIGBYAVARTARID_OFFSET UNITYSDK_OFFSET(0x15ED7410)
#define MOLEMOLE_CONFIGUICOOPTEAM3D_GETYROTATIONBYAVARTARIDANDSLOTINDEX_OFFSET UNITYSDK_OFFSET(0x15ED7060)
#define MOLEMOLE_CONFIGUICOOPTEAM3D__CTOR_OFFSET UNITYSDK_OFFSET(0x15ED7580)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICoopTeam3D_TypeDefinitionIndex = 74906;
