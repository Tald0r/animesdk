...
#define MOLEMOLE_CONFIGUICOOPTEAM3D_GETPOSITIONBYAVARTARIDANDSLOTINDEX_OFFSET UNITYSDK_OFFSET(0xB5A3D90)
#define MOLEMOLE_CONFIGUICOOPTEAM3D_GETSCENECAMERACONFIGBYAVARTARID_OFFSET UNITYSDK_OFFSET(0xB5A3F90)
#define MOLEMOLE_CONFIGUICOOPTEAM3D_GETYROTATIONBYAVARTARIDANDSLOTINDEX_OFFSET UNITYSDK_OFFSET(0xB5A3BE0)
#define MOLEMOLE_CONFIGUICOOPTEAM3D__CTOR_OFFSET UNITYSDK_OFFSET(0xB5A4100)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICoopTeam3D_TypeDefinitionIndex = 42128;
