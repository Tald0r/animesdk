...
#define MOLEMOLE_INLEVELEXTRASYSTEMKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_LOCKEDSETTINGRAWINPUTDEVICELIST_OFFSET UNITYSDK_OFFSET(0x9918DD0)
#define MOLEMOLE_INLEVELEXTRASYSTEMKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x9918DB0)
#define MOLEMOLE_INLEVELEXTRASYSTEMKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x9918DC0)
#define MOLEMOLE_INLEVELEXTRASYSTEMKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x9918E60)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelExtraSystemKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 43308;
