...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS15_3__CTOR_OFFSET UNITYSDK_OFFSET(0xC10BEA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass15_3_TypeDefinitionIndex = 58920;
	...
	public:
		...
		::MoleMole::UIGalgamePageController___c__DisplayClass15_0* CS___8__locals3; // 0x18
