...
#define MOLEMOLE_MONSTERMAPPINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xA6561F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterMappingEntry_TypeDefinitionIndex = 41826;
