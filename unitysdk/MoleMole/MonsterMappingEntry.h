...
#define MOLEMOLE_MONSTERMAPPINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xB3BDA40)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterMappingEntry_TypeDefinitionIndex = 72710;
