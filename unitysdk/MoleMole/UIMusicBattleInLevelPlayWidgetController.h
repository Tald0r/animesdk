...
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_ACTIVATEBONUS_OFFSET UNITYSDK_OFFSET(0xCFF4A10)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_ACTIVATEFEVER_OFFSET UNITYSDK_OFFSET(0xCFF47D0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_ADDTICK_OFFSET UNITYSDK_OFFSET(0xCFF4910)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_GET_MUSICBATTLEPLAYROW_OFFSET UNITYSDK_OFFSET(0xCFF3AD0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_KILLMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0xCFF4460)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFF3E90)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFF3F30)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFF3B50)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFF3C50)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_PLAYMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0xCFF4120)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_REMOVETICK_OFFSET UNITYSDK_OFFSET(0xCFF4020)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xCFF4610)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_UPDATEFEVERPROGRESS_OFFSET UNITYSDK_OFFSET(0xCFF3D80)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF4BF0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER__ONUIINIT_B__15_0_OFFSET UNITYSDK_OFFSET(0xCFF4D20)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFF4F50)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFF4FC0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFF5040)
#define MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFF50A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelPlayWidgetController_TypeDefinitionIndex = 70828;

	class UIMusicBattleInLevelPlayWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		// static const ::System::String* FeverFadeIn; // 0x0
		// static const ::System::String* FeverFadeOut; // 0x0
		// static const ::System::String* FeverWaveFadeIn; // 0x0
		// static const ::System::String* BonusWaveFadeIn; // 0x0
		...
		::Class_3_A2BF74BADF6F7D16<::MoleMole::UIMusicBattleInLevelInteractWidgetController*>* get_MusicBattlePlayRow()
		{
			return ((::Class_3_A2BF74BADF6F7D16<::MoleMole::UIMusicBattleInLevelInteractWidgetController*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMUSICBATTLEINLEVELPLAYWIDGETCONTROLLER_GET_MUSICBATTLEPLAYROW_OFFSET))(this);
		}
