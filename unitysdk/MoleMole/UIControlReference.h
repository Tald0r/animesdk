...
#define MOLEMOLE_UICONTROLREFERENCE_APPLYLAYOUTBYPLATFORM_OFFSET UNITYSDK_OFFSET(0xD102510)
#define MOLEMOLE_UICONTROLREFERENCE_AWAKE_OFFSET UNITYSDK_OFFSET(0xD101D20)
#define MOLEMOLE_UICONTROLREFERENCE_COLLECTISCREENLAYOUTCOMPONENT_OFFSET UNITYSDK_OFFSET(0xD102370)
#define MOLEMOLE_UICONTROLREFERENCE_COLLECTMULTILAYOUTPLATFORMCOMPONENT_OFFSET UNITYSDK_OFFSET(0xD102040)
#define MOLEMOLE_UICONTROLREFERENCE_FORCEREBUILDLAYOUT_OFFSET UNITYSDK_OFFSET(0xD102740)
#define MOLEMOLE_UICONTROLREFERENCE_GET_ISVALIDCTRL_OFFSET UNITYSDK_OFFSET(0xD101C00)
#define MOLEMOLE_UICONTROLREFERENCE_INITLAYOUT_OFFSET UNITYSDK_OFFSET(0xD101F70)
#define MOLEMOLE_UICONTROLREFERENCE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD101DA0)
#define MOLEMOLE_UICONTROLREFERENCE_SHOWEXPORTDIR_OFFSET UNITYSDK_OFFSET(0xD101CC0)
#define MOLEMOLE_UICONTROLREFERENCE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xD102A20)
#define MOLEMOLE_UICONTROLREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xD102A90)
#define MOLEMOLE_UICONTROLREFERENCE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xD102B50)

namespace MoleMole
{
	inline static constexpr unsigned int UIControlReference_TypeDefinitionIndex = 79724;
