...
#define MOLEMOLE_UICONTROLREFERENCE_APPLYLAYOUTBYPLATFORM_OFFSET UNITYSDK_OFFSET(0xA338500)
#define MOLEMOLE_UICONTROLREFERENCE_AWAKE_OFFSET UNITYSDK_OFFSET(0xA337D10)
#define MOLEMOLE_UICONTROLREFERENCE_COLLECTISCREENLAYOUTCOMPONENT_OFFSET UNITYSDK_OFFSET(0xA338360)
#define MOLEMOLE_UICONTROLREFERENCE_COLLECTMULTILAYOUTPLATFORMCOMPONENT_OFFSET UNITYSDK_OFFSET(0xA338030)
#define MOLEMOLE_UICONTROLREFERENCE_FORCEREBUILDLAYOUT_OFFSET UNITYSDK_OFFSET(0xA338730)
#define MOLEMOLE_UICONTROLREFERENCE_GET_ISVALIDCTRL_OFFSET UNITYSDK_OFFSET(0xA337BF0)
#define MOLEMOLE_UICONTROLREFERENCE_INITLAYOUT_OFFSET UNITYSDK_OFFSET(0xA337F60)
#define MOLEMOLE_UICONTROLREFERENCE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA337D90)
#define MOLEMOLE_UICONTROLREFERENCE_SHOWEXPORTDIR_OFFSET UNITYSDK_OFFSET(0xA337CB0)
#define MOLEMOLE_UICONTROLREFERENCE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA338A10)
#define MOLEMOLE_UICONTROLREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xA338A80)
#define MOLEMOLE_UICONTROLREFERENCE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA338B40)

namespace MoleMole
{
	inline static constexpr unsigned int UIControlReference_TypeDefinitionIndex = 41924;
