...
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER_GETHASSTARMATERIAL_OFFSET UNITYSDK_OFFSET(0xBB03050)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER_GETRIGHTBTNTEXT_OFFSET UNITYSDK_OFFSET(0xBB032C0)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB01870)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER_ONSTARUP_OFFSET UNITYSDK_OFFSET(0xBB02B80)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB01910)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB01640)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER_RIGHTBTNCALL_OFFSET UNITYSDK_OFFSET(0xBB03390)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER_SETCONSUME_OFFSET UNITYSDK_OFFSET(0xBB01F60)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER_SETSTAR_OFFSET UNITYSDK_OFFSET(0xBB028D0)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER_SHOWCURSTAR_OFFSET UNITYSDK_OFFSET(0xBB01DA0)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER_SHOWNEXTSTAR_OFFSET UNITYSDK_OFFSET(0xBB01ED0)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER_SHOWPROPERTY_OFFSET UNITYSDK_OFFSET(0xBB027C0)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xBB01C20)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xBB037A0)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB03770)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER__ONSTARUP_B__9_0_OFFSET UNITYSDK_OFFSET(0xBB037E0)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER__ONSTARUP_B__9_1_OFFSET UNITYSDK_OFFSET(0xBB037F0)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER__RIGHTBTNCALL_B__13_0_OFFSET UNITYSDK_OFFSET(0xBB03800)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER___BASE_GETRIGHTBTNTEXT_OFFSET UNITYSDK_OFFSET(0xBB03840)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB038B0)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB03920)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB039A0)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER___BASE_RIGHTBTNCALL_OFFSET UNITYSDK_OFFSET(0xBB03A00)
#define MOLEMOLE_UIBANGBOOSTARUPWIDGETCONTROLLER___BASE_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xBB03A60)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooStarUpWidgetController_TypeDefinitionIndex = 40578;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIBangbooStarUpWidgetController_TypeDefinitionIndex)->GetStaticField(0x3D6D0);
		}
		::Class_2_C832474F3EB70101_1* _view; // 0x2C0
		...
		::Class_2_79F6D62CE30E3F8E_44* _ParentView; // 0x2D8
