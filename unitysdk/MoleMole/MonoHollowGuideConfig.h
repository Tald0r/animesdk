...
#define MOLEMOLE_MONOHOLLOWGUIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC237C20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoHollowGuideConfig_TypeDefinitionIndex = 38245;
