...
#define MOLEMOLE_ACTIVITYSPINEANIMATIONREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x9F95060)

namespace MoleMole
{
	inline static constexpr unsigned int ActivitySpineAnimationReference_TypeDefinitionIndex = 63070;
