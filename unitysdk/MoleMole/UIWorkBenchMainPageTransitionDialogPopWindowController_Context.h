...
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_BGCOLOR_OFFSET UNITYSDK_OFFSET(0x9392570)
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_IMGANIMTIME_OFFSET UNITYSDK_OFFSET(0x9392590)
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT_SET_BGCOLOR_OFFSET UNITYSDK_OFFSET(0x9392580)
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT_SET_IMGANIMTIME_OFFSET UNITYSDK_OFFSET(0x93925A0)
#define MOLEMOLE_UIWORKBENCHMAINPAGETRANSITIONDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x93925B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchMainPageTransitionDialogPopWindowController_Context_TypeDefinitionIndex = 42092;
