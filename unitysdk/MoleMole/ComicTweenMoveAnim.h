...
#define MOLEMOLE_COMICTWEENMOVEANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE31790)

namespace MoleMole
{
	inline static constexpr unsigned int ComicTweenMoveAnim_TypeDefinitionIndex = 30059;
