...
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_CLEARPLAYINFO_OFFSET UNITYSDK_OFFSET(0xB0AF390)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_GET_FILEURL_OFFSET UNITYSDK_OFFSET(0xB0AF320)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_GET_ISMONOBEHAVIOURSTARTCALLED_OFFSET UNITYSDK_OFFSET(0xB0AF380)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_GET_VIDEOHEIGHT_OFFSET UNITYSDK_OFFSET(0xB0AF360)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_GET_VIDEOWIDTH_OFFSET UNITYSDK_OFFSET(0xB0AF340)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_SET_FILEURL_OFFSET UNITYSDK_OFFSET(0xB0AF330)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_SET_VIDEOHEIGHT_OFFSET UNITYSDK_OFFSET(0xB0AF370)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP_SET_VIDEOWIDTH_OFFSET UNITYSDK_OFFSET(0xB0AF350)
#define MOLEMOLE_CRIMANAMOVIECONTROLLERFORNAP__CTOR_OFFSET UNITYSDK_OFFSET(0xB0AF400)

namespace MoleMole
{
	inline static constexpr unsigned int CriManaMovieControllerForNap_TypeDefinitionIndex = 71471;
