...
#define MOLEMOLE_PERFORMANCESETTINGPOSTPROCESSPROFILEBASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6EBF880)
#define MOLEMOLE_PERFORMANCESETTINGPOSTPROCESSPROFILEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x6EBF7E0)

namespace MoleMole
{
	inline static constexpr unsigned int PerformanceSettingPostProcessProfileBase_TypeDefinitionIndex = 71762;
