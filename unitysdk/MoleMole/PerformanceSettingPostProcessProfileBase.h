...
#define MOLEMOLE_PERFORMANCESETTINGPOSTPROCESSPROFILEBASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6E06730)
#define MOLEMOLE_PERFORMANCESETTINGPOSTPROCESSPROFILEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E06690)

namespace MoleMole
{
	inline static constexpr unsigned int PerformanceSettingPostProcessProfileBase_TypeDefinitionIndex = 68111;
