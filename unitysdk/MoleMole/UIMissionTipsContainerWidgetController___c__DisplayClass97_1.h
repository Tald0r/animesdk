...
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS97_1__CTOR_OFFSET UNITYSDK_OFFSET(0xB6AE5E0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS97_1__PLAYHDDHANGTIP_B__2_OFFSET UNITYSDK_OFFSET(0xB6AE5F0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS97_1__PLAYHDDHANGTIP_B__3_OFFSET UNITYSDK_OFFSET(0xB6AE680)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsContainerWidgetController___c__DisplayClass97_1_TypeDefinitionIndex = 70943;
