...
#define MOLEMOLE_REPELPREPPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8F3C7F0)

namespace MoleMole
{
	inline static constexpr unsigned int RepelPrepPageContext_TypeDefinitionIndex = 78130;
