...
#define MOLEMOLE_CONFIGPHOTOSTICKERDYNAMICCHECKTREENODE_CREATE_OFFSET UNITYSDK_OFFSET(0xCDCCC90)
#define MOLEMOLE_CONFIGPHOTOSTICKERDYNAMICCHECKTREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCDCCD30)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigPhotoStickerDynamicCheckTreeNode_TypeDefinitionIndex = 74827;
