...
#define MOLEMOLE_UIEQUIPDEVELOPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA3552E0)
#define MOLEMOLE_UIEQUIPDEVELOPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA355380)
#define MOLEMOLE_UIEQUIPDEVELOPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA355240)
#define MOLEMOLE_UIEQUIPDEVELOPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA355460)
#define MOLEMOLE_UIEQUIPDEVELOPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA355490)
#define MOLEMOLE_UIEQUIPDEVELOPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA355500)
#define MOLEMOLE_UIEQUIPDEVELOPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA355580)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDevelopWidgetController_TypeDefinitionIndex = 72153;
