...
class Class_2_C3DCDC50C2218E7D;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xC350530)
#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC3504B0)
#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3504C0)
#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC350540)
#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC350600)
#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC3508F0)
#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC3509D0)
#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC350690)
#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC350AA0)
#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC350AB0)
#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC350B20)
#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC350B50)
#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC350B60)
#define MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC350B70)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS3RoleSelectPageController_TypeDefinitionIndex = 79986;
	...
	public:
		...
		::Class_2_C3DCDC50C2218E7D* get__viewModel()
		{
			return ((::Class_2_C3DCDC50C2218E7D*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS3ROLESELECTPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
