...
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD0F5A50)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD0F5BD0)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD0F5AF0)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD0F59B0)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0F5EC0)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD0F5ED0)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD0F5F40)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD0F5FC0)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD0F6040)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdleListItemWidgetController_TypeDefinitionIndex = 40455;

	class UICampIdleListItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_C03C66A5789815D6* _view; // 0x2D0
