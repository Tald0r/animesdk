...
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA32EC10)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA32ED90)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA32ECB0)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA32EB70)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA32F080)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA32F090)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA32F100)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA32F180)
#define MOLEMOLE_UICAMPIDLELISTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA32F200)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdleListItemWidgetController_TypeDefinitionIndex = 79126;
