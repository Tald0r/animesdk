...
#define MOLEMOLE_ACTIVITYRHYTHMCLICKRESULTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x96E3770)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityRhythmClickResultContext_TypeDefinitionIndex = 61073;
	...
	public:
		...
		::Enum_3_96F6662CA3713095_6 Rank; // 0x38
