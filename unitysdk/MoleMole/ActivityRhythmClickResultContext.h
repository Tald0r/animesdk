...
#define MOLEMOLE_ACTIVITYRHYTHMCLICKRESULTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB073F80)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityRhythmClickResultContext_TypeDefinitionIndex = 58391;
	...
	public:
		...
		::System::Int32 MissNum; // 0x3C
		::System::Int32 PerfectNum; // 0x40
