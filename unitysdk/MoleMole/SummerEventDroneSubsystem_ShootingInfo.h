...
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_GET_CAPACITY_OFFSET UNITYSDK_OFFSET(0x2C50B0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_INIT_OFFSET UNITYSDK_OFFSET(0x37FF80)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x380080)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_ISFULL_OFFSET UNITYSDK_OFFSET(0x3800F0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_RELOAD_OFFSET UNITYSDK_OFFSET(0x380010)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventDroneSubsystem_ShootingInfo_TypeDefinitionIndex = 63653;
