...
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_GET_CAPACITY_OFFSET UNITYSDK_OFFSET(0x2F6540)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_INIT_OFFSET UNITYSDK_OFFSET(0x340010)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x340110)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_ISFULL_OFFSET UNITYSDK_OFFSET(0x340180)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_SHOOTINGINFO_RELOAD_OFFSET UNITYSDK_OFFSET(0x3400A0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventDroneSubsystem_ShootingInfo_TypeDefinitionIndex = 71335;
