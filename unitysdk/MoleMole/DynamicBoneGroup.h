...
#define MOLEMOLE_DYNAMICBONEGROUP_AWAKE_OFFSET UNITYSDK_OFFSET(0x10ABFFE0)
#define MOLEMOLE_DYNAMICBONEGROUP_EMPTY_OFFSET UNITYSDK_OFFSET(0x10AC0250)
#define MOLEMOLE_DYNAMICBONEGROUP_GETCOMPONENTSAFELY_OFFSET UNITYSDK_OFFSET(0x10AC0380)
#define MOLEMOLE_DYNAMICBONEGROUP_MANUALFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x10AC0E00)
#define MOLEMOLE_DYNAMICBONEGROUP_MANUALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x10AC1050)
#define MOLEMOLE_DYNAMICBONEGROUP_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x10AC0FC0)
#define MOLEMOLE_DYNAMICBONEGROUP_MANUALWAITFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x10AC0F00)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x10AC1300)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_151E25A63D14DDB0_1_OFFSET UNITYSDK_OFFSET(0x10AC0B80)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x10AC0190)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0x10AC1810)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x10AC0D60)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0x10AC11A0)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_BB05490B5710E9A7_OFFSET UNITYSDK_OFFSET(0x10AC00A0)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_C6A2F37261C7C003_OFFSET UNITYSDK_OFFSET(0x10AC0760)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_D1C9D812A3FB4E21_OFFSET UNITYSDK_OFFSET(0x10AC15D0)
#define MOLEMOLE_DYNAMICBONEGROUP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x10AC0870)
#define MOLEMOLE_DYNAMICBONEGROUP_ONDYNAMICBONEDATAREADY_OFFSET UNITYSDK_OFFSET(0x10AC13C0)
#define MOLEMOLE_DYNAMICBONEGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10AC04D0)
#define MOLEMOLE_DYNAMICBONEGROUP_START_OFFSET UNITYSDK_OFFSET(0x10AC0110)
#define MOLEMOLE_DYNAMICBONEGROUP_SWITCHLOD_OFFSET UNITYSDK_OFFSET(0x10AC1110)
#define MOLEMOLE_DYNAMICBONEGROUP_TRYSYNCTIMESCALE_OFFSET UNITYSDK_OFFSET(0x10AC0C50)
#define MOLEMOLE_DYNAMICBONEGROUP__CCTOR_OFFSET UNITYSDK_OFFSET(0x10AC1530)
#define MOLEMOLE_DYNAMICBONEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x10AC14D0)

namespace MoleMole
{
	inline static constexpr unsigned int DynamicBoneGroup_TypeDefinitionIndex = 56830;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::DynamicBoneGroup*>**)Il2CppClass::FromTypeDefinitionIndex(DynamicBoneGroup_TypeDefinitionIndex)->GetStaticField(0x46BD0);
		}
		...
		::System::Void Method_5_BB05490B5710E9A7()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_BB05490B5710E9A7_OFFSET))(this);
		}
		...
		::System::Boolean Method_5_D1C9D812A3FB4E21()
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_D1C9D812A3FB4E21_OFFSET))(this);
		}

		::System::Void Method_5_2B9D478141E0F891()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_2B9D478141E0F891_OFFSET))(this);
		}
