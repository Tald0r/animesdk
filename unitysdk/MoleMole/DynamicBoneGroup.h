...
#define MOLEMOLE_DYNAMICBONEGROUP_AWAKE_OFFSET UNITYSDK_OFFSET(0xE0D8AD0)
#define MOLEMOLE_DYNAMICBONEGROUP_EMPTY_OFFSET UNITYSDK_OFFSET(0xE0D8D40)
#define MOLEMOLE_DYNAMICBONEGROUP_GETCOMPONENTSAFELY_OFFSET UNITYSDK_OFFSET(0xE0D8E70)
#define MOLEMOLE_DYNAMICBONEGROUP_MANUALFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xE0D9900)
#define MOLEMOLE_DYNAMICBONEGROUP_MANUALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0xE0D9B50)
#define MOLEMOLE_DYNAMICBONEGROUP_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0xE0D9AC0)
#define MOLEMOLE_DYNAMICBONEGROUP_MANUALWAITFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xE0D9A00)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xE0D9E00)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_151E25A63D14DDB0_1_OFFSET UNITYSDK_OFFSET(0xE0D8C80)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xE0D9680)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0xE0DA310)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xE0D9860)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0xE0D9CA0)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_BB05490B5710E9A7_OFFSET UNITYSDK_OFFSET(0xE0D8B90)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_C6A2F37261C7C003_OFFSET UNITYSDK_OFFSET(0xE0D9260)
#define MOLEMOLE_DYNAMICBONEGROUP_METHOD_5_D1C9D812A3FB4E21_OFFSET UNITYSDK_OFFSET(0xE0DA0D0)
#define MOLEMOLE_DYNAMICBONEGROUP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xE0D9370)
#define MOLEMOLE_DYNAMICBONEGROUP_ONDYNAMICBONEDATAREADY_OFFSET UNITYSDK_OFFSET(0xE0D9EC0)
#define MOLEMOLE_DYNAMICBONEGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0xE0D8FC0)
#define MOLEMOLE_DYNAMICBONEGROUP_START_OFFSET UNITYSDK_OFFSET(0xE0D8C00)
#define MOLEMOLE_DYNAMICBONEGROUP_SWITCHLOD_OFFSET UNITYSDK_OFFSET(0xE0D9C10)
#define MOLEMOLE_DYNAMICBONEGROUP_TRYSYNCTIMESCALE_OFFSET UNITYSDK_OFFSET(0xE0D9750)
#define MOLEMOLE_DYNAMICBONEGROUP__CCTOR_OFFSET UNITYSDK_OFFSET(0xE0DA030)
#define MOLEMOLE_DYNAMICBONEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xE0D9FD0)

namespace MoleMole
{
	inline static constexpr unsigned int DynamicBoneGroup_TypeDefinitionIndex = 53531;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::DynamicBoneGroup*>**)Il2CppClass::FromTypeDefinitionIndex(DynamicBoneGroup_TypeDefinitionIndex)->GetStaticField(0x3FF90);
		}
