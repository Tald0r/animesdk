...
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_BINDGAMEPADBUTTON_OFFSET UNITYSDK_OFFSET(0x95FE6B0)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_DOTOGGLETRACK_OFFSET UNITYSDK_OFFSET(0x95FF610)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95FE530)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95FE5D0)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95FE2A0)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95FE480)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x95FE8B0)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x95FF9F0)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER__DOTOGGLETRACK_B__8_0_OFFSET UNITYSDK_OFFSET(0x95FFB10)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER__REFRESHVIEW_B__7_0_OFFSET UNITYSDK_OFFSET(0x95FFAB0)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER__REFRESHVIEW_B__7_2_OFFSET UNITYSDK_OFFSET(0x95FFA30)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER__REFRESHVIEW_G__SETGRAPHICALPHA_7_1_OFFSET UNITYSDK_OFFSET(0x95FF550)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95FFB30)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95FFBA0)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95FFC20)
#define MOLEMOLE_UIGENERALQUESTTRACKBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95FFC80)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralQuestTrackBtnWidgetController_TypeDefinitionIndex = 72564;
