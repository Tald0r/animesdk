...
#define MOLEMOLE_UIAREAGOODSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC2625B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAreaGoodsContext_TypeDefinitionIndex = 72356;
