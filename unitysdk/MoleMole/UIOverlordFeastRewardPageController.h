...
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xCA6ACF0)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xCA6AE10)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA6AD00)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA6B9C0)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA6ADA0)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA6B110)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCA6B1D0)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER_TAKEALLREWARDS_OFFSET UNITYSDK_OFFSET(0xCA6BA50)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA6BE80)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER__TAKEALLREWARDS_B__9_0_OFFSET UNITYSDK_OFFSET(0xCA6BE90)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA6BEC0)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA6BF30)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA6BF40)
#define MOLEMOLE_UIOVERLORDFEASTREWARDPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA6BF50)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastRewardPageController_TypeDefinitionIndex = 75350;
