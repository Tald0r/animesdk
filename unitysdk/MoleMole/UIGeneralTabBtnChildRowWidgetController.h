...
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA99E900)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0xA99EFB0)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xA99EF40)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA99EA80)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA99E9A0)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA99E690)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA99E850)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_REFRESHSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xA99EE70)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_SETUPNOTIFICATIONBADGE_1_OFFSET UNITYSDK_OFFSET(0xA99EDD0)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER_SETUPNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0xA99F020)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA99F0A0)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA99F0B0)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0xA99F120)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xA99F180)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA99F1F0)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA99F270)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA99F2F0)
#define MOLEMOLE_UIGENERALTABBTNCHILDROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA99F350)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTabBtnChildRowWidgetController_TypeDefinitionIndex = 37570;
	...
	public:
		...
		::MoleMole::UIGeneralTabBtnWidgetController_Data* _data; // 0x2D8
