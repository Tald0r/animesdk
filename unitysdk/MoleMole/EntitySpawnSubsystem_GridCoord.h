...
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_GRIDCOORD_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x381A70)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_GRIDCOORD_EQUALS_OFFSET UNITYSDK_OFFSET(0x3819F0)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_GRIDCOORD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x381A80)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_GRIDCOORD__CTOR_OFFSET UNITYSDK_OFFSET(0x381AF0)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_GRIDCOORD___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x381B40)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_GRIDCOORD___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x381BA0)

namespace MoleMole
{
	inline static constexpr unsigned int EntitySpawnSubsystem_GridCoord_TypeDefinitionIndex = 55043;
