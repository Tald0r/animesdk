...
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_GRIDCOORD_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3915D0)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_GRIDCOORD_EQUALS_OFFSET UNITYSDK_OFFSET(0x391550)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_GRIDCOORD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3915E0)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_GRIDCOORD__CTOR_OFFSET UNITYSDK_OFFSET(0x391650)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_GRIDCOORD___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3916A0)
#define MOLEMOLE_ENTITYSPAWNSUBSYSTEM_GRIDCOORD___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x391700)

namespace MoleMole
{
	inline static constexpr unsigned int EntitySpawnSubsystem_GridCoord_TypeDefinitionIndex = 40150;
