...
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ENABLESELECTSCALEANIM_OFFSET UNITYSDK_OFFSET(0xD3DA5B0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_GETGAMEPADSELECTABLE_OFFSET UNITYSDK_OFFSET(0xD3D7BA0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_GETINDEX_OFFSET UNITYSDK_OFFSET(0xD3DA210)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_GETSUITID_OFFSET UNITYSDK_OFFSET(0xD3DA280)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_HIDEREDDOT_OFFSET UNITYSDK_OFFSET(0xD3D88A0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xD3D7900)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xD3D8920)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3D7CC0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONFOCUSSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xD3DA4B0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xD3D8DF0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0xD3D9B60)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD3D9050)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3D8ED0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3D7750)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD3D7C10)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONUIREUSE_OFFSET UNITYSDK_OFFSET(0xD3D7D60)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD3D9350)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_RESETIMAGECONTROL_1_OFFSET UNITYSDK_OFFSET(0xD3DA990)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_RESETIMAGECONTROL_OFFSET UNITYSDK_OFFSET(0xD3D8750)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_RESETSELECTOBJALPHA_OFFSET UNITYSDK_OFFSET(0xD3D8830)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0xD3D8380)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0xD3D9710)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETENABLEEMPTYCLICK_OFFSET UNITYSDK_OFFSET(0xD3DA7A0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETINDEX_OFFSET UNITYSDK_OFFSET(0xD3D9270)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETITEMCLICKEDACT_OFFSET UNITYSDK_OFFSET(0xD3DA1A0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETMASKSTATE_OFFSET UNITYSDK_OFFSET(0xD3D9FE0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0xD3D8440)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETSELECTOBJALPHA_OFFSET UNITYSDK_OFFSET(0xD3DA2F0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETSHOWSELECT_OFFSET UNITYSDK_OFFSET(0xD3DA440)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETSUITID_OFFSET UNITYSDK_OFFSET(0xD3D92E0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETSUITITEMINFO_OFFSET UNITYSDK_OFFSET(0xD3D9BD0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_TRYCLEARREDDOT_OFFSET UNITYSDK_OFFSET(0xD3D89E0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_UPDATEREDDOT_OFFSET UNITYSDK_OFFSET(0xD3D94C0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD3DAA10)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER__REFRESHVIEW_B__22_0_OFFSET UNITYSDK_OFFSET(0xD3DAA20)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xD3DAA40)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3DAA50)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xD3DAAC0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0xD3DAB30)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD3DAB90)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3DAC10)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3DAC90)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD3DACF0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONUIREUSE_OFFSET UNITYSDK_OFFSET(0xD3DAD60)

namespace MoleMole
{
	inline static constexpr unsigned int UISuitIconBtnWidgetController_TypeDefinitionIndex = 59891;
