...
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ENABLESELECTSCALEANIM_OFFSET UNITYSDK_OFFSET(0xEE34BB0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_GETGAMEPADSELECTABLE_OFFSET UNITYSDK_OFFSET(0xEE321A0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_GETINDEX_OFFSET UNITYSDK_OFFSET(0xEE34810)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_GETSUITID_OFFSET UNITYSDK_OFFSET(0xEE34880)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_HIDEREDDOT_OFFSET UNITYSDK_OFFSET(0xEE32EA0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xEE31F00)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xEE32F20)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xEE322C0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONFOCUSSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xEE34AB0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xEE333F0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0xEE34160)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xEE33650)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xEE334D0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xEE31D50)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xEE32210)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_ONUIREUSE_OFFSET UNITYSDK_OFFSET(0xEE32360)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xEE33950)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_RESETIMAGECONTROL_1_OFFSET UNITYSDK_OFFSET(0xEE34F90)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_RESETIMAGECONTROL_OFFSET UNITYSDK_OFFSET(0xEE32D50)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_RESETSELECTOBJALPHA_OFFSET UNITYSDK_OFFSET(0xEE32E30)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0xEE32980)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0xEE33D10)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETENABLEEMPTYCLICK_OFFSET UNITYSDK_OFFSET(0xEE34DA0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETINDEX_OFFSET UNITYSDK_OFFSET(0xEE33870)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETITEMCLICKEDACT_OFFSET UNITYSDK_OFFSET(0xEE347A0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETMASKSTATE_OFFSET UNITYSDK_OFFSET(0xEE345E0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0xEE32A40)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETSELECTOBJALPHA_OFFSET UNITYSDK_OFFSET(0xEE348F0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETSHOWSELECT_OFFSET UNITYSDK_OFFSET(0xEE34A40)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETSUITID_OFFSET UNITYSDK_OFFSET(0xEE338E0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETSUITITEMINFO_OFFSET UNITYSDK_OFFSET(0xEE341D0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_TRYCLEARREDDOT_OFFSET UNITYSDK_OFFSET(0xEE32FE0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_UPDATEREDDOT_OFFSET UNITYSDK_OFFSET(0xEE33AC0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xEE35010)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER__REFRESHVIEW_B__22_0_OFFSET UNITYSDK_OFFSET(0xEE35020)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xEE35040)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xEE35050)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xEE350C0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0xEE35130)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xEE35190)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xEE35210)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xEE35290)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xEE352F0)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___BASE_ONUIREUSE_OFFSET UNITYSDK_OFFSET(0xEE35360)

namespace MoleMole
{
	inline static constexpr unsigned int UISuitIconBtnWidgetController_TypeDefinitionIndex = 75500;
	...
	public:
		...
		::Class_2_4D6258F71387F95D* _view; // 0x2D0
		::Class_2_888829D5F4E4EBE0_Class_1_AA3AA9145D9EE846* _suitViewData; // 0x2D8
		::System::Int32 _suitID; // 0x2E0
		::System::Int32 _index; // 0x2E4
		::System::Action_1<::System::Int32>* _itemClickedAct; // 0x2E8
		::System::Boolean _enableEmptyClick; // 0x2F0
		::System::Boolean _isShowSelect; // 0x2F1
		::MoleMole::UIGeneralNewHintWidgetController* _newHintWidgetController; // 0x2F8
		::MonoUIBtnScaleAnim* _selectScaleComp; // 0x300
		...
		::System::Void RefreshView(::Class_2_888829D5F4E4EBE0_Class_1_AA3AA9145D9EE846* suitViewData)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_888829D5F4E4EBE0_Class_1_AA3AA9145D9EE846*))((::PBYTE)hIl2Cpp + MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET))(this, suitViewData);
		}

		::System::Void SetSuitItemInfo(::Class_2_888829D5F4E4EBE0_Class_1_AA3AA9145D9EE846* suitViewData)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_888829D5F4E4EBE0_Class_1_AA3AA9145D9EE846*))((::PBYTE)hIl2Cpp + MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_SETSUITITEMINFO_OFFSET))(this, suitViewData);
		}
		...
		::System::Void ResetImageControl_1(::Class_2_A8F5ABF31E066ED4* controlImage)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_A8F5ABF31E066ED4*))((::PBYTE)hIl2Cpp + MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER_RESETIMAGECONTROL_1_OFFSET))(this, controlImage);
		}
