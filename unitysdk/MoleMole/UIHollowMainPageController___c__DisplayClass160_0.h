...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS160_0__CTOR_OFFSET UNITYSDK_OFFSET(0xE25B5A0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS160_0__ONPUNISHOVERLOAD_G__AFTERPERFORM_1_OFFSET UNITYSDK_OFFSET(0xE282080)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS160_0__ONPUNISHOVERLOAD_G__BEFOREPERFORM_0_OFFSET UNITYSDK_OFFSET(0xE25B860)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController___c__DisplayClass160_0_TypeDefinitionIndex = 52613;
