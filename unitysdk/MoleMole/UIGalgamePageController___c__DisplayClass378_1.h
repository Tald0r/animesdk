...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS378_1__CTOR_OFFSET UNITYSDK_OFFSET(0xA2956B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS378_1__PLAYNPCENTERACTIONS_B__5_OFFSET UNITYSDK_OFFSET(0xA295840)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS378_1__PLAYNPCENTERACTIONS_B__6_OFFSET UNITYSDK_OFFSET(0xA295960)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS378_1__PLAYNPCENTERACTIONS_G__APPLYPOSENFACIALWHENENTER_3_OFFSET UNITYSDK_OFFSET(0xA2956C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass378_1_TypeDefinitionIndex = 54653;
