...
#define MOLEMOLE_UITABBTNBUDDYROLEROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9A25730)

namespace MoleMole
{
	inline static constexpr unsigned int UITabBtnBuddyRoleRowContext_TypeDefinitionIndex = 39649;
