...
#define MOLEMOLE_UITABBTNBUDDYROLEROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8882950)

namespace MoleMole
{
	inline static constexpr unsigned int UITabBtnBuddyRoleRowContext_TypeDefinitionIndex = 45927;
