...
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_ADSORBEDCONFRIMPOS_OFFSET UNITYSDK_OFFSET(0xBFD8A80)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_ASYNCPOS_OFFSET UNITYSDK_OFFSET(0xBFD9A60)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_CHANGESELF_OFFSET UNITYSDK_OFFSET(0xBFDA880)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_CLICKDELETEBTN_OFFSET UNITYSDK_OFFSET(0xBFD7D70)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_CLICKOKBTN_OFFSET UNITYSDK_OFFSET(0xBFD77F0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_CLICKROTATEBTN_OFFSET UNITYSDK_OFFSET(0xBFD7FE0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_CONFRIMPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0xBFD7860)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_GETDIYCOMPONENT_OFFSET UNITYSDK_OFFSET(0xBFD5200)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0xBFDBFA0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_GET_DELETEBTN_OFFSET UNITYSDK_OFFSET(0xBFDBFB0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_GET_OKBTN_OFFSET UNITYSDK_OFFSET(0xBFDB8D0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_GET_ROTATEBTN_OFFSET UNITYSDK_OFFSET(0xBFDBFD0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_HIDEBTNS_OFFSET UNITYSDK_OFFSET(0xBFD7670)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_INVOKECOLLIDERBTN_OFFSET UNITYSDK_OFFSET(0xBFD9130)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_ISINCOMPONENTAREA_OFFSET UNITYSDK_OFFSET(0xBFD85E0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_MOVEPOSITION_OFFSET UNITYSDK_OFFSET(0xBFD9780)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_MOVETOMAPGRID_OFFSET UNITYSDK_OFFSET(0xBFDB8F0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFD67F0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_ONDRAGSTART_OFFSET UNITYSDK_OFFSET(0xBFD84B0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xBFD8E20)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xBFD8970)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_ONGAMEPADEDITOR_OFFSET UNITYSDK_OFFSET(0xBFDB1F0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_ONLONGPRESS_OFFSET UNITYSDK_OFFSET(0xBFD95C0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_ONPOINTCLICKDOWN_OFFSET UNITYSDK_OFFSET(0xBFD90B0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_ONPOINTCLICKUP_OFFSET UNITYSDK_OFFSET(0xBFD9460)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFD6890)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFD6110)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_RESETBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0xBFD8850)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_RESETGAMEPADMOVE_OFFSET UNITYSDK_OFFSET(0xBFDB3C0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_SETBG_OFFSET UNITYSDK_OFFSET(0xBFD7290)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_SETCOMPONENT_OFFSET UNITYSDK_OFFSET(0xBFD6970)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_SETFOCUS_OFFSET UNITYSDK_OFFSET(0xBFDB0A0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_SETICONPOSITION_OFFSET UNITYSDK_OFFSET(0xBFD6D00)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_SETICONROTATE_OFFSET UNITYSDK_OFFSET(0xBFD6A90)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_SETPOSITIONBYGRIDS_OFFSET UNITYSDK_OFFSET(0xBFD9B60)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_SETSCREENPOS_OFFSET UNITYSDK_OFFSET(0xBFD8DC0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_SETTRANSFORMPOSITION_OFFSET UNITYSDK_OFFSET(0xBFD9920)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_SHOWBTNS_OFFSET UNITYSDK_OFFSET(0xBFD74C0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_SWITCHNORMALMODE_OFFSET UNITYSDK_OFFSET(0xBFDA570)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_SWITCHTOEDITORMODE_OFFSET UNITYSDK_OFFSET(0xBFDA160)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_TRYCREATEEDITORCOMPONENT_OFFSET UNITYSDK_OFFSET(0xBFDAF10)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_UNINSTALLCOMMPONENT_OFFSET UNITYSDK_OFFSET(0xBFD9D20)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_UPDATECONTAINER_OFFSET UNITYSDK_OFFSET(0xBFD8160)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBFD94F0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER__ADSORBEDCONFRIMPOS_B__37_0_OFFSET UNITYSDK_OFFSET(0xBFDC120)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xBFDC0B0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFDBFF0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFDC2F0)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFDC360)
#define MOLEMOLE_UIBUDDYDIYCOMPONENTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFDC3E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBuddyDIYComponentWidgetController_TypeDefinitionIndex = 71715;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIBuddyDIYComponentWidgetController_TypeDefinitionIndex)->GetStaticField(0x40640);
		}
		static ::System::String** StaticGet_Rotate_Btn_Name()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIBuddyDIYComponentWidgetController_TypeDefinitionIndex)->GetStaticField(0x40648);
		}
		static ::System::String** StaticGet_Confrim_Btn_Name()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIBuddyDIYComponentWidgetController_TypeDefinitionIndex)->GetStaticField(0x40650);
		}
		static ::System::String** StaticGet_IconGridPrefabPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIBuddyDIYComponentWidgetController_TypeDefinitionIndex)->GetStaticField(0x40658);
		}
