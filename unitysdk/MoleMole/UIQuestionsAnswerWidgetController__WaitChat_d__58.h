...
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__WAITCHAT_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x362420)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__WAITCHAT_D__58_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerWidgetController__WaitChat_d__58_TypeDefinitionIndex = 70208;

	struct alignas(8) UIQuestionsAnswerWidgetController__WaitChat_d__58
	{
		::MoleMole::UIQuestionsAnswerChatPlayContext* context; // 0x10
