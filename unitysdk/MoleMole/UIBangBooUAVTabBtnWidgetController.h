...
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_GETRANKSTRICON_OFFSET UNITYSDK_OFFSET(0xD25B530)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_GETRANKSTR_OFFSET UNITYSDK_OFFSET(0xD25B6E0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_ISPERFECT_OFFSET UNITYSDK_OFFSET(0xD25B2E0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD259FF0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD25A130)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD25B860)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD25B870)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER___BASE_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD25B910)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVTabBtnWidgetController_TypeDefinitionIndex = 73856;
