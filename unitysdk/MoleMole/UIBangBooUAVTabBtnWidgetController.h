...
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_GETRANKSTRICON_OFFSET UNITYSDK_OFFSET(0xA258DE0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_GETRANKSTR_OFFSET UNITYSDK_OFFSET(0xA258F90)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_ISPERFECT_OFFSET UNITYSDK_OFFSET(0xA258B90)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA2578A0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA2579E0)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA259110)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA259120)
#define MOLEMOLE_UIBANGBOOUAVTABBTNWIDGETCONTROLLER___BASE_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA2591C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVTabBtnWidgetController_TypeDefinitionIndex = 51403;
