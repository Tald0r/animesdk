...
#define MOLEMOLE_UIINLEVELPLAYERMOVECHILDWINDOWCONTROLLER_CONTEXT_GET_ISBATTLE_OFFSET UNITYSDK_OFFSET(0x9D73570)
#define MOLEMOLE_UIINLEVELPLAYERMOVECHILDWINDOWCONTROLLER_CONTEXT_SET_ISBATTLE_OFFSET UNITYSDK_OFFSET(0x9D73580)
#define MOLEMOLE_UIINLEVELPLAYERMOVECHILDWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9D73590)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPlayerMoveChildWindowController_Context_TypeDefinitionIndex = 77315;
