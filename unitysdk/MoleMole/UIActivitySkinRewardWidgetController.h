...
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x7F51E50)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F51CD0)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F51D70)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F519F0)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F51C20)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER_SETSKINREWARDSTATE_OFFSET UNITYSDK_OFFSET(0x7F51EC0)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F52200)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F52230)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F522A0)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F52320)
#define MOLEMOLE_UIACTIVITYSKINREWARDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F52380)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySkinRewardWidgetController_TypeDefinitionIndex = 64219;

	class UIActivitySkinRewardWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_E6B1B73EBD006A98* _view; // 0x2A0
		::System::Collections::Generic::List_1<::Class_2_E6B1B73EBD006A98_Class_2_D72E10CE1BC97618_4*>* roleImageView; // 0x2A8
