...
#define MOLEMOLE_GETACCESSORYOFLOCKEDSKIN_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x8B13DA0)
#define MOLEMOLE_GETACCESSORYOFLOCKEDSKIN_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x8B13DF0)
#define MOLEMOLE_GETACCESSORYOFLOCKEDSKIN__CTOR_OFFSET UNITYSDK_OFFSET(0x8B13DB0)

namespace MoleMole
{
	inline static constexpr unsigned int GetAccessoryOfLockedSkin_TypeDefinitionIndex = 76844;
