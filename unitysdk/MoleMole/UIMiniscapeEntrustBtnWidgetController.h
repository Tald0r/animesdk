...
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_GETRARITYICONPATH_OFFSET UNITYSDK_OFFSET(0xA21F010)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_GET_TASKID_OFFSET UNITYSDK_OFFSET(0xA21EF90)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA21DB10)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_ONCLICKBTN_OFFSET UNITYSDK_OFFSET(0xA21F340)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA21DC80)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA21DD20)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA21D9B0)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA21DA50)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_PLAYREFRESHANIM_OFFSET UNITYSDK_OFFSET(0xA21EDA0)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA21DE80)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_SETQUEST_OFFSET UNITYSDK_OFFSET(0xA21DE00)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_TRYREFRESHTASK_OFFSET UNITYSDK_OFFSET(0xA21F1E0)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA21F8E0)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA21F910)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA21F980)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA21FA00)
#define MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA21FA60)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeEntrustBtnWidgetController_TypeDefinitionIndex = 59371;

	class UIMiniscapeEntrustBtnWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_A8C94EA612F5CBF3_8* _view; // 0x2A0
		::Class_3_5139B0F7496B8379_12* _task; // 0x2A8
		...
		::System::Void SetQuest(::Class_3_5139B0F7496B8379_12* task)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_5139B0F7496B8379_12*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMINISCAPEENTRUSTBTNWIDGETCONTROLLER_SETQUEST_OFFSET))(this, task);
		}
