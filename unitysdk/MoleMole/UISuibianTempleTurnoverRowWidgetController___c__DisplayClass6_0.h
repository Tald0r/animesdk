...
#define MOLEMOLE_UISUIBIANTEMPLETURNOVERROWWIDGETCONTROLLER___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBEC45B0)
#define MOLEMOLE_UISUIBIANTEMPLETURNOVERROWWIDGETCONTROLLER___C__DISPLAYCLASS6_0__REFRESHTREND_B__0_OFFSET UNITYSDK_OFFSET(0xBEC45C0)
#define MOLEMOLE_UISUIBIANTEMPLETURNOVERROWWIDGETCONTROLLER___C__DISPLAYCLASS6_0__REFRESHTREND_B__1_OFFSET UNITYSDK_OFFSET(0xBEC4750)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleTurnoverRowWidgetController___c__DisplayClass6_0_TypeDefinitionIndex = 62247;

	class UISuibianTempleTurnoverRowWidgetController___c__DisplayClass6_0 : public ::System::Object
	{
	public:
		::MoleMole::UISuibianTempleTurnoverRowWidgetController* __4__this; // 0x10
		::System::String* lockText; // 0x18
		::Class_0_16E4307DCC419505_103<::System::Int32>* trendID; // 0x20
		::Class_2_CC6C6812D7C240D5* slot; // 0x28
