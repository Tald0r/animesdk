...
#define MOLEMOLE_BLOOMPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xB8FCDA0)
#define MOLEMOLE_BLOOMPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xB8FCF20)
#define MOLEMOLE_BLOOMPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0xB8FCCC0)
#define MOLEMOLE_BLOOMPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xB8FCE80)
#define MOLEMOLE_BLOOMPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xB8FCCB0)
#define MOLEMOLE_BLOOMPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xB8FD050)
#define MOLEMOLE_BLOOMPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xB8FD0E0)
#define MOLEMOLE_BLOOMPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xB8FD150)
#define MOLEMOLE_BLOOMPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xB8FD1C0)

namespace MoleMole
{
	inline static constexpr unsigned int BloomProfile_TypeDefinitionIndex = 45708;
