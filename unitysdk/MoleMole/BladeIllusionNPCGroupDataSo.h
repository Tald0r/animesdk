...
#define MOLEMOLE_BLADEILLUSIONNPCGROUPDATASO__CTOR_OFFSET UNITYSDK_OFFSET(0x84E9910)

namespace MoleMole
{
	inline static constexpr unsigned int BladeIllusionNPCGroupDataSo_TypeDefinitionIndex = 50089;
