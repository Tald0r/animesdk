...
#define MOLEMOLE_MONOGRAPHICRAYCASTER_GET_EVENTCAMERA_OFFSET UNITYSDK_OFFSET(0xD436480)
#define MOLEMOLE_MONOGRAPHICRAYCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD436550)
#define MOLEMOLE_MONOGRAPHICRAYCASTER___BASE_GET_EVENTCAMERA_OFFSET UNITYSDK_OFFSET(0xD4365F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGraphicRaycaster_TypeDefinitionIndex = 61976;
