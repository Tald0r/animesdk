...
#define MOLEMOLE_UGUIEXTENSIONS_TILT_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x8FA81A0)
#define MOLEMOLE_UGUIEXTENSIONS_TILT__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA8110)

namespace MoleMole::UGUIExtensions
{
	inline static constexpr unsigned int Tilt_TypeDefinitionIndex = 77888;
