...
#define MOLEMOLE_UGUIEXTENSIONS_TILT_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xC334D40)
#define MOLEMOLE_UGUIEXTENSIONS_TILT__CTOR_OFFSET UNITYSDK_OFFSET(0xC334CB0)

namespace MoleMole::UGUIExtensions
{
	inline static constexpr unsigned int Tilt_TypeDefinitionIndex = 49688;
