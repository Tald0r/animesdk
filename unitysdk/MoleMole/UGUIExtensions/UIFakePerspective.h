...
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_486AF1E6C0038D4C_1_OFFSET UNITYSDK_OFFSET(0x9866AE0)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_486AF1E6C0038D4C_2_OFFSET UNITYSDK_OFFSET(0x9866AF0)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_486AF1E6C0038D4C_3_OFFSET UNITYSDK_OFFSET(0x9866B00)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_486AF1E6C0038D4C_OFFSET UNITYSDK_OFFSET(0x9866AD0)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x9866B20)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x9866B10)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE_SETUPDATE_OFFSET UNITYSDK_OFFSET(0x9866B30)
#define MOLEMOLE_UGUIEXTENSIONS_UIFAKEPERSPECTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9866BA0)

namespace MoleMole::UGUIExtensions
{
	inline static constexpr unsigned int UIFakePerspective_TypeDefinitionIndex = 40788;
