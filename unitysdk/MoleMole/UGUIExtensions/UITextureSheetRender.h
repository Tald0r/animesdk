...
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_ADDENDEVENT_OFFSET UNITYSDK_OFFSET(0x8F52A20)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_GET_COLUMNS_OFFSET UNITYSDK_OFFSET(0x8F500F0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_GET_CURRENTFRAME_OFFSET UNITYSDK_OFFSET(0x8F50180)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_GET_FRAMES_OFFSET UNITYSDK_OFFSET(0x8F50110)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_GET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0x8F502C0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_GET_ROWS_OFFSET UNITYSDK_OFFSET(0x8F50100)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_INITRAWIMAGE_OFFSET UNITYSDK_OFFSET(0x8F513B0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_INIT_OFFSET UNITYSDK_OFFSET(0x8F509C0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8F528C0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x8F52620)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_PLAYRAWIMAGESINGLEFRAME_OFFSET UNITYSDK_OFFSET(0x8F52100)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_PLAYSINGLEFRAME_OFFSET UNITYSDK_OFFSET(0x8F51A70)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_REFRESHRUNTIMEFREQUENCY_OFFSET UNITYSDK_OFFSET(0x8F52930)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_REMOVEENDEVENT_OFFSET UNITYSDK_OFFSET(0x8F52AC0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER_UPDATE_OFFSET UNITYSDK_OFFSET(0x8F50390)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8F52BC0)
#define MOLEMOLE_UGUIEXTENSIONS_UITEXTURESHEETRENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F52B60)

namespace MoleMole::UGUIExtensions
{
	inline static constexpr unsigned int UITextureSheetRender_TypeDefinitionIndex = 60619;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITextureSheetRender_TypeDefinitionIndex)->GetStaticField(0xDA40);
		}
		static ::System::Int32* StaticGet_Field_6_5()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITextureSheetRender_TypeDefinitionIndex)->GetStaticField(0xDA44);
		}
		static ::System::Int32* StaticGet_Field_6_6()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITextureSheetRender_TypeDefinitionIndex)->GetStaticField(0xDA48);
		}
		static ::System::Int32* StaticGet_Field_6_18()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITextureSheetRender_TypeDefinitionIndex)->GetStaticField(0xDA4C);
		}
		static ::System::Int32* StaticGet_Field_6_10()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITextureSheetRender_TypeDefinitionIndex)->GetStaticField(0xDA50);
		}
