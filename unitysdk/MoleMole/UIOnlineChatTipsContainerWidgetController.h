...
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x8EF0450)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_GET__ONLINECHATOPERATEDATAMODIFYQUEUE_OFFSET UNITYSDK_OFFSET(0x8EEEC60)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_GET__ONLINECHATOPERATEDATAS_OFFSET UNITYSDK_OFFSET(0x8EEED50)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_ISSHOWTIP_OFFSET UNITYSDK_OFFSET(0x8EF0560)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_MOVEOPERATEUITOFRONT_OFFSET UNITYSDK_OFFSET(0x8EEFFF0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EEF630)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_ONRECEIVEMULTIPLAYERCHATMESSAGE_OFFSET UNITYSDK_OFFSET(0x8EEF710)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EEF6A0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EEEE60)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8EEF520)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_PROCESSONLINECHATOPERATEDATAMODIFYQUEUE_OFFSET UNITYSDK_OFFSET(0x8EEFB50)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8EF0640)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_REMOVEOPERATEDATA_OFFSET UNITYSDK_OFFSET(0x8EF01F0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_RESUME_OFFSET UNITYSDK_OFFSET(0x8EF0500)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_SETCONSOLEACTIVE_OFFSET UNITYSDK_OFFSET(0x8EF0290)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x8EEFAE0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8EF06B0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EF0860)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EF08D0)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EF0950)
#define MOLEMOLE_UIONLINECHATTIPSCONTAINERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8EF09B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnlineChatTipsContainerWidgetController_TypeDefinitionIndex = 77268;
