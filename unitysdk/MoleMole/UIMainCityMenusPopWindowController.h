...
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x9AA3F10)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9AA3F00)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_INITSUNDRYVIEW_OFFSET UNITYSDK_OFFSET(0x9AA4770)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9AA3F90)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9AA4B00)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9AA4030)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9AA3F20)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9AA4110)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA4D00)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9AA4DC0)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9AA4E30)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9AA4E60)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9AA4E70)
#define MOLEMOLE_UIMAINCITYMENUSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9AA4E80)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMenusPopWindowController_TypeDefinitionIndex = 60933;

	class UIMainCityMenusPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_95B29E984A609629* _view; // 0x2F8
		::MonoUITableScrollV2* _scroll; // 0x300
		::Enum_3_A8FC943A2182F177 _type; // 0x308
		::System::Collections::Generic::List_1<::System::Int32>* _sundryIndexs; // 0x310
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_606*>* _teleportDatas; // 0x318
