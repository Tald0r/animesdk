...
#define MOLEMOLE_AVATARSTORYSTYLEBTNCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6BD6760)

namespace MoleMole
{
	inline static constexpr unsigned int AvatarStoryStyleBtnContext_TypeDefinitionIndex = 42216;
