...
#define MOLEMOLE_INLEVELINTERACTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_LOCKEDSETTINGRAWINPUTDEVICELIST_OFFSET UNITYSDK_OFFSET(0xF1B7900)
#define MOLEMOLE_INLEVELINTERACTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xF1B78E0)
#define MOLEMOLE_INLEVELINTERACTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xF1B78F0)
#define MOLEMOLE_INLEVELINTERACTKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xF1B7990)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelInteractKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 77680;
