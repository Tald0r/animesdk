...
#define MOLEMOLE_UIAVATARSHOWTYPE_GETAVATARSHOWUITYPE_OFFSET UNITYSDK_OFFSET(0xB73FD80)
#define MOLEMOLE_UIAVATARSHOWTYPE_GET_UITYPE_OFFSET UNITYSDK_OFFSET(0xB73FB90)
#define MOLEMOLE_UIAVATARSHOWTYPE_ONUITYPEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xB740060)
#define MOLEMOLE_UIAVATARSHOWTYPE_SET_UITYPE_OFFSET UNITYSDK_OFFSET(0xB73FCF0)
#define MOLEMOLE_UIAVATARSHOWTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0xB7400F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarShowType_TypeDefinitionIndex = 68745;
