...
#define MOLEMOLE_UIRELICBRANCHOPTIONSDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x68EB5A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRelicBranchOptionsDialogContext_TypeDefinitionIndex = 67984;
