...
#define MOLEMOLE_UIRELICBRANCHOPTIONSDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8686B40)

namespace MoleMole
{
	inline static constexpr unsigned int UIRelicBranchOptionsDialogContext_TypeDefinitionIndex = 54889;
