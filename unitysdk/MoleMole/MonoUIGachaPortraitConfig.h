...
#define MOLEMOLE_MONOUIGACHAPORTRAITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB3BCC60)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIGachaPortraitConfig_TypeDefinitionIndex = 50560;
