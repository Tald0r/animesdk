...
#define MOLEMOLE_LEVEL_BANGBOOFINDOBJCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F8070)

namespace MoleMole::Level
{
	inline static constexpr unsigned int BangbooFindObjConfig_TypeDefinitionIndex = 74723;
