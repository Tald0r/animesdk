...
#define MOLEMOLE_LEVEL_SCENEFCVIEWINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xF1B9ED0)

namespace MoleMole::Level
{
	inline static constexpr unsigned int SceneFCViewInfo_TypeDefinitionIndex = 51798;
