...
#define MOLEMOLE_LEVEL_LEVELCONFIG_GLOBALAIUPGRADEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F81F0)

namespace MoleMole::Level
{
	inline static constexpr unsigned int LevelConfig_GlobalAIUpgradeParam_TypeDefinitionIndex = 55874;
