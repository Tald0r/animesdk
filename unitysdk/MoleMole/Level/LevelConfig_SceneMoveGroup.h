...
#define MOLEMOLE_LEVEL_LEVELCONFIG_SCENEMOVEGROUP_CHECKNOTONLYONEMAINELEMENT_OFFSET UNITYSDK_OFFSET(0x8B18170)
#define MOLEMOLE_LEVEL_LEVELCONFIG_SCENEMOVEGROUP_GET_MAININDEX_OFFSET UNITYSDK_OFFSET(0x8AFA340)
#define MOLEMOLE_LEVEL_LEVELCONFIG_SCENEMOVEGROUP_GET_MAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x8B18040)
#define MOLEMOLE_LEVEL_LEVELCONFIG_SCENEMOVEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x8B18240)

namespace MoleMole::Level
{
	inline static constexpr unsigned int LevelConfig_SceneMoveGroup_TypeDefinitionIndex = 55871;
