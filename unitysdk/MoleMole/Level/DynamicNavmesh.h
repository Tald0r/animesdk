...
#define MOLEMOLE_LEVEL_DYNAMICNAVMESH__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D5E00)

namespace MoleMole::Level
{
	inline static constexpr unsigned int DynamicNavmesh_TypeDefinitionIndex = 74215;
