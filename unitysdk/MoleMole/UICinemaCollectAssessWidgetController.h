...
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0CBC40)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC0CBDC0)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0CBCE0)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0CBBA0)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER_REFRESHASSESS_OFFSET UNITYSDK_OFFSET(0xC0CBEC0)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0CC1B0)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0CC1C0)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC0CC230)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0CC2B0)
#define MOLEMOLE_UICINEMACOLLECTASSESSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0CC330)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaCollectAssessWidgetController_TypeDefinitionIndex = 48277;

	class UICinemaCollectAssessWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_6EF46B4BE03754EE* _view; // 0x2D0
		::System::Int32 reviewCommnetID; // 0x2D8
