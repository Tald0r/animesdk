...
#define MOLEMOLE_UIFLOWERMAIN_RIGHTWIDGETCONTROLLER___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA357B50)
#define MOLEMOLE_UIFLOWERMAIN_RIGHTWIDGETCONTROLLER___C__DISPLAYCLASS21_0__REFRESHSCROLLVIEWDATA_B__0_OFFSET UNITYSDK_OFFSET(0xA357B60)
#define MOLEMOLE_UIFLOWERMAIN_RIGHTWIDGETCONTROLLER___C__DISPLAYCLASS21_0__REFRESHSCROLLVIEWDATA_B__1_OFFSET UNITYSDK_OFFSET(0xA357D10)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMain_RightWidgetController___c__DisplayClass21_0_TypeDefinitionIndex = 57316;
