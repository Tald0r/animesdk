...
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_ADDJUMPCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0xA9951A0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_BINDREDSIGN_OFFSET UNITYSDK_OFFSET(0xA993B50)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_BINDVIEWCALLBACK_OFFSET UNITYSDK_OFFSET(0xA994500)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_GETBUTTONSTATEINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xA993830)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_GETBUTTONSTATETEXTKEY_OFFSET UNITYSDK_OFFSET(0xA993490)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_GETBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0xA993950)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_GETEFFECTENABLED_OFFSET UNITYSDK_OFFSET(0xA995130)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_GETTEXT_OFFSET UNITYSDK_OFFSET(0xA994DD0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0xA9941E0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_REBINDVIEWCALLBACKADVANCE_OFFSET UNITYSDK_OFFSET(0xA994290)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_REMOVECLICKLISTENER_OFFSET UNITYSDK_OFFSET(0xA994430)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0xA980810)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETARGS_OFFSET UNITYSDK_OFFSET(0xA9955E0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETBUTTONSTATEINTERACTABLE_1_OFFSET UNITYSDK_OFFSET(0xA9937C0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETBUTTONSTATEINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xA9935B0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETBUTTONSTATETEXTKEY_1_OFFSET UNITYSDK_OFFSET(0xA993420)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETBUTTONSTATETEXTKEY_OFFSET UNITYSDK_OFFSET(0xA97EE90)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETBUTTONSTATE_1_OFFSET UNITYSDK_OFFSET(0xA980910)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0xA9939C0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETEFFECTENABLED_OFFSET UNITYSDK_OFFSET(0xA994E50)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xA9936C0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETKEY_OFFSET UNITYSDK_OFFSET(0xA995570)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETLOCK_OFFSET UNITYSDK_OFFSET(0xA994210)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETTEXTARGS_OFFSET UNITYSDK_OFFSET(0xA9945B0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETTEXTCOLOR_OFFSET UNITYSDK_OFFSET(0xA994AE0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETTEXTKEY_OFFSET UNITYSDK_OFFSET(0xA992FE0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0xA993C60)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_SET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0xA993AD0)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER_TRIGGERBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xA995430)
#define MOLEMOLE_UIGENERALBUTTONCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA995650)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralButtonController_TypeDefinitionIndex = 60963;
