...
#define MOLEMOLE_SWITCHTEAMINBATTLESUBSYSTEM__PROCESSASSETSASYNC_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3F2E20)
#define MOLEMOLE_SWITCHTEAMINBATTLESUBSYSTEM__PROCESSASSETSASYNC_D__25_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int SwitchTeamInBattleSubSystem__ProcessAssetsAsync_d__25_TypeDefinitionIndex = 67911;

	struct alignas(8) SwitchTeamInBattleSubSystem__ProcessAssetsAsync_d__25
	{
		::System::Collections::Generic::List_1_Enumerator<::Foundation::AssetPath> __7__wrap1; // 0x10
		::MoleMole::SwitchTeamInBattleSubSystem* __4__this; // 0x30
