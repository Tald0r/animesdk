...
#define MOLEMOLE_UIACTIVITYBATTLECOMMONRECORDPOPWINDOWCONTROLLER_RECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB5D4B50)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityBattleCommonRecordPopWindowController_RecordData_TypeDefinitionIndex = 50113;
	...
	public:
		...
		::System::String* noPassTimeTitle; // 0x18
		::System::String* gradeTitle; // 0x20
