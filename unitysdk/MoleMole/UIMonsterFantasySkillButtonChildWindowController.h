...
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAF7FFD0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAF7FFE0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_INITBTN_OFFSET UNITYSDK_OFFSET(0xAF81030)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ISSHOWCURSKILLINFO_OFFSET UNITYSDK_OFFSET(0xAF822F0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAF80110)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONLONGPRESSING_OFFSET UNITYSDK_OFFSET(0xAF824F0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONPREVIEWCHANGE_OFFSET UNITYSDK_OFFSET(0xAF81C50)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAF80050)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONSPCHANGE_OFFSET UNITYSDK_OFFSET(0xAF81870)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF80B20)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_RESETPRESS_OFFSET UNITYSDK_OFFSET(0xAF80980)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_SETIMGMATERIAL_OFFSET UNITYSDK_OFFSET(0xAF81980)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_TOGGLESKILLINFO_OFFSET UNITYSDK_OFFSET(0xAF82180)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_TRIGGERCLICK_OFFSET UNITYSDK_OFFSET(0xAF82460)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAF827F0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__INITBTN_B__26_0_OFFSET UNITYSDK_OFFSET(0xAF82F50)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__INITBTN_B__26_1_OFFSET UNITYSDK_OFFSET(0xAF83DC0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__ONCREATEVIEWMODEL_B__24_0_OFFSET UNITYSDK_OFFSET(0xAF82B40)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__ONCREATEVIEWMODEL_B__24_1_OFFSET UNITYSDK_OFFSET(0xAF82B50)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__ONCREATEVIEWMODEL_B__24_2_OFFSET UNITYSDK_OFFSET(0xAF82B80)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__ONCREATEVIEWMODEL_B__24_3_OFFSET UNITYSDK_OFFSET(0xAF82E00)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAF84070)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAF840E0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF840F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasySkillButtonChildWindowController_TypeDefinitionIndex = 77333;
