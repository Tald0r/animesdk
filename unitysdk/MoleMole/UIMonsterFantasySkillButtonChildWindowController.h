...
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x92B67B0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x92B67C0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_INITBTN_OFFSET UNITYSDK_OFFSET(0x92B7810)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ISSHOWCURSKILLINFO_OFFSET UNITYSDK_OFFSET(0x92B8AB0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x92B68F0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONLONGPRESSING_OFFSET UNITYSDK_OFFSET(0x92B8CB0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONPREVIEWCHANGE_OFFSET UNITYSDK_OFFSET(0x92B8410)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x92B6830)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONSPCHANGE_OFFSET UNITYSDK_OFFSET(0x92B8030)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x92B7300)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_RESETPRESS_OFFSET UNITYSDK_OFFSET(0x92B7160)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_SETIMGMATERIAL_OFFSET UNITYSDK_OFFSET(0x92B8140)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_TOGGLESKILLINFO_OFFSET UNITYSDK_OFFSET(0x92B8940)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_TRIGGERCLICK_OFFSET UNITYSDK_OFFSET(0x92B8C20)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x92B8FB0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__INITBTN_B__26_0_OFFSET UNITYSDK_OFFSET(0x92B9710)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__INITBTN_B__26_1_OFFSET UNITYSDK_OFFSET(0x92BA570)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__ONCREATEVIEWMODEL_B__24_0_OFFSET UNITYSDK_OFFSET(0x92B9300)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__ONCREATEVIEWMODEL_B__24_1_OFFSET UNITYSDK_OFFSET(0x92B9310)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__ONCREATEVIEWMODEL_B__24_2_OFFSET UNITYSDK_OFFSET(0x92B9340)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER__ONCREATEVIEWMODEL_B__24_3_OFFSET UNITYSDK_OFFSET(0x92B95C0)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x92BA820)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x92BA890)
#define MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x92BA8A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasySkillButtonChildWindowController_TypeDefinitionIndex = 58467;

	class UIMonsterFantasySkillButtonChildWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::MoleMole::LogicButtonInputType _logicButtonInputType; // 0x2F8
		::MoleMole::InputLogicEventType _logicEventType; // 0x2FC
		::MoleMole::MonoInputKey* _inputKey; // 0x300
		::Class_2_60DDD9C206686F44* _btn; // 0x308
		::UnityEngine::RectTransform* _pressRoot; // 0x310
		::Class_2_A8F5ABF31E066ED4* _pressFill; // 0x318
		::System::UInt32 _longPressSoundPendingId; // 0x320
		::Il2CppArray<::System::String*>* _matPaths; // 0x328
		::Il2CppArray<::System::String*>* _lightMatPaths; // 0x330
		::Il2CppArray<::System::String*>* _lightGlowMatPaths; // 0x338
		::Il2CppArray<::UnityEngine::Material*>* _lightMaterials; // 0x340
		::Il2CppArray<::UnityEngine::Material*>* _lightGlowMaterials; // 0x348
		::Il2CppArray<::UnityEngine::Material*>* _mat; // 0x350
		::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>* _lightMaterialHandles; // 0x358
		::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>* _lightGlowMaterialHandles; // 0x360
		::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>* _matHandles; // 0x368
		::System::String* _fadeInAnim; // 0x370
		::Class_1_48D56DACBE4271BC* _syncHelper; // 0x378
		::System::Boolean _isResettingPress; // 0x380
		...
		::System::Void SetImgMaterial(::Class_2_A8F5ABF31E066ED4* img, ::System::Int32 index, ::Il2CppArray<::UnityEngine::Material*>* mat, ::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>* handles, ::Il2CppArray<::System::String*>* paths)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_A8F5ABF31E066ED4*, ::System::Int32, ::Il2CppArray<::UnityEngine::Material*>*, ::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>*, ::Il2CppArray<::System::String*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMONSTERFANTASYSKILLBUTTONCHILDWINDOWCONTROLLER_SETIMGMATERIAL_OFFSET))(this, img, index, mat, handles, paths);
		}
