...
#define MOLEMOLE_UINEOGOLDENMECHASKILLBTNWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA35430)
#define MOLEMOLE_UINEOGOLDENMECHASKILLBTNWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA354A0)
#define MOLEMOLE_UINEOGOLDENMECHASKILLBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA355A0)
#define MOLEMOLE_UINEOGOLDENMECHASKILLBTNWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA355B0)

namespace MoleMole
{
	inline static constexpr unsigned int UINeoGoldenMechaSkillBtnWidgetController_TypeDefinitionIndex = 52243;
	...
	public:
		...
		{
			return ((::Class_2_EC28E1D3A39EE7DE_12*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UINEOGOLDENMECHASKILLBTNWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
