...
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_CREATEPERCENTTIPS_OFFSET UNITYSDK_OFFSET(0x8C4A270)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_DOOPENBAG_OFFSET UNITYSDK_OFFSET(0x8C4A860)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_INITFLOWPERCENTTIPS_OFFSET UNITYSDK_OFFSET(0x8C49500)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONACTIVITYPARAMUPDATED_OFFSET UNITYSDK_OFFSET(0x8C4A430)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C4AAB0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONHOLLOWWATERFLOWFEVERCHANGE_OFFSET UNITYSDK_OFFSET(0x8C499E0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONHOLLOWWATERFLOWPERCENTCHANGE_OFFSET UNITYSDK_OFFSET(0x8C4A370)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONHOLLOWWATERFLOWPERCENTTIPSINIT_OFFSET UNITYSDK_OFFSET(0x8C4A1A0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C4AB50)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C48A10)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C4AA00)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_REFRESHPARAMS_OFFSET UNITYSDK_OFFSET(0x8C48F50)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_REGISTERVIRUSINDEX_OFFSET UNITYSDK_OFFSET(0x8C4A730)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_REGISTERVIRUSOFCONCERN_OFFSET UNITYSDK_OFFSET(0x8C4A4A0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_SETDEFAULTVIEW_OFFSET UNITYSDK_OFFSET(0x8C48D00)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_UPDATEFEVER_OFFSET UNITYSDK_OFFSET(0x8C49AA0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER_UPDATEPERCENTVIEW_OFFSET UNITYSDK_OFFSET(0x8C49240)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8C4AC70)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C4AC40)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C4ACB0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C4AD20)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C4ADA0)
#define MOLEMOLE_UIHOLLOWWATERFLOWFISHINGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8C4AE00)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowWaterFlowFishingWidgetController_TypeDefinitionIndex = 64065;
	...
	public:
		...
		{
			return (::MoleMole::UIHollowWaterFlowFishingWidgetController_HollowWaterFlowPercentTipsInitInfo**)Il2CppClass::FromTypeDefinitionIndex(UIHollowWaterFlowFishingWidgetController_TypeDefinitionIndex)->GetStaticField(0x39880);
		}
