...
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0xC7FD160)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC7FBFA0)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xC7FCBB0)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC7FC040)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC7FC2D0)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC7FC1F0)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC7FB930)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC7FBEF0)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER_REFRESHBANGBOO_OFFSET UNITYSDK_OFFSET(0xC7FC410)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER_SHOWPLATFORMUI_OFFSET UNITYSDK_OFFSET(0xC7FD8B0)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC7FC340)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER__BINDVIEW_B__17_0_OFFSET UNITYSDK_OFFSET(0xC7FDB30)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER__BINDVIEW_B__17_1_OFFSET UNITYSDK_OFFSET(0xC7FDD90)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER__BINDVIEW_B__17_2_OFFSET UNITYSDK_OFFSET(0xC7FDFF0)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER__BINDVIEW_B__17_3_OFFSET UNITYSDK_OFFSET(0xC7FE2E0)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER__BINDVIEW_B__17_4_OFFSET UNITYSDK_OFFSET(0xC7FE420)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC7FDAA0)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER__ONUIINIT_B__9_0_OFFSET UNITYSDK_OFFSET(0xC7FDAD0)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER__ONUIINIT_B__9_1_OFFSET UNITYSDK_OFFSET(0xC7FDB00)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER__SHOWPLATFORMUI_G__SETUPPLATFORMUI_18_0_OFFSET UNITYSDK_OFFSET(0xC7FDA30)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC7FE560)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xC7FE5D0)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC7FE650)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC7FE680)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC7FE690)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC7FE710)
#define MOLEMOLE_UIABINLEVELPLAYERINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC7FE770)

namespace MoleMole
{
	inline static constexpr unsigned int UIABInLevelPlayerInfoWidgetController_TypeDefinitionIndex = 55466;
