...
#define MOLEMOLE_UIACTIVITYRETURNCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCA96E90)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityReturnContext_TypeDefinitionIndex = 66390;
