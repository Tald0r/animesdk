...
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER_ISCOLLECT_OFFSET UNITYSDK_OFFSET(0xBFCBF80)
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0xBFCC2C0)
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFCBA10)
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xBFCC510)
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFCBB90)
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFCBAB0)
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFCB970)
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0xBFCC0F0)
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFCC5A0)
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFCC5B0)
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xBFCC620)
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFCC690)
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFCC710)
#define MOLEMOLE_UIBANGBOOUAVWEAPONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFCC790)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVWeaponWidgetController_TypeDefinitionIndex = 75211;
	...
	public:
		...
		::Class_2_208CC9941471731A_849* m_cfg; // 0x2D8
