...
#define MOLEMOLE_CONFIGUIMAINPAGEGENERALSHOWITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xE833590)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainPageGeneralShowItem_TypeDefinitionIndex = 62977;
