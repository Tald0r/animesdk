...
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCFF4D90)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCFF4E00)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_ONFOCUS_OFFSET UNITYSDK_OFFSET(0xCFF52D0)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xCFF5470)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCFF4EC0)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCFF5710)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_TABIDXCHANGED_OFFSET UNITYSDK_OFFSET(0xCFF5AD0)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF5B80)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCFF5BB0)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xCFF5C20)
#define MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCFF5C80)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityBlindBoxWidgetController_TypeDefinitionIndex = 55885;

	class UIActivityBlindBoxWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Action_1<::System::Int32>* OnTabIdxChanged; // 0x2A0
		...
		{
			return ((::Class_2_EC28E1D3A39EE7DE_19*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYBLINDBOXWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
