...
#define MOLEMOLE_UIMAINCITYREWARDTIPSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC12ADC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityRewardTipsContext_TypeDefinitionIndex = 61908;
