...
#define MOLEMOLE_TEXTURESHEETDATA_CREATEPLAYER_OFFSET UNITYSDK_OFFSET(0xA6659F0)
#define MOLEMOLE_TEXTURESHEETDATA_FINDBLENDTEXTURESHEETDATABYKEY_OFFSET UNITYSDK_OFFSET(0xA665800)
#define MOLEMOLE_TEXTURESHEETDATA_FINDBLENDTEXTURESHEETDATABYTEMPLATE_OFFSET UNITYSDK_OFFSET(0xA665730)
#define MOLEMOLE_TEXTURESHEETDATA_FINDTEXTURESHEETDATABYKEY_OFFSET UNITYSDK_OFFSET(0xA665960)
#define MOLEMOLE_TEXTURESHEETDATA_FINDTEXTURESHEETDATABYTEMPLATE_OFFSET UNITYSDK_OFFSET(0xA665880)
#define MOLEMOLE_TEXTURESHEETDATA_GETFRAMETIME_OFFSET UNITYSDK_OFFSET(0xA665A70)
#define MOLEMOLE_TEXTURESHEETDATA_GETSOUNDCLIPCONFIG_OFFSET UNITYSDK_OFFSET(0xA6655D0)
#define MOLEMOLE_TEXTURESHEETDATA_GETTEXTUREOFFSETBYFRAMEINDEX_OFFSET UNITYSDK_OFFSET(0xA665AE0)
#define MOLEMOLE_TEXTURESHEETDATA_ISLOOP_OFFSET UNITYSDK_OFFSET(0xA665C00)
#define MOLEMOLE_TEXTURESHEETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA665D90)

namespace MoleMole
{
	inline static constexpr unsigned int TextureSheetData_TypeDefinitionIndex = 57888;
	...
	public:
		...
		static ::MoleMole::BlendTextureSheetData* FindBlendTextureSheetDataByTemplate(::Class_2_208CC9941471731A_946* template_)
		{
			return ((::MoleMole::BlendTextureSheetData*(*)(::Class_2_208CC9941471731A_946*))((::PBYTE)hIl2Cpp + MOLEMOLE_TEXTURESHEETDATA_FINDBLENDTEXTURESHEETDATABYTEMPLATE_OFFSET))(template_);
		}

		static ::MoleMole::TextureSheetData* FindTextureSheetDataByTemplate(::Class_2_208CC9941471731A_946* template_, ::System::Boolean enableLog)
		{
			return ((::MoleMole::TextureSheetData*(*)(::Class_2_208CC9941471731A_946*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_TEXTURESHEETDATA_FINDTEXTURESHEETDATABYTEMPLATE_OFFSET))(template_, enableLog);
		}
		...
		{
			return ((::Class_1_5A6771CD0CA2718D*(*)(::PVOID, ::Class_0_16E4307DCC419505_411*))((::PBYTE)hIl2Cpp + MOLEMOLE_TEXTURESHEETDATA_CREATEPLAYER_OFFSET))(this, textureSheetImpl);
		}
