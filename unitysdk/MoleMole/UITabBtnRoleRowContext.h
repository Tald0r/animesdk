...
#define MOLEMOLE_UITABBTNROLEROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7530610)

namespace MoleMole
{
	inline static constexpr unsigned int UITabBtnRoleRowContext_TypeDefinitionIndex = 68486;
