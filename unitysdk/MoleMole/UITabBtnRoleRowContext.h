...
#define MOLEMOLE_UITABBTNROLEROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x990B430)

namespace MoleMole
{
	inline static constexpr unsigned int UITabBtnRoleRowContext_TypeDefinitionIndex = 78855;
