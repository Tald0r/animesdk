...
#define MOLEMOLE_SCROLLEXPENDABLEVIEW_GET_EXPENDSTATE_OFFSET UNITYSDK_OFFSET(0xD449960)
#define MOLEMOLE_SCROLLEXPENDABLEVIEW_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD449840)
#define MOLEMOLE_SCROLLEXPENDABLEVIEW_SET_EXPENDSTATE_OFFSET UNITYSDK_OFFSET(0xD449970)
#define MOLEMOLE_SCROLLEXPENDABLEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD449980)
#define MOLEMOLE_SCROLLEXPENDABLEVIEW___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD449990)

namespace MoleMole
{
	inline static constexpr unsigned int ScrollExpendAbleView_TypeDefinitionIndex = 61769;
