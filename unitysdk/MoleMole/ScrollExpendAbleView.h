...
#define MOLEMOLE_SCROLLEXPENDABLEVIEW_GET_EXPENDSTATE_OFFSET UNITYSDK_OFFSET(0x6B20A30)
#define MOLEMOLE_SCROLLEXPENDABLEVIEW_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x6B20910)
#define MOLEMOLE_SCROLLEXPENDABLEVIEW_SET_EXPENDSTATE_OFFSET UNITYSDK_OFFSET(0x6B20A40)
#define MOLEMOLE_SCROLLEXPENDABLEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x6B20A50)
#define MOLEMOLE_SCROLLEXPENDABLEVIEW___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x6B20A60)

namespace MoleMole
{
	inline static constexpr unsigned int ScrollExpendAbleView_TypeDefinitionIndex = 78312;

	class ScrollExpendAbleView : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::System::Boolean _ExpendState_k__BackingField; // 0x2D0
