...
#define MOLEMOLE_USEOFFSCREENPARTICLESMSAABYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x69B5790)
#define MOLEMOLE_USEOFFSCREENPARTICLESMSAABYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x69B5820)
#define MOLEMOLE_USEOFFSCREENPARTICLESMSAABYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x69B5880)

namespace MoleMole
{
	inline static constexpr unsigned int UseOffScreenParticlesMSAAByGPUModelPostProcessorProfile_TypeDefinitionIndex = 76592;
