...
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xAE3F330)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xAE3F3D0)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE3F120)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE3F440)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER__ONUIOPEN_B__1_0_OFFSET UNITYSDK_OFFSET(0xAE3F450)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER___BASE_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xAE3F480)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER___BASE_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xAE3F4B0)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE3F510)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerEventResultPageController_TypeDefinitionIndex = 64524;
