...
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xABA5A70)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xABA5B10)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xABA5850)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xABA5B80)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER__ONUIOPEN_B__1_0_OFFSET UNITYSDK_OFFSET(0xABA5B90)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER___BASE_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xABA5BC0)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER___BASE_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0xABA5BF0)
#define MOLEMOLE_UISUMMEREVENTRESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xABA5C50)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerEventResultPageController_TypeDefinitionIndex = 71522;

	class UISummerEventResultPageController : public ::MoleMole::UIHollowLayerResultPageV2PopWindowController
	{
	public:
		::MoleMole::SummerEventResultContextV2* _context; // 0x378
