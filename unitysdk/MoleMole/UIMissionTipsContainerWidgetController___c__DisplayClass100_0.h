...
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS100_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE2110)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS100_0__PLAYINTERKNOTTIP_B__0_OFFSET UNITYSDK_OFFSET(0xCFEB610)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS100_0__PLAYINTERKNOTTIP_B__1_OFFSET UNITYSDK_OFFSET(0xCFEB6E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsContainerWidgetController___c__DisplayClass100_0_TypeDefinitionIndex = 75707;
