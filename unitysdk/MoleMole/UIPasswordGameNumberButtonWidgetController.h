...
#define MOLEMOLE_UIPASSWORDGAMENUMBERBUTTONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE2E760)
#define MOLEMOLE_UIPASSWORDGAMENUMBERBUTTONWIDGETCONTROLLER_ONNUMBTN_OFFSET UNITYSDK_OFFSET(0xAE2EBF0)
#define MOLEMOLE_UIPASSWORDGAMENUMBERBUTTONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE2E800)
#define MOLEMOLE_UIPASSWORDGAMENUMBERBUTTONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE2E1F0)
#define MOLEMOLE_UIPASSWORDGAMENUMBERBUTTONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE2E290)
#define MOLEMOLE_UIPASSWORDGAMENUMBERBUTTONWIDGETCONTROLLER_RESETVIEW_OFFSET UNITYSDK_OFFSET(0xAE2E440)
#define MOLEMOLE_UIPASSWORDGAMENUMBERBUTTONWIDGETCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0xAE2E8E0)
#define MOLEMOLE_UIPASSWORDGAMENUMBERBUTTONWIDGETCONTROLLER_SIMULATESELECTBTN_OFFSET UNITYSDK_OFFSET(0xAE2EA20)
#define MOLEMOLE_UIPASSWORDGAMENUMBERBUTTONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE2EC70)
#define MOLEMOLE_UIPASSWORDGAMENUMBERBUTTONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE2ECA0)
#define MOLEMOLE_UIPASSWORDGAMENUMBERBUTTONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE2ED10)
#define MOLEMOLE_UIPASSWORDGAMENUMBERBUTTONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE2ED90)
#define MOLEMOLE_UIPASSWORDGAMENUMBERBUTTONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE2EDF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPasswordGameNumberButtonWidgetController_TypeDefinitionIndex = 52607;
