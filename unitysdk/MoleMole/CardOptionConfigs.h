...
#define MOLEMOLE_CARDOPTIONCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x848E1B0)

namespace MoleMole
{
	inline static constexpr unsigned int CardOptionConfigs_TypeDefinitionIndex = 46582;
