...
#define MOLEMOLE_CARDOPTIONCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x94E5760)

namespace MoleMole
{
	inline static constexpr unsigned int CardOptionConfigs_TypeDefinitionIndex = 57684;
