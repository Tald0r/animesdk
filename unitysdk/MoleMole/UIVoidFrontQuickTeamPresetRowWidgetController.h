...
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x953DE20)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x953DF90)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x953E090)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER_ONSELECTROLEEVENT_OFFSET UNITYSDK_OFFSET(0x953E1C0)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x953DE90)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x953E300)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x953E310)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x953E380)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMPRESETROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x953E400)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontQuickTeamPresetRowWidgetController_TypeDefinitionIndex = 52604;
