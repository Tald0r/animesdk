...
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_CHANGEMATERIAL_OFFSET UNITYSDK_OFFSET(0xA631180)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_CLEARPROGRESS_OFFSET UNITYSDK_OFFSET(0xA6311F0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0xA62FF10)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_GETANIMCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0xA630C80)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_GET_MAX_PROGRESS_WIDTH_OFFSET UNITYSDK_OFFSET(0xA62FD80)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA62FD70)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0xA62FFC0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0xA630090)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0xA630D30)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA62FD90)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA62FE30)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER_SETMAT_OFFSET UNITYSDK_OFFSET(0xA630960)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA6312D0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0xA6312E0)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA631340)
#define MOLEMOLE_UIINLEVELQINGYIPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA6313B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelQingYiPanelChildWindowController_TypeDefinitionIndex = 50742;
