...
#define MOLEMOLE_INTERACTTRAITDATA_INTERACTTRAITDATA_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xA5F76A0)
#define MOLEMOLE_INTERACTTRAITDATA_INTERACTTRAITDATA_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xA5F76B0)
#define MOLEMOLE_INTERACTTRAITDATA_INTERACTTRAITDATA_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xA5F7900)
#define MOLEMOLE_INTERACTTRAITDATA_INTERACTTRAITDATA_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA5F7B10)
#define MOLEMOLE_INTERACTTRAITDATA_INTERACTTRAITDATA_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F7AD0)

namespace MoleMole
{
	inline static constexpr unsigned int InteractTraitData_InteractTraitData_UnityGeneratedFormatter_TypeDefinitionIndex = 40018;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigInteractionFanCylinder>**)Il2CppClass::FromTypeDefinitionIndex(InteractTraitData_InteractTraitData_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x38890);
		}
