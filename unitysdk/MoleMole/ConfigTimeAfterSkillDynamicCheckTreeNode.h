...
#define MOLEMOLE_CONFIGTIMEAFTERSKILLDYNAMICCHECKTREENODE_CREATE_OFFSET UNITYSDK_OFFSET(0xE454760)
#define MOLEMOLE_CONFIGTIMEAFTERSKILLDYNAMICCHECKTREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE454820)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTimeAfterSkillDynamicCheckTreeNode_TypeDefinitionIndex = 58834;
