...
#define MOLEMOLE_TWEENPOSITION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xD224AD0)
#define MOLEMOLE_TWEENPOSITION_METHOD_7_08B7287B59325288_OFFSET UNITYSDK_OFFSET(0xD224CD0)
#define MOLEMOLE_TWEENPOSITION_METHOD_7_626C719A884DEF9A_OFFSET UNITYSDK_OFFSET(0xD224C20)
#define MOLEMOLE_TWEENPOSITION_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xD224AF0)
#define MOLEMOLE_TWEENPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xD224DA0)
#define MOLEMOLE_TWEENPOSITION___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xD224DC0)

namespace MoleMole
{
	inline static constexpr unsigned int TweenPosition_TypeDefinitionIndex = 53623;
