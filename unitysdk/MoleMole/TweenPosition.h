...
#define MOLEMOLE_TWEENPOSITION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xA4AEA80)
#define MOLEMOLE_TWEENPOSITION_METHOD_7_08B7287B59325288_OFFSET UNITYSDK_OFFSET(0xA4AEC80)
#define MOLEMOLE_TWEENPOSITION_METHOD_7_626C719A884DEF9A_OFFSET UNITYSDK_OFFSET(0xA4AEBD0)
#define MOLEMOLE_TWEENPOSITION_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xA4AEAA0)
#define MOLEMOLE_TWEENPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AED50)
#define MOLEMOLE_TWEENPOSITION___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xA4AED70)

namespace MoleMole
{
	inline static constexpr unsigned int TweenPosition_TypeDefinitionIndex = 42784;
