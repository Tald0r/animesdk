...
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ANIMATIONFADEOUTFADEINGROUP_MERGE_OFFSET UNITYSDK_OFFSET(0x96F5F40)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ANIMATIONFADEOUTFADEINGROUP_PLAYGROUPFADEIN_OFFSET UNITYSDK_OFFSET(0x96F66A0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ANIMATIONFADEOUTFADEINGROUP_PLAYGROUPFADEOUTFADEIN_OFFSET UNITYSDK_OFFSET(0x96F6340)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ANIMATIONFADEOUTFADEINGROUP_PLAYGROUPFADEOUT_OFFSET UNITYSDK_OFFSET(0x96F61D0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ANIMATIONFADEOUTFADEINGROUP_SAMPLEGROUPFADEOUT_OFFSET UNITYSDK_OFFSET(0x96F6860)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ANIMATIONFADEOUTFADEINGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x96EF980)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoPageController_AnimationFadeOutFadeInGroup_TypeDefinitionIndex = 74626;
