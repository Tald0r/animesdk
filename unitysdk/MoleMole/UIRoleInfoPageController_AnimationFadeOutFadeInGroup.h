...
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ANIMATIONFADEOUTFADEINGROUP_MERGE_OFFSET UNITYSDK_OFFSET(0xA3F9330)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ANIMATIONFADEOUTFADEINGROUP_PLAYGROUPFADEIN_OFFSET UNITYSDK_OFFSET(0xA3F9A90)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ANIMATIONFADEOUTFADEINGROUP_PLAYGROUPFADEOUTFADEIN_OFFSET UNITYSDK_OFFSET(0xA3F9730)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ANIMATIONFADEOUTFADEINGROUP_PLAYGROUPFADEOUT_OFFSET UNITYSDK_OFFSET(0xA3F95C0)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ANIMATIONFADEOUTFADEINGROUP_SAMPLEGROUPFADEOUT_OFFSET UNITYSDK_OFFSET(0xA3F9C50)
#define MOLEMOLE_UIROLEINFOPAGECONTROLLER_ANIMATIONFADEOUTFADEINGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xA3F2DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoPageController_AnimationFadeOutFadeInGroup_TypeDefinitionIndex = 47507;
