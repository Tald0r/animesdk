...
#define MOLEMOLE_DEVICEADAPTDATA_METHOD_1_D64FD9A228A1C4E0_1_OFFSET UNITYSDK_OFFSET(0xD0C04A0)
#define MOLEMOLE_DEVICEADAPTDATA_METHOD_1_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0xD0C03F0)
#define MOLEMOLE_DEVICEADAPTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD0C03B0)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceAdaptData_TypeDefinitionIndex = 44958;
