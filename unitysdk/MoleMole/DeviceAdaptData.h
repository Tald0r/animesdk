...
#define MOLEMOLE_DEVICEADAPTDATA_METHOD_1_D64FD9A228A1C4E0_1_OFFSET UNITYSDK_OFFSET(0x8F60BD0)
#define MOLEMOLE_DEVICEADAPTDATA_METHOD_1_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x8F60B20)
#define MOLEMOLE_DEVICEADAPTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8F60AE0)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceAdaptData_TypeDefinitionIndex = 64388;
