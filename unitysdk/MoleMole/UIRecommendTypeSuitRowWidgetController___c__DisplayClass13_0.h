...
#define MOLEMOLE_UIRECOMMENDTYPESUITROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0xADF3F70)
#define MOLEMOLE_UIRECOMMENDTYPESUITROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__REFRESHVIEW_B__0_OFFSET UNITYSDK_OFFSET(0xADF3F80)
#define MOLEMOLE_UIRECOMMENDTYPESUITROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__REFRESHVIEW_B__1_OFFSET UNITYSDK_OFFSET(0xADF3FB0)
#define MOLEMOLE_UIRECOMMENDTYPESUITROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__REFRESHVIEW_G__GETSUITFILTERINDEX_3_OFFSET UNITYSDK_OFFSET(0xADF4260)
#define MOLEMOLE_UIRECOMMENDTYPESUITROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__REFRESHVIEW_G__ISCANSELECT_4_OFFSET UNITYSDK_OFFSET(0xADF42C0)
#define MOLEMOLE_UIRECOMMENDTYPESUITROWWIDGETCONTROLLER___C__DISPLAYCLASS13_0__REFRESHVIEW_G__ONSUITROWCLICK_2_OFFSET UNITYSDK_OFFSET(0xADF4010)

namespace MoleMole
{
	inline static constexpr unsigned int UIRecommendTypeSuitRowWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 47923;
