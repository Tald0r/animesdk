...
#define MOLEMOLE_UIGENERALTOKENCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA2A3990)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTokenContext_TypeDefinitionIndex = 42813;
