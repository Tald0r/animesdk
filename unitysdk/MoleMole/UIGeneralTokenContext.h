...
#define MOLEMOLE_UIGENERALTOKENCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9129170)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTokenContext_TypeDefinitionIndex = 44967;
