...
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_GETOPTIONITEMICONBTNCONTROLLER_OFFSET UNITYSDK_OFFSET(0x8EF3D30)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x8EF3450)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8EF3440)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_INITITEMLIST_OFFSET UNITYSDK_OFFSET(0x8EF4EE0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x8EF4770)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x8EF38B0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONAUTORECOVERYITEMGETHANDLE_OFFSET UNITYSDK_OFFSET(0x8EF6CD0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONCANCLECLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x8EF7280)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONCLICKITEMBTN_OFFSET UNITYSDK_OFFSET(0x8EF7430)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EF3460)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x8EF40A0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x8EF42F0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x8EF3C80)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x8EF3E20)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONOKCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x8EF72F0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8EF74A0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EF7510)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EF3500)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8EF4540)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_RECALCULATESELECTIDX_OFFSET UNITYSDK_OFFSET(0x8EF6FA0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_SETSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x8EF5820)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_UPDATEBACKUPENERGY_OFFSET UNITYSDK_OFFSET(0x8EF6E30)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER_UPDATEENERGY_OFFSET UNITYSDK_OFFSET(0x8EF5FA0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER__CREATITEM_OFFSET UNITYSDK_OFFSET(0x8EF4C70)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8EF7580)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER__ONOKCLICKHANDLE_B__21_0_OFFSET UNITYSDK_OFFSET(0x8EF76B0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER__ONOKCLICKHANDLE_B__21_1_OFFSET UNITYSDK_OFFSET(0x8EF7A10)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER__ONOKCLICKHANDLE_B__21_2_OFFSET UNITYSDK_OFFSET(0x8EF7A80)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x8EF7B20)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EF7B90)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x8EF7C00)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x8EF7C70)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x8EF7CE0)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x8EF7D10)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8EF7D70)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EF7D80)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EF7D90)
#define MOLEMOLE_UIPOWERTIPSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8EF7DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPowerTipsPopWindowController_TypeDefinitionIndex = 49816;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_96* _view; // 0x2F8
		...
		::Class_2_208CC9941471731A_497* _recoverytemplate; // 0x318
