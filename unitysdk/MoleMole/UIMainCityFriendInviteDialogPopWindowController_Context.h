...
#define MOLEMOLE_UIMAINCITYFRIENDINVITEDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9E77C90)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityFriendInviteDialogPopWindowController_Context_TypeDefinitionIndex = 46316;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_81D34D116310A358*>* activeInvites; // 0x38
