...
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_CHECKCOMPLETE_OFFSET UNITYSDK_OFFSET(0xD274CE0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0xD279A90)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_GENFINISHREQ_OFFSET UNITYSDK_OFFSET(0xD277060)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_GET_CHAPTERS_OFFSET UNITYSDK_OFFSET(0xD273080)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_GET_CURRENTCHAPTER_OFFSET UNITYSDK_OFFSET(0xD272FC0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_GET_ISCURCHAPTERCOMPLETE_OFFSET UNITYSDK_OFFSET(0xD277800)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_GET_PRESSEDCOLOR_OFFSET UNITYSDK_OFFSET(0xD273090)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_INITCHAPTERVIEW_OFFSET UNITYSDK_OFFSET(0xD279810)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_INITCURCHAPTERPIECES_OFFSET UNITYSDK_OFFSET(0xD277F80)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0xD273680)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xD275D10)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONCONSOLEMOVING_OFFSET UNITYSDK_OFFSET(0xD2758C0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD273D10)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xD276120)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xD2766E0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xD274010)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD274530)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xD2746E0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0xD273DB0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD273510)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD274450)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD273150)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD273460)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_REFRESHROWONWIN_OFFSET UNITYSDK_OFFSET(0xD27A090)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_REFRESHTAB_OFFSET UNITYSDK_OFFSET(0xD279890)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_RESETCHAPTERCACHE_OFFSET UNITYSDK_OFFSET(0xD2779A0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_SELECTWIDGET_OFFSET UNITYSDK_OFFSET(0xD275360)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_SENDFINISHONCLOSE_OFFSET UNITYSDK_OFFSET(0xD276C20)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_SENDFINISH_OFFSET UNITYSDK_OFFSET(0xD276EC0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_STOPSELECTFORCONSOLE_OFFSET UNITYSDK_OFFSET(0xD2745E0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_SWAPPIECES_OFFSET UNITYSDK_OFFSET(0xD275960)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_TOGGLECHAPTER_OFFSET UNITYSDK_OFFSET(0xD279D10)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_TOGGLEPREVIEW_OFFSET UNITYSDK_OFFSET(0xD2741E0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD27A180)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER__ONUIINIT_B__24_0_OFFSET UNITYSDK_OFFSET(0xD27A1B0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER__ONUIINIT_B__24_1_OFFSET UNITYSDK_OFFSET(0xD27A1C0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER__ONUIINIT_B__24_2_OFFSET UNITYSDK_OFFSET(0xD27A1D0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER__ONUIINIT_B__24_3_OFFSET UNITYSDK_OFFSET(0xD27A1E0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER__ONUIINIT_B__24_4_OFFSET UNITYSDK_OFFSET(0xD27A2B0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD27A500)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xD27A570)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD27A5D0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xD27A600)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0xD27A660)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD27A6C0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD27A730)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD27A7B0)
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD27A810)

namespace MoleMole
{
	inline static constexpr unsigned int UINewsStandPuzzleGameWidgetController_TypeDefinitionIndex = 55850;

	class UINewsStandPuzzleGameWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_28BDF4B69EE93815_2* _view; // 0x2A0
		::MoleMole::UINewsStandPuzzleGameContext* _context; // 0x2A8
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_887*>* chapters; // 0x2B0
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_887*>* get_Chapters()
		{
			return ((::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_887*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_GET_CHAPTERS_OFFSET))(this);
		}
		...
		::Class_3_D7522358EDC47E3C_1* GenFinishReq()
		{
			return ((::Class_3_D7522358EDC47E3C_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UINEWSSTANDPUZZLEGAMEWIDGETCONTROLLER_GENFINISHREQ_OFFSET))(this);
		}
