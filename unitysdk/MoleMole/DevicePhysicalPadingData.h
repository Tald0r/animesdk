...
#define MOLEMOLE_DEVICEPHYSICALPADINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x13FB03D0)

namespace MoleMole
{
	inline static constexpr unsigned int DevicePhysicalPadingData_TypeDefinitionIndex = 62826;
