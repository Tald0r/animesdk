...
#define MOLEMOLE_DEVICEPHYSICALPADINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xF2EA100)

namespace MoleMole
{
	inline static constexpr unsigned int DevicePhysicalPadingData_TypeDefinitionIndex = 61209;
