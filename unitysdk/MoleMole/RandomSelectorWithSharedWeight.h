...
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0xB1BCDF0)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0xB1BCD80)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB1BC690)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0xB1BCE70)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0xB1BCF00)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT_ONEND_OFFSET UNITYSDK_OFFSET(0xB1BCFA0)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0xB1BD030)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0xB1BC770)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT_SHUFFLECHILDREN_OFFSET UNITYSDK_OFFSET(0xB1BC7E0)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0xB1BD0A0)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0xB1BD160)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0xB1BD1F0)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB1BD280)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0xB1BD310)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0xB1BD3A0)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0xB1BD430)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0xB1BD4C0)
#define MOLEMOLE_RANDOMSELECTORWITHSHAREDWEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0xB1BD550)

namespace MoleMole
{
	inline static constexpr unsigned int RandomSelectorWithSharedWeight_TypeDefinitionIndex = 56595;
