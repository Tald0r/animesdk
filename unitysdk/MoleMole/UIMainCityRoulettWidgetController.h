...
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_AFTERMOUSEPOSSETHANDLE_OFFSET UNITYSDK_OFFSET(0x6CCEAA0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_CLAMPDIRECTIONVALUE_OFFSET UNITYSDK_OFFSET(0x6CC9450)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_CLICKBUTTON_OFFSET UNITYSDK_OFFSET(0x6CCB050)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_DOWNBUTTON_OFFSET UNITYSDK_OFFSET(0x6CCBFF0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETCURRENTINDEX_OFFSET UNITYSDK_OFFSET(0x6CC81A0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETDIRECTIONANDANGLE2D_OFFSET UNITYSDK_OFFSET(0x6CCB610)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETIGNOREFADING_OFFSET UNITYSDK_OFFSET(0x6CC4FC0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETINDEXDIRECTIONVALUE_OFFSET UNITYSDK_OFFSET(0x6CCD3B0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETMISTICKCURRENTINDEX_OFFSET UNITYSDK_OFFSET(0x6CC8210)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x6CC5020)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETRINGINNERRADIUS_OFFSET UNITYSDK_OFFSET(0x6CCAA30)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETROULETTEITEMCONFIGID_OFFSET UNITYSDK_OFFSET(0x6CCE380)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETROULETTETXTKEY_OFFSET UNITYSDK_OFFSET(0x6CCE8C0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETTARGETVIEW_OFFSET UNITYSDK_OFFSET(0x6CC52F0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETVECTORINDEX_OFFSET UNITYSDK_OFFSET(0x6CC8C70)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GET_IGNOREFADING_OFFSET UNITYSDK_OFFSET(0x6CC4F60)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GET_PLATFORMNEEDREFRESHROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0x6CCE640)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_HIDEROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0x6CCE2A0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_INITSELECTINDEXONSHOW_OFFSET UNITYSDK_OFFSET(0x6CCCF50)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x6CC5480)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ISSHOWCURSORMODE_OFFSET UNITYSDK_OFFSET(0x6CC5C80)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ISWITHINANGLE_OFFSET UNITYSDK_OFFSET(0x6CCB300)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ISWITHINRING_OFFSET UNITYSDK_OFFSET(0x6CCAD90)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_JOYSTICK2WHEELPOINT_OFFSET UNITYSDK_OFFSET(0x6CCB4E0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x6CC80A0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_NEEDREFRESHROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0x6CCE0F0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_NEWBIECORRECT_OFFSET UNITYSDK_OFFSET(0x6CC7060)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6CC6ED0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONDOWNBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0x6CCD8A0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONENTERBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0x6CCD910)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONEXITBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0x6CCDAA0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x6CC6DF0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x6CC70E0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONNOTIFY_OFFSET UNITYSDK_OFFSET(0x6CC6CF0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONPHOTOQUESTTIPSUPDATEHANDLE_OFFSET UNITYSDK_OFFSET(0x6CCED00)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6CC5F70)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6CC6F70)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6CC5360)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6CC5760)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONUNLOCKCHANGE_OFFSET UNITYSDK_OFFSET(0x6CCDC50)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONWHEELSHORTCUTCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0x6CCED70)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x6CC5810)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x6CC5DA0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_PLAYTITLEFADEINANIM_OFFSET UNITYSDK_OFFSET(0x6CCEA30)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REFRESHBUTTON_OFFSET UNITYSDK_OFFSET(0x6CCC540)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REFRESHROULETTETITLEVIEWBYCONFIGID_OFFSET UNITYSDK_OFFSET(0x6CCE4D0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REFRESHROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0x6CCE050)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REFRESHTITLETXT_OFFSET UNITYSDK_OFFSET(0x6CCE710)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REGISTNOTIFY_OFFSET UNITYSDK_OFFSET(0x6CC6940)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_RINGANGLERANGEINDEX_OFFSET UNITYSDK_OFFSET(0x6CCAED0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_SETONCLICKBUTTON_OFFSET UNITYSDK_OFFSET(0x6CC8280)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_SHOWVIEW_OFFSET UNITYSDK_OFFSET(0x6CC61A0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x6CCA920)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_TRYREFRESHNOTIFY_OFFSET UNITYSDK_OFFSET(0x6CCC8C0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UNREGISTNOTIFY_OFFSET UNITYSDK_OFFSET(0x6CC63C0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPBUTTON_OFFSET UNITYSDK_OFFSET(0x6CCC2A0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATEARROW_OFFSET UNITYSDK_OFFSET(0x6CCA620)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x6CCA030)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECT_GAMEPAD_OFFSET UNITYSDK_OFFSET(0x6CC7530)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECT_MOBILE_OFFSET UNITYSDK_OFFSET(0x6CCBAE0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECT_MOUSENEW_OFFSET UNITYSDK_OFFSET(0x6CC7AC0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECT_MOUSE_OFFSET UNITYSDK_OFFSET(0x6CC82F0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6CCEE50)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0x6CCEEA0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6CCEF10)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x6CCEF80)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x6CCEFE0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6CCF010)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6CCF080)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6CCF100)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6CCF160)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x6CCF1D0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x6CCF1E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityRoulettWidgetController_TypeDefinitionIndex = 54493;
