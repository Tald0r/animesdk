...
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_AFTERMOUSEPOSSETHANDLE_OFFSET UNITYSDK_OFFSET(0xB4FC670)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_CLAMPDIRECTIONVALUE_OFFSET UNITYSDK_OFFSET(0xB4F7040)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_CLICKBUTTON_OFFSET UNITYSDK_OFFSET(0xB4F8C30)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_DOWNBUTTON_OFFSET UNITYSDK_OFFSET(0xB4F9BD0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETCURRENTINDEX_OFFSET UNITYSDK_OFFSET(0xB4F5D90)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETDIRECTIONANDANGLE2D_OFFSET UNITYSDK_OFFSET(0xB4F91F0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETIGNOREFADING_OFFSET UNITYSDK_OFFSET(0xB4F2BE0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETINDEXDIRECTIONVALUE_OFFSET UNITYSDK_OFFSET(0xB4FAF90)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETMISTICKCURRENTINDEX_OFFSET UNITYSDK_OFFSET(0xB4F5E00)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0xB4F2C40)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETRINGINNERRADIUS_OFFSET UNITYSDK_OFFSET(0xB4F8610)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETROULETTEITEMCONFIGID_OFFSET UNITYSDK_OFFSET(0xB4FBF50)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETROULETTETXTKEY_OFFSET UNITYSDK_OFFSET(0xB4FC490)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETTARGETVIEW_OFFSET UNITYSDK_OFFSET(0xB4F2F10)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GETVECTORINDEX_OFFSET UNITYSDK_OFFSET(0xB4F6860)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GET_IGNOREFADING_OFFSET UNITYSDK_OFFSET(0xB4F2B80)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_GET_PLATFORMNEEDREFRESHROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0xB4FC210)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_HIDEROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0xB4FBE70)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_INITSELECTINDEXONSHOW_OFFSET UNITYSDK_OFFSET(0xB4FAB30)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xB4F30A0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ISSHOWCURSORMODE_OFFSET UNITYSDK_OFFSET(0xB4F38A0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ISWITHINANGLE_OFFSET UNITYSDK_OFFSET(0xB4F8EE0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ISWITHINRING_OFFSET UNITYSDK_OFFSET(0xB4F8970)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_JOYSTICK2WHEELPOINT_OFFSET UNITYSDK_OFFSET(0xB4F90C0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB4F5C90)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_NEEDREFRESHROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0xB4FBCC0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_NEWBIECORRECT_OFFSET UNITYSDK_OFFSET(0xB4F4C60)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB4F4AD0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONDOWNBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0xB4FB480)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONENTERBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0xB4FB4F0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONEXITBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0xB4FB680)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xB4F49F0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xB4F4CE0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONNOTIFY_OFFSET UNITYSDK_OFFSET(0xB4F48F0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONPHOTOQUESTTIPSUPDATEHANDLE_OFFSET UNITYSDK_OFFSET(0xB4FC8D0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB4F3B90)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB4F4B70)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB4F2F80)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB4F3380)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONUNLOCKCHANGE_OFFSET UNITYSDK_OFFSET(0xB4FB820)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_ONWHEELSHORTCUTCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0xB4FC940)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xB4F3430)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0xB4F39C0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_PLAYTITLEFADEINANIM_OFFSET UNITYSDK_OFFSET(0xB4FC600)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REFRESHBUTTON_OFFSET UNITYSDK_OFFSET(0xB4FA120)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REFRESHROULETTETITLEVIEWBYCONFIGID_OFFSET UNITYSDK_OFFSET(0xB4FC0A0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REFRESHROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0xB4FBC20)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REFRESHTITLETXT_OFFSET UNITYSDK_OFFSET(0xB4FC2E0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_REGISTNOTIFY_OFFSET UNITYSDK_OFFSET(0xB4F4550)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_RINGANGLERANGEINDEX_OFFSET UNITYSDK_OFFSET(0xB4F8AB0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_SETONCLICKBUTTON_OFFSET UNITYSDK_OFFSET(0xB4F5E70)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_SHOWVIEW_OFFSET UNITYSDK_OFFSET(0xB4F3DC0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_TRANSFORM_OFFSET UNITYSDK_OFFSET(0xB4F8500)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_TRYREFRESHNOTIFY_OFFSET UNITYSDK_OFFSET(0xB4FA4A0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UNREGISTNOTIFY_OFFSET UNITYSDK_OFFSET(0xB4F3FE0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPBUTTON_OFFSET UNITYSDK_OFFSET(0xB4F9E80)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATEARROW_OFFSET UNITYSDK_OFFSET(0xB4F8200)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xB4F7C10)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECT_GAMEPAD_OFFSET UNITYSDK_OFFSET(0xB4F5120)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECT_MOBILE_OFFSET UNITYSDK_OFFSET(0xB4F96C0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECT_MOUSENEW_OFFSET UNITYSDK_OFFSET(0xB4F56B0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_UPDATESELECT_MOUSE_OFFSET UNITYSDK_OFFSET(0xB4F5EE0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB4FCA20)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0xB4FCA70)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB4FCAE0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xB4FCB50)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xB4FCBB0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB4FCBE0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB4FCC50)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB4FCCD0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB4FCD30)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xB4FCDA0)
#define MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER___BASE_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0xB4FCDB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityRoulettWidgetController_TypeDefinitionIndex = 72943;
	...
	public:
		...
		::Class_2_B61F7879B44C046D* _view; // 0x2A0
		::System::Int32 _currentIndex; // 0x2A8
		::System::Int32 _currentRealStickIndex; // 0x2AC
		::UnityEngine::Vector2 _mousePos; // 0x2B0
		::System::Single _mistakeTimer; // 0x2B8
		::System::Int32 _lastMistakeIndex; // 0x2BC
		::System::Single _newbieTimer; // 0x2C0
		::Class_2_B61F7879B44C046D_Class_2_A8551DB78FCCDD55_1* _mobileView; // 0x2C8
		::System::Boolean _receiveInput; // 0x2D0
		::System::Action_1<::System::Int32>* _onClickButton; // 0x2D8
		...
		static ::System::Void PlayTitleFadeInAnim(::Class_2_9E3E3CDA608A4F58*& anim)
		{
			return ((::System::Void(*)(::Class_2_9E3E3CDA608A4F58*&))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYROULETTWIDGETCONTROLLER_PLAYTITLEFADEINANIM_OFFSET))(anim);
		}
