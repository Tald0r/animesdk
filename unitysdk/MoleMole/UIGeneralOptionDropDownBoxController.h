...
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_GETBUTTON_OFFSET UNITYSDK_OFFSET(0xAD33020)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xAD32660)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_ONDYNAMICTIPSCLOSE_OFFSET UNITYSDK_OFFSET(0xAD33090)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_ONFILTERDROPVALUECHANGE_OFFSET UNITYSDK_OFFSET(0xAD33200)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD32380)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD32420)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_REFRESHCONTEXT_OFFSET UNITYSDK_OFFSET(0xAD33180)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_SETENABLE_OFFSET UNITYSDK_OFFSET(0xAD33110)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER_SHOWDROPDOWN_OFFSET UNITYSDK_OFFSET(0xAD32A90)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD33650)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD33660)
#define MOLEMOLE_UIGENERALOPTIONDROPDOWNBOXCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD336C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralOptionDropDownBoxController_TypeDefinitionIndex = 47296;
