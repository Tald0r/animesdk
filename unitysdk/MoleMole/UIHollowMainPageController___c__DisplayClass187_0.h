...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS187_0__CTOR_OFFSET UNITYSDK_OFFSET(0x744BCA0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS187_0__PAUSEBGVIDEO_B__0_OFFSET UNITYSDK_OFFSET(0x744BCB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController___c__DisplayClass187_0_TypeDefinitionIndex = 49549;
