...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS187_0__CTOR_OFFSET UNITYSDK_OFFSET(0x80AF930)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS187_0__PAUSEBGVIDEO_B__0_OFFSET UNITYSDK_OFFSET(0x80AF940)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController___c__DisplayClass187_0_TypeDefinitionIndex = 52590;

	class UIHollowMainPageController___c__DisplayClass187_0 : public ::System::Object
	{
	public:
		::System::Boolean pause; // 0x10
		::Class_5_AF65C3A968E836D2_Enum_3_AE3AC209555CEF94 pauseVideoReason; // 0x14
