...
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_GETDATA_OFFSET UNITYSDK_OFFSET(0x7C57500)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x7C57C40)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7C575C0)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x7C57670)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_SETSIZE_OFFSET UNITYSDK_OFFSET(0x7C57850)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7C57CC0)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7C57CF0)

namespace MoleMole
{
	inline static constexpr unsigned int UITwoDMapElement_UIController_TypeDefinitionIndex = 44004;

	class UITwoDMapElement_UIController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Single _scale; // 0x2A0
