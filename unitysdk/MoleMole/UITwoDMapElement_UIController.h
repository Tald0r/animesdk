...
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_GETDATA_OFFSET UNITYSDK_OFFSET(0xA6CDD50)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA6CE490)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA6CDE10)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xA6CDEC0)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER_SETSIZE_OFFSET UNITYSDK_OFFSET(0xA6CE0A0)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA6CE510)
#define MOLEMOLE_UITWODMAPELEMENT_UICONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA6CE540)

namespace MoleMole
{
	inline static constexpr unsigned int UITwoDMapElement_UIController_TypeDefinitionIndex = 66542;
