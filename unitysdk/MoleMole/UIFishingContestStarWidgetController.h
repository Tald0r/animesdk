...
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCAB4FD0)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCAB5150)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCAB5070)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCAB4E80)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCAB4F20)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0xCAB53C0)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCAB54F0)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCAB5500)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCAB5570)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCAB55F0)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCAB5670)
#define MOLEMOLE_UIFISHINGCONTESTSTARWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCAB56D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishingContestStarWidgetController_TypeDefinitionIndex = 57282;

	class UIFishingContestStarWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_12CA2BD783D6D85C* _view; // 0x2D0
