...
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_GET_NAPWARNINGLINE_OFFSET UNITYSDK_OFFSET(0xA7E94C0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_GET_STATEPLAYMESSAGE_OFFSET UNITYSDK_OFFSET(0xA7E9650)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_ISTRANSITIONALLOWED_OFFSET UNITYSDK_OFFSET(0xA7E9C60)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xA7E9EE0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_6E6F865C6BBBA8DD_OFFSET UNITYSDK_OFFSET(0xA7E9790)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_8DB98345F9A815B2_OFFSET UNITYSDK_OFFSET(0xA7EA1B0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA7EA370)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_METHOD_7_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA7E9310)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA7E91B0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_ONINPUTPOSITION_OFFSET UNITYSDK_OFFSET(0xA7E9380)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_ONSTATEMESSAGE_OFFSET UNITYSDK_OFFSET(0xA7E9690)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS_PLAYANIMATIONBYSTATE_OFFSET UNITYSDK_OFFSET(0xA7E99B0)
#define MOLEMOLE_MONOEFFECTPLUGINSYNCENTITYPOS__CTOR_OFFSET UNITYSDK_OFFSET(0xA7EA070)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginSyncEntityPos_TypeDefinitionIndex = 68123;
