...
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_GET_CURWEAPONMODE_OFFSET UNITYSDK_OFFSET(0x7F90580)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x7F90570)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x7F90590)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_GET_ROOTANIM_OFFSET UNITYSDK_OFFSET(0x7F905A0)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F8FA10)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x7F8FB40)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_ONISSHOWMODIFIED_OFFSET UNITYSDK_OFFSET(0x7F8FDB0)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_ONMODEMODIFIED_OFFSET UNITYSDK_OFFSET(0x7F90080)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F8FCB0)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F8F8C0)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F8F960)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x7F8FFC0)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_REFRESHMODE_OFFSET UNITYSDK_OFFSET(0x7F90420)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x7F901B0)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_SET_CURWEAPONMODE_OFFSET UNITYSDK_OFFSET(0x7F904E0)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x7F90390)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_SET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x7F90320)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x7F8FAB0)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7F905F0)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F905C0)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F90670)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F906E0)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F90760)
#define MOLEMOLE_UIINLEVELZHUYUANBULLETWIDGETWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F907C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelZhuYuanBulletWidgetWidgetController_TypeDefinitionIndex = 66311;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelZhuYuanBulletWidgetWidgetController_TypeDefinitionIndex)->GetStaticField(0x37450);
		}
		static ::System::String** StaticGet_Orange2Grey()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelZhuYuanBulletWidgetWidgetController_TypeDefinitionIndex)->GetStaticField(0x37458);
		}
		static ::System::String** StaticGet_OrangeGet()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelZhuYuanBulletWidgetWidgetController_TypeDefinitionIndex)->GetStaticField(0x37460);
		}
		static ::System::String** StaticGet_Grey2Orange()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelZhuYuanBulletWidgetWidgetController_TypeDefinitionIndex)->GetStaticField(0x37468);
		}
		static ::System::String** StaticGet_OrangeCost()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelZhuYuanBulletWidgetWidgetController_TypeDefinitionIndex)->GetStaticField(0x37470);
		}
		::System::String* _curAnimClipName; // 0x2A0
		::System::Boolean _isPlaying; // 0x2A8
		::System::Boolean _isShow; // 0x2A9
		::Class_2_5651F3E03076F757_2* _view; // 0x2B0
