...
#define MOLEMOLE_MATANIMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x82E1060)

namespace MoleMole
{
	inline static constexpr unsigned int MatAnimationData_TypeDefinitionIndex = 57442;
