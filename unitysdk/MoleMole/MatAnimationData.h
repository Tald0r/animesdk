...
#define MOLEMOLE_MATANIMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA39B940)

namespace MoleMole
{
	inline static constexpr unsigned int MatAnimationData_TypeDefinitionIndex = 62899;
