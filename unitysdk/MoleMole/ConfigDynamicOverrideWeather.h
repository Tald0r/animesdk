...
#define MOLEMOLE_CONFIGDYNAMICOVERRIDEWEATHER__CTOR_OFFSET UNITYSDK_OFFSET(0xF2DFC50)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigDynamicOverrideWeather_TypeDefinitionIndex = 39207;
