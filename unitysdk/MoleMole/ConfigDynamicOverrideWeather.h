...
#define MOLEMOLE_CONFIGDYNAMICOVERRIDEWEATHER__CTOR_OFFSET UNITYSDK_OFFSET(0x13FA5E70)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigDynamicOverrideWeather_TypeDefinitionIndex = 38735;
