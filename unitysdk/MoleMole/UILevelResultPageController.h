...
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ACTLEVELRESULTCAMERA_OFFSET UNITYSDK_OFFSET(0x8EB6FD0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_CREATEITEMICON_OFFSET UNITYSDK_OFFSET(0x8EBADC0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_GETSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x8EBB1F0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8EB57F0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_HASENDBATTLE_OFFSET UNITYSDK_OFFSET(0x8EB9D20)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITACTVIEW_OFFSET UNITYSDK_OFFSET(0x8EB7F00)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITCHESSBOARDVIEW_OFFSET UNITYSDK_OFFSET(0x8EB8550)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITDAILYCHALLENGEVIEW_OFFSET UNITYSDK_OFFSET(0x8EB8950)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITLOSEVIEW_OFFSET UNITYSDK_OFFSET(0x8EB8D90)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x8EB74E0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INVOKEACTION1_OFFSET UNITYSDK_OFFSET(0x8EBAC30)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_INVOKEACTION2_OFFSET UNITYSDK_OFFSET(0x8EBACB0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ISADDITIONAUPITEM_OFFSET UNITYSDK_OFFSET(0x8EBAD30)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONCLICKITEMBTN_OFFSET UNITYSDK_OFFSET(0x8EBAF50)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EB7CD0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8EB5800)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EB7E40)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EB75B0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_PLAYEXIT_OFFSET UNITYSDK_OFFSET(0x8EB9EF0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_REFRESHACTVIEW_OFFSET UNITYSDK_OFFSET(0x8EBA1D0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_REFRESHCHALLENGE_OFFSET UNITYSDK_OFFSET(0x8EB9540)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_REFRESHCHESSBOARDVIEW_OFFSET UNITYSDK_OFFSET(0x8EBA270)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_REFRESHLOSEVIEW_OFFSET UNITYSDK_OFFSET(0x8EBA310)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_SETMOVE_OFFSET UNITYSDK_OFFSET(0x8EB79D0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x8EB7D70)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8EBB480)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITACTVIEW_B__15_0_OFFSET UNITYSDK_OFFSET(0x8EBB670)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITACTVIEW_B__15_1_OFFSET UNITYSDK_OFFSET(0x8EBB850)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITCHESSBOARDVIEW_B__17_0_OFFSET UNITYSDK_OFFSET(0x8EBBD20)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITDAILYCHALLENGEVIEW_B__16_0_OFFSET UNITYSDK_OFFSET(0x8EBBAF0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITLOSEVIEW_B__18_0_OFFSET UNITYSDK_OFFSET(0x8EBBF30)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__INITLOSEVIEW_B__18_1_OFFSET UNITYSDK_OFFSET(0x8EBBFB0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EBC110)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8EBC180)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EBC190)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EBC1A0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x8EBC1B0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultPageController_TypeDefinitionIndex = 76303;

	class UILevelResultPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_93* _view; // 0x2F8
		...
		::Class_3_BD5405822947C18D_1* Ret; // 0x340
		...
		::System::Collections::Generic::List_1<::Class_1_82297B6AFFE49354*>* _recordItems; // 0x378
