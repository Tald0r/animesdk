...
#define MOLEMOLE_MONOSPAWNPOINT_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0xA653E00)
#define MOLEMOLE_MONOSPAWNPOINT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0xA653D50)
#define MOLEMOLE_MONOSPAWNPOINT_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0xA653DB0)
#define MOLEMOLE_MONOSPAWNPOINT_GET_SCENETOFINDOBJECT_OFFSET UNITYSDK_OFFSET(0xA653F80)
#define MOLEMOLE_MONOSPAWNPOINT_GET_TRIGGERPARAM_OFFSET UNITYSDK_OFFSET(0xA653F70)
#define MOLEMOLE_MONOSPAWNPOINT_GET_XZPOSITION_OFFSET UNITYSDK_OFFSET(0xA653C30)
#define MOLEMOLE_MONOSPAWNPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xA654090)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSpawnPoint_TypeDefinitionIndex = 38456;
