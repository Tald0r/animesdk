...
#define MOLEMOLE_MONOSPAWNPOINT_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0xB3BC360)
#define MOLEMOLE_MONOSPAWNPOINT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0xB3BC2B0)
#define MOLEMOLE_MONOSPAWNPOINT_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0xB3BC310)
#define MOLEMOLE_MONOSPAWNPOINT_GET_SCENETOFINDOBJECT_OFFSET UNITYSDK_OFFSET(0xB3BC4E0)
#define MOLEMOLE_MONOSPAWNPOINT_GET_TRIGGERPARAM_OFFSET UNITYSDK_OFFSET(0xB3BC4D0)
#define MOLEMOLE_MONOSPAWNPOINT_GET_XZPOSITION_OFFSET UNITYSDK_OFFSET(0xB3BC190)
#define MOLEMOLE_MONOSPAWNPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xB3BC5F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSpawnPoint_TypeDefinitionIndex = 67772;
