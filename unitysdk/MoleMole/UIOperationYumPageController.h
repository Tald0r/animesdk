...
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_GETACTUALNPCNAME_OFFSET UNITYSDK_OFFSET(0xCFC3CE0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_GETNPCNAMEBYID_OFFSET UNITYSDK_OFFSET(0xCFC4030)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xCFC20D0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_INITTABS_OFFSET UNITYSDK_OFFSET(0xCFC2700)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFC20E0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONINFOBTNCLICK_OFFSET UNITYSDK_OFFSET(0xCFC3F40)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xCFC2F40)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFC30B0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFC2180)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFC2B80)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_PLAYWIDGETANIMATION_OFFSET UNITYSDK_OFFSET(0xCFC2E00)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCFC3140)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFC4190)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER__INITTABS_B__21_0_OFFSET UNITYSDK_OFFSET(0xCFC4410)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER__ONUIINIT_B__17_0_OFFSET UNITYSDK_OFFSET(0xCFC4220)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER__ONUIINIT_B__17_1_OFFSET UNITYSDK_OFFSET(0xCFC4380)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFC4540)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xCFC45B0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFC45C0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFC45D0)
#define MOLEMOLE_UIOPERATIONYUMPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFC45E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOperationYumPageController_TypeDefinitionIndex = 54537;
