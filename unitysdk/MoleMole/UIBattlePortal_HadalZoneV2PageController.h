...
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ENTERLAYERROOM_OFFSET UNITYSDK_OFFSET(0xAC3ADB0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xAC39D90)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAC39DA0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC39DB0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xAC3B820)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xAC3A940)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC3A9C0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC39E50)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC39F80)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_OPENHISTORYPOPWINDOW_OFFSET UNITYSDK_OFFSET(0xAC3BFC0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_OPENSPECIALLAYERROOMLINEUPWIDGET_OFFSET UNITYSDK_OFFSET(0xAC3BE20)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC3C200)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__ONCLICKBACKBTN_OFFSET UNITYSDK_OFFSET(0xAC3BA10)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__ONCLICKENTERTOLAYERROOM_OFFSET UNITYSDK_OFFSET(0xAC3B990)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__ONSWITCHZONE_OFFSET UNITYSDK_OFFSET(0xAC3B910)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__PLAYBACKGROUNDVIDEO_OFFSET UNITYSDK_OFFSET(0xAC3AAF0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__REFRESHMEDALANDHISTORYFORZONE_OFFSET UNITYSDK_OFFSET(0xAC3B5B0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__UPDATECONTENTS_OFFSET UNITYSDK_OFFSET(0xAC3A330)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC3C7D0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xAC3C840)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xAC3C850)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC3C860)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC3C870)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC3C880)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___ONCLICKBACKBTN_B__27_0_OFFSET UNITYSDK_OFFSET(0xAC3C310)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___ONCLICKBACKBTN_B__27_1_OFFSET UNITYSDK_OFFSET(0xAC3C510)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___ONCLICKBACKBTN_B__27_2_OFFSET UNITYSDK_OFFSET(0xAC3C5D0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___UPDATECONTENTS_B__22_0_OFFSET UNITYSDK_OFFSET(0xAC3C210)

namespace MoleMole
{
	inline static constexpr unsigned int UIBattlePortal_HadalZoneV2PageController_TypeDefinitionIndex = 59776;
	...
	public:
		...
		::Class_2_BE97744DE3DEF97D* _view; // 0x310
		::MoleMole::UIBattlePortal_HadalZoneV2PageController_CurrentStatus _currentStatus; // 0x318
		::MoleMole::UIHadalZone_BgVideoConfig* _uiVideoConfig; // 0x320
		::MoleMole::UIBattlePortal_HadalZoneV2PageController_UIBattlePortal_HadalZoneV2PageContext* _uiCtx; // 0x328
		::Class_2_468A4FBF2E9F527C* _hadalZoneModel; // 0x330
		::MoleMole::UIHadalZone_LayerV2WidgetController* _layerCtrl; // 0x338
		::MoleMole::UIHadalZone_LineupV2_WidgetController* _lineupCtrl; // 0x340
		::MoleMole::UIHadalZone_ImpactBattleInfo_WidgetController* _impactBattleInfoCtrl; // 0x348
		::MoleMole::UIHadalZone_ImpactBattle_LineupWidgetController* _impactBattleLineupCtrl; // 0x350
		::MoleMole::UIBossChallengeBadgeRowWidgetController* _badgeRow; // 0x358
		...
		::System::Void _OnClickEnterToLayerRoom(::Class_1_5DA2E7556103D5A3_245* zoneInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_245*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__ONCLICKENTERTOLAYERROOM_OFFSET))(this, zoneInfo);
		}

		::System::Void EnterLayerRoom(::Class_1_5DA2E7556103D5A3_245* zoneInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_245*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ENTERLAYERROOM_OFFSET))(this, zoneInfo);
		}
