...
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ENTERLAYERROOM_OFFSET UNITYSDK_OFFSET(0xB91A6D0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xB9196B0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB9196C0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB9196D0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xB91B140)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB91A260)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB91A2E0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB919770)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB9198A0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_OPENHISTORYPOPWINDOW_OFFSET UNITYSDK_OFFSET(0xB91B8E0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_OPENSPECIALLAYERROOMLINEUPWIDGET_OFFSET UNITYSDK_OFFSET(0xB91B740)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB91BB20)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__ONCLICKBACKBTN_OFFSET UNITYSDK_OFFSET(0xB91B330)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__ONCLICKENTERTOLAYERROOM_OFFSET UNITYSDK_OFFSET(0xB91B2B0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__ONSWITCHZONE_OFFSET UNITYSDK_OFFSET(0xB91B230)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__PLAYBACKGROUNDVIDEO_OFFSET UNITYSDK_OFFSET(0xB91A410)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__REFRESHMEDALANDHISTORYFORZONE_OFFSET UNITYSDK_OFFSET(0xB91AED0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__UPDATECONTENTS_OFFSET UNITYSDK_OFFSET(0xB919C50)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB91C0F0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xB91C160)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB91C170)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB91C180)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB91C190)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB91C1A0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___ONCLICKBACKBTN_B__27_0_OFFSET UNITYSDK_OFFSET(0xB91BC30)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___ONCLICKBACKBTN_B__27_1_OFFSET UNITYSDK_OFFSET(0xB91BE30)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___ONCLICKBACKBTN_B__27_2_OFFSET UNITYSDK_OFFSET(0xB91BEF0)
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER___UPDATECONTENTS_B__22_0_OFFSET UNITYSDK_OFFSET(0xB91BB30)

namespace MoleMole
{
	inline static constexpr unsigned int UIBattlePortal_HadalZoneV2PageController_TypeDefinitionIndex = 49356;
	...
	public:
		...
		::System::Void _OnClickEnterToLayerRoom(::Class_1_5DA2E7556103D5A3_280* zoneInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_280*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER__ONCLICKENTERTOLAYERROOM_OFFSET))(this, zoneInfo);
		}

		::System::Void EnterLayerRoom(::Class_1_5DA2E7556103D5A3_280* zoneInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_280*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_ENTERLAYERROOM_OFFSET))(this, zoneInfo);
		}
