...
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_0B08B4F8E959C85E_OFFSET UNITYSDK_OFFSET(0xBE72570)
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0xBE726F0)
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBE72510)
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xBE72700)
#define MOLEMOLE_UINONSAFEAREAHANDLER_METHOD_6_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0xBE72710)
#define MOLEMOLE_UINONSAFEAREAHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xBE72250)
#define MOLEMOLE_UINONSAFEAREAHANDLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBE722E0)
#define MOLEMOLE_UINONSAFEAREAHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBE72460)
#define MOLEMOLE_UINONSAFEAREAHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xBE72480)

namespace MoleMole
{
	inline static constexpr unsigned int UINonSafeAreaHandler_TypeDefinitionIndex = 76261;
