...
#define MOLEMOLE_DRAGABLERECTCONTROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xB5A4700)
#define MOLEMOLE_DRAGABLERECTCONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xB5A4890)
#define MOLEMOLE_DRAGABLERECTCONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xB5A4C10)
#define MOLEMOLE_DRAGABLERECTCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB5A4D90)
#define MOLEMOLE_DRAGABLERECTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB5A5120)

namespace MoleMole
{
	inline static constexpr unsigned int DragableRectController_TypeDefinitionIndex = 69473;
