...
#define MOLEMOLE_UISUIBIANSTARTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD6CD8F0)
#define MOLEMOLE_UISUIBIANSTARTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD6CD990)
#define MOLEMOLE_UISUIBIANSTARTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD6CD7A0)
#define MOLEMOLE_UISUIBIANSTARTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD6CD840)
#define MOLEMOLE_UISUIBIANSTARTROWWIDGETCONTROLLER_REFRESHFINISH_OFFSET UNITYSDK_OFFSET(0xD6CD540)
#define MOLEMOLE_UISUIBIANSTARTROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xD6CDA70)
#define MOLEMOLE_UISUIBIANSTARTROWWIDGETCONTROLLER_TRYPLAYGETANIM_OFFSET UNITYSDK_OFFSET(0xD6CD5F0)
#define MOLEMOLE_UISUIBIANSTARTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD6CDB20)
#define MOLEMOLE_UISUIBIANSTARTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD6CDB50)
#define MOLEMOLE_UISUIBIANSTARTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD6CDBC0)
#define MOLEMOLE_UISUIBIANSTARTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD6CDC40)
#define MOLEMOLE_UISUIBIANSTARTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD6CDCA0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianStartRowWidgetController_TypeDefinitionIndex = 67387;

	class UISuibianStartRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_8469E7523673A92C_4* _view; // 0x2A0
