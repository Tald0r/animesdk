...
#define MOLEMOLE_SCENESOUNDDATA_SCENESOUNDDATA_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x7F210F0)
#define MOLEMOLE_SCENESOUNDDATA_SCENESOUNDDATA_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x7F21100)
#define MOLEMOLE_SCENESOUNDDATA_SCENESOUNDDATA_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x7F213C0)
#define MOLEMOLE_SCENESOUNDDATA_SCENESOUNDDATA_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7F215D0)
#define MOLEMOLE_SCENESOUNDDATA_SCENESOUNDDATA_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F21590)

namespace MoleMole
{
	inline static constexpr unsigned int SceneSoundData_SceneSoundData_UnityGeneratedFormatter_TypeDefinitionIndex = 59682;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigSoundActionGeneral*>**)Il2CppClass::FromTypeDefinitionIndex(SceneSoundData_SceneSoundData_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x41620);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::SceneSoundData_SubAreaConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(SceneSoundData_SceneSoundData_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x41628);
		}
