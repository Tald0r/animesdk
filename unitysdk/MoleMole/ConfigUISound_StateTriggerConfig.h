...
#define MOLEMOLE_CONFIGUISOUND_STATETRIGGERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCD33A30)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUISound_StateTriggerConfig_TypeDefinitionIndex = 69988;
