...
#define MOLEMOLE_CONFIGUISOUND_STATETRIGGERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE38C910)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUISound_StateTriggerConfig_TypeDefinitionIndex = 57700;
