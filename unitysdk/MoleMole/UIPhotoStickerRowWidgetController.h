...
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD284750)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD2847C0)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD284880)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD284960)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD284A30)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD284A40)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD284AB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoStickerRowWidgetController_TypeDefinitionIndex = 45884;
