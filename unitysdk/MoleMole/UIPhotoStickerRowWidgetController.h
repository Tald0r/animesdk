...
class Class_2_0DE56911ABFD29F5;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIPhotoStickerRowWidgetController_Data; }
namespace System { class Object; }

#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA853610)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA853680)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA853740)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA853820)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA8538F0)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA853900)
#define MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA853970)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoStickerRowWidgetController_TypeDefinitionIndex = 54007;
	...
	public:
		...
		::Class_2_0DE56911ABFD29F5* get__viewModel()
		{
			return ((::Class_2_0DE56911ABFD29F5*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPHOTOSTICKERROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
