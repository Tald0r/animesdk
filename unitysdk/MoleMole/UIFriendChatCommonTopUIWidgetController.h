...
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA975700)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA975CF0)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA9755A0)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA975D90)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA975500)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xA975E70)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA975EF0)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA975F20)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA975F90)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA976000)
#define MOLEMOLE_UIFRIENDCHATCOMMONTOPUIWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA976080)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatCommonTopUIWidgetController_TypeDefinitionIndex = 58547;
