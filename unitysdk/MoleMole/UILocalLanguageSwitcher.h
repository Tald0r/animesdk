...
#define MOLEMOLE_UILOCALLANGUAGESWITCHER_FINDLOCALIZATIONTEXTREFRESH_OFFSET UNITYSDK_OFFSET(0x6CAA490)
#define MOLEMOLE_UILOCALLANGUAGESWITCHER_METHOD_5_3E6AC14EE28F55D4_OFFSET UNITYSDK_OFFSET(0x6CAAC40)
#define MOLEMOLE_UILOCALLANGUAGESWITCHER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6CAA390)
#define MOLEMOLE_UILOCALLANGUAGESWITCHER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x6CAA310)
#define MOLEMOLE_UILOCALLANGUAGESWITCHER_SETLOCALIZATIONIMAGE_OFFSET UNITYSDK_OFFSET(0x6CAA930)
#define MOLEMOLE_UILOCALLANGUAGESWITCHER_STARTSWITCHLANGUAGE_OFFSET UNITYSDK_OFFSET(0x6CAA3F0)
#define MOLEMOLE_UILOCALLANGUAGESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x6CAAC20)

namespace MoleMole
{
	inline static constexpr unsigned int UILocalLanguageSwitcher_TypeDefinitionIndex = 45406;
