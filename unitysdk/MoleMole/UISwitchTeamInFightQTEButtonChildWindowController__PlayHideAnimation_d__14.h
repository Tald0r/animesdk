...
#define MOLEMOLE_UISWITCHTEAMINFIGHTQTEBUTTONCHILDWINDOWCONTROLLER__PLAYHIDEANIMATION_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x388C70)
#define MOLEMOLE_UISWITCHTEAMINFIGHTQTEBUTTONCHILDWINDOWCONTROLLER__PLAYHIDEANIMATION_D__14_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UISwitchTeamInFightQTEButtonChildWindowController__PlayHideAnimation_d__14_TypeDefinitionIndex = 66366;
