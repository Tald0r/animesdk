...
#define MOLEMOLE_FORBIDDENAREACOLLECTPOPDIALOGSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x6AF7B10)
#define MOLEMOLE_FORBIDDENAREACOLLECTPOPDIALOGSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x6AF7B60)
#define MOLEMOLE_FORBIDDENAREACOLLECTPOPDIALOGSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x6AF7B20)

namespace MoleMole
{
	inline static constexpr unsigned int ForbiddenAreaCollectPopDialogShow_TypeDefinitionIndex = 66987;
