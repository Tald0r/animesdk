...
#define MOLEMOLE_FORBIDDENAREACOLLECTPOPDIALOGSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xB5E6DA0)
#define MOLEMOLE_FORBIDDENAREACOLLECTPOPDIALOGSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xB5E6DF0)
#define MOLEMOLE_FORBIDDENAREACOLLECTPOPDIALOGSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xB5E6DB0)

namespace MoleMole
{
	inline static constexpr unsigned int ForbiddenAreaCollectPopDialogShow_TypeDefinitionIndex = 46826;
