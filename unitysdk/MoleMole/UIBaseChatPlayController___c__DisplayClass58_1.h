...
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER___C__DISPLAYCLASS58_1__CTOR_OFFSET UNITYSDK_OFFSET(0x8BB7D40)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER___C__DISPLAYCLASS58_1__PROCESSCONDITION_B__1_OFFSET UNITYSDK_OFFSET(0x8BB7D50)

namespace MoleMole
{
	inline static constexpr unsigned int UIBaseChatPlayController___c__DisplayClass58_1_TypeDefinitionIndex = 68472;
