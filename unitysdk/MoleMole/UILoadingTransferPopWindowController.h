...
class Class_2_6E0647BD0D3D5DD8;
...
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_COMPAREPLAYPARAMS_OFFSET UNITYSDK_OFFSET(0xC8A24A0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_DOSTOPUNTILCHESSBOARDLOADINGFINISH_OFFSET UNITYSDK_OFFSET(0xC8A22A0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_CURPLAYTYPE_OFFSET UNITYSDK_OFFSET(0xC8A0F70)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_CURRENTVIDEOPLAYERHELPER_OFFSET UNITYSDK_OFFSET(0xC8A0EF0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_CURVIDEOPATH_OFFSET UNITYSDK_OFFSET(0xC8A0DB0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xC8A0E40)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xC8A0930)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xC8A0AF0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xC8A0C50)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0xC8A0CD0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_ISVIDEOSHOW_OFFSET UNITYSDK_OFFSET(0xC8A10B0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_PERMANENT_OFFSET UNITYSDK_OFFSET(0xC8A0AE0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_VIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0xC8A10C0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC8A0920)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_INITVIDEOPLAYER_1_OFFSET UNITYSDK_OFFSET(0xC8A14D0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_INITVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0xC8A13B0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC8A1170)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_ONPREPAREFAKELOADING_OFFSET UNITYSDK_OFFSET(0xC8A2520)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC8A1210)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8A10D0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0xC8A2340)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xC8A0940)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_SET_CURPLAYTYPE_OFFSET UNITYSDK_OFFSET(0xC8A0F80)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_SET_CURVIDEOPATH_OFFSET UNITYSDK_OFFSET(0xC8A0E30)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_SET_ISVIDEOSHOW_OFFSET UNITYSDK_OFFSET(0xC8A0F90)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_STOPANDHIDE_OFFSET UNITYSDK_OFFSET(0xC8A18E0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_STOPIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xC8A1D90)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_UPDATEALPHABYISVIDEOSHOW_OFFSET UNITYSDK_OFFSET(0xC8A1000)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC8A25B0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC8A2590)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER__STOPANDHIDE_B__49_0_OFFSET UNITYSDK_OFFSET(0xC8A2640)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC8A2750)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC8A27C0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8A27D0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xC8A27E0)

namespace MoleMole
{
	inline static constexpr unsigned int UILoadingTransferPopWindowController_TypeDefinitionIndex = 66948;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x2E9B0);
		}
		static ::System::String** StaticGet_kToBattlePath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x2E9B8);
		}
		static ::System::String** StaticGet_kToBattleFakeLoadingPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x2E9C0);
		}
		static ::System::String** StaticGet_kBattle2ChessboardPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x2E9C8);
		}
		static ::System::String** StaticGet_kBattle2ChessboardFakeLoadingPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x2E9D0);
		}
		::MoleMole::UILoadingTransferPopWindowController_PlayType _CurPlayType_k__BackingField; // 0x2F8
		::System::Boolean _isVideoShow; // 0x2FC
		::Class_2_6E0647BD0D3D5DD8* _view; // 0x300
		::System::String* _videoPath; // 0x308
		::MoleMole::MultipleVideoPlayerManager* _multipleVideoPlayerManager; // 0x310
		::System::UInt32 _soundLoadingSignalLostID; // 0x318
		::System::Boolean _isFakeLoadingPlaying; // 0x31C
		::System::Boolean _ownFakeLoading; // 0x31D
		::System::Action* _OnStopAction; // 0x320
		::MoleMole::UIFullScreenVideoV2PopInLoadingWindowController* _fakeLoadingController; // 0x328
		...
		{
			return ((::Class_1_7ECB9691B142D586*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_CURRENTVIDEOPLAYERHELPER_OFFSET))(this);
		}
