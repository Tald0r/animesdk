...
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_COMPAREPLAYPARAMS_OFFSET UNITYSDK_OFFSET(0xCF8CA70)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_DOSTOPUNTILCHESSBOARDLOADINGFINISH_OFFSET UNITYSDK_OFFSET(0xCF8C870)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_CURPLAYTYPE_OFFSET UNITYSDK_OFFSET(0xCF8B540)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_CURRENTVIDEOPLAYERHELPER_OFFSET UNITYSDK_OFFSET(0xCF8B4C0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_CURVIDEOPATH_OFFSET UNITYSDK_OFFSET(0xCF8B380)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xCF8B410)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xCF8AF00)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xCF8B0C0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xCF8B220)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0xCF8B2A0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_ISVIDEOSHOW_OFFSET UNITYSDK_OFFSET(0xCF8B680)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_PERMANENT_OFFSET UNITYSDK_OFFSET(0xCF8B0B0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_VIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0xCF8B690)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xCF8AEF0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_INITVIDEOPLAYER_1_OFFSET UNITYSDK_OFFSET(0xCF8BAA0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_INITVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0xCF8B980)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCF8B740)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_ONPREPAREFAKELOADING_OFFSET UNITYSDK_OFFSET(0xCF8CAF0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCF8B7E0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCF8B6A0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0xCF8C910)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xCF8AF10)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_SET_CURPLAYTYPE_OFFSET UNITYSDK_OFFSET(0xCF8B550)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_SET_CURVIDEOPATH_OFFSET UNITYSDK_OFFSET(0xCF8B400)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_SET_ISVIDEOSHOW_OFFSET UNITYSDK_OFFSET(0xCF8B560)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_STOPANDHIDE_OFFSET UNITYSDK_OFFSET(0xCF8BEB0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_STOPIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xCF8C360)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER_UPDATEALPHABYISVIDEOSHOW_OFFSET UNITYSDK_OFFSET(0xCF8B5D0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCF8CB80)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCF8CB60)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER__STOPANDHIDE_B__49_0_OFFSET UNITYSDK_OFFSET(0xCF8CC20)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCF8CD30)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCF8CDA0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCF8CDB0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xCF8CDC0)

namespace MoleMole
{
	inline static constexpr unsigned int UILoadingTransferPopWindowController_TypeDefinitionIndex = 41102;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x36300);
		}
		static ::System::String** StaticGet_kTranformBattle2ToHollowPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x36308);
		}
		static ::System::String** StaticGet_kToBattleFakeLoadingPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x36310);
		}
		static ::System::String** StaticGet_kToBattlePath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x36318);
		}
		static ::System::String** StaticGet_kBattle2ChessboardPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UILoadingTransferPopWindowController_TypeDefinitionIndex)->GetStaticField(0x36320);
		}
