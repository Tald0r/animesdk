...
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC2EE2B0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC2EE550)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_06971558418B71C4_OFFSET UNITYSDK_OFFSET(0xC2F3990)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_11D9E7585BB3F14E_OFFSET UNITYSDK_OFFSET(0xC2F3580)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_3C34CB4247CE20D0_OFFSET UNITYSDK_OFFSET(0xC2EFB20)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_42E26283B8070FD8_OFFSET UNITYSDK_OFFSET(0xC2F36C0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_42E284B79BA71F17_OFFSET UNITYSDK_OFFSET(0xC2F0500)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_4857357D5C1BFCE8_OFFSET UNITYSDK_OFFSET(0xC2EE790)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0xC2EE6F0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_66F42CE2EDA79734_OFFSET UNITYSDK_OFFSET(0xC2EF4B0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_69161D0DA0E5C4C4_OFFSET UNITYSDK_OFFSET(0xC2F32C0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_70F807F41F81D824_OFFSET UNITYSDK_OFFSET(0xC2F1E50)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_8E0BA7B7FC76D039_OFFSET UNITYSDK_OFFSET(0xC2EFF80)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_A3A311326D005F67_OFFSET UNITYSDK_OFFSET(0xC2EF960)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_B54EC4D992F50245_OFFSET UNITYSDK_OFFSET(0xC2F1860)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_B89A1E5EB5AAFFCE_OFFSET UNITYSDK_OFFSET(0xC2F4050)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_C99DA86370D1A4C9_OFFSET UNITYSDK_OFFSET(0xC2F41D0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC2EE4E0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_DAC15E132264A2F6_OFFSET UNITYSDK_OFFSET(0xC2F14F0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_EBCB76FF27EFDAE1_OFFSET UNITYSDK_OFFSET(0xC2F2CF0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_ECB5F1C983BF42E9_OFFSET UNITYSDK_OFFSET(0xC2F2550)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_F5CE28CE3AF9C477_OFFSET UNITYSDK_OFFSET(0xC2F1900)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_METHOD_5_F8662F63E9A1995F_OFFSET UNITYSDK_OFFSET(0xC2F1F80)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_SETTARGET_1_OFFSET UNITYSDK_OFFSET(0xC2F0280)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_SETTARGET_OFFSET UNITYSDK_OFFSET(0xC2EFE00)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_SETVIEWENABLE_OFFSET UNITYSDK_OFFSET(0xC2EE460)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_SETVIEWVISABLE_OFFSET UNITYSDK_OFFSET(0xC2EFD70)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_STOPALL_OFFSET UNITYSDK_OFFSET(0xC2EF3F0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_STOPTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xC2EFBF0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_STOPTARGETPOINT_OFFSET UNITYSDK_OFFSET(0xC2EF7D0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_WARNNINGTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xC2F0EB0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER_WARNNINGTARGET_OFFSET UNITYSDK_OFFSET(0xC2F07E0)
#define MOLEMOLE_MONOGUIDEVIEWCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2F1060)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGuideViewContainer_TypeDefinitionIndex = 72955;
