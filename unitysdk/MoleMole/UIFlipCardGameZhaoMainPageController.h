...
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_FLIPCARDSUCCESSHANDLE_OFFSET UNITYSDK_OFFSET(0xBF93D40)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xBF92AC0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xBF92F70)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONACTIVITYCHANGE_OFFSET UNITYSDK_OFFSET(0xBF93BB0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF92AD0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONCREATITEM_OFFSET UNITYSDK_OFFSET(0xBF93C20)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONINFOBTNCLICK_OFFSET UNITYSDK_OFFSET(0xBF93EA0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0xBF93A90)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONREWARDBTNCLICK_OFFSET UNITYSDK_OFFSET(0xBF94020)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF94200)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF92B70)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBF93130)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xBF94290)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF94380)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER__FLIPCARDSUCCESSHANDLE_B__15_0_OFFSET UNITYSDK_OFFSET(0xBF94390)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF94460)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF944D0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF944E0)
#define MOLEMOLE_UIFLIPCARDGAMEZHAOMAINPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xBF944F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlipCardGameZhaoMainPageController_TypeDefinitionIndex = 74781;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_125* _view; // 0x310
