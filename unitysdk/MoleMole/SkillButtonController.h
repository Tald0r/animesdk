...
#define MOLEMOLE_SKILLBUTTONCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xB300630)
#define MOLEMOLE_SKILLBUTTONCONTROLLER_ONBUTTONDISABLED_OFFSET UNITYSDK_OFFSET(0xB300EC0)
#define MOLEMOLE_SKILLBUTTONCONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xB300B20)
#define MOLEMOLE_SKILLBUTTONCONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xB300C30)
#define MOLEMOLE_SKILLBUTTONCONTROLLER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xB3008A0)
#define MOLEMOLE_SKILLBUTTONCONTROLLER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xB300990)
#define MOLEMOLE_SKILLBUTTONCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB300D20)
#define MOLEMOLE_SKILLBUTTONCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB300F90)

namespace MoleMole
{
	inline static constexpr unsigned int SkillButtonController_TypeDefinitionIndex = 55556;
