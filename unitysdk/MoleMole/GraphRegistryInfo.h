...
#define MOLEMOLE_GRAPHREGISTRYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x7F0F380)

namespace MoleMole
{
	inline static constexpr unsigned int GraphRegistryInfo_TypeDefinitionIndex = 65207;
