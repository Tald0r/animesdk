...
#define MOLEMOLE_GRAPHREGISTRYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCD59A10)

namespace MoleMole
{
	inline static constexpr unsigned int GraphRegistryInfo_TypeDefinitionIndex = 37947;
