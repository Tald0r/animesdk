...
#define MOLEMOLE_UIACTIVITYTEAMTRIALCONDITIONROWWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8BA5B10)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityTeamTrialConditionRowWidgetController_Context_TypeDefinitionIndex = 74191;
