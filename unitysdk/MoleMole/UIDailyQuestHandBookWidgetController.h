...
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_CANTAKEVITALITYREWARD_OFFSET UNITYSDK_OFFSET(0xBB1D6C0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_CREATEDOUBLEWEEKBINGOROW_OFFSET UNITYSDK_OFFSET(0xBB1C490)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_CREATENORMALROW_OFFSET UNITYSDK_OFFSET(0xBB1C2D0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_CREATESCHEDULEPLANROW_OFFSET UNITYSDK_OFFSET(0xBB1C3B0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xBB1C090)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xBB1AD90)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB1BF10)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBB1B2E0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB1BFB0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB1AB60)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBB1AF70)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_OPENREWARDSPREVIEW_OFFSET UNITYSDK_OFFSET(0xBB1E430)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_PLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0xBB1E0A0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_PLAYPROGRESSPOINTCANTAKEEFFECT_OFFSET UNITYSDK_OFFSET(0xBB1DA20)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_PLAYPROGRESSPOINTDONEEFFECT_OFFSET UNITYSDK_OFFSET(0xBB1DBD0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_REFRESHPROGRESSVIEW_OFFSET UNITYSDK_OFFSET(0xBB1C570)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_REFRESHREWARDSTATE_OFFSET UNITYSDK_OFFSET(0xBB1CCD0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBB1B3B0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0xBB1CE70)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_SHOWGETITEMLIST_OFFSET UNITYSDK_OFFSET(0xBB1DE30)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_TRYPLAYCANTAKEREWARDEFFECT_OFFSET UNITYSDK_OFFSET(0xBB1B040)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_TRYTAKEVITALITYREWARDS_OFFSET UNITYSDK_OFFSET(0xBB1D400)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB1E5A0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0xBB1E5D0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER__ONUIINIT_B__1_1_OFFSET UNITYSDK_OFFSET(0xBB1E600)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER__ONUIINIT_B__1_2_OFFSET UNITYSDK_OFFSET(0xBB1E620)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB1E650)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBB1E6C0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB1E730)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB1E7B0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBB1E810)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestHandBookWidgetController_TypeDefinitionIndex = 73745;

	class UIDailyQuestHandBookWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D3704D04572A8616* _view; // 0x2A0
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_651*>* _dailyQuests; // 0x2A8
