...
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_CANTAKEVITALITYREWARD_OFFSET UNITYSDK_OFFSET(0xBFEA610)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_CREATEDOUBLEWEEKBINGOROW_OFFSET UNITYSDK_OFFSET(0xBFE93E0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_CREATENORMALROW_OFFSET UNITYSDK_OFFSET(0xBFE9220)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_CREATESCHEDULEPLANROW_OFFSET UNITYSDK_OFFSET(0xBFE9300)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xBFE8FE0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xBFE7CE0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFE8E60)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBFE8230)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFE8F00)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFE7AB0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFE7EC0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_OPENREWARDSPREVIEW_OFFSET UNITYSDK_OFFSET(0xBFEB380)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_PLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0xBFEAFF0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_PLAYPROGRESSPOINTCANTAKEEFFECT_OFFSET UNITYSDK_OFFSET(0xBFEA970)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_PLAYPROGRESSPOINTDONEEFFECT_OFFSET UNITYSDK_OFFSET(0xBFEAB20)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_REFRESHPROGRESSVIEW_OFFSET UNITYSDK_OFFSET(0xBFE94C0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_REFRESHREWARDSTATE_OFFSET UNITYSDK_OFFSET(0xBFE9C10)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBFE8300)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0xBFE9DB0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_SHOWGETITEMLIST_OFFSET UNITYSDK_OFFSET(0xBFEAD80)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_TRYPLAYCANTAKEREWARDEFFECT_OFFSET UNITYSDK_OFFSET(0xBFE7F90)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER_TRYTAKEVITALITYREWARDS_OFFSET UNITYSDK_OFFSET(0xBFEA340)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFEB4F0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0xBFEB520)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER__ONUIINIT_B__1_1_OFFSET UNITYSDK_OFFSET(0xBFEB550)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER__ONUIINIT_B__1_2_OFFSET UNITYSDK_OFFSET(0xBFEB570)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFEB5A0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBFEB610)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFEB680)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFEB700)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFEB760)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestHandBookWidgetController_TypeDefinitionIndex = 59323;

	class UIDailyQuestHandBookWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D3704D04572A8616* _view; // 0x2A0
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_419*>* _dailyQuests; // 0x2A8
		::System::Boolean _isTakingRewards; // 0x2B0
