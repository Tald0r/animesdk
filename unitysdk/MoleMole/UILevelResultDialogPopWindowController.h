...
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER_CONTAINS_OFFSET UNITYSDK_OFFSET(0xC11E2B0)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER_CREATEDATA_OFFSET UNITYSDK_OFFSET(0xC11F200)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER_GET_VIEW_OFFSET UNITYSDK_OFFSET(0xC11D1F0)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC11D1E0)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC11E180)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER_ONFAIRYBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xC120D60)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC11E220)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC11D200)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC11D700)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER_PREPAREDATA_OFFSET UNITYSDK_OFFSET(0xC11E710)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0xC11EED0)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC120DC0)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC120FC0)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC120F30)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC120F40)
#define MOLEMOLE_UILEVELRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC120F50)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultDialogPopWindowController_TypeDefinitionIndex = 72864;

	class UILevelResultDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_F96EEF3462521D2D* _view; // 0x2F8
		::System::Collections::Generic::List_1<::System::Single>* weaponRatio; // 0x300
		::System::Collections::Generic::List_1<::System::Single>* equipRatio; // 0x308
		::System::Collections::Generic::List_1<::MoleMole::UILevelResultProgressRowWidgetController*>* widgets; // 0x310
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::Class_1_2A09C8C0CD4D6ED4_1*>*>* failedInfos; // 0x318
		::System::UInt32 _curAvatarId; // 0x320
