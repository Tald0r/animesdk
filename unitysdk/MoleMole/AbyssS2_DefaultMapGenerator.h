...
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_FETCHROUTEPOINTNEIGHBOR_OFFSET UNITYSDK_OFFSET(0xB8E9BC0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_GETAREAMETATYPETEMPLATEEXTBYAREAID_OFFSET UNITYSDK_OFFSET(0xB8EE250)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_GET_RESULT_OFFSET UNITYSDK_OFFSET(0xB8EEC20)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_POST_OFFSET UNITYSDK_OFFSET(0xB8ECA90)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PREPARE_OFFSET UNITYSDK_OFFSET(0xB8E4C60)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_NORMALPARTFIXGEN_3_OFFSET UNITYSDK_OFFSET(0xB8E8780)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_NORMALPARTGEN_1_OFFSET UNITYSDK_OFFSET(0xB8E76B0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_NORMALPARTREDUCEGEN_2_OFFSET UNITYSDK_OFFSET(0xB8E7E00)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_OFFSET UNITYSDK_OFFSET(0xB8E50B0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_STARTPOINTS_0_OFFSET UNITYSDK_OFFSET(0xB8E6F40)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB8E4B40)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__FETCHROUTEPOINTNEIGHBOOR_OFFSET UNITYSDK_OFFSET(0xB8E9880)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__FETCHROUTEPOINTNEIGHBOR_G__GETINDEX_17_0_OFFSET UNITYSDK_OFFSET(0xB8E9EA0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__ISAREAIDUNDERFORBIDRULE_OFFSET UNITYSDK_OFFSET(0xB8E9F90)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__ISAREASERINDEXUNDERFORBIDRULE_OFFSET UNITYSDK_OFFSET(0xB8EBCC0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__ISTAGMATCHLIST_OFFSET UNITYSDK_OFFSET(0xB8E9EF0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__RANDOMFILLAREA_OFFSET UNITYSDK_OFFSET(0xB8E5B90)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__SORTROUTEPOINTLISTBYFLOOR_OFFSET UNITYSDK_OFFSET(0xB8E9310)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__TRYBUILDDYNAMICMERGES_OFFSET UNITYSDK_OFFSET(0xB8ECB00)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__TRYGENSERIALID_OFFSET UNITYSDK_OFFSET(0xB8EC010)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__TRYPARSEAREAPOOL_OFFSET UNITYSDK_OFFSET(0xB8E5330)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__WEIGHTRANDOMAREA_OFFSET UNITYSDK_OFFSET(0xB8E9440)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___FETCHROUTEPOINTNEIGHBOOR_G____GETINDEX_16_0_OFFSET UNITYSDK_OFFSET(0xB8E9B70)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____GETAREAIDBYROUTEPOINTID_29_4_OFFSET UNITYSDK_OFFSET(0xB8EE820)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____HASSPECIALINDEXORTAGS_29_0_OFFSET UNITYSDK_OFFSET(0xB8EE930)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____ISLEFTINRIGHT_29_2_OFFSET UNITYSDK_OFFSET(0xB8EE7A0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____NEXTPOSSIBLESELECTIONS_29_3_OFFSET UNITYSDK_OFFSET(0xB8EE4B0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____SPLITLISTTONEW_29_1_OFFSET UNITYSDK_OFFSET(0xB8EEB30)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_DefaultMapGenerator_TypeDefinitionIndex = 77491;
	...
	public:
		...
		::MoleMole::AbyssS2_GenRouteMapConfig* _genConfig; // 0x18
		::MoleMole::AbyssS2_IRNG* _rngEvent; // 0x20
		::MoleMole::AbyssS2_IRNG* _rngRoute; // 0x28
		::MoleMole::AbyssS2_DefaultMapGenerator_GenPointID2AreaInterObject* runTimeID2AreaInterObject; // 0x30
		...
		::Class_2_208CC9941471731A_193* GetAreaMetaTypeTemplateExtByAreaID(::System::Int32 areaID, ::System::Int32 areaIndex)
		{
			return ((::Class_2_208CC9941471731A_193*(*)(::PVOID, ::System::Int32, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_GETAREAMETATYPETEMPLATEEXTBYAREAID_OFFSET))(this, areaID, areaIndex);
		}
