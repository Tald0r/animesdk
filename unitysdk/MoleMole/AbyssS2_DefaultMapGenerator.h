...
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_FETCHROUTEPOINTNEIGHBOR_OFFSET UNITYSDK_OFFSET(0x671C270)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_GETAREAMETATYPETEMPLATEEXTBYAREAID_OFFSET UNITYSDK_OFFSET(0x6720900)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x67212D0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_POST_OFFSET UNITYSDK_OFFSET(0x671F140)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PREPARE_OFFSET UNITYSDK_OFFSET(0x6717310)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_NORMALPARTFIXGEN_3_OFFSET UNITYSDK_OFFSET(0x671AE30)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_NORMALPARTGEN_1_OFFSET UNITYSDK_OFFSET(0x6719D60)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_NORMALPARTREDUCEGEN_2_OFFSET UNITYSDK_OFFSET(0x671A4B0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x6717760)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_PROCESS_STARTPOINTS_0_OFFSET UNITYSDK_OFFSET(0x67195F0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x67171F0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__FETCHROUTEPOINTNEIGHBOOR_OFFSET UNITYSDK_OFFSET(0x671BF30)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__FETCHROUTEPOINTNEIGHBOR_G__GETINDEX_17_0_OFFSET UNITYSDK_OFFSET(0x671C550)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__ISAREAIDUNDERFORBIDRULE_OFFSET UNITYSDK_OFFSET(0x671C640)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__ISAREASERINDEXUNDERFORBIDRULE_OFFSET UNITYSDK_OFFSET(0x671E370)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__ISTAGMATCHLIST_OFFSET UNITYSDK_OFFSET(0x671C5A0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__RANDOMFILLAREA_OFFSET UNITYSDK_OFFSET(0x6718240)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__SORTROUTEPOINTLISTBYFLOOR_OFFSET UNITYSDK_OFFSET(0x671B9C0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__TRYBUILDDYNAMICMERGES_OFFSET UNITYSDK_OFFSET(0x671F1B0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__TRYGENSERIALID_OFFSET UNITYSDK_OFFSET(0x671E6C0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__TRYPARSEAREAPOOL_OFFSET UNITYSDK_OFFSET(0x67179E0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR__WEIGHTRANDOMAREA_OFFSET UNITYSDK_OFFSET(0x671BAF0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___FETCHROUTEPOINTNEIGHBOOR_G____GETINDEX_16_0_OFFSET UNITYSDK_OFFSET(0x671C220)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____GETAREAIDBYROUTEPOINTID_29_4_OFFSET UNITYSDK_OFFSET(0x6720ED0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____HASSPECIALINDEXORTAGS_29_0_OFFSET UNITYSDK_OFFSET(0x6720FE0)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____ISLEFTINRIGHT_29_2_OFFSET UNITYSDK_OFFSET(0x6720E50)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____NEXTPOSSIBLESELECTIONS_29_3_OFFSET UNITYSDK_OFFSET(0x6720B60)
#define MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR___TRYBUILDDYNAMICMERGES_G____SPLITLISTTONEW_29_1_OFFSET UNITYSDK_OFFSET(0x67211E0)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_DefaultMapGenerator_TypeDefinitionIndex = 68800;
	...
	public:
		...
		::MoleMole::AbyssS2_GenRouteMapConfig* _genConfig; // 0x20
		::MoleMole::AbyssS2_DefaultMapGenerator_GenPointID2AreaInterObject* runTimeID2AreaInterObject; // 0x28
		::MoleMole::AbyssS2_GenResult* _result; // 0x30
		::MoleMole::AbyssS2_IRNG* _rngRoute; // 0x38
		...
		::Class_2_208CC9941471731A_764* GetAreaMetaTypeTemplateExtByAreaID(::System::Int32 areaID, ::System::Int32 areaIndex)
		{
			return ((::Class_2_208CC9941471731A_764*(*)(::PVOID, ::System::Int32, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_ABYSSS2_DEFAULTMAPGENERATOR_GETAREAMETATYPETEMPLATEEXTBYAREAID_OFFSET))(this, areaID, areaIndex);
		}
