...
#define MOLEMOLE_ACTIVITYRHYTHMCLICKBEATMAPCONFIG_BEATMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x81C9DD0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityRhythmClickBeatmapConfig_BeatMap_TypeDefinitionIndex = 38163;
