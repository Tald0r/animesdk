...
#define MOLEMOLE_CHARACTERRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x848E280)

namespace MoleMole
{
	inline static constexpr unsigned int CharacterReloadConfig_TypeDefinitionIndex = 68675;
