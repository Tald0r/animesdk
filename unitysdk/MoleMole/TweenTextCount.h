...
#define MOLEMOLE_TWEENTEXTCOUNT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xA4A15D0)
#define MOLEMOLE_TWEENTEXTCOUNT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xA4A1710)
#define MOLEMOLE_TWEENTEXTCOUNT_METHOD_7_B433DD4DC78D168A_OFFSET UNITYSDK_OFFSET(0xA4A17A0)
#define MOLEMOLE_TWEENTEXTCOUNT_METHOD_7_CC069E7D5D795C91_OFFSET UNITYSDK_OFFSET(0xA4A18E0)
#define MOLEMOLE_TWEENTEXTCOUNT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xA4A1720)
#define MOLEMOLE_TWEENTEXTCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0xA4A1A90)
#define MOLEMOLE_TWEENTEXTCOUNT___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xA4A1AB0)

namespace MoleMole
{
	inline static constexpr unsigned int TweenTextCount_TypeDefinitionIndex = 48815;
