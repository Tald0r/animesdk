...
#define MOLEMOLE_CONFIGDEBUGSOUND_WATCHSTATESBLOCK_CREATEFROMCLIPBOARD_OFFSET UNITYSDK_OFFSET(0xE0C4360)
#define MOLEMOLE_CONFIGDEBUGSOUND_WATCHSTATESBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xE0C46F0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigDebugSound_WatchStatesBlock_TypeDefinitionIndex = 58060;
	...
	public:
		...
		::System::Boolean alwaysShow; // 0x20
		::System::Boolean isCurrentShow; // 0x21
