...
#define MOLEMOLE_UIACTIVITYFRUITTOYSPHASEENDPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xDED7570)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityFruitToysPhaseEndPopWindowController_Context_TypeDefinitionIndex = 39423;
	...
	public:
		...
		::System::Boolean PlayCompleteAnim; // 0x38
		::System::Int32 PopConfigID; // 0x3C
