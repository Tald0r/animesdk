...
#define MOLEMOLE_COMICPAGEDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B4FCB30)
#define MOLEMOLE_COMICPAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4FCBE0)

namespace MoleMole
{
	inline static constexpr unsigned int ComicPageData_TypeDefinitionIndex = 30050;
	...
	public:
		...
		::MoleMole::ComicImgSplitScreenGroup* imgGroup; // 0x18
		...
		::System::Collections::Generic::List_1<::System::String*>* pageStartContinuousAudioKeyList; // 0x30
		::System::String* pageTransitionSoundKey; // 0x38
