...
#define MOLEMOLE_VOXEL_VOXELCOMPRESSCELL_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x939EC80)
#define MOLEMOLE_VOXEL_VOXELCOMPRESSCELL_METHOD_1_8B97FF67BAF171EB_OFFSET UNITYSDK_OFFSET(0x939ED00)
#define MOLEMOLE_VOXEL_VOXELCOMPRESSCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x939EC70)

namespace MoleMole::Voxel
{
	inline static constexpr unsigned int VoxelCompressCell_TypeDefinitionIndex = 72760;
