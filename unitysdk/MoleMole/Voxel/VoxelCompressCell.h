...
#define MOLEMOLE_VOXEL_VOXELCOMPRESSCELL_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x954DA70)
#define MOLEMOLE_VOXEL_VOXELCOMPRESSCELL_METHOD_1_8B97FF67BAF171EB_OFFSET UNITYSDK_OFFSET(0x954DAF0)
#define MOLEMOLE_VOXEL_VOXELCOMPRESSCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x954DA60)

namespace MoleMole::Voxel
{
	inline static constexpr unsigned int VoxelCompressCell_TypeDefinitionIndex = 62791;
