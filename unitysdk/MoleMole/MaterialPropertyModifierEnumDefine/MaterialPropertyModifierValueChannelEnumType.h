...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0xE487DE0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x50F610)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x50F580)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x50F500)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x50F480)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueChannelEnumType_TypeDefinitionIndex = 56418;
