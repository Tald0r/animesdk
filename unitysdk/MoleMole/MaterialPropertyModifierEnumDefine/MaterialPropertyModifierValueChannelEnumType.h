...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0xD80FD10)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x4722F0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x472260)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x4721E0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x472160)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueChannelEnumType_TypeDefinitionIndex = 73822;
