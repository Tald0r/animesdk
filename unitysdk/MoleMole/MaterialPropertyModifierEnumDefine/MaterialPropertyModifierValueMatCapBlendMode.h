...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0xA51B770)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x38D9D0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x38D940)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x38D8C0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x38D840)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueMatCapBlendMode_TypeDefinitionIndex = 80580;
