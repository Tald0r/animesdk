...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0x9920010)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x36AD50)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x36ACC0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x36AC40)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x36ABC0)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueMatCapBlendMode_TypeDefinitionIndex = 67765;
