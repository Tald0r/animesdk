...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x7F13F70)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x7F13F80)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x7F14210)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7F14420)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F143C0)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueScreenMaskUVType_MaterialPropertyModifierValueScreenMaskUVType_UnityGeneratedFormatter_TypeDefinitionIndex = 58683;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueScreenMaskUVType_MaterialPropertyModifierValueScreenMaskUVType_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x415D0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::MaterialPropertyModifierEnumDefine::ScreenMaskUVType>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueScreenMaskUVType_MaterialPropertyModifierValueScreenMaskUVType_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x415D8);
		}
