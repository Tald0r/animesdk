...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0xB840990)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x3B2F70)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x3B2EE0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x3B2E60)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x3B2DE0)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueMatCapType_TypeDefinitionIndex = 39238;
