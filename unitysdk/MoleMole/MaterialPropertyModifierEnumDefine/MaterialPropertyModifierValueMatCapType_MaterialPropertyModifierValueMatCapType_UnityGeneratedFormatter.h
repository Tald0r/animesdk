...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x8F87060)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x8F87070)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x8F87300)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8F87510)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_MATERIALPROPERTYMODIFIERVALUEMATCAPTYPE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F874B0)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueMatCapType_MaterialPropertyModifierValueMatCapType_UnityGeneratedFormatter_TypeDefinitionIndex = 71241;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueMatCapType_MaterialPropertyModifierValueMatCapType_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3EE00);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::MaterialPropertyModifierEnumDefine::MatCapType>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueMatCapType_MaterialPropertyModifierValueMatCapType_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3EE08);
		}
