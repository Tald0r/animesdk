...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEAVATARSHADERBLENDMODE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0xBA1C500)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEAVATARSHADERBLENDMODE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x3B8BE0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEAVATARSHADERBLENDMODE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x3B8B50)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEAVATARSHADERBLENDMODE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x3B8AD0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEAVATARSHADERBLENDMODE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x3B8A50)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueAvatarShaderBlendMode_TypeDefinitionIndex = 56338;
