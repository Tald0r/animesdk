...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEAVATARSHADERBLENDMODE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0xC9D6C60)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEAVATARSHADERBLENDMODE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x3F2130)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEAVATARSHADERBLENDMODE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x3F20A0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEAVATARSHADERBLENDMODE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x3F2020)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEAVATARSHADERBLENDMODE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x3F1FA0)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueAvatarShaderBlendMode_TypeDefinitionIndex = 38763;
