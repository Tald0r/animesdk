...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0xA5FB0C0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x381D90)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x381D00)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x381C80)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUESCREENMASKUVTYPE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x381C00)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueScreenMaskUVType_TypeDefinitionIndex = 58682;
