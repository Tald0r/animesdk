...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xA02AC70)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xA02AC80)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xA02AF10)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA02B120)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_MATERIALPROPERTYMODIFIERVALUECHANNELENUMTYPE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA02B0C0)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueChannelEnumType_MaterialPropertyModifierValueChannelEnumType_UnityGeneratedFormatter_TypeDefinitionIndex = 73823;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::MaterialPropertyModifierEnumDefine::ChannelEnumType>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueChannelEnumType_MaterialPropertyModifierValueChannelEnumType_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x392D0);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Boolean>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueChannelEnumType_MaterialPropertyModifierValueChannelEnumType_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x392D8);
		}
