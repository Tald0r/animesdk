...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0x7A7F070)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x33FEB0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x33FE20)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x33FDA0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x33FD20)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueMaskChannelType_TypeDefinitionIndex = 81004;
