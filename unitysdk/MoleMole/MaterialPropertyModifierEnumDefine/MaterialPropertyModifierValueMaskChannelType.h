...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_GETCLONEFROMENUM_OFFSET UNITYSDK_OFFSET(0xE0DBBD0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_SYNCENABLE_1_OFFSET UNITYSDK_OFFSET(0x4E0500)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_SYNCENABLE_OFFSET UNITYSDK_OFFSET(0x4E0470)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_SYNCVALUE_1_OFFSET UNITYSDK_OFFSET(0x4E03F0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_SYNCVALUE_OFFSET UNITYSDK_OFFSET(0x4E0370)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueMaskChannelType_TypeDefinitionIndex = 55917;
