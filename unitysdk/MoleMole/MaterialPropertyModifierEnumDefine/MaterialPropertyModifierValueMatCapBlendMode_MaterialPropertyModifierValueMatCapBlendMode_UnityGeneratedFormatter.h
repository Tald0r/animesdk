...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCD5DC80)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCD5DC90)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCD5DF20)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD5E130)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_MATERIALPROPERTYMODIFIERVALUEMATCAPBLENDMODE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD5E0D0)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueMatCapBlendMode_MaterialPropertyModifierValueMatCapBlendMode_UnityGeneratedFormatter_TypeDefinitionIndex = 80581;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::MaterialPropertyModifierEnumDefine::MatCapBlendMode>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueMatCapBlendMode_MaterialPropertyModifierValueMatCapBlendMode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x47920);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Boolean>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueMatCapBlendMode_MaterialPropertyModifierValueMatCapBlendMode_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x47928);
		}
