...
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xD80FDA0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xD80FDB0)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xD810040)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD810250)
#define MOLEMOLE_MATERIALPROPERTYMODIFIERENUMDEFINE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_MATERIALPROPERTYMODIFIERVALUEMASKCHANNELTYPE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD8101F0)

namespace MoleMole::MaterialPropertyModifierEnumDefine
{
	inline static constexpr unsigned int MaterialPropertyModifierValueMaskChannelType_MaterialPropertyModifierValueMaskChannelType_UnityGeneratedFormatter_TypeDefinitionIndex = 81005;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueMaskChannelType_MaterialPropertyModifierValueMaskChannelType_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x403F0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::MaterialPropertyModifierEnumDefine::MaskChannelType>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyModifierValueMaskChannelType_MaterialPropertyModifierValueMaskChannelType_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x403F8);
		}
