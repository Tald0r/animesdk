...
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__GETWORLDPOINTSINBIGSCENE_NAVMESHCALC_ASYNC_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x38E4F0)
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__GETWORLDPOINTSINBIGSCENE_NAVMESHCALC_ASYNC_D__17_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapTrackLineWidgetContext__GetWorldPointsInBigScene_NavMeshCalc_Async_d__17_TypeDefinitionIndex = 62889;
	...
	struct alignas(8) UIUrbanMapTrackLineWidgetContext__GetWorldPointsInBigScene_NavMeshCalc_Async_d__17
	{
		...
		::System::Collections::Generic::List_1<::UnityEngine::Vector3>* _pointList_5__2; // 0x40
		::System::Collections::Generic::List_1<::UnityEngine::Vector3>* _navMeshPaths_5__4; // 0x48
		::MoleMole::UIUrbanMapTrackLineWidgetContext* __4__this; // 0x50
		::UnityEngine::Vector3 playerPosVal; // 0x58
		::UnityEngine::Vector3 _firstPoint_5__3; // 0x64
