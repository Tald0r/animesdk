...
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER__TRYSHOWTIPSWITHUNITASK_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x397B70)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER__TRYSHOWTIPSWITHUNITASK_D__14_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x310210)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2EntrancePageController__TryShowTipsWithUniTask_d__14_TypeDefinitionIndex = 69583;
	...
	struct alignas(8) UIAbyssS2EntrancePageController__TryShowTipsWithUniTask_d__14
	{
		...
		::MoleMole::UIAbyssS2EntrancePageController* __4__this; // 0x50
		::System::Int32 __1__state; // 0x58
		::System::Boolean hasWidget; // 0x5C
		::System::Int32 _reminderID_5__2; // 0x60
