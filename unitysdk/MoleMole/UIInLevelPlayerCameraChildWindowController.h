...
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_ADDMOUSEMOVEDELTARECORDDATA_OFFSET UNITYSDK_OFFSET(0x7F8E430)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_CLEARMOUSEMOVEDELTARECORDDATA_OFFSET UNITYSDK_OFFSET(0x7F8E660)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_GETTOTALMOUSEMOVEDELTA_OFFSET UNITYSDK_OFFSET(0x7F8E4F0)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x7F8BD70)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x7F8E7D0)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F8BD80)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x7F8C480)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7F8C100)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F8C170)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F8BE20)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F8C050)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_OVERRIDECAMERAMOVEEVENT_OFFSET UNITYSDK_OFFSET(0x7F8E760)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_REFRESHMOUSEMODECAMERALOCK_OFFSET UNITYSDK_OFFSET(0x7F8D300)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_REFRESHMOUSEMOVEDELTARECORDDATA_OFFSET UNITYSDK_OFFSET(0x7F8E250)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_REGISTERWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x7F8BEB0)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_RESETROTATING_OFFSET UNITYSDK_OFFSET(0x7F8C410)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_SETMANUALLOCKENABLED_OFFSET UNITYSDK_OFFSET(0x7F8E6F0)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_SWITCHMANUALLOCKTARGETBYMOUSEMOVEDELTA_OFFSET UNITYSDK_OFFSET(0x7F8D8E0)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_SWITCHMANUALLOCKTARGETBYMOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x7F8E1D0)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_SWITCHMANUALLOCKTARGET_OFFSET UNITYSDK_OFFSET(0x7F8D080)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_TOGGLEMANUALLOCK_OFFSET UNITYSDK_OFFSET(0x7F8DED0)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER_UNREGISTERWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x7F8C270)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F8E8C0)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER__SWITCHMANUALLOCKTARGETBYMOUSEMOVEDELTA_B__12_0_OFFSET UNITYSDK_OFFSET(0x7F8E970)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER__TOGGLEMANUALLOCK_B__9_0_OFFSET UNITYSDK_OFFSET(0x7F8E960)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F8E980)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x7F8E9F0)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7F8EA20)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F8EA30)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F8EA40)
#define MOLEMOLE_UIINLEVELPLAYERCAMERACHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F8EA50)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPlayerCameraChildWindowController_TypeDefinitionIndex = 64841;

	class UIInLevelPlayerCameraChildWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::System::Boolean isRotating; // 0x2F8
		::Class_2_69CBB7FF0BE6A673_19* _view; // 0x300
