...
#define MOLEMOLE_UIFORBIDDENAREATALENTBRANCHLINKWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9D75910)

namespace MoleMole
{
	inline static constexpr unsigned int UIForbiddenAreaTalentBranchLinkWidgetContext_TypeDefinitionIndex = 58172;
