...
#define MOLEMOLE_UIFORBIDDENAREATALENTBRANCHLINKWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xADE1B90)

namespace MoleMole
{
	inline static constexpr unsigned int UIForbiddenAreaTalentBranchLinkWidgetContext_TypeDefinitionIndex = 76395;
