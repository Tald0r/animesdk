...
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___C__DISPLAYCLASS81_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8931820)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___C__DISPLAYCLASS81_0__MOVELEFTAVATAR_B__0_OFFSET UNITYSDK_OFFSET(0x8931830)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___C__DISPLAYCLASS81_0__MOVELEFTAVATAR_B__2_OFFSET UNITYSDK_OFFSET(0x8931A20)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainBottomWidgetController___c__DisplayClass81_0_TypeDefinitionIndex = 76055;
