...
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___C__DISPLAYCLASS81_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8A318B0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___C__DISPLAYCLASS81_0__MOVELEFTAVATAR_B__0_OFFSET UNITYSDK_OFFSET(0x8A318C0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER___C__DISPLAYCLASS81_0__MOVELEFTAVATAR_B__2_OFFSET UNITYSDK_OFFSET(0x8A31AB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainBottomWidgetController___c__DisplayClass81_0_TypeDefinitionIndex = 78255;
	...
	public:
		...
		::UnityEngine::Transform* nextTran; // 0x18
