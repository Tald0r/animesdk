...
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBECC8D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarStoryActivityPageContext_TypeDefinitionIndex = 54574;
