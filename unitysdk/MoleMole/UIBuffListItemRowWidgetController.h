...
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER_GET_VIEW_OFFSET UNITYSDK_OFFSET(0xD033590)
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0xD033980)
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD033800)
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD033AF0)
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD0338A0)
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD0335A0)
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD033640)
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER_SETMASK_OFFSET UNITYSDK_OFFSET(0xD033A60)
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD034420)
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD034430)
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD0344A0)
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD034520)
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD0345A0)
#define MOLEMOLE_UIBUFFLISTITEMROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD034600)

namespace MoleMole
{
	inline static constexpr unsigned int UIBuffListItemRowWidgetController_TypeDefinitionIndex = 49757;
