...
#define MOLEMOLE_MONOGAMESCENEOBJECTMAP_MONOGAMESCENEOBJECTMAP_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x8F92A90)
#define MOLEMOLE_MONOGAMESCENEOBJECTMAP_MONOGAMESCENEOBJECTMAP_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x8F92AA0)
#define MOLEMOLE_MONOGAMESCENEOBJECTMAP_MONOGAMESCENEOBJECTMAP_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x8F92CA0)
#define MOLEMOLE_MONOGAMESCENEOBJECTMAP_MONOGAMESCENEOBJECTMAP_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8F92E60)
#define MOLEMOLE_MONOGAMESCENEOBJECTMAP_MONOGAMESCENEOBJECTMAP_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F92E20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGameSceneObjectMap_MonoGameSceneObjectMap_UnityGeneratedFormatter_TypeDefinitionIndex = 48534;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Animator*>*>**)Il2CppClass::FromTypeDefinitionIndex(MonoGameSceneObjectMap_MonoGameSceneObjectMap_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3EE30);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::GameObject*>*>**)Il2CppClass::FromTypeDefinitionIndex(MonoGameSceneObjectMap_MonoGameSceneObjectMap_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3EE38);
		}
