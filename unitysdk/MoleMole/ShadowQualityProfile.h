...
#define MOLEMOLE_SHADOWQUALITYPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x7F24CA0)
#define MOLEMOLE_SHADOWQUALITYPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x7F24E20)
#define MOLEMOLE_SHADOWQUALITYPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x7F24BC0)
#define MOLEMOLE_SHADOWQUALITYPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x7F24D80)
#define MOLEMOLE_SHADOWQUALITYPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x7F24BB0)
#define MOLEMOLE_SHADOWQUALITYPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x7F24F50)
#define MOLEMOLE_SHADOWQUALITYPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x7F24FE0)
#define MOLEMOLE_SHADOWQUALITYPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x7F25050)
#define MOLEMOLE_SHADOWQUALITYPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x7F250C0)

namespace MoleMole
{
	inline static constexpr unsigned int ShadowQualityProfile_TypeDefinitionIndex = 71999;
