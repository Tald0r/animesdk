...
#define MOLEMOLE_SHADOWQUALITYPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x8B773F0)
#define MOLEMOLE_SHADOWQUALITYPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x8B77570)
#define MOLEMOLE_SHADOWQUALITYPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x8B77310)
#define MOLEMOLE_SHADOWQUALITYPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x8B774D0)
#define MOLEMOLE_SHADOWQUALITYPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x8B77300)
#define MOLEMOLE_SHADOWQUALITYPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x8B776A0)
#define MOLEMOLE_SHADOWQUALITYPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x8B77730)
#define MOLEMOLE_SHADOWQUALITYPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x8B777A0)
#define MOLEMOLE_SHADOWQUALITYPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x8B77810)

namespace MoleMole
{
	inline static constexpr unsigned int ShadowQualityProfile_TypeDefinitionIndex = 71072;
