...
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_CLOSETEXT_OFFSET UNITYSDK_OFFSET(0xC0BBE30)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_FADEIN_OFFSET UNITYSDK_OFFSET(0xC0BBA80)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_FADEOUT_OFFSET UNITYSDK_OFFSET(0xC0BBB90)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0xC0BBF00)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0xC0BB360)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC0BB350)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0BB3F0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0BBB00)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0BB370)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0BB490)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_SETIMAGE_OFFSET UNITYSDK_OFFSET(0xC0BBC90)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0xC0BB770)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_SHOWTIPS_OFFSET UNITYSDK_OFFSET(0xC0BB540)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER__CLOSETEXT_B__15_0_OFFSET UNITYSDK_OFFSET(0xC0BBF80)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0BBF70)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0BC020)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0BC090)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0BC0A0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0BC0B0)

namespace MoleMole
{
	inline static constexpr unsigned int UICompanionTipsChildWindowController_TypeDefinitionIndex = 73771;
