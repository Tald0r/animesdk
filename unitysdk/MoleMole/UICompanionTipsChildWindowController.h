...
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_CLOSETEXT_OFFSET UNITYSDK_OFFSET(0x8BDC890)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_FADEIN_OFFSET UNITYSDK_OFFSET(0x8BDC4E0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_FADEOUT_OFFSET UNITYSDK_OFFSET(0x8BDC5F0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x8BDC960)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x8BDBDC0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8BDBDB0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BDBE50)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BDC560)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BDBDD0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BDBEF0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_SETIMAGE_OFFSET UNITYSDK_OFFSET(0x8BDC6F0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x8BDC1D0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER_SHOWTIPS_OFFSET UNITYSDK_OFFSET(0x8BDBFA0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER__CLOSETEXT_B__15_0_OFFSET UNITYSDK_OFFSET(0x8BDC9E0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8BDC9D0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BDCA70)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BDCAE0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BDCAF0)
#define MOLEMOLE_UICOMPANIONTIPSCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BDCB00)

namespace MoleMole
{
	inline static constexpr unsigned int UICompanionTipsChildWindowController_TypeDefinitionIndex = 69272;
	...
	public:
		...
		::UnityEngine::Animation* _ani; // 0x308
