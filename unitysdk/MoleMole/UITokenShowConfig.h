...
#define MOLEMOLE_UITOKENSHOWCONFIG_GET_CUSTOMITEMPACKAGETYPE_OFFSET UNITYSDK_OFFSET(0x71DF070)
#define MOLEMOLE_UITOKENSHOWCONFIG_GET_USECUSTOMITEMPACKAGETYPE_OFFSET UNITYSDK_OFFSET(0x71DF000)
#define MOLEMOLE_UITOKENSHOWCONFIG_METHOD_1_AEC5F34E88355378_OFFSET UNITYSDK_OFFSET(0x71DF0A0)
#define MOLEMOLE_UITOKENSHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x71DF080)

namespace MoleMole
{
	inline static constexpr unsigned int UITokenShowConfig_TypeDefinitionIndex = 57598;
