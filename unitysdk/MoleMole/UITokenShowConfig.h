...
#define MOLEMOLE_UITOKENSHOWCONFIG_GET_CUSTOMITEMPACKAGETYPE_OFFSET UNITYSDK_OFFSET(0xCAAE4C0)
#define MOLEMOLE_UITOKENSHOWCONFIG_GET_USECUSTOMITEMPACKAGETYPE_OFFSET UNITYSDK_OFFSET(0xCAAE450)
#define MOLEMOLE_UITOKENSHOWCONFIG_METHOD_1_AEC5F34E88355378_OFFSET UNITYSDK_OFFSET(0xCA7F260)
#define MOLEMOLE_UITOKENSHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCA7F240)

namespace MoleMole
{
	inline static constexpr unsigned int UITokenShowConfig_TypeDefinitionIndex = 60649;
