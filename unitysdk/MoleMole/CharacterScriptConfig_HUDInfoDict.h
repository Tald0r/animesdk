...
#define MOLEMOLE_CHARACTERSCRIPTCONFIG_HUDINFODICT__CTOR_OFFSET UNITYSDK_OFFSET(0x15E9A890)

namespace MoleMole
{
	inline static constexpr unsigned int CharacterScriptConfig_HUDInfoDict_TypeDefinitionIndex = 47308;
