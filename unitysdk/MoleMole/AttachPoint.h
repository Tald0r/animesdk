...
#define MOLEMOLE_ATTACHPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8E93900)
#define MOLEMOLE_ATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x8E938E0)

namespace MoleMole
{
	inline static constexpr unsigned int AttachPoint_TypeDefinitionIndex = 57145;
