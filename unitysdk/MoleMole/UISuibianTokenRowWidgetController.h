...
#define MOLEMOLE_UISUIBIANTOKENROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x887E790)
#define MOLEMOLE_UISUIBIANTOKENROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x887E870)
#define MOLEMOLE_UISUIBIANTOKENROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x887E8A0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTokenRowWidgetController_TypeDefinitionIndex = 58251;
