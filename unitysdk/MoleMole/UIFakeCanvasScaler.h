...
#define MOLEMOLE_UIFAKECANVASSCALER_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0xC6291A0)
#define MOLEMOLE_UIFAKECANVASSCALER_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0xC6291C0)
#define MOLEMOLE_UIFAKECANVASSCALER_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0xC629240)
#define MOLEMOLE_UIFAKECANVASSCALER__CTOR_OFFSET UNITYSDK_OFFSET(0xC629410)

namespace MoleMole
{
	inline static constexpr unsigned int UIFakeCanvasScaler_TypeDefinitionIndex = 52730;
