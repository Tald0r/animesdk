...
#define MOLEMOLE_UIQRCODE_AWAKE_OFFSET UNITYSDK_OFFSET(0xB5276E0)
#define MOLEMOLE_UIQRCODE_CREATEQRCODE_OFFSET UNITYSDK_OFFSET(0xB527F80)
#define MOLEMOLE_UIQRCODE_GENERATEQRIMAGE_OFFSET UNITYSDK_OFFSET(0xB527950)
#define MOLEMOLE_UIQRCODE_METHOD_5_5EF18AEB1B1089EF_OFFSET UNITYSDK_OFFSET(0xB528100)
#define MOLEMOLE_UIQRCODE_START_OFFSET UNITYSDK_OFFSET(0xB527870)
#define MOLEMOLE_UIQRCODE_UPDATE_OFFSET UNITYSDK_OFFSET(0xB5278D0)
#define MOLEMOLE_UIQRCODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB528330)

namespace MoleMole
{
	inline static constexpr unsigned int UIQRCode_TypeDefinitionIndex = 43339;
