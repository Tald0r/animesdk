...
#define MOLEMOLE_UIQRCODE_AWAKE_OFFSET UNITYSDK_OFFSET(0xADF0F20)
#define MOLEMOLE_UIQRCODE_CREATEQRCODE_OFFSET UNITYSDK_OFFSET(0xADF17C0)
#define MOLEMOLE_UIQRCODE_GENERATEQRIMAGE_OFFSET UNITYSDK_OFFSET(0xADF1190)
#define MOLEMOLE_UIQRCODE_METHOD_5_5EF18AEB1B1089EF_OFFSET UNITYSDK_OFFSET(0xADF1940)
#define MOLEMOLE_UIQRCODE_START_OFFSET UNITYSDK_OFFSET(0xADF10B0)
#define MOLEMOLE_UIQRCODE_UPDATE_OFFSET UNITYSDK_OFFSET(0xADF1110)
#define MOLEMOLE_UIQRCODE__CTOR_OFFSET UNITYSDK_OFFSET(0xADF1B70)

namespace MoleMole
{
	inline static constexpr unsigned int UIQRCode_TypeDefinitionIndex = 78486;
