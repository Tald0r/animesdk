...
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x68DDAE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastServePageContext_TypeDefinitionIndex = 73978;
