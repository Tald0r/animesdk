...
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDSINGLEBEHAVIOR_INITFORMCONFIG_OFFSET UNITYSDK_OFFSET(0x9918A50)
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDSINGLEBEHAVIOR_MOLEMOLE_HOLLOWCHESSBOARD_ICONFIGHOLLOWCHESSBOARDBEHAVIOR_INITFORMCONFIG_OFFSET UNITYSDK_OFFSET(0x9918C40)
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDSINGLEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9918C30)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int ConfigHollowChessboardSingleBehavior_TypeDefinitionIndex = 52642;
