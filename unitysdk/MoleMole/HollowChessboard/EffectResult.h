...
#define MOLEMOLE_HOLLOWCHESSBOARD_EFFECTRESULT_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x38D6E0)
#define MOLEMOLE_HOLLOWCHESSBOARD_EFFECTRESULT__CCTOR_OFFSET UNITYSDK_OFFSET(0xA513F60)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int EffectResult_TypeDefinitionIndex = 47466;

	struct alignas(8) EffectResult
	{
		static ::MoleMole::HollowChessboard::EffectResult* StaticGet_Empty()
		{
			return (::MoleMole::HollowChessboard::EffectResult*)Il2CppClass::FromTypeDefinitionIndex(EffectResult_TypeDefinitionIndex)->GetStaticField(0x36EE0);
		}
