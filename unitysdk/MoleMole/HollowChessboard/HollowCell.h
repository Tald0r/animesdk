...
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3B7970)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B78E0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B7980)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_ISVALIDCELL_OFFSET UNITYSDK_OFFSET(0x3B7A10)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_ADDITION_1_OFFSET UNITYSDK_OFFSET(0xB98FC80)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_ADDITION_2_OFFSET UNITYSDK_OFFSET(0xB98FEC0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0xB98FBC0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xB990020)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xB9900C0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_SUBTRACTION_1_OFFSET UNITYSDK_OFFSET(0xB98FE00)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_SUBTRACTION_2_OFFSET UNITYSDK_OFFSET(0xB98FF70)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0xB98FD40)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B7A00)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL__CCTOR_OFFSET UNITYSDK_OFFSET(0xB990460)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x37EE40)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x3B78B0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B7AA0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B7B10)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B7A20)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int HollowCell_TypeDefinitionIndex = 50784;

	struct alignas(4) HollowCell
	{
		static ::MoleMole::HollowChessboard::HollowCell* StaticGet_InvalidCell()
		{
			return (::MoleMole::HollowChessboard::HollowCell*)Il2CppClass::FromTypeDefinitionIndex(HollowCell_TypeDefinitionIndex)->GetStaticField(0x9370);
		}
		::System::Int32 x; // 0x10
		::System::Int32 y; // 0x14
		::System::Int32 z; // 0x18
