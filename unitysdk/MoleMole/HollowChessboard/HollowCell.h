...
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x574710)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_EQUALS_OFFSET UNITYSDK_OFFSET(0x574680)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x574720)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_ISVALIDCELL_OFFSET UNITYSDK_OFFSET(0x5747B0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_ADDITION_1_OFFSET UNITYSDK_OFFSET(0xF1B6140)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_ADDITION_2_OFFSET UNITYSDK_OFFSET(0xF1B6380)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0xF1B6080)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xF1B64E0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xF1B6580)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_SUBTRACTION_1_OFFSET UNITYSDK_OFFSET(0xF1B62C0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_SUBTRACTION_2_OFFSET UNITYSDK_OFFSET(0xF1B6430)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0xF1B6200)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL_TOSTRING_OFFSET UNITYSDK_OFFSET(0x5747A0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL__CCTOR_OFFSET UNITYSDK_OFFSET(0xF1B6920)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2CA8F0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x574650)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x574840)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x5748B0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCELL___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x5747C0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int HollowCell_TypeDefinitionIndex = 55109;

	struct alignas(4) HollowCell
	{
		static ::MoleMole::HollowChessboard::HollowCell* StaticGet_InvalidCell()
		{
			return (::MoleMole::HollowChessboard::HollowCell*)Il2CppClass::FromTypeDefinitionIndex(HollowCell_TypeDefinitionIndex)->GetStaticField(0x95F0);
		}
		::System::Int32 x; // 0x10
		::System::Int32 y; // 0x14
		::System::Int32 z; // 0x18
