...
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_APPLY_OFFSET UNITYSDK_OFFSET(0xE10F690)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_CLONE_OFFSET UNITYSDK_OFFSET(0xE10F5C0)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_GETVALUE_OFFSET UNITYSDK_OFFSET(0xE10F520)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xE10F4D0)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xE10F4F0)
#define MOLEMOLE_HOLLOWCHESSBOARD_VECTORPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE10F500)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int VectorPropertyData_TypeDefinitionIndex = 74813;
