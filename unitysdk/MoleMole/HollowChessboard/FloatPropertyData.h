...
#define MOLEMOLE_HOLLOWCHESSBOARD_FLOATPROPERTYDATA_APPLY_OFFSET UNITYSDK_OFFSET(0xE10EC80)
#define MOLEMOLE_HOLLOWCHESSBOARD_FLOATPROPERTYDATA_CLONE_OFFSET UNITYSDK_OFFSET(0xE10EDA0)
#define MOLEMOLE_HOLLOWCHESSBOARD_FLOATPROPERTYDATA_GETVALUE_OFFSET UNITYSDK_OFFSET(0xE10ED10)
#define MOLEMOLE_HOLLOWCHESSBOARD_FLOATPROPERTYDATA_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xE10EC40)
#define MOLEMOLE_HOLLOWCHESSBOARD_FLOATPROPERTYDATA_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xE10EC50)
#define MOLEMOLE_HOLLOWCHESSBOARD_FLOATPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE10EC60)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int FloatPropertyData_TypeDefinitionIndex = 50722;
