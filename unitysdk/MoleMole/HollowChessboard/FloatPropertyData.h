...
#define MOLEMOLE_HOLLOWCHESSBOARD_FLOATPROPERTYDATA_APPLY_OFFSET UNITYSDK_OFFSET(0x7A736E0)
#define MOLEMOLE_HOLLOWCHESSBOARD_FLOATPROPERTYDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x7A73800)
#define MOLEMOLE_HOLLOWCHESSBOARD_FLOATPROPERTYDATA_GETVALUE_OFFSET UNITYSDK_OFFSET(0x7A73770)
#define MOLEMOLE_HOLLOWCHESSBOARD_FLOATPROPERTYDATA_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x7A736A0)
#define MOLEMOLE_HOLLOWCHESSBOARD_FLOATPROPERTYDATA_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x7A736B0)
#define MOLEMOLE_HOLLOWCHESSBOARD_FLOATPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x7A736C0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int FloatPropertyData_TypeDefinitionIndex = 68278;
