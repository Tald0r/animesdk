...
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_CHECKBIT_OFFSET UNITYSDK_OFFSET(0x319960)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x319A40)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_EQUALS_OFFSET UNITYSDK_OFFSET(0x3199D0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x319A50)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x6E959E0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x6E95AA0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_SETBIT_OFFSET UNITYSDK_OFFSET(0x3198D0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x319AC0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x319B20)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int RangeMask_TypeDefinitionIndex = 57415;
