...
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_CHECKBIT_OFFSET UNITYSDK_OFFSET(0x3106C0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3107A0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_EQUALS_OFFSET UNITYSDK_OFFSET(0x310730)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3107B0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x6E294A0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x6E29560)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK_SETBIT_OFFSET UNITYSDK_OFFSET(0x310630)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x310820)
#define MOLEMOLE_HOLLOWCHESSBOARD_RANGEMASK___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x310880)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int RangeMask_TypeDefinitionIndex = 77235;
