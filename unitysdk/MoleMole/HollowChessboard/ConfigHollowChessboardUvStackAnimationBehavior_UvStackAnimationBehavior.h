...
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDUVSTACKANIMATIONBEHAVIOR_UVSTACKANIMATIONBEHAVIOR_BUILD_OFFSET UNITYSDK_OFFSET(0x7F0F8A0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDUVSTACKANIMATIONBEHAVIOR_UVSTACKANIMATIONBEHAVIOR_TRYADDBLACKBOARDITEM_OFFSET UNITYSDK_OFFSET(0x7F0F950)
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDUVSTACKANIMATIONBEHAVIOR_UVSTACKANIMATIONBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x7F0F890)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int ConfigHollowChessboardUvStackAnimationBehavior_UvStackAnimationBehavior_TypeDefinitionIndex = 68238;
