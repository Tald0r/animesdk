...
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCHESSBOARDEFFECTEVENTBASE_GET_CUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0xA513FA0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCHESSBOARDEFFECTEVENTBASE_SET_CUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0xA513FB0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWCHESSBOARDEFFECTEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xA513FC0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int HollowChessboardEffectEventBase_TypeDefinitionIndex = 60700;
