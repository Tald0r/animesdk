...
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG_SCREENDYNAMICBUILDSECTIONCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xB19BB00)
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG_SCREENDYNAMICBUILDSECTIONCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xB19BB10)
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG_SCREENDYNAMICBUILDSECTIONCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xB19BC60)
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG_SCREENDYNAMICBUILDSECTIONCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xB19BDC0)
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG_SCREENDYNAMICBUILDSECTIONCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB19BD80)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int ScreenDynamicBuildSectionConfig_ScreenDynamicBuildSectionConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 69187;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::HollowChessboard::ScreenDynamicBuildSectionHelperType>**)Il2CppClass::FromTypeDefinitionIndex(ScreenDynamicBuildSectionConfig_ScreenDynamicBuildSectionConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3D400);
		}
