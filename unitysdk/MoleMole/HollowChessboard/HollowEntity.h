...
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F6780)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int HollowEntity_TypeDefinitionIndex = 45908;
