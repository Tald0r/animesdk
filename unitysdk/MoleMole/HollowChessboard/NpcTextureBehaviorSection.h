...
#define MOLEMOLE_HOLLOWCHESSBOARD_NPCTEXTUREBEHAVIORSECTION_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0xE486D40)
#define MOLEMOLE_HOLLOWCHESSBOARD_NPCTEXTUREBEHAVIORSECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0xE486E00)
#define MOLEMOLE_HOLLOWCHESSBOARD_NPCTEXTUREBEHAVIORSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xE486DF0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int NpcTextureBehaviorSection_TypeDefinitionIndex = 59697;
	...
	public:
		...
		{
			return (::MoleMole::HollowChessboard::RenderSequenceSectionType*)Il2CppClass::FromTypeDefinitionIndex(NpcTextureBehaviorSection_TypeDefinitionIndex)->GetStaticField(0xF2D0);
		}
