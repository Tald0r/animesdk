...
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3A86C0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A85E0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3A86D0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_GETLINETYPE_OFFSET UNITYSDK_OFFSET(0x3A84D0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO_ISVALID_OFFSET UNITYSDK_OFFSET(0x3A8550)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3A8780)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_LINEINFO___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3A87F0)

namespace MoleMole::HollowChessboard::ChessboardView
{
	inline static constexpr unsigned int LineInfo_TypeDefinitionIndex = 73047;
