...
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0xB19AA70)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_ONONCEFINISH_OFFSET UNITYSDK_OFFSET(0xB19B1E0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_RUN_OFFSET UNITYSDK_OFFSET(0xB19AB60)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_SEARCHINNEEDCHANGE_OFFSET UNITYSDK_OFFSET(0xB19AA80)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_SETNEEDCHANGE_OFFSET UNITYSDK_OFFSET(0xB19B170)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xB19B260)

namespace MoleMole::HollowChessboard::ChessboardView
{
	inline static constexpr unsigned int ChessPieceLocalMoveEffect_TypeDefinitionIndex = 61773;
	...
	public:
		...
		::MoleMole::Config::ConfigHollowChessboard_PieceChangeStructConfig* Config; // 0x38
		::System::Boolean ForceCloseMultipleDisplay; // 0x40
		::System::Boolean ModifyHollowRenderWorld; // 0x41
		::System::Boolean DoAllPiece; // 0x42
