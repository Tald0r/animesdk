...
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x8B15BE0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_ONONCEFINISH_OFFSET UNITYSDK_OFFSET(0x8B16340)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_RUN_OFFSET UNITYSDK_OFFSET(0x8B15CD0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_SEARCHINNEEDCHANGE_OFFSET UNITYSDK_OFFSET(0x8B15BF0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT_SETNEEDCHANGE_OFFSET UNITYSDK_OFFSET(0x8B162D0)
#define MOLEMOLE_HOLLOWCHESSBOARD_CHESSBOARDVIEW_CHESSPIECELOCALMOVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x8B163C0)

namespace MoleMole::HollowChessboard::ChessboardView
{
	inline static constexpr unsigned int ChessPieceLocalMoveEffect_TypeDefinitionIndex = 59031;
