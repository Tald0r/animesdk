...
#define MOLEMOLE_HOLLOWCHESSBOARD_EFFECTROLETABLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB83B5B0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int EffectRoleTableConfig_TypeDefinitionIndex = 80279;
