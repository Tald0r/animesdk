...
#define MOLEMOLE_HOLLOWCHESSBOARD_EFFECTROLETABLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC224E10)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int EffectRoleTableConfig_TypeDefinitionIndex = 39601;
