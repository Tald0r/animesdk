...
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERTRACKBASE_GETALLSECTIONS_OFFSET UNITYSDK_OFFSET(0x6E29740)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERTRACKBASE_GETBINDEVENTS_OFFSET UNITYSDK_OFFSET(0x6E298F0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERTRACKBASE_GETCONDITIONSBYINDEX_OFFSET UNITYSDK_OFFSET(0x6E29DB0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERTRACKBASE_GETSECTIONBYINDEX_OFFSET UNITYSDK_OFFSET(0x6E297B0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERTRACKBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E2A210)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int RenderTrackBase_TypeDefinitionIndex = 49100;
	...
	public:
		...
		::System::Collections::Generic::IReadOnlyList_1<::Class_0_16E4307DCC419505_467*>* GetAllSections()
		{
			return ((::System::Collections::Generic::IReadOnlyList_1<::Class_0_16E4307DCC419505_467*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_HOLLOWCHESSBOARD_RENDERTRACKBASE_GETALLSECTIONS_OFFSET))(this);
		}

		::Class_0_16E4307DCC419505_467* GetSectionByIndex(::System::Int32 index)
		{
			return ((::Class_0_16E4307DCC419505_467*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_HOLLOWCHESSBOARD_RENDERTRACKBASE_GETSECTIONBYINDEX_OFFSET))(this, index);
		}
