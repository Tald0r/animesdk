...
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERSEQUENCEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x82DE2F0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int RenderSequenceBase_TypeDefinitionIndex = 49728;
