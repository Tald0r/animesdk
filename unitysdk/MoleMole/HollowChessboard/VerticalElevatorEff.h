...
#define MOLEMOLE_HOLLOWCHESSBOARD_VERTICALELEVATOREFF_METHOD_5_63CFAA60FA3D87ED_OFFSET UNITYSDK_OFFSET(0xB83BC80)
#define MOLEMOLE_HOLLOWCHESSBOARD_VERTICALELEVATOREFF_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB83BEA0)
#define MOLEMOLE_HOLLOWCHESSBOARD_VERTICALELEVATOREFF_METHOD_5_DAEB67F34AF80609_OFFSET UNITYSDK_OFFSET(0xB83BF10)
#define MOLEMOLE_HOLLOWCHESSBOARD_VERTICALELEVATOREFF_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB83BD90)
#define MOLEMOLE_HOLLOWCHESSBOARD_VERTICALELEVATOREFF_REBUILD_OFFSET UNITYSDK_OFFSET(0xB83B630)
#define MOLEMOLE_HOLLOWCHESSBOARD_VERTICALELEVATOREFF__CTOR_OFFSET UNITYSDK_OFFSET(0xB83BE30)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int VerticalElevatorEff_TypeDefinitionIndex = 47398;
