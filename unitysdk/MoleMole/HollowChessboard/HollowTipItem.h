...
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWTIPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D3AC0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int HollowTipItem_TypeDefinitionIndex = 49012;
