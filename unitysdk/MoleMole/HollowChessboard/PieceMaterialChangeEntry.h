...
#define MOLEMOLE_HOLLOWCHESSBOARD_PIECEMATERIALCHANGEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x6E29220)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int PieceMaterialChangeEntry_TypeDefinitionIndex = 55425;
