...
#define MOLEMOLE_HOLLOWCHESSBOARD_EFFECTROLEENTRYCONFIG_CREATEEFFECTROLEENTRY_OFFSET UNITYSDK_OFFSET(0xC2D40C0)
#define MOLEMOLE_HOLLOWCHESSBOARD_EFFECTROLEENTRYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC2D4380)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int EffectRoleEntryConfig_TypeDefinitionIndex = 74059;
