...
#define MOLEMOLE_HOLLOWCHESSBOARD_PIECEMATERIALSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xC2D4590)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int PieceMaterialSetting_TypeDefinitionIndex = 74203;
