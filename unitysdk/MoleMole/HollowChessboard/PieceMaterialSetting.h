...
#define MOLEMOLE_HOLLOWCHESSBOARD_PIECEMATERIALSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xB8B04E0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int PieceMaterialSetting_TypeDefinitionIndex = 60217;
