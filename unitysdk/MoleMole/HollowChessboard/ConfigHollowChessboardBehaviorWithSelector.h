...
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDBEHAVIORWITHSELECTOR_INITFORMCONFIG_OFFSET UNITYSDK_OFFSET(0xA5F5E60)
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDBEHAVIORWITHSELECTOR_MOLEMOLE_HOLLOWCHESSBOARD_ICONFIGHOLLOWCHESSBOARDBEHAVIOR_INITFORMCONFIG_OFFSET UNITYSDK_OFFSET(0xA5F6160)
#define MOLEMOLE_HOLLOWCHESSBOARD_CONFIGHOLLOWCHESSBOARDBEHAVIORWITHSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F6150)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int ConfigHollowChessboardBehaviorWithSelector_TypeDefinitionIndex = 42742;
