...
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x3B88E0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3B8970)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B8850)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B86B0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_GETRENDERSTATUES_OFFSET UNITYSDK_OFFSET(0x3B87D0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x302230)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_GET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_ISSET_OFFSET UNITYSDK_OFFSET(0x3B8750)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x3B87C0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xBA196E0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xBA197E0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0xBA198D0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3B86A0)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x3B8630)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B8980)
#define MOLEMOLE_HOLLOWCHESSBOARD_RENDERDATAHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B89F0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int RenderDataHandle_TypeDefinitionIndex = 56379;

	struct alignas(8) RenderDataHandle
	{
		static ::MoleMole::HollowChessboard::RenderDataHandle* StaticGet_Default()
		{
			return (::MoleMole::HollowChessboard::RenderDataHandle*)Il2CppClass::FromTypeDefinitionIndex(RenderDataHandle_TypeDefinitionIndex)->GetStaticField(0x2D1D0);
		}
