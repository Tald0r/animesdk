...
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x6E96760)
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x6E967D0)
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6E967C0)
#define MOLEMOLE_HOLLOWCHESSBOARD_SCREENDYNAMICBUILDSECTIONCONFIG___BASE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x6E96810)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int ScreenDynamicBuildSectionConfig_TypeDefinitionIndex = 69186;
	...
	public:
		...
		{
			return (::MoleMole::HollowChessboard::RenderSequenceSectionType*)Il2CppClass::FromTypeDefinitionIndex(ScreenDynamicBuildSectionConfig_TypeDefinitionIndex)->GetStaticField(0x10AD0);
		}
