...
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWENTITYMOVECOMPONENT_MOVECMD_FROMGRIDDIR_OFFSET UNITYSDK_OFFSET(0xA398660)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWENTITYMOVECOMPONENT_MOVECMD_GETTARGETINDEX_OFFSET UNITYSDK_OFFSET(0x38AD00)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWENTITYMOVECOMPONENT_MOVECMD_GET_GRIDDIR_OFFSET UNITYSDK_OFFSET(0x38AD30)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWENTITYMOVECOMPONENT_MOVECMD_ISDIRMOVE_OFFSET UNITYSDK_OFFSET(0x38ACE0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWENTITYMOVECOMPONENT_MOVECMD_TOGRIDDIR_OFFSET UNITYSDK_OFFSET(0xA380DC0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWENTITYMOVECOMPONENT_MOVECMD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x38ACF0)
#define MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWENTITYMOVECOMPONENT_MOVECMD___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x38ADA0)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int HollowEntityMoveComponent_MoveCmd_TypeDefinitionIndex = 49793;
	...
	struct alignas(4) HollowEntityMoveComponent_MoveCmd
	{
		...
		::MoleMole::HollowChessboard::HollowCell GetTargetIndex(::MoleMole::HollowChessboard::HollowCell currentIndex, ::Class_0_16E4307DCC419505_142* chessboard)
		{
			return ((::MoleMole::HollowChessboard::HollowCell(*)(::PVOID, ::MoleMole::HollowChessboard::HollowCell, ::Class_0_16E4307DCC419505_142*))((::PBYTE)hIl2Cpp + MOLEMOLE_HOLLOWCHESSBOARD_HOLLOWENTITYMOVECOMPONENT_MOVECMD_GETTARGETINDEX_OFFSET))(this, currentIndex, chessboard);
		}
