...
#define MOLEMOLE_HOLLOWCHESSBOARD_PARTICLESECTION_PARTICLESECTION_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x82DDFC0)
#define MOLEMOLE_HOLLOWCHESSBOARD_PARTICLESECTION_PARTICLESECTION_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x82DDFD0)
#define MOLEMOLE_HOLLOWCHESSBOARD_PARTICLESECTION_PARTICLESECTION_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x82DE120)
#define MOLEMOLE_HOLLOWCHESSBOARD_PARTICLESECTION_PARTICLESECTION_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x82DE280)
#define MOLEMOLE_HOLLOWCHESSBOARD_PARTICLESECTION_PARTICLESECTION_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x82DE240)

namespace MoleMole::HollowChessboard
{
	inline static constexpr unsigned int ParticleSection_ParticleSection_UnityGeneratedFormatter_TypeDefinitionIndex = 63619;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::HollowChessboard::ParticleSection_Config*>**)Il2CppClass::FromTypeDefinitionIndex(ParticleSection_ParticleSection_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3C130);
		}
