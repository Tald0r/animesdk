...
#define MOLEMOLE_CONFIGUIMAINCITY_ONGOINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xF18B1D0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainCity_OngoingConfig_TypeDefinitionIndex = 45763;
