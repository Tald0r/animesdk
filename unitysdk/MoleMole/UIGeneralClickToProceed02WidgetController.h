...
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA297520)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA2975C0)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER_SETURL_OFFSET UNITYSDK_OFFSET(0xA2976A0)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA2978A0)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA2978D0)
#define MOLEMOLE_UIGENERALCLICKTOPROCEED02WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA297940)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralClickToProceed02WidgetController_TypeDefinitionIndex = 63215;
