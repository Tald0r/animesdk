...
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER_ISCOLLECT_OFFSET UNITYSDK_OFFSET(0xC0A1E50)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0xC0A2190)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0A18C0)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xC0A23E0)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC0A1960)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0xC0A1FC0)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0A24C0)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0A24D0)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xC0A2540)
#define MOLEMOLE_UIBANGBOOUAVCARDITEMROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC0A25B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooUAVCardItemRowWidgetController_TypeDefinitionIndex = 61855;
	...
	public:
		...
		::Class_2_208CC9941471731A_138* m_cfg; // 0x2D8
