...
#define MOLEMOLE_UIBPPURCHASEDIALOGV2POPWINDOWCONTROLLER___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD017580)
#define MOLEMOLE_UIBPPURCHASEDIALOGV2POPWINDOWCONTROLLER___C__DISPLAYCLASS4_0__SHOWNONEPURCHASEBPSHOP_B__0_OFFSET UNITYSDK_OFFSET(0xD017590)
#define MOLEMOLE_UIBPPURCHASEDIALOGV2POPWINDOWCONTROLLER___C__DISPLAYCLASS4_0__SHOWNONEPURCHASEBPSHOP_B__1_OFFSET UNITYSDK_OFFSET(0xD017650)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPPurchaseDialogV2PopWindowController___c__DisplayClass4_0_TypeDefinitionIndex = 68951;
	...
	public:
		...
		::Class_2_222A145CFB71510C* battlePassModel; // 0x28
