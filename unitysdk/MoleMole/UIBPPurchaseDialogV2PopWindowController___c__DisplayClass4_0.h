...
#define MOLEMOLE_UIBPPURCHASEDIALOGV2POPWINDOWCONTROLLER___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC0ADAA0)
#define MOLEMOLE_UIBPPURCHASEDIALOGV2POPWINDOWCONTROLLER___C__DISPLAYCLASS4_0__SHOWNONEPURCHASEBPSHOP_B__0_OFFSET UNITYSDK_OFFSET(0xC0ADAB0)
#define MOLEMOLE_UIBPPURCHASEDIALOGV2POPWINDOWCONTROLLER___C__DISPLAYCLASS4_0__SHOWNONEPURCHASEBPSHOP_B__1_OFFSET UNITYSDK_OFFSET(0xC0ADB70)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPPurchaseDialogV2PopWindowController___c__DisplayClass4_0_TypeDefinitionIndex = 76439;
