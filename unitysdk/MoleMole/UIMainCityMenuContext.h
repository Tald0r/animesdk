...
#define MOLEMOLE_UIMAINCITYMENUCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9E77CB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMenuContext_TypeDefinitionIndex = 60219;
