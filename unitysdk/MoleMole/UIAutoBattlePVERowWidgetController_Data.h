...
#define MOLEMOLE_UIAUTOBATTLEPVEROWWIDGETCONTROLLER_DATA_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0xC8F5CF0)
#define MOLEMOLE_UIAUTOBATTLEPVEROWWIDGETCONTROLLER_DATA_GET_STATE_OFFSET UNITYSDK_OFFSET(0xC8F5A40)
#define MOLEMOLE_UIAUTOBATTLEPVEROWWIDGETCONTROLLER_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC8F5D30)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattlePVERowWidgetController_Data_TypeDefinitionIndex = 42099;

	class UIAutoBattlePVERowWidgetController_Data : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_111* Template; // 0x10
