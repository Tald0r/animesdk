...
#define MOLEMOLE_UIAUTOBATTLEPVEROWWIDGETCONTROLLER_DATA_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x98A1220)
#define MOLEMOLE_UIAUTOBATTLEPVEROWWIDGETCONTROLLER_DATA_GET_STATE_OFFSET UNITYSDK_OFFSET(0x98A0F70)
#define MOLEMOLE_UIAUTOBATTLEPVEROWWIDGETCONTROLLER_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0x98A1260)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattlePVERowWidgetController_Data_TypeDefinitionIndex = 63989;

	class UIAutoBattlePVERowWidgetController_Data : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_524* Template; // 0x10
