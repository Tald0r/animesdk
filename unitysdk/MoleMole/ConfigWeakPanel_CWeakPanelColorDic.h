...
#define MOLEMOLE_CONFIGWEAKPANEL_CWEAKPANELCOLORDIC__CTOR_OFFSET UNITYSDK_OFFSET(0xCD33A40)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigWeakPanel_CWeakPanelColorDic_TypeDefinitionIndex = 60895;
