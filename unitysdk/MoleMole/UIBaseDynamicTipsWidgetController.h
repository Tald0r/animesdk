...
#define MOLEMOLE_UIBASEDYNAMICTIPSWIDGETCONTROLLER_CLOSEPARENT_OFFSET UNITYSDK_OFFSET(0x8BB82C0)
#define MOLEMOLE_UIBASEDYNAMICTIPSWIDGETCONTROLLER_GETLOCATETRANSFORM_OFFSET UNITYSDK_OFFSET(0x8BB8420)
#define MOLEMOLE_UIBASEDYNAMICTIPSWIDGETCONTROLLER_GET_ENABLEPOSITIONTICK_OFFSET UNITYSDK_OFFSET(0x8BB8160)
#define MOLEMOLE_UIBASEDYNAMICTIPSWIDGETCONTROLLER_GET_ISCLICKMASKTOCLOSE_OFFSET UNITYSDK_OFFSET(0x8BB8140)
#define MOLEMOLE_UIBASEDYNAMICTIPSWIDGETCONTROLLER_GET_POSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x8BB8150)
#define MOLEMOLE_UIBASEDYNAMICTIPSWIDGETCONTROLLER_ONREFRESHWIDGETROOTPOSITION_OFFSET UNITYSDK_OFFSET(0x8BB8480)
#define MOLEMOLE_UIBASEDYNAMICTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BB8250)
#define MOLEMOLE_UIBASEDYNAMICTIPSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BB8170)
#define MOLEMOLE_UIBASEDYNAMICTIPSWIDGETCONTROLLER_SETPARENTCTRL_OFFSET UNITYSDK_OFFSET(0x8BB83B0)
#define MOLEMOLE_UIBASEDYNAMICTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8BB84E0)
#define MOLEMOLE_UIBASEDYNAMICTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BB8510)
#define MOLEMOLE_UIBASEDYNAMICTIPSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BB8590)

namespace MoleMole
{
	inline static constexpr unsigned int UIBaseDynamicTipsWidgetController_TypeDefinitionIndex = 74410;
