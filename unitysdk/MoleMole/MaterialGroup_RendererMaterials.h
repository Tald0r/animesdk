...
#define MOLEMOLE_MATERIALGROUP_RENDERERMATERIALS_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0xC9D61A0)
#define MOLEMOLE_MATERIALGROUP_RENDERERMATERIALS_GET_SHADEDMATERIALS_OFFSET UNITYSDK_OFFSET(0xC9D64C0)
#define MOLEMOLE_MATERIALGROUP_RENDERERMATERIALS_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0xC9D6A00)
#define MOLEMOLE_MATERIALGROUP_RENDERERMATERIALS_METHOD_1_D339EFAB24ED44B0_OFFSET UNITYSDK_OFFSET(0xC9D6650)
#define MOLEMOLE_MATERIALGROUP_RENDERERMATERIALS_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC9D6560)
#define MOLEMOLE_MATERIALGROUP_RENDERERMATERIALS__CCTOR_OFFSET UNITYSDK_OFFSET(0xC9D6620)
#define MOLEMOLE_MATERIALGROUP_RENDERERMATERIALS__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D65E0)

namespace MoleMole
{
	inline static constexpr unsigned int MaterialGroup_RendererMaterials_TypeDefinitionIndex = 75239;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialGroup_RendererMaterials_TypeDefinitionIndex)->GetStaticField(0x2C870);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MATERIALGROUP_RENDERERMATERIALS_METHOD_1_D339EFAB24ED44B0_OFFSET))(this);
		}
