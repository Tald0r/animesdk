...
#define MOLEMOLE_LANGUAGETEXTSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD0E6BA0)

namespace MoleMole
{
	inline static constexpr unsigned int LanguageTextSettingContext_TypeDefinitionIndex = 62493;
