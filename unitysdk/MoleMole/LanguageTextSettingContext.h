...
#define MOLEMOLE_LANGUAGETEXTSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8F86610)

namespace MoleMole
{
	inline static constexpr unsigned int LanguageTextSettingContext_TypeDefinitionIndex = 58849;
