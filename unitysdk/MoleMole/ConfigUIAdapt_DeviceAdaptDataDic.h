...
#define MOLEMOLE_CONFIGUIADAPT_DEVICEADAPTDATADIC__CTOR_OFFSET UNITYSDK_OFFSET(0xEC6B1E0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAdapt_DeviceAdaptDataDic_TypeDefinitionIndex = 51532;
