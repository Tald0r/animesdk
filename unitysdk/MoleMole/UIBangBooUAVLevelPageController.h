...
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ADDDAYWIDGET_OFFSET UNITYSDK_OFFSET(0xBF3A610)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_DATALISTSELECT_OFFSET UNITYSDK_OFFSET(0xBF3B410)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETCANEQUIPCOUNT_OFFSET UNITYSDK_OFFSET(0xBF3A940)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETENTRYLIST_OFFSET UNITYSDK_OFFSET(0xBF38A90)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETINITSELECTOR_OFFSET UNITYSDK_OFFSET(0xBF389E0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETLEVELTABCONTROLLER_OFFSET UNITYSDK_OFFSET(0xBF3A1A0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETREWARDLIST_OFFSET UNITYSDK_OFFSET(0xBF38D40)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GET_CURRENTQUEST_OFFSET UNITYSDK_OFFSET(0xBF37C20)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_HIDERECORD_OFFSET UNITYSDK_OFFSET(0xBF3A070)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_INITEQUIPLIST_OFFSET UNITYSDK_OFFSET(0xBF39720)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ISUNLOCKENTRY_OFFSET UNITYSDK_OFFSET(0xBF381F0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF37C40)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONSTART_OFFSET UNITYSDK_OFFSET(0xBF38550)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF3A6B0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF37D80)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF3A260)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHDATADETAIL_OFFSET UNITYSDK_OFFSET(0xBF3AFB0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0xBF38EE0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHLEVELLIST_OFFSET UNITYSDK_OFFSET(0xBF3B940)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHQUEST_OFFSET UNITYSDK_OFFSET(0xBF39C90)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHTIME_OFFSET UNITYSDK_OFFSET(0xBF399B0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_SET_CURRENTQUEST_OFFSET UNITYSDK_OFFSET(0xBF37C30)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_SHOWTIPSASYNC_OFFSET UNITYSDK_OFFSET(0xBF3A3E0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_TRYSHOWLEVELCHANGEDTIPSASYNC_OFFSET UNITYSDK_OFFSET(0xBF3A4A0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_TRYSHOWNEWEQUIPTIPSASYNC_OFFSET UNITYSDK_OFFSET(0xBF3A560)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_TRYTRIGGERNEWBIEASYNC_OFFSET UNITYSDK_OFFSET(0xBF3AD00)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF3C980)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__DATALISTSELECT_G__SETEQUIPID_33_0_OFFSET UNITYSDK_OFFSET(0xBF3B8F0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__INITEQUIPLIST_G__SETEQUIPDATA_30_0_OFFSET UNITYSDK_OFFSET(0xBF3AB00)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__REFRESHDATADETAIL_B__32_1_OFFSET UNITYSDK_OFFSET(0xBF3CAF0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__REFRESHDATADETAIL_G__SETEQUIP_32_0_OFFSET UNITYSDK_OFFSET(0xBF3B0B0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ADDDAYWIDGET_OFFSET UNITYSDK_OFFSET(0xBF3D170)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_DATALISTSELECT_OFFSET UNITYSDK_OFFSET(0xBF3D210)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETENTRYLIST_OFFSET UNITYSDK_OFFSET(0xBF3D220)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETINITSELECTOR_OFFSET UNITYSDK_OFFSET(0xBF3D230)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETLEVELTABCONTROLLER_OFFSET UNITYSDK_OFFSET(0xBF3D240)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETREWARDLIST_OFFSET UNITYSDK_OFFSET(0xBF3D250)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ISUNLOCKENTRY_OFFSET UNITYSDK_OFFSET(0xBF3D260)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF3D2E0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0xBF3D380)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF3D390)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF3D3A0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF3D3B0)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_REFRESHDATADETAIL_OFFSET UNITYSDK_OFFSET(0xBF3D420)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0xBF3D430)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_REFRESHLEVELLIST_OFFSET UNITYSDK_OFFSET(0xBF3D440)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVLevelPageController_TypeDefinitionIndex = 40624;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E>* equipList; // 0x380
		...
		::Class_0_16E4307DCC419505_235* GetInitSelector()
		{
			return ((::Class_0_16E4307DCC419505_235*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_GETINITSELECTOR_OFFSET))(this);
		}
		...
		::System::Void RefreshDetail(::Class_1_7807B2B04302CD7B_5* data)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7807B2B04302CD7B_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER_REFRESHDETAIL_OFFSET))(this, data);
		}
		...
		::Class_0_16E4307DCC419505_235* __base_GetInitSelector()
		{
			return ((::Class_0_16E4307DCC419505_235*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_GETINITSELECTOR_OFFSET))(this);
		}
		...
		::System::Void __base_RefreshDetail(::Class_1_7807B2B04302CD7B_5* P0)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7807B2B04302CD7B_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER___BASE_REFRESHDETAIL_OFFSET))(this, P0);
		}
