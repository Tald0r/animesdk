...
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_ONCLICKACTION_OFFSET UNITYSDK_OFFSET(0xC297280)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC297390)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC297430)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC296CA0)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC296F10)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_REFRESHVIEWBYCONTEXT_OFFSET UNITYSDK_OFFSET(0xC2970B0)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC297150)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_SETCHECKSTATE_OFFSET UNITYSDK_OFFSET(0xC2971F0)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xC296E80)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC297510)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC297540)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC2975B0)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC297630)
#define MOLEMOLE_UICAMPIDLECHOICEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC297690)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdleChoiceWidgetController_TypeDefinitionIndex = 45878;

	class UICampIdleChoiceWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_46B1304F31463D00_1* _view; // 0x2A0
		::System::Boolean m_isStoryQA; // 0x2A8
		::System::Boolean m_isCorrectAnswer; // 0x2A9
		::MoleMole::UICampIdleChoiceWidgetControllerContext* m_ctx; // 0x2B0
		::System::Action* m_onclickAction; // 0x2B8
