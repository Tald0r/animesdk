...
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_GETREWARD_OFFSET UNITYSDK_OFFSET(0xBFACFE0)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_GET__ROOTACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0xBFACFC0)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFAC820)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFAC8C0)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFAC660)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFAC700)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBFAC9A0)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFAD050)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFAD0F0)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFAD160)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFAD1E0)
#define MOLEMOLE_UIACTIVITYWATERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFAD240)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityWaterWidgetController_TypeDefinitionIndex = 47694;
