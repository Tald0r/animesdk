...
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOTIPINFO_MARK_OFFSET UNITYSDK_OFFSET(0x31FD50)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOTIPINFO_ONFINISH_OFFSET UNITYSDK_OFFSET(0x31FD60)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOTIPINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x71F6C40)
#define MOLEMOLE_VOPERFORMSUBSYSTEM_VOTIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x31FCA0)

namespace MoleMole
{
	inline static constexpr unsigned int VOPerformSubSystem_VoTipInfo_TypeDefinitionIndex = 62433;

	struct alignas(8) VOPerformSubSystem_VoTipInfo
	{
		static ::System::Int32* StaticGet_ID_Gen()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(VOPerformSubSystem_VoTipInfo_TypeDefinitionIndex)->GetStaticField(0x11750);
		}
