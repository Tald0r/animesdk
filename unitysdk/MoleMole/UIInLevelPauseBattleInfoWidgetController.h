...
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_GETBINDMODULES_OFFSET UNITYSDK_OFFSET(0x89407F0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_GETNESTEDLISTDELEGATEGOLIST_OFFSET UNITYSDK_OFFSET(0x8940850)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_GETSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x89429C0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x893E240)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x893E0F0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONCREATREWARDITEM_OFFSET UNITYSDK_OFFSET(0x8940590)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x893E7B0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x893E820)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x893E190)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x893E700)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHACTCHALLENGELIST_OFFSET UNITYSDK_OFFSET(0x8940D70)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHACTVIEW_OFFSET UNITYSDK_OFFSET(0x8940670)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHCHESSBOARDVIEW_OFFSET UNITYSDK_OFFSET(0x893E900)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHCONSOLE_OFFSET UNITYSDK_OFFSET(0x89408B0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x8940D10)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHLEVELQUESTSVIEW_OFFSET UNITYSDK_OFFSET(0x8943510)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x8940C10)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHSHOWREWARDLIST_OFFSET UNITYSDK_OFFSET(0x89421F0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_REFRESHTITLEAREA_OFFSET UNITYSDK_OFFSET(0x8942CD0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER_UPDATEREWARDITEM_OFFSET UNITYSDK_OFFSET(0x8942E80)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8943840)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x89438E0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x89439B0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x89439C0)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8943950)
#define MOLEMOLE_UIINLEVELPAUSEBATTLEINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8943A40)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBattleInfoWidgetController_TypeDefinitionIndex = 46636;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_76* _view; // 0x2A8
