...
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__INITSWITCHAVATARCOMPONENT_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x340900)
#define MOLEMOLE_UIINLEVELSWITCHBTNPANELCHILDWINDOWCONTROLLER__INITSWITCHAVATARCOMPONENT_D__25_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelSwitchBtnPanelChildWindowController__InitSwitchAvatarComponent_d__25_TypeDefinitionIndex = 48350;
