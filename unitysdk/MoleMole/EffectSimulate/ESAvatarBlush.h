...
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0xB48CD00)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xB48BF20)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_3AD73BE4DC8A1A17_OFFSET UNITYSDK_OFFSET(0xB48C4F0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_3E4DAEC21EB746AE_OFFSET UNITYSDK_OFFSET(0xB48C080)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB48C820)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_4FB5F56430673EA6_OFFSET UNITYSDK_OFFSET(0xB48C120)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_581A5078A2F29034_OFFSET UNITYSDK_OFFSET(0xB48CA00)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_681E224EC188A7D5_OFFSET UNITYSDK_OFFSET(0xB48CA10)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_6F54E34F52AB60F6_OFFSET UNITYSDK_OFFSET(0xB48BB20)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_755870B55A8B3AFF_OFFSET UNITYSDK_OFFSET(0xB48C730)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_88B60F3B95FAA4F1_1_OFFSET UNITYSDK_OFFSET(0xB48BFF0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_88B60F3B95FAA4F1_2_OFFSET UNITYSDK_OFFSET(0xB48CBD0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_88B60F3B95FAA4F1_3_OFFSET UNITYSDK_OFFSET(0xB48CF10)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0xB48BE90)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_9441529D4B4B549D_OFFSET UNITYSDK_OFFSET(0xB48CEA0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_9F8EF6EE79B16064_OFFSET UNITYSDK_OFFSET(0xB48CC70)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_B8746CF4034D9E80_OFFSET UNITYSDK_OFFSET(0xB48BD10)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_BB26D4750A632557_OFFSET UNITYSDK_OFFSET(0xB48CA90)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_C694CB4958A79AC7_OFFSET UNITYSDK_OFFSET(0xB48C200)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB48CDC0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB48CD60)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_DA1BF2C227DC3D86_1_OFFSET UNITYSDK_OFFSET(0xB48CFA0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0xB48BF80)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_EEA73B6010018ADD_1_OFFSET UNITYSDK_OFFSET(0xB48C9A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_EEA73B6010018ADD_OFFSET UNITYSDK_OFFSET(0xB48C1A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_F91B8892FC7A8C48_OFFSET UNITYSDK_OFFSET(0xB48CE20)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_FCAE2431182375FA_OFFSET UNITYSDK_OFFSET(0xB48CC60)
#define MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH__CTOR_OFFSET UNITYSDK_OFFSET(0xB48C8C0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAvatarBlush_TypeDefinitionIndex = 40891;
	...
	public:
		...
		{
			return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_581A5078A2F29034_OFFSET))(this);
		}
		...
		{
			return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAVATARBLUSH_METHOD_4_DA1BF2C227DC3D86_1_OFFSET))(this);
		}
	};
}
