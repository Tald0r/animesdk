...
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITTRANSFORMBEHAVIOR_GET_RANDOMVAL_OFFSET UNITYSDK_OFFSET(0x8200D80)
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITTRANSFORMBEHAVIOR_METHOD_3_FA662896843C137A_OFFSET UNITYSDK_OFFSET(0x8200DD0)
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITTRANSFORMBEHAVIOR_SET_RANDOMVAL_OFFSET UNITYSDK_OFFSET(0x8200DA0)
#define MOLEMOLE_EFFECTSIMULATE_ESEMPTYNODEINITTRANSFORMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x8200DB0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESEmptyNodeInitTransformBehavior_TypeDefinitionIndex = 47461;
