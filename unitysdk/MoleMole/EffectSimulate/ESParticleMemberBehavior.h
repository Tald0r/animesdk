...
#define MOLEMOLE_EFFECTSIMULATE_ESPARTICLEMEMBERBEHAVIOR_METHOD_3_4272BE5198E6F216_OFFSET UNITYSDK_OFFSET(0x7554B50)
#define MOLEMOLE_EFFECTSIMULATE_ESPARTICLEMEMBERBEHAVIOR_METHOD_3_F660D274D148C801_OFFSET UNITYSDK_OFFSET(0x75549F0)
#define MOLEMOLE_EFFECTSIMULATE_ESPARTICLEMEMBERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x7554AE0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESParticleMemberBehavior_TypeDefinitionIndex = 76195;
