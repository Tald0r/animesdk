...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_GET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB9FAE40)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB9FAC00)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB9FACC0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB9FAD80)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_04EDF435A0D753A9_OFFSET UNITYSDK_OFFSET(0xB9FB510)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0xB9FB720)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_31FC867766176C3A_OFFSET UNITYSDK_OFFSET(0xB9FB120)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0xB9FBA70)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xB9FBA60)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_8F8B3C218D38C840_OFFSET UNITYSDK_OFFSET(0xB9FB070)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_A0F1D07FA5BAF2AE_OFFSET UNITYSDK_OFFSET(0xB9FB630)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0xB9F27D0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_B56234B03748E3AC_OFFSET UNITYSDK_OFFSET(0xB9FAF00)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB9F23B0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0xB9FAFB0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_D219DD9B6D30CBB4_OFFSET UNITYSDK_OFFSET(0xB9EFED0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_F6044E7AC73C3A15_OFFSET UNITYSDK_OFFSET(0xB9F1490)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_SET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB9FAE70)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB9FAC30)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB9FACF0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB9FADB0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xB9F3810)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector4KeyframeCurve_TypeDefinitionIndex = 69850;
