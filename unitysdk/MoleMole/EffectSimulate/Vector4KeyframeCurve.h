...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_GET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC9B6440)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC9B6200)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC9B62C0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC9B6380)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_04EDF435A0D753A9_OFFSET UNITYSDK_OFFSET(0xC9B6B10)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0xC9B6D20)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_31FC867766176C3A_OFFSET UNITYSDK_OFFSET(0xC9B6720)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0xC9B7070)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xC9B7060)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_8F8B3C218D38C840_OFFSET UNITYSDK_OFFSET(0xC9B6670)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_A0F1D07FA5BAF2AE_OFFSET UNITYSDK_OFFSET(0xC9B6C30)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0xC9ADDC0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_B56234B03748E3AC_OFFSET UNITYSDK_OFFSET(0xC9B6500)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC9AD9A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0xC9B65B0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_D219DD9B6D30CBB4_OFFSET UNITYSDK_OFFSET(0xC9AB4C0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_F6044E7AC73C3A15_OFFSET UNITYSDK_OFFSET(0xC9ACA80)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_SET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC9B6470)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC9B6230)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC9B62F0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC9B63B0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9AEE00)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector4KeyframeCurve_TypeDefinitionIndex = 75202;
	...
	public:
		...
		::System::Void Method_5_F6044E7AC73C3A15(::System::Single a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_VECTOR4KEYFRAMECURVE_METHOD_5_F6044E7AC73C3A15_OFFSET))(this, a1);
		}
