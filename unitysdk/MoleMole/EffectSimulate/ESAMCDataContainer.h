...
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_ENSURETARGETASSETNEW_OFFSET UNITYSDK_OFFSET(0x8F61860)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_GETTARGETASSETNEWBYCTX_OFFSET UNITYSDK_OFFSET(0x8F61800)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_INITCTX_OFFSET UNITYSDK_OFFSET(0x8F61CC0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x8F62490)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_08550FA7D4D2CFC9_OFFSET UNITYSDK_OFFSET(0x8F61BF0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_B67A7D5A7BB42B14_OFFSET UNITYSDK_OFFSET(0x8F62360)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_C030086179B06CA2_OFFSET UNITYSDK_OFFSET(0x8F61D90)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x8F62500)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x8F61C60)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8F62200)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_E9E44213FE3B59FD_OFFSET UNITYSDK_OFFSET(0x8F62260)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_TRYEXPROT_OFFSET UNITYSDK_OFFSET(0x8F61E00)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8F61FD0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F61FB0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAMCDataContainer_TypeDefinitionIndex = 66075;
	...
	public:
		...
		{
			return (::Sirenix::OdinInspector::ValueDropdownList_1<::MoleMole::EffectSimulate::ESAMCDataContainer_Enum_3_CD74075A03CBCAFE>**)Il2CppClass::FromTypeDefinitionIndex(ESAMCDataContainer_TypeDefinitionIndex)->GetStaticField(0x3EC60);
		}
