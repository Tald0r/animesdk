...
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_ENSURETARGETASSETNEW_OFFSET UNITYSDK_OFFSET(0xD0C1130)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_GETTARGETASSETNEWBYCTX_OFFSET UNITYSDK_OFFSET(0xD0C10D0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_INITCTX_OFFSET UNITYSDK_OFFSET(0xD0C1590)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0xD0C1D70)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_08550FA7D4D2CFC9_OFFSET UNITYSDK_OFFSET(0xD0C14C0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_B67A7D5A7BB42B14_OFFSET UNITYSDK_OFFSET(0xD0C1AE0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_C030086179B06CA2_OFFSET UNITYSDK_OFFSET(0xD0C1660)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xD0C1530)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xD0C1DE0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD0C1C10)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_E9E44213FE3B59FD_OFFSET UNITYSDK_OFFSET(0xD0C1C70)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_TRYEXPROT_OFFSET UNITYSDK_OFFSET(0xD0C16D0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD0C18A0)
#define MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0C1880)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESAMCDataContainer_TypeDefinitionIndex = 39912;
	...
	public:
		...
		{
			return (::Sirenix::OdinInspector::ValueDropdownList_1<::MoleMole::EffectSimulate::ESAMCDataContainer_Enum_3_CD74075A03CBCAFE>**)Il2CppClass::FromTypeDefinitionIndex(ESAMCDataContainer_TypeDefinitionIndex)->GetStaticField(0x418E0);
		}
		...
		::MoleMole::EffectSimulate::NapEffectSimulatorMgr* Method_5_C030086179B06CA2()
		{
			return ((::MoleMole::EffectSimulate::NapEffectSimulatorMgr*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_C030086179B06CA2_OFFSET))(this);
		}

		::System::Boolean Method_5_B67A7D5A7BB42B14()
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_ESAMCDATACONTAINER_METHOD_5_B67A7D5A7BB42B14_OFFSET))(this);
		}
