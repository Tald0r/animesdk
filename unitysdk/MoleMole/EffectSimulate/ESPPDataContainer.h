...
#define MOLEMOLE_EFFECTSIMULATE_ESPPDATACONTAINER_LOADTEMPFROMASSET_OFFSET UNITYSDK_OFFSET(0xB0C0F30)
#define MOLEMOLE_EFFECTSIMULATE_ESPPDATACONTAINER_METHOD_5_16F329E8131CBCB7_OFFSET UNITYSDK_OFFSET(0xB0C1470)
#define MOLEMOLE_EFFECTSIMULATE_ESPPDATACONTAINER_METHOD_5_D98FEEA46D5D3B4F_OFFSET UNITYSDK_OFFSET(0xB0C1370)
#define MOLEMOLE_EFFECTSIMULATE_ESPPDATACONTAINER_TRYEXPORT_OFFSET UNITYSDK_OFFSET(0xB0C0E60)
#define MOLEMOLE_EFFECTSIMULATE_ESPPDATACONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0xB0C1350)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPPDataContainer_TypeDefinitionIndex = 74179;
