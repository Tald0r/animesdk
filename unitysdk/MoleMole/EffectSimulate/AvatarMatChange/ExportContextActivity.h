...
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xF2EAD80)
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0xF2EAC90)
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY_METHOD_2_8A082AE0230435DC_OFFSET UNITYSDK_OFFSET(0xF2EAA80)
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY_METHOD_2_B345A53823FD29B2_OFFSET UNITYSDK_OFFSET(0xF2EA8A0)
#define MOLEMOLE_EFFECTSIMULATE_AVATARMATCHANGE_EXPORTCONTEXTACTIVITY__CTOR_OFFSET UNITYSDK_OFFSET(0xF2EAD20)

namespace MoleMole::EffectSimulate::AvatarMatChange
{
	inline static constexpr unsigned int ExportContextActivity_TypeDefinitionIndex = 67237;
