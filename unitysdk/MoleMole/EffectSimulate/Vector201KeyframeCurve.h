...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0xC206DA0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC206990)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC206B80)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_01F677A8852683A3_OFFSET UNITYSDK_OFFSET(0xC206AE0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_037E3F5BEC1EEC81_OFFSET UNITYSDK_OFFSET(0xC2076D0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_2356514D84A0DDE4_OFFSET UNITYSDK_OFFSET(0xC207110)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0xC207AE0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_4552C310294DCA81_OFFSET UNITYSDK_OFFSET(0xC2072C0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_456E9019CE0C69CF_OFFSET UNITYSDK_OFFSET(0xC206FB0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_5C660F51F7E7B3D8_OFFSET UNITYSDK_OFFSET(0xC207230)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xC207AD0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_958E77D3D32E4233_OFFSET UNITYSDK_OFFSET(0xC2071A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xC2078F0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_A596B48F7BD9EDA6_OFFSET UNITYSDK_OFFSET(0xC206DB0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_C21A7AC6282FB0D0_OFFSET UNITYSDK_OFFSET(0xC207660)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_METHOD_4_E49226E55BF3741F_OFFSET UNITYSDK_OFFSET(0xC207030)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC2069F0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC206BE0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR201KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC206CD0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector201KeyframeCurve_TypeDefinitionIndex = 63465;
