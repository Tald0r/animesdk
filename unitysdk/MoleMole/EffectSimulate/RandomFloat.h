...
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_GET_CANUSERANDOM_OFFSET UNITYSDK_OFFSET(0xC2B26C0)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_METHOD_1_8B133A880F05B901_OFFSET UNITYSDK_OFFSET(0xC2B2860)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC2B27F0)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_METHOD_1_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0xC2B2760)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_SET_CANUSERANDOM_OFFSET UNITYSDK_OFFSET(0xC2B26D0)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0xC2B2750)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int RandomFloat_TypeDefinitionIndex = 40897;
