...
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_GET_CANUSERANDOM_OFFSET UNITYSDK_OFFSET(0xB88DE60)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_METHOD_1_8B133A880F05B901_OFFSET UNITYSDK_OFFSET(0xB88DF90)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB88E010)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_METHOD_1_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0xB88DF00)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT_SET_CANUSERANDOM_OFFSET UNITYSDK_OFFSET(0xB88DE70)
#define MOLEMOLE_EFFECTSIMULATE_RANDOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0xB88DEF0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int RandomFloat_TypeDefinitionIndex = 51259;
