...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x9FFD4D0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x9FFD290)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_2FA22A822BDD19EE_OFFSET UNITYSDK_OFFSET(0x9FFCB50)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_3622C2D1E940D3F4_OFFSET UNITYSDK_OFFSET(0x9FFD550)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x9FFD3F0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x9FFC810)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x9FFCC30)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_429B9EF3AD5C70EB_OFFSET UNITYSDK_OFFSET(0x9FFC710)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_43069389B18F0936_OFFSET UNITYSDK_OFFSET(0x9FFC5D0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_4ED0F9748169EC7E_OFFSET UNITYSDK_OFFSET(0x9FFCAF0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_4FB5F56430673EA6_1_OFFSET UNITYSDK_OFFSET(0x9FFC9E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_4FB5F56430673EA6_OFFSET UNITYSDK_OFFSET(0x9FFC960)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_521267F2AEE4A422_OFFSET UNITYSDK_OFFSET(0x9FFA6B0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_54BEE211D32F7DEF_OFFSET UNITYSDK_OFFSET(0x9FFD300)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_55D8CF5F1FB0803A_OFFSET UNITYSDK_OFFSET(0x9FFD560)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_581A5078A2F29034_OFFSET UNITYSDK_OFFSET(0x9FFD520)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_63E3E26A3D57F57D_OFFSET UNITYSDK_OFFSET(0x9FF9060)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x9FF81E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_76CD9B9D1269FA90_OFFSET UNITYSDK_OFFSET(0x9FF8D20)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x9FFD380)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_88B60F3B95FAA4F1_1_OFFSET UNITYSDK_OFFSET(0x9FFC870)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_88B60F3B95FAA4F1_2_OFFSET UNITYSDK_OFFSET(0x9FFCA60)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x9FFC780)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_98B37EE2C09006BA_OFFSET UNITYSDK_OFFSET(0x9FFC120)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_99F887AAD84BE668_OFFSET UNITYSDK_OFFSET(0x9FFC360)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_A1D8CD775DEC3C21_1_OFFSET UNITYSDK_OFFSET(0x9FFD310)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x9FFC900)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_A99467CE9479C990_1_OFFSET UNITYSDK_OFFSET(0x9FFD540)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_A99467CE9479C990_OFFSET UNITYSDK_OFFSET(0x9FFD280)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_B2C24AFA396A3C80_OFFSET UNITYSDK_OFFSET(0x9FFC250)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_B4596DBEA209120C_OFFSET UNITYSDK_OFFSET(0x9FFD450)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_BE3471DF7E3D4326_OFFSET UNITYSDK_OFFSET(0x9FFD4E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9FFD470)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9FF8390)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_D2A9D107FA1E5A31_OFFSET UNITYSDK_OFFSET(0x9FFC6A0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_D5F190FE5CE966B3_OFFSET UNITYSDK_OFFSET(0x9FFD530)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x9FFD390)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_E05ADF64DE351167_OFFSET UNITYSDK_OFFSET(0x9FFCEF0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_E7F1AECA7CFF8AAD_1_OFFSET UNITYSDK_OFFSET(0x9FFD460)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0x9FFD370)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x9FF83F0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_EEED34E9AAC26D51_OFFSET UNITYSDK_OFFSET(0x9FF85D0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_F918726BB6E76D4D_1_OFFSET UNITYSDK_OFFSET(0x9FFB8C0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE_METHOD_5_F918726BB6E76D4D_OFFSET UNITYSDK_OFFSET(0x9FFB060)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSVIGNETTE__CTOR_OFFSET UNITYSDK_OFFSET(0x9FFCFD0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessVignette_TypeDefinitionIndex = 55357;
