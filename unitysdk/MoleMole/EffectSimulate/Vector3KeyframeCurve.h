...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xCD2CCF0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xCD2CDB0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xCD2CE70)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_011F18E07064382B_OFFSET UNITYSDK_OFFSET(0xCD2D200)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_0173DC4321843C93_OFFSET UNITYSDK_OFFSET(0xCD2D650)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_04EDF435A0D753A9_OFFSET UNITYSDK_OFFSET(0xCD2D530)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_31BBB9AD8D2C3DC7_OFFSET UNITYSDK_OFFSET(0xCD2D020)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0xCD2DF80)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_76CD9B9D1269FA90_OFFSET UNITYSDK_OFFSET(0xCD2DB00)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xCD2E020)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_8B6B6AE1C765104E_OFFSET UNITYSDK_OFFSET(0xCD2D770)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_8F089EFDA7DA3A98_OFFSET UNITYSDK_OFFSET(0xCD2D0B0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xCD2DA50)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0xCD2DCF0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0xCD2D150)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_F6044E7AC73C3A15_OFFSET UNITYSDK_OFFSET(0xCD2D960)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xCD2CD20)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xCD2CDE0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xCD2CEA0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD2CF30)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector3KeyframeCurve_TypeDefinitionIndex = 80195;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_F6044E7AC73C3A15_OFFSET))(this, a1);
		}
