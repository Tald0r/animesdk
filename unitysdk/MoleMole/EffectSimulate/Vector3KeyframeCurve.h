...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xE85E110)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xE85E1D0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xE85E290)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_011F18E07064382B_OFFSET UNITYSDK_OFFSET(0xE85E620)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_0173DC4321843C93_OFFSET UNITYSDK_OFFSET(0xE85EA70)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_04EDF435A0D753A9_OFFSET UNITYSDK_OFFSET(0xE85E950)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_31BBB9AD8D2C3DC7_OFFSET UNITYSDK_OFFSET(0xE85E440)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0xE85F3B0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_76CD9B9D1269FA90_OFFSET UNITYSDK_OFFSET(0xE85EF20)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xE85F3A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_8B6B6AE1C765104E_OFFSET UNITYSDK_OFFSET(0xE85EB90)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_8F089EFDA7DA3A98_OFFSET UNITYSDK_OFFSET(0xE85E4D0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE85EE70)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0xE85F110)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0xE85E570)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_METHOD_5_F6044E7AC73C3A15_OFFSET UNITYSDK_OFFSET(0xE85ED80)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xE85E140)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xE85E200)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xE85E2C0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR3KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xE85E350)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector3KeyframeCurve_TypeDefinitionIndex = 73459;
