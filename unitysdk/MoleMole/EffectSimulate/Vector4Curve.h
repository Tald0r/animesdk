...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0x75667F0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_31FC867766176C3A_OFFSET UNITYSDK_OFFSET(0x7565140)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x7566CC0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_48B6F20F4C113255_OFFSET UNITYSDK_OFFSET(0x7565F50)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x7566BF0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_A0F1D07FA5BAF2AE_OFFSET UNITYSDK_OFFSET(0x7565620)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_B56234B03748E3AC_OFFSET UNITYSDK_OFFSET(0x7565EA0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x7566B90)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x7566C00)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x7566C60)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x7566B30)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0x7565DE0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_FAA3010CE1C759D3_OFFSET UNITYSDK_OFFSET(0x7565510)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE_METHOD_4_FFDB41E6BD9C64A5_OFFSET UNITYSDK_OFFSET(0x7565710)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR4CURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x7565060)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector4Curve_TypeDefinitionIndex = 80829;
