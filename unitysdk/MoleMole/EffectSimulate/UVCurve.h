...
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_0B34AA51B95C62BE_1_OFFSET UNITYSDK_OFFSET(0x7564E80)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_0B34AA51B95C62BE_OFFSET UNITYSDK_OFFSET(0x7564DD0)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0x7564A30)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_31FC867766176C3A_OFFSET UNITYSDK_OFFSET(0x7563320)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_48B6F20F4C113255_OFFSET UNITYSDK_OFFSET(0x7564190)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_6FD64B3DB3CCB573_OFFSET UNITYSDK_OFFSET(0x7563710)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x7564F30)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_A0F1D07FA5BAF2AE_OFFSET UNITYSDK_OFFSET(0x7563860)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_B56234B03748E3AC_OFFSET UNITYSDK_OFFSET(0x75640E0)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x7564F40)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x7564FA0)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x7565000)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x7564D70)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0x7564020)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_FFDB41E6BD9C64A5_OFFSET UNITYSDK_OFFSET(0x7563950)
#define MOLEMOLE_EFFECTSIMULATE_UVCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x7563240)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int UVCurve_TypeDefinitionIndex = 66431;
	...
	public:
		...
		{
			return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_0B34AA51B95C62BE_OFFSET))(this);
		}

		::System::String* Method_4_0B34AA51B95C62BE_1()
		{
			return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_UVCURVE_METHOD_4_0B34AA51B95C62BE_1_OFFSET))(this);
		}
