...
#define MOLEMOLE_EFFECTSIMULATE_IEVALUATECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E0C050)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int IEvaluateCurve_TypeDefinitionIndex = 71737;
