...
#define MOLEMOLE_EFFECTSIMULATE_IEVALUATECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC25B5A0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int IEvaluateCurve_TypeDefinitionIndex = 71831;
