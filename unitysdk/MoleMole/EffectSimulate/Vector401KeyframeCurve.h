...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0x1163F370)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_GET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1163F210)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1163ED60)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1163EF50)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1163F0B0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_043B534750B9E7A6_OFFSET UNITYSDK_OFFSET(0x1163EEB0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_0CD324DF036A29AB_OFFSET UNITYSDK_OFFSET(0x1163F380)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_164B2BDEE6F7C25D_OFFSET UNITYSDK_OFFSET(0x1163F720)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0x1163FE60)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_21A9C5CD44F59232_OFFSET UNITYSDK_OFFSET(0x1163FA00)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x116401A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x11640240)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_8899B33907DB68CE_OFFSET UNITYSDK_OFFSET(0x1163FB70)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_8F8B3C218D38C840_OFFSET UNITYSDK_OFFSET(0x1163FAC0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_A0F1D07FA5BAF2AE_OFFSET UNITYSDK_OFFSET(0x1163F7A0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_B06E4777914A5853_OFFSET UNITYSDK_OFFSET(0x115EF310)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_B56234B03748E3AC_OFFSET UNITYSDK_OFFSET(0x1163F890)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_METHOD_4_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0x1163F940)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_SET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1163F280)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1163EDC0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1163EFC0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1163F120)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR401KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x115F2A10)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector401KeyframeCurve_TypeDefinitionIndex = 73065;
