...
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0xB88E7D0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB88E530)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB88E080)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB88E270)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB88E3D0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_043B534750B9E7A6_OFFSET UNITYSDK_OFFSET(0xB88E1D0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_0B34AA51B95C62BE_1_OFFSET UNITYSDK_OFFSET(0xB88FED0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_0B34AA51B95C62BE_OFFSET UNITYSDK_OFFSET(0xB88FE10)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0xB88FA10)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_21A9C5CD44F59232_OFFSET UNITYSDK_OFFSET(0xB88EEA0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xB88FEC0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_8899B33907DB68CE_OFFSET UNITYSDK_OFFSET(0xB88F720)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_8F8B3C218D38C840_OFFSET UNITYSDK_OFFSET(0xB88F670)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_A0F1D07FA5BAF2AE_OFFSET UNITYSDK_OFFSET(0xB88EC40)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_B06E4777914A5853_OFFSET UNITYSDK_OFFSET(0xB88EF60)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_B56234B03748E3AC_OFFSET UNITYSDK_OFFSET(0xB88ED30)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_C21A7AC6282FB0D0_1_OFFSET UNITYSDK_OFFSET(0xB88FF80)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_C21A7AC6282FB0D0_OFFSET UNITYSDK_OFFSET(0xB88FD50)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0xB88EDE0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_CFE795238058307E_OFFSET UNITYSDK_OFFSET(0xB88EB80)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_DABB2D6C36ED9992_OFFSET UNITYSDK_OFFSET(0xB88E7E0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB88E5A0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB88E0E0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB88E2E0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xB88E440)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xB88E690)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int UV01KeyframeCurve_TypeDefinitionIndex = 65453;
	...
	public:
		...
		::System::String* Method_4_0B34AA51B95C62BE()
		{
			return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_0B34AA51B95C62BE_OFFSET))(this);
		}
		...
		::System::String* Method_4_0B34AA51B95C62BE_1()
		{
			return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_0B34AA51B95C62BE_1_OFFSET))(this);
		}
