...
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0xC2B2EF0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC2B2D90)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC2B28E0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC2B2AD0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC2B2C30)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_043B534750B9E7A6_OFFSET UNITYSDK_OFFSET(0xC2B2A30)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_0B34AA51B95C62BE_1_OFFSET UNITYSDK_OFFSET(0xC2B45E0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_0B34AA51B95C62BE_OFFSET UNITYSDK_OFFSET(0xC2B4470)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_1DE6433C25680F9D_OFFSET UNITYSDK_OFFSET(0xC2B4130)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_21A9C5CD44F59232_OFFSET UNITYSDK_OFFSET(0xC2B35C0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xC2B4690)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_8899B33907DB68CE_OFFSET UNITYSDK_OFFSET(0xC2B3E40)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_8F8B3C218D38C840_OFFSET UNITYSDK_OFFSET(0xC2B3D90)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_A0F1D07FA5BAF2AE_OFFSET UNITYSDK_OFFSET(0xC2B3360)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_B06E4777914A5853_OFFSET UNITYSDK_OFFSET(0xC2B3680)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_B56234B03748E3AC_OFFSET UNITYSDK_OFFSET(0xC2B3450)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_C21A7AC6282FB0D0_1_OFFSET UNITYSDK_OFFSET(0xC2B46A0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_C21A7AC6282FB0D0_OFFSET UNITYSDK_OFFSET(0xC2B4520)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0xC2B3500)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_CFE795238058307E_OFFSET UNITYSDK_OFFSET(0xC2B32A0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_METHOD_4_DABB2D6C36ED9992_OFFSET UNITYSDK_OFFSET(0xC2B2F00)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_WKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC2B2E00)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC2B2940)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC2B2B40)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC2B2CA0)
#define MOLEMOLE_EFFECTSIMULATE_UV01KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC29E750)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int UV01KeyframeCurve_TypeDefinitionIndex = 43954;
