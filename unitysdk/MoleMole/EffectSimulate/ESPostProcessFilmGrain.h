...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x16BE3420)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_24B2CA816EFA1FA5_OFFSET UNITYSDK_OFFSET(0x16BE30B0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x16BE3510)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x16BE2F50)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_3622C2D1E940D3F4_OFFSET UNITYSDK_OFFSET(0x16BE32E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x16BE3330)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x16BE2B60)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x16BE0420)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_429B9EF3AD5C70EB_OFFSET UNITYSDK_OFFSET(0x16BE2A80)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_43069389B18F0936_OFFSET UNITYSDK_OFFSET(0x16BE2940)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_459C79521BFE514E_OFFSET UNITYSDK_OFFSET(0x16BE09B0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_4ED0F9748169EC7E_OFFSET UNITYSDK_OFFSET(0x16BE2E40)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_4FB5F56430673EA6_1_OFFSET UNITYSDK_OFFSET(0x16BE2D30)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_4FB5F56430673EA6_OFFSET UNITYSDK_OFFSET(0x16BE2CB0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_54BEE211D32F7DEF_OFFSET UNITYSDK_OFFSET(0x16BE3500)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_55D8CF5F1FB0803A_OFFSET UNITYSDK_OFFSET(0x16BE32D0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_581A5078A2F29034_OFFSET UNITYSDK_OFFSET(0x16BE3300)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x16BE0260)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x16BE32F0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_88B60F3B95FAA4F1_1_OFFSET UNITYSDK_OFFSET(0x16BE2DB0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x16BE2BC0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_8E7482C252877E8A_1_OFFSET UNITYSDK_OFFSET(0x16BE20F0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_8E7482C252877E8A_OFFSET UNITYSDK_OFFSET(0x16BE1C70)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_99F887AAD84BE668_OFFSET UNITYSDK_OFFSET(0x16BE2770)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_A1D8CD775DEC3C21_1_OFFSET UNITYSDK_OFFSET(0x16BE3440)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x16BE2C50)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_A99467CE9479C990_1_OFFSET UNITYSDK_OFFSET(0x16BE3410)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_A99467CE9479C990_OFFSET UNITYSDK_OFFSET(0x16BE33A0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_B1983B8E0FEB5BBD_1_OFFSET UNITYSDK_OFFSET(0x16BE16D0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_B1983B8E0FEB5BBD_OFFSET UNITYSDK_OFFSET(0x16BE0B90)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_B2C24AFA396A3C80_OFFSET UNITYSDK_OFFSET(0x16BE2660)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_B4596DBEA209120C_OFFSET UNITYSDK_OFFSET(0x16BE3310)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_BAEE5DE0AF1ED2B0_OFFSET UNITYSDK_OFFSET(0x16BE2EA0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_BE3471DF7E3D4326_OFFSET UNITYSDK_OFFSET(0x16BE3580)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x16BE34A0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16BE03C0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_D2A9D107FA1E5A31_OFFSET UNITYSDK_OFFSET(0x16BE2A10)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_D5F190FE5CE966B3_OFFSET UNITYSDK_OFFSET(0x16BE3320)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_DA1BF2C227DC3D86_1_OFFSET UNITYSDK_OFFSET(0x16BE33B0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x16BE2AF0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_E7F1AECA7CFF8AAD_1_OFFSET UNITYSDK_OFFSET(0x16BE3430)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0x16BE3390)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_EBEE0D0A222A8264_OFFSET UNITYSDK_OFFSET(0x16BE2570)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN_METHOD_5_F53BAAE38A584428_OFFSET UNITYSDK_OFFSET(0x16BE05B0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSFILMGRAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x16BE3160)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessFilmGrain_TypeDefinitionIndex = 58843;
