...
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_0FABA7B7C4910501_OFFSET UNITYSDK_OFFSET(0xA5D7770)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_22FFB1F2200E3BA7_OFFSET UNITYSDK_OFFSET(0xA5D8080)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_28AEFC556CCDC741_OFFSET UNITYSDK_OFFSET(0xA5D7640)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_43069389B18F0936_OFFSET UNITYSDK_OFFSET(0xA5D7910)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_49AC00594530B714_1_OFFSET UNITYSDK_OFFSET(0xA5D8020)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_49AC00594530B714_OFFSET UNITYSDK_OFFSET(0xA5D73B0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_5BD179982EDEB0FC_OFFSET UNITYSDK_OFFSET(0xA5D7C00)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_63E7CA2473DB5E8B_OFFSET UNITYSDK_OFFSET(0xA5D7510)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_6FF3E514220A5943_OFFSET UNITYSDK_OFFSET(0xA5D74A0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_CA16E66277F3799C_OFFSET UNITYSDK_OFFSET(0xA5D7410)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA5D7BA0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0xA5D7570)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_E88782EA1EE9EB39_OFFSET UNITYSDK_OFFSET(0xA5D7DF0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR_METHOD_3_FFE24DF54B83FB77_OFFSET UNITYSDK_OFFSET(0xA5D79E0)
#define MOLEMOLE_EFFECTSIMULATE_ESSHADERCUSTOMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA5D75D0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESShaderCustomBehavior_TypeDefinitionIndex = 50302;
