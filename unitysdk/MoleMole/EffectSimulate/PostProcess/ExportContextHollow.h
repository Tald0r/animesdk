...
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTHOLLOW_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x141C7C80)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTHOLLOW_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x141C7BE0)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTHOLLOW_METHOD_2_BA0DC2F7F154B425_OFFSET UNITYSDK_OFFSET(0x141C79B0)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTHOLLOW_METHOD_2_C101CD8C5CF89A5A_OFFSET UNITYSDK_OFFSET(0x141C7AE0)
#define MOLEMOLE_EFFECTSIMULATE_POSTPROCESS_EXPORTCONTEXTHOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x141C7C70)

namespace MoleMole::EffectSimulate::PostProcess
{
	inline static constexpr unsigned int ExportContextHollow_TypeDefinitionIndex = 60614;
