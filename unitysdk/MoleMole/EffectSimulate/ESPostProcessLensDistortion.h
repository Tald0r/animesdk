...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0xA4ECA40)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0xA4ED4A0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_1C409C2CC83887DC_OFFSET UNITYSDK_OFFSET(0xA4ECE20)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xA4ED320)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0xA4EBE40)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_31F1C58AB372DEB4_OFFSET UNITYSDK_OFFSET(0xA4E85D0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_3622C2D1E940D3F4_OFFSET UNITYSDK_OFFSET(0xA4ED4C0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0xA4ED540)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xA4EC5E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_429B9EF3AD5C70EB_OFFSET UNITYSDK_OFFSET(0xA4EC500)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_43069389B18F0936_OFFSET UNITYSDK_OFFSET(0xA4EC3C0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_4ED0F9748169EC7E_OFFSET UNITYSDK_OFFSET(0xA4EC8C0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_4FB5F56430673EA6_1_OFFSET UNITYSDK_OFFSET(0xA4EC7B0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_4FB5F56430673EA6_OFFSET UNITYSDK_OFFSET(0xA4EC730)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_50896BDA13FD77D3_OFFSET UNITYSDK_OFFSET(0xA4E9DE0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_54BEE211D32F7DEF_OFFSET UNITYSDK_OFFSET(0xA4ED530)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_55D8CF5F1FB0803A_OFFSET UNITYSDK_OFFSET(0xA4ED460)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_581A5078A2F29034_OFFSET UNITYSDK_OFFSET(0xA4ED470)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0xA4E7500)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_76CD9B9D1269FA90_OFFSET UNITYSDK_OFFSET(0xA4E8120)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_79E872D90798D236_1_OFFSET UNITYSDK_OFFSET(0xA4EB3A0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_79E872D90798D236_OFFSET UNITYSDK_OFFSET(0xA4EA900)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xA4ED4B0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_88B60F3B95FAA4F1_1_OFFSET UNITYSDK_OFFSET(0xA4EC830)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0xA4EC640)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_99F887AAD84BE668_OFFSET UNITYSDK_OFFSET(0xA4EC0C0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_A1D8CD775DEC3C21_1_OFFSET UNITYSDK_OFFSET(0xA4ED390)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xA4EC6D0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_A99467CE9479C990_1_OFFSET UNITYSDK_OFFSET(0xA4ED4E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_A99467CE9479C990_OFFSET UNITYSDK_OFFSET(0xA4ED490)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_B0941EE01F0E187F_OFFSET UNITYSDK_OFFSET(0xA4EC920)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_B2C24AFA396A3C80_OFFSET UNITYSDK_OFFSET(0xA4EBFB0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_B4596DBEA209120C_OFFSET UNITYSDK_OFFSET(0xA4ED450)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0xA4E7770)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_BE3471DF7E3D4326_OFFSET UNITYSDK_OFFSET(0xA4ED4F0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xA4ED3F0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA4E7710)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_D2A9D107FA1E5A31_OFFSET UNITYSDK_OFFSET(0xA4EC490)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_D5F190FE5CE966B3_OFFSET UNITYSDK_OFFSET(0xA4ED5A0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_DA1BF2C227DC3D86_1_OFFSET UNITYSDK_OFFSET(0xA4ED5B0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0xA4EC570)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_E7F1AECA7CFF8AAD_1_OFFSET UNITYSDK_OFFSET(0xA4ED4D0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0xA4ED480)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION_METHOD_5_F53BAAE38A584428_OFFSET UNITYSDK_OFFSET(0xA4E7990)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSLENSDISTORTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA4ECF40)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessLensDistortion_TypeDefinitionIndex = 75844;
