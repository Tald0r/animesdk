...
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0xA4EE6E0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xA4EE0F0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_GET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xA4EE2F0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_GET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xA4EE460)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_0173DC4321843C93_OFFSET UNITYSDK_OFFSET(0xA4EEAC0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_043B534750B9E7A6_OFFSET UNITYSDK_OFFSET(0xA4EE250)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_05A2DFD507593DE5_OFFSET UNITYSDK_OFFSET(0xA4EF520)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_31BBB9AD8D2C3DC7_OFFSET UNITYSDK_OFFSET(0xA4EEBE0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0xA4EFA80)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_459E632F046395C5_OFFSET UNITYSDK_OFFSET(0xA4EE700)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_4D3533BDA0DDCF1E_OFFSET UNITYSDK_OFFSET(0xA4EED10)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xA4EFA70)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_8F089EFDA7DA3A98_OFFSET UNITYSDK_OFFSET(0xA4EEC70)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_C813ED51B36FFD80_OFFSET UNITYSDK_OFFSET(0xA4EEDB0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_D2A1DD761855A1B6_OFFSET UNITYSDK_OFFSET(0xA4EEA40)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0xA4EF7E0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_METHOD_4_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0xA4EF470)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xA4EE150)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_SET_YKEYFRAME_OFFSET UNITYSDK_OFFSET(0xA4EE360)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE_SET_ZKEYFRAME_OFFSET UNITYSDK_OFFSET(0xA4EE4D0)
#define MOLEMOLE_EFFECTSIMULATE_VECTOR301KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xA4EE5D0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Vector301KeyframeCurve_TypeDefinitionIndex = 39431;
