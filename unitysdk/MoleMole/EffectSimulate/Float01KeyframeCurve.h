...
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0xC1F1BF0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC1F1A20)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_11104293008C2056_OFFSET UNITYSDK_OFFSET(0xC1F1D70)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_12CFF13C2757B5FB_OFFSET UNITYSDK_OFFSET(0xC1F20D0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xC1F2290)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_627557CE4CD0ABB4_OFFSET UNITYSDK_OFFSET(0xC1F2010)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_7A37753F2CEC6D53_OFFSET UNITYSDK_OFFSET(0xC1F1CF0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xC1F23B0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_9FBCB7EE3738DEA4_OFFSET UNITYSDK_OFFSET(0xC1F1ED0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xC1F1E60)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_AE7ACA9431B8342C_OFFSET UNITYSDK_OFFSET(0xC1F1C70)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_D5CE98C81E7D70E3_OFFSET UNITYSDK_OFFSET(0xC1F1C00)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_FED21563FA953D2A_OFFSET UNITYSDK_OFFSET(0xC1F1FA0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0xC1F1A80)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xC1F1B10)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Float01KeyframeCurve_TypeDefinitionIndex = 41328;
	...
	public:
		...
		::System::String* Method_4_12CFF13C2757B5FB(::System::Single a1, ::System::Single a2, ::System::Int32 a3)
		{
			return ((::System::String*(*)(::PVOID, ::System::Single, ::System::Single, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_12CFF13C2757B5FB_OFFSET))(this, a1, a2, a3);
		}
