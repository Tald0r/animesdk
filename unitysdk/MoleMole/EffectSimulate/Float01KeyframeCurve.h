...
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_GET_EDITORDEFAULTVAL_OFFSET UNITYSDK_OFFSET(0x8208AD0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_GET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x8208900)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_11104293008C2056_OFFSET UNITYSDK_OFFSET(0x8208C50)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_12CFF13C2757B5FB_OFFSET UNITYSDK_OFFSET(0x8208FB0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x8209170)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_627557CE4CD0ABB4_OFFSET UNITYSDK_OFFSET(0x8208EF0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_7A37753F2CEC6D53_OFFSET UNITYSDK_OFFSET(0x8208BD0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x8209290)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_9FBCB7EE3738DEA4_OFFSET UNITYSDK_OFFSET(0x8208DB0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x8208D40)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_AE7ACA9431B8342C_OFFSET UNITYSDK_OFFSET(0x8208B50)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_D5CE98C81E7D70E3_OFFSET UNITYSDK_OFFSET(0x8208AE0)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_METHOD_4_FED21563FA953D2A_OFFSET UNITYSDK_OFFSET(0x8208E80)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE_SET_XKEYFRAME_OFFSET UNITYSDK_OFFSET(0x8208960)
#define MOLEMOLE_EFFECTSIMULATE_FLOAT01KEYFRAMECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x82089F0)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int Float01KeyframeCurve_TypeDefinitionIndex = 73277;
