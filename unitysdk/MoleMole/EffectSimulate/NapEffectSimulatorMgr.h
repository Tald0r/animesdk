...
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ADDCHILDRENVISIBLESTATE_OFFSET UNITYSDK_OFFSET(0xB5B0FD0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_AWAKE_OFFSET UNITYSDK_OFFSET(0xB5B18E0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_CLEAR_OFFSET UNITYSDK_OFFSET(0xB5B54F0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_DURATIONISINF_OFFSET UNITYSDK_OFFSET(0xB5B4420)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETALLCHILDRENCOM_OFFSET UNITYSDK_OFFSET(0xB5B5AC0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETDTCACHE_OFFSET UNITYSDK_OFFSET(0xB5AEFB0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETESCOMBYGO_OFFSET UNITYSDK_OFFSET(0xB5B3D00)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETFADEOUTVAL_OFFSET UNITYSDK_OFFSET(0xB5B3B50)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETINITPHASEACTIVESTATE_OFFSET UNITYSDK_OFFSET(0xB5B56F0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETISFORCELIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0xB5B1A40)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETISSUPPORTLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0xB5B19E0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETMRBYGO_OFFSET UNITYSDK_OFFSET(0xB5B5C70)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETNOWTIMEAT_OFFSET UNITYSDK_OFFSET(0xB5B5610)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETOTHERRENDERERBYGO_OFFSET UNITYSDK_OFFSET(0xB5B5D10)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETPSBYGO_OFFSET UNITYSDK_OFFSET(0xB5B5B30)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GETPSRBYGO_OFFSET UNITYSDK_OFFSET(0xB5B5BD0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GET_ARRCOMS_OFFSET UNITYSDK_OFFSET(0xB5B18B0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GET_ARRPS_OFFSET UNITYSDK_OFFSET(0xB5B18C0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GET_ISRUNTIMEUPDATEREADY_OFFSET UNITYSDK_OFFSET(0xB5B6840)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GET_MAPGO2ESCOM_OFFSET UNITYSDK_OFFSET(0xB5B18D0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_GET_PLAYMODE_OFFSET UNITYSDK_OFFSET(0xB5B5670)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_HANDLESIMULATORMGRFADEVALUE_OFFSET UNITYSDK_OFFSET(0xB5B3930)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_INIT_OFFSET UNITYSDK_OFFSET(0xB5B49A0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xB5B4330)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ISININIT_OFFSET UNITYSDK_OFFSET(0xB5B5680)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_MAPEFFECTLODTYPE_OFFSET UNITYSDK_OFFSET(0xB5AFCD0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0xB5AEC70)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0xB5B77A0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_0DF420E95D6252BE_OFFSET UNITYSDK_OFFSET(0xB5B6B10)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_0E142E3463F30350_OFFSET UNITYSDK_OFFSET(0xB5B0E30)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xB5B45C0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0xB5B7880)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xB5B7F70)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xB5B6A90)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_1DEF7ECEE7F7C088_OFFSET UNITYSDK_OFFSET(0xB5B6D50)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_2439B52C953E2E46_OFFSET UNITYSDK_OFFSET(0xB5B6C70)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_32B2368221A04800_OFFSET UNITYSDK_OFFSET(0xB5B3430)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0xB5B7820)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xB5B7740)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_3E7CB6C2B0DD1E2A_OFFSET UNITYSDK_OFFSET(0xB5AF310)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_4C1C6BDA70EF0410_OFFSET UNITYSDK_OFFSET(0xB5B5000)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xB5AF0D0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0xB5B6EA0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_7B0A407379BA27E7_OFFSET UNITYSDK_OFFSET(0xB5B1380)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_83A2D2FF4410F4BE_OFFSET UNITYSDK_OFFSET(0xB5B6DF0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_86C362840A264FF1_1_OFFSET UNITYSDK_OFFSET(0xB5B7A20)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_86C362840A264FF1_OFFSET UNITYSDK_OFFSET(0xB5B7220)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_8A7D3CD51620BD77_OFFSET UNITYSDK_OFFSET(0xB5B23B0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xB5B6EB0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_9823BFA3CE8B5542_OFFSET UNITYSDK_OFFSET(0xB5B7E90)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0xB5B0AD0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_9F84D1FF74319152_OFFSET UNITYSDK_OFFSET(0xB5B6F90)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_A3FAE12D7B6ACD62_1_OFFSET UNITYSDK_OFFSET(0xB5B7950)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xB5B12C0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xB5AFB90)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0xB5AEE00)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_C1D3BDE2A17F5C9D_OFFSET UNITYSDK_OFFSET(0xB5B7660)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_C5E0FC6E1C3C1128_OFFSET UNITYSDK_OFFSET(0xB5B0160)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB5B76E0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_D9694B35503C6004_OFFSET UNITYSDK_OFFSET(0xB5B6980)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0xB5B7040)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0xB5B7E60)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_FB870C37E702D8C7_OFFSET UNITYSDK_OFFSET(0xB5B7050)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_FF5188F77C143723_OFFSET UNITYSDK_OFFSET(0xB5B0980)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB5B5DB0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB5B66A0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB5B6510)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB5AF250)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB5AF010)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB5B67B0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_REMOVECHILDRENVISIBLESTATE_OFFSET UNITYSDK_OFFSET(0xB5B15E0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMEDOFADEOUTTHREADSAFE_OFFSET UNITYSDK_OFFSET(0xB5B3570)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMEDOFADEOUT_OFFSET UNITYSDK_OFFSET(0xB5B3300)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMEDOINACTIVE_OFFSET UNITYSDK_OFFSET(0xB5B3750)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMEGLOBALSPEED_OFFSET UNITYSDK_OFFSET(0xB5B38D0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMEINIT_OFFSET UNITYSDK_OFFSET(0xB5B1AA0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMEINIT_POOLOPT_OFFSET UNITYSDK_OFFSET(0xB5AF460)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMERELEASE_OFFSET UNITYSDK_OFFSET(0xB5B2A40)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMESIMULATE_JOB_OTHER_OFFSET UNITYSDK_OFFSET(0xB5AEF50)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMESIMULATE_JOB_PREPARE_OFFSET UNITYSDK_OFFSET(0xB5AE9F0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMESIMULATE_OFFSET UNITYSDK_OFFSET(0xB5B2E10)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_RUNTIMESIMULATE_RECORD_OFFSET UNITYSDK_OFFSET(0xB5AE960)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_SETINITPHASEACTIVESTATE_OFFSET UNITYSDK_OFFSET(0xB5B58E0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_SETPHASETIMEDURATION_OFFSET UNITYSDK_OFFSET(0xB5B51F0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_SETPHASETIMERATE_OFFSET UNITYSDK_OFFSET(0xB5B2860)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_SETTIMEAT_OFFSET UNITYSDK_OFFSET(0xB5B46C0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_SET_ISRUNTIMEUPDATEREADY_OFFSET UNITYSDK_OFFSET(0xB5B6850)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_SIMULATE_OFFSET UNITYSDK_OFFSET(0xB5B3DA0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_START_OFFSET UNITYSDK_OFFSET(0xB5B6700)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_STOPSELF_OFFSET UNITYSDK_OFFSET(0xB5B3650)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_STOP_OFFSET UNITYSDK_OFFSET(0xB5B4490)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR__CCTOR_OFFSET UNITYSDK_OFFSET(0xB5B68D0)
#define MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR__CTOR_OFFSET UNITYSDK_OFFSET(0xB5B6860)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int NapEffectSimulatorMgr_TypeDefinitionIndex = 77562;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::GameObject*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(NapEffectSimulatorMgr_TypeDefinitionIndex)->GetStaticField(0x33FA0);
		}
		static ::System::Single* StaticGet_DEFAULT_RENDERER_CULLING_DIS()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NapEffectSimulatorMgr_TypeDefinitionIndex)->GetStaticField(0xCE70);
		}
		static ::System::Boolean* StaticGet_USE_VISIBLE_OPT()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(NapEffectSimulatorMgr_TypeDefinitionIndex)->GetStaticField(0xCE74);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_2439B52C953E2E46_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_9E38127F40B34F1F_OFFSET))(this);
		}
		...
		::System::Void Method_5_1DEF7ECEE7F7C088(::System::Boolean a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_EFFECTSIMULATE_NAPEFFECTSIMULATORMGR_METHOD_5_1DEF7ECEE7F7C088_OFFSET))(this, a1);
		}
	};
}
