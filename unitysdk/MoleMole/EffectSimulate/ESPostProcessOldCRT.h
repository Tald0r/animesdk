...
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_1092C5537716905B_OFFSET UNITYSDK_OFFSET(0xE85AB20)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0xE85BB50)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xE85B590)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xE85BAD0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_3622C2D1E940D3F4_OFFSET UNITYSDK_OFFSET(0xE85BBA0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0xE85BC30)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xE85B190)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_3D1D38106B4F16A7_1_OFFSET UNITYSDK_OFFSET(0xE85A450)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_3D1D38106B4F16A7_OFFSET UNITYSDK_OFFSET(0xE859D80)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_429B9EF3AD5C70EB_OFFSET UNITYSDK_OFFSET(0xE85B090)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_43069389B18F0936_OFFSET UNITYSDK_OFFSET(0xE85AF50)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_4ED0F9748169EC7E_OFFSET UNITYSDK_OFFSET(0xE85B470)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_4FB5F56430673EA6_1_OFFSET UNITYSDK_OFFSET(0xE85B360)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_4FB5F56430673EA6_OFFSET UNITYSDK_OFFSET(0xE85B2E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_52CA0F45BC3414DC_OFFSET UNITYSDK_OFFSET(0xE85B7B0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_54BEE211D32F7DEF_OFFSET UNITYSDK_OFFSET(0xE85BB40)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_55D8CF5F1FB0803A_OFFSET UNITYSDK_OFFSET(0xE85BC90)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_581A5078A2F29034_OFFSET UNITYSDK_OFFSET(0xE85BC10)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0xE8578A0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_76CD9B9D1269FA90_OFFSET UNITYSDK_OFFSET(0xE858200)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xE85BAB0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_88B60F3B95FAA4F1_1_OFFSET UNITYSDK_OFFSET(0xE85B1F0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_88B60F3B95FAA4F1_2_OFFSET UNITYSDK_OFFSET(0xE85B3E0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0xE85B100)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xE857A90)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_99F887AAD84BE668_OFFSET UNITYSDK_OFFSET(0xE85AD40)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_A1D8CD775DEC3C21_1_OFFSET UNITYSDK_OFFSET(0xE85BCB0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xE85B280)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_A99467CE9479C990_1_OFFSET UNITYSDK_OFFSET(0xE85BD80)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_A99467CE9479C990_OFFSET UNITYSDK_OFFSET(0xE85BAA0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_B2C24AFA396A3C80_OFFSET UNITYSDK_OFFSET(0xE85AC30)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_B4596DBEA209120C_OFFSET UNITYSDK_OFFSET(0xE85BAC0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_B86122B0EE4F8679_OFFSET UNITYSDK_OFFSET(0xE85B4D0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_BE3471DF7E3D4326_OFFSET UNITYSDK_OFFSET(0xE85BB60)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_C6534C82224A6491_1_OFFSET UNITYSDK_OFFSET(0xE8595D0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_C6534C82224A6491_OFFSET UNITYSDK_OFFSET(0xE858490)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xE85BD20)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE857A30)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_D2A9D107FA1E5A31_OFFSET UNITYSDK_OFFSET(0xE85B020)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_D5F190FE5CE966B3_OFFSET UNITYSDK_OFFSET(0xE85BC20)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_D68547FF19A170E2_OFFSET UNITYSDK_OFFSET(0xE857C50)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0xE85BBB0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_E7F1AECA7CFF8AAD_1_OFFSET UNITYSDK_OFFSET(0xE85BD10)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT_METHOD_5_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0xE85BCA0)
#define MOLEMOLE_EFFECTSIMULATE_ESPOSTPROCESSOLDCRT__CTOR_OFFSET UNITYSDK_OFFSET(0xE85B870)

namespace MoleMole::EffectSimulate
{
	inline static constexpr unsigned int ESPostProcessOldCRT_TypeDefinitionIndex = 68276;
