...
#define MOLEMOLE_BATTLEEVALUTECONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x8E9DDF0)

namespace MoleMole
{
	inline static constexpr unsigned int BattleEvaluteConfigs_TypeDefinitionIndex = 41442;
