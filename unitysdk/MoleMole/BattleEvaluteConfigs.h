...
#define MOLEMOLE_BATTLEEVALUTECONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0xF2A46E0)

namespace MoleMole
{
	inline static constexpr unsigned int BattleEvaluteConfigs_TypeDefinitionIndex = 63182;
