...
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER_GETITEMWIDGET_OFFSET UNITYSDK_OFFSET(0x748DD90)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x748D510)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x748D770)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0x748DCB0)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x748D810)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x748D460)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x748D960)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER_REFRESHSELECTITEM_OFFSET UNITYSDK_OFFSET(0x748DF50)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x748D9E0)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER_SETONSELECT_OFFSET UNITYSDK_OFFSET(0x748D8F0)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x748E180)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER__INITVIEW_B__7_0_OFFSET UNITYSDK_OFFSET(0x748E1C0)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER__INITVIEW_B__7_1_OFFSET UNITYSDK_OFFSET(0x748E240)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x748E250)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x748E2C0)
#define MOLEMOLE_UIPARTNERDATESELECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x748E340)

namespace MoleMole
{
	inline static constexpr unsigned int UIPartnerDateSelectWidgetController_TypeDefinitionIndex = 44030;
