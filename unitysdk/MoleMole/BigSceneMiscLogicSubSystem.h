...
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_BIGSCENETELEPORTFADEOUTBEGIN_OFFSET UNITYSDK_OFFSET(0x84877C0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_BIGSCENETELEPORTFADEOUTEND_OFFSET UNITYSDK_OFFSET(0x84879C0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_CALLSIMPLEMOVETASKCALLBACK_OFFSET UNITYSDK_OFFSET(0x848C5D0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_CHECKISCURRTRACKEDQUESTSTORYMODELOCKED_OFFSET UNITYSDK_OFFSET(0x8488100)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_CLEARHIDDENRENDERLAYERON_OFFSET UNITYSDK_OFFSET(0x8486E60)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_CLEARTWOGROUPSVISIBILITY_OFFSET UNITYSDK_OFFSET(0x8486ED0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_DISPATCHABILITYEVENT_OFFSET UNITYSDK_OFFSET(0x8488930)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_DISPATCHGROUPABILITYEVENT_OFFSET UNITYSDK_OFFSET(0x8488B20)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ENTERBATTLESTATISTICS_OFFSET UNITYSDK_OFFSET(0x8489810)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_EXITBATTLESTATISTICS_OFFSET UNITYSDK_OFFSET(0x8489DE0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_FLIPBATTLESTATISTICSWHENTEAMRELOAD_OFFSET UNITYSDK_OFFSET(0x848BB30)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GETLOADINGPAGETIPSTITLEBYTRANSITIONID_OFFSET UNITYSDK_OFFSET(0x8487BE0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GETMAXACCUMULATIONADJUSTMENT_OFFSET UNITYSDK_OFFSET(0x8488380)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GETPROPERTYADJUSTMENT_OFFSET UNITYSDK_OFFSET(0x8487E60)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GETSTORYMODEMONSTERADJUSTMENTFLAGS_OFFSET UNITYSDK_OFFSET(0x8487DE0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GET_LASTTELEPORTEVENT_OFFSET UNITYSDK_OFFSET(0x8487BC0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_HASINBATTLEENEMYMONSTERALIVE_OFFSET UNITYSDK_OFFSET(0x848B690)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONANYSIMPLEMOVETASKFINISHED_OFFSET UNITYSDK_OFFSET(0x848A1C0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x8486A60)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8486B60)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONDYNAMICEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x848A260)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONENTITYENTERBATTLESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x8489F80)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x8489160)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_ONTELEPORTCOMPLETED_OFFSET UNITYSDK_OFFSET(0x8486F40)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_POPHIDDENRENDERLAYERON_1_OFFSET UNITYSDK_OFFSET(0x848C880)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_POPHIDDENRENDERLAYERON_OFFSET UNITYSDK_OFFSET(0x848C7F0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_POPTWOGROUPSVISIBILITY_1_OFFSET UNITYSDK_OFFSET(0x848CA20)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_POPTWOGROUPSVISIBILITY_OFFSET UNITYSDK_OFFSET(0x848C990)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_PUSHHIDDENRENDERLAYERON_OFFSET UNITYSDK_OFFSET(0x848C760)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_PUSHTWOGROUPSVISIBILITY_OFFSET UNITYSDK_OFFSET(0x848C900)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_REGISTERABILITYEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x84886F0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_REGISTERBASEEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x848A650)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0x8488D80)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_REMOVESIMPLEMOVETASKGRAPHCALLBACK_OFFSET UNITYSDK_OFFSET(0x848C280)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SENDTELEPORTEVENT_OFFSET UNITYSDK_OFFSET(0x8487150)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SETSIMPLEMOVETASKGRAPHCALLBACK_OFFSET UNITYSDK_OFFSET(0x848C0B0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SET_LASTTELEPORTEVENT_OFFSET UNITYSDK_OFFSET(0x8487BD0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SHOWTELEPORTPOINTNAMETIP_OFFSET UNITYSDK_OFFSET(0x8487CC0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SPECIALCOOPUPLOADSTATISTICS_OFFSET UNITYSDK_OFFSET(0x848B910)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_TRYSHOWTELEPORTPOINTNAMETIP_OFFSET UNITYSDK_OFFSET(0x8486FD0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_UNREGISTERABILITYEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x8488880)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_UNREGISTERBASEEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x848AE10)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x848CAA0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM__GENUPLOAD_OFFSET UNITYSDK_OFFSET(0x848B570)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM__SENDAVATARCHANGE_OFFSET UNITYSDK_OFFSET(0x8488580)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x848CDA0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x848CE00)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x848CE60)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM___BASE_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0x848CED0)

namespace MoleMole
{
	inline static constexpr unsigned int BigSceneMiscLogicSubSystem_TypeDefinitionIndex = 59894;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::Object*, ::System::ValueTuple_3<::Foundation::ViewObject::ViewObjectHandle, ::System::Int32, ::System::Action*>>* _simpleMoveTaskGraphCallbacks; // 0x10
		::MoleMole::BigSceneMiscLogicSubSystem_HiddenRenderLayer* _hiddenRenderLayer; // 0x18
		::Class_1_57D808FBDC3F6D5A<::System::UInt16, ::Struct_2_53CBFE47A73426AB>* _dynamicEventListenerMap; // 0x20
		::System::Action_1<::Class_1_B7E341C5F1A6F199*>* _dynamicEventDelegate; // 0x28
		::MoleMole::EntityHandle _localAvatar; // 0x30
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _inBattleMonsters; // 0x40
		::MoleMole::BigSceneMiscLogicSubSystem_TwoGroupsVisibility* _twoGroupsVisibility; // 0x48
		::System::Collections::Generic::List_1<::Class_1_3BC6FFBFA6077E08*>* _abilityEventListenerMap; // 0x50
		::System::Int32 _teleportNewsBubbleTipID; // 0x58
		::MoleMole::BigSceneMiscLogicSubSystem_StoryModeMonsterAdjustmentFlags _storyModeMonsterAdjustmentFlags; // 0x5C
		::System::Boolean _isInBattle; // 0x5E
		::Struct_2_9E75F47F2670B678 _cachedEventMask; // 0x60
		::System::ValueTuple_2<::Enum_3_BAE21DD4C85AF7B9, ::System::Int32> _LastTeleportEvent_k__BackingField; // 0xA0
		::Struct_2_9E75F47F2670B678 _dynamicEventMask; // 0xA8
		...
		::System::ValueTuple_2<::Enum_3_BAE21DD4C85AF7B9, ::System::Int32> get_LastTeleportEvent()
		{
			return ((::System::ValueTuple_2<::Enum_3_BAE21DD4C85AF7B9, ::System::Int32>(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_GET_LASTTELEPORTEVENT_OFFSET))(this);
		}

		::System::Void set_LastTeleportEvent(::System::ValueTuple_2<::Enum_3_BAE21DD4C85AF7B9, ::System::Int32> value)
		{
			return ((::System::Void(*)(::PVOID, ::System::ValueTuple_2<::Enum_3_BAE21DD4C85AF7B9, ::System::Int32>))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SET_LASTTELEPORTEVENT_OFFSET))(this, value);
		}

		::System::Void SendTeleportEvent(::Enum_3_BAE21DD4C85AF7B9 graphEvent, ::System::Int32 teleportID)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_BAE21DD4C85AF7B9, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_SENDTELEPORTEVENT_OFFSET))(this, graphEvent, teleportID);
		}
		...
		static ::System::Boolean CheckIsCurrTrackedQuestStoryModeLocked(::Class_2_208CC9941471731A_582*& curPresetRule, ::System::Boolean isStrict)
		{
			return ((::System::Boolean(*)(::Class_2_208CC9941471731A_582*&, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_CHECKISCURRTRACKEDQUESTSTORYMODELOCKED_OFFSET))(curPresetRule, isStrict);
		}
		...
		::System::ValueTuple_2<::Class_3_BE75AAF0F7C40C75*, ::Enum_3_DB663931210BBC27_25> _GenUpload(::System::Boolean avatarAllKilled)
		{
			return ((::System::ValueTuple_2<::Class_3_BE75AAF0F7C40C75*, ::Enum_3_DB663931210BBC27_25>(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM__GENUPLOAD_OFFSET))(this, avatarAllKilled);
		}
