...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER__SHOWNPCEFFECT_D__109_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x355150)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER__SHOWNPCEFFECT_D__109_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController__ShowNPCEffect_d__109_TypeDefinitionIndex = 41479;

	struct alignas(8) UIActivityRhythmClickPageController__ShowNPCEffect_d__109
	{
		::MoleMole::Battle::Entity* npcEntity; // 0x10
		::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskVoidMethodBuilder __t__builder; // 0x18
		::MoleMole::UIActivityRhythmClickPageController* __4__this; // 0x20
		::MoleMole::UIActivityRhythmClickPageController___c__DisplayClass109_0* __8__1; // 0x28
		::MoleMole::Battle::Entity* effectEntity; // 0x30
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__1; // 0x38
		::System::Action_1<::MoleMole::Battle::Entity*>* onEntityReady; // 0x48
