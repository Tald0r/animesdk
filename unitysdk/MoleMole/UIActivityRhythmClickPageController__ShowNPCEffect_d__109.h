...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER__SHOWNPCEFFECT_D__109_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x35E940)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER__SHOWNPCEFFECT_D__109_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController__ShowNPCEffect_d__109_TypeDefinitionIndex = 42758;
	...
	struct alignas(8) UIActivityRhythmClickPageController__ShowNPCEffect_d__109
	{
		...
		::System::Action_1<::MoleMole::Battle::Entity*>* onEntityReady; // 0x38
		...
		::MoleMole::Battle::Entity* npcEntity; // 0x50
