...
#define MOLEMOLE_UIMODELBGSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x9456970)

namespace MoleMole
{
	inline static constexpr unsigned int UIModelBgSetting_TypeDefinitionIndex = 46991;
