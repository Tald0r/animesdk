...
#define MOLEMOLE_UIMAINCITYCAMERAV2PAGECONTROLLER___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB236A60)
#define MOLEMOLE_UIMAINCITYCAMERAV2PAGECONTROLLER___C__DISPLAYCLASS39_0__STATE_PHOTOMODE_END_B__0_OFFSET UNITYSDK_OFFSET(0xB23A4E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityCameraV2PageController___c__DisplayClass39_0_TypeDefinitionIndex = 46865;
