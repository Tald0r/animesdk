...
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF4B800)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONEQUIPSLOTCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xBF4B3F0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONFOCUSSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xBF4AB40)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xBF4ACB0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xBF4AEE0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONROLEICONBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xBF4B250)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONROWCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xBF4B6A0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA95A8A0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF4A520)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF4B750)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_PLAYCHANGEEQUIPANI_OFFSET UNITYSDK_OFFSET(0xA959B70)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_REFRESHDRESSSTATE_OFFSET UNITYSDK_OFFSET(0xBF4BBC0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_REFRESHEQUIPVIEW_OFFSET UNITYSDK_OFFSET(0xA959F60)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_REFRESHSELECTEDSTATE_OFFSET UNITYSDK_OFFSET(0xBF4B0A0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETAVATARDATA_OFFSET UNITYSDK_OFFSET(0xBF4BA20)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETROBOTDATA_OFFSET UNITYSDK_OFFSET(0xBF4B8A0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETROLEICONSTATE_OFFSET UNITYSDK_OFFSET(0xA9599B0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETSELECTALPHA_OFFSET UNITYSDK_OFFSET(0xBF4ABB0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xBF4B530)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETSLOTCLICKACTION_OFFSET UNITYSDK_OFFSET(0xBF4B4C0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETUISTATE_OFFSET UNITYSDK_OFFSET(0xBF4BE00)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA95AA30)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA95AAE0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA95AB50)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xA95ABC0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA95AC20)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA95ACA0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA95AD00)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopEquipGroupWidgetController_TypeDefinitionIndex = 51110;
