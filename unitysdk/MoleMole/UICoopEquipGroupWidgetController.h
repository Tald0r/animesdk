...
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBEE8D90)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONEQUIPSLOTCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xBEE8980)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONFOCUSSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xBEE80C0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xBEE8230)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xBEE8460)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONROLEICONBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xBEE87D0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONROWCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xBEE8C30)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBEEA2E0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBEE7AA0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBEE8CE0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_PLAYCHANGEEQUIPANI_OFFSET UNITYSDK_OFFSET(0xBEE9CD0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_REFRESHDRESSSTATE_OFFSET UNITYSDK_OFFSET(0xBEE9A90)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_REFRESHEQUIPVIEW_OFFSET UNITYSDK_OFFSET(0xBEE8FB0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_REFRESHSELECTEDSTATE_OFFSET UNITYSDK_OFFSET(0xBEE8620)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETAVATARDATA_OFFSET UNITYSDK_OFFSET(0xBEE9900)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETROBOTDATA_OFFSET UNITYSDK_OFFSET(0xBEE8E30)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETROLEICONSTATE_OFFSET UNITYSDK_OFFSET(0xBEEA120)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETSELECTALPHA_OFFSET UNITYSDK_OFFSET(0xBEE8130)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xBEE8AC0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETSLOTCLICKACTION_OFFSET UNITYSDK_OFFSET(0xBEE8A50)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER_SETUISTATE_OFFSET UNITYSDK_OFFSET(0xBEEA0B0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBEEA470)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBEEA520)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xBEEA590)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xBEEA600)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBEEA660)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBEEA6E0)
#define MOLEMOLE_UICOOPEQUIPGROUPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBEEA740)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopEquipGroupWidgetController_TypeDefinitionIndex = 74832;
	...
	public:
		...
		::Class_2_E55F60BF63BB02E0* _view; // 0x2A0
		::Class_2_C04F87C132BA9A06* _coopModel; // 0x2A8
		::System::Collections::Generic::List_1<::MoleMole::UICoopEquipRowWidgetController*>* _rowWidgets; // 0x2B0
		::System::Action_1<::System::Int32>* _slotCkickAcction; // 0x2B8
		::System::Int32 _selectedSlotID; // 0x2C0
		::System::Int32 _avatarID; // 0x2C4
		::System::Int32 _robotID; // 0x2C8
		::MoleMole::UIGeneralIconCardRarityWidgetController* _rarityWidget; // 0x2D0
		::System::Boolean _isAvatarType; // 0x2D8
		::Foundation::Coroutine::CoroutineHandle _fadeCoroutineHandle; // 0x2DC
		::System::Int32 _lastEquipID; // 0x2E0
