...
#define MOLEMOLE_COMMANDLINEPARTICLEQUALITY_METHOD_2_927E546B2D95E0F1_OFFSET UNITYSDK_OFFSET(0x96F3900)
#define MOLEMOLE_COMMANDLINEPARTICLEQUALITY_METHOD_2_F0A11B4DDDFB2408_OFFSET UNITYSDK_OFFSET(0x96F3AB0)
#define MOLEMOLE_COMMANDLINEPARTICLEQUALITY__CTOR_OFFSET UNITYSDK_OFFSET(0x96F3A70)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineParticleQuality_TypeDefinitionIndex = 58742;
