...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__WAITINTERACT_D__53_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x876E380)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__WAITINTERACT_D__53_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x876E4A0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__WAITINTERACT_D__53_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x876E500)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__WAITINTERACT_D__53_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x876E4B0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__WAITINTERACT_D__53_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x876E370)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__WAITINTERACT_D__53__CTOR_OFFSET UNITYSDK_OFFSET(0x876E360)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController__WaitInteract_d__53_TypeDefinitionIndex = 69007;
