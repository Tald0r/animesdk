...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__WAITINTERACT_D__53_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x98BB160)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__WAITINTERACT_D__53_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x98BB280)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__WAITINTERACT_D__53_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x98BB2E0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__WAITINTERACT_D__53_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x98BB290)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__WAITINTERACT_D__53_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x98BB150)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER__WAITINTERACT_D__53__CTOR_OFFSET UNITYSDK_OFFSET(0x98BB140)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController__WaitInteract_d__53_TypeDefinitionIndex = 53839;
	...
	public:
		...
		::System::Single _MaxWait_5__2; // 0x28
