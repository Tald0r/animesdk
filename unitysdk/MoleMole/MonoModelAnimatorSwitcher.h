...
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_CHECKDELAYDISABLE_OFFSET UNITYSDK_OFFSET(0x7A92780)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_GETMODELSETINDEX_OFFSET UNITYSDK_OFFSET(0x7A92640)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_GET_NEEDUPDATEDELAYANIMATORDISABLE_OFFSET UNITYSDK_OFFSET(0x7A92620)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_METHOD_5_7A2E89572E7E9DB4_OFFSET UNITYSDK_OFFSET(0x7A92940)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_SETMODELSETACTIVE_OFFSET UNITYSDK_OFFSET(0x7A92A80)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_SET_NEEDUPDATEDELAYANIMATORDISABLE_OFFSET UNITYSDK_OFFSET(0x7A92630)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER_SWITCHMODELSET_OFFSET UNITYSDK_OFFSET(0x7A929C0)
#define MOLEMOLE_MONOMODELANIMATORSWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x7A92D10)

namespace MoleMole
{
	inline static constexpr unsigned int MonoModelAnimatorSwitcher_TypeDefinitionIndex = 61880;
