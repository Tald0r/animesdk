...
#define MOLEMOLE_UIHANDBOOKTOWERITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C37390)
#define MOLEMOLE_UIHANDBOOKTOWERITEMWIDGETCONTROLLER_ONJUMPCLICK_OFFSET UNITYSDK_OFFSET(0x8C39500)
#define MOLEMOLE_UIHANDBOOKTOWERITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8C37510)
#define MOLEMOLE_UIHANDBOOKTOWERITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C37430)
#define MOLEMOLE_UIHANDBOOKTOWERITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C370B0)
#define MOLEMOLE_UIHANDBOOKTOWERITEMWIDGETCONTROLLER_REFRESHREWARDS_OFFSET UNITYSDK_OFFSET(0x8C38490)
#define MOLEMOLE_UIHANDBOOKTOWERITEMWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x8C383E0)
#define MOLEMOLE_UIHANDBOOKTOWERITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C39750)
#define MOLEMOLE_UIHANDBOOKTOWERITEMWIDGETCONTROLLER__ONJUMPCLICK_B__9_0_OFFSET UNITYSDK_OFFSET(0x8C39760)
#define MOLEMOLE_UIHANDBOOKTOWERITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C39820)
#define MOLEMOLE_UIHANDBOOKTOWERITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8C39890)
#define MOLEMOLE_UIHANDBOOKTOWERITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C39910)
#define MOLEMOLE_UIHANDBOOKTOWERITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C39990)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookTowerItemWidgetController_TypeDefinitionIndex = 80854;

	class UIHandBookTowerItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::System::Int32 towerId; // 0x2D0
		::Class_2_79AE422BA06F6D26_179* _view; // 0x2D8
		::Class_2_208CC9941471731A_499* _data; // 0x2E0
