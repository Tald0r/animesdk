...
#define MOLEMOLE_UIVRBOSSBATTLEINFOPAGECONTROLLER___C__DISPLAYCLASS50_1__CTOR_OFFSET UNITYSDK_OFFSET(0xAA767F0)
#define MOLEMOLE_UIVRBOSSBATTLEINFOPAGECONTROLLER___C__DISPLAYCLASS50_1__GOSINGLEPLAYREAL_B__2_OFFSET UNITYSDK_OFFSET(0xAA76800)

namespace MoleMole
{
	inline static constexpr unsigned int UIVRBossBattleInfoPageController___c__DisplayClass50_1_TypeDefinitionIndex = 49344;
	...
	public:
		...
		::Enum_3_DB663931210BBC27_26 noReward; // 0x1C
