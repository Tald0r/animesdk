...
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER_BINDSPEEDTYPE_OFFSET UNITYSDK_OFFSET(0xA6CF680)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA6CE5B0)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA6CE720)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xA6CE920)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA6CE620)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA6CF030)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA6CE7D0)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER_REFRESHUIPERFORM_OFFSET UNITYSDK_OFFSET(0xA6CED90)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER_SETGUIDEUIWARNNING_OFFSET UNITYSDK_OFFSET(0xA6CF4C0)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER_SETICONWARNING_OFFSET UNITYSDK_OFFSET(0xA6CF400)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER__BINDSPEEDTYPE_B__18_0_OFFSET UNITYSDK_OFFSET(0xA6CFB30)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA6CF940)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER__ONUIINIT_B__12_0_OFFSET UNITYSDK_OFFSET(0xA6CF980)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER__ONUIINIT_B__12_1_OFFSET UNITYSDK_OFFSET(0xA6CFA00)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA6CFC70)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA6CFCD0)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA6CFD40)
#define MOLEMOLE_UIURBANMAPHUDROWPOINTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA6CFDB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapHUDRowPointWidgetController_TypeDefinitionIndex = 42250;
