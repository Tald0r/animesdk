...
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT_BUILDRT_OFFSET UNITYSDK_OFFSET(0xCFC8F10)
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT_GET_UNIT_OFFSET UNITYSDK_OFFSET(0xCFC8EE0)
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT_RELEASE_OFFSET UNITYSDK_OFFSET(0xCFC9020)
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT_SET_UNIT_OFFSET UNITYSDK_OFFSET(0xCFC8EF0)
#define MOLEMOLE_UILINEUPSELECTPAGECONTROLLER_UIBUDDYSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCFC8F00)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectPageController_UIBuddySelect_TypeDefinitionIndex = 57346;
