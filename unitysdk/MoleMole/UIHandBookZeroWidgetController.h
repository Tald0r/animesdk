...
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_DOJUMP_OFFSET UNITYSDK_OFFSET(0xB2CFD50)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_HBTOABYSSENUM_OFFSET UNITYSDK_OFFSET(0xB2CED40)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB2CFBD0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xB2CFAF0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONREWARDBTNCLICK_OFFSET UNITYSDK_OFFSET(0xB2D0B60)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONSHOPBTNCLICK_OFFSET UNITYSDK_OFFSET(0x8929EB0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB2CF850)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2CFC70)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB2CEDC0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB2CF690)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_REFRESHBUTTONSTATES_OFFSET UNITYSDK_OFFSET(0xB2D0890)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_REFRESHHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xB2D0010)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_REFRESHREDEEM_OFFSET UNITYSDK_OFFSET(0xB2CF920)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB2CF7B0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER_UILOCKCHANGEDHANDLE_OFFSET UNITYSDK_OFFSET(0x892A2F0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x892A360)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER__DOJUMP_B__15_0_OFFSET UNITYSDK_OFFSET(0x892A400)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x892A550)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x892A5C0)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x892A620)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x892A690)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x892A710)
#define MOLEMOLE_UIHANDBOOKZEROWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x892A770)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookZeroWidgetController_TypeDefinitionIndex = 61345;
	...
	public:
		...
		::Il2CppArray<::Class_2_208CC9941471731A_848*>* _entries; // 0x2B0
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_848*>* _scrollEntries; // 0x2B8
		::Class_2_79F6D62CE30E3F8E_20* _view; // 0x2C0
