...
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SELECTIMAGE_DOALPHAOFFSET_OFFSET UNITYSDK_OFFSET(0xC8B9590)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SELECTIMAGE_SELECT_OFFSET UNITYSDK_OFFSET(0xC8B9840)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SELECTIMAGE_SETALPHAOFFSET_OFFSET UNITYSDK_OFFSET(0xC8B9300)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SELECTIMAGE_SETITEM_1_OFFSET UNITYSDK_OFFSET(0xC8B9290)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SELECTIMAGE_SETITEM_OFFSET UNITYSDK_OFFSET(0xC8B9220)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SELECTIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC8BA0D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryRow03ChildWindowController_SelectImage_TypeDefinitionIndex = 77810;
