...
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADC01E0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADC0280)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADBFCD0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADBFD70)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER_SHOWSCORECHANGE_OFFSET UNITYSDK_OFFSET(0xADBFEA0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER_SHOWSCORE_OFFSET UNITYSDK_OFFSET(0xADC0580)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xADC0930)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER__SHOWSCORECHANGE_B__5_0_OFFSET UNITYSDK_OFFSET(0xADC0960)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADC0970)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADC09E0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADC0A60)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADC0AC0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSingleBubbleScoreChangeV2WidgetController_TypeDefinitionIndex = 71863;
