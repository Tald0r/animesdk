...
#define MOLEMOLE_CONFIGSTAIRVELOCITYMODIFIER_CONFIGSTAIRVELOCITYMODIFIER_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xB482B90)
#define MOLEMOLE_CONFIGSTAIRVELOCITYMODIFIER_CONFIGSTAIRVELOCITYMODIFIER_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xB482BA0)
#define MOLEMOLE_CONFIGSTAIRVELOCITYMODIFIER_CONFIGSTAIRVELOCITYMODIFIER_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xB482CF0)
#define MOLEMOLE_CONFIGSTAIRVELOCITYMODIFIER_CONFIGSTAIRVELOCITYMODIFIER_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xB482E50)
#define MOLEMOLE_CONFIGSTAIRVELOCITYMODIFIER_CONFIGSTAIRVELOCITYMODIFIER_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB482E10)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigStairVelocityModifier_ConfigStairVelocityModifier_UnityGeneratedFormatter_TypeDefinitionIndex = 37942;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(ConfigStairVelocityModifier_ConfigStairVelocityModifier_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x47810);
		}
