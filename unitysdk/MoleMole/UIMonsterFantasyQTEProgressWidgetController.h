...
#define MOLEMOLE_UIMONSTERFANTASYQTEPROGRESSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA423710)
#define MOLEMOLE_UIMONSTERFANTASYQTEPROGRESSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4237B0)
#define MOLEMOLE_UIMONSTERFANTASYQTEPROGRESSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA423520)
#define MOLEMOLE_UIMONSTERFANTASYQTEPROGRESSWIDGETCONTROLLER_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0xA4238F0)
#define MOLEMOLE_UIMONSTERFANTASYQTEPROGRESSWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA423AC0)
#define MOLEMOLE_UIMONSTERFANTASYQTEPROGRESSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA423A90)
#define MOLEMOLE_UIMONSTERFANTASYQTEPROGRESSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA423B00)
#define MOLEMOLE_UIMONSTERFANTASYQTEPROGRESSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA423B70)
#define MOLEMOLE_UIMONSTERFANTASYQTEPROGRESSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA423BF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyQTEProgressWidgetController_TypeDefinitionIndex = 77388;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMonsterFantasyQTEProgressWidgetController_TypeDefinitionIndex)->GetStaticField(0xD070);
		}
		::Class_2_22FEBBA7FA4D4D4A_9* _view; // 0x2A0
