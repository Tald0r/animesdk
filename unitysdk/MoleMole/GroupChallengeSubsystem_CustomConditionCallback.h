...
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CUSTOMCONDITIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xE486730)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CUSTOMCONDITIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xE486780)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CUSTOMCONDITIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xE486430)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CUSTOMCONDITIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xE486420)

namespace MoleMole
{
	inline static constexpr unsigned int GroupChallengeSubsystem_CustomConditionCallback_TypeDefinitionIndex = 54509;
