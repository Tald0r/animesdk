...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS85_1__CTOR_OFFSET UNITYSDK_OFFSET(0xB23E530)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS85_1__INITPERSONALLINE_B__0_OFFSET UNITYSDK_OFFSET(0xB23E540)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS85_1__INITPERSONALLINE_B__1_OFFSET UNITYSDK_OFFSET(0xB23ECE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController___c__DisplayClass85_1_TypeDefinitionIndex = 71445;
