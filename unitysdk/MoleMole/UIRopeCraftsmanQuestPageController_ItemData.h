...
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ITEMDATA_ISLOCK_OFFSET UNITYSDK_OFFSET(0xB53C570)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ITEMDATA_ISOPEN_OFFSET UNITYSDK_OFFSET(0xB53C760)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ITEMDATA_SHOWLOCKGENERALTIPS_OFFSET UNITYSDK_OFFSET(0xB53C950)
#define MOLEMOLE_UIROPECRAFTSMANQUESTPAGECONTROLLER_ITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB53C9F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRopeCraftsmanQuestPageController_ItemData_TypeDefinitionIndex = 54070;

	class UIRopeCraftsmanQuestPageController_ItemData : public ::System::Object
	{
	public:
		::System::String* FinishDesc; // 0x10
		::System::String* TaskDes; // 0x18
