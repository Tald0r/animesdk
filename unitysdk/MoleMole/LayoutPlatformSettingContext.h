...
#define MOLEMOLE_LAYOUTPLATFORMSETTINGCONTEXT_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xB9938E0)
#define MOLEMOLE_LAYOUTPLATFORMSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB993E10)
#define MOLEMOLE_LAYOUTPLATFORMSETTINGCONTEXT___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xB993E30)

namespace MoleMole
{
	inline static constexpr unsigned int LayoutPlatformSettingContext_TypeDefinitionIndex = 80103;
