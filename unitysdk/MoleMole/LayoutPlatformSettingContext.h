...
#define MOLEMOLE_LAYOUTPLATFORMSETTINGCONTEXT_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xF1B81D0)
#define MOLEMOLE_LAYOUTPLATFORMSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xF1B8700)
#define MOLEMOLE_LAYOUTPLATFORMSETTINGCONTEXT___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xF1B8720)

namespace MoleMole
{
	inline static constexpr unsigned int LayoutPlatformSettingContext_TypeDefinitionIndex = 47280;
