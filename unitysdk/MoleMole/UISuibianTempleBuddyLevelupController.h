...
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0x9A18170)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_CALCURITEMMAX_OFFSET UNITYSDK_OFFSET(0x9A19FE0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_CLEARMATERIAL_OFFSET UNITYSDK_OFFSET(0x9A1A380)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_GETALLSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0x9A196E0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_GETSELECTLEVELUPMATERIALEXCEPTI_OFFSET UNITYSDK_OFFSET(0x9A19C40)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x9A18AB0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x9A17A50)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x9A1CE90)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONCLICKBTN1_OFFSET UNITYSDK_OFFSET(0x9A1A7F0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONCLICKBTN2_OFFSET UNITYSDK_OFFSET(0x9A1B0D0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONCLICKMATITEM_OFFSET UNITYSDK_OFFSET(0x9A1B180)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x9A1C820)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9A1D960)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9A17DD0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A1A560)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9A18920)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_REFRESHLEVELUPINPUTKEY_OFFSET UNITYSDK_OFFSET(0x9A1CA10)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x9A18850)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_SETCONSUME_OFFSET UNITYSDK_OFFSET(0x9A1BA50)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_SETPARENTVIEW_OFFSET UNITYSDK_OFFSET(0x9A176B0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x9A194B0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_TRIGGERGAMEPADADDBTN_OFFSET UNITYSDK_OFFSET(0x9A1CF60)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_TRIGGERGAMEPADREDUCEBTN_OFFSET UNITYSDK_OFFSET(0x9A1D460)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER_UPDATETEMPLEBUDDY_OFFSET UNITYSDK_OFFSET(0x9A18B60)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__23_0_OFFSET UNITYSDK_OFFSET(0x9A1E8D0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__23_1_OFFSET UNITYSDK_OFFSET(0x9A1EA30)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__23_2_OFFSET UNITYSDK_OFFSET(0x9A1EB80)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__23_3_OFFSET UNITYSDK_OFFSET(0x9A1ED80)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__23_4_OFFSET UNITYSDK_OFFSET(0x9A1EF80)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__23_5_OFFSET UNITYSDK_OFFSET(0x9A1F0C0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__BUILDVIEWMODELDATABINDING_B__23_6_OFFSET UNITYSDK_OFFSET(0x9A1F2A0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A1E510)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__ONUIOPEN_B__14_0_OFFSET UNITYSDK_OFFSET(0x9A1E6D0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER__SETPARENTVIEW_B__11_0_OFFSET UNITYSDK_OFFSET(0x9A1E620)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x9A1F3E0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x9A1F440)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9A1F4C0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9A1F4F0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A1F560)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYLEVELUPCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9A1F5E0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleBuddyLevelupController_TypeDefinitionIndex = 70074;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_128* _view; // 0x2A0
