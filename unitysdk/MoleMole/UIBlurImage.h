...
#define MOLEMOLE_UIBLURIMAGE_AWAKE_OFFSET UNITYSDK_OFFSET(0x8BBA0B0)
#define MOLEMOLE_UIBLURIMAGE_HANDLEEVENTS_OFFSET UNITYSDK_OFFSET(0x8BBAD50)
#define MOLEMOLE_UIBLURIMAGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x8BBA400)
#define MOLEMOLE_UIBLURIMAGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8BBA150)
#define MOLEMOLE_UIBLURIMAGE_UPDATE_OFFSET UNITYSDK_OFFSET(0x8BBA6E0)
#define MOLEMOLE_UIBLURIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x8BBAF10)
#define MOLEMOLE_UIBLURIMAGE___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x8BBAF80)
#define MOLEMOLE_UIBLURIMAGE___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x8BBB010)
#define MOLEMOLE_UIBLURIMAGE___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8BBB0D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBlurImage_TypeDefinitionIndex = 64888;
