...
#define MOLEMOLE_GIZMOSUTILSBEHAVIOR_CLEARINSTANCE_OFFSET UNITYSDK_OFFSET(0xC9D0B10)
#define MOLEMOLE_GIZMOSUTILSBEHAVIOR_FINDINSTANCE_OFFSET UNITYSDK_OFFSET(0xC9D0930)
#define MOLEMOLE_GIZMOSUTILSBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D0CD0)

namespace MoleMole
{
	inline static constexpr unsigned int GizmosUtilsBehavior_TypeDefinitionIndex = 39675;
