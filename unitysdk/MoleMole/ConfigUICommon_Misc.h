...
#define MOLEMOLE_CONFIGUICOMMON_MISC__CTOR_OFFSET UNITYSDK_OFFSET(0x13FAF890)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_Misc_TypeDefinitionIndex = 54621;
