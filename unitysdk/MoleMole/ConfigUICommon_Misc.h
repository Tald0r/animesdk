...
#define MOLEMOLE_CONFIGUICOMMON_MISC__CTOR_OFFSET UNITYSDK_OFFSET(0xF2E95C0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_Misc_TypeDefinitionIndex = 42280;
