...
#define MOLEMOLE_MONOMODELSHAPE_FETCHMODELSHAPE_OFFSET UNITYSDK_OFFSET(0xB3B8400)
#define MOLEMOLE_MONOMODELSHAPE_GETSHAPECAPACITY_OFFSET UNITYSDK_OFFSET(0xB3B8320)
#define MOLEMOLE_MONOMODELSHAPE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xB3B85E0)
#define MOLEMOLE_MONOMODELSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0xB3B8640)

namespace MoleMole
{
	inline static constexpr unsigned int MonoModelShape_TypeDefinitionIndex = 55207;
