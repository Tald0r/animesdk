...
#define MOLEMOLE_MONOMODELSHAPE_FETCHMODELSHAPE_OFFSET UNITYSDK_OFFSET(0xA650270)
#define MOLEMOLE_MONOMODELSHAPE_GETSHAPECAPACITY_OFFSET UNITYSDK_OFFSET(0xA650190)
#define MOLEMOLE_MONOMODELSHAPE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xA650450)
#define MOLEMOLE_MONOMODELSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0xA6504B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoModelShape_TypeDefinitionIndex = 67498;
