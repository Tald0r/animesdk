...
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_FILTERAUDIOEVENTLIST_OFFSET UNITYSDK_OFFSET(0xA914DA0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_FORCESTOPPLAYVOICE_OFFSET UNITYSDK_OFFSET(0xA915AF0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_GETLASTPLAYEDROWIDX_OFFSET UNITYSDK_OFFSET(0xA912830)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_GET_ISLASTAUDIOFINISH_OFFSET UNITYSDK_OFFSET(0xA912440)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_GET__ISPLAYINGAUDIO_OFFSET UNITYSDK_OFFSET(0xA914D20)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA912B20)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_MUTEBTNCLICKSOUND_OFFSET UNITYSDK_OFFSET(0xA915B60)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONCLICKPLAYSOUND_OFFSET UNITYSDK_OFFSET(0xA914AD0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONCLICKSHOWMODEL_OFFSET UNITYSDK_OFFSET(0xA9144F0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA913480)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONGAMEPADITEMSELECTED_OFFSET UNITYSDK_OFFSET(0xA913520)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA9128D0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONSTOPAUDIOEVENTLIST_OFFSET UNITYSDK_OFFSET(0xA915A30)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_ONSTOPVOICE_OFFSET UNITYSDK_OFFSET(0xA915970)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_PLAYAUDIOEVENTLIST_OFFSET UNITYSDK_OFFSET(0xA914FC0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_PLAYVOICE_OFFSET UNITYSDK_OFFSET(0xA915320)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xA912A20)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_SETPLAYVOICEBTNSTATE_OFFSET UNITYSDK_OFFSET(0xA915780)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0xA9135F0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_SETVOICEICONSTATE_OFFSET UNITYSDK_OFFSET(0xA913EC0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER_STOPALLAUDIOINSELECTEDROW_OFFSET UNITYSDK_OFFSET(0xA9124D0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA915CB0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA915CA0)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA915D30)
#define MOLEMOLE_UIGALGAMEREVIEWROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA915DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgameReviewRowWidgetController_TypeDefinitionIndex = 63947;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(UIGalgameReviewRowWidgetController_TypeDefinitionIndex)->GetStaticField(0x38B90);
		}
		static ::System::UInt32* StaticGet_lastItemVoicePendingId()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(UIGalgameReviewRowWidgetController_TypeDefinitionIndex)->GetStaticField(0xE0E0);
		}
		static ::System::Int32* StaticGet_lastPlayedRowIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIGalgameReviewRowWidgetController_TypeDefinitionIndex)->GetStaticField(0xE0E4);
		}
		static ::System::Boolean* StaticGet_isLastVoiceFinish()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIGalgameReviewRowWidgetController_TypeDefinitionIndex)->GetStaticField(0xE0E8);
		}
		static ::System::Boolean* StaticGet_isLastAudioEventListFinish()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIGalgameReviewRowWidgetController_TypeDefinitionIndex)->GetStaticField(0xE0E9);
		}
		// static const ::System::String* _LOOP_ANIM_CLIP; // 0x0
