...
#define MOLEMOLE_SPRINGGOGOSHOWOBJ_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xA65FC30)
#define MOLEMOLE_SPRINGGOGOSHOWOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0xA65FBF0)

namespace MoleMole
{
	inline static constexpr unsigned int SpringGoGoShowObj_TypeDefinitionIndex = 46556;
