...
#define MOLEMOLE_MONOCAMERATRIGGERACTION_METHOD_5_573D3230AE2716FB_OFFSET UNITYSDK_OFFSET(0xA636D30)
#define MOLEMOLE_MONOCAMERATRIGGERACTION_TRIGGERVCAMPOINTCLEAR_OFFSET UNITYSDK_OFFSET(0xA637410)
#define MOLEMOLE_MONOCAMERATRIGGERACTION_TRIGGERVCAMPOINTENTER_OFFSET UNITYSDK_OFFSET(0xA6366B0)
#define MOLEMOLE_MONOCAMERATRIGGERACTION_TRIGGERVCAMPOINTEXIT_OFFSET UNITYSDK_OFFSET(0xA637490)
#define MOLEMOLE_MONOCAMERATRIGGERACTION__CCTOR_OFFSET UNITYSDK_OFFSET(0xA637530)
#define MOLEMOLE_MONOCAMERATRIGGERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA637510)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCameraTriggerAction_TypeDefinitionIndex = 50999;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoCameraTriggerAction_TypeDefinitionIndex)->GetStaticField(0xF7E0);
		}
