...
#define MOLEMOLE_ROLETWEAKCOLORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB9AFAF0)

namespace MoleMole
{
	inline static constexpr unsigned int RoleTweakColorData_TypeDefinitionIndex = 72112;
