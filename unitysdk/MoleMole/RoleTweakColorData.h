...
#define MOLEMOLE_ROLETWEAKCOLORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD81F4E0)

namespace MoleMole
{
	inline static constexpr unsigned int RoleTweakColorData_TypeDefinitionIndex = 37792;
