...
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC244A30)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC244CB0)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC244BD0)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC244990)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC245440)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC245450)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC2454C0)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC245540)
#define MOLEMOLE_UIABYSSARPEGGIOTALENTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC2455C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssArpeggioTalentRowWidgetController_TypeDefinitionIndex = 48244;

	class UIAbyssArpeggioTalentRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_BB7F5BC060EB063F* _view; // 0x2D0
		::Class_1_A2FCB0C4C9740099* rowData; // 0x2D8
		::System::Collections::Generic::List_1<::MoleMole::UIAbyssArpeggioTalentItemWidgetController*>* talentItems; // 0x2E0
