...
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_BINDEVENT_BUTTON_OFFSET UNITYSDK_OFFSET(0xABD1B30)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_BINDEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0xABD1FA0)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_BINDEVENT_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xABD1D60)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0xABD2050)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_GET_CURRENTAREA_OFFSET UNITYSDK_OFFSET(0xABD4720)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xABD19F0)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_INITCLUEAREADATA_OFFSET UNITYSDK_OFFSET(0xABD21B0)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_INITCLUEDATA_OFFSET UNITYSDK_OFFSET(0xABD40A0)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xABD1A00)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_ONCURRENTAREACHANGE_OFFSET UNITYSDK_OFFSET(0xABD3DB0)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xABD3340)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xABD2EB0)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xABD2C00)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xABD2E20)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xABD1AA0)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_ONWORKBENCHDATAUPDATE_OFFSET UNITYSDK_OFFSET(0xABD46B0)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_SCROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0xABD3680)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_SELECTEDCLUEAREA_OFFSET UNITYSDK_OFFSET(0xABD3BA0)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_SELECTEDCLUE_OFFSET UNITYSDK_OFFSET(0xABD44E0)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_SET_CURRENTAREA_OFFSET UNITYSDK_OFFSET(0xABD3D20)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER__BINDEVENT_BUTTON_B__12_0_OFFSET UNITYSDK_OFFSET(0xABD4900)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER__BINDEVENT_SCROLLVIEW_B__13_0_OFFSET UNITYSDK_OFFSET(0xABD4A00)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xABD4730)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6AE6190)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x6AE6200)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x6AE6280)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x6AE62B0)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6AE62C0)
#define MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6AE62D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchInformation02PageController_TypeDefinitionIndex = 42286;

	class UIWorkBenchInformation02PageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_C8673CF268A973E6* _view; // 0x2F8
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_363*>*>* _limboPhaseClueAreaTemplateDic; // 0x300
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_363*>*>* _clueAreaPhaseDatas; // 0x308
		::System::Collections::Generic::List_1<::System::Int32>* _clueAreaPhaseDatasKeys; // 0x310
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_363*>* _clueAreaTemplateDatas; // 0x318
		::System::Collections::Generic::List_1<::Class_2_6D99A03C58ED2B6E*>* _clueTemplateDatas; // 0x320
		::Class_2_208CC9941471731A_363* _currentArea; // 0x328
		...
		::System::Void OnCurrentAreaChange(::Class_2_208CC9941471731A_363* oldValue, ::Class_2_208CC9941471731A_363* newValue)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_363*, ::Class_2_208CC9941471731A_363*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_ONCURRENTAREACHANGE_OFFSET))(this, oldValue, newValue);
		}
		...
		::Class_2_208CC9941471731A_363* get_currentArea()
		{
			return ((::Class_2_208CC9941471731A_363*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_GET_CURRENTAREA_OFFSET))(this);
		}

		::System::Void set_currentArea(::Class_2_208CC9941471731A_363* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_363*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIWORKBENCHINFORMATION02PAGECONTROLLER_SET_CURRENTAREA_OFFSET))(this, value);
		}
