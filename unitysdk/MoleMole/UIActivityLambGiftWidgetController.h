...
class Class_2_BB733E8D14A4052D;
...
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_CREATENORMALITEMROW_OFFSET UNITYSDK_OFFSET(0x7F4D880)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_CREATESPECIALITEMROW_OFFSET UNITYSDK_OFFSET(0x7F4D960)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0x7F4D800)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F4C860)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x7F4C900)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONLEVELUP_OFFSET UNITYSDK_OFFSET(0x7F4D570)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONOPENLAMBGIFTWIDGET_OFFSET UNITYSDK_OFFSET(0x7F4C560)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7F4C730)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F4C9F0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F4C220)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F4C3A0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_OPENDETAIL_OFFSET UNITYSDK_OFFSET(0x7F4D780)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_REFRESHBACKGROUND_OFFSET UNITYSDK_OFFSET(0x7F4D1A0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_REFRESHINIT_OFFSET UNITYSDK_OFFSET(0x7F4CDE0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_REFRESHREMAINTIMERTEXT_OFFSET UNITYSDK_OFFSET(0x7F4D450)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER_REFRESHTASKLIST_OFFSET UNITYSDK_OFFSET(0x7F4CBE0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F4DA40)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F4DA70)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x7F4DAE0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7F4DAF0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F4DB00)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F4DB10)
#define MOLEMOLE_UIACTIVITYLAMBGIFTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F4DB70)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityLambGiftWidgetController_TypeDefinitionIndex = 74294;

	class UIActivityLambGiftWidgetController : public ::MoleMole::ActivityGuideUIBaseWidgetController
	{
	public:
		::Class_2_BB733E8D14A4052D* _view; // 0x2C8
		::System::Collections::Generic::List_1<::Class_1_B08665FEB7112467_2*>* rewardContextList; // 0x2D0
