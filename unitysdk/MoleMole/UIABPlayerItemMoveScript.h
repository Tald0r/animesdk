...
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_AWAKE_OFFSET UNITYSDK_OFFSET(0xD39A990)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_ISMOVING_OFFSET UNITYSDK_OFFSET(0xD39AE30)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0xD39AA40)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_SETTARGETPOS_OFFSET UNITYSDK_OFFSET(0xD39ACE0)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_STARTMOVE_OFFSET UNITYSDK_OFFSET(0xD39ADD0)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_STOPMOVE_OFFSET UNITYSDK_OFFSET(0xD39AE90)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT_TICK_OFFSET UNITYSDK_OFFSET(0xD39AAD0)
#define MOLEMOLE_UIABPLAYERITEMMOVESCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0xD39AF00)

namespace MoleMole
{
	inline static constexpr unsigned int UIABPlayerItemMoveScript_TypeDefinitionIndex = 44068;
