...
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_AFTERMOUSEPOSSETHANDLE_OFFSET UNITYSDK_OFFSET(0x90FC760)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_CLAMPDIRECTIONVALUE_OFFSET UNITYSDK_OFFSET(0x90FDC40)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_CLICKBUTTON_OFFSET UNITYSDK_OFFSET(0x90FF6D0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_DOWNBUTTON_OFFSET UNITYSDK_OFFSET(0x9100170)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ENABLEINPUT_OFFSET UNITYSDK_OFFSET(0x90F9DC0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GETDIRECTIONANDANGLE2D_OFFSET UNITYSDK_OFFSET(0x90FFC30)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GETIGNOREFADING_OFFSET UNITYSDK_OFFSET(0x90F9520)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GETINDEXDIRECTIONVALUE_OFFSET UNITYSDK_OFFSET(0x90FC9C0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GETRINGINNERRADIUS_OFFSET UNITYSDK_OFFSET(0x90FF0B0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GETTARGETVIEW_OFFSET UNITYSDK_OFFSET(0x9100600)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GETVECTORINDEX_OFFSET UNITYSDK_OFFSET(0x90FE810)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GET_IGNOREFADING_OFFSET UNITYSDK_OFFSET(0x90F94C0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GET_PLATFORMNEEDREFRESHROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0x90FC690)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_INITSELECTINDEXONSHOW_OFFSET UNITYSDK_OFFSET(0x90FD590)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x90F96A0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ISSHOWCURSORMODE_OFFSET UNITYSDK_OFFSET(0x90FA960)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ISWITHINANGLE_OFFSET UNITYSDK_OFFSET(0x90FF920)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ISWITHINRING_OFFSET UNITYSDK_OFFSET(0x90FF410)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_JOYSTICK2WHEELPOINT_OFFSET UNITYSDK_OFFSET(0x90FFB00)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x90FAFF0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x90F9E80)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONDOWNBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0x90FB520)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONENTERBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0x90FB940)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONEXITBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0x90FBAD0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x90FA000)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x90F9A90)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x90F9F20)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x90F9580)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x90F99E0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x90FB0C0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x90FB410)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_PLAYTITLEFADEINANIM_OFFSET UNITYSDK_OFFSET(0x90FC620)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_REFRESHBUTTONCDVIEW_OFFSET UNITYSDK_OFFSET(0x90FCE50)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_REFRESHBUTTON_OFFSET UNITYSDK_OFFSET(0x90FBF80)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_REFRESHROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0x90FBC70)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_REFRESHTITLETXT_OFFSET UNITYSDK_OFFSET(0x90FC470)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_RINGANGLERANGEINDEX_OFFSET UNITYSDK_OFFSET(0x90FF550)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_SETONCLICKBUTTON_OFFSET UNITYSDK_OFFSET(0x9100100)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_SHOWVIEW_OFFSET UNITYSDK_OFFSET(0x90F9BB0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x90FEFA0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_UPBUTTON_OFFSET UNITYSDK_OFFSET(0x91003C0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_UPDATEARROW_OFFSET UNITYSDK_OFFSET(0x90FD9B0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_UPDATESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x90FB590)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_UPDATESELECT_GAMEPAD_OFFSET UNITYSDK_OFFSET(0x90FA440)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_UPDATESELECT_MOUSENEW_OFFSET UNITYSDK_OFFSET(0x90FAA80)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9100670)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9100710)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9100780)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x91007B0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9100820)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x91008A0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9100900)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x9100970)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x9100980)

namespace MoleMole
{
	inline static constexpr unsigned int UIEmojiTipRouletteWidgetController_TypeDefinitionIndex = 37992;
	...
	public:
		...
		::Class_2_169A9938636591F3* _view; // 0x2A0
		::Class_2_169A9938636591F3_Class_2_A8551DB78FCCDD55* _childView; // 0x2A8
		::UnityEngine::Vector2 _mousePos; // 0x2B0
		::System::Int32 _currentIndex; // 0x2B8
		::System::Int32 _currentRealStickIndex; // 0x2BC
		::System::Single _mistakeTimer; // 0x2C0
		::System::Int32 _lastMistakeIndex; // 0x2C4
		::System::Single _newbieTimer; // 0x2C8
		::System::Action_1<::System::Int32>* _onClickButton; // 0x2D0
		::System::Boolean _receiveInput; // 0x2D8
		::System::Boolean _enableInput; // 0x2D9
		::UnityEngine::Color maskColor; // 0x2DC
		...
		{
			return ((::System::Void(*)(::Class_2_9E3E3CDA608A4F58*&))((::PBYTE)hIl2Cpp + MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_PLAYTITLEFADEINANIM_OFFSET))(anim);
		}
