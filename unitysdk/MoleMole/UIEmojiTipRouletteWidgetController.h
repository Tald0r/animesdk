...
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_AFTERMOUSEPOSSETHANDLE_OFFSET UNITYSDK_OFFSET(0xA2767B0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_CLAMPDIRECTIONVALUE_OFFSET UNITYSDK_OFFSET(0xA277CA0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_CLICKBUTTON_OFFSET UNITYSDK_OFFSET(0xA279740)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_DOWNBUTTON_OFFSET UNITYSDK_OFFSET(0xA27A1E0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ENABLEINPUT_OFFSET UNITYSDK_OFFSET(0xA273DF0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GETDIRECTIONANDANGLE2D_OFFSET UNITYSDK_OFFSET(0xA279CA0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GETIGNOREFADING_OFFSET UNITYSDK_OFFSET(0xA273560)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GETINDEXDIRECTIONVALUE_OFFSET UNITYSDK_OFFSET(0xA276A10)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GETRINGINNERRADIUS_OFFSET UNITYSDK_OFFSET(0xA279120)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GETTARGETVIEW_OFFSET UNITYSDK_OFFSET(0xA27A670)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GETVECTORINDEX_OFFSET UNITYSDK_OFFSET(0xA278880)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GET_IGNOREFADING_OFFSET UNITYSDK_OFFSET(0xA273500)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_GET_PLATFORMNEEDREFRESHROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0xA2766E0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_INITSELECTINDEXONSHOW_OFFSET UNITYSDK_OFFSET(0xA2775F0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA2736E0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ISSHOWCURSORMODE_OFFSET UNITYSDK_OFFSET(0xA2749A0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ISWITHINANGLE_OFFSET UNITYSDK_OFFSET(0xA279990)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ISWITHINRING_OFFSET UNITYSDK_OFFSET(0xA279480)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_JOYSTICK2WHEELPOINT_OFFSET UNITYSDK_OFFSET(0xA279B70)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA275030)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA273EB0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONDOWNBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0xA275560)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONENTERBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0xA275980)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONEXITBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0xA275B10)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA274030)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA273AC0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA273F50)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA2735C0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA273A10)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xA275100)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0xA275450)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_PLAYTITLEFADEINANIM_OFFSET UNITYSDK_OFFSET(0xA276670)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_REFRESHBUTTONCDVIEW_OFFSET UNITYSDK_OFFSET(0xA276EA0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_REFRESHBUTTON_OFFSET UNITYSDK_OFFSET(0xA275FD0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_REFRESHROULETTETITLEVIEW_OFFSET UNITYSDK_OFFSET(0xA275CC0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_REFRESHTITLETXT_OFFSET UNITYSDK_OFFSET(0xA2764C0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_RINGANGLERANGEINDEX_OFFSET UNITYSDK_OFFSET(0xA2795C0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_SETONCLICKBUTTON_OFFSET UNITYSDK_OFFSET(0xA27A170)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_SHOWVIEW_OFFSET UNITYSDK_OFFSET(0xA273BE0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_TRANSFORM_OFFSET UNITYSDK_OFFSET(0xA279010)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_UPBUTTON_OFFSET UNITYSDK_OFFSET(0xA27A430)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_UPDATEARROW_OFFSET UNITYSDK_OFFSET(0xA277A10)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_UPDATESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA2755D0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_UPDATESELECT_GAMEPAD_OFFSET UNITYSDK_OFFSET(0xA274480)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER_UPDATESELECT_MOUSENEW_OFFSET UNITYSDK_OFFSET(0xA274AC0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA27A6E0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA27A780)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA27A7F0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA27A820)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA27A890)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA27A910)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA27A970)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xA27A9E0)
#define MOLEMOLE_UIEMOJITIPROULETTEWIDGETCONTROLLER___BASE_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0xA27A9F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEmojiTipRouletteWidgetController_TypeDefinitionIndex = 66689;
