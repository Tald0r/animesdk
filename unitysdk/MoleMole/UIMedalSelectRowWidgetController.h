...
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER_GET_ISSETGRAY_OFFSET UNITYSDK_OFFSET(0x7D53610)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER_GET_ISUNSELECTABLE_OFFSET UNITYSDK_OFFSET(0x7D53580)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7D53890)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x7D54740)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x7D53BE0)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER_ONSELECTCHANGE_OFFSET UNITYSDK_OFFSET(0x7D53B20)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7D53930)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7D53630)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER_SHOWEMPTYCONTENT_OFFSET UNITYSDK_OFFSET(0x7D54600)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7D548C0)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7D548D0)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x7D54940)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x7D549B0)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7D54A30)
#define MOLEMOLE_UIMEDALSELECTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7D54AB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMedalSelectRowWidgetController_TypeDefinitionIndex = 49990;

	class UIMedalSelectRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_141* _view; // 0x2D0
