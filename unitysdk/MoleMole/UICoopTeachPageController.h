...
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0x8BC8160)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8BC7FA0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8BC7FB0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_INITEXPITEM_OFFSET UNITYSDK_OFFSET(0x8BC87F0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_INITINDEX_OFFSET UNITYSDK_OFFSET(0x8BC8D30)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8BC8020)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONLEVELREWARDCHANGE_OFFSET UNITYSDK_OFFSET(0x8BC8220)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8BC8C50)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BC9240)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BC91B0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_REFRESHEXP_OFFSET UNITYSDK_OFFSET(0x8BC8290)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8BC9450)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8BC9460)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8BC94D0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BC94E0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BC94F0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeachPageController_TypeDefinitionIndex = 78236;
