...
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0xC605AE0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC605920)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC605930)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_INITEXPITEM_OFFSET UNITYSDK_OFFSET(0xC606180)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_INITINDEX_OFFSET UNITYSDK_OFFSET(0xC6066C0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC6059A0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONLEVELREWARDCHANGE_OFFSET UNITYSDK_OFFSET(0xC605BB0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC6065E0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC606BD0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC606B40)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER_REFRESHEXP_OFFSET UNITYSDK_OFFSET(0xC605C20)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC606DE0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC606DF0)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC606E60)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC606E70)
#define MOLEMOLE_UICOOPTEACHPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC606E80)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeachPageController_TypeDefinitionIndex = 78247;
