...
#define MOLEMOLE_SUIBIANPRODUCTIONRIGHTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB8C84E0)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianProductionRightContext_TypeDefinitionIndex = 45173;
