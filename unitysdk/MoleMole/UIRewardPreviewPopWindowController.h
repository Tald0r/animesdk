...
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0xA43B520)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xA43B820)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA43B430)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA43B6F0)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xA43B830)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA43B440)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA43B790)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA43B4B0)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA43B8E0)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0xA43BB20)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA43BE90)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA43BEA0)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xA43BF10)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA43BF70)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA43BF80)
#define MOLEMOLE_UIREWARDPREVIEWPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA43BF90)

namespace MoleMole
{
	inline static constexpr unsigned int UIRewardPreviewPopWindowController_TypeDefinitionIndex = 78435;

	class UIRewardPreviewPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_7C86492618AE1202_1* _view; // 0x2F8
		::System::Collections::Generic::List_1<::Class_1_C4CB11A2FD957208_Struct_2_98E057419FFAAB00>* _dataList; // 0x300
		::System::String* _title; // 0x308
		::System::String* _subTitle; // 0x310
