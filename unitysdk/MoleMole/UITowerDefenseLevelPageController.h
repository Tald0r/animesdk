...
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ADDDAYWIDGET_OFFSET UNITYSDK_OFFSET(0x959E3A0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_CACHEENHANCE_OFFSET UNITYSDK_OFFSET(0x95A17E0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_CLEARDATALIST_OFFSET UNITYSDK_OFFSET(0x95A1240)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_DATALISTSELECT_OFFSET UNITYSDK_OFFSET(0x95A1550)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GETENTRYLIST_OFFSET UNITYSDK_OFFSET(0x959E140)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GETINITSELECTOR_OFFSET UNITYSDK_OFFSET(0x959BB60)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GETLEVELTABCONTROLLER_OFFSET UNITYSDK_OFFSET(0x959FAE0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GETREWARDLIST_OFFSET UNITYSDK_OFFSET(0x959D430)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0x959BB50)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x959BB40)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ISUNLOCKENTRY_OFFSET UNITYSDK_OFFSET(0x959E320)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x959BC00)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ONLEVELSCROLLCREATE_OFFSET UNITYSDK_OFFSET(0x95A0E00)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ONSTART_OFFSET UNITYSDK_OFFSET(0x959CE50)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ONTOWERDEFENSELEVELUPDATE_OFFSET UNITYSDK_OFFSET(0x95A0FB0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x959D390)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x959BCA0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_OPENTUTORIAL_OFFSET UNITYSDK_OFFSET(0x959CCA0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHDATADETAIL_OFFSET UNITYSDK_OFFSET(0x95A12E0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0x959E440)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHLEVELLIST_OFFSET UNITYSDK_OFFSET(0x959FBA0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHREWARD_OFFSET UNITYSDK_OFFSET(0x959D5D0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHSPECIALICON_OFFSET UNITYSDK_OFFSET(0x959DC20)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x959C1B0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_RESETCONTENTPOS_OFFSET UNITYSDK_OFFSET(0x959F990)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_RESETDATALIST_OFFSET UNITYSDK_OFFSET(0x959F590)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_STOPCONTENTANIMATION_OFFSET UNITYSDK_OFFSET(0x959F4E0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x959E0E0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x95A1A20)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER__ONUIINIT_B__12_0_OFFSET UNITYSDK_OFFSET(0x95A1DB0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER__REFRESHDATADETAIL_B__33_0_OFFSET UNITYSDK_OFFSET(0x95A1E80)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95A23E0)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95A2450)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95A2460)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefenseLevelPageController_TypeDefinitionIndex = 70543;
	...
	public:
		...
		::Class_0_16E4307DCC419505_235* initSelector; // 0x2F8
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_884BC23D25390AD2*>* clientEnhanceList; // 0x328
		...
		{
			return ((::Class_0_16E4307DCC419505_235*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_GETINITSELECTOR_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7807B2B04302CD7B_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER_REFRESHDETAIL_OFFSET))(this, data);
		}
