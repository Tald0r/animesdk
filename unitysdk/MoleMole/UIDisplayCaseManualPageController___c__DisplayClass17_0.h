...
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAD06EF0)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER___C__DISPLAYCLASS17_0__REFRESHLEFT_B__0_OFFSET UNITYSDK_OFFSET(0xAD06F00)
#define MOLEMOLE_UIDISPLAYCASEMANUALPAGECONTROLLER___C__DISPLAYCLASS17_0__REFRESHLEFT_B__1_OFFSET UNITYSDK_OFFSET(0xAD07220)

namespace MoleMole
{
	inline static constexpr unsigned int UIDisplayCaseManualPageController___c__DisplayClass17_0_TypeDefinitionIndex = 44956;

	class UIDisplayCaseManualPageController___c__DisplayClass17_0 : public ::System::Object
	{
	public:
		::Foundation::AssetPath prefab; // 0x10
		::System::Action* __9__1; // 0x20
		::MoleMole::UIDisplayCaseManualPageController* __4__this; // 0x28
		::Class_2_4E304963EFC1C1E1_Class_2_385A368C07384AA3* view; // 0x30
