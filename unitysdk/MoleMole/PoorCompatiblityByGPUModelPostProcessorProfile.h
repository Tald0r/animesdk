...
#define MOLEMOLE_POORCOMPATIBLITYBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x9852110)
#define MOLEMOLE_POORCOMPATIBLITYBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x98521A0)
#define MOLEMOLE_POORCOMPATIBLITYBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x9852200)

namespace MoleMole
{
	inline static constexpr unsigned int PoorCompatiblityByGPUModelPostProcessorProfile_TypeDefinitionIndex = 80730;
