...
#define MOLEMOLE_UIACTIVITYHOTPOTCOLLECTDISHTABBTNROWWIDGETCONTROLLER_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8B9E8F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotPotCollectDishTabBtnRowWidgetController_Data_TypeDefinitionIndex = 56266;

	class UIActivityHotPotCollectDishTabBtnRowWidgetController_Data : public ::System::Object
	{
	public:
		::System::String* LockParam; // 0x10
