...
#define MOLEMOLE_UIFRIENDCHATREPLYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFA2880)
#define MOLEMOLE_UIFRIENDCHATREPLYWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFA2A00)
#define MOLEMOLE_UIFRIENDCHATREPLYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFA2920)
#define MOLEMOLE_UIFRIENDCHATREPLYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFA27E0)
#define MOLEMOLE_UIFRIENDCHATREPLYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFA2A80)
#define MOLEMOLE_UIFRIENDCHATREPLYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFA2A90)
#define MOLEMOLE_UIFRIENDCHATREPLYWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFA2B00)
#define MOLEMOLE_UIFRIENDCHATREPLYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFA2B80)
#define MOLEMOLE_UIFRIENDCHATREPLYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFA2C00)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatReplyWidgetController_TypeDefinitionIndex = 49953;
