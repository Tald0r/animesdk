...
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA___C__DISPLAYCLASS6_1__CTOR_OFFSET UNITYSDK_OFFSET(0x971E6F0)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA___C__DISPLAYCLASS6_1__REBUILDUIAVATARSHOWSETTINGDATA_B__0_OFFSET UNITYSDK_OFFSET(0x971E700)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAvatarShowData___c__DisplayClass6_1_TypeDefinitionIndex = 44827;
