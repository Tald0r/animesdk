...
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD017E60)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_GOMAIN_OFFSET UNITYSDK_OFFSET(0xD019460)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_ONBABELRANKSELECT_OFFSET UNITYSDK_OFFSET(0xD019580)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_ONBABELTOWERUPDATERANK_OFFSET UNITYSDK_OFFSET(0xD01A3B0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD017E70)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD018940)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD017F10)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD018A50)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_OPENINFO_OFFSET UNITYSDK_OFFSET(0xD0199E0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_REFRESHAVATARLIST_OFFSET UNITYSDK_OFFSET(0xD019AD0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0xD019640)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_REFRESHTIME_OFFSET UNITYSDK_OFFSET(0xD01A010)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_REFRESHTITLE_OFFSET UNITYSDK_OFFSET(0xD018620)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD018BB0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD01A420)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD01A490)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER__ONUIINIT_B__10_0_OFFSET UNITYSDK_OFFSET(0xD01A4A0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER__ONUIINIT_B__10_1_OFFSET UNITYSDK_OFFSET(0xD01A5A0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER__REFRESHTIME_B__23_0_OFFSET UNITYSDK_OFFSET(0xD01A620)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD01A630)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD01A6A0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD01A6B0)
#define MOLEMOLE_UIBABELTOWERRANKPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD01A6C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerRankPageController_TypeDefinitionIndex = 49011;
