...
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAD38650)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS15_0__DOANIMATIONFADEOUT_B__0_OFFSET UNITYSDK_OFFSET(0xAD38660)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS15_0__DOANIMATIONFADEOUT_B__1_OFFSET UNITYSDK_OFFSET(0xAD38950)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS15_0__DOANIMATIONFADEOUT_B__2_OFFSET UNITYSDK_OFFSET(0xAD388B0)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS15_0__DOANIMATIONFADEOUT_B__3_OFFSET UNITYSDK_OFFSET(0xAD388C0)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS15_0__DOANIMATIONFADEOUT_B__4_OFFSET UNITYSDK_OFFSET(0xAD388D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTipsCameraRowWidgetController___c__DisplayClass15_0_TypeDefinitionIndex = 46277;
