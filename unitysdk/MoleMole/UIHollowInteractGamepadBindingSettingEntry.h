...
#define MOLEMOLE_UIHOLLOWINTERACTGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x80AB4F0)
#define MOLEMOLE_UIHOLLOWINTERACTGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x80AB500)
#define MOLEMOLE_UIHOLLOWINTERACTGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x80AB510)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowInteractGamepadBindingSettingEntry_TypeDefinitionIndex = 49387;
