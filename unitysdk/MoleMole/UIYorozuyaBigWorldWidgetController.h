...
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_CHECKHANDLE_OFFSET UNITYSDK_OFFSET(0xAABD8C0)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_CLOSEOVERHANDLE_OFFSET UNITYSDK_OFFSET(0xAABC130)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0xAABC2C0)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xAABBA60)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_GOBIGWORLDPLAY_OFFSET UNITYSDK_OFFSET(0xAABD5E0)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_LOADBACKGROUND_OFFSET UNITYSDK_OFFSET(0xAABCB70)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_ONBACKCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xAABBAD0)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAABCF10)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_ONMAINCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xAABC1D0)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_ONQUESTROWSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0xAABCE50)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAABD940)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAABB1B0)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAABC500)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_OPENHISTORYVIEW_OFFSET UNITYSDK_OFFSET(0xAABD530)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_SETDEFAULTSELECT_OFFSET UNITYSDK_OFFSET(0xAABCFB0)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER_SETISREAD_OFFSET UNITYSDK_OFFSET(0xAABBBB0)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER__CREATEROW_OFFSET UNITYSDK_OFFSET(0xAABB980)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAABDA20)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER___BASE_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0xAABDAD0)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAABDB40)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAABDBB0)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAABDC30)
#define MOLEMOLE_UIYOROZUYABIGWORLDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAABDC90)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaBigWorldWidgetController_TypeDefinitionIndex = 58541;
	...
	public:
		...
		::Class_2_208CC9941471731A_345* currentSelect; // 0x2B8
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_345*>* scrollChessboardList; // 0x2C0
