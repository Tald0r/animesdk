...
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAB82E10)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerAccessoryPageControllerContext_TypeDefinitionIndex = 64569;
	...
	public:
		...
		::Enum_3_ED790DAC948A65A9_20 InitSkinType; // 0x38
		::System::Int32 TabID; // 0x3C
		::System::Int32 InitSkinID; // 0x40
		::System::Int32 AccIndex; // 0x44
		::System::Int32 InitAvatarID; // 0x48
		::Enum_3_D54A5313F8CDCCC2 PageType; // 0x4C
