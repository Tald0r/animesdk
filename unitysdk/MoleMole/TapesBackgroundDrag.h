...
#define MOLEMOLE_TAPESBACKGROUNDDRAG_FIXDELTA_OFFSET UNITYSDK_OFFSET(0xC32E6B0)
#define MOLEMOLE_TAPESBACKGROUNDDRAG_FIXWALLPOSITION_OFFSET UNITYSDK_OFFSET(0xC32EAC0)
#define MOLEMOLE_TAPESBACKGROUNDDRAG_INITCLAMP_OFFSET UNITYSDK_OFFSET(0xC32E530)
#define MOLEMOLE_TAPESBACKGROUNDDRAG_MOVEWALL_OFFSET UNITYSDK_OFFSET(0xC32E810)
#define MOLEMOLE_TAPESBACKGROUNDDRAG_SETDIR_OFFSET UNITYSDK_OFFSET(0xC32E730)
#define MOLEMOLE_TAPESBACKGROUNDDRAG__CTOR_OFFSET UNITYSDK_OFFSET(0xC32EB80)

namespace MoleMole
{
	inline static constexpr unsigned int TapesBackgroundDrag_TypeDefinitionIndex = 38092;
