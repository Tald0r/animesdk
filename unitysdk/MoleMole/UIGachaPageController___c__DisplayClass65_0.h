...
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS65_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD05A990)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS65_0__OPENPERFORMPAGE_B__0_OFFSET UNITYSDK_OFFSET(0xD05A9A0)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS65_0__OPENPERFORMPAGE_B__1_OFFSET UNITYSDK_OFFSET(0xD05A9D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPageController___c__DisplayClass65_0_TypeDefinitionIndex = 39399;
