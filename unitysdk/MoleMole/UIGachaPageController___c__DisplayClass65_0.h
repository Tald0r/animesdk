...
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS65_0__CTOR_OFFSET UNITYSDK_OFFSET(0xF1ED490)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS65_0__OPENPERFORMPAGE_B__0_OFFSET UNITYSDK_OFFSET(0xF1ED4A0)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS65_0__OPENPERFORMPAGE_B__1_OFFSET UNITYSDK_OFFSET(0xF1ED4D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPageController___c__DisplayClass65_0_TypeDefinitionIndex = 55226;

	class UIGachaPageController___c__DisplayClass65_0 : public ::System::Object
	{
	public:
		::System::Action* onPlayEnd; // 0x10
		::System::Collections::Generic::List_1<::Class_3_601FA52CA5E757A0*>* dropItems; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* pointItems; // 0x20
		::MoleMole::UIGachaPageController* __4__this; // 0x28
