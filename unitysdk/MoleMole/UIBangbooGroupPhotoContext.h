...
#define MOLEMOLE_UIBANGBOOGROUPPHOTOCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD9A2560)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooGroupPhotoContext_TypeDefinitionIndex = 67375;
