...
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA08DC50)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA08DCC0)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMROWWIDGETCONTROLLER_ONSELECTROLEEVENT_OFFSET UNITYSDK_OFFSET(0xA08DFC0)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMROWWIDGETCONTROLLER_ONSETDATA_OFFSET UNITYSDK_OFFSET(0xA08DDC0)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA08DEC0)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA08E090)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA08E0C0)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMROWWIDGETCONTROLLER___BASE_ONSETDATA_OFFSET UNITYSDK_OFFSET(0xA08E130)
#define MOLEMOLE_UIVOIDFRONTQUICKTEAMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA08E1A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontQuickTeamRowWidgetController_TypeDefinitionIndex = 55880;
