...
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER_DONUMBERBLINKASYNC_OFFSET UNITYSDK_OFFSET(0xA366030)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER_GETBLINKMATRIXCONFIG_OFFSET UNITYSDK_OFFSET(0xA366A60)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER_NUMBERBLINK_OFFSET UNITYSDK_OFFSET(0xA366120)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER_SHOWNUMBER_OFFSET UNITYSDK_OFFSET(0xA366410)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER_SWITCHANDSHOWNUMBER_OFFSET UNITYSDK_OFFSET(0xA366240)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER__CTOR_OFFSET UNITYSDK_OFFSET(0xA365F60)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboardResult3DModelController_NumberBlinker_TypeDefinitionIndex = 42505;
	...
	public:
		...
		::MonoHollowResultPageConfig* _config; // 0x18
