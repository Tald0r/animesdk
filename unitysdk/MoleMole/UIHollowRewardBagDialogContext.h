...
#define MOLEMOLE_UIHOLLOWREWARDBAGDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA616500)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowRewardBagDialogContext_TypeDefinitionIndex = 70881;
	...
	public:
		...
		::System::Boolean useCustomInfo; // 0x41
