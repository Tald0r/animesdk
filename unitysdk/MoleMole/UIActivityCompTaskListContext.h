...
#define MOLEMOLE_UIACTIVITYCOMPTASKLISTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB5D8B10)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCompTaskListContext_TypeDefinitionIndex = 60215;
