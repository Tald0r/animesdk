...
#define MOLEMOLE_UIACTIVITYCOMPTASKLISTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC811720)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCompTaskListContext_TypeDefinitionIndex = 77361;
