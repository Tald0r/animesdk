...
class Class_2_0617779D9B0CCA67_1;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA1B97E0)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA1B97F0)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA1B9860)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xA1B9CD0)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA1B9ED0)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA1B9B80)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA1B9E00)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA1B9920)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA1B9FF0)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA1BA000)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xA1BA070)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA1BA0D0)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA1BA100)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA1BA170)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA1BA180)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmEntrancePageController_TypeDefinitionIndex = 54793;
	...
	public:
		...
		::Class_2_0617779D9B0CCA67_1* get__viewModel()
		{
			return ((::Class_2_0617779D9B0CCA67_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
