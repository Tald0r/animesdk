...
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9D4C580)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9D4C590)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9D4C600)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x9D4CA70)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9D4CC70)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9D4C920)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x9D4CBA0)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9D4C6C0)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D4CD90)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9D4CDA0)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x9D4CE10)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9D4CE70)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9D4CEA0)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x9D4CF10)
#define MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9D4CF20)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmEntrancePageController_TypeDefinitionIndex = 42849;
	...
	public:
		...
		{
			return ((::Class_2_0617779D9B0CCA67*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOUSERHYTHMENTRANCEPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
