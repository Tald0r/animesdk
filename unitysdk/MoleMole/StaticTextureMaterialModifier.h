...
#define MOLEMOLE_STATICTEXTUREMATERIALMODIFIER_METHOD_2_3750F4A9FEA7F5EF_OFFSET UNITYSDK_OFFSET(0x35D040)
#define MOLEMOLE_STATICTEXTUREMATERIALMODIFIER_METHOD_2_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x35D0C0)
#define MOLEMOLE_STATICTEXTUREMATERIALMODIFIER_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x35D050)
#define MOLEMOLE_STATICTEXTUREMATERIALMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x35D010)

namespace MoleMole
{
	inline static constexpr unsigned int StaticTextureMaterialModifier_TypeDefinitionIndex = 51835;
	...
	struct alignas(8) StaticTextureMaterialModifier
	{
		...
		{
			return ((::Class_1_A0B58236B258B7B2*(*)(::PVOID, ::Enum_3_8855AD768EB2675C, ::MoleMole::MonoRenderHandler*))((::PBYTE)hIl2Cpp + MOLEMOLE_STATICTEXTUREMATERIALMODIFIER_METHOD_2_3750F4A9FEA7F5EF_OFFSET))(this, a1, a2);
		}
