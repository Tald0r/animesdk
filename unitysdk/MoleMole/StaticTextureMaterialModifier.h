...
#define MOLEMOLE_STATICTEXTUREMATERIALMODIFIER_METHOD_2_3750F4A9FEA7F5EF_OFFSET UNITYSDK_OFFSET(0x3C2990)
#define MOLEMOLE_STATICTEXTUREMATERIALMODIFIER_METHOD_2_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x3C2A10)
#define MOLEMOLE_STATICTEXTUREMATERIALMODIFIER_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x3C29A0)
#define MOLEMOLE_STATICTEXTUREMATERIALMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x3C2960)

namespace MoleMole
{
	inline static constexpr unsigned int StaticTextureMaterialModifier_TypeDefinitionIndex = 67014;
