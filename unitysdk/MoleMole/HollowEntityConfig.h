...
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_ATTACK_OFFSET UNITYSDK_OFFSET(0x6E2AA90)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CAMP_OFFSET UNITYSDK_OFFSET(0x6E2AB10)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANBATTLE_OFFSET UNITYSDK_OFFSET(0x6E2A9F0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANBEPUSH_OFFSET UNITYSDK_OFFSET(0x6E2A8F0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANCOLLIDER_OFFSET UNITYSDK_OFFSET(0x6E2A930)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANMAXDEATHTIME_OFFSET UNITYSDK_OFFSET(0x6E2AB90)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANMOVE_OFFSET UNITYSDK_OFFSET(0x6E2A810)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_CANPUSH_OFFSET UNITYSDK_OFFSET(0x6E2A8D0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_HP_OFFSET UNITYSDK_OFFSET(0x6E2AA10)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x6E2A9D0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_LAYER_OFFSET UNITYSDK_OFFSET(0x6E2A950)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_MAXDEATHTIME_OFFSET UNITYSDK_OFFSET(0x6E2ABB0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_MOVESTATENAME_OFFSET UNITYSDK_OFFSET(0x6E2A830)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x6E2AC30)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_RENDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x6E2AC50)
#define MOLEMOLE_HOLLOWENTITYCONFIG_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x6E2A910)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANBATTLE_OFFSET UNITYSDK_OFFSET(0x6E2AA00)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANBEPUSH_OFFSET UNITYSDK_OFFSET(0x6E2A900)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANCOLLIDER_OFFSET UNITYSDK_OFFSET(0x6E2A940)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANMAXDEATHTIME_OFFSET UNITYSDK_OFFSET(0x6E2ABA0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANMOVE_OFFSET UNITYSDK_OFFSET(0x6E2A820)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_CANPUSH_OFFSET UNITYSDK_OFFSET(0x6E2A8E0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x6E2A9E0)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x6E2AC40)
#define MOLEMOLE_HOLLOWENTITYCONFIG_SET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x6E2A920)
#define MOLEMOLE_HOLLOWENTITYCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x6E2B390)
#define MOLEMOLE_HOLLOWENTITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6E2ACD0)

namespace MoleMole
{
	inline static constexpr unsigned int HollowEntityConfig_TypeDefinitionIndex = 66523;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::Share::GridDir, ::MoleMole::ChessStateMachine::OnceTriggerString*>**)Il2CppClass::FromTypeDefinitionIndex(HollowEntityConfig_TypeDefinitionIndex)->GetStaticField(0x44BF0);
		}
		...
		::Class_4_C70C71116F894573_Enum_3_B4B78138CF90752C _layer; // 0x94
		...
		::Class_4_C70C71116F894573_Enum_3_B4B78138CF90752C get_layer()
		{
			return ((::Class_4_C70C71116F894573_Enum_3_B4B78138CF90752C(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_HOLLOWENTITYCONFIG_GET_LAYER_OFFSET))(this);
		}
