...
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA___C__DISPLAYCLASS4_1__CTOR_OFFSET UNITYSDK_OFFSET(0x971E390)
#define MOLEMOLE_CONFIGUIAVATARSHOWDATA___C__DISPLAYCLASS4_1__REBUILDUIBUDDYSHOWSETTINGDATA_B__0_OFFSET UNITYSDK_OFFSET(0x971E3A0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAvatarShowData___c__DisplayClass4_1_TypeDefinitionIndex = 44830;
