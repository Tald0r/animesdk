...
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCAACBA0)
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER_ONAUDITIONCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xCAACF50)
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCAACC10)
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCAAD360)
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCAAD070)
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER_ONSKINCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xCAAD000)
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCAAD160)
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER_REFRESHVOICEPLAYSTATE_OFFSET UNITYSDK_OFFSET(0xCAAD230)
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER_SETGETCURRENTPLAYINGACTION_OFFSET UNITYSDK_OFFSET(0xCAAD410)
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER_SETONCLICKAUDITIONACTION_OFFSET UNITYSDK_OFFSET(0xCAACEE0)
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCAAD480)
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCAAD490)
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCAAD500)
#define MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCAAD570)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopRoulettSettingRowWidgetController_TypeDefinitionIndex = 70383;

	class UICoopRoulettSettingRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_208CC9941471731A_414* _data; // 0x2D0
		::System::Action_1<::Class_2_208CC9941471731A_414*>* _onClickAuditionAction; // 0x2D8
		...
		::System::Void SetOnClickAuditionAction(::System::Action_1<::Class_2_208CC9941471731A_414*>* action)
		{
			return ((::System::Void(*)(::PVOID, ::System::Action_1<::Class_2_208CC9941471731A_414*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER_SETONCLICKAUDITIONACTION_OFFSET))(this, action);
		}
		...
		::System::Void RefreshView(::Class_2_208CC9941471731A_414* data)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_414*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICOOPROULETTSETTINGROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET))(this, data);
		}
