...
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0053F0)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC005490)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC004B20)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC004BC0)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC005880)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER__ONCLICK_OFFSET UNITYSDK_OFFSET(0xC005570)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER__REFRESH_OFFSET UNITYSDK_OFFSET(0xC004CF0)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0058B0)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC005920)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0059A0)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC005A00)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZoneLayer_PhotoItemWidgetController_TypeDefinitionIndex = 69481;

	class UIHadalZoneLayer_PhotoItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_FB90F8F234309AE5_2* _view; // 0x2A0
		::MoleMole::UIHadalZoneLayer_PhotoItemWidgetController_LayerInfoContext* _curContext; // 0x2A8
