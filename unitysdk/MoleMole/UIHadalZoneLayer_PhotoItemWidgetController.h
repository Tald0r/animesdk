...
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD43710)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD437B0)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD42E40)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD42EE0)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD43BA0)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER__ONCLICK_OFFSET UNITYSDK_OFFSET(0xAD43890)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER__REFRESH_OFFSET UNITYSDK_OFFSET(0xAD43010)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD43BD0)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD43C40)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD43CC0)
#define MOLEMOLE_UIHADALZONELAYER_PHOTOITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD43D20)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZoneLayer_PhotoItemWidgetController_TypeDefinitionIndex = 48653;

	class UIHadalZoneLayer_PhotoItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_FB90F8F234309AE5_1* _view; // 0x2A0
