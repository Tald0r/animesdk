...
#define MOLEMOLE_MONONPCLOOKIKPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x82FD9E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoNpcLookIKParameter_TypeDefinitionIndex = 76695;
