...
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA990BF0)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA990C00)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA990D60)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA991300)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA9913D0)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA990E70)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA991060)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xA990C70)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER_SETUPACTIVITYDATAANDCONFIGS_OFFSET UNITYSDK_OFFSET(0xA9914A0)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER_SETUPVIEWDATA_OFFSET UNITYSDK_OFFSET(0xA991160)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9919C0)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA9919D0)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA991A40)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA991A50)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA991A60)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA991A70)
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xA991A80)

namespace MoleMole
{
	inline static constexpr unsigned int UIGameUIBoardPageController_TypeDefinitionIndex = 78531;

	class UIGameUIBoardPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Enum_3_3EEBD34AD102DD3A _binderType; // 0x308
		::Class_2_65BFFA950148C892_Class_1_9A90CD018E72DF20_4* _viewData; // 0x310
