...
#define MOLEMOLE_UIURBANMAPEXPLORELISTROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x95A7320)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapExploreListRowContext_TypeDefinitionIndex = 54324;
