...
#define MOLEMOLE_UIINLEVELTIMERWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8C81BA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelTimerWidgetController_Context_TypeDefinitionIndex = 56553;
