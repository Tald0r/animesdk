...
#define MOLEMOLE_UIGRANDMARCELMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFFBC10)
#define MOLEMOLE_UIGRANDMARCELMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFFBC80)
#define MOLEMOLE_UIGRANDMARCELMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBFFBD80)
#define MOLEMOLE_UIGRANDMARCELMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFFBF30)
#define MOLEMOLE_UIGRANDMARCELMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFFBF60)
#define MOLEMOLE_UIGRANDMARCELMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBFFBFD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGrandMarcelMapRightListRowScrollViewWidgetController_TypeDefinitionIndex = 42703;
