...
#define MOLEMOLE_UIGRANDMARCELMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAD39F90)
#define MOLEMOLE_UIGRANDMARCELMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAD3A000)
#define MOLEMOLE_UIGRANDMARCELMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAD3A100)
#define MOLEMOLE_UIGRANDMARCELMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD3A2B0)
#define MOLEMOLE_UIGRANDMARCELMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAD3A2E0)
#define MOLEMOLE_UIGRANDMARCELMAPRIGHTLISTROWSCROLLVIEWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAD3A350)

namespace MoleMole
{
	inline static constexpr unsigned int UIGrandMarcelMapRightListRowScrollViewWidgetController_TypeDefinitionIndex = 47188;
