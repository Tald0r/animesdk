...
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_CHANGETOCOMPONENTVIEW_OFFSET UNITYSDK_OFFSET(0xADBD0C0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_COMPONENTSTATEDRAG_OFFSET UNITYSDK_OFFSET(0xADBDED0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ENABLEDRAG_OFFSET UNITYSDK_OFFSET(0xADBCD10)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_GETTOUCHPOSITION_OFFSET UNITYSDK_OFFSET(0xADBD6D0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ISCLICK_OFFSET UNITYSDK_OFFSET(0xADBD560)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ISMOVE_OFFSET UNITYSDK_OFFSET(0xADBD600)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONBAGITEMSELECT_OFFSET UNITYSDK_OFFSET(0xADBE570)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0xADBD770)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONCLEARITEMSELECT_OFFSET UNITYSDK_OFFSET(0xADBEBE0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADBC990)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONDRAGEND_OFFSET UNITYSDK_OFFSET(0xADBE160)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONDRAGING_OFFSET UNITYSDK_OFFSET(0xADBE500)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONDRAGSTART_OFFSET UNITYSDK_OFFSET(0xADBD400)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADBCA30)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADBBFC0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADBC810)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_REGISTERDRAG_OFFSET UNITYSDK_OFFSET(0xADBC480)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER_UPDATEDRAGUI_OFFSET UNITYSDK_OFFSET(0xADBCFE0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xADBEC50)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADBEC80)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADBECF0)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADBED70)
#define MOLEMOLE_UIBUDDYBAGDRAGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADBEDD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBuddyBagDragWidgetController_TypeDefinitionIndex = 39497;
