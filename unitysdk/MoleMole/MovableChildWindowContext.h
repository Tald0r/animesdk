...
#define MOLEMOLE_MOVABLECHILDWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB863070)

namespace MoleMole
{
	inline static constexpr unsigned int MovableChildWindowContext_TypeDefinitionIndex = 41876;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::String*>* camKeyList; // 0x38
		::Foundation::ViewObject::ViewObjectHandle openVo; // 0x40
