...
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB17380)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB17490)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBB17590)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB173F0)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB17750)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB17760)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBB177D0)
#define MOLEMOLE_UIHADALZONEHISTORYROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB17850)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZoneHistoryRowWidgetController_TypeDefinitionIndex = 52930;
