...
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_DOINITLAYOUT_OFFSET UNITYSDK_OFFSET(0xD43DA20)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_INITLAYOUTELEMENT_OFFSET UNITYSDK_OFFSET(0xD43DC00)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_ISCONTAINPLATFORMUIPARAMS_OFFSET UNITYSDK_OFFSET(0xD43D910)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_ISPLATFORMUIPARAMSEMPTY_OFFSET UNITYSDK_OFFSET(0xD43D850)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR_RELOADDATAFROMJSON_OFFSET UNITYSDK_OFFSET(0xD43DDE0)
#define MOLEMOLE_MONOUILAYOUTELEMENTADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD43E100)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUILayoutElementAdaptor_TypeDefinitionIndex = 64340;
