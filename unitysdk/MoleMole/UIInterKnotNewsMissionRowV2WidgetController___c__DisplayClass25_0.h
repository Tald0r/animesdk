...
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8E4E0)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER___C__DISPLAYCLASS25_0__SETMISSIONITEMSELECT_B__0_OFFSET UNITYSDK_OFFSET(0x9A8E4F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotNewsMissionRowV2WidgetController___c__DisplayClass25_0_TypeDefinitionIndex = 47646;
