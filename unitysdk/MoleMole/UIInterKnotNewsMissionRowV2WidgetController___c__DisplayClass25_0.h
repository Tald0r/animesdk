...
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x86EB9D0)
#define MOLEMOLE_UIINTERKNOTNEWSMISSIONROWV2WIDGETCONTROLLER___C__DISPLAYCLASS25_0__SETMISSIONITEMSELECT_B__0_OFFSET UNITYSDK_OFFSET(0x86EB9E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotNewsMissionRowV2WidgetController___c__DisplayClass25_0_TypeDefinitionIndex = 75011;
