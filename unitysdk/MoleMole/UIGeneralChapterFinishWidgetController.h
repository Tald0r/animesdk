...
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8A12630)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x8A127B0)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_ONINTERRUPT_OFFSET UNITYSDK_OFFSET(0x8A128D0)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8A126D0)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8A121F0)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8A12330)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8A12540)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8A12990)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER__ONFADEPLAYFINISH_B__6_0_OFFSET UNITYSDK_OFFSET(0x8A129C0)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER__ONFADEPLAYFINISH_B__6_1_OFFSET UNITYSDK_OFFSET(0x8A12A20)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER__ONINTERRUPT_B__8_0_OFFSET UNITYSDK_OFFSET(0x8A12A40)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8A12A60)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x8A12AD0)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8A12AE0)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8A12B60)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8A12BC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralChapterFinishWidgetController_TypeDefinitionIndex = 46546;

	class UIGeneralChapterFinishWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_7EE413D34B698ECF* _view; // 0x2A0
		::Class_2_208CC9941471731A_232* _template; // 0x2A8
