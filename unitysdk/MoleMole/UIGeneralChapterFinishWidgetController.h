...
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB2B8B00)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xB2B8C80)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_ONINTERRUPT_OFFSET UNITYSDK_OFFSET(0xB2B8DA0)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2B8BA0)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB2B86C0)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB2B8800)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB2B8A10)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB2B8E60)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER__ONFADEPLAYFINISH_B__6_0_OFFSET UNITYSDK_OFFSET(0xB2B8E90)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER__ONFADEPLAYFINISH_B__6_1_OFFSET UNITYSDK_OFFSET(0xB2B8F00)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER__ONINTERRUPT_B__8_0_OFFSET UNITYSDK_OFFSET(0xB2B8F20)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB2B8F40)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xB2B8FB0)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2B8FC0)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB2B9040)
#define MOLEMOLE_UIGENERALCHAPTERFINISHWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB2B90A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralChapterFinishWidgetController_TypeDefinitionIndex = 50537;

	class UIGeneralChapterFinishWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_7EE413D34B698ECF* _view; // 0x2A0
		::Class_2_208CC9941471731A_218* _template; // 0x2A8
		::MoleMole::UIGeneralChapterFinishWidgetController_Context* _context; // 0x2B0
