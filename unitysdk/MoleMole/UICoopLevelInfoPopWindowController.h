...
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xADC5810)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xADC5820)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xADC5890)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADC5950)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xADC5BA0)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xADC5BB0)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADC5C20)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelInfoPopWindowController_TypeDefinitionIndex = 71017;
