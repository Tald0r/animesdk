...
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA52E790)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA52E7A0)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA52E810)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA52E8D0)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA52EB20)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA52EB30)
#define MOLEMOLE_UICOOPLEVELINFOPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA52EBA0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelInfoPopWindowController_TypeDefinitionIndex = 66777;
