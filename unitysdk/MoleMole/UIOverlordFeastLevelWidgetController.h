...
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_DOPLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0xAE29AE0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_DOREFRESHVIEWWITHLEVELUPGRADE_OFFSET UNITYSDK_OFFSET(0xAE29840)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_DOREFRESHVIEWWITHOUTLEVELUPGRADE_OFFSET UNITYSDK_OFFSET(0xAE29030)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_GETLEVELICONSTATE_OFFSET UNITYSDK_OFFSET(0xAE29DF0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_GETNUMIMGPATH_OFFSET UNITYSDK_OFFSET(0xAE29E70)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_GETREMAPPEDPROGRESS_OFFSET UNITYSDK_OFFSET(0xAE2A1A0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE28C60)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xAE28DE0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE28D00)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE28AD0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE28BB0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_PLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0xAE29960)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAE28F50)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0xAE2A090)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE2A240)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER__DOREFRESHVIEWWITHOUTLEVELUPGRADE_B__9_0_OFFSET UNITYSDK_OFFSET(0xAE2A270)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER__DOREFRESHVIEWWITHOUTLEVELUPGRADE_G__GETRAWIMAGEPATH_9_1_OFFSET UNITYSDK_OFFSET(0xAE29FC0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE2A2D0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xAE2A340)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE2A350)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE2A3D0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE2A430)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastLevelWidgetController_TypeDefinitionIndex = 68839;
