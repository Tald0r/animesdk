...
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_DOPLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0x98F1050)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_DOREFRESHVIEWWITHLEVELUPGRADE_OFFSET UNITYSDK_OFFSET(0x98F0DB0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_DOREFRESHVIEWWITHOUTLEVELUPGRADE_OFFSET UNITYSDK_OFFSET(0x98F05A0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_GETLEVELICONSTATE_OFFSET UNITYSDK_OFFSET(0x98F1360)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_GETNUMIMGPATH_OFFSET UNITYSDK_OFFSET(0x98F13E0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_GETREMAPPEDPROGRESS_OFFSET UNITYSDK_OFFSET(0x98F1710)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x98F01D0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x98F0350)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98F0270)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98F0040)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98F0120)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_PLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0x98F0ED0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x98F04C0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0x98F1600)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98F17B0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER__DOREFRESHVIEWWITHOUTLEVELUPGRADE_B__9_0_OFFSET UNITYSDK_OFFSET(0x98F17E0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER__DOREFRESHVIEWWITHOUTLEVELUPGRADE_G__GETRAWIMAGEPATH_9_1_OFFSET UNITYSDK_OFFSET(0x98F1530)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x98F1840)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x98F18B0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98F18C0)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98F1940)
#define MOLEMOLE_UIOVERLORDFEASTLEVELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98F19A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastLevelWidgetController_TypeDefinitionIndex = 54709;

	class UIOverlordFeastLevelWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		// static const ::System::String* LevelNumBaseDir; // 0x0
		// static const ::System::String* FadeInAnimName; // 0x0
		// static const ::System::String* LoopAnimName; // 0x0
		::Class_2_7085AB20EBA3F193* _view; // 0x2A0
		::MoleMole::MonoUIOverlordFeastLevelConfig* _config; // 0x2A8
