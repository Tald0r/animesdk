...
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_GOGUIDE_OFFSET UNITYSDK_OFFSET(0xB95DB70)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB95D810)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB95D8B0)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB95D610)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB95D6B0)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_REFRESHBUFFINFO_OFFSET UNITYSDK_OFFSET(0xB95DAD0)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_REFRESHCOMPWIDGET_OFFSET UNITYSDK_OFFSET(0xB95D990)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB95DC00)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB95DC30)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB95DCA0)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB95DD20)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB95DD80)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCompDoubleWidgetController_TypeDefinitionIndex = 43963;

	class UIActivityCompDoubleWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_B641922BEA7E7FD3* _view; // 0x2A0
