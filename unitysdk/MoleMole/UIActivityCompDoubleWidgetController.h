...
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_GOGUIDE_OFFSET UNITYSDK_OFFSET(0xB8EF370)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB8EF010)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB8EF0B0)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB8EEE10)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB8EEEB0)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_REFRESHBUFFINFO_OFFSET UNITYSDK_OFFSET(0xB8EF2D0)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER_REFRESHCOMPWIDGET_OFFSET UNITYSDK_OFFSET(0xB8EF190)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB8EF400)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB8EF430)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB8EF4A0)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB8EF520)
#define MOLEMOLE_UIACTIVITYCOMPDOUBLEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB8EF580)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCompDoubleWidgetController_TypeDefinitionIndex = 64172;

	class UIActivityCompDoubleWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_B641922BEA7E7FD3_2* _view; // 0x2A0
		::Class_1_D375C91CCE5D3999* activityData; // 0x2A8
		::MoleMole::ActivityWidgetContext* activityWidgetContext; // 0x2B0
