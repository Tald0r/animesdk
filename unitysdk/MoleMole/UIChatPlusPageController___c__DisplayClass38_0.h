...
#define MOLEMOLE_UICHATPLUSPAGECONTROLLER___C__DISPLAYCLASS38_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC29B930)
#define MOLEMOLE_UICHATPLUSPAGECONTROLLER___C__DISPLAYCLASS38_0__PLAYSTORYNODE_B__1_OFFSET UNITYSDK_OFFSET(0xC29C5D0)
#define MOLEMOLE_UICHATPLUSPAGECONTROLLER___C__DISPLAYCLASS38_0__PLAYSTORYNODE_B__2_OFFSET UNITYSDK_OFFSET(0xC29C610)
#define MOLEMOLE_UICHATPLUSPAGECONTROLLER___C__DISPLAYCLASS38_0__PLAYSTORYNODE_B__3_OFFSET UNITYSDK_OFFSET(0xC29C6A0)
#define MOLEMOLE_UICHATPLUSPAGECONTROLLER___C__DISPLAYCLASS38_0__PLAYSTORYNODE_B__5_OFFSET UNITYSDK_OFFSET(0xC29C690)
#define MOLEMOLE_UICHATPLUSPAGECONTROLLER___C__DISPLAYCLASS38_0__PLAYSTORYNODE_G__DOPLAYSTORYNODE_0_OFFSET UNITYSDK_OFFSET(0xC29B940)

namespace MoleMole
{
	inline static constexpr unsigned int UIChatPlusPageController___c__DisplayClass38_0_TypeDefinitionIndex = 46037;
	...
	public:
		...
		::System::Action_1<::System::Boolean>* finishFunc; // 0x18
		::Class_3_A72BA6D8C1BF0087_1* __9__5; // 0x20
		::System::Action* voiceEndFunc; // 0x28
		::MoleMole::GalGame::PlayChatPlusStoryNode* config; // 0x30
