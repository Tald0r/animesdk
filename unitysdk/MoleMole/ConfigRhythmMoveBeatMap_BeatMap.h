...
#define MOLEMOLE_CONFIGRHYTHMMOVEBEATMAP_BEATMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x16BBB650)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigRhythmMoveBeatMap_BeatMap_TypeDefinitionIndex = 58811;
