...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCF9B070)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__SHOWQUESTRECOMMEND_B__2_OFFSET UNITYSDK_OFFSET(0xCF9BBB0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__SHOWQUESTRECOMMEND_B__3_OFFSET UNITYSDK_OFFSET(0xCF9BD60)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__SHOWQUESTRECOMMEND_G__OPENQUESTRECOMMEND_0_OFFSET UNITYSDK_OFFSET(0xCF9B080)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_0__SHOWQUESTRECOMMEND_G__REFRESHQUESTLIST_1_OFFSET UNITYSDK_OFFSET(0xCF9B330)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass55_0_TypeDefinitionIndex = 68992;
