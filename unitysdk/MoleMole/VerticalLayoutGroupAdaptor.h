...
#define MOLEMOLE_VERTICALLAYOUTGROUPADAPTOR_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0xA6E5500)
#define MOLEMOLE_VERTICALLAYOUTGROUPADAPTOR_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0xA6E5520)
#define MOLEMOLE_VERTICALLAYOUTGROUPADAPTOR_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0xA6E56A0)
#define MOLEMOLE_VERTICALLAYOUTGROUPADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA6E55A0)

namespace MoleMole
{
	inline static constexpr unsigned int VerticalLayoutGroupAdaptor_TypeDefinitionIndex = 38566;
