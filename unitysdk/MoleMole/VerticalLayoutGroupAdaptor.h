...
#define MOLEMOLE_VERTICALLAYOUTGROUPADAPTOR_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x7C6F920)
#define MOLEMOLE_VERTICALLAYOUTGROUPADAPTOR_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x7C6F940)
#define MOLEMOLE_VERTICALLAYOUTGROUPADAPTOR_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x7C6FAC0)
#define MOLEMOLE_VERTICALLAYOUTGROUPADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x7C6F9C0)

namespace MoleMole
{
	inline static constexpr unsigned int VerticalLayoutGroupAdaptor_TypeDefinitionIndex = 63550;
