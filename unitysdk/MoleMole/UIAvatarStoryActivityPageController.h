...
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_AFTERSHOW_OFFSET UNITYSDK_OFFSET(0xC0A9F30)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_GET_PAGEWIDGETSTATE_OFFSET UNITYSDK_OFFSET(0xC0A8D20)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC0A9120)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONACTIVITYCLOSE_OFFSET UNITYSDK_OFFSET(0xC0AD360)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKBACK_OFFSET UNITYSDK_OFFSET(0xC0AA630)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKCOINBRUSHINGENTRY_OFFSET UNITYSDK_OFFSET(0xC0AAEC0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKLEFTACTIVITYTAB_OFFSET UNITYSDK_OFFSET(0xC0ABE10)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKNEXTBTN_OFFSET UNITYSDK_OFFSET(0xC0ACE50)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKRIGHTACTIVITYTAB_OFFSET UNITYSDK_OFFSET(0xC0ABEB0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xC0ABBA0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCLICKTIMELIMISHOP_OFFSET UNITYSDK_OFFSET(0xC0ACAA0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0A9130)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONENTEROVA_OFFSET UNITYSDK_OFFSET(0xC0AB040)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONENTERSPECIALENTRY_OFFSET UNITYSDK_OFFSET(0xC0AAB10)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONENTERSTORY_OFFSET UNITYSDK_OFFSET(0xC0AB840)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONSELECTBATTLEQUEST_OFFSET UNITYSDK_OFFSET(0xC0AA960)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC0AA580)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0AA4C0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0A91D0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0A9BA0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_OPENAVATARWIDGETBYBTN_OFFSET UNITYSDK_OFFSET(0xC0AC650)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_OPENMAINBATTLEWIDGET_OFFSET UNITYSDK_OFFSET(0xC0ABA50)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_OPENSTORYWIDEGT_OFFSET UNITYSDK_OFFSET(0xC0AB430)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_PERUNLOCKQUEST_OFFSET UNITYSDK_OFFSET(0xC0AB3B0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_RECOVERCURRENTAVATARWIDGET_OFFSET UNITYSDK_OFFSET(0xC0AAA30)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_SETAVATARACTIVITYTAB_OFFSET UNITYSDK_OFFSET(0xC0ABF50)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_SETBG_OFFSET UNITYSDK_OFFSET(0xC0AC300)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_SETCOMPWEEKREWARDBTN_OFFSET UNITYSDK_OFFSET(0xC0ACEB0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_SET_PAGEWIDGETSTATE_OFFSET UNITYSDK_OFFSET(0xC0A8D30)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER_UPDATETAB_OFFSET UNITYSDK_OFFSET(0xC0AA0A0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0AD6B0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER__ONACTIVITYCLOSE_B__53_0_OFFSET UNITYSDK_OFFSET(0xC0AD8B0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER__ONUIINIT_B__27_0_OFFSET UNITYSDK_OFFSET(0xC0AD7D0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER__ONUIINIT_B__27_1_OFFSET UNITYSDK_OFFSET(0xC0AD7E0)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER__ONUIINIT_B__27_2_OFFSET UNITYSDK_OFFSET(0xC0AD840)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER___BASE_AFTERSHOW_OFFSET UNITYSDK_OFFSET(0xC0AD980)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0AD990)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC0ADA00)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0ADA70)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0ADA80)
#define MOLEMOLE_UIAVATARSTORYACTIVITYPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0ADA90)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarStoryActivityPageController_TypeDefinitionIndex = 39943;
	...
	public:
		...
		::Class_2_208CC9941471731A_147* aSAStoryDisplayConfig; // 0x378
