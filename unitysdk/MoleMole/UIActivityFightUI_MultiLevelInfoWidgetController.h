...
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9B08F90)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9B09000)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x9B09250)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9B09100)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER_SETLEVELLIST_OFFSET UNITYSDK_OFFSET(0x9B09170)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9B094A0)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9B094D0)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x9B09540)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9B095B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityFightUI_MultiLevelInfoWidgetController_TypeDefinitionIndex = 75869;
	...
	public:
		...
		::System::Void SetLevelList(::Class_1_634159F7561ADAA0<::Class_2_8B68985DBB1127AC*>* levels, ::System::Int32 selectIndex)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_634159F7561ADAA0<::Class_2_8B68985DBB1127AC*>*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER_SETLEVELLIST_OFFSET))(this, levels, selectIndex);
		}
