...
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA57D860)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA57D8D0)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA57DB20)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA57D9D0)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER_SETLEVELLIST_OFFSET UNITYSDK_OFFSET(0xA57DA40)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCB12B10)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB12B40)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xCB12BB0)
#define MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCB12C20)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityFightUI_MultiLevelInfoWidgetController_TypeDefinitionIndex = 66800;
	...
	public:
		...
		::System::Void SetLevelList(::Class_1_634159F7561ADAA0<::Class_2_F62B884564C8E6BA*>* levels, ::System::Int32 selectIndex)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_634159F7561ADAA0<::Class_2_F62B884564C8E6BA*>*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYFIGHTUI_MULTILEVELINFOWIDGETCONTROLLER_SETLEVELLIST_OFFSET))(this, levels, selectIndex);
		}
