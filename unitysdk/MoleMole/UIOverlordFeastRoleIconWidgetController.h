...
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA232380)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_ONDISHUNLOCK_OFFSET UNITYSDK_OFFSET(0xA2330F0)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA232500)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA232420)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA2320B0)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA2322D0)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_OPENTIPS_OFFSET UNITYSDK_OFFSET(0xA232F40)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_SETBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xA232DD0)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_SETDISH_OFFSET UNITYSDK_OFFSET(0xA232A30)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_SETGUEST_OFFSET UNITYSDK_OFFSET(0xA232690)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_SETVIEW_OFFSET UNITYSDK_OFFSET(0xA232E60)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA233200)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA233220)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA233290)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA233310)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA233390)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA2333F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastRoleIconWidgetController_TypeDefinitionIndex = 52689;

	class UIOverlordFeastRoleIconWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_1ED77DD93111CFA0* _view; // 0x2D0
		::System::Int32 _guestID; // 0x2D8
		::System::Int32 _dishID; // 0x2DC
		::System::Int32 _gameID; // 0x2E0
