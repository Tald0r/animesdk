...
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB81940)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_ONDISHUNLOCK_OFFSET UNITYSDK_OFFSET(0xAB826B0)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAB81AC0)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB819E0)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB81680)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB81890)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_OPENTIPS_OFFSET UNITYSDK_OFFSET(0xAB82500)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_SETBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xAB82390)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_SETDISH_OFFSET UNITYSDK_OFFSET(0xAB82000)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_SETGUEST_OFFSET UNITYSDK_OFFSET(0xAB81C50)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER_SETVIEW_OFFSET UNITYSDK_OFFSET(0xAB82420)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB827C0)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB827E0)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAB82850)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB828D0)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB82950)
#define MOLEMOLE_UIOVERLORDFEASTROLEICONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB829B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastRoleIconWidgetController_TypeDefinitionIndex = 45700;
