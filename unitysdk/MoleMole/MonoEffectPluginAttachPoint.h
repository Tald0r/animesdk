...
#define MOLEMOLE_MONOEFFECTPLUGINATTACHPOINT_GETATTACHPOINTBYENTITY_OFFSET UNITYSDK_OFFSET(0x67B2730)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x67B2AF0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAttachPoint_TypeDefinitionIndex = 42042;
