...
#define MOLEMOLE_MONOEFFECTPLUGINATTACHPOINT_GETATTACHPOINTBYENTITY_OFFSET UNITYSDK_OFFSET(0x75B07E0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x75B0BA0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAttachPoint_TypeDefinitionIndex = 71176;
