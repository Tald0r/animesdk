...
#define MOLEMOLE_UIACTIVITYWEAPONBANGBOOBGWIDGETCONTROLLER_ONCLICKPREVIEWBTN_OFFSET UNITYSDK_OFFSET(0xDD8C8E0)
#define MOLEMOLE_UIACTIVITYWEAPONBANGBOOBGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDD8C5D0)
#define MOLEMOLE_UIACTIVITYWEAPONBANGBOOBGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDD8C670)
#define MOLEMOLE_UIACTIVITYWEAPONBANGBOOBGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDD8C400)
#define MOLEMOLE_UIACTIVITYWEAPONBANGBOOBGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDD8C4A0)
#define MOLEMOLE_UIACTIVITYWEAPONBANGBOOBGWIDGETCONTROLLER_SETWEAPONORBANGBOOID_OFFSET UNITYSDK_OFFSET(0xDD8C750)
#define MOLEMOLE_UIACTIVITYWEAPONBANGBOOBGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDD8C950)
#define MOLEMOLE_UIACTIVITYWEAPONBANGBOOBGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDD8C980)
#define MOLEMOLE_UIACTIVITYWEAPONBANGBOOBGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDD8C9F0)
#define MOLEMOLE_UIACTIVITYWEAPONBANGBOOBGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDD8CA70)
#define MOLEMOLE_UIACTIVITYWEAPONBANGBOOBGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDD8CAD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityWeaponBangbooBGWidgetController_TypeDefinitionIndex = 57335;
