...
#define MOLEMOLE_UILEVELRESULTV2_BABELTOWERPAGECONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x876BB20)
#define MOLEMOLE_UILEVELRESULTV2_BABELTOWERPAGECONTROLLER___C__DISPLAYCLASS8_0__NEEDSHOWCHEATING_B__0_OFFSET UNITYSDK_OFFSET(0x876BB30)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultV2_BabeltowerPageController___c__DisplayClass8_0_TypeDefinitionIndex = 65396;
