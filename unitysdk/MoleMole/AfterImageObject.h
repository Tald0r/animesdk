...
#define MOLEMOLE_AFTERIMAGEOBJECT_AWAKE_OFFSET UNITYSDK_OFFSET(0xCAC2EF0)
#define MOLEMOLE_AFTERIMAGEOBJECT_BEGINBLURSHADOW_OFFSET UNITYSDK_OFFSET(0xCAC2FA0)
#define MOLEMOLE_AFTERIMAGEOBJECT_METHOD_5_102A1038C38883F3_OFFSET UNITYSDK_OFFSET(0xCAC3940)
#define MOLEMOLE_AFTERIMAGEOBJECT_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xCAC36C0)
#define MOLEMOLE_AFTERIMAGEOBJECT_METHOD_5_C0183173C828D7C0_OFFSET UNITYSDK_OFFSET(0xCAC3190)
#define MOLEMOLE_AFTERIMAGEOBJECT_METHOD_5_F5E47CC27E96B888_OFFSET UNITYSDK_OFFSET(0xCAC3B80)
#define MOLEMOLE_AFTERIMAGEOBJECT_METHOD_5_F655FFE0347E3008_OFFSET UNITYSDK_OFFSET(0xCAC3C20)
#define MOLEMOLE_AFTERIMAGEOBJECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCAC39B0)
#define MOLEMOLE_AFTERIMAGEOBJECT_STOPBLURSHADOW_OFFSET UNITYSDK_OFFSET(0xCAC3590)
#define MOLEMOLE_AFTERIMAGEOBJECT_UPDATE_OFFSET UNITYSDK_OFFSET(0xCAC37E0)
#define MOLEMOLE_AFTERIMAGEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCAC3B60)

namespace MoleMole
{
	inline static constexpr unsigned int AfterImageObject_TypeDefinitionIndex = 42927;
