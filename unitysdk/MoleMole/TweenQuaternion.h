...
#define MOLEMOLE_TWEENQUATERNION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x8FA7B50)
#define MOLEMOLE_TWEENQUATERNION_METHOD_7_CE8B195E1AAB80E3_OFFSET UNITYSDK_OFFSET(0x8FA7BF0)
#define MOLEMOLE_TWEENQUATERNION_METHOD_7_D3E17EE162EAD52F_OFFSET UNITYSDK_OFFSET(0x8FA7CC0)
#define MOLEMOLE_TWEENQUATERNION_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x8FA7B60)
#define MOLEMOLE_TWEENQUATERNION__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA7E00)
#define MOLEMOLE_TWEENQUATERNION___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x8FA7E10)

namespace MoleMole
{
	inline static constexpr unsigned int TweenQuaternion_TypeDefinitionIndex = 74853;
