...
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA82D300)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA82D480)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA82D3A0)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA82D260)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA82D6C0)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA82D6D0)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA82D740)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA82D7C0)
#define MOLEMOLE_UIMARCELMAPROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA82D840)

namespace MoleMole
{
	inline static constexpr unsigned int UIMarcelMapRowWidgetController_TypeDefinitionIndex = 64954;

	class UIMarcelMapRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_22FEBBA7FA4D4D4A_2* _view; // 0x2D0
