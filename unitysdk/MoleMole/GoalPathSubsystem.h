...
#define MOLEMOLE_GOALPATHSUBSYSTEM_DESTROYALLGOALPATH_OFFSET UNITYSDK_OFFSET(0x9915900)
#define MOLEMOLE_GOALPATHSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x9915710)
#define MOLEMOLE_GOALPATHSUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9915850)
#define MOLEMOLE_GOALPATHSUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x99157B0)
#define MOLEMOLE_GOALPATHSUBSYSTEM_REGISTERGOALPATH_OFFSET UNITYSDK_OFFSET(0x9915BB0)
#define MOLEMOLE_GOALPATHSUBSYSTEM_UNREGISTERGOALPATH_OFFSET UNITYSDK_OFFSET(0x9916C90)
#define MOLEMOLE_GOALPATHSUBSYSTEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x9917010)
#define MOLEMOLE_GOALPATHSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9916F80)
#define MOLEMOLE_GOALPATHSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x9917260)
#define MOLEMOLE_GOALPATHSUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x99172C0)
#define MOLEMOLE_GOALPATHSUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x9917320)

namespace MoleMole
{
	inline static constexpr unsigned int GoalPathSubsystem_TypeDefinitionIndex = 42044;

	class GoalPathSubsystem : public ::MoleMole::GameSubsystemBaseEx_1<::MoleMole::GoalPathSubsystem*>
	{
	public:
		static ::System::Collections::Generic::Dictionary_2<::Enum_3_4C4816AD446DEFA2, ::System::String*>** StaticGet_GoalPathTypeMap()
		{
			return (::System::Collections::Generic::Dictionary_2<::Enum_3_4C4816AD446DEFA2, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(GoalPathSubsystem_TypeDefinitionIndex)->GetStaticField(0x34550);
		}
