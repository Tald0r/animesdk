...
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0xE8ECC50)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___C__DISPLAYCLASS21_0__SHOWVERSIONUPDATEREMINDER_WITHUNITASK_B__0_OFFSET UNITYSDK_OFFSET(0xE8ECC60)
#define MOLEMOLE_UIABYSSS2ENTRANCEPAGECONTROLLER___C__DISPLAYCLASS21_0__SHOWVERSIONUPDATEREMINDER_WITHUNITASK_B__1_OFFSET UNITYSDK_OFFSET(0xE8ECF10)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2EntrancePageController___c__DisplayClass21_0_TypeDefinitionIndex = 80145;

	class UIAbyssS2EntrancePageController___c__DisplayClass21_0 : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_271* needShowConfig; // 0x10
		::System::Action* __9__1; // 0x18
		::Cysharp::Threading::Tasks::UniTaskCompletionSource_1<::System::Int32>* tcs; // 0x20
		::MoleMole::UIAbyssS2EntrancePageController* __4__this; // 0x28
