...
#define MOLEMOLE_PARTICLEQUALITYSETTINGENTRY_GET_PROFILETYPE_OFFSET UNITYSDK_OFFSET(0x67C8DC0)
#define MOLEMOLE_PARTICLEQUALITYSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x67C8DB0)
#define MOLEMOLE_PARTICLEQUALITYSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x67C8DD0)

namespace MoleMole
{
	inline static constexpr unsigned int ParticleQualitySettingEntry_TypeDefinitionIndex = 71090;
