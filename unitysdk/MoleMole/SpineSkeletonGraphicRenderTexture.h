...
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_AWAKE_OFFSET UNITYSDK_OFFSET(0xA65BFF0)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_BINDRT_OFFSET UNITYSDK_OFFSET(0xA65DF60)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_CLAMPVECTOR3_OFFSET UNITYSDK_OFFSET(0xA65DDC0)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_CLEARRT_OFFSET UNITYSDK_OFFSET(0xA65DA50)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_DOIMAGELISTDESTROY_OFFSET UNITYSDK_OFFSET(0xA65B540)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_METHOD_6_24983FE76D082542_OFFSET UNITYSDK_OFFSET(0xA65F900)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_METHOD_6_3CAB3F134E5CEF52_OFFSET UNITYSDK_OFFSET(0xA65F550)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_METHOD_6_42583DA595DCD536_OFFSET UNITYSDK_OFFSET(0xA65F5E0)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xA65DE70)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_METHOD_6_4EED0FA306E026CA_OFFSET UNITYSDK_OFFSET(0xA65F320)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_METHOD_6_57454248D6301A57_OFFSET UNITYSDK_OFFSET(0xA65F4D0)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_METHOD_6_8E9E3E0D1D6E6E24_OFFSET UNITYSDK_OFFSET(0xA65C2E0)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_METHOD_6_A27DC2C5A103933A_OFFSET UNITYSDK_OFFSET(0xA65E230)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_METHOD_6_E7A46A8E39261DE6_OFFSET UNITYSDK_OFFSET(0xA65ED60)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_METHOD_6_FC793E2201556942_OFFSET UNITYSDK_OFFSET(0xA65F800)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA65DBE0)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA65D550)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA65D080)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_ONSPINERTCREATEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xA65DEF0)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_ONSPINERTRELEASEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xA65E0F0)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_RESETSPINEMATERIALTEXTURELIST_OFFSET UNITYSDK_OFFSET(0xA65C8B0)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_RESET_OFFSET UNITYSDK_OFFSET(0xA65D010)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_SETIMAGELISTMESH_OFFSET UNITYSDK_OFFSET(0xA65B710)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE_SETIMAGELISTRT_OFFSET UNITYSDK_OFFSET(0xA65BE20)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0xA65E160)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0xA65E210)
#define MOLEMOLE_SPINESKELETONGRAPHICRENDERTEXTURE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA65E220)

namespace MoleMole
{
	inline static constexpr unsigned int SpineSkeletonGraphicRenderTexture_TypeDefinitionIndex = 39804;
