...
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS40_1__CTOR_OFFSET UNITYSDK_OFFSET(0x9EE3450)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS40_1__PERFORMANCEEXPAND_B__1_OFFSET UNITYSDK_OFFSET(0x9EE3460)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS40_1__PERFORMANCEEXPAND_B__2_OFFSET UNITYSDK_OFFSET(0x9EE3610)

namespace MoleMole
{
	inline static constexpr unsigned int UITapesGroup3DModelController___c__DisplayClass40_1_TypeDefinitionIndex = 53121;
