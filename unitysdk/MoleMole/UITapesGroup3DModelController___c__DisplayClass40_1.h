...
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS40_1__CTOR_OFFSET UNITYSDK_OFFSET(0xAE92130)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS40_1__PERFORMANCEEXPAND_B__1_OFFSET UNITYSDK_OFFSET(0xAE92140)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS40_1__PERFORMANCEEXPAND_B__2_OFFSET UNITYSDK_OFFSET(0xAE922F0)

namespace MoleMole
{
	inline static constexpr unsigned int UITapesGroup3DModelController___c__DisplayClass40_1_TypeDefinitionIndex = 69981;
