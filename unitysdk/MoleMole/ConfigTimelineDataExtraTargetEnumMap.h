...
#define MOLEMOLE_CONFIGTIMELINEDATAEXTRATARGETENUMMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xBB0BF90)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTimelineDataExtraTargetEnumMap_TypeDefinitionIndex = 39077;
