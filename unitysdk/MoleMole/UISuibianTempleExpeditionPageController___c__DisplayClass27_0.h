...
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAE539B0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___C__DISPLAYCLASS27_0__ONFOCUSAREA_B__0_OFFSET UNITYSDK_OFFSET(0xAE539C0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___C__DISPLAYCLASS27_0__ONFOCUSAREA_B__1_OFFSET UNITYSDK_OFFSET(0xAE53AC0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleExpeditionPageController___c__DisplayClass27_0_TypeDefinitionIndex = 58229;
