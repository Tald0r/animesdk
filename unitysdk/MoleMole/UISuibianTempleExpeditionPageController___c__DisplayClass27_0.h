...
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0x751FC50)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___C__DISPLAYCLASS27_0__ONFOCUSAREA_B__0_OFFSET UNITYSDK_OFFSET(0x751FC60)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONPAGECONTROLLER___C__DISPLAYCLASS27_0__ONFOCUSAREA_B__1_OFFSET UNITYSDK_OFFSET(0x751FD60)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleExpeditionPageController___c__DisplayClass27_0_TypeDefinitionIndex = 37767;
