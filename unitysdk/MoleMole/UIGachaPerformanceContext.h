...
#define MOLEMOLE_UIGACHAPERFORMANCECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6C5E9E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPerformanceContext_TypeDefinitionIndex = 73979;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::Int32>* ItemResults; // 0x38
		::System::Boolean SkipOpenning; // 0x40
		::System::Boolean ShowBackBtn; // 0x41
		::System::Boolean IsNonGacha; // 0x42
