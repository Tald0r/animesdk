...
#define MOLEMOLE_UIGACHAPERFORMANCECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8C05980)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPerformanceContext_TypeDefinitionIndex = 63459;
	...
	public:
		...
		::System::Boolean AnimaCheckMode; // 0x44
		::System::Boolean IsNonGacha; // 0x45
		::System::Boolean ShowBackBtn; // 0x46
		::System::Boolean SkipOpenning; // 0x47
