...
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAE46130)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER___C__DISPLAYCLASS24_0__REFRESHDETAIL_B__0_OFFSET UNITYSDK_OFFSET(0xAE46140)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER___C__DISPLAYCLASS24_0__REFRESHDETAIL_B__2_OFFSET UNITYSDK_OFFSET(0xAE462A0)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefenseLevelPageController___c__DisplayClass24_0_TypeDefinitionIndex = 73965;
	...
	public:
		...
		::Class_2_208CC9941471731A_710* template_; // 0x18
