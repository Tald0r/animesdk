...
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_BINDEVENTS_OFFSET UNITYSDK_OFFSET(0xD2C19E0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_CHECKCROSSHAIRRANGE_OFFSET UNITYSDK_OFFSET(0xD2CB220)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_CORERELOAD_OFFSET UNITYSDK_OFFSET(0xD2C3970)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_CORESKILLRUNNING_OFFSET UNITYSDK_OFFSET(0xD2C32E0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETCROSSHAIRBASEMOVERATIO_OFFSET UNITYSDK_OFFSET(0xD2C4B40)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETCROSSHAIRMOVESPEEDRATIO_OFFSET UNITYSDK_OFFSET(0xD2C41E0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETDRAGSENSITIVITY_OFFSET UNITYSDK_OFFSET(0xD2C4170)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETSCORERANKINFO_OFFSET UNITYSDK_OFFSET(0xD2C68F0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETSYSTEMMOVESPEEDXRATIO_OFFSET UNITYSDK_OFFSET(0xD2C4290)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETSYSTEMMOVESPEEDYRATIO_OFFSET UNITYSDK_OFFSET(0xD2C4580)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETWEAPONICONPATHBYCONFIGKEY_OFFSET UNITYSDK_OFFSET(0xD2C5E40)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETWEAPONINFOBYKEY_OFFSET UNITYSDK_OFFSET(0xD2C7F90)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETWEAPONINFO_OFFSET UNITYSDK_OFFSET(0xD2C7B90)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xD2C0830)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GET_ISWEAPONSKILLSTART_OFFSET UNITYSDK_OFFSET(0xD2C32D0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GET_MISSIONTIPS_OFFSET UNITYSDK_OFFSET(0xD2C1F10)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GET_ONGOINGCONTROLLER_OFFSET UNITYSDK_OFFSET(0xD2C0840)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0xD2C0820)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD2C0810)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0xD2C1960)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_INITSCORERANK_OFFSET UNITYSDK_OFFSET(0xD2C6330)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_INITUIDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0xD2C1D40)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_INITWEAPONLIST_OFFSET UNITYSDK_OFFSET(0xD2C4BF0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD2C2D00)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_MOVECROSSHAIR_OFFSET UNITYSDK_OFFSET(0xD2C2850)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONAMMOCHANGED_OFFSET UNITYSDK_OFFSET(0xD2C77C0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONAMMOFULL_OFFSET UNITYSDK_OFFSET(0xD2C7DA0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONBULLETHITTARGET_OFFSET UNITYSDK_OFFSET(0xD2CAA30)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONCLICKWEAPONTAB_OFFSET UNITYSDK_OFFSET(0xD2CBAC0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONCLICKWEAPON_OFFSET UNITYSDK_OFFSET(0xD2CBA50)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD2C0960)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONCROSSHAIREVENT_OFFSET UNITYSDK_OFFSET(0xD2C75C0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD2C2160)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xD2C4A00)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONEXITGAME_OFFSET UNITYSDK_OFFSET(0xD2CB8F0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONFREESHOOTSTATECHANGE_OFFSET UNITYSDK_OFFSET(0xD2C90F0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xD2C2050)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD2C25D0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONPERFORMNOTIFY_OFFSET UNITYSDK_OFFSET(0xD2CB5F0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONRELOADSTART_OFFSET UNITYSDK_OFFSET(0xD2C8A30)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONRELOADSTOP_OFFSET UNITYSDK_OFFSET(0xD2C8D20)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONRESTARTGAME_OFFSET UNITYSDK_OFFSET(0xD2CB9A0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONSHOOTBUTTONPRESSSTART_OFFSET UNITYSDK_OFFSET(0xD2CA690)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONSHOOTBUTTONPRESSUP_OFFSET UNITYSDK_OFFSET(0xD2CA860)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONSHOOTSCORECHANGE_OFFSET UNITYSDK_OFFSET(0xD2C9160)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONSHOOTSTART_OFFSET UNITYSDK_OFFSET(0xD2CA4D0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD2C1F20)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONSYSTEMSENSITIVITYUPDATE_OFFSET UNITYSDK_OFFSET(0xD2CB580)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD2C4870)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD2C0B90)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONWEAPONCHANGE_OFFSET UNITYSDK_OFFSET(0xD2C81E0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONWEAPONSKILLEND_OFFSET UNITYSDK_OFFSET(0xD2C9EA0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONWEAPONSKILLSTART_OFFSET UNITYSDK_OFFSET(0xD2CA1B0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONWEAPONSWITCHED_OFFSET UNITYSDK_OFFSET(0xD2C9840)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_PAUSEGAME_OFFSET UNITYSDK_OFFSET(0xD2CB860)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_PLAYFINISHTIP_OFFSET UNITYSDK_OFFSET(0xD2C0860)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_PLAYSTARTTIPS_OFFSET UNITYSDK_OFFSET(0xD2C0A00)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_POPSCORE_OFFSET UNITYSDK_OFFSET(0xD2C94C0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REFRESHBASEMOVERATIO_OFFSET UNITYSDK_OFFSET(0xD2CB380)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REFRESHSCORERANKINFO_OFFSET UNITYSDK_OFFSET(0xD2C6C60)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REFRESHSELECTWEAPON_OFFSET UNITYSDK_OFFSET(0xD2C8590)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REFRESHWEAPONDISPLAYINFO_OFFSET UNITYSDK_OFFSET(0xD2C5180)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REFRESHWEAPONDISPLAYSTATE_OFFSET UNITYSDK_OFFSET(0xD2CAB20)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REFRESHWEAPONSKILLSTATE_OFFSET UNITYSDK_OFFSET(0xD2C8930)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REGISTEREVENT_OFFSET UNITYSDK_OFFSET(0xD2C1570)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SELECTWEAPON_OFFSET UNITYSDK_OFFSET(0xD2C58F0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETAMMOINFO_1_OFFSET UNITYSDK_OFFSET(0xD2C8080)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETAMMOINFO_OFFSET UNITYSDK_OFFSET(0xD2C7C60)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETCOREPROGRESS_OFFSET UNITYSDK_OFFSET(0xD2C6DB0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETMAXAMMOINFO_1_OFFSET UNITYSDK_OFFSET(0xD2C8F90)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETMAXAMMOINFO_OFFSET UNITYSDK_OFFSET(0xD2C87F0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETRELOADTIMERATIO_OFFSET UNITYSDK_OFFSET(0xD2C8BF0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETTOTALWAVE_OFFSET UNITYSDK_OFFSET(0xD2C1DE0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETWEAPONDISPLAYINFONOWEAPON_OFFSET UNITYSDK_OFFSET(0xD2C8E40)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SET_ONGOINGCONTROLLER_OFFSET UNITYSDK_OFFSET(0xD2C0850)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_STARTNEXTWAVE_OFFSET UNITYSDK_OFFSET(0xD2C1E70)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_TICKSCOREWIDGET_OFFSET UNITYSDK_OFFSET(0xD2C3610)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_TRYINITCROSSHAIRRANGE_OFFSET UNITYSDK_OFFSET(0xD2C3C00)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_TRYLOADWEAPONCROSSHAIR_OFFSET UNITYSDK_OFFSET(0xD2C54B0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_TRYLOADWEAPONSKILLCROSSHAIR_OFFSET UNITYSDK_OFFSET(0xD2C7170)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_TRYREFRESHCROSSHAIR_OFFSET UNITYSDK_OFFSET(0xD2C5AC0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD2CBEF0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD2CBB70)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER__PLAYSTARTTIPS_G__STARTGAME_31_0_OFFSET UNITYSDK_OFFSET(0xD2CBF30)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD2CC060)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD2CC0D0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xD2CC0E0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD2CC140)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD2CC170)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD2CC180)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD2CC190)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerEventShootMainPageController_TypeDefinitionIndex = 55080;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UISummerEventShootMainPageController_TypeDefinitionIndex)->GetStaticField(0x10840);
		}
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_0_16E4307DCC419505_518*>* crossHairComponentDict; // 0x3B8
