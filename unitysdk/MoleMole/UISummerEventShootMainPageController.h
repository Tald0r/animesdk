...
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_BINDEVENTS_OFFSET UNITYSDK_OFFSET(0xAE7FB00)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_CHECKCROSSHAIRRANGE_OFFSET UNITYSDK_OFFSET(0xAE89330)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_CORERELOAD_OFFSET UNITYSDK_OFFSET(0xAE81A80)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_CORESKILLRUNNING_OFFSET UNITYSDK_OFFSET(0xAE813F0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETCROSSHAIRBASEMOVERATIO_OFFSET UNITYSDK_OFFSET(0xAE82C50)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETCROSSHAIRMOVESPEEDRATIO_OFFSET UNITYSDK_OFFSET(0xAE822F0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETDRAGSENSITIVITY_OFFSET UNITYSDK_OFFSET(0xAE82280)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETSCORERANKINFO_OFFSET UNITYSDK_OFFSET(0xAE84A00)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETSYSTEMMOVESPEEDXRATIO_OFFSET UNITYSDK_OFFSET(0xAE823A0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETSYSTEMMOVESPEEDYRATIO_OFFSET UNITYSDK_OFFSET(0xAE82690)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETWEAPONICONPATHBYCONFIGKEY_OFFSET UNITYSDK_OFFSET(0xAE83F50)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETWEAPONINFOBYKEY_OFFSET UNITYSDK_OFFSET(0xAE860A0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GETWEAPONINFO_OFFSET UNITYSDK_OFFSET(0xAE85CA0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xAE7E940)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GET_ISWEAPONSKILLSTART_OFFSET UNITYSDK_OFFSET(0xAE813E0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GET_MISSIONTIPS_OFFSET UNITYSDK_OFFSET(0xAE80030)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GET_ONGOINGCONTROLLER_OFFSET UNITYSDK_OFFSET(0xAE7E950)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0xAE7E930)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAE7E920)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0xAE7FA80)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_INITSCORERANK_OFFSET UNITYSDK_OFFSET(0xAE84440)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_INITUIDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0xAE7FE60)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_INITWEAPONLIST_OFFSET UNITYSDK_OFFSET(0xAE82D00)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAE80E20)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_MOVECROSSHAIR_OFFSET UNITYSDK_OFFSET(0xAE80970)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONAMMOCHANGED_OFFSET UNITYSDK_OFFSET(0xAE858D0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONAMMOFULL_OFFSET UNITYSDK_OFFSET(0xAE85EB0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONBULLETHITTARGET_OFFSET UNITYSDK_OFFSET(0xAE88B40)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONCLICKWEAPONTAB_OFFSET UNITYSDK_OFFSET(0xAE89BD0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONCLICKWEAPON_OFFSET UNITYSDK_OFFSET(0xAE89B60)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE7EA70)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONCROSSHAIREVENT_OFFSET UNITYSDK_OFFSET(0xAE856D0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAE80280)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xAE82B10)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONEXITGAME_OFFSET UNITYSDK_OFFSET(0xAE89A00)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONFREESHOOTSTATECHANGE_OFFSET UNITYSDK_OFFSET(0xAE871F0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAE80170)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAE806F0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONPERFORMNOTIFY_OFFSET UNITYSDK_OFFSET(0xAE89700)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONRELOADSTART_OFFSET UNITYSDK_OFFSET(0xAE86B40)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONRELOADSTOP_OFFSET UNITYSDK_OFFSET(0xAE86E30)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONRESTARTGAME_OFFSET UNITYSDK_OFFSET(0xAE89AB0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONSHOOTBUTTONPRESSSTART_OFFSET UNITYSDK_OFFSET(0xAE887A0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONSHOOTBUTTONPRESSUP_OFFSET UNITYSDK_OFFSET(0xAE88970)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONSHOOTSCORECHANGE_OFFSET UNITYSDK_OFFSET(0xAE87260)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONSHOOTSTART_OFFSET UNITYSDK_OFFSET(0xAE885E0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAE80040)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONSYSTEMSENSITIVITYUPDATE_OFFSET UNITYSDK_OFFSET(0xAE89690)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE82980)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE7ECA0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONWEAPONCHANGE_OFFSET UNITYSDK_OFFSET(0xAE862F0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONWEAPONSKILLEND_OFFSET UNITYSDK_OFFSET(0xAE87FA0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONWEAPONSKILLSTART_OFFSET UNITYSDK_OFFSET(0xAE882B0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_ONWEAPONSWITCHED_OFFSET UNITYSDK_OFFSET(0xAE87940)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_PAUSEGAME_OFFSET UNITYSDK_OFFSET(0xAE89970)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_PLAYFINISHTIP_OFFSET UNITYSDK_OFFSET(0xAE7E970)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_PLAYSTARTTIPS_OFFSET UNITYSDK_OFFSET(0xAE7EB10)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_POPSCORE_OFFSET UNITYSDK_OFFSET(0xAE875C0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REFRESHBASEMOVERATIO_OFFSET UNITYSDK_OFFSET(0xAE89490)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REFRESHSCORERANKINFO_OFFSET UNITYSDK_OFFSET(0xAE84D70)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REFRESHSELECTWEAPON_OFFSET UNITYSDK_OFFSET(0xAE866A0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REFRESHWEAPONDISPLAYINFO_OFFSET UNITYSDK_OFFSET(0xAE83290)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REFRESHWEAPONDISPLAYSTATE_OFFSET UNITYSDK_OFFSET(0xAE88C30)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REFRESHWEAPONSKILLSTATE_OFFSET UNITYSDK_OFFSET(0xAE86A40)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_REGISTEREVENT_OFFSET UNITYSDK_OFFSET(0xAE7F6A0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SELECTWEAPON_OFFSET UNITYSDK_OFFSET(0xAE83A00)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETAMMOINFO_1_OFFSET UNITYSDK_OFFSET(0xAE86190)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETAMMOINFO_OFFSET UNITYSDK_OFFSET(0xAE85D70)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETCOREPROGRESS_OFFSET UNITYSDK_OFFSET(0xAE84EC0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETMAXAMMOINFO_1_OFFSET UNITYSDK_OFFSET(0xAE87090)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETMAXAMMOINFO_OFFSET UNITYSDK_OFFSET(0xAE86900)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETRELOADTIMERATIO_OFFSET UNITYSDK_OFFSET(0xAE86D00)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETTOTALWAVE_OFFSET UNITYSDK_OFFSET(0xAE7FF00)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SETWEAPONDISPLAYINFONOWEAPON_OFFSET UNITYSDK_OFFSET(0xAE86F40)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_SET_ONGOINGCONTROLLER_OFFSET UNITYSDK_OFFSET(0xAE7E960)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_STARTNEXTWAVE_OFFSET UNITYSDK_OFFSET(0xAE7FF90)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_TICKSCOREWIDGET_OFFSET UNITYSDK_OFFSET(0xAE81720)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_TRYINITCROSSHAIRRANGE_OFFSET UNITYSDK_OFFSET(0xAE81D10)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_TRYLOADWEAPONCROSSHAIR_OFFSET UNITYSDK_OFFSET(0xAE835C0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_TRYLOADWEAPONSKILLCROSSHAIR_OFFSET UNITYSDK_OFFSET(0xAE85280)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_TRYREFRESHCROSSHAIR_OFFSET UNITYSDK_OFFSET(0xAE83BD0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xAE8A000)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE89C80)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER__PLAYSTARTTIPS_G__STARTGAME_31_0_OFFSET UNITYSDK_OFFSET(0xAE8A040)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE8A170)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAE8A1E0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAE8A1F0)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAE8A250)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAE8A280)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAE8A290)
#define MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE8A2A0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerEventShootMainPageController_TypeDefinitionIndex = 73805;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UISummerEventShootMainPageController_TypeDefinitionIndex)->GetStaticField(0x10880);
		}
		...
		::Class_2_60638234271CCDB8_110* _view; // 0x308
		::MoleMole::UISummerJoyStickChildWindowController* _joystickCtrl; // 0x310
		::MoleMole::UISummerEventShootSkillButtonShootChildWindowController* _skillButtonCtrlShoot; // 0x318
		::MoleMole::UISummerEventShootSkillButtonSwitchChildWindowController* _skillButtonCtrlSwitch; // 0x320
		::MoleMole::UISummerEventShootSkillButtonReloadChildWindowController* _skillButtonCtrlReload; // 0x328
		::MoleMole::UISummerEventShootSkillButtonExspChildWindowController* _skillButtonCtrlExsp; // 0x330
		::MoleMole::UISummerMissionTipsWidgetController* _missionTips; // 0x338
		::Class_1_D6D1B35AE0BED5AD* _ongoing; // 0x340
		::UnityEngine::Vector3 crosshairDefaultOffset; // 0x348
		::UnityEngine::RectTransform* touchPanelTransform; // 0x358
		::UnityEngine::Rect crossHairRange; // 0x360
		::System::Boolean initCrossHairRange; // 0x370
		::System::Boolean hasCrossHairRangeData; // 0x371
		::System::Boolean _gameStart; // 0x372
		::Enum_3_A019F766F8C74696 _lastInputDevice; // 0x374
		::Enum_3_F4705266FB2007C7 _cursorHideState; // 0x378
		::Class_1_B3309433BD404061* _OngoingController_k__BackingField; // 0x380
		::System::Int32 xMoveSensitivityLevel; // 0x388
		::System::Int32 yMoveSensitivityLevel; // 0x38C
		::System::Int32 weaponSkillStartCount; // 0x390
		::System::Collections::Generic::List_1<::System::String*>* weaponList; // 0x398
		::System::Collections::Generic::List_1<::MoleMole::MonoSummerEventShootWeaponUIItem*>* weaponInfoDisplayList; // 0x3A0
		::System::Int32 currentSelectWeaponIndex; // 0x3A8
		::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::GameObject*>* crossHairDict; // 0x3B0
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_0_16E4307DCC419505_417*>* crossHairComponentDict; // 0x3B8
		::System::String* currentDisplayCrosshairKey; // 0x3C0
		::System::Collections::Generic::List_1<::MoleMole::UISummerShootScoreWidgetController*>* scoreWidgetList; // 0x3C8
		::System::Collections::Generic::Queue_1<::MoleMole::UISummerShootScoreWidgetController*>* scoreWidgetRecyclePool; // 0x3D0
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* scoreRankItemList; // 0x3D8
		::System::Int32 currentRankIndex; // 0x3E0
		::System::Single currentScoreProgress; // 0x3E4
		::System::Single scoreProgressDefaultWidth; // 0x3E8
		::UnityEngine::Vector2 scoreProgressDefaultAnchorMax; // 0x3EC
		::System::Collections::Generic::List_1<::System::String*>* scoreRankChangeAnimList; // 0x3F8
		::System::Boolean isPlayRankAnim; // 0x400
		::System::Boolean bUseSkillButtonWeaponInfo; // 0x401
		::UnityEngine::Material* reloadProgressMat; // 0x408
		::System::Boolean reloadStart; // 0x410
		::System::Single reloadDisplayTimer; // 0x414
		::System::Single reloadMaxTimer; // 0x418
		...
		{
			return ((::Enum_3_F4705266FB2007C7(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISUMMEREVENTSHOOTMAINPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET))(this);
		}
