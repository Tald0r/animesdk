...
#define MOLEMOLE_UISOCIALCIRCLENEWSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x96FCA00)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleNewsContext_TypeDefinitionIndex = 63558;
