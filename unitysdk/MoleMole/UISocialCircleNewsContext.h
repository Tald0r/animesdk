...
#define MOLEMOLE_UISOCIALCIRCLENEWSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA401AB0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleNewsContext_TypeDefinitionIndex = 67862;
