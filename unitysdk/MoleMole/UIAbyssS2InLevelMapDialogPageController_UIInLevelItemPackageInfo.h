...
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMPACKAGEINFO_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xC8CE890)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMPACKAGEINFO_SETBRIEF_OFFSET UNITYSDK_OFFSET(0xC8CE8F0)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMPACKAGEINFO_SETSELECT_OFFSET UNITYSDK_OFFSET(0xC8CE960)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELITEMPACKAGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC8CE9D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2InLevelMapDialogPageController_UIInLevelItemPackageInfo_TypeDefinitionIndex = 48291;
