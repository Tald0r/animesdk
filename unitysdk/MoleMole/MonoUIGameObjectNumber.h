...
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8C8CE00)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER_SETNUMBER_OFFSET UNITYSDK_OFFSET(0x8C8BB70)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C8D030)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__DISABLEALLPARTS_OFFSET UNITYSDK_OFFSET(0x8C8C250)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__EFF_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x8C8CB10)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__HASZEROSHOWOPT_OFFSET UNITYSDK_OFFSET(0x8C8BA50)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__SETOFFSET_OFFSET UNITYSDK_OFFSET(0x8C8C4A0)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__SETPARTS_OFFSET UNITYSDK_OFFSET(0x8C8BF70)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__TRYPLAYNUMBANIMATION_OFFSET UNITYSDK_OFFSET(0x8C8C970)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__TRYSETANIMAPAUSE_OFFSET UNITYSDK_OFFSET(0x8C8CC60)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIGameObjectNumber_TypeDefinitionIndex = 66472;
