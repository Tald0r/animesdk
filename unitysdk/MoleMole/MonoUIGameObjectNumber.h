...
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8A84700)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER_SETNUMBER_OFFSET UNITYSDK_OFFSET(0x8A83460)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x8A84920)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__DISABLEALLPARTS_OFFSET UNITYSDK_OFFSET(0x8A83B50)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__EFF_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x8A84410)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__HASZEROSHOWOPT_OFFSET UNITYSDK_OFFSET(0x8A83340)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__SETOFFSET_OFFSET UNITYSDK_OFFSET(0x8A83DA0)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__SETPARTS_OFFSET UNITYSDK_OFFSET(0x8A83870)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__TRYPLAYNUMBANIMATION_OFFSET UNITYSDK_OFFSET(0x8A84270)
#define MOLEMOLE_MONOUIGAMEOBJECTNUMBER__TRYSETANIMAPAUSE_OFFSET UNITYSDK_OFFSET(0x8A84560)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIGameObjectNumber_TypeDefinitionIndex = 61168;
