...
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_CANCELTABREDSIGN_OFFSET UNITYSDK_OFFSET(0x78FE8F0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_CREATELEVELRANKWIDGETGROUP_OFFSET UNITYSDK_OFFSET(0x7900740)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0x78FEC00)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x78FDE30)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_GOTOMAINPANELBUTTON_OFFSET UNITYSDK_OFFSET(0x7901990)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x78FDE40)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x79007F0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONGOTOSELECTEQUIPPANELBUTTON_OFFSET UNITYSDK_OFFSET(0x7901480)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONPOPULARITYICONBUTTON_OFFSET UNITYSDK_OFFSET(0x7901BB0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0x79009C0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONSTARTBATTLEBUTTON_OFFSET UNITYSDK_OFFSET(0x7901B10)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONSUMMERSELECTEQUIPCHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x7901C30)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONTOGGLEPRECHECK_OFFSET UNITYSDK_OFFSET(0x79017E0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONTOGGLE_OFFSET UNITYSDK_OFFSET(0x7901540)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x78FE860)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x78FDFA0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x78FEC10)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SELECTITEMONOPEN_OFFSET UNITYSDK_OFFSET(0x7900330)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SETPANELDATA_OFFSET UNITYSDK_OFFSET(0x78FF5D0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SETTABREDSIGN_OFFSET UNITYSDK_OFFSET(0x78FFAF0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SHOWEQUIPBYDATA_OFFSET UNITYSDK_OFFSET(0x7901070)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SHOWGOTOMAINPANELBUTTON_OFFSET UNITYSDK_OFFSET(0x7900080)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SHOWSCORE_OFFSET UNITYSDK_OFFSET(0x7900BF0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7901CA0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7901D40)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x7901DB0)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7901E70)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7901E80)
#define MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7901E90)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerSelectLevelPageController_TypeDefinitionIndex = 41785;

	class UISummerSelectLevelPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_79AE422BA06F6D26_53* _view; // 0x308
		...
		::System::Void SetPanelData(::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_158*>* LevelList)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_158*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UISUMMERSELECTLEVELPAGECONTROLLER_SETPANELDATA_OFFSET))(this, LevelList);
		}
