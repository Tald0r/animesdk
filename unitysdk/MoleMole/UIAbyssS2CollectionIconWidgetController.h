...
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC803FC0)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC804060)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC803E70)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC803F10)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC804140)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_SETICON_OFFSET UNITYSDK_OFFSET(0xC804250)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER_SETOUTLINE_OFFSET UNITYSDK_OFFSET(0xC8042F0)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC804390)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC8043C0)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC804430)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8044B0)
#define MOLEMOLE_UIABYSSS2COLLECTIONICONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC804510)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2CollectionIconWidgetController_TypeDefinitionIndex = 77743;
