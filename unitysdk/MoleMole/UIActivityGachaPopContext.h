...
#define MOLEMOLE_UIACTIVITYGACHAPOPCONTEXT_INITPOPCONTEXT_OFFSET UNITYSDK_OFFSET(0x8AB9C50)
#define MOLEMOLE_UIACTIVITYGACHAPOPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8AB9DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityGachaPopContext_TypeDefinitionIndex = 69092;

	class UIActivityGachaPopContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_1_D375C91CCE5D3999* relateActivity; // 0x28
		::Class_2_208CC9941471731A_190* template_; // 0x30
