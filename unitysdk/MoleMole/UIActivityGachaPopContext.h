...
#define MOLEMOLE_UIACTIVITYGACHAPOPCONTEXT_INITPOPCONTEXT_OFFSET UNITYSDK_OFFSET(0x8CC2A00)
#define MOLEMOLE_UIACTIVITYGACHAPOPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8CC2B50)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityGachaPopContext_TypeDefinitionIndex = 58638;

	class UIActivityGachaPopContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_2_208CC9941471731A_962* template_; // 0x28
		::Class_1_D375C91CCE5D3999* relateActivity; // 0x30
