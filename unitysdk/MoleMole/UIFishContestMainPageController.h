...
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_CHANGETOFISHQTE_OFFSET UNITYSDK_OFFSET(0xC0E3170)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_CHANGETOSTARTFISH_OFFSET UNITYSDK_OFFSET(0xC0E2F70)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_CHANGETOWAITFISH_OFFSET UNITYSDK_OFFSET(0xC0E2BF0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_CLEARALLSTATE_OFFSET UNITYSDK_OFFSET(0xC0E0280)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_CLOSEMAINCITYSTOREPAGE_OFFSET UNITYSDK_OFFSET(0xC0E6DA0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_CLOSEUI_OFFSET UNITYSDK_OFFSET(0xC0E6740)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_COMPARISON_OFFSET UNITYSDK_OFFSET(0xC0E8B30)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC0DF4B0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC0E2790)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0DF5B0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHBEGINWAITIDLEHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E2E00)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHENDWAITIDLEHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E2EB0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGBATTLEPROGRESSHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E4180)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGENDCOUNTDOWNHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E7510)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGENDTIMELINEHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E7240)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGFAILPRESSHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E5970)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGHPUPDATE_OFFSET UNITYSDK_OFFSET(0xC0E6510)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGMATCHFINALTIMEHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E7930)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGMATCHTIMEOUTHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E77A0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGMATCHTIMEUPDATEHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E76A0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGQTERESULTHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E3910)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGQTETIMERATEHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E39D0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGQUEUEENDHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E6640)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSINGLEBATTLEENDHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E60C0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSTARTBATTLELOOPHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E3AB0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSTARTCOUNTDOWNHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E72B0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSTARTSINGLEBATTLEHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E4220)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSTARTSKILLHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E58A0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSTARTTIMELINEHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E71D0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSUCCESSCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E5E20)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONFISHINGSUCCESSPRESSHANDLE_OFFSET UNITYSDK_OFFSET(0xC0E5BC0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONGOINGTRIGGER_OFFSET UNITYSDK_OFFSET(0xC0E8C10)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xC0E33F0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC0E1BA0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONMATCHCLOSE_OFFSET UNITYSDK_OFFSET(0xC0E6E10)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC0E2990)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC0E1400)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0E1B10)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0E0A30)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0DF650)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xC0DF4C0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_SHOWFOLLOWTIPS_OFFSET UNITYSDK_OFFSET(0xC0E5640)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_SHOWNEWTIPS_OFFSET UNITYSDK_OFFSET(0xC0E3490)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_UPDATEFOLLOWTIPSPOS_OFFSET UNITYSDK_OFFSET(0xC0E10A0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_UPDATEPLAYERINFO_OFFSET UNITYSDK_OFFSET(0xC0E79F0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC0E0D20)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_WAITMESSAGECENTERFREE_OFFSET UNITYSDK_OFFSET(0xC0E6D00)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0E8CB0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONFISHINGSTARTCOUNTDOWNHANDLE_B__68_0_OFFSET UNITYSDK_OFFSET(0xC0E9470)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONFISHINGSTARTSINGLEBATTLEHANDLE_B__49_0_OFFSET UNITYSDK_OFFSET(0xC0E8F70)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONFISHINGSTARTSINGLEBATTLEHANDLE_B__49_1_OFFSET UNITYSDK_OFFSET(0xC0E9040)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONFISHINGSTARTSINGLEBATTLEHANDLE_B__49_2_OFFSET UNITYSDK_OFFSET(0xC0E9110)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONFISHINGSTARTSINGLEBATTLEHANDLE_B__49_3_OFFSET UNITYSDK_OFFSET(0xC0E91E0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONMATCHCLOSE_B__65_0_OFFSET UNITYSDK_OFFSET(0xC0E92E0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONUIINIT_B__33_0_OFFSET UNITYSDK_OFFSET(0xC0E8E30)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONUIOPEN_B__32_0_OFFSET UNITYSDK_OFFSET(0xC0E8DB0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__SHOWFOLLOWTIPS_B__59_0_OFFSET UNITYSDK_OFFSET(0xC0E92B0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_CLOSEMAINCITYSTOREPAGE_OFFSET UNITYSDK_OFFSET(0xC0E94B0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0E94C0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xC0E9530)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC0E9590)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC0E95C0)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC0E9630)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0E9640)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0E9650)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0E9660)
#define MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xC0E9670)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishContestMainPageController_TypeDefinitionIndex = 67667;

	class UIFishContestMainPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_60638234271CCDB8_4* _view; // 0x308
		::MoleMole::UIFishContestMainPageController_EState _state; // 0x310
		::Class_2_3CC769D284A54927_1_Enum_3_059D0CF60338BF04 _mode; // 0x314
		...
		::System::Collections::Generic::List_1<::Class_1_451601B8BB62C38C_4*>* _viewPlayerInfos; // 0x360
		::System::Collections::Generic::List_1<::Class_1_451601B8BB62C38C_4*>* _addList; // 0x368
		::System::Collections::Generic::List_1<::Class_1_451601B8BB62C38C_4*>* _removeList; // 0x370
		...
		::System::Int32 Comparison(::Class_1_451601B8BB62C38C_4* x, ::Class_1_451601B8BB62C38C_4* y)
		{
			return ((::System::Int32(*)(::PVOID, ::Class_1_451601B8BB62C38C_4*, ::Class_1_451601B8BB62C38C_4*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER_COMPARISON_OFFSET))(this, x, y);
		}
		...
		::Class_0_16E4307DCC419505_134* _OnUIOpen_b__32_0()
		{
			return ((::Class_0_16E4307DCC419505_134*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFISHCONTESTMAINPAGECONTROLLER__ONUIOPEN_B__32_0_OFFSET))(this);
		}
