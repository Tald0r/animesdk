...
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB274130)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2741D0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB273FE0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB274080)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_REFRESHVIEW_1_OFFSET UNITYSDK_OFFSET(0xB2749A0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB2742B0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xB274510)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETLEFTRIGHTDESC_OFFSET UNITYSDK_OFFSET(0xB274720)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETNAME_OFFSET UNITYSDK_OFFSET(0xB274650)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETNEW_OFFSET UNITYSDK_OFFSET(0xB2745C0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETSIMPLEDESC_OFFSET UNITYSDK_OFFSET(0xB274840)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETUPARROW_OFFSET UNITYSDK_OFFSET(0xB274910)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB274B50)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB274B80)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB274BF0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB274C70)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB274CD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooDreamGoodsAttrItemWidgetController_TypeDefinitionIndex = 43408;

	class UIBangbooDreamGoodsAttrItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_6015D862D0AF8D6C* _view; // 0x2A0
