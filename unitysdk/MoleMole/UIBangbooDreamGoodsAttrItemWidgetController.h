...
class Class_2_6015D862D0AF8D6C_2;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }
namespace System { class String; }

#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF3D8F0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF3D990)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF3D7A0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF3D840)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_REFRESHVIEW_1_OFFSET UNITYSDK_OFFSET(0xBF3E160)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBF3DA70)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xBF3DCD0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETLEFTRIGHTDESC_OFFSET UNITYSDK_OFFSET(0xBF3DEE0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETNAME_OFFSET UNITYSDK_OFFSET(0xBF3DE10)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETNEW_OFFSET UNITYSDK_OFFSET(0xBF3DD80)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETSIMPLEDESC_OFFSET UNITYSDK_OFFSET(0xBF3E000)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER_SETUPARROW_OFFSET UNITYSDK_OFFSET(0xBF3E0D0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF3E310)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF3E340)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF3E3B0)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF3E430)
#define MOLEMOLE_UIBANGBOODREAMGOODSATTRITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF3E490)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooDreamGoodsAttrItemWidgetController_TypeDefinitionIndex = 63954;

	class UIBangbooDreamGoodsAttrItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_6015D862D0AF8D6C_2* _view; // 0x2A0
