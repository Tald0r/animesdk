...
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER_CHECKCARDISNEW_OFFSET UNITYSDK_OFFSET(0xBB581D0)
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBB58020)
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB585B0)
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBB585E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCardOptionItemWidgetController_TypeDefinitionIndex = 75099;
