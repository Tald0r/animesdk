...
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER_CHECKCARDISNEW_OFFSET UNITYSDK_OFFSET(0xA3A0C20)
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA3A0A70)
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3A1000)
#define MOLEMOLE_UIINLEVELCARDOPTIONITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA3A1030)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCardOptionItemWidgetController_TypeDefinitionIndex = 49937;
