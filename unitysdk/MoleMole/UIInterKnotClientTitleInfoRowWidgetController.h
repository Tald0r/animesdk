...
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_CLICKSELECT_OFFSET UNITYSDK_OFFSET(0x8958810)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8957810)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x89578B0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8957630)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETARROW_OFFSET UNITYSDK_OFFSET(0x89586D0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETBYID_OFFSET UNITYSDK_OFFSET(0x8957A00)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETCB_OFFSET UNITYSDK_OFFSET(0x8957990)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETEPISODE_OFFSET UNITYSDK_OFFSET(0x8958490)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETSHOWCONTENT_OFFSET UNITYSDK_OFFSET(0x8958400)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0x8957F50)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SHOWTARGET_OFFSET UNITYSDK_OFFSET(0x8958180)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x89589C0)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8958990)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8958A10)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8958A80)
#define MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8958B00)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotClientTitleInfoRowWidgetController_TypeDefinitionIndex = 52665;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotClientTitleInfoRowWidgetController_TypeDefinitionIndex)->GetStaticField(0x10C70);
		}
		static ::UnityEngine::Vector3* StaticGet_noSelectArrow()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotClientTitleInfoRowWidgetController_TypeDefinitionIndex)->GetStaticField(0x10C7C);
		}
		...
		::System::Void SetById(::Class_2_208CC9941471731A_787* spConfig, ::System::Int32 questId, ::System::Boolean select)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_787*, ::System::Int32, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINTERKNOTCLIENTTITLEINFOROWWIDGETCONTROLLER_SETBYID_OFFSET))(this, spConfig, questId, select);
		}
