...
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0xADAEF70)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___C__DISPLAYCLASS30_0__SHOWFRIENDINVITEPOPWINDOW_B__0_OFFSET UNITYSDK_OFFSET(0xADAEF80)
#define MOLEMOLE_UIARCADETEAMCHILDWINDOWCONTROLLER___C__DISPLAYCLASS30_0__SHOWFRIENDINVITEPOPWINDOW_B__1_OFFSET UNITYSDK_OFFSET(0xADAF110)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeTeamChildWindowController___c__DisplayClass30_0_TypeDefinitionIndex = 50884;
