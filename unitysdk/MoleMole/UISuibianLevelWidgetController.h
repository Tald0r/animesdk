...
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_BINDNOTIFICATION_OFFSET UNITYSDK_OFFSET(0xA460EB0)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_BINDTOBASELEVEL_OFFSET UNITYSDK_OFFSET(0xA460F40)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_BINDVIEWCALLBACK_OFFSET UNITYSDK_OFFSET(0xA461B70)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA460810)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA460D30)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA460DD0)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4608C0)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA460C80)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_REFRESHLEVEL_1_OFFSET UNITYSDK_OFFSET(0xA461980)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER_REFRESHLEVEL_OFFSET UNITYSDK_OFFSET(0xA461200)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA461C50)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA461D70)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA461DD0)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA461E40)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA461EC0)
#define MOLEMOLE_UISUIBIANLEVELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA461F20)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianLevelWidgetController_TypeDefinitionIndex = 42559;

	class UISuibianLevelWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_68* _view; // 0x2A0
