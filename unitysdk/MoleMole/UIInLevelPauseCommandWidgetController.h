...
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xAD6B030)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD6AEE0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAD6B490)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xAD6B540)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD6B5B0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD6AF80)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD6B3E0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_REFRESHAVATARINFOS_OFFSET UNITYSDK_OFFSET(0xAD6BCD0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_REFRESHSKILLLIST_OFFSET UNITYSDK_OFFSET(0xAD6BF50)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_SETAVATARINFOS_OFFSET UNITYSDK_OFFSET(0xAD6B690)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_SETSELECTEDAVATARID_OFFSET UNITYSDK_OFFSET(0xAD6C500)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_SWITCHSELECTEDAVATAR_OFFSET UNITYSDK_OFFSET(0xAD6BED0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xAD6C890)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD6C720)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER__INITVIEW_B__6_0_OFFSET UNITYSDK_OFFSET(0xAD6C8A0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD6C8B0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAD6C920)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xAD6C990)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD6C9A0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD6CA20)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD6CA80)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseCommandWidgetController_TypeDefinitionIndex = 54710;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseCommandWidgetController_TypeDefinitionIndex)->GetStaticField(0xEF90);
		}
		::Class_2_5F79F2747254EAE8_1* _view; // 0x2A0
		::System::Int32 _selectedIndex; // 0x2A8
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Battle::Entity*>* _avatarTabDict; // 0x2B0
		::System::Collections::Generic::List_1<::System::ValueTuple_2<::Class_2_208CC9941471731A_424*, ::Class_2_013DB5EBD89922B2*>>* _skillListTemplateList; // 0x2B8
		::System::Collections::Generic::List_1<::MoleMole::UITabBtnRoleRowWidgetController*>* _roleTabBtnList; // 0x2C0
