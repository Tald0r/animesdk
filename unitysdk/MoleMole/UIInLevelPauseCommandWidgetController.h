...
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x7A84A20)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7A848D0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7A84E80)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7A84F30)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7A84FA0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7A84970)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7A84DD0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_REFRESHAVATARINFOS_OFFSET UNITYSDK_OFFSET(0x7A856C0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_REFRESHSKILLLIST_OFFSET UNITYSDK_OFFSET(0x7A85940)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_SETAVATARINFOS_OFFSET UNITYSDK_OFFSET(0x7A85080)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_SETSELECTEDAVATARID_OFFSET UNITYSDK_OFFSET(0x7A85EF0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER_SWITCHSELECTEDAVATAR_OFFSET UNITYSDK_OFFSET(0x7A858C0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7A86280)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7A86110)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER__INITVIEW_B__6_0_OFFSET UNITYSDK_OFFSET(0x7A86290)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7A862A0)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7A86310)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7A86380)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7A86390)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7A86410)
#define MOLEMOLE_UIINLEVELPAUSECOMMANDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7A86470)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseCommandWidgetController_TypeDefinitionIndex = 45121;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseCommandWidgetController_TypeDefinitionIndex)->GetStaticField(0xE750);
		}
		...
		::System::Collections::Generic::List_1<::System::ValueTuple_2<::Class_2_208CC9941471731A_793*, ::Class_2_013DB5EBD89922B2*>>* _skillListTemplateList; // 0x2B8
