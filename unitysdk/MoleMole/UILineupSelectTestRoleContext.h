...
#define MOLEMOLE_UILINEUPSELECTTESTROLECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9440640)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectTestRoleContext_TypeDefinitionIndex = 37193;
