...
#define MOLEMOLE_MONOEXCLUSIVEPROPERTYBULLETSHELL_AWAKE_OFFSET UNITYSDK_OFFSET(0xC2EDF20)
#define MOLEMOLE_MONOEXCLUSIVEPROPERTYBULLETSHELL_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC2EE010)
#define MOLEMOLE_MONOEXCLUSIVEPROPERTYBULLETSHELL__CTOR_OFFSET UNITYSDK_OFFSET(0xC2EE160)

namespace MoleMole
{
	inline static constexpr unsigned int MonoExclusivePropertyBulletShell_TypeDefinitionIndex = 71255;
