...
#define MOLEMOLE_MONOEXCLUSIVEPROPERTYBULLETSHELL_AWAKE_OFFSET UNITYSDK_OFFSET(0xB8CA100)
#define MOLEMOLE_MONOEXCLUSIVEPROPERTYBULLETSHELL_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB8CA1F0)
#define MOLEMOLE_MONOEXCLUSIVEPROPERTYBULLETSHELL__CTOR_OFFSET UNITYSDK_OFFSET(0xB8CA340)

namespace MoleMole
{
	inline static constexpr unsigned int MonoExclusivePropertyBulletShell_TypeDefinitionIndex = 37995;
