...
#define MOLEMOLE_QUESTTIPPOPSHOW_GETVIDEOPATH_OFFSET UNITYSDK_OFFSET(0x9AC9620)
#define MOLEMOLE_QUESTTIPPOPSHOW_GET_ISBLOCKCENTER_OFFSET UNITYSDK_OFFSET(0x9AC93E0)
#define MOLEMOLE_QUESTTIPPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x9AC93D0)
#define MOLEMOLE_QUESTTIPPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x9AC9420)
#define MOLEMOLE_QUESTTIPPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x9AC93F0)

namespace MoleMole
{
	inline static constexpr unsigned int QuestTipPopShow_TypeDefinitionIndex = 61861;
