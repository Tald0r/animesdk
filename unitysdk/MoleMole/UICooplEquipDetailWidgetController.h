...
#define MOLEMOLE_UICOOPLEQUIPDETAILWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB28FCC0)
#define MOLEMOLE_UICOOPLEQUIPDETAILWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB28FD30)
#define MOLEMOLE_UICOOPLEQUIPDETAILWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB28FDF0)
#define MOLEMOLE_UICOOPLEQUIPDETAILWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB28FF30)
#define MOLEMOLE_UICOOPLEQUIPDETAILWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB28FF60)
#define MOLEMOLE_UICOOPLEQUIPDETAILWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB28FFD0)

namespace MoleMole
{
	inline static constexpr unsigned int UICooplEquipDetailWidgetController_TypeDefinitionIndex = 75148;
