...
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_FETCHCFGS_OFFSET UNITYSDK_OFFSET(0xD01AC70)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_GET_CURFOCUSED_OFFSET UNITYSDK_OFFSET(0xD01C5A0)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_INITSORT_OFFSET UNITYSDK_OFFSET(0xD01BA90)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_MATCHFUNCCOLLECTED_OFFSET UNITYSDK_OFFSET(0xD01BD50)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD01C080)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_ONSCROLLVIEWSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0xD01C400)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD01CEF0)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_ONSORTORFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0xD01BF50)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD01CE10)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD01A730)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD01B9C0)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_OPENINFO_OFFSET UNITYSDK_OFFSET(0xD01D190)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_REFRESHPROGRESSTITLETEXT_OFFSET UNITYSDK_OFFSET(0xD01C120)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_REFRESHSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xD01BFC0)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_REFRESHSELECTVIEW_OFFSET UNITYSDK_OFFSET(0xD01B070)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_REFRESHVIEWONFOCUSCHANGE_OFFSET UNITYSDK_OFFSET(0xD01B000)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_SETLEVELDESCTEXT_OFFSET UNITYSDK_OFFSET(0xD01C6E0)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_SETSIMPLEDESC_OFFSET UNITYSDK_OFFSET(0xD01CA70)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_TRYCANCELSELECTONLAYOUTCHANGETOCONSOLE_OFFSET UNITYSDK_OFFSET(0xD01D0B0)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER_TRYSELECTFIRSTITEMEXCEPTCONSOLELAYOUT_OFFSET UNITYSDK_OFFSET(0xD01CFD0)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD01D280)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD01D320)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD01D390)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD01D400)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD01D480)
#define MOLEMOLE_UIBACKENDRELICCOLLECTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD01D4E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBackendRelicCollectWidgetController_TypeDefinitionIndex = 52111;

	class UIBackendRelicCollectWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_116* _view; // 0x2A0
