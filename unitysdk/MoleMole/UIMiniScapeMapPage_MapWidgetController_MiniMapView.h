...
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MINIMAPVIEW_GET_ANIMATION_OFFSET UNITYSDK_OFFSET(0xA21C000)
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MINIMAPVIEW_GET_CONTENTLAYOUTELEMENT_OFFSET UNITYSDK_OFFSET(0xA21C1A0)
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MINIMAPVIEW_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0xA21BF30)
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MINIMAPVIEW_GET_SCROLLRECT_OFFSET UNITYSDK_OFFSET(0xA21C270)
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MINIMAPVIEW_GET_SLIDER_OFFSET UNITYSDK_OFFSET(0xA21C0D0)
#define MOLEMOLE_UIMINISCAPEMAPPAGE_MAPWIDGETCONTROLLER_MINIMAPVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA21C340)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniScapeMapPage_MapWidgetController_MiniMapView_TypeDefinitionIndex = 77251;
