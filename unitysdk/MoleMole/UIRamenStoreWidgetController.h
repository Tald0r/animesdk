...
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_BACKTOMAIN_OFFSET UNITYSDK_OFFSET(0xAE3AEA0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_CLICKPAY_OFFSET UNITYSDK_OFFSET(0xAE3BD60)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_DOEAT_OFFSET UNITYSDK_OFFSET(0xAE3C2A0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAE39DD0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xAE39FC0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE3A3A0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONEATRAMEN_OFFSET UNITYSDK_OFFSET(0xAE3C410)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAE3A840)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0xAE3A940)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONRAMENDATACHANGED_OFFSET UNITYSDK_OFFSET(0xAE3AE30)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONSHOWGETRAMENFINISHED_OFFSET UNITYSDK_OFFSET(0xAE3B830)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONTIMELINEPERFORMSTART_OFFSET UNITYSDK_OFFSET(0xAE3B430)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE39DE0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE3A440)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_POPGOTRAMEN_OFFSET UNITYSDK_OFFSET(0xAE3B000)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_REFRESHSELECTVIEW_OFFSET UNITYSDK_OFFSET(0xAE3AA30)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAE3A700)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_SELECTRAMEN_OFFSET UNITYSDK_OFFSET(0xAE3BCB0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_SHOWGETRAMENTIP_OFFSET UNITYSDK_OFFSET(0xAE3B9E0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_STARTSHOWGETRAMENCUTSCENE_OFFSET UNITYSDK_OFFSET(0xAE3B1C0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xAE3C510)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE3C4D0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER__POPGOTRAMEN_B__12_0_OFFSET UNITYSDK_OFFSET(0xAE3C550)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER__POPGOTRAMEN_B__12_1_OFFSET UNITYSDK_OFFSET(0xAE3C5C0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER__SHOWGETRAMENTIP_B__16_0_OFFSET UNITYSDK_OFFSET(0xAE3C810)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAE3C8A0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAE3C910)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAE3C940)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAE3C950)

namespace MoleMole
{
	inline static constexpr unsigned int UIRamenStoreWidgetController_TypeDefinitionIndex = 73220;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIRamenStoreWidgetController_TypeDefinitionIndex)->GetStaticField(0x110F0);
		}
		...
		::Class_2_208CC9941471731A_33* _ramenTemplate; // 0x328
