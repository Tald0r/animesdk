...
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_BACKTOMAIN_OFFSET UNITYSDK_OFFSET(0x99016C0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_CLICKPAY_OFFSET UNITYSDK_OFFSET(0x75077C0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_DOEAT_OFFSET UNITYSDK_OFFSET(0x7507D10)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x99009F0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x9900BE0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9900FC0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONEATRAMEN_OFFSET UNITYSDK_OFFSET(0x7507E80)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9901460)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x9901560)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONRAMENDATACHANGED_OFFSET UNITYSDK_OFFSET(0x9901650)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONSHOWGETRAMENFINISHED_OFFSET UNITYSDK_OFFSET(0x9902050)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONTIMELINEPERFORMSTART_OFFSET UNITYSDK_OFFSET(0x9901C50)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9900A00)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9901060)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_POPGOTRAMEN_OFFSET UNITYSDK_OFFSET(0x9901820)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_REFRESHSELECTVIEW_OFFSET UNITYSDK_OFFSET(0x7507310)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x9901320)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_SELECTRAMEN_OFFSET UNITYSDK_OFFSET(0x7507710)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_SHOWGETRAMENTIP_OFFSET UNITYSDK_OFFSET(0x9902200)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER_STARTSHOWGETRAMENCUTSCENE_OFFSET UNITYSDK_OFFSET(0x99019E0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7507F80)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7507F40)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER__POPGOTRAMEN_B__12_0_OFFSET UNITYSDK_OFFSET(0x7507FC0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER__POPGOTRAMEN_B__12_1_OFFSET UNITYSDK_OFFSET(0x7508030)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER__SHOWGETRAMENTIP_B__16_0_OFFSET UNITYSDK_OFFSET(0x7508280)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7508310)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x7508380)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x75083B0)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x75083C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRamenStoreWidgetController_TypeDefinitionIndex = 37021;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIRamenStoreWidgetController_TypeDefinitionIndex)->GetStaticField(0x11420);
		}
		::System::Boolean _isInRamenPerform; // 0x2F8
		::Class_2_74BE238239689640* _view; // 0x300
		::Class_2_C1865A61828EE67A* _ramenModel; // 0x308
		::System::Collections::Generic::List_1<::System::Int32>* _ramenIDs; // 0x310
		::Class_2_9D9172C07F82DDAE* _itemModel; // 0x318
		::System::Int32 _selectedRamenId; // 0x320
		::Class_2_208CC9941471731A_227* _ramenTemplate; // 0x328
		::MoleMole::UIRamenCurrentBuffChildWindowController* _childCtrl; // 0x330
		::MoleMole::UIRamenStoreWidgetController_Context* _context; // 0x338
