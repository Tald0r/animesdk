...
#define MOLEMOLE_UIMAINSTORYPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9E7C650)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageContext_TypeDefinitionIndex = 42619;
	...
	public:
		...
		::System::Int32 EndOvaContextID; // 0x30
		::System::Int32 ArchiveFileID; // 0x34
		::System::Boolean IsAfkOva; // 0x38
		::System::Int32 FromEndPerform; // 0x3C
		::System::Int32 BattleMission; // 0x40
