...
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__GETWORLDPOINTSINMAINCITY_ASYNC_D__29_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x34D040)
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__GETWORLDPOINTSINMAINCITY_ASYNC_D__29_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapTrackLineWidgetContext__GetWorldPointsInMainCity_Async_d__29_TypeDefinitionIndex = 62890;
