...
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__GETWORLDPOINTSINMAINCITY_ASYNC_D__29_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3A0170)
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__GETWORLDPOINTSINMAINCITY_ASYNC_D__29_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapTrackLineWidgetContext__GetWorldPointsInMainCity_Async_d__29_TypeDefinitionIndex = 45731;
	...
	struct alignas(8) UIUrbanMapTrackLineWidgetContext__GetWorldPointsInMainCity_Async_d__29
	{
		...
		::UnityEngine::Vector3 playerPosVal; // 0x48
		::UnityEngine::Vector3 _targetNavPos_5__2; // 0x54
