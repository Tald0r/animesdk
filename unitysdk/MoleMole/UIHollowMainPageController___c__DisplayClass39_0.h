...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS39_0__CHECKCHESSBOARDPREPARE_B__2_OFFSET UNITYSDK_OFFSET(0x80B1C90)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS39_0__CHECKCHESSBOARDPREPARE_G____AFTERBATTLEWAITFORMAINPAGEFADEIN_1_OFFSET UNITYSDK_OFFSET(0x80B1A30)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS39_0__CHECKCHESSBOARDPREPARE_G____CHECKNORMALCHESSBOARD_0_OFFSET UNITYSDK_OFFSET(0x80B17A0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0x80B1790)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController___c__DisplayClass39_0_TypeDefinitionIndex = 52610;
