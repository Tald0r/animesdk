...
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_CLICKACTION_OFFSET UNITYSDK_OFFSET(0x8EC8370)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_HANDLESELECT_OFFSET UNITYSDK_OFFSET(0x8EC8310)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x8EC82F0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_ISMASK_OFFSET UNITYSDK_OFFSET(0x8EC8330)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_SHOWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x8EC8350)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SETBTNCLICKACTION_OFFSET UNITYSDK_OFFSET(0x8EC8490)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SETHANDLESELECT_OFFSET UNITYSDK_OFFSET(0x8EC83A0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SETMASK_OFFSET UNITYSDK_OFFSET(0x8EC8420)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_CLICKACTION_OFFSET UNITYSDK_OFFSET(0x8EC8380)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_HANDLESELECT_OFFSET UNITYSDK_OFFSET(0x8EC8320)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x8EC8300)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_ISMASK_OFFSET UNITYSDK_OFFSET(0x8EC8340)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_SHOWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x8EC8360)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8EC8390)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySwitchRoleCardWidgetController_Context_TypeDefinitionIndex = 56179;
	...
	public:
		...
		::System::Boolean _HandleSelect_k__BackingField; // 0x34
		::System::Boolean IsBtnInteractable; // 0x35
		::System::Boolean _IsEmpty_k__BackingField; // 0x36
		::System::Boolean _ShowNotification_k__BackingField; // 0x37
		::System::Boolean _IsMask_k__BackingField; // 0x38
