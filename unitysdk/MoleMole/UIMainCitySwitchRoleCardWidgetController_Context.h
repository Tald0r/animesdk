...
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_CLICKACTION_OFFSET UNITYSDK_OFFSET(0x7D4C1A0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_HANDLESELECT_OFFSET UNITYSDK_OFFSET(0x7D4C140)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x7D4C120)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_ISMASK_OFFSET UNITYSDK_OFFSET(0x7D4C160)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_GET_SHOWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x7D4C180)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SETBTNCLICKACTION_OFFSET UNITYSDK_OFFSET(0x7D4C2C0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SETHANDLESELECT_OFFSET UNITYSDK_OFFSET(0x7D4C1D0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SETMASK_OFFSET UNITYSDK_OFFSET(0x7D4C250)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_CLICKACTION_OFFSET UNITYSDK_OFFSET(0x7D4C1B0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_HANDLESELECT_OFFSET UNITYSDK_OFFSET(0x7D4C150)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x7D4C130)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_ISMASK_OFFSET UNITYSDK_OFFSET(0x7D4C170)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT_SET_SHOWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x7D4C190)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7D4C1C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySwitchRoleCardWidgetController_Context_TypeDefinitionIndex = 78889;
	...
	public:
		...
		::System::Boolean _ShowNotification_k__BackingField; // 0x31
		::System::Boolean _IsMask_k__BackingField; // 0x32
		::System::Boolean _HandleSelect_k__BackingField; // 0x33
