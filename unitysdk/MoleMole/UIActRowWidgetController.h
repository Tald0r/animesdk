...
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8CBC280)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8CBC400)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8CBC320)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8CBC060)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER_SHOWROW_OFFSET UNITYSDK_OFFSET(0x8CBC580)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8CBC8C0)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8CBC8D0)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8CBC940)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8CBC9C0)
#define MOLEMOLE_UIACTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8CBCA40)

namespace MoleMole
{
	inline static constexpr unsigned int UIActRowWidgetController_TypeDefinitionIndex = 68654;

	class UIActRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_FB90F8F234309AE5_2* _view; // 0x2D0
		::Class_1_730A101C592B37EC* _selfieMotion; // 0x2D8
