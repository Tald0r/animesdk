...
#define MOLEMOLE_UIINLEVELRANKINGSABINFOROWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x99F9E60)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelRankingSABInfoRowConfig_TypeDefinitionIndex = 66297;
