...
#define MOLEMOLE_UISUIBIANTEMPLEDEPLOYBANGBOOPOPWINDOWCONTROLLER__DORECYCLETEMPLEBUDDIES_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x396FF0)
#define MOLEMOLE_UISUIBIANTEMPLEDEPLOYBANGBOOPOPWINDOWCONTROLLER__DORECYCLETEMPLEBUDDIES_D__28_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleDeployBangbooPopWindowController__DoRecycleTempleBuddies_d__28_TypeDefinitionIndex = 42300;
