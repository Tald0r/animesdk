...
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x992B720)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x992B8A0)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x992B7C0)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x992B680)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x992BAD0)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x992BAE0)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x992BB50)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x992BBD0)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x992BC50)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaAbyssBangbooRowV2WidgetController_TypeDefinitionIndex = 40713;

	class UIYorozuyaAbyssBangbooRowV2WidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_72679ED639CF4AB4_1* _view; // 0x2D0
