...
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7550900)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x7550A80)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x75509A0)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7550860)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7550CB0)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7550CC0)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x7550D30)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7550DB0)
#define MOLEMOLE_UIYOROZUYAABYSSBANGBOOROWV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7550E30)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaAbyssBangbooRowV2WidgetController_TypeDefinitionIndex = 43068;

	class UIYorozuyaAbyssBangbooRowV2WidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_72679ED639CF4AB4* _view; // 0x2D0
