...
#define MOLEMOLE_UIACTIVITYSELECTAVATARWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE924CF0)
#define MOLEMOLE_UIACTIVITYSELECTAVATARWIDGETCONTROLLER_ONSELECTAVATAR_OFFSET UNITYSDK_OFFSET(0xE924F80)
#define MOLEMOLE_UIACTIVITYSELECTAVATARWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE924D90)
#define MOLEMOLE_UIACTIVITYSELECTAVATARWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE924A60)
#define MOLEMOLE_UIACTIVITYSELECTAVATARWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE924C40)
#define MOLEMOLE_UIACTIVITYSELECTAVATARWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xE924E70)
#define MOLEMOLE_UIACTIVITYSELECTAVATARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE925030)
#define MOLEMOLE_UIACTIVITYSELECTAVATARWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE925060)
#define MOLEMOLE_UIACTIVITYSELECTAVATARWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE9250D0)
#define MOLEMOLE_UIACTIVITYSELECTAVATARWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE925150)
#define MOLEMOLE_UIACTIVITYSELECTAVATARWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE9251B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySelectAvatarWidgetController_TypeDefinitionIndex = 71534;
