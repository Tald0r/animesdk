...
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ADDTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xBB3FEC0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_CREATEMISSIONGUIDEPOINT_OFFSET UNITYSDK_OFFSET(0xBB3F780)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0xBB40310)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_HIDEMISSIONGUIDEPOINT_OFFSET UNITYSDK_OFFSET(0xBB40560)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB3FBA0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB3FC40)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB3F630)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBB3FAF0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_REMOVETARGETENTITY_OFFSET UNITYSDK_OFFSET(0xBB40130)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_SHOWMISSIONGUIDEPOINT_OFFSET UNITYSDK_OFFSET(0xBB40480)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xBB3FD20)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB405E0)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB40710)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB40780)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB40800)
#define MOLEMOLE_UIHOLLOWMISSIONGUIDEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBB40860)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMissionGuideWidgetController_TypeDefinitionIndex = 68260;
	...
	public:
		...
		::Class_2_60638234271CCDB8_115* _view; // 0x2A0
