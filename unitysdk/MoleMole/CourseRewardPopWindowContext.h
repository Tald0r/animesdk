...
#define MOLEMOLE_COURSEREWARDPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB487FB0)

namespace MoleMole
{
	inline static constexpr unsigned int CourseRewardPopWindowContext_TypeDefinitionIndex = 44047;
