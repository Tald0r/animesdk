...
#define MOLEMOLE_COURSEREWARDPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xE8336A0)

namespace MoleMole
{
	inline static constexpr unsigned int CourseRewardPopWindowContext_TypeDefinitionIndex = 63539;
