...
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD0F3B60)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD0F3BD0)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD0F3CD0)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER_SETLAYER_OFFSET UNITYSDK_OFFSET(0xD0F3E10)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0F40D0)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0xD0F4100)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER__ONUIINIT_B__3_1_OFFSET UNITYSDK_OFFSET(0xD0F4170)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD0F41E0)
#define MOLEMOLE_UIBOSSCHALLENGECURRENTTEAMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD0F4250)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeCurrentTeamRowWidgetController_TypeDefinitionIndex = 75875;
