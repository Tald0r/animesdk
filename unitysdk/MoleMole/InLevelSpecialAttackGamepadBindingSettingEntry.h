...
#define MOLEMOLE_INLEVELSPECIALATTACKGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x8F865D0)
#define MOLEMOLE_INLEVELSPECIALATTACKGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x8F865E0)
#define MOLEMOLE_INLEVELSPECIALATTACKGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x8F865F0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelSpecialAttackGamepadBindingSettingEntry_TypeDefinitionIndex = 73774;
