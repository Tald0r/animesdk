...
namespace MoleMole { class MonoGridScroller_Class_3_C93A0D0F0F1EBE47; }
...
#define MOLEMOLE_MONOGRIDSCROLLER_ADDCHILDREN_OFFSET UNITYSDK_OFFSET(0xA3ABAA0)
#define MOLEMOLE_MONOGRIDSCROLLER_CENTERITEMBYINDEXMULTI_OFFSET UNITYSDK_OFFSET(0xA3AED30)
#define MOLEMOLE_MONOGRIDSCROLLER_CENTERITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0xA3AE7F0)
#define MOLEMOLE_MONOGRIDSCROLLER_GETGRIDREALCHILDCOUNT_OFFSET UNITYSDK_OFFSET(0xA3B21F0)
#define MOLEMOLE_MONOGRIDSCROLLER_GETITEMDICT_OFFSET UNITYSDK_OFFSET(0xA3B1C00)
#define MOLEMOLE_MONOGRIDSCROLLER_GETITEMTRANSBYINDEX_OFFSET UNITYSDK_OFFSET(0xA3AFB70)
#define MOLEMOLE_MONOGRIDSCROLLER_GETMAXITEMCOUNTWITHOUSCROLL_OFFSET UNITYSDK_OFFSET(0xA3AFC70)
#define MOLEMOLE_MONOGRIDSCROLLER_GETNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0xA3ADF60)
#define MOLEMOLE_MONOGRIDSCROLLER_GETPERFECTSHOWITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xA3AFCE0)
#define MOLEMOLE_MONOGRIDSCROLLER_GETSHOWITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xA3AFD50)
#define MOLEMOLE_MONOGRIDSCROLLER_GET_GRIDLAYOUT_OFFSET UNITYSDK_OFFSET(0xA3B2CE0)
#define MOLEMOLE_MONOGRIDSCROLLER_GET_ITEMSIZE_OFFSET UNITYSDK_OFFSET(0xA3AB730)
#define MOLEMOLE_MONOGRIDSCROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xA3AB760)
#define MOLEMOLE_MONOGRIDSCROLLER_ISCHILDPARTIALLYINVISIBLE_OFFSET UNITYSDK_OFFSET(0xA3B1C60)
#define MOLEMOLE_MONOGRIDSCROLLER_LEFTMOVEITEM_OFFSET UNITYSDK_OFFSET(0xA3B0170)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_235563648AB4317F_OFFSET UNITYSDK_OFFSET(0xA3B2E70)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4358F70A163BCEAE_OFFSET UNITYSDK_OFFSET(0xA3AD2E0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_44248043C21D77EE_OFFSET UNITYSDK_OFFSET(0xA3AF9A0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_458DAEAB6170C584_OFFSET UNITYSDK_OFFSET(0xA3AC2F0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4A0A4692E3EEF246_OFFSET UNITYSDK_OFFSET(0xA3B3010)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4C077BF80FCF2C90_OFFSET UNITYSDK_OFFSET(0xA3ABDA0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0xA3AC750)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4EC65E6D54E9EC81_OFFSET UNITYSDK_OFFSET(0xA3AB9E0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_5587AE4B03E68C58_OFFSET UNITYSDK_OFFSET(0xA3B07C0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_5C466ABEE228060F_OFFSET UNITYSDK_OFFSET(0xA3B0950)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_67329C1ADD73615D_OFFSET UNITYSDK_OFFSET(0xA3B2F00)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_7619D212F4D762A1_OFFSET UNITYSDK_OFFSET(0xA3AE170)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xA3AC4B0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_8CB9BDF340E2FC64_OFFSET UNITYSDK_OFFSET(0xA3AC960)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xA3AF3D0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_AE231BEA38F773A1_OFFSET UNITYSDK_OFFSET(0xA3AF450)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_C0BFE60FE32BE2BE_OFFSET UNITYSDK_OFFSET(0xA3AD7D0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_C467FE94E295849F_OFFSET UNITYSDK_OFFSET(0xA3AEE80)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_CE8FB5AA8B18AC41_OFFSET UNITYSDK_OFFSET(0xA3ADAA0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_D8DF982F4E85DEF4_OFFSET UNITYSDK_OFFSET(0xA3B3130)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_DA6C1E0DEF87D3F0_OFFSET UNITYSDK_OFFSET(0xA3B35F0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0xA3B05A0)
#define MOLEMOLE_MONOGRIDSCROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xA3B1980)
#define MOLEMOLE_MONOGRIDSCROLLER_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xA3AEAB0)
#define MOLEMOLE_MONOGRIDSCROLLER_REFRESHCURRENTBYINDEX_OFFSET UNITYSDK_OFFSET(0xA3ADE10)
#define MOLEMOLE_MONOGRIDSCROLLER_REFRESHCURRENT_OFFSET UNITYSDK_OFFSET(0xA3AC0A0)
#define MOLEMOLE_MONOGRIDSCROLLER_REFRESHINDEXSET_OFFSET UNITYSDK_OFFSET(0xA3AF770)
#define MOLEMOLE_MONOGRIDSCROLLER_REMOVECHILDREN_OFFSET UNITYSDK_OFFSET(0xA3ABBE0)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOBEGIN_OFFSET UNITYSDK_OFFSET(0xA3AE560)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOEND_OFFSET UNITYSDK_OFFSET(0xA3AE6B0)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTONEXTITEM_OFFSET UNITYSDK_OFFSET(0xA3AE4D0)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTONEXTPAGEWITHANIMATION_OFFSET UNITYSDK_OFFSET(0xA3AEDF0)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTONEXTPAGE_OFFSET UNITYSDK_OFFSET(0xA3AE3B0)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOPREITEM_OFFSET UNITYSDK_OFFSET(0xA3AE440)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOPREVPAGEWITHANIMATION_OFFSET UNITYSDK_OFFSET(0xA3AF190)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOPREVPAGE_OFFSET UNITYSDK_OFFSET(0xA3AE0E0)
#define MOLEMOLE_MONOGRIDSCROLLER_SETNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0xA3AE000)
#define MOLEMOLE_MONOGRIDSCROLLER_TURNSCROLLON_OFFSET UNITYSDK_OFFSET(0xA3B04F0)
#define MOLEMOLE_MONOGRIDSCROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA3AF220)
#define MOLEMOLE_MONOGRIDSCROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3B2CF0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGridScroller_TypeDefinitionIndex = 47104;
	...
	public:
		...
		::MoleMole::MonoGridScroller_Class_3_C93A0D0F0F1EBE47* Field_5_15; // 0x70
		::MoleMole::MonoGridScroller_Class_3_C93A0D0F0F1EBE47* Field_5_16; // 0x78
		...
		::System::Void Init(::MoleMole::MonoGridScroller_Class_3_C93A0D0F0F1EBE47* a1, ::System::Int32 a2, ::System::Nullable_1<::UnityEngine::Vector2> a3, ::System::Boolean a4, ::System::Boolean a5, ::System::Boolean a6, ::System::Int32 a7)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::MonoGridScroller_Class_3_C93A0D0F0F1EBE47*, ::System::Int32, ::System::Nullable_1<::UnityEngine::Vector2>, ::System::Boolean, ::System::Boolean, ::System::Boolean, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_INIT_OFFSET))(this, a1, a2, a3, a4, a5, a6, a7);
		}
		...
		::System::Void Method_5_4EC65E6D54E9EC81(::MoleMole::MonoGridScroller_Class_3_C93A0D0F0F1EBE47* a1)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::MonoGridScroller_Class_3_C93A0D0F0F1EBE47*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4EC65E6D54E9EC81_OFFSET))(this, a1);
		}
		...
		::System::Boolean Method_5_C0BFE60FE32BE2BE(::System::Int32 a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_C0BFE60FE32BE2BE_OFFSET))(this, a1);
		}

		::System::Void Method_5_4358F70A163BCEAE()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4358F70A163BCEAE_OFFSET))(this);
		}

		::System::Void Method_5_F5447CD65612575D()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_F5447CD65612575D_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_5587AE4B03E68C58_OFFSET))(this);
		}

		::System::Void Method_5_4C077BF80FCF2C90(::System::Nullable_1<::UnityEngine::Vector2> a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Nullable_1<::UnityEngine::Vector2>))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4C077BF80FCF2C90_OFFSET))(this, a1);
		}

		::MoleMole::MonoGridScroller_Class_3_C93A0D0F0F1EBE47* Method_5_DA6C1E0DEF87D3F0()
		{
			return ((::MoleMole::MonoGridScroller_Class_3_C93A0D0F0F1EBE47*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_DA6C1E0DEF87D3F0_OFFSET))(this);
		}

		::System::Void Method_5_8CB9BDF340E2FC64()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_8CB9BDF340E2FC64_OFFSET))(this);
		}

		::System::Void Method_5_44248043C21D77EE(::System::Int32 a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_44248043C21D77EE_OFFSET))(this, a1);
		}
		...
		::UnityEngine::RectTransform* Method_5_CE8FB5AA8B18AC41(::System::Int32 a1)
		{
			return ((::UnityEngine::RectTransform*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_CE8FB5AA8B18AC41_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4EA6B1791DACA9CC_OFFSET))(this);
		}
	};
}
