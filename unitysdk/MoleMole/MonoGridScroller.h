...
#define MOLEMOLE_MONOGRIDSCROLLER_ADDCHILDREN_OFFSET UNITYSDK_OFFSET(0x82F16C0)
#define MOLEMOLE_MONOGRIDSCROLLER_CENTERITEMBYINDEXMULTI_OFFSET UNITYSDK_OFFSET(0x82F4950)
#define MOLEMOLE_MONOGRIDSCROLLER_CENTERITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0x82F4410)
#define MOLEMOLE_MONOGRIDSCROLLER_GETGRIDREALCHILDCOUNT_OFFSET UNITYSDK_OFFSET(0x82F7E00)
#define MOLEMOLE_MONOGRIDSCROLLER_GETITEMDICT_OFFSET UNITYSDK_OFFSET(0x82F7810)
#define MOLEMOLE_MONOGRIDSCROLLER_GETITEMTRANSBYINDEX_OFFSET UNITYSDK_OFFSET(0x82F5790)
#define MOLEMOLE_MONOGRIDSCROLLER_GETMAXITEMCOUNTWITHOUSCROLL_OFFSET UNITYSDK_OFFSET(0x82F5890)
#define MOLEMOLE_MONOGRIDSCROLLER_GETNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x82F3B80)
#define MOLEMOLE_MONOGRIDSCROLLER_GETPERFECTSHOWITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x82F5900)
#define MOLEMOLE_MONOGRIDSCROLLER_GETSHOWITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x82F5970)
#define MOLEMOLE_MONOGRIDSCROLLER_GET_GRIDLAYOUT_OFFSET UNITYSDK_OFFSET(0x82F88F0)
#define MOLEMOLE_MONOGRIDSCROLLER_GET_ITEMSIZE_OFFSET UNITYSDK_OFFSET(0x82F1350)
#define MOLEMOLE_MONOGRIDSCROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x82F1380)
#define MOLEMOLE_MONOGRIDSCROLLER_ISCHILDPARTIALLYINVISIBLE_OFFSET UNITYSDK_OFFSET(0x82F7870)
#define MOLEMOLE_MONOGRIDSCROLLER_LEFTMOVEITEM_OFFSET UNITYSDK_OFFSET(0x82F5D90)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_235563648AB4317F_OFFSET UNITYSDK_OFFSET(0x82F9180)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4358F70A163BCEAE_OFFSET UNITYSDK_OFFSET(0x82F2F00)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_44248043C21D77EE_OFFSET UNITYSDK_OFFSET(0x82F55C0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_458DAEAB6170C584_OFFSET UNITYSDK_OFFSET(0x82F1F10)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4A0A4692E3EEF246_OFFSET UNITYSDK_OFFSET(0x82F8BA0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4C077BF80FCF2C90_OFFSET UNITYSDK_OFFSET(0x82F19C0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x82F2370)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_4EC65E6D54E9EC81_OFFSET UNITYSDK_OFFSET(0x82F1600)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_5587AE4B03E68C58_OFFSET UNITYSDK_OFFSET(0x82F63E0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_5C466ABEE228060F_OFFSET UNITYSDK_OFFSET(0x82F6570)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_67329C1ADD73615D_OFFSET UNITYSDK_OFFSET(0x82F8A90)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_7619D212F4D762A1_OFFSET UNITYSDK_OFFSET(0x82F3D90)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x82F20D0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_8CB9BDF340E2FC64_OFFSET UNITYSDK_OFFSET(0x82F2580)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x82F4FF0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_AE231BEA38F773A1_OFFSET UNITYSDK_OFFSET(0x82F5070)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_C0BFE60FE32BE2BE_OFFSET UNITYSDK_OFFSET(0x82F33F0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_C467FE94E295849F_OFFSET UNITYSDK_OFFSET(0x82F4AA0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_CE8FB5AA8B18AC41_OFFSET UNITYSDK_OFFSET(0x82F36C0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_D8DF982F4E85DEF4_OFFSET UNITYSDK_OFFSET(0x82F8CC0)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_DA6C1E0DEF87D3F0_OFFSET UNITYSDK_OFFSET(0x82F8A80)
#define MOLEMOLE_MONOGRIDSCROLLER_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x82F61C0)
#define MOLEMOLE_MONOGRIDSCROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x82F7590)
#define MOLEMOLE_MONOGRIDSCROLLER_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x82F46D0)
#define MOLEMOLE_MONOGRIDSCROLLER_REFRESHCURRENTBYINDEX_OFFSET UNITYSDK_OFFSET(0x82F3A30)
#define MOLEMOLE_MONOGRIDSCROLLER_REFRESHCURRENT_OFFSET UNITYSDK_OFFSET(0x82F1CC0)
#define MOLEMOLE_MONOGRIDSCROLLER_REFRESHINDEXSET_OFFSET UNITYSDK_OFFSET(0x82F5390)
#define MOLEMOLE_MONOGRIDSCROLLER_REMOVECHILDREN_OFFSET UNITYSDK_OFFSET(0x82F1800)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOBEGIN_OFFSET UNITYSDK_OFFSET(0x82F4180)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOEND_OFFSET UNITYSDK_OFFSET(0x82F42D0)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTONEXTITEM_OFFSET UNITYSDK_OFFSET(0x82F40F0)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTONEXTPAGEWITHANIMATION_OFFSET UNITYSDK_OFFSET(0x82F4A10)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTONEXTPAGE_OFFSET UNITYSDK_OFFSET(0x82F3FD0)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOPREITEM_OFFSET UNITYSDK_OFFSET(0x82F4060)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOPREVPAGEWITHANIMATION_OFFSET UNITYSDK_OFFSET(0x82F4DB0)
#define MOLEMOLE_MONOGRIDSCROLLER_SCROLLTOPREVPAGE_OFFSET UNITYSDK_OFFSET(0x82F3D00)
#define MOLEMOLE_MONOGRIDSCROLLER_SETNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x82F3C20)
#define MOLEMOLE_MONOGRIDSCROLLER_TURNSCROLLON_OFFSET UNITYSDK_OFFSET(0x82F6110)
#define MOLEMOLE_MONOGRIDSCROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x82F4E40)
#define MOLEMOLE_MONOGRIDSCROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x82F8900)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGridScroller_TypeDefinitionIndex = 55014;
