...
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITMISSION_D__71_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x97FDF40)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITMISSION_D__71_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x97FFA10)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITMISSION_D__71_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x97FFA70)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITMISSION_D__71_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x97FFA20)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITMISSION_D__71_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x97FDF30)
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER__INITMISSION_D__71__CTOR_OFFSET UNITYSDK_OFFSET(0x97FDF20)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultPageController__InitMission_d__71_TypeDefinitionIndex = 61264;
