...
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBF40430)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBF404A0)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER_ONSELECTROLEEVENT_OFFSET UNITYSDK_OFFSET(0xBF40790)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER_ONSETDATA_OFFSET UNITYSDK_OFFSET(0xBF405A0)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF40690)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF40860)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBF40890)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER___BASE_ONSETDATA_OFFSET UNITYSDK_OFFSET(0xBF40900)
#define MOLEMOLE_UIBOSSCHALLENGEQUICKTEAMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF40970)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeQuickTeamRowWidgetController_TypeDefinitionIndex = 49343;
