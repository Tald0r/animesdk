...
#define MOLEMOLE_UIRECYCLEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS57_0__CTOR_OFFSET UNITYSDK_OFFSET(0xADF4650)
#define MOLEMOLE_UIRECYCLEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS57_0__ONSORTERMARKDELETECLICK_B__0_OFFSET UNITYSDK_OFFSET(0xADF4660)
#define MOLEMOLE_UIRECYCLEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS57_0__ONSORTERMARKDELETECLICK_B__1_OFFSET UNITYSDK_OFFSET(0xADF46D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRecycleDialogPopWindowController___c__DisplayClass57_0_TypeDefinitionIndex = 42841;
