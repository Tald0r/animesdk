...
#define MOLEMOLE_UIRECYCLEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS57_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB52ADD0)
#define MOLEMOLE_UIRECYCLEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS57_0__ONSORTERMARKDELETECLICK_B__0_OFFSET UNITYSDK_OFFSET(0xB52ADE0)
#define MOLEMOLE_UIRECYCLEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS57_0__ONSORTERMARKDELETECLICK_B__1_OFFSET UNITYSDK_OFFSET(0xB52AE60)

namespace MoleMole
{
	inline static constexpr unsigned int UIRecycleDialogPopWindowController___c__DisplayClass57_0_TypeDefinitionIndex = 64604;
