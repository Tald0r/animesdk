...
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_HPANIMDATABINDVIEW__HANDLEHPUPANIM_D__18_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x393270)
#define MOLEMOLE_UIMONSTERFANTASYROLEITEMWIDGETCONTROLLER_HPANIMDATABINDVIEW__HANDLEHPUPANIM_D__18_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyRoleItemWidgetController_HpAnimDataBindView__HandleHpUpAnim_d__18_TypeDefinitionIndex = 45167;
