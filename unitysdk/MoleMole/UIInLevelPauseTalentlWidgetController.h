...
class Class_2_1BA1094E16749B02_1;
...
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_GETAVATARID_OFFSET UNITYSDK_OFFSET(0x8957880)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_INITROLEBTN_OFFSET UNITYSDK_OFFSET(0x8956BD0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x89576D0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8957770)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8956A10)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8956AB0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_REFRESHAVATARTALENTINFO_OFFSET UNITYSDK_OFFSET(0x89579D0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_SETSELECTEDAVATARID_OFFSET UNITYSDK_OFFSET(0x89583A0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER_SWITCHSELECTEDAVATAR_OFFSET UNITYSDK_OFFSET(0x8957920)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x89586C0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x89584B0)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER__INITROLEBTN_B__7_0_OFFSET UNITYSDK_OFFSET(0x8958710)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER__ONUIOPEN_B__3_0_OFFSET UNITYSDK_OFFSET(0x8958700)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8958720)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8958790)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8958810)
#define MOLEMOLE_UIINLEVELPAUSETALENTLWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8958870)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseTalentlWidgetController_TypeDefinitionIndex = 60713;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseTalentlWidgetController_TypeDefinitionIndex)->GetStaticField(0x101C0);
		}
		// static const ::System::Int32 MAX_TALENT = 0x8; // 0x0
		::Class_2_1BA1094E16749B02_1* _view; // 0x2A0
		::System::Collections::Generic::List_1<::Foundation::Coroutine::CoroutineHandle>* handleList; // 0x2A8
		::System::Collections::Generic::List_1<::MoleMole::UIInLevelPauseTalentRowWidgetController*>* talentRowList; // 0x2B0
		::System::Collections::Generic::List_1<::System::Int32>* avatarIDList; // 0x2B8
		::System::Collections::Generic::List_1<::Class_2_D89CCC627A66D0AD*>* avatarItemList; // 0x2C0
		::System::Collections::Generic::List_1<::Class_2_8C4A02E118DF31DE*>* _dBattleAvatars; // 0x2C8
