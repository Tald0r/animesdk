...
#define MOLEMOLE_GRIDLAYOUTGROUPADAPTOR_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x759E4B0)
#define MOLEMOLE_GRIDLAYOUTGROUPADAPTOR_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x759E4D0)
#define MOLEMOLE_GRIDLAYOUTGROUPADAPTOR_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x759E640)
#define MOLEMOLE_GRIDLAYOUTGROUPADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x759E550)

namespace MoleMole
{
	inline static constexpr unsigned int GridLayoutGroupAdaptor_TypeDefinitionIndex = 43558;
