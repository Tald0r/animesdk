...
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4AF070)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4AF110)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4AEF10)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA4AEFB0)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA4AF1F0)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4B0020)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4B0050)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4B00C0)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4B0140)
#define MOLEMOLE_UIABINLEVELITEMINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA4B01A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIABInLevelItemInfoWidgetController_TypeDefinitionIndex = 73934;

	class UIABInLevelItemInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_F3088E2F287D7C4D_1* _view; // 0x2A0
