...
#define MOLEMOLE_UICPTAGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B02BF10)

namespace MoleMole
{
	inline static constexpr unsigned int UICpTagBehaviour_TypeDefinitionIndex = 81573;
