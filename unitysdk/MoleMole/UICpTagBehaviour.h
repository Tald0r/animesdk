...
#define MOLEMOLE_UICPTAGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x199E5CE0)

namespace MoleMole
{
	inline static constexpr unsigned int UICpTagBehaviour_TypeDefinitionIndex = 83497;
