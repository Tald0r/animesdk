...
#define MOLEMOLE_PHOTOSETTINGCONTEXT_GET_INITTABTYPE_OFFSET UNITYSDK_OFFSET(0xA53A760)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_GET_ISSHOWFRAME_OFFSET UNITYSDK_OFFSET(0xA53A700)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_GET_ISSHOWSETTINGSCOPEDFRONT_OFFSET UNITYSDK_OFFSET(0xA53A6E0)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_GET_ISSHOWSTICKER_OFFSET UNITYSDK_OFFSET(0xA53A720)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_GET_ISSHOWVOLUME_OFFSET UNITYSDK_OFFSET(0xA53A6C0)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_GET_RESETSETTINGTABINDEX_OFFSET UNITYSDK_OFFSET(0xA53A740)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_SET_INITTABTYPE_OFFSET UNITYSDK_OFFSET(0xA53A770)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_SET_ISSHOWFRAME_OFFSET UNITYSDK_OFFSET(0xA53A710)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_SET_ISSHOWSETTINGSCOPEDFRONT_OFFSET UNITYSDK_OFFSET(0xA53A6F0)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_SET_ISSHOWSTICKER_OFFSET UNITYSDK_OFFSET(0xA53A730)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_SET_ISSHOWVOLUME_OFFSET UNITYSDK_OFFSET(0xA53A6D0)
#define MOLEMOLE_PHOTOSETTINGCONTEXT_SET_RESETSETTINGTABINDEX_OFFSET UNITYSDK_OFFSET(0xA53A750)
#define MOLEMOLE_PHOTOSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA53A780)

namespace MoleMole
{
	inline static constexpr unsigned int PhotoSettingContext_TypeDefinitionIndex = 47075;

	class PhotoSettingContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Func_1<::System::Collections::Generic::IList_1<::MoleMole::UIStickerShowWidgetController*>*>* GetActiveStickerWidgetCtrlList; // 0x28
		::System::Func_2<::MoleMole::InputActionEvent, ::System::Boolean>* OnInputActiveHandle; // 0x30
		::System::Func_1<::UnityEngine::RectTransform*>* GetStickerRoot; // 0x38
		::System::Boolean _ResetSettingTabIndex_k__BackingField; // 0x40
		::System::Boolean _IsShowVolume_k__BackingField; // 0x41
		::System::Boolean _IsShowSticker_k__BackingField; // 0x42
		::System::Boolean _IsShowFrame_k__BackingField; // 0x43
