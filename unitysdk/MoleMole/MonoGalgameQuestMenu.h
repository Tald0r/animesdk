...
#define MOLEMOLE_MONOGALGAMEQUESTMENU_INIT_OFFSET UNITYSDK_OFFSET(0x6B06F60)
#define MOLEMOLE_MONOGALGAMEQUESTMENU_METHOD_5_640514F2FC7A7607_OFFSET UNITYSDK_OFFSET(0x6B07980)
#define MOLEMOLE_MONOGALGAMEQUESTMENU_SETBUTTONINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x6B077A0)
#define MOLEMOLE_MONOGALGAMEQUESTMENU_SETDATA_OFFSET UNITYSDK_OFFSET(0x6B07230)
#define MOLEMOLE_MONOGALGAMEQUESTMENU__CTOR_OFFSET UNITYSDK_OFFSET(0x6B07910)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGalgameQuestMenu_TypeDefinitionIndex = 64226;
