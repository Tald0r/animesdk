...
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_GETANIMCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x8EFD620)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_GET_FLAMEANIM_OFFSET UNITYSDK_OFFSET(0x8EFCEE0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_GET_LIGHTANIM_OFFSET UNITYSDK_OFFSET(0x8EFCF10)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EFCFF0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x8EFD170)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EFD090)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EFCF40)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8EFD1D0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8EFD7E0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER__REFRESHVIEW_B__14_0_OFFSET UNITYSDK_OFFSET(0x8EFD7F0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EFD8F0)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EFD960)
#define MOLEMOLE_UIINLEVELPANYINHUWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EFD9E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPanYinhuWidgetController_TypeDefinitionIndex = 68568;
