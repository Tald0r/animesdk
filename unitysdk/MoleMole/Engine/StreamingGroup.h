...
#define MOLEMOLE_ENGINE_STREAMINGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xC2B4BE0)

namespace MoleMole::Engine
{
	inline static constexpr unsigned int StreamingGroup_TypeDefinitionIndex = 60740;
