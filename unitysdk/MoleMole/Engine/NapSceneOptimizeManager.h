...
#define MOLEMOLE_ENGINE_NAPSCENEOPTIMIZEMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA37B980)
#define MOLEMOLE_ENGINE_NAPSCENEOPTIMIZEMANAGER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0xA37B9F0)
#define MOLEMOLE_ENGINE_NAPSCENEOPTIMIZEMANAGER_TRIGGERSETTINGS_OFFSET UNITYSDK_OFFSET(0xA37BD50)
#define MOLEMOLE_ENGINE_NAPSCENEOPTIMIZEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA37BED0)

namespace MoleMole::Engine
{
	inline static constexpr unsigned int NapSceneOptimizeManager_TypeDefinitionIndex = 40153;
