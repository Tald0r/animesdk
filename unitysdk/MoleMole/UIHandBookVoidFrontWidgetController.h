...
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x91396C0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONENTRANCECHANGE_OFFSET UNITYSDK_OFFSET(0x9139930)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9139760)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9138C00)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x91390C0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x91391E0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_SHOWDETAILPOPUP_OFFSET UNITYSDK_OFFSET(0x9139840)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x91399A0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER__ONUIINIT_B__2_1_OFFSET UNITYSDK_OFFSET(0x91399D0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9139A50)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9139AC0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9139B40)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9139BA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookVoidFrontWidgetController_TypeDefinitionIndex = 47193;
