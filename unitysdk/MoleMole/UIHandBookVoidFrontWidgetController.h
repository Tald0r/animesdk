...
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7D0A8A0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONENTRANCECHANGE_OFFSET UNITYSDK_OFFSET(0x7D0AB10)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7D0A940)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7D09DE0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7D0A2A0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x7D0A3C0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER_SHOWDETAILPOPUP_OFFSET UNITYSDK_OFFSET(0x7D0AA20)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7D0AB80)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER__ONUIINIT_B__2_1_OFFSET UNITYSDK_OFFSET(0x7D0ABB0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7D0AC30)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7D0ACA0)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7D0AD20)
#define MOLEMOLE_UIHANDBOOKVOIDFRONTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7D0AD80)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookVoidFrontWidgetController_TypeDefinitionIndex = 51477;
