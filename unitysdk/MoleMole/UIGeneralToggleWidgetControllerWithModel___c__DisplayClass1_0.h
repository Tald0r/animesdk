...
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCB69240)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___C__DISPLAYCLASS1_0__REFRESHVIEWWITHMODEL_B__0_OFFSET UNITYSDK_OFFSET(0xCB69250)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___C__DISPLAYCLASS1_0__REFRESHVIEWWITHMODEL_B__1_OFFSET UNITYSDK_OFFSET(0xCB69400)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralToggleWidgetControllerWithModel___c__DisplayClass1_0_TypeDefinitionIndex = 46497;

	class UIGeneralToggleWidgetControllerWithModel___c__DisplayClass1_0 : public ::System::Object
	{
	public:
		::Class_0_16E4307DCC41950C_13<::System::Boolean>* model; // 0x10
