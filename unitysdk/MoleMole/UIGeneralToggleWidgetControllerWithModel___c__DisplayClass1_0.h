...
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCAE3490)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___C__DISPLAYCLASS1_0__REFRESHVIEWWITHMODEL_B__0_OFFSET UNITYSDK_OFFSET(0xCAE34A0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLERWITHMODEL___C__DISPLAYCLASS1_0__REFRESHVIEWWITHMODEL_B__1_OFFSET UNITYSDK_OFFSET(0xCAE3650)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralToggleWidgetControllerWithModel___c__DisplayClass1_0_TypeDefinitionIndex = 49995;

	class UIGeneralToggleWidgetControllerWithModel___c__DisplayClass1_0 : public ::System::Object
	{
	public:
		::Class_0_16E4307DCC419505_103<::System::Boolean>* model; // 0x10
