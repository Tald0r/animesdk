...
#define MOLEMOLE_SLIDINGSUBSYSTEM_ADDCHECKINGENTITY_OFFSET UNITYSDK_OFFSET(0xB7014D0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ADDCONTROLENTITY_OFFSET UNITYSDK_OFFSET(0xB8773B0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ADDDEBUGGER_OFFSET UNITYSDK_OFFSET(0xB875B00)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ADDROTATIONENTITY_OFFSET UNITYSDK_OFFSET(0xB700EB0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ADDVELOCITY_OFFSET UNITYSDK_OFFSET(0xB875FE0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ENTRYSLIDINGSTATE_OFFSET UNITYSDK_OFFSET(0xB876A60)
#define MOLEMOLE_SLIDINGSUBSYSTEM_FIXEDUPDATECHECKINGCONTEXT_OFFSET UNITYSDK_OFFSET(0xB701AD0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_FIXEDUPDATECONTROLCONTEXT_OFFSET UNITYSDK_OFFSET(0xB7019E0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_FIXEDUPDATEROTATIONCONTEXT_OFFSET UNITYSDK_OFFSET(0xB701BD0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_GETCURRENTVELOCITY_OFFSET UNITYSDK_OFFSET(0xB876E80)
#define MOLEMOLE_SLIDINGSUBSYSTEM_GETORCREATECOMMONCONTEXT_OFFSET UNITYSDK_OFFSET(0xB700D10)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ISCHECKINGENTITY_OFFSET UNITYSDK_OFFSET(0xB876DA0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ISSLIDINGENTITY_OFFSET UNITYSDK_OFFSET(0xB876BA0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_MULTIPLYVELOCITY_OFFSET UNITYSDK_OFFSET(0xB876900)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB8756F0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB875A20)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ONFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xB701870)
#define MOLEMOLE_SLIDINGSUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xB701C60)
#define MOLEMOLE_SLIDINGSUBSYSTEM_POPMAXSPEEDXZ_OFFSET UNITYSDK_OFFSET(0xB8771B0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_POPSLIDINGFLINGTHRESHOLD_OFFSET UNITYSDK_OFFSET(0xB877240)
#define MOLEMOLE_SLIDINGSUBSYSTEM_PUSHMAXSPEEDXZ_OFFSET UNITYSDK_OFFSET(0xB877050)
#define MOLEMOLE_SLIDINGSUBSYSTEM_PUSHSLIDINGFLINGTHRESHOLD_OFFSET UNITYSDK_OFFSET(0xB877100)
#define MOLEMOLE_SLIDINGSUBSYSTEM_REFRESHEXITVELOCITY_OFFSET UNITYSDK_OFFSET(0xB8772D0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_REMOVECHECKINGENTITY_OFFSET UNITYSDK_OFFSET(0xB701650)
#define MOLEMOLE_SLIDINGSUBSYSTEM_REMOVECONTROLENTITY_OFFSET UNITYSDK_OFFSET(0xB7011E0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_REMOVEDEBUGGER_OFFSET UNITYSDK_OFFSET(0xB875D70)
#define MOLEMOLE_SLIDINGSUBSYSTEM_REMOVEROTATIONENTITY_OFFSET UNITYSDK_OFFSET(0xB701060)
#define MOLEMOLE_SLIDINGSUBSYSTEM_RESETSLIDINGDIRECTION_OFFSET UNITYSDK_OFFSET(0xB876760)
#define MOLEMOLE_SLIDINGSUBSYSTEM_RESETSURFACE_OFFSET UNITYSDK_OFFSET(0xB701F20)
#define MOLEMOLE_SLIDINGSUBSYSTEM_SETSLIDINGDIRECTION_OFFSET UNITYSDK_OFFSET(0xB876140)
#define MOLEMOLE_SLIDINGSUBSYSTEM_SETSURFACE_OFFSET UNITYSDK_OFFSET(0xB701DB0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_SETVELOCITY_OFFSET UNITYSDK_OFFSET(0xB876330)
#define MOLEMOLE_SLIDINGSUBSYSTEM_SWITCHINTOFLYING_OFFSET UNITYSDK_OFFSET(0xB8765A0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_SWITCHINTOSLIDING_OFFSET UNITYSDK_OFFSET(0xB7016F0)
#define MOLEMOLE_SLIDINGSUBSYSTEM_UPDATECONTROLCONTEXT_OFFSET UNITYSDK_OFFSET(0xB701D20)
#define MOLEMOLE_SLIDINGSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB702080)
#define MOLEMOLE_SLIDINGSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB7020A0)
#define MOLEMOLE_SLIDINGSUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB702100)
#define MOLEMOLE_SLIDINGSUBSYSTEM___BASE_ONFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xB702160)
#define MOLEMOLE_SLIDINGSUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xB7021D0)

namespace MoleMole
{
	inline static constexpr unsigned int SlidingSubsystem_TypeDefinitionIndex = 42059;

	class SlidingSubsystem : public ::MoleMole::GameSubsystemBaseEx_1<::MoleMole::SlidingSubsystem*>
	{
	public:
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_301*>* _debuggers; // 0x10
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_E4E9271419E7BF1D*>* _rotationContexts; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_685AC11A7FB5C953*>* _controlContexts; // 0x30
		...
		::System::Void AddDebugger(::Class_0_16E4307DCC419505_301* debugger)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_301*))((::PBYTE)hIl2Cpp + MOLEMOLE_SLIDINGSUBSYSTEM_ADDDEBUGGER_OFFSET))(this, debugger);
		}

		::System::Void RemoveDebugger(::Class_0_16E4307DCC419505_301* debugger)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_301*))((::PBYTE)hIl2Cpp + MOLEMOLE_SLIDINGSUBSYSTEM_REMOVEDEBUGGER_OFFSET))(this, debugger);
		}
