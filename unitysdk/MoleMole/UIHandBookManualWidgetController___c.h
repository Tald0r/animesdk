...
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x8C535C0)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x8C53600)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER___C__INITTAB_B__19_0_OFFSET UNITYSDK_OFFSET(0x8C53610)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER___C__UPDATEWISHLISTSYSTEMPLAN_B__21_0_OFFSET UNITYSDK_OFFSET(0x8C53670)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookManualWidgetController___c_TypeDefinitionIndex = 49200;
	...
	public:
		...
		{
			return (::System::Comparison_1<::MoleMole::UIHandBookManualWidgetController_TabItem*>**)Il2CppClass::FromTypeDefinitionIndex(UIHandBookManualWidgetController___c_TypeDefinitionIndex)->GetStaticField(0x41720);
		}
		static ::System::Action_1<::System::Int32>** StaticGet___9__21_0()
		{
			return (::System::Action_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(UIHandBookManualWidgetController___c_TypeDefinitionIndex)->GetStaticField(0x41728);
		}
		static ::MoleMole::UIHandBookManualWidgetController___c** StaticGet___9()
		{
			return (::MoleMole::UIHandBookManualWidgetController___c**)Il2CppClass::FromTypeDefinitionIndex(UIHandBookManualWidgetController___c_TypeDefinitionIndex)->GetStaticField(0x41730);
		}
