...
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_GET_REFRESH_OFFSET UNITYSDK_OFFSET(0xD29A410)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_GET_SETACTIVE_OFFSET UNITYSDK_OFFSET(0xD29A420)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0xD29A430)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoSkillChildWindowController_SubViewDefine_TypeDefinitionIndex = 48917;

	class UIRoleInfoSkillChildWindowController_SubViewDefine : public ::System::Object
	{
	public:
		::MoleMole::UIRoleInfoSkillChildWindowController_SubViewDefine_RefreshDel* _Refresh_k__BackingField; // 0x10
		::MoleMole::UIRoleInfoSkillChildWindowController_SubViewDefine_SetActiveDel* _SetActive_k__BackingField; // 0x18
