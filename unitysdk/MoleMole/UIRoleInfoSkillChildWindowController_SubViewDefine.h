...
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_GET_REFRESH_OFFSET UNITYSDK_OFFSET(0xAE581E0)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE_GET_SETACTIVE_OFFSET UNITYSDK_OFFSET(0xAE581F0)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER_SUBVIEWDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0xAE58200)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoSkillChildWindowController_SubViewDefine_TypeDefinitionIndex = 49310;
