...
#define MOLEMOLE_MUSICGAME_MUSICCALIBRATIONDATA_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x830C5B0)
#define MOLEMOLE_MUSICGAME_MUSICCALIBRATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x830C5C0)

namespace MoleMole::MusicGame
{
	inline static constexpr unsigned int MusicCalibrationData_TypeDefinitionIndex = 47997;
