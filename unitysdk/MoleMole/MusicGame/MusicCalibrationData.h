...
#define MOLEMOLE_MUSICGAME_MUSICCALIBRATIONDATA_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0xB92A520)
#define MOLEMOLE_MUSICGAME_MUSICCALIBRATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB92A530)

namespace MoleMole::MusicGame
{
	inline static constexpr unsigned int MusicCalibrationData_TypeDefinitionIndex = 39686;
