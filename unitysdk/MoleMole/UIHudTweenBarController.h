...
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xE285330)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_REFRESHBARVIEW_OFFSET UNITYSDK_OFFSET(0xE2856E0)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_SETCURRENTVALUETOEND_OFFSET UNITYSDK_OFFSET(0xE2853A0)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xE2854A0)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER_SETVALUEIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xE285520)
#define MOLEMOLE_UIHUDTWEENBARCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE285A30)

namespace MoleMole
{
	inline static constexpr unsigned int UIHudTweenBarController_TypeDefinitionIndex = 63027;
