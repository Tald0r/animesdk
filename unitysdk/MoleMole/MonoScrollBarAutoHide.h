...
#define MOLEMOLE_MONOSCROLLBARAUTOHIDE_AWAKE_OFFSET UNITYSDK_OFFSET(0xB9A5A00)
#define MOLEMOLE_MONOSCROLLBARAUTOHIDE_UPDATESTATUS_1_OFFSET UNITYSDK_OFFSET(0xB9A5C90)
#define MOLEMOLE_MONOSCROLLBARAUTOHIDE_UPDATESTATUS_OFFSET UNITYSDK_OFFSET(0xB9A5BD0)
#define MOLEMOLE_MONOSCROLLBARAUTOHIDE_UPDATE_OFFSET UNITYSDK_OFFSET(0xB9A5AF0)
#define MOLEMOLE_MONOSCROLLBARAUTOHIDE__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A5E00)

namespace MoleMole
{
	inline static constexpr unsigned int MonoScrollBarAutoHide_TypeDefinitionIndex = 68018;
