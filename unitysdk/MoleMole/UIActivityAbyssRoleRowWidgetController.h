...
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_ONCLICKROW_OFFSET UNITYSDK_OFFSET(0xCFF2270)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFF1BB0)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCFF1D30)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFF1C50)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFF1920)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFF1B00)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER_SETROLEINFO_OFFSET UNITYSDK_OFFSET(0xCFF1EC0)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF2830)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFF2840)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCFF28B0)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFF2930)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFF29B0)
#define MOLEMOLE_UIACTIVITYABYSSROLEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFF2A10)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityAbyssRoleRowWidgetController_TypeDefinitionIndex = 80323;
	...
	public:
		...
		::Class_1_C1067BB4CC216C9A_1* roleData; // 0x2D8
