...
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_GETTARGET_OFFSET UNITYSDK_OFFSET(0xCA3BC60)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xCA38670)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_INITTABS_OFFSET UNITYSDK_OFFSET(0xCA38D50)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xCA38790)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA38680)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xCA396C0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_ONLEVELCHANGED_OFFSET UNITYSDK_OFFSET(0xCA3C070)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCA39750)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xCA39500)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA397C0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA38720)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA389F0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_READPRVGAMES_OFFSET UNITYSDK_OFFSET(0xCA39890)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_REFRESHGAMEENTRYLOCKEDBTN_OFFSET UNITYSDK_OFFSET(0xCA3B220)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_REFRESHGAMEENTRYUNLOCKEDBTN_OFFSET UNITYSDK_OFFSET(0xCA3B9A0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCA39B10)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_SETGAMEENTRYVIEW_OFFSET UNITYSDK_OFFSET(0xCA3A2E0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_SETHIDDENITEMSFORENTRY_OFFSET UNITYSDK_OFFSET(0xCA3ABC0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_SETSTARSFORENTRY_OFFSET UNITYSDK_OFFSET(0xCA3B330)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_SHOULDPLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0xCA3B710)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_TRYPLAYUNLOCKANIMS_OFFSET UNITYSDK_OFFSET(0xCA3C0E0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_TRYPLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0xCA3BAF0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA3C250)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER__INITTABS_B__17_0_OFFSET UNITYSDK_OFFSET(0xCA3C410)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER__REFRESHVIEW_B__11_0_OFFSET UNITYSDK_OFFSET(0xCA3C3D0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA3C550)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xCA3C5C0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCA3C5D0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xCA3C5E0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA3C5F0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA3C600)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA3C610)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastMissionPageController_TypeDefinitionIndex = 68142;
	...
	public:
		...
		::Class_1_8BABEB2BC6365EFE* _dropDownViewModel; // 0x318
		::Il2CppArray<::Struct_2_037D21AC29ED1130>* _dropDownParams; // 0x320
		::System::Int32 _curIdx; // 0x328
		::System::Int32 _targetLevel; // 0x32C
		::Il2CppArray<::Class_2_208CC9941471731A_892*>* _allLevels; // 0x330
		::MoleMole::UIGeneralNewHintWidgetController* _newHintWidget; // 0x338
		::System::Collections::Generic::List_1<::Class_3_022369EEDD787131*>* _showingList; // 0x340
		...
		::System::Void SetGameEntryView(::System::Int32 idx, ::Class_3_022369EEDD787131* game)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Class_3_022369EEDD787131*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_SETGAMEENTRYVIEW_OFFSET))(this, idx, game);
		}
		...
		::System::Void TryPlayUnlockAnim(::Class_2_B382CAAA120A70DB_Class_2_E4D4EF8398E9F9EC* entryView, ::Class_3_022369EEDD787131* game)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_B382CAAA120A70DB_Class_2_E4D4EF8398E9F9EC*, ::Class_3_022369EEDD787131*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER_TRYPLAYUNLOCKANIM_OFFSET))(this, entryView, game);
		}
