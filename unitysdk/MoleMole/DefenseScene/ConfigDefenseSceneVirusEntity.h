...
#define MOLEMOLE_DEFENSESCENE_CONFIGDEFENSESCENEVIRUSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x8F60570)

namespace MoleMole::DefenseScene
{
	inline static constexpr unsigned int ConfigDefenseSceneVirusEntity_TypeDefinitionIndex = 49707;
