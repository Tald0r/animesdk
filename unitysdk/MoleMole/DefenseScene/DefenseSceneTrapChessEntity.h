...
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_ONADDINTERNAL_OFFSET UNITYSDK_OFFSET(0xB4882D0)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_ONINITINTERNAL_OFFSET UNITYSDK_OFFSET(0xB488210)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_ONREMOVEINTERNAL_OFFSET UNITYSDK_OFFSET(0xB488330)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_ONUPDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0xB488390)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY_SENDTIMEROUTEVENT_OFFSET UNITYSDK_OFFSET(0xB488520)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0xB4885C0)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY___BASE_ONADDINTERNAL_OFFSET UNITYSDK_OFFSET(0xB4886A0)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY___BASE_ONINITINTERNAL_OFFSET UNITYSDK_OFFSET(0xB488700)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY___BASE_ONREMOVEINTERNAL_OFFSET UNITYSDK_OFFSET(0xB488770)
#define MOLEMOLE_DEFENSESCENE_DEFENSESCENETRAPCHESSENTITY___BASE_ONUPDATEINTERNAL_OFFSET UNITYSDK_OFFSET(0xB4887D0)

namespace MoleMole::DefenseScene
{
	inline static constexpr unsigned int DefenseSceneTrapChessEntity_TypeDefinitionIndex = 39608;
