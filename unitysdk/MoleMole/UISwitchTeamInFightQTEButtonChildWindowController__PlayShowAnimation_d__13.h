...
#define MOLEMOLE_UISWITCHTEAMINFIGHTQTEBUTTONCHILDWINDOWCONTROLLER__PLAYSHOWANIMATION_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x39B8C0)
#define MOLEMOLE_UISWITCHTEAMINFIGHTQTEBUTTONCHILDWINDOWCONTROLLER__PLAYSHOWANIMATION_D__13_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UISwitchTeamInFightQTEButtonChildWindowController__PlayShowAnimation_d__13_TypeDefinitionIndex = 66367;
