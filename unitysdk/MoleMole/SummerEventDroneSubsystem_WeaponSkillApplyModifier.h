...
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER_CLEANUP_OFFSET UNITYSDK_OFFSET(0xB702D80)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER_INIT_OFFSET UNITYSDK_OFFSET(0xB702710)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER_ISINSTANTSKILLTYPE_OFFSET UNITYSDK_OFFSET(0xB702D20)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER_ONADD_OFFSET UNITYSDK_OFFSET(0xB702890)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0xB702E70)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER_ONREMOVED_OFFSET UNITYSDK_OFFSET(0xB702B50)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0xB702F20)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER___BASE_CLEANUP_OFFSET UNITYSDK_OFFSET(0xB702F40)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER___BASE_INIT_OFFSET UNITYSDK_OFFSET(0xB702FC0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER___BASE_ISINSTANTSKILLTYPE_OFFSET UNITYSDK_OFFSET(0xB703070)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER___BASE_ONADD_OFFSET UNITYSDK_OFFSET(0xB7030D0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLAPPLYMODIFIER___BASE_ONREMOVED_OFFSET UNITYSDK_OFFSET(0xB703130)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventDroneSubsystem_WeaponSkillApplyModifier_TypeDefinitionIndex = 71336;
