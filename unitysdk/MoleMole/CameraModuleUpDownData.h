...
#define MOLEMOLE_CAMERAMODULEUPDOWNDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBAD57D0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraModuleUpDownData_TypeDefinitionIndex = 41700;
