...
#define MOLEMOLE_CAMERAMODULEUPDOWNDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6D33BF0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraModuleUpDownData_TypeDefinitionIndex = 68925;
