...
#define MOLEMOLE_UIMECHBOOPRACTICERESULTROWWIDGETCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA418690)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooPracticeResultRowWidgetControllerContext_TypeDefinitionIndex = 70974;
