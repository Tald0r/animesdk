...
#define MOLEMOLE_UISUMMERSURFRIGHTBARCHILDWINDOWCONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xACD1290)
#define MOLEMOLE_UISUMMERSURFRIGHTBARCHILDWINDOWCONTROLLER_GET_FILLMAT_OFFSET UNITYSDK_OFFSET(0xACD1280)
#define MOLEMOLE_UISUMMERSURFRIGHTBARCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xACD1030)
#define MOLEMOLE_UISUMMERSURFRIGHTBARCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xACD11F0)
#define MOLEMOLE_UISUMMERSURFRIGHTBARCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xACD12B0)
#define MOLEMOLE_UISUMMERSURFRIGHTBARCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xACD1310)
#define MOLEMOLE_UISUMMERSURFRIGHTBARCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xACD1380)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerSurfRightBarChildWindowController_TypeDefinitionIndex = 61026;

	class UISummerSurfRightBarChildWindowController : public ::MoleMole::SummerSurfBar
	{
	public:
		::Class_2_07F94AA48C3B4F12_1* _view; // 0x310
		::UnityEngine::Material* _material; // 0x318
