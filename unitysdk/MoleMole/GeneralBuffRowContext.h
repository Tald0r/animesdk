...
#define MOLEMOLE_GENERALBUFFROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC223A60)

namespace MoleMole
{
	inline static constexpr unsigned int GeneralBuffRowContext_TypeDefinitionIndex = 69172;
