...
#define MOLEMOLE_MONOUIMOVER_AWAKE_OFFSET UNITYSDK_OFFSET(0xB2ED530)
#define MOLEMOLE_MONOUIMOVER_METHOD_5_8E7482C252877E8A_OFFSET UNITYSDK_OFFSET(0xB2ED6F0)
#define MOLEMOLE_MONOUIMOVER_MOVETO_OFFSET UNITYSDK_OFFSET(0xB2ED9D0)
#define MOLEMOLE_MONOUIMOVER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB2ED600)
#define MOLEMOLE_MONOUIMOVER_ONMOVEEND_OFFSET UNITYSDK_OFFSET(0xB2EDA50)
#define MOLEMOLE_MONOUIMOVER_STOPMOVE_OFFSET UNITYSDK_OFFSET(0xB2EDB30)
#define MOLEMOLE_MONOUIMOVER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB2ED670)
#define MOLEMOLE_MONOUIMOVER__CTOR_OFFSET UNITYSDK_OFFSET(0xB2EDBA0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIMover_TypeDefinitionIndex = 67456;
