...
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA90A520)

namespace MoleMole
{
	inline static constexpr unsigned int UIFoodTruckMenuPageContext_TypeDefinitionIndex = 51788;
