...
#define MOLEMOLE_UIFOODTRUCKMENUPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA9341E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFoodTruckMenuPageContext_TypeDefinitionIndex = 79748;
