...
#define MOLEMOLE_CREATESAVEPOINTBYANCHOR_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x16BBCCF0)
#define MOLEMOLE_CREATESAVEPOINTBYANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16BBD160)
#define MOLEMOLE_CREATESAVEPOINTBYANCHOR___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x16BBD1A0)

namespace MoleMole
{
	inline static constexpr unsigned int CreateSavePointByAnchor_TypeDefinitionIndex = 60077;
