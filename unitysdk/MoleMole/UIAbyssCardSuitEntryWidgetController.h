...
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER_GET_BTNENTRYOBJ_OFFSET UNITYSDK_OFFSET(0xA4B02A0)
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0xA4B0A10)
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER_ONCLICKENTRY_OFFSET UNITYSDK_OFFSET(0xA4B0B40)
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4B1060)
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4B1100)
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4B02D0)
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA4B0FA0)
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER_REFRESHCARDS_OFFSET UNITYSDK_OFFSET(0xA4B04D0)
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER_TELEPORTTONESTLEVEL_OFFSET UNITYSDK_OFFSET(0xA4B0DD0)
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4B11E0)
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4B1210)
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4B1280)
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4B1300)
#define MOLEMOLE_UIABYSSCARDSUITENTRYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA4B1360)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssCardSuitEntryWidgetController_TypeDefinitionIndex = 63498;
	...
	public:
		...
		::Class_3_22ABBE9853C94234* m_curSelectAbyssCardBuild; // 0x2B8
