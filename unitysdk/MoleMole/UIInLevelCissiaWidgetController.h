...
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_ITEMFADEIN_OFFSET UNITYSDK_OFFSET(0xBB585F0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_ITEMFADEOUT_OFFSET UNITYSDK_OFFSET(0xBB58640)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_ITEMLOOP_OFFSET UNITYSDK_OFFSET(0xBB58630)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_LIGHTUPANIM_OFFSET UNITYSDK_OFFSET(0xBB586B0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_LIGHTUPGO_OFFSET UNITYSDK_OFFSET(0xBB586A0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_MAXANIM_OFFSET UNITYSDK_OFFSET(0xBB586E0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_POINTMAXFADEIN_OFFSET UNITYSDK_OFFSET(0xBB58680)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_GET_POINTMAXFADEOUT_OFFSET UNITYSDK_OFFSET(0xBB58690)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB58840)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB588E0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB586F0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBB58790)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB589C0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB58A00)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB58A70)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB58AF0)
#define MOLEMOLE_UIINLEVELCISSIAWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBB58B50)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCissiaWidgetController_TypeDefinitionIndex = 56395;

	class UIInLevelCissiaWidgetController : public ::MoleMole::UIInLevelLightUpPointsItemControllerBase
	{
	public:
		::Class_2_7ABF2118692E7A85_10* _view; // 0x2B0
