...
#define MOLEMOLE_UIVOIDFRONTLEVELRESULTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x71E5D30)
#define MOLEMOLE_UIVOIDFRONTLEVELRESULTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x71E5DD0)
#define MOLEMOLE_UIVOIDFRONTLEVELRESULTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x71E5BE0)
#define MOLEMOLE_UIVOIDFRONTLEVELRESULTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x71E5C80)
#define MOLEMOLE_UIVOIDFRONTLEVELRESULTROWWIDGETCONTROLLER_REFRESHWIDGET_OFFSET UNITYSDK_OFFSET(0x71E5EB0)
#define MOLEMOLE_UIVOIDFRONTLEVELRESULTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x71E6080)
#define MOLEMOLE_UIVOIDFRONTLEVELRESULTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x71E60B0)
#define MOLEMOLE_UIVOIDFRONTLEVELRESULTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x71E6120)
#define MOLEMOLE_UIVOIDFRONTLEVELRESULTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x71E61A0)
#define MOLEMOLE_UIVOIDFRONTLEVELRESULTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x71E6200)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontLevelResultRowWidgetController_TypeDefinitionIndex = 70665;
