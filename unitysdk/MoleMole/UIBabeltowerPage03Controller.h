...
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0xBF38880)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_CREATESELECTITEM_OFFSET UNITYSDK_OFFSET(0xBF38D40)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_GETFIGHTINFOWIDGET_OFFSET UNITYSDK_OFFSET(0xBF38BF0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONBABELTOWERUPDATERANK_OFFSET UNITYSDK_OFFSET(0xBF39DA0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF38B40)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBF38A20)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBF38EC0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONTEACH_OFFSET UNITYSDK_OFFSET(0xBF39E10)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF38370)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF38640)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_OPENRANKINFO_OFFSET UNITYSDK_OFFSET(0xBF3A740)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0xBF39400)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_REFRESHPOWER_OFFSET UNITYSDK_OFFSET(0xBF39280)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_TEST_OFFSET UNITYSDK_OFFSET(0xBF382E0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_UPDATERANKDATA_OFFSET UNITYSDK_OFFSET(0xBF3A390)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_UPDATERANKVIEW_OFFSET UNITYSDK_OFFSET(0xBF39A90)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBF3A2D0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER__CREATESELECTITEM_B__10_0_OFFSET UNITYSDK_OFFSET(0xBF3AAA0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF3A960)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0xBF3AA00)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER__OPENRANKINFO_B__19_0_OFFSET UNITYSDK_OFFSET(0xBF3AB50)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0xBF3ACE0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_CREATESELECTITEM_OFFSET UNITYSDK_OFFSET(0xBF3ACF0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_GETFIGHTINFOWIDGET_OFFSET UNITYSDK_OFFSET(0xBF3AD00)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF3AD10)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBF3AD20)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBF3AD50)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF3AD60)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF3AD70)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0xBF3AD80)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xBF3AD90)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerPage03Controller_TypeDefinitionIndex = 58882;

	class UIBabeltowerPage03Controller : public ::MoleMole::UIBabeltowerPage02Controller
	{
	public:
		::Class_2_79AE422BA06F6D26_14* _view; // 0x3C0
		::System::Single configUpdateTime; // 0x3C8
		::System::String* ANIM_NAME; // 0x3D0
		::System::Single waitTimer; // 0x3D8
		::System::Int32 mvpCount; // 0x3DC
		::System::Int32 totalMvpCount; // 0x3E0
