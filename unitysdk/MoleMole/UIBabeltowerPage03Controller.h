...
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0xE93F7C0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_CREATESELECTITEM_OFFSET UNITYSDK_OFFSET(0xE93FC80)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_GETFIGHTINFOWIDGET_OFFSET UNITYSDK_OFFSET(0xE93FB30)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONBABELTOWERUPDATERANK_OFFSET UNITYSDK_OFFSET(0xE940CF0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE93FA80)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xE93F960)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xE93FE00)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONTEACH_OFFSET UNITYSDK_OFFSET(0xE940D60)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE93F2B0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE93F580)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_OPENRANKINFO_OFFSET UNITYSDK_OFFSET(0xE941690)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0xE940340)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_REFRESHPOWER_OFFSET UNITYSDK_OFFSET(0xE9401C0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_TEST_OFFSET UNITYSDK_OFFSET(0xE93F220)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_UPDATERANKDATA_OFFSET UNITYSDK_OFFSET(0xE9412E0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_UPDATERANKVIEW_OFFSET UNITYSDK_OFFSET(0xE9409E0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xE941220)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER__CREATESELECTITEM_B__10_0_OFFSET UNITYSDK_OFFSET(0xE9419F0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE9418B0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0xE941950)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER__OPENRANKINFO_B__19_0_OFFSET UNITYSDK_OFFSET(0xE941AA0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_CHECKNEWBIE_OFFSET UNITYSDK_OFFSET(0xE941C30)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_CREATESELECTITEM_OFFSET UNITYSDK_OFFSET(0xE941C40)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_GETFIGHTINFOWIDGET_OFFSET UNITYSDK_OFFSET(0xE941C50)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE941C60)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xE941C70)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xE941CA0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE941CB0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE941CC0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0xE941CD0)
#define MOLEMOLE_UIBABELTOWERPAGE03CONTROLLER___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xE941CE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerPage03Controller_TypeDefinitionIndex = 76771;

	class UIBabeltowerPage03Controller : public ::MoleMole::UIBabeltowerPage02Controller
	{
	public:
		::Class_2_79AE422BA06F6D26_46* _view; // 0x3C0
