...
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCB49090)
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__INITVIDEOPLAYER_B__0_OFFSET UNITYSDK_OFFSET(0xCB490A0)
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__INITVIDEOPLAYER_B__1_OFFSET UNITYSDK_OFFSET(0xCB49190)

namespace MoleMole
{
	inline static constexpr unsigned int UIFullScreenVideoV2PopWindowController___c__DisplayClass14_0_TypeDefinitionIndex = 58869;
