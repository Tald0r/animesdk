...
#define MOLEMOLE_UIHANDBOOKANTIQUEITEMROWWIDGETCONTROLLER_PANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x7A61670)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookAntiqueItemRowWidgetController_PanelData_TypeDefinitionIndex = 64428;
	...
	public:
		...
		::System::Boolean IsRate; // 0x24
		::Share::ENotificationBadgeType RedSignType; // 0x28
		::System::Int32 CurrentCount; // 0x2C
