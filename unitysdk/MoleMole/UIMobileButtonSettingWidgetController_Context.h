...
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_GET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0xB245F30)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_GET_MINVALUE_OFFSET UNITYSDK_OFFSET(0xB245EA0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_GET_OVERRIDEMOBILEBUTTONPANEL_OFFSET UNITYSDK_OFFSET(0xB245970)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_GET_RUNTIMEVALUE_OFFSET UNITYSDK_OFFSET(0xB245CE0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_SET_RUNTIMEVALUE_OFFSET UNITYSDK_OFFSET(0xB245DB0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB245AA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMobileButtonSettingWidgetController_Context_TypeDefinitionIndex = 60711;
