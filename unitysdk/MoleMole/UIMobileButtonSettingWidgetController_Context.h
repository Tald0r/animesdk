...
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_GET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x747ADE0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_GET_MINVALUE_OFFSET UNITYSDK_OFFSET(0x747AD50)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_GET_OVERRIDEMOBILEBUTTONPANEL_OFFSET UNITYSDK_OFFSET(0x747A820)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_GET_RUNTIMEVALUE_OFFSET UNITYSDK_OFFSET(0x747AB90)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT_SET_RUNTIMEVALUE_OFFSET UNITYSDK_OFFSET(0x747AC60)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x747A950)

namespace MoleMole
{
	inline static constexpr unsigned int UIMobileButtonSettingWidgetController_Context_TypeDefinitionIndex = 45404;
