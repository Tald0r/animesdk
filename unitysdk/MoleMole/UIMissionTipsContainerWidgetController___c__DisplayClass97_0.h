...
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS97_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB7450)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS97_0__PLAYHDDHANGTIP_B__0_OFFSET UNITYSDK_OFFSET(0x9AB7460)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS97_0__PLAYHDDHANGTIP_B__1_OFFSET UNITYSDK_OFFSET(0x9AB7530)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsContainerWidgetController___c__DisplayClass97_0_TypeDefinitionIndex = 70965;
