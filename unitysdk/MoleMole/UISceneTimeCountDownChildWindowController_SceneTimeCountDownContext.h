...
#define MOLEMOLE_UISCENETIMECOUNTDOWNCHILDWINDOWCONTROLLER_SCENETIMECOUNTDOWNCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC3C3FF0)

namespace MoleMole
{
	inline static constexpr unsigned int UISceneTimeCountDownChildWindowController_SceneTimeCountDownContext_TypeDefinitionIndex = 44186;

	class UISceneTimeCountDownChildWindowController_SceneTimeCountDownContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_0_16E4307DCC419505_373* Support; // 0x28
