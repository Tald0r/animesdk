...
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSITEMWIDGETCONTROLLER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC067B50)
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSITEMWIDGETCONTROLLER___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC067B90)
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSITEMWIDGETCONTROLLER___C__REFRESHGAMEPADLIST_B__9_0_OFFSET UNITYSDK_OFFSET(0xC067BA0)
#define MOLEMOLE_UIHANDBOOKWEEKENDBOSSITEMWIDGETCONTROLLER___C__REFRESHGAMEPADLIST_B__9_1_OFFSET UNITYSDK_OFFSET(0xC067BC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookWeekendBossItemWidgetController___c_TypeDefinitionIndex = 45274;
	...
	public:
		...
		{
			return (::System::Func_2<::System::Collections::Generic::KeyValuePair_2<::UnityEngine::GameObject*, ::MoleMole::ScrollViewItemWidgetController*>, ::UnityEngine::GameObject*>**)Il2CppClass::FromTypeDefinitionIndex(UIHandBookWeekendBossItemWidgetController___c_TypeDefinitionIndex)->GetStaticField(0x42700);
		}
		static ::MoleMole::UIHandBookWeekendBossItemWidgetController___c** StaticGet___9()
		{
			return (::MoleMole::UIHandBookWeekendBossItemWidgetController___c**)Il2CppClass::FromTypeDefinitionIndex(UIHandBookWeekendBossItemWidgetController___c_TypeDefinitionIndex)->GetStaticField(0x42708);
		}
		...
		{
			return (::System::Func_2<::System::Collections::Generic::KeyValuePair_2<::UnityEngine::GameObject*, ::MoleMole::ScrollViewItemWidgetController*>, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(UIHandBookWeekendBossItemWidgetController___c_TypeDefinitionIndex)->GetStaticField(0x42710);
		}
