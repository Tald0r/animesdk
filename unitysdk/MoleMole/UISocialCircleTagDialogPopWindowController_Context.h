...
#define MOLEMOLE_UISOCIALCIRCLETAGDIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCA6EC40)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleTagDialogPopWindowController_Context_TypeDefinitionIndex = 37620;
