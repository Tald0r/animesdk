...
#define MOLEMOLE_UIABYSSS2RELICDETAILROWWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xE8F3FF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RelicDetailRowWidgetController_Context_TypeDefinitionIndex = 46465;

	class UIAbyssS2RelicDetailRowWidgetController_Context : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_2_208CC9941471731A_213* RelicLevelTemplateExt; // 0x28
