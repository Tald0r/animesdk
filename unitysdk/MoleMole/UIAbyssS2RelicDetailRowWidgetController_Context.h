...
#define MOLEMOLE_UIABYSSS2RELICDETAILROWWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD1BF9A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RelicDetailRowWidgetController_Context_TypeDefinitionIndex = 63549;
	...
	public:
		...
		::Class_2_208CC9941471731A_620* RelicLevelTemplateExt; // 0x30
