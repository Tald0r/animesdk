...
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER_AFTERDATACHANGE_OFFSET UNITYSDK_OFFSET(0x7C5A360)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER_BINDCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x7C5A280)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER_BINDEVENT_BUTTON_OFFSET UNITYSDK_OFFSET(0x7C59F10)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER_GET_PROMOTERTEMPLATE_OFFSET UNITYSDK_OFFSET(0x7C5A690)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x7C5A1D0)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7C5A050)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7C5A0F0)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7C59E60)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER_REMOVEALLCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x7C5A2F0)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER_SET_PROMOTERTEMPLATE_OFFSET UNITYSDK_OFFSET(0x7C5A6A0)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7C5A740)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x7C5A750)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7C5A760)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7C5A7D0)
#define MOLEMOLE_UIVHSPROMOTERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7C5A850)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSPromoterWidgetController_TypeDefinitionIndex = 76227;
