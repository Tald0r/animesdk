...
#define MOLEMOLE_DYNAMICBONEPARASWITCH_AWAKE_OFFSET UNITYSDK_OFFSET(0x139B1580)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_CHANGEIMMPART_OFFSET UNITYSDK_OFFSET(0x139B1190)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DEALDAMPINGUPDATE_OFFSET UNITYSDK_OFFSET(0x139B1810)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DEALELASTICITY_OFFSET UNITYSDK_OFFSET(0x139B1950)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DEALINERT_OFFSET UNITYSDK_OFFSET(0x139B1BD0)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DEALSTIFFNESS_OFFSET UNITYSDK_OFFSET(0x139B1A90)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DORECORD_OFFSET UNITYSDK_OFFSET(0x139B1300)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_SWITCHTOKEY_OFFSET UNITYSDK_OFFSET(0x139B0F90)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_TRYTEST_OFFSET UNITYSDK_OFFSET(0x139B0F20)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_UPDATE_OFFSET UNITYSDK_OFFSET(0x139B1700)
#define MOLEMOLE_DYNAMICBONEPARASWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x139B1D10)

namespace MoleMole
{
	inline static constexpr unsigned int DynamicBoneParaSwitch_TypeDefinitionIndex = 36731;
