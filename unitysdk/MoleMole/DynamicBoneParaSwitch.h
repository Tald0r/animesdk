...
#define MOLEMOLE_DYNAMICBONEPARASWITCH_AWAKE_OFFSET UNITYSDK_OFFSET(0x91A3B90)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_CHANGEIMMPART_OFFSET UNITYSDK_OFFSET(0x91A37A0)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DEALDAMPINGUPDATE_OFFSET UNITYSDK_OFFSET(0x91A3E20)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DEALELASTICITY_OFFSET UNITYSDK_OFFSET(0x91A3F60)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DEALINERT_OFFSET UNITYSDK_OFFSET(0x91A41E0)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DEALSTIFFNESS_OFFSET UNITYSDK_OFFSET(0x91A40A0)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_DORECORD_OFFSET UNITYSDK_OFFSET(0x91A3910)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_SWITCHTOKEY_OFFSET UNITYSDK_OFFSET(0x91A35A0)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_TRYTEST_OFFSET UNITYSDK_OFFSET(0x91A3530)
#define MOLEMOLE_DYNAMICBONEPARASWITCH_UPDATE_OFFSET UNITYSDK_OFFSET(0x91A3D10)
#define MOLEMOLE_DYNAMICBONEPARASWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x91A4320)

namespace MoleMole
{
	inline static constexpr unsigned int DynamicBoneParaSwitch_TypeDefinitionIndex = 72982;
