...
#define MOLEMOLE_UIMAINCITYMINIMENUINPUTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA5ED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMiniMenuInputConfig_TypeDefinitionIndex = 62668;
