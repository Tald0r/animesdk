...
#define MOLEMOLE_UIMAINCITYMINIMENUINPUTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8702A10)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMiniMenuInputConfig_TypeDefinitionIndex = 54391;
