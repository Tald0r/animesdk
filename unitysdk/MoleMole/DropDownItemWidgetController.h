...
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER_GETINDEX_OFFSET UNITYSDK_OFFSET(0x9720A80)
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER_GETUITABBUTTON_OFFSET UNITYSDK_OFFSET(0x9720900)
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9720960)
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9720AF0)
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9720B20)

namespace MoleMole
{
	inline static constexpr unsigned int DropDownItemWidgetController_TypeDefinitionIndex = 63321;
