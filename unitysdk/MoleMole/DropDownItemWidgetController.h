...
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER_GETINDEX_OFFSET UNITYSDK_OFFSET(0xB0AFC20)
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER_GETUITABBUTTON_OFFSET UNITYSDK_OFFSET(0xB0AFAA0)
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB0AFB00)
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB0AFC90)
#define MOLEMOLE_DROPDOWNITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB0AFCC0)

namespace MoleMole
{
	inline static constexpr unsigned int DropDownItemWidgetController_TypeDefinitionIndex = 48332;

	class DropDownItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Int32 _index; // 0x2A0
		::MoleMole::UIGeneralDropdownOptionContext* _dropdownContext; // 0x2A8
