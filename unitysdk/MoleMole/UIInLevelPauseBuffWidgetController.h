...
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_INITMONSTERINFO_OFFSET UNITYSDK_OFFSET(0xA1DB9A0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_INITROLEBTN_OFFSET UNITYSDK_OFFSET(0xA1DBE60)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ISMONSTERBOSS_OFFSET UNITYSDK_OFFSET(0xA1DD860)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONCLICKDROPDOWN_OFFSET UNITYSDK_OFFSET(0xA1DC8F0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA1DC850)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONDROPDOWNCHANGE_OFFSET UNITYSDK_OFFSET(0xA1DCD10)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA1DD750)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA1DB670)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA1DB710)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_REFRESHAVATARSKILLINFO_OFFSET UNITYSDK_OFFSET(0xA1DDAF0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_REFRESHBUFFINFO_OFFSET UNITYSDK_OFFSET(0xA1DE2B0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_SETSELECTEDAVATARID_OFFSET UNITYSDK_OFFSET(0xA1DDF10)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_SWITCHSELECTEDAVATAR_OFFSET UNITYSDK_OFFSET(0xA1DD0B0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_SWITCHSELECTEDMONSTER_OFFSET UNITYSDK_OFFSET(0xA1DD180)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_TRYHANDLEGAMEPADSELECT_OFFSET UNITYSDK_OFFSET(0xA1DF620)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA1DFA20)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA1DF860)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__INITROLEBTN_B__10_0_OFFSET UNITYSDK_OFFSET(0xA1DFA90)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0xA1DFA80)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA1DFAA0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA1DFB10)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA1DFB90)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA1DFBF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBuffWidgetController_TypeDefinitionIndex = 48199;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseBuffWidgetController_TypeDefinitionIndex)->GetStaticField(0x38D20);
		}
		static ::System::String** StaticGet_BOSS_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseBuffWidgetController_TypeDefinitionIndex)->GetStaticField(0x38D28);
		}
		static ::System::Int32* StaticGet_MAX_AVATAR_NUM()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseBuffWidgetController_TypeDefinitionIndex)->GetStaticField(0xE130);
		}
		::Class_2_938422ACC5F2A616* _view; // 0x2A0
		::System::Collections::Generic::List_1<::Foundation::Coroutine::CoroutineHandle>* handleList; // 0x2A8
		::System::Collections::Generic::List_1<::MoleMole::UIInLevelPauseBuffRowWidgetController*>* _buffRowList; // 0x2B0
		::System::UInt32 _curEntity; // 0x2B8
		::MoleMole::UIInLevelPauseBuffWidgetController_EShowType _curType; // 0x2BC
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* _showAvatars; // 0x2C0
		::MoleMole::Battle::Entity* _showMonster; // 0x2C8
		::MoleMole::UIGeneralDynamicTipsPopWindowController* _dropDown; // 0x2D0
		::System::Collections::Generic::List_1<::System::Int32>* _showBuffIDs; // 0x2D8
