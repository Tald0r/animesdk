...
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_INITMONSTERINFO_OFFSET UNITYSDK_OFFSET(0x9D6E740)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_INITROLEBTN_OFFSET UNITYSDK_OFFSET(0x9D6EC00)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ISMONSTERBOSS_OFFSET UNITYSDK_OFFSET(0x9D70550)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONCLICKDROPDOWN_OFFSET UNITYSDK_OFFSET(0x9D6F690)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9D6F5F0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONDROPDOWNCHANGE_OFFSET UNITYSDK_OFFSET(0x9D6FAB0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9D70440)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9D6E410)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9D6E4B0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_REFRESHAVATARSKILLINFO_OFFSET UNITYSDK_OFFSET(0x9D707E0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_REFRESHBUFFINFO_OFFSET UNITYSDK_OFFSET(0x9D70FA0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_SETSELECTEDAVATARID_OFFSET UNITYSDK_OFFSET(0x9D70C00)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_SWITCHSELECTEDAVATAR_OFFSET UNITYSDK_OFFSET(0x9D6FE50)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_SWITCHSELECTEDMONSTER_OFFSET UNITYSDK_OFFSET(0x9D6FF20)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER_TRYHANDLEGAMEPADSELECT_OFFSET UNITYSDK_OFFSET(0x9D721A0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9D725A0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D723E0)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__INITROLEBTN_B__10_0_OFFSET UNITYSDK_OFFSET(0x9D72610)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0x9D72600)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9D72620)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9D72690)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9D72710)
#define MOLEMOLE_UIINLEVELPAUSEBUFFWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9D72770)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBuffWidgetController_TypeDefinitionIndex = 68423;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseBuffWidgetController_TypeDefinitionIndex)->GetStaticField(0x3B940);
		}
		static ::System::String** StaticGet_AVATAR_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseBuffWidgetController_TypeDefinitionIndex)->GetStaticField(0x3B948);
		}
		static ::System::Int32* StaticGet_MAX_AVATAR_NUM()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelPauseBuffWidgetController_TypeDefinitionIndex)->GetStaticField(0xE750);
		}
