...
#define MOLEMOLE_NPCPROTOTYPEDATAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB867CD0)

namespace MoleMole
{
	inline static constexpr unsigned int NpcPrototypeDataInfo_TypeDefinitionIndex = 81173;
