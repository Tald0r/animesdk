...
#define MOLEMOLE_NPCPROTOTYPEDATAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB2F3300)

namespace MoleMole
{
	inline static constexpr unsigned int NpcPrototypeDataInfo_TypeDefinitionIndex = 53893;
