...
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_EXITGAME_OFFSET UNITYSDK_OFFSET(0x9905500)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_FINISHFADEINANDFADEOUT_OFFSET UNITYSDK_OFFSET(0x9905810)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_GETBUBBLEWIDGET_OFFSET UNITYSDK_OFFSET(0x9905C10)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_GETQUESTID_OFFSET UNITYSDK_OFFSET(0x9904D10)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_GET_ISGAMEPAUSED_OFFSET UNITYSDK_OFFSET(0x9904110)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0x9904080)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9904090)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_INITIALIZENEWSBUBBLE_OFFSET UNITYSDK_OFFSET(0x9905B40)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_OPENBUBBLEROW_OFFSET UNITYSDK_OFFSET(0x9905C80)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_OPENPAUSEDIALOG_OFFSET UNITYSDK_OFFSET(0x9904120)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_OPENSETTING_OFFSET UNITYSDK_OFFSET(0x9905370)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_OPENTUTORIAL_OFFSET UNITYSDK_OFFSET(0x99049D0)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_PLAYANDINVOKECALLBACK_OFFSET UNITYSDK_OFFSET(0x9905A80)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_RESTARTGAME_OFFSET UNITYSDK_OFFSET(0x9905780)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_SETGAMEPAUSESTATE_OFFSET UNITYSDK_OFFSET(0x9904850)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_SETLEVELEND_OFFSET UNITYSDK_OFFSET(0x99040A0)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x9904380)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_TRYCONTINUEGAME_OFFSET UNITYSDK_OFFSET(0x9904F40)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER_TRYPAUSEGAME_OFFSET UNITYSDK_OFFSET(0x9904450)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9905E00)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9905DF0)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER__EXITGAME_G__EXIT_21_0_OFFSET UNITYSDK_OFFSET(0x9905F50)
#define MOLEMOLE_UISUMMEREVENTMAINPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x9905FD0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerEventMainPageController_TypeDefinitionIndex = 48403;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(UISummerEventMainPageController_TypeDefinitionIndex)->GetStaticField(0x452F0);
		}
