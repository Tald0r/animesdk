...
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9D8FD40)
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS18_0__FADEOUT_B__0_OFFSET UNITYSDK_OFFSET(0x9D8FD50)
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS18_0__FADEOUT_B__1_OFFSET UNITYSDK_OFFSET(0x9D8FDB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTipsWidgetController___c__DisplayClass18_0_TypeDefinitionIndex = 54090;
