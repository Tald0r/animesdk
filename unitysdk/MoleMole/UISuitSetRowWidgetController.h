...
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_CLEARVIEW_OFFSET UNITYSDK_OFFSET(0xCA77610)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONCLICKBTN_OFFSET UNITYSDK_OFFSET(0xCA77BA0)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xCA77210)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA77050)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCA77C50)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCA773B0)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA772D0)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA76F00)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA76FA0)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_UPDATEDISPLAY_OFFSET UNITYSDK_OFFSET(0xCA776E0)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA77D80)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xCA77D90)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA77DA0)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCA77E10)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCA77E80)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA77F00)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA77F80)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA77FE0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuitSetRowWidgetController_TypeDefinitionIndex = 72387;
	...
	public:
		...
		::System::Int32 suitId; // 0x2D8
		::System::Boolean isSuitSelected; // 0x2DC
		::System::Int32 filterNum; // 0x2E0
		::System::Boolean showNum; // 0x2E4
		::System::Boolean showSelectIndex; // 0x2E5
		::System::Int32 selectIndex; // 0x2E8
		::System::Boolean useLockIcon; // 0x2EC
		::System::Boolean isDisable; // 0x2ED
		::System::Action_1<::System::Int32>* OnItemClick; // 0x2F0
