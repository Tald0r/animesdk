...
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_CLEARVIEW_OFFSET UNITYSDK_OFFSET(0x78FCEB0)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONCLICKBTN_OFFSET UNITYSDK_OFFSET(0x78FD430)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x78FCAB0)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x78FC8F0)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x78FD4E0)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x78FCC50)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x78FCB70)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x78FC7A0)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x78FC840)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER_UPDATEDISPLAY_OFFSET UNITYSDK_OFFSET(0x78FCF80)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x78FD610)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x78FD620)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x78FD630)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x78FD6A0)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x78FD710)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x78FD790)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x78FD810)
#define MOLEMOLE_UISUITSETROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x78FD870)

namespace MoleMole
{
	inline static constexpr unsigned int UISuitSetRowWidgetController_TypeDefinitionIndex = 37468;
