...
#define MOLEMOLE_HADALGUIDECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBA16E00)

namespace MoleMole
{
	inline static constexpr unsigned int HadalGuideContext_TypeDefinitionIndex = 54155;
