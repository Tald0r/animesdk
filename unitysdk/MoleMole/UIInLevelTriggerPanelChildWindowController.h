...
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_CHANGEMATERIAL_OFFSET UNITYSDK_OFFSET(0x9438BB0)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x9438AF0)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9437970)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x9437AF0)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x9437C10)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x94388D0)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9437980)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9437A20)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9438E00)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER__HANDLECUSTOMPROPERTY_B__16_0_OFFSET UNITYSDK_OFFSET(0x9438E10)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x9438F30)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9438F90)
#define MOLEMOLE_UIINLEVELTRIGGERPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9439000)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelTriggerPanelChildWindowController_TypeDefinitionIndex = 78991;
	...
	public:
		...
		::Class_2_BCA11629035BC7F2_1* _view; // 0x330
