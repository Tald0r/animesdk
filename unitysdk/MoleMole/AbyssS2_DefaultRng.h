...
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_GET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x94D99A0)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x94D99C0)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x94D9AD0)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTINT_OFFSET UNITYSDK_OFFSET(0x94D9A50)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTLONG_OFFSET UNITYSDK_OFFSET(0x94D9B50)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTUINT_OFFSET UNITYSDK_OFFSET(0x94D9BF0)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTULONG_OFFSET UNITYSDK_OFFSET(0x94D9C70)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_RANGEINT_OFFSET UNITYSDK_OFFSET(0x94D9CE0)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_SET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x94D99B0)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG__CTOR_OFFSET UNITYSDK_OFFSET(0x94D9960)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_DefaultRng_TypeDefinitionIndex = 77510;
