...
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_GET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x8481160)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x8481180)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x8481290)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTINT_OFFSET UNITYSDK_OFFSET(0x8481210)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTLONG_OFFSET UNITYSDK_OFFSET(0x8481310)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTUINT_OFFSET UNITYSDK_OFFSET(0x84813B0)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_NEXTULONG_OFFSET UNITYSDK_OFFSET(0x8481430)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_RANGEINT_OFFSET UNITYSDK_OFFSET(0x84814A0)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG_SET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x8481170)
#define MOLEMOLE_ABYSSS2_DEFAULTRNG__CTOR_OFFSET UNITYSDK_OFFSET(0x8481120)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_DefaultRng_TypeDefinitionIndex = 68799;
