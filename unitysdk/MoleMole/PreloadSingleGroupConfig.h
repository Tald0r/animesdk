...
#define MOLEMOLE_PRELOADSINGLEGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA60D460)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadSingleGroupConfig_TypeDefinitionIndex = 63976;
