...
#define MOLEMOLE_SPINESKELETONGRAPHICIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F3E740)

namespace MoleMole
{
	inline static constexpr unsigned int SpineSkeletonGraphicImage_TypeDefinitionIndex = 73765;
