...
#define MOLEMOLE_UILEVELRESULTV2_VR_BIGBOSSLONGFIGHT_PAGECONTROLLER_GET_REWARDBUFFGAMETAG_OFFSET UNITYSDK_OFFSET(0x68B7BF0)
#define MOLEMOLE_UILEVELRESULTV2_VR_BIGBOSSLONGFIGHT_PAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x68B7C00)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultV2_VR_BigBossLongFight_PageController_TypeDefinitionIndex = 41858;
