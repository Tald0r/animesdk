...
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_DEBUGSETCENTERMOVEAREASIZE_OFFSET UNITYSDK_OFFSET(0xAAAEE30)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_DEBUGSETDEADZONEPERCENT_OFFSET UNITYSDK_OFFSET(0xAAAED30)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_DEBUGSETDIRSHAREDANGLEVALUE_OFFSET UNITYSDK_OFFSET(0xAAAEDB0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_DEBUGSETJOYSTICKMOVETYPE_OFFSET UNITYSDK_OFFSET(0xAAAECC0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_DEBUGSETLEFTRIGHTANGLE_OFFSET UNITYSDK_OFFSET(0xAAAEEB0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_GETLOGICBUTTONINPUTTYPEBYDIR_OFFSET UNITYSDK_OFFSET(0xAAB11E0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_GET_VIRTUALAXIS2DINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xAAAD880)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_GET_VIRTUALDOWNINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xAAAD8A0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_GET_VIRTUALLEFTINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xAAAD8B0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_GET_VIRTUALRIGHTINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xAAAD8C0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_GET_VIRTUALUPINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xAAAD890)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAAAD870)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_INITDIRDATA_OFFSET UNITYSDK_OFFSET(0xAAAE0E0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_INITROOTPOSITION_OFFSET UNITYSDK_OFFSET(0xAAB0C20)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_INITVIEWCONTROL_OFFSET UNITYSDK_OFFSET(0xAAAEFF0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_INITVIRTUALJOYSTICKPARAM_OFFSET UNITYSDK_OFFSET(0xAAADD70)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_INTERNALTICK_OFFSET UNITYSDK_OFFSET(0xAAB0810)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_ISINDEADZONE_OFFSET UNITYSDK_OFFSET(0xAAAFD30)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xAAAE4E0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAAAE580)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_ONPOINTDOWN2UP_OFFSET UNITYSDK_OFFSET(0xAAB0F60)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xAAB0C90)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xAAB0ED0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_ONPREUPDATE_OFFSET UNITYSDK_OFFSET(0xAAB0780)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_ONROOTFIXEDCHANGED_OFFSET UNITYSDK_OFFSET(0xAAB1100)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAAAE600)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAAAD8D0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAAADF10)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_ONUNACTIVE_OFFSET UNITYSDK_OFFSET(0xAAB0660)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_ONVIRTUALJOYSTICKDIRSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xAAAF090)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_REFRESHROOTPOSITION_OFFSET UNITYSDK_OFFSET(0xAAB0330)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_REFRESHVIRTUALJOYSTICKDIRSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xAAAEB30)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_REFRESHVIRTUALJOYSTICKPARAM_OFFSET UNITYSDK_OFFSET(0xAAAEF50)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_RESETDIRDATA_OFFSET UNITYSDK_OFFSET(0xAAB0FD0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_RESETGRAPHICPOSITION_OFFSET UNITYSDK_OFFSET(0xAAAE960)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_RESETROOTPOSITION_OFFSET UNITYSDK_OFFSET(0xAAB1070)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_SETGRAPHICPOSITION_OFFSET UNITYSDK_OFFSET(0xAAAFA70)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_SETUICAMERARENDERTYPE_OFFSET UNITYSDK_OFFSET(0xAAADCA0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_SETVIRTUALJOYSTICKDIR_OFFSET UNITYSDK_OFFSET(0xAAAFEA0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_SETVIRTUALLOGICAXIS2D_OFFSET UNITYSDK_OFFSET(0xAAAF560)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_STOPMOVE_OFFSET UNITYSDK_OFFSET(0xAAAEA70)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_TRYGETCURRENTPOINTERID_OFFSET UNITYSDK_OFFSET(0xAAB0A00)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_TRYJOYSTICKMOVECLASSIC_OFFSET UNITYSDK_OFFSET(0xAAAF7C0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_TRYJOYSTICKMOVEMODERN_OFFSET UNITYSDK_OFFSET(0xAAAF2D0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_TRYJOYSTICKMOVE_OFFSET UNITYSDK_OFFSET(0xAAAF140)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAAB12E0)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAAB1450)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAAB1460)
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAAB1470)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirtualJoystickBaseController_TypeDefinitionIndex = 56698;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::Enum_3_D0F2373931CC685D, ::MoleMole::UIVirtualJoystickBaseController_DirData*>* _dirDataDict; // 0x378
