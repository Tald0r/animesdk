...
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__ONCLICKGETREWARD_ASYNC_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3993B0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER__ONCLICKGETREWARD_ASYNC_D__11_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelRewardRowWidgetController__OnClickGetReward_Async_d__11_TypeDefinitionIndex = 80167;
	...
	struct alignas(8) UICoopLevelRewardRowWidgetController__OnClickGetReward_Async_d__11
	{
		...
		::MoleMole::UICoopLevelRewardRowWidgetController___c__DisplayClass11_0* __8__1; // 0x18
