...
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB96FD30)
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB96FD40)
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB96FDB0)
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB96FE70)
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB96FF40)
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB96FF50)
#define MOLEMOLE_UIANTIQUEQUESTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB96FFC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAntiqueQuestPageController_TypeDefinitionIndex = 60902;
