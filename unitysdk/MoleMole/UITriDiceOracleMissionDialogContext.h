...
#define MOLEMOLE_UITRIDICEORACLEMISSIONDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCA83120)

namespace MoleMole
{
	inline static constexpr unsigned int UITriDiceOracleMissionDialogContext_TypeDefinitionIndex = 50244;
