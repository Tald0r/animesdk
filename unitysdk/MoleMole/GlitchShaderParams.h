...
#define MOLEMOLE_GLITCHSHADERPARAMS_AWAKE_OFFSET UNITYSDK_OFFSET(0xB19A460)
#define MOLEMOLE_GLITCHSHADERPARAMS_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xB19A650)
#define MOLEMOLE_GLITCHSHADERPARAMS_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xB19A4D0)
#define MOLEMOLE_GLITCHSHADERPARAMS_UPDATE_OFFSET UNITYSDK_OFFSET(0xB19A7A0)
#define MOLEMOLE_GLITCHSHADERPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xB19A810)

namespace MoleMole
{
	inline static constexpr unsigned int GlitchShaderParams_TypeDefinitionIndex = 66083;
