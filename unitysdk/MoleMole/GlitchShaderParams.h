...
#define MOLEMOLE_GLITCHSHADERPARAMS_AWAKE_OFFSET UNITYSDK_OFFSET(0x8B155D0)
#define MOLEMOLE_GLITCHSHADERPARAMS_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x8B157C0)
#define MOLEMOLE_GLITCHSHADERPARAMS_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x8B15640)
#define MOLEMOLE_GLITCHSHADERPARAMS_UPDATE_OFFSET UNITYSDK_OFFSET(0x8B15910)
#define MOLEMOLE_GLITCHSHADERPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x8B15980)

namespace MoleMole
{
	inline static constexpr unsigned int GlitchShaderParams_TypeDefinitionIndex = 42192;
