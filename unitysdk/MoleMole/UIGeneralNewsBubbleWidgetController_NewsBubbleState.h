...
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATE_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0xAC6C7B0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATE_ONCHANGESTATE_OFFSET UNITYSDK_OFFSET(0xAC6C7E0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATE_SET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0xAC6C7C0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xAC6C7D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleWidgetController_NewsBubbleState_TypeDefinitionIndex = 68355;
