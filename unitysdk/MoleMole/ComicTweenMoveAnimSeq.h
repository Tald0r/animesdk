...
#define MOLEMOLE_COMICTWEENMOVEANIMSEQ__CTOR_OFFSET UNITYSDK_OFFSET(0x1B184C20)

namespace MoleMole
{
	inline static constexpr unsigned int ComicTweenMoveAnimSeq_TypeDefinitionIndex = 30060;
