...
#define MOLEMOLE_COMICTWEENMOVEANIMSEQ__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB54200)

namespace MoleMole
{
	inline static constexpr unsigned int ComicTweenMoveAnimSeq_TypeDefinitionIndex = 29107;

	class ComicTweenMoveAnimSeq : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::ComicPartInfo*>* animInfo; // 0x10
		::System::String* animCurveKey; // 0x18
		::System::String* animSeqName; // 0x20
