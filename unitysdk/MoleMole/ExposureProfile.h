...
#define MOLEMOLE_EXPOSUREPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xC2B50D0)
#define MOLEMOLE_EXPOSUREPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xC2B5250)
#define MOLEMOLE_EXPOSUREPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0xC2B4FC0)
#define MOLEMOLE_EXPOSUREPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xC2B51B0)
#define MOLEMOLE_EXPOSUREPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xC2B4FB0)
#define MOLEMOLE_EXPOSUREPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2B53B0)
#define MOLEMOLE_EXPOSUREPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xC2B5440)
#define MOLEMOLE_EXPOSUREPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xC2B54B0)
#define MOLEMOLE_EXPOSUREPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xC2B5520)

namespace MoleMole
{
	inline static constexpr unsigned int ExposureProfile_TypeDefinitionIndex = 76050;
