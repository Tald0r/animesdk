...
#define MOLEMOLE_EXPOSUREPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xB8909A0)
#define MOLEMOLE_EXPOSUREPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xB890B20)
#define MOLEMOLE_EXPOSUREPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0xB890890)
#define MOLEMOLE_EXPOSUREPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xB890A80)
#define MOLEMOLE_EXPOSUREPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xB890880)
#define MOLEMOLE_EXPOSUREPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xB890C80)
#define MOLEMOLE_EXPOSUREPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xB890D10)
#define MOLEMOLE_EXPOSUREPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xB890D80)
#define MOLEMOLE_EXPOSUREPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xB890DF0)

namespace MoleMole
{
	inline static constexpr unsigned int ExposureProfile_TypeDefinitionIndex = 53392;
