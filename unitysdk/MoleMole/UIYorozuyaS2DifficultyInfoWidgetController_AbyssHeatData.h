...
#define MOLEMOLE_UIYOROZUYAS2DIFFICULTYINFOWIDGETCONTROLLER_ABYSSHEATDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA141230)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaS2DifficultyInfoWidgetController_AbyssHeatData_TypeDefinitionIndex = 76294;

	class UIYorozuyaS2DifficultyInfoWidgetController_AbyssHeatData : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_495* config; // 0x10
