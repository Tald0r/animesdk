...
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___C__DISPLAYCLASS21_0__BUILDVIEWMODELDATABINDING_FLOWERSTATEEXT_B__0_OFFSET UNITYSDK_OFFSET(0xA8FFE60)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___C__DISPLAYCLASS21_0__BUILDVIEWMODELDATABINDING_FLOWERSTATEEXT_B__1_OFFSET UNITYSDK_OFFSET(0xA9001A0)
#define MOLEMOLE_UIFLOWERMAINPAGECONTROLLER___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA8FBB60)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMainPageController___c__DisplayClass21_0_TypeDefinitionIndex = 66256;
