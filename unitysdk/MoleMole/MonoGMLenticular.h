...
#define MOLEMOLE_MONOGMLENTICULAR_AWAKE_OFFSET UNITYSDK_OFFSET(0xA030480)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xA034060)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_1_OFFSET UNITYSDK_OFFSET(0xA033AD0)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_2_OFFSET UNITYSDK_OFFSET(0xA033CB0)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_3_OFFSET UNITYSDK_OFFSET(0xA033E80)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_4_OFFSET UNITYSDK_OFFSET(0xA034090)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_5_OFFSET UNITYSDK_OFFSET(0xA034270)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_6_OFFSET UNITYSDK_OFFSET(0xA034440)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_7_OFFSET UNITYSDK_OFFSET(0xA034620)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_8_OFFSET UNITYSDK_OFFSET(0xA0347F0)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_9_OFFSET UNITYSDK_OFFSET(0xA034A10)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_A5ADA4706DA592FA_OFFSET UNITYSDK_OFFSET(0xA033900)
#define MOLEMOLE_MONOGMLENTICULAR_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA0349D0)
#define MOLEMOLE_MONOGMLENTICULAR_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA031310)
#define MOLEMOLE_MONOGMLENTICULAR_OPENGMLENTICULAR_OFFSET UNITYSDK_OFFSET(0xA032AC0)
#define MOLEMOLE_MONOGMLENTICULAR_RESETDATA_OFFSET UNITYSDK_OFFSET(0xA031380)
#define MOLEMOLE_MONOGMLENTICULAR_UPDATEFINALINPUTVIEW_OFFSET UNITYSDK_OFFSET(0xA033470)
#define MOLEMOLE_MONOGMLENTICULAR_UPDATEGYROSCOPEVIEW_OFFSET UNITYSDK_OFFSET(0xA032B60)
#define MOLEMOLE_MONOGMLENTICULAR_UPDATESTICKVIEW_OFFSET UNITYSDK_OFFSET(0xA033000)
#define MOLEMOLE_MONOGMLENTICULAR__CTOR_OFFSET UNITYSDK_OFFSET(0xA0338E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGMLenticular_TypeDefinitionIndex = 71855;
	...
	public:
		...
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(MonoGMLenticular_TypeDefinitionIndex)->GetStaticField(0x393B0);
		}
