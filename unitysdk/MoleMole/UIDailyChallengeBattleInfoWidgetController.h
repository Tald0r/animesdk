...
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_ADDITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xC609F10)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_FILLCARDLIST_OFFSET UNITYSDK_OFFSET(0xC6097D0)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_FILLREWARDMAP_OFFSET UNITYSDK_OFFSET(0xC609970)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_GETMACHINELEVELID_OFFSET UNITYSDK_OFFSET(0xC609640)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0xC609110)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC609FE0)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER__GETPROGRESS_G__GETCURPROGRESS_0_0_OFFSET UNITYSDK_OFFSET(0xC6093E0)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER__GETPROGRESS_G__GETTOTALNUM_0_1_OFFSET UNITYSDK_OFFSET(0xC609500)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER___BASE_GETMACHINELEVELID_OFFSET UNITYSDK_OFFSET(0xC609FF0)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER___BASE_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0xC60A050)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyChallengeBattleInfoWidgetController_TypeDefinitionIndex = 73935;
