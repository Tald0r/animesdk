...
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_ADDITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x8BCC550)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_FILLCARDLIST_OFFSET UNITYSDK_OFFSET(0x8BCBE10)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_FILLREWARDMAP_OFFSET UNITYSDK_OFFSET(0x8BCBFB0)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_GETMACHINELEVELID_OFFSET UNITYSDK_OFFSET(0x8BCBC80)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x8BCB750)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8BCC620)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER__GETPROGRESS_G__GETCURPROGRESS_0_0_OFFSET UNITYSDK_OFFSET(0x8BCBA20)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER__GETPROGRESS_G__GETTOTALNUM_0_1_OFFSET UNITYSDK_OFFSET(0x8BCBB40)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER___BASE_GETMACHINELEVELID_OFFSET UNITYSDK_OFFSET(0x8BCC630)
#define MOLEMOLE_UIDAILYCHALLENGEBATTLEINFOWIDGETCONTROLLER___BASE_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x8BCC690)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyChallengeBattleInfoWidgetController_TypeDefinitionIndex = 65145;
