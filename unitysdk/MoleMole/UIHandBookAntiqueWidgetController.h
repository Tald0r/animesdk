...
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER_ONAFTERREFRESHALL_OFFSET UNITYSDK_OFFSET(0x7F61470)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F608B0)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER_ONGOTOBUTTON_OFFSET UNITYSDK_OFFSET(0x7F616F0)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER_ONINFOBUTTON_OFFSET UNITYSDK_OFFSET(0x7F61820)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7F60DB0)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F60E30)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F602C0)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F60360)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER_REFRESHLEFTEXPINFO_OFFSET UNITYSDK_OFFSET(0x7F61660)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER_REFRESHLEVELINFO_OFFSET UNITYSDK_OFFSET(0x7F60F10)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER_SHOWPANEL_OFFSET UNITYSDK_OFFSET(0x7F60420)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F618C0)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F618F0)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7F61960)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F61970)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F619F0)
#define MOLEMOLE_UIHANDBOOKANTIQUEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F61A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookAntiqueWidgetController_TypeDefinitionIndex = 74537;

	class UIHandBookAntiqueWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_43* _view; // 0x2A0
