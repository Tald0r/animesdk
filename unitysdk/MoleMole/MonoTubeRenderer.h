...
#define MOLEMOLE_MONOTUBERENDERER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA475DB0)
#define MOLEMOLE_MONOTUBERENDERER_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0xA475A20)
#define MOLEMOLE_MONOTUBERENDERER_GETLENGTHATPOINT_OFFSET UNITYSDK_OFFSET(0xA475D10)
#define MOLEMOLE_MONOTUBERENDERER_GETROTATIONATPOINT_OFFSET UNITYSDK_OFFSET(0xA475C50)
#define MOLEMOLE_MONOTUBERENDERER_GET_CALCULATETANGENTS_OFFSET UNITYSDK_OFFSET(0xA4757B0)
#define MOLEMOLE_MONOTUBERENDERER_GET_EDGECOUNT_OFFSET UNITYSDK_OFFSET(0xA4756A0)
#define MOLEMOLE_MONOTUBERENDERER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0xA475A00)
#define MOLEMOLE_MONOTUBERENDERER_GET_MESH_OFFSET UNITYSDK_OFFSET(0xA475A10)
#define MOLEMOLE_MONOTUBERENDERER_GET_POINTS_OFFSET UNITYSDK_OFFSET(0xA475320)
#define MOLEMOLE_MONOTUBERENDERER_GET_RADIUSES_OFFSET UNITYSDK_OFFSET(0xA4754F0)
#define MOLEMOLE_MONOTUBERENDERER_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0xA475590)
#define MOLEMOLE_MONOTUBERENDERER_GET_UVANTISTRETCHING_OFFSET UNITYSDK_OFFSET(0xA475970)
#define MOLEMOLE_MONOTUBERENDERER_GET_UVRECT_OFFSET UNITYSDK_OFFSET(0xA4758C0)
#define MOLEMOLE_MONOTUBERENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA475A90)
#define MOLEMOLE_MONOTUBERENDERER_MARKDYNAMIC_OFFSET UNITYSDK_OFFSET(0xA475BC0)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0xA476420)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_630A3B9C63A23882_OFFSET UNITYSDK_OFFSET(0xA478C20)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0xA478010)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_C72B925A491E9859_OFFSET UNITYSDK_OFFSET(0xA477B30)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_CD9F3CEFB366C27A_OFFSET UNITYSDK_OFFSET(0xA4765C0)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0xA478310)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_DAEB67F34AF80609_OFFSET UNITYSDK_OFFSET(0xA4795D0)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_DE5BCBAF4D29B552_OFFSET UNITYSDK_OFFSET(0xA475480)
#define MOLEMOLE_MONOTUBERENDERER_METHOD_5_FA58824BA12F6F62_OFFSET UNITYSDK_OFFSET(0xA478FD0)
#define MOLEMOLE_MONOTUBERENDERER_SET_CALCULATETANGENTS_OFFSET UNITYSDK_OFFSET(0xA4757C0)
#define MOLEMOLE_MONOTUBERENDERER_SET_EDGECOUNT_OFFSET UNITYSDK_OFFSET(0xA4756B0)
#define MOLEMOLE_MONOTUBERENDERER_SET_POINTS_OFFSET UNITYSDK_OFFSET(0xA475330)
#define MOLEMOLE_MONOTUBERENDERER_SET_RADIUSES_OFFSET UNITYSDK_OFFSET(0xA475500)
#define MOLEMOLE_MONOTUBERENDERER_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0xA4755A0)
#define MOLEMOLE_MONOTUBERENDERER_SET_UVANTISTRETCHING_OFFSET UNITYSDK_OFFSET(0xA475980)
#define MOLEMOLE_MONOTUBERENDERER_SET_UVRECT_OFFSET UNITYSDK_OFFSET(0xA4758D0)
#define MOLEMOLE_MONOTUBERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0xA479550)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTubeRenderer_TypeDefinitionIndex = 58622;
