...
#define MOLEMOLE_CONFIGUICAMERATIMELINEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCDCDC30)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICameraTimelineData_TypeDefinitionIndex = 44786;
