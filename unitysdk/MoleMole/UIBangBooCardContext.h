...
#define MOLEMOLE_UIBANGBOOCARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB2A66A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooCardContext_TypeDefinitionIndex = 44757;

	class UIBangBooCardContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Func_1<::Class_0_16E4307DCC419505_177*>* OnPointerDown; // 0x28
		...
		::System::Int32 DeployCooldown; // 0x5C
		::System::Int32 TemplateID; // 0x60
		::System::Boolean IsRepeat; // 0x64
