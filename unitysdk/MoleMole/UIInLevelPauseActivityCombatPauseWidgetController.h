...
#define MOLEMOLE_UIINLEVELPAUSEACTIVITYCOMBATPAUSEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EFDA40)
#define MOLEMOLE_UIINLEVELPAUSEACTIVITYCOMBATPAUSEWIDGETCONTROLLER_REFRESHACTCHALLENGELIST_OFFSET UNITYSDK_OFFSET(0x8EFE840)
#define MOLEMOLE_UIINLEVELPAUSEACTIVITYCOMBATPAUSEWIDGETCONTROLLER_REFRESHACTVIEW_OFFSET UNITYSDK_OFFSET(0x8EFDF10)
#define MOLEMOLE_UIINLEVELPAUSEACTIVITYCOMBATPAUSEWIDGETCONTROLLER_REFRESHBUFFVIEW_OFFSET UNITYSDK_OFFSET(0x8EFE380)
#define MOLEMOLE_UIINLEVELPAUSEACTIVITYCOMBATPAUSEWIDGETCONTROLLER_REFRESHTITLEAREA_OFFSET UNITYSDK_OFFSET(0x8EFDC20)
#define MOLEMOLE_UIINLEVELPAUSEACTIVITYCOMBATPAUSEWIDGETCONTROLLER_SETBUFFCOUNT_OFFSET UNITYSDK_OFFSET(0x8EFE5F0)
#define MOLEMOLE_UIINLEVELPAUSEACTIVITYCOMBATPAUSEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8EFECC0)
#define MOLEMOLE_UIINLEVELPAUSEACTIVITYCOMBATPAUSEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EFEDA0)
#define MOLEMOLE_UIINLEVELPAUSEACTIVITYCOMBATPAUSEWIDGETCONTROLLER___BASE_REFRESHACTCHALLENGELIST_OFFSET UNITYSDK_OFFSET(0x8EFEE40)
#define MOLEMOLE_UIINLEVELPAUSEACTIVITYCOMBATPAUSEWIDGETCONTROLLER___BASE_REFRESHACTVIEW_OFFSET UNITYSDK_OFFSET(0x8EFEE50)
#define MOLEMOLE_UIINLEVELPAUSEACTIVITYCOMBATPAUSEWIDGETCONTROLLER___BASE_REFRESHTITLEAREA_OFFSET UNITYSDK_OFFSET(0x8EFEE60)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseActivityCombatPauseWidgetController_TypeDefinitionIndex = 62252;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_742*>* _buffInfos; // 0x2D8
