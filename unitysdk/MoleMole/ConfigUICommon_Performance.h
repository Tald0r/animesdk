...
#define MOLEMOLE_CONFIGUICOMMON_PERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xCDCF5C0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_Performance_TypeDefinitionIndex = 54846;
