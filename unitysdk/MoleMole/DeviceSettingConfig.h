...
#define MOLEMOLE_DEVICESETTINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE43AD80)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingConfig_TypeDefinitionIndex = 66607;
