...
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAB48DE0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS8_0__SHOWMISSIONFINISHANDSWITCHTOCURRENT_B__0_OFFSET UNITYSDK_OFFSET(0xAB48DF0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS8_0__SHOWMISSIONFINISHANDSWITCHTOCURRENT_B__1_OFFSET UNITYSDK_OFFSET(0xAB48EC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMissionWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 64041;
