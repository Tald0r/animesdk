...
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB6BEF60)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastTodoListPageContext_TypeDefinitionIndex = 62124;
