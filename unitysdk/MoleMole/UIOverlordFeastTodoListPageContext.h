...
#define MOLEMOLE_UIOVERLORDFEASTTODOLISTPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9E95EC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastTodoListPageContext_TypeDefinitionIndex = 37091;
