...
#define MOLEMOLE_UIOVERLORDFEASTNEWTIPSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC81EEB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastNewTipsContext_TypeDefinitionIndex = 71639;
	...
	public:
		...
		::System::Action* OnCloseWithoutJump; // 0x40
