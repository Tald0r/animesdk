...
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_GET_PLAYANIMWITHPARENT_OFFSET UNITYSDK_OFFSET(0x8CCB290)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8CCB3C0)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x8CCB5D0)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x8CCB560)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8CCB4F0)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8CCB460)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8CCB2A0)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8CCB340)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8CCB6E0)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8CCB710)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x8CCB780)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x8CCB7F0)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8CCB800)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8CCB810)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8CCB820)
#define MOLEMOLE_UIACTIVITYSIGNININFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8CCB880)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivitySignInInfoWidgetController_TypeDefinitionIndex = 50982;

	class UIActivitySignInInfoWidgetController : public ::MoleMole::ActivityGuideUIBaseWidgetController
	{
	public:
		::Class_2_1060F418DF0EA240* _view; // 0x2C8
