...
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER_NEEDPLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0xDEE9DB0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEE7F30)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER_ONLOCKCONTDOWNEND_OFFSET UNITYSDK_OFFSET(0xDEEA070)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0xDEE82D0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDEE8410)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEE81F0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEE7FD0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER_PLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0xDEE9EE0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER_PREPAREUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0xDEE8620)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0xDEE88D0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER_TRYPLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0xDEE9E50)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDEEA130)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER__ONLOCKCONTDOWNEND_B__16_0_OFFSET UNITYSDK_OFFSET(0xDEEA140)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEEA1E0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0xDEEA250)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDEEA2B0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEEA330)
#define MOLEMOLE_UIACTIVITYTEAMTRIALLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEEA3B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityTeamTrialListRowWidgetController_TypeDefinitionIndex = 78933;
