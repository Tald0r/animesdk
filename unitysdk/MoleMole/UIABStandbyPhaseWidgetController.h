...
class Class_2_C7387D40D4120A48_2_Class_2_EBD92CE648041B43;
...
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0xBD76090)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_CANCELSELECT_OFFSET UNITYSDK_OFFSET(0xBD77480)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_DRAGSTANDBYSLOT_OFFSET UNITYSDK_OFFSET(0xBD77A20)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GETPLAYERITEMMOVESCRIPT_OFFSET UNITYSDK_OFFSET(0xBD74C70)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GETSLIDERVALUE_OFFSET UNITYSDK_OFFSET(0xBD79360)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_BACKBTN_OFFSET UNITYSDK_OFFSET(0xBD75090)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0xBD75060)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_DRAGPIECE_OFFSET UNITYSDK_OFFSET(0xBD75040)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_ISSHOWDAMAGE_OFFSET UNITYSDK_OFFSET(0xBD7A220)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_LOCALGROUP_OFFSET UNITYSDK_OFFSET(0xBD750B0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_RIGHTINFOROOT_OFFSET UNITYSDK_OFFSET(0xBD79490)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_SHOPWIDGET_OFFSET UNITYSDK_OFFSET(0xBD73C80)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_GET_SHOWSTARTBTN_OFFSET UNITYSDK_OFFSET(0xBD75CB0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_HOVERONSTANDBYCTRL_OFFSET UNITYSDK_OFFSET(0xBD77BF0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ISINSELLAREA_OFFSET UNITYSDK_OFFSET(0xBD77030)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBD7A9B0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONBANGBOOREACHLIMIT_OFFSET UNITYSDK_OFFSET(0xBD77EE0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONCHILDGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xBD79C20)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD74DD0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONLEVELBTNCLICK_OFFSET UNITYSDK_OFFSET(0xBD78CE0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONSERVERSORT_OFFSET UNITYSDK_OFFSET(0xBD74920)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONSTAGECHANGE_OFFSET UNITYSDK_OFFSET(0xBD783F0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONSTARTBTNCLICK_OFFSET UNITYSDK_OFFSET(0xBD78020)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD74EB0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD73C90)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD745E0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_OPENCURPLAYERINFO_OFFSET UNITYSDK_OFFSET(0xBD79F60)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_REFRESHRIGHTAREA_OFFSET UNITYSDK_OFFSET(0xBD794C0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_REFRESHSTATPANEL_OFFSET UNITYSDK_OFFSET(0xBD7A350)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_SAVEFINALBATTLERESULT_OFFSET UNITYSDK_OFFSET(0xBD78710)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_SETLEVELBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xBD75A00)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_SETSELLPRICE_OFFSET UNITYSDK_OFFSET(0xBD77180)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_SETSLIDER_OFFSET UNITYSDK_OFFSET(0xBD791F0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_SET_DRAGPIECE_OFFSET UNITYSDK_OFFSET(0xBD75050)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TICKSTAT_OFFSET UNITYSDK_OFFSET(0xBD7A590)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TOGGLEBOTTOM_OFFSET UNITYSDK_OFFSET(0xBD750E0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TOGGLEPLAYERFOCUS_OFFSET UNITYSDK_OFFSET(0xBD79ED0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TOGGLEPLAYERINFO_OFFSET UNITYSDK_OFFSET(0xBD772D0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TOGGLESELLAREA_OFFSET UNITYSDK_OFFSET(0xBD76CF0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TOGGLESHOP_1_OFFSET UNITYSDK_OFFSET(0xBD78E00)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TOGGLESHOP_OFFSET UNITYSDK_OFFSET(0xBD77570)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER_TWEENSLIDER_OFFSET UNITYSDK_OFFSET(0xBD79030)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBD7AEB0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__ONBANGBOOREACHLIMIT_B__52_0_OFFSET UNITYSDK_OFFSET(0xBD7B290)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__ONSTARTBTNCLICK_B__56_0_OFFSET UNITYSDK_OFFSET(0xBD7B3C0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__ONUIOPEN_B__27_0_OFFSET UNITYSDK_OFFSET(0xBD7B000)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__OPENCURPLAYERINFO_B__69_0_OFFSET UNITYSDK_OFFSET(0xBD7B3E0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__TOGGLESELLAREA_B__44_0_OFFSET UNITYSDK_OFFSET(0xBD7B220)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER__TWEENSLIDER_B__60_0_OFFSET UNITYSDK_OFFSET(0xBD7B3D0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD7B460)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD7B4D0)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD7B550)
#define MOLEMOLE_UIABSTANDBYPHASEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD7B5B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIABStandbyPhaseWidgetController_TypeDefinitionIndex = 39592;

	class UIABStandbyPhaseWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_C7387D40D4120A48_2* _view; // 0x2A0
		...
		::Class_2_C7387D40D4120A48_2_Class_2_EBD92CE648041B43* _lvlBtn; // 0x2D0
