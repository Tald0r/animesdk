...
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ACCESSOR_GETDATABYWEATHER_OFFSET UNITYSDK_OFFSET(0xC323C50)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ACCESSOR_METHOD_5_0B7E3489D2C0938B_OFFSET UNITYSDK_OFFSET(0xC323DA0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ACCESSOR_METHOD_5_543F8938BA868A0C_OFFSET UNITYSDK_OFFSET(0xC324010)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ACCESSOR_START_OFFSET UNITYSDK_OFFSET(0xC323D30)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ACCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC324240)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTerrainZoneVoxel_Accessor_TypeDefinitionIndex = 71165;
