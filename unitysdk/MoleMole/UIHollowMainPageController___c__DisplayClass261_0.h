...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS261_0__CAMERASTRETCHBACKWARD_B__0_OFFSET UNITYSDK_OFFSET(0xE282300)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS261_0__CTOR_OFFSET UNITYSDK_OFFSET(0xE26CE40)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController___c__DisplayClass261_0_TypeDefinitionIndex = 52598;
