...
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_AUTOPUSHINNER_OFFSET UNITYSDK_OFFSET(0xC8245C0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CHANGEGUESTPLATE_OFFSET UNITYSDK_OFFSET(0xC827E80)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CHANGEMODULESTATE_OFFSET UNITYSDK_OFFSET(0xC821BF0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CLEARDRAGDATA_OFFSET UNITYSDK_OFFSET(0xC821B30)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CREATEFUNC_OFFSET UNITYSDK_OFFSET(0xC8233D0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CREATENEWDISHOBJECT_OFFSET UNITYSDK_OFFSET(0xC824AA0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CREATEPREORDERDISHOBJECT_OFFSET UNITYSDK_OFFSET(0xC828710)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ENDDRAG_OFFSET UNITYSDK_OFFSET(0xC822570)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETDISHITEMCONTEXT_OFFSET UNITYSDK_OFFSET(0xC823E00)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETDISHITEMLISTINDEX_OFFSET UNITYSDK_OFFSET(0xC828FD0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETGUESTDELICIOUSNESS_OFFSET UNITYSDK_OFFSET(0xC82AB80)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETGUESTHEALTH_OFFSET UNITYSDK_OFFSET(0xC82AD60)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETITEMWIDGET_OFFSET UNITYSDK_OFFSET(0xC824160)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETOBJECTCONTROL_OFFSET UNITYSDK_OFFSET(0xC829420)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GETREALINDEX_OFFSET UNITYSDK_OFFSET(0xC8236E0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xC81EEC0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC81EED0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ISGUESTHAVESPECIFICDISHID_OFFSET UNITYSDK_OFFSET(0xC82AF40)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_MODIFYFILLPERCENTCONTENT_OFFSET UNITYSDK_OFFSET(0xC82A240)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONBEGINDRAGCONTROL_OFFSET UNITYSDK_OFFSET(0xC829DA0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONCLICKOBJECT_OFFSET UNITYSDK_OFFSET(0xC829AE0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONCLICKREMOVE_OFFSET UNITYSDK_OFFSET(0xC829630)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xC827D30)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONCLOSEBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC82B390)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC81EEE0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONDELBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC82B450)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONDRAGCONTROL_OFFSET UNITYSDK_OFFSET(0xC829F40)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONDRAGCUREDITOBJECTCONSOLE_OFFSET UNITYSDK_OFFSET(0xC8223F0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONDRAGFROMCHILD_OFFSET UNITYSDK_OFFSET(0xC823550)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONDRAGSINGLEOBJECT_OFFSET UNITYSDK_OFFSET(0xC8231A0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xC82A020)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONEMPTYSUBMITTIPBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC8222E0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONENDDRAGCONTROL_OFFSET UNITYSDK_OFFSET(0xC82A0C0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xC82A1B0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC821160)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONNUMCHANGE_OFFSET UNITYSDK_OFFSET(0xC825450)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONSELECTCHILD_OFFSET UNITYSDK_OFFSET(0xC8238D0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONSTARTDRAG_OFFSET UNITYSDK_OFFSET(0xC829EA0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONSUBMITBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC82B040)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC822920)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC81EF80)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC81F510)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_REFRESHGUESTTABINFO_OFFSET UNITYSDK_OFFSET(0xC82A600)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_REFRESHITEMLIST_OFFSET UNITYSDK_OFFSET(0xC820AE0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_REFRESHSUBMITBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0xC82A3E0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_REFRESHTABINFO_OFFSET UNITYSDK_OFFSET(0xC81FF20)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_REMOVECURPLATEOBJ_OFFSET UNITYSDK_OFFSET(0xC823EF0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_RESORTITEMLIST_OFFSET UNITYSDK_OFFSET(0xC828E50)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_REVERTDRAGOP_OFFSET UNITYSDK_OFFSET(0xC8218C0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_SCREENTOWORLDPOS_OFFSET UNITYSDK_OFFSET(0xC829540)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_SETGUESTLIST_OFFSET UNITYSDK_OFFSET(0xC81FE00)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_SETREDGREENLIST_OFFSET UNITYSDK_OFFSET(0xC81FA10)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_SHOWBOTTOMTIP_OFFSET UNITYSDK_OFFSET(0xC824320)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_STARTDRAGCUREDITOBJECTCONSOLE_OFFSET UNITYSDK_OFFSET(0xC825120)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_STARTDRAGNEWOBJECT_OFFSET UNITYSDK_OFFSET(0xC823840)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_STARTDRAGSINGLEOBJECT_OFFSET UNITYSDK_OFFSET(0xC8290B0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_STARTEDITSINGLEOBJECT_OFFSET UNITYSDK_OFFSET(0xC824CF0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_STOPEDITSINGLEOBJECT_OFFSET UNITYSDK_OFFSET(0xC8297C0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC822D70)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC82B860)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER__ONDELBTNCLICK_B__75_0_OFFSET UNITYSDK_OFFSET(0xC82BFF0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER__ONNUMCHANGE_B__69_0_OFFSET UNITYSDK_OFFSET(0xC82BD10)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER__RESORTITEMLIST_B__43_0_OFFSET UNITYSDK_OFFSET(0xC82BA00)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER__SHOWBOTTOMTIP_B__80_0_OFFSET UNITYSDK_OFFSET(0xC82C070)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER__SHOWBOTTOMTIP_B__80_1_OFFSET UNITYSDK_OFFSET(0xC82C110)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC82C140)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC82C1B0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC82C1E0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC82C1F0)
#define MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC82C200)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastServePageController_TypeDefinitionIndex = 78930;
	...
	public:
		...
		::Class_2_208CC9941471731A_317* _gameConfig; // 0x310
		::Class_2_208CC9941471731A_762* _guestConfig; // 0x318
		...
		{
			return ((::MoleMole::ScrollViewItemWidgetController*(*)(::PVOID, ::Enum_3_B90C1A15EA6E3C2B, ::System::Func_1<::MoleMole::UIControlReference*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIOVERLORDFEASTSERVEPAGECONTROLLER_CREATEFUNC_OFFSET))(this, arg1, arg2);
		}
