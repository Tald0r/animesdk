...
#define MOLEMOLE_UISUMMEREVENTREWARDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCA780E0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerEventRewardContext_TypeDefinitionIndex = 55678;
