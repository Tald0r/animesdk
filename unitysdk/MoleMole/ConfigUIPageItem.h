...
#define MOLEMOLE_CONFIGUIPAGEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xF2E9720)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIPageItem_TypeDefinitionIndex = 80775;
