...
#define MOLEMOLE_CONFIGUIPAGEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x13FAF9F0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIPageItem_TypeDefinitionIndex = 42770;
