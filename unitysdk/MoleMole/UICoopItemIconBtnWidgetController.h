...
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xA52E4C0)
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA52DF30)
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER_UPDATENEWHINT_OFFSET UNITYSDK_OFFSET(0xA52E250)
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA52E740)
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER__ONCLICKITEM_B__2_0_OFFSET UNITYSDK_OFFSET(0xA52E760)
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xA52E770)
#define MOLEMOLE_UICOOPITEMICONBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA52E780)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopItemIconBtnWidgetController_TypeDefinitionIndex = 62158;
