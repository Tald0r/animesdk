...
#define MOLEMOLE_SUMMEREVENTTRIGGERABILITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x8A8D8E0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventTriggerAbilityParam_TypeDefinitionIndex = 44273;
