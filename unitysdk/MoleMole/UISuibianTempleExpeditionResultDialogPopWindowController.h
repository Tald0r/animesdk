...
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x86A1D80)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_GOACCESS_OFFSET UNITYSDK_OFFSET(0x86A3610)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONCLICKITEMBTN_OFFSET UNITYSDK_OFFSET(0x86A1FE0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x86A2340)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x86A23E0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x86A1D90)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x86A2160)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_PLAYSCORECHANGE_OFFSET UNITYSDK_OFFSET(0x86A32B0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_SETACCESS_OFFSET UNITYSDK_OFFSET(0x86A3500)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_SETAREA_OFFSET UNITYSDK_OFFSET(0x86A35A0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER_SETREAWRDLIST_OFFSET UNITYSDK_OFFSET(0x86A2470)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x86A36F0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__8_0_OFFSET UNITYSDK_OFFSET(0x86A3830)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER__ONUIOPEN_B__10_0_OFFSET UNITYSDK_OFFSET(0x86A3950)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER__ONUIOPEN_B__10_1_OFFSET UNITYSDK_OFFSET(0x86A39C0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x86A3A80)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x86A3AF0)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x86A3B00)
#define MOLEMOLE_UISUIBIANTEMPLEEXPEDITIONRESULTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x86A3B10)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleExpeditionResultDialogPopWindowController_TypeDefinitionIndex = 48416;

	class UISuibianTempleExpeditionResultDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79AE422BA06F6D26_131* _view; // 0x2F8
