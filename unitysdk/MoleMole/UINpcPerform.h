...
#define MOLEMOLE_UINPCPERFORM_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xB6B6E60)
#define MOLEMOLE_UINPCPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xB6B6E20)

namespace MoleMole
{
	inline static constexpr unsigned int UINpcPerform_TypeDefinitionIndex = 47721;
