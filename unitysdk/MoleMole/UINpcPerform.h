...
#define MOLEMOLE_UINPCPERFORM_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x9E8DDA0)
#define MOLEMOLE_UINPCPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x9E8DD60)

namespace MoleMole
{
	inline static constexpr unsigned int UINpcPerform_TypeDefinitionIndex = 52972;
