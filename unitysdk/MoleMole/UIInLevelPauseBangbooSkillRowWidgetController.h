...
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x6CA0F90)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6CA0E10)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6CA0EB0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6CA0CC0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6CA0D60)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x6CA1B40)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0x6CA1EF0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x6CA1570)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHTITLE_OFFSET UNITYSDK_OFFSET(0x6CA11F0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x6CA1AB0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_SETFOLD_OFFSET UNITYSDK_OFFSET(0x6CA2280)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6CA2720)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER__REFRESHINFO_B__7_0_OFFSET UNITYSDK_OFFSET(0x6CA2870)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER__REFRESHINFO_B__7_1_OFFSET UNITYSDK_OFFSET(0x6CA2910)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6CA2920)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6CA2990)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6CA2A10)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6CA2A70)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBangbooSkillRowWidgetController_TypeDefinitionIndex = 48216;

	class UIInLevelPauseBangbooSkillRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_94D5884806027679_2* _view; // 0x2A0
		::System::Boolean isFold; // 0x2A8
		::Class_1_893417714B2AA846* buddyData; // 0x2B0
		::Enum_3_9FBDB47166F97B2B skillType; // 0x2B8
		::Class_1_6D3ECB4C39924DFD* skillInfo; // 0x2C0
		::System::Boolean isBattleBuddy; // 0x2C8
		::System::Boolean isShowingAttribute; // 0x2C9
		::System::Collections::Generic::List_1<::MoleMole::UIRoleSkillInfoRowChildWindowController*>* _infoItemCtrlList; // 0x2D0
		::System::Collections::Generic::List_1<::MoleMole::UIRoleSkillAttributeRowChildWindowController*>* _attributeCtrlList; // 0x2D8
		::System::Collections::Generic::List_1<::Class_1_945ACFB1FEBC7A2C_1*>* cur_ls; // 0x2E0
