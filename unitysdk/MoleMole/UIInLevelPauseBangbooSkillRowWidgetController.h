...
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x6C972B0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C97130)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C971D0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6C96FE0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6C97080)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x6C97E50)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0x6C98200)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x6C97880)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESHTITLE_OFFSET UNITYSDK_OFFSET(0x6C97500)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x6C97DC0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER_SETFOLD_OFFSET UNITYSDK_OFFSET(0x6C98590)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6C98A30)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER__REFRESHINFO_B__7_0_OFFSET UNITYSDK_OFFSET(0x6C98B80)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER__REFRESHINFO_B__7_1_OFFSET UNITYSDK_OFFSET(0x6C98C20)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C98C30)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C98CA0)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6C98D20)
#define MOLEMOLE_UIINLEVELPAUSEBANGBOOSKILLROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6C98D80)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseBangbooSkillRowWidgetController_TypeDefinitionIndex = 55129;

	class UIInLevelPauseBangbooSkillRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_94D5884806027679_5* _view; // 0x2A0
		...
		::System::Collections::Generic::List_1<::Class_1_945ACFB1FEBC7A2C_5*>* cur_ls; // 0x2E0
