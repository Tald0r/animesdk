...
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xAB6B240)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER___C__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6B280)
#define MOLEMOLE_UIMINDSCAPECUTBGCONTROLLER___C__INITVIEW_B__29_0_OFFSET UNITYSDK_OFFSET(0xAB6B290)

namespace MoleMole
{
	inline static constexpr unsigned int UIMindscapeCutBgController___c_TypeDefinitionIndex = 40787;
	...
	public:
		...
		{
			return (::System::Comparison_1<::MoleMole::UIMindscapeLevelRowWidgetController*>**)Il2CppClass::FromTypeDefinitionIndex(UIMindscapeCutBgController___c_TypeDefinitionIndex)->GetStaticField(0x3D900);
		}
		static ::MoleMole::UIMindscapeCutBgController___c** StaticGet___9()
		{
			return (::MoleMole::UIMindscapeCutBgController___c**)Il2CppClass::FromTypeDefinitionIndex(UIMindscapeCutBgController___c_TypeDefinitionIndex)->GetStaticField(0x3D908);
		}
