...
#define MOLEMOLE_UISEARCHOBJECTPAGECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCA5DA00)

namespace MoleMole
{
	inline static constexpr unsigned int UISearchObjectPageControllerContext_TypeDefinitionIndex = 63258;
