...
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA39BE70)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_GET_MAT_OFFSET UNITYSDK_OFFSET(0xA39B960)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_GET_MONOEFFECT_OFFSET UNITYSDK_OFFSET(0xA39B950)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0xA39C560)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_3C081D06DA6B1B22_OFFSET UNITYSDK_OFFSET(0xA39BCB0)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xA39C230)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0xA39C4F0)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_B703CACAF2B5AD56_OFFSET UNITYSDK_OFFSET(0xA39BD50)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_D53907E5392D9A4E_OFFSET UNITYSDK_OFFSET(0xA39BB80)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_METHOD_2_EE4A13D362FE5804_OFFSET UNITYSDK_OFFSET(0xA39C3D0)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA39BF40)
#define MOLEMOLE_MATKEYPROPVALUEFADERBYINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xA39C220)

namespace MoleMole
{
	inline static constexpr unsigned int MatKeyPropValueFaderByIndex_TypeDefinitionIndex = 50777;
