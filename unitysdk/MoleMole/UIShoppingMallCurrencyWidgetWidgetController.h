...
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_GET_BGS_OFFSET UNITYSDK_OFFSET(0xA69F7A0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_GET_RIGHTROOTMODULE_OFFSET UNITYSDK_OFFSET(0xA6A01E0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_GET_ROOTMODULE_OFFSET UNITYSDK_OFFSET(0xA69F780)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA69F7C0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA69F9E0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_ONCLICKGOODS_OFFSET UNITYSDK_OFFSET(0xA6A1AD0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA69F830)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA6A0B10)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA6A0D30)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_ONSCROLLVIEWSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0xA6A0750)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA6A01F0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA69F930)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA6A0130)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_REFRESHJUMPTIP_OFFSET UNITYSDK_OFFSET(0xA6A10A0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0xA6A0320)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_RESETSELECTITEM_OFFSET UNITYSDK_OFFSET(0xA6A04C0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_SELECTJUMPITEM_OFFSET UNITYSDK_OFFSET(0xA6A1780)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_SET_BGS_OFFSET UNITYSDK_OFFSET(0xA69F7B0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_SET_ROOTMODULE_OFFSET UNITYSDK_OFFSET(0xA69F790)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA6A1BA0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER__INITVIEW_B__23_0_OFFSET UNITYSDK_OFFSET(0xA6A1C20)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER__INITVIEW_B__23_1_OFFSET UNITYSDK_OFFSET(0xA6A1CB0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA6A1D30)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER___BASE_ONGAMEPADMODULEDESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA6A1DA0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA6A1E20)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA6A1EA0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA6A1EB0)
#define MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA6A1F10)

namespace MoleMole
{
	inline static constexpr unsigned int UIShoppingMallCurrencyWidgetWidgetController_TypeDefinitionIndex = 46042;

	class UIShoppingMallCurrencyWidgetWidgetController : public ::MoleMole::UIShoppingMallRightBaseController
	{
	public:
		::MonoUITableScrollV2* _Goods_ScrollView; // 0x2A8
		::MonoUITableScrollV2* _Goods_ScrollView_Bg; // 0x2B0
		::MoleMole::MonoGamepadModule* _RootModule_k__BackingField; // 0x2B8
		::Class_0_16E4307DCC419505_133* oldGoods; // 0x2C0
		::MoleMole::ShoppingMallCurrencyContext* _context; // 0x2C8
		::System::Boolean _isShowJumpTip; // 0x2D0
		::System::Int32 _jumpTipItemIndex; // 0x2D4
		::System::Collections::Generic::List_1<::MoleMole::UIShoppingMallCurrencyWidgetWidgetController_BgData>* _Bgs_k__BackingField; // 0x2D8
		...
		{
			return ((::Class_2_EC28E1D3A39EE7DE_12*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISHOPPINGMALLCURRENCYWIDGETWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
