...
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xAD536E0)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_INVOKECLICK_OFFSET UNITYSDK_OFFSET(0xAD55420)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD539C0)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD53A60)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD53550)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xAD55560)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_REFRESHMUTE_OFFSET UNITYSDK_OFFSET(0xAD54A80)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAD53C70)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_SETBANGBOOSTATE_OFFSET UNITYSDK_OFFSET(0xAD55B60)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_SETCLICKFUNCTION_OFFSET UNITYSDK_OFFSET(0xAD553B0)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_SETEFFECT_OFFSET UNITYSDK_OFFSET(0xAD54540)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_SETEMPTYBG_OFFSET UNITYSDK_OFFSET(0xAD544B0)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_SETMOREINFO_OFFSET UNITYSDK_OFFSET(0xAD55C40)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_SETSTATE_OFFSET UNITYSDK_OFFSET(0xAD55620)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAD55200)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD55EC0)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER__INITVIEW_B__15_0_OFFSET UNITYSDK_OFFSET(0xAD55EF0)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD56030)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD560A0)
#define MOLEMOLE_UIHOLLOWCARDITEMBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD56120)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardItemBtnWidgetController_TypeDefinitionIndex = 62079;
