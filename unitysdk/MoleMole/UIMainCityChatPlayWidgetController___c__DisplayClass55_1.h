...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_1__CTOR_OFFSET UNITYSDK_OFFSET(0xA65DF40)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_1__SHOWQUESTRECOMMEND_B__4_OFFSET UNITYSDK_OFFSET(0xA65DF50)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_1__SHOWQUESTRECOMMEND_B__5_OFFSET UNITYSDK_OFFSET(0xA65E090)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS55_1__SHOWQUESTRECOMMEND_B__6_OFFSET UNITYSDK_OFFSET(0xA65E1E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass55_1_TypeDefinitionIndex = 53830;
