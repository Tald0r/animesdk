...
#define MOLEMOLE_SUIBIANDEVELOPRIGHTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA540ED0)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianDevelopRightContext_TypeDefinitionIndex = 47176;
