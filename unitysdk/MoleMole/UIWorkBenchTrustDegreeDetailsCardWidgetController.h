...
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_AFTERTEMPLATECHANGE_OFFSET UNITYSDK_OFFSET(0xA137640)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_BINDEVENT_BUTTON_OFFSET UNITYSDK_OFFSET(0xA1364B0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0xA1366C0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_GET_TEMPLATE_OFFSET UNITYSDK_OFFSET(0xA1380E0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_ONCLICKBASEINFOBUTTON_OFFSET UNITYSDK_OFFSET(0xA136840)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_ONCLICKDETAILBUTTON_OFFSET UNITYSDK_OFFSET(0xA137430)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_ONCLICKMEMORYBUTTON_OFFSET UNITYSDK_OFFSET(0xA137220)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA136AC0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_ONFOCUS_OFFSET UNITYSDK_OFFSET(0xA136C40)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA136B60)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA1363E0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0xA137FB0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_REFRESHCHILDWIDGETFOCUSSTATE_OFFSET UNITYSDK_OFFSET(0xA136CB0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA137710)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER_SET_TEMPLATE_OFFSET UNITYSDK_OFFSET(0xA1380F0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA138300)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER__PLAYANIM_B__12_0_OFFSET UNITYSDK_OFFSET(0xA138340)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER__PLAYANIM_B__12_1_OFFSET UNITYSDK_OFFSET(0xA138350)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER__PLAYANIM_B__12_2_OFFSET UNITYSDK_OFFSET(0xA1383D0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER__SET_TEMPLATE_G__GETSERVERPARTNERDATA_17_0_OFFSET UNITYSDK_OFFSET(0xA138220)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA1383E0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA138450)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA1384D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchTrustDegreeDetailsCardWidgetController_TypeDefinitionIndex = 41061;

	class UIWorkBenchTrustDegreeDetailsCardWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_30* _view; // 0x2A0
		...
		static ::Class_3_BD5405822947C18D* _set_template_g__GetServerPartnerData_17_0(::MoleMole::UIWorkBenchTrustDegreeDetailsCardWidgetController___c__DisplayClass17_0& a1)
		{
			return ((::Class_3_BD5405822947C18D*(*)(::MoleMole::UIWorkBenchTrustDegreeDetailsCardWidgetController___c__DisplayClass17_0&))((::PBYTE)hIl2Cpp + MOLEMOLE_UIWORKBENCHTRUSTDEGREEDETAILSCARDWIDGETCONTROLLER__SET_TEMPLATE_G__GETSERVERPARTNERDATA_17_0_OFFSET))(a1);
		}
