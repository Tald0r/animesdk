...
#define MOLEMOLE_COMMANDLINEMOTIONBLUR_METHOD_2_3807E61C224E8F21_OFFSET UNITYSDK_OFFSET(0x9B50E90)
#define MOLEMOLE_COMMANDLINEMOTIONBLUR_METHOD_2_ED15640EAB4A6A99_OFFSET UNITYSDK_OFFSET(0x9B50FD0)
#define MOLEMOLE_COMMANDLINEMOTIONBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x9B50F90)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineMotionBlur_TypeDefinitionIndex = 70943;
