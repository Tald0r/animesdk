...
#define MOLEMOLE_UICLOUDCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA52ACB0)
#define MOLEMOLE_UICLOUDCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA52AC10)
#define MOLEMOLE_UICLOUDCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA52AD50)

namespace MoleMole
{
	inline static constexpr unsigned int UICloudController_TypeDefinitionIndex = 37912;
