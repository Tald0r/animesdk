...
#define MOLEMOLE_MOTIONBLURPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x6B17310)
#define MOLEMOLE_MOTIONBLURPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x6B17490)
#define MOLEMOLE_MOTIONBLURPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x6B17200)
#define MOLEMOLE_MOTIONBLURPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6B173F0)
#define MOLEMOLE_MOTIONBLURPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x6B171F0)
#define MOLEMOLE_MOTIONBLURPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x6B175F0)
#define MOLEMOLE_MOTIONBLURPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x6B17680)
#define MOLEMOLE_MOTIONBLURPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x6B176F0)
#define MOLEMOLE_MOTIONBLURPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6B17760)

namespace MoleMole
{
	inline static constexpr unsigned int MotionBlurProfile_TypeDefinitionIndex = 50524;
