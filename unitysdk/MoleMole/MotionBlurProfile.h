...
#define MOLEMOLE_MOTIONBLURPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xD4401D0)
#define MOLEMOLE_MOTIONBLURPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xD440350)
#define MOLEMOLE_MOTIONBLURPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0xD4400C0)
#define MOLEMOLE_MOTIONBLURPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xD4402B0)
#define MOLEMOLE_MOTIONBLURPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xD4400B0)
#define MOLEMOLE_MOTIONBLURPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xD4404B0)
#define MOLEMOLE_MOTIONBLURPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xD440540)
#define MOLEMOLE_MOTIONBLURPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xD4405B0)
#define MOLEMOLE_MOTIONBLURPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xD440620)

namespace MoleMole
{
	inline static constexpr unsigned int MotionBlurProfile_TypeDefinitionIndex = 71766;
