...
#define MOLEMOLE_UIFISHQUICKSELECTPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8077810)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishQuickSelectPopWindowContext_TypeDefinitionIndex = 65731;
