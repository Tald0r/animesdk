...
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xB0F8AB0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB0F90F0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB0F9190)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB0F8810)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER_SETAFTERHIDECALLBACK_OFFSET UNITYSDK_OFFSET(0xB0F9270)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB0F92E0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0xB0F9380)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB0F93B0)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB0F9420)
#define MOLEMOLE_UIGENERALSCROLLVIEWTESTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB0F94A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralScrollViewTestWidgetController_TypeDefinitionIndex = 41059;
