...
#define MOLEMOLE_UISOCIALCIRCLEMAIN_MAINWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAE653F0)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_MAINWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAE65460)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_MAINWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAE65560)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_MAINWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE65880)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_MAINWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAE658B0)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_MAINWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAE65920)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleMain_MainWidgetController_TypeDefinitionIndex = 50171;
