...
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_APPLYCHANGEDEPTH_OFFSET UNITYSDK_OFFSET(0x98DB700)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_CALCHANGEDEPTH_OFFSET UNITYSDK_OFFSET(0x98DB4E0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_CREATEBUDDYMODEL_OFFSET UNITYSDK_OFFSET(0x98DB000)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_CREATEBUDDY_OFFSET UNITYSDK_OFFSET(0x98DB8D0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_DESTROYALLBUDDIES_OFFSET UNITYSDK_OFFSET(0x98DA030)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_GETTVSCREEN_OFFSET UNITYSDK_OFFSET(0x98DA880)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_HIDETV_OFFSET UNITYSDK_OFFSET(0x98DC4A0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_INITBUDDYCAMERA_OFFSET UNITYSDK_OFFSET(0x98D9860)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x98D9BA0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98D9D10)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98D87D0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98D9C40)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_PLAYBUDDYANI_OFFSET UNITYSDK_OFFSET(0x98DB450)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_PLAYENTEREDITOREFFECT_OFFSET UNITYSDK_OFFSET(0x98DC770)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_PLAYEXITEDITOREFFECT_OFFSET UNITYSDK_OFFSET(0x98DC7D0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_PLAYFIRSTBUDDY_OFFSET UNITYSDK_OFFSET(0x98DADD0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_PLAYSWITCHBUDDY_OFFSET UNITYSDK_OFFSET(0x98DABD0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_REMOVEBUDDY_OFFSET UNITYSDK_OFFSET(0x98DC580)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_RESERGAMEPADCONTROL_OFFSET UNITYSDK_OFFSET(0x98DA400)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_SETBUDDYCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0x98DBDD0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_SETBUDDYEDITORCAMERAPOS_OFFSET UNITYSDK_OFFSET(0x98DBC00)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_SETBUDDYINITCAMERA_OFFSET UNITYSDK_OFFSET(0x98DC420)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_SETCURRENTBUDDY_OFFSET UNITYSDK_OFFSET(0x98DA900)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_SHOWTV_OFFSET UNITYSDK_OFFSET(0x98DBD00)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_TICKDEPTH_OFFSET UNITYSDK_OFFSET(0x98DA7E0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_TICKGAMEPADCONTROL_OFFSET UNITYSDK_OFFSET(0x98DA320)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x98DA4B0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98DC830)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x98DCA70)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98DCAE0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98DCAF0)
#define MOLEMOLE_UIMODIFICATIONSHOP3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98DCB00)

namespace MoleMole
{
	inline static constexpr unsigned int UIModificationShop3DModelController_TypeDefinitionIndex = 39043;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Struct_2_2D9FE49A93BEEC6D>* waitFadeActions; // 0x410
