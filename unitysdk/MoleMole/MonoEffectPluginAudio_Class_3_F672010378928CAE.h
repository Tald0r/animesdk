...
#define MOLEMOLE_MONOEFFECTPLUGINAUDIO_CLASS_3_F672010378928CAE_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xC2EC460)
#define MOLEMOLE_MONOEFFECTPLUGINAUDIO_CLASS_3_F672010378928CAE_READMEMBER_OFFSET UNITYSDK_OFFSET(0xC2EC470)
#define MOLEMOLE_MONOEFFECTPLUGINAUDIO_CLASS_3_F672010378928CAE_WRITE_OFFSET UNITYSDK_OFFSET(0xC2EC7F0)
#define MOLEMOLE_MONOEFFECTPLUGINAUDIO_CLASS_3_F672010378928CAE__CCTOR_OFFSET UNITYSDK_OFFSET(0xC2ECA60)
#define MOLEMOLE_MONOEFFECTPLUGINAUDIO_CLASS_3_F672010378928CAE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2ECA20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAudio_Class_3_F672010378928CAE_TypeDefinitionIndex = 58352;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigSoundActionGeneral*>**)Il2CppClass::FromTypeDefinitionIndex(MonoEffectPluginAudio_Class_3_F672010378928CAE_TypeDefinitionIndex)->GetStaticField(0x2FC70);
		}
