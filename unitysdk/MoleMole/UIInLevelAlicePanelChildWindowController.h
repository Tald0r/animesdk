...
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x8C4F5B0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_GET_PLACEHOLDERKEY_CURCHARGEPOINT_OFFSET UNITYSDK_OFFSET(0x8C4DC70)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_GET_PLACEHOLDERKEY_ISENHANCE_OFFSET UNITYSDK_OFFSET(0x8C4DCB0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_GET_PLACEHOLDERKEY_MAXCHARGEPOINT_OFFSET UNITYSDK_OFFSET(0x8C4DCF0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8C4DC60)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x8C4DF10)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x8C4E110)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_HANDLEITEMMAT_OFFSET UNITYSDK_OFFSET(0x8C4EC60)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_ISARRIVEMAXVALUE_OFFSET UNITYSDK_OFFSET(0x8C4EF20)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_ISITEMALREADYFADEIN_OFFSET UNITYSDK_OFFSET(0x8C4EBD0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_ISITEMFULL_OFFSET UNITYSDK_OFFSET(0x8C4F010)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x8C4F180)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C4DD30)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C4DDD0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C4F670)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x8C4F6E0)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C4F740)
#define MOLEMOLE_UIINLEVELALICEPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C4F7B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelAlicePanelChildWindowController_TypeDefinitionIndex = 70168;
