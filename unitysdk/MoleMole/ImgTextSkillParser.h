...
#define MOLEMOLE_IMGTEXTSKILLPARSER_METHOD_6_D2A6074756C9D648_OFFSET UNITYSDK_OFFSET(0xA7E09E0)
#define MOLEMOLE_IMGTEXTSKILLPARSER_METHOD_6_FDA1EA0B9E0923F3_OFFSET UNITYSDK_OFFSET(0xA7E1130)
#define MOLEMOLE_IMGTEXTSKILLPARSER_SETLEVEL_OFFSET UNITYSDK_OFFSET(0xA7E0970)
#define MOLEMOLE_IMGTEXTSKILLPARSER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA7E1230)
#define MOLEMOLE_IMGTEXTSKILLPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0xA7E1210)
#define MOLEMOLE_IMGTEXTSKILLPARSER___BASE_GETPARSEDTEXT_OFFSET UNITYSDK_OFFSET(0xA7E1310)

namespace MoleMole
{
	inline static constexpr unsigned int ImgTextSkillParser_TypeDefinitionIndex = 71419;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::ValueTuple_3<::System::Int32, ::System::Int32, ::System::String*>>**)Il2CppClass::FromTypeDefinitionIndex(ImgTextSkillParser_TypeDefinitionIndex)->GetStaticField(0x3B490);
		}
		static ::System::Text::RegularExpressions::Regex** StaticGet_Field_6_0()
		{
			return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(ImgTextSkillParser_TypeDefinitionIndex)->GetStaticField(0x3B498);
		}
