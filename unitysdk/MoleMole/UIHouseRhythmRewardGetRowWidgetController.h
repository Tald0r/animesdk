...
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x893E480)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x893E4F0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x893E5B0)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x893E690)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x893E830)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x893E840)
#define MOLEMOLE_UIHOUSERHYTHMREWARDGETROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x893E8B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmRewardGetRowWidgetController_TypeDefinitionIndex = 77919;
