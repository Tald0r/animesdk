...
#define MOLEMOLE_UIGENERALITEMUSEDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9BE3AE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemUseDialogContext_TypeDefinitionIndex = 57460;
