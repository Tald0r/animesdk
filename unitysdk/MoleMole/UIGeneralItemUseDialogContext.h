...
#define MOLEMOLE_UIGENERALITEMUSEDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBFA8380)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemUseDialogContext_TypeDefinitionIndex = 78580;
	...
	public:
		...
		::System::Boolean showInputField; // 0x40
		::System::Int32 maxUseCount; // 0x44
