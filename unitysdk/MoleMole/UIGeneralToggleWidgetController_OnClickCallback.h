...
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONCLICKCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAA0BB60)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONCLICKCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAA0BBD0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONCLICKCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAA0B5C0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONCLICKCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAA0BB50)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralToggleWidgetController_OnClickCallback_TypeDefinitionIndex = 65858;
