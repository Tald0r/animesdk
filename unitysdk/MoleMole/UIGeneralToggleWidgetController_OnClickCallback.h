...
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONCLICKCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xF231EA0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONCLICKCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xF231F10)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONCLICKCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xF2318F0)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER_ONCLICKCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xF231E80)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralToggleWidgetController_OnClickCallback_TypeDefinitionIndex = 72432;
