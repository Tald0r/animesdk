...
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD5591B0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD559950)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD5599F0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD5591C0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD559420)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_UPDATECARD_OFFSET UNITYSDK_OFFSET(0xD559750)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD559AE0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER__UPDATECARD_G__SETNAME_10_0_OFFSET UNITYSDK_OFFSET(0xD559A80)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD559AF0)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD559B60)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD559B70)
#define MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD559B80)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleEliteExhibitionPopWindowController_TypeDefinitionIndex = 73895;
	...
	public:
		...
		::System::Void UpdateCard(::Class_2_208CC9941471731A_181* template_)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_181*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDOUBLEELITEEXHIBITIONPOPWINDOWCONTROLLER_UPDATECARD_OFFSET))(this, template_);
		}
