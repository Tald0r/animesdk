...
#define MOLEMOLE_UIFLOWERSHOPPREPPAGECONTROLLER_CONTEXT_GET_FLOWERSHOP3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0xD544970)
#define MOLEMOLE_UIFLOWERSHOPPREPPAGECONTROLLER_CONTEXT_SET_FLOWERSHOP3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0xD544980)
#define MOLEMOLE_UIFLOWERSHOPPREPPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD544990)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerShopPrepPageController_Context_TypeDefinitionIndex = 36622;
