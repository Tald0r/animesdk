...
#define MOLEMOLE_UIFLOWERSHOPPREPPAGECONTROLLER_CONTEXT_GET_FLOWERSHOP3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC0ED610)
#define MOLEMOLE_UIFLOWERSHOPPREPPAGECONTROLLER_CONTEXT_SET_FLOWERSHOP3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC0ED620)
#define MOLEMOLE_UIFLOWERSHOPPREPPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC0ED630)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerShopPrepPageController_Context_TypeDefinitionIndex = 59567;
