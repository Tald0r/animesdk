...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARASSEMBLYNPCGO_OFFSET UNITYSDK_OFFSET(0x8C40B00)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARAVATARVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x8C40120)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEAREFFECTENTITIES_OFFSET UNITYSDK_OFFSET(0x8C40DA0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARFILTER_OFFSET UNITYSDK_OFFSET(0x8C40D30)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARROLEINFO_1_OFFSET UNITYSDK_OFFSET(0x8C405B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARROLEINFO_OFFSET UNITYSDK_OFFSET(0x8C403A0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARUIWIDGET_OFFSET UNITYSDK_OFFSET(0x8C413C0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARWINKITEM_OFFSET UNITYSDK_OFFSET(0x8C40280)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEAR_OFFSET UNITYSDK_OFFSET(0x8C414B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ASSEMBLYNPCGO_OFFSET UNITYSDK_OFFSET(0x8C3F7B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_CHARACTERTEXTURESHEETNAME_OFFSET UNITYSDK_OFFSET(0x8C3F880)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_FACIALKEY_OFFSET UNITYSDK_OFFSET(0x8C3F760)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_FILTER_OFFSET UNITYSDK_OFFSET(0x8C3F8A0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_INITSHOWSETTING_OFFSET UNITYSDK_OFFSET(0x8C3F8C0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ISASSEMBLYNPC_OFFSET UNITYSDK_OFFSET(0x8C3F7D0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ISUSINGTEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x8C3F840)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ISVIDEO_OFFSET UNITYSDK_OFFSET(0x8C3F7A0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_POSEKEY_OFFSET UNITYSDK_OFFSET(0x8C3F740)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ROLEINFO_OFFSET UNITYSDK_OFFSET(0x8C3F720)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_TEXTURESHEETNODEPATH_OFFSET UNITYSDK_OFFSET(0x8C3F860)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_VIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x8C3F780)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_WINKITEM_OFFSET UNITYSDK_OFFSET(0x8C3F700)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_INITTEXTURESHEETUSING_OFFSET UNITYSDK_OFFSET(0x8C3F970)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETASSEMBLYNPCGO_OFFSET UNITYSDK_OFFSET(0x8C3FF50)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETAVATARVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x8C3FEE0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETEFFECTLIST_OFFSET UNITYSDK_OFFSET(0x8C3FCF0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETFACIALKEY_OFFSET UNITYSDK_OFFSET(0x8C40040)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETFILTER_OFFSET UNITYSDK_OFFSET(0x8C400B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETINITSHOWSETTING_OFFSET UNITYSDK_OFFSET(0x8C3F8E0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETPOSEKEY_OFFSET UNITYSDK_OFFSET(0x8C3FFD0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETROLEINFO_OFFSET UNITYSDK_OFFSET(0x8C3FE60)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETUIWIDGET_OFFSET UNITYSDK_OFFSET(0x8C3FD70)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETWINKITEM_OFFSET UNITYSDK_OFFSET(0x8C3FDE0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_ASSEMBLYNPCGO_OFFSET UNITYSDK_OFFSET(0x8C3F7C0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_CHARACTERTEXTURESHEETNAME_OFFSET UNITYSDK_OFFSET(0x8C3F890)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_FACIALKEY_OFFSET UNITYSDK_OFFSET(0x8C3F770)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_FILTER_OFFSET UNITYSDK_OFFSET(0x8C3F8B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_INITSHOWSETTING_OFFSET UNITYSDK_OFFSET(0x8C3F8D0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_ISUSINGTEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x8C3F850)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_POSEKEY_OFFSET UNITYSDK_OFFSET(0x8C3F750)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_ROLEINFO_OFFSET UNITYSDK_OFFSET(0x8C3F730)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_TEXTURESHEETNODEPATH_OFFSET UNITYSDK_OFFSET(0x8C3F870)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_VIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0x8C3F790)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_WINKITEM_OFFSET UNITYSDK_OFFSET(0x8C3F710)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_TRYRESETGENERALTEXTURESHEETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x8C40660)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x8C3F950)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController_AvatarDisplaySetting_TypeDefinitionIndex = 54685;
	...
	public:
		...
		::System::String* _facialKey_k__BackingField; // 0x18
		::MoleMole::AvatarShowSetting* _initShowSetting_k__BackingField; // 0x20
		::UnityEngine::GameObject* _assemblyNpcGO_k__BackingField; // 0x28
		::System::String* _poseKey_k__BackingField; // 0x30
		::MoleMole::UIWidgetController* uiWidget; // 0x38
		::MoleMole::IVideoPlayer* _videoPlayer_k__BackingField; // 0x40
		::MoleMole::UIGalgamePageController_UIRoleInfo* _roleInfo_k__BackingField; // 0x48
		::Class_1_9CFBC14B74B66E2C* _winkItem_k__BackingField; // 0x50
		::System::String* _CharacterTextureSheetName_k__BackingField; // 0x58
		::System::Action* OnClear; // 0x60
		::System::Collections::Generic::List_1<::MoleMole::EntityHandle>* longLiveEffectEntities; // 0x68
		::System::Action_1<::Class_1_9CFBC14B74B66E2C*>* winkItemRetrieveAction; // 0x70
		::System::String* _TextureSheetNodePath_k__BackingField; // 0x78
		::Class_1_39F32ADA6528F94C* _filter_k__BackingField; // 0x80
		::System::Boolean isAvatarShowing; // 0x88
		::System::Boolean _NPCGoUseSelfLightSetting; // 0x89
		::System::Boolean enableForbiddenMaterialEffect; // 0x8A
		::System::Boolean _IsUsingTextureSheet_k__BackingField; // 0x8B
		::System::UInt32 entityID; // 0x8C
		::System::Int32 emotionIdx; // 0x90
		::System::Int32 actorId; // 0x94
