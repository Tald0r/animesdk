...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARASSEMBLYNPCGO_OFFSET UNITYSDK_OFFSET(0xB0F1E10)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARAVATARVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0xB0F1430)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEAREFFECTENTITIES_OFFSET UNITYSDK_OFFSET(0xB0F20B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARFILTER_OFFSET UNITYSDK_OFFSET(0xB0F2040)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARROLEINFO_1_OFFSET UNITYSDK_OFFSET(0xB0F18C0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARROLEINFO_OFFSET UNITYSDK_OFFSET(0xB0F16B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARUIWIDGET_OFFSET UNITYSDK_OFFSET(0xB0F26D0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEARWINKITEM_OFFSET UNITYSDK_OFFSET(0xB0F1590)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_CLEAR_OFFSET UNITYSDK_OFFSET(0xB0F27C0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ASSEMBLYNPCGO_OFFSET UNITYSDK_OFFSET(0xB0F0AB0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_CHARACTERTEXTURESHEETNAME_OFFSET UNITYSDK_OFFSET(0xB0F0B80)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_FACIALKEY_OFFSET UNITYSDK_OFFSET(0xB0F0A60)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_FILTER_OFFSET UNITYSDK_OFFSET(0xB0F0BA0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_INITSHOWSETTING_OFFSET UNITYSDK_OFFSET(0xB0F0BC0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ISASSEMBLYNPC_OFFSET UNITYSDK_OFFSET(0xB0F0AD0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ISUSINGTEXTURESHEET_OFFSET UNITYSDK_OFFSET(0xB0F0B40)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ISVIDEO_OFFSET UNITYSDK_OFFSET(0xB0F0AA0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_POSEKEY_OFFSET UNITYSDK_OFFSET(0xB0F0A40)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_ROLEINFO_OFFSET UNITYSDK_OFFSET(0xB0F0A20)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_TEXTURESHEETNODEPATH_OFFSET UNITYSDK_OFFSET(0xB0F0B60)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_VIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0xB0F0A80)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_GET_WINKITEM_OFFSET UNITYSDK_OFFSET(0xB0F0A00)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_INITTEXTURESHEETUSING_OFFSET UNITYSDK_OFFSET(0xB0F0C70)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETASSEMBLYNPCGO_OFFSET UNITYSDK_OFFSET(0xB0F1260)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETAVATARVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0xB0F11F0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETEFFECTLIST_OFFSET UNITYSDK_OFFSET(0xB0F1000)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETFACIALKEY_OFFSET UNITYSDK_OFFSET(0xB0F1350)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETFILTER_OFFSET UNITYSDK_OFFSET(0xB0F13C0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETINITSHOWSETTING_OFFSET UNITYSDK_OFFSET(0xB0F0BE0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETPOSEKEY_OFFSET UNITYSDK_OFFSET(0xB0F12E0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETROLEINFO_OFFSET UNITYSDK_OFFSET(0xB0F1170)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETUIWIDGET_OFFSET UNITYSDK_OFFSET(0xB0F1080)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SETWINKITEM_OFFSET UNITYSDK_OFFSET(0xB0F10F0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_ASSEMBLYNPCGO_OFFSET UNITYSDK_OFFSET(0xB0F0AC0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_CHARACTERTEXTURESHEETNAME_OFFSET UNITYSDK_OFFSET(0xB0F0B90)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_FACIALKEY_OFFSET UNITYSDK_OFFSET(0xB0F0A70)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_FILTER_OFFSET UNITYSDK_OFFSET(0xB0F0BB0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_INITSHOWSETTING_OFFSET UNITYSDK_OFFSET(0xB0F0BD0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_ISUSINGTEXTURESHEET_OFFSET UNITYSDK_OFFSET(0xB0F0B50)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_POSEKEY_OFFSET UNITYSDK_OFFSET(0xB0F0A50)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_ROLEINFO_OFFSET UNITYSDK_OFFSET(0xB0F0A30)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_TEXTURESHEETNODEPATH_OFFSET UNITYSDK_OFFSET(0xB0F0B70)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_VIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0xB0F0A90)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_SET_WINKITEM_OFFSET UNITYSDK_OFFSET(0xB0F0A10)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING_TRYRESETGENERALTEXTURESHEETCOMPONENT_OFFSET UNITYSDK_OFFSET(0xB0F1970)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_AVATARDISPLAYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xB0F0C50)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController_AvatarDisplaySetting_TypeDefinitionIndex = 58913;
	...
	public:
		...
		::UnityEngine::GameObject* _assemblyNpcGO_k__BackingField; // 0x20
		::System::Action_1<::Class_1_9CFBC14B74B66E2C*>* winkItemRetrieveAction; // 0x28
		::System::Action_1<::MoleMole::UIGalgamePageController_UIRoleInfo*>* roleInfoRetrieveAction; // 0x30
		::Class_1_39F32ADA6528F94C* _filter_k__BackingField; // 0x38
		::Class_1_9CFBC14B74B66E2C* _winkItem_k__BackingField; // 0x40
		::MoleMole::AvatarShowSetting* _initShowSetting_k__BackingField; // 0x48
		::System::String* _facialKey_k__BackingField; // 0x50
		::System::String* _poseKey_k__BackingField; // 0x58
		::MoleMole::UIGalgamePageController_UIRoleInfo* _roleInfo_k__BackingField; // 0x60
		::MoleMole::UIWidgetController* uiWidget; // 0x68
		::MoleMole::IVideoPlayer* _videoPlayer_k__BackingField; // 0x70
		::System::Collections::Generic::List_1<::MoleMole::EntityHandle>* longLiveEffectEntities; // 0x78
		::System::String* _TextureSheetNodePath_k__BackingField; // 0x80
		::System::Int32 stageNodeIdx; // 0x88
		::System::Int32 actorId; // 0x8C
		::System::Int32 emotionIdx; // 0x90
		::System::Boolean _NPCGoUseSelfLightSetting; // 0x94
		::System::Boolean enableForbiddenMaterialEffect; // 0x95
		::System::Boolean isAvatarShowing; // 0x96
		::System::Boolean _IsUsingTextureSheet_k__BackingField; // 0x97
		::System::UInt32 entityID; // 0x98
