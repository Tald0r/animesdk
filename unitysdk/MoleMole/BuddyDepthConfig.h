...
#define MOLEMOLE_BUDDYDEPTHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9168DA0)

namespace MoleMole
{
	inline static constexpr unsigned int BuddyDepthConfig_TypeDefinitionIndex = 45849;
