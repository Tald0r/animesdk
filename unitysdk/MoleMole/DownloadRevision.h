...
#define MOLEMOLE_DOWNLOADREVISION_GET_P4CHANGELIST_OFFSET UNITYSDK_OFFSET(0x141A07B0)
#define MOLEMOLE_DOWNLOADREVISION_GET_SUFFIX_OFFSET UNITYSDK_OFFSET(0x141A0770)
#define MOLEMOLE_DOWNLOADREVISION_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x141A09F0)
#define MOLEMOLE_DOWNLOADREVISION_METHOD_1_460AE5949F4C524E_OFFSET UNITYSDK_OFFSET(0x141A0920)
#define MOLEMOLE_DOWNLOADREVISION_METHOD_1_D95BC964A2667B55_OFFSET UNITYSDK_OFFSET(0x141A07C0)
#define MOLEMOLE_DOWNLOADREVISION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x141A08B0)
#define MOLEMOLE_DOWNLOADREVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x141A0760)

namespace MoleMole
{
	inline static constexpr unsigned int DownloadRevision_TypeDefinitionIndex = 75505;
