...
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x754CF10)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_CANOPENAPP_OFFSET UNITYSDK_OFFSET(0x754DE80)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x754CDB0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_GETAPPBGCOLOR_OFFSET UNITYSDK_OFFSET(0x754DD50)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x754CC40)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ICONSCROLLVIEWONMOVE_OFFSET UNITYSDK_OFFSET(0x754F4B0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_INITAPPICONSDATA_OFFSET UNITYSDK_OFFSET(0x754D540)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_INITAPPICONSVIEW_OFFSET UNITYSDK_OFFSET(0x754D080)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONCLICKBIGBTN_OFFSET UNITYSDK_OFFSET(0x754ED50)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x754CC50)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0x754DC30)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x754DB90)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x754DA10)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x754CCF0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x754D960)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_SELECTEDAPPICON_1_OFFSET UNITYSDK_OFFSET(0x754EDC0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_SELECTEDAPPICON_OFFSET UNITYSDK_OFFSET(0x754F7B0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_TRYOPENAPP_OFFSET UNITYSDK_OFFSET(0x754E1B0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER_WARMUPTRANSITIONCONTROLLER_OFFSET UNITYSDK_OFFSET(0x754D3B0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x754FA10)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x754F970)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER__INITAPPICONSDATA_B__25_1_OFFSET UNITYSDK_OFFSET(0x754FA50)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER__INITAPPICONSDATA_B__25_2_OFFSET UNITYSDK_OFFSET(0x754FB30)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x754FD10)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___BASE_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0x754FD80)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x754FD90)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x754FDA0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x754FDB0)
#define MOLEMOLE_UIWORKBENCHMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x754FDC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchMainPageController_TypeDefinitionIndex = 39754;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIWorkBenchMainPageController_TypeDefinitionIndex)->GetStaticField(0x11430);
		}
