...
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xCFCA990)
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCFCAB10)
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xCFCAB80)
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFCABF0)
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFCA9A0)
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFCAA10)
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCFCAC60)
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFCACC0)
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0xCFCACD0)
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCFCAE50)
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xCFCAE60)
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFCAE70)
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFCAE80)
#define MOLEMOLE_UILOGINVAGUEBGDIALOGCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFCAE90)

namespace MoleMole
{
	inline static constexpr unsigned int UILoginVagueBgDialogController_TypeDefinitionIndex = 61234;

	class UILoginVagueBgDialogController : public ::MoleMole::UIWindowController
	{
	public:
		::UnityEngine::GameObject* vebView; // 0x2F8
		::System::Boolean isOpenWebView; // 0x300
