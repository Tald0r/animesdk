...
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_CREATECHALLENGEVIEW_OFFSET UNITYSDK_OFFSET(0xBB5C540)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_FILLCARDLIST_OFFSET UNITYSDK_OFFSET(0xBB5CAD0)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_FILLREWARDMAP_OFFSET UNITYSDK_OFFSET(0xBB5CC80)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0xBB5C450)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB5C990)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBB5C4C0)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB5CF40)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER___BASE_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0xBB5CF50)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB5CFB0)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBB5D050)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelDoubleEliteInfoWidgetController_TypeDefinitionIndex = 53241;

	class UIInLevelDoubleEliteInfoWidgetController : public ::MoleMole::UIBattleInfoWidgetControllerBase
	{
	public:
		::Class_2_79AE422BA06F6D26_119* _view; // 0x2C0
