...
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_CREATECHALLENGEVIEW_OFFSET UNITYSDK_OFFSET(0xA3A49D0)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_FILLCARDLIST_OFFSET UNITYSDK_OFFSET(0xA3A4F70)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_FILLREWARDMAP_OFFSET UNITYSDK_OFFSET(0xA3A5120)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0xA3A48E0)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA3A4E30)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA3A4950)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3A53E0)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER___BASE_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0xA3A53F0)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA3A5450)
#define MOLEMOLE_UIINLEVELDOUBLEELITEINFOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA3A54F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelDoubleEliteInfoWidgetController_TypeDefinitionIndex = 43993;

	class UIInLevelDoubleEliteInfoWidgetController : public ::MoleMole::UIBattleInfoWidgetControllerBase
	{
	public:
		::Class_2_79AE422BA06F6D26_69* _view; // 0x2C0
