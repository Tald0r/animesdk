...
#define MOLEMOLE_MONO2DMAPDATA_ICONINFOGROUP_METHOD_1_66CC9828DB1F478F_1_OFFSET UNITYSDK_OFFSET(0xA483EC0)
#define MOLEMOLE_MONO2DMAPDATA_ICONINFOGROUP_METHOD_1_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0xA482DD0)
#define MOLEMOLE_MONO2DMAPDATA_ICONINFOGROUP_METHOD_1_8594010D6A57C9BB_OFFSET UNITYSDK_OFFSET(0xA483E20)
#define MOLEMOLE_MONO2DMAPDATA_ICONINFOGROUP_METHOD_1_8D61BE16C9463302_OFFSET UNITYSDK_OFFSET(0xA483850)
#define MOLEMOLE_MONO2DMAPDATA_ICONINFOGROUP_METHOD_1_AE5D2F3CFBE15D74_OFFSET UNITYSDK_OFFSET(0xA483630)
#define MOLEMOLE_MONO2DMAPDATA_ICONINFOGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xA482D40)

namespace MoleMole
{
	inline static constexpr unsigned int Mono2dMapData_IconInfoGroup_TypeDefinitionIndex = 63987;
