...
#define MOLEMOLE_MONOONSCREENLOGGER_CLEARCURVE_OFFSET UNITYSDK_OFFSET(0xB3B8C80)
#define MOLEMOLE_MONOONSCREENLOGGER_ISDRAWING_OFFSET UNITYSDK_OFFSET(0xB3B8B60)
#define MOLEMOLE_MONOONSCREENLOGGER_METHOD_5_012ED2CBCD67557A_OFFSET UNITYSDK_OFFSET(0xB3B8D20)
#define MOLEMOLE_MONOONSCREENLOGGER_METHOD_5_35D8A1FE53B06D5C_OFFSET UNITYSDK_OFFSET(0xB3B91E0)
#define MOLEMOLE_MONOONSCREENLOGGER_METHOD_5_464B80C09A37526F_OFFSET UNITYSDK_OFFSET(0xB3B8E30)
#define MOLEMOLE_MONOONSCREENLOGGER_METHOD_5_92193DE475EFDCC9_OFFSET UNITYSDK_OFFSET(0xB3B9410)
#define MOLEMOLE_MONOONSCREENLOGGER_METHOD_5_B98E1DF7C6A97151_OFFSET UNITYSDK_OFFSET(0xB3B8DB0)
#define MOLEMOLE_MONOONSCREENLOGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB3B89E0)
#define MOLEMOLE_MONOONSCREENLOGGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB3B8860)
#define MOLEMOLE_MONOONSCREENLOGGER_START_OFFSET UNITYSDK_OFFSET(0xB3B8670)
#define MOLEMOLE_MONOONSCREENLOGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xB3B8D00)

namespace MoleMole
{
	inline static constexpr unsigned int MonoOnScreenLogger_TypeDefinitionIndex = 48989;
