...
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_HASREDPOINTINSTORYGROUP_OFFSET UNITYSDK_OFFSET(0x7F74750)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F74DF0)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x7F74950)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x7F74F70)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F74E90)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F742D0)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_REFRESHREDPOINT_OFFSET UNITYSDK_OFFSET(0x7F74590)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x7F749E0)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F75130)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F75140)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x7F751B0)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x7F75220)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F752A0)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F75320)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowClueCollectItemWidgetController_TypeDefinitionIndex = 61776;
	...
	public:
		...
		::Class_2_208CC9941471731A_264* m_storyCfg; // 0x2E0
		::System::Collections::Generic::List_1<::Class_2_6D99A03C58ED2B6E*>* m_cfgs; // 0x2E8
