...
#define MOLEMOLE_CONFIGUIGAMESTARTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC1E7FA0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIGameStartItem_TypeDefinitionIndex = 50867;
