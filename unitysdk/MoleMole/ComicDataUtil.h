...
#define MOLEMOLE_COMICDATAUTIL_GETCOMICPARTINFOFROMTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1ACC3A50)
#define MOLEMOLE_COMICDATAUTIL_GETIMGTRANS_OFFSET UNITYSDK_OFFSET(0x1ACC38D0)
#define MOLEMOLE_COMICDATAUTIL_GETTRANSNAMEDDFS_OFFSET UNITYSDK_OFFSET(0x1ACC3910)
#define MOLEMOLE_COMICDATAUTIL_NAMETOPARTTYPE_OFFSET UNITYSDK_OFFSET(0x1ACC3640)
#define MOLEMOLE_COMICDATAUTIL_PARTTYPETONAME_OFFSET UNITYSDK_OFFSET(0x1ACC3790)
#define MOLEMOLE_COMICDATAUTIL_ROOTGETIMGTRANS_OFFSET UNITYSDK_OFFSET(0x1ACC37E0)

namespace MoleMole
{
	inline static constexpr unsigned int ComicDataUtil_TypeDefinitionIndex = 30052;
