...
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF74EC0)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAF75040)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF74F60)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF74CA0)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF74E10)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xAF75180)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAF75E60)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER__UPDATEUI_B__6_0_OFFSET UNITYSDK_OFFSET(0xAF75E70)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF75F80)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAF75FF0)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF76070)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF760F0)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF76150)

namespace MoleMole
{
	inline static constexpr unsigned int UIMallDateRowWidgetController_TypeDefinitionIndex = 62350;
