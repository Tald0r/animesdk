...
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x92AC0A0)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x92AC220)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x92AC140)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x92ABE80)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x92ABFF0)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0x92AC360)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x92AD050)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER__UPDATEUI_B__6_0_OFFSET UNITYSDK_OFFSET(0x92AD060)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x92AD170)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x92AD1E0)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x92AD260)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x92AD2E0)
#define MOLEMOLE_UIMALLDATEROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x92AD340)

namespace MoleMole
{
	inline static constexpr unsigned int UIMallDateRowWidgetController_TypeDefinitionIndex = 37530;

	class UIMallDateRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		// static const ::System::String* ReciveAni; // 0x0
		::Class_2_19206BC47BA92FC3* _view; // 0x2D0
		::MoleMole::MonthCardDayReward* dayData; // 0x2D8
		::UnityEngine::Animation* getAnimation; // 0x2E0
