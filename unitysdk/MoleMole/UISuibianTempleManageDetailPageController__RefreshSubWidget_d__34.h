...
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEDETAILPAGECONTROLLER__REFRESHSUBWIDGET_D__34_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x37F340)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEDETAILPAGECONTROLLER__REFRESHSUBWIDGET_D__34_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2CA890)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleManageDetailPageController__RefreshSubWidget_d__34_TypeDefinitionIndex = 41665;
	...
	struct alignas(8) UISuibianTempleManageDetailPageController__RefreshSubWidget_d__34
	{
		...
		::Enum_3_D3384FC764485EA3 _oldDetailType_5__2; // 0x54
