...
#define MOLEMOLE_LAYOUTELEMENTADAPTOR_GET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x8F867B0)
#define MOLEMOLE_LAYOUTELEMENTADAPTOR_SET_ISCHANGED_OFFSET UNITYSDK_OFFSET(0x8F867D0)
#define MOLEMOLE_LAYOUTELEMENTADAPTOR_UPDATEPARAMS_OFFSET UNITYSDK_OFFSET(0x8F868A0)
#define MOLEMOLE_LAYOUTELEMENTADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x8F86850)

namespace MoleMole
{
	inline static constexpr unsigned int LayoutElementAdaptor_TypeDefinitionIndex = 56149;
