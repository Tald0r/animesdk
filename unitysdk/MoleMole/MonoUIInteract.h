...
#define MOLEMOLE_MONOUIINTERACT_AWAKE_OFFSET UNITYSDK_OFFSET(0x7A95590)
#define MOLEMOLE_MONOUIINTERACT_METHOD_5_33E2FA8E6403B93D_OFFSET UNITYSDK_OFFSET(0x7A959F0)
#define MOLEMOLE_MONOUIINTERACT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x7A95970)
#define MOLEMOLE_MONOUIINTERACT_UPDATE_OFFSET UNITYSDK_OFFSET(0x7A958F0)
#define MOLEMOLE_MONOUIINTERACT_WORLDTOUGUIPOSITION_OFFSET UNITYSDK_OFFSET(0x7A95740)
#define MOLEMOLE_MONOUIINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x7A959D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIInteract_TypeDefinitionIndex = 39714;
	...
	public:
		...
		::Class_2_208CC9941471731A_59* template_; // 0x28
