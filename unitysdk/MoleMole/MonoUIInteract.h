...
#define MOLEMOLE_MONOUIINTERACT_AWAKE_OFFSET UNITYSDK_OFFSET(0xA491F30)
#define MOLEMOLE_MONOUIINTERACT_METHOD_5_33E2FA8E6403B93D_OFFSET UNITYSDK_OFFSET(0xA492390)
#define MOLEMOLE_MONOUIINTERACT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA492310)
#define MOLEMOLE_MONOUIINTERACT_UPDATE_OFFSET UNITYSDK_OFFSET(0xA492290)
#define MOLEMOLE_MONOUIINTERACT_WORLDTOUGUIPOSITION_OFFSET UNITYSDK_OFFSET(0xA4920E0)
#define MOLEMOLE_MONOUIINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0xA492370)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIInteract_TypeDefinitionIndex = 60342;
	...
	public:
		...
		::Class_2_208CC9941471731A_229* template_; // 0x28
