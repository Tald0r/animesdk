...
#define MOLEMOLE_MONOSKIPDITHERCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A6640)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSkipDitherCollider_TypeDefinitionIndex = 55132;
