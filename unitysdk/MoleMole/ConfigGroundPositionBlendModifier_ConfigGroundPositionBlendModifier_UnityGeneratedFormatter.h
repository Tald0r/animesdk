...
#define MOLEMOLE_CONFIGGROUNDPOSITIONBLENDMODIFIER_CONFIGGROUNDPOSITIONBLENDMODIFIER_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x14197D30)
#define MOLEMOLE_CONFIGGROUNDPOSITIONBLENDMODIFIER_CONFIGGROUNDPOSITIONBLENDMODIFIER_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x14197D40)
#define MOLEMOLE_CONFIGGROUNDPOSITIONBLENDMODIFIER_CONFIGGROUNDPOSITIONBLENDMODIFIER_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x14198210)
#define MOLEMOLE_CONFIGGROUNDPOSITIONBLENDMODIFIER_CONFIGGROUNDPOSITIONBLENDMODIFIER_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x14198530)
#define MOLEMOLE_CONFIGGROUNDPOSITIONBLENDMODIFIER_CONFIGGROUNDPOSITIONBLENDMODIFIER_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x141984F0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigGroundPositionBlendModifier_ConfigGroundPositionBlendModifier_UnityGeneratedFormatter_TypeDefinitionIndex = 47295;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(ConfigGroundPositionBlendModifier_ConfigGroundPositionBlendModifier_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x34400);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Single>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(ConfigGroundPositionBlendModifier_ConfigGroundPositionBlendModifier_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x34408);
		}
