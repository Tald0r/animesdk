...
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER__NUMBERBLINK_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3B6820)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_NUMBERBLINKER__NUMBERBLINK_D__7_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboardResult3DModelController_NumberBlinker__NumberBlink_d__7_TypeDefinitionIndex = 42506;
	...
	struct alignas(8) UIHollowChessboardResult3DModelController_NumberBlinker__NumberBlink_d__7
	{
		...
		::HueAndSaturationGroup* _rightGroup_5__9; // 0x40
		::NumberBlinkConfig* configNumberBlinkConfig; // 0x48
		...
		::System::Single _curPrefabTime_5__4; // 0x64
		::System::Single _curTime_5__3; // 0x68
		::System::Int32 _lastRightCache_5__6; // 0x6C
