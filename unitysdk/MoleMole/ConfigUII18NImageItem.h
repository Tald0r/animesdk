...
#define MOLEMOLE_CONFIGUII18NIMAGEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xF18B190)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUII18NImageItem_TypeDefinitionIndex = 72440;
