...
#define MOLEMOLE_AVATARSHOWSETTINGDEFAULT_PARSEDEFAULT_OFFSET UNITYSDK_OFFSET(0x6FAB610)
#define MOLEMOLE_AVATARSHOWSETTINGDEFAULT__CTOR_OFFSET UNITYSDK_OFFSET(0x6FAB560)

namespace MoleMole
{
	inline static constexpr unsigned int AvatarShowSettingDefault_TypeDefinitionIndex = 63460;

	class AvatarShowSettingDefault : public ::System::Object
	{
	public:
		::MoleMole::UIAvatarAnimatorParamsSetting* AnimatorParamsSetting; // 0x10
		::MoleMole::UIAvatarLightSetting* AvatarLightSetting; // 0x18
		::MoleMole::UIAvatarCameraSetting* AvatarCameraSetting; // 0x20
		::MoleMole::UIAvatarSettingDefault* AvatarSetting; // 0x28
