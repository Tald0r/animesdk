...
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0xCA41EC0)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xCA41A00)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA41A10)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA41A80)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCA41CD0)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA421B0)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER__BUILDVIEWMODELDATABINDING_B__10_0_OFFSET UNITYSDK_OFFSET(0xCA42270)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER__BUILDVIEWMODELDATABINDING_B__10_1_OFFSET UNITYSDK_OFFSET(0xCA42340)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA42260)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCA424D0)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCA42540)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA42550)

namespace MoleMole
{
	inline static constexpr unsigned int UIRepelPrepBuffSelectPopWindowController_TypeDefinitionIndex = 55103;

	class UIRepelPrepBuffSelectPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::MoleMole::RepelPrepBuffSelectContext* _context; // 0x2F8
		::Class_1_48D56DACBE4271BC* _syncHelper; // 0x300
		::Class_1_B695D0FA5349962B<::System::Int32>* _listPropertySync; // 0x308
		::Class_2_7BDDEFF879F2DF9B* _model; // 0x310
