...
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0xD7A2860)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD7A23A0)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD7A23B0)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD7A2420)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD7A2670)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD7A2B50)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER__BUILDVIEWMODELDATABINDING_B__10_0_OFFSET UNITYSDK_OFFSET(0xD7A2C10)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER__BUILDVIEWMODELDATABINDING_B__10_1_OFFSET UNITYSDK_OFFSET(0xD7A2CD0)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD7A2C00)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD7A2E60)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD7A2ED0)
#define MOLEMOLE_UIREPELPREPBUFFSELECTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD7A2EE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRepelPrepBuffSelectPopWindowController_TypeDefinitionIndex = 37692;
