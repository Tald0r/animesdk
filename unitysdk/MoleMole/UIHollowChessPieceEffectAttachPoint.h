...
#define MOLEMOLE_UIHOLLOWCHESSPIECEEFFECTATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x892B230)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessPieceEffectAttachPoint_TypeDefinitionIndex = 40668;
