...
#define MOLEMOLE_UIHOLLOWCHESSPIECEEFFECTATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xDFD3A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessPieceEffectAttachPoint_TypeDefinitionIndex = 60470;
