...
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x8BAAA90)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BAA910)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BAA9B0)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BAA7C0)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BAA860)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8BAAB00)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BAAB30)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BAABA0)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BAAC20)
#define MOLEMOLE_UIARCADEGAMINGSCOREWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BAAC80)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeGamingScoreWidgetController_TypeDefinitionIndex = 71835;

	class UIArcadeGamingScoreWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_8D0895B2D04B2FAF* _view; // 0x2A0
