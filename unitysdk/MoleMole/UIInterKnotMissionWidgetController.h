...
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_CHECKCANTOGGLEHANDLE_OFFSET UNITYSDK_OFFSET(0x895A0B0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_CLEARLASTTABMANUALNEW_OFFSET UNITYSDK_OFFSET(0x8959950)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_CLEARMANUALNEWS_OFFSET UNITYSDK_OFFSET(0x895BB90)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_GETCANENTERWORLDSTATE_OFFSET UNITYSDK_OFFSET(0x895D780)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_GETMAINMANUALBYSEASONID_OFFSET UNITYSDK_OFFSET(0x895E530)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_GETMANUALCOMPARE_OFFSET UNITYSDK_OFFSET(0x895EC60)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_GETQUESTDESCPREFIX_OFFSET UNITYSDK_OFFSET(0x895F750)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x8958B60)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_HASMAINQUEST_OFFSET UNITYSDK_OFFSET(0x895E420)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_HASTRACKQUEST_OFFSET UNITYSDK_OFFSET(0x895DF40)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_INITMISSION_OFFSET UNITYSDK_OFFSET(0x895B100)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ISTRACKINGPERSONALQUEST_OFFSET UNITYSDK_OFFSET(0x8961D60)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONCLICLGROUPTAB_OFFSET UNITYSDK_OFFSET(0x895AE50)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x895A1C0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONCREATMISSIONITEM_OFFSET UNITYSDK_OFFSET(0x895BAA0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONGENERALTOGGLEHANDLE_OFFSET UNITYSDK_OFFSET(0x895B940)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x8959880)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x8961DC0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONMISSIONITEMCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x895A260)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONQUESTTRACKUPDATE_OFFSET UNITYSDK_OFFSET(0x89593C0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8959E80)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONTRACKBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x895C3D0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONTRANSBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x895D940)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8961F20)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8958B80)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8959D00)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_OPENMAP_OFFSET UNITYSDK_OFFSET(0x895DDD0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_REFRESHACTIVITYTIMER_OFFSET UNITYSDK_OFFSET(0x895FBA0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_REFRESHMISSIONDETAILLIST_OFFSET UNITYSDK_OFFSET(0x895EED0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_REFRESHMISSIONIMAGE_OFFSET UNITYSDK_OFFSET(0x8960810)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_REFRESHMISSIONREWARDLIST_OFFSET UNITYSDK_OFFSET(0x8960270)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_REFRESHMONSTERLEVEL_OFFSET UNITYSDK_OFFSET(0x8961820)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_REFRESHTRACKTIP_OFFSET UNITYSDK_OFFSET(0x8960E60)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_SELECTQUEST_OFFSET UNITYSDK_OFFSET(0x895E7A0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x8958B70)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_UPDATEMISSIONTRACK_OFFSET UNITYSDK_OFFSET(0x8959430)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER_UPDATESELECTEDMISSION_OFFSET UNITYSDK_OFFSET(0x895A590)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x89621F0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER__CHECKCANTOGGLEHANDLE_B__25_0_OFFSET UNITYSDK_OFFSET(0x8962410)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8962070)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER__INITMISSION_B__41_0_OFFSET UNITYSDK_OFFSET(0x89624B0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER__REFRESHACTIVITYTIMER_G__GETTIMESPANFROMTIMESTRING_49_0_OFFSET UNITYSDK_OFFSET(0x8961C20)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8962590)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x8962600)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x8962660)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x89626C0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8962730)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x89627B0)
#define MOLEMOLE_UIINTERKNOTMISSIONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8962810)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotMissionWidgetController_TypeDefinitionIndex = 56252;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotMissionWidgetController_TypeDefinitionIndex)->GetStaticField(0x443D0);
		}
		static ::System::Collections::Generic::List_1<::System::String*>** StaticGet_specialPics()
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIInterKnotMissionWidgetController_TypeDefinitionIndex)->GetStaticField(0x443D8);
		}
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_582*>* sortTabList; // 0x2E0
