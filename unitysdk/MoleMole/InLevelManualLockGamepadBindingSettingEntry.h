...
#define MOLEMOLE_INLEVELMANUALLOCKGAMEPADBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xD0E6AE0)
#define MOLEMOLE_INLEVELMANUALLOCKGAMEPADBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xD0E6AF0)
#define MOLEMOLE_INLEVELMANUALLOCKGAMEPADBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xD0E6B00)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelManualLockGamepadBindingSettingEntry_TypeDefinitionIndex = 48770;
