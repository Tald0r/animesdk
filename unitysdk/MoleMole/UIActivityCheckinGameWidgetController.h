...
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER_GETREWARD_OFFSET UNITYSDK_OFFSET(0xB32B970)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB32AC80)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB32AD20)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB32A590)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB32A8F0)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER_REFRESHFINALREWARD_OFFSET UNITYSDK_OFFSET(0xB32B630)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0xB32B4D0)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER_REFRESHREWARD_OFFSET UNITYSDK_OFFSET(0xB32AE00)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB32A9B0)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB32C0E0)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER__ONUIINIT_B__5_1_OFFSET UNITYSDK_OFFSET(0xB32C110)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB32C120)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB32C190)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB32C210)
#define MOLEMOLE_UIACTIVITYCHECKINGAMEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB32C270)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCheckinGameWidgetController_TypeDefinitionIndex = 70799;
