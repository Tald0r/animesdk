...
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA_CHALLENGECACHEDATACREATOR_OFFSET UNITYSDK_OFFSET(0xC8C8430)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC8C8600)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA_ISCONDITIONVALUECHANGE_OFFSET UNITYSDK_OFFSET(0xC8C84C0)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0xC8C8730)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA_SETDEFAULT_OFFSET UNITYSDK_OFFSET(0xC8C86C0)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xC8C8880)
#define MOLEMOLE_UIMISSIONTIPSROWWIDGETCONTROLLER_CHALLENGECACHEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC8C84B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsRowWidgetController_ChallengeCacheData_TypeDefinitionIndex = 58135;
	...
	public:
		...
		{
			return (::Foundation::ObjectPool_1<::MoleMole::UIMissionTipsRowWidgetController_ChallengeCacheData*>**)Il2CppClass::FromTypeDefinitionIndex(UIMissionTipsRowWidgetController_ChallengeCacheData_TypeDefinitionIndex)->GetStaticField(0x436E0);
		}
		::Class_0_16E4307DCC419505_235* condition; // 0x10
