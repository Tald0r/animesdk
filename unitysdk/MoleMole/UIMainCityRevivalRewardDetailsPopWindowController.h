...
#define MOLEMOLE_UIMAINCITYREVIVALREWARDDETAILSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xCFA0780)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDDETAILSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFA0B80)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDDETAILSPOPWINDOWCONTROLLER_ONCREATREVIVALREWARDITEM_OFFSET UNITYSDK_OFFSET(0xCFA0A00)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDDETAILSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFA11E0)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDDETAILSPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFA0790)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDDETAILSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFA0C20)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDDETAILSPOPWINDOWCONTROLLER_SELECTITEM_OFFSET UNITYSDK_OFFSET(0xCFA1270)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDDETAILSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFA13A0)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDDETAILSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFA13C0)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDDETAILSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFA1430)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDDETAILSPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFA1440)
#define MOLEMOLE_UIMAINCITYREVIVALREWARDDETAILSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFA1450)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityRevivalRewardDetailsPopWindowController_TypeDefinitionIndex = 68511;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_891*>* _progressTemplates; // 0x308
