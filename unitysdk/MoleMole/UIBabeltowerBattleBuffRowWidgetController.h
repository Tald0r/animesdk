...
#define MOLEMOLE_UIBABELTOWERBATTLEBUFFROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF08730)
#define MOLEMOLE_UIBABELTOWERBATTLEBUFFROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDF088B0)
#define MOLEMOLE_UIBABELTOWERBATTLEBUFFROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF087D0)
#define MOLEMOLE_UIBABELTOWERBATTLEBUFFROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF085E0)
#define MOLEMOLE_UIBABELTOWERBATTLEBUFFROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF08680)
#define MOLEMOLE_UIBABELTOWERBATTLEBUFFROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF08A90)
#define MOLEMOLE_UIBABELTOWERBATTLEBUFFROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF08AA0)
#define MOLEMOLE_UIBABELTOWERBATTLEBUFFROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDF08B10)
#define MOLEMOLE_UIBABELTOWERBATTLEBUFFROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF08B90)
#define MOLEMOLE_UIBABELTOWERBATTLEBUFFROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF08C10)
#define MOLEMOLE_UIBABELTOWERBATTLEBUFFROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF08C70)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerBattleBuffRowWidgetController_TypeDefinitionIndex = 58533;

	class UIBabeltowerBattleBuffRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_8127D35606966C67_22* _view; // 0x2D0
