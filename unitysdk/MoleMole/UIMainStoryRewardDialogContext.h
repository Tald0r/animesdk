...
#define MOLEMOLE_UIMAINSTORYREWARDDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8978620)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryRewardDialogContext_TypeDefinitionIndex = 69057;
