...
#define MOLEMOLE_UIMAINSTORYREWARDDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAC04780)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryRewardDialogContext_TypeDefinitionIndex = 49784;
	...
	public:
		...
		::System::Int32 SelectedVhsTemplateID; // 0x34
		::System::Int32 ArchiveType; // 0x38
