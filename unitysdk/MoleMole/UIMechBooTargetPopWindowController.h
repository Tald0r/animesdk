...
#define MOLEMOLE_UIMECHBOOTARGETPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAC063E0)
#define MOLEMOLE_UIMECHBOOTARGETPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xAC069C0)
#define MOLEMOLE_UIMECHBOOTARGETPOPWINDOWCONTROLLER_ONCLICKOKBTN_OFFSET UNITYSDK_OFFSET(0xAC079E0)
#define MOLEMOLE_UIMECHBOOTARGETPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC063F0)
#define MOLEMOLE_UIMECHBOOTARGETPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC07950)
#define MOLEMOLE_UIMECHBOOTARGETPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC06550)
#define MOLEMOLE_UIMECHBOOTARGETPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC06880)
#define MOLEMOLE_UIMECHBOOTARGETPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC07AD0)
#define MOLEMOLE_UIMECHBOOTARGETPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC07AE0)
#define MOLEMOLE_UIMECHBOOTARGETPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC07B50)
#define MOLEMOLE_UIMECHBOOTARGETPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC07B60)
#define MOLEMOLE_UIMECHBOOTARGETPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC07B70)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooTargetPopWindowController_TypeDefinitionIndex = 45512;

	class UIMechBooTargetPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79AE422BA06F6D26_99* _view; // 0x2F8
