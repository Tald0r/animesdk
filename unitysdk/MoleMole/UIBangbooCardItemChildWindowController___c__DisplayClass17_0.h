...
#define MOLEMOLE_UIBANGBOOCARDITEMCHILDWINDOWCONTROLLER___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBF3D090)
#define MOLEMOLE_UIBANGBOOCARDITEMCHILDWINDOWCONTROLLER___C__DISPLAYCLASS17_0__REGISTERCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0xBF3D0A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooCardItemChildWindowController___c__DisplayClass17_0_TypeDefinitionIndex = 37709;
