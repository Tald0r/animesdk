...
#define MOLEMOLE_UIREALTIMEQTEBUTTONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCA3DD90)

namespace MoleMole
{
	inline static constexpr unsigned int UIRealtimeQTEButtonContext_TypeDefinitionIndex = 61438;
