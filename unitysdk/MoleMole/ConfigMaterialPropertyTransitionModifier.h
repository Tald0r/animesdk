...
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER_DOAFTERONENTER_OFFSET UNITYSDK_OFFSET(0xCD30AF0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER_DOONENTER_OFFSET UNITYSDK_OFFSET(0xCD309E0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER_DOWARMUP_OFFSET UNITYSDK_OFFSET(0xCD32700)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER_PREPAREONENTER_OFFSET UNITYSDK_OFFSET(0xCD30660)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER_PREPAREONEXIT_OFFSET UNITYSDK_OFFSET(0xCD30D40)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER_PROCESSENTER_OFFSET UNITYSDK_OFFSET(0xCD30BB0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER_PROCESSEXIT_OFFSET UNITYSDK_OFFSET(0xCD30E10)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER_PROCESSKEEP_OFFSET UNITYSDK_OFFSET(0xCD31A50)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER_SYNCENABLES_OFFSET UNITYSDK_OFFSET(0xCD31520)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER_SYNCVALUES_OFFSET UNITYSDK_OFFSET(0xCD31060)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD328A0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER___BASE_DOAFTERONENTER_OFFSET UNITYSDK_OFFSET(0xCD328B0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER___BASE_DOONENTER_OFFSET UNITYSDK_OFFSET(0xCD328C0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER___BASE_DOWARMUP_OFFSET UNITYSDK_OFFSET(0xCD328D0)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER___BASE_PREPAREONENTER_OFFSET UNITYSDK_OFFSET(0xCD32930)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER___BASE_PREPAREONEXIT_OFFSET UNITYSDK_OFFSET(0xCD32990)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER___BASE_PROCESSENTER_OFFSET UNITYSDK_OFFSET(0xCD32A00)
#define MOLEMOLE_CONFIGMATERIALPROPERTYTRANSITIONMODIFIER___BASE_PROCESSEXIT_OFFSET UNITYSDK_OFFSET(0xCD32AB0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigMaterialPropertyTransitionModifier_TypeDefinitionIndex = 47892;
	...
	public:
		...
		::System::Single _TransitionCompletionRef; // 0xAC
		::System::Single _TransitionWidthRef; // 0xB0
		::MoleMole::MaterialPropertyModifierValueColor _TransitionColor; // 0xB4
		::MoleMole::MaterialPropertyModifierValueFloat _TransitionWidth; // 0xC8
		::UnityEngine::Color _TransitionColorDefault; // 0xD0
		::MoleMole::MaterialPropertyModifierValueBool _Transition; // 0xE0
		::MoleMole::MaterialPropertyModifierValueBool _OverrideOutlineUseUV2; // 0xE3
		::UnityEngine::Color _TransitionColorRef; // 0xE8
		::MoleMole::MaterialPropertyModifierValueFloat _TransitionCompletion; // 0xF8
		::System::Single _TransitionWidthDefault; // 0x100
