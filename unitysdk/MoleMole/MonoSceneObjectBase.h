...
#define MOLEMOLE_MONOSCENEOBJECTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x6EA7E00)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSceneObjectBase_TypeDefinitionIndex = 47195;
