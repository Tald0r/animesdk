...
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER__OVERDRIVESTATEFADEOUT_D__37_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3A9B60)
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER__OVERDRIVESTATEFADEOUT_D__37_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelToolBarBossWidgetController__OverDriveStateFadeOut_d__37_TypeDefinitionIndex = 61908;
