...
#define MOLEMOLE_ANIMATORCLIPBLENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC3090F0)

namespace MoleMole
{
	inline static constexpr unsigned int AnimatorClipBlendData_TypeDefinitionIndex = 71876;
	...
	public:
		...
		::System::Boolean Backwards; // 0x1C
		::System::Boolean IgnoreRange; // 0x1D
