...
#define MOLEMOLE_MONOGAMEPADSPACELIST_METHOD_8_219339329CC0972E_OFFSET UNITYSDK_OFFSET(0xA48B1D0)
#define MOLEMOLE_MONOGAMEPADSPACELIST_METHOD_8_266A11C83A4BA7EF_OFFSET UNITYSDK_OFFSET(0xA489C10)
#define MOLEMOLE_MONOGAMEPADSPACELIST_METHOD_8_39B2F200808AF4E1_OFFSET UNITYSDK_OFFSET(0xA48B330)
#define MOLEMOLE_MONOGAMEPADSPACELIST_METHOD_8_5E0BCFFA92B1485C_OFFSET UNITYSDK_OFFSET(0xA489FA0)
#define MOLEMOLE_MONOGAMEPADSPACELIST_METHOD_8_94B535719D771BB5_1_OFFSET UNITYSDK_OFFSET(0xA48B900)
#define MOLEMOLE_MONOGAMEPADSPACELIST_METHOD_8_94B535719D771BB5_OFFSET UNITYSDK_OFFSET(0xA48B790)
#define MOLEMOLE_MONOGAMEPADSPACELIST_METHOD_8_97301F7D796C67A8_OFFSET UNITYSDK_OFFSET(0xA489570)
#define MOLEMOLE_MONOGAMEPADSPACELIST_METHOD_8_B4C2A5FB53624FD5_OFFSET UNITYSDK_OFFSET(0xA489620)
#define MOLEMOLE_MONOGAMEPADSPACELIST_METHOD_8_C1660E54F11A6094_OFFSET UNITYSDK_OFFSET(0xA48B070)
#define MOLEMOLE_MONOGAMEPADSPACELIST_METHOD_8_C8D6B29192F288ED_OFFSET UNITYSDK_OFFSET(0xA489170)
#define MOLEMOLE_MONOGAMEPADSPACELIST_METHOD_8_DC7EBFF6F03DDECE_OFFSET UNITYSDK_OFFSET(0xA489D50)
#define MOLEMOLE_MONOGAMEPADSPACELIST__CTOR_OFFSET UNITYSDK_OFFSET(0xA48AEB0)
#define MOLEMOLE_MONOGAMEPADSPACELIST___BASE_ISHANDLEINPUTPOST_OFFSET UNITYSDK_OFFSET(0xA48AFA0)
#define MOLEMOLE_MONOGAMEPADSPACELIST___BASE_ONRUNTIMEMANAGEDITEMSCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0xA48AFD0)
#define MOLEMOLE_MONOGAMEPADSPACELIST___BASE_TRYMOVEINDEXBYDIR_OFFSET UNITYSDK_OFFSET(0xA48B030)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadSpaceList_TypeDefinitionIndex = 74966;
	...
	public:
		...
		::UnityEngine::Vector2 Method_8_39B2F200808AF4E1(::UnityEngine::RectTransform* a1, ::MoleMole::MonoGamepadSpaceList_Enum_3_EBB7C008583235EF a2)
		{
			return ((::UnityEngine::Vector2(*)(::PVOID, ::UnityEngine::RectTransform*, ::MoleMole::MonoGamepadSpaceList_Enum_3_EBB7C008583235EF))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADSPACELIST_METHOD_8_39B2F200808AF4E1_OFFSET))(this, a1, a2);
		}
