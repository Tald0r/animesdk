...
#define MOLEMOLE_UIVOIDFRONTDETAILROLEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x971F030)
#define MOLEMOLE_UIVOIDFRONTDETAILROLEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x971F0A0)
#define MOLEMOLE_UIVOIDFRONTDETAILROLEROWWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x971F2E0)
#define MOLEMOLE_UIVOIDFRONTDETAILROLEROWWIDGETCONTROLLER_ONSETDATA_OFFSET UNITYSDK_OFFSET(0x971F1A0)
#define MOLEMOLE_UIVOIDFRONTDETAILROLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x971F3A0)
#define MOLEMOLE_UIVOIDFRONTDETAILROLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x971F3D0)
#define MOLEMOLE_UIVOIDFRONTDETAILROLEROWWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x971F440)
#define MOLEMOLE_UIVOIDFRONTDETAILROLEROWWIDGETCONTROLLER___BASE_ONSETDATA_OFFSET UNITYSDK_OFFSET(0x971F4A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontDetailRoleRowWidgetController_TypeDefinitionIndex = 76704;
