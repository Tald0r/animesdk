...
namespace MoleMole { class MonoGamepadVirtualCursor_Class_3_5606CA9D493CB084; }
...
namespace MoleMole { class MonoGamepadVirtualCursor_Class_3_EC22137A5AE21E1C_2; }
namespace MoleMole { class MonoGamepadVirtualCursor_Class_3_EDF95BA6C53C8DD1; }
...
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_GET_CURRENTCURSORSCREENPOS_OFFSET UNITYSDK_OFFSET(0xA646C00)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_GET_CURRENTSELECTABLE_OFFSET UNITYSDK_OFFSET(0xA646BF0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_GET_SCROLLVIEWWRAPPER_OFFSET UNITYSDK_OFFSET(0xA646A00)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_ISRAYSEGMENTINTERSECT_OFFSET UNITYSDK_OFFSET(0xA64BE00)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_MANUALREFRESHALLSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xA64BB30)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_MANUALRESETPOS_OFFSET UNITYSDK_OFFSET(0xA648BE0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_14246CEAE2B2DA69_OFFSET UNITYSDK_OFFSET(0xA6471D0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_16795D52109A6C43_OFFSET UNITYSDK_OFFSET(0xA64E9F0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_219BF1D1924FE56E_OFFSET UNITYSDK_OFFSET(0xA64EAB0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_25FCCF7ED28C286C_OFFSET UNITYSDK_OFFSET(0xA6493A0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_28ACE674202A2DAF_OFFSET UNITYSDK_OFFSET(0xA646DF0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0xA6473A0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xA6475D0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_4AF3A50A92CC492C_OFFSET UNITYSDK_OFFSET(0xA648AF0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_56BE2B738E535346_OFFSET UNITYSDK_OFFSET(0xA64AC00)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_672E3DECEBB4A051_OFFSET UNITYSDK_OFFSET(0xA648CE0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0xA64A350)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0xA646FA0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_833E61AA8ABCFDD8_OFFSET UNITYSDK_OFFSET(0xA64DA50)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_84516C3E776F194F_OFFSET UNITYSDK_OFFSET(0xA647930)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_9741A7A0642405F1_OFFSET UNITYSDK_OFFSET(0xA64EA40)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_A791C4352965B7A7_OFFSET UNITYSDK_OFFSET(0xA64D830)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_AD83718567C29017_OFFSET UNITYSDK_OFFSET(0xA64BC00)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_AF12F8432B8B318B_OFFSET UNITYSDK_OFFSET(0xA64C740)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xA6488D0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_B7A138FF7998A4AC_OFFSET UNITYSDK_OFFSET(0xA64A210)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_BC3D63492246CA32_OFFSET UNITYSDK_OFFSET(0xA64A080)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_BFCBCC58B41174A0_OFFSET UNITYSDK_OFFSET(0xA648A60)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_C48187169E33825B_OFFSET UNITYSDK_OFFSET(0xA649140)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA649320)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_CDE4B97094B8D1CF_OFFSET UNITYSDK_OFFSET(0xA64D4B0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_D4E0886303081325_OFFSET UNITYSDK_OFFSET(0xA647B00)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_EBE339A3EBBAC21A_OFFSET UNITYSDK_OFFSET(0xA64CF60)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_F34C7D12CD06208F_1_OFFSET UNITYSDK_OFFSET(0xA64F280)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_F34C7D12CD06208F_OFFSET UNITYSDK_OFFSET(0xA64EFE0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_FB44E56B032AA9DE_OFFSET UNITYSDK_OFFSET(0xA64CF20)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_FD1D91E1FE54EABE_OFFSET UNITYSDK_OFFSET(0xA64B610)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETCURSORTOSELECTBLE_OFFSET UNITYSDK_OFFSET(0xA64AF00)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETHIDECURSORSTATEANDLOCKSELECT_OFFSET UNITYSDK_OFFSET(0xA6477E0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETHIDECURSORSTATE_OFFSET UNITYSDK_OFFSET(0xA6479B0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETLOCKSELECT_OFFSET UNITYSDK_OFFSET(0xA64A140)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SET_SCROLLVIEWWRAPPER_OFFSET UNITYSDK_OFFSET(0xA646A10)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA64C1B0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_GETGAMEPADSELECTABLE_OFFSET UNITYSDK_OFFSET(0xA64C4E0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ISWORKABLEINNER_OFFSET UNITYSDK_OFFSET(0xA64C550)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA64C5B0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA64C640)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONMODULEINIT_OFFSET UNITYSDK_OFFSET(0xA64C650)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONMODULELATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA64C6B0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xA64C730)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadVirtualCursor_TypeDefinitionIndex = 38365;
	...
	public:
		...
		::MoleMole::MonoGamepadVirtualCursor_Class_3_EDF95BA6C53C8DD1* CustomSetItemSelectStateFunc; // 0x190
		...
		::MoleMole::MonoGamepadVirtualCursor_Class_3_5606CA9D493CB084* CustomCheckEdgeFunc; // 0x1C8
		::MoleMole::MonoGamepadVirtualCursor_Class_3_EC22137A5AE21E1C_2* CustomOnClickItemFunc; // 0x1D0
		...
		::Class_0_16E4307DCC419505_170* get_CurrentSelectable()
		{
			return ((::Class_0_16E4307DCC419505_170*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_GET_CURRENTSELECTABLE_OFFSET))(this);
		}
		...
		::System::Boolean Method_6_28ACE674202A2DAF()
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_28ACE674202A2DAF_OFFSET))(this);
		}

		::System::Void Method_6_805C56F44231AEF9()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_805C56F44231AEF9_OFFSET))(this);
		}
		...
		::System::Boolean Method_6_25FCCF7ED28C286C(::MoleMole::InputActionEvent a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::MoleMole::InputActionEvent))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_25FCCF7ED28C286C_OFFSET))(this, a1);
		}
		...
		::System::Void SetCursorToSelectble(::Class_0_16E4307DCC419505_170* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_170*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETCURSORTOSELECTBLE_OFFSET))(this, a1);
		}
		...
		{
			return ((::MoleMole::MonoGamepadSelectable*(*)(::PVOID, ::UnityEngine::Transform*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_AD83718567C29017_OFFSET))(this, a1);
		}
		...
		::UnityEngine::Vector2 Method_6_AF12F8432B8B318B(::UnityEngine::Vector2 a1, ::UnityEngine::Vector2 a2, ::UnityEngine::Vector2 a3)
		{
			return ((::UnityEngine::Vector2(*)(::PVOID, ::UnityEngine::Vector2, ::UnityEngine::Vector2, ::UnityEngine::Vector2))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_AF12F8432B8B318B_OFFSET))(this, a1, a2, a3);
		}
		...
		::Class_0_16E4307DCC419505_171* Method_6_FB44E56B032AA9DE()
		{
			return ((::Class_0_16E4307DCC419505_171*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_FB44E56B032AA9DE_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_2C95AFAD0256302F_OFFSET))(this);
		}
		...
		::System::Void Method_6_219BF1D1924FE56E(::MoleMole::MonoGamepadVirtualCursor_CCursorTransitionParam* a1)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::MonoGamepadVirtualCursor_CCursorTransitionParam*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_219BF1D1924FE56E_OFFSET))(this, a1);
		}

		::System::Boolean Method_6_A791C4352965B7A7(::UnityEngine::Transform* a1, ::MoleMole::MonoGamepadSelectable* a2)
		{
			return ((::System::Boolean(*)(::PVOID, ::UnityEngine::Transform*, ::MoleMole::MonoGamepadSelectable*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_A791C4352965B7A7_OFFSET))(this, a1, a2);
		}
		...
		::System::Void Method_6_C48187169E33825B(::Class_0_16E4307DCC419505_170* a1, ::System::Boolean a2, ::System::Boolean a3)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_170*, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_C48187169E33825B_OFFSET))(this, a1, a2, a3);
		}
