...
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_GET_CURRENTCURSORSCREENPOS_OFFSET UNITYSDK_OFFSET(0xB3AF0E0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_GET_CURRENTSELECTABLE_OFFSET UNITYSDK_OFFSET(0xB3AF0D0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_GET_SCROLLVIEWWRAPPER_OFFSET UNITYSDK_OFFSET(0xB3AEEE0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_ISRAYSEGMENTINTERSECT_OFFSET UNITYSDK_OFFSET(0xB3B4610)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_MANUALREFRESHALLSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xB3B4340)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_MANUALRESETPOS_OFFSET UNITYSDK_OFFSET(0xB3B1110)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_14246CEAE2B2DA69_OFFSET UNITYSDK_OFFSET(0xB3AF6B0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_16795D52109A6C43_OFFSET UNITYSDK_OFFSET(0xB3B77B0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_219BF1D1924FE56E_OFFSET UNITYSDK_OFFSET(0xB3B7050)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_25FCCF7ED28C286C_OFFSET UNITYSDK_OFFSET(0xB3B1850)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_28ACE674202A2DAF_OFFSET UNITYSDK_OFFSET(0xB3AF2D0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0xB3AF880)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xB3AFAB0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_4AF3A50A92CC492C_OFFSET UNITYSDK_OFFSET(0xB3B1020)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_56BE2B738E535346_OFFSET UNITYSDK_OFFSET(0xB3B3410)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_672E3DECEBB4A051_OFFSET UNITYSDK_OFFSET(0xB3B1210)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0xB3B2810)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_833E61AA8ABCFDD8_OFFSET UNITYSDK_OFFSET(0xB3B60B0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_84516C3E776F194F_OFFSET UNITYSDK_OFFSET(0xB3AFE10)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xB3AF480)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_9741A7A0642405F1_OFFSET UNITYSDK_OFFSET(0xB3B6040)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_A791C4352965B7A7_OFFSET UNITYSDK_OFFSET(0xB3B7590)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_AD83718567C29017_OFFSET UNITYSDK_OFFSET(0xB3B4410)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_AF12F8432B8B318B_OFFSET UNITYSDK_OFFSET(0xB3B5820)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xB3B0E00)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_B7A138FF7998A4AC_OFFSET UNITYSDK_OFFSET(0xB3B26D0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_BC3D63492246CA32_OFFSET UNITYSDK_OFFSET(0xB3B2540)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_BFCBCC58B41174A0_OFFSET UNITYSDK_OFFSET(0xB3B0F90)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_C48187169E33825B_OFFSET UNITYSDK_OFFSET(0xB3B15F0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB3B17D0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_CDE4B97094B8D1CF_OFFSET UNITYSDK_OFFSET(0xB3B4F50)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_D4E0886303081325_OFFSET UNITYSDK_OFFSET(0xB3AFFE0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_EBE339A3EBBAC21A_OFFSET UNITYSDK_OFFSET(0xB3B52D0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_F34C7D12CD06208F_1_OFFSET UNITYSDK_OFFSET(0xB3B7AA0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_F34C7D12CD06208F_OFFSET UNITYSDK_OFFSET(0xB3B7800)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_FB44E56B032AA9DE_OFFSET UNITYSDK_OFFSET(0xB3B6000)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_FD1D91E1FE54EABE_OFFSET UNITYSDK_OFFSET(0xB3B3E20)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETCURSORTOSELECTBLE_OFFSET UNITYSDK_OFFSET(0xB3B3710)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETHIDECURSORSTATEANDLOCKSELECT_OFFSET UNITYSDK_OFFSET(0xB3AFCC0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETHIDECURSORSTATE_OFFSET UNITYSDK_OFFSET(0xB3AFE90)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETLOCKSELECT_OFFSET UNITYSDK_OFFSET(0xB3B2600)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SET_SCROLLVIEWWRAPPER_OFFSET UNITYSDK_OFFSET(0xB3AEEF0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB3B49C0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_GETGAMEPADSELECTABLE_OFFSET UNITYSDK_OFFSET(0xB3B4CF0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ISWORKABLEINNER_OFFSET UNITYSDK_OFFSET(0xB3B4D60)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xB3B4DC0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xB3B4E50)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONMODULEINIT_OFFSET UNITYSDK_OFFSET(0xB3B4E60)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONMODULELATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB3B4EC0)
#define MOLEMOLE_MONOGAMEPADVIRTUALCURSOR___BASE_ONMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xB3B4F40)

namespace MoleMole
{
	inline static constexpr unsigned int MonoGamepadVirtualCursor_TypeDefinitionIndex = 46106;
	...
	public:
		...
		::Class_0_16E4307DCC419505_136* get_CurrentSelectable()
		{
			return ((::Class_0_16E4307DCC419505_136*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_GET_CURRENTSELECTABLE_OFFSET))(this);
		}
		...
		::System::Void SetCursorToSelectble(::Class_0_16E4307DCC419505_136* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_136*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_SETCURSORTOSELECTBLE_OFFSET))(this, a1);
		}
		...
		::System::Void Method_6_C48187169E33825B(::Class_0_16E4307DCC419505_136* a1, ::System::Boolean a2, ::System::Boolean a3)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_136*, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_C48187169E33825B_OFFSET))(this, a1, a2, a3);
		}
		...
		::Class_0_16E4307DCC419505_414* Method_6_FB44E56B032AA9DE()
		{
			return ((::Class_0_16E4307DCC419505_414*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOGAMEPADVIRTUALCURSOR_METHOD_6_FB44E56B032AA9DE_OFFSET))(this);
		}
