...
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0xC61AAE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CALCURITEMMAX_OFFSET UNITYSDK_OFFSET(0xC6243B0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CALEQUIPLEFTEXP_OFFSET UNITYSDK_OFFSET(0xC622B80)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CALWEAPONLEFTEXP_OFFSET UNITYSDK_OFFSET(0xC623A00)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CLEARMATERIAL_OFFSET UNITYSDK_OFFSET(0xC6204A0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOREFRESHSTARUPVIEW_OFFSET UNITYSDK_OFFSET(0xC61E650)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOREFRESHVIEWCOMMON_OFFSET UNITYSDK_OFFSET(0xC625C10)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOSETSTARUPCONSUME_OFFSET UNITYSDK_OFFSET(0xC61E9A0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETALLSELECTLEVELUPMATERIAL_OFFSET UNITYSDK_OFFSET(0xC61DA40)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETHASSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0xC61D910)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETLEVELUPITEMS_OFFSET UNITYSDK_OFFSET(0xC61BD70)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETREALADDEDVALUE_OFFSET UNITYSDK_OFFSET(0xC61E2F0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETSELECTLEVELUPMATERIALEXCEPTI_OFFSET UNITYSDK_OFFSET(0xC624660)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETWEAPONRTANIMATOR_OFFSET UNITYSDK_OFFSET(0xC626DD0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xC617CA0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC615DD0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_HANDLEZHENZHENWEAPONSTART_OFFSET UNITYSDK_OFFSET(0xC6269F0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_INITLEVELUPVIEW_OFFSET UNITYSDK_OFFSET(0xC61C810)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_INITSTARUPVIEW_OFFSET UNITYSDK_OFFSET(0xC61C880)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC616640)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ISLEVELUPMATERIALITEMEMPTY_OFFSET UNITYSDK_OFFSET(0xC623AF0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONAUTOBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xC61CDE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0xC618680)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSOLECHECKCONSUMEBTN_OFFSET UNITYSDK_OFFSET(0xC624A60)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSUMEICONBTN_OFFSET UNITYSDK_OFFSET(0xC6249A0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKEQUIPLEVELBTN_OFFSET UNITYSDK_OFFSET(0xC61FDB0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKEQUIPSTARBTN_OFFSET UNITYSDK_OFFSET(0xC61C8F0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKINFOBTN_OFFSET UNITYSDK_OFFSET(0xC6202B0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKSPINFOBTN_OFFSET UNITYSDK_OFFSET(0xC619820)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC617C00)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONEQUIPRTLOADED_OFFSET UNITYSDK_OFFSET(0xC627030)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xC618060)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC6190F0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONITEMCHANGE_OFFSET UNITYSDK_OFFSET(0xC61B930)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xC617CB0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONLEVELUPMATCHANGED_OFFSET UNITYSDK_OFFSET(0xC623C80)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONSTARUPANIMATIONFINISH_OFFSET UNITYSDK_OFFSET(0xC61DFC0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONSTARUPHANDLE_OFFSET UNITYSDK_OFFSET(0xC61DDC0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONSTORYINFOBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xC624C00)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC61A220)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC615DE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC616450)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONWEAPONLEVELUPRSP_OFFSET UNITYSDK_OFFSET(0xC61C690)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONWEAPONRTLOADED_OFFSET UNITYSDK_OFFSET(0xC6264C0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0xC617F70)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPINPUTKEY_OFFSET UNITYSDK_OFFSET(0xC618250)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPVIEWFOREQUIP_OFFSET UNITYSDK_OFFSET(0xC620580)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPVIEWFORWEAPON_OFFSET UNITYSDK_OFFSET(0xC621C80)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPVIEW_OFFSET UNITYSDK_OFFSET(0xC61BEC0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHSTARUPVIEW_OFFSET UNITYSDK_OFFSET(0xC61C030)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHVIEWFOREQUIP_OFFSET UNITYSDK_OFFSET(0xC625260)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHVIEWFORWEAPON_OFFSET UNITYSDK_OFFSET(0xC625600)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC617B50)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_RELEASERTUNIT_OFFSET UNITYSDK_OFFSET(0xC624B70)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETEQUIPDEVELOPCONTENT_OFFSET UNITYSDK_OFFSET(0xC61ACB0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETLEVELUPCONSUME_OFFSET UNITYSDK_OFFSET(0xC622E50)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0xC622C70)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETSTARUPCONSUME_OFFSET UNITYSDK_OFFSET(0xC61E120)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SHOULDWEAPONSHOWSP_OFFSET UNITYSDK_OFFSET(0xC626430)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SHOWBACKITEMLISTDIALOG_OFFSET UNITYSDK_OFFSET(0xC61A910)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TICKRTROTATING_OFFSET UNITYSDK_OFFSET(0xC619B10)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TRIGGERGAMEPADADDBTN_OFFSET UNITYSDK_OFFSET(0xC618750)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TRIGGERGAMEPADREDUCEBTN_OFFSET UNITYSDK_OFFSET(0xC618C20)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TRIGGERSTARTWEAPONPERFORM_OFFSET UNITYSDK_OFFSET(0xC626700)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC619AA0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC627800)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC627600)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__DOSETSTARUPCONSUME_B__49_1_OFFSET UNITYSDK_OFFSET(0xC6278E0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKEQUIPSTARBTN_B__38_0_OFFSET UNITYSDK_OFFSET(0xC627880)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKEQUIPSTARBTN_B__38_1_OFFSET UNITYSDK_OFFSET(0xC627850)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKSPINFOBTN_B__74_0_OFFSET UNITYSDK_OFFSET(0xC627AF0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKSPINFOBTN_B__74_1_OFFSET UNITYSDK_OFFSET(0xC627B20)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONSTORYINFOBTNCLICKED_B__73_0_OFFSET UNITYSDK_OFFSET(0xC627900)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__TRIGGERSTARTWEAPONPERFORM_B__81_0_OFFSET UNITYSDK_OFFSET(0xC627B50)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC627C00)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xC627C70)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC627CF0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xC627D20)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC627D80)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC627D90)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC627DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDevelopPopWindowController_TypeDefinitionIndex = 53582;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIEquipDevelopPopWindowController_TypeDefinitionIndex)->GetStaticField(0x101A0);
		}
		static ::System::Int32* StaticGet_BaseMap()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIEquipDevelopPopWindowController_TypeDefinitionIndex)->GetStaticField(0x101A4);
		}
		...
		::Class_2_79F6D62CE30E3F8E_129* _view; // 0x348
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_240*>* GetLevelupItems()
		{
			return ((::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_240*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETLEVELUPITEMS_OFFSET))(this);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_A3CFC20DC3954F5C_1*, ::Class_2_758D4E94CC1C6B2A*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SHOULDWEAPONSHOWSP_OFFSET))(this, weaponData, weaponConfig);
		}

		::System::Void DoRefreshViewCommon(::System::Int32 templateID, ::Class_2_208CC9941471731A_240* itemConfig, ::System::UInt32 avatarUID, ::System::String* iconPath, ::System::Boolean isEquip, ::System::Boolean isRefreshRT)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Class_2_208CC9941471731A_240*, ::System::UInt32, ::System::String*, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOREFRESHVIEWCOMMON_OFFSET))(this, templateID, itemConfig, avatarUID, iconPath, isEquip, isRefreshRT);
		}
