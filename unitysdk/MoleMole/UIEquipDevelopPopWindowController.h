...
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0xDF85A10)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CALCURITEMMAX_OFFSET UNITYSDK_OFFSET(0xDF8F2E0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CALEQUIPLEFTEXP_OFFSET UNITYSDK_OFFSET(0xDF8DAA0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CALWEAPONLEFTEXP_OFFSET UNITYSDK_OFFSET(0xDF8E930)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_CLEARMATERIAL_OFFSET UNITYSDK_OFFSET(0xDF8B3B0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOREFRESHSTARUPVIEW_OFFSET UNITYSDK_OFFSET(0xDF89570)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOREFRESHVIEWCOMMON_OFFSET UNITYSDK_OFFSET(0xDF90B40)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOSETSTARUPCONSUME_OFFSET UNITYSDK_OFFSET(0xDF898C0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETALLSELECTLEVELUPMATERIAL_OFFSET UNITYSDK_OFFSET(0xDF88960)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETHASSELECTMATERIAL_OFFSET UNITYSDK_OFFSET(0xDF88830)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETLEVELUPITEMS_OFFSET UNITYSDK_OFFSET(0xDF86C90)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETREALADDEDVALUE_OFFSET UNITYSDK_OFFSET(0xDF89210)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETSELECTLEVELUPMATERIALEXCEPTI_OFFSET UNITYSDK_OFFSET(0xDF8F590)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETWEAPONRTANIMATOR_OFFSET UNITYSDK_OFFSET(0xDF91D00)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xDF82C00)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDF80D40)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_HANDLEZHENZHENWEAPONSTART_OFFSET UNITYSDK_OFFSET(0xDF91920)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_INITLEVELUPVIEW_OFFSET UNITYSDK_OFFSET(0xDF87720)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_INITSTARUPVIEW_OFFSET UNITYSDK_OFFSET(0xDF87790)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xDF815A0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ISLEVELUPMATERIALITEMEMPTY_OFFSET UNITYSDK_OFFSET(0xDF8EA20)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONAUTOBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xDF87D00)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0xDF835E0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSOLECHECKCONSUMEBTN_OFFSET UNITYSDK_OFFSET(0xDF8F990)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKCONSUMEICONBTN_OFFSET UNITYSDK_OFFSET(0xDF8F8D0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKEQUIPLEVELBTN_OFFSET UNITYSDK_OFFSET(0xDF8ACC0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKEQUIPSTARBTN_OFFSET UNITYSDK_OFFSET(0xDF87800)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKINFOBTN_OFFSET UNITYSDK_OFFSET(0xDF8B1C0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCLICKSPINFOBTN_OFFSET UNITYSDK_OFFSET(0xDF84760)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF82B60)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONEQUIPRTLOADED_OFFSET UNITYSDK_OFFSET(0xDF91F60)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xDF82FC0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDF84030)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONITEMCHANGE_OFFSET UNITYSDK_OFFSET(0xDF86850)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xDF82C10)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONLEVELUPMATCHANGED_OFFSET UNITYSDK_OFFSET(0xDF8EBB0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONSTARUPANIMATIONFINISH_OFFSET UNITYSDK_OFFSET(0xDF88EE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONSTARUPHANDLE_OFFSET UNITYSDK_OFFSET(0xDF88CE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONSTORYINFOBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xDF8FB30)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF85150)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF80D50)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF813B0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONWEAPONLEVELUPRSP_OFFSET UNITYSDK_OFFSET(0xDF875A0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_ONWEAPONRTLOADED_OFFSET UNITYSDK_OFFSET(0xDF913F0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0xDF82ED0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPINPUTKEY_OFFSET UNITYSDK_OFFSET(0xDF831B0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPVIEWFOREQUIP_OFFSET UNITYSDK_OFFSET(0xDF8B490)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPVIEWFORWEAPON_OFFSET UNITYSDK_OFFSET(0xDF8CBA0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHLEVELUPVIEW_OFFSET UNITYSDK_OFFSET(0xDF86DE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHSTARUPVIEW_OFFSET UNITYSDK_OFFSET(0xDF86F50)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHVIEWFOREQUIP_OFFSET UNITYSDK_OFFSET(0xDF90190)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHVIEWFORWEAPON_OFFSET UNITYSDK_OFFSET(0xDF90530)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xDF82AB0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_RELEASERTUNIT_OFFSET UNITYSDK_OFFSET(0xDF8FAA0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETEQUIPDEVELOPCONTENT_OFFSET UNITYSDK_OFFSET(0xDF85BE0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETLEVELUPCONSUME_OFFSET UNITYSDK_OFFSET(0xDF8DD80)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0xDF8DB90)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SETSTARUPCONSUME_OFFSET UNITYSDK_OFFSET(0xDF89040)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SHOULDWEAPONSHOWSP_OFFSET UNITYSDK_OFFSET(0xDF91360)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SHOWBACKITEMLISTDIALOG_OFFSET UNITYSDK_OFFSET(0xDF85840)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TICKRTROTATING_OFFSET UNITYSDK_OFFSET(0xDF84A40)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TRIGGERGAMEPADADDBTN_OFFSET UNITYSDK_OFFSET(0xDF836B0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TRIGGERGAMEPADREDUCEBTN_OFFSET UNITYSDK_OFFSET(0xDF83B70)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_TRIGGERSTARTWEAPONPERFORM_OFFSET UNITYSDK_OFFSET(0xDF91630)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xDF849D0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xDF92730)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF92530)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__DOSETSTARUPCONSUME_B__49_1_OFFSET UNITYSDK_OFFSET(0xDF92820)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKEQUIPSTARBTN_B__38_0_OFFSET UNITYSDK_OFFSET(0xDF927C0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKEQUIPSTARBTN_B__38_1_OFFSET UNITYSDK_OFFSET(0xDF92780)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKSPINFOBTN_B__74_0_OFFSET UNITYSDK_OFFSET(0xDF92A30)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONCLICKSPINFOBTN_B__74_1_OFFSET UNITYSDK_OFFSET(0xDF92A60)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__ONSTORYINFOBTNCLICKED_B__73_0_OFFSET UNITYSDK_OFFSET(0xDF92840)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER__TRIGGERSTARTWEAPONPERFORM_B__81_0_OFFSET UNITYSDK_OFFSET(0xDF92A90)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF92B40)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xDF92BB0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDF92C30)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xDF92C60)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF92CC0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF92CD0)
#define MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF92CE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDevelopPopWindowController_TypeDefinitionIndex = 71925;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIEquipDevelopPopWindowController_TypeDefinitionIndex)->GetStaticField(0x11890);
		}
		static ::System::Int32* StaticGet_BaseMap()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIEquipDevelopPopWindowController_TypeDefinitionIndex)->GetStaticField(0x11894);
		}
		...
		::System::Int32 firstUnenoughID; // 0x2F8
		::System::Boolean isJumpToCompose; // 0x2FC
		::System::Int32 jumpToItemID; // 0x300
		::System::Int32 jumpTabIndex; // 0x304
		::System::Int32 composeNeedCount; // 0x308
		::System::Boolean isSuggestUseMaterialConversion; // 0x30C
		::MoleMole::UIGeneralConversionTipsPopWindowContext* conversionContext; // 0x310
		::System::Boolean isSuggestUseMaterialConversionAndAdaptive; // 0x318
		::System::Boolean isSuggestUseAdaptiveMaterial; // 0x319
		::System::Boolean isUseAdaptiveMaterial; // 0x31A
		::System::Int32 useAdaptiveItemID; // 0x31C
		::System::Int32 useAdaptiveItemCount; // 0x320
		::Foundation::Coroutine::CoroutineHandle okBtnDisableHandle; // 0x324
		::System::Boolean isStarUping; // 0x328
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* hasMaterialDir; // 0x330
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* suggestMaterialDir; // 0x338
		::System::Int32 lastRandomPropertyCount; // 0x340
		::Class_2_79F6D62CE30E3F8E_176* _view; // 0x348
		::MoleMole::UIEquipDevelopContext* _context; // 0x350
		::Enum_3_B9002106B360C669 _curDevelopType; // 0x358
		::Class_1_0D6706375CDAAE8C* _curItemData; // 0x360
		::Class_2_888829D5F4E4EBE0* _equipmentDataProxy; // 0x368
		::Class_2_A63C194229EB6BF2* _equipmentModel; // 0x370
		::Class_2_9D9172C07F82DDAE* _itemModel; // 0x378
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnWidgetController*>* _levelUpMats; // 0x380
		::System::Collections::Generic::List_1<::MoleMole::UIItemIconBtnWidgetController*>* _equipStarUpMats; // 0x388
		::System::Collections::Generic::List_1<::Class_1_BDEEA5009A8A636E*>* _equipBasePropertyItems; // 0x390
		::System::Collections::Generic::List_1<::Class_1_BDEEA5009A8A636E*>* _equipRandomPropertyItems; // 0x398
		::System::Collections::Generic::List_1<::MonoUILoopBGText*>* _loopTxtList; // 0x3A0
		::System::Single _allNeedCountpercent; // 0x3A8
		::System::Single _curCountPercent; // 0x3AC
		::System::Boolean _isDevelopedUp; // 0x3B0
		::System::Boolean _isEquipLevelUpMaxLevel; // 0x3B1
		::UnityEngine::Material* _processMaterial; // 0x3B8
		::System::Int32 curLeftExp; // 0x3C0
		::System::Int32 weaponToMaxLvNeedExp; // 0x3C4
		::System::Int32 equipToNextLvNeedExp; // 0x3C8
		::MoleMole::MonoGamepadCustomList* _monoGamepadCustomList; // 0x3D0
		::System::Int32 _gamepadAddSelectIndex; // 0x3D8
		::System::Int32 _gamepadReduceSelectIndex; // 0x3DC
		::System::Boolean _isGamepadAddBtnPressed; // 0x3E0
		::System::Boolean _isGamepadReduceBtnPressed; // 0x3E1
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* backItemList; // 0x3E8
		::System::Int32 _consumeItemID; // 0x3F0
		::Class_2_C2B4B123B5A9B78A* _iconRTUnit; // 0x3F8
		::System::Boolean hasWeaponFirstRefreshed; // 0x400
		::System::Boolean shouldShowSP; // 0x401
		::System::Boolean isSPInfoExpand; // 0x402
		::Foundation::Coroutine::CoroutineHandle _weaponTransformTriggerResetHandle; // 0x404
		::System::Single _weaponTransformTriggerRotateCounter; // 0x408
		::System::String* DefaultTipsTextTextMap; // 0x410
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_53*>* GetLevelupItems()
		{
			return ((::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_53*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_GETLEVELUPITEMS_OFFSET))(this);
		}
		...
		::System::Boolean ShouldWeaponShowSP(::Class_2_A3CFC20DC3954F5C* weaponData, ::Class_2_758D4E94CC1C6B2A* weaponConfig)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_A3CFC20DC3954F5C*, ::Class_2_758D4E94CC1C6B2A*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_SHOULDWEAPONSHOWSP_OFFSET))(this, weaponData, weaponConfig);
		}

		::System::Void DoRefreshViewCommon(::System::Int32 templateID, ::Class_2_208CC9941471731A_53* itemConfig, ::System::UInt32 avatarUID, ::System::String* iconPath, ::System::Boolean isEquip, ::System::Boolean isRefreshRT)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Class_2_208CC9941471731A_53*, ::System::UInt32, ::System::String*, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIEQUIPDEVELOPPOPWINDOWCONTROLLER_DOREFRESHVIEWCOMMON_OFFSET))(this, templateID, itemConfig, avatarUID, iconPath, isEquip, isRefreshRT);
		}
