...
#define MOLEMOLE_CONFIGUILIGHTPARAM_GET_CHARTOONNORMAL_OFFSET UNITYSDK_OFFSET(0xD0B4780)
#define MOLEMOLE_CONFIGUILIGHTPARAM_SET_CHARTOONNORMAL_OFFSET UNITYSDK_OFFSET(0xD0B4790)
#define MOLEMOLE_CONFIGUILIGHTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xD0B4830)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUILightParam_TypeDefinitionIndex = 39352;
