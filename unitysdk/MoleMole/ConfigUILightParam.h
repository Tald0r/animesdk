...
#define MOLEMOLE_CONFIGUILIGHTPARAM_GET_CHARTOONNORMAL_OFFSET UNITYSDK_OFFSET(0xCDCF7E0)
#define MOLEMOLE_CONFIGUILIGHTPARAM_SET_CHARTOONNORMAL_OFFSET UNITYSDK_OFFSET(0xCDCF7F0)
#define MOLEMOLE_CONFIGUILIGHTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xCDCF890)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUILightParam_TypeDefinitionIndex = 62268;
