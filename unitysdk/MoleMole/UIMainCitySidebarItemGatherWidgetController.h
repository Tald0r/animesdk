...
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER_GETFOCUSINDEX_OFFSET UNITYSDK_OFFSET(0x74730A0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7472860)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7472B90)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0x7472F20)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x7472970)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x7472C90)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x74728D0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER_TRYOVERRIDESELECTONFOCUS_OFFSET UNITYSDK_OFFSET(0x7472DE0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7473160)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7473170)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEXFROMINPUT_OFFSET UNITYSDK_OFFSET(0x74731E0)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x7473260)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x7473290)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7473310)
#define MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER___BASE_TRYOVERRIDESELECTONFOCUS_OFFSET UNITYSDK_OFFSET(0x7473370)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySidebarItemGatherWidgetController_TypeDefinitionIndex = 37376;
	...
	public:
		...
		::Class_2_E7AAB39A5FB9E8F9* get__viewModel()
		{
			return ((::Class_2_E7AAB39A5FB9E8F9*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYSIDEBARITEMGATHERWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
