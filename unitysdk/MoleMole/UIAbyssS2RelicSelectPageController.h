...
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_CREATEOPTIONDATALIST_OFFSET UNITYSDK_OFFSET(0xA4F4E60)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_FINDCURSELECTEDITEMID_OFFSET UNITYSDK_OFFSET(0xA4F4DE0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GETCURRENTSKILLRELICITEM_OFFSET UNITYSDK_OFFSET(0xA4F6A60)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GETTRENDID_OFFSET UNITYSDK_OFFSET(0xA4F8200)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_ABYSSS2MODEL_OFFSET UNITYSDK_OFFSET(0xA4FA260)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_CURFOCUSED_OFFSET UNITYSDK_OFFSET(0xA4F6D30)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xA4F3310)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_INITIALRELICMODEL_OFFSET UNITYSDK_OFFSET(0xA4FA110)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA4F3320)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITGENERALTOKENWIDGET_OFFSET UNITYSDK_OFFSET(0xA4F6580)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITGENREGROUPLIST_OFFSET UNITYSDK_OFFSET(0xA4F5300)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITINITIALRELICVIEW_OFFSET UNITYSDK_OFFSET(0xA4F46B0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITRELICACTIVEVIEW_OFFSET UNITYSDK_OFFSET(0xA4F4920)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITRELICITEMLIST_OFFSET UNITYSDK_OFFSET(0xA4F49F0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITRELICTYPE_OFFSET UNITYSDK_OFFSET(0xA4F4D20)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xA4F5F10)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITSELECTEDVIEW_1_OFFSET UNITYSDK_OFFSET(0xA4F84D0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITSELECTEDVIEW_OFFSET UNITYSDK_OFFSET(0xA4F8420)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITSTATEDATALIST_OFFSET UNITYSDK_OFFSET(0xA4F5850)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITTOGGLE_OFFSET UNITYSDK_OFFSET(0xA4F3A60)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKCANCELBTN_OFFSET UNITYSDK_OFFSET(0xA4F99A0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKCLOSEBTN_OFFSET UNITYSDK_OFFSET(0xA4F8A00)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKOKBTN_OFFSET UNITYSDK_OFFSET(0xA4F8E80)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKPAYBTN_OFFSET UNITYSDK_OFFSET(0xA4F8AB0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKTRENDBTN_OFFSET UNITYSDK_OFFSET(0xA4F9B20)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0xA4F9760)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4F3330)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONINITIALRELICDATAUPDATE_OFFSET UNITYSDK_OFFSET(0xA4F9F80)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA4F40E0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0xA4F9DB0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONTOGGLECHANGE_OFFSET UNITYSDK_OFFSET(0xA4F3CE0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4F6CA0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4F33D0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA4F42E0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_PLAYSELECTTOPANIM_OFFSET UNITYSDK_OFFSET(0xA4F98F0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_PROCESSNORMALCONFIRM_OFFSET UNITYSDK_OFFSET(0xA4F9320)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHSELECTVIEW_OFFSET UNITYSDK_OFFSET(0xA4F3DD0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHTOPVIEW_OFFSET UNITYSDK_OFFSET(0xA4F6F40)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHTRENDVIEW_OFFSET UNITYSDK_OFFSET(0xA4F7A80)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHVIEWONFOCUSCHANGE_OFFSET UNITYSDK_OFFSET(0xA4F6E70)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA4F69E0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_SETCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0xA4F8590)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4FA3B0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER__ONCLICKCANCELBTN_B__59_0_OFFSET UNITYSDK_OFFSET(0xA4FA440)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER__ONCONFIRM_B__57_0_OFFSET UNITYSDK_OFFSET(0xA4FA430)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4FA4B0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA4FA520)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4FA550)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4FA560)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA4FA570)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RelicSelectPageController_TypeDefinitionIndex = 46163;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_7* _view; // 0x2F8
		::System::Collections::Generic::List_1<::MoleMole::UIWidgetController*>* _contentAddtiveWidgetList; // 0x300
		::System::UInt32 _lastMUid; // 0x308
		::System::Boolean playSelectAnim; // 0x30C
		::System::Int32 _lastIndex; // 0x310
		::MoleMole::UIGeneralToggleWidgetControllerWithModel* toggle; // 0x318
		::MoleMole::UIAbyssS2RelicSelectPageController_RelicSelectType _relicType; // 0x320
		::Enum_3_15A8EF2824547B27 _currentPageShowType; // 0x324
		::System::UInt32 initialRelicUID; // 0x328
		::Class_1_0E5778BB52E10271* _showData; // 0x330
		::Class_1_0E5778BB52E10271* _lastShowData; // 0x338
		::System::Boolean _everSelected; // 0x340
		::MoleMole::MonoGamepadCustomList* _naviList; // 0x348
		::System::Collections::Generic::List_1<::Class_1_0E5778BB52E10271*>* _list; // 0x350
		::System::Collections::Generic::List_1<::Class_1_E49B99468FA26AB2_1*>* _groupByGenreList; // 0x358
		::System::Collections::Generic::List_1<::System::Int32>* relicItemIDList; // 0x360
		::System::Int32 m_relicID; // 0x368
		::System::UInt32 m_objUID; // 0x36C
		::System::Boolean CanUnlock; // 0x370
		::System::Boolean isCurrentLocked; // 0x371
		::Class_2_86B3C791290970F4* m_initialRelicModel; // 0x378
		::Class_2_DA8BF519212BAE65_1* _abyssS2Model; // 0x380
		::MoleMole::UIAbyssS2InfoBtnWidgetController* _abyssS2InfoBtn; // 0x388
		...
		::System::Void ProcessNormalConfirm(::System::Boolean isShow, ::System::String* localKey, ::MoleMole::UserLocalDataItem* localData, ::Class_2_208CC9941471731A_240* itemTemplate)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::System::String*, ::MoleMole::UserLocalDataItem*, ::Class_2_208CC9941471731A_240*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_PROCESSNORMALCONFIRM_OFFSET))(this, isShow, localKey, localData, itemTemplate);
		}
		...
		::Class_2_DA8BF519212BAE65_1* get_AbyssS2Model()
		{
			return ((::Class_2_DA8BF519212BAE65_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_ABYSSS2MODEL_OFFSET))(this);
		}
