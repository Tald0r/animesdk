...
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_CREATEOPTIONDATALIST_OFFSET UNITYSDK_OFFSET(0xA4B6510)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_FINDCURSELECTEDITEMID_OFFSET UNITYSDK_OFFSET(0xA4B6490)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GETCURRENTSKILLRELICITEM_OFFSET UNITYSDK_OFFSET(0xA4B8100)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GETTRENDID_OFFSET UNITYSDK_OFFSET(0xA4B98C0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_ABYSSS2MODEL_OFFSET UNITYSDK_OFFSET(0xA4BB930)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_CURFOCUSED_OFFSET UNITYSDK_OFFSET(0xA4B83D0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xA4B49C0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_INITIALRELICMODEL_OFFSET UNITYSDK_OFFSET(0xA4BB7F0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA4B49D0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITGENERALTOKENWIDGET_OFFSET UNITYSDK_OFFSET(0xA4B7C30)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITGENREGROUPLIST_OFFSET UNITYSDK_OFFSET(0xA4B69B0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITINITIALRELICVIEW_OFFSET UNITYSDK_OFFSET(0xA4B5D60)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITRELICACTIVEVIEW_OFFSET UNITYSDK_OFFSET(0xA4B5FD0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITRELICITEMLIST_OFFSET UNITYSDK_OFFSET(0xA4B60A0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITRELICTYPE_OFFSET UNITYSDK_OFFSET(0xA4B63D0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xA4B75C0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITSELECTEDVIEW_1_OFFSET UNITYSDK_OFFSET(0xA4B9B90)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITSELECTEDVIEW_OFFSET UNITYSDK_OFFSET(0xA4B9AE0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITSTATEDATALIST_OFFSET UNITYSDK_OFFSET(0xA4B6F00)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_INITTOGGLE_OFFSET UNITYSDK_OFFSET(0xA4B5110)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKCANCELBTN_OFFSET UNITYSDK_OFFSET(0xA4BB080)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKCLOSEBTN_OFFSET UNITYSDK_OFFSET(0xA4BA0C0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKOKBTN_OFFSET UNITYSDK_OFFSET(0xA4BA550)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKPAYBTN_OFFSET UNITYSDK_OFFSET(0xA4BA180)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCLICKTRENDBTN_OFFSET UNITYSDK_OFFSET(0xA4BB200)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0xA4BAE40)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4B49E0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONINITIALRELICDATAUPDATE_OFFSET UNITYSDK_OFFSET(0xA4BB660)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA4B5790)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0xA4BB490)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONTOGGLECHANGE_OFFSET UNITYSDK_OFFSET(0xA4B5390)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4B8340)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4B4A80)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA4B5990)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_PLAYSELECTTOPANIM_OFFSET UNITYSDK_OFFSET(0xA4BAFD0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_PROCESSNORMALCONFIRM_OFFSET UNITYSDK_OFFSET(0xA4BA9F0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHSELECTVIEW_OFFSET UNITYSDK_OFFSET(0xA4B5480)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHTOPVIEW_OFFSET UNITYSDK_OFFSET(0xA4B85E0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHTRENDVIEW_OFFSET UNITYSDK_OFFSET(0xA4B9130)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHVIEWONFOCUSCHANGE_OFFSET UNITYSDK_OFFSET(0xA4B8510)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA4B8080)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_SETCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0xA4B9C50)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4BBA70)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER__ONCLICKCANCELBTN_B__59_0_OFFSET UNITYSDK_OFFSET(0xA4BBB00)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER__ONCONFIRM_B__57_0_OFFSET UNITYSDK_OFFSET(0xA4BBAF0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4BBB70)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA4BBBE0)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4BBC10)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4BBC20)
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA4BBC30)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RelicSelectPageController_TypeDefinitionIndex = 44425;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_96* _view; // 0x2F8
		...
		::Enum_3_58B93C9F467751D5 _currentPageShowType; // 0x324
		...
		::System::Collections::Generic::List_1<::Class_1_E49B99468FA26AB2*>* _groupByGenreList; // 0x358
		...
		::System::Void ProcessNormalConfirm(::System::Boolean isShow, ::System::String* localKey, ::MoleMole::UserLocalDataItem* localData, ::Class_2_208CC9941471731A_53* itemTemplate)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::System::String*, ::MoleMole::UserLocalDataItem*, ::Class_2_208CC9941471731A_53*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER_PROCESSNORMALCONFIRM_OFFSET))(this, isShow, localKey, localData, itemTemplate);
		}
