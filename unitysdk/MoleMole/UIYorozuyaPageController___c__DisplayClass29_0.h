...
#define MOLEMOLE_UIYOROZUYAPAGECONTROLLER___C__DISPLAYCLASS29_0__CTOR_OFFSET UNITYSDK_OFFSET(0xEE685A0)
#define MOLEMOLE_UIYOROZUYAPAGECONTROLLER___C__DISPLAYCLASS29_0__REFRESHCAPTERMES_B__2_OFFSET UNITYSDK_OFFSET(0xEE685B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaPageController___c__DisplayClass29_0_TypeDefinitionIndex = 45379;
