...
#define MOLEMOLE_DISTORTIONPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xB0AF5A0)
#define MOLEMOLE_DISTORTIONPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xB0AF720)
#define MOLEMOLE_DISTORTIONPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0xB0AF490)
#define MOLEMOLE_DISTORTIONPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xB0AF680)
#define MOLEMOLE_DISTORTIONPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xB0AF480)
#define MOLEMOLE_DISTORTIONPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xB0AF880)
#define MOLEMOLE_DISTORTIONPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xB0AF910)
#define MOLEMOLE_DISTORTIONPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xB0AF980)
#define MOLEMOLE_DISTORTIONPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xB0AF9F0)

namespace MoleMole
{
	inline static constexpr unsigned int DistortionProfile_TypeDefinitionIndex = 80277;
