...
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0x984AA00)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_DESTROYALLUNIT_OFFSET UNITYSDK_OFFSET(0x984AC00)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_GETALLAVATARIDS_OFFSET UNITYSDK_OFFSET(0x984B970)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_GETSHOWAVATARID_OFFSET UNITYSDK_OFFSET(0x984B260)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9849F40)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_INITUI_OFFSET UNITYSDK_OFFSET(0x984A070)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_LOADRTMODELFINISHED_OFFSET UNITYSDK_OFFSET(0x984B900)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x984A8C0)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9849F50)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x984AB70)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x984A960)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_SELECTROLE_OFFSET UNITYSDK_OFFSET(0x984B370)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_SETMODELACTIVE_OFFSET UNITYSDK_OFFSET(0x984A6E0)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER_SETROLEIMAGEACTIVE_OFFSET UNITYSDK_OFFSET(0x984AD90)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x984BAA0)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x984BBB0)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x984BC20)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x984BC30)
#define MOLEMOLE_UILINEUPSELECTTESTROLEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x984BC40)

namespace MoleMole
{
	inline static constexpr unsigned int UILineupSelectTestRolePageController_TypeDefinitionIndex = 51651;
