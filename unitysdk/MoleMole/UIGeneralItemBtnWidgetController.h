...
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_GET_BTN_OFFSET UNITYSDK_OFFSET(0xB2BC2F0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONBTNCLICK_OFFSET UNITYSDK_OFFSET(0xB2BB820)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB2BB6A0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0xB2BB950)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONITEMICONBTNCLICK_OFFSET UNITYSDK_OFFSET(0xB2BB8A0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2BB740)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB2BB0D0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB2BB310)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_REFRESHITEMVIEW_OFFSET UNITYSDK_OFFSET(0xB2BB9C0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB2BB550)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_SETCLICK_OFFSET UNITYSDK_OFFSET(0xB2BC000)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_SETITEMNUM_OFFSET UNITYSDK_OFFSET(0xB2BC0A0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_SETITEM_OFFSET UNITYSDK_OFFSET(0xB2BBE40)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_SETSHOWTYPE_OFFSET UNITYSDK_OFFSET(0xB2BBF90)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_SETTIPS_OFFSET UNITYSDK_OFFSET(0xB2BBCD0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB2BC310)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB2BC350)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB2BC3C0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB2BC440)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB2BC4A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemBtnWidgetController_TypeDefinitionIndex = 60451;

	class UIGeneralItemBtnWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_BBB9057201B3EEE3* _view; // 0x2A0
		::System::Int32 itemID; // 0x2A8
		::Class_1_0D6706375CDAAE8C* itemData; // 0x2B0
		::Enum_3_0AB14FA7677844A2 showType; // 0x2B8
		::System::Int32 consume; // 0x2BC
		::System::Boolean canClick; // 0x2C0
		::UnityEngine::Events::UnityAction* clickAction; // 0x2C8
		::MoleMole::UIGeneralItemBtnWidgetContext* _context; // 0x2D0
