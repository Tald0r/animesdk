...
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_GET_BTN_OFFSET UNITYSDK_OFFSET(0x8A15F50)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONBTNCLICK_OFFSET UNITYSDK_OFFSET(0x8A15480)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8A15300)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x8A155B0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONITEMICONBTNCLICK_OFFSET UNITYSDK_OFFSET(0x8A15500)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8A153A0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8A14D30)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8A14F70)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_REFRESHITEMVIEW_OFFSET UNITYSDK_OFFSET(0x8A15620)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8A151B0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_SETCLICK_OFFSET UNITYSDK_OFFSET(0x8A15C60)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_SETITEMNUM_OFFSET UNITYSDK_OFFSET(0x8A15D00)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_SETITEM_OFFSET UNITYSDK_OFFSET(0x8A15AA0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_SETSHOWTYPE_OFFSET UNITYSDK_OFFSET(0x8A15BF0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER_SETTIPS_OFFSET UNITYSDK_OFFSET(0x8A15930)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8A15F70)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8A15FB0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8A16020)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8A160A0)
#define MOLEMOLE_UIGENERALITEMBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8A16100)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemBtnWidgetController_TypeDefinitionIndex = 55656;
