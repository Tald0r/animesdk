...
#define MOLEMOLE_UIBABELTOWERTRICKAVATARROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBAFADA0)
#define MOLEMOLE_UIBABELTOWERTRICKAVATARROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBAFAE40)
#define MOLEMOLE_UIBABELTOWERTRICKAVATARROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBAFAC50)
#define MOLEMOLE_UIBABELTOWERTRICKAVATARROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBAFACF0)
#define MOLEMOLE_UIBABELTOWERTRICKAVATARROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBAFAF20)
#define MOLEMOLE_UIBABELTOWERTRICKAVATARROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBAFB380)
#define MOLEMOLE_UIBABELTOWERTRICKAVATARROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBAFB3B0)
#define MOLEMOLE_UIBABELTOWERTRICKAVATARROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBAFB420)
#define MOLEMOLE_UIBABELTOWERTRICKAVATARROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBAFB4A0)
#define MOLEMOLE_UIBABELTOWERTRICKAVATARROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBAFB500)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerTrickAvatarRowWidgetController_TypeDefinitionIndex = 65599;
