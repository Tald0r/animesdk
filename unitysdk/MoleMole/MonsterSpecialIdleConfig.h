...
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xA52F780)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xA52F0F0)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA52FB70)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xA52FC80)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xA52FC90)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterSpecialIdleConfig_TypeDefinitionIndex = 76702;
