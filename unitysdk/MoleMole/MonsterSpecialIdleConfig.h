...
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9ABC7E0)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9ABC150)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9ABCBD0)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9ABCCE0)
#define MOLEMOLE_MONSTERSPECIALIDLECONFIG___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9ABCCF0)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterSpecialIdleConfig_TypeDefinitionIndex = 62338;
