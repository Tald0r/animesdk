...
#define MOLEMOLE_UIINLEVELPAUSEADDITIONALWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC875C90)
#define MOLEMOLE_UIINLEVELPAUSEADDITIONALWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC875E80)
#define MOLEMOLE_UIINLEVELPAUSEADDITIONALWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC875D30)
#define MOLEMOLE_UIINLEVELPAUSEADDITIONALWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC875DD0)
#define MOLEMOLE_UIINLEVELPAUSEADDITIONALWIDGETCONTROLLER_SHOWDESC_OFFSET UNITYSDK_OFFSET(0xC875F60)
#define MOLEMOLE_UIINLEVELPAUSEADDITIONALWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC876040)
#define MOLEMOLE_UIINLEVELPAUSEADDITIONALWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC876070)
#define MOLEMOLE_UIINLEVELPAUSEADDITIONALWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC8760E0)
#define MOLEMOLE_UIINLEVELPAUSEADDITIONALWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC876160)
#define MOLEMOLE_UIINLEVELPAUSEADDITIONALWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC8761C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseAdditionalWidgetController_TypeDefinitionIndex = 43757;
