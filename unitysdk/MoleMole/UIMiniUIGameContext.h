...
#define MOLEMOLE_UIMINIUIGAMECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD786380)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniUIGameContext_TypeDefinitionIndex = 40192;
	...
	public:
		...
		::Il2CppArray<::System::String*>* LightKey; // 0x38
		::System::Boolean IsGroup; // 0x40
		::System::Boolean needNewbie; // 0x41
		::UnityEngine::Quaternion LightRot; // 0x44
		::UnityEngine::Vector3 LightPos; // 0x54
		::System::Int32 LevelID; // 0x60
		::System::Int32 GroupID; // 0x64
		::Enum_3_2271A294FCCB3EAE GameType; // 0x68
