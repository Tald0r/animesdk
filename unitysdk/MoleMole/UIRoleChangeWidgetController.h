...
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_CHECKAVATARCANSELECT_1_OFFSET UNITYSDK_OFFSET(0xD7A65F0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_CHECKAVATARCANSELECT_OFFSET UNITYSDK_OFFSET(0xD7A5A90)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_CREATROLELISTROW_OFFSET UNITYSDK_OFFSET(0xD7A5910)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_DELAYCHANGEACTION_OFFSET UNITYSDK_OFFSET(0xD7A83E0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_GET_SHOULDHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0xD7A54C0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xD7A6A70)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONAVATARSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0xD7A7EC0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0xD7A73E0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD7A7C50)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xD7A72A0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD7A61C0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONNEXTBTN_OFFSET UNITYSDK_OFFSET(0xD7A5D60)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONPREVIOUSBTN_OFFSET UNITYSDK_OFFSET(0xD7A6110)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD7A68E0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD7A8450)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD7A54D0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD7A6820)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0xD7A7E40)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETBLOCKINPUT_OFFSET UNITYSDK_OFFSET(0xD7A7B00)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETCHANGEACTION_OFFSET UNITYSDK_OFFSET(0xD7A7CF0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETCHANGEBTNSTATE_OFFSET UNITYSDK_OFFSET(0xD7A5CB0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETFORBIDSELECTLOCKAVATAR_OFFSET UNITYSDK_OFFSET(0xD7A5C30)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETLEFTACTION_OFFSET UNITYSDK_OFFSET(0xD7A7D60)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETNEXTAVATAR_OFFSET UNITYSDK_OFFSET(0xD7A5E00)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETRIGHTACTION_OFFSET UNITYSDK_OFFSET(0xD7A7DD0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD7A85E0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER__SETBLOCKINPUT_B__25_0_OFFSET UNITYSDK_OFFSET(0xD7A8690)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD7A8730)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xD7A87A0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD7A8800)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD7A8830)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD7A88A0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD7A8920)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD7A8980)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleChangeWidgetController_TypeDefinitionIndex = 47882;

	class UIRoleChangeWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_55648B18360E84CE_1* _view; // 0x2A0
		::System::Collections::Generic::List_1<::Class_1_2CCC5D7984CDCED4*>* _allItems; // 0x2A8
		::System::Action_1<::Class_1_2CCC5D7984CDCED4*>* _selectChangeAction; // 0x2B0
