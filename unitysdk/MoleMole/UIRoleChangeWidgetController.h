...
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_CHECKAVATARCANSELECT_1_OFFSET UNITYSDK_OFFSET(0xCA45C60)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_CHECKAVATARCANSELECT_OFFSET UNITYSDK_OFFSET(0xCA450F0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_CREATROLELISTROW_OFFSET UNITYSDK_OFFSET(0xCA44F70)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_DELAYCHANGEACTION_OFFSET UNITYSDK_OFFSET(0xCA47A40)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_GET_SHOULDHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0xCA44B20)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xCA460E0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONAVATARSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0xCA47520)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0xCA46A50)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA472B0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xCA46910)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xCA45820)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONNEXTBTN_OFFSET UNITYSDK_OFFSET(0xCA453C0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONPREVIOUSBTN_OFFSET UNITYSDK_OFFSET(0xCA45770)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCA45F50)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA47AB0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA44B30)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA45E90)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0xCA474A0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETBLOCKINPUT_OFFSET UNITYSDK_OFFSET(0xCA47170)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETCHANGEACTION_OFFSET UNITYSDK_OFFSET(0xCA47350)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETCHANGEBTNSTATE_OFFSET UNITYSDK_OFFSET(0xCA45310)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETFORBIDSELECTLOCKAVATAR_OFFSET UNITYSDK_OFFSET(0xCA45290)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETLEFTACTION_OFFSET UNITYSDK_OFFSET(0xCA473C0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETNEXTAVATAR_OFFSET UNITYSDK_OFFSET(0xCA45460)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETRIGHTACTION_OFFSET UNITYSDK_OFFSET(0xCA47430)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA47C40)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER__SETBLOCKINPUT_B__25_0_OFFSET UNITYSDK_OFFSET(0xCA47CF0)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA47D90)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xCA47E00)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xCA47E60)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCA47E90)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA47F00)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA47F80)
#define MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA47FE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleChangeWidgetController_TypeDefinitionIndex = 68831;

	class UIRoleChangeWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_55648B18360E84CE_1* _view; // 0x2A0
		::System::Collections::Generic::List_1<::Class_1_3CDBAA6BC10A7F83*>* _allItems; // 0x2A8
		::System::Action_1<::Class_1_3CDBAA6BC10A7F83*>* _selectChangeAction; // 0x2B0
		::System::Action* _selectLeftAction; // 0x2B8
		::System::Action* _selectRightAction; // 0x2C0
		::System::Single changeDelayTime; // 0x2C8
		::System::Int32 _curSelectIndex; // 0x2CC
		::System::Boolean _isForbidSelectLockAvatar; // 0x2D0
		::System::Int32 _forbidSelectLockAvatarTip; // 0x2D4
		::System::Boolean _isSelectChange; // 0x2D8
		::System::Int32 _selectChangeType; // 0x2DC
		::Foundation::Coroutine::CoroutineHandle changeDelay; // 0x2E0
		...
		::System::Void SetChangeAction(::System::Action_1<::Class_1_3CDBAA6BC10A7F83*>* action)
		{
			return ((::System::Void(*)(::PVOID, ::System::Action_1<::Class_1_3CDBAA6BC10A7F83*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIROLECHANGEWIDGETCONTROLLER_SETCHANGEACTION_OFFSET))(this, action);
		}
