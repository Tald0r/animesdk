...
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ACTIONSETTINGS_METHOD_2_51ED388E34509EDE_OFFSET UNITYSDK_OFFSET(0x418530)
#define MOLEMOLE_MONOLEVELTRIGGERACTION_ACTIONSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x4184E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLevelTriggerAction_ActionSettings_TypeDefinitionIndex = 51798;
