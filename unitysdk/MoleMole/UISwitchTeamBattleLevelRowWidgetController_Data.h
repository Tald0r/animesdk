...
#define MOLEMOLE_UISWITCHTEAMBATTLELEVELROWWIDGETCONTROLLER_DATA_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0xABAAF50)
#define MOLEMOLE_UISWITCHTEAMBATTLELEVELROWWIDGETCONTROLLER_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0xABAAFB0)

namespace MoleMole
{
	inline static constexpr unsigned int UISwitchTeamBattleLevelRowWidgetController_Data_TypeDefinitionIndex = 69232;
