...
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_UIINLEVELCOUNTDOWNUICONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x99F0B60)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCountDownUIChildWindowController_UIInLevelCountDownUIContext_TypeDefinitionIndex = 39682;
	...
	public:
		...
		::Class_0_16E4307DCC419505_210* newsBubbleSupport; // 0x30
