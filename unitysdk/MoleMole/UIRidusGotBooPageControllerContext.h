...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLERCONTEXT_BUILD_OFFSET UNITYSDK_OFFSET(0xCA83380)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCA83320)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageControllerContext_TypeDefinitionIndex = 47076;

	class UIRidusGotBooPageControllerContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_49*>* PassiveSkills; // 0x28
