...
#define MOLEMOLE_UILOGINPAGECONTROLLER_CANCELLOGIN_OFFSET UNITYSDK_OFFSET(0x7466010)
#define MOLEMOLE_UILOGINPAGECONTROLLER_CLOSELOGIN2_OFFSET UNITYSDK_OFFSET(0x7467540)
#define MOLEMOLE_UILOGINPAGECONTROLLER_CLOSELOGIN_OFFSET UNITYSDK_OFFSET(0x7467120)
#define MOLEMOLE_UILOGINPAGECONTROLLER_COLOSESDKTIPS_OFFSET UNITYSDK_OFFSET(0x7467A00)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ENABLELOGININPUTBLOCK_OFFSET UNITYSDK_OFFSET(0x7468500)
#define MOLEMOLE_UILOGINPAGECONTROLLER_GAMEPADSETDEFAULTSELECT_OFFSET UNITYSDK_OFFSET(0x7463510)
#define MOLEMOLE_UILOGINPAGECONTROLLER_GETLOGINKEY_OFFSET UNITYSDK_OFFSET(0x7462E30)
#define MOLEMOLE_UILOGINPAGECONTROLLER_GETTIPSROOTWIDGET_OFFSET UNITYSDK_OFFSET(0x74607A0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_GETTIPSROOT_OFFSET UNITYSDK_OFFSET(0x74606E0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x7460530)
#define MOLEMOLE_UILOGINPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0x74604F0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_GET_SDKWIGETROOT_OFFSET UNITYSDK_OFFSET(0x7460500)
#define MOLEMOLE_UILOGINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x74604E0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_INITLOGIN_OFFSET UNITYSDK_OFFSET(0x74639B0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_INITSEVERLIST_OFFSET UNITYSDK_OFFSET(0x74644F0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ISDISPATCHFREQUENTATTEMPTS_OFFSET UNITYSDK_OFFSET(0x7465430)
#define MOLEMOLE_UILOGINPAGECONTROLLER_LOGININDISPATCH_OFFSET UNITYSDK_OFFSET(0x7465250)
#define MOLEMOLE_UILOGINPAGECONTROLLER_LOGININGAMESERVER_OFFSET UNITYSDK_OFFSET(0x7465730)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0x7464C00)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7460810)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x7462B30)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ONLOGINERROR_OFFSET UNITYSDK_OFFSET(0x7466B10)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ONLOGINGAMESERVER_OFFSET UNITYSDK_OFFSET(0x7466CB0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ONSDKENTERGAMESUCCESS_OFFSET UNITYSDK_OFFSET(0x7466F50)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ONSDKLOGINSUCCESS_OFFSET UNITYSDK_OFFSET(0x7465AA0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ONSETLANGUAGEVOICE_OFFSET UNITYSDK_OFFSET(0x7468160)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x74605A0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7461FB0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x74608B0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7468580)
#define MOLEMOLE_UILOGINPAGECONTROLLER_OPENAGEDAILOG_OFFSET UNITYSDK_OFFSET(0x7467FE0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_OPENCLOUDPRELOGIN_OFFSET UNITYSDK_OFFSET(0x7467CE0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_OPENDEBUGLOGIN_OFFSET UNITYSDK_OFFSET(0x7467AA0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_OPENRESOURCELOAD_OFFSET UNITYSDK_OFFSET(0x7468350)
#define MOLEMOLE_UILOGINPAGECONTROLLER_OPENSDKLOGIN_OFFSET UNITYSDK_OFFSET(0x7467B30)
#define MOLEMOLE_UILOGINPAGECONTROLLER_OPENSELECTSERVER_OFFSET UNITYSDK_OFFSET(0x7465040)
#define MOLEMOLE_UILOGINPAGECONTROLLER_REFRESHSERVERTEXT_OFFSET UNITYSDK_OFFSET(0x74678E0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_REQUESTSERVERLIST_OFFSET UNITYSDK_OFFSET(0x7464290)
#define MOLEMOLE_UILOGINPAGECONTROLLER_RESETFOCUS_OFFSET UNITYSDK_OFFSET(0x74669B0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_RESETLOGIN_OFFSET UNITYSDK_OFFSET(0x7466380)
#define MOLEMOLE_UILOGINPAGECONTROLLER_SETBESTSERVER_OFFSET UNITYSDK_OFFSET(0x7464AE0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_SETIGNORECUSTOMLISTNAVIGATESTATE_OFFSET UNITYSDK_OFFSET(0x7466720)
#define MOLEMOLE_UILOGINPAGECONTROLLER_SETLOGINMODE_OFFSET UNITYSDK_OFFSET(0x74674D0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_SETLOGINREADY_OFFSET UNITYSDK_OFFSET(0x7465D40)
#define MOLEMOLE_UILOGINPAGECONTROLLER_SETMESSAGEKEY_OFFSET UNITYSDK_OFFSET(0x7462F70)
#define MOLEMOLE_UILOGINPAGECONTROLLER_SETRESOURCEVERSION_OFFSET UNITYSDK_OFFSET(0x74637D0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_SETSERVERBYNAME_OFFSET UNITYSDK_OFFSET(0x74648E0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x7461EE0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_SETVERSIONINFO_OFFSET UNITYSDK_OFFSET(0x7461C90)
#define MOLEMOLE_UILOGINPAGECONTROLLER_SETXBOXIDTAG_OFFSET UNITYSDK_OFFSET(0x7463740)
#define MOLEMOLE_UILOGINPAGECONTROLLER_SHOWSERVERLISTVIEW_OFFSET UNITYSDK_OFFSET(0x74650B0)
#define MOLEMOLE_UILOGINPAGECONTROLLER_STARTLOGINANDLOADRESOURCE_OFFSET UNITYSDK_OFFSET(0x7466430)
#define MOLEMOLE_UILOGINPAGECONTROLLER_STARTLOGINPROCESS_OFFSET UNITYSDK_OFFSET(0x7461D80)
#define MOLEMOLE_UILOGINPAGECONTROLLER_STARTLOGIN_OFFSET UNITYSDK_OFFSET(0x7463F90)
#define MOLEMOLE_UILOGINPAGECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x7464230)
#define MOLEMOLE_UILOGINPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7468710)
#define MOLEMOLE_UILOGINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x74686F0)
#define MOLEMOLE_UILOGINPAGECONTROLLER__LOGININGAMESERVER_B__30_0_OFFSET UNITYSDK_OFFSET(0x74688F0)
#define MOLEMOLE_UILOGINPAGECONTROLLER__ONUIINIT_B__13_0_OFFSET UNITYSDK_OFFSET(0x7468720)
#define MOLEMOLE_UILOGINPAGECONTROLLER__ONUIOPEN_B__58_0_OFFSET UNITYSDK_OFFSET(0x7468A30)
#define MOLEMOLE_UILOGINPAGECONTROLLER__ONUIOPEN_B__58_1_OFFSET UNITYSDK_OFFSET(0x7468A40)
#define MOLEMOLE_UILOGINPAGECONTROLLER__STARTLOGINPROCESS_B__20_0_OFFSET UNITYSDK_OFFSET(0x74687B0)
#define MOLEMOLE_UILOGINPAGECONTROLLER__STARTLOGIN_B__21_0_OFFSET UNITYSDK_OFFSET(0x74687C0)
#define MOLEMOLE_UILOGINPAGECONTROLLER___BASE_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x7468A50)
#define MOLEMOLE_UILOGINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7468A60)
#define MOLEMOLE_UILOGINPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x7468AD0)
#define MOLEMOLE_UILOGINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7468B30)
#define MOLEMOLE_UILOGINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7468B40)
#define MOLEMOLE_UILOGINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7468B50)
#define MOLEMOLE_UILOGINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7468B60)
#define MOLEMOLE_UILOGINPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x7468BD0)

namespace MoleMole
{
	inline static constexpr unsigned int UILoginPageController_TypeDefinitionIndex = 52007;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UILoginPageController_TypeDefinitionIndex)->GetStaticField(0xBC80);
		}
		...
		::Class_2_79F6D62CE30E3F8E_115* _view; // 0x308
