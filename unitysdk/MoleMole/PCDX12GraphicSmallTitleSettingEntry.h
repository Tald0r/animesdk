...
#define MOLEMOLE_PCDX12GRAPHICSMALLTITLESETTINGENTRY_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xA47BC20)
#define MOLEMOLE_PCDX12GRAPHICSMALLTITLESETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xA47BC80)
#define MOLEMOLE_PCDX12GRAPHICSMALLTITLESETTINGENTRY___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xA47BCA0)

namespace MoleMole
{
	inline static constexpr unsigned int PCDX12GraphicSmallTitleSettingEntry_TypeDefinitionIndex = 49233;
