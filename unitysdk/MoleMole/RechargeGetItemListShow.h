...
#define MOLEMOLE_RECHARGEGETITEMLISTSHOW_ORDERCONFIRM_OFFSET UNITYSDK_OFFSET(0xA659440)
#define MOLEMOLE_RECHARGEGETITEMLISTSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xA6593D0)
#define MOLEMOLE_RECHARGEGETITEMLISTSHOW___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xA6595B0)

namespace MoleMole
{
	inline static constexpr unsigned int RechargeGetItemListShow_TypeDefinitionIndex = 72780;
