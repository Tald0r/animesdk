...
#define MOLEMOLE_RECHARGEGETITEMLISTSHOW_ORDERCONFIRM_OFFSET UNITYSDK_OFFSET(0xB3C0C90)
#define MOLEMOLE_RECHARGEGETITEMLISTSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xB3C0C20)
#define MOLEMOLE_RECHARGEGETITEMLISTSHOW___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xB3C0E00)

namespace MoleMole
{
	inline static constexpr unsigned int RechargeGetItemListShow_TypeDefinitionIndex = 78751;
