...
#define MOLEMOLE_TWEENBAR_BEGIN_1_OFFSET UNITYSDK_OFFSET(0xB3EF200)
#define MOLEMOLE_TWEENBAR_BEGIN_OFFSET UNITYSDK_OFFSET(0xB3EF040)
#define MOLEMOLE_TWEENBAR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xB3EE6E0)
#define MOLEMOLE_TWEENBAR_INITINFO_OFFSET UNITYSDK_OFFSET(0xB3EEC10)
#define MOLEMOLE_TWEENBAR_METHOD_7_0BF1620F1E4289BD_OFFSET UNITYSDK_OFFSET(0xB3EE780)
#define MOLEMOLE_TWEENBAR_METHOD_7_60DD2CD26268C60E_OFFSET UNITYSDK_OFFSET(0xB3EECD0)
#define MOLEMOLE_TWEENBAR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB3EEDE0)
#define MOLEMOLE_TWEENBAR_RESETSTART_OFFSET UNITYSDK_OFFSET(0xB3EEF10)
#define MOLEMOLE_TWEENBAR_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xB3EE6F0)
#define MOLEMOLE_TWEENBAR_START_OFFSET UNITYSDK_OFFSET(0xB3EEB50)
#define MOLEMOLE_TWEENBAR__CTOR_OFFSET UNITYSDK_OFFSET(0xB3EF370)
#define MOLEMOLE_TWEENBAR___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB3EF3A0)
#define MOLEMOLE_TWEENBAR___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xB3EF390)
#define MOLEMOLE_TWEENBAR___BASE_START_OFFSET UNITYSDK_OFFSET(0xB3EF400)

namespace MoleMole
{
	inline static constexpr unsigned int TweenBar_TypeDefinitionIndex = 60531;
