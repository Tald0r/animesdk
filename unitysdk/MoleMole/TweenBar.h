...
#define MOLEMOLE_TWEENBAR_BEGIN_1_OFFSET UNITYSDK_OFFSET(0xA687F60)
#define MOLEMOLE_TWEENBAR_BEGIN_OFFSET UNITYSDK_OFFSET(0xA687DA0)
#define MOLEMOLE_TWEENBAR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xA687440)
#define MOLEMOLE_TWEENBAR_INITINFO_OFFSET UNITYSDK_OFFSET(0xA687970)
#define MOLEMOLE_TWEENBAR_METHOD_7_0BF1620F1E4289BD_OFFSET UNITYSDK_OFFSET(0xA6874E0)
#define MOLEMOLE_TWEENBAR_METHOD_7_60DD2CD26268C60E_OFFSET UNITYSDK_OFFSET(0xA687A30)
#define MOLEMOLE_TWEENBAR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA687B40)
#define MOLEMOLE_TWEENBAR_RESETSTART_OFFSET UNITYSDK_OFFSET(0xA687C70)
#define MOLEMOLE_TWEENBAR_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xA687450)
#define MOLEMOLE_TWEENBAR_START_OFFSET UNITYSDK_OFFSET(0xA6878B0)
#define MOLEMOLE_TWEENBAR__CTOR_OFFSET UNITYSDK_OFFSET(0xA6880D0)
#define MOLEMOLE_TWEENBAR___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA688100)
#define MOLEMOLE_TWEENBAR___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xA6880F0)
#define MOLEMOLE_TWEENBAR___BASE_START_OFFSET UNITYSDK_OFFSET(0xA688160)

namespace MoleMole
{
	inline static constexpr unsigned int TweenBar_TypeDefinitionIndex = 39589;
	...
	public:
		...
		::System::Void Method_7_60DD2CD26268C60E(::System::Single a1, ::System::Boolean a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_TWEENBAR_METHOD_7_60DD2CD26268C60E_OFFSET))(this, a1, a2);
		}
		...
		::System::Void Method_7_0BF1620F1E4289BD(::System::Single a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_TWEENBAR_METHOD_7_0BF1620F1E4289BD_OFFSET))(this, a1);
		}
	};
}
