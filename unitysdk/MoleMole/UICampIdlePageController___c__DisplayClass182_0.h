...
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS182_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C96C0)
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS182_0__REFRESHCURRENTQA_B__2_OFFSET UNITYSDK_OFFSET(0xC0C96D0)
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS182_0__REFRESHCURRENTQA_B__4_OFFSET UNITYSDK_OFFSET(0xC0C97B0)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdlePageController___c__DisplayClass182_0_TypeDefinitionIndex = 71286;
	...
	public:
		...
		::Class_2_208CC9941471731A_616* curQuestion; // 0x20
		::Il2CppArray<::Class_2_208CC9941471731A_616*>* questions; // 0x28
		::Il2CppArray<::System::String*>* choiceResArr; // 0x30
		::UnityEngine::Events::UnityAction* __9__4; // 0x38
