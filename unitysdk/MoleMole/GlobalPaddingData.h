...
#define MOLEMOLE_GLOBALPADDINGDATA_METHOD_1_E06B7E07D5241CFE_1_OFFSET UNITYSDK_OFFSET(0xE4850D0)
#define MOLEMOLE_GLOBALPADDINGDATA_METHOD_1_E06B7E07D5241CFE_2_OFFSET UNITYSDK_OFFSET(0xE4851B0)
#define MOLEMOLE_GLOBALPADDINGDATA_METHOD_1_E06B7E07D5241CFE_3_OFFSET UNITYSDK_OFFSET(0xE485270)
#define MOLEMOLE_GLOBALPADDINGDATA_METHOD_1_E06B7E07D5241CFE_OFFSET UNITYSDK_OFFSET(0xE485010)
#define MOLEMOLE_GLOBALPADDINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE485000)

namespace MoleMole
{
	inline static constexpr unsigned int GlobalPaddingData_TypeDefinitionIndex = 57846;
