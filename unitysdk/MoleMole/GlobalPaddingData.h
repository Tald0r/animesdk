...
#define MOLEMOLE_GLOBALPADDINGDATA_METHOD_1_E06B7E07D5241CFE_1_OFFSET UNITYSDK_OFFSET(0xD80D140)
#define MOLEMOLE_GLOBALPADDINGDATA_METHOD_1_E06B7E07D5241CFE_2_OFFSET UNITYSDK_OFFSET(0xD80D200)
#define MOLEMOLE_GLOBALPADDINGDATA_METHOD_1_E06B7E07D5241CFE_3_OFFSET UNITYSDK_OFFSET(0xD80D2C0)
#define MOLEMOLE_GLOBALPADDINGDATA_METHOD_1_E06B7E07D5241CFE_OFFSET UNITYSDK_OFFSET(0xD80D060)
#define MOLEMOLE_GLOBALPADDINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD80D050)

namespace MoleMole
{
	inline static constexpr unsigned int GlobalPaddingData_TypeDefinitionIndex = 41520;
