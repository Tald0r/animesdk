...
#define MOLEMOLE_NEWCONFIGUICOMMON_GETALLSUBCONFIGS_OFFSET UNITYSDK_OFFSET(0xD81C6C0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETBUTTONCLICKCOLDDOWN_OFFSET UNITYSDK_OFFSET(0xD81DFA0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETCARDOPTIONBGCOLOR_OFFSET UNITYSDK_OFFSET(0xD81D240)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETCARDOPTIONRARITYBGCOLOR_OFFSET UNITYSDK_OFFSET(0xD81D500)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETGENERALICONBADGEDATA_OFFSET UNITYSDK_OFFSET(0xD81DD70)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETITEMRARITYBGCOLOR_OFFSET UNITYSDK_OFFSET(0xD81D7F0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETOVERRIDESIZE_OFFSET UNITYSDK_OFFSET(0xD81CE30)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETROLERARITYICONPATH_OFFSET UNITYSDK_OFFSET(0xD81CFB0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETSTANIMAOVERLOADENDEFFECT_OFFSET UNITYSDK_OFFSET(0xD81CC40)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETSTANIMAOVERLOADLOOPEFFECT_OFFSET UNITYSDK_OFFSET(0xD81CA50)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETSTANIMAOVERLOADSTARTEFFECT_OFFSET UNITYSDK_OFFSET(0xD81C860)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETUITOKENDIALOGCONFIGSBYTYPE_OFFSET UNITYSDK_OFFSET(0xD81DAA0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0xD81C5A0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONGAMESTART_OFFSET UNITYSDK_OFFSET(0xD81C410)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONHOLLOWCARD_OFFSET UNITYSDK_OFFSET(0xD81C550)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONI18NIMAGE_OFFSET UNITYSDK_OFFSET(0xD81C600)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONINPUT_OFFSET UNITYSDK_OFFSET(0xD81C660)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONMISC_OFFSET UNITYSDK_OFFSET(0xD81C460)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xD81C4B0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONUIPAGE_OFFSET UNITYSDK_OFFSET(0xD81C500)
#define MOLEMOLE_NEWCONFIGUICOMMON__CCTOR_OFFSET UNITYSDK_OFFSET(0xD81E080)
#define MOLEMOLE_NEWCONFIGUICOMMON__CTOR_OFFSET UNITYSDK_OFFSET(0xD81E050)

namespace MoleMole
{
	inline static constexpr unsigned int NewConfigUICommon_TypeDefinitionIndex = 62582;
	...
	public:
		...
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(NewConfigUICommon_TypeDefinitionIndex)->GetStaticField(0x10780);
		}
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_613*>* _allSubConfigs; // 0x98
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_613*>* GetAllSubConfigs()
		{
			return ((::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_613*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_NEWCONFIGUICOMMON_GETALLSUBCONFIGS_OFFSET))(this);
		}
