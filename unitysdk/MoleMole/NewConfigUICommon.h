...
#define MOLEMOLE_NEWCONFIGUICOMMON_GETALLSUBCONFIGS_OFFSET UNITYSDK_OFFSET(0xB9ACC20)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETBUTTONCLICKCOLDDOWN_OFFSET UNITYSDK_OFFSET(0xB9AE4F0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETCARDOPTIONBGCOLOR_OFFSET UNITYSDK_OFFSET(0xB9AD7A0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETCARDOPTIONRARITYBGCOLOR_OFFSET UNITYSDK_OFFSET(0xB9ADA60)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETGENERALICONBADGEDATA_OFFSET UNITYSDK_OFFSET(0xB9AE2C0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETITEMRARITYBGCOLOR_OFFSET UNITYSDK_OFFSET(0xB9ADD40)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETOVERRIDESIZE_OFFSET UNITYSDK_OFFSET(0xB9AD390)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETROLERARITYICONPATH_OFFSET UNITYSDK_OFFSET(0xB9AD510)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETSTANIMAOVERLOADENDEFFECT_OFFSET UNITYSDK_OFFSET(0xB9AD1A0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETSTANIMAOVERLOADLOOPEFFECT_OFFSET UNITYSDK_OFFSET(0xB9ACFB0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETSTANIMAOVERLOADSTARTEFFECT_OFFSET UNITYSDK_OFFSET(0xB9ACDC0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GETUITOKENDIALOGCONFIGSBYTYPE_OFFSET UNITYSDK_OFFSET(0xB9ADFF0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0xB9ACB00)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONGAMESTART_OFFSET UNITYSDK_OFFSET(0xB9AC970)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONHOLLOWCARD_OFFSET UNITYSDK_OFFSET(0xB9ACAB0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONI18NIMAGE_OFFSET UNITYSDK_OFFSET(0xB9ACB60)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONINPUT_OFFSET UNITYSDK_OFFSET(0xB9ACBC0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONMISC_OFFSET UNITYSDK_OFFSET(0xB9AC9C0)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xB9ACA10)
#define MOLEMOLE_NEWCONFIGUICOMMON_GET_CONFIGUICOMMONUIPAGE_OFFSET UNITYSDK_OFFSET(0xB9ACA60)
#define MOLEMOLE_NEWCONFIGUICOMMON__CCTOR_OFFSET UNITYSDK_OFFSET(0xB9AE5D0)
#define MOLEMOLE_NEWCONFIGUICOMMON__CTOR_OFFSET UNITYSDK_OFFSET(0xB9AE5A0)

namespace MoleMole
{
	inline static constexpr unsigned int NewConfigUICommon_TypeDefinitionIndex = 46542;
	...
	public:
		...
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(NewConfigUICommon_TypeDefinitionIndex)->GetStaticField(0x10740);
		}
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_389*>* _allSubConfigs; // 0x98
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_389*>* GetAllSubConfigs()
		{
			return ((::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_389*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_NEWCONFIGUICOMMON_GETALLSUBCONFIGS_OFFSET))(this);
		}
