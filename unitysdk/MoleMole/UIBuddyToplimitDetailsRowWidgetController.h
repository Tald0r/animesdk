...
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONCLICKGETBTN_OFFSET UNITYSDK_OFFSET(0xBFDD440)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFDC650)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFDC7D0)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONTAKERAWARDHANDLE_OFFSET UNITYSDK_OFFSET(0xBFDD620)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFDC6F0)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFDC440)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_REFRESHBUDDYVIEW_OFFSET UNITYSDK_OFFSET(0xBFDC8B0)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFDD6E0)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFDD770)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFDD7E0)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFDD860)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFDD8E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBuddyToplimitDetailsRowWidgetController_TypeDefinitionIndex = 37405;
	...
	public:
		...
		::Class_1_47F523CB5C537A8A* detailData; // 0x2E8
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONTAKERAWARDHANDLE_OFFSET))(this, rcvMessage);
		}
