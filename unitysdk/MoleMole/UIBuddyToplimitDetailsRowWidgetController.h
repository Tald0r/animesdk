...
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONCLICKGETBTN_OFFSET UNITYSDK_OFFSET(0xBB109D0)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB0FBE0)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBB0FD60)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONTAKERAWARDHANDLE_OFFSET UNITYSDK_OFFSET(0xBB10BB0)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB0FC80)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB0F9E0)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_REFRESHBUDDYVIEW_OFFSET UNITYSDK_OFFSET(0xBB0FE40)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB10C70)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBB10D00)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBB10D70)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBB10DF0)
#define MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB10E70)

namespace MoleMole
{
	inline static constexpr unsigned int UIBuddyToplimitDetailsRowWidgetController_TypeDefinitionIndex = 78338;
	...
	public:
		...
		::MoleMole::UIItemIconBtnSmallWidgetController* _iconBtnSmallWidget; // 0x2E0
		::Class_1_47F523CB5C537A8A_1* detailData; // 0x2E8
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_7*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBUDDYTOPLIMITDETAILSROWWIDGETCONTROLLER_ONTAKERAWARDHANDLE_OFFSET))(this, rcvMessage);
		}
