...
#define MOLEMOLE_UIDAILYQUESTNORMALROWWIDGETCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC60F200)
#define MOLEMOLE_UIDAILYQUESTNORMALROWWIDGETCONTROLLER___C__DISPLAYCLASS7_0__SETSTATE_B__1_OFFSET UNITYSDK_OFFSET(0xC60F2D0)
#define MOLEMOLE_UIDAILYQUESTNORMALROWWIDGETCONTROLLER___C__DISPLAYCLASS7_0__SETSTATE_G__JUMP_0_OFFSET UNITYSDK_OFFSET(0xC60F210)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestNormalRowWidgetController___c__DisplayClass7_0_TypeDefinitionIndex = 54990;
