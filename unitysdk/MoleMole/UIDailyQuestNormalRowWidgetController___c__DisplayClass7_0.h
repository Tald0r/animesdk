...
#define MOLEMOLE_UIDAILYQUESTNORMALROWWIDGETCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0xDF7A370)
#define MOLEMOLE_UIDAILYQUESTNORMALROWWIDGETCONTROLLER___C__DISPLAYCLASS7_0__SETSTATE_B__1_OFFSET UNITYSDK_OFFSET(0xDF7A440)
#define MOLEMOLE_UIDAILYQUESTNORMALROWWIDGETCONTROLLER___C__DISPLAYCLASS7_0__SETSTATE_G__JUMP_0_OFFSET UNITYSDK_OFFSET(0xDF7A380)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestNormalRowWidgetController___c__DisplayClass7_0_TypeDefinitionIndex = 62123;
