...
class Class_2_BFE1A5062E431B57_3;
...
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_CHESSBOARDHANDLEMINIGAMEMOVE_OFFSET UNITYSDK_OFFSET(0xAD5DD90)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_DEFAULTHANDLEMINIGAMEMOVE_OFFSET UNITYSDK_OFFSET(0xAD5DF90)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_GETBUBBLEWIDGET_OFFSET UNITYSDK_OFFSET(0xAD5CD30)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_GETCURCLICKINTERVALTIME_OFFSET UNITYSDK_OFFSET(0xAD5E140)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAD5CD20)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_HANDLEMINIGAMEMOVE_OFFSET UNITYSDK_OFFSET(0xAD5DAE0)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_ISINCLICKPROTECTTIME_OFFSET UNITYSDK_OFFSET(0xAD5DCA0)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD5D3B0)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAD5D600)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD5D450)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD5CDA0)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD5D150)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_PERFORMPUSHBOXGAMEFINISH_OFFSET UNITYSDK_OFFSET(0xAD5E2A0)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAD5CFD0)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD5E460)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD5E470)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAD5E4E0)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD5E510)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD5E520)
#define MOLEMOLE_UIHOLLOWMINIGAMEPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD5E530)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMiniGamePopWindowController_TypeDefinitionIndex = 48295;

	class UIHollowMiniGamePopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_BFE1A5062E431B57_3* _view; // 0x2F8
