...
#define MOLEMOLE_GRAPHICSETTINGPROFILECONTEXTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F85040)

namespace MoleMole
{
	inline static constexpr unsigned int GraphicSettingProfileContextBase_TypeDefinitionIndex = 46996;
