...
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_FORBIDDENCHAT_OFFSET UNITYSDK_OFFSET(0x980A9A0)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_ISFORBIDDEN_OFFSET UNITYSDK_OFFSET(0x980A6C0)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_ONBANBTNCALLBACK_OFFSET UNITYSDK_OFFSET(0x980BA00)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_ONREFRESHFORBIDDENCHATCHANGE_OFFSET UNITYSDK_OFFSET(0x980B250)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_ONSELFINFOCALLBACK_OFFSET UNITYSDK_OFFSET(0x980B410)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x980B020)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0x980AC30)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_REFRESHFORBIDDENUI_OFFSET UNITYSDK_OFFSET(0x980BD80)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_REFRESHFORBIDDEN_OFFSET UNITYSDK_OFFSET(0x980B320)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x980AD90)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x980BE10)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x980BE30)
#define MOLEMOLE_UIINLEVELFRIENDCARDROWWIDGETCONTROLLER___BASE_REFRESHUI_OFFSET UNITYSDK_OFFSET(0x980BE40)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelFriendCardRowWidgetController_TypeDefinitionIndex = 46469;

	class UIInLevelFriendCardRowWidgetController : public ::MoleMole::UIFriendCardRowWidgetController
	{
	public:
		::MoleMole::UIOnlinePlayerItemWidgetController* _onlinePlayerDetailContentWidgetController; // 0x348
