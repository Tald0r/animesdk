...
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_CLEANSTATE_OFFSET UNITYSDK_OFFSET(0xAB604C0)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_DISAPPEAR_OFFSET UNITYSDK_OFFSET(0xAB60E20)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_FADEIN_OFFSET UNITYSDK_OFFSET(0xAB61170)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_FADEOUT_OFFSET UNITYSDK_OFFSET(0xAB61290)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_MOVETOTOP_OFFSET UNITYSDK_OFFSET(0xAB60D00)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB600D0)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB60170)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB60010)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_SETINFO_OFFSET UNITYSDK_OFFSET(0xAB606A0)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_SETPARENT_OFFSET UNITYSDK_OFFSET(0xAB61220)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_UPDATENONERANK_OFFSET UNITYSDK_OFFSET(0xAB60250)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_UPDATERANK_OFFSET UNITYSDK_OFFSET(0xAB60EC0)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB613A0)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB613D0)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB61440)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB614C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMarcelHudRankRowWidgetController_TypeDefinitionIndex = 56653;

	class UIMarcelHudRankRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_A58928D7D947D7A1* _view; // 0x2A0
		::MoleMole::UIGrandMarcelAdventureChildWindowController* _parent; // 0x2A8
		::Class_1_BE6BF7909AD9D940* _info; // 0x2B0
