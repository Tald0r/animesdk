...
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_CLEANSTATE_OFFSET UNITYSDK_OFFSET(0xA210F40)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_DISAPPEAR_OFFSET UNITYSDK_OFFSET(0xA2118A0)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_FADEIN_OFFSET UNITYSDK_OFFSET(0xA211BF0)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_FADEOUT_OFFSET UNITYSDK_OFFSET(0xA211D10)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_MOVETOTOP_OFFSET UNITYSDK_OFFSET(0xA211780)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA210B50)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA210BF0)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA210A90)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_SETINFO_OFFSET UNITYSDK_OFFSET(0xA211120)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_SETPARENT_OFFSET UNITYSDK_OFFSET(0xA211CA0)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_UPDATENONERANK_OFFSET UNITYSDK_OFFSET(0xA210CD0)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER_UPDATERANK_OFFSET UNITYSDK_OFFSET(0xA211940)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA211E20)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA211E50)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA211EC0)
#define MOLEMOLE_UIMARCELHUDRANKROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA211F40)

namespace MoleMole
{
	inline static constexpr unsigned int UIMarcelHudRankRowWidgetController_TypeDefinitionIndex = 78975;
