...
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_CLEARCHAT_OFFSET UNITYSDK_OFFSET(0xC0B7190)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_CLOSECHAT_OFFSET UNITYSDK_OFFSET(0xC0B73C0)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_CONTINUESHOW_OFFSET UNITYSDK_OFFSET(0xC0B72A0)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_ENDTEXT_OFFSET UNITYSDK_OFFSET(0xC0B7E40)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_FADEOUT_OFFSET UNITYSDK_OFFSET(0xC0B7730)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_FINISHTEXT_OFFSET UNITYSDK_OFFSET(0xC0B7DD0)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_FIRSTSHOW_OFFSET UNITYSDK_OFFSET(0xC0B7020)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_GETRESIDUETIME_OFFSET UNITYSDK_OFFSET(0xC0B8060)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_HIDECHAT_OFFSET UNITYSDK_OFFSET(0xC0B77B0)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_INTERRUPT_OFFSET UNITYSDK_OFFSET(0xC0B78D0)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0B7940)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_ONTEXTFINISHED_OFFSET UNITYSDK_OFFSET(0xC0B7F10)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0B79E0)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0B6C60)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_PAUSETEXT_OFFSET UNITYSDK_OFFSET(0xC0B7C70)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_RESUMETEXT_OFFSET UNITYSDK_OFFSET(0xC0B7D20)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_SETCHATTEXT_OFFSET UNITYSDK_OFFSET(0xC0B7A70)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_SETNAMETEXT_OFFSET UNITYSDK_OFFSET(0xC0B7B40)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_SETTEXTDURATION_OFFSET UNITYSDK_OFFSET(0xC0B7F90)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0B80E0)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0B8110)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0B8180)
#define MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0B8190)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaOngoingTipsWidgetController_TypeDefinitionIndex = 75132;
	...
	public:
		...
		::System::Action_2<::Class_2_208CC9941471731A_654*, ::System::Single>* onSetChatText; // 0x2B0
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_654*, ::System::Action*, ::System::Action*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_FIRSTSHOW_OFFSET))(this, config, playSound, callback);
		}

		::System::Void ContinueShow(::Class_2_208CC9941471731A_654* config, ::System::Action* playSound, ::System::Action* callback)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_654*, ::System::Action*, ::System::Action*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_CONTINUESHOW_OFFSET))(this, config, playSound, callback);
		}
		...
		::System::Void SetChatText(::Class_2_208CC9941471731A_654* template_, ::System::Single duration)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_654*, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMAONGOINGTIPSWIDGETCONTROLLER_SETCHATTEXT_OFFSET))(this, template_, duration);
		}
