...
#define MOLEMOLE_CONFIGBULLETTRACINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCB06CF0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigBulletTracingData_TypeDefinitionIndex = 42896;
