...
#define MOLEMOLE_CONFIGBULLETTRACINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xEC49B70)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigBulletTracingData_TypeDefinitionIndex = 51547;
