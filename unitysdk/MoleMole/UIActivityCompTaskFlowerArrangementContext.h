...
#define MOLEMOLE_UIACTIVITYCOMPTASKFLOWERARRANGEMENTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC8D44F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCompTaskFlowerArrangementContext_TypeDefinitionIndex = 45811;
