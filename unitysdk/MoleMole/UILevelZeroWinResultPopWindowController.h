...
#define MOLEMOLE_UILEVELZEROWINRESULTPOPWINDOWCONTROLLER_ACQUIRETITLETEXT_OFFSET UNITYSDK_OFFSET(0x876D580)
#define MOLEMOLE_UILEVELZEROWINRESULTPOPWINDOWCONTROLLER_GETBUTTONCOMBINESTATE_OFFSET UNITYSDK_OFFSET(0x876D460)
#define MOLEMOLE_UILEVELZEROWINRESULTPOPWINDOWCONTROLLER_GETPANELSTATE_OFFSET UNITYSDK_OFFSET(0x876D4C0)
#define MOLEMOLE_UILEVELZEROWINRESULTPOPWINDOWCONTROLLER_ONPOPSHOWED_OFFSET UNITYSDK_OFFSET(0x876D520)
#define MOLEMOLE_UILEVELZEROWINRESULTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x876D680)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelZeroWinResultPopWindowController_TypeDefinitionIndex = 39666;
