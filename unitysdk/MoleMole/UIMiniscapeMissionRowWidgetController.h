...
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_ADDITEMICONBTNSMALLWIDGET_OFFSET UNITYSDK_OFFSET(0x9AB6A10)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_CANGETREWARD_OFFSET UNITYSDK_OFFSET(0x9AB62B0)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_ISREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0x9AB5E10)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_ONCLICKGOBTN_OFFSET UNITYSDK_OFFSET(0x9AB6AE0)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_ONCLICKTAKEREWARD_OFFSET UNITYSDK_OFFSET(0x9AB6880)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9AB5510)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9AB5690)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9AB55B0)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9AB52A0)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9AB5460)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_REFRESHBTNSTATE_OFFSET UNITYSDK_OFFSET(0x9AB5F60)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x9AB5820)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_SHOULDSHOWGOBTN_OFFSET UNITYSDK_OFFSET(0x9AB6400)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB6CC0)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER__ONCLICKTAKEREWARD_B__8_0_OFFSET UNITYSDK_OFFSET(0x9AB6CD0)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9AB6D50)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9AB6DC0)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9AB6E40)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9AB6EC0)
#define MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9AB6F20)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeMissionRowWidgetController_TypeDefinitionIndex = 66315;
	...
	public:
		...
		::Class_2_F69D29AB796376C2* _config; // 0x2D8
		...
		{
			return ((::MoleMole::UIItemIconBtnSmallWidgetController*(*)(::PVOID, ::Enum_3_340DE32BA097F66C, ::System::Func_1<::MoleMole::UIControlReference*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMINISCAPEMISSIONROWWIDGETCONTROLLER_ADDITEMICONBTNSMALLWIDGET_OFFSET))(this, ctrl, arg);
		}
