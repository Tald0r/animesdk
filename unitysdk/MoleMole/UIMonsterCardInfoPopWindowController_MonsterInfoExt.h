...
#define MOLEMOLE_UIMONSTERCARDINFOPOPWINDOWCONTROLLER_MONSTERINFOEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB505A10)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterCardInfoPopWindowController_MonsterInfoExt_TypeDefinitionIndex = 47519;
