...
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_APPLYLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0x68E0550)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0x68DF450)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_GETLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0x68DFB40)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x68DF340)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_0B08B4F8E959C85E_OFFSET UNITYSDK_OFFSET(0x68E0940)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_0B1EB5C9B94BAB66_OFFSET UNITYSDK_OFFSET(0x68DF620)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_15E224C23D482CD3_OFFSET UNITYSDK_OFFSET(0x68E0780)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_1CCA9681CE0AE7A7_OFFSET UNITYSDK_OFFSET(0x68E0870)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x68E0C60)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x68E0BC0)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x68E0BE0)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x68E0BD0)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_F4ADC37B63F4E9EF_1_OFFSET UNITYSDK_OFFSET(0x68E0D20)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0x68DF730)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_METHOD_6_F7AB163354E6802C_OFFSET UNITYSDK_OFFSET(0x68DF950)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x68DF2D0)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x68E0AF0)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x68E0AD0)
#define MOLEMOLE_UIPHYSICALSIZEHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x68E0B30)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhysicalSizeHandler_TypeDefinitionIndex = 71412;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIPhysicalSizeHandler_TypeDefinitionIndex)->GetStaticField(0xCE90);
		}
		static ::UnityEngine::Vector2* StaticGet_Field_6_5()
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(UIPhysicalSizeHandler_TypeDefinitionIndex)->GetStaticField(0xCE94);
		}
