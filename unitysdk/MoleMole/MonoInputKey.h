...
#define MOLEMOLE_MONOINPUTKEY_CLEARGENERALKEYPANEL_OFFSET UNITYSDK_OFFSET(0x8F2A6F0)
#define MOLEMOLE_MONOINPUTKEY_DOCOPYRESET_OFFSET UNITYSDK_OFFSET(0x8F2A760)
#define MOLEMOLE_MONOINPUTKEY_FORCECREATEGENERALKEYPANEL_OFFSET UNITYSDK_OFFSET(0x8F2A8E0)
#define MOLEMOLE_MONOINPUTKEY_GETGENERALKEYPANEL_OFFSET UNITYSDK_OFFSET(0x8F2A420)
#define MOLEMOLE_MONOINPUTKEY_GET_BINDEDBUTTON_OFFSET UNITYSDK_OFFSET(0x8F294D0)
#define MOLEMOLE_MONOINPUTKEY_GET_BINDEDTEXT_OFFSET UNITYSDK_OFFSET(0x8F294F0)
#define MOLEMOLE_MONOINPUTKEY_GET_HANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x8F29490)
#define MOLEMOLE_MONOINPUTKEY_GET_HIDEHINTWHENBUTTONDISABLE_OFFSET UNITYSDK_OFFSET(0x8F294E0)
#define MOLEMOLE_MONOINPUTKEY_GET_HIDEHINTWHENCANNOTNAVIGATETO_OFFSET UNITYSDK_OFFSET(0x8F29540)
#define MOLEMOLE_MONOINPUTKEY_GET_ISCOLLECTED_OFFSET UNITYSDK_OFFSET(0x8F29470)
#define MOLEMOLE_MONOINPUTKEY_GET_ISHANDLELONGPRESS_OFFSET UNITYSDK_OFFSET(0x8F29500)
#define MOLEMOLE_MONOINPUTKEY_GET_ISHIDEHINT_OFFSET UNITYSDK_OFFSET(0x8F29510)
#define MOLEMOLE_MONOINPUTKEY_GET_LOGICEVENT_OFFSET UNITYSDK_OFFSET(0x8F294C0)
#define MOLEMOLE_MONOINPUTKEY_GET_NOTIFICATIONBADGETYPE_OFFSET UNITYSDK_OFFSET(0x8F29520)
#define MOLEMOLE_MONOINPUTKEY_GET_NOTIFICATIONKEY_OFFSET UNITYSDK_OFFSET(0x8F29530)
#define MOLEMOLE_MONOINPUTKEY_GET_PRIORITYLEVEL_OFFSET UNITYSDK_OFFSET(0x8F294A0)
#define MOLEMOLE_MONOINPUTKEY_GET_SPECIALGAMEPADINPUTHINT_OFFSET UNITYSDK_OFFSET(0x8F294B0)
#define MOLEMOLE_MONOINPUTKEY_INITGENERALKEYPANEL_OFFSET UNITYSDK_OFFSET(0x8F2A670)
#define MOLEMOLE_MONOINPUTKEY_INIT_OFFSET UNITYSDK_OFFSET(0x8F29FA0)
#define MOLEMOLE_MONOINPUTKEY_ISCONFIGEMPTY_OFFSET UNITYSDK_OFFSET(0x8F29F30)
#define MOLEMOLE_MONOINPUTKEY_ISWORKABLE_OFFSET UNITYSDK_OFFSET(0x8F29E70)
#define MOLEMOLE_MONOINPUTKEY_METHOD_5_9AF91962BC6E178A_OFFSET UNITYSDK_OFFSET(0x8F295C0)
#define MOLEMOLE_MONOINPUTKEY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8F29550)
#define MOLEMOLE_MONOINPUTKEY_REFRESHGENERALKEYHINTSTATE_OFFSET UNITYSDK_OFFSET(0x8F2A500)
#define MOLEMOLE_MONOINPUTKEY_RESETLAYOUTELEMENTIGNORE_OFFSET UNITYSDK_OFFSET(0x8F2A1B0)
#define MOLEMOLE_MONOINPUTKEY_RESETLOGINEVENTANDTEXT_OFFSET UNITYSDK_OFFSET(0x8F2A950)
#define MOLEMOLE_MONOINPUTKEY_RESETTEXTKEY_OFFSET UNITYSDK_OFFSET(0x8F2A7D0)
#define MOLEMOLE_MONOINPUTKEY_SETGENERALKEYHINTSTATE_OFFSET UNITYSDK_OFFSET(0x8F2A490)
#define MOLEMOLE_MONOINPUTKEY_SETGENERALKEYPANEL_OFFSET UNITYSDK_OFFSET(0x8F2A3B0)
#define MOLEMOLE_MONOINPUTKEY_SET_ISCOLLECTED_OFFSET UNITYSDK_OFFSET(0x8F29480)
#define MOLEMOLE_MONOINPUTKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x8F2AA90)

namespace MoleMole
{
	inline static constexpr unsigned int MonoInputKey_TypeDefinitionIndex = 52547;
	...
	public:
		...
		::System::Void Method_5_9AF91962BC6E178A()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOINPUTKEY_METHOD_5_9AF91962BC6E178A_OFFSET))(this);
		}
	};
}
