...
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GETCURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0xC081AA0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GETDESCTITLEKEY_OFFSET UNITYSDK_OFFSET(0xC082980)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GETMAXLEVEL_OFFSET UNITYSDK_OFFSET(0xC081960)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GETTEMPLATE_OFFSET UNITYSDK_OFFSET(0xC0823B0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GETTITLEKEY_OFFSET UNITYSDK_OFFSET(0xC0828F0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC081250)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC081260)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xC081FD0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC081F40)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC081300)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC081E90)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_REFRESHLAYOUT_OFFSET UNITYSDK_OFFSET(0xC081DE0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_UPDATELEVELITEM_OFFSET UNITYSDK_OFFSET(0xC081BF0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC082A10)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER__UPDATELEVELITEM_B__7_0_OFFSET UNITYSDK_OFFSET(0xC082A30)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC082AD0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xC082B40)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC082BC0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC082BD0)
#define MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC082BE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeLevelInfoDialogPopWindowController_TypeDefinitionIndex = 66678;
	...
	public:
		...
		::Class_2_208CC9941471731A_11* GetTemplate(::System::Int32 level)
		{
			return ((::Class_2_208CC9941471731A_11*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADELEVELINFODIALOGPOPWINDOWCONTROLLER_GETTEMPLATE_OFFSET))(this, level);
		}
