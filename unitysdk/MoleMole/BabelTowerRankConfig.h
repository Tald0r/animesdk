...
#define MOLEMOLE_BABELTOWERRANKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x78E2ED0)

namespace MoleMole
{
	inline static constexpr unsigned int BabelTowerRankConfig_TypeDefinitionIndex = 44413;
