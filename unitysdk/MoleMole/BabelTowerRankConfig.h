...
#define MOLEMOLE_BABELTOWERRANKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8E94190)

namespace MoleMole
{
	inline static constexpr unsigned int BabelTowerRankConfig_TypeDefinitionIndex = 41610;
