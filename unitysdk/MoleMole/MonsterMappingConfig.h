...
#define MOLEMOLE_MONSTERMAPPINGCONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB2EE030)
#define MOLEMOLE_MONSTERMAPPINGCONFIG_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB2EDE00)
#define MOLEMOLE_MONSTERMAPPINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB2EE2F0)
#define MOLEMOLE_MONSTERMAPPINGCONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB2EE400)
#define MOLEMOLE_MONSTERMAPPINGCONFIG___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB2EE410)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterMappingConfig_TypeDefinitionIndex = 39660;
