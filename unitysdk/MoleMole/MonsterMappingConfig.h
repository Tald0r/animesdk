...
#define MOLEMOLE_MONSTERMAPPINGCONFIG_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB862C80)
#define MOLEMOLE_MONSTERMAPPINGCONFIG_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB862A50)
#define MOLEMOLE_MONSTERMAPPINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB862F40)
#define MOLEMOLE_MONSTERMAPPINGCONFIG___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB863050)
#define MOLEMOLE_MONSTERMAPPINGCONFIG___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xB863060)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterMappingConfig_TypeDefinitionIndex = 53929;
