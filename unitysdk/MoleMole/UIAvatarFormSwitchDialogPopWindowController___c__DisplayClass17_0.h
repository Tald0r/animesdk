...
#define MOLEMOLE_UIAVATARFORMSWITCHDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC094B90)
#define MOLEMOLE_UIAVATARFORMSWITCHDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_0__ONCLICKSWITCH_B__0_OFFSET UNITYSDK_OFFSET(0xC094BA0)
#define MOLEMOLE_UIAVATARFORMSWITCHDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_0__ONCLICKSWITCH_B__1_OFFSET UNITYSDK_OFFSET(0xC094CE0)
#define MOLEMOLE_UIAVATARFORMSWITCHDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS17_0__ONCLICKSWITCH_B__2_OFFSET UNITYSDK_OFFSET(0xC094E70)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarFormSwitchDialogPopWindowController___c__DisplayClass17_0_TypeDefinitionIndex = 74984;
	...
	public:
		...
		::System::Int32 controlAvatar; // 0x28
