...
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ACTIVEBUFF_CONVERTTEXT_OFFSET UNITYSDK_OFFSET(0xCFCF410)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ACTIVEBUFF_CORRECTOPTION_OFFSET UNITYSDK_OFFSET(0xCFCFB80)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ACTIVEBUFF_EXADDHP_OFFSET UNITYSDK_OFFSET(0xCFD0860)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ACTIVEBUFF_EXSCORE_OFFSET UNITYSDK_OFFSET(0xCFD0430)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_BEFORESTAGENPC_OFFSET UNITYSDK_OFFSET(0xCFCCD00)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_CANACTIVEBUFF_CONVERTTEXT_OFFSET UNITYSDK_OFFSET(0xCFCEF50)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_CANACTIVEBUFF_CORRECTOPTION_OFFSET UNITYSDK_OFFSET(0xCFCF210)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_CANACTIVEBUFF_EXADDHP_OFFSET UNITYSDK_OFFSET(0xCFCF390)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_CANACTIVEBUFF_EXSCORE_OFFSET UNITYSDK_OFFSET(0xCFCF310)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_CANACTIVEBUFF_OFFSET UNITYSDK_OFFSET(0xCFCE500)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_CANCEL_OFFSET UNITYSDK_OFFSET(0xCFCC790)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_CHECKCHATFINISH_OFFSET UNITYSDK_OFFSET(0xCFCCF90)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_CREATEUIQUESTIONSANSWERCARDITEMROWWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0xCFCAB80)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_CREATEUIQUESTIONSANSWERCHATPLAYWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0xCFCAC60)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ENABLECHEETBUTTON_OFFSET UNITYSDK_OFFSET(0xCFCAD90)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_FADEOUTEMOJI_OFFSET UNITYSDK_OFFSET(0xCFD2350)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_GETBUFFTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xCFCAE50)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_GETBUFFVIEW_OFFSET UNITYSDK_OFFSET(0xCFCAEC0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_GETENDBLACKTEXT_OFFSET UNITYSDK_OFFSET(0xCFCCBB0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_GETFAILBLACKTEXT_OFFSET UNITYSDK_OFFSET(0xCFCCB20)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_GETHPCOLOR_OFFSET UNITYSDK_OFFSET(0xCFCD210)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_GETSTARTBLACKTEXT_OFFSET UNITYSDK_OFFSET(0xCFCB000)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_GET_ENDING_OFFSET UNITYSDK_OFFSET(0xCFCB140)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_GET_PARENTCONTROLLER_OFFSET UNITYSDK_OFFSET(0xCFCB0A0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_GET_PLAYING_OFFSET UNITYSDK_OFFSET(0xCFCB120)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_HIDEEMOJI_OFFSET UNITYSDK_OFFSET(0xCFD22D0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_HIDEFAIRY_OFFSET UNITYSDK_OFFSET(0xCFCBD50)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_INITBUFFSTATE_OFFSET UNITYSDK_OFFSET(0xCFCD690)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ISBLACKSCREEN_OFFSET UNITYSDK_OFFSET(0xCFD2460)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_LOADSCOREIMAGE_OFFSET UNITYSDK_OFFSET(0xCFCE230)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_NARRATORPREDICATE_OFFSET UNITYSDK_OFFSET(0xCFD2A10)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_OBBACKCALLBACK_OFFSET UNITYSDK_OFFSET(0xCFD0E00)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ONCHATFINISH_OFFSET UNITYSDK_OFFSET(0xCFCD000)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ONCHEATSHEETCALLBACK_OFFSET UNITYSDK_OFFSET(0xCFD10A0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ONCLICKNARRATORCALLBACK_OFFSET UNITYSDK_OFFSET(0xCFD0D90)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFCB970)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xCFCBA10)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ONRESTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0xCFD0F50)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCFCB8C0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xCFCBDC0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFCC000)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFCB160)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFCB810)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_PREPARESTARTGAME_OFFSET UNITYSDK_OFFSET(0xCFCCA20)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_REFRESHBUFFLEFTCOUNT_OFFSET UNITYSDK_OFFSET(0xCFCEA90)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_REFRESHBUFFSTATE_OFFSET UNITYSDK_OFFSET(0xCFCEBE0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_RESETBUFFLEFTCOUNT_OFFSET UNITYSDK_OFFSET(0xCFCED90)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_RESETBUFFSTATE_OFFSET UNITYSDK_OFFSET(0xCFCEE50)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_SETCURRENTSCORE_OFFSET UNITYSDK_OFFSET(0xCFCDE00)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_SETHP_OFFSET UNITYSDK_OFFSET(0xCFCD340)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_SETMAXHP_OFFSET UNITYSDK_OFFSET(0xCFCD080)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_SETMAXSCORE_OFFSET UNITYSDK_OFFSET(0xCFCE150)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_SETPLAYBLACKSCREEN_OFFSET UNITYSDK_OFFSET(0xCFD2580)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_SETSCORETEXT_OFFSET UNITYSDK_OFFSET(0xCFCDEE0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_SET_ENDING_OFFSET UNITYSDK_OFFSET(0xCFCB150)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_SET_PLAYING_OFFSET UNITYSDK_OFFSET(0xCFCB130)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_SHOWEMOJI_OFFSET UNITYSDK_OFFSET(0xCFD1D10)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_SHOWERRORFAIRY_OFFSET UNITYSDK_OFFSET(0xCFD1860)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_SHOWFAIRY_OFFSET UNITYSDK_OFFSET(0xCFD0C90)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_STARTGAME_OFFSET UNITYSDK_OFFSET(0xCFCCC50)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_STARTSCOREDOTWEEN_OFFSET UNITYSDK_OFFSET(0xCFD1240)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_TRYACTIVEBUFF_OFFSET UNITYSDK_OFFSET(0xCFCE6E0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_TRYNEXTNPC_OFFSET UNITYSDK_OFFSET(0xCFCCDD0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_TRYTRIGGERBUFF_OFFSET UNITYSDK_OFFSET(0xCFCE2F0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_UPDATEEMOJIPOS_OFFSET UNITYSDK_OFFSET(0xCFCC4A0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCFCC100)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_WAITBLACKSCREENCLICK_OFFSET UNITYSDK_OFFSET(0xCFD2890)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_WAITBLACKSCREENFADEOUT_OFFSET UNITYSDK_OFFSET(0xCFD2950)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_WAITCHAT_OFFSET UNITYSDK_OFFSET(0xCFCCED0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_WAITCLICKCONTINUEBTN_OFFSET UNITYSDK_OFFSET(0xCFD1C50)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_WAITPLAYBLACKSCREENTEXT_OFFSET UNITYSDK_OFFSET(0xCFD27D0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER_WAITPLAYBLACKSCREEN_OFFSET UNITYSDK_OFFSET(0xCFD24D0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFCA8C0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__OBBACKCALLBACK_B__87_0_OFFSET UNITYSDK_OFFSET(0xCFD2C30)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__OBBACKCALLBACK_B__87_1_OFFSET UNITYSDK_OFFSET(0xCFD2E70)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__ONRESTARTCALLBACK_B__88_0_OFFSET UNITYSDK_OFFSET(0xCFD2FB0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__ONRESTARTCALLBACK_B__88_1_OFFSET UNITYSDK_OFFSET(0xCFD31F0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__SETCURRENTSCORE_B__67_0_OFFSET UNITYSDK_OFFSET(0xCFD2A80)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__SETMAXSCORE_B__68_0_OFFSET UNITYSDK_OFFSET(0xCFD2BB0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFD3340)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xCFD33B0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCFD3410)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xCFD3480)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFD3490)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFD3510)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFD3570)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerWidgetController_TypeDefinitionIndex = 66336;

	class UIQuestionsAnswerWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_87* _view; // 0x2A0
