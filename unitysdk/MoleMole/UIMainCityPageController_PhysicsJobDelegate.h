...
#define MOLEMOLE_UIMAINCITYPAGECONTROLLER_PHYSICSJOBDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xCFA0720)
#define MOLEMOLE_UIMAINCITYPAGECONTROLLER_PHYSICSJOBDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xCFA0770)
#define MOLEMOLE_UIMAINCITYPAGECONTROLLER_PHYSICSJOBDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xCFA0430)
#define MOLEMOLE_UIMAINCITYPAGECONTROLLER_PHYSICSJOBDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xCFA0410)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityPageController_PhysicsJobDelegate_TypeDefinitionIndex = 60260;
