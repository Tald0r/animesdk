...
#define MOLEMOLE_UIMAINCITYPAGECONTROLLER_PHYSICSJOBDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC8B58A0)
#define MOLEMOLE_UIMAINCITYPAGECONTROLLER_PHYSICSJOBDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC8B58F0)
#define MOLEMOLE_UIMAINCITYPAGECONTROLLER_PHYSICSJOBDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xC8B55A0)
#define MOLEMOLE_UIMAINCITYPAGECONTROLLER_PHYSICSJOBDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC8B5590)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityPageController_PhysicsJobDelegate_TypeDefinitionIndex = 53402;
