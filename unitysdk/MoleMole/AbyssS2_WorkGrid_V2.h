...
#define MOLEMOLE_ABYSSS2_WORKGRID_V2_EQUALS_OFFSET UNITYSDK_OFFSET(0x2F7480)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2F7490)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3730)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x2F7500)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2F7560)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_WorkGrid_V2_TypeDefinitionIndex = 68788;
