...
#define MOLEMOLE_ABYSSS2_WORKGRID_V2_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B6C60)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B6C70)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2__CTOR_OFFSET UNITYSDK_OFFSET(0x2F3C30)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B6CE0)
#define MOLEMOLE_ABYSSS2_WORKGRID_V2___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B6D40)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_WorkGrid_V2_TypeDefinitionIndex = 77508;
