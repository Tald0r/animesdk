...
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xC265760)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GETCURLAYER_OFFSET UNITYSDK_OFFSET(0xC263810)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GETEFFECTIVESCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xC266070)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GETMAXLAYER_OFFSET UNITYSDK_OFFSET(0xC263A60)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GETSORTEDGOODS_OFFSET UNITYSDK_OFFSET(0xC267040)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_CURSELECTEDGOODSID_OFFSET UNITYSDK_OFFSET(0xC2654E0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xC2625C0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_INBUYTAB_OFFSET UNITYSDK_OFFSET(0xC2625D0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_INCONSOLE_OFFSET UNITYSDK_OFFSET(0xC265700)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_INSELLTAB_OFFSET UNITYSDK_OFFSET(0xC2625E0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0xC265630)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_NETHANDLER_OFFSET UNITYSDK_OFFSET(0xC265570)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_UID_OFFSET UNITYSDK_OFFSET(0xC2659B0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC2625F0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_INITHPBAR_OFFSET UNITYSDK_OFFSET(0xC266100)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCLICKBTNBUY_OFFSET UNITYSDK_OFFSET(0xC264A50)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCLICKBTNSELL_OFFSET UNITYSDK_OFFSET(0xC2653E0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCLICKHPINFO_OFFSET UNITYSDK_OFFSET(0xC263720)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCLICKMAP_OFFSET UNITYSDK_OFFSET(0xC263400)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCLICKPACKAGE_OFFSET UNITYSDK_OFFSET(0xC263590)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCLICKREFRESHGOODS_OFFSET UNITYSDK_OFFSET(0xC266CA0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC262600)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONDATAUPDATE_OFFSET UNITYSDK_OFFSET(0xC263BC0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xC2676F0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONITEMCHANGE_OFFSET UNITYSDK_OFFSET(0xC264840)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONSCROLLVIEWSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0xC265470)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONTOGGLECHANGE_OFFSET UNITYSDK_OFFSET(0xC263150)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC2673D0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC2626A0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC2659C0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0xC263290)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHHPBAR_OFFSET UNITYSDK_OFFSET(0xC267200)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHITEMSVIEW_OFFSET UNITYSDK_OFFSET(0xC2648C0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHOUTERUI_OFFSET UNITYSDK_OFFSET(0xC263E80)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHSCROLLVIEWITEMS_OFFSET UNITYSDK_OFFSET(0xC264AE0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHSHOPDATA_OFFSET UNITYSDK_OFFSET(0xC263C40)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHTOGGLETEXT_OFFSET UNITYSDK_OFFSET(0xC2631D0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHTOKENS_OFFSET UNITYSDK_OFFSET(0xC266610)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_SETCURSELECTGOODS_OFFSET UNITYSDK_OFFSET(0xC2652B0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2677C0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER__REFRESHSCROLLVIEWITEMS_B__59_0_OFFSET UNITYSDK_OFFSET(0xC267850)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER__REFRESHSCROLLVIEWITEMS_B__59_1_OFFSET UNITYSDK_OFFSET(0xC2678F0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC267B20)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC267B90)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC267BA0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC267BB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAreaShopPageController_TypeDefinitionIndex = 43002;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_73* _view; // 0x300
		...
		::Class_3_9F091E965E210217_30* m_curSelectedBuyGoods; // 0x318
		::Class_3_E27FF972D6A12E8E_1* m_curSelectedSellGoods; // 0x320
		...
		::System::Collections::Generic::List_1<::Class_3_9F091E965E210217_30*>* m_globalBuyGoodsList; // 0x340
		::System::Collections::Generic::List_1<::Class_3_9F091E965E210217_30*>* m_buyGoodsList; // 0x348
		::System::Collections::Generic::List_1<::Class_3_E27FF972D6A12E8E_1*>* m_sellGoodsList; // 0x350
		...
		{
			return ((::System::Collections::Generic::List_1<::Class_3_9F091E965E210217_30*>*(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_3_9F091E965E210217_30*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIAREASHOPPAGECONTROLLER_GETSORTEDGOODS_OFFSET))(this, goodsIDList);
		}
