...
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xC296DA0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GETCURLAYER_OFFSET UNITYSDK_OFFSET(0xC294E70)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GETEFFECTIVESCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xC2976B0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GETMAXLAYER_OFFSET UNITYSDK_OFFSET(0xC2950C0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GETSORTEDGOODS_OFFSET UNITYSDK_OFFSET(0xC298680)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_CURSELECTEDGOODSID_OFFSET UNITYSDK_OFFSET(0xC296B30)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xC293C10)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_INBUYTAB_OFFSET UNITYSDK_OFFSET(0xC293C20)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_INCONSOLE_OFFSET UNITYSDK_OFFSET(0xC296D40)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_INSELLTAB_OFFSET UNITYSDK_OFFSET(0xC293C30)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0xC296C80)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_NETHANDLER_OFFSET UNITYSDK_OFFSET(0xC296BC0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_UID_OFFSET UNITYSDK_OFFSET(0xC296FF0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC293C40)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_INITHPBAR_OFFSET UNITYSDK_OFFSET(0xC297740)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCLICKBTNBUY_OFFSET UNITYSDK_OFFSET(0xC2960A0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCLICKBTNSELL_OFFSET UNITYSDK_OFFSET(0xC296A30)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCLICKHPINFO_OFFSET UNITYSDK_OFFSET(0xC294D80)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCLICKMAP_OFFSET UNITYSDK_OFFSET(0xC294A60)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCLICKPACKAGE_OFFSET UNITYSDK_OFFSET(0xC294BF0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCLICKREFRESHGOODS_OFFSET UNITYSDK_OFFSET(0xC2982E0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC293C50)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONDATAUPDATE_OFFSET UNITYSDK_OFFSET(0xC295210)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xC298D30)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONITEMCHANGE_OFFSET UNITYSDK_OFFSET(0xC295E90)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONSCROLLVIEWSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0xC296AC0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONTOGGLECHANGE_OFFSET UNITYSDK_OFFSET(0xC2947B0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC298A10)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC293CF0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC297000)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0xC2948F0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHHPBAR_OFFSET UNITYSDK_OFFSET(0xC298840)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHITEMSVIEW_OFFSET UNITYSDK_OFFSET(0xC295F10)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHOUTERUI_OFFSET UNITYSDK_OFFSET(0xC2954D0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHSCROLLVIEWITEMS_OFFSET UNITYSDK_OFFSET(0xC296130)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHSHOPDATA_OFFSET UNITYSDK_OFFSET(0xC295290)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHTOGGLETEXT_OFFSET UNITYSDK_OFFSET(0xC294830)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_REFRESHTOKENS_OFFSET UNITYSDK_OFFSET(0xC297C50)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_SETCURSELECTGOODS_OFFSET UNITYSDK_OFFSET(0xC296900)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC298E00)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER__REFRESHSCROLLVIEWITEMS_B__59_0_OFFSET UNITYSDK_OFFSET(0xC298E90)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER__REFRESHSCROLLVIEWITEMS_B__59_1_OFFSET UNITYSDK_OFFSET(0xC298F30)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC299160)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC2991D0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC2991E0)
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC2991F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAreaShopPageController_TypeDefinitionIndex = 66718;

	class UIAreaShopPageController : public ::MoleMole::UIWindowController
	{
	public:
		// static const ::System::String* MuteLogicTimerTag; // 0x0
		::MoleMole::UIAreaShopPageController_TabType m_curTabType; // 0x2F8
		::Class_2_79AE422BA06F6D26_181* _view; // 0x300
		::MoleMole::UIGeneralToggleWidgetControllerWithModel* toggle; // 0x308
		::MoleMole::UIAbyssS2InfoBtnWidgetController* _infoButton; // 0x310
		::Class_3_9F091E965E210217_5* m_curSelectedBuyGoods; // 0x318
		::Class_3_E27FF972D6A12E8E* m_curSelectedSellGoods; // 0x320
		::System::Collections::Generic::List_1<::MoleMole::UIAreaGoodsWidgetController*>* m_goodsList; // 0x328
		::MoleMole::UIAreaShopPageController_Context* m_ctx; // 0x330
		::System::UInt32 m_uid; // 0x338
		::System::Int32 _currencyID; // 0x33C
		::System::Collections::Generic::List_1<::Class_3_9F091E965E210217_5*>* m_globalBuyGoodsList; // 0x340
		::System::Collections::Generic::List_1<::Class_3_9F091E965E210217_5*>* m_buyGoodsList; // 0x348
		::System::Collections::Generic::List_1<::Class_3_E27FF972D6A12E8E*>* m_sellGoodsList; // 0x350
		::System::UInt32 m_shopID; // 0x358
		::System::Collections::Generic::List_1<::MoleMole::UIAreaGoodsWidgetController*>* m_ctrlList; // 0x360
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::UIAbyssS2TalentItemWidgetController*>* m_ctrlDict; // 0x368
		::System::Collections::Generic::List_1<::MoleMole::UIAreaShopRoleWidgetController*>* _areaShopList; // 0x370
		::System::Boolean _needShowLeft; // 0x378
		...
		::System::Collections::Generic::List_1<::Class_3_9F091E965E210217_5*>* GetSortedGoods(::System::Collections::Generic::List_1<::Class_3_9F091E965E210217_5*>* goodsIDList)
		{
			return ((::System::Collections::Generic::List_1<::Class_3_9F091E965E210217_5*>*(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_3_9F091E965E210217_5*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIAREASHOPPAGECONTROLLER_GETSORTEDGOODS_OFFSET))(this, goodsIDList);
		}
