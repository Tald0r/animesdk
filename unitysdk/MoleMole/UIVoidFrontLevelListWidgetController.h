...
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_AFTERSHOW_OFFSET UNITYSDK_OFFSET(0xA08CE30)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA08CAE0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_GMREFRESH_OFFSET UNITYSDK_OFFSET(0xA08D320)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA08CB50)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA08CD80)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA08CC50)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_REFRESHWIDGET_OFFSET UNITYSDK_OFFSET(0xA08D030)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_SETNODECLICKCB_OFFSET UNITYSDK_OFFSET(0xA08D210)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_SETTABSELECTCB_OFFSET UNITYSDK_OFFSET(0xA08D110)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_TRYOVERRIDESELECTONFOCUS_OFFSET UNITYSDK_OFFSET(0xA08CF00)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA08D3F0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER___BASE_AFTERSHOW_OFFSET UNITYSDK_OFFSET(0xA08D420)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA08D430)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA08D4A0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA08D510)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER___BASE_TRYOVERRIDESELECTONFOCUS_OFFSET UNITYSDK_OFFSET(0xA08D570)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontLevelListWidgetController_TypeDefinitionIndex = 79051;
	...
	public:
		...
		::System::Void RefreshWidget(::Enum_3_121CF606CB7E9CD1_1 difficulty, ::System::Int32 focusNodeId, ::System::Boolean playAnim)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_121CF606CB7E9CD1_1, ::System::Int32, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_REFRESHWIDGET_OFFSET))(this, difficulty, focusNodeId, playAnim);
		}

		::System::Void SetTabSelectCb(::System::Action_1<::Enum_3_121CF606CB7E9CD1_1>* onSelectTab)
		{
			return ((::System::Void(*)(::PVOID, ::System::Action_1<::Enum_3_121CF606CB7E9CD1_1>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_SETTABSELECTCB_OFFSET))(this, onSelectTab);
		}
