...
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_AFTERSHOW_OFFSET UNITYSDK_OFFSET(0x971FE20)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x971FAD0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_GMREFRESH_OFFSET UNITYSDK_OFFSET(0x9720320)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x971FB40)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x971FD70)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x971FC40)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_REFRESHWIDGET_OFFSET UNITYSDK_OFFSET(0x9720020)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_SETNODECLICKCB_OFFSET UNITYSDK_OFFSET(0x9720210)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_SETTABSELECTCB_OFFSET UNITYSDK_OFFSET(0x9720100)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER_TRYOVERRIDESELECTONFOCUS_OFFSET UNITYSDK_OFFSET(0x971FEF0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x97203F0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER___BASE_AFTERSHOW_OFFSET UNITYSDK_OFFSET(0x9720420)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9720430)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x97204A0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9720510)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTWIDGETCONTROLLER___BASE_TRYOVERRIDESELECTONFOCUS_OFFSET UNITYSDK_OFFSET(0x9720570)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontLevelListWidgetController_TypeDefinitionIndex = 60715;
