...
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER_CLEARCACHE_OFFSET UNITYSDK_OFFSET(0xA91ABF0)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER_CLOSEVIEW_OFFSET UNITYSDK_OFFSET(0xA91B0A0)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0xA91A9D0)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA91ADE0)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA91AC60)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA91AB30)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA91AD00)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA91A9E0)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA91AA80)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER_REFRESHVISIBILITY_OFFSET UNITYSDK_OFFSET(0xA91AFE0)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER_TICKPOS_OFFSET UNITYSDK_OFFSET(0xA91B110)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA91B760)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA91B790)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA91B800)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA91B810)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA91B890)
#define MOLEMOLE_UIETHEREYESOBJECTPOINTWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA91B8F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEtherEyesObjectPointWidgetController_TypeDefinitionIndex = 75118;

	class UIEtherEyesObjectPointWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_9E5C60401935EF42_2* _view; // 0x2A0
