...
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_GET_OPENSCORERANDOM_OFFSET UNITYSDK_OFFSET(0xB9A8200)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_ISFULLRANDOM_OFFSET UNITYSDK_OFFSET(0xB9A8220)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_ISSPLITRANDOM_OFFSET UNITYSDK_OFFSET(0xB9A8290)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_SETNUMBER_OFFSET UNITYSDK_OFFSET(0xB9A8410)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_SET_OPENSCORERANDOM_OFFSET UNITYSDK_OFFSET(0xB9A8210)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_STARTNORMALRANDOM_OFFSET UNITYSDK_OFFSET(0xB9A8F90)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_STARTROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0xB9A92B0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_UPDATE_OFFSET UNITYSDK_OFFSET(0xB9A8800)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A9560)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__FLUSHRUNDIGITSTONUM_OFFSET UNITYSDK_OFFSET(0xB9A9130)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__FULLANYRANDOM_OFFSET UNITYSDK_OFFSET(0xB9A8B40)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__GETCURVEDURATION_OFFSET UNITYSDK_OFFSET(0xB9A91E0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__GETMAXNUMBERTAG_OFFSET UNITYSDK_OFFSET(0xB9A8300)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__GETPARTINTERVAL_OFFSET UNITYSDK_OFFSET(0xB9A9020)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__ONTOTALDIGIT_OFFSET UNITYSDK_OFFSET(0xB9A8190)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__SETREALNUMBER_OFFSET UNITYSDK_OFFSET(0xB9A8510)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__SPLITRANDOM_OFFSET UNITYSDK_OFFSET(0xB9A8C10)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__TRYRANDOM_OFFSET UNITYSDK_OFFSET(0xB9A8AB0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__TRYROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0xB9A88F0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY___FULLANYRANDOM_G____GETCURVALUE_41_0_OFFSET UNITYSDK_OFFSET(0xB9A9700)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY___FULLANYRANDOM_G____GETRANDOMINTERVAL_41_1_OFFSET UNITYSDK_OFFSET(0xB9A9000)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY___TRYROLLTOTARGET_G___ROLLPART_51_0_OFFSET UNITYSDK_OFFSET(0xB9A9360)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIImageNumberWithKUnity_TypeDefinitionIndex = 71393;
