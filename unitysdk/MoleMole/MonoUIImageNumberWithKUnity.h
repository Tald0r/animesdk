...
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_GET_OPENSCORERANDOM_OFFSET UNITYSDK_OFFSET(0xD818410)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_ISFULLRANDOM_OFFSET UNITYSDK_OFFSET(0xD818430)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_ISSPLITRANDOM_OFFSET UNITYSDK_OFFSET(0xD8184A0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_SETNUMBER_OFFSET UNITYSDK_OFFSET(0xD818620)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_SET_OPENSCORERANDOM_OFFSET UNITYSDK_OFFSET(0xD818420)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_STARTNORMALRANDOM_OFFSET UNITYSDK_OFFSET(0xD8191A0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_STARTROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0xD8194C0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY_UPDATE_OFFSET UNITYSDK_OFFSET(0xD818A10)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__CTOR_OFFSET UNITYSDK_OFFSET(0xD819770)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__FLUSHRUNDIGITSTONUM_OFFSET UNITYSDK_OFFSET(0xD819340)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__FULLANYRANDOM_OFFSET UNITYSDK_OFFSET(0xD818D50)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__GETCURVEDURATION_OFFSET UNITYSDK_OFFSET(0xD8193F0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__GETMAXNUMBERTAG_OFFSET UNITYSDK_OFFSET(0xD818510)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__GETPARTINTERVAL_OFFSET UNITYSDK_OFFSET(0xD819230)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__ONTOTALDIGIT_OFFSET UNITYSDK_OFFSET(0xD8183A0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__SETREALNUMBER_OFFSET UNITYSDK_OFFSET(0xD818720)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__SPLITRANDOM_OFFSET UNITYSDK_OFFSET(0xD818E20)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__TRYRANDOM_OFFSET UNITYSDK_OFFSET(0xD818CC0)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY__TRYROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0xD818B00)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY___FULLANYRANDOM_G____GETCURVALUE_41_0_OFFSET UNITYSDK_OFFSET(0xD819910)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY___FULLANYRANDOM_G____GETRANDOMINTERVAL_41_1_OFFSET UNITYSDK_OFFSET(0xD819210)
#define MOLEMOLE_MONOUIIMAGENUMBERWITHKUNITY___TRYROLLTOTARGET_G___ROLLPART_51_0_OFFSET UNITYSDK_OFFSET(0xD819570)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIImageNumberWithKUnity_TypeDefinitionIndex = 48602;
