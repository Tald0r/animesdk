...
#define MOLEMOLE_IMONOMODELSHAPEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x6E2B440)

namespace MoleMole
{
	inline static constexpr unsigned int IMonoModelShapeElement_TypeDefinitionIndex = 46227;
