...
#define MOLEMOLE_SCROLLVIEWARROW_AWAKE_OFFSET UNITYSDK_OFFSET(0x8A89D00)
#define MOLEMOLE_SCROLLVIEWARROW_HIDEARROW_OFFSET UNITYSDK_OFFSET(0x8A8A0E0)
#define MOLEMOLE_SCROLLVIEWARROW_METHOD_5_19CCC07C980409E4_1_OFFSET UNITYSDK_OFFSET(0x8A8A850)
#define MOLEMOLE_SCROLLVIEWARROW_METHOD_5_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x8A8A540)
#define MOLEMOLE_SCROLLVIEWARROW_METHOD_5_4D9E1AC61B60D577_OFFSET UNITYSDK_OFFSET(0x8A8A150)
#define MOLEMOLE_SCROLLVIEWARROW_METHOD_5_6C28F1129EF1A082_OFFSET UNITYSDK_OFFSET(0x8A8A5E0)
#define MOLEMOLE_SCROLLVIEWARROW_METHOD_5_C8110F9A5AB27813_OFFSET UNITYSDK_OFFSET(0x8A89EC0)
#define MOLEMOLE_SCROLLVIEWARROW_METHOD_5_F6EB917C5A67C7BA_OFFSET UNITYSDK_OFFSET(0x8A89E40)
#define MOLEMOLE_SCROLLVIEWARROW_SETARROWSTATE_OFFSET UNITYSDK_OFFSET(0x8A89D70)
#define MOLEMOLE_SCROLLVIEWARROW_SETENDHINT_OFFSET UNITYSDK_OFFSET(0x8A8A390)
#define MOLEMOLE_SCROLLVIEWARROW_SETSTARTHINT_OFFSET UNITYSDK_OFFSET(0x8A8A200)
#define MOLEMOLE_SCROLLVIEWARROW_SHOWARROW_OFFSET UNITYSDK_OFFSET(0x8A8A070)
#define MOLEMOLE_SCROLLVIEWARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x8A8A520)

namespace MoleMole
{
	inline static constexpr unsigned int ScrollViewArrow_TypeDefinitionIndex = 41672;
