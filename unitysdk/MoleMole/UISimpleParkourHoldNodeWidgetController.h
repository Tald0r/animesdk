...
#define MOLEMOLE_UISIMPLEPARKOURHOLDNODEWIDGETCONTROLLER_GET__HOLDNODEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAB72BB0)
#define MOLEMOLE_UISIMPLEPARKOURHOLDNODEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAB72C10)
#define MOLEMOLE_UISIMPLEPARKOURHOLDNODEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB72CD0)
#define MOLEMOLE_UISIMPLEPARKOURHOLDNODEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAB72D00)

namespace MoleMole
{
	inline static constexpr unsigned int UISimpleParkourHoldNodeWidgetController_TypeDefinitionIndex = 54180;
