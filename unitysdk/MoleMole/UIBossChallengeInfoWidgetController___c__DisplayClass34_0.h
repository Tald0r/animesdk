...
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER___C__DISPLAYCLASS34_0__CTOR_OFFSET UNITYSDK_OFFSET(0xADB83A0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER___C__DISPLAYCLASS34_0__OPENSELECTROLEPAGE_B__0_OFFSET UNITYSDK_OFFSET(0xADB8960)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER___C__DISPLAYCLASS34_0__OPENSELECTROLEPAGE_B__1_OFFSET UNITYSDK_OFFSET(0xADB83B0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER___C__DISPLAYCLASS34_0__OPENSELECTROLEPAGE_B__2_OFFSET UNITYSDK_OFFSET(0xADB86B0)
#define MOLEMOLE_UIBOSSCHALLENGEINFOWIDGETCONTROLLER___C__DISPLAYCLASS34_0__OPENSELECTROLEPAGE_B__3_OFFSET UNITYSDK_OFFSET(0xADB88A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeInfoWidgetController___c__DisplayClass34_0_TypeDefinitionIndex = 49478;
