...
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x9597F60)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9596B80)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x9597DD0)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9596D00)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9596C20)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9596960)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x95970C0)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_SETCLICKCHECKACTION_OFFSET UNITYSDK_OFFSET(0x9597C60)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x9596E20)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER_UPDATECOOPUP_OFFSET UNITYSDK_OFFSET(0x9597CD0)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9598030)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x9598040)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9598050)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x95980C0)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9598130)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95981B0)
#define MOLEMOLE_UITABBTNROLELISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9598230)

namespace MoleMole
{
	inline static constexpr unsigned int UITabBtnRoleListRowWidgetController_TypeDefinitionIndex = 50569;

	class UITabBtnRoleListRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_143* _view; // 0x2D0
		::Class_1_2CCC5D7984CDCED4* _data; // 0x2D8
