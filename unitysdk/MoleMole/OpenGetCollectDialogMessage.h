...
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0xA656ED0)
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xA656EC0)
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xA656F20)
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA656EE0)

namespace MoleMole
{
	inline static constexpr unsigned int OpenGetCollectDialogMessage_TypeDefinitionIndex = 55565;
