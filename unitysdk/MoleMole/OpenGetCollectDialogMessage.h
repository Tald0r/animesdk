...
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0xB3BE720)
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xB3BE710)
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xB3BE770)
#define MOLEMOLE_OPENGETCOLLECTDIALOGMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB3BE730)

namespace MoleMole
{
	inline static constexpr unsigned int OpenGetCollectDialogMessage_TypeDefinitionIndex = 47594;
