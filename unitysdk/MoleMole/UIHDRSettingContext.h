...
#define MOLEMOLE_UIHDRSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8C161D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHDRSettingContext_TypeDefinitionIndex = 74476;
