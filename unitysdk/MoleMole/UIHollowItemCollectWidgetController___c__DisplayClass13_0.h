...
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x7A74FA0)
#define MOLEMOLE_UIHOLLOWITEMCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS13_0__PLAYGRIDCOLLECTIONDATA_G____EFFECTFINISHCALLBACK_0_OFFSET UNITYSDK_OFFSET(0x7A74FB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemCollectWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 62669;
