...
#define MOLEMOLE_COMMONNEWBIEDISPLAYMESSAGE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xB460440)
#define MOLEMOLE_COMMONNEWBIEDISPLAYMESSAGE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xB460450)
#define MOLEMOLE_COMMONNEWBIEDISPLAYMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB4603F0)

namespace MoleMole
{
	inline static constexpr unsigned int CommonNewbieDisplayMessage_TypeDefinitionIndex = 46841;
