...
#define MOLEMOLE_GETAVATARSKINPACKAGEBANNERSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xB5EB3F0)
#define MOLEMOLE_GETAVATARSKINPACKAGEBANNERSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xB5EB440)
#define MOLEMOLE_GETAVATARSKINPACKAGEBANNERSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xB5EB400)

namespace MoleMole
{
	inline static constexpr unsigned int GetAvatarSkinPackageBannerShow_TypeDefinitionIndex = 76554;
