...
#define MOLEMOLE_GETAVATARSKINPACKAGEBANNERSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x6AFBC40)
#define MOLEMOLE_GETAVATARSKINPACKAGEBANNERSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x6AFBC90)
#define MOLEMOLE_GETAVATARSKINPACKAGEBANNERSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x6AFBC50)

namespace MoleMole
{
	inline static constexpr unsigned int GetAvatarSkinPackageBannerShow_TypeDefinitionIndex = 41853;
