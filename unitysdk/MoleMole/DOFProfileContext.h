...
#define MOLEMOLE_DOFPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15ED76F0)

namespace MoleMole
{
	inline static constexpr unsigned int DOFProfileContext_TypeDefinitionIndex = 46815;
