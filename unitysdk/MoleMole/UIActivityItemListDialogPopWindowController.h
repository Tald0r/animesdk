...
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_AFTERCREATEITEMDATA_OFFSET UNITYSDK_OFFSET(0xB963DF0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_CANSELECT_OFFSET UNITYSDK_OFFSET(0xB963FF0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xB963610)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB962D90)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_INITSCROLLLIST_OFFSET UNITYSDK_OFFSET(0xB963530)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ISEQUIPED_OFFSET UNITYSDK_OFFSET(0xB963800)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ISLOCK_OFFSET UNITYSDK_OFFSET(0xB963F10)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ISSELECT_OFFSET UNITYSDK_OFFSET(0xB964410)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONBEFORESELECT_OFFSET UNITYSDK_OFFSET(0xB963F80)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONCONFIRMBTN_OFFSET UNITYSDK_OFFSET(0xB963460)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0xB9634D0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB963330)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0xB9640A0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB9633D0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB962DA0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB962F10)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_REFRESHDATALIST_OFFSET UNITYSDK_OFFSET(0xB963880)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0xB963180)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER__AFTERCREATEITEMDATA_B__14_0_OFFSET UNITYSDK_OFFSET(0xB964620)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB964490)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER__INITSCROLLLIST_B__11_0_OFFSET UNITYSDK_OFFSET(0xB9645A0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB964940)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB9649B0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB9649C0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB9649D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityItemListDialogPopWindowController_TypeDefinitionIndex = 74946;

	class UIActivityItemListDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_DAA2287413BF9E42* _view; // 0x2F8
		::System::Int32 questid; // 0x300
		::MoleMole::UITowerBuffListDialogContext* context; // 0x308
		::System::Int32 MAXCOUNT; // 0x310
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::UIBuffListItemRowWidgetController_BuffListItemData*>* buffDataDic; // 0x318
		::System::Collections::Generic::List_1<::System::Int32>* EquipedData; // 0x320
		::System::Collections::Generic::List_1<::System::Int32>* NewEquipedData; // 0x328
		...
		{
			return ((::MoleMole::UIBuffListItemRowWidgetController_BuffListItemData*(*)(::PVOID, ::Class_2_208CC9941471731A_53*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_CREATEITEM_OFFSET))(this, template_);
		}
