...
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_AFTERCREATEITEMDATA_OFFSET UNITYSDK_OFFSET(0xB8F3320)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_CANSELECT_OFFSET UNITYSDK_OFFSET(0xB8F3520)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xB8F2B30)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB8F22C0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_INITSCROLLLIST_OFFSET UNITYSDK_OFFSET(0xB8F2A60)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ISEQUIPED_OFFSET UNITYSDK_OFFSET(0xB8F2D20)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ISLOCK_OFFSET UNITYSDK_OFFSET(0xB8F3440)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ISSELECT_OFFSET UNITYSDK_OFFSET(0xB8F3950)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONBEFORESELECT_OFFSET UNITYSDK_OFFSET(0xB8F34B0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONCONFIRMBTN_OFFSET UNITYSDK_OFFSET(0xB8F2990)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0xB8F2A00)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB8F2860)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0xB8F35D0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB8F2900)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB8F22D0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB8F2440)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_REFRESHDATALIST_OFFSET UNITYSDK_OFFSET(0xB8F2DA0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_REFRESHDATA_OFFSET UNITYSDK_OFFSET(0xB8F26B0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER__AFTERCREATEITEMDATA_B__14_0_OFFSET UNITYSDK_OFFSET(0xB8F3B60)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB8F39D0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER__INITSCROLLLIST_B__11_0_OFFSET UNITYSDK_OFFSET(0xB8F3AE0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB8F3E80)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB8F3EF0)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB8F3F00)
#define MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB8F3F10)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityItemListDialogPopWindowController_TypeDefinitionIndex = 45105;
	...
	public:
		...
		{
			return ((::MoleMole::UIBuffListItemRowWidgetController_BuffListItemData*(*)(::PVOID, ::Class_2_208CC9941471731A_240*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYITEMLISTDIALOGPOPWINDOWCONTROLLER_CREATEITEM_OFFSET))(this, template_);
		}
