...
#define MOLEMOLE_UIBATTLEPORTAL_HADALZONEV2PAGECONTROLLER_UIBATTLEPORTAL_HADALZONEV2PAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB91C1B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBattlePortal_HadalZoneV2PageController_UIBattlePortal_HadalZoneV2PageContext_TypeDefinitionIndex = 49360;
