...
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_BUILDLEVELDESC_OFFSET UNITYSDK_OFFSET(0xB718B60)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_CHANGEEXPAND_OFFSET UNITYSDK_OFFSET(0xB7168B0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_CLEANDYNAMICINFO_OFFSET UNITYSDK_OFFSET(0xB7173A0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_INITBACKAGEROLEVIEW_OFFSET UNITYSDK_OFFSET(0xB719310)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_INITICONVIEW_OFFSET UNITYSDK_OFFSET(0xB719230)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_INITRELICVIEW_OFFSET UNITYSDK_OFFSET(0xB716BC0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_INITTAROTCARD_OFFSET UNITYSDK_OFFSET(0xB717680)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_INSERTRELICLEVELVIEW_OFFSET UNITYSDK_OFFSET(0xB718290)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_INSERTRELICSKILLVIEW_OFFSET UNITYSDK_OFFSET(0xB717D70)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_ONBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xB716780)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0xB719B50)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB716240)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB7163C0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0xB7198B0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB7162E0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB716030)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_REFRESHICONVIEW_OFFSET UNITYSDK_OFFSET(0xB719950)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0xB716480)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_SETEXPAND_OFFSET UNITYSDK_OFFSET(0xB716930)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB719BC0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB719CA0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB719D10)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB719D90)
#define MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB719E10)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapInLevelRelicRowWidgetController_TypeDefinitionIndex = 60637;
	...
	public:
		...
		::Class_2_208CC9941471731A_608* _relicConfig; // 0x310
		::Class_2_208CC9941471731A_53* _itemConfig; // 0x318
		...
		::System::Void InsertRelicLevelView(::Class_2_208CC9941471731A_213* levelConfig, ::System::Boolean divide, ::System::Boolean light, ::System::Boolean hideLevel, ::System::Int32 upgradeCardCount, ::System::String* cardIconPath, ::System::Boolean briefDesc)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_213*, ::System::Boolean, ::System::Boolean, ::System::Boolean, ::System::Int32, ::System::String*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_INSERTRELICLEVELVIEW_OFFSET))(this, levelConfig, divide, light, hideLevel, upgradeCardCount, cardIconPath, briefDesc);
		}
		...
		{
			return ((::System::String*(*)(::PVOID, ::Class_2_208CC9941471731A_213*, ::MoleMole::GradientColor*, ::System::Boolean, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2MAPINLEVELRELICROWWIDGETCONTROLLER_BUILDLEVELDESC_OFFSET))(this, levelConfig, gradientColor, light, hideLevel, briefDesc);
		}
