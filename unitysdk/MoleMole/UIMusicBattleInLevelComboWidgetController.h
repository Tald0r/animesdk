...
#define MOLEMOLE_UIMUSICBATTLEINLEVELCOMBOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x68D4390)
#define MOLEMOLE_UIMUSICBATTLEINLEVELCOMBOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x68D4430)
#define MOLEMOLE_UIMUSICBATTLEINLEVELCOMBOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x68D3FB0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELCOMBOWIDGETCONTROLLER_SETSCORE_OFFSET UNITYSDK_OFFSET(0x68D4080)
#define MOLEMOLE_UIMUSICBATTLEINLEVELCOMBOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x68D4510)
#define MOLEMOLE_UIMUSICBATTLEINLEVELCOMBOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x68D4540)
#define MOLEMOLE_UIMUSICBATTLEINLEVELCOMBOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x68D45B0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELCOMBOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x68D4630)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelComboWidgetController_TypeDefinitionIndex = 47376;
