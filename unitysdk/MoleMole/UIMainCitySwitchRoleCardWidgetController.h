...
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0xA1FE190)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA1FDF30)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xA1FE2E0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA1FE0B0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONSERVERFORMDATACHANGED_OFFSET UNITYSDK_OFFSET(0xA1FD1E0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA1FDFD0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA1FCFC0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0xA1FD400)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_REFRESHFORM_OFFSET UNITYSDK_OFFSET(0xA1FDC80)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA1FE4C0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA1FE4B0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0xA1FE4D0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA1FE550)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xA1FE5C0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA1FE630)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA1FE6B0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA1FE730)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySwitchRoleCardWidgetController_TypeDefinitionIndex = 56178;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMainCitySwitchRoleCardWidgetController_TypeDefinitionIndex)->GetStaticField(0xA740);
		}
		::Class_2_126D16B1AF601722* _view; // 0x2D0
		::MoleMole::UIMainCitySwitchRoleCardWidgetController_Context* _context; // 0x2D8
		::System::Action_1<::MoleMole::UIMainCitySwitchRoleCardWidgetController_Context*>* _clickAction; // 0x2E0
