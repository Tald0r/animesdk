...
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_HIDEALL_OFFSET UNITYSDK_OFFSET(0xAB4D740)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB4D4E0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAB4D890)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAB4D660)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONSERVERFORMDATACHANGED_OFFSET UNITYSDK_OFFSET(0xAB4C790)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB4D580)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB4C580)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0xAB4C9B0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER_REFRESHFORM_OFFSET UNITYSDK_OFFSET(0xAB4D230)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xAB4DA70)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB4DA60)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0xAB4DA80)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB4DB00)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAB4DB70)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAB4DBE0)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB4DC60)
#define MOLEMOLE_UIMAINCITYSWITCHROLECARDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB4DCE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySwitchRoleCardWidgetController_TypeDefinitionIndex = 78888;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMainCitySwitchRoleCardWidgetController_TypeDefinitionIndex)->GetStaticField(0xA270);
		}
