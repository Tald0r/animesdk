...
#define MOLEMOLE_UIINLEVELASTRAPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x6C9E630)
#define MOLEMOLE_UIINLEVELASTRAPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x6C9DE70)
#define MOLEMOLE_UIINLEVELASTRAPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x6C9E1A0)
#define MOLEMOLE_UIINLEVELASTRAPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x6C9E2C0)
#define MOLEMOLE_UIINLEVELASTRAPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x6C9DFF0)
#define MOLEMOLE_UIINLEVELASTRAPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C9DE80)
#define MOLEMOLE_UIINLEVELASTRAPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C9DF20)
#define MOLEMOLE_UIINLEVELASTRAPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6C9E6F0)
#define MOLEMOLE_UIINLEVELASTRAPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x6C9E780)
#define MOLEMOLE_UIINLEVELASTRAPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C9E7E0)
#define MOLEMOLE_UIINLEVELASTRAPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C9E850)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelAstraPanelChildWindowController_TypeDefinitionIndex = 52327;
	...
	public:
		...
		::Class_2_53FDDB62C05D7434* _view; // 0x330
		::System::Collections::Generic::List_1<::MoleMole::UIInLevelAstraChildWindowController*>* _childCtrlers; // 0x338
