...
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOWSETTINGS_CONFIGGALGAMEAVATARSHOWSETTINGS_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xE0C4750)
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOWSETTINGS_CONFIGGALGAMEAVATARSHOWSETTINGS_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xE0C4760)
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOWSETTINGS_CONFIGGALGAMEAVATARSHOWSETTINGS_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xE0C48B0)
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOWSETTINGS_CONFIGGALGAMEAVATARSHOWSETTINGS_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xE0C4A10)
#define MOLEMOLE_CONFIGGALGAMEAVATARSHOWSETTINGS_CONFIGGALGAMEAVATARSHOWSETTINGS_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xE0C49D0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigGalGameAvatarShowSettings_ConfigGalGameAvatarShowSettings_UnityGeneratedFormatter_TypeDefinitionIndex = 39967;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::AvatarShowSetting*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigGalGameAvatarShowSettings_ConfigGalGameAvatarShowSettings_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3FED0);
		}
