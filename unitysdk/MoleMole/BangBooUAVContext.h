...
#define MOLEMOLE_BANGBOOUAVCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x89DDB80)

namespace MoleMole
{
	inline static constexpr unsigned int BangBooUAVContext_TypeDefinitionIndex = 61714;
