...
#define MOLEMOLE_BANGBOOUAVCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB37D740)

namespace MoleMole
{
	inline static constexpr unsigned int BangBooUAVContext_TypeDefinitionIndex = 41135;
