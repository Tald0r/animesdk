...
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8084060)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x80841E0)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8084100)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8083FC0)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x80843B0)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x80843C0)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8084430)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x80844B0)
#define MOLEMOLE_UIGENERALFAIRYDETAILTITLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8084530)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralFairyDetailTitleWidgetController_TypeDefinitionIndex = 47151;

	class UIGeneralFairyDetailTitleWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_8127D35606966C67_16* _view; // 0x2D0
