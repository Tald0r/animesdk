...
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCB4B4C0)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___C__DISPLAYCLASS3_0__ONUIOPEN_B__0_OFFSET UNITYSDK_OFFSET(0xCB4B4D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralBlackMaskController___c__DisplayClass3_0_TypeDefinitionIndex = 49499;
