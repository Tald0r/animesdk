...
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY_CLEANUP_OFFSET UNITYSDK_OFFSET(0x6ED7CB0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY_INIT_OFFSET UNITYSDK_OFFSET(0x6ED7840)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY_ISINSTANTSKILLTYPE_OFFSET UNITYSDK_OFFSET(0x6ED7D80)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY_ONADD_OFFSET UNITYSDK_OFFSET(0x6ED79B0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x6ED7E00)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x6ED7B40)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x6ED7EB0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY___BASE_CLEANUP_OFFSET UNITYSDK_OFFSET(0x6ED7ED0)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x6ED7F50)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY___BASE_ISINSTANTSKILLTYPE_OFFSET UNITYSDK_OFFSET(0x6ED8000)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY___BASE_ONADD_OFFSET UNITYSDK_OFFSET(0x6ED8060)
#define MOLEMOLE_SUMMEREVENTDRONESUBSYSTEM_WEAPONSKILLTRIGGERABILITY___BASE_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x6ED80C0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventDroneSubsystem_WeaponSkillTriggerAbility_TypeDefinitionIndex = 71337;
