...
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_CLEARREWARDS_OFFSET UNITYSDK_OFFSET(0xBA1AD50)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_ONCLICKTAKEREWARD_OFFSET UNITYSDK_OFFSET(0xBA1AEF0)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBA19EC0)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBA19F60)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_ONTAKEREWARDSUCCESS_OFFSET UNITYSDK_OFFSET(0xBA1B2A0)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBA19D60)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_REFRESHREWARD_OFFSET UNITYSDK_OFFSET(0xBA1A800)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBA1A2E0)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_SETROWSTATE_OFFSET UNITYSDK_OFFSET(0xBA1A0D0)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBA1B310)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBA1B3A0)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBA1B410)
#define MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBA1B490)

namespace MoleMole
{
	inline static constexpr unsigned int InterKnowCourseRewardListRowWidgetController_TypeDefinitionIndex = 44302;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_INTERKNOWCOURSEREWARDLISTROWWIDGETCONTROLLER_ONTAKEREWARDSUCCESS_OFFSET))(this, rcvMessage);
		}
