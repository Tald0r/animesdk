...
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS46_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA8521A0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS46_0__ONPLAYCGEND_B__0_OFFSET UNITYSDK_OFFSET(0xA852F70)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___C__DISPLAYCLASS46_0__ONPLAYCGEND_B__3_OFFSET UNITYSDK_OFFSET(0xA853080)

namespace MoleMole
{
	inline static constexpr unsigned int UIPerformPageController___c__DisplayClass46_0_TypeDefinitionIndex = 63756;
