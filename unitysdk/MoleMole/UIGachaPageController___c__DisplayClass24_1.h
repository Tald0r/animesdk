...
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS24_1__CTOR_OFFSET UNITYSDK_OFFSET(0xA28ECD0)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS24_1__REFRESHGACHATABS_B__4_OFFSET UNITYSDK_OFFSET(0xA28ECE0)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS24_1__REFRESHGACHATABS_B__5_OFFSET UNITYSDK_OFFSET(0xA28EFC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPageController___c__DisplayClass24_1_TypeDefinitionIndex = 39391;
