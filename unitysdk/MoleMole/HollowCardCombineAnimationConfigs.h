...
#define MOLEMOLE_HOLLOWCARDCOMBINEANIMATIONCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0xA397EB0)

namespace MoleMole
{
	inline static constexpr unsigned int HollowCardCombineAnimationConfigs_TypeDefinitionIndex = 63518;
