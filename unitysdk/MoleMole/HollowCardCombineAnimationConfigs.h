...
#define MOLEMOLE_HOLLOWCARDCOMBINEANIMATIONCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x82DD5B0)

namespace MoleMole
{
	inline static constexpr unsigned int HollowCardCombineAnimationConfigs_TypeDefinitionIndex = 47599;
