...
#define MOLEMOLE_DITHERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x13FB0650)

namespace MoleMole
{
	inline static constexpr unsigned int DitherConfig_TypeDefinitionIndex = 67579;
	...
	public:
		...
		::System::String* PartDitherAlphaConfigName; // 0x20
		...
		::System::Boolean BornDither; // 0x44
		::System::Boolean MpDisconnectDither; // 0x45
