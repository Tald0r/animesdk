...
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x94219E0)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9421AC0)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9421890)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9421930)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_SETREWARDACTIVE_OFFSET UNITYSDK_OFFSET(0x9421BA0)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_SETREWARDMES_OFFSET UNITYSDK_OFFSET(0x9421C30)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_SETTITLEANDDES_OFFSET UNITYSDK_OFFSET(0x9421D10)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x94221D0)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9422280)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x94222F0)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9422370)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x94223D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMissionRow03WidgetController_TypeDefinitionIndex = 41927;

	class UIHollowMissionRow03WidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_C9DDE9730C6BE395_2* _view; // 0x2A0
		::System::Collections::Generic::List_1<::UnityEngine::UI::Text*>* cacheText; // 0x2A8
