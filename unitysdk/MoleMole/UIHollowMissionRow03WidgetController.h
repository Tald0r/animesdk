...
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x99E4C80)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x99E4D60)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x99E4B30)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x99E4BD0)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_SETREWARDACTIVE_OFFSET UNITYSDK_OFFSET(0x99E4E40)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_SETREWARDMES_OFFSET UNITYSDK_OFFSET(0x99E4ED0)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER_SETTITLEANDDES_OFFSET UNITYSDK_OFFSET(0x99E4FB0)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x99E5470)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x99E5510)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x99E5580)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x99E5600)
#define MOLEMOLE_UIHOLLOWMISSIONROW03WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x99E5660)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMissionRow03WidgetController_TypeDefinitionIndex = 63817;

	class UIHollowMissionRow03WidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_C9DDE9730C6BE395_8* _view; // 0x2A0
