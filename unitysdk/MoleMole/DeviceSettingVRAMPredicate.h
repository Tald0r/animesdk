...
#define MOLEMOLE_DEVICESETTINGVRAMPREDICATE_GETPREDICATEFLOAT_OFFSET UNITYSDK_OFFSET(0x8F60C90)
#define MOLEMOLE_DEVICESETTINGVRAMPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F60D00)
#define MOLEMOLE_DEVICESETTINGVRAMPREDICATE___BASE_GETPREDICATEFLOAT_OFFSET UNITYSDK_OFFSET(0x8F60D60)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingVRAMPredicate_TypeDefinitionIndex = 72565;
