...
#define MOLEMOLE_POPMONSTERCARDDELIVERSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x9852290)
#define MOLEMOLE_POPMONSTERCARDDELIVERSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x98522E0)
#define MOLEMOLE_POPMONSTERCARDDELIVERSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x98522A0)

namespace MoleMole
{
	inline static constexpr unsigned int PopMonsterCardDeliverShow_TypeDefinitionIndex = 67852;
