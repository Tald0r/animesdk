...
#define MOLEMOLE_UIHOLLOWRELICOPTIONSUPGRADEPOPWINDOWCONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x97FDE20)
#define MOLEMOLE_UIHOLLOWRELICOPTIONSUPGRADEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x97FDF00)
#define MOLEMOLE_UIHOLLOWRELICOPTIONSUPGRADEPOPWINDOWCONTROLLER___BASE_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x97FDF10)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowRelicOptionsUpGradePopWindowController_TypeDefinitionIndex = 67705;
