...
#define MOLEMOLE_UIHOLLOWRELICOPTIONSUPGRADEPOPWINDOWCONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x89338C0)
#define MOLEMOLE_UIHOLLOWRELICOPTIONSUPGRADEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x89339A0)
#define MOLEMOLE_UIHOLLOWRELICOPTIONSUPGRADEPOPWINDOWCONTROLLER___BASE_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x89339B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowRelicOptionsUpGradePopWindowController_TypeDefinitionIndex = 40468;
