...
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_AFTERREFRESHSTAGEONEFRAME_OFFSET UNITYSDK_OFFSET(0x7A33DA0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_CHECKRARITYTV_OFFSET UNITYSDK_OFFSET(0x7A37790)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_FIRETVEFFECT_OFFSET UNITYSDK_OFFSET(0x7A36070)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETCURPLAYERCONDITION_OFFSET UNITYSDK_OFFSET(0x7A346F0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETLIGHTCUTSCENEATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x7A32650)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETRARITYEFFDELAY_OFFSET UNITYSDK_OFFSET(0x7A366B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETSCREENPLAYDATAFROM_1_OFFSET UNITYSDK_OFFSET(0xBF1BE20)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETSCREENPLAYDATAFROM_OFFSET UNITYSDK_OFFSET(0xBF1BCD0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETUIPREFABPATH_OFFSET UNITYSDK_OFFSET(0xBF20110)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETUITEXTMOVEDISTANE_OFFSET UNITYSDK_OFFSET(0x7A324A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_ANIMACHECKMODE_OFFSET UNITYSDK_OFFSET(0x7A38AE0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_BLUEPRINT_NAME_OFFSET UNITYSDK_OFFSET(0x7A38980)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_CURCHARACTERLIGHTTIMELINEGO_OFFSET UNITYSDK_OFFSET(0x7A35F80)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_CURMODEL_OFFSET UNITYSDK_OFFSET(0x7A389A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_CURTIMESCALE_OFFSET UNITYSDK_OFFSET(0x7A35DA0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x7A389B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_ISANIMATORSPEEDCTRLED_OFFSET UNITYSDK_OFFSET(0x7A37D20)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0x7A38990)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_RARITY_TV_INDEX_OFFSET UNITYSDK_OFFSET(0x7A38970)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_SHAKEITEMGO_OFFSET UNITYSDK_OFFSET(0x7A34AE0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_TOTAL_TV_NUM_OFFSET UNITYSDK_OFFSET(0x7A38960)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET__ISNONGACHA_OFFSET UNITYSDK_OFFSET(0x7A389D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLECREATESUMMONS_OFFSET UNITYSDK_OFFSET(0xBF1F6C0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEONOPEN_OFFSET UNITYSDK_OFFSET(0xBF1B790)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEREMOVESUMMONS_OFFSET UNITYSDK_OFFSET(0xBF1EE20)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLESUMMONENTITYONCLOSEUPTLCHANGE_OFFSET UNITYSDK_OFFSET(0x7A38200)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEUITEXTMATONREFRESH_OFFSET UNITYSDK_OFFSET(0xBF20710)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEUPDATE_OFFSET UNITYSDK_OFFSET(0xBF1B4D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ISVIDEOTVINDEX_OFFSET UNITYSDK_OFFSET(0xBF1BF70)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBF1AF00)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_NEXTITEM_OFFSET UNITYSDK_OFFSET(0x7A34320)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONCAMERASHAKE_OFFSET UNITYSDK_OFFSET(0x7A38130)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONCLOSEUPTLEND_OFFSET UNITYSDK_OFFSET(0x7A383B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONCLOSEUPTLSTART_OFFSET UNITYSDK_OFFSET(0x7A38190)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONTIMESCALECHANGED_OFFSET UNITYSDK_OFFSET(0x7A37820)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBF19EC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF1A620)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF19A80)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF19B70)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYBLUEPRINT_OFFSET UNITYSDK_OFFSET(0x7A32F30)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYCHARACTERLIGHTSTL_OFFSET UNITYSDK_OFFSET(0x7A34B90)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYITEMSHAKE_OFFSET UNITYSDK_OFFSET(0x7A36F90)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYSTAGETEXSHEETBYBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x7A326B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYSTAGETEXSHEET_OFFSET UNITYSDK_OFFSET(0x7A328A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYSUMMONSBORNANIMATION_OFFSET UNITYSDK_OFFSET(0x7A38420)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYTVEFFECTANIMLASTFRAME_OFFSET UNITYSDK_OFFSET(0x7A36BD0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYTVEFFECTANIM_OFFSET UNITYSDK_OFFSET(0x7A369B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PRELOADITEMSTAGE_OFFSET UNITYSDK_OFFSET(0xBF1BFE0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REALSHOWCHARACTERLIGHTSV2_OFFSET UNITYSDK_OFFSET(0x7A351C0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REALSHOWCHARACTERLIGHTS_OFFSET UNITYSDK_OFFSET(0x7A34CA0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REFRESHITEMSTAGE_1_OFFSET UNITYSDK_OFFSET(0xBF1FF30)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REFRESHITEMSTAGE_OFFSET UNITYSDK_OFFSET(0xBF1C090)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REFRESHSTAGE_OFFSET UNITYSDK_OFFSET(0x7A33430)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REMOVECURENTITY_OFFSET UNITYSDK_OFFSET(0xBF1F330)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_RESETUITEXT_1_OFFSET UNITYSDK_OFFSET(0xBF20370)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_RESETUITEXT_OFFSET UNITYSDK_OFFSET(0xBF20250)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_SETSUMMONSTIMESCALE_OFFSET UNITYSDK_OFFSET(0x7A37F00)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_SETTVMATPROPERTY_OFFSET UNITYSDK_OFFSET(0x7A376D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x7A389C0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPALLTVS_OFFSET UNITYSDK_OFFSET(0x7A32DB0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPPLAY_OFFSET UNITYSDK_OFFSET(0x7A34780)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPSOUND_OFFSET UNITYSDK_OFFSET(0x7A34B30)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPTVEFFECTANIM_OFFSET UNITYSDK_OFFSET(0x7A36D80)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPTV_OFFSET UNITYSDK_OFFSET(0x7A32CC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_UPDATESUMMONSANIMATORMANUALLY_OFFSET UNITYSDK_OFFSET(0x7A386A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_UPDATETVS_OFFSET UNITYSDK_OFFSET(0xBF1B540)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xBF19AF0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x7A38BF0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__REFRESHITEMSTAGE_B__18_0_OFFSET UNITYSDK_OFFSET(0x7A39160)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__REFRESHSTAGE_B__40_0_OFFSET UNITYSDK_OFFSET(0x7A391D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7A391E0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7A391F0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7A39200)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7A39210)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStage3DModelControllerBase_TypeDefinitionIndex = 60223;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* _toHideModels; // 0x340
		::System::Int32 _characterTemplateID; // 0x348
		::System::Collections::Generic::Dictionary_2<::Foundation::AssetPath, ::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*>* _loadedSummonGos; // 0x350
		::System::Collections::Generic::Dictionary_2<::Foundation::AssetPath, ::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*>* _usedSummonGos; // 0x358
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* _summonEntitys; // 0x360
		::MoleMole::Config::ConfigEntityTimeSlow* _timeSlowConfig; // 0x368
		::Class_1_CC527FA3839977FC* _timeSlowData; // 0x370
		::System::String* PreTexSheetStart_Tv; // 0x378
		::System::String* PreTexSheetLoop_Tv; // 0x380
		::System::String* PreTexSheetEnd_Tv; // 0x388
		::System::String* TexSheetStart_Tv; // 0x390
		::System::String* TexSheetLoop_Tv; // 0x398
		::System::String* TexSheetEnd_Tv; // 0x3A0
		::System::String* AnimationKeyDelay; // 0x3A8
		::System::String* ModelAnimatorCom; // 0x3B0
		::System::String* CamShakeKey; // 0x3B8
		::System::String* CamRotDuration; // 0x3C0
		::System::String* IfRefreshStage; // 0x3C8
		::System::String* AllowToNext; // 0x3D0
		::System::String* AvatarAnimOffset; // 0x3D8
		::System::String* UITextMoveDuration; // 0x3E0
		::System::String* UITextMoveCurve; // 0x3E8
		::System::String* UITextTwinkleDuration; // 0x3F0
		::System::String* UITextTwinkleCurve; // 0x3F8
		::System::String* UITextTwinkleMaxAlpha; // 0x400
		::System::String* UITextSpeedUpScale; // 0x408
		::System::String* UITextFadeOutDelaySpeedUp; // 0x410
		::System::String* UITextFadeInSuspend; // 0x418
		::System::String* UITextFadeInCurve; // 0x420
		::System::String* UITextFadeInMaxAlpha; // 0x428
		::System::String* IsNextItemBtnClicked; // 0x430
		::System::String* ItemNameKey; // 0x438
		::System::String* ItemNameText; // 0x440
		::System::String* ItemNameAnim; // 0x448
		::System::String* UITextUpGo; // 0x450
		::System::String* UITextLeftGo; // 0x458
		::System::String* UITextRightGo; // 0x460
		::System::String* UITextMidGo; // 0x468
		::System::String* RarityEffectPattern; // 0x470
		::System::String* RarityEffectPatternSpecial; // 0x478
		::System::String* StageRarityEffectPattern; // 0x480
		::System::String* CamRarityEffectPattern_Openning; // 0x488
		::System::String* CamRarityEffectPattern_ItemStage; // 0x490
		::System::String* CamRarityEffectPattern_Common; // 0x498
		::System::String* MonoCGCustomGlobalAnimationGo; // 0x4A0
		::System::String* MonoCGCustomGlobalAnimationGo1; // 0x4A8
		::System::String* MonoCGCustomGlobalAnimationGo2; // 0x4B0
		::System::String* CGCustomGlobalAnimationOpenCurve; // 0x4B8
		::System::String* CGCustomGlobalAnimationOpenDuration; // 0x4C0
		::System::String* CGCustomGlobalAnimationCloseCurve; // 0x4C8
		::System::String* CGCustomGlobalAnimationCloseDuration; // 0x4D0
		::System::String* IsRarityS; // 0x4D8
		::System::String* TvRarityEffShowInterval; // 0x4E0
		::System::String* TvRarityEffAnimShowInterval; // 0x4E8
		::System::String* RaritySPerformInterval; // 0x4F0
		::System::String* IsRarityTv; // 0x4F8
		::System::String* TvRarityEffAnim; // 0x500
		::System::String* TvCommonEffAnim_ItemStage; // 0x508
		::System::String* UITextColor; // 0x510
		::System::String* UITextIntensityCurve; // 0x518
		::System::String* UITextIntensityDuration; // 0x520
		::System::String* CamEff_Rotate_Delay; // 0x528
		::System::String* HasRarityS; // 0x530
		::System::String* NeedStopCloseupTL; // 0x538
		::System::Collections::Generic::List_1<::UnityEngine::Renderer*>* _tvRenders; // 0x540
		::System::Collections::Generic::List_1<::MoleMole::ScreenPlayer*>* _screenPlayers; // 0x548
		::System::Collections::Generic::List_1<::TextureFrameScreenPlayData*>* _startScreenDatas; // 0x550
		::System::Collections::Generic::List_1<::TextureFrameScreenPlayData*>* _loopScreenDatas; // 0x558
		::System::Collections::Generic::List_1<::TextureFrameScreenPlayData*>* _endScreenDatas; // 0x560
		::System::Collections::Generic::List_1<::VideoScreenPlayData*>* _startVideoScreenDatas; // 0x568
		::System::Collections::Generic::List_1<::VideoScreenPlayData*>* _loopVideoScreenDatas; // 0x570
		::System::Collections::Generic::List_1<::VideoScreenPlayData*>* _endVideoScreenDatas; // 0x578
		::Class_1_F50B5EAC0B6702FB* _player; // 0x580
		::UnityEngine::Transform* _characterLightsTimelineRoot; // 0x588
		::Class_2_208CC9941471731A_471* _itemPerformTemplate; // 0x590
		::UnityEngine::GameObject* _curModel; // 0x598
		::UnityEngine::Vector3 _startLocalPos; // 0x5A0
		::MoleMole::Battle::Entity* _curEntity; // 0x5B0
		::UnityEngine::GameObject* _contentRootGo; // 0x5B8
		::System::Boolean _IsActive_k__BackingField; // 0x5C0
		::System::Collections::Generic::Dictionary_2<::Foundation::AssetPath, ::UnityEngine::GameObject*>* _loadedModels; // 0x5C8
		::System::Collections::Generic::Dictionary_2<::Foundation::AssetPath, ::UnityEngine::GameObject*>* _loadedUITextModels; // 0x5D0
		::System::String* _Color; // 0x5D8
		::System::String* _ChannelA; // 0x5E0
		::Class_2_208CC9941471731A_894* _gachaPerformTamplate; // 0x5E8
		::System::Collections::Generic::List_1<::UnityEngine::Light*>* _allLights; // 0x5F0
		::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::GameObject*>* _loadedCharacterLightsTLs; // 0x5F8
		::UnityEngine::Playables::PlayableDirector* _curCharacterLightsDirector; // 0x600
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*>* _loadedTvEffects; // 0x608
		::Class_2_5F64140FAB2210F3* _camClip; // 0x610
		::Foundation::AssetPath _lastModelPrefabPath; // 0x618
		...
		::System::Void PlayBlueprint(::System::Single camRotateDuration, ::Class_2_208CC9941471731A_471* tamplate, ::System::Action* blueprintEndCb, ::System::Int32 performedPhaseCount, ::System::Int32 totalPhaseCount, ::System::String* overrideBlueprint)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single, ::Class_2_208CC9941471731A_471*, ::System::Action*, ::System::Int32, ::System::Int32, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYBLUEPRINT_OFFSET))(this, camRotateDuration, tamplate, blueprintEndCb, performedPhaseCount, totalPhaseCount, overrideBlueprint);
		}
		...
		::Class_1_F50B5EAC0B6702FB* get_Player()
		{
			return ((::Class_1_F50B5EAC0B6702FB*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_PLAYER_OFFSET))(this);
		}
