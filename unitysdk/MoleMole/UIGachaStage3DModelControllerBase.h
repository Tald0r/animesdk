...
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_AFTERREFRESHSTAGEONEFRAME_OFFSET UNITYSDK_OFFSET(0xA98AE20)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_CHECKRARITYTV_OFFSET UNITYSDK_OFFSET(0xA98E5A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_FIRETVEFFECT_OFFSET UNITYSDK_OFFSET(0xA98CEB0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETCURPLAYERCONDITION_OFFSET UNITYSDK_OFFSET(0xA98B760)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETLIGHTCUTSCENEATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xA9896E0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETRARITYEFFDELAY_OFFSET UNITYSDK_OFFSET(0xA98D4E0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETSCREENPLAYDATAFROM_1_OFFSET UNITYSDK_OFFSET(0xA9843D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETSCREENPLAYDATAFROM_OFFSET UNITYSDK_OFFSET(0xA984280)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETUIPREFABPATH_OFFSET UNITYSDK_OFFSET(0xA988B90)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GETUITEXTMOVEDISTANE_OFFSET UNITYSDK_OFFSET(0xA989530)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_ANIMACHECKMODE_OFFSET UNITYSDK_OFFSET(0xA989190)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_BLUEPRINT_NAME_OFFSET UNITYSDK_OFFSET(0xA98F0F0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_CURCHARACTERLIGHTTIMELINEGO_OFFSET UNITYSDK_OFFSET(0xA98CDC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_CURMODEL_OFFSET UNITYSDK_OFFSET(0xA98F110)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_CURTIMESCALE_OFFSET UNITYSDK_OFFSET(0xA9840A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xA98F120)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_ISANIMATORSPEEDCTRLED_OFFSET UNITYSDK_OFFSET(0xA987D30)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0xA98F100)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_RARITY_TV_INDEX_OFFSET UNITYSDK_OFFSET(0xA98F0E0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_SHAKEITEMGO_OFFSET UNITYSDK_OFFSET(0xA983850)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET_TOTAL_TV_NUM_OFFSET UNITYSDK_OFFSET(0xA98F0D0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_GET__ISNONGACHA_OFFSET UNITYSDK_OFFSET(0xA9878A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLECREATESUMMONS_OFFSET UNITYSDK_OFFSET(0xA987F10)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEONOPEN_OFFSET UNITYSDK_OFFSET(0xA983B60)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEREMOVESUMMONS_OFFSET UNITYSDK_OFFSET(0xA987390)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLESUMMONENTITYONCLOSEUPTLCHANGE_OFFSET UNITYSDK_OFFSET(0xA98EBF0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEUITEXTMATONREFRESH_OFFSET UNITYSDK_OFFSET(0xA9892A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_HANDLEUPDATE_OFFSET UNITYSDK_OFFSET(0xA9838A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ISVIDEOTVINDEX_OFFSET UNITYSDK_OFFSET(0xA984520)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA983280)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_NEXTITEM_OFFSET UNITYSDK_OFFSET(0xA98B3A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONCAMERASHAKE_OFFSET UNITYSDK_OFFSET(0xA98EB20)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONCLOSEUPTLEND_OFFSET UNITYSDK_OFFSET(0xA98EDA0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONCLOSEUPTLSTART_OFFSET UNITYSDK_OFFSET(0xA98EB80)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONTIMESCALECHANGED_OFFSET UNITYSDK_OFFSET(0xA98E630)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA982240)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA9829A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA981E00)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA981EF0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYBLUEPRINT_OFFSET UNITYSDK_OFFSET(0xA989FC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYCHARACTERLIGHTSTL_OFFSET UNITYSDK_OFFSET(0xA98BBB0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYITEMSHAKE_OFFSET UNITYSDK_OFFSET(0xA98DDC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYSTAGETEXSHEETBYBLACKBOARD_OFFSET UNITYSDK_OFFSET(0xA989740)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYSTAGETEXSHEET_OFFSET UNITYSDK_OFFSET(0xA989930)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYSUMMONSBORNANIMATION_OFFSET UNITYSDK_OFFSET(0xA97E0A0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYTVEFFECTANIMLASTFRAME_OFFSET UNITYSDK_OFFSET(0xA98DA00)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYTVEFFECTANIM_OFFSET UNITYSDK_OFFSET(0xA98D7E0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PRELOADITEMSTAGE_OFFSET UNITYSDK_OFFSET(0xA984590)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REALSHOWCHARACTERLIGHTSV2_OFFSET UNITYSDK_OFFSET(0xA98C1E0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REALSHOWCHARACTERLIGHTS_OFFSET UNITYSDK_OFFSET(0xA98BCC0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REFRESHITEMSTAGE_1_OFFSET UNITYSDK_OFFSET(0xA9889B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REFRESHITEMSTAGE_OFFSET UNITYSDK_OFFSET(0xA984640)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REFRESHSTAGE_OFFSET UNITYSDK_OFFSET(0xA98A4C0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_REMOVECURENTITY_OFFSET UNITYSDK_OFFSET(0xA9879B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_RESETUITEXT_1_OFFSET UNITYSDK_OFFSET(0xA988DF0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_RESETUITEXT_OFFSET UNITYSDK_OFFSET(0xA988CD0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_SETSUMMONSTIMESCALE_OFFSET UNITYSDK_OFFSET(0xA988780)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_SETTVMATPROPERTY_OFFSET UNITYSDK_OFFSET(0xA98E4E0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xA98F130)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPALLTVS_OFFSET UNITYSDK_OFFSET(0xA989E40)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPPLAY_OFFSET UNITYSDK_OFFSET(0xA98B7F0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPSOUND_OFFSET UNITYSDK_OFFSET(0xA98BB50)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPTVEFFECTANIM_OFFSET UNITYSDK_OFFSET(0xA98DBB0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_STOPTV_OFFSET UNITYSDK_OFFSET(0xA989D50)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_UPDATESUMMONSANIMATORMANUALLY_OFFSET UNITYSDK_OFFSET(0xA98EE10)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_UPDATETVS_OFFSET UNITYSDK_OFFSET(0xA983910)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xA981E70)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xA98F140)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__REFRESHITEMSTAGE_B__18_0_OFFSET UNITYSDK_OFFSET(0xA98F6B0)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE__REFRESHSTAGE_B__40_0_OFFSET UNITYSDK_OFFSET(0xA98F720)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA98F730)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA98F740)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA98F750)
#define MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA98F760)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStage3DModelControllerBase_TypeDefinitionIndex = 45125;
	...
	public:
		...
		::Class_2_208CC9941471731A_672* _itemPerformTemplate; // 0x590
		...
		::Class_2_208CC9941471731A_687* _gachaPerformTamplate; // 0x5E8
		...
		::System::Void PlayBlueprint(::System::Single camRotateDuration, ::Class_2_208CC9941471731A_672* tamplate, ::System::Action* blueprintEndCb, ::System::Int32 performedPhaseCount, ::System::Int32 totalPhaseCount, ::System::String* overrideBlueprint)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single, ::Class_2_208CC9941471731A_672*, ::System::Action*, ::System::Int32, ::System::Int32, ::System::String*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGACHASTAGE3DMODELCONTROLLERBASE_PLAYBLUEPRINT_OFFSET))(this, camRotateDuration, tamplate, blueprintEndCb, performedPhaseCount, totalPhaseCount, overrideBlueprint);
		}
