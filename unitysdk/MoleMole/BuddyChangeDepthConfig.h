...
#define MOLEMOLE_BUDDYCHANGEDEPTHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCCE8F80)

namespace MoleMole
{
	inline static constexpr unsigned int BuddyChangeDepthConfig_TypeDefinitionIndex = 57452;

	class BuddyChangeDepthConfig : public ::System::Object
	{
	public:
		::MoleMole::BuddyDepthConfig* near; // 0x10
		::UnityEngine::AnimationCurve* curve_nearForFar; // 0x18
		::MoleMole::BuddyDepthConfig* far; // 0x20
