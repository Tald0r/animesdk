...
#define MOLEMOLE_BUDDYCHANGEDEPTHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x7BB5980)

namespace MoleMole
{
	inline static constexpr unsigned int BuddyChangeDepthConfig_TypeDefinitionIndex = 44202;

	class BuddyChangeDepthConfig : public ::System::Object
	{
	public:
		::UnityEngine::AnimationCurve* curve; // 0x10
		::MoleMole::BuddyDepthConfig* far; // 0x18
		::UnityEngine::AnimationCurve* curve_nearForFar; // 0x20
		::MoleMole::BuddyDepthConfig* near; // 0x28
