...
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_CALSETTINGTYPEBYIDX_OFFSET UNITYSDK_OFFSET(0xA65A6F0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_CREATECONTENTAREABYTABTYPE_OFFSET UNITYSDK_OFFSET(0xA65A7A0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xA659010)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA659000)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA659090)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA659420)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA659CB0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xA659550)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONRESETBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xA659EB0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONSETLANGUAGEVOICE_OFFSET UNITYSDK_OFFSET(0xA65A8A0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA6594C0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA659020)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA659370)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA6595C0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_SWITCHCONTENTAREA_OFFSET UNITYSDK_OFFSET(0xA65A330)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA65AB40)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER__ONRESETBTNCLICKED_B__13_0_OFFSET UNITYSDK_OFFSET(0xA65AB50)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA65AC20)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA65AC90)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xA65ACC0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA65AD20)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA65AD30)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA65AD40)

namespace MoleMole
{
	inline static constexpr unsigned int UILoginSettingPopWindowController_TypeDefinitionIndex = 45781;

	class UILoginSettingPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_864B40477E229EA3* _view; // 0x2F8
		...
		::System::Collections::Generic::List_1<::MoleMole::ESystemSettingType>* _loginSettingList; // 0x318
