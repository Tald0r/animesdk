...
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_CALSETTINGTYPEBYIDX_OFFSET UNITYSDK_OFFSET(0xBD4F2D0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_CREATECONTENTAREABYTABTYPE_OFFSET UNITYSDK_OFFSET(0xBD4F380)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xBD4DBF0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xBD4DBE0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xBD4DC70)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD4E000)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBD4E890)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xBD4E130)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONRESETBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xBD4EA90)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONSETLANGUAGEVOICE_OFFSET UNITYSDK_OFFSET(0xBD4F480)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD4E0A0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD4DC00)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD4DF50)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBD4E1A0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER_SWITCHCONTENTAREA_OFFSET UNITYSDK_OFFSET(0xBD4EF10)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBD4F720)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER__ONRESETBTNCLICKED_B__13_0_OFFSET UNITYSDK_OFFSET(0xBD4F730)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD4F800)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBD4F870)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xBD4F8A0)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD4F900)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD4F910)
#define MOLEMOLE_UILOGINSETTINGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD4F920)

namespace MoleMole
{
	inline static constexpr unsigned int UILoginSettingPopWindowController_TypeDefinitionIndex = 58972;
