...
#define MOLEMOLE_UIGENERALVIDEOINFODIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_CONTENTTITLE_OFFSET UNITYSDK_OFFSET(0xF2335A0)
#define MOLEMOLE_UIGENERALVIDEOINFODIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xF2335B0)
#define MOLEMOLE_UIGENERALVIDEOINFODIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_DIALOGTITLE_OFFSET UNITYSDK_OFFSET(0xF233590)
#define MOLEMOLE_UIGENERALVIDEOINFODIALOGPOPWINDOWCONTROLLER_CONTEXT_GET_VIDEOPATH_OFFSET UNITYSDK_OFFSET(0xF233580)
#define MOLEMOLE_UIGENERALVIDEOINFODIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xF1ECE80)
#define MOLEMOLE_UIGENERALVIDEOINFODIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xF2335C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralVideoInfoDialogPopWindowController_Context_TypeDefinitionIndex = 75344;
	...
	public:
		...
		::Class_0_16E4307DCC41950C_13<::System::String*>* _Content_k__BackingField; // 0x30
		::Class_0_16E4307DCC41950C_13<::System::String*>* _ContentTitle_k__BackingField; // 0x38
		::Class_0_16E4307DCC41950C_13<::System::String*>* _VideoPath_k__BackingField; // 0x40
		::Class_1_EDF4DCFB9AF1C323* _propertyAllocateHelper; // 0x48
