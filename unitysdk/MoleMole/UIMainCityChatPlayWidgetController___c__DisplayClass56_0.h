...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS56_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAF3C600)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS56_0__SHOW3DMODEL_G__OPENMODELDIALOG_0_OFFSET UNITYSDK_OFFSET(0xAF3C610)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass56_0_TypeDefinitionIndex = 53838;
