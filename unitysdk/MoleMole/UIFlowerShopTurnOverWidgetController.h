...
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0xD544B90)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER_CREATESUBWIDGET_OFFSET UNITYSDK_OFFSET(0xD544A60)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xD544D10)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD544E70)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD544F10)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD5449A0)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD544DC0)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER_REFRESHINCOME_OFFSET UNITYSDK_OFFSET(0xD545200)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER_SETINCOME_OFFSET UNITYSDK_OFFSET(0xD544FF0)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER__BUILDVIEWMODELDATABINDING_B__8_0_OFFSET UNITYSDK_OFFSET(0xD545B80)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD545A30)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xD545C80)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD545CE0)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD545D50)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD545DD0)
#define MOLEMOLE_UIFLOWERSHOPTURNOVERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD545E30)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerShopTurnOverWidgetController_TypeDefinitionIndex = 46446;
