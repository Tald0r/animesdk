...
#define MOLEMOLE_FREEBUFFERTRIMOPTIMIZATIONPOSTPROCESSPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0xE102FA0)
#define MOLEMOLE_FREEBUFFERTRIMOPTIMIZATIONPOSTPROCESSPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xE103030)
#define MOLEMOLE_FREEBUFFERTRIMOPTIMIZATIONPOSTPROCESSPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0xE103040)

namespace MoleMole
{
	inline static constexpr unsigned int FreeBufferTrimOptimizationPostProcessProfile_TypeDefinitionIndex = 68024;
