...
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B7730)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B7740)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xC294850)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xC2948D0)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B7750)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B77B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengePageController_LayerInfoData_TypeDefinitionIndex = 77351;
