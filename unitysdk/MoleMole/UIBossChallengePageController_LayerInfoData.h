...
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x3C0CC0)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3C0CD0)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xC2C6080)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xC2C6100)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3C0CE0)
#define MOLEMOLE_UIBOSSCHALLENGEPAGECONTROLLER_LAYERINFODATA___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3C0D40)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengePageController_LayerInfoData_TypeDefinitionIndex = 38178;
