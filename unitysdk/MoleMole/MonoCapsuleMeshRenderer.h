...
#define MOLEMOLE_MONOCAPSULEMESHRENDERER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC231480)
#define MOLEMOLE_MONOCAPSULEMESHRENDERER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC231270)
#define MOLEMOLE_MONOCAPSULEMESHRENDERER_METHOD_5_8CD8E4A63CA5905B_OFFSET UNITYSDK_OFFSET(0xC231680)
#define MOLEMOLE_MONOCAPSULEMESHRENDERER_METHOD_5_ADE72E2505ADFFDB_OFFSET UNITYSDK_OFFSET(0xC232460)
#define MOLEMOLE_MONOCAPSULEMESHRENDERER_METHOD_5_E2C05663B5DE5BEA_OFFSET UNITYSDK_OFFSET(0xC232160)
#define MOLEMOLE_MONOCAPSULEMESHRENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC231FC0)
#define MOLEMOLE_MONOCAPSULEMESHRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0xC232140)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCapsuleMeshRenderer_TypeDefinitionIndex = 52532;
	...
	public:
		...
		static ::UnityEngine::Mesh* Method_5_8CD8E4A63CA5905B(::System::Single a1, ::System::Single a2, ::System::Int32 a3, ::System::Int32 a4)
		{
			return ((::UnityEngine::Mesh*(*)(::System::Single, ::System::Single, ::System::Int32, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOCAPSULEMESHRENDERER_METHOD_5_8CD8E4A63CA5905B_OFFSET))(a1, a2, a3, a4);
		}
