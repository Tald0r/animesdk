...
#define MOLEMOLE_ACCOUNTPUSHSMALLTITLESETTINGENTRY_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x6BD2B10)
#define MOLEMOLE_ACCOUNTPUSHSMALLTITLESETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x6BD2CB0)
#define MOLEMOLE_ACCOUNTPUSHSMALLTITLESETTINGENTRY___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0x6BD2CD0)

namespace MoleMole
{
	inline static constexpr unsigned int AccountPushSmallTitleSettingEntry_TypeDefinitionIndex = 53713;
