...
#define MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9472D40)
#define MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9472DB0)
#define MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9472EB0)
#define MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9472EE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRepelSelectLevelWidgetController_TypeDefinitionIndex = 73588;
	...
	public:
		...
		{
			return ((::Class_2_EC28E1D3A39EE7DE_30*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIREPELSELECTLEVELWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
