...
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER_ONCLICKBUFF_OFFSET UNITYSDK_OFFSET(0xAC3F8E0)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER_ONCLOSEPOPUPWINDOW_OFFSET UNITYSDK_OFFSET(0xAC40410)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC3F260)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC3F490)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC3EE90)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC3F300)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER_REFRESHBUFFCOUNT_OFFSET UNITYSDK_OFFSET(0xAC3F6E0)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER_SHOWBUFFDESC_OFFSET UNITYSDK_OFFSET(0xAC3FA60)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER_SHOWUPDIALOG_OFFSET UNITYSDK_OFFSET(0xAC3FCD0)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0xAC3F420)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC405F0)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC40620)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC40690)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC40710)
#define MOLEMOLE_UICAFECURRENTBUFFWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC40770)

namespace MoleMole
{
	inline static constexpr unsigned int UICafeCurrentBuffWidgetController_TypeDefinitionIndex = 39777;
