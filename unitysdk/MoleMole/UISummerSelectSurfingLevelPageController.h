...
#define MOLEMOLE_UISUMMERSELECTSURFINGLEVELPAGECONTROLLER_CREATELEVELRANKWIDGETGROUP_OFFSET UNITYSDK_OFFSET(0xCA7C5F0)
#define MOLEMOLE_UISUMMERSELECTSURFINGLEVELPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA7C6A0)
#define MOLEMOLE_UISUMMERSELECTSURFINGLEVELPAGECONTROLLER___BASE_CREATELEVELRANKWIDGETGROUP_OFFSET UNITYSDK_OFFSET(0xCA7C740)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerSelectSurfingLevelPageController_TypeDefinitionIndex = 73703;
