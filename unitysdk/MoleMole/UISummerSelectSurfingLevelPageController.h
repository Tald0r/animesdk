...
#define MOLEMOLE_UISUMMERSELECTSURFINGLEVELPAGECONTROLLER_CREATELEVELRANKWIDGETGROUP_OFFSET UNITYSDK_OFFSET(0x7901EA0)
#define MOLEMOLE_UISUMMERSELECTSURFINGLEVELPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7901F50)
#define MOLEMOLE_UISUMMERSELECTSURFINGLEVELPAGECONTROLLER___BASE_CREATELEVELRANKWIDGETGROUP_OFFSET UNITYSDK_OFFSET(0x7901FF0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerSelectSurfingLevelPageController_TypeDefinitionIndex = 42772;
