...
#define MOLEMOLE_CONFIGUIMAINSTORY_PERSONALLINEENDPERFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xF2E9710)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainStory_PersonalLineEndPerformConfig_TypeDefinitionIndex = 52619;
