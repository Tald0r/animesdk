...
#define MOLEMOLE_CONFIGLINEARSTEPSTAIRDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0xB480610)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigLinearStepStairDamper_TypeDefinitionIndex = 68669;
