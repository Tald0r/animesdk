...
#define MOLEMOLE_UIGENERALSUBTITLE05EDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC0580B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSubtitle05EDContext_TypeDefinitionIndex = 72506;
