...
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME_CREATEUICONTROLLER_OFFSET UNITYSDK_OFFSET(0xABBC240)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME_GETICONTYPE_OFFSET UNITYSDK_OFFSET(0xABBC140)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME_GETOFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0xABBC1A0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME_GET_ROOTNAME_OFFSET UNITYSDK_OFFSET(0xABBC320)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME_SHOWPROGRESS_OFFSET UNITYSDK_OFFSET(0xABBC360)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME__CTOR_OFFSET UNITYSDK_OFFSET(0xABBC130)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME___BASE_CREATEUICONTROLLER_OFFSET UNITYSDK_OFFSET(0xABBC3C0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME___BASE_GETICONTYPE_OFFSET UNITYSDK_OFFSET(0xABBC3D0)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME___BASE_GETOFFSETPOSITION_OFFSET UNITYSDK_OFFSET(0xABBC430)
#define MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME___BASE_SHOWPROGRESS_OFFSET UNITYSDK_OFFSET(0xABBC440)

namespace MoleMole
{
	inline static constexpr unsigned int UITwoDMapElement_Data_StreetName_TypeDefinitionIndex = 46873;

	class UITwoDMapElement_Data_StreetName : public ::MoleMole::UITwoDMapElement_Data_StreetIcon
	{
	public:
		::System::Void _ctor(::System::Int32 streetId, ::System::Single rate, ::Class_0_16E4307DCC419505_192* posProvider, ::System::Action_2<::MoleMole::UITwoDMapElement_Data_StreetIcon*, ::System::Single>* onScrollTo)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::Single, ::Class_0_16E4307DCC419505_192*, ::System::Action_2<::MoleMole::UITwoDMapElement_Data_StreetIcon*, ::System::Single>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UITWODMAPELEMENT_DATA_STREETNAME__CTOR_OFFSET))(this, streetId, rate, posProvider, onScrollTo);
		}
