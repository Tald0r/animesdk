...
#define MOLEMOLE_JUMPSETTINGENTRY_GET_SETTINGWIDGETTYPE_OFFSET UNITYSDK_OFFSET(0xE487630)
#define MOLEMOLE_JUMPSETTINGENTRY_GET__ISHIDEVERSIONCODE_OFFSET UNITYSDK_OFFSET(0xE487620)
#define MOLEMOLE_JUMPSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xE484D90)

namespace MoleMole
{
	inline static constexpr unsigned int JumpSettingEntry_TypeDefinitionIndex = 41896;
