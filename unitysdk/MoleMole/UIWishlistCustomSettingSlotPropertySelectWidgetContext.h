...
#define MOLEMOLE_UIWISHLISTCUSTOMSETTINGSLOTPROPERTYSELECTWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x754B6C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistCustomSettingSlotPropertySelectWidgetContext_TypeDefinitionIndex = 51605;
