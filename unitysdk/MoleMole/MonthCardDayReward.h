...
#define MOLEMOLE_MONTHCARDDAYREWARD_GET_CARDINDEX_OFFSET UNITYSDK_OFFSET(0x8F3AE20)
#define MOLEMOLE_MONTHCARDDAYREWARD_GET_DAYINDEX_OFFSET UNITYSDK_OFFSET(0x8F3AE00)
#define MOLEMOLE_MONTHCARDDAYREWARD_GET_DAY_OFFSET UNITYSDK_OFFSET(0x8F3ADF0)
#define MOLEMOLE_MONTHCARDDAYREWARD_GET_STATE_OFFSET UNITYSDK_OFFSET(0x8F3AE40)
#define MOLEMOLE_MONTHCARDDAYREWARD_METHOD_1_3E4243BB348DE0D4_OFFSET UNITYSDK_OFFSET(0x8F3AFD0)
#define MOLEMOLE_MONTHCARDDAYREWARD_METHOD_1_8073A3C8BD4F2EE0_OFFSET UNITYSDK_OFFSET(0x8F3B4B0)
#define MOLEMOLE_MONTHCARDDAYREWARD_METHOD_1_F9B57DBF3518EF48_OFFSET UNITYSDK_OFFSET(0x8F3B400)
#define MOLEMOLE_MONTHCARDDAYREWARD_SET_CARDINDEX_OFFSET UNITYSDK_OFFSET(0x8F3AE30)
#define MOLEMOLE_MONTHCARDDAYREWARD_SET_DAYINDEX_OFFSET UNITYSDK_OFFSET(0x8F3AE10)
#define MOLEMOLE_MONTHCARDDAYREWARD_SET_STATE_OFFSET UNITYSDK_OFFSET(0x8F3AE50)
#define MOLEMOLE_MONTHCARDDAYREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x8F3AE60)

namespace MoleMole
{
	inline static constexpr unsigned int MonthCardDayReward_TypeDefinitionIndex = 40479;
