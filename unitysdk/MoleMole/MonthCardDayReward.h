...
#define MOLEMOLE_MONTHCARDDAYREWARD_GET_CARDINDEX_OFFSET UNITYSDK_OFFSET(0x9850CB0)
#define MOLEMOLE_MONTHCARDDAYREWARD_GET_DAYINDEX_OFFSET UNITYSDK_OFFSET(0x9850C90)
#define MOLEMOLE_MONTHCARDDAYREWARD_GET_DAY_OFFSET UNITYSDK_OFFSET(0x9850C80)
#define MOLEMOLE_MONTHCARDDAYREWARD_GET_STATE_OFFSET UNITYSDK_OFFSET(0x9850CD0)
#define MOLEMOLE_MONTHCARDDAYREWARD_METHOD_1_3E4243BB348DE0D4_OFFSET UNITYSDK_OFFSET(0x9850F00)
#define MOLEMOLE_MONTHCARDDAYREWARD_METHOD_1_8073A3C8BD4F2EE0_OFFSET UNITYSDK_OFFSET(0x9850E60)
#define MOLEMOLE_MONTHCARDDAYREWARD_METHOD_1_F9B57DBF3518EF48_OFFSET UNITYSDK_OFFSET(0x9851330)
#define MOLEMOLE_MONTHCARDDAYREWARD_SET_CARDINDEX_OFFSET UNITYSDK_OFFSET(0x9850CC0)
#define MOLEMOLE_MONTHCARDDAYREWARD_SET_DAYINDEX_OFFSET UNITYSDK_OFFSET(0x9850CA0)
#define MOLEMOLE_MONTHCARDDAYREWARD_SET_STATE_OFFSET UNITYSDK_OFFSET(0x9850CE0)
#define MOLEMOLE_MONTHCARDDAYREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x9850CF0)

namespace MoleMole
{
	inline static constexpr unsigned int MonthCardDayReward_TypeDefinitionIndex = 77709;
