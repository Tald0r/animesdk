...
#define MOLEMOLE_MONOTWEENANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x8C8B7A0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTweenAnimation_TypeDefinitionIndex = 62607;
