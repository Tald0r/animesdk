...
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_ADDCONDITION_OFFSET UNITYSDK_OFFSET(0xD3C1E50)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_ADDSPECIALSTUNCONDITION_OFFSET UNITYSDK_OFFSET(0xD3C1DD0)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_GETENTITYSPACERATIO_OFFSET UNITYSDK_OFFSET(0xD3C39D0)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_GETNOTSTUNTAKERATIO_OFFSET UNITYSDK_OFFSET(0xD3C2BE0)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_GETSTUNDAMAGEVALUE_OFFSET UNITYSDK_OFFSET(0xD3C3330)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_GET__STUNDAMAGESHOWFLAG_OFFSET UNITYSDK_OFFSET(0xD3C39C0)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0xD3C26A0)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3C2330)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_ONSPACERATIOCHANGE_OFFSET UNITYSDK_OFFSET(0xD3C3BB0)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3C23D0)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3C1C90)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_REFRESHSHOWFLAG_OFFSET UNITYSDK_OFFSET(0xD3C2DE0)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_REMOVECONDITION_OFFSET UNITYSDK_OFFSET(0xD3C2110)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_REMOVESPECIALSTUNCONDITION_OFFSET UNITYSDK_OFFSET(0xD3C2090)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_SETENTITY_OFFSET UNITYSDK_OFFSET(0xD3C2F20)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_SET__STUNDAMAGESHOWFLAG_OFFSET UNITYSDK_OFFSET(0xD3C2890)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_SHOWSTUNDAMAGEVALUEINNER_OFFSET UNITYSDK_OFFSET(0xD3C35B0)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_SHOWSTUNDAMAGEVALUE_OFFSET UNITYSDK_OFFSET(0xD3C37C0)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_UPDATECOLORSTATE_OFFSET UNITYSDK_OFFSET(0xD3C3880)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_UPDATENUMUPTRIGGER_OFFSET UNITYSDK_OFFSET(0xD3C2990)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_UPDATESTUNDAMAGEUIINNER_OFFSET UNITYSDK_OFFSET(0xD3C3740)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER_UPDATESTUNDAMAGEUI_OFFSET UNITYSDK_OFFSET(0xD3C3630)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD3C3CD0)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD3C3C90)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3C3D50)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3C3DC0)
#define MOLEMOLE_UISTUNDAMAGEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3C3E40)

namespace MoleMole
{
	inline static constexpr unsigned int UIStunDamageWidgetController_TypeDefinitionIndex = 46499;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIStunDamageWidgetController_TypeDefinitionIndex)->GetStaticField(0xA850);
		}
		static ::System::Int32* StaticGet_NumUp()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIStunDamageWidgetController_TypeDefinitionIndex)->GetStaticField(0xA854);
		}
		static ::System::Int32* StaticGet_Show()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIStunDamageWidgetController_TypeDefinitionIndex)->GetStaticField(0xA858);
		}
		static ::System::Int32* StaticGet_Special()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIStunDamageWidgetController_TypeDefinitionIndex)->GetStaticField(0xA85C);
		}
