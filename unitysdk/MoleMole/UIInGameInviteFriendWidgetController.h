...
#define MOLEMOLE_UIINGAMEINVITEFRIENDWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9EAC100)
#define MOLEMOLE_UIINGAMEINVITEFRIENDWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9EAC170)
#define MOLEMOLE_UIINGAMEINVITEFRIENDWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9EAC270)
#define MOLEMOLE_UIINGAMEINVITEFRIENDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9EAC450)
#define MOLEMOLE_UIINGAMEINVITEFRIENDWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9EAC460)
#define MOLEMOLE_UIINGAMEINVITEFRIENDWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9EAC4D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInGameInviteFriendWidgetController_TypeDefinitionIndex = 42859;
