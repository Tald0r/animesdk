...
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_GETADAPTASPECTOFFSET_OFFSET UNITYSDK_OFFSET(0xA3A1DB0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_05132253A9091649_OFFSET UNITYSDK_OFFSET(0xA3A2F90)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0xA3A33E0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_1D4018D4200358D0_2_OFFSET UNITYSDK_OFFSET(0xA3A3680)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_1D4018D4200358D0_3_OFFSET UNITYSDK_OFFSET(0xA3A36F0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xA3A2C90)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_24902946B5E8137E_OFFSET UNITYSDK_OFFSET(0xA3A2B30)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_250144EB25DB3FF3_OFFSET UNITYSDK_OFFSET(0xA3A2700)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_57C33BB5669A5FB3_OFFSET UNITYSDK_OFFSET(0xA3A2D00)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_A3FAE12D7B6ACD62_1_OFFSET UNITYSDK_OFFSET(0xA3A35B0)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xA3A3450)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_BEA3E455B88CC3AF_OFFSET UNITYSDK_OFFSET(0xA3A1F40)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_METHOD_6_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0xA3A3520)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA__CCTOR_OFFSET UNITYSDK_OFFSET(0xA3A2C80)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xA3A2C60)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAttachToCamera_TypeDefinitionIndex = 40384;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MonoEffectPluginAttachToCamera_TypeDefinitionIndex)->GetStaticField(0xF410);
		}
