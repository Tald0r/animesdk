...
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x6C5FFA0)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_GET_SELECTED_OFFSET UNITYSDK_OFFSET(0x6C602E0)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C608E0)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x6C60980)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C60CE0)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SETACTIVECONSOLETIP_OFFSET UNITYSDK_OFFSET(0x6C60850)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SETONCLICK_OFFSET UNITYSDK_OFFSET(0x6C60520)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SET_BUTTONENABLED_OFFSET UNITYSDK_OFFSET(0x6C603A0)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SET_BUTTONVISIBLE_OFFSET UNITYSDK_OFFSET(0x6C60460)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SET_COLOR_OFFSET UNITYSDK_OFFSET(0x6C60240)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SET_SELECTED_OFFSET UNITYSDK_OFFSET(0x6C60310)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SET_TITLE_OFFSET UNITYSDK_OFFSET(0x6C5FFB0)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER_SHOWNUMBER_OFFSET UNITYSDK_OFFSET(0x6C60640)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6C60DC0)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C60DF0)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x6C60E60)
#define MOLEMOLE_UIGENERALFILTERITEMROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C60E70)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralFilterItemRowWidgetController_TypeDefinitionIndex = 69354;
