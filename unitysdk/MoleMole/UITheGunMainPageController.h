...
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_GETLISTDATA_OFFSET UNITYSDK_OFFSET(0xA6BF660)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_GETQUESTINDEX_OFFSET UNITYSDK_OFFSET(0xA6BF780)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA6BE570)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_GOTOMAINCITY_OFFSET UNITYSDK_OFFSET(0xA6C0720)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONACTIVITYCLOSE_OFFSET UNITYSDK_OFFSET(0xA6C0C80)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONCLICKLEVELITEM_OFFSET UNITYSDK_OFFSET(0xA6C0120)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONCLICKMAIN_OFFSET UNITYSDK_OFFSET(0xA6C0240)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA6BE580)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA6BF5E0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA6BF020)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA6BE620)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA6BF0B0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_OPENINFO_OFFSET UNITYSDK_OFFSET(0xA6C03A0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_REFRESHTABNEW_OFFSET UNITYSDK_OFFSET(0xA6BFD50)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_REFRESHTABTRACK_OFFSET UNITYSDK_OFFSET(0xA6BFC40)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_REFRESHTAB_OFFSET UNITYSDK_OFFSET(0xA6BF420)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_SETPAGEMODE_OFFSET UNITYSDK_OFFSET(0xA6BF8A0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_SHOWGOBATTLE_OFFSET UNITYSDK_OFFSET(0xA6C05C0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_TRACKQUESTGROUP_OFFSET UNITYSDK_OFFSET(0xA6C0880)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA6C0E20)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_0_OFFSET UNITYSDK_OFFSET(0xA6C0E30)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_1_OFFSET UNITYSDK_OFFSET(0xA6C0E40)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_2_OFFSET UNITYSDK_OFFSET(0xA6C0E50)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_3_OFFSET UNITYSDK_OFFSET(0xA6C0E60)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_4_OFFSET UNITYSDK_OFFSET(0xA6C0E70)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA6C0E80)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA6C0EF0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA6C0F00)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA6C0F10)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA6C0F20)

namespace MoleMole
{
	inline static constexpr unsigned int UITheGunMainPageController_TypeDefinitionIndex = 79943;

	class UITheGunMainPageController : public ::MoleMole::UIWindowController
	{
	public:
		::UnityEngine::GameObject* BGNormal; // 0x2F8
		::UnityEngine::GameObject* BGHard; // 0x300
		::MoleMole::UITheGunGoBattlePopWindowController* goBattlePop; // 0x308
		::MoleMole::TheGunGoBattleContext* popContex; // 0x310
		::System::Int32 currentTab; // 0x318
		::Class_2_A29AABB3C13F614B* model; // 0x320
		::System::Int32 activityID; // 0x328
		...
		::Class_2_79F6D62CE30E3F8E_143* _view; // 0x340
