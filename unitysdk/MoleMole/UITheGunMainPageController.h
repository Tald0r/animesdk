...
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_GETLISTDATA_OFFSET UNITYSDK_OFFSET(0x7C49950)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_GETQUESTINDEX_OFFSET UNITYSDK_OFFSET(0x7C49A70)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x7C48850)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_GOTOMAINCITY_OFFSET UNITYSDK_OFFSET(0x7C4AA00)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONACTIVITYCLOSE_OFFSET UNITYSDK_OFFSET(0x7C4AF50)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONCLICKLEVELITEM_OFFSET UNITYSDK_OFFSET(0x7C4A400)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONCLICKMAIN_OFFSET UNITYSDK_OFFSET(0x7C4A520)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7C48860)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7C498D0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7C49300)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7C48900)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7C49390)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_OPENINFO_OFFSET UNITYSDK_OFFSET(0x7C4A680)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_REFRESHTABNEW_OFFSET UNITYSDK_OFFSET(0x7C4A020)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_REFRESHTABTRACK_OFFSET UNITYSDK_OFFSET(0x7C49F20)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_REFRESHTAB_OFFSET UNITYSDK_OFFSET(0x7C49700)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_SETPAGEMODE_OFFSET UNITYSDK_OFFSET(0x7C49B90)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_SHOWGOBATTLE_OFFSET UNITYSDK_OFFSET(0x7C4A8A0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_TRACKQUESTGROUP_OFFSET UNITYSDK_OFFSET(0x7C4AB50)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7C4B0F0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_0_OFFSET UNITYSDK_OFFSET(0x7C4B100)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_1_OFFSET UNITYSDK_OFFSET(0x7C4B110)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_2_OFFSET UNITYSDK_OFFSET(0x7C4B120)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_3_OFFSET UNITYSDK_OFFSET(0x7C4B130)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER__ONUIINIT_B__14_4_OFFSET UNITYSDK_OFFSET(0x7C4B140)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7C4B150)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7C4B1C0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7C4B1D0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7C4B1E0)
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7C4B1F0)

namespace MoleMole
{
	inline static constexpr unsigned int UITheGunMainPageController_TypeDefinitionIndex = 68726;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_147* _view; // 0x340
