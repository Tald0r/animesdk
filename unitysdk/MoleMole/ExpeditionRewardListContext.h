...
#define MOLEMOLE_EXPEDITIONREWARDLISTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB5C2CE0)

namespace MoleMole
{
	inline static constexpr unsigned int ExpeditionRewardListContext_TypeDefinitionIndex = 55757;
