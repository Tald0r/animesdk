...
#define MOLEMOLE_INLEVELSKILLLISTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x67A8970)
#define MOLEMOLE_INLEVELSKILLLISTKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0x67A8980)
#define MOLEMOLE_INLEVELSKILLLISTKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x67A8990)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelSkillListKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 61259;
