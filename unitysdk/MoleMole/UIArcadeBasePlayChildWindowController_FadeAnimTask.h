...
#define MOLEMOLE_UIARCADEBASEPLAYCHILDWINDOWCONTROLLER_FADEANIMTASK__CTOR_OFFSET UNITYSDK_OFFSET(0xC8EA680)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeBasePlayChildWindowController_FadeAnimTask_TypeDefinitionIndex = 53986;
