...
#define MOLEMOLE_MONOLEVELDOORFXAUTOLAYOUT_METHOD_5_52466F3CA46AC7C4_OFFSET UNITYSDK_OFFSET(0x993BF80)
#define MOLEMOLE_MONOLEVELDOORFXAUTOLAYOUT_METHOD_5_86365E2EC5AEA470_OFFSET UNITYSDK_OFFSET(0x993C190)
#define MOLEMOLE_MONOLEVELDOORFXAUTOLAYOUT_METHOD_5_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0x993AF10)
#define MOLEMOLE_MONOLEVELDOORFXAUTOLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x993AEE0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLevelDoorFxAutoLayout_TypeDefinitionIndex = 43943;
