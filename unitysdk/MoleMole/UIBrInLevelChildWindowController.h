...
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0x1AE74A30)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1AE74580)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1AE74B60)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONGAMEEND_OFFSET UNITYSDK_OFFSET(0x1AE75230)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1AE74D00)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONSCORECHANGE_OFFSET UNITYSDK_OFFSET(0x1AE752A0)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONSPEEDSYNC_OFFSET UNITYSDK_OFFSET(0x1AE751D0)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONTIMELEFTSYNC_OFFSET UNITYSDK_OFFSET(0x1AE75660)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1AE74BF0)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1AE74590)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1AE746C0)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AE74F90)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE75840)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1AE75850)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1AE758C0)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1AE758F0)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1AE75900)
#define MOLEMOLE_UIBRINLEVELCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1AE75910)

namespace MoleMole
{
	inline static constexpr unsigned int UIBrInLevelChildWindowController_TypeDefinitionIndex = 80117;
