...
#define MOLEMOLE_ACTIVITYTRICKLEVELCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9F95070)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityTrickLevelContext_TypeDefinitionIndex = 74254;
