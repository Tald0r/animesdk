...
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_GETLEVELASSETPATH_OFFSET UNITYSDK_OFFSET(0xC8E9270)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC8E8630)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONANTIQUELEVELCHANGE_OFFSET UNITYSDK_OFFSET(0xC8EA3F0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONCLICKCOLLECTTASK_OFFSET UNITYSDK_OFFSET(0xC8EA0D0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONCLICKCOLLECT_OFFSET UNITYSDK_OFFSET(0xC8EA190)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONCLICKINFO_OFFSET UNITYSDK_OFFSET(0xC8EA070)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONCLICKSIDETASK_OFFSET UNITYSDK_OFFSET(0xC8EA250)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONCLICKTAKEALLREWARD_OFFSET UNITYSDK_OFFSET(0xC8EA310)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC8E8640)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONEXPCHANGE_OFFSET UNITYSDK_OFFSET(0xC8EA380)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONPERMANENTREWARDUPDATE_OFFSET UNITYSDK_OFFSET(0xC8EA460)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC8E9170)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC8E91E0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8E8DD0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC8E8FB0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_REFRESHEXP_OFFSET UNITYSDK_OFFSET(0xC8E9B30)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_REFRESHGETALL_OFFSET UNITYSDK_OFFSET(0xC8E9590)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_REFRESHGOTOBTN_OFFSET UNITYSDK_OFFSET(0xC8E9D30)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0xC8E90F0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_REFRESHLEFTINFO_OFFSET UNITYSDK_OFFSET(0xC8E9380)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_REFRESHREWARDLIST_OFFSET UNITYSDK_OFFSET(0xC8E9640)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER_SORTREWARD_OFFSET UNITYSDK_OFFSET(0xC8E9FC0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC8EA4E0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC8EA570)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC8EA5E0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC8EA5F0)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8EA600)
#define MOLEMOLE_UIANTIQUEREWARDPAGEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC8EA610)

namespace MoleMole
{
	inline static constexpr unsigned int UIAntiqueRewardPagePageController_TypeDefinitionIndex = 36572;
