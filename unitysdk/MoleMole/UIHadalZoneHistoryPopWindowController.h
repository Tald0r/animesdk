...
#define MOLEMOLE_UIHADALZONEHISTORYPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAD42990)
#define MOLEMOLE_UIHADALZONEHISTORYPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAD429A0)
#define MOLEMOLE_UIHADALZONEHISTORYPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAD42A10)
#define MOLEMOLE_UIHADALZONEHISTORYPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD42B10)
#define MOLEMOLE_UIHADALZONEHISTORYPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD42D50)
#define MOLEMOLE_UIHADALZONEHISTORYPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAD42D60)
#define MOLEMOLE_UIHADALZONEHISTORYPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD42DD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZoneHistoryPopWindowController_TypeDefinitionIndex = 65908;
