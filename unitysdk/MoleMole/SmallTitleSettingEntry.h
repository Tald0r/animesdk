...
#define MOLEMOLE_SMALLTITLESETTINGENTRY_GET_SETTINGWIDGETTYPE_OFFSET UNITYSDK_OFFSET(0xA610780)
#define MOLEMOLE_SMALLTITLESETTINGENTRY_GET__ISHIDEVERSIONCODE_OFFSET UNITYSDK_OFFSET(0xA610770)
#define MOLEMOLE_SMALLTITLESETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xA610790)

namespace MoleMole
{
	inline static constexpr unsigned int SmallTitleSettingEntry_TypeDefinitionIndex = 74800;
