...
#define MOLEMOLE_SMALLTITLESETTINGENTRY_GET_SETTINGWIDGETTYPE_OFFSET UNITYSDK_OFFSET(0xA7FAAB0)
#define MOLEMOLE_SMALLTITLESETTINGENTRY_GET__ISHIDEVERSIONCODE_OFFSET UNITYSDK_OFFSET(0xA7FAAA0)
#define MOLEMOLE_SMALLTITLESETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xA7FAAC0)

namespace MoleMole
{
	inline static constexpr unsigned int SmallTitleSettingEntry_TypeDefinitionIndex = 72512;
