...
#define MOLEMOLE_UIINLEVELSKILLBUTTONSOLOAIDCHILDWINDOWCONTROLLER__INITSWITCHAVATARCOMPONENT_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x37EC00)
#define MOLEMOLE_UIINLEVELSKILLBUTTONSOLOAIDCHILDWINDOWCONTROLLER__INITSWITCHAVATARCOMPONENT_D__13_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelSkillButtonSoloAidChildWindowController__InitSwitchAvatarComponent_d__13_TypeDefinitionIndex = 56729;

	struct alignas(8) UIInLevelSkillButtonSoloAidChildWindowController__InitSwitchAvatarComponent_d__13
	{
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__1; // 0x10
		::MoleMole::UIInLevelSkillButtonSoloAidChildWindowController* __4__this; // 0x20
