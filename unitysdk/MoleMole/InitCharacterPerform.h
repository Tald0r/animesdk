...
#define MOLEMOLE_INITCHARACTERPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xE487010)

namespace MoleMole
{
	inline static constexpr unsigned int InitCharacterPerform_TypeDefinitionIndex = 59078;
