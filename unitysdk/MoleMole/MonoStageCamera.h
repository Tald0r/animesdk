...
#define MOLEMOLE_MONOSTAGECAMERA_ACTIVECAM_OFFSET UNITYSDK_OFFSET(0xD816470)
#define MOLEMOLE_MONOSTAGECAMERA_AWAKE_OFFSET UNITYSDK_OFFSET(0xD816090)
#define MOLEMOLE_MONOSTAGECAMERA_GET_TRANSFORMNAME_OFFSET UNITYSDK_OFFSET(0xD816080)
#define MOLEMOLE_MONOSTAGECAMERA_METHOD_5_3574512695A597AB_OFFSET UNITYSDK_OFFSET(0xD816140)
#define MOLEMOLE_MONOSTAGECAMERA_METHOD_5_CEBFF096B4C9D46B_OFFSET UNITYSDK_OFFSET(0xD8164F0)
#define MOLEMOLE_MONOSTAGECAMERA_METHOD_5_D35B60AE823B8CC1_OFFSET UNITYSDK_OFFSET(0xD816870)
#define MOLEMOLE_MONOSTAGECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xD816840)

namespace MoleMole
{
	inline static constexpr unsigned int MonoStageCamera_TypeDefinitionIndex = 71624;
