...
#define MOLEMOLE_CONFIGUIMAINPAGESHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xD7DC730)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainPageShow_TypeDefinitionIndex = 64676;
