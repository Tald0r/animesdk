...
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDF53EB0)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDF53F20)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDF54020)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF54160)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDF54190)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDF54200)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapDistrictWidgetController_TypeDefinitionIndex = 46656;
