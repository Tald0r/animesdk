...
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6E4940)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6E49B0)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD6E4AB0)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD6E4BF0)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD6E4C20)
#define MOLEMOLE_UIURBANMAPDISTRICTWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD6E4C90)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapDistrictWidgetController_TypeDefinitionIndex = 46701;
