...
#define MOLEMOLE_UISOCIALCIRCLEMANAGEPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAB9DBE0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleManagePageController_Context_TypeDefinitionIndex = 78644;
