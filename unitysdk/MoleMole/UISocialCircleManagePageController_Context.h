...
#define MOLEMOLE_UISOCIALCIRCLEMANAGEPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA24ED30)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleManagePageController_Context_TypeDefinitionIndex = 38104;
	...
	public:
		...
		::Class_2_2B9D1521AEB6DD72_1* CircleStaticData; // 0x38
