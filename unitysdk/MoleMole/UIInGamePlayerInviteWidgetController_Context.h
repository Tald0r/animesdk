...
#define MOLEMOLE_UIINGAMEPLAYERINVITEWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA1BA1A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInGamePlayerInviteWidgetController_Context_TypeDefinitionIndex = 40656;
	...
	public:
		...
		::System::Action_1<::Class_1_BE6BF7909AD9D940*>* OnClickFriend; // 0x38
