...
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBE51260)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0xBE514C0)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xBE513E0)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBE50420)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBE51300)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBE500E0)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBE515A0)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0xBE515B0)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBE51610)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER___BASE_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0xBE51680)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xBE516E0)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBE51750)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBE517D0)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBE51850)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyTabWidgetController_TypeDefinitionIndex = 54454;

	class UIMonsterFantasyTabWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_176* _view; // 0x2D0
