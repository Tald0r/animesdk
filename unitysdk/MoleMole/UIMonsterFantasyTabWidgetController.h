...
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFF2C80)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0xCFF2EE0)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCFF2E00)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCFF1E30)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFF2D20)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFF1AF0)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF2FC0)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0xCFF2FD0)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFF3030)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER___BASE_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0xCFF30A0)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xCFF3100)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCFF3170)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFF31F0)
#define MOLEMOLE_UIMONSTERFANTASYTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFF3270)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyTabWidgetController_TypeDefinitionIndex = 70581;

	class UIMonsterFantasyTabWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_163* _view; // 0x2D0
