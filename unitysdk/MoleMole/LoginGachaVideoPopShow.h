...
#define MOLEMOLE_LOGINGACHAVIDEOPOPSHOW_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x67AA850)
#define MOLEMOLE_LOGINGACHAVIDEOPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x67AA840)
#define MOLEMOLE_LOGINGACHAVIDEOPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x67AA8D0)
#define MOLEMOLE_LOGINGACHAVIDEOPOPSHOW_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x67AA860)
#define MOLEMOLE_LOGINGACHAVIDEOPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x67AAC50)
#define MOLEMOLE_LOGINGACHAVIDEOPOPSHOW___BASE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x67AAC60)

namespace MoleMole
{
	inline static constexpr unsigned int LoginGachaVideoPopShow_TypeDefinitionIndex = 60346;
