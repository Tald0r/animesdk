...
#define MOLEMOLE_COMICIMGSTYLE_CLEARUSELESSDATA_OFFSET UNITYSDK_OFFSET(0x1ADE81E0)
#define MOLEMOLE_COMICIMGSTYLE_CREATENEWANIMINFO_OFFSET UNITYSDK_OFFSET(0x1ADE9610)
#define MOLEMOLE_COMICIMGSTYLE_GETDEFAULTIMGLISTORDERFROMPREFAB_OFFSET UNITYSDK_OFFSET(0x1ADE7A30)
#define MOLEMOLE_COMICIMGSTYLE_GETINITDATAFROMPREFAB_OFFSET UNITYSDK_OFFSET(0x1ADE7860)
#define MOLEMOLE_COMICIMGSTYLE_GETINITSCREENINFO_OFFSET UNITYSDK_OFFSET(0x1ADE8A10)
#define MOLEMOLE_COMICIMGSTYLE_GETORIGINTRANSFORMINFOSFROMPREFAB_OFFSET UNITYSDK_OFFSET(0x1ADE7C20)
#define MOLEMOLE_COMICIMGSTYLE_ONPREFABCHANGE_OFFSET UNITYSDK_OFFSET(0x1ADE7850)
#define MOLEMOLE_COMICIMGSTYLE_ONSCREENINFOITEMBEGINGUI_OFFSET UNITYSDK_OFFSET(0x1ADE8150)
#define MOLEMOLE_COMICIMGSTYLE_ONSCREENINFOITEMENDGUI_OFFSET UNITYSDK_OFFSET(0x1ADE8160)
#define MOLEMOLE_COMICIMGSTYLE_RECOVERPREFABTOINIT_OFFSET UNITYSDK_OFFSET(0x1ADE8170)
#define MOLEMOLE_COMICIMGSTYLE_SETTOTARGETINFO_OFFSET UNITYSDK_OFFSET(0x1ADE8F10)
#define MOLEMOLE_COMICIMGSTYLE__CLEARUSELESSDATA_G__DOCLEAR_8_0_OFFSET UNITYSDK_OFFSET(0x1ADE8B10)
#define MOLEMOLE_COMICIMGSTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE9A30)
#define MOLEMOLE_COMICIMGSTYLE__GETEASYPREVIEWBTNNAME_OFFSET UNITYSDK_OFFSET(0x1ADE9980)
#define MOLEMOLE_COMICIMGSTYLE__ONPREVIEWSHOWIDCHANGE_OFFSET UNITYSDK_OFFSET(0x1ADE99C0)
#define MOLEMOLE_COMICIMGSTYLE__PREVIEWINSHOWID_OFFSET UNITYSDK_OFFSET(0x1ADE9A00)
#define MOLEMOLE_COMICIMGSTYLE__SETTOTARGETINFO_G__GETINFOS_9_0_OFFSET UNITYSDK_OFFSET(0x1ADE9590)
#define MOLEMOLE_COMICIMGSTYLE__STARTEASYPREVIEW_OFFSET UNITYSDK_OFFSET(0x1ADE9960)
#define MOLEMOLE_COMICIMGSTYLE__UPDATETIME_OFFSET UNITYSDK_OFFSET(0x1ADE98A0)

namespace MoleMole
{
	inline static constexpr unsigned int ComicImgStyle_TypeDefinitionIndex = 29100;

	class ComicImgStyle : public ::System::Object
	{
	public:
		// static const ::System::String* PRVIEW_ID_GROUP_NAME; // 0x0
		::System::Collections::Generic::List_1<::MoleMole::ComicImgUITransformData*>* originTransformInfos; // 0x10
		::UnityEngine::GameObject* _testObj; // 0x18
		::System::Collections::Generic::List_1<::MoleMole::ComicPartInfo*>* initInfo; // 0x20
		::UnityEngine::GameObject* prefab; // 0x28
		::System::Collections::Generic::List_1<::MoleMole::ComicShakeInfo*>* shakeInfos; // 0x30
		::System::Collections::Generic::List_1<::MoleMole::ComicImgPart>* imgListOrder; // 0x38
		::System::String* prefabPath; // 0x40
		::System::Collections::Generic::List_1<::MoleMole::ComicTweenMoveAnimSeq*>* seqList; // 0x48
		::System::Collections::Generic::List_1<::MoleMole::ComicScreenInfo*>* screenInfos; // 0x50
		::System::Int32 _previewShowID; // 0x58
		::System::Single _testTime; // 0x5C
