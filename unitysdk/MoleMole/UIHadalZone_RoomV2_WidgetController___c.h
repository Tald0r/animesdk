...
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x87195B0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x87195F0)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___C___OPENSELECTHEROPAGE_B__24_7_OFFSET UNITYSDK_OFFSET(0x8719640)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___C___REFRESHSELECTEDAVATAR_B__29_0_OFFSET UNITYSDK_OFFSET(0x8719760)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___C___REFRESHSELECTEDBUDDY_B__30_0_OFFSET UNITYSDK_OFFSET(0x8719790)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___C___UPDATEROLES_B__13_2_OFFSET UNITYSDK_OFFSET(0x8719600)
#define MOLEMOLE_UIHADALZONE_ROOMV2_WIDGETCONTROLLER___C___UPDATEROLES_B__13_3_OFFSET UNITYSDK_OFFSET(0x8719620)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_RoomV2_WidgetController___c_TypeDefinitionIndex = 76403;
	...
	public:
		...
		{
			return (::System::Action_1<::MoleMole::UIGeneralHeadRowWidgetController*>**)Il2CppClass::FromTypeDefinitionIndex(UIHadalZone_RoomV2_WidgetController___c_TypeDefinitionIndex)->GetStaticField(0x39820);
		}
		static ::System::Action_1<::MoleMole::UIGeneralHeadRowWidgetController*>** StaticGet___9__13_3()
		{
			return (::System::Action_1<::MoleMole::UIGeneralHeadRowWidgetController*>**)Il2CppClass::FromTypeDefinitionIndex(UIHadalZone_RoomV2_WidgetController___c_TypeDefinitionIndex)->GetStaticField(0x39828);
		}
		static ::MoleMole::UIHadalZone_RoomV2_WidgetController___c** StaticGet___9()
		{
			return (::MoleMole::UIHadalZone_RoomV2_WidgetController___c**)Il2CppClass::FromTypeDefinitionIndex(UIHadalZone_RoomV2_WidgetController___c_TypeDefinitionIndex)->GetStaticField(0x39830);
		}
		static ::System::Action_1<::MoleMole::UIGeneralHeadRowWidgetController*>** StaticGet___9__29_0()
		{
			return (::System::Action_1<::MoleMole::UIGeneralHeadRowWidgetController*>**)Il2CppClass::FromTypeDefinitionIndex(UIHadalZone_RoomV2_WidgetController___c_TypeDefinitionIndex)->GetStaticField(0x39838);
		}
		static ::System::Action** StaticGet___9__24_7()
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(UIHadalZone_RoomV2_WidgetController___c_TypeDefinitionIndex)->GetStaticField(0x39840);
		}
		static ::System::Action_1<::MoleMole::UIGeneralHeadRowWidgetController*>** StaticGet___9__30_0()
		{
			return (::System::Action_1<::MoleMole::UIGeneralHeadRowWidgetController*>**)Il2CppClass::FromTypeDefinitionIndex(UIHadalZone_RoomV2_WidgetController___c_TypeDefinitionIndex)->GetStaticField(0x39848);
		}
