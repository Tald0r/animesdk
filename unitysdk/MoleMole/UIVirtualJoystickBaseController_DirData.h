...
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_DIRDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC3FEFC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirtualJoystickBaseController_DirData_TypeDefinitionIndex = 56699;
