...
#define MOLEMOLE_UIVIRTUALJOYSTICKBASECONTROLLER_DIRDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA12CC80)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirtualJoystickBaseController_DirData_TypeDefinitionIndex = 80524;
