...
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_BINDNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0x9A240F0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_ENABLEWIDGET_OFFSET UNITYSDK_OFFSET(0x9A241B0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_GETSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0x9A23D50)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_GETTABBUTTON_OFFSET UNITYSDK_OFFSET(0x9A23AB0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A23550)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_ONHOLLOWEXITPOINT_OFFSET UNITYSDK_OFFSET(0x9A23840)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A235F0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9A23310)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_REFRESHPOINT_OFFSET UNITYSDK_OFFSET(0x9A238B0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_REGISTERREDPOINT_OFFSET UNITYSDK_OFFSET(0x9A23DC0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_SETSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0x9A23BC0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_SETTABNAMEBYTEXTKEY_OFFSET UNITYSDK_OFFSET(0x9A24400)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0x9A23B20)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_SHOWLOCK_OFFSET UNITYSDK_OFFSET(0x9A24490)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A24520)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A24550)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A245C0)
#define MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9A24640)

namespace MoleMole
{
	inline static constexpr unsigned int UITabBtn03RowWidgetController_TypeDefinitionIndex = 46127;

	class UITabBtn03RowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_F4F42734846BD0C3* _view; // 0x2A0
		::Enum_3_0F46F2034DC32D68 _hollowInfoType; // 0x2A8
		::MoleMole::ESystemSettingType _settingType; // 0x2AC
		::MoleMole::UIGeneralPopUpHintWidgetController* _popCtrl; // 0x2B0
		::System::Action* click; // 0x2B8
		...
		::System::Void BindNotificationBadge(::Class_1_79526D80B8F6897C* node)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_79526D80B8F6897C*))((::PBYTE)hIl2Cpp + MOLEMOLE_UITABBTN03ROWWIDGETCONTROLLER_BINDNOTIFICATIONBADGE_OFFSET))(this, node);
		}
