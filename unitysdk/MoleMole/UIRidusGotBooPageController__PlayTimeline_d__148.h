...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYTIMELINE_D__148_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3AAB10)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYTIMELINE_D__148_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__PlayTimeline_d__148_TypeDefinitionIndex = 44098;

	struct alignas(8) UIRidusGotBooPageController__PlayTimeline_d__148
	{
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__1; // 0x10
		::MoleMole::UIRidusGotBooPageController___c__DisplayClass148_0* __8__1; // 0x20
