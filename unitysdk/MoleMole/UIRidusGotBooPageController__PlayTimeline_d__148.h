...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYTIMELINE_D__148_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x392CF0)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYTIMELINE_D__148_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__PlayTimeline_d__148_TypeDefinitionIndex = 66331;

	struct alignas(8) UIRidusGotBooPageController__PlayTimeline_d__148
	{
		::System::String* key; // 0x10
		::MoleMole::UIRidusGotBooPageController___c__DisplayClass148_0* __8__1; // 0x18
