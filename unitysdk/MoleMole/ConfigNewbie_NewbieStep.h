...
#define MOLEMOLE_CONFIGNEWBIE_NEWBIESTEP_LOADFROMBYTES_OFFSET UNITYSDK_OFFSET(0xCDCBC40)
#define MOLEMOLE_CONFIGNEWBIE_NEWBIESTEP__CTOR_OFFSET UNITYSDK_OFFSET(0xCDCCAD0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigNewbie_NewbieStep_TypeDefinitionIndex = 54137;
