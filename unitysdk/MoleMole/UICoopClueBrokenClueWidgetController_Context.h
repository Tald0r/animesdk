...
#define MOLEMOLE_UICOOPCLUEBROKENCLUEWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCC7C940)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopClueBrokenClueWidgetController_Context_TypeDefinitionIndex = 77387;

	class UICoopClueBrokenClueWidgetController_Context : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_0_16E4307DCC419505_102<::Class_2_035093BE115F9154_Class_1_84D29A777CDEE069*>* Data; // 0x28
