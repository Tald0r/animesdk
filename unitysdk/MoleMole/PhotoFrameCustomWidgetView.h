...
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x9AC7770)

namespace MoleMole
{
	inline static constexpr unsigned int PhotoFrameCustomWidgetView_TypeDefinitionIndex = 79124;
