...
#define MOLEMOLE_PHOTOFRAMECUSTOMWIDGETVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA53A6A0)

namespace MoleMole
{
	inline static constexpr unsigned int PhotoFrameCustomWidgetView_TypeDefinitionIndex = 56662;
