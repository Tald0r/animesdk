...
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR_AWAKE_OFFSET UNITYSDK_OFFSET(0xEC68A20)
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR_METHOD_5_CD9F3CEFB366C27A_OFFSET UNITYSDK_OFFSET(0xEC68D10)
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR_METHOD_5_D29C2F8DD9EA7988_OFFSET UNITYSDK_OFFSET(0xEC6AA00)
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0xEC68CA0)
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0xEC6A980)
#define MOLEMOLE_ETHEREYESRIBBONGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xEC6B0B0)

namespace MoleMole
{
	inline static constexpr unsigned int EtherEyesRibbonGenerator_TypeDefinitionIndex = 38262;
