...
#define MOLEMOLE_UIGACHAREWARDLISTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS28_0__CTOR_OFFSET UNITYSDK_OFFSET(0x6C5E9F0)
#define MOLEMOLE_UIGACHAREWARDLISTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS28_0__ONITEMCLICK_B__0_OFFSET UNITYSDK_OFFSET(0x6C5EA00)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaRewardListDialogPopWindowController___c__DisplayClass28_0_TypeDefinitionIndex = 47570;
	...
	public:
		...
		::Enum_3_5EA2B17DF83E32C8_1 type; // 0x1C
