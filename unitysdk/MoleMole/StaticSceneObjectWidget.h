...
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_AWAKE_OFFSET UNITYSDK_OFFSET(0xA660180)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_METHOD_5_5176DC743E478510_OFFSET UNITYSDK_OFFSET(0xA660360)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_METHOD_5_C8D6D8DA0C67D22D_OFFSET UNITYSDK_OFFSET(0xA660B50)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_METHOD_5_FD647A48096EB173_OFFSET UNITYSDK_OFFSET(0xA660FC0)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA660A50)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA6607C0)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA660670)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_ONLEAVESCENE_OFFSET UNITYSDK_OFFSET(0xA6609D0)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xA660930)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET_START_OFFSET UNITYSDK_OFFSET(0xA6602C0)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET__CCTOR_OFFSET UNITYSDK_OFFSET(0xA660AF0)
#define MOLEMOLE_STATICSCENEOBJECTWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0xA660AD0)

namespace MoleMole
{
	inline static constexpr unsigned int StaticSceneObjectWidget_TypeDefinitionIndex = 80706;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(StaticSceneObjectWidget_TypeDefinitionIndex)->GetStaticField(0xF800);
		}
		static ::UnityEngine::Vector3* StaticGet_Field_5_12()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(StaticSceneObjectWidget_TypeDefinitionIndex)->GetStaticField(0xF804);
		}
