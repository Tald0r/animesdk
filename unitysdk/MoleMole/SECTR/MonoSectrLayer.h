...
#define MOLEMOLE_SECTR_MONOSECTRLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xB872360)

namespace MoleMole::SECTR
{
	inline static constexpr unsigned int MonoSectrLayer_TypeDefinitionIndex = 40127;
