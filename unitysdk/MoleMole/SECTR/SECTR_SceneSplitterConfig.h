...
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_ADDNEWLAYER_OFFSET UNITYSDK_OFFSET(0x8B72830)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_ADDNEWTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x8B729C0)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_COMPARELAYERCONFIG_OFFSET UNITYSDK_OFFSET(0x8B727B0)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_GETALLCONFIGS_OFFSET UNITYSDK_OFFSET(0x8B72680)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_GETTHRESHOLDBYNAME_OFFSET UNITYSDK_OFFSET(0x8B72B50)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_INIT_OFFSET UNITYSDK_OFFSET(0x8B72260)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_REMOVELAYER_OFFSET UNITYSDK_OFFSET(0x8B72910)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_REMOVETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x8B72AA0)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_SORTCONFIGS_OFFSET UNITYSDK_OFFSET(0x8B72550)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8B72C70)

namespace MoleMole::SECTR
{
	inline static constexpr unsigned int SECTR_SceneSplitterConfig_TypeDefinitionIndex = 64654;
