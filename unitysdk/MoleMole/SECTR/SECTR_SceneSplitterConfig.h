...
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_ADDNEWLAYER_OFFSET UNITYSDK_OFFSET(0x7F204B0)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_ADDNEWTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x7F20640)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_COMPARELAYERCONFIG_OFFSET UNITYSDK_OFFSET(0x7F20430)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_GETALLCONFIGS_OFFSET UNITYSDK_OFFSET(0x7F20300)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_GETTHRESHOLDBYNAME_OFFSET UNITYSDK_OFFSET(0x7F207D0)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_INIT_OFFSET UNITYSDK_OFFSET(0x7F1FED0)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_REMOVELAYER_OFFSET UNITYSDK_OFFSET(0x7F20590)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_REMOVETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x7F20720)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG_SORTCONFIGS_OFFSET UNITYSDK_OFFSET(0x7F201D0)
#define MOLEMOLE_SECTR_SECTR_SCENESPLITTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x7F208F0)

namespace MoleMole::SECTR
{
	inline static constexpr unsigned int SECTR_SceneSplitterConfig_TypeDefinitionIndex = 49976;
