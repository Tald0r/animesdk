...
#define MOLEMOLE_SECTR_MONOGUID_GET_INSTANCEGUID_OFFSET UNITYSDK_OFFSET(0xB8C60C0)
#define MOLEMOLE_SECTR_MONOGUID__CTOR_OFFSET UNITYSDK_OFFSET(0xB8C6180)

namespace MoleMole::SECTR
{
	inline static constexpr unsigned int MonoGuid_TypeDefinitionIndex = 73311;
