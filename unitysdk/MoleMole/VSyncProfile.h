...
#define MOLEMOLE_VSYNCPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xEE6F530)
#define MOLEMOLE_VSYNCPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xEE6F6B0)
#define MOLEMOLE_VSYNCPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0xEE6F450)
#define MOLEMOLE_VSYNCPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xEE6F610)
#define MOLEMOLE_VSYNCPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xEE6F440)
#define MOLEMOLE_VSYNCPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xEE6F7E0)
#define MOLEMOLE_VSYNCPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xEE6F870)
#define MOLEMOLE_VSYNCPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xEE6F8E0)
#define MOLEMOLE_VSYNCPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xEE6F950)

namespace MoleMole
{
	inline static constexpr unsigned int VSyncProfile_TypeDefinitionIndex = 75728;
