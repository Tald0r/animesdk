...
#define MOLEMOLE_VSYNCPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xAA96460)
#define MOLEMOLE_VSYNCPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xAA965E0)
#define MOLEMOLE_VSYNCPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0xAA96380)
#define MOLEMOLE_VSYNCPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xAA96540)
#define MOLEMOLE_VSYNCPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xAA96370)
#define MOLEMOLE_VSYNCPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xAA96710)
#define MOLEMOLE_VSYNCPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xAA967A0)
#define MOLEMOLE_VSYNCPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xAA96810)
#define MOLEMOLE_VSYNCPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xAA96880)

namespace MoleMole
{
	inline static constexpr unsigned int VSyncProfile_TypeDefinitionIndex = 51776;
