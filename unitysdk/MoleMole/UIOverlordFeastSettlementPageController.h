...
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_CREATEFUNC_OFFSET UNITYSDK_OFFSET(0xD27C1E0)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0xD27CC30)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD27B480)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD27B490)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xD27BF70)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_ONOKBTNCLICK_OFFSET UNITYSDK_OFFSET(0xD27C2C0)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD27B8C0)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD27B530)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0xD27C330)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD27CDC0)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER__ONUIDESTROY_G__SHOULDOPENMAINPAGE_8_0_OFFSET UNITYSDK_OFFSET(0xD27BC20)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD27CDD0)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xD27CE40)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD27CE50)
#define MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD27CE60)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastSettlementPageController_TypeDefinitionIndex = 61646;
	...
	public:
		...
		{
			return ((::MoleMole::ScrollViewItemWidgetController*(*)(::PVOID, ::Enum_3_340DE32BA097F66C, ::System::Func_1<::MoleMole::UIControlReference*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIOVERLORDFEASTSETTLEMENTPAGECONTROLLER_CREATEFUNC_OFFSET))(this, arg1, arg2);
		}
