...
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_CANADDNEWPLAN_OFFSET UNITYSDK_OFFSET(0xC0CA010)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_CREATEITEMWIDGET_OFFSET UNITYSDK_OFFSET(0xC0C95A0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_GETCURSELECTWIDGET_OFFSET UNITYSDK_OFFSET(0xC0C9E60)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xC0C9230)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC0C8AC0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC0C8D30)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ISCHECKED_OFFSET UNITYSDK_OFFSET(0xC0C9240)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0xC0C9380)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0C9100)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ONITEMCLICKED_OFFSET UNITYSDK_OFFSET(0xC0C9720)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0C91A0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0C8AD0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0C8E10)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_REFRESHBTN_OFFSET UNITYSDK_OFFSET(0xC0C92C0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC0C9050)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0CA0A0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0xC0CA210)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0CA2A0)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0CA310)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0CA320)
#define MOLEMOLE_UIDAILYQUESTSCHEDULEPLANPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0CA330)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestSchedulePlanPopWindowController_TypeDefinitionIndex = 63758;
	...
	public:
		...
		::Class_2_208CC9941471731A_290* _poolConfig; // 0x318
