...
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_CREATEBTNROW_OFFSET UNITYSDK_OFFSET(0xC8F8440)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC8F8090)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC8F80A0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC8F8110)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC8F8520)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8F8210)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_SETSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xC8F8280)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC8F86F0)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC8F8700)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC8F8770)
#define MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8F8780)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarSpecialAwakenPageController_TypeDefinitionIndex = 65975;
	...
	public:
		...
		::Class_3_91FA7424F7A03A99* get__viewModel()
		{
			return ((::Class_3_91FA7424F7A03A99*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIAVATARSPECIALAWAKENPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
