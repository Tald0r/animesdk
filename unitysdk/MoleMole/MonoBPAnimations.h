...
#define MOLEMOLE_MONOBPANIMATIONS_BPMOTIONANIMEND_OFFSET UNITYSDK_OFFSET(0xB8C60A0)
#define MOLEMOLE_MONOBPANIMATIONS_BPMOTIONANIM_OFFSET UNITYSDK_OFFSET(0xB8C5FF0)
#define MOLEMOLE_MONOBPANIMATIONS_CALCULATEBPPOS_OFFSET UNITYSDK_OFFSET(0xB8C5D20)
#define MOLEMOLE_MONOBPANIMATIONS_INITREWARDENTERANIM_OFFSET UNITYSDK_OFFSET(0xB8C5B30)
#define MOLEMOLE_MONOBPANIMATIONS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB8C58C0)
#define MOLEMOLE_MONOBPANIMATIONS_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB8C5EC0)
#define MOLEMOLE_MONOBPANIMATIONS_STARTREWARDENTERANIM_OFFSET UNITYSDK_OFFSET(0xB8C5920)
#define MOLEMOLE_MONOBPANIMATIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xB8C6120)

namespace MoleMole
{
	inline static constexpr unsigned int MonoBPAnimations_TypeDefinitionIndex = 39007;
