...
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x86E80F0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_GETAVATARAWAKENINFO_OFFSET UNITYSDK_OFFSET(0x86E95B0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_GETSKILLDISPLAYLEVELANDTALENTADD_OFFSET UNITYSDK_OFFSET(0x86E8BC0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_GETSKILLLEVELANDTALENTADD_OFFSET UNITYSDK_OFFSET(0x86E97B0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x86E7F70)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x86E8010)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x86E7E20)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x86E7EC0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_REFRESHATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x86E8350)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0x86E90D0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x86E98F0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_REFRESHTITLE_OFFSET UNITYSDK_OFFSET(0x86E85D0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x86E8C30)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_SETFOLD_OFFSET UNITYSDK_OFFSET(0x86EA0F0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x86EA790)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x86EA880)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x86EA8F0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x86EA970)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x86EA9D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseSkillRowWidgetController_TypeDefinitionIndex = 75344;

	class UIInLevelPauseSkillRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_E0691DCD748D31EC* _view; // 0x2A0
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_739*>* skillDescTemplates; // 0x2A8
		::Class_2_208CC9941471731A_774* passiveTemplate; // 0x2B0
		::Class_2_208CC9941471731A_671* passiveDesTemplate; // 0x2B8
		::System::Collections::Generic::List_1<::Class_1_FE222B85F7CE3D1B*>* groups; // 0x2C0
		::System::Boolean isFold; // 0x2C8
		::System::Int32 avatarID; // 0x2CC
		::System::Boolean isShowingAttribute; // 0x2D0
		::Class_2_D89CCC627A66D0AD* avatarItem; // 0x2D8
		::Share::EAvatarSkillType skillType; // 0x2E0
		...
		::System::Void Refresh(::System::Boolean init, ::Class_2_D89CCC627A66D0AD* avatarItem)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::Class_2_D89CCC627A66D0AD*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_REFRESH_OFFSET))(this, init, avatarItem);
		}
		...
		::System::Void RefreshInfo(::Share::EAvatarSkillType type, ::System::Int32 avatarID, ::Class_2_D89CCC627A66D0AD* avatarItem)
		{
			return ((::System::Void(*)(::PVOID, ::Share::EAvatarSkillType, ::System::Int32, ::Class_2_D89CCC627A66D0AD*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_REFRESHINFO_OFFSET))(this, type, avatarID, avatarItem);
		}
