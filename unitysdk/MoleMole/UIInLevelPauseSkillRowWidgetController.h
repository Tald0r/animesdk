...
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x9A8ABE0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_GETAVATARAWAKENINFO_OFFSET UNITYSDK_OFFSET(0x9A8C080)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_GETSKILLDISPLAYLEVELANDTALENTADD_OFFSET UNITYSDK_OFFSET(0x9A8B690)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_GETSKILLLEVELANDTALENTADD_OFFSET UNITYSDK_OFFSET(0x9A8C280)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A8AA60)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A8AB00)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9A8A910)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9A8A9B0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_REFRESHATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x9A8AE30)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0x9A8BBA0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x9A8C3C0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_REFRESHTITLE_OFFSET UNITYSDK_OFFSET(0x9A8B0B0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x9A8B700)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER_SETFOLD_OFFSET UNITYSDK_OFFSET(0x9A8CBC0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8D260)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A8D350)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A8D3C0)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9A8D440)
#define MOLEMOLE_UIINLEVELPAUSESKILLROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9A8D4A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPauseSkillRowWidgetController_TypeDefinitionIndex = 80184;

	class UIInLevelPauseSkillRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_E0691DCD748D31EC* _view; // 0x2A0
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_281*>* skillDescTemplates; // 0x2A8
		::Class_2_208CC9941471731A_276* passiveTemplate; // 0x2B0
		::Class_2_208CC9941471731A_521* passiveDesTemplate; // 0x2B8
