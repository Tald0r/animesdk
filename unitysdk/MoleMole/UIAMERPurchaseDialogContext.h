...
#define MOLEMOLE_UIAMERPURCHASEDIALOGCONTEXT_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0x9AE5EE0)
#define MOLEMOLE_UIAMERPURCHASEDIALOGCONTEXT_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x9AE5EC0)
#define MOLEMOLE_UIAMERPURCHASEDIALOGCONTEXT_PARSEJUMPPARAS_OFFSET UNITYSDK_OFFSET(0x9AE5FF0)
#define MOLEMOLE_UIAMERPURCHASEDIALOGCONTEXT_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x9AE5ED0)
#define MOLEMOLE_UIAMERPURCHASEDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9AE60A0)
#define MOLEMOLE_UIAMERPURCHASEDIALOGCONTEXT___BASE_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0x9AE60B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAMERPurchaseDialogContext_TypeDefinitionIndex = 67404;
