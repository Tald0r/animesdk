...
#define MOLEMOLE_COMMANDLINESCENEQUALITY_METHOD_2_C29C8CADB68273FF_OFFSET UNITYSDK_OFFSET(0x15E9D460)
#define MOLEMOLE_COMMANDLINESCENEQUALITY_METHOD_2_EB9779B12C7F7019_OFFSET UNITYSDK_OFFSET(0x15E9D2F0)
#define MOLEMOLE_COMMANDLINESCENEQUALITY__CTOR_OFFSET UNITYSDK_OFFSET(0x15E9D420)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineSceneQuality_TypeDefinitionIndex = 37485;
