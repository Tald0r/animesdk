...
#define MOLEMOLE_GYROROTATE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A5A4970)
#define MOLEMOLE_GYROROTATE_METHOD_6_189C865264480324_OFFSET UNITYSDK_OFFSET(0x1A5A49E0)
#define MOLEMOLE_GYROROTATE_METHOD_6_7D3DB889EB40A97B_OFFSET UNITYSDK_OFFSET(0x1A5A5340)
#define MOLEMOLE_GYROROTATE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A5A48B0)
#define MOLEMOLE_GYROROTATE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A5A45F0)
#define MOLEMOLE_GYROROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5A52F0)

namespace MoleMole
{
	inline static constexpr unsigned int GyroRotate_TypeDefinitionIndex = 8194;
