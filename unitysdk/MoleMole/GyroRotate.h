...
#define MOLEMOLE_GYROROTATE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB7CA90)
#define MOLEMOLE_GYROROTATE_METHOD_6_189C865264480324_OFFSET UNITYSDK_OFFSET(0x1AB7CB00)
#define MOLEMOLE_GYROROTATE_METHOD_6_7D3DB889EB40A97B_OFFSET UNITYSDK_OFFSET(0x1AB7D460)
#define MOLEMOLE_GYROROTATE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AB7C9D0)
#define MOLEMOLE_GYROROTATE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AB7C710)
#define MOLEMOLE_GYROROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB7D410)

namespace MoleMole
{
	inline static constexpr unsigned int GyroRotate_TypeDefinitionIndex = 7909;
