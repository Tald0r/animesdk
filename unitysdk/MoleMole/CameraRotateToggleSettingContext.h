...
#define MOLEMOLE_CAMERAROTATETOGGLESETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x89E0710)

namespace MoleMole
{
	inline static constexpr unsigned int CameraRotateToggleSettingContext_TypeDefinitionIndex = 70092;
