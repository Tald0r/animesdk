...
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB1022B0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB102430)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB102350)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB102030)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_REFRESHGAMEPADLIST_OFFSET UNITYSDK_OFFSET(0xB1041F0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB1047D0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__9_1_OFFSET UNITYSDK_OFFSET(0xB1047E0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER__ONSCROLLITEMUPDATE_G__SETEMPTY_9_0_OFFSET UNITYSDK_OFFSET(0xB104190)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB104850)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB1048C0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB104940)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB1049C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookItemWidgetController_TypeDefinitionIndex = 41351;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_32* _view; // 0x2E0
