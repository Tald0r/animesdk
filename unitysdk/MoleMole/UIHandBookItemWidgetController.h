...
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C50E50)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8C50FD0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C50EF0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C50BD0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER_REFRESHGAMEPADLIST_OFFSET UNITYSDK_OFFSET(0x8C52D90)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C53370)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__9_1_OFFSET UNITYSDK_OFFSET(0x8C53380)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER__ONSCROLLITEMUPDATE_G__SETEMPTY_9_0_OFFSET UNITYSDK_OFFSET(0x8C52D30)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C533F0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8C53460)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C534E0)
#define MOLEMOLE_UIHANDBOOKITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C53560)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookItemWidgetController_TypeDefinitionIndex = 61209;

	class UIHandBookItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		// static const ::System::String* GoText; // 0x0
		// static const ::System::String* DailyConsumeText; // 0x0
		// static const ::System::String* LockedText; // 0x0
		::MoleMole::UIWishlistTargetAvatarPopupWidgetController* _wishlistTargetAvatarPopupWidgetCtrl; // 0x2D0
		::System::Collections::Generic::List_1<::Class_1_1685EC66FBD28897*>* _rewards; // 0x2D8
		::Class_2_79F6D62CE30E3F8E_161* _view; // 0x2E0
