...
#define MOLEMOLE_UIARCADEMENUSELECTROWWIDGETCONTROLLER_INITVIEWCONTROL_OFFSET UNITYSDK_OFFSET(0xA4CD1C0)
#define MOLEMOLE_UIARCADEMENUSELECTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4CD090)
#define MOLEMOLE_UIARCADEMENUSELECTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA4CD2E0)
#define MOLEMOLE_UIARCADEMENUSELECTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4CD130)
#define MOLEMOLE_UIARCADEMENUSELECTROWWIDGETCONTROLLER_SETACTIVITYSTATUS_OFFSET UNITYSDK_OFFSET(0xA4CD4A0)
#define MOLEMOLE_UIARCADEMENUSELECTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4CD530)
#define MOLEMOLE_UIARCADEMENUSELECTROWWIDGETCONTROLLER___BASE_INITVIEWCONTROL_OFFSET UNITYSDK_OFFSET(0xA4CD540)
#define MOLEMOLE_UIARCADEMENUSELECTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4CD550)
#define MOLEMOLE_UIARCADEMENUSELECTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA4CD5C0)
#define MOLEMOLE_UIARCADEMENUSELECTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4CD5D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeMenuSelectRowWidgetController_TypeDefinitionIndex = 61670;

	class UIArcadeMenuSelectRowWidgetController : public ::MoleMole::UIArcadeMenuSelectRowBaseWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_85* _view; // 0x388
		::Class_1_451601B8BB62C38C_9* rowData; // 0x390
