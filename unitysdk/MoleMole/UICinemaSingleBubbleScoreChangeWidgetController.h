...
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER_GETCOMBOIMGBYINT_OFFSET UNITYSDK_OFFSET(0xA52A1C0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA52A040)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA52A0E0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA529AC0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA529B60)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER_SHOWSCORECHANGE_OFFSET UNITYSDK_OFFSET(0xA529C80)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA52A3E0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER__SHOWSCORECHANGE_B__5_0_OFFSET UNITYSDK_OFFSET(0xA52A460)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA52A470)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA52A4E0)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA52A560)
#define MOLEMOLE_UICINEMASINGLEBUBBLESCORECHANGEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA52A5C0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSingleBubbleScoreChangeWidgetController_TypeDefinitionIndex = 59885;
