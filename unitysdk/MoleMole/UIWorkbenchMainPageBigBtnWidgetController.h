...
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER_ONBTNCALLBACK_OFFSET UNITYSDK_OFFSET(0x992B3F0)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x992B270)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x992B310)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x992AFD0)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x992B1C0)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER_REGISTERONCLICK_OFFSET UNITYSDK_OFFSET(0x9929B00)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x992B470)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x992B4A0)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x992B510)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x992B590)
#define MOLEMOLE_UIWORKBENCHMAINPAGEBIGBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x992B5F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkbenchMainPageBigBtnWidgetController_TypeDefinitionIndex = 66828;

	class UIWorkbenchMainPageBigBtnWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_EC707217DE7794EF_4* _view; // 0x2A0
