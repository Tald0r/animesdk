...
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB966520)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xB9666B0)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB966530)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0xB9673F0)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB9665D0)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB967360)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB966B00)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_REFRESHTABNEW_OFFSET UNITYSDK_OFFSET(0xB966F60)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB9667D0)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB967550)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER__ONUIINIT_B__10_0_OFFSET UNITYSDK_OFFSET(0xB967560)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER__ONUIINIT_B__10_1_OFFSET UNITYSDK_OFFSET(0xB967660)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER__ONUIINIT_B__10_2_OFFSET UNITYSDK_OFFSET(0xB967670)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB967680)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB9676F0)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB967700)
#define MOLEMOLE_UIACTIVITYOVABATTLESPECIALPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB967710)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityOVABattleSpecialPageController_TypeDefinitionIndex = 68713;

	class UIActivityOVABattleSpecialPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79AE422BA06F6D26_92* _view; // 0x2F8
