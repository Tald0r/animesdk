...
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_CALCULATEEXPMAP_OFFSET UNITYSDK_OFFSET(0xAC32CD0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETBUTTONCOMBINESTATE_OFFSET UNITYSDK_OFFSET(0xAC33030)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETCHALLENGETIME_OFFSET UNITYSDK_OFFSET(0xAC32380)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETPANELSTATE_OFFSET UNITYSDK_OFFSET(0xAC33090)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETRANKINGSCORE_OFFSET UNITYSDK_OFFSET(0xAC330F0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_GETRATINGTYPE_OFFSET UNITYSDK_OFFSET(0xAC32100)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC32720)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONFADEINANIMEVENT_OFFSET UNITYSDK_OFFSET(0xAC328D0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONPOPSHOWED_OFFSET UNITYSDK_OFFSET(0xAC332E0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONPREPARESHOW_OFFSET UNITYSDK_OFFSET(0xAC33190)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC32860)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_REFRESHCARD_OFFSET UNITYSDK_OFFSET(0xAC33370)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER_REFRESHDAMAGE_OFFSET UNITYSDK_OFFSET(0xAC32A00)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC34010)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER__REFRESHABYSSPOINT2_OFFSET UNITYSDK_OFFSET(0xAC337D0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_GETCHALLENGETIME_OFFSET UNITYSDK_OFFSET(0xAC34030)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_GETRANKINGSCORE_OFFSET UNITYSDK_OFFSET(0xAC34040)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_GETRATINGTYPE_OFFSET UNITYSDK_OFFSET(0xAC340A0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC340B0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_ONPREPARESHOW_OFFSET UNITYSDK_OFFSET(0xAC34150)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC341C0)
#define MOLEMOLE_UIBANGBOODREAMRESULTPAGECONTROLLER___BASE__REFRESHABYSSPOINT2_OFFSET UNITYSDK_OFFSET(0xAC34020)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooDreamResultPageController_TypeDefinitionIndex = 63528;

	class UIBangBooDreamResultPageController : public ::MoleMole::UILevelResultV2_PageController
	{
	public:
		::Class_2_60638234271CCDB8_56* _view; // 0x3A8
