...
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_PATTERNPAIR_PATTERNPAIR_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xD1A1C90)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_PATTERNPAIR_PATTERNPAIR_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xD1A1CA0)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_PATTERNPAIR_PATTERNPAIR_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xD1A1EA0)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_PATTERNPAIR_PATTERNPAIR_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD1A2060)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_PATTERNPAIR_PATTERNPAIR_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD1A2020)

namespace MoleMole
{
	inline static constexpr unsigned int SkillCharacterScriptConfig_PatternPair_PatternPair_UnityGeneratedFormatter_TypeDefinitionIndex = 61675;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(SkillCharacterScriptConfig_PatternPair_PatternPair_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44C30);
		}
