...
#define MOLEMOLE_SUMMEREVENTSHOOTINGGAMEPLAYCONFIG_SUMMEREVENTSHOOTINGGAMEPLAYCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x9946930)
#define MOLEMOLE_SUMMEREVENTSHOOTINGGAMEPLAYCONFIG_SUMMEREVENTSHOOTINGGAMEPLAYCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x9946940)
#define MOLEMOLE_SUMMEREVENTSHOOTINGGAMEPLAYCONFIG_SUMMEREVENTSHOOTINGGAMEPLAYCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x9947010)
#define MOLEMOLE_SUMMEREVENTSHOOTINGGAMEPLAYCONFIG_SUMMEREVENTSHOOTINGGAMEPLAYCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9947450)
#define MOLEMOLE_SUMMEREVENTSHOOTINGGAMEPLAYCONFIG_SUMMEREVENTSHOOTINGGAMEPLAYCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9947410)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventShootingGamePlayConfig_SummerEventShootingGamePlayConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 53135;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::SummerPlayerWeaponInfo*>*>**)Il2CppClass::FromTypeDefinitionIndex(SummerEventShootingGamePlayConfig_SummerEventShootingGamePlayConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x34670);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(SummerEventShootingGamePlayConfig_SummerEventShootingGamePlayConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x34678);
		}
