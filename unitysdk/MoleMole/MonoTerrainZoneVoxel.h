...
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ADDDYNAMICOBJECTVOXEL_OFFSET UNITYSDK_OFFSET(0xB1ADFA0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_FETCHVOXELWITHLAYER_COMPRESSEDARRAY_OFFSET UNITYSDK_OFFSET(0xB1ADB50)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_FETCHVOXELWITHLAYER_OCT_OFFSET UNITYSDK_OFFSET(0xB1AD290)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_FETCHVOXELWITHLAYER_OFFSET UNITYSDK_OFFSET(0xB1AD180)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_FETCHVOXELWITHLAYER_RAWARRAY_OFFSET UNITYSDK_OFFSET(0xB1AD830)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_GETSURFACECOVERSWITCHINFO_OFFSET UNITYSDK_OFFSET(0xB1ABAD0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_GETSURFACESWITCHINFO_OFFSET UNITYSDK_OFFSET(0xB1AB8F0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_GETUNSCALEPOS_OFFSET UNITYSDK_OFFSET(0xB1ACDE0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_GETVOXEL_OFFSET UNITYSDK_OFFSET(0xB1ACF10)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0xB1AE880)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_0927CBCFB2A51C9A_OFFSET UNITYSDK_OFFSET(0xB1AF4C0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_19FB9C4218A5B74F_OFFSET UNITYSDK_OFFSET(0xB1AE8F0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_2D96614001512C7D_OFFSET UNITYSDK_OFFSET(0xB1AFA00)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_3EA2E124EC6BB35D_OFFSET UNITYSDK_OFFSET(0xB1AF6B0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_464F9487BF0D77F8_OFFSET UNITYSDK_OFFSET(0xB1AF8D0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0xB1AEA00)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_6239EA04E2FB2F4A_OFFSET UNITYSDK_OFFSET(0xB1AE7F0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_6424DA16BE1ACD1D_OFFSET UNITYSDK_OFFSET(0xB1AEF90)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_6C34F0EA80C7348F_OFFSET UNITYSDK_OFFSET(0xB1AE140)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0xB1AC4C0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_7F576417C636CD3F_1_OFFSET UNITYSDK_OFFSET(0xB1AEAE0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_7F576417C636CD3F_OFFSET UNITYSDK_OFFSET(0xB1AD0E0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_9062BAA313DFA78D_OFFSET UNITYSDK_OFFSET(0xB1AEB80)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_9076BB310BB6989E_OFFSET UNITYSDK_OFFSET(0xB1AC840)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xB1AE680)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_A5B6063FFC26FC8F_OFFSET UNITYSDK_OFFSET(0xB1AF000)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0xB1AC1E0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_BFB8545B28B0DAAD_OFFSET UNITYSDK_OFFSET(0xB1AEF10)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB1AF540)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB1AE790)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_DDA7FEACCC547653_OFFSET UNITYSDK_OFFSET(0xB1AF9C0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_DDA8A2337932DF10_OFFSET UNITYSDK_OFFSET(0xB1AF2D0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_E05A16F4C3178177_1_OFFSET UNITYSDK_OFFSET(0xB1AF5B0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_E05A16F4C3178177_OFFSET UNITYSDK_OFFSET(0xB1AF630)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xB1ABF90)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_F3F1A00B2E67355E_OFFSET UNITYSDK_OFFSET(0xB1ADF30)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_METHOD_5_FEA241CA014F8043_OFFSET UNITYSDK_OFFSET(0xB1AEE50)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB1ABF20)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB1ABEC0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_PACKMATTYPE_OFFSET UNITYSDK_OFFSET(0xB1ABC70)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_PACKSPANDATATOTOP_OFFSET UNITYSDK_OFFSET(0xB1ABE50)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_REMOVEDYNAMICOBJECTVOXEL_OFFSET UNITYSDK_OFFSET(0xB1AE070)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_RESETVOXEL_OFFSET UNITYSDK_OFFSET(0xB1ACEA0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_START_OFFSET UNITYSDK_OFFSET(0xB1AC450)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_UNPACKMATTYPE_OFFSET UNITYSDK_OFFSET(0xB1ABDB0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL_UPDATE_OFFSET UNITYSDK_OFFSET(0xB1AC7D0)
#define MOLEMOLE_MONOTERRAINZONEVOXEL__CCTOR_OFFSET UNITYSDK_OFFSET(0xB1AE610)
#define MOLEMOLE_MONOTERRAINZONEVOXEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB1AE360)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTerrainZoneVoxel_TypeDefinitionIndex = 40525;
	...
	public:
		...
		{
			return (::System::Action_1<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(MonoTerrainZoneVoxel_TypeDefinitionIndex)->GetStaticField(0x2DF10);
		}
		static ::System::Int32* StaticGet_Field_5_29()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoTerrainZoneVoxel_TypeDefinitionIndex)->GetStaticField(0xA5F0);
		}
		static ::System::Byte* StaticGet_COVER_MAT_MAX_RANGE()
		{
			return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(MonoTerrainZoneVoxel_TypeDefinitionIndex)->GetStaticField(0xA5F4);
		}
		static ::System::Byte* StaticGet_BASE_MAT_MAX_RANGE()
		{
			return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(MonoTerrainZoneVoxel_TypeDefinitionIndex)->GetStaticField(0xA5F5);
		}
		static ::System::Int32* StaticGet_Field_5_28()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoTerrainZoneVoxel_TypeDefinitionIndex)->GetStaticField(0xA5F8);
		}
