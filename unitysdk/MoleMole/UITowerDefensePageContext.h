...
#define MOLEMOLE_UITOWERDEFENSEPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x990E7A0)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefensePageContext_TypeDefinitionIndex = 77215;
