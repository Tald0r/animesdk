...
#define MOLEMOLE_UICOMPOSEITEMCONTEXTBASE_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0xB2BEF60)
#define MOLEMOLE_UICOMPOSEITEMCONTEXTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xB2BEFF0)
#define MOLEMOLE_UICOMPOSEITEMCONTEXTBASE___BASE_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0xB2BF000)

namespace MoleMole
{
	inline static constexpr unsigned int UIComposeItemContextBase_TypeDefinitionIndex = 73982;
