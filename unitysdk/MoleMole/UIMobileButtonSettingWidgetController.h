...
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xAC0A9F0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_MANUALONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC0A8B0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC0A650)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_ONSLIDERVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xAC0ADF0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC0A6F0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC0A5A0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_ONUIOPENINNER_OFFSET UNITYSDK_OFFSET(0xAC0A970)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAC0AC90)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC0AFE0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0xAC0B010)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC0B020)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC0B090)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC0B110)

namespace MoleMole
{
	inline static constexpr unsigned int UIMobileButtonSettingWidgetController_TypeDefinitionIndex = 60710;

	class UIMobileButtonSettingWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_76BDA31962EF0DA3* _view; // 0x2A0
		::MoleMole::UIMobileButtonSettingWidgetController_Context* _context; // 0x2A8
