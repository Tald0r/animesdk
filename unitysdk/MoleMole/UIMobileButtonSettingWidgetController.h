...
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x897E830)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_MANUALONUIOPEN_OFFSET UNITYSDK_OFFSET(0x897E6F0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x897E490)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_ONSLIDERVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x897EC30)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x897E530)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x897E3E0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_ONUIOPENINNER_OFFSET UNITYSDK_OFFSET(0x897E7B0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x897EAD0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x897EE20)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0x897EE50)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x897EE60)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x897EED0)
#define MOLEMOLE_UIMOBILEBUTTONSETTINGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x897EF50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMobileButtonSettingWidgetController_TypeDefinitionIndex = 45403;
