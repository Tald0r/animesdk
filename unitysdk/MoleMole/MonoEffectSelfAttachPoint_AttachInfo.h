...
#define MOLEMOLE_MONOEFFECTSELFATTACHPOINT_ATTACHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA600230)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectSelfAttachPoint_AttachInfo_TypeDefinitionIndex = 65804;
