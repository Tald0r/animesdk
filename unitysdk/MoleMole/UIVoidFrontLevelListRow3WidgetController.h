...
class Class_2_669A1564D361F7D3;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x971F510)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x971F580)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x971F7E0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x971F680)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x971F960)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x971F970)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x971F9E0)
#define MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x971FA50)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontLevelListRow3WidgetController_TypeDefinitionIndex = 48768;
	...
	public:
		...
		::Class_2_669A1564D361F7D3* get__viewModel()
		{
			return ((::Class_2_669A1564D361F7D3*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVOIDFRONTLEVELLISTROW3WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
