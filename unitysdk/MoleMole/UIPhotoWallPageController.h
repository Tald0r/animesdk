...
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_BEGINDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xAF78630)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CHANGEPLATFORMIDMODE_OFFSET UNITYSDK_OFFSET(0xAF76ED0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CHANGETOEDITMODE_OFFSET UNITYSDK_OFFSET(0xAF752D0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CHANGETOWATCHMODE_OFFSET UNITYSDK_OFFSET(0xAF75430)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CUSTOMCHECKEDGEFUNC_OFFSET UNITYSDK_OFFSET(0xAF7DDD0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CUSTOMCOLLECTALLITEMFUNC_OFFSET UNITYSDK_OFFSET(0xAF7CAE0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CUSTOMGETITEMPOSFUNC_OFFSET UNITYSDK_OFFSET(0xAF7BCC0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CUSTOMSETITEMSELECTSTATEFUNC_OFFSET UNITYSDK_OFFSET(0xAF7BA00)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_DRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xAF78E50)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_DRAGTWOPOINTCALLBACK_OFFSET UNITYSDK_OFFSET(0xAF7A5C0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ENDDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xAF78CA0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ENDDRAGTWOPOINTCALLBACK_OFFSET UNITYSDK_OFFSET(0xAF7A540)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_FIXEXMOVEDELTA_OFFSET UNITYSDK_OFFSET(0xAF72BE0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GETCAMERA_OFFSET UNITYSDK_OFFSET(0xAF6ADD0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GETCURRENTCAMERAOFFSET_OFFSET UNITYSDK_OFFSET(0xAF6AF90)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GETCURRENTFOV_OFFSET UNITYSDK_OFFSET(0xAF75750)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GETFRIENDNETWORKDATA_OFFSET UNITYSDK_OFFSET(0xAF78410)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0xAF7B600)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_CURRENTFRIENDSYS_OFFSET UNITYSDK_OFFSET(0xAF6FDE0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_CURRENTGROUP_OFFSET UNITYSDK_OFFSET(0xAF6FD80)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_FRIENDSYSINFOS_OFFSET UNITYSDK_OFFSET(0xAF6FDC0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_NETWORKDATA_OFFSET UNITYSDK_OFFSET(0xAF6FD90)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_OPENMODE_OFFSET UNITYSDK_OFFSET(0xAF6FDA0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_PHOTOWALLOBJECTDATAS_OFFSET UNITYSDK_OFFSET(0xAF63A30)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_VIRTUALCURSOR_OFFSET UNITYSDK_OFFSET(0xAF64620)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAF6FD70)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_INITBYOPENMODE_OFFSET UNITYSDK_OFFSET(0xAF716E0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_INITCAMERA_OFFSET UNITYSDK_OFFSET(0xAF77650)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0xAF77F30)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ISINNEWBIE_OFFSET UNITYSDK_OFFSET(0xAF67FA0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAF799D0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_MOVECAMERAFORWARD_OFFSET UNITYSDK_OFFSET(0xAF739A0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_MOVECAMERATO_OFFSET UNITYSDK_OFFSET(0xAF6B0C0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONBEFORENEXTSTEPHANDLE_OFFSET UNITYSDK_OFFSET(0xAF7DB40)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCHANGECURRENTINDEXHANDLE_OFFSET UNITYSDK_OFFSET(0xAF77C60)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCLICKBACK_OFFSET UNITYSDK_OFFSET(0xAF767E0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCLICKLEFTCALLBACK_OFFSET UNITYSDK_OFFSET(0xAF7B3A0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCLICKPLATFORMIDCALLBACK_OFFSET UNITYSDK_OFFSET(0xAF76E60)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCLICKRIGHTCALLBACK_OFFSET UNITYSDK_OFFSET(0xAF7B4E0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCLICKSHOWUI_OFFSET UNITYSDK_OFFSET(0xAF76CB0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCLICKSWITCHCALLBACK_OFFSET UNITYSDK_OFFSET(0xAF773B0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF6FE00)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xAF73B80)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAF71010)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAF72540)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONNEWBIECLOSEHANDLE_OFFSET UNITYSDK_OFFSET(0xAF7DD60)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONPHOTOWALLNAMEHANDLE_OFFSET UNITYSDK_OFFSET(0xAF7B880)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONSCROLLCALLBACK_OFFSET UNITYSDK_OFFSET(0xAF7B230)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAF71140)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF70870)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF6FEA0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF70E70)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_POINTUPCALLBACK_OFFSET UNITYSDK_OFFSET(0xAF7A310)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_PROCESS3DENTITYHANDLE_OFFSET UNITYSDK_OFFSET(0xAF72320)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_PROCESSAFTERSETFOV_OFFSET UNITYSDK_OFFSET(0xAF73D40)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_PROCESSTWOPOINTERDRAG_OFFSET UNITYSDK_OFFSET(0xAF7A680)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_RAYCASTPHOTOWALLOBJECT_OFFSET UNITYSDK_OFFSET(0xAF78830)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_REFRESHOPENMODE_OFFSET UNITYSDK_OFFSET(0xAF715B0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0xAF681C0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_SETBACKBTNENABLE_OFFSET UNITYSDK_OFFSET(0xAF756C0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_SETBLOCKALLBUTTON_OFFSET UNITYSDK_OFFSET(0xAF7DBD0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_SETEDITMODECAMERACLAMP_OFFSET UNITYSDK_OFFSET(0xAF758A0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_SETFULLSCREENBTNACTIVE_OFFSET UNITYSDK_OFFSET(0xAF67B60)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_SETSHARECONSOLEBTN_OFFSET UNITYSDK_OFFSET(0xAF7B7B0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xAF72450)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__CHANGETOEDITMODE_B__36_0_OFFSET UNITYSDK_OFFSET(0xAF7F2F0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__CHANGETOEDITMODE_B__36_1_OFFSET UNITYSDK_OFFSET(0xAF7F400)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAF7EB10)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONCHANGECURRENTINDEXHANDLE_B__56_0_OFFSET UNITYSDK_OFFSET(0xAF7F670)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONCLICKBACK_B__51_0_OFFSET UNITYSDK_OFFSET(0xAF7F4A0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONCLICKBACK_B__51_1_OFFSET UNITYSDK_OFFSET(0xAF7F4E0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONCLICKSWITCHCALLBACK_B__54_0_OFFSET UNITYSDK_OFFSET(0xAF7F520)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONSHOW_B__27_0_OFFSET UNITYSDK_OFFSET(0xAF7EC00)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONUIINIT_B__23_0_OFFSET UNITYSDK_OFFSET(0xAF7EB20)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER__ONUIINIT_B__23_1_OFFSET UNITYSDK_OFFSET(0xAF7EB90)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_GETNEWBIEDYNAMICOBJECT_OFFSET UNITYSDK_OFFSET(0xAF7FAB0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF7FB20)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xAF7FB90)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAF7FC10)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAF7FC70)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAF7FCA0)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF7FD10)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF7FD20)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF7FD30)
#define MOLEMOLE_UIPHOTOWALLPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xAF7FE00)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWallPageController_TypeDefinitionIndex = 36586;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_136*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPHOTOWALLPAGECONTROLLER_CUSTOMSETITEMSELECTSTATEFUNC_OFFSET))(this, target, isselect);
		}
