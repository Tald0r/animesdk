...
#define MOLEMOLE_UIWORKBENCHROLEINFODIALOGPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC408520)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchRoleInfoDialogPopWindowController_Context_TypeDefinitionIndex = 60911;
