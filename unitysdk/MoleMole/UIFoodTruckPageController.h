...
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_CHECKCB_OFFSET UNITYSDK_OFFSET(0x9BD7A20)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9BD2D60)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONACTIVECHANGEACTION_OFFSET UNITYSDK_OFFSET(0x9BD7E60)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONCLICKOKBUTTONCALLBACK_OFFSET UNITYSDK_OFFSET(0x9BD8540)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0x9BD80F0)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9BD2E60)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x9BD7160)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONSTARFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x9BD4270)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x9BD78B0)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9BD7F00)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9BD2F00)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9BD3280)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_REFRESHALLTABS_OFFSET UNITYSDK_OFFSET(0x9BD45D0)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_REFRESHQUEST_OFFSET UNITYSDK_OFFSET(0x9BD4E80)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x9BD2D70)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9BD8870)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9BD8890)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x9BD8900)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9BD8910)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9BD8920)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9BD8930)
#define MOLEMOLE_UIFOODTRUCKPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x9BD8940)

namespace MoleMole
{
	inline static constexpr unsigned int UIFoodTruckPageController_TypeDefinitionIndex = 44280;

	class UIFoodTruckPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_055450060950DB07_2* _view; // 0x308
