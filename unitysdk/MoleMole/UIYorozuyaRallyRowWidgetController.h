...
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_ONBTNCLICK_OFFSET UNITYSDK_OFFSET(0x9F10680)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9F0FAD0)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9F0F100)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9F0FB70)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9F0EF00)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0x9F104C0)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_REFRESHSCROLLVIEWCONTENTACTIVE_OFFSET UNITYSDK_OFFSET(0x9F107F0)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_REFRESHSHOWSUBITEMS_OFFSET UNITYSDK_OFFSET(0x9F0FD60)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x9F0F260)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_REGISTERONCLICKRALLYQUEST_OFFSET UNITYSDK_OFFSET(0x9F0FC50)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_RESELECTRALLYQUEST_OFFSET UNITYSDK_OFFSET(0x9F100F0)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_SELECTRALLYCHAPTER_OFFSET UNITYSDK_OFFSET(0x9F0FCC0)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_SELECTRALLYQUEST_OFFSET UNITYSDK_OFFSET(0x9F0FF80)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER_SETNAME_OFFSET UNITYSDK_OFFSET(0x9F101C0)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9F10890)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x9F10930)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER__REFRESHSHOWSUBITEMS_B__11_0_OFFSET UNITYSDK_OFFSET(0x9F109A0)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER__REFRESHVIEW_B__9_0_OFFSET UNITYSDK_OFFSET(0x9F10940)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9F109D0)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9F10A40)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9F10AC0)
#define MOLEMOLE_UIYOROZUYARALLYROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9F10B40)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaRallyRowWidgetController_TypeDefinitionIndex = 50149;

	class UIYorozuyaRallyRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_28BDF4B69EE93815_1* _view; // 0x2D0
