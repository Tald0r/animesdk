...
#define MOLEMOLE_UIGENERALLOGINDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9D8B9C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLoginDialogContext_TypeDefinitionIndex = 52179;
