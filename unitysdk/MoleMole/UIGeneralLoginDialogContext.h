...
#define MOLEMOLE_UIGENERALLOGINDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xADF6E90)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLoginDialogContext_TypeDefinitionIndex = 38035;
