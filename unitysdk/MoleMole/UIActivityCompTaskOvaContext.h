...
#define MOLEMOLE_UIACTIVITYCOMPTASKOVACONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC811730)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCompTaskOvaContext_TypeDefinitionIndex = 61618;
