...
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x9608F00)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9608F10)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_ONCLICKLEFTTAB_OFFSET UNITYSDK_OFFSET(0x960A910)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x960A190)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x960AA20)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x960A230)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9608F20)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9609060)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x960ADE0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__CREATEROWLAYERREWARD_OFFSET UNITYSDK_OFFSET(0x960A7F0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x960AD50)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__ONEKEYGETREWARD_OFFSET UNITYSDK_OFFSET(0x960A2C0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__ONUIOPEN_B__12_0_OFFSET UNITYSDK_OFFSET(0x960AF60)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__ONUIOPEN_B__12_1_OFFSET UNITYSDK_OFFSET(0x960AF70)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__UPDATEONEKEYSTATUS_OFFSET UNITYSDK_OFFSET(0x9609DE0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER__UPDATEREWARDS_OFFSET UNITYSDK_OFFSET(0x9609350)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x960B150)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x960B1C0)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x960B230)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x960B240)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x960B250)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___CREATEROWLAYERREWARD_B__19_0_OFFSET UNITYSDK_OFFSET(0x960B140)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___ONEKEYGETREWARD_B__16_0_OFFSET UNITYSDK_OFFSET(0x960AF80)
#define MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___UPDATEREWARDS_G__GETZONENAMETEXTKEY_18_1_OFFSET UNITYSDK_OFFSET(0x960A710)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_RewardV3_PopWindowController_TypeDefinitionIndex = 46782;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIHadalZone_RewardV3_PopWindowController_TypeDefinitionIndex)->GetStaticField(0x36B70);
		}
		::MoleMole::UIHadalZone_RewardV3_PopWindowController_RewardContext* _ctx; // 0x2F8
		::Class_2_A6415ACD2BAEC3D4* _view; // 0x300
		::Class_2_468A4FBF2E9F527C* _hadalZoneModel; // 0x308
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::MoleMole::UIHadalZone_RewardV3_PopWindowController_HadalRewardData>*>* _scrollDataList; // 0x310
		::System::Int32 _currSelectTabIdx; // 0x318
		...
		::System::Void __OneKeyGetReward_b__16_0(::Class_3_025FF4981524A424_518* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_025FF4981524A424_518*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___ONEKEYGETREWARD_B__16_0_OFFSET))(this, rsp);
		}

		static ::System::String* __UpdateRewards_g__GetZoneNameTextKey_18_1(::Class_1_5DA2E7556103D5A3_280* zoneInfo, ::System::Int32 index)
		{
			return ((::System::String*(*)(::Class_1_5DA2E7556103D5A3_280*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_REWARDV3_POPWINDOWCONTROLLER___UPDATEREWARDS_G__GETZONENAMETEXTKEY_18_1_OFFSET))(zoneInfo, index);
		}
