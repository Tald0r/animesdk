...
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA45C110)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_ONCLICKSENDMSGBTN_OFFSET UNITYSDK_OFFSET(0xA45C4B0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA45C5B0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA45C6E0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA45C650)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA45C120)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA45C290)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA45C7C0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA45C7D0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA45C840)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA45C8B0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA45C8C0)
#define MOLEMOLE_UISELECTFRIENDLISTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA45C8D0)

namespace MoleMole
{
	inline static constexpr unsigned int UISelectFriendListPopWindowController_TypeDefinitionIndex = 79540;

	class UISelectFriendListPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_9D4A1E4158F1CD49* _view; // 0x2F8
		::MoleMole::UIFriendInfoWidgetController* _friendInfoController; // 0x300
