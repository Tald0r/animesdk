...
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT_ADDNEWBRANCH_OFFSET UNITYSDK_OFFSET(0xD81A830)
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT_ISDEBUG_OFFSET UNITYSDK_OFFSET(0xD81A9C0)
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT_REFRESHSPLIT_OFFSET UNITYSDK_OFFSET(0xD81AA50)
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xD81AC30)

namespace MoleMole
{
	inline static constexpr unsigned int NapSplitSerialized_MainScriptableObject_TypeDefinitionIndex = 45724;
