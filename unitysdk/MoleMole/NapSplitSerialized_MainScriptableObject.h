...
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT_ADDNEWBRANCH_OFFSET UNITYSDK_OFFSET(0xB9AAD90)
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT_ISDEBUG_OFFSET UNITYSDK_OFFSET(0xB9AAF20)
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT_REFRESHSPLIT_OFFSET UNITYSDK_OFFSET(0xB9AAFB0)
#define MOLEMOLE_NAPSPLITSERIALIZED_MAINSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xB9AB190)

namespace MoleMole
{
	inline static constexpr unsigned int NapSplitSerialized_MainScriptableObject_TypeDefinitionIndex = 63922;
