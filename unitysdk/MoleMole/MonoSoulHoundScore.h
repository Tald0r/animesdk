...
#define MOLEMOLE_MONOSOULHOUNDSCORE_METHOD_5_448C960F8C07057B_OFFSET UNITYSDK_OFFSET(0x8B26850)
#define MOLEMOLE_MONOSOULHOUNDSCORE_PAUSE_OFFSET UNITYSDK_OFFSET(0x8B26A50)
#define MOLEMOLE_MONOSOULHOUNDSCORE_SHOWSCORENUMBER_OFFSET UNITYSDK_OFFSET(0x8B264F0)
#define MOLEMOLE_MONOSOULHOUNDSCORE_UPDATE_OFFSET UNITYSDK_OFFSET(0x8B26B80)
#define MOLEMOLE_MONOSOULHOUNDSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x8B26C40)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSoulHoundScore_TypeDefinitionIndex = 37578;
