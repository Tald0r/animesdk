...
#define MOLEMOLE_UIHOLLOWMINIEVENTWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6C97F40)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMiniEventWidgetController_Context_TypeDefinitionIndex = 46832;
