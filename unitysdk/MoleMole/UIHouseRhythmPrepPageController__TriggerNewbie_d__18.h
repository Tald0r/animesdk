...
#define MOLEMOLE_UIHOUSERHYTHMPREPPAGECONTROLLER__TRIGGERNEWBIE_D__18_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3A1CE0)
#define MOLEMOLE_UIHOUSERHYTHMPREPPAGECONTROLLER__TRIGGERNEWBIE_D__18_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x308FB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmPrepPageController__TriggerNewbie_d__18_TypeDefinitionIndex = 62365;
	...
	struct alignas(8) UIHouseRhythmPrepPageController__TriggerNewbie_d__18
	{
		...
		::MoleMole::UIHouseRhythmPrepPageController* __4__this; // 0x40
