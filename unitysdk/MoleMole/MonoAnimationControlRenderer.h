...
#define MOLEMOLE_MONOANIMATIONCONTROLRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x82E4800)

namespace MoleMole
{
	inline static constexpr unsigned int MonoAnimationControlRenderer_TypeDefinitionIndex = 75837;
