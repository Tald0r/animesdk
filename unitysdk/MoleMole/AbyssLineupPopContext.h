...
#define MOLEMOLE_ABYSSLINEUPPOPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9CCA100)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssLineupPopContext_TypeDefinitionIndex = 52038;

	class AbyssLineupPopContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Collections::Generic::List_1<::Class_2_D89CCC627A66D0AD*>* AvatarItemList; // 0x28
