...
#define MOLEMOLE_CONFIGUIICONMOUNT_TRYGETMOUNTCONFIG_1_OFFSET UNITYSDK_OFFSET(0xCD33730)
#define MOLEMOLE_CONFIGUIICONMOUNT_TRYGETMOUNTCONFIG_OFFSET UNITYSDK_OFFSET(0xCD335F0)
#define MOLEMOLE_CONFIGUIICONMOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD33980)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIIconMount_TypeDefinitionIndex = 62988;
