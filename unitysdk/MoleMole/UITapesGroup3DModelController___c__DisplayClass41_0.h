...
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS41_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9EE3670)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS41_0__SWITCHPERFORMANCE_B__0_OFFSET UNITYSDK_OFFSET(0x9EE3680)

namespace MoleMole
{
	inline static constexpr unsigned int UITapesGroup3DModelController___c__DisplayClass41_0_TypeDefinitionIndex = 53127;
	...
	public:
		...
		::MoleMole::Config::ConfigSetCameraStateCommonNode_CameraState* state; // 0x18
