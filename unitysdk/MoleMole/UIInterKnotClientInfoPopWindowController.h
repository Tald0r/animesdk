...
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_DEFEREDSETLOOPTEXT_OFFSET UNITYSDK_OFFSET(0x896A380)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_GETQUESTNAMETEXT_OFFSET UNITYSDK_OFFSET(0x896B050)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x896A0E0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x896B1D0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x896B300)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x896B270)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x896A0F0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x896A420)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_REFRESHLAYOUT_OFFSET UNITYSDK_OFFSET(0x896AFD0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_UPDATEQUESTITEM_OFFSET UNITYSDK_OFFSET(0x896AC80)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x896B500)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER__DEFEREDSETLOOPTEXT_B__4_0_OFFSET UNITYSDK_OFFSET(0x896B510)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER__UPDATEQUESTITEM_B__8_0_OFFSET UNITYSDK_OFFSET(0x896B550)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x896B670)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x896B6E0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x896B710)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x896B720)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x896B730)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotClientInfoPopWindowController_TypeDefinitionIndex = 67302;

	class UIInterKnotClientInfoPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_1B691570AFD0213C* _view; // 0x2F8
		::Class_2_61AC41B6DCFBC671* _uiQuestModel; // 0x300
		::MoleMole::UIInterKnotClientInfoDialogContext* _curContext; // 0x308
		::System::Collections::Generic::List_1<::System::Int32>* _cachedId; // 0x310
		::System::Int32 _selectIndex; // 0x318
		::MoleMole::UIInterKnotClientTitleInfoRowWidgetController* _selectCtrl; // 0x320
		::Class_2_208CC9941471731A_279* _spConfig; // 0x328
		::System::Single detailHeight; // 0x330
		::UnityEngine::RectTransform* detailContentRectTrans; // 0x338
		::UnityEngine::RectTransform* detailParentRectTrans; // 0x340
