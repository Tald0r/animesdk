...
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_DEFEREDSETLOOPTEXT_OFFSET UNITYSDK_OFFSET(0x9835140)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_GETQUESTNAMETEXT_OFFSET UNITYSDK_OFFSET(0x9835E10)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9834EA0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9835F90)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x98360C0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9836030)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9834EB0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98351E0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_REFRESHLAYOUT_OFFSET UNITYSDK_OFFSET(0x9835D90)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER_UPDATEQUESTITEM_OFFSET UNITYSDK_OFFSET(0x9835A40)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98362C0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER__DEFEREDSETLOOPTEXT_B__4_0_OFFSET UNITYSDK_OFFSET(0x98362D0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER__UPDATEQUESTITEM_B__8_0_OFFSET UNITYSDK_OFFSET(0x9836310)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9836430)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x98364A0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98364D0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98364E0)
#define MOLEMOLE_UIINTERKNOTCLIENTINFOPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98364F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotClientInfoPopWindowController_TypeDefinitionIndex = 52932;
	...
	public:
		...
		::Class_2_208CC9941471731A_787* _spConfig; // 0x328
