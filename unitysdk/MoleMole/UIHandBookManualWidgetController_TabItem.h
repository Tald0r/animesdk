...
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_CHECKCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x9611250)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_CHECKREWARDBUFF_OFFSET UNITYSDK_OFFSET(0x9611460)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GETREWARDBUFFGAMETAG_OFFSET UNITYSDK_OFFSET(0x96113D0)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0x9610BF0)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x9610D20)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x9610B80)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_ICONTYPE_OFFSET UNITYSDK_OFFSET(0x9610BC0)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_REDDOTINFO_OFFSET UNITYSDK_OFFSET(0x9610BD0)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_REWARDBUFF_OFFSET UNITYSDK_OFFSET(0x9610D40)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x9610AC0)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_SET_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x9610D30)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_SET_REDDOTINFO_OFFSET UNITYSDK_OFFSET(0x9610BE0)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_SET_REWARDBUFF_OFFSET UNITYSDK_OFFSET(0x9610D50)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_SHOWTAB_OFFSET UNITYSDK_OFFSET(0x9610D60)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9611640)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookManualWidgetController_TabItem_TypeDefinitionIndex = 49199;

	class UIHandBookManualWidgetController_TabItem : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_187* entryTemplate; // 0x10
		::System::Func_1<::MoleMole::UIBaseController*>* _CreateWidget_k__BackingField; // 0x18
		::Class_1_6535CE33BDD95E74* _RewardBuff_k__BackingField; // 0x20
		...
		::System::Int64 EndTimeStamp; // 0x40
