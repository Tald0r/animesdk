...
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_CHECKCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x8C36110)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_CHECKREWARDBUFF_OFFSET UNITYSDK_OFFSET(0x8C36320)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GETREWARDBUFFGAMETAG_OFFSET UNITYSDK_OFFSET(0x8C36290)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_CONTROLLER_OFFSET UNITYSDK_OFFSET(0x8C35AB0)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x8C35BE0)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x8C35A40)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_ICONTYPE_OFFSET UNITYSDK_OFFSET(0x8C35A80)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_REDDOTINFO_OFFSET UNITYSDK_OFFSET(0x8C35A90)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_REWARDBUFF_OFFSET UNITYSDK_OFFSET(0x8C35C00)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x8C35980)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_SET_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x8C35BF0)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_SET_REDDOTINFO_OFFSET UNITYSDK_OFFSET(0x8C35AA0)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_SET_REWARDBUFF_OFFSET UNITYSDK_OFFSET(0x8C35C10)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM_SHOWTAB_OFFSET UNITYSDK_OFFSET(0x8C35C20)
#define MOLEMOLE_UIHANDBOOKMANUALWIDGETCONTROLLER_TABITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x8C36500)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookManualWidgetController_TabItem_TypeDefinitionIndex = 37681;
	...
	public:
		...
		::Class_1_6535CE33BDD95E74* _RewardBuff_k__BackingField; // 0x18
		::Class_2_208CC9941471731A_96* entryTemplate; // 0x20
