...
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB9CE40)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB9CC70)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB9CEE0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB9C950)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB9CBC0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB9CFC0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB9CFF0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB9D060)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB9D0D0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB9D150)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARD03ROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB9D1B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIShoppingMallLimitedCard03RowWidgetController_TypeDefinitionIndex = 38454;

	class UIShoppingMallLimitedCard03RowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_1AE7AA27121819AA* _view; // 0x2A0
