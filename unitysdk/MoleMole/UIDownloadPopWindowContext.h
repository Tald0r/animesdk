...
#define MOLEMOLE_UIDOWNLOADPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA2734F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDownloadPopWindowContext_TypeDefinitionIndex = 39202;
