...
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_ACCELERATIONVIEW_OFFSET UNITYSDK_OFFSET(0xBE2C0D0)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_GET_ISMANUALACCELERATIONON_OFFSET UNITYSDK_OFFSET(0xBE2BBA0)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_LOCKVIEW_OFFSET UNITYSDK_OFFSET(0xBE2C270)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_MANUALACCELERATE_OFFSET UNITYSDK_OFFSET(0xBE2BE20)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_NOACCELERATIONVIEW_OFFSET UNITYSDK_OFFSET(0xBE2C1A0)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBE2BF50)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBE2BFF0)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBE2BBD0)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBE2BEA0)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBE2C340)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0xBE2C370)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBE2C500)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBE2C570)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBE2C5F0)
#define MOLEMOLE_UIMANUALACCLERATEBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBE2C650)

namespace MoleMole
{
	inline static constexpr unsigned int UIManualAcclerateBtnWidgetController_TypeDefinitionIndex = 54005;
