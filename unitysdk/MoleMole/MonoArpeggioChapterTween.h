...
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN_PLAYCHAPTERTWEEN_OFFSET UNITYSDK_OFFSET(0xA7E8970)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN_PLAYCONTENTRECTTWEEN_OFFSET UNITYSDK_OFFSET(0xA7E8AF0)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN_RECOVERCHAPTER_OFFSET UNITYSDK_OFFSET(0xA7E8E80)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0xA7E8F50)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN__PLAYCONTENTRECTTWEEN_B__8_0_OFFSET UNITYSDK_OFFSET(0xA7E8F70)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN__PLAYCONTENTRECTTWEEN_B__8_1_OFFSET UNITYSDK_OFFSET(0xA7E8FB0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoArpeggioChapterTween_TypeDefinitionIndex = 52791;
