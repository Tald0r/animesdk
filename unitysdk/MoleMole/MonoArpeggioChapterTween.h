...
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN_PLAYCHAPTERTWEEN_OFFSET UNITYSDK_OFFSET(0xA5FEB00)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN_PLAYCONTENTRECTTWEEN_OFFSET UNITYSDK_OFFSET(0xA5FEC80)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN_RECOVERCHAPTER_OFFSET UNITYSDK_OFFSET(0xA5FF010)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0xA5FF0E0)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN__PLAYCONTENTRECTTWEEN_B__8_0_OFFSET UNITYSDK_OFFSET(0xA5FF100)
#define MOLEMOLE_MONOARPEGGIOCHAPTERTWEEN__PLAYCONTENTRECTTWEEN_B__8_1_OFFSET UNITYSDK_OFFSET(0xA5FF140)

namespace MoleMole
{
	inline static constexpr unsigned int MonoArpeggioChapterTween_TypeDefinitionIndex = 43235;
