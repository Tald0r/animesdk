...
#define MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER_CANSELECT_OFFSET UNITYSDK_OFFSET(0xB755D00)
#define MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xB755E20)
#define MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER_ISLOCK_OFFSET UNITYSDK_OFFSET(0xB755DB0)
#define MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0xB755B90)
#define MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB755910)
#define MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB755A50)
#define MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB756000)
#define MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER___BASE_CANSELECT_OFFSET UNITYSDK_OFFSET(0xB756010)
#define MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER___BASE_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xB756020)
#define MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER___BASE_ISLOCK_OFFSET UNITYSDK_OFFSET(0xB756030)
#define MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONCONFIRM_OFFSET UNITYSDK_OFFSET(0xB7560A0)
#define MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB756100)
#define MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB7561A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooUAVBuffListDialogPopWindowController_TypeDefinitionIndex = 65389;
	...
	public:
		...
		{
			return ((::MoleMole::UIBuffListItemRowWidgetController_BuffListItemData*(*)(::PVOID, ::Class_2_208CC9941471731A_53*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER_CREATEITEM_OFFSET))(this, template_);
		}
		...
		{
			return ((::MoleMole::UIBuffListItemRowWidgetController_BuffListItemData*(*)(::PVOID, ::Class_2_208CC9941471731A_53*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBANGBOOUAVBUFFLISTDIALOGPOPWINDOWCONTROLLER___BASE_CREATEITEM_OFFSET))(this, P0);
		}
