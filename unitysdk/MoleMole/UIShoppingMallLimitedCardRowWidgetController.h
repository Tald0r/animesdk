...
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9586870)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x95869F0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x95866A0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9586910)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9586370)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95865F0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9586A80)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9586AB0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9586B20)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9586B50)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9586BC0)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9586C40)
#define MOLEMOLE_UISHOPPINGMALLLIMITEDCARDROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9586CA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIShoppingMallLimitedCardRowWidgetController_TypeDefinitionIndex = 67273;

	class UIShoppingMallLimitedCardRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_230* _view; // 0x2A0
