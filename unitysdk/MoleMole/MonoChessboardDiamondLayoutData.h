...
#define MOLEMOLE_MONOCHESSBOARDDIAMONDLAYOUTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x75AE7C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoChessboardDiamondLayoutData_TypeDefinitionIndex = 70590;
