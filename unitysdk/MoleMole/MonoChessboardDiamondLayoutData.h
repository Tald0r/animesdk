...
#define MOLEMOLE_MONOCHESSBOARDDIAMONDLAYOUTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x67B0CB0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoChessboardDiamondLayoutData_TypeDefinitionIndex = 49658;
