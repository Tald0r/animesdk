...
#define MOLEMOLE_UICPROLESELECTDIFFICULTYSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x17B5FF00)

namespace MoleMole
{
	inline static constexpr unsigned int UICpRoleSelectDifficultyScript_TypeDefinitionIndex = 81478;
