...
#define MOLEMOLE_UICPROLESELECTDIFFICULTYSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A39B3C0)

namespace MoleMole
{
	inline static constexpr unsigned int UICpRoleSelectDifficultyScript_TypeDefinitionIndex = 83529;
