...
namespace MoleMole
{
	...
	public:
		...
		::System::Void _ctor()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_VOPERFORMSUBSYSTEM___C__DISPLAYCLASS51_0__CTOR_OFFSET))(this);
		}

		::System::Void __OperateNpcEntityNameByEntity_b__1(::MoleMole::VOPerformSubSystem_NpcNameShowInfo& cur)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::VOPerformSubSystem_NpcNameShowInfo&))((::PBYTE)hIl2Cpp + MOLEMOLE_VOPERFORMSUBSYSTEM___C__DISPLAYCLASS51_0___OPERATENPCENTITYNAMEBYENTITY_B__1_OFFSET))(this, cur);
		}
	};
}
