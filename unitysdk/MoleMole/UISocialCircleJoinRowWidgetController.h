...
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD3B5C10)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD3B5D20)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD3B5E20)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3B5C80)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD3B6000)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD3B6010)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD3B6080)
#define MOLEMOLE_UISOCIALCIRCLEJOINROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3B6100)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleJoinRowWidgetController_TypeDefinitionIndex = 80786;
