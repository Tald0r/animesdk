...
#define MOLEMOLE_UITAGCOMPONENT_SETHINT_OFFSET UNITYSDK_OFFSET(0x7C48600)
#define MOLEMOLE_UITAGCOMPONENT_SETTAG_OFFSET UNITYSDK_OFFSET(0x7C482E0)
#define MOLEMOLE_UITAGCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x7C48710)

namespace MoleMole
{
	inline static constexpr unsigned int UITagComponent_TypeDefinitionIndex = 51316;
	...
	public:
		...
		::Class_2_208CC9941471731A_648* Field_5_3; // 0x30
