...
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER_CREATEUIQUESTIONSANSWER3D3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x96E3DF0)
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER_CREATEUIQUESTIONSANSWERWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x96E3D20)
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER_CREATEUIQUESTIONSLISTWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x96E3C50)
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x96E3EA0)
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER___BASE_CREATEUIQUESTIONSANSWER3D3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x96E3EB0)
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER___BASE_CREATEUIQUESTIONSANSWERWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x96E3F60)
#define MOLEMOLE_UIQUESTIONSANSWERV3PAGECONTROLLER___BASE_CREATEUIQUESTIONSLISTWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0x96E3F70)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerV3PageController_TypeDefinitionIndex = 63820;
