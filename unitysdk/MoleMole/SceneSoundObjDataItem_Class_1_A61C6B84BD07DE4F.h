...
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_CLASS_1_A61C6B84BD07DE4F_INIT_OFFSET UNITYSDK_OFFSET(0x9853A20)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_CLASS_1_A61C6B84BD07DE4F_METHOD_1_956051F9F414D412_OFFSET UNITYSDK_OFFSET(0x9854F50)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_CLASS_1_A61C6B84BD07DE4F_ONSYNC_OFFSET UNITYSDK_OFFSET(0x9854680)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_CLASS_1_A61C6B84BD07DE4F_POLISH_OFFSET UNITYSDK_OFFSET(0x9854D40)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_CLASS_1_A61C6B84BD07DE4F_RECYCLE_OFFSET UNITYSDK_OFFSET(0x9854DE0)
#define MOLEMOLE_SCENESOUNDOBJDATAITEM_CLASS_1_A61C6B84BD07DE4F__CTOR_OFFSET UNITYSDK_OFFSET(0x9854F40)

namespace MoleMole
{
	inline static constexpr unsigned int SceneSoundObjDataItem_Class_1_A61C6B84BD07DE4F_TypeDefinitionIndex = 80781;

	class SceneSoundObjDataItem_Class_1_A61C6B84BD07DE4F : public ::System::Object
	{
	public:
		::MoleMole::SceneSoundObjDataItem* Field_1_0; // 0x10
		::Dest::Math::Sphere3 Field_1_5; // 0x18
		::Dest::Math::Box3 Field_1_2; // 0x28
		::Dest::Math::Box3 Field_1_4; // 0x64
		::System::UInt32 Field_1_1; // 0xA0
		::Dest::Math::Sphere3 Field_1_3; // 0xA4
