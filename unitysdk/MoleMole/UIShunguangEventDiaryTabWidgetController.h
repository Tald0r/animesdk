...
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x78F2FB0)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x78F3130)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x78F3050)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x78F2E50)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x78F3210)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x78F3490)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x78F34A0)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x78F3510)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x78F3590)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x78F3610)

namespace MoleMole
{
	inline static constexpr unsigned int UIShunguangEventDiaryTabWidgetController_TypeDefinitionIndex = 57573;

	class UIShunguangEventDiaryTabWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_AF7956DF7F5D0968* _view; // 0x2D0
		::Class_1_3D46C5D064952E16_2* _data; // 0x2D8
