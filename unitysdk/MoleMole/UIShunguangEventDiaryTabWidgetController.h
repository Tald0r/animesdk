...
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA6D8B0)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCA6DA30)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA6D950)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA6D750)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCA6DB10)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA6DD90)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA6DDA0)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCA6DE10)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA6DE90)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA6DF10)

namespace MoleMole
{
	inline static constexpr unsigned int UIShunguangEventDiaryTabWidgetController_TypeDefinitionIndex = 68574;
	...
	public:
		...
		::Class_1_3D46C5D064952E16* _data; // 0x2D8
