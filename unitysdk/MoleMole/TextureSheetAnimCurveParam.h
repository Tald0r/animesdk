...
#define MOLEMOLE_TEXTURESHEETANIMCURVEPARAM_EVALUATE_OFFSET UNITYSDK_OFFSET(0x99475A0)
#define MOLEMOLE_TEXTURESHEETANIMCURVEPARAM_GET_VALID_OFFSET UNITYSDK_OFFSET(0x9947520)
#define MOLEMOLE_TEXTURESHEETANIMCURVEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x99476E0)

namespace MoleMole
{
	inline static constexpr unsigned int TextureSheetAnimCurveParam_TypeDefinitionIndex = 59196;
