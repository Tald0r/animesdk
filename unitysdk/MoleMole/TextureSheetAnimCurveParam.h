...
#define MOLEMOLE_TEXTURESHEETANIMCURVEPARAM_EVALUATE_OFFSET UNITYSDK_OFFSET(0xC7DB0B0)
#define MOLEMOLE_TEXTURESHEETANIMCURVEPARAM_GET_VALID_OFFSET UNITYSDK_OFFSET(0xC7DB030)
#define MOLEMOLE_TEXTURESHEETANIMCURVEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC7DB1F0)

namespace MoleMole
{
	inline static constexpr unsigned int TextureSheetAnimCurveParam_TypeDefinitionIndex = 57821;
