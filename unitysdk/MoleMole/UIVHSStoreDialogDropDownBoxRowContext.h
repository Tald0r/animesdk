...
#define MOLEMOLE_UIVHSSTOREDIALOGDROPDOWNBOXROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9EE9B70)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreDialogDropDownBoxRowContext_TypeDefinitionIndex = 61302;

	class UIVHSStoreDialogDropDownBoxRowContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::UnityEngine::RectTransform* localTrans; // 0x28
		::System::Action* onCloseCallback; // 0x30
		::System::Collections::Generic::HashSet_1<::System::Int32>* filterTagLv; // 0x38
		::System::Collections::Generic::HashSet_1<::System::Int32>* filterTag; // 0x40
		::System::Int32 typeSelectWidth; // 0x48
		::System::Int32 typeSelectHeight; // 0x4C
		::System::Int32 typeSelectOffsetX; // 0x50
		::System::Int32 typeSelectOffsetY; // 0x54
