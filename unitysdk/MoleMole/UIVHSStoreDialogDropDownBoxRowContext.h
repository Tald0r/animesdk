...
#define MOLEMOLE_UIVHSSTOREDIALOGDROPDOWNBOXROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAE98860)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreDialogDropDownBoxRowContext_TypeDefinitionIndex = 79084;
