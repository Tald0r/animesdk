...
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_CLEARBUFFID_OFFSET UNITYSDK_OFFSET(0x744B6C0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_CLEARHANDLE_OFFSET UNITYSDK_OFFSET(0x744A0E0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_CLEARNEXTBUFFSTATE_OFFSET UNITYSDK_OFFSET(0x7449D00)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_GETPLACEHOLDERCOUNT_OFFSET UNITYSDK_OFFSET(0x744A270)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_GET_END_OFFSET UNITYSDK_OFFSET(0x7448320)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_GET_LOOP02ROOT_OFFSET UNITYSDK_OFFSET(0x7447930)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_GET_LOOP02_OFFSET UNITYSDK_OFFSET(0x7447A50)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_GET_LOOP_OFFSET UNITYSDK_OFFSET(0x7448020)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_GET_START_OFFSET UNITYSDK_OFFSET(0x7448700)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0x744A6A0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_PLAYBUFFDES_OFFSET UNITYSDK_OFFSET(0x744B1D0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_REFRESHSPECIALSTATE_OFFSET UNITYSDK_OFFSET(0x7448E70)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_REPLAY_OFFSET UNITYSDK_OFFSET(0x744B950)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_RESETBUFFID_OFFSET UNITYSDK_OFFSET(0x744B400)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_RESET_OFFSET UNITYSDK_OFFSET(0x7449D80)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_SETBUFFID_OFFSET UNITYSDK_OFFSET(0x744ACA0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_SETNEXTBUFFSTATE_OFFSET UNITYSDK_OFFSET(0x7449F10)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_SETSATURATION_OFFSET UNITYSDK_OFFSET(0x7449740)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_SETTOTOP_OFFSET UNITYSDK_OFFSET(0x74496D0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_SHOWLOOP_OFFSET UNITYSDK_OFFSET(0x744B060)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT_UPDATEMUTESTATE_OFFSET UNITYSDK_OFFSET(0x744A4E0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__CLEARBUFFID_B__45_0_OFFSET UNITYSDK_OFFSET(0x744BAC0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x74492A0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x7448AE0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__DELAY_OFFSET UNITYSDK_OFFSET(0x744B130)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__REFRESHSPECIALSTATE_G__UPDATEPARTICLE_38_0_OFFSET UNITYSDK_OFFSET(0x744A730)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__SETNEXTBUFFSTATE_B__34_0_OFFSET UNITYSDK_OFFSET(0x744B9D0)
#define MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT___DELAY_B__42_0_OFFSET UNITYSDK_OFFSET(0x744BA80)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainBottomWidgetController_BuffSlot_TypeDefinitionIndex = 76067;
	...
	public:
		...
		::UnityEngine::CanvasGroup* group; // 0x18
		::UnityEngine::UI::Text* buffDes; // 0x20
		::UnityEngine::GameObject* normalGo; // 0x28
		::UnityEngine::GameObject* specialGo; // 0x30
		...
		::MoleMole::UIHollowMainBottomWidgetController* ctrl; // 0x50
		::Class_2_00EADCA3A1989FAA* bless; // 0x58
		::UnityEngine::Animation* lockAnim; // 0x60
		::UnityEngine::RectTransform* transform; // 0x68
		::System::Int32 itemid; // 0x70
		::System::Boolean isRemoving; // 0x74
		::System::Boolean isNextBuff; // 0x75
		::System::Boolean isStarting; // 0x76
		::System::Boolean ForbidSpecial; // 0x77
		::System::Boolean isSpecial; // 0x78
		::System::Int32 slotIndex; // 0x7C
		...
		::System::Void _ctor_1(::System::Int32 i, ::Class_3_647A206587033F4E<::MoleMole::UIArpeggioBottomBlessRowWidgetController*>* tran, ::MoleMole::UIHollowMainBottomWidgetController* uiHollowMainBottomWidgetController)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Class_3_647A206587033F4E<::MoleMole::UIArpeggioBottomBlessRowWidgetController*>*, ::MoleMole::UIHollowMainBottomWidgetController*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWMAINBOTTOMWIDGETCONTROLLER_BUFFSLOT__CTOR_1_OFFSET))(this, i, tran, uiHollowMainBottomWidgetController);
		}
