...
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER_INITSTYLE_OFFSET UNITYSDK_OFFSET(0xD7088F0)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD708A40)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD708AE0)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD708840)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD708990)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER_SETRELATIVEPOSITIONBYPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xD708BC0)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD708D50)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD708D80)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD708DF0)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD708E70)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD708ED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWaterFlowPointRowWidgetController_TypeDefinitionIndex = 78458;
