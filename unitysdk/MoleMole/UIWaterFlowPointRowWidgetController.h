...
class Class_2_3994ECBAB54F14BF;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER_INITSTYLE_OFFSET UNITYSDK_OFFSET(0x85071B0)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8507300)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x85073A0)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8507100)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8507250)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER_SETRELATIVEPOSITIONBYPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x8507480)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8507610)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8507640)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x85076B0)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8507730)
#define MOLEMOLE_UIWATERFLOWPOINTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8507790)

namespace MoleMole
{
	inline static constexpr unsigned int UIWaterFlowPointRowWidgetController_TypeDefinitionIndex = 59915;

	class UIWaterFlowPointRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_3994ECBAB54F14BF* _view; // 0x2A0
