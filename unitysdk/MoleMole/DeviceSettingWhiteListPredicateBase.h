...
#define MOLEMOLE_DEVICESETTINGWHITELISTPREDICATEBASE_GETPREDICATESTRING_OFFSET UNITYSDK_OFFSET(0x6E06C60)
#define MOLEMOLE_DEVICESETTINGWHITELISTPREDICATEBASE_PREDICATE_OFFSET UNITYSDK_OFFSET(0x6E069D0)
#define MOLEMOLE_DEVICESETTINGWHITELISTPREDICATEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E06CD0)
#define MOLEMOLE_DEVICESETTINGWHITELISTPREDICATEBASE___BASE_PREDICATE_OFFSET UNITYSDK_OFFSET(0x6E06D50)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingWhiteListPredicateBase_TypeDefinitionIndex = 45076;
