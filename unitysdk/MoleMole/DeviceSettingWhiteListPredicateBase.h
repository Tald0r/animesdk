...
#define MOLEMOLE_DEVICESETTINGWHITELISTPREDICATEBASE_GETPREDICATESTRING_OFFSET UNITYSDK_OFFSET(0xC255F00)
#define MOLEMOLE_DEVICESETTINGWHITELISTPREDICATEBASE_PREDICATE_OFFSET UNITYSDK_OFFSET(0xC255C70)
#define MOLEMOLE_DEVICESETTINGWHITELISTPREDICATEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xC255F70)
#define MOLEMOLE_DEVICESETTINGWHITELISTPREDICATEBASE___BASE_PREDICATE_OFFSET UNITYSDK_OFFSET(0xC255FF0)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingWhiteListPredicateBase_TypeDefinitionIndex = 46534;
