...
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ADDBOSSID_OFFSET UNITYSDK_OFFSET(0x8966450)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_CLEARCURBOSSHUD_OFFSET UNITYSDK_OFFSET(0x8967A70)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_CREATESUBWIDGETS_OFFSET UNITYSDK_OFFSET(0x89655A0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_DELAYCALL_OFFSET UNITYSDK_OFFSET(0x89698C0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89661E0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_GETBACKUPCACHE_OFFSET UNITYSDK_OFFSET(0x8968190)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_GETBOSSID_OFFSET UNITYSDK_OFFSET(0x8967D10)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_GETMODELCACHEBYID_OFFSET UNITYSDK_OFFSET(0x89694D0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_GETVIEWMODELBYID_OFFSET UNITYSDK_OFFSET(0x8969440)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x8965470)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8968D10)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONBUFFADD_OFFSET UNITYSDK_OFFSET(0x8968300)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONBUFFCUSTOMNUMCHANGE_OFFSET UNITYSDK_OFFSET(0x8968580)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONBUFFREMOVE_OFFSET UNITYSDK_OFFSET(0x8968690)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8966050)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x89688F0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x8969A70)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONLOCKTARGET_OFFSET UNITYSDK_OFFSET(0x8968DD0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONOVERDRIVEHUDSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x89697C0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONSTUNDESTROYDELAY_OFFSET UNITYSDK_OFFSET(0x89695F0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONSTUNRESETSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x89692A0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x89660F0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8965480)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8965C10)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_OVERDRIVESTATEFADEIN_OFFSET UNITYSDK_OFFSET(0x89691E0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_OVERDRIVESTATEFADEOUT_OFFSET UNITYSDK_OFFSET(0x8969120)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_REFRESHLIFEPOINT_OFFSET UNITYSDK_OFFSET(0x8967430)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8966CF0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_REMOVEBOSSHUD_OFFSET UNITYSDK_OFFSET(0x8967D90)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_SETACTIVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x8968820)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_SETACTIVEWITHANIM_OFFSET UNITYSDK_OFFSET(0x8968790)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x8965870)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_STOPALLDELAYCALLBACK_OFFSET UNITYSDK_OFFSET(0x89699B0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_TICKDELAYCALL_OFFSET UNITYSDK_OFFSET(0x8965D60)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x8965CD0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER__ADDBOSSID_G__NEEDCHANGEBOSSVIEWMODEL_10_0_OFFSET UNITYSDK_OFFSET(0x8966A00)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8969B80)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0x8969CE0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER__OVERDRIVESTATEFADEIN_B__40_0_OFFSET UNITYSDK_OFFSET(0x8969E40)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER__SETACTIVEINTERNAL_B__35_0_OFFSET UNITYSDK_OFFSET(0x8969D60)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8969F20)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8969F90)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x896A010)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x896A070)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelUpToolBarBossWidgetController_TypeDefinitionIndex = 71770;
	...
	public:
		...
		// static const ::System::String* OverDriverFadeInAnim; // 0x0
		// static const ::System::String* OverDriverLoopAnim; // 0x0
		// static const ::System::String* OverDriverFadeOutAnim; // 0x0
		::Class_2_77915EE9002093EC_1* _view; // 0x2A0
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* _lifePoints; // 0x2A8
		::System::String* _lifePointCustomProperty; // 0x2B0
		::System::Boolean isFading; // 0x2B8
		::System::Boolean fadeing; // 0x2B9
		::System::Boolean curActiveValue; // 0x2BA
		::System::Boolean targetActiveValue; // 0x2BB
		::System::Boolean cancelActiveFade; // 0x2BC
		::System::Boolean loopInOverDrive; // 0x2BD
		::System::Collections::Generic::List_1<::System::Single>* delayTimerList; // 0x2C0
		::System::Collections::Generic::List_1<::System::Action*>* delayCallBackList; // 0x2C8
		::Class_1_5549A0E56E69A540* bossViewModel_1; // 0x2D0
		::MoleMole::UIStunDamageWidgetController* _stunDamageWidget_1; // 0x2D8
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_6740168B11ECBECF*>* bossModelCache; // 0x2E0
		...
		::System::Void Update()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_UPDATE_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_LATEUPDATE_OFFSET))(this);
		}
		...
		::Class_1_5549A0E56E69A540* GetViewModelById(::System::UInt32 targetId)
		{
			return ((::Class_1_5549A0E56E69A540*(*)(::PVOID, ::System::UInt32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_GETVIEWMODELBYID_OFFSET))(this, targetId);
		}
