...
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ADDBOSSID_OFFSET UNITYSDK_OFFSET(0x9831230)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_CLEARCURBOSSHUD_OFFSET UNITYSDK_OFFSET(0x9832840)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_CREATESUBWIDGETS_OFFSET UNITYSDK_OFFSET(0x9830370)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_DELAYCALL_OFFSET UNITYSDK_OFFSET(0x9834690)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9830FC0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_GETBACKUPCACHE_OFFSET UNITYSDK_OFFSET(0x9832F50)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_GETBOSSID_OFFSET UNITYSDK_OFFSET(0x9832AE0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_GETMODELCACHEBYID_OFFSET UNITYSDK_OFFSET(0x98342A0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_GETVIEWMODELBYID_OFFSET UNITYSDK_OFFSET(0x9834210)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x9830240)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9833AE0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONBUFFADD_OFFSET UNITYSDK_OFFSET(0x98330C0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONBUFFCUSTOMNUMCHANGE_OFFSET UNITYSDK_OFFSET(0x9833340)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONBUFFREMOVE_OFFSET UNITYSDK_OFFSET(0x9833460)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9830E30)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x98336C0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x9834840)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONLOCKTARGET_OFFSET UNITYSDK_OFFSET(0x9833BA0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONOVERDRIVEHUDSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x9834590)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONSTUNDESTROYDELAY_OFFSET UNITYSDK_OFFSET(0x98343C0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONSTUNRESETSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x9834070)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9830ED0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9830250)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98309F0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_OVERDRIVESTATEFADEIN_OFFSET UNITYSDK_OFFSET(0x9833FB0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_OVERDRIVESTATEFADEOUT_OFFSET UNITYSDK_OFFSET(0x9833EF0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_REFRESHLIFEPOINT_OFFSET UNITYSDK_OFFSET(0x9832200)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x9831AD0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_REMOVEBOSSHUD_OFFSET UNITYSDK_OFFSET(0x9832B60)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_SETACTIVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x98335F0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_SETACTIVEWITHANIM_OFFSET UNITYSDK_OFFSET(0x9833560)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x9830650)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_STOPALLDELAYCALLBACK_OFFSET UNITYSDK_OFFSET(0x9834780)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_TICKDELAYCALL_OFFSET UNITYSDK_OFFSET(0x9830B40)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9830AB0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER__ADDBOSSID_G__NEEDCHANGEBOSSVIEWMODEL_10_0_OFFSET UNITYSDK_OFFSET(0x98317E0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9834950)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0x9834AA0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER__OVERDRIVESTATEFADEIN_B__40_0_OFFSET UNITYSDK_OFFSET(0x9834C00)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER__SETACTIVEINTERNAL_B__35_0_OFFSET UNITYSDK_OFFSET(0x9834B20)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9834CE0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9834D50)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9834DD0)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9834E30)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelUpToolBarBossWidgetController_TypeDefinitionIndex = 61165;
	...
	public:
		...
		::Class_1_E76B0395C1735292* bossViewModel_1; // 0x2D0
		...
		::Class_1_E76B0395C1735292* GetViewModelById(::System::UInt32 targetId)
		{
			return ((::Class_1_E76B0395C1735292*(*)(::PVOID, ::System::UInt32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER_GETVIEWMODELBYID_OFFSET))(this, targetId);
		}
