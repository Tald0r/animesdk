...
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_AFTERCASELOAD_OFFSET UNITYSDK_OFFSET(0xAC525D0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0xAC51290)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_CUSTOMCHECKEDGEFUNC_OFFSET UNITYSDK_OFFSET(0xAC52FA0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_CUSTOMCLICKSELECTABLE_OFFSET UNITYSDK_OFFSET(0xAC53140)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_CUSTOMCOLLECTALLITEMFUNC_OFFSET UNITYSDK_OFFSET(0xAC52960)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_CUSTOMGETITEMPOSFUNC_OFFSET UNITYSDK_OFFSET(0xAC52E20)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_CUSTOMSETITEMSELECTSTATEFUNC_OFFSET UNITYSDK_OFFSET(0xAC52CD0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_DOBACK_OFFSET UNITYSDK_OFFSET(0xAC514C0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_FORCEREFRESHMODE_OFFSET UNITYSDK_OFFSET(0xAC50070)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_GETCAMERA_OFFSET UNITYSDK_OFFSET(0xAC4F480)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_GETCURGROUPGENERALCOUNT_OFFSET UNITYSDK_OFFSET(0xAC50E80)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_GETCURGROUPSUBTYPECOUNT_OFFSET UNITYSDK_OFFSET(0xAC51070)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_GETWORLDDELTA_OFFSET UNITYSDK_OFFSET(0xAC51960)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_GET_CURMODE_OFFSET UNITYSDK_OFFSET(0xAC4C5C0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_GET_ISANYCONTROLLING_OFFSET UNITYSDK_OFFSET(0xAC4F6C0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_GET_ISANYSETTLING_OFFSET UNITYSDK_OFFSET(0xAC4F570)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_GET_PIVOTPOS_OFFSET UNITYSDK_OFFSET(0xAC4F500)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0xAC4F540)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_HANDLESPECIALVM_OFFSET UNITYSDK_OFFSET(0xAC505C0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_HIDEBTNS_OFFSET UNITYSDK_OFFSET(0xAC4F8F0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_INITCAMERA_OFFSET UNITYSDK_OFFSET(0xAC52810)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_INITEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0xAC4D040)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xAC4CB30)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_INITVIRTUALCURSOR_OFFSET UNITYSDK_OFFSET(0xAC4D400)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xAC518E0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC4C7E0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xAC52090)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xAC522A0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAC4E460)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONITEMADDED_OFFSET UNITYSDK_OFFSET(0xAC501E0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONITEMREMOVED_OFFSET UNITYSDK_OFFSET(0xAC50830)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xAC4F340)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONPOINTDOWN_OFFSET UNITYSDK_OFFSET(0xAC516D0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONPOINTUP_OFFSET UNITYSDK_OFFSET(0xAC51740)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xAC52470)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONTWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0xAC52320)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC4D710)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC4C880)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC4DF90)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_REFRESHCASE_OFFSET UNITYSDK_OFFSET(0xAC4F9E0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_REFRESHFRIENDVIEW_OFFSET UNITYSDK_OFFSET(0xAC4FBB0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_REFRESHMODE_OFFSET UNITYSDK_OFFSET(0xAC4C660)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAC4E300)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_REMOVEEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0xAC4DBD0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_RESETCAMPOS_1_OFFSET UNITYSDK_OFFSET(0xAC50160)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_RESETCAMPOS_OFFSET UNITYSDK_OFFSET(0xAC500E0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_REVERTALL_OFFSET UNITYSDK_OFFSET(0xAC50E10)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_SAVEALL_OFFSET UNITYSDK_OFFSET(0xAC50C00)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_SETBTNHIDE_OFFSET UNITYSDK_OFFSET(0xAC4F750)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_SET_CURMODE_OFFSET UNITYSDK_OFFSET(0xAC4C5D0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_TOGGLEHIDEBTN_OFFSET UNITYSDK_OFFSET(0xAC4EDA0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_TOGGLEVIRTUALCURSOR_OFFSET UNITYSDK_OFFSET(0xAC4EF60)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_TRYMOVECAMERAANDITEM_OFFSET UNITYSDK_OFFSET(0xAC4EE20)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_TRYSELECTVM_1_OFFSET UNITYSDK_OFFSET(0xAC50A30)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_TRYSELECTVM_2_OFFSET UNITYSDK_OFFSET(0xAC502C0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_TRYSELECTVM_OFFSET UNITYSDK_OFFSET(0xAC50920)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_UICLOSE_OFFSET UNITYSDK_OFFSET(0xAC4D630)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC53210)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER__INITCAMERA_B__66_0_OFFSET UNITYSDK_OFFSET(0xAC53270)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER__INITVIEW_B__67_0_OFFSET UNITYSDK_OFFSET(0xAC532B0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER__INITVIEW_B__67_1_OFFSET UNITYSDK_OFFSET(0xAC53330)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER__INITVIEW_B__67_2_OFFSET UNITYSDK_OFFSET(0xAC53360)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER__INITVIEW_B__67_3_OFFSET UNITYSDK_OFFSET(0xAC53370)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER__INITVIEW_B__67_4_OFFSET UNITYSDK_OFFSET(0xAC53380)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER__TOGGLEVIRTUALCURSOR_B__36_0_OFFSET UNITYSDK_OFFSET(0xAC53220)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC533A0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAC53410)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xAC53440)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC534A0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC534B0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC534C0)
#define MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER___BASE_UICLOSE_OFFSET UNITYSDK_OFFSET(0xAC534D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDisplayCasePageController_TypeDefinitionIndex = 45009;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_170*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_CUSTOMSETITEMSELECTSTATEFUNC_OFFSET))(this, target, isSelect);
		}
		...
		::System::Boolean CustomClickSelectable(::Class_0_16E4307DCC419505_170* selectable)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_0_16E4307DCC419505_170*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDISPLAYCASEPAGECONTROLLER_CUSTOMCLICKSELECTABLE_OFFSET))(this, selectable);
		}
