...
#define MOLEMOLE_UIURBANMAPHUDLOCALPLAYERWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x880F4B0)
#define MOLEMOLE_UIURBANMAPHUDLOCALPLAYERWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x880F520)
#define MOLEMOLE_UIURBANMAPHUDLOCALPLAYERWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x880F620)
#define MOLEMOLE_UIURBANMAPHUDLOCALPLAYERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x880F6D0)
#define MOLEMOLE_UIURBANMAPHUDLOCALPLAYERWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x880F700)
#define MOLEMOLE_UIURBANMAPHUDLOCALPLAYERWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x880F770)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapHUDLocalPlayerWidgetController_TypeDefinitionIndex = 69992;
