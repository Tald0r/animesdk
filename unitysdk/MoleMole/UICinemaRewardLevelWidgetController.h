...
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_GETASSETPATH_OFFSET UNITYSDK_OFFSET(0xC0B8540)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0B8350)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0B83F0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0B8200)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0B82A0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_SETASSETPATHGETTER_OFFSET UNITYSDK_OFFSET(0xC0B84D0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER_SETSHOWLEVEL_OFFSET UNITYSDK_OFFSET(0xC0B8690)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0B8740)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0B8770)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0B87E0)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0B8860)
#define MOLEMOLE_UICINEMAREWARDLEVELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC0B88C0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaRewardLevelWidgetController_TypeDefinitionIndex = 80834;

	class UICinemaRewardLevelWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_94C9713A8E4B253E_2* _view; // 0x2A0
		::System::Func_3<::System::Int32, ::System::Boolean, ::Foundation::AssetPath>* _assetPathGetter; // 0x2A8
		::System::Threading::CancellationTokenSource* effectTokenSource; // 0x2B0
