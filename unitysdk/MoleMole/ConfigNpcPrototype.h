...
#define MOLEMOLE_CONFIGNPCPROTOTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0xE454700)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigNpcPrototype_TypeDefinitionIndex = 66000;
