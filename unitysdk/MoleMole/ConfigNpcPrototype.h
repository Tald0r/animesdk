...
#define MOLEMOLE_CONFIGNPCPROTOTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0xD7DB2E0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigNpcPrototype_TypeDefinitionIndex = 38762;
