...
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_ADDNPCCOMPLETED_OFFSET UNITYSDK_OFFSET(0xD02DEC0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_CREATEUIANIMATORENTITY_OFFSET UNITYSDK_OFFSET(0xD02DCF0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_DOSTOREEXITINTERACTPERFORM_OFFSET UNITYSDK_OFFSET(0xD02E910)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_AUTOPROCESSCAMERA_OFFSET UNITYSDK_OFFSET(0xD02BCB0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_CAMERAOVERLAYINDEX_OFFSET UNITYSDK_OFFSET(0xD02BC90)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_CAMERARENDERTYPE_OFFSET UNITYSDK_OFFSET(0xD02BCC0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_SHOW3DSCENEENTITIES_OFFSET UNITYSDK_OFFSET(0xD02BCA0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD02BC80)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_INITMAINVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0xD02C480)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_LOADUISTOREPAGENPCS_OFFSET UNITYSDK_OFFSET(0xD02D810)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD02CCA0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD02BCD0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD02C620)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_REFRESHUICAMERASETTINGINFO_OFFSET UNITYSDK_OFFSET(0xD02C7A0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_REMOVEALLUIANIMATORENTITIES_OFFSET UNITYSDK_OFFSET(0xD02D200)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETALLNPCACTIVE_OFFSET UNITYSDK_OFFSET(0xD02E350)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETCAMERARENDERTYPE2BASE_OFFSET UNITYSDK_OFFSET(0xD02C4E0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETCINEMACHINERECOMPOSERPAN_OFFSET UNITYSDK_OFFSET(0xD02EBA0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETMODELCAMERA_OFFSET UNITYSDK_OFFSET(0xD02BF90)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETNPCCONFIG_OFFSET UNITYSDK_OFFSET(0xD02D6D0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETNPCTRIGGER_OFFSET UNITYSDK_OFFSET(0xD02E680)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SYNCTRANSFORMPOS_OFFSET UNITYSDK_OFFSET(0xD02D670)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_TRYGETCAMERATRANSFORMINFO_OFFSET UNITYSDK_OFFSET(0xD02E490)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD02EEB0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER__ONUIOPEN_B__23_0_OFFSET UNITYSDK_OFFSET(0xD02EF20)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER__SETCINEMACHINERECOMPOSERPAN_B__36_0_OFFSET UNITYSDK_OFFSET(0xD02F090)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER__SETTOPAN_OFFSET UNITYSDK_OFFSET(0xD02EE20)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD02F0B0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD02F0C0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD02F0D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBase3DModelController_TypeDefinitionIndex = 38371;

	class UIBase3DModelController : public ::MoleMole::UIWindowController
	{
	public:
		::UnityEngine::Camera* ModelCamera; // 0x2F8
		::UnityEngine::Rendering::Universal::UniversalAdditionalCameraData* ModelCameraData; // 0x300
		::Cinemachine::CinemachineVirtualCamera* MainVirtualCamera; // 0x308
		::CinemachineRecomposer* _cinemachineRecomposer; // 0x310
		::System::Collections::Generic::List_1<::Foundation::Tuple_2<::System::String*, ::UnityEngine::GameObject*>>* _allLoadedNPCModels; // 0x318
		::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::UIStorePageNPCConfig*>* npcConfigDict; // 0x320
		::System::Collections::Generic::List_1<::System::UInt32>* _2DSound; // 0x328
		::System::Collections::Generic::List_1<::System::UInt32>* _cachedEntityIDs; // 0x330
		::System::String* _parentControllerName; // 0x338
		...
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_9BBAAE8F3BACC9BC))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBASE3DMODELCONTROLLER_SETNPCTRIGGER_OFFSET))(this, performTriggerType);
		}
