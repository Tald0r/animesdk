...
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_ADDNPCCOMPLETED_OFFSET UNITYSDK_OFFSET(0xDDC0E20)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_CREATEUIANIMATORENTITY_OFFSET UNITYSDK_OFFSET(0xDDC0C50)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_DOSTOREEXITINTERACTPERFORM_OFFSET UNITYSDK_OFFSET(0xDDC1870)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_AUTOPROCESSCAMERA_OFFSET UNITYSDK_OFFSET(0xDDBEC10)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_CAMERAOVERLAYINDEX_OFFSET UNITYSDK_OFFSET(0xDDBEBF0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_CAMERARENDERTYPE_OFFSET UNITYSDK_OFFSET(0xDDBEC20)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_SHOW3DSCENEENTITIES_OFFSET UNITYSDK_OFFSET(0xDDBEC00)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDDBEBE0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_INITMAINVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0xDDBF3E0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_LOADUISTOREPAGENPCS_OFFSET UNITYSDK_OFFSET(0xDDC0770)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDDBFC00)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDDBEC30)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDDBF580)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_REFRESHUICAMERASETTINGINFO_OFFSET UNITYSDK_OFFSET(0xDDBF700)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_REMOVEALLUIANIMATORENTITIES_OFFSET UNITYSDK_OFFSET(0xDDC0160)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETALLNPCACTIVE_OFFSET UNITYSDK_OFFSET(0xDDC12B0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETCAMERARENDERTYPE2BASE_OFFSET UNITYSDK_OFFSET(0xDDBF440)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETCINEMACHINERECOMPOSERPAN_OFFSET UNITYSDK_OFFSET(0xDDC1B00)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETMODELCAMERA_OFFSET UNITYSDK_OFFSET(0xDDBEEF0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETNPCCONFIG_OFFSET UNITYSDK_OFFSET(0xDDC0630)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SETNPCTRIGGER_OFFSET UNITYSDK_OFFSET(0xDDC15E0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_SYNCTRANSFORMPOS_OFFSET UNITYSDK_OFFSET(0xDDC05D0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER_TRYGETCAMERATRANSFORMINFO_OFFSET UNITYSDK_OFFSET(0xDDC13F0)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDDC1E20)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER__ONUIOPEN_B__23_0_OFFSET UNITYSDK_OFFSET(0xDDC1E90)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER__SETCINEMACHINERECOMPOSERPAN_B__36_0_OFFSET UNITYSDK_OFFSET(0xDDC2000)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER__SETTOPAN_OFFSET UNITYSDK_OFFSET(0xDDC1D90)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDDC2020)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDDC2030)
#define MOLEMOLE_UIBASE3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDDC2040)

namespace MoleMole
{
	inline static constexpr unsigned int UIBase3DModelController_TypeDefinitionIndex = 47671;
