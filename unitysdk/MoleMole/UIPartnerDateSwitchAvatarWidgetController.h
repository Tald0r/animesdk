...
#define MOLEMOLE_UIPARTNERDATESWITCHAVATARWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC82C7D0)
#define MOLEMOLE_UIPARTNERDATESWITCHAVATARWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC82C940)
#define MOLEMOLE_UIPARTNERDATESWITCHAVATARWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC82C840)
#define MOLEMOLE_UIPARTNERDATESWITCHAVATARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC82CA40)
#define MOLEMOLE_UIPARTNERDATESWITCHAVATARWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0xC82CA70)
#define MOLEMOLE_UIPARTNERDATESWITCHAVATARWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC82CB20)
#define MOLEMOLE_UIPARTNERDATESWITCHAVATARWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC82CB90)

namespace MoleMole
{
	inline static constexpr unsigned int UIPartnerDateSwitchAvatarWidgetController_TypeDefinitionIndex = 59875;
