...
#define MOLEMOLE_UIACTIVITYFIGHTUI_REWARDGROUP_MAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD232A80)
#define MOLEMOLE_UIACTIVITYFIGHTUI_REWARDGROUP_MAINPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD232A90)
#define MOLEMOLE_UIACTIVITYFIGHTUI_REWARDGROUP_MAINPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD232B00)
#define MOLEMOLE_UIACTIVITYFIGHTUI_REWARDGROUP_MAINPAGECONTROLLER_ONLYPLAYITEMANI_OFFSET UNITYSDK_OFFSET(0xD232D00)
#define MOLEMOLE_UIACTIVITYFIGHTUI_REWARDGROUP_MAINPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD232C00)
#define MOLEMOLE_UIACTIVITYFIGHTUI_REWARDGROUP_MAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD232DC0)
#define MOLEMOLE_UIACTIVITYFIGHTUI_REWARDGROUP_MAINPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD232DD0)
#define MOLEMOLE_UIACTIVITYFIGHTUI_REWARDGROUP_MAINPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD232E40)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityFightUI_RewardGroup_MainPageController_TypeDefinitionIndex = 45157;
