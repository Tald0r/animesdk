...
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER_CHECKISFIRST_OFFSET UNITYSDK_OFFSET(0xA9B1180)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER_CLEARREWARDS_OFFSET UNITYSDK_OFFSET(0xA9B12E0)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA9AFB60)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA9B0080)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA9B10B0)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA9AFD30)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA9AFF70)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER_REFRESHNOTIFY_OFFSET UNITYSDK_OFFSET(0xA9B0A60)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER_REFRESHREWARD_OFFSET UNITYSDK_OFFSET(0xA9B0BF0)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA9B01E0)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9B1480)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0xA9B1510)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER__ONUIINIT_B__2_1_OFFSET UNITYSDK_OFFSET(0xA9B1660)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER__ONUIOPEN_B__3_0_OFFSET UNITYSDK_OFFSET(0xA9B1770)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA9B1780)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA9B17F0)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA9B1870)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA9B18F0)
#define MOLEMOLE_UIHIAREWARDLISTROWITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA9B1950)

namespace MoleMole
{
	inline static constexpr unsigned int UIHIARewardListRowItemWidgetController_TypeDefinitionIndex = 61436;
	...
	public:
		...
		::Class_2_208CC9941471731A_806* _template; // 0x2D8
