...
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD12C770)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD12CC10)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD12CC80)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD12C780)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD12C900)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD12CD00)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD12CCF0)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD12CD50)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD12CD60)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD12CD70)
#define MOLEMOLE_UIGENERALBLACKMASKCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD12CD80)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralBlackMaskController_TypeDefinitionIndex = 49498;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralBlackMaskController_TypeDefinitionIndex)->GetStaticField(0x45270);
		}
		static ::System::String** StaticGet_FadeOutAnimName()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralBlackMaskController_TypeDefinitionIndex)->GetStaticField(0x45278);
		}
