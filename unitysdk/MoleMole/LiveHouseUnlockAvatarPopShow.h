...
#define MOLEMOLE_LIVEHOUSEUNLOCKAVATARPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x67A9A20)
#define MOLEMOLE_LIVEHOUSEUNLOCKAVATARPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x67A9A70)
#define MOLEMOLE_LIVEHOUSEUNLOCKAVATARPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x67A9A30)

namespace MoleMole
{
	inline static constexpr unsigned int LiveHouseUnlockAvatarPopShow_TypeDefinitionIndex = 48433;
