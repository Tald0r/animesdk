...
#define MOLEMOLE_LIVEHOUSEUNLOCKAVATARPOPSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x75A72F0)
#define MOLEMOLE_LIVEHOUSEUNLOCKAVATARPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x75A7340)
#define MOLEMOLE_LIVEHOUSEUNLOCKAVATARPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x75A7300)

namespace MoleMole
{
	inline static constexpr unsigned int LiveHouseUnlockAvatarPopShow_TypeDefinitionIndex = 58692;
