...
#define MOLEMOLE_ANIMATORRANDOMINT__CTOR_OFFSET UNITYSDK_OFFSET(0x62104B0)

namespace MoleMole
{
	inline static constexpr unsigned int AnimatorRandomInt_TypeDefinitionIndex = 73525;
