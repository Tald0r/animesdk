...
#define MOLEMOLE_DISABLEHALFRESSHADOWBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0xACE2760)
#define MOLEMOLE_DISABLEHALFRESSHADOWBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xACE27F0)
#define MOLEMOLE_DISABLEHALFRESSHADOWBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0xACE2850)

namespace MoleMole
{
	inline static constexpr unsigned int DisableHalfResShadowByGPUModelPostProcessorProfile_TypeDefinitionIndex = 52368;
