...
#define MOLEMOLE_INLEVELMOVEDOWNKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xA028F70)
#define MOLEMOLE_INLEVELMOVEDOWNKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xA028F80)
#define MOLEMOLE_INLEVELMOVEDOWNKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xA028F90)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelMoveDownKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 69994;
