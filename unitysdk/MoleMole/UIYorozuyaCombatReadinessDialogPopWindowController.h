...
class Class_1_5DA2E7556103D5A3_363;
...
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_GETBANNERPICPATH_OFFSET UNITYSDK_OFFSET(0x889D860)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_GETISFINISH_OFFSET UNITYSDK_OFFSET(0x889ADF0)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_GETQUESTBOXREWARDLIST_OFFSET UNITYSDK_OFFSET(0x889AE70)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x8899190)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8899180)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x88991A0)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_ONGETWEEKLYHOLLOWDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x889DE40)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x889E4A0)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8899590)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8899240)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_OPENBUFFTIPS_OFFSET UNITYSDK_OFFSET(0x8899780)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x88994D0)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_PLAYFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x889E330)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_REFRESHABYSSREWARD_OFFSET UNITYSDK_OFFSET(0x889CE80)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_REFRESHYOROZUYAVIEW_OFFSET UNITYSDK_OFFSET(0x8899930)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_SETTASKINFO_OFFSET UNITYSDK_OFFSET(0x889DA10)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER_UPDATEREWARDLIST_OFFSET UNITYSDK_OFFSET(0x889B8E0)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x889E6A0)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0x889E810)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x889E8B0)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x889E920)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x889E950)
#define MOLEMOLE_UIYOROZUYACOMBATREADINESSDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x889E960)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaCombatReadinessDialogPopWindowController_TypeDefinitionIndex = 42284;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_61* _view; // 0x308
		::Class_1_A047EA5169B6B30F* _selectQuestInfo; // 0x310
		::Class_1_5DA2E7556103D5A3_363* weeklyBattleCfg; // 0x318
		...
		::Class_2_0A55B5A82A61DAFA* hollowQuestTemplateExt; // 0x330
