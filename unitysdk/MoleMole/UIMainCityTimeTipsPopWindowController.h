...
class Class_2_6E81A070E6FB2A27_Class_2_C522E7E80DC8591C;
...
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB3F1A00)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB3F20C0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_ONMODTIMERSP_OFFSET UNITYSDK_OFFSET(0xB3F42F0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB3F2160)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB3F1A10)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB3F1EF0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_REFRESHBTN_OFFSET UNITYSDK_OFFSET(0xB3F4140)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0xB3F2260)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_REFRESHSTAGE_OFFSET UNITYSDK_OFFSET(0xB3F3DF0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_REFRESHTIME_OFFSET UNITYSDK_OFFSET(0xB3F3BD0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB3F2030)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_ROTARROW_OFFSET UNITYSDK_OFFSET(0xB3F49E0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_SETDESC_OFFSET UNITYSDK_OFFSET(0xB3F21F0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_SPENDTIME_OFFSET UNITYSDK_OFFSET(0xB3F39D0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_TRYROTARROW_OFFSET UNITYSDK_OFFSET(0xB3F4640)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB3F4A90)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__REFRESHSTAGE_B__18_0_OFFSET UNITYSDK_OFFSET(0xB3F4AA0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__REFRESHSTAGE_G__TOGGLESTAGEICON_18_1_OFFSET UNITYSDK_OFFSET(0xB3F4940)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__REFRESHTIME_G__GETTIMEPROGRESS_17_0_OFFSET UNITYSDK_OFFSET(0xB3F4600)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB3F4B50)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB3F4BC0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB3F4BD0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB3F4BE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityTimeTipsPopWindowController_TypeDefinitionIndex = 67621;
	...
	public:
		...
		::Class_2_6E81A070E6FB2A27* _view; // 0x2F8
		::Class_2_37FEA7F793EE2199* _model; // 0x300
		::System::Collections::Generic::List_1<::UnityEngine::Animation*>* _anims; // 0x308
		::Foundation::Coroutine::CoroutineHandle _handle; // 0x310
		::System::Int32 _curStage; // 0x314
		...
		static ::System::Void _RefreshStage_g__ToggleStageIcon_18_1(::System::Collections::Generic::List_1<::Class_2_0D31A1661D004892<::Class_2_6E81A070E6FB2A27_Class_2_C522E7E80DC8591C*>*>* icons, ::System::Int32 stage)
		{
			return ((::System::Void(*)(::System::Collections::Generic::List_1<::Class_2_0D31A1661D004892<::Class_2_6E81A070E6FB2A27_Class_2_C522E7E80DC8591C*>*>*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__REFRESHSTAGE_G__TOGGLESTAGEICON_18_1_OFFSET))(icons, stage);
		}
