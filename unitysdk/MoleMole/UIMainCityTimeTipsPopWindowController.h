...
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAF3DD00)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF3E3B0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_ONMODTIMERSP_OFFSET UNITYSDK_OFFSET(0xAF405F0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF3E450)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF3DD10)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF3E1E0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_REFRESHBTN_OFFSET UNITYSDK_OFFSET(0xAF40440)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0xAF3E550)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_REFRESHSTAGE_OFFSET UNITYSDK_OFFSET(0xAF400F0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_REFRESHTIME_OFFSET UNITYSDK_OFFSET(0xAF3FED0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAF3E320)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_ROTARROW_OFFSET UNITYSDK_OFFSET(0xAF40CE0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_SETDESC_OFFSET UNITYSDK_OFFSET(0xAF3E4E0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_SPENDTIME_OFFSET UNITYSDK_OFFSET(0xAF3FCD0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER_TRYROTARROW_OFFSET UNITYSDK_OFFSET(0xAF40940)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAF40D90)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__REFRESHSTAGE_B__18_0_OFFSET UNITYSDK_OFFSET(0xAF40DA0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__REFRESHSTAGE_G__TOGGLESTAGEICON_18_1_OFFSET UNITYSDK_OFFSET(0xAF40C40)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__REFRESHTIME_G__GETTIMEPROGRESS_17_0_OFFSET UNITYSDK_OFFSET(0xAF40900)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF40E50)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF40EC0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF40ED0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF40EE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityTimeTipsPopWindowController_TypeDefinitionIndex = 77796;
