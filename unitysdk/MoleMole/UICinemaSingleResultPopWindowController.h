...
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC601F80)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_INITDATALINES_OFFSET UNITYSDK_OFFSET(0xC602EA0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_INITDESCRIPTION_OFFSET UNITYSDK_OFFSET(0xC6038A0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_INITMOVEIMG_OFFSET UNITYSDK_OFFSET(0xC602CE0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_INITUI_OFFSET UNITYSDK_OFFSET(0xC6022E0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONCLICKCLOSE_OFFSET UNITYSDK_OFFSET(0xC602980)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONCLICKRESTART_OFFSET UNITYSDK_OFFSET(0xC603C50)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC602840)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC6028E0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC602A40)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC601F90)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC6021C0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC603CE0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER__ONCLICKCLOSE_B__16_0_OFFSET UNITYSDK_OFFSET(0xC603CF0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC603E00)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC603E70)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC603EA0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC603EB0)
#define MOLEMOLE_UICINEMASINGLERESULTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC603EC0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSingleResultPopWindowController_TypeDefinitionIndex = 69722;
