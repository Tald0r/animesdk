...
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_GET_VIRUSADDANIMCOOLDOWN_OFFSET UNITYSDK_OFFSET(0x9148610)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x9148710)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9148A80)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9148E30)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9148ED0)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9148CE0)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9148D80)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_SETNUM_OFFSET UNITYSDK_OFFSET(0x91489E0)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER_UPDATEADDANIM_OFFSET UNITYSDK_OFFSET(0x9148AF0)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9148FB0)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9148FE0)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9149050)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x91490D0)
#define MOLEMOLE_UIHOLLOWWATERFLOWVIRUSROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9149130)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowWaterFlowVirusRowWidgetController_TypeDefinitionIndex = 67649;
