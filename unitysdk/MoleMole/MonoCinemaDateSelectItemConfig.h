...
#define MOLEMOLE_MONOCINEMADATESELECTITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA39F590)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCinemaDateSelectItemConfig_TypeDefinitionIndex = 44735;
