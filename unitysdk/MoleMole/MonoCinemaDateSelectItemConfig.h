...
#define MOLEMOLE_MONOCINEMADATESELECTITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x82E4CB0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCinemaDateSelectItemConfig_TypeDefinitionIndex = 49859;
