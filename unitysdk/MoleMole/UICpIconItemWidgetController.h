...
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1B419670)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1B419700)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B419540)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1B4195D0)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x1B4197D0)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER_UPDATEINFO_OFFSET UNITYSDK_OFFSET(0x1B419920)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B419E80)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1B419EB0)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1B419F20)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1B419FA0)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1B41A000)

namespace MoleMole
{
	inline static constexpr unsigned int UICpIconItemWidgetController_TypeDefinitionIndex = 83471;
