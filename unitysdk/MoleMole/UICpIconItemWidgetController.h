...
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18E2DEA0)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18E2DF30)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18E2DD70)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18E2DE00)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x18E2E000)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER_UPDATEINFO_OFFSET UNITYSDK_OFFSET(0x18E2E150)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2E6B0)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x18E2E6E0)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x18E2E750)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x18E2E7D0)
#define MOLEMOLE_UICPICONITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x18E2E830)

namespace MoleMole
{
	inline static constexpr unsigned int UICpIconItemWidgetController_TypeDefinitionIndex = 81477;

	class UICpIconItemWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_FBCF3B1F3705EFD2_1* _view; // 0x2A0
