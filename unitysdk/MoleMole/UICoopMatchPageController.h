...
class Class_3_1F2AB93F01651F88_2;
...
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_CHECKTABCLICKWITHTIPS_OFFSET UNITYSDK_OFFSET(0xA33C090)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_CHECKUNLOCKPOP_OFFSET UNITYSDK_OFFSET(0xA33D870)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_DELTABLEVELNEW_OFFSET UNITYSDK_OFFSET(0xA33C110)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_GETTABANIM_OFFSET UNITYSDK_OFFSET(0xA33C800)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_GETTABINDEX_OFFSET UNITYSDK_OFFSET(0xA33BC80)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_GETTABTYPE_OFFSET UNITYSDK_OFFSET(0xA33B920)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA33A840)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA33A850)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_INITPLATFORMSETTING_OFFSET UNITYSDK_OFFSET(0xA33B4B0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xA33BCF0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA33A8C0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONGAMEROOMCHANGEDETAILHANDLE_OFFSET UNITYSDK_OFFSET(0xA33CF50)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0xA33D790)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA33E400)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA33A980)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA33D520)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_PLAYTABFADEINANIM_OFFSET UNITYSDK_OFFSET(0xA33CB90)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_PLAYTABFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0xA33C990)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_REFRESHTABANIM_OFFSET UNITYSDK_OFFSET(0xA33C190)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_SELECTTAB_OFFSET UNITYSDK_OFFSET(0xA33B990)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_SETPLATFORMBTNSHOWSTATE_OFFSET UNITYSDK_OFFSET(0xA33D600)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_SHOWTIP_OFFSET UNITYSDK_OFFSET(0xA33D1D0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_STOPSWITCHANIM_OFFSET UNITYSDK_OFFSET(0xA33C6E0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_STOPTABANIM_OFFSET UNITYSDK_OFFSET(0xA33CD90)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER_TIPENDHANDLE_OFFSET UNITYSDK_OFFSET(0xA33D3A0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA33E6D0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA33E470)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__ONPOSTPAGESHOWED_B__32_0_OFFSET UNITYSDK_OFFSET(0xA33F100)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0xA33E8F0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__ONUIINIT_B__6_1_OFFSET UNITYSDK_OFFSET(0xA33E930)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__ONUIOPEN_B__31_0_OFFSET UNITYSDK_OFFSET(0xA33EFB0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER__ONUIOPEN_B__31_1_OFFSET UNITYSDK_OFFSET(0xA33F0D0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA33F110)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER___BASE_ONPOSTPAGESHOWED_OFFSET UNITYSDK_OFFSET(0xA33F180)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA33F190)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA33F1A0)
#define MOLEMOLE_UICOOPMATCHPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA33F1B0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopMatchPageController_TypeDefinitionIndex = 58237;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::MoleMole::UICoopMatchPageController_LevelTabStatus, ::Il2CppArray<::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(UICoopMatchPageController_TypeDefinitionIndex)->GetStaticField(0x44090);
		}
		...
		::Class_3_1F2AB93F01651F88_2* _view; // 0x350
