...
#define MOLEMOLE_MONOEFFECTSHAPE_GETRELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x6B06510)
#define MOLEMOLE_MONOEFFECTSHAPE_METHOD_5_AAD44B4BC056326D_OFFSET UNITYSDK_OFFSET(0x6B06B00)
#define MOLEMOLE_MONOEFFECTSHAPE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6B06D10)
#define MOLEMOLE_MONOEFFECTSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x6B06E10)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectShape_TypeDefinitionIndex = 59552;
