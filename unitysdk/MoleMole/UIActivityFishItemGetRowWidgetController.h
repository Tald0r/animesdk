...
#define MOLEMOLE_UIACTIVITYFISHITEMGETROWWIDGETCONTROLLER_ONCLICKJUMP_OFFSET UNITYSDK_OFFSET(0xBFA5F30)
#define MOLEMOLE_UIACTIVITYFISHITEMGETROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFA5B90)
#define MOLEMOLE_UIACTIVITYFISHITEMGETROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFA5D10)
#define MOLEMOLE_UIACTIVITYFISHITEMGETROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFA5C30)
#define MOLEMOLE_UIACTIVITYFISHITEMGETROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFA5A30)
#define MOLEMOLE_UIACTIVITYFISHITEMGETROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xBFA5E80)
#define MOLEMOLE_UIACTIVITYFISHITEMGETROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFA6100)
#define MOLEMOLE_UIACTIVITYFISHITEMGETROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFA6110)
#define MOLEMOLE_UIACTIVITYFISHITEMGETROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFA6180)
#define MOLEMOLE_UIACTIVITYFISHITEMGETROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFA6200)
#define MOLEMOLE_UIACTIVITYFISHITEMGETROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFA6280)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityFishItemGetRowWidgetController_TypeDefinitionIndex = 77997;
