...
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER_INITCOREREWARDSELECT_OFFSET UNITYSDK_OFFSET(0xB97C970)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER_INITREWARDWIDGETS_OFFSET UNITYSDK_OFFSET(0xB97C680)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER_ONCLICKCOREREWARD_OFFSET UNITYSDK_OFFSET(0xB97D050)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB97CED0)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xB97CDE0)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB97CAA0)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB97CF70)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB97C2D0)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB97C450)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER_REFRESHCOREREWARDTIPS_OFFSET UNITYSDK_OFFSET(0xB97CD30)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER_SHOWCOREREWARDINFO_OFFSET UNITYSDK_OFFSET(0xB97D690)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER_TAKESELECTCOREREWARD_OFFSET UNITYSDK_OFFSET(0xB97D4F0)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB97D8A0)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB97D8D0)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xB97D940)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB97D9A0)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB97DA10)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB97DA90)
#define MOLEMOLE_UIBPCOREREWARDWIDGETWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC2DA70)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPCoreRewardWidgetWidgetController_TypeDefinitionIndex = 52549;
