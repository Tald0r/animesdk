...
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ABYSSTONORMAL3D_OFFSET UNITYSDK_OFFSET(0xAAC1D90)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_CHECKCUBEMESHRENDER_OFFSET UNITYSDK_OFFSET(0xAAC1790)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_GETANCHORPOINTS_OFFSET UNITYSDK_OFFSET(0xAABFA90)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_GETCUBEGRIDFADEOUTDURATION_OFFSET UNITYSDK_OFFSET(0xAAC0A40)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_GETRALLYWIDGETAUTOOPENDELAY_OFFSET UNITYSDK_OFFSET(0xAAC2540)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_GETVOLUMECURVEVALUE_OFFSET UNITYSDK_OFFSET(0xAAC1AE0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xAABDD00)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_INITCITYHOLLOWMAP_OFFSET UNITYSDK_OFFSET(0xAABFB00)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_KILLMAPTIPSSHOWDELAY_OFFSET UNITYSDK_OFFSET(0xAAC1A10)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAABF290)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_LOADMATERIALPROPERTYANDTEXTURE_OFFSET UNITYSDK_OFFSET(0xAAC01D0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONALLSPHEREHIDE_OFFSET UNITYSDK_OFFSET(0xAAC1680)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONALLSPHERESHOW_OFFSET UNITYSDK_OFFSET(0xAAC18C0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0xAABF7C0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAABE400)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xAABE4A0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAABE610)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAABDD20)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAABE390)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_PLAYHIDEMAP_OFFSET UNITYSDK_OFFSET(0xAAC14C0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_PLAYSPHERETRACKFADEANI_OFFSET UNITYSDK_OFFSET(0xAAC0AB0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_PLAYSTARTMAP_OFFSET UNITYSDK_OFFSET(0xAAC1020)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_REFRESHREFLECTIONPROBE_OFFSET UNITYSDK_OFFSET(0xAABF5D0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_REGISTERVOLUME_OFFSET UNITYSDK_OFFSET(0xAABE190)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_RESETVOLUME_OFFSET UNITYSDK_OFFSET(0xAABE830)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SETCONTINER_OFFSET UNITYSDK_OFFSET(0xAABFA20)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SETCUBEGRIDEMATPROPERTY_OFFSET UNITYSDK_OFFSET(0xAAC2140)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SETSOUNDWILLHIDESPHERE_OFFSET UNITYSDK_OFFSET(0xAABFD90)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SETSOUNDWILLSHOWSPHERE_OFFSET UNITYSDK_OFFSET(0xAABFFB0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SETYOROZUYACAMERA_OFFSET UNITYSDK_OFFSET(0xAABF680)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xAABDD10)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SHOWCURRENTSPHERE_OFFSET UNITYSDK_OFFSET(0xAAC0B80)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_SWITCHHOLLOWGROUP_OFFSET UNITYSDK_OFFSET(0xAAC1BF0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_TICKENDMAP_OFFSET UNITYSDK_OFFSET(0xAABF070)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_TICKSTARTMAP_OFFSET UNITYSDK_OFFSET(0xAABEE50)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_TRYHIDEALLSPHEREANDSHOWNEW_OFFSET UNITYSDK_OFFSET(0xAAC06C0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_UPDATESPHERESINK_OFFSET UNITYSDK_OFFSET(0xAABE950)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_UPDATETEST_OFFSET UNITYSDK_OFFSET(0xAAC0990)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_UPDATEVOLUME_OFFSET UNITYSDK_OFFSET(0xAABF300)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAABE8D0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xAAC26D0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAAC25C0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER__SHOWCURRENTSPHERE_B__30_0_OFFSET UNITYSDK_OFFSET(0xAAC2780)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER__TRYHIDEALLSPHEREANDSHOWNEW_B__25_0_OFFSET UNITYSDK_OFFSET(0xAAC26E0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAAC27C0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xAAC2830)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAAC28C0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAAC28D0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAAC28E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaChapterMap3DModelController_TypeDefinitionIndex = 66763;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIYorozuyaChapterMap3DModelController_TypeDefinitionIndex)->GetStaticField(0xEEF0);
		}
		static ::System::Boolean* StaticGet_isDebugPotLight()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIYorozuyaChapterMap3DModelController_TypeDefinitionIndex)->GetStaticField(0xEEF1);
		}
		static ::System::Boolean* StaticGet_isDebugReflectProbe()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIYorozuyaChapterMap3DModelController_TypeDefinitionIndex)->GetStaticField(0xEEF2);
		}
		static ::System::Boolean* StaticGet_isDebugVolume()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIYorozuyaChapterMap3DModelController_TypeDefinitionIndex)->GetStaticField(0xEEF3);
		}
		...
		::Class_2_79F6D62CE30E3F8E_154* _view; // 0x360
		...
		::Class_2_208CC9941471731A_632* preSelectChapter; // 0x410
		...
		::System::Boolean LoadMaterialPropertyAndTexture(::Class_2_208CC9941471731A_632* config, ::System::Boolean setStart, ::System::Boolean setEnd)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_632*, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER_LOADMATERIALPROPERTYANDTEXTURE_OFFSET))(this, config, setStart, setEnd);
		}
