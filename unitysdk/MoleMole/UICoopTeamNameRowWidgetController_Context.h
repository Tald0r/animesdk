...
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_CONTEXT_GET_BRIEFINFO_OFFSET UNITYSDK_OFFSET(0xACFD570)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xACFD690)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeamNameRowWidgetController_Context_TypeDefinitionIndex = 42216;
