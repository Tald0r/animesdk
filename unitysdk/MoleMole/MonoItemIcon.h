...
#define MOLEMOLE_MONOITEMICON_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9AB6ED0)
#define MOLEMOLE_MONOITEMICON_METHOD_5_B259052A9D4A7733_OFFSET UNITYSDK_OFFSET(0x9AB69C0)
#define MOLEMOLE_MONOITEMICON_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9AB6F80)
#define MOLEMOLE_MONOITEMICON_METHOD_5_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0x9AB6CE0)
#define MOLEMOLE_MONOITEMICON_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x9AB6E20)
#define MOLEMOLE_MONOITEMICON_REGISTERCALLBACKS_OFFSET UNITYSDK_OFFSET(0x9AB6C10)
#define MOLEMOLE_MONOITEMICON_SELECTITEM_OFFSET UNITYSDK_OFFSET(0x9AB6DA0)
#define MOLEMOLE_MONOITEMICON_SETUPVIEW_1_OFFSET UNITYSDK_OFFSET(0x9AB6A90)
#define MOLEMOLE_MONOITEMICON_SETUPVIEW_2_OFFSET UNITYSDK_OFFSET(0x9AB6B40)
#define MOLEMOLE_MONOITEMICON_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x9AB6920)
#define MOLEMOLE_MONOITEMICON_UNSELECTITEM_OFFSET UNITYSDK_OFFSET(0x9AB6C70)
#define MOLEMOLE_MONOITEMICON__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB6EB0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoItemIcon_TypeDefinitionIndex = 47216;
