...
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_GETFISHTANKTRANSFORM_OFFSET UNITYSDK_OFFSET(0x75AD4B0)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_GETFISHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x75AD130)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x75AD640)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_2C1FE282BA2BA531_OFFSET UNITYSDK_OFFSET(0x75ADD30)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_4389275F4099DE36_OFFSET UNITYSDK_OFFSET(0x75AC690)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_4434761CB9BE21F7_OFFSET UNITYSDK_OFFSET(0x75ADE40)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x75ABD20)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_6C5219D256048011_OFFSET UNITYSDK_OFFSET(0x75AE0E0)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_9BFE7737D26CFA72_OFFSET UNITYSDK_OFFSET(0x75AD6C0)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_METHOD_5_AA08720895458700_OFFSET UNITYSDK_OFFSET(0x75ADDA0)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x75ACBD0)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x75AB700)
#define MOLEMOLE_MODULE_FISHINGV2_SUMMERFISHAQUARIUMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x75ADD10)

namespace MoleMole::Module::FishingV2
{
	inline static constexpr unsigned int SummerFishAquariumController_TypeDefinitionIndex = 79468;
