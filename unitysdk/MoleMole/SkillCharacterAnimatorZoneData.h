...
#define MOLEMOLE_SKILLCHARACTERANIMATORZONEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8F3E690)

namespace MoleMole
{
	inline static constexpr unsigned int SkillCharacterAnimatorZoneData_TypeDefinitionIndex = 57603;
