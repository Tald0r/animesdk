...
#define MOLEMOLE_SKILLCHARACTERANIMATORZONEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9855BA0)

namespace MoleMole
{
	inline static constexpr unsigned int SkillCharacterAnimatorZoneData_TypeDefinitionIndex = 78949;
