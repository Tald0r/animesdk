...
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_CLICKINVITEBTN_OFFSET UNITYSDK_OFFSET(0xC0FDD30)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_CLICKSHAREBTN_OFFSET UNITYSDK_OFFSET(0xC0FCFE0)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_ONCLICKREMOVEBTN_OFFSET UNITYSDK_OFFSET(0xC0FDE60)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0FBFF0)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC0FC180)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xC0FBD00)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0FC090)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0FBAD0)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_RESETUIBTNVIEW_OFFSET UNITYSDK_OFFSET(0xC0FC6A0)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_SHOWARCADESTATE_OFFSET UNITYSDK_OFFSET(0xC0FC8C0)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_SHOWFRINEDINFO_OFFSET UNITYSDK_OFFSET(0xC0FC830)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_SHOWPLATFORMUI_OFFSET UNITYSDK_OFFSET(0xC0FBDD0)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_SHOWUIVIEW_OFFSET UNITYSDK_OFFSET(0xC0FD110)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_SWITCHINVITEBTNSTATE_OFFSET UNITYSDK_OFFSET(0xC0FDC70)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER_SWITCHSHAREBTNSTATE_OFFSET UNITYSDK_OFFSET(0xC0FCF20)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0FDF50)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER__ONCLICKREMOVEBTN_B__17_0_OFFSET UNITYSDK_OFFSET(0xC0FE1F0)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__7_0_OFFSET UNITYSDK_OFFSET(0xC0FDF70)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__7_1_OFFSET UNITYSDK_OFFSET(0xC0FDFD0)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER__SHOWARCADESTATE_B__13_0_OFFSET UNITYSDK_OFFSET(0xC0FE0B0)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER__SHOWARCADESTATE_B__13_1_OFFSET UNITYSDK_OFFSET(0xC0FE110)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER__SHOWUIVIEW_G__SETUPPLATFORMUI_12_0_OFFSET UNITYSDK_OFFSET(0xC0FDBC0)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0FE250)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC0FE2C0)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0FE340)
#define MOLEMOLE_UIFRIENDMINICARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0FE3C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendMiniCardRowWidgetController_TypeDefinitionIndex = 74090;

	class UIFriendMiniCardRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_187* _view; // 0x2D0
