...
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_ACTIVELOADINGUI_OFFSET UNITYSDK_OFFSET(0xD76CB00)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_GET_ALLOWASSETPROXYUNLOADRES_OFFSET UNITYSDK_OFFSET(0xD76C980)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xD76C9A0)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_GET_PERMANENT_OFFSET UNITYSDK_OFFSET(0xD76C9B0)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD76C990)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD76D6C0)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD76C9C0)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_SETCORNER_OFFSET UNITYSDK_OFFSET(0xD76D760)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_SETLOADINGVIEW_OFFSET UNITYSDK_OFFSET(0xD76CD10)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xD76D520)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_UNACTIVELOADINGUI_OFFSET UNITYSDK_OFFSET(0xD76D270)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD76D980)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD76D990)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD76DA00)
#define MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xD76DA10)

namespace MoleMole
{
	inline static constexpr unsigned int UILoadingPopWindowController_TypeDefinitionIndex = 62599;
	...
	public:
		...
		::System::Void SetCorner(::Class_2_208CC9941471731A_469* loadingPage, ::Class_2_A8F5ABF31E066ED4* cornerIcon, ::UnityEngine::UI::Extension::UILocalizationText* numberText, ::UnityEngine::UI::Extension::UILocalizationText* tagText)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_469*, ::Class_2_A8F5ABF31E066ED4*, ::UnityEngine::UI::Extension::UILocalizationText*, ::UnityEngine::UI::Extension::UILocalizationText*))((::PBYTE)hIl2Cpp + MOLEMOLE_UILOADINGPOPWINDOWCONTROLLER_SETCORNER_OFFSET))(this, loadingPage, cornerIcon, numberText, tagText);
		}
