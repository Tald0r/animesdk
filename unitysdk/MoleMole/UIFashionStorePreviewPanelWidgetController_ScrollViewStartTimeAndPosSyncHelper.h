...
#define MOLEMOLE_UIFASHIONSTOREPREVIEWPANELWIDGETCONTROLLER_SCROLLVIEWSTARTTIMEANDPOSSYNCHELPER_CALSCROLLVIEWSTARTTIME_OFFSET UNITYSDK_OFFSET(0xA27D0E0)
#define MOLEMOLE_UIFASHIONSTOREPREVIEWPANELWIDGETCONTROLLER_SCROLLVIEWSTARTTIMEANDPOSSYNCHELPER_INIT_OFFSET UNITYSDK_OFFSET(0xA27C710)
#define MOLEMOLE_UIFASHIONSTOREPREVIEWPANELWIDGETCONTROLLER_SCROLLVIEWSTARTTIMEANDPOSSYNCHELPER_ONMUSICTRACKMOVE_OFFSET UNITYSDK_OFFSET(0xA27D990)
#define MOLEMOLE_UIFASHIONSTOREPREVIEWPANELWIDGETCONTROLLER_SCROLLVIEWSTARTTIMEANDPOSSYNCHELPER_SCROLLVIEWSTARTTIMETOSCROLLDELTA_OFFSET UNITYSDK_OFFSET(0xA27CEA0)
#define MOLEMOLE_UIFASHIONSTOREPREVIEWPANELWIDGETCONTROLLER_SCROLLVIEWSTARTTIMEANDPOSSYNCHELPER_UPDATESCROLLVIEWSTARTTIME_OFFSET UNITYSDK_OFFSET(0xA27CD40)
#define MOLEMOLE_UIFASHIONSTOREPREVIEWPANELWIDGETCONTROLLER_SCROLLVIEWSTARTTIMEANDPOSSYNCHELPER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA27CCC0)
#define MOLEMOLE_UIFASHIONSTOREPREVIEWPANELWIDGETCONTROLLER_SCROLLVIEWSTARTTIMEANDPOSSYNCHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0xA27C560)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStorePreviewPanelWidgetController_ScrollViewStartTimeAndPosSyncHelper_TypeDefinitionIndex = 37919;
	...
	public:
		...
		::Class_0_16E4307DCC419505_103<::System::Single>* _scrollViewStartTime; // 0x30
