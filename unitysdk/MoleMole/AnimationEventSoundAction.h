...
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_AUTOCREATECUSTOMSOUNDEMITTER_OFFSET UNITYSDK_OFFSET(0x620FD00)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x6210160)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x620FFB0)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_SOUNDOTHER_OFFSET UNITYSDK_OFFSET(0x6210350)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_SOUNDPLAY_OFFSET UNITYSDK_OFFSET(0x6210230)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION_SOUNDSTOP_OFFSET UNITYSDK_OFFSET(0x62102C0)
#define MOLEMOLE_ANIMATIONEVENTSOUNDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x6210490)

namespace MoleMole
{
	inline static constexpr unsigned int AnimationEventSoundAction_TypeDefinitionIndex = 48693;
