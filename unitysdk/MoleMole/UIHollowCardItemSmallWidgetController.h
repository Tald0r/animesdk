...
#define MOLEMOLE_UIHOLLOWCARDITEMSMALLWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7D0FE10)
#define MOLEMOLE_UIHOLLOWCARDITEMSMALLWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7D0FEB0)
#define MOLEMOLE_UIHOLLOWCARDITEMSMALLWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7D0FCC0)
#define MOLEMOLE_UIHOLLOWCARDITEMSMALLWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7D0FD60)
#define MOLEMOLE_UIHOLLOWCARDITEMSMALLWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x7D10090)
#define MOLEMOLE_UIHOLLOWCARDITEMSMALLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7D10460)
#define MOLEMOLE_UIHOLLOWCARDITEMSMALLWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7D10490)
#define MOLEMOLE_UIHOLLOWCARDITEMSMALLWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7D10500)
#define MOLEMOLE_UIHOLLOWCARDITEMSMALLWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7D10580)
#define MOLEMOLE_UIHOLLOWCARDITEMSMALLWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7D105E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardItemSmallWidgetController_TypeDefinitionIndex = 73810;

	class UIHollowCardItemSmallWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_108* _view; // 0x2A0
		::System::String* smallCardKey; // 0x2A8
		::UnityEngine::GameObject* smallCard; // 0x2B0
