...
#define MOLEMOLE_MIRRORREFLECTIONPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA39EAD0)

namespace MoleMole
{
	inline static constexpr unsigned int MirrorReflectionProfileContext_TypeDefinitionIndex = 81146;
