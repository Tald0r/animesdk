...
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x67CB510)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_CHOOSEEXCUTEINDEX_OFFSET UNITYSDK_OFFSET(0x67CB210)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x67CB4A0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_GETALLWEIGHT_OFFSET UNITYSDK_OFFSET(0x67CB320)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x67CB0C0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x67CB580)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x67CB600)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONEND_OFFSET UNITYSDK_OFFSET(0x67CB670)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0x67CB6E0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0x67CB1A0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x67CB750)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0x67CB7F0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0x67CB880)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x67CB910)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0x67CB9A0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0x67CBA30)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x67CBAC0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x67CBB50)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x67CBBE0)

namespace MoleMole
{
	inline static constexpr unsigned int RandomExcuteWithWeight_TypeDefinitionIndex = 37688;
	...
	public:
		...
		::System::Int32 _excuteIndex; // 0x6C
