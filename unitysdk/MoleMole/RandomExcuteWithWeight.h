...
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0xA47ECC0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_CHOOSEEXCUTEINDEX_OFFSET UNITYSDK_OFFSET(0xA47E9C0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0xA47EC50)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_GETALLWEIGHT_OFFSET UNITYSDK_OFFSET(0xA47EAD0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xA47E870)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0xA47ED30)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0xA47EDB0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONEND_OFFSET UNITYSDK_OFFSET(0xA47EE20)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONRESET_OFFSET UNITYSDK_OFFSET(0xA47EE90)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT_ONSTART_OFFSET UNITYSDK_OFFSET(0xA47E950)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0xA47EF00)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_CANEXECUTE_OFFSET UNITYSDK_OFFSET(0xA47EFA0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_CURRENTCHILDINDEX_OFFSET UNITYSDK_OFFSET(0xA47F030)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xA47F0C0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONCHILDEXECUTED_OFFSET UNITYSDK_OFFSET(0xA47F150)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONCONDITIONALABORT_OFFSET UNITYSDK_OFFSET(0xA47F1E0)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0xA47F270)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0xA47F300)
#define MOLEMOLE_RANDOMEXCUTEWITHWEIGHT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0xA47F390)

namespace MoleMole
{
	inline static constexpr unsigned int RandomExcuteWithWeight_TypeDefinitionIndex = 57776;
