...
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB6BD2E0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER___C__DISPLAYCLASS12_0__SETGAMEENTRYVIEW_B__0_OFFSET UNITYSDK_OFFSET(0xB6BD2F0)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER___C__DISPLAYCLASS12_0__SETGAMEENTRYVIEW_B__3_OFFSET UNITYSDK_OFFSET(0xB6BD650)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER___C__DISPLAYCLASS12_0__SETGAMEENTRYVIEW_B__4_OFFSET UNITYSDK_OFFSET(0xB6BDA80)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER___C__DISPLAYCLASS12_0__SETGAMEENTRYVIEW_G__CLOSEANDSTARTGAME_2_OFFSET UNITYSDK_OFFSET(0xB6BD490)
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTROLLER___C__DISPLAYCLASS12_0__SETGAMEENTRYVIEW_G__PLAYGETSTARANIM_1_OFFSET UNITYSDK_OFFSET(0xB6BD8B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastMissionPageController___c__DisplayClass12_0_TypeDefinitionIndex = 65918;
	...
	public:
		...
		::Class_2_208CC9941471731A_32* config; // 0x28
		::Class_3_DBE524ABBB651066* game; // 0x30
		::System::Int32 gameID; // 0x38
		::System::Int32 idx; // 0x3C
