...
#define MOLEMOLE_UIQUESTIONSLISTV2WIDGETCONTROLLER_ONSETCREATEFUNC_OFFSET UNITYSDK_OFFSET(0x946D4D0)
#define MOLEMOLE_UIQUESTIONSLISTV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x946D5B0)
#define MOLEMOLE_UIQUESTIONSLISTV2WIDGETCONTROLLER___BASE_ONSETCREATEFUNC_OFFSET UNITYSDK_OFFSET(0x946D5C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsListV2WidgetController_TypeDefinitionIndex = 78206;
