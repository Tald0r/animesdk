...
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER__UPDATENEWBIE_D__62_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x37D1E0)
#define MOLEMOLE_UIACTIVITYHOTPOTINGAMEPAGECONTROLLER__UPDATENEWBIE_D__62_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2EA620)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotpotInGamePageController__UpdateNewbie_d__62_TypeDefinitionIndex = 79909;
