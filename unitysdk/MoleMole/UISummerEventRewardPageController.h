...
class Class_2_D47A06C1149790BF;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }
namespace System { class EventArgs; }

#define MOLEMOLE_UISUMMEREVENTREWARDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAA93230)
#define MOLEMOLE_UISUMMEREVENTREWARDPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAA93240)
#define MOLEMOLE_UISUMMEREVENTREWARDPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAA934F0)
#define MOLEMOLE_UISUMMEREVENTREWARDPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAA932B0)
#define MOLEMOLE_UISUMMEREVENTREWARDPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAA935F0)
#define MOLEMOLE_UISUMMEREVENTREWARDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAA93730)
#define MOLEMOLE_UISUMMEREVENTREWARDPAGECONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0xAA937E0)
#define MOLEMOLE_UISUMMEREVENTREWARDPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAA938C0)
#define MOLEMOLE_UISUMMEREVENTREWARDPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAA93930)
#define MOLEMOLE_UISUMMEREVENTREWARDPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAA93940)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerEventRewardPageController_TypeDefinitionIndex = 59358;
	...
	public:
		...
		::Class_2_D47A06C1149790BF* get__viewModel()
		{
			return ((::Class_2_D47A06C1149790BF*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISUMMEREVENTREWARDPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
