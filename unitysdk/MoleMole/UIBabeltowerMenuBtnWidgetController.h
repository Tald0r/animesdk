...
#define MOLEMOLE_UIBABELTOWERMENUBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF371B0)
#define MOLEMOLE_UIBABELTOWERMENUBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF37250)
#define MOLEMOLE_UIBABELTOWERMENUBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF37060)
#define MOLEMOLE_UIBABELTOWERMENUBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF37100)
#define MOLEMOLE_UIBABELTOWERMENUBTNWIDGETCONTROLLER_OPENTOWERUTIL_OFFSET UNITYSDK_OFFSET(0xBF379C0)
#define MOLEMOLE_UIBABELTOWERMENUBTNWIDGETCONTROLLER_REFRESHTOWERID_OFFSET UNITYSDK_OFFSET(0xBF37330)
#define MOLEMOLE_UIBABELTOWERMENUBTNWIDGETCONTROLLER_SETNAME_OFFSET UNITYSDK_OFFSET(0xBF37930)
#define MOLEMOLE_UIBABELTOWERMENUBTNWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xBF37F40)
#define MOLEMOLE_UIBABELTOWERMENUBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF37F10)
#define MOLEMOLE_UIBABELTOWERMENUBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF38010)
#define MOLEMOLE_UIBABELTOWERMENUBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF38080)
#define MOLEMOLE_UIBABELTOWERMENUBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF38100)
#define MOLEMOLE_UIBABELTOWERMENUBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF38160)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerMenuBtnWidgetController_TypeDefinitionIndex = 48549;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(UIBabeltowerMenuBtnWidgetController_TypeDefinitionIndex)->GetStaticField(0x44C80);
		}
		::Class_2_5934BFCF1206F4CB* _view; // 0x2A0
