...
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ADDBOTTOMMESSAGE_OFFSET UNITYSDK_OFFSET(0xC8376A0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_CHECKQUICKMODE_OFFSET UNITYSDK_OFFSET(0xC8374A0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_CREATECONVERSION_OFFSET UNITYSDK_OFFSET(0xC8363A0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_CREATEREPLAY_OFFSET UNITYSDK_OFFSET(0xC836480)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ENTERQUICKMODE_OFFSET UNITYSDK_OFFSET(0xC837BF0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_FINISHSCROLL_OFFSET UNITYSDK_OFFSET(0xC8390D0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xC8362A0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_HANDLEQUICKMODE_OFFSET UNITYSDK_OFFSET(0xC8394C0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xC836AC0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC835CC0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ISLASTLOGICGROUP_OFFSET UNITYSDK_OFFSET(0xC8378B0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_NEWMESSAGEFADEIN_OFFSET UNITYSDK_OFFSET(0xC838E30)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONCLICKNEW_OFFSET UNITYSDK_OFFSET(0xC839050)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONCLICKSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xC839450)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC836200)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONNEXTLETTERAPPEAR_OFFSET UNITYSDK_OFFSET(0xC837F30)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONSCROLLEND_OFFSET UNITYSDK_OFFSET(0xC8380D0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xC8385A0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC836560)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC835A90)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xC837380)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_REFOCUSITEM_OFFSET UNITYSDK_OFFSET(0xC8383C0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xC837240)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_SHOWEFFECT_OFFSET UNITYSDK_OFFSET(0xC8382B0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_SHOWEMPTY_OFFSET UNITYSDK_OFFSET(0xC837030)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_SHOWINVITATION_OFFSET UNITYSDK_OFFSET(0xC836E50)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_SHOWMESSAGE_OFFSET UNITYSDK_OFFSET(0xC8368A0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_TRYENTERQUICKMODE_OFFSET UNITYSDK_OFFSET(0xC8379F0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_TRYREFOCUSITEM_OFFSET UNITYSDK_OFFSET(0xC838350)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC838910)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC839690)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC839580)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__ENTERQUICKMODE_B__44_0_OFFSET UNITYSDK_OFFSET(0xC839730)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__ONNEXTLETTERAPPEAR_B__32_0_OFFSET UNITYSDK_OFFSET(0xC839700)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__TRYENTERQUICKMODE_B__31_0_OFFSET UNITYSDK_OFFSET(0xC8396A0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC839790)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC839800)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC839880)

namespace MoleMole
{
	inline static constexpr unsigned int UIPrivateMessageWidgetController_TypeDefinitionIndex = 44634;
	...
	public:
		...
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(UIPrivateMessageWidgetController_TypeDefinitionIndex)->GetStaticField(0x2D3B0);
		}
		::Class_2_799F87BA96E527A8* _view; // 0x2A0
		::Class_1_794BA983EDDBCFDE_Class_1_40F0860CEB67D2B1* _curUser; // 0x2A8
		::System::Int32 _toSetIndex; // 0x2B0
		::System::Int32 _endIndex; // 0x2B4
		::Class_1_8914B0C55B12E9CE<::Class_1_794BA983EDDBCFDE_Class_1_6142B71DCEBDB866*>* _messages; // 0x2B8
		::UnityEngine::Animation* _scrollAnim; // 0x2C0
		::MoleMole::MonoEventTrigger* _eventTrigger; // 0x2C8
		::Class_1_794BA983EDDBCFDE_Class_1_6142B71DCEBDB866* _curMessage; // 0x2D0
		::Class_2_D7D8BB398F7CF61F* _privateMessageModel; // 0x2D8
		::System::Boolean _checkFocus; // 0x2E0
		::MoleMole::MonoGamepadScrollView* _gamepadScroll; // 0x2E8
		::Foundation::Coroutine::CoroutineHandle _waitQuickMode; // 0x2F0
		::Foundation::Coroutine::CoroutineHandle _quickModeDelay; // 0x2F4
		::System::Boolean _canQuickMode; // 0x2F8
		::MoleMole::UIPrivateMessageWidgetController_MessageState _messageState; // 0x2FC
		::MoleMole::UIPrivateMessageNewMessageHintKeyWidgetController* _hintKeyWidget; // 0x300
		::MoleMole::UIInvitationMessageWidgetController* _invitationWidget; // 0x308
