...
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ADDBOTTOMMESSAGE_OFFSET UNITYSDK_OFFSET(0xD39F150)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_CHECKQUICKMODE_OFFSET UNITYSDK_OFFSET(0xD39EF50)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_CREATECONVERSION_OFFSET UNITYSDK_OFFSET(0xD39DE50)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_CREATEREPLAY_OFFSET UNITYSDK_OFFSET(0xD39DF30)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ENTERQUICKMODE_OFFSET UNITYSDK_OFFSET(0xD39F6A0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_FINISHSCROLL_OFFSET UNITYSDK_OFFSET(0xD3A0B80)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xD39DD50)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_HANDLEQUICKMODE_OFFSET UNITYSDK_OFFSET(0xD3A0F70)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_INITSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xD39E570)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xD39D760)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ISLASTLOGICGROUP_OFFSET UNITYSDK_OFFSET(0xD39F360)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_NEWMESSAGEFADEIN_OFFSET UNITYSDK_OFFSET(0xD3A08E0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONCLICKNEW_OFFSET UNITYSDK_OFFSET(0xD3A0B00)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONCLICKSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xD3A0F00)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD39DCB0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONNEXTLETTERAPPEAR_OFFSET UNITYSDK_OFFSET(0xD39F9E0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONSCROLLEND_OFFSET UNITYSDK_OFFSET(0xD39FB80)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xD3A0050)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD39E010)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD39D530)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xD39EE30)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_REFOCUSITEM_OFFSET UNITYSDK_OFFSET(0xD39FE70)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xD39ECF0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_SHOWEFFECT_OFFSET UNITYSDK_OFFSET(0xD39FD60)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_SHOWEMPTY_OFFSET UNITYSDK_OFFSET(0xD39EAE0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_SHOWINVITATION_OFFSET UNITYSDK_OFFSET(0xD39E900)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_SHOWMESSAGE_OFFSET UNITYSDK_OFFSET(0xD39E350)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_TRYENTERQUICKMODE_OFFSET UNITYSDK_OFFSET(0xD39F4A0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_TRYREFOCUSITEM_OFFSET UNITYSDK_OFFSET(0xD39FE00)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD3A03C0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD3A1140)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD3A1030)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__ENTERQUICKMODE_B__44_0_OFFSET UNITYSDK_OFFSET(0xD3A11E0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__ONNEXTLETTERAPPEAR_B__32_0_OFFSET UNITYSDK_OFFSET(0xD3A11B0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER__TRYENTERQUICKMODE_B__31_0_OFFSET UNITYSDK_OFFSET(0xD3A1150)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3A1240)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3A12B0)
#define MOLEMOLE_UIPRIVATEMESSAGEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3A1330)

namespace MoleMole
{
	inline static constexpr unsigned int UIPrivateMessageWidgetController_TypeDefinitionIndex = 47793;
	...
	public:
		...
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(UIPrivateMessageWidgetController_TypeDefinitionIndex)->GetStaticField(0x2E830);
		}
