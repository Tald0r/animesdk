...
#define MOLEMOLE_WEATHERV1CASTV2ENTRY_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x3133B0)

namespace MoleMole
{
	inline static constexpr unsigned int WeatherV1CastV2Entry_TypeDefinitionIndex = 51031;
