...
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x67CC640)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x67CC6E0)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x67CC740)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x67CC6F0)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x67CC630)
#define MOLEMOLE_SETTRIGGERPARAMETER__RESETVALUE_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0x67CC620)

namespace MoleMole
{
	inline static constexpr unsigned int SetTriggerParameter__ResetValue_d__7_TypeDefinitionIndex = 63362;
