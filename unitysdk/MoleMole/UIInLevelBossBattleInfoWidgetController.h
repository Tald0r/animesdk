...
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER_FILLCARDBYLITTLEBOSS_OFFSET UNITYSDK_OFFSET(0x8C750D0)
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER_FILLCARDLIST_OFFSET UNITYSDK_OFFSET(0x8C74E20)
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER_FILLREWARDMAP_OFFSET UNITYSDK_OFFSET(0x8C75960)
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x8C74DB0)
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER_MONSTERCARDCOMPARISON_OFFSET UNITYSDK_OFFSET(0x8C75710)
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C75F20)
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER___BASE_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0x8C75F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelBossBattleInfoWidgetController_TypeDefinitionIndex = 57849;
