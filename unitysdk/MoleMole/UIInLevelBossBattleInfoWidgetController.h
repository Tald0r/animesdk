...
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER_FILLCARDBYLITTLEBOSS_OFFSET UNITYSDK_OFFSET(0xB126620)
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER_FILLCARDLIST_OFFSET UNITYSDK_OFFSET(0xB126360)
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER_FILLREWARDMAP_OFFSET UNITYSDK_OFFSET(0xB126EB0)
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0xB1262F0)
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER_MONSTERCARDCOMPARISON_OFFSET UNITYSDK_OFFSET(0xB126C60)
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB127470)
#define MOLEMOLE_UIINLEVELBOSSBATTLEINFOWIDGETCONTROLLER___BASE_GETPROGRESS_OFFSET UNITYSDK_OFFSET(0xB127480)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelBossBattleInfoWidgetController_TypeDefinitionIndex = 77193;
