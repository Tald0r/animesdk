...
#define MOLEMOLE_SYSTEMSETTINGLOCALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB305030)

namespace MoleMole
{
	inline static constexpr unsigned int SystemSettingLocalData_TypeDefinitionIndex = 76486;
