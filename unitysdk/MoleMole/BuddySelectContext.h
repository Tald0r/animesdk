...
#define MOLEMOLE_BUDDYSELECTCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xBAD5750)
#define MOLEMOLE_BUDDYSELECTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBAD5700)

namespace MoleMole
{
	inline static constexpr unsigned int BuddySelectContext_TypeDefinitionIndex = 39465;
	...
	public:
		...
		::System::Int32 MultiSelectCount; // 0x60
		::System::Boolean IsShowBuddySelect; // 0x64
		::System::Boolean IsStoryMode; // 0x65
		::System::Boolean IsRobotBuddy; // 0x66
