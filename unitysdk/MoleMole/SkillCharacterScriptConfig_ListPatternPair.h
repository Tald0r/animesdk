...
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_LISTPATTERNPAIR_ADDPAIR_OFFSET UNITYSDK_OFFSET(0x9ACD5E0)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_LISTPATTERNPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x9ACD690)

namespace MoleMole
{
	inline static constexpr unsigned int SkillCharacterScriptConfig_ListPatternPair_TypeDefinitionIndex = 61676;
