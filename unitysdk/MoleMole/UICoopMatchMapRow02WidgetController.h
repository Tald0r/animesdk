...
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCAAC140)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCAAC1B0)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCAAC3F0)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCAAC4D0)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCAAC680)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER__ONCREATEVIEWMODEL_B__4_0_OFFSET UNITYSDK_OFFSET(0xCAAC690)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCAACAB0)
#define MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCAACB20)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopMatchMapRow02WidgetController_TypeDefinitionIndex = 60877;
	...
	public:
		...
		{
			return ((::Class_2_B3BE3A775F46A81F*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UICOOPMATCHMAPROW02WIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
