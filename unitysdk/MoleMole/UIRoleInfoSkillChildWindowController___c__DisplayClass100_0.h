...
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER___C__DISPLAYCLASS100_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA3F9D80)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER___C__DISPLAYCLASS100_0__ONUNLOCKTALENTANIMPLAY_B__0_OFFSET UNITYSDK_OFFSET(0xA3F9D90)
#define MOLEMOLE_UIROLEINFOSKILLCHILDWINDOWCONTROLLER___C__DISPLAYCLASS100_0__ONUNLOCKTALENTANIMPLAY_B__1_OFFSET UNITYSDK_OFFSET(0xA3F9FB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoSkillChildWindowController___c__DisplayClass100_0_TypeDefinitionIndex = 49308;
