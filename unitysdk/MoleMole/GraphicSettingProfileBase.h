...
#define MOLEMOLE_GRAPHICSETTINGPROFILEBASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xA50B2C0)
#define MOLEMOLE_GRAPHICSETTINGPROFILEBASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xA50B3A0)
#define MOLEMOLE_GRAPHICSETTINGPROFILEBASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xA50B4B0)
#define MOLEMOLE_GRAPHICSETTINGPROFILEBASE_GETPOWERCOST_OFFSET UNITYSDK_OFFSET(0xA5123D0)
#define MOLEMOLE_GRAPHICSETTINGPROFILEBASE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xA5123C0)
#define MOLEMOLE_GRAPHICSETTINGPROFILEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xA50B240)

namespace MoleMole
{
	inline static constexpr unsigned int GraphicSettingProfileBase_TypeDefinitionIndex = 56865;
