...
#define MOLEMOLE_UIMATERIALANIMATION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7D52B20)
#define MOLEMOLE_UIMATERIALANIMATION_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x7D52A20)
#define MOLEMOLE_UIMATERIALANIMATION_METHOD_5_3D32A8D32FBB901A_OFFSET UNITYSDK_OFFSET(0x7D52FE0)
#define MOLEMOLE_UIMATERIALANIMATION_METHOD_5_504F1A2F5A0739A0_OFFSET UNITYSDK_OFFSET(0x7D52680)
#define MOLEMOLE_UIMATERIALANIMATION_METHOD_5_97D83E4CB3B11935_1_OFFSET UNITYSDK_OFFSET(0x7D52D90)
#define MOLEMOLE_UIMATERIALANIMATION_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x7D533A0)
#define MOLEMOLE_UIMATERIALANIMATION_PLAYDEFAULTBYLOADMATERIAL_OFFSET UNITYSDK_OFFSET(0x7D52300)
#define MOLEMOLE_UIMATERIALANIMATION_PLAYUIMATANIBYLOAD_OFFSET UNITYSDK_OFFSET(0x7D52390)
#define MOLEMOLE_UIMATERIALANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x7D532E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMaterialAnimation_TypeDefinitionIndex = 51312;
