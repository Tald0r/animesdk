...
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA12A320)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA12A4A0)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA12A3C0)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA12A280)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA12A580)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA12A590)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA12A600)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA12A680)
#define MOLEMOLE_UIVIDEODETAILROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA12A700)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoDetailRowWidgetController_TypeDefinitionIndex = 50828;

	class UIVideoDetailRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_8127D35606966C67_21* _view; // 0x2D0
