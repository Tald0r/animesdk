...
#define MOLEMOLE_MONOLEVELRESULTPAGECONFIG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9AB6FE0)
#define MOLEMOLE_MONOLEVELRESULTPAGECONFIG_START_OFFSET UNITYSDK_OFFSET(0x9AB7040)
#define MOLEMOLE_MONOLEVELRESULTPAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB7280)
#define MOLEMOLE_MONOLEVELRESULTPAGECONFIG__START_G____NOTIFYEXP_9_0_OFFSET UNITYSDK_OFFSET(0x9AB7150)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLevelResultPageConfig_TypeDefinitionIndex = 66286;
