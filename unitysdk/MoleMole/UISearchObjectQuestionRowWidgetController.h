...
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xB53D630)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB53D850)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB53D9D0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB53D8F0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB53D410)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_REFRESHBYCONTEXT_OFFSET UNITYSDK_OFFSET(0xB53DA50)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_REFRESHSELECT_OFFSET UNITYSDK_OFFSET(0xB53D6B0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xB53DDC0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB53DE50)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xB53DEC0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB53DED0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB53DF40)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB53DFC0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB53E040)

namespace MoleMole
{
	inline static constexpr unsigned int UISearchObjectQuestionRowWidgetController_TypeDefinitionIndex = 41841;

	class UISearchObjectQuestionRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_410E84DCFF746137_2* _view; // 0x2D0
		::System::String* m_animNameSingleFadein; // 0x2D8
		::System::String* m_animNameSingleFadeout; // 0x2E0
		::System::String* m_animNameMultiFadein; // 0x2E8
		::System::String* m_animNameMultiFadeout; // 0x2F0
		::System::Boolean m_useSingleOrMultiple; // 0x2F8
		::System::Boolean m_isSelected; // 0x2F9
		::System::Action_2<::System::Int32, ::System::Boolean>* m_selectedChangeCallback; // 0x300
		::System::Int32 m_index; // 0x308
