...
#define MOLEMOLE_MONORENDERHANDLER_ADDMATPRIORITY_OFFSET UNITYSDK_OFFSET(0xA3BE170)
#define MOLEMOLE_MONORENDERHANDLER_ADDMAWORKINGPROPERTIES_OFFSET UNITYSDK_OFFSET(0xB924300)
#define MOLEMOLE_MONORENDERHANDLER_ADDMODIFIERINSTANCE_OFFSET UNITYSDK_OFFSET(0xA3BBD80)
#define MOLEMOLE_MONORENDERHANDLER_ADDRUNNINGMATPROPERTIESPATTERN_OFFSET UNITYSDK_OFFSET(0xA3BBFE0)
#define MOLEMOLE_MONORENDERHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA3BAB20)
#define MOLEMOLE_MONORENDERHANDLER_CHECKWRITEMATPROPERTYAUTHORITY_OFFSET UNITYSDK_OFFSET(0xA3BEFD0)
#define MOLEMOLE_MONORENDERHANDLER_CLEARMATERIALGROUP_OFFSET UNITYSDK_OFFSET(0xA3BC980)
#define MOLEMOLE_MONORENDERHANDLER_EMPTY_OFFSET UNITYSDK_OFFSET(0xA3BA760)
#define MOLEMOLE_MONORENDERHANDLER_FORCESYNCMATERIALSEFFECTSTORENDERERS_OFFSET UNITYSDK_OFFSET(0xA3BB760)
#define MOLEMOLE_MONORENDERHANDLER_GETCOMPONENTSAFELY_OFFSET UNITYSDK_OFFSET(0xA3BAA00)
#define MOLEMOLE_MONORENDERHANDLER_GETLASTWRITEMATPROPERTYAUTHORITY_OFFSET UNITYSDK_OFFSET(0xA3BF500)
#define MOLEMOLE_MONORENDERHANDLER_GETMATERIALMODIFIERINSTANCE_OFFSET UNITYSDK_OFFSET(0xA3BB950)
#define MOLEMOLE_MONORENDERHANDLER_GETMATPRIORITYPROPERTYKEY_OFFSET UNITYSDK_OFFSET(0xA3BEE70)
#define MOLEMOLE_MONORENDERHANDLER_GETMATVALUEBOOL_OFFSET UNITYSDK_OFFSET(0xA3BD7C0)
#define MOLEMOLE_MONORENDERHANDLER_GETMATVALUECOLOR_OFFSET UNITYSDK_OFFSET(0xA3BD370)
#define MOLEMOLE_MONORENDERHANDLER_GETMATVALUEFLOAT_OFFSET UNITYSDK_OFFSET(0xA3BCAF0)
#define MOLEMOLE_MONORENDERHANDLER_GETMATVALUEKEYWORD_OFFSET UNITYSDK_OFFSET(0xA3BD9F0)
#define MOLEMOLE_MONORENDERHANDLER_GETMATVALUETEXTUREOFFSET_OFFSET UNITYSDK_OFFSET(0xA3BCF30)
#define MOLEMOLE_MONORENDERHANDLER_GETMATVALUETEXTURETILLING_OFFSET UNITYSDK_OFFSET(0xA3BD150)
#define MOLEMOLE_MONORENDERHANDLER_GETMATVALUETEXTURE_OFFSET UNITYSDK_OFFSET(0xA3BCD10)
#define MOLEMOLE_MONORENDERHANDLER_GETMATVALUEVECTOR_OFFSET UNITYSDK_OFFSET(0xA3BD590)
#define MOLEMOLE_MONORENDERHANDLER_GETRUNNINGMATPROPERTIESPATTERNSBYTYPE_OFFSET UNITYSDK_OFFSET(0xA3BDD40)
#define MOLEMOLE_MONORENDERHANDLER_GETRUNNINGMATPROPERTIESPATTERN_OFFSET UNITYSDK_OFFSET(0xA3BDC20)
#define MOLEMOLE_MONORENDERHANDLER_GETRUNNINGPATTERNNONALLOC_OFFSET UNITYSDK_OFFSET(0xB924290)
#define MOLEMOLE_MONORENDERHANDLER_GET_ALLMATERIALMODIFIERINSTANCELIST_OFFSET UNITYSDK_OFFSET(0xA3BA580)
#define MOLEMOLE_MONORENDERHANDLER_GET_DEFAULTGROUP_OFFSET UNITYSDK_OFFSET(0xA3BA590)
#define MOLEMOLE_MONORENDERHANDLER_GET_INSTANCEDMATERIALS_OFFSET UNITYSDK_OFFSET(0xA3BA5B0)
#define MOLEMOLE_MONORENDERHANDLER_GET_ORIGINALINSTANCEDMATERIALGROUP_OFFSET UNITYSDK_OFFSET(0xA3BA5A0)
#define MOLEMOLE_MONORENDERHANDLER_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xA3BA620)
#define MOLEMOLE_MONORENDERHANDLER_HASHIGHERRUNNINGMATPROPERTIESPATTERNS_OFFSET UNITYSDK_OFFSET(0xA3BDED0)
#define MOLEMOLE_MONORENDERHANDLER_HASRUNNINGMATPROPERTIESPATTERNSBYTYPE_OFFSET UNITYSDK_OFFSET(0xA3BDE50)
#define MOLEMOLE_MONORENDERHANDLER_INITRENDERERS_OFFSET UNITYSDK_OFFSET(0xA3BAD10)
#define MOLEMOLE_MONORENDERHANDLER_INIT_OFFSET UNITYSDK_OFFSET(0xA3BAB90)
#define MOLEMOLE_MONORENDERHANDLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA3BB6F0)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xB9257F0)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_205A14011EEBDE57_OFFSET UNITYSDK_OFFSET(0xB925000)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_4D2A473556700CDC_OFFSET UNITYSDK_OFFSET(0xB925940)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_4D4839DB20A4F280_OFFSET UNITYSDK_OFFSET(0xB924C00)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xB925140)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_5C373407A2F6FEB8_OFFSET UNITYSDK_OFFSET(0xB924E50)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_913947B6596EB50A_OFFSET UNITYSDK_OFFSET(0xB924B10)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xB925080)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_A1E37D8FC0177BE6_OFFSET UNITYSDK_OFFSET(0xB9253A0)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_A66B981E1EA3E23D_OFFSET UNITYSDK_OFFSET(0xB926AB0)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_A99D60F1D5BF87C4_OFFSET UNITYSDK_OFFSET(0xB925460)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_B768DA94E3FD91D9_OFFSET UNITYSDK_OFFSET(0xB926930)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB924FA0)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA3BB1A0)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_DD784213055292FB_OFFSET UNITYSDK_OFFSET(0xA3BCA10)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_EA2EE4B996A25906_OFFSET UNITYSDK_OFFSET(0xB926C20)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xB924B00)
#define MOLEMOLE_MONORENDERHANDLER_METHOD_5_F735665AF9627D1B_OFFSET UNITYSDK_OFFSET(0xB924CC0)
#define MOLEMOLE_MONORENDERHANDLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA3BB200)
#define MOLEMOLE_MONORENDERHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA3BAE10)
#define MOLEMOLE_MONORENDERHANDLER_REFRESHMATPRIPORITY_OFFSET UNITYSDK_OFFSET(0xA3BE4B0)
#define MOLEMOLE_MONORENDERHANDLER_REMOVEENTITY_OFFSET UNITYSDK_OFFSET(0xA3BA860)
#define MOLEMOLE_MONORENDERHANDLER_REMOVEMATPRIORITY_OFFSET UNITYSDK_OFFSET(0xA3BE780)
#define MOLEMOLE_MONORENDERHANDLER_REMOVEMAWORKINGPROPERTIES_OFFSET UNITYSDK_OFFSET(0xB924690)
#define MOLEMOLE_MONORENDERHANDLER_REMOVEMODIFIERINSTANCE_OFFSET UNITYSDK_OFFSET(0xA3BBF10)
#define MOLEMOLE_MONORENDERHANDLER_REMOVERUNNINGMATPROPERTIESPATTERN_OFFSET UNITYSDK_OFFSET(0xA3BC1C0)
#define MOLEMOLE_MONORENDERHANDLER_RESETDIRTYCOUNT_OFFSET UNITYSDK_OFFSET(0xA3BC580)
#define MOLEMOLE_MONORENDERHANDLER_SETLASTWRITEMATPROPERTYAUTHORITY_OFFSET UNITYSDK_OFFSET(0xA3BF2B0)
#define MOLEMOLE_MONORENDERHANDLER_SETMODIFIERINSTANCEDIRTY_OFFSET UNITYSDK_OFFSET(0xA3BA500)
#define MOLEMOLE_MONORENDERHANDLER_SETUPALLMATERIALINSTANCES_OFFSET UNITYSDK_OFFSET(0xA3BBAC0)
#define MOLEMOLE_MONORENDERHANDLER_SETUPANDSTARTMATERIALINSTANCES_OFFSET UNITYSDK_OFFSET(0xA3BBB20)
#define MOLEMOLE_MONORENDERHANDLER_SETUPANDSTARTMATPROPERTIESPATTERN_OFFSET UNITYSDK_OFFSET(0xA3BBE30)
#define MOLEMOLE_MONORENDERHANDLER_SET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xA3BA630)
#define MOLEMOLE_MONORENDERHANDLER_STARTALLMATERIALMODIFIERINSTANCES_OFFSET UNITYSDK_OFFSET(0xA3BAF40)
#define MOLEMOLE_MONORENDERHANDLER_START_OFFSET UNITYSDK_OFFSET(0xA3BAE70)
#define MOLEMOLE_MONORENDERHANDLER_TRYCREATEMATERIALMODIFIERINSTANCE_OFFSET UNITYSDK_OFFSET(0xA3BBEA0)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_10_OFFSET UNITYSDK_OFFSET(0xB923C80)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_11_OFFSET UNITYSDK_OFFSET(0xB923E10)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_12_OFFSET UNITYSDK_OFFSET(0xB923F90)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_13_OFFSET UNITYSDK_OFFSET(0xB924110)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_1_OFFSET UNITYSDK_OFFSET(0xA3BC670)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_2_OFFSET UNITYSDK_OFFSET(0xA3BC6F0)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_3_OFFSET UNITYSDK_OFFSET(0xA3BC770)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_4_OFFSET UNITYSDK_OFFSET(0xA3BC800)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_5_OFFSET UNITYSDK_OFFSET(0xA3BC880)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_6_OFFSET UNITYSDK_OFFSET(0xA3BC900)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_7_OFFSET UNITYSDK_OFFSET(0xA3BEB80)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_8_OFFSET UNITYSDK_OFFSET(0xA3BF650)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_9_OFFSET UNITYSDK_OFFSET(0xB923B00)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETMATERIALMODIFIER_OFFSET UNITYSDK_OFFSET(0xA3BC5F0)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETSECONDPRIORITYITEM_1_OFFSET UNITYSDK_OFFSET(0xA3BED00)
#define MOLEMOLE_MONORENDERHANDLER_TRYGETSECONDPRIORITYITEM_OFFSET UNITYSDK_OFFSET(0xA3BEA60)
#define MOLEMOLE_MONORENDERHANDLER_TRYREINIT_OFFSET UNITYSDK_OFFSET(0xA3BB110)
#define MOLEMOLE_MONORENDERHANDLER_UPDATECOMMONSWITCH_OFFSET UNITYSDK_OFFSET(0xA3BC520)
#define MOLEMOLE_MONORENDERHANDLER_UPDATEMATERIALMODIFIERINSTANCES_OFFSET UNITYSDK_OFFSET(0xA3BC320)
#define MOLEMOLE_MONORENDERHANDLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xB924A80)
#define MOLEMOLE_MONORENDERHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB9249D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoRenderHandler_TypeDefinitionIndex = 56341;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::MoleMole::MonoRenderHandler*>**)Il2CppClass::FromTypeDefinitionIndex(MonoRenderHandler_TypeDefinitionIndex)->GetStaticField(0x3EF00);
		}
