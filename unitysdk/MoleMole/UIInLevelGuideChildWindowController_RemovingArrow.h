...
#define MOLEMOLE_UIINLEVELGUIDECHILDWINDOWCONTROLLER_REMOVINGARROW_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x9EB4C10)
#define MOLEMOLE_UIINLEVELGUIDECHILDWINDOWCONTROLLER_REMOVINGARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x9EB4CD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelGuideChildWindowController_RemovingArrow_TypeDefinitionIndex = 70581;
