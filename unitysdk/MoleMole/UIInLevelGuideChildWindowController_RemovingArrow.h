...
#define MOLEMOLE_UIINLEVELGUIDECHILDWINDOWCONTROLLER_REMOVINGARROW_GETPOSITION_OFFSET UNITYSDK_OFFSET(0xC875460)
#define MOLEMOLE_UIINLEVELGUIDECHILDWINDOWCONTROLLER_REMOVINGARROW__CTOR_OFFSET UNITYSDK_OFFSET(0xC875520)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelGuideChildWindowController_RemovingArrow_TypeDefinitionIndex = 62946;
