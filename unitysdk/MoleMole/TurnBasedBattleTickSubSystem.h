...
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM_CHECKOCCLUSIONDITHER_OFFSET UNITYSDK_OFFSET(0xB3ECD00)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM_CREATEPREVIEWEFFECT_OFFSET UNITYSDK_OFFSET(0xB3EB9D0)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM_DESTROYALLPREVIEWEFFECT_OFFSET UNITYSDK_OFFSET(0xB3EC860)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB3EB610)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xB3EB7D0)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xB3ECB90)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xB3EB3B0)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM_TICKEFFECT_OFFSET UNITYSDK_OFFSET(0xB3EC1C0)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM_TICKPROTECTTIME_OFFSET UNITYSDK_OFFSET(0xB3EDAE0)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM_TRYDESTROYPREVIEWEFFECT_OFFSET UNITYSDK_OFFSET(0xB3EBFA0)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB3EE1E0)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB3EE350)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xB3EE3B0)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xB3EE420)
#define MOLEMOLE_TURNBASEDBATTLETICKSUBSYSTEM___BASE_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xB3EE480)

namespace MoleMole
{
	inline static constexpr unsigned int TurnBasedBattleTickSubSystem_TypeDefinitionIndex = 42515;
	...
	public:
		...
		::Class_4_3D4EFA6B3CC691CC* GameContext; // 0x20
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* occludedBuffer; // 0x28
		::System::Single checkDitherTimer; // 0x30
		::System::Single protectTime; // 0x34
		::System::Single checkInterval; // 0x38
		::System::Single enemyRoundProtectTime; // 0x3C
		::System::Single enemyRoundProtectTimer; // 0x40
		::System::Boolean startEnemyRoundProtect; // 0x44
		::System::Boolean startSelfRoundProtect; // 0x45
		::System::Single protectTimer; // 0x48
