...
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___C__DISPLAYCLASS34_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBAF6730)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___C__DISPLAYCLASS34_0__STARTSECONDINCREASE_B__1_OFFSET UNITYSDK_OFFSET(0xBAF6740)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___C__DISPLAYCLASS34_0__STARTSECONDINCREASE_B__2_OFFSET UNITYSDK_OFFSET(0xBAF6880)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPLevelRowWidgetController___c__DisplayClass34_0_TypeDefinitionIndex = 56527;
