...
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___C__DISPLAYCLASS34_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBFC31D0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___C__DISPLAYCLASS34_0__STARTSECONDINCREASE_B__1_OFFSET UNITYSDK_OFFSET(0xBFC31E0)
#define MOLEMOLE_UIBPLEVELROWWIDGETCONTROLLER___C__DISPLAYCLASS34_0__STARTSECONDINCREASE_B__2_OFFSET UNITYSDK_OFFSET(0xBFC3320)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPLevelRowWidgetController___c__DisplayClass34_0_TypeDefinitionIndex = 79018;
