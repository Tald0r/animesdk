...
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__SHOWFEVERTIPSDIALOG_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x37E1F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER__SHOWFEVERTIPSDIALOG_D__24_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSinglePlayWidgetController__ShowFeverTipsDialog_d__24_TypeDefinitionIndex = 64973;
