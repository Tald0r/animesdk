...
#define MOLEMOLE_ANIMATORBLENDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xB498E20)

namespace MoleMole
{
	inline static constexpr unsigned int AnimatorBlendGroup_TypeDefinitionIndex = 55037;
