...
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_CLEARWRONGTIPS_OFFSET UNITYSDK_OFFSET(0xA24B920)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_GETCURSELECTEDCOUNT_OFFSET UNITYSDK_OFFSET(0xA24D4B0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_GETORADDWIDGET_OFFSET UNITYSDK_OFFSET(0xA24C620)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0xA24C0E0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_GET_QAMAP_OFFSET UNITYSDK_OFFSET(0xA24C560)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_INITOPTIONS_OFFSET UNITYSDK_OFFSET(0xA24C920)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_ONCLICKNEXTOREND_OFFSET UNITYSDK_OFFSET(0xA24B170)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA24C1A0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_ONOPTIONSELECTED_OFFSET UNITYSDK_OFFSET(0xA24D010)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA24C330)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA24C240)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA24B010)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_REFRESHBYCTX_OFFSET UNITYSDK_OFFSET(0xA24C3B0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_REFRESHDESC_OFFSET UNITYSDK_OFFSET(0xA24C760)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_REFRESHQUESTION_OFFSET UNITYSDK_OFFSET(0xA24B9A0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_REFRESHSELECTIONACTIVE_OFFSET UNITYSDK_OFFSET(0xA24CAB0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_REFRESHSUBMITBTN_OFFSET UNITYSDK_OFFSET(0xA24CD90)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_SHOWSETTLETEMP_OFFSET UNITYSDK_OFFSET(0xA24C050)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_SHOWSUBMITORNEXTBTN_OFFSET UNITYSDK_OFFSET(0xA24BF30)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA24D640)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA24D6B0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA24D720)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA24D7A0)
#define MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA24D820)

namespace MoleMole
{
	inline static constexpr unsigned int UISearchObjectQuestionWidgetController_TypeDefinitionIndex = 39744;

	class UISearchObjectQuestionWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_1B1C05BC0A38A2D5_2* _view; // 0x2D0
		...
		::Class_2_208CC9941471731A_519* m_groupCfg; // 0x310
		...
		{
			return ((::Class_1_B0D0FA59121B13B3*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISEARCHOBJECTQUESTIONWIDGETCONTROLLER_GET_QAMAP_OFFSET))(this);
		}
