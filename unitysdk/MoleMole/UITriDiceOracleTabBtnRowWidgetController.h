...
#define MOLEMOLE_UITRIDICEORACLETABBTNROWWIDGETCONTROLLER_GETBADGE_OFFSET UNITYSDK_OFFSET(0xCAAEEE0)
#define MOLEMOLE_UITRIDICEORACLETABBTNROWWIDGETCONTROLLER_GETTABBUTTON_OFFSET UNITYSDK_OFFSET(0xCAAEBF0)
#define MOLEMOLE_UITRIDICEORACLETABBTNROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCAAEA70)
#define MOLEMOLE_UITRIDICEORACLETABBTNROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCAAEB10)
#define MOLEMOLE_UITRIDICEORACLETABBTNROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCAAE920)
#define MOLEMOLE_UITRIDICEORACLETABBTNROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCAAE9C0)
#define MOLEMOLE_UITRIDICEORACLETABBTNROWWIDGETCONTROLLER_SETLUCKTYPE_OFFSET UNITYSDK_OFFSET(0xCAAEC60)
#define MOLEMOLE_UITRIDICEORACLETABBTNROWWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0xCAAEE40)
#define MOLEMOLE_UITRIDICEORACLETABBTNROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCAAEF50)
#define MOLEMOLE_UITRIDICEORACLETABBTNROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCAAEF80)
#define MOLEMOLE_UITRIDICEORACLETABBTNROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCAAEFF0)
#define MOLEMOLE_UITRIDICEORACLETABBTNROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCAAF070)
#define MOLEMOLE_UITRIDICEORACLETABBTNROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCAAF0D0)

namespace MoleMole
{
	inline static constexpr unsigned int UITriDiceOracleTabBtnRowWidgetController_TypeDefinitionIndex = 74316;
