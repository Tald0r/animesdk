...
#define MOLEMOLE_SHOWINLEVELDAMAGETEXTSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6B20BE0)

namespace MoleMole
{
	inline static constexpr unsigned int ShowInLevelDamageTextSettingContext_TypeDefinitionIndex = 74818;
