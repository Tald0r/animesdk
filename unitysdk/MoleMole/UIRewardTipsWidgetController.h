...
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_ADDPREVIEWCOMMONREWARD_OFFSET UNITYSDK_OFFSET(0xCA43460)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0xCA42FE0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_GETREWARDTIPSWIDGET_OFFSET UNITYSDK_OFFSET(0xCA438C0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_INITTIPSWIDGET_OFFSET UNITYSDK_OFFSET(0xCA43B90)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_INTERRUPT_OFFSET UNITYSDK_OFFSET(0xCA42E60)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA42990)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_ONSHOWCOMMONREWARDSEND_OFFSET UNITYSDK_OFFSET(0xCA42F50)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_ONSHOWCOMMONREWARDS_OFFSET UNITYSDK_OFFSET(0xCA430D0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA42A00)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA42760)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_PAUSE_OFFSET UNITYSDK_OFFSET(0xCA42DF0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0xCA42C20)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_PREVIEWCLEARCOMMONREWARDS_OFFSET UNITYSDK_OFFSET(0xCA435E0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_PREVIEWCOMMONREWARDS_OFFSET UNITYSDK_OFFSET(0xCA43670)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_REALPLAY_OFFSET UNITYSDK_OFFSET(0xCA42D40)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_RECYLEREWARDTIPWIDGET_OFFSET UNITYSDK_OFFSET(0xCA43760)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_REFRESHTIPSWIDGET_OFFSET UNITYSDK_OFFSET(0xCA43D50)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_TRYPLAY_OFFSET UNITYSDK_OFFSET(0xCA43240)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA43E20)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA43F20)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA43F90)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA44010)

namespace MoleMole
{
	inline static constexpr unsigned int UIRewardTipsWidgetController_TypeDefinitionIndex = 49947;
