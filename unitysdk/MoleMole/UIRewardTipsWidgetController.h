...
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_ADDPREVIEWCOMMONREWARD_OFFSET UNITYSDK_OFFSET(0xD7A3DF0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0xD7A3970)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_GETREWARDTIPSWIDGET_OFFSET UNITYSDK_OFFSET(0xD7A4250)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_INITTIPSWIDGET_OFFSET UNITYSDK_OFFSET(0xD7A4530)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_INTERRUPT_OFFSET UNITYSDK_OFFSET(0xD7A37F0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD7A3320)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_ONSHOWCOMMONREWARDSEND_OFFSET UNITYSDK_OFFSET(0xD7A38E0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_ONSHOWCOMMONREWARDS_OFFSET UNITYSDK_OFFSET(0xD7A3A60)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD7A3390)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD7A30F0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_PAUSE_OFFSET UNITYSDK_OFFSET(0xD7A3780)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0xD7A35B0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_PREVIEWCLEARCOMMONREWARDS_OFFSET UNITYSDK_OFFSET(0xD7A3F70)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_PREVIEWCOMMONREWARDS_OFFSET UNITYSDK_OFFSET(0xD7A4000)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_REALPLAY_OFFSET UNITYSDK_OFFSET(0xD7A36D0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_RECYLEREWARDTIPWIDGET_OFFSET UNITYSDK_OFFSET(0xD7A40F0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_REFRESHTIPSWIDGET_OFFSET UNITYSDK_OFFSET(0xD7A46F0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER_TRYPLAY_OFFSET UNITYSDK_OFFSET(0xD7A3BD0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD7A47C0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD7A48C0)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD7A4930)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD7A49B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRewardTipsWidgetController_TypeDefinitionIndex = 77651;

	class UIRewardTipsWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::UIMainCityRewardTipsWidgetController*>* cacheWidgetList; // 0x2A0
		::Class_1_3FA43C71A3D27BCE* animHandler; // 0x2A8
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* previewDataList; // 0x2B0
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* _cacheList; // 0x2B8
		::System::Action* _onComplete; // 0x2C0
