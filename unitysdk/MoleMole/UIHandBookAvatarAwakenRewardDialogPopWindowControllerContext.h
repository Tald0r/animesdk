...
#define MOLEMOLE_UIHANDBOOKAVATARAWAKENREWARDDIALOGPOPWINDOWCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8A25E60)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookAvatarAwakenRewardDialogPopWindowControllerContext_TypeDefinitionIndex = 36901;
