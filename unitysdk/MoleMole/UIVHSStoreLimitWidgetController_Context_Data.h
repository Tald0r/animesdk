...
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_CURTAGLIST_OFFSET UNITYSDK_OFFSET(0x99153D0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_CURTAGWITHOUTHIDING_OFFSET UNITYSDK_OFFSET(0x99154A0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_CURVHSSLOTLIST_OFFSET UNITYSDK_OFFSET(0x99156A0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_ENERGY_OFFSET UNITYSDK_OFFSET(0x9914FC0)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_OPTIONRECORDLIST_OFFSET UNITYSDK_OFFSET(0x9915090)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_RECOMMENDROUND_OFFSET UNITYSDK_OFFSET(0x9915230)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x9915160)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_VHSRECOMMENDROUNDMAP_OFFSET UNITYSDK_OFFSET(0x9915300)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_WAITREFRESHTAGIDX_OFFSET UNITYSDK_OFFSET(0x9915770)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_WAITREFRESHTAGNEW_OFFSET UNITYSDK_OFFSET(0x9915840)
#define MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9915910)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreLimitWidgetController_Context_Data_TypeDefinitionIndex = 43522;
	...
	public:
		...
		::System::Collections::Generic::IReadOnlyList_1<::Class_3_B6A6E344CE687278_10*>* get_OptionRecordList()
		{
			return ((::System::Collections::Generic::IReadOnlyList_1<::Class_3_B6A6E344CE687278_10*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVHSSTORELIMITWIDGETCONTROLLER_CONTEXT_DATA_GET_OPTIONRECORDLIST_OFFSET))(this);
		}
