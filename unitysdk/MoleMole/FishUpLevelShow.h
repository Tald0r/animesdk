...
#define MOLEMOLE_FISHUPLEVELSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x6E0F370)
#define MOLEMOLE_FISHUPLEVELSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x6E0F400)
#define MOLEMOLE_FISHUPLEVELSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x6E0F380)

namespace MoleMole
{
	inline static constexpr unsigned int FishUpLevelShow_TypeDefinitionIndex = 77545;
