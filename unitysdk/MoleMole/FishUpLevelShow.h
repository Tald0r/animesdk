...
#define MOLEMOLE_FISHUPLEVELSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xC25E8E0)
#define MOLEMOLE_FISHUPLEVELSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xC25E970)
#define MOLEMOLE_FISHUPLEVELSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xC25E8F0)

namespace MoleMole
{
	inline static constexpr unsigned int FishUpLevelShow_TypeDefinitionIndex = 53844;
