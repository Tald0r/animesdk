...
#define MOLEMOLE_STEERGLOBALUPDATE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB935990)
#define MOLEMOLE_STEERGLOBALUPDATE_ONSTART_OFFSET UNITYSDK_OFFSET(0xB935BF0)
#define MOLEMOLE_STEERGLOBALUPDATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xB935FC0)
#define MOLEMOLE_STEERGLOBALUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0xB936020)
#define MOLEMOLE_STEERGLOBALUPDATE___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB9360D0)
#define MOLEMOLE_STEERGLOBALUPDATE___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0xB936160)
#define MOLEMOLE_STEERGLOBALUPDATE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xB9361F0)

namespace MoleMole
{
	inline static constexpr unsigned int SteerGlobalUpdate_TypeDefinitionIndex = 55863;
	...
	public:
		...
		::MoleMole::SharedGameEntity* Entity; // 0x68
		::Class_3_883FBE6CFFAC5DA2* rvoComponent; // 0x70
		::BehaviorDesigner::Runtime::SharedFloat* CameraWeight; // 0x78
		::BehaviorDesigner::Runtime::SharedFloat* RVOPriority; // 0x80
		::BehaviorDesigner::Runtime::SharedFloat* SeparateGatherWeight; // 0x88
		::BehaviorDesigner::Runtime::SharedFloat* NearWeight; // 0x90
		::BehaviorDesigner::Runtime::SharedFloat* RVOWeight; // 0x98
		::MoleMole::Battle::Entity* ownerEntity; // 0xA0
