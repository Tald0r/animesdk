...
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xBB16990)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBB16CE0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBB16D40)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xBB16CF0)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBB16980)
#define MOLEMOLE_UIGROCERYCHILDWINDOWCONTROLLER__COUNTDOWN_D__33__CTOR_OFFSET UNITYSDK_OFFSET(0xBB16970)

namespace MoleMole
{
	inline static constexpr unsigned int UIGroceryChildWindowController__CountDown_d__33_TypeDefinitionIndex = 74609;
