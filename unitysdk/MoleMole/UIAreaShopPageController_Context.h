...
#define MOLEMOLE_UIAREASHOPPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC0913E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAreaShopPageController_Context_TypeDefinitionIndex = 66722;
