...
#define MOLEMOLE_UITRIDICEORACLEINFODIALOGOPENCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9A293F0)

namespace MoleMole
{
	inline static constexpr unsigned int UITriDiceOracleInfoDialogOpenContext_TypeDefinitionIndex = 70698;

	class UITriDiceOracleInfoDialogOpenContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::String* TodaySignResShortContent; // 0x28
		::System::String* TodaySignResDetail; // 0x30
		::System::String* TodaySignResTitle; // 0x38
		::System::Collections::Generic::List_1<::System::Int32>* DetailSignIdListInOrder; // 0x40
		::System::Boolean IsInHidingQuest; // 0x48
		::MoleMole::TriDiceLuckPerformType TodayLuckPerformType; // 0x4C
		::Class_2_B89683A15B3B0C43_Enum_3_55DEA7760B94F1B2 TodayLuckType; // 0x50
		::System::Int32 SignId; // 0x54
