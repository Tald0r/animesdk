...
#define MOLEMOLE_UITRIDICEORACLEINFODIALOGOPENCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x88865C0)

namespace MoleMole
{
	inline static constexpr unsigned int UITriDiceOracleInfoDialogOpenContext_TypeDefinitionIndex = 73092;

	class UITriDiceOracleInfoDialogOpenContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::String* TodaySignResDetail; // 0x28
		...
		::MoleMole::TriDiceLuckPerformType TodayLuckPerformType; // 0x48
		::System::Boolean IsInHidingQuest; // 0x4C
		::System::Int32 SignId; // 0x50
