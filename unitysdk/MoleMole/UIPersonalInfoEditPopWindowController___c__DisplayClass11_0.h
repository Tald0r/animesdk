...
#define MOLEMOLE_UIPERSONALINFOEDITPOPWINDOWCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA42F5B0)
#define MOLEMOLE_UIPERSONALINFOEDITPOPWINDOWCONTROLLER___C__DISPLAYCLASS11_0__DOUPDATESTRATEGY_B__0_OFFSET UNITYSDK_OFFSET(0xA42F5C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPersonalInfoEditPopWindowController___c__DisplayClass11_0_TypeDefinitionIndex = 53672;
	...
	public:
		...
		::Enum_3_5F152DBF108B0858 oldIdentityType; // 0x20
		::Enum_3_5F152DBF108B0858 newIdentityType; // 0x24
