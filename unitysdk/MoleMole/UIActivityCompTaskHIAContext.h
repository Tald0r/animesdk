...
#define MOLEMOLE_UIACTIVITYCOMPTASKHIACONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB95EAB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityCompTaskHIAContext_TypeDefinitionIndex = 78738;
