...
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x6C68A30)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__DOANIMATION_B__0_OFFSET UNITYSDK_OFFSET(0x6C68A40)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__DOANIMATION_B__1_OFFSET UNITYSDK_OFFSET(0x6C68E50)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__DOANIMATION_B__2_OFFSET UNITYSDK_OFFSET(0x6C68B50)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__DOANIMATION_B__3_OFFSET UNITYSDK_OFFSET(0x6C68DB0)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__DOANIMATION_B__4_OFFSET UNITYSDK_OFFSET(0x6C68DC0)
#define MOLEMOLE_UIGENERALTIPSCAMERAROWWIDGETCONTROLLER___C__DISPLAYCLASS14_0__DOANIMATION_B__5_OFFSET UNITYSDK_OFFSET(0x6C68DD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTipsCameraRowWidgetController___c__DisplayClass14_0_TypeDefinitionIndex = 46278;

	class UIGeneralTipsCameraRowWidgetController___c__DisplayClass14_0 : public ::System::Object
	{
	public:
		::MoleMole::UIGeneralTipsCameraRowWidgetController* __4__this; // 0x10
		::System::Action* __9__2; // 0x18
		::System::Action* action; // 0x20
		::DG::Tweening::Core::DOGetter_1<::System::Single>* __9__3; // 0x28
