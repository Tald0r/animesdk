...
#define MOLEMOLE_UIROLEINFOBASICCHILDWINDOWCONTROLLER___C__DISPLAYCLASS51_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAC34C80)
#define MOLEMOLE_UIROLEINFOBASICCHILDWINDOWCONTROLLER___C__DISPLAYCLASS51_0__INITAVATARSCOREDIALOG_B__3_OFFSET UNITYSDK_OFFSET(0xAC34C90)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleInfoBasicChildWindowController___c__DisplayClass51_0_TypeDefinitionIndex = 40205;
	...
	public:
		...
		::Enum_3_CAE10C54ABAE6FAF equipScoreLevel; // 0x28
		::Enum_3_CAE10C54ABAE6FAF levelScoreLevel; // 0x2C
