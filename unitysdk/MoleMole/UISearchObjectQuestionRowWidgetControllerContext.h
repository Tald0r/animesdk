...
#define MOLEMOLE_UISEARCHOBJECTQUESTIONROWWIDGETCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD6C5950)

namespace MoleMole
{
	inline static constexpr unsigned int UISearchObjectQuestionRowWidgetControllerContext_TypeDefinitionIndex = 37127;
