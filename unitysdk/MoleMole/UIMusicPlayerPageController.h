...
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0xB408F40)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_CHECKANDGENERATERANDOMLIST_OFFSET UNITYSDK_OFFSET(0xB40A390)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_COMPUTESMOOTHENERGY_OFFSET UNITYSDK_OFFSET(0xB40E600)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_CREATEGAUSSIANKERNEL_OFFSET UNITYSDK_OFFSET(0xB40EFE0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_DEALPAUSE_OFFSET UNITYSDK_OFFSET(0xB40A810)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_DEALRESUME_OFFSET UNITYSDK_OFFSET(0xB40AAF0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_DURATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0xB40DF10)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_FADESPECTRUM_OFFSET UNITYSDK_OFFSET(0xB40EC10)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GAUSSIANSMOOTH_OFFSET UNITYSDK_OFFSET(0xB40E8F0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GET_CURMUSICDURATION_OFFSET UNITYSDK_OFFSET(0xB408590)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GET_MUSICTIMEPERCENT_OFFSET UNITYSDK_OFFSET(0xB4085B0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB408580)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_INITSPECTRUMS_OFFSET UNITYSDK_OFFSET(0xB4087C0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0xB40E370)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB4085D0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONDRAGFINISHED_OFFSET UNITYSDK_OFFSET(0xB40AEE0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONENDEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xB40DE00)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONEVENTPLAYFAILED_OFFSET UNITYSDK_OFFSET(0xB40DE90)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xB40E250)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xB409520)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONMAINBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xB40C2C0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONPOSTEVENTSUCCESS_OFFSET UNITYSDK_OFFSET(0xB40DD80)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONSLIDERPOINTERDOWNHANDLE_OFFSET UNITYSDK_OFFSET(0xB40B280)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONSLIDERPOINTERUPHANDLE_OFFSET UNITYSDK_OFFSET(0xB40B1A0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB40B360)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB408670)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB4099F0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYINDEX_OFFSET UNITYSDK_OFFSET(0xB40A6B0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYNEXT_OFFSET UNITYSDK_OFFSET(0xB40B870)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYPREV_OFFSET UNITYSDK_OFFSET(0xB40E3E0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYSONG_OFFSET UNITYSDK_OFFSET(0xB40C420)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_REFRESHMODEDISPLAY_OFFSET UNITYSDK_OFFSET(0xB40A4A0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETDRAGGING_OFFSET UNITYSDK_OFFSET(0xB409930)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETMODE_OFFSET UNITYSDK_OFFSET(0xB40E120)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETSPECTRUMPARAMS_OFFSET UNITYSDK_OFFSET(0xB40D6D0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SET_CURMUSICDURATION_OFFSET UNITYSDK_OFFSET(0xB4085A0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SHOWCURPLAYTIME_OFFSET UNITYSDK_OFFSET(0xB40B690)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SHOWCURSPECTRUM_OFFSET UNITYSDK_OFFSET(0xB40B9B0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_TOGGLELIKE_OFFSET UNITYSDK_OFFSET(0xB40E500)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_TOGGLEPLAY_OFFSET UNITYSDK_OFFSET(0xB40E1C0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_TOGGLESPECTRUMNOISE_OFFSET UNITYSDK_OFFSET(0xB40BFF0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_UPDATELIKEBTNSTATUS_OFFSET UNITYSDK_OFFSET(0xB40A200)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_UPDATEPLAYDISPLAY_OFFSET UNITYSDK_OFFSET(0xB40D430)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB40B5A0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_0_OFFSET UNITYSDK_OFFSET(0xB40F390)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_1_OFFSET UNITYSDK_OFFSET(0xB40F3A0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_2_OFFSET UNITYSDK_OFFSET(0xB40F3B0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_3_OFFSET UNITYSDK_OFFSET(0xB40F3C0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB40F200)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__FADESPECTRUM_B__84_0_OFFSET UNITYSDK_OFFSET(0xB40F3D0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__ONUIOPEN_B__45_1_OFFSET UNITYSDK_OFFSET(0xB40F2B0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__ONUIOPEN_B__45_2_OFFSET UNITYSDK_OFFSET(0xB40F360)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB40F410)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xB40F480)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xB40F4F0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB40F520)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB40F530)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB40F540)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicPlayerPageController_TypeDefinitionIndex = 49612;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_77* _view; // 0x2F8
		...
		::Class_2_BF1F922B5C5C5180_Class_1_110CEE6864079A61_1* _spectrumData; // 0x348
		...
		::System::Void SetMode(::Enum_3_DB663931210BBC27_16 mode)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_16))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETMODE_OFFSET))(this, mode);
		}

		::System::Void RefreshModeDisplay(::Enum_3_DB663931210BBC27_16 mode, ::System::Boolean isOpen)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_16, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_REFRESHMODEDISPLAY_OFFSET))(this, mode, isOpen);
		}

		::System::Void CheckAndGenerateRandomList(::Enum_3_DB663931210BBC27_16 mode)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_16))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_CHECKANDGENERATERANDOMLIST_OFFSET))(this, mode);
		}
