...
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0xAF551D0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_CHECKANDGENERATERANDOMLIST_OFFSET UNITYSDK_OFFSET(0xAF565E0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_COMPUTESMOOTHENERGY_OFFSET UNITYSDK_OFFSET(0xAF5A830)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_CREATEGAUSSIANKERNEL_OFFSET UNITYSDK_OFFSET(0xAF5B210)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_DEALPAUSE_OFFSET UNITYSDK_OFFSET(0xAF56A60)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_DEALRESUME_OFFSET UNITYSDK_OFFSET(0xAF56D40)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_DURATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0xAF5A140)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_FADESPECTRUM_OFFSET UNITYSDK_OFFSET(0xAF5AE40)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GAUSSIANSMOOTH_OFFSET UNITYSDK_OFFSET(0xAF5AB20)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GET_CURMUSICDURATION_OFFSET UNITYSDK_OFFSET(0xAF54830)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GET_MUSICTIMEPERCENT_OFFSET UNITYSDK_OFFSET(0xAF54850)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAF54820)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_INITSPECTRUMS_OFFSET UNITYSDK_OFFSET(0xAF54A60)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0xAF5A5A0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF54870)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONDRAGFINISHED_OFFSET UNITYSDK_OFFSET(0xAF57140)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONENDEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xAF5A030)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONEVENTPLAYFAILED_OFFSET UNITYSDK_OFFSET(0xAF5A0C0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xAF5A480)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAF557A0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONMAINBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xAF58510)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONPOSTEVENTSUCCESS_OFFSET UNITYSDK_OFFSET(0xAF59FB0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONSLIDERPOINTERDOWNHANDLE_OFFSET UNITYSDK_OFFSET(0xAF574E0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONSLIDERPOINTERUPHANDLE_OFFSET UNITYSDK_OFFSET(0xAF57400)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF575C0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF54910)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF55C70)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYINDEX_OFFSET UNITYSDK_OFFSET(0xAF56900)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYNEXT_OFFSET UNITYSDK_OFFSET(0xAF57AC0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYPREV_OFFSET UNITYSDK_OFFSET(0xAF5A610)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_PLAYSONG_OFFSET UNITYSDK_OFFSET(0xAF58660)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_REFRESHMODEDISPLAY_OFFSET UNITYSDK_OFFSET(0xAF566F0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETDRAGGING_OFFSET UNITYSDK_OFFSET(0xAF55BB0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETMODE_OFFSET UNITYSDK_OFFSET(0xAF5A350)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETSPECTRUMPARAMS_OFFSET UNITYSDK_OFFSET(0xAF59910)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SET_CURMUSICDURATION_OFFSET UNITYSDK_OFFSET(0xAF54840)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SHOWCURPLAYTIME_OFFSET UNITYSDK_OFFSET(0xAF578F0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SHOWCURSPECTRUM_OFFSET UNITYSDK_OFFSET(0xAF57C00)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_TOGGLELIKE_OFFSET UNITYSDK_OFFSET(0xAF5A730)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_TOGGLEPLAY_OFFSET UNITYSDK_OFFSET(0xAF5A3F0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_TOGGLESPECTRUMNOISE_OFFSET UNITYSDK_OFFSET(0xAF58240)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_UPDATELIKEBTNSTATUS_OFFSET UNITYSDK_OFFSET(0xAF56470)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_UPDATEPLAYDISPLAY_OFFSET UNITYSDK_OFFSET(0xAF59670)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAF57800)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_0_OFFSET UNITYSDK_OFFSET(0xAF5B5C0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_1_OFFSET UNITYSDK_OFFSET(0xAF5B5D0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_2_OFFSET UNITYSDK_OFFSET(0xAF5B5E0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__BINDEVENT_B__54_3_OFFSET UNITYSDK_OFFSET(0xAF5B5F0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAF5B430)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__FADESPECTRUM_B__84_0_OFFSET UNITYSDK_OFFSET(0xAF5B600)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__ONUIOPEN_B__45_1_OFFSET UNITYSDK_OFFSET(0xAF5B4E0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER__ONUIOPEN_B__45_2_OFFSET UNITYSDK_OFFSET(0xAF5B590)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF5B640)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xAF5B6B0)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xAF5B720)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF5B750)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF5B760)
#define MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF5B770)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicPlayerPageController_TypeDefinitionIndex = 73999;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_37* _view; // 0x2F8
		::System::Collections::Generic::List_1<::System::Int32>* curUnlockedIDList; // 0x300
		::System::Collections::Generic::List_1<::System::Int32>* curRamdomList; // 0x308
		::System::Int32 curPlayIndex; // 0x310
		::System::Int32 curRandomIndex; // 0x314
		::System::Int32 curMusicId; // 0x318
		::System::Boolean isCurLike; // 0x31C
		::System::Int32 curPlayGroupId; // 0x320
		::System::Boolean isBtnPlaying; // 0x324
		::System::Boolean isRealPlaying; // 0x325
		::System::Single _curMusicDuration; // 0x328
		::System::Single curMusicTimer; // 0x32C
		::System::Single _lastShowtimer; // 0x330
		::Class_2_BF1F922B5C5C5180* _musicPlayerModel; // 0x338
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::System::Single>*>* _initParams; // 0x340
		::Class_2_BF1F922B5C5C5180_Class_1_110CEE6864079A61_5* _spectrumData; // 0x348
		::UnityEngine::Matrix4x4 _matrix; // 0x350
		::System::Single _lerpSpeed; // 0x390
		::System::Collections::Generic::List_1<::DG::Tweening::Tween*>* _spectrumTweens; // 0x398
		::System::Boolean _isShowSpectrum; // 0x3A0
		::System::UInt32 _currentPendingId; // 0x3A4
		::System::UInt32 _currentPlayingId; // 0x3A8
		::UnityEngine::GameObject* _currentPlayingSoundEmitter; // 0x3B0
		::Foundation::Coroutine::CoroutineHandle _coroutineHandle; // 0x3B8
		::Foundation::Coroutine::CoroutineHandle _switchHandle; // 0x3BC
		::System::Boolean isLastFrameAxisInputting; // 0x3C0
		::System::Boolean isDragging; // 0x3C1
		::System::Boolean isDragStartPlaying; // 0x3C2
		::System::Int32 _lastClickIndex; // 0x3C4
		::System::Collections::Generic::List_1<::System::Single>* energyList; // 0x3C8
		::System::Collections::Generic::List_1<::System::Single>* smoothEnergy; // 0x3D0
		...
		::System::Void SetMode(::Enum_3_DB663931210BBC27_32 mode)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_SETMODE_OFFSET))(this, mode);
		}

		::System::Void RefreshModeDisplay(::Enum_3_DB663931210BBC27_32 mode, ::System::Boolean isOpen)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_32, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_REFRESHMODEDISPLAY_OFFSET))(this, mode, isOpen);
		}

		::System::Void CheckAndGenerateRandomList(::Enum_3_DB663931210BBC27_32 mode)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_DB663931210BBC27_32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMUSICPLAYERPAGECONTROLLER_CHECKANDGENERATERANDOMLIST_OFFSET))(this, mode);
		}
