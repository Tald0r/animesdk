...
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBE25AB0)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBE25C30)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBE25B50)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBE25960)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER_REFRESHWEAPONVIEW_OFFSET UNITYSDK_OFFSET(0xBE25D00)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBE263E0)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBE26470)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBE264E0)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBE26560)
#define MOLEMOLE_UILEVELUPDETAILSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBE265E0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelUpDetailsRowWidgetController_TypeDefinitionIndex = 50752;
