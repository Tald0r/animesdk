...
class Class_2_79AE422BA06F6D26_40_Class_2_0CFC8DCC343CD856;
class PhotoFrame;
...
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD008BA0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_GET__PHOTOFRAMESETTING_OFFSET UNITYSDK_OFFSET(0xD0050D0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_INITPHOTOFRAME_OFFSET UNITYSDK_OFFSET(0xD0050F0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_LOADCONFIGSETFRAMEINNER_OFFSET UNITYSDK_OFFSET(0xD005A20)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_LOADCONFIGSETFRAMEOUTER_OFFSET UNITYSDK_OFFSET(0xD006290)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_LOADCONFIGSETFRAMEPHOTO_OFFSET UNITYSDK_OFFSET(0xD005790)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_LOADFRAMEASSETS_OFFSET UNITYSDK_OFFSET(0xD0075D0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD008E00)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_ONPHOTOPLAYERINFOCHANGE_OFFSET UNITYSDK_OFFSET(0xD008950)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xD008AD0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD008EA0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD008BB0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD008CD0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_PROCESSINNER_OFFSET UNITYSDK_OFFSET(0xD006AE0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_PROCESSNEXTFRAME_OFFSET UNITYSDK_OFFSET(0xD006A60)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_PROCESSOUTER_OFFSET UNITYSDK_OFFSET(0xD006FB0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_PROCESSSCALE_OFFSET UNITYSDK_OFFSET(0xD0074A0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_REFRESHMPTEAMMATEINFO_OFFSET UNITYSDK_OFFSET(0xD007940)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_REFRESHPLAYERINFO_OFFSET UNITYSDK_OFFSET(0xD0079D0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_SETPHOTOSTEP1_OFFSET UNITYSDK_OFFSET(0xD005280)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_SET__PHOTOFRAMESETTING_OFFSET UNITYSDK_OFFSET(0xD0050E0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_SHOWPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xD0080E0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_SHOWSTICKERS_OFFSET UNITYSDK_OFFSET(0xD005E60)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD008F60)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD009050)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD0090C0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD0090D0)
#define MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD0090E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoFrameChildWindowController_TypeDefinitionIndex = 47846;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_40* _view; // 0x358
		...
		::System::Boolean ShowPlatformInfo(::Class_2_79AE422BA06F6D26_40_Class_2_0CFC8DCC343CD856* view, ::System::UInt32 uid, ::System::Boolean isShowPlatform)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_79AE422BA06F6D26_40_Class_2_0CFC8DCC343CD856*, ::System::UInt32, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPHOTOFRAMECHILDWINDOWCONTROLLER_SHOWPLATFORMINFO_OFFSET))(this, view, uid, isShowPlatform);
		}
