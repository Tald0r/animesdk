...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__STARTLEVEL_D__205_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3B6790)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__STARTLEVEL_D__205_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__StartLevel_d__205_TypeDefinitionIndex = 66306;
	...
	struct alignas(8) UIRidusGotBooPageController__StartLevel_d__205
	{
		...
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::Class_1_1F219549AE9B7C82_Enum_3_05F7423D39739F87> __u__2; // 0x30
