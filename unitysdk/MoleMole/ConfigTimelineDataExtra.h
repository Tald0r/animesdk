...
#define MOLEMOLE_CONFIGTIMELINEDATAEXTRA__CTOR_OFFSET UNITYSDK_OFFSET(0xE38BF20)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTimelineDataExtra_TypeDefinitionIndex = 71114;
