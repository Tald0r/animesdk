...
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_BINDNEWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0xA10BDC0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_CHANGENEWBADGETYPE_OFFSET UNITYSDK_OFFSET(0xA10BA30)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_CHANGEREDDOTBADGETYPE_OFFSET UNITYSDK_OFFSET(0xA10B9A0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_GETBATTLEINFONAME_OFFSET UNITYSDK_OFFSET(0xA10B650)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_GETNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0xA10BE50)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_GETSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0xA10B8C0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_GETUITABBUTTON_OFFSET UNITYSDK_OFFSET(0xA10B930)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA10B050)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA10B0F0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA10B1D0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_REGISTERNEWSUBNOTIFY_OFFSET UNITYSDK_OFFSET(0xA10BB60)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_REGISTERREDDOTSUBNOTIFY_OFFSET UNITYSDK_OFFSET(0xA10BAC0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0xA10BEC0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_SETSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0xA10B4A0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_SETTEXTMAPKEY_OFFSET UNITYSDK_OFFSET(0xA10B3C0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_SETTEXT_OFFSET UNITYSDK_OFFSET(0xA10B320)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_SETUPNEWNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0xA10BCE0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_SETUPNOTIFICATIONBADGE_OFFSET UNITYSDK_OFFSET(0xA10BC00)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA10BF30)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA10BF60)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA10BFD0)
#define MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA10C050)

namespace MoleMole
{
	inline static constexpr unsigned int UITabBtn03RowAllRoundWidgetController_TypeDefinitionIndex = 79433;
	...
	public:
		...
		::System::Void BindNewNotification(::Class_1_5A585DEB704A07E2* node)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5A585DEB704A07E2*))((::PBYTE)hIl2Cpp + MOLEMOLE_UITABBTN03ROWALLROUNDWIDGETCONTROLLER_BINDNEWNOTIFICATION_OFFSET))(this, node);
		}
