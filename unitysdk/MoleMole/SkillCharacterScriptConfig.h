...
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_CLEAN_OFFSET UNITYSDK_OFFSET(0x99458D0)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_GETSHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x991C410)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_GET_ANIMATORZONEGROUP_OFFSET UNITYSDK_OFFSET(0x9945B50)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_GET_EVENTPATTERNCONFIGS_OFFSET UNITYSDK_OFFSET(0x9945D60)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_GET_LINKEDANIMEVENTSOBJECT_OFFSET UNITYSDK_OFFSET(0x9946470)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_GET_LINKEDANIMEVENTS_OFFSET UNITYSDK_OFFSET(0x9946390)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_GET_STATELENGTHCONFIG_OFFSET UNITYSDK_OFFSET(0x9945950)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x99460D0)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x9946720)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9946560)
#define MOLEMOLE_SKILLCHARACTERSCRIPTCONFIG___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9946730)

namespace MoleMole
{
	inline static constexpr unsigned int SkillCharacterScriptConfig_TypeDefinitionIndex = 61673;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SkillCharacterScriptConfig_TypeDefinitionIndex)->GetStaticField(0xCD90);
		}
		static ::System::Boolean* StaticGet_S_False()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SkillCharacterScriptConfig_TypeDefinitionIndex)->GetStaticField(0xCD91);
		}
