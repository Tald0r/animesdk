...
#define MOLEMOLE_MONOSHOOTINGWAVE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xB9A5E20)
#define MOLEMOLE_MONOSHOOTINGWAVE_METHOD_5_4155E433CDAD6311_OFFSET UNITYSDK_OFFSET(0xB9A6230)
#define MOLEMOLE_MONOSHOOTINGWAVE_METHOD_5_D17B49CABC597E3E_OFFSET UNITYSDK_OFFSET(0xB9A6160)
#define MOLEMOLE_MONOSHOOTINGWAVE_SETTOTALWAVE_OFFSET UNITYSDK_OFFSET(0xB9A5EA0)
#define MOLEMOLE_MONOSHOOTINGWAVE_STARTNEXTWAVE_OFFSET UNITYSDK_OFFSET(0xB9A5F60)
#define MOLEMOLE_MONOSHOOTINGWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0xB9A6210)

namespace MoleMole
{
	inline static constexpr unsigned int MonoShootingWave_TypeDefinitionIndex = 49392;
