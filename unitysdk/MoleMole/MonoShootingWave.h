...
#define MOLEMOLE_MONOSHOOTINGWAVE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xD815840)
#define MOLEMOLE_MONOSHOOTINGWAVE_METHOD_5_4155E433CDAD6311_OFFSET UNITYSDK_OFFSET(0xD815C50)
#define MOLEMOLE_MONOSHOOTINGWAVE_METHOD_5_D17B49CABC597E3E_OFFSET UNITYSDK_OFFSET(0xD815B80)
#define MOLEMOLE_MONOSHOOTINGWAVE_SETTOTALWAVE_OFFSET UNITYSDK_OFFSET(0xD8158C0)
#define MOLEMOLE_MONOSHOOTINGWAVE_STARTNEXTWAVE_OFFSET UNITYSDK_OFFSET(0xD815980)
#define MOLEMOLE_MONOSHOOTINGWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0xD815C30)

namespace MoleMole
{
	inline static constexpr unsigned int MonoShootingWave_TypeDefinitionIndex = 37903;
