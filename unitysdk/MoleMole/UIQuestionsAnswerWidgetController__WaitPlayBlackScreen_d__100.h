...
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__WAITPLAYBLACKSCREEN_D__100_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x357130)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER__WAITPLAYBLACKSCREEN_D__100_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerWidgetController__WaitPlayBlackScreen_d__100_TypeDefinitionIndex = 66355;
