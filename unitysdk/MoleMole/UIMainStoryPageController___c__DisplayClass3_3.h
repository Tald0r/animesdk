...
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS3_3__CTOR_OFFSET UNITYSDK_OFFSET(0xBE2B5F0)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS3_3__ONSHOW_B__5_OFFSET UNITYSDK_OFFSET(0xBE2B600)
#define MOLEMOLE_UIMAINSTORYPAGECONTROLLER___C__DISPLAYCLASS3_3__ONSHOW_B__6_OFFSET UNITYSDK_OFFSET(0xBE2BB90)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryPageController___c__DisplayClass3_3_TypeDefinitionIndex = 40416;
