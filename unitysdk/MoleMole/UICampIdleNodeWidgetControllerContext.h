...
#define MOLEMOLE_UICAMPIDLENODEWIDGETCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC5FFFC0)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdleNodeWidgetControllerContext_TypeDefinitionIndex = 75342;
