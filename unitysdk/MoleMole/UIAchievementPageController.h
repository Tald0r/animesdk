...
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_ACHIEVEMENTCOMPARISON_OFFSET UNITYSDK_OFFSET(0xDC2CEB0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_CHECKAUTOSELECTGETAWARD_OFFSET UNITYSDK_OFFSET(0xDC2D5D0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_GETALLCALLBACK_OFFSET UNITYSDK_OFFSET(0xDC2D8C0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_GETFIRSTCLASSCONFIGBYINDEX_OFFSET UNITYSDK_OFFSET(0xDC2ABB0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDC29BE0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_ONCLICKFIRSTTAB_OFFSET UNITYSDK_OFFSET(0xDC2AE60)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDC29BF0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_ONGETDATAHANDLE_OFFSET UNITYSDK_OFFSET(0xDC2D790)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xDC2B430)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_ONMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xDC2D820)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_ONSELECTSECONDTAB_OFFSET UNITYSDK_OFFSET(0xDC2C380)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xDC2B770)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDC2A400)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDC29C90)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDC2A4F0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_ONUPDATEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0xDC2CFF0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_REFRESHACHIEVEMENTS_OFFSET UNITYSDK_OFFSET(0xDC2C490)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_REFRESHARROWTIPS_OFFSET UNITYSDK_OFFSET(0xDC2C6D0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_REFRESHGETALL_OFFSET UNITYSDK_OFFSET(0xDC2CD40)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_REFRESHRANKS_OFFSET UNITYSDK_OFFSET(0xDC2AF30)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_REFRESHSECONDTABS_OFFSET UNITYSDK_OFFSET(0xDC2BAF0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_SECONDTABCOMPARISON_OFFSET UNITYSDK_OFFSET(0xDC2CC90)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_TRYOVERRIDESELECTONFOCUS_OFFSET UNITYSDK_OFFSET(0xDC2B8D0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xDC2DBA0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC2DA00)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDC2DBF0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xDC2DC60)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xDC2DCC0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDC2DCD0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDC2DCE0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDC2DCF0)
#define MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER___BASE_TRYOVERRIDESELECTONFOCUS_OFFSET UNITYSDK_OFFSET(0xDC2DD60)

namespace MoleMole
{
	inline static constexpr unsigned int UIAchievementPageController_TypeDefinitionIndex = 67553;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(UIAchievementPageController_TypeDefinitionIndex)->GetStaticField(0x3EF10);
		}
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_77*>* _secondTabConfigs; // 0x308
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_24*>* _firstClassConfigs; // 0x330
		...
		::System::Int32 SecondTabComparison(::Class_2_208CC9941471731A_77* x, ::Class_2_208CC9941471731A_77* y)
		{
			return ((::System::Int32(*)(::PVOID, ::Class_2_208CC9941471731A_77*, ::Class_2_208CC9941471731A_77*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_SECONDTABCOMPARISON_OFFSET))(this, x, y);
		}
		...
		::Class_2_208CC9941471731A_24* GetFirstClassConfigByIndex(::System::Int32 index)
		{
			return ((::Class_2_208CC9941471731A_24*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACHIEVEMENTPAGECONTROLLER_GETFIRSTCLASSCONFIGBYINDEX_OFFSET))(this, index);
		}
