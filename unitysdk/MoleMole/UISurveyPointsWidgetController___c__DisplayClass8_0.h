...
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAAFAC20)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__1_OFFSET UNITYSDK_OFFSET(0xAAFAC30)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__2_OFFSET UNITYSDK_OFFSET(0xAAFB100)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__3_OFFSET UNITYSDK_OFFSET(0xAAFB360)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__4_OFFSET UNITYSDK_OFFSET(0xAAFB600)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__6_OFFSET UNITYSDK_OFFSET(0xAAFB850)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__7_OFFSET UNITYSDK_OFFSET(0xAAFB8D0)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_B__8_OFFSET UNITYSDK_OFFSET(0xAAFBB70)
#define MOLEMOLE_UISURVEYPOINTSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__REFRESHCONTROBUTEVIEW_G__ONPROGRESS_0_OFFSET UNITYSDK_OFFSET(0xAAFAED0)

namespace MoleMole
{
	inline static constexpr unsigned int UISurveyPointsWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 70920;
	...
	public:
		...
		::System::Int32 levelNeedExp; // 0x30
		::System::Int32 lastExp; // 0x34
		::System::Single curRatio; // 0x38
		::System::Int32 currentAbyssPoint; // 0x3C
		::System::Single minRatio; // 0x40
		::System::ValueTuple_3<::System::Boolean, ::System::Int32, ::System::Int32> progressData; // 0x44
		::System::Boolean isMaxLevel; // 0x50
		::System::Single timer; // 0x54
		::System::Int32 curLevel; // 0x58
		::System::Single prvRatio; // 0x5C
