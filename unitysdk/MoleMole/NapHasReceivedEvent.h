...
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONBEHAVIORCOMPLETE_OFFSET UNITYSDK_OFFSET(0x8C8FEF0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONEND_OFFSET UNITYSDK_OFFSET(0x8C8F4A0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONRESET_OFFSET UNITYSDK_OFFSET(0x8C90250)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONSTART_OFFSET UNITYSDK_OFFSET(0x8C8EED0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x8C8F310)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_RECEIVEDEVENT_1_OFFSET UNITYSDK_OFFSET(0x8C8F890)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_RECEIVEDEVENT_2_OFFSET UNITYSDK_OFFSET(0x8C8FA10)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_RECEIVEDEVENT_3_OFFSET UNITYSDK_OFFSET(0x8C8FC30)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_RECEIVEDEVENT_OFFSET UNITYSDK_OFFSET(0x8C8F820)
#define MOLEMOLE_NAPHASRECEIVEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x8C902D0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONBEHAVIORCOMPLETE_OFFSET UNITYSDK_OFFSET(0x8C90330)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x8C903C0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x8C90450)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x8C904E0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x8C90570)

namespace MoleMole
{
	inline static constexpr unsigned int NapHasReceivedEvent_TypeDefinitionIndex = 57978;

	class NapHasReceivedEvent : public ::BehaviorDesigner::Runtime::Tasks::Conditional
	{
	public:
		::BehaviorDesigner::Runtime::SharedVariable* storedValue1; // 0x50
