...
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONBEHAVIORCOMPLETE_OFFSET UNITYSDK_OFFSET(0x8A87960)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONEND_OFFSET UNITYSDK_OFFSET(0x8A86F10)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONRESET_OFFSET UNITYSDK_OFFSET(0x8A87CC0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONSTART_OFFSET UNITYSDK_OFFSET(0x8A86940)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x8A86D80)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_RECEIVEDEVENT_1_OFFSET UNITYSDK_OFFSET(0x8A87300)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_RECEIVEDEVENT_2_OFFSET UNITYSDK_OFFSET(0x8A87480)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_RECEIVEDEVENT_3_OFFSET UNITYSDK_OFFSET(0x8A876A0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT_RECEIVEDEVENT_OFFSET UNITYSDK_OFFSET(0x8A87290)
#define MOLEMOLE_NAPHASRECEIVEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x8A87D40)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONBEHAVIORCOMPLETE_OFFSET UNITYSDK_OFFSET(0x8A87DA0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONEND_OFFSET UNITYSDK_OFFSET(0x8A87E30)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x8A87EC0)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONSTART_OFFSET UNITYSDK_OFFSET(0x8A87F50)
#define MOLEMOLE_NAPHASRECEIVEDEVENT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x8A87FE0)

namespace MoleMole
{
	inline static constexpr unsigned int NapHasReceivedEvent_TypeDefinitionIndex = 61107;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedVariable* storedValue3; // 0x80
		::System::Double lastReceivedTime; // 0x88
		::System::Boolean registered; // 0x90
		::System::Boolean eventReceived; // 0x91
