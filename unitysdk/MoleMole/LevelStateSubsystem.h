...
#define MOLEMOLE_LEVELSTATESUBSYSTEM_GETLEVELSTATE_OFFSET UNITYSDK_OFFSET(0x8F86970)
#define MOLEMOLE_LEVELSTATESUBSYSTEM_REGISTERONLEVELSTAGECHANGED_OFFSET UNITYSDK_OFFSET(0x8F86AC0)
#define MOLEMOLE_LEVELSTATESUBSYSTEM_UNREGISTERONLEVELSTAGECHANGED_OFFSET UNITYSDK_OFFSET(0x8F86B70)
#define MOLEMOLE_LEVELSTATESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x8F86C20)

namespace MoleMole
{
	inline static constexpr unsigned int LevelStateSubsystem_TypeDefinitionIndex = 77522;
