...
class Class_2_8127D35606966C67_27;
namespace MoleMole { class UICommentInfoGoodsRowWidgetContext; }
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UICOMMENTINFOGOODSROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD0397B0)
#define MOLEMOLE_UICOMMENTINFOGOODSROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD039850)
#define MOLEMOLE_UICOMMENTINFOGOODSROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD039530)
#define MOLEMOLE_UICOMMENTINFOGOODSROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD0395D0)
#define MOLEMOLE_UICOMMENTINFOGOODSROWWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0xD0396F0)
#define MOLEMOLE_UICOMMENTINFOGOODSROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD039930)
#define MOLEMOLE_UICOMMENTINFOGOODSROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD039960)
#define MOLEMOLE_UICOMMENTINFOGOODSROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD0399D0)
#define MOLEMOLE_UICOMMENTINFOGOODSROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD039A50)
#define MOLEMOLE_UICOMMENTINFOGOODSROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD039AB0)

namespace MoleMole
{
	inline static constexpr unsigned int UICommentInfoGoodsRowWidgetController_TypeDefinitionIndex = 63888;

	class UICommentInfoGoodsRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_8127D35606966C67_27* _view; // 0x2A0
