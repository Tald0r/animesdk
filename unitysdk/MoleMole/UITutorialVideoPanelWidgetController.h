...
#define MOLEMOLE_UITUTORIALVIDEOPANELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xEE45820)
#define MOLEMOLE_UITUTORIALVIDEOPANELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xEE458C0)
#define MOLEMOLE_UITUTORIALVIDEOPANELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xEE45590)
#define MOLEMOLE_UITUTORIALVIDEOPANELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xEE45770)
#define MOLEMOLE_UITUTORIALVIDEOPANELWIDGETCONTROLLER_PLAYVIDEOBYNAME_OFFSET UNITYSDK_OFFSET(0xEE45A30)
#define MOLEMOLE_UITUTORIALVIDEOPANELWIDGETCONTROLLER_PLAYVIDEOINNER_OFFSET UNITYSDK_OFFSET(0xEE45B60)
#define MOLEMOLE_UITUTORIALVIDEOPANELWIDGETCONTROLLER_SWITCHPLAYVIDEO_OFFSET UNITYSDK_OFFSET(0xEE45D50)
#define MOLEMOLE_UITUTORIALVIDEOPANELWIDGETCONTROLLER_SWTICHIMG_OFFSET UNITYSDK_OFFSET(0xEE45E40)
#define MOLEMOLE_UITUTORIALVIDEOPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xEE45F80)
#define MOLEMOLE_UITUTORIALVIDEOPANELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xEE45FB0)
#define MOLEMOLE_UITUTORIALVIDEOPANELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xEE46020)
#define MOLEMOLE_UITUTORIALVIDEOPANELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xEE460A0)
#define MOLEMOLE_UITUTORIALVIDEOPANELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xEE46100)

namespace MoleMole
{
	inline static constexpr unsigned int UITutorialVideoPanelWidgetController_TypeDefinitionIndex = 68973;
