...
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0xA9B7730)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER_GET_CURMONSTER_OFFSET UNITYSDK_OFFSET(0xA9B7670)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA9B78F0)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAD46230)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA9B7A70)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA9B7990)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA9B7680)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER_REFRESHCARDIMG_OFFSET UNITYSDK_OFFSET(0xAD467F0)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER_REFRESHEMPTYSTATE_OFFSET UNITYSDK_OFFSET(0xAD46410)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAD465F0)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER_SETCLICKENABLE_OFFSET UNITYSDK_OFFSET(0xAD46300)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER_USELOCKUI_OFFSET UNITYSDK_OFFSET(0xAD46D70)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD472E0)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER__UPDATEWEAKS_OFFSET UNITYSDK_OFFSET(0xAD46F30)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER__UPDATEWEAK_OFFSET UNITYSDK_OFFSET(0xAD470F0)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD472F0)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAD47360)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAD473D0)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD47450)
#define MOLEMOLE_UIHADALZONE_MONSTERCARDINFO_ROW_V2_WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD474D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_MonsterCardInfo_Row_V2_WidgetController_TypeDefinitionIndex = 71105;

	class UIHadalZone_MonsterCardInfo_Row_V2_WidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_136* _view; // 0x2D0
