...
#define MOLEMOLE_UIARCADEFRIENDINVITECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB738A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeFriendInviteContext_TypeDefinitionIndex = 53793;
