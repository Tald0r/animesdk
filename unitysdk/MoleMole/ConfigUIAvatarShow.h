...
#define MOLEMOLE_CONFIGUIAVATARSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xE454D60)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAvatarShow_TypeDefinitionIndex = 75482;
