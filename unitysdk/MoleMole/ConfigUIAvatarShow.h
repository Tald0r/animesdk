...
#define MOLEMOLE_CONFIGUIAVATARSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xD7DB940)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIAvatarShow_TypeDefinitionIndex = 62084;
