...
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_CLEARTIMEOUTCALLBACK_OFFSET UNITYSDK_OFFSET(0xBD1D650)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_CLOSETIMER_OFFSET UNITYSDK_OFFSET(0xBD1DF30)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_COUNTDOWNUI_CHANGETIMEWIDGET_OFFSET UNITYSDK_OFFSET(0xBD1E240)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xBD1CFE0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD1CFF0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBD1D310)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD1D380)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD1D090)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD1D100)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_OPENTIMER_OFFSET UNITYSDK_OFFSET(0xBD1DC30)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_PAUSE_OFFSET UNITYSDK_OFFSET(0xBD1E170)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_SETTIMEOUTCALLBACK_OFFSET UNITYSDK_OFFSET(0xBD1D5E0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_SHOWBONUSTIME_OFFSET UNITYSDK_OFFSET(0xBD1E3B0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_TICKTIMER_OFFSET UNITYSDK_OFFSET(0xBD1D490)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_UPDATEFIXEDTEXT_OFFSET UNITYSDK_OFFSET(0xBD1E0B0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_UPDATETIMER_OFFSET UNITYSDK_OFFSET(0xBD1DA60)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBD1D410)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBD1E5C0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER__EASEADDTIME_OFFSET UNITYSDK_OFFSET(0xBD1E300)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER__GETTIMER_OFFSET UNITYSDK_OFFSET(0xBD1D6C0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER__TRYCORETIMER_OFFSET UNITYSDK_OFFSET(0xBD1D970)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD1E6C0)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBD1E730)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD1E740)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD1E750)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD1E760)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___GETTIMER_B__15_0_OFFSET UNITYSDK_OFFSET(0xBD1E600)
#define MOLEMOLE_UIINLEVELCOUNTDOWNUICHILDWINDOWCONTROLLER___GETTIMER_B__15_1_OFFSET UNITYSDK_OFFSET(0xBD1E660)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelCountDownUIChildWindowController_TypeDefinitionIndex = 39680;
	...
	public:
		...
		::Class_0_16E4307DCC419505_210* _rowContainer; // 0x2F8
		...
		::Class_2_9760011945436DFC_1* _view; // 0x320
