...
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER_GETTRICKSCORECONTROLLER_OFFSET UNITYSDK_OFFSET(0xCAA1590)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER_GETTRICKSCOREROWCONTROLLER_OFFSET UNITYSDK_OFFSET(0xCAA1780)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xCA9F180)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER_INITSIZE_OFFSET UNITYSDK_OFFSET(0xCA9F410)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA9F190)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCA9FBB0)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA9FE60)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA9F230)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER_REFRESHAVATAR_OFFSET UNITYSDK_OFFSET(0xCA9FEF0)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER_REFRESHDURATION_OFFSET UNITYSDK_OFFSET(0xCAA0A60)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER_REFRESHRECORD_OFFSET UNITYSDK_OFFSET(0xCA9FC90)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER_REFRESHTRICKLEVELSCORE_OFFSET UNITYSDK_OFFSET(0xCAA0EA0)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER_REFRESHTRICKSCORE_OFFSET UNITYSDK_OFFSET(0xCAA0410)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCAA1970)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0xCAA1C00)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCAA1C10)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCAA1C80)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCAA1C90)
#define MOLEMOLE_UIBABELTOWERINLEVELPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCAA1CA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerInLevelPageController_TypeDefinitionIndex = 49896;
