...
#define MOLEMOLE_CAMERACHANGETYPE_INSTANCE_CAMERACHANGETYPE_INSTANCE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCD90EE0)
#define MOLEMOLE_CAMERACHANGETYPE_INSTANCE_CAMERACHANGETYPE_INSTANCE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCD90EF0)
#define MOLEMOLE_CAMERACHANGETYPE_INSTANCE_CAMERACHANGETYPE_INSTANCE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCD90F80)
#define MOLEMOLE_CAMERACHANGETYPE_INSTANCE_CAMERACHANGETYPE_INSTANCE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD90FF0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraChangeType_Instance_CameraChangeType_Instance_UnityGeneratedFormatter_TypeDefinitionIndex = 58404;
