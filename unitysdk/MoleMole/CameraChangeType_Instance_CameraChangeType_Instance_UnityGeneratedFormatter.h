...
#define MOLEMOLE_CAMERACHANGETYPE_INSTANCE_CAMERACHANGETYPE_INSTANCE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xB8FD260)
#define MOLEMOLE_CAMERACHANGETYPE_INSTANCE_CAMERACHANGETYPE_INSTANCE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xB8FD270)
#define MOLEMOLE_CAMERACHANGETYPE_INSTANCE_CAMERACHANGETYPE_INSTANCE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xB8FD300)
#define MOLEMOLE_CAMERACHANGETYPE_INSTANCE_CAMERACHANGETYPE_INSTANCE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB8FD370)

namespace MoleMole
{
	inline static constexpr unsigned int CameraChangeType_Instance_CameraChangeType_Instance_UnityGeneratedFormatter_TypeDefinitionIndex = 56139;
