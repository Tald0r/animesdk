...
#define MOLEMOLE_UICPSCORETIPSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A99F400)

namespace MoleMole
{
	inline static constexpr unsigned int UICpScoreTipScript_TypeDefinitionIndex = 81435;
