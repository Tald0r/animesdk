...
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE_GETPREDICATEFLOAT_OFFSET UNITYSDK_OFFSET(0xE38CBD0)
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE_PREDICATE_OFFSET UNITYSDK_OFFSET(0xE38CA60)
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xE38CC30)
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE___BASE_PREDICATE_OFFSET UNITYSDK_OFFSET(0xE38CC90)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingGradingPredicateBase_TypeDefinitionIndex = 64205;
