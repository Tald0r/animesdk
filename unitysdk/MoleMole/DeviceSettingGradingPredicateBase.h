...
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE_GETPREDICATEFLOAT_OFFSET UNITYSDK_OFFSET(0xCD33CF0)
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE_PREDICATE_OFFSET UNITYSDK_OFFSET(0xCD33B80)
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD33D50)
#define MOLEMOLE_DEVICESETTINGGRADINGPREDICATEBASE___BASE_PREDICATE_OFFSET UNITYSDK_OFFSET(0xCD33DB0)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingGradingPredicateBase_TypeDefinitionIndex = 50203;
