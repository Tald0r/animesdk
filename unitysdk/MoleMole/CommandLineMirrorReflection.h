...
#define MOLEMOLE_COMMANDLINEMIRRORREFLECTION_METHOD_2_2362E43632123EB3_OFFSET UNITYSDK_OFFSET(0x622A6A0)
#define MOLEMOLE_COMMANDLINEMIRRORREFLECTION_METHOD_2_D50F0DD8B88045FF_OFFSET UNITYSDK_OFFSET(0x622A810)
#define MOLEMOLE_COMMANDLINEMIRRORREFLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x622A7D0)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineMirrorReflection_TypeDefinitionIndex = 52015;
