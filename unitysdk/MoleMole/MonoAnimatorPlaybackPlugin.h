...
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_AWAKE_OFFSET UNITYSDK_OFFSET(0x8F8B9C0)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x8F8CAA0)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8F8BB00)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x8F8C960)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_PLAYANDMUTEINTERACT_OFFSET UNITYSDK_OFFSET(0x8F8CB20)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_PLAYBACKWARD_OFFSET UNITYSDK_OFFSET(0x8F8C690)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_PLAYFORWARD_OFFSET UNITYSDK_OFFSET(0x8F8BE30)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_PLAYSOUND_OFFSET UNITYSDK_OFFSET(0x8F8C000)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_SETANIMTOFINISH_OFFSET UNITYSDK_OFFSET(0x8F8C860)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_SETDATA_OFFSET UNITYSDK_OFFSET(0x8F8BCD0)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_STARTFROMTIME_OFFSET UNITYSDK_OFFSET(0x8F8BD70)
#define MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x8F8CD20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoAnimatorPlaybackPlugin_TypeDefinitionIndex = 45930;
	...
	public:
		...
		::Class_3_0683A56451C2D19E* cachedComponent; // 0x58
		...
		::System::Void PlayAndMuteInteract(::System::Boolean a1, ::Class_3_0683A56451C2D19E* a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::Class_3_0683A56451C2D19E*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOANIMATORPLAYBACKPLUGIN_PLAYANDMUTEINTERACT_OFFSET))(this, a1, a2);
		}
