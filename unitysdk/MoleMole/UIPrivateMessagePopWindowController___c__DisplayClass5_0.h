...
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAB832E0)
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__REFRESHCONTACTFORSETTINGTOP_B__0_OFFSET UNITYSDK_OFFSET(0xAB832F0)
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__REFRESHCONTACTFORSETTINGTOP_B__2_OFFSET UNITYSDK_OFFSET(0xAB83920)
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__REFRESHCONTACTFORSETTINGTOP_B__3_OFFSET UNITYSDK_OFFSET(0xAB839B0)
#define MOLEMOLE_UIPRIVATEMESSAGEPOPWINDOWCONTROLLER___C__DISPLAYCLASS5_0__REFRESHCONTACTFORSETTINGTOP_G__SELECTTARGET_1_OFFSET UNITYSDK_OFFSET(0xAB836B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPrivateMessagePopWindowController___c__DisplayClass5_0_TypeDefinitionIndex = 73473;
