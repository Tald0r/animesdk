...
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD4F70)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuickSelectPopWindowContext_TypeDefinitionIndex = 74456;
