...
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBE8AED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuickSelectPopWindowContext_TypeDefinitionIndex = 67918;
