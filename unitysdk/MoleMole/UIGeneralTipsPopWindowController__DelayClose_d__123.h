...
#define MOLEMOLE_UIGENERALTIPSPOPWINDOWCONTROLLER__DELAYCLOSE_D__123_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xAC700F0)
#define MOLEMOLE_UIGENERALTIPSPOPWINDOWCONTROLLER__DELAYCLOSE_D__123_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAC70210)
#define MOLEMOLE_UIGENERALTIPSPOPWINDOWCONTROLLER__DELAYCLOSE_D__123_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAC70270)
#define MOLEMOLE_UIGENERALTIPSPOPWINDOWCONTROLLER__DELAYCLOSE_D__123_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xAC70220)
#define MOLEMOLE_UIGENERALTIPSPOPWINDOWCONTROLLER__DELAYCLOSE_D__123_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAC700E0)
#define MOLEMOLE_UIGENERALTIPSPOPWINDOWCONTROLLER__DELAYCLOSE_D__123__CTOR_OFFSET UNITYSDK_OFFSET(0xAC700D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTipsPopWindowController__DelayClose_d__123_TypeDefinitionIndex = 74347;
