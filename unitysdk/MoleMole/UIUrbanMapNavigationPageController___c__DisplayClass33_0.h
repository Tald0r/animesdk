...
#define MOLEMOLE_UIURBANMAPNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS33_0__CTOR_OFFSET UNITYSDK_OFFSET(0x971C800)
#define MOLEMOLE_UIURBANMAPNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS33_0__ONSKIPFADEINANIMATION_B__0_OFFSET UNITYSDK_OFFSET(0x971C810)
#define MOLEMOLE_UIURBANMAPNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS33_0__ONSKIPFADEINANIMATION_B__1_OFFSET UNITYSDK_OFFSET(0x971DFB0)
#define MOLEMOLE_UIURBANMAPNAVIGATIONPAGECONTROLLER___C__DISPLAYCLASS33_0__ONSKIPFADEINANIMATION_G__TRYSTARTNAVIGATIONPAGEFADEIN_2_OFFSET UNITYSDK_OFFSET(0x971C820)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapNavigationPageController___c__DisplayClass33_0_TypeDefinitionIndex = 38867;
