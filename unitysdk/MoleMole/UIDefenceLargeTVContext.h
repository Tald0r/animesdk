...
#define MOLEMOLE_UIDEFENCELARGETVCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x95DD4E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDefenceLargeTVContext_TypeDefinitionIndex = 68170;
