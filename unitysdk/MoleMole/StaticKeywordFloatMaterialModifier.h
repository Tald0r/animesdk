...
#define MOLEMOLE_STATICKEYWORDFLOATMATERIALMODIFIER_METHOD_2_3750F4A9FEA7F5EF_OFFSET UNITYSDK_OFFSET(0x397990)
#define MOLEMOLE_STATICKEYWORDFLOATMATERIALMODIFIER_METHOD_2_C446CE6A5E1982BC_OFFSET UNITYSDK_OFFSET(0x397A10)
#define MOLEMOLE_STATICKEYWORDFLOATMATERIALMODIFIER_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x3979A0)
#define MOLEMOLE_STATICKEYWORDFLOATMATERIALMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x397930)

namespace MoleMole
{
	inline static constexpr unsigned int StaticKeywordFloatMaterialModifier_TypeDefinitionIndex = 54237;
	...
	struct alignas(8) StaticKeywordFloatMaterialModifier
	{
		...
		{
			return ((::Class_1_A0B58236B258B7B2*(*)(::PVOID, ::Enum_3_8855AD768EB2675C, ::MoleMole::MonoRenderHandler*))((::PBYTE)hIl2Cpp + MOLEMOLE_STATICKEYWORDFLOATMATERIALMODIFIER_METHOD_2_3750F4A9FEA7F5EF_OFFSET))(this, a1, a2);
		}
