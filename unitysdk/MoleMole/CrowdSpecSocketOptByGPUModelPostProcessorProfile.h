...
#define MOLEMOLE_CROWDSPECSOCKETOPTBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6E065A0)
#define MOLEMOLE_CROWDSPECSOCKETOPTBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E06630)
#define MOLEMOLE_CROWDSPECSOCKETOPTBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x6E066A0)

namespace MoleMole
{
	inline static constexpr unsigned int CrowdSpecSocketOptByGPUModelPostProcessorProfile_TypeDefinitionIndex = 45132;
