...
#define MOLEMOLE_CROWDSPECSOCKETOPTBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0xC2558E0)
#define MOLEMOLE_CROWDSPECSOCKETOPTBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xC255970)
#define MOLEMOLE_CROWDSPECSOCKETOPTBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0xC2559D0)

namespace MoleMole
{
	inline static constexpr unsigned int CrowdSpecSocketOptByGPUModelPostProcessorProfile_TypeDefinitionIndex = 54922;
