...
#define MOLEMOLE_UIBPPURCHASEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0xDDA18B0)
#define MOLEMOLE_UIBPPURCHASEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__SHOWNONEPURCHASEBPSHOP_B__0_OFFSET UNITYSDK_OFFSET(0xDDA18C0)
#define MOLEMOLE_UIBPPURCHASEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__SHOWNONEPURCHASEBPSHOP_B__1_OFFSET UNITYSDK_OFFSET(0xDDA1980)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPPurchaseDialogPopWindowController___c__DisplayClass23_0_TypeDefinitionIndex = 51330;
