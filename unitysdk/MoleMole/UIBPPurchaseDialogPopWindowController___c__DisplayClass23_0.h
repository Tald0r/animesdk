...
#define MOLEMOLE_UIBPPURCHASEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB5FBBB0)
#define MOLEMOLE_UIBPPURCHASEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__SHOWNONEPURCHASEBPSHOP_B__0_OFFSET UNITYSDK_OFFSET(0xB5FBBC0)
#define MOLEMOLE_UIBPPURCHASEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__SHOWNONEPURCHASEBPSHOP_B__1_OFFSET UNITYSDK_OFFSET(0xB5FBC80)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPPurchaseDialogPopWindowController___c__DisplayClass23_0_TypeDefinitionIndex = 78692;
	...
	public:
		...
		::Class_1_D12E4BF61CBE42EF* advanceItem; // 0x20
