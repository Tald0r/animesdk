...
#define MOLEMOLE_UIEQUIPDEVELOPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA95FB00)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDevelopContext_TypeDefinitionIndex = 38654;
