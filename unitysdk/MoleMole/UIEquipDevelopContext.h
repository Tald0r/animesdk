...
#define MOLEMOLE_UIEQUIPDEVELOPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBEEF860)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDevelopContext_TypeDefinitionIndex = 64258;
	...
	public:
		...
		::Enum_3_B9002106B360C669 Type; // 0x38
		::System::Int32 CloseIndex; // 0x3C
		::System::Boolean CloseOpenDialog; // 0x40
