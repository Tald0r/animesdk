...
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x830AA60)
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER_CURRENTBOUNDVALID_OFFSET UNITYSDK_OFFSET(0x830B050)
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER_ISINCURRENTBOUND_OFFSET UNITYSDK_OFFSET(0x830B0B0)
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x830B150)
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER_START_OFFSET UNITYSDK_OFFSET(0x830AAD0)
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER_UPDATECURRENTBOUND_OFFSET UNITYSDK_OFFSET(0x830AE50)
#define MOLEMOLE_MONOSTAGEAREABVSMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x830B1C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoStageAreaBVSManager_TypeDefinitionIndex = 56614;
	...
	public:
		...
		{
			return (::MoleMole::MonoStageAreaBVSManager**)Il2CppClass::FromTypeDefinitionIndex(MonoStageAreaBVSManager_TypeDefinitionIndex)->GetStaticField(0x3C1F0);
		}
