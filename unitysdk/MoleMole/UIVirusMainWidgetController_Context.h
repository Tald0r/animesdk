...
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x95B1230)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusMainWidgetController_Context_TypeDefinitionIndex = 48843;
