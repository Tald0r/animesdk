...
#define MOLEMOLE_UIURBANMAPAREASTREETPOINTWIDGETCONTEXT_GETTITLEICON_OFFSET UNITYSDK_OFFSET(0x880F270)
#define MOLEMOLE_UIURBANMAPAREASTREETPOINTWIDGETCONTEXT_GETTITLEKEY_OFFSET UNITYSDK_OFFSET(0x880F2F0)
#define MOLEMOLE_UIURBANMAPAREASTREETPOINTWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x880F230)
#define MOLEMOLE_UIURBANMAPAREASTREETPOINTWIDGETCONTEXT___BASE_GETTITLEICON_OFFSET UNITYSDK_OFFSET(0x880F470)
#define MOLEMOLE_UIURBANMAPAREASTREETPOINTWIDGETCONTEXT___BASE_GETTITLEKEY_OFFSET UNITYSDK_OFFSET(0x880F4A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapAreaStreetPointWidgetContext_TypeDefinitionIndex = 40765;

	class UIUrbanMapAreaStreetPointWidgetContext : public ::MoleMole::UIUrbanMapPointWidgetContext
	{
	public:
		::Class_1_3C29F96DEFD2E870* AreaStreetData; // 0x50
