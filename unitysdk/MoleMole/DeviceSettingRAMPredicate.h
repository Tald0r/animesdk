...
#define MOLEMOLE_DEVICESETTINGRAMPREDICATE_GETPREDICATEFLOAT_OFFSET UNITYSDK_OFFSET(0x13FB0460)
#define MOLEMOLE_DEVICESETTINGRAMPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x13FB04D0)
#define MOLEMOLE_DEVICESETTINGRAMPREDICATE___BASE_GETPREDICATEFLOAT_OFFSET UNITYSDK_OFFSET(0x13FB0530)

namespace MoleMole
{
	inline static constexpr unsigned int DeviceSettingRAMPredicate_TypeDefinitionIndex = 48410;
