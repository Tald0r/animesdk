...
#define MOLEMOLE_UIAVATARLIGHTCHANGESETTINGS_UIAVATARLIGHTCHANGESETTINGS_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xA51AC80)
#define MOLEMOLE_UIAVATARLIGHTCHANGESETTINGS_UIAVATARLIGHTCHANGESETTINGS_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xA51AC90)
#define MOLEMOLE_UIAVATARLIGHTCHANGESETTINGS_UIAVATARLIGHTCHANGESETTINGS_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xA51AF20)
#define MOLEMOLE_UIAVATARLIGHTCHANGESETTINGS_UIAVATARLIGHTCHANGESETTINGS_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA51B130)
#define MOLEMOLE_UIAVATARLIGHTCHANGESETTINGS_UIAVATARLIGHTCHANGESETTINGS_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA51B0D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarLightChangeSettings_UIAvatarLightChangeSettings_UnityGeneratedFormatter_TypeDefinitionIndex = 66269;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIAvatarLightChangeSettings_UIAvatarLightChangeSettings_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x435B0);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::EAvatarLightChangeType>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::EAvatarLightChangeType>**)Il2CppClass::FromTypeDefinitionIndex(UIAvatarLightChangeSettings_UIAvatarLightChangeSettings_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x435B8);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Single>** StaticGet_CachedSerializer2()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(UIAvatarLightChangeSettings_UIAvatarLightChangeSettings_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x435C0);
		}
