...
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER_DOSKIP_OFFSET UNITYSDK_OFFSET(0xB6A4A90)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xB6A3C60)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6A4C50)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER_ONTIMELINEENDHANDLE_OFFSET UNITYSDK_OFFSET(0xB6A4B60)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB6A4930)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6A4CF0)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6A3C70)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB6A3CE0)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB6A4170)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER_SETTIMELINEENDHANDLE_OFFSET UNITYSDK_OFFSET(0xB6A4BE0)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB6A4D80)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6A4DF0)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xB6A4E60)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6A4E70)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6A4E80)
#define MOLEMOLE_UIMAINSTORYCHAPTER3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB6A4E90)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryChapter3DModelController_TypeDefinitionIndex = 52958;

	class UIMainStoryChapter3DModelController : public ::MoleMole::UIBase3DModelController
	{
	public:
		::Class_2_5DF031D85FFEFBF9* _view; // 0x340
		::System::Int32 _chapterPerformID; // 0x348
		::Class_2_208CC9941471731A_556* _chapterPerformCfg; // 0x350
