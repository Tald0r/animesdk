...
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_AFTERREFRESHBUFF_OFFSET UNITYSDK_OFFSET(0xD254210)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CALCULATESELECTTYPE_OFFSET UNITYSDK_OFFSET(0xD256940)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CANCELSCROLLVIEWSELECT_OFFSET UNITYSDK_OFFSET(0xD258180)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CHECKSAFEDELAY_OFFSET UNITYSDK_OFFSET(0xD255330)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CLICKBUDDY_OFFSET UNITYSDK_OFFSET(0xD24F810)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CLICKROLE_OFFSET UNITYSDK_OFFSET(0xD24F3D0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_EXCHANGEBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xD257DF0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GENERALROLECARDCLICK_OFFSET UNITYSDK_OFFSET(0xD24E6E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GETAVATARSELECTTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xD258DF0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GETCURRENTTEMPLATE_OFFSET UNITYSDK_OFFSET(0xD251A80)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GETREWARDINFODATALIST_OFFSET UNITYSDK_OFFSET(0xD257E70)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GET_DATALOGIC_OFFSET UNITYSDK_OFFSET(0xD24E310)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_INITBUDDY_OFFSET UNITYSDK_OFFSET(0xD255800)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_INITPOOLDATA_OFFSET UNITYSDK_OFFSET(0xD254270)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_INITREWARD_OFFSET UNITYSDK_OFFSET(0xD253E30)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONCARDSET_OFFSET UNITYSDK_OFFSET(0xD2508A0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONCLEARINTERACT_OFFSET UNITYSDK_OFFSET(0xD256C60)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD251E50)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD24E330)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONGO_OFFSET UNITYSDK_OFFSET(0xD255A10)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONMULTISELECTBUDDY_OFFSET UNITYSDK_OFFSET(0xD256ED0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD2541B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONPOSTSETROLECARDDATA_OFFSET UNITYSDK_OFFSET(0xD257CA0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONREWARDINFOCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xD2583E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONSELECTAVATAR_OFFSET UNITYSDK_OFFSET(0xD2572B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD251EF0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD24E570)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD24F950)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENBANGBOO_OFFSET UNITYSDK_OFFSET(0xD24EFA0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENBUFF_OFFSET UNITYSDK_OFFSET(0xD2507E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENDETAILDIALOG_OFFSET UNITYSDK_OFFSET(0xD251C20)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENMONSTER_OFFSET UNITYSDK_OFFSET(0xD251870)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENPOOLROLESELECT_OFFSET UNITYSDK_OFFSET(0xD24E7C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENROLEDETAIL_OFFSET UNITYSDK_OFFSET(0xD250EB0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REALFLOORINDEXTOINDEX_OFFSET UNITYSDK_OFFSET(0xD251B90)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHBOSS_OFFSET UNITYSDK_OFFSET(0xD2525A0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHBUFFSTATE_OFFSET UNITYSDK_OFFSET(0xD250AD0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHBUFF_OFFSET UNITYSDK_OFFSET(0xD253630)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0xD253000)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHRANKING_OFFSET UNITYSDK_OFFSET(0xD2553A0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHRESETBTNSTATE_OFFSET UNITYSDK_OFFSET(0xD252110)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD252390)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REQBABELTOWERBEGINFIGHT_OFFSET UNITYSDK_OFFSET(0xD256DC0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_RESETAVATAR_OFFSET UNITYSDK_OFFSET(0xD251FD0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_RESETPOOL_OFFSET UNITYSDK_OFFSET(0xD252040)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_SETBEFOREENTERACTION_OFFSET UNITYSDK_OFFSET(0xD252320)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_SETBUFFSELECTBTNSTATE_OFFSET UNITYSDK_OFFSET(0xD250680)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_SETCARDSETBUFF_OFFSET UNITYSDK_OFFSET(0xD250970)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_SET_DATALOGIC_OFFSET UNITYSDK_OFFSET(0xD24E320)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_TRIGGERNEWBIE_OFFSET UNITYSDK_OFFSET(0xD250C30)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEAVATARSELECTVIEW_OFFSET UNITYSDK_OFFSET(0xD257C10)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEFLOORINDEX_OFFSET UNITYSDK_OFFSET(0xD2513D0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEPOOLAVARTAR_OFFSET UNITYSDK_OFFSET(0xD254680)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEROOMRECOMMANDBYINDEX_OFFSET UNITYSDK_OFFSET(0xD258AF0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEROOMRECOMMAND_OFFSET UNITYSDK_OFFSET(0xD252E10)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEROOMRESISTBYINDEX_OFFSET UNITYSDK_OFFSET(0xD2587F0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEROOMRESIST_OFFSET UNITYSDK_OFFSET(0xD252C20)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD2505F0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD258E80)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__ONGO_OFFSET UNITYSDK_OFFSET(0xD256260)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__ONUIINIT_B__19_0_OFFSET UNITYSDK_OFFSET(0xD2590C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__ONUIOPEN_B__21_0_OFFSET UNITYSDK_OFFSET(0xD259140)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__REFRESHRANKING_G__REFRESHRANKIMAGE_47_0_OFFSET UNITYSDK_OFFSET(0xD255720)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET UNITYSDK_OFFSET(0xD258750)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD2594A0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xD259570)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD259630)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD259510)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD2596B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___ONGO_B__51_0_OFFSET UNITYSDK_OFFSET(0xD259280)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerFightingInfoWidgetController_TypeDefinitionIndex = 65875;
	...
	public:
		...
		::Class_2_60638234271CCDB8_34* _view; // 0x2A8
		...
		::System::Void ReqBabelTowerBeginFight(::System::Int32 towerid, ::System::UInt32 floorIndex, ::System::Int32 buddy, ::System::Collections::Generic::List_1<::System::Int32>* selectAvatars, ::System::Collections::Generic::List_1<::System::Int32>* poolAvatars, ::System::Collections::Generic::List_1<::System::Int32>* buddyList, ::System::Boolean isContinue, ::System::Int32 selectBuf, ::System::Action_2<::System::Boolean, ::Class_3_025FF4981524A424_471*>* overrideCallback)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::UInt32, ::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*, ::System::Collections::Generic::List_1<::System::Int32>*, ::System::Collections::Generic::List_1<::System::Int32>*, ::System::Boolean, ::System::Int32, ::System::Action_2<::System::Boolean, ::Class_3_025FF4981524A424_471*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REQBABELTOWERBEGINFIGHT_OFFSET))(this, towerid, floorIndex, buddy, selectAvatars, poolAvatars, buddyList, isContinue, selectBuf, overrideCallback);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_300*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET))(this, cardConfigTemplate);
		}
		...
		::System::Void __OnGo_b__51_0(::System::Boolean s, ::Class_3_025FF4981524A424_471* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::Class_3_025FF4981524A424_471*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___ONGO_B__51_0_OFFSET))(this, s, rsp);
		}
