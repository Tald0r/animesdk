...
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_AFTERREFRESHBUFF_OFFSET UNITYSDK_OFFSET(0xA251770)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CALCULATESELECTTYPE_OFFSET UNITYSDK_OFFSET(0xA253E70)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CANCELSCROLLVIEWSELECT_OFFSET UNITYSDK_OFFSET(0xA2556C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CHECKSAFEDELAY_OFFSET UNITYSDK_OFFSET(0xA252870)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CLICKBUDDY_OFFSET UNITYSDK_OFFSET(0xA24CDA0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_CLICKROLE_OFFSET UNITYSDK_OFFSET(0xA24C960)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_EXCHANGEBTNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xA255330)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GENERALROLECARDCLICK_OFFSET UNITYSDK_OFFSET(0xA24BC70)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GETAVATARSELECTTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xA2568B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GETCURRENTTEMPLATE_OFFSET UNITYSDK_OFFSET(0xA24EFF0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GETREWARDINFODATALIST_OFFSET UNITYSDK_OFFSET(0xA2553B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_GET_DATALOGIC_OFFSET UNITYSDK_OFFSET(0xA24B8B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_INITBUDDY_OFFSET UNITYSDK_OFFSET(0xA252D40)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_INITPOOLDATA_OFFSET UNITYSDK_OFFSET(0xA2517D0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_INITREWARD_OFFSET UNITYSDK_OFFSET(0xA251390)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONCARDSET_OFFSET UNITYSDK_OFFSET(0xA24DE10)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONCLEARINTERACT_OFFSET UNITYSDK_OFFSET(0xA254190)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA24F3C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA24B8D0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONGO_OFFSET UNITYSDK_OFFSET(0xA252F50)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONMULTISELECTBUDDY_OFFSET UNITYSDK_OFFSET(0xA254400)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONPOSTREFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA251710)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONPOSTSETROLECARDDATA_OFFSET UNITYSDK_OFFSET(0xA2551E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONREWARDINFOCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xA255920)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONSELECTAVATAR_OFFSET UNITYSDK_OFFSET(0xA2547F0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA24F460)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA24BB10)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA24CEE0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENBANGBOO_OFFSET UNITYSDK_OFFSET(0xA24C530)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENBUFF_OFFSET UNITYSDK_OFFSET(0xA24DD50)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENDETAILDIALOG_OFFSET UNITYSDK_OFFSET(0xA24F190)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENMONSTER_OFFSET UNITYSDK_OFFSET(0xA24EDE0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENPOOLROLESELECT_OFFSET UNITYSDK_OFFSET(0xA24BD50)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_OPENROLEDETAIL_OFFSET UNITYSDK_OFFSET(0xA24E420)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REALFLOORINDEXTOINDEX_OFFSET UNITYSDK_OFFSET(0xA24F100)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHBOSS_OFFSET UNITYSDK_OFFSET(0xA24FB10)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHBUFFSTATE_OFFSET UNITYSDK_OFFSET(0xA24E040)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHBUFF_OFFSET UNITYSDK_OFFSET(0xA250B80)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0xA250570)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHRANKING_OFFSET UNITYSDK_OFFSET(0xA2528E0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHRESETBTNSTATE_OFFSET UNITYSDK_OFFSET(0xA24F680)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA24F900)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REQBABELTOWERBEGINFIGHT_OFFSET UNITYSDK_OFFSET(0xA2542F0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_RESETAVATAR_OFFSET UNITYSDK_OFFSET(0xA24F540)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_RESETPOOL_OFFSET UNITYSDK_OFFSET(0xA24F5B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_SETBEFOREENTERACTION_OFFSET UNITYSDK_OFFSET(0xA24F890)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_SETBUFFSELECTBTNSTATE_OFFSET UNITYSDK_OFFSET(0xA24DBF0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_SETCARDSETBUFF_OFFSET UNITYSDK_OFFSET(0xA24DEE0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_SET_DATALOGIC_OFFSET UNITYSDK_OFFSET(0xA24B8C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_TRIGGERNEWBIE_OFFSET UNITYSDK_OFFSET(0xA24E1A0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEAVATARSELECTVIEW_OFFSET UNITYSDK_OFFSET(0xA255150)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEFLOORINDEX_OFFSET UNITYSDK_OFFSET(0xA24E940)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEPOOLAVARTAR_OFFSET UNITYSDK_OFFSET(0xA251BF0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEROOMRECOMMANDBYINDEX_OFFSET UNITYSDK_OFFSET(0xA2565B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEROOMRECOMMAND_OFFSET UNITYSDK_OFFSET(0xA250380)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEROOMRESISTBYINDEX_OFFSET UNITYSDK_OFFSET(0xA2562B0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATEROOMRESIST_OFFSET UNITYSDK_OFFSET(0xA250190)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA24DB60)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA256940)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__ONGO_OFFSET UNITYSDK_OFFSET(0xA253790)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__ONUIINIT_B__19_0_OFFSET UNITYSDK_OFFSET(0xA256B80)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__ONUIOPEN_B__21_0_OFFSET UNITYSDK_OFFSET(0xA256C00)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__REFRESHRANKING_G__REFRESHRANKIMAGE_47_0_OFFSET UNITYSDK_OFFSET(0xA252C60)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET UNITYSDK_OFFSET(0xA256210)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA256D50)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA256E20)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA256EE0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA256DC0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA256F60)
#define MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___ONGO_B__51_0_OFFSET UNITYSDK_OFFSET(0xA256D40)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerFightingInfoWidgetController_TypeDefinitionIndex = 53738;
	...
	public:
		...
		::System::Boolean DirectOpen; // 0x2A0
		::Class_2_60638234271CCDB8_50* _view; // 0x2A8
		::Class_2_08E43914789BE5F3* _babelTowerModel; // 0x2B0
		::Enum_3_1B538C1D42F00F85 state; // 0x2B8
		::Class_1_C6A4DECEE09618C7* towerData; // 0x2C0
		::System::Int32 selectBuddy; // 0x2C8
		::System::Collections::Generic::HashSet_1<::System::Int32>* emptyIndex; // 0x2D0
		::System::Collections::Generic::List_1<::System::Int32>* avatarIndex; // 0x2D8
		::System::Collections::Generic::List_1<::System::Int32>* buddyIndex; // 0x2E0
		::Class_1_F84327483F47ADE0* SelectData; // 0x2E8
		::MoleMole::UIGeneralBtn03WidgetController* ResetBtn; // 0x2F0
		::System::Int32 curSelectBuff; // 0x2F8
		::System::Single animTimer; // 0x2FC
		::Class_1_EFA6AA5AA832852E* _DataLogic_k__BackingField; // 0x300
		::System::Boolean _isListeningClear; // 0x308
		::System::Boolean isSending; // 0x309
		::System::Action* beforeAction; // 0x310
		::System::UInt32 currentFloor; // 0x318
		::System::Int32 towerid; // 0x31C
		::MoleMole::UIBabeltowerFightingInfoWidgetController_BabeltowerSelectType curType; // 0x320
		::MoleMole::Project::Config::BabelFloorInfoTemplateExt* floorTemplate; // 0x328
		::Il2CppArray<::System::Int32>* curAvatarList; // 0x330
		::System::Collections::Generic::List_1<::System::UInt32>* curPoolAvatarID; // 0x338
		::System::Collections::Generic::List_1<::System::UInt32>* originalPoolAvatarID; // 0x340
		::System::Collections::Generic::List_1<::MoleMole::UIGeneralRoleCardRowWidgetController_Context*>* curPoolAvatarDatas; // 0x348
		::Il2CppArray<::System::UInt32>* buddyLists; // 0x350
		::System::Collections::Generic::List_1<::System::UInt32>* curSelectAvatarID; // 0x358
		::Class_1_98DE5B0AA67D49FB* _buffShowConfig; // 0x360
		::MoleMole::UIGeneralBuffPanelWidgetController* _buffController; // 0x368
		::MoleMole::UIHollowResultBossInfoRow02WidgetController* monster1; // 0x370
		::MoleMole::UIHollowResultBossInfoRow02WidgetController* monster2; // 0x378
		...
		::System::Void ReqBabelTowerBeginFight(::System::Int32 towerid, ::System::UInt32 floorIndex, ::System::Int32 buddy, ::System::Collections::Generic::List_1<::System::Int32>* selectAvatars, ::System::Collections::Generic::List_1<::System::Int32>* poolAvatars, ::System::Collections::Generic::List_1<::System::Int32>* buddyList, ::System::Boolean isContinue, ::System::Int32 selectBuf, ::System::Action_2<::System::Boolean, ::Class_3_025FF4981524A424_488*>* overrideCallback)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::UInt32, ::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*, ::System::Collections::Generic::List_1<::System::Int32>*, ::System::Collections::Generic::List_1<::System::Int32>*, ::System::Boolean, ::System::Int32, ::System::Action_2<::System::Boolean, ::Class_3_025FF4981524A424_488*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER_REQBABELTOWERBEGINFIGHT_OFFSET))(this, towerid, floorIndex, buddy, selectAvatars, poolAvatars, buddyList, isContinue, selectBuf, overrideCallback);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_349*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__UPDATEBOSSIMAGE_OFFSET))(this, cardConfigTemplate);
		}
		...
		static ::System::Void _RefreshRanking_g__RefreshRankImage_47_0(::Class_2_A8F5ABF31E066ED4* image, ::MoleMole::MissionResult result, ::MoleMole::UIBabeltowerFightingInfoWidgetController___c__DisplayClass47_0& a3)
		{
			return ((::System::Void(*)(::Class_2_A8F5ABF31E066ED4*, ::MoleMole::MissionResult, ::MoleMole::UIBabeltowerFightingInfoWidgetController___c__DisplayClass47_0&))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER__REFRESHRANKING_G__REFRESHRANKIMAGE_47_0_OFFSET))(image, result, a3);
		}

		::System::Void __OnGo_b__51_0(::System::Boolean s, ::Class_3_025FF4981524A424_488* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::Class_3_025FF4981524A424_488*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBABELTOWERFIGHTINGINFOWIDGETCONTROLLER___ONGO_B__51_0_OFFSET))(this, s, rsp);
		}
