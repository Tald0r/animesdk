...
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_ACTLEVELRESULTCAMERA_OFFSET UNITYSDK_OFFSET(0x8967E60)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8967CE0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_HASENDBATTLE_OFFSET UNITYSDK_OFFSET(0x8969130)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_INITLOSEVIEW_OFFSET UNITYSDK_OFFSET(0x8968B80)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x8968370)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8968950)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8967CF0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8968AC0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x89683E0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_PLAYEXIT_OFFSET UNITYSDK_OFFSET(0x8969300)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_REFRESHLOSEVIEW_OFFSET UNITYSDK_OFFSET(0x89695F0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_SETMOVE_OFFSET UNITYSDK_OFFSET(0x8968650)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x89689F0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8969E70)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER__INITLOSEVIEW_B__14_0_OFFSET UNITYSDK_OFFSET(0x8969E80)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER__INITLOSEVIEW_B__14_1_OFFSET UNITYSDK_OFFSET(0x8969EA0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8969F10)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8969F80)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8969F90)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8969FA0)
#define MOLEMOLE_UILEVELLOSERESULTPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x8969FB0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelLoseResultPageController_TypeDefinitionIndex = 53272;

	class UILevelLoseResultPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_94D5884806027679_4* _view; // 0x2F8
