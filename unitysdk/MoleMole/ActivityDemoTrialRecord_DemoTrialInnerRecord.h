...
#define MOLEMOLE_ACTIVITYDEMOTRIALRECORD_DEMOTRIALINNERRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x6531600)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityDemoTrialRecord_DemoTrialInnerRecord_TypeDefinitionIndex = 51231;
