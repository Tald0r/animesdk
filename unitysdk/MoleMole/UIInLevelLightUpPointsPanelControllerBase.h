...
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_GET_ISARRIVEMAXPOINT_OFFSET UNITYSDK_OFFSET(0x99F4D40)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x99F4D30)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x99F4F00)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_HANDLEARRIVEMAXPOINTCHANGED_OFFSET UNITYSDK_OFFSET(0x99F5AF0)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_HANDLECURPOINT_OFFSET UNITYSDK_OFFSET(0x99F58C0)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x99F5020)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_HANDLEMAXPOINT_OFFSET UNITYSDK_OFFSET(0x99F52A0)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x99F51E0)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x99F4E10)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x99F5C80)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x99F5D80)
#define MOLEMOLE_UIINLEVELLIGHTUPPOINTSPANELCONTROLLERBASE___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x99F5D10)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelLightUpPointsPanelControllerBase_TypeDefinitionIndex = 46831;
