...
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xE8E8830)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE8E82A0)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xE8E8940)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xE8E8420)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE8E8340)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE8E7FB0)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xE8E8510)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xE8E8780)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE8E8B80)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xE8E8B90)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE8E8BA0)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xE8E8C10)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xE8E8C80)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE8E8D00)
#define MOLEMOLE_UIABRESULTCAMPITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE8E8D80)

namespace MoleMole
{
	inline static constexpr unsigned int UIABResultCampItemWidgetController_TypeDefinitionIndex = 51894;
