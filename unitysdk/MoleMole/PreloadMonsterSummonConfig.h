...
#define MOLEMOLE_PRELOADMONSTERSUMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB2FC440)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadMonsterSummonConfig_TypeDefinitionIndex = 68080;
