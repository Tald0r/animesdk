...
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_BTNCONFIRM_OFFSET UNITYSDK_OFFSET(0x8EAB360)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x8EAA430)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8EAA420)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x8EAAD70)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_MASKCLOSEINNER_OFFSET UNITYSDK_OFFSET(0x8EAA8C0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x8EAA850)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EAA720)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x8EAACC0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EAA7C0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EAA440)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8EAA670)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8EAAFF0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8EAB450)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0x8EAB460)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER__ONUIINIT_B__5_1_OFFSET UNITYSDK_OFFSET(0x8EAB470)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER___BASE_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x8EAB480)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8EAB4F0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x8EAB560)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8EAB590)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8EAB5A0)
#define MOLEMOLE_UIKEYBINDINGCONFLICTTIPSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8EAB5B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIKeyBindingConflictTipsPopWindowController_TypeDefinitionIndex = 72773;
