...
#define MOLEMOLE_UIFORBIDDENAREAPREPPAGECONTROLLER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x807AB70)
#define MOLEMOLE_UIFORBIDDENAREAPREPPAGECONTROLLER___C__DISPLAYCLASS16_0__REFRESHTALENTVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x807AC80)
#define MOLEMOLE_UIFORBIDDENAREAPREPPAGECONTROLLER___C__DISPLAYCLASS16_0__REFRESHTALENTVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x807AB80)

namespace MoleMole
{
	inline static constexpr unsigned int UIForbiddenAreaPrepPageController___c__DisplayClass16_0_TypeDefinitionIndex = 42633;
