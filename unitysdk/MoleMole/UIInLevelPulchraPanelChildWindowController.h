...
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_COLLECTALLANIMATIONCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x8C861B0)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_GET_ISARRIVEMAXATTACKTIME_OFFSET UNITYSDK_OFFSET(0x8C85520)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8C85510)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_HANDLEALLCUSTOMPROPERTIESONSHOW_OFFSET UNITYSDK_OFFSET(0x8C857C0)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_HANDLECURATTACKTIME_OFFSET UNITYSDK_OFFSET(0x8C85A90)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_HANDLECUSTOMPROPERTY_OFFSET UNITYSDK_OFFSET(0x8C858E0)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_HANDLEISENHANCE_OFFSET UNITYSDK_OFFSET(0x8C86210)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_HANDLEMAXATTACKTIME_OFFSET UNITYSDK_OFFSET(0x8C85C40)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x8C860F0)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C85610)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C856B0)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C863A0)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER___BASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x8C86430)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C86490)
#define MOLEMOLE_UIINLEVELPULCHRAPANELCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C86500)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelPulchraPanelChildWindowController_TypeDefinitionIndex = 75660;

	class UIInLevelPulchraPanelChildWindowController : public ::MonoCustomPropertyUIControllerBase
	{
	public:
		::Class_2_69CBB7FF0BE6A673_17* _view; // 0x330
