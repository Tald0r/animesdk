...
#define MOLEMOLE_SCENEGLAREPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8F3CC80)

namespace MoleMole
{
	inline static constexpr unsigned int SceneGlareProfileContext_TypeDefinitionIndex = 45236;
