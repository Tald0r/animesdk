...
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_CLICKITEMBUTTON_OFFSET UNITYSDK_OFFSET(0xCAAF360)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCAAE5D0)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCAAE750)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCAAE670)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCAAE3F0)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCAAE940)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCAAF3D0)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCAAF440)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCAAF4B0)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCAAF530)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCAAF5B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEmoticonsTipItemWidgetController_TypeDefinitionIndex = 37475;
