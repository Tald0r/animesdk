...
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_CLICKITEMBUTTON_OFFSET UNITYSDK_OFFSET(0xCB35720)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCB34990)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCB34B10)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCB34A30)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCB347B0)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCB34D00)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCB35790)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCB35800)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCB35870)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCB358F0)
#define MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCB35970)

namespace MoleMole
{
	inline static constexpr unsigned int UIEmoticonsTipItemWidgetController_TypeDefinitionIndex = 48107;

	class UIEmoticonsTipItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_964D8E1BC1392751* _view; // 0x2D0
		::UnityEngine::Color maskColor; // 0x2D8
		...
		::System::Void RefreshView(::Class_1_82297B6AFFE49354_1* context)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_82297B6AFFE49354_1*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIEMOTICONSTIPITEMWIDGETCONTROLLER_REFRESHVIEW_OFFSET))(this, context);
		}
