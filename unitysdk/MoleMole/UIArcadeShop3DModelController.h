...
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERARCADEMACHINEPHASEFROMPLAYGAMENOANIM_OFFSET UNITYSDK_OFFSET(0xC8EDFA0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERARCADEMACHINEPHASEFROMPLAYGAME_OFFSET UNITYSDK_OFFSET(0xC8EDD80)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERARCADEMACHINEPHASEFROMSPINNINGTABLE_OFFSET UNITYSDK_OFFSET(0xC8ECE50)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERENTRANCEPHASEFROMSPINNINGTABLE_OFFSET UNITYSDK_OFFSET(0xC8EC650)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERPLAYGAMEPHASEFROMARCADEMACHINENOANIM_OFFSET UNITYSDK_OFFSET(0xC8EDB20)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERPLAYGAMEPHASEFROMARCADEMACHINE_OFFSET UNITYSDK_OFFSET(0xC8ED5E0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERPLAYGAMEPHASEFROMSPINNINGTABLE_OFFSET UNITYSDK_OFFSET(0xC8EE200)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERSPINNINGTABLEPHASEFROMARCADEMACHINE_OFFSET UNITYSDK_OFFSET(0xC8ED0C0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERSPINNINGTABLEPHASEFROMENTRANCEDIRECT_OFFSET UNITYSDK_OFFSET(0xC8EC3F0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERSPINNINGTABLEPHASEFROMENTRANCE_OFFSET UNITYSDK_OFFSET(0xC8EC070)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ENTERSPINNINGTABLEPHASEFROMPLAYGAME_OFFSET UNITYSDK_OFFSET(0xC8EE420)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_GETARCADEMODELSCREENDISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0xC8EF960)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_GETCENTERDATAINDEX_OFFSET UNITYSDK_OFFSET(0xC8EC000)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_GETCENTERPOSITIONINDEX_OFFSET UNITYSDK_OFFSET(0xC8EBF90)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_GETMACHINEUNIT3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC8EEAF0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_GETTARGETROTATIONAXISVALUE_OFFSET UNITYSDK_OFFSET(0xC8F0370)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_INITARCADEMACHINEINFO_OFFSET UNITYSDK_OFFSET(0xC8EFAA0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_INITCAMERAINFO_OFFSET UNITYSDK_OFFSET(0xC8F0470)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC8EA7B0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ISTABLEROTATING_OFFSET UNITYSDK_OFFSET(0xC8EFF20)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC8EAC20)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ONENTERGAMERTPHASE_OFFSET UNITYSDK_OFFSET(0xC8ED800)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ONENTERNEARPOSPHASE_OFFSET UNITYSDK_OFFSET(0xC8ED330)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ONENTERTITLEVIDEOPHASE_OFFSET UNITYSDK_OFFSET(0xC8ECB20)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC8EACC0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8EA6F0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_PRELEAVEPLAYGAMEPHASE_OFFSET UNITYSDK_OFFSET(0xC8ECAA0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_REFRESHCOMMONVIEW_OFFSET UNITYSDK_OFFSET(0xC8EECC0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_REFRESHSPINNINGTABLESTATE_OFFSET UNITYSDK_OFFSET(0xC8EE710)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_REFRESHTABLEROTATINGBYGAMELIST_OFFSET UNITYSDK_OFFSET(0xC8EFBB0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_REFRESHTABLEROTATING_OFFSET UNITYSDK_OFFSET(0xC8EFC20)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_REGISTERMINIGAMEWORLD_OFFSET UNITYSDK_OFFSET(0xC8EF440)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_RESETCAMERAMOVE_OFFSET UNITYSDK_OFFSET(0xC8EC280)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_RESETTABLEROTATING_OFFSET UNITYSDK_OFFSET(0xC8ECA30)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_SET3DSCREENSHOWENABLED_OFFSET UNITYSDK_OFFSET(0xC8EF790)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_SETCAMERAMOVESTATE_OFFSET UNITYSDK_OFFSET(0xC8F01E0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_SETDIRECTIONALLIGHTSTATE_OFFSET UNITYSDK_OFFSET(0xC8EFF90)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_SETREFCONTROLLER_OFFSET UNITYSDK_OFFSET(0xC8EF250)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_STARTARCADEGAME_OFFSET UNITYSDK_OFFSET(0xC8EF6B0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_STOPCENTERMACHINEVIDEO_OFFSET UNITYSDK_OFFSET(0xC8EE640)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_TICKCAMERA_OFFSET UNITYSDK_OFFSET(0xC8EAEB0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_TICKSPINNINGTABLEROTATE_OFFSET UNITYSDK_OFFSET(0xC8EBA80)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_TICKTABLEROTATINGBYSELF_OFFSET UNITYSDK_OFFSET(0xC8EBE90)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_UNREGISTERMINIGAMEWORLD_OFFSET UNITYSDK_OFFSET(0xC8EF580)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC8EAD50)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC8F0A80)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC8F0B80)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC8F0BF0)
#define MOLEMOLE_UIARCADESHOP3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8F0C00)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeShop3DModelController_TypeDefinitionIndex = 42305;

	class UIArcadeShop3DModelController : public ::MoleMole::UIBase3DModelController
	{
	public:
		::Class_2_56AF18CD74DA940A_4* _view; // 0x340
