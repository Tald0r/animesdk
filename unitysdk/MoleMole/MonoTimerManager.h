...
#define MOLEMOLE_MONOTIMERMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x8A81FD0)
#define MOLEMOLE_MONOTIMERMANAGER_REGISTERTIMER_1_OFFSET UNITYSDK_OFFSET(0x8A82BF0)
#define MOLEMOLE_MONOTIMERMANAGER_REGISTERTIMER_2_OFFSET UNITYSDK_OFFSET(0x8A82E70)
#define MOLEMOLE_MONOTIMERMANAGER_REGISTERTIMER_OFFSET UNITYSDK_OFFSET(0x8A82A00)
#define MOLEMOLE_MONOTIMERMANAGER_RESETALLTRIGGERTIMER_OFFSET UNITYSDK_OFFSET(0x8A82470)
#define MOLEMOLE_MONOTIMERMANAGER_RESTARTGAME_OFFSET UNITYSDK_OFFSET(0x8A821B0)
#define MOLEMOLE_MONOTIMERMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x8A82630)
#define MOLEMOLE_MONOTIMERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x8A82F40)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTimerManager_TypeDefinitionIndex = 40212;
	...
	public:
		...
		{
			return (::MoleMole::MonoTimerManager**)Il2CppClass::FromTypeDefinitionIndex(MonoTimerManager_TypeDefinitionIndex)->GetStaticField(0x2C8E0);
		}
