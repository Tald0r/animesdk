...
#define MOLEMOLE_UIARCADEPLAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8BAACF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadePlayContext_TypeDefinitionIndex = 54610;

	class UIArcadePlayContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Int32 ArcadeID; // 0x28
		::Enum_3_71AA90D596A09AC8_3 MiniGameType; // 0x2C
