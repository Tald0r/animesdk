...
#define MOLEMOLE_UITALENTPOINTMONO__CTOR_OFFSET UNITYSDK_OFFSET(0xA6BE450)

namespace MoleMole
{
	inline static constexpr unsigned int UITalentPointMono_TypeDefinitionIndex = 42369;
