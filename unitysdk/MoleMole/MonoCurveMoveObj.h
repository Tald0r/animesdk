...
#define MOLEMOLE_MONOCURVEMOVEOBJ_AWAKE_OFFSET UNITYSDK_OFFSET(0xD80C600)
#define MOLEMOLE_MONOCURVEMOVEOBJ_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xD80C670)
#define MOLEMOLE_MONOCURVEMOVEOBJ_METHOD_8_DFBBBBB761BF1414_OFFSET UNITYSDK_OFFSET(0xD80D110)
#define MOLEMOLE_MONOCURVEMOVEOBJ_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0xD80C7E0)
#define MOLEMOLE_MONOCURVEMOVEOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0xD80D220)
#define MOLEMOLE_MONOCURVEMOVEOBJ___BASE_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0xD80D2E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCurveMoveObj_TypeDefinitionIndex = 74810;
