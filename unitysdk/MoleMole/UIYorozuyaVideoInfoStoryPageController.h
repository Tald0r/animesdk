...
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_GETYOROZUYAVIDEOURL_OFFSET UNITYSDK_OFFSET(0x954A880)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_GET_ISSHOW2DUI_OFFSET UNITYSDK_OFFSET(0x954B0E0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9547600)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9547C00)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9547FB0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9547610)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_OVERRIDELOOPTEXT_OFFSET UNITYSDK_OFFSET(0x954A4B0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_PLAYMAPLOGO_OFFSET UNITYSDK_OFFSET(0x954AF80)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x95498D0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_REFRESHRECOMMENDEDHITTYPES_OFFSET UNITYSDK_OFFSET(0x9549CC0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_REFRESHVIDEOVIEW_OFFSET UNITYSDK_OFFSET(0x954AC50)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_SETCOMPLEXITYINFO_OFFSET UNITYSDK_OFFSET(0x9549110)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_SETLEVELINFO_OFFSET UNITYSDK_OFFSET(0x954A210)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_SETNOISE_OFFSET UNITYSDK_OFFSET(0x9547D10)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_SETVIDEINFO_OFFSET UNITYSDK_OFFSET(0x9549440)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_SET_ISSHOW2DUI_OFFSET UNITYSDK_OFFSET(0x954B0D0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER_UPDATELEFTVIEW_OFFSET UNITYSDK_OFFSET(0x95482B0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x954B0F0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER__REFRESHVIDEOVIEW_B__15_0_OFFSET UNITYSDK_OFFSET(0x954B1C0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER__SETCOMPLEXITYINFO_G__SETTIMECOST_10_0_OFFSET UNITYSDK_OFFSET(0x954A750)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER__SETVIDEINFO_B__11_0_OFFSET UNITYSDK_OFFSET(0x954B180)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER__VIDEOPLAYER_PREPARECOMPLETED_OFFSET UNITYSDK_OFFSET(0x9547CA0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x954B1D0)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x954B240)
#define MOLEMOLE_UIYOROZUYAVIDEOINFOSTORYPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x954B2C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaVideoInfoStoryPageController_TypeDefinitionIndex = 77946;
	...
	public:
		...
		::Class_2_79F6D62CE30E3F8E_179* _view; // 0x2A0
		...
		::Class_1_A047EA5169B6B30F* _selectQuestInfo; // 0x368
		...
		::Class_2_0A55B5A82A61DAFA* _selectQuestConfig; // 0x388
