...
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBFCA6F0)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS16_0__INITSORT_B__1_OFFSET UNITYSDK_OFFSET(0xBFCA700)
#define MOLEMOLE_UIHOLLOWCARDCOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS16_0__INITSORT_B__3_OFFSET UNITYSDK_OFFSET(0xBFCA710)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardCollectWidgetController___c__DisplayClass16_0_TypeDefinitionIndex = 72093;
