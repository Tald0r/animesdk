...
class Class_2_A73484641D9B4122;
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFA1DB0)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFA1E20)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xBFA2150)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFA1F20)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBFA2430)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFA24F0)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFA2500)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xBFA2570)
#define MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBFA25E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIForumPostRowWidgetController_TypeDefinitionIndex = 64918;
	...
	public:
		...
		::Class_2_A73484641D9B4122* get__viewModel()
		{
			return ((::Class_2_A73484641D9B4122*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFORUMPOSTROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
