...
#define MOLEMOLE_AUTOGETITEMLISTSHOW_DIRECTSHOW_OFFSET UNITYSDK_OFFSET(0xB43CE50)
#define MOLEMOLE_AUTOGETITEMLISTSHOW_DOPROCESS_OFFSET UNITYSDK_OFFSET(0xB43CEC0)
#define MOLEMOLE_AUTOGETITEMLISTSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xB43CBE0)
#define MOLEMOLE_AUTOGETITEMLISTSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xB43CDE0)
#define MOLEMOLE_AUTOGETITEMLISTSHOW_SETGOBTN_OFFSET UNITYSDK_OFFSET(0xB43CD60)
#define MOLEMOLE_AUTOGETITEMLISTSHOW_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0xB43CCE0)
#define MOLEMOLE_AUTOGETITEMLISTSHOW_SHOWREWARDWINDOW_OFFSET UNITYSDK_OFFSET(0xB43CF30)
#define MOLEMOLE_AUTOGETITEMLISTSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xB43CBF0)
#define MOLEMOLE_AUTOGETITEMLISTSHOW___BASE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0xB43D1D0)

namespace MoleMole
{
	inline static constexpr unsigned int AutoGetItemListShow_TypeDefinitionIndex = 69785;
	...
	public:
		...
		::System::Action* goCallback; // 0x30
		::System::String* goText; // 0x38
		::System::Boolean showGoBtn; // 0x40
		::System::Boolean showOverflowHint; // 0x41
