...
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_BINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xBF17D80)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_INITROLEINDEX_OFFSET UNITYSDK_OFFSET(0xBF17B20)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF19690)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF19730)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF19450)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xBF19810)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0xBF17B90)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF198A0)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0xBF198D0)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF19930)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF199A0)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF19A20)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaRolePoolWidgetController_TypeDefinitionIndex = 46866;

	class UIGachaRolePoolWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_72679ED639CF4AB4_1* _view; // 0x2A0
		::System::Action_1<::MoleMole::UIGachaRolePoolWidgetController*>* _callback; // 0x2A8
		::UnityEngine::Color _origImgColor; // 0x2B0
		::UnityEngine::Color _unselectImgColor; // 0x2C0
