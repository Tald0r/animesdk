...
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_BINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xA97F9D0)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_INITROLEINDEX_OFFSET UNITYSDK_OFFSET(0xA97F780)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA981A10)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA981AB0)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA9817D0)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xA981B90)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0xA97F7F0)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA981C20)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER__ONUIINIT_B__5_0_OFFSET UNITYSDK_OFFSET(0xA981C50)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA981CB0)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA981D20)
#define MOLEMOLE_UIGACHAROLEPOOLWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA981DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaRolePoolWidgetController_TypeDefinitionIndex = 70569;
