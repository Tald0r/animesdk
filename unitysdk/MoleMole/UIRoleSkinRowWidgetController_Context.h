...
#define MOLEMOLE_UIROLESKINROWWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD6C5570)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSkinRowWidgetController_Context_TypeDefinitionIndex = 41192;
	...
	public:
		...
		::System::Boolean isGetMethodPreview; // 0x34
		::System::Boolean isAvatarObtained; // 0x35
