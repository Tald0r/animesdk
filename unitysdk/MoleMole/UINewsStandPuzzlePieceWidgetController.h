...
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0xA4277D0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_COPYFROM_OFFSET UNITYSDK_OFFSET(0xA428120)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_GET_CANDRAG_OFFSET UNITYSDK_OFFSET(0xA428A90)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_GET_DATA_OFFSET UNITYSDK_OFFSET(0xA4283A0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_GET_EVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0xA4265A0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_GET_ISCORRECT_OFFSET UNITYSDK_OFFSET(0xA4278C0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0xA426590)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_GET_POS_OFFSET UNITYSDK_OFFSET(0xA4283B0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xA428890)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0xA4285C0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4271C0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xA428B50)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xA4275B0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xA4274E0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONSWAP_OFFSET UNITYSDK_OFFSET(0xA427ED0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA426A50)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA427260)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4265C0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA4269A0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONWIN_OFFSET UNITYSDK_OFFSET(0xA427B80)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_PLAYDRAGANIM_OFFSET UNITYSDK_OFFSET(0xA4283D0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_RESETANIM_OFFSET UNITYSDK_OFFSET(0xA427C80)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_RESETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xA428480)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0xA426B40)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_SET_POS_OFFSET UNITYSDK_OFFSET(0xA4283C0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_SWAP_1_OFFSET UNITYSDK_OFFSET(0xA4280A0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_SWAP_OFFSET UNITYSDK_OFFSET(0xA427D60)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_TOGGLECONSOLESELECTIMG_OFFSET UNITYSDK_OFFSET(0xA4279A0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_TOGGLECONSOLESELECTSHOW_OFFSET UNITYSDK_OFFSET(0xA428260)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_TOGGLEHOVER_OFFSET UNITYSDK_OFFSET(0xA4281D0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA428C80)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER__ONSWAP_B__36_0_OFFSET UNITYSDK_OFFSET(0xA428E40)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0xA428CB0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER__ONUIINIT_B__6_1_OFFSET UNITYSDK_OFFSET(0xA428CC0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA428E80)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xA428EF0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA428F50)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA428F60)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA428FE0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA429040)

namespace MoleMole
{
	inline static constexpr unsigned int UINewsStandPuzzlePieceWidgetController_TypeDefinitionIndex = 81014;

	class UINewsStandPuzzlePieceWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_569219A648BABC87* _view; // 0x2A0
		::MoleMole::MonoGamepadSelectable* _selectable; // 0x2A8
		::System::ValueTuple_2<::System::Int32, ::System::Int32> _Pos_k__BackingField; // 0x2B0
		::Class_2_EF0B7B770198FEB2* _data; // 0x2B8
		::UnityEngine::GameObject* curSelect; // 0x2C0
		::Foundation::AssetPath _currentFullImagePathForUV; // 0x2C8
		::System::Int32 _currentPuzzleSize; // 0x2D8
