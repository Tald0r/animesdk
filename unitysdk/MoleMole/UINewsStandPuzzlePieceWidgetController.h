...
class Class_2_443D2F540A50DD79;
...
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x945F6C0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_COPYFROM_OFFSET UNITYSDK_OFFSET(0x945FFA0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_GET_CANDRAG_OFFSET UNITYSDK_OFFSET(0x94607B0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_GET_DATA_OFFSET UNITYSDK_OFFSET(0x9460200)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_GET_EVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0x945E830)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_GET_ISCORRECT_OFFSET UNITYSDK_OFFSET(0x945F780)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x945E820)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_GET_POS_OFFSET UNITYSDK_OFFSET(0x9460210)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x94605B0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0x94602E0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x945F0B0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x9460870)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x945F4A0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x945F3D0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONSWAP_OFFSET UNITYSDK_OFFSET(0x945FD50)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x945ECE0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x945F150)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x945E850)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x945EC30)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_ONWIN_OFFSET UNITYSDK_OFFSET(0x945FA40)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_PLAYDRAGANIM_OFFSET UNITYSDK_OFFSET(0x9460230)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_RESETANIM_OFFSET UNITYSDK_OFFSET(0x945FB40)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x945EDB0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_SET_POS_OFFSET UNITYSDK_OFFSET(0x9460220)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_SWAP_1_OFFSET UNITYSDK_OFFSET(0x945FF20)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_SWAP_OFFSET UNITYSDK_OFFSET(0x945FC20)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_TOGGLECONSOLESELECTIMG_OFFSET UNITYSDK_OFFSET(0x945F860)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_TOGGLECONSOLESELECTSHOW_OFFSET UNITYSDK_OFFSET(0x94600C0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_TOGGLEHOVER_OFFSET UNITYSDK_OFFSET(0x9460030)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x94609A0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER__ONSWAP_B__33_0_OFFSET UNITYSDK_OFFSET(0x9460B60)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x94609D0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER__ONUIINIT_B__6_1_OFFSET UNITYSDK_OFFSET(0x94609E0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9460BA0)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x9460C10)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x9460C70)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9460C80)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9460D00)
#define MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9460D60)

namespace MoleMole
{
	inline static constexpr unsigned int UINewsStandPuzzlePieceWidgetController_TypeDefinitionIndex = 58234;

	class UINewsStandPuzzlePieceWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_443D2F540A50DD79* _view; // 0x2A0
		...
		::System::Void SetData(::Class_2_EF0B7B770198FEB2* data, ::System::ValueTuple_2<::System::Int32, ::System::Int32> pos, ::System::Boolean isWin)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_EF0B7B770198FEB2*, ::System::ValueTuple_2<::System::Int32, ::System::Int32>, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER_SETDATA_OFFSET))(this, data, pos, isWin);
		}
		...
		::System::Void _OnSwap_b__33_0()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UINEWSSTANDPUZZLEPIECEWIDGETCONTROLLER__ONSWAP_B__33_0_OFFSET))(this);
		}
