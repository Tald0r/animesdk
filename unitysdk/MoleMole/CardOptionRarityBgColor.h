...
#define MOLEMOLE_CARDOPTIONRARITYBGCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x81D72D0)

namespace MoleMole
{
	inline static constexpr unsigned int CardOptionRarityBgColor_TypeDefinitionIndex = 76726;
