...
#define MOLEMOLE_CARDOPTIONRARITYBGCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x653CBC0)

namespace MoleMole
{
	inline static constexpr unsigned int CardOptionRarityBgColor_TypeDefinitionIndex = 79204;
