...
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8069F40)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONCLICKGETREWARD_ASYNC_B__1_OFFSET UNITYSDK_OFFSET(0x8069F50)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONCLICKGETREWARD_ASYNC_B__2_OFFSET UNITYSDK_OFFSET(0x8069F60)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONCLICKGETREWARD_ASYNC_B__3_OFFSET UNITYSDK_OFFSET(0x8069F90)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelRewardRowWidgetController___c__DisplayClass11_0_TypeDefinitionIndex = 59535;
