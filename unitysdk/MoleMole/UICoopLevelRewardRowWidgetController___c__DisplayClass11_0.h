...
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAC47AC0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONCLICKGETREWARD_ASYNC_B__1_OFFSET UNITYSDK_OFFSET(0xAC47AD0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONCLICKGETREWARD_ASYNC_B__2_OFFSET UNITYSDK_OFFSET(0xAC47AE0)
#define MOLEMOLE_UICOOPLEVELREWARDROWWIDGETCONTROLLER___C__DISPLAYCLASS11_0__ONCLICKGETREWARD_ASYNC_B__3_OFFSET UNITYSDK_OFFSET(0xAC47B10)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelRewardRowWidgetController___c__DisplayClass11_0_TypeDefinitionIndex = 80166;
