...
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_CACHEENTITYCOMPONENTS_OFFSET UNITYSDK_OFFSET(0xBEADC80)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_CALCDSTATE_OFFSET UNITYSDK_OFFSET(0xBEB1C20)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_CLEARBTNHOLDPARAMS_OFFSET UNITYSDK_OFFSET(0xBEB1000)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_CLEARBTNINPUT_OFFSET UNITYSDK_OFFSET(0xBEB4790)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_CLICKHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xBEB41B0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_DOBRANCHSKILLBTNREFRESHCDVIEW_OFFSET UNITYSDK_OFFSET(0xBEB2670)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_DOREFRESHCDVIEW_OFFSET UNITYSDK_OFFSET(0xBEB2880)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GETCDRECOVERFILLAMOUNT_OFFSET UNITYSDK_OFFSET(0xBEB40A0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GETSPECIALFEEDBACKANIMATIONCLIPPATH_OFFSET UNITYSDK_OFFSET(0xBEB5660)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GETUIHIDEITEMTAG_OFFSET UNITYSDK_OFFSET(0xBEAEEC0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_BUTTONSKILLNAME_OFFSET UNITYSDK_OFFSET(0xBEAD7C0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_ENABLEDRAGINPUTINSKILLBUTTON_OFFSET UNITYSDK_OFFSET(0xBEB56D0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_HANDLEINPUTINEARLYUPDATE_OFFSET UNITYSDK_OFFSET(0xBEAD7A0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_KEYBUTTONCODE_OFFSET UNITYSDK_OFFSET(0xBEAD7D0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_SKILLBTNINDEX_OFFSET UNITYSDK_OFFSET(0xBEAD840)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_SKILLBTNTYPE_OFFSET UNITYSDK_OFFSET(0xBEAD8A0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_SKILLINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xBEAD7E0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xBEAD7B0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET__OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xBEAD900)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_INITDRAGINPUTSUPPORT_OFFSET UNITYSDK_OFFSET(0xBEB04B0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_INITSKILLBTNSPECIALFEEDBACK_OFFSET UNITYSDK_OFFSET(0xBEAE1C0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_INITSKILLBTNVIEW_OFFSET UNITYSDK_OFFSET(0xBEAF170)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_INITSKILLBUTTON_OFFSET UNITYSDK_OFFSET(0xBEAE370)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ISBASEPAGEALLOWSKILLINPUT_OFFSET UNITYSDK_OFFSET(0xBEB2330)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ISSKILLBUTTONHINTENABLE_OFFSET UNITYSDK_OFFSET(0xBEB4F40)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ISSKILLBUTTONINPUTENABLED_OFFSET UNITYSDK_OFFSET(0xBEB4880)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ISSKILLBUTTONSHOWUI_OFFSET UNITYSDK_OFFSET(0xBEB4B90)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0xBEB01C0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0xBEB1590)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONCLICKCUSTOMCALLBACK_OFFSET UNITYSDK_OFFSET(0xBEB4670)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xBEB0350)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBEAF700)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONPOINTERDOWNCUSTOMCALLBACK_OFFSET UNITYSDK_OFFSET(0xBEB46D0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xBEAFE30)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONPOINTERPRESS_OFFSET UNITYSDK_OFFSET(0xBEAFFB0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONPOINTERUPCUSTOMCALLBACK_OFFSET UNITYSDK_OFFSET(0xBEB4730)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xBEB0040)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONPREUPDATE_OFFSET UNITYSDK_OFFSET(0xBEB10D0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONSKILLBUTTONACTIVESTATECHANGED_OFFSET UNITYSDK_OFFSET(0xBEAEC00)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONTOUCHPOINTERDOWNFROMBUTTON_OFFSET UNITYSDK_OFFSET(0xBEB4300)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONTOUCHPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xBEB43D0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONTOUCHPOINTERENTER_OFFSET UNITYSDK_OFFSET(0xBEB4510)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONTOUCHPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0xBEB45C0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONTOUCHPOINTERUPFROMBUTTON_OFFSET UNITYSDK_OFFSET(0xBEB4450)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONTOUCHPOINTERUP_OFFSET UNITYSDK_OFFSET(0xBEB02E0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBEAF1D0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBEAE040)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBEAE870)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_OVERWRITELAYOUTADAPTORWITH_OFFSET UNITYSDK_OFFSET(0xBEB5220)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REBINDSKILLINFO_OFFSET UNITYSDK_OFFSET(0xBEB0410)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHBRANCHSKILLBTNNONECDVIEW_OFFSET UNITYSDK_OFFSET(0xBEB3850)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHCDVIEW_OFFSET UNITYSDK_OFFSET(0xBEB1DD0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHCOUNTCDVIEW_OFFSET UNITYSDK_OFFSET(0xBEB29B0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHFORCECDVIEW_OFFSET UNITYSDK_OFFSET(0xBEB3330)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHINPUTDEVICE_OFFSET UNITYSDK_OFFSET(0xBEAF5E0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHNONECDVIEW_OFFSET UNITYSDK_OFFSET(0xBEB2EA0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHSILENCECDVIEW_OFFSET UNITYSDK_OFFSET(0xBEB2F30)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHSKILLBTNNONECDVIEW_OFFSET UNITYSDK_OFFSET(0xBEB3C30)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHSKILLBUTTONHINTENABLE_OFFSET UNITYSDK_OFFSET(0xBEB5090)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHSKILLBUTTONVIEW_OFFSET UNITYSDK_OFFSET(0xBEB4FB0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHSKILLBUTTON_OFFSET UNITYSDK_OFFSET(0xBEB0890)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHSKILLINFO_OFFSET UNITYSDK_OFFSET(0xBEB0ED0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REGISTERBUTTONENABLECHANGE_OFFSET UNITYSDK_OFFSET(0xBEADF80)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_SENDEVTSKILLBTNOPERATE_OFFSET UNITYSDK_OFFSET(0xBEB2010)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_SETRANDOMSKILLBTNACTIVE_OFFSET UNITYSDK_OFFSET(0xBEB0D50)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_SETSKILLBUTTONCDSTATE_OFFSET UNITYSDK_OFFSET(0xBEB3F80)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_SET__OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xBEAD910)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_SHOULDSKILLBUTTONHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0xBEAF680)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xBEB1620)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_TRYRESETBUTTON_OFFSET UNITYSDK_OFFSET(0xBEADC00)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_USESKILL_OFFSET UNITYSDK_OFFSET(0xBEB4250)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBEB56E0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__INITDRAGINPUTSUPPORT_B__52_0_OFFSET UNITYSDK_OFFSET(0xBEB5A30)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__INITDRAGINPUTSUPPORT_B__52_1_OFFSET UNITYSDK_OFFSET(0xBEB5BC0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__ONUIOPEN_B__40_0_OFFSET UNITYSDK_OFFSET(0xBEB5760)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__ONUIOPEN_B__40_1_OFFSET UNITYSDK_OFFSET(0xBEB57E0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__ONUIOPEN_B__40_2_OFFSET UNITYSDK_OFFSET(0xBEB58B0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__ONUIOPEN_B__40_3_OFFSET UNITYSDK_OFFSET(0xBEB5960)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__ONUIOPEN_B__40_4_OFFSET UNITYSDK_OFFSET(0xBEB5A00)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBEB5E40)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBEB5DB0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBEB5DC0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBEB5DD0)

namespace MoleMole
{
	inline static constexpr unsigned int UISkillButtonBaseController_TypeDefinitionIndex = 49205;

	class UISkillButtonBaseController : public ::MoleMole::UIWindowController
	{
	public:
		::System::Single clickLightTime; // 0x2F8
		::System::String* _ButtonSkillName_k__BackingField; // 0x300
		::MoleMole::LogicButtonInputType _KeyButtonCode_k__BackingField; // 0x308
		::MoleMole::Battle::Entity* _btnOwnerEntity; // 0x310
		::Class_2_A8F5ABF31E066ED4* _btnIcon; // 0x318
		::UnityEngine::UI::Image* _trigger; // 0x320
		::Class_2_60DDD9C206686F44* _button; // 0x328
		::System::Action_1<::System::Boolean>* _onButtonEnableChange; // 0x330
		::UnityEngine::UI::Text* _cdText; // 0x338
		::Class_2_A8F5ABF31E066ED4* _ringImg; // 0x340
		::Class_2_A8F5ABF31E066ED4* _silenceRecoverMaskImg; // 0x348
		::Class_2_A8F5ABF31E066ED4* _forceRecoverMaskImg; // 0x350
		::UnityEngine::UI::Text* _epCntText; // 0x358
		::UnityEngine::GameObject* _skillNumPanel; // 0x360
		::UnityEngine::Transform* _skillLoopLight; // 0x368
		::UnityEngine::Transform* _skillLight; // 0x370
		::UnityEngine::Transform* _endMaskTrans; // 0x378
		::UnityEngine::Animator* _skillBtnAnimator; // 0x380
		::UnityEngine::Animator* _skillBtnAnimatorForSpecialFeedback; // 0x388
		::Class_1_BBBB2C2BE00F33C3* _skillInfo; // 0x390
		::UnityEngine::RectTransform* _keyPanel; // 0x398
		::System::String* _uiHideItemTag; // 0x3A0
		::System::Boolean isStayNoneCDView; // 0x3A8
		::System::Boolean _isAwaked; // 0x3A9
		::Class_3_BD1C1745FBC83F51* _inputComponent; // 0x3B0
		::Class_3_B9D5951434CC70FD* _skillComponent; // 0x3B8
		::Class_3_C0D5B1A036ED00F0* _dataComponent; // 0x3C0
		::System::Boolean _isHoldTriggered; // 0x3C8
		::System::Boolean _buttonHoldBegin; // 0x3C9
		::System::Single _holdTime; // 0x3CC
		::System::Single _totalHoldTime; // 0x3D0
		::System::Single HOLD_TIME_THRESHOLD; // 0x3D4
		::System::Boolean _buttonClickTrigger; // 0x3D8
		::System::Boolean _buttonHoldRelease; // 0x3D9
		::MoleMole::UISkillButtonBaseController_BtnCDState _cdState; // 0x3DC
		::System::Boolean _isCDStateNeedReset; // 0x3E0
		::System::Boolean _isInSkillButtonCDState; // 0x3E1
		::System::Boolean isEquipSkill; // 0x3E2
		::MoleMole::UIGeneralKeyPanelWidgetController* _keyPanelWidgetCtrl; // 0x3E8
		::MoleMole::ButtonPressType _buttonPressType; // 0x3F0
		::System::Boolean _isKeyPressing; // 0x3F4
		::System::Boolean _isTouchButtonDown; // 0x3F5
		::System::Boolean _isToggleCurFrame; // 0x3F6
		::System::Boolean _isTouchButtonDownCurFrame; // 0x3F7
		::Enum_3_A019F766F8C74696 _lastInputDevice; // 0x3F8
		::UnityEngine::AnimatorOverrideController* _animatorOverrideController; // 0x400
		::Class_1_FEB95EB7BCDEE1B8* _dragInputSupport; // 0x408
		...
		::System::Boolean IsBasePageAllowSkillInput()
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ISBASEPAGEALLOWSKILLINPUT_OFFSET))(this);
		}
