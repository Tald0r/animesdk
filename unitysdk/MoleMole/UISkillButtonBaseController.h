...
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_CACHEENTITYCOMPONENTS_OFFSET UNITYSDK_OFFSET(0xA6A2B50)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_CALCDSTATE_OFFSET UNITYSDK_OFFSET(0xA6A6AD0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_CLEARBTNHOLDPARAMS_OFFSET UNITYSDK_OFFSET(0xA6A5ED0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_CLEARBTNINPUT_OFFSET UNITYSDK_OFFSET(0xA6A9300)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_CLICKHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xA6A8D20)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_DOBRANCHSKILLBTNREFRESHCDVIEW_OFFSET UNITYSDK_OFFSET(0xA6A71E0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_DOREFRESHCDVIEW_OFFSET UNITYSDK_OFFSET(0xA6A73F0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GETCDRECOVERFILLAMOUNT_OFFSET UNITYSDK_OFFSET(0xA6A8C10)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GETSPECIALFEEDBACKANIMATIONCLIPPATH_OFFSET UNITYSDK_OFFSET(0xA6AA500)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GETUIHIDEITEMTAG_OFFSET UNITYSDK_OFFSET(0xA6A3DA0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_BUTTONSKILLNAME_OFFSET UNITYSDK_OFFSET(0xA6A26A0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_ENABLEDRAGINPUTINSKILLBUTTON_OFFSET UNITYSDK_OFFSET(0xA6AA570)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_HANDLEINPUTINEARLYUPDATE_OFFSET UNITYSDK_OFFSET(0xA6A2680)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_KEYBUTTONCODE_OFFSET UNITYSDK_OFFSET(0xA6A26B0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_SKILLBTNINDEX_OFFSET UNITYSDK_OFFSET(0xA6A2720)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_SKILLBTNTYPE_OFFSET UNITYSDK_OFFSET(0xA6A2780)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_SKILLINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xA6A26C0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA6A2690)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_GET__OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xA6A27E0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_INITDRAGINPUTSUPPORT_OFFSET UNITYSDK_OFFSET(0xA6A5380)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_INITSKILLBTNSPECIALFEEDBACK_OFFSET UNITYSDK_OFFSET(0xA6A3090)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_INITSKILLBTNVIEW_OFFSET UNITYSDK_OFFSET(0xA6A4050)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_INITSKILLBUTTON_OFFSET UNITYSDK_OFFSET(0xA6A3240)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ISSKILLBUTTONHINTENABLE_OFFSET UNITYSDK_OFFSET(0xA6A9DE0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ISSKILLBUTTONINPUTENABLED_OFFSET UNITYSDK_OFFSET(0xA6A9720)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ISSKILLBUTTONSHOWUI_OFFSET UNITYSDK_OFFSET(0xA6A9A40)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ISSTREAMINGPAGEBLOCKINPUT_OFFSET UNITYSDK_OFFSET(0xA6A93F0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0xA6A5090)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0xA6A6450)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONCLICKCUSTOMCALLBACK_OFFSET UNITYSDK_OFFSET(0xA6A91E0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA6A5220)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA6A45E0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONPOINTERDOWNCUSTOMCALLBACK_OFFSET UNITYSDK_OFFSET(0xA6A9240)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xA6A4D00)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONPOINTERPRESS_OFFSET UNITYSDK_OFFSET(0xA6A4E80)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONPOINTERUPCUSTOMCALLBACK_OFFSET UNITYSDK_OFFSET(0xA6A92A0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xA6A4F10)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONPREUPDATE_OFFSET UNITYSDK_OFFSET(0xA6A5FA0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONSKILLBUTTONACTIVESTATECHANGED_OFFSET UNITYSDK_OFFSET(0xA6A3AE0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONTOUCHPOINTERDOWNFROMBUTTON_OFFSET UNITYSDK_OFFSET(0xA6A8E70)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONTOUCHPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xA6A8F40)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONTOUCHPOINTERENTER_OFFSET UNITYSDK_OFFSET(0xA6A9080)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONTOUCHPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0xA6A9130)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONTOUCHPOINTERUPFROMBUTTON_OFFSET UNITYSDK_OFFSET(0xA6A8FC0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONTOUCHPOINTERUP_OFFSET UNITYSDK_OFFSET(0xA6A51B0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA6A40B0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA6A2F10)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA6A3750)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_OVERWRITELAYOUTADAPTORWITH_OFFSET UNITYSDK_OFFSET(0xA6AA0C0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REBINDSKILLINFO_OFFSET UNITYSDK_OFFSET(0xA6A52E0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHBRANCHSKILLBTNNONECDVIEW_OFFSET UNITYSDK_OFFSET(0xA6A83C0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHCDVIEW_OFFSET UNITYSDK_OFFSET(0xA6A6C80)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHCOUNTCDVIEW_OFFSET UNITYSDK_OFFSET(0xA6A7520)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHFORCECDVIEW_OFFSET UNITYSDK_OFFSET(0xA6A7EA0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHINPUTDEVICE_OFFSET UNITYSDK_OFFSET(0xA6A44C0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHNONECDVIEW_OFFSET UNITYSDK_OFFSET(0xA6A7A10)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHSILENCECDVIEW_OFFSET UNITYSDK_OFFSET(0xA6A7AA0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHSKILLBTNNONECDVIEW_OFFSET UNITYSDK_OFFSET(0xA6A87A0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHSKILLBUTTONHINTENABLE_OFFSET UNITYSDK_OFFSET(0xA6A9F30)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHSKILLBUTTONVIEW_OFFSET UNITYSDK_OFFSET(0xA6A9E50)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHSKILLBUTTON_OFFSET UNITYSDK_OFFSET(0xA6A5760)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REFRESHSKILLINFO_OFFSET UNITYSDK_OFFSET(0xA6A5DA0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_REGISTERBUTTONENABLECHANGE_OFFSET UNITYSDK_OFFSET(0xA6A2E50)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_SENDEVTSKILLBTNOPERATE_OFFSET UNITYSDK_OFFSET(0xA6A6EC0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_SETRANDOMSKILLBTNACTIVE_OFFSET UNITYSDK_OFFSET(0xA6A5C20)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_SETSKILLBUTTONCDSTATE_OFFSET UNITYSDK_OFFSET(0xA6A8AF0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_SET__OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xA6A27F0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_SHOULDSKILLBUTTONHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0xA6A4560)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xA6A64E0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_TRYRESETBUTTON_OFFSET UNITYSDK_OFFSET(0xA6A2AE0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER_USESKILL_OFFSET UNITYSDK_OFFSET(0xA6A8DC0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA6AA580)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__INITDRAGINPUTSUPPORT_B__52_0_OFFSET UNITYSDK_OFFSET(0xA6AA8D0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__INITDRAGINPUTSUPPORT_B__52_1_OFFSET UNITYSDK_OFFSET(0xA6AAA60)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__ONUIOPEN_B__40_0_OFFSET UNITYSDK_OFFSET(0xA6AA600)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__ONUIOPEN_B__40_1_OFFSET UNITYSDK_OFFSET(0xA6AA680)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__ONUIOPEN_B__40_2_OFFSET UNITYSDK_OFFSET(0xA6AA750)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__ONUIOPEN_B__40_3_OFFSET UNITYSDK_OFFSET(0xA6AA800)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER__ONUIOPEN_B__40_4_OFFSET UNITYSDK_OFFSET(0xA6AA8A0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA6AACE0)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA6AAC50)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA6AAC60)
#define MOLEMOLE_UISKILLBUTTONBASECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA6AAC70)

namespace MoleMole
{
	inline static constexpr unsigned int UISkillButtonBaseController_TypeDefinitionIndex = 66659;
