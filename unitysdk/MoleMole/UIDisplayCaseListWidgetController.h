...
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER_BEGINDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xAC4C0F0)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER_DRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xAC4C190)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER_ENDDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xAC4C350)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xAC4BD40)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC4B0F0)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC4B3F0)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC4B190)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC4AE20)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAC4B4D0)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xAC4C010)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC4C3D0)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xAC4C3E0)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC4C3F0)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC4C460)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC4C4E0)
#define MOLEMOLE_UIDISPLAYCASELISTWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC4C560)

namespace MoleMole
{
	inline static constexpr unsigned int UIDisplayCaseListWidgetController_TypeDefinitionIndex = 40487;

	class UIDisplayCaseListWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_38* _view; // 0x2D0
