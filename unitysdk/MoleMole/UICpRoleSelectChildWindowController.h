...
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_BACKDIFFICULTYPAGE_OFFSET UNITYSDK_OFFSET(0x1A3585B0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_BUILDINFO_OFFSET UNITYSDK_OFFSET(0x1A359350)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_CREATEROLEGRID_OFFSET UNITYSDK_OFFSET(0x1A358B90)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_GETDIFFICULTY_OFFSET UNITYSDK_OFFSET(0x1A35A3B0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_GETPAGESTATE_OFFSET UNITYSDK_OFFSET(0x1A358890)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_GETSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x1A35A130)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x1A357FC0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_MOVEFOCUS_OFFSET UNITYSDK_OFFSET(0x1A35A8E0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A35A030)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A3588E0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1A35A450)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1A359EB0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A35A0C0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A357FD0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A359D60)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_REFRESHCANDY_OFFSET UNITYSDK_OFFSET(0x1A3594D0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_REFRESHDIFFICULTYPANEL_OFFSET UNITYSDK_OFFSET(0x1A35AF90)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_REFRESHDIFFICULTY_OFFSET UNITYSDK_OFFSET(0x1A358450)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_REFRESHGRID_OFFSET UNITYSDK_OFFSET(0x1A35ADB0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x1A359650)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_REFRESHSELECT_OFFSET UNITYSDK_OFFSET(0x1A359430)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_SENDDIFFICULTYREADY_OFFSET UNITYSDK_OFFSET(0x1A358210)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_SETROLEVIEWPROPDATA_OFFSET UNITYSDK_OFFSET(0x1A35A1C0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_SETROLEVIEWPROPEMPTY_OFFSET UNITYSDK_OFFSET(0x1A35A280)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER_SWITCHPAGESTATE_OFFSET UNITYSDK_OFFSET(0x1A358770)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A35B470)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A35B3D0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER__ONUIINIT_B__14_0_OFFSET UNITYSDK_OFFSET(0x1A35B500)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER__ONUIINIT_B__14_1_OFFSET UNITYSDK_OFFSET(0x1A35B6B0)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A35B890)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1A35B900)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x1A35B930)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A35B940)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A35B950)
#define MOLEMOLE_UICPROLESELECTCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A35B960)

namespace MoleMole
{
	inline static constexpr unsigned int UICpRoleSelectChildWindowController_TypeDefinitionIndex = 81448;
	...
	public:
		...
		{
			return (::System::Comparison_1<::Class_1_D76391934630D6CD*>**)Il2CppClass::FromTypeDefinitionIndex(UICpRoleSelectChildWindowController_TypeDefinitionIndex)->GetStaticField(0x468D0);
		}
		...
		::Class_2_79F6D62CE30E3F8E_187* _view; // 0x2F8
