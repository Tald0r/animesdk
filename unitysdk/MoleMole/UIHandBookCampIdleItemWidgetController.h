...
#define MOLEMOLE_UIHANDBOOKCAMPIDLEITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC008F00)
#define MOLEMOLE_UIHANDBOOKCAMPIDLEITEMWIDGETCONTROLLER_ONJUMPCLICK_OFFSET UNITYSDK_OFFSET(0xC009610)
#define MOLEMOLE_UIHANDBOOKCAMPIDLEITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC009080)
#define MOLEMOLE_UIHANDBOOKCAMPIDLEITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC008FA0)
#define MOLEMOLE_UIHANDBOOKCAMPIDLEITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC008C90)
#define MOLEMOLE_UIHANDBOOKCAMPIDLEITEMWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xC009560)
#define MOLEMOLE_UIHANDBOOKCAMPIDLEITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC009720)
#define MOLEMOLE_UIHANDBOOKCAMPIDLEITEMWIDGETCONTROLLER__ONJUMPCLICK_B__7_0_OFFSET UNITYSDK_OFFSET(0xC009730)
#define MOLEMOLE_UIHANDBOOKCAMPIDLEITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC009810)
#define MOLEMOLE_UIHANDBOOKCAMPIDLEITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC009880)
#define MOLEMOLE_UIHANDBOOKCAMPIDLEITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC009900)
#define MOLEMOLE_UIHANDBOOKCAMPIDLEITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC009980)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookCampIdleItemWidgetController_TypeDefinitionIndex = 48652;
	...
	public:
		...
		::Class_2_208CC9941471731A_31* _cfg; // 0x2D8
