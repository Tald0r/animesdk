...
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELRELICPACKAGEINFO_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xA4B4450)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELRELICPACKAGEINFO_SETBRIEF_OFFSET UNITYSDK_OFFSET(0xA4B44B0)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELRELICPACKAGEINFO_SETSELECT_OFFSET UNITYSDK_OFFSET(0xA4B4520)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELRELICPACKAGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AA200)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2InLevelMapDialogPageController_UIInLevelRelicPackageInfo_TypeDefinitionIndex = 44695;
	...
	public:
		...
		::System::Boolean UseGamepadSelectable; // 0x23
