...
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELRELICPACKAGEINFO_GETTEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0xA4F2DA0)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELRELICPACKAGEINFO_SETBRIEF_OFFSET UNITYSDK_OFFSET(0xA4F2E00)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELRELICPACKAGEINFO_SETSELECT_OFFSET UNITYSDK_OFFSET(0xA4F2E70)
#define MOLEMOLE_UIABYSSS2INLEVELMAPDIALOGPAGECONTROLLER_UIINLEVELRELICPACKAGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA4E8B20)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2InLevelMapDialogPageController_UIInLevelRelicPackageInfo_TypeDefinitionIndex = 48295;
	...
	public:
		...
		::System::Boolean HideLevel; // 0x20
		::System::Boolean IsSelect; // 0x21
		::System::Boolean BriefDesc; // 0x22
		::System::Boolean Expand; // 0x23
