...
#define MOLEMOLE_UIBPCOREREWARDSHOWWIDGETWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x98A3EA0)
#define MOLEMOLE_UIBPCOREREWARDSHOWWIDGETWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98A3F40)
#define MOLEMOLE_UIBPCOREREWARDSHOWWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98A3D50)
#define MOLEMOLE_UIBPCOREREWARDSHOWWIDGETWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98A3DF0)
#define MOLEMOLE_UIBPCOREREWARDSHOWWIDGETWIDGETCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0x98A4090)
#define MOLEMOLE_UIBPCOREREWARDSHOWWIDGETWIDGETCONTROLLER_SETCOREREWARDSHOWITEM_OFFSET UNITYSDK_OFFSET(0x98A4020)
#define MOLEMOLE_UIBPCOREREWARDSHOWWIDGETWIDGETCONTROLLER_SETSELECTWIDGET_OFFSET UNITYSDK_OFFSET(0x98A4210)
#define MOLEMOLE_UIBPCOREREWARDSHOWWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98A42A0)
#define MOLEMOLE_UIBPCOREREWARDSHOWWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x98A42D0)
#define MOLEMOLE_UIBPCOREREWARDSHOWWIDGETWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98A4340)
#define MOLEMOLE_UIBPCOREREWARDSHOWWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98A43C0)
#define MOLEMOLE_UIBPCOREREWARDSHOWWIDGETWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98A4420)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPCoreRewardShowWidgetWidgetController_TypeDefinitionIndex = 72883;

	class UIBPCoreRewardShowWidgetWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D68EC59F0214DAC2_2* _view; // 0x2A0
		::System::Int32 rewardID; // 0x2A8
