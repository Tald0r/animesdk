...
#define MOLEMOLE_CONFIGSPECIALDAMAGETEXT_ISVALID_OFFSET UNITYSDK_OFFSET(0x367040)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigSpecialDamageText_TypeDefinitionIndex = 37789;
