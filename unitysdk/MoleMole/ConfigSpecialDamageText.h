...
#define MOLEMOLE_CONFIGSPECIALDAMAGETEXT_ISVALID_OFFSET UNITYSDK_OFFSET(0x3A7860)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigSpecialDamageText_TypeDefinitionIndex = 72361;
