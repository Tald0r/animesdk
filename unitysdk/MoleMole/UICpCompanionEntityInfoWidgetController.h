...
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_HIDETAGS_OFFSET UNITYSDK_OFFSET(0x1AABB380)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1AABAD20)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1AABADB0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1AABABF0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1AABAC80)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_SETTAGSCRIPT_OFFSET UNITYSDK_OFFSET(0x1AABBB30)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0x1AABAEB0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_UPDATETAGS_OFFSET UNITYSDK_OFFSET(0x1AABB3F0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AABBCC0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1AABBD40)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1AABBDB0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1AABBE30)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1AABBE90)

namespace MoleMole
{
	inline static constexpr unsigned int UICpCompanionEntityInfoWidgetController_TypeDefinitionIndex = 83547;
