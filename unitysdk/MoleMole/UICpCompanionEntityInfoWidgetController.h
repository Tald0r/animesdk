...
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_HIDETAGS_OFFSET UNITYSDK_OFFSET(0x1A356AB0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A356450)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A3564E0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A356320)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A3563B0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_SETTAGSCRIPT_OFFSET UNITYSDK_OFFSET(0x1A357260)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0x1A3565E0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_UPDATETAGS_OFFSET UNITYSDK_OFFSET(0x1A356B20)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3573F0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1A357470)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x1A3574E0)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x1A357560)
#define MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x1A3575C0)

namespace MoleMole
{
	inline static constexpr unsigned int UICpCompanionEntityInfoWidgetController_TypeDefinitionIndex = 81577;

	class UICpCompanionEntityInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_1DAC8AE00C47D12C_2* _view; // 0x2A0
		::System::String* tagPathRoot; // 0x2A8
		::System::Collections::Generic::List_1<::System::Int32>* tags; // 0x2B0
		...
		::System::Void UpdateTags(::System::Collections::Generic::List_1<::System::Int32>* configTagss, ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* tagNumDict, ::Class_1_6399F7CE1D7FBB9B* configMap, ::Class_3_412776396A6B9A05_1* world)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::System::Int32>*, ::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>*, ::Class_1_6399F7CE1D7FBB9B*, ::Class_3_412776396A6B9A05_1*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICPCOMPANIONENTITYINFOWIDGETCONTROLLER_UPDATETAGS_OFFSET))(this, configTagss, tagNumDict, configMap, world);
		}
