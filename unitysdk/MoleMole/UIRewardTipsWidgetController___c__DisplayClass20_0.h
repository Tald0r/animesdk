...
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAC2AD80)
#define MOLEMOLE_UIREWARDTIPSWIDGETCONTROLLER___C__DISPLAYCLASS20_0__RECYLEREWARDTIPWIDGET_B__0_OFFSET UNITYSDK_OFFSET(0xAC2AD90)

namespace MoleMole
{
	inline static constexpr unsigned int UIRewardTipsWidgetController___c__DisplayClass20_0_TypeDefinitionIndex = 49948;
