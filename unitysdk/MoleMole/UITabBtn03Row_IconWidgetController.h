...
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x9A25410)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A24800)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0x9A24A30)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x9A24980)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9A24BA0)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A248A0)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9A246A0)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER_SETICONANDTEXT_OFFSET UNITYSDK_OFFSET(0x9A24EE0)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER_SETREDPOINT_OFFSET UNITYSDK_OFFSET(0x9A25160)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A25480)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A25490)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER___BASE_ONITEMRESELECT_OFFSET UNITYSDK_OFFSET(0x9A25500)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x9A25560)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9A255D0)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A25650)
#define MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9A256D0)

namespace MoleMole
{
	inline static constexpr unsigned int UITabBtn03Row_IconWidgetController_TypeDefinitionIndex = 48420;
	...
	public:
		...
		{
			return ((::Class_2_AEEA82AB75F4904D*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UITABBTN03ROW_ICONWIDGETCONTROLLER_GETVIEW_OFFSET))(this);
		}
