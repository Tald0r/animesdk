...
#define MOLEMOLE_SWITCHTEAMINBATTLESUBSYSTEM___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0x6ED8140)
#define MOLEMOLE_SWITCHTEAMINBATTLESUBSYSTEM___C__DISPLAYCLASS23_0__SWITCHTEAM_B__0_OFFSET UNITYSDK_OFFSET(0x6ED8150)

namespace MoleMole
{
	inline static constexpr unsigned int SwitchTeamInBattleSubSystem___c__DisplayClass23_0_TypeDefinitionIndex = 67910;
