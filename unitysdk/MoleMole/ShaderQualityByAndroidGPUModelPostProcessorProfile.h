...
#define MOLEMOLE_SHADERQUALITYBYANDROIDGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0xC7D8520)
#define MOLEMOLE_SHADERQUALITYBYANDROIDGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xC7D85B0)
#define MOLEMOLE_SHADERQUALITYBYANDROIDGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0xC7D8610)

namespace MoleMole
{
	inline static constexpr unsigned int ShaderQualityByAndroidGPUModelPostProcessorProfile_TypeDefinitionIndex = 76941;
