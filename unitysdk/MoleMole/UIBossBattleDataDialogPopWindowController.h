...
#define MOLEMOLE_UIBOSSBATTLEDATADIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD028060)
#define MOLEMOLE_UIBOSSBATTLEDATADIALOGPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD028070)
#define MOLEMOLE_UIBOSSBATTLEDATADIALOGPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD0280E0)
#define MOLEMOLE_UIBOSSBATTLEDATADIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD0281A0)
#define MOLEMOLE_UIBOSSBATTLEDATADIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD028530)
#define MOLEMOLE_UIBOSSBATTLEDATADIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD028540)
#define MOLEMOLE_UIBOSSBATTLEDATADIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD0285B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossBattleDataDialogPopWindowController_TypeDefinitionIndex = 76627;
