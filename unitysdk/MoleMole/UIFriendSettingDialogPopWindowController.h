...
#define MOLEMOLE_UIFRIENDSETTINGDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAD16470)
#define MOLEMOLE_UIFRIENDSETTINGDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD167C0)
#define MOLEMOLE_UIFRIENDSETTINGDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD16860)
#define MOLEMOLE_UIFRIENDSETTINGDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD16480)
#define MOLEMOLE_UIFRIENDSETTINGDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD168F0)
#define MOLEMOLE_UIFRIENDSETTINGDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD16900)
#define MOLEMOLE_UIFRIENDSETTINGDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD16970)
#define MOLEMOLE_UIFRIENDSETTINGDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAD16980)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendSettingDialogPopWindowController_TypeDefinitionIndex = 62436;
