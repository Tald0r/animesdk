...
class Class_2_809B068491AD1EEA_1;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }
namespace System { class String; }

#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC3E4E0)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC3E580)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC3E390)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC3E430)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_REFRESHACTIVESTATE_OFFSET UNITYSDK_OFFSET(0xAC3E8D0)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_REFRESHBUFFID_OFFSET UNITYSDK_OFFSET(0xAC3E660)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_REFRESHBUFF_1_OFFSET UNITYSDK_OFFSET(0xAC3EB40)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_REFRESHBUFF_OFFSET UNITYSDK_OFFSET(0xAC3E760)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER_SETTITLE_OFFSET UNITYSDK_OFFSET(0xAC3EA20)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC3ECA0)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC3ECD0)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC3ED40)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC3EDC0)
#define MOLEMOLE_UIBUFFINFOPANELWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC3EE20)

namespace MoleMole
{
	inline static constexpr unsigned int UIBuffInfoPanelWidgetController_TypeDefinitionIndex = 38151;

	class UIBuffInfoPanelWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_809B068491AD1EEA_1* _view; // 0x2A0
		::MoleMole::UIWidgetController* currentBuffInfoWidget; // 0x2A8
