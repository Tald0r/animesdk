...
#define MOLEMOLE_FISHCAMERACONFIGGROUPV2__CTOR_OFFSET UNITYSDK_OFFSET(0xE0E97F0)

namespace MoleMole
{
	inline static constexpr unsigned int FishCameraConfigGroupV2_TypeDefinitionIndex = 40363;
