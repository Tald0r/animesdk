...
#define MOLEMOLE_FISHCAMERACONFIGGROUPV2__CTOR_OFFSET UNITYSDK_OFFSET(0x7A4E470)

namespace MoleMole
{
	inline static constexpr unsigned int FishCameraConfigGroupV2_TypeDefinitionIndex = 41747;
