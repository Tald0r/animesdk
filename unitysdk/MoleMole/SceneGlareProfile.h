...
#define MOLEMOLE_SCENEGLAREPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xB872630)
#define MOLEMOLE_SCENEGLAREPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xB8727B0)
#define MOLEMOLE_SCENEGLAREPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0xB872520)
#define MOLEMOLE_SCENEGLAREPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xB872710)
#define MOLEMOLE_SCENEGLAREPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xB872510)
#define MOLEMOLE_SCENEGLAREPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xB872910)
#define MOLEMOLE_SCENEGLAREPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xB8729A0)
#define MOLEMOLE_SCENEGLAREPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xB872A10)
#define MOLEMOLE_SCENEGLAREPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xB872A80)

namespace MoleMole
{
	inline static constexpr unsigned int SceneGlareProfile_TypeDefinitionIndex = 56365;
