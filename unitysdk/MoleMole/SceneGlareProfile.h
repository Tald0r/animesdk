...
#define MOLEMOLE_SCENEGLAREPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xB2FDC60)
#define MOLEMOLE_SCENEGLAREPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xB2FDDE0)
#define MOLEMOLE_SCENEGLAREPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0xB2FDB50)
#define MOLEMOLE_SCENEGLAREPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xB2FDD40)
#define MOLEMOLE_SCENEGLAREPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xB2FDB40)
#define MOLEMOLE_SCENEGLAREPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xB2FDF40)
#define MOLEMOLE_SCENEGLAREPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xB2FDFD0)
#define MOLEMOLE_SCENEGLAREPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xB2FE040)
#define MOLEMOLE_SCENEGLAREPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xB2FE0B0)

namespace MoleMole
{
	inline static constexpr unsigned int SceneGlareProfile_TypeDefinitionIndex = 68717;
