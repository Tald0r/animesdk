...
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0BA8B0)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER_ONGENERALLEVELCHANGE_OFFSET UNITYSDK_OFFSET(0xC0BAFF0)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC0BAA30)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0BA950)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0BA570)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC0BAB30)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0BB0F0)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER__ONUIINIT_B__4_0_OFFSET UNITYSDK_OFFSET(0xC0BB100)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC0BB180)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC0BB1F0)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC0BB270)
#define MOLEMOLE_UICOMMENTLEVELROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC0BB2F0)

namespace MoleMole
{
	inline static constexpr unsigned int UICommentLevelRowWidgetController_TypeDefinitionIndex = 68007;

	class UICommentLevelRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_42D947D2D80CC77C* _view; // 0x2D0
		::Class_2_C868A5F010AE909D* _model; // 0x2D8
		::System::Int32 _levelId; // 0x2E0
