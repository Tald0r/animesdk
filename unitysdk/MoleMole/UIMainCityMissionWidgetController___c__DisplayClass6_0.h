...
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA5EF0)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS6_0__SHOWMISSIONFINISHANDSETTOTRACKQUEST_B__0_OFFSET UNITYSDK_OFFSET(0x9AA5F00)
#define MOLEMOLE_UIMAINCITYMISSIONWIDGETCONTROLLER___C__DISPLAYCLASS6_0__SHOWMISSIONFINISHANDSETTOTRACKQUEST_B__1_OFFSET UNITYSDK_OFFSET(0x9AA5F50)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMissionWidgetController___c__DisplayClass6_0_TypeDefinitionIndex = 53708;
