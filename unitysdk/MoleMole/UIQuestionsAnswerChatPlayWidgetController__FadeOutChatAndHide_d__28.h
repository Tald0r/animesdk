...
#define MOLEMOLE_UIQUESTIONSANSWERCHATPLAYWIDGETCONTROLLER__FADEOUTCHATANDHIDE_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x390F60)
#define MOLEMOLE_UIQUESTIONSANSWERCHATPLAYWIDGETCONTROLLER__FADEOUTCHATANDHIDE_D__28_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerChatPlayWidgetController__FadeOutChatAndHide_d__28_TypeDefinitionIndex = 43457;

	struct alignas(8) UIQuestionsAnswerChatPlayWidgetController__FadeOutChatAndHide_d__28
	{
		::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder __t__builder; // 0x10
		::MoleMole::UIQuestionsAnswerChatPlayWidgetController* __4__this; // 0x20
