...
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_CREATEIMPACTBATTLELAYER_OFFSET UNITYSDK_OFFSET(0xA92B3B0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_CREATENORMALLAYER_OFFSET UNITYSDK_OFFSET(0xA92B0A0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_GET_ONENTERLAYERROOMCALLBACK_OFFSET UNITYSDK_OFFSET(0xA928670)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_GET_ONSWITCHZONE_OFFSET UNITYSDK_OFFSET(0xA928650)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA929C90)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA92D810)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xA92D650)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA92A740)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xA929BC0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA92CBD0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONPARENTWINDOWFADEINDONE_OFFSET UNITYSDK_OFFSET(0xA92C390)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONREWARDNOTIFICATIONUPDATE_OFFSET UNITYSDK_OFFSET(0xA92C4D0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA929970)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA929D30)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA928690)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA928950)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_SETLAYERWIDGET_OFFSET UNITYSDK_OFFSET(0xA92B170)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_SET_ONENTERLAYERROOMCALLBACK_OFFSET UNITYSDK_OFFSET(0xA928680)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_SET_ONSWITCHZONE_OFFSET UNITYSDK_OFFSET(0xA928660)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_UPDATEFRAMETEXTURE_OFFSET UNITYSDK_OFFSET(0xA92C400)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__BINDGAMEPAD_OFFSET UNITYSDK_OFFSET(0xA9296A0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__BINDZONEINFOBTN_OFFSET UNITYSDK_OFFSET(0xA92A5D0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__CHECKPREVDYNAMICLAYER_OFFSET UNITYSDK_OFFSET(0xA92BCB0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__CLOSELAYERSPREV_OFFSET UNITYSDK_OFFSET(0xA9299E0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA92DB90)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__FINDLAYERINDEXTOLISTINDEX_OFFSET UNITYSDK_OFFSET(0xA92B480)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__GAMEPADITEMSUBMIT_OFFSET UNITYSDK_OFFSET(0xA92D2C0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__GAMEPADSELECTNAVLISTITEM_OFFSET UNITYSDK_OFFSET(0xA92CDB0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__MARKALLLAYERROWSTATU_OFFSET UNITYSDK_OFFSET(0xA92C990)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__ONCLICK_LAYERITEM_OFFSET UNITYSDK_OFFSET(0xA92C7C0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__ONCLICK_ZONEINFOITEM_OFFSET UNITYSDK_OFFSET(0xA92AE00)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__ONUIOPEN_B__14_0_OFFSET UNITYSDK_OFFSET(0xA92DD00)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__ONUIOPEN_B__14_2_OFFSET UNITYSDK_OFFSET(0xA92DED0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__SETLAYERSSCROLLCREATEFUNC_OFFSET UNITYSDK_OFFSET(0xA928E70)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__SETLAYERWIDGET_B__41_0_OFFSET UNITYSDK_OFFSET(0xA92E5E0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__SETLAYERWIDGET_B__41_1_OFFSET UNITYSDK_OFFSET(0xA92E5F0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__SHOWZONEINFO_OFFSET UNITYSDK_OFFSET(0xA92A9F0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__TRYSELECTZONEITEM_OFFSET UNITYSDK_OFFSET(0xA929F10)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__UPDATEBADGE_OFFSET UNITYSDK_OFFSET(0xA92C300)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__UPDATECONSOLELAYERBYSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA92AC40)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__UPDATEFRAMETEXTURE_G__SHOULDPLAYREWARDFRAMETEXTURE_47_0_OFFSET UNITYSDK_OFFSET(0xA92C540)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__UPDATEZONEINFO_OFFSET UNITYSDK_OFFSET(0xA92B620)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__UPDATEZONES_OFFSET UNITYSDK_OFFSET(0xA929030)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__UPDATE_ZONELAYERS_OFFSET UNITYSDK_OFFSET(0xA92A150)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA92E720)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA92E790)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xA92E800)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA92E870)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xA92E930)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA92E990)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA92E9C0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA92E9D0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA92EA50)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA92EAB0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BINDGAMEPAD_B__18_1_OFFSET UNITYSDK_OFFSET(0xA92DEE0)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___BINDZONEINFOBTN_B__31_0_OFFSET UNITYSDK_OFFSET(0xA92E270)
#define MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER___SETLAYERSSCROLLCREATEFUNC_B__38_0_OFFSET UNITYSDK_OFFSET(0xA92E460)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_LayerV2WidgetController_TypeDefinitionIndex = 63869;
	...
	public:
		...
		::System::Action_1<::Class_1_5DA2E7556103D5A3_280*>* _OnEnterLayerRoomCallback_k__BackingField; // 0x2C0
		...
		::System::Action_1<::Class_1_5DA2E7556103D5A3_280*>* get_OnEnterLayerRoomCallback()
		{
			return ((::System::Action_1<::Class_1_5DA2E7556103D5A3_280*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_GET_ONENTERLAYERROOMCALLBACK_OFFSET))(this);
		}

		::System::Void set_OnEnterLayerRoomCallback(::System::Action_1<::Class_1_5DA2E7556103D5A3_280*>* value)
		{
			return ((::System::Void(*)(::PVOID, ::System::Action_1<::Class_1_5DA2E7556103D5A3_280*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER_SET_ONENTERLAYERROOMCALLBACK_OFFSET))(this, value);
		}
		...
		::System::Int32 _FindLayerIndexToListIndex(::System::Collections::Generic::List_1<::Class_1_5DA2E7556103D5A3_280*>* dataList, ::System::Int32 layerIndex)
		{
			return ((::System::Int32(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_1_5DA2E7556103D5A3_280*>*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_LAYERV2WIDGETCONTROLLER__FINDLAYERINDEXTOLISTINDEX_OFFSET))(this, dataList, layerIndex);
		}
