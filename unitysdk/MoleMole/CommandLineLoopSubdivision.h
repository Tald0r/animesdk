...
#define MOLEMOLE_COMMANDLINELOOPSUBDIVISION_METHOD_2_B803F7DBC34AF411_OFFSET UNITYSDK_OFFSET(0x629C930)
#define MOLEMOLE_COMMANDLINELOOPSUBDIVISION_METHOD_2_BE3FE5ABE9D35D0A_OFFSET UNITYSDK_OFFSET(0x629CA80)
#define MOLEMOLE_COMMANDLINELOOPSUBDIVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x629CA40)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineLoopSubdivision_TypeDefinitionIndex = 78763;
