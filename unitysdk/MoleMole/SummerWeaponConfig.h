...
#define MOLEMOLE_SUMMERWEAPONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA7FAAE0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerWeaponConfig_TypeDefinitionIndex = 60671;
