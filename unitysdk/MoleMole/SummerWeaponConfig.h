...
#define MOLEMOLE_SUMMERWEAPONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA6107B0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerWeaponConfig_TypeDefinitionIndex = 46868;
