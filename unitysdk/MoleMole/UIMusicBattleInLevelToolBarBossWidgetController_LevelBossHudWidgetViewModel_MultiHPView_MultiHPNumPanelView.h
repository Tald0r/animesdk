...
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL_MULTIHPVIEW_MULTIHPNUMPANELVIEW_GET_ANIM_OFFSET UNITYSDK_OFFSET(0x9E8D240)
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL_MULTIHPVIEW_MULTIHPNUMPANELVIEW_GET_NUM_OFFSET UNITYSDK_OFFSET(0x9E8D170)
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL_MULTIHPVIEW_MULTIHPNUMPANELVIEW_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x9E8D320)
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL_MULTIHPVIEW_MULTIHPNUMPANELVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x9E8D3F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelToolBarBossWidgetController_LevelBossHudWidgetViewModel_MultiHPView_MultiHPNumPanelView_TypeDefinitionIndex = 64886;
