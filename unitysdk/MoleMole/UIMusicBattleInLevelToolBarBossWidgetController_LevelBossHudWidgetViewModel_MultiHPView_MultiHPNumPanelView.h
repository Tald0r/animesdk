...
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL_MULTIHPVIEW_MULTIHPNUMPANELVIEW_GET_ANIM_OFFSET UNITYSDK_OFFSET(0xB6B6300)
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL_MULTIHPVIEW_MULTIHPNUMPANELVIEW_GET_NUM_OFFSET UNITYSDK_OFFSET(0xB6B6230)
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL_MULTIHPVIEW_MULTIHPNUMPANELVIEW_GET_ROOT_OFFSET UNITYSDK_OFFSET(0xB6B63E0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL_MULTIHPVIEW_MULTIHPNUMPANELVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xB6B64B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelToolBarBossWidgetController_LevelBossHudWidgetViewModel_MultiHPView_MultiHPNumPanelView_TypeDefinitionIndex = 61902;
