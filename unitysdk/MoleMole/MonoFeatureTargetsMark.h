...
#define MOLEMOLE_MONOFEATURETARGETSMARK_EMPTY_OFFSET UNITYSDK_OFFSET(0x8B23400)
#define MOLEMOLE_MONOFEATURETARGETSMARK_GETCOMPONENTSAFELY_OFFSET UNITYSDK_OFFSET(0x8B23530)
#define MOLEMOLE_MONOFEATURETARGETSMARK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x8B23870)
#define MOLEMOLE_MONOFEATURETARGETSMARK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8B23680)
#define MOLEMOLE_MONOFEATURETARGETSMARK__CCTOR_OFFSET UNITYSDK_OFFSET(0x8B23BF0)
#define MOLEMOLE_MONOFEATURETARGETSMARK__CTOR_OFFSET UNITYSDK_OFFSET(0x8B23AD0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoFeatureTargetsMark_TypeDefinitionIndex = 67380;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::MonoFeatureTargetsMark*>**)Il2CppClass::FromTypeDefinitionIndex(MonoFeatureTargetsMark_TypeDefinitionIndex)->GetStaticField(0x3A6C0);
		}
