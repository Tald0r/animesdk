...
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD3A7870)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___C__DISPLAYCLASS13_0__STARTSHOWGETRAMENCUTSCENE_B__0_OFFSET UNITYSDK_OFFSET(0xD3A7880)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___C__DISPLAYCLASS13_0__STARTSHOWGETRAMENCUTSCENE_B__1_OFFSET UNITYSDK_OFFSET(0xD3A78B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRamenStoreWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 73221;
