...
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC83FE00)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___C__DISPLAYCLASS13_0__STARTSHOWGETRAMENCUTSCENE_B__0_OFFSET UNITYSDK_OFFSET(0xC83FE10)
#define MOLEMOLE_UIRAMENSTOREWIDGETCONTROLLER___C__DISPLAYCLASS13_0__STARTSHOWGETRAMENCUTSCENE_B__1_OFFSET UNITYSDK_OFFSET(0xC83FE40)

namespace MoleMole
{
	inline static constexpr unsigned int UIRamenStoreWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 37023;
