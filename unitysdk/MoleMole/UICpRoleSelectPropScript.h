...
#define MOLEMOLE_UICPROLESELECTPROPSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE383D0)

namespace MoleMole
{
	inline static constexpr unsigned int UICpRoleSelectPropScript_TypeDefinitionIndex = 81599;
