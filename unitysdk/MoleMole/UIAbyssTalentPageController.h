...
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_FINDNEXTTALENTPOINTCTRL_OFFSET UNITYSDK_OFFSET(0xC80A370)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_GETDEFAULTSELECT_OFFSET UNITYSDK_OFFSET(0xC80B690)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_GETISBOUNDSIDE_OFFSET UNITYSDK_OFFSET(0xC80B200)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xC808C80)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC808C90)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_INITTALENTTREE_OFFSET UNITYSDK_OFFSET(0xC809630)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_ONCLOSEBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC80D1C0)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC808CA0)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_ONICONBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC80C6D0)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC809CB0)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_ONITEMCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0xC80BA70)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_ONTALENTACTIVEHANDLE_OFFSET UNITYSDK_OFFSET(0xC80CC40)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_ONTALENTPOINTACTIVECLICK_OFFSET UNITYSDK_OFFSET(0xC80C830)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_ONTALENTPOINTCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xC80AC80)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC809B50)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC80D230)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC808D40)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC809170)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_REFRESHINFOVIEW_OFFSET UNITYSDK_OFFSET(0xC80BAF0)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_REFRESHPOINTVIEW_OFFSET UNITYSDK_OFFSET(0xC80B520)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC80D2C0)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER__INITTALENTTREE_B__13_0_OFFSET UNITYSDK_OFFSET(0xC80D3D0)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER__ONTALENTACTIVEHANDLE_B__22_0_OFFSET UNITYSDK_OFFSET(0xC80D4C0)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC80D4E0)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC80D550)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC80D580)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC80D590)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC80D5A0)
#define MOLEMOLE_UIABYSSTALENTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC80D5B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssTalentPageController_TypeDefinitionIndex = 68426;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_140* _view; // 0x2F8
		::System::Boolean _isStopRefreshData; // 0x300
		::Class_2_208CC9941471731A_111* currentTalentCfg; // 0x308
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSTALENTPAGECONTROLLER_ONTALENTACTIVEHANDLE_OFFSET))(this, rcvMessage);
		}
