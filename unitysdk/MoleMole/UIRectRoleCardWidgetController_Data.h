...
#define MOLEMOLE_UIRECTROLECARDWIDGETCONTROLLER_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAB8A740)

namespace MoleMole
{
	inline static constexpr unsigned int UIRectRoleCardWidgetController_Data_TypeDefinitionIndex = 70086;
