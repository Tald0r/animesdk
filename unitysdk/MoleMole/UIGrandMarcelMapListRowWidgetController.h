...
#define MOLEMOLE_UIGRANDMARCELMAPLISTROWWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xAD397A0)
#define MOLEMOLE_UIGRANDMARCELMAPLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD38D10)
#define MOLEMOLE_UIGRANDMARCELMAPLISTROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAD39B10)
#define MOLEMOLE_UIGRANDMARCELMAPLISTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAD39190)
#define MOLEMOLE_UIGRANDMARCELMAPLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD38DB0)
#define MOLEMOLE_UIGRANDMARCELMAPLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD38AA0)
#define MOLEMOLE_UIGRANDMARCELMAPLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD39D30)
#define MOLEMOLE_UIGRANDMARCELMAPLISTROWWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xAD39D40)
#define MOLEMOLE_UIGRANDMARCELMAPLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAD39D50)
#define MOLEMOLE_UIGRANDMARCELMAPLISTROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAD39DC0)
#define MOLEMOLE_UIGRANDMARCELMAPLISTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAD39E30)
#define MOLEMOLE_UIGRANDMARCELMAPLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAD39EB0)
#define MOLEMOLE_UIGRANDMARCELMAPLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAD39F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIGrandMarcelMapListRowWidgetController_TypeDefinitionIndex = 42249;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIGrandMarcelMapListRowWidgetController_TypeDefinitionIndex)->GetStaticField(0xCFF0);
		}
		::Class_2_61C99D337397632C_1* _view; // 0x2D0
