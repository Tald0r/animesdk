...
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_CALCUPOS_OFFSET UNITYSDK_OFFSET(0xBFD83D0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_GETDAMAGETEXTLENGTH_OFFSET UNITYSDK_OFFSET(0xBFD7F30)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_GETFINALDISPLAYPOS_OFFSET UNITYSDK_OFFSET(0xBFD8180)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_GET_ISTEXTHIDDEN_OFFSET UNITYSDK_OFFSET(0xBFD7BF0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xBFD7BE0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_HIDETEXT_OFFSET UNITYSDK_OFFSET(0xBFD8590)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xBFD8830)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_ONPAUSEGAMESTATECHANGED_OFFSET UNITYSDK_OFFSET(0xBFD9090)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFD7C00)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_ONUPDATETEXT_OFFSET UNITYSDK_OFFSET(0xBFD7FA0)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBFD8B10)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_SETPARENTCONTAINER_OFFSET UNITYSDK_OFFSET(0xBFD8010)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER_SHOWTEXT_OFFSET UNITYSDK_OFFSET(0xBFD8080)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xBFD9140)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFD9100)
#define MOLEMOLE_UIINLEVELDAMAGETEXTBASECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFD9180)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelDamageTextBaseController_TypeDefinitionIndex = 61917;
	...
	public:
		...
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(UIInLevelDamageTextBaseController_TypeDefinitionIndex)->GetStaticField(0xA240);
		}
