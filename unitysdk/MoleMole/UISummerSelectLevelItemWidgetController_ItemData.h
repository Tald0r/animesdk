...
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_GETMAXSCORECOUNT_OFFSET UNITYSDK_OFFSET(0x88800D0)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_GETNAME_OFFSET UNITYSDK_OFFSET(0x8880000)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_GETTABLEID_OFFSET UNITYSDK_OFFSET(0x88803C0)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_GETTIME_OFFSET UNITYSDK_OFFSET(0x8880320)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_ISLOCK_OFFSET UNITYSDK_OFFSET(0x8880150)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_SETRANKICON_OFFSET UNITYSDK_OFFSET(0x88801C0)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA_SORTMETHOD_OFFSET UNITYSDK_OFFSET(0x8880430)
#define MOLEMOLE_UISUMMERSELECTLEVELITEMWIDGETCONTROLLER_ITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8880530)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerSelectLevelItemWidgetController_ItemData_TypeDefinitionIndex = 78093;

	class UISummerSelectLevelItemWidgetController_ItemData : public ::System::Object
	{
	public:
		::Class_0_16E4307DCC419505_158* LevelData; // 0x10
		::Class_2_208CC9941471731A_325* TableInfo; // 0x18
		::Class_2_F69D29AB796376C2* _questTableInfo; // 0x20
		::System::String* ScoreTitleText; // 0x28
