...
#define MOLEMOLE_UIROLEEQUIPREPLACEWIDGETCONTROLLER___C__DISPLAYCLASS130_1__CTOR_OFFSET UNITYSDK_OFFSET(0xAFAE040)
#define MOLEMOLE_UIROLEEQUIPREPLACEWIDGETCONTROLLER___C__DISPLAYCLASS130_1__TRYSHOWPROFRESSIONLACKWEAPONTIP_G__SETGENERALCTRL_4_OFFSET UNITYSDK_OFFSET(0xAFAE050)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleEquipReplaceWidgetController___c__DisplayClass130_1_TypeDefinitionIndex = 57495;
	...
	public:
		...
		::Class_2_208CC9941471731A_612* generalTip; // 0x20
