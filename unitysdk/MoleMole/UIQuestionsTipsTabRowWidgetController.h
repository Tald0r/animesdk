...
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD2930A0)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD293220)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD293140)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD292F40)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD2936E0)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD293880)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD2938F0)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD293970)
#define MOLEMOLE_UIQUESTIONSTIPSTABROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD2939F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsTipsTabRowWidgetController_TypeDefinitionIndex = 47329;

	class UIQuestionsTipsTabRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Il2CppArray<::System::String*>* NumberPath; // 0x2D0
		::Class_2_D974C8170E0C9A87* _view; // 0x2D8
