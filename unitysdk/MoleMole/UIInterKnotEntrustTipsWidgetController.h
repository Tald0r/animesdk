...
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA1E42D0)
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER_ISON_OFFSET UNITYSDK_OFFSET(0xA1E44B0)
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA1E4340)
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER_SETCALLBACK_OFFSET UNITYSDK_OFFSET(0xA1E4440)
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER_SETISON_OFFSET UNITYSDK_OFFSET(0xA1E4580)
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA1E4660)
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA1E4690)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotEntrustTipsWidgetController_TypeDefinitionIndex = 62687;

	class UIInterKnotEntrustTipsWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::System::Action_1<::System::Boolean>* callback; // 0x2A0
