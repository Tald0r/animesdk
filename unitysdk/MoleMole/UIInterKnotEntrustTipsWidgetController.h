...
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9D76F50)
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER_ISON_OFFSET UNITYSDK_OFFSET(0x9D77130)
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9D76FC0)
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER_SETCALLBACK_OFFSET UNITYSDK_OFFSET(0x9D770C0)
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER_SETISON_OFFSET UNITYSDK_OFFSET(0x9D77200)
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D772E0)
#define MOLEMOLE_UIINTERKNOTENTRUSTTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9D77310)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotEntrustTipsWidgetController_TypeDefinitionIndex = 42208;
