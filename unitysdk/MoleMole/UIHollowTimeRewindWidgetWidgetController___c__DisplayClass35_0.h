...
#define MOLEMOLE_UIHOLLOWTIMEREWINDWIDGETWIDGETCONTROLLER___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB124640)
#define MOLEMOLE_UIHOLLOWTIMEREWINDWIDGETWIDGETCONTROLLER___C__DISPLAYCLASS35_0__ONTIMEREWINDNOTIFY_B__0_OFFSET UNITYSDK_OFFSET(0xB124650)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowTimeRewindWidgetWidgetController___c__DisplayClass35_0_TypeDefinitionIndex = 55518;

	class UIHollowTimeRewindWidgetWidgetController___c__DisplayClass35_0 : public ::System::Object
	{
	public:
		::MoleMole::UIHollowTimeRewindWidgetWidgetController* __4__this; // 0x10
		::MoleMole::UIHollowTimeRewindFillWidgetWidgetController* local; // 0x18
