...
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER_GETBUTTON_OFFSET UNITYSDK_OFFSET(0x95FDD60)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x95FD860)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95FDBD0)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER_ONDROPDOWNSELECT_OFFSET UNITYSDK_OFFSET(0x95FDEE0)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95FDC70)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95FD690)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95FD730)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER_REFRESHCONTEXT_OFFSET UNITYSDK_OFFSET(0x95FE020)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER_SETENABLE_OFFSET UNITYSDK_OFFSET(0x95FDE20)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER_SETINITSELECTINDEX_OFFSET UNITYSDK_OFFSET(0x95FDFA0)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x95FE0A0)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95FE0D0)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95FE140)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95FE1C0)
#define MOLEMOLE_UIGENERALOPTIONLISTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95FE220)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralOptionListRowWidgetController_TypeDefinitionIndex = 61681;
