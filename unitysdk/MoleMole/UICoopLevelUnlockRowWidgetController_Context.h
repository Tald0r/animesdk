...
#define MOLEMOLE_UICOOPLEVELUNLOCKROWWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x90F3D80)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopLevelUnlockRowWidgetController_Context_TypeDefinitionIndex = 43277;

	class UICoopLevelUnlockRowWidgetController_Context : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_2_208CC9941471731A_926* CoopQuestTemplate; // 0x28
		::System::String* TextKey; // 0x30
		::Class_2_F69D29AB796376C2* QuestTemplate; // 0x38
		::System::Boolean ShowNightmare; // 0x40
		::System::Boolean ShowStudy; // 0x41
