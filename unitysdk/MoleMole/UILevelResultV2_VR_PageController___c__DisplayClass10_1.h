...
#define MOLEMOLE_UILEVELRESULTV2_VR_PAGECONTROLLER___C__DISPLAYCLASS10_1__CTOR_OFFSET UNITYSDK_OFFSET(0x7FAD7E0)
#define MOLEMOLE_UILEVELRESULTV2_VR_PAGECONTROLLER___C__DISPLAYCLASS10_1__REFRESHFAIRYBTNSTATE_B__18_OFFSET UNITYSDK_OFFSET(0x7FAD7F0)
#define MOLEMOLE_UILEVELRESULTV2_VR_PAGECONTROLLER___C__DISPLAYCLASS10_1__REFRESHFAIRYBTNSTATE_B__19_OFFSET UNITYSDK_OFFSET(0x7FAD820)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultV2_VR_PageController___c__DisplayClass10_1_TypeDefinitionIndex = 58401;
