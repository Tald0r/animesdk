...
#define MOLEMOLE_UIOVERLORDFEASTMISSIONPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAE2A610)

namespace MoleMole
{
	inline static constexpr unsigned int UIOverlordFeastMissionPageContext_TypeDefinitionIndex = 73125;
