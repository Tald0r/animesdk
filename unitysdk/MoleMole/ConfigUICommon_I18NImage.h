...
#define MOLEMOLE_CONFIGUICOMMON_I18NIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x13FAF860)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICommon_I18NImage_TypeDefinitionIndex = 63243;
