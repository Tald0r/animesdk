...
#define MOLEMOLE_MAINCITYQUICFUNCSHOWOBJ_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0xB5ECAB0)
#define MOLEMOLE_MAINCITYQUICFUNCSHOWOBJ_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xB5ECAA0)
#define MOLEMOLE_MAINCITYQUICFUNCSHOWOBJ_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xB5ECAD0)
#define MOLEMOLE_MAINCITYQUICFUNCSHOWOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0xB5ECAC0)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityQuicFuncShowObj_TypeDefinitionIndex = 77358;
