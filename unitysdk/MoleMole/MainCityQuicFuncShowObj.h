...
#define MOLEMOLE_MAINCITYQUICFUNCSHOWOBJ_GET_ISTRIGGERINLOADING_OFFSET UNITYSDK_OFFSET(0x6AFD5B0)
#define MOLEMOLE_MAINCITYQUICFUNCSHOWOBJ_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x6AFD5A0)
#define MOLEMOLE_MAINCITYQUICFUNCSHOWOBJ_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x6AFD5D0)
#define MOLEMOLE_MAINCITYQUICFUNCSHOWOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x6AFD5C0)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityQuicFuncShowObj_TypeDefinitionIndex = 46159;
