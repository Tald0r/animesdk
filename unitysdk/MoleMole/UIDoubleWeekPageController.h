...
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_BINDNOTIFICATION_OFFSET UNITYSDK_OFFSET(0xC611F80)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_DOREFRESHBINGOFORSINGLEGRID_OFFSET UNITYSDK_OFFSET(0xC613F50)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xC611F70)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC610890)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC610AA0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC6108A0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0xC612910)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONSELECTGRID_OFFSET UNITYSDK_OFFSET(0xC612AD0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC611970)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONTAKEGRIDREWARDS_OFFSET UNITYSDK_OFFSET(0xC614610)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONTAKESCOREREWARDS_OFFSET UNITYSDK_OFFSET(0xC6145A0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC611320)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC610A30)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC6117F0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_OPENINFO_OFFSET UNITYSDK_OFFSET(0xC613840)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_REFRESHBINGOFORGRID_OFFSET UNITYSDK_OFFSET(0xC613A20)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_REFRESHBINGOTARGET_OFFSET UNITYSDK_OFFSET(0xC612980)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_REFRESHCURRENCY_OFFSET UNITYSDK_OFFSET(0xC6125D0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_REFRESHGRIDS_OFFSET UNITYSDK_OFFSET(0xC6121A0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_REFRESHSCORE_OFFSET UNITYSDK_OFFSET(0xC612100)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xC6119F0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xC6118A0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_TAKEALLGRIDREWARDS_OFFSET UNITYSDK_OFFSET(0xC614300)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER_TRYTAKESPECIALREWARDS_OFFSET UNITYSDK_OFFSET(0xC6113C0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC614680)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER__INITVIEW_B__11_1_OFFSET UNITYSDK_OFFSET(0xC614690)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER__INITVIEW_B__11_2_OFFSET UNITYSDK_OFFSET(0xC6146F0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER__INITVIEW_B__11_3_OFFSET UNITYSDK_OFFSET(0xC614760)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER__INITVIEW_B__11_4_OFFSET UNITYSDK_OFFSET(0xC6147D0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC6147E0)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC614850)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC614860)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC614870)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC614880)
#define MOLEMOLE_UIDOUBLEWEEKPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xC6148F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleWeekPageController_TypeDefinitionIndex = 55543;

	class UIDoubleWeekPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_40* _view; // 0x2F8
		::Class_2_80EC5A94E858E47B* _integralRewardHandler; // 0x300
		::System::Collections::Generic::List_1<::Class_3_31FA216B8128BBFD_1*>* _grids; // 0x308
