...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS51_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB2B60F0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS51_0__PLAYNOAVATARSTORYNODE_B__0_OFFSET UNITYSDK_OFFSET(0xB2B6100)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS51_0__PLAYNOAVATARSTORYNODE_B__1_OFFSET UNITYSDK_OFFSET(0xB2B6150)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS51_0__PLAYNOAVATARSTORYNODE_B__2_OFFSET UNITYSDK_OFFSET(0xB2B6190)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS51_0__PLAYNOAVATARSTORYNODE_B__3_OFFSET UNITYSDK_OFFSET(0xB2B6130)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass51_0_TypeDefinitionIndex = 58926;
