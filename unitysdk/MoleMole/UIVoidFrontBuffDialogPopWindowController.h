...
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER_GETBUFFLEVELDESC_OFFSET UNITYSDK_OFFSET(0x79145D0)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x7913B40)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x7913B30)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER_INITBUFFDIALOG_OFFSET UNITYSDK_OFFSET(0x79147A0)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7913B50)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x7913FD0)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER_ONSELECTBUFFITEM_OFFSET UNITYSDK_OFFSET(0x7914AC0)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7913E90)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7913BF0)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7913F20)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER_SHOWBUFFLEVELPANEL_OFFSET UNITYSDK_OFFSET(0x7914070)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7914BC0)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__8_0_OFFSET UNITYSDK_OFFSET(0x7914C50)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7914C60)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x7914CD0)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7914D30)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7914D40)
#define MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7914D50)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontBuffDialogPopWindowController_TypeDefinitionIndex = 73938;

	class UIVoidFrontBuffDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_FF33B5ED14FB44B2_3* _view; // 0x2F8
		...
		::System::String* GetBuffLevelDesc(::System::Int32 battleId, ::Enum_3_96F6662CA3713095_1 curRankType, ::Enum_3_96F6662CA3713095_1 needType)
		{
			return ((::System::String*(*)(::PVOID, ::System::Int32, ::Enum_3_96F6662CA3713095_1, ::Enum_3_96F6662CA3713095_1))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVOIDFRONTBUFFDIALOGPOPWINDOWCONTROLLER_GETBUFFLEVELDESC_OFFSET))(this, battleId, curRankType, needType);
		}
