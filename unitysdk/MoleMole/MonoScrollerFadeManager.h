...
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_FASTFORWARDTOANIMEND_OFFSET UNITYSDK_OFFSET(0xCD65D20)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xCD650A0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xCD650B0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_METHOD_5_1F130271093617A5_OFFSET UNITYSDK_OFFSET(0xCD65FD0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_METHOD_5_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xCD65BD0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xCD65810)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_METHOD_5_E01AB12B6F23773D_OFFSET UNITYSDK_OFFSET(0xCD661D0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_PLAYWHENSTOP_OFFSET UNITYSDK_OFFSET(0xCD658B0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_PLAY_OFFSET UNITYSDK_OFFSET(0xCD656E0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_RESET_OFFSET UNITYSDK_OFFSET(0xCD65920)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD65FA0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoScrollerFadeManager_TypeDefinitionIndex = 69791;
