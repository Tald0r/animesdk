...
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_FASTFORWARDTOANIMEND_OFFSET UNITYSDK_OFFSET(0x7F1B6A0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x7F1AA20)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0x7F1AA30)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_METHOD_5_1F130271093617A5_OFFSET UNITYSDK_OFFSET(0x7F1BA10)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_METHOD_5_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0x7F1B550)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x7F1B190)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_METHOD_5_E01AB12B6F23773D_OFFSET UNITYSDK_OFFSET(0x7F1B950)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_PLAYWHENSTOP_OFFSET UNITYSDK_OFFSET(0x7F1B230)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_PLAY_OFFSET UNITYSDK_OFFSET(0x7F1B060)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER_RESET_OFFSET UNITYSDK_OFFSET(0x7F1B2A0)
#define MOLEMOLE_MONOSCROLLERFADEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F1B920)

namespace MoleMole
{
	inline static constexpr unsigned int MonoScrollerFadeManager_TypeDefinitionIndex = 46364;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOSCROLLERFADEMANAGER_METHOD_5_25DEA5C65A602671_OFFSET))(this);
		}
