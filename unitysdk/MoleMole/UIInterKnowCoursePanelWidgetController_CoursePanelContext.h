...
#define MOLEMOLE_UIINTERKNOWCOURSEPANELWIDGETCONTROLLER_COURSEPANELCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6CACD70)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnowCoursePanelWidgetController_CoursePanelContext_TypeDefinitionIndex = 69421;
	...
	public:
		...
		::System::Int32 showEndNodeIdx; // 0x34
		::System::Int32 focusTargetNode; // 0x38
		::System::Int32 showStartNodeIdx; // 0x3C
