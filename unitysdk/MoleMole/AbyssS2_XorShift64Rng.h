...
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_GET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x620F600)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x620F620)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x620F740)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTINT_OFFSET UNITYSDK_OFFSET(0x620F6B0)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTLONG_OFFSET UNITYSDK_OFFSET(0x620F7E0)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTUINT_OFFSET UNITYSDK_OFFSET(0x620F870)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTULONG_OFFSET UNITYSDK_OFFSET(0x620F900)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_RANGEINT_OFFSET UNITYSDK_OFFSET(0x620F990)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_SET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x620F610)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG__CTOR_OFFSET UNITYSDK_OFFSET(0x620F5F0)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_XorShift64Rng_TypeDefinitionIndex = 68790;
