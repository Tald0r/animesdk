...
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_GET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x84E2FB0)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x84E2FD0)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x84E30F0)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTINT_OFFSET UNITYSDK_OFFSET(0x84E3060)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTLONG_OFFSET UNITYSDK_OFFSET(0x84E3190)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTUINT_OFFSET UNITYSDK_OFFSET(0x84E3220)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_NEXTULONG_OFFSET UNITYSDK_OFFSET(0x84E32B0)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_RANGEINT_OFFSET UNITYSDK_OFFSET(0x84E3340)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG_SET_RNGSEED_OFFSET UNITYSDK_OFFSET(0x84E2FC0)
#define MOLEMOLE_ABYSSS2_XORSHIFT64RNG__CTOR_OFFSET UNITYSDK_OFFSET(0x84E2FA0)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_XorShift64Rng_TypeDefinitionIndex = 77512;
