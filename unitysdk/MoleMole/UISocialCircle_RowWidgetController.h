...
#define MOLEMOLE_UISOCIALCIRCLE_ROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAE486F0)
#define MOLEMOLE_UISOCIALCIRCLE_ROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAE48760)
#define MOLEMOLE_UISOCIALCIRCLE_ROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE48860)
#define MOLEMOLE_UISOCIALCIRCLE_ROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAE48890)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircle_RowWidgetController_TypeDefinitionIndex = 57516;
