...
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM_GET_CURRENTTEMPLATE_OFFSET UNITYSDK_OFFSET(0xB18FAC0)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM_INITDATA_OFFSET UNITYSDK_OFFSET(0xB18FCB0)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB18FAE0)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB18FF10)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM_ONQUESTADD_OFFSET UNITYSDK_OFFSET(0xB1900E0)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM_SET_CURRENTTEMPLATE_OFFSET UNITYSDK_OFFSET(0xB18FAD0)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB1902C0)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB1902E0)
#define MOLEMOLE_FORBIDDENQUESTUNLOCKEDSUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB190340)

namespace MoleMole
{
	inline static constexpr unsigned int ForbiddenQuestUnlockedSubsystem_TypeDefinitionIndex = 70263;
