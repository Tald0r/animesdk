...
class Class_2_22A64AF0CF608D0B;
namespace MoleMole { class UIABInLevelGeneralWidgetController; }
namespace MoleMole { class UIControlReference; }
namespace System { class Object; }

#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_BINDVIEW_OFFSET UNITYSDK_OFFSET(0xC268050)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xC268DC0)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC267E10)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xC268E50)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC267F90)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC267EB0)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC267C20)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC269010)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0xC269020)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC269030)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xC2690A0)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC269110)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC269190)
#define MOLEMOLE_UIAUTOBATTLECAMPITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC269210)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattleCampItemWidgetController_TypeDefinitionIndex = 78839;

	class UIAutoBattleCampItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_22A64AF0CF608D0B* _view; // 0x2D0
		::MoleMole::UIABInLevelGeneralWidgetController* _parent; // 0x2D8
