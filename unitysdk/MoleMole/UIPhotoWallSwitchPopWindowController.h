...
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_DATACOMPARISON_OFFSET UNITYSDK_OFFSET(0xBE69220)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_GETCURRENTDATA_OFFSET UNITYSDK_OFFSET(0xBE69AD0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_GETCURRENTINDEX_OFFSET UNITYSDK_OFFSET(0xBE69920)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_GETORCREATECONTEXT_OFFSET UNITYSDK_OFFSET(0xBE69BD0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xBE67D30)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONCLICKCONFIRMCALLBACK_OFFSET UNITYSDK_OFFSET(0xBE69E40)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONCLICKDELCALLBACK_OFFSET UNITYSDK_OFFSET(0xBE6A180)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONCLICKRENAMECALLBACK_OFFSET UNITYSDK_OFFSET(0xBE6A450)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBE69490)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xBE695C0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xBE696C0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONSELECTCHILD_OFFSET UNITYSDK_OFFSET(0xBE699E0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBE68330)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBE69530)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBE67D40)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBE68280)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_PHOTOWALLADDNEWSCHEMEHANDLE_OFFSET UNITYSDK_OFFSET(0xBE6A5C0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_REFRESHBTN_OFFSET UNITYSDK_OFFSET(0xBE68BB0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER_REFRESHSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xBE68410)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBE6A650)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBE6A6E0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xBE6A750)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xBE6A7D0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBE6A890)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBE6A8A0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBE6A8B0)
#define MOLEMOLE_UIPHOTOWALLSWITCHPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBE6A8C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWallSwitchPopWindowController_TypeDefinitionIndex = 77326;
