...
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_RECOMMANDLOGIC_ONOKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x953CD70)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_RECOMMANDLOGIC_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x953CCA0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_RECOMMANDLOGIC__CTOR_OFFSET UNITYSDK_OFFSET(0x9539B60)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_RECOMMANDLOGIC___BASE_ONOKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x953D0A0)
#define MOLEMOLE_UIVHSSTOREDIALOGV2POPWINDOWCONTROLLER_RECOMMANDLOGIC___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x953D100)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreDialogV2PopWindowController_RecommandLogic_TypeDefinitionIndex = 77180;
