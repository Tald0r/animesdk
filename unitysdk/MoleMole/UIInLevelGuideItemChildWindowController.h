...
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_BINDSPEEDTYPE_OFFSET UNITYSDK_OFFSET(0x8942100)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_CANPLAYFADEONINIT_OFFSET UNITYSDK_OFFSET(0x8942EA0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x89443F0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_GETGUIDEITEMFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x8943270)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_GETGUIDEITEMFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x8943F30)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_GETSELFSCREENPOSITION_OFFSET UNITYSDK_OFFSET(0x8946450)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_GETTARGETSCREENPOSITION_OFFSET UNITYSDK_OFFSET(0x89464E0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x8946DA0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8942930)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x8945050)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_INITICONBYCOMPTYPE_OFFSET UNITYSDK_OFFSET(0x8944960)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_INITICON_OFFSET UNITYSDK_OFFSET(0x8944BB0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_INITTEAMINDEX_OFFSET UNITYSDK_OFFSET(0x8944C40)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x8942A50)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_ISINCAMERAVIEWPORT_OFFSET UNITYSDK_OFFSET(0x8944750)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_ISINFADESTATE_OFFSET UNITYSDK_OFFSET(0x8945240)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_ISINSCENECAMERABACK_OFFSET UNITYSDK_OFFSET(0x8946550)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_ISSHOWARROW_OFFSET UNITYSDK_OFFSET(0x8944380)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8942940)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x89436D0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x89435E0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x8943770)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8943320)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8943550)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x89429E0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8942CE0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x89438F0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_PLAYWARNINGWITHANIM_OFFSET UNITYSDK_OFFSET(0x8942060)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_PLAYWARNINGWITHTWEEN_OFFSET UNITYSDK_OFFSET(0x8942440)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x89444C0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_SETCONTROLVISIBLE_OFFSET UNITYSDK_OFFSET(0x8946310)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_SETDISPLAYMODE_OFFSET UNITYSDK_OFFSET(0x8944080)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_SETICONWARNING_OFFSET UNITYSDK_OFFSET(0x8942750)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_SETINIT_OFFSET UNITYSDK_OFFSET(0x89439B0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_SETSCREENPARAM_OFFSET UNITYSDK_OFFSET(0x89452B0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_SETSTYLE_OFFSET UNITYSDK_OFFSET(0x8944310)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_SETVISIBLE_OFFSET UNITYSDK_OFFSET(0x8943A80)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_SET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0x8946DB0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_SHOULDUPDATEARROWORTARGATICON_OFFSET UNITYSDK_OFFSET(0x8946620)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_SHOULDUPDATERECTTRANSFORMANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x8946CE0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_STARTFADE_OFFSET UNITYSDK_OFFSET(0x8945100)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_STOPWARNINGWITHANIM_OFFSET UNITYSDK_OFFSET(0x89423C0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_STOPWARNINGWITHTWEEN_OFFSET UNITYSDK_OFFSET(0x8942600)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x8945370)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_TRYPLAYFADE_OFFSET UNITYSDK_OFFSET(0x8943810)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_UPDATEALPHA_OFFSET UNITYSDK_OFFSET(0x8946BA0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_UPDATEARROW_OFFSET UNITYSDK_OFFSET(0x89456A0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_UPDATESELFPOS_OFFSET UNITYSDK_OFFSET(0x8946860)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_UPDATETARGETICON_OFFSET UNITYSDK_OFFSET(0x8945D30)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_UPDATETEXTPOS_OFFSET UNITYSDK_OFFSET(0x8946A40)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_WAITARROWINVISIBLE_OFFSET UNITYSDK_OFFSET(0x8944270)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER_WAITINVISIBLE_OFFSET UNITYSDK_OFFSET(0x8943FE0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER__BINDSPEEDTYPE_B__9_0_OFFSET UNITYSDK_OFFSET(0x8946DF0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER__CACHECLEAN_OFFSET UNITYSDK_OFFSET(0x8943480)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8946DC0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x8946FC0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8947020)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x8947090)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x89470F0)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8947100)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8947110)
#define MOLEMOLE_UIINLEVELGUIDEITEMCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8947120)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelGuideItemChildWindowController_TypeDefinitionIndex = 50940;
