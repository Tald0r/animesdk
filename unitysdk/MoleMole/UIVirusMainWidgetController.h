...
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_GETCOLLECTSHOWITEM_OFFSET UNITYSDK_OFFSET(0xAA7E240)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_GET_SELECTQUESTID_OFFSET UNITYSDK_OFFSET(0xAA7BBA0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_HIDEALLSHOWITEM_OFFSET UNITYSDK_OFFSET(0xAA7E040)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_MOVETOLEVELPROCESS_OFFSET UNITYSDK_OFFSET(0xAA7D540)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONCLICKLEVELBTN_OFFSET UNITYSDK_OFFSET(0xAA7E390)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONCLICKQUEST_OFFSET UNITYSDK_OFFSET(0xAA7D740)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAA7BC20)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xAA7C430)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xAA7D610)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAA7C380)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONSELECTQUEST_OFFSET UNITYSDK_OFFSET(0xAA7DAB0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAA7C090)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAA7BEB0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAA7C170)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_PLAYLEVELUPANIMBYCO_OFFSET UNITYSDK_OFFSET(0xAA7D490)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_PLAYLEVELUPANIM_OFFSET UNITYSDK_OFFSET(0xAA7C4E0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_RECORDTABSHOW_OFFSET UNITYSDK_OFFSET(0xAA7CE60)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHLEVEL_OFFSET UNITYSDK_OFFSET(0xAA7C870)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHQUESTS_OFFSET UNITYSDK_OFFSET(0xAA7CA70)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHVIRUSCOLLECTTIPS_OFFSET UNITYSDK_OFFSET(0xAA7DBF0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHWIDGET_OFFSET UNITYSDK_OFFSET(0xAA7C7C0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_SETLEVEL_OFFSET UNITYSDK_OFFSET(0xAA7D320)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_SETPOINT_OFFSET UNITYSDK_OFFSET(0xAA7D050)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_SETVIRUSCOLLECTTIPS_OFFSET UNITYSDK_OFFSET(0xAA7DDA0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAA7E500)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAA7E600)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xAA7E670)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xAA7E680)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAA7E700)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAA7E760)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAA7E7E0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAA7E840)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusMainWidgetController_TypeDefinitionIndex = 48842;
	...
	public:
		...
		::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317 _levelType; // 0x2B0
		...
		::System::Void RefreshWidget(::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317 levelType, ::System::Int32 questID)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHWIDGET_OFFSET))(this, levelType, questID);
		}

		::System::Void RecordTabShow(::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317 levelType)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_RECORDTABSHOW_OFFSET))(this, levelType);
		}
		...
		::System::Void RefreshQuests(::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317 levelType, ::System::Int32 questID)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHQUESTS_OFFSET))(this, levelType, questID);
		}
