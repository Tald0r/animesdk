...
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_GETCOLLECTSHOWITEM_OFFSET UNITYSDK_OFFSET(0xEE574B0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_GET_SELECTQUESTID_OFFSET UNITYSDK_OFFSET(0xEE54E00)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_HIDEALLSHOWITEM_OFFSET UNITYSDK_OFFSET(0xEE572B0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_MOVETOLEVELPROCESS_OFFSET UNITYSDK_OFFSET(0xEE567A0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONCLICKLEVELBTN_OFFSET UNITYSDK_OFFSET(0xEE57600)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONCLICKQUEST_OFFSET UNITYSDK_OFFSET(0xEE569A0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xEE54E80)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xEE55690)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xEE56870)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xEE555E0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONSELECTQUEST_OFFSET UNITYSDK_OFFSET(0xEE56D20)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xEE552F0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xEE55110)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xEE553D0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_PLAYLEVELUPANIMBYCO_OFFSET UNITYSDK_OFFSET(0xEE566F0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_PLAYLEVELUPANIM_OFFSET UNITYSDK_OFFSET(0xEE55740)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_RECORDTABSHOW_OFFSET UNITYSDK_OFFSET(0xEE560C0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHLEVEL_OFFSET UNITYSDK_OFFSET(0xEE55AD0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHQUESTS_OFFSET UNITYSDK_OFFSET(0xEE55CD0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHVIRUSCOLLECTTIPS_OFFSET UNITYSDK_OFFSET(0xEE56E60)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHWIDGET_OFFSET UNITYSDK_OFFSET(0xEE55A20)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_SETLEVEL_OFFSET UNITYSDK_OFFSET(0xEE56580)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_SETPOINT_OFFSET UNITYSDK_OFFSET(0xEE562B0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_SETVIRUSCOLLECTTIPS_OFFSET UNITYSDK_OFFSET(0xEE57010)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xEE57770)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xEE57870)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xEE578E0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0xEE578F0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xEE57970)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xEE579D0)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xEE57A50)
#define MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xEE57AB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusMainWidgetController_TypeDefinitionIndex = 57588;

	class UIVirusMainWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		// static const ::System::String* ShowPanelAnimFadeIn; // 0x0
		// static const ::System::String* ShowPanelAnimFadeOut; // 0x0
		// static const ::System::String* LevelUpAnim; // 0x0
		::Class_2_7CD0CB2DB1477D73* _view; // 0x2A0
		::MoleMole::UIVirusMainWidgetController_Context* _context; // 0x2A8
		::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 _levelType; // 0x2B0
		::System::Int32 _normalSelectQuestID; // 0x2B4
		::System::Int32 _hardSelectQuestID; // 0x2B8
		::System::Collections::Generic::List_1<::MoleMole::UIVirusStageRowWidgetController_Data*>* _dataList; // 0x2C0
		::System::Collections::Generic::List_1<::MoleMole::UIVirusShowRowWidgetController*>* _collectShowItems; // 0x2C8
		::Foundation::Coroutine::CoroutineHandle _levelUpCoHandle; // 0x2D0
		::System::Boolean _needLevelUpAnim; // 0x2D4
		::System::Int32 _levelUpStartPoint; // 0x2D8
		::System::Int32 _levelUpEndPoint; // 0x2DC
		::System::Int32 _collectTipsQuestID; // 0x2E0
		...
		::System::Void RefreshWidget(::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 levelType, ::System::Int32 questID)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHWIDGET_OFFSET))(this, levelType, questID);
		}

		::System::Void RecordTabShow(::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 levelType)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_RECORDTABSHOW_OFFSET))(this, levelType);
		}
		...
		::System::Void RefreshQuests(::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 levelType, ::System::Int32 questID)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSMAINWIDGETCONTROLLER_REFRESHQUESTS_OFFSET))(this, levelType, questID);
		}
