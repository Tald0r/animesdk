...
#define MOLEMOLE_DYNAMICOVERRIDEWEATHERV2ENTRY_ISVALID_OFFSET UNITYSDK_OFFSET(0x3C0A80)

namespace MoleMole
{
	inline static constexpr unsigned int DynamicOverrideWeatherV2Entry_TypeDefinitionIndex = 40522;
