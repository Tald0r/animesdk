...
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xC3DD300)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER_ISALIVE_OFFSET UNITYSDK_OFFSET(0xC3DD500)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC3DD180)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC3DD220)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC3DD030)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC3DD0D0)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC3DD580)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC3DD5B0)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC3DD620)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC3DD6A0)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC3DD700)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerShootScoreWidgetController_TypeDefinitionIndex = 65371;
