...
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xA10A570)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER_ISALIVE_OFFSET UNITYSDK_OFFSET(0xA10A770)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA10A3F0)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA10A490)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA10A2A0)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA10A340)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA10A7F0)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA10A820)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA10A890)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA10A910)
#define MOLEMOLE_UISUMMERSHOOTSCOREWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA10A970)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerShootScoreWidgetController_TypeDefinitionIndex = 46281;
