...
#define MOLEMOLE_UIBPPAGETOPBTNWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0xA316640)
#define MOLEMOLE_UIBPPAGETOPBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA3164C0)
#define MOLEMOLE_UIBPPAGETOPBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA316560)
#define MOLEMOLE_UIBPPAGETOPBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA316370)
#define MOLEMOLE_UIBPPAGETOPBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA316410)
#define MOLEMOLE_UIBPPAGETOPBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3166B0)
#define MOLEMOLE_UIBPPAGETOPBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA3166E0)
#define MOLEMOLE_UIBPPAGETOPBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA316750)
#define MOLEMOLE_UIBPPAGETOPBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA3167D0)
#define MOLEMOLE_UIBPPAGETOPBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA316830)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPPageTopBtnWidgetController_TypeDefinitionIndex = 43075;
