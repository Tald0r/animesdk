...
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATEALLOWWHITELIST_GET_STATE_OFFSET UNITYSDK_OFFSET(0xD57F8A0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATEALLOWWHITELIST_ONCHANGESTATE_OFFSET UNITYSDK_OFFSET(0xD57F8B0)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATEALLOWWHITELIST__CTOR_OFFSET UNITYSDK_OFFSET(0xD575D10)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATEALLOWWHITELIST___BASE_ONCHANGESTATE_OFFSET UNITYSDK_OFFSET(0xD57FE40)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleWidgetController_NewsBubbleStateAllowWhiteList_TypeDefinitionIndex = 75075;
