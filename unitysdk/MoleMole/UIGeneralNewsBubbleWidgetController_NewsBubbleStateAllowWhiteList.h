...
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATEALLOWWHITELIST_GET_STATE_OFFSET UNITYSDK_OFFSET(0xC128720)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATEALLOWWHITELIST_ONCHANGESTATE_OFFSET UNITYSDK_OFFSET(0xC128730)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATEALLOWWHITELIST__CTOR_OFFSET UNITYSDK_OFFSET(0xC11EB90)
#define MOLEMOLE_UIGENERALNEWSBUBBLEWIDGETCONTROLLER_NEWSBUBBLESTATEALLOWWHITELIST___BASE_ONCHANGESTATE_OFFSET UNITYSDK_OFFSET(0xC128CC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleWidgetController_NewsBubbleStateAllowWhiteList_TypeDefinitionIndex = 68356;
