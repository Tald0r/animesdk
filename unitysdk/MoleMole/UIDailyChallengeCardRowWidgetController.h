...
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x8BCCAA0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_ENABLEIMGOFFSET_OFFSET UNITYSDK_OFFSET(0xDF75E40)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_FORCEINITLOOPTEXT_OFFSET UNITYSDK_OFFSET(0x8BCCCA0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_GETLOOPTEXTRUNINGTIME_OFFSET UNITYSDK_OFFSET(0xDF75EB0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8BCC900)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_GET__VIEW_OFFSET UNITYSDK_OFFSET(0x8BCC970)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xDF786E0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8BCCEA0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BCC9E0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xDF78890)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xDF761E0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0xDF78960)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETALWAYSINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xDF76170)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETBUTTONENABLE_OFFSET UNITYSDK_OFFSET(0xDF78000)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETCONSOLEKEY_OFFSET UNITYSDK_OFFSET(0xDF75D20)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETDATA_1_OFFSET UNITYSDK_OFFSET(0xDF77E40)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0xDF77C90)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETDOUBLETIP_OFFSET UNITYSDK_OFFSET(0xDF78430)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETEMPTYLOCK_OFFSET UNITYSDK_OFFSET(0xDF76090)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETENABLEADD_OFFSET UNITYSDK_OFFSET(0xDF76020)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETENABLECOOLDOWN_OFFSET UNITYSDK_OFFSET(0xDF75A90)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETIGNORESHOWSPOILED_OFFSET UNITYSDK_OFFSET(0xDF76100)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETOVERRIDELOCKSTATE_OFFSET UNITYSDK_OFFSET(0xDF78080)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETREWARDBUFFICON_OFFSET UNITYSDK_OFFSET(0xDF780F0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SETUPICON_OFFSET UNITYSDK_OFFSET(0xDF782B0)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER_SYNCANIMATION_OFFSET UNITYSDK_OFFSET(0xDF75B00)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF78A10)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDF78A40)
#define MOLEMOLE_UIDAILYCHALLENGECARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF78AB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyChallengeCardRowWidgetController_TypeDefinitionIndex = 79636;
