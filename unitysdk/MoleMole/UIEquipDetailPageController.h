...
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0xBFF5660)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_BINDNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0xBFFFDF0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_DESTROYWEAPONVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0xBFFF750)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_DOREFRESHVIEWCOMMON_OFFSET UNITYSDK_OFFSET(0xBFFB760)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_GETRTSOUNDGO_OFFSET UNITYSDK_OFFSET(0xC000AD0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_GETWEAPONRTANIMATOR_OFFSET UNITYSDK_OFFSET(0xBFF9C30)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xBFF2C50)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_GET_INPREVIEWMODE_OFFSET UNITYSDK_OFFSET(0xBFF2A30)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_GET_ROTATESPEED_OFFSET UNITYSDK_OFFSET(0xBFFD020)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xBFF2A20)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_HANDLEZHENZHENWEAPONSTART_OFFSET UNITYSDK_OFFSET(0xBFFD740)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xBFF3D00)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_INITWEAPON2DSWITCH_OFFSET UNITYSDK_OFFSET(0xBFFB510)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_INITWEAPONVIDEOPLAYER_OFFSET UNITYSDK_OFFSET(0xC0007D0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ISHOLLOWGAMEROOM_OFFSET UNITYSDK_OFFSET(0xBFF3B30)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONBACKBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xBFF5B80)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKINFOBTN_OFFSET UNITYSDK_OFFSET(0xBFF8690)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKLEVELUPBTN_OFFSET UNITYSDK_OFFSET(0xBFF8880)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKPREVIEWBTN_OFFSET UNITYSDK_OFFSET(0xBFF62C0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKREFINELEVELPREVIEWBTN_OFFSET UNITYSDK_OFFSET(0xBFF8DD0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKSPINFOBTN_OFFSET UNITYSDK_OFFSET(0xBFF58B0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKSTARUPBTN_OFFSET UNITYSDK_OFFSET(0xBFF5E60)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCLICKSWITCHWEAPON2DBTN_OFFSET UNITYSDK_OFFSET(0xC000040)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFF2BB0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONEQUIPRTLOADED_OFFSET UNITYSDK_OFFSET(0xBFFDB20)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xBFFEFD0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBFF91B0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONITEMCHANGE_OFFSET UNITYSDK_OFFSET(0xBFFF310)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xBFF2C60)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONMAINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xBFF8BC0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONSHOWFRIENDPREVIEWMODEHINT_OFFSET UNITYSDK_OFFSET(0xBFF5D50)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONSHOWPREVIEWMODEHINT_OFFSET UNITYSDK_OFFSET(0xBFF5C40)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBFFE570)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONSTORYINFOBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xBFF3350)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONSTORYINFOGAMEPADBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xBFF8D20)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBFFF380)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFFF510)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFFE740)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONWEAPONREFINECLOSEHANDLE_OFFSET UNITYSDK_OFFSET(0xBFF61A0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_ONWEAPONRTLOADED_OFFSET UNITYSDK_OFFSET(0xBFFD500)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_PLAYVIDEOFORWEAPON_OFFSET UNITYSDK_OFFSET(0xC000400)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_PROCESSUIAVATAR_OFFSET UNITYSDK_OFFSET(0xBFF3C90)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0xBFF3970)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHANDPLAYLEVELUPANIM_OFFSET UNITYSDK_OFFSET(0xBFFA2F0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHANDPLAYREFINEANIM_OFFSET UNITYSDK_OFFSET(0xBFFA3F0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHAUDIOOCCLUSION_OFFSET UNITYSDK_OFFSET(0xC000CB0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHMAINCITYBTN_OFFSET UNITYSDK_OFFSET(0xBFF2E60)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHRTORVIDEO_OFFSET UNITYSDK_OFFSET(0xBFFFD50)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHRT_OFFSET UNITYSDK_OFFSET(0xBFFCC80)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHVIEWFOREQUIP_OFFSET UNITYSDK_OFFSET(0xBFFA620)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHVIEWFORWEAPON_OFFSET UNITYSDK_OFFSET(0xBFF64D0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBFF3A60)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_RELEASERTUNIT_OFFSET UNITYSDK_OFFSET(0xBFF5820)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_RESETGAMEPADLISTSELECT_OFFSET UNITYSDK_OFFSET(0xBFF3160)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SETBTNGAMEPADLISTFOCUS_OFFSET UNITYSDK_OFFSET(0xBFFE180)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SETROLEJUMPDATA_OFFSET UNITYSDK_OFFSET(0xBFFE260)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SETSTAR_OFFSET UNITYSDK_OFFSET(0xBFF8FE0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SETUPSTARLIGHTNODES_OFFSET UNITYSDK_OFFSET(0xBFF9F70)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SETWEAPONANIMATORENABLE_OFFSET UNITYSDK_OFFSET(0xBFF9E80)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SETWEAPONVIDEOTOGGLEBTNSTATE_OFFSET UNITYSDK_OFFSET(0xBFFFC30)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SHOULDSHOWWEAPON2DSWITCH_OFFSET UNITYSDK_OFFSET(0xBFFFBA0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SHOULDWEAPONSHOWSP_OFFSET UNITYSDK_OFFSET(0xBFFE0F0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_STOPVIDEOFORWEAPON_OFFSET UNITYSDK_OFFSET(0xC0005D0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_TICKRTROTATING_OFFSET UNITYSDK_OFFSET(0xBFF9480)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_TOGGLEAUDIOFORWEAPONVIDEO_OFFSET UNITYSDK_OFFSET(0xBFFF7D0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_TRIGGERSTARTWEAPONPERFORM_OFFSET UNITYSDK_OFFSET(0xBFF9940)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_TRYREADWEAPONVIDEONEW_OFFSET UNITYSDK_OFFSET(0xC000150)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_TRYSETOCCLUSIONRTPCFORRTGO_OFFSET UNITYSDK_OFFSET(0xC000E20)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_TRYSETOCCULSIONRTPCFORVIDEO_OFFSET UNITYSDK_OFFSET(0xC001020)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBFF9410)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC0011F0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC001190)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__INITVIEW_B__38_0_OFFSET UNITYSDK_OFFSET(0xC001240)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__INITVIEW_B__38_1_OFFSET UNITYSDK_OFFSET(0xC001250)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__INITWEAPONVIDEOPLAYER_B__106_0_OFFSET UNITYSDK_OFFSET(0xC001990)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__ONBACKBTNCLICKHANDLE_B__43_0_OFFSET UNITYSDK_OFFSET(0xC0012C0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__ONCLICKSPINFOBTN_B__42_0_OFFSET UNITYSDK_OFFSET(0xC001260)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__ONCLICKSPINFOBTN_B__42_1_OFFSET UNITYSDK_OFFSET(0xC001290)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__ONSTORYINFOBTNCLICKED_B__53_0_OFFSET UNITYSDK_OFFSET(0xC001640)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__ONUIOPEN_B__80_0_OFFSET UNITYSDK_OFFSET(0xC001960)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__ONUIOPEN_B__80_1_OFFSET UNITYSDK_OFFSET(0xC001980)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__REFRESHANDPLAYLEVELUPANIM_B__62_0_OFFSET UNITYSDK_OFFSET(0xC0018C0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__REFRESHANDPLAYREFINEANIM_B__63_0_OFFSET UNITYSDK_OFFSET(0xC0018E0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__STOPVIDEOFORWEAPON_B__109_1_OFFSET UNITYSDK_OFFSET(0xC0019A0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__STOPVIDEOFORWEAPON_G__SETSTATE_109_0_OFFSET UNITYSDK_OFFSET(0xC0009F0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER__TRIGGERSTARTWEAPONPERFORM_B__58_0_OFFSET UNITYSDK_OFFSET(0xC001810)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC001A30)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xC001AA0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xC001B10)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xC001B40)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC001BA0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xC001BB0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC001BC0)
#define MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC001BD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIEquipDetailPageController_TypeDefinitionIndex = 39106;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIEquipDetailPageController_TypeDefinitionIndex)->GetStaticField(0xF820);
		}
		static ::System::Int32* StaticGet_BaseMap()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIEquipDetailPageController_TypeDefinitionIndex)->GetStaticField(0xF824);
		}
		...
		::Class_2_60638234271CCDB8_14* _view; // 0x368
		...
		::Class_1_C419268BEAFF8CB0* _gamepadEquipStateProxy; // 0x388
		...
		::System::Void DoRefreshViewCommon(::System::Int32 templateID, ::Class_2_208CC9941471731A_53* itemConfig, ::System::UInt32 avatarUID, ::System::UInt32 curLevel, ::System::UInt32 maxLevel, ::System::String* iconPath, ::System::Boolean canLevelUp, ::System::Boolean canStarUp, ::System::Boolean isMaxLevel, ::System::Boolean isMaxStar, ::System::Boolean isEquip, ::System::Boolean isRefreshRT)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Class_2_208CC9941471731A_53*, ::System::UInt32, ::System::UInt32, ::System::UInt32, ::System::String*, ::System::Boolean, ::System::Boolean, ::System::Boolean, ::System::Boolean, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_DOREFRESHVIEWCOMMON_OFFSET))(this, templateID, itemConfig, avatarUID, curLevel, maxLevel, iconPath, canLevelUp, canStarUp, isMaxLevel, isMaxStar, isEquip, isRefreshRT);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_A3CFC20DC3954F5C*, ::Class_2_758D4E94CC1C6B2A*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIEQUIPDETAILPAGECONTROLLER_SHOULDWEAPONSHOWSP_OFFSET))(this, weaponData, weaponConfig);
		}
