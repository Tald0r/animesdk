...
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFE6920)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFE6990)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBFE6C40)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xBFE7040)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFE6A50)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0xBFE6FB0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_SHOWPLATFORMUI_OFFSET UNITYSDK_OFFSET(0xBFE7110)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_SHOWUIVIEW_OFFSET UNITYSDK_OFFSET(0xBFE7330)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFE7840)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER__SHOWUIVIEW_G__SETUPPLATFORMUI_11_0_OFFSET UNITYSDK_OFFSET(0xBFE7760)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFE7870)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBFE78E0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFE7950)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeamNameRowWidgetController_TypeDefinitionIndex = 42215;

	class UICoopTeamNameRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_3_B6F2480661C7032D_1* _view; // 0x2A0
		::Class_2_2F3C7D4EFC74D485* _model; // 0x2A8
		::MoleMole::UICoopTeamNameRowWidgetController_Context* _context; // 0x2B0
