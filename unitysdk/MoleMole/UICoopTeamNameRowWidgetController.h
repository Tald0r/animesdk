...
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB199C0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB19A30)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBB19CE0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xBB1A0E0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB19AF0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0xBB1A050)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_SHOWPLATFORMUI_OFFSET UNITYSDK_OFFSET(0xBB1A1B0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER_SHOWUIVIEW_OFFSET UNITYSDK_OFFSET(0xBB1A3D0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB1A8F0)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER__SHOWUIVIEW_G__SETUPPLATFORMUI_11_0_OFFSET UNITYSDK_OFFSET(0xBB1A810)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB1A920)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBB1A990)
#define MOLEMOLE_UICOOPTEAMNAMEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBB1AA00)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeamNameRowWidgetController_TypeDefinitionIndex = 41135;

	class UICoopTeamNameRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_3_B6F2480661C7032D* _view; // 0x2A0
