...
#define MOLEMOLE_MAINQUESTDIFFICULTYSETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xE117090)

namespace MoleMole
{
	inline static constexpr unsigned int MainQuestDifficultySettingContext_TypeDefinitionIndex = 58481;
