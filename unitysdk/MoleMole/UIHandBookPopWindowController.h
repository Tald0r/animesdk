...
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_CLEAN_OFFSET UNITYSDK_OFFSET(0x9DA3230)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_GETTACTICS_OFFSET UNITYSDK_OFFSET(0x9DA26E0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x9D9F9B0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9D9F9C0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_INITTACTICSNODE_OFFSET UNITYSDK_OFFSET(0x9DA0FC0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9DA2160)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONREQUIRECLOSEHANDBOOK_OFFSET UNITYSDK_OFFSET(0x9DA2750)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9DA1470)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONTACTICSNODE_OFFSET UNITYSDK_OFFSET(0x9DA34B0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9DA2200)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9D9F9D0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9DA15F0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_OPENREWARDTAB_OFFSET UNITYSDK_OFFSET(0x9DA1C50)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_REFRESHLOCK_OFFSET UNITYSDK_OFFSET(0x9DA0A90)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_SETREWARDINPUTKEYHINT_OFFSET UNITYSDK_OFFSET(0x9DA2590)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x9DA2670)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER_SHOWTAB_OFFSET UNITYSDK_OFFSET(0x9DA2BB0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9DA3910)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__26_0_OFFSET UNITYSDK_OFFSET(0x9DA3A30)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__26_1_OFFSET UNITYSDK_OFFSET(0x9DA3A40)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__26_2_OFFSET UNITYSDK_OFFSET(0x9DA3A50)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__26_3_OFFSET UNITYSDK_OFFSET(0x9DA3A60)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER__ONUIINIT_B__26_4_OFFSET UNITYSDK_OFFSET(0x9DA3A70)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9DA3A80)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9DA3AF0)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9DA3B00)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9DA3B10)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9DA3B20)
#define MOLEMOLE_UIHANDBOOKPOPWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x9DA3B90)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookPopWindowController_TypeDefinitionIndex = 52013;
	...
	public:
		...
		::Class_2_C7387D40D4120A48_14* _view; // 0x2F8
		::System::Collections::Generic::HashSet_1<::System::Int32>* _viewedTabs; // 0x300
		::Class_1_79526D80B8F6897C* _tacticsNode; // 0x308
