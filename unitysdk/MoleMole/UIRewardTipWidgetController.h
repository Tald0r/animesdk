...
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xDF28020)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF283B0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF28450)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF28030)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF28300)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0xDF28670)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER_SETANIMMOVE_OFFSET UNITYSDK_OFFSET(0xDF28B90)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__CALLDELAYCLOSE_OFFSET UNITYSDK_OFFSET(0xDF28970)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF28E30)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__ONDELAYCALLBACK_OFFSET UNITYSDK_OFFSET(0xDF28A90)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__SETANIMMOVE_B__24_0_OFFSET UNITYSDK_OFFSET(0xDF28EA0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER__SETANIMMOVE_B__24_1_OFFSET UNITYSDK_OFFSET(0xDF29080)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF291B0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF29220)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF292A0)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF29300)
#define MOLEMOLE_UIREWARDTIPWIDGETCONTROLLER___ONDELAYCALLBACK_B__23_0_OFFSET UNITYSDK_OFFSET(0xDF28E80)

namespace MoleMole
{
	inline static constexpr unsigned int UIRewardTipWidgetController_TypeDefinitionIndex = 75723;
