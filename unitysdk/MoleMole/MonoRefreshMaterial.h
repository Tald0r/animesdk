...
#define MOLEMOLE_MONOREFRESHMATERIAL_ONLYREFRESHCURRENTCOUNT_OFFSET UNITYSDK_OFFSET(0xA652D30)
#define MOLEMOLE_MONOREFRESHMATERIAL_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA652FA0)
#define MOLEMOLE_MONOREFRESHMATERIAL_PLAYITEMICONADDANI_OFFSET UNITYSDK_OFFSET(0xA652150)
#define MOLEMOLE_MONOREFRESHMATERIAL_REFRESHITEMICON_OFFSET UNITYSDK_OFFSET(0xA651BD0)
#define MOLEMOLE_MONOREFRESHMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA653100)
#define MOLEMOLE_MONOREFRESHMATERIAL___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA653120)

namespace MoleMole
{
	inline static constexpr unsigned int MonoRefreshMaterial_TypeDefinitionIndex = 40027;
