...
#define MOLEMOLE_MONOREFRESHMATERIAL_ONLYREFRESHCURRENTCOUNT_OFFSET UNITYSDK_OFFSET(0xB3BAEC0)
#define MOLEMOLE_MONOREFRESHMATERIAL_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB3BB130)
#define MOLEMOLE_MONOREFRESHMATERIAL_PLAYITEMICONADDANI_OFFSET UNITYSDK_OFFSET(0xB3BA2E0)
#define MOLEMOLE_MONOREFRESHMATERIAL_REFRESHITEMICON_OFFSET UNITYSDK_OFFSET(0xB3B9D60)
#define MOLEMOLE_MONOREFRESHMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0xB3BB290)
#define MOLEMOLE_MONOREFRESHMATERIAL___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB3BB2B0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoRefreshMaterial_TypeDefinitionIndex = 77815;
