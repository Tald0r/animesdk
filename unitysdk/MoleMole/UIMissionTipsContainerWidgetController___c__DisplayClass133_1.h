...
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS133_1__CTOR_OFFSET UNITYSDK_OFFSET(0xAF7D6B0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS133_1__PLAYMISSIONSYNC_B__0_OFFSET UNITYSDK_OFFSET(0xAF7D710)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS133_1__PLAYMISSIONSYNC_B__2_OFFSET UNITYSDK_OFFSET(0xAF7D6C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsContainerWidgetController___c__DisplayClass133_1_TypeDefinitionIndex = 70951;
