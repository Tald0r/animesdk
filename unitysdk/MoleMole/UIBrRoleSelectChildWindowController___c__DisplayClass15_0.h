...
#define MOLEMOLE_UIBRROLESELECTCHILDWINDOWCONTROLLER___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A468410)
#define MOLEMOLE_UIBRROLESELECTCHILDWINDOWCONTROLLER___C__DISPLAYCLASS15_0__SWITCHINFO_B__0_OFFSET UNITYSDK_OFFSET(0x1A468BA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBrRoleSelectChildWindowController___c__DisplayClass15_0_TypeDefinitionIndex = 80192;
