...
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL__CALLDELAYED_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3A3CE0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELTOOLBARBOSSWIDGETCONTROLLER_LEVELBOSSHUDWIDGETVIEWMODEL__CALLDELAYED_D__58_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x30F550)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelToolBarBossWidgetController_LevelBossHudWidgetViewModel__CallDelayed_d__58_TypeDefinitionIndex = 61906;
