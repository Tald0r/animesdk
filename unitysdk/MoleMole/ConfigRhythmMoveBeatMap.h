...
#define MOLEMOLE_CONFIGRHYTHMMOVEBEATMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x13FAF3C0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigRhythmMoveBeatMap_TypeDefinitionIndex = 58810;
