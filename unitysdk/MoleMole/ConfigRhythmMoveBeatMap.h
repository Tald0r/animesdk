...
#define MOLEMOLE_CONFIGRHYTHMMOVEBEATMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xF2E9170)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigRhythmMoveBeatMap_TypeDefinitionIndex = 52946;
