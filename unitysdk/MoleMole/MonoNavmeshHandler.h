...
#define MOLEMOLE_MONONAVMESHHANDLER_CALCULATEPATH_OFFSET UNITYSDK_OFFSET(0x7F19900)
#define MOLEMOLE_MONONAVMESHHANDLER_GET_DEBUGPATHROOT_OFFSET UNITYSDK_OFFSET(0x7F197E0)
#define MOLEMOLE_MONONAVMESHHANDLER_GET_MOVEPATHDEBUGGER_OFFSET UNITYSDK_OFFSET(0x7F195A0)
#define MOLEMOLE_MONONAVMESHHANDLER_GET_NAVMESHHELPER_OFFSET UNITYSDK_OFFSET(0x7F197F0)
#define MOLEMOLE_MONONAVMESHHANDLER_GET_PATHINDEX_OFFSET UNITYSDK_OFFSET(0x7F197D0)
#define MOLEMOLE_MONONAVMESHHANDLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7F19AA0)
#define MOLEMOLE_MONONAVMESHHANDLER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x7F19E00)
#define MOLEMOLE_MONONAVMESHHANDLER_METHOD_5_CCAB1FEBC1E7CB11_OFFSET UNITYSDK_OFFSET(0x7F19FB0)
#define MOLEMOLE_MONONAVMESHHANDLER_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x7F19E70)
#define MOLEMOLE_MONONAVMESHHANDLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x7F19C20)
#define MOLEMOLE_MONONAVMESHHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x7F19D00)
#define MOLEMOLE_MONONAVMESHHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x7F19CA0)
#define MOLEMOLE_MONONAVMESHHANDLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x7F19B90)
#define MOLEMOLE_MONONAVMESHHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F19D70)

namespace MoleMole
{
	inline static constexpr unsigned int MonoNavmeshHandler_TypeDefinitionIndex = 54244;
