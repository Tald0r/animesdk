...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_STAGEZOOMINFO_SETBGPARAM_OFFSET UNITYSDK_OFFSET(0xBFF0D70)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_STAGEZOOMINFO_SETRTCAMERAPARAM_OFFSET UNITYSDK_OFFSET(0xBFF0D00)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_STAGEZOOMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xBFF0CF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController_StageZoomInfo_TypeDefinitionIndex = 54698;
