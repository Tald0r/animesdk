...
#define MOLEMOLE_MONOMISSIONTIPSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6EB8FB0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoMissionTipsConfig_TypeDefinitionIndex = 60823;
