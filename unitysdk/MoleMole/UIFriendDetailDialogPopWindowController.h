...
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA9361E0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_INITPLATFORM_OFFSET UNITYSDK_OFFSET(0xA936C80)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA937160)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA936670)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA937080)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xA936470)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA9361F0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA936750)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_SHOWUIVIEW_OFFSET UNITYSDK_OFFSET(0xA937200)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER_SWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xA9365E0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9372B0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER__INITPLATFORM_B__12_0_OFFSET UNITYSDK_OFFSET(0xA9372C0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER__INITPLATFORM_B__12_1_OFFSET UNITYSDK_OFFSET(0xA937340)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA9373C0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xA937430)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA9374A0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA9374B0)
#define MOLEMOLE_UIFRIENDDETAILDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA9374C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendDetailDialogPopWindowController_TypeDefinitionIndex = 50900;

	class UIFriendDetailDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_0E70B6069F671466* _view; // 0x2F8
		...
		::System::Boolean _allowShowPlatform; // 0x318
		::System::Boolean _canSwitchPlatformInfo; // 0x319
