...
#define MOLEMOLE_CONFIGUINEWMAP_2DGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xB5A4260)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUINewMap_2DGroup_TypeDefinitionIndex = 37605;
