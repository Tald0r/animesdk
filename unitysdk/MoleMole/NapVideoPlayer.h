...
#define MOLEMOLE_NAPVIDEOPLAYER_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xD81ACD0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0xD81BB70)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ENABLEUPDATELOG_OFFSET UNITYSDK_OFFSET(0xD81AC60)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0xD81B780)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_FRAMERATE_OFFSET UNITYSDK_OFFSET(0xD81B7B0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_FRAME_OFFSET UNITYSDK_OFFSET(0xD81B750)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xD81B8D0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ISCANRENDER_OFFSET UNITYSDK_OFFSET(0xD81BC30)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ISLOOPING_OFFSET UNITYSDK_OFFSET(0xD81B4B0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0xD81B450)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xD81B420)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ISPREPARED_OFFSET UNITYSDK_OFFSET(0xD81B480)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0xD81B6F0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_PLAYBACKSPEED_OFFSET UNITYSDK_OFFSET(0xD81B7E0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0xD81AEC0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_PLAYONAWAKE_OFFSET UNITYSDK_OFFSET(0xD81B570)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0xD81BC60)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_TARGETMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0xD81BAB0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_TARGETMATERIALRENDERER_OFFSET UNITYSDK_OFFSET(0xD81B930)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_TARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0xD81B9F0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0xD81B900)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_TIME_OFFSET UNITYSDK_OFFSET(0xD81B720)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_URL_OFFSET UNITYSDK_OFFSET(0xD81B3F0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_WAITFORFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0xD81B630)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0xD81B8A0)
#define MOLEMOLE_NAPVIDEOPLAYER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD81C2F0)
#define MOLEMOLE_NAPVIDEOPLAYER_LOGERROR_OFFSET UNITYSDK_OFFSET(0xD81ADE0)
#define MOLEMOLE_NAPVIDEOPLAYER_LOGUPDATE_OFFSET UNITYSDK_OFFSET(0xD81ACF0)
#define MOLEMOLE_NAPVIDEOPLAYER_LOG_OFFSET UNITYSDK_OFFSET(0xD81AD70)
#define MOLEMOLE_NAPVIDEOPLAYER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD81C370)
#define MOLEMOLE_NAPVIDEOPLAYER_PAUSE_OFFSET UNITYSDK_OFFSET(0xD81BEA0)
#define MOLEMOLE_NAPVIDEOPLAYER_PLAY_OFFSET UNITYSDK_OFFSET(0xD81BE20)
#define MOLEMOLE_NAPVIDEOPLAYER_PREPARE_OFFSET UNITYSDK_OFFSET(0xD81BDA0)
#define MOLEMOLE_NAPVIDEOPLAYER_PRINTONSCREEN_OFFSET UNITYSDK_OFFSET(0xD81AE50)
#define MOLEMOLE_NAPVIDEOPLAYER_SEEKFRAME_OFFSET UNITYSDK_OFFSET(0xD81C0C0)
#define MOLEMOLE_NAPVIDEOPLAYER_SEEKTIME_OFFSET UNITYSDK_OFFSET(0xD81C150)
#define MOLEMOLE_NAPVIDEOPLAYER_SETAUDIOMODENONE_OFFSET UNITYSDK_OFFSET(0xD81BD20)
#define MOLEMOLE_NAPVIDEOPLAYER_SETURL_OFFSET UNITYSDK_OFFSET(0xD81BFA0)
#define MOLEMOLE_NAPVIDEOPLAYER_SETVIDEOCLIP_OFFSET UNITYSDK_OFFSET(0xD81C1E0)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xD81ACE0)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0xD81BBA0)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_ENABLEUPDATELOG_OFFSET UNITYSDK_OFFSET(0xD81ACA0)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_ISLOOPING_OFFSET UNITYSDK_OFFSET(0xD81B4E0)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_PLAYBACKSPEED_OFFSET UNITYSDK_OFFSET(0xD81B810)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_PLAYER_OFFSET UNITYSDK_OFFSET(0xD81AED0)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_PLAYONAWAKE_OFFSET UNITYSDK_OFFSET(0xD81B5A0)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0xD81BC90)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_TARGETMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0xD81BAE0)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_TARGETMATERIALRENDERER_OFFSET UNITYSDK_OFFSET(0xD81B960)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_TARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0xD81BA20)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_WAITFORFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0xD81B660)
#define MOLEMOLE_NAPVIDEOPLAYER_STEPFORWARD_OFFSET UNITYSDK_OFFSET(0xD81C270)
#define MOLEMOLE_NAPVIDEOPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0xD81BF20)
#define MOLEMOLE_NAPVIDEOPLAYER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD81C3F0)
#define MOLEMOLE_NAPVIDEOPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xD81AEE0)
#define MOLEMOLE_NAPVIDEOPLAYER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD81C400)

namespace MoleMole
{
	inline static constexpr unsigned int NapVideoPlayer_TypeDefinitionIndex = 61153;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(NapVideoPlayer_TypeDefinitionIndex)->GetStaticField(0xDCA0);
		}
		::Struct_2_A11167748A3D1C6F videoFileUrl; // 0x48
		::System::String* _DebugName_k__BackingField; // 0x68
		::MoleMole::IVideoPlayer* _Player_k__BackingField; // 0x70
		::System::String* _url; // 0x78
