...
#define MOLEMOLE_NAPVIDEOPLAYER_GET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xB9AB230)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0xB9AC0D0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ENABLEUPDATELOG_OFFSET UNITYSDK_OFFSET(0xB9AB1C0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0xB9ABCE0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_FRAMERATE_OFFSET UNITYSDK_OFFSET(0xB9ABD10)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_FRAME_OFFSET UNITYSDK_OFFSET(0xB9ABCB0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xB9ABE30)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ISCANRENDER_OFFSET UNITYSDK_OFFSET(0xB9AC190)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ISLOOPING_OFFSET UNITYSDK_OFFSET(0xB9ABA10)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0xB9AB9B0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xB9AB980)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_ISPREPARED_OFFSET UNITYSDK_OFFSET(0xB9AB9E0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0xB9ABC50)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_PLAYBACKSPEED_OFFSET UNITYSDK_OFFSET(0xB9ABD40)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0xB9AB420)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_PLAYONAWAKE_OFFSET UNITYSDK_OFFSET(0xB9ABAD0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0xB9AC1C0)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_TARGETMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0xB9AC010)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_TARGETMATERIALRENDERER_OFFSET UNITYSDK_OFFSET(0xB9ABE90)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_TARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0xB9ABF50)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0xB9ABE60)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_TIME_OFFSET UNITYSDK_OFFSET(0xB9ABC80)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_URL_OFFSET UNITYSDK_OFFSET(0xB9AB950)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_WAITFORFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0xB9ABB90)
#define MOLEMOLE_NAPVIDEOPLAYER_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0xB9ABE00)
#define MOLEMOLE_NAPVIDEOPLAYER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB9AC850)
#define MOLEMOLE_NAPVIDEOPLAYER_LOGERROR_OFFSET UNITYSDK_OFFSET(0xB9AB340)
#define MOLEMOLE_NAPVIDEOPLAYER_LOGUPDATE_OFFSET UNITYSDK_OFFSET(0xB9AB250)
#define MOLEMOLE_NAPVIDEOPLAYER_LOG_OFFSET UNITYSDK_OFFSET(0xB9AB2D0)
#define MOLEMOLE_NAPVIDEOPLAYER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB9AC8D0)
#define MOLEMOLE_NAPVIDEOPLAYER_PAUSE_OFFSET UNITYSDK_OFFSET(0xB9AC400)
#define MOLEMOLE_NAPVIDEOPLAYER_PLAY_OFFSET UNITYSDK_OFFSET(0xB9AC380)
#define MOLEMOLE_NAPVIDEOPLAYER_PREPARE_OFFSET UNITYSDK_OFFSET(0xB9AC300)
#define MOLEMOLE_NAPVIDEOPLAYER_PRINTONSCREEN_OFFSET UNITYSDK_OFFSET(0xB9AB3B0)
#define MOLEMOLE_NAPVIDEOPLAYER_SEEKFRAME_OFFSET UNITYSDK_OFFSET(0xB9AC620)
#define MOLEMOLE_NAPVIDEOPLAYER_SEEKTIME_OFFSET UNITYSDK_OFFSET(0xB9AC6B0)
#define MOLEMOLE_NAPVIDEOPLAYER_SETAUDIOMODENONE_OFFSET UNITYSDK_OFFSET(0xB9AC280)
#define MOLEMOLE_NAPVIDEOPLAYER_SETURL_OFFSET UNITYSDK_OFFSET(0xB9AC500)
#define MOLEMOLE_NAPVIDEOPLAYER_SETVIDEOCLIP_OFFSET UNITYSDK_OFFSET(0xB9AC740)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_DEBUGNAME_OFFSET UNITYSDK_OFFSET(0xB9AB240)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0xB9AC100)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_ENABLEUPDATELOG_OFFSET UNITYSDK_OFFSET(0xB9AB200)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_ISLOOPING_OFFSET UNITYSDK_OFFSET(0xB9ABA40)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_PLAYBACKSPEED_OFFSET UNITYSDK_OFFSET(0xB9ABD70)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_PLAYER_OFFSET UNITYSDK_OFFSET(0xB9AB430)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_PLAYONAWAKE_OFFSET UNITYSDK_OFFSET(0xB9ABB00)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_RENDERMODE_OFFSET UNITYSDK_OFFSET(0xB9AC1F0)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_TARGETMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0xB9AC040)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_TARGETMATERIALRENDERER_OFFSET UNITYSDK_OFFSET(0xB9ABEC0)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_TARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0xB9ABF80)
#define MOLEMOLE_NAPVIDEOPLAYER_SET_WAITFORFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0xB9ABBC0)
#define MOLEMOLE_NAPVIDEOPLAYER_STEPFORWARD_OFFSET UNITYSDK_OFFSET(0xB9AC7D0)
#define MOLEMOLE_NAPVIDEOPLAYER_STOP_OFFSET UNITYSDK_OFFSET(0xB9AC480)
#define MOLEMOLE_NAPVIDEOPLAYER__CCTOR_OFFSET UNITYSDK_OFFSET(0xB9AC950)
#define MOLEMOLE_NAPVIDEOPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xB9AB440)
#define MOLEMOLE_NAPVIDEOPLAYER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB9AC960)

namespace MoleMole
{
	inline static constexpr unsigned int NapVideoPlayer_TypeDefinitionIndex = 59289;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(NapVideoPlayer_TypeDefinitionIndex)->GetStaticField(0xE3D0);
		}
