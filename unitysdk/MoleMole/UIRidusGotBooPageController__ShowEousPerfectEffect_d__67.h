...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__SHOWEOUSPERFECTEFFECT_D__67_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x325AD0)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__SHOWEOUSPERFECTEFFECT_D__67_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__ShowEousPerfectEffect_d__67_TypeDefinitionIndex = 66295;
