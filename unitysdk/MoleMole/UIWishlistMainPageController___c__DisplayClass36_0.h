...
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x938DC50)
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS36_0__SHOWSKILLLEVELUPPROCESS_B__0_OFFSET UNITYSDK_OFFSET(0x938DC60)
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS36_0__SHOWSKILLLEVELUPPROCESS_B__1_OFFSET UNITYSDK_OFFSET(0x938DCB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistMainPageController___c__DisplayClass36_0_TypeDefinitionIndex = 49122;
