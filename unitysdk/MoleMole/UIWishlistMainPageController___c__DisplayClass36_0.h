...
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x953EC10)
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS36_0__SHOWSKILLLEVELUPPROCESS_B__0_OFFSET UNITYSDK_OFFSET(0x953EC20)
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS36_0__SHOWSKILLLEVELUPPROCESS_B__1_OFFSET UNITYSDK_OFFSET(0x953EC70)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistMainPageController___c__DisplayClass36_0_TypeDefinitionIndex = 77828;
