...
#define MOLEMOLE_MONONAMECARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6EB9020)

namespace MoleMole
{
	inline static constexpr unsigned int MonoNameCardConfig_TypeDefinitionIndex = 55114;
