...
#define MOLEMOLE_MONONAMECARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6E47230)

namespace MoleMole
{
	inline static constexpr unsigned int MonoNameCardConfig_TypeDefinitionIndex = 65278;
