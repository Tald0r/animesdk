...
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x6CAB3A0)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x6CAB410)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x6CAB4D0)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x6CAB5B0)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6CAB750)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x6CAB760)
#define MOLEMOLE_UIINTERKNOTFORUMLEVELROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x6CAB7D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotForumLevelRowWidgetController_TypeDefinitionIndex = 50838;
