...
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_CACHEGROUPSALPHA_OFFSET UNITYSDK_OFFSET(0xD27D0F0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_DOSKIP_OFFSET UNITYSDK_OFFSET(0xD280BE0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xD280450)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xD27CE80)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_ISALLOWINPUTPASS_OFFSET UNITYSDK_OFFSET(0xD27CF30)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0xD27CE90)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0xD27CEA0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0xD2837E0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_PERFORMTYPE_OFFSET UNITYSDK_OFFSET(0xD27D460)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0xD27CEB0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD27CE70)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_INITSKIPBTNSETTING_OFFSET UNITYSDK_OFFSET(0xD27E390)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ISALLOWINPUTPASSBYACTION_OFFSET UNITYSDK_OFFSET(0xD27CF40)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0xD280E60)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONCLOSEPERFORMPAGEFROMOUTSIDE_OFFSET UNITYSDK_OFFSET(0xD282F80)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD27CFE0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONPLAYCGEND_OFFSET UNITYSDK_OFFSET(0xD282220)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONREALSTARTPERFORM_OFFSET UNITYSDK_OFFSET(0xD281A80)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD27D480)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONSKIPBTNLONGPRESSTRIGGER_OFFSET UNITYSDK_OFFSET(0xD280B00)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONSKIPBTNLONGPRESSUP_OFFSET UNITYSDK_OFFSET(0xD280B70)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONSKIP_OFFSET UNITYSDK_OFFSET(0xD281CD0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD27F780)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD27D080)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD2804C0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PLAYCAMERASHOT_OFFSET UNITYSDK_OFFSET(0xD27E840)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PLAYCHAPTERTIMELINE_OFFSET UNITYSDK_OFFSET(0xD27F190)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PLAYFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0xD2832C0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PLAYFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0xD283530)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PLAYTIMELINECUTSCENE_OFFSET UNITYSDK_OFFSET(0xD27F360)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PLAYVIDEO_OFFSET UNITYSDK_OFFSET(0xD27EB10)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_POSTRELEASEUI_OFFSET UNITYSDK_OFFSET(0xD2802A0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_PRESTARTPERFORM_OFFSET UNITYSDK_OFFSET(0xD281220)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_RESETGROUPSALPHA_OFFSET UNITYSDK_OFFSET(0xD280910)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SENDENDCOMMTOSERVER_OFFSET UNITYSDK_OFFSET(0xD282DD0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SENDSTARTCOMMTOSERVER_OFFSET UNITYSDK_OFFSET(0xD27F5E0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SETFULLSCREENCONNECTCUTSCENE_OFFSET UNITYSDK_OFFSET(0xD283090)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SETONSKIPACTION_OFFSET UNITYSDK_OFFSET(0xD283020)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SETPRESSSKIPBTNTIME_OFFSET UNITYSDK_OFFSET(0xD280860)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SETVIDEOACTIVE_OFFSET UNITYSDK_OFFSET(0xD281040)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SET_NEEDCACHE_OFFSET UNITYSDK_OFFSET(0xD2837F0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SET_PERFORMTYPE_OFFSET UNITYSDK_OFFSET(0xD27D470)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SHOWSKIP_OFFSET UNITYSDK_OFFSET(0xD281160)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_SKIPFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0xD283470)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_STOPPERFORM_OFFSET UNITYSDK_OFFSET(0xD27FA30)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_TRYCLOSEPOPTIP_OFFSET UNITYSDK_OFFSET(0xD27FFA0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_TRYTRIGGERPLOTPLAYPERFORMJUMP_OFFSET UNITYSDK_OFFSET(0xD282080)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_UPDATELONGPRESSSKIP_OFFSET UNITYSDK_OFFSET(0xD280630)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD2805C0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__CACHECLEAN_OFFSET UNITYSDK_OFFSET(0xD280310)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD283890)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD283800)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__ONREALSTARTPERFORM_B__39_0_OFFSET UNITYSDK_OFFSET(0xD283AA0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__ONREALSTARTPERFORM_B__39_1_OFFSET UNITYSDK_OFFSET(0xD283AE0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__ONSKIP_B__42_0_OFFSET UNITYSDK_OFFSET(0xD283AF0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__ONUIOPEN_B__25_0_OFFSET UNITYSDK_OFFSET(0xD2838D0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__PLAYCHAPTERTIMELINE_B__36_0_OFFSET UNITYSDK_OFFSET(0xD2838E0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__PLAYFADEINANIMATION_B__51_0_OFFSET UNITYSDK_OFFSET(0xD283B30)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__PLAYTIMELINECUTSCENE_B__37_0_OFFSET UNITYSDK_OFFSET(0xD2838F0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__PLAYTIMELINECUTSCENE_B__37_1_OFFSET UNITYSDK_OFFSET(0xD283900)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__PLAYVIDEO_B__38_0_OFFSET UNITYSDK_OFFSET(0xD2839B0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__PLAYVIDEO_B__38_1_OFFSET UNITYSDK_OFFSET(0xD2839E0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER__SENDSTARTCOMMTOSERVER_B__98_0_OFFSET UNITYSDK_OFFSET(0xD283B60)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0xD283B70)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_ISALLOWINPUTPASSBYACTION_OFFSET UNITYSDK_OFFSET(0xD283B80)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD283C10)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD283C80)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD283C90)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD283CA0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD283CB0)
#define MOLEMOLE_UIPERFORMPAGECONTROLLER___BASE_POSTRELEASEUI_OFFSET UNITYSDK_OFFSET(0xD283D20)

namespace MoleMole
{
	inline static constexpr unsigned int UIPerformPageController_TypeDefinitionIndex = 60588;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIPerformPageController_TypeDefinitionIndex)->GetStaticField(0x43380);
		}
		...
		::System::Boolean _isVideoPlaying; // 0x310
		::Class_2_5647A056215EFB9A* _view; // 0x318
		::System::Int32 curPerformID; // 0x320
		::System::Int64 curPerformUID; // 0x328
		::System::Int32 plotPlayType; // 0x330
		::System::Boolean _isPlayEnd; // 0x334
		::System::Single _showSkipTime; // 0x338
		::System::Boolean isInitUrl; // 0x33C
		::System::String* fadeInAnimation; // 0x340
		::System::String* fadeOutAnimation; // 0x348
		::System::Boolean _NeedCache_k__BackingField; // 0x350
		::System::Boolean _connectCutScene; // 0x351
		::Class_1_43BD383C98B4C0C5_18* param; // 0x358
		::MoleMole::UIGeneralTipsPopWindowController* popTipCtr; // 0x360
		::System::Boolean _isIgnoreInput; // 0x368
		::System::Boolean _isAllowInputPass; // 0x369
		::Enum_3_F4705266FB2007C7 _cursorHideState; // 0x36C
		::System::Action* _onSkip; // 0x370
		::System::Boolean _isLongPressingMenuBtn; // 0x378
		::System::Boolean _clickFromLongPress; // 0x379
		::System::Single _pressedTime; // 0x37C
		::System::Single TOTAL_FILL_TIME; // 0x380
		::System::Boolean _skipBtnAllowClick; // 0x384
		::System::Boolean _isFakeSeamlessMode; // 0x385
		::Il2CppArray<::UnityEngine::CanvasGroup*>* _groups; // 0x388
		::Il2CppArray<::System::Single>* _groupsAlpha; // 0x390
		::UnityEngine::Vector2 _topFramePos; // 0x398
		::UnityEngine::Vector2 _bottomFramePos; // 0x3A0
		::UnityEngine::Vector2 _skipBtnPos; // 0x3A8
		...
		::Class_1_43BD383C98B4C0C5_18* GetContext()
		{
			return ((::Class_1_43BD383C98B4C0C5_18*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPERFORMPAGECONTROLLER_GETCONTEXT_OFFSET))(this);
		}
		...
		::System::Void _SendStartCommToServer_b__98_0(::System::Int64 uid)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int64))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPERFORMPAGECONTROLLER__SENDSTARTCOMMTOSERVER_B__98_0_OFFSET))(this, uid);
		}
