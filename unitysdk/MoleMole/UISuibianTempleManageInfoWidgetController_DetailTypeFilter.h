...
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_DETAILTYPEFILTER_PREDICATE_OFFSET UNITYSDK_OFFSET(0xAE7E3F0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_DETAILTYPEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE7E3E0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleManageInfoWidgetController_DetailTypeFilter_TypeDefinitionIndex = 51380;
