...
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_DETAILTYPEFILTER_PREDICATE_OFFSET UNITYSDK_OFFSET(0xD2C02F0)
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOWIDGETCONTROLLER_DETAILTYPEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD2C02E0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleManageInfoWidgetController_DetailTypeFilter_TypeDefinitionIndex = 40175;
