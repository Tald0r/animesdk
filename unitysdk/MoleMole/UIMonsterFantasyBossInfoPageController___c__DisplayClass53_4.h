...
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___C__DISPLAYCLASS53_4__BUILDCLIENTMONSTERINFO_B__13_OFFSET UNITYSDK_OFFSET(0xC148260)
#define MOLEMOLE_UIMONSTERFANTASYBOSSINFOPAGECONTROLLER___C__DISPLAYCLASS53_4__CTOR_OFFSET UNITYSDK_OFFSET(0xC148250)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyBossInfoPageController___c__DisplayClass53_4_TypeDefinitionIndex = 63395;
