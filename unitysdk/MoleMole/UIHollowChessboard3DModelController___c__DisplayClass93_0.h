...
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER___C__DISPLAYCLASS93_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAA238A0)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER___C__DISPLAYCLASS93_0__TRYRETURN2PERSISTFOCUSCAMERA_B__0_OFFSET UNITYSDK_OFFSET(0xAA238B0)
#define MOLEMOLE_UIHOLLOWCHESSBOARD3DMODELCONTROLLER___C__DISPLAYCLASS93_0__TRYRETURN2PERSISTFOCUSCAMERA_G__ONREACHTARGETPOS_1_OFFSET UNITYSDK_OFFSET(0xAA23AF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboard3DModelController___c__DisplayClass93_0_TypeDefinitionIndex = 75056;
	...
	public:
		...
		::Class_3_AB9E23F58C71A630* focusStateNet; // 0x18
