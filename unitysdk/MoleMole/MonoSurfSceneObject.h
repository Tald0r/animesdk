...
#define MOLEMOLE_MONOSURFSCENEOBJECT_GETROTATION_OFFSET UNITYSDK_OFFSET(0x6E4C1F0)
#define MOLEMOLE_MONOSURFSCENEOBJECT_METHOD_7_14014646206E49EF_OFFSET UNITYSDK_OFFSET(0x6E4BB60)
#define MOLEMOLE_MONOSURFSCENEOBJECT_METHOD_7_637B937DC0F2692B_OFFSET UNITYSDK_OFFSET(0x6E4B9F0)
#define MOLEMOLE_MONOSURFSCENEOBJECT_METHOD_7_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0x6E4C170)
#define MOLEMOLE_MONOSURFSCENEOBJECT_METHOD_7_C240407BAEA69CE9_OFFSET UNITYSDK_OFFSET(0x6E4BE30)
#define MOLEMOLE_MONOSURFSCENEOBJECT_METHOD_7_FCA7C739F8E5F729_OFFSET UNITYSDK_OFFSET(0x6E4C080)
#define MOLEMOLE_MONOSURFSCENEOBJECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x6E4BAF0)
#define MOLEMOLE_MONOSURFSCENEOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x6E4B930)
#define MOLEMOLE_MONOSURFSCENEOBJECT_ONTRIGGEREVENT_OFFSET UNITYSDK_OFFSET(0x6E4BCD0)
#define MOLEMOLE_MONOSURFSCENEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x6E4C2A0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSurfSceneObject_TypeDefinitionIndex = 48744;
