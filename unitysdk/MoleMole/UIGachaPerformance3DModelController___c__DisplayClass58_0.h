...
#define MOLEMOLE_UIGACHAPERFORMANCE3DMODELCONTROLLER___C__DISPLAYCLASS58_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBFEB5F0)
#define MOLEMOLE_UIGACHAPERFORMANCE3DMODELCONTROLLER___C__DISPLAYCLASS58_0__HANDLETVRARITYSPERFORM_B__0_OFFSET UNITYSDK_OFFSET(0xBFEDE10)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPerformance3DModelController___c__DisplayClass58_0_TypeDefinitionIndex = 40459;
