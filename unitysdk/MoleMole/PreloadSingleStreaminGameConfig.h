...
#define MOLEMOLE_PRELOADSINGLESTREAMINGAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x67CB0B0)

namespace MoleMole
{
	inline static constexpr unsigned int PreloadSingleStreaminGameConfig_TypeDefinitionIndex = 76145;
