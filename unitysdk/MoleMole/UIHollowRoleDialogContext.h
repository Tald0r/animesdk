...
#define MOLEMOLE_UIHOLLOWROLEDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8A36C80)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowRoleDialogContext_TypeDefinitionIndex = 53142;
