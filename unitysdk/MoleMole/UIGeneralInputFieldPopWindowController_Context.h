...
#define MOLEMOLE_UIGENERALINPUTFIELDPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB2BAEE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralInputFieldPopWindowController_Context_TypeDefinitionIndex = 74905;
	...
	public:
		...
		::Class_2_19B7C5138FC90FBC* TextValidate; // 0x58
		::System::String* OKButtonTextKey; // 0x60
		::System::String* Text; // 0x68
		::System::String* TitleText; // 0x70
		::System::String* TipsText; // 0x78
		::System::Nullable_1<::Enum_3_63D476C405CEAF7E_1> SensitiveTextType; // 0x80
