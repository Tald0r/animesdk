...
#define MOLEMOLE_UICAMPIDLENODEWIDGETCONTROLLER___C__DISPLAYCLASS58_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBF42B30)
#define MOLEMOLE_UICAMPIDLENODEWIDGETCONTROLLER___C__DISPLAYCLASS58_0__REFRESHVIEW_B__0_OFFSET UNITYSDK_OFFSET(0xBF42B40)
#define MOLEMOLE_UICAMPIDLENODEWIDGETCONTROLLER___C__DISPLAYCLASS58_0__REFRESHVIEW_B__1_OFFSET UNITYSDK_OFFSET(0xBF42B90)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdleNodeWidgetController___c__DisplayClass58_0_TypeDefinitionIndex = 67903;
