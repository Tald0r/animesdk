...
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_GET_NULLTARGET_OFFSET UNITYSDK_OFFSET(0x679F0A0)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_GET_TARGETMODULEWRAPPER_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x2F8830)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_METHOD_2_5FFB353256AF4026_OFFSET UNITYSDK_OFFSET(0x2F87B0)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_METHOD_2_636C126D43A6C8E2_OFFSET UNITYSDK_OFFSET(0x2F8900)
#define MOLEMOLE_GAMEPADNAVTARGETCONFIG_SET_TARGETMODULEWRAPPER_OFFSET UNITYSDK_OFFSET(0x2F87A0)

namespace MoleMole
{
	inline static constexpr unsigned int GamepadNavTargetConfig_TypeDefinitionIndex = 73174;
