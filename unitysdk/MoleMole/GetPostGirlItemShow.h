...
#define MOLEMOLE_GETPOSTGIRLITEMSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xF1B4FF0)
#define MOLEMOLE_GETPOSTGIRLITEMSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xF1B5220)
#define MOLEMOLE_GETPOSTGIRLITEMSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xF1B5000)

namespace MoleMole
{
	inline static constexpr unsigned int GetPostGirlItemShow_TypeDefinitionIndex = 42468;
