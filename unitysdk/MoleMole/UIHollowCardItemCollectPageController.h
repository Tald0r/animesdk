...
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_CREATEWIDGET_OFFSET UNITYSDK_OFFSET(0x7F69B50)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GETCARDWIDGETCONTEXT_OFFSET UNITYSDK_OFFSET(0x7F69190)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GETCTRL_OFFSET UNITYSDK_OFFSET(0x7F6A660)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GETCURRENTREWARDBADGETYPE_OFFSET UNITYSDK_OFFSET(0x7F66E20)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GETRESEARCHPROGRESSCONFIGLIST_OFFSET UNITYSDK_OFFSET(0x7F6AF50)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x7F65E90)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x7F65EA0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GOTOMAINCITY_OFFSET UNITYSDK_OFFSET(0x7F6A790)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_INITTOPTABS_OFFSET UNITYSDK_OFFSET(0x7F66840)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_INITWIDGET_OFFSET UNITYSDK_OFFSET(0x7F66750)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONABYSSTABSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0x7F66CC0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONCLICKVIDEOBTN_OFFSET UNITYSDK_OFFSET(0x7F6B340)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONCLOSEREFRESHHALLDATA_OFFSET UNITYSDK_OFFSET(0x7F69030)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F65EB0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONDATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7F68460)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x7F680B0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONGOTOREWARDBTN_OFFSET UNITYSDK_OFFSET(0x7F68390)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x7F6B600)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7F68590)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONTABSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0x7F6A8F0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7F68ED0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F6B720)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F65F50)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F68740)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_REFRESHORIGINALBADGETYPELIST_OFFSET UNITYSDK_OFFSET(0x7F696C0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_REFRESHREWARDTAKENPROGRESS_OFFSET UNITYSDK_OFFSET(0x7F677F0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_REFRESHREWARDTEX_OFFSET UNITYSDK_OFFSET(0x7F67EA0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_REFRESHSYSTEMREDPOINT_OFFSET UNITYSDK_OFFSET(0x7F68240)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_REFRESHTABREDPOINT_OFFSET UNITYSDK_OFFSET(0x7F67BC0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_REFRESHTAB_OFFSET UNITYSDK_OFFSET(0x7F66EB0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x7F684E0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_SORTCFGS_OFFSET UNITYSDK_OFFSET(0x7F664E0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_TRYCANCELSELECT_OFFSET UNITYSDK_OFFSET(0x7F6B080)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_TRYPOPTIPSANDCLEARUNLOCKNEWGENREWINDOW_OFFSET UNITYSDK_OFFSET(0x7F68910)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_TRYSELECTCTRL_OFFSET UNITYSDK_OFFSET(0x7F6ABA0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F6B960)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__INITTOPTABS_B__8_0_OFFSET UNITYSDK_OFFSET(0x7F6B970)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__INITTOPTABS_B__8_1_OFFSET UNITYSDK_OFFSET(0x7F6B9A0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__ONCLICKVIDEOBTN_B__40_0_OFFSET UNITYSDK_OFFSET(0x7F6BA10)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__ONTABSELECTHANDLE_B__36_0_OFFSET UNITYSDK_OFFSET(0x7F6B9D0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F6BA40)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x7F6BAB0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x7F6BB20)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7F6BB80)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7F6BB90)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F6BBA0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F6BBB0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F6BBC0)
#define MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x7F6BC30)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowCardItemCollectPageController_TypeDefinitionIndex = 78873;

	class UIHollowCardItemCollectPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79AE422BA06F6D26_240* _view; // 0x2F8
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_789*>* m_sortedTabList; // 0x310
		...
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_139*>* GetResearchProgressConfigList(::MoleMole::UIHollowCardItemCollectPageController_TabType type)
		{
			return ((::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_139*>*(*)(::PVOID, ::MoleMole::UIHollowCardItemCollectPageController_TabType))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER_GETRESEARCHPROGRESSCONFIGLIST_OFFSET))(this, type);
		}
		...
		::System::Boolean _OnTabSelectHandle_b__36_0(::Class_2_208CC9941471731A_789* x)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_789*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__ONTABSELECTHANDLE_B__36_0_OFFSET))(this, x);
		}

		::System::Boolean _OnClickVideoBtn_b__40_0(::Class_2_208CC9941471731A_789* x)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_208CC9941471731A_789*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHOLLOWCARDITEMCOLLECTPAGECONTROLLER__ONCLICKVIDEOBTN_B__40_0_OFFSET))(this, x);
		}
