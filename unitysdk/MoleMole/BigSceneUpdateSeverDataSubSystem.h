...
#define MOLEMOLE_BIGSCENEUPDATESEVERDATASUBSYSTEM_ADDAVATARFIGHTUNIT_OFFSET UNITYSDK_OFFSET(0x9B95190)
#define MOLEMOLE_BIGSCENEUPDATESEVERDATASUBSYSTEM_GET_ISINFORCEUPDATEMUSTLOGOUTSTATE_OFFSET UNITYSDK_OFFSET(0x9B94B80)
#define MOLEMOLE_BIGSCENEUPDATESEVERDATASUBSYSTEM_MARKFORCEUPDATEMUSTLOGOUT_OFFSET UNITYSDK_OFFSET(0x9B94BA0)
#define MOLEMOLE_BIGSCENEUPDATESEVERDATASUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x9B94C00)
#define MOLEMOLE_BIGSCENEUPDATESEVERDATASUBSYSTEM_SET_ISINFORCEUPDATEMUSTLOGOUTSTATE_OFFSET UNITYSDK_OFFSET(0x9B94B90)
#define MOLEMOLE_BIGSCENEUPDATESEVERDATASUBSYSTEM_STOREABILITYSPECIAL_OFFSET UNITYSDK_OFFSET(0x9B954E0)
#define MOLEMOLE_BIGSCENEUPDATESEVERDATASUBSYSTEM_UPDATEABILITYSPECIALCHANGEDDATA_OFFSET UNITYSDK_OFFSET(0x9B94EB0)
#define MOLEMOLE_BIGSCENEUPDATESEVERDATASUBSYSTEM_UPLOAD_OFFSET UNITYSDK_OFFSET(0x9B94CB0)
#define MOLEMOLE_BIGSCENEUPDATESEVERDATASUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9B95830)
#define MOLEMOLE_BIGSCENEUPDATESEVERDATASUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x9B95890)

namespace MoleMole
{
	inline static constexpr unsigned int BigSceneUpdateSeverDataSubSystem_TypeDefinitionIndex = 42431;
	...
	public:
		...
		::System::Boolean _IsInForceUpdateMustLogoutState_k__BackingField; // 0x20
		::System::Single _checkDirtyTimer; // 0x24
		...
		static ::System::Void StoreAbilitySpecial(::Class_1_D4CCA64101A9C471<::System::String*, ::Class_3_768DB2EE9B72C12D*>* abilities, ::Struct_2_0301145851E02767 key, ::Struct_2_745325AFD7021EFB value)
		{
			return ((::System::Void(*)(::Class_1_D4CCA64101A9C471<::System::String*, ::Class_3_768DB2EE9B72C12D*>*, ::Struct_2_0301145851E02767, ::Struct_2_745325AFD7021EFB))((::PBYTE)hIl2Cpp + MOLEMOLE_BIGSCENEUPDATESEVERDATASUBSYSTEM_STOREABILITYSPECIAL_OFFSET))(abilities, key, value);
		}
