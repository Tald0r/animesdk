...
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER__SHOWANDHIDECONFLICTACCPAIR_D__163_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x329E80)
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER__SHOWANDHIDECONFLICTACCPAIR_D__163_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerAccessoryPageController__ShowAndHideConflictAccPair_d__163_TypeDefinitionIndex = 39876;
	...
	struct alignas(8) UIPlayerAccessoryPageController__ShowAndHideConflictAccPair_d__163
	{
		...
		::System::String* conflictFormat; // 0x30
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__2; // 0x38
		::System::Int32 newAcc; // 0x48
		::System::Int32 oldAcc; // 0x4C
