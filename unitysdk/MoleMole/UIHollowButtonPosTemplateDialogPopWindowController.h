...
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_CREATESLIDERWIDGETS_OFFSET UNITYSDK_OFFSET(0x7D0B190)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_GETBUTTONTYPEBYPOSITIONTYPE_BIGSCENE_OFFSET UNITYSDK_OFFSET(0x7D0F2F0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_GETBUTTONTYPEBYPOSITIONTYPE_CURRENT_OFFSET UNITYSDK_OFFSET(0x7D0E440)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_GETBUTTONTYPEBYPOSITIONTYPE_HOLLOW_OFFSET UNITYSDK_OFFSET(0x7D0EE60)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_GETBUTTONTYPEBYPOSITIONTYPE_INLEVEL_OFFSET UNITYSDK_OFFSET(0x7D0E520)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_GETBUTTONTYPEBYPOSITIONTYPE_MAINCITY_OFFSET UNITYSDK_OFFSET(0x7D0E9D0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_GETPOSITIONTYPEFROMTEMPLATE_OFFSET UNITYSDK_OFFSET(0x7D0DDF0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x7D0AED0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_GET_ISHOLLOW_OFFSET UNITYSDK_OFFSET(0x7D0AEB0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_GET_ISINLEVEL_OFFSET UNITYSDK_OFFSET(0x7D0AE90)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_GET_ISMAINCITY_OFFSET UNITYSDK_OFFSET(0x7D0AEA0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x7D0AEC0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_INITRTBG_OFFSET UNITYSDK_OFFSET(0x7D0CE10)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_MARKALLBUTTONLAYOUTDIRTY_OFFSET UNITYSDK_OFFSET(0x7D0CD60)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_ONCAPTUREFINISHED_OFFSET UNITYSDK_OFFSET(0x7D0D420)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_ONCLICKBUTTONPOSTEMPLATE_OFFSET UNITYSDK_OFFSET(0x7D0D6E0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7D0CB60)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7D0CC00)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7D0AEE0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7D0CAB0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_REFRESHBUTTONPOSTEMPLATEWIDGETICON_OFFSET UNITYSDK_OFFSET(0x7D0C2F0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x7D0BFC0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_RELEASECAPTURETEXTURE_OFFSET UNITYSDK_OFFSET(0x7D0CC90)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER_RESETALLSLIDERVALUEANDBUTTONPOSITION_OFFSET UNITYSDK_OFFSET(0x7D0F7A0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7D0FA70)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7D0FA60)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER__ONUIINIT_B__14_0_OFFSET UNITYSDK_OFFSET(0x7D0FAB0)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7D0FB10)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7D0FB80)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7D0FB90)
#define MOLEMOLE_UIHOLLOWBUTTONPOSTEMPLATEDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7D0FBA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowButtonPosTemplateDialogPopWindowController_TypeDefinitionIndex = 51233;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIHollowButtonPosTemplateDialogPopWindowController_TypeDefinitionIndex)->GetStaticField(0xFE80);
		}
		static ::System::Boolean* StaticGet_EnableBlurBG()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIHollowButtonPosTemplateDialogPopWindowController_TypeDefinitionIndex)->GetStaticField(0xFE81);
		}
		static ::System::Boolean* StaticGet_Disable3DEntityiesOnFinishCallback()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIHollowButtonPosTemplateDialogPopWindowController_TypeDefinitionIndex)->GetStaticField(0xFE82);
		}
		::Class_2_79AE422BA06F6D26_152* _view; // 0x2F8
