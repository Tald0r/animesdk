...
#define MOLEMOLE_GAMEENGINE_ADDDEPENDENCY_OFFSET UNITYSDK_OFFSET(0x7590750)
#define MOLEMOLE_GAMEENGINE_ADD_ONFRAMESTART_OFFSET UNITYSDK_OFFSET(0x75902E0)
#define MOLEMOLE_GAMEENGINE_AFTERLOCALSTORAGELOADED_OFFSET UNITYSDK_OFFSET(0x7592A20)
#define MOLEMOLE_GAMEENGINE_AWAKE_OFFSET UNITYSDK_OFFSET(0x7590800)
#define MOLEMOLE_GAMEENGINE_BINDEXTRAUPDATEPHASECALLBACK_OFFSET UNITYSDK_OFFSET(0x7591080)
#define MOLEMOLE_GAMEENGINE_CLAMPDOUBLE_OFFSET UNITYSDK_OFFSET(0x7590080)
#define MOLEMOLE_GAMEENGINE_CREATEWHENRESTART_OFFSET UNITYSDK_OFFSET(0x7598C70)
#define MOLEMOLE_GAMEENGINE_DISPOSEWHENRESTART_OFFSET UNITYSDK_OFFSET(0x7598E30)
#define MOLEMOLE_GAMEENGINE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x7592B50)
#define MOLEMOLE_GAMEENGINE_FORCEQUITAPPLICATION2_OFFSET UNITYSDK_OFFSET(0x75980C0)
#define MOLEMOLE_GAMEENGINE_FORCEQUITAPPLICATION_OFFSET UNITYSDK_OFFSET(0x7597DA0)
#define MOLEMOLE_GAMEENGINE_GETCURGAMECONTEXT_OFFSET UNITYSDK_OFFSET(0x7598920)
#define MOLEMOLE_GAMEENGINE_GETCURGAMETYPE_OFFSET UNITYSDK_OFFSET(0x7598840)
#define MOLEMOLE_GAMEENGINE_GETLASTGAMECONTEXT_OFFSET UNITYSDK_OFFSET(0x7598990)
#define MOLEMOLE_GAMEENGINE_GETLASTGAMETYPE_OFFSET UNITYSDK_OFFSET(0x75988B0)
#define MOLEMOLE_GAMEENGINE_GETNAPSEED_OFFSET UNITYSDK_OFFSET(0x75903C0)
#define MOLEMOLE_GAMEENGINE_GET_APPLICATIONTARGETFRAMERATE_OFFSET UNITYSDK_OFFSET(0x758FF60)
#define MOLEMOLE_GAMEENGINE_GET_BUDGETSEC_OFFSET UNITYSDK_OFFSET(0x758FF70)
#define MOLEMOLE_GAMEENGINE_GET_CURGAME_OFFSET UNITYSDK_OFFSET(0x75901D0)
#define MOLEMOLE_GAMEENGINE_GET_CURRENTRUNSEED_OFFSET UNITYSDK_OFFSET(0x7590730)
#define MOLEMOLE_GAMEENGINE_GET_CURUISCENE_OFFSET UNITYSDK_OFFSET(0x75901E0)
#define MOLEMOLE_GAMEENGINE_GET_HANDLEINPUTINEARLYUPDATE_OFFSET UNITYSDK_OFFSET(0x7590130)
#define MOLEMOLE_GAMEENGINE_GET_ISLOADING_OFFSET UNITYSDK_OFFSET(0x7590260)
#define MOLEMOLE_GAMEENGINE_GET_ISRESTART_OFFSET UNITYSDK_OFFSET(0x75901C0)
#define MOLEMOLE_GAMEENGINE_GET_ISSEEDED_OFFSET UNITYSDK_OFFSET(0x7590740)
#define MOLEMOLE_GAMEENGINE_GET_USEFULLTIMELIMIT_OFFSET UNITYSDK_OFFSET(0x758FF40)
#define MOLEMOLE_GAMEENGINE_GET_USETIMELIMIT_OFFSET UNITYSDK_OFFSET(0x758FF20)
#define MOLEMOLE_GAMEENGINE_GOTOLOGINGAME_OFFSET UNITYSDK_OFFSET(0x7598A00)
#define MOLEMOLE_GAMEENGINE_INITCONFIGDATA_OFFSET UNITYSDK_OFFSET(0x7597B60)
#define MOLEMOLE_GAMEENGINE_INITWHENRESTART_OFFSET UNITYSDK_OFFSET(0x7598CE0)
#define MOLEMOLE_GAMEENGINE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7595490)
#define MOLEMOLE_GAMEENGINE_LAUNCHERGAME_OFFSET UNITYSDK_OFFSET(0x75983F0)
#define MOLEMOLE_GAMEENGINE_METHOD_5_045F1AAB54606068_OFFSET UNITYSDK_OFFSET(0x759AE40)
#define MOLEMOLE_GAMEENGINE_METHOD_5_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0x7599840)
#define MOLEMOLE_GAMEENGINE_METHOD_5_0AAA07F08640B711_OFFSET UNITYSDK_OFFSET(0x7598510)
#define MOLEMOLE_GAMEENGINE_METHOD_5_0B7E3489D2C0938B_OFFSET UNITYSDK_OFFSET(0x759AA00)
#define MOLEMOLE_GAMEENGINE_METHOD_5_23E4256FCB16FEBB_OFFSET UNITYSDK_OFFSET(0x7590A10)
#define MOLEMOLE_GAMEENGINE_METHOD_5_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0x759ABD0)
#define MOLEMOLE_GAMEENGINE_METHOD_5_276036CDF4BFF5A6_OFFSET UNITYSDK_OFFSET(0x7595FE0)
#define MOLEMOLE_GAMEENGINE_METHOD_5_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x75990B0)
#define MOLEMOLE_GAMEENGINE_METHOD_5_3CF43707BF2E9BBA_1_OFFSET UNITYSDK_OFFSET(0x7590980)
#define MOLEMOLE_GAMEENGINE_METHOD_5_3CF43707BF2E9BBA_2_OFFSET UNITYSDK_OFFSET(0x7596290)
#define MOLEMOLE_GAMEENGINE_METHOD_5_3CF43707BF2E9BBA_OFFSET UNITYSDK_OFFSET(0x75933D0)
#define MOLEMOLE_GAMEENGINE_METHOD_5_3E23A2EE3F65066B_OFFSET UNITYSDK_OFFSET(0x759C110)
#define MOLEMOLE_GAMEENGINE_METHOD_5_464B80C09A37526F_OFFSET UNITYSDK_OFFSET(0x759A780)
#define MOLEMOLE_GAMEENGINE_METHOD_5_5D3D37F2BAE9FB65_OFFSET UNITYSDK_OFFSET(0x7591660)
#define MOLEMOLE_GAMEENGINE_METHOD_5_627C7524E98F4AC5_1_OFFSET UNITYSDK_OFFSET(0x759A640)
#define MOLEMOLE_GAMEENGINE_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x759A6E0)
#define MOLEMOLE_GAMEENGINE_METHOD_5_6423291ED13007B8_OFFSET UNITYSDK_OFFSET(0x7598D50)
#define MOLEMOLE_GAMEENGINE_METHOD_5_676E831338583C9D_OFFSET UNITYSDK_OFFSET(0x759C6E0)
#define MOLEMOLE_GAMEENGINE_METHOD_5_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0x7599A50)
#define MOLEMOLE_GAMEENGINE_METHOD_5_705FFC79B57F4953_OFFSET UNITYSDK_OFFSET(0x759A130)
#define MOLEMOLE_GAMEENGINE_METHOD_5_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x7599210)
#define MOLEMOLE_GAMEENGINE_METHOD_5_7A73F165001BC325_OFFSET UNITYSDK_OFFSET(0x7592180)
#define MOLEMOLE_GAMEENGINE_METHOD_5_7DBE4BF81A0D0238_OFFSET UNITYSDK_OFFSET(0x7591860)
#define MOLEMOLE_GAMEENGINE_METHOD_5_8327FEEFBF3EC917_OFFSET UNITYSDK_OFFSET(0x75931C0)
#define MOLEMOLE_GAMEENGINE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x759C620)
#define MOLEMOLE_GAMEENGINE_METHOD_5_9765352E01408D38_OFFSET UNITYSDK_OFFSET(0x759AC80)
#define MOLEMOLE_GAMEENGINE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x7599F80)
#define MOLEMOLE_GAMEENGINE_METHOD_5_CF8BA38996D09531_OFFSET UNITYSDK_OFFSET(0x7599FE0)
#define MOLEMOLE_GAMEENGINE_METHOD_5_DF3BCB639F0C02DF_OFFSET UNITYSDK_OFFSET(0x7596320)
#define MOLEMOLE_GAMEENGINE_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x7597920)
#define MOLEMOLE_GAMEENGINE_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x75973D0)
#define MOLEMOLE_GAMEENGINE_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x7597060)
#define MOLEMOLE_GAMEENGINE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x7596120)
#define MOLEMOLE_GAMEENGINE_REMOVE_ONFRAMESTART_OFFSET UNITYSDK_OFFSET(0x7590350)
#define MOLEMOLE_GAMEENGINE_SETLOADINGSTAGE_OFFSET UNITYSDK_OFFSET(0x75987C0)
#define MOLEMOLE_GAMEENGINE_SETUPCURRENTCULTURE_OFFSET UNITYSDK_OFFSET(0x75921F0)
#define MOLEMOLE_GAMEENGINE_SET_BUDGETSEC_OFFSET UNITYSDK_OFFSET(0x758FF80)
#define MOLEMOLE_GAMEENGINE_SET_CURRENTRUNSEED_OFFSET UNITYSDK_OFFSET(0x7590690)
#define MOLEMOLE_GAMEENGINE_SET_HANDLEINPUTINEARLYUPDATE_OFFSET UNITYSDK_OFFSET(0x7590140)
#define MOLEMOLE_GAMEENGINE_SET_USEFULLTIMELIMIT_OFFSET UNITYSDK_OFFSET(0x758FF50)
#define MOLEMOLE_GAMEENGINE_SET_USETIMELIMIT_OFFSET UNITYSDK_OFFSET(0x758FF30)
#define MOLEMOLE_GAMEENGINE_START_OFFSET UNITYSDK_OFFSET(0x7591430)
#define MOLEMOLE_GAMEENGINE_TESTANDINFORMFRAMESTART_OFFSET UNITYSDK_OFFSET(0x7592990)
#define MOLEMOLE_GAMEENGINE_UNBINDEXTRAUPDATECALLBACK_OFFSET UNITYSDK_OFFSET(0x7591280)
#define MOLEMOLE_GAMEENGINE_UPDATE_OFFSET UNITYSDK_OFFSET(0x7593570)
#define MOLEMOLE_GAMEENGINE__CCTOR_OFFSET UNITYSDK_OFFSET(0x7599200)
#define MOLEMOLE_GAMEENGINE__CTOR_OFFSET UNITYSDK_OFFSET(0x7599170)

namespace MoleMole
{
	inline static constexpr unsigned int GameEngine_TypeDefinitionIndex = 56887;
	...
	public:
		...
		{
			return (::MoleMole::GameEngine**)Il2CppClass::FromTypeDefinitionIndex(GameEngine_TypeDefinitionIndex)->GetStaticField(0x29160);
		}
		static ::System::Boolean* StaticGet_HalfFrameFixedUpdate()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(GameEngine_TypeDefinitionIndex)->GetStaticField(0x9380);
		}
		static ::System::Boolean* StaticGet_QuitApplication()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(GameEngine_TypeDefinitionIndex)->GetStaticField(0x9381);
		}
		static ::System::Boolean* StaticGet_Field_5_7()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(GameEngine_TypeDefinitionIndex)->GetStaticField(0x9382);
		}
