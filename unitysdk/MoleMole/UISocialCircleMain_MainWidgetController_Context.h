...
#define MOLEMOLE_UISOCIALCIRCLEMAIN_MAINWIDGETCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAE11C10)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleMain_MainWidgetController_Context_TypeDefinitionIndex = 50172;
