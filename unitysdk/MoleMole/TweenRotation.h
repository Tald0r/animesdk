...
#define MOLEMOLE_TWEENROTATION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x6EE3D40)
#define MOLEMOLE_TWEENROTATION_METHOD_7_CCD232FEDFF62067_OFFSET UNITYSDK_OFFSET(0x6EE3E10)
#define MOLEMOLE_TWEENROTATION_METHOD_7_D3E17EE162EAD52F_OFFSET UNITYSDK_OFFSET(0x6EE3F70)
#define MOLEMOLE_TWEENROTATION_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x6EE3D60)
#define MOLEMOLE_TWEENROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x6EE40C0)
#define MOLEMOLE_TWEENROTATION___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x6EE40D0)

namespace MoleMole
{
	inline static constexpr unsigned int TweenRotation_TypeDefinitionIndex = 58226;
