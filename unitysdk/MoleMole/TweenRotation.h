...
#define MOLEMOLE_TWEENROTATION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xD1AEDD0)
#define MOLEMOLE_TWEENROTATION_METHOD_7_CCD232FEDFF62067_OFFSET UNITYSDK_OFFSET(0xD1AEEA0)
#define MOLEMOLE_TWEENROTATION_METHOD_7_D3E17EE162EAD52F_OFFSET UNITYSDK_OFFSET(0xD1AF000)
#define MOLEMOLE_TWEENROTATION_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xD1AEDF0)
#define MOLEMOLE_TWEENROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0xD1AF150)
#define MOLEMOLE_TWEENROTATION___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xD1AF160)

namespace MoleMole
{
	inline static constexpr unsigned int TweenRotation_TypeDefinitionIndex = 58140;
