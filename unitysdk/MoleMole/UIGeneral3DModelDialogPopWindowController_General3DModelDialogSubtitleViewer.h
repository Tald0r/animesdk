...
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER_GENERAL3DMODELDIALOGSUBTITLEVIEWER_HIDE_OFFSET UNITYSDK_OFFSET(0xA991CA0)
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER_GENERAL3DMODELDIALOGSUBTITLEVIEWER_SHOW_OFFSET UNITYSDK_OFFSET(0xA991B10)
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER_GENERAL3DMODELDIALOGSUBTITLEVIEWER__CTOR_OFFSET UNITYSDK_OFFSET(0xA991B00)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneral3DModelDialogPopWindowController_General3DModelDialogSubtitleViewer_TypeDefinitionIndex = 42259;
