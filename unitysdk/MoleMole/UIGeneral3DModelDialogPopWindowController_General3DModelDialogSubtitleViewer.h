...
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER_GENERAL3DMODELDIALOGSUBTITLEVIEWER_HIDE_OFFSET UNITYSDK_OFFSET(0x7A3B760)
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER_GENERAL3DMODELDIALOGSUBTITLEVIEWER_SHOW_OFFSET UNITYSDK_OFFSET(0x7A3B5D0)
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER_GENERAL3DMODELDIALOGSUBTITLEVIEWER__CTOR_OFFSET UNITYSDK_OFFSET(0x7A3B5C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneral3DModelDialogPopWindowController_General3DModelDialogSubtitleViewer_TypeDefinitionIndex = 40564;
