...
#define MOLEMOLE_UIHANDBOOKTOWERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x809C000)
#define MOLEMOLE_UIHANDBOOKTOWERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x809C0A0)
#define MOLEMOLE_UIHANDBOOKTOWERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x809B5E0)
#define MOLEMOLE_UIHANDBOOKTOWERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x809BA40)
#define MOLEMOLE_UIHANDBOOKTOWERWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x809BB60)
#define MOLEMOLE_UIHANDBOOKTOWERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x809C180)
#define MOLEMOLE_UIHANDBOOKTOWERWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0x809C1B0)
#define MOLEMOLE_UIHANDBOOKTOWERWIDGETCONTROLLER__ONUIINIT_B__2_1_OFFSET UNITYSDK_OFFSET(0x809C1D0)
#define MOLEMOLE_UIHANDBOOKTOWERWIDGETCONTROLLER__ONUIINIT_B__2_3_OFFSET UNITYSDK_OFFSET(0x809C1F0)
#define MOLEMOLE_UIHANDBOOKTOWERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x809C270)
#define MOLEMOLE_UIHANDBOOKTOWERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x809C2E0)
#define MOLEMOLE_UIHANDBOOKTOWERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x809C360)
#define MOLEMOLE_UIHANDBOOKTOWERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x809C3C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookTowerWidgetController_TypeDefinitionIndex = 65806;
