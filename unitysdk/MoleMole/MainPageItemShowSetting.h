...
#define MOLEMOLE_MAINPAGEITEMSHOWSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x8F87010)

namespace MoleMole
{
	inline static constexpr unsigned int MainPageItemShowSetting_TypeDefinitionIndex = 74139;
