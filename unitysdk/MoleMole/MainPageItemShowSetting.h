...
#define MOLEMOLE_MAINPAGEITEMSHOWSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xD0E7410)

namespace MoleMole
{
	inline static constexpr unsigned int MainPageItemShowSetting_TypeDefinitionIndex = 41113;
