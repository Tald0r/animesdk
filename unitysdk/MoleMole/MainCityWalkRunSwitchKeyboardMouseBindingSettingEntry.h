...
#define MOLEMOLE_MAINCITYWALKRUNSWITCHKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xD80FAB0)
#define MOLEMOLE_MAINCITYWALKRUNSWITCHKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xD80FAC0)
#define MOLEMOLE_MAINCITYWALKRUNSWITCHKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xD80FAD0)

namespace MoleMole
{
	inline static constexpr unsigned int MainCityWalkRunSwitchKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 56011;
