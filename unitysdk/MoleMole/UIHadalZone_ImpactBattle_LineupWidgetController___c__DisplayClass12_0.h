...
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8C2A2A0)
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__OPENSELECTROLEPAGE_B__0_OFFSET UNITYSDK_OFFSET(0x8C2A7B0)
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__OPENSELECTROLEPAGE_B__1_OFFSET UNITYSDK_OFFSET(0x8C2A2B0)
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__OPENSELECTROLEPAGE_B__3_OFFSET UNITYSDK_OFFSET(0x8C2A6B0)
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__OPENSELECTROLEPAGE_B__4_OFFSET UNITYSDK_OFFSET(0x8C2A730)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_ImpactBattle_LineupWidgetController___c__DisplayClass12_0_TypeDefinitionIndex = 54347;
	...
	public:
		...
		::System::Void _OpenSelectRolePage_b__1(::Class_1_44EFB945CAE441A3* data)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_44EFB945CAE441A3*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__OPENSELECTROLEPAGE_B__1_OFFSET))(this, data);
		}
