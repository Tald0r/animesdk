...
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9605560)
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__OPENSELECTROLEPAGE_B__0_OFFSET UNITYSDK_OFFSET(0x9605A70)
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__OPENSELECTROLEPAGE_B__1_OFFSET UNITYSDK_OFFSET(0x9605570)
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__OPENSELECTROLEPAGE_B__3_OFFSET UNITYSDK_OFFSET(0x9605970)
#define MOLEMOLE_UIHADALZONE_IMPACTBATTLE_LINEUPWIDGETCONTROLLER___C__DISPLAYCLASS12_0__OPENSELECTROLEPAGE_B__4_OFFSET UNITYSDK_OFFSET(0x96059F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_ImpactBattle_LineupWidgetController___c__DisplayClass12_0_TypeDefinitionIndex = 58621;
