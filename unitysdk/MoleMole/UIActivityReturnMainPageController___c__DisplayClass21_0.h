...
#define MOLEMOLE_UIACTIVITYRETURNMAINPAGECONTROLLER___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0xE90CA40)
#define MOLEMOLE_UIACTIVITYRETURNMAINPAGECONTROLLER___C__DISPLAYCLASS21_0__PLAYVIDEO_B__0_OFFSET UNITYSDK_OFFSET(0xE90CA50)
#define MOLEMOLE_UIACTIVITYRETURNMAINPAGECONTROLLER___C__DISPLAYCLASS21_0__PLAYVIDEO_B__1_OFFSET UNITYSDK_OFFSET(0xE90CAA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityReturnMainPageController___c__DisplayClass21_0_TypeDefinitionIndex = 52503;
