...
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_CANTRANSFERTONEXTROUND_OFFSET UNITYSDK_OFFSET(0xC26E8B0)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_GET_ENDROUNDINDEX_OFFSET UNITYSDK_OFFSET(0xC26E880)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_GET_SOURCEUNIT_OFFSET UNITYSDK_OFFSET(0xC26E8A0)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_ONTURNOVER_OFFSET UNITYSDK_OFFSET(0xC26EBA0)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_ONTURNSTART_OFFSET UNITYSDK_OFFSET(0xC26EB20)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_SET_ENDROUNDINDEX_OFFSET UNITYSDK_OFFSET(0xC26E890)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT_TRYEXCHANGEENDROUNDINDEX_OFFSET UNITYSDK_OFFSET(0xC26E9D0)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT__CCTOR_OFFSET UNITYSDK_OFFSET(0xC26EC20)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0xC26E930)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT___BASE_ONTURNOVER_OFFSET UNITYSDK_OFFSET(0xC26EC60)
#define MOLEMOLE_TURNBATTLEENTITYEXTRAUNIT___BASE_ONTURNSTART_OFFSET UNITYSDK_OFFSET(0xC26ECC0)

namespace MoleMole
{
	inline static constexpr unsigned int TurnBattleEntityExtraUnit_TypeDefinitionIndex = 48878;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(TurnBattleEntityExtraUnit_TypeDefinitionIndex)->GetStaticField(0xE6E0);
		}
