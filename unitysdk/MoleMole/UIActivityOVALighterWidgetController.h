...
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_CLEARCOMPONTNBTNS_OFFSET UNITYSDK_OFFSET(0xBF19A20)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_CREATEBASEACTIVITYINFO_OFFSET UNITYSDK_OFFSET(0xBF18F40)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_CREATEBTNSTYLE_OFFSET UNITYSDK_OFFSET(0xBF18A40)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_INVOKEENTRYBTN_OFFSET UNITYSDK_OFFSET(0xBF19E00)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONCLICKGENERALACTIVITYTAG_OFFSET UNITYSDK_OFFSET(0xBF193F0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONCLICKREWARD_OFFSET UNITYSDK_OFFSET(0xBF19A80)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF19280)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBF18590)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF19620)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF183E0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF184E0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONUPDATEUI_OFFSET UNITYSDK_OFFSET(0xBF191F0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER__CREATEBASEACTIVITYINFO_B__10_0_OFFSET UNITYSDK_OFFSET(0xBF1A0B0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF1A010)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF1A160)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBF1A1D0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF1A240)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF1A2C0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF1A320)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityOVALighterWidgetController_TypeDefinitionIndex = 57366;
	...
	public:
		...
		::Class_2_447546814EA5BBED* _view; // 0x2A0
		::MoleMole::ActivityAvatarWdigetContext* contex; // 0x2A8
		::System::Collections::Generic::List_1<::MoleMole::UIActivityOVALighterEntryBtnWidgetController*>* btns; // 0x2B0
		::MoleMole::UIActivityCompWeekRewardBtnWidgetController* _compRewardBtn; // 0x2B8
