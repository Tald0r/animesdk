...
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_CLEARCOMPONTNBTNS_OFFSET UNITYSDK_OFFSET(0xBD86F20)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_CREATEBASEACTIVITYINFO_OFFSET UNITYSDK_OFFSET(0xBD86440)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_CREATEBTNSTYLE_OFFSET UNITYSDK_OFFSET(0xBD85F30)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_INVOKEENTRYBTN_OFFSET UNITYSDK_OFFSET(0xBD87300)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONCLICKGENERALACTIVITYTAG_OFFSET UNITYSDK_OFFSET(0xBD868F0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONCLICKREWARD_OFFSET UNITYSDK_OFFSET(0xBD86F80)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD86780)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBD85A80)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD86B20)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD858D0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD859D0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER_ONUPDATEUI_OFFSET UNITYSDK_OFFSET(0xBD866F0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER__CREATEBASEACTIVITYINFO_B__10_0_OFFSET UNITYSDK_OFFSET(0xBD875C0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBD87510)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD87670)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBD876E0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD87750)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD877D0)
#define MOLEMOLE_UIACTIVITYOVALIGHTERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBD87830)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityOVALighterWidgetController_TypeDefinitionIndex = 62024;
