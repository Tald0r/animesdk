...
#define MOLEMOLE_UISUIBIANTEMPLEPRODUCTIONPANELWIDGETCONTROLLER__CHECKNEWBIE_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x325B00)
#define MOLEMOLE_UISUIBIANTEMPLEPRODUCTIONPANELWIDGETCONTROLLER__CHECKNEWBIE_D__25_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2C7C30)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleProductionPanelWidgetController__CheckNewBie_d__25_TypeDefinitionIndex = 77466;
