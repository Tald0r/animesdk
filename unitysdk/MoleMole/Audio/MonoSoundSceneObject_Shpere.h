...
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_SHPERE_AWAKE_OFFSET UNITYSDK_OFFSET(0x7BA97D0)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_SHPERE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x7BA9980)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_SHPERE__CTOR_OFFSET UNITYSDK_OFFSET(0x7BA9AD0)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSoundSceneObject_Shpere_TypeDefinitionIndex = 55538;
