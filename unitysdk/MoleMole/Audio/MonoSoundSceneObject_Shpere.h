...
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_SHPERE_AWAKE_OFFSET UNITYSDK_OFFSET(0x95C4670)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_SHPERE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x95C4820)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_SHPERE__CTOR_OFFSET UNITYSDK_OFFSET(0x95C4970)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSoundSceneObject_Shpere_TypeDefinitionIndex = 65164;
