...
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_AUTOCOLLECTWAYPATHPOINTS_OFFSET UNITYSDK_OFFSET(0xB43B8E0)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_DRAWGIZMOSARROW_OFFSET UNITYSDK_OFFSET(0xB43C170)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_INIT_OFFSET UNITYSDK_OFFSET(0xB43B000)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xB43C840)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_ONITEMACTIVECHANGED_OFFSET UNITYSDK_OFFSET(0xB43B120)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_REGISTER_OFFSET UNITYSDK_OFFSET(0xB43BCA0)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_UNREGISTER_OFFSET UNITYSDK_OFFSET(0xB43BEE0)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC__CTOR_OFFSET UNITYSDK_OFFSET(0xB43CBC0)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int SceneSound_WayPathToRTPC_TypeDefinitionIndex = 72556;
