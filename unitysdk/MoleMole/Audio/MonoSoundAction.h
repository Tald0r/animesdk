...
#define MOLEMOLE_AUDIO_MONOSOUNDACTION_AWAKE_OFFSET UNITYSDK_OFFSET(0x6BD4710)
#define MOLEMOLE_AUDIO_MONOSOUNDACTION_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x6BD4640)
#define MOLEMOLE_AUDIO_MONOSOUNDACTION_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x6BD3B10)
#define MOLEMOLE_AUDIO_MONOSOUNDACTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6BD4BF0)
#define MOLEMOLE_AUDIO_MONOSOUNDACTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x6BD49E0)
#define MOLEMOLE_AUDIO_MONOSOUNDACTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x6BD47A0)
#define MOLEMOLE_AUDIO_MONOSOUNDACTION_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x6BD4EF0)
#define MOLEMOLE_AUDIO_MONOSOUNDACTION_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x6BD5010)
#define MOLEMOLE_AUDIO_MONOSOUNDACTION_TRIGGERONDISABLESOUNDACTION_OFFSET UNITYSDK_OFFSET(0x6BD4B60)
#define MOLEMOLE_AUDIO_MONOSOUNDACTION_TRIGGERONENABLESOUNDACTION_OFFSET UNITYSDK_OFFSET(0x6BD4950)
#define MOLEMOLE_AUDIO_MONOSOUNDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x6BD5130)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSoundAction_TypeDefinitionIndex = 41000;
