...
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x9B2BE10)
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x9B2BDE0)
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x9B2BDD0)
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9B2BF20)
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM_ONSCENELEAVE_OFFSET UNITYSDK_OFFSET(0x9B2C2B0)
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM_ONSCENETAGCHANGED_OFFSET UNITYSDK_OFFSET(0x9B2C060)
#define MOLEMOLE_AUDIO_MONOSCENESOUNDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9B2C370)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSceneSoundItem_TypeDefinitionIndex = 44091;
