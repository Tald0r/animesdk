...
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_BOX_AWAKE_OFFSET UNITYSDK_OFFSET(0x62104D0)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_BOX_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6210680)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_BOX__CTOR_OFFSET UNITYSDK_OFFSET(0x62107D0)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSoundSceneObject_Box_TypeDefinitionIndex = 67903;
