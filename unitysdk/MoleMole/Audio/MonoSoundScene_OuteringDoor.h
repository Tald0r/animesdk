...
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR_AWAKE_OFFSET UNITYSDK_OFFSET(0xB073F90)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR_METHOD_5_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0xB074340)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR_METHOD_5_99053D1AE5A59190_OFFSET UNITYSDK_OFFSET(0xB0746B0)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB074A80)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR_START_OFFSET UNITYSDK_OFFSET(0xB074000)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR_UPDATE_OFFSET UNITYSDK_OFFSET(0xB0740D0)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENE_OUTERINGDOOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB074C50)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSoundScene_OuteringDoor_TypeDefinitionIndex = 50916;
