...
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER_CREATE_OFFSET UNITYSDK_OFFSET(0x84E55B0)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER_INIT_OFFSET UNITYSDK_OFFSET(0x84E4A60)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER_ONSYNC_OFFSET UNITYSDK_OFFSET(0x84E4EA0)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER_POLISH_OFFSET UNITYSDK_OFFSET(0x84E5420)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER_RECYCLE_OFFSET UNITYSDK_OFFSET(0x84E54C0)
#define MOLEMOLE_AUDIO_SCENESOUND_WAYPATHTORTPC_WAYPATHTORTPC_SYNCMETHODPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x84E5670)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int SceneSound_WayPathToRTPC_WayPathToRTPC_SyncMethodProvider_TypeDefinitionIndex = 72557;
