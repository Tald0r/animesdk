...
#define MOLEMOLE_AUDIO_MONOSOUND_SIMPLEMASTS_WATCHER_AWAKE_OFFSET UNITYSDK_OFFSET(0x91589A0)
#define MOLEMOLE_AUDIO_MONOSOUND_SIMPLEMASTS_WATCHER_METHOD_5_B961D33AD47A2113_OFFSET UNITYSDK_OFFSET(0x9159340)
#define MOLEMOLE_AUDIO_MONOSOUND_SIMPLEMASTS_WATCHER_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x9158D30)
#define MOLEMOLE_AUDIO_MONOSOUND_SIMPLEMASTS_WATCHER_START_OFFSET UNITYSDK_OFFSET(0x9158A90)
#define MOLEMOLE_AUDIO_MONOSOUND_SIMPLEMASTS_WATCHER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9158DE0)
#define MOLEMOLE_AUDIO_MONOSOUND_SIMPLEMASTS_WATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x9159290)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSound_SimpleMASTS_Watcher_TypeDefinitionIndex = 42651;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::MoleMole::Audio::MonoSound_SimpleMASTS_Watcher_Enum_3_AFB340EC45DBD241, ::MoleMole::Audio::MonoSound_SimpleMASTS_Watcher_Class_1_87A39285B4D9F2A1*>* Field_5_2; // 0x28
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_AUDIO_MONOSOUND_SIMPLEMASTS_WATCHER_METHOD_5_B961D33AD47A2113_OFFSET))(this);
		}
	};
}
