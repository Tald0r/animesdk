...
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_FOLLOW_AWAKE_OFFSET UNITYSDK_OFFSET(0xE2A3150)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_FOLLOW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xE2A3500)
#define MOLEMOLE_AUDIO_MONOSOUNDSCENEOBJECT_FOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0xE2A36E0)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int MonoSoundSceneObject_Follow_TypeDefinitionIndex = 47297;
