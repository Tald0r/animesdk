...
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING_INIT_OFFSET UNITYSDK_OFFSET(0x7BAA040)
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING_ONSUBSCRIPTACTIVE_OFFSET UNITYSDK_OFFSET(0x7BAA550)
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING_ONSUBSCRIPTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x7BAA8D0)
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING_ONSUBSCRIPTTICK_OFFSET UNITYSDK_OFFSET(0x7BAA0B0)
#define MOLEMOLE_AUDIO_SOUNDSUBSCRIPT_MOVING__CTOR_OFFSET UNITYSDK_OFFSET(0x7BAABA0)

namespace MoleMole::Audio
{
	inline static constexpr unsigned int SoundSubScript_Moving_TypeDefinitionIndex = 44666;
