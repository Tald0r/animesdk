...
#define MOLEMOLE_UIGENERALBUBBLECHATCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8A121E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralBubbleChatContext_TypeDefinitionIndex = 65848;
