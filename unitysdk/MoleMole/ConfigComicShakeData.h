...
#define MOLEMOLE_CONFIGCOMICSHAKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC1E4B10)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigComicShakeData_TypeDefinitionIndex = 75375;

	class ConfigComicShakeData : public ::System::Object
	{
	public:
		::MoleMole::Config::AnimCurveParam* EnlargeScaleParam; // 0x10
