...
#define MOLEMOLE_UIFISHINGCONTESTMATCHRESULTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA356C80)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishingContestMatchResultContext_TypeDefinitionIndex = 57137;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_451601B8BB62C38C*>* PlayerInfos; // 0x30
