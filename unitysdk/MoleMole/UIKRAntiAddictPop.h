...
#define MOLEMOLE_UIKRANTIADDICTPOP_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xC11CA30)
#define MOLEMOLE_UIKRANTIADDICTPOP_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xC11CA70)
#define MOLEMOLE_UIKRANTIADDICTPOP__CTOR_OFFSET UNITYSDK_OFFSET(0xC11CA40)

namespace MoleMole
{
	inline static constexpr unsigned int UIKRAntiAddictPop_TypeDefinitionIndex = 51020;
