...
#define MOLEMOLE_UIKRANTIADDICTPOP_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xAD9B390)
#define MOLEMOLE_UIKRANTIADDICTPOP_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xAD9B3D0)
#define MOLEMOLE_UIKRANTIADDICTPOP__CTOR_OFFSET UNITYSDK_OFFSET(0xAD9B3A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIKRAntiAddictPop_TypeDefinitionIndex = 60735;
