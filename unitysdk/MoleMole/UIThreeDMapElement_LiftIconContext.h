...
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9713520)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_EQUALS_OFFSET UNITYSDK_OFFSET(0x9713360)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_GETICONWIDGETNAME_OFFSET UNITYSDK_OFFSET(0x97130D0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_GETMAPICON_OFFSET UNITYSDK_OFFSET(0x9713670)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_GETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x9713220)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_ISENABLE_OFFSET UNITYSDK_OFFSET(0x9713160)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x97131C0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x97137C0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x97137D0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_GETICONWIDGETNAME_OFFSET UNITYSDK_OFFSET(0x97137E0)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_GETMAPICON_OFFSET UNITYSDK_OFFSET(0x9713840)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_GETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x9713870)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_ISENABLE_OFFSET UNITYSDK_OFFSET(0x9713920)
#define MOLEMOLE_UITHREEDMAPELEMENT_LIFTICONCONTEXT___BASE_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x9713930)

namespace MoleMole
{
	inline static constexpr unsigned int UIThreeDMapElement_LiftIconContext_TypeDefinitionIndex = 43419;
