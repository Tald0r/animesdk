...
#define MOLEMOLE_IMGTEXTPARSERBASE_METHOD_5_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0xF1B7750)
#define MOLEMOLE_IMGTEXTPARSERBASE_METHOD_5_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0xF1B7810)
#define MOLEMOLE_IMGTEXTPARSERBASE_METHOD_5_BCC281DC419BB5B6_OFFSET UNITYSDK_OFFSET(0xF1B76C0)
#define MOLEMOLE_IMGTEXTPARSERBASE_METHOD_5_D4112DE96B7B2EBB_OFFSET UNITYSDK_OFFSET(0xF1B6F40)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETCOLOR_OFFSET UNITYSDK_OFFSET(0xF1B6E30)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETKEY_OFFSET UNITYSDK_OFFSET(0xF1B7160)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETTEXTFUNCNOTCLEARFUNC_OFFSET UNITYSDK_OFFSET(0xF1B7240)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETTEXTFUNC_OFFSET UNITYSDK_OFFSET(0xF1B7080)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETTEXTNOTCLEARFUNC_OFFSET UNITYSDK_OFFSET(0xF1B7550)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETTEXT_OFFSET UNITYSDK_OFFSET(0xF1B73E0)
#define MOLEMOLE_IMGTEXTPARSERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xF1B7730)

namespace MoleMole
{
	inline static constexpr unsigned int ImgTextParserBase_TypeDefinitionIndex = 47708;
