...
#define MOLEMOLE_IMGTEXTPARSERBASE_METHOD_5_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0xB991290)
#define MOLEMOLE_IMGTEXTPARSERBASE_METHOD_5_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0xB991350)
#define MOLEMOLE_IMGTEXTPARSERBASE_METHOD_5_BCC281DC419BB5B6_OFFSET UNITYSDK_OFFSET(0xB991200)
#define MOLEMOLE_IMGTEXTPARSERBASE_METHOD_5_D4112DE96B7B2EBB_OFFSET UNITYSDK_OFFSET(0xB990A80)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETCOLOR_OFFSET UNITYSDK_OFFSET(0xB990970)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETKEY_OFFSET UNITYSDK_OFFSET(0xB990CA0)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETTEXTFUNCNOTCLEARFUNC_OFFSET UNITYSDK_OFFSET(0xB990D80)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETTEXTFUNC_OFFSET UNITYSDK_OFFSET(0xB990BC0)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETTEXTNOTCLEARFUNC_OFFSET UNITYSDK_OFFSET(0xB991090)
#define MOLEMOLE_IMGTEXTPARSERBASE_SETTEXT_OFFSET UNITYSDK_OFFSET(0xB990F20)
#define MOLEMOLE_IMGTEXTPARSERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xB991270)

namespace MoleMole
{
	inline static constexpr unsigned int ImgTextParserBase_TypeDefinitionIndex = 72933;
	...
	public:
		...
		::UnityEngine::UI::Extension::UIImgText* Method_5_D4112DE96B7B2EBB()
		{
			return ((::UnityEngine::UI::Extension::UIImgText*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_IMGTEXTPARSERBASE_METHOD_5_D4112DE96B7B2EBB_OFFSET))(this);
		}
