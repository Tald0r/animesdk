...
#define MOLEMOLE_MONOSIMPLEAVATARRENDERHANDLE_FORCECLEAR_OFFSET UNITYSDK_OFFSET(0x67C0440)
#define MOLEMOLE_MONOSIMPLEAVATARRENDERHANDLE_GETALLMATERIALS_OFFSET UNITYSDK_OFFSET(0x67C0680)
#define MOLEMOLE_MONOSIMPLEAVATARRENDERHANDLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x67C04B0)
#define MOLEMOLE_MONOSIMPLEAVATARRENDERHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x67C0CC0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSimpleAvatarRenderHandle_TypeDefinitionIndex = 52889;
