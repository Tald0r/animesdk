...
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER_GET_GENERALBUTTONCONTROLLER_OFFSET UNITYSDK_OFFSET(0xB523350)
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5233C0)
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB523430)
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB5234F0)
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB523740)
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB523770)
#define MOLEMOLE_UIPLATFORMGENERALBUTTONWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB5237E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlatformGeneralButtonWidgetController_TypeDefinitionIndex = 68557;
