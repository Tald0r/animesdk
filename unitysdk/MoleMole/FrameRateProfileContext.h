...
#define MOLEMOLE_FRAMERATEPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x678F9C0)

namespace MoleMole
{
	inline static constexpr unsigned int FrameRateProfileContext_TypeDefinitionIndex = 42600;
