...
#define MOLEMOLE_FRAMERATEPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x758C780)

namespace MoleMole
{
	inline static constexpr unsigned int FrameRateProfileContext_TypeDefinitionIndex = 56510;
