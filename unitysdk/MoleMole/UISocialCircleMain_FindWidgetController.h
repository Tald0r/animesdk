...
#define MOLEMOLE_UISOCIALCIRCLEMAIN_FINDWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAB77D30)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_FINDWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAB77DA0)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_FINDWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB77EA0)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_FINDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB78250)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_FINDWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAB78280)
#define MOLEMOLE_UISOCIALCIRCLEMAIN_FINDWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAB782F0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleMain_FindWidgetController_TypeDefinitionIndex = 79891;
