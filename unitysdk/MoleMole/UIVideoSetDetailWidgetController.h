...
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER_CLEARRARITYITEMLIST_OFFSET UNITYSDK_OFFSET(0x95AC750)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x95AC2F0)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95AC480)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x95AC520)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95AC660)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95AC240)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95AC3D0)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x95AC9D0)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER_SETSUITDATA_OFFSET UNITYSDK_OFFSET(0x95AC8F0)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x95AD300)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95AD3A0)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x95AD410)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95AD480)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95AD500)
#define MOLEMOLE_UIVIDEOSETDETAILWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95AD560)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoSetDetailWidgetController_TypeDefinitionIndex = 57307;
