...
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONCLICKLOCKED_OFFSET UNITYSDK_OFFSET(0x8BB0F10)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONCLICKRECEIVE_OFFSET UNITYSDK_OFFSET(0x8BB0CA0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BAF750)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x8BAF8D0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8BAF960)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BAF7F0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BAF630)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_REFRESHREDDOT_OFFSET UNITYSDK_OFFSET(0x8BB0C00)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_REFRESHTASKPROGRESS_OFFSET UNITYSDK_OFFSET(0x8BB07E0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_REFRESHTASKSTATUS_OFFSET UNITYSDK_OFFSET(0x8BAFFE0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_REFRESHTASKTYPE_OFFSET UNITYSDK_OFFSET(0x8BAFBA0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_SETREWARD_OFFSET UNITYSDK_OFFSET(0x8BB0910)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8BB0FE0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BB0FF0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x8BB1060)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8BB10C0)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BB1140)
#define MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BB11C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPTaskRowWidgetController_TypeDefinitionIndex = 79475;

	class UIBPTaskRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_188* _view; // 0x2D0
		::Class_3_AE02BC8285203464_31* refBPTask; // 0x2D8
		...
		::System::Void RefreshTaskStatus(::Enum_3_4608E37A1B3D374A_1 targetStatus)
		{
			return ((::System::Void(*)(::PVOID, ::Enum_3_4608E37A1B3D374A_1))((::PBYTE)hIl2Cpp + MOLEMOLE_UIBPTASKROWWIDGETCONTROLLER_REFRESHTASKSTATUS_OFFSET))(this, targetStatus);
		}
