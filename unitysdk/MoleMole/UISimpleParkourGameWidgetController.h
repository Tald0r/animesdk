...
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_DORESET_OFFSET UNITYSDK_OFFSET(0xAFB5850)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_GETCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0xAFB6B30)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_GETNODEROOT_OFFSET UNITYSDK_OFFSET(0xAFB5C70)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_GET_FADECURVE_OFFSET UNITYSDK_OFFSET(0xAFB4390)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAFB4320)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_INITTRACK_OFFSET UNITYSDK_OFFSET(0xAFB53C0)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xAFB50C0)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAFB4400)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xAFB4E30)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAFB4550)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAFB4B10)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_ONWIN_OFFSET UNITYSDK_OFFSET(0xAFB5AF0)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_SETANIMATORLOCKED_OFFSET UNITYSDK_OFFSET(0xAFB54E0)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_TOGGLEPLAYERHOLDSOUND_OFFSET UNITYSDK_OFFSET(0xAFB6230)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_TOGGLEPLAYERHOLD_OFFSET UNITYSDK_OFFSET(0xAFB60C0)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_TRIGGERCLICKANIM_OFFSET UNITYSDK_OFFSET(0xAFB5DD0)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_TRIGGERSPEEDBOOSTANIM_OFFSET UNITYSDK_OFFSET(0xAFB5E50)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_TRYSWITCHTRACK_1_OFFSET UNITYSDK_OFFSET(0xAFB6580)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER_TRYSWITCHTRACK_OFFSET UNITYSDK_OFFSET(0xAFB63D0)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAFB6D70)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER__INITVIEW_B__22_0_OFFSET UNITYSDK_OFFSET(0xAFB7960)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER__ONUIINIT_B__19_0_OFFSET UNITYSDK_OFFSET(0xAFB6DA0)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER__ONUIINIT_B__19_1_OFFSET UNITYSDK_OFFSET(0xAFB7540)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER__ONWIN_B__25_0_OFFSET UNITYSDK_OFFSET(0xAFB79F0)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAFB7A60)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xAFB7AD0)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAFB7AE0)
#define MOLEMOLE_UISIMPLEPARKOURGAMEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAFB7B40)

namespace MoleMole
{
	inline static constexpr unsigned int UISimpleParkourGameWidgetController_TypeDefinitionIndex = 44888;
