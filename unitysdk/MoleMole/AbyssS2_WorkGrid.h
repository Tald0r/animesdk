...
#define MOLEMOLE_ABYSSS2_WORKGRID_ADDLINE_1_OFFSET UNITYSDK_OFFSET(0xB4969B0)
#define MOLEMOLE_ABYSSS2_WORKGRID_ADDLINE_OFFSET UNITYSDK_OFFSET(0xB496710)
#define MOLEMOLE_ABYSSS2_WORKGRID_DELLINE_OFFSET UNITYSDK_OFFSET(0xB496AB0)
#define MOLEMOLE_ABYSSS2_WORKGRID_GET_CURRENTLINES_OFFSET UNITYSDK_OFFSET(0xB495E80)
#define MOLEMOLE_ABYSSS2_WORKGRID_GET_ISSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xB495EF0)
#define MOLEMOLE_ABYSSS2_WORKGRID_HASINTERSECT_1_OFFSET UNITYSDK_OFFSET(0xB496470)
#define MOLEMOLE_ABYSSS2_WORKGRID_HASINTERSECT_OFFSET UNITYSDK_OFFSET(0xB496150)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISCOLLINEARANDOVERLAP_OFFSET UNITYSDK_OFFSET(0xB497390)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISINTERSECTED_OFFSET UNITYSDK_OFFSET(0xB496F50)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISLINESAME_OFFSET UNITYSDK_OFFSET(0xB496E60)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISPOINTONSEGMENT_OFFSET UNITYSDK_OFFSET(0xB4977A0)
#define MOLEMOLE_ABYSSS2_WORKGRID_LINEINTERSECT_OFFSET UNITYSDK_OFFSET(0xB4963E0)
#define MOLEMOLE_ABYSSS2_WORKGRID_MARKSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xB495F10)
#define MOLEMOLE_ABYSSS2_WORKGRID_NEGATIVE_OFFSET UNITYSDK_OFFSET(0xB4976B0)
#define MOLEMOLE_ABYSSS2_WORKGRID_ROLLBACKSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xB495FD0)
#define MOLEMOLE_ABYSSS2_WORKGRID_SET_ISSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xB495F00)
#define MOLEMOLE_ABYSSS2_WORKGRID_SUBMITSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xB496060)
#define MOLEMOLE_ABYSSS2_WORKGRID_VECTORPRODUCT_OFFSET UNITYSDK_OFFSET(0xB497720)
#define MOLEMOLE_ABYSSS2_WORKGRID__CHECK_INTERSECT_OFFSET UNITYSDK_OFFSET(0xB496DA0)
#define MOLEMOLE_ABYSSS2_WORKGRID__CTOR_OFFSET UNITYSDK_OFFSET(0xB497850)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_WorkGrid_TypeDefinitionIndex = 68787;
