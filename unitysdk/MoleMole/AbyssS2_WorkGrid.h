...
#define MOLEMOLE_ABYSSS2_WORKGRID_ADDLINE_1_OFFSET UNITYSDK_OFFSET(0xE29F200)
#define MOLEMOLE_ABYSSS2_WORKGRID_ADDLINE_OFFSET UNITYSDK_OFFSET(0xE29EF60)
#define MOLEMOLE_ABYSSS2_WORKGRID_DELLINE_OFFSET UNITYSDK_OFFSET(0xE29F300)
#define MOLEMOLE_ABYSSS2_WORKGRID_GET_CURRENTLINES_OFFSET UNITYSDK_OFFSET(0xE29E6D0)
#define MOLEMOLE_ABYSSS2_WORKGRID_GET_ISSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xE29E740)
#define MOLEMOLE_ABYSSS2_WORKGRID_HASINTERSECT_1_OFFSET UNITYSDK_OFFSET(0xE29ECC0)
#define MOLEMOLE_ABYSSS2_WORKGRID_HASINTERSECT_OFFSET UNITYSDK_OFFSET(0xE29E9A0)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISCOLLINEARANDOVERLAP_OFFSET UNITYSDK_OFFSET(0xE29FBE0)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISINTERSECTED_OFFSET UNITYSDK_OFFSET(0xE29F7A0)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISLINESAME_OFFSET UNITYSDK_OFFSET(0xE29F6B0)
#define MOLEMOLE_ABYSSS2_WORKGRID_ISPOINTONSEGMENT_OFFSET UNITYSDK_OFFSET(0xE29FFF0)
#define MOLEMOLE_ABYSSS2_WORKGRID_LINEINTERSECT_OFFSET UNITYSDK_OFFSET(0xE29EC30)
#define MOLEMOLE_ABYSSS2_WORKGRID_MARKSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xE29E760)
#define MOLEMOLE_ABYSSS2_WORKGRID_NEGATIVE_OFFSET UNITYSDK_OFFSET(0xE29FF00)
#define MOLEMOLE_ABYSSS2_WORKGRID_ROLLBACKSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xE29E820)
#define MOLEMOLE_ABYSSS2_WORKGRID_SET_ISSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xE29E750)
#define MOLEMOLE_ABYSSS2_WORKGRID_SUBMITSNAPSHOT_OFFSET UNITYSDK_OFFSET(0xE29E8B0)
#define MOLEMOLE_ABYSSS2_WORKGRID_VECTORPRODUCT_OFFSET UNITYSDK_OFFSET(0xE29FF70)
#define MOLEMOLE_ABYSSS2_WORKGRID__CHECK_INTERSECT_OFFSET UNITYSDK_OFFSET(0xE29F5F0)
#define MOLEMOLE_ABYSSS2_WORKGRID__CTOR_OFFSET UNITYSDK_OFFSET(0xE2A00A0)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_WorkGrid_TypeDefinitionIndex = 77506;
