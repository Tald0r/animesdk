...
#define MOLEMOLE_MONOHINTARROW_AWAKE_OFFSET UNITYSDK_OFFSET(0xC237760)
#define MOLEMOLE_MONOHINTARROW_GET_MASKED_OFFSET UNITYSDK_OFFSET(0xC237750)
#define MOLEMOLE_MONOHINTARROW_GET_STATE_OFFSET UNITYSDK_OFFSET(0xC237500)
#define MOLEMOLE_MONOHINTARROW_METHOD_5_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0xC237B90)
#define MOLEMOLE_MONOHINTARROW_METHOD_5_1CD1133DC003C11C_OFFSET UNITYSDK_OFFSET(0xC237590)
#define MOLEMOLE_MONOHINTARROW_METHOD_5_9D9CF8F6C2342EE5_OFFSET UNITYSDK_OFFSET(0xC237AD0)
#define MOLEMOLE_MONOHINTARROW_METHOD_5_E374F6C9CEE8E680_OFFSET UNITYSDK_OFFSET(0xC237A30)
#define MOLEMOLE_MONOHINTARROW_SET_MASKED_OFFSET UNITYSDK_OFFSET(0xC237510)
#define MOLEMOLE_MONOHINTARROW_START_OFFSET UNITYSDK_OFFSET(0xC237960)
#define MOLEMOLE_MONOHINTARROW__CTOR_OFFSET UNITYSDK_OFFSET(0xC2379D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoHintArrow_TypeDefinitionIndex = 50085;
