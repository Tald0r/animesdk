...
#define MOLEMOLE_MONOHINTARROW_AWAKE_OFFSET UNITYSDK_OFFSET(0xB84DAD0)
#define MOLEMOLE_MONOHINTARROW_GET_MASKED_OFFSET UNITYSDK_OFFSET(0xB84DAC0)
#define MOLEMOLE_MONOHINTARROW_GET_STATE_OFFSET UNITYSDK_OFFSET(0xB84D870)
#define MOLEMOLE_MONOHINTARROW_METHOD_5_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0xB84DF00)
#define MOLEMOLE_MONOHINTARROW_METHOD_5_1CD1133DC003C11C_OFFSET UNITYSDK_OFFSET(0xB84D900)
#define MOLEMOLE_MONOHINTARROW_METHOD_5_9D9CF8F6C2342EE5_OFFSET UNITYSDK_OFFSET(0xB84DE40)
#define MOLEMOLE_MONOHINTARROW_METHOD_5_E374F6C9CEE8E680_OFFSET UNITYSDK_OFFSET(0xB84DDA0)
#define MOLEMOLE_MONOHINTARROW_SET_MASKED_OFFSET UNITYSDK_OFFSET(0xB84D880)
#define MOLEMOLE_MONOHINTARROW_START_OFFSET UNITYSDK_OFFSET(0xB84DCD0)
#define MOLEMOLE_MONOHINTARROW__CTOR_OFFSET UNITYSDK_OFFSET(0xB84DD40)

namespace MoleMole
{
	inline static constexpr unsigned int MonoHintArrow_TypeDefinitionIndex = 73497;
