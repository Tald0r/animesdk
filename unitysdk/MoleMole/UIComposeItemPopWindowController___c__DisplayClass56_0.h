...
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___C__DISPLAYCLASS56_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD551BF0)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___C__DISPLAYCLASS56_0__SENDDATA_B__0_OFFSET UNITYSDK_OFFSET(0xD551C00)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___C__DISPLAYCLASS56_0__SENDDATA_B__1_OFFSET UNITYSDK_OFFSET(0xD551E10)
#define MOLEMOLE_UICOMPOSEITEMPOPWINDOWCONTROLLER___C__DISPLAYCLASS56_0__SENDDATA_B__2_OFFSET UNITYSDK_OFFSET(0xD552020)

namespace MoleMole
{
	inline static constexpr unsigned int UIComposeItemPopWindowController___c__DisplayClass56_0_TypeDefinitionIndex = 53224;
