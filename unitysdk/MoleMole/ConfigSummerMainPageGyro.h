...
#define MOLEMOLE_CONFIGSUMMERMAINPAGEGYRO__CTOR_OFFSET UNITYSDK_OFFSET(0xB482F40)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigSummerMainPageGyro_TypeDefinitionIndex = 66842;
