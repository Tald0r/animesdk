...
#define MOLEMOLE_CONFIGSUMMERMAINPAGEGYRO__CTOR_OFFSET UNITYSDK_OFFSET(0xE82E630)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigSummerMainPageGyro_TypeDefinitionIndex = 44017;
