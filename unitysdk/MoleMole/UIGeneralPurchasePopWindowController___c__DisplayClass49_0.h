...
#define MOLEMOLE_UIGENERALPURCHASEPOPWINDOWCONTROLLER___C__DISPLAYCLASS49_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAA084B0)
#define MOLEMOLE_UIGENERALPURCHASEPOPWINDOWCONTROLLER___C__DISPLAYCLASS49_0__DOPURCHASE_B__0_OFFSET UNITYSDK_OFFSET(0xAA084C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralPurchasePopWindowController___c__DisplayClass49_0_TypeDefinitionIndex = 53798;
	...
	public:
		...
		::Class_0_16E4307DCC419505_187* goodsInfo; // 0x48
