...
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_GET_ISPOPANIMWAITPROGRESSDONE_OFFSET UNITYSDK_OFFSET(0xBEF7AF0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_GET_ISPOPEXPADDANIM_OFFSET UNITYSDK_OFFSET(0xBEF7AD0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBEF64D0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBEF6570)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBEF6370)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBEF6410)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_PREPAREUI_1_OFFSET UNITYSDK_OFFSET(0xBEF6B40)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_PREPAREUI_OFFSET UNITYSDK_OFFSET(0xBEF69B0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_SAMPLEANIM_OFFSET UNITYSDK_OFFSET(0xBEF79D0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_SET_ISPOPANIMWAITPROGRESSDONE_OFFSET UNITYSDK_OFFSET(0xBEF7B00)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_SET_ISPOPEXPADDANIM_OFFSET UNITYSDK_OFFSET(0xBEF7AE0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_SKIPEXPPROGRESS_OFFSET UNITYSDK_OFFSET(0xBEF7F10)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER_STARTEXPPROGRESS_OFFSET UNITYSDK_OFFSET(0xBEF7B10)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBEF7FB0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__GETLEVELTARGETEXP_OFFSET UNITYSDK_OFFSET(0xBEF6770)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__LOG_OFFSET UNITYSDK_OFFSET(0xBEF6950)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__PLAYADDEXPANI_OFFSET UNITYSDK_OFFSET(0xBEF7DE0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__PLAYUPGRADELVTEXTANIM_OFFSET UNITYSDK_OFFSET(0xBEF7860)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__REFRESHINITTARGETEXP_OFFSET UNITYSDK_OFFSET(0xBEF7180)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0xBEF72A0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER__UPGRADETOCURRLEVEL_OFFSET UNITYSDK_OFFSET(0xBEF76A0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBEF8070)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBEF80E0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBEF8160)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBEF81C0)
#define MOLEMOLE_UIEXPPROGRESSWIDGETWIDGETCONTROLLER___PLAYUPGRADELVTEXTANIM_B__20_0_OFFSET UNITYSDK_OFFSET(0xBEF7FF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIExpProgressWidgetWidgetController_TypeDefinitionIndex = 42441;
	...
	public:
		...
		::Class_3_AE02BC8285203464_5* _prevLvInfo; // 0x2C0
		::Class_3_AE02BC8285203464_5* _curLvInfo; // 0x2C8
