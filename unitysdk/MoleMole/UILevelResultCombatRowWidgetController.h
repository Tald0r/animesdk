...
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8A68A70)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8A68BF0)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8A68B10)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8A689D0)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8A69140)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8A69150)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8A691C0)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8A69240)
#define MOLEMOLE_UILEVELRESULTCOMBATROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8A692C0)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultCombatRowWidgetController_TypeDefinitionIndex = 68826;

	class UILevelResultCombatRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_64B8AF843BB0F160* _view; // 0x2D0
