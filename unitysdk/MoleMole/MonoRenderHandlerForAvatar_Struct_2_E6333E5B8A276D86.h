...
#define MOLEMOLE_MONORENDERHANDLERFORAVATAR_STRUCT_2_E6333E5B8A276D86_METHOD_2_1435D5A3459C003C_OFFSET UNITYSDK_OFFSET(0x6B0DD60)
#define MOLEMOLE_MONORENDERHANDLERFORAVATAR_STRUCT_2_E6333E5B8A276D86_METHOD_2_428A34C139FA4351_OFFSET UNITYSDK_OFFSET(0x308900)

namespace MoleMole
{
	inline static constexpr unsigned int MonoRenderHandlerForAvatar_Struct_2_E6333E5B8A276D86_TypeDefinitionIndex = 54385;
	...
	struct alignas(4) MonoRenderHandlerForAvatar_Struct_2_E6333E5B8A276D86
	{
		...
		::System::Void Method_2_428A34C139FA4351(::UnityEngine::Material* a1, ::System::UInt32& a2)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Material*, ::System::UInt32&))((::PBYTE)hIl2Cpp + MOLEMOLE_MONORENDERHANDLERFORAVATAR_STRUCT_2_E6333E5B8A276D86_METHOD_2_428A34C139FA4351_OFFSET))(this, a1, a2);
		}
	};
}
