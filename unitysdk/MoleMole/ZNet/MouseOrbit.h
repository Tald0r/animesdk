...
#define MOLEMOLE_ZNET_MOUSEORBIT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x73F8140)
#define MOLEMOLE_ZNET_MOUSEORBIT_METHOD_5_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x73F87B0)
#define MOLEMOLE_ZNET_MOUSEORBIT_METHOD_5_B2E1F4B7BD95D0F7_OFFSET UNITYSDK_OFFSET(0x73F86C0)
#define MOLEMOLE_ZNET_MOUSEORBIT_START_OFFSET UNITYSDK_OFFSET(0x73F7EA0)
#define MOLEMOLE_ZNET_MOUSEORBIT__CTOR_OFFSET UNITYSDK_OFFSET(0x73F8B60)

namespace MoleMole::ZNet
{
	inline static constexpr unsigned int MouseOrbit_TypeDefinitionIndex = 76394;
