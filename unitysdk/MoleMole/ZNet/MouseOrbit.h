...
#define MOLEMOLE_ZNET_MOUSEORBIT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7BEEA50)
#define MOLEMOLE_ZNET_MOUSEORBIT_METHOD_5_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x7BEF0C0)
#define MOLEMOLE_ZNET_MOUSEORBIT_METHOD_5_B2E1F4B7BD95D0F7_OFFSET UNITYSDK_OFFSET(0x7BEEFD0)
#define MOLEMOLE_ZNET_MOUSEORBIT_START_OFFSET UNITYSDK_OFFSET(0x7BEE7B0)
#define MOLEMOLE_ZNET_MOUSEORBIT__CTOR_OFFSET UNITYSDK_OFFSET(0x7BEF470)

namespace MoleMole::ZNet
{
	inline static constexpr unsigned int MouseOrbit_TypeDefinitionIndex = 66649;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_ZNET_MOUSEORBIT_METHOD_5_4307B2A4B4A12C1A_OFFSET))(this);
		}
	};
}
