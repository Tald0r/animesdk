...
#include "unitysdk/MoleMole/ZNet/ZNetSceneRootCom_Enum_3_77609652203F7CD8.h"
#include "unitysdk/UnityEngine/MonoBehaviour.h"

namespace MoleMole::EffectSimulate { class FxEditorConfigData; }

#define MOLEMOLE_ZNET_ZNETSCENEROOTCOM_FORCERESIMULATEAFTERONESECOND_OFFSET UNITYSDK_OFFSET(0x71F6F00)
#define MOLEMOLE_ZNET_ZNETSCENEROOTCOM_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x71F6EA0)
#define MOLEMOLE_ZNET_ZNETSCENEROOTCOM_METHOD_5_DE3FCF8E254811E9_OFFSET UNITYSDK_OFFSET(0x71F6F80)
#define MOLEMOLE_ZNET_ZNETSCENEROOTCOM_UPDATE_OFFSET UNITYSDK_OFFSET(0x71F6D80)
#define MOLEMOLE_ZNET_ZNETSCENEROOTCOM__CTOR_OFFSET UNITYSDK_OFFSET(0x71F6F60)

namespace MoleMole::ZNet
{
	inline static constexpr unsigned int ZNetSceneRootCom_TypeDefinitionIndex = 73695;

	class ZNetSceneRootCom : public ::UnityEngine::MonoBehaviour
	{
	public:
		::MoleMole::ZNet::ZNetSceneRootCom_Enum_3_77609652203F7CD8 rootType; // 0x18
