...
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_GET_LEADERCOLOR_OFFSET UNITYSDK_OFFSET(0xBF47430)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_METHOD_1_092CD57850778EFC_OFFSET UNITYSDK_OFFSET(0xBF481B0)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xBF47A30)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_METHOD_1_7A0A609FED879DF6_OFFSET UNITYSDK_OFFSET(0xBF47E70)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_METHOD_1_B0F2C48B9F11EEB1_OFFSET UNITYSDK_OFFSET(0xBF47F20)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_METHOD_1_D4E0886303081325_OFFSET UNITYSDK_OFFSET(0xBF47AB0)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_METHOD_1_EE60F812A0098D6C_OFFSET UNITYSDK_OFFSET(0xBF475F0)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP_SET_LEADERCOLOR_OFFSET UNITYSDK_OFFSET(0xBF47460)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP__CCTOR_OFFSET UNITYSDK_OFFSET(0xBF47580)
#define MOLEMOLE_UICOLORTWEAKERTARGETGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xBF47570)

namespace MoleMole
{
	inline static constexpr unsigned int UIColorTweakerTargetGroup_TypeDefinitionIndex = 57274;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MoleMole::UIColorTweakerTargetGroup_Struct_2_B6CC7A1324E97FE4>**)Il2CppClass::FromTypeDefinitionIndex(UIColorTweakerTargetGroup_TypeDefinitionIndex)->GetStaticField(0x3D5A0);
		}
