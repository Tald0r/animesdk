...
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW_CLOSEACTION_OFFSET UNITYSDK_OFFSET(0x6AF8D00)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW_ONNEWBIEGONEXTHANDLE_OFFSET UNITYSDK_OFFSET(0x6AF9200)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x6AF8AE0)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x6AF8A70)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x6AF89B0)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW___BASE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x6AF96F0)

namespace MoleMole
{
	inline static constexpr unsigned int UnlockViewPointRewardPopShow_TypeDefinitionIndex = 76480;
