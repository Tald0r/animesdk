...
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW_CLOSEACTION_OFFSET UNITYSDK_OFFSET(0x883A4A0)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW_ONNEWBIEGONEXTHANDLE_OFFSET UNITYSDK_OFFSET(0x883A9A0)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x883A280)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x883A210)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x883A150)
#define MOLEMOLE_UNLOCKVIEWPOINTREWARDPOPSHOW___BASE_SETMESSAGECONFIG_OFFSET UNITYSDK_OFFSET(0x883AE90)

namespace MoleMole
{
	inline static constexpr unsigned int UnlockViewPointRewardPopShow_TypeDefinitionIndex = 60707;
