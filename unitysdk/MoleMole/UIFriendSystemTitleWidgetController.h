...
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_GET_HASTITLE_OFFSET UNITYSDK_OFFSET(0xA9765E0)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA9762E0)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA976350)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA976410)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_REFRESHPLAYERTITLE_OFFSET UNITYSDK_OFFSET(0xA9767E0)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_REFRESHSELFTITLE_OFFSET UNITYSDK_OFFSET(0xA976720)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9768F0)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA976920)
#define MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA976990)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendSystemTitleWidgetController_TypeDefinitionIndex = 80245;
	...
	public:
		...
		::System::Void RefreshPlayerTitle(::System::UInt32 playerAvatarId, ::Struct_2_24AC061D0BCF0A10 title)
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32, ::Struct_2_24AC061D0BCF0A10))((::PBYTE)hIl2Cpp + MOLEMOLE_UIFRIENDSYSTEMTITLEWIDGETCONTROLLER_REFRESHPLAYERTITLE_OFFSET))(this, playerAvatarId, title);
		}
