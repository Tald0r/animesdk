...
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_CANCELTWEEN_OFFSET UNITYSDK_OFFSET(0xACD8130)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_GET_NEEDPLAYINSERT_OFFSET UNITYSDK_OFFSET(0xACD7CF0)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_GET_NEEDPLAYREMOVE_OFFSET UNITYSDK_OFFSET(0xACD7D70)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_ONSETROOTCONTROLLER_OFFSET UNITYSDK_OFFSET(0xACD7DF0)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xACD8240)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_PLAYINSERT_OFFSET UNITYSDK_OFFSET(0xACD8030)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_PLAYREMOVE_OFFSET UNITYSDK_OFFSET(0xACD80B0)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER_SETTWEENDURATION_OFFSET UNITYSDK_OFFSET(0xACD81B0)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xACD8310)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER___BASE_ONSETROOTCONTROLLER_OFFSET UNITYSDK_OFFSET(0xACD83C0)
#define MOLEMOLE_UITWEENSLOTWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xACD8340)

namespace MoleMole
{
	inline static constexpr unsigned int UITweenSlotWidgetController_TypeDefinitionIndex = 75240;
