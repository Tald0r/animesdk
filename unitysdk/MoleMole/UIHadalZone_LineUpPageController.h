...
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x7F5E090)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F5E0A0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER_ONSELECTAVATAR_OFFSET UNITYSDK_OFFSET(0x7F5F170)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F5F4D0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F5E140)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F5E1B0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__CLOSEPREV_RANKINGWIDGETS_OFFSET UNITYSDK_OFFSET(0x7F5FA30)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__CREATERANKINGWIDGET_OFFSET UNITYSDK_OFFSET(0x7F5FC40)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F5FD60)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__GO_OFFSET UNITYSDK_OFFSET(0x7F5F350)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__ONLAYERCLIPCLICK_OFFSET UNITYSDK_OFFSET(0x7F5F560)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__ONSELECTAVATAR_B__9_0_OFFSET UNITYSDK_OFFSET(0x7F5FFF0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__ONUIOPEN_B__8_1_OFFSET UNITYSDK_OFFSET(0x7F5FEA0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__REFRESHBTNS_OFFSET UNITYSDK_OFFSET(0x7F5E690)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__REFRESHLAYER_OFFSET UNITYSDK_OFFSET(0x7F5E9D0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__REFRESHOTHERLAYERS_OFFSET UNITYSDK_OFFSET(0x7F5E8F0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__SCROLLTOINDEX_OFFSET UNITYSDK_OFFSET(0x7F5F230)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F60110)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F60180)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F60190)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F601A0)
#define MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER___REFRESHBTNS_B__11_0_OFFSET UNITYSDK_OFFSET(0x7F60100)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_LineUpPageController_TypeDefinitionIndex = 52758;

	class UIHadalZone_LineUpPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_66* _view; // 0x2F8
		...
		::System::Collections::Generic::List_1<::Class_1_5DA2E7556103D5A3_245*>* _zoneLayers; // 0x330
		::Class_1_5DA2E7556103D5A3_319* _lastLayerInfo; // 0x338
		...
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::Level::RatingType, ::Class_1_5DA2E7556103D5A3_245*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_LINEUPPAGECONTROLLER__CREATERANKINGWIDGET_OFFSET))(this, type, zoneInfo);
		}
