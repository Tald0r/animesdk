...
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA363250)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA3632F0)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA363100)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA3631A0)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xA3633D0)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA363460)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA363490)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA363500)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA363580)
#define MOLEMOLE_UIGENERALCONSOLEBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA3635E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralConsoleBtnWidgetController_TypeDefinitionIndex = 51617;

	class UIGeneralConsoleBtnWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D90DF3D7E5474EF5* _view; // 0x2A0
