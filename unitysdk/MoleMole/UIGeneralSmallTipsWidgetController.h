...
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x9BEC6E0)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9BEC2F0)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9BEC390)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9BEC250)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9BEC5B0)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9BEC940)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER__INITVIEW_B__5_0_OFFSET UNITYSDK_OFFSET(0x9BEC970)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER__INITVIEW_B__5_1_OFFSET UNITYSDK_OFFSET(0x9BECA10)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9BECA20)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9BECA90)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9BECB10)
#define MOLEMOLE_UIGENERALSMALLTIPSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9BECB70)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSmallTipsWidgetController_TypeDefinitionIndex = 62449;

	class UIGeneralSmallTipsWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_C72EFEEE926A8E9E_1* _view; // 0x2A0
