...
#define MOLEMOLE_MONSTERSPECIALIDLESERIALIZEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBD45B20)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterSpecialIdleSerializedData_TypeDefinitionIndex = 58011;
