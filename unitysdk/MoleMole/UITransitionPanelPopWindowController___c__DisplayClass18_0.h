...
#define MOLEMOLE_UITRANSITIONPANELPOPWINDOWCONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x990F310)
#define MOLEMOLE_UITRANSITIONPANELPOPWINDOWCONTROLLER___C__DISPLAYCLASS18_0__DOFADETRANSITIONWITHSTARTCOLOR_B__0_OFFSET UNITYSDK_OFFSET(0x990F320)

namespace MoleMole
{
	inline static constexpr unsigned int UITransitionPanelPopWindowController___c__DisplayClass18_0_TypeDefinitionIndex = 39286;
