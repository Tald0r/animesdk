...
#define MOLEMOLE_HACKERGAMEBASEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D1840)

namespace MoleMole
{
	inline static constexpr unsigned int HackerGameBaseDamage_TypeDefinitionIndex = 77307;
