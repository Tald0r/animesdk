...
#define MOLEMOLE_HACKERGAMEBASEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xBA16DF0)

namespace MoleMole
{
	inline static constexpr unsigned int HackerGameBaseDamage_TypeDefinitionIndex = 63673;
