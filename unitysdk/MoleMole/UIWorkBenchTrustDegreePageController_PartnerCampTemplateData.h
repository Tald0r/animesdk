...
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTEMPLATEDATA_GET_BADGESUBID_OFFSET UNITYSDK_OFFSET(0xEA0B320)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTEMPLATEDATA_GET_BADGETYPE_OFFSET UNITYSDK_OFFSET(0xEA0B310)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTEMPLATEDATA_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xEA0B2E0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_PARTNERCAMPTEMPLATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xEA0B410)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchTrustDegreePageController_PartnerCampTemplateData_TypeDefinitionIndex = 80394;
