...
#define MOLEMOLE_DEPOSITORYTABCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE38CA50)

namespace MoleMole
{
	inline static constexpr unsigned int DepositoryTabConfig_TypeDefinitionIndex = 39954;
