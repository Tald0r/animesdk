...
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYPAGECONTROLLER_BINDVIEWCALLBACKS_OFFSET UNITYSDK_OFFSET(0xA6B2900)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYPAGECONTROLLER_BUILDVIEWMODELDATABINDING_OFFSET UNITYSDK_OFFSET(0xA6B2960)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYPAGECONTROLLER_GET_CANCELLATIONTOKENSOURCE_OFFSET UNITYSDK_OFFSET(0xA6B2BD0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA6B2620)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYPAGECONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA6B2B20)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA6B2630)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA6B29F0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA6B26D0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA6B2C30)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYPAGECONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0xA6B2CE0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA6B2D40)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA6B2DB0)
#define MOLEMOLE_UISUIBIANTEMPLEBUDDYPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA6B2DC0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleBuddyPageController_TypeDefinitionIndex = 79681;

	class UISuibianTempleBuddyPageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_95* _view; // 0x2F8
