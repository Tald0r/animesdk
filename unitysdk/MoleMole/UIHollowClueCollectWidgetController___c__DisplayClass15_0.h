...
#define MOLEMOLE_UIHOLLOWCLUECOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBFD0860)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS15_0__ONCLICKGOTOAGENCY_B__0_OFFSET UNITYSDK_OFFSET(0xBFD0870)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowClueCollectWidgetController___c__DisplayClass15_0_TypeDefinitionIndex = 76722;
