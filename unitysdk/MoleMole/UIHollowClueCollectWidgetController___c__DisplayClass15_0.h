...
#define MOLEMOLE_UIHOLLOWCLUECOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9C0C370)
#define MOLEMOLE_UIHOLLOWCLUECOLLECTWIDGETCONTROLLER___C__DISPLAYCLASS15_0__ONCLICKGOTOAGENCY_B__0_OFFSET UNITYSDK_OFFSET(0x9C0C380)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowClueCollectWidgetController___c__DisplayClass15_0_TypeDefinitionIndex = 72196;
