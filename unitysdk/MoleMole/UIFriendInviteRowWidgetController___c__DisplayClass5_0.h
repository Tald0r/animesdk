...
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBF79630)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___C__DISPLAYCLASS5_0__ONSCROLLITEMUPDATE_B__0_OFFSET UNITYSDK_OFFSET(0xBF79640)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___C__DISPLAYCLASS5_0__ONSCROLLITEMUPDATE_B__1_OFFSET UNITYSDK_OFFSET(0xBF79AA0)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___C__DISPLAYCLASS5_0__ONSCROLLITEMUPDATE_B__2_OFFSET UNITYSDK_OFFSET(0xBF798A0)
#define MOLEMOLE_UIFRIENDINVITEROWWIDGETCONTROLLER___C__DISPLAYCLASS5_0__ONSCROLLITEMUPDATE_B__3_OFFSET UNITYSDK_OFFSET(0xBF79A30)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendInviteRowWidgetController___c__DisplayClass5_0_TypeDefinitionIndex = 65408;

	class UIFriendInviteRowWidgetController___c__DisplayClass5_0 : public ::System::Object
	{
	public:
		::MoleMole::UIFriendInviteRowWidgetController* __4__this; // 0x10
		::MoleMole::UIFriendInviteRowWidgetController_Context* _data; // 0x18
