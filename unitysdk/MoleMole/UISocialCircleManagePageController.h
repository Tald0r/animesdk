...
#define MOLEMOLE_UISOCIALCIRCLEMANAGEPAGECONTROLLER_GETBOTTOMTIPSROOT_OFFSET UNITYSDK_OFFSET(0xC84E720)
#define MOLEMOLE_UISOCIALCIRCLEMANAGEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC84E710)
#define MOLEMOLE_UISOCIALCIRCLEMANAGEPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC84E7E0)
#define MOLEMOLE_UISOCIALCIRCLEMANAGEPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC84E850)
#define MOLEMOLE_UISOCIALCIRCLEMANAGEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC84E950)
#define MOLEMOLE_UISOCIALCIRCLEMANAGEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC84EC40)
#define MOLEMOLE_UISOCIALCIRCLEMANAGEPAGECONTROLLER___BASE_GETBOTTOMTIPSROOT_OFFSET UNITYSDK_OFFSET(0xC84EC50)
#define MOLEMOLE_UISOCIALCIRCLEMANAGEPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC84ECB0)
#define MOLEMOLE_UISOCIALCIRCLEMANAGEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC84ED20)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleManagePageController_TypeDefinitionIndex = 78643;
