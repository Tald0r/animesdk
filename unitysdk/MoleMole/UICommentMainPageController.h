...
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAC44AE0)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_INITACTIVITYREWARD_OFFSET UNITYSDK_OFFSET(0xAC45130)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_INITBIND_OFFSET UNITYSDK_OFFSET(0xAC44EE0)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_MODIFYFILLPERCENTCONTENT_OFFSET UNITYSDK_OFFSET(0xAC45F40)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC44BE0)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xAC457A0)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xAC459A0)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_ONINFOBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xAC45BA0)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_ONLEVELPROGRESSBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xAC45C20)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC45700)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC44C80)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_OPENINFOPANEL_OFFSET UNITYSDK_OFFSET(0xAC445D0)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_REFRESHLEVELPROGRESSINFO_OFFSET UNITYSDK_OFFSET(0xAC45D30)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAC45540)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xAC44AF0)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC460E0)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER__INITACTIVITYREWARD_B__15_1_OFFSET UNITYSDK_OFFSET(0xAC461A0)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER__INITBIND_B__14_0_OFFSET UNITYSDK_OFFSET(0xAC460F0)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC462D0)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xAC46340)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0xAC463B0)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC46420)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC46430)
#define MOLEMOLE_UICOMMENTMAINPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xAC46440)

namespace MoleMole
{
	inline static constexpr unsigned int UICommentMainPageController_TypeDefinitionIndex = 67399;

	class UICommentMainPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_D77EAB658E5C94F9* _view; // 0x308
		::Class_1_D375C91CCE5D3999* _activityBaseData; // 0x310
		::System::Boolean _isInInfoPanel; // 0x318
		::MoleMole::UICommentLevelWidgetController* _levelWidgetController; // 0x320
		::MoleMole::UICommentInfoWidgetController* _infoWidgetController; // 0x328
		::UnityEngine::Material* _LevelProgressFillMat; // 0x330
