...
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xDC712D0)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0xDC717F0)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER_GET_PLAYTYPE_OFFSET UNITYSDK_OFFSET(0xDC71610)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDC71030)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDC71800)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDC71410)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDC718A0)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDC71040)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDC71620)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC71930)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDC71940)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDC719B0)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDC719E0)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDC719F0)
#define MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDC71A00)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdleListPopWindowController_TypeDefinitionIndex = 40373;

	class UICampIdleListPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_55648B18360E84CE* _view; // 0x2F8
		::Enum_3_0A3761FE34514D6C_50 m_playType; // 0x300
		...
		::Enum_3_0A3761FE34514D6C_50 get_PlayType()
		{
			return ((::Enum_3_0A3761FE34514D6C_50(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UICAMPIDLELISTPOPWINDOWCONTROLLER_GET_PLAYTYPE_OFFSET))(this);
		}
