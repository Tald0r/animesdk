...
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ADDCOMPENTERBTN_OFFSET UNITYSDK_OFFSET(0xD240780)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_CLEARCOMPONTNBTNS_OFFSET UNITYSDK_OFFSET(0xD240070)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD23FB60)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_INITANDPLAYVIDEO_OFFSET UNITYSDK_OFFSET(0xD240C30)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONABILITYSELECTCHANGE_OFFSET UNITYSDK_OFFSET(0xD242830)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONACTIVITYCLOSE_OFFSET UNITYSDK_OFFSET(0xD241CF0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONACTIVITYEND_OFFSET UNITYSDK_OFFSET(0xD241E70)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONCLICKBACK_OFFSET UNITYSDK_OFFSET(0xD242890)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONCLICKINFO_OFFSET UNITYSDK_OFFSET(0xD242A70)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONCLICKMAINCITY_OFFSET UNITYSDK_OFFSET(0xD242910)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONCLICKOK_OFFSET UNITYSDK_OFFSET(0xD242CC0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD23FB70)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xD241A60)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD241BA0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONSELECTQUEST_OFFSET UNITYSDK_OFFSET(0xD242650)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD241950)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD2413C0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD23FFB0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD23FC10)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD240190)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_REFRESHGAMEPADBTN_OFFSET UNITYSDK_OFFSET(0xD242460)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_REFRESHOKBTN_OFFSET UNITYSDK_OFFSET(0xD2422D0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_REFRESHREMAINTIMER_OFFSET UNITYSDK_OFFSET(0xD2409D0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_SETTEAMTRIALSTATE_OFFSET UNITYSDK_OFFSET(0xD240ED0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER_TRYCREATETEAMTRIALWIDGET_OFFSET UNITYSDK_OFFSET(0xD241F10)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD242F10)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER__INITANDPLAYVIDEO_B__26_0_OFFSET UNITYSDK_OFFSET(0xD242F20)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER__INITANDPLAYVIDEO_B__26_1_OFFSET UNITYSDK_OFFSET(0xD242F80)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER__SETTEAMTRIALSTATE_B__27_0_OFFSET UNITYSDK_OFFSET(0xD242FC0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD243080)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xD2430F0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD243150)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD243180)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD243190)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD2431A0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD2431B0)
#define MOLEMOLE_UIACTIVITYTEAMTRIALPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD2431C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityTeamTrialPageController_TypeDefinitionIndex = 79104;
