...
#define MOLEMOLE_MONOUICURVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8A83150)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUICurveConfig_TypeDefinitionIndex = 53482;
