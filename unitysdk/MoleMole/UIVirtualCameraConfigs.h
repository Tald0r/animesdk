...
#define MOLEMOLE_UIVIRTUALCAMERACONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0xAE9C210)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirtualCameraConfigs_TypeDefinitionIndex = 61420;
