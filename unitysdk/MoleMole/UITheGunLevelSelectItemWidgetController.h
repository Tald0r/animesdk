...
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_NEEDPLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x9711CA0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9710250)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONFADEINFINISH_OFFSET UNITYSDK_OFFSET(0x97112D0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x97114A0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONLOCKCONTDOWNEND_OFFSET UNITYSDK_OFFSET(0x9712120)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x97103D0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x97102F0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x970FE50)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x97101A0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_PLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x9711E20)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_PREPAREUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x97107B0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0x9710910)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_REFRESHNEW_OFFSET UNITYSDK_OFFSET(0x9711A10)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_REFRESHTRACK_OFFSET UNITYSDK_OFFSET(0x97117F0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER_TRYPLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x9711410)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x97121D0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER__ONLOCKCONTDOWNEND_B__21_0_OFFSET UNITYSDK_OFFSET(0x97121F0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER__ONUIINIT_B__7_0_OFFSET UNITYSDK_OFFSET(0x97121E0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9712290)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONFADEINFINISH_OFFSET UNITYSDK_OFFSET(0x9712300)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x9712360)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x97123D0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9712450)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x97124D0)
#define MOLEMOLE_UITHEGUNLEVELSELECTITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9712530)

namespace MoleMole
{
	inline static constexpr unsigned int UITheGunLevelSelectItemWidgetController_TypeDefinitionIndex = 52977;

	class UITheGunLevelSelectItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_121* _view; // 0x2D0
