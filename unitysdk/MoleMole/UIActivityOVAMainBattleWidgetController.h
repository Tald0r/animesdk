...
#define MOLEMOLE_UIACTIVITYOVAMAINBATTLEWIDGETCONTROLLER_CREATITEM_OFFSET UNITYSDK_OFFSET(0xE90C6F0)
#define MOLEMOLE_UIACTIVITYOVAMAINBATTLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE90C570)
#define MOLEMOLE_UIACTIVITYOVAMAINBATTLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE90C610)
#define MOLEMOLE_UIACTIVITYOVAMAINBATTLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE90BF90)
#define MOLEMOLE_UIACTIVITYOVAMAINBATTLEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE90C100)
#define MOLEMOLE_UIACTIVITYOVAMAINBATTLEWIDGETCONTROLLER_ONUPDATEUI_OFFSET UNITYSDK_OFFSET(0xE90C7D0)
#define MOLEMOLE_UIACTIVITYOVAMAINBATTLEWIDGETCONTROLLER_SHOWBATTLEROW_OFFSET UNITYSDK_OFFSET(0xE90C230)
#define MOLEMOLE_UIACTIVITYOVAMAINBATTLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE90C850)
#define MOLEMOLE_UIACTIVITYOVAMAINBATTLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xE90C880)
#define MOLEMOLE_UIACTIVITYOVAMAINBATTLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xE90C8F0)
#define MOLEMOLE_UIACTIVITYOVAMAINBATTLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xE90C970)
#define MOLEMOLE_UIACTIVITYOVAMAINBATTLEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xE90C9D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityOVAMainBattleWidgetController_TypeDefinitionIndex = 53038;

	class UIActivityOVAMainBattleWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_68D38DAD1613A778_2* _view; // 0x2A0
