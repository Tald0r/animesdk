...
#define MOLEMOLE_UIMONSTERFANTASYQTEEFFWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x866C5E0)
#define MOLEMOLE_UIMONSTERFANTASYQTEEFFWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x866C680)
#define MOLEMOLE_UIMONSTERFANTASYQTEEFFWIDGETCONTROLLER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x866C760)
#define MOLEMOLE_UIMONSTERFANTASYQTEEFFWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x866C870)
#define MOLEMOLE_UIMONSTERFANTASYQTEEFFWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x866C8A0)
#define MOLEMOLE_UIMONSTERFANTASYQTEEFFWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x866C910)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyQteEffWidgetController_TypeDefinitionIndex = 43472;
