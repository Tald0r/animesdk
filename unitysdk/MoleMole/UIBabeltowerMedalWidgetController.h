...
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC273C90)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC273D30)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC273B40)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC273BE0)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC273E10)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC273E40)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC273EB0)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC273F30)
#define MOLEMOLE_UIBABELTOWERMEDALWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC273F90)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerMedalWidgetController_TypeDefinitionIndex = 49722;

	class UIBabeltowerMedalWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_89* _view; // 0x2A0
