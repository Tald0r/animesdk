...
#define MOLEMOLE_UIURBANMAPPOINTBANGBOOPLATFORMERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE98750)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapPointBangbooPlatformerWidgetController_TypeDefinitionIndex = 74621;
