...
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0xBAFE1E0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xBAFE130)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBAFE140)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONINITMINIWORLD_OFFSET UNITYSDK_OFFSET(0xBAFE590)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBAFE3A0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBAFE310)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBAFE1F0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBAFE260)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBAFE600)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBAFE610)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBAFE680)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBAFE6B0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBAFE6C0)
#define MOLEMOLE_UIBALLRACEGAMEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBAFE6D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBallRaceGamePageController_TypeDefinitionIndex = 52428;
