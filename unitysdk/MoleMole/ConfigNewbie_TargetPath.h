...
#define MOLEMOLE_CONFIGNEWBIE_TARGETPATH_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xCD32CE0)
#define MOLEMOLE_CONFIGNEWBIE_TARGETPATH_GET_PATH_OFFSET UNITYSDK_OFFSET(0xCD32D60)
#define MOLEMOLE_CONFIGNEWBIE_TARGETPATH_LOADFROMBYTES_OFFSET UNITYSDK_OFFSET(0xCD32D70)
#define MOLEMOLE_CONFIGNEWBIE_TARGETPATH_PARSEEXTRADATA_OFFSET UNITYSDK_OFFSET(0xCD32F20)
#define MOLEMOLE_CONFIGNEWBIE_TARGETPATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0xCD32CD0)
#define MOLEMOLE_CONFIGNEWBIE_TARGETPATH__CTOR_OFFSET UNITYSDK_OFFSET(0xCD32CC0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigNewbie_TargetPath_TypeDefinitionIndex = 54134;
