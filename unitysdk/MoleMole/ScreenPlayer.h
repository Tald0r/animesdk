...
#define MOLEMOLE_SCREENPLAYER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD821860)
#define MOLEMOLE_SCREENPLAYER_GET_CURRENTPLAYDATA_OFFSET UNITYSDK_OFFSET(0xD81F870)
#define MOLEMOLE_SCREENPLAYER_GET_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0xD81F910)
#define MOLEMOLE_SCREENPLAYER_GET_GETRENDERTARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0xD821A40)
#define MOLEMOLE_SCREENPLAYER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xD81F890)
#define MOLEMOLE_SCREENPLAYER_GET_SCREENGO_OFFSET UNITYSDK_OFFSET(0xD81F930)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_031CF150391E9B14_OFFSET UNITYSDK_OFFSET(0xD8221E0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_0810265D1B861881_OFFSET UNITYSDK_OFFSET(0xD822BD0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_0CC4BC19C602BCD0_1_OFFSET UNITYSDK_OFFSET(0xD8214D0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0xD821450)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_106E1EED1398BAC3_OFFSET UNITYSDK_OFFSET(0xD81FC70)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_136A2D4A777E5F48_OFFSET UNITYSDK_OFFSET(0xD827100)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_14E279FBAB0C92E2_OFFSET UNITYSDK_OFFSET(0xD822F60)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xD821110)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_154998A4087BBA4C_OFFSET UNITYSDK_OFFSET(0xD826BA0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_15849F8CE554F058_OFFSET UNITYSDK_OFFSET(0xD820780)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xD821270)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_1CF84FBD817B0F20_OFFSET UNITYSDK_OFFSET(0xD8266B0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xD822ED0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_28A5AB1678E791E7_OFFSET UNITYSDK_OFFSET(0xD8224E0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_34E27C48868DCFB3_OFFSET UNITYSDK_OFFSET(0xD820430)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_35AA1256336E8112_OFFSET UNITYSDK_OFFSET(0xD826910)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_3EAE0F6D775220FA_1_OFFSET UNITYSDK_OFFSET(0xD826A20)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_3EAE0F6D775220FA_OFFSET UNITYSDK_OFFSET(0xD826420)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_3F0D4D20CAA05725_OFFSET UNITYSDK_OFFSET(0xD826850)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_4A71A6F8EF7C6F24_OFFSET UNITYSDK_OFFSET(0xD826AD0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_4BCD51618C77AD95_OFFSET UNITYSDK_OFFSET(0xD8206E0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_50FFE8C44036C61A_OFFSET UNITYSDK_OFFSET(0xD8265E0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_5CE94B0371C7CF88_OFFSET UNITYSDK_OFFSET(0xD826920)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_6597F9D2D4A0542F_OFFSET UNITYSDK_OFFSET(0xD826640)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_67D41ACFEF39E84E_OFFSET UNITYSDK_OFFSET(0xD821C30)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_705FFC79B57F4953_OFFSET UNITYSDK_OFFSET(0xD820DC0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_70BDBAE57C1C9100_OFFSET UNITYSDK_OFFSET(0xD8270A0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_7207BD0B2F768243_OFFSET UNITYSDK_OFFSET(0xD8271F0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_7C925D77C4DBAFE3_OFFSET UNITYSDK_OFFSET(0xD826040)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_84713B30DA3BE782_OFFSET UNITYSDK_OFFSET(0xD826230)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_86143FF46EAE82B7_OFFSET UNITYSDK_OFFSET(0xD8260F0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xD822E10)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD8217B0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_9D9CF8F6C2342EE5_OFFSET UNITYSDK_OFFSET(0xD823010)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xD826950)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_A682E540F239EE22_OFFSET UNITYSDK_OFFSET(0xD822440)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_A97A6D4EE559F25B_OFFSET UNITYSDK_OFFSET(0xD8223B0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_AA7E3074254D484A_OFFSET UNITYSDK_OFFSET(0xD821F90)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_ACABA92D6D2C50BC_OFFSET UNITYSDK_OFFSET(0xD8261B0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_AD8D049D8DF5CCB2_OFFSET UNITYSDK_OFFSET(0xD822650)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xD8264D0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_B70E664C5CD0DECB_OFFSET UNITYSDK_OFFSET(0xD822590)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_B82A6C005D3ADCE3_OFFSET UNITYSDK_OFFSET(0xD81FAE0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_BAD42A15E1550F87_OFFSET UNITYSDK_OFFSET(0xD822250)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xD820D40)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xD825FE0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0xD826580)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_CA373AA1C7054598_4_OFFSET UNITYSDK_OFFSET(0xD826710)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD8219E0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_CB6F9BCB94300035_OFFSET UNITYSDK_OFFSET(0xD8230D0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_CD7415D0B2EB38A2_OFFSET UNITYSDK_OFFSET(0xD826770)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_DA8915F72DE34BAE_OFFSET UNITYSDK_OFFSET(0xD81FE10)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_E5695720AB0F6E98_OFFSET UNITYSDK_OFFSET(0xD8201B0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xD821550)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_F46B5BF207C29F9A_OFFSET UNITYSDK_OFFSET(0xD821AC0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_FED43F89BEEE494D_OFFSET UNITYSDK_OFFSET(0xD8262B0)
#define MOLEMOLE_SCREENPLAYER_METHOD_1_FF8E81CF7F8437BB_OFFSET UNITYSDK_OFFSET(0xD8260C0)
#define MOLEMOLE_SCREENPLAYER_SET_CURRENTPLAYDATA_OFFSET UNITYSDK_OFFSET(0xD81F880)
#define MOLEMOLE_SCREENPLAYER_SET_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0xD81F920)
#define MOLEMOLE_SCREENPLAYER_SET_SCREENGO_OFFSET UNITYSDK_OFFSET(0xD81F940)
#define MOLEMOLE_SCREENPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD81F950)
#define MOLEMOLE_SCREENPLAYER__CCTOR_OFFSET UNITYSDK_OFFSET(0xD822160)
#define MOLEMOLE_SCREENPLAYER__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD820370)
#define MOLEMOLE_SCREENPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xD81FB50)

namespace MoleMole
{
	inline static constexpr unsigned int ScreenPlayer_TypeDefinitionIndex = 40970;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ScreenPlayer_TypeDefinitionIndex)->GetStaticField(0x42550);
		}
		static ::System::String** StaticGet_Value()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ScreenPlayer_TypeDefinitionIndex)->GetStaticField(0x42558);
		}
		static ::System::String** StaticGet_BlendKey()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ScreenPlayer_TypeDefinitionIndex)->GetStaticField(0x42560);
		}
		static ::System::String** StaticGet_Hue()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ScreenPlayer_TypeDefinitionIndex)->GetStaticField(0x42568);
		}
		static ::System::Int32* StaticGet__ScreenMaskTex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScreenPlayer_TypeDefinitionIndex)->GetStaticField(0x10790);
		}
		...
		::Class_3_025A1030984A033D* _blendTextureSheetVeUpdater; // 0x70
