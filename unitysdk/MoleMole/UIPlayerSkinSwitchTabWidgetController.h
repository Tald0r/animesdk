...
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9EAF010)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9EAF190)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9EAF0B0)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9EAEB40)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9EAED30)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9EAF210)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9EAF220)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9EAF290)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9EAF310)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9EAF390)
#define MOLEMOLE_UIPLAYERSKINSWITCHTABWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9EAF3F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerSkinSwitchTabWidgetController_TypeDefinitionIndex = 37946;

	class UIPlayerSkinSwitchTabWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_A8D72D44ADC143C2* _view; // 0x2D0
		::System::Int32 m_avatarID; // 0x2D8
