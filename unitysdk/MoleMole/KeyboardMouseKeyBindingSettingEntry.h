...
#define MOLEMOLE_KEYBOARDMOUSEKEYBINDINGSETTINGENTRY_GET_SETTINGRAWINPUTDEVICELIST_OFFSET UNITYSDK_OFFSET(0xB19C320)
#define MOLEMOLE_KEYBOARDMOUSEKEYBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xB19C2F0)
#define MOLEMOLE_KEYBOARDMOUSEKEYBINDINGSETTINGENTRY___BASE_GET_SETTINGRAWINPUTDEVICELIST_OFFSET UNITYSDK_OFFSET(0xB19C420)

namespace MoleMole
{
	inline static constexpr unsigned int KeyboardMouseKeyBindingSettingEntry_TypeDefinitionIndex = 52045;
