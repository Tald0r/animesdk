...
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_CREATEITEMICON_OFFSET UNITYSDK_OFFSET(0x8093080)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8092250)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x8092500)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONCLICKITEMBTN_OFFSET UNITYSDK_OFFSET(0x8093210)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8092960)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8092A00)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8092260)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8092370)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_OPENEQUIPDETAIL_OFFSET UNITYSDK_OFFSET(0x8093590)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8092B60)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER_SETTIP_OFFSET UNITYSDK_OFFSET(0x8092A90)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x80938F0)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8093920)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8093990)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x80939A0)
#define MOLEMOLE_UIGENERALUPDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x80939B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralUpDialogPopWindowController_TypeDefinitionIndex = 75632;

	class UIGeneralUpDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_08996034AAFF91A2* _view; // 0x2F8
		::Class_2_9D9172C07F82DDAE* _itemModel; // 0x300
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* _curShowItems; // 0x308
		::System::Boolean _skipAnim; // 0x310
		::System::Single _scrollPos; // 0x314
		::System::Boolean _useCustomInfo; // 0x318
		::System::Collections::Generic::List_1<::Class_1_0D6706375CDAAE8C*>* _customItemList; // 0x320
		::System::String* _customTitle; // 0x328
		::System::String* _customTitleEn; // 0x330
		::System::String* _tipInfo; // 0x338
