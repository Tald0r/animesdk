...
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_BEGINDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0x6CF0060)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_COMPARISONFRAME_OFFSET UNITYSDK_OFFSET(0x6CEF3E0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_COMPARISON_OFFSET UNITYSDK_OFFSET(0x6CF1EC0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ENDDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0x6CEFFE0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_FINDTABINDEX_OFFSET UNITYSDK_OFFSET(0xADEB590)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_GETCUSTOMBINDER_OFFSET UNITYSDK_OFFSET(0x6CEF720)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_GETFRAMEFROMID_OFFSET UNITYSDK_OFFSET(0x6CEF300)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_GETSELFIEMOTIONFROMID_OFFSET UNITYSDK_OFFSET(0x6CEE870)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_GETVOLUMEFROMID_OFFSET UNITYSDK_OFFSET(0xADEC1B0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_GET_ISSHOWFRONTANIMATION_OFFSET UNITYSDK_OFFSET(0x6CEDB10)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xADEC330)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_INITANIMATION_OFFSET UNITYSDK_OFFSET(0x6CEDCF0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_INITFRAME_OFFSET UNITYSDK_OFFSET(0x6CEE9F0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_INITSTICKER_OFFSET UNITYSDK_OFFSET(0x6CEF7E0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_INITTAB_OFFSET UNITYSDK_OFFSET(0x6CF22F0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_INITVOLUME_OFFSET UNITYSDK_OFFSET(0xADEBBA0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0xADEC510)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_MASKPOINTUPCALLBACK_OFFSET UNITYSDK_OFFSET(0x6CF07C0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0x6CF0750)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONCLICKSTICKER_OFFSET UNITYSDK_OFFSET(0x6CF0F00)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADEC6F0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONFRAMECLICKED_OFFSET UNITYSDK_OFFSET(0x6CEEB80)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONFRAMESELECTED_OFFSET UNITYSDK_OFFSET(0x6CEEC70)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xADEC9C0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONPREINPUTACTION_OFFSET UNITYSDK_OFFSET(0x6CF21B0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONSELFIEMOTIONCLICKED_OFFSET UNITYSDK_OFFSET(0x6CEDE80)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONSELFIEMOTIONSELECTED_OFFSET UNITYSDK_OFFSET(0x6CEDF70)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xADEC820)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONSTARTDRAGOUTSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x6CF15D0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONTABCLICKED_OFFSET UNITYSDK_OFFSET(0x6CF2540)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONTABSELECTED_OFFSET UNITYSDK_OFFSET(0xADEAA60)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADEC790)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADEC340)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADEC640)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONVOLUMECLICKED_OFFSET UNITYSDK_OFFSET(0xADEBD30)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_ONVOLUMESELECTED_OFFSET UNITYSDK_OFFSET(0xADEBE20)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_REFRESHFRAMEDATA_OFFSET UNITYSDK_OFFSET(0x6CEEEE0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_REFRESHFRAMESELECTED_OFFSET UNITYSDK_OFFSET(0x6CEF680)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_REFRESHSELFIEMOTIONDATA_OFFSET UNITYSDK_OFFSET(0x6CEE200)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_REFRESHSELFIEMOTIONSELECTED_OFFSET UNITYSDK_OFFSET(0x6CEE950)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_REFRESHSTICKERDATA_OFFSET UNITYSDK_OFFSET(0x6CF11E0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_REFRESHTABDATA_OFFSET UNITYSDK_OFFSET(0xADEB060)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_REFRESHVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0xADEB670)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_REFRESHVOLUMESELECTED_OFFSET UNITYSDK_OFFSET(0xADEC290)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_SHOWFILTER_OFFSET UNITYSDK_OFFSET(0xADEBFC0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_SHOWFRAME_OFFSET UNITYSDK_OFFSET(0x6CEECF0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_SHOWMOTION_OFFSET UNITYSDK_OFFSET(0x6CEE010)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_SHOWTABUI_OFFSET UNITYSDK_OFFSET(0xADEC950)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_SHOWTAB_OFFSET UNITYSDK_OFFSET(0xADEAAE0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_SHOWUNLOCKTIPS_OFFSET UNITYSDK_OFFSET(0xADEBEC0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xADECD50)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xADECA60)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER__INITSTICKER_B__30_0_OFFSET UNITYSDK_OFFSET(0xADECDD0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___BASE_GETCUSTOMBINDER_OFFSET UNITYSDK_OFFSET(0xADECDE0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___BASE_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0xADECE50)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADECEC0)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xADECF30)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___BASE_ONPREINPUTACTION_OFFSET UNITYSDK_OFFSET(0xADECF90)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xADED020)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADED030)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADED040)
#define MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADED050)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoSettingChildWindowController_TypeDefinitionIndex = 76827;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIPhotoSettingChildWindowController_TypeDefinitionIndex)->GetStaticField(0x3F0B0);
		}
		static ::System::String** StaticGet_PhotoSettingTabIcon_Frame()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIPhotoSettingChildWindowController_TypeDefinitionIndex)->GetStaticField(0x3F0B8);
		}
		static ::System::String** StaticGet_PhotoSettingTabIcon_Setting()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIPhotoSettingChildWindowController_TypeDefinitionIndex)->GetStaticField(0x3F0C0);
		}
		static ::System::String** StaticGet_PhotoSettingTabIcon_Volume()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIPhotoSettingChildWindowController_TypeDefinitionIndex)->GetStaticField(0x3F0C8);
		}
		static ::System::String** StaticGet_PhotoSettingTabIcon_Animation()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIPhotoSettingChildWindowController_TypeDefinitionIndex)->GetStaticField(0x3F0D0);
		}
		...
		::Class_2_79AE422BA06F6D26_57* _view; // 0x3B8
		...
		{
			return ((::Class_0_16E4307DCC419505_155*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER_GETCUSTOMBINDER_OFFSET))(this);
		}
		...
		{
			return ((::Class_0_16E4307DCC419505_155*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIPHOTOSETTINGCHILDWINDOWCONTROLLER___BASE_GETCUSTOMBINDER_OFFSET))(this);
		}
