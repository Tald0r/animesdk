...
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER___C__DISPLAYCLASS90_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAF81BE0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER___C__DISPLAYCLASS90_0__STARTSCOREDOTWEEN_B__0_OFFSET UNITYSDK_OFFSET(0xAF81CE0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER___C__DISPLAYCLASS90_0__STARTSCOREDOTWEEN_B__1_OFFSET UNITYSDK_OFFSET(0xAF81D30)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER___C__DISPLAYCLASS90_0__STARTSCOREDOTWEEN_B__2_OFFSET UNITYSDK_OFFSET(0xAF81BF0)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER___C__DISPLAYCLASS90_0__STARTSCOREDOTWEEN_B__3_OFFSET UNITYSDK_OFFSET(0xAF81C50)
#define MOLEMOLE_UIQUESTIONSANSWERWIDGETCONTROLLER___C__DISPLAYCLASS90_0__STARTSCOREDOTWEEN_B__4_OFFSET UNITYSDK_OFFSET(0xAF81CB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerWidgetController___c__DisplayClass90_0_TypeDefinitionIndex = 70194;
