...
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPINLOADINGWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xA976A00)
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPINLOADINGWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA976BA0)
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPINLOADINGWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xA976BB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFullScreenVideoV2PopInLoadingWindowController_TypeDefinitionIndex = 45522;
