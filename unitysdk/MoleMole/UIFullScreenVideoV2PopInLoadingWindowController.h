...
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPINLOADINGWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xBF0F140)
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPINLOADINGWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF0F2E0)
#define MOLEMOLE_UIFULLSCREENVIDEOV2POPINLOADINGWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xBF0F2F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFullScreenVideoV2PopInLoadingWindowController_TypeDefinitionIndex = 69276;
