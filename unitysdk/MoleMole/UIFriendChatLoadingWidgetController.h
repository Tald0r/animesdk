...
#define MOLEMOLE_UIFRIENDCHATLOADINGWIDGETCONTROLLER_DOINIT_OFFSET UNITYSDK_OFFSET(0xA358AC0)
#define MOLEMOLE_UIFRIENDCHATLOADINGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA3587F0)
#define MOLEMOLE_UIFRIENDCHATLOADINGWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA358970)
#define MOLEMOLE_UIFRIENDCHATLOADINGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA358890)
#define MOLEMOLE_UIFRIENDCHATLOADINGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA358750)
#define MOLEMOLE_UIFRIENDCHATLOADINGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA358C50)
#define MOLEMOLE_UIFRIENDCHATLOADINGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA358C60)
#define MOLEMOLE_UIFRIENDCHATLOADINGWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA358CD0)
#define MOLEMOLE_UIFRIENDCHATLOADINGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA358D50)
#define MOLEMOLE_UIFRIENDCHATLOADINGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA358DD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatLoadingWidgetController_TypeDefinitionIndex = 44317;

	class UIFriendChatLoadingWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_56AF18CD74DA940A_7* _view; // 0x2D0
		::System::Boolean _isDetector; // 0x2D8
		::UnityEngine::RectTransform* _detectorTrans; // 0x2E0
