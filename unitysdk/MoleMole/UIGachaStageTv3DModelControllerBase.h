...
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_CHECKRARITYTV_OFFSET UNITYSDK_OFFSET(0xBF7E070)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_GETCHARACTERLIGHTSTLPATH_OFFSET UNITYSDK_OFFSET(0xBF7E000)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_GETLIGHTIDS_OFFSET UNITYSDK_OFFSET(0xBF7DFA0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_GETRARITYEFFDELAY_OFFSET UNITYSDK_OFFSET(0xBF7DBE0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_GET_BLUEPRINT_NAME_OFFSET UNITYSDK_OFFSET(0xBF7E100)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_GET_CONTENTROOTANIM_OFFSET UNITYSDK_OFFSET(0xBF7E1A0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_GET_TOTAL_TV_NUM_OFFSET UNITYSDK_OFFSET(0xBF7DF30)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_HANDLEONOPEN_OFFSET UNITYSDK_OFFSET(0xBF7AF50)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_HANDLEUPDATE_OFFSET UNITYSDK_OFFSET(0xBF7B1A0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_INITLIGHTS_OFFSET UNITYSDK_OFFSET(0xBF7DF40)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_ONREFRESHSTAGE_OFFSET UNITYSDK_OFFSET(0xBF7B440)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_PRELOADSTAGEBEFOREPLAY_OFFSET UNITYSDK_OFFSET(0xBF7B3C0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_STOPSOUND_OFFSET UNITYSDK_OFFSET(0xBF7B250)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xBF7E1B0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE___BASE_CHECKRARITYTV_OFFSET UNITYSDK_OFFSET(0xBF7E320)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE___BASE_GETRARITYEFFDELAY_OFFSET UNITYSDK_OFFSET(0xBF7E3C0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE___BASE_GET_BLUEPRINT_NAME_OFFSET UNITYSDK_OFFSET(0xBF7E3B0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE___BASE_HANDLEONOPEN_OFFSET UNITYSDK_OFFSET(0xBF7E3D0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE___BASE_HANDLEUPDATE_OFFSET UNITYSDK_OFFSET(0xBF7E3E0)
#define MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE___BASE_STOPSOUND_OFFSET UNITYSDK_OFFSET(0xBF7E450)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaStageTv3DModelControllerBase_TypeDefinitionIndex = 64383;
	...
	public:
		...
		::Class_2_208CC9941471731A_894* _gachaPerformTamplate; // 0x658
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_471*, ::System::Action*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGACHASTAGETV3DMODELCONTROLLERBASE_PRELOADSTAGEBEFOREPLAY_OFFSET))(this, template_, preloadComplete);
		}
