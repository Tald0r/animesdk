...
#define MOLEMOLE_TEXTURESHEETLOOPFRAME_COLLIDEREND_OFFSET UNITYSDK_OFFSET(0xD44A880)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME_COLLIDERSTART_OFFSET UNITYSDK_OFFSET(0xD44A7A0)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME_ISEND_OFFSET UNITYSDK_OFFSET(0xD44A8F0)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME_NEXTLOOP_OFFSET UNITYSDK_OFFSET(0xD44A960)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME_RESET_OFFSET UNITYSDK_OFFSET(0xD44A810)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME_TOSTRING_OFFSET UNITYSDK_OFFSET(0xD44A9C0)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0xD44AD00)
#define MOLEMOLE_TEXTURESHEETLOOPFRAME___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xD44AD10)

namespace MoleMole
{
	inline static constexpr unsigned int TextureSheetLoopFrame_TypeDefinitionIndex = 72116;
