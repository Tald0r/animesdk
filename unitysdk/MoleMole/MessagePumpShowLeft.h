...
#define MOLEMOLE_MESSAGEPUMPSHOWLEFT_GET_ISPENETRATE_OFFSET UNITYSDK_OFFSET(0x82E2520)
#define MOLEMOLE_MESSAGEPUMPSHOWLEFT_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x82E2530)
#define MOLEMOLE_MESSAGEPUMPSHOWLEFT_ONPROCESS_OFFSET UNITYSDK_OFFSET(0x82E2570)
#define MOLEMOLE_MESSAGEPUMPSHOWLEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x82E2540)

namespace MoleMole
{
	inline static constexpr unsigned int MessagePumpShowLeft_TypeDefinitionIndex = 39708;
