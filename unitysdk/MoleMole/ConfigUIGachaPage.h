...
#define MOLEMOLE_CONFIGUIGACHAPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x139B03A0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIGachaPage_TypeDefinitionIndex = 39371;
