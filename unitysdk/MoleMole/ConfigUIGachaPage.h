...
#define MOLEMOLE_CONFIGUIGACHAPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x91A29B0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIGachaPage_TypeDefinitionIndex = 37723;
