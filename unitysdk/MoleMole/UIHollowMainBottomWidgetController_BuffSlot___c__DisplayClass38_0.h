...
namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainBottomWidgetController_BuffSlot___c__DisplayClass38_0_TypeDefinitionIndex = 78272;
	...
	struct alignas(8) UIHollowMainBottomWidgetController_BuffSlot___c__DisplayClass38_0
	{
		...
		::UnityEngine::ParticleSystem* oStart; // 0x30
	};
}
