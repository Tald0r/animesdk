...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_3__CTOR_OFFSET UNITYSDK_OFFSET(0xD12BFE0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_3__PLAYSTORYNODE_B__12_OFFSET UNITYSDK_OFFSET(0xD12BFF0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_3__PLAYSTORYNODE_B__13_OFFSET UNITYSDK_OFFSET(0xD12C320)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass33_3_TypeDefinitionIndex = 58880;
	...
	public:
		...
		::MoleMole::UIGalgamePageController___c__DisplayClass33_0* CS___8__locals3; // 0x20
