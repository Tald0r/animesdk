...
#define MOLEMOLE_UIGENERALNEWSBUBBLEROWWIDGETCONTROLLER___C__DISPLAYCLASS79_1__CTOR_OFFSET UNITYSDK_OFFSET(0xC11EA10)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralNewsBubbleRowWidgetController___c__DisplayClass79_1_TypeDefinitionIndex = 73189;
	...
	public:
		...
		::UnityEngine::UI::VerticalLayoutGroup* frameGroup; // 0x28
		::System::Single lastHeight; // 0x30
		::System::Single delta; // 0x34
