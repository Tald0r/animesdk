...
#define MOLEMOLE_STATEBASELAYER_METHOD_4_2DB8CABC5F9281CC_OFFSET UNITYSDK_OFFSET(0xA660170)
#define MOLEMOLE_STATEBASELAYER_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xA65FDD0)
#define MOLEMOLE_STATEBASELAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xA660140)

namespace MoleMole
{
	inline static constexpr unsigned int StateBaseLayer_TypeDefinitionIndex = 68787;
