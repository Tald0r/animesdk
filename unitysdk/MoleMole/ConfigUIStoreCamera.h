...
#define MOLEMOLE_CONFIGUISTORECAMERA_GETUICAMERATELESCOPECONFIG_OFFSET UNITYSDK_OFFSET(0xE0D6F30)
#define MOLEMOLE_CONFIGUISTORECAMERA_GETUISTOREPAGECONFIG_OFFSET UNITYSDK_OFFSET(0xE0D6E50)
#define MOLEMOLE_CONFIGUISTORECAMERA_GETUIVIRTUALCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0xE0D6D40)
#define MOLEMOLE_CONFIGUISTORECAMERA_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xE0D63B0)
#define MOLEMOLE_CONFIGUISTORECAMERA_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xE0D5C80)
#define MOLEMOLE_CONFIGUISTORECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xE0D7040)
#define MOLEMOLE_CONFIGUISTORECAMERA___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xE0D73A0)
#define MOLEMOLE_CONFIGUISTORECAMERA___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xE0D73B0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIStoreCamera_TypeDefinitionIndex = 58911;
