...
#define MOLEMOLE_CONFIGUISTORECAMERA_GETUICAMERATELESCOPECONFIG_OFFSET UNITYSDK_OFFSET(0x10ABE140)
#define MOLEMOLE_CONFIGUISTORECAMERA_GETUISTOREPAGECONFIG_OFFSET UNITYSDK_OFFSET(0x10ABE060)
#define MOLEMOLE_CONFIGUISTORECAMERA_GETUIVIRTUALCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0x10ABDF50)
#define MOLEMOLE_CONFIGUISTORECAMERA_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10ABD5C0)
#define MOLEMOLE_CONFIGUISTORECAMERA_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10ABCE90)
#define MOLEMOLE_CONFIGUISTORECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x10ABE250)
#define MOLEMOLE_CONFIGUISTORECAMERA___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10ABE5B0)
#define MOLEMOLE_CONFIGUISTORECAMERA___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x10ABE5C0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIStoreCamera_TypeDefinitionIndex = 78712;
