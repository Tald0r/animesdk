...
#define MOLEMOLE_ABYSSS2_WORKGRID_LINE_CREATELINE_OFFSET UNITYSDK_OFFSET(0x9B2AB20)
#define MOLEMOLE_ABYSSS2_WORKGRID_LINE_EQUALS_OFFSET UNITYSDK_OFFSET(0x36E6F0)
#define MOLEMOLE_ABYSSS2_WORKGRID_LINE_ISPOINTINSIDE_OFFSET UNITYSDK_OFFSET(0x36E700)
#define MOLEMOLE_ABYSSS2_WORKGRID_LINE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x36E730)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_WorkGrid_Line_TypeDefinitionIndex = 68789;
