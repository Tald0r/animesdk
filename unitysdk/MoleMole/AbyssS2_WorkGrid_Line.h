...
#define MOLEMOLE_ABYSSS2_WORKGRID_LINE_CREATELINE_OFFSET UNITYSDK_OFFSET(0x9F94A40)
#define MOLEMOLE_ABYSSS2_WORKGRID_LINE_EQUALS_OFFSET UNITYSDK_OFFSET(0x386B50)
#define MOLEMOLE_ABYSSS2_WORKGRID_LINE_ISPOINTINSIDE_OFFSET UNITYSDK_OFFSET(0x386B60)
#define MOLEMOLE_ABYSSS2_WORKGRID_LINE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x386B90)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_WorkGrid_Line_TypeDefinitionIndex = 77507;
