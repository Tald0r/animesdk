...
#define MOLEMOLE_POWERTIPSPOPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8A89830)

namespace MoleMole
{
	inline static constexpr unsigned int PowerTipsPopContext_TypeDefinitionIndex = 42745;
