...
#define MOLEMOLE_UISUIBIANTEMPLEMANAGEINFOCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x951A4C0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleManageInfoContext_TypeDefinitionIndex = 45870;

	class UISuibianTempleManageInfoContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Boolean FromJump; // 0x28
		::Enum_3_D3384FC764485EA3 OpenType; // 0x2C
		::System::UInt32 CraftBenchID; // 0x30
		::System::UInt32 GoodShelveID; // 0x34
