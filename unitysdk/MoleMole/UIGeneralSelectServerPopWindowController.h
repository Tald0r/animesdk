...
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_CLOSESELF_OFFSET UNITYSDK_OFFSET(0xDFC31B0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0xDFC2510)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDFC2500)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDFC28D0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xDFC2FE0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDFC2F50)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDFC2520)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDFC2970)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_SETGAMEPADSELECTED_OFFSET UNITYSDK_OFFSET(0xDFC2CD0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER_SETSELECTSERVERCALLBACK_OFFSET UNITYSDK_OFFSET(0xDFC3130)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDFC3220)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER__ONUIINIT_B__7_0_OFFSET UNITYSDK_OFFSET(0xDFC3280)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDFC3530)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xDFC35A0)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDFC3600)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDFC3610)
#define MOLEMOLE_UIGENERALSELECTSERVERPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDFC3620)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSelectServerPopWindowController_TypeDefinitionIndex = 67524;

	class UIGeneralSelectServerPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_167* _view; // 0x2F8
