...
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER_GETBADGEMAP_OFFSET UNITYSDK_OFFSET(0xB755370)
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER_GETCARDLIST_OFFSET UNITYSDK_OFFSET(0xB755870)
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB7558E0)
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER___BASE_GETBADGEMAP_OFFSET UNITYSDK_OFFSET(0xB7558F0)
#define MOLEMOLE_UIBANGBOODREAMACHIEVEMENTDIALOGWIDGETCONTROLLER___BASE_GETCARDLIST_OFFSET UNITYSDK_OFFSET(0xB755900)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooDreamAchievementDialogWidgetController_TypeDefinitionIndex = 48866;
