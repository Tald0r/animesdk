...
#define MOLEMOLE_ACTIVITYLIVEHOUSERHYTHMBEATMAPCONFIG_GET_AUDIOOFFSETSECONDS_OFFSET UNITYSDK_OFFSET(0x6290E30)
#define MOLEMOLE_ACTIVITYLIVEHOUSERHYTHMBEATMAPCONFIG_METHOD_3_15E82C5C62701F51_OFFSET UNITYSDK_OFFSET(0x6291100)
#define MOLEMOLE_ACTIVITYLIVEHOUSERHYTHMBEATMAPCONFIG_METHOD_3_284A00008B880FD6_OFFSET UNITYSDK_OFFSET(0x6291300)
#define MOLEMOLE_ACTIVITYLIVEHOUSERHYTHMBEATMAPCONFIG_METHOD_3_5DB88A6B329F3A46_OFFSET UNITYSDK_OFFSET(0x6291200)
#define MOLEMOLE_ACTIVITYLIVEHOUSERHYTHMBEATMAPCONFIG_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x6291370)
#define MOLEMOLE_ACTIVITYLIVEHOUSERHYTHMBEATMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6290E40)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityLivehouseRhythmBeatmapConfig_TypeDefinitionIndex = 40571;
