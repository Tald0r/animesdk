...
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB04BB0)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB04C20)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xBB04FD0)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBB04CE0)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xBB04DC0)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBB05110)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBB05120)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xBB05190)
#define MOLEMOLE_UIBOSSBATTLEDATATABROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xBB05200)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossBattleDataTabRowWidgetController_TypeDefinitionIndex = 50217;
