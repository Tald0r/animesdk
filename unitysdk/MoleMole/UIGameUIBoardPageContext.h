...
#define MOLEMOLE_UIGAMEUIBOARDPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB2B6CD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGameUIBoardPageContext_TypeDefinitionIndex = 67654;
