...
#define MOLEMOLE_COMMANDLINEMODELQUALITY_METHOD_2_5CA9975A94142337_OFFSET UNITYSDK_OFFSET(0x81DBED0)
#define MOLEMOLE_COMMANDLINEMODELQUALITY_METHOD_2_DA6A28AF1A5D9016_OFFSET UNITYSDK_OFFSET(0x81DC020)
#define MOLEMOLE_COMMANDLINEMODELQUALITY__CTOR_OFFSET UNITYSDK_OFFSET(0x81DBFE0)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineModelQuality_TypeDefinitionIndex = 58383;
