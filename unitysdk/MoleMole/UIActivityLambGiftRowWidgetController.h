...
#define MOLEMOLE_UIACTIVITYLAMBGIFTROWWIDGETCONTROLLER_ONCLICKREWARDITEM_OFFSET UNITYSDK_OFFSET(0xDEE1D10)
#define MOLEMOLE_UIACTIVITYLAMBGIFTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEE0EC0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDEE1040)
#define MOLEMOLE_UIACTIVITYLAMBGIFTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEE0F60)
#define MOLEMOLE_UIACTIVITYLAMBGIFTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEE0990)
#define MOLEMOLE_UIACTIVITYLAMBGIFTROWWIDGETCONTROLLER_REFRESHREWARDSTATE_OFFSET UNITYSDK_OFFSET(0xDEE1860)
#define MOLEMOLE_UIACTIVITYLAMBGIFTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDEE1F90)
#define MOLEMOLE_UIACTIVITYLAMBGIFTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEE1FA0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDEE2010)
#define MOLEMOLE_UIACTIVITYLAMBGIFTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEE2090)
#define MOLEMOLE_UIACTIVITYLAMBGIFTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEE2110)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityLambGiftRowWidgetController_TypeDefinitionIndex = 80847;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_237* _view; // 0x2D0
