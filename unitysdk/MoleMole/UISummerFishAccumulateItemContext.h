...
#define MOLEMOLE_UISUMMERFISHACCUMULATEITEMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x71D7DE0)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishAccumulateItemContext_TypeDefinitionIndex = 44925;
