...
#define MOLEMOLE_UICONTROLITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0xA52D450)
#define MOLEMOLE_UICONTROLITEM_ISMATCH_OFFSET UNITYSDK_OFFSET(0xA52D1C0)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_41081A5E55D64FFA_OFFSET UNITYSDK_OFFSET(0xA52D830)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_54EE5091F9DB1A7D_OFFSET UNITYSDK_OFFSET(0xA52DB30)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_802C78794466A385_OFFSET UNITYSDK_OFFSET(0xA52DC00)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_A0C62902B517B139_OFFSET UNITYSDK_OFFSET(0xA52D520)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_DC142A2AF2A69784_OFFSET UNITYSDK_OFFSET(0xA52DB20)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_FE6ADCB1EC61DCFF_OFFSET UNITYSDK_OFFSET(0xA52DC80)
#define MOLEMOLE_UICONTROLITEM_METHOD_1_FF9D9C132E279CF6_OFFSET UNITYSDK_OFFSET(0xA52D9D0)
#define MOLEMOLE_UICONTROLITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA52D820)

namespace MoleMole
{
	inline static constexpr unsigned int UIControlItem_TypeDefinitionIndex = 60578;
