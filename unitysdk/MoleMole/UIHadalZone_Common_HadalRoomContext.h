...
#define MOLEMOLE_UIHADALZONE_COMMON_HADALROOMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x91352C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_Common_HadalRoomContext_TypeDefinitionIndex = 40928;

	class UIHadalZone_Common_HadalRoomContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_2_208CC9941471731A_415* activityBattleQuestCfg; // 0x28
		::Class_2_14E7CE92E8A3183F* abyssDungeonCfg; // 0x30
		::Class_2_0A55B5A82A61DAFA* questCfg; // 0x38
		::MoleMole::Project::Config::BabelFloorInfoTemplateExt* babelFloorCfg; // 0x40
		::System::Collections::Generic::List_1<::System::Int32>* cardIDList; // 0x48
