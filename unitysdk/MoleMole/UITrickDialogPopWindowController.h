...
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_GETTRICKROWCONTROLLERS_OFFSET UNITYSDK_OFFSET(0xAA6AEF0)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAA6A000)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAA6A010)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_INITTRICKS_OFFSET UNITYSDK_OFFSET(0xAA6A5B0)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAA6A080)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAA6A370)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_SETSTATE_OFFSET UNITYSDK_OFFSET(0xAA6AAB0)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAA6B060)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAA6B180)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAA6B1F0)

namespace MoleMole
{
	inline static constexpr unsigned int UITrickDialogPopWindowController_TypeDefinitionIndex = 37443;
