...
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_GETTRICKROWCONTROLLERS_OFFSET UNITYSDK_OFFSET(0xEE44180)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xEE43270)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEE43280)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_INITTRICKS_OFFSET UNITYSDK_OFFSET(0xEE43820)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEE432F0)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xEE435E0)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_SETSTATE_OFFSET UNITYSDK_OFFSET(0xEE43D40)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xEE442F0)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEE44410)
#define MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xEE44480)

namespace MoleMole
{
	inline static constexpr unsigned int UITrickDialogPopWindowController_TypeDefinitionIndex = 40841;

	class UITrickDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::MoleMole::UIWidgetController*>*>* trickMapController; // 0x2F8
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* titleMap; // 0x300
		...
		{
			return ((::Class_2_11247D643A7817C1_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UITRICKDIALOGPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
