...
#define MOLEMOLE_UIGENERALLOGINTIPSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBFAF4E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLoginTipsContext_TypeDefinitionIndex = 37491;
