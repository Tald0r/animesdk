...
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8A24500)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8A24510)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8A24580)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER_ONPROCESSSENSOR_OFFSET UNITYSDK_OFFSET(0x8A258F0)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8A250C0)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8A25130)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8A24680)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8A24FC0)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x8A25290)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8A259E0)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x8A25A70)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8A25AE0)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8A25AF0)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8A25B00)
#define MOLEMOLE_UIGYRO3DMODELTESTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8A25B10)

namespace MoleMole
{
	inline static constexpr unsigned int UIGyro3DModelTestPopWindowController_TypeDefinitionIndex = 45021;
