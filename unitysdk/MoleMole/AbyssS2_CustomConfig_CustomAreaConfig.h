...
#define MOLEMOLE_ABYSSS2_CUSTOMCONFIG_CUSTOMAREACONFIG_GETALLAREACONFIG_OFFSET UNITYSDK_OFFSET(0x3B6C50)
#define MOLEMOLE_ABYSSS2_CUSTOMCONFIG_CUSTOMAREACONFIG_GETALLSCENE_OFFSET UNITYSDK_OFFSET(0xB8E4610)
#define MOLEMOLE_ABYSSS2_CUSTOMCONFIG_CUSTOMAREACONFIG_REFRESH_OFFSET UNITYSDK_OFFSET(0x3B6C40)

namespace MoleMole
{
	inline static constexpr unsigned int AbyssS2_CustomConfig_CustomAreaConfig_TypeDefinitionIndex = 77501;
