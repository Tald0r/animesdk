...
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER_CLOSEMAINCITYSTOREPAGE_OFFSET UNITYSDK_OFFSET(0xCFD57E0)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFD4F80)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xCFD55E0)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xCFD5AF0)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFD5440)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFD5020)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xCFD5350)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER_TRIGGERBACKBTN_OFFSET UNITYSDK_OFFSET(0xCFD5920)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD5B70)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER___BASE_CLOSEMAINCITYSTOREPAGE_OFFSET UNITYSDK_OFFSET(0xCFD5B80)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFD5B90)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xCFD5C00)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xCFD5C30)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFD5C40)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFD5C50)
#define MOLEMOLE_UIRAMENSTOREPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xCFD5C60)

namespace MoleMole
{
	inline static constexpr unsigned int UIRamenStorePageController_TypeDefinitionIndex = 76237;

	class UIRamenStorePageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_D68EC59F0214DAC2* _view; // 0x308
