...
#define MOLEMOLE_UIHADALZONE_COMMON_UILINEUPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD587270)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_Common_UILineupContext_TypeDefinitionIndex = 40921;

	class UIHadalZone_Common_UILineupContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_1_5DA2E7556103D5A3_245* lineupZoneInfo; // 0x28
