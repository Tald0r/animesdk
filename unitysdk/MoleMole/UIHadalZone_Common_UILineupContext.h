...
#define MOLEMOLE_UIHADALZONE_COMMON_UILINEUPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9D9AD30)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_Common_UILineupContext_TypeDefinitionIndex = 49070;

	class UIHadalZone_Common_UILineupContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::Class_1_5DA2E7556103D5A3_280* lineupZoneInfo; // 0x28
