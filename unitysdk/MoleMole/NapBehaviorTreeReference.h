...
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE_GETEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0xB1B8D50)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE_LOADPATHBEHAVIORTREE_OFFSET UNITYSDK_OFFSET(0xB1B8E30)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE_ONPREPAREEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0xB1B8BF0)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xB1B8DB0)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE_TRYLOADNULLBEHAVIORTREE_OFFSET UNITYSDK_OFFSET(0xB1B9130)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xB1B9370)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE__DOCUSTOMLOAD_OFFSET UNITYSDK_OFFSET(0xB1B9310)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE__LOADEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0xB1B8CC0)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE___BASE_GETEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0xB1B93B0)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE___BASE_ONPREPAREEXTERNALBEHAVIORS_OFFSET UNITYSDK_OFFSET(0xB1B9440)
#define MOLEMOLE_NAPBEHAVIORTREEREFERENCE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xB1B94D0)

namespace MoleMole
{
	inline static constexpr unsigned int NapBehaviorTreeReference_TypeDefinitionIndex = 66167;
