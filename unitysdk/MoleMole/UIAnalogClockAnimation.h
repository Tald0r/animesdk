...
#define MOLEMOLE_UIANALOGCLOCKANIMATION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB7385B0)
#define MOLEMOLE_UIANALOGCLOCKANIMATION_METHOD_5_8C0442D62EFC6002_OFFSET UNITYSDK_OFFSET(0xB7387F0)
#define MOLEMOLE_UIANALOGCLOCKANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xB738A30)

namespace MoleMole
{
	inline static constexpr unsigned int UIAnalogClockAnimation_TypeDefinitionIndex = 56716;
