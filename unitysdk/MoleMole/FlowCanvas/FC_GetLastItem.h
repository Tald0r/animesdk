...
#define MOLEMOLE_FLOWCANVAS_FC_GETLASTITEM_INVOKE_OFFSET UNITYSDK_OFFSET(0x141CA690)
#define MOLEMOLE_FLOWCANVAS_FC_GETLASTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x141CA740)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int FC_GetLastItem_TypeDefinitionIndex = 53461;
