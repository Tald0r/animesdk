...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GETTIME_OFFSET UNITYSDK_OFFSET(0xB5C7140)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_CURRENTCHESSBOARD_OFFSET UNITYSDK_OFFSET(0xB5C68B0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_DELAY_OFFSET UNITYSDK_OFFSET(0xB5C6630)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_DISCRETEMODE_OFFSET UNITYSDK_OFFSET(0xB5C67A0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xB5C68A0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0xB5C6820)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_MAXX_OFFSET UNITYSDK_OFFSET(0xB5C64B0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_MAXY_OFFSET UNITYSDK_OFFSET(0xB5C65B0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_MINX_OFFSET UNITYSDK_OFFSET(0xB5C6430)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_GET_MINY_OFFSET UNITYSDK_OFFSET(0xB5C6530)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xB5C7200)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB5C69D0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_SETACTIVE_OFFSET UNITYSDK_OFFSET(0xB5C77B0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_START_OFFSET UNITYSDK_OFFSET(0xB5C7670)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_STOP_OFFSET UNITYSDK_OFFSET(0xB5C7520)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE_UPDATE_OFFSET UNITYSDK_OFFSET(0xB5C6CE0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB5C7830)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE__REGISTERPORTS_B__40_0_OFFSET UNITYSDK_OFFSET(0xB5C78B0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE__REGISTERPORTS_B__40_1_OFFSET UNITYSDK_OFFSET(0xB5C78E0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE__REGISTERPORTS_B__40_2_OFFSET UNITYSDK_OFFSET(0xB5C78F0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEWAVEACTIONNODE__REGISTERPORTS_B__40_3_OFFSET UNITYSDK_OFFSET(0xB5C7900)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameWaveActionNode_TypeDefinitionIndex = 49399;

	class HackerGameWaveActionNode : public ::FlowCanvas::FlowNode
	{
	public:
		::FlowCanvas::FlowOutput* _invokeCell; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Boolean>* _discreteMode; // 0xB0
		::FlowCanvas::ValueOutput_1<::System::Int32>* _xOutput; // 0xB8
		::FlowCanvas::FlowOutput* _output; // 0xC0
		::FlowCanvas::FlowInput* _start; // 0xC8
		::FlowCanvas::ValueInput_1<::System::Int32>* _maxY; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Int32>* _minX; // 0xD8
		::FlowCanvas::FlowOutput* _invokeColumn; // 0xE0
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::System::Single>*>* _delay; // 0xE8
		::FlowCanvas::ValueOutput_1<::System::Int32>* _yOutput; // 0xF0
		::FlowCanvas::ValueOutput_1<::MoleMole::HollowChessboard::HollowCell>* _cellOutput; // 0xF8
		::FlowCanvas::ValueInput_1<::System::Int32>* _minY; // 0x100
		::FlowCanvas::Flow _flow; // 0x108
		::FlowCanvas::ValueInput_1<::System::Int32>* _maxX; // 0x130
		::FlowCanvas::ValueInput_1<::System::Boolean>* _isPaused; // 0x138
		::FlowCanvas::FlowOutput* _invokeFinish; // 0x140
		::System::Int32 _x; // 0x148
		::System::Single _timer; // 0x14C
		::System::Int32 _indexCache; // 0x150
		::System::Int32 _y; // 0x154
		::MoleMole::HollowChessboard::HollowCell _cell; // 0x158
		::System::Boolean _isActive; // 0x164
