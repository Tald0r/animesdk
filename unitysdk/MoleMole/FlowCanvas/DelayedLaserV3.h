...
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_APPLYLASERDAMAGE_1_OFFSET UNITYSDK_OFFSET(0xC20BB30)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_APPLYLASERDAMAGE_2_OFFSET UNITYSDK_OFFSET(0xC20CDD0)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_APPLYLASERDAMAGE_OFFSET UNITYSDK_OFFSET(0xC20B9D0)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_DESTROYALERTENTITIES_OFFSET UNITYSDK_OFFSET(0xC20A1F0)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_EXECUTEDELAYEDLASER_OFFSET UNITYSDK_OFFSET(0xC20A850)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_GETDAMAGERANGE_OFFSET UNITYSDK_OFFSET(0xC20B760)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_GETLASERSTARTTIME_OFFSET UNITYSDK_OFFSET(0xC20BA70)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_GET_ALERTFINISHFRAME_OFFSET UNITYSDK_OFFSET(0xC20A030)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_GET_ALERTSTARTTIME_OFFSET UNITYSDK_OFFSET(0xC20A040)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_GET_ALERTSTOPTIME_OFFSET UNITYSDK_OFFSET(0xC20A050)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_GET_PERFORMSTARTTIME_OFFSET UNITYSDK_OFFSET(0xC20A060)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_GET_SEQUENCECOUNT_OFFSET UNITYSDK_OFFSET(0xC20A110)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_GET_TOTALTIME_OFFSET UNITYSDK_OFFSET(0xC20A070)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_ISINLASERAREA_OFFSET UNITYSDK_OFFSET(0xC20CD30)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC20A180)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_POSTALERTSOUND_OFFSET UNITYSDK_OFFSET(0xC20A660)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_POSTDAMAGESOUND_OFFSET UNITYSDK_OFFSET(0xC20A960)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_POSTLASERSPAWNSOUND_OFFSET UNITYSDK_OFFSET(0xC20AD20)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_SPAWNLASEREFFECT_OFFSET UNITYSDK_OFFSET(0xC20A8F0)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_UPDATEDAMAGEACTIVERANGE_OFFSET UNITYSDK_OFFSET(0xC20B4E0)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_UPDATEDAMAGE_OFFSET UNITYSDK_OFFSET(0xC20B800)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_UPDATELASERPARTICLE_OFFSET UNITYSDK_OFFSET(0xC20AF10)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3_UPDATE_OFFSET UNITYSDK_OFFSET(0xC20A440)
#define MOLEMOLE_FLOWCANVAS_DELAYEDLASERV3__CTOR_OFFSET UNITYSDK_OFFSET(0xC20CEB0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int DelayedLaserV3_TypeDefinitionIndex = 63884;

	class DelayedLaserV3 : public ::System::Object
	{
	public:
		::MoleMole::HackerGameBaseDamage* Damage; // 0x10
		...
		::MoleMole::ChessEntityCollection* ChessEntityCollection; // 0x28
		::System::Collections::Generic::List_1<::MoleMole::HollowChessboard::HollowEntity*>* RenderDataHandles; // 0x30
		::System::Collections::Generic::List_1<::System::Single>* LaserPerformSequence; // 0x38
		::System::String* LaserParticleKey; // 0x40
		::System::String* LaserSpawnSoundTriggerName; // 0x48
		::System::String* DamageSoundTriggerName; // 0x50
		::System::Action* SpawnLaserEffectDelegate; // 0x58
		::System::String* AlertSoundTriggerName; // 0x60
		::MoleMole::ChessEntityCollection* PlayerEntityCollection; // 0x68
		::Class_5_AF65C3A968E836D2* CurrentChessboard; // 0x70
		::System::String* FeverSoundTriggerName; // 0x78
		::System::Int32 DamageFinishIndex; // 0x80
		::System::Int32 PerformSequenceIndex; // 0x84
		::System::Single DamageDelay; // 0x88
		::System::Single AlertExtraDuration; // 0x8C
		::System::Single DamageDuration; // 0x90
		::MoleMole::Vector2Int DamageActiveRange; // 0x94
		::System::Int32 StartFrameIndex; // 0x9C
		::System::Int32 AlertFrameCount; // 0xA0
		::System::ValueTuple_2<::System::Int32, ::System::Int32> XRange; // 0xA4
		::System::Int32 LastDamageIndex; // 0xAC
		::System::Boolean IsFinished; // 0xB0
		::System::Boolean alertAudioPost; // 0xB1
		::System::ValueTuple_2<::System::Int32, ::System::Int32> YRange; // 0xB4
		::MoleMole::HollowChessboard::HollowCell TriggerPoint; // 0xBC
