...
#define MOLEMOLE_FLOWCANVAS_HACKEROVERRIDEQUESTCHALLENGE_HANDLEQUEST_OFFSET UNITYSDK_OFFSET(0xEC7F090)
#define MOLEMOLE_FLOWCANVAS_HACKEROVERRIDEQUESTCHALLENGE_INVOKE_OFFSET UNITYSDK_OFFSET(0xEC7EAA0)
#define MOLEMOLE_FLOWCANVAS_HACKEROVERRIDEQUESTCHALLENGE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xEC7F2F0)
#define MOLEMOLE_FLOWCANVAS_HACKEROVERRIDEQUESTCHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC7F4A0)
#define MOLEMOLE_FLOWCANVAS_HACKEROVERRIDEQUESTCHALLENGE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xEC7F4C0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerOverrideQuestChallenge_TypeDefinitionIndex = 42428;
