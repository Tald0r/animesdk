...
{
	inline static constexpr unsigned int ChessBoardChangePieceInfo_ServerInfo_TypeDefinitionIndex = 65720;
	...
	struct alignas(4) ChessBoardChangePieceInfo_ServerInfo
	{
		...
		::MoleMole::FlowCanvas::Optional_1<::Enum_3_4608E37A1B3D374A_25> GridType; // 0x34
		::Class_1_398BF5C97F336D80_Enum_3_9CA0D4E7230BAB54 ChangeType; // 0x3C
	};
}
