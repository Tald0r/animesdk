...
#define MOLEMOLE_FLOWCANVAS_CHESSHACKPLAYERENTITYSPLITNODE_CHANGESPLITSTATE_OFFSET UNITYSDK_OFFSET(0x6E10080)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKPLAYERENTITYSPLITNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6E0FD50)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKPLAYERENTITYSPLITNODE_START_OFFSET UNITYSDK_OFFSET(0x6E0FF10)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKPLAYERENTITYSPLITNODE_TRYCREATEENTITY_OFFSET UNITYSDK_OFFSET(0x6E10AF0)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKPLAYERENTITYSPLITNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E10EA0)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKPLAYERENTITYSPLITNODE__REGISTERPORTS_B__10_0_OFFSET UNITYSDK_OFFSET(0x6E10EC0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessHackPlayerEntitySplitNode_TypeDefinitionIndex = 40691;

	class ChessHackPlayerEntitySplitNode : public ::MoleMole::FlowCanvas::ChessboardFlowNode
	{
	public:
		::FlowCanvas::FlowInput* _in; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::HollowChessboard::HollowCell>*>* _boundList; // 0xB0
		::FlowCanvas::ValueInput_1<::System::Int32>* _count; // 0xB8
		::FlowCanvas::FlowOutput* _out; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Boolean>* _do; // 0xC8
		::FlowCanvas::ValueInput_1<::System::Int32>* _fakePlayerId; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Int32>* _mainPlayer; // 0xD8
		::FlowCanvas::ValueInput_1<::MoleMole::ChessEntityCollection*>* _collection; // 0xE0
		::FlowCanvas::ValueOutput_1<::System::Boolean>* _result; // 0xE8
