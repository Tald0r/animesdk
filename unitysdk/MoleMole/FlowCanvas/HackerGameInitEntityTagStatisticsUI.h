...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEINITENTITYTAGSTATISTICSUI_INVOKE_OFFSET UNITYSDK_OFFSET(0xD0CBD20)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEINITENTITYTAGSTATISTICSUI_REGISTERVIRUSINDEX_OFFSET UNITYSDK_OFFSET(0xD0CBFB0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEINITENTITYTAGSTATISTICSUI__CTOR_OFFSET UNITYSDK_OFFSET(0xD0CC170)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameInitEntityTagStatisticsUI_TypeDefinitionIndex = 58037;
