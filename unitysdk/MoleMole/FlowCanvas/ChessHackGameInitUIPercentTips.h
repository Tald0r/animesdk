...
#define MOLEMOLE_FLOWCANVAS_CHESSHACKGAMEINITUIPERCENTTIPS_INVOKE_OFFSET UNITYSDK_OFFSET(0xE471360)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKGAMEINITUIPERCENTTIPS__CTOR_OFFSET UNITYSDK_OFFSET(0xE4714D0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessHackGameInitUIPercentTips_TypeDefinitionIndex = 73325;
