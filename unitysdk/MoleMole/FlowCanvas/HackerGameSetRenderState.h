...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMESETRENDERSTATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x6AD7030)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMESETRENDERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x6AD7150)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameSetRenderState_TypeDefinitionIndex = 49233;
