...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMESETRENDERSTATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xB5C62F0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMESETRENDERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xB5C6410)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameSetRenderState_TypeDefinitionIndex = 45733;
