...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDCHANGEPIECEINFOV2_INVOKE_OFFSET UNITYSDK_OFFSET(0x8AEA630)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDCHANGEPIECEINFOV2__CTOR_OFFSET UNITYSDK_OFFSET(0x8AEAB30)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessBoardChangePieceInfoV2_TypeDefinitionIndex = 76881;
