...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEENTITYGETEFFECTTYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA4F33E0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEENTITYGETEFFECTTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0xA4F34B0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameEntityGetEffectType_TypeDefinitionIndex = 62794;
