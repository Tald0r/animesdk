...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEENTITYGETEFFECTTYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x141CD250)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEENTITYGETEFFECTTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x141CD320)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameEntityGetEffectType_TypeDefinitionIndex = 63584;
