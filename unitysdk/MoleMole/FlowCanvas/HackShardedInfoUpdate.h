...
#define MOLEMOLE_FLOWCANVAS_HACKSHARDEDINFOUPDATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xE472430)
#define MOLEMOLE_FLOWCANVAS_HACKSHARDEDINFOUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0xE4724E0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackShardedInfoUpdate_TypeDefinitionIndex = 65664;
