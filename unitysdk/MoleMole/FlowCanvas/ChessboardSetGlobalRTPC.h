...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETGLOBALRTPC_INVOKE_OFFSET UNITYSDK_OFFSET(0xA5DDFC0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETGLOBALRTPC_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xA5DE1B0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETGLOBALRTPC__CTOR_OFFSET UNITYSDK_OFFSET(0xA5DE2F0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETGLOBALRTPC___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xA5DE380)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardSetGlobalRTPC_TypeDefinitionIndex = 37033;
