...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDRESETBGM_INVOKE_OFFSET UNITYSDK_OFFSET(0x6AD4FB0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDRESETBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x6AD5180)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessBoardResetBGM_TypeDefinitionIndex = 49565;
