...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDOVERRIDEISUSEJOYSTICK_INVOKE_OFFSET UNITYSDK_OFFSET(0xC2B8870)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDOVERRIDEISUSEJOYSTICK_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xC2B8B30)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDOVERRIDEISUSEJOYSTICK__CTOR_OFFSET UNITYSDK_OFFSET(0xC2B8CA0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDOVERRIDEISUSEJOYSTICK___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xC2B8CC0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardOverrideIsUseJoystick_TypeDefinitionIndex = 70869;
