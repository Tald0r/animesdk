...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEAIMRECT_INVOKE_OFFSET UNITYSDK_OFFSET(0xA5DEA60)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEAIMRECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA5DEB50)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameUpdateAimRect_TypeDefinitionIndex = 66112;
