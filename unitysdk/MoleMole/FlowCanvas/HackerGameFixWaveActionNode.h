...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_ADVANCE_OFFSET UNITYSDK_OFFSET(0x6AD6520)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_GET_CURRENTCHESSBOARD_OFFSET UNITYSDK_OFFSET(0x6AD6170)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x6AD6160)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x6AD60E0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_INITBOUND_OFFSET UNITYSDK_OFFSET(0x6AD6D90)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x6AD6830)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6AD62A0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x6AD6C90)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_START_OFFSET UNITYSDK_OFFSET(0x6AD6AD0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_STOP_OFFSET UNITYSDK_OFFSET(0x6AD6950)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_UPDATE_OFFSET UNITYSDK_OFFSET(0x6AD65B0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6AD6F00)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE__REGISTERPORTS_B__26_0_OFFSET UNITYSDK_OFFSET(0x6AD6F20)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE__REGISTERPORTS_B__26_1_OFFSET UNITYSDK_OFFSET(0x6AD6F50)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE__REGISTERPORTS_B__26_2_OFFSET UNITYSDK_OFFSET(0x6AD7000)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE__REGISTERPORTS_B__26_3_OFFSET UNITYSDK_OFFSET(0x6AD7020)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameFixWaveActionNode_TypeDefinitionIndex = 62126;

	class HackerGameFixWaveActionNode : public ::FlowCanvas::FlowNode
	{
	public:
		::FlowCanvas::FlowOutput* _invokeCell; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Boolean>* _isPaused; // 0xB0
		::FlowCanvas::FlowOutput* _then; // 0xB8
		::FlowCanvas::FlowInput* _advance; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Int32>* _delay; // 0xC8
		::FlowCanvas::ValueOutput_1<::System::Int32>* _col; // 0xD0
		...
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::HollowChessboard::HollowCell>*>* Bound; // 0xF0
		::FlowCanvas::FlowOutput* _invokeCol; // 0xF8
		::System::Int32 _minY; // 0x100
		::System::Int32 _maxY; // 0x104
		::System::Int32 _timer; // 0x108
		::System::Int32 _maxX; // 0x10C
		::System::Int32 _indexCache; // 0x110
		::System::Int32 _colValue; // 0x114
		::System::Int32 _minX; // 0x118
		::System::Boolean _isActive; // 0x11C
