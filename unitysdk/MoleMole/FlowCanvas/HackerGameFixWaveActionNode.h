...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_ADVANCE_OFFSET UNITYSDK_OFFSET(0xB5C57F0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_GET_CURRENTCHESSBOARD_OFFSET UNITYSDK_OFFSET(0xB5C5450)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xB5C5440)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0xB5C53C0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_INITBOUND_OFFSET UNITYSDK_OFFSET(0xB5C6060)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xB5C5B00)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB5C5570)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_SETACTIVE_OFFSET UNITYSDK_OFFSET(0xB5C5F60)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_START_OFFSET UNITYSDK_OFFSET(0xB5C5DA0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_STOP_OFFSET UNITYSDK_OFFSET(0xB5C5C20)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE_UPDATE_OFFSET UNITYSDK_OFFSET(0xB5C5880)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB5C61C0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE__REGISTERPORTS_B__26_0_OFFSET UNITYSDK_OFFSET(0xB5C61E0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE__REGISTERPORTS_B__26_1_OFFSET UNITYSDK_OFFSET(0xB5C6210)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE__REGISTERPORTS_B__26_2_OFFSET UNITYSDK_OFFSET(0xB5C62C0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEFIXWAVEACTIONNODE__REGISTERPORTS_B__26_3_OFFSET UNITYSDK_OFFSET(0xB5C62E0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameFixWaveActionNode_TypeDefinitionIndex = 43379;

	class HackerGameFixWaveActionNode : public ::FlowCanvas::FlowNode
	{
	public:
		::FlowCanvas::FlowOutput* _then; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::HollowChessboard::HollowCell>*>* Bound; // 0xB0
		::FlowCanvas::FlowInput* _advance; // 0xB8
		::FlowCanvas::ValueInput_1<::System::Boolean>* _isPaused; // 0xC0
		::FlowCanvas::FlowOutput* _finish; // 0xC8
		::FlowCanvas::FlowOutput* _invokeCell; // 0xD0
		...
		::FlowCanvas::FlowOutput* _invokeCol; // 0xF0
		::FlowCanvas::ValueOutput_1<::System::Int32>* _col; // 0xF8
		::System::Int32 _maxX; // 0x100
		::MoleMole::HollowChessboard::HollowCell _cell; // 0x104
		::System::Int32 _timer; // 0x110
		::System::Int32 _maxY; // 0x114
		::System::Int32 _minX; // 0x118
		::System::Int32 _indexCache; // 0x11C
		::System::Int32 _minY; // 0x120
		::System::Int32 _colValue; // 0x124
		::System::Boolean _isActive; // 0x128
