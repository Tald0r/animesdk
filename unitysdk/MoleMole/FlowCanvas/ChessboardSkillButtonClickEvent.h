...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSKILLBUTTONCLICKEVENT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xC9B9FC0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSKILLBUTTONCLICKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xC9BA020)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardSkillButtonClickEvent_TypeDefinitionIndex = 37597;
