...
#define MOLEMOLE_FLOWCANVAS_CHESSHIDEUIVIEW_INVOKE_OFFSET UNITYSDK_OFFSET(0x8AEAEE0)
#define MOLEMOLE_FLOWCANVAS_CHESSHIDEUIVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x8AEB000)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessHideUIView_TypeDefinitionIndex = 57572;
