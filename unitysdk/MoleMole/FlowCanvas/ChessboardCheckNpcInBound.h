...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDCHECKNPCINBOUND_INVOKE_OFFSET UNITYSDK_OFFSET(0xE4717F0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDCHECKNPCINBOUND__CTOR_OFFSET UNITYSDK_OFFSET(0xE471C50)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardCheckNpcInBound_TypeDefinitionIndex = 57021;
