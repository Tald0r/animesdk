...
#define MOLEMOLE_FLOWCANVAS_FC_STRINGTOFLOAT_INVOKE_OFFSET UNITYSDK_OFFSET(0xA5DE790)
#define MOLEMOLE_FLOWCANVAS_FC_STRINGTOFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0xA5DE860)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int FC_StringToFloat_TypeDefinitionIndex = 58857;
