...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_DOFILTER_OFFSET UNITYSDK_OFFSET(0x8F6A700)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_DOSEARCH_OFFSET UNITYSDK_OFFSET(0x8F6A440)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_FILTERDISTANCEINTERNAL_OFFSET UNITYSDK_OFFSET(0x8F6AC20)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_FILTERINVALIDCHESSPIECE_OFFSET UNITYSDK_OFFSET(0x8F6ABB0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_INDEXTOBOARDPOS_OFFSET UNITYSDK_OFFSET(0x8F6B670)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_INVOKE_OFFSET UNITYSDK_OFFSET(0x8F6A2E0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__CCTOR_OFFSET UNITYSDK_OFFSET(0x8F6B780)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x8F6B6F0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__DOSEARCH_G__SEARCHBYBOUND_6_1_OFFSET UNITYSDK_OFFSET(0x8F6AAA0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__DOSEARCH_G__SEARCHBYPOSITION_6_0_OFFSET UNITYSDK_OFFSET(0x8F6A9E0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__FILTERDISTANCEINTERNAL_G__CHECKCOLLISION_10_1_OFFSET UNITYSDK_OFFSET(0x8F6B280)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__FILTERDISTANCEINTERNAL_G__INDEXTOSAMPLEGRIDPOS_10_0_OFFSET UNITYSDK_OFFSET(0x8F6B250)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessBoardSearchMap_TypeDefinitionIndex = 60836;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(ChessBoardSearchMap_TypeDefinitionIndex)->GetStaticField(0x3EC70);
		}
