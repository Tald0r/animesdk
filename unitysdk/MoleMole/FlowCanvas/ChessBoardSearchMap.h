...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_DOFILTER_OFFSET UNITYSDK_OFFSET(0xD0C9FD0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_DOSEARCH_OFFSET UNITYSDK_OFFSET(0xD0C9D10)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_FILTERDISTANCEINTERNAL_OFFSET UNITYSDK_OFFSET(0xD0CA4F0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_FILTERINVALIDCHESSPIECE_OFFSET UNITYSDK_OFFSET(0xD0CA480)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_INDEXTOBOARDPOS_OFFSET UNITYSDK_OFFSET(0xD0CAF40)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP_INVOKE_OFFSET UNITYSDK_OFFSET(0xD0C9BB0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__CCTOR_OFFSET UNITYSDK_OFFSET(0xD0CB050)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0CAFC0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__DOSEARCH_G__SEARCHBYBOUND_6_1_OFFSET UNITYSDK_OFFSET(0xD0CA370)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__DOSEARCH_G__SEARCHBYPOSITION_6_0_OFFSET UNITYSDK_OFFSET(0xD0CA2B0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__FILTERDISTANCEINTERNAL_G__CHECKCOLLISION_10_1_OFFSET UNITYSDK_OFFSET(0xD0CAB50)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSEARCHMAP__FILTERDISTANCEINTERNAL_G__INDEXTOSAMPLEGRIDPOS_10_0_OFFSET UNITYSDK_OFFSET(0xD0CAB20)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessBoardSearchMap_TypeDefinitionIndex = 79088;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(ChessBoardSearchMap_TypeDefinitionIndex)->GetStaticField(0x418F0);
		}
