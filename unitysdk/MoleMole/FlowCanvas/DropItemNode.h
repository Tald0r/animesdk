...
#define MOLEMOLE_FLOWCANVAS_DROPITEMNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xE0EA790)
#define MOLEMOLE_FLOWCANVAS_DROPITEMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE0EA800)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int DropItemNode_TypeDefinitionIndex = 41849;
