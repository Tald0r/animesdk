...
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE_CHECKNEEDAVOIDANCE_OFFSET UNITYSDK_OFFSET(0xA005920)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE_HANDLEINAVOIDANCEMOVE_OFFSET UNITYSDK_OFFSET(0xA005C60)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE_HANDLENORMALMOVE_OFFSET UNITYSDK_OFFSET(0xA005E80)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA0057C0)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA006180)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessHackEntityAvoidanceMoveNode_TypeDefinitionIndex = 77572;
