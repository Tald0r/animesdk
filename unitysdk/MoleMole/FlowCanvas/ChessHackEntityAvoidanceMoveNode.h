...
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE_CHECKNEEDAVOIDANCE_OFFSET UNITYSDK_OFFSET(0xCCD5E70)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE_HANDLEINAVOIDANCEMOVE_OFFSET UNITYSDK_OFFSET(0xCCD61B0)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE_HANDLENORMALMOVE_OFFSET UNITYSDK_OFFSET(0xCCD63D0)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xCCD5D10)
#define MOLEMOLE_FLOWCANVAS_CHESSHACKENTITYAVOIDANCEMOVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCCD66D0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessHackEntityAvoidanceMoveNode_TypeDefinitionIndex = 47318;
