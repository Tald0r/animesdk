...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE_ADVANCEINTERNAL_OFFSET UNITYSDK_OFFSET(0x82C30D0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE_ADVANCE_OFFSET UNITYSDK_OFFSET(0x82C2EA0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE_PAUSE_OFFSET UNITYSDK_OFFSET(0x82C2D80)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x82C2230)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE_RESUME_OFFSET UNITYSDK_OFFSET(0x82C2E10)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE_START_OFFSET UNITYSDK_OFFSET(0x82C26E0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x82C3560)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE__REGISTERPORTS_B__0_0_OFFSET UNITYSDK_OFFSET(0x82C3580)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE__REGISTERPORTS_B__0_1_OFFSET UNITYSDK_OFFSET(0x82C35B0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE__REGISTERPORTS_B__0_2_OFFSET UNITYSDK_OFFSET(0x82C3660)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE__REGISTERPORTS_B__0_3_OFFSET UNITYSDK_OFFSET(0x82C3710)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE__REGISTERPORTS_B__0_4_OFFSET UNITYSDK_OFFSET(0x82C3720)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE__REGISTERPORTS_B__0_5_OFFSET UNITYSDK_OFFSET(0x82C3730)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE__REGISTERPORTS_B__0_6_OFFSET UNITYSDK_OFFSET(0x82C3750)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE__REGISTERPORTS_B__0_7_OFFSET UNITYSDK_OFFSET(0x82C3760)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDMONSTERSPAWNERNODE__REGISTERPORTS_B__0_8_OFFSET UNITYSDK_OFFSET(0x82C3770)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardMonsterSpawnerNode_TypeDefinitionIndex = 57138;
	...
	public:
		...
		::System::String* _spawnSignalValue; // 0xC0
		::FlowCanvas::FlowOutput* _then; // 0xC8
		::FlowCanvas::ValueOutput_1<::System::Int32>* _curFrame; // 0xD0
		::FlowCanvas::FlowOutput* _finish; // 0xD8
		::Class_1_16EA9862B8D2E5C9* _spawner; // 0xE0
		::FlowCanvas::ValueInput_1<::System::Int32>* _feverGroupId; // 0xE8
		::FlowCanvas::FlowInput* _advance; // 0xF0
		::FlowCanvas::ValueOutput_1<::System::Collections::Generic::List_1<::System::Int32>*>* _TokenList; // 0xF8
		::FlowCanvas::FlowInput* _pause; // 0x100
		::FlowCanvas::FlowOutput* _update; // 0x108
		::FlowCanvas::ValueOutput_1<::System::String*>* _spawnSignal; // 0x110
		::FlowCanvas::FlowInput* _resume; // 0x118
		::FlowCanvas::ValueOutput_1<::System::Int32>* _totalFrame; // 0x120
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::HollowChessboard::HollowCell>*>* _cellMap; // 0x128
		::FlowCanvas::ValueInput_1<::System::Int32>* _peedRatio; // 0x130
		::System::Collections::Generic::List_1<::System::Int32>* _tokenList; // 0x138
		::FlowCanvas::ValueInput_1<::System::Int32>* _groupId; // 0x140
		::FlowCanvas::ValueInput_1<::System::String*>* _groupIndex; // 0x148
		::FlowCanvas::ValueOutput_1<::System::Collections::Generic::List_1<::System::UInt32>*>* _spawnerEntityList; // 0x150
		::System::Collections::Generic::List_1<::System::UInt32>* cacheSpawnerEntityList; // 0x158
		::System::Boolean finish; // 0x160
		::System::Boolean pause; // 0x161
		::System::Boolean start; // 0x162
		::System::Int32 _curTime; // 0x164
