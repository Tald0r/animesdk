...
#define MOLEMOLE_FLOWCANVAS_CHESSFIXHOLLOWCELLLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x141C9A10)
#define MOLEMOLE_FLOWCANVAS_CHESSFIXHOLLOWCELLLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x141C9B50)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessFixHollowCellList_TypeDefinitionIndex = 67850;
