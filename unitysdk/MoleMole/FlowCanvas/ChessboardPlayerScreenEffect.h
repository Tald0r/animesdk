...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT_GETEFFECTCONFIG_OFFSET UNITYSDK_OFFSET(0x8F6BC60)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x8F6B810)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x8F6BFA0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT_PROCESSSCREENEFFECT_OFFSET UNITYSDK_OFFSET(0x8F6BD20)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x8F6C000)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x8F6C090)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardPlayerScreenEffect_TypeDefinitionIndex = 40402;
