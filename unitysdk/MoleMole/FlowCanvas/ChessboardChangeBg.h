...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDCHANGEBG_CHANGEPIECECENTER_OFFSET UNITYSDK_OFFSET(0xEC6B8A0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDCHANGEBG_INVOKE_OFFSET UNITYSDK_OFFSET(0xEC6B240)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDCHANGEBG__CTOR_OFFSET UNITYSDK_OFFSET(0xEC6C0C0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardChangeBg_TypeDefinitionIndex = 56434;
