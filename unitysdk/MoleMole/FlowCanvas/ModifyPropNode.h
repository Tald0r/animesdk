...
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE_GETCONFIGMAXVAL_OFFSET UNITYSDK_OFFSET(0x11645BA0)
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x11645980)
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE_MODIFYPROP_OFFSET UNITYSDK_OFFSET(0x11645B30)
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x11645CF0)
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE_PROCESSHPDESC_OFFSET UNITYSDK_OFFSET(0x11645C80)
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE_PROCESSTEAMSTAMINA_OFFSET UNITYSDK_OFFSET(0x11645C10)
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x11645D60)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ModifyPropNode_TypeDefinitionIndex = 78085;
