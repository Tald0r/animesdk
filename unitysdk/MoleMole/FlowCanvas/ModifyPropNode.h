...
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE_GETCONFIGMAXVAL_OFFSET UNITYSDK_OFFSET(0x8AEEE50)
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x8AEEC30)
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE_MODIFYPROP_OFFSET UNITYSDK_OFFSET(0x8AEEDE0)
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x8AEEFA0)
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE_PROCESSHPDESC_OFFSET UNITYSDK_OFFSET(0x8AEEF30)
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE_PROCESSTEAMSTAMINA_OFFSET UNITYSDK_OFFSET(0x8AEEEC0)
#define MOLEMOLE_FLOWCANVAS_MODIFYPROPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x8AEF010)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ModifyPropNode_TypeDefinitionIndex = 42664;
