...
#define MOLEMOLE_FLOWCANVAS_CHESSFOCUSCAMERA_INVOKE_OFFSET UNITYSDK_OFFSET(0xE8650E0)
#define MOLEMOLE_FLOWCANVAS_CHESSFOCUSCAMERA_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xE865640)
#define MOLEMOLE_FLOWCANVAS_CHESSFOCUSCAMERA_TRYFOCUSINTERNAL_OFFSET UNITYSDK_OFFSET(0xE865930)
#define MOLEMOLE_FLOWCANVAS_CHESSFOCUSCAMERA_TRYFOCUS_OFFSET UNITYSDK_OFFSET(0xE8651B0)
#define MOLEMOLE_FLOWCANVAS_CHESSFOCUSCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xE865EB0)
#define MOLEMOLE_FLOWCANVAS_CHESSFOCUSCAMERA___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xE865F60)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessFocusCamera_TypeDefinitionIndex = 49585;
	...
	public:
		...
		static ::System::Boolean TryFocusInternal(::Enum_3_E2BB401879FE05E8 priority, ::MoleMole::UIHollowChessboard3DModelController* chessboardCtrl, ::Class_5_AF65C3A968E836D2* hollowChessboard, ::Class_2_21BB1EBBC5460F75* cameraController, ::Class_1_4780554EDDCA538F* focusCamera, ::Struct_2_AAD2B1B6FB741157& cameraStateHandle)
		{
			return ((::System::Boolean(*)(::Enum_3_E2BB401879FE05E8, ::MoleMole::UIHollowChessboard3DModelController*, ::Class_5_AF65C3A968E836D2*, ::Class_2_21BB1EBBC5460F75*, ::Class_1_4780554EDDCA538F*, ::Struct_2_AAD2B1B6FB741157&))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_CHESSFOCUSCAMERA_TRYFOCUSINTERNAL_OFFSET))(priority, chessboardCtrl, hollowChessboard, cameraController, focusCamera, cameraStateHandle);
		}
