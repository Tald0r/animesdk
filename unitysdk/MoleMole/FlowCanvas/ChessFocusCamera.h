...
#define MOLEMOLE_FLOWCANVAS_CHESSFOCUSCAMERA_INVOKE_OFFSET UNITYSDK_OFFSET(0xCD33FB0)
#define MOLEMOLE_FLOWCANVAS_CHESSFOCUSCAMERA_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xCD34510)
#define MOLEMOLE_FLOWCANVAS_CHESSFOCUSCAMERA_TRYFOCUSINTERNAL_OFFSET UNITYSDK_OFFSET(0xCD34800)
#define MOLEMOLE_FLOWCANVAS_CHESSFOCUSCAMERA_TRYFOCUS_OFFSET UNITYSDK_OFFSET(0xCD34080)
#define MOLEMOLE_FLOWCANVAS_CHESSFOCUSCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD34D90)
#define MOLEMOLE_FLOWCANVAS_CHESSFOCUSCAMERA___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xCD34E40)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessFocusCamera_TypeDefinitionIndex = 65459;
