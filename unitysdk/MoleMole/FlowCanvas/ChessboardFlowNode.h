...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDFLOWNODE_GET_CHESSPIECEDATA_OFFSET UNITYSDK_OFFSET(0x141C9D30)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDFLOWNODE_GET_CURRENTCHESSBOARD_OFFSET UNITYSDK_OFFSET(0x141C9C00)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDFLOWNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x141C9E60)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardFlowNode_TypeDefinitionIndex = 66605;
