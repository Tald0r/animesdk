...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDCAMERASHAKE_INVOKE_OFFSET UNITYSDK_OFFSET(0x8AEB020)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDCAMERASHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x8AEB220)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardCameraShake_TypeDefinitionIndex = 69008;
