...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECTBYTYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0xE0E9F10)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECTBYTYPE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xE0EA4D0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECTBYTYPE_PROCESSSCREENEFFECT_OFFSET UNITYSDK_OFFSET(0xE0E9FD0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECTBYTYPE_STOPEFFECT_OFFSET UNITYSDK_OFFSET(0xE0EA360)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECTBYTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0xE0EA6B0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDPLAYERSCREENEFFECTBYTYPE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xE0EA780)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessboardPlayerScreenEffectByType_TypeDefinitionIndex = 55784;
