...
#define MOLEMOLE_FLOWCANVAS_SUMINT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x82D4A40)
#define MOLEMOLE_FLOWCANVAS_SUMINT__CTOR_OFFSET UNITYSDK_OFFSET(0x82D4CF0)
#define MOLEMOLE_FLOWCANVAS_SUMINT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x82D4D10)
#define MOLEMOLE_FLOWCANVAS_SUMINT__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x82D4D20)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int SumInt_TypeDefinitionIndex = 51998;
