...
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT_CLEAR_OFFSET UNITYSDK_OFFSET(0xE0EB1C0)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xE0EB150)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE0EB000)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT_TRYSWITCH_OFFSET UNITYSDK_OFFSET(0xE0EB2B0)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xE0EB610)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0xE0EB630)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT__REGISTERPORTS_B__1_1_OFFSET UNITYSDK_OFFSET(0xE0EB680)
#define MOLEMOLE_FLOWCANVAS_HACKERSWITCHNAPEFFECT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xE0EB690)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerSwitchNapEffect_TypeDefinitionIndex = 41763;
	...
	public:
		...
		::System::String* lastPlayKey; // 0xB0
