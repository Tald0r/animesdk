...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEDAMAGESTATISTICS_INVOKE_OFFSET UNITYSDK_OFFSET(0x141CD340)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEDAMAGESTATISTICS__CTOR_OFFSET UNITYSDK_OFFSET(0x141CD580)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameUpdateDamageStatistics_TypeDefinitionIndex = 38491;
