...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEDAMAGESTATISTICS_INVOKE_OFFSET UNITYSDK_OFFSET(0xA4F34D0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEDAMAGESTATISTICS__CTOR_OFFSET UNITYSDK_OFFSET(0xA4F3710)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameUpdateDamageStatistics_TypeDefinitionIndex = 75169;
