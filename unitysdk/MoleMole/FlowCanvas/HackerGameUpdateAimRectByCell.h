...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEAIMRECTBYCELL_INVOKE_OFFSET UNITYSDK_OFFSET(0xC9BAC90)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEAIMRECTBYCELL_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xC9BADC0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEAIMRECTBYCELL__CTOR_OFFSET UNITYSDK_OFFSET(0xC9BAE60)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMEUPDATEAIMRECTBYCELL___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xC9BAEF0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameUpdateAimRectByCell_TypeDefinitionIndex = 68305;
