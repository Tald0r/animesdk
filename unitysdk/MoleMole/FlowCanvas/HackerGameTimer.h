...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_PAUSE_OFFSET UNITYSDK_OFFSET(0x8F6CEA0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8F6CBC0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_RESUME_OFFSET UNITYSDK_OFFSET(0x8F6CE10)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_START_OFFSET UNITYSDK_OFFSET(0x8F6CF30)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER_UPDATE_OFFSET UNITYSDK_OFFSET(0x8F6CFC0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F6D090)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_0_OFFSET UNITYSDK_OFFSET(0x8F6D0B0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_1_OFFSET UNITYSDK_OFFSET(0x8F6D170)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_2_OFFSET UNITYSDK_OFFSET(0x8F6D220)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_3_OFFSET UNITYSDK_OFFSET(0x8F6D2D0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_4_OFFSET UNITYSDK_OFFSET(0x8F6D2E0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMETIMER__REGISTERPORTS_B__0_5_OFFSET UNITYSDK_OFFSET(0x8F6D300)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameTimer_TypeDefinitionIndex = 47795;

	class HackerGameTimer : public ::FlowCanvas::FlowNode
	{
	public:
		::FlowCanvas::ValueOutput_1<::System::Int32>* _totalTimeOutputInt32; // 0xA8
		::FlowCanvas::ValueOutput_1<::System::Single>* _deltaTimeFloat; // 0xB0
		::FlowCanvas::FlowInput* _start; // 0xB8
		::FlowCanvas::FlowOutput* _advance; // 0xC0
		::FlowCanvas::ValueOutput_1<::System::Single>* _totalTimeOutput; // 0xC8
		::FlowCanvas::FlowInput* _resume; // 0xD0
