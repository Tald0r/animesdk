...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0xD0D0BC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_CHECKFINISH_OFFSET UNITYSDK_OFFSET(0xD0D22A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_CHECKHIGHTOLOW_OFFSET UNITYSDK_OFFSET(0xD0D2D80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_CHECKLOWTOHIGH_OFFSET UNITYSDK_OFFSET(0xD0D2B80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_CHECKSTARTVALUE_OFFSET UNITYSDK_OFFSET(0xD0D1EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_GETLOCALAVATARHPPERCENT_OFFSET UNITYSDK_OFFSET(0xD0D15F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_GETTEAMHPPERCENT_OFFSET UNITYSDK_OFFSET(0xD0D1BE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_INITLOACLAVATARDATA_OFFSET UNITYSDK_OFFSET(0xD0D1390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_INITTEAMDATA_OFFSET UNITYSDK_OFFSET(0xD0D1820)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xD0D24C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xD0D0B50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xD0D0DE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_ONLOCALAVATARCHANGE_OFFSET UNITYSDK_OFFSET(0xD0D2550)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xD0D0900)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_START_OFFSET UNITYSDK_OFFSET(0xD0D1070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_STOP_OFFSET UNITYSDK_OFFSET(0xD0D2440)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0xD0D0E50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE_UPDATE_OFFSET UNITYSDK_OFFSET(0xD0D2890)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0D2F80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE__REGISTERPORTS_B__21_0_OFFSET UNITYSDK_OFFSET(0xD0D2FA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xD0D2FD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENAVATARNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xD0D2FE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenAvatarNode_TypeDefinitionIndex = 55513;

	class LDListenAvatarNode : public ::FlowCanvas::FlowNode
	{
	public:
		// static const ::System::Single tickSpan; // 0x0
		::System::Collections::Generic::List_1<::Class_3_F25C0BD4B2C92757*>* aliveStateList; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Single>* lowToHighInput; // 0xB0
		::FlowCanvas::ValueInput_1<::System::Single>* highToLowInput; // 0xB8
		::FlowCanvas::FlowInput* flowIn; // 0xC0
		::FlowCanvas::FlowOutput* reachedHighToLowOutput; // 0xC8
		::Class_3_F25C0BD4B2C92757* aliveStateComponent; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Int32>* lowToHighTriggerCountInput; // 0xD8
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::LDListenAvatarNode_ListenAvatarTargetType>* listenTypeInput; // 0xE0
		::Class_3_F97B015544BE936B* localAvatarData; // 0xE8
		::FlowCanvas::FlowOutput* reachedLowToHighOutput; // 0xF0
		::FlowCanvas::ValueInput_1<::System::Int32>* highToLowTriggerCountInput; // 0xF8
		::System::Collections::Generic::List_1<::Class_3_F97B015544BE936B*>* teamDataList; // 0x100
		::FlowCanvas::FlowOutput* flowOut; // 0x108
		::System::Int32 lowToHightTriggerCnt; // 0x110
		::System::Single tickDelta; // 0x114
		::System::Boolean isStart; // 0x118
		::System::Boolean bindEvent; // 0x119
		::System::Single lastHpPercent; // 0x11C
		::System::Int32 highToLowTriggerCnt; // 0x120
