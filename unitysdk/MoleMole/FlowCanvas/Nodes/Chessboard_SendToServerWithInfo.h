...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARD_SENDTOSERVERWITHINFO_INVOKE_OFFSET UNITYSDK_OFFSET(0x7A50780)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARD_SENDTOSERVERWITHINFO_MODIFYPLAYERPOS_OFFSET UNITYSDK_OFFSET(0x7A50920)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARD_SENDTOSERVERWITHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x7A50D30)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int Chessboard_SendToServerWithInfo_TypeDefinitionIndex = 63085;
