...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARD_SENDTOSERVERWITHINFO_INVOKE_OFFSET UNITYSDK_OFFSET(0xE0EBB10)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARD_SENDTOSERVERWITHINFO_MODIFYPLAYERPOS_OFFSET UNITYSDK_OFFSET(0xE0EBCB0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARD_SENDTOSERVERWITHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xE0EC0D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int Chessboard_SendToServerWithInfo_TypeDefinitionIndex = 52088;
