...
#define MOLEMOLE_FLOWCANVAS_NODES_LDENTERSIDESCROLLINGCAMERAMODEV2___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0xE0EFDD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENTERSIDESCROLLINGCAMERAMODEV2___C__DISPLAYCLASS7_0__HANDLEFLOWINPUT_B__0_OFFSET UNITYSDK_OFFSET(0xE0EFDE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDEnterSideScrollingCameraModeV2___c__DisplayClass7_0_TypeDefinitionIndex = 56454;
