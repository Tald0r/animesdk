...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWGETINDEXBYDIR_INVOKE_OFFSET UNITYSDK_OFFSET(0x6AD9A40)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWGETINDEXBYDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x6AD9E20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowGetIndexByDir_TypeDefinitionIndex = 64867;
