...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWGETINDEXBYDIR_INVOKE_OFFSET UNITYSDK_OFFSET(0xB5C8CF0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWGETINDEXBYDIR__CTOR_OFFSET UNITYSDK_OFFSET(0xB5C90D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowGetIndexByDir_TypeDefinitionIndex = 58640;
