...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETALLLOCALAVATARNODE_GETLOCALAVATARLIST_OFFSET UNITYSDK_OFFSET(0x8F6FF20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETALLLOCALAVATARNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8F70190)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETALLLOCALAVATARNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F70260)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetAllLocalAvatarNode_TypeDefinitionIndex = 47060;
