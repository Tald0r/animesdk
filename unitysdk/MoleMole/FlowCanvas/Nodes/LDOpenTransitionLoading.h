...
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENTRANSITIONLOADING_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA5E8D00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENTRANSITIONLOADING__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E8EA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENTRANSITIONLOADING__ONSTARTCOMPLETE_OFFSET UNITYSDK_OFFSET(0xA5E8E10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENTRANSITIONLOADING__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xA5E8EC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDOpenTransitionLoading_TypeDefinitionIndex = 61925;
