...
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENTRANSITIONLOADING_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA7D2B10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENTRANSITIONLOADING__CTOR_OFFSET UNITYSDK_OFFSET(0xA7D2CB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENTRANSITIONLOADING__ONSTARTCOMPLETE_OFFSET UNITYSDK_OFFSET(0xA7D2C20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENTRANSITIONLOADING__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xA7D2CD0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDOpenTransitionLoading_TypeDefinitionIndex = 55319;
