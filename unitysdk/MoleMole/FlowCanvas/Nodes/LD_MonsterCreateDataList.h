...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0xC2CC140)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC2CC160)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0xC2CC150)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST__CTOR_OFFSET UNITYSDK_OFFSET(0xC2CC380)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0xC2CC420)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0xC2CC460)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_MonsterCreateDataList_TypeDefinitionIndex = 40489;
