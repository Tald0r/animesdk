...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0xB8A7BE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB8A7C00)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0xB8A7BF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A7E20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0xB8A7EC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCREATEDATALIST__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0xB8A7F00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_MonsterCreateDataList_TypeDefinitionIndex = 69494;

	class LD_MonsterCreateDataList : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* _output; // 0xA8
		::System::Collections::Generic::List_1<::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::MonsterCreateData*>*>* values; // 0xB0
