...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKTIMER_BEIGIN_OFFSET UNITYSDK_OFFSET(0xC216F60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKTIMER_BREAK_OFFSET UNITYSDK_OFFSET(0xC217140)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKTIMER_CHECKMONSTERNUMBER_OFFSET UNITYSDK_OFFSET(0xC216810)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKTIMER_COMPAREMONSTERCAMP_OFFSET UNITYSDK_OFFSET(0xC2165D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKTIMER_INTERNALCOROUTINE_OFFSET UNITYSDK_OFFSET(0xC217070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKTIMER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC215E50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKTIMER_SELECTMONSTERBYCAMP_OFFSET UNITYSDK_OFFSET(0xC216180)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0xC217230)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKTIMER__REGISTERPORTS_B__20_0_OFFSET UNITYSDK_OFFSET(0xC2172A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKTIMER__REGISTERPORTS_B__20_1_OFFSET UNITYSDK_OFFSET(0xC2172D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKTIMER__REGISTERPORTS_B__20_2_OFFSET UNITYSDK_OFFSET(0xC217300)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKTIMER__REGISTERPORTS_B__20_3_OFFSET UNITYSDK_OFFSET(0xC217330)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKTIMER__REGISTERPORTS_B__20_4_OFFSET UNITYSDK_OFFSET(0xC217340)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMonsterLeftCheckTimer_TypeDefinitionIndex = 71263;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::EntitySaveDataMap*>* dataMapInput; // 0xB8
		::FlowCanvas::ValueInput_1<::System::Boolean>* allMonsterInput; // 0xC0
		::FlowCanvas::ValueOutput_1<::System::Single>* currTimeOutPut; // 0xC8
		::FlowCanvas::ValueInput_1<::System::Single>* timeInput; // 0xD0
		::FlowCanvas::ValueOutput_1<::System::Single>* normaliezedOutPut; // 0xD8
		::FlowCanvas::FlowOutput* trueOutPut; // 0xE0
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::NumberCompareType>* compareTypeInput; // 0xE8
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* monsterList; // 0xF0
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::MonsterPickType>* monsterCampInput; // 0xF8
		...
		::FlowCanvas::FlowInput* breakInput; // 0x118
		::System::Single normalized; // 0x120
		::System::Single curTickTime; // 0x124
		::System::Boolean isStart; // 0x128
		::System::Boolean finish; // 0x129
		::System::Single tickStart; // 0x12C
