...
#define MOLEMOLE_FLOWCANVAS_NODES_BANDTRAPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xF19D620)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int BandTrapData_TypeDefinitionIndex = 62286;
