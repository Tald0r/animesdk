...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_ISMONSTER_OFFSET UNITYSDK_OFFSET(0xE868D50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_ONEVTKILLED_OFFSET UNITYSDK_OFFSET(0xE868960)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xE869130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xE868EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE868820)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED__CTOR_OFFSET UNITYSDK_OFFSET(0xE869200)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0xE869250)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0xE869260)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xE869270)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xE869280)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCoinBrushingListenMonsterBeKilled_TypeDefinitionIndex = 45080;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::GameplayTag>* _emptyTags; // 0xB8
