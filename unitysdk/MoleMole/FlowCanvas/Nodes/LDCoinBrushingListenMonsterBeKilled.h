...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_ISMONSTER_OFFSET UNITYSDK_OFFSET(0xCD37C40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_ONEVTKILLED_OFFSET UNITYSDK_OFFSET(0xCD37850)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xCD38020)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xCD37DD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xCD37710)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED__CTOR_OFFSET UNITYSDK_OFFSET(0xCD380F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0xCD38140)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0xCD38150)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xCD38160)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGLISTENMONSTERBEKILLED___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xCD38170)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCoinBrushingListenMonsterBeKilled_TypeDefinitionIndex = 71080;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::GameplayTag>* _killedEntityTags; // 0xB0
		::FlowCanvas::FlowOutput* _onMonsterKilled; // 0xB8
		::MoleMole::Battle::Entity* _killedEntity; // 0xC0
		::System::Collections::Generic::List_1<::MoleMole::GameplayTag>* _emptyTags; // 0xC8
