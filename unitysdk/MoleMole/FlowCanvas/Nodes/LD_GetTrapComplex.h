...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTRAPCOMPLEX_INVOKE_OFFSET UNITYSDK_OFFSET(0xB8A6D70)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTRAPCOMPLEX__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A6EA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_GetTrapComplex_TypeDefinitionIndex = 56945;
