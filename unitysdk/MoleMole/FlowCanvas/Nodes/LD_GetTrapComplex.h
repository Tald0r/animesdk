...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTRAPCOMPLEX_INVOKE_OFFSET UNITYSDK_OFFSET(0xC2CB2D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTRAPCOMPLEX__CTOR_OFFSET UNITYSDK_OFFSET(0xC2CB400)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_GetTrapComplex_TypeDefinitionIndex = 37172;
