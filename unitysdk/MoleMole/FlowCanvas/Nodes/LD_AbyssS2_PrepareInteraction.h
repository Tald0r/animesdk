...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_PREPAREINTERACTION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA7D55E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_PREPAREINTERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA7D56E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_PREPAREINTERACTION__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xA7D5700)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_PrepareInteraction_TypeDefinitionIndex = 65366;
