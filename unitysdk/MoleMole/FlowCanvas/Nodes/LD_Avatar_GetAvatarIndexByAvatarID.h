...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARINDEXBYAVATARID_GETAVATARINDEXBYAVATARID_OFFSET UNITYSDK_OFFSET(0xA38C7B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARINDEXBYAVATARID_INVOKE_OFFSET UNITYSDK_OFFSET(0xA38C740)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARINDEXBYAVATARID__CTOR_OFFSET UNITYSDK_OFFSET(0xA38CBA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_Avatar_GetAvatarIndexByAvatarID_TypeDefinitionIndex = 72295;
