...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCAMERASTATENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x82C6E40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCAMERASTATENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x82C71C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCameraStateNode_TypeDefinitionIndex = 58146;
