...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HASCHALLENGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA5EE4E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HASCHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA5EE740)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HASCHALLENGE__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0xA5EE760)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_HasChallenge_TypeDefinitionIndex = 67136;
