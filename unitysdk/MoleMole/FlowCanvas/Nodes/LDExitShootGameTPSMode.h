...
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITSHOOTGAMETPSMODE_PROCESS_OFFSET UNITYSDK_OFFSET(0xD0CF410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITSHOOTGAMETPSMODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xD0CF330)
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITSHOOTGAMETPSMODE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0CF580)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDExitShootGameTPSMode_TypeDefinitionIndex = 50136;
