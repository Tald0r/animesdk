...
#define MOLEMOLE_FLOWCANVAS_NODES_LDFAILBACKCHECKPOINT_ISFAILBACK_OFFSET UNITYSDK_OFFSET(0xA5E44A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDFAILBACKCHECKPOINT_PARSEREXPRESSION_OFFSET UNITYSDK_OFFSET(0xA5E4500)
#define MOLEMOLE_FLOWCANVAS_NODES_LDFAILBACKCHECKPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E46D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDFAILBACKCHECKPOINT___BASE_ISFAILBACK_OFFSET UNITYSDK_OFFSET(0xA5E4730)
#define MOLEMOLE_FLOWCANVAS_NODES_LDFAILBACKCHECKPOINT___BASE_PARSEREXPRESSION_OFFSET UNITYSDK_OFFSET(0xA5E4790)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDFailBackCheckPoint_TypeDefinitionIndex = 44358;
