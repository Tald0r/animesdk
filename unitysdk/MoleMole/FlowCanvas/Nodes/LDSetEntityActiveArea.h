...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETENTITYACTIVEAREA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB982730)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETENTITYACTIVEAREA_START_OFFSET UNITYSDK_OFFSET(0xB982860)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETENTITYACTIVEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xB982EF0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetEntityActiveArea_TypeDefinitionIndex = 67192;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::MoleMole::EntityHandle>* handleInput; // 0xB8
