...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETENTITYACTIVEAREA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xF1A87F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETENTITYACTIVEAREA_START_OFFSET UNITYSDK_OFFSET(0xF1A8920)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETENTITYACTIVEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xF1A8FB0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetEntityActiveArea_TypeDefinitionIndex = 39792;
