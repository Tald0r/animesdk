...
#define MOLEMOLE_FLOWCANVAS_NODES_SETANIMATORTRIGGER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB18F660)
#define MOLEMOLE_FLOWCANVAS_NODES_SETANIMATORTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xB18F790)
#define MOLEMOLE_FLOWCANVAS_NODES_SETANIMATORTRIGGER__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0xB18F7B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int SetAnimatorTrigger_TypeDefinitionIndex = 69638;
