...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYPOSITONANDROTATION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE0F06A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYPOSITONANDROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0xE0F0830)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYPOSITONANDROTATION__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xE0F0850)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYPOSITONANDROTATION__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0xE0F0B00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYPOSITONANDROTATION__REGISTERPORTS_B__4_2_OFFSET UNITYSDK_OFFSET(0xE0F0B20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetEntityPositonAndRotation_TypeDefinitionIndex = 51977;
