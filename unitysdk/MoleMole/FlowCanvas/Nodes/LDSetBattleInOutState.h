...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETBATTLEINOUTSTATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xB8A28C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETBATTLEINOUTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A2AB0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetBattleInOutState_TypeDefinitionIndex = 64268;
