...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETBATTLEINOUTSTATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xC2C6DF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETBATTLEINOUTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2C6FE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetBattleInOutState_TypeDefinitionIndex = 76873;
