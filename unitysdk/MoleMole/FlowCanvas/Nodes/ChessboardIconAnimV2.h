...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2_CHECKRENDERSTATEENABLE_OFFSET UNITYSDK_OFFSET(0x141CF5E0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2_GET_RENDERDATAHANDLELIST_OFFSET UNITYSDK_OFFSET(0x141CF4A0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2_INVOKE_OFFSET UNITYSDK_OFFSET(0x141CF910)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2__CTOR_OFFSET UNITYSDK_OFFSET(0x141CFDE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardIconAnimV2_TypeDefinitionIndex = 69086;
