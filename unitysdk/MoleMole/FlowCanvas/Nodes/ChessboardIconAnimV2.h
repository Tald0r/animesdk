...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2_CHECKRENDERSTATEENABLE_OFFSET UNITYSDK_OFFSET(0xA4F5770)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2_GET_RENDERDATAHANDLELIST_OFFSET UNITYSDK_OFFSET(0xA4F5630)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2_INVOKE_OFFSET UNITYSDK_OFFSET(0xA4F5AA0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2__CTOR_OFFSET UNITYSDK_OFFSET(0xA4F5F70)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardIconAnimV2_TypeDefinitionIndex = 71568;
