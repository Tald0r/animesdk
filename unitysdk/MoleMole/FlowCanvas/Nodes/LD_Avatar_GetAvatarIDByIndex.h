...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARIDBYINDEX_GETAVATARIDBYINDEX_OFFSET UNITYSDK_OFFSET(0xC2CAC80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARIDBYINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0xC2CAC10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_GETAVATARIDBYINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xC2CAF00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_Avatar_GetAvatarIDByIndex_TypeDefinitionIndex = 40530;
