...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0xCD4B170)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_BEGIN_OFFSET UNITYSDK_OFFSET(0xCD4B8A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xCD4C080)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xCD4A4D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_SEARCHANCHORBYPREFIX_OFFSET UNITYSDK_OFFSET(0xCD4AFC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xCD4A9B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD4C2C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0xCD4C390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0xCD4C3D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_2_OFFSET UNITYSDK_OFFSET(0xCD4C4C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_3_OFFSET UNITYSDK_OFFSET(0xCD4C4F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_4_OFFSET UNITYSDK_OFFSET(0xCD4C500)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_5_OFFSET UNITYSDK_OFFSET(0xCD4C510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0xCD4C560)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0xCD4C520)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xCD4C600)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xCD4C610)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xCD4C550)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonsterPosRandom_TypeDefinitionIndex = 63068;
	...
	public:
		...
		::Class_3_F35B080B137ECC46* inputModelComponent; // 0x1B8
		...
		::System::Collections::Generic::HashSet_1<::System::Int32>* alreadySearchedSet; // 0x1D0
		::FlowCanvas::ValueInput_1<::System::Single>* minimumRadiusInput; // 0x1D8
