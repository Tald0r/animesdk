...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0xE87C5D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_BEGIN_OFFSET UNITYSDK_OFFSET(0xE87CD10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xE87D500)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE87B930)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_SEARCHANCHORBYPREFIX_OFFSET UNITYSDK_OFFSET(0xE87C420)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xE87BE10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0xE87D740)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0xE87D810)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0xE87D850)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_2_OFFSET UNITYSDK_OFFSET(0xE87D940)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_3_OFFSET UNITYSDK_OFFSET(0xE87D970)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_4_OFFSET UNITYSDK_OFFSET(0xE87D980)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM__REGISTERPORTS_B__8_5_OFFSET UNITYSDK_OFFSET(0xE87D990)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0xE87D9E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0xE87D9A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xE87DA80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE87DA90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERPOSRANDOM___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xE87D9D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonsterPosRandom_TypeDefinitionIndex = 45755;
	...
	public:
		...
		::Class_3_F35B080B137ECC46* inputModelComponent; // 0x1D8
