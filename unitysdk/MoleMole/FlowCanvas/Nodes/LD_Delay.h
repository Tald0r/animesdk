...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA507230)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY__CTOR_OFFSET UNITYSDK_OFFSET(0xA507430)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xA507450)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY__WAITTIMEOUT_OFFSET UNITYSDK_OFFSET(0xA507340)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_Delay_TypeDefinitionIndex = 45023;
