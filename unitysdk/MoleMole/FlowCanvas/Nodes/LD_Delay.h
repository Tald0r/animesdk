...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x990C3F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x990C5F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x990C610)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DELAY__WAITTIMEOUT_OFFSET UNITYSDK_OFFSET(0x990C500)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_Delay_TypeDefinitionIndex = 47423;
