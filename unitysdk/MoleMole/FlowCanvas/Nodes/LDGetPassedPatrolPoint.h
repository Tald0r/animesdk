...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x6E17AD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x6E17EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x6E17CA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_ONNODETASKFINISH_OFFSET UNITYSDK_OFFSET(0x6E18270)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_ONPASSWAYPOINT_OFFSET UNITYSDK_OFFSET(0x6E181B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6E17600)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_STARTLISTEN_OFFSET UNITYSDK_OFFSET(0x6E17800)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x6E17D20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x6E182F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x6E18320)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT__REGISTERPORTS_B__11_1_OFFSET UNITYSDK_OFFSET(0x6E18330)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPASSEDPATROLPOINT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x6E18340)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetPassedPatrolPoint_TypeDefinitionIndex = 36909;

	class LDGetPassedPatrolPoint : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::System::String* currentWayPoint; // 0xA8
		::FlowCanvas::ValueOutput_1<::System::String*>* waypathNameOutput; // 0xB0
		::FlowCanvas::FlowInput* inputPort; // 0xB8
		::FlowCanvas::ValueOutput_1<::System::String*>* waypointOutput; // 0xC0
		::FlowCanvas::FlowOutput* outputPort; // 0xC8
		::FlowCanvas::FlowOutput* wayPointArrivePort; // 0xD0
		::System::String* currentWay; // 0xD8
