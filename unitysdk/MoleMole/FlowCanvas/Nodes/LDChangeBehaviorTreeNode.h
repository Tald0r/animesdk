...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA5E3960)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE_ISCOULDOUTCALL_OFFSET UNITYSDK_OFFSET(0xA5E3BC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E3C30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE__INVOKE_B__0_0_OFFSET UNITYSDK_OFFSET(0xA5E3C50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE___BASE_ISCOULDOUTCALL_OFFSET UNITYSDK_OFFSET(0xA5E3C60)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDChangeBehaviorTreeNode_TypeDefinitionIndex = 68282;
