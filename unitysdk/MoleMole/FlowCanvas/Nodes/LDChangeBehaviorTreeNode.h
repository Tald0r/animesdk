...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA7CD790)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE_ISCOULDOUTCALL_OFFSET UNITYSDK_OFFSET(0xA7CD9F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA7CDA60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE__INVOKE_B__0_0_OFFSET UNITYSDK_OFFSET(0xA7CDA80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEBEHAVIORTREENODE___BASE_ISCOULDOUTCALL_OFFSET UNITYSDK_OFFSET(0xA7CDA90)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDChangeBehaviorTreeNode_TypeDefinitionIndex = 75829;
