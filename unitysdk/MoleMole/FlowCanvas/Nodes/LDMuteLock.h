...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMUTELOCK_INVOKE_OFFSET UNITYSDK_OFFSET(0x8AF6B50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMUTELOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x8AF7060)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMuteLock_TypeDefinitionIndex = 63024;
