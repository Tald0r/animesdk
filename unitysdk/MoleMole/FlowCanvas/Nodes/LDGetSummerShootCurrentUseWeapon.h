...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETSUMMERSHOOTCURRENTUSEWEAPON_GETSUMMEREVENTSHOOTWEAPONKEY_OFFSET UNITYSDK_OFFSET(0xBA02450)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETSUMMERSHOOTCURRENTUSEWEAPON_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xBA02380)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETSUMMERSHOOTCURRENTUSEWEAPON__CTOR_OFFSET UNITYSDK_OFFSET(0xBA02540)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetSummerShootCurrentUseWeapon_TypeDefinitionIndex = 48957;
