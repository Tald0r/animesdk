...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETSUMMERSHOOTCURRENTUSEWEAPON_GETSUMMEREVENTSHOOTWEAPONKEY_OFFSET UNITYSDK_OFFSET(0xC9BDA60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETSUMMERSHOOTCURRENTUSEWEAPON_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC9BD990)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETSUMMERSHOOTCURRENTUSEWEAPON__CTOR_OFFSET UNITYSDK_OFFSET(0xC9BDB50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetSummerShootCurrentUseWeapon_TypeDefinitionIndex = 63171;
