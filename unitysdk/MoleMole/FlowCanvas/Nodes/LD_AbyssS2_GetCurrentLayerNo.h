...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETCURRENTLAYERNO_INVOKE_OFFSET UNITYSDK_OFFSET(0xC21DEA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETCURRENTLAYERNO__CTOR_OFFSET UNITYSDK_OFFSET(0xC21E050)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_GetCurrentLayerNo_TypeDefinitionIndex = 65343;
