...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETIP_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA7CDAA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETIP__CTOR_OFFSET UNITYSDK_OFFSET(0xA7CDC20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETIP__GETCREATEDTIPOBJECT_OFFSET UNITYSDK_OFFSET(0xA7CDBB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETIP__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xA7CDC40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCloseTip_TypeDefinitionIndex = 50773;
