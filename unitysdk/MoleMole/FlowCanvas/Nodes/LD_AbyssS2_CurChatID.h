...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CURCHATID_INVOKE_OFFSET UNITYSDK_OFFSET(0x82D1310)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CURCHATID__CTOR_OFFSET UNITYSDK_OFFSET(0x82D13C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_CurChatID_TypeDefinitionIndex = 67519;
