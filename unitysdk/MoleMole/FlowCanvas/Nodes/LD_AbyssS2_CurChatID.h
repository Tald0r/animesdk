...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CURCHATID_INVOKE_OFFSET UNITYSDK_OFFSET(0xA38B550)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CURCHATID__CTOR_OFFSET UNITYSDK_OFFSET(0xA38B600)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_CurChatID_TypeDefinitionIndex = 68192;
