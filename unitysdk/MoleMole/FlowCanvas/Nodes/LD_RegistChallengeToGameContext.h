...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REGISTCHALLENGETOGAMECONTEXT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA508C30)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REGISTCHALLENGETOGAMECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA508D60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REGISTCHALLENGETOGAMECONTEXT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xA508D80)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_RegistChallengeToGameContext_TypeDefinitionIndex = 50933;

	class LD_RegistChallengeToGameContext : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::ChallengeQuestType>* ChallengeQuestType; // 0xA8
