...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0xEC80140)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xEC80090)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xEC804F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0xEC806A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER___BASE_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0xEC806B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xEC806C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTER___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xEC806D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDRandomWaveMonster_TypeDefinitionIndex = 46373;
