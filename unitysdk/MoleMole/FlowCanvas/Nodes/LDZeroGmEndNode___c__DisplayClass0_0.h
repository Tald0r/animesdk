...
#define MOLEMOLE_FLOWCANVAS_NODES_LDZEROGMENDNODE___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0xF1ADDF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDZEROGMENDNODE___C__DISPLAYCLASS0_0__INVOKE_B__0_OFFSET UNITYSDK_OFFSET(0xF1ADE00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDZeroGmEndNode___c__DisplayClass0_0_TypeDefinitionIndex = 73314;
