...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSWITCHGAMEWEATHERANDTIME_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xEC83610)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSWITCHGAMEWEATHERANDTIME_START_OFFSET UNITYSDK_OFFSET(0xEC837A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSWITCHGAMEWEATHERANDTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xEC83B60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSWITCHGAMEWEATHERANDTIME__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xEC83B80)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSwitchGameWeatherAndTime_TypeDefinitionIndex = 77229;
