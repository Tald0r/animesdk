...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYCUSTOMCAMERASEQUENCE__CLEARWHENGAMEEND_D__12_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x310620)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYCUSTOMCAMERASEQUENCE__CLEARWHENGAMEEND_D__12_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPlayCustomCameraSequence__ClearWhenGameEnd_d__12_TypeDefinitionIndex = 61487;
	...
	struct alignas(8) LDPlayCustomCameraSequence__ClearWhenGameEnd_d__12
	{
		...
		::System::WeakReference_1<::Class_0_16E4307DCC419505_199*>* performer; // 0x30
