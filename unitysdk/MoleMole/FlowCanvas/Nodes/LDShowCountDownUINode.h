...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_BEGIN_OFFSET UNITYSDK_OFFSET(0xB984070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_CLOSE_OFFSET UNITYSDK_OFFSET(0xB983A50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0xB984600)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_FAIL_OFFSET UNITYSDK_OFFSET(0xB983890)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB9830E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xB9831F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xB983260)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_PAUSECOUNTDOWNUI_OFFSET UNITYSDK_OFFSET(0xB984960)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_PAUSE_OFFSET UNITYSDK_OFFSET(0xB984BF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB9832F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_RESTART_OFFSET UNITYSDK_OFFSET(0xB9846D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_RESUME_OFFSET UNITYSDK_OFFSET(0xB984CA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_SHOWCOUNTDOWNUI_OFFSET UNITYSDK_OFFSET(0xB983B10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE_SUCCESS_OFFSET UNITYSDK_OFFSET(0xB9836D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB984D40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE__REGISTERPORTS_B__18_0_OFFSET UNITYSDK_OFFSET(0xB984D60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE__REGISTERPORTS_B__18_1_OFFSET UNITYSDK_OFFSET(0xB984D90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE__REGISTERPORTS_B__18_2_OFFSET UNITYSDK_OFFSET(0xB984DD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE__SETREMAIN_OFFSET UNITYSDK_OFFSET(0xB984500)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE___BASE_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB984E80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xB984E90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWCOUNTDOWNUINODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xB984EA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowCountDownUINode_TypeDefinitionIndex = 41141;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Single>* totalDuration; // 0xB8
		::FlowCanvas::ValueInput_1<::System::String*>* linkTimerKey; // 0xC0
		::FlowCanvas::FlowOutput* update; // 0xC8
		::FlowCanvas::FlowOutput* finish; // 0xD0
		::Class_1_8289F2785D9AA990* timer; // 0xD8
		::FlowCanvas::ValueInput_1<::System::Single>* resetRemainTime; // 0xE0
