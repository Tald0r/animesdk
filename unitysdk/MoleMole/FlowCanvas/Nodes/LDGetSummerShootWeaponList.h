...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETSUMMERSHOOTWEAPONLIST_GETWEAPONLIST_OFFSET UNITYSDK_OFFSET(0x7A56200)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETSUMMERSHOOTWEAPONLIST_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7A56130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETSUMMERSHOOTWEAPONLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x7A56330)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetSummerShootWeaponList_TypeDefinitionIndex = 47564;
