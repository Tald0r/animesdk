...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0xCD469F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_BEGIN_OFFSET UNITYSDK_OFFSET(0xCD49E60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_BUILDCREATEVALUES_OFFSET UNITYSDK_OFFSET(0xCD45C90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0xCD45910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_GETCENTERANCHORNAME_OFFSET UNITYSDK_OFFSET(0xCD46EE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0xCD499E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0xCD46E30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_ISSPAWNPOINTINEXCLUDEREGION_OFFSET UNITYSDK_OFFSET(0xCD48980)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xCD454C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_SEARCHACHORBYPREFIX_OFFSET UNITYSDK_OFFSET(0xCD47B90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_SEARCHMONSTERSPAWNERPOINT_OFFSET UNITYSDK_OFFSET(0xCD47450)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_SEARCHVALIDPOINTBYDISTANCEANDANGLE_OFFSET UNITYSDK_OFFSET(0xCD49460)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_STARTSPAWN_OFFSET UNITYSDK_OFFSET(0xCD49A60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xCD49F20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_WRAPANGLERANGE_OFFSET UNITYSDK_OFFSET(0xCD49370)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__CTOR_OFFSET UNITYSDK_OFFSET(0xCD4A160)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__REGISTERPORTS_B__10_0_OFFSET UNITYSDK_OFFSET(0xCD4A180)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__REGISTERPORTS_B__10_1_OFFSET UNITYSDK_OFFSET(0xCD4A260)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__REGISTERPORTS_B__10_2_OFFSET UNITYSDK_OFFSET(0xCD4A350)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__REGISTERPORTS_B__10_3_OFFSET UNITYSDK_OFFSET(0xCD4A380)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__REGISTERPORTS_B__10_4_OFFSET UNITYSDK_OFFSET(0xCD4A390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2__REGISTERPORTS_B__10_5_OFFSET UNITYSDK_OFFSET(0xCD4A3A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0xCD4A3B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0xCD4A450)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0xCD4A480)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0xCD4A490)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0xCD4A4A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xCD4A4B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xCD4A4C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonsterAbyssS2_TypeDefinitionIndex = 65909;

	class LDWaveMonsterAbyssS2 : public ::MoleMole::FlowCanvas::Nodes::LDWaveMonster
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::AbyssS2PatternMonsterCreate*>* monsterCreateValues; // 0x1B0
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* monsterWaveRawIndex; // 0x1D8
		...
		{
			return ((::MoleMole::MonoSpawnPoint*(*)(::PVOID, ::Class_3_F35B080B137ECC46*, ::System::String*, ::UnityEngine::Vector2, ::UnityEngine::Vector2, ::System::Boolean&, ::System::Collections::Generic::HashSet_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERABYSSS2_SEARCHACHORBYPREFIX_OFFSET))(this, inputModelComponent, prefix, radius, angle, lastChooseLeft, excludePointSet);
		}
