...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTIP_ONCREATE_OFFSET UNITYSDK_OFFSET(0xC21BA10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTIP_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC21B820)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTIP__CTOR_OFFSET UNITYSDK_OFFSET(0xC21BAF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTIP__GETCREATEDTIPOBJECT_OFFSET UNITYSDK_OFFSET(0xC21BA80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTIP__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0xC21BB10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTIP__REGISTERPORTS_B__7_1_OFFSET UNITYSDK_OFFSET(0xC21BF90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTIP___BASE_ONCREATE_OFFSET UNITYSDK_OFFSET(0xC21BFD0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowTip_TypeDefinitionIndex = 51897;

	class LDShowTip : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::String*>* tipParam; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::System::String*>*>* tipParamList; // 0xB0
		::MoleMole::UIBubbleTips* _bubbleTip; // 0xB8
