...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CALLCAMERAEFFECT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA7D6990)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CALLCAMERAEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA7D6BA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CALLCAMERAEFFECT__REGISTERPORTS_B__10_0_OFFSET UNITYSDK_OFFSET(0xA7D6BC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CALLCAMERAEFFECT__REGISTERPORTS_B__10_1_OFFSET UNITYSDK_OFFSET(0xA7D6F50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_CallCameraEffect_TypeDefinitionIndex = 65516;

	class LD_CallCameraEffect : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::String*>* effectKey; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Boolean>* isInterruptType; // 0xB0
		::FlowCanvas::ValueInput_1<::MoleMole::Config::ScreenEffectType>* effectType; // 0xB8
		::FlowCanvas::FlowOutput* _output; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Boolean>* isEndByKey; // 0xC8
		::FlowCanvas::ValueInput_1<::MoleMole::Config::ShaderCustomType>* shaderCustomType; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Boolean>* isOneFrameEnd; // 0xD8
