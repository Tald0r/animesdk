...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CALLCAMERAEFFECT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA5ECBB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CALLCAMERAEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA5ECDC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CALLCAMERAEFFECT__REGISTERPORTS_B__10_0_OFFSET UNITYSDK_OFFSET(0xA5ECDE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CALLCAMERAEFFECT__REGISTERPORTS_B__10_1_OFFSET UNITYSDK_OFFSET(0xA5ED170)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_CallCameraEffect_TypeDefinitionIndex = 47440;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::String*>* effectKey; // 0xB0
		...
		::FlowCanvas::FlowOutput* _onStopOutput; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Boolean>* isInterruptType; // 0xD8
		::FlowCanvas::ValueInput_1<::System::Boolean>* isEndByKey; // 0xE0
