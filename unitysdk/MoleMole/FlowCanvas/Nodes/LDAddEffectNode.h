...
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDEFFECTNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xEC72470)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC726E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAddEffectNode_TypeDefinitionIndex = 58187;
