...
#define MOLEMOLE_FLOWCANVAS_NODES_LDACTIVEAREABLOCKWITHPARAM_INVOKE_OFFSET UNITYSDK_OFFSET(0xA7CA920)
#define MOLEMOLE_FLOWCANVAS_NODES_LDACTIVEAREABLOCKWITHPARAM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA7CA7C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDACTIVEAREABLOCKWITHPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA7CAF30)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDActiveAreaBlockWithParam_TypeDefinitionIndex = 68430;
