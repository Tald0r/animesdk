...
#define MOLEMOLE_FLOWCANVAS_NODES_LDACTIVEAREABLOCKWITHPARAM_INVOKE_OFFSET UNITYSDK_OFFSET(0xA5E0AD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDACTIVEAREABLOCKWITHPARAM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA5E0970)
#define MOLEMOLE_FLOWCANVAS_NODES_LDACTIVEAREABLOCKWITHPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E10E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDActiveAreaBlockWithParam_TypeDefinitionIndex = 74015;
