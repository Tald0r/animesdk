...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x75739B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x7573CC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x7573D20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x7573CD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x75739A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHECKPOINT__SAFEINVOKE_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0x7573990)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCheckPoint__SafeInvoke_d__13_TypeDefinitionIndex = 68196;
