...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_PLAY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7588450)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_PLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x7588610)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_PLAY__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x7588630)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_TextureSheet_Play_TypeDefinitionIndex = 48564;

	class LD_TextureSheet_Play : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Boolean>* _isKeepLastFrame; // 0xA8
		::FlowCanvas::FlowOutput* _output; // 0xB0
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* _targetEntity; // 0xB8
		::FlowCanvas::ValueInput_1<::MoleMole::Config::TextureSheetInterruptType>* _interruptType; // 0xC0
		::FlowCanvas::ValueInput_1<::System::String*>* _textureSheetKey; // 0xC8
		::FlowCanvas::ValueInput_1<::System::Boolean>* _isForceUpdate; // 0xD0
