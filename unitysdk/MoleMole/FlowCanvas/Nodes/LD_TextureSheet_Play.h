...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_PLAY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x678BB30)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_PLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x678BCF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_PLAY__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x678BD10)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_TextureSheet_Play_TypeDefinitionIndex = 46740;
