...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYJUMPTOPOSITION_INVOKEINNER_OFFSET UNITYSDK_OFFSET(0xC2BBE50)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYJUMPTOPOSITION_INVOKES_OFFSET UNITYSDK_OFFSET(0xC2BC130)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYJUMPTOPOSITION_INVOKE_OFFSET UNITYSDK_OFFSET(0xC2BBD40)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYJUMPTOPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xC2BC1D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowEntityJumpToPosition_TypeDefinitionIndex = 69817;
