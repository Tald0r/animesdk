...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYJUMPTOPOSITION_INVOKEINNER_OFFSET UNITYSDK_OFFSET(0xB897970)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYJUMPTOPOSITION_INVOKES_OFFSET UNITYSDK_OFFSET(0xB897C50)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYJUMPTOPOSITION_INVOKE_OFFSET UNITYSDK_OFFSET(0xB897860)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYJUMPTOPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xB897CF0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowEntityJumpToPosition_TypeDefinitionIndex = 75002;
