...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVE_INVOKEINNER_OFFSET UNITYSDK_OFFSET(0xA7C9010)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVE_INVOKES_OFFSET UNITYSDK_OFFSET(0xA7C9230)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA7C8F70)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C92C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowEntityMove_TypeDefinitionIndex = 66025;
