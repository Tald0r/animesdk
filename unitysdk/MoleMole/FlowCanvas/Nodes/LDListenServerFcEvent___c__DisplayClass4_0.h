...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB89FD90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT___C__DISPLAYCLASS4_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0xB89FDA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT___C__DISPLAYCLASS4_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0xB89FED0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenServerFcEvent___c__DisplayClass4_0_TypeDefinitionIndex = 45160;
