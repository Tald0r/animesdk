...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC2C42C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT___C__DISPLAYCLASS4_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0xC2C42D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT___C__DISPLAYCLASS4_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0xC2C4400)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenServerFcEvent___c__DisplayClass4_0_TypeDefinitionIndex = 51543;
