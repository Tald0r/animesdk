...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDCREATENEWTURNUNIT_INVOKE_OFFSET UNITYSDK_OFFSET(0x6AEF080)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDCREATENEWTURNUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x6AEF1A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedCreateNewTurnUnit_TypeDefinitionIndex = 56032;
