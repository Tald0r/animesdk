...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_STRING_DOGET_OFFSET UNITYSDK_OFFSET(0xB17E820)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_STRING__CTOR_OFFSET UNITYSDK_OFFSET(0xB17E8B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLEGET_STRING___BASE_DOGET_OFFSET UNITYSDK_OFFSET(0xB17E8E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPublicVariableGet_String_TypeDefinitionIndex = 80973;
