...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xA00DF70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xA00E130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT_ONSERVERFCEVENT_OFFSET UNITYSDK_OFFSET(0xA00DE30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA00D8F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA00E2F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xA00E310)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xA00E320)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenServerFcEvent_TypeDefinitionIndex = 45159;
