...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xCCDE4C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xCCDE680)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT_ONSERVERFCEVENT_OFFSET UNITYSDK_OFFSET(0xCCDE380)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xCCDDE40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xCCDE840)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xCCDE860)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENSERVERFCEVENT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xCCDE870)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenServerFcEvent_TypeDefinitionIndex = 51542;
