...
#define MOLEMOLE_FLOWCANVAS_NODES_CUSTOMSETENTITYSAVEMAPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE0EC0F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomSetEntitySaveMapNode_TypeDefinitionIndex = 36739;
