...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELHADALMSG_PREACTIVEROOMNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xC2C0310)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELHADALMSG_PREACTIVEROOMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2C0440)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDLevelHadalMsg_PreActiveRoomNode_TypeDefinitionIndex = 68365;
