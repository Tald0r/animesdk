...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERANIMEVENTNODE__WAITTRIGGER_D__5_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8F78590)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERANIMEVENTNODE__WAITTRIGGER_D__5_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8F78700)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERANIMEVENTNODE__WAITTRIGGER_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8F78760)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERANIMEVENTNODE__WAITTRIGGER_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x8F78710)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERANIMEVENTNODE__WAITTRIGGER_D__5_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F78580)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTRIGGERANIMEVENTNODE__WAITTRIGGER_D__5__CTOR_OFFSET UNITYSDK_OFFSET(0x8F78570)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTriggerAnimEventNode__WaitTrigger_d__5_TypeDefinitionIndex = 70028;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Boolean>* BoolParam; // 0x28
		::System::Object* __2__current; // 0x30
		::System::Collections::Generic::List_1<::System::String*>* TriggerParam; // 0x38
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Single>* FloatParam; // 0x40
