...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HADALROOMINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0xC9CC010)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HADALROOMINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xC9CC250)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_HadalRoomIndex_TypeDefinitionIndex = 51620;
