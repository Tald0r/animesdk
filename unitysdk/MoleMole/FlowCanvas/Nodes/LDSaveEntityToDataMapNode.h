...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSAVEENTITYTODATAMAPNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xC2C6140)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSAVEENTITYTODATAMAPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2C64F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSaveEntityToDataMapNode_TypeDefinitionIndex = 78107;
