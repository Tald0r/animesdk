...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0xA00BD20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE_ENTITYONREADY_OFFSET UNITYSDK_OFFSET(0xA00BC30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE_ONEVENT_OFFSET UNITYSDK_OFFSET(0xA00C140)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xA00BCB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xA00BEF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE_PREPAREDATA_OFFSET UNITYSDK_OFFSET(0xA00B660)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE_PREPAREINTERACTMSG_OFFSET UNITYSDK_OFFSET(0xA00B6C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE_PREPAREINTERACTVALUE_OFFSET UNITYSDK_OFFSET(0xA00B840)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA00B0C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE_TRYCREATEINTERACT_OFFSET UNITYSDK_OFFSET(0xA00B990)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0xA00BF60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA00C350)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0xA00C370)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE__REGISTERPORTS_B__11_1_OFFSET UNITYSDK_OFFSET(0xA00C3B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xA00C3C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEINTERACTITEMNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xA00C3D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateInteractItemNode_TypeDefinitionIndex = 66550;

	class LDCreateInteractItemNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* _overrideAbilityMap; // 0xA8
		::System::String* inputInteractKey; // 0xB0
		::FlowCanvas::FlowOutput* output; // 0xB8
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Object*>* _interactValueDict; // 0xC0
