...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTIPUPDATE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC2C8D70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTIPUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2C9220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTIPUPDATE__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0xC2C9250)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTIPUPDATE__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0xC2C9440)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTIPUPDATE__UPDATETIP_OFFSET UNITYSDK_OFFSET(0xC2C8EC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowTipUpdate_TypeDefinitionIndex = 57025;

	class LDShowTipUpdate : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::String*>* tipParam; // 0xA8
		::System::String* _cacheString; // 0xB0
