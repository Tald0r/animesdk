...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTHEGUNSCORE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA382F30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTHEGUNSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0xA3830D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetTheGunScore_TypeDefinitionIndex = 45713;
