...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEDYNAMICOBJECTSETSTATE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xEC746D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEDYNAMICOBJECTSETSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC74800)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEDYNAMICOBJECTSETSTATE__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0xEC74820)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDChangeDynamicObjectSetState_TypeDefinitionIndex = 47105;
