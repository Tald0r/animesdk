...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEDYNAMICOBJECTSETSTATE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x75731C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEDYNAMICOBJECTSETSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x75732F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEDYNAMICOBJECTSETSTATE__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x7573310)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDChangeDynamicObjectSetState_TypeDefinitionIndex = 56767;
