...
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2TREASURECREATEDATALIST_GET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0xE0ED8B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2TREASURECREATEDATALIST_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE0ED8D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2TREASURECREATEDATALIST_SET_PORTCOUNT_OFFSET UNITYSDK_OFFSET(0xE0ED8C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2TREASURECREATEDATALIST__CTOR_OFFSET UNITYSDK_OFFSET(0xE0EDAF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2TREASURECREATEDATALIST__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0xE0EDB90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2TREASURECREATEDATALIST__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0xE0EDDA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAbyssS2TreasureCreateDataList_TypeDefinitionIndex = 44631;
