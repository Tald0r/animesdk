...
#define MOLEMOLE_FLOWCANVAS_NODES_LDHIDEAVATARGUIDEITEM_INVOKE_OFFSET UNITYSDK_OFFSET(0xE0F1850)
#define MOLEMOLE_FLOWCANVAS_NODES_LDHIDEAVATARGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xE0F1A40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDHideAvatarGuideItem_TypeDefinitionIndex = 54819;
