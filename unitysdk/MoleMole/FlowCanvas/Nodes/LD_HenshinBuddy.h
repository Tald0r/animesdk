...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY_RECOVERENTITY_OFFSET UNITYSDK_OFFSET(0xBA11B00)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xBA11640)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY_START_INTERACT_OFFSET UNITYSDK_OFFSET(0xBA117D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY__CTOR_OFFSET UNITYSDK_OFFSET(0xBA11CB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xBA11CD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0xBA11D40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_HenshinBuddy_TypeDefinitionIndex = 74070;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* buddyID; // 0xC0
