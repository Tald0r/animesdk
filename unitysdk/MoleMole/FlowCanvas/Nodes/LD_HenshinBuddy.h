...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY_RECOVERENTITY_OFFSET UNITYSDK_OFFSET(0xC9CC740)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC9CC270)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY_START_INTERACT_OFFSET UNITYSDK_OFFSET(0xC9CC400)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY__CTOR_OFFSET UNITYSDK_OFFSET(0xC9CC8F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xC9CC910)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HENSHINBUDDY__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0xC9CC980)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_HenshinBuddy_TypeDefinitionIndex = 73817;
