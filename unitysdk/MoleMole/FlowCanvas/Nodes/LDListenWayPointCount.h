...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x141D7190)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_HANDLERWAYPOINTEVT_OFFSET UNITYSDK_OFFSET(0x9902870)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_INTERNALENTITYSTAYCOROUTINE_OFFSET UNITYSDK_OFFSET(0x9902D10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_ONENTITYENTERWAYPOINT_OFFSET UNITYSDK_OFFSET(0x9902920)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_ONENTITYEXITWAYPOINT_OFFSET UNITYSDK_OFFSET(0x9902B20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x141D7360)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x141D68C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x141D6920)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_ONNODETASKFINISH_OFFSET UNITYSDK_OFFSET(0x9902DB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x141D66B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_STARTLISTEN_OFFSET UNITYSDK_OFFSET(0x141D6B90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x141D69C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x9902E80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT__REGISTERPORTS_B__19_0_OFFSET UNITYSDK_OFFSET(0x9902EA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x9902ED0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENWAYPOINTCOUNT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x9902EE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenWayPointCount_TypeDefinitionIndex = 42586;
	...
	public:
		...
		::FlowCanvas::FlowOutput* wayPointStayPort; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Int32>* triggerCountInput; // 0xC8
		::FlowCanvas::ValueInput_1<::System::String*>* waypathNameInput; // 0xD0
		::FlowCanvas::FlowOutput* wayPointOutPort; // 0xD8
		::UnityEngine::Coroutine* stayWaypointCo; // 0xE0
		::FlowCanvas::FlowOutput* outputPort; // 0xE8
		::FlowCanvas::FlowOutput* wayPointInPort; // 0xF0
		::System::String* currWayPoint; // 0xF8
		::FlowCanvas::ValueInput_1<::System::String*>* waypointInput; // 0x100
		::System::Int32 currentListenCount; // 0x108
		::System::Single elapsedStart; // 0x10C
		::System::UInt32 listenEntityId; // 0x110
