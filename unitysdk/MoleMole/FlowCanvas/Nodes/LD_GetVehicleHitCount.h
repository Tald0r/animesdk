...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETVEHICLEHITCOUNT_INVOKE_OFFSET UNITYSDK_OFFSET(0xC21FE70)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETVEHICLEHITCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0xC21FF50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_GetVehicleHitCount_TypeDefinitionIndex = 73069;
