...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVETOPOSITION_INVOKEINNER_OFFSET UNITYSDK_OFFSET(0xA00A8B0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVETOPOSITION_INVOKES_OFFSET UNITYSDK_OFFSET(0xA00AD40)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVETOPOSITION_INVOKE_OFFSET UNITYSDK_OFFSET(0xA00A7A0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVETOPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xA00ADE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowEntityMoveToPosition_TypeDefinitionIndex = 57577;
