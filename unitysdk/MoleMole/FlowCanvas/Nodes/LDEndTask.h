...
#define MOLEMOLE_FLOWCANVAS_NODES_LDENDTASK_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x82C79E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENDTASK_START_OFFSET UNITYSDK_OFFSET(0x82C7AF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENDTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x82C7C10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENDTASK__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x82C7C30)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDEndTask_TypeDefinitionIndex = 49117;
