...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWRITEAIPARAMINTNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x6E1CA80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWRITEAIPARAMINTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E1CC70)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWriteAIParamIntNode_TypeDefinitionIndex = 72904;
