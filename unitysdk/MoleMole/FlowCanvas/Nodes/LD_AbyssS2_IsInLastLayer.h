...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ISINLASTLAYER_INVOKE_OFFSET UNITYSDK_OFFSET(0x6E1D460)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ISINLASTLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x6E1D5B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_IsInLastLayer_TypeDefinitionIndex = 78018;
