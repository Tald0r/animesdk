...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0xBA08060)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_CHECKALIVECOUNT_OFFSET UNITYSDK_OFFSET(0xBA06670)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_COMPAREMONSTERCAMP_OFFSET UNITYSDK_OFFSET(0xBA08CD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_HANDLECOMPARE_OFFSET UNITYSDK_OFFSET(0xBA07D80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xBA060B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ISNORMALCOUNTINGTAG_OFFSET UNITYSDK_OFFSET(0xBA090C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0xBA05660)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_LISTENENTITYTAGCHANGE_OFFSET UNITYSDK_OFFSET(0xBA084B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xBA08960)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xBA083B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xBA08420)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONHOSTCHANGED_OFFSET UNITYSDK_OFFSET(0xBA07EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONLATETICKCALLBACK_OFFSET UNITYSDK_OFFSET(0xBA08BC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_ONMONSTERSTATECHANGE_OFFSET UNITYSDK_OFFSET(0xBA085A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xBA05430)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_REMOTEWAITFLOWPROCESS_OFFSET UNITYSDK_OFFSET(0xBA07E50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0xBA05D80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_WAITTOCHECKALIVECOUNT_OFFSET UNITYSDK_OFFSET(0xBA08C30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE__CALLREACHED_OFFSET UNITYSDK_OFFSET(0xBA056C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xBA09350)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE__REGISTERPORTS_B__15_0_OFFSET UNITYSDK_OFFSET(0xBA09410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE___BASE_ISSERVERCARE_OFFSET UNITYSDK_OFFSET(0xBA098F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xBA09900)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xBA09910)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMonsterLeftCheckNode_TypeDefinitionIndex = 72222;

	class LDMonsterLeftCheckNode : public ::FlowCanvas::FlowNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Int32>* inputLeftCount; // 0xA8
		::System::Collections::Generic::List_1<::System::String*>* removeList; // 0xB0
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::NumberCompareType>* inputCompareFunc; // 0xB8
		...
		::FlowCanvas::ValueInput_1<::System::Boolean>* inputAllMonster; // 0xD8
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::EntityDieCheckType>* deathCheckType; // 0xE0
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::EntitySaveDataMap*>* inputEntityMap; // 0xE8
		::FlowCanvas::FlowOutput* Reached; // 0xF0
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* monstList; // 0xF8
		::System::Boolean goalReached; // 0x100
		::System::Boolean notifyServer; // 0x101
		::System::Boolean eventBind; // 0x102
		...
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::EntityHandle, ::Class_2_5DFC66413CB20B09_Enum_3_A5191D6218CE9E26, ::MoleMole::GameplayTag))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERLEFTCHECKNODE_LISTENENTITYTAGCHANGE_OFFSET))(this, entityHandle, changeType, tag);
		}
