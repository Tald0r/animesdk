...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLEARITEM_CLEARALLITEM_OFFSET UNITYSDK_OFFSET(0x7A53270)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLEARITEM_CLEARITEM_OFFSET UNITYSDK_OFFSET(0x7A52E20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLEARITEM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7A52CF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLEARITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x7A535C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDClearItem_TypeDefinitionIndex = 63700;

	class LDClearItem : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* output; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Boolean>* isAllInput; // 0xB0
