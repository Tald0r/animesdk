...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LAYERFAILEDTIME_INVOKE_OFFSET UNITYSDK_OFFSET(0xA5EE8A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LAYERFAILEDTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xA5EEA00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_LayerFailedTime_TypeDefinitionIndex = 59076;
