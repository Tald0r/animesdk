...
#define MOLEMOLE_FLOWCANVAS_NODES_LDREADBLOCKCONFIG___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9903BA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREADBLOCKCONFIG___C__DISPLAYCLASS1_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x9903BD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREADBLOCKCONFIG___C__DISPLAYCLASS1_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x9903C10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREADBLOCKCONFIG___C__DISPLAYCLASS1_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0x9903C40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREADBLOCKCONFIG___C__DISPLAYCLASS1_0__REGISTERPORTS_B__3_OFFSET UNITYSDK_OFFSET(0x9903C70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREADBLOCKCONFIG___C__DISPLAYCLASS1_0__REGISTERPORTS_B__4_OFFSET UNITYSDK_OFFSET(0x9903CB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREADBLOCKCONFIG___C__DISPLAYCLASS1_0__REGISTERPORTS_B__5_OFFSET UNITYSDK_OFFSET(0x9903CE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREADBLOCKCONFIG___C__DISPLAYCLASS1_0__REGISTERPORTS_B__6_OFFSET UNITYSDK_OFFSET(0x9903D10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREADBLOCKCONFIG___C__DISPLAYCLASS1_0__REGISTERPORTS_B__7_OFFSET UNITYSDK_OFFSET(0x9903D40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREADBLOCKCONFIG___C__DISPLAYCLASS1_0__REGISTERPORTS_B__8_OFFSET UNITYSDK_OFFSET(0x9903D80)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDReadBlockConfig___c__DisplayClass1_0_TypeDefinitionIndex = 48165;
