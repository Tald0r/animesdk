...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTARGETENTITYUINODE_GUIDEENTITYTARGETCAMERAVIEWCHECKER_GET_ISINCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0xBA0CBC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTARGETENTITYUINODE_GUIDEENTITYTARGETCAMERAVIEWCHECKER_GET_SHOULDCONTINUE_OFFSET UNITYSDK_OFFSET(0xBA0CBB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTARGETENTITYUINODE_GUIDEENTITYTARGETCAMERAVIEWCHECKER_ISBINDTOTHISENTITY_OFFSET UNITYSDK_OFFSET(0xBA0CDB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTARGETENTITYUINODE_GUIDEENTITYTARGETCAMERAVIEWCHECKER_MARKCONTINUE_OFFSET UNITYSDK_OFFSET(0xBA0CB40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTARGETENTITYUINODE_GUIDEENTITYTARGETCAMERAVIEWCHECKER_UPDATEINCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0xBA0CBD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWTARGETENTITYUINODE_GUIDEENTITYTARGETCAMERAVIEWCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0xBA0CE30)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowTargetEntityUINode_GuideEntityTargetCameraViewChecker_TypeDefinitionIndex = 79737;
	...
	public:
		...
		::MoleMole::Battle::Entity* TestEntity; // 0x20
