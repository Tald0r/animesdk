...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP_GETENTITY_OFFSET UNITYSDK_OFFSET(0xE475400)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP_LOGERROR_OFFSET UNITYSDK_OFFSET(0xE475300)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE475190)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xE4757F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xE475810)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYFROMDATAMAP__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0xE475820)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetEntityFromDataMap_TypeDefinitionIndex = 77578;
