...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECHECKNODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x7A57F50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECHECKNODE_CHECKDIECOUNT_OFFSET UNITYSDK_OFFSET(0x7A574E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECHECKNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x7A57010)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECHECKNODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x7A581A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECHECKNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x7A57EE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECHECKNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x7A58130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECHECKNODE_ONMONSTERDIE_OFFSET UNITYSDK_OFFSET(0x7A582C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECHECKNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7A56E60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECHECKNODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x7A57D10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECHECKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x7A587E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECHECKNODE__REGISTERPORTS_B__9_0_OFFSET UNITYSDK_OFFSET(0x7A58800)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECHECKNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x7A588B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECHECKNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x7A588C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMonsterDieCheckNode_TypeDefinitionIndex = 79899;
