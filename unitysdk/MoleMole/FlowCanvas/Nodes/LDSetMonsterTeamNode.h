...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETMONSTERTEAMNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA5EA7C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETMONSTERTEAMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA5EA890)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetMonsterTeamNode_TypeDefinitionIndex = 46300;
