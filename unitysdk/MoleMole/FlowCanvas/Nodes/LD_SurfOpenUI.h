...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SURFOPENUI_ONREGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC220F60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SURFOPENUI_START_OFFSET UNITYSDK_OFFSET(0xC221050)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SURFOPENUI__CTOR_OFFSET UNITYSDK_OFFSET(0xC2211A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SurfOpenUI_TypeDefinitionIndex = 64294;
