...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SURFOPENUI_ONREGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB8376D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SURFOPENUI_START_OFFSET UNITYSDK_OFFSET(0xB8377C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SURFOPENUI__CTOR_OFFSET UNITYSDK_OFFSET(0xB837910)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SurfOpenUI_TypeDefinitionIndex = 66638;
