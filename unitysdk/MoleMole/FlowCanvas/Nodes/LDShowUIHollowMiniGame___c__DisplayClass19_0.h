...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME___C__DISPLAYCLASS19_0__CLOSEBIGTVMINIGAME_B__0_OFFSET UNITYSDK_OFFSET(0x6AEAF90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME___C__DISPLAYCLASS19_0__CLOSEBIGTVMINIGAME_B__1_OFFSET UNITYSDK_OFFSET(0x6AEB080)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x6AEAF80)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowUIHollowMiniGame___c__DisplayClass19_0_TypeDefinitionIndex = 49726;
