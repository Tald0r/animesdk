...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME___C__DISPLAYCLASS19_0__CLOSEBIGTVMINIGAME_B__0_OFFSET UNITYSDK_OFFSET(0xB5DA1D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME___C__DISPLAYCLASS19_0__CLOSEBIGTVMINIGAME_B__1_OFFSET UNITYSDK_OFFSET(0xB5DA2C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB5DA1C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowUIHollowMiniGame___c__DisplayClass19_0_TypeDefinitionIndex = 60606;
	...
	public:
		...
		::System::Boolean skipFadeOut; // 0x20
		::System::Boolean isSuccess; // 0x21
