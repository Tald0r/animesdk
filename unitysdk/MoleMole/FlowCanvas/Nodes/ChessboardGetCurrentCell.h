...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCURRENTCELL_INVOKE_OFFSET UNITYSDK_OFFSET(0xB5C7CC0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCURRENTCELL__CTOR_OFFSET UNITYSDK_OFFSET(0xB5C7E00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardGetCurrentCell_TypeDefinitionIndex = 72091;
