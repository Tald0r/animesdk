...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCURRENTCELL_INVOKE_OFFSET UNITYSDK_OFFSET(0x6AD8A10)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCURRENTCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x6AD8B50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardGetCurrentCell_TypeDefinitionIndex = 58165;
