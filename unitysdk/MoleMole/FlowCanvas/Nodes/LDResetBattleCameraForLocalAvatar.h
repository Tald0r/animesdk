...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETBATTLECAMERAFORLOCALAVATAR_BACKCAMERA_OFFSET UNITYSDK_OFFSET(0xA5EA200)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETBATTLECAMERAFORLOCALAVATAR_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA5EA120)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETBATTLECAMERAFORLOCALAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0xA5EA2C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDResetBattleCameraForLocalAvatar_TypeDefinitionIndex = 63425;
