...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__CTOR_OFFSET UNITYSDK_OFFSET(0x6E14D50)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__INTERNALCOROUTINE_B__0_OFFSET UNITYSDK_OFFSET(0x6E14D60)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__INTERNALCOROUTINE_G__CREATEENTITY_2_OFFSET UNITYSDK_OFFSET(0x6E15640)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__INTERNALCOROUTINE_G__CREATENEXTENTITY_1_OFFSET UNITYSDK_OFFSET(0x6E14DB0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__INTERNALCOROUTINE_G__ISALLBLOCK_3_OFFSET UNITYSDK_OFFSET(0x6E15840)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowCreateEntityLikeBombermanBomb___c__DisplayClass28_0_TypeDefinitionIndex = 55311;
