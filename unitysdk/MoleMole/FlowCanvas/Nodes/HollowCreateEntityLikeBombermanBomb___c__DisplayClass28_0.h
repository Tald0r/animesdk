...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC2642D0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__INTERNALCOROUTINE_B__0_OFFSET UNITYSDK_OFFSET(0xC2642E0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__INTERNALCOROUTINE_G__CREATEENTITY_2_OFFSET UNITYSDK_OFFSET(0xC264BC0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__INTERNALCOROUTINE_G__CREATENEXTENTITY_1_OFFSET UNITYSDK_OFFSET(0xC264330)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWCREATEENTITYLIKEBOMBERMANBOMB___C__DISPLAYCLASS28_0__INTERNALCOROUTINE_G__ISALLBLOCK_3_OFFSET UNITYSDK_OFFSET(0xC264DC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowCreateEntityLikeBombermanBomb___c__DisplayClass28_0_TypeDefinitionIndex = 79487;

	class HollowCreateEntityLikeBombermanBomb___c__DisplayClass28_0 : public ::System::Object
	{
	public:
		::FlowCanvas::Flow f; // 0x10
		::MoleMole::FlowCanvas::Nodes::HollowCreateEntityLikeBombermanBomb* __4__this; // 0x38
