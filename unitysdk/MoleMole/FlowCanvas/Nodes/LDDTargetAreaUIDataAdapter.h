...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDTARGETAREAUIDATAADAPTER_GETANCHORS_OFFSET UNITYSDK_OFFSET(0x53A040)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDTARGETAREAUIDATAADAPTER_GETSTYLES_OFFSET UNITYSDK_OFFSET(0x53A050)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDTARGETAREAUIDATAADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x53A060)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDTargetAreaUIDataAdapter_TypeDefinitionIndex = 68497;
