...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDTARGETAREAUIDATAADAPTER_GETANCHORS_OFFSET UNITYSDK_OFFSET(0x4180D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDTARGETAREAUIDATAADAPTER_GETSTYLES_OFFSET UNITYSDK_OFFSET(0x4180E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDTARGETAREAUIDATAADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x4180F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDTargetAreaUIDataAdapter_TypeDefinitionIndex = 40639;
