...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE___SYNMODELTRANSFORM_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xBA0CE60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE___SYNMODELTRANSFORM_D__21_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBA0D100)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE___SYNMODELTRANSFORM_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBA0D160)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE___SYNMODELTRANSFORM_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xBA0D110)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE___SYNMODELTRANSFORM_D__21_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBA0CE50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE___SYNMODELTRANSFORM_D__21__CTOR_OFFSET UNITYSDK_OFFSET(0xBA0CE40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSpawnBuddyNode___SynModelTransform_d__21_TypeDefinitionIndex = 54286;
