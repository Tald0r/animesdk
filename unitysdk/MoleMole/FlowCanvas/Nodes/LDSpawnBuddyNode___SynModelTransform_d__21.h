...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE___SYNMODELTRANSFORM_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC9C7A70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE___SYNMODELTRANSFORM_D__21_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC9C7D10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE___SYNMODELTRANSFORM_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC9C7D70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE___SYNMODELTRANSFORM_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC9C7D20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE___SYNMODELTRANSFORM_D__21_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC9C7A60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSPAWNBUDDYNODE___SYNMODELTRANSFORM_D__21__CTOR_OFFSET UNITYSDK_OFFSET(0xC9C7A50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSpawnBuddyNode___SynModelTransform_d__21_TypeDefinitionIndex = 43512;
	...
	public:
		...
		::MoleMole::Battle::Entity* localAvatar; // 0x20
