...
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_FROMPROTO_OFFSET UNITYSDK_OFFSET(0xB18F320)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xB18F2B0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0xB18F2D0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_GET_UNLOCKSKILLLIST_OFFSET UNITYSDK_OFFSET(0xB18F2F0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xB18F2C0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_SET_ISNEW_OFFSET UNITYSDK_OFFSET(0xB18F2E0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_SET_UNLOCKSKILLLIST_OFFSET UNITYSDK_OFFSET(0xB18F300)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO_TOPROTO_OFFSET UNITYSDK_OFFSET(0xB18F480)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYMONSTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB18F310)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int MonsterFantasyMonsterInfo_TypeDefinitionIndex = 74400;
