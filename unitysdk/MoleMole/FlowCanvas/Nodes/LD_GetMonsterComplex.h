...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETMONSTERCOMPLEX_INVOKE_OFFSET UNITYSDK_OFFSET(0x7F09630)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETMONSTERCOMPLEX__CTOR_OFFSET UNITYSDK_OFFSET(0x7F09760)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_GetMonsterComplex_TypeDefinitionIndex = 51266;
