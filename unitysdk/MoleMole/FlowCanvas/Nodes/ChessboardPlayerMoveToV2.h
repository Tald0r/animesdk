...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPLAYERMOVETOV2_INVOKE_OFFSET UNITYSDK_OFFSET(0x8AEF030)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPLAYERMOVETOV2__CTOR_OFFSET UNITYSDK_OFFSET(0x8AEF230)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardPlayerMoveToV2_TypeDefinitionIndex = 78638;
