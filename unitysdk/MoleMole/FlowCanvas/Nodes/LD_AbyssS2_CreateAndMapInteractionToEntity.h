...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CREATEANDMAPINTERACTIONTOENTITY_CREATEANDINITP2PINTERACTION_OFFSET UNITYSDK_OFFSET(0xC21D4D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CREATEANDMAPINTERACTIONTOENTITY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC21D380)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CREATEANDMAPINTERACTIONTOENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0xC21D710)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CREATEANDMAPINTERACTIONTOENTITY__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xC21D730)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_CreateAndMapInteractionToEntity_TypeDefinitionIndex = 63241;
