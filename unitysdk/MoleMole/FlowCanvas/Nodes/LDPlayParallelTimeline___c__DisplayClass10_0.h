...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD7FFB90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE___C__DISPLAYCLASS10_0__PLAYTIMELINE_B__0_OFFSET UNITYSDK_OFFSET(0xD7FFBA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPlayParallelTimeline___c__DisplayClass10_0_TypeDefinitionIndex = 78677;
