...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0xD0D8800)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xD0D82A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0xD0D8860)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETENEMYMONSTERLIST___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xD0D88C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedGetEnemyMonsterList_TypeDefinitionIndex = 63153;
