...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_ONENTITYREADYCONTEXT_ONENTITYREADY_OFFSET UNITYSDK_OFFSET(0x6AEFCB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER_ONENTITYREADYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6AEFCA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonster_OnEntityReadyContext_TypeDefinitionIndex = 59858;
