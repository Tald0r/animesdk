...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETRANSITIONLOADING_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC265B50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETRANSITIONLOADING__CTOR_OFFSET UNITYSDK_OFFSET(0xC265CC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETRANSITIONLOADING__ONSTOPCOMPLETE_OFFSET UNITYSDK_OFFSET(0xC265C30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCLOSETRANSITIONLOADING__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0xC265CE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCloseTransitionLoading_TypeDefinitionIndex = 62468;
