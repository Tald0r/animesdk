...
{
	inline static constexpr unsigned int LDWaveTreasure___c__DisplayClass10_0_TypeDefinitionIndex = 69041;

	struct alignas(8) LDWaveTreasure___c__DisplayClass10_0
	{
		::MoleMole::FlowCanvas::Nodes::LDWaveTreasure* __4__this; // 0x10
		::MoleMole::FlowCanvas::Nodes::MonsterCreateDataBase* createData; // 0x18
