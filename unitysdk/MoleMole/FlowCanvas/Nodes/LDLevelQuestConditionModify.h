...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELQUESTCONDITIONMODIFY_BEGIN_OFFSET UNITYSDK_OFFSET(0xF1A1980)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELQUESTCONDITIONMODIFY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xF1A1820)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELQUESTCONDITIONMODIFY__CTOR_OFFSET UNITYSDK_OFFSET(0xF1A2130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELQUESTCONDITIONMODIFY__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0xF1A2150)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDLevelQuestConditionModify_TypeDefinitionIndex = 78881;

	class LDLevelQuestConditionModify : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::LevelQuestConditionModifyData*>*>* successConditions; // 0xA8
