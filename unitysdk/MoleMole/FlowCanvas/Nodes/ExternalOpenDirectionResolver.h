...
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x11646280)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_GETDATA_OFFSET UNITYSDK_OFFSET(0x11646440)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x11646600)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_METHOD_4_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0x11646820)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_METHOD_4_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0x11646690)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_METHOD_4_BB75FB1EF4C67D87_OFFSET UNITYSDK_OFFSET(0x11646750)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_SETPATH_OFFSET UNITYSDK_OFFSET(0x116461C0)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x11646630)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x11646610)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExternalOpenDirectionResolver_TypeDefinitionIndex = 51633;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(ExternalOpenDirectionResolver_TypeDefinitionIndex)->GetStaticField(0xEC30);
		}
