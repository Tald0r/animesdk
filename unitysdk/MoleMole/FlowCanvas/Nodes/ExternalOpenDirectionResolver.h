...
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x8AEF530)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_GETDATA_OFFSET UNITYSDK_OFFSET(0x8AEF6F0)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x8AEF8B0)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_METHOD_4_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0x8AEFAD0)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_METHOD_4_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0x8AEF940)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_METHOD_4_BB75FB1EF4C67D87_OFFSET UNITYSDK_OFFSET(0x8AEFA00)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER_SETPATH_OFFSET UNITYSDK_OFFSET(0x8AEF470)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8AEF8E0)
#define MOLEMOLE_FLOWCANVAS_NODES_EXTERNALOPENDIRECTIONRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x8AEF8C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ExternalOpenDirectionResolver_TypeDefinitionIndex = 57676;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(ExternalOpenDirectionResolver_TypeDefinitionIndex)->GetStaticField(0xE690);
		}
