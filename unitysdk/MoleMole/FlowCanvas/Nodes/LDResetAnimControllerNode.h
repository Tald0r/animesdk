...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETANIMCONTROLLERNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xB8311C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETANIMCONTROLLERNODE_STOPTYPEENTITYTIMESLOW_OFFSET UNITYSDK_OFFSET(0xB831530)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETANIMCONTROLLERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB831820)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDResetAnimControllerNode_TypeDefinitionIndex = 79905;
