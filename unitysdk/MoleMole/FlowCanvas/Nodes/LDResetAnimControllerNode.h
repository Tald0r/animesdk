...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETANIMCONTROLLERNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xC21AA50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETANIMCONTROLLERNODE_STOPTYPEENTITYTIMESLOW_OFFSET UNITYSDK_OFFSET(0xC21ADC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETANIMCONTROLLERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC21B0C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDResetAnimControllerNode_TypeDefinitionIndex = 68550;
