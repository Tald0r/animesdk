...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMUTEHUD_INVOKE_OFFSET UNITYSDK_OFFSET(0xE0F3BD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMUTEHUD__CTOR_OFFSET UNITYSDK_OFFSET(0xE0F3F10)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMuteHud_TypeDefinitionIndex = 78038;
