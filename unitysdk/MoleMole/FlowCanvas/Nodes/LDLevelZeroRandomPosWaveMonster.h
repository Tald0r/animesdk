...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_BEGIN_OFFSET UNITYSDK_OFFSET(0x75771D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x7578970)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_EXPENDCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x7577C80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0x75773C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x75788F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x75787D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x7577160)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETCURRENTTAG_OFFSET UNITYSDK_OFFSET(0x7578BA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_GETMONSTERTYPE_OFFSET UNITYSDK_OFFSET(0x7578C70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_PREPROCESSMONSTERCREATELIST_OFFSET UNITYSDK_OFFSET(0x7577630)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7576C70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x7578DA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0x7578E30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_1_OFFSET UNITYSDK_OFFSET(0x7578E60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_2_OFFSET UNITYSDK_OFFSET(0x7578F50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_3_OFFSET UNITYSDK_OFFSET(0x7578F80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_4_OFFSET UNITYSDK_OFFSET(0x7578F90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER__REGISTERPORTS_B__7_5_OFFSET UNITYSDK_OFFSET(0x7578FA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x7578FB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x7578FE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x7578FF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x7579000)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x7579010)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZERORANDOMPOSWAVEMONSTER___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7579020)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDLevelZeroRandomPosWaveMonster_TypeDefinitionIndex = 69453;

	class LDLevelZeroRandomPosWaveMonster : public ::MoleMole::FlowCanvas::Nodes::LDWaveMonsterPosRandom
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::LevelZeroRandomPosMonsterCreateData*>* PostCreateData; // 0x1F0
		...
		::FlowCanvas::ValueInput_1<::MoleMole::Project::Config::MonsterGroupTemplateExt_MonsterTypeEnum>* typeInput; // 0x208
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::LevelZeroRandomPosMonsterCreateData*>*>* levelZeroCreateInput; // 0x210
