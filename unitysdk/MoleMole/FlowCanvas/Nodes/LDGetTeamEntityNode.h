...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTEAMENTITYNODE_GETTEAMENTITY_OFFSET UNITYSDK_OFFSET(0xEC832F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTEAMENTITYNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xEC83410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTEAMENTITYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC834E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETTEAMENTITYNODE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xEC83500)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetTeamEntityNode_TypeDefinitionIndex = 55056;
