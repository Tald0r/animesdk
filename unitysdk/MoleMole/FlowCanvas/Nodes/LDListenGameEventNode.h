...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE_BINDEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x757BE80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x757CD20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x757C600)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE_ONEVENTREACHED_OFFSET UNITYSDK_OFFSET(0x757C910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE_ONHOSTCHANGED_OFFSET UNITYSDK_OFFSET(0x757C290)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE_ONSTAGECHANGED_OFFSET UNITYSDK_OFFSET(0x757C3F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE_PROCESSEVENT_OFFSET UNITYSDK_OFFSET(0x757C6E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x757B2D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE_START_OFFSET UNITYSDK_OFFSET(0x757B4D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE_UNBINDEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0x757BA40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE_WAITAUTHORITYNOTIFYCOROUTINE_OFFSET UNITYSDK_OFFSET(0x757BDE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x757CD90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE__REGISTERPORTS_B__16_0_OFFSET UNITYSDK_OFFSET(0x757CDB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENGAMEEVENTNODE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x757CF10)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenGameEventNode_TypeDefinitionIndex = 81104;

	class LDListenGameEventNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::MoleMole::EntityHandle bindEntityHandle; // 0xA8
		::FlowCanvas::FlowOutput* output; // 0xB8
		::FlowCanvas::ValueInput_1<::System::Int32>* listenTimesInput; // 0xC0
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* listenerEntityInput; // 0xC8
		::FlowCanvas::FlowOutput* reached; // 0xD0
		::UnityEngine::Coroutine* coroutine; // 0xD8
		::FlowCanvas::ValueInput_1<::System::Boolean>* isGloableInput; // 0xE0
		::FlowCanvas::ValueOutput_1<::MoleMole::Battle::Entity*>* entityOutput; // 0xE8
		::FlowCanvas::ValueInput_1<::System::String*>* eventInput; // 0xF0
		::System::UInt32 triggerEventEntityId; // 0xF8
		::System::Boolean bindStageChangeEvent; // 0xFC
		::System::Boolean bindEvent; // 0xFD
		::System::Boolean AutoRegisterOnStageChanged; // 0xFE
		::System::Boolean listenStart; // 0xFF
		::System::UInt32 listenEnittyId; // 0x100
		::System::Int32 currentListenTimes; // 0x104
