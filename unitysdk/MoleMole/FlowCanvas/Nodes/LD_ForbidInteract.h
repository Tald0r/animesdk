...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_FORBIDINTERACT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA7D7580)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_FORBIDINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0xA7D7D60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_FORBIDINTERACT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xA7D7D80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_FORBIDINTERACT__STARTMUTE_OFFSET UNITYSDK_OFFSET(0xA7D76D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ForbidInteract_TypeDefinitionIndex = 67634;
