...
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_ONANIMSTATEFRAMEREACHED_OFFSET UNITYSDK_OFFSET(0xA5E2560)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_ONENTITYLOST_OFFSET UNITYSDK_OFFSET(0xA5E24F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_ONFINISH_OFFSET UNITYSDK_OFFSET(0xA5E2710)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_REGISTERLISTENER_OFFSET UNITYSDK_OFFSET(0xA5E1C50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA5E13D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_START_OFFSET UNITYSDK_OFFSET(0xA5E15D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_UNREGISTERLISTENER_OFFSET UNITYSDK_OFFSET(0xA5E2360)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E28A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0xA5E28C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAnimStateCompletionDetection_TypeDefinitionIndex = 49404;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::MoleMole::AnimStateCheckType>* stateDetectionTypeInput; // 0xD8
