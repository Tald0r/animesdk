...
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_ONANIMSTATEFRAMEREACHED_OFFSET UNITYSDK_OFFSET(0xA7CC3A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_ONENTITYLOST_OFFSET UNITYSDK_OFFSET(0xA7CC330)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_ONFINISH_OFFSET UNITYSDK_OFFSET(0xA7CC550)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_REGISTERLISTENER_OFFSET UNITYSDK_OFFSET(0xA7CBA90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA7CB220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_START_OFFSET UNITYSDK_OFFSET(0xA7CB420)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION_UNREGISTERLISTENER_OFFSET UNITYSDK_OFFSET(0xA7CC1A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA7CC6E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDANIMSTATECOMPLETIONDETECTION__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0xA7CC700)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAnimStateCompletionDetection_TypeDefinitionIndex = 46712;

	class LDAnimStateCompletionDetection : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Boolean>* transitionOutTriggerInput; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Int32>* animStateFrameInput; // 0xB0
		::FlowCanvas::ValueInput_1<::System::Int32>* animStateLayerInput; // 0xB8
		::FlowCanvas::ValueInput_1<::MoleMole::AnimStateCheckType>* stateDetectionTypeInput; // 0xC0
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::NumberCompareType>* animStateFrameCompareInput; // 0xC8
		::FlowCanvas::FlowOutput* conditionReach; // 0xD0
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* entityInput; // 0xD8
		::FlowCanvas::ValueInput_1<::System::String*>* animStateInput; // 0xE0
		::FlowCanvas::FlowOutput* output; // 0xE8
		::System::UInt32 listenId; // 0xF0
		::System::Int32 listenIdx; // 0xF4
