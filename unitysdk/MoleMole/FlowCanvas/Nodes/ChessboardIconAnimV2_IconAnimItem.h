...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2_ICONANIMITEM_GETRENDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x7A50360)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDICONANIMV2_ICONANIMITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x7A50430)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardIconAnimV2_IconAnimItem_TypeDefinitionIndex = 71569;
