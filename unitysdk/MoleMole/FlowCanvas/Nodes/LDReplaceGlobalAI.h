...
#define MOLEMOLE_FLOWCANVAS_NODES_LDREPLACEGLOBALAI_PROCESS_OFFSET UNITYSDK_OFFSET(0xC9C5D00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREPLACEGLOBALAI_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC9C5BF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREPLACEGLOBALAI__CTOR_OFFSET UNITYSDK_OFFSET(0xC9C5FB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREPLACEGLOBALAI__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xC9C5FD0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDReplaceGlobalAI_TypeDefinitionIndex = 78194;
