...
#define MOLEMOLE_FLOWCANVAS_NODES_LDREPLACEGLOBALAI_PROCESS_OFFSET UNITYSDK_OFFSET(0xBA0A740)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREPLACEGLOBALAI_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xBA0A630)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREPLACEGLOBALAI__CTOR_OFFSET UNITYSDK_OFFSET(0xBA0A9F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREPLACEGLOBALAI__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xBA0AA10)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDReplaceGlobalAI_TypeDefinitionIndex = 68133;
