...
#define MOLEMOLE_FLOWCANVAS_NODES_LDENABLEBLACKCURTAIN_INVOKE_OFFSET UNITYSDK_OFFSET(0xA7CDEF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENABLEBLACKCURTAIN_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0xA7CE1F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENABLEBLACKCURTAIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA7CE2A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENABLEBLACKCURTAIN___BASE_ONREGISTEREXTRAPORTS_OFFSET UNITYSDK_OFFSET(0xA7CE2C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDEnableBlackCurtain_TypeDefinitionIndex = 39550;
