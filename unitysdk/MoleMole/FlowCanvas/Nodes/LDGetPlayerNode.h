...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPLAYERNODE_ISENTITYACTIVE_OFFSET UNITYSDK_OFFSET(0xC9BD460)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPLAYERNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC9BD390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPLAYERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9BD710)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETPLAYERNODE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xC9BD780)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetPlayerNode_TypeDefinitionIndex = 70463;
