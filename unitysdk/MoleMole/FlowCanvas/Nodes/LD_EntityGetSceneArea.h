...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTITYGETSCENEAREA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8F0CD70)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTITYGETSCENEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x8F0CF50)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTITYGETSCENEAREA__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x8F0CF70)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTITYGETSCENEAREA__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x8F0D240)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTITYGETSCENEAREA__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x8F0D250)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTITYGETSCENEAREA__REGISTERPORTS_B__5_3_OFFSET UNITYSDK_OFFSET(0x8F0D260)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_EntityGetSceneArea_TypeDefinitionIndex = 56409;
