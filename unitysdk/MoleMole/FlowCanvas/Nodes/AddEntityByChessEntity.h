...
#define MOLEMOLE_FLOWCANVAS_NODES_ADDENTITYBYCHESSENTITY_INVOKE_OFFSET UNITYSDK_OFFSET(0xA5DEDF0)
#define MOLEMOLE_FLOWCANVAS_NODES_ADDENTITYBYCHESSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0xA5DEE80)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int AddEntityByChessEntity_TypeDefinitionIndex = 64508;
