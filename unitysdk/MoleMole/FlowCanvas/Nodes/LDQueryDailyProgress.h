...
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYDAILYPROGRESS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xF1A6BB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYDAILYPROGRESS_START_OFFSET UNITYSDK_OFFSET(0xF1A6D60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYDAILYPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0xF1A6F60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYDAILYPROGRESS__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xF1A6F80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYDAILYPROGRESS__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0xF1A6F90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDQUERYDAILYPROGRESS__REGISTERPORTS_B__4_2_OFFSET UNITYSDK_OFFSET(0xF1A6FA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDQueryDailyProgress_TypeDefinitionIndex = 65631;

	class LDQueryDailyProgress : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* _output; // 0xA8
		::System::Int32 maxIndexOut; // 0xB0
