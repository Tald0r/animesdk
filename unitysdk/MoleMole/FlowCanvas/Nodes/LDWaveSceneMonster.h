...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_BEGIN_OFFSET UNITYSDK_OFFSET(0xE0FD190)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_COLLECTMONSTERCREATEDATA_OFFSET UNITYSDK_OFFSET(0xE0FCF40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0xE0FD370)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GENERATECREATEDATA_OFFSET UNITYSDK_OFFSET(0xE0FC840)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GENERATEMONSTERCREATDATA_OFFSET UNITYSDK_OFFSET(0xE0FD070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0xE0FD250)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0xE0FD2D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0xE0FD970)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xE0FDD00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_ONRESET_OFFSET UNITYSDK_OFFSET(0xE0FD9E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE0FC4A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xE0FD690)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0xE0FDF40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0xE0FDF50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0xE0FE030)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_2_OFFSET UNITYSDK_OFFSET(0xE0FE120)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_3_OFFSET UNITYSDK_OFFSET(0xE0FE150)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_4_OFFSET UNITYSDK_OFFSET(0xE0FE160)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_5_OFFSET UNITYSDK_OFFSET(0xE0FE170)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0xE0FE180)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0xE0FE1B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0xE0FE1C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0xE0FE1D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0xE0FE1E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xE0FE1F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0xE0FE200)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE0FE210)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xE0FE220)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveSceneMonster_TypeDefinitionIndex = 67944;

	class LDWaveSceneMonster : public ::MoleMole::FlowCanvas::Nodes::LDWaveMonster
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::SceneMonsterCreateData*>*>* createSceneMonsterInputList; // 0x1B0
		...
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::MonsterCreateData*>* monsterList; // 0x1C8
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::MonsterIDType>* monsterIDTypeList; // 0x1D0
		::MoleMole::FlowCanvas::Nodes::MonsterIDType currentMonsterIdType; // 0x1D8
		::System::Boolean preLoadGenerateMonsterData; // 0x1DC
		::System::Boolean alreadyHasCreateData; // 0x1DD
