...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_BEGIN_OFFSET UNITYSDK_OFFSET(0x7A61B60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_COLLECTMONSTERCREATEDATA_OFFSET UNITYSDK_OFFSET(0x7A61910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x7A61D40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GENERATECREATEDATA_OFFSET UNITYSDK_OFFSET(0x7A61210)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GENERATEMONSTERCREATDATA_OFFSET UNITYSDK_OFFSET(0x7A61A40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x7A61C20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x7A61CA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x7A62330)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x7A626B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_ONRESET_OFFSET UNITYSDK_OFFSET(0x7A623A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7A60E70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x7A62050)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x7A628F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x7A62900)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x7A629E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_2_OFFSET UNITYSDK_OFFSET(0x7A62AD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_3_OFFSET UNITYSDK_OFFSET(0x7A62B00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_4_OFFSET UNITYSDK_OFFSET(0x7A62B10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER__REGISTERPORTS_B__8_5_OFFSET UNITYSDK_OFFSET(0x7A62B20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x7A62B30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x7A62B60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x7A62B70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x7A62B80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x7A62B90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x7A62BA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_ONRESET_OFFSET UNITYSDK_OFFSET(0x7A62BB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7A62BC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVESCENEMONSTER___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x7A62BD0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveSceneMonster_TypeDefinitionIndex = 46334;

	class LDWaveSceneMonster : public ::MoleMole::FlowCanvas::Nodes::LDWaveMonster
	{
	public:
		::System::String* lastGenerateDataStage; // 0x1B0
		...
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::MonsterIDType>* monsterIDTypeList; // 0x1C8
