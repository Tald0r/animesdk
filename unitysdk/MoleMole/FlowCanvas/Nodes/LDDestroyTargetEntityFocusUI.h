...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI_ONENTITYREADY_OFFSET UNITYSDK_OFFSET(0x141D3160)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x141D2880)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI_START_INVOKE_OFFSET UNITYSDK_OFFSET(0x141D29B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI__CTOR_OFFSET UNITYSDK_OFFSET(0x141D3220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x141D3240)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI___SENDENTITYDESTROYTARGETUI_OFFSET UNITYSDK_OFFSET(0x141D2CC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDestroyTargetEntityFocusUI_TypeDefinitionIndex = 51406;

	class LDDestroyTargetEntityFocusUI : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Boolean>* removeHpBarInput; // 0xA8
