...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI_ONENTITYREADY_OFFSET UNITYSDK_OFFSET(0xA4F92F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA4F8A10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI_START_INVOKE_OFFSET UNITYSDK_OFFSET(0xA4F8B40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI__CTOR_OFFSET UNITYSDK_OFFSET(0xA4F93B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0xA4F93D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTARGETENTITYFOCUSUI___SENDENTITYDESTROYTARGETUI_OFFSET UNITYSDK_OFFSET(0xA4F8E50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDestroyTargetEntityFocusUI_TypeDefinitionIndex = 43588;
