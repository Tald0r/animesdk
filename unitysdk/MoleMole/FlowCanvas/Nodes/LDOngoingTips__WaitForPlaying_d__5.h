...
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS__WAITFORPLAYING_D__5_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8AF74D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS__WAITFORPLAYING_D__5_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8AF76E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS__WAITFORPLAYING_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8AF7740)
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS__WAITFORPLAYING_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x8AF76F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS__WAITFORPLAYING_D__5_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8AF74C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS__WAITFORPLAYING_D__5__CTOR_OFFSET UNITYSDK_OFFSET(0x8AF74B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDOngoingTips__WaitForPlaying_d__5_TypeDefinitionIndex = 56077;

	class LDOngoingTips__WaitForPlaying_d__5 : public ::System::Object
	{
	public:
		::System::Object* __2__current; // 0x10
		::Class_0_16E4307DCC419505_558* inLevel; // 0x18
		::FlowCanvas::FlowOutput* finish; // 0x20
		::MoleMole::FlowCanvas::Nodes::LDOngoingTips___c__DisplayClass5_0* __8__1; // 0x28
