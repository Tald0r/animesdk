...
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS__WAITFORPLAYING_D__5_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1164E060)
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS__WAITFORPLAYING_D__5_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1164E270)
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS__WAITFORPLAYING_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1164E2D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS__WAITFORPLAYING_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1164E280)
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS__WAITFORPLAYING_D__5_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1164E050)
#define MOLEMOLE_FLOWCANVAS_NODES_LDONGOINGTIPS__WAITFORPLAYING_D__5__CTOR_OFFSET UNITYSDK_OFFSET(0x1164E040)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDOngoingTips__WaitForPlaying_d__5_TypeDefinitionIndex = 80997;

	class LDOngoingTips__WaitForPlaying_d__5 : public ::System::Object
	{
	public:
		::FlowCanvas::FlowOutput* finish; // 0x10
		::Class_0_16E4307DCC419505_131* inLevel; // 0x18
