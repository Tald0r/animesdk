...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xB829540)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xB829EC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB82A030)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xB82A050)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateMonsterNode_TypeDefinitionIndex = 51647;
