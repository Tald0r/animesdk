...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xC212C70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xC2135F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC213760)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEMONSTERNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xC213780)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateMonsterNode_TypeDefinitionIndex = 47601;
