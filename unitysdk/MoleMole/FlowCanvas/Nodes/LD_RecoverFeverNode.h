...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_RECOVERFEVERNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xD0D9E80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_RECOVERFEVERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0DA0C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_RecoverFeverNode_TypeDefinitionIndex = 69216;
