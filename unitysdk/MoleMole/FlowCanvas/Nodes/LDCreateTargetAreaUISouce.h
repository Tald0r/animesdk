...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETARGETAREAUISOUCE_INVOKE_OFFSET UNITYSDK_OFFSET(0xF19FF70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETARGETAREAUISOUCE__CTOR_OFFSET UNITYSDK_OFFSET(0xF1A01E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateTargetAreaUISouce_TypeDefinitionIndex = 48333;
