...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSENDCHECKPOINT2SERVER_INVOKE_OFFSET UNITYSDK_OFFSET(0xB5D8C50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSENDCHECKPOINT2SERVER__CTOR_OFFSET UNITYSDK_OFFSET(0xB5D8E30)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSendCheckPoint2Server_TypeDefinitionIndex = 48623;
