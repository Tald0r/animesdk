...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATELEVELSECTIONDATA_INVOKE_OFFSET UNITYSDK_OFFSET(0xE473F00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATELEVELSECTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE474060)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateLevelSectionData_TypeDefinitionIndex = 53125;
