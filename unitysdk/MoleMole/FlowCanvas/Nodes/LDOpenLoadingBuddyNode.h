...
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENLOADINGBUDDYNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xCCE2E00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENLOADINGBUDDYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCCE2EB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENLOADINGBUDDYNODE__INVOKE_B__2_0_OFFSET UNITYSDK_OFFSET(0xCCE2ED0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDOPENLOADINGBUDDYNODE__INVOKE_B__2_1_OFFSET UNITYSDK_OFFSET(0xCCE2EE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDOpenLoadingBuddyNode_TypeDefinitionIndex = 61622;
