...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETLEVELCONDITIONTARGETNUM_INVOKE_OFFSET UNITYSDK_OFFSET(0xC2CAFF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETLEVELCONDITIONTARGETNUM__CTOR_OFFSET UNITYSDK_OFFSET(0xC2CB2B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_GetLevelConditionTargetNum_TypeDefinitionIndex = 76701;
