...
#define MOLEMOLE_FLOWCANVAS_NODES_LDINITCAMERADATANODE_INITCAMERACOMPONENT_OFFSET UNITYSDK_OFFSET(0xE0F1B90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDINITCAMERADATANODE_INITCAMERADATA_OFFSET UNITYSDK_OFFSET(0xE0F1A60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDINITCAMERADATANODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xE0F1BF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDINITCAMERADATANODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE0F1CA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDInitCameraDataNode_TypeDefinitionIndex = 52628;
