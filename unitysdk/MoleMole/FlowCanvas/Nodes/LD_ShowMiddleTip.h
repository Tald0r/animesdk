...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWMIDDLETIP_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xD0DB130)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWMIDDLETIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0DB410)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWMIDDLETIP__GETCREATEDTIPOBJECT_OFFSET UNITYSDK_OFFSET(0xD0DB3A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWMIDDLETIP__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0xD0DB430)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWMIDDLETIP__REGISTERPORTS_B__11_1_OFFSET UNITYSDK_OFFSET(0xD0DB930)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOWMIDDLETIP__REGISTERPORTS_B__11_2_OFFSET UNITYSDK_OFFSET(0xD0DB990)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ShowMiddleTip_TypeDefinitionIndex = 60842;

	class LD_ShowMiddleTip : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Boolean>* show; // 0xA8
		::FlowCanvas::FlowInput* Hide; // 0xB0
		::FlowCanvas::ValueInput_1<::System::Boolean>* showIcon; // 0xB8
		::FlowCanvas::FlowOutput* ShowOutput; // 0xC0
		::MoleMole::UIMiddleTip* _middleTip; // 0xC8
		::FlowCanvas::FlowOutput* HideOutput; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Int32>* tipID; // 0xD8
		::FlowCanvas::ValueInput_1<::System::Int32>* showPage; // 0xE0
		::FlowCanvas::ValueInput_1<::System::String*>* updateText; // 0xE8
		::FlowCanvas::FlowInput* Show; // 0xF0
		::FlowCanvas::ValueInput_1<::System::String*>* debugText; // 0xF8
