...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CURINTERACTIONNPCID_INVOKE_OFFSET UNITYSDK_OFFSET(0x6787280)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CURINTERACTIONNPCID__CTOR_OFFSET UNITYSDK_OFFSET(0x6787330)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_CurInteractionNpcId_TypeDefinitionIndex = 66905;
