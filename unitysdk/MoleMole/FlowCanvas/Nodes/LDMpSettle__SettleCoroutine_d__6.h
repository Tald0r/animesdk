...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPSETTLE__SETTLECOROUTINE_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD0D34F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPSETTLE__SETTLECOROUTINE_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD0D3670)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPSETTLE__SETTLECOROUTINE_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD0D36D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPSETTLE__SETTLECOROUTINE_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD0D3680)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPSETTLE__SETTLECOROUTINE_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD0D34E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPSETTLE__SETTLECOROUTINE_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0xD0D34D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMpSettle__SettleCoroutine_d__6_TypeDefinitionIndex = 77470;
