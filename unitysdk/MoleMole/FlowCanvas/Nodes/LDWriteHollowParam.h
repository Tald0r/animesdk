...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWRITEHOLLOWPARAM_INVOKE_OFFSET UNITYSDK_OFFSET(0xE0FE230)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWRITEHOLLOWPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xE0FE420)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWriteHollowParam_TypeDefinitionIndex = 53007;
