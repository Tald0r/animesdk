...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWRITEHOLLOWPARAM_INVOKE_OFFSET UNITYSDK_OFFSET(0x7A62BE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWRITEHOLLOWPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x7A62DD0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWriteHollowParam_TypeDefinitionIndex = 47033;
