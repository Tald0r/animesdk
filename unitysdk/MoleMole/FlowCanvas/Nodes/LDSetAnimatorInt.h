...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORINT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8F75E10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORINT__CTOR_OFFSET UNITYSDK_OFFSET(0x8F75F60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORINT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x8F75F80)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetAnimatorInt_TypeDefinitionIndex = 65600;
