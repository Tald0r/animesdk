...
#define MOLEMOLE_FLOWCANVAS_NODES_WAVEMONSTERINFO_GETVALUE_OFFSET UNITYSDK_OFFSET(0x6AF78D0)
#define MOLEMOLE_FLOWCANVAS_NODES_WAVEMONSTERINFO_SETVALUE_OFFSET UNITYSDK_OFFSET(0x6AF79F0)
#define MOLEMOLE_FLOWCANVAS_NODES_WAVEMONSTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x6AF7AF0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int WaveMonsterInfo_TypeDefinitionIndex = 55271;
