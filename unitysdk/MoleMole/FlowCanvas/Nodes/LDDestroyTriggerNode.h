...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTRIGGERNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA4F9400)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTRIGGERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA4F9510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDESTROYTRIGGERNODE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xA4F9530)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDestroyTriggerNode_TypeDefinitionIndex = 64943;
