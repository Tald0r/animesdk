...
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERRANDOMSELECTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x990EC90)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int MonsterRandomSelectItem_TypeDefinitionIndex = 52394;
