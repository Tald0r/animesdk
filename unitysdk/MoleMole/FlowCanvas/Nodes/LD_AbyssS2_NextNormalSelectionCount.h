...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_NEXTNORMALSELECTIONCOUNT_INVOKE_OFFSET UNITYSDK_OFFSET(0x8B08190)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_NEXTNORMALSELECTIONCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x8B08360)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_NextNormalSelectionCount_TypeDefinitionIndex = 63921;
