...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0xE871C20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE871910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE_TRYCALLFINISH_OFFSET UNITYSDK_OFFSET(0xE871AC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE_TRYCALLOUTPUT_OFFSET UNITYSDK_OFFSET(0xE871B70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0xE872060)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0xE872080)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPlayParallelTimeline_TypeDefinitionIndex = 67317;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::String*>* _timelineDataKey; // 0xB0
		::FlowCanvas::FlowOutput* _output; // 0xB8
		::FlowCanvas::ValueInput_1<::System::Boolean>* _muteInLevelInput; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Boolean>* _hideInLevelUIAndMuteInput; // 0xC8
