...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0xCD40800)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xCD404F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE_TRYCALLFINISH_OFFSET UNITYSDK_OFFSET(0xCD406A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE_TRYCALLOUTPUT_OFFSET UNITYSDK_OFFSET(0xCD40750)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD40C40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPLAYPARALLELTIMELINE__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0xCD40C60)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPlayParallelTimeline_TypeDefinitionIndex = 78676;

	class LDPlayParallelTimeline : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Boolean>* _hideInLevelUIAndMuteInput; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Boolean>* _muteInLevelInput; // 0xB0
		::FlowCanvas::FlowOutput* _finish; // 0xB8
		::FlowCanvas::ValueInput_1<::System::Boolean>* _isSyncLoad; // 0xC0
		::FlowCanvas::ValueInput_1<::System::String*>* _customTag; // 0xC8
		::FlowCanvas::ValueInput_1<::System::String*>* _timelineDataKey; // 0xD0
