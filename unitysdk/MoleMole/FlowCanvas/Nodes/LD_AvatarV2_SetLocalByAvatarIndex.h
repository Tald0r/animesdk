...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARV2_SETLOCALBYAVATARINDEX_PROCESS_OFFSET UNITYSDK_OFFSET(0xC9CB180)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARV2_SETLOCALBYAVATARINDEX_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC9CB050)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARV2_SETLOCALBYAVATARINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xC9CB370)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARV2_SETLOCALBYAVATARINDEX__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0xC9CB390)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AvatarV2_SetLocalByAvatarIndex_TypeDefinitionIndex = 51187;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* targetAvatarIndex; // 0xB8
