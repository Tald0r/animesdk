...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETMONSTERLEVELFROMCARDLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0xD0CFB60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETMONSTERLEVELFROMCARDLIST__CTOR_OFFSET UNITYSDK_OFFSET(0xD0D0170)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETMONSTERLEVELFROMCARDLIST__GETMONSTERLEVEL_OFFSET UNITYSDK_OFFSET(0xD0CFCE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetMonsterLevelFromCardList_TypeDefinitionIndex = 53889;
