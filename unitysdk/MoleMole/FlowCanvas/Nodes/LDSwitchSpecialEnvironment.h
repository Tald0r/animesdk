...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSWITCHSPECIALENVIRONMENT_INVOKE_OFFSET UNITYSDK_OFFSET(0xE47D920)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSWITCHSPECIALENVIRONMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xE47DD00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSwitchSpecialEnvironment_TypeDefinitionIndex = 44683;
