...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x9909240)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x9909530)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x990A1D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_GET_ISOPENDEBUGFETCH_OFFSET UNITYSDK_OFFSET(0x9908F90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_ISSHOWELE_OFFSET UNITYSDK_OFFSET(0x9909110)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x9909010)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x99096D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__CCTOR_OFFSET UNITYSDK_OFFSET(0x990A660)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__CONFIRMTREASURECOUNT_OFFSET UNITYSDK_OFFSET(0x9909380)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__CTOR_OFFSET UNITYSDK_OFFSET(0x990A650)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x990A720)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__TRYCREATEMONSTER_G____CALLCREATEMONSTER_10_0_OFFSET UNITYSDK_OFFSET(0x9909F70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__TRYFETCHTREASUREID_OFFSET UNITYSDK_OFFSET(0x9909CB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x990A730)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x990A740)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___BASE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0x990A750)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___BASE_ISSHOWELE_OFFSET UNITYSDK_OFFSET(0x990A760)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x990A7D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x990A7E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___TRYFETCHTREASUREID_G___CHECKONCE_12_0_OFFSET UNITYSDK_OFFSET(0x990A230)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___TRYFETCHTREASUREID_G___CHECKREPEAT_12_1_OFFSET UNITYSDK_OFFSET(0x990A440)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveTreasure_TypeDefinitionIndex = 69039;
	...
	public:
		...
		{
			return (::ParadoxNotion::Serialization::Graph_BinarySerializer_Setting_OptBool**)Il2CppClass::FromTypeDefinitionIndex(LDWaveTreasure_TypeDefinitionIndex)->GetStaticField(0x344B0);
		}
		...
		::System::Void _TryFetchTreasureID(::System::Int32 treasureID, ::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E>*& baseIDs, ::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E>*& subIDs)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E>*&, ::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E>*&))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__TRYFETCHTREASUREID_OFFSET))(this, treasureID, baseIDs, subIDs);
		}
		...
		::System::Void _TryCreateMonster_g____CallCreateMonster_10_0(::Struct_2_A725E4562D03EA4E tPair, ::System::Boolean isBaseID, ::MoleMole::FlowCanvas::Nodes::LDWaveTreasure___c__DisplayClass10_0& a3, ::MoleMole::FlowCanvas::Nodes::LDWaveTreasure___c__DisplayClass10_1& a4)
		{
			return ((::System::Void(*)(::PVOID, ::Struct_2_A725E4562D03EA4E, ::System::Boolean, ::MoleMole::FlowCanvas::Nodes::LDWaveTreasure___c__DisplayClass10_0&, ::MoleMole::FlowCanvas::Nodes::LDWaveTreasure___c__DisplayClass10_1&))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__TRYCREATEMONSTER_G____CALLCREATEMONSTER_10_0_OFFSET))(this, tPair, isBaseID, a3, a4);
		}

		static ::System::Void __TryFetchTreasureID_g___CheckOnce_12_0(::Class_1_48F4A404A08692BE_12* rewardConfigTemplate, ::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E>* retList)
		{
			return ((::System::Void(*)(::Class_1_48F4A404A08692BE_12*, ::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E>*))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___TRYFETCHTREASUREID_G___CHECKONCE_12_0_OFFSET))(rewardConfigTemplate, retList);
		}

		static ::System::Void __TryFetchTreasureID_g___CheckRepeat_12_1(::Class_1_48F4A404A08692BE_12* rewardConfigTemplate, ::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E>* retList)
		{
			return ((::System::Void(*)(::Class_1_48F4A404A08692BE_12*, ::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E>*))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___TRYFETCHTREASUREID_G___CHECKREPEAT_12_1_OFFSET))(rewardConfigTemplate, retList);
		}
