...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0xA504080)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0xA504370)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0xA505010)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_GET_ISOPENDEBUGFETCH_OFFSET UNITYSDK_OFFSET(0xA503DD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_ISSHOWELE_OFFSET UNITYSDK_OFFSET(0xA503F50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA503E50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xA504510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__CCTOR_OFFSET UNITYSDK_OFFSET(0xA5054A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__CONFIRMTREASURECOUNT_OFFSET UNITYSDK_OFFSET(0xA5041C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__CTOR_OFFSET UNITYSDK_OFFSET(0xA505490)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0xA505560)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__TRYCREATEMONSTER_G____CALLCREATEMONSTER_10_0_OFFSET UNITYSDK_OFFSET(0xA504DB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE__TRYFETCHTREASUREID_OFFSET UNITYSDK_OFFSET(0xA504AF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0xA505570)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0xA505580)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___BASE_GETCURRENTMONSTERIDTYPE_OFFSET UNITYSDK_OFFSET(0xA505590)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___BASE_ISSHOWELE_OFFSET UNITYSDK_OFFSET(0xA5055A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA505610)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xA505620)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___TRYFETCHTREASUREID_G___CHECKONCE_12_0_OFFSET UNITYSDK_OFFSET(0xA505070)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___TRYFETCHTREASUREID_G___CHECKREPEAT_12_1_OFFSET UNITYSDK_OFFSET(0xA505280)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveTreasure_TypeDefinitionIndex = 79754;
	...
	public:
		...
		{
			return (::ParadoxNotion::Serialization::Graph_BinarySerializer_Setting_OptBool**)Il2CppClass::FromTypeDefinitionIndex(LDWaveTreasure_TypeDefinitionIndex)->GetStaticField(0x36E20);
		}
		...
		static ::System::Void __TryFetchTreasureID_g___CheckOnce_12_0(::Class_1_48F4A404A08692BE_181* rewardConfigTemplate, ::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E_1>* retList)
		{
			return ((::System::Void(*)(::Class_1_48F4A404A08692BE_181*, ::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E_1>*))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___TRYFETCHTREASUREID_G___CHECKONCE_12_0_OFFSET))(rewardConfigTemplate, retList);
		}

		static ::System::Void __TryFetchTreasureID_g___CheckRepeat_12_1(::Class_1_48F4A404A08692BE_181* rewardConfigTemplate, ::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E_1>* retList)
		{
			return ((::System::Void(*)(::Class_1_48F4A404A08692BE_181*, ::System::Collections::Generic::List_1<::Struct_2_A725E4562D03EA4E_1>*))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LDWAVETREASURE___TRYFETCHTREASUREID_G___CHECKREPEAT_12_1_OFFSET))(rewardConfigTemplate, retList);
		}
