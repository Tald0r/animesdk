...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_RESETTEAMAVATARVISIBILITY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA5EBBD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_RESETTEAMAVATARVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0xA5EBCB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_RESETTEAMAVATARVISIBILITY__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0xA5EBCD0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_ResetTeamAvatarVisibility_TypeDefinitionIndex = 70153;
