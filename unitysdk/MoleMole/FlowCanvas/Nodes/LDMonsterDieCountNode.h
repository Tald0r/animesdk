...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0xB5D58F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_CHECKDIECOUNT_OFFSET UNITYSDK_OFFSET(0xB5D5470)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_CHECKFINISH_OFFSET UNITYSDK_OFFSET(0xB5D6FB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_CHECKMONSTERDIETYPE_OFFSET UNITYSDK_OFFSET(0xB5D69D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_COMPAREMONSTERCAMP_OFFSET UNITYSDK_OFFSET(0xB5D7270)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_FINDINMONSTERMAP_OFFSET UNITYSDK_OFFSET(0xB5D67D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xB5D4EE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ISMATCHMONSTER_OFFSET UNITYSDK_OFFSET(0xB5D6590)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xB5D5C80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xB5D5880)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xB5D5BA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONLATETICKCALLBACK_OFFSET UNITYSDK_OFFSET(0xB5D5C10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONMONSTERDIE_OFFSET UNITYSDK_OFFSET(0xB5D5DB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB5D4920)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_STOP_OFFSET UNITYSDK_OFFSET(0xB5D4B90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0xB5D4C30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE__CALLREACHFLOW_OFFSET UNITYSDK_OFFSET(0xB5D71E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB5D74B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE__REGISTERPORTS_B__14_0_OFFSET UNITYSDK_OFFSET(0xB5D74D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE__REGISTERPORTS_B__14_1_OFFSET UNITYSDK_OFFSET(0xB5D76B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xB5D7780)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xB5D7790)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMonsterDieCountNode_TypeDefinitionIndex = 41594;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* triggerCountInput; // 0xE8
		::System::Int32 alreadyTriggerCount; // 0xF0
		::System::Int32 currentDieCount; // 0xF4
		::System::Boolean bindEvent; // 0xF8
		::System::Boolean nodeEnter; // 0xF9
		::System::Boolean goalReached; // 0xFA
