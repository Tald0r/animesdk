...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x6AE6690)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_CHECKDIECOUNT_OFFSET UNITYSDK_OFFSET(0x6AE6200)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_CHECKFINISH_OFFSET UNITYSDK_OFFSET(0x6AE7D60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_CHECKMONSTERDIETYPE_OFFSET UNITYSDK_OFFSET(0x6AE7780)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_COMPAREMONSTERCAMP_OFFSET UNITYSDK_OFFSET(0x6AE8020)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_FINDINMONSTERMAP_OFFSET UNITYSDK_OFFSET(0x6AE7580)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x6AE5C70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ISMATCHMONSTER_OFFSET UNITYSDK_OFFSET(0x6AE7340)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x6AE6A30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x6AE6620)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x6AE6950)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONLATETICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x6AE69C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_ONMONSTERDIE_OFFSET UNITYSDK_OFFSET(0x6AE6B60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6AE56B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_STOP_OFFSET UNITYSDK_OFFSET(0x6AE5910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x6AE59B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE__CALLREACHFLOW_OFFSET UNITYSDK_OFFSET(0x6AE7F90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6AE8260)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE__REGISTERPORTS_B__14_0_OFFSET UNITYSDK_OFFSET(0x6AE8280)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE__REGISTERPORTS_B__14_1_OFFSET UNITYSDK_OFFSET(0x6AE8450)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x6AE8520)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMONSTERDIECOUNTNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x6AE8530)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMonsterDieCountNode_TypeDefinitionIndex = 58024;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* triggerCountInput; // 0xB8
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::EntitySaveDataMap*>* inputEntityMap; // 0xC0
		::FlowCanvas::FlowOutput* Reached; // 0xC8
		::FlowCanvas::ValueInput_1<::System::Boolean>* allMonsterInput; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Int32>* inputNumber; // 0xD8
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::EntityDieCheckType>* inputDeathCheckType; // 0xE0
		::System::Collections::Generic::HashSet_1<::System::UInt32>* dieMonsterSet; // 0xE8
		::System::Int32 currentDieCount; // 0xF0
		::System::Int32 alreadyTriggerCount; // 0xF4
		::System::Boolean goalReached; // 0xF8
		::System::Boolean nodeEnter; // 0xF9
		::System::Boolean bindEvent; // 0xFA
