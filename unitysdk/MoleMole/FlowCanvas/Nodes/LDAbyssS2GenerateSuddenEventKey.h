...
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2GENERATESUDDENEVENTKEY_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xA4F6A80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2GENERATESUDDENEVENTKEY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA4F69B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2GENERATESUDDENEVENTKEY__CTOR_OFFSET UNITYSDK_OFFSET(0xA4F6CA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2GENERATESUDDENEVENTKEY__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0xA4F6CC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDABYSSS2GENERATESUDDENEVENTKEY___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xA4F6CD0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAbyssS2GenerateSuddenEventKey_TypeDefinitionIndex = 51836;
