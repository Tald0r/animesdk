...
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYSKILLINFO_FROMPROTO_OFFSET UNITYSDK_OFFSET(0xD0DDF10)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYSKILLINFO_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0xD0DDEE0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYSKILLINFO_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xD0DDEC0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYSKILLINFO_SET_ISNEW_OFFSET UNITYSDK_OFFSET(0xD0DDEF0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYSKILLINFO_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0xD0DDED0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYSKILLINFO_TOPROTO_OFFSET UNITYSDK_OFFSET(0xD0DDFE0)
#define MOLEMOLE_FLOWCANVAS_NODES_MONSTERFANTASYSKILLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD0DDF00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int MonsterFantasySkillInfo_TypeDefinitionIndex = 80322;
