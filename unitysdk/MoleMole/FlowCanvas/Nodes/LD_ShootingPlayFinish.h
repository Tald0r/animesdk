...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOOTINGPLAYFINISH_ONREGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xD809920)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOOTINGPLAYFINISH_START_OFFSET UNITYSDK_OFFSET(0xD809A10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOOTINGPLAYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0xD809C00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ShootingPlayFinish_TypeDefinitionIndex = 61128;
