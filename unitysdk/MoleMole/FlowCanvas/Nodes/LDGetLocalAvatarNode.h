...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLOCALAVATARNODE_GETLOCALAVATAR_OFFSET UNITYSDK_OFFSET(0x6ADEC60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLOCALAVATARNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6ADEED0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLOCALAVATARNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6ADEFA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLOCALAVATARNODE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x6ADEFC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetLocalAvatarNode_TypeDefinitionIndex = 51599;
