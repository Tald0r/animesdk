...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CHANGEHENSHINBUDDYPLAYTYPE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7F07590)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CHANGEHENSHINBUDDYPLAYTYPE_START_INTERACT_OFFSET UNITYSDK_OFFSET(0x7F076A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CHANGEHENSHINBUDDYPLAYTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x7F078D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CHANGEHENSHINBUDDYPLAYTYPE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x7F078F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ChangeHenshinBuddyPlayType_TypeDefinitionIndex = 42565;
