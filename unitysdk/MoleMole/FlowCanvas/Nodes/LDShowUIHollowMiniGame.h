...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_CACHEAUDIOSTATE_OFFSET UNITYSDK_OFFSET(0x7A5B2F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_CLOSEBIGTVMINIGAME_OFFSET UNITYSDK_OFFSET(0x7A5C850)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_ENTERBIGTV_OFFSET UNITYSDK_OFFSET(0x7A5B730)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_HANDLELEVELTIMER_OFFSET UNITYSDK_OFFSET(0x7A5C1A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_ONENTERSCENE_OFFSET UNITYSDK_OFFSET(0x7A5C320)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_ONHOLLOWCHANGECHESSBOARD_OFFSET UNITYSDK_OFFSET(0x7A5B4C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7A5ABD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_RESTOREAUDIOSTATE_OFFSET UNITYSDK_OFFSET(0x7A5CAC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_SHOWBIGTVMINIGAME_OFFSET UNITYSDK_OFFSET(0x7A5BE80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_SHOWHOLLOWMINIGAME_OFFSET UNITYSDK_OFFSET(0x7A5AD80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_STARTPUSHBOX_OFFSET UNITYSDK_OFFSET(0x7A5B7B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME_STOPPUSHBOX_OFFSET UNITYSDK_OFFSET(0x7A5C960)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x7A5CCE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIHOLLOWMINIGAME__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x7A5CD00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowUIHollowMiniGame_TypeDefinitionIndex = 60605;

	class LDShowUIHollowMiniGame : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::MoleMole::UIHollowMiniGamePopWindowController* _miniGamePopWindow; // 0xA8
		...
		::System::String* _cachedAudioGameStateValue; // 0xC8
		::FlowCanvas::ValueInput_1<::System::Boolean>* _skipFadeOutOnFail; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Int32>* _gameIDInput; // 0xD8
