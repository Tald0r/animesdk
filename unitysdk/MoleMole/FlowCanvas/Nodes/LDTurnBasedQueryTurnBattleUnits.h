...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDQUERYTURNBATTLEUNITS_INVOKE_OFFSET UNITYSDK_OFFSET(0xE47DDB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDQUERYTURNBATTLEUNITS__CTOR_OFFSET UNITYSDK_OFFSET(0xE47DF90)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedQueryTurnBattleUnits_TypeDefinitionIndex = 41601;
