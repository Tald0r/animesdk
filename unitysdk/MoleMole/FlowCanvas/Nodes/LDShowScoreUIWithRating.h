...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING_GETONRESTARTPARAM_OFFSET UNITYSDK_OFFSET(0xA015BB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING_GETONSTARTPARAM_OFFSET UNITYSDK_OFFSET(0xA015990)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA015870)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING__CTOR_OFFSET UNITYSDK_OFFSET(0xA015DD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING__GETONRESTARTPARAM_B__6_0_OFFSET UNITYSDK_OFFSET(0xA015F40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING__GETONRESTARTPARAM_B__6_1_OFFSET UNITYSDK_OFFSET(0xA016010)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING__GETONSTARTPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0xA015DE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING__GETONSTARTPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0xA015EB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING___BASE_GETONRESTARTPARAM_OFFSET UNITYSDK_OFFSET(0xA0160A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING___BASE_GETONSTARTPARAM_OFFSET UNITYSDK_OFFSET(0xA0160B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWSCOREUIWITHRATING___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA0160C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowScoreUIWithRating_TypeDefinitionIndex = 47063;

	class LDShowScoreUIWithRating : public ::MoleMole::FlowCanvas::Nodes::LDShowScoreUI
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Single>* progress; // 0x100
		::FlowCanvas::ValueInput_1<::System::Boolean>* hideProgress; // 0x108
		::FlowCanvas::ValueInput_1<::System::String*>* dynamicRatingIconPresetKey; // 0x110
