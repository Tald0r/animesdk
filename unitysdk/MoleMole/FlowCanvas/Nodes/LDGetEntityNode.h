...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYNODE_GETENTITY_OFFSET UNITYSDK_OFFSET(0xA4FA0F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA4FA280)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA4FA380)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYNODE__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0xA4FA3A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetEntityNode_TypeDefinitionIndex = 46031;
