...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYNODE_GETENTITY_OFFSET UNITYSDK_OFFSET(0x141D3F60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x141D40F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x141D41F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETENTITYNODE__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x141D4210)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetEntityNode_TypeDefinitionIndex = 39499;
