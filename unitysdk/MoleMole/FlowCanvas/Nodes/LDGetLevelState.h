...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE_BEGIN_OFFSET UNITYSDK_OFFSET(0xA382C00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA3828F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xA382D10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xA382D30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0xA382DB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE__REGISTERPORTS_B__4_2_OFFSET UNITYSDK_OFFSET(0xA382E30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLEVELSTATE__REGISTERPORTS_B__4_3_OFFSET UNITYSDK_OFFSET(0xA382EB0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetLevelState_TypeDefinitionIndex = 54215;

	class LDGetLevelState : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* _output; // 0xA8
		::Struct_2_A47ACAABA9AAFE92 stateValue; // 0xB0
		::FlowCanvas::FlowInput* beginFlowInput; // 0xC8
