...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMECHBOOGETSERVERROBOTID_INVOKE_OFFSET UNITYSDK_OFFSET(0xC9C09C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMECHBOOGETSERVERROBOTID__CTOR_OFFSET UNITYSDK_OFFSET(0xC9C0A20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMechBooGetServerRobotID_TypeDefinitionIndex = 73538;
