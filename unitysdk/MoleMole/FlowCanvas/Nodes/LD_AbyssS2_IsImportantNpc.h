...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ISIMPORTANTNPC_INVOKE_OFFSET UNITYSDK_OFFSET(0xD807510)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ISIMPORTANTNPC__CTOR_OFFSET UNITYSDK_OFFSET(0xD807680)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_IsImportantNpc_TypeDefinitionIndex = 65889;
