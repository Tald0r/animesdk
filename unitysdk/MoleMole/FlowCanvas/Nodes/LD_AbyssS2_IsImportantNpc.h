...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ISIMPORTANTNPC_INVOKE_OFFSET UNITYSDK_OFFSET(0xE47F4F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ISIMPORTANTNPC__CTOR_OFFSET UNITYSDK_OFFSET(0xE47F660)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_IsImportantNpc_TypeDefinitionIndex = 71904;
