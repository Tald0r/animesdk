...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETANIMATORINT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE8699B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETANIMATORINT__CTOR_OFFSET UNITYSDK_OFFSET(0xE869AD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETANIMATORINT__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0xE869AF0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetAnimatorInt_TypeDefinitionIndex = 78905;
