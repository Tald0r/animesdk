...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENDINLEVELCHATBYDYNAMICCHATID_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC21FBF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENDINLEVELCHATBYDYNAMICCHATID__CTOR_OFFSET UNITYSDK_OFFSET(0xC21FD00)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENDINLEVELCHATBYDYNAMICCHATID__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xC21FD20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_EndInLevelChatByDynamicChatId_TypeDefinitionIndex = 61155;
