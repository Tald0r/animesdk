...
#define MOLEMOLE_FLOWCANVAS_NODES_LDFAIRYTEXTMIDDLETIP_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA5E47A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDFAIRYTEXTMIDDLETIP__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E4910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDFAIRYTEXTMIDDLETIP__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0xA5E4930)
#define MOLEMOLE_FLOWCANVAS_NODES_LDFAIRYTEXTMIDDLETIP__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0xA5E4A20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDFairyTextMiddleTip_TypeDefinitionIndex = 78137;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::String*>* NoMiddleTipText; // 0xB8
		::FlowCanvas::ValueOutput_1<::System::String*>* FinalText; // 0xC0
