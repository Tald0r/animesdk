...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMUTEENEMYINDICATOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x8AF6650)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMUTEENEMYINDICATOR_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8AF6540)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMUTEENEMYINDICATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x8AF6B00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMUTEENEMYINDICATOR__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x8AF6B20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMuteEnemyIndicator_TypeDefinitionIndex = 72317;
