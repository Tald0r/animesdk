...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0xCCE4AD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xCCE4A00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xCCE4F80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS__CTOR_OFFSET UNITYSDK_OFFSET(0xCCE5130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS___BASE_FULLCREATEDLIST_OFFSET UNITYSDK_OFFSET(0xCCE51C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xCCE51D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRANDOMWAVEMONSTERWITHRANDOMPOS___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xCCE51E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDRandomWaveMonsterWithRandomPos_TypeDefinitionIndex = 49840;
