...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDCASTTOENTITYUNIT_INVOKE_OFFSET UNITYSDK_OFFSET(0xEC83D50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDCASTTOENTITYUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0xEC83ED0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedCastToEntityUnit_TypeDefinitionIndex = 65108;
