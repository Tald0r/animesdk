...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA_CHOOSEACTION_OFFSET UNITYSDK_OFFSET(0x6789200)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x6789660)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x67896D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA_ONSELECTEDCALL_OFFSET UNITYSDK_OFFSET(0x67895C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA_REFRESHACTION_OFFSET UNITYSDK_OFFSET(0x6789190)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x67884B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA__CHOOSEACTION_B__13_0_OFFSET UNITYSDK_OFFSET(0x6789A60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA__CHOOSEACTION_G___DELAYWAIT_13_1_OFFSET UNITYSDK_OFFSET(0x6789D50)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA__CTOR_OFFSET UNITYSDK_OFFSET(0x6789740)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA__ONRECV_OFFSET UNITYSDK_OFFSET(0x67889C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA__REFRESHCARD_OFFSET UNITYSDK_OFFSET(0x6788630)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x6789760)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0x6789770)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x6789DA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x6789DB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA___REFRESHCARD_B__8_0_OFFSET UNITYSDK_OFFSET(0x6789870)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA___REFRESHCARD_B__8_1_OFFSET UNITYSDK_OFFSET(0x67899C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_GetTarotCardGacha_TypeDefinitionIndex = 73170;
	...
	public:
		...
		::Class_1_F7E5D5115AAF8D85* _ldGetTarot; // 0xC8
		...
		::System::Void _OnRecv(::System::Collections::Generic::IList_1<::Class_3_6EF456A21AE85EEC_161*>* cardCachaDataList, ::System::Int32 refreshCount, ::System::Boolean isRefreshNew)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::IList_1<::Class_3_6EF456A21AE85EEC_161*>*, ::System::Int32, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA__ONRECV_OFFSET))(this, cardCachaDataList, refreshCount, isRefreshNew);
		}
		...
		::System::Void __RefreshCard_b__8_0(::System::Boolean b, ::Class_3_053A7430E9F1DCE4_2* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::Class_3_053A7430E9F1DCE4_2*))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA___REFRESHCARD_B__8_0_OFFSET))(this, b, rsp);
		}
