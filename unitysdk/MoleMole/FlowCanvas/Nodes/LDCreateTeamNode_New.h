...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC2BC430)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__CHECKREADY_OFFSET UNITYSDK_OFFSET(0xC2BC5C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC2BC7A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0xC2BC7C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0xC2BCBB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW___CHECKREADY_G____CHECKREADYCOROTINE_6_0_OFFSET UNITYSDK_OFFSET(0xC2BC750)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateTeamNode_New_TypeDefinitionIndex = 62731;
