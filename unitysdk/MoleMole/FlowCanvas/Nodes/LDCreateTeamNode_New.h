...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB897F50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__CHECKREADY_OFFSET UNITYSDK_OFFSET(0xB8980E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__CTOR_OFFSET UNITYSDK_OFFSET(0xB8982C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0xB8982E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0xB8986C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETEAMNODE_NEW___CHECKREADY_G____CHECKREADYCOROTINE_6_0_OFFSET UNITYSDK_OFFSET(0xB898270)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateTeamNode_New_TypeDefinitionIndex = 51597;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::MoleMole::TeamGroupDataItem*>* teamGroupDataItem; // 0xB8
		::FlowCanvas::ValueInput_1<::System::String*>* bornPos; // 0xC0
