...
#define MOLEMOLE_FLOWCANVAS_NODES_LDENTERANDCONFIGTOPVIEWCAMERA_INVOKE_OFFSET UNITYSDK_OFFSET(0xC2BE2A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENTERANDCONFIGTOPVIEWCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xC2BE700)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDEnterAndConfigTopViewCamera_TypeDefinitionIndex = 40496;
