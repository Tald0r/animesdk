...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MODIFYLIMITCHALLENGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC9CCD30)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MODIFYLIMITCHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9CCE60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MODIFYLIMITCHALLENGE__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xC9CCE80)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ModifyLimitChallenge_TypeDefinitionIndex = 46229;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Single>* LeftDeltaTime; // 0xB0
