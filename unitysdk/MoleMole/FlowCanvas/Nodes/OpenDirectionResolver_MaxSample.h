...
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONRESOLVER_MAXSAMPLE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x7F0A890)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONRESOLVER_MAXSAMPLE_GETDATA_OFFSET UNITYSDK_OFFSET(0x7F0AA50)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONRESOLVER_MAXSAMPLE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x7F0B030)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONRESOLVER_MAXSAMPLE_METHOD_4_006A039FD955061C_OFFSET UNITYSDK_OFFSET(0x7F0B0A0)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONRESOLVER_MAXSAMPLE_METHOD_4_427F9234AFC9D15D_OFFSET UNITYSDK_OFFSET(0x7F0B220)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONRESOLVER_MAXSAMPLE_METHOD_4_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0x7F0B2F0)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONRESOLVER_MAXSAMPLE_METHOD_4_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0x7F0B360)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONRESOLVER_MAXSAMPLE_SETPATH_OFFSET UNITYSDK_OFFSET(0x7F0A7D0)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONRESOLVER_MAXSAMPLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x7F0B060)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONRESOLVER_MAXSAMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x7F0B040)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int OpenDirectionResolver_MaxSample_TypeDefinitionIndex = 56367;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(OpenDirectionResolver_MaxSample_TypeDefinitionIndex)->GetStaticField(0x10160);
		}
