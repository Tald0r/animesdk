...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETAREARANDOMNOWITHJUMP_INVOKE_OFFSET UNITYSDK_OFFSET(0x8B06AD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETAREARANDOMNOWITHJUMP__CTOR_OFFSET UNITYSDK_OFFSET(0x8B06EA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_GetAreaRandomNoWithJump_TypeDefinitionIndex = 38319;
