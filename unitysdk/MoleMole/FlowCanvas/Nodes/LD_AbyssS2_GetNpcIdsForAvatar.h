...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETNPCIDSFORAVATAR_INNERFINDNPCIDS_OFFSET UNITYSDK_OFFSET(0xC9CAA10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETNPCIDSFORAVATAR_INVOKE_OFFSET UNITYSDK_OFFSET(0xC9CA750)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETNPCIDSFORAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0xC9CAC20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_GetNpcIdsForAvatar_TypeDefinitionIndex = 37731;
