...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETNPCIDSFORAVATAR_INNERFINDNPCIDS_OFFSET UNITYSDK_OFFSET(0xBA0FDF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETNPCIDSFORAVATAR_INVOKE_OFFSET UNITYSDK_OFFSET(0xBA0FB30)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETNPCIDSFORAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0xBA10000)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_GetNpcIdsForAvatar_TypeDefinitionIndex = 53024;
