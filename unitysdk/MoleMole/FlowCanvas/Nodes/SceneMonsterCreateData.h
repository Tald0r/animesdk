...
#define MOLEMOLE_FLOWCANVAS_NODES_SCENEMONSTERCREATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xF1B2670)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int SceneMonsterCreateData_TypeDefinitionIndex = 75198;
