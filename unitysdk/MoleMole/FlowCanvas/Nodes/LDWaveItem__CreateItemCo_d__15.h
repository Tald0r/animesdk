...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA503220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA5036F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA503750)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA503700)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA503210)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEITEM__CREATEITEMCO_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0xA503200)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveItem__CreateItemCo_d__15_TypeDefinitionIndex = 46769;

	class LDWaveItem__CreateItemCo_d__15 : public ::System::Object
	{
	public:
		::MoleMole::FlowCanvas::Nodes::LDWaveItem* __4__this; // 0x10
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::CreateItemData*>* _list_5__2; // 0x18
		::MoleMole::FlowCanvas::Nodes::CreateItemData* _data_5__4; // 0x20
