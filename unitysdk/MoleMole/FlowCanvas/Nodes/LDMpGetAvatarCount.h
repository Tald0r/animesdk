...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETAVATARCOUNT_GETONLINECOUNT_OFFSET UNITYSDK_OFFSET(0x8AF5C10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETAVATARCOUNT_GETTEAMCOUNT_OFFSET UNITYSDK_OFFSET(0x8AF5DF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETAVATARCOUNT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8AF5AF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETAVATARCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x8AF5FC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMpGetAvatarCount_TypeDefinitionIndex = 67255;
