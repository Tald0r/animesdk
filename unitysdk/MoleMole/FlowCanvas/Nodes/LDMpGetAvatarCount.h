...
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETAVATARCOUNT_GETONLINECOUNT_OFFSET UNITYSDK_OFFSET(0x1164C920)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETAVATARCOUNT_GETTEAMCOUNT_OFFSET UNITYSDK_OFFSET(0x1164CB00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETAVATARCOUNT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x1164C7F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDMPGETAVATARCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1164CB60)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDMpGetAvatarCount_TypeDefinitionIndex = 47436;
