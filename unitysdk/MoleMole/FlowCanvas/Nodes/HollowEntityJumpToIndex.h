...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYJUMPTOINDEX_INVOKEINNER_OFFSET UNITYSDK_OFFSET(0xE4734C0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYJUMPTOINDEX_INVOKES_OFFSET UNITYSDK_OFFSET(0xE4737A0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYJUMPTOINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0xE4733C0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYJUMPTOINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xE473840)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowEntityJumpToIndex_TypeDefinitionIndex = 37413;
