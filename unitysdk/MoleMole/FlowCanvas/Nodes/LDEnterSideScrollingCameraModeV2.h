...
#define MOLEMOLE_FLOWCANVAS_NODES_LDENTERSIDESCROLLINGCAMERAMODEV2_HANDLEFLOWINPUT_OFFSET UNITYSDK_OFFSET(0xD7FC4B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENTERSIDESCROLLINGCAMERAMODEV2_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xD7FC320)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENTERSIDESCROLLINGCAMERAMODEV2__CTOR_OFFSET UNITYSDK_OFFSET(0xD7FCCB0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDEnterSideScrollingCameraModeV2_TypeDefinitionIndex = 38920;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::MoleMole::Cameras::SideScrollingCameraRuntimeParam*>* _param; // 0xB8
		::FlowCanvas::FlowOutput* _output; // 0xC0
		::FlowCanvas::ValueInput_1<::System::String*>* _cameraModeKey; // 0xC8
		::FlowCanvas::ValueInput_1<::MoleMole::Cameras::OverrideConfigSideScrollingCamera*>* _overrideConfig; // 0xD0
