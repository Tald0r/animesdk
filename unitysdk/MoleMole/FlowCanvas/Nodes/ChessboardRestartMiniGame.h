...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDRESTARTMINIGAME_INVOKE_OFFSET UNITYSDK_OFFSET(0xE0EB960)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDRESTARTMINIGAME__CTOR_OFFSET UNITYSDK_OFFSET(0xE0EBB00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardRestartMiniGame_TypeDefinitionIndex = 49870;
