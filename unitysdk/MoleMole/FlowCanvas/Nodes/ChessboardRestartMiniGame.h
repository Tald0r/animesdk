...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDRESTARTMINIGAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x7A505D0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDRESTARTMINIGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x7A50770)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardRestartMiniGame_TypeDefinitionIndex = 65142;
