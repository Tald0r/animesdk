...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEATTRIBUTENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xE473BF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGEATTRIBUTENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE473EE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDChangeAttributeNode_TypeDefinitionIndex = 41715;
