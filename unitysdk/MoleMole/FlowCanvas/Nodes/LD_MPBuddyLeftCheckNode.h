...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_DOREGISTEREVENT_OFFSET UNITYSDK_OFFSET(0xCD53F60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_GETALIVECOUNT_OFFSET UNITYSDK_OFFSET(0xCD543A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_GETDEADCOUNT_OFFSET UNITYSDK_OFFSET(0xCD54420)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_GETTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xCD547B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_ONMARCELANYPLAYERFINISH_OFFSET UNITYSDK_OFFSET(0xCD54260)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_ONMARCELUPDATETOTALNUMBER_OFFSET UNITYSDK_OFFSET(0xCD54300)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xCD53DC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MPBUDDYLEFTCHECKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD54980)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_MPBuddyLeftCheckNode_TypeDefinitionIndex = 42069;

	class LD_MPBuddyLeftCheckNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* _OnChanged; // 0xA8
