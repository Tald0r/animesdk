...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETTARGETENTITYUIWARNNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xD0D5E50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETTARGETENTITYUIWARNNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xD0D5FE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetTargetEntityUIWarnNode_TypeDefinitionIndex = 56914;
