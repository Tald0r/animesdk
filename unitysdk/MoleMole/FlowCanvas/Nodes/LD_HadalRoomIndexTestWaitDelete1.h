...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HADALROOMINDEXTESTWAITDELETE1_INVOKE_OFFSET UNITYSDK_OFFSET(0x8F0D280)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_HADALROOMINDEXTESTWAITDELETE1__CTOR_OFFSET UNITYSDK_OFFSET(0x8F0D4C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_HadalRoomIndexTestWaitDelete1_TypeDefinitionIndex = 47958;
