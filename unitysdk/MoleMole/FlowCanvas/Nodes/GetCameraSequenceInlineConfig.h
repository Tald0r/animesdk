...
#define MOLEMOLE_FLOWCANVAS_NODES_GETCAMERASEQUENCEINLINECONFIG_INVOKE_OFFSET UNITYSDK_OFFSET(0x6AD97F0)
#define MOLEMOLE_FLOWCANVAS_NODES_GETCAMERASEQUENCEINLINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6AD99B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int GetCameraSequenceInlineConfig_TypeDefinitionIndex = 58715;
