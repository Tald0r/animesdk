...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETDYNAMICTARGETVALUE_INVOKE_OFFSET UNITYSDK_OFFSET(0xD8004E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETDYNAMICTARGETVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0xD800660)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDResetDynamicTargetValue_TypeDefinitionIndex = 53939;
