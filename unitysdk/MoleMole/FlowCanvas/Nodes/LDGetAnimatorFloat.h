...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETANIMATORFLOAT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8AF4A50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETANIMATORFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x8AF4B70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETANIMATORFLOAT__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x8AF4B90)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetAnimatorFloat_TypeDefinitionIndex = 42191;
