...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWOPTIONPOPWINDOW_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7A5A280)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWOPTIONPOPWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x7A5A3E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWOPTIONPOPWINDOW__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x7A5A400)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWOPTIONPOPWINDOW__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x7A5AB90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWOPTIONPOPWINDOW__REGISTERPORTS_B__5_2_OFFSET UNITYSDK_OFFSET(0x7A5AA20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWOPTIONPOPWINDOW__REGISTERPORTS_B__5_3_OFFSET UNITYSDK_OFFSET(0x7A5AB50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowOptionPopWindow_TypeDefinitionIndex = 40579;
	...
	public:
		...
		::FlowCanvas::FlowOutput* onClosed; // 0xC0
