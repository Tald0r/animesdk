...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOOTINGPLAYFINISH___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x678BAD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SHOOTINGPLAYFINISH___C__DISPLAYCLASS2_0__START_B__0_OFFSET UNITYSDK_OFFSET(0x678BAE0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ShootingPlayFinish___c__DisplayClass2_0_TypeDefinitionIndex = 51818;
