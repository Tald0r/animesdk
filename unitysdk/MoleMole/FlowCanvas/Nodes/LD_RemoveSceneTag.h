...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REMOVESCENETAG_INVOKE_OFFSET UNITYSDK_OFFSET(0x7A661E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REMOVESCENETAG__CTOR_OFFSET UNITYSDK_OFFSET(0x7A66290)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_RemoveSceneTag_TypeDefinitionIndex = 55682;
