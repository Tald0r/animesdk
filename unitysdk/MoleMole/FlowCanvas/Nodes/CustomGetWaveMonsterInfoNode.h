...
#define MOLEMOLE_FLOWCANVAS_NODES_CUSTOMGETWAVEMONSTERINFONODE__CTOR_OFFSET UNITYSDK_OFFSET(0x82C6930)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomGetWaveMonsterInfoNode_TypeDefinitionIndex = 57204;
