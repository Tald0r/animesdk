...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0xA01A3D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_BEGIN_OFFSET UNITYSDK_OFFSET(0xA01C8D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_BUILDCREATEVALUES_OFFSET UNITYSDK_OFFSET(0xA019A10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0xA019650)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0xA01C450)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0xA01A810)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA0191E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHACHORBYPREFIX_OFFSET UNITYSDK_OFFSET(0xA01AFF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHMONSTERSPAWNERPOINT_OFFSET UNITYSDK_OFFSET(0xA01A8C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHVALIDPOINTBYDISTANCEANDANGLE_OFFSET UNITYSDK_OFFSET(0xA01BED0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_STARTSPAWN_OFFSET UNITYSDK_OFFSET(0xA01C4D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xA01C990)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_WRAPANGLERANGE_OFFSET UNITYSDK_OFFSET(0xA01BDE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__CTOR_OFFSET UNITYSDK_OFFSET(0xA01CB50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_0_OFFSET UNITYSDK_OFFSET(0xA01CB60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_1_OFFSET UNITYSDK_OFFSET(0xA01CC40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_2_OFFSET UNITYSDK_OFFSET(0xA01CD30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_3_OFFSET UNITYSDK_OFFSET(0xA01CD60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_4_OFFSET UNITYSDK_OFFSET(0xA01CD70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_5_OFFSET UNITYSDK_OFFSET(0xA01CD80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_6_OFFSET UNITYSDK_OFFSET(0xA01CD90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0xA01CDA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0xA01CE40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0xA01CE70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0xA01CE80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0xA01CE90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA01CEA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0xA01CEB0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonsterByPatternID_TypeDefinitionIndex = 77731;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::PatternMonsterCreate*>* monsterCreateValues; // 0x1B8
		::FlowCanvas::ValueOutput_1<::System::Int32>* patternTypeOutput; // 0x1C0
		::FlowCanvas::ValueInput_1<::System::String*>* anchorPosPrefixInput; // 0x1C8
		::FlowCanvas::ValueInput_1<::System::Single>* angleRangeInput; // 0x1D0
		::FlowCanvas::ValueInput_1<::System::Single>* spawnIntervalInput; // 0x1D8
		::FlowCanvas::ValueInput_1<::System::Int32>* patternId; // 0x1E0
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* inputPosEntity; // 0x1E8
