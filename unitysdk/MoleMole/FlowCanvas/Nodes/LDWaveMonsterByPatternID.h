...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x8F08850)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_BEGIN_OFFSET UNITYSDK_OFFSET(0x8F0AD70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_BUILDCREATEVALUES_OFFSET UNITYSDK_OFFSET(0x8F07E90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x8F07AC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x8F0A8F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x8F08C90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8F07660)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHACHORBYPREFIX_OFFSET UNITYSDK_OFFSET(0x8F09480)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHMONSTERSPAWNERPOINT_OFFSET UNITYSDK_OFFSET(0x8F08D40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHVALIDPOINTBYDISTANCEANDANGLE_OFFSET UNITYSDK_OFFSET(0x8F0A370)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_STARTSPAWN_OFFSET UNITYSDK_OFFSET(0x8F0A970)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x8F0AE30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_WRAPANGLERANGE_OFFSET UNITYSDK_OFFSET(0x8F0A280)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__CTOR_OFFSET UNITYSDK_OFFSET(0x8F0AFF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_0_OFFSET UNITYSDK_OFFSET(0x8F0B000)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_1_OFFSET UNITYSDK_OFFSET(0x8F0B0E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_2_OFFSET UNITYSDK_OFFSET(0x8F0B1D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_3_OFFSET UNITYSDK_OFFSET(0x8F0B200)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_4_OFFSET UNITYSDK_OFFSET(0x8F0B210)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_5_OFFSET UNITYSDK_OFFSET(0x8F0B220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID__REGISTERPORTS_B__10_6_OFFSET UNITYSDK_OFFSET(0x8F0B230)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_ACTIVEPRELOADMONSTER_OFFSET UNITYSDK_OFFSET(0x8F0B240)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_BEGIN_OFFSET UNITYSDK_OFFSET(0x8F0B2E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x8F0B310)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_GETCREATELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x8F0B320)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_GETCREATELISTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x8F0B330)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8F0B340)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID___BASE_TRYCREATEMONSTER_OFFSET UNITYSDK_OFFSET(0x8F0B350)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonsterByPatternID_TypeDefinitionIndex = 53350;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* inputPosEntity; // 0x1C0
		::FlowCanvas::ValueOutput_1<::System::Int32>* patternTypeOutput; // 0x1C8
		::FlowCanvas::ValueInput_1<::System::Single>* spawnIntervalInput; // 0x1D0
		::FlowCanvas::ValueInput_1<::System::String*>* anchorPosPrefixInput; // 0x1D8
		::FlowCanvas::ValueInput_1<::System::Int32>* patternId; // 0x1E0
		::System::Collections::Generic::List_1<::MoleMole::FlowCanvas::Nodes::PatternMonsterCreate*>* monsterCreateValues; // 0x1E8
		...
		::MoleMole::MonoSpawnPoint* SearchAchorByPrefix(::Class_3_F35B080B137ECC46* inputModelComponent, ::System::String* prefix, ::UnityEngine::Vector2 radius, ::UnityEngine::Vector2 angle, ::System::Boolean& lastChooseLeft, ::System::Collections::Generic::HashSet_1<::System::Int32>* excludePointSet)
		{
			return ((::MoleMole::MonoSpawnPoint*(*)(::PVOID, ::Class_3_F35B080B137ECC46*, ::System::String*, ::UnityEngine::Vector2, ::UnityEngine::Vector2, ::System::Boolean&, ::System::Collections::Generic::HashSet_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTERBYPATTERNID_SEARCHACHORBYPREFIX_OFFSET))(this, inputModelComponent, prefix, radius, angle, lastChooseLeft, excludePointSet);
		}
