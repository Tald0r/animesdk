...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYGETCANMOVENEIGHBORPOSITION_INVOKE_OFFSET UNITYSDK_OFFSET(0xE0EC120)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYGETCANMOVENEIGHBORPOSITION__CCTOR_OFFSET UNITYSDK_OFFSET(0xE0EC670)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYGETCANMOVENEIGHBORPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xE0EC5C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowEntityGetCanMoveNeighborPosition_TypeDefinitionIndex = 48306;
	...
	public:
		...
		{
			return (::Il2CppArray<::Share::GridDir>**)Il2CppClass::FromTypeDefinitionIndex(HollowEntityGetCanMoveNeighborPosition_TypeDefinitionIndex)->GetStaticField(0x3FFA0);
		}
