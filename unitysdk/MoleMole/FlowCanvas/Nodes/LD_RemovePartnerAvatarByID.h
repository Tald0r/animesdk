...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REMOVEPARTNERAVATARBYID_INVOKE_OFFSET UNITYSDK_OFFSET(0xE1016C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REMOVEPARTNERAVATARBYID__CTOR_OFFSET UNITYSDK_OFFSET(0xE101800)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_RemovePartnerAvatarByID_TypeDefinitionIndex = 63098;
