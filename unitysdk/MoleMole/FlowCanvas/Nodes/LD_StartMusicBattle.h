...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTMUSICBATTLE_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0xA5EEB90)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTMUSICBATTLE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA5EEA20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTMUSICBATTLE_TRYCALLFINISH_OFFSET UNITYSDK_OFFSET(0xA5EF280)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTMUSICBATTLE_TRYPLAYMUSIC_OFFSET UNITYSDK_OFFSET(0xA5EEFB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTMUSICBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0xA5EF410)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_StartMusicBattle_TypeDefinitionIndex = 68052;

	class LD_StartMusicBattle : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::String*>* _timelineDataKey; // 0xA8
