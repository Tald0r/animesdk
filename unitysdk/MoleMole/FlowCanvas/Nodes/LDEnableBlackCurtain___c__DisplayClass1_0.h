...
#define MOLEMOLE_FLOWCANVAS_NODES_LDENABLEBLACKCURTAIN___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0xE869450)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENABLEBLACKCURTAIN___C__DISPLAYCLASS1_0__INVOKE_B__0_OFFSET UNITYSDK_OFFSET(0xE869460)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENABLEBLACKCURTAIN___C__DISPLAYCLASS1_0__INVOKE_B__1_OFFSET UNITYSDK_OFFSET(0xE8694C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENABLEBLACKCURTAIN___C__DISPLAYCLASS1_0__INVOKE_B__2_OFFSET UNITYSDK_OFFSET(0xE8696A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENABLEBLACKCURTAIN___C__DISPLAYCLASS1_0__INVOKE_B__3_OFFSET UNITYSDK_OFFSET(0xE869650)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDEnableBlackCurtain___c__DisplayClass1_0_TypeDefinitionIndex = 57705;

	class LDEnableBlackCurtain___c__DisplayClass1_0 : public ::System::Object
	{
	public:
		::System::Action_1<::Class_1_FC3A9C07FC781527_Enum_3_6E0E8267CDDC65CF>* callOnFinish; // 0x10
