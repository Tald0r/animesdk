...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETCURRENTINDEXTAG_INVOKE_OFFSET UNITYSDK_OFFSET(0xB18BCA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_GETCURRENTINDEXTAG__CTOR_OFFSET UNITYSDK_OFFSET(0xB18BDF0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_GetCurrentIndexTag_TypeDefinitionIndex = 46037;
