...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOUNTDOWNUI_MODIFY_INVOKE_OFFSET UNITYSDK_OFFSET(0x8AF3B20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOUNTDOWNUI_MODIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x8AF3D90)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCountDownUI_Modify_TypeDefinitionIndex = 53569;
