...
#define MOLEMOLE_FLOWCANVAS_NODES_PLAYSUMMERSHOOTINGOPENINGAUDIO_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8F7DA90)
#define MOLEMOLE_FLOWCANVAS_NODES_PLAYSUMMERSHOOTINGOPENINGAUDIO_START_OFFSET UNITYSDK_OFFSET(0x8F7DB90)
#define MOLEMOLE_FLOWCANVAS_NODES_PLAYSUMMERSHOOTINGOPENINGAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0x8F7DD90)
#define MOLEMOLE_FLOWCANVAS_NODES_PLAYSUMMERSHOOTINGOPENINGAUDIO__START_B__3_0_OFFSET UNITYSDK_OFFSET(0x8F7DDB0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int PlaySummerShootingOpeningAudio_TypeDefinitionIndex = 72293;
