...
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDAVATARGUIDEITEM_INVOKE_OFFSET UNITYSDK_OFFSET(0xD0CCC10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDAVATARGUIDEITEM_TRYADDAVATARGUIDEITEM_OFFSET UNITYSDK_OFFSET(0xD0CCC80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDAVATARGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD0CD010)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAddAvatarGuideItem_TypeDefinitionIndex = 71603;
