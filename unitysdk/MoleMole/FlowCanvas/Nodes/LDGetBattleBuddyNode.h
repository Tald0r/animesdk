...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETBATTLEBUDDYNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6E16F20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETBATTLEBUDDYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E17080)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetBattleBuddyNode_TypeDefinitionIndex = 63972;
