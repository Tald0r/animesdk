...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETBATTLEBUDDYNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC266480)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETBATTLEBUDDYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2665E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetBattleBuddyNode_TypeDefinitionIndex = 69253;
