...
#define MOLEMOLE_FLOWCANVAS_NODES_LDNOTIFYMONSTERREADYFORTIPS_INVOKE_OFFSET UNITYSDK_OFFSET(0x6E19F10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDNOTIFYMONSTERREADYFORTIPS__CCTOR_OFFSET UNITYSDK_OFFSET(0x6E1A140)
#define MOLEMOLE_FLOWCANVAS_NODES_LDNOTIFYMONSTERREADYFORTIPS__CTOR_OFFSET UNITYSDK_OFFSET(0x6E1A120)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDNotifyMonsterReadyForTips_TypeDefinitionIndex = 50319;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::MoleMole::Config::MonsterStrengthType, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(LDNotifyMonsterReadyForTips_TypeDefinitionIndex)->GetStaticField(0x44A90);
		}
