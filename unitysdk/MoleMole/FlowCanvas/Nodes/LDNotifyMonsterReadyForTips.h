...
#define MOLEMOLE_FLOWCANVAS_NODES_LDNOTIFYMONSTERREADYFORTIPS_INVOKE_OFFSET UNITYSDK_OFFSET(0xC269390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDNOTIFYMONSTERREADYFORTIPS__CCTOR_OFFSET UNITYSDK_OFFSET(0xC2695C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDNOTIFYMONSTERREADYFORTIPS__CTOR_OFFSET UNITYSDK_OFFSET(0xC2695A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDNotifyMonsterReadyForTips_TypeDefinitionIndex = 46937;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::MoleMole::Config::MonsterStrengthType, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(LDNotifyMonsterReadyForTips_TypeDefinitionIndex)->GetStaticField(0x440F0);
		}
