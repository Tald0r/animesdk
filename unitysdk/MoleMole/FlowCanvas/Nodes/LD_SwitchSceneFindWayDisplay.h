...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SWITCHSCENEFINDWAYDISPLAY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC2CDD10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SWITCHSCENEFINDWAYDISPLAY_START_INTERACT_OFFSET UNITYSDK_OFFSET(0xC2CDE60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SWITCHSCENEFINDWAYDISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0xC2CE240)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SWITCHSCENEFINDWAYDISPLAY__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xC2CE260)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SwitchSceneFindWayDisplay_TypeDefinitionIndex = 48704;
