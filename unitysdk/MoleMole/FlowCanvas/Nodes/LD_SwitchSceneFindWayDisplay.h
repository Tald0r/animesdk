...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SWITCHSCENEFINDWAYDISPLAY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB8A97B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SWITCHSCENEFINDWAYDISPLAY_START_INTERACT_OFFSET UNITYSDK_OFFSET(0xB8A9900)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SWITCHSCENEFINDWAYDISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A9CE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SWITCHSCENEFINDWAYDISPLAY__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xB8A9D00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SwitchSceneFindWayDisplay_TypeDefinitionIndex = 56999;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::Int32>* wayID; // 0xC0
