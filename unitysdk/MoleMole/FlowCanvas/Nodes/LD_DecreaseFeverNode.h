...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DECREASEFEVERNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x6787A20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_DECREASEFEVERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6787C50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_DecreaseFeverNode_TypeDefinitionIndex = 69097;
