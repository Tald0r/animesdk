...
#define MOLEMOLE_FLOWCANVAS_NODES_LASTPHASEFALLBACKINLEVELSETTLEMENT_STRUCT_2_E499DDD21BF551C3_2_COMPARE_OFFSET UNITYSDK_OFFSET(0x32F240)
#define MOLEMOLE_FLOWCANVAS_NODES_LASTPHASEFALLBACKINLEVELSETTLEMENT_STRUCT_2_E499DDD21BF551C3_2_GET_MAXPITCH_OFFSET UNITYSDK_OFFSET(0x32F2A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LASTPHASEFALLBACKINLEVELSETTLEMENT_STRUCT_2_E499DDD21BF551C3_2_GET_MINPITCH_OFFSET UNITYSDK_OFFSET(0x32F290)
#define MOLEMOLE_FLOWCANVAS_NODES_LASTPHASEFALLBACKINLEVELSETTLEMENT_STRUCT_2_E499DDD21BF551C3_2__CTOR_OFFSET UNITYSDK_OFFSET(0x32F200)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LastPhaseFallbackInLevelSettlement_Struct_2_E499DDD21BF551C3_2_TypeDefinitionIndex = 66868;
