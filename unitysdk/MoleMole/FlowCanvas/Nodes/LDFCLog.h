...
#define MOLEMOLE_FLOWCANVAS_NODES_LDFCLOG_LOG_OFFSET UNITYSDK_OFFSET(0xA382200)
#define MOLEMOLE_FLOWCANVAS_NODES_LDFCLOG_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA3820E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDFCLOG__CTOR_OFFSET UNITYSDK_OFFSET(0xA382510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDFCLOG__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0xA382530)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDFCLog_TypeDefinitionIndex = 80795;

	class LDFCLog : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::MoleMole::FlowCanvas::Nodes::EFCLogLevel>* logLevelInput; // 0xA8
		::FlowCanvas::ValueInput_1<::System::String*>* logInput; // 0xB0
