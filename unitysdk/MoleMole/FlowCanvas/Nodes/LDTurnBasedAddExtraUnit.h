...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDADDEXTRAUNIT_INVOKE_OFFSET UNITYSDK_OFFSET(0xC21CC70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDADDEXTRAUNIT_ISAPPENDTARGET_OFFSET UNITYSDK_OFFSET(0xC21D220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDADDEXTRAUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0xC21D360)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedAddExtraUnit_TypeDefinitionIndex = 51832;
