...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDADDEXTRAUNIT_INVOKE_OFFSET UNITYSDK_OFFSET(0xB8333E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDADDEXTRAUNIT_ISAPPENDTARGET_OFFSET UNITYSDK_OFFSET(0xB833980)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDADDEXTRAUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0xB833AC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedAddExtraUnit_TypeDefinitionIndex = 65409;
