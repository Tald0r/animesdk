...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSELECTION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xF1A7BE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSELECTION_START_OFFSET UNITYSDK_OFFSET(0xF1A8610)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xF1A87D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSelection_TypeDefinitionIndex = 38580;
