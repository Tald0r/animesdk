...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARV2_UNLOADAVATARBYINDEX_PROCESS_OFFSET UNITYSDK_OFFSET(0xA38C3C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARV2_UNLOADAVATARBYINDEX_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA38C2B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARV2_UNLOADAVATARBYINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xA38C6F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATARV2_UNLOADAVATARBYINDEX__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xA38C710)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AvatarV2_UnloadAvatarByIndex_TypeDefinitionIndex = 46243;
