...
#define MOLEMOLE_FLOWCANVAS_NODES_QUERYENTITY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x758AE80)
#define MOLEMOLE_FLOWCANVAS_NODES_QUERYENTITY_START_OFFSET UNITYSDK_OFFSET(0x758B040)
#define MOLEMOLE_FLOWCANVAS_NODES_QUERYENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x758B4B0)
#define MOLEMOLE_FLOWCANVAS_NODES_QUERYENTITY__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x758B4D0)
#define MOLEMOLE_FLOWCANVAS_NODES_QUERYENTITY__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x758B4E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int QueryEntity_TypeDefinitionIndex = 48936;
	...
	public:
		...
		::FlowCanvas::FlowInput* _input; // 0xC8
		::FlowCanvas::ValueOutput_1<::System::Int32>* countOutput; // 0xD0
