...
#define MOLEMOLE_FLOWCANVAS_NODES_QUERYENTITY_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x678E0C0)
#define MOLEMOLE_FLOWCANVAS_NODES_QUERYENTITY_START_OFFSET UNITYSDK_OFFSET(0x678E280)
#define MOLEMOLE_FLOWCANVAS_NODES_QUERYENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x678E6F0)
#define MOLEMOLE_FLOWCANVAS_NODES_QUERYENTITY__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x678E710)
#define MOLEMOLE_FLOWCANVAS_NODES_QUERYENTITY__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x678E720)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int QueryEntity_TypeDefinitionIndex = 42744;

	class QueryEntity : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* _doOuptut; // 0xA8
		::MoleMole::EntityHandle entity; // 0xB0
		::FlowCanvas::ValueOutput_1<::MoleMole::EntityHandle>* entityOutput; // 0xC0
		::FlowCanvas::ValueInput_1<::MoleMole::GameplayTag>* tagInput; // 0xC8
		::FlowCanvas::FlowOutput* _output; // 0xD0
		::FlowCanvas::FlowInput* _input; // 0xD8
