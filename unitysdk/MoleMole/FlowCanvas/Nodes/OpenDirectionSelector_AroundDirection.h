...
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONSELECTOR_AROUNDDIRECTION_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0xA509E50)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONSELECTOR_AROUNDDIRECTION_GETDATA_OFFSET UNITYSDK_OFFSET(0xA50A010)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONSELECTOR_AROUNDDIRECTION_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xA50A610)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONSELECTOR_AROUNDDIRECTION_METHOD_4_24B1E1DE85E3C92F_OFFSET UNITYSDK_OFFSET(0xA50A6D0)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONSELECTOR_AROUNDDIRECTION_METHOD_4_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0xA50AA80)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONSELECTOR_AROUNDDIRECTION_METHOD_4_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0xA50A9C0)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONSELECTOR_AROUNDDIRECTION_METHOD_4_8A5D6889494E1D04_OFFSET UNITYSDK_OFFSET(0xA50A7B0)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONSELECTOR_AROUNDDIRECTION_METHOD_4_C1397965C8E8E75A_OFFSET UNITYSDK_OFFSET(0xA50A8E0)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONSELECTOR_AROUNDDIRECTION_SETPATH_OFFSET UNITYSDK_OFFSET(0xA509D90)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONSELECTOR_AROUNDDIRECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0xA50A640)
#define MOLEMOLE_FLOWCANVAS_NODES_OPENDIRECTIONSELECTOR_AROUNDDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA50A620)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int OpenDirectionSelector_AroundDirection_TypeDefinitionIndex = 58012;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(OpenDirectionSelector_AroundDirection_TypeDefinitionIndex)->GetStaticField(0xD6C0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_direction()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(OpenDirectionSelector_AroundDirection_TypeDefinitionIndex)->GetStaticField(0xD6C8);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_projectOnXZPlane()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(OpenDirectionSelector_AroundDirection_TypeDefinitionIndex)->GetStaticField(0xD6D0);
		}
