...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGESOUNDSTATE_BEGIN_OFFSET UNITYSDK_OFFSET(0xC212510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGESOUNDSTATE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC2123D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGESOUNDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC212A70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCHANGESOUNDSTATE__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xC212A90)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDChangeSoundState_TypeDefinitionIndex = 53485;

	class LDChangeSoundState : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::String*>* Group; // 0xA8
