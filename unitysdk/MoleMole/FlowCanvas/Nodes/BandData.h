...
#define MOLEMOLE_FLOWCANVAS_NODES_BANDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC2BA370)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int BandData_TypeDefinitionIndex = 70561;
