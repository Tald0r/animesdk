...
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITFIXEDCAMERA_INVOKE_OFFSET UNITYSDK_OFFSET(0xC2662F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITFIXEDCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xC266470)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDExitFixedCamera_TypeDefinitionIndex = 70424;
