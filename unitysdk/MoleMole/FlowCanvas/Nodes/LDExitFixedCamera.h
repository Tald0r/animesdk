...
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITFIXEDCAMERA_INVOKE_OFFSET UNITYSDK_OFFSET(0x6E16D80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITFIXEDCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x6E16F10)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDExitFixedCamera_TypeDefinitionIndex = 71067;
