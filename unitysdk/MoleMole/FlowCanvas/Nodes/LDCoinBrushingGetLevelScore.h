...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGGETLEVELSCORE_INVOKE_OFFSET UNITYSDK_OFFSET(0xEC75240)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCOINBRUSHINGGETLEVELSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC75440)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCoinBrushingGetLevelScore_TypeDefinitionIndex = 47947;
