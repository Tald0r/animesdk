...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8B089E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETTAROTCARDGACHA___C__DISPLAYCLASS10_0___ONRECV_B__0_OFFSET UNITYSDK_OFFSET(0x8B089F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_GetTarotCardGacha___c__DisplayClass10_0_TypeDefinitionIndex = 73171;
