...
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDENTITYABILITYBYID_INVOKE_OFFSET UNITYSDK_OFFSET(0xA5E1100)
#define MOLEMOLE_FLOWCANVAS_NODES_LDADDENTITYABILITYBYID__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E13B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAddEntityAbilityById_TypeDefinitionIndex = 40929;
