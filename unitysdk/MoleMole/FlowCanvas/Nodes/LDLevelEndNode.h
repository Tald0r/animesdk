...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE_CLEARLAZYINSTANCE_OFFSET UNITYSDK_OFFSET(0xBA03200)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xBA03780)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xBA036A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xBA03260)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xBA03480)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE__CCTOR_OFFSET UNITYSDK_OFFSET(0xBA05380)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xBA05360)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE__ENDPERFORMCALL_OFFSET UNITYSDK_OFFSET(0xBA03FE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE__GMEXECUTED_OFFSET UNITYSDK_OFFSET(0xBA03710)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE__JUMPTOLASTCURTAIN_OFFSET UNITYSDK_OFFSET(0xBA051D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE__PLAYCAMERASEQUENCEANDASCRIPT_OFFSET UNITYSDK_OFFSET(0xBA04DC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE__TRYINTERRUPTTYPELEVELEND_OFFSET UNITYSDK_OFFSET(0xBA03E20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE__TRYPLAYDYNAMICENDPERFORMS_OFFSET UNITYSDK_OFFSET(0xBA04A50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE__TRYWAITCUTSCENEWHENLEVELEND_OFFSET UNITYSDK_OFFSET(0xBA04390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xBA05390)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xBA053A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDLevelEndNode_TypeDefinitionIndex = 68168;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(LDLevelEndNode_TypeDefinitionIndex)->GetStaticField(0xA580);
		}
