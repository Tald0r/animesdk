...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORFLOAT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6AE9BE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x6AE9D30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORFLOAT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x6AE9D50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetAnimatorFloat_TypeDefinitionIndex = 65872;
