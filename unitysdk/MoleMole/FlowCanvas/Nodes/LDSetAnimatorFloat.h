...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORFLOAT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB5D8E40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0xB5D8F90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORFLOAT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xB5D8FB0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetAnimatorFloat_TypeDefinitionIndex = 38588;
