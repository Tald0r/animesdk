...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE_ONEVENT_OFFSET UNITYSDK_OFFSET(0x678A610)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x678A530)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x678A5A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6789F30)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x678A360)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE__BINDEVENT_OFFSET UNITYSDK_OFFSET(0x678A190)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x678AD60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE__REGISTERPORTS_B__11_0_OFFSET UNITYSDK_OFFSET(0x678AD80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE__REGISTERPORTS_B__11_1_OFFSET UNITYSDK_OFFSET(0x678B0F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE__START_OFFSET UNITYSDK_OFFSET(0x678A120)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x678B1A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENENTITYBEDAMAGECHANGE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x678B1B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ListenEntityBeDamageChange_TypeDefinitionIndex = 49933;
	...
	public:
		...
		::System::Single totalBeDamage; // 0xE8
