...
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0xB895880)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_GETDATA_OFFSET UNITYSDK_OFFSET(0xB895A40)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xB895C10)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_METHOD_3_3621B53786EE26C8_OFFSET UNITYSDK_OFFSET(0xB895AD0)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_METHOD_3_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0xB895E00)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_METHOD_3_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0xB895C70)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_METHOD_3_83ED25F6A8C66D20_OFFSET UNITYSDK_OFFSET(0xB895D30)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_SETPATH_OFFSET UNITYSDK_OFFSET(0xB8957C0)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER__CCTOR_OFFSET UNITYSDK_OFFSET(0xB895C30)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xB895C20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int AspectRatioProvider_TypeDefinitionIndex = 72006;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AspectRatioProvider_TypeDefinitionIndex)->GetStaticField(0xC1B0);
		}
