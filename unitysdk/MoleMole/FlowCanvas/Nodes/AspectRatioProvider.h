...
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0xC2B9D80)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_GETDATA_OFFSET UNITYSDK_OFFSET(0xC2B9F40)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xC2BA110)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_METHOD_3_3621B53786EE26C8_OFFSET UNITYSDK_OFFSET(0xC2B9FD0)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_METHOD_3_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0xC2BA230)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_METHOD_3_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0xC2BA170)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_METHOD_3_83ED25F6A8C66D20_OFFSET UNITYSDK_OFFSET(0xC2BA2A0)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER_SETPATH_OFFSET UNITYSDK_OFFSET(0xC2B9CC0)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC2BA130)
#define MOLEMOLE_FLOWCANVAS_NODES_ASPECTRATIOPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2BA120)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int AspectRatioProvider_TypeDefinitionIndex = 75187;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AspectRatioProvider_TypeDefinitionIndex)->GetStaticField(0xB520);
		}
