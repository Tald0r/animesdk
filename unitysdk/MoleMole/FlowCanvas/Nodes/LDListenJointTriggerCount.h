...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT_ATTACHEVENT_OFFSET UNITYSDK_OFFSET(0xEC84B40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT_CHECKMONSTERFUNCTIONTYPE_OFFSET UNITYSDK_OFFSET(0xB97E270)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT_INVOKE_OFFSET UNITYSDK_OFFSET(0xEC844E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT_ISALLAVATARIN_OFFSET UNITYSDK_OFFSET(0xB97DE70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT_ISENTITYEXITALLTRIGGER_OFFSET UNITYSDK_OFFSET(0xB97DCD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xEC84D10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xEC84D80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT_ONTRIGGERENTITYENTER_OFFSET UNITYSDK_OFFSET(0xEC85160)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT_ONTRIGGERENTITYEXIT_OFFSET UNITYSDK_OFFSET(0xB97DAF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT_ONTRIGGERENTITYSTAY_OFFSET UNITYSDK_OFFSET(0xEC856F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xEC84030)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0xB97E500)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT__DORESET_OFFSET UNITYSDK_OFFSET(0xEC84DF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT__REGISTERPORTS_B__26_0_OFFSET UNITYSDK_OFFSET(0xB97E6C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT__REGISTERPORTS_B__26_1_OFFSET UNITYSDK_OFFSET(0xB97E6D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT__REGISTERPORTS_B__26_2_OFFSET UNITYSDK_OFFSET(0xB97E6E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT__REGISTERPORTS_B__26_3_OFFSET UNITYSDK_OFFSET(0xB97E6F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT__REGISTERPORTS_B__26_4_OFFSET UNITYSDK_OFFSET(0xB97E700)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT__REGISTERPORTS_B__26_5_OFFSET UNITYSDK_OFFSET(0xB97E710)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT__REGISTERPORTS_B__26_6_OFFSET UNITYSDK_OFFSET(0xB97EA80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xB97EA90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENJOINTTRIGGERCOUNT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xB97EAA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenJointTriggerCount_TypeDefinitionIndex = 59498;

	class LDListenJointTriggerCount : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::MoleMole::Battle::Entity* triggerEnterEntity; // 0xA8
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::MoleMole::Config::MonsterFunctionType>*>* monsterFunctionTypeValueInput; // 0xB0
		::FlowCanvas::ValueInput_1<::System::Boolean>* colliderEnableValueInput; // 0xB8
		::MoleMole::Battle::Entity* triggerExitEntity; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Boolean>* functionTypeEnableValueInput; // 0xC8
		::FlowCanvas::FlowOutput* triggerEnter; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::System::String*>*>* enableGameplayTagsValueInput; // 0xD8
		::System::Collections::Generic::HashSet_1<::System::UInt32>* triggerExitSet; // 0xE0
		::FlowCanvas::FlowOutput* triggerExit; // 0xE8
		::MoleMole::Battle::Entity* triggerStayEntity; // 0xF0
		...
		::System::Collections::Generic::List_1<::MoleMole::LevelNodeEventTrigger*>* levelTriggerList; // 0x108
		::System::Collections::Generic::HashSet_1<::System::UInt32>* triggerEnterSet; // 0x110
		::FlowCanvas::ValueInput_1<::System::Boolean>* enableAvatarValueInput; // 0x118
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Single>* triggerStayRecordDic; // 0x120
		::FlowCanvas::FlowOutput* triggerStay; // 0x128
		::FlowCanvas::FlowOutput* finish; // 0x130
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::System::String*>*>* spawnPointValueInput; // 0x138
		::FlowCanvas::FlowOutput* raised; // 0x140
		...
		::System::Boolean createTriggerResult; // 0x14C
