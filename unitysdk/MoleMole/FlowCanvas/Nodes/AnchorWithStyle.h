...
#define MOLEMOLE_FLOWCANVAS_NODES_ANCHORWITHSTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x2D6E20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int AnchorWithStyle_TypeDefinitionIndex = 55655;
