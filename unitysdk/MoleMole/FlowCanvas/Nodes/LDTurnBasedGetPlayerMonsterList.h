...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETPLAYERMONSTERLIST_INVOKE_OFFSET UNITYSDK_OFFSET(0x6AEF1C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDGETPLAYERMONSTERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x6AEF3E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedGetPlayerMonsterList_TypeDefinitionIndex = 67178;
