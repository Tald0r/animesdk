...
#define MOLEMOLE_FLOWCANVAS_NODES_DEVELOPSCENEINFODISPLAYSUBSYSTEM_REMOVESCENEINFO_OFFSET UNITYSDK_OFFSET(0xEC722B0)
#define MOLEMOLE_FLOWCANVAS_NODES_DEVELOPSCENEINFODISPLAYSUBSYSTEM_SETCOLOR_OFFSET UNITYSDK_OFFSET(0xEC72230)
#define MOLEMOLE_FLOWCANVAS_NODES_DEVELOPSCENEINFODISPLAYSUBSYSTEM_SHOWSCENEINFO_OFFSET UNITYSDK_OFFSET(0xEC72130)
#define MOLEMOLE_FLOWCANVAS_NODES_DEVELOPSCENEINFODISPLAYSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0xEC72320)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int DevelopSceneInfoDisplaySubsystem_TypeDefinitionIndex = 68471;
