...
#define MOLEMOLE_FLOWCANVAS_NODES_DEVELOPSCENEINFODISPLAYSUBSYSTEM_REMOVESCENEINFO_OFFSET UNITYSDK_OFFSET(0x7570DA0)
#define MOLEMOLE_FLOWCANVAS_NODES_DEVELOPSCENEINFODISPLAYSUBSYSTEM_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x7570D20)
#define MOLEMOLE_FLOWCANVAS_NODES_DEVELOPSCENEINFODISPLAYSUBSYSTEM_SHOWSCENEINFO_OFFSET UNITYSDK_OFFSET(0x7570C20)
#define MOLEMOLE_FLOWCANVAS_NODES_DEVELOPSCENEINFODISPLAYSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x7570E10)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int DevelopSceneInfoDisplaySubsystem_TypeDefinitionIndex = 58826;
