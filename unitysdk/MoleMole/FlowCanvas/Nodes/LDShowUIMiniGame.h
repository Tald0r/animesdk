...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIMINIGAME_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x99050F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIMINIGAME_SHOWMAINCITYGAME_OFFSET UNITYSDK_OFFSET(0x99052E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIMINIGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x9905C30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIMINIGAME__REGISTERPORTS_B__8_0_OFFSET UNITYSDK_OFFSET(0x9905C50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWUIMINIGAME__REGISTERPORTS_B__8_1_OFFSET UNITYSDK_OFFSET(0x9905C60)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowUIMiniGame_TypeDefinitionIndex = 77015;
	...
	public:
		...
		::FlowCanvas::FlowOutput* _flowOnFinish; // 0xC0
		::FlowCanvas::ValueInput_1<::MoleMole::Battle::Entity*>* _lightNpc; // 0xC8
