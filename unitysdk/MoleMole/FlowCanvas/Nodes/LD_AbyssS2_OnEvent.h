...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_BINDEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0xF1AF310)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xF1AFBA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xF1AF2A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xF1AF660)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_ONPOSTGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xF1AFB30)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_ONSTAGECHANGED_OFFSET UNITYSDK_OFFSET(0xF1AFA20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_PROCESSEVENT_OFFSET UNITYSDK_OFFSET(0xF1AFC80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xF1AF120)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT_UNBINDEVENTLISTENER_OFFSET UNITYSDK_OFFSET(0xF1AF6D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xF1AFDA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xF1AFDC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0xF1AFDD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT__REGISTERPORTS_B__4_2_OFFSET UNITYSDK_OFFSET(0xF1AFDE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xF1AFDF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xF1AFE00)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_ONEVENT___BASE_ONPOSTGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xF1AFE10)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_OnEvent_TypeDefinitionIndex = 55940;

	class LD_AbyssS2_OnEvent : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueOutput_1<::MoleMole::AbyssS2_EventType>* _eventOut; // 0xA8
