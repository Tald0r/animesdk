...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0x6E8CA60)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__1_OFFSET UNITYSDK_OFFSET(0x6E8CF50)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__2_OFFSET UNITYSDK_OFFSET(0x6E8CFB0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__3_OFFSET UNITYSDK_OFFSET(0x6E8D010)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__4_OFFSET UNITYSDK_OFFSET(0x6E8D070)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__5_OFFSET UNITYSDK_OFFSET(0x6E8D090)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__6_OFFSET UNITYSDK_OFFSET(0x6E8D270)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_B__7_OFFSET UNITYSDK_OFFSET(0x6E8D310)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTLIMITCHALLENGE___C__DISPLAYCLASS27_0__ONSTART_G__STARTCHALLENGE_0_OFFSET UNITYSDK_OFFSET(0x6E8CA70)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_StartLimitChallenge___c__DisplayClass27_0_TypeDefinitionIndex = 38464;
