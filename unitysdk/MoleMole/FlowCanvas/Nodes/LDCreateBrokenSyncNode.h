...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEBROKENSYNCNODE_ONENTIYREADY_OFFSET UNITYSDK_OFFSET(0x8F6F220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEBROKENSYNCNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8F6E870)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEBROKENSYNCNODE_TRYCREATEBROKEN_OFFSET UNITYSDK_OFFSET(0x8F6EA00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEBROKENSYNCNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F6F4D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEBROKENSYNCNODE__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x8F6F4F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATEBROKENSYNCNODE__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0x8F6F560)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateBrokenSyncNode_TypeDefinitionIndex = 66370;
	...
	public:
		...
		::MoleMole::Battle::Entity* monster; // 0xB8
