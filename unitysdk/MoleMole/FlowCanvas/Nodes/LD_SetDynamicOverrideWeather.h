...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6E8BF70)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHER_REVERT_OFFSET UNITYSDK_OFFSET(0x6E8C320)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHER_START_OFFSET UNITYSDK_OFFSET(0x6E8C0E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHER__CTOR_OFFSET UNITYSDK_OFFSET(0x6E8C590)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHER__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x6E8C5B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHER__REGISTERPORTS_B__3_1_OFFSET UNITYSDK_OFFSET(0x6E8C5E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SetDynamicOverrideWeather_TypeDefinitionIndex = 61293;
