...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CHECKENTITYNEEDCHAT_INVOKE_OFFSET UNITYSDK_OFFSET(0x8F78FD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CHECKENTITYNEEDCHAT__CTOR_OFFSET UNITYSDK_OFFSET(0x8F790A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_CheckEntityNeedChat_TypeDefinitionIndex = 72632;
