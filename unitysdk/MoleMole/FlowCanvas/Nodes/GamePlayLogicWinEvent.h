...
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT_ONRECEIVEEVENT_OFFSET UNITYSDK_OFFSET(0x8AEFDE0)
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8AEFD60)
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x8AEFB40)
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x8AEFC50)
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x8AEFED0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int GamePlayLogicWinEvent_TypeDefinitionIndex = 50891;
