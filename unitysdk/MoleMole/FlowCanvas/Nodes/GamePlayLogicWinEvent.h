...
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT_ONRECEIVEEVENT_OFFSET UNITYSDK_OFFSET(0x11646B30)
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x11646AB0)
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x11646890)
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x116469A0)
#define MOLEMOLE_FLOWCANVAS_NODES_GAMEPLAYLOGICWINEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x11646C20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int GamePlayLogicWinEvent_TypeDefinitionIndex = 75488;
