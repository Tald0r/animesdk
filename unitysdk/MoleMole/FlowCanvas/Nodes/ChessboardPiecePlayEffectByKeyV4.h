...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYEFFECTBYKEYV4_INVOKE_OFFSET UNITYSDK_OFFSET(0x6AD9530)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYEFFECTBYKEYV4__CTOR_OFFSET UNITYSDK_OFFSET(0x6AD9760)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardPiecePlayEffectByKeyV4_TypeDefinitionIndex = 70637;
