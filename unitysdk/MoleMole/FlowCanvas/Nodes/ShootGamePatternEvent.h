...
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT_ONRECEIVEEVENT_OFFSET UNITYSDK_OFFSET(0x7F0BA00)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7F0B660)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x7F0B7E0)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT_UNSUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x7F0B8F0)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x7F0BD00)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0x7F0BD30)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0x7F0BD40)
#define MOLEMOLE_FLOWCANVAS_NODES_SHOOTGAMEPATTERNEVENT__REGISTERPORTS_B__6_2_OFFSET UNITYSDK_OFFSET(0x7F0BD50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ShootGamePatternEvent_TypeDefinitionIndex = 66959;
