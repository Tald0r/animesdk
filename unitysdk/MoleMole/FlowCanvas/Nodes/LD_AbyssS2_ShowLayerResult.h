...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_SHOWLAYERRESULT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC9CAC70)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_SHOWLAYERRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xC9CAD70)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_SHOWLAYERRESULT__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xC9CAD90)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_SHOWLAYERRESULT__REGISTERPORTS_B__2_1_OFFSET UNITYSDK_OFFSET(0xC9CAF20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_ShowLayerResult_TypeDefinitionIndex = 52948;
