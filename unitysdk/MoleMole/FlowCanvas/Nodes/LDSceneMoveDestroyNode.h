...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE_BEIGIN_OFFSET UNITYSDK_OFFSET(0xB17EDF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE_DEINITSCENEMOVEENTITY_OFFSET UNITYSDK_OFFSET(0xB17F1A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0xB17ED90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB17EC30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE__BEIGIN_G__FINISH_7_0_OFFSET UNITYSDK_OFFSET(0xB17F150)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB17F7D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0xB17F7F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0xB17F820)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0xB17F830)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSceneMoveDestroyNode_TypeDefinitionIndex = 37577;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::System::String*>* keyInput; // 0xC8
