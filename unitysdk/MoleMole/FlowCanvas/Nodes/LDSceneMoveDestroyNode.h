...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE_BEIGIN_OFFSET UNITYSDK_OFFSET(0x8AF9A20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE_DEINITSCENEMOVEENTITY_OFFSET UNITYSDK_OFFSET(0x8AF9DD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x8AF99C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8AF9860)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE__BEIGIN_G__FINISH_7_0_OFFSET UNITYSDK_OFFSET(0x8AF9D80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x8AFA410)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE__REGISTERPORTS_B__5_0_OFFSET UNITYSDK_OFFSET(0x8AFA430)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE__REGISTERPORTS_B__5_1_OFFSET UNITYSDK_OFFSET(0x8AFA460)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSCENEMOVEDESTROYNODE___BASE_DOPRELOAD_OFFSET UNITYSDK_OFFSET(0x8AFA470)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSceneMoveDestroyNode_TypeDefinitionIndex = 62108;
