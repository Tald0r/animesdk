...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYPREDICTMOVE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA5DF490)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYPREDICTMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0xA5DFA00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowEntityPredictMove_TypeDefinitionIndex = 49036;
