...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYNAPEFFECT_INVOKE_OFFSET UNITYSDK_OFFSET(0xC20E6C0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYNAPEFFECT_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xC20E9E0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYNAPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC20EB70)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDPIECEPLAYNAPEFFECT___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xC20EC20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardPiecePlayNapEffect_TypeDefinitionIndex = 41400;
