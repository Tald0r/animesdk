...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xB18E780)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xB18E7F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB18E150)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0xB18E5D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE__BINDEVENT_OFFSET UNITYSDK_OFFSET(0xB18E430)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB18E860)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE__ONEVENT_OFFSET UNITYSDK_OFFSET(0xB18E310)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xB18E880)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xB18E8D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LISTENAVATARDEATHCOUNTNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xB18E8E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ListenAvatarDeathCountNode_TypeDefinitionIndex = 54109;

	class LD_ListenAvatarDeathCountNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::FlowOutput* OnDeathOut; // 0xA8
