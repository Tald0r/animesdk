...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_GETCURMUSICPLAYTIME_OFFSET UNITYSDK_OFFSET(0xEC70790)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_GET_CURRENTCHESSBOARD_OFFSET UNITYSDK_OFFSET(0xEC6FA90)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_INTERRUPT_OFFSET UNITYSDK_OFFSET(0xEC71590)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_ONBGMSYNCCALLBACKEVENT_OFFSET UNITYSDK_OFFSET(0xEC704B0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xEC70100)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xEC70620)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xEC6FBC0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_RESET_OFFSET UNITYSDK_OFFSET(0xEC70270)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_START_OFFSET UNITYSDK_OFFSET(0xEC713F0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_UPDATE_OFFSET UNITYSDK_OFFSET(0xEC70A00)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__CTOR_OFFSET UNITYSDK_OFFSET(0xEC71630)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_0_OFFSET UNITYSDK_OFFSET(0xEC71650)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_1_OFFSET UNITYSDK_OFFSET(0xEC71680)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_2_OFFSET UNITYSDK_OFFSET(0xEC71750)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_3_OFFSET UNITYSDK_OFFSET(0xEC71760)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_4_OFFSET UNITYSDK_OFFSET(0xEC71770)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_5_OFFSET UNITYSDK_OFFSET(0xEC71780)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_6_OFFSET UNITYSDK_OFFSET(0xEC71790)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_7_OFFSET UNITYSDK_OFFSET(0xEC717A0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_8_OFFSET UNITYSDK_OFFSET(0xEC717B0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__UPDATE_G__TRYLATETICK_42_0_OFFSET UNITYSDK_OFFSET(0xEC71380)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xEC717C0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xEC717D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardBeatMapUpdater_TypeDefinitionIndex = 72229;

	class ChessboardBeatMapUpdater : public ::FlowCanvas::FlowNode
	{
	public:
		::FlowCanvas::FlowOutput* lateTick; // 0xA8
		::FlowCanvas::FlowOutput* update; // 0xB0
		::FlowCanvas::ValueOutput_1<::System::Collections::Generic::List_1<::MoleMole::ConfigRhythmMoveBeatMap_BeatMap_BeatItem>*>* alertBeatItems; // 0xB8
		::FlowCanvas::FlowOutput* finish; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Boolean>* continueAfterMusicFinish; // 0xC8
		::FlowCanvas::ValueInput_1<::System::Single>* speedRatio; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Single>* lateTickOffset; // 0xD8
		::FlowCanvas::ValueInput_1<::System::Int32>* beatIndexOffset; // 0xE0
		::FlowCanvas::ValueInput_1<::System::Int32>* alertBeatOffset; // 0xE8
		::FlowCanvas::ValueOutput_1<::System::Int32>* currentBeatIndexWithOffset; // 0xF0
		::MoleMole::ConfigRhythmMoveBeatMap_BeatMap* _beatMap; // 0xF8
		::FlowCanvas::ValueOutput_1<::System::Single>* preBeatTime; // 0x100
		::FlowCanvas::ValueInput_1<::System::Single>* beatMapTimeOffset; // 0x108
		::FlowCanvas::ValueOutput_1<::System::Int32>* currentBeatIndex; // 0x110
		::FlowCanvas::ValueInput_1<::System::String*>* beatMapKey; // 0x118
		::FlowCanvas::ValueOutput_1<::System::Single>* nextBeatTime; // 0x120
		::FlowCanvas::ValueOutput_1<::System::Collections::Generic::List_1<::MoleMole::ConfigRhythmMoveBeatMap_BeatMap_BeatItem>*>* currentBeatItems; // 0x128
		::Class_5_AF65C3A968E836D2* _savedCurrentChessboard; // 0x130
		...
		::FlowCanvas::ValueOutput_1<::System::Single>* currentTime; // 0x148
		::System::Collections::Generic::List_1<::MoleMole::ConfigRhythmMoveBeatMap_BeatMap_BeatItem>* _alertBeatItems; // 0x150
		::System::Single _lastLateBeatIndex; // 0x158
		::System::Single _nextLateBeatTime; // 0x15C
		::System::Single _currentTime; // 0x160
		::System::Single _lastUpdatedTime; // 0x164
		::System::Int32 _lastBeatIndex; // 0x168
		::System::Boolean _revertFlag; // 0x16C
		::System::Boolean _nodeEnter; // 0x16D
		::System::Boolean _finish; // 0x16E
		::System::Boolean _init; // 0x16F
		::System::Single _nextBeatTime; // 0x170
		::System::Single _preBeatTime; // 0x174
		::System::Int32 beatOffset; // 0x178
