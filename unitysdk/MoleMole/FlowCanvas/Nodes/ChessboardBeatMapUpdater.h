...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_GETCURMUSICPLAYTIME_OFFSET UNITYSDK_OFFSET(0x756F270)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_GET_CURRENTCHESSBOARD_OFFSET UNITYSDK_OFFSET(0x756E580)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_INTERRUPT_OFFSET UNITYSDK_OFFSET(0x7570080)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_ONBGMSYNCCALLBACKEVENT_OFFSET UNITYSDK_OFFSET(0x756EF90)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x756EBE0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x756F100)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x756E6A0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_RESET_OFFSET UNITYSDK_OFFSET(0x756ED50)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_START_OFFSET UNITYSDK_OFFSET(0x756FEF0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER_UPDATE_OFFSET UNITYSDK_OFFSET(0x756F4E0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__CTOR_OFFSET UNITYSDK_OFFSET(0x7570120)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_0_OFFSET UNITYSDK_OFFSET(0x7570140)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_1_OFFSET UNITYSDK_OFFSET(0x7570170)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_2_OFFSET UNITYSDK_OFFSET(0x7570240)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_3_OFFSET UNITYSDK_OFFSET(0x7570250)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_4_OFFSET UNITYSDK_OFFSET(0x7570260)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_5_OFFSET UNITYSDK_OFFSET(0x7570270)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_6_OFFSET UNITYSDK_OFFSET(0x7570280)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_7_OFFSET UNITYSDK_OFFSET(0x7570290)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__REGISTERPORTS_B__36_8_OFFSET UNITYSDK_OFFSET(0x75702A0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER__UPDATE_G__TRYLATETICK_42_0_OFFSET UNITYSDK_OFFSET(0x756FE80)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x75702B0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDBEATMAPUPDATER___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x75702C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardBeatMapUpdater_TypeDefinitionIndex = 65631;

	class ChessboardBeatMapUpdater : public ::FlowCanvas::FlowNode
	{
	public:
		::FlowCanvas::ValueOutput_1<::System::Collections::Generic::List_1<::MoleMole::ConfigRhythmMoveBeatMap_BeatMap_BeatItem>*>* alertBeatItems; // 0xA8
		::FlowCanvas::ValueOutput_1<::System::Single>* preBeatTime; // 0xB0
		::FlowCanvas::FlowOutput* finish; // 0xB8
		::FlowCanvas::ValueOutput_1<::System::Int32>* currentBeatIndex; // 0xC0
		::System::Collections::Generic::List_1<::MoleMole::ConfigRhythmMoveBeatMap_BeatMap_BeatItem>* _alertBeatItems; // 0xC8
		::FlowCanvas::ValueOutput_1<::System::Collections::Generic::List_1<::MoleMole::ConfigRhythmMoveBeatMap_BeatMap_BeatItem>*>* currentBeatItems; // 0xD0
		::FlowCanvas::ValueInput_1<::System::Single>* beatMapTimeOffset; // 0xD8
		::FlowCanvas::ValueInput_1<::System::String*>* beatMapKey; // 0xE0
		::FlowCanvas::ValueInput_1<::System::Boolean>* continueAfterMusicFinish; // 0xE8
		::FlowCanvas::FlowOutput* lateTick; // 0xF0
		::FlowCanvas::FlowOutput* update; // 0xF8
		::FlowCanvas::ValueInput_1<::System::Int32>* beatIndexOffset; // 0x100
		::FlowCanvas::ValueInput_1<::System::Single>* speedRatio; // 0x108
		::MoleMole::ConfigRhythmMoveBeatMap_BeatMap* _beatMap; // 0x110
		::FlowCanvas::ValueInput_1<::System::Int32>* alertBeatOffset; // 0x118
		::Class_5_AF65C3A968E836D2* _savedCurrentChessboard; // 0x120
		::FlowCanvas::ValueOutput_1<::System::Int32>* currentBeatIndexWithOffset; // 0x128
		::FlowCanvas::ValueOutput_1<::System::Single>* nextBeatTime; // 0x130
		::System::Collections::Generic::List_1<::MoleMole::ConfigRhythmMoveBeatMap_BeatMap_BeatItem>* _currentBeatItems; // 0x138
		::FlowCanvas::ValueInput_1<::System::Boolean>* enableAutoRefreshIndex; // 0x140
		::FlowCanvas::ValueInput_1<::System::Single>* lateTickOffset; // 0x148
		::FlowCanvas::ValueOutput_1<::System::Single>* currentTime; // 0x150
		::System::Single _preBeatTime; // 0x158
		::System::Int32 beatOffset; // 0x15C
		::System::Boolean _finish; // 0x160
		::System::Boolean _init; // 0x161
		::System::Boolean _revertFlag; // 0x162
		::System::Boolean _nodeEnter; // 0x163
		::System::Single _nextLateBeatTime; // 0x164
		::System::Single _lastUpdatedTime; // 0x168
		::System::Int32 _lastBeatIndex; // 0x16C
		::System::Single _nextBeatTime; // 0x170
		::System::Single _lastLateBeatIndex; // 0x174
