...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CREATEINTERACTIONBUILDDATABYROOMAREANO_INNERBUILD_OFFSET UNITYSDK_OFFSET(0xCD50C90)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CREATEINTERACTIONBUILDDATABYROOMAREANO_INVOKE_OFFSET UNITYSDK_OFFSET(0xCD50B80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_CREATEINTERACTIONBUILDDATABYROOMAREANO__CTOR_OFFSET UNITYSDK_OFFSET(0xCD50F20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_CreateInteractionBuildDataByRoomAreaNo_TypeDefinitionIndex = 50437;
