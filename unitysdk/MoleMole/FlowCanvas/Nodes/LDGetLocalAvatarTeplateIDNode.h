...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLOCALAVATARTEPLATEIDNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xE475830)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETLOCALAVATARTEPLATEIDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE475AC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetLocalAvatarTeplateIDNode_TypeDefinitionIndex = 74210;
