...
#define MOLEMOLE_FLOWCANVAS_NODES_LDENTERTOPVIEWCAMERA_INVOKE_OFFSET UNITYSDK_OFFSET(0x82C7DD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDENTERTOPVIEWCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x82C7F00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDEnterTopViewCamera_TypeDefinitionIndex = 69809;
