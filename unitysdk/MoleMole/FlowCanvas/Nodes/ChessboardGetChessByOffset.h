...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCHESSBYOFFSET_INVOKE_OFFSET UNITYSDK_OFFSET(0x75706F0)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCHESSBYOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x7570990)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardGetChessByOffset_TypeDefinitionIndex = 60272;
