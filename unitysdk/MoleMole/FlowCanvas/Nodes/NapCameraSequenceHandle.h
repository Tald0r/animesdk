...
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE_ISVALID_1_OFFSET UNITYSDK_OFFSET(0x50F450)
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x50F420)
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE_JUMPTOSECTION_OFFSET UNITYSDK_OFFSET(0x50F460)
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE_STOP_OFFSET UNITYSDK_OFFSET(0x50F470)
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x50F410)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int NapCameraSequenceHandle_TypeDefinitionIndex = 59021;
