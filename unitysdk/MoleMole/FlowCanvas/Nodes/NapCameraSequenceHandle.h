...
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE_ISVALID_1_OFFSET UNITYSDK_OFFSET(0x472130)
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x472100)
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE_JUMPTOSECTION_OFFSET UNITYSDK_OFFSET(0x472140)
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE_STOP_OFFSET UNITYSDK_OFFSET(0x472150)
#define MOLEMOLE_FLOWCANVAS_NODES_NAPCAMERASEQUENCEHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x4720F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int NapCameraSequenceHandle_TypeDefinitionIndex = 58860;
