...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETSTRING_DOSET_OFFSET UNITYSDK_OFFSET(0xEC7FE60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0xEC80050)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPUBLICVARIABLESETSTRING___BASE_DOSET_OFFSET UNITYSDK_OFFSET(0xEC80080)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPublicVariableSetString_TypeDefinitionIndex = 39691;
