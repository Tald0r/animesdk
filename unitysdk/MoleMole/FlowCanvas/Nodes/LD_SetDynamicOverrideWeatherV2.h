...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2_POP_OFFSET UNITYSDK_OFFSET(0xB8A9420)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2_PUSH_OFFSET UNITYSDK_OFFSET(0xB8A91E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB8A9070)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A96D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0xB8A96F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETDYNAMICOVERRIDEWEATHERV2__REGISTERPORTS_B__3_1_OFFSET UNITYSDK_OFFSET(0xB8A9720)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SetDynamicOverrideWeatherV2_TypeDefinitionIndex = 63144;
