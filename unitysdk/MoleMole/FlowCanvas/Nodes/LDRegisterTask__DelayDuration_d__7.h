...
#define MOLEMOLE_FLOWCANVAS_NODES_LDREGISTERTASK__DELAYDURATION_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA7D3520)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREGISTERTASK__DELAYDURATION_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA7D3620)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREGISTERTASK__DELAYDURATION_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA7D3680)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREGISTERTASK__DELAYDURATION_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA7D3630)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREGISTERTASK__DELAYDURATION_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA7D3510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDREGISTERTASK__DELAYDURATION_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0xA7D3500)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDRegisterTask__DelayDuration_d__7_TypeDefinitionIndex = 52006;
