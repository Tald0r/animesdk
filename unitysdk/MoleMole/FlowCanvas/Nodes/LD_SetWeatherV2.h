...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETWEATHERV2_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6E21F70)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETWEATHERV2_START_OFFSET UNITYSDK_OFFSET(0x6E22080)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETWEATHERV2__CTOR_OFFSET UNITYSDK_OFFSET(0x6E22370)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SETWEATHERV2__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x6E22390)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SetWeatherV2_TypeDefinitionIndex = 78092;
