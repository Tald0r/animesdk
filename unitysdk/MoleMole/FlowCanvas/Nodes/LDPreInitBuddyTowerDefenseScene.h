...
#define MOLEMOLE_FLOWCANVAS_NODES_LDPREINITBUDDYTOWERDEFENSESCENE_INITBUDDYTOWERDEFENSESCENE_OFFSET UNITYSDK_OFFSET(0x8AF7F60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPREINITBUDDYTOWERDEFENSESCENE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8AF7E80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPREINITBUDDYTOWERDEFENSESCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x8AF84E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDPREINITBUDDYTOWERDEFENSESCENE__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x8AF8500)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDPreInitBuddyTowerDefenseScene_TypeDefinitionIndex = 63475;
