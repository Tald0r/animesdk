...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWGETPOSITIONBYOFFSET_INVOKE_OFFSET UNITYSDK_OFFSET(0xEC72340)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWGETPOSITIONBYOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0xEC72450)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowGetPositionByOffset_TypeDefinitionIndex = 52433;
