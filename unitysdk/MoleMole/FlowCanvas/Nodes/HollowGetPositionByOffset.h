...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWGETPOSITIONBYOFFSET_INVOKE_OFFSET UNITYSDK_OFFSET(0x7570E30)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWGETPOSITIONBYOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x7570F40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowGetPositionByOffset_TypeDefinitionIndex = 69514;
