...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSORTDAILYCARDDATA_INVOKE_OFFSET UNITYSDK_OFFSET(0xC21BFE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSORTDAILYCARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC21C0C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSortDailyCardData_TypeDefinitionIndex = 44756;
