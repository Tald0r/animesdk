...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSORTDAILYCARDDATA_INVOKE_OFFSET UNITYSDK_OFFSET(0xB832750)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSORTDAILYCARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB832830)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSortDailyCardData_TypeDefinitionIndex = 46777;
