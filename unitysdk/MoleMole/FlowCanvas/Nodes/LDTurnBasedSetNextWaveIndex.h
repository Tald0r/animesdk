...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDSETNEXTWAVEINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0x82D1140)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDSETNEXTWAVEINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x82D12A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedSetNextWaveIndex_TypeDefinitionIndex = 49800;
