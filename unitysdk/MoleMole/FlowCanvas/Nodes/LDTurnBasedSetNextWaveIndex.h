...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDSETNEXTWAVEINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0xA38B380)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDSETNEXTWAVEINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xA38B4E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedSetNextWaveIndex_TypeDefinitionIndex = 79362;
