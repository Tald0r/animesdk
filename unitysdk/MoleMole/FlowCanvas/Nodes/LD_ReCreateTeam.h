...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_RECREATETEAM_PROCESS_OFFSET UNITYSDK_OFFSET(0xC2CD100)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_RECREATETEAM_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC2CD020)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_RECREATETEAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC2CD420)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_RECREATETEAM__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0xC2CD440)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ReCreateTeam_TypeDefinitionIndex = 63828;
