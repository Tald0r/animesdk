...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETREVIVECOUNT_INVOKE_OFFSET UNITYSDK_OFFSET(0x7A63F20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_GETREVIVECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x7A640A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_GetReviveCount_TypeDefinitionIndex = 57571;
