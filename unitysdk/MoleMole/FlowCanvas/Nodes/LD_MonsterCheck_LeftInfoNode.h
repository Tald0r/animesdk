...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0xD808B10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xD808CE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xD808860)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xD8086B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0xD8088D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__CTOR_OFFSET UNITYSDK_OFFSET(0xD808F80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__ONEVENTFROMANYONE_B__12_0_OFFSET UNITYSDK_OFFSET(0xD809250)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0xD808FA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0xD809170)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__START_OFFSET UNITYSDK_OFFSET(0xD808AA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xD809290)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_MonsterCheck_LeftInfoNode_TypeDefinitionIndex = 56831;
	...
	public:
		...
		::FlowCanvas::ValueOutput_1<::System::Int32>* _aliveCount; // 0xB8
		::FlowCanvas::FlowOutput* _output; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Boolean>* _isUpgrade; // 0xC8
