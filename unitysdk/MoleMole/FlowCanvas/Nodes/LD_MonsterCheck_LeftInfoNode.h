...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_BINDEVENT_OFFSET UNITYSDK_OFFSET(0xE480B00)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xE480CD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xE480850)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE4806A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0xE4808C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE480F70)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__ONEVENTFROMANYONE_B__12_0_OFFSET UNITYSDK_OFFSET(0xE481240)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0xE480F90)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0xE481160)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE__START_OFFSET UNITYSDK_OFFSET(0xE480A90)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERCHECK_LEFTINFONODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xE481280)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_MonsterCheck_LeftInfoNode_TypeDefinitionIndex = 61335;

	class LD_MonsterCheck_LeftInfoNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Boolean>* _isUpgrade; // 0xA8
		::FlowCanvas::ValueInput_1<::MoleMole::Config::MonsterStrengthType>* _monsterStrength; // 0xB0
		::FlowCanvas::FlowOutput* _output; // 0xB8
		::FlowCanvas::FlowOutput* _OnChanged; // 0xC0
		::FlowCanvas::ValueInput_1<::System::Boolean>* _isAll; // 0xC8
		::FlowCanvas::ValueOutput_1<::System::Int32>* _aliveCount; // 0xD0
