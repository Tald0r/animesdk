...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE_ONMONSTERDIE_OFFSET UNITYSDK_OFFSET(0xC268600)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC268350)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE__CTOR_OFFSET UNITYSDK_OFFSET(0xC268D50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0xC268D70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE__REGISTERPORTS_B__1_1_OFFSET UNITYSDK_OFFSET(0xC268F50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE__REGISTERPORTS_B__1_2_OFFSET UNITYSDK_OFFSET(0xC269020)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE___BASE_ONMONSTERDIE_OFFSET UNITYSDK_OFFSET(0xC269030)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENMONSTERDIE___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC269040)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenMonsterDie_TypeDefinitionIndex = 54933;
