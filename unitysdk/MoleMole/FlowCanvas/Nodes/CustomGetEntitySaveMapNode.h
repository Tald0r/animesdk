...
#define MOLEMOLE_FLOWCANVAS_NODES_CUSTOMGETENTITYSAVEMAPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x82C6900)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int CustomGetEntitySaveMapNode_TypeDefinitionIndex = 40200;
