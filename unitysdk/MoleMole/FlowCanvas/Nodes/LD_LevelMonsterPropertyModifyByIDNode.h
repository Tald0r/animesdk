...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB8A6EC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A7000)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE__REGISTERPORTS_B__2_1_OFFSET UNITYSDK_OFFSET(0xB8A74C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE__REGISTERPORTS_B__2_2_OFFSET UNITYSDK_OFFSET(0xB8A7510)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE__REGISTERPORTS_G___SETKEY_2_0_OFFSET UNITYSDK_OFFSET(0xB8A7020)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_LevelMonsterPropertyModifyByIDNode_TypeDefinitionIndex = 37526;
