...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC2CB420)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2CB560)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE__REGISTERPORTS_B__2_1_OFFSET UNITYSDK_OFFSET(0xC2CBA20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE__REGISTERPORTS_B__2_2_OFFSET UNITYSDK_OFFSET(0xC2CBA70)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_LEVELMONSTERPROPERTYMODIFYBYIDNODE__REGISTERPORTS_G___SETKEY_2_0_OFFSET UNITYSDK_OFFSET(0xC2CB580)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_LevelMonsterPropertyModifyByIDNode_TypeDefinitionIndex = 43719;
