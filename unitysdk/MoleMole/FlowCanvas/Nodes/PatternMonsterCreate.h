...
#define MOLEMOLE_FLOWCANVAS_NODES_PATTERNMONSTERCREATE__CTOR_OFFSET UNITYSDK_OFFSET(0xB8AA800)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int PatternMonsterCreate_TypeDefinitionIndex = 68960;

	class PatternMonsterCreate : public ::MoleMole::FlowCanvas::Nodes::MonsterCreateDataBase
	{
	public:
		::System::Int32 areaMinAngle; // 0x48
		::System::Single areaMaxRange; // 0x4C
		::System::Single areaMinRange; // 0x50
