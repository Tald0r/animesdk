...
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__SINGLEINTERNALCOROUTINE_D__69_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB985AD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__SINGLEINTERNALCOROUTINE_D__69_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB9867C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__SINGLEINTERNALCOROUTINE_D__69_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB986820)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__SINGLEINTERNALCOROUTINE_D__69_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB9867D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__SINGLEINTERNALCOROUTINE_D__69_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB985AC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDWAVEMONSTER__SINGLEINTERNALCOROUTINE_D__69__CTOR_OFFSET UNITYSDK_OFFSET(0xB985AB0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDWaveMonster__SingleInternalCoroutine_d__69_TypeDefinitionIndex = 51979;
