...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARTSHOOTBEATMAP_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6AEE4F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARTSHOOTBEATMAP_START_OFFSET UNITYSDK_OFFSET(0x6AEE6A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARTSHOOTBEATMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x6AEE9B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARTSHOOTBEATMAP__START_G__ONFINISH_6_1_OFFSET UNITYSDK_OFFSET(0x6AEE9E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARTSHOOTBEATMAP__START_G__ONSTART_6_0_OFFSET UNITYSDK_OFFSET(0x6AEE9D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDStartShootBeatMap_TypeDefinitionIndex = 55022;
