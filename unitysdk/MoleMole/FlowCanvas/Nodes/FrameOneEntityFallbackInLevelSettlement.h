...
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0xA007C30)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0xA007CC0)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0xA007EA0)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0xA007F80)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0xA007E40)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xA007F70)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_ISLOOP_OFFSET UNITYSDK_OFFSET(0xA007F10)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_METHOD_5_1C8B3BE692DDD2FB_OFFSET UNITYSDK_OFFSET(0xA0082A0)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_METHOD_5_24B1E1DE85E3C92F_OFFSET UNITYSDK_OFFSET(0xA00A6C0)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_METHOD_5_2C57E01B5F9E414E_OFFSET UNITYSDK_OFFSET(0xA00A5F0)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_METHOD_5_481846442A541626_OFFSET UNITYSDK_OFFSET(0xA00A100)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_METHOD_5_67A0C6C4B5A4811F_OFFSET UNITYSDK_OFFSET(0xA009F50)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_METHOD_5_834919B5E4C42716_OFFSET UNITYSDK_OFFSET(0xA00A020)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_METHOD_5_C1397965C8E8E75A_OFFSET UNITYSDK_OFFSET(0xA009E70)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_METHOD_5_C2848DDD4D0013BC_OFFSET UNITYSDK_OFFSET(0xA009930)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT_METHOD_5_DB4FC2BDB0943F99_OFFSET UNITYSDK_OFFSET(0xA009C60)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xA0097E0)
#define MOLEMOLE_FLOWCANVAS_NODES_FRAMEONEENTITYFALLBACKINLEVELSETTLEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA009750)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int FrameOneEntityFallbackInLevelSettlement_TypeDefinitionIndex = 41742;
	...
	public:
		...
		{
			return (::System::Func_5<::MoleMole::FlowCanvas::Nodes::FrameOneEntityFallbackInLevelSettlement*, ::System::Single, ::PipelineCamera::WorldBasicCameraData, ::PipelineCamera::CameraSequence::CameraSequenceContext*, ::PipelineCamera::WorldBasicCameraData>**)Il2CppClass::FromTypeDefinitionIndex(FrameOneEntityFallbackInLevelSettlement_TypeDefinitionIndex)->GetStaticField(0x39210);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_resampleEachTime()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOneEntityFallbackInLevelSettlement_TypeDefinitionIndex)->GetStaticField(0xDF50);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_EntityWorld()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOneEntityFallbackInLevelSettlement_TypeDefinitionIndex)->GetStaticField(0xDF58);
		}
		static ::Foundation::Unreal::FName* StaticGet_CachedId()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOneEntityFallbackInLevelSettlement_TypeDefinitionIndex)->GetStaticField(0xDF60);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_screenOffset()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOneEntityFallbackInLevelSettlement_TypeDefinitionIndex)->GetStaticField(0xDF68);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_heightRatio()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOneEntityFallbackInLevelSettlement_TypeDefinitionIndex)->GetStaticField(0xDF70);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_EntityId()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOneEntityFallbackInLevelSettlement_TypeDefinitionIndex)->GetStaticField(0xDF78);
		}
