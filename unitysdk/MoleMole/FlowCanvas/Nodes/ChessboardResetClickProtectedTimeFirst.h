...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDRESETCLICKPROTECTEDTIMEFIRST_INVOKE_OFFSET UNITYSDK_OFFSET(0xF19D770)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDRESETCLICKPROTECTEDTIMEFIRST__CTOR_OFFSET UNITYSDK_OFFSET(0xF19D810)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardResetClickProtectedTimeFirst_TypeDefinitionIndex = 60409;
