...
#define MOLEMOLE_FLOWCANVAS_NODES_RANDOMMONSTERLAB_GETVALUE_OFFSET UNITYSDK_OFFSET(0x7F0B420)
#define MOLEMOLE_FLOWCANVAS_NODES_RANDOMMONSTERLAB_SETVALUE_OFFSET UNITYSDK_OFFSET(0x7F0B540)
#define MOLEMOLE_FLOWCANVAS_NODES_RANDOMMONSTERLAB__CTOR_OFFSET UNITYSDK_OFFSET(0x7F0B640)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int RandomMonsterLab_TypeDefinitionIndex = 54522;
