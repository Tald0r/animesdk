...
#define MOLEMOLE_FLOWCANVAS_NODES_RANDOMMONSTERLAB_GETVALUE_OFFSET UNITYSDK_OFFSET(0xCD55A80)
#define MOLEMOLE_FLOWCANVAS_NODES_RANDOMMONSTERLAB_SETVALUE_OFFSET UNITYSDK_OFFSET(0xCD55BA0)
#define MOLEMOLE_FLOWCANVAS_NODES_RANDOMMONSTERLAB__CTOR_OFFSET UNITYSDK_OFFSET(0xCD55CA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int RandomMonsterLab_TypeDefinitionIndex = 72218;
