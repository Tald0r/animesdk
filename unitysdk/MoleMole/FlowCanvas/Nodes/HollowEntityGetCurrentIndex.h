...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYGETCURRENTINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0x141D04D0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYGETCURRENTINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x141D0800)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowEntityGetCurrentIndex_TypeDefinitionIndex = 52886;
