...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYGETCURRENTINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0xA4F6660)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYGETCURRENTINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xA4F6990)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowEntityGetCurrentIndex_TypeDefinitionIndex = 37745;
