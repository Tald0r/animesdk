...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CLEARCHATCAMERA_DOCLEARCHATCAMERA_OFFSET UNITYSDK_OFFSET(0xA01E360)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CLEARCHATCAMERA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA01E250)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CLEARCHATCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xA01E510)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CLEARCHATCAMERA__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xA01E530)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ClearChatCamera_TypeDefinitionIndex = 68873;
