...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CLEARCHATCAMERA_DOCLEARCHATCAMERA_OFFSET UNITYSDK_OFFSET(0x8F0C810)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CLEARCHATCAMERA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x8F0C700)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CLEARCHATCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x8F0C9C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_CLEARCHATCAMERA__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x8F0C9E0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ClearChatCamera_TypeDefinitionIndex = 60116;
