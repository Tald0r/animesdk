...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELMULTICHAT__GETAVAILABLECHATKEYS_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA01F080)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELMULTICHAT__GETAVAILABLECHATKEYS_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_OBJECT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA01F510)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELMULTICHAT__GETAVAILABLECHATKEYS_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA01F4A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELMULTICHAT__GETAVAILABLECHATKEYS_D__19_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA01F580)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELMULTICHAT__GETAVAILABLECHATKEYS_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA01F500)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELMULTICHAT__GETAVAILABLECHATKEYS_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA01F4B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELMULTICHAT__GETAVAILABLECHATKEYS_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA01F050)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELMULTICHAT__GETAVAILABLECHATKEYS_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0xA01F030)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_INLEVELMULTICHAT__GETAVAILABLECHATKEYS_D__19___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0xA01F070)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_InLevelMultiChat__GetAvailableChatKeys_d__19_TypeDefinitionIndex = 45651;

	class LD_InLevelMultiChat__GetAvailableChatKeys_d__19 : public ::System::Object
	{
	public:
		::System::Object* __2__current; // 0x10
		::System::Collections::Generic::Dictionary_2_KeyCollection_Enumerator<::System::String*, ::MoleMole::InLevelMultiChatConfig> __7__wrap1; // 0x18
