...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_BABELTOWER_GETCURFLOOROVERRIDEDATA_INVOKE_OFFSET UNITYSDK_OFFSET(0xB18D280)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_BABELTOWER_GETCURFLOOROVERRIDEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB18D470)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_BabelTower_GetCurFloorOverrideData_TypeDefinitionIndex = 68075;
