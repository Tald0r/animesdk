...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISGETONCEREWARD_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6E8B3C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISGETONCEREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x6E8B4D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISGETONCEREWARD__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x6E8B4F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_IsGetOnceReward_TypeDefinitionIndex = 67858;
