...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISGETONCEREWARD_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6E20D00)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISGETONCEREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x6E20E10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ISGETONCEREWARD__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x6E20E30)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_IsGetOnceReward_TypeDefinitionIndex = 73900;
