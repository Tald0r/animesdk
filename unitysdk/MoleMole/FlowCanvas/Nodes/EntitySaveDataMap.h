...
#define MOLEMOLE_FLOWCANVAS_NODES_ENTITYSAVEDATAMAP_GETVALUE_OFFSET UNITYSDK_OFFSET(0xA5DEF10)
#define MOLEMOLE_FLOWCANVAS_NODES_ENTITYSAVEDATAMAP_SETVALUE_OFFSET UNITYSDK_OFFSET(0xA5DF030)
#define MOLEMOLE_FLOWCANVAS_NODES_ENTITYSAVEDATAMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xA5DF100)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int EntitySaveDataMap_TypeDefinitionIndex = 58020;
