...
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETDEADAVATARINFO_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x141D3940)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETDEADAVATARINFO_START_OFFSET UNITYSDK_OFFSET(0x141D3B00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETDEADAVATARINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x141D3E60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETDEADAVATARINFO__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x141D3F00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETDEADAVATARINFO__REGISTERPORTS_B__4_1_OFFSET UNITYSDK_OFFSET(0x141D3F30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETDEADAVATARINFO__REGISTERPORTS_B__4_2_OFFSET UNITYSDK_OFFSET(0x141D3F40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDGETDEADAVATARINFO__REGISTERPORTS_B__4_3_OFFSET UNITYSDK_OFFSET(0x141D3F50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDGetDeadAvatarInfo_TypeDefinitionIndex = 62486;
