...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERLOOPSCENENODE___C__DISPLAYCLASS8_1__CTOR_OFFSET UNITYSDK_OFFSET(0x8F70E80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERLOOPSCENENODE___C__DISPLAYCLASS8_1___TRANSFERAVATARTOLOOPSCENE_G___DELAYSET_1_OFFSET UNITYSDK_OFFSET(0x8F70FD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELZEROENTERLOOPSCENENODE___C__DISPLAYCLASS8_1___TRANSFERAVATARTOLOOPSCENE_G___SETPOS_0_OFFSET UNITYSDK_OFFSET(0x8F70E90)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDLevelZeroEnterLoopSceneNode___c__DisplayClass8_1_TypeDefinitionIndex = 78805;
