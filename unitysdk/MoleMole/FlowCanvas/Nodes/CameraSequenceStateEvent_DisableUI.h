...
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0xC9BAFF0)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0xC9BB060)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xC9BAFB0)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xC9BB050)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xC9BB1E0)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0xC9BB4B0)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0xC9BB430)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI__CCTOR_OFFSET UNITYSDK_OFFSET(0xC9BB7B0)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI__CTOR_OFFSET UNITYSDK_OFFSET(0xC9BB780)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int CameraSequenceStateEvent_DisableUI_TypeDefinitionIndex = 55761;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DisableUI_TypeDefinitionIndex)->GetStaticField(0xA0D0);
		}
