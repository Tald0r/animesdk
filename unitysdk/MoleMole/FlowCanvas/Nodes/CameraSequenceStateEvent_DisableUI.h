...
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0xB9FF9D0)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0xB9FFA40)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0xB9FF990)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xB9FFA30)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0xB9FFBC0)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0xB9FFE90)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0xB9FFE10)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI__CCTOR_OFFSET UNITYSDK_OFFSET(0xBA00190)
#define MOLEMOLE_FLOWCANVAS_NODES_CAMERASEQUENCESTATEEVENT_DISABLEUI__CTOR_OFFSET UNITYSDK_OFFSET(0xBA00160)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int CameraSequenceStateEvent_DisableUI_TypeDefinitionIndex = 40835;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_DisableUI_TypeDefinitionIndex)->GetStaticField(0xA570);
		}
