...
#define MOLEMOLE_FLOWCANVAS_NODES_LDFORCEREMOVECARD_INVOKE_OFFSET UNITYSDK_OFFSET(0xC9BCBD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDFORCEREMOVECARD__CTOR_OFFSET UNITYSDK_OFFSET(0xC9BCC80)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDForceRemoveCard_TypeDefinitionIndex = 49509;
