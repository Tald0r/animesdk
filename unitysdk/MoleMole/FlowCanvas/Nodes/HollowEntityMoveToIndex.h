...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVETOINDEX_INVOKEINNER_OFFSET UNITYSDK_OFFSET(0xE0EC800)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVETOINDEX_INVOKES_OFFSET UNITYSDK_OFFSET(0xE0ECC90)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVETOINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0xE0EC700)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVETOINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xE0ECD30)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowEntityMoveToIndex_TypeDefinitionIndex = 58646;
