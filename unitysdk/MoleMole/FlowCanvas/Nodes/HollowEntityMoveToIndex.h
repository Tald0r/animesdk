...
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVETOINDEX_INVOKEINNER_OFFSET UNITYSDK_OFFSET(0x7A51460)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVETOINDEX_INVOKES_OFFSET UNITYSDK_OFFSET(0x7A518F0)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVETOINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0x7A51360)
#define MOLEMOLE_FLOWCANVAS_NODES_HOLLOWENTITYMOVETOINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x7A51990)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int HollowEntityMoveToIndex_TypeDefinitionIndex = 49274;
