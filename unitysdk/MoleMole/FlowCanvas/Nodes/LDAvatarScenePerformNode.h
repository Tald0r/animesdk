...
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC265270)
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC265460)
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0xC265480)
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC2658A0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAvatarScenePerformNode_TypeDefinitionIndex = 52787;
