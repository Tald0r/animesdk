...
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6E15CF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E15EE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x6E15F00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDAVATARSCENEPERFORMNODE___BASE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6E16330)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDAvatarScenePerformNode_TypeDefinitionIndex = 48527;
