...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONBYANCHORTASK_CLOSE_OFFSET UNITYSDK_OFFSET(0xB832D00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONBYANCHORTASK_CORORANDOMPOSITION_OFFSET UNITYSDK_OFFSET(0xB833270)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONBYANCHORTASK_PAUSE_OFFSET UNITYSDK_OFFSET(0xB832BE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONBYANCHORTASK_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB832850)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONBYANCHORTASK_RESUME_OFFSET UNITYSDK_OFFSET(0xB832C70)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONBYANCHORTASK_START_OFFSET UNITYSDK_OFFSET(0xB832E00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONBYANCHORTASK__CTOR_OFFSET UNITYSDK_OFFSET(0xB833330)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONBYANCHORTASK__REGISTERPORTS_B__18_0_OFFSET UNITYSDK_OFFSET(0xB833350)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONBYANCHORTASK__REGISTERPORTS_B__18_1_OFFSET UNITYSDK_OFFSET(0xB833360)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDStarRandomPositionByAnchorTask_TypeDefinitionIndex = 75006;

	class LDStarRandomPositionByAnchorTask : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::UnityEngine::Vector2>* inputRandomDelay; // 0xA8
		...
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::System::String*>*>* _inputDefaultExclude; // 0xC8
		::FlowCanvas::ValueInput_1<::System::Int32>* inputCount; // 0xD0
		::FlowCanvas::ValueInput_1<::UnityEngine::Vector3>* _inputCenterOffset; // 0xD8
		::FlowCanvas::ValueInput_1<::System::Single>* _inputRange; // 0xE0
		::UnityEngine::Coroutine* runingCoroutine; // 0xE8
		::FlowCanvas::FlowOutput* _groupStart; // 0xF0
		::FlowCanvas::ValueInput_1<::System::Collections::Generic::List_1<::System::String*>*>* _inputAnchorList; // 0xF8
		::FlowCanvas::ValueInput_1<::MoleMole::EntityHandle>* inputCenter; // 0x100
		::FlowCanvas::ValueInput_1<::System::Single>* inputInterval; // 0x108
		::FlowCanvas::FlowOutput* _flowOutputOut; // 0x110
		::UnityEngine::Vector3 outPosition; // 0x118
		::MoleMole::FlowCanvas::Nodes::LDStarRandomPositionByAnchorTask_State _state; // 0x124
