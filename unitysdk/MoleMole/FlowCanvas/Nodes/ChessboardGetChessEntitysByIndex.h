...
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCHESSENTITYSBYINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0xE867380)
#define MOLEMOLE_FLOWCANVAS_NODES_CHESSBOARDGETCHESSENTITYSBYINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xE8674B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int ChessboardGetChessEntitysByIndex_TypeDefinitionIndex = 59175;
