...
#define MOLEMOLE_FLOWCANVAS_NODES_LDHASCUTSCENE_CHECK_OFFSET UNITYSDK_OFFSET(0xE0F1700)
#define MOLEMOLE_FLOWCANVAS_NODES_LDHASCUTSCENE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE0F1630)
#define MOLEMOLE_FLOWCANVAS_NODES_LDHASCUTSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0xE0F1800)
#define MOLEMOLE_FLOWCANVAS_NODES_LDHASCUTSCENE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xE0F1820)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDHasCutScene_TypeDefinitionIndex = 71231;
