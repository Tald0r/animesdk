...
#define MOLEMOLE_FLOWCANVAS_NODES_LDHASCUTSCENE_CHECK_OFFSET UNITYSDK_OFFSET(0x7A56430)
#define MOLEMOLE_FLOWCANVAS_NODES_LDHASCUTSCENE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7A56350)
#define MOLEMOLE_FLOWCANVAS_NODES_LDHASCUTSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x7A56530)
#define MOLEMOLE_FLOWCANVAS_NODES_LDHASCUTSCENE__REGISTERPORTS_B__2_0_OFFSET UNITYSDK_OFFSET(0x7A56550)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDHasCutScene_TypeDefinitionIndex = 37420;
