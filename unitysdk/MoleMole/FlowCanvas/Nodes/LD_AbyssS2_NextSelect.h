...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_NEXTSELECT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xCD51320)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_NEXTSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD51650)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_NEXTSELECT__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0xCD51670)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_NEXTSELECT__REGISTERPORTS_B__3_1_OFFSET UNITYSDK_OFFSET(0xCD518D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_NEXTSELECT__SENDEVENT_OFFSET UNITYSDK_OFFSET(0xCD51440)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_NextSelect_TypeDefinitionIndex = 73219;
