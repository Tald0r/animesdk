...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_NEXTSELECT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7F06CE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_NEXTSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x7F07010)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_NEXTSELECT__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0x7F07030)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_NEXTSELECT__REGISTERPORTS_B__3_1_OFFSET UNITYSDK_OFFSET(0x7F07290)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ABYSSS2_NEXTSELECT__SENDEVENT_OFFSET UNITYSDK_OFFSET(0x7F06E00)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_AbyssS2_NextSelect_TypeDefinitionIndex = 41466;
