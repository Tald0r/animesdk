...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORBOOL_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC2C6510)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0xC2C6660)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETANIMATORBOOL__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xC2C6680)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetAnimatorBool_TypeDefinitionIndex = 64262;
