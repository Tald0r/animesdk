...
#define MOLEMOLE_FLOWCANVAS_NODES_LDINTERACTCONTROL_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE475CA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDINTERACTCONTROL_START_OFFSET UNITYSDK_OFFSET(0xE475DD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDINTERACTCONTROL__CONTROLINTERACT_OFFSET UNITYSDK_OFFSET(0xE476120)
#define MOLEMOLE_FLOWCANVAS_NODES_LDINTERACTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xE476420)
#define MOLEMOLE_FLOWCANVAS_NODES_LDINTERACTCONTROL__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0xE476440)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDInteractControl_TypeDefinitionIndex = 41735;
