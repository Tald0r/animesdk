...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_REPLACEAVATARBYROBOTID_PROCESS_OFFSET UNITYSDK_OFFSET(0xC9CB670)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_REPLACEAVATARBYROBOTID_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC9CB4E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_REPLACEAVATARBYROBOTID__CTOR_OFFSET UNITYSDK_OFFSET(0xC9CBA20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_AVATAR_REPLACEAVATARBYROBOTID__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0xC9CBA40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_Avatar_ReplaceAvatarByRobotID_TypeDefinitionIndex = 70623;
