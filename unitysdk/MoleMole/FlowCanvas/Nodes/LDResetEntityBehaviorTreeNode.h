...
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETENTITYBEHAVIORTREENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xCCE51F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETENTITYBEHAVIORTREENODE_ISCOULDOUTCALL_OFFSET UNITYSDK_OFFSET(0xCCE5430)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETENTITYBEHAVIORTREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCCE54A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETENTITYBEHAVIORTREENODE__INVOKE_B__0_0_OFFSET UNITYSDK_OFFSET(0xCCE54C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDRESETENTITYBEHAVIORTREENODE___BASE_ISCOULDOUTCALL_OFFSET UNITYSDK_OFFSET(0xCCE54D0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDResetEntityBehaviorTreeNode_TypeDefinitionIndex = 60960;
