...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_BEGIN_OFFSET UNITYSDK_OFFSET(0xCD3C170)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_DESTROYTARGETAREAUI_OFFSET UNITYSDK_OFFSET(0xCD3C580)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_ONEVENT_OFFSET UNITYSDK_OFFSET(0xCD3CF50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_ONFCSTARTQUICKEXECMODE_OFFSET UNITYSDK_OFFSET(0xCD3D100)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xCD3CE60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xCD3CEE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xCD3C040)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_REMOVELISTEN_OFFSET UNITYSDK_OFFSET(0xCD3C7D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED_STARTLISTEN_OFFSET UNITYSDK_OFFSET(0xCD3CB10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED__CTOR_OFFSET UNITYSDK_OFFSET(0xCD3D2B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED__REGISTERPORTS_B__7_0_OFFSET UNITYSDK_OFFSET(0xCD3D400)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xCD3D430)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLISTENTARGETAREAUIREMOVED___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xCD3D440)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDListenTargetAreaUIRemoved_TypeDefinitionIndex = 69667;

	class LDListenTargetAreaUIRemoved : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::System::Collections::Generic::List_1<::System::String*>* quickRemoveTargetList; // 0xA8
