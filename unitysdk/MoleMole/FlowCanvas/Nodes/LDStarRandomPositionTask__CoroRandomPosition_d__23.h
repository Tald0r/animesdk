...
class Class_1_E3601008F832A38A;
namespace MoleMole::FlowCanvas::Nodes { class LDStarRandomPositionTask; }
namespace System::Runtime::CompilerServices { class IAsyncStateMachine; }

#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONTASK__CORORANDOMPOSITION_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x53A0A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTARRANDOMPOSITIONTASK__CORORANDOMPOSITION_D__23_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDStarRandomPositionTask__CoroRandomPosition_d__23_TypeDefinitionIndex = 75824;
	...
	struct alignas(8) LDStarRandomPositionTask__CoroRandomPosition_d__23
	{
		...
		::Class_1_E3601008F832A38A* _task_5__2; // 0x38
