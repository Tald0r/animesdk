...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTNEWBIE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE481C00)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTNEWBIE__CTOR_OFFSET UNITYSDK_OFFSET(0xE481D80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTNEWBIE__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0xE481DA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTNEWBIE__REGISTERPORTS_B__6_1_OFFSET UNITYSDK_OFFSET(0xE482080)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_STARTNEWBIE__REGISTERPORTS_B__6_2_OFFSET UNITYSDK_OFFSET(0xE4820C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_StartNewbie_TypeDefinitionIndex = 46357;

	class LD_StartNewbie : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Int32>* _newbieConfigID; // 0xA8
		::FlowCanvas::FlowOutput* _closeCall; // 0xB0
		...
		::FlowCanvas::FlowOutput* _finishCall; // 0xD0
