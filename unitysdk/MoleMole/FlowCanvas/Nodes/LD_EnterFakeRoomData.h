...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTERFAKEROOMDATA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7584710)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTERFAKEROOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x75847F0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTERFAKEROOMDATA__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x7584810)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_EnterFakeRoomData_TypeDefinitionIndex = 66881;
