...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTERFAKEROOMDATA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x6787E20)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTERFAKEROOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6787F00)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_ENTERFAKEROOMDATA__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x6787F20)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_EnterFakeRoomData_TypeDefinitionIndex = 77538;
