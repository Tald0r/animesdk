...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SCENEVIDEO_PLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0xBA12860)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_SCENEVIDEO_PLAY__CTOR_OFFSET UNITYSDK_OFFSET(0xBA12B40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_SceneVideo_Play_TypeDefinitionIndex = 43587;
