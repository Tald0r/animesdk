...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x9907FF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x99081A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER_ONTURNOVER_OFFSET UNITYSDK_OFFSET(0x9908270)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x9907F50)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x9908380)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x99083A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x99083B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedOnTurnOver_TypeDefinitionIndex = 78846;
