...
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xA502E30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xA502FE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER_ONTURNOVER_OFFSET UNITYSDK_OFFSET(0xA5030B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA502D90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER__CTOR_OFFSET UNITYSDK_OFFSET(0xA5031C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xA5031E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDTURNBASEDONTURNOVER___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xA5031F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDTurnBasedOnTurnOver_TypeDefinitionIndex = 75817;
