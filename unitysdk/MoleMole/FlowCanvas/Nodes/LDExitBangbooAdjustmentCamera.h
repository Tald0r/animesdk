...
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITBANGBOOADJUSTMENTCAMERA_INVOKE_OFFSET UNITYSDK_OFFSET(0xC2BE720)
#define MOLEMOLE_FLOWCANVAS_NODES_LDEXITBANGBOOADJUSTMENTCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xC2BE8C0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDExitBangbooAdjustmentCamera_TypeDefinitionIndex = 60701;
