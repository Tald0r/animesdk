...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_INTERRUPT_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xB18EC00)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_INTERRUPT__CTOR_OFFSET UNITYSDK_OFFSET(0xB18ED50)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_TEXTURESHEET_INTERRUPT__REGISTERPORTS_B__4_0_OFFSET UNITYSDK_OFFSET(0xB18ED70)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_TextureSheet_Interrupt_TypeDefinitionIndex = 50755;
