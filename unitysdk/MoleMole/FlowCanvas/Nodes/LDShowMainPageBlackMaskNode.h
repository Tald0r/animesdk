...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWMAINPAGEBLACKMASKNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xEC82E40)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWMAINPAGEBLACKMASKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC82F20)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWMAINPAGEBLACKMASKNODE__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0xEC82F40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowMainPageBlackMaskNode_TypeDefinitionIndex = 50814;
