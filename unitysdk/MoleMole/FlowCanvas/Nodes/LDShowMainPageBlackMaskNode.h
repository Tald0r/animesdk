...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWMAINPAGEBLACKMASKNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x7581780)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWMAINPAGEBLACKMASKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x7581860)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSHOWMAINPAGEBLACKMASKNODE__REGISTERPORTS_B__1_0_OFFSET UNITYSDK_OFFSET(0x7581880)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDShowMainPageBlackMaskNode_TypeDefinitionIndex = 75591;
