...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETAVATARVOICETYPE_BEGIN_OFFSET UNITYSDK_OFFSET(0xC2C6AE0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETAVATARVOICETYPE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xC2C6A00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETAVATARVOICETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2C6DA0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETAVATARVOICETYPE__REGISTERPORTS_B__3_0_OFFSET UNITYSDK_OFFSET(0xC2C6DC0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetAvatarVoiceType_TypeDefinitionIndex = 49493;
