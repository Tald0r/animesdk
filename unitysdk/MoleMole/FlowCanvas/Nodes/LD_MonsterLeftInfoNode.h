...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERLEFTINFONODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xB5E3F80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERLEFTINFONODE_QUERYMONSTERCOUNT_OFFSET UNITYSDK_OFFSET(0xB5E4010)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERLEFTINFONODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB5E4370)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_MonsterLeftInfoNode_TypeDefinitionIndex = 54145;
