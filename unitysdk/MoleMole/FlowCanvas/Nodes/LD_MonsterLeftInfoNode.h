...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERLEFTINFONODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x6AF4D80)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERLEFTINFONODE_QUERYMONSTERCOUNT_OFFSET UNITYSDK_OFFSET(0x6AF4E10)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_MONSTERLEFTINFONODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6AF5180)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_MonsterLeftInfoNode_TypeDefinitionIndex = 58087;
