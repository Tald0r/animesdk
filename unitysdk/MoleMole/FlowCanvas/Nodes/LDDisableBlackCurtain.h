...
#define MOLEMOLE_FLOWCANVAS_NODES_LDDISABLEBLACKCURTAIN_INVOKE_OFFSET UNITYSDK_OFFSET(0xC214440)
#define MOLEMOLE_FLOWCANVAS_NODES_LDDISABLEBLACKCURTAIN__CTOR_OFFSET UNITYSDK_OFFSET(0xC2145B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDDisableBlackCurtain_TypeDefinitionIndex = 48174;
