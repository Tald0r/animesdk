...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA4F7600)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xA4F7C10)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xA4F7C80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_ONTRIGGERENTITYENTER_OFFSET UNITYSDK_OFFSET(0xA4F7F60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_ONTRIGGERENTITYEXIT_OFFSET UNITYSDK_OFFSET(0xA4F82C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_ONTRIGGERENTITYSTAY_OFFSET UNITYSDK_OFFSET(0xA4F8110)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xA4F7220)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__ATTACHEVENT_OFFSET UNITYSDK_OFFSET(0xA4F7A00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA4F8470)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__REGISTERPORTS_B__17_0_OFFSET UNITYSDK_OFFSET(0xA4F8490)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__REGISTERPORTS_B__17_1_OFFSET UNITYSDK_OFFSET(0xA4F84A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__REGISTERPORTS_B__17_2_OFFSET UNITYSDK_OFFSET(0xA4F84B0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__REGISTERPORTS_B__17_3_OFFSET UNITYSDK_OFFSET(0xA4F84C0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__REGISTERPORTS_B__17_4_OFFSET UNITYSDK_OFFSET(0xA4F84D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__REGISTERPORTS_B__17_5_OFFSET UNITYSDK_OFFSET(0xA4F84E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__RESETATTACHEVENT_OFFSET UNITYSDK_OFFSET(0xA4F7EF0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0xA4F8830)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0xA4F8840)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateTriggerNode_TypeDefinitionIndex = 79680;
