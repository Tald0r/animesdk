...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x141D1470)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x141D1A90)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x141D1B00)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_ONTRIGGERENTITYENTER_OFFSET UNITYSDK_OFFSET(0x141D1DD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_ONTRIGGERENTITYEXIT_OFFSET UNITYSDK_OFFSET(0x141D2130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_ONTRIGGERENTITYSTAY_OFFSET UNITYSDK_OFFSET(0x141D1F80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x141D1090)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__ATTACHEVENT_OFFSET UNITYSDK_OFFSET(0x141D1880)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x141D22E0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__REGISTERPORTS_B__17_0_OFFSET UNITYSDK_OFFSET(0x141D2300)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__REGISTERPORTS_B__17_1_OFFSET UNITYSDK_OFFSET(0x141D2310)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__REGISTERPORTS_B__17_2_OFFSET UNITYSDK_OFFSET(0x141D2320)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__REGISTERPORTS_B__17_3_OFFSET UNITYSDK_OFFSET(0x141D2330)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__REGISTERPORTS_B__17_4_OFFSET UNITYSDK_OFFSET(0x141D2340)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__REGISTERPORTS_B__17_5_OFFSET UNITYSDK_OFFSET(0x141D2350)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE__RESETATTACHEVENT_OFFSET UNITYSDK_OFFSET(0x141D1D60)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE___BASE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x141D26A0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATETRIGGERNODE___BASE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x141D26B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateTriggerNode_TypeDefinitionIndex = 39207;

	class LDCreateTriggerNode : public ::FlowCanvas::Nodes::FlowControlNode
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Boolean>* colliderEnableValueInput; // 0xA8
		::FlowCanvas::FlowOutput* triggerStay; // 0xB0
		::FlowCanvas::FlowOutput* triggerExit; // 0xB8
		::MoleMole::Battle::Entity* triggerEnterEntity; // 0xC0
		::FlowCanvas::ValueInput_1<::System::String*>* spawnPointValueInput; // 0xC8
		...
		::UnityEngine::GameObject* _triggerObject; // 0xF0
		::FlowCanvas::ValueInput_1<::System::Boolean>* enableAvatarValueInput; // 0xF8
		::MoleMole::LevelNodeEventTrigger* levelTrigger; // 0x100
		::FlowCanvas::FlowOutput* raised; // 0x108
		::FlowCanvas::ValueInput_1<::System::Boolean>* enableMonsterValueInput; // 0x110
