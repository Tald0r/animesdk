...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTAGECAMERASWITCH_INVOKE_OFFSET UNITYSDK_OFFSET(0x6E1B830)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSTAGECAMERASWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x6E1BBA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDStageCameraSwitch_TypeDefinitionIndex = 67473;
