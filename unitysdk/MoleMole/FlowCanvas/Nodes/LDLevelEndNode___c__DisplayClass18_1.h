...
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE___C__DISPLAYCLASS18_1__CTOR_OFFSET UNITYSDK_OFFSET(0x6AE2F30)
#define MOLEMOLE_FLOWCANVAS_NODES_LDLEVELENDNODE___C__DISPLAYCLASS18_1___TRYPLAYDYNAMICENDPERFORMS_B__0_OFFSET UNITYSDK_OFFSET(0x6AE2F40)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDLevelEndNode___c__DisplayClass18_1_TypeDefinitionIndex = 56074;
	...
	public:
		...
		::Class_1_FC3A9C07FC781527* blackCurtain; // 0x28
