...
#define MOLEMOLE_FLOWCANVAS_NODES_TREASURECREATEDATA_HIDEMONSTERID_OFFSET UNITYSDK_OFFSET(0x990FA00)
#define MOLEMOLE_FLOWCANVAS_NODES_TREASURECREATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x990FA60)
#define MOLEMOLE_FLOWCANVAS_NODES_TREASURECREATEDATA___BASE_HIDEMONSTERID_OFFSET UNITYSDK_OFFSET(0x990FAB0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int TreasureCreateData_TypeDefinitionIndex = 39041;
