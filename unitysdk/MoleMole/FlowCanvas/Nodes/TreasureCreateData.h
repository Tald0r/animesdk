...
#define MOLEMOLE_FLOWCANVAS_NODES_TREASURECREATEDATA_HIDEMONSTERID_OFFSET UNITYSDK_OFFSET(0xA50AAF0)
#define MOLEMOLE_FLOWCANVAS_NODES_TREASURECREATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA50AB50)
#define MOLEMOLE_FLOWCANVAS_NODES_TREASURECREATEDATA___BASE_HIDEMONSTERID_OFFSET UNITYSDK_OFFSET(0xA50ABA0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int TreasureCreateData_TypeDefinitionIndex = 70060;
