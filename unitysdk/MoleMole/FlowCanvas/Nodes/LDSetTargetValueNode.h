...
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETTARGETVALUENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xEC82BD0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDSETTARGETVALUENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC82CD0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDSetTargetValueNode_TypeDefinitionIndex = 78138;
