...
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REVIVEAVATAR_INVOKE_OFFSET UNITYSDK_OFFSET(0xC2CD4D0)
#define MOLEMOLE_FLOWCANVAS_NODES_LD_REVIVEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0xC2CD5B0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LD_ReviveAvatar_TypeDefinitionIndex = 41607;
