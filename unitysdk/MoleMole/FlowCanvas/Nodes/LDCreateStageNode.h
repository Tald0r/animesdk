...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATESTAGENODE_CREATESTAGE_OFFSET UNITYSDK_OFFSET(0x6E16BC0)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATESTAGENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0x6E16910)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATESTAGENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6E16C80)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateStageNode_TypeDefinitionIndex = 61957;
