...
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATESTAGENODE_CREATESTAGE_OFFSET UNITYSDK_OFFSET(0xC266130)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATESTAGENODE_INVOKE_OFFSET UNITYSDK_OFFSET(0xC265E80)
#define MOLEMOLE_FLOWCANVAS_NODES_LDCREATESTAGENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2661F0)

namespace MoleMole::FlowCanvas::Nodes
{
	inline static constexpr unsigned int LDCreateStageNode_TypeDefinitionIndex = 53453;
