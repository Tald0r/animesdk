...
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETENTITYHEIGHTNODE_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xE46DBB0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETENTITYHEIGHTNODE_START_OFFSET UNITYSDK_OFFSET(0xE46DCF0)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETENTITYHEIGHTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE46EB80)
#define MOLEMOLE_FLOWCANVAS_CHESSBOARDSETENTITYHEIGHTNODE__REGISTERPORTS_B__6_0_OFFSET UNITYSDK_OFFSET(0xE46EC20)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int ChessBoardSetEntityHeightNode_TypeDefinitionIndex = 67021;
	...
	public:
		...
		::FlowCanvas::ValueInput_1<::MoleMole::ChessEntity*>* entity; // 0xC0
		::FlowCanvas::ValueInput_1<::Share::GridDir>* targetDir; // 0xC8
		::System::Collections::Generic::List_1<::MoleMole::HollowChessboard::HollowCell>* tmpCells; // 0xD0
