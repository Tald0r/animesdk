...
#define MOLEMOLE_FLOWCANVAS_HACKERGAMENPCSWITCHAPPEARANCE_INVOKE_OFFSET UNITYSDK_OFFSET(0xE0EAAD0)
#define MOLEMOLE_FLOWCANVAS_HACKERGAMENPCSWITCHAPPEARANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xE0EAFE0)

namespace MoleMole::FlowCanvas
{
	inline static constexpr unsigned int HackerGameNpcSwitchAppearance_TypeDefinitionIndex = 38766;
