...
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA29F3B0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__PROGRESSBARANIM_B__0_OFFSET UNITYSDK_OFFSET(0xA29F3C0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__PROGRESSBARANIM_B__1_OFFSET UNITYSDK_OFFSET(0xA29F4A0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__PROGRESSBARANIM_B__2_OFFSET UNITYSDK_OFFSET(0xA29F730)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralPhaseProgressWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 51540;
