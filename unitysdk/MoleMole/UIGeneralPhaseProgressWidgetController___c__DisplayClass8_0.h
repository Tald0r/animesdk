...
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9124BA0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__PROGRESSBARANIM_B__0_OFFSET UNITYSDK_OFFSET(0x9124BB0)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__PROGRESSBARANIM_B__1_OFFSET UNITYSDK_OFFSET(0x9124C90)
#define MOLEMOLE_UIGENERALPHASEPROGRESSWIDGETCONTROLLER___C__DISPLAYCLASS8_0__PROGRESSBARANIM_B__2_OFFSET UNITYSDK_OFFSET(0x9124F20)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralPhaseProgressWidgetController___c__DisplayClass8_0_TypeDefinitionIndex = 59486;
