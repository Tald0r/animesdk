...
#define MOLEMOLE_UIGENERALROLESKINNAMEPLATEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xF22EB90)
#define MOLEMOLE_UIGENERALROLESKINNAMEPLATEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xF22EC30)
#define MOLEMOLE_UIGENERALROLESKINNAMEPLATEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xF22E960)
#define MOLEMOLE_UIGENERALROLESKINNAMEPLATEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xF22EA00)
#define MOLEMOLE_UIGENERALROLESKINNAMEPLATEWIDGETCONTROLLER_SETNAME_OFFSET UNITYSDK_OFFSET(0xF22ED10)
#define MOLEMOLE_UIGENERALROLESKINNAMEPLATEWIDGETCONTROLLER_SETSUBNAME_OFFSET UNITYSDK_OFFSET(0xF22EDA0)
#define MOLEMOLE_UIGENERALROLESKINNAMEPLATEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xF22EE30)
#define MOLEMOLE_UIGENERALROLESKINNAMEPLATEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xF22EE60)
#define MOLEMOLE_UIGENERALROLESKINNAMEPLATEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xF22EED0)
#define MOLEMOLE_UIGENERALROLESKINNAMEPLATEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xF22EF50)
#define MOLEMOLE_UIGENERALROLESKINNAMEPLATEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xF22EFB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralRoleSkinNameplateWidgetController_TypeDefinitionIndex = 57087;
