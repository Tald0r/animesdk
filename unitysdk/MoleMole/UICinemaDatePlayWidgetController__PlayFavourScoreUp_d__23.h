...
#define MOLEMOLE_UICINEMADATEPLAYWIDGETCONTROLLER__PLAYFAVOURSCOREUP_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3B2DA0)
#define MOLEMOLE_UICINEMADATEPLAYWIDGETCONTROLLER__PLAYFAVOURSCOREUP_D__23_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaDatePlayWidgetController__PlayFavourScoreUp_d__23_TypeDefinitionIndex = 39212;
