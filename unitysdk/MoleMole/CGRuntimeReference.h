...
#define MOLEMOLE_CGRUNTIMEREFERENCE_GETBINDTYPE_OFFSET UNITYSDK_OFFSET(0xCAC5780)
#define MOLEMOLE_CGRUNTIMEREFERENCE_GET_ISPART_OFFSET UNITYSDK_OFFSET(0xCAC5710)
#define MOLEMOLE_CGRUNTIMEREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xCAC5810)

namespace MoleMole
{
	inline static constexpr unsigned int CGRuntimeReference_TypeDefinitionIndex = 49375;
