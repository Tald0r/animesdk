...
#include "unitysdk/Enum_3_19924699CD9A9583.h"
...
#define MOLEMOLE_TWEENER_ADDONFINISHED_OFFSET UNITYSDK_OFFSET(0xB5C0D40)
#define MOLEMOLE_TWEENER_GET_AMOUNTPERDELTA_OFFSET UNITYSDK_OFFSET(0xB5C0190)
#define MOLEMOLE_TWEENER_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0xB5C02F0)
#define MOLEMOLE_TWEENER_GET_TWEENFACTOR_OFFSET UNITYSDK_OFFSET(0xB5C0250)
#define MOLEMOLE_TWEENER_ISSAMPLESTART_OFFSET UNITYSDK_OFFSET(0xB5C0C40)
#define MOLEMOLE_TWEENER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB5C0E20)
#define MOLEMOLE_TWEENER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB5C0990)
#define MOLEMOLE_TWEENER_PLAYFORWARD_OFFSET UNITYSDK_OFFSET(0xB5C0E80)
#define MOLEMOLE_TWEENER_PLAYREVERSE_OFFSET UNITYSDK_OFFSET(0xB5C1040)
#define MOLEMOLE_TWEENER_PLAY_OFFSET UNITYSDK_OFFSET(0xB5C0EF0)
#define MOLEMOLE_TWEENER_REMOVEONFINISHED_OFFSET UNITYSDK_OFFSET(0xB5C0DB0)
#define MOLEMOLE_TWEENER_RESETTOBEGINNING_OFFSET UNITYSDK_OFFSET(0xB5C0A00)
#define MOLEMOLE_TWEENER_RESET_OFFSET UNITYSDK_OFFSET(0xB5C0410)
#define MOLEMOLE_TWEENER_SAMPLE_OFFSET UNITYSDK_OFFSET(0xB5C0B40)
#define MOLEMOLE_TWEENER_SETCURRENTVALUETOEND_OFFSET UNITYSDK_OFFSET(0xB5C13E0)
#define MOLEMOLE_TWEENER_SETCURRENTVALUETOSTART_OFFSET UNITYSDK_OFFSET(0xB5C1380)
#define MOLEMOLE_TWEENER_SETENDTOCURRENTVALUE_OFFSET UNITYSDK_OFFSET(0xB5C1320)
#define MOLEMOLE_TWEENER_SETONFINISHED_OFFSET UNITYSDK_OFFSET(0xB5C0CD0)
#define MOLEMOLE_TWEENER_SETSTARTTOCURRENTVALUE_OFFSET UNITYSDK_OFFSET(0xB5C12C0)
#define MOLEMOLE_TWEENER_SET_TWEENFACTOR_OFFSET UNITYSDK_OFFSET(0xB5C0260)
#define MOLEMOLE_TWEENER_START_OFFSET UNITYSDK_OFFSET(0xB5C04B0)
#define MOLEMOLE_TWEENER_TOGGLE_OFFSET UNITYSDK_OFFSET(0xB5C10B0)
#define MOLEMOLE_TWEENER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB5C0520)
#define MOLEMOLE_TWEENER__CTOR_OFFSET UNITYSDK_OFFSET(0xB5C1440)

namespace MoleMole
{
	inline static constexpr unsigned int Tweener_TypeDefinitionIndex = 60791;
	...
	public:
		...
		{
			return (::MoleMole::Tweener**)Il2CppClass::FromTypeDefinitionIndex(Tweener_TypeDefinitionIndex)->GetStaticField(0x34690);
		}
		...
		::Enum_3_19924699CD9A9583 get_direction()
		{
			return ((::Enum_3_19924699CD9A9583(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TWEENER_GET_DIRECTION_OFFSET))(this);
		}
