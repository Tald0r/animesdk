...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS283_0__CHANGECHESSBOARDUPORDOWNNEW_B__0_OFFSET UNITYSDK_OFFSET(0x744C230)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS283_0__CTOR_OFFSET UNITYSDK_OFFSET(0x744C220)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController___c__DisplayClass283_0_TypeDefinitionIndex = 49578;

	class UIHollowMainPageController___c__DisplayClass283_0 : public ::System::Object
	{
	public:
		::Class_5_AF65C3A968E836D2* newChessboard; // 0x10
		...
		::Class_5_0B648F1F8F6AC84A* curProxy; // 0x38
		::Class_5_0B648F1F8F6AC84A* prvProxy; // 0x40
