...
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS283_0__CHANGECHESSBOARDUPORDOWNNEW_B__0_OFFSET UNITYSDK_OFFSET(0x80AFEC0)
#define MOLEMOLE_UIHOLLOWMAINPAGECONTROLLER___C__DISPLAYCLASS283_0__CTOR_OFFSET UNITYSDK_OFFSET(0x80AFEB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowMainPageController___c__DisplayClass283_0_TypeDefinitionIndex = 52607;

	class UIHollowMainPageController___c__DisplayClass283_0 : public ::System::Object
	{
	public:
		::Class_5_2169ABC757988FED* prvProxy; // 0x10
		...
		::Class_5_2169ABC757988FED* curProxy; // 0x30
		::Class_5_AF65C3A968E836D2* newChessboard; // 0x38
		::MoleMole::HollowChessboard::HollowEntity* tempLightEntity; // 0x40
