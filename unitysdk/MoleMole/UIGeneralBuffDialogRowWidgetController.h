...
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xF2232D0)
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xF223450)
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xF223370)
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xF223180)
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xF223220)
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER_REFRESHREWARDBUFFVIEW_OFFSET UNITYSDK_OFFSET(0xF223F30)
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0xF223DA0)
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xF224370)
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__5_0_OFFSET UNITYSDK_OFFSET(0xF224380)
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xF2243B0)
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xF224420)
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xF2244A0)
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xF224520)
#define MOLEMOLE_UIGENERALBUFFDIALOGROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xF224580)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralBuffDialogRowWidgetController_TypeDefinitionIndex = 78824;

	class UIGeneralBuffDialogRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_64* _view; // 0x2D0
