...
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_DORESET_OFFSET UNITYSDK_OFFSET(0xD1163F0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_GET_RTIMG_OFFSET UNITYSDK_OFFSET(0xD115360)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD116210)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONRESET_OFFSET UNITYSDK_OFFSET(0xD1166F0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD115E30)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD1162B0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD115390)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD115640)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_ONWIN_OFFSET UNITYSDK_OFFSET(0xD116950)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER_RESETVIEW_OFFSET UNITYSDK_OFFSET(0xD116790)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD116BE0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__DORESET_B__14_0_OFFSET UNITYSDK_OFFSET(0xD116C80)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONUIINIT_B__9_0_OFFSET UNITYSDK_OFFSET(0xD116C10)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONUIOPEN_B__10_0_OFFSET UNITYSDK_OFFSET(0xD116C40)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONUIOPEN_B__10_1_OFFSET UNITYSDK_OFFSET(0xD116C60)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER__ONWIN_B__16_0_OFFSET UNITYSDK_OFFSET(0xD116CB0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD116D20)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD116D90)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD116DA0)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD116E20)
#define MOLEMOLE_UIDATAFIXOUTERRENDERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD116E80)

namespace MoleMole
{
	inline static constexpr unsigned int UIDataFixOuterRenderWidgetController_TypeDefinitionIndex = 72162;
