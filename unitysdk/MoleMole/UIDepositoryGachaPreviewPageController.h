...
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_CREATEFILTERANDSORTDATA_OFFSET UNITYSDK_OFFSET(0xADC9BF0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xADC8D20)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_CURITEMHASJUMPITEMS_OFFSET UNITYSDK_OFFSET(0xADC8A40)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xADC6780)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_GOTODETAIL_OFFSET UNITYSDK_OFFSET(0xADCAC70)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xADC6A40)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADC6790)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xADC83A0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_ONONSYNCBGPOS_OFFSET UNITYSDK_OFFSET(0xADC8F20)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xADC7AE0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_ONSORTORFILTERCHANGED_OFFSET UNITYSDK_OFFSET(0xADC8CA0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_ONTABBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xADCABE0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xADC7980)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADC8310)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADC6830)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADC72B0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_REFRESHCURTABITEMSDATA_OFFSET UNITYSDK_OFFSET(0xADC9020)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_REFRESHFETCHBTN_OFFSET UNITYSDK_OFFSET(0xADC8460)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_REFRESHPREVIEWBYITEMDATA_OFFSET UNITYSDK_OFFSET(0xADC8760)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xADC7ED0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_RESETFOCUS_OFFSET UNITYSDK_OFFSET(0xADC81F0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_SELECTITEMBYINDEXONITEMUIDCHANGE_OFFSET UNITYSDK_OFFSET(0xADC8580)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_SELECTITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0xADC85F0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_SETCURRENTTABINDEX_OFFSET UNITYSDK_OFFSET(0xADC7BA0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_SETSCROLLSELECTBYINDEX_OFFSET UNITYSDK_OFFSET(0xADC88A0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_SETUPTAB_OFFSET UNITYSDK_OFFSET(0xADC7500)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xADCADD0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER__INITVIEW_B__32_0_OFFSET UNITYSDK_OFFSET(0xADCADE0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER__INITVIEW_B__32_1_OFFSET UNITYSDK_OFFSET(0xADCADF0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER__INITVIEW_B__32_2_OFFSET UNITYSDK_OFFSET(0xADCAE00)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER__REFRESHCURTABITEMSDATA_G__ADDITEMTOICONLIST_38_0_OFFSET UNITYSDK_OFFSET(0xADC9AD0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADCAF00)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xADCAF70)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xADCAFE0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xADCAFF0)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADCB000)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADCB010)
#define MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADCB020)

namespace MoleMole
{
	inline static constexpr unsigned int UIDepositoryGachaPreviewPageController_TypeDefinitionIndex = 47410;
	...
	public:
		...
		::Class_2_2BD3078077E999CE<::Class_1_1685EC66FBD28897*>* _sorter; // 0x308
		...
		{
			return ((::System::ValueTuple_2<::Class_1_859934EE40ACBAD7<::Class_1_1685EC66FBD28897*>*, ::Il2CppArray<::Struct_2_6AB58C5477BF48DC>*>(*)(::PVOID, ::System::Collections::Generic::List_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIDEPOSITORYGACHAPREVIEWPAGECONTROLLER_CREATEFILTERANDSORTDATA_OFFSET))(this, classTypes);
		}
