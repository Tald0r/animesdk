...
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___C__DISPLAYCLASS37_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCA76E90)
#define MOLEMOLE_UISUITICONBTNWIDGETCONTROLLER___C__DISPLAYCLASS37_0__SETENABLEEMPTYCLICK_B__0_OFFSET UNITYSDK_OFFSET(0xCA76EA0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuitIconBtnWidgetController___c__DisplayClass37_0_TypeDefinitionIndex = 75501;
