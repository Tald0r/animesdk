...
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_ONCLICKEDITNAMECALLBACK_OFFSET UNITYSDK_OFFSET(0x74933D0)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7492840)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x74929E0)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x74928E0)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7492490)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0x7492C10)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_REFRESHPHOTOIMAGE_OFFSET UNITYSDK_OFFSET(0x74931E0)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER_TRIGGERRENAME_OFFSET UNITYSDK_OFFSET(0x7493260)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7493550)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER__ONCLICKEDITNAMECALLBACK_B__10_0_OFFSET UNITYSDK_OFFSET(0x7493560)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER__ONCLICKEDITNAMECALLBACK_B__10_2_OFFSET UNITYSDK_OFFSET(0x7493730)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7493850)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x74938C0)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7493940)
#define MOLEMOLE_UIPHOTOWALLSWITCHITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x74939C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoWallSwitchItemWidgetController_TypeDefinitionIndex = 40460;
