...
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_ATTACHEFFECT_OFFSET UNITYSDK_OFFSET(0xA396E80)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_INIT_OFFSET UNITYSDK_OFFSET(0xA397200)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_ONEFFECTTYPECHANGED_OFFSET UNITYSDK_OFFSET(0xA397430)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_SETEFFECT_OFFSET UNITYSDK_OFFSET(0xA397120)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_TAKEDAMAGE_OFFSET UNITYSDK_OFFSET(0xA396C80)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0xA397600)

namespace MoleMole
{
	inline static constexpr unsigned int HackerGamePlayerChessEntity_TypeDefinitionIndex = 66641;
