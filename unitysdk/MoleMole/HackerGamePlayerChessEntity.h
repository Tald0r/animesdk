...
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_ATTACHEFFECT_OFFSET UNITYSDK_OFFSET(0x82DC3E0)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_INIT_OFFSET UNITYSDK_OFFSET(0x82DC760)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_ONEFFECTTYPECHANGED_OFFSET UNITYSDK_OFFSET(0x82DC990)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_SETEFFECT_OFFSET UNITYSDK_OFFSET(0x82DC680)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY_TAKEDAMAGE_OFFSET UNITYSDK_OFFSET(0x82DC1E0)
#define MOLEMOLE_HACKERGAMEPLAYERCHESSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x82DCB60)

namespace MoleMole
{
	inline static constexpr unsigned int HackerGamePlayerChessEntity_TypeDefinitionIndex = 61285;
