...
#define MOLEMOLE_UIACTIVITYLISTDIALOGCONTEXT_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0xC291240)
#define MOLEMOLE_UIACTIVITYLISTDIALOGCONTEXT_SET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0xC291250)
#define MOLEMOLE_UIACTIVITYLISTDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC291260)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityListDialogContext_TypeDefinitionIndex = 64826;
