...
#define MOLEMOLE_UIACTIVITYLISTDIALOGCONTEXT_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0xC25FB50)
#define MOLEMOLE_UIACTIVITYLISTDIALOGCONTEXT_SET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0xC25FB60)
#define MOLEMOLE_UIACTIVITYLISTDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC25FB70)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityListDialogContext_TypeDefinitionIndex = 37654;
