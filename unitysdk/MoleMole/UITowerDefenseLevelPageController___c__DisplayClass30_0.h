...
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA75C380)
#define MOLEMOLE_UITOWERDEFENSELEVELPAGECONTROLLER___C__DISPLAYCLASS30_0__ONTOWERDEFENSELEVELUPDATE_B__0_OFFSET UNITYSDK_OFFSET(0xA75C390)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefenseLevelPageController___c__DisplayClass30_0_TypeDefinitionIndex = 73967;
	...
	public:
		...
		::Class_1_7807B2B04302CD7B_13* towerData; // 0x18
