...
#define MOLEMOLE_CONFIGCINEMAMOVECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9199A80)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigCinemaMoveCurve_TypeDefinitionIndex = 38876;
