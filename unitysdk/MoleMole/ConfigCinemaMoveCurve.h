...
#define MOLEMOLE_CONFIGCINEMAMOVECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x139A76F0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigCinemaMoveCurve_TypeDefinitionIndex = 48177;
