...
#define MOLEMOLE_UITITLESELECTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF4E470)
#define MOLEMOLE_UITITLESELECTROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xDF4F1D0)
#define MOLEMOLE_UITITLESELECTROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDF4E680)
#define MOLEMOLE_UITITLESELECTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF4E510)
#define MOLEMOLE_UITITLESELECTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF4E130)
#define MOLEMOLE_UITITLESELECTROWWIDGETCONTROLLER_SHOWASNORMALTITLE_OFFSET UNITYSDK_OFFSET(0xDF4E870)
#define MOLEMOLE_UITITLESELECTROWWIDGETCONTROLLER_SHOWASVARIABLETITLE_OFFSET UNITYSDK_OFFSET(0xDF4EE80)
#define MOLEMOLE_UITITLESELECTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF4F3C0)
#define MOLEMOLE_UITITLESELECTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF4F3D0)
#define MOLEMOLE_UITITLESELECTROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xDF4F440)
#define MOLEMOLE_UITITLESELECTROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDF4F4B0)
#define MOLEMOLE_UITITLESELECTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF4F530)
#define MOLEMOLE_UITITLESELECTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF4F5B0)

namespace MoleMole
{
	inline static constexpr unsigned int UITitleSelectRowWidgetController_TypeDefinitionIndex = 38069;
	...
	public:
		...
		::Class_1_C52591F09EF1D4E4* _titleData; // 0x2D8
