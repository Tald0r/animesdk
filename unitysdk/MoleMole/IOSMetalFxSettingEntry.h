...
#define MOLEMOLE_IOSMETALFXSETTINGENTRY_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0xA398C00)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xA398BF0)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY_ISMETALFXENABLED_OFFSET UNITYSDK_OFFSET(0xA398D10)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xA398CA0)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xA3990B0)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY___BASE_GETSETTINGCONTROLUNIT_OFFSET UNITYSDK_OFFSET(0xA399150)
#define MOLEMOLE_IOSMETALFXSETTINGENTRY___BASE_ISSHOWONUIINNER_OFFSET UNITYSDK_OFFSET(0xA399160)

namespace MoleMole
{
	inline static constexpr unsigned int IOSMetalFxSettingEntry_TypeDefinitionIndex = 67261;
