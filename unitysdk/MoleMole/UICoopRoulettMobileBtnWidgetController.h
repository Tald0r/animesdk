...
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER_ONCLICKBUTTON_OFFSET UNITYSDK_OFFSET(0x8BC72B0)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BC7410)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BC7CD0)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BC7050)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BC7360)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER_REFRESHBUTTONVIEW_OFFSET UNITYSDK_OFFSET(0x8BC7940)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER_SETCLICKACTION_OFFSET UNITYSDK_OFFSET(0x8BC74B0)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x8BC77B0)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER_SETINDEX_OFFSET UNITYSDK_OFFSET(0x8BC7520)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER_SETSELECTALPHA_OFFSET UNITYSDK_OFFSET(0x8BC7640)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER_SETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x8BC7590)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8BC7DB0)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8BC7DE0)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8BC7E50)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8BC7ED0)
#define MOLEMOLE_UICOOPROULETTMOBILEBTNWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8BC7F30)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopRoulettMobileBtnWidgetController_TypeDefinitionIndex = 60257;

	class UICoopRoulettMobileBtnWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_61C99D337397632C_2* _view; // 0x2A0
