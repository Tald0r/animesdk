...
#define MOLEMOLE_MODELPARTROOT_AWAKE_OFFSET UNITYSDK_OFFSET(0xBA1DB40)
#define MOLEMOLE_MODELPARTROOT_CHANGEPARTPATHS_OFFSET UNITYSDK_OFFSET(0xBA1DFF0)
#define MOLEMOLE_MODELPARTROOT_GET_BONEDICT_OFFSET UNITYSDK_OFFSET(0xBA1DB20)
#define MOLEMOLE_MODELPARTROOT_GET_FINALPATHS_OFFSET UNITYSDK_OFFSET(0xBA1DB30)
#define MOLEMOLE_MODELPARTROOT_METHOD_5_01E1F9C70185D085_OFFSET UNITYSDK_OFFSET(0xBA1E170)
#define MOLEMOLE_MODELPARTROOT_METHOD_5_031CA91FBC1DE467_OFFSET UNITYSDK_OFFSET(0xBA1F770)
#define MOLEMOLE_MODELPARTROOT_METHOD_5_061577877B22B100_OFFSET UNITYSDK_OFFSET(0xBA1E840)
#define MOLEMOLE_MODELPARTROOT_METHOD_5_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xBA1F870)
#define MOLEMOLE_MODELPARTROOT_METHOD_5_329A3B18C35ECAC2_OFFSET UNITYSDK_OFFSET(0xBA1E250)
#define MOLEMOLE_MODELPARTROOT_METHOD_5_51DEC44B986280C0_OFFSET UNITYSDK_OFFSET(0xBA1EAF0)
#define MOLEMOLE_MODELPARTROOT_METHOD_5_7A097E7EF929F289_OFFSET UNITYSDK_OFFSET(0xBA1E550)
#define MOLEMOLE_MODELPARTROOT_METHOD_5_8F88A97FE60CA67F_1_OFFSET UNITYSDK_OFFSET(0xBA1F350)
#define MOLEMOLE_MODELPARTROOT_METHOD_5_8F88A97FE60CA67F_OFFSET UNITYSDK_OFFSET(0xBA1F450)
#define MOLEMOLE_MODELPARTROOT_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xBA1E4C0)
#define MOLEMOLE_MODELPARTROOT_METHOD_5_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0xBA1F980)
#define MOLEMOLE_MODELPARTROOT_METHOD_5_D5E670EE3337D3EC_OFFSET UNITYSDK_OFFSET(0xBA1F550)
#define MOLEMOLE_MODELPARTROOT_METHOD_5_DE52BD42C4B0B772_OFFSET UNITYSDK_OFFSET(0xBA1F090)
#define MOLEMOLE_MODELPARTROOT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBA1DF70)
#define MOLEMOLE_MODELPARTROOT__CTOR_OFFSET UNITYSDK_OFFSET(0xBA1E4A0)

namespace MoleMole
{
	inline static constexpr unsigned int ModelPartRoot_TypeDefinitionIndex = 79739;
