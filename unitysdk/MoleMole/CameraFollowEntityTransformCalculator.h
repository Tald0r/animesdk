...
#define MOLEMOLE_CAMERAFOLLOWENTITYTRANSFORMCALCULATOR_PROCESSS_OFFSET UNITYSDK_OFFSET(0x6215EC0)
#define MOLEMOLE_CAMERAFOLLOWENTITYTRANSFORMCALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x62163D0)
#define MOLEMOLE_CAMERAFOLLOWENTITYTRANSFORMCALCULATOR___BASE_PROCESSS_OFFSET UNITYSDK_OFFSET(0x62163E0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraFollowEntityTransformCalculator_TypeDefinitionIndex = 37608;
