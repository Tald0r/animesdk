...
#define MOLEMOLE_CAMERAFOLLOWENTITYTRANSFORMCALCULATOR_PROCESSS_OFFSET UNITYSDK_OFFSET(0x84E9F90)
#define MOLEMOLE_CAMERAFOLLOWENTITYTRANSFORMCALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x84EA4B0)
#define MOLEMOLE_CAMERAFOLLOWENTITYTRANSFORMCALCULATOR___BASE_PROCESSS_OFFSET UNITYSDK_OFFSET(0x84EA4C0)

namespace MoleMole
{
	inline static constexpr unsigned int CameraFollowEntityTransformCalculator_TypeDefinitionIndex = 54335;
