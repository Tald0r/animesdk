...
#define MOLEMOLE_AVATARUIELEMENTCOLORCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x6532180)

namespace MoleMole
{
	inline static constexpr unsigned int AvatarUIElementColorConfigs_TypeDefinitionIndex = 49437;
