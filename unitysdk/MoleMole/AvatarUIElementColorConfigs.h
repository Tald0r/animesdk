...
#define MOLEMOLE_AVATARUIELEMENTCOLORCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x81CA940)

namespace MoleMole
{
	inline static constexpr unsigned int AvatarUIElementColorConfigs_TypeDefinitionIndex = 60756;
