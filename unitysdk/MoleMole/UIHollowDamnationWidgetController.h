...
class Class_2_EEE2810345E4FBCA_1;
...
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER_DOFADEIN_OFFSET UNITYSDK_OFFSET(0xA36DF10)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER_DOFADEOUT_OFFSET UNITYSDK_OFFSET(0xA36DDE0)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER_GETPARENTALPHA_OFFSET UNITYSDK_OFFSET(0xA36E5A0)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA36DB70)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA36DC10)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA36D9E0)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA36E070)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA36DCF0)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA36E6A0)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER__DOFADEIN_B__7_0_OFFSET UNITYSDK_OFFSET(0xA36E770)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER__DOFADEIN_B__7_1_OFFSET UNITYSDK_OFFSET(0xA36E780)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER__DOFADEOUT_B__6_0_OFFSET UNITYSDK_OFFSET(0xA36E750)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER__DOFADEOUT_B__6_1_OFFSET UNITYSDK_OFFSET(0xA36E760)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA36E790)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA36E800)
#define MOLEMOLE_UIHOLLOWDAMNATIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA36E880)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowDamnationWidgetController_TypeDefinitionIndex = 78391;

	class UIHollowDamnationWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_EEE2810345E4FBCA_1* _view; // 0x2A0
