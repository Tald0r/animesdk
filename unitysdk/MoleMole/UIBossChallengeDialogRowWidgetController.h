...
#define MOLEMOLE_UIBOSSCHALLENGEDIALOGROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC5FA0E0)
#define MOLEMOLE_UIBOSSCHALLENGEDIALOGROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC5FA150)
#define MOLEMOLE_UIBOSSCHALLENGEDIALOGROWWIDGETCONTROLLER_SETLAYERRECORD_OFFSET UNITYSDK_OFFSET(0xC5FA250)
#define MOLEMOLE_UIBOSSCHALLENGEDIALOGROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC5FA510)
#define MOLEMOLE_UIBOSSCHALLENGEDIALOGROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC5FA540)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeDialogRowWidgetController_TypeDefinitionIndex = 59415;
