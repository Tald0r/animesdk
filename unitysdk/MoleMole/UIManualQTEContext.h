...
#define MOLEMOLE_UIMANUALQTECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6CD1EE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIManualQTEContext_TypeDefinitionIndex = 74692;
