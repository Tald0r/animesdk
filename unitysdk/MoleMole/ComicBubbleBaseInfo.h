...
#define MOLEMOLE_COMICBUBBLEBASEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6C83D0)

namespace MoleMole
{
	inline static constexpr unsigned int ComicBubbleBaseInfo_TypeDefinitionIndex = 29092;
