...
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA2A3620)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER___C__DISPLAYCLASS13_0__REFRESHVIEW_B__0_OFFSET UNITYSDK_OFFSET(0xA2A3630)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER___C__DISPLAYCLASS13_0__REFRESHVIEW_B__1_OFFSET UNITYSDK_OFFSET(0xA2A3830)
#define MOLEMOLE_UIGENERALTOGGLEWIDGETCONTROLLER___C__DISPLAYCLASS13_0__REFRESHVIEW_B__2_OFFSET UNITYSDK_OFFSET(0xA2A38E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralToggleWidgetController___c__DisplayClass13_0_TypeDefinitionIndex = 65859;
	...
	public:
		...
		::System::Func_1<::System::Boolean>* CheckCanToggle; // 0x18
		::System::Action_1<::System::Action*>* doubleCheckAction; // 0x20
