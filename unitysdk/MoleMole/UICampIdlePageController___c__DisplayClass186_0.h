...
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS186_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD033B20)
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS186_0__REFRESHBATTLEREWARD_B__0_OFFSET UNITYSDK_OFFSET(0xD033B30)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdlePageController___c__DisplayClass186_0_TypeDefinitionIndex = 66505;
