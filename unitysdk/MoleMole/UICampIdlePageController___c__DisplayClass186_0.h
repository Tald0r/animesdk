...
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS186_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC0CA170)
#define MOLEMOLE_UICAMPIDLEPAGECONTROLLER___C__DISPLAYCLASS186_0__REFRESHBATTLEREWARD_B__0_OFFSET UNITYSDK_OFFSET(0xC0CA180)

namespace MoleMole
{
	inline static constexpr unsigned int UICampIdlePageController___c__DisplayClass186_0_TypeDefinitionIndex = 71284;
