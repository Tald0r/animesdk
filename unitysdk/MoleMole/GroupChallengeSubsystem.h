...
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_BUILDGROUPCHALLENGEENDCSREQ_OFFSET UNITYSDK_OFFSET(0xE10A580)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_BUILDMULTIPLAYERFLOORCHALLENGEINFOCSNOTIFY_OFFSET UNITYSDK_OFFSET(0xE109340)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_BUILDMULTIPLAYERGROUPCHALLENGEINFOCSNOTIFY_OFFSET UNITYSDK_OFFSET(0xE109760)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_CANCELGROUPCHALLENGEBYID_OFFSET UNITYSDK_OFFSET(0xE10C8F0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_FINISHGROUPCHALLENGEBYID_OFFSET UNITYSDK_OFFSET(0xE10CB30)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_HANDLEEVTLEVELCONDITION_OFFSET UNITYSDK_OFFSET(0xE10B5C0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_MAPPINGFLAGSTOREPORTREASON_OFFSET UNITYSDK_OFFSET(0xE10A430)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONCHALLENGEBEGIN_OFFSET UNITYSDK_OFFSET(0xE10A7E0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONCHALLENGECANCEL_OFFSET UNITYSDK_OFFSET(0xE10A390)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONCHALLENGEEND_OFFSET UNITYSDK_OFFSET(0xE109C40)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONCHALLENGEFINISH_OFFSET UNITYSDK_OFFSET(0xE109B90)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONCHALLENGEPROGRESSCHANGED_OFFSET UNITYSDK_OFFSET(0xE108FA0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xE10BAF0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xE10B530)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xE10BD10)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_REGISTERCUSTOMCHALLENGECONDITION_OFFSET UNITYSDK_OFFSET(0xE10A980)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xE10B000)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_REGISTERGROUPCHALLENGE_OFFSET UNITYSDK_OFFSET(0xE10C440)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_REGISTERLEVELCONDITION_OFFSET UNITYSDK_OFFSET(0xE10B720)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_TRIGGERCUSTOMCHALLENGECONDITION_OFFSET UNITYSDK_OFFSET(0xE10AE50)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_TRYGETGROUPCHALLENGERECORD_1_OFFSET UNITYSDK_OFFSET(0xE10C310)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_TRYGETGROUPCHALLENGERECORD_2_OFFSET UNITYSDK_OFFSET(0xE10CC90)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_TRYGETGROUPCHALLENGERECORD_3_OFFSET UNITYSDK_OFFSET(0xE10C7B0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_TRYGETGROUPCHALLENGERECORD_OFFSET UNITYSDK_OFFSET(0xE10C210)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_UNREGISTERCUSTOMCHALLENGECONDITION_OFFSET UNITYSDK_OFFSET(0xE10AC00)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_UNREGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xE10B300)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM_UNREGISTERLEVELCONDITION_OFFSET UNITYSDK_OFFSET(0xE10B920)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0xE10CDB0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xE10CF10)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM___BASE_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xE10CF70)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xE10CFE0)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM___BASE_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xE10D040)
#define MOLEMOLE_GROUPCHALLENGESUBSYSTEM___BASE_UNREGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xE10D0A0)

namespace MoleMole
{
	inline static constexpr unsigned int GroupChallengeSubsystem_TypeDefinitionIndex = 54508;
	...
	public:
		...
		::Class_3_4EE04B418903C4E1_66* BuildMultiPlayerGroupChallengeInfoCsNotify(::Class_1_6178B3CA1C4EB604* challenge, ::Enum_3_DB663931210BBC27_30 state)
		{
			return ((::Class_3_4EE04B418903C4E1_66*(*)(::PVOID, ::Class_1_6178B3CA1C4EB604*, ::Enum_3_DB663931210BBC27_30))((::PBYTE)hIl2Cpp + MOLEMOLE_GROUPCHALLENGESUBSYSTEM_BUILDMULTIPLAYERGROUPCHALLENGEINFOCSNOTIFY_OFFSET))(this, challenge, state);
		}

		::Class_3_1A345EAE5F749316_103* BuildMultiPlayerFloorChallengeInfoCsNotify(::Class_1_6178B3CA1C4EB604* challenge, ::Enum_3_DB663931210BBC27_30 state)
		{
			return ((::Class_3_1A345EAE5F749316_103*(*)(::PVOID, ::Class_1_6178B3CA1C4EB604*, ::Enum_3_DB663931210BBC27_30))((::PBYTE)hIl2Cpp + MOLEMOLE_GROUPCHALLENGESUBSYSTEM_BUILDMULTIPLAYERFLOORCHALLENGEINFOCSNOTIFY_OFFSET))(this, challenge, state);
		}
		...
		::Class_3_9F091E965E210217_36* BuildGroupChallengeEndCsReq(::Class_1_6178B3CA1C4EB604* challenge, ::System::Boolean isSuccess, ::Enum_3_3ED7CD02351A6F35 endReportReason)
		{
			return ((::Class_3_9F091E965E210217_36*(*)(::PVOID, ::Class_1_6178B3CA1C4EB604*, ::System::Boolean, ::Enum_3_3ED7CD02351A6F35))((::PBYTE)hIl2Cpp + MOLEMOLE_GROUPCHALLENGESUBSYSTEM_BUILDGROUPCHALLENGEENDCSREQ_OFFSET))(this, challenge, isSuccess, endReportReason);
		}
