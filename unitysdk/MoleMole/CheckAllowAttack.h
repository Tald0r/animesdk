...
#define MOLEMOLE_CHECKALLOWATTACK_ALLOWATTACK_OFFSET UNITYSDK_OFFSET(0xB459B20)
#define MOLEMOLE_CHECKALLOWATTACK_DOCHECKBYTYPE_OFFSET UNITYSDK_OFFSET(0xB45A130)
#define MOLEMOLE_CHECKALLOWATTACK_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB459890)
#define MOLEMOLE_CHECKALLOWATTACK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xB459AB0)
#define MOLEMOLE_CHECKALLOWATTACK_SETALLOWATTACKINFO_OFFSET UNITYSDK_OFFSET(0xB45A0A0)
#define MOLEMOLE_CHECKALLOWATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB45A3D0)
#define MOLEMOLE_CHECKALLOWATTACK___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB45A410)
#define MOLEMOLE_CHECKALLOWATTACK___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xB45A4A0)

namespace MoleMole
{
	inline static constexpr unsigned int CheckAllowAttack_TypeDefinitionIndex = 73388;
	...
	public:
		...
		::BehaviorDesigner::Runtime::SharedBool* BoolReadyToAttack; // 0x68
