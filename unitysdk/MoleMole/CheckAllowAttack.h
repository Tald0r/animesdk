...
#define MOLEMOLE_CHECKALLOWATTACK_ALLOWATTACK_OFFSET UNITYSDK_OFFSET(0x9B4A7B0)
#define MOLEMOLE_CHECKALLOWATTACK_DOCHECKBYTYPE_OFFSET UNITYSDK_OFFSET(0x9B4ADC0)
#define MOLEMOLE_CHECKALLOWATTACK_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x9B4A510)
#define MOLEMOLE_CHECKALLOWATTACK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x9B4A740)
#define MOLEMOLE_CHECKALLOWATTACK_SETALLOWATTACKINFO_OFFSET UNITYSDK_OFFSET(0x9B4AD30)
#define MOLEMOLE_CHECKALLOWATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x9B4B060)
#define MOLEMOLE_CHECKALLOWATTACK___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x9B4B0A0)
#define MOLEMOLE_CHECKALLOWATTACK___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x9B4B130)

namespace MoleMole
{
	inline static constexpr unsigned int CheckAllowAttack_TypeDefinitionIndex = 54891;
