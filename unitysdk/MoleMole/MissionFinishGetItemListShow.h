...
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_DIRECTSHOW_OFFSET UNITYSDK_OFFSET(0xBA1D410)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_DOPROCESS_OFFSET UNITYSDK_OFFSET(0xBA1D480)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xBA1D020)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xBA1D3A0)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_SHOWREWARDWINDOW_OFFSET UNITYSDK_OFFSET(0xBA1D4F0)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xBA1D030)

namespace MoleMole
{
	inline static constexpr unsigned int MissionFinishGetItemListShow_TypeDefinitionIndex = 48250;
