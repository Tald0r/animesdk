...
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_DIRECTSHOW_OFFSET UNITYSDK_OFFSET(0xC9D7B60)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_DOPROCESS_OFFSET UNITYSDK_OFFSET(0xC9D7BD0)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xC9D7770)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xC9D7AF0)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW_SHOWREWARDWINDOW_OFFSET UNITYSDK_OFFSET(0xC9D7C40)
#define MOLEMOLE_MISSIONFINISHGETITEMLISTSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D7780)

namespace MoleMole
{
	inline static constexpr unsigned int MissionFinishGetItemListShow_TypeDefinitionIndex = 43099;
