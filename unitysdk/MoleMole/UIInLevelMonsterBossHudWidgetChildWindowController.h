...
#define MOLEMOLE_UIINLEVELMONSTERBOSSHUDWIDGETCHILDWINDOWCONTROLLER_GET_HUDFADEINANIMNAME_OFFSET UNITYSDK_OFFSET(0x914EDA0)
#define MOLEMOLE_UIINLEVELMONSTERBOSSHUDWIDGETCHILDWINDOWCONTROLLER_GET_HUDFADEOUTANIMNAME_OFFSET UNITYSDK_OFFSET(0x914EDE0)
#define MOLEMOLE_UIINLEVELMONSTERBOSSHUDWIDGETCHILDWINDOWCONTROLLER_GET_ISBOSS_OFFSET UNITYSDK_OFFSET(0x914ECF0)
#define MOLEMOLE_UIINLEVELMONSTERBOSSHUDWIDGETCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x914ED00)
#define MOLEMOLE_UIINLEVELMONSTERBOSSHUDWIDGETCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x914EE20)
#define MOLEMOLE_UIINLEVELMONSTERBOSSHUDWIDGETCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x914EE50)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelMonsterBossHudWidgetChildWindowController_TypeDefinitionIndex = 75593;
