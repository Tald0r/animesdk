...
#define MOLEMOLE_IMAGESMOOTHMASK_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD5B070)
#define MOLEMOLE_IMAGESMOOTHMASK_GENERATEUIQUADS_OFFSET UNITYSDK_OFFSET(0xCD5B960)
#define MOLEMOLE_IMAGESMOOTHMASK_METHOD_5_153FE1250EA5E5EE_OFFSET UNITYSDK_OFFSET(0xCD5D3C0)
#define MOLEMOLE_IMAGESMOOTHMASK_METHOD_5_1D670D366F907230_OFFSET UNITYSDK_OFFSET(0xCD5C590)
#define MOLEMOLE_IMAGESMOOTHMASK_METHOD_5_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0xCD5CDB0)
#define MOLEMOLE_IMAGESMOOTHMASK_METHOD_5_37D3D9A3F3244B90_OFFSET UNITYSDK_OFFSET(0xCD5B000)
#define MOLEMOLE_IMAGESMOOTHMASK_METHOD_5_999B8B439422C7E7_OFFSET UNITYSDK_OFFSET(0xCD5D480)
#define MOLEMOLE_IMAGESMOOTHMASK_METHOD_5_B3F39261B5412C77_OFFSET UNITYSDK_OFFSET(0xCD5D1A0)
#define MOLEMOLE_IMAGESMOOTHMASK_METHOD_5_C7BF9C1E6A78DCAB_OFFSET UNITYSDK_OFFSET(0xCD5B0E0)
#define MOLEMOLE_IMAGESMOOTHMASK_METHOD_5_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0xCD5D120)
#define MOLEMOLE_IMAGESMOOTHMASK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD5B690)
#define MOLEMOLE_IMAGESMOOTHMASK_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD5AF50)
#define MOLEMOLE_IMAGESMOOTHMASK__CTOR_OFFSET UNITYSDK_OFFSET(0xCD5CD90)

namespace MoleMole
{
	inline static constexpr unsigned int ImageSmoothMask_TypeDefinitionIndex = 74486;
