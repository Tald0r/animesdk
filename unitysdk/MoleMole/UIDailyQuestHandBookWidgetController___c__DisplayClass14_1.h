...
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_1__CTOR_OFFSET UNITYSDK_OFFSET(0xA26EE20)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_1__TRYPLAYCANTAKEREWARDEFFECT_B__3_OFFSET UNITYSDK_OFFSET(0xA26EE30)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_1__TRYPLAYCANTAKEREWARDEFFECT_B__4_OFFSET UNITYSDK_OFFSET(0xA26EE90)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_1__TRYPLAYCANTAKEREWARDEFFECT_B__5_OFFSET UNITYSDK_OFFSET(0xA26EF20)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestHandBookWidgetController___c__DisplayClass14_1_TypeDefinitionIndex = 73752;

	class UIDailyQuestHandBookWidgetController___c__DisplayClass14_1 : public ::System::Object
	{
	public:
		::MoleMole::UIDailyQuestHandBookWidgetController___c__DisplayClass14_0* CS___8__locals1; // 0x10
