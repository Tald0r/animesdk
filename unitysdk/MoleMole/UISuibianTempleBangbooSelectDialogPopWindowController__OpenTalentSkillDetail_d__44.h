...
#define MOLEMOLE_UISUIBIANTEMPLEBANGBOOSELECTDIALOGPOPWINDOWCONTROLLER__OPENTALENTSKILLDETAIL_D__44_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x325AE0)
#define MOLEMOLE_UISUIBIANTEMPLEBANGBOOSELECTDIALOGPOPWINDOWCONTROLLER__OPENTALENTSKILLDETAIL_D__44_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleBangbooSelectDialogPopWindowController__OpenTalentSkillDetail_d__44_TypeDefinitionIndex = 72133;
