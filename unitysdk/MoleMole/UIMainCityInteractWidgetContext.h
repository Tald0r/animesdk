...
#define MOLEMOLE_UIMAINCITYINTERACTWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7D494B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityInteractWidgetContext_TypeDefinitionIndex = 49004;
