...
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_EXPLEVELMAP_OFFSET UNITYSDK_OFFSET(0x880E3D0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_GAINEXP_OFFSET UNITYSDK_OFFSET(0x880E730)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_GAMECONTEXT_OFFSET UNITYSDK_OFFSET(0x880D210)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x880D170)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x880D4B0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ONFADEINANIMEVENT_1_OFFSET UNITYSDK_OFFSET(0x880EBE0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ONFADEINANIMEVENT_OFFSET UNITYSDK_OFFSET(0x880EB10)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x880C9F0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_OPENEXPWIDGET_OFFSET UNITYSDK_OFFSET(0x880CC20)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x880D7F0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ROWDATA_OFFSET UNITYSDK_OFFSET(0x880D370)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x880ED70)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER___BASE_GETMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x880ED80)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER___BASE_GETOVERRIDEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x880EDB0)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x880EE10)
#define MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER___BASE_REFRESHREWARDVIEW_OFFSET UNITYSDK_OFFSET(0x880EE20)

namespace MoleMole
{
	inline static constexpr unsigned int UITriggerShootResultPageController_TypeDefinitionIndex = 57658;
	...
	public:
		...
		::System::Void OnFadeInAnimEvent_1(::Class_2_385517C600618BB4<::MoleMole::MonoLevelResultPageConfig_DelayType, ::System::Object*>* args)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_385517C600618BB4<::MoleMole::MonoLevelResultPageConfig_DelayType, ::System::Object*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UITRIGGERSHOOTRESULTPAGECONTROLLER_ONFADEINANIMEVENT_1_OFFSET))(this, args);
		}
