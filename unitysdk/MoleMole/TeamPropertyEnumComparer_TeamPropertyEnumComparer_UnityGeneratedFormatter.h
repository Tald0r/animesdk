...
#define MOLEMOLE_TEAMPROPERTYENUMCOMPARER_TEAMPROPERTYENUMCOMPARER_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x8FA27F0)
#define MOLEMOLE_TEAMPROPERTYENUMCOMPARER_TEAMPROPERTYENUMCOMPARER_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x8FA2800)
#define MOLEMOLE_TEAMPROPERTYENUMCOMPARER_TEAMPROPERTYENUMCOMPARER_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x8FA2890)
#define MOLEMOLE_TEAMPROPERTYENUMCOMPARER_TEAMPROPERTYENUMCOMPARER_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA2900)

namespace MoleMole
{
	inline static constexpr unsigned int TeamPropertyEnumComparer_TeamPropertyEnumComparer_UnityGeneratedFormatter_TypeDefinitionIndex = 44526;
