...
#define MOLEMOLE_TEAMPROPERTYENUMCOMPARER_TEAMPROPERTYENUMCOMPARER_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xC32EBA0)
#define MOLEMOLE_TEAMPROPERTYENUMCOMPARER_TEAMPROPERTYENUMCOMPARER_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xC32EBB0)
#define MOLEMOLE_TEAMPROPERTYENUMCOMPARER_TEAMPROPERTYENUMCOMPARER_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xC32EC40)
#define MOLEMOLE_TEAMPROPERTYENUMCOMPARER_TEAMPROPERTYENUMCOMPARER_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC32ECB0)

namespace MoleMole
{
	inline static constexpr unsigned int TeamPropertyEnumComparer_TeamPropertyEnumComparer_UnityGeneratedFormatter_TypeDefinitionIndex = 70777;
