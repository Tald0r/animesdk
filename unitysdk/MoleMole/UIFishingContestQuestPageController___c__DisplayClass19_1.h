...
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER___C__DISPLAYCLASS19_1__CTOR_OFFSET UNITYSDK_OFFSET(0xD056090)
#define MOLEMOLE_UIFISHINGCONTESTQUESTPAGECONTROLLER___C__DISPLAYCLASS19_1__ONGOTOTASKBUTTON_B__0_OFFSET UNITYSDK_OFFSET(0xD0560A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFishingContestQuestPageController___c__DisplayClass19_1_TypeDefinitionIndex = 51495;
