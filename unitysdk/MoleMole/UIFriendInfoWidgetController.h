...
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_INITFRIENDINFOPAGE_OFFSET UNITYSDK_OFFSET(0x6C5A8F0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONCLICKCONSOLEFRIENDTAB_OFFSET UNITYSDK_OFFSET(0x6C5CCA0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONCLICKINGAMEFRIENDTAB_OFFSET UNITYSDK_OFFSET(0x6C5CD10)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C5B590)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONFRIENDINFOGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x6C5B710)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x6C5B4C0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONRECEIVEFRIENDLIST_OFFSET UNITYSDK_OFFSET(0x6C5BCC0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6C5B250)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C5B630)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6C5A6A0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_PLATFORM_ONRECEIVEFRIENDLIST_OFFSET UNITYSDK_OFFSET(0x6C5C500)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_SETUPONCLICKSENDMSGBTNACTION_OFFSET UNITYSDK_OFFSET(0x6C5B1E0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_UPDATEFRIENDINFOPAGE_OFFSET UNITYSDK_OFFSET(0x6C5B3D0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_UPDATEFRIENDINFO_OFFSET UNITYSDK_OFFSET(0x6C5B820)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6C5CDE0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_1_OFFSET UNITYSDK_OFFSET(0x6C5CE90)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_2_OFFSET UNITYSDK_OFFSET(0x6C5CEC0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_3_OFFSET UNITYSDK_OFFSET(0x6C5CF40)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_4_OFFSET UNITYSDK_OFFSET(0x6C5CFC0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_5_OFFSET UNITYSDK_OFFSET(0x6C5CFD0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C5D040)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x6C5D0B0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6C5D110)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C5D180)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6C5D200)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendInfoWidgetController_TypeDefinitionIndex = 55768;

	class UIFriendInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_129* _view; // 0x2A0
		::Class_2_2F3C7D4EFC74D485* _model; // 0x2A8
		::System::Collections::Generic::List_1<::MoleMole::UIFriendCardContext*>* _contextList; // 0x2B0
		::System::Boolean _otherPlatformEnable; // 0x2B8
		::System::Boolean _isShowingPlatform; // 0x2B9
		::System::Boolean _isSelectingInGameTab; // 0x2BA
		::System::Boolean _showInGameFriendListOnly; // 0x2BB
		::System::Action_1<::Class_1_BE6BF7909AD9D940*>* _onClickSendMsgBtn; // 0x2C0
