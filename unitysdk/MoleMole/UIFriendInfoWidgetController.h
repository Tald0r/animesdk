...
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_INITFRIENDINFOPAGE_OFFSET UNITYSDK_OFFSET(0x8C018E0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONCLICKCONSOLEFRIENDTAB_OFFSET UNITYSDK_OFFSET(0x8C03C40)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONCLICKINGAMEFRIENDTAB_OFFSET UNITYSDK_OFFSET(0x8C03CB0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C02560)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONFRIENDINFOGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x8C026E0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x8C02490)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONRECEIVEFRIENDLIST_OFFSET UNITYSDK_OFFSET(0x8C02C80)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8C02230)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C02600)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C01690)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_PLATFORM_ONRECEIVEFRIENDLIST_OFFSET UNITYSDK_OFFSET(0x8C034A0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_SETUPONCLICKSENDMSGBTNACTION_OFFSET UNITYSDK_OFFSET(0x8C021C0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_UPDATEFRIENDINFOPAGE_OFFSET UNITYSDK_OFFSET(0x8C023B0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER_UPDATEFRIENDINFO_OFFSET UNITYSDK_OFFSET(0x8C027F0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C03D80)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_1_OFFSET UNITYSDK_OFFSET(0x8C03E30)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_2_OFFSET UNITYSDK_OFFSET(0x8C03E60)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_3_OFFSET UNITYSDK_OFFSET(0x8C03EE0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_4_OFFSET UNITYSDK_OFFSET(0x8C03F60)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER__INITFRIENDINFOPAGE_B__10_5_OFFSET UNITYSDK_OFFSET(0x8C03F70)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C03FE0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x8C04050)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8C040B0)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C04120)
#define MOLEMOLE_UIFRIENDINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8C041A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendInfoWidgetController_TypeDefinitionIndex = 53907;

	class UIFriendInfoWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_96* _view; // 0x2A0
