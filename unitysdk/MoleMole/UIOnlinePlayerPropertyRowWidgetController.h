...
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA38080)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA38120)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA37F30)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA37FD0)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0xCA38200)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA38470)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCA384A0)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCA38510)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCA38590)
#define MOLEMOLE_UIONLINEPLAYERPROPERTYROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCA385F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnlinePlayerPropertyRowWidgetController_TypeDefinitionIndex = 68849;

	class UIOnlinePlayerPropertyRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_3E1A0459A6647B99_4* _view; // 0x2A0
