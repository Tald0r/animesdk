...
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__ROTARROW_D__22_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB6A3970)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__ROTARROW_D__22_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB6A3BC0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__ROTARROW_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB6A3C20)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__ROTARROW_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB6A3BD0)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__ROTARROW_D__22_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB6A3960)
#define MOLEMOLE_UIMAINCITYTIMETIPSPOPWINDOWCONTROLLER__ROTARROW_D__22__CTOR_OFFSET UNITYSDK_OFFSET(0xB6A3950)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityTimeTipsPopWindowController__RotArrow_d__22_TypeDefinitionIndex = 67626;
