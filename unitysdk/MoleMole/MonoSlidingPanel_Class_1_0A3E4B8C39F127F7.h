...
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x67C0CF0)
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7_METHOD_1_154217890BB9535A_OFFSET UNITYSDK_OFFSET(0x67C0DC0)
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7_METHOD_1_AA6AC38756233BD0_OFFSET UNITYSDK_OFFSET(0x67C0D50)
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7_METHOD_1_D937CCF249E8F991_OFFSET UNITYSDK_OFFSET(0x67C0EA0)
#define MOLEMOLE_MONOSLIDINGPANEL_CLASS_1_0A3E4B8C39F127F7__CTOR_OFFSET UNITYSDK_OFFSET(0x67C0CE0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSlidingPanel_Class_1_0A3E4B8C39F127F7_TypeDefinitionIndex = 49998;
