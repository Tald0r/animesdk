...
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x68C41B0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_APPLYAVATARSHOWSETTINGFORGO_OFFSET UNITYSDK_OFFSET(0x68C80F0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_CREATECACHEENTITY_OFFSET UNITYSDK_OFFSET(0x68C59E0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_DESTROYALLCACHEENTITIES_OFFSET UNITYSDK_OFFSET(0x68C4CC0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_DOPROCESSUIPREFAB_OFFSET UNITYSDK_OFFSET(0x68C76C0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ENABLEOVERRIDEMAINLIGHT_OFFSET UNITYSDK_OFFSET(0x68C7FD0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETENTITYTYPEFORITEM_OFFSET UNITYSDK_OFFSET(0x68C5820)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETSCENELIGHT_OFFSET UNITYSDK_OFFSET(0x68C9490)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETSCENEVOLUME_OFFSET UNITYSDK_OFFSET(0x68C9350)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETUIAVATARGRAPHICS_OFFSET UNITYSDK_OFFSET(0x68C82F0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETUIPREFABPATHFORITEM_OFFSET UNITYSDK_OFFSET(0x68C58B0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETVISUALENVIRONMENTECOMP_OFFSET UNITYSDK_OFFSET(0x68C9230)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_INITCAMERADATA_OFFSET UNITYSDK_OFFSET(0x68C3D60)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_LOADRTMODELFINISHED_OFFSET UNITYSDK_OFFSET(0x68C95B0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x68C3C00)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x68C6CF0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0x68C7600)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x68C3E80)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x68C6EA0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x68C7000)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x68C3CA0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSAVATARMODEL_1_OFFSET UNITYSDK_OFFSET(0x68C9800)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSAVATARMODEL_OFFSET UNITYSDK_OFFSET(0x68C9770)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSMAINPAGEGO_OFFSET UNITYSDK_OFFSET(0x68C5290)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSMAINPAGEITEM_OFFSET UNITYSDK_OFFSET(0x68C5760)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIAVATAR_1_OFFSET UNITYSDK_OFFSET(0x68C7AF0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIAVATAR_OFFSET UNITYSDK_OFFSET(0x68C5620)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIBUDDY_OFFSET UNITYSDK_OFFSET(0x68C7BB0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIPERFORM_OFFSET UNITYSDK_OFFSET(0x68C5D70)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUISKIN_OFFSET UNITYSDK_OFFSET(0x68C7C90)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x68C4140)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REBINDSHOWTIMELINE_OFFSET UNITYSDK_OFFSET(0x68C8720)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REFRESHCAMERADATA_OFFSET UNITYSDK_OFFSET(0x68C6990)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x68C43D0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_RELEASERTUNIT_OFFSET UNITYSDK_OFFSET(0x68C74F0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_RELEASEUIMODELS_OFFSET UNITYSDK_OFFSET(0x68C6E20)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_RESETCAMERADATA_OFFSET UNITYSDK_OFFSET(0x68C6C60)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_SETHAIRSHADOWOFFSETS_OFFSET UNITYSDK_OFFSET(0x68C7EB0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_SETVIEWLIGHTROTOFFSET_OFFSET UNITYSDK_OFFSET(0x68C7D50)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__GETRANDOMCOUNT_59_0_OFFSET UNITYSDK_OFFSET(0x68C9A50)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__GETRANDOMINT_59_1_OFFSET UNITYSDK_OFFSET(0x68C9D00)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__HANDLESHADERUIOUTLINE_59_8_OFFSET UNITYSDK_OFFSET(0x68C9D40)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__PLAYAVATARANIMATIONBYSETTING_59_6_OFFSET UNITYSDK_OFFSET(0x68CA460)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETANIMATORRANDOMINT_59_7_OFFSET UNITYSDK_OFFSET(0x68CA920)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATARANIMATION_59_5_OFFSET UNITYSDK_OFFSET(0x68C9FD0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATARSHADERPROPERTYBYRENDERS_59_4_OFFSET UNITYSDK_OFFSET(0x68CA290)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATARSHADERPROPERTY_59_3_OFFSET UNITYSDK_OFFSET(0x68C9D70)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATAR_59_2_OFFSET UNITYSDK_OFFSET(0x68C9D30)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x68CA250)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x68CA170)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x68CB0F0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x68CB160)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0x68CB1C0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x68CB1D0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x68CB1E0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x68CB1F0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x68CB200)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainPageBG3DModelController_TypeDefinitionIndex = 54978;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMainPageBG3DModelController_TypeDefinitionIndex)->GetStaticField(0xCE80);
		}
		...
		::Class_2_45EB76A87BDD923A* _view; // 0x3B0
