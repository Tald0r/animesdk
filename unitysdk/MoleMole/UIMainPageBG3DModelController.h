...
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x865E370)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_APPLYAVATARSHOWSETTINGFORGO_OFFSET UNITYSDK_OFFSET(0x86622B0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_CREATECACHEENTITY_OFFSET UNITYSDK_OFFSET(0x865FBA0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_DESTROYALLCACHEENTITIES_OFFSET UNITYSDK_OFFSET(0x865EE70)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_DOPROCESSUIPREFAB_OFFSET UNITYSDK_OFFSET(0x8661880)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ENABLEOVERRIDEMAINLIGHT_OFFSET UNITYSDK_OFFSET(0x8662190)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETENTITYTYPEFORITEM_OFFSET UNITYSDK_OFFSET(0x865F9E0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETSCENELIGHT_OFFSET UNITYSDK_OFFSET(0x8663650)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETSCENEVOLUME_OFFSET UNITYSDK_OFFSET(0x8663510)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETUIAVATARGRAPHICS_OFFSET UNITYSDK_OFFSET(0x86624B0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETUIPREFABPATHFORITEM_OFFSET UNITYSDK_OFFSET(0x865FA70)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_GETVISUALENVIRONMENTECOMP_OFFSET UNITYSDK_OFFSET(0x86633F0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_INITCAMERADATA_OFFSET UNITYSDK_OFFSET(0x865DF20)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_LOADRTMODELFINISHED_OFFSET UNITYSDK_OFFSET(0x8663770)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x865DDC0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x8660EB0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0x86617C0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x865E040)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8661060)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x86611C0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x865DE60)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSAVATARMODEL_1_OFFSET UNITYSDK_OFFSET(0x86639C0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSAVATARMODEL_OFFSET UNITYSDK_OFFSET(0x8663930)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSMAINPAGEGO_OFFSET UNITYSDK_OFFSET(0x865F450)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSMAINPAGEITEM_OFFSET UNITYSDK_OFFSET(0x865F920)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIAVATAR_1_OFFSET UNITYSDK_OFFSET(0x8661CB0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIAVATAR_OFFSET UNITYSDK_OFFSET(0x865F7E0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIBUDDY_OFFSET UNITYSDK_OFFSET(0x8661D70)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUIPERFORM_OFFSET UNITYSDK_OFFSET(0x865FF30)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_PROCESSUISKIN_OFFSET UNITYSDK_OFFSET(0x8661E50)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REALLOCRTUNIT_OFFSET UNITYSDK_OFFSET(0x865E300)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REBINDSHOWTIMELINE_OFFSET UNITYSDK_OFFSET(0x86628E0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REFRESHCAMERADATA_OFFSET UNITYSDK_OFFSET(0x8660B50)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x865E590)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_RELEASERTUNIT_OFFSET UNITYSDK_OFFSET(0x86616B0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_RELEASEUIMODELS_OFFSET UNITYSDK_OFFSET(0x8660FE0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_RESETCAMERADATA_OFFSET UNITYSDK_OFFSET(0x8660E20)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_SETHAIRSHADOWOFFSETS_OFFSET UNITYSDK_OFFSET(0x8662070)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER_SETVIEWLIGHTROTOFFSET_OFFSET UNITYSDK_OFFSET(0x8661F10)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__GETRANDOMCOUNT_59_0_OFFSET UNITYSDK_OFFSET(0x8663C10)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__GETRANDOMINT_59_1_OFFSET UNITYSDK_OFFSET(0x8663EC0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__HANDLESHADERUIOUTLINE_59_8_OFFSET UNITYSDK_OFFSET(0x8663F00)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__PLAYAVATARANIMATIONBYSETTING_59_6_OFFSET UNITYSDK_OFFSET(0x8664620)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETANIMATORRANDOMINT_59_7_OFFSET UNITYSDK_OFFSET(0x8664AE0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATARANIMATION_59_5_OFFSET UNITYSDK_OFFSET(0x8664190)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATARSHADERPROPERTYBYRENDERS_59_4_OFFSET UNITYSDK_OFFSET(0x8664450)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATARSHADERPROPERTY_59_3_OFFSET UNITYSDK_OFFSET(0x8663F30)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__APPLYAVATARSHOWSETTINGFORGO_G__SETAVATAR_59_2_OFFSET UNITYSDK_OFFSET(0x8663EF0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8664410)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8664330)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x86652B0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x8665320)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONPREPAREHIDE_OFFSET UNITYSDK_OFFSET(0x8665380)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8665390)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x86653A0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x86653B0)
#define MOLEMOLE_UIMAINPAGEBG3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x86653C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainPageBG3DModelController_TypeDefinitionIndex = 70073;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMainPageBG3DModelController_TypeDefinitionIndex)->GetStaticField(0xD9A0);
		}
		// static const ::System::String* CameraShowTrack; // 0x0
		// static const ::System::String* VolumeName; // 0x0
		::Class_2_C2B4B123B5A9B78A* _roleUnit; // 0x340
		::MoleMole::AvatarShowSetting* _avatarShowSetting; // 0x348
		::MoleMole::UIMainPageBGContext* uIMainPageBGContext; // 0x350
		::System::String* mainPagePrefabPath; // 0x358
		::UnityEngine::GameObject* mainPagePrefabModelGo; // 0x360
		::UnityEngine::Rendering::Universal::UniversalAdditionalCameraData* cameraData; // 0x368
		::System::Single lastRenderScale; // 0x370
		::System::Boolean applyLutAfterEverything; // 0x374
		::System::Boolean renderVolumetricFog; // 0x375
		::System::Boolean renderWater; // 0x376
		::UnityEngine::Animator* cameraAnimator; // 0x378
		::UnityEngine::Animation* cameraAnimation; // 0x380
		::System::String* cameraAnimationName; // 0x388
		::System::String* animationClipPath; // 0x390
		::System::String* animatorControllerPath; // 0x398
		::System::String* avatarShowTlPath; // 0x3A0
		::UnityEngine::GameObject* avatarShowTl; // 0x3A8
		::Class_2_45EB76A87BDD923A_2* _view; // 0x3B0
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Battle::Entity*>* _cacheEntityDic; // 0x3B8
