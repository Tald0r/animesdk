...
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA338B70)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA338B80)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA338BF0)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA338CB0)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA338DF0)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA338E00)
#define MOLEMOLE_UICOOPCLUEINFOPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA338E70)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopClueInfoPopWindowController_TypeDefinitionIndex = 68043;
