...
#define MOLEMOLE_MONOSPIN_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xD43B6F0)
#define MOLEMOLE_MONOSPIN_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xD43B900)
#define MOLEMOLE_MONOSPIN_UPDATE_OFFSET UNITYSDK_OFFSET(0xD43B680)
#define MOLEMOLE_MONOSPIN__CTOR_OFFSET UNITYSDK_OFFSET(0xD43B8E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSpin_TypeDefinitionIndex = 80370;
