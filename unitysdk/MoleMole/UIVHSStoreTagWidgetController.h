...
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_AFTERTAGIDCHANGE_OFFSET UNITYSDK_OFFSET(0x753E960)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_CALALLTAGSUCCESS_OFFSET UNITYSDK_OFFSET(0x753E4B0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_CALTAGLAYER_OFFSET UNITYSDK_OFFSET(0x753DF50)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_CALVHSATLEASTMATCHONETAG_OFFSET UNITYSDK_OFFSET(0x753E2F0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_GET__DATA_OFFSET UNITYSDK_OFFSET(0x753EB00)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x753D6B0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x753D8C0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x753D750)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x753D560)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x753D600)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_PLAYHIGHLIGHTTAGANIM_OFFSET UNITYSDK_OFFSET(0x753E880)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_REFRESHLAYER_OFFSET UNITYSDK_OFFSET(0x753DBA0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_REFRESHTAGLAYER_OFFSET UNITYSDK_OFFSET(0x753BDD0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER_SET__DATA_OFFSET UNITYSDK_OFFSET(0x753DAE0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x753EB60)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x753EB10)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x753EBA0)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x753EC10)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x753EC90)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x753ED10)
#define MOLEMOLE_UIVHSSTORETAGWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x753ED70)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreTagWidgetController_TypeDefinitionIndex = 44990;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIVHSStoreTagWidgetController_TypeDefinitionIndex)->GetStaticField(0x32B50);
		}
		// static const ::System::String* UnknowTagTextmapKey; // 0x0
