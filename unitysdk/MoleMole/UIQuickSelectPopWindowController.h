...
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x96E4D60)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ISITEMEQUIPPED_OFFSET UNITYSDK_OFFSET(0x96E6A90)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ISITEMLEVELUP_OFFSET UNITYSDK_OFFSET(0x96E6B90)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ISITEMLOCK_OFFSET UNITYSDK_OFFSET(0x96E6980)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ISITEMTRASH_OFFSET UNITYSDK_OFFSET(0x96E6CA0)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x96E5F70)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ONOKBTNCLICK_OFFSET UNITYSDK_OFFSET(0x96E6D70)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ONRESETBTNCLICK_OFFSET UNITYSDK_OFFSET(0x96E7050)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x96E6010)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x96E4D70)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x96E5060)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_REFRESHITEMTYPEROW_OFFSET UNITYSDK_OFFSET(0x96E60A0)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_REFRESHNUM_OFFSET UNITYSDK_OFFSET(0x96E6370)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x96E5210)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x96E70C0)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_0_OFFSET UNITYSDK_OFFSET(0x96E70D0)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_1_OFFSET UNITYSDK_OFFSET(0x96E7100)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_2_OFFSET UNITYSDK_OFFSET(0x96E7150)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_3_OFFSET UNITYSDK_OFFSET(0x96E71A0)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_4_OFFSET UNITYSDK_OFFSET(0x96E71F0)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_5_OFFSET UNITYSDK_OFFSET(0x96E7240)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_6_OFFSET UNITYSDK_OFFSET(0x96E7290)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER__REFRESHVIEW_B__20_7_OFFSET UNITYSDK_OFFSET(0x96E72C0)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x96E72F0)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x96E7360)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x96E7370)
#define MOLEMOLE_UIQUICKSELECTPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x96E7380)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuickSelectPopWindowController_TypeDefinitionIndex = 78856;

	class UIQuickSelectPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_60638234271CCDB8_54* _view; // 0x2F8
