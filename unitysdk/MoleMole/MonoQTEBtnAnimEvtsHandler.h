...
#define MOLEMOLE_MONOQTEBTNANIMEVTSHANDLER_PLAYQTEFADEINOVERANIMEVENT_OFFSET UNITYSDK_OFFSET(0xA3BA2C0)
#define MOLEMOLE_MONOQTEBTNANIMEVTSHANDLER_PLAYQTEFADEOUTOVERANIMEVENT_OFFSET UNITYSDK_OFFSET(0xA3BA3A0)
#define MOLEMOLE_MONOQTEBTNANIMEVTSHANDLER_PLAYQTETWEENBARANIMEVENT_OFFSET UNITYSDK_OFFSET(0xA3BA180)
#define MOLEMOLE_MONOQTEBTNANIMEVTSHANDLER_SETMONOQTESWITCHAVATARPANEL_OFFSET UNITYSDK_OFFSET(0xA3BA110)
#define MOLEMOLE_MONOQTEBTNANIMEVTSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3BA4E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoQTEBtnAnimEvtsHandler_TypeDefinitionIndex = 42459;
