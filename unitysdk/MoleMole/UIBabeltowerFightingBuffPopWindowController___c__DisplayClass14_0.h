...
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC8FD7C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__REFRESHBUFFSET_B__2_OFFSET UNITYSDK_OFFSET(0xC8FD9C0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__REFRESHBUFFSET_G__OPENMONSTER_3_OFFSET UNITYSDK_OFFSET(0xC8FD9D0)
#define MOLEMOLE_UIBABELTOWERFIGHTINGBUFFPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__REFRESHBUFFSET_G__REFRESHMONSTER_0_OFFSET UNITYSDK_OFFSET(0xC8FD7D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerFightingBuffPopWindowController___c__DisplayClass14_0_TypeDefinitionIndex = 59880;
