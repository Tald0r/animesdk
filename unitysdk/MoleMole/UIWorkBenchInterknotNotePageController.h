...
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_BINDEVENT_BUTTON_OFFSET UNITYSDK_OFFSET(0x68405E0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_BINDEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x6840800)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_GETPOPUPSORTTEMPLATE_OFFSET UNITYSDK_OFFSET(0x68420A0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x68404A0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_INITBG_OFFSET UNITYSDK_OFFSET(0x6841500)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_INITPOPUPSORTDATA_OFFSET UNITYSDK_OFFSET(0x6840970)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_INITWIDGET_OFFSET UNITYSDK_OFFSET(0x68408B0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_NEEDSHOWINWORKBENCH_OFFSET UNITYSDK_OFFSET(0x6841F80)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x68404B0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x6841AA0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6841430)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x6841630)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6841A10)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6840550)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONWORKBENCHDATAUPDATE_OFFSET UNITYSDK_OFFSET(0x68427F0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_SELECTEDPOPUPSORT_OFFSET UNITYSDK_OFFSET(0x68421B0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_SELECTEDPOPUP_OFFSET UNITYSDK_OFFSET(0x6841CB0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER__BINDEVENT_BUTTON_B__12_0_OFFSET UNITYSDK_OFFSET(0x6842A90)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x6842A50)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6842860)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6842B90)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x6842C00)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6842C70)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x6842C80)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6842C90)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6842CA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchInterknotNotePageController_TypeDefinitionIndex = 55797;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIWorkBenchInterknotNotePageController_TypeDefinitionIndex)->GetStaticField(0xE190);
		}
		::Class_2_F4B807A3857A9487* _view; // 0x2F8
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_46*>* _popUpSortTemplateDatas; // 0x300
		::System::Collections::Generic::List_1<::Class_1_EDBF989FCD2F91A5_Class_1_9E89B2D44593C915*>* _popUpGroupDatas; // 0x308
		::Class_1_EDBF989FCD2F91A5_Class_1_9E89B2D44593C915* _emptyPopUpGroupData; // 0x310
		::System::Nullable_1<::System::Boolean> _isEmpty; // 0x318
		::System::Collections::Generic::Dictionary_2<::Class_2_208CC9941471731A_46*, ::System::Collections::Generic::List_1<::Class_1_EDBF989FCD2F91A5_Class_1_9E89B2D44593C915*>*>* _popupGroupDataDic; // 0x320
		...
		static ::Class_2_208CC9941471731A_46* GetPopUpSortTemplate(::System::Int32 popupGroupID)
		{
			return ((::Class_2_208CC9941471731A_46*(*)(::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_GETPOPUPSORTTEMPLATE_OFFSET))(popupGroupID);
		}
