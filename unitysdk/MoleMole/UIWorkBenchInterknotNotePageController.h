...
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_BINDEVENT_BUTTON_OFFSET UNITYSDK_OFFSET(0x8515A20)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_BINDEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x8515C50)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_GETPOPUPSORTTEMPLATE_OFFSET UNITYSDK_OFFSET(0x8517520)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x85158E0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_INITBG_OFFSET UNITYSDK_OFFSET(0x8516960)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_INITPOPUPSORTDATA_OFFSET UNITYSDK_OFFSET(0x8515DC0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_INITWIDGET_OFFSET UNITYSDK_OFFSET(0x8515D00)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_NEEDSHOWINWORKBENCH_OFFSET UNITYSDK_OFFSET(0x8517400)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x85158F0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x8516F10)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x8516890)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x8516A90)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8516E80)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8515990)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_ONWORKBENCHDATAUPDATE_OFFSET UNITYSDK_OFFSET(0x8517C70)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_SELECTEDPOPUPSORT_OFFSET UNITYSDK_OFFSET(0x8517630)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_SELECTEDPOPUP_OFFSET UNITYSDK_OFFSET(0x8517120)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER__BINDEVENT_BUTTON_B__12_0_OFFSET UNITYSDK_OFFSET(0x8517F00)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8517EC0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8517CE0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8518000)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x8518070)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x85180E0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x85180F0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8518100)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8518110)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchInterknotNotePageController_TypeDefinitionIndex = 55722;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIWorkBenchInterknotNotePageController_TypeDefinitionIndex)->GetStaticField(0xE7B0);
		}
		::Class_2_F4B807A3857A9487* _view; // 0x2F8
		::System::Collections::Generic::List_1<::Class_2_208CC9941471731A_155*>* _popUpSortTemplateDatas; // 0x300
		::System::Collections::Generic::List_1<::Class_1_8C25B6E4C19F237F_Class_1_9E89B2D44593C915*>* _popUpGroupDatas; // 0x308
		::Class_1_8C25B6E4C19F237F_Class_1_9E89B2D44593C915* _emptyPopUpGroupData; // 0x310
		::System::Nullable_1<::System::Boolean> _isEmpty; // 0x318
		::System::Collections::Generic::Dictionary_2<::Class_2_208CC9941471731A_155*, ::System::Collections::Generic::List_1<::Class_1_8C25B6E4C19F237F_Class_1_9E89B2D44593C915*>*>* _popupGroupDataDic; // 0x320
		::MoleMole::UIWorkBenchInterKnotNoteTutorialWidgetController* _tutorialWidget; // 0x328
		::System::Collections::Generic::List_1<::MoleMole::UIWidgetController*>* _rightTabControllerList; // 0x330
		::System::Collections::Generic::List_1<::System::UInt32>* _readPopupGroupIDs; // 0x338
		::MoleMole::UIWorkBenchInterknotNotePageController_Context* _context; // 0x340
		...
		static ::Class_2_208CC9941471731A_155* GetPopUpSortTemplate(::System::Int32 popupGroupID)
		{
			return ((::Class_2_208CC9941471731A_155*(*)(::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_GETPOPUPSORTTEMPLATE_OFFSET))(popupGroupID);
		}
