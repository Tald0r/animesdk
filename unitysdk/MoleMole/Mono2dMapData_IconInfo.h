...
#define MOLEMOLE_MONO2DMAPDATA_ICONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x6B04300)

namespace MoleMole
{
	inline static constexpr unsigned int Mono2dMapData_IconInfo_TypeDefinitionIndex = 63986;
