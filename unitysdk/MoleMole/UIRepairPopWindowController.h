...
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_ABORTCHECKGAMERESINTEGRITY_OFFSET UNITYSDK_OFFSET(0xADF5500)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xADF4730)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_ONBUNDLEVERIFIERFINISHED_OFFSET UNITYSDK_OFFSET(0xADF56B0)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_ONBUNDLEVERIFIERUPDATE_OFFSET UNITYSDK_OFFSET(0xADF5570)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_ONCANCELREPAIR_OFFSET UNITYSDK_OFFSET(0xADF53E0)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADF4E20)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_ONRETURNUPDATE_OFFSET UNITYSDK_OFFSET(0xADF61C0)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADF4F80)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADF4740)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_REPAIRFAILED_OFFSET UNITYSDK_OFFSET(0xADF5BE0)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_SETPROGRESS_OFFSET UNITYSDK_OFFSET(0xADF50A0)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_SHOWREPAIRCONFIRM_OFFSET UNITYSDK_OFFSET(0xADF5F00)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_SHOWREPAIRFAILED_OFFSET UNITYSDK_OFFSET(0xADF5C40)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_SHOWREPAIRSUCCESS_OFFSET UNITYSDK_OFFSET(0xADF63A0)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_STARTCHECKGAMERESINTEGRITY_OFFSET UNITYSDK_OFFSET(0xADF4BE0)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_STATE_SHOWREPAIR_OFFSET UNITYSDK_OFFSET(0xADF4800)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xADF5020)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER_WARMUPSHADERAFTERREPAIR_OFFSET UNITYSDK_OFFSET(0xADF5610)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xADF65E0)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADF65F0)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADF6660)
#define MOLEMOLE_UIREPAIRPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADF6670)

namespace MoleMole
{
	inline static constexpr unsigned int UIRepairPopWindowController_TypeDefinitionIndex = 72787;
