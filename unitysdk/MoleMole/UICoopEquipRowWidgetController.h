...
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCB30D90)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_ONFOCUSSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xCB30980)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_ONITEMCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xCB30C00)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xCB30B60)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCB32150)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCB30680)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCB30CE0)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_PLAYCHANGEEQUIPANI_OFFSET UNITYSDK_OFFSET(0xCB31C30)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_REFRESHDRESSSTATE_OFFSET UNITYSDK_OFFSET(0xCB31A80)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCB310C0)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_SETAVATARDATA_OFFSET UNITYSDK_OFFSET(0xCB30FC0)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_SETROBOTDATA_OFFSET UNITYSDK_OFFSET(0xCB31FD0)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_SETSELECTALPHA_OFFSET UNITYSDK_OFFSET(0xCB309F0)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_SETSELECTID_OFFSET UNITYSDK_OFFSET(0xCB32040)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER_SETSLOTDATA_OFFSET UNITYSDK_OFFSET(0xCB30E30)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCB32230)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER__PLAYCHANGEEQUIPANI_B__25_0_OFFSET UNITYSDK_OFFSET(0xCB32260)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER__PLAYCHANGEEQUIPANI_B__25_1_OFFSET UNITYSDK_OFFSET(0xCB32270)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCB322D0)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xCB32340)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCB323A0)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCB32420)
#define MOLEMOLE_UICOOPEQUIPROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCB32480)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopEquipRowWidgetController_TypeDefinitionIndex = 56707;

	class UICoopEquipRowWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_135* _view; // 0x2A0
