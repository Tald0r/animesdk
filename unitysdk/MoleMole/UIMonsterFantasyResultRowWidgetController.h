...
#define MOLEMOLE_UIMONSTERFANTASYRESULTROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB75240)
#define MOLEMOLE_UIMONSTERFANTASYRESULTROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB752E0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB750F0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB75190)
#define MOLEMOLE_UIMONSTERFANTASYRESULTROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xAB753C0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB755C0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAB755F0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAB75660)
#define MOLEMOLE_UIMONSTERFANTASYRESULTROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAB756E0)
#define MOLEMOLE_UIMONSTERFANTASYRESULTROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAB75740)

namespace MoleMole
{
	inline static constexpr unsigned int UIMonsterFantasyResultRowWidgetController_TypeDefinitionIndex = 73847;
