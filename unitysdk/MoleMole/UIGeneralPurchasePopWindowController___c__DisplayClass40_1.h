...
#define MOLEMOLE_UIGENERALPURCHASEPOPWINDOWCONTROLLER___C__DISPLAYCLASS40_1__CTOR_OFFSET UNITYSDK_OFFSET(0xDFC0AD0)
#define MOLEMOLE_UIGENERALPURCHASEPOPWINDOWCONTROLLER___C__DISPLAYCLASS40_1__ONREWARDONCLICKCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0xDFC0AE0)
#define MOLEMOLE_UIGENERALPURCHASEPOPWINDOWCONTROLLER___C__DISPLAYCLASS40_1__ONREWARDONCLICKCALLBACK_B__1_OFFSET UNITYSDK_OFFSET(0xDFC0C90)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralPurchasePopWindowController___c__DisplayClass40_1_TypeDefinitionIndex = 38004;
