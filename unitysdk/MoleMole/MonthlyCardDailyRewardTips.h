...
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0xD81A320)
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xD81A310)
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xD81A3B0)
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS_SETPOPPRIORITY_OFFSET UNITYSDK_OFFSET(0xD81A340)
#define MOLEMOLE_MONTHLYCARDDAILYREWARDTIPS__CTOR_OFFSET UNITYSDK_OFFSET(0xD81A330)

namespace MoleMole
{
	inline static constexpr unsigned int MonthlyCardDailyRewardTips_TypeDefinitionIndex = 77530;
