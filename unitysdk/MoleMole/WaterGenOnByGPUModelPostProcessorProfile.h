...
#define MOLEMOLE_WATERGENONBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x9A32590)
#define MOLEMOLE_WATERGENONBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A32620)
#define MOLEMOLE_WATERGENONBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x9A32680)

namespace MoleMole
{
	inline static constexpr unsigned int WaterGenOnByGPUModelPostProcessorProfile_TypeDefinitionIndex = 43443;
