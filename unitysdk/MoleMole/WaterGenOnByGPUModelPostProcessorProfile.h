...
#define MOLEMOLE_WATERGENONBYGPUMODELPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0xACFFD60)
#define MOLEMOLE_WATERGENONBYGPUMODELPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xACFFDF0)
#define MOLEMOLE_WATERGENONBYGPUMODELPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0xACFFE50)

namespace MoleMole
{
	inline static constexpr unsigned int WaterGenOnByGPUModelPostProcessorProfile_TypeDefinitionIndex = 71733;
