...
#define MOLEMOLE_CONFIGUIMAINCITY_CHALLENGETIPSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCCB1A30)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIMainCity_ChallengeTipsConfig_TypeDefinitionIndex = 45768;
