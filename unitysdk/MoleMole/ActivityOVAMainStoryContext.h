...
#define MOLEMOLE_ACTIVITYOVAMAINSTORYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7BA8A10)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityOVAMainStoryContext_TypeDefinitionIndex = 55350;
