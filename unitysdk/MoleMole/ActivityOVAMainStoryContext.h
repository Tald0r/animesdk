...
#define MOLEMOLE_ACTIVITYOVAMAINSTORYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x95C4660)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityOVAMainStoryContext_TypeDefinitionIndex = 54816;
