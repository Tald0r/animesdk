...
#define MOLEMOLE_UIFLOWERMAIN_RIGHTWIDGETCONTROLLER___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBF00A10)
#define MOLEMOLE_UIFLOWERMAIN_RIGHTWIDGETCONTROLLER___C__DISPLAYCLASS27_0__SORTFLOWERDATA_G__SORTEDFUNC_0_OFFSET UNITYSDK_OFFSET(0xBF00A20)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerMain_RightWidgetController___c__DisplayClass27_0_TypeDefinitionIndex = 57314;
	...
	public:
		...
		::System::Boolean gentleSelected; // 0x18
		::System::Boolean richSelected; // 0x19
		::System::Boolean romanceSelected; // 0x1A
		::System::Boolean funSelected; // 0x1B
