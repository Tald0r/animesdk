...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS52_1__CTOR_OFFSET UNITYSDK_OFFSET(0xB2B67B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS52_1__PLAYPICTURESTORYNODE_B__5_OFFSET UNITYSDK_OFFSET(0xB2B67C0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS52_1__PLAYPICTURESTORYNODE_B__6_OFFSET UNITYSDK_OFFSET(0xB2B68A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass52_1_TypeDefinitionIndex = 58902;
