...
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x98B53C0)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x98B5540)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98B5460)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98B5320)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98B5BD0)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x98B5BE0)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x98B5C50)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x98B5CD0)
#define MOLEMOLE_UILEVELRESULTCHALLENGEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98B5D50)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultChallengeRowWidgetController_TypeDefinitionIndex = 60541;

	class UILevelResultChallengeRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_77D12983AB7F9492_3* _view; // 0x2D0
