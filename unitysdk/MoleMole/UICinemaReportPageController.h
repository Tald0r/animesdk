...
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD0FAF40)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD0FAF50)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD0FAFC0)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONSELFINFOCHAGNED_OFFSET UNITYSDK_OFFSET(0xD0FB4C0)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD0FB310)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD0FB3F0)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD0FB080)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_SETVIEWRADARCHARTLIST_OFFSET UNITYSDK_OFFSET(0xD0FB670)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD0FB590)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0FB740)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD0FB750)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD0FB7C0)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD0FB7D0)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD0FB7E0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaReportPageController_TypeDefinitionIndex = 74689;
