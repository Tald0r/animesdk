...
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA3340F0)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA334100)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA334170)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONSELFINFOCHAGNED_OFFSET UNITYSDK_OFFSET(0xA334670)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA3344C0)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA3345A0)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA334230)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_SETVIEWRADARCHARTLIST_OFFSET UNITYSDK_OFFSET(0xA334820)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA334740)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3348F0)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA334900)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA334970)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA334980)
#define MOLEMOLE_UICINEMAREPORTPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA334990)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaReportPageController_TypeDefinitionIndex = 65168;
