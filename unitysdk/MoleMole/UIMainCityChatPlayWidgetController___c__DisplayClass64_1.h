...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_1__CTOR_OFFSET UNITYSDK_OFFSET(0x8EC4F90)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_1__SHOWNARRATORSCREEN_G__PLAYGALEFFECT_5_OFFSET UNITYSDK_OFFSET(0x8EC4FA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass64_1_TypeDefinitionIndex = 69005;

	class UIMainCityChatPlayWidgetController___c__DisplayClass64_1 : public ::System::Object
	{
	public:
		::MoleMole::UIMainCityChatPlayWidgetController___c__DisplayClass64_0* CS___8__locals1; // 0x10
