...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_1__CTOR_OFFSET UNITYSDK_OFFSET(0x7D48DF0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_1__SHOWNARRATORSCREEN_G__PLAYGALEFFECT_5_OFFSET UNITYSDK_OFFSET(0x7D48E00)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass64_1_TypeDefinitionIndex = 53832;
