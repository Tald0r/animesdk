...
#define MOLEMOLE_UISUMMERFISHINGLOCATIONWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3DA920)
#define MOLEMOLE_UISUMMERFISHINGLOCATIONWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3DA990)
#define MOLEMOLE_UISUMMERFISHINGLOCATIONWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xC3DACA0)
#define MOLEMOLE_UISUMMERFISHINGLOCATIONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC3DAA90)
#define MOLEMOLE_UISUMMERFISHINGLOCATIONWIDGETCONTROLLER_SETSELECT_OFFSET UNITYSDK_OFFSET(0xC3DABD0)
#define MOLEMOLE_UISUMMERFISHINGLOCATIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC3DAE20)
#define MOLEMOLE_UISUMMERFISHINGLOCATIONWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3DAE50)
#define MOLEMOLE_UISUMMERFISHINGLOCATIONWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xC3DAEC0)
#define MOLEMOLE_UISUMMERFISHINGLOCATIONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC3DAF20)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishingLocationWidgetController_TypeDefinitionIndex = 78871;
