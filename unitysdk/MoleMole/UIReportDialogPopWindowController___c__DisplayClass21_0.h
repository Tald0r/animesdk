...
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD7E20)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__ONCLICKSELECTCHATHISTORY_B__0_OFFSET UNITYSDK_OFFSET(0xCFD7E30)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__ONCLICKSELECTCHATHISTORY_B__1_OFFSET UNITYSDK_OFFSET(0xCFD80E0)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__ONCLICKSELECTCHATHISTORY_B__2_OFFSET UNITYSDK_OFFSET(0xCFD8150)
#define MOLEMOLE_UIREPORTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS21_0__ONCLICKSELECTCHATHISTORY_B__3_OFFSET UNITYSDK_OFFSET(0xCFD8070)

namespace MoleMole
{
	inline static constexpr unsigned int UIReportDialogPopWindowController___c__DisplayClass21_0_TypeDefinitionIndex = 60491;
