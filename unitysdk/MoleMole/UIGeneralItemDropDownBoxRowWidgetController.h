...
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER_ENABLENEWWIDGET_OFFSET UNITYSDK_OFFSET(0xF22B2F0)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER_GETUITABBUTTON_OFFSET UNITYSDK_OFFSET(0xF22A570)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER_INITNORMALVIEW_OFFSET UNITYSDK_OFFSET(0xF22A700)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xF22B110)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xF22B210)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xF22B1B0)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xF22A5E0)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER_SHOWNOTIFICATION_OFFSET UNITYSDK_OFFSET(0xF22B4B0)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xF22B740)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER__INITNORMALVIEW_B__11_0_OFFSET UNITYSDK_OFFSET(0xF22B940)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER__ONUIOPEN_B__5_0_OFFSET UNITYSDK_OFFSET(0xF22B770)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER___BASE_GETUITABBUTTON_OFFSET UNITYSDK_OFFSET(0xF22BA00)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xF22BA60)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xF22BAD0)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xF22BB50)
#define MOLEMOLE_UIGENERALITEMDROPDOWNBOXROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xF22BBB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralItemDropDownBoxRowWidgetController_TypeDefinitionIndex = 38361;
