...
#define MOLEMOLE_UICINEMAPREPPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x95CF3D0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaPrepPageContext_TypeDefinitionIndex = 63916;
