...
#define MOLEMOLE_UICINEMAPREPPAGECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD54A5B0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaPrepPageContext_TypeDefinitionIndex = 57537;
