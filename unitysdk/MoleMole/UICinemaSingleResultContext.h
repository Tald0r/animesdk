...
#define MOLEMOLE_UICINEMASINGLERESULTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8BD9FF0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSingleResultContext_TypeDefinitionIndex = 39337;
	...
	public:
		...
		::System::Int32 clearAllBubbleCount; // 0x34
		...
		::System::Int32 historyMaxCount; // 0x44
		::System::Int32 currMaxCount; // 0x48
