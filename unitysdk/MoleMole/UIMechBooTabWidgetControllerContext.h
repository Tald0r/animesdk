...
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBE2C7A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooTabWidgetControllerContext_TypeDefinitionIndex = 71039;
