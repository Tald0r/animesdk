...
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCFCE4C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooTabWidgetControllerContext_TypeDefinitionIndex = 57896;
