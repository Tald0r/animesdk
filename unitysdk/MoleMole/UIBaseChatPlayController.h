...
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_FINISH_OFFSET UNITYSDK_OFFSET(0xD52C2E0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GETCANAUTONEXT_OFFSET UNITYSDK_OFFSET(0xD52C790)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GETCHATSYNCDATA_OFFSET UNITYSDK_OFFSET(0xD52F410)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GETISRUNNINGSKIP_OFFSET UNITYSDK_OFFSET(0xD52C4E0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GETNPCTAGBYCHATCONFIGAVATARID_OFFSET UNITYSDK_OFFSET(0xD52E620)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GET_CAMERAWRAPPER_OFFSET UNITYSDK_OFFSET(0xD52C350)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xD52C2D0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_GET_OPENCONTEXT_OFFSET UNITYSDK_OFFSET(0xD52C340)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_INITNPCIK_OFFSET UNITYSDK_OFFSET(0xD52C980)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_ISINMAINCITY_OFFSET UNITYSDK_OFFSET(0xD52D230)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_MODIFYTIME_OFFSET UNITYSDK_OFFSET(0xD52FC40)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_ONNODERUN_OFFSET UNITYSDK_OFFSET(0xD52C370)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_OVERRIDENEARCLIPDIS_OFFSET UNITYSDK_OFFSET(0xD52EF00)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xD52EA50)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_PLAYAVATARANIMATION_OFFSET UNITYSDK_OFFSET(0xD52E7B0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_PROCESSCHATIK_OFFSET UNITYSDK_OFFSET(0xD52CEB0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_PROCESSCONDITION_OFFSET UNITYSDK_OFFSET(0xD530E30)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_PRVCHECKSYNCINTERACTIONTOSERVER_OFFSET UNITYSDK_OFFSET(0xD52F7A0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RECORDDYNAMICOBJECTVISIBILITY_OFFSET UNITYSDK_OFFSET(0xD52F180)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RECORDMEMBERIKOPERATION_OFFSET UNITYSDK_OFFSET(0xD52D2D0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RECORDNPCIKOPERATION_OFFSET UNITYSDK_OFFSET(0xD52CE00)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RECORDNPCVISIBILITY_OFFSET UNITYSDK_OFFSET(0xD52F0E0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RECORDPLAYERTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD52D740)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RESTORENPCIK_OFFSET UNITYSDK_OFFSET(0xD52D590)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_RESTOREPLAYERTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD52DC90)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETANIMATORPARAM_OFFSET UNITYSDK_OFFSET(0xD52EC80)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETATTACHEFFECT_OFFSET UNITYSDK_OFFSET(0xD52E1E0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETDYNAMICOBJECTVISIBLE_OFFSET UNITYSDK_OFFSET(0xD5309C0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETJUMP_OFFSET UNITYSDK_OFFSET(0xD5311F0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETNEXT_OFFSET UNITYSDK_OFFSET(0xD530DA0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETNPC_OFFSET UNITYSDK_OFFSET(0xD52C8D0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETSPECIALS_OFFSET UNITYSDK_OFFSET(0xD52F220)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SETTAGVISIBLE_OFFSET UNITYSDK_OFFSET(0xD5301D0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SET_CAMERAWRAPPER_OFFSET UNITYSDK_OFFSET(0xD52C360)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_SKIPSTORYPLAY_OFFSET UNITYSDK_OFFSET(0xD52C5B0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_STARTSKIPCHAT_OFFSET UNITYSDK_OFFSET(0xD52C3E0)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_STOPSKIPCHAT_OFFSET UNITYSDK_OFFSET(0xD52C460)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_TRYNOOPTIONSYNCINTERACTIONTOSERVER_OFFSET UNITYSDK_OFFSET(0xD52F930)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_TRYOPTIONSYNCINTERACTIONTOSERVER_OFFSET UNITYSDK_OFFSET(0xD52F480)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER_UPDATESKIPSTATE_OFFSET UNITYSDK_OFFSET(0xD52C720)
#define MOLEMOLE_UIBASECHATPLAYCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD5312F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBaseChatPlayController_TypeDefinitionIndex = 68467;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::GalGame::LookIKCfg*>* _ikRecordMemberList; // 0x310
