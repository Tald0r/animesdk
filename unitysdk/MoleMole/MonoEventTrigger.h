...
#define MOLEMOLE_MONOEVENTTRIGGER_ADDTRIGGER_OFFSET UNITYSDK_OFFSET(0xB1A6200)
#define MOLEMOLE_MONOEVENTTRIGGER_CLEARTRIGGERS_OFFSET UNITYSDK_OFFSET(0xB1A63D0)
#define MOLEMOLE_MONOEVENTTRIGGER_CLEAR_OFFSET UNITYSDK_OFFSET(0xB1A6080)
#define MOLEMOLE_MONOEVENTTRIGGER_GET_ISDRAGGING_OFFSET UNITYSDK_OFFSET(0xB1A7E00)
#define MOLEMOLE_MONOEVENTTRIGGER_METHOD_5_E92A4A6790C96646_OFFSET UNITYSDK_OFFSET(0xB1A6600)
#define MOLEMOLE_MONOEVENTTRIGGER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xB1A7880)
#define MOLEMOLE_MONOEVENTTRIGGER_ONCANCEL_OFFSET UNITYSDK_OFFSET(0xB1A7CA0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONDESELECT_OFFSET UNITYSDK_OFFSET(0xB1A7170)
#define MOLEMOLE_MONOEVENTTRIGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB1A5FD0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB1A5F60)
#define MOLEMOLE_MONOEVENTTRIGGER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xB1A6840)
#define MOLEMOLE_MONOEVENTTRIGGER_ONDROP_OFFSET UNITYSDK_OFFSET(0xB1A69A0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xB1A79E0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0xB1A7720)
#define MOLEMOLE_MONOEVENTTRIGGER_ONMOVE_OFFSET UNITYSDK_OFFSET(0xB1A7460)
#define MOLEMOLE_MONOEVENTTRIGGER_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0xB1A6E70)
#define MOLEMOLE_MONOEVENTTRIGGER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xB1A6B30)
#define MOLEMOLE_MONOEVENTTRIGGER_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0xB1A64A0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0xB1A66E0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xB1A6CD0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xB1A72D0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONSELECT_OFFSET UNITYSDK_OFFSET(0xB1A7010)
#define MOLEMOLE_MONOEVENTTRIGGER_ONSUBMIT_OFFSET UNITYSDK_OFFSET(0xB1A7B40)
#define MOLEMOLE_MONOEVENTTRIGGER_ONUPDATESELECTED_OFFSET UNITYSDK_OFFSET(0xB1A75C0)
#define MOLEMOLE_MONOEVENTTRIGGER_REMOVETRIGGER_OFFSET UNITYSDK_OFFSET(0xB1A62E0)
#define MOLEMOLE_MONOEVENTTRIGGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB1A60F0)
#define MOLEMOLE_MONOEVENTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xB1A7E10)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEventTrigger_TypeDefinitionIndex = 55165;
