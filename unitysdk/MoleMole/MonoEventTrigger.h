...
#define MOLEMOLE_MONOEVENTTRIGGER_ADDTRIGGER_OFFSET UNITYSDK_OFFSET(0x8B21770)
#define MOLEMOLE_MONOEVENTTRIGGER_CLEARTRIGGERS_OFFSET UNITYSDK_OFFSET(0x8B21940)
#define MOLEMOLE_MONOEVENTTRIGGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x8B215F0)
#define MOLEMOLE_MONOEVENTTRIGGER_GET_ISDRAGGING_OFFSET UNITYSDK_OFFSET(0x8B23370)
#define MOLEMOLE_MONOEVENTTRIGGER_METHOD_5_E92A4A6790C96646_OFFSET UNITYSDK_OFFSET(0x8B21B70)
#define MOLEMOLE_MONOEVENTTRIGGER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x8B22DF0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONCANCEL_OFFSET UNITYSDK_OFFSET(0x8B23210)
#define MOLEMOLE_MONOEVENTTRIGGER_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x8B226E0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8B21540)
#define MOLEMOLE_MONOEVENTTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x8B214D0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x8B21DB0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONDROP_OFFSET UNITYSDK_OFFSET(0x8B21F10)
#define MOLEMOLE_MONOEVENTTRIGGER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x8B22F50)
#define MOLEMOLE_MONOEVENTTRIGGER_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0x8B22C90)
#define MOLEMOLE_MONOEVENTTRIGGER_ONMOVE_OFFSET UNITYSDK_OFFSET(0x8B229D0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x8B223E0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x8B220A0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x8B21A10)
#define MOLEMOLE_MONOEVENTTRIGGER_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x8B21C50)
#define MOLEMOLE_MONOEVENTTRIGGER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x8B22240)
#define MOLEMOLE_MONOEVENTTRIGGER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x8B22840)
#define MOLEMOLE_MONOEVENTTRIGGER_ONSELECT_OFFSET UNITYSDK_OFFSET(0x8B22580)
#define MOLEMOLE_MONOEVENTTRIGGER_ONSUBMIT_OFFSET UNITYSDK_OFFSET(0x8B230B0)
#define MOLEMOLE_MONOEVENTTRIGGER_ONUPDATESELECTED_OFFSET UNITYSDK_OFFSET(0x8B22B30)
#define MOLEMOLE_MONOEVENTTRIGGER_REMOVETRIGGER_OFFSET UNITYSDK_OFFSET(0x8B21850)
#define MOLEMOLE_MONOEVENTTRIGGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x8B21660)
#define MOLEMOLE_MONOEVENTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x8B23380)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEventTrigger_TypeDefinitionIndex = 78076;
