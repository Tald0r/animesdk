...
#define MOLEMOLE_EXPOSUREPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xEC7ADC0)

namespace MoleMole
{
	inline static constexpr unsigned int ExposureProfileContext_TypeDefinitionIndex = 48062;
