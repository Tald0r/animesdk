...
#define MOLEMOLE_SERIALIZABLEDECALAREADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9ACD2D0)

namespace MoleMole
{
	inline static constexpr unsigned int SerializableDecalAreaData_TypeDefinitionIndex = 68751;
