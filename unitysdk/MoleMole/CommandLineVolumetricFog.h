...
#define MOLEMOLE_COMMANDLINEVOLUMETRICFOG_METHOD_2_5A641E4B57BEEA2D_OFFSET UNITYSDK_OFFSET(0x8492B60)
#define MOLEMOLE_COMMANDLINEVOLUMETRICFOG_METHOD_2_9E416DEC21EEB640_OFFSET UNITYSDK_OFFSET(0x8492CA0)
#define MOLEMOLE_COMMANDLINEVOLUMETRICFOG__CTOR_OFFSET UNITYSDK_OFFSET(0x8492C60)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineVolumetricFog_TypeDefinitionIndex = 50967;
