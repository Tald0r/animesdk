...
#define MOLEMOLE_UISAFEAREAHANDLER_GETSAFEAREARECT_OFFSET UNITYSDK_OFFSET(0xAB98510)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_0B08B4F8E959C85E_OFFSET UNITYSDK_OFFSET(0xAB99000)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_0CEE9868CF9CA474_OFFSET UNITYSDK_OFFSET(0xAB98EC0)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_6F9CD8CD29C814C3_OFFSET UNITYSDK_OFFSET(0xAB988C0)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_A27DC2C5A103933A_OFFSET UNITYSDK_OFFSET(0xAB99180)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0xAB98EB0)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAB98E50)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xAB99EC0)
#define MOLEMOLE_UISAFEAREAHANDLER_METHOD_6_FC924E2ADB89532B_OFFSET UNITYSDK_OFFSET(0xAB99E50)
#define MOLEMOLE_UISAFEAREAHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAB982F0)
#define MOLEMOLE_UISAFEAREAHANDLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAB98390)
#define MOLEMOLE_UISAFEAREAHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB98DA0)
#define MOLEMOLE_UISAFEAREAHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAB98DC0)

namespace MoleMole
{
	inline static constexpr unsigned int UISafeAreaHandler_TypeDefinitionIndex = 60621;
