...
#define MOLEMOLE_UIDISPLAYCASECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBB1F640)

namespace MoleMole
{
	inline static constexpr unsigned int UIDisplayCaseContext_TypeDefinitionIndex = 56035;
	...
	public:
		...
		::System::Int32 CurFriendIdx; // 0x38
		::System::Boolean IsFemale; // 0x3C
		::System::Boolean IsFriend; // 0x3D
