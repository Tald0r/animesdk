...
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_CONTEXT_GET_USEGENERALBG_OFFSET UNITYSDK_OFFSET(0x9A38530)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_CONTEXT_SET_USEGENERALBG_OFFSET UNITYSDK_OFFSET(0x9A38540)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9A38550)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchInterknotNotePageController_Context_TypeDefinitionIndex = 55800;
