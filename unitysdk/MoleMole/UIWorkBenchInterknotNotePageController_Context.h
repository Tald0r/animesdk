...
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_CONTEXT_GET_USEGENERALBG_OFFSET UNITYSDK_OFFSET(0x8895B90)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_CONTEXT_SET_USEGENERALBG_OFFSET UNITYSDK_OFFSET(0x8895BA0)
#define MOLEMOLE_UIWORKBENCHINTERKNOTNOTEPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8895BB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchInterknotNotePageController_Context_TypeDefinitionIndex = 55725;
