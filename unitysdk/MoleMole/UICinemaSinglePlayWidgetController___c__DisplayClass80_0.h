...
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA52A6B0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__0_OFFSET UNITYSDK_OFFSET(0xA52A6C0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__1_OFFSET UNITYSDK_OFFSET(0xA52A880)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__2_OFFSET UNITYSDK_OFFSET(0xA52A980)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__3_OFFSET UNITYSDK_OFFSET(0xA52AAD0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__4_OFFSET UNITYSDK_OFFSET(0xA52A830)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__5_OFFSET UNITYSDK_OFFSET(0xA52A930)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSinglePlayWidgetController___c__DisplayClass80_0_TypeDefinitionIndex = 64974;
	...
	public:
		...
		::Class_2_3F802DF1B3FAD67A_5* bubbleEvent; // 0x30
		::Class_2_79AE422BA06F6D26_101* controllerView; // 0x38
