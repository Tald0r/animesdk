...
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__CTOR_OFFSET UNITYSDK_OFFSET(0xADC1720)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__0_OFFSET UNITYSDK_OFFSET(0xADC1730)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__1_OFFSET UNITYSDK_OFFSET(0xADC18F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__2_OFFSET UNITYSDK_OFFSET(0xADC19F0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__3_OFFSET UNITYSDK_OFFSET(0xADC1B40)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__4_OFFSET UNITYSDK_OFFSET(0xADC18A0)
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTROLLER___C__DISPLAYCLASS80_0__SHOWSUPERBUBBLE_B__5_OFFSET UNITYSDK_OFFSET(0xADC19A0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSinglePlayWidgetController___c__DisplayClass80_0_TypeDefinitionIndex = 38051;

	class UICinemaSinglePlayWidgetController___c__DisplayClass80_0 : public ::System::Object
	{
	public:
		::Class_2_3F802DF1B3FAD67A_3* bubbleEvent; // 0x10
		::System::Func_1<::Foundation::Tuple_2<::System::Int32, ::System::Single>>* onClick; // 0x18
		::Class_2_79AE422BA06F6D26_13* controllerView; // 0x20
