...
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_CREATEDROPDOWNWIDGET_OFFSET UNITYSDK_OFFSET(0xA364AD0)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_GETDROPDOWNWIDGET_OFFSET UNITYSDK_OFFSET(0xA364A10)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_GETOVERRIDEFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0xA364D10)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_GET_ENABLEPOSITIONTICK_OFFSET UNITYSDK_OFFSET(0xA363870)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_GET_ISALLOWINPUTPASS_OFFSET UNITYSDK_OFFSET(0xA3636D0)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_GET_POSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0xA363780)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_INITNORMALVIEW_OFFSET UNITYSDK_OFFSET(0xA363CE0)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA363880)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA364930)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xA364850)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_ONPLAYFADEINANIMATIONAFTERLOADING_OFFSET UNITYSDK_OFFSET(0xA364C30)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA364760)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA3636E0)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA363920)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA364DD0)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER___BASE_GETOVERRIDEFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0xA364E10)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER___BASE_GET_POSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0xA364E00)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA364E20)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA364E90)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xA364EC0)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER___BASE_ONPLAYFADEINANIMATIONAFTERLOADING_OFFSET UNITYSDK_OFFSET(0xA364F20)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA364F30)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA364FA0)
#define MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA365000)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralDropDownTipsWidgetController_TypeDefinitionIndex = 49815;

	class UIGeneralDropDownTipsWidgetController : public ::MoleMole::UIBaseDynamicTipsWidgetController
	{
	public:
		::Class_2_54134CBC16D70821* _view; // 0x2A8
		::MoleMole::UIGeneralDropDownControllerContext* _normalContext; // 0x2B0
		::System::Collections::Generic::List_1<::MoleMole::DropDownItemWidgetController*>* _scrollContentList; // 0x2B8
		::System::Action* onCloseAction; // 0x2C0
		...
		{
			return ((::System::String*(*)(::PVOID, ::MoleMole::UIFadeConfig*, ::Enum_3_B90C1A15EA6E3C2B))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER_GETOVERRIDEFADEOUTANIM_OFFSET))(this, fadeData, nextPage);
		}
		...
		{
			return ((::System::String*(*)(::PVOID, ::MoleMole::UIFadeConfig*, ::Enum_3_B90C1A15EA6E3C2B))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALDROPDOWNTIPSWIDGETCONTROLLER___BASE_GETOVERRIDEFADEOUTANIM_OFFSET))(this, P0, P1);
		}
