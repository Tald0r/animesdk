...
#define MOLEMOLE_SCROLLVIEWDUMMYITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0xB1BF4E0)
#define MOLEMOLE_SCROLLVIEWDUMMYITEM_GETLAYOUTELEMENTSIZE_OFFSET UNITYSDK_OFFSET(0xB1BF680)
#define MOLEMOLE_SCROLLVIEWDUMMYITEM_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB1BF750)
#define MOLEMOLE_SCROLLVIEWDUMMYITEM_SETLAYOUTELEMENTSIZE_OFFSET UNITYSDK_OFFSET(0xB1BF5B0)
#define MOLEMOLE_SCROLLVIEWDUMMYITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB1BF730)

namespace MoleMole
{
	inline static constexpr unsigned int ScrollViewDummyItem_TypeDefinitionIndex = 61444;
