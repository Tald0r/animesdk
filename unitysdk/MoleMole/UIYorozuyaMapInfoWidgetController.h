...
#define MOLEMOLE_UIYOROZUYAMAPINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA08EF10)
#define MOLEMOLE_UIYOROZUYAMAPINFOWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA08F5A0)
#define MOLEMOLE_UIYOROZUYAMAPINFOWIDGETCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0xA08F2E0)
#define MOLEMOLE_UIYOROZUYAMAPINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA08F4C0)
#define MOLEMOLE_UIYOROZUYAMAPINFOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA08ED30)
#define MOLEMOLE_UIYOROZUYAMAPINFOWIDGETCONTROLLER_PLAYFADEANI_OFFSET UNITYSDK_OFFSET(0xA08F0D0)
#define MOLEMOLE_UIYOROZUYAMAPINFOWIDGETCONTROLLER_REFLESHVIEW_OFFSET UNITYSDK_OFFSET(0xA08EFB0)
#define MOLEMOLE_UIYOROZUYAMAPINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA08F720)
#define MOLEMOLE_UIYOROZUYAMAPINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA08F730)
#define MOLEMOLE_UIYOROZUYAMAPINFOWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA08F7A0)
#define MOLEMOLE_UIYOROZUYAMAPINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA08F820)
#define MOLEMOLE_UIYOROZUYAMAPINFOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA08F8A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaMapInfoWidgetController_TypeDefinitionIndex = 75430;
	...
	public:
		...
		::Class_2_208CC9941471731A_360* _mData; // 0x2D8
		...
		::System::Void RefleshView(::Class_2_208CC9941471731A_360* sceneCfg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_360*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIYOROZUYAMAPINFOWIDGETCONTROLLER_REFLESHVIEW_OFFSET))(this, sceneCfg);
		}
