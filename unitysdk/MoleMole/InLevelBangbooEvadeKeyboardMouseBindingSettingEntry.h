...
#define MOLEMOLE_INLEVELBANGBOOEVADEKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0xA7E1380)
#define MOLEMOLE_INLEVELBANGBOOEVADEKEYBOARDMOUSEBINDINGSETTINGENTRY_GET_SETTINGLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xA7E1390)
#define MOLEMOLE_INLEVELBANGBOOEVADEKEYBOARDMOUSEBINDINGSETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xA7E13A0)

namespace MoleMole
{
	inline static constexpr unsigned int InLevelBangbooEvadeKeyboardMouseBindingSettingEntry_TypeDefinitionIndex = 59035;
