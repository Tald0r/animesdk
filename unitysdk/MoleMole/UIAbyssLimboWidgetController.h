...
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GETENTRANCEID_OFFSET UNITYSDK_OFFSET(0xC3492F0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GETNEEDPLAYUNLOCKEFFECT_OFFSET UNITYSDK_OFFSET(0xC34D690)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GETPROGRESSEFFECTPLAYCOUNT_OFFSET UNITYSDK_OFFSET(0xC34D760)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GET_ISAFKLOCKED_OFFSET UNITYSDK_OFFSET(0xC34D670)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GET_ISBOSSRUSHENTRANCE_OFFSET UNITYSDK_OFFSET(0xC34C6A0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GET_ISLOCK_OFFSET UNITYSDK_OFFSET(0xC34D680)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_GET_ISNESTENTRANCE_OFFSET UNITYSDK_OFFSET(0xC34C6B0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC348AE0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ISNEW_OFFSET UNITYSDK_OFFSET(0xC34E450)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ISRED_OFFSET UNITYSDK_OFFSET(0xC34E660)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC34E850)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC34D4A0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONLIMBOBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0xC345E40)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC34D5C0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC34E8F0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC34C6C0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC34D250)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_REFRESHENTRANCEVIEW_OFFSET UNITYSDK_OFFSET(0xC34D800)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_REFRESHHOBAPREFACVIEW_OFFSET UNITYSDK_OFFSET(0xC34DE40)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_REFRESHNEWSTATE_OFFSET UNITYSDK_OFFSET(0xC34A3F0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_REFRESHPERIODVIEW_OFFSET UNITYSDK_OFFSET(0xC34DA20)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0xC349370)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC34E9D0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__ONUIOPEN_B__21_0_OFFSET UNITYSDK_OFFSET(0xC34EAF0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__ONUIOPEN_B__21_1_OFFSET UNITYSDK_OFFSET(0xC34EB00)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__REFRESHSTATE_B__35_0_OFFSET UNITYSDK_OFFSET(0xC34EB10)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__REFRESHSTATE_B__35_1_OFFSET UNITYSDK_OFFSET(0xC34EB80)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__REFRESHSTATE_B__35_2_OFFSET UNITYSDK_OFFSET(0xC34EBF0)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER__REFRESHSTATE_B__35_3_OFFSET UNITYSDK_OFFSET(0xC34EC90)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC34EE20)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC34EE90)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC34EF00)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC34EF80)
#define MOLEMOLE_UIABYSSLIMBOWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC34EFE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssLimboWidgetController_TypeDefinitionIndex = 71587;

	class UIAbyssLimboWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_46B1304F31463D00_1* _view; // 0x2A0
		...
		::System::Action_1<::Class_2_208CC9941471731A_538*>* clickAction; // 0x2E8
		...
		::Class_2_208CC9941471731A_538* entranceCfg; // 0x330
