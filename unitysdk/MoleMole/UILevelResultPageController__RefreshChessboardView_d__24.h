...
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x6CA4690)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x6CA5C90)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x6CA5CF0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x6CA5CA0)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6CA4680)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER__REFRESHCHESSBOARDVIEW_D__24__CTOR_OFFSET UNITYSDK_OFFSET(0x6CA4670)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultPageController__RefreshChessboardView_d__24_TypeDefinitionIndex = 76305;
	...
	public:
		...
		::System::Boolean _isEndBattle_5__2; // 0x1C
		::System::Int32 _coinNum_5__3; // 0x20
