...
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT_GET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0xEE50620)
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT_GET_VIDEOSKIP_OFFSET UNITYSDK_OFFSET(0xEE50640)
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT_SET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0xEE50630)
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT_SET_VIDEOSKIP_OFFSET UNITYSDK_OFFSET(0xEE50650)
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xEE50660)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoWidgetContext_TypeDefinitionIndex = 40598;

	class UIVideoWidgetContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Action_1<::MoleMole::UIVideoWidgetController*>* OnVideoPrepare; // 0x28
		::System::Action* OnVideoDestroy; // 0x30
		::System::Action* OnSkip; // 0x38
		::System::Action* OnSetPlayData; // 0x40
		::UnityEngine::Video::VideoClip* clip; // 0x48
		::Class_1_D00124C4966CEBFC* _Acceleration_k__BackingField; // 0x50
		::System::Action* OnPlayEnd; // 0x58
		::System::String* audioTimeline; // 0x60
		::System::String* relativeUrl; // 0x68
		::Class_2_208CC9941471731A_805* performTemplate; // 0x70
		::Class_1_F7E58FEB09AEC901* _VideoSkip_k__BackingField; // 0x78
		::System::Action* OnRealPlay; // 0x80
		::System::Single screenHeightOffset; // 0x88
		::Enum_3_502044D76C6270C7 endMode; // 0x8C
		::UnityEngine::UI::AspectRatioFitter_AspectMode aspectMode; // 0x90
		::System::Boolean IsSkip; // 0x94
		::System::Boolean isPlayOnAwake; // 0x95
		::System::Boolean isAutoPlayByPrepare; // 0x96
		::System::Boolean autoSetPlayMix; // 0x97
		::Enum_3_43038093CB6347E9 fadeMode; // 0x98
