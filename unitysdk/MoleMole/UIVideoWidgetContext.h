...
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT_GET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0xAA773C0)
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT_GET_VIDEOSKIP_OFFSET UNITYSDK_OFFSET(0xAA773E0)
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT_SET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0xAA773D0)
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT_SET_VIDEOSKIP_OFFSET UNITYSDK_OFFSET(0xAA773F0)
#define MOLEMOLE_UIVIDEOWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAA77400)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoWidgetContext_TypeDefinitionIndex = 78970;

	class UIVideoWidgetContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Action* OnVideoDestroy; // 0x28
		::System::Action* OnSetPlayData; // 0x30
		::System::String* relativeUrl; // 0x38
		::System::Action* OnPlayEnd; // 0x40
		::System::Action* OnSkip; // 0x48
		::System::Action* OnRealPlay; // 0x50
		::System::Action_1<::MoleMole::UIVideoWidgetController*>* OnVideoPrepare; // 0x58
		::Class_2_208CC9941471731A_339* performTemplate; // 0x60
		::System::String* audioTimeline; // 0x68
		::Class_1_D00124C4966CEBFC* _Acceleration_k__BackingField; // 0x70
		::UnityEngine::Video::VideoClip* clip; // 0x78
		::Class_1_F7E58FEB09AEC901* _VideoSkip_k__BackingField; // 0x80
		...
		::System::Boolean isPlayOnAwake; // 0x94
		::System::Boolean isAutoPlayByPrepare; // 0x95
		::System::Boolean autoSetPlayMix; // 0x96
		::System::Boolean IsSkip; // 0x97
