...
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xC228B70)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xC228CF0)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0xC228A60)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xC228C50)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xC228A50)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xC228E50)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xC228EE0)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xC228F50)
#define MOLEMOLE_LOOPSUBDIVISIONPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xC228FC0)

namespace MoleMole
{
	inline static constexpr unsigned int LoopSubdivisionProfile_TypeDefinitionIndex = 56555;
