...
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_CHECKADDNEWENTITY_OFFSET UNITYSDK_OFFSET(0xBD44DE0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_CHECKCANLINKHATREDLINE_OFFSET UNITYSDK_OFFSET(0xBD42D70)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_CHECKVALIDENTITY_OFFSET UNITYSDK_OFFSET(0xBD453D0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_FETCHNEEDPROCESSDATA_OFFSET UNITYSDK_OFFSET(0xBD421A0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_LINKTARGETHEAD_OFFSET UNITYSDK_OFFSET(0xBD43B00)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_LOADHEADQUADRESOBJ_OFFSET UNITYSDK_OFFSET(0xBD43FC0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_LOADRESOBJ_OFFSET UNITYSDK_OFFSET(0xBD43A00)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xBD41BA0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBD440D0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xBD44CB0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONMONSTERREMOVE_OFFSET UNITYSDK_OFFSET(0xBD44FE0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xBD423D0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_REFRESHHATREDLINESTATE_OFFSET UNITYSDK_OFFSET(0xBD43540)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xBD447F0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_RELEASEHATREDLINEGAMEOBJECTTOPOOL_OFFSET UNITYSDK_OFFSET(0xBD45570)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_RELEASEHATREDLINE_OFFSET UNITYSDK_OFFSET(0xBD43440)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_RELEASELINKTARGETHEAD_OFFSET UNITYSDK_OFFSET(0xBD43200)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_SETENTITYLINKINFO_OFFSET UNITYSDK_OFFSET(0xBD42EC0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_TICKHATREDLINE_OFFSET UNITYSDK_OFFSET(0xBD429F0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_TICKWAITINGENTITY_OFFSET UNITYSDK_OFFSET(0xBD42800)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_UNREGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xBD44AE0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0xBD45620)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xBD45930)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBD45990)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xBD459F0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xBD45A50)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_UNREGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xBD45AB0)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterHatredLineSubSystem_TypeDefinitionIndex = 74870;
	...
	public:
		...
		::System::String* enemyAttachPointName; // 0x10
		::System::String* hetredLineEnableAnimatorZoneTag; // 0x18
		::Foundation::AssetRequestHandle quadResHandle; // 0x20
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* waittingList; // 0x40
		::System::Collections::Generic::Queue_1<::UnityEngine::GameObject*>* hatredLineObjectPool; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::ScreenSpaceQuadRenderer*>* linkHeadDic; // 0x50
		::Foundation::AssetPath lineResPath; // 0x58
		::System::Collections::Generic::List_1<::MoleMole::MonsterHatredLineSubSystem_HatredLineLinkData*>* newAddHatredDataList; // 0x68
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* linkedTargetRecord; // 0x70
		::System::Collections::Generic::List_1<::MoleMole::MonsterHatredLineSubSystem_HatredLineLinkData*>* hatredLineDataList; // 0x78
		::System::String* hideHetredLineAnimatorZoneTag; // 0x80
		::Foundation::AssetPath quadResPath; // 0x88
		::Foundation::AssetRequestHandle lineResHandle; // 0x98
		::System::Collections::Generic::Queue_1<::UnityEngine::GameObject*>* headQuadObjectPool; // 0xB8
		::System::String* playerAttachPointName; // 0xC0
