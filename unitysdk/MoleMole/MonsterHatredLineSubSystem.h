...
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_CHECKADDNEWENTITY_OFFSET UNITYSDK_OFFSET(0xB1B5D00)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_CHECKCANLINKHATREDLINE_OFFSET UNITYSDK_OFFSET(0xB1B3CB0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_CHECKVALIDENTITY_OFFSET UNITYSDK_OFFSET(0xB1B62F0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_FETCHNEEDPROCESSDATA_OFFSET UNITYSDK_OFFSET(0xB1B3100)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_LINKTARGETHEAD_OFFSET UNITYSDK_OFFSET(0xB1B4A40)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_LOADHEADQUADRESOBJ_OFFSET UNITYSDK_OFFSET(0xB1B4EF0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_LOADRESOBJ_OFFSET UNITYSDK_OFFSET(0xB1B4940)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB1B2B00)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB1B4FF0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0xB1B5BD0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONMONSTERREMOVE_OFFSET UNITYSDK_OFFSET(0xB1B5F00)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xB1B3320)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_REFRESHHATREDLINESTATE_OFFSET UNITYSDK_OFFSET(0xB1B4480)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xB1B5710)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_RELEASEHATREDLINEGAMEOBJECTTOPOOL_OFFSET UNITYSDK_OFFSET(0xB1B6490)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_RELEASEHATREDLINE_OFFSET UNITYSDK_OFFSET(0xB1B4380)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_RELEASELINKTARGETHEAD_OFFSET UNITYSDK_OFFSET(0xB1B4140)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_SETENTITYLINKINFO_OFFSET UNITYSDK_OFFSET(0xB1B3E00)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_TICKHATREDLINE_OFFSET UNITYSDK_OFFSET(0xB1B3940)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_TICKWAITINGENTITY_OFFSET UNITYSDK_OFFSET(0xB1B3750)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM_UNREGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xB1B5A00)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB1B6540)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xB1B6850)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB1B68B0)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xB1B6910)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_REGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xB1B6970)
#define MOLEMOLE_MONSTERHATREDLINESUBSYSTEM___BASE_UNREGISTEREVENTSYSTEMCALLBACK_OFFSET UNITYSDK_OFFSET(0xB1B69D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonsterHatredLineSubSystem_TypeDefinitionIndex = 77310;
	...
	public:
		...
		::Foundation::AssetPath lineResPath; // 0x10
		::Foundation::AssetRequestHandle quadResHandle; // 0x20
		::System::Collections::Generic::Queue_1<::UnityEngine::GameObject*>* hatredLineObjectPool; // 0x40
		::System::String* hetredLineEnableAnimatorZoneTag; // 0x48
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* linkedTargetRecord; // 0x60
		::Foundation::AssetPath quadResPath; // 0x68
		::System::String* hideHetredLineAnimatorZoneTag; // 0x78
		::System::Collections::Generic::List_1<::MoleMole::MonsterHatredLineSubSystem_HatredLineLinkData*>* newAddHatredDataList; // 0x80
		::System::Collections::Generic::List_1<::MoleMole::MonsterHatredLineSubSystem_HatredLineLinkData*>* hatredLineDataList; // 0x88
		::System::Collections::Generic::Queue_1<::UnityEngine::GameObject*>* headQuadObjectPool; // 0x90
