...
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_GETBOTTOMTIPSROOT_OFFSET UNITYSDK_OFFSET(0xC3C7A40)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC3C78C0)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3C78D0)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3C7940)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC3C7B00)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC3C7D00)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER___BASE_GETBOTTOMTIPSROOT_OFFSET UNITYSDK_OFFSET(0xC3C7D10)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3C7D70)
#define MOLEMOLE_UISOCIALCIRCLEMAINPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC3C7DE0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleMainPageController_TypeDefinitionIndex = 36826;
