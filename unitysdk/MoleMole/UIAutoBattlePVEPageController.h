...
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_BINDBUTTON_OFFSET UNITYSDK_OFFSET(0x98A00E0)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_CREATECHALLENGEITEMROW_OFFSET UNITYSDK_OFFSET(0x98A0CB0)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_CREATENORMALITEMROW_OFFSET UNITYSDK_OFFSET(0x98A0AF0)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0x98A0950)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x989FEF0)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x989FF00)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x989FF70)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98A0070)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98A0430)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98A0E70)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x98A0E80)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x98A0EF0)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x98A0F00)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattlePVEPageController_TypeDefinitionIndex = 67254;
