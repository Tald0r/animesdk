...
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_BINDBUTTON_OFFSET UNITYSDK_OFFSET(0xC8F4BB0)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_CREATECHALLENGEITEMROW_OFFSET UNITYSDK_OFFSET(0xC8F5780)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_CREATENORMALITEMROW_OFFSET UNITYSDK_OFFSET(0xC8F55C0)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0xC8F5420)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC8F49C0)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC8F49D0)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC8F4A40)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8F4B40)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC8F4F00)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC8F5940)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC8F5950)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8F59C0)
#define MOLEMOLE_UIAUTOBATTLEPVEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC8F59D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattlePVEPageController_TypeDefinitionIndex = 53343;
