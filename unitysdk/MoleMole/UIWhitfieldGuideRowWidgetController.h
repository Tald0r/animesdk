...
#define MOLEMOLE_UIWHITFIELDGUIDEROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEA081C0)
#define MOLEMOLE_UIWHITFIELDGUIDEROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEA082D0)
#define MOLEMOLE_UIWHITFIELDGUIDEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xEA083D0)
#define MOLEMOLE_UIWHITFIELDGUIDEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xEA08230)
#define MOLEMOLE_UIWHITFIELDGUIDEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xEA084D0)
#define MOLEMOLE_UIWHITFIELDGUIDEROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEA084E0)
#define MOLEMOLE_UIWHITFIELDGUIDEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xEA08550)
#define MOLEMOLE_UIWHITFIELDGUIDEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xEA085D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWhitfieldGuideRowWidgetController_TypeDefinitionIndex = 66616;
