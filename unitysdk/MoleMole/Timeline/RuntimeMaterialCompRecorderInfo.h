...
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0xB9C5880)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_GET_FRAMEATTRS_OFFSET UNITYSDK_OFFSET(0xB9C4B70)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_GET_INSTANCEMATERIALS_OFFSET UNITYSDK_OFFSET(0xB9C4940)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0xB9C5860)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_03BFDB1C3240A55A_OFFSET UNITYSDK_OFFSET(0xB9C6310)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_1AF357BC8EC348BD_OFFSET UNITYSDK_OFFSET(0xB9C9B30)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_22E26A255EB831DA_OFFSET UNITYSDK_OFFSET(0xB9C8900)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_277F8930086803D1_OFFSET UNITYSDK_OFFSET(0xB9C8E20)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_2D331162118AACA5_OFFSET UNITYSDK_OFFSET(0xB9C9080)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_493D6328E01546D4_OFFSET UNITYSDK_OFFSET(0xB9C85C0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_4DC7D80C2275A666_OFFSET UNITYSDK_OFFSET(0xB9C6550)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_4F7257DB3153C8CF_OFFSET UNITYSDK_OFFSET(0xB9C5A20)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_57149EFD880E9414_OFFSET UNITYSDK_OFFSET(0xB9C5AD0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_614D893906E2A775_OFFSET UNITYSDK_OFFSET(0xB9C9650)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_652F3820D8B242FF_OFFSET UNITYSDK_OFFSET(0xB9C7810)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_72DCA587D9B741B5_OFFSET UNITYSDK_OFFSET(0xB9C5EE0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_749CA2576B2ED62D_OFFSET UNITYSDK_OFFSET(0xB9C9AB0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_7BB5F5F4EFB4FA9A_OFFSET UNITYSDK_OFFSET(0xB9C8AA0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_90CE536D92651230_OFFSET UNITYSDK_OFFSET(0xB9C5470)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_9339CF0298A5CC7D_OFFSET UNITYSDK_OFFSET(0xB9C5F40)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_990B4432466915BC_OFFSET UNITYSDK_OFFSET(0xB9C6D00)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_ABBCFE8E4A0717AE_OFFSET UNITYSDK_OFFSET(0xB9C7780)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_AD55443DF1E11181_OFFSET UNITYSDK_OFFSET(0xB9C7A40)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_C27445BF0EA312D1_OFFSET UNITYSDK_OFFSET(0xB9C93F0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_C830CA5B31AAFAEB_OFFSET UNITYSDK_OFFSET(0xB9C58F0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_EE7339DA6ECF5F6D_OFFSET UNITYSDK_OFFSET(0xB9C61B0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_METHOD_1_FBD12382B8568056_OFFSET UNITYSDK_OFFSET(0xB9C8330)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0xB9C58B0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB9C52E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimeMaterialCompRecorderInfo_TypeDefinitionIndex = 46456;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(RuntimeMaterialCompRecorderInfo_TypeDefinitionIndex)->GetStaticField(0x10760);
		}
