...
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_GET_SCALECURVEWHENCLIPTIMECHANGEINFOMSG_OFFSET UNITYSDK_OFFSET(0xA4A5890)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_METHOD_2_043D66DF0962D23F_OFFSET UNITYSDK_OFFSET(0xA4A6860)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_METHOD_2_1CCB664FA80C2930_OFFSET UNITYSDK_OFFSET(0xA4A6AE0)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_METHOD_2_29A494D59164912A_OFFSET UNITYSDK_OFFSET(0xA4A59F0)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0xA4A6B60)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0xA4A6B50)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_METHOD_2_B507396681F9F72C_OFFSET UNITYSDK_OFFSET(0xA4A6230)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_METHOD_2_BF2ABB022A6B2E57_OFFSET UNITYSDK_OFFSET(0xA4A6920)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0xA4A6220)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xA4A5C20)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xA4A5930)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xA4A5E00)
#define MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA4A61C0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MihoyoPostProcessBehavior_TypeDefinitionIndex = 74714;
	...
	public:
		...
		::System::Void Method_2_043D66DF0962D23F(::MoleMole::EffectSimulate::IEffectSimulate* a1)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::EffectSimulate::IEffectSimulate*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_MIHOYOPOSTPROCESSBEHAVIOR_METHOD_2_043D66DF0962D23F_OFFSET))(this, a1);
		}
