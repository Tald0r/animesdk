...
#define MOLEMOLE_TIMELINE_COLORRECORDERUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C3760)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorRecorderUnit_TypeDefinitionIndex = 30112;
