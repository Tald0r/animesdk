...
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA556660)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xA556650)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xA5567C0)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetAbilityScriptSupportPlayableAsset_TypeDefinitionIndex = 58254;
