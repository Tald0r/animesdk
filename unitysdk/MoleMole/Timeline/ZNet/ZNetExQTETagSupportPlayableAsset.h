...
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB5BAFE0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB5BAFD0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xB5BB150)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetExQTETagSupportPlayableAsset_TypeDefinitionIndex = 49386;
