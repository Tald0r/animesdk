...
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTTRACK_CANMOVEBYUSERINTIMELINE_OFFSET UNITYSDK_OFFSET(0xA4AE850)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA4AE780)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0xA4AE8E0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTTRACK_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xA4AE920)
#define MOLEMOLE_TIMELINE_ZNET_ZNETABILITYSCRIPTSUPPORTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AE8B0)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetAbilityScriptSupportTrack_TypeDefinitionIndex = 72064;
