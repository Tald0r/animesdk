...
#define MOLEMOLE_TIMELINE_ZNET_ZNETANIMATIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xD390380)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetAnimationTrack_TypeDefinitionIndex = 37669;
