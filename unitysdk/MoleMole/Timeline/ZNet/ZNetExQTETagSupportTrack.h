...
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA4D6D10)
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0xA4D7370)
#define MOLEMOLE_TIMELINE_ZNET_ZNETEXQTETAGSUPPORTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA4D7340)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetExQTETagSupportTrack_TypeDefinitionIndex = 58042;
