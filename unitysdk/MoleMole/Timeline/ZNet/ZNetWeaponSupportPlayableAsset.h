...
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB3EB1D0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB3EB1C0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xB3EB340)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetWeaponSupportPlayableAsset_TypeDefinitionIndex = 66252;
