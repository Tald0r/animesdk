...
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA683F50)
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xA683F40)
#define MOLEMOLE_TIMELINE_ZNET_ZNETWEAPONSUPPORTPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xA6840C0)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetWeaponSupportPlayableAsset_TypeDefinitionIndex = 69512;
