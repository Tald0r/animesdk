...
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD844630)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0xD844AA0)
#define MOLEMOLE_TIMELINE_ZNET_ZNETCAMERASUPPORTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xD844A70)

namespace MoleMole::Timeline::ZNet
{
	inline static constexpr unsigned int ZNetCameraSupportTrack_TypeDefinitionIndex = 50104;
