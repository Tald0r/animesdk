...
#define MOLEMOLE_TIMELINE_MONOCUTSCENETIMEPERIODCONTROL_GETCURTIMEOFDAY_OFFSET UNITYSDK_OFFSET(0xB8CC9E0)
#define MOLEMOLE_TIMELINE_MONOCUTSCENETIMEPERIODCONTROL_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0xB8CC970)
#define MOLEMOLE_TIMELINE_MONOCUTSCENETIMEPERIODCONTROL_TRYSWITCHTIME_OFFSET UNITYSDK_OFFSET(0xB8CCB70)
#define MOLEMOLE_TIMELINE_MONOCUTSCENETIMEPERIODCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB8CD120)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MonoCutsceneTimePeriodControl_TypeDefinitionIndex = 62497;
