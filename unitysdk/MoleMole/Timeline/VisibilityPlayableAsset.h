...
#define MOLEMOLE_TIMELINE_VISIBILITYPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD223850)
#define MOLEMOLE_TIMELINE_VISIBILITYPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD223840)
#define MOLEMOLE_TIMELINE_VISIBILITYPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xD223980)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VisibilityPlayableAsset_TypeDefinitionIndex = 51033;
