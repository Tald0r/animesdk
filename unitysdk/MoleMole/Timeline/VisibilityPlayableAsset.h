...
#define MOLEMOLE_TIMELINE_VISIBILITYPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA4AD800)
#define MOLEMOLE_TIMELINE_VISIBILITYPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xA4AD7F0)
#define MOLEMOLE_TIMELINE_VISIBILITYPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AD930)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VisibilityPlayableAsset_TypeDefinitionIndex = 77667;
