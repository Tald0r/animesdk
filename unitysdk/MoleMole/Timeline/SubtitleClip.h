...
#define MOLEMOLE_TIMELINE_SUBTITLECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD46C410)
#define MOLEMOLE_TIMELINE_SUBTITLECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD46C3F0)
#define MOLEMOLE_TIMELINE_SUBTITLECLIP_GET_CLIPTYPE_OFFSET UNITYSDK_OFFSET(0xD46C400)
#define MOLEMOLE_TIMELINE_SUBTITLECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD46C600)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SubtitleClip_TypeDefinitionIndex = 41032;
