...
#define MOLEMOLE_TIMELINE_FIXCONTROLBEHAVIOR_METHOD_3_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0xC330340)
#define MOLEMOLE_TIMELINE_FIXCONTROLBEHAVIOR_METHOD_3_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xC330330)
#define MOLEMOLE_TIMELINE_FIXCONTROLBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0xC330270)
#define MOLEMOLE_TIMELINE_FIXCONTROLBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0xC3301E0)
#define MOLEMOLE_TIMELINE_FIXCONTROLBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC3302F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FixControlBehavior_TypeDefinitionIndex = 46196;
