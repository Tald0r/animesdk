...
#define MOLEMOLE_TIMELINE_TVTEXTURESHEETCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x8F4BB10)
#define MOLEMOLE_TIMELINE_TVTEXTURESHEETCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x8F4BB00)
#define MOLEMOLE_TIMELINE_TVTEXTURESHEETCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x8F4BD10)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSheetClip_TypeDefinitionIndex = 65100;
