...
#define MOLEMOLE_TIMELINE_TVTEXTURESHEETCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x9863A70)
#define MOLEMOLE_TIMELINE_TVTEXTURESHEETCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x9863A60)
#define MOLEMOLE_TIMELINE_TVTEXTURESHEETCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x9863C70)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSheetClip_TypeDefinitionIndex = 59786;
