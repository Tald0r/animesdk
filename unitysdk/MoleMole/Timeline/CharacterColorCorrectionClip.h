...
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8C8840)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8C8830)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8C8BC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterColorCorrectionClip_TypeDefinitionIndex = 48283;
