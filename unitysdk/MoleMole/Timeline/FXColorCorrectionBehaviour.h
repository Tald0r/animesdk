...
#include "unitysdk/MoleMole/Timeline/FXColorCorrectionBehaviour_Struct_2_52AD02145F5FCE3A_25.h"
...
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xA5428E0)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xA550480)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xA550470)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xA550490)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xA550460)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONBEHAVIOUR_METHOD_4_D2435584F0C6BA4D_OFFSET UNITYSDK_OFFSET(0xA543C90)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONBEHAVIOUR_METHOD_4_F53BAAE38A584428_OFFSET UNITYSDK_OFFSET(0xA544A50)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xA544050)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xA54C160)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xA54CBD0)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA550090)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FXColorCorrectionBehaviour_TypeDefinitionIndex = 69605;

	class FXColorCorrectionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::FXColorCorrectionBehaviour_Struct_2_52AD02145F5FCE3A_25 _methodParm; // 0x18
