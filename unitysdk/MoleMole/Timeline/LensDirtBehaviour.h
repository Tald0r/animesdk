...
#include "unitysdk/MoleMole/Timeline/LensDirtBehaviour_Struct_2_52AD02145F5FCE3A.h"
...
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x6B23900)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x6B25150)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_METHOD_4_46744B55F75226ED_OFFSET UNITYSDK_OFFSET(0x6B23BC0)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x6B240A0)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x6B25160)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x6B25170)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x6B25140)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x6B23F80)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x6B24AF0)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x6B24C90)
#define MOLEMOLE_TIMELINE_LENSDIRTBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x6B250F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LensDirtBehaviour_TypeDefinitionIndex = 36582;

	class LensDirtBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::LensDirtBehaviour_Struct_2_52AD02145F5FCE3A _methodParm; // 0x18
