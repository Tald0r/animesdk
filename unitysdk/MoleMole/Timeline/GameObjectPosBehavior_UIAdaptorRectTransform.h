...
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_UIADAPTORRECTTRANSFORM_REINITFROMRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A866E00)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_UIADAPTORRECTTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A866DF0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int GameObjectPosBehavior_UIAdaptorRectTransform_TypeDefinitionIndex = 29193;
