...
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_UIADAPTORRECTTRANSFORM_REINITFROMRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AE317B0)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSBEHAVIOR_UIADAPTORRECTTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE317A0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int GameObjectPosBehavior_UIAdaptorRectTransform_TypeDefinitionIndex = 30146;
