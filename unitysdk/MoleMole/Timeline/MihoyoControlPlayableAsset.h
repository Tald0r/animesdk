...
#define MOLEMOLE_TIMELINE_MIHOYOCONTROLPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB3D2E30)
#define MOLEMOLE_TIMELINE_MIHOYOCONTROLPLAYABLEASSET_METHOD_6_05ED597505047531_OFFSET UNITYSDK_OFFSET(0xB3D4FB0)
#define MOLEMOLE_TIMELINE_MIHOYOCONTROLPLAYABLEASSET_METHOD_6_22AC46E5805BE83F_OFFSET UNITYSDK_OFFSET(0xB3D4CE0)
#define MOLEMOLE_TIMELINE_MIHOYOCONTROLPLAYABLEASSET_METHOD_6_5F06DDD630BF6D19_OFFSET UNITYSDK_OFFSET(0xB3D45B0)
#define MOLEMOLE_TIMELINE_MIHOYOCONTROLPLAYABLEASSET_METHOD_6_6A991C592995A78A_OFFSET UNITYSDK_OFFSET(0xB3D4A30)
#define MOLEMOLE_TIMELINE_MIHOYOCONTROLPLAYABLEASSET_METHOD_6_98327DE548306CA0_OFFSET UNITYSDK_OFFSET(0xB3D3F20)
#define MOLEMOLE_TIMELINE_MIHOYOCONTROLPLAYABLEASSET_METHOD_6_DE1B6E378A62D004_OFFSET UNITYSDK_OFFSET(0xB3D4170)
#define MOLEMOLE_TIMELINE_MIHOYOCONTROLPLAYABLEASSET_METHOD_6_E47EEE8FF1774C6E_OFFSET UNITYSDK_OFFSET(0xB3D40C0)
#define MOLEMOLE_TIMELINE_MIHOYOCONTROLPLAYABLEASSET_METHOD_6_EE119400B0A814A8_OFFSET UNITYSDK_OFFSET(0xB3D4DF0)
#define MOLEMOLE_TIMELINE_MIHOYOCONTROLPLAYABLEASSET_METHOD_6_FD6EF60946CE2CE7_OFFSET UNITYSDK_OFFSET(0xB3D5210)
#define MOLEMOLE_TIMELINE_MIHOYOCONTROLPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xB3D4BB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MihoyoControlPlayableAsset_TypeDefinitionIndex = 45180;
