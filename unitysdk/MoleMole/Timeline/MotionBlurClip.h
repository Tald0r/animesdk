...
#define MOLEMOLE_TIMELINE_MOTIONBLURCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD839880)
#define MOLEMOLE_TIMELINE_MOTIONBLURCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD839870)
#define MOLEMOLE_TIMELINE_MOTIONBLURCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD839A60)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MotionBlurClip_TypeDefinitionIndex = 55632;
