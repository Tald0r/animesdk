...
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1AE31BC0)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1AE31BB0)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERPLAYABLEASSET_INITCLIP_OFFSET UNITYSDK_OFFSET(0x1AE31C90)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE31CB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SkinnedMeshRendererPlayableAsset_TypeDefinitionIndex = 30143;
