...
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1A867210)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1A867200)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERPLAYABLEASSET_INITCLIP_OFFSET UNITYSDK_OFFSET(0x1A8672F0)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A867310)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SkinnedMeshRendererPlayableAsset_TypeDefinitionIndex = 29190;
