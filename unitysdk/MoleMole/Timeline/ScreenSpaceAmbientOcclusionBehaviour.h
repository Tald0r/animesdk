...
#include "unitysdk/MoleMole/Timeline/ScreenSpaceAmbientOcclusionBehaviour_Struct_2_52AD02145F5FCE36_5.h"
...
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xA67C8B0)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_METHOD_4_136D252CBA9085C6_OFFSET UNITYSDK_OFFSET(0xA67CC20)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xA67F3E0)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xA67F3D0)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xA67F3F0)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xA67F3C0)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_METHOD_4_EEED34E9AAC26D51_OFFSET UNITYSDK_OFFSET(0xA67D1A0)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xA67CFE0)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xA67E9F0)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xA67EC30)
#define MOLEMOLE_TIMELINE_SCREENSPACEAMBIENTOCCLUSIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA67F350)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ScreenSpaceAmbientOcclusionBehaviour_TypeDefinitionIndex = 41238;

	class ScreenSpaceAmbientOcclusionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ScreenSpaceAmbientOcclusionBehaviour_Struct_2_52AD02145F5FCE36_5 _methodParm; // 0x18
