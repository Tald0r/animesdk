...
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVMOONCONFIG_METHOD_2_1374F5C8C30BDCEE_OFFSET UNITYSDK_OFFSET(0xD38BCB0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVMOONCONFIG_METHOD_2_167EDA53C47E20A4_OFFSET UNITYSDK_OFFSET(0xD38B770)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVMOONCONFIG_METHOD_2_24325C4D1CDD5758_OFFSET UNITYSDK_OFFSET(0xD38BC00)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVMOONCONFIG_METHOD_2_29DFCCC291F2C3F0_OFFSET UNITYSDK_OFFSET(0xD38B490)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVMOONCONFIG_METHOD_2_7144A3A3D733A906_OFFSET UNITYSDK_OFFSET(0xD38B9C0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVMOONCONFIG_METHOD_2_97FA89D8D3694CF1_OFFSET UNITYSDK_OFFSET(0xD38BC10)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVMOONCONFIG_METHOD_2_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0xD38B600)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVMOONCONFIG_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD38BBA0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVMOONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD38B9A0)

namespace MoleMole::Timeline::VisualEnvCompTracks
{
	inline static constexpr unsigned int VisualEnvMoonConfig_TypeDefinitionIndex = 59958;
