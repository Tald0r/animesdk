...
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONFIG_METHOD_2_1374F5C8C30BDCEE_OFFSET UNITYSDK_OFFSET(0xA556540)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONFIG_METHOD_2_171FCDDC6C47F867_OFFSET UNITYSDK_OFFSET(0xA5560D0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONFIG_METHOD_2_24325C4D1CDD5758_OFFSET UNITYSDK_OFFSET(0xA556490)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONFIG_METHOD_2_7FD1635A2D6EEB81_OFFSET UNITYSDK_OFFSET(0xA5562C0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONFIG_METHOD_2_97FA89D8D3694CF1_OFFSET UNITYSDK_OFFSET(0xA5564A0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONFIG_METHOD_2_B768DA94E3FD91D9_OFFSET UNITYSDK_OFFSET(0xA555F70)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONFIG_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA5565F0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONFIG_METHOD_2_F3A0B0CF16594F6F_OFFSET UNITYSDK_OFFSET(0xA555DE0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA5562A0)

namespace MoleMole::Timeline::VisualEnvCompTracks
{
	inline static constexpr unsigned int VisualEnvFogConfig_TypeDefinitionIndex = 40304;
