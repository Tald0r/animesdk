...
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVMOONCONTROLASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA4AD960)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVMOONCONTROLASSET_METHOD_4_2F2C11EE837C55A9_OFFSET UNITYSDK_OFFSET(0xA4ADB30)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVMOONCONTROLASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xA4ADAD0)

namespace MoleMole::Timeline::VisualEnvCompTracks
{
	inline static constexpr unsigned int VisualEnvMoonControlAsset_TypeDefinitionIndex = 77478;
