...
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONTROLASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD1ADA70)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONTROLASSET_METHOD_4_2F2C11EE837C55A9_OFFSET UNITYSDK_OFFSET(0xD1ADC40)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVFOGCONTROLASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xD1ADBE0)

namespace MoleMole::Timeline::VisualEnvCompTracks
{
	inline static constexpr unsigned int VisualEnvFogControlAsset_TypeDefinitionIndex = 56321;
