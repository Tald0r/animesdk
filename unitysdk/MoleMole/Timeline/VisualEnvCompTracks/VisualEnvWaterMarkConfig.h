...
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONFIG_METHOD_2_1374F5C8C30BDCEE_OFFSET UNITYSDK_OFFSET(0xB313CF0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONFIG_METHOD_2_24325C4D1CDD5758_OFFSET UNITYSDK_OFFSET(0xB313DA0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONFIG_METHOD_2_29DFCCC291F2C3F0_OFFSET UNITYSDK_OFFSET(0xB313520)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONFIG_METHOD_2_4C2226B1674A06C1_OFFSET UNITYSDK_OFFSET(0xB313A40)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONFIG_METHOD_2_6386111AF3985F9C_OFFSET UNITYSDK_OFFSET(0xB313770)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONFIG_METHOD_2_97FA89D8D3694CF1_OFFSET UNITYSDK_OFFSET(0xB313C50)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONFIG_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xB313670)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONFIG_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB313DB0)
#define MOLEMOLE_TIMELINE_VISUALENVCOMPTRACKS_VISUALENVWATERMARKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB313A20)

namespace MoleMole::Timeline::VisualEnvCompTracks
{
	inline static constexpr unsigned int VisualEnvWaterMarkConfig_TypeDefinitionIndex = 75272;
