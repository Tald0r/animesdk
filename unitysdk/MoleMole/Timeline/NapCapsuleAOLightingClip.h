...
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB9C4060)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB9C4050)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB9C4260)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int NapCapsuleAOLightingClip_TypeDefinitionIndex = 49641;
