...
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1A6C8450)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1A6C8440)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSPLAYABLEASSET_INITDATA_OFFSET UNITYSDK_OFFSET(0x1A6C8590)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6C85B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int GameObjectPosPlayableAsset_TypeDefinitionIndex = 29194;
