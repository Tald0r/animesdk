...
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1AC736B0)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1AC736A0)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSPLAYABLEASSET_INITDATA_OFFSET UNITYSDK_OFFSET(0x1AC737F0)
#define MOLEMOLE_TIMELINE_GAMEOBJECTPOSPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC73810)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int GameObjectPosPlayableAsset_TypeDefinitionIndex = 30147;
