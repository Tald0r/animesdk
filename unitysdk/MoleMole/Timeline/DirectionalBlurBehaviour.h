...
#include "unitysdk/MoleMole/Timeline/DirectionalBlurBehaviour_Struct_2_52AD02145F5FCE36_34.h"
...
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x6ED98C0)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x6EDAC40)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_4EB343AC19B8B5A0_OFFSET UNITYSDK_OFFSET(0x6ED9A80)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x6ED9F10)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x6EDAC30)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x6EDAC60)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x6EDAC50)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x6ED9E30)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x6EDA7D0)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x6EDA920)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x6EDABF0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DirectionalBlurBehaviour_TypeDefinitionIndex = 70592;

	class DirectionalBlurBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::DirectionalBlurBehaviour_Struct_2_52AD02145F5FCE36_34 _methodParm; // 0x18
