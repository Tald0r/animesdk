...
#include "unitysdk/MoleMole/Timeline/DirectionalBlurBehaviour_Struct_2_52AD02145F5FCE36_37.h"
...
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xD1A4D90)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xD1A6110)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_4EB343AC19B8B5A0_OFFSET UNITYSDK_OFFSET(0xD1A4F50)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0xD1A53E0)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xD1A6100)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xD1A6130)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xD1A6120)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xD1A5300)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD1A5CA0)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xD1A5DF0)
#define MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD1A60C0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DirectionalBlurBehaviour_TypeDefinitionIndex = 74282;

	class DirectionalBlurBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::DirectionalBlurBehaviour_Struct_2_52AD02145F5FCE36_37 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET))(this);
		}

		::UnityEngine::Rendering::Universal::DirectionalBlur* Method_4_4EB343AC19B8B5A0(::System::Object* a1)
		{
			return ((::UnityEngine::Rendering::Universal::DirectionalBlur*(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_DIRECTIONALBLURBEHAVIOUR_METHOD_4_4EB343AC19B8B5A0_OFFSET))(this, a1);
		}
