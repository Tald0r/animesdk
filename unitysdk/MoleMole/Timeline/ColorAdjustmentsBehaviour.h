...
#include "unitysdk/MoleMole/Timeline/ColorAdjustmentsBehaviour_Struct_2_52AD02145F5FCE3A_9.h"
...
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xB9BEAE0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xB9C1390)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_51E23932F40D6D69_OFFSET UNITYSDK_OFFSET(0xB9BEFA0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xB9C13A0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xB9C13B0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xB9C1380)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_F53BAAE38A584428_OFFSET UNITYSDK_OFFSET(0xB9BF560)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB9BF360)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB9C0930)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xB9C0BA0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB9C1300)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorAdjustmentsBehaviour_TypeDefinitionIndex = 46064;

	class ColorAdjustmentsBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ColorAdjustmentsBehaviour_Struct_2_52AD02145F5FCE3A_9 _methodParm; // 0x18
