...
#include "unitysdk/MoleMole/Timeline/ColorAdjustmentsBehaviour_Struct_2_52AD02145F5FCE3A_21.h"
...
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xD82EAA0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xD831360)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_51E23932F40D6D69_OFFSET UNITYSDK_OFFSET(0xD82EF60)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xD831350)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xD831370)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xD831340)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_F53BAAE38A584428_OFFSET UNITYSDK_OFFSET(0xD82F520)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xD82F320)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD8308F0)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xD830B60)
#define MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD8312C0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorAdjustmentsBehaviour_TypeDefinitionIndex = 65353;

	class ColorAdjustmentsBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ColorAdjustmentsBehaviour_Struct_2_52AD02145F5FCE3A_21 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_F53BAAE38A584428_OFFSET))(this);
		}
		...
		::UnityEngine::Rendering::Universal::ColorAdjustments* Method_4_51E23932F40D6D69(::System::Object* a1)
		{
			return ((::UnityEngine::Rendering::Universal::ColorAdjustments*(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_COLORADJUSTMENTSBEHAVIOUR_METHOD_4_51E23932F40D6D69_OFFSET))(this, a1);
		}
