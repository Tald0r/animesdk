...
#include "unitysdk/MoleMole/Timeline/AutoExposureBehaviour_Struct_2_52AD02145F5FCE36_24.h"
...
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xB3CD9C0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xB3CEF10)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0xB3CE0C0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xB3CEEF0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xB3CEF00)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xB3CEEE0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_D456E0234629494F_OFFSET UNITYSDK_OFFSET(0xB3CDC00)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB3CDFC0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB3CE9C0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xB3CEB30)
#define MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB3CEEA0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AutoExposureBehaviour_TypeDefinitionIndex = 62124;

	class AutoExposureBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::AutoExposureBehaviour_Struct_2_52AD02145F5FCE36_24 _methodParm; // 0x18
		...
		::UnityEngine::Rendering::Universal::AutoExposure* Method_4_D456E0234629494F(::System::Object* a1)
		{
			return ((::UnityEngine::Rendering::Universal::AutoExposure*(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_D456E0234629494F_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_AUTOEXPOSUREBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET))(this);
		}
