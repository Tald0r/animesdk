...
#define MOLEMOLE_TIMELINE_PARTIALBLURCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD83A0F0)
#define MOLEMOLE_TIMELINE_PARTIALBLURCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD83A0E0)
#define MOLEMOLE_TIMELINE_PARTIALBLURCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD83A2F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int PartialBlurClip_TypeDefinitionIndex = 63995;
