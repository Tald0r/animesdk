...
#define MOLEMOLE_TIMELINE_TVMATERIALTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB70F040)
#define MOLEMOLE_TIMELINE_TVMATERIALTRACK_METHOD_5_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xB70F410)
#define MOLEMOLE_TIMELINE_TVMATERIALTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB70F3E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVMaterialTrack_TypeDefinitionIndex = 72989;
