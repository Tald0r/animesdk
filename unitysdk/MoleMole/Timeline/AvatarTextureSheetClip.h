...
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA667310)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xA667300)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xA667510)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AvatarTextureSheetClip_TypeDefinitionIndex = 61794;
