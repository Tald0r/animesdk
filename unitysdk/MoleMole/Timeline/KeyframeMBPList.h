...
#define MOLEMOLE_TIMELINE_KEYFRAMEMBPLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA3790)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int KeyframeMBPList_TypeDefinitionIndex = 36805;
