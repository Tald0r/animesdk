...
#include "unitysdk/MoleMole/Timeline/ChannelMixerBehaviour_Struct_2_52AD02145F5FCE36_24.h"
...
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x8B7BC00)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x8B7D550)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x8B7C380)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x8B7D560)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x8B7D580)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x8B7D570)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_D3C1979E63256BA4_OFFSET UNITYSDK_OFFSET(0x8B7BE70)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x8B7C230)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x8B7CF10)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x8B7D0D0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x8B7D520)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ChannelMixerBehaviour_TypeDefinitionIndex = 65797;

	class ChannelMixerBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ChannelMixerBehaviour_Struct_2_52AD02145F5FCE36_24 _methodParm; // 0x18
