...
#include "unitysdk/MoleMole/Timeline/ChannelMixerBehaviour_Struct_2_52AD02145F5FCE36_38.h"
...
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x7F293F0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x7F2AD60)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x7F29B70)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x7F2AD40)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x7F2AD70)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x7F2AD50)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_D3C1979E63256BA4_OFFSET UNITYSDK_OFFSET(0x7F29660)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x7F29A20)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x7F2A700)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x7F2A8C0)
#define MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x7F2AD10)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ChannelMixerBehaviour_TypeDefinitionIndex = 77409;

	class ChannelMixerBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ChannelMixerBehaviour_Struct_2_52AD02145F5FCE36_38 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET))(this);
		}

		::UnityEngine::Rendering::Universal::ChannelMixer* Method_4_D3C1979E63256BA4(::System::Object* a1)
		{
			return ((::UnityEngine::Rendering::Universal::ChannelMixer*(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_CHANNELMIXERBEHAVIOUR_METHOD_4_D3C1979E63256BA4_OFFSET))(this, a1);
		}
