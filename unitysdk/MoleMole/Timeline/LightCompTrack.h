...
#define MOLEMOLE_TIMELINE_LIGHTCOMPTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD1AA800)
#define MOLEMOLE_TIMELINE_LIGHTCOMPTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0xD1AAA60)
#define MOLEMOLE_TIMELINE_LIGHTCOMPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xD1AAA30)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LightCompTrack_TypeDefinitionIndex = 77380;
