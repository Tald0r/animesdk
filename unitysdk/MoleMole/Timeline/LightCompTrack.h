...
#define MOLEMOLE_TIMELINE_LIGHTCOMPTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x6EDF730)
#define MOLEMOLE_TIMELINE_LIGHTCOMPTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x6EDF990)
#define MOLEMOLE_TIMELINE_LIGHTCOMPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x6EDF960)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LightCompTrack_TypeDefinitionIndex = 74095;
