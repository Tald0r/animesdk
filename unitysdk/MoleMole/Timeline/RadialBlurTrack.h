...
#define MOLEMOLE_TIMELINE_RADIALBLURTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x8FA3AB0)
#define MOLEMOLE_TIMELINE_RADIALBLURTRACK_METHOD_6_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0x8FA3D80)
#define MOLEMOLE_TIMELINE_RADIALBLURTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA3D50)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RadialBlurTrack_TypeDefinitionIndex = 65339;
