...
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_BAKEEXISTINGVOLUME_OFFSET UNITYSDK_OFFSET(0x7F36ED0)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_BAKEVOLUME_OFFSET UNITYSDK_OFFSET(0x7F35800)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_BLURSCATTERLEVEL_OFFSET UNITYSDK_OFFSET(0x7F34380)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_CALCULATESPOTDIRECTIONPOINTLIGHTS_OFFSET UNITYSDK_OFFSET(0x7F321C0)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_COMPOSEFINALCOLOR_OFFSET UNITYSDK_OFFSET(0x7F32B90)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_COMPUTEBLURREDEMISSIONVOLUME_OFFSET UNITYSDK_OFFSET(0x7F34EB0)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_COMPUTEINITIALEMISSIONVOLUME_OFFSET UNITYSDK_OFFSET(0x7F33B30)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_EVALSPOTDIRECTIONPOINTLIGHTS_OFFSET UNITYSDK_OFFSET(0x7F31190)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_GENERATEDENSITYLOD_OFFSET UNITYSDK_OFFSET(0x7F30C90)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_INITKERNEL_OFFSET UNITYSDK_OFFSET(0x7F30190)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7F37D50)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_06C5FF2B786D0828_OFFSET UNITYSDK_OFFSET(0x7F30A10)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_223FBB3600E44315_OFFSET UNITYSDK_OFFSET(0x7F31980)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_56731F34F9527C0F_OFFSET UNITYSDK_OFFSET(0x7F37760)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_6173AF17811AED4B_OFFSET UNITYSDK_OFFSET(0x7F34000)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_80A0160496D5F928_OFFSET UNITYSDK_OFFSET(0x7F33790)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_9147902B29E5FC51_OFFSET UNITYSDK_OFFSET(0x7F32AA0)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_B77B3A82EF12AAFA_OFFSET UNITYSDK_OFFSET(0x7F35A00)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_B87ABFDC088BA9E8_OFFSET UNITYSDK_OFFSET(0x7F37850)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_ED75E4E7234FB470_OFFSET UNITYSDK_OFFSET(0x7F370D0)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x7F37970)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x7F37910)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x7F379E0)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_RELEASE_OFFSET UNITYSDK_OFFSET(0x7F37190)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_RESET_OFFSET UNITYSDK_OFFSET(0x7F37A50)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_SETINPUTVOLUME_OFFSET UNITYSDK_OFFSET(0x7F30420)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_SETMATERIALTEXTURE_OFFSET UNITYSDK_OFFSET(0x7F36710)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME__CCTOR_OFFSET UNITYSDK_OFFSET(0x7F38080)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x7F37DC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int GasBakeVolume_TypeDefinitionIndex = 46350;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(GasBakeVolume_TypeDefinitionIndex)->GetStaticField(0x10190);
		}
		...
		::System::Void Method_5_80A0160496D5F928(::UnityEngine::Texture2D*& a1, ::UnityEngine::Gradient* a2)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Texture2D*&, ::UnityEngine::Gradient*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_80A0160496D5F928_OFFSET))(this, a1, a2);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::ComputeBuffer*&))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_B87ABFDC088BA9E8_OFFSET))(this, a1);
		}

		::System::Void Method_5_56731F34F9527C0F(::UnityEngine::RenderTexture*& a1)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::RenderTexture*&))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_56731F34F9527C0F_OFFSET))(this, a1);
		}

		::Il2CppArray<::System::Single>* Method_5_9147902B29E5FC51(::UnityEngine::Vector3 a1)
		{
			return ((::Il2CppArray<::System::Single>*(*)(::PVOID, ::UnityEngine::Vector3))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_9147902B29E5FC51_OFFSET))(this, a1);
		}
		...
		::System::Void Method_5_B77B3A82EF12AAFA(::UnityEngine::Rendering::CommandBuffer* a1)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Rendering::CommandBuffer*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_B77B3A82EF12AAFA_OFFSET))(this, a1);
		}

		::System::Void Method_5_6173AF17811AED4B()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_6173AF17811AED4B_OFFSET))(this);
		}

		::UnityEngine::RenderTexture* Method_5_06C5FF2B786D0828(::UnityEngine::RenderTexture* a1, ::UnityEngine::Vector3Int a2, ::UnityEngine::RenderTextureFormat a3, ::UnityEngine::RenderTextureReadWrite a4)
		{
			return ((::UnityEngine::RenderTexture*(*)(::PVOID, ::UnityEngine::RenderTexture*, ::UnityEngine::Vector3Int, ::UnityEngine::RenderTextureFormat, ::UnityEngine::RenderTextureReadWrite))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_06C5FF2B786D0828_OFFSET))(this, a1, a2, a3, a4);
		}
	};
}
