...
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_BAKEEXISTINGVOLUME_OFFSET UNITYSDK_OFFSET(0x8B89450)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_BAKEVOLUME_OFFSET UNITYSDK_OFFSET(0x8B87D80)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_BLURSCATTERLEVEL_OFFSET UNITYSDK_OFFSET(0x8B86900)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_CALCULATESPOTDIRECTIONPOINTLIGHTS_OFFSET UNITYSDK_OFFSET(0x8B84740)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_COMPOSEFINALCOLOR_OFFSET UNITYSDK_OFFSET(0x8B85110)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_COMPUTEBLURREDEMISSIONVOLUME_OFFSET UNITYSDK_OFFSET(0x8B87430)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_COMPUTEINITIALEMISSIONVOLUME_OFFSET UNITYSDK_OFFSET(0x8B860B0)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_EVALSPOTDIRECTIONPOINTLIGHTS_OFFSET UNITYSDK_OFFSET(0x8B83710)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_GENERATEDENSITYLOD_OFFSET UNITYSDK_OFFSET(0x8B83210)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_INITKERNEL_OFFSET UNITYSDK_OFFSET(0x8B82710)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8B8A2D0)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_06C5FF2B786D0828_OFFSET UNITYSDK_OFFSET(0x8B82F90)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_223FBB3600E44315_OFFSET UNITYSDK_OFFSET(0x8B83F00)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_56731F34F9527C0F_OFFSET UNITYSDK_OFFSET(0x8B89CE0)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_6173AF17811AED4B_OFFSET UNITYSDK_OFFSET(0x8B86580)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_80A0160496D5F928_OFFSET UNITYSDK_OFFSET(0x8B85D10)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_9147902B29E5FC51_OFFSET UNITYSDK_OFFSET(0x8B85020)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_B77B3A82EF12AAFA_OFFSET UNITYSDK_OFFSET(0x8B87F80)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_B87ABFDC088BA9E8_OFFSET UNITYSDK_OFFSET(0x8B89DD0)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_METHOD_5_ED75E4E7234FB470_OFFSET UNITYSDK_OFFSET(0x8B89650)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x8B89EF0)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8B89E90)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x8B89F60)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_RELEASE_OFFSET UNITYSDK_OFFSET(0x8B89710)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_RESET_OFFSET UNITYSDK_OFFSET(0x8B89FD0)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_SETINPUTVOLUME_OFFSET UNITYSDK_OFFSET(0x8B829A0)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME_SETMATERIALTEXTURE_OFFSET UNITYSDK_OFFSET(0x8B88C90)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME__CCTOR_OFFSET UNITYSDK_OFFSET(0x8B8A600)
#define MOLEMOLE_TIMELINE_GASBAKEVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x8B8A340)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int GasBakeVolume_TypeDefinitionIndex = 69883;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(GasBakeVolume_TypeDefinitionIndex)->GetStaticField(0x11880);
		}
