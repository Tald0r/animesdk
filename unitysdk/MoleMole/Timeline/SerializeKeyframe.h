...
#define MOLEMOLE_TIMELINE_SERIALIZEKEYFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0xA67F400)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SerializeKeyframe_TypeDefinitionIndex = 60182;
