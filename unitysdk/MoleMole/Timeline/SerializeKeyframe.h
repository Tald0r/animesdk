...
#define MOLEMOLE_TIMELINE_SERIALIZEKEYFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0xB3E6660)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SerializeKeyframe_TypeDefinitionIndex = 59022;
