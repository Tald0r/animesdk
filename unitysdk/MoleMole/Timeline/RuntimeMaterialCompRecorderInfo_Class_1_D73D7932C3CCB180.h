...
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_CLASS_1_D73D7932C3CCB180_METHOD_1_4770B1AF087E56D8_OFFSET UNITYSDK_OFFSET(0x67DCAA0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALCOMPRECORDERINFO_CLASS_1_D73D7932C3CCB180__CTOR_OFFSET UNITYSDK_OFFSET(0x67DCA90)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimeMaterialCompRecorderInfo_Class_1_D73D7932C3CCB180_TypeDefinitionIndex = 68200;
