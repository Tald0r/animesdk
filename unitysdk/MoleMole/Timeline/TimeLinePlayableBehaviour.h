...
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1A748D20)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_GET_DONTRESETACTIVE_OFFSET UNITYSDK_OFFSET(0x1A748CE0)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_GET_DONTRESETWHENDESTROY_OFFSET UNITYSDK_OFFSET(0x1A748CC0)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_GET_STOPPLAYABLEBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x1A748CD0)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1A748D10)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_SETTIMELINEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1A748CF0)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_SETVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A748E20)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A748D30)
#define MOLEMOLE_TIMELINE_TIMELINEPLAYABLEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A748E30)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TimeLinePlayableBehaviour_TypeDefinitionIndex = 29127;
