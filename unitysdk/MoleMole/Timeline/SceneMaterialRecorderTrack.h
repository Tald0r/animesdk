...
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1ACD3670)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1ACD37F0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACD38C0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SceneMaterialRecorderTrack_TypeDefinitionIndex = 30126;
