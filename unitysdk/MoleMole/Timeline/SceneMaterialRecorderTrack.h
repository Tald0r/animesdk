...
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1A72FF00)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1A730080)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A730150)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SceneMaterialRecorderTrack_TypeDefinitionIndex = 29173;
