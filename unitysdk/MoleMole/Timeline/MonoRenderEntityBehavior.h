...
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_METHOD_3_5F2840AE4F677063_OFFSET UNITYSDK_OFFSET(0xA4A6F40)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_METHOD_3_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0xA4A7170)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_METHOD_3_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xA4A6F30)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_METHOD_3_927B092C347D3361_OFFSET UNITYSDK_OFFSET(0xA4A6E30)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_METHOD_3_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xA4A70A0)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_METHOD_3_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xA4A6C40)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0xA4A6D60)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0xA4A6B70)
#define MOLEMOLE_TIMELINE_MONORENDERENTITYBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA4A6E10)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MonoRenderEntityBehavior_TypeDefinitionIndex = 46990;
