...
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_GETMESHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x7AA86C0)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_GETSCATTERPOINTS_OFFSET UNITYSDK_OFFSET(0x7AA8650)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_METHOD_5_29023BDC8A1D46E3_OFFSET UNITYSDK_OFFSET(0x7AA6500)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_METHOD_5_3E7B7DB0EDF962BA_OFFSET UNITYSDK_OFFSET(0x7AA62F0)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_METHOD_5_45138DD0E82F085A_OFFSET UNITYSDK_OFFSET(0x7AA7950)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_METHOD_5_AAE2380A4AD9C102_OFFSET UNITYSDK_OFFSET(0x7AA7E00)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x7AA8720)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x7AA8780)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_PROCESSMESH_OFFSET UNITYSDK_OFFSET(0x7AA60C0)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x7AA88E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MeshListToParticle_TypeDefinitionIndex = 46535;
