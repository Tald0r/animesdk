...
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_GETMESHTRANSFORM_OFFSET UNITYSDK_OFFSET(0xA4A53C0)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_GETSCATTERPOINTS_OFFSET UNITYSDK_OFFSET(0xA4A5350)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_METHOD_5_29023BDC8A1D46E3_OFFSET UNITYSDK_OFFSET(0xA4A3200)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_METHOD_5_3E7B7DB0EDF962BA_OFFSET UNITYSDK_OFFSET(0xA4A2FF0)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_METHOD_5_45138DD0E82F085A_OFFSET UNITYSDK_OFFSET(0xA4A4650)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_METHOD_5_AAE2380A4AD9C102_OFFSET UNITYSDK_OFFSET(0xA4A4B00)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA4A5420)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xA4A5480)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_PROCESSMESH_OFFSET UNITYSDK_OFFSET(0xA4A2DC0)
#define MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0xA4A55E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MeshListToParticle_TypeDefinitionIndex = 39699;
	...
	public:
		...
		::System::Boolean Method_5_29023BDC8A1D46E3(::System::Single a1, ::UnityEngine::GameObject* a2, ::System::Int32 a3)
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Single, ::UnityEngine::GameObject*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_MESHLISTTOPARTICLE_METHOD_5_29023BDC8A1D46E3_OFFSET))(this, a1, a2, a3);
		}
