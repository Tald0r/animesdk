...
#define MOLEMOLE_TIMELINE_MATERIALRECORDERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A72F3E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialRecorderBehavior_TypeDefinitionIndex = 29167;
