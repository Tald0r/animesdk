...
#include "unitysdk/MoleMole/Timeline/DepthOfFieldBehaviour_Struct_2_52AD02145F5FCE36_43.h"
...
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x8B7DEF0)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x8B807E0)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x8B807F0)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_A307B521288CF6B1_OFFSET UNITYSDK_OFFSET(0x8B7E260)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x8B807D0)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x8B807C0)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_METHOD_4_EEED34E9AAC26D51_OFFSET UNITYSDK_OFFSET(0x8B7E800)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x8B7E620)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x8B7FDA0)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x8B7FFF0)
#define MOLEMOLE_TIMELINE_DEPTHOFFIELDBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x8B80700)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DepthOfFieldBehaviour_TypeDefinitionIndex = 81055;

	class DepthOfFieldBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::DepthOfFieldBehaviour_Struct_2_52AD02145F5FCE36_43 _methodParm; // 0x18
