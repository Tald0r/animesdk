...
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD37C870)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD37C860)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD37CA70)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int NapContactShadowClip_TypeDefinitionIndex = 70097;
