...
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD45DCC0)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD45DCB0)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD45DEC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int NapContactShadowClip_TypeDefinitionIndex = 63814;
