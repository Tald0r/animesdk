...
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CANCUSTOMRECORD_OFFSET UNITYSDK_OFFSET(0xB5BC1A0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB5BB1C0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB5BC6C0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CUSTOMGETRECORDANIMCLIPIMP_OFFSET UNITYSDK_OFFSET(0xB5BC410)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CUSTOMGETSCENEGAMEOBJECTIMP_OFFSET UNITYSDK_OFFSET(0xB5BC310)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ERRORMSG_OFFSET UNITYSDK_OFFSET(0xB5BBF00)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0xB5BC800)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ISCUSTOMGETRECORDANIMCLIP_OFFSET UNITYSDK_OFFSET(0xB5BC3B0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ISCUSTOMGETSCENEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xB5BC2B0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_0B3E671DEF028216_OFFSET UNITYSDK_OFFSET(0xB5BB960)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0xB5BCAD0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0xB5BCB20)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xB5BCB60)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_7B61E867C49E0BFA_OFFSET UNITYSDK_OFFSET(0xB5BBCA0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xB5BCB10)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_9CA5A80F6B5B9E01_OFFSET UNITYSDK_OFFSET(0xB5BCAE0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_A0C3689E220BE4D5_OFFSET UNITYSDK_OFFSET(0xB5BCAB0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_BAF1B727A81278E6_OFFSET UNITYSDK_OFFSET(0xB5BCAC0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_BC46FCF99873D9DD_OFFSET UNITYSDK_OFFSET(0xB5BC140)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_CC634B4673437CA3_OFFSET UNITYSDK_OFFSET(0xB5BCAF0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0xB5BCAA0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_F0088C88851A7DFB_2_OFFSET UNITYSDK_OFFSET(0xB5BCB00)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xB5BCA90)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ONDUPLICATETRACK_OFFSET UNITYSDK_OFFSET(0xB5BC660)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ONMUTESTATECHANGE_OFFSET UNITYSDK_OFFSET(0xB5BC5F0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB5BCA60)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ZNetEffectTrack_TypeDefinitionIndex = 42187;
