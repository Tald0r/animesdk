...
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CANCUSTOMRECORD_OFFSET UNITYSDK_OFFSET(0xC7F4A90)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xC7F3AC0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xC7F4FB0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CUSTOMGETRECORDANIMCLIPIMP_OFFSET UNITYSDK_OFFSET(0xC7F4D00)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_CUSTOMGETSCENEGAMEOBJECTIMP_OFFSET UNITYSDK_OFFSET(0xC7F4C00)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ERRORMSG_OFFSET UNITYSDK_OFFSET(0xC7F47F0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0xC7F50F0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ISCUSTOMGETRECORDANIMCLIP_OFFSET UNITYSDK_OFFSET(0xC7F4CA0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ISCUSTOMGETSCENEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xC7F4BA0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_0B3E671DEF028216_OFFSET UNITYSDK_OFFSET(0xC7F4250)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0xC7F54C0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0xC7F5480)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xC7F5380)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_7B61E867C49E0BFA_OFFSET UNITYSDK_OFFSET(0xC7F4590)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xC7F5420)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_9CA5A80F6B5B9E01_OFFSET UNITYSDK_OFFSET(0xC7F54E0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_A0C3689E220BE4D5_OFFSET UNITYSDK_OFFSET(0xC7F5460)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_BAF1B727A81278E6_OFFSET UNITYSDK_OFFSET(0xC7F5430)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_BC46FCF99873D9DD_OFFSET UNITYSDK_OFFSET(0xC7F4A30)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_CC634B4673437CA3_OFFSET UNITYSDK_OFFSET(0xC7F54D0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0xC7F5450)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_F0088C88851A7DFB_2_OFFSET UNITYSDK_OFFSET(0xC7F5470)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xC7F5440)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ONDUPLICATETRACK_OFFSET UNITYSDK_OFFSET(0xC7F4F50)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_ONMUTESTATECHANGE_OFFSET UNITYSDK_OFFSET(0xC7F4EE0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xC7F5350)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ZNetEffectTrack_TypeDefinitionIndex = 73596;
	...
	public:
		...
		{
			return ((::UnityEngine::Playables::Playable(*)(::PVOID, ::UnityEngine::Playables::PlayableGraph, ::UnityEngine::GameObject*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_6CBA94B39B120DE0_OFFSET))(this, a1, a2, a3);
		}

		static ::System::Void Method_5_7B61E867C49E0BFA(::UnityEngine::Timeline::TimelineClip* a1, ::System::Single a2)
		{
			return ((::System::Void(*)(::UnityEngine::Timeline::TimelineClip*, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_7B61E867C49E0BFA_OFFSET))(a1, a2);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Playables::PlayableDirector*, ::UnityEngine::Timeline::IPropertyCollector*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_BAF1B727A81278E6_OFFSET))(this, a1, a2);
		}
		...
		::System::Void Method_5_A0C3689E220BE4D5(::System::Boolean a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_A0C3689E220BE4D5_OFFSET))(this, a1);
		}
		...
		static ::System::Single Method_5_0B3E671DEF028216(::MoleMole::EffectSimulate::NapEffectSimulatorMgr* a1, ::MoleMole::Timeline::ZNetEffectPlayableAsset* a2)
		{
			return ((::System::Single(*)(::MoleMole::EffectSimulate::NapEffectSimulatorMgr*, ::MoleMole::Timeline::ZNetEffectPlayableAsset*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_ZNETEFFECTTRACK_METHOD_5_0B3E671DEF028216_OFFSET))(a1, a2);
		}
