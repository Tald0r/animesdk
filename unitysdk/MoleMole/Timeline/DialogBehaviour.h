...
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_GET_CANPLAYSUBTITLE_OFFSET UNITYSDK_OFFSET(0xC26C700)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_1_OFFSET UNITYSDK_OFFSET(0xC26CB50)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_2_OFFSET UNITYSDK_OFFSET(0xC26CB60)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xC26CB40)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0xC26CBE0)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0xC26CB70)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC26CB80)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0xC26CB30)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xC26C900)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xC26C850)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xC26C770)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xC26C7E0)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xC26CAB0)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xC26C9B0)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xC26CB20)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DialogBehaviour_TypeDefinitionIndex = 58329;
