...
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_GET_CANPLAYSUBTITLE_OFFSET UNITYSDK_OFFSET(0xC2410E0)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_1_OFFSET UNITYSDK_OFFSET(0xC241530)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_2_OFFSET UNITYSDK_OFFSET(0xC2415B0)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xC241510)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0xC2415A0)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0xC241520)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC241540)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0xC2415C0)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xC2412E0)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xC241230)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xC241150)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xC2411C0)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xC241490)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xC241390)
#define MOLEMOLE_TIMELINE_DIALOGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xC241500)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DialogBehaviour_TypeDefinitionIndex = 39816;
