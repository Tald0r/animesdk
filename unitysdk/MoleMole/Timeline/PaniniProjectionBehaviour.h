...
#include "unitysdk/MoleMole/Timeline/PaniniProjectionBehaviour_Struct_2_E658502528B7C034_2.h"
...
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x8F47030)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x8F47C80)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_METHOD_4_5EECA38C2DA6206B_OFFSET UNITYSDK_OFFSET(0x8F47170)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x8F475D0)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x8F47C90)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x8F47CA0)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x8F47C70)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x8F47520)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x8F479B0)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x8F47AE0)
#define MOLEMOLE_TIMELINE_PANINIPROJECTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x8F47C50)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int PaniniProjectionBehaviour_TypeDefinitionIndex = 57710;

	class PaniniProjectionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::PaniniProjectionBehaviour_Struct_2_E658502528B7C034_2 _methodParm; // 0x18
