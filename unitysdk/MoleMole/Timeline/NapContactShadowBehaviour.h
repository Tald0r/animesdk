...
#include "unitysdk/MoleMole/Timeline/NapContactShadowBehaviour_Struct_2_AA4EE15A8D4DB005_2.h"
...
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x67D99E0)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x67DA940)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x67DA960)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x67DA950)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x67DA930)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_D7B815BF9DA0748D_OFFSET UNITYSDK_OFFSET(0x67D9B40)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_E2BCD1B56132A826_OFFSET UNITYSDK_OFFSET(0x67D9FB0)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x67D9EF0)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x67DA600)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x67DA730)
#define MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x67DA910)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int NapContactShadowBehaviour_TypeDefinitionIndex = 51221;

	class NapContactShadowBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::NapContactShadowBehaviour_Struct_2_AA4EE15A8D4DB005_2 _methodParm; // 0x18
		...
		::UnityEngine::Rendering::Universal::NapContactShadow* Method_4_D7B815BF9DA0748D(::System::Object* a1)
		{
			return ((::UnityEngine::Rendering::Universal::NapContactShadow*(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_D7B815BF9DA0748D_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_NAPCONTACTSHADOWBEHAVIOUR_METHOD_4_E2BCD1B56132A826_OFFSET))(this);
		}
