...
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_DELETEANIMATIONFRAMES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A7480E0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_DELETEANIMATIONFRAMES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A748120)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_DELETEANIMATIONFRAMES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A747B60)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_DELETEANIMATIONFRAMES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A747B50)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialBaseBehavior_DeleteAnimationFrames_TypeDefinitionIndex = 29139;
