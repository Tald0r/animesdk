...
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_DELETEANIMATIONFRAMES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ACEBE00)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_DELETEANIMATIONFRAMES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ACEBE40)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_DELETEANIMATIONFRAMES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ACEB880)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_DELETEANIMATIONFRAMES__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACEB860)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialBaseBehavior_DeleteAnimationFrames_TypeDefinitionIndex = 30092;
