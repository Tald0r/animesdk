...
#define MOLEMOLE_TIMELINE_OVERRIDERADIALBLURCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD37CE70)
#define MOLEMOLE_TIMELINE_OVERRIDERADIALBLURCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD37CE60)
#define MOLEMOLE_TIMELINE_OVERRIDERADIALBLURCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD37D070)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int OverrideRadialBlurClip_TypeDefinitionIndex = 76826;
