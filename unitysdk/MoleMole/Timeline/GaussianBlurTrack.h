...
#define MOLEMOLE_TIMELINE_GAUSSIANBLURTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xC26D200)
#define MOLEMOLE_TIMELINE_GAUSSIANBLURTRACK_METHOD_6_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xC26D4D0)
#define MOLEMOLE_TIMELINE_GAUSSIANBLURTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xC26D4A0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int GaussianBlurTrack_TypeDefinitionIndex = 65859;
