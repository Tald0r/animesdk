...
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_METHOD_3_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x7F3B670)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x7F3B310)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_METHOD_3_885FFDF82166B31E_OFFSET UNITYSDK_OFFSET(0x7F3B130)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_METHOD_3_C5373F1C0C4425FC_OFFSET UNITYSDK_OFFSET(0x7F3B420)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x7F3B6E0)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x7F3B680)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x7F3B3B0)
#define MOLEMOLE_TIMELINE_WWISESWITCHBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x7F3B660)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WwiseSwitchBehaviour_TypeDefinitionIndex = 48518;
