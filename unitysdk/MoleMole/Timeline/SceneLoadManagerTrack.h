...
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xD220A50)
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERTRACK_METHOD_5_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xD220C00)
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xD220BD0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SceneLoadManagerTrack_TypeDefinitionIndex = 70059;
