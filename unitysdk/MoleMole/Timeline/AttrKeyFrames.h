...
#define MOLEMOLE_TIMELINE_ATTRKEYFRAMES__CTOR_OFFSET UNITYSDK_OFFSET(0xD1A46A0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AttrKeyFrames_TypeDefinitionIndex = 36807;
