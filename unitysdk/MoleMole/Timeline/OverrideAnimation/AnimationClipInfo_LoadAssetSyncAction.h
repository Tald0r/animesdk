...
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_LOADASSETSYNCACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A437E70)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_LOADASSETSYNCACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A437EA0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_LOADASSETSYNCACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A437930)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_LOADASSETSYNCACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A437920)

namespace MoleMole::Timeline::OverrideAnimation
{
	inline static constexpr unsigned int AnimationClipInfo_LoadAssetSyncAction_TypeDefinitionIndex = 29199;
