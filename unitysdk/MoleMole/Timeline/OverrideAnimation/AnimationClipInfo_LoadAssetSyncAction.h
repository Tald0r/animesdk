...
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_LOADASSETSYNCACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA03530)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_LOADASSETSYNCACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA03560)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_LOADASSETSYNCACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA02FF0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_LOADASSETSYNCACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA02FD0)

namespace MoleMole::Timeline::OverrideAnimation
{
	inline static constexpr unsigned int AnimationClipInfo_LoadAssetSyncAction_TypeDefinitionIndex = 30152;
