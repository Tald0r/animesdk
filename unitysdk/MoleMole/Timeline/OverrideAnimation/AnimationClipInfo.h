...
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1AF878E0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_LOADASSETSYNC_OFFSET UNITYSDK_OFFSET(0x1AF878F0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1AF87A00)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF87A60)

namespace MoleMole::Timeline::OverrideAnimation
{
	inline static constexpr unsigned int AnimationClipInfo_TypeDefinitionIndex = 29198;
	...
	public:
		...
		{
			return (::MoleMole::Timeline::OverrideAnimation::AnimationClipInfo_UnloadAction**)Il2CppClass::FromTypeDefinitionIndex(AnimationClipInfo_TypeDefinitionIndex)->GetStaticField(0x22D60);
		}
		static ::MoleMole::Timeline::OverrideAnimation::AnimationClipInfo_LoadAssetSyncAction** StaticGet_LoadAssetSyncD()
		{
			return (::MoleMole::Timeline::OverrideAnimation::AnimationClipInfo_LoadAssetSyncAction**)Il2CppClass::FromTypeDefinitionIndex(AnimationClipInfo_TypeDefinitionIndex)->GetStaticField(0x22D68);
		}
