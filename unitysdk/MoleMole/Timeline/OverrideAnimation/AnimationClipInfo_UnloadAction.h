...
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_UNLOADACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B40B320)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_UNLOADACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B40B350)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_UNLOADACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B40AE20)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_UNLOADACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40AE00)

namespace MoleMole::Timeline::OverrideAnimation
{
	inline static constexpr unsigned int AnimationClipInfo_UnloadAction_TypeDefinitionIndex = 30153;
