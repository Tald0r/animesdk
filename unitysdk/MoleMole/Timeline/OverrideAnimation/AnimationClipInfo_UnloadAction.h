...
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_UNLOADACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADEAB90)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_UNLOADACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADEABC0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_UNLOADACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADEA690)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_ANIMATIONCLIPINFO_UNLOADACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADEA680)

namespace MoleMole::Timeline::OverrideAnimation
{
	inline static constexpr unsigned int AnimationClipInfo_UnloadAction_TypeDefinitionIndex = 29200;
