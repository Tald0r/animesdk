...
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A73E930)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A73E980)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A73E630)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A73E620)

namespace MoleMole::Timeline::OverrideAnimation
{
	inline static constexpr unsigned int ConfigSkinMapAnimationClipData_GetSkinIDAction_TypeDefinitionIndex = 29197;
