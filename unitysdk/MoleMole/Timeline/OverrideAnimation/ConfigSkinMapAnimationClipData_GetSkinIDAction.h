...
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ACE2660)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ACE26B0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ACE2370)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETSKINIDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACE2350)

namespace MoleMole::Timeline::OverrideAnimation
{
	inline static constexpr unsigned int ConfigSkinMapAnimationClipData_GetSkinIDAction_TypeDefinitionIndex = 30150;
