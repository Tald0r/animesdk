...
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETANIMATIONCLIP_1_OFFSET UNITYSDK_OFFSET(0x1AB598B0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0x1AB590E0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA_GETUNITANIMATIONCLIPS_OFFSET UNITYSDK_OFFSET(0x1AB594F0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB59CB0)
#define MOLEMOLE_TIMELINE_OVERRIDEANIMATION_CONFIGSKINMAPANIMATIONCLIPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB59CA0)

namespace MoleMole::Timeline::OverrideAnimation
{
	inline static constexpr unsigned int ConfigSkinMapAnimationClipData_TypeDefinitionIndex = 29196;
	...
	public:
		...
		{
			return (::MoleMole::Timeline::OverrideAnimation::ConfigSkinMapAnimationClipData_GetSkinIDAction**)Il2CppClass::FromTypeDefinitionIndex(ConfigSkinMapAnimationClipData_TypeDefinitionIndex)->GetStaticField(0x22780);
		}
