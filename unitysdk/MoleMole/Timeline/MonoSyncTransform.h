...
#define MOLEMOLE_TIMELINE_MONOSYNCTRANSFORM_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD839200)
#define MOLEMOLE_TIMELINE_MONOSYNCTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xD8394E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MonoSyncTransform_TypeDefinitionIndex = 54976;
