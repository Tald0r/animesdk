...
#define MOLEMOLE_TIMELINE_MONOSYNCTRANSFORM_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB9C3780)
#define MOLEMOLE_TIMELINE_MONOSYNCTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xB9C3A60)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MonoSyncTransform_TypeDefinitionIndex = 74503;
