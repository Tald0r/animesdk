...
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD44C760)
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD44C750)
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD44C960)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int HandleAdditiveSceneClip_TypeDefinitionIndex = 45548;
