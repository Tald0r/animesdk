...
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1ACE18C0)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1ACE2090)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1ACE1E20)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1ACE21B0)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1ACE1F50)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_SELECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1ACE15E0)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACE22D0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MultiRendererBehavior_TypeDefinitionIndex = 30138;
