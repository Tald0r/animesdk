...
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1A73DB90)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1A73E360)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1A73E0F0)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1A73E480)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1A73E220)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR_SELECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A73D8A0)
#define MOLEMOLE_TIMELINE_MULTIRENDERERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A73E5A0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MultiRendererBehavior_TypeDefinitionIndex = 29185;
