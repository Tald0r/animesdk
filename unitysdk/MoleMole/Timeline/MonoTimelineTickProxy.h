...
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x67D8360)
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x67D8140)
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY_METHOD_5_4867D67F27947ACE_OFFSET UNITYSDK_OFFSET(0x67D81D0)
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x67D7CF0)
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x67D8590)
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x67D84C0)
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY_METHOD_5_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x67D8520)
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x67D8460)
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY_METHOD_5_F7E674C1303ACB5B_OFFSET UNITYSDK_OFFSET(0x67D7F60)
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x67D80E0)
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x67D7D90)
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY_REFRESHTIMESCALE_OFFSET UNITYSDK_OFFSET(0x67D83C0)
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY_START_OFFSET UNITYSDK_OFFSET(0x67D7BF0)
#define MOLEMOLE_TIMELINE_MONOTIMELINETICKPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x67D8440)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MonoTimelineTickProxy_TypeDefinitionIndex = 47076;
