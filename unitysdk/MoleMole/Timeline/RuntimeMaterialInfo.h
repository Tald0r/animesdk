...
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_GET_MESHRENDERER_OFFSET UNITYSDK_OFFSET(0xA66E340)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_GET__MATERIALPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0xA66E350)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_03C9423DB0AB525F_OFFSET UNITYSDK_OFFSET(0xA673290)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0xA672020)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_0A94652C700DE681_OFFSET UNITYSDK_OFFSET(0xA676D80)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_157714A21849D308_OFFSET UNITYSDK_OFFSET(0xA67A680)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_2157CED3CDDF8996_1_OFFSET UNITYSDK_OFFSET(0xA66ED20)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_2157CED3CDDF8996_OFFSET UNITYSDK_OFFSET(0xA670B90)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_21B23FB7F45D62F4_OFFSET UNITYSDK_OFFSET(0xA672990)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_22A1AF9593D03312_OFFSET UNITYSDK_OFFSET(0xA67A380)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_28EB11670A8E5A86_OFFSET UNITYSDK_OFFSET(0xA674660)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_37EDB908C0475DE9_OFFSET UNITYSDK_OFFSET(0xA67A070)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_3DAF14EF0477A1DA_OFFSET UNITYSDK_OFFSET(0xA6752C0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_4618384FA3BBF17B_OFFSET UNITYSDK_OFFSET(0xA6777F0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_480B3AD7C7FF0861_OFFSET UNITYSDK_OFFSET(0xA672AF0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_48B6CD53C9BCBAE3_OFFSET UNITYSDK_OFFSET(0xA674240)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_4AB78CEA4D660760_OFFSET UNITYSDK_OFFSET(0xA67A230)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_4B374FDE77243500_OFFSET UNITYSDK_OFFSET(0xA6748C0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_5160A6048C9530CE_OFFSET UNITYSDK_OFFSET(0xA66E8A0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_631B7E4F0A611ADD_OFFSET UNITYSDK_OFFSET(0xA6769E0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_64DBA18F795F9555_OFFSET UNITYSDK_OFFSET(0xA67B9B0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_6675531D375F235D_OFFSET UNITYSDK_OFFSET(0xA678720)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_6AFDBBB08FAC598D_OFFSET UNITYSDK_OFFSET(0xA673880)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_7C4776284A6A3539_OFFSET UNITYSDK_OFFSET(0xA6705C0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_94B4E8244AAA5FFE_OFFSET UNITYSDK_OFFSET(0xA678450)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0xA67A7C0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_9773ABD3DD8F7AA4_OFFSET UNITYSDK_OFFSET(0xA6750F0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_992C4981A31A4392_OFFSET UNITYSDK_OFFSET(0xA674450)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_A47F69FAF411C04C_OFFSET UNITYSDK_OFFSET(0xA673140)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_ABE7715DB28B2DD1_OFFSET UNITYSDK_OFFSET(0xA674A60)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_AEB85D9249402975_OFFSET UNITYSDK_OFFSET(0xA66E820)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_BB1ADEF6A5975F1D_OFFSET UNITYSDK_OFFSET(0xA6734F0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_C73125933564EC44_OFFSET UNITYSDK_OFFSET(0xA6786A0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xA6741D0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA678610)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_CD1D8725807FDBA7_OFFSET UNITYSDK_OFFSET(0xA6774E0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_CD8EB704BDED69B6_OFFSET UNITYSDK_OFFSET(0xA6724E0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_DFA330684A0231AB_OFFSET UNITYSDK_OFFSET(0xA677FD0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_ED34DCC6F6541B09_OFFSET UNITYSDK_OFFSET(0xA6723F0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_F55104B9B863B6F0_OFFSET UNITYSDK_OFFSET(0xA670770)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO_METHOD_1_F96B1C7229DF29DF_OFFSET UNITYSDK_OFFSET(0xA67A520)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0xA6700A0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA66FD00)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA66E410)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimeMaterialInfo_TypeDefinitionIndex = 80458;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeMaterialInfo_TypeDefinitionIndex)->GetStaticField(0x40500);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_colorSubKey()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeMaterialInfo_TypeDefinitionIndex)->GetStaticField(0x40508);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Material*, ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Boolean>*>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeMaterialInfo_TypeDefinitionIndex)->GetStaticField(0x40510);
		}
		static ::System::Collections::Generic::List_1<::System::Int32>** StaticGet_properties()
		{
			return (::System::Collections::Generic::List_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeMaterialInfo_TypeDefinitionIndex)->GetStaticField(0x40518);
		}
		static ::System::Collections::Generic::List_1<::System::String*>** StaticGet_PreZKeyWordList()
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeMaterialInfo_TypeDefinitionIndex)->GetStaticField(0x40520);
		}
		static ::System::Collections::Generic::List_1<::System::String*>** StaticGet_SkipFloatKeys()
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeMaterialInfo_TypeDefinitionIndex)->GetStaticField(0x40528);
		}
		static ::System::Collections::Generic::List_1<::System::String*>** StaticGet_AoParamPropertyList()
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeMaterialInfo_TypeDefinitionIndex)->GetStaticField(0x40530);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Material*, ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Boolean>*>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeMaterialInfo_TypeDefinitionIndex)->GetStaticField(0x40538);
		}
		static ::System::Reflection::MethodInfo** StaticGet_addInstanceMaterialPathMethod()
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(RuntimeMaterialInfo_TypeDefinitionIndex)->GetStaticField(0x40540);
		}
		static ::System::Collections::Generic::List_1<::System::String*>** StaticGet_SpShaderPassList()
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RuntimeMaterialInfo_TypeDefinitionIndex)->GetStaticField(0x40548);
		}
