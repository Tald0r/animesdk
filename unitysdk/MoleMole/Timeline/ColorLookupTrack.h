...
#define MOLEMOLE_TIMELINE_COLORLOOKUPTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB8CB0A0)
#define MOLEMOLE_TIMELINE_COLORLOOKUPTRACK_METHOD_6_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xB8CB370)
#define MOLEMOLE_TIMELINE_COLORLOOKUPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB8CB340)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorLookupTrack_TypeDefinitionIndex = 62987;
