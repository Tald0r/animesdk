...
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB70E0E0)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB70E0D0)
#define MOLEMOLE_TIMELINE_SCREENSPACEREFLECTIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB70E2E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ScreenSpaceReflectionClip_TypeDefinitionIndex = 43159;
