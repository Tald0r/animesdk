...
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B59A9B0)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B59A9A0)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_GET_RECORDER_OFFSET UNITYSDK_OFFSET(0x1B59A930)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_INITDATA_OFFSET UNITYSDK_OFFSET(0x1B59A940)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_RELOADGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B59A990)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET_REVERTATTR_OFFSET UNITYSDK_OFFSET(0x1B59AAA0)
#define MOLEMOLE_TIMELINE_MATERIALBASEPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B59AAF0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialBasePlayableAsset_TypeDefinitionIndex = 30096;
