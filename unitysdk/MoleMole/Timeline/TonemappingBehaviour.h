...
#include "unitysdk/MoleMole/Timeline/TonemappingBehaviour_Struct_2_52AD02145F5FCE36_11.h"
...
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xA681BF0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xA6831B0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0xA6822D0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xA683190)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_73FD77060B8CE016_OFFSET UNITYSDK_OFFSET(0xA681E00)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xA6831A0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xA683180)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xA6821C0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xA682C60)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xA682DE0)
#define MOLEMOLE_TIMELINE_TONEMAPPINGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA683150)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TonemappingBehaviour_TypeDefinitionIndex = 45112;

	class TonemappingBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::TonemappingBehaviour_Struct_2_52AD02145F5FCE36_11 _methodParm; // 0x18
