...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEMAP_GETSKINANDACCESSORYCONFIG_OFFSET UNITYSDK_OFFSET(0xA6809C0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEMAP_REBIND_OFFSET UNITYSDK_OFFSET(0xA680C80)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xA6816A0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEMAP__REBIND_G__BINDGOTOTACK_4_0_OFFSET UNITYSDK_OFFSET(0xA6814A0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineMap_TypeDefinitionIndex = 58612;
