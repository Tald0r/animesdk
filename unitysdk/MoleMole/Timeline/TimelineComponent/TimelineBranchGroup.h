...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_GET_BRANCHTRACK_OFFSET UNITYSDK_OFFSET(0xB312210)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_0BDFAC56E6B704CB_1_OFFSET UNITYSDK_OFFSET(0xB312970)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0xB312340)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_1290EA767C459179_1_OFFSET UNITYSDK_OFFSET(0xB3124A0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_1290EA767C459179_2_OFFSET UNITYSDK_OFFSET(0xB312870)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xB312230)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP_METHOD_1_3016C1136D90757E_OFFSET UNITYSDK_OFFSET(0xB3125A0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_TIMELINEBRANCHGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xB312220)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int TimelineBranchGroup_TypeDefinitionIndex = 62951;
