...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_APPLYBRANCHGROUP_OFFSET UNITYSDK_OFFSET(0xA4ABF30)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_APPLYTRACKSTATES_OFFSET UNITYSDK_OFFSET(0xA4ACAF0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_CLEARALLTRACKRUNTIMEMUTE_OFFSET UNITYSDK_OFFSET(0xA4AC400)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_CLEARSELFALLTRACKRUNTIMEMUTE_OFFSET UNITYSDK_OFFSET(0xA4AC540)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETACTIVEGROUPNAME_OFFSET UNITYSDK_OFFSET(0xA4ACCF0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETALLBRANCHGROUPNAMES_OFFSET UNITYSDK_OFFSET(0xA4ACD50)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETBRANCHGROUP_OFFSET UNITYSDK_OFFSET(0xA4ACF40)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETBRANCHPLAYABLEDIRECTORS_OFFSET UNITYSDK_OFFSET(0xA4ABDB0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GET_BRANCHGROUPDIC_OFFSET UNITYSDK_OFFSET(0xA4AB5D0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_INITIALIZEBRANCHGROUPS_OFFSET UNITYSDK_OFFSET(0xA4AB8E0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA4AB870)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_RESETALLTRACKSTATES_OFFSET UNITYSDK_OFFSET(0xA4AC810)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_SET_BRANCHGROUPDIC_OFFSET UNITYSDK_OFFSET(0xA4AB860)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_SWITCHBRANCH_OFFSET UNITYSDK_OFFSET(0xA4AC150)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_UPDATEBRANCHGROUPS_OFFSET UNITYSDK_OFFSET(0xA4AB5F0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AD070)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineBranchManager_TypeDefinitionIndex = 78450;
