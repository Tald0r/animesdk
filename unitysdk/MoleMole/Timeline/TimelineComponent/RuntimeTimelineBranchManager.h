...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_APPLYBRANCHGROUP_OFFSET UNITYSDK_OFFSET(0xD221FB0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_APPLYTRACKSTATES_OFFSET UNITYSDK_OFFSET(0xD222B40)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_CLEARALLTRACKRUNTIMEMUTE_OFFSET UNITYSDK_OFFSET(0xD222470)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_CLEARSELFALLTRACKRUNTIMEMUTE_OFFSET UNITYSDK_OFFSET(0xD2225B0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETACTIVEGROUPNAME_OFFSET UNITYSDK_OFFSET(0xD222D40)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETALLBRANCHGROUPNAMES_OFFSET UNITYSDK_OFFSET(0xD222DA0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETBRANCHGROUP_OFFSET UNITYSDK_OFFSET(0xD222F90)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GETBRANCHPLAYABLEDIRECTORS_OFFSET UNITYSDK_OFFSET(0xD221E30)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_GET_BRANCHGROUPDIC_OFFSET UNITYSDK_OFFSET(0xD221650)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_INITIALIZEBRANCHGROUPS_OFFSET UNITYSDK_OFFSET(0xD221960)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD2218F0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_RESETALLTRACKSTATES_OFFSET UNITYSDK_OFFSET(0xD222870)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_SET_BRANCHGROUPDIC_OFFSET UNITYSDK_OFFSET(0xD2218E0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_SWITCHBRANCH_OFFSET UNITYSDK_OFFSET(0xD2221C0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER_UPDATEBRANCHGROUPS_OFFSET UNITYSDK_OFFSET(0xD221670)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEBRANCHMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD2230C0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineBranchManager_TypeDefinitionIndex = 74319;
