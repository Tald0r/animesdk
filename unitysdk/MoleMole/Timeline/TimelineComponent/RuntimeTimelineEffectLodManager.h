...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_COLLECTPARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0xB3E7260)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_START_OFFSET UNITYSDK_OFFSET(0xB3E7A80)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_UPDATELOD_OFFSET UNITYSDK_OFFSET(0xB3E77A0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xB3E7AF0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineEffectLodManager_TypeDefinitionIndex = 37452;
