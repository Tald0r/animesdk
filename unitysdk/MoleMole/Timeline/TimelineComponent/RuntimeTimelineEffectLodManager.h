...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_COLLECTPARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0xA680000)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_START_OFFSET UNITYSDK_OFFSET(0xA680820)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER_UPDATELOD_OFFSET UNITYSDK_OFFSET(0xA680540)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEEFFECTLODMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA680890)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineEffectLodManager_TypeDefinitionIndex = 78750;
