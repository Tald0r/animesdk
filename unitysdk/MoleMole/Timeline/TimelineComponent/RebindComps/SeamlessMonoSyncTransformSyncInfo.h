...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO_INITBASEINFO_OFFSET UNITYSDK_OFFSET(0x8B8BD80)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO_INITINFO_OFFSET UNITYSDK_OFFSET(0x8B8BED0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x8B8C060)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8B8BD40)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8B8BD20)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO___BASE_INITBASEINFO_OFFSET UNITYSDK_OFFSET(0x8B8C430)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_SEAMLESSMONOSYNCTRANSFORMSYNCINFO___BASE_REBIND_OFFSET UNITYSDK_OFFSET(0x8B8C4C0)

namespace MoleMole::Timeline::TimelineComponent::RebindComps
{
	inline static constexpr unsigned int SeamlessMonoSyncTransformSyncInfo_TypeDefinitionIndex = 75505;
