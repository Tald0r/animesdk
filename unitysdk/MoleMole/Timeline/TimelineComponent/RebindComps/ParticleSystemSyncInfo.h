...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_PARTICLESYSTEMSYNCINFO_CHECKISVALID_OFFSET UNITYSDK_OFFSET(0xB9CCB60)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_PARTICLESYSTEMSYNCINFO_INITINFO_OFFSET UNITYSDK_OFFSET(0xB9CC3D0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_PARTICLESYSTEMSYNCINFO_REBIND_OFFSET UNITYSDK_OFFSET(0xB9CC580)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_PARTICLESYSTEMSYNCINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0xB9CC3A0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_PARTICLESYSTEMSYNCINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB9CC370)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_PARTICLESYSTEMSYNCINFO___BASE_CHECKISVALID_OFFSET UNITYSDK_OFFSET(0xB9CCFA0)

namespace MoleMole::Timeline::TimelineComponent::RebindComps
{
	inline static constexpr unsigned int ParticleSystemSyncInfo_TypeDefinitionIndex = 44849;
