...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_MONOSYNCTRANSFORMSYNCINFO_INITINFO_OFFSET UNITYSDK_OFFSET(0xA492DA0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_MONOSYNCTRANSFORMSYNCINFO_REBIND_OFFSET UNITYSDK_OFFSET(0xA492F50)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_MONOSYNCTRANSFORMSYNCINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA492D80)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_REBINDCOMPS_MONOSYNCTRANSFORMSYNCINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA492D60)

namespace MoleMole::Timeline::TimelineComponent::RebindComps
{
	inline static constexpr unsigned int MonoSyncTransformSyncInfo_TypeDefinitionIndex = 53135;
