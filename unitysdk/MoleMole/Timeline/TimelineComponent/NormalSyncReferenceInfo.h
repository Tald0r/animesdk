...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_NORMALSYNCREFERENCEINFO_CHECKISVALID_OFFSET UNITYSDK_OFFSET(0x8CA90D0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_NORMALSYNCREFERENCEINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x8CA8F30)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_NORMALSYNCREFERENCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8CA8EF0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_NORMALSYNCREFERENCEINFO___BASE_CHECKISVALID_OFFSET UNITYSDK_OFFSET(0x8CA9300)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int NormalSyncReferenceInfo_TypeDefinitionIndex = 49066;
