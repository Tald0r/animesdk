...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_CLEAR_OFFSET UNITYSDK_OFFSET(0xC331580)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_GETROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC332180)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_GETSEAMLESSGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0xC332B50)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_GET_PDCOMP_OFFSET UNITYSDK_OFFSET(0xC331480)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC332BC0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_REBINDNONSEAMLESS_OFFSET UNITYSDK_OFFSET(0xC3317F0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_REBINDSEAMLESS_1_OFFSET UNITYSDK_OFFSET(0xC332400)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_REBINDSEAMLESS_OFFSET UNITYSDK_OFFSET(0xC332270)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_SETOVERRIDEROOT_OFFSET UNITYSDK_OFFSET(0xC331510)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP__CTOR_OFFSET UNITYSDK_OFFSET(0xC332C90)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineRebindComp_TypeDefinitionIndex = 62887;
