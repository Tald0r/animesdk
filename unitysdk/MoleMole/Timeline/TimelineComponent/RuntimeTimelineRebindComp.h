...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_CLEAR_OFFSET UNITYSDK_OFFSET(0x8FA49B0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_GETROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x8FA55B0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_GETSEAMLESSGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x8FA5F90)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_GET_PDCOMP_OFFSET UNITYSDK_OFFSET(0x8FA48B0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8FA6000)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_REBINDNONSEAMLESS_OFFSET UNITYSDK_OFFSET(0x8FA4C20)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_REBINDSEAMLESS_1_OFFSET UNITYSDK_OFFSET(0x8FA5830)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_REBINDSEAMLESS_OFFSET UNITYSDK_OFFSET(0x8FA56A0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP_SETOVERRIDEROOT_OFFSET UNITYSDK_OFFSET(0x8FA4940)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_RUNTIMETIMELINEREBINDCOMP__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA60D0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int RuntimeTimelineRebindComp_TypeDefinitionIndex = 40034;
