...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSTRACKBINDINFO_GETSYNCENTITYTAGID_OFFSET UNITYSDK_OFFSET(0x7F3A030)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSTRACKBINDINFO_GET_REFERENCENAME_OFFSET UNITYSDK_OFFSET(0x7F39FB0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSTRACKBINDINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x7F3A3B0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSTRACKBINDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x7F3A7A0)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int SeamlessTrackBindInfo_TypeDefinitionIndex = 67732;
