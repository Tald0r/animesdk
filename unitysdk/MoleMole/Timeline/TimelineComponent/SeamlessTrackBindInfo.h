...
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSTRACKBINDINFO_GETSYNCENTITYTAGID_OFFSET UNITYSDK_OFFSET(0x8B8C5B0)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSTRACKBINDINFO_GET_REFERENCENAME_OFFSET UNITYSDK_OFFSET(0x8B8C530)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSTRACKBINDINFO_REBIND_OFFSET UNITYSDK_OFFSET(0x8B8C930)
#define MOLEMOLE_TIMELINE_TIMELINECOMPONENT_SEAMLESSTRACKBINDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8B8CD20)

namespace MoleMole::Timeline::TimelineComponent
{
	inline static constexpr unsigned int SeamlessTrackBindInfo_TypeDefinitionIndex = 51762;
