...
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_CHECKANDUPDATEMATERIALS_OFFSET UNITYSDK_OFFSET(0x1B189560)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_CHECKISSCREENMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B185770)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_CHECKMATERIALINDEXVALID_OFFSET UNITYSDK_OFFSET(0x1B188060)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_CLEARFRAMEALTERS_OFFSET UNITYSDK_OFFSET(0x1B186D30)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_FINDPROPERTYALTERS_OFFSET UNITYSDK_OFFSET(0x1B1860F0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GETATTRALTERS_OFFSET UNITYSDK_OFFSET(0x1B1887D0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GETFRAMETIMES_OFFSET UNITYSDK_OFFSET(0x1B187810)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1B186500)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GETMULTIMATERIALPATTERN_OFFSET UNITYSDK_OFFSET(0x1B188120)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1B189190)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GET_INSTANCEMATERIALS_OFFSET UNITYSDK_OFFSET(0x1B184DF0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1B1872C0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RECORDERFRAMES_OFFSET UNITYSDK_OFFSET(0x1B1875F0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RECORDERMATERIALLEN_OFFSET UNITYSDK_OFFSET(0x1B189280)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RECORDMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1B185120)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RECOVERFRAME_OFFSET UNITYSDK_OFFSET(0x1B186F70)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RECOVERMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1B185780)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RELOADMESHRENDERERCHANGE_OFFSET UNITYSDK_OFFSET(0x1B185EE0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RELOADMESHRENDERERUNCHANGE_OFFSET UNITYSDK_OFFSET(0x1B185DB0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_RELOADMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x1B185AC0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_REVERTATTRALTERS_OFFSET UNITYSDK_OFFSET(0x1B189180)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_REVERTATTR_OFFSET UNITYSDK_OFFSET(0x1B186DD0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_REVERTSOURCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B185480)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_UPDATEADDEDMATERIALINFO_OFFSET UNITYSDK_OFFSET(0x1B1893B0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_UPDATEALTERS_OFFSET UNITYSDK_OFFSET(0x1B187EF0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO_UPDATEMATERIALONINSPECTORGUI_OFFSET UNITYSDK_OFFSET(0x1B1873B0)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B189840)
#define MOLEMOLE_TIMELINE_MATERIALCOMPRECORDERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B184FC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialCompRecorderInfo_TypeDefinitionIndex = 30098;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialCompRecorderInfo_TypeDefinitionIndex)->GetStaticField(0x24080);
		}
		static ::System::Collections::Generic::List_1<::System::String*>** StaticGet_MultiMaterialKeyList()
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialCompRecorderInfo_TypeDefinitionIndex)->GetStaticField(0x24088);
		}
		static ::System::Int32* StaticGet_layerIdColor()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MaterialCompRecorderInfo_TypeDefinitionIndex)->GetStaticField(0x78C0);
		}
