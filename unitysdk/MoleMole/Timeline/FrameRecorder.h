...
#define MOLEMOLE_TIMELINE_FRAMERECORDER_CLEARDATA_OFFSET UNITYSDK_OFFSET(0x1ADAA130)
#define MOLEMOLE_TIMELINE_FRAMERECORDER_GETMATERIALKEY_OFFSET UNITYSDK_OFFSET(0x1ADAC300)
#define MOLEMOLE_TIMELINE_FRAMERECORDER_RECORDERFRAMEINFO_OFFSET UNITYSDK_OFFSET(0x1ADAA260)
#define MOLEMOLE_TIMELINE_FRAMERECORDER_RECORDERFRAME_OFFSET UNITYSDK_OFFSET(0x1ADAA230)
#define MOLEMOLE_TIMELINE_FRAMERECORDER_SETINSTANCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1ADAB250)
#define MOLEMOLE_TIMELINE_FRAMERECORDER_SETMATERIALPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1ADAAB30)
#define MOLEMOLE_TIMELINE_FRAMERECORDER_UPDATEINSTANCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1ADAB190)
#define MOLEMOLE_TIMELINE_FRAMERECORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADAC3C0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FrameRecorder_TypeDefinitionIndex = 29132;
