...
#define MOLEMOLE_TIMELINE_VISUALENVCONTROLTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA4D6940)
#define MOLEMOLE_TIMELINE_VISUALENVCONTROLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA4D67C0)
#define MOLEMOLE_TIMELINE_VISUALENVCONTROLTRACK_METHOD_6_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0xA4D6C30)
#define MOLEMOLE_TIMELINE_VISUALENVCONTROLTRACK_METHOD_6_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xA4D6C70)
#define MOLEMOLE_TIMELINE_VISUALENVCONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA4D6C00)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VisualEnvControlTrack_TypeDefinitionIndex = 50135;
