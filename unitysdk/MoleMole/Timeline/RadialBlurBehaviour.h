...
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xBEF4B30)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xBEF7BE0)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_3E106EB9A8888BCB_OFFSET UNITYSDK_OFFSET(0xBEF4F40)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xBEF7BC0)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xBEF7BD0)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xBEF7BB0)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_METHOD_4_EEED34E9AAC26D51_OFFSET UNITYSDK_OFFSET(0xBEF5530)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xBEF5300)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xBEF6F90)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xBEF7230)
#define MOLEMOLE_TIMELINE_RADIALBLURBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xBEF7AE0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RadialBlurBehaviour_TypeDefinitionIndex = 62160;
