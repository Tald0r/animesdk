...
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1ACD3B90)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1ACD3B40)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERPLAYABLEASSET_INITDATA_OFFSET UNITYSDK_OFFSET(0x1ACD3B50)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACD3C60)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SourceMaterialRecorderPlayableAsset_TypeDefinitionIndex = 30129;
