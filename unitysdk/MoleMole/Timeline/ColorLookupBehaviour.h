...
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xD44B5A0)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xD44C1E0)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0xD44BB40)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xD44C1D0)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xD44C1C0)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xD44C1B0)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_METHOD_4_CB4B5714D4DD6688_OFFSET UNITYSDK_OFFSET(0xD44B6E0)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xD44BA90)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD44BF20)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xD44C050)
#define MOLEMOLE_TIMELINE_COLORLOOKUPBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD44C190)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorLookupBehaviour_TypeDefinitionIndex = 80992;
