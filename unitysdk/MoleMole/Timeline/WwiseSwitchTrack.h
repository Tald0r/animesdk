...
#define MOLEMOLE_TIMELINE_WWISESWITCHTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB3EA7C0)
#define MOLEMOLE_TIMELINE_WWISESWITCHTRACK_METHOD_5_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xB3EAEA0)
#define MOLEMOLE_TIMELINE_WWISESWITCHTRACK_METHOD_5_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0xB3EACC0)
#define MOLEMOLE_TIMELINE_WWISESWITCHTRACK_METHOD_5_960032BA2E22793D_OFFSET UNITYSDK_OFFSET(0xB3EA9F0)
#define MOLEMOLE_TIMELINE_WWISESWITCHTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB3EA940)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WwiseSwitchTrack_TypeDefinitionIndex = 49830;
