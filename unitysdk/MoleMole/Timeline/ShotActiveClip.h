...
#define MOLEMOLE_TIMELINE_SHOTACTIVECLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x7F39170)
#define MOLEMOLE_TIMELINE_SHOTACTIVECLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x7F390E0)
#define MOLEMOLE_TIMELINE_SHOTACTIVECLIP_GET_CLIPTYPE_OFFSET UNITYSDK_OFFSET(0x7F390F0)
#define MOLEMOLE_TIMELINE_SHOTACTIVECLIP_METHOD_5_0043BC75B602D2E3_OFFSET UNITYSDK_OFFSET(0x7F39450)
#define MOLEMOLE_TIMELINE_SHOTACTIVECLIP_METHOD_5_8281A73B45B1EA1A_OFFSET UNITYSDK_OFFSET(0x7F394C0)
#define MOLEMOLE_TIMELINE_SHOTACTIVECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x7F393F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ShotActiveClip_TypeDefinitionIndex = 40318;
