...
#include "unitysdk/MoleMole/Timeline/CharacterColorCorrectionBehaviour_Struct_2_52AD02145F5FCE3A_29.h"
...
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xB703610)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_1_OFFSET UNITYSDK_OFFSET(0xB70A7C0)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xB70A790)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xB70A780)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_80313B77C31AD02B_OFFSET UNITYSDK_OFFSET(0xB7049C0)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xB70A7B0)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xB70A7A0)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_METHOD_4_BEBCAFF53057C562_OFFSET UNITYSDK_OFFSET(0xB7040A0)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xB7034F0)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB704460)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB708240)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xB708820)
#define MOLEMOLE_TIMELINE_CHARACTERCOLORCORRECTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB70A590)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterColorCorrectionBehaviour_TypeDefinitionIndex = 79664;

	class CharacterColorCorrectionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::CharacterColorCorrectionBehaviour_Struct_2_52AD02145F5FCE3A_29 _methodParm; // 0x18
