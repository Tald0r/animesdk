...
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_05BF0F202AD17366_OFFSET UNITYSDK_OFFSET(0x8A98A90)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0x8A98930)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x8A99720)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_3AA20A0DA6990FBE_OFFSET UNITYSDK_OFFSET(0x8A98F10)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_5A89F090AC5C6BC6_OFFSET UNITYSDK_OFFSET(0x8A99350)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_6103E5D7CF046E3B_OFFSET UNITYSDK_OFFSET(0x8A97130)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0x8A99730)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_891AE2223A8E0EF9_OFFSET UNITYSDK_OFFSET(0x8A97550)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0x8A99270)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_A5809AB80389F7DE_OFFSET UNITYSDK_OFFSET(0x8A97870)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_C8E2469222842786_OFFSET UNITYSDK_OFFSET(0x8A97480)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x8A992F0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8A97420)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_D109CE569415FA03_1_OFFSET UNITYSDK_OFFSET(0x8A98230)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_D109CE569415FA03_OFFSET UNITYSDK_OFFSET(0x8A985B0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0x8A97310)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_METHOD_2_F620DD2FD48DDF53_OFFSET UNITYSDK_OFFSET(0x8A97390)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x8A965B0)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0x8A97000)
#define MOLEMOLE_TIMELINE_AVATARTEXTURESHEETBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x8A96F20)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AvatarTextureSheetBehaviour_TypeDefinitionIndex = 75350;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::MoleMole::Timeline::AvatarTextureSheetBehaviour*>*>**)Il2CppClass::FromTypeDefinitionIndex(AvatarTextureSheetBehaviour_TypeDefinitionIndex)->GetStaticField(0x2C930);
		}
		static ::System::String** StaticGet_TvIconTextureSheetRoot()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(AvatarTextureSheetBehaviour_TypeDefinitionIndex)->GetStaticField(0x2C938);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::MoleMole::Timeline::AvatarTextureSheetBehaviour*>*>**)Il2CppClass::FromTypeDefinitionIndex(AvatarTextureSheetBehaviour_TypeDefinitionIndex)->GetStaticField(0x2C940);
		}
		...
		::Class_2_208CC9941471731A_281* templateConfig; // 0x68
