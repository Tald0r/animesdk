...
#include "unitysdk/MoleMole/Timeline/GlitchBehaviour_Struct_2_52AD02145F5FCE3A_7.h"
...
#define MOLEMOLE_TIMELINE_GLITCHBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x67CEA10)
#define MOLEMOLE_TIMELINE_GLITCHBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x67D3530)
#define MOLEMOLE_TIMELINE_GLITCHBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x67D3540)
#define MOLEMOLE_TIMELINE_GLITCHBEHAVIOUR_METHOD_4_6B07BC4E43DB3C44_OFFSET UNITYSDK_OFFSET(0x67CF240)
#define MOLEMOLE_TIMELINE_GLITCHBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x67D3520)
#define MOLEMOLE_TIMELINE_GLITCHBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x67D3510)
#define MOLEMOLE_TIMELINE_GLITCHBEHAVIOUR_METHOD_4_EEED34E9AAC26D51_OFFSET UNITYSDK_OFFSET(0x67CF9A0)
#define MOLEMOLE_TIMELINE_GLITCHBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x67CF600)
#define MOLEMOLE_TIMELINE_GLITCHBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x67D2140)
#define MOLEMOLE_TIMELINE_GLITCHBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x67D2550)
#define MOLEMOLE_TIMELINE_GLITCHBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x67D3420)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int GlitchBehaviour_TypeDefinitionIndex = 45190;

	class GlitchBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::GlitchBehaviour_Struct_2_52AD02145F5FCE3A_7 _methodParm; // 0x18
