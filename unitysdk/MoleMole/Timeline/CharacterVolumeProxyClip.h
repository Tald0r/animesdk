...
#define MOLEMOLE_TIMELINE_CHARACTERVOLUMEPROXYCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA4A28A0)
#define MOLEMOLE_TIMELINE_CHARACTERVOLUMEPROXYCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xA4A2890)
#define MOLEMOLE_TIMELINE_CHARACTERVOLUMEPROXYCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xA4A2AA0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterVolumeProxyClip_TypeDefinitionIndex = 73604;
