...
#define MOLEMOLE_TIMELINE_RUNTIMEKEYFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A437EB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimeKeyFrame_TypeDefinitionIndex = 29134;
