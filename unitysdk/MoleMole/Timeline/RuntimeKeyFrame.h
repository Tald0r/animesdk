...
#define MOLEMOLE_TIMELINE_RUNTIMEKEYFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA03570)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimeKeyFrame_TypeDefinitionIndex = 30087;
