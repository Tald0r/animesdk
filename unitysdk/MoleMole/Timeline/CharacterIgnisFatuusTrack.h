...
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xD1A4A20)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSTRACK_METHOD_6_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xD1A4CF0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xD1A4CC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterIgnisFatuusTrack_TypeDefinitionIndex = 58435;
