...
#define MOLEMOLE_TIMELINE_LOOPSUBDIVISIONDATAHOLDERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x994B090)
#define MOLEMOLE_TIMELINE_LOOPSUBDIVISIONDATAHOLDERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x994B080)
#define MOLEMOLE_TIMELINE_LOOPSUBDIVISIONDATAHOLDERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x994B280)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LoopSubdivisionDataHolderClip_TypeDefinitionIndex = 39968;
