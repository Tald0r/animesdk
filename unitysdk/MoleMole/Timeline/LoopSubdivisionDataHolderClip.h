...
#define MOLEMOLE_TIMELINE_LOOPSUBDIVISIONDATAHOLDERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xC7DEBA0)
#define MOLEMOLE_TIMELINE_LOOPSUBDIVISIONDATAHOLDERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xC7DEB90)
#define MOLEMOLE_TIMELINE_LOOPSUBDIVISIONDATAHOLDERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xC7DED90)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LoopSubdivisionDataHolderClip_TypeDefinitionIndex = 48344;
