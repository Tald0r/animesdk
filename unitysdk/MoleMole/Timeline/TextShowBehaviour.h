...
#define MOLEMOLE_TIMELINE_TEXTSHOWBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0x8F4BE20)
#define MOLEMOLE_TIMELINE_TEXTSHOWBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x8F4BD70)
#define MOLEMOLE_TIMELINE_TEXTSHOWBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x8F4BE10)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TextShowBehaviour_TypeDefinitionIndex = 43698;
