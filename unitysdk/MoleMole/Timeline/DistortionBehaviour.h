...
#include "unitysdk/MoleMole/Timeline/DistortionBehaviour_Struct_2_52AD02145F5FCE36_20.h"
...
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x8B80800)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x8B82110)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x8B82120)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_970DD0C46A33229F_OFFSET UNITYSDK_OFFSET(0x8B80A20)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_AE828D899505A3B4_OFFSET UNITYSDK_OFFSET(0x8B80EF0)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x8B82140)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x8B82130)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x8B80DE0)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x8B81B90)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x8B81D10)
#define MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x8B820F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int DistortionBehaviour_TypeDefinitionIndex = 58982;

	class DistortionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::DistortionBehaviour_Struct_2_52AD02145F5FCE36_20 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_DISTORTIONBEHAVIOUR_METHOD_4_AE828D899505A3B4_OFFSET))(this);
		}
