...
#define MOLEMOLE_TIMELINE_FIXCONTROLPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB93A510)
#define MOLEMOLE_TIMELINE_FIXCONTROLPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB93A500)
#define MOLEMOLE_TIMELINE_FIXCONTROLPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xB93A680)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FixControlPlayableAsset_TypeDefinitionIndex = 67398;
