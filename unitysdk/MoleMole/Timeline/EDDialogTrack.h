...
#define MOLEMOLE_TIMELINE_EDDIALOGTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x7F2FBD0)
#define MOLEMOLE_TIMELINE_EDDIALOGTRACK_METHOD_5_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0x7F2FD80)
#define MOLEMOLE_TIMELINE_EDDIALOGTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x7F2FD50)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int EDDialogTrack_TypeDefinitionIndex = 61953;
