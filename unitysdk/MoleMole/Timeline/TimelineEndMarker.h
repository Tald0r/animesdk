...
#define MOLEMOLE_TIMELINE_TIMELINEENDMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0xB3E8DB0)
#define MOLEMOLE_TIMELINE_TIMELINEENDMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0xB3E8E10)
#define MOLEMOLE_TIMELINE_TIMELINEENDMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0xB3E8D40)
#define MOLEMOLE_TIMELINE_TIMELINEENDMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0xB3E8E20)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TimelineEndMarker_TypeDefinitionIndex = 57872;
