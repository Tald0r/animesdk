...
#include "unitysdk/MoleMole/Timeline/ColorCurvesBehaviour_Struct_2_52AD02145F5FCE3A_3.h"
...
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xB8C9A30)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xB8CB060)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_345410654E10FA57_OFFSET UNITYSDK_OFFSET(0xB8C9C80)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0xB8CA190)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xB8CB080)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xB8CB090)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xB8CB070)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB8CA040)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB8CAC20)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xB8CADE0)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB8CB050)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorCurvesBehaviour_TypeDefinitionIndex = 40072;

	class ColorCurvesBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ColorCurvesBehaviour_Struct_2_52AD02145F5FCE3A_3 _methodParm; // 0x18
