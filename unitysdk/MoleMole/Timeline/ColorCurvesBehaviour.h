...
#include "unitysdk/MoleMole/Timeline/ColorCurvesBehaviour_Struct_2_52AD02145F5FCE3A_26.h"
...
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xB9377D0)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xB938E10)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_345410654E10FA57_OFFSET UNITYSDK_OFFSET(0xB937A20)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0xB937F30)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xB938E00)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xB938E30)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xB938E20)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB937DE0)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB9389C0)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xB938B80)
#define MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB938DF0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ColorCurvesBehaviour_TypeDefinitionIndex = 69687;

	class ColorCurvesBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ColorCurvesBehaviour_Struct_2_52AD02145F5FCE3A_26 _methodParm; // 0x18
		...
		::UnityEngine::Rendering::Universal::ColorCurves* Method_4_345410654E10FA57(::System::Object* a1)
		{
			return ((::UnityEngine::Rendering::Universal::ColorCurves*(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_345410654E10FA57_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_COLORCURVESBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET))(this);
		}
