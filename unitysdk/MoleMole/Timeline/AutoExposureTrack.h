...
#define MOLEMOLE_TIMELINE_AUTOEXPOSURETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xBD609E0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSURETRACK_METHOD_6_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xBD60CB0)
#define MOLEMOLE_TIMELINE_AUTOEXPOSURETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xBD60C80)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int AutoExposureTrack_TypeDefinitionIndex = 38567;
