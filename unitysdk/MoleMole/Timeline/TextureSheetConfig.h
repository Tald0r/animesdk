...
#define MOLEMOLE_TIMELINE_TEXTURESHEETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA4AB5C0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TextureSheetConfig_TypeDefinitionIndex = 37926;
