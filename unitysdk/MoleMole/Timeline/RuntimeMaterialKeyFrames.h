...
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALKEYFRAMES_METHOD_1_EB476E77D9330246_OFFSET UNITYSDK_OFFSET(0x994BBB0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALKEYFRAMES__CTOR_OFFSET UNITYSDK_OFFSET(0x994BAD0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimeMaterialKeyFrames_TypeDefinitionIndex = 74694;
