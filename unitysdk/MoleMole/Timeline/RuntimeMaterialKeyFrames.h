...
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALKEYFRAMES_METHOD_1_EB476E77D9330246_OFFSET UNITYSDK_OFFSET(0xC7DF2D0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALKEYFRAMES__CTOR_OFFSET UNITYSDK_OFFSET(0xC7DF1F0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimeMaterialKeyFrames_TypeDefinitionIndex = 51957;
