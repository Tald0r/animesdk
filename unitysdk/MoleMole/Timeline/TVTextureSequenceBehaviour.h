...
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_0F30679B05E70FC1_OFFSET UNITYSDK_OFFSET(0xB70F6D0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xB7101C0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_60D9A75AE5CB1F8F_OFFSET UNITYSDK_OFFSET(0xB70FC40)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_61FC9C8A6106EA6A_OFFSET UNITYSDK_OFFSET(0xB710430)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_830C8E34300646A6_OFFSET UNITYSDK_OFFSET(0xB710150)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0xB710640)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xB710630)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_A2F71555A1437C8A_OFFSET UNITYSDK_OFFSET(0xB7101D0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_CC15D6CD4D3CC816_OFFSET UNITYSDK_OFFSET(0xB70F8C0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_ED01C45E2F8DB392_OFFSET UNITYSDK_OFFSET(0xB710420)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0xB70FE60)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB70FF40)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_ONPLAY_OFFSET UNITYSDK_OFFSET(0xB70F4B0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB70FCB0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB710110)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSequenceBehaviour_TypeDefinitionIndex = 80215;
	...
	public:
		...
		::Sirenix::OdinInspector::ValueDropdownList_1<::System::Int32>* Method_4_61FC9C8A6106EA6A()
		{
			return ((::Sirenix::OdinInspector::ValueDropdownList_1<::System::Int32>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEBEHAVIOUR_METHOD_4_61FC9C8A6106EA6A_OFFSET))(this);
		}
