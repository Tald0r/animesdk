...
class Class_2_044BCD66E5BB706C_Class_0_16E7307DCC43CB2C_9;
...
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_08BBACE844405300_OFFSET UNITYSDK_OFFSET(0xD46E270)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_1_OFFSET UNITYSDK_OFFSET(0xD46FA30)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_2_OFFSET UNITYSDK_OFFSET(0xD46FA50)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xD46F7F0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_58B9CB68ABC64928_OFFSET UNITYSDK_OFFSET(0xD46F490)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_637BB645FA4F6E89_OFFSET UNITYSDK_OFFSET(0xD46F800)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0xD46FA40)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0xD46FA20)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_81459141CB11ADC8_OFFSET UNITYSDK_OFFSET(0xD46F640)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_BE18C04CD91E0748_OFFSET UNITYSDK_OFFSET(0xD46F9B0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0xD46F7E0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_METHOD_2_E69AA2E64A20143D_OFFSET UNITYSDK_OFFSET(0xD46E750)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xD46E6A0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xD46E1C0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xD46D6A0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xD46DCC0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xD46F5B0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD46EAF0)
#define MOLEMOLE_TIMELINE_WWISEAUDIOBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD46F620)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WwiseAudioBehaviour_TypeDefinitionIndex = 60697;
	...
	public:
		...
		::Class_2_044BCD66E5BB706C_Class_0_16E7307DCC43CB2C_9* _subtitleViewer; // 0x70
