...
#define MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA7FB170)
#define MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xA7FB160)
#define MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSCLIP_METHOD_4_A4DFF492750B09F7_OFFSET UNITYSDK_OFFSET(0xA7FB340)
#define MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xA7FB2E0)

namespace MoleMole::Timeline::AvatarGraphics
{
	inline static constexpr unsigned int AvatarGraphicsClip_TypeDefinitionIndex = 68475;
	...
	public:
		...
		::System::Void Method_4_A4DFF492750B09F7(::MoleMole::UIAvatarGraphics* a1)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::UIAvatarGraphics*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_AVATARGRAPHICS_AVATARGRAPHICSCLIP_METHOD_4_A4DFF492750B09F7_OFFSET))(this, a1);
		}
	};
}
