...
#define MOLEMOLE_TIMELINE_MULTIRENDERERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1A867020)
#define MOLEMOLE_TIMELINE_MULTIRENDERERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1A867010)
#define MOLEMOLE_TIMELINE_MULTIRENDERERCLIP_GET_REFERENCES_OFFSET UNITYSDK_OFFSET(0x1A866FD0)
#define MOLEMOLE_TIMELINE_MULTIRENDERERCLIP_SET_REFERENCES_OFFSET UNITYSDK_OFFSET(0x1A866FF0)
#define MOLEMOLE_TIMELINE_MULTIRENDERERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A867120)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MultiRendererClip_TypeDefinitionIndex = 29186;
