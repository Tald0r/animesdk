...
#define MOLEMOLE_TIMELINE_VIGNETTETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xD844290)
#define MOLEMOLE_TIMELINE_VIGNETTETRACK_METHOD_6_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xD844560)
#define MOLEMOLE_TIMELINE_VIGNETTETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xD844530)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VignetteTrack_TypeDefinitionIndex = 69165;
