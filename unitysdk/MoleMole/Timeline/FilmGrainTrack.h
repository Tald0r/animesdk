...
#define MOLEMOLE_TIMELINE_FILMGRAINTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA5504A0)
#define MOLEMOLE_TIMELINE_FILMGRAINTRACK_METHOD_6_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xA550770)
#define MOLEMOLE_TIMELINE_FILMGRAINTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA550740)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FilmGrainTrack_TypeDefinitionIndex = 74708;
