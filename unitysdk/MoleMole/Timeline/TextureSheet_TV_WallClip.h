...
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB8D11A0)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB8D1190)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLCLIP_METHOD_4_0F2138E056F9294A_OFFSET UNITYSDK_OFFSET(0xB8D13E0)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLCLIP_METHOD_4_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xB8D1590)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLCLIP__CCTOR_OFFSET UNITYSDK_OFFSET(0xB8D1580)
#define MOLEMOLE_TIMELINE_TEXTURESHEET_TV_WALLCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB8D1520)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TextureSheet_TV_WallClip_TypeDefinitionIndex = 41487;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(TextureSheet_TV_WallClip_TypeDefinitionIndex)->GetStaticField(0xEE80);
		}
