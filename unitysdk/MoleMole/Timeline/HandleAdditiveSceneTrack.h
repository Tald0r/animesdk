...
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x994AE30)
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENETRACK_METHOD_5_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0x994AFE0)
#define MOLEMOLE_TIMELINE_HANDLEADDITIVESCENETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x994AFB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int HandleAdditiveSceneTrack_TypeDefinitionIndex = 56707;
