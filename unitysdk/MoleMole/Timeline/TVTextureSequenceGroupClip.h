...
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB9CBF40)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB9CBF30)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB9CC0B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSequenceGroupClip_TypeDefinitionIndex = 57889;
