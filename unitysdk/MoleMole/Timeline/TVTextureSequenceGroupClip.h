...
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD8419F0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD8419E0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD841B60)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSequenceGroupClip_TypeDefinitionIndex = 50880;
