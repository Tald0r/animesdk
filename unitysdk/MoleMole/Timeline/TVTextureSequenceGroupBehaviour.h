...
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xB9CBF20)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_60D9A75AE5CB1F8F_OFFSET UNITYSDK_OFFSET(0xB9CAF20)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_70589F89E4D22649_OFFSET UNITYSDK_OFFSET(0xB9CB990)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_7117F6276F27D578_OFFSET UNITYSDK_OFFSET(0xB9CBB10)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0xB9CBDD0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_79ED6854413CA2F4_2_OFFSET UNITYSDK_OFFSET(0xB9CBF10)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0xB9CBB00)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xB9CBDE0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0xB9CAAD0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_E5E342154D4EA5F5_OFFSET UNITYSDK_OFFSET(0xB9CBAF0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xB9CB2B0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xB9CA800)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB9CB710)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_PREPAREDATA_OFFSET UNITYSDK_OFFSET(0xB9CA760)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB9CAF90)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0xB9CB8F0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB9CB8E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSequenceGroupBehaviour_TypeDefinitionIndex = 70077;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::UnityEngine::Texture2D*>*>**)Il2CppClass::FromTypeDefinitionIndex(TVTextureSequenceGroupBehaviour_TypeDefinitionIndex)->GetStaticField(0x43030);
		}
		...
		::System::Collections::Generic::List_1<::UnityEngine::Texture2D*>* Method_4_7117F6276F27D578()
		{
			return ((::System::Collections::Generic::List_1<::UnityEngine::Texture2D*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_7117F6276F27D578_OFFSET))(this);
		}
		...
		::MoleMole::TextureSheetData* Method_4_60D9A75AE5CB1F8F()
		{
			return ((::MoleMole::TextureSheetData*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPBEHAVIOUR_METHOD_4_60D9A75AE5CB1F8F_OFFSET))(this);
		}
