...
#include "unitysdk/MoleMole/Timeline/UnsharpMaskBehaviour_Struct_2_52AD02145F5FCE36_6.h"
...
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xB9CD010)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xB9CE560)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xB9CE530)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_8BE8558572949051_OFFSET UNITYSDK_OFFSET(0xB9CD1E0)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xB9CE550)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xB9CE540)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_E2BCD1B56132A826_OFFSET UNITYSDK_OFFSET(0xB9CD680)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB9CD590)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB9CE0A0)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xB9CE200)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB9CE510)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int UnsharpMaskBehaviour_TypeDefinitionIndex = 41271;

	class UnsharpMaskBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::UnsharpMaskBehaviour_Struct_2_52AD02145F5FCE36_6 _methodParm; // 0x18
