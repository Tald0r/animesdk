...
#include "unitysdk/MoleMole/Timeline/UnsharpMaskBehaviour_Struct_2_52AD02145F5FCE36_32.h"
...
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xD842AC0)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xD844010)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xD843FF0)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_8BE8558572949051_OFFSET UNITYSDK_OFFSET(0xD842C90)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xD844000)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xD843FE0)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_E2BCD1B56132A826_OFFSET UNITYSDK_OFFSET(0xD843130)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xD843040)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD843B50)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xD843CB0)
#define MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD843FC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int UnsharpMaskBehaviour_TypeDefinitionIndex = 67335;

	class UnsharpMaskBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::UnsharpMaskBehaviour_Struct_2_52AD02145F5FCE36_32 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_E2BCD1B56132A826_OFFSET))(this);
		}

		::UnityEngine::Rendering::Universal::UnsharpMask* Method_4_8BE8558572949051(::System::Object* a1)
		{
			return ((::UnityEngine::Rendering::Universal::UnsharpMask*(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_UNSHARPMASKBEHAVIOUR_METHOD_4_8BE8558572949051_OFFSET))(this, a1);
		}
