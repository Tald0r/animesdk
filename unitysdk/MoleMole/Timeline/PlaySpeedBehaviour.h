...
#define MOLEMOLE_TIMELINE_PLAYSPEEDBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xC7DF1E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int PlaySpeedBehaviour_TypeDefinitionIndex = 61564;
