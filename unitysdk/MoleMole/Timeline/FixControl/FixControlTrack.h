...
#define MOLEMOLE_TIMELINE_FIXCONTROL_FIXCONTROLTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x8F45B70)
#define MOLEMOLE_TIMELINE_FIXCONTROL_FIXCONTROLTRACK_METHOD_5_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0x8F45D20)
#define MOLEMOLE_TIMELINE_FIXCONTROL_FIXCONTROLTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8F45CF0)

namespace MoleMole::Timeline::FixControl
{
	inline static constexpr unsigned int FixControlTrack_TypeDefinitionIndex = 41019;
