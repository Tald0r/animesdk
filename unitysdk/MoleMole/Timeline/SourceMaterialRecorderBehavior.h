...
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_CHECKMATERIALINDEXVALID_OFFSET UNITYSDK_OFFSET(0x1B5C4AC0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_CLEARFRAMEALTERS_OFFSET UNITYSDK_OFFSET(0x1B5C4570)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_FINDPROPERTYALTERS_OFFSET UNITYSDK_OFFSET(0x1B5C4820)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GETFRAMETIMES_OFFSET UNITYSDK_OFFSET(0x1B5C4E10)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1B5C3C20)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GETMULTIMATERIALPATTERN_OFFSET UNITYSDK_OFFSET(0x1B5C4A60)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1B5C37D0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GET_FRAMEENDTIME_OFFSET UNITYSDK_OFFSET(0x1B5C3920)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GET_FRAMESTARTTIME_OFFSET UNITYSDK_OFFSET(0x1B5C3830)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1B5C3770)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_INIT_OFFSET UNITYSDK_OFFSET(0x1B5C3A10)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_LOADKFRAMESFROMANIMATOR_OFFSET UNITYSDK_OFFSET(0x1B5C3A40)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1B5C3A70)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1B5C3A50)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B5C4610)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_RECORDERFRAMES_OFFSET UNITYSDK_OFFSET(0x1B5C4C20)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_RECORDER_OFFSET UNITYSDK_OFFSET(0x1B5C4560)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_RECOVERMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1B5C4460)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_UPDATEALTERS_OFFSET UNITYSDK_OFFSET(0x1B5C54F0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_UPDATEMATERIALONINSPECTORGUI_OFFSET UNITYSDK_OFFSET(0x1B5C3A90)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5C5640)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C5560)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SourceMaterialRecorderBehavior_TypeDefinitionIndex = 30127;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(SourceMaterialRecorderBehavior_TypeDefinitionIndex)->GetStaticField(0x24540);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>** StaticGet_MatchStrDic()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(SourceMaterialRecorderBehavior_TypeDefinitionIndex)->GetStaticField(0x24548);
		}
