...
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_CHECKMATERIALINDEXVALID_OFFSET UNITYSDK_OFFSET(0x1AFB4060)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_CLEARFRAMEALTERS_OFFSET UNITYSDK_OFFSET(0x1AFB3B10)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_FINDPROPERTYALTERS_OFFSET UNITYSDK_OFFSET(0x1AFB3DC0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GETFRAMETIMES_OFFSET UNITYSDK_OFFSET(0x1AFB43B0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GETKEYFRAMES_OFFSET UNITYSDK_OFFSET(0x1AFB31C0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GETMULTIMATERIALPATTERN_OFFSET UNITYSDK_OFFSET(0x1AFB4000)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1AFB2D70)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GET_FRAMEENDTIME_OFFSET UNITYSDK_OFFSET(0x1AFB2EC0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GET_FRAMESTARTTIME_OFFSET UNITYSDK_OFFSET(0x1AFB2DD0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1AFB2D10)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_INIT_OFFSET UNITYSDK_OFFSET(0x1AFB2FB0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_LOADKFRAMESFROMANIMATOR_OFFSET UNITYSDK_OFFSET(0x1AFB2FE0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1AFB3010)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1AFB2FF0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1AFB3BB0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_RECORDERFRAMES_OFFSET UNITYSDK_OFFSET(0x1AFB41C0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_RECORDER_OFFSET UNITYSDK_OFFSET(0x1AFB3B00)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_RECOVERMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1AFB3A00)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_UPDATEALTERS_OFFSET UNITYSDK_OFFSET(0x1AFB4A90)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR_UPDATEMATERIALONINSPECTORGUI_OFFSET UNITYSDK_OFFSET(0x1AFB3030)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFB4BE0)
#define MOLEMOLE_TIMELINE_SOURCEMATERIALRECORDERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFB4B00)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SourceMaterialRecorderBehavior_TypeDefinitionIndex = 29174;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(SourceMaterialRecorderBehavior_TypeDefinitionIndex)->GetStaticField(0x22C20);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>** StaticGet_MatchStrDic()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(SourceMaterialRecorderBehavior_TypeDefinitionIndex)->GetStaticField(0x22C28);
		}
