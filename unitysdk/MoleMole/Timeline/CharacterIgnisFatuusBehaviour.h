...
#include "unitysdk/MoleMole/Timeline/CharacterIgnisFatuusBehaviour_Struct_2_52AD02145F5FCE3A_6.h"
...
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x9858140)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_21D7417E6EFA9730_OFFSET UNITYSDK_OFFSET(0x98588B0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x985D810)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x985D7E0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_80313B77C31AD02B_OFFSET UNITYSDK_OFFSET(0x9859070)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x985D800)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x985D7F0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x9858C70)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x985C0D0)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x985C540)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x985D620)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterIgnisFatuusBehaviour_TypeDefinitionIndex = 44358;

	class CharacterIgnisFatuusBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::CharacterIgnisFatuusBehaviour_Struct_2_52AD02145F5FCE3A_6 _methodParm; // 0x18
