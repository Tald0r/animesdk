...
#include "unitysdk/MoleMole/Timeline/MotionBlurBehaviour_Struct_2_52AD02145F5FCE36_15.h"
...
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xA48D020)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xA48E3D0)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0xA48D690)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xA48E3F0)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_71B2B0457D9C4983_OFFSET UNITYSDK_OFFSET(0xA48D1F0)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xA48E3E0)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xA48E3C0)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xA48D5A0)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xA48DF10)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xA48E070)
#define MOLEMOLE_TIMELINE_MOTIONBLURBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xA48E380)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MotionBlurBehaviour_TypeDefinitionIndex = 50216;

	class MotionBlurBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::MotionBlurBehaviour_Struct_2_52AD02145F5FCE36_15 _methodParm; // 0x18
