...
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xD1A69B0)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xD1A69A0)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xD1A6BB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FXColorCorrectionClip_TypeDefinitionIndex = 71275;
