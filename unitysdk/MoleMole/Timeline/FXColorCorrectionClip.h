...
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x6EDB4E0)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x6EDB4D0)
#define MOLEMOLE_TIMELINE_FXCOLORCORRECTIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x6EDB6E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FXColorCorrectionClip_TypeDefinitionIndex = 72456;
