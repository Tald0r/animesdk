...
#define MOLEMOLE_TIMELINE_REALMESHRENDERERPARAMS_LAYERSELECT_OFFSET UNITYSDK_OFFSET(0x1A72F520)
#define MOLEMOLE_TIMELINE_REALMESHRENDERERPARAMS_SETSKINNEDMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x1A72FB90)
#define MOLEMOLE_TIMELINE_REALMESHRENDERERPARAMS_TRACINGLAYERSELECT_OFFSET UNITYSDK_OFFSET(0x1A72F630)
#define MOLEMOLE_TIMELINE_REALMESHRENDERERPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A72F9E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RealMeshRendererParams_TypeDefinitionIndex = 29182;
