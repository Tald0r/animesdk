...
#define MOLEMOLE_TIMELINE_REALMESHRENDERERPARAMS_LAYERSELECT_OFFSET UNITYSDK_OFFSET(0x1ACD2C40)
#define MOLEMOLE_TIMELINE_REALMESHRENDERERPARAMS_SETSKINNEDMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x1ACD3300)
#define MOLEMOLE_TIMELINE_REALMESHRENDERERPARAMS_TRACINGLAYERSELECT_OFFSET UNITYSDK_OFFSET(0x1ACD2D60)
#define MOLEMOLE_TIMELINE_REALMESHRENDERERPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACD3150)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RealMeshRendererParams_TypeDefinitionIndex = 30135;
