...
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERPARAMS_METHOD_1_37D3D9A3F3244B90_OFFSET UNITYSDK_OFFSET(0xA67C350)
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERPARAMS_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xA67C4E0)
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERPARAMS_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA67C480)
#define MOLEMOLE_TIMELINE_SCENELOADMANAGERPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xA67C340)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SceneLoadManagerParams_TypeDefinitionIndex = 56245;
