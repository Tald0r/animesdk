...
#include "unitysdk/MoleMole/Timeline/NAPBloomBehaviour_Struct_2_52AD02145F5FCE3A_21.h"
...
#define MOLEMOLE_TIMELINE_NAPBLOOMBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xD453F50)
#define MOLEMOLE_TIMELINE_NAPBLOOMBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xD45DC70)
#define MOLEMOLE_TIMELINE_NAPBLOOMBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xD45DCA0)
#define MOLEMOLE_TIMELINE_NAPBLOOMBEHAVIOUR_METHOD_4_AA2DC8D4971CD696_OFFSET UNITYSDK_OFFSET(0xD454CB0)
#define MOLEMOLE_TIMELINE_NAPBLOOMBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xD45DC90)
#define MOLEMOLE_TIMELINE_NAPBLOOMBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xD45DC80)
#define MOLEMOLE_TIMELINE_NAPBLOOMBEHAVIOUR_METHOD_4_EEED34E9AAC26D51_OFFSET UNITYSDK_OFFSET(0xD4558B0)
#define MOLEMOLE_TIMELINE_NAPBLOOMBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xD455070)
#define MOLEMOLE_TIMELINE_NAPBLOOMBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD45B110)
#define MOLEMOLE_TIMELINE_NAPBLOOMBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xD45B9C0)
#define MOLEMOLE_TIMELINE_NAPBLOOMBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD45D9E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int NAPBloomBehaviour_TypeDefinitionIndex = 58624;

	class NAPBloomBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::NAPBloomBehaviour_Struct_2_52AD02145F5FCE3A_21 _methodParm; // 0x18
