...
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_BASEONPAUSE_OFFSET UNITYSDK_OFFSET(0x1AB54230)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_BASEONPLAY_OFFSET UNITYSDK_OFFSET(0x1AB54210)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AB54280)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1AB54260)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1AB54250)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1AB54270)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB54290)

namespace MoleMole::Timeline::BaseTimeline
{
	inline static constexpr unsigned int BaseTimelineBehavior_TypeDefinitionIndex = 29204;
