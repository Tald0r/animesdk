...
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_BASEONPAUSE_OFFSET UNITYSDK_OFFSET(0x1B184C50)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_BASEONPLAY_OFFSET UNITYSDK_OFFSET(0x1B184C30)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B184CA0)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1B184C80)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1B184C70)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B184C90)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B184CB0)

namespace MoleMole::Timeline::BaseTimeline
{
	inline static constexpr unsigned int BaseTimelineBehavior_TypeDefinitionIndex = 30157;
