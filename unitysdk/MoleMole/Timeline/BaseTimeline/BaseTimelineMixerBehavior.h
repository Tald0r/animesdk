...
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEMIXERBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1B59A8A0)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEMIXERBEHAVIOR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1B59A8C0)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEMIXERBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1B59A8D0)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEMIXERBEHAVIOR_PAUSE_OFFSET UNITYSDK_OFFSET(0x1B59A510)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEMIXERBEHAVIOR_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x1B59A4F0)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEMIXERBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B599CF0)
#define MOLEMOLE_TIMELINE_BASETIMELINE_BASETIMELINEMIXERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B59A8E0)

namespace MoleMole::Timeline::BaseTimeline
{
	inline static constexpr unsigned int BaseTimelineMixerBehavior_TypeDefinitionIndex = 30158;
