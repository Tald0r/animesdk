...
#define MOLEMOLE_TIMELINE_LIGHTINGTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB3D2AC0)
#define MOLEMOLE_TIMELINE_LIGHTINGTRACK_METHOD_6_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xB3D2D90)
#define MOLEMOLE_TIMELINE_LIGHTINGTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB3D2D60)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LightingTrack_TypeDefinitionIndex = 44104;
