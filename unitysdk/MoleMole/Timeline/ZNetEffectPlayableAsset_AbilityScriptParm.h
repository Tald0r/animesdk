...
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_ABILITYSCRIPTPARM__CTOR_OFFSET UNITYSDK_OFFSET(0x8AA0F50)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ZNetEffectPlayableAsset_AbilityScriptParm_TypeDefinitionIndex = 44953;
