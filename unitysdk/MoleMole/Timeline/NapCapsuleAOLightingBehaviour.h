...
#include "unitysdk/MoleMole/Timeline/NapCapsuleAOLightingBehaviour_Struct_2_52AD02145F5FCE36_35.h"
...
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xB93B1F0)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xB93C420)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xB93C410)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_METHOD_4_6FB0247AFD7D752E_OFFSET UNITYSDK_OFFSET(0xB93B3A0)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xB93C440)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xB93C430)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_METHOD_4_E2BCD1B56132A826_OFFSET UNITYSDK_OFFSET(0xB93B830)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB93B750)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB93BFE0)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xB93C140)
#define MOLEMOLE_TIMELINE_NAPCAPSULEAOLIGHTINGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB93C3E0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int NapCapsuleAOLightingBehaviour_TypeDefinitionIndex = 74040;

	class NapCapsuleAOLightingBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::NapCapsuleAOLightingBehaviour_Struct_2_52AD02145F5FCE36_35 _methodParm; // 0x18
