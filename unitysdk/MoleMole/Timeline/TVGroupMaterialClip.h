...
#define MOLEMOLE_TIMELINE_TVGROUPMATERIALCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA492550)
#define MOLEMOLE_TIMELINE_TVGROUPMATERIALCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xA492540)
#define MOLEMOLE_TIMELINE_TVGROUPMATERIALCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xA492750)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVGroupMaterialClip_TypeDefinitionIndex = 48611;
