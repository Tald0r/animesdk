...
#include "unitysdk/MoleMole/Timeline/ScreenSpacePlanarReflectionBehaviour_Struct_2_52AD02145F5FCE36.h"
...
#define MOLEMOLE_TIMELINE_SCREENSPACEPLANARREFLECTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xB93CD30)
#define MOLEMOLE_TIMELINE_SCREENSPACEPLANARREFLECTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xB93EDA0)
#define MOLEMOLE_TIMELINE_SCREENSPACEPLANARREFLECTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xB93EDB0)
#define MOLEMOLE_TIMELINE_SCREENSPACEPLANARREFLECTIONBEHAVIOUR_METHOD_4_80313B77C31AD02B_OFFSET UNITYSDK_OFFSET(0xB93D5C0)
#define MOLEMOLE_TIMELINE_SCREENSPACEPLANARREFLECTIONBEHAVIOUR_METHOD_4_86038EB414D95013_OFFSET UNITYSDK_OFFSET(0xB93D080)
#define MOLEMOLE_TIMELINE_SCREENSPACEPLANARREFLECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xB93EDD0)
#define MOLEMOLE_TIMELINE_SCREENSPACEPLANARREFLECTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xB93EDC0)
#define MOLEMOLE_TIMELINE_SCREENSPACEPLANARREFLECTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB93D440)
#define MOLEMOLE_TIMELINE_SCREENSPACEPLANARREFLECTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB93E610)
#define MOLEMOLE_TIMELINE_SCREENSPACEPLANARREFLECTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xB93E800)
#define MOLEMOLE_TIMELINE_SCREENSPACEPLANARREFLECTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB93ED50)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ScreenSpacePlanarReflectionBehaviour_TypeDefinitionIndex = 37741;

	class ScreenSpacePlanarReflectionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ScreenSpacePlanarReflectionBehaviour_Struct_2_52AD02145F5FCE36 _methodParm; // 0x18
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_SCREENSPACEPLANARREFLECTIONBEHAVIOUR_METHOD_4_80313B77C31AD02B_OFFSET))(this);
		}
