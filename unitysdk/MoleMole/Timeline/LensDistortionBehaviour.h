...
#include "unitysdk/MoleMole/Timeline/LensDistortionBehaviour_Struct_2_52AD02145F5FCE36.h"
...
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x9ADBB30)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x9ADD050)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x9ADC220)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x9ADD040)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_82E2323103AE431E_OFFSET UNITYSDK_OFFSET(0x9ADBD60)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x9ADD030)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x9ADD020)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x9ADC120)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x9ADCB40)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x9ADCCB0)
#define MOLEMOLE_TIMELINE_LENSDISTORTIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x9ADCFE0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int LensDistortionBehaviour_TypeDefinitionIndex = 37977;

	class LensDistortionBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::LensDistortionBehaviour_Struct_2_52AD02145F5FCE36 _methodParm; // 0x18
