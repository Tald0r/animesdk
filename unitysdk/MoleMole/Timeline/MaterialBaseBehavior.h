...
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_CLEARCOMPRECORDERINFO_OFFSET UNITYSDK_OFFSET(0x1AEDB100)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_FINDRELATIVEMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x1AEDAC70)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_GETALLRENDERERS_OFFSET UNITYSDK_OFFSET(0x1AED9CD0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_GETCOMPRECORDERINFO_OFFSET UNITYSDK_OFFSET(0x1AEDB210)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1AED9440)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_GET_REFERENCETARGET_OFFSET UNITYSDK_OFFSET(0x1AED94A0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1AED93E0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_INIT_OFFSET UNITYSDK_OFFSET(0x1AED9850)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_LOADKFRAMESFROMANIMATOR_OFFSET UNITYSDK_OFFSET(0x1AED9650)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1AED9660)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1AED9790)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1AED9640)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1AED9830)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1AED9670)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1AED94C0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_RECORDMESHRENDERSFROMBATCH_OFFSET UNITYSDK_OFFSET(0x1AEDA490)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_RECORDMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1AED9E00)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_RECOVERMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1AEDAF20)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_REFRESHMONORENDERENTITY_OFFSET UNITYSDK_OFFSET(0x1AED9710)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_REINIT_OFFSET UNITYSDK_OFFSET(0x1AED9CC0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_RELOADMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0x1AED9B20)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_REVERTATTR_OFFSET UNITYSDK_OFFSET(0x1AEDA7B0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_SET_REFERENCETARGET_OFFSET UNITYSDK_OFFSET(0x1AED94B0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR_UPDATEMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0x1AEDA0E0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AEDB4A0)
#define MOLEMOLE_TIMELINE_MATERIALBASEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEDB410)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialBaseBehavior_TypeDefinitionIndex = 29138;
	...
	public:
		...
		{
			return (::MoleMole::Timeline::MaterialBaseBehavior_DeleteAnimationFrames**)Il2CppClass::FromTypeDefinitionIndex(MaterialBaseBehavior_TypeDefinitionIndex)->GetStaticField(0x22910);
		}
		static ::System::Reflection::MethodInfo** StaticGet_mbpRefresh()
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(MaterialBaseBehavior_TypeDefinitionIndex)->GetStaticField(0x22918);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>** StaticGet_MatchStrDic()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialBaseBehavior_TypeDefinitionIndex)->GetStaticField(0x22920);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>** StaticGet_RealKeyPathDic()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialBaseBehavior_TypeDefinitionIndex)->GetStaticField(0x22928);
		}
		static ::System::Int32* StaticGet_delayTime()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MaterialBaseBehavior_TypeDefinitionIndex)->GetStaticField(0x7650);
		}
