...
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPCONTROLBEHAVIOR_GET_COMPTIMELINECONFIG_OFFSET UNITYSDK_OFFSET(0xB8C87B0)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPCONTROLBEHAVIOR_METHOD_2_7A391CCE1142AE06_OFFSET UNITYSDK_OFFSET(0xB8C87C0)
#define MOLEMOLE_TIMELINE_AUTOGENERATECOMPS_COMPCONTROLBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB8C8820)

namespace MoleMole::Timeline::AutoGenerateComps
{
	inline static constexpr unsigned int CompControlBehavior_TypeDefinitionIndex = 45051;
