...
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1AC792A0)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1AC79290)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC79380)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FixedTimeStepClip_TypeDefinitionIndex = 29129;
