...
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B29EE80)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B29EE70)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B29EF50)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FixedTimeStepClip_TypeDefinitionIndex = 30082;
