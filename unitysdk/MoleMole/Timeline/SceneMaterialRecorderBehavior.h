...
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_CHECKRENDERERMATERIALINDEX_OFFSET UNITYSDK_OFFSET(0x1B2A07A0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_GETALLRENDERERS_OFFSET UNITYSDK_OFFSET(0x1B2A0B40)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_GET_INSTANCEMATERIALS_OFFSET UNITYSDK_OFFSET(0x1B2A05D0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_GET_MATERIALINFODIC_OFFSET UNITYSDK_OFFSET(0x1B29F7C0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_INIT_OFFSET UNITYSDK_OFFSET(0x1B29FA50)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_MATERIALCHANGED_OFFSET UNITYSDK_OFFSET(0x1B29FCF0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B2A1010)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1B2A1000)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1B2A0E90)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1B2A0B30)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B2A0FF0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_RECORDMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1B2A0320)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_RECOVERINSTANCEMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1B2A1020)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_RECOVERMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1B2A00A0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B2A11D0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A1150)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SceneMaterialRecorderBehavior_TypeDefinitionIndex = 30124;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::GameObject*, ::Il2CppArray<::UnityEngine::Renderer*>*>**)Il2CppClass::FromTypeDefinitionIndex(SceneMaterialRecorderBehavior_TypeDefinitionIndex)->GetStaticField(0x24520);
		}
