...
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_CHECKRENDERERMATERIALINDEX_OFFSET UNITYSDK_OFFSET(0x1AC7ABE0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_GETALLRENDERERS_OFFSET UNITYSDK_OFFSET(0x1AC7AF80)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_GET_INSTANCEMATERIALS_OFFSET UNITYSDK_OFFSET(0x1AC7AA10)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_GET_MATERIALINFODIC_OFFSET UNITYSDK_OFFSET(0x1AC79BF0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_INIT_OFFSET UNITYSDK_OFFSET(0x1AC79E90)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_MATERIALCHANGED_OFFSET UNITYSDK_OFFSET(0x1AC7A130)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AC7B450)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1AC7B440)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1AC7B2D0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1AC7AF70)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1AC7B430)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_RECORDMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1AC7A760)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_RECOVERINSTANCEMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1AC7B460)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR_RECOVERMESHRENDERS_OFFSET UNITYSDK_OFFSET(0x1AC7A4E0)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AC7B610)
#define MOLEMOLE_TIMELINE_SCENEMATERIALRECORDERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC7B590)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SceneMaterialRecorderBehavior_TypeDefinitionIndex = 29171;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::GameObject*, ::Il2CppArray<::UnityEngine::Renderer*>*>**)Il2CppClass::FromTypeDefinitionIndex(SceneMaterialRecorderBehavior_TypeDefinitionIndex)->GetStaticField(0x22C00);
		}
