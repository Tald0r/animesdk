...
#define MOLEMOLE_TIMELINE_SPLITTONINGBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x9ADF510)
#define MOLEMOLE_TIMELINE_SPLITTONINGBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x9AE0490)
#define MOLEMOLE_TIMELINE_SPLITTONINGBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x9AE04A0)
#define MOLEMOLE_TIMELINE_SPLITTONINGBEHAVIOUR_METHOD_4_9D2640C77F24BA37_OFFSET UNITYSDK_OFFSET(0x9ADF6A0)
#define MOLEMOLE_TIMELINE_SPLITTONINGBEHAVIOUR_METHOD_4_AE828D899505A3B4_OFFSET UNITYSDK_OFFSET(0x9ADFB10)
#define MOLEMOLE_TIMELINE_SPLITTONINGBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x9AE04B0)
#define MOLEMOLE_TIMELINE_SPLITTONINGBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x9AE0480)
#define MOLEMOLE_TIMELINE_SPLITTONINGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x9ADFA50)
#define MOLEMOLE_TIMELINE_SPLITTONINGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x9AE0030)
#define MOLEMOLE_TIMELINE_SPLITTONINGBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x9AE0170)
#define MOLEMOLE_TIMELINE_SPLITTONINGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x9AE0460)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SplitToningBehaviour_TypeDefinitionIndex = 52092;
