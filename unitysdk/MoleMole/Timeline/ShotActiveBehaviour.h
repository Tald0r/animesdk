...
#define MOLEMOLE_TIMELINE_SHOTACTIVEBEHAVIOUR_GET_DURATIONTIME_OFFSET UNITYSDK_OFFSET(0x6EE1900)
#define MOLEMOLE_TIMELINE_SHOTACTIVEBEHAVIOUR_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x6EE18D0)
#define MOLEMOLE_TIMELINE_SHOTACTIVEBEHAVIOUR_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x6EE18B0)
#define MOLEMOLE_TIMELINE_SHOTACTIVEBEHAVIOUR_METHOD_2_0043BC75B602D2E3_OFFSET UNITYSDK_OFFSET(0x6EE1930)
#define MOLEMOLE_TIMELINE_SHOTACTIVEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x6EE1920)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ShotActiveBehaviour_TypeDefinitionIndex = 43531;
