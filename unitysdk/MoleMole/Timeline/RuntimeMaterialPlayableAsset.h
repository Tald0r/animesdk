...
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x8FA3ED0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x8FA3EC0)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALPLAYABLEASSET_METHOD_4_4E497FF5F288E9D7_OFFSET UNITYSDK_OFFSET(0x8FA3E20)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALPLAYABLEASSET_METHOD_4_C433AF37CE9D6E5B_OFFSET UNITYSDK_OFFSET(0x8FA4120)
#define MOLEMOLE_TIMELINE_RUNTIMEMATERIALPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA4040)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimeMaterialPlayableAsset_TypeDefinitionIndex = 40385;
