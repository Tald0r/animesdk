...
#define MOLEMOLE_TIMELINE_MATERIALGLITCHCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1ACEBE60)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1ACEBE50)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHCLIP_INITDATA_OFFSET UNITYSDK_OFFSET(0x1ACEBF30)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACEBF50)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialGlitchClip_TypeDefinitionIndex = 30132;
