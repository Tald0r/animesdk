...
#define MOLEMOLE_TIMELINE_MATERIALGLITCHCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1A748140)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1A748130)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHCLIP_INITDATA_OFFSET UNITYSDK_OFFSET(0x1A748220)
#define MOLEMOLE_TIMELINE_MATERIALGLITCHCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A748240)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MaterialGlitchClip_TypeDefinitionIndex = 29179;
