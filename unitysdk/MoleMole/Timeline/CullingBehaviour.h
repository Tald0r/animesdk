...
#include "unitysdk/MoleMole/Timeline/CullingBehaviour_Struct_2_52AD02145F5FCE36_40.h"
...
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x9947A80)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0x994A7F0)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0x994A820)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_METHOD_4_80313B77C31AD02B_OFFSET UNITYSDK_OFFSET(0x99483C0)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0x994A810)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0x994A800)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_METHOD_4_B39D466EDF92F6FD_OFFSET UNITYSDK_OFFSET(0x9947E70)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x9948230)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x9949D60)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x9949F60)
#define MOLEMOLE_TIMELINE_CULLINGBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x994A7B0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CullingBehaviour_TypeDefinitionIndex = 78527;

	class CullingBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::CullingBehaviour_Struct_2_52AD02145F5FCE36_40 _methodParm; // 0x18
