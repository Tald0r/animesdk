...
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADBEHAVIOR_METHOD_2_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xA491A70)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADBEHAVIOR_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xA491A90)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADBEHAVIOR_METHOD_2_79ED6854413CA2F4_1_OFFSET UNITYSDK_OFFSET(0xA491A60)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADBEHAVIOR_METHOD_2_79ED6854413CA2F4_2_OFFSET UNITYSDK_OFFSET(0xA491A80)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADBEHAVIOR_METHOD_2_79ED6854413CA2F4_OFFSET UNITYSDK_OFFSET(0xA491A50)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADBEHAVIOR_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xA491560)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xA491780)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xA491680)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xA491900)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADBEHAVIOR_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0xA4914B0)
#define MOLEMOLE_TIMELINE_RUNTIMEPRELOADBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA491A40)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RuntimePreLoadBehavior_TypeDefinitionIndex = 78800;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_RUNTIMEPRELOADBEHAVIOR_METHOD_2_4307B2A4B4A12C1A_OFFSET))(this);
		}
	};
}
