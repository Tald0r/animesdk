...
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1AC7B6B0)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1AC7BC80)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1AC7BA10)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1AC7BDA0)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1AC7BB40)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC7BEC0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SkinnedMeshRendererBehavior_TypeDefinitionIndex = 29188;
