...
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1B2A1270)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1B2A1840)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B2A15D0)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1B2A1960)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B2A1700)
#define MOLEMOLE_TIMELINE_SKINNEDMESHRENDERERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A1A80)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int SkinnedMeshRendererBehavior_TypeDefinitionIndex = 30141;
