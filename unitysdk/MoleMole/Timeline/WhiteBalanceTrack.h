...
#define MOLEMOLE_TIMELINE_WHITEBALANCETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x8F4D170)
#define MOLEMOLE_TIMELINE_WHITEBALANCETRACK_METHOD_6_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0x8F4D440)
#define MOLEMOLE_TIMELINE_WHITEBALANCETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8F4D410)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int WhiteBalanceTrack_TypeDefinitionIndex = 78455;
