...
#define MOLEMOLE_TIMELINE_SCREENEFFECTSTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB3E37A0)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSTRACK_METHOD_6_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xB3E3A70)
#define MOLEMOLE_TIMELINE_SCREENEFFECTSTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB3E3A40)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ScreenEffectsTrack_TypeDefinitionIndex = 44493;
