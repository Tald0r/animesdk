...
#define MOLEMOLE_TIMELINE_ACTIVEEXTERNALTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x7F291A0)
#define MOLEMOLE_TIMELINE_ACTIVEEXTERNALTRACK_METHOD_5_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0x7F29350)
#define MOLEMOLE_TIMELINE_ACTIVEEXTERNALTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x7F29320)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ActiveExternalTrack_TypeDefinitionIndex = 38800;
