...
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_GET_REALPRIORITY_OFFSET UNITYSDK_OFFSET(0xD1ADCC0)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_METHOD_3_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0xD1AE120)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_METHOD_3_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xD1AE110)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_METHOD_3_ED01C45E2F8DB392_OFFSET UNITYSDK_OFFSET(0xD1AE130)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0xD1ADDF0)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0xD1ADCD0)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR_ONPROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD1ADF10)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD1AE100)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VisualEnvironmentOverrideBehavior_TypeDefinitionIndex = 70945;
