...
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_EFFECTAUTODYNAMICINFO_EDITORSHOWER_METHOD_1_711029325A16F9C2_OFFSET UNITYSDK_OFFSET(0xB9CF0D0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_EFFECTAUTODYNAMICINFO_EDITORSHOWER_METHOD_1_7FE685DCE6329F46_OFFSET UNITYSDK_OFFSET(0xB9CF030)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_EFFECTAUTODYNAMICINFO_EDITORSHOWER_METHOD_1_C0C89E0E67AC729E_OFFSET UNITYSDK_OFFSET(0xB9CF280)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_EFFECTAUTODYNAMICINFO_EDITORSHOWER_METHOD_1_DF7E81ADDCFE3A0C_OFFSET UNITYSDK_OFFSET(0xB9CF1C0)
#define MOLEMOLE_TIMELINE_ZNETEFFECTPLAYABLEASSET_EFFECTAUTODYNAMICINFO_EDITORSHOWER__CTOR_OFFSET UNITYSDK_OFFSET(0xB9CF020)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ZNetEffectPlayableAsset_EffectAutoDynamicInfo_EditorShower_TypeDefinitionIndex = 49164;
