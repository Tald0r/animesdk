...
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x67CD930)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x67CD7B0)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0x67CDE20)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONTRACK_METHOD_5_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0x67CDD80)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONTRACK_METHOD_5_B67A7D5A7BB42B14_OFFSET UNITYSDK_OFFSET(0x67CDC30)
#define MOLEMOLE_TIMELINE_EMOSYNCANIMATIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x67CDD50)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int EmoSyncAnimationTrack_TypeDefinitionIndex = 44994;
	...
	public:
		...
		{
			return ((::UnityEngine::Playables::Playable(*)(::PVOID, ::UnityEngine::Playables::PlayableGraph, ::UnityEngine::GameObject*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_TIMELINE_EMOSYNCANIMATIONTRACK_METHOD_5_6CBA94B39B120DE0_OFFSET))(this, a1, a2, a3);
		}
