...
#include "unitysdk/MoleMole/Timeline/ChromaticAberrationBehaviour_Struct_2_52AD02145F5FCE36_21.h"
...
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0xB70AA40)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xB70C7B0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0xB70B230)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xB70C7C0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xB70C7A0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xB70C790)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_METHOD_4_FC9E97531AC756AC_OFFSET UNITYSDK_OFFSET(0xB70AD00)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xB70B0C0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xB70BEC0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xB70C0A0)
#define MOLEMOLE_TIMELINE_CHROMATICABERRATIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB70C710)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int ChromaticAberrationBehaviour_TypeDefinitionIndex = 61522;

	class ChromaticAberrationBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::ChromaticAberrationBehaviour_Struct_2_52AD02145F5FCE36_21 _methodParm; // 0x18
