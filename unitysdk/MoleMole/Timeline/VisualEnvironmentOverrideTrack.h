...
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xA4ADBB0)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDETRACK_METHOD_5_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xA4ADD60)
#define MOLEMOLE_TIMELINE_VISUALENVIRONMENTOVERRIDETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA4ADD30)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int VisualEnvironmentOverrideTrack_TypeDefinitionIndex = 50717;
