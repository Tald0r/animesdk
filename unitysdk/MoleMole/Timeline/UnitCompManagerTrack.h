...
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xC26DF40)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xC26DDC0)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0xC26E230)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK_METHOD_5_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xC26E190)
#define MOLEMOLE_TIMELINE_UNITCOMPMANAGERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xC26E160)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int UnitCompManagerTrack_TypeDefinitionIndex = 67038;
