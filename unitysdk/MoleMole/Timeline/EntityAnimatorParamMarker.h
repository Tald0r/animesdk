...
#define MOLEMOLE_TIMELINE_ENTITYANIMATORPARAMMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0xA482270)
#define MOLEMOLE_TIMELINE_ENTITYANIMATORPARAMMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0xA4822D0)
#define MOLEMOLE_TIMELINE_ENTITYANIMATORPARAMMARKER_METHOD_4_111E3F406ABDDAA7_OFFSET UNITYSDK_OFFSET(0xA4822E0)
#define MOLEMOLE_TIMELINE_ENTITYANIMATORPARAMMARKER_METHOD_4_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xA481CA0)
#define MOLEMOLE_TIMELINE_ENTITYANIMATORPARAMMARKER_METHOD_4_AA94FB72678389C0_OFFSET UNITYSDK_OFFSET(0xA482190)
#define MOLEMOLE_TIMELINE_ENTITYANIMATORPARAMMARKER_METHOD_4_E0591EC1742C2C2C_OFFSET UNITYSDK_OFFSET(0xA481B70)
#define MOLEMOLE_TIMELINE_ENTITYANIMATORPARAMMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0xA482200)
#define MOLEMOLE_TIMELINE_ENTITYANIMATORPARAMMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0xA482350)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int EntityAnimatorParamMarker_TypeDefinitionIndex = 37447;
