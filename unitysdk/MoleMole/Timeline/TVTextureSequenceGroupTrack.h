...
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xC242410)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPTRACK_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xC242600)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0xC242640)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xC242610)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSequenceGroupTrack_TypeDefinitionIndex = 61511;
