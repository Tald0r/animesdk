...
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xC26DAE0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPTRACK_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xC26DCD0)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPTRACK_METHOD_5_652F102150AC9967_OFFSET UNITYSDK_OFFSET(0xC26DD10)
#define MOLEMOLE_TIMELINE_TVTEXTURESEQUENCEGROUPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xC26DCE0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TVTextureSequenceGroupTrack_TypeDefinitionIndex = 68560;
