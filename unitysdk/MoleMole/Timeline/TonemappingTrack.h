...
#define MOLEMOLE_TIMELINE_TONEMAPPINGTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x8F4BE30)
#define MOLEMOLE_TIMELINE_TONEMAPPINGTRACK_METHOD_6_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0x8F4C100)
#define MOLEMOLE_TIMELINE_TONEMAPPINGTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x8F4C0D0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int TonemappingTrack_TypeDefinitionIndex = 39682;
