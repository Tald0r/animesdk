...
#define MOLEMOLE_TIMELINE_POSTPROCESSBEHAVIOURBASE_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD83A370)
#define MOLEMOLE_TIMELINE_POSTPROCESSBEHAVIOURBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xD831330)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int PostProcessBehaviourBase_TypeDefinitionIndex = 73657;
