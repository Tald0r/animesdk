...
#include "unitysdk/MoleMole/Timeline/RTXVolumeBehaviour_Struct_2_52AD02145F5FCE3A_7.h"
...
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_COPYVALUEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x7AAA5B0)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_324AEE341AAA7A1B_OFFSET UNITYSDK_OFFSET(0xD2207A0)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_5F1FE78F971E9268_OFFSET UNITYSDK_OFFSET(0xD21EEE0)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_63F7844DC2D57F6C_OFFSET UNITYSDK_OFFSET(0xD220790)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_80313B77C31AD02B_OFFSET UNITYSDK_OFFSET(0xD21AD50)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_B072873681D4192B_1_OFFSET UNITYSDK_OFFSET(0xD2207B0)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_METHOD_4_B072873681D4192B_OFFSET UNITYSDK_OFFSET(0xD220780)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xD21A7E0)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xD21E900)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR_SETVALUE_OFFSET UNITYSDK_OFFSET(0xD21F2A0)
#define MOLEMOLE_TIMELINE_RTXVOLUMEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xD220660)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int RTXVolumeBehaviour_TypeDefinitionIndex = 44835;

	class RTXVolumeBehaviour : public ::MoleMole::Timeline::PostProcessBehaviourBase
	{
	public:
		::MoleMole::Timeline::RTXVolumeBehaviour_Struct_2_52AD02145F5FCE3A_7 _methodParm; // 0x18
