...
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1B40A340)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B40A280)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1B40A3C0)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B40A2F0)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40A440)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FixedTimeStepBehavior_TypeDefinitionIndex = 30081;
