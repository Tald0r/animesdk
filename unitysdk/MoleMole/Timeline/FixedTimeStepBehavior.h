...
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1ADE9BB0)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1ADE9AF0)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1ADE9C30)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1ADE9B60)
#define MOLEMOLE_TIMELINE_FIXEDTIMESTEPBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE9CB0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int FixedTimeStepBehavior_TypeDefinitionIndex = 29128;
