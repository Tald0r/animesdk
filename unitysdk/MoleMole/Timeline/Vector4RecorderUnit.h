...
#define MOLEMOLE_TIMELINE_VECTOR4RECORDERUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D6480)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int Vector4RecorderUnit_TypeDefinitionIndex = 30109;
