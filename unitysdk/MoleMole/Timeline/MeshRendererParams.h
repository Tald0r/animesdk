...
#define MOLEMOLE_TIMELINE_MESHRENDERERPARAMS_LAYERMASHSELECT_OFFSET UNITYSDK_OFFSET(0x1B5D59F0)
#define MOLEMOLE_TIMELINE_MESHRENDERERPARAMS_LAYERSELECT_OFFSET UNITYSDK_OFFSET(0x1B5D58D0)
#define MOLEMOLE_TIMELINE_MESHRENDERERPARAMS_SETSKINNEDMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x1B5D5FB0)
#define MOLEMOLE_TIMELINE_MESHRENDERERPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D5DE0)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int MeshRendererParams_TypeDefinitionIndex = 30142;
