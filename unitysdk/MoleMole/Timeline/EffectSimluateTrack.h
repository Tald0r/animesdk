...
#define MOLEMOLE_TIMELINE_EFFECTSIMLUATETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0xB3D03A0)
#define MOLEMOLE_TIMELINE_EFFECTSIMLUATETRACK_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0xB3D0950)
#define MOLEMOLE_TIMELINE_EFFECTSIMLUATETRACK_METHOD_5_6CBA94B39B120DE0_OFFSET UNITYSDK_OFFSET(0xB3D10F0)
#define MOLEMOLE_TIMELINE_EFFECTSIMLUATETRACK_METHOD_5_BAF1B727A81278E6_OFFSET UNITYSDK_OFFSET(0xB3D1190)
#define MOLEMOLE_TIMELINE_EFFECTSIMLUATETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB3D1080)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int EffectSimluateTrack_TypeDefinitionIndex = 63621;
