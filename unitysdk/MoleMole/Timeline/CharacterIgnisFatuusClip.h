...
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xB3CFB50)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xB3CFB40)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xB3CFD50)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterIgnisFatuusClip_TypeDefinitionIndex = 44060;
