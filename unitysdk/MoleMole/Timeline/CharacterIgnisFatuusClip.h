...
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xA668920)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0xA668910)
#define MOLEMOLE_TIMELINE_CHARACTERIGNISFATUUSCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xA668B20)

namespace MoleMole::Timeline
{
	inline static constexpr unsigned int CharacterIgnisFatuusClip_TypeDefinitionIndex = 43979;
