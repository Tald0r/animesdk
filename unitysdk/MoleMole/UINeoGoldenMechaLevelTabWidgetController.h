...
#define MOLEMOLE_UINEOGOLDENMECHALEVELTABWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBE5D860)
#define MOLEMOLE_UINEOGOLDENMECHALEVELTABWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBE5D8D0)
#define MOLEMOLE_UINEOGOLDENMECHALEVELTABWIDGETCONTROLLER_SETLEVEL_OFFSET UNITYSDK_OFFSET(0xBE5D9D0)
#define MOLEMOLE_UINEOGOLDENMECHALEVELTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBE5DAA0)
#define MOLEMOLE_UINEOGOLDENMECHALEVELTABWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBE5DAD0)

namespace MoleMole
{
	inline static constexpr unsigned int UINeoGoldenMechaLevelTabWidgetController_TypeDefinitionIndex = 53740;
