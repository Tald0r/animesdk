...
#define MOLEMOLE_ANIMATIONCURVEEX_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xACA2C10)
#define MOLEMOLE_ANIMATIONCURVEEX_GET_KEYS_OFFSET UNITYSDK_OFFSET(0xACA2B50)
#define MOLEMOLE_ANIMATIONCURVEEX_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0xACA2C70)
#define MOLEMOLE_ANIMATIONCURVEEX_GET_NOTNULLRUNTIMECURVE_OFFSET UNITYSDK_OFFSET(0xACA2B30)
#define MOLEMOLE_ANIMATIONCURVEEX_GET__NOTNULLRUNTIMECURVE_OFFSET UNITYSDK_OFFSET(0xACA29F0)
#define MOLEMOLE_ANIMATIONCURVEEX_METHOD_1_532AE2993E04D764_OFFSET UNITYSDK_OFFSET(0xACA2CF0)
#define MOLEMOLE_ANIMATIONCURVEEX_METHOD_1_64629612F3646911_OFFSET UNITYSDK_OFFSET(0xACA2DA0)
#define MOLEMOLE_ANIMATIONCURVEEX_METHOD_1_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0xACA2A10)
#define MOLEMOLE_ANIMATIONCURVEEX_METHOD_1_A82658DA976A3BA7_OFFSET UNITYSDK_OFFSET(0xACA2E40)
#define MOLEMOLE_ANIMATIONCURVEEX_METHOD_1_D09831639F615812_OFFSET UNITYSDK_OFFSET(0xACA2F90)
#define MOLEMOLE_ANIMATIONCURVEEX_METHOD_1_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0xACA2EF0)
#define MOLEMOLE_ANIMATIONCURVEEX_SET_KEYS_OFFSET UNITYSDK_OFFSET(0xACA2B80)
#define MOLEMOLE_ANIMATIONCURVEEX_SET__NOTNULLRUNTIMECURVE_OFFSET UNITYSDK_OFFSET(0xACA2B20)
#define MOLEMOLE_ANIMATIONCURVEEX__CCTOR_OFFSET UNITYSDK_OFFSET(0xACA2CA0)
#define MOLEMOLE_ANIMATIONCURVEEX__CTOR_OFFSET UNITYSDK_OFFSET(0xACA29E0)

namespace MoleMole
{
	inline static constexpr unsigned int AnimationCurveEx_TypeDefinitionIndex = 42004;
	...
	public:
		...
		{
			return (::UnityEngine::AnimationCurve**)Il2CppClass::FromTypeDefinitionIndex(AnimationCurveEx_TypeDefinitionIndex)->GetStaticField(0x38E60);
		}
