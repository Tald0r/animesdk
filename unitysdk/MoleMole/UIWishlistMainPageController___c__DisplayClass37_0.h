...
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS37_0__CTOR_OFFSET UNITYSDK_OFFSET(0x95B7AD0)
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS37_0__SHOWSKILLSPECIALITEMPROCESS_B__0_OFFSET UNITYSDK_OFFSET(0x95B7AE0)
#define MOLEMOLE_UIWISHLISTMAINPAGECONTROLLER___C__DISPLAYCLASS37_0__SHOWSKILLSPECIALITEMPROCESS_B__1_OFFSET UNITYSDK_OFFSET(0x95B7B60)

namespace MoleMole
{
	inline static constexpr unsigned int UIWishlistMainPageController___c__DisplayClass37_0_TypeDefinitionIndex = 77827;
