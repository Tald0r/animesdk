...
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA6D1100)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xA6D1300)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA6D2170)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA6D22A0)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA6D2210)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA6D1110)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_SORTFUNC_OFFSET UNITYSDK_OFFSET(0xA6D23A0)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA6D24B0)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER__INITVIEW_B__8_0_OFFSET UNITYSDK_OFFSET(0xA6D25F0)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER__INITVIEW_B__8_1_OFFSET UNITYSDK_OFFSET(0xA6D24C0)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA6D2630)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA6D26A0)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA6D26D0)
#define MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA6D26E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVideoShopTipsPopWindowController_TypeDefinitionIndex = 71761;

	class UIVideoShopTipsPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79AE422BA06F6D26_232* _view; // 0x2F8
		...
		::System::Int32 SortFunc(::Class_2_CFD622191BF76048_Struct_2_680BF1744D60EED9_1 lhs, ::Class_2_CFD622191BF76048_Struct_2_680BF1744D60EED9_1 rhs)
		{
			return ((::System::Int32(*)(::PVOID, ::Class_2_CFD622191BF76048_Struct_2_680BF1744D60EED9_1, ::Class_2_CFD622191BF76048_Struct_2_680BF1744D60EED9_1))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIDEOSHOPTIPSPOPWINDOWCONTROLLER_SORTFUNC_OFFSET))(this, lhs, rhs);
		}
