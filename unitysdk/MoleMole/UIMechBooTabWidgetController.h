...
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER_GET_TABBUTTON_OFFSET UNITYSDK_OFFSET(0xC1378E0)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC1382B0)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xC137E30)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC138350)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC137900)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC1379A0)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER_REFRESHSELECTED_OFFSET UNITYSDK_OFFSET(0xC138100)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER_REFRESHTABNEW_OFFSET UNITYSDK_OFFSET(0xC137F70)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER_SETCOSTSTATE_OFFSET UNITYSDK_OFFSET(0xC138220)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER_SETTOTALCOST_OFFSET UNITYSDK_OFFSET(0xC138170)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC138430)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC138460)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xC1384D0)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC138530)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC1385B0)
#define MOLEMOLE_UIMECHBOOTABWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC138610)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooTabWidgetController_TypeDefinitionIndex = 65563;
