...
#define MOLEMOLE_NAPCANVASSCALER_CALLHANDLE_OFFSET UNITYSDK_OFFSET(0xA47AC40)
#define MOLEMOLE_NAPCANVASSCALER_METHOD_7_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0xA47AD70)
#define MOLEMOLE_NAPCANVASSCALER_METHOD_7_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0xA47AD00)
#define MOLEMOLE_NAPCANVASSCALER_METHOD_7_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA47AD10)
#define MOLEMOLE_NAPCANVASSCALER_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xA47ADE0)
#define MOLEMOLE_NAPCANVASSCALER__CTOR_OFFSET UNITYSDK_OFFSET(0xA47ACB0)

namespace MoleMole
{
	inline static constexpr unsigned int NapCanvasScaler_TypeDefinitionIndex = 48298;
