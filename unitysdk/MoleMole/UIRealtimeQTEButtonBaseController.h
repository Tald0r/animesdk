...
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_CHECKQTEWRONGINPUT_OFFSET UNITYSDK_OFFSET(0xA437230)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_CLEARMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0xA4367D0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_GET_VIRTUALLOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xA4362B0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA4362A0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_INITINPUTCODEFORWRONGINPUTDETECT_OFFSET UNITYSDK_OFFSET(0xA438B60)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_INITMATERIAL_OFFSET UNITYSDK_OFFSET(0xA438400)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_INITQTEBUTTON_OFFSET UNITYSDK_OFFSET(0xA4364B0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_INITTASKPROGRESS_OFFSET UNITYSDK_OFFSET(0xA4386C0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_ISBTNWORKABLE_OFFSET UNITYSDK_OFFSET(0xA436D60)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xA436A30)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_ONBUTTONDOWN_OFFSET UNITYSDK_OFFSET(0xA436B00)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_ONBUTTONUP_OFFSET UNITYSDK_OFFSET(0xA436C30)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_ONINITQTEBUTTON_OFFSET UNITYSDK_OFFSET(0xA436E90)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA436900)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_ONQTEBUTTONBEFOREWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0xA436FB0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_ONTRYCLOSEREALTIMEQTE_OFFSET UNITYSDK_OFFSET(0xA436E10)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4366C0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA4362C0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA4363C0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_REFRESHTASKPROGRESS_OFFSET UNITYSDK_OFFSET(0xA437070)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_SET_LOGICBUTTONINPUTTYPE_OFFSET UNITYSDK_OFFSET(0xA438FE0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_SHOULDSKILLBUTTONHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0xA4369B0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER_TRYCLOSEREALTIMEQTE_OFFSET UNITYSDK_OFFSET(0xA436EF0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA438FF0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER___BASE_ISBTNWORKABLE_OFFSET UNITYSDK_OFFSET(0xA4390A0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER___BASE_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xA4390B0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER___BASE_ONBUTTONDOWN_OFFSET UNITYSDK_OFFSET(0xA439110)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER___BASE_ONBUTTONUP_OFFSET UNITYSDK_OFFSET(0xA439170)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA4391D0)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA439070)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA439080)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA439090)
#define MOLEMOLE_UIREALTIMEQTEBUTTONBASECONTROLLER___BASE_SHOULDSKILLBUTTONHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0xA439200)

namespace MoleMole
{
	inline static constexpr unsigned int UIRealtimeQTEButtonBaseController_TypeDefinitionIndex = 76231;
	...
	public:
		...
		::Class_1_43BD383C98B4C0C5_85* _buttonStyle; // 0x368
