...
#define MOLEMOLE_UISETTINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8688810)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingContext_TypeDefinitionIndex = 56711;
