...
#define MOLEMOLE_UICOOPNEWTIPSDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD043CD0)
#define MOLEMOLE_UICOOPNEWTIPSDIALOGPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD043CE0)
#define MOLEMOLE_UICOOPNEWTIPSDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD043D50)
#define MOLEMOLE_UICOOPNEWTIPSDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD043E50)
#define MOLEMOLE_UICOOPNEWTIPSDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD044020)
#define MOLEMOLE_UICOOPNEWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD044030)
#define MOLEMOLE_UICOOPNEWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD0440A0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopNewTipsDialogPopWindowController_TypeDefinitionIndex = 51867;
