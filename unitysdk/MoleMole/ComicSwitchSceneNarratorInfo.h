...
#define MOLEMOLE_COMICSWITCHSCENENARRATORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6C83E0)

namespace MoleMole
{
	inline static constexpr unsigned int ComicSwitchSceneNarratorInfo_TypeDefinitionIndex = 29094;
