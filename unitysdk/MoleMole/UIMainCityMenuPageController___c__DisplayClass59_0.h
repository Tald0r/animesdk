...
#define MOLEMOLE_UIMAINCITYMENUPAGECONTROLLER___C__DISPLAYCLASS59_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA4110C0)
#define MOLEMOLE_UIMAINCITYMENUPAGECONTROLLER___C__DISPLAYCLASS59_0__ONOPENBATTLEPASS_B__0_OFFSET UNITYSDK_OFFSET(0xA4110D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityMenuPageController___c__DisplayClass59_0_TypeDefinitionIndex = 59232;
