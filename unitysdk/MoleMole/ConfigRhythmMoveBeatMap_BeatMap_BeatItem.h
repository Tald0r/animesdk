...
#define MOLEMOLE_CONFIGRHYTHMMOVEBEATMAP_BEATMAP_BEATITEM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x38EE70)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigRhythmMoveBeatMap_BeatMap_BeatItem_TypeDefinitionIndex = 58814;
