...
#define MOLEMOLE_TURNBATTLEROUNDDUMMYUNIT_GET_ROUNDINDEX_OFFSET UNITYSDK_OFFSET(0xB9CF430)
#define MOLEMOLE_TURNBATTLEROUNDDUMMYUNIT_SET_ROUNDINDEX_OFFSET UNITYSDK_OFFSET(0xB9CF440)
#define MOLEMOLE_TURNBATTLEROUNDDUMMYUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0xB9CF450)

namespace MoleMole
{
	inline static constexpr unsigned int TurnBattleRoundDummyUnit_TypeDefinitionIndex = 72705;
