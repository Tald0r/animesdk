...
#define MOLEMOLE_TURNBATTLEROUNDDUMMYUNIT_GET_ROUNDINDEX_OFFSET UNITYSDK_OFFSET(0xD844EF0)
#define MOLEMOLE_TURNBATTLEROUNDDUMMYUNIT_SET_ROUNDINDEX_OFFSET UNITYSDK_OFFSET(0xD844F00)
#define MOLEMOLE_TURNBATTLEROUNDDUMMYUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0xD844F10)

namespace MoleMole
{
	inline static constexpr unsigned int TurnBattleRoundDummyUnit_TypeDefinitionIndex = 61256;
