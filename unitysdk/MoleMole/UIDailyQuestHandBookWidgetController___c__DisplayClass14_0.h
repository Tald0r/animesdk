...
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBFEA600)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_0__TRYPLAYCANTAKEREWARDEFFECT_B__0_OFFSET UNITYSDK_OFFSET(0xBFEB7D0)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_0__TRYPLAYCANTAKEREWARDEFFECT_G__DOPLAYPROGRESSANIM_2_OFFSET UNITYSDK_OFFSET(0xBFEB880)
#define MOLEMOLE_UIDAILYQUESTHANDBOOKWIDGETCONTROLLER___C__DISPLAYCLASS14_0__TRYPLAYCANTAKEREWARDEFFECT_G__PLAYANIMATIONTOWARDSCURLEVEL_1_OFFSET UNITYSDK_OFFSET(0xBFEA770)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestHandBookWidgetController___c__DisplayClass14_0_TypeDefinitionIndex = 59328;
