...
#define MOLEMOLE_UICINEMASINGLEPLAYWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAC434A0)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaSinglePlayWidgetContext_TypeDefinitionIndex = 74597;
