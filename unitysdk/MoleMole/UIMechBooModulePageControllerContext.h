...
#define MOLEMOLE_UIMECHBOOMODULEPAGECONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x98C63A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooModulePageControllerContext_TypeDefinitionIndex = 42334;
