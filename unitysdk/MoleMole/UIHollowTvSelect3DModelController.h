...
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_DOFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x6C92060)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x6C91080)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_LOOPBLENDTOENDANIM_OFFSET UNITYSDK_OFFSET(0x6C91F10)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C912B0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONSTOPLOOPANIM_OFFSET UNITYSDK_OFFSET(0x6C91910)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C91350)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6C91090)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6C91240)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_PLAYFADEINANDLOOPANIM_OFFSET UNITYSDK_OFFSET(0x6C91670)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_PLAYFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x6C91B40)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_STOPALLANIM_OFFSET UNITYSDK_OFFSET(0x6C91500)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_SYNCTRANSFORM_OFFSET UNITYSDK_OFFSET(0x6C92110)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER_WAITFORANIMATION_OFFSET UNITYSDK_OFFSET(0x6C91AA0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6C92530)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER__WAITFORANIMATION_B__20_0_OFFSET UNITYSDK_OFFSET(0x6C92610)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6C92640)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6C926B0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6C926C0)
#define MOLEMOLE_UIHOLLOWTVSELECT3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6C926D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowTvSelect3DModelController_TypeDefinitionIndex = 59399;
