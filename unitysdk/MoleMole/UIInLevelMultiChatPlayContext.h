...
#define MOLEMOLE_UIINLEVELMULTICHATPLAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x927ABD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelMultiChatPlayContext_TypeDefinitionIndex = 78060;
