...
#define MOLEMOLE_UIINLEVELMULTICHATPLAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8C69110)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelMultiChatPlayContext_TypeDefinitionIndex = 48212;
