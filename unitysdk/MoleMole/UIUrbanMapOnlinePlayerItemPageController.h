...
class Class_2_626C276089BB3996;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }
namespace MoleMole { class UIUrbanOnLinePlayerWidgetContext; }
namespace System { class EventArgs; }

#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xEE4AF10)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEE4AF20)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_ONCAMERAFOLLOWCHANGE_OFFSET UNITYSDK_OFFSET(0xEE4B3F0)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEE4AF90)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xEE4B0E0)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xEE4B360)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xEE4B880)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEE4B8B0)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xEE4B920)
#define MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xEE4B990)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapOnlinePlayerItemPageController_TypeDefinitionIndex = 69162;

	class UIUrbanMapOnlinePlayerItemPageController : public ::MoleMole::UIWidgetController
	{
	public:
		::MoleMole::UIUrbanOnLinePlayerWidgetContext* _context; // 0x2A0
		...
		::Class_2_626C276089BB3996* get__viewModel()
		{
			return ((::Class_2_626C276089BB3996*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIURBANMAPONLINEPLAYERITEMPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
