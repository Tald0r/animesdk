...
#define MOLEMOLE_CONFIGTEXTURESHEET_CONFIGTEXTURESHEET_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x15ED5DF0)
#define MOLEMOLE_CONFIGTEXTURESHEET_CONFIGTEXTURESHEET_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x15ED5E00)
#define MOLEMOLE_CONFIGTEXTURESHEET_CONFIGTEXTURESHEET_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x15ED6170)
#define MOLEMOLE_CONFIGTEXTURESHEET_CONFIGTEXTURESHEET_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x15ED63E0)
#define MOLEMOLE_CONFIGTEXTURESHEET_CONFIGTEXTURESHEET_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x15ED63A0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTextureSheet_ConfigTextureSheet_UnityGeneratedFormatter_TypeDefinitionIndex = 73664;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::TextureSheetData*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigTextureSheet_ConfigTextureSheet_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x320C0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::BlendTextureSheetData*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigTextureSheet_ConfigTextureSheet_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x320C8);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::RandomTextureSheetData*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigTextureSheet_ConfigTextureSheet_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x320D8);
		}
