...
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_ASPECTWH_GET_MINASPECT_OFFSET UNITYSDK_OFFSET(0x3A8B00)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_ASPECTWH_GET_RATIO_OFFSET UNITYSDK_OFFSET(0x3A8A80)
#define MOLEMOLE_MONOEFFECTPLUGINATTACHTOCAMERA_ASPECTWH_METHOD_2_B31A23B75E1D102F_OFFSET UNITYSDK_OFFSET(0xB1A5E20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectPluginAttachToCamera_AspectWH_TypeDefinitionIndex = 40388;
