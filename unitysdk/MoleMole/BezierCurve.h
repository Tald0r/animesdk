...
#define MOLEMOLE_BEZIERCURVE_AUTOSMOOTHALL_OFFSET UNITYSDK_OFFSET(0x8022FE0)
#define MOLEMOLE_BEZIERCURVE_GETPOSITIONBYNORMALIZETIME_OFFSET UNITYSDK_OFFSET(0x8022F40)
#define MOLEMOLE_BEZIERCURVE_GET_MAXTIME_OFFSET UNITYSDK_OFFSET(0x8022E80)
#define MOLEMOLE_BEZIERCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x8023080)

namespace MoleMole
{
	inline static constexpr unsigned int BezierCurve_TypeDefinitionIndex = 49499;
