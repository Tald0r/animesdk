...
#define MOLEMOLE_BEZIERCURVE_AUTOSMOOTHALL_OFFSET UNITYSDK_OFFSET(0x9CD6E90)
#define MOLEMOLE_BEZIERCURVE_GETPOSITIONBYNORMALIZETIME_OFFSET UNITYSDK_OFFSET(0x9CD6DF0)
#define MOLEMOLE_BEZIERCURVE_GET_MAXTIME_OFFSET UNITYSDK_OFFSET(0x9CD6D30)
#define MOLEMOLE_BEZIERCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9CD6F30)

namespace MoleMole
{
	inline static constexpr unsigned int BezierCurve_TypeDefinitionIndex = 55681;
