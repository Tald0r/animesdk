...
#define MOLEMOLE_UIACTIVITYNORMALCONTEXTBASE_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0xD858DD0)
#define MOLEMOLE_UIACTIVITYNORMALCONTEXTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xD858E80)
#define MOLEMOLE_UIACTIVITYNORMALCONTEXTBASE___BASE_APPLYJUMPPARAS_OFFSET UNITYSDK_OFFSET(0xD858E90)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityNormalContextBase_TypeDefinitionIndex = 74758;

	class UIActivityNormalContextBase : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Action* OnCloseAction; // 0x28
		::Class_1_43BD383C98B4C0C5_104* widgetPageData; // 0x30
