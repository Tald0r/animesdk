...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PREPARESTAGE_D__123_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x385790)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PREPARESTAGE_D__123_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__PrepareStage_d__123_TypeDefinitionIndex = 66338;

	struct alignas(8) UIRidusGotBooPageController__PrepareStage_d__123
	{
		::MoleMole::UIRidusGotBooPageController* __4__this; // 0x10
		::Class_3_A57C497A7F67FFC9* _npcTransform_5__4; // 0x18
