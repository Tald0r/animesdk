...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PREPARESTAGE_D__123_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x39B870)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PREPARESTAGE_D__123_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__PrepareStage_d__123_TypeDefinitionIndex = 44144;

	struct alignas(8) UIRidusGotBooPageController__PrepareStage_d__123
	{
		::Class_3_A57C497A7F67FFC9* _npcTransform_5__4; // 0x10
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__1; // 0x18
		::MoleMole::UIRidusGotBooPageController___c__DisplayClass123_0* __8__1; // 0x28
		...
		::System::Int32 _buddyID_5__3; // 0x50
