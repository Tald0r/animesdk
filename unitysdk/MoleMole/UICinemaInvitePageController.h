...
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0xDDD3230)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDDD2580)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_ONCINEMAPLAYEXIT_OFFSET UNITYSDK_OFFSET(0xDDD3A90)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_ONCLICKCLOSE_OFFSET UNITYSDK_OFFSET(0xDDD32A0)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_ONCLOSESELECTMOVIE_OFFSET UNITYSDK_OFFSET(0xDDD3470)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDDD2590)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_ONENTERCINEMALEVELERROR_OFFSET UNITYSDK_OFFSET(0xDDD3A20)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_ONENTERCINEMALEVELSUCCESS_OFFSET UNITYSDK_OFFSET(0xDDD37F0)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDDD2F60)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_ONSTARTDATELEVEL_OFFSET UNITYSDK_OFFSET(0xDDD3540)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDDD2FE0)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDDD2630)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDDD2840)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_OPENSELECTMOVIE_OFFSET UNITYSDK_OFFSET(0xDDD2D50)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_OPENSELECTROLE_OFFSET UNITYSDK_OFFSET(0xDDD2B70)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDDD3CA0)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDDD3CB0)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDDD3D20)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDDD3D30)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDDD3D40)
#define MOLEMOLE_UICINEMAINVITEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDDD3D50)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaInvitePageController_TypeDefinitionIndex = 77057;

	class UICinemaInvitePageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_C66DEC328A595BAB_1* _view; // 0x2F8
		...
		::Class_2_C66DEC328A595BAB_1* GetView()
		{
			return ((::Class_2_C66DEC328A595BAB_1*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_GETVIEW_OFFSET))(this);
		}
		...
		::System::Void OnEnterCinemaLevelSuccess(::Class_3_32CD58E95ADFF8F5_27* rcvMessage)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_32CD58E95ADFF8F5_27*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_ONENTERCINEMALEVELSUCCESS_OFFSET))(this, rcvMessage);
		}

		::System::Void OnEnterCinemaLevelError(::Class_0_16E4307DCC419505_5* rcvMessage)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UICINEMAINVITEPAGECONTROLLER_ONENTERCINEMALEVELERROR_OFFSET))(this, rcvMessage);
		}
