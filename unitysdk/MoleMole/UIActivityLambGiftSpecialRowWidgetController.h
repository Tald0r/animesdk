...
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER_ONCLICKREWARDITEM_OFFSET UNITYSDK_OFFSET(0xC290DE0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC28FF90)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC290110)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC290030)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC28FA50)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER_REFRESHREWARDSTATE_OFFSET UNITYSDK_OFFSET(0xC290930)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC291060)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC291070)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC2910E0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC291160)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC2911E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityLambGiftSpecialRowWidgetController_TypeDefinitionIndex = 71202;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_243* _view; // 0x2D0
		::Class_1_B08665FEB7112467_1* activityData; // 0x2D8
