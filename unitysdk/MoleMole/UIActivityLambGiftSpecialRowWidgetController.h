...
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER_ONCLICKREWARDITEM_OFFSET UNITYSDK_OFFSET(0xC25F6F0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC25E890)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC25EA10)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC25E930)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC25E360)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER_REFRESHREWARDSTATE_OFFSET UNITYSDK_OFFSET(0xC25F230)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC25F970)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC25F980)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC25F9F0)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC25FA70)
#define MOLEMOLE_UIACTIVITYLAMBGIFTSPECIALROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC25FAF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityLambGiftSpecialRowWidgetController_TypeDefinitionIndex = 42145;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_62* _view; // 0x2D0
